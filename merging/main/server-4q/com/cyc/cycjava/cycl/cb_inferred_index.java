...
import static com.cyc.cycjava.cycl.inferred_indexing.all_inferred_gaf_arg_index_ontology_terms;
import static com.cyc.cycjava.cycl.inferred_indexing.all_inferred_gaf_arg_index_predicates;
import static com.cyc.cycjava.cycl.inferred_indexing.all_inferred_gaf_arg_index_tuples;
import static com.cyc.cycjava.cycl.inferred_indexing.categorize_inferred_gaf_arg_index_tuples;
import static com.cyc.cycjava.cycl.inferred_indexing.categorize_via_pred_filters;
import static com.cyc.cycjava.cycl.inferred_indexing.num_inferred_gaf_arg_index_tuple;
import static com.cyc.cycjava.cycl.inferred_indexing.num_inferred_gaf_arg_index_tuple_groups;
import static com.cyc.cycjava.cycl.inferred_indexing.num_inferred_gaf_arg_index_tuples;
...
/**
 * Copyright (c) 1995 - 2019 Cycorp, Inc.  All rights reserved.
 * module:      CB-INFERRED-INDEX
 * source file: /cyc/top/cycl/cb-inferred-index.lisp
 * created:     2019/07/03 17:38:05
 */
public final class cb_inferred_index extends SubLTranslatedFile implements V12 {
 ...
 public static final String myName = "com.cyc.cycjava.cycl.cb_inferred_index";
    ...
    static private final SubLList $list5 = list(makeSymbol("INDEX-ID"));

    static private final SubLString $str6$Unable_to_determine_a_term_from__ = makeString("Unable to determine a term from ~S");

    private static final SubLSymbol CB_INFERRED_INDEX_FRAME = makeSymbol("CB-INFERRED-INDEX-FRAME");
    ...
    static private final SubLString $$$create_spec = makeString("create spec");
    ...
    private static final SubLList $list131 = list(reader_make_constant_shell("genls"), reader_make_constant_shell("genlPreds"), reader_make_constant_shell("genlMt"));
    ...
    static private final SubLList $list185 = list(makeSymbol("NAME"), makeSymbol("VALUE"));
    ...
    static private final SubLList $list195 = list($SELF, makeKeyword("LOWER"), makeKeyword("MIDDLE"), makeKeyword("ALL"));
    ...
    private static final SubLList $list229 = list(cons(reader_make_constant_shell("isa"), makeKeyword("ISA")), cons(reader_make_constant_shell("genls"), makeKeyword("GENLS")), cons(reader_make_constant_shell("equals"), makeKeyword("EQUALITY")));
    ...
    private static final SubLList $list238 = list(reader_make_constant_shell("Thing"));
    ...
    private static final SubLList $list251 = list($NAME, $PRED, makeKeyword("ARGNUM"));
    ...
    public static final SubLObject cb_inferred_index_frame_alt(SubLObject args) {
        {
            SubLObject datum = args;
            SubLObject current = datum;
            SubLObject index_id = NIL;
            destructuring_bind_must_consp(current, datum, $list_alt5);
            index_id = current.first();
            current = current.rest();
            if (NIL == current) {
                {
                    SubLObject index_hook = cb_guess_index(index_id);
                    if (NIL == index_hook) {
                        return cb_error($str_alt6$Unable_to_determine_a_term_from__, index_id, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                    }
                    return com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_index(index_hook);
                }
            } else {
    ...
    public static final SubLObject cb_link_inferred_index_alt(SubLObject v_term, SubLObject linktext, SubLObject target) {
        ...
        }
        {
            ...
            if (NIL == linktext) {
                linktext = $str_alt9$_Inferred_;
            }
            {
                SubLObject index_id = cb_index_identifier(v_term);
                SubLObject frame_name_var = cb_frame_name(target);
                html_markup(html_macros.$html_anchor_head$.getGlobalValue());
                html_markup(html_macros.$html_anchor_href$.getGlobalValue());
                html_char(CHAR_quotation, UNPROVIDED);
                cyc_cgi_url_int();
                format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt10$cb_inferred_index_frame__A, index_id);
                html_char(CHAR_quotation, UNPROVIDED);
    ...
    public static final SubLObject cb_legacy_index_frame_alt(SubLObject args) {
        {
            SubLObject datum = args;
            SubLObject current = datum;
            SubLObject index_id = NIL;
    ...
    public static final SubLObject cb_link_legacy_index_alt(SubLObject v_term, SubLObject linktext, SubLObject target) {
        if (linktext == UNPROVIDED) {
            linktext = NIL;
        }
        if (target == UNPROVIDED) {
        ...
        }
        {
            ...
            }
            {
                ...
                html_char(CHAR_quotation, UNPROVIDED);
                cyc_cgi_url_int();
                format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt15$cb_legacy_index_frame__A, index_id);
                html_char(CHAR_quotation, UNPROVIDED);
                if (NIL != frame_name_var) {
                    html_markup(html_macros.$html_anchor_target$.getGlobalValue());
                    html_char(CHAR_quotation, UNPROVIDED);
    ...
    public static final SubLObject cb_inferred_index_alt(SubLObject v_term) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject order_by = $cb_inferred_index_order_by$.getDynamicValue(thread);
                SubLObject filters = $cb_inferred_index_filters$.getDynamicValue(thread);
                ...
                html_source_readability_terpri(UNPROVIDED);
                {
                    ...
                    try {
                        ...
                        html_char(CHAR_greater, UNPROVIDED);
                        {
                            ...
                            try {
                                html_macros.$html_safe_print$.bind(T, thread);
                                com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_index_header(v_term, order_by);
                                html_hr(UNPROVIDED, UNPROVIDED);
                                com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_index_utilities_section(v_term);
                                html_hr(UNPROVIDED, UNPROVIDED);
                                com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_index(v_term, filters, order_by);
                                html_source_readability_terpri(UNPROVIDED);
                            } finally {
    ...
    public static final SubLObject cb_show_inferred_gaf_arg_index_utilities_section_alt(SubLObject v_term) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject modification_permittedP = cb_editor.term_modification_permittedP(v_term);
                SubLObject not_modifiableP = makeBoolean(NIL == modification_permittedP);
                {
                    ...
                    html_char(CHAR_greater, UNPROVIDED);
                    {
                        ...
                        try {
                            html_macros.$html_safe_print$.bind(T, thread);
                            dhtml_macros.dhtml_switch_visibility_links_arrows_and_text($$$browsing, $$$Browsing);
                ...
                if (NIL != $cb_editing_enabled$.getDynamicValue(thread)) {
                    {
                        ...
                        html_char(CHAR_greater, UNPROVIDED);
                        {
                            ...
                            try {
                                html_macros.$html_safe_print$.bind(T, thread);
                                dhtml_macros.dhtml_switch_visibility_links_arrows_and_text($$$edit, $$$Editing);
                                html_indent(TWO_INTEGER);
                            } finally {
                                html_macros.$html_safe_print$.rebind(_prev_bind_0, thread);
                            }
                ...
                dhtml_macros.dhtml_set_switched_visibility($$$browsing, $INVISIBLE, $TEXT);
                html_markup(html_macros.$html_div_head$.getGlobalValue());
                if (true) {
                    html_markup(html_macros.$html_attribute_id$.getGlobalValue());
                    html_char(CHAR_quotation, UNPROVIDED);
                    html_markup($$$browsing);
                    html_char(CHAR_quotation, UNPROVIDED);
                }
                html_char(CHAR_greater, UNPROVIDED);
                {
                ...
                html_source_readability_terpri(UNPROVIDED);
                if (NIL != $cb_editing_enabled$.getDynamicValue(thread)) {
                    dhtml_macros.dhtml_set_switched_visibility($$$edit, $INVISIBLE, $TEXT);
                    html_markup(html_macros.$html_div_head$.getGlobalValue());
                    if (true) {
                        html_markup(html_macros.$html_attribute_id$.getGlobalValue());
                        html_char(CHAR_quotation, UNPROVIDED);
                    ...
                    html_char(CHAR_greater, UNPROVIDED);
                    {
                        ...
                        try {
                            ...
                            {
                                SubLObject unlexifiedP = lexification_utilities.unlexifiedP(v_term, UNPROVIDED);
                                html_princ($str_alt25$___);
                                if (NIL != unlexifiedP) {
                            ...
                            html_princ($str_alt25$___);
                            cb_link(NIL != $cb_confirm_kills$.getDynamicValue(thread) ? ((SubLObject) ($CONFIRM_KILL)) : $KILL, v_term, $$$kill, not_modifiableP, UNPROVIDED, UNPROVIDED);
                            html_princ($str_alt25$___);
                            cb_link($ALL_ASSERTIONS_TMS, v_term, $$$force_TMS, UNPROVIDED, UNPROVIDED, UNPROVIDED);
    ...
    public static final SubLObject cb_show_inferred_gaf_arg_index_header(SubLObject v_term, SubLObject order_by) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
                        ...
                        try {
                            ...
                            html_char(CHAR_greater, UNPROVIDED);
                            {
                                ...
                                try {
                                    html_macros.$html_safe_print$.bind(T, thread);
                                    {
                                        ...
                                        html_char(CHAR_greater, UNPROVIDED);
                                        {
                                            ...
                                            try {
                                                html_macros.$html_safe_print$.bind(T, thread);
                                                html_markup(html_macros.$html_no_break_head$.getGlobalValue());
                                                html_princ_strong($$$Inferred_Index);
                                                html_markup(html_macros.$html_no_break_tail$.getGlobalValue());
                                            } finally {
                                    ...
                                    html_newline(UNPROVIDED);
                                    {
                                        SubLObject size = cb_term_font_size(v_term, UNPROVIDED, UNPROVIDED);
                                        html_markup(html_macros.$html_strong_head$.getGlobalValue());
                                        {
                            ...
                            html_char(CHAR_greater, UNPROVIDED);
                            {
                                ...
                                try {
                                    ...
                                    html_markup(html_macros.$html_small_head$.getGlobalValue());
                                    html_markup(html_macros.$html_no_break_head$.getGlobalValue());
                                    html_princ($str_alt56$order_by__);
                                    html_indent(UNPROVIDED);
                                    ...
                                    html_newline(UNPROVIDED);
                                    html_markup(html_macros.$html_no_break_head$.getGlobalValue());
                                    html_princ($str_alt61$filters__);
                                    html_indent(UNPROVIDED);
                                    ...
                                    html_newline(UNPROVIDED);
                                    html_markup(html_macros.$html_no_break_head$.getGlobalValue());
                                    html_princ($str_alt64$index_view__);
                                    html_indent(UNPROVIDED);
                                    html_markup(html_macros.$html_strong_head$.getGlobalValue());
    ...
    public static final SubLObject cb_show_inferred_gaf_arg_index_alt(SubLObject v_term, SubLObject filters, SubLObject order_by) {
        ...
        {
            SubLObject tuples = all_inferred_gaf_arg_index_tuples(v_term, filters, order_by);
            SubLObject tuple_groups = categorize_inferred_gaf_arg_index_tuples(v_term, tuples, order_by);
            SubLObject pcase_var = order_by;
            if (pcase_var.eql($ONTOLOGY)) {
                return com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_index_by_ontology(v_term, tuple_groups);
            } else {
                if (pcase_var.eql($PREDICATE)) {
                    return com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_index_by_predicate(v_term, tuple_groups);
                } else {
                    return cb_error($str_alt67$Unexpected_order_by____S, order_by, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                }
            }
        }
    }
    ...
    public static final SubLObject cb_show_inferred_gaf_arg_index_by_ontology_alt(SubLObject v_term, SubLObject tuple_groups) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL != tuple_groups) {
                com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_index_all_assertions_line(v_term, tuple_groups);
                html_newline(UNPROVIDED);
            }
            {
                SubLObject cdolist_list_var = tuple_groups;
                SubLObject tuples = NIL;
                for (tuples = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , tuples = cdolist_list_var.first()) {
                    {
                        SubLObject first_tuple = tuples.first();
                        SubLObject group_qua = second(first_tuple);
                        SubLObject dhtml_object_id = com.cyc.cycjava.cycl.cb_inferred_index.cb_make_inferred_gaf_arg_index_tuples_object_id(group_qua, UNPROVIDED);
                        html_markup(html_macros.$html_no_break_head$.getGlobalValue());
                        dhtml_macros.dhtml_switch_visibility_links_arrows(dhtml_object_id, $str_alt68$);
                        html_markup(html_macros.$html_small_head$.getGlobalValue());
                        html_princ($str_alt69$via_);
                        html_markup(html_macros.$html_small_tail$.getGlobalValue());
                        cb_link($INFERRED_GAF_ARG_ASSERTIONS, v_term, group_qua, group_qua, UNPROVIDED, UNPROVIDED);
                        {
                            SubLObject count = num_inferred_gaf_arg_index_tuples(tuples);
                            html_indent(TWO_INTEGER);
                            com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_index_count(count, $int$100);
                        }
                        html_markup(html_macros.$html_no_break_tail$.getGlobalValue());
                        html_newline(UNPROVIDED);
                        ...
                        html_char(CHAR_greater, UNPROVIDED);
                        {
                            ...
                            try {
                                html_macros.$html_safe_print$.bind(T, thread);
                                {
                                    SubLObject cdolist_list_var_8 = tuples;
                                    SubLObject tuple = NIL;
                                    for (tuple = cdolist_list_var_8.first(); NIL != cdolist_list_var_8; cdolist_list_var_8 = cdolist_list_var_8.rest() , tuple = cdolist_list_var_8.first()) {
                                        {
                                            ...
                                            if (NIL == current) {
                                                ...
                                                if (!argnum.numE(ONE_INTEGER)) {
                                                    format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt73$_arg_S, argnum);
                                                }
                                                {
                                                    SubLObject count = num_inferred_gaf_arg_index_tuple(tuple);
                                                    html_indent(TWO_INTEGER);
                                                    com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_index_count(count, $int$100);
                                                }
                                                {
                                                    SubLObject literal_queryP = com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_index_literal_query_linkP(v_term, argnum, pred);
    ...
    public static final SubLObject cb_show_inferred_gaf_arg_index_by_predicate_alt(SubLObject v_term, SubLObject tuple_groups) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL != tuple_groups) {
                com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_index_all_assertions_line(v_term, tuple_groups);
            ...
            }
            {
                ...
                for (tuples = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , tuples = cdolist_list_var.first()) {
                    {
                        SubLObject first_tuple = tuples.first();
                        SubLObject first_qua = second(first_tuple);
                        SubLObject group_pred = fourth(first_tuple);
                        SubLObject group_argnum = third(first_tuple);
                        SubLObject dhtml_object_id = com.cyc.cycjava.cycl.cb_inferred_index.cb_make_inferred_gaf_arg_index_tuples_object_id(group_pred, group_argnum);
                        SubLObject only_selfP = makeBoolean((NIL != list_utilities.singletonP(tuples)) && v_term.equal(first_qua));
                        if (NIL != only_selfP) {
                        ...
                        {
                            SubLObject size = cb_term_font_size(group_pred, UNPROVIDED, UNPROVIDED);
                            html_markup(html_macros.$html_no_break_head$.getGlobalValue());
                            {
                                SubLObject size_val = size;
                                html_markup(html_macros.$html_font_head$.getGlobalValue());
                            ...
                            if (!group_argnum.numE(ONE_INTEGER)) {
                                format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt73$_arg_S, group_argnum);
                            }
                            {
                                SubLObject count = num_inferred_gaf_arg_index_tuples(tuples);
                                html_indent(TWO_INTEGER);
                            ...
                            {
                                SubLObject literal_queryP = makeBoolean((NIL == only_selfP) || (NIL != com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_index_literal_query_linkP(v_term, group_argnum, group_pred)));
                                if (NIL != literal_queryP) {
                                    html_indent(UNPROVIDED);
                        ...
                        if (!((NIL != list_utilities.singletonP(tuples)) && v_term.equal(first_qua))) {
                            ...
                            html_char(CHAR_greater, UNPROVIDED);
                            {
                                ...
                                try {
                                    html_macros.$html_safe_print$.bind(T, thread);
                                    {
                                        SubLObject cdolist_list_var_9 = tuples;
                                        SubLObject tuple = NIL;
                                        for (tuple = cdolist_list_var_9.first(); NIL != cdolist_list_var_9; cdolist_list_var_9 = cdolist_list_var_9.rest() , tuple = cdolist_list_var_9.first()) {
                                            {
                                                SubLObject datum = tuple;
                                                SubLObject current = datum;
                                                SubLObject infer_pred = NIL;
    ...
    public static final SubLObject cb_show_inferred_gaf_arg_index_all_assertions_line_alt(SubLObject v_term, SubLObject tuple_groups) {
        cb_link($INFERRED_GAF_ARG_ASSERTIONS, v_term, $$$All_Assertions, UNPROVIDED, UNPROVIDED, UNPROVIDED);
        {
            SubLObject count = num_inferred_gaf_arg_index_tuple_groups(tuple_groups);
            html_indent(TWO_INTEGER);
            com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_index_count(count, $int$1000);
        }
        html_indent(FOUR_INTEGER);
    ...
    public static final SubLObject cb_show_inferred_index_count_alt(SubLObject count, SubLObject warning_limit) {
        ...
        }
        {
            ...
            if (!ONE_INTEGER.numE(count)) {
                html_markup(html_macros.$html_small_head$.getGlobalValue());
                html_markup(html_macros.$html_italic_head$.getGlobalValue());
                format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt79$__A_, count);
                html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                if ((NIL != warning_limit) && count.numG(warning_limit)) {
                    ...
                    html_char(CHAR_quotation, UNPROVIDED);
                    html_style_background_color($RED);
                    html_char(CHAR_quotation, UNPROVIDED);
                    html_char(CHAR_greater, UNPROVIDED);
                    {
                        SubLObject _prev_bind_0 = html_macros.$html_safe_print$.currentBinding(thread);
    ...
    public static final SubLObject cb_make_inferred_gaf_arg_index_tuples_object_id_alt(SubLObject v_term, SubLObject argnum) {
        if (argnum == UNPROVIDED) {
            argnum = NIL;
        }
        {
            SubLObject id = cb_term_identifier(v_term);
            return cconcatenate($str_alt83$igai_, new SubLObject[]{ format_nil.format_nil_a_no_copy(id), format_nil.format_nil_a_no_copy(NIL != argnum ? ((SubLObject) (argnum)) : $str_alt68$) });
        }
    }
    ...
    public static final SubLObject cb_link_literal_query_alt(SubLObject v_term, SubLObject argnum, SubLObject pred, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                ...
                cyc_cgi_url_int();
                if (NIL != mt) {
                    format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt85$cb_lq__A__A__A__A, new SubLObject[]{ cb_fort_identifier(v_term), argnum, cb_fort_identifier(pred), cb_fort_identifier(mt) });
                } else {
                    format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt86$cb_lq__A__A__A, new SubLObject[]{ cb_fort_identifier(v_term), argnum, cb_fort_identifier(pred) });
                }
                html_char(CHAR_quotation, UNPROVIDED);
                if (NIL != frame_name_var) {
                    html_markup(html_macros.$html_anchor_target$.getGlobalValue());
                ...
                html_char(CHAR_greater, UNPROVIDED);
                {
                    ...
                    try {
                        html_macros.$html_safe_print$.bind(T, thread);
                        {
                            SubLObject image_src = cb_icon_file_path($PLUS_GREEN);
                            SubLObject align = $TOP;
                            SubLObject alt = cb_get_icon_alt_string($PLUS_GREEN);
    ...
    public static final SubLObject cb_show_inferred_index_literal_query_linkP_alt(SubLObject v_term, SubLObject argnum, SubLObject pred) {
    ...
    public static final SubLObject cb_inferred_index_order_by_alt(SubLObject args) {
        {
            SubLObject datum = args;
            SubLObject current = datum;
            SubLObject index_id = NIL;
            ...
            if (NIL == current) {
                {
                    ...
                    {
                        SubLObject order_by = make_keyword(order_by_string);
    ...
    public static final SubLObject cb_link_inferred_index_order_by_alt(SubLObject v_term, SubLObject order_by, SubLObject linktext) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject index_id = cb_index_identifier(v_term);
                ...
                html_char(CHAR_quotation, UNPROVIDED);
                cyc_cgi_url_int();
                format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt91$cb_inferred_index_order_by__A__A, index_id, order_by);
                html_char(CHAR_quotation, UNPROVIDED);
                if (NIL != frame_name_var) {
                    html_markup(html_macros.$html_anchor_target$.getGlobalValue());
                    html_char(CHAR_quotation, UNPROVIDED);
    ...
    public static final SubLObject cb_inferred_index_visibility_alt(SubLObject args) {
        {
            SubLObject datum = args;
            SubLObject current = datum;
            SubLObject index_id = NIL;
            ...
            if (NIL == current) {
                {
                    SubLObject index_hook = cb_guess_index(index_id);
                    SubLObject visibility = read_from_string_ignoring_errors(visibility_string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                    if (NIL == index_hook) {
                        return cb_error($str_alt6$Unable_to_determine_a_term_from__, index_id, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                    }
    ...
    public static final SubLObject cb_link_inferred_index_toggle_visibility_alt(SubLObject v_term) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject index_id = cb_index_identifier(v_term);
                SubLObject toggled_visibility = ($cb_inferred_index_visibility$.getDynamicValue(thread) == $VISIBLE) ? ((SubLObject) ($INVISIBLE)) : $VISIBLE;
                SubLObject linktext = ($cb_inferred_index_visibility$.getDynamicValue(thread) == $VISIBLE) ? ((SubLObject) ($$$close_all)) : $$$open_all;
                SubLObject icon = ($cb_inferred_index_visibility$.getDynamicValue(thread) == $VISIBLE) ? ((SubLObject) ($DOWN_TRIANGLE_V)) : $RIGHT_TRIANGLE_V;
                SubLObject frame_name_var = cb_frame_name($SELF);
                html_markup(html_macros.$html_anchor_head$.getGlobalValue());
                html_markup(html_macros.$html_anchor_href$.getGlobalValue());
                html_char(CHAR_quotation, UNPROVIDED);
                cyc_cgi_url_int();
                format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt100$cb_inferred_index_visibility__A__, index_id, toggled_visibility);
                html_char(CHAR_quotation, UNPROVIDED);
                if (NIL != frame_name_var) {
                    html_markup(html_macros.$html_anchor_target$.getGlobalValue());
                    html_char(CHAR_quotation, UNPROVIDED);
                ...
                html_char(CHAR_greater, UNPROVIDED);
                {
                    ...
                    try {
                        ...
                        html_markup(html_macros.$html_small_head$.getGlobalValue());
                        {
                            SubLObject image_src = cconcatenate(system_parameters.$html_image_directory$.getDynamicValue(thread), html_icon_src(icon));
                            SubLObject align = (true) ? ((SubLObject) ($TOP)) : $CENTER;
                            SubLObject alt = get_html_icon_alt_string(icon);
    ...
    public static final SubLObject cb_inferred_index_predicate_filters_alt(SubLObject args) {
        {
            SubLObject datum = args;
            SubLObject current = datum;
            ...
            if (NIL == current) {
                {
                    SubLObject v_term = cb_guess_term(id_string, UNPROVIDED);
                    if (NIL == indexed_term_p(v_term)) {
                        return cb_error($str_alt104$_S_did_not_specify_a_term, id_string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                    }
                    return com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_index_predicate_filters_guts(v_term);
                }
            } else {
    ...
    public static final SubLObject cb_link_inferred_index_predicate_filters_alt(SubLObject v_term, SubLObject linktext) {
        ...
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL == linktext) {
                linktext = $str_alt106$_Predicate_Filters_;
            }
            {
                SubLObject id = cb_term_identifier(v_term);
                SubLObject frame_name_var = cb_frame_name($CONTENT);
                ...
                html_char(CHAR_quotation, UNPROVIDED);
                cyc_cgi_url_int();
                format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt107$cb_inferred_index_predicate_filte, id);
                html_char(CHAR_quotation, UNPROVIDED);
                if (NIL != frame_name_var) {
                    html_markup(html_macros.$html_anchor_target$.getGlobalValue());
                    html_char(CHAR_quotation, UNPROVIDED);
    ...
    public static final SubLObject cb_inferred_index_predicate_filters_guts_alt(SubLObject v_term) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject title = $$$Inferred_Index_Predicate_Filters;
                html_markup(html_macros.$html_html_head$.getGlobalValue());
                html_markup(html_macros.$html_head_head$.getGlobalValue());
                html_macros.html_head_content_type();
                cb_head_shortcut_icon();
                                ...
                                html_macros.$html_safe_print$.bind(T, thread);
                                {
                                    ...
                                    html_char(CHAR_greater, UNPROVIDED);
                                    {
                                        ...
                                        try {
                                            ...
                                            html_hidden_input($str_alt110$cb_handle_inferred_index_predicat, T, UNPROVIDED);
                                            {
                                                SubLObject size_val = FIVE_INTEGER;
                                                html_markup(html_macros.$html_font_head$.getGlobalValue());
                                                if (NIL != size_val) {
                                                ...
                                                html_newline(UNPROVIDED);
                                                html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                html_princ($str_alt111$relevant_to_);
                                                html_indent(UNPROVIDED);
                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                html_markup(html_macros.$html_strong_head$.getGlobalValue());
                                            ...
                                            html_newline(TWO_INTEGER);
                                            {
                                                SubLObject datum = $cb_inferred_index_filters$.getDynamicValue(thread);
                                                SubLObject current = datum;
                                                ...
                                                SubLObject term_predicates = all_inferred_gaf_arg_index_predicates(v_term);
                                                thread.resetMultipleValues();
                                                {
                                                    SubLObject term_allow_predicates = categorize_via_pred_filters(term_predicates, $cb_inferred_index_filters$.getDynamicValue(thread));
                                                                    ...
                                                                    html_char(CHAR_greater, UNPROVIDED);
                                                                    {
                                                                        ...
                                                                        try {
                                                                            html_macros.$html_safe_print$.bind(T, thread);
                                                                            {
                                                                                ...
                                                                                if (NIL != allow_predicate_types) {
                                                                                    ...
                                                                                    html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                    {
                                                                                        ...
                                                                                        for (type = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , type = cdolist_list_var.first()) {
                                                                                            html_newline(UNPROVIDED);
                                                                                            com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_index_predicate_type_filter_remove_allow_checkbox(type);
                                                                                            html_indent(UNPROVIDED);
                                                                                ...
                                                                                html_newline(UNPROVIDED);
                                                                                html_princ($str_alt124$add_);
                                                                                html_text_input($str_alt125$type_allow, $str_alt68$, $int$30);
                                                                                html_indent(ONE_INTEGER);
                                                                                html_complete.html_complete_button($str_alt125$type_allow, $$$Complete, $$Collection, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                                html_newline(TWO_INTEGER);
                                                                            }
                                                                        } finally {
                                                                            ...
                                                                            html_macros.$html_safe_print$.bind(T, thread);
                                                                            {
                                                                                ...
                                                                                if (NIL != forbid_predicate_types) {
                                                                                    ...
                                                                                    html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                    {
                                                                                        ...
                                                                                        for (type = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , type = cdolist_list_var.first()) {
                                                                                            html_newline(UNPROVIDED);
                                                                                            com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_index_predicate_type_filter_remove_forbid_checkbox(type);
                                                                                            html_indent(UNPROVIDED);
                                                                                            cb_form(type, UNPROVIDED, UNPROVIDED);
                                                                                        }
                                                                                    }
                                                                                ...
                                                                                html_newline(UNPROVIDED);
                                                                                html_princ($str_alt124$add_);
                                                                                html_text_input($str_alt130$type_forbid, $str_alt68$, $int$30);
                                                                                html_indent(ONE_INTEGER);
                                                                                html_complete.html_complete_button($str_alt130$type_forbid, $$$Complete, $$Collection, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                                html_newline(TWO_INTEGER);
                                                                            }
                                                                        } finally {
                                                                                ...
                                                                                if (NIL != term_allow_predicates) {
                                                                                    ...
                                                                                    html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                    {
                                                                                        ...
                                                                                        for (predicate = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , predicate = cdolist_list_var.first()) {
                                                                                            html_newline(UNPROVIDED);
                                                                                            com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_index_predicate_filter_forbid_checkbox(predicate);
                                                                                            html_indent(UNPROVIDED);
                                                                            ...
                                                                            html_macros.$html_safe_print$.bind(T, thread);
                                                                            {
                                                                                ...
                                                                                if (NIL != term_forbid_predicates) {
                                                                                    ...
                                                                                    html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                    {
                                                                                        ...
                                                                                        for (predicate = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , predicate = cdolist_list_var.first()) {
                                                                                            html_newline(UNPROVIDED);
                                                                                            com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_index_predicate_filter_allow_checkbox(predicate);
                                                                                            html_indent(UNPROVIDED);
                                                                                            cb_form(predicate, UNPROVIDED, UNPROVIDED);
                                                                                        }
                                                                                    }
    ...
    public static final SubLObject cb_inferred_index_predicate_type_filter_remove_allow_checkbox_alt(SubLObject type) {
        return html_checkbox_input(cconcatenate($str_alt136$remove_type_allow_, format_nil.format_nil_a_no_copy(cb_term_identifier(type))), $$$T, NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED);
    }
    ...
    public static final SubLObject cb_inferred_index_predicate_type_filter_remove_forbid_checkbox_alt(SubLObject type) {
        return html_checkbox_input(cconcatenate($str_alt138$remove_type_forbid_, format_nil.format_nil_a_no_copy(cb_term_identifier(type))), $$$T, NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED);
    }
    ...
    public static final SubLObject cb_inferred_index_predicate_filter_forbid_checkbox_alt(SubLObject predicate) {
        return html_checkbox_input(cconcatenate($str_alt139$forbid_, format_nil.format_nil_a_no_copy(cb_term_identifier(predicate))), $$$T, NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED);
    }
    ...
    public static final SubLObject cb_inferred_index_predicate_filter_allow_checkbox_alt(SubLObject predicate) {
        return html_checkbox_input(cconcatenate($str_alt140$allow_, format_nil.format_nil_a_no_copy(cb_term_identifier(predicate))), $$$T, NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED);
    }
    ...
    public static final SubLObject cb_handle_inferred_index_predicate_filters_alt(SubLObject args) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject term_string = html_extract_input($$$term, args);
                SubLObject v_term = cb_guess_term(term_string, UNPROVIDED);
                if (NIL != html_extract_input($$$clear, args)) {
                    com.cyc.cycjava.cycl.cb_inferred_index.cb_clear_inferred_index_predicate_filters();
                } else {
                    thread.resetMultipleValues();
                    {
                        SubLObject new_type_allow = com.cyc.cycjava.cycl.cb_inferred_index.cb_extract_inferred_index_predicate_filters(args);
                        SubLObject type_allows_to_remove = thread.secondMultipleValue();
                        SubLObject new_type_forbid = thread.thirdMultipleValue();
                        SubLObject type_forbids_to_remove = thread.fourthMultipleValue();
                        SubLObject new_predicates_to_allow = thread.fifthMultipleValue();
                        SubLObject new_predicates_to_forbid = thread.sixthMultipleValue();
                        thread.resetMultipleValues();
                        com.cyc.cycjava.cycl.cb_inferred_index.cb_update_inferred_index_predicate_filters(new_type_allow, type_allows_to_remove, new_type_forbid, type_forbids_to_remove, new_predicates_to_allow, new_predicates_to_forbid);
                    }
                }
                return com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_index_predicate_filters_guts(v_term);
            }
    ...
    public static final SubLObject cb_extract_inferred_index_predicate_filters_alt(SubLObject args) {
        {
            ...
            SubLObject type_allow_string = html_extract_input($str_alt125$type_allow, args);
            if (NIL == string_utilities.empty_string_p(type_allow_string)) {
                {
                    SubLObject v_term = cb_guess_term(type_allow_string, UNPROVIDED);
                    if (NIL != v_term) {
            ...
            {
                SubLObject type_forbid_string = html_extract_input($str_alt130$type_forbid, args);
                if (NIL == string_utilities.empty_string_p(type_forbid_string)) {
                    {
                        SubLObject v_term = cb_guess_term(type_forbid_string, UNPROVIDED);
                        if (NIL != v_term) {
                            new_type_forbid = v_term;
                        }
                    }
                }
            }
                    ...
                    if (arg.isCons()) {
                        {
                            ...
                            current = current.rest();
                            if (NIL == current) {
                                if (NIL != string_utilities.starts_with(name, $str_alt139$forbid_)) {
                                    {
                                        SubLObject id_string = string_utilities.substring(name, SEVEN_INTEGER, UNPROVIDED);
                                        SubLObject v_term = cb_guess_term(id_string, UNPROVIDED);
                                    ...
                                    if (NIL != string_utilities.starts_with(name, $str_alt140$allow_)) {
                                        {
                                            SubLObject id_string = string_utilities.substring(name, SIX_INTEGER, UNPROVIDED);
                                            SubLObject v_term = cb_guess_term(id_string, UNPROVIDED);
                                            SubLObject var = v_term;
                                            if (NIL != var) {
                                        ...
                                        if (NIL != string_utilities.starts_with(name, $str_alt138$remove_type_forbid_)) {
                                            {
                                                SubLObject id_string = string_utilities.substring(name, NINETEEN_INTEGER, UNPROVIDED);
                                                SubLObject v_term = cb_guess_term(id_string, UNPROVIDED);
                                                SubLObject var = v_term;
                                                if (NIL != var) {
                                            ...
                                            if (NIL != string_utilities.starts_with(name, $str_alt136$remove_type_allow_)) {
                                                {
                                                    SubLObject id_string = string_utilities.substring(name, EIGHTEEN_INTEGER, UNPROVIDED);
                                                    SubLObject v_term = cb_guess_term(id_string, UNPROVIDED);
                                                    SubLObject var = v_term;
                                                    if (NIL != var) {
    ...
    public static final SubLObject cb_clear_inferred_index_predicate_filters_alt() {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    public static final SubLObject cb_update_inferred_index_predicate_filters_alt(SubLObject new_type_allow, SubLObject type_allows_to_remove, SubLObject new_type_forbid, SubLObject type_forbids_to_remove, SubLObject new_predicates_to_allow, SubLObject new_predicates_to_forbid) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            ...
            if ((NIL != new_type_forbid) || (NIL != type_forbids_to_remove)) {
                {
                    ...
                    SubLObject var = new_type_forbid;
                    if (NIL != var) {
                        {
                            SubLObject item_var = var;
                            if (NIL == member(item_var, types, symbol_function(EQL), symbol_function(IDENTITY))) {
            ...
            if ((NIL != new_predicates_to_allow) || (NIL != new_predicates_to_forbid)) {
                {
                    ...
                    {
                        SubLObject cdolist_list_var = new_predicates_to_forbid;
                        SubLObject pred = NIL;
                        for (pred = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , pred = cdolist_list_var.first()) {
    ...
    public static final SubLObject cb_inferred_index_ontology_filters_alt(SubLObject args) {
        {
            SubLObject datum = args;
            SubLObject current = datum;
            SubLObject id_string = NIL;
            ...
            if (NIL == current) {
                {
                    ...
                    return com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_index_ontology_filters_guts(v_term);
                }
            } else {
                cdestructuring_bind_error(datum, $list_alt103);
            }
    ...
    public static final SubLObject cb_link_inferred_index_ontology_filters_alt(SubLObject v_term, SubLObject linktext) {
        if (v_term == UNPROVIDED) {
            v_term = NIL;
        }
        if (linktext == UNPROVIDED) {
        ...
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL == linktext) {
                linktext = $str_alt144$_Ontology_Filters_;
            }
            {
                SubLObject id = cb_term_identifier(v_term);
                SubLObject frame_name_var = cb_frame_name($CONTENT);
                ...
                html_char(CHAR_quotation, UNPROVIDED);
                cyc_cgi_url_int();
                format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt145$cb_inferred_index_ontology_filter, id);
                html_char(CHAR_quotation, UNPROVIDED);
                if (NIL != frame_name_var) {
                    html_markup(html_macros.$html_anchor_target$.getGlobalValue());
                    html_char(CHAR_quotation, UNPROVIDED);
    ...
    public static final SubLObject cb_inferred_index_ontology_filters_guts_alt(SubLObject v_term) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject title = $$$Inferred_Index_Ontology_Filters;
                html_markup(html_macros.$html_html_head$.getGlobalValue());
                html_markup(html_macros.$html_head_head$.getGlobalValue());
                html_macros.html_head_content_type();
                cb_head_shortcut_icon();
                                ...
                                html_macros.$html_safe_print$.bind(T, thread);
                                {
                                    ...
                                    html_char(CHAR_greater, UNPROVIDED);
                                    {
                                        ...
                                        try {
                                            ...
                                            html_macros.$within_html_form$.bind(T, thread);
                                            html_macros.$html_form_field_uniquifier_code$.bind(html_macros.next_html_form_field_uniquifier_code(), thread);
                                            html_hidden_input($str_alt148$cb_handle_inferred_index_ontology, T, UNPROVIDED);
                                            {
                                                SubLObject size_val = FIVE_INTEGER;
                                                html_markup(html_macros.$html_font_head$.getGlobalValue());
                                                if (NIL != size_val) {
                                            ...
                                            html_newline(TWO_INTEGER);
                                            {
                                                ...
                                                SubLObject ontology_terms = all_inferred_gaf_arg_index_ontology_terms(v_term);
                                                html_hidden_input($$$term, cb_term_identifier(v_term), UNPROVIDED);
                                                {
                                                    SubLObject size_val = FIVE_INTEGER;
                                                    html_markup(html_macros.$html_font_head$.getGlobalValue());
                                                ...
                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                {
                                                    SubLObject cdolist_list_var = $list_alt152;
                                                    SubLObject qua = NIL;
                                                    for (qua = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , qua = cdolist_list_var.first()) {
                                                        html_newline(UNPROVIDED);
                                                        com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_index_ontology_horizon_radio_button(qua, ontology_horizon);
                                                        html_indent(UNPROVIDED);
                                                        com.cyc.cycjava.cycl.cb_inferred_index.cb_show_ontology_horizon_term(qua);
                                                    }
                                                }
                                                html_newline(TWO_INTEGER);
                                                html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                ...
                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                {
                                                    SubLObject cdolist_list_var = ontology_terms;
                                                    SubLObject qua = NIL;
                                                    for (qua = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , qua = cdolist_list_var.first()) {
                                                        if (!qua.equal(v_term)) {
                                                            html_newline(UNPROVIDED);
    ...
    public static final SubLObject cb_inferred_index_ontology_horizon_radio_button_alt(SubLObject qua, SubLObject ontology_horizon) {
        {
            SubLObject checkedP = makeBoolean(((NIL == ontology_horizon) && (qua == $ALL)) || (qua == ontology_horizon));
            SubLObject value = (NIL != fort_p(qua)) ? ((SubLObject) (cb_fort_identifier(qua))) : prin1_to_string(qua);
            return html_radio_input($str_alt155$ontology_horizon, value, checkedP);
        }
    }
    ...
    public static final SubLObject cb_handle_inferred_index_ontology_filters_alt(SubLObject args) {
        {
            SubLObject term_string = html_extract_input($$$term, args);
            SubLObject v_term = cb_guess_term(term_string, UNPROVIDED);
            SubLObject ontology_horizon = com.cyc.cycjava.cycl.cb_inferred_index.cb_extract_inferred_index_ontology_horizon(args);
            com.cyc.cycjava.cycl.cb_inferred_index.cb_update_inferred_index_ontology_filters(ontology_horizon);
            return com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_index_ontology_filters_guts(v_term);
        }
    }
    ...
    public static final SubLObject cb_show_ontology_horizon_term_alt(SubLObject qua) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject pcase_var = qua;
                if (pcase_var.eql($SELF)) {
                    ...
                    if (pcase_var.eql($LOWER)) {
                        ...
                        if (pcase_var.eql($MIDDLE)) {
                            html_princ($str_alt161$Also_up_through_the_middle_ontolo);
                        } else {
                            if (pcase_var.eql($ALL)) {
                                html_princ($$$Everything);
                            } else {
                                {
                                    SubLObject size = cb_term_font_size(qua, UNPROVIDED, UNPROVIDED);
                                    SubLObject size_val = size;
                                    html_markup(html_macros.$html_font_head$.getGlobalValue());
                                    if (NIL != size_val) {
                                        html_markup(html_macros.$html_font_size$.getGlobalValue());
                                    ...
                                    html_char(CHAR_greater, UNPROVIDED);
                                    {
                                        ...
                                        try {
                                            html_macros.$html_safe_print$.bind(T, thread);
                                            cb_form(qua, UNPROVIDED, UNPROVIDED);
                                        } finally {
                                            html_macros.$html_safe_print$.rebind(_prev_bind_0, thread);
                                        }
                                    }
    ...
    public static final SubLObject cb_extract_inferred_index_ontology_horizon_alt(SubLObject args) {
        {
            SubLObject identifier_string = html_extract_input($str_alt155$ontology_horizon, args);
            SubLObject fort = cb_guess_fort(identifier_string, UNPROVIDED);
            if (NIL != fort_p(fort)) {
                return fort;
            }
    ...
    public static final SubLObject cb_update_inferred_index_ontology_filters_alt(SubLObject ontology_horizon) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    public static final SubLObject cb_link_inferred_gaf_arg_assertions_alt(SubLObject v_term, SubLObject display_term, SubLObject qua, SubLObject argnum, SubLObject pred) {
        if (qua == UNPROVIDED) {
            qua = NIL;
        }
        if (argnum == UNPROVIDED) {
        ...
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject display_string = cb_term_display_string(display_term);
                SubLObject size = cb_term_font_size(display_term, UNPROVIDED, UNPROVIDED);
                SubLObject frame_name_var = cb_frame_name($CONTENT);
                html_markup(html_macros.$html_anchor_head$.getGlobalValue());
                html_markup(html_macros.$html_anchor_href$.getGlobalValue());
                html_char(CHAR_quotation, UNPROVIDED);
                ...
                if (((NIL != qua) && (NIL != argnum)) && (NIL != pred)) {
                    format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt163$cb_inferred_gaf_arg_assertions__A, new SubLObject[]{ cb_index_identifier(v_term), cb_index_identifier(qua), argnum, cb_index_identifier(pred) });
                } else {
                    if (((NIL == qua) && (NIL != argnum)) && (NIL != pred)) {
                        format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt163$cb_inferred_gaf_arg_assertions__A, new SubLObject[]{ cb_index_identifier(v_term), NIL, argnum, cb_index_identifier(pred) });
                    } else {
                        if (((NIL != qua) && (NIL == argnum)) && (NIL == pred)) {
                            format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt164$cb_inferred_gaf_arg_assertions__A, cb_index_identifier(v_term), cb_index_identifier(qua));
                        } else {
                            if (!(((NIL != qua) || (NIL != argnum)) || (NIL != pred))) {
                                format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt165$cb_inferred_gaf_arg_assertions__A, cb_index_identifier(v_term));
                            }
                        }
                    }
                }
    ...
    public static final SubLObject cb_inferred_gaf_arg_assertions_alt(SubLObject args) {
        {
            SubLObject datum = args;
            SubLObject current = datum;
            ...
            current = current.rest();
            {
                SubLObject qua_spec = (current.isCons()) ? ((SubLObject) (current.first())) : NIL;
                destructuring_bind_must_listp(current, datum, $list_alt167);
                current = current.rest();
                {
                    SubLObject argnum_spec = (current.isCons()) ? ((SubLObject) (current.first())) : NIL;
                    destructuring_bind_must_listp(current, datum, $list_alt167);
                    current = current.rest();
                    {
                        ...
                        if (NIL == current) {
                            {
                                ...
                                if (NIL == indexed_term_p(v_term)) {
                                    return cb_error($str_alt168$Could_not_determine_a_term_from__, term_spec, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                }
                                if ((NIL != qua_spec) && (!$$$NIL.equal(qua_spec))) {
                                    qua = cb_guess_index(qua_spec);
                                    if (NIL == indexed_term_p(qua)) {
                                        return cb_error($str_alt168$Could_not_determine_a_term_from__, qua_spec, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                    }
                                }
                                if (NIL != argnum_spec) {
                                    argnum = read_from_string_ignoring_errors(argnum_spec, NIL, NIL, UNPROVIDED, UNPROVIDED);
                                    if (!argnum.isInteger()) {
                                        return cb_error($str_alt170$Could_not_determine_an_argnum_fro, argnum_spec, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                    }
                                }
                                if (NIL != pred_spec) {
                                    predicate = cb_guess_fort(pred_spec, UNPROVIDED);
                                    if (NIL == fort_p(predicate)) {
                                        return cb_error($str_alt168$Could_not_determine_a_term_from__, pred_spec, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                    }
                                }
                                return com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_gaf_arg_assertions_guts(v_term, qua, argnum, predicate);
                            }
                        } else {
    ...
    public static final SubLObject cb_inferred_gaf_arg_assertions_guts_alt(SubLObject v_term, SubLObject qua, SubLObject argnum, SubLObject predicate) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject filters = $cb_inferred_index_filters$.getDynamicValue(thread);
                SubLObject order_by = $cb_inferred_index_order_by$.getDynamicValue(thread);
                SubLObject raw_tuples = all_inferred_gaf_arg_index_tuples(v_term, filters, order_by);
                SubLObject filtered_tuples = com.cyc.cycjava.cycl.cb_inferred_index.filter_gaf_arg_index_tuples(raw_tuples, qua, argnum, predicate);
                SubLObject tuple_groups = categorize_inferred_gaf_arg_index_tuples(v_term, filtered_tuples, order_by);
                SubLObject title = format(NIL, $str_alt172$Inferred_GAF_arg_index_for__S, v_term);
                        ...
                        html_source_readability_terpri(UNPROVIDED);
                        {
                            ...
                            try {
                                ...
                                if (true) {
                                    ...
                                    html_char(CHAR_quotation, UNPROVIDED);
                                    html_markup($str_alt173$yui_skin_sam);
                                    html_char(CHAR_quotation, UNPROVIDED);
                                }
                                html_char(CHAR_greater, UNPROVIDED);
                                {
                                    ...
                                    try {
                                        ...
                                        com.cyc.cycjava.cycl.cb_inferred_index.cb_term_type_header_with_gaf_entry(v_term, UNPROVIDED);
                                        {
                                            SubLObject pcase_var = order_by;
                                            if (pcase_var.eql($ONTOLOGY)) {
                                                com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_assertions_by_ontology(v_term, tuple_groups);
                                            } else {
                                                if (pcase_var.eql($PREDICATE)) {
                                                    com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_assertions_by_predicate(v_term, tuple_groups);
                                                } else {
                                                    cb_error($str_alt67$Unexpected_order_by____S, order_by, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                }
                                            }
                                        }
                                        html_source_readability_terpri(UNPROVIDED);
    ...
    public static final SubLObject cb_show_inferred_gaf_arg_assertions_by_ontology_alt(SubLObject v_term, SubLObject tuple_groups) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject _prev_bind_0 = cb_browser.$cb_c_gaf_arg_show_arg_headerP$.currentBinding(thread);
                SubLObject _prev_bind_1 = cb_browser.$cb_c_gaf_arg_show_mt_headerP$.currentBinding(thread);
                try {
                    cb_browser.$cb_c_gaf_arg_show_arg_headerP$.bind(NIL, thread);
                    cb_browser.$cb_c_gaf_arg_show_mt_headerP$.bind(NIL, thread);
                    {
                        SubLObject list_var = NIL;
                        SubLObject tuples = NIL;
                        SubLObject index = NIL;
                        for (list_var = tuple_groups, tuples = list_var.first(), index = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest() , tuples = list_var.first() , index = add(ONE_INTEGER, index)) {
                            if (!index.isZero()) {
                                html_newline(UNPROVIDED);
                            }
                            {
                                SubLObject first_tuple = tuples.first();
                                SubLObject infer_pred = first_tuple.first();
                                SubLObject group_qua = second(first_tuple);
                                com.cyc.cycjava.cycl.cb_inferred_index.cb_show_qua_justification(infer_pred, v_term, group_qua);
                                html_newline(TWO_INTEGER);
                                {
                                    ...
                                    for (tuple = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , tuple = cdolist_list_var.first()) {
                                        {
                                            SubLObject datum = tuple;
                                            SubLObject current = datum;
                                            SubLObject infer_pred_37 = NIL;
                                            SubLObject qua = NIL;
                                            SubLObject argnum = NIL;
                                            SubLObject pred = NIL;
                                            destructuring_bind_must_consp(current, datum, $list_alt72);
                                            infer_pred_37 = current.first();
                                            current = current.rest();
                                            destructuring_bind_must_consp(current, datum, $list_alt72);
                                            qua = current.first();
                                            current = current.rest();
                                            ...
                                            current = current.rest();
                                            if (NIL == current) {
                                                com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_index_assertions_final(v_term, infer_pred_37, qua, argnum, pred);
                                            } else {
                                                cdestructuring_bind_error(datum, $list_alt72);
                                            }
                                        }
                    ...
                    cb_browser.$cb_c_gaf_arg_show_mt_headerP$.rebind(_prev_bind_1, thread);
    ...
    public static final SubLObject cb_show_inferred_gaf_arg_assertions_by_predicate_alt(SubLObject v_term, SubLObject tuple_groups) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject _prev_bind_0 = cb_browser.$cb_c_gaf_arg_show_arg_headerP$.currentBinding(thread);
                ...
                try {
                    ...
                    cb_browser.$cb_c_gaf_arg_show_mt_headerP$.bind(NIL, thread);
                    {
                        SubLObject ontology_horizon = getf($cb_inferred_index_filters$.getDynamicValue(thread), $ONTOLOGY_HORIZON, UNPROVIDED);
                        SubLObject list_var = NIL;
                        SubLObject tuples = NIL;
                        SubLObject index = NIL;
                        for (list_var = tuple_groups, tuples = list_var.first(), index = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest() , tuples = list_var.first() , index = add(ONE_INTEGER, index)) {
                            {
                                ...
                                for (list_var_38 = tuples, tuple = list_var_38.first(), tuple_index = ZERO_INTEGER; NIL != list_var_38; list_var_38 = list_var_38.rest() , tuple = list_var_38.first() , tuple_index = add(ONE_INTEGER, tuple_index)) {
                                    {
                                        SubLObject datum = tuple;
                                        SubLObject current = datum;
                                        SubLObject infer_pred = NIL;
                                        ...
                                        if (NIL == current) {
                                            if (!qua.equal(last_qua)) {
                                                ...
                                                if ($SELF != ontology_horizon) {
                                                    com.cyc.cycjava.cycl.cb_inferred_index.cb_show_qua_justification(infer_pred, v_term, qua);
                                                    html_newline(UNPROVIDED);
                                                }
                                            }
                                            com.cyc.cycjava.cycl.cb_inferred_index.cb_show_inferred_gaf_arg_index_assertions_final(v_term, infer_pred, qua, argnum, pred);
                                            last_qua = qua;
                                        } else {
                                            cdestructuring_bind_error(datum, $list_alt72);
                                        }
    ...
    public static final SubLObject cb_show_inferred_gaf_arg_index_assertions_final_alt(SubLObject v_term, SubLObject infer_pred, SubLObject qua, SubLObject argnum, SubLObject pred) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject pcase_var = infer_pred;
                if (pcase_var.eql($QUERY_ISA)) {
                    cb_form(pred, UNPROVIDED, UNPROVIDED);
                    if (!argnum.numE(ONE_INTEGER)) {
                        format(html_macros.$html_stream$.getDynamicValue(thread), $str_alt73$_arg_S, argnum);
                    }
                    html_princ($str_alt175$_query);
                    html_indent(UNPROVIDED);
                    cb_link($LITERAL_QUERY, v_term, argnum, pred, $$EverythingPSC, UNPROVIDED);
                    html_newline(UNPROVIDED);
                } else {
    ...
    public static final SubLObject hl_support_module_for_predicate_alt(SubLObject predicate) {
    ...
    public static final SubLObject cb_show_qua_justification_alt(SubLObject infer_pred, SubLObject v_term, SubLObject qua) {
        {
            SubLObject leader = (infer_pred == $$equals) ? ((SubLObject) ($str_alt179$on_)) : $str_alt69$via_;
            html_markup(html_macros.$html_strong_head$.getGlobalValue());
            html_princ(leader);
            html_indent(UNPROVIDED);
            if (infer_pred == $$equals) {
                html_princ($$$the_term);
            } else {
                cb_form(qua, ZERO_INTEGER, NIL);
            }
            html_markup(html_macros.$html_strong_tail$.getGlobalValue());
            if (infer_pred != $$equals) {
                ...
                {
                    SubLObject sentence = make_binary_formula(infer_pred, v_term, qua);
                    SubLObject module = com.cyc.cycjava.cycl.cb_inferred_index.hl_support_module_for_predicate(infer_pred);
                    SubLObject support = arguments.make_hl_support(module, sentence, $$EverythingPSC, UNPROVIDED);
                    html_indent(UNPROVIDED);
                    html_markup(html_macros.$html_superscript_head$.getGlobalValue());
                    html_markup(html_macros.$html_small_head$.getGlobalValue());
                    cb_link($HL_SUPPORT, support, $NONE, $str_alt184$___, UNPROVIDED, UNPROVIDED);
                    html_markup(html_macros.$html_small_tail$.getGlobalValue());
    ...
    public static final SubLObject filter_gaf_arg_index_tuples_alt(SubLObject tuples, SubLObject match_qua, SubLObject match_argnum, SubLObject match_pred) {
    ...
    public static final SubLObject cb_inferred_index_definitional_information_alt(SubLObject fort) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject _prev_bind_0 = $cb_inferred_index_filters$.currentBinding(thread);
                try {
                    $cb_inferred_index_filters$.bind(com.cyc.cycjava.cycl.cb_inferred_index.inferred_index_definitional_information_override($cb_inferred_index_filters$.getDynamicValue(thread), fort), thread);
                    com.cyc.cycjava.cycl.cb_inferred_index.cb_inferred_gaf_arg_assertions_guts(fort, fort, NIL, NIL);
                } finally {
    ...
    public static final SubLObject inferred_index_definitional_information_override_alt(SubLObject filters, SubLObject fort) {
        filters = copy_list(filters);
        {
            SubLObject predicates = cb_definitional_preds_for_fort(fort);
            ...
            filters = putf(filters, $FORBID_PREDICATE_TYPES, $list_alt185);
            return filters;
        }
    }
    ...
    public static final SubLObject cb_term_type_header_with_gaf_entry_alt(SubLObject v_term, SubLObject gaf_entry_properties) {
        if (gaf_entry_properties == UNPROVIDED) {
            gaf_entry_properties = NIL;
        }
        com.cyc.cycjava.cycl.cb_inferred_index.cb_term_type_header(v_term, FIVE_INTEGER);
        if (NIL != fort_p(v_term)) {
            html_indent(UNPROVIDED);
            html_markup(html_macros.$html_superscript_head$.getGlobalValue());
            html_markup(html_macros.$html_teletype_head$.getGlobalValue());
            com.cyc.cycjava.cycl.cb_inferred_index.cb_gaf_entry_widget_links($str_alt190$gaf_entry, $str_alt191$___, $str_alt192$___);
            html_markup(html_macros.$html_teletype_tail$.getGlobalValue());
            html_markup(html_macros.$html_superscript_tail$.getGlobalValue());
            html_newline(TWO_INTEGER);
            com.cyc.cycjava.cycl.cb_inferred_index.cb_gaf_entry_widget(v_term, gaf_entry_properties);
        }
        return NIL;
    }
    ...
    public static final SubLObject cb_term_type_header_alt(SubLObject v_term, SubLObject baseline_size) {
        ...
        }
        {
            ...
            html_markup(html_macros.$html_strong_head$.getGlobalValue());
            {
                SubLObject size_val = baseline_size;
                html_markup(html_macros.$html_font_head$.getGlobalValue());
                if (NIL != size_val) {
                    html_markup(html_macros.$html_font_size$.getGlobalValue());
                    html_char(CHAR_quotation, UNPROVIDED);
            ...
            html_markup(html_macros.$html_strong_tail$.getGlobalValue());
            if (NIL != nart_p(v_term)) {
                html_newline(UNPROVIDED);
            }
            {
                SubLObject size = cb_term_font_size(v_term, baseline_size, UNPROVIDED);
                html_markup(html_macros.$html_strong_head$.getGlobalValue());
                {
                    SubLObject size_val = size;
                    html_markup(html_macros.$html_font_head$.getGlobalValue());
    ...
    public static final SubLObject cb_gaf_entry_widget_links_alt(SubLObject name, SubLObject show_text, SubLObject hide_text) {
        if (name == UNPROVIDED) {
            name = $str_alt190$gaf_entry;
        }
        if (show_text == UNPROVIDED) {
            show_text = $str_alt191$___;
        }
        if (hide_text == UNPROVIDED) {
            hide_text = $str_alt192$___;
        }
    ...
    public static final SubLObject cb_gaf_entry_widget_alt(SubLObject fort, SubLObject v_properties) {
        ...
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                ...
                for (; NIL != rest;) {
                    ...
                    rest = rest.rest();
                    destructuring_bind_must_consp(rest, datum, $list_alt194);
                    if (NIL == member(current_39, $list_alt195, UNPROVIDED, UNPROVIDED)) {
                        bad = T;
                    }
                ...
                }
                {
                    ...
                    SubLObject name = (NIL != name_tail) ? ((SubLObject) (cadr(name_tail))) : $str_alt190$gaf_entry;
                    SubLObject pred_tail = property_list_member($PRED, current);
                    SubLObject pred = (NIL != pred_tail) ? ((SubLObject) (cadr(pred_tail))) : NIL;
                    ...
                    html_char(CHAR_greater, UNPROVIDED);
                    {
                        ...
                        try {
                            html_macros.$html_safe_print$.bind(T, thread);
                            dhtml_macros.dhtml_set_switched_visibility($str_alt202$unary_frame, $INVISIBLE, $PARAGRAPH);
                            html_markup(html_macros.$html_div_head$.getGlobalValue());
                            if (true) {
                                html_markup(html_macros.$html_attribute_id$.getGlobalValue());
                                html_char(CHAR_quotation, UNPROVIDED);
                                html_markup($str_alt202$unary_frame);
                                html_char(CHAR_quotation, UNPROVIDED);
                            }
                            html_char(CHAR_greater, UNPROVIDED);
                            {
                                    ...
                                    html_macros.$html_safe_print$.bind(T, thread);
                                    {
                                        ...
                                        html_char(CHAR_greater, UNPROVIDED);
                                        {
                                            ...
                                            try {
                                                ...
                                                html_macros.$within_html_form$.bind(T, thread);
                                                html_macros.$html_form_field_uniquifier_code$.bind(html_macros.next_html_form_field_uniquifier_code(), thread);
                                                html_hidden_input($str_alt203$cb_handle_gaf_entry, T, UNPROVIDED);
                                                html_hidden_input($str_alt204$implicit_arg1, cb_fort_identifier(fort), UNPROVIDED);
                                                html_markup(html_macros.$html_table_head$.getGlobalValue());
                                                html_char(CHAR_greater, UNPROVIDED);
                                                {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_italic_head$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                                                                html_complete.html_complete_link($str_alt205$unary_frame_pred, $$$unary_predicate, $$UnaryPredicate, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                                                                                            } finally {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_event_attribute_onclick$.getGlobalValue());
                                                                                                html_char(CHAR_quotation, UNPROVIDED);
                                                                                                html_markup(dhtml_macros.dhtml_change_visible_section_onclick($str_alt208$binary_frame, $str_alt202$unary_frame));
                                                                                                html_char(CHAR_quotation, UNPROVIDED);
                                                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                                                {
                                                                        ...
                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                        {
                                                                            ...
                                                                            try {
                                                                                html_macros.$html_safe_print$.bind(T, thread);
                                                                                html_submit_input($$$Assert, $str_alt202$unary_frame, UNPROVIDED);
                                                                            } finally {
                                                        ...
                                                        html_char(CHAR_greater, UNPROVIDED);
                                                        {
                                                            ...
                                                            try {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        cb_form_widgets.cb_el_term_input_section(NIL, list(new SubLObject[]{ $INPUT_NAME, $str_alt205$unary_frame_pred, $COMPLETE_TYPE, $$UnaryPredicate, $CLEAR_LABEL, NIL, $COMPLETE_LABEL, NIL, $WIDTH, text_width }));
                                                                    } finally {
                            ...
                            html_markup(html_macros.$html_div_tail$.getGlobalValue());
                            html_source_readability_terpri(UNPROVIDED);
                            dhtml_macros.dhtml_set_switched_visibility($str_alt208$binary_frame, $VISIBLE, $PARAGRAPH);
                            html_markup(html_macros.$html_div_head$.getGlobalValue());
                            if (true) {
                                html_markup(html_macros.$html_attribute_id$.getGlobalValue());
                                html_char(CHAR_quotation, UNPROVIDED);
                                html_markup($str_alt208$binary_frame);
                                html_char(CHAR_quotation, UNPROVIDED);
                            }
                            html_char(CHAR_greater, UNPROVIDED);
                            {
                                                        ...
                                                        html_char(CHAR_greater, UNPROVIDED);
                                                        {
                                                            ...
                                                            try {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_italic_head$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                                                                html_complete.html_complete_link($str_alt217$binary_frame_pred, $$$binary_predicate, $$BinaryPredicate, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                                                                                            } finally {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_event_attribute_onclick$.getGlobalValue());
                                                                                                html_char(CHAR_quotation, UNPROVIDED);
                                                                                                html_markup(dhtml_macros.dhtml_change_visible_section_onclick($$$binary, $str_alt208$binary_frame));
                                                                                                html_char(CHAR_quotation, UNPROVIDED);
                                                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                                                {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_italic_head$.getGlobalValue());
                                                                                                html_complete.html_complete_link($str_alt222$binary_frame_arg2, $$$arg2, $$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                                                html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                            } finally {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_event_attribute_onclick$.getGlobalValue());
                                                                                                html_char(CHAR_quotation, UNPROVIDED);
                                                                                                html_markup(dhtml_macros.dhtml_change_visible_section_onclick($str_alt202$unary_frame, $str_alt208$binary_frame));
                                                                                                html_char(CHAR_quotation, UNPROVIDED);
                                                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                                                {
                                                                                                    ...
                                                                                                    try {
                                                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                                                        {
                                                                                                            SubLObject image_src = cb_icon_file_path($CLOSE_RED);
                                                                                                            SubLObject align = $TOP;
                                                                                                            SubLObject alt = cb_get_icon_alt_string($CLOSE_RED);
                                                                                                            SubLObject border = ZERO_INTEGER;
                                                                                                            html_markup(html_macros.$html_image_head$.getGlobalValue());
                                                                                                            html_markup(html_macros.$html_image_src$.getGlobalValue());
                                                                                                            html_char(CHAR_quotation, UNPROVIDED);
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_event_attribute_onclick$.getGlobalValue());
                                                                                                html_char(CHAR_quotation, UNPROVIDED);
                                                                                                html_markup(dhtml_macros.dhtml_change_visible_section_onclick($$$ternary, $str_alt208$binary_frame));
                                                                                                html_char(CHAR_quotation, UNPROVIDED);
                                                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                                                {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        html_submit_input($$$Assert, $str_alt208$binary_frame, UNPROVIDED);
                                                                    } finally {
                                                        ...
                                                        html_char(CHAR_greater, UNPROVIDED);
                                                        {
                                                            ...
                                                            try {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        cb_form_widgets.cb_el_term_input_section(NIL, list(new SubLObject[]{ $INPUT_NAME, $str_alt217$binary_frame_pred, $COMPLETE_TYPE, $$BinaryPredicate, $CLEAR_LABEL, NIL, $COMPLETE_LABEL, NIL, $WIDTH, text_width }));
                                                                    } finally {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        cb_form_widgets.cb_el_term_input_section(NIL, list($INPUT_NAME, $str_alt222$binary_frame_arg2, $CLEAR_LABEL, NIL, $COMPLETE_LABEL, NIL, $WIDTH, text_width));
                                                                    } finally {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_italic_head$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                                                                html_complete.html_complete_link($str_alt227$binary_pred, $$$binary_predicate, $$BinaryPredicate, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                                                                                            } finally {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_italic_head$.getGlobalValue());
                                                                                                html_complete.html_complete_link($str_alt228$binary_arg1, $$$arg1, $$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                                                html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                            } finally {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_event_attribute_onclick$.getGlobalValue());
                                                                                                html_char(CHAR_quotation, UNPROVIDED);
                                                                                                html_markup(dhtml_macros.dhtml_change_visible_section_onclick($str_alt208$binary_frame, $$$binary));
                                                                                                html_char(CHAR_quotation, UNPROVIDED);
                                                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                                                {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_italic_head$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                                                                html_complete.html_complete_link($str_alt230$binary_arg2, $$$arg2, $$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                                                                                            } finally {
                                                        ...
                                                        html_char(CHAR_greater, UNPROVIDED);
                                                        {
                                                            ...
                                                            try {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        cb_form_widgets.cb_el_term_input_section(NIL, list(new SubLObject[]{ $INPUT_NAME, $str_alt227$binary_pred, $COMPLETE_TYPE, $$BinaryPredicate, $CLEAR_LABEL, NIL, $COMPLETE_LABEL, NIL, $WIDTH, text_width }));
                                                                    } finally {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        cb_form_widgets.cb_el_term_input_section(NIL, list($INPUT_NAME, $str_alt228$binary_arg1, $CLEAR_LABEL, NIL, $COMPLETE_LABEL, NIL, $WIDTH, text_width));
                                                                    } finally {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        cb_form_widgets.cb_el_term_input_section(NIL, list($INPUT_NAME, $str_alt230$binary_arg2, $CLEAR_LABEL, NIL, $COMPLETE_LABEL, NIL, $WIDTH, text_width));
                                                                    } finally {
                                                            ...
                                                            try {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_italic_head$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                                                                html_complete.html_complete_link($str_alt231$ternary_pred, $$$ternary_predicate, $$TernaryPredicate, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                                                                                            } finally {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        html_markup(html_macros.$html_italic_head$.getGlobalValue());
                                                                        html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                                        html_complete.html_complete_link($str_alt234$ternary_arg1, $$$arg1, $$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                        html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                        html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                                                                    } finally {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        html_markup(html_macros.$html_italic_head$.getGlobalValue());
                                                                        html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                                        html_complete.html_complete_link($str_alt235$ternary_arg2, $$$arg2, $$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                        html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                        html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                                                                    } finally {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        html_char(CHAR_greater, UNPROVIDED);
                                                                                        {
                                                                                            ...
                                                                                            try {
                                                                                                ...
                                                                                                html_markup(html_macros.$html_small_head$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_italic_head$.getGlobalValue());
                                                                                                html_complete.html_complete_link($str_alt236$ternary_arg3, $$$arg3, $$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                                                html_markup(html_macros.$html_italic_tail$.getGlobalValue());
                                                                                                html_markup(html_macros.$html_small_tail$.getGlobalValue());
                                                                                            } finally {
                                                        ...
                                                        html_char(CHAR_greater, UNPROVIDED);
                                                        {
                                                            ...
                                                            try {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        cb_form_widgets.cb_el_term_input_section(NIL, list(new SubLObject[]{ $INPUT_NAME, $str_alt231$ternary_pred, $COMPLETE_TYPE, $$TernaryPredicate, $CLEAR_LABEL, NIL, $COMPLETE_LABEL, NIL, $WIDTH, text_width }));
                                                                    } finally {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        cb_form_widgets.cb_el_term_input_section(NIL, list($INPUT_NAME, $str_alt234$ternary_arg1, $CLEAR_LABEL, NIL, $COMPLETE_LABEL, NIL, $WIDTH, text_width));
                                                                    } finally {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        cb_form_widgets.cb_el_term_input_section(NIL, list($INPUT_NAME, $str_alt235$ternary_arg2, $CLEAR_LABEL, NIL, $COMPLETE_LABEL, NIL, $WIDTH, text_width));
                                                                    } finally {
                                                                ...
                                                                html_char(CHAR_greater, UNPROVIDED);
                                                                {
                                                                    ...
                                                                    try {
                                                                        html_macros.$html_safe_print$.bind(T, thread);
                                                                        cb_form_widgets.cb_el_term_input_section(NIL, list($INPUT_NAME, $str_alt236$ternary_arg3, $CLEAR_LABEL, NIL, $COMPLETE_LABEL, NIL, $WIDTH, text_width));
                                                                    } finally {
    ...
    public static final SubLObject cb_handle_gaf_entry_alt(SubLObject args) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            thread.resetMultipleValues();
            {
                SubLObject sentence = com.cyc.cycjava.cycl.cb_inferred_index.cb_extract_gaf_entry_sentence(args);
                SubLObject error = thread.secondMultipleValue();
                thread.resetMultipleValues();
                if (NIL != error) {
                    return com.cyc.cycjava.cycl.cb_inferred_index.cb_show_gaf_entry_error(error);
                }
    ...
    public static final SubLObject cb_extract_gaf_entry_sentence_alt(SubLObject args) {
        if (NIL != html_extract_input($str_alt202$unary_frame, args)) {
            {
                SubLObject pred = cb_guess_term(html_extract_input($str_alt205$unary_frame_pred, args), UNPROVIDED);
                SubLObject arg1 = cb_guess_term(html_extract_input($str_alt204$implicit_arg1, args), UNPROVIDED);
                if (NIL == pred) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt205$unary_frame_pred, args)), $str_alt241$_did_not_specify_a_term));
                }
                if (NIL == arg1) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt204$implicit_arg1, args)), $str_alt241$_did_not_specify_a_term));
                }
                {
                    SubLObject sentence = make_unary_formula(pred, arg1);
                    return values(sentence, NIL);
                }
            }
        }
        if (NIL != html_extract_input($str_alt208$binary_frame, args)) {
            {
                SubLObject pred = cb_guess_term(html_extract_input($str_alt217$binary_frame_pred, args), UNPROVIDED);
                SubLObject arg1 = cb_guess_term(html_extract_input($str_alt204$implicit_arg1, args), UNPROVIDED);
                SubLObject arg2 = cb_guess_term(html_extract_input($str_alt222$binary_frame_arg2, args), UNPROVIDED);
                if (NIL == pred) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt217$binary_frame_pred, args)), $str_alt241$_did_not_specify_a_term));
                }
                if (NIL == arg1) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt204$implicit_arg1, args)), $str_alt241$_did_not_specify_a_term));
                }
                if (NIL == arg2) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt222$binary_frame_arg2, args)), $str_alt241$_did_not_specify_a_term));
                }
                {
                    SubLObject sentence = make_binary_formula(pred, arg1, arg2);
                    return values(sentence, NIL);
                }
            }
        }
        if (NIL != html_extract_input($$$binary, args)) {
            {
                SubLObject pred = cb_guess_term(html_extract_input($str_alt227$binary_pred, args), UNPROVIDED);
                SubLObject arg1 = cb_guess_term(html_extract_input($str_alt228$binary_arg1, args), UNPROVIDED);
                SubLObject arg2 = cb_guess_term(html_extract_input($str_alt230$binary_arg2, args), UNPROVIDED);
                if (NIL == pred) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt227$binary_pred, args)), $str_alt241$_did_not_specify_a_term));
                }
                if (NIL == arg1) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt228$binary_arg1, args)), $str_alt241$_did_not_specify_a_term));
                }
                if (NIL == arg2) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt230$binary_arg2, args)), $str_alt241$_did_not_specify_a_term));
                }
                {
                    SubLObject sentence = make_binary_formula(pred, arg1, arg2);
                    return values(sentence, NIL);
        ...
        if (NIL != html_extract_input($$$ternary, args)) {
            {
                SubLObject pred = cb_guess_term(html_extract_input($str_alt231$ternary_pred, args), UNPROVIDED);
                SubLObject arg1 = cb_guess_term(html_extract_input($str_alt234$ternary_arg1, args), UNPROVIDED);
                SubLObject arg2 = cb_guess_term(html_extract_input($str_alt235$ternary_arg2, args), UNPROVIDED);
                SubLObject arg3 = cb_guess_term(html_extract_input($str_alt236$ternary_arg3, args), UNPROVIDED);
                if (NIL == pred) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt231$ternary_pred, args)), $str_alt241$_did_not_specify_a_term));
                }
                if (NIL == arg1) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt234$ternary_arg1, args)), $str_alt241$_did_not_specify_a_term));
                }
                if (NIL == arg2) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt235$ternary_arg2, args)), $str_alt241$_did_not_specify_a_term));
                }
                if (NIL == arg3) {
                    return values(NIL, cconcatenate(format_nil.format_nil_a_no_copy(html_extract_input($str_alt236$ternary_arg3, args)), $str_alt241$_did_not_specify_a_term));
                }
                {
                    SubLObject sentence = make_ternary_formula(pred, arg1, arg2, arg3);
                    return values(sentence, NIL);
                }
            }
        }
    ...
    public static final SubLObject cb_show_gaf_entry_error_alt(SubLObject error) {
        return cb_error($str_alt243$_A, error, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
    }
    ...
    public static final SubLObject dhtml_highlight_icon_on_mouseover_alt(SubLObject dim_icon, SubLObject bright_icon) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject dim_id = cconcatenate($str_alt244$dim_, format_nil.format_nil_a_no_copy(random.random($int$10000)));
                SubLObject bright_id = cconcatenate($str_alt244$dim_, format_nil.format_nil_a_no_copy(random.random($int$10000)));
                SubLObject dim_src = cb_icon_file_path(dim_icon);
                SubLObject bright_src = cb_icon_file_path(bright_icon);
                html_markup(html_macros.$html_anchor_head$.getGlobalValue());
                html_markup(html_macros.$html_anchor_href$.getGlobalValue());
                html_char(CHAR_quotation, UNPROVIDED);
                html_markup(html_complete.javascript_void_url());
                ...
                html_char(CHAR_quotation, UNPROVIDED);
                html_markup(cconcatenate($str_alt246$setVisibility__, new SubLObject[]{ format_nil.format_nil_a_no_copy(bright_id), $str_alt247$___inline___setVisibility__, format_nil.format_nil_a_no_copy(dim_id), $str_alt248$___none___ }));
                html_char(CHAR_quotation, UNPROVIDED);
                html_markup(html_macros.$html_anchor_onmouseout$.getGlobalValue());
                html_char(CHAR_quotation, UNPROVIDED);
                html_markup(cconcatenate($str_alt246$setVisibility__, new SubLObject[]{ format_nil.format_nil_a_no_copy(dim_id), $str_alt247$___inline___setVisibility__, format_nil.format_nil_a_no_copy(bright_id), $str_alt248$___none___ }));
                html_char(CHAR_quotation, UNPROVIDED);
                html_char(CHAR_greater, UNPROVIDED);
                {
                    SubLObject _prev_bind_0 = html_macros.$html_safe_print$.currentBinding(thread);
    ...
    public static final SubLObject declare_cb_inferred_index_file_alt() {
        declareFunction("cb_inferred_index_frame", "CB-INFERRED-INDEX-FRAME", 1, 0, false);
        declareFunction("cb_link_inferred_index", "CB-LINK-INFERRED-INDEX", 1, 2, false);
        declareFunction("cb_legacy_index_frame", "CB-LEGACY-INDEX-FRAME", 1, 0, false);
        declareFunction("cb_link_legacy_index", "CB-LINK-LEGACY-INDEX", 1, 2, false);
        declareFunction("cb_inferred_index", "CB-INFERRED-INDEX", 1, 0, false);
        declareFunction("cb_show_inferred_gaf_arg_index_utilities_section", "CB-SHOW-INFERRED-GAF-ARG-INDEX-UTILITIES-SECTION", 1, 0, false);
        declareFunction("cb_show_inferred_gaf_arg_index_header", "CB-SHOW-INFERRED-GAF-ARG-INDEX-HEADER", 2, 0, false);
        declareFunction("cb_show_inferred_gaf_arg_index", "CB-SHOW-INFERRED-GAF-ARG-INDEX", 1, 2, false);
        declareFunction("cb_show_inferred_gaf_arg_index_by_ontology", "CB-SHOW-INFERRED-GAF-ARG-INDEX-BY-ONTOLOGY", 2, 0, false);
        declareFunction("cb_show_inferred_gaf_arg_index_by_predicate", "CB-SHOW-INFERRED-GAF-ARG-INDEX-BY-PREDICATE", 2, 0, false);
        declareFunction("cb_show_inferred_gaf_arg_index_all_assertions_line", "CB-SHOW-INFERRED-GAF-ARG-INDEX-ALL-ASSERTIONS-LINE", 2, 0, false);
        declareFunction("cb_show_inferred_index_count", "CB-SHOW-INFERRED-INDEX-COUNT", 1, 1, false);
        declareFunction("cb_make_inferred_gaf_arg_index_tuples_object_id", "CB-MAKE-INFERRED-GAF-ARG-INDEX-TUPLES-OBJECT-ID", 1, 1, false);
        declareFunction("cb_link_literal_query", "CB-LINK-LITERAL-QUERY", 3, 1, false);
        declareFunction("cb_show_inferred_index_literal_query_linkP", "CB-SHOW-INFERRED-INDEX-LITERAL-QUERY-LINK?", 3, 0, false);
        declareFunction("cb_inferred_index_order_by", "CB-INFERRED-INDEX-ORDER-BY", 1, 0, false);
        declareFunction("cb_link_inferred_index_order_by", "CB-LINK-INFERRED-INDEX-ORDER-BY", 3, 0, false);
        declareFunction("cb_inferred_index_visibility", "CB-INFERRED-INDEX-VISIBILITY", 1, 0, false);
        declareFunction("cb_link_inferred_index_toggle_visibility", "CB-LINK-INFERRED-INDEX-TOGGLE-VISIBILITY", 1, 0, false);
        declareFunction("cb_inferred_index_predicate_filters", "CB-INFERRED-INDEX-PREDICATE-FILTERS", 1, 0, false);
        declareFunction("cb_link_inferred_index_predicate_filters", "CB-LINK-INFERRED-INDEX-PREDICATE-FILTERS", 0, 2, false);
        declareFunction("cb_inferred_index_predicate_filters_guts", "CB-INFERRED-INDEX-PREDICATE-FILTERS-GUTS", 1, 0, false);
        declareFunction("cb_inferred_index_predicate_type_filter_remove_allow_checkbox", "CB-INFERRED-INDEX-PREDICATE-TYPE-FILTER-REMOVE-ALLOW-CHECKBOX", 1, 0, false);
        declareFunction("cb_inferred_index_predicate_type_filter_remove_forbid_checkbox", "CB-INFERRED-INDEX-PREDICATE-TYPE-FILTER-REMOVE-FORBID-CHECKBOX", 1, 0, false);
        declareFunction("cb_inferred_index_predicate_filter_forbid_checkbox", "CB-INFERRED-INDEX-PREDICATE-FILTER-FORBID-CHECKBOX", 1, 0, false);
        declareFunction("cb_inferred_index_predicate_filter_allow_checkbox", "CB-INFERRED-INDEX-PREDICATE-FILTER-ALLOW-CHECKBOX", 1, 0, false);
        declareFunction("cb_handle_inferred_index_predicate_filters", "CB-HANDLE-INFERRED-INDEX-PREDICATE-FILTERS", 1, 0, false);
        declareFunction("cb_extract_inferred_index_predicate_filters", "CB-EXTRACT-INFERRED-INDEX-PREDICATE-FILTERS", 1, 0, false);
        declareFunction("cb_clear_inferred_index_predicate_filters", "CB-CLEAR-INFERRED-INDEX-PREDICATE-FILTERS", 0, 0, false);
        declareFunction("cb_update_inferred_index_predicate_filters", "CB-UPDATE-INFERRED-INDEX-PREDICATE-FILTERS", 6, 0, false);
        declareFunction("cb_inferred_index_ontology_filters", "CB-INFERRED-INDEX-ONTOLOGY-FILTERS", 1, 0, false);
        declareFunction("cb_link_inferred_index_ontology_filters", "CB-LINK-INFERRED-INDEX-ONTOLOGY-FILTERS", 0, 2, false);
        declareFunction("cb_inferred_index_ontology_filters_guts", "CB-INFERRED-INDEX-ONTOLOGY-FILTERS-GUTS", 1, 0, false);
        declareFunction("cb_inferred_index_ontology_horizon_radio_button", "CB-INFERRED-INDEX-ONTOLOGY-HORIZON-RADIO-BUTTON", 2, 0, false);
        declareFunction("cb_handle_inferred_index_ontology_filters", "CB-HANDLE-INFERRED-INDEX-ONTOLOGY-FILTERS", 1, 0, false);
        declareFunction("cb_show_ontology_horizon_term", "CB-SHOW-ONTOLOGY-HORIZON-TERM", 1, 0, false);
        declareFunction("cb_extract_inferred_index_ontology_horizon", "CB-EXTRACT-INFERRED-INDEX-ONTOLOGY-HORIZON", 1, 0, false);
        declareFunction("cb_update_inferred_index_ontology_filters", "CB-UPDATE-INFERRED-INDEX-ONTOLOGY-FILTERS", 1, 0, false);
        declareFunction("cb_link_inferred_gaf_arg_assertions", "CB-LINK-INFERRED-GAF-ARG-ASSERTIONS", 2, 3, false);
        declareFunction("cb_inferred_gaf_arg_assertions", "CB-INFERRED-GAF-ARG-ASSERTIONS", 1, 0, false);
        declareFunction("cb_inferred_gaf_arg_assertions_guts", "CB-INFERRED-GAF-ARG-ASSERTIONS-GUTS", 4, 0, false);
        declareFunction("cb_show_inferred_gaf_arg_assertions_by_ontology", "CB-SHOW-INFERRED-GAF-ARG-ASSERTIONS-BY-ONTOLOGY", 2, 0, false);
        declareFunction("cb_show_inferred_gaf_arg_assertions_by_predicate", "CB-SHOW-INFERRED-GAF-ARG-ASSERTIONS-BY-PREDICATE", 2, 0, false);
        declareFunction("cb_show_inferred_gaf_arg_index_assertions_final", "CB-SHOW-INFERRED-GAF-ARG-INDEX-ASSERTIONS-FINAL", 5, 0, false);
        declareFunction("hl_support_module_for_predicate", "HL-SUPPORT-MODULE-FOR-PREDICATE", 1, 0, false);
        declareFunction("cb_show_qua_justification", "CB-SHOW-QUA-JUSTIFICATION", 3, 0, false);
        declareFunction("filter_gaf_arg_index_tuples", "FILTER-GAF-ARG-INDEX-TUPLES", 1, 3, false);
        declareFunction("cb_inferred_index_definitional_information", "CB-INFERRED-INDEX-DEFINITIONAL-INFORMATION", 1, 0, false);
        declareFunction("inferred_index_definitional_information_override", "INFERRED-INDEX-DEFINITIONAL-INFORMATION-OVERRIDE", 2, 0, false);
        declareFunction("cb_term_type_header_with_gaf_entry", "CB-TERM-TYPE-HEADER-WITH-GAF-ENTRY", 1, 1, false);
        declareFunction("cb_term_type_header", "CB-TERM-TYPE-HEADER", 1, 1, false);
        declareFunction("cb_gaf_entry_widget_links", "CB-GAF-ENTRY-WIDGET-LINKS", 0, 3, false);
        declareFunction("cb_gaf_entry_widget", "CB-GAF-ENTRY-WIDGET", 1, 1, false);
        declareFunction("cb_handle_gaf_entry", "CB-HANDLE-GAF-ENTRY", 1, 0, false);
        declareFunction("cb_extract_gaf_entry_sentence", "CB-EXTRACT-GAF-ENTRY-SENTENCE", 1, 0, false);
        declareFunction("cb_show_gaf_entry_error", "CB-SHOW-GAF-ENTRY-ERROR", 1, 0, false);
        declareFunction("dhtml_highlight_icon_on_mouseover", "DHTML-HIGHLIGHT-ICON-ON-MOUSEOVER", 2, 0, false);
        return NIL;
    }
    ...
    public static SubLObject declare_cb_inferred_index_file() {
        if (SubLFiles.USE_V1) {
            ...
            declareFunction("cb_inferred_index", "CB-INFERRED-INDEX", 1, 0, false);
            declareFunction("cb_show_inferred_gaf_arg_index_utilities_section", "CB-SHOW-INFERRED-GAF-ARG-INDEX-UTILITIES-SECTION", 1, 0, false);
            declareFunction("cb_possibly_show_term_as_seen_from_mt_header", "CB-POSSIBLY-SHOW-TERM-AS-SEEN-FROM-MT-HEADER", 1, 1, false);
            declareFunction("cb_show_term_as_seen_from_mt_header", "CB-SHOW-TERM-AS-SEEN-FROM-MT-HEADER", 1, 0, false);
            declareFunction("cb_show_inferred_gaf_arg_index_header", "CB-SHOW-INFERRED-GAF-ARG-INDEX-HEADER", 3, 0, false);
            declareFunction("cb_show_inferred_gaf_arg_index", "CB-SHOW-INFERRED-GAF-ARG-INDEX", 1, 2, false);
            declareFunction("cb_show_inferred_gaf_arg_index_by_ontology", "CB-SHOW-INFERRED-GAF-ARG-INDEX-BY-ONTOLOGY", 2, 0, false);
            declareFunction("cb_show_inferred_gaf_arg_index_by_predicate", "CB-SHOW-INFERRED-GAF-ARG-INDEX-BY-PREDICATE", 2, 0, false);
            declareFunction("cb_show_inferred_gaf_arg_index_all_assertions_line", "CB-SHOW-INFERRED-GAF-ARG-INDEX-ALL-ASSERTIONS-LINE", 2, 0, false);
            ...
            declareFunction("cb_link_literal_query", "CB-LINK-LITERAL-QUERY", 3, 1, false);
            declareFunction("cb_show_inferred_index_literal_query_linkP", "CB-SHOW-INFERRED-INDEX-LITERAL-QUERY-LINK?", 3, 0, false);
            declareFunction("cb_link_hier_brow", "CB-LINK-HIER-BROW", 3, 1, false);
            declareFunction("cb_show_inferred_index_hierarchy_browser_linkP", "CB-SHOW-INFERRED-INDEX-HIERARCHY-BROWSER-LINK?", 3, 0, false);
            declareFunction("cb_inferred_index_order_by", "CB-INFERRED-INDEX-ORDER-BY", 1, 0, false);
            declareFunction("cb_link_inferred_index_order_by", "CB-LINK-INFERRED-INDEX-ORDER-BY", 3, 0, false);
            declareFunction("cb_inferred_index_visibility", "CB-INFERRED-INDEX-VISIBILITY", 1, 0, false);
            declareFunction("cb_link_inferred_index_toggle_visibility", "CB-LINK-INFERRED-INDEX-TOGGLE-VISIBILITY", 1, 0, false);
            ...
            declareFunction("cb_extract_inferred_index_ontology_horizon", "CB-EXTRACT-INFERRED-INDEX-ONTOLOGY-HORIZON", 1, 0, false);
            declareFunction("cb_update_inferred_index_ontology_filters", "CB-UPDATE-INFERRED-INDEX-ONTOLOGY-FILTERS", 1, 0, false);
            declareFunction("cb_inferred_index_microtheory_filters", "CB-INFERRED-INDEX-MICROTHEORY-FILTERS", 1, 0, false);
            declareFunction("cb_link_inferred_index_microtheory_filters", "CB-LINK-INFERRED-INDEX-MICROTHEORY-FILTERS", 0, 2, false);
            declareFunction("cb_set_microtheory_browsing_filter", "CB-SET-MICROTHEORY-BROWSING-FILTER", 1, 0, false);
            declareFunction("cb_link_inferred_gaf_arg_assertions", "CB-LINK-INFERRED-GAF-ARG-ASSERTIONS", 2, 3, false);
            declareFunction("cb_inferred_gaf_arg_assertions", "CB-INFERRED-GAF-ARG-ASSERTIONS", 1, 0, false);
            declareFunction("cb_inferred_gaf_arg_assertions_guts", "CB-INFERRED-GAF-ARG-ASSERTIONS-GUTS", 4, 0, false);
            declareFunction("cb_show_inferred_gaf_arg_assertions_by_ontology", "CB-SHOW-INFERRED-GAF-ARG-ASSERTIONS-BY-ONTOLOGY", 2, 0, false);
    ...
    public static SubLObject declare_cb_inferred_index_file_Previous() {
        declareFunction("cb_inferred_index_frame", "CB-INFERRED-INDEX-FRAME", 1, 0, false);
        declareFunction("cb_link_inferred_index", "CB-LINK-INFERRED-INDEX", 1, 2, false);
        declareFunction("cb_legacy_index_frame", "CB-LEGACY-INDEX-FRAME", 1, 0, false);
        declareFunction("cb_link_legacy_index", "CB-LINK-LEGACY-INDEX", 1, 2, false);
    ...
    public static final SubLObject init_cb_inferred_index_file_alt() {
        ...
        deflexical("*PREDICATE-SUPPORT-MODULE-MAP*", $list_alt176);
        return NIL;
    }
    ...
    public static SubLObject init_cb_inferred_index_file_Previous() {
        defvar("*CB-INFERRED-INDEX-ORDER-BY*", $ONTOLOGY);
        defvar("*CB-INFERRED-INDEX-FILTERS*", NIL);
        defvar("*CB-INFERRED-INDEX-VISIBILITY*", $INVISIBLE);
        deflexical("*PREDICATE-SUPPORT-MODULE-MAP*", $list229);
    ...
    public static final SubLObject setup_cb_inferred_index_file_alt() {
        ...
        html_macros.note_html_handler_function(CB_INFERRED_INDEX_FRAME);
        setup_cb_link_method($INFERRED_INDEX, CB_LINK_INFERRED_INDEX, THREE_INTEGER);
        html_macros.note_html_handler_function(CB_LEGACY_INDEX_FRAME);
        ...
        html_macros.note_html_handler_function(CB_INFERRED_INDEX_ORDER_BY);
        setup_cb_link_method($INFERRED_INDEX_ORDER_BY, CB_LINK_INFERRED_INDEX_ORDER_BY, THREE_INTEGER);
        html_macros.note_html_handler_function(CB_INFERRED_INDEX_VISIBILITY);
        setup_cb_link_method($INFERRED_INDEX_TOGGLE_VISIBILITY, CB_LINK_INFERRED_INDEX_TOGGLE_VISIBILITY, ONE_INTEGER);
        html_macros.note_html_handler_function(CB_INFERRED_INDEX_PREDICATE_FILTERS);
        setup_cb_link_method($INFERRED_INDEX_PREDICATE_FILTERS, CB_LINK_INFERRED_INDEX_PREDICATE_FILTERS, TWO_INTEGER);
        html_macros.note_html_handler_function(CB_HANDLE_INFERRED_INDEX_PREDICATE_FILTERS);
        html_macros.note_html_handler_function(CB_INFERRED_INDEX_ONTOLOGY_FILTERS);
        setup_cb_link_method($INFERRED_INDEX_ONTOLOGY_FILTERS, CB_LINK_INFERRED_INDEX_ONTOLOGY_FILTERS, TWO_INTEGER);
        html_macros.note_html_handler_function(CB_HANDLE_INFERRED_INDEX_ONTOLOGY_FILTERS);
        setup_cb_link_method($INFERRED_GAF_ARG_ASSERTIONS, CB_LINK_INFERRED_GAF_ARG_ASSERTIONS, FIVE_INTEGER);
        html_macros.note_html_handler_function(CB_INFERRED_GAF_ARG_ASSERTIONS);
        sethash($CLOSE_RED, $cb_icon_definitions$.getGlobalValue(), list($str_alt187$red_x_close_15_gif, NIL));
        sethash($CLOSE_RED_DIM, $cb_icon_definitions$.getGlobalValue(), list($str_alt189$dim_red_x_close_15_gif, NIL));
        html_macros.note_html_handler_function(CB_HANDLE_GAF_ENTRY);
        return NIL;
    }
    ...
    public static SubLObject setup_cb_inferred_index_file_Previous() {
        register_html_state_variable($cb_inferred_index_order_by$);
        register_html_interface_variable($cb_inferred_index_order_by$);
        register_html_state_variable($cb_inferred_index_filters$);
        register_html_interface_variable($cb_inferred_index_filters$);
    ...
    static private final SubLList $list_alt5 = list(makeSymbol("INDEX-ID"));

    static private final SubLString $str_alt6$Unable_to_determine_a_term_from__ = makeString("Unable to determine a term from ~S");

    static private final SubLString $str_alt9$_Inferred_ = makeString("[Inferred]");

    static private final SubLString $str_alt10$cb_inferred_index_frame__A = makeString("cb-inferred-index-frame&~A");

    static private final SubLString $str_alt14$_Legacy_ = makeString("[Legacy]");

    static private final SubLString $str_alt15$cb_legacy_index_frame__A = makeString("cb-legacy-index-frame&~A");
    ...
    static private final SubLString $$$Editing = makeString("Editing");
    ...
    static private final SubLString $$$force_TMS = makeString("force TMS");

    static private final SubLString $str_alt49$100_ = makeString("100%");

    static private final SubLString $$$Inferred_Index = makeString("Inferred Index");

    static private final SubLString $$$for = makeString("for");

    static private final SubLString $str_alt55$40_ = makeString("40%");

    static private final SubLString $str_alt56$order_by__ = makeString("order by :");

    static private final SubLString $str_alt61$filters__ = makeString("filters :");

    static private final SubLString $str_alt64$index_view__ = makeString("index view :");

    static private final SubLString $str_alt67$Unexpected_order_by____S = makeString("Unexpected order-by : ~S");

    static private final SubLString $str_alt69$via_ = makeString("via ");

    static private final SubLList $list_alt72 = list(makeSymbol("INFER-PRED"), makeSymbol("QUA"), makeSymbol("ARGNUM"), makeSymbol("PRED"));

    static private final SubLString $str_alt73$_arg_S = makeString(" arg~S");

    static private final SubLString $str_alt79$__A_ = makeString("(~A)");

    static private final SubLString $str_alt82$_ = makeString("!");

    static private final SubLString $str_alt83$igai_ = makeString("igai_");

    static private final SubLString $str_alt85$cb_lq__A__A__A__A = makeString("cb-lq&~A&~A&~A&~A");

    static private final SubLString $str_alt86$cb_lq__A__A__A = makeString("cb-lq&~A&~A&~A");

    static private final SubLList $list_alt89 = list(makeSymbol("INDEX-ID"), makeSymbol("ORDER-BY-STRING"));

    static private final SubLString $str_alt91$cb_inferred_index_order_by__A__A = makeString("cb-inferred-index-order-by&~A&~A");

    static private final SubLList $list_alt93 = list(makeSymbol("INDEX-ID"), makeSymbol("VISIBILITY-STRING"));

    static private final SubLString $str_alt100$cb_inferred_index_visibility__A__ = makeString("cb-inferred-index-visibility&~A&~S");

    static private final SubLList $list_alt103 = list(makeSymbol("ID-STRING"));

    static private final SubLString $str_alt104$_S_did_not_specify_a_term = makeString("~S did not specify a term");

    static private final SubLString $str_alt106$_Predicate_Filters_ = makeString("[Predicate Filters]");

    static private final SubLString $str_alt107$cb_inferred_index_predicate_filte = makeString("cb-inferred-index-predicate-filters&~A");

    static private final SubLString $str_alt110$cb_handle_inferred_index_predicat = makeString("cb-handle-inferred-index-predicate-filters");

    static private final SubLString $str_alt111$relevant_to_ = makeString("relevant to ");

    static private final SubLString $str_alt124$add_ = makeString("add ");

    static private final SubLString $str_alt125$type_allow = makeString("type_allow");

    static private final SubLString $str_alt130$type_forbid = makeString("type_forbid");

    static private final SubLString $str_alt132$None_ = makeString("None!");

    static private final SubLString $str_alt136$remove_type_allow_ = makeString("remove_type_allow_");

    static private final SubLString $str_alt138$remove_type_forbid_ = makeString("remove_type_forbid_");

    static private final SubLString $str_alt139$forbid_ = makeString("forbid_");

    static private final SubLString $str_alt140$allow_ = makeString("allow_");

    static private final SubLList $list_alt142 = list(makeSymbol("NAME"), makeSymbol("VALUE"));

    static private final SubLString $str_alt144$_Ontology_Filters_ = makeString("[Ontology Filters]");

    static private final SubLString $str_alt145$cb_inferred_index_ontology_filter = makeString("cb-inferred-index-ontology-filters&~A");

    static private final SubLString $str_alt148$cb_handle_inferred_index_ontology = makeString("cb-handle-inferred-index-ontology-filters");

    static private final SubLList $list_alt152 = list($SELF, makeKeyword("LOWER"), makeKeyword("MIDDLE"), makeKeyword("ALL"));

    static private final SubLString $str_alt155$ontology_horizon = makeString("ontology-horizon");

    static private final SubLString $str_alt161$Also_up_through_the_middle_ontolo = makeString("Also up through the middle ontology");

    static private final SubLString $str_alt163$cb_inferred_gaf_arg_assertions__A = makeString("cb-inferred-gaf-arg-assertions&~A&~A&~A&~A");

    static private final SubLString $str_alt164$cb_inferred_gaf_arg_assertions__A = makeString("cb-inferred-gaf-arg-assertions&~A&~A");

    static private final SubLString $str_alt165$cb_inferred_gaf_arg_assertions__A = makeString("cb-inferred-gaf-arg-assertions&~A");

    static private final SubLList $list_alt167 = list(makeSymbol("TERM-SPEC"), makeSymbol("&OPTIONAL"), makeSymbol("QUA-SPEC"), makeSymbol("ARGNUM-SPEC"), makeSymbol("PRED-SPEC"));

    static private final SubLString $str_alt168$Could_not_determine_a_term_from__ = makeString("Could not determine a term from ~a");

    static private final SubLString $str_alt170$Could_not_determine_an_argnum_fro = makeString("Could not determine an argnum from ~a");

    static private final SubLString $str_alt172$Inferred_GAF_arg_index_for__S = makeString("Inferred GAF arg index for ~S");

    static private final SubLString $str_alt173$yui_skin_sam = makeString("yui-skin-sam");

    static private final SubLString $str_alt175$_query = makeString(" query");

    static private final SubLList $list_alt176 = list(cons(reader_make_constant_shell("isa"), makeKeyword("ISA")), cons(reader_make_constant_shell("genls"), makeKeyword("GENLS")), cons(reader_make_constant_shell("equals"), makeKeyword("EQUALITY")));

    static private final SubLString $str_alt179$on_ = makeString("on ");

    static private final SubLString $str_alt184$___ = makeString("[?]");

    static private final SubLList $list_alt185 = list(reader_make_constant_shell("Thing"));

    static private final SubLString $str_alt187$red_x_close_15_gif = makeString("red-x-close-15.gif");

    static private final SubLString $str_alt189$dim_red_x_close_15_gif = makeString("dim-red-x-close-15.gif");

    static private final SubLString $str_alt190$gaf_entry = makeString("gaf_entry");

    static private final SubLString $str_alt191$___ = makeString("[+]");

    static private final SubLString $str_alt192$___ = makeString("[-]");

    static private final SubLString $str_alt193$___ = makeString(" : ");

    static private final SubLList $list_alt194 = list(makeSymbol("&KEY"), list(makeSymbol("NAME"), makeString("gaf_entry")), makeSymbol("PRED"), makeSymbol("ARGNUM"));

    static private final SubLList $list_alt195 = list($NAME, $PRED, makeKeyword("ARGNUM"));

    static private final SubLString $str_alt202$unary_frame = makeString("unary_frame");

    static private final SubLString $str_alt203$cb_handle_gaf_entry = makeString("cb-handle-gaf-entry");

    static private final SubLString $str_alt204$implicit_arg1 = makeString("implicit_arg1");

    static private final SubLString $str_alt205$unary_frame_pred = makeString("unary_frame_pred");

    static private final SubLString $str_alt208$binary_frame = makeString("binary_frame");

    static private final SubLString $str_alt209$_arg2 = makeString("+arg2");

    static private final SubLString $str_alt217$binary_frame_pred = makeString("binary_frame_pred");

    static private final SubLString $str_alt221$_arg1 = makeString("+arg1");

    static private final SubLString $str_alt222$binary_frame_arg2 = makeString("binary_frame_arg2");

    static private final SubLString $str_alt226$_arg3 = makeString("+arg3");

    static private final SubLString $str_alt227$binary_pred = makeString("binary_pred");

    static private final SubLString $str_alt228$binary_arg1 = makeString("binary_arg1");

    static private final SubLString $str_alt230$binary_arg2 = makeString("binary_arg2");

    static private final SubLString $str_alt231$ternary_pred = makeString("ternary_pred");

    static private final SubLString $str_alt234$ternary_arg1 = makeString("ternary_arg1");

    static private final SubLString $str_alt235$ternary_arg2 = makeString("ternary_arg2");

    static private final SubLString $str_alt236$ternary_arg3 = makeString("ternary_arg3");

    static private final SubLString $str_alt238$_arg4 = makeString("+arg4");

    static private final SubLString $str_alt241$_did_not_specify_a_term = makeString(" did not specify a term");

    static private final SubLString $str_alt243$_A = makeString("~A");

    static private final SubLString $str_alt244$dim_ = makeString("dim_");

    static private final SubLString $str_alt246$setVisibility__ = makeString("setVisibility('");

    static private final SubLString $str_alt247$___inline___setVisibility__ = makeString("','inline');setVisibility('");

    static private final SubLString $str_alt248$___none___ = makeString("','none');");
}
