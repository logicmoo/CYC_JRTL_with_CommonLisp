/**
 * import $problem_strategic_properties_native;
 */
/**
 ...
 */
/**
 * import $strategy_native;
 */
/**
 * import $tactic_strategic_properties_native;
 */
/**
...
import static com.cyc.cycjava.cycl.inference.modules.preference_modules.completeness_to_preference_level;
import static com.cyc.cycjava.cycl.inference.modules.preference_modules.preference_level_to_completeness;
...
public final class inference_datastructures_strategy extends SubLTranslatedFile implements V12 {
    ...
    public static SubLObject tactic_thrown_away_cache_status_wrt_motivation(SubLObject tactic, SubLObject strategy, SubLObject motivation) {
	{
    ...
    public static SubLObject tactic_set_aside_cache_status_wrt_motivation(SubLObject tactic, SubLObject strategy, SubLObject motivation) {
	{
	    final SubLThread thread = SubLProcess.currentSubLThread();
	    if (NIL == $uninterestingness_cache_lookup_enabledP$.getDynamicValue(thread)) {
		return $RECOMPUTE;
    ...
    public static SubLObject set_uninterestingness_cache_thrown_away_wrt_transformation_code(SubLObject flags, SubLObject code) {
	return bytes.dpb(code, $uninterestingness_cache_thrown_away_wrt_transformation_byte$.getGlobalValue(), flags);
    }

    public static SubLObject set_uninterestingness_cache_thrown_away_wrt_removal_code(SubLObject flags, SubLObject code) {
	return bytes.dpb(code, $uninterestingness_cache_thrown_away_wrt_removal_byte$.getGlobalValue(), flags);
    }

    public static SubLObject set_uninterestingness_cache_thrown_away_wrt_new_root_code(SubLObject flags, SubLObject code) {
    ...
    public static SubLObject set_uninterestingness_cache_set_aside_wrt_transformation_code(SubLObject flags, SubLObject code) {
    ...
    public static SubLObject set_uninterestingness_cache_set_aside_wrt_new_root_code(SubLObject flags, SubLObject code) {
	...
	{
	    SubLObject flags = tactic_strategic_flags(tactic, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_removal_code(flags, encode_uninterestingness_cache_status(T));
	    return set_tactic_strategic_flags(tactic, strategy, new_flags);
	}
    }
	...
	{
	    SubLObject flags = tactic_strategic_flags(tactic, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_new_root_code(flags, encode_uninterestingness_cache_status(T));
	    return set_tactic_strategic_flags(tactic, strategy, new_flags);
	}
    }
    ...
    public static SubLObject set_tactic_recompute_thrown_away_wrt_transformation(SubLObject tactic, SubLObject strategy) {
	{
	    SubLObject flags = tactic_strategic_flags(tactic, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_transformation_code(flags, encode_uninterestingness_cache_status($RECOMPUTE));
	    return set_tactic_strategic_flags(tactic, strategy, new_flags);
	}
    }
	...
	{
	    SubLObject flags = tactic_strategic_flags(tactic, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_removal_code(flags, encode_uninterestingness_cache_status($RECOMPUTE));
	    return set_tactic_strategic_flags(tactic, strategy, new_flags);
	}
    }
	...
	{
	    SubLObject flags = tactic_strategic_flags(tactic, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_new_root_code(flags, encode_uninterestingness_cache_status($RECOMPUTE));
	    return set_tactic_strategic_flags(tactic, strategy, new_flags);
	}
    }

    public static SubLObject set_tactic_recompute_thrown_away_wrt_all_motivations(SubLObject tactic, SubLObject strategy) {
    ...
    public static SubLObject set_tactic_recompute_thrown_away_wrt(SubLObject tactic, SubLObject strategy, SubLObject motivation) {
	{
	    SubLObject pcase_var = motivation;
	    if (pcase_var.eql($REMOVAL)) {
	...
	{
	    SubLObject flags = tactic_strategic_flags(tactic, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_transformation_code(flags, encode_uninterestingness_cache_status($RECOMPUTE));
	    return set_tactic_strategic_flags(tactic, strategy, new_flags);
	}
    }
	...
	{
	    SubLObject flags = tactic_strategic_flags(tactic, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_removal_code(flags, encode_uninterestingness_cache_status($RECOMPUTE));
	    return set_tactic_strategic_flags(tactic, strategy, new_flags);
	}
    }
	...
	{
	    SubLObject flags = tactic_strategic_flags(tactic, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_new_root_code(flags, encode_uninterestingness_cache_status($RECOMPUTE));
	    return set_tactic_strategic_flags(tactic, strategy, new_flags);
	}
    }

    public static SubLObject set_tactic_recompute_set_aside_wrt_all_relevant_strategies_and_all_motivations(SubLObject tactic) {
	{
    ...
    public static SubLObject set_tactic_recompute_set_aside_wrt_all_motivations(SubLObject tactic, SubLObject strategy) {
	if (NIL != balancing_tactician.balancing_tactician_substrategy_p(strategy)) {
    ...
    public static SubLObject set_tactic_recompute_set_aside_wrt(SubLObject tactic, SubLObject strategy, SubLObject motivation) {
	{
	    SubLObject pcase_var = motivation;
	    if (pcase_var.eql($REMOVAL)) {
    ...
    public static SubLObject set_tactic_not_thrown_away_wrt(SubLObject tactic, SubLObject strategy, SubLObject motivation) {
	{
	    SubLObject pcase_var = motivation;
	    if (pcase_var.eql($REMOVAL)) {
    ...
    public static SubLObject set_tactic_not_set_aside_wrt(SubLObject tactic, SubLObject strategy, SubLObject motivation) {
	{
	    SubLObject pcase_var = motivation;
	    if (pcase_var.eql($REMOVAL)) {
    ...
    public static SubLObject set_problem_thrown_away_wrt(SubLObject problem, SubLObject strategy, SubLObject motivation) {
	{
	    SubLObject pcase_var = motivation;
	    if (pcase_var.eql($REMOVAL)) {
    ...
    public static SubLObject set_problem_tactics_recompute_thrown_away_wrt_all_relevant_strategies_and_all_motivations(SubLObject problem) {
	{
    ...
    public static SubLObject set_problem_tactics_recompute_thrown_away_wrt_all_motivations(SubLObject problem, SubLObject strategy) {
	{
    ...
    public static SubLObject set_problem_tactics_recompute_set_aside_wrt_all_relevant_strategies_and_all_motivations(SubLObject problem) {
	{
	    SubLObject prob = problem;
	    SubLObject store = inference_datastructures_problem.problem_store(prob);
	    SubLObject idx = inference_datastructures_problem_store.problem_store_inference_id_index(store);
			...
			if (NIL != do_id_index_id_and_object_validP(id, inference, $SKIP)) {
			    if (NIL != inference_datastructures_problem.problem_relevant_to_inferenceP(prob, inference)) {
				{
				    ...
				    for (state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); NIL == set_contents.do_set_contents_doneP(basis_object, state); state = set_contents.do_set_contents_update_state(state)) {
					{
					    SubLObject strategy = set_contents.do_set_contents_next(basis_object, state);
					    if (NIL != set_contents.do_set_contents_element_validP(state, strategy)) {
						set_problem_tactics_recompute_set_aside_wrt_all_motivations(problem, strategy);
					    }
					}
				    }
				}
    ...
    public static SubLObject set_problem_tactics_recompute_set_aside_wrt_all_motivations(SubLObject problem, SubLObject strategy) {
	{
	    SubLObject cdolist_list_var = inference_datastructures_problem.problem_tactics(problem);
	    SubLObject tactic = NIL;
	    for (tactic = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest(), tactic = cdolist_list_var.first()) {
    ...
    public static SubLObject set_problem_recompute_thrown_away_wrt_transformation(SubLObject problem, SubLObject strategy) {
	{
	    SubLObject flags = problem_strategic_flags(problem, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_transformation_code(flags, encode_uninterestingness_cache_status($RECOMPUTE));
	    return set_problem_strategic_flags(problem, strategy, new_flags);
    ...
    public static SubLObject set_problem_recompute_thrown_away_wrt_all_relevant_strategies_and_all_motivations(SubLObject problem) {
	{
	    SubLObject prob = problem;
	    SubLObject store = inference_datastructures_problem.problem_store(prob);
	    SubLObject idx = inference_datastructures_problem_store.problem_store_inference_id_index(store);
    ...
    public static SubLObject set_problem_recompute_thrown_away_wrt_all_motivations(SubLObject problem, SubLObject strategy) {
	if (NIL != balancing_tactician.balancing_tactician_substrategy_p(strategy)) {
    ...
    public static SubLObject set_problem_recompute_thrown_away_wrt(SubLObject problem, SubLObject strategy, SubLObject motivation) {
	{
	    SubLObject pcase_var = motivation;
	    if (pcase_var.eql($REMOVAL)) {
    ...
    public static SubLObject set_problem_recompute_set_aside_wrt_transformation(SubLObject problem, SubLObject strategy) {
	{
	    SubLObject flags = problem_strategic_flags(problem, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_transformation_code(flags, encode_uninterestingness_cache_status($RECOMPUTE));
	    return set_problem_strategic_flags(problem, strategy, new_flags);
    ...
    public static SubLObject set_problem_recompute_set_aside_wrt_all_relevant_strategies_and_all_motivations(SubLObject problem) {
	{
	    SubLObject prob = problem;
	    SubLObject store = inference_datastructures_problem.problem_store(prob);
	    SubLObject idx = inference_datastructures_problem_store.problem_store_inference_id_index(store);
    ...
    public static SubLObject set_problem_recompute_set_aside_wrt_all_motivations(SubLObject problem, SubLObject strategy) {
	if (NIL != balancing_tactician.balancing_tactician_substrategy_p(strategy)) {
    ...
    public static SubLObject set_problem_recompute_set_aside_wrt(SubLObject problem, SubLObject strategy, SubLObject motivation) {
	{
	    SubLObject pcase_var = motivation;
	    if (pcase_var.eql($REMOVAL)) {
    ...
    public static SubLObject set_problem_not_thrown_away_wrt(SubLObject problem, SubLObject strategy, SubLObject motivation) {
	{
	    SubLObject pcase_var = motivation;
	    if (pcase_var.eql($REMOVAL)) {
    ...
    public static SubLObject set_problem_not_set_aside_wrt(SubLObject problem, SubLObject strategy, SubLObject motivation) {
	{
	    SubLObject pcase_var = motivation;
	    if (pcase_var.eql($REMOVAL)) {
    ...
    public static SubLObject problem_thrown_away_cache_status_wrt_motivation(SubLObject problem, SubLObject strategy, SubLObject motivation) {
	{
	    final SubLThread thread = SubLProcess.currentSubLThread();
	    if (NIL == $uninterestingness_cache_lookup_enabledP$.getDynamicValue(thread)) {
		return $RECOMPUTE;
    ...
    public static SubLObject problem_set_aside_cache_status_wrt_motivation(SubLObject problem, SubLObject strategy, SubLObject motivation) {
	{
	    final SubLThread thread = SubLProcess.currentSubLThread();
	    if (NIL == $uninterestingness_cache_lookup_enabledP$.getDynamicValue(thread)) {
		return $RECOMPUTE;
	...
	return decode_uninterestingness_cache_code(uninterestingness_cache_set_aside_wrt_new_root_code(problem_strategic_flags(problem, strategy)));
    }
    ...
    private static final SubLSymbol $uninterestingness_cache_set_aside_byte$ = makeSymbol("*UNINTERESTINGNESS-CACHE-SET-ASIDE-BYTE*");

    // defconstant
    @LispMethod(comment = "defconstant")
    private static final SubLSymbol $uninterestingness_cache_thrown_away_byte$ = makeSymbol("*UNINTERESTINGNESS-CACHE-THROWN-AWAY-BYTE*");

    // defconstant
    @LispMethod(comment = "defconstant")
    private static final SubLSymbol $uninterestingness_cache_set_aside_wrt_new_root_byte$ = makeSymbol("*UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-NEW-ROOT-BYTE*");

    // defconstant
    @LispMethod(comment = "defconstant")
    private static final SubLSymbol $uninterestingness_cache_set_aside_wrt_transformation_byte$ = makeSymbol("*UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-TRANSFORMATION-BYTE*");

    // defconstant
    @LispMethod(comment = "defconstant")
    private static final SubLSymbol $uninterestingness_cache_set_aside_wrt_removal_byte$ = makeSymbol("*UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-REMOVAL-BYTE*");

    // defconstant
    @LispMethod(comment = "defconstant")
    private static final SubLSymbol $uninterestingness_cache_thrown_away_wrt_new_root_byte$ = makeSymbol("*UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-NEW-ROOT-BYTE*");

    // defconstant
    @LispMethod(comment = "defconstant")
    private static final SubLSymbol $uninterestingness_cache_thrown_away_wrt_transformation_byte$ = makeSymbol("*UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-TRANSFORMATION-BYTE*");

    // defconstant
    @LispMethod(comment = "defconstant")
    private static final SubLSymbol $uninterestingness_cache_thrown_away_wrt_removal_byte$ = makeSymbol("*UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-REMOVAL-BYTE*");
 ...
 public static final String myName = "com.cyc.cycjava.cycl.inference.harness.inference_datastructures_strategy";
    ...
    static private final SubLList $list2 = list(
    ...
    static private final SubLList $list3 = list(new SubLObject[] { $SUID, makeKeyword("INFERENCE"), makeKeyword("RESULT-UNIQUENESS-CRITERION"), makeKeyword("ACTIVE-PROBLEMS"), makeKeyword("MOTIVATED-PROBLEMS"), makeKeyword("SET-ASIDE-PROBLEMS"),
	    makeKeyword("SHOULD-RECONSIDER-SET-ASIDES?"), makeKeyword("PRODUCTIVITY-LIMIT"), makeKeyword("REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT"), makeKeyword("PROOF-SPEC"), makeKeyword("PROBLEM-PROOF-SPEC-INDEX"), makeKeyword("PROBLEM-STRATEGIC-INDEX"), makeKeyword("MEMOIZATION-STATE"),
	    makeKeyword("STEP-COUNT"), $TYPE, $DATA });

    static private final SubLList $list4 = list(new SubLObject[] { makeSymbol("STRAT-SUID"), makeSymbol("STRAT-INFERENCE"), makeSymbol("STRAT-RESULT-UNIQUENESS-CRITERION"), makeSymbol("STRAT-ACTIVE-PROBLEMS"), makeSymbol("STRAT-MOTIVATED-PROBLEMS"), makeSymbol("STRAT-SET-ASIDE-PROBLEMS"),
    ...
    static private final SubLList $list5 = list(new SubLObject[] { makeSymbol("_CSETF-STRAT-SUID"), makeSymbol("_CSETF-STRAT-INFERENCE"), makeSymbol("_CSETF-STRAT-RESULT-UNIQUENESS-CRITERION"), makeSymbol("_CSETF-STRAT-ACTIVE-PROBLEMS"), makeSymbol("_CSETF-STRAT-MOTIVATED-PROBLEMS"),
    ...
    private static final SubLSymbol STRATEGY_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("STRATEGY-PRINT-FUNCTION-TRAMPOLINE");
    ...
    private static final SubLList $list119 = list(makeSymbol("STATUS"), makeSymbol("TACTIC-STRATEGIC-PROPERTY-INDEX"), makeSymbol("POSSIBLE-TACTIC-COUNT"), makeKeyword("FLAGS"), makeSymbol("UNINTERESTINGNESS"));

    private static final SubLList $list120 = list(makeKeyword("STATUS"), makeKeyword("TACTIC-STRATEGIC-PROPERTY-INDEX"), makeKeyword("POSSIBLE-TACTIC-COUNT"), makeKeyword("FLAGS"), makeKeyword("UNINTERESTINGNESS"));

    private static final SubLList $list121 = list(makeSymbol("PROB-STRATEGIC-PROPERTIES-STATUS"), makeSymbol("PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX"), makeSymbol("PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT"), makeSymbol("PROB-STRATEGIC-PROPERTIES-FLAGS"),
	    makeSymbol("PROB-STRATEGIC-PROPERTIES-UNINTERESTINGNESS"));

    private static final SubLList $list122 = list(makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-STATUS"), makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX"), makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT"),
	    makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-FLAGS"), makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-UNINTERESTINGNESS"));
    ...
    private static final SubLList $list159 = list(makeSymbol("_CSETF-TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL"), makeSymbol("_CSETF-TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL-JUSTIFICATION"), makeSymbol("_CSETF-TACT-STRATEGIC-PROPERTIES-PRODUCTIVITY"),
	...
	assert NIL != inference_datastructures_strategy.strategy_p(v_object) : "! inference_datastructures_strategy.strategy_p(v_object) " + "inference_datastructures_strategy.strategy_p error :" + v_object;
    ...
    public static SubLObject _csetf_strat_removal_backtracking_productivity_limit_alt(SubLObject v_object, SubLObject value) {
	SubLTrampolineFile.checkType(v_object, inference_datastructures_strategy.STRATEGY_P);
	return (($strategy_native) v_object).$productivity_limit = (value);
    }
	...
	for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
		...
		inference_datastructures_strategy._csetf_strat_removal_backtracking_productivity_limit(v_new, current_value);
	...
	funcall(visitor_fn, obj, $SLOT, inference_datastructures_strategy.$RESULT_UNIQUENESS_CRITERION, inference_datastructures_strategy.strat_result_uniqueness_criterion(obj));
	funcall(visitor_fn, obj, $SLOT, $ACTIVE_PROBLEMS, inference_datastructures_strategy.strat_active_problems(obj));
	funcall(visitor_fn, obj, $SLOT, $MOTIVATED_PROBLEMS, inference_datastructures_strategy.strat_motivated_problems(obj));
	funcall(visitor_fn, obj, $SLOT, inference_datastructures_strategy.$SET_ASIDE_PROBLEMS, inference_datastructures_strategy.strat_set_aside_problems(obj));
	funcall(visitor_fn, obj, $SLOT, inference_datastructures_strategy.$kw47$SHOULD_RECONSIDER_SET_ASIDES_, inference_datastructures_strategy.strat_should_reconsider_set_asidesP(obj));
	funcall(visitor_fn, obj, $SLOT, $PRODUCTIVITY_LIMIT, inference_datastructures_strategy.strat_productivity_limit(obj));
	funcall(visitor_fn, obj, $SLOT, inference_datastructures_strategy.$REMOVAL_BACKTRACKING_PRODUCTIVITY_LIMIT, inference_datastructures_strategy.strat_removal_backtracking_productivity_limit(obj));
	funcall(visitor_fn, obj, $SLOT, $PROOF_SPEC, inference_datastructures_strategy.strat_proof_spec(obj));
	funcall(visitor_fn, obj, $SLOT, inference_datastructures_strategy.$PROBLEM_PROOF_SPEC_INDEX, inference_datastructures_strategy.strat_problem_proof_spec_index(obj));
	funcall(visitor_fn, obj, $SLOT, inference_datastructures_strategy.$PROBLEM_STRATEGIC_INDEX, inference_datastructures_strategy.strat_problem_strategic_index(obj));
	funcall(visitor_fn, obj, $SLOT, $MEMOIZATION_STATE, inference_datastructures_strategy.strat_memoization_state(obj));
	...
	return makeBoolean((NIL != inference_datastructures_strategy.strategy_p(v_object)) && (NIL == inference_datastructures_strategy.strategy_invalid_p(v_object)));
    }
	...
	if (NIL != inference_datastructures_strategy.strategy_invalid_p(v_object)) {
	    format(stream, inference_datastructures_strategy.$str64$_Invalid_STRATEGY__s_, inference_datastructures_strategy.strat_suid(v_object));
	} else {
	...
	assert NIL != inference_datastructures_strategy.strategy_type_p(type) : "! inference_datastructures_strategy.strategy_type_p(type) " + ("inference_datastructures_strategy.strategy_type_p(type) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_type_p(type) ") + type;
	...
	inference_datastructures_strategy._csetf_strat_active_problems(strategy, set.new_set(symbol_function(EQ), UNPROVIDED));
	inference_datastructures_strategy._csetf_strat_motivated_problems(strategy, set_contents.new_set_contents(ZERO_INTEGER, symbol_function(EQ)));
	inference_datastructures_strategy._csetf_strat_set_aside_problems(strategy, set.new_set(symbol_function(EQ), UNPROVIDED));
	inference_datastructures_strategy._csetf_strat_problem_proof_spec_index(strategy, dictionary.new_dictionary(symbol_function(EQ), UNPROVIDED));
	inference_datastructures_strategy._csetf_strat_should_reconsider_set_asidesP(strategy, NIL);
	inference_datastructures_strategy._csetf_strat_productivity_limit(strategy, inference_datastructures_enumerated_types.$default_productivity_limit$.getGlobalValue());
	inference_datastructures_strategy._csetf_strat_removal_backtracking_productivity_limit(strategy, inference_datastructures_enumerated_types.$default_removal_backtracking_productivity_limit$.getGlobalValue());
	inference_datastructures_strategy._csetf_strat_proof_spec(strategy, inference_datastructures_enumerated_types.$default_proof_spec$.getGlobalValue());
	inference_datastructures_strategy._csetf_strat_problem_strategic_index(strategy, make_hash_table(ONE_INTEGER, symbol_function(EQ), UNPROVIDED));
	inference_datastructures_strategy._csetf_strat_memoization_state(strategy, memoization_state.new_memoization_state(inference_datastructures_strategy.$$$strategy_memoization_state, UNPROVIDED, UNPROVIDED, UNPROVIDED));
	...
	if (NIL != inference_datastructures_strategy.valid_strategy_p(strategy)) {
	    ...
	    inference_datastructures_problem_store.remove_problem_store_strategy(inference_datastructures_strategy.strategy_problem_store(strategy), strategy);
	    inference_datastructures_inference.remove_inference_strategy(inference_datastructures_strategy.strategy_inference(strategy), strategy);
    ...
    public static SubLObject set_strategy_result_uniqueness_criterion_alt(SubLObject strategy, SubLObject result_uniqueness_criterion) {
	SubLTrampolineFile.checkType(strategy, STRATEGY_P);
	...
	assert NIL != inference_datastructures_strategy.strategy_p(strategy) : "! inference_datastructures_strategy.strategy_p(strategy) " + ("inference_datastructures_strategy.strategy_p(strategy) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_p(strategy) ") + strategy;
	assert NIL != inference_datastructures_enumerated_types.result_uniqueness_criterion_p(result_uniqueness_criterion) : "! inference_datastructures_enumerated_types.result_uniqueness_criterion_p(result_uniqueness_criterion) "
		+ ("inference_datastructures_enumerated_types.result_uniqueness_criterion_p(result_uniqueness_criterion) " + "CommonSymbols.NIL != inference_datastructures_enumerated_types.result_uniqueness_criterion_p(result_uniqueness_criterion) ") + result_uniqueness_criterion;
	inference_datastructures_strategy._csetf_strat_result_uniqueness_criterion(strategy, result_uniqueness_criterion);
	return strategy;
    }
	...
	assert NIL != inference_datastructures_strategy.strategy_p(strategy) : "! inference_datastructures_strategy.strategy_p(strategy) " + ("inference_datastructures_strategy.strategy_p(strategy) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_p(strategy) ") + strategy;
	assert NIL != inference_datastructures_enumerated_types.productivity_p(productivity_limit) : "! inference_datastructures_enumerated_types.productivity_p(productivity_limit) "
		+ ("inference_datastructures_enumerated_types.productivity_p(productivity_limit) " + "CommonSymbols.NIL != inference_datastructures_enumerated_types.productivity_p(productivity_limit) ") + productivity_limit;
	inference_datastructures_strategy._csetf_strat_productivity_limit(strategy, productivity_limit);
	return strategy;
    }

    public static SubLObject set_strategy_removal_backtracking_productivity_limit_alt(SubLObject strategy, SubLObject productivity_limit) {
	SubLTrampolineFile.checkType(strategy, STRATEGY_P);
	SubLTrampolineFile.checkType(productivity_limit, PRODUCTIVITY_P);
	...
	assert NIL != inference_datastructures_enumerated_types.productivity_p(productivity_limit) : "! inference_datastructures_enumerated_types.productivity_p(productivity_limit) "
		+ ("inference_datastructures_enumerated_types.productivity_p(productivity_limit) " + "CommonSymbols.NIL != inference_datastructures_enumerated_types.productivity_p(productivity_limit) ") + productivity_limit;
	inference_datastructures_strategy._csetf_strat_removal_backtracking_productivity_limit(strategy, productivity_limit);
	return strategy;
    }
	...
	assert NIL != inference_datastructures_strategy.strategy_p(strategy) : "! inference_datastructures_strategy.strategy_p(strategy) " + ("inference_datastructures_strategy.strategy_p(strategy) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_p(strategy) ") + strategy;
	assert NIL != inference_proof_spec.proof_spec_p(proof_spec) : "! inference_proof_spec.proof_spec_p(proof_spec) " + ("inference_proof_spec.proof_spec_p(proof_spec) " + "CommonSymbols.NIL != inference_proof_spec.proof_spec_p(proof_spec) ") + proof_spec;
	...
	current = body = temp;
	return listS(DO_SET, list(problem_var, list(inference_datastructures_strategy.STRATEGY_ACTIVE_PROBLEMS, strategy), $DONE, done), append(body, NIL));
    }
	...
	final SubLObject body;
	current = body = temp;
	return listS(DO_SET_CONTENTS, list(problem_var, list(inference_datastructures_strategy.STRATEGY_MOTIVATED_PROBLEMS, strategy), $DONE, done), append(body, NIL));
    }
	...
	final SubLObject body;
	current = body = temp;
	return listS(DO_SET, list(problem_var, list(inference_datastructures_strategy.STRATEGY_SET_ASIDE_PROBLEMS, strategy), $DONE, done), append(body, NIL));
    }
	...
	return list(CLET, list(list(strategy_var, strategy), list(state_var, list(inference_datastructures_strategy.STRATEGY_MEMOIZATION_STATE, strategy_var)), list(inference_datastructures_strategy.$current_strategy_wrt_memoization$, strategy_var)),
	...
	return NIL != inference_datastructures_strategy.strategy_p(strategic_context) ? inference_datastructures_strategy.strategy_inference(strategic_context) : NIL;
    }
	...
	return inference_datastructures_inference.inference_root_link(inference_datastructures_strategy.strategy_inference(strategy));
    }
	...
	return inference_worker_answer.answer_link_propagatedP(inference_datastructures_strategy.strategy_answer_link(strategy));
    }
	...
	if ((NIL != inference_worker.inference_deems_answer_link_should_be_closedP(inference_datastructures_strategy.strategy_inference(strategy), inference_datastructures_strategy.strategy_answer_link(strategy)))
		&& (NIL != inference_datastructures_inference.inference_has_some_answerP(inference_datastructures_strategy.strategy_inference(strategy)))) {
	    return NIL;
	}
	return T;
    }
	...
	return inference_datastructures_inference.inference_root_problem(inference_datastructures_strategy.strategy_inference(strategy));
    }
	...
	return inference_datastructures_inference.inference_continuableP(inference_datastructures_strategy.strategy_inference(strategy));
    }
	...
	return set_contents.set_contents_memberP(problem, inference_datastructures_strategy.strategy_motivated_problems(strategy), symbol_function(EQ));
    }
	...
	return makeBoolean(NIL == set.set_emptyP(inference_datastructures_strategy.strategy_set_aside_problems(strategy)));
    }
	...
	return list_utilities.delete_if_not(inference_datastructures_strategy.VALID_PROBLEM_P, set.set_element_list(inference_datastructures_strategy.strategy_set_aside_problems(strategy)), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
    }
	...
	return inference_datastructures_inference.inference_problem_store(inference_datastructures_strategy.strategy_inference(strategy));
    }
	...
	final SubLObject local_criterion = inference_datastructures_strategy.strategy_local_result_uniqueness_criterion(strategy);
	if (NIL != local_criterion) {
	    return local_criterion;
	}
	...
	return dictionary.dictionary_lookup_without_values(inference_datastructures_strategy.strategy_problem_proof_spec_index(strategy), problem, $ANYTHING);
    }
	...
	assert NIL != inference_datastructures_strategy.strategy_p(strategy) : "! inference_datastructures_strategy.strategy_p(strategy) " + ("inference_datastructures_strategy.strategy_p(strategy) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_p(strategy) ") + strategy;
	assert NIL != inference_datastructures_enumerated_types.strategy_property_p(property) : "! inference_datastructures_enumerated_types.strategy_property_p(property) "
		+ ("inference_datastructures_enumerated_types.strategy_property_p(property) " + "CommonSymbols.NIL != inference_datastructures_enumerated_types.strategy_property_p(property) ") + property;
	...
	inference_datastructures_strategy.set_strategy_productivity_limit(target_strategy, inference_datastructures_strategy.strategy_productivity_limit(source_strategy));
	inference_datastructures_strategy.set_strategy_removal_backtracking_productivity_limit(target_strategy, inference_datastructures_strategy.strategy_removal_backtracking_productivity_limit(source_strategy));
	inference_datastructures_strategy.set_strategy_proof_spec(target_strategy, inference_datastructures_strategy.strategy_proof_spec(source_strategy));
	...
	assert NIL != inference_datastructures_enumerated_types.strategy_properties_p(strategy_properties) : "! inference_datastructures_enumerated_types.strategy_properties_p(strategy_properties) "
		+ ("inference_datastructures_enumerated_types.strategy_properties_p(strategy_properties) " + "CommonSymbols.NIL != inference_datastructures_enumerated_types.strategy_properties_p(strategy_properties) ") + strategy_properties;
	...
	inference_datastructures_strategy._csetf_strat_motivated_problems(strategy, set_contents.set_contents_add(problem, motivated_problems, symbol_function(EQ)));
	inference_datastructures_strategy.controlling_strategy_callback(strategy, inference_datastructures_strategy.$SUBSTRATEGY_STRATEGEM_MOTIVATED, problem, UNPROVIDED, UNPROVIDED, UNPROVIDED);
	return strategy;
    }
	...
	set_contents.set_contents_delete(problem, inference_datastructures_strategy.strategy_motivated_problems(strategy), symbol_function(EQ));
	return strategy;
    }
    ...
    public static SubLObject with_strategically_active_problem_alt(SubLObject macroform, SubLObject environment) {
	{
		...
		current = current.first();
		{
			...
			current = temp;
			{
			    ...
			    return listS(CLET, list(list(strategy_var, strategy), list(problem_var, problem)), list(STRATEGY_NOTE_PROBLEM_ACTIVE, strategy_var, problem_var),
				    append(body, list(list(STRATEGY_NOTE_PROBLEM_INACTIVE, strategy_var, problem_var), list(POSSIBLY_REACTIVATE_PROBLEM, strategy_var, problem_var))));
			}
		    } else {
	...
	if (NIL == current) {
	    ...
	    return listS(CLET, list(list(strategy_var, strategy), list(problem_var, problem)), list(inference_datastructures_strategy.STRATEGY_NOTE_PROBLEM_ACTIVE, strategy_var, problem_var),
		    append(body, list(list(inference_datastructures_strategy.STRATEGY_NOTE_PROBLEM_INACTIVE, strategy_var, problem_var), list(inference_datastructures_strategy.POSSIBLY_REACTIVATE_PROBLEM, strategy_var, problem_var))));
	}
    ...
    public static SubLObject strategy_note_problem_proof_spec_alt(SubLObject strategy, SubLObject problem, SubLObject proof_spec) {
	SubLTrampolineFile.checkType(problem, PROBLEM_P);
	{
	...
	assert NIL != inference_datastructures_problem.problem_p(problem) : "! inference_datastructures_problem.problem_p(problem) " + ("inference_datastructures_problem.problem_p(problem) " + "CommonSymbols.NIL != inference_datastructures_problem.problem_p(problem) ") + problem;
	final SubLObject old_value = dictionary.dictionary_lookup_without_values(inference_datastructures_strategy.strategy_problem_proof_spec_index(strategy), problem, $NOTHING);
	final SubLObject new_value = inference_proof_spec.merge_2_proof_specs(old_value, proof_spec);
	if (!new_value.equal(old_value)) {
	    dictionary.dictionary_enter(inference_datastructures_strategy.strategy_problem_proof_spec_index(strategy), problem, new_value);
    ...
    public static SubLObject strategy_dispatch_alt(SubLObject strategy, SubLObject method_type, SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4, SubLObject arg5) {
	...
	if ((NIL == handler_func) && (NIL != balancing_tactician.balancing_tactician_p(strategy))) {
	    return Errors.error(inference_datastructures_strategy.$str111$balancing_tactician_does_not_impl, method_type);
	}
	if (NIL != arg5_providedP) {
	    return inference_datastructures_strategy.strategy_dispatch_funcall_5(handler_func, strategy, arg1, arg2, arg3, arg4, arg5);
	}
	if (NIL != arg4_providedP) {
	    return inference_datastructures_strategy.strategy_dispatch_funcall_4(handler_func, strategy, arg1, arg2, arg3, arg4);
	}
	if (NIL != arg3_providedP) {
	    return inference_datastructures_strategy.strategy_dispatch_funcall_3(handler_func, strategy, arg1, arg2, arg3);
	}
	if (NIL != arg2_providedP) {
    ...
    public static SubLObject strategy_dispatch_funcall_2_alt(SubLObject func, SubLObject strategy, SubLObject arg1, SubLObject arg2) {
	{
	    SubLObject pcase_var = func;
    ...
    public static SubLObject strategy_dispatch_funcall_3_alt(SubLObject func, SubLObject strategy, SubLObject arg1, SubLObject arg2, SubLObject arg3) {
	{
	    SubLObject pcase_var = func;
    ...
    public static SubLObject strategy_dispatch_funcall_4_alt(SubLObject func, SubLObject strategy, SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4) {
	{
	    SubLObject pcase_var = func;
    ...
    public static SubLObject strategy_dispatch_funcall_5_alt(SubLObject func, SubLObject strategy, SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4, SubLObject arg5) {
	{
	    SubLObject pcase_var = func;
    ...
    public static SubLObject controlling_strategy_callback_alt(SubLObject substrategy, SubLObject method_type, SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4) {
	SubLObject arg1_providedP = makeBoolean(arg1 != UNPROVIDED);
	SubLObject arg2_providedP = makeBoolean(arg2 != UNPROVIDED);
	SubLObject arg3_providedP = makeBoolean(arg3 != UNPROVIDED);
	SubLObject arg4_providedP = makeBoolean(arg4 != UNPROVIDED);
	...
	if (NIL != arg4_providedP) {
	    return inference_datastructures_strategy.strategy_dispatch(controlling_strategy, method_type, substrategy, arg1, arg2, arg3, arg4);
	}
	if (NIL != arg3_providedP) {
	    return inference_datastructures_strategy.strategy_dispatch(controlling_strategy, method_type, substrategy, arg1, arg2, arg3, UNPROVIDED);
	}
	if (NIL != arg2_providedP) {
	    return inference_datastructures_strategy.strategy_dispatch(controlling_strategy, method_type, substrategy, arg1, arg2, UNPROVIDED, UNPROVIDED);
	}
	if (NIL != arg1_providedP) {
	    return inference_datastructures_strategy.strategy_dispatch(controlling_strategy, method_type, substrategy, arg1, UNPROVIDED, UNPROVIDED, UNPROVIDED);
	}
	return inference_datastructures_strategy.strategy_dispatch(controlling_strategy, method_type, substrategy, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
    }
	...
	assert NIL != inference_datastructures_enumerated_types.strategy_type_property_p(property) : "! inference_datastructures_enumerated_types.strategy_type_property_p(property) "
		+ ("inference_datastructures_enumerated_types.strategy_type_property_p(property) " + "CommonSymbols.NIL != inference_datastructures_enumerated_types.strategy_type_property_p(property) ") + property;
	return dictionary_utilities.dictionary_putf($strategy_type_store$.getGlobalValue(), type, property, value);
    }
    ...
    public static SubLObject problem_strategic_properties_print_function_trampoline_alt(SubLObject v_object, SubLObject stream) {
	...
	return v_object.getClass() == inference_datastructures_strategy.$problem_strategic_properties_native.class ? ((SubLObject) (T)) : NIL;
    }
	...
	assert NIL != inference_datastructures_strategy.problem_strategic_properties_p(v_object) : "! inference_datastructures_strategy.problem_strategic_properties_p(v_object) " + "inference_datastructures_strategy.problem_strategic_properties_p error :" + v_object;
	return v_object.getField2();
    }
    ...
    public static SubLObject _csetf_prob_strategic_properties_tactic_strategic_property_index_alt(SubLObject v_object, SubLObject value) {
	SubLTrampolineFile.checkType(v_object, PROBLEM_STRATEGIC_PROPERTIES_P);
	return v_object.setField3(value);
    }
    ...
    public static SubLObject _csetf_prob_strategic_properties_possible_tactic_count_alt(SubLObject v_object, SubLObject value) {
	SubLTrampolineFile.checkType(v_object, PROBLEM_STRATEGIC_PROPERTIES_P);
	return v_object.setField4(value);
    }
	...
	for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
		...
		inference_datastructures_strategy._csetf_prob_strategic_properties_tactic_strategic_property_index(v_new, current_value);
	    } else if (pcase_var.eql($POSSIBLE_TACTIC_COUNT)) {
		inference_datastructures_strategy._csetf_prob_strategic_properties_possible_tactic_count(v_new, current_value);
	    } else if (pcase_var.eql($UNINTERESTINGNESS)) {
		inference_datastructures_strategy._csetf_prob_strategic_properties_uninterestingness(v_new, current_value);
	    } else {
		Errors.error(inference_datastructures_strategy.$str57$Invalid_slot__S_for_construction_, current_arg);
	    }
	...
	funcall(visitor_fn, obj, $BEGIN, inference_datastructures_strategy.MAKE_PROBLEM_STRATEGIC_PROPERTIES, FOUR_INTEGER);
	funcall(visitor_fn, obj, $SLOT, $STATUS, inference_datastructures_strategy.prob_strategic_properties_status(obj));
	funcall(visitor_fn, obj, $SLOT, $TACTIC_STRATEGIC_PROPERTY_INDEX, inference_datastructures_strategy.prob_strategic_properties_tactic_strategic_property_index(obj));
	funcall(visitor_fn, obj, $SLOT, $POSSIBLE_TACTIC_COUNT, inference_datastructures_strategy.prob_strategic_properties_possible_tactic_count(obj));
	funcall(visitor_fn, obj, $SLOT, $UNINTERESTINGNESS, inference_datastructures_strategy.prob_strategic_properties_uninterestingness(obj));
	funcall(visitor_fn, obj, $END, inference_datastructures_strategy.MAKE_PROBLEM_STRATEGIC_PROPERTIES, FOUR_INTEGER);
	return obj;
    }
	...
	final SubLObject problem_strategic_properties = inference_datastructures_strategy.make_problem_strategic_properties(UNPROVIDED);
	inference_datastructures_strategy._csetf_prob_strategic_properties_status(problem_strategic_properties, $NEW);
	inference_datastructures_strategy._csetf_prob_strategic_properties_tactic_strategic_property_index(problem_strategic_properties, NIL);
	inference_datastructures_strategy._csetf_prob_strategic_properties_possible_tactic_count(problem_strategic_properties, ZERO_INTEGER);
	inference_datastructures_strategy._csetf_prob_strategic_properties_uninterestingness(problem_strategic_properties, inference_datastructures_strategy.default_uninterestingness_cache_value());
	return problem_strategic_properties;
    }
	...
	SubLTrampolineFile.checkType(strategy, STRATEGY_P);
	{
	    SubLObject problem_strategic_properties = gethash_without_values(problem, strategy_problem_strategic_index(strategy), UNPROVIDED);
	    return problem_strategic_properties;
	}
    }
	...
	assert NIL != inference_datastructures_problem.problem_p(problem) : "! inference_datastructures_problem.problem_p(problem) " + ("inference_datastructures_problem.problem_p(problem) " + "CommonSymbols.NIL != inference_datastructures_problem.problem_p(problem) ") + problem;
	assert NIL != inference_datastructures_strategy.strategy_p(strategy) : "! inference_datastructures_strategy.strategy_p(strategy) " + ("inference_datastructures_strategy.strategy_p(strategy) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_p(strategy) ") + strategy;
	final SubLObject problem_strategic_properties = gethash_without_values(problem, inference_datastructures_strategy.strategy_problem_strategic_index(strategy), UNPROVIDED);
	return problem_strategic_properties;
    }

    public static SubLObject set_problem_strategic_properties_alt(SubLObject problem, SubLObject strategy, SubLObject v_properties) {
	SubLTrampolineFile.checkType(problem, PROBLEM_P);
	SubLTrampolineFile.checkType(strategy, STRATEGY_P);
	...
	assert NIL != inference_datastructures_problem.problem_p(problem) : "! inference_datastructures_problem.problem_p(problem) " + ("inference_datastructures_problem.problem_p(problem) " + "CommonSymbols.NIL != inference_datastructures_problem.problem_p(problem) ") + problem;
	assert NIL != inference_datastructures_strategy.strategy_p(strategy) : "! inference_datastructures_strategy.strategy_p(strategy) " + ("inference_datastructures_strategy.strategy_p(strategy) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_p(strategy) ") + strategy;
	assert NIL != inference_datastructures_strategy.problem_strategic_properties_p(v_properties) : "! inference_datastructures_strategy.problem_strategic_properties_p(v_properties) "
		+ ("inference_datastructures_strategy.problem_strategic_properties_p(v_properties) " + "CommonSymbols.NIL != inference_datastructures_strategy.problem_strategic_properties_p(v_properties) ") + v_properties;
	...
	SubLObject problem_strategic_properties = inference_datastructures_strategy.problem_strategic_properties_int(problem, strategy);
	if (NIL == inference_datastructures_strategy.problem_strategic_properties_p(problem_strategic_properties)) {
	    ...
	    inference_datastructures_strategy.set_problem_strategic_properties(problem, strategy, problem_strategic_properties);
	}
	return problem_strategic_properties;
    }
    ...
    public static SubLObject problem_strategic_properties_tactic_strategic_property_index_alt(SubLObject problem, SubLObject problem_strategic_properties) {
	{
	...
	SubLObject tactic_properties_vector = inference_datastructures_strategy.prob_strategic_properties_tactic_strategic_property_index(problem_strategic_properties);
	if (!tactic_properties_vector.isVector()) {
	    tactic_properties_vector = make_vector(inference_datastructures_problem.problem_tactic_count(problem), UNPROVIDED);
	    inference_datastructures_strategy._csetf_prob_strategic_properties_tactic_strategic_property_index(problem_strategic_properties, tactic_properties_vector);
	}
	if (length(tactic_properties_vector).numL(inference_datastructures_problem.problem_tactic_count(problem))) {
	    tactic_properties_vector = vector_utilities.extend_vector_to(tactic_properties_vector, inference_datastructures_problem.problem_tactic_count(problem), UNPROVIDED);
	    inference_datastructures_strategy._csetf_prob_strategic_properties_tactic_strategic_property_index(problem_strategic_properties, tactic_properties_vector);
	...
	final SubLObject strategic_status = inference_datastructures_strategy.problem_raw_strategic_status(problem, strategy);
	...
	final SubLObject problem_strategic_properties = inference_datastructures_strategy.problem_strategic_properties(problem, strategy);
	final SubLObject strategic_status = inference_datastructures_strategy.prob_strategic_properties_status(problem_strategic_properties);
	if (($NEW == strategic_status) && ($NEW != inference_datastructures_problem.problem_status(problem))) {
	    return $UNEXAMINED;
	}
	return strategic_status;
	...
	final SubLObject weak_tactical_status = inference_datastructures_strategy.problem_weak_strategic_status(problem, strategy);
	if (NIL != inference_datastructures_problem.tactically_finished_problem_p(problem)) {
	    return $FINISHED;
	}
	return weak_tactical_status;
    ...
    public static SubLObject problem_strategic_provability_status_alt(SubLObject problem, SubLObject strategy) {
	{
	    ...
	    if (($NEUTRAL == weak_provability_status) && (NIL != inference_datastructures_problem.tactically_good_problem_p(problem))) {
		return $GOOD;
	    } else {
    ...
    public static SubLObject problem_tactical_or_strategic_status_alt(SubLObject problem, SubLObject strategic_context) {
	SubLTrampolineFile.checkType(strategic_context, STRATEGIC_CONTEXT_P);
	return NIL != strategy_p(strategic_context) ? ((SubLObject) (problem_strategic_status(problem, strategic_context))) : inference_datastructures_problem.problem_tactical_status(problem);
    }
	...
	assert NIL != inference_worker.strategic_context_p(strategic_context) : "! inference_worker.strategic_context_p(strategic_context) " + ("inference_worker.strategic_context_p(strategic_context) " + "CommonSymbols.NIL != inference_worker.strategic_context_p(strategic_context) ")
		+ strategic_context;
	return NIL != inference_datastructures_strategy.strategy_p(strategic_context) ? inference_datastructures_strategy.problem_strategic_status(problem, strategic_context) : inference_datastructures_problem.problem_tactical_status(problem);
    }
	...
	SubLTrampolineFile.checkType(strategic_context, STRATEGIC_CONTEXT_P);
	return NIL != strategy_p(strategic_context) ? ((SubLObject) (problem_strategic_provability_status(problem, strategic_context))) : inference_datastructures_problem.problem_tactical_provability_status(problem);
    }
	...
	assert NIL != inference_worker.strategic_context_p(strategic_context) : "! inference_worker.strategic_context_p(strategic_context) " + ("inference_worker.strategic_context_p(strategic_context) " + "CommonSymbols.NIL != inference_worker.strategic_context_p(strategic_context) ")
		+ strategic_context;
	return NIL != inference_datastructures_strategy.strategy_p(strategic_context) ? inference_datastructures_strategy.problem_strategic_provability_status(problem, strategic_context) : inference_datastructures_problem.problem_tactical_provability_status(problem);
    }

    public static SubLObject set_problem_raw_strategic_status_alt(SubLObject problem, SubLObject strategy, SubLObject status) {
	{
	    SubLObject problem_strategic_properties = problem_strategic_properties(problem, strategy);
	...
	if ((NIL == Errors.$ignore_mustsP$.getDynamicValue(thread)) && (NIL != inference_datastructures_enumerated_types.good_problem_status_p(status))) {
	    Errors.error(inference_datastructures_strategy.$str146$poking_good_status__s_into_proble, status, problem, strategy);
	}
	if ((NIL == Errors.$ignore_mustsP$.getDynamicValue(thread)) && (inference_datastructures_strategy.$POSSIBLE_NO_GOOD == status)) {
	...
	return makeBoolean((NIL != inference_datastructures_strategy.strategically_possible_problem_p(problem, strategy)) || (NIL != inference_datastructures_problem.tactically_unexamined_problem_p(problem)));
    }

    public static SubLObject strategically_not_potentially_possible_problem_p_alt(SubLObject problem, SubLObject strategy) {
	...
	return makeBoolean(((NIL != inference_datastructures_strategy.strategically_examined_problem_p(problem, strategy)) || (NIL != inference_datastructures_strategy.strategically_pending_problem_p(problem, strategy)))
	...
	return inference_datastructures_strategy.strategically_no_good_problem_p(problem, inference_tactician.controlling_strategy(strategy));
    }

    public static SubLObject problem_strategic_uninterestingness(final SubLObject problem, final SubLObject strategy) {
	final SubLObject problem_strategic_properties = inference_datastructures_strategy.problem_strategic_properties(problem, strategy);
	return inference_datastructures_strategy.prob_strategic_properties_uninterestingness(problem_strategic_properties);
    }
	...
	assert NIL != inference_datastructures_strategy.uninterestingness_cache_value_p(uninterestingness) : "! inference_datastructures_strategy.uninterestingness_cache_value_p(uninterestingness) "
		+ ("inference_datastructures_strategy.uninterestingness_cache_value_p(uninterestingness) " + "CommonSymbols.NIL != inference_datastructures_strategy.uninterestingness_cache_value_p(uninterestingness) ") + uninterestingness;
	final SubLObject problem_strategic_properties = inference_datastructures_strategy.problem_strategic_properties(problem, strategy);
	inference_datastructures_strategy._csetf_prob_strategic_properties_uninterestingness(problem_strategic_properties, uninterestingness);
	...
	final SubLObject uninterestingness = inference_datastructures_strategy.problem_strategic_uninterestingness(problem, strategy);
	final SubLObject new_uninterestingness = inference_datastructures_strategy.note_uninterestingness_cache_thrown_away_value(uninterestingness, T, conditions);
	return inference_datastructures_strategy.set_problem_strategic_uninterestingness(problem, strategy, new_uninterestingness);
    }
	...
	final SubLObject uninterestingness = inference_datastructures_strategy.problem_strategic_uninterestingness(problem, strategy);
	final SubLObject new_uninterestingness = inference_datastructures_strategy.note_uninterestingness_cache_thrown_away_value(uninterestingness, NIL, conditions);
	return inference_datastructures_strategy.set_problem_strategic_uninterestingness(problem, strategy, new_uninterestingness);
    }

    public static SubLObject set_just_problem_recompute_thrown_away(final SubLObject problem, final SubLObject strategy) {
	final SubLObject uninterestingness = inference_datastructures_strategy.problem_strategic_uninterestingness(problem, strategy);
	final SubLObject new_uninterestingness = inference_datastructures_strategy.note_uninterestingness_cache_thrown_away_value(uninterestingness, $RECOMPUTE, $ALL);
	return inference_datastructures_strategy.set_problem_strategic_uninterestingness(problem, strategy, new_uninterestingness);
    }
	...
	final SubLObject uninterestingness = inference_datastructures_strategy.problem_strategic_uninterestingness(problem, strategy);
	final SubLObject new_uninterestingness = inference_datastructures_strategy.note_uninterestingness_cache_set_aside_value(uninterestingness, T, conditions);
	return inference_datastructures_strategy.set_problem_strategic_uninterestingness(problem, strategy, new_uninterestingness);
    }
	...
	final SubLObject uninterestingness = inference_datastructures_strategy.problem_strategic_uninterestingness(problem, strategy);
	final SubLObject new_uninterestingness = inference_datastructures_strategy.note_uninterestingness_cache_set_aside_value(uninterestingness, NIL, conditions);
	return inference_datastructures_strategy.set_problem_strategic_uninterestingness(problem, strategy, new_uninterestingness);
    }

    public static SubLObject set_just_problem_recompute_set_aside(final SubLObject problem, final SubLObject strategy) {
	final SubLObject uninterestingness = inference_datastructures_strategy.problem_strategic_uninterestingness(problem, strategy);
	final SubLObject new_uninterestingness = inference_datastructures_strategy.note_uninterestingness_cache_set_aside_value(uninterestingness, $RECOMPUTE, $ALL);
	return inference_datastructures_strategy.set_problem_strategic_uninterestingness(problem, strategy, new_uninterestingness);
    }
	...
	return inference_datastructures_strategy.thrown_away_cache_status_from_uninterestingness(inference_datastructures_strategy.problem_strategic_uninterestingness(problem, strategy), conditions);
    }
	...
	return inference_datastructures_strategy.set_aside_cache_status_from_uninterestingness(inference_datastructures_strategy.problem_strategic_uninterestingness(problem, strategy), conditions);
    }
	...
	{
	    SubLObject flags = problem_strategic_flags(problem, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_thrown_away_code(flags, encode_uninterestingness_cache_status($RECOMPUTE));
	    return set_problem_strategic_flags(problem, strategy, new_flags);
	}
    }
	...
	{
	    SubLObject flags = problem_strategic_flags(problem, strategy);
	    SubLObject new_flags = set_uninterestingness_cache_set_aside_code(flags, encode_uninterestingness_cache_status($RECOMPUTE));
	    return set_problem_strategic_flags(problem, strategy, new_flags);
	}
    }
    ...
    public static SubLObject tactic_strategic_properties_print_function_trampoline_alt(SubLObject v_object, SubLObject stream) {
	compatibility.default_struct_print_function(v_object, stream, ZERO_INTEGER);
	return NIL;
    }
	...
	assert NIL != inference_datastructures_strategy.tactic_strategic_properties_p(v_object) : "! inference_datastructures_strategy.tactic_strategic_properties_p(v_object) " + "inference_datastructures_strategy.tactic_strategic_properties_p error :" + v_object;
	return v_object.getField2();
    }
    ...
    public static SubLObject _csetf_tact_strategic_properties_preference_level_alt(SubLObject v_object, SubLObject value) {
	SubLTrampolineFile.checkType(v_object, TACTIC_STRATEGIC_PROPERTIES_P);
	return v_object.setField2(value);
    }
    ...
    public static SubLObject _csetf_tact_strategic_properties_preference_level_justification_alt(SubLObject v_object, SubLObject value) {
	SubLTrampolineFile.checkType(v_object, TACTIC_STRATEGIC_PROPERTIES_P);
	return v_object.setField3(value);
    }
	...
	private static final SubLStructDeclNative structDecl = makeStructDeclNative($tactic_strategic_properties_native.class, TACTIC_STRATEGIC_PROPERTIES, TACTIC_STRATEGIC_PROPERTIES_P,
		new String[] { "$preference_level", "$preference_level_justification", "$productivity", "$flags", "$uninterestingness" }, DEFAULT_STRUCT_PRINT_FUNCTION);
    }
	...
	for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
	    ...
	    pcase_var = current_arg;
	    if (pcase_var.eql($PREFERENCE_LEVEL)) {
		inference_datastructures_strategy._csetf_tact_strategic_properties_preference_level(v_new, current_value);
	    } else if (pcase_var.eql(inference_datastructures_strategy.$PREFERENCE_LEVEL_JUSTIFICATION)) {
		inference_datastructures_strategy._csetf_tact_strategic_properties_preference_level_justification(v_new, current_value);
		...
		inference_datastructures_strategy._csetf_tact_strategic_properties_uninterestingness(v_new, current_value);
	    } else {
		Errors.error(inference_datastructures_strategy.$str57$Invalid_slot__S_for_construction_, current_arg);
	    }
	...
	funcall(visitor_fn, obj, $BEGIN, inference_datastructures_strategy.MAKE_TACTIC_STRATEGIC_PROPERTIES, FOUR_INTEGER);
	funcall(visitor_fn, obj, $SLOT, $PREFERENCE_LEVEL, inference_datastructures_strategy.tact_strategic_properties_preference_level(obj));
	funcall(visitor_fn, obj, $SLOT, inference_datastructures_strategy.$PREFERENCE_LEVEL_JUSTIFICATION, inference_datastructures_strategy.tact_strategic_properties_preference_level_justification(obj));
	funcall(visitor_fn, obj, $SLOT, $PRODUCTIVITY, inference_datastructures_strategy.tact_strategic_properties_productivity(obj));
	funcall(visitor_fn, obj, $SLOT, $UNINTERESTINGNESS, inference_datastructures_strategy.tact_strategic_properties_uninterestingness(obj));
	funcall(visitor_fn, obj, $END, inference_datastructures_strategy.MAKE_TACTIC_STRATEGIC_PROPERTIES, FOUR_INTEGER);
	return obj;
    }
	...
	final SubLObject tactic_strategic_properties = inference_datastructures_strategy.make_tactic_strategic_properties(UNPROVIDED);
	inference_datastructures_strategy._csetf_tact_strategic_properties_preference_level(tactic_strategic_properties, preference_modules.$default_preference_level$.getGlobalValue());
	inference_datastructures_strategy._csetf_tact_strategic_properties_preference_level_justification(tactic_strategic_properties, inference_datastructures_strategy.$str175$);
	inference_datastructures_strategy._csetf_tact_strategic_properties_productivity(tactic_strategic_properties, number_utilities.positive_infinity());
	inference_datastructures_strategy._csetf_tact_strategic_properties_uninterestingness(tactic_strategic_properties, inference_datastructures_strategy.default_uninterestingness_cache_value());
	return tactic_strategic_properties;
    }
	...
	final SubLObject problem_strategic_properties = inference_datastructures_strategy.problem_strategic_properties(problem, strategy);
	if (NIL != inference_datastructures_strategy.problem_strategic_properties_p(problem_strategic_properties)) {
	    final SubLObject tactic_properties_vector = inference_datastructures_strategy.problem_strategic_properties_tactic_strategic_property_index(problem, problem_strategic_properties);
	    if (tactic_properties_vector.isVector()) {
    ...
    public static SubLObject set_tactic_strategic_properties_alt(SubLObject tactic, SubLObject strategy, SubLObject v_properties) {
	SubLTrampolineFile.checkType(tactic, TACTIC_P);
	SubLTrampolineFile.checkType(strategy, STRATEGY_P);
	...
	assert NIL != inference_datastructures_tactic.tactic_p(tactic) : "! inference_datastructures_tactic.tactic_p(tactic) " + ("inference_datastructures_tactic.tactic_p(tactic) " + "CommonSymbols.NIL != inference_datastructures_tactic.tactic_p(tactic) ") + tactic;
	assert NIL != inference_datastructures_strategy.strategy_p(strategy) : "! inference_datastructures_strategy.strategy_p(strategy) " + ("inference_datastructures_strategy.strategy_p(strategy) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_p(strategy) ") + strategy;
	assert NIL != inference_datastructures_strategy.tactic_strategic_properties_p(v_properties) : "! inference_datastructures_strategy.tactic_strategic_properties_p(v_properties) "
		+ ("inference_datastructures_strategy.tactic_strategic_properties_p(v_properties) " + "CommonSymbols.NIL != inference_datastructures_strategy.tactic_strategic_properties_p(v_properties) ") + v_properties;
	final SubLObject problem = inference_datastructures_tactic.tactic_problem(tactic);
	final SubLObject problem_strategic_properties = inference_datastructures_strategy.problem_strategic_properties(problem, strategy);
	final SubLObject tactic_properties_vector = inference_datastructures_strategy.problem_strategic_properties_tactic_strategic_property_index(problem, problem_strategic_properties);
	final SubLObject tactic_suid = inference_datastructures_tactic.tactic_suid(tactic);
	...
	SubLObject tactic_strategic_properties = inference_datastructures_strategy.tactic_strategic_properties_int(tactic, strategy);
	if (NIL == inference_datastructures_strategy.tactic_strategic_properties_p(tactic_strategic_properties)) {
	    ...
	    inference_datastructures_strategy.set_tactic_strategic_properties(tactic, strategy, tactic_strategic_properties);
	}
	return tactic_strategic_properties;
    }
	...
	if (NIL != inference_worker.generalized_structural_tactic_p(tactic)) {
	    final SubLObject tactic_strategic_properties = inference_datastructures_strategy.tactic_strategic_properties(tactic, strategic_context);
	    return inference_datastructures_strategy.tact_strategic_properties_preference_level(tactic_strategic_properties);
	}
	return Errors.error(inference_datastructures_strategy.$str179$content_tactic__s_cannot_have_a_p, tactic);
    }

    public static SubLObject tactic_strategic_preference_level_justification_alt(SubLObject tactic, SubLObject strategic_context) {
	SubLTrampolineFile.checkType(strategic_context, STRATEGIC_CONTEXT_P);
	if ($TACTICAL == strategic_context) {
	...
	if (NIL != inference_worker.generalized_structural_tactic_p(tactic)) {
	    final SubLObject tactic_strategic_properties = inference_datastructures_strategy.tactic_strategic_properties(tactic, strategic_context);
	    return inference_datastructures_strategy.tact_strategic_properties_preference_level_justification(tactic_strategic_properties);
	}
    ...
    public static SubLObject tactic_strategic_dwimmed_completeness_alt(SubLObject tactic, SubLObject strategic_context) {
	if (NIL != inference_worker.content_tactic_p(tactic)) {
	...
	return preference_modules.preference_level_to_completeness(inference_datastructures_strategy.tactic_strategic_preference_level(tactic, strategic_context));
    }

    public static SubLObject conjunctive_tactic_strategic_preference_level_alt(SubLObject tactic, SubLObject strategic_context) {
	...
	assert NIL != inference_worker.generalized_conjunctive_tactic_p(tactic) : "! inference_worker.generalized_conjunctive_tactic_p(tactic) " + ("inference_worker.generalized_conjunctive_tactic_p(tactic) " + "CommonSymbols.NIL != inference_worker.generalized_conjunctive_tactic_p(tactic) ")
		+ tactic;
	if (NIL != inference_worker_removal.conjunctive_removal_tactic_p(tactic)) {
	    return preference_modules.completeness_to_preference_level(inference_datastructures_strategy.tactic_strategic_completeness(tactic, strategic_context));
	}
	return inference_datastructures_strategy.tactic_strategic_preference_level(tactic, strategic_context);
    }

    public static SubLObject conjunctive_tactic_strategic_preference_level_justification_alt(SubLObject tactic, SubLObject strategic_context) {
	SubLTrampolineFile.checkType(tactic, GENERALIZED_CONJUNCTIVE_TACTIC_P);
	if (NIL != inference_worker_removal.conjunctive_removal_tactic_p(tactic)) {
	...
	assert NIL != inference_worker.generalized_conjunctive_tactic_p(tactic) : "! inference_worker.generalized_conjunctive_tactic_p(tactic) " + ("inference_worker.generalized_conjunctive_tactic_p(tactic) " + "CommonSymbols.NIL != inference_worker.generalized_conjunctive_tactic_p(tactic) ")
		+ tactic;
	if (NIL != inference_worker_removal.conjunctive_removal_tactic_p(tactic)) {
	    return string_utilities.str(inference_datastructures_strategy.tactic_strategic_completeness(tactic, strategic_context));
	}
	return inference_datastructures_strategy.tactic_strategic_preference_level_justification(tactic, strategic_context);
    }
    ...
    public static SubLObject set_tactic_strategic_preference_level_alt(SubLObject tactic, SubLObject strategy, SubLObject preference_level, SubLObject justification) {
	...
	assert NIL != preference_modules.preference_level_p(preference_level) : "! preference_modules.preference_level_p(preference_level) " + ("preference_modules.preference_level_p(preference_level) " + "CommonSymbols.NIL != preference_modules.preference_level_p(preference_level) ")
		+ preference_level;
	final SubLObject tactic_strategic_properties = inference_datastructures_strategy.tactic_strategic_properties(tactic, strategy);
	inference_datastructures_strategy._csetf_tact_strategic_properties_preference_level(tactic_strategic_properties, preference_level);
	inference_datastructures_strategy._csetf_tact_strategic_properties_preference_level_justification(tactic_strategic_properties, justification);
	return tactic;
    }

    public static SubLObject set_tactic_strategic_productivity_alt(SubLObject tactic, SubLObject strategy, SubLObject productivity) {
	{
	    SubLObject tactic_strategic_properties = tactic_strategic_properties(tactic, strategy);
	...
	final SubLObject tactic_strategic_properties = inference_datastructures_strategy.tactic_strategic_properties(tactic, strategy);
	inference_datastructures_strategy._csetf_tact_strategic_properties_productivity(tactic_strategic_properties, productivity);
	return tactic;
    }
	...
	assert NIL != inference_datastructures_strategy.strategy_p(strategy) : "! inference_datastructures_strategy.strategy_p(strategy) " + ("inference_datastructures_strategy.strategy_p(strategy) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_p(strategy) ") + strategy;
	final SubLObject problem_strategic_properties = inference_datastructures_strategy.problem_strategic_properties(problem, strategy);
	return inference_datastructures_strategy.prob_strategic_properties_possible_tactic_count(problem_strategic_properties);
    }

    public static SubLObject problem_note_tactic_strategically_possible_alt(SubLObject problem, SubLObject tactic, SubLObject strategy) {
	SubLTrampolineFile.checkType(problem, PROBLEM_P);
	SubLTrampolineFile.checkType(tactic, TACTIC_P);
	SubLTrampolineFile.checkType(strategy, STRATEGY_P);
	{
	...
	assert NIL != inference_datastructures_strategy.strategy_p(strategy) : "! inference_datastructures_strategy.strategy_p(strategy) " + ("inference_datastructures_strategy.strategy_p(strategy) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_p(strategy) ") + strategy;
	final SubLObject problem_strategic_properties = inference_datastructures_strategy.problem_strategic_properties(problem, strategy);
	inference_datastructures_strategy._csetf_prob_strategic_properties_possible_tactic_count(problem_strategic_properties, add(inference_datastructures_strategy.prob_strategic_properties_possible_tactic_count(problem_strategic_properties), ONE_INTEGER));
	return problem;
    }

    public static SubLObject problem_note_tactic_not_strategically_possible_alt(SubLObject problem, SubLObject tactic, SubLObject strategy) {
	SubLTrampolineFile.checkType(problem, PROBLEM_P);
	SubLTrampolineFile.checkType(tactic, TACTIC_P);
	SubLTrampolineFile.checkType(strategy, STRATEGY_P);
	{
	...
	assert NIL != inference_datastructures_strategy.strategy_p(strategy) : "! inference_datastructures_strategy.strategy_p(strategy) " + ("inference_datastructures_strategy.strategy_p(strategy) " + "CommonSymbols.NIL != inference_datastructures_strategy.strategy_p(strategy) ") + strategy;
	final SubLObject problem_strategic_properties = inference_datastructures_strategy.problem_strategic_properties(problem, strategy);
	inference_datastructures_strategy._csetf_prob_strategic_properties_possible_tactic_count(problem_strategic_properties, subtract(inference_datastructures_strategy.prob_strategic_properties_possible_tactic_count(problem_strategic_properties), ONE_INTEGER));
	return problem;
    }

    public static SubLObject problem_note_all_tactics_not_strategically_possible_alt(SubLObject problem, SubLObject strategy) {
	{
	    SubLObject problem_strategic_properties = problem_strategic_properties(problem, strategy);
	    _csetf_prob_strategic_properties_possible_tactic_count(problem_strategic_properties, ZERO_INTEGER);
	}
	...
	final SubLObject tactic_strategic_properties = inference_datastructures_strategy.tactic_strategic_properties(tactic, strategy);
	return inference_datastructures_strategy.tact_strategic_properties_uninterestingness(tactic_strategic_properties);
    }
	...
	assert NIL != inference_datastructures_strategy.uninterestingness_cache_value_p(uninterestingness) : "! inference_datastructures_strategy.uninterestingness_cache_value_p(uninterestingness) "
		+ ("inference_datastructures_strategy.uninterestingness_cache_value_p(uninterestingness) " + "CommonSymbols.NIL != inference_datastructures_strategy.uninterestingness_cache_value_p(uninterestingness) ") + uninterestingness;
	final SubLObject tactic_strategic_properties = inference_datastructures_strategy.tactic_strategic_properties(tactic, strategy);
	inference_datastructures_strategy._csetf_tact_strategic_properties_uninterestingness(tactic_strategic_properties, uninterestingness);
	return uninterestingness;
    }
	...
	return inference_datastructures_strategy.cache_status_for_conditions(aref(uninterestingness, ZERO_INTEGER), conditions);
    }
	...
	return inference_datastructures_strategy.cache_status_for_conditions(aref(uninterestingness, ONE_INTEGER), conditions);
    }
	...
	assert NIL != inference_datastructures_strategy.uninterestingness_cache_conditions_p(conditions) : "! inference_datastructures_strategy.uninterestingness_cache_conditions_p(conditions) "
		+ ("inference_datastructures_strategy.uninterestingness_cache_conditions_p(conditions) " + "CommonSymbols.NIL != inference_datastructures_strategy.uninterestingness_cache_conditions_p(conditions) ") + conditions;
	SubLObject cache_status = aref(uninterestingness, ZERO_INTEGER);
	if ((SubLMain.BOOTY_HACKZ || true) && uninterestingness == NIL)
	    return uninterestingness;
	cache_status = inference_datastructures_strategy.modify_cache_status_for_value_and_conditions(cache_status, value, conditions);
	...
	return makeBoolean(((v_object.isVector() && (NIL != list_utilities.lengthE(v_object, TWO_INTEGER, UNPROVIDED))) && (NIL != inference_datastructures_strategy.thrown_away_cache_value_p(aref(v_object, ZERO_INTEGER))))
	...
	return makeBoolean(v_object.isList() && (NIL != list_utilities.every_in_list(inference_datastructures_strategy.UNINTERESTINGNESS_CACHE_CONDITIONS_P, v_object, UNPROVIDED)));
    }
	...
	return makeBoolean(($RECOMPUTE == v_object)
		|| (((NIL != list_utilities.doubletonP(v_object)) && (NIL != inference_datastructures_strategy.uninterestingness_cache_conditions_list_p(v_object.first()))) && (NIL != inference_datastructures_strategy.uninterestingness_cache_conditions_list_p(second(v_object)))));
    }
	...
	final SubLObject uninterestingness = inference_datastructures_strategy.tactic_strategic_uninterestingness(tactic, strategy);
	final SubLObject new_uninterestingness = inference_datastructures_strategy.note_uninterestingness_cache_thrown_away_value(uninterestingness, T, conditions);
	return inference_datastructures_strategy.set_tactic_strategic_uninterestingness(tactic, strategy, new_uninterestingness);
    }
	...
	return inference_datastructures_strategy.thrown_away_cache_status_from_uninterestingness(inference_datastructures_strategy.tactic_strategic_uninterestingness(tactic, strategy), conditions);
    }
	...
	return inference_datastructures_strategy.set_aside_cache_status_from_uninterestingness(inference_datastructures_strategy.tactic_strategic_uninterestingness(tactic, strategy), conditions);
    }
	...
	inference_datastructures_strategy.set_just_problem_recompute_thrown_away(inference_datastructures_tactic.tactic_problem(tactic), strategy);
	return NIL;
    }
	...
	if ((NIL == inference_datastructures_strategy.strategy_continuableP(strategy)) && (NIL != inference_tactician.strategy_set_aside_non_continuable_implies_throw_awayP(strategy))) {
	    inference_datastructures_strategy.set_just_tactic_recompute_thrown_away(tactic, strategy);
	}
	inference_datastructures_strategy.set_just_problem_recompute_set_aside(inference_datastructures_tactic.tactic_problem(tactic), strategy);
	return NIL;
    }
	...
	if (NIL == id_index_objects_empty_p(idx, $SKIP)) {
		...
		for (length = length(vector_var), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL(length); v_iteration = add(v_iteration, ONE_INTEGER)) {
			...
			if (NIL != inference_datastructures_problem.problem_relevant_to_inferenceP(prob, inference)) {
				...
				strategy = set_contents.do_set_contents_next(basis_object, state);
				if (NIL != set_contents.do_set_contents_element_validP(state, strategy)) {
				    inference_datastructures_strategy.set_tactic_recompute_thrown_away(tactic, strategy);
				}
			    }
			}
		    }
		...
		try {
			...
			if (NIL != inference_datastructures_problem.problem_relevant_to_inferenceP(prob, inference2)) {
				...
				strategy2 = set_contents.do_set_contents_next(basis_object2, state2);
				if (NIL != set_contents.do_set_contents_element_validP(state2, strategy2)) {
				    inference_datastructures_strategy.set_tactic_recompute_thrown_away(tactic, strategy2);
				}
			    }
			}
		    }
	...
	if (NIL != inference_datastructures_strategy.any_conditions_implyP(nth(ZERO_INTEGER, cache_status), conditions, NIL)) {
	    return T;
	}
	if (NIL != inference_datastructures_strategy.any_conditions_implyP(nth(ONE_INTEGER, cache_status), conditions, T)) {
	    return NIL;
	}
	return $RECOMPUTE;
    }
	...
	if (value == $RECOMPUTE) {
	...
	} else if (NIL == inference_datastructures_strategy.cache_status_known_for_conditionsP(cache_status, value, conditions)) {
	    if ((cache_status == $RECOMPUTE) || cache_status.eql(inference_datastructures_strategy.$default_uninterestingness_cache_value$.getGlobalValue())) {
		cache_status = copy_list(inference_datastructures_strategy.$default_uninterestingness_cache_value$.getGlobalValue());
	    }
		...
		while (NIL != cdolist_list_var) {
		    if (NIL == inference_datastructures_strategy.conditions_implyP(conditions, current_conditions, makeBoolean(NIL == value))) {
	...
	return NIL == negP ? inference_datastructures_strategy.conditions_booleanly_implyP(p_conditions, q_conditions) : inference_datastructures_strategy.conditions_booleanly_implyP(q_conditions, p_conditions);
    }
	...
	declareFunction("strat_removal_backtracking_productivity_limit", "STRAT-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT", 1, 0, false);
	...
	declareFunction("_csetf_strat_result_uniqueness_criterion", "_CSETF-STRAT-RESULT-UNIQUENESS-CRITERION", 2, 0, false);
	...
	declareFunction("_csetf_strat_should_reconsider_set_asidesP", "_CSETF-STRAT-SHOULD-RECONSIDER-SET-ASIDES?", 2, 0, false);
	declareFunction("_csetf_strat_productivity_limit", "_CSETF-STRAT-PRODUCTIVITY-LIMIT", 2, 0, false);
	declareFunction("_csetf_strat_removal_backtracking_productivity_limit", "_CSETF-STRAT-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT", 2, 0, false);
	...
	declareFunction("strategy_local_result_uniqueness_criterion", "STRATEGY-LOCAL-RESULT-UNIQUENESS-CRITERION", 1, 0, false);
	...
	declareFunction("strategy_should_reconsider_set_asidesP", "STRATEGY-SHOULD-RECONSIDER-SET-ASIDES?", 1, 0, false);
	declareFunction("strategy_productivity_limit", "STRATEGY-PRODUCTIVITY-LIMIT", 1, 0, false);
	declareFunction("strategy_removal_backtracking_productivity_limit", "STRATEGY-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT", 1, 0, false);
	...
	declareFunction("set_strategy_result_uniqueness_criterion", "SET-STRATEGY-RESULT-UNIQUENESS-CRITERION", 2, 0, false);
	declareFunction("set_strategy_productivity_limit", "SET-STRATEGY-PRODUCTIVITY-LIMIT", 2, 0, false);
	declareFunction("set_strategy_removal_backtracking_productivity_limit", "SET-STRATEGY-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT", 2, 0, false);
	...
	declareFunction("strategy_should_propagate_answer_linkP", "STRATEGY-SHOULD-PROPAGATE-ANSWER-LINK?", 1, 0, false);
	...
	declareFunction("note_strategy_should_reconsider_set_asides", "NOTE-STRATEGY-SHOULD-RECONSIDER-SET-ASIDES", 1, 0, false);
	declareFunction("clear_strategy_should_reconsider_set_asides", "CLEAR-STRATEGY-SHOULD-RECONSIDER-SET-ASIDES", 1, 0, false);
	...
	declareFunction("strategy_dispatch_unexpected_strategy_type_error", "STRATEGY-DISPATCH-UNEXPECTED-STRATEGY-TYPE-ERROR", 1, 0, false);
	...
	declareFunction("uninterestingness_cache_thrown_away_wrt_removal_code", "UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-REMOVAL-CODE", 1, 0, false);
	declareFunction("uninterestingness_cache_thrown_away_wrt_transformation_code", "UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-TRANSFORMATION-CODE", 1, 0, false);
	declareFunction("uninterestingness_cache_thrown_away_wrt_new_root_code", "UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-NEW-ROOT-CODE", 1, 0, false);
	declareFunction("uninterestingness_cache_set_aside_wrt_removal_code", "UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-REMOVAL-CODE", 1, 0, false);
	declareFunction("uninterestingness_cache_set_aside_wrt_transformation_code", "UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-TRANSFORMATION-CODE", 1, 0, false);
	declareFunction("uninterestingness_cache_set_aside_wrt_new_root_code", "UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-NEW-ROOT-CODE", 1, 0, false);
	declareFunction("uninterestingness_cache_thrown_away_code", "UNINTERESTINGNESS-CACHE-THROWN-AWAY-CODE", 1, 0, false);
	declareFunction("uninterestingness_cache_set_aside_code", "UNINTERESTINGNESS-CACHE-SET-ASIDE-CODE", 1, 0, false);
	declareFunction("set_uninterestingness_cache_thrown_away_wrt_removal_code", "SET-UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-REMOVAL-CODE", 2, 0, false);
	declareFunction("set_uninterestingness_cache_thrown_away_wrt_transformation_code", "SET-UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-TRANSFORMATION-CODE", 2, 0, false);
	declareFunction("set_uninterestingness_cache_thrown_away_wrt_new_root_code", "SET-UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-NEW-ROOT-CODE", 2, 0, false);
	declareFunction("set_uninterestingness_cache_set_aside_wrt_removal_code", "SET-UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-REMOVAL-CODE", 2, 0, false);
	declareFunction("set_uninterestingness_cache_set_aside_wrt_transformation_code", "SET-UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-TRANSFORMATION-CODE", 2, 0, false);
	declareFunction("set_uninterestingness_cache_set_aside_wrt_new_root_code", "SET-UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-NEW-ROOT-CODE", 2, 0, false);
	declareFunction("set_uninterestingness_cache_thrown_away_code", "SET-UNINTERESTINGNESS-CACHE-THROWN-AWAY-CODE", 2, 0, false);
	declareFunction("set_uninterestingness_cache_set_aside_code", "SET-UNINTERESTINGNESS-CACHE-SET-ASIDE-CODE", 2, 0, false);
	...
	declareFunction("problem_strategic_properties_print_function_trampoline", "PROBLEM-STRATEGIC-PROPERTIES-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
	...
	declareFunction("prob_strategic_properties_tactic_strategic_property_index", "PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX", 1, 0, false);
	declareFunction("prob_strategic_properties_possible_tactic_count", "PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT", 1, 0, false);
	declareFunction("prob_strategic_properties_flags", "PROB-STRATEGIC-PROPERTIES-FLAGS", 1, 0, false);
	declareFunction("_csetf_prob_strategic_properties_status", "_CSETF-PROB-STRATEGIC-PROPERTIES-STATUS", 2, 0, false);
	declareFunction("_csetf_prob_strategic_properties_tactic_strategic_property_index", "_CSETF-PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX", 2, 0, false);
	declareFunction("_csetf_prob_strategic_properties_possible_tactic_count", "_CSETF-PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT", 2, 0, false);
	declareFunction("_csetf_prob_strategic_properties_flags", "_CSETF-PROB-STRATEGIC-PROPERTIES-FLAGS", 2, 0, false);
	...
	declareFunction("problem_strategic_properties_tactic_strategic_property_index", "PROBLEM-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX", 2, 0, false);
	...
	declareFunction("strategically_potentially_possible_problem_p", "STRATEGICALLY-POTENTIALLY-POSSIBLE-PROBLEM-P", 2, 0, false);
	declareFunction("strategically_not_potentially_possible_problem_p", "STRATEGICALLY-NOT-POTENTIALLY-POSSIBLE-PROBLEM-P", 2, 0, false);
	declareFunction("strategically_totally_no_good_problem_p", "STRATEGICALLY-TOTALLY-NO-GOOD-PROBLEM-P", 2, 0, false);
	...
	declareFunction("problem_thrown_away_cache_removal_status", "PROBLEM-THROWN-AWAY-CACHE-REMOVAL-STATUS", 2, 0, false);
	declareFunction("problem_thrown_away_cache_transformation_status", "PROBLEM-THROWN-AWAY-CACHE-TRANSFORMATION-STATUS", 2, 0, false);
	declareFunction("problem_thrown_away_cache_new_root_status", "PROBLEM-THROWN-AWAY-CACHE-NEW-ROOT-STATUS", 2, 0, false);
	declareFunction("problem_set_aside_cache_removal_status", "PROBLEM-SET-ASIDE-CACHE-REMOVAL-STATUS", 2, 0, false);
	declareFunction("problem_set_aside_cache_status", "PROBLEM-SET-ASIDE-CACHE-STATUS", 2, 0, false);
	declareFunction("problem_set_aside_cache_transformation_status", "PROBLEM-SET-ASIDE-CACHE-TRANSFORMATION-STATUS", 2, 0, false);
	declareFunction("problem_set_aside_cache_new_root_status", "PROBLEM-SET-ASIDE-CACHE-NEW-ROOT-STATUS", 2, 0, false);
	...
	declareFunction("set_problem_not_thrown_away_wrt_removal", "SET-PROBLEM-NOT-THROWN-AWAY-WRT-REMOVAL", 2, 0, false);
	declareFunction("set_problem_recompute_thrown_away_wrt_removal", "SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-REMOVAL", 2, 0, false);
	declareFunction("set_problem_thrown_away_wrt_transformation", "SET-PROBLEM-THROWN-AWAY-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_problem_not_thrown_away_wrt_transformation", "SET-PROBLEM-NOT-THROWN-AWAY-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_problem_recompute_thrown_away_wrt_transformation", "SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_problem_thrown_away_wrt_new_root", "SET-PROBLEM-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
	declareFunction("set_problem_not_thrown_away_wrt_new_root", "SET-PROBLEM-NOT-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
	declareFunction("set_problem_recompute_thrown_away_wrt_new_root", "SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
	...
	declareFunction("set_problem_recompute_set_aside_wrt_removal", "SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-REMOVAL", 2, 0, false);
	declareFunction("set_problem_set_aside_wrt_transformation", "SET-PROBLEM-SET-ASIDE-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_problem_not_set_aside_wrt_transformation", "SET-PROBLEM-NOT-SET-ASIDE-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_problem_recompute_set_aside_wrt_transformation", "SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_problem_set_aside_wrt_new_root", "SET-PROBLEM-SET-ASIDE-WRT-NEW-ROOT", 2, 0, false);
	declareFunction("set_problem_not_set_aside_wrt_new_root", "SET-PROBLEM-NOT-SET-ASIDE-WRT-NEW-ROOT", 2, 0, false);
	declareFunction("set_problem_recompute_set_aside_wrt_new_root", "SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-NEW-ROOT", 2, 0, false);
	...
	declareFunction("problem_thrown_away_cache_status_wrt_motivation", "PROBLEM-THROWN-AWAY-CACHE-STATUS-WRT-MOTIVATION", 3, 0, false);
	declareFunction("set_problem_recompute_thrown_away_wrt_all_motivations", "SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-ALL-MOTIVATIONS", 2, 0, false);
	declareFunction("set_problem_recompute_thrown_away_wrt_all_relevant_strategies_and_all_motivations", "SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-ALL-RELEVANT-STRATEGIES-AND-ALL-MOTIVATIONS", 1, 0, false);
	declareFunction("problem_set_aside_cache_status_wrt_motivation", "PROBLEM-SET-ASIDE-CACHE-STATUS-WRT-MOTIVATION", 3, 0, false);
	declareFunction("set_problem_recompute_set_aside_wrt_all_motivations", "SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-ALL-MOTIVATIONS", 2, 0, false);
	declareFunction("set_problem_recompute_set_aside_wrt_all_relevant_strategies_and_all_motivations", "SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-ALL-RELEVANT-STRATEGIES-AND-ALL-MOTIVATIONS", 1, 0, false);
	declareFunction("tactic_strategic_properties_print_function_trampoline", "TACTIC-STRATEGIC-PROPERTIES-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
	...
	declareFunction("tact_strategic_properties_preference_level", "TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL", 1, 0, false);
	declareFunction("tact_strategic_properties_preference_level_justification", "TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL-JUSTIFICATION", 1, 0, false);
	declareFunction("tact_strategic_properties_productivity", "TACT-STRATEGIC-PROPERTIES-PRODUCTIVITY", 1, 0, false);
	declareFunction("tact_strategic_properties_flags", "TACT-STRATEGIC-PROPERTIES-FLAGS", 1, 0, false);
	declareFunction("_csetf_tact_strategic_properties_preference_level", "_CSETF-TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL", 2, 0, false);
	declareFunction("_csetf_tact_strategic_properties_preference_level_justification", "_CSETF-TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL-JUSTIFICATION", 2, 0, false);
	declareFunction("_csetf_tact_strategic_properties_productivity", "_CSETF-TACT-STRATEGIC-PROPERTIES-PRODUCTIVITY", 2, 0, false);
	declareFunction("_csetf_tact_strategic_properties_flags", "_CSETF-TACT-STRATEGIC-PROPERTIES-FLAGS", 2, 0, false);
	...
	declareFunction("tactic_strategic_preference_level_justification", "TACTIC-STRATEGIC-PREFERENCE-LEVEL-JUSTIFICATION", 2, 0, false);
	declareFunction("tactic_strategic_dwimmed_completeness", "TACTIC-STRATEGIC-DWIMMED-COMPLETENESS", 2, 0, false);
	declareFunction("conjunctive_tactic_strategic_preference_level", "CONJUNCTIVE-TACTIC-STRATEGIC-PREFERENCE-LEVEL", 2, 0, false);
	declareFunction("conjunctive_tactic_strategic_preference_level_justification", "CONJUNCTIVE-TACTIC-STRATEGIC-PREFERENCE-LEVEL-JUSTIFICATION", 2, 0, false);
	...
	declareFunction("tactic_thrown_away_cache_removal_status", "TACTIC-THROWN-AWAY-CACHE-REMOVAL-STATUS", 2, 0, false);
	declareFunction("tactic_thrown_away_cache_transformation_status", "TACTIC-THROWN-AWAY-CACHE-TRANSFORMATION-STATUS", 2, 0, false);
	declareFunction("tactic_thrown_away_cache_new_root_status", "TACTIC-THROWN-AWAY-CACHE-NEW-ROOT-STATUS", 2, 0, false);
	...
	declareFunction("tactic_set_aside_cache_transformation_status", "TACTIC-SET-ASIDE-CACHE-TRANSFORMATION-STATUS", 2, 0, false);
	declareFunction("tactic_set_aside_cache_new_root_status", "TACTIC-SET-ASIDE-CACHE-NEW-ROOT-STATUS", 2, 0, false);
	...
	declareFunction("set_tactic_not_thrown_away_wrt_removal", "SET-TACTIC-NOT-THROWN-AWAY-WRT-REMOVAL", 2, 0, false);
	declareFunction("set_tactic_recompute_thrown_away_wrt_removal", "SET-TACTIC-RECOMPUTE-THROWN-AWAY-WRT-REMOVAL", 2, 0, false);
	declareFunction("set_tactic_thrown_away_wrt_transformation", "SET-TACTIC-THROWN-AWAY-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_tactic_not_thrown_away_wrt_transformation", "SET-TACTIC-NOT-THROWN-AWAY-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_tactic_recompute_thrown_away_wrt_transformation", "SET-TACTIC-RECOMPUTE-THROWN-AWAY-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_tactic_thrown_away_wrt_new_root", "SET-TACTIC-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
	declareFunction("set_tactic_not_thrown_away_wrt_new_root", "SET-TACTIC-NOT-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
	declareFunction("set_tactic_recompute_thrown_away_wrt_new_root", "SET-TACTIC-RECOMPUTE-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
	...
	declareFunction("set_tactic_recompute_set_aside_wrt_removal", "SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-REMOVAL", 2, 0, false);
	declareFunction("set_tactic_set_aside_wrt_transformation", "SET-TACTIC-SET-ASIDE-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_tactic_not_set_aside_wrt_transformation", "SET-TACTIC-NOT-SET-ASIDE-WRT-TRANSFORMATION", 2, 0, false);
	declareFunction("set_tactic_recompute_set_aside_wrt_transformation", "SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-TRANSFORMATION", 2, 0, false);
	...
	declareFunction("set_tactic_recompute_set_aside_wrt_new_root", "SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-NEW-ROOT", 2, 0, false);
	...
	declareFunction("tactic_thrown_away_cache_status_wrt_motivation", "TACTIC-THROWN-AWAY-CACHE-STATUS-WRT-MOTIVATION", 3, 0, false);
	declareFunction("set_tactic_recompute_thrown_away_wrt_all_motivations", "SET-TACTIC-RECOMPUTE-THROWN-AWAY-WRT-ALL-MOTIVATIONS", 2, 0, false);
	declareFunction("set_problem_tactics_recompute_thrown_away_wrt_all_motivations", "SET-PROBLEM-TACTICS-RECOMPUTE-THROWN-AWAY-WRT-ALL-MOTIVATIONS", 2, 0, false);
	declareFunction("set_problem_tactics_recompute_thrown_away_wrt_all_relevant_strategies_and_all_motivations", "SET-PROBLEM-TACTICS-RECOMPUTE-THROWN-AWAY-WRT-ALL-RELEVANT-STRATEGIES-AND-ALL-MOTIVATIONS", 1, 0, false);
	declareFunction("tactic_set_aside_cache_status_wrt_motivation", "TACTIC-SET-ASIDE-CACHE-STATUS-WRT-MOTIVATION", 3, 0, false);
	declareFunction("set_tactic_recompute_set_aside_wrt_all_motivations", "SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-ALL-MOTIVATIONS", 2, 0, false);
	declareFunction("set_tactic_recompute_set_aside_wrt_all_relevant_strategies_and_all_motivations", "SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-ALL-RELEVANT-STRATEGIES-AND-ALL-MOTIVATIONS", 1, 0, false);
	declareFunction("set_problem_tactics_recompute_set_aside_wrt_all_motivations", "SET-PROBLEM-TACTICS-RECOMPUTE-SET-ASIDE-WRT-ALL-MOTIVATIONS", 2, 0, false);
	declareFunction("set_problem_tactics_recompute_set_aside_wrt_all_relevant_strategies_and_all_motivations", "SET-PROBLEM-TACTICS-RECOMPUTE-SET-ASIDE-WRT-ALL-RELEVANT-STRATEGIES-AND-ALL-MOTIVATIONS", 1, 0, false);
	declareFunction("problem_strategically_possible_tactic_count", "PROBLEM-STRATEGICALLY-POSSIBLE-TACTIC-COUNT", 2, 0, false);
	declareFunction("problem_note_tactic_strategically_possible", "PROBLEM-NOTE-TACTIC-STRATEGICALLY-POSSIBLE", 3, 0, false);
	declareFunction("problem_note_tactic_not_strategically_possible", "PROBLEM-NOTE-TACTIC-NOT-STRATEGICALLY-POSSIBLE", 3, 0, false);
	declareFunction("problem_note_all_tactics_not_strategically_possible", "PROBLEM-NOTE-ALL-TACTICS-NOT-STRATEGICALLY-POSSIBLE", 2, 0, false);
	return NIL;
    }
	...
	if (SubLFiles.USE_V1) {
	    ...
	    declareFunction("visit_defstruct_object_strategy_method", "VISIT-DEFSTRUCT-OBJECT-STRATEGY-METHOD", 2, 0, false);
	    declareFunction("valid_strategy_p", "VALID-STRATEGY-P", 1, 0, false);
	    declareFunction("strategy_invalid_p", "STRATEGY-INVALID-P", 1, 0, false);
	    declareFunction("print_strategy", "PRINT-STRATEGY", 3, 0, false);
	    declareFunction("sxhash_strategy_method", "SXHASH-STRATEGY-METHOD", 1, 0, false);
	    ...
	    declareFunction("prob_strategic_properties_tactic_strategic_property_index", "PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX", 1, 0, false);
	    declareFunction("prob_strategic_properties_possible_tactic_count", "PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT", 1, 0, false);
	    declareFunction("prob_strategic_properties_uninterestingness", "PROB-STRATEGIC-PROPERTIES-UNINTERESTINGNESS", 1, 0, false);
	    declareFunction("_csetf_prob_strategic_properties_status", "_CSETF-PROB-STRATEGIC-PROPERTIES-STATUS", 2, 0, false);
	    declareFunction("_csetf_prob_strategic_properties_tactic_strategic_property_index", "_CSETF-PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX", 2, 0, false);
	    declareFunction("_csetf_prob_strategic_properties_possible_tactic_count", "_CSETF-PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT", 2, 0, false);
	    declareFunction("_csetf_prob_strategic_properties_uninterestingness", "_CSETF-PROB-STRATEGIC-PROPERTIES-UNINTERESTINGNESS", 2, 0, false);
	    declareFunction("make_problem_strategic_properties", "MAKE-PROBLEM-STRATEGIC-PROPERTIES", 0, 1, false);
	    declareFunction("visit_defstruct_problem_strategic_properties", "VISIT-DEFSTRUCT-PROBLEM-STRATEGIC-PROPERTIES", 2, 0, false);
	    declareFunction("visit_defstruct_object_problem_strategic_properties_method", "VISIT-DEFSTRUCT-OBJECT-PROBLEM-STRATEGIC-PROPERTIES-METHOD", 2, 0, false);
	    declareFunction("new_problem_strategic_properties", "NEW-PROBLEM-STRATEGIC-PROPERTIES", 0, 0, false);
	    declareFunction("problem_strategic_properties_int", "PROBLEM-STRATEGIC-PROPERTIES-INT", 2, 0, false);
	    declareFunction("set_problem_strategic_properties", "SET-PROBLEM-STRATEGIC-PROPERTIES", 3, 0, false);
	    declareFunction("remove_problem_strategic_properties", "REMOVE-PROBLEM-STRATEGIC-PROPERTIES", 2, 0, false);
	    ...
	    declareFunction("set_problem_strategic_uninterestingness", "SET-PROBLEM-STRATEGIC-UNINTERESTINGNESS", 3, 0, false);
	    ...
	    declareFunction("set_just_problem_recompute_thrown_away", "SET-JUST-PROBLEM-RECOMPUTE-THROWN-AWAY", 2, 0, false);
	    ...
	    declareFunction("tact_strategic_properties_preference_level_justification", "TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL-JUSTIFICATION", 1, 0, false);
	    declareFunction("tact_strategic_properties_productivity", "TACT-STRATEGIC-PROPERTIES-PRODUCTIVITY", 1, 0, false);
	    declareFunction("tact_strategic_properties_uninterestingness", "TACT-STRATEGIC-PROPERTIES-UNINTERESTINGNESS", 1, 0, false);
	    declareFunction("_csetf_tact_strategic_properties_preference_level", "_CSETF-TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL", 2, 0, false);
	    declareFunction("_csetf_tact_strategic_properties_preference_level_justification", "_CSETF-TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL-JUSTIFICATION", 2, 0, false);
	    declareFunction("_csetf_tact_strategic_properties_productivity", "_CSETF-TACT-STRATEGIC-PROPERTIES-PRODUCTIVITY", 2, 0, false);
	    declareFunction("_csetf_tact_strategic_properties_uninterestingness", "_CSETF-TACT-STRATEGIC-PROPERTIES-UNINTERESTINGNESS", 2, 0, false);
	    declareFunction("make_tactic_strategic_properties", "MAKE-TACTIC-STRATEGIC-PROPERTIES", 0, 1, false);
	    declareFunction("visit_defstruct_tactic_strategic_properties", "VISIT-DEFSTRUCT-TACTIC-STRATEGIC-PROPERTIES", 2, 0, false);
	    declareFunction("visit_defstruct_object_tactic_strategic_properties_method", "VISIT-DEFSTRUCT-OBJECT-TACTIC-STRATEGIC-PROPERTIES-METHOD", 2, 0, false);
	    declareFunction("new_tactic_strategic_properties", "NEW-TACTIC-STRATEGIC-PROPERTIES", 0, 0, false);
	    declareFunction("tactic_strategic_properties_int", "TACTIC-STRATEGIC-PROPERTIES-INT", 2, 0, false);
	    declareFunction("set_tactic_strategic_properties", "SET-TACTIC-STRATEGIC-PROPERTIES", 3, 0, false);
	    declareFunction("tactic_strategic_properties", "TACTIC-STRATEGIC-PROPERTIES", 2, 0, false);
	    ...
	    declareFunction("set_tactic_strategic_uninterestingness", "SET-TACTIC-STRATEGIC-UNINTERESTINGNESS", 3, 0, false);
	    declareFunction("thrown_away_cache_status_from_uninterestingness", "THROWN-AWAY-CACHE-STATUS-FROM-UNINTERESTINGNESS", 2, 0, false);
	    declareFunction("set_aside_cache_status_from_uninterestingness", "SET-ASIDE-CACHE-STATUS-FROM-UNINTERESTINGNESS", 2, 0, false);
	    declareFunction("note_uninterestingness_cache_thrown_away_value", "NOTE-UNINTERESTINGNESS-CACHE-THROWN-AWAY-VALUE", 3, 0, false);
	    declareFunction("note_uninterestingness_cache_set_aside_value", "NOTE-UNINTERESTINGNESS-CACHE-SET-ASIDE-VALUE", 3, 0, false);
	    ...
	    declareFunction("uninterestingness_cache_conditions_list_p", "UNINTERESTINGNESS-CACHE-CONDITIONS-LIST-P", 1, 0, false);
	    ...
	    declareFunction("set_tactic_recompute_set_aside", "SET-TACTIC-RECOMPUTE-SET-ASIDE", 2, 0, false);
	    declareFunction("set_problem_recompute_thrown_away_wrt_all_relevant_strategies", "SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-ALL-RELEVANT-STRATEGIES", 1, 0, false);
	    declareFunction("set_problem_recompute_set_aside_wrt_all_relevant_strategies", "SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-ALL-RELEVANT-STRATEGIES", 1, 0, false);
	    declareFunction("set_tactic_recompute_thrown_away_wrt_all_relevant_strategies", "SET-TACTIC-RECOMPUTE-THROWN-AWAY-WRT-ALL-RELEVANT-STRATEGIES", 1, 0, false);
	    declareFunction("set_tactic_recompute_set_aside_wrt_all_relevant_strategies", "SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-ALL-RELEVANT-STRATEGIES", 1, 0, false);
	    declareFunction("set_problem_tactics_recompute_thrown_away_wrt_all_relevant_strategies", "SET-PROBLEM-TACTICS-RECOMPUTE-THROWN-AWAY-WRT-ALL-RELEVANT-STRATEGIES", 1, 0, false);
	    declareFunction("set_problem_tactics_recompute_set_aside_wrt_all_relevant_strategies", "SET-PROBLEM-TACTICS-RECOMPUTE-SET-ASIDE-WRT-ALL-RELEVANT-STRATEGIES", 1, 0, false);
	    declareFunction("set_problem_tactics_recompute_thrown_away", "SET-PROBLEM-TACTICS-RECOMPUTE-THROWN-AWAY", 2, 0, false);
	    declareFunction("set_problem_tactics_recompute_set_aside", "SET-PROBLEM-TACTICS-RECOMPUTE-SET-ASIDE", 2, 0, false);
	    ...
	    declareFunction("modify_cache_status_for_value_and_conditions", "MODIFY-CACHE-STATUS-FOR-VALUE-AND-CONDITIONS", 3, 0, false);
    ...
    static private final SubLList $list_alt2 = list(
	    new SubLObject[] { makeSymbol("SUID"), makeSymbol("INFERENCE"), makeSymbol("RESULT-UNIQUENESS-CRITERION"), makeSymbol("ACTIVE-PROBLEMS"), makeSymbol("MOTIVATED-PROBLEMS"), makeSymbol("SET-ASIDE-PROBLEMS"), makeSymbol("SHOULD-RECONSIDER-SET-ASIDES?"), makeSymbol("PRODUCTIVITY-LIMIT"),
		    makeSymbol("REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT"), makeSymbol("PROOF-SPEC"), makeSymbol("PROBLEM-PROOF-SPEC-INDEX"), makeSymbol("PROBLEM-STRATEGIC-INDEX"), makeSymbol("MEMOIZATION-STATE"), makeSymbol("TYPE"), makeSymbol("DATA") });

    static private final SubLList $list_alt3 = list(
	    new SubLObject[] { $SUID, makeKeyword("INFERENCE"), makeKeyword("RESULT-UNIQUENESS-CRITERION"), makeKeyword("ACTIVE-PROBLEMS"), makeKeyword("MOTIVATED-PROBLEMS"), makeKeyword("SET-ASIDE-PROBLEMS"), makeKeyword("SHOULD-RECONSIDER-SET-ASIDES?"),
		    makeKeyword("PRODUCTIVITY-LIMIT"), makeKeyword("REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT"), makeKeyword("PROOF-SPEC"), makeKeyword("PROBLEM-PROOF-SPEC-INDEX"), makeKeyword("PROBLEM-STRATEGIC-INDEX"), makeKeyword("MEMOIZATION-STATE"), $TYPE, $DATA });

    static private final SubLList $list_alt4 = list(new SubLObject[] { makeSymbol("STRAT-SUID"), makeSymbol("STRAT-INFERENCE"), makeSymbol("STRAT-RESULT-UNIQUENESS-CRITERION"), makeSymbol("STRAT-ACTIVE-PROBLEMS"), makeSymbol("STRAT-MOTIVATED-PROBLEMS"), makeSymbol("STRAT-SET-ASIDE-PROBLEMS"),
	    makeSymbol("STRAT-SHOULD-RECONSIDER-SET-ASIDES?"), makeSymbol("STRAT-PRODUCTIVITY-LIMIT"), makeSymbol("STRAT-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT"), makeSymbol("STRAT-PROOF-SPEC"), makeSymbol("STRAT-PROBLEM-PROOF-SPEC-INDEX"), makeSymbol("STRAT-PROBLEM-STRATEGIC-INDEX"),
	    makeSymbol("STRAT-MEMOIZATION-STATE"), makeSymbol("STRAT-TYPE"), makeSymbol("STRAT-DATA") });

    static private final SubLList $list_alt5 = list(new SubLObject[] { makeSymbol("_CSETF-STRAT-SUID"), makeSymbol("_CSETF-STRAT-INFERENCE"), makeSymbol("_CSETF-STRAT-RESULT-UNIQUENESS-CRITERION"), makeSymbol("_CSETF-STRAT-ACTIVE-PROBLEMS"), makeSymbol("_CSETF-STRAT-MOTIVATED-PROBLEMS"),
	    makeSymbol("_CSETF-STRAT-SET-ASIDE-PROBLEMS"), makeSymbol("_CSETF-STRAT-SHOULD-RECONSIDER-SET-ASIDES?"), makeSymbol("_CSETF-STRAT-PRODUCTIVITY-LIMIT"), makeSymbol("_CSETF-STRAT-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT"), makeSymbol("_CSETF-STRAT-PROOF-SPEC"),
	    makeSymbol("_CSETF-STRAT-PROBLEM-PROOF-SPEC-INDEX"), makeSymbol("_CSETF-STRAT-PROBLEM-STRATEGIC-INDEX"), makeSymbol("_CSETF-STRAT-MEMOIZATION-STATE"), makeSymbol("_CSETF-STRAT-TYPE"), makeSymbol("_CSETF-STRAT-DATA") });

    static private final SubLSymbol $sym20$STRAT_SHOULD_RECONSIDER_SET_ASIDES_ = makeSymbol("STRAT-SHOULD-RECONSIDER-SET-ASIDES?");

    static private final SubLSymbol $sym21$_CSETF_STRAT_SHOULD_RECONSIDER_SET_ASIDES_ = makeSymbol("_CSETF-STRAT-SHOULD-RECONSIDER-SET-ASIDES?");
    ...
    static private final SubLString $str_alt56$__a_STRATEGY__a__a_for_inference_ = makeString("<~a STRATEGY ~a.~a for inference ~a.~a>");
	...
	deflexical("*STRATEGY-TYPE-STORE*", NIL != boundp($strategy_type_store$) ? ((SubLObject) ($strategy_type_store$.getGlobalValue())) : dictionary.new_dictionary(symbol_function(EQ), FIVE_INTEGER));
	defparameter("*UNINTERESTINGNESS-CACHE-LOOKUP-ENABLED?*", T);
	defconstant("*DEFAULT-UNINTERESTINGNESS-FLAGS*", ZERO_INTEGER);
	defconstant("*UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-REMOVAL-BYTE*", bytes.sublisp_byte(TWO_INTEGER, ZERO_INTEGER));
	defconstant("*UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-TRANSFORMATION-BYTE*", bytes.sublisp_byte(TWO_INTEGER, TWO_INTEGER));
	defconstant("*UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-NEW-ROOT-BYTE*", bytes.sublisp_byte(TWO_INTEGER, FOUR_INTEGER));
	defconstant("*UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-REMOVAL-BYTE*", bytes.sublisp_byte(TWO_INTEGER, SIX_INTEGER));
	defconstant("*UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-TRANSFORMATION-BYTE*", bytes.sublisp_byte(TWO_INTEGER, EIGHT_INTEGER));
	defconstant("*UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-NEW-ROOT-BYTE*", bytes.sublisp_byte(TWO_INTEGER, TEN_INTEGER));
    ...
    static private final SubLList $list_alt70 = list(list(makeSymbol("PROBLEM-VAR"), makeSymbol("STRATEGY"), makeSymbol("&KEY"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	if (SubLFiles.USE_V1) {
	    register_method($print_object_method_table$.getGlobalValue(), inference_datastructures_strategy.$dtp_strategy$.getGlobalValue(), symbol_function(inference_datastructures_strategy.STRATEGY_PRINT_FUNCTION_TRAMPOLINE));
	    ...
	    def_csetf(inference_datastructures_strategy.STRAT_INFERENCE, inference_datastructures_strategy._CSETF_STRAT_INFERENCE);
	    def_csetf(inference_datastructures_strategy.STRAT_RESULT_UNIQUENESS_CRITERION, inference_datastructures_strategy._CSETF_STRAT_RESULT_UNIQUENESS_CRITERION);
	    def_csetf(inference_datastructures_strategy.STRAT_ACTIVE_PROBLEMS, inference_datastructures_strategy._CSETF_STRAT_ACTIVE_PROBLEMS);
	    def_csetf(inference_datastructures_strategy.STRAT_MOTIVATED_PROBLEMS, inference_datastructures_strategy._CSETF_STRAT_MOTIVATED_PROBLEMS);
	    def_csetf(inference_datastructures_strategy.STRAT_SET_ASIDE_PROBLEMS, inference_datastructures_strategy._CSETF_STRAT_SET_ASIDE_PROBLEMS);
	    def_csetf(inference_datastructures_strategy.$sym21$STRAT_SHOULD_RECONSIDER_SET_ASIDES_, inference_datastructures_strategy.$sym22$_CSETF_STRAT_SHOULD_RECONSIDER_SET_ASIDES_);
	    def_csetf(inference_datastructures_strategy.STRAT_PRODUCTIVITY_LIMIT, inference_datastructures_strategy._CSETF_STRAT_PRODUCTIVITY_LIMIT);
	    def_csetf(inference_datastructures_strategy.STRAT_REMOVAL_BACKTRACKING_PRODUCTIVITY_LIMIT, inference_datastructures_strategy._CSETF_STRAT_REMOVAL_BACKTRACKING_PRODUCTIVITY_LIMIT);
	    def_csetf(inference_datastructures_strategy.STRAT_PROOF_SPEC, inference_datastructures_strategy._CSETF_STRAT_PROOF_SPEC);
	    def_csetf(inference_datastructures_strategy.STRAT_PROBLEM_PROOF_SPEC_INDEX, inference_datastructures_strategy._CSETF_STRAT_PROBLEM_PROOF_SPEC_INDEX);
	    def_csetf(inference_datastructures_strategy.STRAT_PROBLEM_STRATEGIC_INDEX, inference_datastructures_strategy._CSETF_STRAT_PROBLEM_STRATEGIC_INDEX);
	    def_csetf(inference_datastructures_strategy.STRAT_MEMOIZATION_STATE, inference_datastructures_strategy._CSETF_STRAT_MEMOIZATION_STATE);
	    def_csetf(inference_datastructures_strategy.STRAT_STEP_COUNT, inference_datastructures_strategy._CSETF_STRAT_STEP_COUNT);
	    ...
	    identity(STRATEGY);
	    register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), inference_datastructures_strategy.$dtp_strategy$.getGlobalValue(), symbol_function(inference_datastructures_strategy.VISIT_DEFSTRUCT_OBJECT_STRATEGY_METHOD));
	    register_method(Sxhash.$sxhash_method_table$.getGlobalValue(), inference_datastructures_strategy.$dtp_strategy$.getGlobalValue(), symbol_function(inference_datastructures_strategy.SXHASH_STRATEGY_METHOD));
	    register_macro_helper(inference_datastructures_strategy.STRATEGY_ACTIVE_PROBLEMS, inference_datastructures_strategy.DO_STRATEGY_ACTIVE_PROBLEMS);
	    register_macro_helper(inference_datastructures_strategy.STRATEGY_MOTIVATED_PROBLEMS, inference_datastructures_strategy.DO_STRATEGY_MOTIVATED_PROBLEMS);
	    register_macro_helper(inference_datastructures_strategy.STRATEGY_SET_ASIDE_PROBLEMS, inference_datastructures_strategy.DO_STRATEGY_SET_ASIDE_PROBLEMS);
	    register_macro_helper(inference_datastructures_strategy.STRATEGY_MEMOIZATION_STATE, inference_datastructures_strategy.WITH_STRATEGY_MEMOIZATION_STATE);
	    register_macro_helper(inference_datastructures_strategy.CURRENT_STRATEGY_WRT_MEMOIZATION, inference_datastructures_strategy.WITH_STRATEGY_MEMOIZATION_STATE);
	    declare_defglobal($strategy_type_store$);
	    register_method($print_object_method_table$.getGlobalValue(), inference_datastructures_strategy.$dtp_problem_strategic_properties$.getGlobalValue(), symbol_function(PROBLEM_STRATEGIC_PROPERTIES_PRINT_FUNCTION_TRAMPOLINE));
	    SubLSpecialOperatorDeclarations.proclaim(inference_datastructures_strategy.$list125);
	    def_csetf(PROB_STRATEGIC_PROPERTIES_STATUS, _CSETF_PROB_STRATEGIC_PROPERTIES_STATUS);
	    def_csetf(PROB_STRATEGIC_PROPERTIES_TACTIC_STRATEGIC_PROPERTY_INDEX, _CSETF_PROB_STRATEGIC_PROPERTIES_TACTIC_STRATEGIC_PROPERTY_INDEX);
	    def_csetf(PROB_STRATEGIC_PROPERTIES_POSSIBLE_TACTIC_COUNT, _CSETF_PROB_STRATEGIC_PROPERTIES_POSSIBLE_TACTIC_COUNT);
	    def_csetf(inference_datastructures_strategy.PROB_STRATEGIC_PROPERTIES_UNINTERESTINGNESS, inference_datastructures_strategy._CSETF_PROB_STRATEGIC_PROPERTIES_UNINTERESTINGNESS);
	    identity(PROBLEM_STRATEGIC_PROPERTIES);
	    register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), inference_datastructures_strategy.$dtp_problem_strategic_properties$.getGlobalValue(), symbol_function(inference_datastructures_strategy.VISIT_DEFSTRUCT_OBJECT_PROBLEM_STRATEGIC_PROPERTIES_METHOD));
	    register_method($print_object_method_table$.getGlobalValue(), inference_datastructures_strategy.$dtp_tactic_strategic_properties$.getGlobalValue(), symbol_function(TACTIC_STRATEGIC_PROPERTIES_PRINT_FUNCTION_TRAMPOLINE));
	    SubLSpecialOperatorDeclarations.proclaim(inference_datastructures_strategy.$list161);
	    def_csetf(inference_datastructures_strategy.TACT_STRATEGIC_PROPERTIES_PREFERENCE_LEVEL, inference_datastructures_strategy._CSETF_TACT_STRATEGIC_PROPERTIES_PREFERENCE_LEVEL);
	    def_csetf(inference_datastructures_strategy.TACT_STRATEGIC_PROPERTIES_PREFERENCE_LEVEL_JUSTIFICATION, inference_datastructures_strategy._CSETF_TACT_STRATEGIC_PROPERTIES_PREFERENCE_LEVEL_JUSTIFICATION);
	    def_csetf(inference_datastructures_strategy.TACT_STRATEGIC_PROPERTIES_PRODUCTIVITY, inference_datastructures_strategy._CSETF_TACT_STRATEGIC_PROPERTIES_PRODUCTIVITY);
	    def_csetf(inference_datastructures_strategy.TACT_STRATEGIC_PROPERTIES_UNINTERESTINGNESS, inference_datastructures_strategy._CSETF_TACT_STRATEGIC_PROPERTIES_UNINTERESTINGNESS);
	    identity(TACTIC_STRATEGIC_PROPERTIES);
	    register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), inference_datastructures_strategy.$dtp_tactic_strategic_properties$.getGlobalValue(), symbol_function(inference_datastructures_strategy.VISIT_DEFSTRUCT_OBJECT_TACTIC_STRATEGIC_PROPERTIES_METHOD));
	}
	if (SubLFiles.USE_V2) {
	    def_csetf($sym20$STRAT_SHOULD_RECONSIDER_SET_ASIDES_, $sym21$_CSETF_STRAT_SHOULD_RECONSIDER_SET_ASIDES_);
	    def_csetf(PROB_STRATEGIC_PROPERTIES_FLAGS, _CSETF_PROB_STRATEGIC_PROPERTIES_FLAGS);
    ...
    static private final SubLString $str_alt91$Unexpected_strategy_property__s_w = makeString("Unexpected strategy property ~s with value ~s");

    static private final SubLList $list_alt94 = list(list(makeSymbol("STRATEGY"), makeSymbol("PROBLEM")), makeSymbol("&BODY"), makeSymbol("BODY"));
    ...
    static private final SubLString $str_alt101$balancing_tactician_does_not_impl = makeString("balancing tactician does not implement ~a");

    private static final SubLSymbol BALANCED_STRATEGY_DEFAULT_SELECT_BEST_STRATEGEM = makeSymbol("BALANCED-STRATEGY-DEFAULT-SELECT-BEST-STRATEGEM");
    ...
    private static final SubLSymbol BALANCED_STRATEGY_POSSIBLY_ACTIVATE_PROBLEM = makeSymbol("BALANCED-STRATEGY-POSSIBLY-ACTIVATE-PROBLEM");

    static private final SubLString $str_alt106$Unexpected_strategy_type__a = makeString("Unexpected strategy type ~a");

    private static final SubLSymbol STRATEGY_TYPE_PROPERTY_P = makeSymbol("STRATEGY-TYPE-PROPERTY-P");

    static private final SubLString $str_alt111$invalid_uninterestingness_cache_c = makeString("invalid uninterestingness cache code ~s");

    static private final SubLString $str_alt112$invalid_uninterestingness_cache_s = makeString("invalid uninterestingness cache status ~s");

    private static final SubLSymbol PROBLEM_STRATEGIC_PROPERTIES = makeSymbol("PROBLEM-STRATEGIC-PROPERTIES");

    private static final SubLSymbol PROBLEM_STRATEGIC_PROPERTIES_P = makeSymbol("PROBLEM-STRATEGIC-PROPERTIES-P");

    static private final SubLList $list_alt115 = list(makeSymbol("STATUS"), makeSymbol("TACTIC-STRATEGIC-PROPERTY-INDEX"), makeSymbol("POSSIBLE-TACTIC-COUNT"), makeSymbol("FLAGS"));

    static private final SubLList $list_alt116 = list(makeKeyword("STATUS"), makeKeyword("TACTIC-STRATEGIC-PROPERTY-INDEX"), makeKeyword("POSSIBLE-TACTIC-COUNT"), makeKeyword("FLAGS"));
    ...
    static private final SubLList $list_alt117 = list(makeSymbol("PROB-STRATEGIC-PROPERTIES-STATUS"), makeSymbol("PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX"), makeSymbol("PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT"), makeSymbol("PROB-STRATEGIC-PROPERTIES-FLAGS"));
	...
	static {
	    structDecl = makeStructDeclNative(inference_datastructures_strategy.$strategy_native.class, STRATEGY, inference_datastructures_strategy.STRATEGY_P, inference_datastructures_strategy.$list2, inference_datastructures_strategy.$list3,
		    new String[] { "$suid", "$inference", "$result_uniqueness_criterion", "$active_problems", "$motivated_problems", "$set_aside_problems", "$should_reconsider_set_asidesP", "$productivity_limit", "$removal_backtracking_productivity_limit", "$proof_spec", "$problem_proof_spec_index",
			    "$problem_strategic_index", "$memoization_state", "$step_count", "$type", "$data" },
		    inference_datastructures_strategy.$list4, inference_datastructures_strategy.$list5, inference_datastructures_strategy.PRINT_STRATEGY);
	}
    }

    static private final SubLList $list_alt118 = list(makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-STATUS"), makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX"), makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT"),
    ...
    public static final SubLSymbol _CSETF_PROB_STRATEGIC_PROPERTIES_STATUS = makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-STATUS");

    private static final SubLSymbol PROB_STRATEGIC_PROPERTIES_TACTIC_STRATEGIC_PROPERTY_INDEX = makeSymbol("PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX");

    public static final SubLSymbol _CSETF_PROB_STRATEGIC_PROPERTIES_TACTIC_STRATEGIC_PROPERTY_INDEX = makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX");

    private static final SubLSymbol PROB_STRATEGIC_PROPERTIES_POSSIBLE_TACTIC_COUNT = makeSymbol("PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT");

    public static final SubLSymbol _CSETF_PROB_STRATEGIC_PROPERTIES_POSSIBLE_TACTIC_COUNT = makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT");

    private static final SubLSymbol PROB_STRATEGIC_PROPERTIES_FLAGS = makeSymbol("PROB-STRATEGIC-PROPERTIES-FLAGS");

    public static final SubLSymbol _CSETF_PROB_STRATEGIC_PROPERTIES_FLAGS = makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-FLAGS");
    ...
    static private final SubLList $list_alt151 = list(makeSymbol("PREFERENCE-LEVEL"), makeSymbol("PREFERENCE-LEVEL-JUSTIFICATION"), makeSymbol("PRODUCTIVITY"), makeSymbol("FLAGS"));

    static private final SubLList $list_alt152 = list(makeKeyword("PREFERENCE-LEVEL"), makeKeyword("PREFERENCE-LEVEL-JUSTIFICATION"), makeKeyword("PRODUCTIVITY"), makeKeyword("FLAGS"));

    static private final SubLList $list_alt153 = list(makeSymbol("TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL"), makeSymbol("TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL-JUSTIFICATION"), makeSymbol("TACT-STRATEGIC-PROPERTIES-PRODUCTIVITY"), makeSymbol("TACT-STRATEGIC-PROPERTIES-FLAGS"));

    static private final SubLList $list_alt154 = list(makeSymbol("_CSETF-TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL"), makeSymbol("_CSETF-TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL-JUSTIFICATION"), makeSymbol("_CSETF-TACT-STRATEGIC-PROPERTIES-PRODUCTIVITY"),
    ...
    public static final SubLSymbol _CSETF_TACT_STRATEGIC_PROPERTIES_FLAGS = makeSymbol("_CSETF-TACT-STRATEGIC-PROPERTIES-FLAGS");

    static private final SubLString $str_alt171$structural_tactic__s_cannot_have_ = makeString("structural tactic ~s cannot have a completeness");

    static private final SubLString $str_alt172$content_tactic__s_cannot_have_a_p = makeString("content tactic ~s cannot have a preference level");

    static private final SubLString $str_alt173$content_tactic__s_cannot_have_a_p = makeString("content tactic ~s cannot have a preference level justification");
	...
	// }
	static {
	    structDecl = makeStructDeclNative(inference_datastructures_strategy.$problem_strategic_properties_native.class, PROBLEM_STRATEGIC_PROPERTIES, PROBLEM_STRATEGIC_PROPERTIES_P, inference_datastructures_strategy.$list119, inference_datastructures_strategy.$list120,
		    new String[] { "$status", "$tactic_strategic_property_index", "$possible_tactic_count", "$flags", "$uninterestingness" }, inference_datastructures_strategy.$list121, inference_datastructures_strategy.$list122, DEFAULT_STRUCT_PRINT_FUNCTION);
	}
    }
