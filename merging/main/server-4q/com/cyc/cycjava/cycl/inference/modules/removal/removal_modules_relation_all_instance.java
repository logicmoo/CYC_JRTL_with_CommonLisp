...
/**
 * Copyright (c) 1995 - 2019 Cycorp, Inc.  All rights reserved.
 * module:      REMOVAL-MODULES-RELATION-ALL-INSTANCE
 * source file: /cyc/top/cycl/inference/modules/removal/removal-modules-relation-all-instance.lisp
 * created:     2019/07/03 17:37:44
 */
public final class removal_modules_relation_all_instance extends SubLTranslatedFile implements V12 {
 ...
 public static final String myName = "com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance";
    ...
    static private final SubLList $list1 = list(makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("REQUIRED-PATTERN"), list(makeKeyword("FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("PREFERENCE"), makeSymbol("RELATION-ALL-INSTANCE-COULD-APPLY-IF-MORE-BOUND"));
    ...
    private static final SubLList $list9 = list(reader_make_constant_shell("implies"), list(reader_make_constant_shell("and"), list(reader_make_constant_shell("relationAllInstance"), makeSymbol("?PRED"), makeSymbol("?COL"), makeSymbol("?VALUE")), list(reader_make_constant_shell("isa"), makeSymbol("?OBJ"), makeSymbol("?COL"))), list(makeSymbol("?PRED"), makeSymbol("?OBJ"), makeSymbol("?VALUE")));
    ...
    static private final SubLList $list40 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("ARITY"), TWO_INTEGER, makeKeyword("REQUIRED-PATTERN"), list($FORT, makeKeyword("NOT-FULLY-BOUND"), $FORT), makeKeyword("REQUIRED"), makeSymbol("REMOVAL-RELATION-ALL-INSTANCE-ITERATE-REQUIRED"), $COST, makeSymbol("REMOVAL-RELATION-ALL-INSTANCE-ITERATE-COST"), makeKeyword("COMPLETENESS"), makeKeyword("INCOMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-RELATION-ALL-INSTANCE-ITERATE-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(<predicate> <non-fort> <object>) where <object> is a FORT\n from (#$relationAllInstance <predicate> <collection> <object>)"), makeKeyword("EXAMPLE"), makeString("(#$hasGender ?WHO #$Masculine)\n from (#$relationAllInstance #$hasGender #$MalePerson #$Masculine)") });

    private static final SubLList $list41 = list(reader_make_constant_shell("implies"), list(reader_make_constant_shell("and"), list(reader_make_constant_shell("relationInstanceAll"), makeSymbol("?PRED"), makeSymbol("?VALUE"), makeSymbol("?COL")), list(reader_make_constant_shell("isa"), makeSymbol("?OBJ"), makeSymbol("?COL"))), list(makeSymbol("?PRED"), makeSymbol("?VALUE"), makeSymbol("?OBJ")));
    ...
    // Definitions
    public static final SubLObject removal_some_relation_all_instance_for_predicate_alt(SubLObject predicate, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
    ...
    public static final SubLObject removal_some_relation_all_instance_for_collection_alt(SubLObject collection, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
    ...
    public static final SubLObject removal_some_relation_all_instance_for_value_alt(SubLObject v_term, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
    ...
    public static final SubLObject relation_all_instance_predicate_cost_estimate_alt(SubLObject predicate) {
    ...
    public static final SubLObject relation_all_instance_collection_cost_estimate_alt() {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    public static final SubLObject relation_all_instance_value_cost_estimate_alt(SubLObject value) {
    ...
    public static final SubLObject removal_relation_all_instance_required_alt(SubLObject asent) {
        {
            SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
            return makeBoolean((NIL == hl_supports.hl_predicate_p(predicate)) && (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_some_relation_all_instance_for_predicate(predicate, NIL)));
        }
    }
    ...
    public static final SubLObject make_relation_all_instance_support_alt() {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    public static final SubLObject removal_relation_all_instance_check_required_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        if (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_required(asent)) {
            {
                SubLObject value = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
                return makeBoolean((NIL != possibly_naut_p(value)) || (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_some_relation_all_instance_for_value(value, NIL)));
            }
        }
        return NIL;
    }
    ...
    public static final SubLObject removal_relation_all_instance_check_expand_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            ...
            SubLObject value = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
            SubLObject predicate_cost_estimate = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.relation_all_instance_predicate_cost_estimate(predicate);
            SubLObject collection_cost_estimate = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.relation_all_instance_collection_cost_estimate();
            SubLObject value_cost_estimate_meaningfulP = fort_p(value);
            SubLObject value_cost_estimate = (NIL != value_cost_estimate_meaningfulP) ? ((SubLObject) (com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.relation_all_instance_value_cost_estimate(value))) : NIL;
            if (((NIL != value_cost_estimate_meaningfulP) && value_cost_estimate.numLE(predicate_cost_estimate)) && value_cost_estimate.numLE(collection_cost_estimate)) {
                                                    ...
                                                    while (NIL == done_var_1) {
                                                        {
                                                            ...
                                                            if (NIL != valid_3) {
                                                                com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_check_via_value_expand(asent, assertion);
                                                            }
                ...
                if (predicate_cost_estimate.numLE(collection_cost_estimate)) {
                                                        ...
                                                        while (NIL == done_var_4) {
                                                            {
                                                                ...
                                                                if (NIL != valid_6) {
                                                                    com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_check_via_predicate_expand(asent, assertion);
                                                                }
                    ...
                    {
                        SubLObject all_isa = isa.all_isa(v_object, NIL, UNPROVIDED);
                        ...
                        for (collection = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , collection = cdolist_list_var.first()) {
                            if (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_some_relation_all_instance_for_collection(collection, NIL)) {
                                {
                                    SubLObject pred_var = $$relationAllInstance;
                                                                    ...
                                                                    while (NIL == done_var_7) {
                                                                        {
                                                                            ...
                                                                            if (NIL != valid_9) {
                                                                                com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_check_via_collection_expand(asent, assertion);
                                                                            }
    ...
    public static final SubLObject removal_relation_all_instance_check_via_value_expand_alt(SubLObject asent, SubLObject assertion) {
        {
            SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
            SubLObject v_object = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
            ...
            return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_check_expand_guts(asent, assertion);
        }
    }
    ...
    public static final SubLObject removal_relation_all_instance_check_via_collection_expand_alt(SubLObject asent, SubLObject assertion) {
        {
            SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
            SubLObject value = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
            if (predicate != assertions_high.gaf_arg1(assertion)) {
    ...
    public static final SubLObject removal_relation_all_instance_check_via_predicate_expand_alt(SubLObject asent, SubLObject assertion) {
        {
            SubLObject v_object = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
            SubLObject value = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
            if (!value.equal(assertions_high.gaf_arg3(assertion))) {
    ...
    public static final SubLObject removal_relation_all_instance_check_expand_guts_alt(SubLObject asent, SubLObject assertion) {
        if (NIL != backward_utilities.direction_is_relevant(assertion)) {
            {
                SubLObject v_object = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
                SubLObject collection = assertions_high.gaf_arg2(assertion);
                SubLObject rule_support = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.make_relation_all_instance_support();
    ...
    public static final SubLObject removal_relation_all_instance_unify_required_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        if (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_required(asent)) {
            {
                SubLObject v_object = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
                return makeBoolean((NIL != fort_p(v_object)) || (NIL != possibly_naut_p(v_object)));
            }
        }
        return NIL;
    }
    ...
    public static final SubLObject removal_relation_all_instance_unify_cost_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            return max($minimum_relation_all_instance_unify_cost$.getDynamicValue(thread), min(com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.relation_all_instance_predicate_cost_estimate(cycl_utilities.atomic_sentence_predicate(asent)), com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.relation_all_instance_collection_cost_estimate()));
        }
    }
    ...
    public static final SubLObject removal_relation_all_instance_unify_expand_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
                                                    ...
                                                    while (NIL == done_var_10) {
                                                        {
                                                            ...
                                                            if (NIL != valid_12) {
                                                                com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_unify_via_predicate_expand(asent, assertion);
                                                            }
                                                                ...
                                                                while (NIL == done_var_13) {
                                                                    {
                                                                        ...
                                                                        if (NIL != valid_15) {
                                                                            com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_unify_via_collection_expand(asent, assertion);
                                                                        }
    ...
    public static final SubLObject removal_relation_all_instance_unify_via_collection_expand_alt(SubLObject asent, SubLObject assertion) {
        {
            SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
            if (predicate != assertions_high.gaf_arg1(assertion)) {
                return NIL;
            }
            return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_unify_expand_guts(asent, assertion);
        }
    }
    ...
    public static final SubLObject removal_relation_all_instance_unify_via_predicate_expand_alt(SubLObject asent, SubLObject assertion) {
        {
    ...
    public static final SubLObject removal_relation_all_instance_unify_expand_guts_alt(SubLObject asent, SubLObject assertion) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL != backward_utilities.direction_is_relevant(assertion)) {
                {
    ...
    public static final SubLObject removal_relation_all_instance_iterate_required_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        if (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_required(asent)) {
            {
                ...
                return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_some_relation_all_instance_for_value(v_object, NIL);
            }
        }
        return NIL;
    }
    ...
    public static final SubLObject removal_relation_all_instance_iterate_cost_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            ...
            SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
            SubLObject v_object = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
            SubLObject collections = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_iteration_collections(predicate, v_object);
    ...
    public static final SubLObject removal_relation_all_instance_iteration_collections_alt(SubLObject predicate, SubLObject v_object) {
        return alist_keys(com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_iteration_collections_rai(predicate, v_object));
    }
    ...
    public static final SubLObject removal_relation_all_instance_iteration_collections_rai_alt(SubLObject predicate, SubLObject v_object) {
        {
            SubLObject collections_rai = NIL;
            SubLObject rai_assertions = kb_mapping_utilities.pred_u_v_holds_gafs($$relationAllInstance, predicate, v_object, ONE_INTEGER, THREE_INTEGER, $TRUE);
            SubLObject cdolist_list_var = rai_assertions;
            SubLObject rai_ass = NIL;
            for (rai_ass = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , rai_ass = cdolist_list_var.first()) {
                {
                    SubLObject collection = assertions_high.gaf_arg2(rai_ass);
                    SubLObject collection_assertions = alist_lookup(collections_rai, collection, UNPROVIDED, UNPROVIDED);
                    collection_assertions = cons(rai_ass, collection_assertions);
                    collections_rai = alist_enter(collections_rai, collection, collection_assertions, UNPROVIDED);
                }
            }
    ...
    public static final SubLObject removal_relation_all_instance_iterate_expand_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                ...
                SubLObject v_object = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
                SubLObject code_support = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.make_relation_all_instance_support();
                SubLObject collections_rai = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_all_instance_iteration_collections_rai(predicate, v_object);
                SubLObject cdolist_list_var = collections_rai;
                SubLObject cons = NIL;
                                                            ...
                                                            }
                                                            {
                                                                ...
                                                                try {
                                                                    ...
                                                                    if ((NIL != sbhl_paranoia.suspend_sbhl_type_checkingP()) || (NIL != sbhl_module_utilities.apply_sbhl_module_type_test(node_var, sbhl_module_vars.get_sbhl_module(UNPROVIDED)))) {
                                                                                ...
                                                                                while (NIL != node_var_16) {
                                                                                    {
                                                                                        ...
                                                                                        SubLObject cdolist_list_var_25 = accessible_modules;
                                                                                        SubLObject module_var = NIL;
                                                                                        for (module_var = cdolist_list_var_25.first(); NIL != cdolist_list_var_25; cdolist_list_var_25 = cdolist_list_var_25.rest() , module_var = cdolist_list_var_25.first()) {
                                                                                            {
                                                                                                                                                                            ...
                                                                                                                                                                            sbhl_link_vars.$sbhl_link_tv$.bind(tv, thread);
                                                                                                                                                                            {
                                                                                                                                                                                ...
                                                                                                                                                                                for (instance = cdolist_list_var_31.first(); NIL != cdolist_list_var_31; cdolist_list_var_31 = cdolist_list_var_31.rest() , instance = cdolist_list_var_31.first()) {
                                                                                                                                                                                    if (NIL == sbhl_marking_utilities.sbhl_search_path_termination_p(instance, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(thread))) {
                                                                                                                                                                                        ...
                                                                                                                                                                                        if (NIL != fort_p(instance)) {
                                                                                                                                                                                            {
                                                                                                                                                                                                SubLObject cdolist_list_var_32 = rai_assertions;
                                                                                                                                                                                                SubLObject rai_ass = NIL;
                                                                                                                                                                                                for (rai_ass = cdolist_list_var_32.first(); NIL != cdolist_list_var_32; cdolist_list_var_32 = cdolist_list_var_32.rest() , rai_ass = cdolist_list_var_32.first()) {
                                                                                                                                                                                                    thread.resetMultipleValues();
                                                                                                                                                                                                    {
                                                                                                                                                                                                        SubLObject v_bindings = unification_utilities.term_unify(unbound_instance, instance, T, T);
                                                                                                                                                                                                        SubLObject unify_justification = thread.secondMultipleValue();
                                                                                                                                                                                                        thread.resetMultipleValues();
                                                                                                                                                                                                        {
                                                                                                                                                                                                            SubLObject isa_support = arguments.make_hl_support($ISA, list($$isa, instance, collection), UNPROVIDED, UNPROVIDED);
                                                                                                                                                                                                            SubLObject more_supports = append(list(code_support, isa_support), unify_justification);
                                                                                                                                                                                                            if (NIL != v_bindings) {
                                                                                                            ...
                                                                                                            if (NIL != sbhl_macros.do_sbhl_non_fort_linksP(node, sbhl_module_vars.get_sbhl_module(UNPROVIDED))) {
                                                                                                                {
                                                                                                                    ...
                                                                                                                    for (instance_tuple = csome_list_var.first(); NIL != csome_list_var; csome_list_var = csome_list_var.rest() , instance_tuple = csome_list_var.first()) {
                                                                                                                        {
                                                                                                                            SubLObject datum_33 = instance_tuple;
                                                                                                                            SubLObject current_34 = datum_33;
                                                                                                                            SubLObject link_node = NIL;
                                                                                                                            SubLObject mt = NIL;
                                                                                                                            SubLObject tv = NIL;
                                                                                                                            destructuring_bind_must_consp(current_34, datum_33, $list_alt28);
                                                                                                                            link_node = current_34.first();
                                                                                                                            ...
                                                                                                                            if (NIL == current_34) {
                                                                                                                                            ...
                                                                                                                                            if (NIL != sbhl_search_vars.relevant_sbhl_tvP(tv)) {
                                                                                                                                                {
                                                                                                                                                    ...
                                                                                                                                                    try {
                                                                                                                                                        sbhl_link_vars.$sbhl_link_tv$.bind(tv, thread);
                                                                                                                                                        {
                                                                                                                                                            ...
                                                                                                                                                            SubLObject instance = NIL;
                                                                                                                                                            for (instance = cdolist_list_var_37.first(); NIL != cdolist_list_var_37; cdolist_list_var_37 = cdolist_list_var_37.rest() , instance = cdolist_list_var_37.first()) {
                                                                                                                                                                if (NIL == sbhl_marking_utilities.sbhl_search_path_termination_p(instance, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(thread))) {
                                                                                                                                                                    sbhl_marking_utilities.sbhl_mark_node_marked(instance, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(thread));
                                                                                                                                                                    if (NIL != fort_p(instance)) {
                                                                                                                                                                        {
                                                                                                                                                                            SubLObject cdolist_list_var_38 = rai_assertions;
                                                                                                                                                                            SubLObject rai_ass = NIL;
                                                                                                                                                                            for (rai_ass = cdolist_list_var_38.first(); NIL != cdolist_list_var_38; cdolist_list_var_38 = cdolist_list_var_38.rest() , rai_ass = cdolist_list_var_38.first()) {
                                                                                                                                                                                thread.resetMultipleValues();
                                                                                                                                                                                {
                                                                                                                                                                                    SubLObject v_bindings = unification_utilities.term_unify(unbound_instance, instance, T, T);
                                                                                                                                                                                    SubLObject unify_justification = thread.secondMultipleValue();
                                                                                                                                ...
                                                                                                                                cdestructuring_bind_error(datum_33, $list_alt28);
                                                                                                                            }
                                                                                                                        }
                                                                                                                    }
                                                                                                                }
                                                                                                                    ...
                                                                                                                    for (generating_fn = cdolist_list_var_39.first(); NIL != cdolist_list_var_39; cdolist_list_var_39 = cdolist_list_var_39.rest() , generating_fn = cdolist_list_var_39.first()) {
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            try {
                                                                                                                                sbhl_link_vars.$sbhl_link_generator$.bind(generating_fn, thread);
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    SubLObject new_list_41 = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? ((SubLObject) (randomize_list(link_nodes))) : link_nodes;
                                                                                                                                    SubLObject cdolist_list_var_42 = new_list_41;
                                                                                                                                    SubLObject instance = NIL;
                                                                                                                                    for (instance = cdolist_list_var_42.first(); NIL != cdolist_list_var_42; cdolist_list_var_42 = cdolist_list_var_42.rest() , instance = cdolist_list_var_42.first()) {
                                                                                                                                        if (NIL == sbhl_marking_utilities.sbhl_search_path_termination_p(instance, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(thread))) {
                                                                                                                                            sbhl_marking_utilities.sbhl_mark_node_marked(instance, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(thread));
                                                                                                                                            if (NIL != fort_p(instance)) {
                                                                                                                                                {
                                                                                                                                                    SubLObject cdolist_list_var_43 = rai_assertions;
                                                                                                                                                    SubLObject rai_ass = NIL;
                                                                                                                                                    for (rai_ass = cdolist_list_var_43.first(); NIL != cdolist_list_var_43; cdolist_list_var_43 = cdolist_list_var_43.rest() , rai_ass = cdolist_list_var_43.first()) {
                                                                                                                                                        thread.resetMultipleValues();
                                                                                                                                                        {
                                                                                                                                                            SubLObject v_bindings = unification_utilities.term_unify(unbound_instance, instance, T, T);
                                                                                                                                                            SubLObject unify_justification = thread.secondMultipleValue();
                                                                                    ...
                                                                                    }
                                                                                    {
                                                                                        ...
                                                                                        SubLObject cdolist_list_var_44 = accessible_modules;
                                                                                        SubLObject module_var = NIL;
                                                                                        for (module_var = cdolist_list_var_44.first(); NIL != cdolist_list_var_44; cdolist_list_var_44 = cdolist_list_var_44.rest() , module_var = cdolist_list_var_44.first()) {
                                                                                            {
                                                                                                                                        ...
                                                                                                                                        if (NIL != mt_relevance_macros.relevant_mtP(mt)) {
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                try {
                                                                                                                                                    sbhl_link_vars.$sbhl_link_mt$.bind(mt, thread);
                                                                                                                                                    {
                                                                                                                                                        SubLObject iteration_state_48 = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents(tv_links));
                                                                                                                                                        while (NIL == dictionary_contents.do_dictionary_contents_doneP(iteration_state_48)) {
                                                                                                                                                            thread.resetMultipleValues();
                                                                                                                                                            {
                                                                                                                                                                SubLObject tv = dictionary_contents.do_dictionary_contents_key_value(iteration_state_48);
                                                                                                                                                                SubLObject link_nodes = thread.secondMultipleValue();
                                                                                                                                                                thread.resetMultipleValues();
                                                                                                                                                                if (NIL != sbhl_search_vars.relevant_sbhl_tvP(tv)) {
                                                                                                                                                                    {
                                                                                                                                                                        SubLObject _prev_bind_0_49 = sbhl_link_vars.$sbhl_link_tv$.currentBinding(thread);
                                                                                                                                                                        try {
                                                                                                                                                                            sbhl_link_vars.$sbhl_link_tv$.bind(tv, thread);
                                                                                                                                                                            {
                                                                                                                                                                                SubLObject new_list = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? ((SubLObject) (randomize_list(link_nodes))) : link_nodes;
                                                                                                                                                                                ...
                                                                                                                                                                                for (node_vars_link_node = cdolist_list_var_50.first(); NIL != cdolist_list_var_50; cdolist_list_var_50 = cdolist_list_var_50.rest() , node_vars_link_node = cdolist_list_var_50.first()) {
                                                                                                                                                                            ...
                                                                                                                                                                            sbhl_link_vars.$sbhl_link_tv$.rebind(_prev_bind_0_49, thread);
                                                                                                                                                                        }
                                                                                                                                                                    }
                                                                                                                                                                }
                                                                                                                                                                iteration_state_48 = dictionary_contents.do_dictionary_contents_next(iteration_state_48);
                                                                                                                                                            }
                                                                                                                                                        } 
                                                                                                                                                        dictionary_contents.do_dictionary_contents_finalize(iteration_state_48);
                                                                                                                                                    }
                                                                                                                                                } finally {
                                                                                                            ...
                                                                                                            if (NIL != obsolete.cnat_p(node, UNPROVIDED)) {
                                                                                                                {
                                                                                                                    ...
                                                                                                                    SubLObject generating_fn = NIL;
                                                                                                                    for (generating_fn = cdolist_list_var_51.first(); NIL != cdolist_list_var_51; cdolist_list_var_51 = cdolist_list_var_51.rest() , generating_fn = cdolist_list_var_51.first()) {
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            try {
                                                                                                                                ...
                                                                                                                                {
                                                                                                                                    SubLObject link_nodes = funcall(generating_fn, node);
                                                                                                                                    SubLObject new_list_53 = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? ((SubLObject) (randomize_list(link_nodes))) : link_nodes;
                                                                                                                                    SubLObject cdolist_list_var_54 = new_list_53;
                                                                                                                                    SubLObject node_vars_link_node = NIL;
                                                                        ...
                                                                        sbhl_paranoia.sbhl_warn(TWO_INTEGER, $str_alt29$Node__a_does_not_pass_sbhl_type_t, node_var, sbhl_module_utilities.get_sbhl_type_test(sbhl_module_vars.get_sbhl_module(UNPROVIDED)), UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                    }
                                                                } finally {
    ...
    public static final SubLObject removal_some_relation_instance_all_for_predicate_alt(SubLObject predicate, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
        if (NIL != fort_p(predicate)) {
    ...
    public static final SubLObject removal_some_relation_instance_all_for_value_alt(SubLObject v_term, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
        if (NIL != indexed_term_p(v_term)) {
    ...
    public static final SubLObject removal_some_relation_instance_all_for_collection_alt(SubLObject collection, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
        if (NIL != fort_p(collection)) {
    ...
    public static final SubLObject relation_instance_all_predicate_cost_estimate_alt(SubLObject predicate) {
    ...
    public static final SubLObject relation_instance_all_collection_cost_estimate_alt() {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    public static final SubLObject relation_instance_all_value_cost_estimate_alt(SubLObject v_term) {
    ...
    public static final SubLObject removal_relation_instance_all_required_alt(SubLObject asent) {
        {
            SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
            return makeBoolean((NIL == hl_supports.hl_predicate_p(predicate)) && (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_some_relation_instance_all_for_predicate(predicate, NIL)));
        }
    }
    ...
    public static final SubLObject make_relation_instance_all_support_alt() {
    ...
    public static final SubLObject removal_relation_instance_all_check_required_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        if (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_required(asent)) {
            {
                SubLObject value = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
                return makeBoolean((NIL != possibly_naut_p(value)) || (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_some_relation_instance_all_for_value(value, NIL)));
            }
        }
        return NIL;
    }
    ...
    public static final SubLObject removal_relation_instance_all_check_expand_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            ...
            SubLObject value = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
            SubLObject v_object = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
            SubLObject predicate_cost_estimate = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.relation_instance_all_predicate_cost_estimate(predicate);
            SubLObject collection_cost_estimate = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.relation_instance_all_collection_cost_estimate();
            SubLObject value_cost_estimate_meaningfulP = fort_p(value);
            SubLObject value_cost_estimate = (NIL != value_cost_estimate_meaningfulP) ? ((SubLObject) (com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.relation_instance_all_value_cost_estimate(value))) : NIL;
            if (((NIL != value_cost_estimate_meaningfulP) && value_cost_estimate.numLE(predicate_cost_estimate)) && value_cost_estimate.numLE(collection_cost_estimate)) {
                {
                                                    ...
                                                    while (NIL == done_var_55) {
                                                        {
                                                            ...
                                                            if (NIL != valid_57) {
                                                                com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_check_via_value_expand(asent, assertion);
                                                            }
                ...
                if (predicate_cost_estimate.numLE(collection_cost_estimate)) {
                                                        ...
                                                        while (NIL == done_var_58) {
                                                            {
                                                                ...
                                                                if (NIL != valid_60) {
                                                                    com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_check_via_predicate_expand(asent, assertion);
                                                                }
                ...
                } else {
                    {
                        ...
                        SubLObject collection = NIL;
                        for (collection = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , collection = cdolist_list_var.first()) {
                            if (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_some_relation_instance_all_for_collection(collection, NIL)) {
                                {
                                    SubLObject pred_var = $$relationInstanceAll;
                                                                    ...
                                                                    while (NIL == done_var_61) {
                                                                        {
                                                                            ...
                                                                            if (NIL != valid_63) {
                                                                                com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_check_via_collection_expand(asent, assertion);
                                                                            }
    ...
    public static final SubLObject removal_relation_instance_all_check_via_value_expand_alt(SubLObject asent, SubLObject assertion) {
        {
            SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
            SubLObject v_object = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
            if (predicate != assertions_high.gaf_arg1(assertion)) {
            ...
            return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_check_expand_guts(asent, assertion);
        }
    }
    ...
    public static final SubLObject removal_relation_instance_all_check_via_collection_expand_alt(SubLObject asent, SubLObject assertion) {
        {
            SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
            SubLObject value = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
            if (predicate != assertions_high.gaf_arg1(assertion)) {
    ...
    public static final SubLObject removal_relation_instance_all_check_via_predicate_expand_alt(SubLObject asent, SubLObject assertion) {
        {
            SubLObject value = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
            SubLObject v_object = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
            if (!value.equal(assertions_high.gaf_arg2(assertion))) {
    ...
    public static final SubLObject removal_relation_instance_all_check_expand_guts_alt(SubLObject asent, SubLObject assertion) {
        if (NIL != backward_utilities.direction_is_relevant(assertion)) {
            {
                SubLObject v_object = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
                SubLObject collection = assertions_high.gaf_arg3(assertion);
                SubLObject rule_support = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.make_relation_instance_all_support();
                SubLObject isa_support = arguments.make_hl_support($ISA, list($$isa, v_object, collection), UNPROVIDED, UNPROVIDED);
                SubLObject more_supports = list(rule_support, isa_support);
                backward.removal_add_node(assertion, NIL, more_supports);
            }
    ...
    public static final SubLObject removal_relation_instance_all_unify_required_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        if (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_required(asent)) {
    ...
    public static final SubLObject removal_relation_instance_all_unify_cost_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            return max($minimum_relation_instance_all_unify_cost$.getDynamicValue(thread), min(com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.relation_instance_all_predicate_cost_estimate(cycl_utilities.atomic_sentence_predicate(asent)), com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.relation_instance_all_collection_cost_estimate()));
        }
    }
    ...
    public static final SubLObject removal_relation_instance_all_unify_expand_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            ...
            if (predicate_cost_estimate.numLE(collection_cost_estimate)) {
                                                    ...
                                                    while (NIL == done_var_64) {
                                                        {
                                                            ...
                                                            if (NIL != valid_66) {
                                                                com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_unify_via_predicate_expand(asent, assertion);
                                                            }
                ...
                {
                    SubLObject all_isa = isa.all_isa(arg2, NIL, UNPROVIDED);
                    SubLObject cdolist_list_var = all_isa;
                    SubLObject collection = NIL;
                    for (collection = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , collection = cdolist_list_var.first()) {
                        if (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_some_relation_instance_all_for_collection(collection, NIL)) {
                                                                ...
                                                                while (NIL == done_var_67) {
                                                                    {
                                                                        ...
                                                                        if (NIL != valid_69) {
                                                                            com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_unify_via_collection_expand(asent, assertion);
                                                                        }
    ...
    public static final SubLObject removal_relation_instance_all_unify_via_predicate_expand_alt(SubLObject asent, SubLObject assertion) {
        {
            SubLObject v_object = cycl_utilities.atomic_sentence_arg2(asent, UNPROVIDED);
            SubLObject collection = assertions_high.gaf_arg3(assertion);
            ...
            return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_unify_expand_guts(asent, assertion);
        }
    }
    ...
    public static final SubLObject removal_relation_instance_all_unify_via_collection_expand_alt(SubLObject asent, SubLObject assertion) {
        {
            SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
            if (predicate != assertions_high.gaf_arg1(assertion)) {
                return NIL;
    ...
    public static final SubLObject removal_relation_instance_all_unify_expand_guts_alt(SubLObject asent, SubLObject assertion) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL != backward_utilities.direction_is_relevant(assertion)) {
                {
    ...
    public static final SubLObject removal_relation_instance_all_iterate_required_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        if (NIL != com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_required(asent)) {
            {
                SubLObject v_object = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
                return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_some_relation_instance_all_for_value(v_object, NIL);
            }
        }
        return NIL;
    }
    ...
    public static final SubLObject removal_relation_instance_all_iterate_cost_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            ...
            SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
            SubLObject v_object = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
            SubLObject collections = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_iteration_collections(predicate, v_object);
            SubLObject cdolist_list_var = collections;
            SubLObject collection = NIL;
            for (collection = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , collection = cdolist_list_var.first()) {
                {
    ...
    public static final SubLObject removal_relation_instance_all_iteration_collections_alt(SubLObject predicate, SubLObject v_object) {
        return alist_keys(com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_iteration_collections_ria(predicate, v_object));
    }
    ...
    public static final SubLObject removal_relation_instance_all_iteration_collections_ria_alt(SubLObject predicate, SubLObject v_object) {
        {
            SubLObject collections_ria = NIL;
            SubLObject ria_assertions = kb_mapping_utilities.pred_u_v_holds_gafs($$relationInstanceAll, predicate, v_object, ONE_INTEGER, TWO_INTEGER, $TRUE);
            SubLObject cdolist_list_var = ria_assertions;
            SubLObject ria_ass = NIL;
            for (ria_ass = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , ria_ass = cdolist_list_var.first()) {
                {
                    SubLObject collection = assertions_high.gaf_arg3(ria_ass);
                    SubLObject collection_assertions = alist_lookup(collections_ria, collection, UNPROVIDED, UNPROVIDED);
                    collection_assertions = cons(ria_ass, collection_assertions);
                    collections_ria = alist_enter(collections_ria, collection, collection_assertions, UNPROVIDED);
                }
            }
    ...
    public static final SubLObject removal_relation_instance_all_iterate_expand_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                ...
                SubLObject code_support = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.make_relation_instance_all_support();
                SubLObject collections_ria = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relation_all_instance.removal_relation_instance_all_iteration_collections_ria(predicate, v_object);
                SubLObject cdolist_list_var = collections_ria;
                SubLObject cons = NIL;
                for (cons = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , cons = cdolist_list_var.first()) {
                    {
                        SubLObject datum = cons;
                        ...
                        rai_assertions = current;
                        {
                            SubLObject cdolist_list_var_70 = rai_assertions;
                            SubLObject rai_ass = NIL;
                            for (rai_ass = cdolist_list_var_70.first(); NIL != cdolist_list_var_70; cdolist_list_var_70 = cdolist_list_var_70.rest() , rai_ass = cdolist_list_var_70.first()) {
                                {
                                    SubLObject node_var = collection;
                                    {
                                        SubLObject _prev_bind_0 = sbhl_module_vars.$sbhl_module$.currentBinding(thread);
                                        ...
                                        try {
                                            ...
                                            sbhl_marking_vars.$sbhl_gather_space$.bind(sbhl_marking_vars.get_sbhl_marking_space(), thread);
                                            {
                                                SubLObject node_var_71 = node_var;
                                                SubLObject deck_type = (false) ? ((SubLObject) ($QUEUE)) : $STACK;
                                                SubLObject recur_deck = deck.create_deck(deck_type);
                                                {
                                                                            ...
                                                                            if ((NIL != sbhl_paranoia.suspend_sbhl_type_checkingP()) || (NIL != sbhl_module_utilities.apply_sbhl_module_type_test(node_var, sbhl_module_vars.get_sbhl_module(UNPROVIDED)))) {
                                                                                {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        sbhl_link_vars.$sbhl_link_direction$.bind(sbhl_module_utilities.sbhl_search_direction_to_link_direction(sbhl_search_vars.get_sbhl_backward_search_direction(), sbhl_module_utilities.get_sbhl_transfers_through_module(sbhl_module_vars.get_sbhl_module($$isa))), thread);
                                                                                        sbhl_search_vars.$genl_inverse_mode_p$.bind(NIL, thread);
                                                                                        sbhl_marking_utilities.sbhl_mark_node_marked(node_var_71, UNPROVIDED);
                                                                                        while (NIL != node_var_71) {
                                                                                            {
                                                                                                SubLObject tt_node_var = node_var_71;
                                                                                                SubLObject accessible_modules = sbhl_macros.get_sbhl_accessible_modules(sbhl_module_vars.get_sbhl_module($$isa));
                                                                                                SubLObject cdolist_list_var_80 = accessible_modules;
                                                                                                SubLObject module_var = NIL;
                                                                                                for (module_var = cdolist_list_var_80.first(); NIL != cdolist_list_var_80; cdolist_list_var_80 = cdolist_list_var_80.rest() , module_var = cdolist_list_var_80.first()) {
                                                                                                    {
                                                                                                        SubLObject _prev_bind_0_81 = sbhl_module_vars.$sbhl_module$.currentBinding(thread);
                                                                                                        SubLObject _prev_bind_1_82 = sbhl_search_vars.$genl_inverse_mode_p$.currentBinding(thread);
                                                                                                        try {
                                                                                                            sbhl_module_vars.$sbhl_module$.bind(module_var, thread);
                                                                                                            sbhl_search_vars.$genl_inverse_mode_p$.bind(NIL != sbhl_search_vars.flip_genl_inverse_modeP(UNPROVIDED, UNPROVIDED) ? ((SubLObject) (makeBoolean(NIL == sbhl_search_vars.$genl_inverse_mode_p$.getDynamicValue(thread)))) : sbhl_search_vars.$genl_inverse_mode_p$.getDynamicValue(thread), thread);
                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                if (NIL != mt_relevance_macros.relevant_mtP(mt)) {
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        try {
                                                                                                                                                            sbhl_link_vars.$sbhl_link_mt$.bind(mt, thread);
                                                                                                                                                            {
                                                                                                                                                                SubLObject iteration_state_84 = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents(tv_links));
                                                                                                                                                                while (NIL == dictionary_contents.do_dictionary_contents_doneP(iteration_state_84)) {
                                                                                                                                                                    thread.resetMultipleValues();
                                                                                                                                                                    {
                                                                                                                                                                        SubLObject tv = dictionary_contents.do_dictionary_contents_key_value(iteration_state_84);
                                                                                                                                                                        SubLObject link_nodes = thread.secondMultipleValue();
                                                                                                                                                                        thread.resetMultipleValues();
                                                                                                                                                                        if (NIL != sbhl_search_vars.relevant_sbhl_tvP(tv)) {
                                                                                                                                                                            {
                                                                                                                                                                                SubLObject _prev_bind_0_85 = sbhl_link_vars.$sbhl_link_tv$.currentBinding(thread);
                                                                                                                                                                                try {
                                                                                                                                                                                    sbhl_link_vars.$sbhl_link_tv$.bind(tv, thread);
                                                                                                                                                                                    {
                                                                                                                                                                                        SubLObject new_list = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? ((SubLObject) (randomize_list(link_nodes))) : link_nodes;
                                                                                                                                                                                        ...
                                                                                                                                                                                        SubLObject instance = NIL;
                                                                                                                                                                                        for (instance = cdolist_list_var_86.first(); NIL != cdolist_list_var_86; cdolist_list_var_86 = cdolist_list_var_86.rest() , instance = cdolist_list_var_86.first()) {
                                                                                                                                                                                            if (NIL == sbhl_marking_utilities.sbhl_search_path_termination_p(instance, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(thread))) {
                                                                                                                                                                                                sbhl_marking_utilities.sbhl_mark_node_marked(instance, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(thread));
                                                                                                                                                                                                if (NIL != fort_p(instance)) {
                                                                                                                                                                                                    thread.resetMultipleValues();
                                                                                                                                                                                    ...
                                                                                                                                                                                    sbhl_link_vars.$sbhl_link_tv$.rebind(_prev_bind_0_85, thread);
                                                                                                                                                                                }
                                                                                                                                                                            }
                                                                                                                                                                        }
                                                                                                                                                                        iteration_state_84 = dictionary_contents.do_dictionary_contents_next(iteration_state_84);
                                                                                                                                                                    }
                                                                                                                                                                } 
                                                                                                                                                                dictionary_contents.do_dictionary_contents_finalize(iteration_state_84);
                                                                                                                                                            }
                                                                                                                                                        } finally {
                                                                                                                    ...
                                                                                                                    if (NIL != sbhl_macros.do_sbhl_non_fort_linksP(node, sbhl_module_vars.get_sbhl_module(UNPROVIDED))) {
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            for (instance_tuple = csome_list_var.first(); NIL != csome_list_var; csome_list_var = csome_list_var.rest() , instance_tuple = csome_list_var.first()) {
                                                                                                                                {
                                                                                                                                    SubLObject datum_87 = instance_tuple;
                                                                                                                                    SubLObject current_88 = datum_87;
                                                                                                                                    SubLObject link_node = NIL;
                                                                                                                                    SubLObject mt = NIL;
                                                                                                                                    SubLObject tv = NIL;
                                                                                                                                    destructuring_bind_must_consp(current_88, datum_87, $list_alt28);
                                                                                                                                    link_node = current_88.first();
                                                                                                                                    ...
                                                                                                                                    if (NIL == current_88) {
                                                                                                                                        if (NIL != mt_relevance_macros.relevant_mtP(mt)) {
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                try {
                                                                                                                                                    ...
                                                                                                                                                    if (NIL != sbhl_search_vars.relevant_sbhl_tvP(tv)) {
                                                                                                                                                        {
                                                                                                                                                            SubLObject _prev_bind_0_90 = sbhl_link_vars.$sbhl_link_tv$.currentBinding(thread);
                                                                                                                                                            try {
                                                                                                                                                                sbhl_link_vars.$sbhl_link_tv$.bind(tv, thread);
                                                                                                                                                                {
                                                                                                                                                                    SubLObject link_nodes = list(link_node);
                                                                                                                                                                    SubLObject new_list = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? ((SubLObject) (randomize_list(link_nodes))) : link_nodes;
                                                                                                                                                                    SubLObject cdolist_list_var_91 = new_list;
                                                                                                                                                                    SubLObject instance = NIL;
                                                                                                                                                                    for (instance = cdolist_list_var_91.first(); NIL != cdolist_list_var_91; cdolist_list_var_91 = cdolist_list_var_91.rest() , instance = cdolist_list_var_91.first()) {
                                                                                                                                                                        if (NIL == sbhl_marking_utilities.sbhl_search_path_termination_p(instance, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(thread))) {
                                                                                                                                                                            sbhl_marking_utilities.sbhl_mark_node_marked(instance, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(thread));
                                                                                                                                                                            if (NIL != fort_p(instance)) {
                                                                                                                                                                                thread.resetMultipleValues();
                                                                                                                                                                ...
                                                                                                                                                                sbhl_link_vars.$sbhl_link_tv$.rebind(_prev_bind_0_90, thread);
                                                                                                                                                            }
                                                                                                                                                        }
                                                                                                                                                    }
                                                                                                                                                } finally {
                                                                                                                                        ...
                                                                                                                                        cdestructuring_bind_error(datum_87, $list_alt28);
                                                                                                                                    }
                                                                                                                                }
                                                                                                                            }
                                                                                                                        }
                                                                                                                            ...
                                                                                                                            for (generating_fn = cdolist_list_var_92.first(); NIL != cdolist_list_var_92; cdolist_list_var_92 = cdolist_list_var_92.rest() , generating_fn = cdolist_list_var_92.first()) {
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    try {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            SubLObject link_nodes = funcall(generating_fn, node);
                                                                                                                                            SubLObject new_list_94 = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? ((SubLObject) (randomize_list(link_nodes))) : link_nodes;
                                                                                                            ...
                                                                                                            sbhl_search_vars.$genl_inverse_mode_p$.rebind(_prev_bind_1_82, thread);
                                                                                                            sbhl_module_vars.$sbhl_module$.rebind(_prev_bind_0_81, thread);
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                            {
                                                                                                SubLObject accessible_modules = sbhl_macros.get_sbhl_accessible_modules(sbhl_module_utilities.get_sbhl_transfers_through_module(sbhl_module_vars.get_sbhl_module($$isa)));
                                                                                                SubLObject cdolist_list_var_96 = accessible_modules;
                                                                                                SubLObject module_var = NIL;
                                                                                                for (module_var = cdolist_list_var_96.first(); NIL != cdolist_list_var_96; cdolist_list_var_96 = cdolist_list_var_96.rest() , module_var = cdolist_list_var_96.first()) {
                                                                                                    {
                                                                                                        ...
                                                                                                        try {
                                                                                                            ...
                                                                                                            sbhl_search_vars.$genl_inverse_mode_p$.bind(NIL != sbhl_search_vars.flip_genl_inverse_modeP(UNPROVIDED, UNPROVIDED) ? ((SubLObject) (makeBoolean(NIL == sbhl_search_vars.$genl_inverse_mode_p$.getDynamicValue(thread)))) : sbhl_search_vars.$genl_inverse_mode_p$.getDynamicValue(thread), thread);
                                                                                                            {
                                                                                                                SubLObject node = function_terms.naut_to_nart(node_var_71);
                                                                                                                if (NIL != sbhl_link_vars.sbhl_node_object_p(node)) {
                                                                                                                    {
                                                                                                                        SubLObject d_link = sbhl_graphs.get_sbhl_graph_link(node, sbhl_module_vars.get_sbhl_module(UNPROVIDED));
                                                                                                                        if (NIL != d_link) {
                                                                                                                            ...
                                                                                                                            for (generating_fn = cdolist_list_var_103.first(); NIL != cdolist_list_var_103; cdolist_list_var_103 = cdolist_list_var_103.rest() , generating_fn = cdolist_list_var_103.first()) {
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    try {
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            SubLObject link_nodes = funcall(generating_fn, node);
                                                                                                                                            SubLObject new_list_105 = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? ((SubLObject) (randomize_list(link_nodes))) : link_nodes;
                                                                                            ...
                                                                                            node_var_71 = deck.deck_pop(recur_deck);
                                                                                        } 
                                                                                    } finally {
    ...
    public static SubLObject declare_removal_modules_relation_all_instance_file() {
        declareFunction("relation_all_instance_could_apply_if_more_bound", "RELATION-ALL-INSTANCE-COULD-APPLY-IF-MORE-BOUND", 3, 0, false);
        declareFunction("relation_instance_all_could_apply_if_more_bound", "RELATION-INSTANCE-ALL-COULD-APPLY-IF-MORE-BOUND", 3, 0, false);
        declareFunction("removal_some_relation_all_instance_for_predicate", "REMOVAL-SOME-RELATION-ALL-INSTANCE-FOR-PREDICATE", 1, 1, false);
        declareFunction("removal_some_relation_all_instance_for_collection", "REMOVAL-SOME-RELATION-ALL-INSTANCE-FOR-COLLECTION", 1, 1, false);
        declareFunction("removal_some_relation_all_instance_for_value", "REMOVAL-SOME-RELATION-ALL-INSTANCE-FOR-VALUE", 1, 1, false);
        declareFunction("relation_all_instance_predicate_cost_estimate", "RELATION-ALL-INSTANCE-PREDICATE-COST-ESTIMATE", 1, 0, false);
        declareFunction("relation_all_instance_collection_cost_estimate", "RELATION-ALL-INSTANCE-COLLECTION-COST-ESTIMATE", 0, 0, false);
        declareFunction("relation_all_instance_value_cost_estimate", "RELATION-ALL-INSTANCE-VALUE-COST-ESTIMATE", 1, 0, false);
        declareFunction("removal_relation_all_instance_required", "REMOVAL-RELATION-ALL-INSTANCE-REQUIRED", 1, 0, false);
        declareFunction("make_relation_all_instance_support", "MAKE-RELATION-ALL-INSTANCE-SUPPORT", 0, 0, false);
        declareFunction("removal_relation_all_instance_check_required", "REMOVAL-RELATION-ALL-INSTANCE-CHECK-REQUIRED", 1, 1, false);
        declareFunction("removal_relation_all_instance_check_expand", "REMOVAL-RELATION-ALL-INSTANCE-CHECK-EXPAND", 1, 1, false);
        declareFunction("removal_relation_all_instance_check_via_value_expand", "REMOVAL-RELATION-ALL-INSTANCE-CHECK-VIA-VALUE-EXPAND", 2, 0, false);
        declareFunction("removal_relation_all_instance_check_via_collection_expand", "REMOVAL-RELATION-ALL-INSTANCE-CHECK-VIA-COLLECTION-EXPAND", 2, 0, false);
        declareFunction("removal_relation_all_instance_check_via_predicate_expand", "REMOVAL-RELATION-ALL-INSTANCE-CHECK-VIA-PREDICATE-EXPAND", 2, 0, false);
        declareFunction("removal_relation_all_instance_check_expand_guts", "REMOVAL-RELATION-ALL-INSTANCE-CHECK-EXPAND-GUTS", 2, 0, false);
        declareFunction("removal_relation_all_instance_unify_required", "REMOVAL-RELATION-ALL-INSTANCE-UNIFY-REQUIRED", 1, 1, false);
        ...
        declareFunction("removal_relation_all_instance_unify_cost", "REMOVAL-RELATION-ALL-INSTANCE-UNIFY-COST", 1, 1, false);
        declareFunction("removal_relation_all_instance_unify_expand", "REMOVAL-RELATION-ALL-INSTANCE-UNIFY-EXPAND", 1, 1, false);
        declareFunction("removal_relation_all_instance_unify_via_collection_expand", "REMOVAL-RELATION-ALL-INSTANCE-UNIFY-VIA-COLLECTION-EXPAND", 2, 0, false);
        declareFunction("removal_relation_all_instance_unify_via_predicate_expand", "REMOVAL-RELATION-ALL-INSTANCE-UNIFY-VIA-PREDICATE-EXPAND", 2, 0, false);
        declareFunction("removal_relation_all_instance_unify_expand_guts", "REMOVAL-RELATION-ALL-INSTANCE-UNIFY-EXPAND-GUTS", 2, 0, false);
        declareFunction("removal_relation_all_instance_iterate_required", "REMOVAL-RELATION-ALL-INSTANCE-ITERATE-REQUIRED", 1, 1, false);
        ...
        declareFunction("removal_relation_all_instance_iterate_cost", "REMOVAL-RELATION-ALL-INSTANCE-ITERATE-COST", 1, 1, false);
        declareFunction("removal_relation_all_instance_iteration_collections", "REMOVAL-RELATION-ALL-INSTANCE-ITERATION-COLLECTIONS", 2, 0, false);
        declareFunction("removal_relation_all_instance_iteration_collections_rai", "REMOVAL-RELATION-ALL-INSTANCE-ITERATION-COLLECTIONS-RAI", 2, 0, false);
        declareFunction("removal_relation_all_instance_iterate_expand", "REMOVAL-RELATION-ALL-INSTANCE-ITERATE-EXPAND", 1, 1, false);
        declareFunction("removal_some_relation_instance_all_for_predicate", "REMOVAL-SOME-RELATION-INSTANCE-ALL-FOR-PREDICATE", 1, 1, false);
        declareFunction("removal_some_relation_instance_all_for_value", "REMOVAL-SOME-RELATION-INSTANCE-ALL-FOR-VALUE", 1, 1, false);
        declareFunction("removal_some_relation_instance_all_for_collection", "REMOVAL-SOME-RELATION-INSTANCE-ALL-FOR-COLLECTION", 1, 1, false);
        declareFunction("relation_instance_all_predicate_cost_estimate", "RELATION-INSTANCE-ALL-PREDICATE-COST-ESTIMATE", 1, 0, false);
        declareFunction("relation_instance_all_collection_cost_estimate", "RELATION-INSTANCE-ALL-COLLECTION-COST-ESTIMATE", 0, 0, false);
        declareFunction("relation_instance_all_value_cost_estimate", "RELATION-INSTANCE-ALL-VALUE-COST-ESTIMATE", 1, 0, false);
        declareFunction("removal_relation_instance_all_required", "REMOVAL-RELATION-INSTANCE-ALL-REQUIRED", 1, 0, false);
        declareFunction("make_relation_instance_all_support", "MAKE-RELATION-INSTANCE-ALL-SUPPORT", 0, 0, false);
        declareFunction("removal_relation_instance_all_check_required", "REMOVAL-RELATION-INSTANCE-ALL-CHECK-REQUIRED", 1, 1, false);
        declareFunction("removal_relation_instance_all_check_expand", "REMOVAL-RELATION-INSTANCE-ALL-CHECK-EXPAND", 1, 1, false);
        declareFunction("removal_relation_instance_all_check_via_value_expand", "REMOVAL-RELATION-INSTANCE-ALL-CHECK-VIA-VALUE-EXPAND", 2, 0, false);
        declareFunction("removal_relation_instance_all_check_via_collection_expand", "REMOVAL-RELATION-INSTANCE-ALL-CHECK-VIA-COLLECTION-EXPAND", 2, 0, false);
        declareFunction("removal_relation_instance_all_check_via_predicate_expand", "REMOVAL-RELATION-INSTANCE-ALL-CHECK-VIA-PREDICATE-EXPAND", 2, 0, false);
        declareFunction("removal_relation_instance_all_check_expand_guts", "REMOVAL-RELATION-INSTANCE-ALL-CHECK-EXPAND-GUTS", 2, 0, false);
        declareFunction("removal_relation_instance_all_unify_required", "REMOVAL-RELATION-INSTANCE-ALL-UNIFY-REQUIRED", 1, 1, false);
        ...
        declareFunction("removal_relation_instance_all_unify_cost", "REMOVAL-RELATION-INSTANCE-ALL-UNIFY-COST", 1, 1, false);
        declareFunction("removal_relation_instance_all_unify_expand", "REMOVAL-RELATION-INSTANCE-ALL-UNIFY-EXPAND", 1, 1, false);
        declareFunction("removal_relation_instance_all_unify_via_predicate_expand", "REMOVAL-RELATION-INSTANCE-ALL-UNIFY-VIA-PREDICATE-EXPAND", 2, 0, false);
        declareFunction("removal_relation_instance_all_unify_via_collection_expand", "REMOVAL-RELATION-INSTANCE-ALL-UNIFY-VIA-COLLECTION-EXPAND", 2, 0, false);
        declareFunction("removal_relation_instance_all_unify_expand_guts", "REMOVAL-RELATION-INSTANCE-ALL-UNIFY-EXPAND-GUTS", 2, 0, false);
        declareFunction("removal_relation_instance_all_iterate_required", "REMOVAL-RELATION-INSTANCE-ALL-ITERATE-REQUIRED", 1, 1, false);
        ...
        declareFunction("removal_relation_instance_all_iterate_cost", "REMOVAL-RELATION-INSTANCE-ALL-ITERATE-COST", 1, 1, false);
        declareFunction("removal_relation_instance_all_iteration_collections", "REMOVAL-RELATION-INSTANCE-ALL-ITERATION-COLLECTIONS", 2, 0, false);
        declareFunction("removal_relation_instance_all_iteration_collections_ria", "REMOVAL-RELATION-INSTANCE-ALL-ITERATION-COLLECTIONS-RIA", 2, 0, false);
        declareFunction("removal_relation_instance_all_iterate_expand", "REMOVAL-RELATION-INSTANCE-ALL-ITERATE-EXPAND", 1, 1, false);
        return NIL;
    }

    public static final SubLObject init_removal_modules_relation_all_instance_file_alt() {
        defparameter("*ESTIMATED-PER-COLLECTION-REMOVAL-ALL-INSTANCE-COUNT*", TWO_INTEGER);
        defparameter("*RELATION-ALL-INSTANCE-RULE*", $list_alt1);
        deflexical("*RELATION-ALL-INSTANCE-DEFINING-MT*", NIL != boundp($relation_all_instance_defining_mt$) ? ((SubLObject) ($relation_all_instance_defining_mt$.getGlobalValue())) : $$BaseKB);
        ...
        deflexical("*RELATION-INSTANCE-ALL-RULE*", $list_alt33);
        deflexical("*RELATION-INSTANCE-ALL-DEFINING-MT*", NIL != boundp($relation_instance_all_defining_mt$) ? ((SubLObject) ($relation_instance_all_defining_mt$.getGlobalValue())) : $$BaseKB);
    ...
    public static SubLObject init_removal_modules_relation_all_instance_file_Previous() {
        defparameter("*ESTIMATED-PER-COLLECTION-REMOVAL-ALL-INSTANCE-COUNT*", TWO_INTEGER);
        defparameter("*RELATION-ALL-INSTANCE-RULE*", $list9);
        deflexical("*RELATION-ALL-INSTANCE-DEFINING-MT*", SubLTrampolineFile.maybeDefault($relation_all_instance_defining_mt$, $relation_all_instance_defining_mt$, $$BaseKB));
        defparameter("*REMOVAL-RELATION-ALL-INSTANCE-CHECK-COST*", $float$1_5);
    ...
    public static final SubLObject setup_removal_modules_relation_all_instance_file_alt() {
        ...
        inference_modules.inference_removal_module($REMOVAL_RELATION_ALL_INSTANCE_CHECK, $list_alt10);
        inference_modules.inference_removal_module($REMOVAL_RELATION_ALL_INSTANCE_UNIFY, $list_alt14);
        inference_modules.inference_removal_module($REMOVAL_RELATION_ALL_INSTANCE_ITERATE, $list_alt31);
        ...
        inference_modules.inference_removal_module($REMOVAL_RELATION_INSTANCE_ALL_CHECK, $list_alt36);
        inference_modules.inference_removal_module($REMOVAL_RELATION_INSTANCE_ALL_UNIFY, $list_alt38);
        inference_modules.inference_removal_module($REMOVAL_RELATION_INSTANCE_ALL_ITERATE, $list_alt40);
        return NIL;
    }
    ...
    public static SubLObject setup_removal_modules_relation_all_instance_file_Previous() {
        preference_modules.inference_preference_module($RELATION_ALL_INSTANCE, $list1);
        note_funcall_helper_function(RELATION_ALL_INSTANCE_COULD_APPLY_IF_MORE_BOUND);
        preference_modules.inference_preference_module($RELATION_INSTANCE_ALL, $list6);
        note_funcall_helper_function(RELATION_INSTANCE_ALL_COULD_APPLY_IF_MORE_BOUND);
    ...
    static private final SubLList $list_alt1 = list(reader_make_constant_shell("implies"), list(reader_make_constant_shell("and"), list(reader_make_constant_shell("relationAllInstance"), makeSymbol("?PRED"), makeSymbol("?COL"), makeSymbol("?VALUE")), list(reader_make_constant_shell("isa"), makeSymbol("?OBJ"), makeSymbol("?COL"))), list(makeSymbol("?PRED"), makeSymbol("?OBJ"), makeSymbol("?VALUE")));

    static private final SubLList $list_alt10 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("ARITY"), TWO_INTEGER, makeKeyword("REQUIRED-PATTERN"), list($FORT, makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND")), makeKeyword("REQUIRED"), makeSymbol("REMOVAL-RELATION-ALL-INSTANCE-CHECK-REQUIRED"), makeKeyword("COST-EXPRESSION"), makeSymbol("*REMOVAL-RELATION-ALL-INSTANCE-CHECK-COST*"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-RELATION-ALL-INSTANCE-CHECK-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(<predicate> <object> <value>) where <object> and <value> are FORTs or NAUTs\nfrom (#$relationAllInstance <predicate> <collection> <value>) \nand (#$isa <arg1> <collection>)"), makeKeyword("EXAMPLE"), makeString("(#$hasGender #$AbrahamLincoln #$Masculine)\nfrom (#$relationAllInstance #$hasGender #$MalePerson #$Masculine)\nand (#$isa #$AbrahamLincoln #$MalePerson)\n(#$duration (#$YearFn 2001) (#$YearsDuration 1))\nfrom (#$relationAllInstance #$duration #$CalendarYear (#$YearsDuration 1))\nand (#$isa (#$YearFn 2001) #$CalendarYear)") });

    static private final SubLList $list_alt14 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("ARITY"), TWO_INTEGER, makeKeyword("REQUIRED-PATTERN"), list($FORT, makeKeyword("ANYTHING"), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("REQUIRED"), makeSymbol("REMOVAL-RELATION-ALL-INSTANCE-UNIFY-REQUIRED"), $COST, makeSymbol("REMOVAL-RELATION-ALL-INSTANCE-UNIFY-COST"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-RELATION-ALL-INSTANCE-UNIFY-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(<predicate> <object> <non-fort>) where <object> is a FORT or NAUT\nfrom (#$relationAllInstance <predicate> <collection> <value>) \nand (#$isa <object> <collection>)"), makeKeyword("EXAMPLE"), makeString("(#$hasGender #$AbrahamLincoln ?GENDER)\nfrom (#$relationAllInstance #$hasGender #$MalePerson #$Masculine)\nand (#$isa #$AbrahamLincoln #$MalePerson)\n(#$duration (#$YearFn 2001) ?TIME)\nfrom (#$relationAllInstance #$duration #$CalendarYear (#$YearsDuration 1))\nand (#$isa (#$YearFn 2001) #$CalendarYear)") });

    static private final SubLList $list_alt15 = cons(makeSymbol("COLLECTION"), makeSymbol("RAI-ASSERTIONS"));
    ...
    static private final SubLList $list_alt28 = list(makeUninternedSymbol("LINK-NODE"), makeUninternedSymbol("MT"), makeUninternedSymbol("TV"));
    ...
    static private final SubLList $list_alt33 = list(reader_make_constant_shell("implies"), list(reader_make_constant_shell("and"), list(reader_make_constant_shell("relationInstanceAll"), makeSymbol("?PRED"), makeSymbol("?VALUE"), makeSymbol("?COL")), list(reader_make_constant_shell("isa"), makeSymbol("?OBJ"), makeSymbol("?COL"))), list(makeSymbol("?PRED"), makeSymbol("?VALUE"), makeSymbol("?OBJ")));

    static private final SubLList $list_alt36 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("ARITY"), TWO_INTEGER, makeKeyword("REQUIRED-PATTERN"), list($FORT, makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND")), makeKeyword("REQUIRED"), makeSymbol("REMOVAL-RELATION-INSTANCE-ALL-CHECK-REQUIRED"), makeKeyword("COST-EXPRESSION"), makeSymbol("*REMOVAL-RELATION-INSTANCE-ALL-CHECK-COST*"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-RELATION-INSTANCE-ALL-CHECK-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(<predicate> <object> <value>) where <object> and <value> are FORTs or NAUTs\nfrom (#$relationInstanceAll <predicate> <collection> <value>) \nand (#$isa <arg1> <collection>)"), makeKeyword("EXAMPLE"), makeString("(#$hasGender #$AbrahamLincoln #$Masculine)\nfrom (#$relationInstanceAll #$hasGender #$MalePerson #$Masculine)\nand (#$isa #$AbrahamLincoln #$MalePerson)\n(#$duration (#$YearFn 2001) ?TIME)\nfrom (#$relationInstanceAll #$duration #$CalendarYear (#$YearsDuration 1))\nand (#$isa (#$YearFn 2001) #$CalendarYear)") });
    ...
    static private final SubLList $list_alt40 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("ARITY"), TWO_INTEGER, makeKeyword("REQUIRED-PATTERN"), list($FORT, $FORT, makeKeyword("NOT-FULLY-BOUND")), makeKeyword("REQUIRED"), makeSymbol("REMOVAL-RELATION-INSTANCE-ALL-ITERATE-REQUIRED"), $COST, makeSymbol("REMOVAL-RELATION-INSTANCE-ALL-ITERATE-COST"), makeKeyword("COMPLETENESS"), makeKeyword("INCOMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-RELATION-INSTANCE-ALL-ITERATE-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(<predicate> <object> <non-fort>) where <object> is a FORT\n from (#$relationInstanceAll <predicate> <object> <collection>)\n by iterating over <collection>"), makeKeyword("EXAMPLE"), makeString("(subsetOf TheEmptySet ?WHAT) \n from\n   (relationInstanceAll subsetOf TheEmptySet SetOrCollection)") });
}
