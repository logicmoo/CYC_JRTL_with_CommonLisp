...
public final class owl_exporter2 extends SubLTranslatedFile implements V10 {
    ...
    private static final SubLList $list0 = list(new SubLObject[] { makeKeyword("ONTOLOGY-TERM"), makeKeyword("ONTOLOGY-MT"), makeKeyword("ONTOLOGY-URI"), makeKeyword("BASE-URI"), makeKeyword("DEFAULT-NAMESPACE-URI"), makeKeyword("CYCLIST"), makeKeyword("PREFER-URIS"), makeKeyword("SAME-AS-URIS"),
	    makeKeyword("ADD-COMMENTS"), makeKeyword("ADD-PRETTY-STRINGS"), makeKeyword("ADD-PRETTY-STRING-CANONICAL"), makeKeyword("RESTRICT-CONTEXT?"), makeKeyword("SUPPRESS-ADDITIONAL-TYPE-TRIPLES?"), makeKeyword("SUPPRESS-EXPORT-OF-DERIVED-KNOWLEDGE?"),
	    makeKeyword("SUPPRESS-HUMANLY-READABLE-NON-OPENCYC-URIS"), makeKeyword("EXPORT-ENTIRE-KB?"), makeKeyword("OPENCYC-EXPORT?"), makeKeyword("VERBOSE?") });
    ...
    private static final SubLList $list63 = list(
	    new SubLObject[] { makeSymbol("ID"), makeSymbol("URI"), makeSymbol("FILE"), makeSymbol("GRAPH"), makeSymbol("CYCLIST"), makeSymbol("EXPORT"), makeSymbol("ONTOLOGY"), makeSymbol("TERMS"), makeSymbol("SENTENCES"), makeSymbol("STATS"), makeSymbol("OPTIONS"), makeSymbol("THREAD") });

    private static final SubLList $list64 = list(new SubLObject[] { makeKeyword("ID"), makeKeyword("URI"), $FILE, makeKeyword("GRAPH"), makeKeyword("CYCLIST"), makeKeyword("EXPORT"), makeKeyword("ONTOLOGY"), makeKeyword("TERMS"), makeKeyword("SENTENCES"), makeKeyword("STATS"),
	    makeKeyword("OPTIONS"), makeKeyword("THREAD") });

    private static final SubLList $list65 = list(new SubLObject[] { makeSymbol("OWL-EXP2-ID"), makeSymbol("OWL-EXP2-URI"), makeSymbol("OWL-EXP2-FILE"), makeSymbol("OWL-EXP2-GRAPH"), makeSymbol("OWL-EXP2-CYCLIST"), makeSymbol("OWL-EXP2-EXPORT"), makeSymbol("OWL-EXP2-ONTOLOGY"),
	    makeSymbol("OWL-EXP2-TERMS"), makeSymbol("OWL-EXP2-SENTENCES"), makeSymbol("OWL-EXP2-STATS"), makeSymbol("OWL-EXP2-OPTIONS"), makeSymbol("OWL-EXP2-THREAD") });

    private static final SubLList $list66 = list(new SubLObject[] { makeSymbol("_CSETF-OWL-EXP2-ID"), makeSymbol("_CSETF-OWL-EXP2-URI"), makeSymbol("_CSETF-OWL-EXP2-FILE"), makeSymbol("_CSETF-OWL-EXP2-GRAPH"), makeSymbol("_CSETF-OWL-EXP2-CYCLIST"), makeSymbol("_CSETF-OWL-EXP2-EXPORT"),
	    makeSymbol("_CSETF-OWL-EXP2-ONTOLOGY"), makeSymbol("_CSETF-OWL-EXP2-TERMS"), makeSymbol("_CSETF-OWL-EXP2-SENTENCES"), makeSymbol("_CSETF-OWL-EXP2-STATS"), makeSymbol("_CSETF-OWL-EXP2-OPTIONS"), makeSymbol("_CSETF-OWL-EXP2-THREAD") });
    ...
    private static final SubLList $list146 = list(reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("genls")), reader_make_constant_shell(makeString("genlPreds")), reader_make_constant_shell(makeString("comment")),
	    reader_make_constant_shell(makeString("coExtensional")), reader_make_constant_shell(makeString("disjointWith")), reader_make_constant_shell(makeString("arg1Isa")), reader_make_constant_shell(makeString("arg2Isa")));
    ...
    private static final SubLList $list183 = list(reader_make_constant_shell(makeString("relationAllExists")), reader_make_constant_shell(makeString("relationAllOnly")), reader_make_constant_shell(makeString("relationAllInstance")), reader_make_constant_shell(makeString("relationAllExistsCount")),
	    reader_make_constant_shell(makeString("relationAllExistsMin")), reader_make_constant_shell(makeString("relationAllExistsMax")));
	...
	} else if ((NIL == isa.isa_in_any_mtP(operation_communication.the_cyclist(), $$Cyclist)) || $$Guest.eql(operation_communication.the_cyclist())) {
	...
	try {
		...
		if (NIL != owl_exporter2_get_option(exporter, $kw41$OPENCYC_EXPORT_, UNPROVIDED)) {
		    ...
		    } else if ($VERSIONED == owl_exporter2_get_option(exporter, $kw41$OPENCYC_EXPORT_, UNPROVIDED)) {
		    ...
		    } else if ($UNVERSIONED == owl_exporter2_get_option(exporter, $kw41$OPENCYC_EXPORT_, UNPROVIDED)) {
	...
	assert NIL != owl_exporter2_p(v_object) : "owl_exporter2.owl_exporter2_p error :" + v_object;
	...
	try {
	    ...
	    mt_relevance_macros.$relevant_mt_function$.bind(
		    (NIL != owl_exporter2_get_option(exporter, $kw127$EXPORT_ENTIRE_KB_, UNPROVIDED)) || ($ALL == ontology_mt) ? RELEVANT_MT_IS_EVERYTHING : NIL != owl_exporter2_get_option(exporter, $kw129$RESTRICT_CONTEXT_, UNPROVIDED) ? RELEVANT_MT_IS_EQ : RELEVANT_MT_IS_GENL_MT, thread);
	...
	} else if ((NIL != focal_nodeP) && v_term.eql($$TheEmptyList)) {
	    result = rdf_uri.get_rdf_uri(owl_cycl_to_xml.owl_opencyc_readable_uri_for_fort(v_term, UNPROVIDED), UNPROVIDED, UNPROVIDED);
	} else if ((((NIL != focal_nodeP) && ($OPENCYC == owl_exporter2_get_option(exporter, $PREFER_URIS, UNPROVIDED))) && (NIL != list_utilities.member_eqP(v_term, $list146)))
		&& ((NIL != owl_exporter2_get_option(exporter, $kw127$EXPORT_ENTIRE_KB_, UNPROVIDED)) || (NIL != list_utilities.member_eqP(v_term, owl_exporter2_terms(exporter))))) {
	...
	if (((NIL != nart_handles.nart_p(v_term)) && (NIL == narts_high.nart_with_functor_p($$ResourceWithURIFn, v_term))) && ((NIL != isa.isa_in_any_mtP(v_term, $const149$owl_Class)) || (NIL != isa.isa_in_any_mtP(v_term, $const150$owl_Restriction)))) {
	...
	} else if ((NIL != nart_handles.nart_p(v_term)) && (NIL != narts_high.nart_with_functor_p($$ResourceWithURIFn, v_term))) {
	    ...
	    if (((NIL != constant_p(v_term))
		    && ((NIL != string_utilities.substringP($$$Indeterminate, constants_high.constant_name(v_term), UNPROVIDED, UNPROVIDED, UNPROVIDED)) || (NIL != string_utilities.substringP($$$Anonymous, constants_high.constant_name(v_term), UNPROVIDED, UNPROVIDED, UNPROVIDED))))
		    && (NIL != isa.quoted_isa_in_any_mtP(v_term, $$IndeterminateTerm))) {
		result = rdf_blank_node.new_rdf_blank_node(owl_exporter2_next_blank_node_id(exporter));
	    } else if ((NIL != nart_handles.nart_p(v_term)) && cycl_utilities.nat_functor(v_term).eql($$TheCollection)) {
		result = rdf_blank_node.new_rdf_blank_node(owl_exporter2_next_blank_node_id(exporter));
	    } else if ((($SYNONYMOUS_EXTERNAL_CONCEPT == owl_exporter2_get_option(exporter, $PREFER_URIS, UNPROVIDED)) && (NIL != forts.fort_p(v_term))) && (NIL != owl_exporter2_owl_synonymous_external_concept_uri_for_fort(exporter, v_term))) {
		result = owl_exporter2_owl_synonymous_external_concept_uri_for_fort(exporter, v_term);
	    } else if ((($OPENCYC == owl_exporter2_get_option(exporter, $PREFER_URIS, UNPROVIDED)) && (NIL != forts.fort_p(v_term))) && (NIL != owl_exporter2_fort_has_exported_owl_opencyc_contentP(exporter, v_term))) {
		result = owl_exporter2_owl_opencyc_uri_for_fort(exporter, v_term);
	    } else if (($OPENCYC == owl_exporter2_get_option(exporter, $PREFER_URIS, UNPROVIDED)) && (NIL != forts.fort_p(v_term))) {
	    ...
	    } else if ((NIL != forts.fort_p(v_term)) && ((NIL != (NIL != hlmt.hlmt_p(ontology_mt) ? kb_mapping_utilities.pred_values(v_term, $$rdfURI, UNPROVIDED, UNPROVIDED, UNPROVIDED) : kb_mapping_utilities.pred_values_in_any_mt(v_term, $$rdfURI, UNPROVIDED, UNPROVIDED, UNPROVIDED)))
		    || (NIL != kb_mapping_utilities.pred_values_in_mt(v_term, $$rdfURI, $$BaseKB, UNPROVIDED, UNPROVIDED, UNPROVIDED)))) {
	...
	if (NIL != synonymous_external_concept_assertions) {
		...
		while ((NIL == result) && (NIL != csome_list_var)) {
		    ...
		    } else if ((NIL != string_utilities.non_empty_stringP(ontology_base_uri)) && ONE_INTEGER.numE(string_utilities.count_chars_in_string(synonymous_external_concept_string, CHAR_colon))) {
	...
	if ((((((!predicate.eql($$isa)) && ((!predicate.eql($$genls)) || (NIL != genls.genl_in_any_mtP(v_object, subject))))
		&& ((!predicate.eql($$genlPreds)) || (((NIL != forts.fort_p(v_object)) && (NIL != forts.fort_p(subject))) && (NIL != genl_predicates.genl_predicate_in_any_mtP(v_object, subject))))) && (NIL == has_known_uriP(predicate)))
		&& (NIL == subl_promotions.memberP(predicate, terms, EQUAL, UNPROVIDED))) && (NIL == export_entire_kbP)) {
	...
	if (((((((((NIL == has_known_uriP(v_object)) && (NIL == subl_promotions.memberP(v_object, terms, EQUAL, UNPROVIDED))) && (NIL == export_entire_kbP)) && (NIL == el_list_p(v_object))) && (!v_object.isString())) && (NIL == unicode_nauts.unicode_naut_p(v_object, UNPROVIDED)))
		&& (!v_object.isInteger())) && ((NIL == forts.fort_p(v_object)) || (NIL == kb_mapping_utilities.fpred_value_in_any_mt(v_object, $$owlDataTypeSemanticCorrelation, TWO_INTEGER, ONE_INTEGER, UNPROVIDED))))
		&& ((NIL == nart_handles.nart_p(v_object)) || (!cycl_utilities.nat_functor(v_object).eql($$ResourceWithURIFn)))) {
	...
	if (NIL != triples) {
		...
		if ((NIL != rdf_blank_node.rdf_blank_node_p(possible_restriction)) && ((((rmp_predicate.eql($$relationAllExists) && (NIL != rdf_graph.rdf_graph_find_triple(v_graph, possible_restriction, rdf_graph.get_known_uri($str196$owl_someValuesFrom), col2)))
			|| (rmp_predicate.eql($$relationAllOnly) && (NIL != rdf_graph.rdf_graph_find_triple(v_graph, possible_restriction, rdf_graph.get_known_uri($str198$owl_allValuesFrom), col2))))
			|| (rmp_predicate.eql($$relationAllInstance) && (NIL != rdf_graph.rdf_graph_find_triple(v_graph, possible_restriction, rdf_graph.get_known_uri($str200$owl_hasValue), col2))))
			|| ((NIL != list_utilities.member_eqP(rmp_predicate, $list201)) && (NIL != rdf_graph.rdf_graph_find_triple(v_graph, possible_restriction, rdf_graph.get_known_uri($str202$owl_valuesFrom), col2))))) {
		    return NIL;
		}
		cdolist_list_var = cdolist_list_var.rest();
		triple = cdolist_list_var.first();
	...
	if (NIL != owl_export_supported_rule_macro_predicateP(rmp_predicate)) {
	    ...
	    } else if (rmp_predicate.eql($$relationAllExistsMin)) {
		rdf_graph.rdf_graph_add_triple(v_graph, restriction, rdf_graph.get_known_uri($str202$owl_valuesFrom), col2);
	    ...
	    } else if (rmp_predicate.eql($$relationAllExistsMax)) {
		rdf_graph.rdf_graph_add_triple(v_graph, restriction, rdf_graph.get_known_uri($str202$owl_valuesFrom), col2);
	...
	try {
	    $progress_note$.bind(NIL != cconcatenate($$$Adding_additional_triples_for_, new SubLObject[] { format_nil.format_nil_a_no_copy(length(subjects)), $str231$_nodes___ })
		    ? cconcatenate($$$Adding_additional_triples_for_, new SubLObject[] { format_nil.format_nil_a_no_copy(length(subjects)), $str231$_nodes___ })
		    : $$$cdolist, thread);
	    $progress_start_time$.bind(get_universal_time(), thread);
	    $progress_total$.bind(length(list_var), thread);
	    $progress_sofar$.bind(ZERO_INTEGER, thread);
		...
		try {
			...
			try {
				...
				try {
					...
					try {
					    $progress_note$.bind(NIL != cconcatenate($str245$Adding_rdf_label_triples_for_, new SubLObject[] { format_nil.format_nil_a_no_copy(length(v_forts)), $$$_FORTs })
						    ? cconcatenate($str245$Adding_rdf_label_triples_for_, new SubLObject[] { format_nil.format_nil_a_no_copy(length(v_forts)), $$$_FORTs })
						    : $$$cdolist, thread);
					    $progress_start_time$.bind(get_universal_time(), thread);
					    $progress_total$.bind(length(list_var), thread);
					    $progress_sofar$.bind(ZERO_INTEGER, thread);
					...
					try {
					    $progress_note$.bind(NIL != cconcatenate($str253$Adding_cycAnnot_externalID_triple, new SubLObject[] { format_nil.format_nil_a_no_copy(length(v_forts)), $$$_FORTs })
						    ? cconcatenate($str253$Adding_cycAnnot_externalID_triple, new SubLObject[] { format_nil.format_nil_a_no_copy(length(v_forts)), $$$_FORTs })
						    : $$$cdolist, thread);
					    $progress_start_time$.bind(get_universal_time(), thread);
					...
					final SubLObject _prev_bind_22 = $percent_progress_start_time$.currentBinding(thread);
					try {
					    $progress_note$.bind(NIL != cconcatenate($str255$Adding_cycAnnot_label_triples_for, new SubLObject[] { format_nil.format_nil_a_no_copy(length(v_forts)), $$$_FORTs })
						    ? cconcatenate($str255$Adding_cycAnnot_label_triples_for, new SubLObject[] { format_nil.format_nil_a_no_copy(length(v_forts)), $$$_FORTs })
						    : $$$cdolist, thread);
					    $progress_start_time$.bind(get_universal_time(), thread);
					    $progress_total$.bind(length(list_var2), thread);
					    $progress_sofar$.bind(ZERO_INTEGER, thread);
	...
	if (((NIL == foundP) && (NIL != rdf_graph.rdf_node_symmetric_predicateP(rdf_triple.rdf_triple_predicate(triple))))
		&& (NIL != keyhash.getkeyhash(list(rdf_triple.rdf_triple_predicate(triple), rdf_triple.rdf_triple_object(triple), rdf_triple.rdf_triple_subject(triple)), $owl_export_exported_triples$.getDynamicValue(thread)))) {
	    foundP = T;
	}
	return foundP;
    }
		...
		try {
			...
			try {
				...
				try {
					...
					while (NIL != cdolist_list_var) {
					    if ((NIL != rdf_graph.rdf_nodes_equalP(rdf_triple.rdf_triple_predicate(ontology_triple), rdf_graph.get_known_uri($str154$rdf_type)))
						    && (NIL != rdf_graph.rdf_nodes_equalP(rdf_triple.rdf_triple_object(ontology_triple), rdf_graph.get_known_uri($str213$owl_Ontology)))) {
	...
	if (NIL != list_utilities.singletonP(type_triples)) {
		...
		if (NIL == rdf_blank_node.rdf_blank_node_p(type_triple_object_node)) {
			...
			try {
				...
				xml_utilities.$xml_indentation_level$.bind(add(xml_utilities.$xml_indentation_amount$.getDynamicValue(thread), xml_utilities.$xml_indentation_level$.getDynamicValue(thread)), thread);
				xml_utilities.$cycml_indent_level$.bind(xml_utilities.$xml_indentation_level$.getDynamicValue(thread), thread);
				xml_utilities.xml_start_tag_internal(xml_tag_abbrev(exporter, type_triple_object_node),
					NIL != owl_exporter2_blank_node_should_be_referenced_by_nameP(exporter, type_triple_subject_node) ? owl_exporter2_xml_about_attributes_for_node(exporter, type_triple_subject_node) : NIL, NIL, NIL, $UNINITIALIZED);
				final SubLObject _prev_bind_0_$113 = xml_vars.$xml_default_namespace$.currentBinding(thread);
				try {
				    xml_vars.$xml_default_namespace$.bind($UNINITIALIZED, thread);
				    if (NIL != subject_triples) {
	    ...
	    } else if (NIL != rdf_graph.rdf_nodes_equalP(type_triple_object_node, rdf_uri.get_rdf_uri(owl_utilities.owl_expanded_name($$$Class), UNPROVIDED, UNPROVIDED))) {
		try {
		    final SubLObject _prev_bind_3 = xml_utilities.$xml_indentation_level$.currentBinding(thread);
		    final SubLObject _prev_bind_4 = xml_utilities.$cycml_indent_level$.currentBinding(thread);
		    try {
			xml_utilities.$xml_indentation_level$.bind(add(xml_utilities.$xml_indentation_amount$.getDynamicValue(thread), xml_utilities.$xml_indentation_level$.getDynamicValue(thread)), thread);
			xml_utilities.$cycml_indent_level$.bind(xml_utilities.$xml_indentation_level$.getDynamicValue(thread), thread);
			xml_utilities.xml_start_tag_internal(xml_tag_abbrev(exporter, rdf_uri.get_rdf_uri(rdf_utilities.rdf_expanded_name($$$Description), UNPROVIDED, UNPROVIDED)), owl_exporter2_xml_about_attributes_for_node(exporter, type_triple_subject_node), makeBoolean(NIL == subject_triples),
				NIL, $UNINITIALIZED);
	...
	final SubLObject v_graph = owl_exporter2_graph(exporter);
	if (((NIL != owl_exporter2_blank_node_should_be_referenced_by_nameP(exporter, blank_node)) && (!blank_node.eql($owl_export_exporting_focal_nodeP$.getDynamicValue(thread))))
		&& (NIL != remove_if($sym285$OWL_EXPORT_EXPORTED_TRIPLE_, rdf_graph.rdf_graph_find_subject_triples_canonical(v_graph, blank_node, UNPROVIDED), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED))) {
	    xml_utilities.xml_terpri();
	    final SubLObject _prev_bind_0 = xml_utilities.$xml_indentation_level$.currentBinding(thread);
	    final SubLObject _prev_bind_2 = xml_utilities.$cycml_indent_level$.currentBinding(thread);
	    try {
	...
	final SubLObject v_graph = owl_exporter2_graph(exporter);
	return makeBoolean((((NIL == owl_exporter2_get_option(exporter, $kw309$SUPPRESS_DUPLICATE_EXPORT_OF_BLANK_NODES_, UNPROVIDED)) && (NIL != rdf_blank_node.rdf_blank_node_p(blank_node))) && (NIL == rdf_utilities.rdf_list_p(blank_node, v_graph)))
		&& ONE_INTEGER.numL(length(rdf_graph.rdf_graph_find_object_triples_canonical(v_graph, blank_node, UNPROVIDED))));
    }
	...
	declareFunction("show_owl_export_usages", "SHOW-OWL-EXPORT-USAGES", 0, 0, false);
	declareFunction("owl_export_ontology_to_file", "OWL-EXPORT-ONTOLOGY-TO-FILE", 2, 1, false);
	declareFunction("owl_export_ontology_to_stream", "OWL-EXPORT-ONTOLOGY-TO-STREAM", 1, 2, false);
	declareFunction("owl_export_terms_to_file", "OWL-EXPORT-TERMS-TO-FILE", 2, 1, false);
	declareFunction("owl_export_terms_to_stream", "OWL-EXPORT-TERMS-TO-STREAM", 1, 2, false);
	declareFunction("owl_terms_for_ontology", "OWL-TERMS-FOR-ONTOLOGY", 1, 0, false);
	declareFunction("validate_owl_export_parameters", "VALIDATE-OWL-EXPORT-PARAMETERS", 2, 0, false);
	declareFunction("owl_export_with_exporter", "OWL-EXPORT-WITH-EXPORTER", 1, 0, false);
	declareFunction("owl_exporter_v2_version_number", "OWL-EXPORTER-V2-VERSION-NUMBER", 0, 0, false);
	declareFunction("owl_exporter2_print_function_trampoline", "OWL-EXPORTER2-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
	declareFunction("owl_exporter2_p", "OWL-EXPORTER2-P", 1, 0, false);
	new owl_exporter2.$owl_exporter2_p$UnaryFunction();
	declareFunction("owl_exp2_id", "OWL-EXP2-ID", 1, 0, false);
	declareFunction("owl_exp2_uri", "OWL-EXP2-URI", 1, 0, false);
	declareFunction("owl_exp2_file", "OWL-EXP2-FILE", 1, 0, false);
	declareFunction("owl_exp2_graph", "OWL-EXP2-GRAPH", 1, 0, false);
	declareFunction("owl_exp2_cyclist", "OWL-EXP2-CYCLIST", 1, 0, false);
	declareFunction("owl_exp2_export", "OWL-EXP2-EXPORT", 1, 0, false);
	declareFunction("owl_exp2_ontology", "OWL-EXP2-ONTOLOGY", 1, 0, false);
	declareFunction("owl_exp2_terms", "OWL-EXP2-TERMS", 1, 0, false);
	declareFunction("owl_exp2_sentences", "OWL-EXP2-SENTENCES", 1, 0, false);
	declareFunction("owl_exp2_stats", "OWL-EXP2-STATS", 1, 0, false);
	declareFunction("owl_exp2_options", "OWL-EXP2-OPTIONS", 1, 0, false);
	declareFunction("owl_exp2_thread", "OWL-EXP2-THREAD", 1, 0, false);
	declareFunction("_csetf_owl_exp2_id", "_CSETF-OWL-EXP2-ID", 2, 0, false);
	declareFunction("_csetf_owl_exp2_uri", "_CSETF-OWL-EXP2-URI", 2, 0, false);
	declareFunction("_csetf_owl_exp2_file", "_CSETF-OWL-EXP2-FILE", 2, 0, false);
	declareFunction("_csetf_owl_exp2_graph", "_CSETF-OWL-EXP2-GRAPH", 2, 0, false);
	declareFunction("_csetf_owl_exp2_cyclist", "_CSETF-OWL-EXP2-CYCLIST", 2, 0, false);
	declareFunction("_csetf_owl_exp2_export", "_CSETF-OWL-EXP2-EXPORT", 2, 0, false);
	declareFunction("_csetf_owl_exp2_ontology", "_CSETF-OWL-EXP2-ONTOLOGY", 2, 0, false);
	declareFunction("_csetf_owl_exp2_terms", "_CSETF-OWL-EXP2-TERMS", 2, 0, false);
	declareFunction("_csetf_owl_exp2_sentences", "_CSETF-OWL-EXP2-SENTENCES", 2, 0, false);
	declareFunction("_csetf_owl_exp2_stats", "_CSETF-OWL-EXP2-STATS", 2, 0, false);
	declareFunction("_csetf_owl_exp2_options", "_CSETF-OWL-EXP2-OPTIONS", 2, 0, false);
	declareFunction("_csetf_owl_exp2_thread", "_CSETF-OWL-EXP2-THREAD", 2, 0, false);
	declareFunction("make_owl_exporter2", "MAKE-OWL-EXPORTER2", 0, 1, false);
	declareFunction("visit_defstruct_owl_exporter2", "VISIT-DEFSTRUCT-OWL-EXPORTER2", 2, 0, false);
	declareFunction("visit_defstruct_object_owl_exporter2_method", "VISIT-DEFSTRUCT-OBJECT-OWL-EXPORTER2-METHOD", 2, 0, false);
	declareFunction("print_owl_exporter2", "PRINT-OWL-EXPORTER2", 3, 0, false);
	declareFunction("new_owl_exporter2", "NEW-OWL-EXPORTER2", 1, 0, false);
	declareFunction("cyclist_using_owl_exporter_v2", "CYCLIST-USING-OWL-EXPORTER-V2", 1, 0, false);
	declareFunction("next_owl_exporter2_id", "NEXT-OWL-EXPORTER2-ID", 0, 0, false);
	declareFunction("owl_exporter2_id_map", "OWL-EXPORTER2-ID-MAP", 0, 0, false);
	declareFunction("note_owl_exporter2_id", "NOTE-OWL-EXPORTER2-ID", 2, 0, false);
	declareFunction("owl_exporter2_id", "OWL-EXPORTER2-ID", 1, 0, false);
	declareFunction("owl_exporter2_uri", "OWL-EXPORTER2-URI", 1, 0, false);
	declareFunction("owl_exporter2_file", "OWL-EXPORTER2-FILE", 1, 0, false);
	declareFunction("owl_exporter2_graph", "OWL-EXPORTER2-GRAPH", 1, 0, false);
	declareFunction("owl_exporter2_set_graph", "OWL-EXPORTER2-SET-GRAPH", 2, 0, false);
	declareFunction("owl_exporter2_cyclist", "OWL-EXPORTER2-CYCLIST", 1, 0, false);
	declareFunction("owl_exporter2_export", "OWL-EXPORTER2-EXPORT", 1, 0, false);
	declareFunction("owl_exporter2_ontology", "OWL-EXPORTER2-ONTOLOGY", 1, 0, false);
	declareFunction("owl_exporter2_set_ontology", "OWL-EXPORTER2-SET-ONTOLOGY", 2, 0, false);
	declareFunction("owl_exporter2_terms", "OWL-EXPORTER2-TERMS", 1, 0, false);
	declareFunction("owl_exporter2_set_terms", "OWL-EXPORTER2-SET-TERMS", 2, 0, false);
	declareFunction("owl_exporter2_sentences", "OWL-EXPORTER2-SENTENCES", 1, 0, false);
	declareFunction("owl_exporter2_stats", "OWL-EXPORTER2-STATS", 1, 0, false);
	declareFunction("owl_exporter2_note_stat", "OWL-EXPORTER2-NOTE-STAT", 3, 0, false);
	declareFunction("owl_exporter2_lookup_stat", "OWL-EXPORTER2-LOOKUP-STAT", 2, 0, false);
	declareFunction("owl_exporter2_triple_count", "OWL-EXPORTER2-TRIPLE-COUNT", 1, 0, false);
	declareFunction("owl_exporter2_triples_done", "OWL-EXPORTER2-TRIPLES-DONE", 1, 0, false);
	declareFunction("owl_exporter2_nodes_done", "OWL-EXPORTER2-NODES-DONE", 1, 0, false);
	declareFunction("owl_exporter2_increment_triples_done", "OWL-EXPORTER2-INCREMENT-TRIPLES-DONE", 1, 0, false);
	declareFunction("owl_exporter2_increment_nodes_done", "OWL-EXPORTER2-INCREMENT-NODES-DONE", 1, 0, false);
	declareFunction("owl_exporter2_set_options", "OWL-EXPORTER2-SET-OPTIONS", 2, 0, false);
	declareFunction("owl_exporter2_set_option", "OWL-EXPORTER2-SET-OPTION", 3, 0, false);
	declareFunction("owl_exporter2_set_option_if_not_set", "OWL-EXPORTER2-SET-OPTION-IF-NOT-SET", 3, 0, false);
	declareFunction("owl_exporter2_get_option", "OWL-EXPORTER2-GET-OPTION", 2, 1, false);
	declareFunction("owl_exporter2_options", "OWL-EXPORTER2-OPTIONS", 1, 0, false);
	declareFunction("owl_exporter2_note_thread", "OWL-EXPORTER2-NOTE-THREAD", 2, 0, false);
	declareFunction("owl_exporter2_thread", "OWL-EXPORTER2-THREAD", 1, 0, false);
	declareFunction("sxhash_owl_exporter2_method", "SXHASH-OWL-EXPORTER2-METHOD", 1, 0, false);
	declareFunction("sxhash_owl_exporter2", "SXHASH-OWL-EXPORTER2", 1, 0, false);
	declareFunction("owl_exporter2_create_graph", "OWL-EXPORTER2-CREATE-GRAPH", 1, 0, false);
	declareFunction("owl_exporter2_add_term_assertions_to_graph", "OWL-EXPORTER2-ADD-TERM-ASSERTIONS-TO-GRAPH", 2, 1, false);
	declareFunction("owl_exporter2_find_node_for_term", "OWL-EXPORTER2-FIND-NODE-FOR-TERM", 2, 2, false);
	declareFunction("owl_exporter2_find_node_for_term_int_internal", "OWL-EXPORTER2-FIND-NODE-FOR-TERM-INT-INTERNAL", 2, 0, false);
	declareFunction("owl_exporter2_find_node_for_term_int", "OWL-EXPORTER2-FIND-NODE-FOR-TERM-INT", 2, 0, false);
	declareFunction("owl_exporter2_owl_opencyc_uri_for_fort", "OWL-EXPORTER2-OWL-OPENCYC-URI-FOR-FORT", 2, 0, false);
	declareFunction("owl_exporter2_owl_synonymous_external_concept_uri_for_fort", "OWL-EXPORTER2-OWL-SYNONYMOUS-EXTERNAL-CONCEPT-URI-FOR-FORT", 2, 0, false);
	declareFunction("owl_exporter2_fort_has_exported_owl_opencyc_contentP", "OWL-EXPORTER2-FORT-HAS-EXPORTED-OWL-OPENCYC-CONTENT?", 2, 0, false);
	declareFunction("owl_exporter2_next_blank_node_id", "OWL-EXPORTER2-NEXT-BLANK-NODE-ID", 1, 0, false);
	declareFunction("owl_exporter2_term_graph_assertions", "OWL-EXPORTER2-TERM-GRAPH-ASSERTIONS", 2, 0, false);
	declareFunction("owl_export_supported_rule_macro_predicateP", "OWL-EXPORT-SUPPORTED-RULE-MACRO-PREDICATE?", 1, 0, false);
	declareFunction("owl_exporter2_exportable_assertionP", "OWL-EXPORTER2-EXPORTABLE-ASSERTION?", 2, 0, false);
	declareFunction("owl_exporter2_exportable_binary_gaf_formulaP", "OWL-EXPORTER2-EXPORTABLE-BINARY-GAF-FORMULA?", 4, 0, false);
	declareFunction("owl_exporter2_add_assertion_to_graph", "OWL-EXPORTER2-ADD-ASSERTION-TO-GRAPH", 2, 0, false);
	declareFunction("owl_exporter2_add_binary_gaf_to_graph", "OWL-EXPORTER2-ADD-BINARY-GAF-TO-GRAPH", 2, 0, false);
	declareFunction("owl_exporter2_add_rmp_assertion_to_graph", "OWL-EXPORTER2-ADD-RMP-ASSERTION-TO-GRAPH", 2, 0, false);
	declareFunction("owl_exporter2_add_type_for_node_to_graph", "OWL-EXPORTER2-ADD-TYPE-FOR-NODE-TO-GRAPH", 3, 0, false);
	declareFunction("owl_exporter2_add_range_for_predicate", "OWL-EXPORTER2-ADD-RANGE-FOR-PREDICATE", 3, 0, false);
	declareFunction("owl_exporter2_add_domain_for_predicate", "OWL-EXPORTER2-ADD-DOMAIN-FOR-PREDICATE", 3, 0, false);
	declareFunction("owl_exporter2_add_el_list_to_graph", "OWL-EXPORTER2-ADD-EL-LIST-TO-GRAPH", 2, 0, false);
	declareFunction("uri_for_cyc_term", "URI-FOR-CYC-TERM", 1, 0, false);
	declareFunction("has_known_uriP", "HAS-KNOWN-URI?", 1, 0, false);
	declareFunction("owl_exporter2_modify_graph", "OWL-EXPORTER2-MODIFY-GRAPH", 1, 0, false);
	declareFunction("owl_exporter2_add_extra_triples", "OWL-EXPORTER2-ADD-EXTRA-TRIPLES", 1, 0, false);
	declareFunction("get_language_code_for_mt", "GET-LANGUAGE-CODE-FOR-MT", 1, 0, false);
	declareFunction("owl_exporter2_add_opencyc_ontology", "OWL-EXPORTER2-ADD-OPENCYC-ONTOLOGY", 1, 0, false);
	declareFunction("owl_exporter2_add_rdf_graph_prefix_map", "OWL-EXPORTER2-ADD-RDF-GRAPH-PREFIX-MAP", 1, 0, false);
	declareFunction("owl_exporter2_output_to_stream", "OWL-EXPORTER2-OUTPUT-TO-STREAM", 1, 0, false);
	declareFunction("owl_export_exported_tripleP", "OWL-EXPORT-EXPORTED-TRIPLE?", 1, 0, false);
	declareFunction("owl_export_note_exported_triple", "OWL-EXPORT-NOTE-EXPORTED-TRIPLE", 1, 0, false);
	declareFunction("owl_export_exported_focal_nodeP", "OWL-EXPORT-EXPORTED-FOCAL-NODE?", 1, 0, false);
	declareFunction("owl_export_note_exported_focal_node", "OWL-EXPORT-NOTE-EXPORTED-FOCAL-NODE", 1, 0, false);
	declareFunction("owl_exporter2_focal_nodeP", "OWL-EXPORTER2-FOCAL-NODE?", 2, 0, false);
	declareFunction("owl_exporter2_export_rdf_graph_to_stream", "OWL-EXPORTER2-EXPORT-RDF-GRAPH-TO-STREAM", 1, 0, false);
	declareFunction("owl_exporter2_export_rdf_nodes_of_type_to_stream", "OWL-EXPORTER2-EXPORT-RDF-NODES-OF-TYPE-TO-STREAM", 2, 0, false);
	declareFunction("owl_exporter2_export_rdf_subject_node_to_stream_int", "OWL-EXPORTER2-EXPORT-RDF-SUBJECT-NODE-TO-STREAM-INT", 3, 0, false);
	declareFunction("owl_exporter2_xml_about_attributes_for_node", "OWL-EXPORTER2-XML-ABOUT-ATTRIBUTES-FOR-NODE", 2, 0, false);
	declareFunction("owl_exporter2_xml_resource_attributes_for_node", "OWL-EXPORTER2-XML-RESOURCE-ATTRIBUTES-FOR-NODE", 2, 0, false);
	declareFunction("owl_exporter2_export_rdf_subject_node_to_stream", "OWL-EXPORTER2-EXPORT-RDF-SUBJECT-NODE-TO-STREAM", 2, 1, false);
	declareFunction("owl_exporter2_export_rdf_triple_to_stream", "OWL-EXPORTER2-EXPORT-RDF-TRIPLE-TO-STREAM", 2, 0, false);
	declareFunction("owl_exporter2_export_literal_to_stream", "OWL-EXPORTER2-EXPORT-LITERAL-TO-STREAM", 2, 1, false);
	declareFunction("owl_exporter2_export_node_to_stream", "OWL-EXPORTER2-EXPORT-NODE-TO-STREAM", 2, 0, false);
	declareFunction("owl_exporter2_export_blank_node_to_stream", "OWL-EXPORTER2-EXPORT-BLANK-NODE-TO-STREAM", 2, 0, false);
	declareFunction("owl_exporter2_blank_node_should_be_referenced_by_nameP", "OWL-EXPORTER2-BLANK-NODE-SHOULD-BE-REFERENCED-BY-NAME?", 2, 0, false);
	declareFunction("xml_tag_abbrev", "XML-TAG-ABBREV", 2, 0, false);
	declareFunction("owl_exporter2_abbrevname_for_xml_tag", "OWL-EXPORTER2-ABBREVNAME-FOR-XML-TAG", 2, 0, false);
	declareFunction("owl_exporter2_abbrevname_for_uri", "OWL-EXPORTER2-ABBREVNAME-FOR-URI", 2, 0, false);
	return NIL;
    }
	...
	static {
	    structDecl = makeStructDeclNative($owl_exporter2_native.class, OWL_EXPORTER2, OWL_EXPORTER2_P, $list63, $list64, new String[] { "$id", "$uri", "$file", "$graph", "$cyclist", "$export", "$ontology", "$terms", "$sentences", "$stats", "$options", "$thread" }, $list65, $list66,
		    PRINT_OWL_EXPORTER2);
	}
    }
