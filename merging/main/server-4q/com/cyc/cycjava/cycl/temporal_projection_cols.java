...
public final class temporal_projection_cols extends SubLTranslatedFile implements V10 {
    public static final SubLFile me = new temporal_projection_cols();

    public static final String myName = "com.cyc.cycjava_2.cycl.temporal_projection_cols";
    ...
    public static SubLObject declare_temporal_projection_cols_file() {
        declareFunction("collect_intervals_from_events", "COLLECT-INTERVALS-FROM-EVENTS", 3, 0, false);
        declareFunction("create_forward_intervals_from_events", "CREATE-FORWARD-INTERVALS-FROM-EVENTS", 3, 0, false);
        declareFunction("create_backward_intervals_from_events", "CREATE-BACKWARD-INTERVALS-FROM-EVENTS", 3, 0, false);
        declareFunction("possibly_retract_stale_deductions", "POSSIBLY-RETRACT-STALE-DEDUCTIONS", 2, 0, false);
        declareFunction("argument_is_better_thanP", "ARGUMENT-IS-BETTER-THAN?", 2, 0, false);
        declareFunction("argument_has_more_factsP", "ARGUMENT-HAS-MORE-FACTS?", 2, 0, false);
        declareFunction("support_subsumed_by_justificationP", "SUPPORT-SUBSUMED-BY-JUSTIFICATION?", 2, 0, false);
        declareFunction("distribution_related_supportP", "DISTRIBUTION-RELATED-SUPPORT?", 1, 0, false);
        declareFunction("collect_intervals_from_events_for_negated_sentence", "COLLECT-INTERVALS-FROM-EVENTS-FOR-NEGATED-SENTENCE", 3, 0, false);
        declareFunction("collect_intervals_from_both_starting_point_and_ending_point_assertions", "COLLECT-INTERVALS-FROM-BOTH-STARTING-POINT-AND-ENDING-POINT-ASSERTIONS", 5, 0, false);
        declareFunction("collect_intervals_from_both_starting_point_and_ending_point_assertions_negated", "COLLECT-INTERVALS-FROM-BOTH-STARTING-POINT-AND-ENDING-POINT-ASSERTIONS-NEGATED", 5, 0, false);
        declareFunction("backward_intervals_for_sentence", "BACKWARD-INTERVALS-FOR-SENTENCE", 3, 0, false);
        declareFunction("forward_intervals_for_sentence", "FORWARD-INTERVALS-FOR-SENTENCE", 3, 0, false);
        declareFunction("find_best_backward_distribution_for_sentence", "FIND-BEST-BACKWARD-DISTRIBUTION-FOR-SENTENCE", 1, 0, false);
        declareFunction("find_best_forward_distribution_for_sentence", "FIND-BEST-FORWARD-DISTRIBUTION-FOR-SENTENCE", 1, 0, false);
        declareFunction("find_type_level_distribution_for_sentence", "FIND-TYPE-LEVEL-DISTRIBUTION-FOR-SENTENCE", 1, 0, false);
        declareFunction("find_default_backward_distribution_for_sentence", "FIND-DEFAULT-BACKWARD-DISTRIBUTION-FOR-SENTENCE", 1, 0, false);
        declareFunction("find_default_forward_distribution_for_sentence", "FIND-DEFAULT-FORWARD-DISTRIBUTION-FOR-SENTENCE", 1, 0, false);
        declareFunction("find_default_distribution_for_sentence", "FIND-DEFAULT-DISTRIBUTION-FOR-SENTENCE", 1, 0, false);
        declareFunction("create_time_line_from_assertions", "CREATE-TIME-LINE-FROM-ASSERTIONS", 2, 0, false);
        declareFunction("list_time_comparator", "LIST-TIME-COMPARATOR", 2, 0, false);
        declareFunction("compute_likelihoods_from_event_calculus", "COMPUTE-LIKELIHOODS-FROM-EVENT-CALCULUS", 3, 0, false);
        declareFunction("find_likelihood_from_default_conditional_probability_for_sentence_backwards", "FIND-LIKELIHOOD-FROM-DEFAULT-CONDITIONAL-PROBABILITY-FOR-SENTENCE-BACKWARDS", 6, 0, false);
        declareFunction("find_likelihood_from_default_conditional_probability_for_sentence_forwards", "FIND-LIKELIHOOD-FROM-DEFAULT-CONDITIONAL-PROBABILITY-FOR-SENTENCE-FORWARDS", 6, 0, false);
        declareFunction("handle_temporal_interpolation_function_for_predicate", "HANDLE-TEMPORAL-INTERPOLATION-FUNCTION-FOR-PREDICATE", 2, 0, false);
        declareFunction("handle_duration_weighted_decay_distribution", "HANDLE-DURATION-WEIGHTED-DECAY-DISTRIBUTION", 2, 0, false);
        declareFunction("handle_decay_distribution_for_assertion_in_time_interval", "HANDLE-DECAY-DISTRIBUTION-FOR-ASSERTION-IN-TIME-INTERVAL", 2, 0, false);
        declareFunction("use_causal_analysis_to_find_likelihood", "USE-CAUSAL-ANALYSIS-TO-FIND-LIKELIHOOD", 2, 0, false);
        declareFunction("use_noisy_and_model_to_calculate_prob", "USE-NOISY-AND-MODEL-TO-CALCULATE-PROB", 2, 0, false);
        declareFunction("find_probabilities_due_to_unobserved_causes", "FIND-PROBABILITIES-DUE-TO-UNOBSERVED-CAUSES", 2, 0, false);
        declareFunction("check_presence_of_condition_in_observed_causes_ins_pos_1", "CHECK-PRESENCE-OF-CONDITION-IN-OBSERVED-CAUSES-INS-POS-1", 3, 0, false);
        declareFunction("use_noisy_or_model_to_calculate_prob", "USE-NOISY-OR-MODEL-TO-CALCULATE-PROB", 2, 0, false);
        declareFunction("use_causal_analysis_to_find_likelihood_2", "USE-CAUSAL-ANALYSIS-TO-FIND-LIKELIHOOD-2", 2, 0, false);
        declareFunction("compute_probability_for_list_of_causes", "COMPUTE-PROBABILITY-FOR-LIST-OF-CAUSES", 1, 0, false);
        declareFunction("compute_probability_for_subset", "COMPUTE-PROBABILITY-FOR-SUBSET", 2, 0, false);
        declareFunction("find_prior_and_probability_from_list", "FIND-PRIOR-AND-PROBABILITY-FROM-LIST", 2, 0, false);
        declareFunction("check_delay_between_start_of_event_types_in_sit_type", "CHECK-DELAY-BETWEEN-START-OF-EVENT-TYPES-IN-SIT-TYPE", 1, 0, false);
        declareFunction("handle_default_decay_function_for_predicate", "HANDLE-DEFAULT-DECAY-FUNCTION-FOR-PREDICATE", 2, 0, false);
        declareFunction("handle_default_decay_function_for_predicate_backwards", "HANDLE-DEFAULT-DECAY-FUNCTION-FOR-PREDICATE-BACKWARDS", 2, 0, false);
        declareFunction("handle_decay_distribution_for_specs", "HANDLE-DECAY-DISTRIBUTION-FOR-SPECS", 2, 0, false);
        declareFunction("handle_decay_distribution_for_specs_2", "HANDLE-DECAY-DISTRIBUTION-FOR-SPECS-2", 3, 0, false);
        declareFunction("get_assertions_for_fact", "GET-ASSERTIONS-FOR-FACT", 1, 0, false);
        declareFunction("handle_temporal_interpolation_function_for_collection", "HANDLE-TEMPORAL-INTERPOLATION-FUNCTION-FOR-COLLECTION", 2, 0, false);
        declareFunction("find_probability_of_end_of_event", "FIND-PROBABILITY-OF-END-OF-EVENT", 3, 0, false);
        declareFunction("find_probability_of_event_occurrence", "FIND-PROBABILITY-OF-EVENT-OCCURRENCE", 2, 0, false);
        declareFunction("use_risk_analysis", "USE-RISK-ANALYSIS", 2, 0, false);
        declareFunction("get_probability_of_event_occurrence", "GET-PROBABILITY-OF-EVENT-OCCURRENCE", 2, 0, false);
        declareFunction("calculate_probability_of_event_occurring_before_age", "CALCULATE-PROBABILITY-OF-EVENT-OCCURRING-BEFORE-AGE", 3, 0, false);
        declareFunction("get_probability_of_state_persisting_from_time", "GET-PROBABILITY-OF-STATE-PERSISTING-FROM-TIME", 4, 0, false);
        declareFunction("get_probability_of_event_not_occurring", "GET-PROBABILITY-OF-EVENT-NOT-OCCURRING", 3, 0, false);
        declareFunction("get_duration_from_intensity_function", "GET-DURATION-FROM-INTENSITY-FUNCTION", 1, 0, false);
        declareFunction("get_intensity_function_for_event_type", "GET-INTENSITY-FUNCTION-FOR-EVENT-TYPE", 2, 0, false);
        declareFunction("find_intensity_function_at_age", "FIND-INTENSITY-FUNCTION-AT-AGE", 2, 0, false);
        declareFunction("find_intensity_function_at_age_for_role", "FIND-INTENSITY-FUNCTION-AT-AGE-FOR-ROLE", 3, 0, false);
        declareFunction("get_intensity_function_for_event_2", "GET-INTENSITY-FUNCTION-FOR-EVENT-2", 2, 0, false);
        declareFunction("find_transition_probability", "FIND-TRANSITION-PROBABILITY", 3, 0, false);
        declareFunction("find_backward_transition_probabilities", "FIND-BACKWARD-TRANSITION-PROBABILITIES", 3, 0, false);
        declareFunction("find_backward_transition_probabilities_to_self", "FIND-BACKWARD-TRANSITION-PROBABILITIES-TO-SELF", 3, 0, false);
        declareFunction("find_prob_of_backward_transition", "FIND-PROB-OF-BACKWARD-TRANSITION", 6, 0, false);
        declareFunction("find_probability_for_state", "FIND-PROBABILITY-FOR-STATE", 4, 0, false);
        declareFunction("get_array_element", "GET-ARRAY-ELEMENT", 3, 0, false);
        declareFunction("get_assertions_for_transition_from_state_to_state", "GET-ASSERTIONS-FOR-TRANSITION-FROM-STATE-TO-STATE", 2, 0, false);
        declareFunction("find_probability_of_remaining_in_state_1", "FIND-PROBABILITY-OF-REMAINING-IN-STATE-1", 3, 0, false);
        declareFunction("find_probability_of_remaining_in_state_2", "FIND-PROBABILITY-OF-REMAINING-IN-STATE-2", 3, 0, false);
        declareFunction("find_forward_transition_probabilities", "FIND-FORWARD-TRANSITION-PROBABILITIES", 3, 0, false);
        declareFunction("check_cardinality_of_collection", "CHECK-CARDINALITY-OF-COLLECTION", 2, 0, false);
        declareFunction("check_number_of_instances", "CHECK-NUMBER-OF-INSTANCES", 3, 0, false);
        declareFunction("use_event_calculus_to_find_likelihood", "USE-EVENT-CALCULUS-TO-FIND-LIKELIHOOD", 2, 0, false);
        declareFunction("use_conditional_likelihood", "USE-CONDITIONAL-LIKELIHOOD", 2, 0, false);
        declareFunction("handle_delay_between_collections", "HANDLE-DELAY-BETWEEN-COLLECTIONS", 2, 0, false);
        declareFunction("handle_default_decay_distribution_for_collection_in_interval", "HANDLE-DEFAULT-DECAY-DISTRIBUTION-FOR-COLLECTION-IN-INTERVAL", 2, 0, false);
        declareFunction("handle_temporal_relation_between_collections", "HANDLE-TEMPORAL-RELATION-BETWEEN-COLLECTIONS", 2, 0, false);
        declareFunction("handle_decay_distribution_for_collection_in_interval_when_instance_in_spec", "HANDLE-DECAY-DISTRIBUTION-FOR-COLLECTION-IN-INTERVAL-WHEN-INSTANCE-IN-SPEC", 2, 0, false);
        declareFunction("handle_default_decay_distribution_for_collection", "HANDLE-DEFAULT-DECAY-DISTRIBUTION-FOR-COLLECTION", 1, 0, false);
        declareFunction("handle_default_decay_distribution_for_collection_backwards", "HANDLE-DEFAULT-DECAY-DISTRIBUTION-FOR-COLLECTION-BACKWARDS", 2, 0, false);
        declareFunction("handle_decay_distribution_for_collection_forward", "HANDLE-DECAY-DISTRIBUTION-FOR-COLLECTION-FORWARD", 3, 0, false);
        declareFunction("handle_decay_distribution_for_specs_collection", "HANDLE-DECAY-DISTRIBUTION-FOR-SPECS-COLLECTION", 2, 0, false);
        declareFunction("handle_decay_distribution_for_collection_in_interval_backwards", "HANDLE-DECAY-DISTRIBUTION-FOR-COLLECTION-IN-INTERVAL-BACKWARDS", 2, 0, false);
        declareFunction("handle_decay_distribution_for_assertion_in_interval", "HANDLE-DECAY-DISTRIBUTION-FOR-ASSERTION-IN-INTERVAL", 2, 0, false);
        declareFunction("handle_decay_distribution_for_assertion_in_interval_backwards", "HANDLE-DECAY-DISTRIBUTION-FOR-ASSERTION-IN-INTERVAL-BACKWARDS", 2, 0, false);
        declareFunction("check_time_subsumption", "CHECK-TIME-SUBSUMPTION", 4, 0, false);
        declareFunction("handle_decay_distribution_for_assertion_causal", "HANDLE-DECAY-DISTRIBUTION-FOR-ASSERTION-CAUSAL", 2, 0, false);
        declareFunction("handle_decay_distribution_for_collection_when_time_in_interval", "HANDLE-DECAY-DISTRIBUTION-FOR-COLLECTION-WHEN-TIME-IN-INTERVAL", 2, 0, false);
        declareFunction("check_temporal_relation", "CHECK-TEMPORAL-RELATION", 3, 0, false);
        declareFunction("get_persistence_likelihood_for_fact_at_time", "GET-PERSISTENCE-LIKELIHOOD-FOR-FACT-AT-TIME", 2, 4, false);
        declareFunction("get_persistence_of_isa_assertion", "GET-PERSISTENCE-OF-ISA-ASSERTION", 3, 0, false);
        declareFunction("get_persistence_of_non_isa_assertion", "GET-PERSISTENCE-OF-NON-ISA-ASSERTION", 3, 0, false);
        declareFunction("collect_evidence_from_rules", "COLLECT-EVIDENCE-FROM-RULES", 3, 0, false);
        declareFunction("find_decay_function_for_collection", "FIND-DECAY-FUNCTION-FOR-COLLECTION", 3, 0, false);
        declareFunction("find_decay_function_for_fact", "FIND-DECAY-FUNCTION-FOR-FACT", 3, 0, false);
        declareFunction("time_elapsed_falls_in_interval", "TIME-ELAPSED-FALLS-IN-INTERVAL", 2, 0, false);
        declareFunction("calculate_persistence_likelihood", "CALCULATE-PERSISTENCE-LIKELIHOOD", 2, 0, false);
        declareFunction("calculate_persistence_likelihood_from_non_narts", "CALCULATE-PERSISTENCE-LIKELIHOOD-FROM-NON-NARTS", 2, 0, false);
        declareFunction("calculate_persistence_for_exponential_decay_function", "CALCULATE-PERSISTENCE-FOR-EXPONENTIAL-DECAY-FUNCTION", 2, 0, false);
        declareFunction("calculate_persistence_for_exponential_decay_function_scaled", "CALCULATE-PERSISTENCE-FOR-EXPONENTIAL-DECAY-FUNCTION-SCALED", 2, 0, false);
        declareFunction("calculate_persistence_for_bounded_exponentially_increasing_function", "CALCULATE-PERSISTENCE-FOR-BOUNDED-EXPONENTIALLY-INCREASING-FUNCTION", 2, 0, false);
        declareFunction("calculate_persistence_for_bounded_exponentially_increasing_function_with_initial_value", "CALCULATE-PERSISTENCE-FOR-BOUNDED-EXPONENTIALLY-INCREASING-FUNCTION-WITH-INITIAL-VALUE", 2, 0, false);
        declareFunction("calculate_persistence_for_exponential_decay_distribution_with_initial_and_final_value_fn", "CALCULATE-PERSISTENCE-FOR-EXPONENTIAL-DECAY-DISTRIBUTION-WITH-INITIAL-AND-FINAL-VALUE-FN", 2, 0, false);
        declareFunction("calculate_persistence_for_exponential_decay_distribution_with_initial_value_fn", "CALCULATE-PERSISTENCE-FOR-EXPONENTIAL-DECAY-DISTRIBUTION-WITH-INITIAL-VALUE-FN", 2, 0, false);
        declareFunction("calculate_persistence_for_constant_function", "CALCULATE-PERSISTENCE-FOR-CONSTANT-FUNCTION", 1, 0, false);
        declareFunction("calculate_persistence_for_gaussian_decay_function2", "CALCULATE-PERSISTENCE-FOR-GAUSSIAN-DECAY-FUNCTION2", 2, 0, false);
        declareFunction("calculate_persistence_for_gaussian_decay_function", "CALCULATE-PERSISTENCE-FOR-GAUSSIAN-DECAY-FUNCTION", 2, 0, false);
        declareFunction("calculate_persistence_for_linear_decay_function", "CALCULATE-PERSISTENCE-FOR-LINEAR-DECAY-FUNCTION", 2, 0, false);
        declareFunction("calculate_persistence_for_linearly_increasing_function", "CALCULATE-PERSISTENCE-FOR-LINEARLY-INCREASING-FUNCTION", 2, 0, false);
        declareFunction("time_falls_in_interval", "TIME-FALLS-IN-INTERVAL", 3, 1, false);
        declareFunction("get_mt_time_for_assertion", "GET-MT-TIME-FOR-ASSERTION", 1, 0, false);
        declareFunction("get_time_from_ist_facts", "GET-TIME-FROM-IST-FACTS", 1, 0, false);
        declareFunction("get_farthest_time_for_assertion", "GET-FARTHEST-TIME-FOR-ASSERTION", 2, 0, false);
        declareFunction("get_closest_time_for_assertion", "GET-CLOSEST-TIME-FOR-ASSERTION", 2, 0, false);
        declareFunction("get_closest_time_for_assertion_before_given_time", "GET-CLOSEST-TIME-FOR-ASSERTION-BEFORE-GIVEN-TIME", 2, 0, false);
        declareFunction("get_earliest_time_for_fact", "GET-EARLIEST-TIME-FOR-FACT", 1, 0, false);
        declareFunction("handle_time_intervals_closest", "HANDLE-TIME-INTERVALS-CLOSEST", 2, 0, false);
        declareFunction("map_indexicals_in_date", "MAP-INDEXICALS-IN-DATE", 1, 0, false);
        declareFunction("check_fact_true_at_point", "CHECK-FACT-TRUE-AT-POINT", 2, 0, false);
        declareFunction("check_isa_fact_false_at_point", "CHECK-ISA-FACT-FALSE-AT-POINT", 2, 0, false);
        declareFunction("time_subsumes_anotherP", "TIME-SUBSUMES-ANOTHER?", 2, 0, false);
        declareFunction("get_assertion_for_given_fact_and_time", "GET-ASSERTION-FOR-GIVEN-FACT-AND-TIME", 2, 0, false);
        declareFunction("get_fact_closest_to_time_point", "GET-FACT-CLOSEST-TO-TIME-POINT", 2, 0, false);
        declareFunction("get_assertion_for_binary_predicates", "GET-ASSERTION-FOR-BINARY-PREDICATES", 1, 0, false);
        declareFunction("get_assertion_for_ternary_predicates", "GET-ASSERTION-FOR-TERNARY-PREDICATES", 4, 0, false);
        declareFunction("get_assertion_for_predicate_of_arity_five", "GET-ASSERTION-FOR-PREDICATE-OF-ARITY-FIVE", 6, 0, false);
        declareFunction("get_assertion_for_predicate_of_arity_four", "GET-ASSERTION-FOR-PREDICATE-OF-ARITY-FOUR", 5, 0, false);
        declareFunction("find_assertion_for_predicate_of_arity_6", "FIND-ASSERTION-FOR-PREDICATE-OF-ARITY-6", 7, 0, false);
        declareFunction("check_always_trueP", "CHECK-ALWAYS-TRUE?", 1, 0, false);
        declareFunction("check_temporal_relation_between_arguments", "CHECK-TEMPORAL-RELATION-BETWEEN-ARGUMENTS", 1, 0, false);
        declareFunction("check_starting_times", "CHECK-STARTING-TIMES", 2, 0, false);
        declareFunction("check_ending_times", "CHECK-ENDING-TIMES", 2, 0, false);
        declareFunction("get_arg_cons_for_pos", "GET-ARG-CONS-FOR-POS", 2, 0, false);
        declareFunction("get_starting_date_of_concept", "GET-STARTING-DATE-OF-CONCEPT", 1, 0, false);
        declareFunction("get_ending_date_of_concept", "GET-ENDING-DATE-OF-CONCEPT", 1, 0, false);
        declareFunction("find_time_elapsed", "FIND-TIME-ELAPSED", 2, 0, false);
        declareFunction("find_time_elapsed_for_indeterminate_terms", "FIND-TIME-ELAPSED-FOR-INDETERMINATE-TERMS", 2, 0, false);
        declareFunction("mt_later_thanP", "MT-LATER-THAN?", 2, 0, false);
        declareFunction("at_least_one_point_is_later_thanP", "AT-LEAST-ONE-POINT-IS-LATER-THAN?", 2, 0, false);
        declareFunction("at_least_one_point_is_before_thanP", "AT-LEAST-ONE-POINT-IS-BEFORE-THAN?", 2, 0, false);
        declareFunction("all_points_are_before_thanP", "ALL-POINTS-ARE-BEFORE-THAN?", 2, 0, false);
        declareFunction("all_points_are_after_thanP", "ALL-POINTS-ARE-AFTER-THAN?", 2, 0, false);
        declareFunction("get_last_time_point_of", "GET-LAST-TIME-POINT-OF", 1, 0, false);
        declareFunction("verify_temporal_relation", "VERIFY-TEMPORAL-RELATION", 3, 0, false);
        declareFunction("get_first_time_point_of", "GET-FIRST-TIME-POINT-OF", 1, 0, false);
        declareFunction("convert_to_unit", "CONVERT-TO-UNIT", 2, 0, false);
        declareFunction("error_fn", "ERROR-FN", 1, 0, false);
        declareFunction("find_list_of_starting_times", "FIND-LIST-OF-STARTING-TIMES", 1, 0, false);
        declareFunction("find_list_of_ending_times", "FIND-LIST-OF-ENDING-TIMES", 1, 0, false);
        declareFunction("find_closest_time_after", "FIND-CLOSEST-TIME-AFTER", 2, 0, false);
        declareFunction("find_closest_time_before", "FIND-CLOSEST-TIME-BEFORE", 2, 0, false);
        declareFunction("create_timeline_for_assertion", "CREATE-TIMELINE-FOR-ASSERTION", 1, 0, false);
        declareFunction("check_boundary_conditions", "CHECK-BOUNDARY-CONDITIONS", 3, 0, false);
        declareFunction("find_closest_time_around_time_point", "FIND-CLOSEST-TIME-AROUND-TIME-POINT", 2, 0, false);
        declareFunction("find_most_specific_assertion", "FIND-MOST-SPECIFIC-ASSERTION", 1, 0, false);
        declareFunction("find_persistence_by_combining_evidence", "FIND-PERSISTENCE-BY-COMBINING-EVIDENCE", 1, 0, false);
        declareFunction("combined_evidence_for_persistence", "COMBINED-EVIDENCE-FOR-PERSISTENCE", 1, 0, false);
        declareFunction("check_whether_fact_satisfies_constraints", "CHECK-WHETHER-FACT-SATISFIES-CONSTRAINTS", 2, 0, false);
        declareFunction("find_assertion_matching_conditions_in_conseq", "FIND-ASSERTION-MATCHING-CONDITIONS-IN-CONSEQ", 2, 0, false);
        declareFunction("find_constraints_for_variable_from_conditions", "FIND-CONSTRAINTS-FOR-VARIABLE-FROM-CONDITIONS", 2, 0, false);
        declareFunction("check_isa_constraint", "CHECK-ISA-CONSTRAINT", 2, 0, false);
        declareFunction("get_binding_for_variable", "GET-BINDING-FOR-VARIABLE", 2, 0, false);
        declareFunction("get_list_of_bindings_for_cons", "GET-LIST-OF-BINDINGS-FOR-CONS", 2, 0, false);
        declareFunction("convert_exponential_decay_distribution_with_initial_value_fn_to_lambda_form", "CONVERT-EXPONENTIAL-DECAY-DISTRIBUTION-WITH-INITIAL-VALUE-FN-TO-LAMBDA-FORM", 3, 0, false);
        declareFunction("get_date_for_earliest_collection_members", "GET-DATE-FOR-EARLIEST-COLLECTION-MEMBERS", 1, 0, false);
        declareFunction("recursive_temporal_projection_queryP", "RECURSIVE-TEMPORAL-PROJECTION-QUERY?", 2, 0, false);
        declareFunction("find_earliest_event", "FIND-EARLIEST-EVENT", 1, 0, false);
        declareFunction("get_prior_probability_for_pattern", "GET-PRIOR-PROBABILITY-FOR-PATTERN", 2, 0, false);
        declareFunction("test_constraints_for_arg_position", "TEST-CONSTRAINTS-FOR-ARG-POSITION", 5, 0, false);
        declareFunction("generate_powerset", "GENERATE-POWERSET", 1, 0, false);
        declareFunction("lambda_function_elt", "LAMBDA-FUNCTION-ELT", 1, 0, false);
        declareFunction("time_falls_in_temporal_interval", "TIME-FALLS-IN-TEMPORAL-INTERVAL", 2, 0, false);
        declareFunction("handle_distribution_for_termination_of_membership", "HANDLE-DISTRIBUTION-FOR-TERMINATION-OF-MEMBERSHIP", 2, 0, false);
        declareFunction("find_probability_of_belonging_to_collection", "FIND-PROBABILITY-OF-BELONGING-TO-COLLECTION", 4, 0, false);
        declareFunction("calculate_probability_using_life_tables", "CALCULATE-PROBABILITY-USING-LIFE-TABLES", 4, 0, false);
        declareFunction("calculate_probability_of_delay_between_events", "CALCULATE-PROBABILITY-OF-DELAY-BETWEEN-EVENTS", 4, 0, false);
        declareFunction("last_iterationP", "LAST-ITERATION?", 3, 0, false);
        declareFunction("find_relevant_distribution_at_age", "FIND-RELEVANT-DISTRIBUTION-AT-AGE", 2, 0, false);
        declareFunction("find_relevant_distribution_for_delay_between_events", "FIND-RELEVANT-DISTRIBUTION-FOR-DELAY-BETWEEN-EVENTS", 2, 0, false);
        declareFunction("find_relevant_distribution_for_transition", "FIND-RELEVANT-DISTRIBUTION-FOR-TRANSITION", 2, 0, false);
        declareFunction("check_duration_of_event_type", "CHECK-DURATION-OF-EVENT-TYPE", 1, 0, false);
        declareFunction("calculate_probability_of_end_of_event", "CALCULATE-PROBABILITY-OF-END-OF-EVENT", 4, 0, false);
        declareFunction("calculate_probability_of_transition_to_state", "CALCULATE-PROBABILITY-OF-TRANSITION-TO-STATE", 4, 0, false);
        declareFunction("calculate_probability_of_remaining_in_state", "CALCULATE-PROBABILITY-OF-REMAINING-IN-STATE", 4, 0, false);
        declareFunction("get_already_computed_answers", "GET-ALREADY-COMPUTED-ANSWERS", 2, 0, false);
        declareFunction("get_duration_of_time_interval", "GET-DURATION-OF-TIME-INTERVAL", 1, 0, false);
        declareFunction("scale_distribution", "SCALE-DISTRIBUTION", 3, 0, false);
        declareFunction("get_list_of_times_for_assertion", "GET-LIST-OF-TIMES-FOR-ASSERTION", 1, 0, false);
        return NIL;
    }
