...
public final class alexandria_iterators extends SubLTranslatedFile implements V10 {
    ...
    public static SubLObject declare_alexandria_iterators_file() {
        declareFunction("new_alexandria_iterator", "NEW-ALEXANDRIA-ITERATOR", 2, 0, false);
        declareFunction("alexandria_kb_store_iterator_done", "ALEXANDRIA-KB-STORE-ITERATOR-DONE", 1, 0, false);
        declareFunction("alexandria_kb_store_iterator_next", "ALEXANDRIA-KB-STORE-ITERATOR-NEXT", 1, 0, false);
        declareFunction("alexandria_kb_store_iterator_finalize", "ALEXANDRIA-KB-STORE-ITERATOR-FINALIZE", 1, 0, false);
        declareFunction("count_alexandria_gafs_matching_formula", "COUNT-ALEXANDRIA-GAFS-MATCHING-FORMULA", 1, 4, false);
        declareFunction("count_alexandria_gafs_matching_formula_relevant_mt_and_pred", "COUNT-ALEXANDRIA-GAFS-MATCHING-FORMULA-RELEVANT-MT-AND-PRED", 1, 3, false);
        declareFunction("create_alexandria_gafs_matching_formula_iterator_state", "CREATE-ALEXANDRIA-GAFS-MATCHING-FORMULA-ITERATOR-STATE", 1, 4, false);
        declareFunction("new_alexandria_gafs_matching_formula_iterator", "NEW-ALEXANDRIA-GAFS-MATCHING-FORMULA-ITERATOR", 1, 4, false);
        declareFunction("create_alexandria_gafs_matching_formula_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-GAFS-MATCHING-FORMULA-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 1, 3, false);
        declareFunction("new_alexandria_gafs_matching_formula_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-GAFS-MATCHING-FORMULA-RELEVANT-MT-AND-PRED-ITERATOR", 1, 3, false);
        declareFunction("create_alexandria_nats_matching_formula_iterator", "CREATE-ALEXANDRIA-NATS-MATCHING-FORMULA-ITERATOR", 2, 0, false);
        declareFunction("new_alexandria_nats_matching_formula_iterator", "NEW-ALEXANDRIA-NATS-MATCHING-FORMULA-ITERATOR", 2, 0, false);
        declareFunction("count_alexandria_nats_matching_formula", "COUNT-ALEXANDRIA-NATS-MATCHING-FORMULA", 2, 0, false);
        declareFunction("count_alexandria_reifiable_function_extent", "COUNT-ALEXANDRIA-REIFIABLE-FUNCTION-EXTENT", 1, 0, false);
        declareFunction("create_alexandria_reifiable_function_extent_iterator_state", "CREATE-ALEXANDRIA-REIFIABLE-FUNCTION-EXTENT-ITERATOR-STATE", 1, 0, false);
        declareFunction("new_alexandria_reifiable_function_extent_iterator", "NEW-ALEXANDRIA-REIFIABLE-FUNCTION-EXTENT-ITERATOR", 1, 0, false);
        declareFunction("create_alexandria_all_forts_iterator_state", "CREATE-ALEXANDRIA-ALL-FORTS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_forts_iterator", "NEW-ALEXANDRIA-ALL-FORTS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_gafs_iterator_state", "CREATE-ALEXANDRIA-ALL-GAFS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_gafs_iterator", "NEW-ALEXANDRIA-ALL-GAFS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_rules_iterator_state", "CREATE-ALEXANDRIA-ALL-RULES-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_rules_iterator", "NEW-ALEXANDRIA-ALL-RULES-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_unbound_rules_iterator_state", "CREATE-ALEXANDRIA-ALL-UNBOUND-RULES-ITERATOR-STATE", 0, 2, false);
        declareFunction("new_alexandria_all_unbound_rules_iterator", "NEW-ALEXANDRIA-ALL-UNBOUND-RULES-ITERATOR", 0, 2, false);
        declareFunction("create_alexandria_all_unbound_rules_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-ALL-UNBOUND-RULES-RELEVANT-MT-ITERATOR-STATE", 0, 2, false);
        declareFunction("new_alexandria_all_unbound_rules_relevant_mt_iterator", "NEW-ALEXANDRIA-ALL-UNBOUND-RULES-RELEVANT-MT-ITERATOR", 0, 2, false);
        declareFunction("create_alexandria_all_assertions_iterator_state", "CREATE-ALEXANDRIA-ALL-ASSERTIONS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_assertions_iterator", "NEW-ALEXANDRIA-ALL-ASSERTIONS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_big_integers_iterator_state", "CREATE-ALEXANDRIA-ALL-BIG-INTEGERS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_big_integers_iterator", "NEW-ALEXANDRIA-ALL-BIG-INTEGERS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_integers_iterator_state", "CREATE-ALEXANDRIA-ALL-INTEGERS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_integers_iterator", "NEW-ALEXANDRIA-ALL-INTEGERS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_bookkeeping_gafs_iterator_state", "CREATE-ALEXANDRIA-ALL-BOOKKEEPING-GAFS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_bookkeeping_gafs_iterator", "NEW-ALEXANDRIA-ALL-BOOKKEEPING-GAFS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_constants_iterator_state", "CREATE-ALEXANDRIA-ALL-CONSTANTS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_constants_iterator", "NEW-ALEXANDRIA-ALL-CONSTANTS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_narts_iterator_state", "CREATE-ALEXANDRIA-ALL-NARTS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_narts_iterator", "NEW-ALEXANDRIA-ALL-NARTS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_deductions_iterator_state", "CREATE-ALEXANDRIA-ALL-DEDUCTIONS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_deductions_iterator", "NEW-ALEXANDRIA-ALL-DEDUCTIONS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_floats_iterator_state", "CREATE-ALEXANDRIA-ALL-FLOATS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_floats_iterator", "NEW-ALEXANDRIA-ALL-FLOATS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_formulas_iterator_state", "CREATE-ALEXANDRIA-ALL-FORMULAS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_formulas_iterator", "NEW-ALEXANDRIA-ALL-FORMULAS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_hl_supports_iterator_state", "CREATE-ALEXANDRIA-ALL-HL-SUPPORTS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_hl_supports_iterator", "NEW-ALEXANDRIA-ALL-HL-SUPPORTS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_kb_hl_supports_iterator_state", "CREATE-ALEXANDRIA-ALL-KB-HL-SUPPORTS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_kb_hl_supports_iterator", "NEW-ALEXANDRIA-ALL-KB-HL-SUPPORTS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_items_iterator_state", "CREATE-ALEXANDRIA-ALL-ITEMS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_items_iterator", "NEW-ALEXANDRIA-ALL-ITEMS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_strings_iterator_state", "CREATE-ALEXANDRIA-ALL-STRINGS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_strings_iterator", "NEW-ALEXANDRIA-ALL-STRINGS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_numbers_iterator_state", "CREATE-ALEXANDRIA-ALL-NUMBERS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_numbers_iterator", "NEW-ALEXANDRIA-ALL-NUMBERS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_subl_expressions_iterator_state", "CREATE-ALEXANDRIA-ALL-SUBL-EXPRESSIONS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_subl_expressions_iterator", "NEW-ALEXANDRIA-ALL-SUBL-EXPRESSIONS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_variables_iterator_state", "CREATE-ALEXANDRIA-ALL-VARIABLES-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_variables_iterator", "NEW-ALEXANDRIA-ALL-VARIABLES-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_all_unrepresented_terms_iterator_state", "CREATE-ALEXANDRIA-ALL-UNREPRESENTED-TERMS-ITERATOR-STATE", 0, 0, false);
        declareFunction("new_alexandria_all_unrepresented_terms_iterator", "NEW-ALEXANDRIA-ALL-UNREPRESENTED-TERMS-ITERATOR", 0, 0, false);
        declareFunction("create_alexandria_term_assertions_relevant_mt_pred_iterator_state", "CREATE-ALEXANDRIA-TERM-ASSERTIONS-RELEVANT-MT-PRED-ITERATOR-STATE", 1, 4, false);
        declareFunction("new_alexandria_term_assertions_relevant_mt_pred_iterator", "NEW-ALEXANDRIA-TERM-ASSERTIONS-RELEVANT-MT-PRED-ITERATOR", 1, 4, false);
        declareFunction("count_alexandria_term_assertions_relevant_mt_pred", "COUNT-ALEXANDRIA-TERM-ASSERTIONS-RELEVANT-MT-PRED", 1, 4, false);
        declareFunction("create_alexandria_term_assertions_iterator_state", "CREATE-ALEXANDRIA-TERM-ASSERTIONS-ITERATOR-STATE", 1, 4, false);
        declareFunction("new_alexandria_term_assertions_iterator", "NEW-ALEXANDRIA-TERM-ASSERTIONS-ITERATOR", 1, 4, false);
        declareFunction("count_alexandria_term_assertions", "COUNT-ALEXANDRIA-TERM-ASSERTIONS", 1, 4, false);
        declareFunction("create_alexandria_gaf_arg0_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG0-ITERATOR-STATE", 1, 3, false);
        declareFunction("new_alexandria_gaf_arg0_iterator", "NEW-ALEXANDRIA-GAF-ARG0-ITERATOR", 1, 3, false);
        declareFunction("count_alexandria_gaf_arg0", "COUNT-ALEXANDRIA-GAF-ARG0", 1, 3, false);
        declareFunction("create_alexandria_gaf_arg0_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG0-RELEVANT-MT-ITERATOR-STATE", 1, 2, false);
        declareFunction("new_alexandria_gaf_arg0_iterator_relevant_mt", "NEW-ALEXANDRIA-GAF-ARG0-ITERATOR-RELEVANT-MT", 1, 2, false);
        declareFunction("count_alexandria_gaf_arg0_relevant_mt", "COUNT-ALEXANDRIA-GAF-ARG0-RELEVANT-MT", 1, 3, false);
        declareFunction("create_alexandria_gaf_arg_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-ITERATOR-STATE", 1, 4, false);
        declareFunction("new_alexandria_gaf_arg_iterator", "NEW-ALEXANDRIA-GAF-ARG-ITERATOR", 1, 4, false);
        declareFunction("create_alexandria_gaf_arg_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 1, 4, false);
        declareFunction("new_alexandria_gaf_arg_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-GAF-ARG-RELEVANT-MT-AND-PRED-ITERATOR", 1, 4, false);
        declareFunction("create_alexandria_gaf_arg_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-RELEVANT-MT-ITERATOR-STATE", 1, 4, false);
        declareFunction("new_alexandria_gaf_arg_relevant_mt_iterator", "NEW-ALEXANDRIA-GAF-ARG-RELEVANT-MT-ITERATOR", 1, 4, false);
        declareFunction("create_alexandria_gaf_arg_formula_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-FORMULA-ITERATOR-STATE", 1, 4, false);
        declareFunction("new_alexandria_gaf_arg_formula_iterator", "NEW-ALEXANDRIA-GAF-ARG-FORMULA-ITERATOR", 1, 4, false);
        declareFunction("create_alexandria_gaf_arg_formula_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-FORMULA-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 1, 4, false);
        declareFunction("new_alexandria_gaf_arg_formula_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-GAF-ARG-FORMULA-RELEVANT-MT-AND-PRED-ITERATOR", 1, 4, false);
        declareFunction("create_alexandria_gaf_arg_formula_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-FORMULA-RELEVANT-MT-ITERATOR-STATE", 1, 4, false);
        declareFunction("new_alexandria_gaf_arg_formula_relevant_mt_iterator", "NEW-ALEXANDRIA-GAF-ARG-FORMULA-RELEVANT-MT-ITERATOR", 1, 4, false);
        declareFunction("create_alexandria_gaf_arg_values_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-VALUES-ITERATOR-STATE", 2, 4, false);
        declareFunction("new_alexandria_gaf_arg_values_iterator", "NEW-ALEXANDRIA-GAF-ARG-VALUES-ITERATOR", 2, 4, false);
        declareFunction("create_alexandria_gaf_arg_values_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-VALUES-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 2, 4, false);
        declareFunction("new_alexandria_gaf_arg_values_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-GAF-ARG-VALUES-RELEVANT-MT-AND-PRED-ITERATOR", 2, 4, false);
        declareFunction("create_alexandria_gaf_arg_values_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-VALUES-RELEVANT-MT-ITERATOR-STATE", 2, 4, false);
        declareFunction("new_alexandria_gaf_arg_values_relevant_mt_iterator", "NEW-ALEXANDRIA-GAF-ARG-VALUES-RELEVANT-MT-ITERATOR", 2, 4, false);
        declareFunction("count_alexandria_gaf_arg_relevant_mt_and_pred", "COUNT-ALEXANDRIA-GAF-ARG-RELEVANT-MT-AND-PRED", 1, 4, false);
        declareFunction("count_alexandria_gaf_arg", "COUNT-ALEXANDRIA-GAF-ARG", 1, 5, false);
        declareFunction("new_alexandria_gaf_arg_arg_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-GAF-ARG-ARG-RELEVANT-MT-AND-PRED-ITERATOR", 2, 5, false);
        declareFunction("create_alexandria_gaf_arg_arg_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-ARG-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 2, 5, false);
        declareFunction("count_alexandria_gaf_arg_arg_relevant_mt_and_pred", "COUNT-ALEXANDRIA-GAF-ARG-ARG-RELEVANT-MT-AND-PRED", 2, 5, false);
        declareFunction("create_alexandria_mt_contents_iterator_state_relevant_pred", "CREATE-ALEXANDRIA-MT-CONTENTS-ITERATOR-STATE-RELEVANT-PRED", 1, 3, false);
        declareFunction("new_alexandria_mt_contents_iterator_relevant_pred", "NEW-ALEXANDRIA-MT-CONTENTS-ITERATOR-RELEVANT-PRED", 1, 3, false);
        declareFunction("count_alexandria_mt_contents_relevant_pred", "COUNT-ALEXANDRIA-MT-CONTENTS-RELEVANT-PRED", 1, 3, false);
        declareFunction("create_alexandria_mt_contents_iterator_state", "CREATE-ALEXANDRIA-MT-CONTENTS-ITERATOR-STATE", 1, 3, false);
        declareFunction("new_alexandria_mt_contents_iterator", "NEW-ALEXANDRIA-MT-CONTENTS-ITERATOR", 1, 3, false);
        declareFunction("count_alexandria_mt_contents", "COUNT-ALEXANDRIA-MT-CONTENTS", 1, 3, false);
        declareFunction("create_alexandria_other_index_iterator_state", "CREATE-ALEXANDRIA-OTHER-INDEX-ITERATOR-STATE", 1, 3, false);
        declareFunction("new_alexandria_other_index_iterator", "NEW-ALEXANDRIA-OTHER-INDEX-ITERATOR", 1, 3, false);
        declareFunction("create_alexandria_other_index_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-OTHER-INDEX-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 1, 3, false);
        declareFunction("new_alexandria_other_index_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-OTHER-INDEX-RELEVANT-MT-AND-PRED-ITERATOR", 1, 3, false);
        declareFunction("create_alexandria_other_index_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-OTHER-INDEX-RELEVANT-MT-ITERATOR-STATE", 1, 3, false);
        declareFunction("new_alexandria_other_index_relevant_mt_iterator", "NEW-ALEXANDRIA-OTHER-INDEX-RELEVANT-MT-ITERATOR", 1, 3, false);
        declareFunction("create_alexandria_rules_with_pred_iterator_state", "CREATE-ALEXANDRIA-RULES-WITH-PRED-ITERATOR-STATE", 1, 2, false);
        declareFunction("new_alexandria_rules_with_pred_iterator", "NEW-ALEXANDRIA-RULES-WITH-PRED-ITERATOR", 1, 2, false);
        declareFunction("count_alexandria_rules_with_pred", "COUNT-ALEXANDRIA-RULES-WITH-PRED", 1, 3, false);
        declareFunction("create_alexandria_rules_with_pred_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-RULES-WITH-PRED-RELEVANT-MT-ITERATOR-STATE", 1, 2, false);
        declareFunction("new_alexandria_rules_with_pred_relevant_mt_iterator", "NEW-ALEXANDRIA-RULES-WITH-PRED-RELEVANT-MT-ITERATOR", 1, 2, false);
        declareFunction("count_alexandria_rules_with_pred_relevant_mt", "COUNT-ALEXANDRIA-RULES-WITH-PRED-RELEVANT-MT", 1, 2, false);
        declareFunction("create_alexandria_rules_with_pred_and_arg2_iterator_state", "CREATE-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-ITERATOR-STATE", 2, 2, false);
        declareFunction("new_alexandria_rules_with_pred_and_arg2_iterator", "NEW-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-ITERATOR", 2, 2, false);
        declareFunction("count_alexandria_rules_with_pred_and_arg2", "COUNT-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2", 2, 3, false);
        declareFunction("create_alexandria_rules_with_pred_and_arg2_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-RELEVANT-MT-ITERATOR-STATE", 2, 2, false);
        declareFunction("new_alexandria_rules_with_pred_and_arg2_relevant_mt_iterator", "NEW-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-RELEVANT-MT-ITERATOR", 2, 2, false);
        declareFunction("count_alexandria_rules_with_pred_and_arg2_relevant_mt", "COUNT-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-RELEVANT-MT", 2, 2, false);
        declareFunction("create_alexandria_nested_formula_rules_iterator_state", "CREATE-ALEXANDRIA-NESTED-FORMULA-RULES-ITERATOR-STATE", 2, 2, false);
        declareFunction("new_alexandria_nested_formula_rules_iterator", "NEW-ALEXANDRIA-NESTED-FORMULA-RULES-ITERATOR", 2, 2, false);
        declareFunction("count_alexandria_nested_formula_rules", "COUNT-ALEXANDRIA-NESTED-FORMULA-RULES", 2, 3, false);
        declareFunction("create_alexandria_nested_formula_rules_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-NESTED-FORMULA-RULES-RELEVANT-MT-ITERATOR-STATE", 2, 2, false);
        declareFunction("new_alexandria_nested_formula_rules_relevant_mt_iterator", "NEW-ALEXANDRIA-NESTED-FORMULA-RULES-RELEVANT-MT-ITERATOR", 2, 2, false);
        declareFunction("count_alexandria_nested_formula_rules_relevant_mt", "COUNT-ALEXANDRIA-NESTED-FORMULA-RULES-RELEVANT-MT", 2, 2, false);
        declareFunction("create_alexandria_function_extent_iterator_state", "CREATE-ALEXANDRIA-FUNCTION-EXTENT-ITERATOR-STATE", 1, 2, false);
        declareFunction("new_alexandria_function_extent_iterator", "NEW-ALEXANDRIA-FUNCTION-EXTENT-ITERATOR", 1, 2, false);
        declareFunction("count_alexandria_nart_arg_index", "COUNT-ALEXANDRIA-NART-ARG-INDEX", 1, 2, false);
        declareFunction("create_alexandria_nart_arg_index_iterator_state", "CREATE-ALEXANDRIA-NART-ARG-INDEX-ITERATOR-STATE", 1, 2, false);
        declareFunction("new_alexandria_nart_arg_index_iterator", "NEW-ALEXANDRIA-NART-ARG-INDEX-ITERATOR", 1, 2, false);
        declareFunction("create_alexandria_rules_with_cnf_iterator_state", "CREATE-ALEXANDRIA-RULES-WITH-CNF-ITERATOR-STATE", 1, 0, false);
        declareFunction("new_alexandria_rules_with_cnf_iterator", "NEW-ALEXANDRIA-RULES-WITH-CNF-ITERATOR", 1, 0, false);
        declareFunction("does_constant_exist_with_name_or_guid", "DOES-CONSTANT-EXIST-WITH-NAME-OR-GUID", 2, 1, false);
        declareFunction("clear_alexandria_caches", "CLEAR-ALEXANDRIA-CACHES", 0, 0, false);
        declareFunction("term_assertion_usage_count_estimate", "TERM-ASSERTION-USAGE-COUNT-ESTIMATE", 1, 0, false);
        declareFunction("estimated_cost_for_indexing_on_term", "ESTIMATED-COST-FOR-INDEXING-ON-TERM", 1, 0, false);
        declareFunction("create_alexandria_assertion_asserted_by_iterator_state", "CREATE-ALEXANDRIA-ASSERTION-ASSERTED-BY-ITERATOR-STATE", 1, 1, false);
        declareFunction("new_alexandria_assertion_asserted_by_iterator", "NEW-ALEXANDRIA-ASSERTION-ASSERTED-BY-ITERATOR", 1, 1, false);
        declareFunction("count_alexandria_rules_assertion_asserted_by", "COUNT-ALEXANDRIA-RULES-ASSERTION-ASSERTED-BY", 1, 0, false);
        declareFunction("create_alexandria_assertion_asserted_why_iterator_state", "CREATE-ALEXANDRIA-ASSERTION-ASSERTED-WHY-ITERATOR-STATE", 1, 1, false);
        declareFunction("new_alexandria_assertion_asserted_why_iterator", "NEW-ALEXANDRIA-ASSERTION-ASSERTED-WHY-ITERATOR", 1, 1, false);
        declareFunction("count_alexandria_rules_assertion_asserted_why", "COUNT-ALEXANDRIA-RULES-ASSERTION-ASSERTED-WHY", 1, 0, false);
        declareFunction("create_alexandria_assertion_asserted_on_iterator_state", "CREATE-ALEXANDRIA-ASSERTION-ASSERTED-ON-ITERATOR-STATE", 1, 1, false);
        declareFunction("new_alexandria_assertion_asserted_on_iterator", "NEW-ALEXANDRIA-ASSERTION-ASSERTED-ON-ITERATOR", 1, 1, false);
        declareFunction("count_alexandria_rules_assertion_asserted_on", "COUNT-ALEXANDRIA-RULES-ASSERTION-ASSERTED-ON", 1, 1, false);
        declareFunction("all_genl_mts_alexandria", "ALL-GENL-MTS-ALEXANDRIA", 3, 0, false);
        declareFunction("all_spec_mts_alexandria", "ALL-SPEC-MTS-ALEXANDRIA", 3, 0, false);
        declareFunction("create_alexandria_defns_cache_iterator_state", "CREATE-ALEXANDRIA-DEFNS-CACHE-ITERATOR-STATE", 1, 0, false);
        declareFunction("new_alexandria_defns_cache_iterator", "NEW-ALEXANDRIA-DEFNS-CACHE-ITERATOR", 1, 0, false);
        return NIL;
    }
