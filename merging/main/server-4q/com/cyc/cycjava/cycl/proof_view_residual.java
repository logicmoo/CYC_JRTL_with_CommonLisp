...
public final class proof_view_residual extends SubLTranslatedFile implements V10 {
    ...
    // defparameter
    private static final SubLSymbol $residual_proof_view_recursion_depth$ = makeSymbol("*RESIDUAL-PROOF-VIEW-RECURSION-DEPTH*");

    // defparameter
    public static final SubLSymbol $residual_proof_view_check_fitP$ = makeSymbol("*RESIDUAL-PROOF-VIEW-CHECK-FIT?*");

    private static final SubLString $str0$__Residual_recursion_depth___D__ = makeString("~&Residual recursion depth: ~D~%");

    private static final SubLString $str1$__Adding_residual_transformation_ = makeString("~&Adding residual transformation entry for~% ~S~% under ~S~%");
    ...
    private static final SubLSymbol PROOF_VIEW_ADD_ENTRIES_FOR_RESIDUAL_TRANSFORMATION_PROOF = makeSymbol("PROOF-VIEW-ADD-ENTRIES-FOR-RESIDUAL-TRANSFORMATION-PROOF");





    private static final SubLString $str9$__Adding_entry_for_subproof____S_ = makeString("~&Adding entry for subproof~% ~S~% under ~S");

    private static final SubLString $str10$__Attaching_residual_subproof__S_ = makeString("~&Attaching residual subproof ~S~% under ~S~%");

    private static final SubLSymbol $sym11$_EXIT = makeSymbol("%EXIT");

    private static final SubLString $str12$__Suppressing_proof_conclusion___ = makeString("~&Suppressing proof-conclusion~% ~S~%");

    private static final SubLSymbol $RESIDUAL_PROOF_ATTACHMENT_POINTS = makeKeyword("RESIDUAL-PROOF-ATTACHMENT-POINTS");

    private static final SubLString $str14$__Reconsidering_placement_of__S__ = makeString("~&Reconsidering placement of ~S~%");

    private static final SubLString $str15$__Found_lower_residual_transforma = makeString("~&Found lower residual transformation entry ~S~%");

    private static final SubLString $str16$__Push_down____S___under__S___int = makeString("~&Push down?? ~S~% under ~S~% into ~S~%");

    private static final SubLString $str17$__Reconsidered_point___S__ = makeString("~&Reconsidered point: ~S~%");

    private static final SubLString $str18$__Picking_attachment_point_for__S = makeString("~&Picking attachment point for ~S~% under ~S~%");

    private static final SubLString $str19$__Non_conjunction_parent_non_foca = makeString("~&Non-conjunction parent non-focal conclusion:~% ~S~%");

    private static final SubLString $str20$__Couldn_t_find__S___in__S__ = makeString("~&Couldn't find ~S~% in ~S~%");

    private static final SubLString $str21$__Placing__S___under__S__ = makeString("~&Placing ~S~% under ~S~%");

    private static final SubLString $str22$__Highest_good_fit___S__ = makeString("~&Highest good fit: ~S~%");

    private static final SubLString $str23$__Moving__S___up_under__S__ = makeString("~&Moving ~S~% up under ~S~%");

    private static final SubLString $str24$__Assuming__S___fits_under__S__ = makeString("~&Assuming ~S~% fits under ~S~%");

    private static final SubLString $str25$__Bad_fit___S___not_in__S__ = makeString("~&Bad fit: ~S~% not in ~S~%");

    private static final SubLString $str26$__Good_fit___S___in__S__ = makeString("~&Good fit: ~S~% in ~S~%");

    private static final SubLString $str27$__Found_proof__S___of__S__ = makeString("~&Found proof ~S~% of ~S~%");

    private static final SubLString $str28$Found_double_duty_residiual_trans = makeString("Found double-duty residiual transformation proof:~% ~S");

    private static final SubLString $str29$Found_double_duty_conjunctive_rem = makeString("Found double-duty conjunctive removal proof:~% ~S");

    private static final SubLString $str30$Couldn_t_find_subproof_of____S___ = makeString("Couldn't find subproof of~% ~S~% for ~S");
    ...
    public static SubLObject proof_view_add_entries_for_residual_transformation_proof(final SubLObject v_proof_view, final SubLObject residual_transformation_proof, final SubLObject parent_proof_view_entry, final SubLObject mt, final SubLObject inference_answer, final SubLObject proof_index_string, final SubLObject pph_relevance_safe_list) {
        ...
        try {
            ...
            if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
                format_nil.force_format(T, $str0$__Residual_recursion_depth___D__, $residual_proof_view_recursion_depth$.getDynamicValue(thread), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
            }
            if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
            ...
            final SubLObject object_type = EL_SENTENCE_P;
            ...
            try {
                ...
                if (NIL != pph_proof.pph_irrelevant_formulaP(proof_conclusion, pph_relevance_safe_list, pph_proof.pph_irrelevance_check_mt())) {
                    ...
                    if (NIL != pph_proof.pph_trivial_sentenceP(proof_conclusion, pph_proof.pph_triviality_check_mt())) {
                        proof_view.proof_view_note_filtered_item(v_proof_view, proof_conclusion, $TRIVIAL);
                    } else
                        if (NIL == proof_view.proof_view_has_entry_for_objectP(v_proof_view, proof_conclusion, parent_proof_view_entry)) {
                            if (NIL == proof_view_suppress_proof_conclusionP(v_proof_view, residual_transformation_proof, proof_conclusion)) {
                                quasi_transformation_entry = proof_view_populator.proof_view_add_new_entry(v_proof_view, label, parent_proof_view_entry, object_type, proof_conclusion, list($FN, PROOF_VIEW_ADD_ENTRIES_FOR_RESIDUAL_TRANSFORMATION_PROOF, $PROOF, residual_transformation_proof));
                                if (NIL != pph_proof.pph_irrelevant_supportP(rule, NIL, UNPROVIDED)) {
                                    proof_view.proof_view_note_filtered_item(v_proof_view, rule, $IRRELEVANT);
                                } else {
                                ...
                                final SubLObject v_forts = list_utilities.tree_gather(asents_to_support, FORT_P, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                ...
                                while (NIL != cdolist_list_var) {
                                    if (NIL != proof_view_conjunctive_removal_proof_p(subproof, mt)) {
                                        ...
                                        while (NIL != cdolist_list_var_$2) {
                                            if (NIL != subl_promotions.memberP(arguments.support_sentence(support), asents_to_support, symbol_function(EQUAL), UNPROVIDED)) {
    ...
    public static SubLObject proof_view_suppress_proof_conclusionP(final SubLObject v_proof_view, final SubLObject proof, final SubLObject proof_conclusion) {
        ...
        while (NIL != cdolist_list_var) {
            ...
            if (NIL != subl_promotions.memberP(conclusion_sentence, lits_to_suppress, symbol_function(EQUAL), UNPROVIDED)) {
                if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
    ...
    public static SubLObject proof_view_add_relocated_proof(final SubLObject relocated_proof) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        if (NIL == member(relocated_proof, $proof_view_relocated_proofs$.getDynamicValue(thread), symbol_function(EQL), symbol_function(IDENTITY))) {
            $proof_view_relocated_proofs$.setDynamicValue(cons(relocated_proof, $proof_view_relocated_proofs$.getDynamicValue(thread)), thread);
        }
    ...
    public static SubLObject pick_residual_proof_subproof_attachment_point(final SubLObject subproof, final SubLObject parent_proof_view_entry, final SubLObject mt) {
        ...
        SubLObject done = proof_view.proof_view_get_property(v_proof_view, $RESIDUAL_PROOF_ATTACHMENT_POINTS, UNPROVIDED);
        if (NIL == done) {
            done = dictionary.new_dictionary(symbol_function(EQUAL), UNPROVIDED);
            proof_view.proof_view_set_property(v_proof_view, $RESIDUAL_PROOF_ATTACHMENT_POINTS, done);
        }
        final SubLObject key = list(subproof, parent_proof_view_entry);
    ...
    public static SubLObject maybe_reconsider_parent_proof_view_entry(SubLObject parent_proof_view_entry, final SubLObject proof) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        final SubLObject v_proof_view = proof_view.proof_view_entry_get_proof_view(parent_proof_view_entry);
        if (((NIL != parent_proof_view_entry) && (NIL != proof_view_populator.proof_view_get_justification_root_entry(v_proof_view))) && (NIL != proof_view.proof_view_entry_has_ancestorP(parent_proof_view_entry, proof_view_populator.proof_view_get_justification_root_entry(v_proof_view), T))) {
    ...
    public static SubLObject proof_view_child_with_residual_transformation_dependent_proof(final SubLObject proof, final SubLObject parent_proof_view_entry) {
        ...
        while (NIL != cdolist_list_var) {
            ...
            if ((NIL != inference_worker_residual_transformation.residual_transformation_proof_p(child_proof)) && (NIL != member(proof, inference_datastructures_proof.all_proof_subproofs(child_proof), UNPROVIDED, UNPROVIDED))) {
                return child;
            }
            cdolist_list_var = cdolist_list_var.rest();
            child = cdolist_list_var.first();
    ...
    public static SubLObject pick_residual_proof_subproof_attachment_point_internal(final SubLObject subproof, final SubLObject parent_proof_view_entry, final SubLObject mt) {
        ...
        if (NIL != inference_worker_residual_transformation.residual_transformation_proof_p(subproof)) {
            ...
            while ((NIL == doneP) && (NIL != inference_worker_residual_transformation.residual_transformation_proof_p(parent_proof))) {
                ...
                if (NIL == el_conjunction_p(non_focal_conclusion)) {
                    if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
                    ...
                    if (NIL == subl_promotions.memberP(subproof_conclusion, cycl_utilities.formula_args(non_focal_conclusion, UNPROVIDED), symbol_function(EQUAL), UNPROVIDED)) {
                        if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
    ...
    public static SubLObject residual_transformation_proof_entry_good_fitP(final SubLObject subproof, final SubLObject attachment_point) {
        ...
        if ((NIL != inference_worker_transformation.transformation_proof_p(proof_view.proof_view_entry_get_proof(attachment_point, UNPROVIDED))) && (NIL != member(subproof, inference_datastructures_proof.all_proof_subproofs(proof_view.proof_view_entry_get_proof(attachment_point, UNPROVIDED)), UNPROVIDED, UNPROVIDED))) {
            if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
            ...
            if (NIL != inference_worker_removal.removal_proof_p(subproof)) {
                ...
                if (NIL == cycl_utilities.expression_find(conclusion, proof_view.proof_view_fact_sentence(pph_proof.pph_proof_conclusion(proof_view.proof_view_get_proof(v_proof_view), UNPROVIDED)), NIL, symbol_function(EQUAL), UNPROVIDED)) {
                    if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
                        format_nil.force_format(T, $str25$__Bad_fit___S___not_in__S__, conclusion, proof_view.proof_view_fact_sentence(pph_proof.pph_proof_conclusion(proof_view.proof_view_get_proof(v_proof_view), UNPROVIDED)), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                    }
                    return NIL;
                }
                if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
                    format_nil.force_format(T, $str26$__Good_fit___S___in__S__, conclusion, proof_view.proof_view_fact_sentence(pph_proof.pph_proof_conclusion(proof_view.proof_view_get_proof(v_proof_view), UNPROVIDED)), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                }
                return T;
            }
    ...
    public static SubLObject proof_view_conjunctive_removal_proof_p(final SubLObject proof, final SubLObject mt) {
        return makeBoolean((NIL != inference_worker_removal.removal_proof_p(proof)) && (NIL != el_conjunction_p(pph_proof.pph_proof_conclusion(proof, mt))));
    }
    ...
    public static SubLObject pph_residual_transformation_proof_subproofs_for_conclusion(final SubLObject residual_transformation_proof, final SubLObject mt) {
        ...
        SubLObject remaining_conjuncts = copy_list(proved_transformed_conjuncts);
        ...
        while (NIL != cdolist_list_var) {
            ...
            if (NIL != n) {
                ...
                n = position(proved_conjunct, remaining_conjuncts, symbol_function(EQUAL), UNPROVIDED, UNPROVIDED, UNPROVIDED);
            }
            cdolist_list_var = cdolist_list_var.rest();
            proved_conjunct = cdolist_list_var.first();
        } 
        ...
        while ((NIL == queues.queue_empty_p(queue)) && (NIL == list_utilities.empty_list_p(remaining_conjuncts))) {
            ...
            if (NIL != subl_promotions.memberP(current_subproof_conclusion, remaining_conjuncts, symbol_function(EQUAL), UNPROVIDED)) {
                ...
                if (NIL != subl_promotions.memberP(current_subproof_conclusion, proved_conjuncts, symbol_function(EQUAL), UNPROVIDED)) {
                    if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
                    ...
                    double_duty_subproofs = cons(current_subproof, double_duty_subproofs);
                }
                ...
                supported_asents = cons(current_subproof_conclusion, supported_asents);
            } else
                if ((NIL != el_conjunction_p(current_subproof_conclusion)) && (NIL != list_utilities.non_empty_list_p(intersection(cycl_utilities.formula_args(current_subproof_conclusion, UNPROVIDED), remaining_conjuncts, symbol_function(EQUAL), UNPROVIDED)))) {
                    if (NIL != inference_worker_residual_transformation.residual_transformation_proof_p(current_subproof)) {
                        subproofs = list_utilities.add_to_end(current_subproof, subproofs);
                    } else {
                        subproofs = cons(current_subproof, subproofs);
                    }
                    if (NIL != list_utilities.non_empty_list_p(intersection(cycl_utilities.formula_args(current_subproof_conclusion, UNPROVIDED), proved_conjuncts, symbol_function(EQUAL), UNPROVIDED))) {
                        if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
                    ...
                    final SubLObject items_var = intersection(remaining_conjuncts, cycl_utilities.formula_args(current_subproof_conclusion, UNPROVIDED), symbol_function(EQUAL), UNPROVIDED);
                    if (items_var.isVector()) {
                        ...
                        for (length = length(vector_var), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL(length); v_iteration = add(v_iteration, ONE_INTEGER)) {
                            ...
                            supported_asents = cons(item, supported_asents);
                        }
                    } else {
                        ...
                        while (NIL != cdolist_list_var2) {
                            supported_asents = cons(item2, supported_asents);
                            cdolist_list_var2 = cdolist_list_var2.rest();
                            item2 = cdolist_list_var2.first();
                        } 
                    }
                    remaining_conjuncts = set_difference(remaining_conjuncts, cycl_utilities.formula_args(current_subproof_conclusion, UNPROVIDED), symbol_function(EQUAL), UNPROVIDED);
                }
        ...
        return values(subproofs, double_duty_subproofs, supported_asents);
    }
    ...
    public static SubLObject init_proof_view_residual_file() {
        ...
        defparameter("*RESIDUAL-PROOF-VIEW-RECURSION-DEPTH*", ZERO_INTEGER);
        defparameter("*RESIDUAL-PROOF-VIEW-CHECK-FIT?*", NIL);
        return NIL;
    }
