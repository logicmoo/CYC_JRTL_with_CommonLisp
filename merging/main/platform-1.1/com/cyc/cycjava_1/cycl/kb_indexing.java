...
Relevant mts are assumed scoped from the outside. */
  ...
  public static final SubLObject declare_kb_indexing_file() {
    ...
    declareFunction("clear_key_gaf_arg_index_cached", "CLEAR-KEY-GAF-ARG-INDEX-CACHED", 0, 0, false); new $clear_key_gaf_arg_index_cached$ZeroArityFunction();
    ...
    declareFunction("num_predicate_extent_index", "NUM-PREDICATE-EXTENT-INDEX", 1, 1, false); new $num_predicate_extent_index$UnaryFunction(); new $num_predicate_extent_index$BinaryFunction();
    ...
    declareFunction("num_index", "NUM-INDEX", 1, 0, false); new $num_index$UnaryFunction();
