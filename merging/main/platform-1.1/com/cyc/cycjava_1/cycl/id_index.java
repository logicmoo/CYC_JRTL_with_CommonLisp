...
Access to OLD-OBJECTS-SIZE number of ids starting at 0 will be optimized. */
  ...
  public static final SubLObject init_id_index_file() {
    ...
    $id_index_empty_list$ = deflexical("*ID-INDEX-EMPTY-LIST*", maybeDefault( $sym43$_ID_INDEX_EMPTY_LIST_, $id_index_empty_list$, ()-> (Symbols.make_symbol($str44$THE_EMPTY_LIST))));
