...
c) if DIRECTION is non-nil, then DIRECTION must be its direction. */
  ...
  public static final SubLObject declare_kb_mapping_file() {
    ...
    //declareFunction("assertion_with_search_term", "ASSERTION-WITH-SEARCH-TERM", 1, 0, false); new $assertion_with_search_term$UnaryFunction();
    ...
    declareFunction("gather_assertions", "GATHER-ASSERTIONS", 1, 0, false); new $gather_assertions$UnaryFunction();
