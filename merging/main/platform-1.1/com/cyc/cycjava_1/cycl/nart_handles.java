...
public  final class nart_handles extends SubLTranslatedFile {
  ...
  public static final String myName = "com.cyc.cycjava_1.cycl.nart_handles";
  ...
  public static final SubLObject declare_nart_handles_file() {
    ...
    declareFunction("nart_p", "NART-P", 1, 0, false); new $nart_p$UnaryFunction();
    ...
    declareFunction("sxhash_nart_method", "SXHASH-NART-METHOD", 1, 0, false); new $sxhash_nart_method$UnaryFunction();
  ...
  public static final SubLObject init_nart_handles_file() {
    $nart_from_id$ = deflexical("*NART-FROM-ID*", maybeDefault( $sym0$_NART_FROM_ID_, $nart_from_id$, NIL));
