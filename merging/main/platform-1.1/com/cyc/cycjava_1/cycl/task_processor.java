...
request originated. */
  ...
  public static final SubLObject declare_task_processor_file() {
    ...
    declareFunction("task_info_p", "TASK-INFO-P", 1, 0, false); new $task_info_p$UnaryFunction();
    ...
    declareFunction("task_result_set_p", "TASK-RESULT-SET-P", 1, 0, false); new $task_result_set_p$UnaryFunction();
    ...
    declareFunction("task_processor_p", "TASK-PROCESSOR-P", 1, 0, false); new $task_processor_p$UnaryFunction();
    ...
    declareFunction("task_process_pool_p", "TASK-PROCESS-POOL-P", 1, 0, false); new $task_process_pool_p$UnaryFunction();
