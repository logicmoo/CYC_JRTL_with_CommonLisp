...
public  final class verbosifier extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_verbosifier_file() {
    ...
    declareFunction("expandible_el_relation_expressionP", "EXPANDIBLE-EL-RELATION-EXPRESSION?", 1, 1, false); new $expandible_el_relation_expressionP$UnaryFunction(); new $expandible_el_relation_expressionP$BinaryFunction();
