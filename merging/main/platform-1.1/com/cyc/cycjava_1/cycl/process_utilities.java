...
public  final class process_utilities extends SubLTranslatedFile {
  ...
  public static final String myName = "com.cyc.cycjava_1.cycl.process_utilities";
  ...
  public static final SubLObject declare_process_utilities_file() {
    ...
    //declareFunction("task_p", "TASK-P", 1, 0, false); new $task_p$UnaryFunction();
    ...
    //declareFunction("thinking_task_p", "THINKING-TASK-P", 1, 0, false); new $thinking_task_p$UnaryFunction();
    ...
    //declareFunction("ipc_queue_p", "IPC-QUEUE-P", 1, 0, false); new $ipc_queue_p$UnaryFunction();
    ...
    //declareFunction("ordered_ipc_queue_p", "ORDERED-IPC-QUEUE-P", 1, 0, false); new $ordered_ipc_queue_p$UnaryFunction();
    ...
    //declareFunction("process_wrapper_p", "PROCESS-WRAPPER-P", 1, 0, false); new $process_wrapper_p$UnaryFunction();
  ...
  public static final SubLObject init_process_utilities_file() {
    ...
    $process_wrapper_isg$ = deflexical("*PROCESS-WRAPPER-ISG*", maybeDefault( $sym166$_PROCESS_WRAPPER_ISG_, $process_wrapper_isg$, ()-> (integer_sequence_generator.new_integer_sequence_generator(UNPROVIDED, UNPROVIDED, UNPROVIDED))));
    return NIL;
  }
