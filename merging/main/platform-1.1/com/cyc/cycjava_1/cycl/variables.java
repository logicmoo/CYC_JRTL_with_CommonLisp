...
of the prefix in @xref print-variable */
  ...
  public static final SubLObject declare_variables_file() {
    ...
    declareFunction("variable_p", "VARIABLE-P", 1, 0, false); new $variable_p$UnaryFunction();
    ...
    declareFunction("sxhash_variable_method", "SXHASH-VARIABLE-METHOD", 1, 0, false); new $sxhash_variable_method$UnaryFunction();
    ...
    declareFunction("variable_L", "VARIABLE-<", 2, 0, false); new $variable_L$BinaryFunction();
    ...
    declareFunction("fully_bound_p", "FULLY-BOUND-P", 1, 0, false); new $fully_bound_p$UnaryFunction();
    declareFunction("not_fully_bound_p", "NOT-FULLY-BOUND-P", 1, 0, false); new $not_fully_bound_p$UnaryFunction();
