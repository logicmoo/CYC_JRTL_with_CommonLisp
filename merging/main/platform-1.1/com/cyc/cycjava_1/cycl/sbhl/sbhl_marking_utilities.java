...
public  final class sbhl_marking_utilities extends SubLTranslatedFile {
  ...
  public static final String myName = "com.cyc.cycjava_1.cycl.sbhl.sbhl_marking_utilities";
  ...
  public static final SubLObject declare_sbhl_marking_utilities_file() {
    ...
    //declareFunction("sbhl_predicate_unmarking_fn", "SBHL-PREDICATE-UNMARKING-FN", 1, 1, false); new $sbhl_predicate_unmarking_fn$UnaryFunction(); new $sbhl_predicate_unmarking_fn$BinaryFunction();
    ...
    declareFunction("sbhl_marked_in_target_space_p", "SBHL-MARKED-IN-TARGET-SPACE-P", 1, 0, false); new $sbhl_marked_in_target_space_p$UnaryFunction();
