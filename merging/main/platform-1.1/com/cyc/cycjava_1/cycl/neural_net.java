...
public  final class neural_net extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_neural_net_file() {
    ...
    declareFunction("neural_net_p", "NEURAL-NET-P", 1, 0, false); new $neural_net_p$UnaryFunction();
    ...
    declareFunction("nn_input_node_p", "NN-INPUT-NODE-P", 1, 0, false); new $nn_input_node_p$UnaryFunction();
