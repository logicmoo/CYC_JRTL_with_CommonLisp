...
public  final class value_tables extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_value_tables_file() {
    ...
    //declareFunction("value_table_column_p", "VALUE-TABLE-COLUMN-P", 1, 0, false); new $value_table_column_p$UnaryFunction();
    ...
    //declareFunction("value_table_p", "VALUE-TABLE-P", 1, 0, false); new $value_table_p$UnaryFunction();
    ...
    //declareFunction("variable_mapping_table_p", "VARIABLE-MAPPING-TABLE-P", 1, 0, false); new $variable_mapping_table_p$UnaryFunction();
