...
public  class web_utilities extends SubLTranslatedFile {
 ...
 @note validation is *not* exhaustive: DTDs are not checked, and in general only
  ...
  public static final SubLObject declare_web_utilities_file() {
    ...
    declareFunction("html_url_expand_char", "HTML-URL-EXPAND-CHAR", 1, 0, false); new $html_url_expand_char$UnaryFunction();
    ...
    declareFunction("url_p", "URL-P", 1, 0, false); new $url_p$UnaryFunction();
    ...
    declareFunction("xml_token_iterator_state_p", "XML-TOKEN-ITERATOR-STATE-P", 1, 0, false); new $xml_token_iterator_state_p$UnaryFunction();
    ...
    declareFunction("xml_token_mentions", "XML-TOKEN-MENTIONS", 2, 0, false); new $xml_token_mentions$BinaryFunction();
