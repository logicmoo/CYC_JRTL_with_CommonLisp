...
public  final class set extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_set_file() {
    ...
    declareFunction("set_p", "SET-P", 1, 0, false); new $set_p$UnaryFunction();
    ...
    declareFunction("cfasl_input_set", "CFASL-INPUT-SET", 1, 0, false); new $cfasl_input_set$UnaryFunction();
