...
public  final class removal_modules_relation_all_exists extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_removal_modules_relation_all_exists_file() {
    ...
    declareFunction("removal_relation_all_exists_unify_required", "REMOVAL-RELATION-ALL-EXISTS-UNIFY-REQUIRED", 1, 1, false); new $removal_relation_all_exists_unify_required$UnaryFunction(); new $removal_relation_all_exists_unify_required$BinaryFunction();
    ...
    declareFunction("removal_relation_exists_all_unify_required", "REMOVAL-RELATION-EXISTS-ALL-UNIFY-REQUIRED", 1, 1, false); new $removal_relation_exists_all_unify_required$UnaryFunction(); new $removal_relation_exists_all_unify_required$BinaryFunction();
