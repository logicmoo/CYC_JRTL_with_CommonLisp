...
public  final class removal_modules_relation_instance_exists extends SubLTranslatedFile {
  ...
  public static final String myName = "com.cyc.cycjava_1.cycl.inference.modules.removal.removal_modules_relation_instance_exists";
  ...
  public static final SubLObject declare_removal_modules_relation_instance_exists_file() {
    ...
    declareFunction("removal_relation_instance_exists_unify_arg1_required", "REMOVAL-RELATION-INSTANCE-EXISTS-UNIFY-ARG1-REQUIRED", 1, 1, false); new $removal_relation_instance_exists_unify_arg1_required$UnaryFunction(); new $removal_relation_instance_exists_unify_arg1_required$BinaryFunction();
    declareFunction("removal_relation_instance_exists_unify_arg2_required", "REMOVAL-RELATION-INSTANCE-EXISTS-UNIFY-ARG2-REQUIRED", 1, 1, false); new $removal_relation_instance_exists_unify_arg2_required$UnaryFunction(); new $removal_relation_instance_exists_unify_arg2_required$BinaryFunction();
    ...
    declareFunction("removal_relation_instance_exists_unbound_arg1_required", "REMOVAL-RELATION-INSTANCE-EXISTS-UNBOUND-ARG1-REQUIRED", 1, 1, false); new $removal_relation_instance_exists_unbound_arg1_required$UnaryFunction(); new $removal_relation_instance_exists_unbound_arg1_required$BinaryFunction();
    declareFunction("removal_relation_instance_exists_unbound_arg2_required", "REMOVAL-RELATION-INSTANCE-EXISTS-UNBOUND-ARG2-REQUIRED", 1, 1, false); new $removal_relation_instance_exists_unbound_arg2_required$UnaryFunction(); new $removal_relation_instance_exists_unbound_arg2_required$BinaryFunction();
    ...
    declareFunction("removal_relation_exists_instance_unify_arg1_required", "REMOVAL-RELATION-EXISTS-INSTANCE-UNIFY-ARG1-REQUIRED", 1, 1, false); new $removal_relation_exists_instance_unify_arg1_required$UnaryFunction(); new $removal_relation_exists_instance_unify_arg1_required$BinaryFunction();
    declareFunction("removal_relation_exists_instance_unify_arg2_required", "REMOVAL-RELATION-EXISTS-INSTANCE-UNIFY-ARG2-REQUIRED", 1, 1, false); new $removal_relation_exists_instance_unify_arg2_required$UnaryFunction(); new $removal_relation_exists_instance_unify_arg2_required$BinaryFunction();
    ...
    declareFunction("removal_relation_exists_instance_unbound_arg1_required", "REMOVAL-RELATION-EXISTS-INSTANCE-UNBOUND-ARG1-REQUIRED", 1, 1, false); new $removal_relation_exists_instance_unbound_arg1_required$UnaryFunction(); new $removal_relation_exists_instance_unbound_arg1_required$BinaryFunction();
    declareFunction("removal_relation_exists_instance_unbound_arg2_required", "REMOVAL-RELATION-EXISTS-INSTANCE-UNBOUND-ARG2-REQUIRED", 1, 1, false); new $removal_relation_exists_instance_unbound_arg2_required$UnaryFunction(); new $removal_relation_exists_instance_unbound_arg2_required$BinaryFunction();
    ...
    declareFunction("removal_relation_instance_exists_expansion_applicability", "REMOVAL-RELATION-INSTANCE-EXISTS-EXPANSION-APPLICABILITY", 1, 0, false); new $removal_relation_instance_exists_expansion_applicability$UnaryFunction();
  ...
  public static final SubLObject init_removal_modules_relation_instance_exists_file() {
    ...
    $relation_instance_exists_defining_mt$ = deflexical("*RELATION-INSTANCE-EXISTS-DEFINING-MT*", maybeDefault( $sym6$_RELATION_INSTANCE_EXISTS_DEFINING_MT_, $relation_instance_exists_defining_mt$, ()-> ($const7$BaseKB)));
    ...
    $relation_exists_instance_defining_mt$ = deflexical("*RELATION-EXISTS-INSTANCE-DEFINING-MT*", maybeDefault( $sym40$_RELATION_EXISTS_INSTANCE_DEFINING_MT_, $relation_exists_instance_defining_mt$, ()-> ($const7$BaseKB)));
