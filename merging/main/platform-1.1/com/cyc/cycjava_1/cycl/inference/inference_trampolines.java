...
we need to be conservative and only look for universally true backchain control assertions. */
  ...
  public static final SubLObject declare_inference_trampolines_file() {
    ...
    declareFunction("inference_predicate_p", "INFERENCE-PREDICATE-P", 1, 0, false); new $inference_predicate_p$UnaryFunction();
    declareFunction("inference_commutative_relationP", "INFERENCE-COMMUTATIVE-RELATION?", 1, 0, false);
    declareFunction("inference_symmetric_predicateP", "INFERENCE-SYMMETRIC-PREDICATE?", 1, 0, false); new $inference_symmetric_predicateP$UnaryFunction();
    declareFunction("inference_commutative_predicate_p", "INFERENCE-COMMUTATIVE-PREDICATE-P", 1, 0, false); new $inference_commutative_predicate_p$UnaryFunction();
    ...
    declareFunction("inference_partially_commutative_predicate_p", "INFERENCE-PARTIALLY-COMMUTATIVE-PREDICATE-P", 1, 0, false); new $inference_partially_commutative_predicate_p$UnaryFunction();
    ...
    declareFunction("inference_transitive_predicateP", "INFERENCE-TRANSITIVE-PREDICATE?", 1, 0, false); new $inference_transitive_predicateP$UnaryFunction();
    declareFunction("inference_evaluatable_predicateP", "INFERENCE-EVALUATABLE-PREDICATE?", 1, 0, false); new $inference_evaluatable_predicateP$UnaryFunction();
    declareFunction("inference_reflexive_predicateP", "INFERENCE-REFLEXIVE-PREDICATE?", 1, 0, false); new $inference_reflexive_predicateP$UnaryFunction();
    ...
    declareFunction("clear_indeterminate_term_p", "CLEAR-INDETERMINATE-TERM-P", 0, 0, false); new $clear_indeterminate_term_p$ZeroArityFunction();
    ...
    declareFunction("inference_some_genl_pred_or_inverseP", "INFERENCE-SOME-GENL-PRED-OR-INVERSE?", 1, 0, false); new $inference_some_genl_pred_or_inverseP$UnaryFunction();
    declareFunction("inference_some_spec_pred_or_inverseP", "INFERENCE-SOME-SPEC-PRED-OR-INVERSE?", 1, 0, false); new $inference_some_spec_pred_or_inverseP$UnaryFunction();
