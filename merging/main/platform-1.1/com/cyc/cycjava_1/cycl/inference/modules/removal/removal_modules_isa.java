...
public  final class removal_modules_isa extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_removal_modules_isa_file() {
    ...
    declareFunction("removal_isa_collection_check_pos_cost", "REMOVAL-ISA-COLLECTION-CHECK-POS-COST", 1, 1, false); new $removal_isa_collection_check_pos_cost$UnaryFunction(); new $removal_isa_collection_check_pos_cost$BinaryFunction();
    ...
    declareFunction("removal_all_instances_cost", "REMOVAL-ALL-INSTANCES-COST", 1, 1, false); new $removal_all_instances_cost$UnaryFunction(); new $removal_all_instances_cost$BinaryFunction();
    declareFunction("removal_all_instances_completeness", "REMOVAL-ALL-INSTANCES-COMPLETENESS", 1, 0, false); new $removal_all_instances_completeness$UnaryFunction();
    ...
    declareFunction("removal_elementof_check_expand", "REMOVAL-ELEMENTOF-CHECK-EXPAND", 1, 1, false); new $removal_elementof_check_expand$UnaryFunction(); new $removal_elementof_check_expand$BinaryFunction();
    ...
    declareFunction("removal_all_isa_of_type_applicability", "REMOVAL-ALL-ISA-OF-TYPE-APPLICABILITY", 1, 0, false); new $removal_all_isa_of_type_applicability$UnaryFunction();
    ...
    declareFunction("removal_quoted_isa_collection_check_pos_cost", "REMOVAL-QUOTED-ISA-COLLECTION-CHECK-POS-COST", 1, 1, false); new $removal_quoted_isa_collection_check_pos_cost$UnaryFunction(); new $removal_quoted_isa_collection_check_pos_cost$BinaryFunction();
    declareFunction("removal_quoted_isa_collection_check_neg_cost", "REMOVAL-QUOTED-ISA-COLLECTION-CHECK-NEG-COST", 1, 1, false);
    declareFunction("removal_quoted_isa_collection_check_pos_expand", "REMOVAL-QUOTED-ISA-COLLECTION-CHECK-POS-EXPAND", 1, 1, false); new $removal_quoted_isa_collection_check_pos_expand$UnaryFunction(); new $removal_quoted_isa_collection_check_pos_expand$BinaryFunction();
    ...
    declareFunction("removal_quoted_isa_defn_pos_required", "REMOVAL-QUOTED-ISA-DEFN-POS-REQUIRED", 1, 1, false); new $removal_quoted_isa_defn_pos_required$UnaryFunction(); new $removal_quoted_isa_defn_pos_required$BinaryFunction();
