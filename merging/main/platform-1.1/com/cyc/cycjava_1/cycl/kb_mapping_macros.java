...
Therefore, we need to gate it based on whether these assertions came from the other index. */
  ...
  public static final SubLObject declare_kb_mapping_macros_file() {
    ...
    declareFunction("gaf_arg_final_index_spec_iterator_doneP", "GAF-ARG-FINAL-INDEX-SPEC-ITERATOR-DONE?", 1, 0, false); new $gaf_arg_final_index_spec_iterator_doneP$UnaryFunction();
    declareFunction("gaf_arg_final_index_spec_iterator_next", "GAF-ARG-FINAL-INDEX-SPEC-ITERATOR-NEXT", 1, 0, false); new $gaf_arg_final_index_spec_iterator_next$UnaryFunction();
    ...
    declareFunction("predicate_extent_final_index_spec_iterator_doneP", "PREDICATE-EXTENT-FINAL-INDEX-SPEC-ITERATOR-DONE?", 1, 0, false); new $predicate_extent_final_index_spec_iterator_doneP$UnaryFunction();
    declareFunction("predicate_extent_final_index_spec_iterator_next", "PREDICATE-EXTENT-FINAL-INDEX-SPEC-ITERATOR-NEXT", 1, 0, false); new $predicate_extent_final_index_spec_iterator_next$UnaryFunction();
    ...
    declareFunction("nart_arg_final_index_spec_iterator_doneP", "NART-ARG-FINAL-INDEX-SPEC-ITERATOR-DONE?", 1, 0, false); new $nart_arg_final_index_spec_iterator_doneP$UnaryFunction();
    declareFunction("nart_arg_final_index_spec_iterator_next", "NART-ARG-FINAL-INDEX-SPEC-ITERATOR-NEXT", 1, 0, false); new $nart_arg_final_index_spec_iterator_next$UnaryFunction();
    ...
    declareFunction("predicate_rule_final_index_spec_iterator_doneP", "PREDICATE-RULE-FINAL-INDEX-SPEC-ITERATOR-DONE?", 1, 0, false); new $predicate_rule_final_index_spec_iterator_doneP$UnaryFunction();
    declareFunction("predicate_rule_final_index_spec_iterator_next", "PREDICATE-RULE-FINAL-INDEX-SPEC-ITERATOR-NEXT", 1, 0, false); new $predicate_rule_final_index_spec_iterator_next$UnaryFunction();
    ...
    declareFunction("decontextualized_ist_predicate_rule_final_index_spec_iterator_doneP", "DECONTEXTUALIZED-IST-PREDICATE-RULE-FINAL-INDEX-SPEC-ITERATOR-DONE?", 1, 0, false); new $decontextualized_ist_predicate_rule_final_index_spec_iterator_doneP$UnaryFunction();
    declareFunction("decontextualized_ist_predicate_rule_final_index_spec_iterator_next", "DECONTEXTUALIZED-IST-PREDICATE-RULE-FINAL-INDEX-SPEC-ITERATOR-NEXT", 1, 0, false); new $decontextualized_ist_predicate_rule_final_index_spec_iterator_next$UnaryFunction();
    ...
    declareFunction("pred_arg2_rule_final_index_spec_iterator_doneP", "PRED-ARG2-RULE-FINAL-INDEX-SPEC-ITERATOR-DONE?", 1, 0, false); new $pred_arg2_rule_final_index_spec_iterator_doneP$UnaryFunction();
    declareFunction("pred_arg2_rule_final_index_spec_iterator_next", "PRED-ARG2-RULE-FINAL-INDEX-SPEC-ITERATOR-NEXT", 1, 0, false); new $pred_arg2_rule_final_index_spec_iterator_next$UnaryFunction();
    ...
    declareFunction("other_index_assertion_match_p", "OTHER-INDEX-ASSERTION-MATCH-P", 2, 0, false); new $other_index_assertion_match_p$BinaryFunction();
    ...
    declareFunction("assertion_semantically_matches_simple_final_index_specP", "ASSERTION-SEMANTICALLY-MATCHES-SIMPLE-FINAL-INDEX-SPEC?", 2, 0, false); new $assertion_semantically_matches_simple_final_index_specP$BinaryFunction();
    ...
    declareFunction("clear_simple_term_assertion_list_filtered", "CLEAR-SIMPLE-TERM-ASSERTION-LIST-FILTERED", 0, 0, false); new $clear_simple_term_assertion_list_filtered$ZeroArityFunction();
    ...
    declareFunction("decontextualized_ist_predicate_rule_index_asent_match_p", "DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX-ASENT-MATCH-P", 2, 0, false); new $decontextualized_ist_predicate_rule_index_asent_match_p$BinaryFunction();
