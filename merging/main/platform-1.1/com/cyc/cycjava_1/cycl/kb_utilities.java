...
Handles dotted pairs. */
  ...
  public static final SubLObject declare_kb_utilities_file() {
    ...
    //declareFunction("hl_external_id_string_p", "HL-EXTERNAL-ID-STRING-P", 1, 0, false); new $hl_external_id_string_p$UnaryFunction();
    ...
    declareFunction("term_L", "TERM-<", 2, 3, false); new $term_L$BinaryFunction();
    //declareFunction("term_L_with_constant_by_name", "TERM-<-WITH-CONSTANT-BY-NAME", 2, 1, false);
    declareFunction("form_sort_pred", "FORM-SORT-PRED", 2, 0, false); new $form_sort_pred$BinaryFunction();
    ...
    //declareFunction("fort_L", "FORT-<", 2, 0, false); new $fort_L$BinaryFunction();
    ...
    //declareFunction("clear_cached_union_all_specs_count", "CLEAR-CACHED-UNION-ALL-SPECS-COUNT", 0, 0, false); new $clear_cached_union_all_specs_count$ZeroArityFunction();
    ...
    //declareFunction("clear_forbidden_kb_covering_collections_set", "CLEAR-FORBIDDEN-KB-COVERING-COLLECTIONS-SET", 0, 0, false); new $clear_forbidden_kb_covering_collections_set$ZeroArityFunction();
