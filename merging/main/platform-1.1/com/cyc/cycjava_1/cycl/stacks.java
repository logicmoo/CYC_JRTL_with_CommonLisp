...
public  final class stacks extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_stacks_file() {
    ...
    declareFunction("stack_p", "STACK-P", 1, 0, false); new $stack_p$UnaryFunction();
    ...
    declareFunction("locked_stack_p", "LOCKED-STACK-P", 1, 0, false); new $locked_stack_p$UnaryFunction();
