      ...
      SimpleNode
{
  ...
  public Object eval(CallStack callstack, Interpreter interpreter) throws EvalError
  {
     ...
     * dimensions to worry about). The syntax uses the undefinedDimension count.
     * e.g. int [][] { 1, 2 };
     */
    if( child instanceof BSHArrayInitializer )
    {
      ...
      if( definedDimensions.length != numUndefinedDims )
        throw new EvalError( "Incompatible initializer. Allocation calls for a " + numUndefinedDims + " dimensional array, but initializer is a " + definedDimensions.length + " dimensional array", this, callstack );
      return initValue;
    }
    else
