...
public final class module0548 extends SubLTranslatedFile
{
    ...
    public static SubLObject f33817(final SubLObject var1, final SubLObject var2) {
        final SubLObject var3 = conses_high.getf(var2, (SubLObject)$ic0$, (SubLObject)$ic1$);
        SubLObject var4 = conses_high.copy_list(var2);
        var4 = conses_high.remf(var4, (SubLObject)$ic0$);
        var4 = conses_high.putf(var4, (SubLObject)$ic2$, (SubLObject)ConsesLow.list(var3));
    ...
    public static SubLObject f33818(final SubLObject var6, final SubLObject var2) {
        ...
        f33822(var9, var8, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f33831(final SubLObject var1, final SubLObject var2) {
        ...
        f33822(var3, var4, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f33833(final SubLObject var14, final SubLObject var2, SubLObject var15) {
        ...
        final SubLObject var16 = (NIL != var15) ? f33834(var14) : var14;
        final SubLObject var17 = f33835(Mapping.mapcar((SubLObject)$ic3$, var16));
    ...
    public static SubLObject f33841(final SubLObject var17, final SubLObject var18, final SubLObject var19, SubLObject var2, SubLObject var23, SubLObject var11) {
        ...
        if (var23 == UNPROVIDED) {
            var23 = (SubLObject)$ic4$;
        }
        if (var11 == UNPROVIDED) {
            var11 = (SubLObject)NIL;
        }
        final SubLThread var24 = SubLProcess.currentSubLThread();
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var24) && NIL == conses_high.member(var23, (SubLObject)$ic5$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f33843(final SubLObject var25, final SubLObject var19, SubLObject var2, SubLObject var23) {
        ...
        if (var23 == UNPROVIDED) {
            var23 = (SubLObject)$ic7$;
        }
        final SubLThread var26 = SubLProcess.currentSubLThread();
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var26) && NIL == conses_high.member(var23, (SubLObject)$ic8$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
            Errors.error((SubLObject)$ic6$);
        }
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var26) && !Sequences.length(var25).numG((SubLObject)ONE_INTEGER)) {
    ...
    public static SubLObject f33845(final SubLObject var20, final SubLObject var26, SubLObject var2, SubLObject var23, SubLObject var11) {
        ...
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var27) && var23 != $ic10$ && NIL == conses_high.member(var23, var26, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
            Errors.error((SubLObject)$ic6$);
        }
    ...
    public static SubLObject f33847(final SubLObject var20, final SubLObject var19, SubLObject var27, SubLObject var2, SubLObject var11) {
        ...
        if (NIL == var27) {
            var27 = (SubLObject)ConsesLow.list(Symbols.symbol_function((SubLObject)$ic11$));
        }
    ...
    public static SubLObject f33850(final SubLObject var20, final SubLObject var19, SubLObject var2, SubLObject var28) {
        ...
        if (var28 == UNPROVIDED) {
            var28 = Symbols.symbol_function((SubLObject)$ic12$);
        }
    ...
    public static SubLObject f33851(final SubLObject var29, final SubLObject var30, final SubLObject var19, SubLObject var2, final SubLObject var28) {
        ...
        final SubLObject var33 = cdestructuring_bind.property_list_member((SubLObject)$ic13$, var32);
        final SubLObject var34 = (SubLObject)((NIL != var33) ? conses_high.cadr(var33) : T);
        final SubLObject var35 = module0424.f29687(var29, var19, (SubLObject)UNPROVIDED);
        final SubLObject var36 = module0424.f29687(var30, var19, (SubLObject)UNPROVIDED);
        final SubLObject var37 = (SubLObject)ConsesLow.list(var35, var36);
        final SubLObject var38 = (NIL != var34) ? f33834(var37) : var37;
        SubLObject var38_39;
        final SubLObject var36_37 = var38_39 = var38;
        SubLObject var39 = (SubLObject)NIL;
        SubLObject var40 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var38_39, var36_37, (SubLObject)$ic14$);
        ...
        var38_39 = var38_39.rest();
        if (NIL == var38_39) {
            final SubLObject var41 = Sort.sort(var39, var28, (SubLObject)UNPROVIDED);
            final SubLObject var42 = Sort.sort(var40, var28, (SubLObject)UNPROVIDED);
            ...
            if (NIL == conses_high.getf(var2, (SubLObject)$ic2$, (SubLObject)UNPROVIDED)) {
                var2 = conses_high.copy_list(var2);
                var2 = conses_high.putf(var2, (SubLObject)$ic2$, (SubLObject)$ic15$);
            }
            return f33818(var45, var2);
        }
        cdestructuring_bind.cdestructuring_bind_error(var36_37, (SubLObject)$ic14$);
    ...
    public static SubLObject f33852(final SubLObject var20, final SubLObject var46, final SubLObject var19, SubLObject var2, SubLObject var28) {
        ...
        final SubLObject var49 = module0424.f29952(var48, (SubLObject)$ic16$, (SubLObject)$ic17$, (SubLObject)UNPROVIDED);
        final SubLObject var50 = module0424.f29693(var49, var47, (SubLObject)NIL);
        final SubLObject var51 = module0424.f29693(var49, var47, (SubLObject)T);
        if (NIL == module0424.f29678(var50)) {
            Errors.warn((SubLObject)$ic18$);
            return (SubLObject)NIL;
        }
    ...
    public static SubLObject f33853(final SubLObject var51, final SubLObject var52, SubLObject var2) {
        ...
        final SubLObject var53 = (SubLObject)$ic19$;
        final SubLObject var54 = (SubLObject)$ic20$;
        f33854(var51, var53);
    ...
    public static SubLObject f33857(final SubLObject var17, final SubLObject var18, final SubLObject var19) {
        ...
        while (NIL != var21) {
            ...
            final SubLObject var25 = module0424.f29640(var22, var19, (SubLObject)UNPROVIDED);
            final SubLObject var26 = module0424.f29640(var24, var19, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f33860(final SubLObject var25, final SubLObject var19) {
        ...
        final SubLObject var28 = module0424.f29687(var27, (SubLObject)$ic21$, (SubLObject)UNPROVIDED);
        ...
        while (NIL != var33) {
            ...
            var31 = module0424.f29640(var30, var19, (SubLObject)UNPROVIDED);
            if (NIL != var31) {
    ...
    public static SubLObject f33844(final SubLObject var25, final SubLObject var19, final SubLObject var23) {
        ...
        var33 = var32.first();
        while (NIL != var32) {
            var30 = module0424.f29640(var33, var19, (SubLObject)UNPROVIDED);
            if (NIL != var30) {
        ...
        while (NIL != var32) {
            var29 = (SubLObject)ZERO_INTEGER;
            if (var23.eql((SubLObject)$ic10$)) {
                SubLObject var55_72;
                var28 = (var55_72 = module0424.f30006(var34, var19));
                SubLObject var35 = (SubLObject)NIL;
                var35 = var55_72.first();
                while (NIL != var55_72) {
                    var30 = module0424.f29640(var35, var19, (SubLObject)UNPROVIDED);
                    if (NIL != var30) {
                        var31 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list(var29, var30), var31);
                    }
                    var29 = Numbers.add(var29, (SubLObject)ONE_INTEGER);
            ...
            else if (var23.eql((SubLObject)$ic7$)) {
                SubLObject var55_73 = var27;
                SubLObject var35 = (SubLObject)NIL;
                var35 = var55_73.first();
                while (NIL != var55_73) {
                    final SubLObject var36 = module0424.f29801(var34, module0424.f29640(var35, (SubLObject)$ic21$, (SubLObject)UNPROVIDED));
                    var30 = module0424.f29640(var36, var19, (SubLObject)UNPROVIDED);
                    if (NIL != var30) {
                        var31 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list(var29, var30), var31);
                    }
                    var29 = Numbers.add(var29, (SubLObject)ONE_INTEGER);
    ...
    public static SubLObject f33858(final SubLObject var2, final SubLObject var19) {
        final SubLObject var20 = cdestructuring_bind.property_list_member((SubLObject)$ic22$, var2);
        final SubLObject var21 = (SubLObject)((NIL != var20) ? conses_high.cadr(var20) : $ic23$);
        final SubLObject var22 = cdestructuring_bind.property_list_member((SubLObject)$ic24$, var2);
        final SubLObject var23 = (SubLObject)((NIL != var22) ? conses_high.cadr(var22) : $ic25$);
        final SubLObject var24 = Sequences.cconcatenate((SubLObject)$ic26$, module0006.f203(var21));
        final SubLObject var25 = Sequences.cconcatenate((SubLObject)$ic27$, module0006.f203(var23));
        final SubLObject var26 = Sequences.cconcatenate((SubLObject)$ic28$, module0006.f205(var19));
    ...
    public static SubLObject f33840(final SubLObject var20, final SubLObject var26, final SubLObject var2) {
        final SubLThread var27 = SubLProcess.currentSubLThread();
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var27) && NIL == module0035.f1994(var26, (SubLObject)TEN_INTEGER, (SubLObject)UNPROVIDED)) {
            Errors.error((SubLObject)$ic29$, var26);
        }
    ...
    public static SubLObject f33861(final SubLObject var20, final SubLObject var26) {
        ...
        while (NIL != var29) {
            ...
            while (NIL != var55_84) {
                final SubLObject var33 = module0424.f29640(var30, var32, (SubLObject)UNPROVIDED);
                var31 = (SubLObject)ConsesLow.cons(var33, var31);
                var55_84 = var55_84.rest();
                var32 = var55_84.first();
            }
            if (NIL == module0035.member_if_not(Symbols.symbol_function((SubLObject)$ic30$), var31, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f33862(final SubLObject var2, final SubLObject var26) {
        ...
        final SubLObject var28 = (SubLObject)((NIL != var27) ? conses_high.cadr(var27) : $ic25$);
        final SubLObject var29 = Sequences.cconcatenate((SubLObject)$ic27$, module0006.f203(var28));
        final SubLObject var30 = Sequences.cconcatenate((SubLObject)$ic31$, module0006.f205(var26));
    ...
    public static SubLObject f33865(final SubLObject var2, final SubLObject var19) {
        final SubLObject var20 = cdestructuring_bind.property_list_member((SubLObject)$ic24$, var2);
        final SubLObject var21 = (SubLObject)((NIL != var20) ? conses_high.cadr(var20) : $ic25$);
        final SubLObject var22 = Sequences.cconcatenate((SubLObject)$ic27$, module0006.f203(var21));
        final SubLObject var23 = Sequences.cconcatenate((SubLObject)$ic28$, module0006.f205(var19));
        final SubLObject var24 = Sequences.copy_seq((SubLObject)$ic32$);
    ...
    public static SubLObject f33867(final SubLObject var8, final SubLObject var27) {
        SubLObject var28 = (SubLObject)NIL;
        final SubLObject var29 = Sort.stable_sort(conses_high.copy_list(var8), Symbols.symbol_function((SubLObject)$ic33$), Symbols.symbol_function((SubLObject)$ic34$));
        final SubLObject var30 = module0067.f4880((SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        SubLObject var31 = (SubLObject)NIL;
        SubLObject var32 = (SubLObject)NIL;
        SubLObject var33 = (SubLObject)NIL;
        var31 = var29;
        ...
        final SubLObject var34 = module0035.f2520(var29, var27, Symbols.symbol_function((SubLObject)$ic35$));
        SubLObject var35 = (SubLObject)NIL;
        SubLObject var36 = (SubLObject)NIL;
        ...
        for (var37 = (SubLObject)ZERO_INTEGER; NIL != var35; var35 = var35.rest(), var36 = var35.first(), var37 = Numbers.add((SubLObject)ONE_INTEGER, var37)) {
            if (!var37.isZero()) {
                final SubLObject var38 = Sequences.cconcatenate((SubLObject)$ic36$, module0006.f203(var37));
                var28 = (SubLObject)ConsesLow.cons(var38, var28);
            }
            if (NIL == var36) {
                Errors.warn((SubLObject)$ic37$, var37);
            }
            SubLObject var39 = var36;
            SubLObject var40 = (SubLObject)NIL;
            var40 = var39.first();
            while (NIL != var39) {
                final SubLObject var41 = module0067.f4884(var30, var40, (SubLObject)UNPROVIDED);
                SubLObject var43;
                final SubLObject var42 = var43 = var40;
                SubLObject var44 = (SubLObject)NIL;
                SubLObject var45 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var43, var42, (SubLObject)$ic38$);
                var44 = var43.first();
                var43 = var43.rest();
                cdestructuring_bind.destructuring_bind_must_consp(var43, var42, (SubLObject)$ic38$);
                var45 = var43.first();
                ...
                if (NIL == var43) {
                    ...
                    cdestructuring_bind.cdestructuring_bind_error(var42, (SubLObject)$ic38$);
                }
                var39 = var39.rest();
                var40 = var39.first();
            }
    ...
    public static SubLObject f33854(final SubLObject var51, final SubLObject var9) {
        ...
        return f33822(var9, var52, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f33868(final SubLObject var51) {
        SubLObject var52 = (SubLObject)NIL;
        final SubLObject var53 = inference_datastructures_inference_oc.f25492(var51);
        if (NIL == module0065.f4772(var53, (SubLObject)$ic39$)) {
            final SubLObject var106_107 = var53;
            if (NIL == module0065.f4775(var106_107, (SubLObject)$ic39$)) {
                ...
                for (var56 = Sequences.length(var54), var57 = (SubLObject)NIL, var57 = (SubLObject)ZERO_INTEGER; var57.numL(var56); var57 = Numbers.add(var57, (SubLObject)ONE_INTEGER)) {
                    ...
                    if (NIL == module0065.f4749(var59) || NIL == module0065.f4773((SubLObject)$ic39$)) {
                        if (NIL != module0065.f4749(var59)) {
                            var59 = (SubLObject)$ic39$;
                        }
                        var114_115 = inference_datastructures_inference_oc.f25629(var59);
                        var60 = inference_datastructures_inference_oc.f25623(var59, (SubLObject)NIL);
                        var52 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list(var60, var114_115), var52);
                    }
                }
            }
            final SubLObject var117_118 = var53;
            if (NIL == module0065.f4777(var117_118) || NIL == module0065.f4773((SubLObject)$ic39$)) {
                ...
                final SubLObject var64 = (SubLObject)((NIL != module0065.f4773((SubLObject)$ic39$)) ? NIL : $ic39$);
                while (var62.numL(var63)) {
                    final SubLObject var65 = Hashtables.gethash_without_values(var62, var61, var64);
                    if (NIL == module0065.f4773((SubLObject)$ic39$) || NIL == module0065.f4749(var65)) {
                        final SubLObject var114_116 = inference_datastructures_inference_oc.f25629(var65);
                        final SubLObject var66 = inference_datastructures_inference_oc.f25623(var65, (SubLObject)NIL);
    ...
    public static SubLObject f33870(final SubLObject var20, final SubLObject var19) {
        ...
        for (var24 = (SubLObject)ZERO_INTEGER; NIL != var22; var22 = var22.rest(), var23 = var22.first(), var24 = Numbers.add((SubLObject)ONE_INTEGER, var24)) {
            final SubLObject var25 = module0424.f29640(var23, var19, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f33820(final SubLObject var5) {
        ...
        var7 = var5;
        var8 = var7.first();
        for (var9 = (SubLObject)ZERO_INTEGER; NIL != var7; var7 = var7.rest(), var8 = var7.first(), var9 = Numbers.add((SubLObject)ONE_INTEGER, var9)) {
    ...
    public static SubLObject f33835(final SubLObject var6) {
        SubLObject var7 = (SubLObject)NIL;
        final SubLObject var8 = module0048.f3381(Mapping.mapcar(Symbols.symbol_function((SubLObject)$ic41$), var6), (SubLObject)UNPROVIDED);
        ...
        while (NIL != var9) {
            ...
            SubLObject var15;
            SubLObject var16;
            for (var15 = (SubLObject)NIL, var15 = (SubLObject)ZERO_INTEGER; var15.numL(var8); var15 = Numbers.add(var15, (SubLObject)ONE_INTEGER)) {
                if (var15.numL(var12)) {
    ...
    public static SubLObject f33834(final SubLObject var132) {
        ...
        final SubLObject var134 = module0048.f3381(Mapping.mapcar(Symbols.symbol_function((SubLObject)$ic41$), var132), (SubLObject)UNPROVIDED);
        SubLObject var135 = var132;
        SubLObject var136 = (SubLObject)NIL;
        var136 = var135.first();
        while (NIL != var135) {
            final SubLObject var137 = Numbers.round(Numbers.divide(var134, Sequences.length(var136)), (SubLObject)UNPROVIDED);
            if (var137.numG((SubLObject)ONE_INTEGER)) {
                ...
                while (NIL != var55_137) {
                    SubLObject var140;
                    for (var140 = (SubLObject)NIL, var140 = (SubLObject)ZERO_INTEGER; var140.numL(var137); var140 = Numbers.add(var140, (SubLObject)ONE_INTEGER)) {
    ...
    public static SubLObject f33871(final SubLObject var1) {
        ...
        while (NIL != var6) {
            ...
            cdestructuring_bind.destructuring_bind_must_consp(var9, var8, (SubLObject)$ic42$);
            var10 = var9.first();
            var9 = var9.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var9, var8, (SubLObject)$ic42$);
            var11 = var9.first();
            ...
            if (NIL == var9) {
                ...
                cdestructuring_bind.cdestructuring_bind_error(var8, (SubLObject)$ic42$);
            }
            var6 = var6.rest();
            var7 = var6.first();
        }
        final SubLObject var12 = Numbers.subtract(var3, var2);
        final SubLObject var13 = Numbers.add(var2, Numbers.multiply((SubLObject)$ic43$, var12));
        final SubLObject var14 = Numbers.subtract(var5, var4);
        final SubLObject var15 = Numbers.add(var5, Numbers.multiply((SubLObject)$ic44$, var14));
    ...
    public static SubLObject f33872(final SubLObject var8) {
        ...
        for (var12 = (SubLObject)ZERO_INTEGER; NIL != var10; var10 = var10.rest(), var11 = var10.first(), var12 = Numbers.add((SubLObject)ONE_INTEGER, var12)) {
            ...
            cdestructuring_bind.destructuring_bind_must_consp(var14, var13, (SubLObject)$ic45$);
            var15 = var14.first();
            var14 = var14.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var14, var13, (SubLObject)$ic45$);
            var16 = var14.first();
            ...
            if (NIL == var14) {
                ...
                cdestructuring_bind.cdestructuring_bind_error(var13, (SubLObject)$ic45$);
            }
        }
    ...
    public static SubLObject f33873(final SubLObject var2) {
        return conses_high.getf(var2, (SubLObject)$ic47$, $g3979$.getGlobalValue());
    }
    
    public static SubLObject f33824(final SubLObject var2) {
        return conses_high.getf(var2, (SubLObject)$ic48$, (SubLObject)NIL);
    }
    
    public static SubLObject f33874(final SubLObject var154, final SubLObject var155, SubLObject var156) {
        if (var156 == UNPROVIDED) {
            var156 = $g3980$.getGlobalValue();
        }
        return Sequences.cconcatenate(var156, new SubLObject[] { var154, $ic50$, var155 });
    }
    
    public static SubLObject f33875(final SubLObject var154) {
        return f33874(var154, (SubLObject)$ic51$, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f33876(final SubLObject var154) {
        return f33874(var154, (SubLObject)$ic46$, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f33856(final SubLObject var10, final SubLObject var52) {
        ...
        return (SubLObject)((NIL != f33878(var10)) ? var53 : NIL);
    }
    ...
    public static SubLObject f33882() {
        return (SubLObject)makeBoolean(NIL != Processes.external_processes_supportedP() && NIL != f33883());
    }
    ...
    public static SubLObject f33869() {
        return Errors.warn((SubLObject)$ic52$);
    }
    ...
    public static SubLObject f33885() {
        $g3978$ = SubLFiles.deflexical("S#37275", (SubLObject)$ic40$);
        $g3979$ = SubLFiles.deflexical("S#37276", (SubLObject)$ic46$);
        $g3980$ = SubLFiles.deflexical("S#37277", (SubLObject)$ic49$);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g3979$ = null;
        $g3980$ = null;
        $ic0$ = makeKeyword("LINE-LABEL");
        $ic1$ = makeString("");
        $ic2$ = makeKeyword("LINE-LABELS");
        $ic3$ = makeSymbol("S#29144", "CYC");
        $ic4$ = makeKeyword("BOTH");
        $ic5$ = ConsesLow.list((SubLObject)makeKeyword("BOTH"), (SubLObject)makeKeyword("BASELINE"), (SubLObject)makeKeyword("EXPERIMENT"));
        $ic6$ = makeString("Invalid sort-by parameter.");
        $ic7$ = makeKeyword("FIRST");
        $ic8$ = ConsesLow.list((SubLObject)makeKeyword("ALL"), (SubLObject)makeKeyword("FIRST"));
        $ic9$ = makeString("There should be atleast 2 runs specified");
        $ic10$ = makeKeyword("ALL");
        $ic11$ = makeSymbol("TRUE");
        $ic12$ = makeSymbol("S#3700", "CYC");
        $ic13$ = makeKeyword("SCALE?");
        $ic14$ = ConsesLow.list((SubLObject)makeSymbol("S#37278", "CYC"), (SubLObject)makeSymbol("S#37279", "CYC"));
        $ic15$ = ConsesLow.list((SubLObject)makeString("unanswerable"), (SubLObject)makeString("answerable"));
        $ic16$ = makeString("timed out");
        $ic17$ = makeSymbol("S#32819", "CYC");
        $ic18$ = makeString("No oracularly answerable timed-out queries");
        $ic19$ = makeString("/tmp/inference_answer_timeline.data");
        $ic20$ = makeString("/tmp/inference_answer_timeline.plot");
        $ic21$ = makeKeyword("QUERY");
        $ic22$ = makeKeyword("BASELINE-NAME");
        $ic23$ = makeString("baseline");
        $ic24$ = makeKeyword("EXPERIMENT-NAME");
        $ic25$ = makeString("experiment");
        $ic26$ = makeString("baseline   = ");
        $ic27$ = makeString("experiment = ");
        $ic28$ = makeString("property   = ");
        $ic29$ = makeString("Cannot handle more than 10 properties, got ~s");
        $ic30$ = makeSymbol("NUMBERP");
        $ic31$ = makeString("properties = ");
        $ic32$ = makeString("classification 0");
        $ic33$ = makeSymbol("<");
        $ic34$ = makeSymbol("SECOND");
        $ic35$ = makeSymbol("FIRST");
        $ic36$ = makeString("classification ");
        $ic37$ = makeString("Classification ~S was empty");
        $ic38$ = ConsesLow.list((SubLObject)makeSymbol("S#7306", "CYC"), (SubLObject)makeSymbol("S#132", "CYC"));
        $ic39$ = makeKeyword("SKIP");
        $ic40$ = makeString("/cyc/top/data/kb-stats/");
        $ic41$ = makeSymbol("LENGTH");
        $ic42$ = ConsesLow.list((SubLObject)makeSymbol("S#9941", "CYC"), (SubLObject)makeSymbol("S#9942", "CYC"));
        $ic43$ = (SubLFloat)makeDouble(0.3);
        $ic44$ = (SubLFloat)makeDouble(0.0);
        $ic45$ = ConsesLow.list((SubLObject)makeSymbol("S#37280", "CYC"), (SubLObject)makeSymbol("S#132", "CYC"));
        $ic46$ = makeString("plot");
        $ic47$ = makeKeyword("PLOT-NAME");
        $ic48$ = makeKeyword("DISPLAY");
        $ic49$ = makeString("/tmp/");
        $ic50$ = makeString(".");
        $ic51$ = makeString("dat");
        $ic52$ = makeString("External plotting not enabled in this image");
    }
}
