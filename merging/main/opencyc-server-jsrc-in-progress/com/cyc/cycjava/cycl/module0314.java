...
public final class module0314 extends SubLTranslatedFile
{
    ...
    public static SubLObject f21163() {
        ...
        if (NIL != module0221.$g2399$.getDynamicValue(var1)) {
    ...
    public static SubLObject f21165(final SubLObject var2) {
        ...
        module0313.f21151((SubLObject)THREE_INTEGER, (SubLObject)$ic4$, module0145.$g1895$.getDynamicValue(var3), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f21167(final SubLObject var4) {
        ...
        try {
            module0145.$g1902$.bind((SubLObject)NIL, var5);
            try {
                assert NIL != Types.function_spec_p((SubLObject)$ic5$) : $ic5$;
                final SubLObject var6_7 = module0145.$g1904$.currentBinding(var5);
                try {
                    module0145.$g1904$.bind((SubLObject)$ic5$, var5);
                    f21168(var4, (SubLObject)UNPROVIDED);
                }
                finally {
    ...
    public static SubLObject f21169(final SubLObject var9) {
        ...
        if (NIL != module0145.$g1932$.getDynamicValue(var10) && module0145.$g1934$.getDynamicValue(var10).numGE(module0145.$g1933$.getDynamicValue(var10))) {
            module0012.f425();
            var11 = (SubLObject)T;
        }
        if (NIL == var11) {
            module0145.$g1934$.setDynamicValue(Numbers.add(module0145.$g1934$.getDynamicValue(var10), (SubLObject)ONE_INTEGER), var10);
    ...
    public static SubLObject f21170(final SubLObject var11) {
        ...
        if (NIL != module0313.f21137(var11)) {
            if (NIL == f21171(var11)) {
                f21169(var11);
                f21172(var11);
        ...
        else if (NIL != module0145.$g1910$.getDynamicValue(var12)) {
            if (NIL == conses_high.member(var11, module0145.$g1902$.getDynamicValue(var12), module0145.$g1910$.getDynamicValue(var12), Symbols.symbol_function((SubLObject)IDENTITY))) {
    ...
    public static SubLObject f21173(final SubLObject var2) {
        ...
        if (NIL != module0313.f21137(var4)) {
            if (NIL != module0145.$g1937$.getDynamicValue(var3)) {
        ...
        else if (NIL != module0145.$g1910$.getDynamicValue(var3)) {
            final SubLObject var6 = (SubLObject)ConsesLow.cons(var4, var5);
            if (NIL == conses_high.member(var6, module0145.$g1902$.getDynamicValue(var3), module0145.$g1910$.getDynamicValue(var3), Symbols.symbol_function((SubLObject)IDENTITY))) {
    ...
    public static SubLObject f21174(final SubLObject var4) {
        ...
        try {
            module0145.$g1902$.bind((SubLObject)NIL, var5);
            try {
                assert NIL != Types.function_spec_p((SubLObject)$ic7$) : $ic7$;
                final SubLObject var6_14 = module0145.$g1904$.currentBinding(var5);
                try {
                    module0145.$g1904$.bind((SubLObject)$ic7$, var5);
                    f21168(var4, (SubLObject)UNPROVIDED);
                }
                finally {
    ...
    public static SubLObject f21175(final SubLObject var11) {
        final SubLThread var12 = SubLProcess.currentSubLThread();
        if (NIL != module0313.f21137(var11) && NIL == f21171(var11)) {
            f21172(var11);
            final SubLObject var13 = module0145.$g1895$.getDynamicValue(var12);
            if (var13.eql((SubLObject)$ic1$)) {
                if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var12) && NIL == module0313.f21138((SubLObject)$ic2$)) {
                    Errors.error((SubLObject)$ic8$, (SubLObject)$ic2$);
                }
                final SubLObject var14 = module0145.$g1895$.currentBinding(var12);
                try {
                    module0145.$g1895$.bind((SubLObject)$ic2$, var12);
                    assert NIL != Types.function_spec_p((SubLObject)$ic5$) : $ic5$;
                    final SubLObject var6_16 = module0145.$g1904$.currentBinding(var12);
                    try {
                        module0145.$g1904$.bind((SubLObject)$ic5$, var12);
                        f21168(var11, (SubLObject)UNPROVIDED);
                    }
                    finally {
            ...
            else if (var13.eql((SubLObject)$ic2$)) {
                if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var12) && NIL == module0313.f21138((SubLObject)$ic1$)) {
                    Errors.error((SubLObject)$ic8$, (SubLObject)$ic1$);
                }
                final SubLObject var14 = module0145.$g1895$.currentBinding(var12);
                try {
                    module0145.$g1895$.bind((SubLObject)$ic1$, var12);
                    assert NIL != Types.function_spec_p((SubLObject)$ic5$) : $ic5$;
                ...
                module0313.f21151((SubLObject)FIVE_INTEGER, (SubLObject)$ic9$, module0145.$g1895$.getDynamicValue(var12), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            }
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21176(final SubLObject var4) {
        ...
        try {
            module0145.$g1902$.bind((SubLObject)NIL, var5);
            assert NIL != Types.function_spec_p((SubLObject)$ic10$) : $ic10$;
            final SubLObject var6_18 = module0145.$g1905$.currentBinding(var5);
            try {
                module0145.$g1905$.bind((SubLObject)$ic10$, var5);
                if (NIL != module0313.f21140()) {
                    f21169(var4);
                }
                assert NIL != Types.function_spec_p((SubLObject)$ic5$) : $ic5$;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (NIL != ((NIL != module0145.$g1955$.getDynamicValue(var5)) ? $ic10$ : NIL) && !areAssertionsDisabledFor(me) && NIL == Types.function_spec_p((SubLObject)((NIL != module0145.$g1955$.getDynamicValue(var5)) ? $ic10$ : NIL))) {
                        throw new AssertionError((NIL != module0145.$g1955$.getDynamicValue(var5)) ? $ic10$ : NIL);
                    }
                    final SubLObject var6_23 = module0145.$g1905$.currentBinding(var5);
                    try {
                        module0145.$g1905$.bind((SubLObject)((NIL != module0145.$g1955$.getDynamicValue(var5)) ? $ic10$ : NIL), var5);
                        SubLObject var13 = var8;
                        SubLObject var14 = (SubLObject)NIL;
                        var14 = var13.first();
                        while (NIL != var13) {
                            if (NIL != module0313.f21137(var14)) {
                                f21168(var14, (SubLObject)UNPROVIDED);
                            }
                            var13 = var13.rest();
                            var14 = var13.first();
                        }
            ...
            if (NIL != module0226.f14795(module0145.$g1948$.getDynamicValue(var5))) {
    ...
    public static SubLObject f21178(final SubLObject var4) {
        ...
        try {
            ...
            try {
                module0145.$g1905$.bind((SubLObject)$ic10$, var5);
                try {
                    assert NIL != Types.function_spec_p((SubLObject)$ic11$) : $ic11$;
                    final SubLObject var6_31 = module0145.$g1904$.currentBinding(var5);
                    try {
                        module0145.$g1904$.bind((SubLObject)$ic11$, var5);
                        f21168(var4, (SubLObject)UNPROVIDED);
                    }
                    finally {
            ...
            if (NIL != module0145.$g1902$.getDynamicValue(var5)) {
                var6 = module0145.$g1902$.getDynamicValue(var5);
            }
            else if (NIL != module0313.f21140()) {
    ...
    public static SubLObject f21179(final SubLObject var11) {
        ...
        if (NIL != module0313.f21137(var11)) {
            if (NIL != f21171(var11)) {
                module0145.$g1900$.setDynamicValue((SubLObject)T, var12);
            }
            else {
                f21172(var11);
                ...
                try {
                    module0145.$g1902$.bind((SubLObject)NIL, var12);
                    module0145.$g1900$.bind((SubLObject)NIL, var12);
                    module0313.f21153(var11);
                    var14 = (SubLObject)makeBoolean(NIL != var14 || NIL != module0145.$g1900$.getDynamicValue(var12));
    ...
    public static SubLObject f21180(final SubLObject var4, final SubLObject var35, SubLObject var36) {
        ...
        try {
            module0145.$g1902$.bind((SubLObject)NIL, var37);
            module0145.$g1899$.bind((SubLObject)NIL, var37);
            final SubLObject var6_37 = module0145.$g1901$.currentBinding(var37);
            try {
                module0145.$g1901$.bind(var35, var37);
                assert NIL != Types.function_spec_p(var36) : var36;
                ...
                try {
                    ...
                    try {
                        module0145.$g1905$.bind((SubLObject)$ic10$, var37);
                        try {
                            assert NIL != Types.function_spec_p((SubLObject)$ic12$) : $ic12$;
                            final SubLObject var6_40 = module0145.$g1904$.currentBinding(var37);
                            try {
                                module0145.$g1904$.bind((SubLObject)$ic12$, var37);
                                f21168(var4, (SubLObject)UNPROVIDED);
                            }
                            finally {
    ...
    public static SubLObject f21181(final SubLObject var11) {
        final SubLThread var12 = SubLProcess.currentSubLThread();
        if (NIL != module0313.f21156(var11, module0145.$g1901$.getDynamicValue(var12))) {
            f21182((SubLObject)T);
        }
        else if (NIL != module0313.f21137(var11) && NIL == f21171(var11)) {
            f21172(var11);
            module0313.f21153(var11);
        }
        return module0145.$g1902$.getDynamicValue(var12);
    ...
    public static SubLObject f21183(final SubLObject var42, final SubLObject var43) {
        ...
        try {
            module0145.$g1902$.bind((SubLObject)NIL, var44);
            module0145.$g1899$.bind((SubLObject)NIL, var44);
            if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var44) && !var43.isFunctionSpec()) {
                Errors.error((SubLObject)$ic13$, var43);
            }
            ...
            try {
                ...
                try {
                    module0145.$g1905$.bind((SubLObject)$ic10$, var44);
                    try {
                        assert NIL != Types.function_spec_p((SubLObject)$ic14$) : $ic14$;
                        final SubLObject var6_46 = module0145.$g1904$.currentBinding(var44);
                        try {
                            module0145.$g1904$.bind((SubLObject)$ic14$, var44);
                            f21168(var42, (SubLObject)UNPROVIDED);
                        }
                        finally {
    ...
    public static SubLObject f21185(final SubLObject var49, SubLObject var50, SubLObject var13) {
        ...
        try {
            ...
            try {
                ...
                module0145.$g1924$.bind((SubLObject)NIL, var51);
                module0145.$g1924$.setDynamicValue(Hashtables.make_hash_table((SubLObject)$ic15$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var51);
            ...
            var60 = var58.first();
            while (NIL != var58) {
                if (NIL != f21187(var60, var49, (SubLObject)UNPROVIDED)) {
                    if (NIL == var50) {
                        var52 = (SubLObject)ConsesLow.cons(var60, var52);
                    }
                    else if (NIL != module0004.f104(var60, var50, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        var52 = (SubLObject)ConsesLow.cons(var60, var52);
                    }
                }
                var58 = var58.rest();
    ...
    public static SubLObject f21188(final SubLObject var4, final SubLObject var57, SubLObject var58) {
        ...
        try {
            module0145.$g1902$.bind((SubLObject)NIL, var59);
            assert NIL != Types.function_spec_p((SubLObject)$ic10$) : $ic10$;
            final SubLObject var6_59 = module0145.$g1905$.currentBinding(var59);
            try {
                module0145.$g1905$.bind((SubLObject)$ic10$, var59);
                if (NIL != module0313.f21140()) {
                    SubLObject var62 = (SubLObject)NIL;
                    if (NIL != module0145.$g1932$.getDynamicValue(var59) && module0145.$g1934$.getDynamicValue(var59).numGE(module0145.$g1933$.getDynamicValue(var59))) {
                        module0012.f425();
                        var62 = (SubLObject)T;
                    }
                    if (NIL == var62) {
                        module0145.$g1934$.setDynamicValue(Numbers.add(module0145.$g1934$.getDynamicValue(var59), (SubLObject)ONE_INTEGER), var59);
                ...
                assert NIL != Types.function_spec_p((SubLObject)$ic16$) : $ic16$;
                final SubLObject var6_60 = module0145.$g1904$.currentBinding(var59);
                try {
                    module0145.$g1904$.bind((SubLObject)$ic16$, var59);
                    assert NIL != Types.function_spec_p(var58) : var58;
    ...
    public static SubLObject f21189(final SubLObject var11) {
        ...
        if (NIL != module0313.f21137(var11)) {
            SubLObject var13 = (SubLObject)NIL;
            if (NIL != module0145.$g1932$.getDynamicValue(var12) && module0145.$g1934$.getDynamicValue(var12).numGE(module0145.$g1933$.getDynamicValue(var12))) {
                module0012.f425();
                var13 = (SubLObject)T;
            }
            if (NIL == var13) {
                module0145.$g1934$.setDynamicValue(Numbers.add(module0145.$g1934$.getDynamicValue(var12), (SubLObject)ONE_INTEGER), var12);
                if (NIL == f21171(var11)) {
                    f21172(var11);
                    module0313.f21153(var11);
    ...
    public static SubLObject f21190(final SubLObject var4, final SubLObject var63, SubLObject var58) {
        ...
        try {
            ...
            if (NIL != module0313.f21140() && NIL != Functions.funcall(var63, var4)) {
    ...
    public static SubLObject f21191(final SubLObject var11) {
        ...
        if (NIL != module0313.f21137(var11) && NIL == f21171(var11)) {
            f21172(var11);
            module0313.f21153(var11);
            if (NIL != Functions.funcall(module0145.$g1906$.getDynamicValue(var12), var11)) {
    ...
    public static SubLObject f21192(final SubLObject var4) {
        ...
        try {
            ...
            try {
                ...
                try {
                    f21172(var4);
                    assert NIL != Types.function_spec_p((SubLObject)$ic19$) : $ic19$;
                    final SubLObject var6_71 = module0145.$g1904$.currentBinding(var5);
                    try {
                        module0145.$g1904$.bind((SubLObject)$ic19$, var5);
                        f21168(var4, (SubLObject)UNPROVIDED);
                    }
                    finally {
                    ...
                    f21193(var4);
                    f21194(var4);
                    if (NIL != var7 && NIL != module0313.f21150(var4)) {
                        module0145.$g1902$.setDynamicValue((SubLObject)ConsesLow.cons(var4, module0145.$g1902$.getDynamicValue(var5)), var5);
                    }
                }
                finally {
                    ...
                    try {
                        Threads.$is_thread_performing_cleanupP$.bind((SubLObject)T, var5);
                        f21195(var4);
                        assert NIL != Types.function_spec_p((SubLObject)$ic20$) : $ic20$;
                        final SubLObject var6_73 = module0145.$g1904$.currentBinding(var5);
                        try {
                            module0145.$g1904$.bind((SubLObject)$ic20$, var5);
                            f21168(var4, (SubLObject)UNPROVIDED);
                        }
                        finally {
    ...
    public static SubLObject f21194(final SubLObject var4) {
        ...
        try {
            ...
            module0145.$g1924$.bind((SubLObject)NIL, var5);
            module0145.$g1924$.setDynamicValue(Hashtables.make_hash_table((SubLObject)$ic15$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var5);
            try {
                assert NIL != Types.function_spec_p((SubLObject)$ic21$) : $ic21$;
                final SubLObject var6_74 = module0145.$g1904$.currentBinding(var5);
                try {
                    module0145.$g1904$.bind((SubLObject)$ic21$, var5);
                    assert NIL != Types.function_spec_p((SubLObject)$ic17$) : $ic17$;
                    final SubLObject var6_75 = module0145.$g1908$.currentBinding(var5);
                    try {
                        module0145.$g1908$.bind((SubLObject)$ic17$, var5);
                        f21168(var4, (SubLObject)UNPROVIDED);
                    }
                    finally {
    ...
    public static SubLObject f21196(final SubLObject var11) {
        ...
        if (NIL != module0313.f21137(var11) && NIL == f21171(var11)) {
            f21172(var11);
            if (NIL != f21197(var11, (SubLObject)UNPROVIDED)) {
                module0313.f21153(var11);
                module0145.$g1902$.setDynamicValue(Functions.funcall(module0145.$g1908$.getDynamicValue(var12), var11, module0145.$g1902$.getDynamicValue(var12)), var12);
    ...
    public static SubLObject f21193(final SubLObject var4) {
        ...
        try {
            ...
            module0145.$g1924$.setDynamicValue(Hashtables.make_hash_table((SubLObject)$ic15$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var5);
            try {
                assert NIL != Types.function_spec_p((SubLObject)$ic22$) : $ic22$;
                final SubLObject var6_78 = module0145.$g1904$.currentBinding(var5);
                try {
                    module0145.$g1904$.bind((SubLObject)$ic22$, var5);
                    assert NIL != Types.function_spec_p((SubLObject)$ic23$) : $ic23$;
                    final SubLObject var6_79 = module0145.$g1906$.currentBinding(var5);
                    try {
                        module0145.$g1906$.bind((SubLObject)$ic23$, var5);
                        f21168(var4, (SubLObject)UNPROVIDED);
                    }
                    finally {
            ...
            if (NIL != f21197(var11, (SubLObject)UNPROVIDED)) {
                ...
                try {
                    ...
                    if (NIL == Functions.funcall(module0145.$g1906$.getDynamicValue(var12), var11)) {
                        ...
                        try {
                            module0145.$g1904$.bind((SubLObject)$ic20$, var12);
                            f21168(var11, (SubLObject)UNPROVIDED);
                        }
                        finally {
    ...
    public static SubLObject f21200(final SubLObject var4, final SubLObject var83) {
        ...
        try {
            module0145.$g1902$.bind((SubLObject)NIL, var84);
            if (NIL != ((NIL == module0145.$g1948$.getDynamicValue(var84) || NIL != module0145.$g1955$.getDynamicValue(var84)) ? $ic10$ : NIL) && !areAssertionsDisabledFor(me) && NIL == Types.function_spec_p((SubLObject)((NIL == module0145.$g1948$.getDynamicValue(var84) || NIL != module0145.$g1955$.getDynamicValue(var84)) ? $ic10$ : NIL))) {
                throw new AssertionError((NIL == module0145.$g1948$.getDynamicValue(var84) || NIL != module0145.$g1955$.getDynamicValue(var84)) ? $ic10$ : NIL);
            }
            final SubLObject var6_84 = module0145.$g1905$.currentBinding(var84);
            try {
                module0145.$g1905$.bind((SubLObject)((NIL == module0145.$g1948$.getDynamicValue(var84) || NIL != module0145.$g1955$.getDynamicValue(var84)) ? $ic10$ : NIL), var84);
                try {
                    assert NIL != Types.function_spec_p((SubLObject)$ic24$) : $ic24$;
                    final SubLObject var6_85 = module0145.$g1904$.currentBinding(var84);
                    try {
                        module0145.$g1904$.bind((SubLObject)$ic24$, var84);
                        assert NIL != module0173.f10955(var83) : var83;
                    ...
                    try {
                        Threads.$is_thread_performing_cleanupP$.bind((SubLObject)T, var84);
    ...
    public static SubLObject f21201(final SubLObject var11) {
        ...
        try {
            ...
            module0145.$g1905$.bind((SubLObject)NIL, var12);
            if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var12) && NIL == module0313.f21138((SubLObject)$ic0$)) {
                Errors.error((SubLObject)$ic8$, (SubLObject)$ic0$);
            }
            final SubLObject var6_88 = module0145.$g1895$.currentBinding(var12);
            try {
                module0145.$g1895$.bind((SubLObject)$ic0$, var12);
                assert NIL != Types.function_spec_p((SubLObject)$ic5$) : $ic5$;
    ...
    public static SubLObject f21203(final SubLObject var4, final SubLObject var35) {
        ...
        if (var35.equal(var4)) {
            if (NIL != module0313.f21140()) {
                var37 = (SubLObject)ConsesLow.list(reader.bq_cons((SubLObject)ConsesLow.list($ic26$, var35, var4), (SubLObject)$ic27$));
            }
        }
        else {
            ...
            try {
                module0145.$g1902$.bind((SubLObject)NIL, var36);
                module0145.$g1899$.bind((SubLObject)NIL, var36);
                final SubLObject var6_90 = module0145.$g1901$.currentBinding(var36);
                try {
                    module0145.$g1901$.bind(var35, var36);
                    assert NIL != Types.function_spec_p((SubLObject)EQL) : EQL;
                    final SubLObject var6_91 = module0145.$g1909$.currentBinding(var36);
                    try {
                        module0145.$g1909$.bind((SubLObject)EQL, var36);
                        assert NIL != Types.function_spec_p((SubLObject)$ic10$) : $ic10$;
                        final SubLObject var6_92 = module0145.$g1905$.currentBinding(var36);
                        try {
                            module0145.$g1905$.bind((SubLObject)$ic10$, var36);
                            try {
                                assert NIL != Types.function_spec_p((SubLObject)$ic28$) : $ic28$;
                                final SubLObject var6_93 = module0145.$g1904$.currentBinding(var36);
                                try {
                                    module0145.$g1904$.bind((SubLObject)$ic28$, var36);
                                    f21168(var4, (SubLObject)UNPROVIDED);
                                }
                                finally {
    ...
    public static SubLObject f21204(final SubLObject var11) {
        ...
        if (NIL != module0313.f21156(var11, module0145.$g1901$.getDynamicValue(var12))) {
            ...
            f21182((SubLObject)UNPROVIDED);
        }
        else if (NIL != module0313.f21137(var11) && NIL == module0145.$g1902$.getDynamicValue(var12) && NIL == f21171(var11)) {
            f21172(var11);
            module0313.f21153(var11);
            if (NIL != module0145.$g1902$.getDynamicValue(var12)) {
                module0145.$g1902$.setDynamicValue((SubLObject)ConsesLow.cons(var13, module0145.$g1902$.getDynamicValue(var12)), var12);
            }
        }
        return (SubLObject)NIL;
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    module0145.$g1904$.bind((SubLObject)$ic29$, var36);
                                    f21168(var4, (SubLObject)UNPROVIDED);
                                }
                                finally {
    ...
    public static SubLObject f21207(final SubLObject var101, final SubLObject var102) {
        ...
        try {
            module0147.$g2094$.bind((SubLObject)$ic30$, var103);
            module0147.$g2095$.bind($ic31$, var103);
            var104 = module0315.f21304(var102, var101, (SubLObject)UNPROVIDED);
        }
        finally {
            module0147.$g2095$.rebind(var106, var103);
            module0147.$g2094$.rebind(var105, var103);
        }
        if (var104.equal((SubLObject)ConsesLow.list(reader.bq_cons((SubLObject)ConsesLow.list($ic26$, var102, var101), (SubLObject)$ic27$)))) {
            return module0259.f16933(module0145.$g1888$.getDynamicValue(var103), $ic32$, (SubLObject)UNPROVIDED);
        }
        ...
        var109 = var108.first();
        while (NIL != var108) {
            if (NIL != module0210.f13566(var109)) {
        ...
        if (NIL != var107) {
            var107 = module0262.f17364(module0035.f2272(var107), (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f21208(final SubLObject var105, final SubLObject var106) {
        ...
        if (NIL != var107) {
            ...
            while (NIL != var110) {
                ...
                var109 = (SubLObject)ConsesLow.cons(module0315.f21330($ic33$, module0315.f21321($ic33$, var108, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var109);
                var110 = var110.rest();
                var111 = var110.first();
            }
        }
    ...
    public static SubLObject f21209(final SubLObject var110) {
        ...
        try {
            ...
            if (NIL == module0004.f104(var110, module0145.$g1921$.getDynamicValue(var111), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                ...
                try {
                    ...
                    module0145.$g1924$.bind((SubLObject)NIL, var111);
                    module0145.$g1924$.setDynamicValue(Hashtables.make_hash_table((SubLObject)$ic15$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var111);
                ...
                if (NIL != var113) {
                    ...
                    try {
                        ...
                        module0145.$g1924$.bind((SubLObject)NIL, var111);
                        module0145.$g1924$.setDynamicValue(Hashtables.make_hash_table((SubLObject)$ic15$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var111);
                        var117 = module0315.f21322($ic33$, ConsesLow.append(var113, var117), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    }
                    finally {
                        module0145.$g1924$.rebind(var118, var111);
                        module0145.$g1925$.rebind(var6_116, var111);
                    }
                    if (NIL == module0035.f2201(var113, var117, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f21212(final SubLObject var11) {
        final SubLThread var12 = SubLProcess.currentSubLThread();
        assert NIL != module0130.f8511((SubLObject)$ic34$) : $ic34$;
        final SubLObject var13 = module0145.$g1897$.currentBinding(var12);
        try {
            module0145.$g1897$.bind((SubLObject)$ic34$, var12);
            assert NIL != Types.function_spec_p((SubLObject)$ic10$) : $ic10$;
            final SubLObject var6_117 = module0145.$g1905$.currentBinding(var12);
            try {
                module0145.$g1905$.bind((SubLObject)$ic10$, var12);
                assert NIL != Types.function_spec_p((SubLObject)$ic36$) : $ic36$;
                final SubLObject var6_118 = module0145.$g1904$.currentBinding(var12);
                try {
                    module0145.$g1904$.bind((SubLObject)$ic36$, var12);
                    f21168(var11, (SubLObject)UNPROVIDED);
                }
                finally {
    ...
    public static SubLObject f21213(final SubLObject var4) {
        ...
        final SubLObject var8 = module0145.$g1902$.currentBinding(var5);
        try {
            module0145.$g1921$.bind((SubLObject)NIL, var5);
            module0145.$g1902$.bind((SubLObject)NIL, var5);
            ...
            try {
                module0145.$g1905$.bind((SubLObject)$ic10$, var5);
                assert NIL != Types.function_spec_p((SubLObject)$ic37$) : $ic37$;
                final SubLObject var6_120 = module0145.$g1904$.currentBinding(var5);
                try {
                    module0145.$g1904$.bind((SubLObject)$ic37$, var5);
                    f21168(var4, (SubLObject)UNPROVIDED);
                }
                finally {
    ...
    public static SubLObject f21214(final SubLObject var11) {
        ...
        try {
            ...
            if (var11.equalp(module0145.$g1935$.getDynamicValue(var12))) {
                ...
                SubLObject var121_123 = (SubLObject)NIL;
                var121_123 = var18.first();
                while (NIL != var18) {
                    f21210(var121_123.first(), (SubLObject)TWO_INTEGER);
                    var18 = var18.rest();
                    var121_123 = var18.first();
                }
                module0145.$g1936$.setDynamicValue((SubLObject)NIL, var12);
            }
            else {
                final SubLObject var19 = var15;
                if (var19.eql((SubLObject)$ic38$) || var19.eql((SubLObject)NIL)) {
                    f21210(var11, (SubLObject)ONE_INTEGER);
                    module0145.$g1921$.setDynamicValue((SubLObject)ConsesLow.cons(var11, module0145.$g1921$.getDynamicValue(var12)), var12);
                    module0313.f21153(var11);
                }
                else if (var19.eql((SubLObject)ONE_INTEGER)) {
                    if (NIL != module0004.f104(var11, module0145.$g1921$.getDynamicValue(var12), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                ...
                else if (var19.eql((SubLObject)TWO_INTEGER)) {
                    module0145.$g1902$.setDynamicValue(ConsesLow.append(module0145.$g1936$.getDynamicValue(var12), module0145.$g1902$.getDynamicValue(var12)), var12);
                    SubLObject var20 = module0145.$g1936$.getDynamicValue(var12);
                    SubLObject var121_124 = (SubLObject)NIL;
                    var121_124 = var20.first();
                    while (NIL != var20) {
                        f21210(var121_124.first(), (SubLObject)TWO_INTEGER);
                        var20 = var20.rest();
                        var121_124 = var20.first();
                    }
                    module0145.$g1936$.setDynamicValue((SubLObject)NIL, var12);
    ...
    public static SubLObject f21215() {
        ...
        var3 = var2.first();
        while (NIL != var2) {
            if (f21171(var3.first()).eql((SubLObject)TWO_INTEGER)) {
    ...
    public static SubLObject f21216(final SubLObject var126) {
        ...
        try {
            module0145.$g1902$.bind((SubLObject)NIL, var127);
            module0145.$g1939$.bind((SubLObject)NIL, var127);
            assert NIL != Types.function_spec_p((SubLObject)$ic10$) : $ic10$;
            final SubLObject var6_127 = module0145.$g1905$.currentBinding(var127);
            try {
                module0145.$g1905$.bind((SubLObject)$ic10$, var127);
                assert NIL != Types.function_spec_p((SubLObject)$ic39$) : $ic39$;
                final SubLObject var6_128 = module0145.$g1904$.currentBinding(var127);
                try {
                    module0145.$g1904$.bind((SubLObject)$ic39$, var127);
                    f21168(var126, (SubLObject)UNPROVIDED);
                }
                finally {
    ...
    public static SubLObject f21217(final SubLObject var126) {
        ...
        try {
            module0145.$g1902$.bind((SubLObject)NIL, var127);
            assert NIL != Types.function_spec_p((SubLObject)$ic40$) : $ic40$;
            final SubLObject var6_129 = module0145.$g1905$.currentBinding(var127);
            try {
                module0145.$g1905$.bind((SubLObject)$ic40$, var127);
                assert NIL != Types.function_spec_p((SubLObject)$ic41$) : $ic41$;
                final SubLObject var6_130 = module0145.$g1904$.currentBinding(var127);
                try {
                    module0145.$g1904$.bind((SubLObject)$ic41$, var127);
                    f21218(var126, (SubLObject)UNPROVIDED);
                }
                finally {
    ...
    public static SubLObject f21219(final SubLObject var11) {
        ...
        try {
            ...
            if (var11.equalp(module0145.$g1935$.getDynamicValue(var12))) {
                ...
                SubLObject var2_131 = (SubLObject)NIL;
    ...
    public static SubLObject f21220(final SubLObject var126) {
        ...
        try {
            ...
            try {
                module0145.$g1905$.bind((SubLObject)$ic40$, var127);
                assert NIL != Types.function_spec_p((SubLObject)$ic42$) : $ic42$;
                final SubLObject var6_133 = module0145.$g1904$.currentBinding(var127);
                try {
                    module0145.$g1904$.bind((SubLObject)$ic42$, var127);
                    f21218(var126, (SubLObject)UNPROVIDED);
                }
                finally {
    ...
    public static SubLObject f21218(final SubLObject var4, SubLObject var134) {
        ...
        if (var136.eql((SubLObject)$ic43$)) {
            f21221(var4, var134);
        }
        else {
            module0313.f21151((SubLObject)THREE_INTEGER, (SubLObject)$ic44$, module0145.$g1894$.getDynamicValue(var135), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21222(final SubLObject var11) {
        ...
        try {
            ...
            if (!var14.eql(module0145.$g1888$.getDynamicValue(var12))) {
                var15 = ((NIL != module0260.f17089(var14, module0145.$g1888$.getDynamicValue(var12), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) ? module0260.f17139(var14, module0145.$g1888$.getDynamicValue(var12)).first() : module0260.f17144(var14, module0145.$g1888$.getDynamicValue(var12), (SubLObject)UNPROVIDED).first());
            }
            f21223(var13);
            if (NIL != var15) {
                f21223(var15);
            ...
            else if (NIL == module0004.f104(var11, module0145.$g1921$.getDynamicValue(var12), (SubLObject)$ic45$, (SubLObject)UNPROVIDED) && NIL == f21225(var17, var16)) {
                f21226(var11, var17);
                module0145.$g1921$.setDynamicValue((SubLObject)ConsesLow.cons(var11, module0145.$g1921$.getDynamicValue(var12)), var12);
    ...
    public static SubLObject f21224(final SubLObject var140) {
        ...
        final SubLObject var142 = module0349.f23437(var140, (SubLObject)UNPROVIDED);
        if (NIL != var142) {
    ...
    public static SubLObject f21225(final SubLObject var141, final SubLObject var142) {
        ...
        if (NIL == var144) {
            ...
            var148 = var147.first();
            while (NIL == var144 && NIL != var147) {
                if (var148.eql(module0145.$g1922$.getDynamicValue(var143)) && NIL != f21227(var141, var146.first())) {
                    var145 = (SubLObject)T;
                    var144 = (SubLObject)T;
                }
                else {
    ...
    public static SubLObject f21227(final SubLObject var147, final SubLObject var148) {
        ...
        final SubLObject var150 = Hashtables.make_hash_table((SubLObject)$ic46$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        SubLObject var151 = (SubLObject)T;
        if (NIL == var148 && NIL != var147) {
        ...
        var153 = var152.first();
        while (NIL != var152) {
            f21228(var153, (SubLObject)T, var150);
            var152 = var152.rest();
            var153 = var152.first();
        }
        if (NIL == var149) {
            ...
            var153 = var154.first();
            while (NIL == var149 && NIL != var154) {
                if (NIL == f21197(var153, var150)) {
                    var151 = (SubLObject)NIL;
                    var149 = (SubLObject)T;
                }
                var154 = var154.rest();
    ...
    public static SubLObject f21223(final SubLObject var13) {
        ...
        final SubLObject var15 = module0004.f104(var13, module0145.$g1920$.getDynamicValue(var14), (SubLObject)$ic45$, (SubLObject)UNPROVIDED);
        if (NIL == var15) {
            module0145.$g1920$.setDynamicValue((SubLObject)ConsesLow.cons(var13, module0145.$g1920$.getDynamicValue(var14)), var14);
            module0145.$g1922$.setDynamicValue(Numbers.add(module0145.$g1922$.getDynamicValue(var14), (SubLObject)ONE_INTEGER), var14);
        }
        return var15;
    }
    ...
    public static SubLObject f21168(final SubLObject var4, SubLObject var134) {
        ...
        try {
            module0153.$g2135$.bind((SubLObject)(module0153.$g2135$.getDynamicValue(var135).isInteger() ? Numbers.subtract(module0153.$g2135$.getDynamicValue(var135), (SubLObject)ONE_INTEGER) : NIL), var135);
            module0145.$g1926$.bind(Numbers.subtract(module0145.$g1926$.getDynamicValue(var135), (SubLObject)ONE_INTEGER), var135);
            if (module0153.$g2135$.getDynamicValue(var135).isInteger() && module0153.$g2135$.getDynamicValue(var135).numL((SubLObject)ZERO_INTEGER)) {
                Errors.error((SubLObject)$ic47$);
            }
            if (NIL != module0145.$g1927$.getDynamicValue(var135) && module0145.$g1926$.getDynamicValue(var135).numL((SubLObject)ZERO_INTEGER)) {
                var136 = (SubLObject)T;
            }
            if (NIL != module0145.$g1929$.getDynamicValue(var135) && module0145.$g1930$.getDynamicValue(var135).numL(Numbers.divide(Numbers.subtract(Time.get_internal_real_time(), module0145.$g1931$.getDynamicValue(var135)), time_high.$internal_time_units_per_second$.getGlobalValue()))) {
                var136 = (SubLObject)T;
            }
            if (NIL == var136) {
                final SubLObject var139 = module0145.$g1894$.getDynamicValue(var135);
                if (var139.eql((SubLObject)$ic43$)) {
                    f21221(var4, var134);
                }
                else if (var139.eql((SubLObject)$ic48$)) {
                    f21229(var4, var134);
                }
                else {
                    module0313.f21151((SubLObject)THREE_INTEGER, (SubLObject)$ic44$, module0145.$g1894$.getDynamicValue(var135), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f21221(final SubLObject var4, final SubLObject var134) {
        ...
        try {
            module0221.$g2399$.bind((SubLObject)NIL, var135);
            final SubLObject var137 = module0145.$g1895$.getDynamicValue(var135);
            if (var137.eql((SubLObject)$ic0$)) {
            ...
            else if (var137.eql((SubLObject)$ic3$)) {
            ...
            else if (var137.eql((SubLObject)$ic1$)) {
                f21230(var134, var4, module0145.$g1891$.getDynamicValue(var135), module0145.$g1888$.getDynamicValue(var135), module0145.$g1897$.getDynamicValue(var135));
            }
            else if (var137.eql((SubLObject)$ic2$)) {
                f21230(var134, var4, module0145.$g1892$.getDynamicValue(var135), module0145.$g1888$.getDynamicValue(var135), module0145.$g1897$.getDynamicValue(var135));
            }
            else if (var137.eql((SubLObject)$ic49$)) {
                if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var135) && NIL == module0313.f21138((SubLObject)$ic1$)) {
                    Errors.error((SubLObject)$ic8$, (SubLObject)$ic1$);
                }
                final SubLObject var6_151 = module0145.$g1895$.currentBinding(var135);
                try {
                    module0145.$g1895$.bind((SubLObject)$ic1$, var135);
                    f21230(var134, var4, module0145.$g1891$.getDynamicValue(var135), module0145.$g1888$.getDynamicValue(var135), module0145.$g1897$.getDynamicValue(var135));
                }
                finally {
                ...
                if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var135) && NIL == module0313.f21138((SubLObject)$ic2$)) {
                    Errors.error((SubLObject)$ic8$, (SubLObject)$ic2$);
                }
                final SubLObject var6_152 = module0145.$g1895$.currentBinding(var135);
                try {
                    module0145.$g1895$.bind((SubLObject)$ic2$, var135);
                    f21230(var134, var4, module0145.$g1892$.getDynamicValue(var135), module0145.$g1888$.getDynamicValue(var135), module0145.$g1897$.getDynamicValue(var135));
                }
                finally {
                ...
                module0313.f21151((SubLObject)FIVE_INTEGER, (SubLObject)$ic4$, module0145.$g1895$.getDynamicValue(var135), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            }
        }
        finally {
    ...
    public static SubLObject f21229(final SubLObject var4, final SubLObject var134) {
        ...
        while (NIL != var136) {
            if (var137.isCons()) {
                ...
                try {
                    module0145.$g1888$.bind((SubLObject)NIL, var135);
                    module0145.$g1891$.bind((SubLObject)NIL, var135);
                    module0145.$g1892$.bind((SubLObject)NIL, var135);
                    cdestructuring_bind.destructuring_bind_must_consp(var139, var138, (SubLObject)$ic50$);
                    ...
                    if (NIL == var139) {
                        ...
                        cdestructuring_bind.cdestructuring_bind_error(var138, (SubLObject)$ic50$);
                    }
                }
                finally {
    ...
    public static SubLObject f21230(final SubLObject var156, final SubLObject var42, final SubLObject var157, final SubLObject var83, SubLObject var158) {
        ...
        try {
            module0139.$g1631$.bind(module0139.f9015(var160, (SubLObject)SIX_INTEGER), var159);
            module0139.$g1632$.bind(module0139.f9016(var160), var159);
            module0139.$g1630$.bind((SubLObject)T, var159);
            if (NIL != module0145.$g1915$.getDynamicValue(var159)) {
    ...
    public static SubLObject f21231(final SubLObject var156, final SubLObject var42, final SubLObject var157, final SubLObject var83) {
        ...
        try {
            ...
            try {
                ...
                if (NIL != module0158.f10010(var42, var157, var162)) {
                    ...
                    while (NIL == var164) {
                        ...
                        final SubLObject var167 = (SubLObject)makeBoolean(!var165.eql(var166));
                        if (NIL != var167) {
                            SubLObject var168 = (SubLObject)NIL;
                            try {
                                var168 = module0158.f10316(var166, (SubLObject)$ic53$, (SubLObject)$ic34$, (SubLObject)NIL);
                                SubLObject var163_168 = (SubLObject)NIL;
                                final SubLObject var164_169 = (SubLObject)NIL;
                                while (NIL == var163_168) {
                                    final SubLObject var169 = module0052.f3695(var168, var164_169);
                                    final SubLObject var166_170 = (SubLObject)makeBoolean(!var164_169.eql(var169));
                                    if (NIL != var166_170) {
                                    ...
                                    var163_168 = (SubLObject)makeBoolean(NIL == var166_170);
                                }
                            }
                            finally {
                        ...
                        var164 = (SubLObject)makeBoolean(NIL == var167);
                    }
                }
            }
            finally {
            ...
            if (NIL != module0221.f14609(var83)) {
                var160 = module0148.$g2099$.currentBinding(var158);
                var161 = module0148.$g2097$.currentBinding(var158);
                try {
                    module0148.$g2099$.bind((SubLObject)$ic54$, var158);
                    module0148.$g2097$.bind(var83, var158);
                    final SubLObject var162 = (SubLObject)NIL;
                    if (NIL != module0158.f10010(var42, module0225.f14782(var157), var162)) {
                        ...
                        while (NIL == var164) {
                            ...
                            if (NIL != var167) {
                                ...
                                try {
                                    var168 = module0158.f10316(var166, (SubLObject)$ic53$, (SubLObject)$ic34$, (SubLObject)NIL);
                                    SubLObject var163_169 = (SubLObject)NIL;
                                    final SubLObject var164_170 = (SubLObject)NIL;
                                    while (NIL == var163_169) {
                                        final SubLObject var169 = module0052.f3695(var168, var164_170);
                                        final SubLObject var166_171 = (SubLObject)makeBoolean(!var164_170.eql(var169));
                                        if (NIL != var166_171) {
                                            ...
                                            try {
                                                module0221.$g2399$.bind((SubLObject)makeBoolean(NIL == module0221.$g2399$.getDynamicValue(var158)), var158);
                                                module0145.$g1917$.bind(var169, var158);
                                        ...
                                        var163_169 = (SubLObject)makeBoolean(NIL == var166_171);
                                    }
                                }
                                finally {
            ...
            var159 = Errors.handleThrowable(var172, (SubLObject)$ic51$);
        }
        finally {
    ...
    public static SubLObject f21232(final SubLObject var156, final SubLObject var42, final SubLObject var157, final SubLObject var83, final SubLObject var158) {
        ...
        try {
            var159.throwStack.push($ic51$);
            f21233(var156, var42, var157, var83, var158, (SubLObject)UNPROVIDED);
        }
        catch (Throwable var161) {
            var160 = Errors.handleThrowable(var161, (SubLObject)$ic51$);
        }
        finally {
    ...
    public static SubLObject f21233(final SubLObject var156, final SubLObject var42, final SubLObject var180, SubLObject var83, SubLObject var158, SubLObject var13) {
        ...
        assert NIL != Types.function_spec_p(var156) : var156;
        assert NIL != module0004.f105(var180) : var180;
        SubLObject var182 = (SubLObject)NIL;
        try {
            var181.throwStack.push($ic51$);
            ...
            try {
                ...
                if (NIL != var83 && NIL != var158) {
                    final SubLObject var186 = var83;
                    if (NIL != module0158.f10010(var42, var180, var186)) {
                        ...
                        while (NIL == var188) {
                            ...
                            final SubLObject var191 = (SubLObject)makeBoolean(!var189.eql(var190));
                            if (NIL != var191) {
                                SubLObject var192 = (SubLObject)NIL;
                                try {
                                    var192 = module0158.f10316(var190, (SubLObject)$ic53$, var158, (SubLObject)NIL);
                                    SubLObject var163_182 = (SubLObject)NIL;
                                    final SubLObject var164_183 = (SubLObject)NIL;
                                    while (NIL == var163_182) {
                                        final SubLObject var193 = module0052.f3695(var192, var164_183);
                                        final SubLObject var166_185 = (SubLObject)makeBoolean(!var164_183.eql(var193));
                                        if (NIL != var166_185) {
                                        ...
                                        var163_182 = (SubLObject)makeBoolean(NIL == var166_185);
                                    }
                                }
                                finally {
                                    final SubLObject var6_187 = Threads.$is_thread_performing_cleanupP$.currentBinding(var181);
                                    try {
                                        Threads.$is_thread_performing_cleanupP$.bind((SubLObject)T, var181);
                                        if (NIL != var192) {
                            ...
                            var188 = (SubLObject)makeBoolean(NIL == var191);
                        }
                    }
                }
                else if (NIL != var83 && NIL == var158) {
                    final SubLObject var186 = var83;
                    if (NIL != module0158.f10010(var42, var180, var186)) {
                        final SubLObject var187 = module0158.f10011(var42, var180, var186);
                        SubLObject var188 = (SubLObject)NIL;
                        ...
                        while (NIL == var188) {
                            ...
                            if (NIL != var191) {
                                SubLObject var192 = (SubLObject)NIL;
                                try {
                                    var192 = module0158.f10316(var190, (SubLObject)$ic53$, (SubLObject)NIL, (SubLObject)NIL);
                                    SubLObject var163_183 = (SubLObject)NIL;
                                    final SubLObject var164_184 = (SubLObject)NIL;
                                    while (NIL == var163_183) {
                                        final SubLObject var193 = module0052.f3695(var192, var164_184);
                                        final SubLObject var166_186 = (SubLObject)makeBoolean(!var164_184.eql(var193));
                                        if (NIL != var166_186) {
                                        ...
                                        var163_183 = (SubLObject)makeBoolean(NIL == var166_186);
                                    }
                                }
                                finally {
                    ...
                    if (NIL != module0158.f10010(var42, var180, var186)) {
                        ...
                        while (NIL == var188) {
                            ...
                            if (NIL != var191) {
                                ...
                                try {
                                    var192 = module0158.f10316(var190, (SubLObject)$ic53$, var158, (SubLObject)NIL);
                                    SubLObject var163_184 = (SubLObject)NIL;
                                    final SubLObject var164_185 = (SubLObject)NIL;
                                    while (NIL == var163_184) {
                                        final SubLObject var193 = module0052.f3695(var192, var164_185);
                                        final SubLObject var166_187 = (SubLObject)makeBoolean(!var164_185.eql(var193));
                                        if (NIL != var166_187) {
                                        ...
                                        var163_184 = (SubLObject)makeBoolean(NIL == var166_187);
                                    }
                                }
                                finally {
                    ...
                    if (NIL != module0158.f10010(var42, var180, var186)) {
                        ...
                        while (NIL == var188) {
                            ...
                            if (NIL != var191) {
                                ...
                                try {
                                    var192 = module0158.f10316(var190, (SubLObject)$ic53$, (SubLObject)NIL, (SubLObject)NIL);
                                    SubLObject var163_185 = (SubLObject)NIL;
                                    final SubLObject var164_186 = (SubLObject)NIL;
                                    while (NIL == var163_185) {
                                        final SubLObject var193 = module0052.f3695(var192, var164_186);
                                        final SubLObject var166_188 = (SubLObject)makeBoolean(!var164_186.eql(var193));
                                        if (NIL != var166_188) {
                                        ...
                                        var163_185 = (SubLObject)makeBoolean(NIL == var166_188);
                                    }
                                }
                                finally {
            ...
            var182 = Errors.handleThrowable(var195, (SubLObject)$ic51$);
        }
        finally {
    ...
    public static SubLObject f21172(final SubLObject var11) {
        final SubLThread var12 = SubLProcess.currentSubLThread();
        if (NIL != module0313.f21137(var11)) {
            Hashtables.sethash(var11, module0145.$g1924$.getDynamicValue(var12), (SubLObject)T);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21195(final SubLObject var11) {
        final SubLThread var12 = SubLProcess.currentSubLThread();
        if (NIL != module0313.f21137(var11)) {
            Hashtables.sethash(var11, module0145.$g1924$.getDynamicValue(var12), (SubLObject)NIL);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21171(final SubLObject var11) {
        final SubLThread var12 = SubLProcess.currentSubLThread();
        if (NIL != module0313.f21137(var11)) {
            return Hashtables.gethash(var11, module0145.$g1924$.getDynamicValue(var12), (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21226(final SubLObject var11, final SubLObject var203) {
        ...
        if (NIL != module0313.f21137(var11)) {
            ...
            var205 = Hashtables.gethash(var11, module0145.$g1924$.getDynamicValue(var204), (SubLObject)UNPROVIDED);
            Hashtables.sethash(var11, module0145.$g1924$.getDynamicValue(var204), conses_high.adjoin(var203, var205, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21234(final SubLObject var11, final SubLObject var203, SubLObject var205) {
        if (var205 == UNPROVIDED) {
            var205 = (SubLObject)EQL;
        }
        final SubLThread var206 = SubLProcess.currentSubLThread();
        if (NIL != module0313.f21137(var11)) {
            return module0004.f104(var203, Hashtables.gethash(var11, module0145.$g1924$.getDynamicValue(var206), (SubLObject)UNPROVIDED), var205, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21187(final SubLObject var206, final SubLObject var207, SubLObject var205) {
        ...
        if (NIL == var208) {
            SubLObject var209;
            SubLObject var210;
            for (var209 = var207, var210 = (SubLObject)NIL, var210 = var209.first(); NIL == var208 && NIL != var209; var208 = (SubLObject)makeBoolean(NIL == f21234(var206, var210, var205)), var209 = var209.rest(), var210 = var209.first()) {}
        }
        return (SubLObject)makeBoolean(NIL == var208);
    }
    ...
    public static SubLObject f21197(final SubLObject var11, SubLObject var209) {
        ...
        if (NIL != module0313.f21137(var11)) {
            return Hashtables.gethash(var11, var209, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21235(final SubLObject var2) {
        ...
        if (NIL != module0313.f21137(var3) && NIL == f21171(var3)) {
            f21172(var3);
    ...
    public static SubLObject f21239(final SubLObject var2) {
        final SubLThread var3 = SubLProcess.currentSubLThread();
        final SubLObject var4 = f21165(var2);
        if (NIL != module0313.f21137(var4) && NIL == f21234(var4, module0145.$g1903$.getDynamicValue(var3), (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f21240(final SubLObject var11) {
        final SubLThread var12 = SubLProcess.currentSubLThread();
        if (NIL != module0313.f21137(var11) && NIL == f21234(var11, module0145.$g1903$.getDynamicValue(var12), (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f21244(final SubLObject var11) {
        ...
        try {
            ...
            try {
                ...
                try {
                    module0145.$g1904$.bind((SubLObject)$ic19$, var12);
                    f21168(var11, (SubLObject)UNPROVIDED);
                }
                finally {
    ...
    public static SubLObject f21253(final SubLObject var11, final SubLObject var203) {
        ...
        try {
            module0145.$g1897$.bind((SubLObject)$ic34$, var204);
            assert NIL != Types.function_spec_p((SubLObject)$ic10$) : $ic10$;
            final SubLObject var6_216 = module0145.$g1905$.currentBinding(var204);
            try {
                module0145.$g1905$.bind((SubLObject)$ic10$, var204);
                assert NIL != Types.function_spec_p((SubLObject)$ic56$) : $ic56$;
                ...
                try {
                    module0145.$g1904$.bind((SubLObject)$ic56$, var204);
    ...
    static {
        ...
        $ic0$ = makeKeyword("DIRECTED");
        $ic1$ = makeKeyword("SUPERIOR");
        $ic2$ = makeKeyword("INFERIOR");
        $ic3$ = makeKeyword("INVERSE");
        $ic4$ = makeString("illegal value of *gt-mode*: ~s");
        $ic5$ = makeSymbol("S#23756", "CYC");
        $ic6$ = makeSymbol("FUNCTION-SPEC-P");
        $ic7$ = makeSymbol("S#23790", "CYC");
        $ic8$ = makeString("invalid gt mode: ~a");
        $ic9$ = makeString("illegal value of *gt-mode*");
        $ic10$ = makeSymbol("S#23754", "CYC");
        $ic11$ = makeSymbol("S#23794", "CYC");
        $ic12$ = makeSymbol("S#23757", "CYC");
        $ic13$ = makeString("~a is not a function");
        $ic14$ = makeSymbol("S#23797", "CYC");
        $ic15$ = makeInteger(128);
        $ic16$ = makeSymbol("S#23800", "CYC");
        $ic17$ = makeSymbol("CONS");
        $ic18$ = makeSymbol("S#23802", "CYC");
        $ic19$ = makeSymbol("S#23846", "CYC");
        $ic20$ = makeSymbol("S#23848", "CYC");
        $ic21$ = makeSymbol("S#23805", "CYC");
        $ic22$ = makeSymbol("S#23807", "CYC");
        $ic23$ = makeSymbol("S#23772", "CYC");
        $ic24$ = makeSymbol("S#23809", "CYC");
        $ic25$ = makeSymbol("FORT-P");
        $ic26$ = constant_handles_oc.f8479((SubLObject)makeString("equals"));
        $ic27$ = ConsesLow.list((SubLObject)makeKeyword("TRUE"));
        $ic28$ = makeSymbol("S#23759", "CYC");
        $ic29$ = makeSymbol("S#23813", "CYC");
        $ic30$ = makeSymbol("S#12274", "CYC");
        $ic31$ = constant_handles_oc.f8479((SubLObject)makeString("EverythingPSC"));
        $ic32$ = constant_handles_oc.f8479((SubLObject)makeString("ReflexiveBinaryPredicate"));
        $ic33$ = constant_handles_oc.f8479((SubLObject)makeString("genlMt"));
        $ic34$ = makeKeyword("TRUE");
        $ic35$ = makeSymbol("TRUTH-P");
        $ic36$ = makeSymbol("S#23817", "CYC");
        $ic37$ = makeSymbol("S#23816", "CYC");
        $ic38$ = makeSymbol("QUOTE");
        $ic39$ = makeSymbol("S#23820", "CYC");
        $ic40$ = makeSymbol("S#23755", "CYC");
        $ic41$ = makeSymbol("S#23824", "CYC");
        $ic42$ = makeSymbol("S#23758", "CYC");
        $ic43$ = makeKeyword("ASSERTION");
        $ic44$ = makeString("illegal value of *gt-link-type*: ~s");
        $ic45$ = makeSymbol("HLMT-EQUAL");
        $ic46$ = makeInteger(512);
        $ic47$ = makeString("GT recursion limit reached.");
        $ic48$ = makeKeyword("ACCESSORS");
        $ic49$ = makeKeyword("ACCESSIBLE");
        $ic50$ = ConsesLow.list((SubLObject)makeSymbol("S#12012", "CYC"), (SubLObject)makeSymbol("S#12015", "CYC"), (SubLObject)makeSymbol("S#12016", "CYC"));
        $ic51$ = makeKeyword("MAPPING-DONE");
        $ic52$ = makeSymbol("S#12347", "CYC");
        $ic53$ = makeKeyword("GAF");
        $ic54$ = makeSymbol("S#12348", "CYC");
        $ic55$ = makeSymbol("POSITIVE-INTEGER-P");
        $ic56$ = makeSymbol("S#23850", "CYC");
    }
}
