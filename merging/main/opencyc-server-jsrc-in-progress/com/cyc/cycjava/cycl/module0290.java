...
public final class module0290 extends SubLTranslatedFile
{
    ...
    public static SubLObject f19495(final SubLObject var1) {
        ...
        return module0276.f18287(var2, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f19499(final SubLObject var3) {
        return module0036.f2531(var3, (SubLObject)$ic0$, (SubLObject)$ic1$, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f19496(final SubLObject var1) {
        ...
        if (NIL == var4) {
            SubLObject var6;
            SubLObject var7;
            for (var6 = var3, var7 = (SubLObject)NIL, var7 = var6.first(); NIL == var4 && NIL != var6; var4 = (SubLObject)makeBoolean(NIL == module0161.f10513(var2, module0178.f11287(var7))), var6 = var6.rest(), var7 = var6.first()) {}
        }
        if (NIL != var4) {
    ...
    public static SubLObject f19500(final SubLObject var1) {
        ...
        var5 = var4.first();
        while (NIL != var4) {
            var3 = conses_high.nunion(var3, module0287.f19222(var5, var2, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            var4 = var4.rest();
            var5 = var4.first();
        }
        return var3;
    ...
    public static SubLObject f19501(final SubLObject var1) {
        ...
        return module0202.f12768($ic2$, var2, var3);
    }
    
    public static SubLObject f19502(final SubLObject var1) {
        final SubLThread var2 = SubLProcess.currentSubLThread();
        SubLObject var3 = (SubLObject)NIL;
        final SubLObject var4 = $g2657$.currentBinding(var2);
        try {
            $g2657$.bind(module0178.f11294(var1), var2);
            var3 = module0232.f15328(f19503(f19504(var1)), (SubLObject)UNPROVIDED);
        }
        finally {
            $g2657$.rebind(var4, var2);
        }
        return var3;
    }
    ...
    public static SubLObject f19503(final SubLObject var3) {
        return module0036.f2547(var3, (SubLObject)$ic3$, (SubLObject)$ic4$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f19507(final SubLObject var14, final SubLObject var4) {
        if ($ic5$.eql(module0205.f13132(var14))) {
            final SubLObject var15 = module0205.f13207(var14, (SubLObject)UNPROVIDED);
            final SubLObject var16 = var15.first();
            SubLObject var17 = (SubLObject)NIL;
            if (!$ic2$.eql(module0205.f13132(var16))) {
    ...
    public static SubLObject f19509(final SubLObject var20) {
        final SubLObject var21 = f19510(module0205.f13203(var20, (SubLObject)UNPROVIDED));
        final SubLObject var22 = module0205.f13204(var20, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f19508(final SubLObject var21, final SubLObject var13) {
        ...
        if (NIL != module0161.f10481(var23)) {
    ...
    public static SubLObject f19514(final SubLObject var3) {
        return module0036.f2547(var3, (SubLObject)$ic6$, (SubLObject)$ic7$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f19513(final SubLObject var24) {
        final SubLObject var25 = module0205.f13136(var24);
        if (var25.eql($ic8$)) {
            final SubLObject var26 = (SubLObject)((NIL != module0202.f12595(module0205.f13203(var24, (SubLObject)UNPROVIDED))) ? module0205.f13207(module0205.f13203(var24, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED) : ConsesLow.list(module0205.f13203(var24, (SubLObject)UNPROVIDED)));
            final SubLObject var27 = (SubLObject)((NIL != module0202.f12594(module0205.f13204(var24, (SubLObject)UNPROVIDED))) ? module0205.f13207(module0205.f13204(var24, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED) : ConsesLow.list(module0205.f13204(var24, (SubLObject)UNPROVIDED)));
            return module0232.f15326(var26, var27);
        }
        if (var25.eql($ic9$)) {
            return module0232.f15326((SubLObject)NIL, module0205.f13207(var24, (SubLObject)UNPROVIDED));
        }
        if (var25.eql($ic10$)) {
            return module0232.f15326((NIL != module0202.f12595(module0205.f13203(var24, (SubLObject)UNPROVIDED))) ? module0205.f13207(module0205.f13203(var24, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED) : module0205.f13207(var24, (SubLObject)UNPROVIDED), (SubLObject)NIL);
        }
        return module0232.f15326((SubLObject)NIL, (SubLObject)ConsesLow.list(var24));
    }
    
    public static SubLObject f19515(final SubLObject var28) {
        return (SubLObject)makeBoolean(NIL != f19516(var28) || NIL != f19517(var28) || NIL != f19518(var28));
    }
    
    public static SubLObject f19516(final SubLObject var28) {
        if (NIL != module0202.f12659(var28) && $ic11$.eql(module0205.f13366(var28)) && NIL != module0202.f12637(var28, (SubLObject)TWO_INTEGER, (SubLObject)UNPROVIDED)) {
            final SubLObject var29 = module0205.f13367(var28, (SubLObject)UNPROVIDED);
            final SubLObject var30 = module0205.f13369(var28, (SubLObject)UNPROVIDED);
            return (SubLObject)makeBoolean(NIL != module0202.f12657(var29) && NIL != module0202.f12590(var30));
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f19517(final SubLObject var28) {
        if (NIL != module0202.f12659(var28) && $ic12$.eql(module0205.f13366(var28)) && NIL != module0202.f12637(var28, (SubLObject)ONE_INTEGER, (SubLObject)UNPROVIDED)) {
            final SubLObject var29 = module0205.f13367(var28, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f19518(final SubLObject var28) {
        if (NIL != module0202.f12659(var28) && $ic13$.eql(module0205.f13366(var28)) && NIL != module0202.f12637(var28, (SubLObject)TWO_INTEGER, (SubLObject)UNPROVIDED)) {
            final SubLObject var29 = module0205.f13367(var28, (SubLObject)UNPROVIDED);
            final SubLObject var30 = module0205.f13369(var28, (SubLObject)UNPROVIDED);
            return (SubLObject)makeBoolean(var29.isInteger() && (var30.isString() || NIL == var30));
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f19519(final SubLObject var28) {
        return (SubLObject)makeBoolean(NIL != assertion_handles_oc.f11035(var28) || NIL != module0167.f10813(var28) || NIL != module0193.f12067(var28));
    }
    ...
    public static SubLObject f19520(final SubLObject var28) {
        ...
        if (NIL != module0167.f10813(var28)) {
            return f19522(var28);
        }
        if (NIL != module0193.f12067(var28)) {
            return f19523(var28, (SubLObject)UNPROVIDED);
        }
        return var28;
    }
    ...
    public static SubLObject f19521(final SubLObject var1) {
        ...
        if (!var1.eql(f19506(var3, var2))) {
            module0202.f12747((SubLObject)THREE_INTEGER, (SubLObject)$ic14$, var1, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return module0202.f12768($ic11$, var4, var3);
    }
    
    public static SubLObject f19522(final SubLObject var31) {
        final SubLObject var32 = module0172.f10915(var31);
        if (NIL == module0210.f13594(var32) || !var31.eql(module0172.f10921(var32))) {
            module0202.f12747((SubLObject)THREE_INTEGER, (SubLObject)$ic15$, var31, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return module0202.f12643($ic12$, var32);
    }
    
    public static SubLObject f19523(final SubLObject var33, SubLObject var34) {
        if (var34 == UNPROVIDED) {
            var34 = $g2657$.getDynamicValue();
        }
        final SubLObject var35 = module0193.f12073(var33);
        final SubLObject var36 = (SubLObject)(var35.isInteger() ? ConsesLow.nth(var35, var34) : NIL);
        return module0202.f12768($ic13$, var35, var36);
    }
    
    public static SubLObject f19524(final SubLObject var28) {
        if (NIL != module0035.f2239(var28) && NIL == f19519(var28)) {
            return var28;
        }
        return (SubLObject)ConsesLow.list((SubLObject)$ic16$, var28);
    }
    ...
    public static SubLObject f19525(final SubLObject var37) {
        final SubLObject var38 = module0205.f13368(var37, (SubLObject)UNPROVIDED);
        final SubLObject var39 = f19510(module0205.f13277(var37, (SubLObject)UNPROVIDED));
        final SubLObject var40 = f19506(var38, var39);
        if (NIL != assertion_handles_oc.f11035(var40)) {
            return var40;
        }
        module0202.f12747((SubLObject)THREE_INTEGER, (SubLObject)$ic17$, var37, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        return f19528(var37);
    }
    
    public static SubLObject f19526(final SubLObject var38) {
        final SubLObject var39 = module0205.f13277(var38, (SubLObject)UNPROVIDED);
        final SubLObject var40 = f19529(var39);
        if (NIL != module0167.f10813(var40)) {
            return var40;
        }
        module0202.f12747((SubLObject)THREE_INTEGER, (SubLObject)$ic18$, var38, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        return f19530(var38);
    }
    
    public static SubLObject f19527(final SubLObject var40) {
        final SubLObject var41 = module0205.f13277(var40, (SubLObject)UNPROVIDED);
        if (var41.isInteger()) {
    ...
    public static SubLObject f19528(final SubLObject var37) {
        final SubLObject var38 = module0205.f13368(var37, (SubLObject)UNPROVIDED);
        final SubLObject var39 = f19531(module0205.f13277(var37, (SubLObject)UNPROVIDED));
        return Values.values(module0202.f12768($ic2$, var39, var38), module0132.$g1553$.getGlobalValue());
    }
    
    public static SubLObject f19530(final SubLObject var38) {
        final SubLThread var39 = SubLProcess.currentSubLThread();
        final SubLObject var40 = module0205.f13277(var38, (SubLObject)UNPROVIDED);
        SubLObject var41 = (SubLObject)NIL;
        if (NIL != module0210.f13595(var40, (SubLObject)UNPROVIDED)) {
            var41 = var40;
        }
        else if (NIL != module0167.f10813(var40) && NIL != module0172.f10915(var40)) {
    ...
    public static SubLObject f19532(final SubLObject var40) {
        ...
        final SubLObject var42 = module0205.f13368(var40, (SubLObject)UNPROVIDED);
        if (var42.isString()) {
    ...
    public static SubLObject f19529(final SubLObject var39) {
        ...
        return (SubLObject)((NIL != module0167.f10813(var40)) ? var40 : NIL);
    }
    
    public static SubLObject f19533(final SubLObject var42) {
        if (NIL != module0035.f2371(Symbols.symbol_function((SubLObject)$ic22$), var42, (SubLObject)UNPROVIDED)) {
            final SubLObject var43 = module0172.f10916(var42);
            return (NIL != module0167.f10813(var43)) ? var43 : var42;
        }
        ...
        while (NIL != var45) {
            ...
            else if (NIL != module0228.f15225(var46)) {
        ...
        return (NIL != module0167.f10813(var48)) ? var48 : var44;
    }
    
    public static SubLObject f19534(final SubLObject var28) {
        return module0205.f13147(var28, (SubLObject)$ic23$, (SubLObject)$ic21$, (SubLObject)T, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f19535(final SubLObject var28) {
        return module0205.f13147(var28, (SubLObject)$ic24$, (SubLObject)$ic25$, (SubLObject)T, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f19536(final SubLObject var1) {
        ...
        return module0004.f104(var1, var4, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f19537(final SubLObject var1) {
        ...
        try {
            ...
            try {
                Errors.$error_handler$.bind((SubLObject)$ic26$, var2);
                try {
                    final SubLObject var6 = f19495(var1);
                    final SubLObject var7 = module0178.f11287(var1);
                    final SubLObject var8 = f19511(var6);
                    final SubLObject var9 = (SubLObject)((NIL != var8) ? module0217.f14415(var8, var7) : NIL);
                    if (NIL != var9) {
                        var3 = Equality.eql(var1, var9);
                    }
                    else {
                        var3 = module0035.f2201(f19500(var1), f19507(var6, var7), (SubLObject)UNPROVIDED);
                    }
                }
    ...
    public static SubLObject f19541(final SubLObject var14, final SubLObject var4) {
        ...
        if (NIL == var16) {
            module0538.f33320((SubLObject)ConsesLow.list((SubLObject)$ic27$, (SubLObject)$ic28$, var14, var4));
        }
        else {
            final SubLObject var17 = module0178.f11378(var16);
            if (NIL == var17) {
                module0538.f33320((SubLObject)ConsesLow.list((SubLObject)$ic29$, (SubLObject)$ic30$, var14, var4));
            }
            else {
                module0342.f23121(var17, var16, (SubLObject)UNPROVIDED);
            }
        }
        var15 = (SubLObject)makeBoolean(NIL == module0538.f33324());
    ...
    public static SubLObject f19543() {
        $g2657$ = SubLFiles.defparameter("S#22150", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $ic1$ = makeSymbol("S#22114", "CYC");
        $ic2$ = constant_handles_oc.f8479((SubLObject)makeString("ist"));
        $ic3$ = makeSymbol("S#22132", "CYC");
        $ic4$ = makeSymbol("S#14910", "CYC");
        $ic5$ = constant_handles_oc.f8479((SubLObject)makeString("and"));
        $ic6$ = makeSymbol("S#22110", "CYC");
        $ic7$ = makeSymbol("S#14108", "CYC");
        $ic8$ = constant_handles_oc.f8479((SubLObject)makeString("implies"));
        $ic9$ = constant_handles_oc.f8479((SubLObject)makeString("or"));
        $ic10$ = constant_handles_oc.f8479((SubLObject)makeString("not"));
        $ic11$ = constant_handles_oc.f8479((SubLObject)makeString("TLAssertionFn"));
        $ic12$ = constant_handles_oc.f8479((SubLObject)makeString("TLReifiedNatFn"));
        $ic13$ = constant_handles_oc.f8479((SubLObject)makeString("TLVariableFn"));
        $ic14$ = makeString("referenced assertion not found: ~%  ~s");
        $ic15$ = makeString("referenced function not found: ~%  ~s");
        $ic16$ = makeSymbol("QUOTE");
        $ic17$ = makeString("referenced TL assertion not found: ~%  ~s");
        $ic18$ = makeString("referenced TL nart not found: ~%  ~s");
        $ic19$ = makeSymbol("TL-ASSERTION-TERM-TO-EL");
        $ic20$ = makeSymbol("TL-FUNCTION-TERM-TO-EL");
        $ic21$ = makeSymbol("TL-VAR-TO-EL");
        $ic22$ = makeSymbol("CONSP");
        $ic23$ = makeSymbol("S#15432", "CYC");
        $ic24$ = makeSymbol("S#22131", "CYC");
        $ic25$ = makeSymbol("S#22137", "CYC");
        $ic26$ = makeSymbol("S#38", "CYC");
        $ic27$ = makeKeyword("ASSERTION-NOT-PRESENT");
        $ic28$ = makeString("formula ~S in mt ~S cannot be found");
        $ic29$ = makeKeyword("ASSERTION-NOT-LOCAL");
        $ic30$ = makeString("CNF ~S in mt ~S is not locally in the KB");
    }
