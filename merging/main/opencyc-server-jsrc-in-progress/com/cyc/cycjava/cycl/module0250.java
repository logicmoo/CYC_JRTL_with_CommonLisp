...
public final class module0250 extends SubLTranslatedFile
{
    ...
    public static SubLObject f16095(final SubLObject var1, final SubLObject var2, final SubLObject var3) {
        ...
        if (NIL != module0244.f15762(var1)) {
            if (NIL != module0141.f9279(var3)) {
                return (SubLObject)$ic1$;
            }
            return (SubLObject)$ic2$;
        }
        else if (NIL != module0244.f15770(var1)) {
            if (NIL != module0141.f9207(var2)) {
            ...
            module0136.f8870((SubLObject)ONE_INTEGER, (SubLObject)$ic6$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f16096(final SubLObject var4) {
        ...
        module0136.f8870((SubLObject)ONE_INTEGER, (SubLObject)$ic7$, var4, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16097() {
        return (SubLObject)makeBoolean(NIL != module0141.f9165() && NIL != module0244.f15754() && NIL != module0141.f9278());
    }
    ...
    public static SubLObject f16104(final SubLObject var10) {
        ...
        if (NIL == var11) {
            ...
            while (NIL == var11 && NIL != var12) {
                if (NIL != module0147.f9507(module0178.f11287(var13))) {
                    var11 = var13;
                }
                var12 = var12.rest();
                var13 = var12.first();
    ...
    public static SubLObject f16105(final SubLObject var10, final SubLObject var8, final SubLObject var3) {
        ...
        final SubLObject var14 = module0244.f15790(module0244.f15736(module0137.f8955((SubLObject)UNPROVIDED)));
        if (NIL != var12) {
            var11 = var12;
        }
        else if (NIL == module0244.f15730(var13)) {
        ...
        else if (NIL == module0244.f15779(module0137.f8955(var13))) {
            SubLObject var15_19 = (SubLObject)NIL;
            SubLObject var16 = (SubLObject)NIL;
            SubLObject var17 = (SubLObject)NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var10, var10, (SubLObject)$ic12$);
            var15_19 = var10.first();
            SubLObject var18 = var10.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var18, var10, (SubLObject)$ic12$);
            var16 = var18.first();
            var18 = var18.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var18, var10, (SubLObject)$ic12$);
            var17 = var18.first();
            ...
            if (NIL == var18) {
                ...
                cdestructuring_bind.cdestructuring_bind_error(var10, (SubLObject)$ic12$);
            }
        }
        else {
            final SubLObject var15 = f16104(var10);
    ...
    public static SubLObject f16106(final SubLObject var7, SubLObject var8) {
        ...
        if (NIL != module0191.f11952(var7)) {
            return var7;
        }
        SubLObject var9 = module0141.f9173();
        final SubLObject var10 = f16101(var7);
        final SubLObject var11 = (NIL != module0138.f8990(var10)) ? module0141.f9296(var10) : var10;
        if (NIL == var9 && NIL != module0141.f9181()) {
            var9 = (SubLObject)$ic13$;
        }
        final SubLObject var12 = var9;
        if (var12.eql((SubLObject)$ic14$)) {
            return f16105(f16098(var7), f16100(var7, var8), var10);
        }
        if (var12.eql((SubLObject)$ic15$)) {
            return var7;
        }
        if (var12.eql((SubLObject)$ic13$)) {
            return (SubLObject)((NIL != module0141.f9181()) ? ConsesLow.list(f16098(var7), var11) : ConsesLow.list(f16098(var7), module0141.f9296(f16101(var7))));
        }
        module0136.f8870((SubLObject)ONE_INTEGER, (SubLObject)$ic16$, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16108(final SubLObject var27, final SubLObject var1, final SubLObject var28, final SubLObject var29, SubLObject var8, SubLObject var3, SubLObject var30, SubLObject var31) {
        ...
        try {
            ...
            module0141.$g1674$.bind((SubLObject)NIL, var32);
            module0137.$g1605$.bind(var1, var32);
            module0141.$g1668$.bind((SubLObject)NIL, var32);
            module0141.$g1667$.bind((SubLObject)NIL, var32);
            if (NIL != var30) {
                final SubLObject var33_40 = module0141.$g1666$.currentBinding(var32);
                try {
                    module0141.$g1666$.bind(var30, var32);
                    if (NIL != var31 && var28.equal(var29) && NIL != module0244.f15772(var1)) {
                        var33 = (SubLObject)ConsesLow.list(module0191.f11990((SubLObject)$ic17$, module0202.f12768(module0244.f15736(var1), var28, var29), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
                    }
                    else if (NIL != var31 && var28.equal(var29) && NIL != module0244.f15733(var1) && NIL != module0142.f9318()) {
                        var33 = (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list($ic18$, var28, var29), var8, $ic19$);
                    }
                    else {
                        ...
                        try {
                            module0141.$g1598$.bind((SubLObject)T, var32);
                            module0141.$g1682$.bind((SubLObject)NIL, var32);
                            module0141.$g1681$.bind((SubLObject)((NIL != module0244.f15755()) ? $ic20$ : $ic21$), var32);
                            module0141.$g1692$.bind((SubLObject)NIL, var32);
                            try {
        ...
        if (NIL != module0035.f2000(var33, (SubLObject)TWO_INTEGER, (SubLObject)UNPROVIDED) && NIL != module0244.f15762(var1) && NIL == module0244.f15763(var1)) {
            var33 = conses_high.adjoin(f16109(var1, var8), var33, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED);
        }
        return (NIL != var33) ? var33 : var34;
    }
    ...
    public static SubLObject f16109(final SubLObject var1, SubLObject var8) {
        ...
        final SubLThread var9 = SubLProcess.currentSubLThread();
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var9) && NIL == module0244.f15762(var1)) {
            Errors.error((SubLObject)$ic22$, var1);
        }
        return module0440.f30709(module0244.f15736(var1), $ic23$, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f16110(final SubLObject var51) {
        module0141.$g1692$.setDynamicValue((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list($ic24$, var51, var51), (SubLObject)NIL, (SubLObject)$ic8$)));
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16111(final SubLObject var51, final SubLObject var52) {
        ...
        return (SubLObject)ConsesLow.list(module0244.f15765(module0137.f8955((SubLObject)UNPROVIDED)), var51, var52, module0138.$g1623$.getDynamicValue(var53));
    }
    
    public static SubLObject f16112(final SubLObject var53) {
        final SubLThread var54 = SubLProcess.currentSubLThread();
        SubLObject var55 = (SubLObject)NIL;
        final SubLObject var56 = Hashtables.gethash(var53, module0142.$g1720$.getGlobalValue(), (SubLObject)UNPROVIDED);
        if (NIL == var55) {
            ...
            while (NIL == var55 && NIL != var57) {
                if (var58.isKeyword()) {
                    if (NIL == module0142.$g1718$.getDynamicValue(var54)) {
                        return (SubLObject)NIL;
                    }
                    if (NIL != module0142.$g1719$.getDynamicValue(var54)) {
                ...
                else if (NIL != module0178.f11361(var58, (SubLObject)UNPROVIDED)) {
                    if (NIL != module0142.$g1718$.getDynamicValue(var54)) {
                        if (NIL != module0142.$g1719$.getDynamicValue(var54)) {
                            var55 = (SubLObject)ConsesLow.cons(var53, var55);
                        }
    ...
    public static SubLObject f16113(final SubLObject var56, final SubLObject var53) {
        ...
        SubLObject var58 = (SubLObject)NIL;
        final SubLObject var59 = Hashtables.gethash(var56, module0142.$g1721$.getGlobalValue(), (SubLObject)UNPROVIDED);
        final SubLObject var60 = Hashtables.gethash(var56, module0142.$g1727$.getDynamicValue(var57), (SubLObject)UNPROVIDED);
        ...
        try {
            ...
            if (NIL == var58) {
                ...
                var63 = var62.first();
                while (NIL == var58 && NIL != var62) {
                    if (NIL != module0178.f11361(var63, (SubLObject)UNPROVIDED)) {
                        if (NIL != module0142.$g1718$.getDynamicValue(var57)) {
                            if (NIL != module0142.$g1719$.getDynamicValue(var57)) {
    ...
    public static SubLObject f16114(final SubLObject var51) {
        ...
        if (NIL != module0141.f9165()) {
            return module0249.f16027(var51, (SubLObject)UNPROVIDED);
        }
        if (NIL != module0139.f9077()) {
            return (SubLObject)makeBoolean(NIL != module0249.f16027(var51, (SubLObject)UNPROVIDED) && NIL != module0249.f16031() && NIL != module0249.f16027(var51, module0139.$g1646$.getDynamicValue(var52)) && NIL != module0324.f21955(var51));
        }
        return (SubLObject)makeBoolean(NIL != module0249.f16027(var51, (SubLObject)UNPROVIDED) && NIL != module0249.f16031() && NIL != module0324.f21955(var51));
    }
    
    public static SubLObject f16115(final SubLObject var64, final SubLObject var51) {
        if (var64.eql((SubLObject)$ic25$)) {
            return module0141.f9196();
        }
        if (var64.eql((SubLObject)$ic26$)) {
            return module0141.f9195();
        }
        if (var64.eql((SubLObject)$ic27$)) {
            return (SubLObject)T;
        }
        if (var64.eql((SubLObject)$ic28$)) {
            return f16114(var51);
        }
        module0136.f8872((SubLObject)THREE_INTEGER, (SubLObject)$ic29$, var64, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f16116(final SubLObject var64) {
        ...
        module0136.f8872((SubLObject)ONE_INTEGER, (SubLObject)$ic30$, var64, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f16120(final SubLObject var51) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var55, var54, (SubLObject)$ic31$);
        var56 = var55.first();
        var55 = var55.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var55, var54, (SubLObject)$ic31$);
        var57 = var55.first();
        ...
        if (NIL == var55) {
            ...
            cdestructuring_bind.cdestructuring_bind_error(var54, (SubLObject)$ic31$);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16121(final SubLObject var71) {
        ...
        if (NIL != module0244.f15755()) {
            f16122(var71);
        }
        else {
            final SubLObject var73 = module0244.f15779(module0137.f8955((SubLObject)UNPROVIDED));
            final SubLObject var74 = (SubLObject)((NIL != var73) ? module0138.f8972(module0138.f8979()) : T);
            final SubLObject var75 = (NIL != var74) ? var71.first() : conses_high.second(var71);
            final SubLObject var76 = (NIL != var74) ? conses_high.second(var71) : var71.first();
            if (NIL != module0173.f10955(var75) || NIL == var74) {
                module0141.$g1692$.setDynamicValue((SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(module0244.f15736(module0137.f8955((SubLObject)UNPROVIDED)), var75, var76), module0138.f8997(), module0138.f8998()), module0141.$g1692$.getDynamicValue(var72)), var72);
            }
            else {
    ...
    public static SubLObject f16122(final SubLObject var71) {
        ...
        if (NIL != module0324.f21976(var74)) {
            module0142.$g1735$.setDynamicValue((SubLObject)T, var72);
        }
        if (NIL == module0142.$g1735$.getDynamicValue(var72) || NIL == module0142.$g1734$.getDynamicValue(var72) || NIL != module0142.$g1718$.getDynamicValue(var72)) {
    ...
    public static SubLObject f16123(final SubLObject var51) {
        ...
        if (NIL != module0139.f9070()) {
            ...
            try {
                ...
                module0139.$g1644$.bind((SubLObject)T, var52);
    ...
    public static SubLObject f16124(final SubLObject var51) {
        ...
        if (NIL != module0139.f9070()) {
            ...
            try {
                ...
                module0139.$g1636$.bind(module0139.$g1657$.getDynamicValue(var52), var52);
                module0139.$g1644$.bind((SubLObject)T, var52);
                if (NIL != Functions.funcall(var54, var51)) {
                    Functions.funcall(var53, var51);
                }
            }
            finally {
        ...
        else if (NIL != Functions.funcall(var54, var51)) {
            Functions.funcall(var53, var51);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16126(final SubLObject var51) {
        ...
        if (NIL != var54) {
            ...
            module0141.$g1685$.setDynamicValue((SubLObject)T, var52);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16127(final SubLObject var51) {
        ...
        if (NIL == var59) {
            ...
            cdestructuring_bind.cdestructuring_bind_error(var58, (SubLObject)$ic31$);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16128(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        if (NIL != module0248.f15924(var51)) {
    ...
    public static SubLObject f16129(final SubLObject var51) {
        ...
        module0141.$g1685$.setDynamicValue((SubLObject)T);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16130(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        if (NIL == module0249.f16059(var51, module0139.$g1647$.getDynamicValue(var52))) {
            module0141.$g1691$.setDynamicValue(var51, var52);
            module0141.$g1685$.setDynamicValue((SubLObject)T, var52);
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f16132() {
        ...
        if (NIL != module0141.f9168()) {
            ...
            module0141.$g1691$.setDynamicValue((SubLObject)T);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16133(final SubLObject var51) {
        ...
        if (NIL != module0249.f16059(var51, var53)) {
            if (NIL != module0141.f9168() && NIL != f16097()) {
    ...
    public static SubLObject f16138(final SubLObject var79, final SubLObject var51) {
        ...
        if (NIL != var81 && NIL != var79) {
            if (var79.eql((SubLObject)$ic32$)) {
                f16117(var51);
            }
            else if (var79.eql((SubLObject)$ic33$)) {
                f16120(var51);
            }
            else if (var79.eql((SubLObject)$ic34$)) {
                f16134(var51);
            }
            else if (var79.eql((SubLObject)$ic35$)) {
                f16133(var51);
            }
            else if (var79.eql((SubLObject)$ic36$)) {
                f16126(var51);
            }
            else if (var79.eql((SubLObject)$ic37$)) {
                f16127(var51);
            }
            else if (var79.eql((SubLObject)$ic38$)) {
                f16123(var51);
            }
            else if (var79.eql((SubLObject)$ic39$)) {
                f16125(var51);
            }
            else if (var79.eql((SubLObject)$ic40$)) {
                module0252.f16255(var51);
            }
            else if (var79.eql((SubLObject)$ic41$)) {
                f16128(var51);
            }
            else {
    ...
    public static SubLObject f16143(final SubLObject var51) {
        ...
        if (NIL == module0249.f16059(var51, (SubLObject)UNPROVIDED)) {
            ...
            f16144(var51);
            if (NIL == module0141.f9238()) {
                final SubLObject var53 = module0200.f12443(module0137.f8955((SubLObject)UNPROVIDED));
                SubLObject var54;
                SubLObject var55;
                SubLObject var56;
                SubLObject var57;
                ...
                SubLObject var80;
                SubLObject var81;
                for (var54 = (SubLObject)NIL, var54 = var53; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var54; var54 = var54.rest()) {
                    var55 = var54.first();
                    var56 = module0137.$g1605$.currentBinding(var52);
                    var57 = module0141.$g1674$.currentBinding(var52);
                    try {
                        module0137.$g1605$.bind(var55, var52);
                        module0141.$g1674$.bind((SubLObject)((NIL != module0141.f9205((SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) ? makeBoolean(NIL == module0141.$g1674$.getDynamicValue(var52)) : module0141.$g1674$.getDynamicValue(var52)), var52);
                        var87_88 = module0228.f15229(var51);
                        if (NIL != module0138.f8992(var87_88)) {
                            var58 = module0242.f15664(var87_88, module0137.f8955((SubLObject)UNPROVIDED));
                            if (NIL != var58) {
                                var59 = module0245.f15834(var58, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                                if (NIL != var59) {
                                    for (var60 = module0066.f4838(module0067.f4891(var59)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var60); var60 = module0066.f4840(var60)) {
                                        ...
                                        if (NIL != module0147.f9507(var61)) {
                                            ...
                                            try {
                                                ...
                                                for (var91_95 = module0066.f4838(module0067.f4891(var62)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var91_95); var91_95 = module0066.f4840(var91_95)) {
                                                    var52.resetMultipleValues();
                                                    ...
                                                    if (NIL != module0141.f9289(var63)) {
                                                        ...
                                                        try {
                                                            ...
                                                            if (NIL != module0077.f5302(var65)) {
                                                                ...
                                                                for (var67 = module0032.f1741(var66), var68 = (SubLObject)NIL, var68 = module0032.f1742(var67, var66); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0032.f1744(var67, var68); var68 = module0032.f1743(var68)) {
                                                                    var69 = module0032.f1745(var67, var68);
                                                                    if (NIL != module0032.f1746(var68, var69)) {
                                                                        if (NIL != module0159.$g2149$.getGlobalValue() && NIL != module0159.f10366()) {
                                                                            f16145(var51, var69);
                                                                        }
                                                                        f16143(var69);
                                                                        if (NIL != module0141.f9224()) {
                                                                ...
                                                                if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                                                                    var70 = var65;
                                                                    var71 = (SubLObject)NIL;
                                                                    var71 = var70.first();
                                                                    while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var70) {
                                                                        if (NIL != module0159.$g2149$.getGlobalValue() && NIL != module0159.f10366()) {
                                                                            f16145(var51, var71);
                                                                        }
                                                                        f16143(var71);
                                                                ...
                                                                Errors.error((SubLObject)$ic42$, var65);
                                                            }
                                                        }
                                                        finally {
                        ...
                        else if (NIL != module0155.f9785(var87_88, (SubLObject)UNPROVIDED)) {
                            var72 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED)));
                            for (var85_104 = (SubLObject)NIL, var85_104 = var72; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var85_104; var85_104 = var85_104.rest()) {
                                ...
                                try {
                                    ...
                                    if (NIL != module0077.f5302(var75)) {
                                        ...
                                        for (var77 = module0032.f1741(var76), var78 = (SubLObject)NIL, var78 = module0032.f1742(var77, var76); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0032.f1744(var77, var78); var78 = module0032.f1743(var78)) {
                                        ...
                                        if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                                            ...
                                            var81 = var80.first();
                                            while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var80) {
                                                if (NIL != module0159.$g2149$.getGlobalValue() && NIL != module0159.f10366()) {
                                                    f16145(var51, var81);
                                                }
                                                f16143(var81);
                                        ...
                                        Errors.error((SubLObject)$ic42$, var75);
                                    }
                                }
                                finally {
    ...
    public static SubLObject f16147(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        if (NIL != module0249.f16059(var51, (SubLObject)UNPROVIDED)) {
            module0249.f16063(var51, (SubLObject)UNPROVIDED);
            ...
            if (NIL == module0141.f9238()) {
                final SubLObject var54 = module0200.f12443(module0137.f8955((SubLObject)UNPROVIDED));
                SubLObject var55;
                SubLObject var56;
                SubLObject var57;
                SubLObject var58;
                ...
                for (var55 = (SubLObject)NIL, var55 = var54; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var55; var55 = var55.rest()) {
                    var56 = var55.first();
                    ...
                    try {
                        ...
                        if (NIL != module0138.f8992(var87_107)) {
                            var59 = module0242.f15664(var87_107, module0137.f8955((SubLObject)UNPROVIDED));
                            if (NIL != var59) {
                                var60 = module0245.f15834(var59, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                                if (NIL != var60) {
                                    for (var61 = module0066.f4838(module0067.f4891(var60)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var61); var61 = module0066.f4840(var61)) {
                                        var52.resetMultipleValues();
                                        ...
                                        if (NIL != module0147.f9507(var62)) {
                                            ...
                                            try {
                                                ...
                                                for (var91_109 = module0066.f4838(module0067.f4891(var63)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var91_109); var91_109 = module0066.f4840(var91_109)) {
                                                    var52.resetMultipleValues();
                                                    ...
                                                    if (NIL != module0141.f9289(var64)) {
                                                        ...
                                                        try {
                                                            ...
                                                            if (NIL != module0077.f5302(var66)) {
                                                                ...
                                                                for (var68 = module0032.f1741(var67), var69 = (SubLObject)NIL, var69 = module0032.f1742(var68, var67); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0032.f1744(var68, var69); var69 = module0032.f1743(var69)) {
                                                                ...
                                                                if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                                                                    ...
                                                                    var72 = var71.first();
                                                                    while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var71) {
                                                                        if (NIL != module0159.$g2149$.getGlobalValue() && NIL != module0159.f10366()) {
                                                                            f16145(var51, var72);
                                                                        }
                                                                ...
                                                                Errors.error((SubLObject)$ic42$, var66);
                                                            }
                                                        }
                                                        finally {
                        ...
                        else if (NIL != module0155.f9785(var87_107, (SubLObject)UNPROVIDED)) {
                            var73 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED)));
                            for (var85_113 = (SubLObject)NIL, var85_113 = var73; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var85_113; var85_113 = var85_113.rest()) {
                                ...
                                try {
                                    ...
                                    if (NIL != module0077.f5302(var76)) {
                                        ...
                                        for (var78 = module0032.f1741(var77), var79 = (SubLObject)NIL, var79 = module0032.f1742(var78, var77); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0032.f1744(var78, var79); var79 = module0032.f1743(var79)) {
                                        ...
                                        if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                                            ...
                                            var82 = var81.first();
                                            while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var81) {
                                                if (NIL != module0159.$g2149$.getGlobalValue() && NIL != module0159.f10366()) {
                                                    f16145(var51, var82);
                                                }
                                        ...
                                        Errors.error((SubLObject)$ic42$, var76);
                                    }
                                }
                                finally {
            ...
            if (NIL == module0141.f9238()) {
                ...
                for (var54 = (SubLObject)NIL, var54 = var53; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var54; var54 = var54.rest()) {
                    ...
                    try {
                        ...
                        if (NIL != module0138.f8992(var87_117)) {
                            var58 = module0242.f15664(var87_117, module0137.f8955((SubLObject)UNPROVIDED));
                            if (NIL != var58) {
                                var59 = module0245.f15834(var58, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                                if (NIL != var59) {
                                    for (var60 = module0066.f4838(module0067.f4891(var59)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var60); var60 = module0066.f4840(var60)) {
                                        ...
                                        if (NIL != module0147.f9507(var61)) {
                                            ...
                                            try {
                                                module0138.$g1623$.bind(var61, var52);
                                                for (var91_119 = module0066.f4838(module0067.f4891(var62)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var91_119); var91_119 = module0066.f4840(var91_119)) {
                                                    var52.resetMultipleValues();
                        ...
                        else if (NIL != module0155.f9785(var87_117, (SubLObject)UNPROVIDED)) {
                            var72 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED)));
                            for (var85_121 = (SubLObject)NIL, var85_121 = var72; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var85_121; var85_121 = var85_121.rest()) {
            ...
            if (NIL == module0141.f9238()) {
                ...
                for (var54 = (SubLObject)NIL, var54 = var53; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var54; var54 = var54.rest()) {
                    ...
                    try {
                        ...
                        if (NIL != module0138.f8992(var87_123)) {
                            var58 = module0242.f15664(var87_123, module0137.f8955((SubLObject)UNPROVIDED));
                            if (NIL != var58) {
                                var59 = module0245.f15834(var58, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                                if (NIL != var59) {
                                    for (var60 = module0066.f4838(module0067.f4891(var59)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var60); var60 = module0066.f4840(var60)) {
                                        ...
                                        if (NIL != module0147.f9507(var61)) {
                                            ...
                                            try {
                                                module0138.$g1623$.bind(var61, var52);
                                                for (var91_125 = module0066.f4838(module0067.f4891(var62)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var91_125); var91_125 = module0066.f4840(var91_125)) {
                                                    var52.resetMultipleValues();
                                                            ...
                                                            if (NIL != module0077.f5302(var65)) {
                                                                ...
                                                                for (var67 = module0032.f1741(var66), var68 = (SubLObject)NIL, var68 = module0032.f1742(var67, var66); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0032.f1744(var67, var68); var68 = module0032.f1743(var68)) {
                                                                    ...
                                                                    if (NIL != module0032.f1746(var68, var69)) {
                                                                        ...
                                                                        try {
                                                                            module0141.$g1683$.bind(module0141.$g1683$.getDynamicValue(var52), var52);
                                                                            module0142.$g1734$.bind((SubLObject)((NIL != module0141.f9168()) ? makeBoolean(NIL != module0324.f21976(var51) || NIL != module0142.$g1734$.getDynamicValue(var52)) : NIL), var52);
                                                                            if (NIL == module0141.f9168() || NIL == module0142.f9316(f16111(var51, var69))) {
                                                                                f16149(var69);
                                                                            }
                                                                        }
                                                                        finally {
                                                                ...
                                                                if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                                                                    ...
                                                                    while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var70) {
                                                                        ...
                                                                        try {
                                                                            module0141.$g1683$.bind(module0141.$g1683$.getDynamicValue(var52), var52);
                                                                            module0142.$g1734$.bind((SubLObject)((NIL != module0141.f9168()) ? makeBoolean(NIL != module0324.f21976(var51) || NIL != module0142.$g1734$.getDynamicValue(var52)) : NIL), var52);
                                                                            if (NIL == module0141.f9168() || NIL == module0142.f9316(f16111(var51, var71))) {
                                                                                f16149(var71);
                                                                            }
                                                                        }
                                                                        finally {
                        ...
                        else if (NIL != module0155.f9785(var87_123, (SubLObject)UNPROVIDED)) {
                            var72 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED)));
                            for (var85_131 = (SubLObject)NIL, var85_131 = var72; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var85_131; var85_131 = var85_131.rest()) {
                                        ...
                                        for (var77 = module0032.f1741(var76), var78 = (SubLObject)NIL, var78 = module0032.f1742(var77, var76); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0032.f1744(var77, var78); var78 = module0032.f1743(var78)) {
                                            ...
                                            if (NIL != module0032.f1746(var78, var79)) {
                                                ...
                                                try {
                                                    module0141.$g1683$.bind(module0141.$g1683$.getDynamicValue(var52), var52);
                                                    module0142.$g1734$.bind((SubLObject)((NIL != module0141.f9168()) ? makeBoolean(NIL != module0324.f21976(var51) || NIL != module0142.$g1734$.getDynamicValue(var52)) : NIL), var52);
                                                    if (NIL == module0141.f9168() || NIL == module0142.f9316(f16111(var51, var79))) {
                                                        f16149(var79);
                                                    }
                                                }
                                                finally {
                                        ...
                                        if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                                            ...
                                            while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var80) {
                                                ...
                                                try {
                                                    module0141.$g1683$.bind(module0141.$g1683$.getDynamicValue(var52), var52);
                                                    module0142.$g1734$.bind((SubLObject)((NIL != module0141.f9168()) ? makeBoolean(NIL != module0324.f21976(var51) || NIL != module0142.$g1734$.getDynamicValue(var52)) : NIL), var52);
                                                    if (NIL == module0141.f9168() || NIL == module0142.f9316(f16111(var51, var81))) {
                                                        f16149(var81);
                                                    }
                                                }
                                                finally {
    ...
    public static SubLObject f16150(final SubLObject var51, final SubLObject var137) {
        ...
        final SubLObject var140 = module0200.f12443(module0137.f8955((SubLObject)UNPROVIDED));
        SubLObject var141;
        SubLObject var142;
        SubLObject var143;
        SubLObject var144;
        ...
        SubLObject var167;
        SubLObject var168;
        for (var141 = (SubLObject)NIL, var141 = var140; NIL == module0141.$g1685$.getDynamicValue(var138) && NIL != var141; var141 = var141.rest()) {
            var142 = var141.first();
            ...
            try {
                ...
                module0141.$g1674$.bind((SubLObject)((NIL != module0141.f9205((SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) ? makeBoolean(NIL == module0141.$g1674$.getDynamicValue(var138)) : module0141.$g1674$.getDynamicValue(var138)), var138);
                var87_139 = module0228.f15229(var51);
                if (NIL != module0138.f8992(var87_139)) {
                    var145 = module0242.f15664(var87_139, module0137.f8955((SubLObject)UNPROVIDED));
                    if (NIL != var145) {
                        var146 = module0245.f15834(var145, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                        if (NIL != var146) {
                            for (var147 = module0066.f4838(module0067.f4891(var146)); NIL == module0141.$g1685$.getDynamicValue(var138) && NIL == module0066.f4841(var147); var147 = module0066.f4840(var147)) {
                                var138.resetMultipleValues();
                                var148 = module0066.f4839(var147);
                                var149 = var138.secondMultipleValue();
                                var138.resetMultipleValues();
                                if (NIL != module0147.f9507(var148)) {
                                    var33_140 = module0138.$g1623$.currentBinding(var138);
                                    try {
                                        module0138.$g1623$.bind(var148, var138);
                                        for (var91_141 = module0066.f4838(module0067.f4891(var149)); NIL == module0141.$g1685$.getDynamicValue(var138) && NIL == module0066.f4841(var91_141); var91_141 = module0066.f4840(var91_141)) {
                                            var138.resetMultipleValues();
                                            var150 = module0066.f4839(var91_141);
                                            var151 = var138.secondMultipleValue();
                                            var138.resetMultipleValues();
                                            if (NIL != module0141.f9289(var150)) {
                                                var33_141 = module0138.$g1624$.currentBinding(var138);
                                                try {
                                                    module0138.$g1624$.bind(var150, var138);
                                                    var152 = var151;
                                                    if (NIL != module0077.f5302(var152)) {
                                                        var153 = module0077.f5333(var152);
                                                        for (var154 = module0032.f1741(var153), var155 = (SubLObject)NIL, var155 = module0032.f1742(var154, var153); NIL == module0141.$g1685$.getDynamicValue(var138) && NIL == module0032.f1744(var154, var155); var155 = module0032.f1743(var155)) {
                                                            var156 = module0032.f1745(var154, var155);
                                                            if (NIL != module0032.f1746(var155, var156)) {
                                                                if (NIL != var137) {
                                                                    var139 = (SubLObject)NIL;
                                                                }
                                                                else {
                                                                    var139 = module0249.f16059(var156, (SubLObject)UNPROVIDED);
                                                                }
                                                                if (NIL == var139) {
                                                                    f16144(var156);
                                                                }
                                                        ...
                                                        if (NIL == module0141.$g1685$.getDynamicValue(var138)) {
                                                            var157 = var152;
                                                            var158 = (SubLObject)NIL;
                                                            var158 = var157.first();
                                                            while (NIL == module0141.$g1685$.getDynamicValue(var138) && NIL != var157) {
                                                                if (NIL != var137) {
                                                                    var139 = (SubLObject)NIL;
                                                                }
                                                                else {
                                                                    var139 = module0249.f16059(var158, (SubLObject)UNPROVIDED);
                                                                }
                                                                if (NIL == var139) {
                                                                    f16144(var158);
                                                                }
                                                        ...
                                                        Errors.error((SubLObject)$ic42$, var152);
                                                    }
                                                }
                                                finally {
                ...
                else if (NIL != module0155.f9785(var87_139, (SubLObject)UNPROVIDED)) {
                    var159 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var138), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var138), module0137.f8955((SubLObject)UNPROVIDED)));
                    for (var85_143 = (SubLObject)NIL, var85_143 = var159; NIL == module0141.$g1685$.getDynamicValue(var138) && NIL != var85_143; var85_143 = var85_143.rest()) {
                        ...
                        try {
                            ...
                            if (NIL != module0077.f5302(var162)) {
                                var163 = module0077.f5333(var162);
                                for (var164 = module0032.f1741(var163), var165 = (SubLObject)NIL, var165 = module0032.f1742(var164, var163); NIL == module0141.$g1685$.getDynamicValue(var138) && NIL == module0032.f1744(var164, var165); var165 = module0032.f1743(var165)) {
                                    var166 = module0032.f1745(var164, var165);
                                    if (NIL != module0032.f1746(var165, var166)) {
                                        if (NIL != var137) {
                                            var139 = (SubLObject)NIL;
                                        }
                                        else {
                                            var139 = module0249.f16059(var166, (SubLObject)UNPROVIDED);
                                        }
                                        if (NIL == var139) {
                                            f16144(var166);
                                        }
                                ...
                                if (NIL == module0141.$g1685$.getDynamicValue(var138)) {
                                    ...
                                    var168 = var167.first();
                                    while (NIL == module0141.$g1685$.getDynamicValue(var138) && NIL != var167) {
                                        if (NIL != var137) {
                                            var139 = (SubLObject)NIL;
                                        }
                                        else {
                                            var139 = module0249.f16059(var168, (SubLObject)UNPROVIDED);
                                        }
                                        if (NIL == var139) {
                                            f16144(var168);
                                        }
                                ...
                                Errors.error((SubLObject)$ic42$, var162);
                            }
                        }
                        finally {
    ...
    public static SubLObject f16151(final SubLObject var51) {
        ...
        for (var54 = (SubLObject)NIL, var54 = var53; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var54; var54 = var54.rest()) {
            ...
            try {
                ...
                if (NIL != module0138.f8992(var87_145)) {
                    var58 = module0242.f15664(var87_145, module0137.f8955((SubLObject)UNPROVIDED));
                    if (NIL != var58) {
                        var59 = module0245.f15834(var58, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                        if (NIL != var59) {
                            for (var60 = module0066.f4838(module0067.f4891(var59)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var60); var60 = module0066.f4840(var60)) {
                                ...
                                if (NIL != module0147.f9507(var61)) {
                                    ...
                                    try {
                                        module0138.$g1623$.bind(var61, var52);
                                        for (var91_147 = module0066.f4838(module0067.f4891(var62)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var91_147); var91_147 = module0066.f4840(var91_147)) {
                                            var52.resetMultipleValues();
                ...
                else if (NIL != module0155.f9785(var87_145, (SubLObject)UNPROVIDED)) {
                    var72 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED)));
                    for (var85_149 = (SubLObject)NIL, var85_149 = var72; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var85_149; var85_149 = var85_149.rest()) {
    ...
    public static SubLObject f16152(final SubLObject var51) {
        ...
        for (var54 = (SubLObject)NIL, var54 = var53; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var54; var54 = var54.rest()) {
            ...
            try {
                ...
                if (NIL != module0138.f8992(var151_152)) {
                    var58 = module0242.f15664(var151_152, module0137.f8955((SubLObject)UNPROVIDED));
                    if (NIL != var58) {
                        var59 = module0245.f15834(var58, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                        if (NIL != var59) {
                            for (var60 = module0066.f4838(module0067.f4891(var59)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var60); var60 = module0066.f4840(var60)) {
                                ...
                                if (NIL != module0147.f9507(var61)) {
                                    ...
                                    try {
                                        module0138.$g1623$.bind(var61, var52);
                                        for (var91_154 = module0066.f4838(module0067.f4891(var62)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var91_154); var91_154 = module0066.f4840(var91_154)) {
                                            var52.resetMultipleValues();
                    ...
                    if (NIL != module0200.f12419(var151_152, module0137.f8955((SubLObject)UNPROVIDED)) && NIL == module0141.$g1685$.getDynamicValue(var52)) {
                        var72 = module0248.f15995(var151_152);
                        var73 = (SubLObject)NIL;
                        var73 = var72.first();
                        while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var72) {
                            var74 = (var75 = var73);
                            var76 = (SubLObject)NIL;
                            var77 = (SubLObject)NIL;
                            var78 = (SubLObject)NIL;
                            cdestructuring_bind.destructuring_bind_must_consp(var75, var74, (SubLObject)$ic44$);
                            var76 = var75.first();
                            var75 = var75.rest();
                            cdestructuring_bind.destructuring_bind_must_consp(var75, var74, (SubLObject)$ic44$);
                            var77 = var75.first();
                            ...
                            if (NIL == var75) {
                                            ...
                                            try {
                                                ...
                                                if (NIL != module0077.f5302(var65)) {
                                                    ...
                                                    for (var67 = module0032.f1741(var66), var68 = (SubLObject)NIL, var68 = module0032.f1742(var67, var66); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0032.f1744(var67, var68); var68 = module0032.f1743(var68)) {
                                                        ...
                                                        if (NIL != module0032.f1746(var68, var52_165)) {
                                                            if (NIL == module0249.f16059(var52_165, (SubLObject)UNPROVIDED)) {
                                                                module0249.f16055(var52_165, (SubLObject)UNPROVIDED);
                                                                f16144(var52_165);
                                                            }
                                                            if (NIL != module0141.f9224()) {
                                                    ...
                                                    if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                                                        var12_166 = var65;
                                                        var52_166 = (SubLObject)NIL;
                                                        var52_166 = var12_166.first();
                                                        while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var12_166) {
                                                            if (NIL == module0249.f16059(var52_166, (SubLObject)UNPROVIDED)) {
                                                                module0249.f16055(var52_166, (SubLObject)UNPROVIDED);
                                                                f16144(var52_166);
                                                            }
                                                            if (NIL != module0141.f9224()) {
                                ...
                                cdestructuring_bind.cdestructuring_bind_error(var74, (SubLObject)$ic44$);
                            }
                            var72 = var72.rest();
                            var73 = var72.first();
                        }
                ...
                else if (NIL != module0155.f9785(var151_152, (SubLObject)UNPROVIDED)) {
                    var80 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED)));
                    for (var85_168 = (SubLObject)NIL, var85_168 = var80; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var85_168; var85_168 = var85_168.rest()) {
                        ...
                        try {
                            ...
                            if (NIL != module0077.f5302(var83)) {
                                ...
                                for (var85 = module0032.f1741(var84), var86 = (SubLObject)NIL, var86 = module0032.f1742(var85, var84); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0032.f1744(var85, var86); var86 = module0032.f1743(var86)) {
                                    var87 = module0032.f1745(var85, var86);
                                    if (NIL != module0032.f1746(var86, var87)) {
                                ...
                                if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                                    ...
                                    var89 = var88.first();
                                    while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var88) {
                                ...
                                Errors.error((SubLObject)$ic42$, var83);
                            }
                        }
                        finally {
    ...
    public static SubLObject f16153(final SubLObject var51) {
        ...
        for (var54 = (SubLObject)NIL, var54 = var53; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var54; var54 = var54.rest()) {
            ...
            try {
                ...
                if (NIL != module0138.f8992(var87_170)) {
                    var58 = module0242.f15664(var87_170, module0137.f8955((SubLObject)UNPROVIDED));
                    if (NIL != var58) {
                        var59 = module0245.f15834(var58, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                        if (NIL != var59) {
                            for (var60 = module0066.f4838(module0067.f4891(var59)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var60); var60 = module0066.f4840(var60)) {
                                ...
                                if (NIL != module0147.f9507(var61)) {
                                    ...
                                    try {
                                        module0138.$g1623$.bind(var61, var52);
                                        for (var91_172 = module0066.f4838(module0067.f4891(var62)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var91_172); var91_172 = module0066.f4840(var91_172)) {
                                            var52.resetMultipleValues();
                                                ...
                                                try {
                                                    ...
                                                    if (NIL != module0077.f5302(var65)) {
                                                        ...
                                                        for (var67 = module0032.f1741(var66), var68 = (SubLObject)NIL, var68 = module0032.f1742(var67, var66); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0032.f1744(var67, var68); var68 = module0032.f1743(var68)) {
                                                            ...
                                                            if (NIL != module0032.f1746(var68, var69)) {
                                                                if (NIL != module0249.f16059(var69, (SubLObject)UNPROVIDED)) {
                                                                    module0249.f16063(var69, (SubLObject)UNPROVIDED);
                                                                    f16144(var69);
                                                                }
                                                                if (NIL != module0141.f9224()) {
                                                                    f16146((SubLObject)ConsesLow.list(var51, var69));
                                                        ...
                                                        if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                                                            ...
                                                            while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var70) {
                                                                if (NIL != module0249.f16059(var71, (SubLObject)UNPROVIDED)) {
                                                                    module0249.f16063(var71, (SubLObject)UNPROVIDED);
                                                                    f16144(var71);
                                                                }
                                                                if (NIL != module0141.f9224()) {
                                                                    f16146((SubLObject)ConsesLow.list(var51, var71));
                ...
                else if (NIL != module0155.f9785(var87_170, (SubLObject)UNPROVIDED)) {
                    var72 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED)));
                    for (var85_174 = (SubLObject)NIL, var85_174 = var72; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var85_174; var85_174 = var85_174.rest()) {
                        ...
                        try {
                            ...
                            if (NIL != module0077.f5302(var75)) {
                                ...
                                for (var77 = module0032.f1741(var76), var78 = (SubLObject)NIL, var78 = module0032.f1742(var77, var76); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0032.f1744(var77, var78); var78 = module0032.f1743(var78)) {
                                    ...
                                    if (NIL != module0032.f1746(var78, var79)) {
                                        if (NIL != module0249.f16059(var79, (SubLObject)UNPROVIDED)) {
                                            module0249.f16063(var79, (SubLObject)UNPROVIDED);
                                            f16144(var79);
                                        }
                                        if (NIL != module0141.f9224()) {
                                            f16146((SubLObject)ConsesLow.list(var51, var79));
                                ...
                                if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                                    ...
                                    while (NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var80) {
                                        if (NIL != module0249.f16059(var81, (SubLObject)UNPROVIDED)) {
                                            module0249.f16063(var81, (SubLObject)UNPROVIDED);
                                            f16144(var81);
                                        }
                                        if (NIL != module0141.f9224()) {
                                            f16146((SubLObject)ConsesLow.list(var51, var81));
    ...
    public static SubLObject f16155(final SubLObject var1, final SubLObject var176, final SubLObject var3, final SubLObject var177, final SubLObject var178, final SubLObject var51) {
        ...
        try {
            ...
            module0141.f9230(module0249.f16019(var51, (SubLObject)UNPROVIDED));
            f16147(var51);
        }
        finally {
    ...
    public static SubLObject f16158(final SubLObject var1, final SubLObject var176, final SubLObject var3, final SubLObject var177, final SubLObject var178, final SubLObject var51) {
        assert NIL != module0137.f8885(var1) : var1;
        f16157(var1, var176, var3, var177, var178, var51, (SubLObject)T, (SubLObject)T);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16159(final SubLObject var1, final SubLObject var176, final SubLObject var3, final SubLObject var177, final SubLObject var178, final SubLObject var51, SubLObject var179) {
        ...
        assert NIL != module0137.f8885(var1) : var1;
        if (NIL != var179) {
            f16160(var1, var176, var3, var177, var178, var51, (SubLObject)T);
        }
        else {
            f16157(var1, var176, var3, var177, var178, var51, (SubLObject)T, (SubLObject)NIL);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16161(final SubLObject var1, final SubLObject var176, final SubLObject var3, final SubLObject var177, final SubLObject var178, final SubLObject var51, SubLObject var179) {
        ...
        assert NIL != module0137.f8885(var1) : var1;
        if (NIL != var179) {
            f16160(var1, var176, var3, var177, var178, var51, (SubLObject)UNPROVIDED);
        }
        else {
            f16157(var1, var176, var3, var177, var178, var51, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16162(final SubLObject var30, final SubLObject var51) {
        if (var30.eql((SubLObject)$ic1$)) {
            f16163(var51);
        }
        else if (var30.eql((SubLObject)$ic2$)) {
            f16164(var51);
        }
        else if (var30.eql((SubLObject)$ic3$)) {
            f16165(var51);
        }
        else if (var30.eql((SubLObject)$ic4$)) {
            f16166(var51);
        }
        else if (var30.eql((SubLObject)$ic5$)) {
            f16167(var51);
        }
        else if (var30.eql((SubLObject)$ic45$)) {
            f16168(var51);
        }
        else if (var30.eql((SubLObject)$ic46$)) {
            f16169(var51);
        }
        else {
            module0136.f8870((SubLObject)ONE_INTEGER, (SubLObject)$ic47$, var30, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16144(final SubLObject var51) {
        ...
        if (var53.eql((SubLObject)$ic48$)) {
            f16140(var51);
        }
        else if (var53.eql((SubLObject)$ic49$)) {
            f16141(var51);
        }
        else if (var53.eql((SubLObject)$ic50$)) {
            f16170(var51);
        }
        else if (var53.eql((SubLObject)$ic51$)) {
            f16171(var51);
        }
        else if (var53.eql((SubLObject)$ic52$)) {
            f16172(var51);
        }
        else if (var53.eql((SubLObject)$ic53$)) {
            f16173(var51);
        }
        else if (var53.eql((SubLObject)$ic54$)) {
            f16174(var51);
        }
        else if (var53.eql((SubLObject)$ic55$)) {
            f16175(var51);
        }
        else if (var53.eql((SubLObject)$ic56$)) {
            f16176(var51);
        }
        else if (var53.eql((SubLObject)$ic57$)) {
            f16137(var51);
        }
        else {
            Functions.funcall(var52, var51);
    ...
    public static SubLObject f16163(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16154(module0141.f9188(), module0138.f8979(), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic48$, var51, module0141.f9185());
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16168(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16156(module0141.f9188(), module0138.f8979(), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic48$, var51, module0141.f9185());
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16164(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16154(module0141.f9188(), module0138.f8980(), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic55$, var51, module0141.f9185());
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16175(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16159(module0141.f9188(), module0244.f15782(module0141.f9211(), module0137.f8955((SubLObject)UNPROVIDED)), module0141.f9294(), module0139.$g1636$.getDynamicValue(var52), (SubLObject)$ic56$, var51, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16176(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16154(module0141.f9192(), module0138.f8980(), module0141.f9293(), module0139.$g1636$.getDynamicValue(var52), (SubLObject)$ic48$, var51, module0141.f9185());
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16165(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16159(module0141.f9188(), module0244.f15782(module0141.f9211(), module0137.f8955((SubLObject)UNPROVIDED)), module0141.$g1714$.getDynamicValue(var52), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic50$, var51, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16170(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16154(module0244.f15771(module0137.f8955((SubLObject)UNPROVIDED)), (NIL != module0141.f9278()) ? module0138.f8979() : module0138.f8980(), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic48$, var51, module0141.f9185());
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16166(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16154(module0244.f15771(module0137.f8955((SubLObject)UNPROVIDED)), (NIL != module0141.f9278()) ? module0138.f8979() : module0138.f8980(), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic51$, var51, module0141.f9185());
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16171(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        if (NIL != module0141.f9269()) {
            module0055.f4021(var51, module0141.$g1701$.getDynamicValue(var52));
        }
        f16161(module0141.f9188(), module0244.f15782(module0141.f9211(), module0137.f8955((SubLObject)UNPROVIDED)), (NIL != module0141.f9278()) ? module0141.f9293() : module0141.f9294(), module0139.$g1636$.getDynamicValue(var52), (SubLObject)$ic48$, var51, module0141.f9185());
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16167(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        if (NIL != module0141.f9278() && NIL != module0141.f9165() && (NIL != f16177(var51) || NIL != f16178())) {
            if (NIL != module0141.f9168()) {
                if (NIL != f16178()) {
                ...
                module0141.$g1691$.setDynamicValue((SubLObject)T, var52);
            }
        }
        else {
            final SubLObject var53 = module0244.f15773(module0137.f8955((SubLObject)UNPROVIDED));
            f16154(var53, (NIL != module0141.f9278()) ? module0244.f15778(var53) : module0244.f15780(var53), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)((NIL != module0141.f9278()) ? ((NIL != module0141.f9165()) ? $ic54$ : $ic52$) : $ic58$), var51, module0141.f9185());
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16172(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16159(module0141.f9188(), module0138.f8977(), module0141.$g1714$.getDynamicValue(var52), module0139.$g1636$.getDynamicValue(var52), (SubLObject)$ic53$, var51, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16173(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        final SubLObject var53 = module0244.f15773(module0137.f8955((SubLObject)UNPROVIDED));
        f16154(var53, (NIL != module0141.f9278()) ? module0244.f15780(var53) : module0244.f15778(var53), module0141.$g1714$.getDynamicValue(var52), module0139.$g1636$.getDynamicValue(var52), (SubLObject)$ic48$, var51, module0141.f9185());
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16174(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16158(module0141.f9188(), module0138.f8977(), module0141.$g1714$.getDynamicValue(var52), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic59$, var51);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16179(final SubLObject var51) {
        final SubLObject var52 = module0248.f15931(module0244.f15769(module0141.f9188()), var51, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        SubLObject var53 = (SubLObject)NIL;
        var53 = module0004.f104(var51, var52, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        return var53;
    }
    
    public static SubLObject f16177(final SubLObject var51) {
        return module0252.f16282(module0244.f15773(module0137.f8955((SubLObject)UNPROVIDED)), var51, (SubLObject)$ic60$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f16178() {
        ...
        if (NIL != var185) {
            if (NIL == var186) {
                ...
                var188 = var187.first();
                while (NIL == var186 && NIL != var187) {
                    if (NIL != f16177(var188)) {
                        var186 = (SubLObject)T;
                    }
                    var187 = var187.rest();
                    var188 = var187.first();
    ...
    public static SubLObject f16180(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        final SubLObject var53 = module0244.f15773(module0137.f8955((SubLObject)UNPROVIDED));
        if (NIL == f16177(var51) && NIL != module0137.$g1609$.getDynamicValue(var52)) {
            f16154(var53, module0244.f15778(var53), module0141.f9293(), module0139.$g1636$.getDynamicValue(var52), (SubLObject)$ic48$, var51, (SubLObject)UNPROVIDED);
        }
        f16159(module0141.f9188(), module0138.f8977(), module0141.f9294(), module0139.$g1636$.getDynamicValue(var52), (SubLObject)$ic61$, var51, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16182(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        final SubLObject var53 = module0244.f15773(module0137.f8955((SubLObject)UNPROVIDED));
        f16154(var53, (NIL != module0141.f9278()) ? module0244.f15778(var53) : module0244.f15780(var53), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic62$, var51, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16183(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16161(module0141.f9188(), module0138.f8977(), (NIL != module0141.f9278()) ? module0141.f9293() : module0141.f9294(), module0139.$g1636$.getDynamicValue(var52), (SubLObject)$ic48$, var51, module0141.f9185());
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16184(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        final SubLObject var53 = module0244.f15773(module0137.f8955((SubLObject)UNPROVIDED));
        f16154(var53, (NIL != module0141.f9278()) ? module0244.f15778(var53) : module0244.f15780(var53), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic63$, var51, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f16185(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        f16161(module0141.f9188(), module0138.f8977(), (NIL != module0141.f9278()) ? module0141.f9293() : module0141.f9294(), module0139.$g1636$.getDynamicValue(var52), (SubLObject)$ic59$, var51, module0141.f9185());
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16186(SubLObject var186) {
        ...
        if (NIL == module0244.f15770(module0141.f9188())) {
            module0136.f8870((SubLObject)ONE_INTEGER, (SubLObject)$ic66$, module0141.f9188(), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            return (SubLObject)NIL;
        }
        if (NIL != var186) {
    ...
    public static SubLObject f16169(final SubLObject var51) {
        ...
        try {
            module0141.$g1681$.bind((SubLObject)$ic67$, var52);
            module0141.$g1682$.bind((SubLObject)T, var52);
            f16156(module0244.f15771(module0137.f8955((SubLObject)UNPROVIDED)), module0138.f8979(), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic68$, var51, (SubLObject)NIL);
        }
        finally {
    ...
    public static SubLObject f16188(final SubLObject var51) {
        ...
        try {
            module0141.$g1682$.bind((SubLObject)NIL, var52);
            if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
                f16161(module0141.f9188(), module0244.f15782(module0141.f9211(), module0137.f8955((SubLObject)UNPROVIDED)), module0141.f9293(), module0139.$g1636$.getDynamicValue(var52), (SubLObject)$ic48$, var51, (SubLObject)NIL);
                if (NIL == module0141.$g1685$.getDynamicValue(var52)) {
    ...
    public static SubLObject f16189(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        if (NIL != module0249.f16068(var51, (SubLObject)UNPROVIDED)) {
            if (NIL != module0141.f9271(var51) && !module0249.f16069(var51, (SubLObject)UNPROVIDED).numE(module0139.f9068())) {
                module0139.f9067();
            }
        }
        else {
            module0249.f16070(var51, (SubLObject)UNPROVIDED);
            if (NIL != module0141.f9271(var51)) {
                final SubLObject var53 = module0200.f12443(module0137.f8955((SubLObject)UNPROVIDED));
                SubLObject var54;
                SubLObject var55;
                SubLObject var56;
                ...
                for (var54 = (SubLObject)NIL, var54 = var53; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var54; var54 = var54.rest()) {
                    ...
                    try {
                        ...
                        if (NIL != module0138.f8992(var87_187)) {
                            var58 = module0242.f15664(var87_187, module0137.f8955((SubLObject)UNPROVIDED));
                            if (NIL != var58) {
                                var59 = module0245.f15834(var58, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                                if (NIL != var59) {
                                    for (var60 = module0066.f4838(module0067.f4891(var59)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var60); var60 = module0066.f4840(var60)) {
                                        ...
                                        if (NIL != module0147.f9507(var61)) {
                                            ...
                                            try {
                                                module0138.$g1623$.bind(var61, var52);
                                                for (var91_189 = module0066.f4838(module0067.f4891(var62)); NIL == module0141.$g1685$.getDynamicValue(var52) && NIL == module0066.f4841(var91_189); var91_189 = module0066.f4840(var91_189)) {
                                                    var52.resetMultipleValues();
                        ...
                        else if (NIL != module0155.f9785(var87_187, (SubLObject)UNPROVIDED)) {
                            var72 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var52), module0137.f8955((SubLObject)UNPROVIDED)));
                            for (var85_191 = (SubLObject)NIL, var85_191 = var72; NIL == module0141.$g1685$.getDynamicValue(var52) && NIL != var85_191; var85_191 = var85_191.rest()) {
                ...
                if (module0249.f16069(var51, (SubLObject)UNPROVIDED).numE(module0139.f9068())) {
                    module0139.f9067();
                    f16146(var51);
                }
            }
    ...
    public static SubLObject f16190(final SubLObject var1, final SubLObject var51, final SubLObject var193, SubLObject var8, SubLObject var3) {
        ...
        try {
            ...
            module0141.$g1674$.bind((SubLObject)NIL, var194);
            ...
            try {
                ...
                try {
                    module0141.$g1714$.bind((NIL != var202) ? var202 : module0141.f9283(), var194);
                    module0141.$g1715$.bind((SubLObject)((NIL != var202) ? $ic69$ : module0141.$g1715$.getDynamicValue(var194)), var194);
                    if (NIL != var202 && NIL != module0136.f8864() && NIL == module0141.f9279(var202)) {
                        final SubLObject var203 = module0136.$g1591$.getDynamicValue(var194);
                        if (var203.eql((SubLObject)$ic70$)) {
                            module0136.f8870((SubLObject)ONE_INTEGER, (SubLObject)$ic71$, var202, (SubLObject)$ic72$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                        }
                        else if (var203.eql((SubLObject)$ic73$)) {
                            module0136.f8871((SubLObject)ONE_INTEGER, (SubLObject)$ic74$, (SubLObject)$ic71$, var202, (SubLObject)$ic72$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                        }
                        else if (var203.eql((SubLObject)$ic75$)) {
                            Errors.warn((SubLObject)$ic71$, var202, (SubLObject)$ic72$);
                        }
                        else {
                            Errors.warn((SubLObject)$ic76$, module0136.$g1591$.getDynamicValue(var194));
                            Errors.cerror((SubLObject)$ic74$, (SubLObject)$ic71$, var202, (SubLObject)$ic72$);
                        }
                    }
                    ...
                    try {
                        module0141.$g1710$.bind($ic77$, var194);
                        module0141.$g1677$.bind(module0141.f9210(), var194);
                        module0138.$g1619$.bind(module0244.f15780(module0137.f8955((SubLObject)UNPROVIDED)), var194);
                        final SubLObject var204 = module0139.f9036();
                        final SubLObject var33_198 = module0139.$g1635$.currentBinding(var194);
                        try {
                            module0139.$g1635$.bind((var204 == $ic13$) ? module0139.$g1635$.getDynamicValue(var194) : module0139.f9038(var204), var194);
                            final SubLObject var33_199 = module0139.$g1636$.currentBinding(var194);
                            try {
                                module0139.$g1636$.bind((var204 == $ic13$) ? module0139.$g1636$.getDynamicValue(var194) : module0139.f9038(var204), var194);
                                ...
                                try {
                                    module0141.$g1685$.bind((SubLObject)NIL, var194);
                                    module0141.$g1686$.bind((SubLObject)NIL, var194);
                                    module0141.$g1683$.bind((SubLObject)NIL, var194);
                                    module0141.$g1684$.bind((SubLObject)NIL, var194);
                                    module0141.$g1674$.bind((SubLObject)NIL, var194);
    ...
    public static SubLObject f16191(final SubLObject var51, final SubLObject var193) {
        ...
        try {
            module0141.$g1681$.bind((SubLObject)$ic79$, var194);
            module0141.$g1703$.bind(var193, var194);
            module0141.$g1691$.bind((SubLObject)NIL, var194);
            try {
                final SubLObject var33_214 = module0139.$g1654$.currentBinding(var194);
                try {
                    module0139.$g1654$.bind((SubLObject)ZERO_INTEGER, var194);
                    f16189(var51);
                }
                finally {
                ...
                try {
                    Threads.$is_thread_performing_cleanupP$.bind((SubLObject)T, var194);
    ...
    public static SubLObject f16192(final SubLObject var51) {
        ...
        if (NIL != module0244.f15752(module0141.f9188())) {
            if (NIL != module0141.f9195()) {
                module0141.$g1691$.setDynamicValue(module0035.f2056(module0137.f8955($ic80$), var51, module0141.$g1691$.getDynamicValue(var52), (SubLObject)UNPROVIDED), var52);
            }
            else {
                module0141.$g1691$.setDynamicValue(module0035.f2056(module0137.f8955($ic81$), var51, module0141.$g1691$.getDynamicValue(var52), (SubLObject)UNPROVIDED), var52);
            }
        }
        else {
            module0141.$g1691$.setDynamicValue((SubLObject)ConsesLow.cons(var51, module0141.$g1691$.getDynamicValue(var52)), var52);
    ...
    public static SubLObject f16193(final SubLObject var51) {
        final SubLThread var52 = SubLProcess.currentSubLThread();
        final SubLObject var53 = module0244.f15773(module0137.f8955((SubLObject)UNPROVIDED));
        f16154(var53, module0244.f15780(var53), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic82$, var51, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f16194(final SubLObject var51) {
        ...
        try {
            ...
            final SubLObject var54 = module0244.f15773(module0137.f8955((SubLObject)UNPROVIDED));
            f16154(var54, module0244.f15778(var54), module0141.f9293(), module0139.$g1635$.getDynamicValue(var52), (SubLObject)$ic54$, var51, (SubLObject)UNPROVIDED);
        }
        finally {
    ...
    public static SubLObject f16145(final SubLObject var51, final SubLObject var52) {
        final SubLObject var53 = module0137.f8955((SubLObject)UNPROVIDED);
        ...
        if (NIL == module0035.f2169(var54, (SubLObject)$ic83$)) {
            Errors.error((SubLObject)$ic84$, var54);
        }
        if (NIL != module0173.f10955(var57) && NIL != var56) {
            final SubLObject var58 = (var54 == $ic85$) ? module0202.f12768(var57, var52, var51) : module0202.f12768(var57, var51, var52);
            final SubLObject var59 = f16105(var58, var56, var55);
            if (NIL == assertion_handles_oc.f11035(var59)) {
                Errors.sublisp_break((SubLObject)$ic86$, new SubLObject[] { var51, var52, var54 });
            }
            if (NIL != assertion_handles_oc.f11035(var59)) {
                return module0159.f10364(var59);
            }
        }
        return Errors.warn((SubLObject)$ic87$, var51, var52);
    }
    ...
    static {
        ...
        $ic1$ = makeSymbol("S#18907", "CYC");
        $ic2$ = makeSymbol("S#18908", "CYC");
        $ic3$ = makeSymbol("S#18911", "CYC");
        $ic4$ = makeSymbol("S#18913", "CYC");
        $ic5$ = makeSymbol("S#18915", "CYC");
        $ic6$ = makeString("Search behavior not recognized. Sorry.");
        $ic7$ = makeString("Search Behavior not recognized: ~a");
        $ic8$ = makeKeyword("TRUE");
        $ic9$ = makeKeyword("TRUE-DEF");
        $ic10$ = makeKeyword("FALSE");
        $ic11$ = makeKeyword("FALSE-DEF");
        $ic12$ = ConsesLow.list((SubLObject)makeSymbol("S#155", "CYC"), (SubLObject)makeSymbol("S#750", "CYC"), (SubLObject)makeSymbol("S#751", "CYC"));
        $ic13$ = makeKeyword("OLD");
        $ic14$ = makeKeyword("ASSERTION");
        $ic15$ = makeKeyword("VERBOSE");
        $ic16$ = makeString("incorrect justification assembly ~a");
        $ic17$ = makeKeyword("REFLEXIVE");
        $ic18$ = constant_handles_oc.f8479((SubLObject)makeString("equals"));
        $ic19$ = constant_handles_oc.f8479((SubLObject)makeString("MonotonicallyTrue"));
        $ic20$ = makeSymbol("S#11667", "CYC");
        $ic21$ = makeSymbol("S#11668", "CYC");
        $ic22$ = makeString("~S is not a transitive module");
        $ic23$ = constant_handles_oc.f8479((SubLObject)makeString("UniversalVocabularyMt"));
        $ic24$ = constant_handles_oc.f8479((SubLObject)makeString("disjointWith"));
        $ic25$ = makeSymbol("S#11503", "CYC");
        $ic26$ = makeSymbol("S#11502", "CYC");
        $ic27$ = makeSymbol("S#18935", "CYC");
        $ic28$ = makeSymbol("S#18868", "CYC");
        $ic29$ = makeString("Using potentially unsupported gather gating behavior: ~a");
        $ic30$ = makeString("Using potentially unsupported unmark gather gating behavior: ~a");
        $ic31$ = ConsesLow.list((SubLObject)makeSymbol("S#3267", "CYC"), (SubLObject)makeSymbol("S#15403", "CYC"));
        $ic32$ = makeSymbol("S#18870", "CYC");
        $ic33$ = makeSymbol("S#18872", "CYC");
        $ic34$ = makeSymbol("S#15382", "CYC");
        $ic35$ = makeSymbol("S#15385", "CYC");
        $ic36$ = makeSymbol("S#18876", "CYC");
        $ic37$ = makeSymbol("S#18877", "CYC");
        $ic38$ = makeSymbol("S#18873", "CYC");
        $ic39$ = makeSymbol("S#18875", "CYC");
        $ic40$ = makeSymbol("S#18848", "CYC");
        $ic41$ = makeSymbol("S#18878", "CYC");
        ...
        $ic44$ = ConsesLow.list((SubLObject)makeUninternedSymbol("US#4D5E436"), (SubLObject)makeUninternedSymbol("US#1526883"), (SubLObject)makeUninternedSymbol("US#15AA083"));
        $ic45$ = makeSymbol("S#15390", "CYC");
        $ic46$ = makeSymbol("S#15389", "CYC");
        $ic47$ = makeString("attempt to call unsupported sbhl search behavior: ~a~%");
        $ic48$ = makeSymbol("S#18886", "CYC");
        $ic49$ = makeSymbol("S#18887", "CYC");
        $ic50$ = makeSymbol("S#18912", "CYC");
        $ic51$ = makeSymbol("S#18914", "CYC");
        $ic52$ = makeSymbol("S#18916", "CYC");
        $ic53$ = makeSymbol("S#18917", "CYC");
        $ic54$ = makeSymbol("S#18918", "CYC");
        $ic55$ = makeSymbol("S#18909", "CYC");
        $ic56$ = makeSymbol("S#18910", "CYC");
        $ic57$ = makeSymbol("S#18847", "CYC");
        $ic58$ = makeSymbol("S#18921", "CYC");
        $ic59$ = makeSymbol("S#18849", "CYC");
        $ic60$ = makeSymbol("S#18850", "CYC");
        $ic61$ = makeSymbol("S#18922", "CYC");
        $ic62$ = makeSymbol("S#18852", "CYC");
        $ic63$ = makeSymbol("S#18925", "CYC");
        $ic64$ = makeSymbol("S#18880", "CYC");
        $ic65$ = makeSymbol("S#18879", "CYC");
        $ic66$ = makeString("invalid module type ~a");
        $ic67$ = makeSymbol("S#18928", "CYC");
        $ic68$ = makeSymbol("S#18927", "CYC");
        $ic69$ = makeSymbol("S#11450", "CYC");
        $ic70$ = makeKeyword("ERROR");
        $ic71$ = makeString("~A is not a ~A");
        $ic72$ = makeSymbol("S#11592", "CYC");
        $ic73$ = makeKeyword("CERROR");
        $ic74$ = makeString("continue anyway");
        $ic75$ = makeKeyword("WARN");
        $ic76$ = makeString("~A is not a valid *sbhl-type-error-action* value");
        $ic77$ = constant_handles_oc.f8479((SubLObject)makeString("True-JustificationTruth"));
        $ic78$ = makeKeyword("RESOURCE");
        $ic79$ = makeSymbol("S#18932", "CYC");
        $ic80$ = constant_handles_oc.f8479((SubLObject)makeString("genlInverse"));
        $ic81$ = constant_handles_oc.f8479((SubLObject)makeString("genlPreds"));
        $ic82$ = makeSymbol("S#18934", "CYC");
        $ic83$ = ConsesLow.list((SubLObject)makeKeyword("PREDICATE"), (SubLObject)makeKeyword("INVERSE"));
        $ic84$ = makeString("Unexpected direction : ~S");
        $ic85$ = makeKeyword("INVERSE");
        $ic86$ = makeString("KB access missed for SBHL ~S to ~S for ~S");
        $ic87$ = makeString("KB access missed for SBHL ~S to ~S");
    }
