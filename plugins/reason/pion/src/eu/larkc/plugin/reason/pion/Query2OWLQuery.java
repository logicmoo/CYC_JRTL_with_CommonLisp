...
public class Query2OWLQuery {
	...
	public static List<String> getLiteralsFromBasicPattern(BasicPattern pattern)
	{
...
//		  Node predicate =  t.getPredicate();
		 ...
		 if (subject.isConcrete()) {result.add(removePrefix(subject.toString()));}
		  if (object.isConcrete()) {result.add(removePrefix(object.toString()));}
...
//	      System.out.println("Basic pattern ="+triples);
	...
	public static String BasicPattern2OWLQuery(BasicPattern pattern)
	{
...
//		  System.out.println("the triple from ID = " +tt );
		  ...
		  { answer1 =""; // anything on rdf:type owl:Class checking, it is assumed to be true.
			 ...
			 { 
				 answer1 ="<AreClasesDisjoint kb ="+ kb + ">"+ OWL("owl:Class", subject.toString())+ OWL("owl:Class", object.toString())+ "</AreClassesDisjoint>";	 	 
			//answer1 ="<disjoint id ="+ ID + ">"+ DIG("catom", subject.toString())+ DIG("catom", object.toString())+ "</disjoint>";	 
	//			 org.w3c.dom.Element e = docAnswer.createElement("AreClassesDisjoint");
    ...
    //             org.w3c.dom.Element e1;
			 ...
			 { answer1 ="<IsInstanceOf kb ="+ kb + ">"+ OWL("ox:Individual", subject.toString())+ OWL("owl:Class", object.toString())+ "</IsInstanceOf>";	 
			 iter.remove();}

			 
			 else if ((subject.isVariable())&& predicate.hasURI("http://www.w3.org/1999/02/22-rdf-syntax-ns#type")&&(object.isConcrete()) )
			 { answer1 ="<GetInstances kb ="+ kb + ">"+ OWL("owl:Class", object.toString())+ "</GetInstances>";	 
			 iter.remove();}
			 ...
			 {  iter.remove();	 
			 answer1 ="<IsClassSubsumedBy kb ="+ kb + ">"+ OWL("owl:Class", subject.toString())+ OWL("owl:Class", object.toString())+ "</IsClassSubsumedBy>";			   
			 }
...
//			 }
			 ...
			 {  iter.remove();
			 answer1 = "<GetEquivalentClasses kb="+ kb + ">"+ OWL("owl:Class", subject.toString())+"</GetEquivalentClassses>";			   
			 }
			 else if ((object.isConcrete())&& predicate.hasURI("owl:equivalentClass") )
			 {  iter.remove();
			 answer1 = "<GetEquivalentClasses kb="+ kb + ">"+ OWL("catom", object.toString())+"</GetEquivalentClasses>";			   
			 }
...
//		 System.out.println("Answer2="+answer2);
		  ...
		  {case 1: answer2=Variable2OWLConcept(object, pattern);
			  if (answer2==null){
		     answer ="<GetTypes kb ="+ kb + ">"+ OWL("Individual", subject.toString())+ "</GetTypes>";	 }
		     else {answer ="<IsInstanceOf kb ="+ kb + ">"+ OWL("Individual", subject.toString())+answer2 + "</IsInstanceOf>";	};
		     break;
		  case 2: answer2=Variable2OWLConcept(subject, pattern);
			  if (answer2==null)
		  { answer = "<descendants kb ="+ kb + ">"+ OWL("owl:Class", object.toString())+ "</descendants>";	 
			  } else {answer = "<ancestors kb ="+ kb + ">"+ answer2+ "</ancestors>";};
		     break;
		     
		  case 5:answer2=Variable2OWLConcept(object, pattern);
			     if (answer2==null){
			     answer ="<ancestors kb ="+ kb + ">"+ OWL("owl:Class", subject.toString())+ "</ancestors>";	 }
			     else {answer ="<IsSuperClassOf kb ="+ kb + ">"+ answer2 + OWL("owl:Class", subject.toString()) + "</IsSuperClassOf>";	};
			     break; 
			     
		  case 6: answer2=Variable2OWLConcept(object, pattern);
			     if (answer2==null){
			     answer ="<error id ="+ kb + "unsupported disjoint query"+ "</error>";	 }
			     else {answer ="<IsDisjointClass kb ="+ kb + ">"+ answer2 + OWL("owl:Class", subject.toString()) + "</IsDisjointClass>";	};
			     break; 
			     
		  case 7: answer1=Variable2OWLConcept(subject, pattern);
			     if (answer1==null){
			     answer ="<error id ="+ kb + "unsupported disjoint query"+ "</error>";	 }
			     else {answer ="<IsDisjointClass kb ="+ kb + ">"+ answer1 + OWL("owl:Class", object.toString()) + "</IsDisjointClass>";	};
			     break; 
			     
		  case 8: answer1=Variable2OWLConcept(subject, pattern);
		          answer2=Variable2OWLConcept(object, pattern);
		     if (answer1==null||answer2==null){
		     answer ="<error kb ="+ kb + "unsupported disjoint query"+ "</error>";	 }
		     else {answer ="<IsDisjointClass kb ="+ kb + ">"+ answer1 + answer2 + "</IsDisjointClass>";	};
		     break; 
