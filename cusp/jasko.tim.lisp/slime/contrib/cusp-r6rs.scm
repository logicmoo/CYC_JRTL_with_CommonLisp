;; cusp-r6rs.sls --- Shareable code between cusp-ikarus and cusp-larceny
;;
;; Licence: public domain
;; Author: Helmut Eller
;;
;; This is a Cusp server barely capable enough to process simple eval
...
;;
;; Despite standard modules, this file uses (cusp os) and (cusp sys)
...
(library (cusp)
 ...
 (define rpc-entries (environment '(prefix (cusp rpc) cusp:)))
