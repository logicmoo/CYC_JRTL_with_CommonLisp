 ...
 */
public class LarKCImplementation extends LispImplementation {
	
	/**
	 * @return Lisp implementation found in the preferences, or null if none is found
	 */
	static public LarKCImplementation findImplementation() {
		return new LarKCImplementation();
	}
