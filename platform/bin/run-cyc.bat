...
if  "%1"=="00" set PORT_OFFSET=%DEFAULT_PORT_OFFSET%
if  "%1"=="20" set /a PORT_OFFSET=%DEFAULT_PORT_OFFSET%+%1
if  "%1"=="40" set /a PORT_OFFSET=%DEFAULT_PORT_OFFSET%+%1
if  "%1"=="60" set /a PORT_OFFSET=%DEFAULT_PORT_OFFSET%+%1
if  "%1"=="80" set /a PORT_OFFSET=%DEFAULT_PORT_OFFSET%+%1

:port_set
echo PORT_OFFSET = %PORT_OFFSET%

set INIT_FORM="(progn (load \"init/jrtl-release-init.lisp\") (csetq *base-tcp-port* %PORT_OFFSET%) (load \"init/port-init.lisp\"))"
