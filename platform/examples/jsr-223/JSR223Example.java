...
public class JSR223Example {
	...
	public static void main(String[] args) {
		...
		try {
			...
			((Invocable) lispEngine).invokeFunction("hello", VA("world"));

			// Implementing a Java interface in Lisp
			lispEngine.eval("(defun compare-to (&rest args) 42)");
			Comparable c = (Comparable) ((Invocable) lispEngine).getInterface(java.lang.Comparable.class);
	 ...
	 * @return
	 */
	private static Object[] VA(Object... string) {
		return string;
	}
