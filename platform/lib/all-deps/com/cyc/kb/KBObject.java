...
public interface KBObject {
   ...
   * <code>p</code> with <code>this</code> at position <code>thisArgPos</code> of the Fact
   * <p>
   *
  ...
  /**
   * This method gets asserted facts visible from
   * <code>ctx</code> with predicate represented by
   * <code>pred</code> and
   ...
   * @param ctxStr  the string representation of the context. If set to "", returns
   * facts from the default context {@link KBAPIDefaultContext#forQuery()}
   *
   * @return a collection of objects of type O
   *
   * @see {@link #getFacts(KBPredicate, int, Context)} for a method that returns the
  ...
  /**
   * This method gets all facts visible from
   * <code>ctx</code> that use predicate
   * <code>pred</code>, have
   * <code>this</code> in the
   * <code>thisArgPos</code> arg position, and also have
   * <code>matchArg</code> in the
   * <code>matchArgPos</code> arg position; it returns a list of
   * <code>O</code> objects from the
   * <code>getArgPos</code> argument position of the fact.
   *
   * @param pred	the predicate of the facts
   ...
   * <p>
   * The method finds a Fact in the KB with predicate
   * <code>pred</code>, and
   * <code>this</code> at the argument position
   * <code>thisArgPos</code>, in the context
   * <code>ctx</code>. The otherArgs specify all the arguments of the Fact,
   * completely. If the fact specified by the input arguments is not found,
   * creates and persists a new fact in the underlying KB.
   *
   * Note: Not all subclasses of the KB objects are directly assertible. For example, 
   * Sentence, Variable and Symbol need to be quoted, using Quote method, before they
   * can participate in closed assertions.
   * 
   * Note: The context is the first argument in methods that have variable number of
   * arguments. In all other methods, context is the last argument.
   * 
  ...
  /**
   * get all collections that the <code>this</code> object is a quoted instance of.
   * The collections are instance of <code>SubLExpressionType</code>. 
   * <p>
   * All subclasses of KBObject can be quoted. Refer to 
   * <code>#$NoteAboutQuotingInCycL</code> for a more detailed
   * discussion of quoting. 
   * 
   * @return the collection of KBCollections that <code>this</code> is quoted instance
   * of
   */
   ...
   * discussion of quoting. 
   * 
   * @param c   the instance of SubLExpressionType, the collection <code>this<code>
   * is quoted instance of. 
   * 
   ...
   * @throws KBTypeException 
   */
  public void addQuotedIsa(KBCollection c, Context ctx)
      throws KBTypeException, CreateException;

  /**
   * creates a new
   * <code>Fact</code> stating that <code>this</code>
   * <code>KBIndividual</code> instantiates the
   * <code>#$Collection</code> represented by
   * <code>col</code> in the context represented by
   * <code>ctx</code>. Effectively, this asserts
   * <code>(#$isa this col)</code>.
   * <p>
   *
   * @param colStr the string representing the KBCollection this
  ...
  /**
   * creates a new
   * <code>Fact</code> stating that this
   * <code>KBIndividual</code> instantiates the
   * <code>col</code> in
   * <code>ctx</code>. Effectively, this asserts
   * <code>(#$isa this col)</code>.
  ...
  /**
   * Is
   * <code>this</code> an instance of
   * <code>col</code> in any context?
   *  This does not require that
   * <code>(#$isa this col)</code> be asserted, merely that it be
   * trivially inferrible.
   *
   * @param col the collection which <code>this</code> may or may not be
   * an instance of
   * 
   ...
   * Is 
   * <code>this</code> an instance of
   * <code>col</code> in any context? This does not require that
   * <code>(#$isa this col)</code> be asserted, merely that it be
   * trivially inferrible.
   *
   * @param colStr the string representing the collection which <code>this</code> may or may not be
   * an instance of
   * 
   * @return whether <code>this</code> is trivially provable to be an instance
   * of <code>col</code>
   ...
   * Is
   * <code>this</code> an instance of
   * <code>col</code> in context <code>ctx</code>? This does not require that
   * <code>(#$isa this col)</code> be asserted, merely that it be
   * trivially inferrible.
   * 
   * @param col the collection which <code>this</code> may or may not be
   ...
   * @param ctxStr the string representation of the context where the 
   * instance relation holds
   * 
   * @return whether <code>this</code> is trivially provable to be an instance
   * of <code>col</code>
   */
  ...
  /**
   * Is
   * <code>this</code> a quoted instance of
   * <code>col</code> in any context? Essentially this verifies that 
   * <code>(#$quotedIsa this col)</code> is true in some context. 
   *
   * Refer to 
   * <code>#$NoteAboutQuotingInCycL</code> for a more detailed
   * discussion of quoting.
   * 
   * @param col the collection which <code>this</code> may or may not be
   * a quoted instance of
   * 
   * @return whether <code>this</code> is provable to be a quoted instance
   * of <code>col</code>
   */
   ...
   * discussion of quoting.
   * 
   * @param colStr the string representation of the collection which <code>this</code> may or may not be
   * a quoted instance of
   * 
   * @return whether <code>this</code> is provable to be a quoted instance
   * of <code>col</code>
   ...
   * Is
   * <code>this</code> a quoted instance of
   * <code>col</code>? Essentially this verifies that 
  ...
  /**
   * Is there an assertion in
   * <code>ctx</code> with a sentence using
   * <code>pred</code>, with
   * <code>this</code> in the
   * <code>thisArgPos</code> argument position, and with the arguments in
   * <code>otherArgs</code> as the rest of its arguments? This method will not
   * throw exceptions. Effectively, this is a wrapper around {@link #getFact()}
   ...
   * 
   * @return true iff the fact is determined to be true.
   */
  public boolean isAsserted(Context ctx, KBPredicate pred,
      int thisArgPos, Object... otherArgs);

  /**
   * find the specific existing Fact, in
   * <code>ctx</code>, that has
   * <code>pred</code> as its predicate,
   * <code>this</code> in the
   * <code>thisArgPos</code> argument position, and
   * <code>otherArgs</code> as its other arguments. Effectively,
   * <code>this</code> is inserted into position
   * <code>thisArgPos</code> of
   * <code>otherArgs</code> to form the arguments for a Fact that is searched
   * for in the KB. If an assertion using that sentence is found in the context,
   * the Fact is returned. If no such assertion is found, appropriate exception is
   * thrown.
   *
   * Note: The context is the first argument in methods that have variable number of
   * arguments. In all other methods, context is the last argument.
   ...
   * @param thisArgPos  the position where <code>this</code> is found in the fact
   * @param otherArgs the arguments in positions other than 0 and thisArgPos. They have to be
  ...
  public Sentence getSentence(KBPredicate pred, int thisArgPos,
      Object... otherArgs) throws KBTypeException;
  ...
  /**
   * gets all the comments for <code>this</code> visible from 
   * the default context {@link KBAPIDefaultContext#forQuery()}
   * <p>
   *
  ...
  /**
   * Add a new comment for
   * <code>this</code> in the context specified
   * <p>
   *
   * In the CycKB comments can be added only on <code>#$CycLIndexedTerm</code>s, which
   * include <code>CycLReifiableDenotationalTerm</code> and <code>CycLAssertion</code>. 
   * An exception will be thrown if attempted to add a comment on Quoted terms, Sentence,
   * Variable and Symbol. This means that only subclasses of KBTerm and Assertion can 
   * have comments. 
   * 
  ...
  /**
   * gets the object in
   * <code>getPos</code> argument position of this KBObject as an object of type
   * <code>O</code>. This method works for Sentences and Assertions, as
   * well as non-atomic KBTerms. However, because a constant has no "arguments",
   * calling this method on a KBObject representing a Cyc constant will result
   * in a KBApiException.
   *
   ...
   * this to test for term automicity, use {@link #isAtomic()} instead.
   * @throws IllegalArgumentException for a class of object types which do not support getArgument.
   * Example include: Variable, Symbol   
   */
   ...
   * <code>KBObject</code>s that represent Cyc constants, Cyc variables, or
   * Cyc symbols. It returns false for anything else.
   *
   * @return true iff this KBObject is not decomposable into other constituent
   * KBObjects.
   * 
  ...
  /**
   * Does
   * <code>this</code> correspond to any kind of Cyc assertion?
   *
   * @return true iff this object is an assertion
   */
   ...
   * 
   * @see org.opencyc.cycobject.CycConstant
   * @see org.opencyc.cycobject.CycFormula#getArity()
   */
   ...
   * <code>toString</code> that is suitable for use when talking directly to a
   * Cyc server via methods in {@link org.opencyc.api.CycAccess}.
   * <p>
  ...
  /**
   * delete
   * <code>this</code> term and all the facts using it in the KB.
   * <p>
  ...
  /**
   * Change the name of this object to
   * <code>name</code>. Throws {@link InvalidNameException} in cases where the rename cannot
   * be completed, for any reason, one of the reasons could be that the name does not conform
   * to Cyc constant-naming conventions. Among objects that cannot be renamed are non-atomic terms,
   * assertions, and constant that are mentioned in server code. An {@link UnsupportedOperationException}
   * will be thrown if attempted to rename Assertion or Non-atomic terms. 
   *
   * @param name the new name
   * 
   * @throws InvalidNameException if Cyc Server errors out for any reason, including invalid name 
   * @throws UnsupportedOperationException if the object being renamed is not {@link #isAtomic()}
   * 
   * @throws KBApiException if the operation cannot be completed.
   */
  ...
  /**
   * get the CycL representation of
   * <code>this</code> as a String. This representation should be suitable for
   * use with the KBObject factory methods, but may not be suitable for use with
   * lower-level APIs. It should not be expected to contain "#$"
   * constant-prefixes.
   *
   * @return
   */
  ...
  /**
   * Returns a stable, globally unique ID for
   * <code>this</code>. In terms of Cyc-specific nomenclature, this Id is the
   * compact, hl external ID for the underlying Cyc object.
   *
   * Generally the HL IDs of indexed terms <code>#$CycLIndexedTerm</code>s are useful.
   * Cyc can generate HL IDs for Sentences, Variables and Symbols.  
   *  
  ...
  /**
   * Does
   * <code>this</code> represent the same object in the KB as
  ...
  /**
   * A quoted object refers to the object itself and not its meaning. For example,
   * (#$Quote #$Plato) refers to the term #$Plato, and not to the philosopher.
   * 
   * Refer to 
   * <code>#$NoteAboutQuotingInCycL</code> for a more detailed
   * discussion of quoting.
