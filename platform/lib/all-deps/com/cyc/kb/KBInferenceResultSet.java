...
//import org.opencyc.inference.AbstractResultSet;
//import org.opencyc.inference.InferenceIdentifier;
//import org.opencyc.inference.InferenceResultSet;

/**
 * <P>KBInferenceResultSet provides a class for easy access and manipulation
 ...
 * InferenceResultSet is zero-based while java.sql.ResultSet is one-based.
 * 
 * @author daves
 */
...
public class KBInferenceResultSet  implements ResultSet {

  private InferenceResultSet rs;
  
  public KBInferenceResultSet(List<Object> results) {
    this.rs = new DefaultResultSet(results);
  }

  public KBInferenceResultSet(InferenceResultSet rs) {
    this.rs = rs;
  }
  ...
  public <T> T getObject(int columnIndex, Class<T> type) throws SQLException {
    ...
    try {
      ...
      Logger.getLogger(KBInferenceResultSet.class.getName()).log(Level.SEVERE, null, ex);
  ...
  public <T> T getKBObject(String columnLabel) throws SQLException {
    Object obj = rs.getObject(columnLabel);
    try {
      return KBObjectImpl.<T>checkAndCastObject(obj);
    } catch (IllegalArgumentException ex) {
  ...
  public boolean next() {
   ...
   public int findColumn(Variable col) throws IllegalArgumentException {
     return rs.findColumn((CycVariableI)(col.getCore()));
   }
