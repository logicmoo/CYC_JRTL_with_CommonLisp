 ...
 * @version $Id: KBTermImpl.java 151340 2014-05-19 15:55:29Z vijay $
 */
public class KBTermImpl extends StandardKBObject implements KBTerm {
  ...
  /**
   * This is not part of the KB API. finds or creates an kb Term (#$Thing)
   ...
   * @throws CreateException 
   */
  public static KBTerm findOrCreate(String nameOrId, KBCollection constraintCol, ContextImpl ctx) 
      throws CreateException, KBTypeException{
  ...
  public boolean provablyNotInstanceOf(KBCollection col, Context ctx) {
    try {
      return CycAccessManager.get().getCurrentAccess().getInspectorTool().isa(this.getCore(), col.getCore(), ctx.getCore());
