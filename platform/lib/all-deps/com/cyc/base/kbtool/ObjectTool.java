...
public interface ObjectTool {
   ...
   */
  CycConstantI constantNameCaseCollision(String name) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the Cyc server returns an error
   */
  Object getHLCycTerm(String string) throws CycConnectionException, CycConnectionException, CycApiException;
  
  /**
   * Makes a known CycConstantI by using its GUID and name, adding it to the cache.
   *
   ...
   */
  CycConstantI makeConstantWithGuidName(String guidString, String constantName);
   ...
   * @return the complete <tt>CycConstantI</tt> if found, otherwise return <tt>null</tt>
   */
  CycConstantI makeConstantWithGuidName(Guid guid, String constantName);

  /**
   * Returns a new <tt>CycConstantI</tt> object using the constant name, recording bookkeeping
   ...
   *
   * @return a new <tt>CycConstantI</tt> object using the constant name, recording bookkeeping
   * information and archiving to the Cyc transcript
   *
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  CycConstantI makeCycConstant(String name) throws CycConnectionException, CycConnectionException, CycApiException;

  /**
   * Returns a new <tt>CycConstantI</tt> object using the constant name
   *
   * @param name Name of the constant. If prefixed with "#$", then the prefix is removed for
   * canonical representation.
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  CycConstantI makeCycConstant(String name, boolean bookkeeping, boolean transcript) throws CycConnectionException, CycConnectionException, CycApiException;
 ...
 may or may not include all appropriate "#$"s.
  ...
  /**
   * Returns a new unique <tt>CycConstantI</tt> object using the constant start name prefixed by
   ...
   *
   * @return a new <tt>CycConstantI</tt> object using the constant starting name, recording
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  CycConstantI makeUniqueCycConstant(final String startName) throws CycConnectionException, CycConnectionException, CycApiException;

  /**
   * Returns a new unique <tt>CycConstantI</tt> object using the constant start name and prefix,
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  CycConstantI makeUniqueCycConstant(String startName, String prefix) throws CycConnectionException, CycConnectionException, CycApiException;
  
  /** 
   * Record the information that <tt>focalTerm</tt> is known to have a fact sheet accessible to this CycAccess
   */
  void noteTermHasPrecachedFactSheet(final CycObject focalTerm);
  
  CycList phraseStructureParse(String str) throws CycConnectionException, CycApiException;
  
  /** 
   * @return true iff <tt>focalTerm</tt> is known to have a fact sheet accessible to this CycAccess 
   */
  boolean termKnownToHavePrecachedFactSheet(final CycObject focalTerm);
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void rename(final CycConstantI cycConstant, final String newName) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void rename(final CycConstantI cycConstant, final String newName, final boolean bookkeeping, final boolean transcript) throws CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  Object getSymbolValue(CycSymbolI cycSymbol) throws CycConnectionException, CycConnectionException, CycApiException;
   ...
   * @throws CycApiException if the api request results in a cyc server error
   */
  void setSymbolValue(CycSymbolI cycSymbol, Object value) throws CycConnectionException, CycApiException;
