...
public interface CycList<E> extends CycObject, List<E>, Serializable {
   ...
   */
  Object getf(CycSymbolI indicator, Object defaultResult, boolean treatNilAsAbsent);

  /**
   * This behaves like the SubL function GETF
   */
  Object getf(CycSymbolI indicator, Object defaultResult);
