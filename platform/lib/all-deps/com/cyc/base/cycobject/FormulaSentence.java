...
public interface FormulaSentence extends Formula, CycSentence {
   ...
   * @param var
   */
  void existentiallyBind(CycVariableI var);
   ...
   * @param var
   */
  void existentiallyUnbind(CycVariableI var);
   ...
   * use the much more constraining {@link com.cyc.base.cycobject.CycFormulaSentenceI#getNonWffAssertExplanation getNonWffAssertExplanation}.
   *
   * @param access
   * @param mt
   * @return An explanation, or null if no problems found.
   ...
   * @return An explanation, or null if no problems found.
   */
  String getNonWffExplanation(ELMt mt);
   ...
   * @throws CycConnectionException
   */
  Map<CycVariableI, String> getOptimizedVarNames(CycAccess access) throws CycConnectionException;
   ...
   * @throws CycConnectionException
   */
  FormulaSentence treeSubstitute(Map<CycObject, Object> substitutions) throws CycApiException, CycConnectionException;
