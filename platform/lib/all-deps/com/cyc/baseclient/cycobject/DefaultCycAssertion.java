 ...
 * is fetched later.
 *
 * @version $Id: DefaultCycAssertion.java 150938 2014-05-02 21:39:12Z nwinant $
 * @author Stephen L. Reed
 * @author Dan Lipofsky
 */
public class DefaultCycAssertion extends DefaultCycObject implements CycAssertion {
   ...
   */
  public DefaultCycAssertion(CycList hlFormula, CycObject mt) {
    //// Preconditions
   ...
   * @param mt the assertion mt
   */
  public DefaultCycAssertion(FormulaSentence posLit, CycObject mt) {
    //// Preconditions
    assert mt != null : "mt cannot be null";
  ...
  /** Constructs a the singleton invalid <tt>DefaultCycAssertion</tt> object. 
  ...
  public static CycAssertion makeInvalidAssertion() {
    final DefaultCycAssertion cycAssertion = new DefaultCycAssertion();
  ...
  public boolean equals(Object object) {
    if (!(object instanceof DefaultCycAssertion)) {
      return false;
    }
    DefaultCycAssertion that = (DefaultCycAssertion) object;
  ...
  /**
   * Returns a <tt>String</tt> representation of the <tt>DefaultCycAssertion</tt>.
   *
   * @return a <tt>String</tt> representation of the <tt>DefaultCycAssertion</tt>
   */
  @Override
  ...
  /**
   * Prints the XML representation of the DefaultCycAssertion to an <code>XMLWriter</code>
   *
 ...
 a symbol or variable will return the empty list.
  ...
  public int compareTo(Object o) {
    if (!(o instanceof DefaultCycAssertion)) {
      return toString().compareTo(o.toString());
    }
    DefaultCycAssertion cao = (DefaultCycAssertion) o;
