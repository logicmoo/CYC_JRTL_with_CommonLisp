 ...
 * Author     : baxter
 * @version $Id: PasswordManager.java 150787 2014-04-26 01:55:03Z nwinant $
 */
public class PasswordManager {
   ...
   */
  public boolean areLoginCredentialsValid(final CycConstant user, final DenotationalTerm applicationTerm,
   ...
   */
  public boolean updatePassword(final CycConstant user, final DenotationalTerm applicationTerm,
          final char[] unencryptedPassword) {
    final String encryptedPassword = encryptPassword(unencryptedPassword, user);
   ...
   */
  public String lookupPassword(final CycConstant user, final DenotationalTerm applicationTerm) {
  ...
  private void noteValidPassword(final CycConstant user, final DenotationalTerm applicationTerm,
          final String encryptedPassword) {
    CACHE.put(new CacheKey(user, applicationTerm, cycAccess), encryptedPassword);
  }
  //// Internal Rep
  private final CycAccess cycAccess;
  static private final CycConstant testUser = new CycConstant("Baxter", new CycGuid("beeac37c-9c29-11b1-9dad-c379636f7270"));
  ...
  private class CacheKey {
    ...
    private CacheKey(final CycConstant user, final DenotationalTerm applicationTerm,
            final CycAccess cyc) {
      this.user = user;
