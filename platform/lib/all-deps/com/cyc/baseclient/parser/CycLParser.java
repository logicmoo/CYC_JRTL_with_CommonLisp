 ...
 *
 * @version $Id: CycLParser.java 150787 2014-04-26 01:55:03Z nwinant $
  ...
  CycArrayList val = new CycArrayList();
    ...
    default:
      ...
      throw new ParseException();
                                                   ...
                                                   val.add(CommonConstants.xorConst);
    sent = sentence(false);
                             val.add(sent);
  ...
  CycArrayList val = new CycArrayList();
    ...
    default:
      ...
      throw new ParseException();
                                                           ...
                                                           val.add(CommonConstants.impliesConst);
    sent = sentence(false);
                             val.add(sent);
    sent2 = sentence(false);
                              val.add(sent2);
  ...
  CycArrayList val = new CycArrayList();
    ...
    default:
      ...
      throw new ParseException();
                                                       ...
                                                       val.add(CommonConstants.equivConst);
    sent = sentence(false);
                             val.add(sent);
    sent2 = sentence(false);
                              val.add(sent2);
  ...
  CycArrayList val = new CycArrayList();
    ...
    default:
      ...
      throw new ParseException();
                                                         ...
                                                         val.add(CommonConstants.forAllConst);
    var = variable(false);
                            val.add(var);
    sent = sentence(false);
                             val.add(sent);
  ...
  CycArrayList val = new CycArrayList();
    ...
    default:
      ...
      throw new ParseException();
                                                                   ...
                                                                   val.add(CommonConstants.thereExistsConst);
    var = variable(false);
                            val.add(var);
    sent = sentence(false);
                             val.add(sent);
  ...
  CycArrayList val = new CycArrayList();
    ...
    default:
      ...
      throw new ParseException();
                                                                               ...
                                                                               val.add(CommonConstants.thereExistExactlyConst);
    var = variable(false);
                            val.add(var);
    sent = sentence(false);
                             val.add(sent);
  ...
  CycArrayList val = new CycArrayList();
    ...
    default:
      ...
      throw new ParseException();
                                                                             ...
                                                                             val.add(CommonConstants.thereExistAtMostConst);
    var = variable(false);
                            val.add(var);
    sent = sentence(false);
                             val.add(sent);
  ...
  CycArrayList val = new CycArrayList();
    ...
    default:
      ...
      throw new ParseException();
                                                                               ...
                                                                               val.add(CommonConstants.thereExistAtLeastConst);
    var = variable(false);
                            val.add(var);
    sent = sentence(false);
                             val.add(sent);
  ...
  CycConstant val = null;
    ...
    case TRUE_CONSTANT:
      jj_consume_token(TRUE_CONSTANT);
                        val = CommonConstants.trueConst;
      break;
    case FALSE_CONSTANT:
      jj_consume_token(FALSE_CONSTANT);
                           val = CommonConstants.falseConst;
      break;
    case AND_CONSTANT:
      jj_consume_token(AND_CONSTANT);
    ...
    case EQUIV_CONSTANT:
      jj_consume_token(EQUIV_CONSTANT);
                           val = CommonConstants.equivConst;
      break;
    case IMPLIES_CONSTANT:
      jj_consume_token(IMPLIES_CONSTANT);
                             val = CommonConstants.impliesConst;
      break;
    case FORALL_CONSTANT:
      jj_consume_token(FORALL_CONSTANT);
                            val = CommonConstants.forAllConst;
      break;
    case THEREEXISTS_CONSTANT:
      jj_consume_token(THEREEXISTS_CONSTANT);
                                 val = CommonConstants.thereExistsConst;
      break;
    case THEREEXISTEXACTLY_CONSTANT:
      jj_consume_token(THEREEXISTEXACTLY_CONSTANT);
                                       val = CommonConstants.thereExistExactlyConst;
      break;
    case THEREEXISTATMOST_CONSTANT:
      jj_consume_token(THEREEXISTATMOST_CONSTANT);
                                      val = CommonConstants.thereExistAtMostConst;
      break;
    case THEREEXISTATLEAST_CONSTANT:
      jj_consume_token(THEREEXISTATLEAST_CONSTANT);
                                       val = CommonConstants.thereExistAtLeastConst;
      break;
    case EXPANDSUBLFN_CONSTANT:
      jj_consume_token(EXPANDSUBLFN_CONSTANT);
                                  {if (true) throw new UnsupportedVocabularyException(CommonConstants.expandSubLFnConst);}
      break;
    case SUBLQUOTEFN_CONSTANT:
      jj_consume_token(SUBLQUOTEFN_CONSTANT);
                                 {if (true) throw new UnsupportedVocabularyException(CommonConstants.sublQuoteFnConst);}
      break;
    default:
      jj_la1[27] = jj_gen;
      jj_consume_token(-1);
