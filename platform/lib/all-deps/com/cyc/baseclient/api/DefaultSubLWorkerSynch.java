 ...
 * <P>Example usage: <code>
 try {
    CycAccess access = new CycClient("localhost", 3640);
 ...
 * @version $Id: DefaultSubLWorkerSynch.java 150787 2014-04-26 01:55:03Z nwinant $
 */
public class DefaultSubLWorkerSynch
  ...
  public static void main(String[] args) {
    ...
    try {
      final CycAccess access = CycClientManager.get().getAccess("localhost", 3640);
