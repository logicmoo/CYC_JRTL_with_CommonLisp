...
import com.cyc.baseclient.cycobject.CycFormula;
 ...
 * 
 * @version $Id: CfaslOutputStream.java 150785 2014-04-26 01:34:40Z nwinant $
 * @author Christopher
...
public class CfaslOutputStream
 ...
 list.
  ...
  /**
   * Writes a <tt>CycGuid</tt> object to this CfaslOutputStream.
   * 
   * @param guid the <tt>CycGuid</tt> to be written
   * 
   * @throws IOException if a communications error occurs
   */
  public void writeGuid(CycGuid guid)
                 throws IOException {
    if (trace == API_TRACE_DETAILED) {
  ...
  /**
   * Writes a <tt>DefaultCycAssertion</tt> object to this CfaslOutputStream.
   * 
   * @param cycAssertion the <tt>DefaultCycAssertion</tt> to be written
   * 
   * @throws IOException if a communications error occurs
   */
  public void writeAssertion(DefaultCycAssertion cycAssertion)
                      throws IOException {
    if (trace == API_TRACE_DETAILED) {
  ...
  public void writeObject(Object o)
    ...
    else if (o instanceof DefaultCycAssertion) {
      writeAssertion((DefaultCycAssertion) o);
    }
