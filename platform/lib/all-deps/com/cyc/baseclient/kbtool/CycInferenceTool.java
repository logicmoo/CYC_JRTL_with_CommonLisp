...
/**
 *
 * FIXME: more specific return types?
 * 
 * @author nwinant
 */
public class CycInferenceTool extends AbstractKBTool implements InferenceTool {
  ...
  public String queryPropertiesToString(
    ...
    for (final Iterator<Map.Entry<CycSymbolI, Object>> iter = tempQueryProperties.entrySet().iterator(); iter.hasNext();) {
      Map.Entry<CycSymbolI, Object> mapEntry = iter.next();
      CycSymbolI queryParameterKeyword = mapEntry.getKey();
 ...
 to the specifications in the CycArrayList xmlSpec.
   ...
   */
  @Override
  public CycArrayList<Object> queryVariable(final CycVariableI variable,
   ...
   */
  @Override
  public CycArrayList<Object> queryVariable(final CycVariableI queryVariable,
  ...
  @Override
  public CycArrayList<Object> queryVariableLow(final CycVariableI queryVariable,
   ...
   */
  @Override
  public CycList queryVariable(final CycVariableI variable,
          final CycList query,
          final CycObject mt,
          final InferenceParameters queryProperties,
   ...
   */
  @Override
  public CycList<Object> queryVariables(final CycList<CycVariableI> variables,
   ...
   */
  @Override
  public CycArrayList<Object> queryVariables(final CycList<CycVariableI> variables,
   ...
   */
  @Override
  public CycArrayList queryVariables(final CycList<CycVariableI> queryVariables,
          final FormulaSentence query,
          final CycObject mt,
          final InferenceParameters queryProperties,
          final String inferenceProblemStoreName)
  ...
  private CycArrayList<Object> queryVariablesLow(
          final CycList<CycVariableI> queryVariables,
          final CycObject query,
          final CycObject mt,
          final InferenceParameters queryProperties,
          final long timeoutMsecs)
  ...
  private void initializeQueryProperties() {
    ...
    final CycArrayList<CycSymbol> queryPropertiesList = new CycArrayList(
