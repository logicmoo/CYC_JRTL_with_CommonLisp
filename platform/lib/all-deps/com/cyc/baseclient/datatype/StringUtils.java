 ...
 *
 * @version $Id: StringUtils.java 150787 2014-04-26 01:55:03Z nwinant $
...
public class StringUtils {
  ...
  public static final CycConstant UNICODE_STRING_FN = new CycConstant("UnicodeStringFn", new CycGuid("dbc65ea5-e65c-11d8-89df-0002b3620a7d"));
  ...
  public static String cyclStringToJavaString(final Object cyclString) {
    if (cyclString instanceof String) {
      ...
      try {
        ...
        if (UNICODE_STRING_FN.equals(naut.getFunctor())) {
    ...
    if (tree instanceof String) {
      ...
      try {
        ...
        if (newItems instanceof CycArrayList && newItems.size() == 3
                && UNICODE_STRING_FN.equals(newItems.get(1))) {
