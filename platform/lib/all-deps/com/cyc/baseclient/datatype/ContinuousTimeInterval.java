...
public class ContinuousTimeInterval extends AbstractTimeInterval {
   ...
   * @see com.cyc.baseclient.cycobject.CycObject
   */
  ...
  private static final CycConstant CYC_ALWAYS = new CycConstant(
          "Always-TimeInterval",
          new CycGuid("c0ea3419-9c29-11b1-9dad-c379636f7270"));
  static final CycConstant CYC_NOW = new CycConstant("Now", new CycGuid(
          "bd58a068-9c29-11b1-9dad-c379636f7270"));
  static final CycNaut CYC_BEGINNING_OF_TIME = new CycNaut(
          new CycConstant("StartFn", new CycGuid("be010fc3-9c29-11b1-9dad-c379636f7270")),
          CYC_ALWAYS);
  static final CycNaut CYC_END_OF_TIME = new CycNaut(
          new CycConstant("EndFn", new CycGuid("be01123d-9c29-11b1-9dad-c379636f7270")),
          CYC_ALWAYS);
  ...
  public enum TimeIntervalFunction {
    ...
    private TimeIntervalFunction(final String name, final String guid,
      ...
      this.includesStart = includesStart;
      this.includesEnd = includesEnd;
      this.cycConstant = new CycConstant(name, new CycGuid(guid));
    }
    ...
    private static final CycConstant INTERVAL_BEFORE_FN
            = new CycConstant("IntervalBeforeFn", new CycGuid("bd58fa99-9c29-11b1-9dad-c379636f7270"));
    private static final CycConstant INTERVAL_AFTER_FN
            = new CycConstant("IntervalAfterFn", new CycGuid("bd58a0a0-9c29-11b1-9dad-c379636f7270"));
    
    private static final CycConstant SECONDS_DURATION
            = new CycConstant("SecondsDuration", new CycGuid("bd58ebb1-9c29-11b1-9dad-c379636f7270"));
