# SQL driver file for Derby
#
# (c) Copyright 2006 Hewlett-Packard Development Company, LP
#
# + INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY
# + VARCHAR(32672) for blobs because of .setString
#
#-------------------------------------------------------------------
...
# HSQL has IDENTITY for the ID field
insertGraph
...
getInsertID
SELECT IDENTITY_VAL_LOCAL() FROM ${a}
...
# with the specified subject, property anPreparedStatement ps =d literal (resource)
selectReifNodeSPOT
SELECT S.Stmt
