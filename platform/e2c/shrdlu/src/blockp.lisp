...
(THSETF (G3T 'TA-EXISTS 'THEOREM) '(THANTE (X) (\#EXISTS (THV X)) (THSUCCEED)))

(THSETF (G3T 'TA-SUPP 'THEOREM)
	 '(THANTE (X Y Z)
		 (\#AT (THV X) (THV Y))
...
(THSETF (G3T 'TC-CHOOSEPLACE 'THEOREM)
	 '(THCONSE (X) (\#CHOOSEPLACE (THV X)) (ERT CHOOSEPLACE UNDEFINED)))

(THSETF (G3T 'TC-CLEARTOP 'THEOREM)
...
(THSETF (G3T 'TC-EXISTS 'THEOREM) '(THCONSE (X) (\#EXISTS (THV X)) (THSUCCEED)))

(THSETF (G3T 'TC-FINDSPACE 'THEOREM)
...
(THSETF (G3T 'TC-GET-RID-OF 'THEOREM)
	 '(THCONSE (X Y (WHY (EV)) EV)
		  (\#GET-RID-OF (THV X))
...
(THSETF (G3T 'TC-MAKESPACE 'THEOREM)
...
(THSETF (G3T 'TC-MOVEHAND 'THEOREM)
 '(THCONSE
  (X Y W Z)
  (\#MOVEHAND (THV Y))
  (THCOND
...
(THSETF (G3T 'TC-MOVEHAND2 'THEOREM)
	 '(THCONSE (Y LOC)
		  (\#MOVEHAND2 (THV Y))
...
(THSETF (G3T 'TC-PHYSOB 'THEOREM)
	 '(THCONSE (X)
		  (\#PHYSOB (THV X))
		  (THOR (THGOAL (\#MANIP (THV X)))
			(THAMONG (THV X) '(:BOX :TABLE :HAND)))))

(THSETF (G3T 'TC-PICKUP 'THEOREM)
	 '(THCONSE (X (WHY (EV)) EV)
		  (\#PICKUP (THV X))
		  (MEMORY)
...
(THSETF (G3T 'TC-RAISEHAND 'THEOREM)
	 '(THCONSE ((WHY (EV)) EV)
		  (\#RAISEHAND)
		  (MEMORY)
...
(THSETF (G3T 'TCT-EXISTS 'THEOREM) '(THCONSE NIL (\#EXISTS ? ?) (THSUCCEED)))

(THSETF (G3T 'TCT-PICKUP 'THEOREM)
	 '(THCONSE (X EV TIME)
...
(THSETF (G3T 'TCT-SUPPORT 'THEOREM)
	 '(THCONSE (X Y Z TIME)
...
(THSETF (G3T 'TE-CONTAIN 'THEOREM)
	 '(THERASING (X Y)
		    (\#AT (THV X) ?)
		    (THGOAL (\#CONTAIN (THNV Y) (THV X)))
		    (THERASE (\#CONTAIN (THV Y) (THV X)))))

(THSETF (G3T 'TE-EXISTS 'THEOREM) '(THERASING (X) (\#EXISTS (THV X)) (THSUCCEED)))

(THSETF (G3T 'TE-SUPP 'THEOREM)
	 '(THERASING (X Y Z)
		    (\#AT (THV X) ?)
