...
(DEFUN FINDSPACE
      ...
      (PROG (XYMAX XYMIN N V X1 X2 FINDLEVEL)
	    ...
	    GO
	    (COND ((ZEROP (SETQ N (- N 1))) (RETURN NIL))
		  ((OR (NOT (SETQ V
      ...
      (PROG (GROW XL XH XO YL YH YO)
	    ...
	    (COND
		  ((OR
		   ...
		   (RETURN NIL)))
	    GO
	    (COND ((= (SETQ GROW (MIN (CAAR XL) (CAAR XH) (CAAR YL) (CAAR YH)))
		      2000)
