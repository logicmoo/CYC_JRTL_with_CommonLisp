...
(THSETF (G3T 'THTAG 'THFAIL) 'THTAGF)

(THSETF (G3T 'THTAG 'THSUCCEED) 'THTAGT)

(THSETF (G3T 'THGOAL 'THSUCCEED) 'THGOALT)

(THSETF (G3T 'THGOAL 'THFAIL) 'THGOALF)

(THSETF (G3T 'THFAIL? 'THFAIL) 'THFAIL?F)

(THSETF (G3T 'THFAIL? 'THSUCCEED) 'THFAIL?T)

(THSETF (G3T 'THAMONG 'THFAIL) 'THAMONGF)

(THSETF (G3T 'THFIND 'THFAIL) 'THFINDF)

(THSETF (G3T 'THFIND 'THSUCCEED) 'THFINDT)

(THSETF (G3T 'THPROG 'THSUCCEED) 'THPROGT)

(THSETF (G3T 'THAND 'THSUCCEED) 'THANDT)

(THSETF (G3T 'THMUNG 'THSUCCEED) 'THMUNGT)

(THSETF (G3T 'THERASE 'THSUCCEED) 'THERASET)

(THSETF (G3T 'THASSERT 'THSUCCEED) 'THASSERTT)

(THSETF (G3T 'THOR 'THSUCCEED) 'THORT)

(THSETF (G3T 'THCOND 'THSUCCEED) 'THCONDT)

(THSETF (G3T 'THAND 'THFAIL) 'THANDF)

(THSETF (G3T 'THPROG 'THFAIL) 'THPROGF)

(THSETF (G3T 'THMUNG 'THFAIL) 'THMUNGF)

(THSETF (G3T 'THASSERT 'THFAIL) 'THASSERTF)

(THSETF (G3T 'THERASE 'THFAIL) 'THERASEF)

(THSETF (G3T 'THCOND 'THFAIL) 'THCONDF)

(THSETF (G3T 'THOR 'THFAIL) 'THORF)

(THSETF (G3T 'THDO 'THSUCCEED) 'THDOB)

(THSETF (G3T 'THDO 'THFAIL) 'THDOB)

(THSETF (G3T 'THUNDO 'THFAIL) 'THUNDOF)

(THSETF (G3T 'THUNDO 'THSUCCEED) 'THUNDOT)

(THSETF (G3T 'THMESSAGE 'THFAIL) 'THMESSAGEF)

(THSETF (G3T 'THMESSAGE 'THSUCCEED) 'THMESSAGET)

(THSETF (G3T 'THREMBIND 'THSUCCEED) 'THREMBINDT)

(THSETF (G3T 'THREMBIND 'THFAIL) 'THREMBINDF)
