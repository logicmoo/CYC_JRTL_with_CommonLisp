...
(#$Action "act" "tAct" "iAct_")(#$Goal  "goal" "tGoal" "iGoal_" )(#$Capability  "cap"  "tCap" "cap")(#$IBTContentType "tIbo" "tIbo" "ibo")(#$Event  "tEvent" "tEvent" "iEvent_")  (#$Situation  "state" "tState" "iState_")(#$FormulaTemplate  "ui_" "uiTopic_" "iUI_")(#$Topic  "ui_" "uiTopic_" "iUI_")(#$PhysicalPartOfObject "tPartType" "tPartType" "iPartType_")(#$SpecifiedPartTypeCollection "ttPartType" "ttPartType" "tPartType")(#$OrganismClassificationType  "tTypeOf" "ttTypeOf" "tClassificationOf_")(#$ConventionalClassificationType  "tTypeOf" "ttTypeOf" "tClassificationOf_")(#$SpaceRegion "tPlace"  "tPlaceLike" "iLoc_")(#$TwoDimensionalThing     "tPlacePartOf"  "tPlacePartOf" "iLocPart_") ;; (#$AbstractVisualStructure "tPlacePartOf"  ttPlacePartOf" "iLocPart_")
...
(#$SpecifiedPartTypeCollection "ttPartType" "ttPartType" "tPartType")
...
(define guess-fn-prefix (trm)
 ...
 (pcond
  ...
  ((isa-p trm #$CodingFunctionTypeByOperationType) (ret "s_iCW"))
  ((isa-p trm #$CodingFunction) (ret "s_iCW"))
  ((isa-p trm #$StandardLibraryFunction) (ret "s_iCW"))
...
(define namet()
 ...
 (mud-rename #$The-Unreifiable "uUnreifiableTheFn") 
 (cdolist (trm (ALL-INSTANCES #$Function-Denotational)) (maybe-rename trm))
 (offer-prefix #$ThePrototypicalFixedArityFunction "uf")
 (offer-prefix #$ThePrototypicalSextaryFunction "uf")
 (offer-prefix #$ThePrototypicalQuintaryFunction "uf")
 (offer-prefix #$SkolemFuncNFn "r")
 (offer-prefix #$SubPathBetweenFn "iLoc")
 (offer-prefix #$AbducedTermFn "r")
 (offer-prefix #$MathBugTypeFn "tColOf")
 (offer-prefix #$CNInstanceNamedFn "r")
 (offer-prefix #$MaximalWithRespectToDurationFn "v")
 (offer-prefix #$MinimalWithRespectToDurationFn "v")
 ...
 (offer-prefix #$AmountOfSubstanceFn "v")
 (offer-prefix #$TableCellValueFn "s_iDB")
 (offer-prefix #$FieldValueFn "s_iDB")
 (offer-prefix #$RDFTypedLiteralFn "r")
 (offer-prefix #$GeneLocusFn "iPlace")
