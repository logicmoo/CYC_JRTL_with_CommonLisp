...
public final class module0380 extends SubLTranslatedFile
{
    ...
    public static SubLObject f26955(final SubLObject var1) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0380.NIL != module0364.f24699(var1) && module0380.$ic0$ == module0364.f24721(var1));
    }
    
    public static SubLObject f26956(final SubLObject var2, final SubLObject var3) {
        SubLObject var4 = f26957(var2);
        if (module0380.NIL == var4) {
    ...
    public static SubLObject f26959(final SubLObject var2, final SubLObject var6) {
        final SubLObject var7 = module0364.f24729((SubLObject)module0380.$ic0$, var2);
        SubLObject var8 = var6;
        SubLObject var9 = (SubLObject)module0380.NIL;
        var9 = var8.first();
        while (module0380.NIL != var8) {
    ...
    public static SubLObject f26960(final SubLObject var4) {
        ...
        SubLObject var6 = (SubLObject)module0380.NIL;
        var6 = var5.first();
        while (module0380.NIL != var5) {
            if (module0380.NIL != module0365.f24845(var6)) {
                module0365.f24861(var6);
            }
            var5 = var5.rest();
            var6 = var5.first();
        }
        return (SubLObject)module0380.NIL;
    }
    
    public static SubLObject f26962(final SubLObject var10, final SubLObject var11) {
        SubLObject var13;
        final SubLObject var12 = var13 = var10.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var13, var12, (SubLObject)module0380.$ic1$);
        final SubLObject var14 = var13.rest();
        var13 = var13.first();
        SubLObject var15 = (SubLObject)module0380.NIL;
        SubLObject var16 = (SubLObject)module0380.NIL;
        SubLObject var17 = (SubLObject)module0380.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var13, var12, (SubLObject)module0380.$ic1$);
        var15 = var13.first();
        var13 = var13.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var13, var12, (SubLObject)module0380.$ic1$);
        ...
        var17 = var13.first();
        var13 = var13.rest();
        if (module0380.NIL == var13) {
            final SubLObject var18;
            var13 = (var18 = var14);
            final SubLObject var19 = (SubLObject)module0380.$ic2$;
            return (SubLObject)ConsesLow.list((SubLObject)module0380.$ic3$, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(var19, var17)), (SubLObject)ConsesLow.list((SubLObject)module0380.$ic4$, (SubLObject)ConsesLow.list(var15, var16, var19), (SubLObject)ConsesLow.listS((SubLObject)module0380.$ic5$, (SubLObject)ConsesLow.list((SubLObject)module0380.$ic6$, var19, var16), ConsesLow.append(var18, (SubLObject)module0380.NIL))));
        }
        cdestructuring_bind.cdestructuring_bind_error(var12, (SubLObject)module0380.$ic1$);
        return (SubLObject)module0380.NIL;
    }
    
    public static SubLObject f26963(final SubLObject var4, final SubLObject var8) {
        final SubLThread var9 = SubLProcess.currentSubLThread();
        if (module0380.NIL == Errors.$ignore_mustsP$.getDynamicValue(var9) && module0380.NIL == module0004.f104(var8, module0364.f24735(var4), Symbols.symbol_function((SubLObject)module0380.EQ), (SubLObject)module0380.UNPROVIDED)) {
            Errors.error((SubLObject)module0380.$ic7$, var8, var4);
        }
        final SubLObject var10 = module0364.f24725(var4);
        SubLObject var11 = module0363.f24517(var10);
        SubLObject var12 = (SubLObject)module0380.NIL;
        var12 = var11.first();
        while (module0380.NIL != var11) {
            if (module0380.NIL != module0363.f24522(var12, module0380.$g3208$.getDynamicValue(var9))) {
    ...
    public static SubLObject f26965(final SubLObject var4) {
        ...
        if (module0380.NIL == Errors.$ignore_mustsP$.getDynamicValue(var5) && module0380.NIL == var6) {
            Errors.error((SubLObject)module0380.$ic8$, var4);
        }
        return var6;
    }
    
    public static SubLObject f26961(final SubLObject var4) {
        SubLObject var5 = (SubLObject)module0380.NIL;
        final SubLObject var6 = module0364.f24725(var4);
        SubLObject var7 = module0363.f24517(var6);
        SubLObject var8 = (SubLObject)module0380.NIL;
        var8 = var7.first();
        while (module0380.NIL != var7) {
            if (module0380.NIL != f26966(var8)) {
    ...
    public static SubLObject f26967(final SubLObject var4) {
        SubLObject var5 = (SubLObject)module0380.ZERO_INTEGER;
        SubLObject var6 = module0364.f24735(var4);
        SubLObject var7 = (SubLObject)module0380.NIL;
        var7 = var6.first();
        while (module0380.NIL != var6) {
            if (module0380.NIL != module0339.f22743((SubLObject)module0380.NIL, var4, var7)) {
                if (module0380.NIL != module0364.f24761(var4, var5)) {
                    module0364.f24779(var4, var5);
                    module0373.f26370(var7, var4);
                }
                var5 = Numbers.add(var5, (SubLObject)module0380.ONE_INTEGER);
            }
            var6 = var6.rest();
            var7 = var6.first();
        }
    ...
    public static SubLObject f26958(final SubLObject var5, final SubLObject var3) {
        ...
        var9 = var8.first();
        while (module0380.NIL != var8) {
            final SubLObject var10 = module0373.f26435(var5, var9, (SubLObject)module0380.UNPROVIDED);
    ...
    public static SubLObject f26969(final SubLObject var1) {
        ...
        return (SubLObject)SubLObjectFactory.makeBoolean(module0380.NIL != module0365.f24819(var1) && module0380.$g3208$.getDynamicValue(var2).eql(module0365.f24865(var1)));
    }
    
    public static SubLObject f26970(final SubLObject var2, final SubLObject var23) {
        final SubLThread var24 = SubLProcess.currentSubLThread();
        final SubLObject var25 = module0365.f24854(var2, module0380.$g3208$.getDynamicValue(var24), var23);
        final SubLObject var26 = module0363.f24507(var2);
        final SubLObject var27 = module0361.f24123(var26);
        if (module0380.NIL == module0065.f4772(var27, (SubLObject)module0380.$ic9$)) {
            final SubLObject var30_31 = var27;
            if (module0380.NIL == module0065.f4775(var30_31, (SubLObject)module0380.$ic9$)) {
                final SubLObject var28 = module0065.f4740(var30_31);
                final SubLObject var29 = (SubLObject)module0380.NIL;
                SubLObject var30;
                SubLObject var31;
                SubLObject var32;
                SubLObject var33;
                ...
                SubLObject var37;
                SubLObject var38;
                for (var30 = Sequences.length(var28), var31 = (SubLObject)module0380.NIL, var31 = (SubLObject)module0380.ZERO_INTEGER; var31.numL(var30); var31 = Numbers.add(var31, (SubLObject)module0380.ONE_INTEGER)) {
                    var32 = ((module0380.NIL != var29) ? Numbers.subtract(var30, var31, (SubLObject)module0380.ONE_INTEGER) : var31);
                    var33 = Vectors.aref(var28, var32);
                    if (module0380.NIL == module0065.f4749(var33) || module0380.NIL == module0065.f4773((SubLObject)module0380.$ic9$)) {
                        if (module0380.NIL != module0065.f4749(var33)) {
                            var33 = (SubLObject)module0380.$ic9$;
                        }
            ...
            if (module0380.NIL == module0065.f4777(var43_44)) {
                final SubLObject var39 = module0065.f4738(var43_44);
                SubLObject var40 = (SubLObject)module0380.NIL;
                SubLObject var41 = (SubLObject)module0380.NIL;
                ...
                try {
                    while (Hashtables.iteratorHasNext(var42)) {
                        ...
                        if (module0380.NIL != module0363.f24547(var2, var41)) {
                            ...
                            SubLObject var47;
                            SubLObject var48;
                            for (var46 = module0032.f1741(var45), var47 = (SubLObject)module0380.NIL, var47 = module0032.f1742(var46, var45); module0380.NIL == module0032.f1744(var46, var47); var47 = module0032.f1743(var47)) {
                                var48 = module0032.f1745(var46, var47);
                                if (module0380.NIL != module0032.f1746(var47, var48)) {
    ...
    public static SubLObject f26972(final SubLObject var48) {
        ...
        if (module0380.NIL != var50) {
            return var50;
        }
        return Errors.error((SubLObject)module0380.$ic10$, var48);
    }
    
    public static SubLObject f26964(final SubLObject var9) {
        final SubLThread var10 = SubLProcess.currentSubLThread();
        assert module0380.NIL != f26969(var9) : var9;
        final SubLObject var11 = f26971(var9);
        final SubLObject var12 = f26972(var9);
        final SubLObject var13 = module0364.f24809(var12, var11);
        if (module0380.NIL == Errors.$ignore_mustsP$.getDynamicValue(var10) && module0380.NIL == var13) {
            Errors.error((SubLObject)module0380.$ic12$, var9);
        }
    ...
    public static SubLObject f26975(final SubLObject var9) {
        if (module0380.NIL == module0361.f24164(module0365.f24879(var9))) {
            final SubLObject var10 = module0365.f24850(var9);
            return module0373.f26208(var10, (SubLObject)module0380.NIL, (SubLObject)module0380.NIL, (SubLObject)module0380.$ic0$, var9, (SubLObject)module0380.NIL);
        }
        return (SubLObject)module0380.NIL;
    }
    ...
    public static SubLObject f26976(final SubLObject var2, final SubLObject var3) {
        ...
        if (module0380.NIL == Errors.$ignore_mustsP$.getDynamicValue(var4) && !var6.numG((SubLObject)module0380.ONE_INTEGER)) {
            Errors.error((SubLObject)module0380.$ic13$, var5);
        }
        module0373.f26120(var2, (SubLObject)module0380.NIL, (SubLObject)module0380.$ic14$, (SubLObject)module0380.T);
        if (module0380.NIL == module0373.f26327(var2, (SubLObject)module0380.$ic14$)) {
            SubLObject var7 = (SubLObject)module0380.ZERO_INTEGER;
            final SubLObject var8 = var5;
            SubLObject var9 = module0364.f24735(var8);
            SubLObject var10 = (SubLObject)module0380.NIL;
            var10 = var9.first();
            while (module0380.NIL != var9) {
                if (module0380.NIL != module0339.f22743((SubLObject)module0380.NIL, var8, var10)) {
                    f26970(var2, var7);
                    var7 = Numbers.add(var7, (SubLObject)module0380.ONE_INTEGER);
                }
                var9 = var9.rest();
                var10 = var9.first();
            }
    ...
    public static SubLObject f26977(final SubLObject var9, final SubLObject var52, final SubLObject var42) {
        ...
        if (module0380.NIL == module0358.f23680(module0365.f24868(var9))) {
            var53.resetMultipleValues();
            final SubLObject var55 = f26978(var54, var52, (SubLObject)module0380.$ic14$);
    ...
    public static SubLObject f26978(final SubLObject var2, final SubLObject var52, final SubLObject var57) {
        ...
        SubLObject var59 = module0388.f27577(var52, var57, (SubLObject)module0380.NIL);
        SubLObject var60 = var58.secondMultipleValue();
        var58.resetMultipleValues();
        if (module0380.NIL == module0358.f23683(var59)) {
            var59 = module0380.$g3209$.getGlobalValue();
            var60 = module0380.$g3210$.getGlobalValue();
        }
    ...
    public static SubLObject f26973(final SubLObject var49) {
        return module0363.f24595(var49, (SubLObject)module0380.$ic0$);
    }
    
    public static SubLObject f26957(final SubLObject var49) {
        return module0363.f24594(var49, (SubLObject)module0380.$ic0$);
    }
    ...
    public static SubLObject f26983(final SubLObject var4) {
        ...
        while (module0380.NIL != var6) {
            if (module0380.NIL != module0339.f22743((SubLObject)module0380.NIL, var4, var7)) {
                ...
                if (module0380.NIL != module0363.f24555(var8)) {
                    var5 = (SubLObject)ConsesLow.cons(var8, var5);
                }
            }
            var6 = var6.rest();
    ...
    public static SubLObject f26985(final SubLObject var1) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0380.NIL != module0366.f24916(var1) && module0380.$ic0$ == module0366.f24989(var1));
    }
    ...
    public static SubLObject f26986(final SubLObject var63, final SubLObject var64, final SubLObject var4) {
        ...
        SubLObject var66 = (SubLObject)module0380.NIL;
        SubLObject var67 = (SubLObject)module0380.NIL;
        final SubLObject var68 = module0366.f24956(var63);
        SubLObject var69 = module0364.f24735(var4);
        SubLObject var70 = (SubLObject)module0380.NIL;
        var70 = var69.first();
        while (module0380.NIL != var69) {
            if (module0380.NIL != module0339.f22743((SubLObject)module0380.NIL, var4, var70)) {
                final SubLObject var71 = module0364.f24736(var70);
                final SubLObject var72 = module0364.f24737(var70);
                if (var71.eql(var68) && module0380.NIL != module0233.f15364(var72, var64)) {
                    ...
                    SubLObject var75 = (SubLObject)module0380.NIL;
                    final SubLObject var76 = (SubLObject)module0380.$ic17$;
                    SubLObject var77;
                    for (var77 = module0066.f4838(module0363.f24537(var71)); module0380.NIL == module0066.f4841(var77); var77 = module0066.f4840(var77)) {
                        ...
                        SubLObject var80 = (SubLObject)module0380.NIL;
                        var80 = var7_75.first();
                        while (module0380.NIL != var7_75) {
                            if (module0380.NIL != module0363.f24538(var80, var76)) {
        ...
        final SubLObject var82 = var69 = module0035.f2489(var67, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED);
        SubLObject var83 = (SubLObject)module0380.NIL;
        var83 = var69.first();
        while (module0380.NIL != var69) {
            var65.resetMultipleValues();
        ...
        SubLObject var87 = (SubLObject)module0380.NIL;
        var87 = var86.first();
        while (module0380.NIL != var86) {
    ...
    public static SubLObject f26987(final SubLObject var3) {
        ...
        var6 = var5.first();
        while (module0380.NIL != var5) {
            if (module0380.NIL != module0202.f12690(var6)) {
                return (SubLObject)module0380.NIL;
            }
            var5 = var5.rest();
            var6 = var5.first();
        ...
        var6 = (SubLObject)module0380.NIL;
        var6 = var5.first();
        while (module0380.NIL != var5) {
            if (module0380.NIL != module0202.f12690(var6)) {
                return (SubLObject)module0380.NIL;
        ...
        var4.resetMultipleValues();
        return (SubLObject)SubLObjectFactory.makeBoolean(module0380.NIL == var8 && module0380.NIL != module0035.f1997(var7));
    }
    
    public static SubLObject f26968(final SubLObject var3) {
        final SubLThread var4 = SubLProcess.currentSubLThread();
        SubLObject var5 = (SubLObject)module0380.NIL;
        if (module0380.NIL != module0202.f12690(var3)) {
            SubLObject var6 = (SubLObject)module0380.ZERO_INTEGER;
            SubLObject var7 = module0232.f15306(var3);
            SubLObject var8 = (SubLObject)module0380.NIL;
            var8 = var7.first();
            while (module0380.NIL != var7) {
                final SubLObject var9 = (SubLObject)module0380.$ic18$;
                final SubLObject var10 = module0362.f24453(var8, var9);
                var5 = (SubLObject)ConsesLow.cons(var10, var5);
                var6 = Numbers.add(var6, (SubLObject)module0380.ONE_INTEGER);
                var7 = var7.rest();
                var8 = var7.first();
            }
            var6 = (SubLObject)module0380.ZERO_INTEGER;
            var7 = module0232.f15308(var3);
            var8 = (SubLObject)module0380.NIL;
            var8 = var7.first();
            while (module0380.NIL != var7) {
                final SubLObject var9 = (SubLObject)module0380.$ic19$;
                final SubLObject var10 = module0362.f24453(var8, var9);
                var5 = (SubLObject)ConsesLow.cons(var10, var5);
                var6 = Numbers.add(var6, (SubLObject)module0380.ONE_INTEGER);
                var7 = var7.rest();
            ...
            var14 = var13;
            var15 = (SubLObject)module0380.NIL;
            var15 = var14.first();
            while (module0380.NIL != var14) {
                final SubLObject var16 = f26991(var15);
                var5 = (SubLObject)ConsesLow.cons(var16, var5);
        ...
        return module0035.f2269(var5, Symbols.symbol_function((SubLObject)module0380.EQUAL), (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED);
    }
    
    public static SubLObject f26988(final SubLObject var88) {
        final SubLObject var89 = module0035.f2399(var88, (SubLObject)module0380.$ic20$, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED);
        final SubLObject var90 = module0204.f13079(var88);
        return module0100.f7254(var89, var90, (SubLObject)module0380.UNPROVIDED);
    }
    
    public static SubLObject f26990(final SubLObject var86) {
        final SubLThread var87 = SubLProcess.currentSubLThread();
        SubLObject var88 = (SubLObject)module0380.NIL;
        SubLObject var89 = var86;
        SubLObject var90 = (SubLObject)module0380.NIL;
        var90 = var89.first();
        while (module0380.NIL != var89) {
            if (module0380.NIL != module0202.f12690(var90)) {
        ...
        final SubLObject var92 = module0035.f2399(var86, (SubLObject)module0380.$ic20$, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED);
        var87.resetMultipleValues();
        final SubLObject var93 = module0100.f7254(var92, var86, (SubLObject)module0380.UNPROVIDED);
    ...
    public static SubLObject f26989(final SubLObject var88) {
        SubLObject var89 = (SubLObject)module0380.NIL;
        SubLObject var90 = (SubLObject)module0380.ZERO_INTEGER;
        SubLObject var91 = module0232.f15306(var88);
        SubLObject var92 = (SubLObject)module0380.NIL;
        var92 = var91.first();
        while (module0380.NIL != var91) {
            var89 = (SubLObject)ConsesLow.cons(module0205.f13338(var92), var89);
            var90 = Numbers.add(var90, (SubLObject)module0380.ONE_INTEGER);
            var91 = var91.rest();
            var92 = var91.first();
        }
        var90 = (SubLObject)module0380.ZERO_INTEGER;
        var91 = module0232.f15308(var88);
        var92 = (SubLObject)module0380.NIL;
        var92 = var91.first();
        while (module0380.NIL != var91) {
    ...
    public static SubLObject f26993(final SubLObject var92) {
        if (module0380.NIL != module0202.f12592(var92)) {
            return Values.values(module0202.f12826(var92), (SubLObject)module0380.$ic18$);
        }
        return Values.values(var92, (SubLObject)module0380.$ic19$);
    }
    
    public static SubLObject f26992(final SubLObject var92) {
        return (SubLObject)ConsesLow.list((SubLObject)module0380.NIL, (SubLObject)ConsesLow.list(var92));
    }
    ...
    public static SubLObject f26994() {
        ...
        return module0380.$g3211$.getDynamicValue(var19);
    }
    
    public static SubLObject f26995(final SubLObject var1) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0380.NIL != module0365.f24819(var1) && module0380.$g3212$.getGlobalValue().eql(module0365.f24865(var1)));
    }
    
    public static SubLObject f26966(final SubLObject var1) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0380.NIL != f26969(var1) || module0380.NIL != f26995(var1));
    }
    ...
    public static SubLObject f26998(final SubLObject var99, final SubLObject var23) {
        ...
        return (SubLObject)SubLObjectFactory.makeBoolean(module0380.NIL == module0035.f2169(var23, var100));
    }
    ...
    public static SubLObject f27000(final SubLObject var2, final SubLObject var3) {
        ...
        if (module0380.NIL == module0373.f26327(var2, (SubLObject)module0380.$ic14$)) {
            f27001(var2);
            return (SubLObject)module0380.T;
        }
        return (SubLObject)module0380.NIL;
    }
    ...
    public static SubLObject f27001(final SubLObject var49) {
        ...
        final SubLObject var52 = conses_high.copy_list(module0035.f2160(var51, (SubLObject)module0380.UNPROVIDED));
        final SubLObject var53 = module0365.f24854(var49, module0380.$g3212$.getGlobalValue(), var52);
        ...
        if (module0380.NIL == module0065.f4772(var55, (SubLObject)module0380.$ic9$)) {
            final SubLObject var30_101 = var55;
            if (module0380.NIL == module0065.f4775(var30_101, (SubLObject)module0380.$ic9$)) {
                final SubLObject var56 = module0065.f4740(var30_101);
                final SubLObject var57 = (SubLObject)module0380.NIL;
                SubLObject var58;
                SubLObject var59;
                SubLObject var60;
                SubLObject var61;
                ...
                SubLObject var65;
                SubLObject var66;
                for (var58 = Sequences.length(var56), var59 = (SubLObject)module0380.NIL, var59 = (SubLObject)module0380.ZERO_INTEGER; var59.numL(var58); var59 = Numbers.add(var59, (SubLObject)module0380.ONE_INTEGER)) {
                    var60 = ((module0380.NIL != var57) ? Numbers.subtract(var58, var59, (SubLObject)module0380.ONE_INTEGER) : var59);
                    var61 = Vectors.aref(var56, var60);
                    if (module0380.NIL == module0065.f4749(var61) || module0380.NIL == module0065.f4773((SubLObject)module0380.$ic9$)) {
                        if (module0380.NIL != module0065.f4749(var61)) {
                            var61 = (SubLObject)module0380.$ic9$;
                        }
            ...
            if (module0380.NIL == module0065.f4777(var43_102)) {
                final SubLObject var67 = module0065.f4738(var43_102);
                SubLObject var68 = (SubLObject)module0380.NIL;
                SubLObject var69 = (SubLObject)module0380.NIL;
                ...
                try {
                    while (Hashtables.iteratorHasNext(var70)) {
                        ...
                        if (module0380.NIL != module0363.f24547(var49, var69)) {
                            ...
                            SubLObject var75;
                            SubLObject var76;
                            for (var74 = module0032.f1741(var73), var75 = (SubLObject)module0380.NIL, var75 = module0032.f1742(var74, var73); module0380.NIL == module0032.f1744(var74, var75); var75 = module0032.f1743(var75)) {
                                var76 = module0032.f1745(var74, var75);
                                if (module0380.NIL != module0032.f1746(var75, var76)) {
    ...
    public static SubLObject f27003(final SubLObject var9, final SubLObject var42) {
        if (module0380.NIL == module0358.f23680(module0365.f24868(var9))) {
            module0365.f24873(var9, module0380.$g3213$.getGlobalValue(), module0380.$g3214$.getGlobalValue());
        }
        module0367.f25205(var9, var42, module0380.$g3213$.getGlobalValue(), module0380.$g3214$.getGlobalValue());
        module0367.f25206(var9, var42, (SubLObject)module0380.ZERO_INTEGER);
        return var9;
    }
    
    public static SubLObject f27002(final SubLObject var9) {
        return module0365.f24906((SubLObject)module0380.$ic24$, var9, (SubLObject)module0380.NIL);
    }
    
    public static SubLObject f27004(final SubLObject var9) {
        if (module0380.NIL != f26995(var9)) {
            return f27005(var9);
        }
        return Errors.error((SubLObject)module0380.$ic25$, var9);
    }
    
    public static SubLObject f27005(final SubLObject var9) {
        final SubLObject var10 = module0365.f24850(var9);
        final SubLObject var11 = f26997(var9);
        return (SubLObject)SubLObjectFactory.makeBoolean(module0380.NIL == var11 || module0380.NIL != module0373.f26327(var10, (SubLObject)module0380.$ic14$));
    }
    
    public static SubLObject f27006() {
        final SubLThread var19 = SubLProcess.currentSubLThread();
        if (module0380.NIL != module0380.$g3215$.getDynamicValue(var19)) {
            return module0380.$g3215$.getDynamicValue(var19);
        }
        if (module0380.NIL != module0380.$g3216$.getDynamicValue(var19)) {
            return (SubLObject)module0380.$ic26$;
        }
        if (module0380.NIL != module0380.$g3217$.getDynamicValue(var19)) {
            return (SubLObject)module0380.$ic27$;
        }
        return (SubLObject)module0380.$ic28$;
    }
    
    public static SubLObject f27007(final SubLObject var9) {
        final SubLThread var10 = SubLProcess.currentSubLThread();
        final SubLObject var11 = module0365.f24850(var9);
        if (module0380.NIL == module0363.f24681(var11)) {
            final SubLObject var12 = f26996(var9);
            SubLObject var13 = (SubLObject)module0380.NIL;
            SubLObject var14 = (SubLObject)module0380.NIL;
            if (module0380.NIL == var14) {
                SubLObject var15 = f27006();
                SubLObject var16 = (SubLObject)module0380.NIL;
                var16 = var15.first();
                while (module0380.NIL == var14 && module0380.NIL != var15) {
                    SubLObject var17 = (SubLObject)module0380.ZERO_INTEGER;
                    ...
                    SubLObject var22;
                    SubLObject var23;
                    for (var19 = (SubLObject)module0380.NIL, var19 = module0364.f24735(var18); module0380.NIL == var14 && module0380.NIL != var19; var19 = var19.rest()) {
                        var20 = var19.first();
                        if (module0380.NIL != module0339.f22743((SubLObject)module0380.NIL, var18, var20)) {
                            if (module0380.NIL == f26998(var9, var17)) {
                                var21 = module0364.f24736(var20);
                                var10.resetMultipleValues();
                                var22 = f27008(var16, var21);
                                var23 = var10.secondMultipleValue();
                                var10.resetMultipleValues();
                                if (module0380.NIL != var22) {
                                    var13 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list(var17, var21), var13);
                                    if (module0380.NIL != var23) {
                                        var14 = (SubLObject)module0380.T;
                                    }
                                }
                            }
                            var17 = Numbers.add(var17, (SubLObject)module0380.ONE_INTEGER);
                        }
                    }
                    if (module0380.NIL != var13) {
                        var14 = (SubLObject)module0380.T;
    ...
    public static SubLObject f27008(final SubLObject var106, final SubLObject var110) {
        if (var106.eql((SubLObject)module0380.$ic29$)) {
            return Values.values(module0363.f24681(var110), (SubLObject)module0380.T);
        }
        if (var106.eql((SubLObject)module0380.$ic30$)) {
            return Values.values(module0363.f24562(var110), (SubLObject)module0380.NIL);
        }
        if (var106.eql((SubLObject)module0380.$ic31$)) {
            return Values.values(Numbers.numG(module0363.f24600(var110), (SubLObject)module0380.ONE_INTEGER), (SubLObject)module0380.NIL);
        }
        if (var106.eql((SubLObject)module0380.$ic32$)) {
            return Values.values(module0363.f24553(var110), (SubLObject)module0380.T);
        }
        if (var106.eql((SubLObject)module0380.$ic33$)) {
            return Values.values((SubLObject)SubLObjectFactory.makeBoolean(module0380.NIL != module0363.f24553(var110) && module0363.f24600(var110).numG((SubLObject)module0380.ONE_INTEGER)), (SubLObject)module0380.T);
        }
        if (var106.eql((SubLObject)module0380.$ic34$)) {
            return Values.values((SubLObject)SubLObjectFactory.makeBoolean(module0380.NIL != module0363.f24562(var110) && module0363.f24600(var110).numG((SubLObject)module0380.ONE_INTEGER)), (SubLObject)module0380.NIL);
        }
        if (var106.eql((SubLObject)module0380.$ic35$)) {
            return Values.values((SubLObject)module0380.T, (SubLObject)module0380.NIL);
        }
        return Errors.error((SubLObject)module0380.$ic36$, var106);
    }
    
    public static SubLObject f27009(final SubLObject var99, final SubLObject var2, final SubLObject var103) {
        SubLObject var104 = (SubLObject)module0380.NIL;
        SubLObject var105 = var103;
        SubLObject var106 = (SubLObject)module0380.NIL;
        var106 = var105.first();
        while (module0380.NIL != var105) {
            SubLObject var108;
            final SubLObject var107 = var108 = var106;
            SubLObject var109 = (SubLObject)module0380.NIL;
            SubLObject var110 = (SubLObject)module0380.NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var108, var107, (SubLObject)module0380.$ic37$);
            var109 = var108.first();
            var108 = var108.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var108, var107, (SubLObject)module0380.$ic37$);
            var110 = var108.first();
            var108 = var108.rest();
            if (module0380.NIL == var108) {
                final SubLObject var111 = f27010(var99, var2, var109);
                var104 = (SubLObject)ConsesLow.cons(var111, var104);
            }
            else {
                cdestructuring_bind.cdestructuring_bind_error(var107, (SubLObject)module0380.$ic37$);
            }
            var105 = var105.rest();
            var106 = var105.first();
        }
    ...
    public static SubLObject f27012(final SubLObject var9, final SubLObject var23) {
        ...
        var24 = Sequences.delete(var23, var24, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED, (SubLObject)module0380.UNPROVIDED);
        module0365.f24875(var9, var24);
        return var9;
    }
    
    public static SubLObject f27011(final SubLObject var112) {
        if (module0380.NIL != var112) {
            ...
            if (module0380.NIL == module0065.f4772(var116, (SubLObject)module0380.$ic9$)) {
                final SubLObject var30_116 = var116;
                if (module0380.NIL == module0065.f4775(var30_116, (SubLObject)module0380.$ic9$)) {
                    final SubLObject var117 = module0065.f4740(var30_116);
                    final SubLObject var118 = (SubLObject)module0380.NIL;
                    SubLObject var119;
                    SubLObject var120;
                    SubLObject var121;
                    SubLObject var122;
                    ...
                    SubLObject var126;
                    SubLObject var127;
                    for (var119 = Sequences.length(var117), var120 = (SubLObject)module0380.NIL, var120 = (SubLObject)module0380.ZERO_INTEGER; var120.numL(var119); var120 = Numbers.add(var120, (SubLObject)module0380.ONE_INTEGER)) {
                        var121 = ((module0380.NIL != var118) ? Numbers.subtract(var119, var120, (SubLObject)module0380.ONE_INTEGER) : var120);
                        var122 = Vectors.aref(var117, var121);
                        if (module0380.NIL == module0065.f4749(var122) || module0380.NIL == module0065.f4773((SubLObject)module0380.$ic9$)) {
                            if (module0380.NIL != module0065.f4749(var122)) {
                                var122 = (SubLObject)module0380.$ic9$;
                            }
                ...
                if (module0380.NIL == module0065.f4777(var43_117)) {
                    final SubLObject var128 = module0065.f4738(var43_117);
                    SubLObject var129 = (SubLObject)module0380.NIL;
                    SubLObject var130 = (SubLObject)module0380.NIL;
                    ...
                    try {
                        while (Hashtables.iteratorHasNext(var131)) {
                            ...
                            if (module0380.NIL != module0363.f24547(var114, var130)) {
                                ...
                                SubLObject var136;
                                SubLObject var137;
                                for (var135 = module0032.f1741(var134), var136 = (SubLObject)module0380.NIL, var136 = module0032.f1742(var135, var134); module0380.NIL == module0032.f1744(var135, var136); var136 = module0032.f1743(var136)) {
                                    var137 = module0032.f1745(var135, var136);
                                    if (module0380.NIL != module0032.f1746(var136, var137)) {
    ...
    public static SubLObject f27014() {
        module0380.$g3208$ = SubLFiles.defparameter("S#30149", module0340.f22997((SubLObject)module0380.$ic0$, (SubLObject)module0380.UNPROVIDED));
        module0380.$g3209$ = SubLFiles.deflexical("S#30150", (SubLObject)module0380.$ic15$);
        module0380.$g3210$ = SubLFiles.deflexical("S#30151", (SubLObject)module0380.$ic16$);
        module0380.$g3211$ = SubLFiles.defparameter("S#30152", (SubLObject)module0380.T);
        module0380.$g3212$ = SubLFiles.deflexical("S#30153", (module0380.NIL != Symbols.boundp((SubLObject)module0380.$ic21$)) ? module0380.$g3212$.getGlobalValue() : module0340.f23003((SubLObject)module0380.$ic22$, (SubLObject)module0380.UNPROVIDED));
        module0380.$g3213$ = SubLFiles.deflexical("S#30154", (SubLObject)module0380.$ic15$);
        module0380.$g3214$ = SubLFiles.deflexical("S#30155", (SubLObject)module0380.$ic23$);
        module0380.$g3215$ = SubLFiles.defparameter("S#30156", (SubLObject)module0380.NIL);
        module0380.$g3216$ = SubLFiles.defparameter("S#30157", (SubLObject)module0380.T);
        module0380.$g3217$ = SubLFiles.defparameter("S#30158", (SubLObject)module0380.T);
        return (SubLObject)module0380.NIL;
    }
    
    public static SubLObject f27015() {
        module0003.f57((SubLObject)module0380.$ic21$);
        return (SubLObject)module0380.NIL;
    }
    ...
    static {
        ...
        module0380.$g3208$ = null;
        module0380.$g3209$ = null;
        module0380.$g3210$ = null;
        module0380.$g3211$ = null;
        module0380.$g3212$ = null;
        module0380.$g3213$ = null;
        module0380.$g3214$ = null;
        module0380.$g3215$ = null;
        module0380.$g3216$ = null;
        module0380.$g3217$ = null;
        $ic0$ = SubLObjectFactory.makeKeyword("SPLIT");
        $ic1$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#25405", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#15216", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#30159", "CYC")), (SubLObject)SubLObjectFactory.makeSymbol("&BODY"), (SubLObject)SubLObjectFactory.makeSymbol("S#5", "CYC"));
        $ic2$ = SubLObjectFactory.makeUninternedSymbol("US#6DAC82A");
        $ic3$ = SubLObjectFactory.makeSymbol("CLET");
        $ic4$ = SubLObjectFactory.makeSymbol("S#25372", "CYC");
        $ic5$ = SubLObjectFactory.makeSymbol("PWHEN");
        $ic6$ = SubLObjectFactory.makeSymbol("S#27656", "CYC");
        $ic7$ = SubLObjectFactory.makeString("~s is not a supporting mapped problem of ~s.");
        $ic8$ = SubLObjectFactory.makeString("couldn't find any split tactics for ~s");
        $ic9$ = SubLObjectFactory.makeKeyword("SKIP");
        $ic10$ = SubLObjectFactory.makeString("Could not find the link for ~a");
        $ic11$ = SubLObjectFactory.makeSymbol("S#27351", "CYC");
        $ic12$ = SubLObjectFactory.makeString("Generalized tactic ~a did not indicate a valid supporting mapped problem");
        $ic13$ = SubLObjectFactory.makeString("Tried to make a split link with less than two supporting problems: ~a");
        $ic14$ = SubLObjectFactory.makeKeyword("TACTICAL");
        $ic15$ = SubLObjectFactory.makeKeyword("PREFERRED");
        $ic16$ = SubLObjectFactory.makeString("the default for split tactics");
        $ic17$ = SubLObjectFactory.makeKeyword("PROVEN");
        $ic18$ = SubLObjectFactory.makeKeyword("NEG");
        $ic19$ = SubLObjectFactory.makeKeyword("POS");
        $ic20$ = SubLObjectFactory.makeSymbol("HL-VARIABLE-P");
        $ic21$ = SubLObjectFactory.makeSymbol("S#30153", "CYC");
        $ic22$ = SubLObjectFactory.makeKeyword("DETERMINE-NEW-SPLIT-TACTICS");
        $ic23$ = SubLObjectFactory.makeString("the default for meta-split tactics");
        $ic24$ = SubLObjectFactory.makeKeyword("META-STRUCTURAL");
        $ic25$ = SubLObjectFactory.makeString("unexpected meta-structural tactic ~s");
        $ic26$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("ONE-NO-GOOD"), (SubLObject)SubLObjectFactory.makeKeyword("ALL-SINGLE-LITERAL"), (SubLObject)SubLObjectFactory.makeKeyword("ALL-THE-REST"));
        $ic27$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("ONE-NO-GOOD"), (SubLObject)SubLObjectFactory.makeKeyword("ONE-CLOSED-PROBLEM-REUSE"), (SubLObject)SubLObjectFactory.makeKeyword("ALL-SINGLE-LITERAL-PROBLEM-REUSE"), (SubLObject)SubLObjectFactory.makeKeyword("ONE-CLOSED"), (SubLObject)SubLObjectFactory.makeKeyword("ALL-THE-REST"));
        $ic28$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("ONE-NO-GOOD"), (SubLObject)SubLObjectFactory.makeKeyword("ONE-CLOSED"), (SubLObject)SubLObjectFactory.makeKeyword("ALL-THE-REST"));
        $ic29$ = SubLObjectFactory.makeKeyword("ONE-NO-GOOD");
        $ic30$ = SubLObjectFactory.makeKeyword("ALL-SINGLE-LITERAL");
        $ic31$ = SubLObjectFactory.makeKeyword("ALL-PROBLEM-REUSE");
        $ic32$ = SubLObjectFactory.makeKeyword("ONE-CLOSED");
        $ic33$ = SubLObjectFactory.makeKeyword("ONE-CLOSED-PROBLEM-REUSE");
        $ic34$ = SubLObjectFactory.makeKeyword("ALL-SINGLE-LITERAL-PROBLEM-REUSE");
        $ic35$ = SubLObjectFactory.makeKeyword("ALL-THE-REST");
        $ic36$ = SubLObjectFactory.makeString("Unknown meta-split criterion ~s");
        $ic37$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#134", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#30160", "CYC"));
    }
}
...
/*
	...
	Decompiled from: G:\opt\CYC_JRTL_with_CommonLisp\platform\lib\cyc-oc4.0-unzipped/com/cyc/cycjava/cycl/module0380.class
	Total time: 341 ms
