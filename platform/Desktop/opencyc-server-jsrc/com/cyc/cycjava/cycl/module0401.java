...
public final class module0401 extends SubLTranslatedFile
{
    ...
    public static SubLObject f28265(final SubLObject var1) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0401.NIL != module0402.f28280(var1) && module0401.NIL == module0367.f25079(var1));
    }
    
    public static SubLObject f28266(final SubLObject var1) {
        final SubLThread var2 = SubLProcess.currentSubLThread();
        SubLObject var3;
        for (var3 = (SubLObject)module0401.$ic0$; module0401.$ic0$ == var3; var3 = f28267(var1)) {}
        if (module0401.NIL != module0018.$g629$.getDynamicValue(var2) && module0401.$ic1$ == var3 && module0401.NIL == module0402.f28280(var1)) {
            Errors.cerror((SubLObject)module0401.$ic2$, (SubLObject)module0401.$ic3$, var1);
        }
        return Equality.eq((SubLObject)module0401.$ic1$, var3);
    }
    
    public static SubLObject f28267(final SubLObject var1) {
        SubLObject var2 = (SubLObject)module0401.NIL;
        if (module0401.NIL != module0367.f25060(var1)) {
            module0387.f27567(var1);
            var2 = (SubLObject)module0401.$ic0$;
        }
        else if (module0401.NIL != module0387.f27469(var1)) {
            var2 = (SubLObject)module0401.$ic1$;
        }
        else {
            final SubLObject var3 = f28268(var1);
            if (module0401.NIL != var3) {
    ...
    public static SubLObject f28268(final SubLObject var1) {
        return module0367.f25109(var1, (SubLObject)module0401.$ic4$, (SubLObject)module0401.UNPROVIDED, (SubLObject)module0401.UNPROVIDED, (SubLObject)module0401.UNPROVIDED, (SubLObject)module0401.UNPROVIDED, (SubLObject)module0401.UNPROVIDED);
    }
    
    public static SubLObject f28269(final SubLObject var1) {
        f28270(var1);
        if (module0401.NIL == module0402.f28280(var1)) {
            return module0402.f28286(var1);
        }
        if (module0401.NIL != module0367.f25079(var1)) {
            return module0367.f25077(var1);
        }
        return (SubLObject)module0401.NIL;
    }
    
    public static SubLObject f28270(final SubLObject var1) {
        final SubLThread var2 = SubLProcess.currentSubLThread();
        assert module0401.NIL != module0398.f28152(var1) : var1;
        if (Numbers.mod(module0367.f25065(var1), module0401.$g3291$.getDynamicValue(var2)).isZero()) {
        ...
        while (true) {
            ...
            if (module0401.NIL == var4) {
                return var3;
            }
            final SubLObject var5 = var4;
            if (var5.eql((SubLObject)module0401.$ic7$)) {
                module0398.f28172(var1, var3);
            }
            else if (var5.eql((SubLObject)module0401.$ic8$)) {}
    ...
    public static SubLObject f28271(final SubLObject var1, final SubLObject var4) {
        assert module0401.NIL != module0398.f28152(var1) : var1;
        assert module0401.NIL != module0387.f27526(var4) : var4;
        SubLObject var5 = (SubLObject)module0401.$ic0$;
        if (module0401.NIL != module0387.f27527(var4)) {
            final SubLObject var6 = module0387.f27530(var4);
            module0400.f28257(var1, var4);
            f28272(var1, var4);
            module0400.f28258(var1, var6);
            var5 = (SubLObject)module0401.$ic10$;
        }
        else if (module0401.NIL != module0373.f26163(var4)) {
        ...
        else if (module0401.NIL != module0377.f26746(var4)) {
            module0400.f28233(var1, var4);
            module0400.f28256(var1, var4);
            var5 = (SubLObject)module0401.$ic10$;
        }
        else {
            if (module0401.NIL == module0374.f26529(var4)) {
                return Errors.error((SubLObject)module0401.$ic11$, var4);
            }
    ...
    public static SubLObject f28272(final SubLObject var1, final SubLObject var8) {
        if (module0401.NIL != module0373.f26176(var8)) {
    ...
    public static SubLObject f28275(final SubLObject var1, final SubLObject var4) {
        ...
        if (module0401.NIL != var5) {
            module0400.f28255(var1, var4);
        }
        module0387.f27510(var1, var4);
        if (module0401.NIL == var5 && module0401.NIL != module0365.f24883(var4)) {
            module0400.f28255(var1, var4);
        }
        return var4;
    }
    ...
    public static SubLObject f28277() {
        module0401.$g3291$ = SubLFiles.defparameter("S#31403", (SubLObject)module0401.$ic5$);
        return (SubLObject)module0401.NIL;
    }
    ...
    static {
        ...
        module0401.$g3291$ = null;
        $ic0$ = SubLObjectFactory.makeKeyword("UNINTERESTING");
        $ic1$ = SubLObjectFactory.makeKeyword("DONE");
        $ic2$ = SubLObjectFactory.makeString("Continue");
        $ic3$ = SubLObjectFactory.makeString("~s says it's done, but its T-box is nonempty");
        $ic4$ = SubLObjectFactory.makeKeyword("SELECT-BEST-STRATEGEM");
        $ic5$ = SubLObjectFactory.makeInteger(50);
        $ic6$ = SubLObjectFactory.makeSymbol("S#30356", "CYC");
        ...
        $ic11$ = SubLObjectFactory.makeString("~S was an unexpected strategem");
    }
}
...
/*
	...
	Decompiled from: G:\opt\CYC_JRTL_with_CommonLisp\platform\lib\cyc-oc4.0-unzipped/com/cyc/cycjava/cycl/module0401.class
	Total time: 79 ms
