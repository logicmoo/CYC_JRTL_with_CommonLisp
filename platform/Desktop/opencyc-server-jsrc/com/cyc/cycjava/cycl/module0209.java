...
public final class module0209 extends SubLTranslatedFile
{
    ...
    public static SubLObject f13550(final SubLObject var1) {
        return (SubLObject)makeBoolean(var1.isString() || NIL != module0208.f13537(var1, (SubLObject)UNPROVIDED));
    }
    
    public static SubLObject f13551(final SubLObject var1) {
        return (SubLObject)makeBoolean(NIL != f13550(var1) && NIL != module0038.f2746(f13552(var1)));
    }
    ...
    public static SubLObject f13552(final SubLObject var2) {
        if (NIL != module0208.f13537(var2, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f13554(final SubLObject var3) {
        return module0039.f3000((NIL != module0039.f3006(var3)) ? var3 : module0205.f13277(var3, (SubLObject)UNPROVIDED));
    }
    
    public static SubLObject f13555(final SubLObject var4) {
        return Mapping.mapcar((SubLObject)$ic1$, var4);
    }
    
    public static SubLObject f13556(final SubLObject var5, final SubLObject var6) {
        return Strings.stringE(f13552(var5), f13552(var6), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f13557(final SubLObject var5, final SubLObject var6) {
        return Strings.string_equal(f13552(var5), f13552(var6), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f13558(final SubLObject var2, final SubLObject var7, final SubLObject var8) {
        assert NIL != f13550(var2) : var2;
        assert NIL != f13550(var7) : var7;
        if (var2.isString() && var7.isString()) {
            return module0038.f2756(var2, var7, var8, (SubLObject)UNPROVIDED);
        }
        ...
        return (SubLObject)makeBoolean(NIL != module0035.f2008(var10, var12) && (NIL != module0038.f2756(var9, var11, var8, (SubLObject)UNPROVIDED) || NIL != Sequences.search(var12, var10, var8, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)));
    }
    
    public static SubLObject f13559(final SubLObject var2, final SubLObject var13, final SubLObject var8) {
        assert NIL != f13550(var2) : var2;
        assert NIL != f13550(var13) : var13;
        ...
        return (SubLObject)makeBoolean(NIL != module0035.f2008(var15, var17) && (NIL != module0038.f2675(var14, var16, var8) || var17.equalp(Sequences.subseq(var15, (SubLObject)ZERO_INTEGER, Sequences.length(var17)))));
    }
    
    public static SubLObject f13560(final SubLObject var2, final SubLObject var14, final SubLObject var8) {
        assert NIL != f13550(var2) : var2;
        assert NIL != f13550(var14) : var14;
        ...
        return (SubLObject)makeBoolean(NIL != module0035.f2008(var16, var18) && (NIL != module0038.f2673(var15, var17, var8) || var18.equalp(Sequences.subseq(var16, Numbers.subtract(Sequences.length(var16), Sequences.length(var18)), (SubLObject)UNPROVIDED))));
    }
    
    public static SubLObject f13561(final SubLObject var3) {
        final SubLThread var4 = SubLProcess.currentSubLThread();
        SubLObject var5 = var3;
        if (NIL != Sequences.find_if((SubLObject)$ic3$, var3, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
            var5 = module0039.f3036(module0039.f3044(var3));
        }
        if (NIL != module0039.f3012(var5)) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        final SubLObject var9 = module0039.f3017(var8, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            ...
            if (NIL != var6) {
                Errors.warn((SubLObject)$ic5$, var3, var6);
            }
        }
        return var5;
    }
    ...
    static {
        ...
        $ic0$ = makeSymbol("CYCL-TO-UTF8-STRING");
        $ic1$ = makeSymbol("S#16391", "CYC");
        $ic2$ = makeSymbol("S#3935", "CYC");
        $ic3$ = makeSymbol("S#3950", "CYC");
        $ic4$ = makeSymbol("S#38", "CYC");
        $ic5$ = makeString("Error converting string to CycL:~% ~S~% ~S");
    }
}
