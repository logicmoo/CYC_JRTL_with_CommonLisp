...
public final class module0713 extends SubLTranslatedFile
{
    ...
    public static SubLObject f43848(final SubLObject var1) {
        ...
        var3 = module0166.f10737(var2);
        if (module0713.NIL != module0173.f10955(var3)) {
            return var3;
        }
        var3 = module0166.f10737(module0038.f2842((SubLObject)Characters.CHAR_underbar, (SubLObject)Characters.CHAR_hyphen, var2));
        if (module0713.NIL != module0173.f10955(var3)) {
            return var3;
        }
        var3 = module0166.f10737(module0038.f2842((SubLObject)Characters.CHAR_hyphen, (SubLObject)Characters.CHAR_underbar, var2));
        if (module0713.NIL != module0173.f10955(var3)) {
            return var3;
        }
        return (SubLObject)module0713.NIL;
    ...
    static {
        ...
        $ic40$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("retainTerm"));
        $ic41$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("OWLOntologyFn"));
        $ic42$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("BaseKB"));
        $ic43$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ContextOfPCWFn"));
        ...
        $ic50$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("baseNamespaceForSKS"));
        $ic51$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("URIFn"));
        $ic52$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("nameSpacePrefixForSKS"));
        ...
        $ic71$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Cyclist"));
        $ic72$ = SubLObjectFactory.makeString("~A: IMPORTER-OPTIONS :cyclist ~A is not a #$Cyclist~%");
        $ic73$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Guest"));
        ...
        $ic81$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SoftwareVersion"));
        $ic82$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("OWLImporter-Cyc"));
        $ic83$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("UserOfProgramFn"));
        ...
        $ic146$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SoftwareVersionFn"));
        ...
        $ic162$ = ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("OWLProperty")));
        ...
        $ic167$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TheEmptyList"));
        $ic168$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TheList"));
        ...
        $ic175$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("genls"));
        ...
        $ic178$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("quotedIsa"));
        $ic179$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TermFromOntologyFn"));
        $ic180$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("BookkeepingMt"));
        $ic181$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("synonymousExternalConcept"));
        $ic182$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("rdfURI"));
        ...
        $ic189$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CollectionIntersectionFn"));
        $ic190$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TheSet"));
        ...
        $ic194$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CollectionDifferenceFn"));
        $ic195$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Thing"));
        ...
        $ic206$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationAllOnly"));
        $ic207$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CollectionSubsetFn"));
        $ic208$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TheSetOf"));
        $ic209$ = SubLObjectFactory.makeSymbol("?X");
        $ic210$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceOnly"));
        $ic211$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExists"));
        $ic212$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceExists"));
        $ic213$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationAllInstance"));
        $ic214$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsMax"));
        $ic215$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceExistsMax"));
        $ic216$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsMin"));
        $ic217$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceExistsMin"));
        $ic218$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsCount"));
        $ic219$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceExistsCount"));
        $ic220$ = SubLObjectFactory.makeString("restriction not handled yet: ~A~% ~A~% ~A~% ~A~%");
        $ic221$ = SubLObjectFactory.makeString("oneOf");
        $ic222$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TheCollection"));
        $ic223$ = SubLObjectFactory.makeString("AnonymousOWLTerm");
        $ic224$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt"));
        $ic225$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("IndeterminateTerm"));
