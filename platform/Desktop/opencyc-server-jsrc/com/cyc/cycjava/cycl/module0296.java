...
public final class module0296 extends SubLTranslatedFile
{
    ...
    public static SubLObject f19924(final SubLObject var1, SubLObject var2, SubLObject var6, SubLObject var7) {
        ...
        try {
            ...
            if (NIL != var6) {
                ...
                SubLObject var15;
                final SubLObject var14 = var15 = f19925(var1, var13, var2, (SubLObject)NIL, var6, (SubLObject)$ic2$, var7);
                SubLObject var16 = (SubLObject)NIL;
                var16 = var15.first();
                while (NIL != var15) {
                    if (NIL != f19926(var16, var2)) {
                        final SubLObject var17 = f19927(var16, var2, var6);
                        if (NIL != f19928(var1, var13, var16, var17)) {
    ...
    public static SubLObject f19929(final SubLObject var1, final SubLObject var2, final SubLObject var3, final SubLObject var5) {
        ...
        if (var12 == $ic4$) {
            ...
            var17 = ((NIL != module0173.f10955(var1)) ? var16 : ConsesLow.append(var16, var5));
        }
        else {
    ...
    public static SubLObject f19923(final SubLObject var1, final SubLObject var2, final SubLObject var3, final SubLObject var5) {
        ...
        var8 = module0034.f1857(var7, (SubLObject)$ic3$, (SubLObject)UNPROVIDED);
        if (NIL == var8) {
            var8 = module0034.f1807(module0034.f1842(var7), (SubLObject)$ic3$, (SubLObject)FOUR_INTEGER, (SubLObject)$ic6$, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var7, (SubLObject)$ic3$, var8);
        }
                ...
                if (var1.equal(var13.first())) {
                    ...
                    if (var2.equal(var13.first())) {
                        ...
                        if (var3.equal(var13.first())) {
                            var13 = var13.rest();
                            if (NIL != var13 && NIL == var13.rest() && var5.equal(var13.first())) {
    ...
    public static SubLObject f19934(final SubLObject var16, final SubLObject var42, final SubLObject var2) {
        ...
        if (NIL != f19935(var16) && NIL == var46) {
            SubLObject var47 = var45;
            SubLObject var48 = (SubLObject)NIL;
            var48 = var47.first();
            while (NIL == var46 && NIL != var47) {
                if (NIL != module0222.f14635($ic8$, var48, (SubLObject)ONE_INTEGER, (SubLObject)UNPROVIDED)) {
                    final SubLObject var49 = module0147.$g2094$.currentBinding(var43);
                    final SubLObject var50 = module0147.$g2095$.currentBinding(var43);
                    try {
                        module0147.$g2094$.bind((SubLObject)$ic9$, var43);
                        module0147.$g2095$.bind(var2, var43);
                        if (NIL != module0035.sublisp_boolean(module0220.f14553(var48, $ic8$, (SubLObject)ONE_INTEGER, (SubLObject)ONE_INTEGER, (SubLObject)UNPROVIDED))) {
                            var46 = (SubLObject)T;
                        }
                    }
                    finally {
    ...
    public static SubLObject f19936(final SubLObject var16, final SubLObject var42, final SubLObject var2) {
        ...
        if (NIL != f19935(var16)) {
            ...
            if ($ic10$.eql(var42) && NIL != module0204.f13060(var47)) {
                var45 = module0204.f13063(var47);
            }
            else {
                var45 = module0205.f13203(module0293.f19754(var16), (SubLObject)UNPROVIDED);
            }
            if (NIL != module0004.f104(var45, var44, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) && NIL != module0269.f17769(var45, var2)) {
                var46 = (SubLObject)T;
            }
        }
        return var46;
    ...
    public static SubLObject f19935(final SubLObject var16) {
        ...
        return (SubLObject)makeBoolean(var17.eql($ic11$) || var17.eql($ic12$));
    }
    ...
    public static SubLObject f19932(final SubLObject var1, final SubLObject var13, final SubLObject var16, final SubLObject var2, final SubLObject var3, final SubLObject var6, final SubLObject var20) {
        ...
        if (NIL == f19928(var1, var13, var16, var22)) {
            return (SubLObject)NIL;
        }
        if (NIL != f19934(var16, var22, var2)) {
            return (SubLObject)NIL;
        }
        if (NIL != f19936(var16, var22, var2)) {
            return (SubLObject)NIL;
        }
        ...
        var21.resetMultipleValues();
        if (NIL != var23 && NIL != f19938(var1, var16, var2, var23, var24, var25, var3, var22)) {
            return var23;
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f19937(SubLObject var1, final SubLObject var16, final SubLObject var2, final SubLObject var17, final SubLObject var20) {
        ...
        try {
            module0295.$g2691$.bind((SubLObject)NIL, var21);
            ...
            if (NIL != var25) {
                ...
                var29 = conses_high.nsublis(var23, var29, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                var29 = conses_high.nsublis(var25, var29, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f19939(final SubLObject var59, final SubLObject var60, final SubLObject var61, final SubLObject var62) {
        ...
        var63 = ((NIL != var61) ? module0235.f15481(var59, var60, (SubLObject)NIL, (SubLObject)UNPROVIDED).first() : module0234.f15444(var59, var60, (SubLObject)NIL, (SubLObject)UNPROVIDED));
        if (NIL != f19940(var59, var60, var63)) {
            return var63;
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f19940(final SubLObject var59, final SubLObject var60, final SubLObject var63) {
        ...
        var67 = var66.first();
        while (NIL != var66) {
            if (NIL != module0201.f12546(var67.first())) {
        ...
        final SubLObject var68 = conses_high.sublis(var65, var59, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        final SubLObject var69 = conses_high.sublis(var65, var60, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        ...
        while (NIL != var70) {
            ...
            if (NIL != f19941(var68, var69, var72, var73)) {
                return (SubLObject)NIL;
            }
            var70 = var70.rest();
            var71 = var70.first();
        }
        if (NIL != module0035.f2194(var64, Symbols.symbol_function((SubLObject)EQUAL), Symbols.symbol_function((SubLObject)$ic13$)) || NIL != module0035.f2194(var64, Symbols.symbol_function((SubLObject)EQUAL), Symbols.symbol_function((SubLObject)$ic14$))) {
            return (SubLObject)NIL;
        }
        return (SubLObject)T;
    }
    ...
    public static SubLObject f19941(final SubLObject var59, final SubLObject var60, final SubLObject var69, final SubLObject var70) {
        return (SubLObject)makeBoolean(NIL != module0205.f13220(var69, var60, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0205.f13220(var70, var59, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
    }
    ...
    public static SubLObject f19927(final SubLObject var16, final SubLObject var2, final SubLObject var6) {
        ...
        if (NIL == var17) {
            SubLObject var18;
            SubLObject var19;
            for (var18 = var6, var19 = (SubLObject)NIL, var19 = var18.first(); NIL == var17 && NIL != var18; var17 = f19943(var16, var2, var19), var18 = var18.rest(), var19 = var18.first()) {}
        }
        return var17;
    }
    ...
    public static SubLObject f19946(final SubLObject var73, final SubLObject var2) {
        ...
        if (NIL == var74) {
            ...
            while (NIL == var74 && NIL != var75) {
                if (NIL == f19948(var76) && NIL != f19949(var76, var2)) {
                    var74 = f19950(var76);
                }
                var75 = var75.rest();
                var76 = var75.first();
    ...
    public static SubLObject f19948(final SubLObject var75) {
        return Equality.eq(f19950(var75), $ic15$);
    }
    ...
    public static SubLObject f19925(final SubLObject var1, final SubLObject var13, final SubLObject var2, final SubLObject var18, final SubLObject var6, final SubLObject var20, final SubLObject var7) {
        ...
        if (NIL != constant_handles_oc.f8449(var1)) {
            var21 = Hashtables.gethash(var1, module0295.f19837(), (SubLObject)UNPROVIDED);
        }
        else if (NIL != module0167.f10813(var1)) {
            var21 = Hashtables.gethash(var1, module0295.f19838(), (SubLObject)UNPROVIDED);
        }
        else {
            ...
            var24 = var23.first();
            while (NIL != var23) {
                var21 = conses_high.union(var21, Hashtables.gethash(var24, module0295.f19836(), (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                var23 = var23.rest();
                var24 = var23.first();
            }
        }
        ...
        var25 = var23.first();
        while (NIL != var23) {
            if (NIL == module0004.f104(var25, var18, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                final SubLObject var26 = Hashtables.gethash(var25, module0295.f19835(), (SubLObject)UNPROVIDED);
                if (NIL != f19952(var26, var2, var6, var20, var7)) {
    ...
    public static SubLObject f19953(final SubLObject var22, final SubLObject var18, final SubLObject var2, final SubLObject var6, final SubLObject var20, final SubLObject var7) {
        ...
        var25 = module0034.f1857(var24, (SubLObject)$ic16$, (SubLObject)UNPROVIDED);
        if (NIL == var25) {
            var25 = module0034.f1807(module0034.f1842(var24), (SubLObject)$ic16$, (SubLObject)SIX_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var24, (SubLObject)$ic16$, var25);
        }
        final SubLObject var26 = module0034.f1778(var22, var18, var2, var6, var20, var7);
        final SubLObject var27 = module0034.f1814(var25, var26, (SubLObject)UNPROVIDED);
        if (var27 != $ic7$) {
                        ...
                        if (var2.equal(var30.first())) {
                            ...
                            if (var6.equal(var30.first())) {
                                ...
                                if (var20.equal(var30.first())) {
                                    var30 = var30.rest();
                                    if (NIL != var30 && NIL == var30.rest() && var7.equal(var30.first())) {
    ...
    public static SubLObject f19955(final SubLObject var22, final SubLObject var18, final SubLObject var2, final SubLObject var6, final SubLObject var20, final SubLObject var7) {
        ...
        var25 = var24.first();
        while (NIL != var24) {
            if (NIL == module0004.f104(module0295.f19834(var25), var18, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) && NIL != f19952(var25, var2, var6, var20, var7)) {
    ...
    public static SubLObject f19952(final SubLObject var16, final SubLObject var2, final SubLObject var6, final SubLObject var20, final SubLObject var7) {
        return (SubLObject)makeBoolean(NIL != f19956(var16, var20) && NIL != f19926(var16, var2) && NIL != f19957(var16, var7) && NIL != f19958(var16, var6, var2));
    }
    ...
    public static SubLObject f19959(final SubLObject var13, final SubLObject var2) {
        ...
        var16 = var15.first();
        while (NIL != var15) {
            if (NIL != module0269.f17715(var16)) {
                SubLObject var15_82 = module0260.f17028(var16, var2, (SubLObject)UNPROVIDED);
                SubLObject var17 = (SubLObject)NIL;
            ...
            else if (NIL != module0269.f17709(var16)) {
            ...
            else if (NIL != module0269.f17730(var16)) {
                SubLObject var15_84 = module0262.f17311(var16, var2, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f19930(final SubLObject var40, final SubLObject var1, final SubLObject var13, final SubLObject var2, final SubLObject var6) {
        ...
        var50 = var49.first();
        while (NIL != var49) {
            if (NIL != f19960(var50, var2) && NIL != f19961(var50, var13)) {
                if (NIL != f19962(var50, var41, var2)) {
                    var44 = (SubLObject)ConsesLow.cons(var50, var44);
                }
                else if (NIL != f19962(var50, var42, var2)) {
                    var45 = (SubLObject)ConsesLow.cons(var50, var45);
                }
                else if (NIL != f19962(var50, var43, var2)) {
    ...
    public static SubLObject f19960(final SubLObject var16, final SubLObject var2) {
        ...
        final SubLObject var20 = module0147.$g2095$.currentBinding(var17);
        try {
            module0147.$g2094$.bind((SubLObject)$ic18$, var17);
    ...
    public static SubLObject f19961(final SubLObject var16, final SubLObject var97) {
        SubLObject var98 = (SubLObject)T;
        SubLObject var99 = (SubLObject)NIL;
        if (NIL == var99) {
            SubLObject var100 = var97;
            SubLObject var101 = (SubLObject)NIL;
            var101 = var100.first();
            while (NIL == var99 && NIL != var100) {
                if (NIL == module0293.f19756(var16, var101)) {
    ...
    public static SubLObject f19956(final SubLObject var81, final SubLObject var20) {
        ...
        if (var20.eql((SubLObject)$ic19$)) {
            var83 = (SubLObject)T;
        }
        else if (var20.eql((SubLObject)$ic2$)) {
            var83 = conses_high.member(var82, (SubLObject)$ic20$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        else if (var20.eql((SubLObject)$ic21$)) {
            var83 = conses_high.member(var82, (SubLObject)$ic22$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        else if (var20.eql((SubLObject)$ic23$)) {
            var83 = Equality.eq(var82, (SubLObject)$ic23$);
        }
        return var83;
    }
    ...
    public static SubLObject f19958(final SubLObject var81, final SubLObject var6, final SubLObject var2) {
        ...
        if (NIL == var82) {
            SubLObject var83;
            SubLObject var84;
            for (var83 = var6, var84 = (SubLObject)NIL, var84 = var83.first(); NIL == var82 && NIL != var83; var82 = f19962(var81, var84, var2), var83 = var83.rest(), var84 = var83.first()) {}
        }
        return var82;
    }
    ...
    public static SubLObject f19962(final SubLObject var81, final SubLObject var72, final SubLObject var2) {
        ...
        final SubLObject var85 = module0035.delete_if_not((SubLObject)$ic24$, ConsesLow.append(var83, var84), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        final SubLObject var86 = Mapping.mapcar(Symbols.symbol_function((SubLObject)$ic25$), var85);
        ...
        if (NIL != var86) {
            ...
            try {
                ...
                if (NIL == var87) {
                    SubLObject var90;
                    SubLObject var91;
                    for (var90 = var86, var91 = (SubLObject)NIL, var91 = var90.first(); NIL == var87 && NIL != var90; var87 = module0147.f9507(var91), var90 = var90.rest(), var91 = var90.first()) {}
                }
            }
            finally {
        ...
        return (SubLObject)makeBoolean(NIL == var87);
    }
    ...
    public static SubLObject f19963(final SubLObject var81, final SubLObject var72, final SubLObject var2, final SubLObject var73) {
        ...
        var85 = var84.first();
        while (NIL != var84) {
            if (NIL == f19964(var85, var2, var73)) {
            ...
            while (NIL == var108 && NIL != var109) {
                if (NIL != f19949(var110, var2)) {
                    ...
                    try {
                        ...
                        var108 = (SubLObject)makeBoolean(NIL != module0147.f9507(var107) && NIL != module0147.f9507(f19951(var110)));
                    }
                    finally {
    ...
    public static SubLObject f19957(final SubLObject var16, final SubLObject var7) {
        ...
        if (NIL == var18) {
            ...
            while (NIL == var18 && NIL != var19) {
                if (NIL != module0178.f11284(var20) && NIL != conses_high.member(module0178.f11333(var20), var7, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                    var18 = (SubLObject)T;
                }
                var19 = var19.rest();
                var20 = var19.first();
    ...
    public static SubLObject f19938(final SubLObject var1, final SubLObject var16, final SubLObject var2, final SubLObject var50, final SubLObject var51, final SubLObject var52, final SubLObject var3, final SubLObject var111) {
        ...
        while (NIL != var114) {
            ...
            var112.resetMultipleValues();
            if (NIL != f19966(var116, var111) && NIL != f19967(var118, var2) && NIL == f19968(var117, var1, var16, var2, var50, var51, var52, var113, var3)) {
                return (SubLObject)NIL;
            }
            var114 = var114.rest();
            var115 = var114.first();
    ...
    public static SubLObject f19968(final SubLObject var115, final SubLObject var1, final SubLObject var16, final SubLObject var2, final SubLObject var50, final SubLObject var51, final SubLObject var52, final SubLObject var112, final SubLObject var3) {
        final SubLObject var116 = conses_high.nsublis(var52, conses_high.sublis(var51, var115, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        SubLObject var117 = (SubLObject)NIL;
        if (var112.eql((SubLObject)$ic26$)) {
    ...
    public static SubLObject f19970(final SubLObject var117, final SubLObject var2, final SubLObject var3) {
        ...
        SubLObject var120 = $g2692$.getGlobalValue();
        final SubLObject var121 = module0291.f19647(var3);
        if (NIL != var121) {
            var120 = ConsesLow.append((SubLObject)ConsesLow.list((SubLObject)$ic29$, Numbers.floor(var121, (SubLObject)UNPROVIDED)), var120);
        }
        ...
        try {
            module0018.$g696$.bind((SubLObject)NIL, var118);
            module0271.$g2562$.bind((SubLObject)NIL, var118);
            module0144.$g1752$.bind((SubLObject)NIL, var118);
            module0271.$g2560$.bind((SubLObject)NIL, var118);
            module0271.$g2561$.bind((SubLObject)NIL, var118);
            module0271.$g2563$.bind((SubLObject)NIL, var118);
            module0146.$g2055$.bind((SubLObject)NIL, var118);
            module0144.$g1771$.bind((SubLObject)NIL, var118);
            module0144.$g1769$.bind((SubLObject)NIL, var118);
            module0152.$g2107$.bind((SubLObject)NIL, var118);
            module0110.$g1374$.bind((SubLObject)T, var118);
            module0271.$g2564$.bind((SubLObject)NIL, var118);
            if (NIL != module0202.f12691(var117, (SubLObject)UNPROVIDED) && NIL != module0552.f34036(var117)) {
                if (NIL != module0347.f23352(var117)) {
                    var119 = module0347.f23354(var117, (NIL != var2) ? var2 : module0147.$g2095$.getDynamicValue(var118), (SubLObject)UNPROVIDED);
                }
                else {
                    var119 = module0540.f33526(module0409.f28506(var117, (NIL != var2) ? var2 : module0147.$g2095$.getDynamicValue(var118), var120));
                }
            }
        }
        finally {
    ...
    public static SubLObject f19969(final SubLObject var117, final SubLObject var2, final SubLObject var3) {
        ...
        var120 = module0034.f1857(var119, (SubLObject)$ic28$, (SubLObject)UNPROVIDED);
        if (NIL == var120) {
            var120 = module0034.f1807(module0034.f1842(var119), (SubLObject)$ic28$, (SubLObject)THREE_INTEGER, (SubLObject)$ic30$, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var119, (SubLObject)$ic28$, var120);
        }
            ...
            while (NIL != var123) {
                ...
                if (var117.equal(var125.first())) {
                    ...
                    if (var2.equal(var125.first())) {
                        var125 = var125.rest();
                        if (NIL != var125 && NIL == var125.rest() && var3.equal(var125.first())) {
    ...
    public static SubLObject f19974(final SubLObject var1, final SubLObject var13, final SubLObject var133) {
        return module0035.f2183(module0295.f19816(var133), var13, Symbols.symbol_function((SubLObject)EQL), (SubLObject)$ic31$, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f19976() {
        $g2692$ = SubLFiles.defconstant("S#22621", (SubLObject)$ic27$);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g2692$ = null;
        $ic0$ = constant_handles_oc.f8479((SubLObject)makeString("ReformulatorRuleUnifier"));
        $ic1$ = ConsesLow.list(new SubLObject[] { makeKeyword("REQUIRED"), makeSymbol("TRUE"), makeKeyword("COST"), makeSymbol("S#22567", "CYC"), makeKeyword("REFORMULATE"), makeSymbol("S#22568", "CYC"), makeKeyword("DOCUMENTATION"), makeString("The fallback mechanism for the reformulator.\n    Unifies the input expression with applicable reformulator rules."), makeKeyword("EXAMPLE-SOURCE"), makeString("(#$implies (#$isa ?X #$Dog) (#$isa ?X #$Animal))"), makeKeyword("EXAMPLE-TARGET"), makeString("(#$genls #$Dog #$Animal)") });
        $ic2$ = makeKeyword("KB");
        $ic3$ = makeSymbol("S#22571", "CYC");
        $ic4$ = makeKeyword("TRUE");
        $ic5$ = makeKeyword("NO-SEARCH");
        $ic6$ = makeInteger(64);
        $ic7$ = makeKeyword("&MEMOIZED-ITEM-NOT-FOUND&");
        $ic8$ = constant_handles_oc.f8479((SubLObject)makeString("notAssertible"));
        $ic9$ = makeSymbol("S#12278", "CYC");
        $ic10$ = constant_handles_oc.f8479((SubLObject)makeString("ReformulationBackwardDirection"));
        $ic11$ = constant_handles_oc.f8479((SubLObject)makeString("expansion"));
        $ic12$ = constant_handles_oc.f8479((SubLObject)makeString("expansionAxiom"));
        $ic13$ = makeSymbol("CAR");
        $ic14$ = makeSymbol("CDR");
        $ic15$ = constant_handles_oc.f8479((SubLObject)makeString("ReformulationNeitherDirection"));
        $ic16$ = makeSymbol("S#22595", "CYC");
        $ic17$ = makeKeyword("FALSE");
        $ic18$ = makeSymbol("S#12276", "CYC");
        $ic19$ = makeKeyword("NONE");
        $ic20$ = ConsesLow.list((SubLObject)makeKeyword("KB"), (SubLObject)makeKeyword("ARITY"), (SubLObject)makeKeyword("ALL"));
        $ic21$ = makeKeyword("ARITY");
        $ic22$ = ConsesLow.list((SubLObject)makeKeyword("ARITY"), (SubLObject)makeKeyword("ALL"));
        $ic23$ = makeKeyword("ALL");
        $ic24$ = makeSymbol("S#22563", "CYC");
        $ic25$ = makeSymbol("SECOND");
        $ic26$ = makeKeyword("REMOVAL-ONLY-ASK");
        $ic27$ = ConsesLow.list((SubLObject)makeKeyword("ANSWER-LANGUAGE"), (SubLObject)makeKeyword("HL"), (SubLObject)makeKeyword("MAX-NUMBER"), (SubLObject)ONE_INTEGER);
        $ic28$ = makeSymbol("S#22613", "CYC");
        $ic29$ = makeKeyword("MAX-TIME");
        $ic30$ = makeInteger(256);
        $ic31$ = makeSymbol("S#16704", "CYC");
    }
