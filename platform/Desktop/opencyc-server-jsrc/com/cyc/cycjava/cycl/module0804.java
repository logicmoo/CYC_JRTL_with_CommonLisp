...
public final class module0804 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic0$ = makeSymbol("GET-PASSAGES-FOR-ENTITY");
        $ic1$ = makeSymbol("RETURN-DOCUMENT-AS-STRING");
        $ic2$ = makeString("");
        $ic3$ = makeSymbol("TOPICS-RELATED-TO-ENTITY");
        $ic4$ = makeSymbol("ANSWER-GUI-QUESTION");
        $ic5$ = makeSymbol("IDENTIFY-ALL-GEQ-ENTITIES");
        $ic6$ = makeSymbol("GET-FOLLOWUPS-FOR-ENTITY");
    }
}
