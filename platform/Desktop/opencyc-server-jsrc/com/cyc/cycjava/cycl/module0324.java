...
public final class module0324 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic0$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("weak-HL-TimePrecedence")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("strict-HL-TimePrecedence")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("successorStrict-HL-TimePrecedence")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("weakSuccessor-HL-TimePrecedence")));
        ...
        $ic49$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeTimeInIntervalFn"));
        $ic50$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalInclusiveFn"));
        $ic51$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalBetweenFn"));
        $ic52$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("StartFn"));
        $ic53$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EndFn"));
        $ic54$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalStartedByFn"));
        $ic55$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalStartedByFn-Inclusive"));
        $ic56$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn"));
        $ic57$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn-Inclusive"));
        $ic58$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalInclusiveFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("StartFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EndFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalStartedByFn-Inclusive")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn-Inclusive")));
        $ic59$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalInclusiveFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("StartFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EndFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalStartedByFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalStartedByFn-Inclusive")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn-Inclusive")));
        $ic60$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SecondFn"));
        $ic61$ = SubLObjectFactory.makeInteger(59);
        $ic62$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MinuteFn"));
        $ic63$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HourFn"));
        $ic64$ = SubLObjectFactory.makeInteger(23);
        $ic65$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DayFn"));
        $ic66$ = SubLObjectFactory.makeInteger(31);
        $ic67$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MonthFn"));
        $ic68$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearFn"));
        $ic69$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("QuarterFn"));
        $ic70$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DecadeFn"));
        $ic71$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CenturyFn"));
        $ic72$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("weak-HL-TimePrecedence"));
