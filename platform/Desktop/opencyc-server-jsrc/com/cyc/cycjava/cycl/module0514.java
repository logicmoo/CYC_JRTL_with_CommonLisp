...
public final class module0514 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic0$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?UNIT"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UnitOfMeasure"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("operatorFormulas")), (SubLObject)SubLObjectFactory.makeSymbol("?UNIT"), (SubLObject)SubLObjectFactory.makeSymbol("?NAT")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argN")), (SubLObject)SubLObjectFactory.makeSymbol("?MIN-VALUE"), (SubLObject)module0514.ONE_INTEGER, (SubLObject)SubLObjectFactory.makeSymbol("?NAT")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argN")), (SubLObject)SubLObjectFactory.makeSymbol("?MAX-VALUE"), (SubLObject)module0514.TWO_INTEGER, (SubLObject)SubLObjectFactory.makeSymbol("?NAT"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("intervalRange")), (SubLObject)SubLObjectFactory.makeSymbol("?NAT"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?UNIT"), (SubLObject)SubLObjectFactory.makeSymbol("?MIN-VALUE")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?UNIT"), (SubLObject)SubLObjectFactory.makeSymbol("?MAX-VALUE"))));
        $ic1$ = SubLObjectFactory.makeKeyword("CODE");
        $ic2$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt"));
        $ic3$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?NAT")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?UNIT"), (SubLObject)SubLObjectFactory.makeSymbol("?MIN-VALUE"), (SubLObject)SubLObjectFactory.makeSymbol("?MAX-VALUE")), (SubLObject)module0514.NIL), (SubLObject)ConsesLow.list((SubLObject)module0514.NIL, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?UNIT"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UnitOfMeasure"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("operatorFormulas")), (SubLObject)SubLObjectFactory.makeSymbol("?UNIT"), (SubLObject)SubLObjectFactory.makeSymbol("?NAT")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argN")), (SubLObject)SubLObjectFactory.makeSymbol("?MIN-VALUE"), (SubLObject)module0514.ONE_INTEGER, (SubLObject)SubLObjectFactory.makeSymbol("?NAT")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argN")), (SubLObject)SubLObjectFactory.makeSymbol("?MAX-VALUE"), (SubLObject)module0514.TWO_INTEGER, (SubLObject)SubLObjectFactory.makeSymbol("?NAT")))));
        ...
        $ic11$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("intervalRange")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#35960", "CYC")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        $ic12$ = SubLObjectFactory.makeSymbol("S#35960", "CYC");
        $ic13$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("intervalRange"));
