...
public final class module0777 extends SubLTranslatedFile
{
    ...
    public static SubLObject f50117(final SubLObject var177, SubLObject var189) {
        ...
        assert module0777.NIL != assertion_handles_oc.f11035(var177) : var177;
    ...
    static {
        ...
        $ic26$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("VAR", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("&OPTIONAL"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#295", "CYC"), (SubLObject)SubLObjectFactory.makeString("Finding unlexified terms...")), (SubLObject)SubLObjectFactory.makeSymbol("S#54687", "CYC")), (SubLObject)SubLObjectFactory.makeSymbol("&BODY"), (SubLObject)SubLObjectFactory.makeSymbol("S#5", "CYC"));
        ...
        $ic35$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EverythingPSC"));
        $ic36$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("termDoesntNeedLexification"));
        $ic37$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("instancesDontNeedLexification"));
        $ic38$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("quotedInstancesDontNeedLexification"));
        $ic39$ = SubLObjectFactory.makeSymbol("STRINGP");
        $ic40$ = SubLObjectFactory.makeKeyword("SKIP");
        $ic41$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("termStrings"));
        $ic42$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and"));
        $ic43$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("conceptuallyRelated"));
        $ic44$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?MT"));
        $ic45$ = ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlMt")), (SubLObject)SubLObjectFactory.makeSymbol("?MT"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("GeneralLexiconMt"))));
        ...
        $ic47$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TemporaryLexicalAssertionsMt"));
        $ic48$ = SubLObjectFactory.makeString("char=~a next=~a next-next=~a run-len=~a new-index=~a~%");
        $ic49$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("singular")));
        ...
        $ic56$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("multiWordString"));
        $ic57$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Know-TheWord"));
        $ic58$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MassNoun"));
        ...
        $ic68$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CycLReifiableDenotationalTerm"));
        $ic69$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EnglishLexiconMt"));
        $ic70$ = SubLObjectFactory.makeSymbol("KEYWORD-FOR-POS");
        $ic71$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ProperNoun"));
        $ic72$ = SubLObjectFactory.makeKeyword("PROPER-NOUN");
        $ic73$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Determiner"));
        $ic74$ = SubLObjectFactory.makeKeyword("DET");
        $ic75$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Pronoun"));
        $ic76$ = SubLObjectFactory.makeKeyword("PRONOUN");
        $ic77$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Noun"));
        $ic78$ = SubLObjectFactory.makeKeyword("NOUN");
        $ic79$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Verb"));
        $ic80$ = SubLObjectFactory.makeKeyword("VERB");
        $ic81$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Adjective"));
        $ic82$ = SubLObjectFactory.makeKeyword("ADJECTIVE");
        $ic83$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Adverb"));
        $ic84$ = SubLObjectFactory.makeKeyword("ADVERB");
        $ic85$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Preposition"));
        $ic86$ = SubLObjectFactory.makeKeyword("PREP");
        $ic87$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Conjunction"));
        ...
        $ic95$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CountNoun"));
        $ic96$ = SubLObjectFactory.makeKeyword("SIMPLE-NOUN");
        $ic97$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AgentiveNoun"));
        $ic98$ = SubLObjectFactory.makeKeyword("AGENTIVE-NOUN");
        $ic99$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("GerundiveNoun"));
        $ic100$ = SubLObjectFactory.makeKeyword("GERUNDIVE-NOUN");
        $ic101$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DeVerbalNoun"));
        $ic102$ = SubLObjectFactory.makeKeyword("DEVERBAL-NOUN");
        $ic103$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AuxVerb"));
        ...
        $ic111$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Individual"));
        $ic112$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ProperNoun")));
        ...
        $ic125$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AllLexicalMicrotheoryPSC"));
        $ic126$ = SubLObjectFactory.makeSymbol("S#54613", "CYC");
        $ic127$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2Isa"));
        $ic128$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?CONSTRAINT"));
        $ic129$ = ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genls")), (SubLObject)SubLObjectFactory.makeSymbol("?CONSTRAINT"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Abbreviation"))));
        $ic130$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InferencePSC"));
        ...
        $ic134$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("properNameStrings"));
        ...
        $ic138$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("examples-Positive"));
        $ic139$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("exampleSentence")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("examplePredSentence")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("exampleAssertions")));
        $ic140$ = SubLObjectFactory.makeKeyword("GAF");
        $ic141$ = SubLObjectFactory.makeKeyword("DEFAULT");
        $ic142$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("toBeReviewedBy"));
        $ic143$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist"));
        $ic144$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BookkeepingMt"));
        $ic145$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DeadTerm"));
        $ic146$ = SubLObjectFactory.makeString("DeadTerm");
        $ic147$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("preferredTermStrings"));
        ...
        $ic151$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nameableCollection"));
        $ic152$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("comment"));
        ...
        $ic160$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HeadInitialMultiWordPhrasePred"));
        ...
        $ic178$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HeadFinalMultiWordPhrasePred"));
        $ic179$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("ANY"), (SubLObject)SubLObjectFactory.makeKeyword("MEDIAL"));
        $ic180$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HeadMedialMultiWordPhrasePred"));
        ...
        $ic187$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("definiteDescriptions"));
        ...
        $ic190$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TerrorismLexicalMt"));
        ...
        $ic195$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TestQueryFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLGIT-LexifyTerroristAttack")));
    }
}
