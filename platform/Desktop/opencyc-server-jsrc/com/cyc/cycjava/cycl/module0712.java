...
public final class module0712 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic10$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("prettyString"));
        ...
        $ic13$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nameString"));
        ...
        $ic44$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("termTypeForOntology"));
        $ic45$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("contextOfPCW"));
        $ic46$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("synonymousExternalConcept"));
        $ic47$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("overlappingExternalConcept"));
        ...
        $ic51$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ExistingObjectType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ExistingStuffType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TemporalObjectType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TemporalStuffType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ObjectType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("StuffType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Collection")));
        ...
        $ic55$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BinaryPredicateTypeByLogicalFeature"));
        $ic56$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CoexistingObjectsPredicate")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BinaryRolePredicate")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ComplexTemporalPredicate")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BinaryPredicate")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Predicate")));
        ...
        $ic63$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlPreds")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg1Isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2Isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg1SometimesIsa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2SometimesIsa")));
        $ic64$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa"));
        $ic65$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genls"));
        ...
        $ic102$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlPreds"));
        ...
        $ic106$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genls")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("geographicalSubRegions")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("geopoliticalSubdivision")));
        ...
        $ic140$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("OWLURIFn"));
        $ic141$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("OWLDatatypeFn"));
