...
public final class module0224 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic0$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Thing"));
        ...
        $ic8$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genls"));
        $ic9$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa"));
        $ic10$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equals"));
        ...
        $ic16$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("quotedIsa"));
        $ic17$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllInstance"));
        $ic18$ = SubLObjectFactory.makeKeyword("QUERY-ISA");
        $ic19$ = SubLObjectFactory.makeKeyword("TRUE");
        $ic20$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceAll"));
        $ic21$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExists"));
        $ic22$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsAll"));
        ...
        $ic25$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("transitiveViaArgInverse"));
        ...
        $ic40$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equals")));
