...
public final class module0787 extends SubLTranslatedFile
{
    ...
    public static SubLObject f50466(final SubLObject var1) {
        return module0087.f5956(var1, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f50467() {
        return module0087.f5954(Symbols.symbol_function((SubLObject)EQUALP));
    }
    ...
    public static SubLObject f50470(final SubLObject var2) {
        if (var2.eql((SubLObject)$ic4$)) {
            return $g6302$.getGlobalValue();
        }
        if (var2.eql((SubLObject)$ic5$)) {
            return $g6303$.getGlobalValue();
        }
    ...
    public static SubLObject f50471(final SubLObject var2) {
        if (var2.eql((SubLObject)$ic4$)) {
            return $g6304$.getGlobalValue();
        }
        if (var2.eql((SubLObject)$ic5$)) {
            return $g6305$.getGlobalValue();
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f50472(final SubLObject var4, final SubLObject var5) {
        ...
        if (NIL == module0038.f2608(var5) && NIL == Sequences.find((SubLObject)Characters.CHAR_vertical, var5, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
            SubLObject var8;
    ...
    public static SubLObject f50480(final SubLObject var2) {
        ...
        if (var2.eql((SubLObject)$ic4$)) {
            ...
            try {
                ...
                final SubLObject var9 = module0259.f16848($ic6$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                ...
                try {
                    ...
                    module0012.f478((SubLObject)$ic7$);
                    SubLObject var13 = var9;
                    SubLObject var14 = (SubLObject)NIL;
                    var14 = var13.first();
                    while (NIL != var13) {
                        if (NIL == module0259.f16854(var14, $ic8$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                            SubLObject var15 = $ic9$;
                            if (NIL != module0158.f10010(var14, (SubLObject)NIL, var15)) {
                                final SubLObject var16 = module0158.f10011(var14, (SubLObject)NIL, var15);
                                ...
                                while (NIL == var17) {
                                    ...
                                    if (NIL != var20) {
                                        ...
                                        try {
                                            var21 = module0158.f10316(var19, (SubLObject)$ic10$, (SubLObject)$ic11$, (SubLObject)NIL);
                                            ...
                                            while (NIL == var30_35) {
                                                ...
                                                final SubLObject var33_38 = (SubLObject)makeBoolean(!var31_36.eql(var22));
                                                if (NIL != var33_38) {
                            ...
                            if (NIL != $g6306$.getDynamicValue(var3)) {
                                var15 = $ic12$;
                                if (NIL != module0158.f10010(var14, (SubLObject)NIL, var15)) {
                                    final SubLObject var16 = module0158.f10011(var14, (SubLObject)NIL, var15);
                                    SubLObject var17 = (SubLObject)NIL;
                                        ...
                                        if (NIL != var20) {
                                            ...
                                            try {
                                                ...
                                                while (NIL == var30_36) {
                                                    ...
                                                    final SubLObject var33_39 = (SubLObject)makeBoolean(!var31_37.eql(var22));
                                                    if (NIL != var33_39) {
                                                        final SubLObject var23 = module0786.f50434(var14);
                                                        final SubLObject var24 = module0209.f13552(module0178.f11335(var22));
                                                        var4 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list(var24, var23), var4);
                ...
                if (NIL != module0158.f10038(var25)) {
                    ...
                    try {
                        ...
                        while (NIL == var17) {
                            ...
                            final SubLObject var20 = (SubLObject)makeBoolean(!var18.eql(var32));
                            if (NIL != var20) {
                                module0012.f476();
                                SubLObject var21 = (SubLObject)NIL;
                                try {
                                    var21 = module0158.f10316(var32, (SubLObject)$ic10$, (SubLObject)NIL, (SubLObject)NIL);
                                    ...
                                    while (NIL == var30_37) {
                                        ...
                                        final SubLObject var33_40 = (SubLObject)makeBoolean(!var31_38.eql(var33));
                                        if (NIL != var33_40) {
    ...
    public static SubLObject f50481(final SubLObject var2) {
        ...
        if (var2.eql((SubLObject)$ic4$)) {
            ...
            try {
                ...
                module0147.$g2094$.bind(module0147.f9546(var5), var3);
                module0147.$g2096$.bind(module0147.f9549(var5), var3);
                final SubLObject var9 = module0259.f16848($ic14$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                final SubLObject var10 = Sequences.length(var9);
                SubLObject var11 = (SubLObject)ZERO_INTEGER;
                ...
                try {
                    ...
                    module0012.$g77$.bind((SubLObject)T, var3);
                    module0012.$g78$.bind(Time.get_universal_time(), var3);
                    module0012.f478((SubLObject)$ic15$);
                    SubLObject var13 = var9;
                    SubLObject var14 = (SubLObject)NIL;
                    var14 = var13.first();
                    while (NIL != var13) {
                        if (NIL == module0259.f16854(var14, $ic8$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                            final SubLObject var15 = $ic16$;
                            if (NIL != module0158.f10010(var14, (SubLObject)NIL, var15)) {
                                final SubLObject var16 = module0158.f10011(var14, (SubLObject)NIL, var15);
                                SubLObject var17 = (SubLObject)NIL;
                                final SubLObject var18 = (SubLObject)NIL;
                                while (NIL == var17) {
                                    ...
                                    if (NIL != var20) {
                                        ...
                                        try {
                                            var21 = module0158.f10316(var19, (SubLObject)$ic10$, (SubLObject)$ic11$, (SubLObject)NIL);
                                            SubLObject var30_66 = (SubLObject)NIL;
                                            final SubLObject var31_67 = (SubLObject)NIL;
                                            while (NIL == var30_66) {
                                                final SubLObject var22 = module0052.f3695(var21, var31_67);
                                                final SubLObject var33_68 = (SubLObject)makeBoolean(!var31_67.eql(var22));
                                                if (NIL != var33_68) {
                                                    final SubLObject var23 = module0786.f50434(var14);
                                                    final SubLObject var24 = module0209.f13552(module0178.f11335(var22));
                                                    var4 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list(var24, var23), var4);
                                                }
                                                var30_66 = (SubLObject)makeBoolean(NIL == var33_68);
                                            }
                                        }
                                        finally {
    ...
    public static SubLObject f50475(final SubLObject var2) {
        ...
        while (NIL != var3) {
            ...
            if (NIL == var6) {
                ...
                cdestructuring_bind.cdestructuring_bind_error(var5, (SubLObject)$ic17$);
            }
            var3 = var3.rest();
            var4 = var3.first();
        }
    ...
    public static SubLObject f50477(final SubLObject var2) {
        ...
        while (NIL != var3) {
            ...
            if (NIL == var6) {
                ...
                cdestructuring_bind.cdestructuring_bind_error(var5, (SubLObject)$ic18$);
            }
            var3 = var3.rest();
            var4 = var3.first();
        }
    ...
    public static SubLObject f50485() {
        $g6302$ = SubLFiles.deflexical("S#55035", (NIL != Symbols.boundp((SubLObject)$ic0$)) ? $g6302$.getGlobalValue() : f50467());
        $g6303$ = SubLFiles.deflexical("S#55036", (NIL != Symbols.boundp((SubLObject)$ic1$)) ? $g6303$.getGlobalValue() : f50467());
        $g6304$ = SubLFiles.deflexical("S#55037", (NIL != Symbols.boundp((SubLObject)$ic2$)) ? $g6304$.getGlobalValue() : f50469());
        $g6305$ = SubLFiles.deflexical("S#55038", (NIL != Symbols.boundp((SubLObject)$ic3$)) ? $g6305$.getGlobalValue() : f50469());
        $g6306$ = SubLFiles.defparameter("S#55039", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g6305$ = null;
        $g6306$ = null;
        $ic0$ = makeSymbol("S#55035", "CYC");
        $ic1$ = makeSymbol("S#55036", "CYC");
        $ic2$ = makeSymbol("S#55037", "CYC");
        $ic3$ = makeSymbol("S#55038", "CYC");
        $ic4$ = makeKeyword("DERIV");
        $ic5$ = makeKeyword("INFL");
        $ic6$ = constant_handles_oc.f8479((SubLObject)makeString("DerivationalSuffix"));
        $ic7$ = makeString("Finding derivational suffix strings...");
        $ic8$ = constant_handles_oc.f8479((SubLObject)makeString("UnproductiveLexicalAffix"));
        $ic9$ = constant_handles_oc.f8479((SubLObject)makeString("suffixString"));
        $ic10$ = makeKeyword("GAF");
        $ic11$ = makeKeyword("TRUE");
        $ic12$ = constant_handles_oc.f8479((SubLObject)makeString("phoneticVariantOfSuffix"));
        $ic13$ = constant_handles_oc.f8479((SubLObject)makeString("regularSuffix"));
        $ic14$ = constant_handles_oc.f8479((SubLObject)makeString("DerivationalPrefix"));
        $ic15$ = makeString("Finding derivational prefix strings...");
        $ic16$ = constant_handles_oc.f8479((SubLObject)makeString("prefixString"));
        $ic17$ = ConsesLow.list((SubLObject)makeSymbol("S#39569", "CYC"), (SubLObject)makeSymbol("S#132", "CYC"));
        $ic18$ = ConsesLow.list((SubLObject)makeSymbol("S#10299", "CYC"), (SubLObject)makeSymbol("S#132", "CYC"));
    }
}
