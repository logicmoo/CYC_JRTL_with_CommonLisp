...
public final class module0651 extends SubLTranslatedFile
{
    ...
    public static SubLObject f39716(final SubLObject var62, final SubLObject var67, final SubLObject var68) {
        ...
        for (var71 = module0066.f4838(module0067.f4891(var67)); module0651.NIL == module0066.f4841(var71); var71 = module0066.f4840(var71)) {
            ...
            var69.resetMultipleValues();
            if (module0651.NIL != assertion_handles_oc.f11035(var72)) {
    ...
    static {
        ...
        $ic2$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("firstSubEvents")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("properSubEvents")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("lastSubEvents")));
        $ic3$ = ConsesLow.list(new SubLObject[] { constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("perpetrator")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("hostages")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("dateOfEvent")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("losesControl")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("objectOfControlTransfer")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("agreeingAgents")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ransomDemanded")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("senderOfInfo")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("agreementCreated")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("crimeVictim")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("eventOccursAt")) });
        $ic4$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equivRolePlayers")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equivRolePlayersOfType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equivalentRolePlayers-SitTypeToSubSitType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equivalentRolePlayers-SitTypeToSubSitType-Unique")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equivalentRolePlayers-SubSitTypeToSubSitType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equivalentRolePlayers-SubSitTypeToSubSitType-Unique")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equivalentRolePlayersOfType-SubSitTypeToSubSitType")));
        ...
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SituationType"));
        $ic15$ = SubLObjectFactory.makeString("Argument not a situation type");
        $ic16$ = SubLObjectFactory.makeKeyword("SUB-EVT-TYPE");
        $ic17$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("properSubSituationTypes"));
        ...
        $ic22$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equivalentRolePlayers-SubSitTypeToSubSitType"));
        ...
        $ic24$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equivalentRolePlayers-SitTypeToSubSitType"));
        ...
        $ic41$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheSet"));
        $ic42$ = SubLObjectFactory.makeKeyword("EVT");
        $ic43$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("properSubEvents"));
        ...
        $ic46$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("assertedSentence"));
        $ic47$ = SubLObjectFactory.makeSymbol("?PRED");
        $ic48$ = SubLObjectFactory.makeSymbol("?SUB-EVENT");
        $ic49$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("elementOf"));
        ...
        $ic55$ = ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("join-left")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist-Asserted")), (SubLObject)SubLObjectFactory.makeSymbol("?SUB-MT"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("properSubEvents")), (SubLObject)SubLObjectFactory.makeSymbol("?SUB"), (SubLObject)SubLObjectFactory.makeSymbol("?SUB1"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist-Asserted")), (SubLObject)SubLObjectFactory.makeSymbol("?SUB2-MT"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("properSubEvents")), (SubLObject)SubLObjectFactory.makeSymbol("?SUB1"), (SubLObject)SubLObjectFactory.makeSymbol("?SUB2")))));
