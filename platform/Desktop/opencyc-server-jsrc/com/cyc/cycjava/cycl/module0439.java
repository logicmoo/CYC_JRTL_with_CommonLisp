...
public final class module0439 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic20$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("commutativeInArgs"));
        $ic21$ = SubLObjectFactory.makeKeyword("GAF");
        $ic22$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("commutativeInArgsAndRest"));
