...
public final class module0450 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic5$ = ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeKeyword("NOT-FULLY-BOUND"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("TEST"), (SubLObject)SubLObjectFactory.makeSymbol("S#12600", "CYC")));
        $ic6$ = SubLObjectFactory.makeSymbol("VARIABLE-P");
        $ic7$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SubcollectionOfWithRelationToFn"));
        $ic8$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SubcollectionOfWithRelationFromFn"));
        $ic9$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("AbducedTermFn"));
        $ic10$ = SubLObjectFactory.makeSymbol("S#34311", "CYC");
        $ic11$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Individual"));
