...
public final class module0132 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic0$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("VAR", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#9672", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("&OPTIONAL"), (SubLObject)SubLObjectFactory.makeSymbol("S#291", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("COMMENT"));
        ...
        $ic7$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BaseKB"));
        ...
        $ic13$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt"));
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Microtheory"));
        $ic15$ = SubLObjectFactory.makeSymbol("S#10734", "CYC");
        $ic16$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("definingMt"));
        $ic17$ = SubLObjectFactory.makeSymbol("S#10735", "CYC");
        $ic18$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("decontextualizedPredicate"));
        $ic19$ = SubLObjectFactory.makeSymbol("S#10736", "CYC");
        $ic20$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("decontextualizedCollection"));
        $ic21$ = SubLObjectFactory.makeSymbol("S#10737", "CYC");
        $ic22$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ephemeralTerm"));
        $ic23$ = SubLObjectFactory.makeSymbol("S#10738", "CYC");
        $ic24$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist"));
        $ic25$ = SubLObjectFactory.makeSymbol("S#10739", "CYC");
        $ic26$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InferenceRelatedBookkeepingPredicate"));
        $ic27$ = SubLObjectFactory.makeSymbol("*ANECT-MT*");
        $ic28$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AtemporalNecessarilyEssentialCollectionType"));
        $ic29$ = SubLObjectFactory.makeSymbol("S#10740", "CYC");
        $ic30$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BroadMicrotheory"));
        $ic31$ = SubLObjectFactory.makeSymbol("S#10741", "CYC");
        $ic32$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ProblemSolvingCntxt"));
        $ic33$ = SubLObjectFactory.makeSymbol("S#10742", "CYC");
        $ic34$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("termOfUnit"));
        $ic35$ = SubLObjectFactory.makeSymbol("S#10743", "CYC");
        $ic36$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("skolem"));
        $ic37$ = SubLObjectFactory.makeSymbol("S#10744", "CYC");
        $ic38$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Thing"));
        $ic39$ = SubLObjectFactory.makeSymbol("S#10745", "CYC");
        $ic40$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Relation"));
        $ic41$ = SubLObjectFactory.makeSymbol("S#10746", "CYC");
        $ic42$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equals"));
        $ic43$ = SubLObjectFactory.makeSymbol("S#10747", "CYC");
        $ic44$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("elementOf"));
        $ic45$ = SubLObjectFactory.makeSymbol("S#10748", "CYC");
        $ic46$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("subsetOf"));
        $ic47$ = SubLObjectFactory.makeSymbol("S#10749", "CYC");
        $ic48$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arity"));
        $ic49$ = SubLObjectFactory.makeSymbol("S#10750", "CYC");
        $ic50$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CycAPIMt"));
        $ic51$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("subLIdentifier"));
        $ic52$ = SubLObjectFactory.makeSymbol("S#10751", "CYC");
        $ic53$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("notAssertibleMt"));
        ...
        $ic60$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("LogicalTruthMt")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("LogicalTruthImplementationMt")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CoreCycLMt")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CoreCycLImplementationMt")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyImplementationMt")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BaseKB")));
        $ic61$ = ConsesLow.list((SubLObject)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("LogicalTruthMt")), (SubLObject)module0132.ZERO_INTEGER), (SubLObject)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("LogicalTruthImplementationMt")), (SubLObject)module0132.ZERO_INTEGER), (SubLObject)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CoreCycLMt")), (SubLObject)module0132.ONE_INTEGER), (SubLObject)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CoreCycLImplementationMt")), (SubLObject)module0132.ONE_INTEGER), (SubLObject)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), (SubLObject)module0132.TWO_INTEGER), (SubLObject)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyImplementationMt")), (SubLObject)module0132.TWO_INTEGER), (SubLObject)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BaseKB")), (SubLObject)module0132.THREE_INTEGER));
        $ic62$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BaseKB")));
