...
public final class module0386 extends SubLTranslatedFile
{
    ...
    public static SubLObject f27416(final SubLObject var3) {
        ...
        if (module0363.$g3132$.getDynamicValue(var4) == $ic1$) {
            return f27417(var3);
        }
        return f27418(var3);
    }
    ...
    public static SubLObject f27419(final SubLObject var5, final SubLObject var2) {
        ...
        if (NIL != module0381.f27067(var5)) {
            return f27420(var5, var7);
        }
        if (NIL != module0380.f26969(var5)) {
            return f27421(var5, var7);
        }
        if (NIL != module0383.f27235(var5)) {
            return f27422(var5, var7);
        }
        return Errors.error((SubLObject)$ic2$, var5);
    }
    
    public static SubLObject f27423(final SubLObject var6) {
        final SubLObject var7 = module0361.f24123(module0364.f24722(var6));
        if (NIL == module0065.f4772(var7, (SubLObject)$ic3$)) {
            final SubLObject var8_9 = var7;
            if (NIL == module0065.f4775(var8_9, (SubLObject)$ic3$)) {
                ...
                for (var10 = Sequences.length(var8), var11 = (SubLObject)NIL, var11 = (SubLObject)ZERO_INTEGER; var11.numL(var10); var11 = Numbers.add(var11, (SubLObject)ONE_INTEGER)) {
                    ...
                    if (NIL == module0065.f4749(var13) || NIL == module0065.f4773((SubLObject)$ic3$)) {
                        if (NIL != module0065.f4749(var13)) {
                            var13 = (SubLObject)$ic3$;
                        }
                        f27424(var6, var13);
                    }
                }
    ...
    public static SubLObject f27425(final SubLObject var1, final SubLObject var20, final SubLObject var2) {
        ...
        if (NIL != var21) {
            ...
            if (NIL == module0065.f4772(var23, (SubLObject)$ic3$)) {
                final SubLObject var8_24 = var23;
                if (NIL == module0065.f4775(var8_24, (SubLObject)$ic3$)) {
                    ...
                    for (var26 = Sequences.length(var24), var27 = (SubLObject)NIL, var27 = (SubLObject)ZERO_INTEGER; var27.numL(var26); var27 = Numbers.add(var27, (SubLObject)ONE_INTEGER)) {
                        ...
                        if (NIL == module0065.f4749(var25_26) || NIL == module0065.f4773((SubLObject)$ic3$)) {
                            if (NIL != module0065.f4749(var25_26)) {
                                var25_26 = (SubLObject)$ic3$;
                            }
                            if (NIL != module0363.f24547(var1, var25_26)) {
                                var29 = var25_26;
                                ...
                                for (var31 = module0032.f1741(var30), var32 = (SubLObject)NIL, var32 = module0032.f1742(var31, var30); NIL == module0032.f1744(var31, var32); var32 = module0032.f1743(var32)) {
                                    ...
                                    if (NIL != module0032.f1746(var32, var33) && NIL != module0398.f28152(var33)) {
                ...
                if (NIL == module0065.f4777(var15_32)) {
                    final SubLObject var34 = module0065.f4738(var15_32);
                    SubLObject var35 = (SubLObject)NIL;
                    SubLObject var25_27 = (SubLObject)NIL;
                    ...
                    try {
                        while (Hashtables.iteratorHasNext(var36)) {
                            ...
                            if (NIL != module0363.f24547(var1, var25_27)) {
                                final SubLObject var38 = var25_27;
                                final SubLObject var39 = module0077.f5333(inference_datastructures_inference_oc.f25473(var38));
                                SubLObject var40;
                                SubLObject var41;
                                SubLObject var42;
                                for (var40 = module0032.f1741(var39), var41 = (SubLObject)NIL, var41 = module0032.f1742(var40, var39); NIL == module0032.f1744(var40, var41); var41 = module0032.f1743(var41)) {
                                    ...
                                    if (NIL != module0032.f1746(var41, var42) && NIL != module0398.f28152(var42)) {
            ...
            for (var44 = module0032.f1741(var43), var45 = (SubLObject)NIL, var45 = module0032.f1742(var44, var43); NIL == module0032.f1744(var44, var45); var45 = module0032.f1743(var45)) {
                ...
                if (NIL != module0032.f1746(var45, var46)) {
                    f27423(var46);
                }
            }
        }
    ...
    public static SubLObject f27424(final SubLObject var6, final SubLObject var2) {
        ...
        if ($ic0$ != var8) {
            if (NIL != module0377.f26746(var6)) {
                return f27426(var8, var6, var2);
            }
            if (NIL != module0381.f27029(var6)) {
                return f27427(var8, var6, var2);
            }
            if (NIL != module0378.f26860(var6)) {
                return f27428(var8, var6, var2);
            }
            if (NIL != module0380.f26955(var6)) {
                return f27429(var8, var6, var2);
            }
            if (NIL != module0375.f26571(var6)) {
                return f27430(var8, var6, var2);
            }
            if (NIL != module0383.f27227(var6)) {
    ...
    public static SubLObject f27426(final SubLObject var35, final SubLObject var36, final SubLObject var2) {
        ...
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var37) && NIL == f27432(var35)) {
            Errors.error((SubLObject)$ic4$, var35);
        }
        if (NIL != module0364.f24749(var36)) {
    ...
    public static SubLObject f27434(final SubLObject var35, final SubLObject var41) {
        ...
        if (NIL != var45) {
            ...
            if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var42) && NIL != module0035.f2434((SubLObject)$ic5$, var50)) {
                Errors.error((SubLObject)$ic6$, var50);
            }
            return f27437(var50);
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f27427(final SubLObject var35, final SubLObject var44, final SubLObject var2) {
        ...
        if (NIL != var46) {
            ...
            if (NIL != module0381.f27046(var44)) {
    ...
    public static SubLObject f27429(final SubLObject var35, final SubLObject var53, final SubLObject var2) {
        ...
        var56 = var55.first();
        while (NIL != var55) {
            if (NIL != module0339.f22743((SubLObject)NIL, var53, var56)) {
    ...
    public static SubLObject f27440(final SubLObject var54, final SubLObject var57, final SubLObject var35) {
        ...
        SubLObject var60 = conses_high.copy_tree(f27433(module0363.f24509(var58), (SubLObject)$ic7$));
    ...
    public static SubLObject f27441(final SubLObject var54, final SubLObject var57) {
        ...
        return f27442(var59, var64, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f27443(final SubLObject var67, final SubLObject var35) {
        if (NIL != module0363.f24562(module0364.f24725(var67))) {
            return var35;
        }
        final SubLObject var68 = module0364.f24757(var67);
        final SubLObject var69 = f27444(var67);
        SubLObject var70 = conses_high.copy_tree(f27433(module0363.f24509(var68), (SubLObject)$ic7$));
    ...
    public static SubLObject f27445(SubLObject var70, final SubLObject var75) {
        ...
        if (NIL != module0004.f104((SubLObject)NIL, var76.first(), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0004.f104((SubLObject)NIL, conses_high.second(var76), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f27446(final SubLObject var77, final SubLObject var78) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var77, var77, (SubLObject)$ic8$);
        var79 = var77.first();
        SubLObject var81 = var77.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var81, var77, (SubLObject)$ic8$);
        var80 = var81.first();
        var81 = var81.rest();
        if (NIL == var81) {
            SubLObject var82 = (SubLObject)NIL;
            SubLObject var83 = (SubLObject)NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var78, var78, (SubLObject)$ic9$);
            var82 = var78.first();
            SubLObject var85_86 = var78.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var85_86, var78, (SubLObject)$ic9$);
            ...
            if (NIL == var85_86) {
                ...
                var87 = var86.first();
                while (NIL != var86) {
                    final SubLObject var88 = Sequences.position(var87, var82, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                ...
                var89 = var86.first();
                while (NIL != var86) {
                    final SubLObject var88 = Sequences.position(var89, var83, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            ...
            cdestructuring_bind.cdestructuring_bind_error(var78, (SubLObject)$ic9$);
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var77, (SubLObject)$ic8$);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f27448(final SubLObject var100) {
        return (SubLObject)makeBoolean(NIL != f27432(var100) || NIL != f27449(var100) || NIL != f27447(var100));
    }
    ...
    public static SubLObject f27449(final SubLObject var100) {
        return (SubLObject)makeBoolean(var100.isCons() && NIL != module0035.f1995(var100, (SubLObject)TWO_INTEGER, (SubLObject)UNPROVIDED) && var100.first().isList() && NIL != module0035.f2370((SubLObject)$ic11$, var100.first(), (SubLObject)UNPROVIDED) && conses_high.second(var100).isList() && NIL != module0035.f2370((SubLObject)$ic11$, conses_high.second(var100), (SubLObject)UNPROVIDED));
    }
    
    public static SubLObject f27447(final SubLObject var100) {
        return (SubLObject)makeBoolean(var100.isCons() && NIL != module0035.f2000(var100, (SubLObject)TWO_INTEGER, (SubLObject)UNPROVIDED) && NIL != module0035.f2370((SubLObject)$ic12$, var100, (SubLObject)UNPROVIDED));
    }
    
    public static SubLObject f27450() {
        final SubLObject var101 = $g3231$.getGlobalValue();
        if (NIL != var101) {
    ...
    public static SubLObject f27451(final SubLObject var102) {
        return module0034.f1829($g3231$.getGlobalValue(), (SubLObject)ConsesLow.list(var102), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f27452(final SubLObject var102) {
        assert NIL != f27448(var102) : var102;
        return conses_high.copy_tree(var102);
    }
    
    public static SubLObject f27437(final SubLObject var102) {
        SubLObject var103 = $g3231$.getGlobalValue();
        if (NIL == var103) {
            var103 = module0034.f1934((SubLObject)$ic13$, (SubLObject)$ic15$, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)ONE_INTEGER, (SubLObject)ZERO_INTEGER);
        }
        SubLObject var104 = module0034.f1814(var103, var102, (SubLObject)$ic16$);
        if (var104 == $ic16$) {
            var104 = Values.arg2(Values.resetMultipleValues(), (SubLObject)Values.multiple_value_list(f27452(var102)));
            module0034.f1816(var103, var102, var104, (SubLObject)UNPROVIDED);
        }
    ...
    public static SubLObject f27433(final SubLObject var105, SubLObject var106) {
        if (var106 == UNPROVIDED) {
            var106 = (SubLObject)ZERO_INTEGER;
        }
        if (NIL != module0362.f24460(var105)) {
            return var106;
        }
        if (NIL != module0035.f1997(var105)) {
    ...
    public static SubLObject f27435(final SubLObject var109, final SubLObject var110) {
        assert NIL != f27449(var109) : var109;
        SubLObject var111 = (SubLObject)NIL;
        SubLObject var112 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var109, var109, (SubLObject)$ic17$);
        var111 = var109.first();
        SubLObject var113 = var109.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var113, var109, (SubLObject)$ic17$);
        var112 = var113.first();
        var113 = var113.rest();
        if (NIL == var113) {
            SubLObject var114 = (SubLObject)NIL;
            SubLObject var115 = (SubLObject)NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var110, var110, (SubLObject)$ic18$);
            var114 = var110.first();
            SubLObject var117_118 = var110.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var117_118, var110, (SubLObject)$ic18$);
            ...
            if (NIL == var117_118) {
                ...
                if (NIL == var116 && NIL != module0035.f1997(var117)) {
                    return var117.first();
                }
                if (NIL == var117 && NIL != module0035.f1997(var116)) {
                    return var116.first();
                }
                return f27437((SubLObject)ConsesLow.list(var116, var117));
            }
            else {
                cdestructuring_bind.cdestructuring_bind_error(var110, (SubLObject)$ic18$);
            }
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var109, (SubLObject)$ic17$);
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f27454() {
        final SubLObject var101 = $g3232$.getGlobalValue();
        if (NIL != var101) {
            module0034.f1818(var101);
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f27455(final SubLObject var102, final SubLObject var125) {
        return module0034.f1829($g3232$.getGlobalValue(), (SubLObject)ConsesLow.list(var102, var125), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f27456(final SubLObject var102, final SubLObject var125) {
        if (var125.eql((SubLObject)$ic20$)) {
            return f27417(var102);
        }
        if (var125.eql((SubLObject)$ic21$)) {
            return f27418(var102);
        }
        return Errors.error((SubLObject)$ic22$, var125);
    }
    
    public static SubLObject f27457(final SubLObject var102, final SubLObject var125) {
        SubLObject var126 = $g3232$.getGlobalValue();
        if (NIL == var126) {
            var126 = module0034.f1934((SubLObject)$ic19$, (SubLObject)$ic23$, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)TWO_INTEGER, (SubLObject)ZERO_INTEGER);
        }
        final SubLObject var127 = module0034.f1782(var102, var125);
        final SubLObject var128 = module0034.f1814(var126, var127, (SubLObject)UNPROVIDED);
        if (var128 != $ic16$) {
            ...
            while (NIL != var129) {
                ...
                if (var102.equal(var131.first())) {
                    var131 = var131.rest();
                    if (NIL != var131 && NIL == var131.rest() && var125.equal(var131.first())) {
    ...
    public static SubLObject f27458(final SubLObject var134, final SubLObject var135) {
        ...
        if (NIL != f27432(var134)) {
            return f27459(var134, var135);
        }
        if (NIL != f27449(var134)) {
    ...
    public static SubLObject f27442(final SubLObject var155, final SubLObject var156, SubLObject var157) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var155, var155, (SubLObject)$ic24$);
        var159 = var155.first();
        SubLObject var161 = var155.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var161, var155, (SubLObject)$ic24$);
        var160 = var161.first();
        var161 = var161.rest();
        if (NIL == var161) {
            SubLObject var162 = (SubLObject)NIL;
            SubLObject var163 = (SubLObject)NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var156, var156, (SubLObject)$ic25$);
            var162 = var156.first();
            SubLObject var164_165 = var156.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var164_165, var156, (SubLObject)$ic25$);
            ...
            if (NIL == var164_165) {
                ...
                var166 = var159;
                var167 = var166.first();
                for (var168 = (SubLObject)ZERO_INTEGER; NIL != var166; var166 = var166.rest(), var167 = var166.first(), var168 = Numbers.add((SubLObject)ONE_INTEGER, var168)) {
                    final SubLObject var169 = Sequences.position(var167, var162, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    if (var169.isInteger()) {
                ...
                var167 = var166.first();
                for (var168 = (SubLObject)ZERO_INTEGER; NIL != var166; var166 = var166.rest(), var167 = var166.first(), var168 = Numbers.add((SubLObject)ONE_INTEGER, var168)) {
                    final SubLObject var169 = Sequences.position(var167, var163, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    if (var169.isInteger()) {
                        ConsesLow.set_nth(var168, var165, var169);
                    }
                }
                final SubLObject var170 = (SubLObject)ConsesLow.list(var164, var165);
                if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var158) && NIL == module0035.f2439(Symbols.symbol_function((SubLObject)$ic26$), var170, (SubLObject)UNPROVIDED)) {
                    Errors.error((SubLObject)$ic27$, var170);
                }
                return var170;
            }
            cdestructuring_bind.cdestructuring_bind_error(var156, (SubLObject)$ic25$);
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var155, (SubLObject)$ic24$);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f27436(final SubLObject var174, final SubLObject var43, SubLObject var175) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var174, var174, (SubLObject)$ic28$);
        var176 = var174.first();
        SubLObject var178 = var174.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var178, var174, (SubLObject)$ic28$);
        var177 = var178.first();
        var178 = var178.rest();
        if (NIL == var178) {
            SubLObject var179 = (SubLObject)NIL;
            SubLObject var180 = (SubLObject)NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var43, var43, (SubLObject)$ic29$);
            var179 = var43.first();
            SubLObject var182_183 = var43.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var182_183, var43, (SubLObject)$ic29$);
            var180 = var182_183.first();
            var182_183 = var182_183.rest();
            if (NIL == var182_183) {
                final SubLObject var181 = (SubLObject)(var175.isCons() ? var175.first() : NIL);
                final SubLObject var182 = (SubLObject)(var175.isCons() ? conses_high.second(var175) : NIL);
                SubLObject var183 = (SubLObject)NIL;
                SubLObject var187_188 = (SubLObject)NIL;
                SubLObject var184 = (SubLObject)NIL;
                SubLObject var190_191 = (SubLObject)NIL;
                var183 = var176;
                var187_188 = var183.first();
                var184 = var179;
                var190_191 = var184.first();
                while (NIL != var184 || NIL != var183) {
                ...
                SubLObject var196_197 = (SubLObject)NIL;
                var185 = var177;
                var193_194 = var185.first();
                var186 = var180;
                var196_197 = var186.first();
                while (NIL != var186 || NIL != var185) {
                ...
                cdestructuring_bind.cdestructuring_bind_error(var43, (SubLObject)$ic29$);
            }
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var174, (SubLObject)$ic28$);
        }
        return var175;
    }
    
    public static SubLObject f27418(final SubLObject var198) {
        return f27462(var198, (SubLObject)ZERO_INTEGER);
    }
    ...
    public static SubLObject f27465() {
        $g3231$ = SubLFiles.deflexical("S#30547", (SubLObject)NIL);
        $g3232$ = SubLFiles.deflexical("S#30548", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g3231$ = null;
        $g3232$ = null;
        $ic0$ = makeKeyword("UNDETERMINED");
        $ic1$ = makeKeyword("COUNTERINTUITIVE");
        $ic2$ = makeString("Unexpected logical-tactic : ~S");
        $ic3$ = makeKeyword("SKIP");
        $ic4$ = makeString("Time to support ~S propagation");
        $ic5$ = makeKeyword("TRANSFORMATION");
        $ic6$ = makeString("Propagation error : ~S");
        $ic7$ = makeKeyword("UNINITIALIZED");
        $ic8$ = ConsesLow.list((SubLObject)makeSymbol("S#30549", "CYC"), (SubLObject)makeSymbol("S#30550", "CYC"));
        $ic9$ = ConsesLow.list((SubLObject)makeSymbol("S#30551", "CYC"), (SubLObject)makeSymbol("S#30552", "CYC"));
        $ic10$ = makeSymbol("S#30527", "CYC");
        $ic11$ = makeSymbol("S#30525", "CYC");
        $ic12$ = makeSymbol("S#30526", "CYC");
        $ic13$ = makeSymbol("S#30531", "CYC");
        $ic14$ = makeSymbol("S#27391", "CYC");
        $ic15$ = makeSymbol("S#30547", "CYC");
        $ic16$ = makeKeyword("&MEMOIZED-ITEM-NOT-FOUND&");
        $ic17$ = ConsesLow.list((SubLObject)makeSymbol("S#30553", "CYC"), (SubLObject)makeSymbol("S#30554", "CYC"));
        $ic18$ = ConsesLow.list((SubLObject)makeSymbol("S#30555", "CYC"), (SubLObject)makeSymbol("S#30556", "CYC"));
        $ic19$ = makeSymbol("S#30537", "CYC");
        $ic20$ = makeKeyword("UNINTUITIVE");
        $ic21$ = makeKeyword("INTUITIVE");
        $ic22$ = makeString("unexpected mode ~S");
        $ic23$ = makeSymbol("S#30548", "CYC");
        $ic24$ = ConsesLow.list((SubLObject)makeSymbol("S#30557", "CYC"), (SubLObject)makeSymbol("S#30558", "CYC"));
        $ic25$ = ConsesLow.list((SubLObject)makeSymbol("S#30559", "CYC"), (SubLObject)makeSymbol("S#30560", "CYC"));
        $ic26$ = makeSymbol("INTEGERP");
        $ic27$ = makeString("Failed literal map ~S");
        $ic28$ = ConsesLow.list((SubLObject)makeSymbol("S#30561", "CYC"), (SubLObject)makeSymbol("S#30562", "CYC"));
        $ic29$ = ConsesLow.list((SubLObject)makeSymbol("S#30563", "CYC"), (SubLObject)makeSymbol("S#30564", "CYC"));
        $ic30$ = makeKeyword("POSITIVE-INFINITY");
    }
}
