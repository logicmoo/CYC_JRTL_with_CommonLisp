...
public final class module0030 extends SubLTranslatedFile
{
    ...
    public static SubLObject f1590() {
        return module0030.$g858$.getGlobalValue();
    }
    
    public static SubLObject f1591(final SubLObject var1) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0030.NIL != module0004.f104(var1, module0030.$g858$.getGlobalValue(), Symbols.symbol_function((SubLObject)module0030.EQ), (SubLObject)module0030.UNPROVIDED) || module0030.NIL != module0004.f104(var1, module0030.$g859$.getGlobalValue(), Symbols.symbol_function((SubLObject)module0030.EQ), (SubLObject)module0030.UNPROVIDED));
    }
    
    public static SubLObject f1592(final SubLObject var2) {
        assert module0030.NIL != f1591(var2) : var2;
        if (var2.isSymbol()) {
            return var2;
        }
        return Sequences.find(var2, module0030.$g858$.getGlobalValue(), Symbols.symbol_function((SubLObject)module0030.EQL), Symbols.symbol_function((SubLObject)module0030.$ic2$), (SubLObject)module0030.UNPROVIDED, (SubLObject)module0030.UNPROVIDED);
    }
    
    public static SubLObject f1593(final SubLObject var1) {
        if (module0030.NIL != f1591(var1)) {
            return var1;
        }
        if (var1.eql(Symbols.symbol_function((SubLObject)module0030.$ic3$))) {
            return Symbols.symbol_function((SubLObject)module0030.EQ);
        }
        if (var1 == module0030.$ic3$) {
            return (SubLObject)module0030.EQ;
        }
        return Errors.error((SubLObject)module0030.$ic4$, var1);
    }
    
    public static SubLObject f1594(final SubLObject var3) {
        return Numbers.numE((SubLObject)module0030.ZERO_INTEGER, Hashtables.hash_table_count(var3));
    }
    
    public static SubLObject f1595(final SubLObject var3) {
        SubLObject var4 = (SubLObject)module0030.NIL;
        SubLObject var5 = (SubLObject)module0030.NIL;
        SubLObject var6 = (SubLObject)module0030.NIL;
        ...
        SubLObject var10 = (SubLObject)module0030.NIL;
        var10 = var9.first();
        while (module0030.NIL != var9) {
            SubLObject var12;
            final SubLObject var11 = var12 = var10;
            SubLObject var13 = (SubLObject)module0030.NIL;
            SubLObject var14 = (SubLObject)module0030.NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var12, var11, (SubLObject)module0030.$ic5$);
            var13 = var12.first();
    ...
    public static SubLObject f1597(final SubLObject var3) {
        ...
        final SubLObject var6 = Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED);
        final SubLObject var7 = var4.secondMultipleValue();
        var4.resetMultipleValues();
        return (SubLObject)SubLObjectFactory.makeBoolean(module0030.NIL == var7);
    }
    
    public static SubLObject f1599(final SubLObject var5, final SubLObject var16, final SubLObject var3) {
        return Hashtables.sethash(var5, var3, (SubLObject)ConsesLow.cons(var16, Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED)));
    }
    
    public static SubLObject f1600(final SubLObject var5, final SubLObject var16, final SubLObject var3, SubLObject var2) {
        if (var2 == module0030.UNPROVIDED) {
            var2 = Symbols.symbol_function((SubLObject)module0030.EQL);
        }
        return Hashtables.sethash(var5, var3, conses_high.adjoin(var16, Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED), var2, (SubLObject)module0030.UNPROVIDED));
    }
    
    public static SubLObject f1601(final SubLObject var5, final SubLObject var16, final SubLObject var3) {
        return Hashtables.sethash(var5, var3, module0035.f2084(var16, Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED)));
    }
    ...
    public static SubLObject f1602(final SubLObject var5, final SubLObject var3, final SubLObject var16, SubLObject var17, SubLObject var18) {
        if (var17 == module0030.UNPROVIDED) {
            var17 = (SubLObject)module0030.$ic6$;
        }
        if (var18 == module0030.UNPROVIDED) {
            var18 = Symbols.symbol_function((SubLObject)module0030.$ic7$);
        }
        assert module0030.NIL != Types.hash_table_p(var3) : var3;
        SubLObject var19 = Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED);
        if (var19.isList()) {
            var19 = module0035.f2244(var16, var19, var17, var18);
            return Hashtables.sethash(var5, var3, var19);
        }
        Errors.error((SubLObject)module0030.$ic9$, var19);
        return (SubLObject)module0030.NIL;
    }
    
    public static SubLObject f1603(final SubLObject var5, final SubLObject var16, final SubLObject var3) {
        return Hashtables.sethash(var5, var3, module0035.f2086(var16, Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED), (SubLObject)module0030.UNPROVIDED));
    }
    
    public static SubLObject f1604(final SubLObject var5, final SubLObject var3) {
        final SubLObject var6 = Hashtables.gethash_without_values(var5, var3, (SubLObject)module0030.UNPROVIDED);
    ...
    public static SubLObject f1605(final SubLObject var5, final SubLObject var16, final SubLObject var3, SubLObject var2) {
        ...
        return Hashtables.sethash(var5, var3, Sequences.remove(var16, Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED), var2, (SubLObject)module0030.UNPROVIDED, (SubLObject)module0030.UNPROVIDED, (SubLObject)module0030.UNPROVIDED, (SubLObject)module0030.UNPROVIDED));
    }
    
    public static SubLObject f1606(final SubLObject var5, final SubLObject var3, SubLObject var20) {
        if (var20 == module0030.UNPROVIDED) {
            var20 = (SubLObject)module0030.NIL;
        }
    ...
    public static SubLObject f1607(final SubLObject var5, final SubLObject var3, final SubLObject var6) {
        ...
        SubLObject var8 = (SubLObject)module0030.NIL;
        var7.resetMultipleValues();
        final SubLObject var9 = Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED);
        final SubLObject var10 = var7.secondMultipleValue();
        var7.resetMultipleValues();
        if (module0030.NIL == var10) {
    ...
    public static SubLObject f1608(final SubLObject var5, final SubLObject var16, final SubLObject var3) {
        return Hashtables.sethash(var5, var3, ConsesLow.nconc(var16, Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED)));
    }
    
    public static SubLObject f1609(final SubLObject var5, final SubLObject var16, final SubLObject var3) {
        return Hashtables.sethash(var5, var3, ConsesLow.nconc(Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED), var16));
    }
    
    public static SubLObject f1610(final SubLObject var24, final SubLObject var25) {
        SubLObject var26 = (SubLObject)module0030.NIL;
        SubLObject var27 = (SubLObject)module0030.NIL;
    ...
    public static SubLObject f1611(final SubLObject var28, SubLObject var29) {
        if (var29 == module0030.UNPROVIDED) {
            var29 = Hashtables.hash_table_count(var28);
        }
        assert module0030.NIL != Types.hash_table_p(var28) : var28;
        final SubLObject var30 = Hashtables.hash_table_test(var28);
        final SubLObject var31 = Hashtables.make_hash_table(var29, var30, (SubLObject)module0030.UNPROVIDED);
        f1610(var28, var31);
        return var31;
    }
    
    public static SubLObject f1612(final SubLObject var5, final SubLObject var3, final SubLObject var31) {
        return Hashtables.sethash(var5, var3, Functions.funcall(var31, Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED)));
    }
    ...
    public static SubLObject f1613(final SubLObject var5, final SubLObject var16, final SubLObject var3, SubLObject var2, SubLObject var32) {
        ...
        if (var32 == module0030.UNPROVIDED) {
            var32 = Symbols.symbol_function((SubLObject)module0030.IDENTITY);
        }
        return Hashtables.sethash(var5, var3, Sequences.delete(var16, Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED), var2, var32, (SubLObject)module0030.UNPROVIDED, (SubLObject)module0030.UNPROVIDED, (SubLObject)module0030.UNPROVIDED));
    }
    ...
    public static SubLObject f1614(final SubLObject var5, final SubLObject var16, final SubLObject var3, SubLObject var2, SubLObject var32) {
        ...
        final SubLObject var33 = Sequences.delete(var16, Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED), var2, var32, (SubLObject)module0030.UNPROVIDED, (SubLObject)module0030.UNPROVIDED, (SubLObject)module0030.UNPROVIDED);
        if (module0030.NIL != var33) {
    ...
    public static SubLObject f1615(final SubLObject var5, final SubLObject var3, SubLObject var33, SubLObject var34) {
        if (var33 == module0030.UNPROVIDED) {
            var33 = (SubLObject)module0030.ONE_INTEGER;
        }
        if (var34 == module0030.UNPROVIDED) {
            var34 = var33;
        }
        final SubLThread var35 = SubLProcess.currentSubLThread();
        assert module0030.NIL != Types.hash_table_p(var3) : var3;
        final SubLObject var36 = Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED);
        if (module0030.NIL == Errors.$ignore_mustsP$.getDynamicValue(var35) && module0030.NIL != var36 && !var36.isNumber()) {
            Errors.error((SubLObject)module0030.$ic10$, var5, var36, var3);
        }
        return Hashtables.sethash(var5, var3, (module0030.NIL != var36) ? Numbers.add(var36, var33) : var34);
    }
    ...
    public static SubLObject f1616(final SubLObject var5, final SubLObject var36, final SubLObject var3, SubLObject var2) {
        ...
        return Hashtables.sethash(var5, var3, conses_high.nunion(Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED), var36, var2, (SubLObject)module0030.UNPROVIDED));
    }
    ...
    public static SubLObject f1617(final SubLObject var5, final SubLObject var36, final SubLObject var3, SubLObject var2) {
        ...
        return Hashtables.sethash(var5, var3, conses_high.nset_difference(Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED), var36, var2, (SubLObject)module0030.UNPROVIDED));
    }
    ...
    public static SubLObject f1618(final SubLObject var37, final SubLObject var38, SubLObject var2) {
        ...
        SubLObject var39 = (SubLObject)module0030.NIL;
        SubLObject var40 = (SubLObject)module0030.NIL;
        SubLObject var41 = (SubLObject)module0030.NIL;
        ...
        try {
            while (Hashtables.iteratorHasNext(var42)) {
                ...
                if (module0030.NIL == Functions.funcall(var2, var41, Hashtables.gethash(var40, var38, (SubLObject)module0030.UNPROVIDED))) {
    ...
    public static SubLObject f1619(final SubLObject var37, final SubLObject var38) {
        ...
        try {
            while (Hashtables.iteratorHasNext(var42)) {
                ...
                var40 = Hashtables.getEntryKey(var43);
                var41 = Hashtables.getEntryValue(var43);
                if (module0030.$ic11$ == Hashtables.gethash(var40, var38, (SubLObject)module0030.$ic11$)) {
                    var39 = (SubLObject)ConsesLow.cons(var40, var39);
                }
            }
        }
    ...
    public static SubLObject f1620(final SubLObject var5, final SubLObject var16, final SubLObject var3, SubLObject var40, SubLObject var41) {
        if (var40 == module0030.UNPROVIDED) {
            var40 = Symbols.symbol_function((SubLObject)module0030.EQL);
        }
        if (var41 == module0030.UNPROVIDED) {
            var41 = Symbols.symbol_function((SubLObject)module0030.IDENTITY);
        }
        return module0004.f104(var16, Hashtables.gethash(var5, var3, (SubLObject)module0030.UNPROVIDED), var40, var41);
    }
    
    public static SubLObject f1621(final SubLObject var42, final SubLObject var43) {
        SubLObject var44 = (SubLObject)module0030.NIL;
        if (module0030.NIL == var44) {
            SubLObject var45 = var42;
            SubLObject var46 = (SubLObject)module0030.NIL;
            var46 = var45.first();
            while (module0030.NIL == var44 && module0030.NIL != var45) {
                if (module0030.NIL == Hashtables.gethash(var46, var43, (SubLObject)module0030.UNPROVIDED)) {
                    var44 = (SubLObject)module0030.T;
                }
                var45 = var45.rest();
                var46 = var45.first();
            }
        }
        return (SubLObject)SubLObjectFactory.makeBoolean(module0030.NIL == var44);
    }
    
    public static SubLObject f1622(final SubLObject var46, final SubLObject var17, SubLObject var5) {
        if (var5 == module0030.UNPROVIDED) {
            var5 = Symbols.symbol_function((SubLObject)module0030.IDENTITY);
        }
        assert module0030.NIL != Types.hash_table_p(var46) : var46;
        final SubLObject var47 = Hashtables.hash_table_count(var46);
        if (var47.numG((SubLObject)module0030.ZERO_INTEGER)) {
            SubLObject var48 = Vectors.make_vector(var47, (SubLObject)module0030.UNPROVIDED);
            SubLObject var49 = (SubLObject)module0030.NIL;
            SubLObject var50 = (SubLObject)module0030.ZERO_INTEGER;
            SubLObject var51 = (SubLObject)module0030.NIL;
            SubLObject var52 = (SubLObject)module0030.NIL;
            ...
            try {
                while (Hashtables.iteratorHasNext(var53)) {
                    ...
                    var50 = Numbers.add(var50, (SubLObject)module0030.ONE_INTEGER);
                }
            }
            finally {
            ...
            SubLObject var55;
            SubLObject var50_53;
            for (var55 = Sequences.length(var48), var50_53 = (SubLObject)module0030.NIL, var50_53 = (SubLObject)module0030.ZERO_INTEGER; var50_53.numL(var55); var50_53 = Numbers.add(var50_53, (SubLObject)module0030.ONE_INTEGER)) {
    ...
    public static SubLObject f1623(final SubLObject var54, final SubLObject var3) {
        ...
        SubLObject var56 = (SubLObject)module0030.ZERO_INTEGER;
        SubLObject var57 = (SubLObject)module0030.NIL;
        SubLObject var58 = (SubLObject)module0030.NIL;
        try {
            var55.throwStack.push(module0030.$ic12$);
            SubLObject var59 = (SubLObject)module0030.NIL;
            SubLObject var60 = (SubLObject)module0030.NIL;
            ...
            try {
                while (Hashtables.iteratorHasNext(var61)) {
                    ...
                    var56 = Numbers.add(var56, (SubLObject)module0030.ONE_INTEGER);
            ...
            var58 = Errors.handleThrowable(var63, (SubLObject)module0030.$ic12$);
        }
        finally {
    ...
    public static SubLObject f1598(final SubLObject var28) {
        SubLObject var29 = (SubLObject)module0030.NIL;
        SubLObject var30 = (SubLObject)module0030.NIL;
    ...
    public static SubLObject f1625(final SubLObject var28) {
        assert module0030.NIL != Types.hash_table_p(var28) : var28;
        SubLObject var30;
        final SubLObject var29 = var30 = (SubLObject)ConsesLow.make_list(Hashtables.hash_table_count(var28), (SubLObject)module0030.UNPROVIDED);
        SubLObject var31 = (SubLObject)module0030.NIL;
        SubLObject var32 = (SubLObject)module0030.NIL;
    ...
    public static SubLObject f1628(final SubLObject var28, final SubLObject var60, SubLObject var2) {
        ...
        SubLObject var61 = (SubLObject)module0030.NIL;
        SubLObject var62 = (SubLObject)module0030.NIL;
        SubLObject var63 = (SubLObject)module0030.NIL;
        ...
        try {
            while (Hashtables.iteratorHasNext(var64)) {
                ...
                if (module0030.NIL != Functions.funcall(var2, var63, var60)) {
    ...
    public static SubLObject f1631(final SubLObject var62, SubLObject var2) {
        ...
        final SubLObject var63 = Hashtables.make_hash_table(Sequences.length(var62), var2, (SubLObject)module0030.UNPROVIDED);
        SubLObject var64 = var62;
        SubLObject var65 = (SubLObject)module0030.NIL;
        var65 = var64.first();
        while (module0030.NIL != var64) {
            SubLObject var67;
            final SubLObject var66 = var67 = var65;
            SubLObject var68 = (SubLObject)module0030.NIL;
            SubLObject var69 = (SubLObject)module0030.NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var67, var66, (SubLObject)module0030.$ic5$);
            var68 = var67.first();
    ...
    public static SubLObject f1632(final SubLObject var46) {
        SubLObject var47 = (SubLObject)module0030.NIL;
        SubLObject var48 = (SubLObject)module0030.NIL;
        SubLObject var49 = (SubLObject)module0030.NIL;
    ...
    public static SubLObject f1633(final SubLObject var3, SubLObject var20) {
        if (var20 == module0030.UNPROVIDED) {
            var20 = (SubLObject)module0030.ZERO_INTEGER;
        }
        SubLObject var21 = (SubLObject)module0030.NIL;
        if (var3.isHashtable()) {
            SubLObject var22 = (SubLObject)module0030.NIL;
            SubLObject var23 = (SubLObject)module0030.NIL;
            ...
            try {
                while (Hashtables.iteratorHasNext(var24)) {
                    ...
                    if (module0030.NIL == var21) {
                        var21 = Sequences.length(var23);
                    }
                    else {
                        if (module0030.ZERO_INTEGER.numE(var21)) {
                            continue;
                        }
    ...
    public static SubLObject f1635(final SubLObject var42, SubLObject var2, SubLObject var29, SubLObject var70) {
        if (var2 == module0030.UNPROVIDED) {
            var2 = Symbols.symbol_function((SubLObject)module0030.EQUAL);
        }
        if (var29 == module0030.UNPROVIDED) {
            var29 = Sequences.length(var42);
        }
        if (var70 == module0030.UNPROVIDED) {
            var70 = Symbols.symbol_function((SubLObject)module0030.$ic13$);
        }
        final SubLObject var71 = Hashtables.make_hash_table(var29, var2, (SubLObject)module0030.UNPROVIDED);
        SubLObject var72 = var42;
        SubLObject var73 = (SubLObject)module0030.NIL;
        var73 = var72.first();
        while (module0030.NIL != var72) {
            Hashtables.sethash(var73, var71, (SubLObject)(var70.eql(Symbols.symbol_function((SubLObject)module0030.$ic13$)) ? module0030.T : Functions.funcall(var70, var73)));
            var72 = var72.rest();
            var73 = var72.first();
        }
        return var71;
    ...
    public static SubLObject f1636(final SubLObject var46, final SubLObject var72, final SubLObject var73) {
        SubLObject var74 = (SubLObject)module0030.NIL;
        SubLObject var75 = (SubLObject)module0030.NIL;
        SubLObject var76 = (SubLObject)module0030.NIL;
        ...
        try {
            while (Hashtables.iteratorHasNext(var77)) {
                ...
                if (module0030.NIL != Functions.funcall(var72, var75) && module0030.NIL != Functions.funcall(var73, var76)) {
    ...
    public static SubLObject f1637(final SubLObject var46, final SubLObject var72, final SubLObject var73) {
        ...
        try {
            while (Hashtables.iteratorHasNext(var77)) {
                ...
                var75 = Hashtables.getEntryKey(var78);
                var76 = Hashtables.getEntryValue(var78);
                if (module0030.NIL != Functions.funcall(var72, var75)) {
                    if (module0030.NIL != Functions.funcall(var73, var76)) {
                        continue;
                    }
                    var74 = (SubLObject)ConsesLow.cons(var75, var74);
                }
    ...
    public static SubLObject f1638(final SubLObject var46, SubLObject var75) {
        if (var75 == module0030.UNPROVIDED) {
            var75 = (SubLObject)module0030.T;
        }
        SubLObject var76 = (SubLObject)module0030.NIL;
        SubLObject var77 = (SubLObject)module0030.NIL;
        ...
        try {
            while (Hashtables.iteratorHasNext(var78)) {
                ...
                PrintLow.format(var75, (SubLObject)module0030.$ic14$, var76, var77);
            }
        }
        finally {
    ...
    public static SubLObject f1639(final SubLObject var46) {
        assert module0030.NIL != Types.hash_table_p(var46) : var46;
        final SubLObject var47 = Hashtables.hash_table_count(var46);
        final SubLObject var48 = Hashtables.make_hash_table(var47, Symbols.symbol_function((SubLObject)module0030.EQL), (SubLObject)module0030.UNPROVIDED);
        SubLObject var49 = (SubLObject)module0030.NIL;
        SubLObject var50 = (SubLObject)module0030.NIL;
        ...
        try {
            while (Hashtables.iteratorHasNext(var51)) {
                ...
                Hashtables.sethash(Hashtables.gethash_bucket(var49, var46), var48, Numbers.add(Hashtables.gethash(Hashtables.gethash_bucket(var49, var46), var48, (SubLObject)module0030.ZERO_INTEGER), (SubLObject)module0030.ONE_INTEGER));
            }
        }
        finally {
    ...
    public static SubLObject f1642() {
        module0030.$g858$ = SubLFiles.defconstant("S#2877", (SubLObject)module0030.$ic0$);
        module0030.$g859$ = SubLFiles.defconstant("S#2878", (SubLObject)ConsesLow.list(Symbols.symbol_function((SubLObject)module0030.EQ), Symbols.symbol_function((SubLObject)module0030.EQL), Symbols.symbol_function((SubLObject)module0030.EQUAL), Symbols.symbol_function((SubLObject)module0030.EQUALP)));
        return (SubLObject)module0030.NIL;
    }
    ...
    static {
        ...
        module0030.$g858$ = null;
        module0030.$g859$ = null;
        $ic0$ = ConsesLow.list((SubLObject)module0030.EQ, (SubLObject)module0030.EQL, (SubLObject)module0030.EQUAL, (SubLObject)module0030.EQUALP);
        $ic1$ = SubLObjectFactory.makeSymbol("S#2831", "CYC");
        $ic2$ = SubLObjectFactory.makeSymbol("SYMBOL-FUNCTION");
        $ic3$ = SubLObjectFactory.makeSymbol("S#2879", "CYC");
        $ic4$ = SubLObjectFactory.makeString("~S cannot be coerced into a valid SubL hash test");
        $ic5$ = (SubLList)ConsesLow.cons((SubLObject)SubLObjectFactory.makeSymbol("S#131", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#132", "CYC"));
        $ic6$ = SubLObjectFactory.makeSymbol("STRING<=");
        $ic7$ = SubLObjectFactory.makeSymbol("SYMBOL-NAME");
        $ic8$ = SubLObjectFactory.makeSymbol("HASH-TABLE-P");
        $ic9$ = SubLObjectFactory.makeString("Corrupted hash table; attempting to add values on a non-listp ~a.~%");
        $ic10$ = SubLObjectFactory.makeString("The key ~S maps to the non-numeric value ~S in the hashtable ~A.");
        $ic11$ = SubLObjectFactory.makeKeyword("NOTHING");
        $ic12$ = SubLObjectFactory.makeKeyword("MAPPING-DONE");
        $ic13$ = SubLObjectFactory.makeSymbol("TRUE");
        $ic14$ = SubLObjectFactory.makeString("~S -> ~S~%");
    }
}
...
/*
	...
	Decompiled from: G:\opt\CYC_JRTL_with_CommonLisp\platform\lib\cyc-oc4.0-unzipped/com/cyc/cycjava/cycl/module0030.class
	Total time: 180 ms
