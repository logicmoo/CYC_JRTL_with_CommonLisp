...
public final class module0358 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic31$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa"));
        $ic32$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genls"));
        $ic33$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Thing"));
        $ic34$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Thing")));
