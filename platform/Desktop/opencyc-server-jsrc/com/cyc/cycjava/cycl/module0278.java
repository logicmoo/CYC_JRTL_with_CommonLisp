...
public final class module0278 extends SubLTranslatedFile
{
    ...
    public static SubLObject f18390(final SubLObject var9, final SubLObject var2) {
        ...
        try {
            module0146.$g2031$.bind(Hashtables.make_hash_table((SubLObject)FOUR_INTEGER, Symbols.symbol_function((SubLObject)EQL), (SubLObject)UNPROVIDED), var10);
            module0146.$g2003$.bind((SubLObject)NIL, var10);
            var10.resetMultipleValues();
            final SubLObject var12_13 = f18391(var9, var2, $g2603$.getDynamicValue(var10), (SubLObject)ZERO_INTEGER);
    ...
    public static SubLObject f18393(final SubLObject var9, final SubLObject var2) {
        ...
        try {
            module0146.$g2031$.bind(Hashtables.make_hash_table((SubLObject)FOUR_INTEGER, Symbols.symbol_function((SubLObject)EQL), (SubLObject)UNPROVIDED), var10);
            module0146.$g2003$.bind((SubLObject)NIL, var10);
            if (NIL != module0202.f12590(var9) && NIL != f18394(var9)) {
                var10.resetMultipleValues();
    ...
    public static SubLObject f18396(final SubLObject var9, final SubLObject var2) {
        return f18397(var9, var2, (SubLObject)$ic1$);
    }
    
    public static SubLObject f18398(final SubLObject var9, final SubLObject var2) {
        return f18397(var9, var2, (SubLObject)$ic2$);
    }
    ...
    public static SubLObject f18397(final SubLObject var9, SubLObject var2, final SubLObject var20) {
        ...
        try {
            module0146.$g2031$.bind(Hashtables.make_hash_table((SubLObject)FOUR_INTEGER, Symbols.symbol_function((SubLObject)EQL), (SubLObject)UNPROVIDED), var21);
            module0146.$g2003$.bind((SubLObject)NIL, var21);
            try {
                var21.throwStack.push($ic3$);
                ...
                try {
                    ...
                    final SubLObject var26_27 = module0205.f13243(var9, var2, var20, (SubLObject)$ic4$, (SubLObject)NIL, $g2603$.getDynamicValue(var21));
                ...
                var22 = Errors.handleThrowable(var28, (SubLObject)$ic3$);
            }
            finally {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    var10.resetMultipleValues();
                    final SubLObject var33_34 = module0205.f13244(var9, (SubLObject)$ic1$, (SubLObject)$ic4$, (SubLObject)NIL, $g2603$.getDynamicValue(var10), (SubLObject)UNPROVIDED);
                ...
                var11 = Errors.handleThrowable(var17, (SubLObject)$ic3$);
            }
            finally {
    ...
    public static SubLObject f18400(final SubLObject var37, SubLObject var2) {
        ...
        try {
            ...
            var39 = (SubLObject)makeBoolean(NIL != module0202.f12590(var37) && NIL != module0205.f13215((SubLObject)$ic6$, var37, (SubLObject)NIL, (SubLObject)UNPROVIDED));
        }
        finally {
    ...
    public static SubLObject f18401() {
        final SubLThread var4 = SubLProcess.currentSubLThread();
        return $g2604$.getDynamicValue(var4);
    }
    ...
    public static SubLObject f18403(final SubLObject var39) {
        ...
        $g2605$.setDynamicValue((SubLObject)ConsesLow.cons(var39, $g2605$.getDynamicValue(var40)), var40);
        return var39;
    }
    
    public static SubLObject f18404() {
        final SubLThread var4 = SubLProcess.currentSubLThread();
        return module0035.f2269(Sequences.nreverse(conses_high.copy_list($g2605$.getDynamicValue(var4))), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f18405(final SubLObject var40, final SubLObject var41) {
        ...
        return (SubLObject)ConsesLow.listS((SubLObject)$ic7$, (SubLObject)$ic8$, ConsesLow.append(var44, (SubLObject)NIL));
    }
    ...
    public static SubLObject f18406(final SubLObject var1, SubLObject var2, SubLObject var3) {
        ...
        final SubLObject var7 = $g2604$.currentBinding(var4);
        final SubLObject var8 = $g2605$.currentBinding(var4);
        try {
            $g2604$.bind((SubLObject)T, var4);
            $g2605$.bind((SubLObject)NIL, var4);
            var5 = f18388(var1, var2, var3);
            var6 = f18404();
        }
        finally {
            $g2605$.rebind(var8, var4);
            $g2604$.rebind(var7, var4);
        }
    ...
    public static SubLObject f18407(final SubLObject var9, SubLObject var2) {
        ...
        SubLObject var11 = (SubLObject)NIL;
        SubLObject var12 = (SubLObject)NIL;
        final SubLObject var13 = $g2604$.currentBinding(var10);
        final SubLObject var14 = $g2605$.currentBinding(var10);
        try {
            $g2604$.bind((SubLObject)T, var10);
            $g2605$.bind((SubLObject)NIL, var10);
            var10.resetMultipleValues();
            ...
            $g2605$.rebind(var14, var10);
            $g2604$.rebind(var13, var10);
        }
    ...
    public static SubLObject f18414(final SubLObject var9, final SubLObject var2, SubLObject var74, SubLObject var75) {
        ...
        if (var75.numG(var74)) {
            Dynamic.sublisp_throw((SubLObject)$ic5$, (SubLObject)ConsesLow.list((SubLObject)$ic5$, var75, var74));
        }
        ...
        if (NIL != f18415(var9)) {
            ...
            return f18414(var77, var78, var74, Numbers.add((SubLObject)ONE_INTEGER, var75));
        }
        else if (NIL != module0202.f12903(var9)) {
            final SubLObject var79 = module0202.f12887(var9);
            final SubLObject var80 = module0202.f12906(var9);
            if (NIL != module0161.f10485(var80)) {
                var76.resetMultipleValues();
                final SubLObject var81 = f18414(var79, var80, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            ...
            if (NIL != module0205.f13215(Symbols.symbol_function((SubLObject)$ic9$), var9, (SubLObject)NIL, (SubLObject)UNPROVIDED)) {
                SubLObject var83 = (SubLObject)NIL;
                SubLObject var84 = (SubLObject)NIL;
                final SubLObject var85 = module0205.f13180(var9, (SubLObject)$ic10$);
                SubLObject var86 = (SubLObject)NIL;
                SubLObject var87 = (SubLObject)NIL;
                SubLObject var88 = (SubLObject)NIL;
                var86 = var85;
                var87 = var86.first();
                for (var88 = (SubLObject)ZERO_INTEGER; NIL != var86; var86 = var86.rest(), var87 = var86.first(), var88 = module0048.f_1X(var88)) {
                    SubLObject var89 = var87;
                    SubLObject var90 = (SubLObject)NIL;
                    final SubLObject var91 = module0205.f13136(var9);
                    if (NIL == module0279.f18485(var91, var88, var2) && NIL == module0206.f13472(var87)) {
                        var76.resetMultipleValues();
                        final SubLObject var88_89 = f18414(var87, var2, var74, Numbers.add((SubLObject)ONE_INTEGER, var75));
                        final SubLObject var90_91 = var76.secondMultipleValue();
                        var76.resetMultipleValues();
                        var89 = var88_89;
                        var90 = var90_91;
                    }
                    if (NIL != var90 && NIL == module0161.f10513(var2, var90)) {
                ...
                var84 = module0202.f12720(var83.first(), var83.rest(), module0202.f12707(var9, (SubLObject)UNPROVIDED));
    ...
    public static SubLObject f18416(final SubLObject var37, SubLObject var2) {
        ...
        return (SubLObject)makeBoolean(NIL != module0202.f12590(var37) && NIL != module0269.f17769(module0205.f13132(var37), var2));
    }
    
    public static SubLObject f18417(final SubLObject var9) {
        return (SubLObject)makeBoolean(NIL != module0202.f12590(var9) && NIL != f18418(module0205.f13132(var9)));
    }
    ...
    public static SubLObject f18394(final SubLObject var9) {
        ...
        if (NIL != f18419(var9) || NIL != f18420(var9)) {
            return (SubLObject)T;
        }
        if (NIL != module0146.$g1986$.getDynamicValue(var10) || NIL != module0152.$g2101$.getDynamicValue(var10)) {
            Dynamic.sublisp_throw((SubLObject)$ic11$, (SubLObject)ConsesLow.list((SubLObject)$ic11$, var9, module0205.f13136(var9), module0220.f14557(module0205.f13136(var9), $ic12$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)));
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f18421(final SubLObject var9) {
        return (SubLObject)makeBoolean(NIL != f18394(var9) && NIL != module0229.f15238(var9));
    }
    
    public static SubLObject f18418(final SubLObject var37) {
        final SubLObject var38 = module0205.f13328(var37);
        return (SubLObject)makeBoolean(NIL != module0173.f10955(var38) && NIL != f18422(var38));
    }
    
    public static SubLObject f18423(final SubLObject var37) {
        return (SubLObject)makeBoolean(NIL != module0202.f12590(var37) && NIL != module0269.f17768(module0205.f13132(var37)) && NIL != f18417(var37));
    }
    
    public static SubLObject f18424(final SubLObject var37) {
        return (SubLObject)makeBoolean(NIL != module0202.f12590(var37) && NIL != f18417(var37));
    }
    
    public static SubLObject f18415(final SubLObject var37) {
        return (SubLObject)makeBoolean(NIL != module0202.f12590(var37) && NIL != module0269.f17768(module0205.f13132(var37)) && NIL != f18394(var37));
    }
    
    public static SubLObject f18422(final SubLObject var37) {
        return (SubLObject)makeBoolean(NIL != module0220.f14557(var37, $ic12$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0220.f14557(var37, $ic13$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
    }
    ...
    public static SubLObject f18395(final SubLObject var95, SubLObject var2) {
        ...
        try {
            ...
            final SubLObject var105 = module0220.f14550(var97, $ic12$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            if (NIL != var105) {
                ...
                final SubLObject var107 = module0220.f14550(var97, $ic13$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                if (NIL != var107) {
                    final SubLObject var108 = module0202.f12757(module0178.f11335(var107));
                    if (NIL != module0305.f20359(var108, (SubLObject)UNPROVIDED)) {
                        var99 = var108;
                        f18402(var107);
                    }
                }
            ...
            if (NIL != var98) {
                ...
                SubLObject var112;
                final SubLObject var111 = var112 = module0205.f13207(var95, (SubLObject)$ic10$);
                ...
                var98 = (var100 = conses_high.sublis(var109, var98, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
            }
            else if (NIL != var99) {
    ...
    public static SubLObject f18391(final SubLObject var9, final SubLObject var2, final SubLObject var74, final SubLObject var75) {
        final SubLThread var76 = SubLProcess.currentSubLThread();
        if (var75.numG(var74)) {
            module0202.f12747((SubLObject)TWO_INTEGER, (SubLObject)$ic14$, var74, var9, (SubLObject)UNPROVIDED);
            return (SubLObject)NIL;
        }
        if (NIL != module0202.f12590(var9) && NIL != f18394(var9)) {
            var76.resetMultipleValues();
            ...
            final SubLObject var78 = var76.secondMultipleValue();
            var76.resetMultipleValues();
            return f18391(var77, var78, var74, Numbers.add((SubLObject)ONE_INTEGER, var75));
        }
        return Values.values(var9, var2);
    }
    
    public static SubLObject f18419(final SubLObject var95) {
        final SubLObject var96 = module0220.f14557(module0205.f13328(module0205.f13136(var95)), $ic12$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        final SubLObject var97 = (SubLObject)(var96.isCons() ? module0035.f2399(module0036.f2532(module0036.f2531(var96, Symbols.symbol_function((SubLObject)$ic15$), Symbols.symbol_function((SubLObject)$ic16$), (SubLObject)UNPROVIDED), Symbols.symbol_function((SubLObject)$ic17$), Symbols.symbol_function((SubLObject)$ic18$), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), Symbols.symbol_function((SubLObject)$ic15$), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) : NIL);
        if (var97.isCons()) {
            return module0202.f12732(var95, Functions.apply(Symbols.symbol_function((SubLObject)$ic19$), var97), (SubLObject)UNPROVIDED);
        }
        return module0202.f12734(var95, (SubLObject)ZERO_INTEGER, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f18420(final SubLObject var95) {
        final SubLObject var96 = module0202.f12757(module0220.f14557(module0205.f13136(var95), $ic13$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        return module0305.f20359(var96, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f18427(final SubLObject var113, final SubLObject var9) {
        return (NIL != module0035.f2428(var113, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) ? module0282.f18697(var113) : var113;
    }
    
    public static SubLObject f18425(final SubLObject var114, final SubLObject var115) {
        return f18428(var114, var115, (SubLObject)NIL);
    }
    
    public static SubLObject f18429(final SubLObject var114, final SubLObject var115) {
        return f18428(var114, var115, (SubLObject)T);
    }
    ...
    public static SubLObject f18428(final SubLObject var114, final SubLObject var115, final SubLObject var116) {
        ...
        final SubLObject var117 = module0205.f13188(var114, Symbols.symbol_function((SubLObject)$ic20$), (SubLObject)NIL, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        final SubLObject var118 = (SubLObject)((NIL != var117) ? module0205.f13188(var115, Symbols.symbol_function((SubLObject)$ic20$), (SubLObject)NIL, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) : NIL);
        final SubLObject var119 = (SubLObject)((NIL != var117 && NIL != var118) ? conses_high.nintersection(var117, var118, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) : NIL);
        if (NIL != var119) {
            ...
            return (NIL != var116) ? conses_high.nsublis(var120, var114, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) : conses_high.sublis(var120, var114, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return var114;
    }
    ...
    public static SubLObject f18430(final SubLObject var37, SubLObject var2) {
        ...
        try {
            module0147.$g2094$.bind(module0147.f9531(var40), var38);
            module0147.$g2095$.bind(module0147.f9534(var40), var38);
            if (NIL != module0210.f13598(var37)) {
    ...
    public static SubLObject f18431(final SubLObject var87) {
        ...
        if (NIL != module0173.f10955(var87)) {
            ...
            try {
                ...
                module0018.$g584$.bind((SubLObject)NIL, var88);
                module0219.f14502((SubLObject)$ic21$, var87, (SubLObject)$ic22$, (SubLObject)T);
        ...
        if (NIL != module0210.f13598(var87)) {
    ...
    public static SubLObject f18432(final SubLObject var123) {
        ...
        if (NIL != module0178.f11284(var123) && $ic12$.eql(module0178.f11333(var123)) && module0018.$g586$.getDynamicValue(var124).eql(module0205.f13132(module0178.f11335(var123)))) {
            module0018.$g584$.setDynamicValue((SubLObject)T, var124);
            module0012.f425();
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f18434() {
        $g2603$ = SubLFiles.defparameter("S#21037", (SubLObject)$ic0$);
        $g2604$ = SubLFiles.defparameter("S#21038", (SubLObject)NIL);
        $g2605$ = SubLFiles.defparameter("S#21039", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g2605$ = null;
        $ic0$ = makeInteger(212);
        $ic1$ = makeSymbol("S#21018", "CYC");
        $ic2$ = makeSymbol("S#21019", "CYC");
        $ic3$ = makeKeyword("TRANSFORMATION-LIMIT-EXCEEDED");
        $ic4$ = makeSymbol("S#21026", "CYC");
        $ic5$ = makeKeyword("RECURSION-LIMIT-EXCEEDED");
        $ic6$ = makeSymbol("S#21022", "CYC");
        $ic7$ = makeSymbol("CLET");
        $ic8$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#21038", "CYC"), (SubLObject)T), (SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#21039", "CYC"), (SubLObject)NIL));
        $ic9$ = makeSymbol("S#20996", "CYC");
        $ic10$ = makeKeyword("IGNORE");
        $ic11$ = makeKeyword("INVALID-EXPANSION");
        $ic12$ = constant_handles_oc.f8479((SubLObject)makeString("expansion"));
        $ic13$ = constant_handles_oc.f8479((SubLObject)makeString("expansionDefn"));
        $ic14$ = makeString("Trying to expand a recursive EL relation, hit the recursion limit ~D while expanding ~A~%");
        $ic15$ = makeSymbol("INTEGERP");
        $ic16$ = makeSymbol("NULL");
        $ic17$ = makeSymbol("S#15431", "CYC");
        $ic18$ = makeSymbol("S#20632", "CYC");
        $ic19$ = makeSymbol("MAX");
        $ic20$ = makeSymbol("EL-VAR?");
        $ic21$ = makeSymbol("S#21036", "CYC");
        $ic22$ = makeKeyword("TRUE");
    }
    ...
    public static final class $f18416$UnaryFunction extends UnaryFunction
    {
        ...
        public SubLObject processItem(final SubLObject var92) {
            return f18416(var92, (SubLObject)$f18416$UnaryFunction.UNPROVIDED);
        }
    }
