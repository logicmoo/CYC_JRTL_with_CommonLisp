...
public final class module0767 extends SubLTranslatedFile
{
    ...
    public static SubLObject f48904(final SubLObject var22, SubLObject var32) {
        ...
        while (module0767.NIL != var37) {
            if (module0767.NIL != constant_handles_oc.f8463(var38, (SubLObject)module0767.UNPROVIDED)) {
    ...
    public static SubLObject f48911(final SubLObject var411, final SubLObject var176, SubLObject var300) {
        ...
        try {
            ...
            if (module0767.NIL == assertion_handles_oc.f11035(var411)) {
                return (SubLObject)module0767.NIL;
            }
    ...
    public static SubLObject f48936(final SubLObject var411, SubLObject var458) {
        ...
        if (module0767.NIL == module0077.f5302(var458) || module0767.NIL == module0077.f5320(var411, var458)) {
            ...
            if (module0767.NIL == assertion_handles_oc.f11035(var411) || module0767.NIL != module0178.f11376(var411)) {
    ...
    public static SubLObject f48946(final SubLObject var6, SubLObject var49) {
        ...
        for (var53 = (var435_498 = Sequences.length(var6)), var54 = (SubLObject)module0767.NIL, var54 = (SubLObject)module0767.ZERO_INTEGER; !var54.numGE(var435_498); var54 = module0048.f_1X(var54)) {
            ...
            if (Characters.CHAR_hash.eql(var55) && (!var54.isPositive() || module0767.NIL == module0126.f8387(Strings.sublisp_char(var6, module0048.f_1_(var54)))) && module0767.NIL != module0035.f2002(var6, var54, (SubLObject)module0767.UNPROVIDED) && Characters.CHAR_dollar.eql(Strings.sublisp_char(var6, module0048.f_1X(var54)))) {
                ...
                if (module0767.NIL != constant_handles_oc.f8463(var59, (SubLObject)module0767.UNPROVIDED) && module0767.NIL != module0769.f49012(var59) && module0767.NIL != module0035.sublisp_boolean(module0769.f49014(var59))) {
    ...
    static {
        ...
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nameString"));
        $ic15$ = SubLObjectFactory.makeSymbol("S#53280", "CYC");
        $ic16$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InferencePSC"));
        ...
        $ic20$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("singular")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("massNumber")));
        ...
        $ic27$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Collection"));
        ...
        $ic36$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Instance-TheWord"));
        $ic37$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CountNoun"));
        ...
        $ic49$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nonPlural-Generic"));
        $ic50$ = SubLObjectFactory.makeString("~&Paraphrasing ~S as ~S in context ~S.~%");
        $ic51$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Determiner"));
        $ic52$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PhraseFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Determiner")));
        ...
        $ic56$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nounStrings"));
        $ic57$ = SubLObjectFactory.makeString("Can't reconcile ~S with ~S");
        $ic58$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FacetingCollectionType"));
        $ic59$ = SubLObjectFactory.makeSymbol("?TG");
        $ic60$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("typeGenls"));
        ...
        $ic67$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("True-JustificationTruth"));
        ...
        $ic76$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlPreds"));
        ...
        $ic93$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists"));
        $ic94$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("forAll"));
        ...
        $ic97$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("not")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("unknownSentence")));
        ...
        $ic126$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ProperNoun"));
        $ic127$ = SubLObjectFactory.makeString("the word ");
        $ic128$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("chemicalFormulaString"));
        ...
        $ic130$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ElectronicCharge"));
        $ic131$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ElementalSubstanceFn")), (SubLObject)SubLObjectFactory.makeKeyword("FORT"));
        $ic132$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheList"));
        $ic133$ = ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheList")), (SubLObject)module0767.ONE_INTEGER));
        $ic134$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?ELEMENTS"), (SubLObject)SubLObjectFactory.makeSymbol("?QUANTITIES"));
        $ic135$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completeAtomicComposition-List"));
        $ic136$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeFn"));
        $ic137$ = SubLObjectFactory.makeSymbol("?CHARGE");
        $ic138$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("chargeOfObject"));
        $ic139$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?CHARGE"));
        $ic140$ = SubLObjectFactory.makeSymbol("?MOLECULE-TYPE");
        $ic141$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("moleculesOfCompoundType"));
        $ic142$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?MOLECULE-TYPE"));
        $ic143$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ChemicalSubstanceFn"));
        ...
        $ic152$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("False"));
        ...
        $ic176$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Noun"));
        $ic177$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("definiteDescriptions"));
        ...
        $ic181$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nounStrings")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("properNameStrings")));
        $ic182$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("plural-Generic")));
        $ic183$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("singular-Generic")));
        $ic184$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("massNumber-Generic")));
        $ic185$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("properNameStrings"));
        ...
        $ic197$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("preferredNameString"));
        $ic198$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ProperNamePredicate-Strict"));
        ...
        $ic205$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("preferredTermStrings"));
        $ic206$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ProperNamePredicate-Loose"));
        ...
        $ic212$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("abbreviationString"));
        $ic213$ = SubLObjectFactory.makeSymbol("S#39293", "CYC");
        $ic214$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtUnionFn"));
        $ic215$ = SubLObjectFactory.makeSymbol("S#53464", "CYC");
        $ic216$ = SubLObjectFactory.makeSymbol("S#53355", "CYC");
        $ic217$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("validatedLexicalPSCForLanguage"));
        $ic218$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("dispreferredLexification"));
        $ic219$ = SubLObjectFactory.makeString("Generated name for ~S from~% ~S");
        $ic220$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ChemicalSubstanceType"));
        ...
        $ic225$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("abbreviationString-PN"));
        ...
        $ic229$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("acronymString"));
        ...
        $ic231$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Artifact-Generic"));
        $ic232$ = ConsesLow.list(new SubLObject[] { constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("middleName")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("scientificName")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nicknames")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("firstName")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("givenNames")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("familyName")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("formerName")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("placeName-LocalLongForm")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("placeName-LocalShortForm")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("countryName-LocalLongForm")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("countryName-LocalShortForm")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("epistleAddresseeText")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("abbreviationString-PN")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("internetCountryCode")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("countryCodeDigraph")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("geopoliticalEntityCodeDigraph")) });
        $ic233$ = SubLObjectFactory.makeSymbol("S#53376", "CYC");
        $ic234$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("scientificName"));
        $ic235$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("prettyString-Canonical")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("prettyString")));
        ...
        $ic239$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("rewriteOf"));
        ...
        $ic247$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genTemplate-Constrained"));
        $ic248$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genTemplate"));
        ...
        $ic262$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MultiplicationSign-TheSymbol"));
        ...
        $ic276$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("OrdinalAdjective"));
        $ic277$ = SubLObjectFactory.makeSymbol("?STRING");
        $ic278$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("imageURLPathname"));
        ...
        $ic289$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Always-TimeInterval"));
        $ic290$ = SubLObjectFactory.makeSymbol("S#53400", "CYC");
        $ic291$ = SubLObjectFactory.makeKeyword("ASSERTION");
        $ic292$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist"));
        $ic293$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeDimFn"));
        $ic294$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("SELF"));
        $ic295$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalInclusiveFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#53480", "CYC")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#53481", "CYC")));
        $ic296$ = SubLObjectFactory.makeSymbol("S#53481", "CYC");
        $ic297$ = SubLObjectFactory.makeSymbol("S#53480", "CYC");
        $ic298$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalStartedByFn-Inclusive"));
        $ic299$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn-Inclusive"));
        $ic300$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeTimeInIntervalFn")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalBetweenFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#53480", "CYC")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#53481", "CYC"))), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("GUID")));
        $ic301$ = SubLObjectFactory.makeSymbol("GUID");
        $ic302$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeTimeInIntervalFn"));
        $ic303$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalStartedByFn"));
        $ic304$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn"));
        $ic305$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeTimeInIntervalFn")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#13151", "CYC"))), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        ...
        $ic309$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtTimeIndex"));
        $ic310$ = SubLObjectFactory.makeSymbol("?TIME-INDEX");
        $ic311$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("assertedSentence"));
        $ic312$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?TIME-INDEX"));
        $ic313$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TKBSourceSpindleHeadMt"));
        $ic314$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TKBSourceSpindleCollectorMt"));
        ...
        $ic323$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CIAWorldFactbook1995Mt"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearFn")), (SubLObject)SubLObjectFactory.makeInteger(1994))), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtSpace")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BaseKB")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeDimFn")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearFn")), (SubLObject)SubLObjectFactory.makeInteger(1994))))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearFn")), (SubLObject)SubLObjectFactory.makeInteger(1994))));
        $ic324$ = SubLObjectFactory.makeKeyword("SUBSUMING");
        $ic325$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("startsAfterEndingOf"));
        $ic326$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalInclusiveFn"));
        $ic327$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeTimeInIntervalFn")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#53481", "CYC"))), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        ...
        $ic331$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalBetweenFn"));
        $ic332$ = SubLObjectFactory.makeSymbol("S#53411", "CYC");
        $ic333$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarYear"));
        $ic334$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DaysDuration")), (SubLObject)module0767.ONE_INTEGER);
        $ic335$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DurationFn"));
        $ic336$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarDay"));
        $ic337$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearsDuration")), (SubLObject)module0767.ONE_INTEGER);
        $ic338$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarMonth"));
        $ic339$ = SubLObjectFactory.makeSymbol("S#53409", "CYC");
        $ic340$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MonthFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("February")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearFn")), (SubLObject)SubLObjectFactory.makeInteger(1956)))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MonthFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("February")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearFn")), (SubLObject)SubLObjectFactory.makeInteger(1956)))), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SecondFn")), (SubLObject)module0767.SIXTEEN_INTEGER, (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MinuteFn")), (SubLObject)SubLObjectFactory.makeInteger(42), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HourFn")), (SubLObject)module0767.TWENTY_INTEGER, (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DayFn")), (SubLObject)module0767.ELEVEN_INTEGER, (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MonthFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("August")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearFn")), (SubLObject)SubLObjectFactory.makeInteger(2004)))))))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MonthFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("August")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearFn")), (SubLObject)SubLObjectFactory.makeInteger(2004)))), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DecadeFn")), (SubLObject)SubLObjectFactory.makeInteger(198))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DecadeFn")), (SubLObject)SubLObjectFactory.makeInteger(198))));
        $ic341$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genWithGloss"));
        $ic342$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("englishGloss"));
        ...
        $ic351$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ScalarInterval"));
        $ic352$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InstanceWithRelationFromFn"));
        $ic353$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Collection")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Relation")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("GAFGathering")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("StringBasedSearching")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ObtainingAStringBasedSearchResult")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("LexicalItem")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SKSSchema-LogicalOrPhysical")));
        $ic354$ = SubLObjectFactory.makeSymbol("S#53429", "CYC");
        $ic355$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("possessiveRelation"));
        ...
        $ic360$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FirstPerson-NLAttr")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Plural-NLAttr")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Ungendered-NLAttr")));
        $ic361$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PossessivePronoun-Pre"));
        $ic362$ = SubLObjectFactory.makeString("Couldn't find possessor for ~S");
        $ic363$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheCoordinationSet"));
        ...
        $ic366$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Individual")));
        ...
        $ic369$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestDetNbarFn-Definite"));
        $ic370$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TermParaphraseFn-Constrained"));
        $ic371$ = SubLObjectFactory.makeSymbol("S#53442", "CYC");
        $ic372$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLGenderAttribute"));
        $ic373$ = SubLObjectFactory.makeString("Defaulting to English gender unification in non-English context");
        $ic374$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Masculine-NLAttr"));
        $ic375$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Feminine-NLAttr"));
        $ic376$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Neuter-NLAttr"));
        $ic377$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Ungendered-NLAttr"));
        $ic378$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Plural-NLAttr"));
        $ic379$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Singular-NLAttr"));
        $ic380$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ThirdPerson-NLAttr"));
        $ic381$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FirstPerson-NLAttr"));
        $ic382$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SecondPerson-NLAttr"));
        $ic383$ = SubLObjectFactory.makeSymbol("?GENDER");
        $ic384$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("languageUsesGrammaticalGender"));
        ...
        $ic388$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EnglishLanguage")));
        $ic389$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("LanguageDialect"));
        $ic390$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("dialects"));
        $ic391$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EnglishLanguage"));
        $ic392$ = SubLObjectFactory.makeSymbol("S#53453", "CYC");
        $ic393$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("GeneralLexiconMt"));
        $ic394$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("defaultGrammaticalGender"));
        $ic395$ = SubLObjectFactory.makeString("pph-number-of-var guessing that ~S is singular because it's not a discourse referent~%");
        $ic396$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Group"));
        $ic397$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Agent-Generic"));
        $ic398$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ConceptualWorkSeries"));
        $ic399$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("licensedGrammaticalGender"));
