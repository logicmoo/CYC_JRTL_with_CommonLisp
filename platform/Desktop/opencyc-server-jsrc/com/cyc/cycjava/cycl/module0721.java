...
public final class module0721 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic15$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist-Intermediate"));
        ...
        $ic19$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("temporallySubsumes"));
        ...
        $ic28$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EverythingPSC"));
        $ic29$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("transitiveViaArgInverse"));
        ...
        $ic34$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("geographicallySubsumes"));
        ...
        $ic39$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("temporallySubsumes")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeTimeInIntervalFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#48405", "CYC")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        $ic40$ = SubLObjectFactory.makeSymbol("S#48405", "CYC");
        $ic41$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("temporallySubsumes")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalInclusiveFn")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeTimeInIntervalFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#124", "CYC")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeTimeInIntervalFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#125", "CYC")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"))), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        ...
        $ic46$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalOfTypeMinFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalOfTypeMaxFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalRangeFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ApproximatelyFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AlmostFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Unity")));
        $ic47$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalOfTypeMinFn"));
        $ic48$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("greaterThanOrEqualTo"));
        $ic49$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalOfTypeMaxFn"));
        $ic50$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("lessThanOrEqualTo"));
        $ic51$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ApproximatelyFn"));
        $ic52$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimesFn"));
        ...
        $ic55$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AlmostFn"));
        $ic56$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("lessThan"));
        $ic57$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Unity"));
        $ic58$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalRangeFn"));
        ...
        $ic62$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeFn"));
        $ic63$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Thing"));
        ...
        $ic67$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InstanceNamedFn-Ternary"));
        $ic68$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("trueSentence-CaseInsensitive"));
        $ic69$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist"));
        $ic70$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("The")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Microtheory")));
        $ic71$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtSpace")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("AND"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#48406", "CYC")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeWithGranularityDimFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("AND"), (SubLObject)SubLObjectFactory.makeKeyword("EL-VARIABLE"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#48407", "CYC"))), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimePoint"))))), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        ...
        $ic76$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AnytimeDuringPSCFn"));
        $ic77$ = SubLObjectFactory.makeString("MT");
        $ic78$ = SubLObjectFactory.makeString("MT-DIMS");
        $ic79$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtSpace"));
        $ic80$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist-Asserted"));
        $ic81$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and"));
        $ic82$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtUnionFn"));
        $ic83$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlMt"));
        $ic84$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("regexStringMatch-CaseInsensitive"));
        $ic85$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("regexStringMatch"));
        $ic86$ = SubLObjectFactory.makeSymbol("S#48408", "CYC");
        $ic87$ = SubLObjectFactory.makeString("STANDIN");
        $ic88$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("termStrings"));
        $ic89$ = SubLObjectFactory.makeString("REGEX");
        $ic90$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("assertionProducedByReformulation"));
    }
}
