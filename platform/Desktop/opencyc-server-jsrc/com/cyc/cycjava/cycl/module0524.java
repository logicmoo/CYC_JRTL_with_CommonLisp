...
public final class module0524 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic3$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("suffixSubstring")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("substring")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("prefixSubstring")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("prefixSubstring-CaseInsensitive")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("substring-CaseInsensitive")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("suffixSubstring-CaseInsensitive")));
        $ic4$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equalStrings-CaseInsensitive"));
        $ic5$ = SubLObjectFactory.makeSymbol("S#36116", "CYC");
        $ic6$ = SubLObjectFactory.makeSymbol("S#36117", "CYC");
        $ic7$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("substring"));
        ...
        $ic13$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("prefixSubstring-CaseInsensitive"));
        $ic14$ = SubLObjectFactory.makeSymbol("S#16397", "CYC");
        $ic15$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("suffixSubstring"));
