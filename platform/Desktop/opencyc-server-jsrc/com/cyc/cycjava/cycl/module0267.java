...
public final class module0267 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic1$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt"));
        $ic2$ = SubLObjectFactory.makeKeyword("TIME");
        $ic3$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("temporallySubsumes"));
        $ic4$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("temporallySubsumes-TypeType"));
        $ic5$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("temporallySubsumes-InsType"));
        $ic6$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Null-TimeParameter"));
        $ic7$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TimePoint"));
        ...
        $ic12$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("startingDate"));
        $ic13$ = SubLObjectFactory.makeSymbol("?X");
        $ic14$ = SubLObjectFactory.makeSymbol("CDAR");
        $ic15$ = SubLObjectFactory.makeSymbol("S#20158", "CYC");
        $ic16$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("endingDate"));
        ...
        $ic21$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Always-TimeInterval"));
        ...
        $ic27$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TheEmptyTimeInterval"));
        $ic28$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn-Inclusive"));
        $ic29$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("IntervalStartedByFn-Inclusive"));
        $ic30$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalInclusiveFn"));
