...
public final class module0365 extends SubLTranslatedFile
{
    ...
    public static SubLObject f24817(final SubLObject var1, final SubLObject var2) {
        f24818(var1, var2, (SubLObject)module0365.ZERO_INTEGER);
        return (SubLObject)module0365.NIL;
    }
    
    public static SubLObject f24819(final SubLObject var1) {
        return (SubLObject)((var1.getClass() == $sX24101_native.class) ? module0365.T : module0365.NIL);
    }
    
    public static SubLObject f24820(final SubLObject var1) {
        assert module0365.NIL != f24819(var1) : var1;
    ...
    public static SubLObject f24842(SubLObject var5) {
        if (var5 == module0365.UNPROVIDED) {
            var5 = (SubLObject)module0365.NIL;
        }
        ...
        SubLObject var9;
        SubLObject var10;
        for (var7 = (SubLObject)module0365.NIL, var7 = var5; module0365.NIL != var7; var7 = conses_high.cddr(var7)) {
            var8 = var7.first();
            var9 = conses_high.cadr(var7);
            var10 = var8;
            if (var10.eql((SubLObject)module0365.$ic32$)) {
                f24831(var6, var9);
            }
            else if (var10.eql((SubLObject)module0365.$ic33$)) {
                f24832(var6, var9);
            }
            else if (var10.eql((SubLObject)module0365.$ic34$)) {
                f24833(var6, var9);
            }
            else if (var10.eql((SubLObject)module0365.$ic35$)) {
                f24834(var6, var9);
            }
            else if (var10.eql((SubLObject)module0365.$ic36$)) {
                f24835(var6, var9);
            }
            else if (var10.eql((SubLObject)module0365.$ic37$)) {
                f24836(var6, var9);
            }
            else if (var10.eql((SubLObject)module0365.$ic38$)) {
                f24837(var6, var9);
            }
            else if (var10.eql((SubLObject)module0365.$ic39$)) {
                f24838(var6, var9);
            }
            else if (var10.eql((SubLObject)module0365.$ic40$)) {
                f24839(var6, var9);
            }
            else if (var10.eql((SubLObject)module0365.$ic41$)) {
                f24840(var6, var9);
            }
            else if (var10.eql((SubLObject)module0365.$ic42$)) {
                f24841(var6, var9);
            }
            else {
                Errors.error((SubLObject)module0365.$ic43$, var8);
            }
        }
        return var6;
    }
    ...
    public static SubLObject f24843(final SubLObject var11, final SubLObject var12) {
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic44$, (SubLObject)module0365.$ic45$, (SubLObject)module0365.ELEVEN_INTEGER);
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic32$, f24820(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic33$, f24821(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic34$, f24822(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic35$, f24823(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic36$, f24824(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic37$, f24825(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic38$, f24826(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic39$, f24827(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic40$, f24828(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic41$, f24829(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic46$, (SubLObject)module0365.$ic42$, f24830(var11));
        Functions.funcall(var12, var11, (SubLObject)module0365.$ic47$, (SubLObject)module0365.$ic45$, (SubLObject)module0365.ELEVEN_INTEGER);
        return var11;
    }
    ...
    public static SubLObject f24845(final SubLObject var13) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0365.NIL != f24819(var13) && module0365.NIL == f24846(var13));
    }
    ...
    public static SubLObject f24846(final SubLObject var13) {
        return Equality.eq((SubLObject)module0365.$ic49$, f24848(var13));
    }
    
    public static SubLObject f24818(final SubLObject var14, final SubLObject var2, final SubLObject var15) {
        final SubLThread var16 = SubLProcess.currentSubLThread();
        if (module0365.NIL != f24846(var14)) {
            PrintLow.format(var2, (SubLObject)module0365.$ic50$, f24849(var14));
        }
        else {
            final SubLObject var17 = f24850(var14);
            PrintLow.format(var2, (SubLObject)module0365.$ic51$, new SubLObject[] { f24851(var14), module0361.f23996(module0363.f24507(var17)), module0363.f24508(var17), f24849(var14), (module0365.NIL != module0365.$g3137$.getDynamicValue(var16) && module0365.NIL != module0373.f26163(var14)) ? module0365.NIL : f24852(var14), f24824(var14) });
        }
        return (SubLObject)module0365.NIL;
    }
    ...
    public static SubLObject f24853(final SubLObject var14) {
        ...
        if (module0365.NIL != module0363.f24504(var15)) {
            return Numbers.logxor(module0363.f24508(var15), f24849(var14));
        }
        return (SubLObject)module0365.ZERO_INTEGER;
    }
    
    public static SubLObject f24854(final SubLObject var17, final SubLObject var18, SubLObject var19) {
        if (var19 == module0365.UNPROVIDED) {
            var19 = (SubLObject)module0365.NIL;
        }
        assert module0365.NIL != module0363.f24478(var17) : var17;
        assert module0365.NIL != module0340.f22789(var18) : var18;
        final SubLObject var20 = f24842((SubLObject)module0365.UNPROVIDED);
        final SubLObject var21 = module0363.f24610(var17);
        f24831(var20, var21);
        f24832(var20, var17);
        f24833(var20, module0360.f23923(var18));
        f24834(var20, var18);
        f24855(var20, (SubLObject)module0365.$ic55$);
        f24840(var20, (SubLObject)module0365.NIL);
        f24856(var20, var19);
    ...
    public static SubLObject f24857(final SubLObject var13) {
        if (module0365.NIL != f24845(var13)) {
            f24858(var13);
            f24859(var13);
            final SubLObject var14 = f24850(var13);
            f24860(var13);
            if (module0365.NIL != module0363.f24687(var14) && module0363.f24611(var14).isZero()) {
                if (module0365.NIL != module0363.f24646(var14)) {
                    Errors.error((SubLObject)module0365.$ic56$, var14);
                }
                else {
    ...
    public static SubLObject f24861(final SubLObject var13) {
        final SubLObject var14 = f24850(var13);
        if (module0365.NIL != module0363.f24504(var14)) {
    ...
    public static SubLObject f24858(final SubLObject var13) {
        ...
        if (module0365.NIL != f24863(var14)) {
            f24864(var14);
            f24840(var13, (SubLObject)module0365.NIL);
        }
        return var13;
    }
    
    public static SubLObject f24860(final SubLObject var13) {
        f24841(var13, (SubLObject)module0365.$ic49$);
        f24840(var13, (SubLObject)module0365.$ic49$);
        f24835(var13, (SubLObject)module0365.$ic49$);
        f24836(var13, (SubLObject)module0365.$ic49$);
        f24837(var13, (SubLObject)module0365.$ic49$);
        f24838(var13, (SubLObject)module0365.$ic49$);
        f24834(var13, (SubLObject)module0365.$ic49$);
        f24832(var13, (SubLObject)module0365.$ic49$);
        return (SubLObject)module0365.NIL;
    }
    
    public static SubLObject f24859(final SubLObject var13) {
        f24839(var13, (SubLObject)module0365.$ic49$);
        return var13;
    }
    
    public static SubLObject f24849(final SubLObject var13) {
        assert module0365.NIL != f24819(var13) : var13;
        return f24820(var13);
    }
    ...
    public static SubLObject f24867(final SubLObject var13) {
        ...
        if (module0365.NIL != module0358.f23680(var14)) {
    ...
    public static SubLObject f24868(final SubLObject var13) {
        ...
        if (module0365.NIL != var14 && !module0365.areAssertionsDisabledFor(me) && module0365.NIL == module0358.f23680(var14)) {
    ...
    public static SubLObject f24852(final SubLObject var13) {
        ...
        assert module0365.NIL != f24819(var13) : var13;
        if (module0365.NIL != module0365.$g3137$.getDynamicValue(var14) && module0365.NIL != module0373.f26163(var13)) {
            return Errors.error((SubLObject)module0365.$ic58$, var13);
        }
        return f24826(var13);
    }
    ...
    public static SubLObject f24872(final SubLObject var13, final SubLObject var23) {
        assert module0365.NIL != f24819(var13) : var13;
        assert module0365.NIL != module0360.f23925(var23) : var23;
        f24835(var13, var23);
        f24836(var13, (SubLObject)module0365.$ic60$);
        return var13;
    }
    
    public static SubLObject f24873(final SubLObject var13, final SubLObject var24, final SubLObject var25) {
        assert module0365.NIL != f24819(var13) : var13;
        assert module0365.NIL != module0358.f23680(var24) : var24;
        f24835(var13, var24);
        f24836(var13, var25);
        return var13;
    }
    ...
    public static SubLObject f24874(final SubLObject var13, final SubLObject var26, SubLObject var27) {
        if (var27 == module0365.UNPROVIDED) {
            var27 = (SubLObject)module0365.T;
        }
        final SubLThread var28 = SubLProcess.currentSubLThread();
        assert module0365.NIL != f24819(var13) : var13;
        assert module0365.NIL != module0360.f23933(var26) : var26;
        if (module0365.NIL != module0365.$g3137$.getDynamicValue(var28) && module0365.NIL != module0373.f26163(var13)) {
            return var13;
        }
        f24837(var13, var26);
        if (module0365.NIL != var27) {
            f24838(var13, var26);
        }
        return var13;
    }
    ...
    public static SubLObject f24855(final SubLObject var13, final SubLObject var28) {
        assert module0365.NIL != f24819(var13) : var13;
        assert module0365.NIL != module0360.f23921(var28) : var28;
        f24839(var13, var28);
        return var13;
    }
    ...
    public static SubLObject f24875(final SubLObject var13, final SubLObject var19) {
        assert module0365.NIL != module0380.f26995(var13) : var13;
    ...
    public static SubLObject f24876(final SubLObject var29, final SubLObject var30) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var32, var31, (SubLObject)module0365.$ic64$);
        final SubLObject var33 = var32.rest();
        var32 = var32.first();
        SubLObject var34 = (SubLObject)module0365.NIL;
        SubLObject var35 = (SubLObject)module0365.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var32, var31, (SubLObject)module0365.$ic64$);
        var34 = var32.first();
        var32 = var32.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var32, var31, (SubLObject)module0365.$ic64$);
        var35 = var32.first();
        var32 = var32.rest();
        if (module0365.NIL == var32) {
            final SubLObject var36;
            var32 = (var36 = var33);
            return (SubLObject)ConsesLow.listS((SubLObject)module0365.$ic65$, (SubLObject)ConsesLow.list(var34, (SubLObject)ConsesLow.list((SubLObject)module0365.$ic66$, var35)), ConsesLow.append(var36, (SubLObject)module0365.NIL));
        }
        cdestructuring_bind.cdestructuring_bind_error(var31, (SubLObject)module0365.$ic64$);
        return (SubLObject)module0365.NIL;
    }
    ...
    public static SubLObject f24877(final SubLObject var29, final SubLObject var30) {
        SubLObject var32;
        final SubLObject var31 = var32 = var29.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var32, var31, (SubLObject)module0365.$ic67$);
        final SubLObject var33 = var32.rest();
        var32 = var32.first();
        SubLObject var34 = (SubLObject)module0365.NIL;
        SubLObject var35 = (SubLObject)module0365.NIL;
        ...
        var35 = var32.first();
        var32 = var32.rest();
        SubLObject var36 = (SubLObject)module0365.NIL;
        SubLObject var37 = var32;
        SubLObject var38 = (SubLObject)module0365.NIL;
        SubLObject var43_44 = (SubLObject)module0365.NIL;
        while (module0365.NIL != var37) {
            cdestructuring_bind.destructuring_bind_must_consp(var37, var31, (SubLObject)module0365.$ic67$);
            var43_44 = var37.first();
            var37 = var37.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var37, var31, (SubLObject)module0365.$ic67$);
            if (module0365.NIL == conses_high.member(var43_44, (SubLObject)module0365.$ic68$, (SubLObject)module0365.UNPROVIDED, (SubLObject)module0365.UNPROVIDED)) {
                var38 = (SubLObject)module0365.T;
            }
            if (var43_44 == module0365.$ic69$) {
                var36 = var37.first();
            }
            var37 = var37.rest();
        }
        if (module0365.NIL != var38 && module0365.NIL == var36) {
            cdestructuring_bind.cdestructuring_bind_error(var31, (SubLObject)module0365.$ic67$);
        }
        final SubLObject var39 = cdestructuring_bind.property_list_member((SubLObject)module0365.$ic70$, var32);
        final SubLObject var40 = (SubLObject)((module0365.NIL != var39) ? conses_high.cadr(var39) : module0365.NIL);
        final SubLObject var41 = cdestructuring_bind.property_list_member((SubLObject)module0365.$ic40$, var32);
        final SubLObject var42 = (SubLObject)((module0365.NIL != var41) ? conses_high.cadr(var41) : module0365.NIL);
        final SubLObject var43 = cdestructuring_bind.property_list_member((SubLObject)module0365.$ic36$, var32);
        final SubLObject var44 = (SubLObject)((module0365.NIL != var43) ? conses_high.cadr(var43) : module0365.NIL);
        final SubLObject var45 = cdestructuring_bind.property_list_member((SubLObject)module0365.$ic71$, var32);
        final SubLObject var46 = (SubLObject)((module0365.NIL != var45) ? conses_high.cadr(var45) : module0365.NIL);
        final SubLObject var47 = cdestructuring_bind.property_list_member((SubLObject)module0365.$ic35$, var32);
        final SubLObject var48 = (SubLObject)((module0365.NIL != var47) ? conses_high.cadr(var47) : module0365.NIL);
        final SubLObject var49 = cdestructuring_bind.property_list_member((SubLObject)module0365.$ic34$, var32);
        final SubLObject var50 = (SubLObject)((module0365.NIL != var49) ? conses_high.cadr(var49) : module0365.NIL);
        final SubLObject var51 = cdestructuring_bind.property_list_member((SubLObject)module0365.$ic38$, var32);
        final SubLObject var52 = (SubLObject)((module0365.NIL != var51) ? conses_high.cadr(var51) : module0365.NIL);
        final SubLObject var53;
        var32 = (var53 = var33);
        final SubLObject var54 = (SubLObject)module0365.$ic72$;
        return (SubLObject)ConsesLow.list((SubLObject)module0365.$ic73$, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(var54, var35)), (SubLObject)ConsesLow.list((SubLObject)module0365.$ic74$, (SubLObject)ConsesLow.list(new SubLObject[] { var34, ConsesLow.list((SubLObject)module0365.$ic66$, var54), module0365.$ic70$, var40, module0365.$ic40$, var42, module0365.$ic36$, var44, module0365.$ic71$, var46, module0365.$ic35$, var48, module0365.$ic34$, var50, module0365.$ic38$, var52 }), (SubLObject)ConsesLow.listS((SubLObject)module0365.$ic75$, (SubLObject)ConsesLow.list((SubLObject)module0365.EQ, var34, var54), ConsesLow.append(var53, (SubLObject)module0365.NIL))));
    }
    ...
    public static SubLObject f24880(final SubLObject var17, final SubLObject var55) {
        ...
        if (module0365.NIL != module0004.f106(var57)) {
    ...
    public static SubLObject f24882(final SubLObject var13) {
        return Equality.eq((SubLObject)module0365.$ic55$, f24848(var13));
    }
    
    public static SubLObject f24883(final SubLObject var13) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0365.NIL != f24882(var13) && module0365.NIL != f24863(f24862(var13)));
    }
    
    public static SubLObject f24884(final SubLObject var13) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0365.NIL == f24882(var13));
    }
    
    public static SubLObject f24885(final SubLObject var13) {
        return Equality.eq((SubLObject)module0365.$ic76$, f24848(var13));
    }
    
    public static SubLObject f24886(final SubLObject var13) {
        return Equality.eq((SubLObject)module0365.$ic77$, f24848(var13));
    }
    
    public static SubLObject f24887(final SubLObject var13, final SubLObject var62) {
        if (var62.eql((SubLObject)module0365.$ic78$)) {
            return (SubLObject)SubLObjectFactory.makeBoolean(module0365.NIL == f24886(var13));
        }
        if (var62.eql((SubLObject)module0365.$ic79$)) {
            return f24883(var13);
        }
        if (var62.eql((SubLObject)module0365.$ic80$)) {
            return (SubLObject)SubLObjectFactory.makeBoolean(module0365.NIL != f24885(var13) || module0365.NIL != f24883(var13));
        }
    ...
    public static SubLObject f24891(final SubLObject var13, final SubLObject var63) {
        ...
        f24874(var13, var63, (SubLObject)module0365.NIL);
        return var13;
    }
    
    public static SubLObject f24892(final SubLObject var13, SubLObject var65) {
        if (var65 == module0365.UNPROVIDED) {
            var65 = (SubLObject)module0365.ONE_INTEGER;
        }
        final SubLObject var66 = f24852(var13);
        SubLObject var67 = module0360.f23949(var66, var65);
        var67 = Numbers.max(var67, (SubLObject)module0365.ZERO_INTEGER);
        f24874(var13, var67, (SubLObject)module0365.NIL);
        return var67;
    }
    
    public static SubLObject f24893(final SubLObject var13) {
        f24855(var13, (SubLObject)module0365.$ic76$);
        module0413.f28790();
        return var13;
    }
    ...
    public static SubLObject f24894(final SubLObject var13) {
        if (module0365.NIL != f24845(var13)) {
            f24895(var13);
            f24855(var13, (SubLObject)module0365.$ic77$);
            module0413.f28792();
    ...
    public static SubLObject f24896(final SubLObject var13, final SubLObject var21) {
        assert module0365.NIL != f24882(var13) : var13;
        assert module0365.NIL != f24863(var21) : var21;
        f24840(var13, var21);
        return var13;
    }
    ...
    public static SubLObject f24897(final SubLObject var13) {
        final SubLObject var14 = f24862(var13);
        SubLObject var15 = (SubLObject)module0365.NIL;
        try {
            if (module0365.NIL == module0052.f3687(var14)) {
                module0052.f3693(var14);
                var15 = (SubLObject)module0365.T;
            }
        }
        finally {
            final SubLObject var16 = Dynamic.currentBinding(Threads.$is_thread_performing_cleanupP$);
            try {
                Dynamic.bind(Threads.$is_thread_performing_cleanupP$, (SubLObject)module0365.T);
                if ((module0365.NIL == var15 || module0365.NIL != module0052.f3687(var14)) && module0365.NIL != f24882(var13)) {
                    f24895(var13);
                }
            }
            finally {
    ...
    public static SubLObject f24898(final SubLObject var13, final SubLObject var68) {
        SubLObject var69 = (SubLObject)module0365.NIL;
        SubLObject var70 = (SubLObject)module0365.NIL;
        if (module0365.NIL != module0052.f3717(var68)) {
            var69 = module0052.f3720(var68);
        }
        if (module0365.NIL != var69) {
            var70 = module0360.f23935(var69);
        }
        if (module0365.NIL != module0360.f23933(var70)) {
            f24891(var13, var70);
            return (SubLObject)module0365.T;
        }
        return (SubLObject)module0365.NIL;
    }
    
    public static SubLObject f24899(final SubLObject var58) {
        return module0035.f2378(var58, Symbols.symbol_function((SubLObject)module0365.$ic83$), (SubLObject)module0365.$ic84$);
    }
    
    public static SubLObject f24900(final SubLObject var58) {
        SubLObject var59 = (SubLObject)module0365.ZERO_INTEGER;
        SubLObject var60 = var58;
        SubLObject var61 = (SubLObject)module0365.NIL;
        var61 = var60.first();
        while (module0365.NIL != var60) {
    ...
    public static SubLObject f24901(final SubLObject var17) {
        SubLObject var18 = (SubLObject)module0365.ZERO_INTEGER;
        SubLObject var19 = module0363.f24517(var17);
        SubLObject var20 = (SubLObject)module0365.NIL;
        var20 = var19.first();
        while (module0365.NIL != var19) {
            if (module0365.NIL != module0363.f24518(var20, (SubLObject)module0365.$ic55$)) {
    ...
    public static SubLObject f24902(final SubLObject var17) {
        ...
        while (module0365.NIL != var19) {
            if (module0365.NIL != module0363.f24518(var20, (SubLObject)module0365.$ic55$)) {
                ...
                if (module0365.NIL != module0360.f23940(var21, var18)) {
                    var18 = var21;
                }
            }
            var19 = var19.rest();
    ...
    public static SubLObject f24904(final SubLObject var72) {
        SubLObject var73 = (SubLObject)module0365.ZERO_INTEGER;
        final SubLObject var74 = module0361.f24128(var72);
        if (module0365.NIL == module0065.f4772(var74, (SubLObject)module0365.$ic85$)) {
            final SubLObject var74_75 = var74;
            if (module0365.NIL == module0065.f4775(var74_75, (SubLObject)module0365.$ic85$)) {
                final SubLObject var75 = module0065.f4740(var74_75);
                final SubLObject var76 = (SubLObject)module0365.NIL;
                SubLObject var77;
                SubLObject var78;
                SubLObject var79;
                SubLObject var80;
                SubLObject var81;
                SubLObject var82;
                for (var77 = Sequences.length(var75), var78 = (SubLObject)module0365.NIL, var78 = (SubLObject)module0365.ZERO_INTEGER; var78.numL(var77); var78 = Numbers.add(var78, (SubLObject)module0365.ONE_INTEGER)) {
                    var79 = ((module0365.NIL != var76) ? Numbers.subtract(var77, var78, (SubLObject)module0365.ONE_INTEGER) : var78);
                    var80 = Vectors.aref(var75, var79);
                    if (module0365.NIL == module0065.f4749(var80) || module0365.NIL == module0065.f4773((SubLObject)module0365.$ic85$)) {
                        if (module0365.NIL != module0065.f4749(var80)) {
                            var80 = (SubLObject)module0365.$ic85$;
                        }
                        var81 = module0363.f24517(var80);
                        var82 = (SubLObject)module0365.NIL;
                        var82 = var81.first();
                        while (module0365.NIL != var81) {
            ...
            if (module0365.NIL == module0065.f4777(var81_82)) {
                final SubLObject var83 = module0065.f4738(var81_82);
                SubLObject var84 = (SubLObject)module0365.NIL;
                SubLObject var85 = (SubLObject)module0365.NIL;
                ...
                try {
                    while (Hashtables.iteratorHasNext(var86)) {
                        ...
                        SubLObject var89 = (SubLObject)module0365.NIL;
                        var89 = var88.first();
                        while (module0365.NIL != var88) {
    ...
    public static SubLObject f24905(final SubLObject var13) {
        if (module0365.NIL != module0373.f26176(var13)) {
            return Numbers.round(module0360.f23936(module0373.f26182(var13)), (SubLObject)module0365.UNPROVIDED);
        }
        if (module0365.NIL != f24885(var13)) {
            return (SubLObject)module0365.ONE_INTEGER;
        }
        return (SubLObject)module0365.ZERO_INTEGER;
    }
    ...
    public static SubLObject f24906(final SubLObject var86, final SubLObject var13, final SubLObject var87) {
        return module0052.f3689(f24907(var86, var13, var87), (SubLObject)module0365.$ic86$, (SubLObject)module0365.$ic87$, (SubLObject)module0365.$ic88$);
    }
    ...
    public static SubLObject f24908(final SubLObject var89) {
        SubLObject var88_92 = (SubLObject)module0365.NIL;
        SubLObject var90 = (SubLObject)module0365.NIL;
        SubLObject var91 = (SubLObject)module0365.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var89, var89, (SubLObject)module0365.$ic89$);
        var88_92 = var89.first();
        SubLObject var92 = var89.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var92, var89, (SubLObject)module0365.$ic89$);
        var90 = var92.first();
        var92 = var92.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var92, var89, (SubLObject)module0365.$ic89$);
        var91 = var92.first();
        var92 = var92.rest();
        if (module0365.NIL == var92) {
            final SubLObject var93 = var90;
            if (var93.eql((SubLObject)module0365.$ic90$)) {
                return Types.sublisp_null(var88_92);
            }
            if (var93.eql((SubLObject)module0365.$ic91$)) {
                SubLObject var95_96;
                final SubLObject var93_94 = var95_96 = var88_92;
                SubLObject var94 = (SubLObject)module0365.NIL;
                SubLObject var95 = (SubLObject)module0365.NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var95_96, var93_94, (SubLObject)module0365.$ic92$);
                var94 = var95_96.first();
                var95_96 = var95_96.rest();
                cdestructuring_bind.destructuring_bind_must_consp(var95_96, var93_94, (SubLObject)module0365.$ic92$);
                var95 = var95_96.first();
                var95_96 = var95_96.rest();
                if (module0365.NIL == var95_96) {
                    return module0052.f3687(var94);
                }
                cdestructuring_bind.cdestructuring_bind_error(var93_94, (SubLObject)module0365.$ic92$);
            }
            else {
                if (var93.eql((SubLObject)module0365.$ic93$)) {
                    return Types.sublisp_null(var88_92);
                }
                if (var93.eql((SubLObject)module0365.$ic94$)) {
                    return module0052.f3687(var88_92);
                }
                if (var93.eql((SubLObject)module0365.$ic95$)) {
                    return Types.sublisp_null(var88_92);
                }
                if (var93.eql((SubLObject)module0365.$ic96$)) {
                    return module0380.f27004(var91);
                }
                return Errors.error((SubLObject)module0365.$ic97$, var90);
            }
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var89, (SubLObject)module0365.$ic89$);
        }
        return (SubLObject)module0365.NIL;
    }
    
    public static SubLObject f24909(final SubLObject var89) {
        SubLObject var88_100 = (SubLObject)module0365.NIL;
        SubLObject var90 = (SubLObject)module0365.NIL;
        SubLObject var91 = (SubLObject)module0365.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var89, var89, (SubLObject)module0365.$ic89$);
        ...
        if (module0365.NIL == var92) {
            ...
            if (var93.eql((SubLObject)module0365.$ic91$)) {
                ...
                SubLObject var97 = (SubLObject)module0365.NIL;
                SubLObject var98 = (SubLObject)module0365.NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var106_107, var104_105, (SubLObject)module0365.$ic98$);
                var97 = var106_107.first();
                var106_107 = var106_107.rest();
                cdestructuring_bind.destructuring_bind_must_consp(var106_107, var104_105, (SubLObject)module0365.$ic98$);
                var98 = var106_107.first();
                var106_107 = var106_107.rest();
                if (module0365.NIL == var106_107) {
                    final SubLObject var99 = module0376.f26694(var91, var97, var98);
                    return Values.values(var99, var89);
                }
                cdestructuring_bind.cdestructuring_bind_error(var104_105, (SubLObject)module0365.$ic98$);
            }
            else {
                if (var93.eql((SubLObject)module0365.$ic93$)) {
                    final SubLObject var94 = var88_100.first();
                ...
                if (var93.eql((SubLObject)module0365.$ic96$)) {
                    ...
                    return Values.values((SubLObject)module0365.NIL, var89);
                }
                return Errors.error((SubLObject)module0365.$ic99$, var90);
            }
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var89, (SubLObject)module0365.$ic89$);
    ...
    public static SubLObject f24910(final SubLObject var89) {
        SubLObject var88_112 = (SubLObject)module0365.NIL;
        SubLObject var90 = (SubLObject)module0365.NIL;
        SubLObject var91 = (SubLObject)module0365.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var89, var89, (SubLObject)module0365.$ic89$);
        ...
        if (module0365.NIL == var92) {
            ...
            if (var93.eql((SubLObject)module0365.$ic91$)) {
                ...
                SubLObject var94 = (SubLObject)module0365.NIL;
                SubLObject var95 = (SubLObject)module0365.NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var115_116, var113_114, (SubLObject)module0365.$ic98$);
                var94 = var115_116.first();
                var115_116 = var115_116.rest();
                cdestructuring_bind.destructuring_bind_must_consp(var115_116, var113_114, (SubLObject)module0365.$ic98$);
                var95 = var115_116.first();
                var115_116 = var115_116.rest();
                if (module0365.NIL == var115_116) {
                    return module0052.f3696(var94);
                }
                cdestructuring_bind.cdestructuring_bind_error(var113_114, (SubLObject)module0365.$ic98$);
            }
            else {
                if (var93.eql((SubLObject)module0365.$ic93$)) {
                    return (SubLObject)module0365.T;
                ...
                return Errors.error((SubLObject)module0365.$ic100$, var90);
            }
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var89, (SubLObject)module0365.$ic89$);
    ...
    public static SubLObject f24912() {
        module0365.$g3137$ = SubLFiles.defvar("S#27802", (SubLObject)module0365.NIL);
        module0365.$g3138$ = SubLFiles.defconstant("S#27803", (SubLObject)module0365.$ic0$);
        return (SubLObject)module0365.NIL;
    }
    
    public static SubLObject f24913() {
        Structures.register_method(print_high.$print_object_method_table$.getGlobalValue(), module0365.$g3138$.getGlobalValue(), Symbols.symbol_function((SubLObject)module0365.$ic8$));
        SubLSpecialOperatorDeclarations.proclaim((SubLObject)module0365.$ic9$);
        Structures.def_csetf((SubLObject)module0365.$ic10$, (SubLObject)module0365.$ic11$);
        Structures.def_csetf((SubLObject)module0365.$ic12$, (SubLObject)module0365.$ic13$);
        Structures.def_csetf((SubLObject)module0365.$ic14$, (SubLObject)module0365.$ic15$);
        Structures.def_csetf((SubLObject)module0365.$ic16$, (SubLObject)module0365.$ic17$);
        Structures.def_csetf((SubLObject)module0365.$ic18$, (SubLObject)module0365.$ic19$);
        Structures.def_csetf((SubLObject)module0365.$ic20$, (SubLObject)module0365.$ic21$);
        Structures.def_csetf((SubLObject)module0365.$ic22$, (SubLObject)module0365.$ic23$);
        Structures.def_csetf((SubLObject)module0365.$ic24$, (SubLObject)module0365.$ic25$);
        Structures.def_csetf((SubLObject)module0365.$ic26$, (SubLObject)module0365.$ic27$);
        Structures.def_csetf((SubLObject)module0365.$ic28$, (SubLObject)module0365.$ic29$);
        Structures.def_csetf((SubLObject)module0365.$ic30$, (SubLObject)module0365.$ic31$);
        Equality.identity((SubLObject)module0365.$ic0$);
        Structures.register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), module0365.$g3138$.getGlobalValue(), Symbols.symbol_function((SubLObject)module0365.$ic48$));
        Structures.register_method(Sxhash.$sxhash_method_table$.getGlobalValue(), module0365.$g3138$.getGlobalValue(), Symbols.symbol_function((SubLObject)module0365.$ic52$));
        module0012.f419((SubLObject)module0365.$ic86$);
        module0012.f419((SubLObject)module0365.$ic87$);
        module0012.f419((SubLObject)module0365.$ic88$);
        return (SubLObject)module0365.NIL;
    }
    ...
    static {
        ...
        module0365.$g3137$ = null;
        module0365.$g3138$ = null;
        $ic0$ = SubLObjectFactory.makeSymbol("S#24101", "CYC");
        $ic1$ = SubLObjectFactory.makeSymbol("S#26790", "CYC");
        $ic2$ = SubLObjectFactory.makeInteger(210);
        $ic3$ = ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeSymbol("S#10593", "CYC"), SubLObjectFactory.makeSymbol("S#24274", "CYC"), SubLObjectFactory.makeSymbol("TYPE"), SubLObjectFactory.makeSymbol("S#14781", "CYC"), SubLObjectFactory.makeSymbol("S#25691", "CYC"), SubLObjectFactory.makeSymbol("S#27804", "CYC"), SubLObjectFactory.makeSymbol("S#26071", "CYC"), SubLObjectFactory.makeSymbol("S#27805", "CYC"), SubLObjectFactory.makeSymbol("S#5846", "CYC"), SubLObjectFactory.makeSymbol("S#27806", "CYC"), SubLObjectFactory.makeSymbol("S#1625", "CYC") });
        $ic4$ = ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeKeyword("SUID"), SubLObjectFactory.makeKeyword("PROBLEM"), SubLObjectFactory.makeKeyword("TYPE"), SubLObjectFactory.makeKeyword("HL-MODULE"), SubLObjectFactory.makeKeyword("COMPLETENESS"), SubLObjectFactory.makeKeyword("PREFERENCE-LEVEL-JUSTIFICATION"), SubLObjectFactory.makeKeyword("PRODUCTIVITY"), SubLObjectFactory.makeKeyword("ORIGINAL-PRODUCTIVITY"), SubLObjectFactory.makeKeyword("STATUS"), SubLObjectFactory.makeKeyword("PROGRESS-ITERATOR"), SubLObjectFactory.makeKeyword("DATA") });
        $ic5$ = ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeSymbol("S#27729", "CYC"), SubLObjectFactory.makeSymbol("S#27730", "CYC"), SubLObjectFactory.makeSymbol("S#27731", "CYC"), SubLObjectFactory.makeSymbol("S#27732", "CYC"), SubLObjectFactory.makeSymbol("S#27733", "CYC"), SubLObjectFactory.makeSymbol("S#27734", "CYC"), SubLObjectFactory.makeSymbol("S#27735", "CYC"), SubLObjectFactory.makeSymbol("S#27736", "CYC"), SubLObjectFactory.makeSymbol("S#27737", "CYC"), SubLObjectFactory.makeSymbol("S#27738", "CYC"), SubLObjectFactory.makeSymbol("S#27739", "CYC") });
        $ic6$ = ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeSymbol("S#27740", "CYC"), SubLObjectFactory.makeSymbol("S#27741", "CYC"), SubLObjectFactory.makeSymbol("S#27742", "CYC"), SubLObjectFactory.makeSymbol("S#27743", "CYC"), SubLObjectFactory.makeSymbol("S#27744", "CYC"), SubLObjectFactory.makeSymbol("S#27745", "CYC"), SubLObjectFactory.makeSymbol("S#27746", "CYC"), SubLObjectFactory.makeSymbol("S#27747", "CYC"), SubLObjectFactory.makeSymbol("S#27748", "CYC"), SubLObjectFactory.makeSymbol("S#27749", "CYC"), SubLObjectFactory.makeSymbol("S#27750", "CYC") });
        $ic7$ = SubLObjectFactory.makeSymbol("S#27757", "CYC");
        $ic8$ = SubLObjectFactory.makeSymbol("S#27728", "CYC");
        $ic9$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("OPTIMIZE-FUNCALL"), (SubLObject)SubLObjectFactory.makeSymbol("S#26790", "CYC"));
        $ic10$ = SubLObjectFactory.makeSymbol("S#27729", "CYC");
        $ic11$ = SubLObjectFactory.makeSymbol("S#27740", "CYC");
        $ic12$ = SubLObjectFactory.makeSymbol("S#27730", "CYC");
        $ic13$ = SubLObjectFactory.makeSymbol("S#27741", "CYC");
        $ic14$ = SubLObjectFactory.makeSymbol("S#27731", "CYC");
        $ic15$ = SubLObjectFactory.makeSymbol("S#27742", "CYC");
        $ic16$ = SubLObjectFactory.makeSymbol("S#27732", "CYC");
        $ic17$ = SubLObjectFactory.makeSymbol("S#27743", "CYC");
        $ic18$ = SubLObjectFactory.makeSymbol("S#27733", "CYC");
        $ic19$ = SubLObjectFactory.makeSymbol("S#27744", "CYC");
        $ic20$ = SubLObjectFactory.makeSymbol("S#27734", "CYC");
        $ic21$ = SubLObjectFactory.makeSymbol("S#27745", "CYC");
        $ic22$ = SubLObjectFactory.makeSymbol("S#27735", "CYC");
        $ic23$ = SubLObjectFactory.makeSymbol("S#27746", "CYC");
        $ic24$ = SubLObjectFactory.makeSymbol("S#27736", "CYC");
        $ic25$ = SubLObjectFactory.makeSymbol("S#27747", "CYC");
        $ic26$ = SubLObjectFactory.makeSymbol("S#27737", "CYC");
        $ic27$ = SubLObjectFactory.makeSymbol("S#27748", "CYC");
        $ic28$ = SubLObjectFactory.makeSymbol("S#27738", "CYC");
        $ic29$ = SubLObjectFactory.makeSymbol("S#27749", "CYC");
        $ic30$ = SubLObjectFactory.makeSymbol("S#27739", "CYC");
        $ic31$ = SubLObjectFactory.makeSymbol("S#27750", "CYC");
        $ic32$ = SubLObjectFactory.makeKeyword("SUID");
        $ic33$ = SubLObjectFactory.makeKeyword("PROBLEM");
        $ic34$ = SubLObjectFactory.makeKeyword("TYPE");
        $ic35$ = SubLObjectFactory.makeKeyword("HL-MODULE");
        $ic36$ = SubLObjectFactory.makeKeyword("COMPLETENESS");
        $ic37$ = SubLObjectFactory.makeKeyword("PREFERENCE-LEVEL-JUSTIFICATION");
        $ic38$ = SubLObjectFactory.makeKeyword("PRODUCTIVITY");
        $ic39$ = SubLObjectFactory.makeKeyword("ORIGINAL-PRODUCTIVITY");
        $ic40$ = SubLObjectFactory.makeKeyword("STATUS");
        $ic41$ = SubLObjectFactory.makeKeyword("PROGRESS-ITERATOR");
        $ic42$ = SubLObjectFactory.makeKeyword("DATA");
        $ic43$ = SubLObjectFactory.makeString("Invalid slot ~S for construction function");
        $ic44$ = SubLObjectFactory.makeKeyword("BEGIN");
        $ic45$ = SubLObjectFactory.makeSymbol("S#27751", "CYC");
        $ic46$ = SubLObjectFactory.makeKeyword("SLOT");
        $ic47$ = SubLObjectFactory.makeKeyword("END");
        $ic48$ = SubLObjectFactory.makeSymbol("S#27753", "CYC");
        $ic49$ = SubLObjectFactory.makeKeyword("FREE");
        $ic50$ = SubLObjectFactory.makeString("<Invalid TACTIC ~s>");
        $ic51$ = SubLObjectFactory.makeString("<~a TACTIC ~a.~a.~a:(~a ~a)>");
        $ic52$ = SubLObjectFactory.makeSymbol("S#27712", "CYC");
        $ic53$ = SubLObjectFactory.makeSymbol("S#26082", "CYC");
        $ic54$ = SubLObjectFactory.makeSymbol("S#14902", "CYC");
        $ic55$ = SubLObjectFactory.makeKeyword("POSSIBLE");
        $ic56$ = SubLObjectFactory.makeString("proofy problem ~a is possible but has no tactics");
        $ic57$ = SubLObjectFactory.makeSymbol("S#26357", "CYC");
        $ic58$ = SubLObjectFactory.makeString("tactical productivity being referenced on ~S");
        $ic59$ = SubLObjectFactory.makeSymbol("S#26617", "CYC");
        $ic60$ = SubLObjectFactory.makeString("");
        $ic61$ = SubLObjectFactory.makeSymbol("S#26625", "CYC");
        $ic62$ = SubLObjectFactory.makeSymbol("S#26613", "CYC");
        $ic63$ = SubLObjectFactory.makeSymbol("S#27714", "CYC");
        $ic64$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#24185", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#24101", "CYC")), (SubLObject)SubLObjectFactory.makeSymbol("&BODY"), (SubLObject)SubLObjectFactory.makeSymbol("S#5", "CYC"));
        $ic65$ = SubLObjectFactory.makeSymbol("S#27450", "CYC");
        $ic66$ = SubLObjectFactory.makeSymbol("S#27763", "CYC");
        $ic67$ = ConsesLow.list((SubLObject)ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeSymbol("S#27807", "CYC"), SubLObjectFactory.makeSymbol("S#24101", "CYC"), SubLObjectFactory.makeSymbol("&KEY"), SubLObjectFactory.makeSymbol("S#127", "CYC"), SubLObjectFactory.makeSymbol("S#5846", "CYC"), SubLObjectFactory.makeSymbol("S#25691", "CYC"), SubLObjectFactory.makeSymbol("S#26474", "CYC"), SubLObjectFactory.makeSymbol("S#14781", "CYC"), SubLObjectFactory.makeSymbol("TYPE"), SubLObjectFactory.makeSymbol("S#26071", "CYC") }), (SubLObject)SubLObjectFactory.makeSymbol("&BODY"), (SubLObject)SubLObjectFactory.makeSymbol("S#5", "CYC"));
        $ic68$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("DONE"), (SubLObject)SubLObjectFactory.makeKeyword("STATUS"), (SubLObject)SubLObjectFactory.makeKeyword("COMPLETENESS"), (SubLObject)SubLObjectFactory.makeKeyword("PREFERENCE-LEVEL"), (SubLObject)SubLObjectFactory.makeKeyword("HL-MODULE"), (SubLObject)SubLObjectFactory.makeKeyword("TYPE"), (SubLObject)SubLObjectFactory.makeKeyword("PRODUCTIVITY"));
        $ic69$ = SubLObjectFactory.makeKeyword("ALLOW-OTHER-KEYS");
        $ic70$ = SubLObjectFactory.makeKeyword("DONE");
        $ic71$ = SubLObjectFactory.makeKeyword("PREFERENCE-LEVEL");
        $ic72$ = SubLObjectFactory.makeUninternedSymbol("US#6B70E19");
        $ic73$ = SubLObjectFactory.makeSymbol("CLET");
        $ic74$ = SubLObjectFactory.makeSymbol("DO-PROBLEM-TACTICS");
        $ic75$ = SubLObjectFactory.makeSymbol("PUNLESS");
        $ic76$ = SubLObjectFactory.makeKeyword("EXECUTED");
        $ic77$ = SubLObjectFactory.makeKeyword("DISCARDED");
        $ic78$ = SubLObjectFactory.makeKeyword("NON-DISCARDED");
        $ic79$ = SubLObjectFactory.makeKeyword("IN-PROGRESS");
        $ic80$ = SubLObjectFactory.makeKeyword("EXECUTED-OR-IN-PROGRESS");
        $ic81$ = SubLObjectFactory.makeSymbol("S#27583", "CYC");
        $ic82$ = SubLObjectFactory.makeSymbol("S#27798", "CYC");
        $ic83$ = SubLObjectFactory.makeSymbol("<");
        $ic84$ = SubLObjectFactory.makeSymbol("S#27339", "CYC");
        $ic85$ = SubLObjectFactory.makeKeyword("SKIP");
        $ic86$ = SubLObjectFactory.makeSymbol("S#27719", "CYC");
        $ic87$ = SubLObjectFactory.makeSymbol("S#27726", "CYC");
        $ic88$ = SubLObjectFactory.makeSymbol("S#27727", "CYC");
        $ic89$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#5232", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#27808", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#24101", "CYC"));
        $ic90$ = SubLObjectFactory.makeKeyword("REMOVAL-EXPAND");
        $ic91$ = SubLObjectFactory.makeKeyword("REMOVAL-OUTPUT-GENERATE");
        $ic92$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#27809", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#713", "CYC"));
        $ic93$ = SubLObjectFactory.makeKeyword("CONJUNCTIVE-REMOVAL-EXPAND");
        $ic94$ = SubLObjectFactory.makeKeyword("CONJUNCTIVE-REMOVAL-EXPAND-ITERATIVE");
        $ic95$ = SubLObjectFactory.makeKeyword("TRANSFORMATION-RULE-SELECT");
        $ic96$ = SubLObjectFactory.makeKeyword("META-STRUCTURAL");
        $ic97$ = SubLObjectFactory.makeString("Time to implement tactic-progress-done? for ~S");
        $ic98$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#27809", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#27810", "CYC"));
        $ic99$ = SubLObjectFactory.makeString("Time to implement tactic-progress-next for ~S");
        $ic100$ = SubLObjectFactory.makeString("Time to implement tactic-progress-finalize for ~S");
    }
    ...
    public static final class $sX24101_native extends SubLStructNative
    {
        ...
        static {
            structDecl = Structures.makeStructDeclNative((Class)$sX24101_native.class, module0365.$ic0$, module0365.$ic1$, module0365.$ic3$, module0365.$ic4$, new String[] { "$suid", "$problem", "$type", "$hl_module", "$completeness", "$preference_level_justification", "$productivity", "$original_productivity", "$status", "$progress_iterator", "$data" }, module0365.$ic5$, module0365.$ic6$, module0365.$ic7$);
        }
    }
...
/*
	...
	Decompiled from: G:\opt\CYC_JRTL_with_CommonLisp\platform\lib\cyc-oc4.0-unzipped/com/cyc/cycjava/cycl/module0365.class
	Total time: 370 ms
	 synthetic 
