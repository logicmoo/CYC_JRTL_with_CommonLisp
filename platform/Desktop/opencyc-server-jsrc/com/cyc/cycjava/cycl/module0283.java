...
public final class module0283 extends SubLTranslatedFile
{
    ...
    public static SubLObject f18756(final SubLObject var1) {
        ...
        return Equality.equal($g2626$.getDynamicValue(var2), var1.first());
    }
    
    public static SubLObject f18757(final SubLObject var1) {
        final SubLThread var2 = SubLProcess.currentSubLThread();
        return Equality.equal($g2627$.getDynamicValue(var2), var1.first());
    }
    
    public static SubLObject f18758(final SubLObject var1) {
        final SubLThread var2 = SubLProcess.currentSubLThread();
        return Equality.equal($g2628$.getDynamicValue(var2), var1.first());
    }
    
    public static SubLObject f18759(final SubLObject var3) {
        final SubLThread var4 = SubLProcess.currentSubLThread();
        return (SubLObject)ConsesLow.cons($g2626$.getDynamicValue(var4), var3);
    }
    
    public static SubLObject f18760(final SubLObject var3) {
        final SubLThread var4 = SubLProcess.currentSubLThread();
        return (SubLObject)ConsesLow.cons($g2627$.getDynamicValue(var4), var3);
    }
    
    public static SubLObject f18761(final SubLObject var4) {
        final SubLThread var5 = SubLProcess.currentSubLThread();
        return (SubLObject)ConsesLow.list($g2628$.getDynamicValue(var5), var4);
    }
    
    public static SubLObject f18762(final SubLObject var5) {
        return Mapping.mapcar((SubLObject)$ic5$, var5);
    }
    ...
    public static SubLObject f18764(final SubLObject var6, final SubLObject var7) {
        return Sequences.find(var6, var7, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)$ic6$), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f18767(final SubLObject var4) {
        ...
        if (NIL != f18758(var4)) {
            ...
            if (NIL == var6) {
                ...
                if (NIL != f18758(var7)) {
                    ...
                    cdestructuring_bind.destructuring_bind_must_consp(var14_15, var12_13, (SubLObject)$ic8$);
                    var8 = var14_15.first();
                    var14_15 = var14_15.rest();
                    if (NIL == var14_15) {
                        return f18767(var8);
                    }
                    cdestructuring_bind.cdestructuring_bind_error(var12_13, (SubLObject)$ic8$);
                }
                else {
                    if (NIL != f18756(var7)) {
                    ...
                    return Errors.error((SubLObject)$ic9$, var4);
                }
            }
            else {
        ...
        if (NIL != f18756(var4)) {
            return f18759(Mapping.mapcar((SubLObject)$ic10$, f18763(var4)));
        }
        if (NIL != f18757(var4)) {
            return f18760(Mapping.mapcar((SubLObject)$ic10$, f18763(var4)));
        }
        return Errors.error((SubLObject)$ic9$, var4);
    }
    ...
    public static SubLObject f18768(final SubLObject var4) {
        ...
        if (NIL != f18756(var4)) {
            return f18759(Mapping.mapcar((SubLObject)$ic11$, f18763(var4)));
        }
        if (NIL == f18757(var4)) {
            return Errors.error((SubLObject)$ic9$, var4);
        }
        final SubLObject var6 = f18763(var4);
        final SubLObject var7 = f18764($g2626$.getDynamicValue(var5), var6);
        if (NIL == var7) {
            return var4;
        }
        final SubLObject var8 = Sequences.delete(var7, var6, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        if (NIL != var8) {
            ...
            return f18759(Mapping.mapcar((SubLObject)$ic11$, var9));
        }
        return var7;
    }
    ...
    public static SubLObject f18770(final SubLObject var4) {
        ...
        if (NIL != f18757(var4)) {
            return f18760(Mapping.mapcar((SubLObject)$ic12$, f18763(var4)));
        }
        if (NIL == f18756(var4)) {
            return Errors.error((SubLObject)$ic9$, var4);
        }
        final SubLObject var6 = f18763(var4);
        final SubLObject var7 = f18764($g2627$.getDynamicValue(var5), var6);
        if (NIL == var7) {
            return var4;
        }
        final SubLObject var8 = Sequences.delete(var7, var6, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        if (NIL != var8) {
            ...
            return f18760(Mapping.mapcar((SubLObject)$ic12$, var9));
        }
        return var7;
    }
    ...
    public static SubLObject f18772(final SubLObject var4) {
        ...
        SubLObject var7 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var4, var4, (SubLObject)$ic13$);
        var6 = var4.first();
        final SubLObject var8 = var7 = var4.rest();
        var7 = Mapping.mapcar((SubLObject)$ic14$, var7);
        SubLObject var9 = (SubLObject)NIL;
        ...
        while (NIL != var10) {
            if (var11.isCons()) {
                ...
                cdestructuring_bind.destructuring_bind_must_consp(var31_32, var29_30, (SubLObject)$ic15$);
                var12 = var31_32.first();
                var31_32 = (var13 = var31_32.rest());
                if ($g2626$.getDynamicValue(var5).eql(var12)) {
        ...
        var7 = Sequences.delete_duplicates(var7, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        var7 = Sequences.delete($g2629$.getDynamicValue(var5), var7, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        if (NIL == var7) {
            return $g2629$.getDynamicValue(var5);
        }
        if (NIL != module0035.f1997(var7)) {
            SubLObject var38_39;
            final SubLObject var36_37 = var38_39 = var7;
            var11 = (SubLObject)NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var38_39, var36_37, (SubLObject)$ic7$);
            var11 = var38_39.first();
            var38_39 = var38_39.rest();
            if (NIL == var38_39) {
                return var11;
            }
            cdestructuring_bind.cdestructuring_bind_error(var36_37, (SubLObject)$ic7$);
            return (SubLObject)NIL;
        }
        else {
            if (NIL != module0004.f104($g2630$.getDynamicValue(var5), var7, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED)) {
                return $g2630$.getDynamicValue(var5);
            }
            if (NIL != f18775(var7)) {
                return $g2630$.getDynamicValue(var5);
            }
    ...
    public static SubLObject f18773(final SubLObject var4) {
        ...
        while (NIL != var10) {
            if (var11.isCons()) {
                ...
                SubLObject var12 = (SubLObject)NIL;
                SubLObject var13 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var44_45, var42_43, (SubLObject)$ic15$);
                var12 = var44_45.first();
                var44_45 = (var13 = var44_45.rest());
                if ($g2627$.getDynamicValue(var5).eql(var12)) {
        ...
        var7 = Sequences.nreverse(var9);
        var7 = Sequences.delete_duplicates(var7, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        var7 = Sequences.delete($g2630$.getDynamicValue(var5), var7, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        if (NIL == var7) {
            return $g2630$.getDynamicValue(var5);
        }
        if (NIL != module0035.f1997(var7)) {
        ...
        if (NIL != module0004.f104($g2629$.getDynamicValue(var5), var7, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED)) {
            return $g2629$.getDynamicValue(var5);
        }
        if (NIL != f18775(var7)) {
            return $g2629$.getDynamicValue(var5);
    ...
    public static SubLObject f18774(final SubLObject var4) {
        ...
        SubLObject var6 = (SubLObject)NIL;
        SubLObject var7 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var4, var4, (SubLObject)$ic16$);
        var6 = var4.first();
        SubLObject var8 = var4.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var8, var4, (SubLObject)$ic16$);
        var7 = var8.first();
        var8 = var8.rest();
        if (NIL != var8) {
        ...
        var7 = f18771(var7);
        if (var7.equal($g2629$.getDynamicValue(var5))) {
            return $g2630$.getDynamicValue(var5);
        }
        if (var7.equal($g2630$.getDynamicValue(var5))) {
            return $g2629$.getDynamicValue(var5);
        }
        if (var7.isCons() && $g2628$.getDynamicValue(var5).eql(var7.first())) {
    ...
    public static SubLObject f18775(final SubLObject var7) {
        ...
        SubLObject var8 = (SubLObject)NIL;
        SubLObject var9 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var7, var7, (SubLObject)$ic17$);
        var8 = var7.first();
    ...
    public static SubLObject f18776(final SubLObject var54, final SubLObject var55) {
        ...
        if (var54.isCons() && $g2628$.getDynamicValue(var56).eql(var54.first())) {
            return Equality.equal(conses_high.second(var54), var55);
        }
        if (var55.isCons() && $g2628$.getDynamicValue(var56).eql(var55.first())) {
    ...
    public static SubLObject f18778() {
        $g2626$ = SubLFiles.defparameter("S#21357", $ic0$);
        $g2627$ = SubLFiles.defparameter("S#21358", $ic1$);
        $g2628$ = SubLFiles.defparameter("S#21359", $ic2$);
        $g2629$ = SubLFiles.defparameter("S#21360", $ic3$);
        $g2630$ = SubLFiles.defparameter("S#21361", $ic4$);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g2629$ = null;
        $g2630$ = null;
        $ic0$ = constant_handles_oc.f8479((SubLObject)makeString("and"));
        ...
        $ic4$ = constant_handles_oc.f8479((SubLObject)makeString("False"));
        $ic5$ = makeSymbol("S#21341", "CYC");
        $ic6$ = makeSymbol("S#21345", "CYC");
        $ic7$ = ConsesLow.list((SubLObject)makeSymbol("S#202", "CYC"));
        $ic8$ = ConsesLow.list((SubLObject)makeSymbol("S#21362", "CYC"));
        $ic9$ = makeString("Can't handle ~S");
        $ic10$ = makeSymbol("S#21348", "CYC");
        $ic11$ = makeSymbol("S#21349", "CYC");
        $ic12$ = makeSymbol("S#21350", "CYC");
        $ic13$ = (SubLList)ConsesLow.cons((SubLObject)makeSymbol("S#166", "CYC"), (SubLObject)makeSymbol("S#105", "CYC"));
        $ic14$ = makeSymbol("S#21351", "CYC");
        $ic15$ = (SubLList)ConsesLow.cons((SubLObject)makeSymbol("S#21363", "CYC"), (SubLObject)makeSymbol("S#21364", "CYC"));
        $ic16$ = ConsesLow.list((SubLObject)makeSymbol("S#166", "CYC"), (SubLObject)makeSymbol("S#202", "CYC"));
        $ic17$ = (SubLList)ConsesLow.cons((SubLObject)makeSymbol("S#21365", "CYC"), (SubLObject)makeSymbol("S#21366", "CYC"));
    }
}
