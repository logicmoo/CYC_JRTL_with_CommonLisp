...
public final class module0758 extends SubLTranslatedFile
{
            ...
            if (module0758.NIL == module0756.f47479(var1)) {
                if (module0758.NIL != module0756.f47519(var1)) {
                    ...
                    try {
                        ...
                        if (module0758.NIL != module0756.f47479(var21) && module0758.NIL == module0038.f2684(module0756.f47480(var21, (SubLObject)module0758.NIL), constant_reader_oc.f8495())) {
    ...
    public static SubLObject f47991(final SubLObject var236, final SubLObject var237) {
        ...
        else if (module0758.NIL != module0035.f2002(var239, (SubLObject)module0758.TWO_INTEGER, (SubLObject)module0758.UNPROVIDED) && module0758.NIL != module0581.f35655(var239, constant_reader_oc.f8495(), (SubLObject)module0758.UNPROVIDED) && (module0758.NIL == module0269.f17710(module0756.f47487(var237, (SubLObject)module0758.UNPROVIDED)) || module0758.NIL == module0751.f46684(module0756.f47487(var237, (SubLObject)module0758.UNPROVIDED), module0758.$ic191$, (SubLObject)module0758.UNPROVIDED))) {
    ...
    static {
        ...
        $ic32$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PossessivePhrase"));
        ...
        $ic47$ = (SubLList)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheList")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        ...
        $ic51$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CurrentListItemFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("TEST"), (SubLObject)SubLObjectFactory.makeSymbol("S#52372", "CYC")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("TEST"), (SubLObject)SubLObjectFactory.makeSymbol("NON-NEGATIVE-INTEGER-P")));
        ...
        $ic81$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheNthFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SententialConstituent")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        ...
        $ic107$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PhraseFormFn"));
        ...
        $ic116$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("atomicSymbol"));
        $ic117$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?SYMBOL"));
        $ic118$ = SubLObjectFactory.makeKeyword("SYMBOL");
        $ic119$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nameString"));
        $ic120$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PhraseFn-Bar1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Noun")));
        $ic121$ = SubLObjectFactory.makeSymbol("?CODE");
        $ic122$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("htmlGlyphCode"));
        $ic123$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?CODE"));
        $ic124$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("htmlStringVersionOfCharacter"));
        $ic125$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("termStrings"));
        ...
        $ic146$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Noun"));
        $ic147$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("plural-Generic"));
        $ic148$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("singular-Generic"));
        $ic149$ = SubLObjectFactory.makeString("~&Setting conjunctive agr of ~S to ~S");
        $ic150$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("No-NLAttr"));
        $ic151$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Determiner"));
        ...
        $ic156$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Verb"));
        ...
        $ic161$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MeasurableQuantity"));
        $ic162$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("adjStrings"));
        $ic163$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Adjective"));
        ...
        $ic166$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("untensed"));
        ...
        $ic170$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("tensed"));
        ...
        $ic174$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BareForm-NLAttr"));
        ...
        $ic185$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nonSingular-Generic"));
        ...
        $ic191$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ExistingStuffType"));
        $ic192$ = SubLObjectFactory.makeString("~&Using English-specific indefinite determiner hack: ~S with Nbar ~S.~%");
        $ic193$ = ConsesLow.list((SubLObject)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Thing")), (SubLObject)SubLObjectFactory.makeString("something")), (SubLObject)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Person")), (SubLObject)SubLObjectFactory.makeString("someone")), (SubLObject)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Place")), (SubLObject)SubLObjectFactory.makeString("someplace")));
        $ic194$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("singular")));
        ...
        $ic197$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nounStrings"));
        ...
        $ic200$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Pronoun"));
        $ic201$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("verbStrings"));
        $ic202$ = SubLObjectFactory.makeSymbol("S#48593", "CYC");
        $ic203$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("singularVerb-Generic"));
        $ic204$ = SubLObjectFactory.makeString("~&Subject agr: ~S~%");
        $ic205$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SecondPerson-NLAttr"));
        $ic206$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("secondPersonSg-Generic"));
        $ic207$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("secondPersonSg-Present"));
        $ic208$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FirstPerson-NLAttr"));
        $ic209$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("firstPersonSg-Generic"));
        $ic210$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("firstPersonSg-Present"));
        ...
        $ic217$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nonPlural-Generic"));
        $ic218$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("pluralVerb-Generic"));
        $ic219$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thirdPersonSg-Generic"));
        ...
        $ic225$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PhraseFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Determiner")));
