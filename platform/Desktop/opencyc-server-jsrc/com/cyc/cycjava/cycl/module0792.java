...
public final class module0792 extends SubLTranslatedFile
{
    ...
    public static SubLObject f50558(final SubLObject var17, final SubLObject var24, final SubLObject var19, SubLObject var16) {
        ...
        while (module0792.NIL != var26) {
            assert module0792.NIL != assertion_handles_oc.f11035(var27) : var27;
            var26 = var26.rest();
            var27 = var26.first();
        }
    ...
    public static SubLObject f50565(final SubLObject var17, final SubLObject var51, final SubLObject var39, final SubLObject var64, final SubLObject var16, final SubLObject var71, final SubLObject var76, final SubLObject var10, final SubLObject var68) {
        ...
        while (module0792.NIL != var78) {
            assert module0792.NIL != assertion_handles_oc.f11035(var79) : var79;
            var78 = var78.rest();
            var79 = var78.first();
        }
    ...
    public static SubLObject f50574(final SubLObject var121) {
        ...
        try {
            ...
            try {
                ...
                module0021.f1149(oc_dumper.f37935());
    ...
    public static SubLObject f50621(final SubLObject var278) {
        ...
        if (module0792.NIL != constant_handles_oc.f8449(var278)) {
        ...
        if (module0792.NIL != assertion_handles_oc.f11035(var278)) {
    ...
    public static SubLObject f50689(final SubLObject var105, final SubLObject var125) {
        ...
        var128 = var128.rest();
        if (module0792.NIL == var128) {
            if (module0792.NIL != assertion_handles_oc.f11035(var126)) {
                final SubLObject var130 = var126;
                PrintLow.format(var125, (SubLObject)module0792.$ic251$, assertion_handles_oc.f11025(var130));
    ...
    public static SubLObject f50692(final SubLObject var140, final SubLObject var125) {
        if (module0792.NIL != assertion_handles_oc.f11035(var140)) {
            PrintLow.format(var125, (SubLObject)module0792.$ic253$, assertion_handles_oc.f11025(var140));
        }
        ...
        else if (module0792.NIL != constant_handles_oc.f8449(var140)) {
            PrintLow.format(var125, (SubLObject)module0792.$ic255$, constants_high_oc.f10749(var140));
        }
    ...
    public static SubLObject f50711(final SubLObject var125, final SubLObject var436) {
        ...
        if (module0792.NIL == var440) {
            if (module0792.$g6315$.getDynamicValue(var437) == module0792.$ic201$) {
                ...
                print_high.princ(f50719(Sequences.cconcatenate((SubLObject)module0792.$ic322$, constants_high_oc.f10743(var439))), var125);
            }
        }
        else {
    ...
    public static SubLObject f50732(final SubLObject var125, final SubLObject var140, final SubLObject var516) {
        if (module0792.NIL != constant_handles_oc.f8449(var140)) {
    ...
    private static SubLObject _constant_360_initializer() {
        return (SubLObject)ConsesLow.list(new SubLObject[] { ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BaseKB")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Individual")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BaseKB")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("disjointWith")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Baseball-Ball")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Cube")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ProductUsageMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("typePrimaryFunction")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Bathtub")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TakingABath")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("deviceUsed")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AnimalActivitiesMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("typeBehaviorIncapable")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InanimateObject")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AtLeastPartiallyMentalEvent")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("doneBy")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UnitedStatesSocialLifeMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genls")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HumanInfant")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HumanPreSchoolageChild")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IndustryMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("subOrganizations")), (SubLObject)SubLObjectFactory.makeSymbol("?Z"), (SubLObject)SubLObjectFactory.makeSymbol("?X")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("hasMembers")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Y"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("hasMembers")), (SubLObject)SubLObjectFactory.makeSymbol("?Z"), (SubLObject)SubLObjectFactory.makeSymbol("?Y")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ClothingGMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Garment"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Bluish")))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("WorldCulturalGeographyDataMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("perpetrator")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BombingOfIraqEvent")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UnitedStatesOfAmerica"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Person"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("responsibleFor")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BombingOfIraqEvent"))))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("disjointWith")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BlowDryer")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Weapon")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("GolfCart"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("not")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ArmoredVehicle")))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("or")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Alice")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Animal"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Alice")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Vegetable-Plant"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Alice")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Mineral"))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ArtifactGVocabularyMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FireplacePoker"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("productTypeManufacturedIn")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Foundry-Building"))))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("parts")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Y")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("parts")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), (SubLObject)SubLObjectFactory.makeSymbol("?Z"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("parts")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Z")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("covers-Generic")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Y")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("not")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("transformedInto")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), (SubLObject)SubLObjectFactory.makeSymbol("?X"))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("anatomicalParts")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FruitFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BananaTree"))), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BananaTree")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("not")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("performedBy")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Y")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ArrestingSomeone"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PrivateSectorEmployee")))))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Thinking"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("doneBy")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Y"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomethingExisting"))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CIAWorldFactbook1997Mt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("not")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("permanentMemberOfOrganization")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SouthKorea")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UNSecurityCouncil"))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ScatteredSpaceRegion"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("convexSpaceRegionOf")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), (SubLObject)SubLObjectFactory.makeSymbol("?X")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists")), (SubLObject)SubLObjectFactory.makeSymbol("?Z"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("convexSpaceRegionOf")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Z")))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("componentPartOfSpaceRegion")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), (SubLObject)SubLObjectFactory.makeSymbol("?X")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ProductPhysicalCharacteristicsMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PhoneAnsweringMachineCombo"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("uniformColorOfObject")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Y")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?Z"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ResetButton"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("surfaceParts")), (SubLObject)SubLObjectFactory.makeSymbol("?Z"), (SubLObject)SubLObjectFactory.makeSymbol("?X"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("uniformColorOfObject")), (SubLObject)SubLObjectFactory.makeSymbol("?Z"), (SubLObject)SubLObjectFactory.makeSymbol("?Y")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PatternsOfGlobalTerrorism1998Mt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?COMP2"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IBMNetfinityComputer"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?COMP1"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SunMachine"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equivalentHosts")), (SubLObject)SubLObjectFactory.makeSymbol("?COMP1"), (SubLObject)SubLObjectFactory.makeSymbol("?COMP2")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("doneBy")), (SubLObject)SubLObjectFactory.makeSymbol("?CRACK"), (SubLObject)SubLObjectFactory.makeSymbol("?HACKER")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?CRACK"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Cracking-CompromisingSecurity"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("securityCompromised")), (SubLObject)SubLObjectFactory.makeSymbol("?CRACK"), (SubLObject)SubLObjectFactory.makeSymbol("?COMP1"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists")), (SubLObject)SubLObjectFactory.makeSymbol("?ACTION"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("damages")), (SubLObject)SubLObjectFactory.makeSymbol("?ACTION"), (SubLObject)SubLObjectFactory.makeSymbol("?COMP2"))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NaiveInformationMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?CUP"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Demitasse"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?COFFEE"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Coffee-Hot"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("in-ContOpen")), (SubLObject)SubLObjectFactory.makeSymbol("?COFFEE"), (SubLObject)SubLObjectFactory.makeSymbol("?CUP"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("orientation")), (SubLObject)SubLObjectFactory.makeSymbol("?CUP"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RightSideUp"))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CurrentWorldDataCollectorMt-NonHomocentric")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("typeBehaviorIncapable")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Can")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Cancan-StyleOfDance")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("performedBy")))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CurrentWorldDataCollectorMt-NonHomocentric")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("not")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceExists")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("biologicalFather")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Cyc")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MaleAnimal"))))), ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TKBSourceSpindleCollectorMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists")), (SubLObject)SubLObjectFactory.makeSymbol("?TERRORIST"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?TERRORIST"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Terrorist"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("birthPlace")), (SubLObject)SubLObjectFactory.makeSymbol("?TERRORIST"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ContinentOfAsia")))))) });
    }
    ...
    static {
        ...
        $ic14$ = ConsesLow.list(new SubLObject[] { constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Quote")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EscapeQuote")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("QuasiQuote")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SubLQuoteFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ExpandSubLFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completeExtentEnumerable")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completelyEnumerableCollection")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("unknownSentence")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("evaluate")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Nothing")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CollectionDifferenceFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("reformulatorEquiv")) });
        ...
        $ic62$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EverythingPSC"));
        ...
        $ic80$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlMt"));
        $ic81$ = SubLObjectFactory.makeSymbol("?MT");
        $ic82$ = SubLObjectFactory.makeKeyword("MT-VISIBLE");
        $ic83$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtVisible"));
        ...
        $ic101$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("resultIsaArg"));
        $ic102$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RelationAllExistsFn"));
        $ic103$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?TERM"), (SubLObject)SubLObjectFactory.makeSymbol("?INDEP-COL")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExists")), (SubLObject)SubLObjectFactory.makeSymbol("?PRED"), (SubLObject)SubLObjectFactory.makeSymbol("?INDEP-COL"), (SubLObject)SubLObjectFactory.makeSymbol("?DEP-COL"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RelationAllExistsFn")), (SubLObject)SubLObjectFactory.makeSymbol("?TERM"), (SubLObject)SubLObjectFactory.makeSymbol("?PRED"), (SubLObject)SubLObjectFactory.makeSymbol("?INDEP-COL"), (SubLObject)SubLObjectFactory.makeSymbol("?DEP-COL")), (SubLObject)SubLObjectFactory.makeSymbol("?DEP-COL")));
        $ic104$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RelationExistsAllFn"));
        $ic105$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?TERM"), (SubLObject)SubLObjectFactory.makeSymbol("?INDEP-COL")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsAll")), (SubLObject)SubLObjectFactory.makeSymbol("?PRED"), (SubLObject)SubLObjectFactory.makeSymbol("?DEP-COL"), (SubLObject)SubLObjectFactory.makeSymbol("?INDEP-COL"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RelationExistsAllFn")), (SubLObject)SubLObjectFactory.makeSymbol("?TERM"), (SubLObject)SubLObjectFactory.makeSymbol("?PRED"), (SubLObject)SubLObjectFactory.makeSymbol("?DEP-COL"), (SubLObject)SubLObjectFactory.makeSymbol("?INDEP-COL")), (SubLObject)SubLObjectFactory.makeSymbol("?DEP-COL")));
        ...
        $ic109$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("expansion"));
        ...
        $ic127$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-UnhandledFn"));
        ...
        $ic129$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlPreds"));
        $ic130$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#750", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#751", "CYC"));
        $ic131$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("negationPreds"));
        $ic132$ = ConsesLow.list((SubLObject)module0792.NIL);
        $ic133$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg1Isa"));
        $ic134$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2Isa"));
        $ic135$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg3Isa"));
        $ic136$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg4Isa"));
        $ic137$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg5Isa"));
        $ic138$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg6Isa"));
        $ic139$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa"));
        $ic140$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg1Genl"));
        $ic141$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2Genl"));
        $ic142$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg3Genl"));
        $ic143$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg4Genl"));
        $ic144$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg5Genl"));
        $ic145$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg6Genl"));
        $ic146$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genls"));
        $ic147$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("resultIsa"));
        $ic148$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("resultGenl"));
        $ic149$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("disjointWith"));
        $ic150$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlInverse"));
        $ic151$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("True"));
        ...
        $ic162$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equiv"));
        $ic163$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-PredicateFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)module0792.TWO_INTEGER);
        $ic164$ = SubLObjectFactory.makeSymbol("?X");
        $ic165$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-PredicateFn"));
        $ic166$ = ConsesLow.list((SubLObject)module0792.ONE_INTEGER);
        $ic167$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?X"));
        $ic168$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies"));
        $ic169$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-PredicateFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtVisible")), (SubLObject)module0792.ONE_INTEGER), (SubLObject)SubLObjectFactory.makeSymbol("?SPEC-MT")), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-PredicateFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlMt")), (SubLObject)module0792.TWO_INTEGER), (SubLObject)SubLObjectFactory.makeSymbol("?SPEC-MT"), (SubLObject)SubLObjectFactory.makeSymbol("?GENL-MT"))), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-PredicateFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtVisible")), (SubLObject)module0792.ONE_INTEGER), (SubLObject)SubLObjectFactory.makeSymbol("?GENL-MT")));
        ...
        $ic171$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-PredicateFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtVisible")), (SubLObject)module0792.ONE_INTEGER);
        ...
        $ic193$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("transitiveViaArg"));
        $ic194$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("transitiveViaArgInverse"));
        ...
        $ic199$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("natFunction"));
        $ic200$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("natArgument"));
        $ic201$ = SubLObjectFactory.makeKeyword("SET-THEORY");
        $ic202$ = SubLObjectFactory.makeKeyword("SEQUENCE-VAR");
        $ic203$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("different"));
        $ic204$ = SubLObjectFactory.makeSymbol("S#55172", "CYC");
        $ic205$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equals"));
        ...
        $ic213$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("memberOfSet"));
        $ic214$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SetifyArgumentFn"));
        $ic215$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist"));
        $ic216$ = SubLObjectFactory.makeKeyword("IST");
        $ic217$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equals")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equalSymbols")));
        ...
        $ic222$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Kappa"));
        ...
        $ic231$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Lambda"));
        $ic232$ = SubLObjectFactory.makeKeyword("LAMBDA");
        $ic233$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-AtomicTermFn"));
        $ic234$ = SubLObjectFactory.makeSymbol("INTEGERP");
        $ic235$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-FunctionFn"));
        $ic236$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-StringFn"));
        $ic237$ = SubLObjectFactory.makeKeyword("DWIM-TO-DISTINCT-CONSTANTS");
        $ic238$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-StringConstantFn"));
        $ic239$ = SubLObjectFactory.makeKeyword("DWIM-TO-SINGLE-CONSTANT");
        $ic240$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Canonical_String"));
        $ic241$ = SubLObjectFactory.makeString("unexpected string handling directive ~s");
        $ic242$ = SubLObjectFactory.makeSymbol("NUMBERP");
        $ic243$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-NumberFn"));
        $ic244$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FOL-NumberConstantFn"));
        ...
        $ic299$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and"));
        $ic300$ = SubLObjectFactory.makeString(" & ");
        $ic301$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("or"));
        $ic302$ = SubLObjectFactory.makeString(" | ");
        $ic303$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("not"));
        $ic304$ = SubLObjectFactory.makeString("(~");
        $ic305$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists"));
        ...
        $ic308$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("forAll"));
        $ic309$ = SubLObjectFactory.makeString("(! [~a] : ");
        $ic310$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equalSymbols"));
        ...
        $ic359$ = ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CurrentWorldDataCollectorMt-NonHomocentric")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Individual")))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CurrentWorldDataCollectorMt-NonHomocentric")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("subOrganizations")), (SubLObject)SubLObjectFactory.makeSymbol("?Z"), (SubLObject)SubLObjectFactory.makeSymbol("?X")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("hasMembers")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Y"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("hasMembers")), (SubLObject)SubLObjectFactory.makeSymbol("?Z"), (SubLObject)SubLObjectFactory.makeSymbol("?Y")))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CurrentWorldDataCollectorMt-NonHomocentric")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("typePrimaryFunction")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Bathtub")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TakingABath")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("deviceUsed")))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CurrentWorldDataCollectorMt-NonHomocentric")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("typeBehaviorIncapable")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Doughnut")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Talking")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("doneBy")))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CurrentWorldDataCollectorMt-NonHomocentric")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("parts")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Y")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("parts")), (SubLObject)SubLObjectFactory.makeSymbol("?Y"), (SubLObject)SubLObjectFactory.makeSymbol("?Z"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("parts")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), (SubLObject)SubLObjectFactory.makeSymbol("?Z")))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CurrentWorldDataCollectorMt-NonHomocentric")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("disjointWith")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Baseball-Ball")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Cube")))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CurrentWorldDataCollectorMt-NonHomocentric")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("disjointWith")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HumanInfant")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Doctor-Medical")))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TerrestrialFrameOfReferenceMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("implies")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?CUP"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CoffeeCup"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?COFFEE"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Coffee-Hot"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("in-ContOpen")), (SubLObject)SubLObjectFactory.makeSymbol("?COFFEE"), (SubLObject)SubLObjectFactory.makeSymbol("?CUP"))), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("orientation")), (SubLObject)SubLObjectFactory.makeSymbol("?CUP"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RightSideUp"))))));
