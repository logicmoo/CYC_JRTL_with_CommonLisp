...
public final class module0616 extends SubLTranslatedFile
{
    ...
    public static SubLObject f37785(final SubLObject var2, final SubLObject var3, final SubLObject var10, final SubLObject var4, final SubLObject var5) {
        ...
        if (module0616.NIL == assertion_handles_oc.f11041(var17, (SubLObject)module0616.UNPROVIDED)) {
    ...
    public static SubLObject f37786(final SubLObject var2, final SubLObject var3, final SubLObject var9, final SubLObject var4, final SubLObject var5) {
        ...
        var10.resetMultipleValues();
        if (module0616.NIL != var18 || module0616.NIL != oc_deduction_handles.f11659(var17)) {
    ...
    public static SubLObject f37796(final SubLObject var1, final SubLObject var2, final SubLObject var3, final SubLObject var4, final SubLObject var5) {
        ...
        if (module0616.NIL != constant_handles_oc.f8449(var7) && module0616.NIL != module0126.f8389(var8) && !var8.equal(var9)) {
    ...
    public static SubLObject f37797(final SubLObject var1, final SubLObject var2, final SubLObject var3) {
        ...
        if (module0616.NIL != constant_handles_oc.f8449(var5) && module0616.NIL != module0126.f8389(var6) && var6.equal(var7)) {
            return (SubLObject)module0616.NIL;
        }
        return (SubLObject)module0616.NIL;
    }
    ...
    static {
        ...
        $ic24$ = ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeKeyword("PRETTY-NAME"), SubLObjectFactory.makeString("ist"), SubLObjectFactory.makeKeyword("ARGUMENT-TYPE"), SubLObjectFactory.makeKeyword("ARGUMENT"), SubLObjectFactory.makeKeyword("PREDICATE"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), SubLObjectFactory.makeKeyword("APPLICABILITY"), SubLObjectFactory.makeSymbol("S#41392", "CYC"), SubLObjectFactory.makeKeyword("INCOMPLETENESS"), SubLObjectFactory.makeSymbol("S#41393", "CYC"), SubLObjectFactory.makeKeyword("ADD"), SubLObjectFactory.makeSymbol("S#41394", "CYC"), SubLObjectFactory.makeKeyword("REMOVE"), SubLObjectFactory.makeSymbol("S#41395", "CYC"), SubLObjectFactory.makeKeyword("REMOVE-ALL"), SubLObjectFactory.makeSymbol("S#41396", "CYC") });
        $ic25$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist"));
        $ic26$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        ...
        $ic29$ = ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeKeyword("PRETTY-NAME"), SubLObjectFactory.makeString("constantName"), SubLObjectFactory.makeKeyword("ARGUMENT-TYPE"), SubLObjectFactory.makeKeyword("ARGUMENT"), SubLObjectFactory.makeKeyword("PREDICATE"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("constantName")), SubLObjectFactory.makeKeyword("APPLICABILITY"), SubLObjectFactory.makeSymbol("S#41397", "CYC"), SubLObjectFactory.makeKeyword("INCOMPLETENESS"), SubLObjectFactory.makeSymbol("S#41398", "CYC"), SubLObjectFactory.makeKeyword("ADD"), SubLObjectFactory.makeSymbol("S#41399", "CYC"), SubLObjectFactory.makeKeyword("REMOVE"), SubLObjectFactory.makeSymbol("S#41400", "CYC"), SubLObjectFactory.makeKeyword("REMOVE-ALL"), SubLObjectFactory.makeSymbol("S#41400", "CYC") });
        $ic30$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("constantName"));
        $ic31$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("constantName")), (SubLObject)SubLObjectFactory.makeKeyword("CONSTANT"), (SubLObject)SubLObjectFactory.makeKeyword("STRING"));
        $ic32$ = SubLObjectFactory.makeKeyword("ASSERTION-DIRECTION");
        $ic33$ = ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeKeyword("PRETTY-NAME"), SubLObjectFactory.makeString("assertionDirection"), SubLObjectFactory.makeKeyword("ARGUMENT-TYPE"), SubLObjectFactory.makeKeyword("ARGUMENT"), SubLObjectFactory.makeKeyword("PREDICATE"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("assertionDirection")), SubLObjectFactory.makeKeyword("APPLICABILITY"), SubLObjectFactory.makeSymbol("S#41401", "CYC"), SubLObjectFactory.makeKeyword("INCOMPLETENESS"), SubLObjectFactory.makeSymbol("S#41402", "CYC"), SubLObjectFactory.makeKeyword("ADD"), SubLObjectFactory.makeSymbol("S#41403", "CYC"), SubLObjectFactory.makeKeyword("REMOVE"), SubLObjectFactory.makeSymbol("S#41404", "CYC"), SubLObjectFactory.makeKeyword("REMOVE-ALL"), SubLObjectFactory.makeSymbol("S#41404", "CYC") });
        $ic34$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("assertionDirection"));
        $ic35$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("assertionDirection")), (SubLObject)SubLObjectFactory.makeKeyword("ASSERTION"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("TEST"), (SubLObject)SubLObjectFactory.makeSymbol("S#35404", "CYC")));
        $ic36$ = SubLObjectFactory.makeKeyword("INDEXICAL-THE-USER");
        $ic37$ = ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeKeyword("PRETTY-NAME"), SubLObjectFactory.makeString("indexicalReferent TheUser"), SubLObjectFactory.makeKeyword("ARGUMENT-TYPE"), SubLObjectFactory.makeKeyword("ARGUMENT"), SubLObjectFactory.makeKeyword("PREDICATE"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("indexicalReferent")), SubLObjectFactory.makeKeyword("APPLICABILITY"), SubLObjectFactory.makeSymbol("S#41405", "CYC"), SubLObjectFactory.makeKeyword("INCOMPLETENESS"), SubLObjectFactory.makeSymbol("S#41406", "CYC"), SubLObjectFactory.makeKeyword("ADD"), SubLObjectFactory.makeSymbol("S#41407", "CYC"), SubLObjectFactory.makeKeyword("REMOVE"), SubLObjectFactory.makeSymbol("S#41408", "CYC"), SubLObjectFactory.makeKeyword("REMOVE-ALL"), SubLObjectFactory.makeSymbol("S#41408", "CYC") });
        $ic38$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("indexicalReferent"));
        $ic39$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("indexicalReferent")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheUser")), (SubLObject)SubLObjectFactory.makeKeyword("FULLY-BOUND"));
        $ic40$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheUser"));
        $ic41$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("performSubL"));
        $ic42$ = SubLObjectFactory.makeKeyword("PERFORM-SUBL");
        $ic43$ = ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeKeyword("PRETTY-NAME"), SubLObjectFactory.makeString("performSubL"), SubLObjectFactory.makeKeyword("ARGUMENT-TYPE"), SubLObjectFactory.makeKeyword("ARGUMENT"), SubLObjectFactory.makeKeyword("PREDICATE"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("performSubL")), SubLObjectFactory.makeKeyword("APPLICABILITY"), SubLObjectFactory.makeSymbol("S#41409", "CYC"), SubLObjectFactory.makeKeyword("INCOMPLETENESS"), SubLObjectFactory.makeSymbol("S#41410", "CYC"), SubLObjectFactory.makeKeyword("ADD"), SubLObjectFactory.makeSymbol("S#41411", "CYC"), SubLObjectFactory.makeKeyword("REMOVE"), SubLObjectFactory.makeSymbol("S#41412", "CYC"), SubLObjectFactory.makeKeyword("REMOVE-ALL"), SubLObjectFactory.makeSymbol("S#41412", "CYC") });
        $ic44$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("performSubL")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("OR"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SubLQuoteFn")), (SubLObject)SubLObjectFactory.makeKeyword("FULLY-BOUND")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ExpandSubLFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("AND"), (SubLObject)SubLObjectFactory.makeKeyword("FULLY-BOUND"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("TEST"), (SubLObject)SubLObjectFactory.makeSymbol("LISTP"))), (SubLObject)SubLObjectFactory.makeKeyword("FULLY-BOUND"))));
