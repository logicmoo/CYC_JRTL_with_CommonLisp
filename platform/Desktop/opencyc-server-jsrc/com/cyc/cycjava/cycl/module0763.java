...
public final class module0763 extends SubLTranslatedFile
{
    ...
    public static SubLObject f48247(final SubLObject var177) {
        final SubLObject var178 = constants_high_oc.f10737((SubLObject)module0763.$ic49$);
        SubLObject var179 = (SubLObject)module0763.NIL;
        if (module0763.NIL != constant_handles_oc.f8463(var178, (SubLObject)module0763.UNPROVIDED)) {
    ...
    public static SubLObject f48240(final SubLObject var145, SubLObject var142) {
        ...
        assert module0763.NIL != assertion_handles_oc.f11035(var145) : var145;
    ...
    public static SubLObject f48268(SubLObject var256, final SubLObject var253, final SubLObject var251, final SubLObject var250) {
        ...
        if (var253.numE((SubLObject)module0763.ONE_INTEGER) && (var251.equalp(module0763.$ic70$) || var251.equalp(module0763.$ic71$))) {
            ...
            if (!var253.numE((SubLObject)module0763.ONE_INTEGER) || !var251.equalp(module0763.$ic74$) || module0763.NIL == module0202.f12590(var256)) {
                ...
                else if (module0763.NIL != constant_handles_oc.f8449(var256)) {
                    SubLObject var263;
    ...
    public static SubLObject f48282(final SubLObject var171, SubLObject var222) {
        ...
        else if (module0763.NIL != module0210.f13576(var223, (SubLObject)module0763.UNPROVIDED) && module0205.f13364(var223).eql(constants_high_oc.f10737((SubLObject)module0763.$ic139$))) {
    ...
    public static SubLObject f48395(final SubLObject var585, SubLObject var577) {
        ...
        assert module0763.NIL != constant_handles_oc.f8449(var585) : var585;
    ...
    static {
        ...
        $ic9$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLTemplateGenerationPredicate"));
        ...
        $ic28$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Relation"));
        ...
        $ic40$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Kappa")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        $ic41$ = SubLObjectFactory.makeSymbol("S#52722", "CYC");
        $ic42$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Kappa")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#4", "CYC")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#33867", "CYC")));
        $ic43$ = SubLObjectFactory.makeSymbol("S#33867", "CYC");
        $ic44$ = SubLObjectFactory.makeSymbol("S#4", "CYC");
        $ic45$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TermParaphraseFn"));
        ...
        $ic52$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InferencePSC"));
        ...
        $ic63$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RepeatForSubsequentArgsFn"));
        $ic64$ = SubLObjectFactory.makeSymbol("S#52733", "CYC");
        $ic65$ = (SubLList)ConsesLow.cons(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestBindingsPhraseFn")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"));
        $ic66$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheNthFn"));
        ...
        $ic70$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ConditionalPhraseFn"));
        $ic71$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestBindingsPhraseFn"));
        ...
        $ic74$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PhraseFormFn"));
        $ic75$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SententialConstituent"));
        $ic76$ = SubLObjectFactory.makeSymbol("S#51007", "CYC");
        $ic77$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("LexicalWord"));
        ...
        $ic80$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argIsa"));
        $ic81$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("GeneralLexiconMt"));
        ...
        $ic87$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genTemplate"));
        $ic88$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genTemplate-QuerySentence"));
        $ic89$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genTemplate-Constrained"));
        $ic90$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("detailedIsaParaphrase"));
        ...
        $ic96$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("GenTemplateRecipeOmitsArgFn"));
        ...
        $ic100$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TypeClarifyingPhraseFn"));
        $ic101$ = ConsesLow.list((SubLObject)module0763.ONE_INTEGER);
        $ic102$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestSymbolPhraseFn"));
        $ic103$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PercentParaphraseFn"));
        $ic104$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestCycLPhraseFn"));
        $ic105$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ConcatenatePhrasesFn"));
        $ic106$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ConcatenatePhrasesFn-NoSpaces"));
        $ic107$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestNLPhraseOfStringFn"));
        $ic108$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("StringMentionFn"));
        $ic109$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("QuotedParaphraseFn"));
        $ic110$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TerseParaphraseFn"));
        $ic111$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PreciseParaphraseFn"));
        $ic112$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PhraseCycLFn"));
        $ic113$ = SubLObjectFactory.makeKeyword("ARG1");
        $ic114$ = SubLObjectFactory.makeSymbol("S#50969", "CYC");
        $ic115$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TermParaphraseFn-Possessive"));
        $ic116$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PossessivePhrase"));
        $ic117$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestVerbFormForSubjectFn"));
        $ic118$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestNLWordFormOfLexemeFn"));
        $ic119$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLConjunctionFn"));
        $ic120$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLConjunctionFn-But"));
        $ic121$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLDisjunctionFn"));
        $ic122$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestNumberedListParaphraseFn-Constrained"));
        $ic123$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestChemicalFormulaFn"));
        $ic124$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestDetNbarFn"));
        $ic125$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HeadWordOfPhraseFn"));
        $ic126$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("WithTenseToDaughterFn"));
        ...
        $ic143$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Verb"));
        $ic144$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PhraseFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Determiner")));
        $ic145$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Determiner"));
        $ic146$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PhraseFn-Bar1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Noun")));
        $ic147$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nounStrings")));
        ...
        $ic155$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("denotation"));
        $ic156$ = SubLObjectFactory.makeSymbol("S#51494", "CYC");
        $ic157$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genFormat-ArgFixed"));
        $ic158$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("equals"));
        ...
        $ic167$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Determiner-Indefinite"));
        $ic168$ = SubLObjectFactory.makeKeyword("INDEFINITE");
        $ic169$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Determiner-Definite"));
        $ic170$ = SubLObjectFactory.makeKeyword("DEFINITE");
        $ic171$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestDetNbarFn-Indefinite"));
        $ic172$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestDetNbarFn-Definite"));
        $ic173$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nounStrings"));
        $ic174$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("plural-Generic"));
        $ic175$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nonSingular-Generic"));
        $ic176$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nonPlural-Generic"));
        $ic177$ = SubLObjectFactory.makeSymbol("S#52786", "CYC");
        $ic178$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestHeadVerbForInitialSubjectFn"));
        $ic179$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NthPhraseFn"));
        $ic180$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestNLWordFormOfLexemeFn-Constrained"));
        $ic181$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("verbStrings"));
        $ic182$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TermParaphraseFn-Constrained"));
        ...
        $ic200$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlPreds"));
        $ic201$ = SubLObjectFactory.makeKeyword("DEPTH");
        $ic202$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("True-JustificationTruth"));
        ...
        $ic221$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genFormat")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genFormat-Precise")));
        ...
        $ic227$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genFormat-Precise"));
        $ic228$ = SubLObjectFactory.makeString("Template doesn't apply to input formula.");
        $ic229$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SymmetricBinaryPredicate"));
        ...
        $ic237$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nounStrings")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("determinerStrings")));
        ...
        $ic242$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("MODES"), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ReformulatorMode-Tersify"))));
        ...
        $ic245$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("deeperGenTemplateRecipe"));
        ...
        $ic263$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TermParaphraseFn-TemporalLocation"));
        ...
        $ic275$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Function"));
        ...
        $ic281$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("metaGenTemplate-QuerySentence"));
