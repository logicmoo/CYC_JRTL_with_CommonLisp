...
public final class module0307 extends SubLTranslatedFile
{
    ...
    public static SubLObject f20733(final SubLObject var1, final SubLObject var2) {
        return f20734(module0202.f12643((SubLObject)$ic0$, var1), var2);
    }
    
    public static SubLObject f20734(final SubLObject var3, final SubLObject var2) {
        final SubLThread var4 = SubLProcess.currentSubLThread();
        var4.resetMultipleValues();
        final SubLObject var5 = f20735(var3, var2, (SubLObject)T, (SubLObject)T);
        final SubLObject var6 = var4.secondMultipleValue();
        var4.resetMultipleValues();
        return (SubLObject)makeBoolean(NIL != var5 && NIL != f20736(var5, var6, (SubLObject)$ic1$));
    }
    
    public static SubLObject f20737(final SubLObject var3, final SubLObject var2) {
        return f20738(var3, var2, (SubLObject)NIL, (SubLObject)NIL);
    }
    ...
    public static SubLObject f20738(final SubLObject var3, final SubLObject var2, final SubLObject var7, final SubLObject var8) {
        ...
        var9.resetMultipleValues();
        return (SubLObject)makeBoolean(NIL != var10 && NIL != f20739(var10, var11, (SubLObject)$ic1$));
    }
    ...
    public static SubLObject f20736(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        if (NIL != module0152.$g2133$.getDynamicValue(var10) && NIL != module0202.f12865(var12) && NIL != module0258.f16777(module0205.f13203(var12, (SubLObject)UNPROVIDED), module0205.f13204(var12, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED)) {
            final SubLObject var13 = module0258.$g2489$.currentBinding(var10);
            try {
                module0258.$g2489$.bind((SubLObject)T, var10);
    ...
    public static SubLObject f20740(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        if (NIL == var12) {
            ...
            while (NIL == var12 && NIL != var13) {
                if (NIL != module0035.f2439((SubLObject)$ic3$, var14, (SubLObject)UNPROVIDED)) {
                    var11 = (SubLObject)ConsesLow.cons(var14, var11);
                }
                else {
                    var10 = (SubLObject)makeBoolean(NIL != f20741(var14, var2, var9) && NIL != var10);
                    var12 = module0303.f20199((SubLObject)makeBoolean(NIL == var10));
                }
                var13 = var13.rest();
                var14 = var13.first();
            }
        }
        if (NIL == var12 && NIL == var12) {
            SubLObject var13 = module0035.f2399(var11, (SubLObject)$ic3$, (SubLObject)EQUAL, (SubLObject)IDENTITY, (SubLObject)NIL);
            ...
            while (NIL == var12 && NIL != var13) {
                ...
                var18 = var17.first();
                while (NIL != var17) {
                    if (NIL != module0035.f2428(var15, var18, (SubLObject)EQUAL, (SubLObject)UNPROVIDED)) {
                ...
                if (NIL == var12) {
                    SubLObject var15_20 = module0204.f13064(var16, (SubLObject)UNPROVIDED);
                    SubLObject var19 = (SubLObject)NIL;
                    var19 = var15_20.first();
                    while (NIL == var12 && NIL != var15_20) {
                        var10 = (SubLObject)makeBoolean(NIL != f20742(var19, var2, var9) && NIL != var10);
                        var12 = module0303.f20199((SubLObject)makeBoolean(NIL == var10));
    ...
    public static SubLObject f20743(final SubLObject var22, SubLObject var2, final SubLObject var8) {
        ...
        try {
            ...
            module0146.$g2055$.bind((SubLObject)NIL, var23);
            module0146.$g2013$.bind((SubLObject)NIL, var23);
            module0146.$g2027$.bind((SubLObject)NIL, var23);
            module0146.$g2028$.bind((SubLObject)NIL, var23);
            SubLObject var32 = (SubLObject)NIL;
            if (NIL != var8) {
                try {
                    var23.throwStack.push($ic4$);
                    ...
                    try {
                        module0146.$g2031$.bind(Hashtables.make_hash_table((SubLObject)FOUR_INTEGER, Symbols.symbol_function((SubLObject)EQL), (SubLObject)UNPROVIDED), var23);
                        module0146.$g2003$.bind((SubLObject)NIL, var23);
                    ...
                    var32 = Errors.handleThrowable(var33, (SubLObject)$ic4$);
                }
                finally {
            ...
            if (NIL != var32) {
                module0303.f20203((SubLObject)ConsesLow.list((SubLObject)$ic4$, var22));
    ...
    public static SubLObject f20745() {
        final SubLObject var44 = $g2785$.getGlobalValue();
        if (NIL != var44) {
    ...
    public static SubLObject f20746(final SubLObject var22, final SubLObject var2) {
        return module0034.f1829($g2785$.getGlobalValue(), (SubLObject)ConsesLow.list(var22, var2), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f20747(final SubLObject var22, final SubLObject var2) {
        final SubLThread var23 = SubLProcess.currentSubLThread();
        if (NIL != module0274.f18101(var22, (SubLObject)UNPROVIDED)) {
            var23.resetMultipleValues();
            final SubLObject var24 = module0282.f18747(var22, var2);
            final SubLObject var25 = var23.secondMultipleValue();
            var23.resetMultipleValues();
            return Values.values(module0036.f2531(var24, (SubLObject)$ic3$, (SubLObject)$ic6$, (SubLObject)UNPROVIDED), var25);
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f20744(final SubLObject var22, final SubLObject var2) {
        SubLObject var23 = $g2785$.getGlobalValue();
        if (NIL == var23) {
            var23 = module0034.f1934((SubLObject)$ic5$, (SubLObject)$ic7$, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)TWO_INTEGER, (SubLObject)$ic8$);
        }
        ...
        if (var25 != $ic9$) {
            ...
            while (NIL != var26) {
                ...
                if (var22.equal(var28.first())) {
                    var28 = var28.rest();
                    if (NIL != var28 && NIL == var28.rest() && var2.equal(var28.first())) {
    ...
    public static SubLObject f20748(final SubLObject var22, final SubLObject var2) {
        return f20735(var22, var2, (SubLObject)NIL, (SubLObject)NIL);
    }
    ...
    public static SubLObject f20735(final SubLObject var22, SubLObject var2, final SubLObject var7, final SubLObject var8) {
        ...
        try {
            ...
            module0146.$g2027$.bind((SubLObject)NIL, var23);
            module0146.$g2028$.bind((SubLObject)NIL, var23);
            if (NIL != var7 || NIL != module0274.f18101(var22, (SubLObject)UNPROVIDED)) {
                ...
                try {
                    module0147.$g2095$.bind((NIL != module0269.f17707(var2)) ? var2 : module0147.$g2095$.getDynamicValue(var23), var23);
                    module0282.$g2616$.bind((SubLObject)NIL, var23);
                    SubLObject var29 = (SubLObject)NIL;
                    if (NIL != var8) {
                        try {
                            var23.throwStack.push($ic10$);
                            var23.resetMultipleValues();
                            ...
                            var29 = Errors.handleThrowable(var30, (SubLObject)$ic10$);
                        }
                        finally {
                            var23.throwStack.pop();
                        }
                    ...
                    if (NIL != var29) {
                        module0303.f20203((SubLObject)ConsesLow.list((SubLObject)$ic10$, var22));
                        var24 = (SubLObject)NIL;
                    }
                }
                finally {
    ...
    public static SubLObject f20749(final SubLObject var22) {
        ...
        try {
            ...
            module0146.$g2003$.bind((SubLObject)NIL, var23);
            var23.resetMultipleValues();
            final SubLObject var62_63 = module0282.f18746(module0276.f18293(module0276.f18344(f20751(var22, module0147.$g2095$.getDynamicValue(var23))), (SubLObject)UNPROVIDED), module0147.$g2095$.getDynamicValue(var23));
    ...
    public static SubLObject f20752(final SubLObject var3, final SubLObject var66) {
        return (SubLObject)makeBoolean(NIL != module0205.f13128(var3, var66) || (ONE_INTEGER.numE(var66) && NIL != module0202.f12589(var3, $ic12$)));
    }
    
    public static SubLObject f20751(final SubLObject var22, final SubLObject var2) {
        final SubLThread var23 = SubLProcess.currentSubLThread();
        SubLObject var24 = (SubLObject)NIL;
        final SubLObject var25 = $g2786$.currentBinding(var23);
        try {
            $g2786$.bind(module0077.f5313(Symbols.symbol_function((SubLObject)EQL), (SubLObject)UNPROVIDED), var23);
            SubLObject var26 = module0261.f17222($ic13$, var2, (SubLObject)NIL);
            SubLObject var27 = (SubLObject)NIL;
            var27 = var26.first();
            while (NIL != var26) {
                module0077.f5326(var27, $g2786$.getDynamicValue(var23));
                var26 = var26.rest();
                var27 = var26.first();
            }
            final SubLObject var11_69 = module0205.$g2314$.currentBinding(var23);
            try {
                module0205.$g2314$.bind((SubLObject)$ic14$, var23);
                var24 = module0205.f13147(var22, (SubLObject)$ic15$, (SubLObject)$ic16$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            }
            finally {
    ...
    public static SubLObject f20753(final SubLObject var3) {
        ...
        if (NIL != module0173.f10955(var5)) {
            return module0077.f5320(var5, $g2786$.getDynamicValue(var4));
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f20754(final SubLObject var3) {
        return module0276.f18323(module0205.f13203(var3, (SubLObject)UNPROVIDED));
    }
        ...
        if (var5.isCons()) {
            ...
            while (NIL != var7) {
                ...
                if (NIL != module0035.f1997(var10)) {
                    ...
                    if (NIL == conses_high.member(var11, var6, (SubLObject)EQUAL, Symbols.symbol_function((SubLObject)IDENTITY))) {
                    ...
                    while (NIL != var19_74) {
                        final SubLObject var13 = module0232.f15326(var9, (SubLObject)ConsesLow.list(module0036.f2531(var12, (SubLObject)$ic3$, (SubLObject)$ic6$, (SubLObject)UNPROVIDED)));
                        if (NIL == conses_high.member(var13, var6, (SubLObject)EQUAL, Symbols.symbol_function((SubLObject)IDENTITY))) {
                    ...
                    final SubLObject var11 = module0232.f15326(var9, (SubLObject)NIL);
                    if (NIL == conses_high.member(var11, var6, (SubLObject)EQUAL, Symbols.symbol_function((SubLObject)IDENTITY))) {
                        var6 = (SubLObject)ConsesLow.cons(var11, var6);
                    }
                }
        ...
        if (NIL != var18) {
            if (NIL == var20) {
                ...
                while (NIL == var20 && NIL != var21) {
                    var19 = (SubLObject)makeBoolean(NIL != f20742((SubLObject)ConsesLow.list(module0232.f15326(var17, (SubLObject)ConsesLow.list(var22))), var2, var9) && NIL != var19);
                    var20 = module0303.f20199((SubLObject)makeBoolean(NIL == var19));
                    var21 = var21.rest();
                    var22 = var21.first();
                }
            }
            ...
            var19 = (SubLObject)makeBoolean(NIL != f20742((SubLObject)ConsesLow.list(module0232.f15326(var17, (SubLObject)ConsesLow.list((SubLObject)NIL))), var2, var9) && NIL != var19);
        }
        return var19;
    }
    ...
    public static SubLObject f20756(final SubLObject var16, final SubLObject var2, SubLObject var9) {
        ...
        if (NIL != var18) {
            if (NIL == var20) {
                ...
                var22 = var21.first();
                while (NIL == var20 && NIL != var21) {
                    var19 = (SubLObject)makeBoolean(NIL != f20739((SubLObject)ConsesLow.list(module0232.f15326(var17, (SubLObject)ConsesLow.list(var22))), var2, var9) && NIL != var19);
                    var20 = module0303.f20199((SubLObject)makeBoolean(NIL == var19));
                    var21 = var21.rest();
                    var22 = var21.first();
                }
            ...
            var19 = (SubLObject)makeBoolean(NIL != f20739((SubLObject)ConsesLow.list(module0232.f15326(var17, (SubLObject)ConsesLow.list((SubLObject)NIL))), var2, var9) && NIL != var19);
        }
        return var19;
    }
    ...
    public static SubLObject f20757(final SubLObject var76, SubLObject var2, SubLObject var9) {
        ...
        try {
            module0147.$g2095$.bind((NIL != module0269.f17707(var2)) ? var2 : module0147.$g2095$.getDynamicValue(var77), var77);
            module0146.$g2055$.bind((SubLObject)NIL, var77);
            module0146.$g2013$.bind((SubLObject)NIL, var77);
            SubLObject var83 = (SubLObject)NIL;
            if (NIL != module0274.f18101(var76, (SubLObject)UNPROVIDED)) {
                try {
                    var77.throwStack.push($ic4$);
                    ...
                    var83 = Errors.handleThrowable(var84, (SubLObject)$ic4$);
                }
                finally {
                ...
                if (NIL != var83) {
                    ...
                    module0303.f20203((SubLObject)ConsesLow.list((SubLObject)$ic4$, var76));
                }
            }
        }
        finally {
        ...
        if (NIL == module0152.$g2129$.getDynamicValue(var77)) {
            if (var79.isCons()) {
                SubLObject var85 = var79;
                SubLObject var86 = (SubLObject)NIL;
                var86 = var85.first();
                while (NIL != var85) {
                    var78 = (SubLObject)makeBoolean(NIL != f20758((SubLObject)ConsesLow.list(var86), var2, var9) && NIL != var78);
                    var85 = var85.rest();
                    var86 = var85.first();
                }
            }
    ...
    public static SubLObject f20759(final SubLObject var1, final SubLObject var2, SubLObject var9) {
        ...
        return f20760(module0202.f12643($ic17$, var1), var2, var9);
    }
    ...
    public static SubLObject f20760(final SubLObject var3, final SubLObject var2, SubLObject var9) {
        ...
        try {
            ...
            module0152.$g2122$.bind((SubLObject)NIL, var10);
            module0152.$g2133$.bind((SubLObject)T, var10);
            var10.resetMultipleValues();
            final SubLObject var16 = f20748(module0202.f12768($ic18$, var3, var11), var2_83);
            final SubLObject var17 = var10.secondMultipleValue();
            var10.resetMultipleValues();
            var12 = f20763(var16, var17, (SubLObject)UNPROVIDED);
        }
        finally {
    ...
    public static SubLObject f20761(final SubLObject var3, final SubLObject var2) {
        ...
        try {
            var4.throwStack.push($ic19$);
            try {
                var4.throwStack.push($ic20$);
                var4.resetMultipleValues();
                ...
                var7 = Errors.handleThrowable(var8, (SubLObject)$ic20$);
            }
            finally {
                var4.throwStack.pop();
            }
            ...
            var7 = Errors.handleThrowable(var8, (SubLObject)$ic19$);
        }
        finally {
            var4.throwStack.pop();
        }
    ...
    public static SubLObject f20764(final SubLObject var88, final SubLObject var89) {
        ...
        if (var93.eql($ic21$)) {
            return (SubLObject)ConsesLow.list(module0549.f33908(conses_high.union((SubLObject)ConsesLow.list(module0205.f13204(var89, (SubLObject)UNPROVIDED)), var90, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED), var91, var92);
        }
        if (var93.eql($ic22$)) {
            return (SubLObject)ConsesLow.list(var90, module0549.f33908(conses_high.union((SubLObject)ConsesLow.list(conses_high.third(var89)), var91, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED), var92);
        }
        if (var93.eql($ic23$)) {
            return (SubLObject)ConsesLow.list(var90, var91, module0549.f33908(conses_high.union((SubLObject)ConsesLow.list(module0205.f13204(var89, (SubLObject)UNPROVIDED)), var92, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED));
        }
        return var88;
    }
    ...
    public static SubLObject f20765(final SubLObject var3, final SubLObject var2, SubLObject var9, SubLObject var95) {
        ...
        final SubLObject var96 = module0202.f12693(var3, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        SubLObject var97 = (SubLObject)NIL;
        SubLObject var98 = (SubLObject)NIL;
        final SubLObject var99 = f20760(var3, var2, var9);
        final SubLObject var100 = module0067.f4880((SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        if (var99.first().eql($ic18$)) {
            SubLObject var101 = var99;
            SubLObject var102 = (SubLObject)NIL;
            var102 = var101.first();
            while (NIL != var101) {
                if (var102.isList()) {
                    var97 = module0205.f13203(var102, (SubLObject)UNPROVIDED);
                    if (NIL == var95 || (NIL != var95 && NIL != module0004.f104(var97, var96, (SubLObject)EQUAL, (SubLObject)UNPROVIDED))) {
                        var98 = module0067.f4884(var100, var97, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f20769(final SubLObject var3, SubLObject var2, SubLObject var9) {
        ...
        try {
            module0147.$g2095$.bind((NIL != module0269.f17707(var2)) ? var2 : module0147.$g2095$.getDynamicValue(var10), var10);
            module0146.$g2055$.bind((SubLObject)NIL, var10);
            module0146.$g2013$.bind((SubLObject)NIL, var10);
            if (NIL != module0274.f18101(var3, (SubLObject)UNPROVIDED)) {
                var10.resetMultipleValues();
    ...
    public static SubLObject f20772(final SubLObject var76, final SubLObject var2, SubLObject var9) {
        ...
        final SubLThread var77 = SubLProcess.currentSubLThread();
        var77.resetMultipleValues();
        final SubLObject var78 = f20743(var76, var2, (SubLObject)NIL);
    ...
    public static SubLObject f20762(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        return module0276.f18304(module0276.f18287(Sequences.nreverse(var10), (SubLObject)UNPROVIDED), var9);
    }
    ...
    public static SubLObject f20768(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        var13 = var12.first();
        while (NIL != var12) {
            if (NIL != module0035.f2439((SubLObject)$ic3$, var13, (SubLObject)UNPROVIDED)) {
        ...
        var12 = module0035.f2399(var11, (SubLObject)$ic3$, (SubLObject)EQUAL, (SubLObject)IDENTITY, (SubLObject)NIL);
        SubLObject var15 = (SubLObject)NIL;
        var15 = var12.first();
        while (NIL != var12) {
            SubLObject var16 = (SubLObject)NIL;
            ...
            while (NIL != var19_110) {
                if (NIL != module0035.f2428(var15, var17, (SubLObject)EQUAL, (SubLObject)UNPROVIDED)) {
                    var16 = (SubLObject)ConsesLow.cons(var17, var16);
                }
                var19_110 = var19_110.rest();
                var17 = var19_110.first();
            }
            SubLObject var19_111 = module0204.f13064(var16, (SubLObject)UNPROVIDED);
            SubLObject var18 = (SubLObject)NIL;
        ...
        return module0276.f18305(module0276.f18280(Sequences.nreverse(var10), (SubLObject)UNPROVIDED), var9);
    }
    ...
    public static SubLObject f20763(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        final SubLObject var10 = Sequences.nreverse(module0035.f2399(var5, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        final SubLObject var11 = Hashtables.make_hash_table(Sequences.length(var10), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        final SubLObject var12 = Hashtables.make_hash_table(Sequences.length(var10), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        SubLObject var13 = (SubLObject)NIL;
        ...
        while (NIL != var14) {
            ...
            while (NIL != var19_115) {
                ...
                Hashtables.sethash(var17, var11, ConsesLow.append(var18, Hashtables.gethash(var17, var11, (SubLObject)UNPROVIDED)));
            ...
            while (NIL != var19_116) {
                ...
                Hashtables.sethash(var17, var12, ConsesLow.append(var20, Hashtables.gethash(var17, var12, (SubLObject)UNPROVIDED)));
        ...
        try {
            while (Hashtables.iteratorHasNext(var23)) {
                ...
                SubLObject var25 = f20777(Sequences.remove_duplicates(var22, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var2);
                SubLObject var26 = (SubLObject)NIL;
                var26 = var25.first();
                while (NIL != var25) {
                    var13 = (SubLObject)ConsesLow.cons(module0202.f12768($ic21$, var21, var26), var13);
                    var25 = var25.rest();
                    var26 = var25.first();
                }
            }
        ...
        try {
            while (Hashtables.iteratorHasNext(var23)) {
                ...
                SubLObject var25 = f20777(Sequences.remove_duplicates(var27, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var2);
                SubLObject var28 = (SubLObject)NIL;
                var28 = var25.first();
                while (NIL != var25) {
                    var13 = (SubLObject)ConsesLow.cons(module0202.f12768($ic22$, var21, var28), var13);
                    var25 = var25.rest();
                    var28 = var25.first();
                }
            }
        ...
        return module0276.f18304(module0276.f18287(Sequences.nreverse(var13), (SubLObject)UNPROVIDED), var9);
    }
    ...
    public static SubLObject f20778(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        final SubLThread var10 = SubLProcess.currentSubLThread();
        final SubLObject var11 = Sequences.nreverse(module0035.f2399(var5, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        final SubLObject var12 = module0067.f4880(Symbols.symbol_function((SubLObject)EQL), Sequences.length(var11));
        SubLObject var13 = (SubLObject)NIL;
        SubLObject var14 = var5;
        SubLObject var15 = (SubLObject)NIL;
        var15 = var14.first();
        ...
        SubLObject var19;
        for (var19 = module0066.f4838(module0067.f4891(var12)); NIL == module0066.f4841(var19); var19 = module0066.f4840(var19)) {
            var10.resetMultipleValues();
    ...
    public static SubLObject f20782(final SubLObject var16, final SubLObject var2) {
        return f20774(var16, var2, (SubLObject)$ic24$);
    }
    ...
    public static SubLObject f20774(final SubLObject var16, final SubLObject var2, SubLObject var9) {
        ...
        while (NIL != var18) {
            ...
            while (NIL != var19_134) {
                var17 = (SubLObject)ConsesLow.cons(module0202.f12768($ic21$, var20, var22), var17);
        ...
        while (NIL != var18) {
            ...
            while (NIL != var19_135) {
                var17 = (SubLObject)ConsesLow.cons(module0202.f12768($ic23$, var20, var25), var17);
        ...
        while (NIL != var18) {
            ...
            while (NIL != var19_136) {
                var17 = (SubLObject)ConsesLow.cons(module0202.f12768($ic22$, var20, var28), var17);
        ...
        return module0276.f18287(Sequences.nreverse(var17), (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f20783(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        return (SubLObject)makeBoolean(NIL != f20784(var10, (SubLObject)$ic25$, var2) && NIL != f20784(f20779(var5, var2, var9), (SubLObject)$ic26$, var2) && NIL != f20784(f20781(var5, var2, var9), (SubLObject)$ic27$, var2) && NIL != f20785(var5, var10, var2, var9));
    }
    ...
    public static SubLObject f20742(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        return (SubLObject)makeBoolean(NIL != f20784(var10, (SubLObject)$ic25$, var2) && NIL != f20784(f20787(var5, var2, var9), (SubLObject)$ic26$, var2) && NIL != f20784(f20788(var5, var2, var9), (SubLObject)$ic27$, var2) && NIL != f20785(var5, var10, var2, var9));
    }
    ...
    public static SubLObject f20741(final SubLObject var16, final SubLObject var2, SubLObject var9) {
        ...
        return (SubLObject)makeBoolean(NIL != f20784(var17, (SubLObject)$ic25$, var2) && NIL != f20784(f20780(var16, var2, var9), (SubLObject)$ic26$, var2) && NIL != f20784(f20776(var16, var2, var9), (SubLObject)$ic27$, var2) && NIL != f20789(var16, var17, var2, var9));
    }
    ...
    public static SubLObject f20790(final SubLObject var117, final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        return conses_high.assoc(var117, f20786(var5, var2, var9), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED).rest();
    }
    ...
    public static SubLObject f20791(final SubLObject var117, final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        return conses_high.assoc(var117, f20788(var5, var2, var9), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED).rest();
    }
    
    public static SubLObject f20786(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        if (var9 == UNPROVIDED) {
            var9 = (SubLObject)$ic24$;
        }
        final SubLThread var10 = SubLProcess.currentSubLThread();
        SubLObject var11 = (SubLObject)NIL;
        SubLObject var12 = (SubLObject)NIL;
        SubLObject var14;
        final SubLObject var13 = var14 = Sequences.nreverse(module0035.f2399(var5, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        SubLObject var15 = (SubLObject)NIL;
        var15 = var14.first();
        while (NIL != var14) {
        ...
        if (NIL != var12 && NIL != module0144.$g1755$.getDynamicValue(var10)) {
            var14 = var13;
    ...
    public static SubLObject f20787(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        SubLObject var11 = (SubLObject)NIL;
        SubLObject var13;
        final SubLObject var12 = var13 = Sequences.nreverse(module0035.f2399(var5, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        SubLObject var14 = (SubLObject)NIL;
        var14 = var13.first();
        while (NIL != var13) {
    ...
    public static SubLObject f20788(final SubLObject var5, final SubLObject var2, SubLObject var9) {
        ...
        if (NIL != var12 && NIL != module0144.$g1757$.getDynamicValue(var10)) {
            var14 = var13;
            var15 = (SubLObject)NIL;
            var15 = var14.first();
            while (NIL != var14) {
    ...
    public static SubLObject f20775(final SubLObject var16, final SubLObject var2, SubLObject var9) {
        ...
        final SubLObject var18 = module0232.f15308(var16);
        if (NIL != var18) {
            final SubLObject var19 = Sequences.nreverse(module0035.f2399(var16, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
            SubLObject var20 = (SubLObject)NIL;
            SubLObject var21 = (SubLObject)NIL;
            ...
            var23 = var22.first();
            while (NIL != var22) {
                if (NIL != module0144.$g1755$.getDynamicValue(var17) || NIL != module0035.f2428(var23, var18, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED)) {
            ...
            if (NIL != var21 && NIL != module0144.$g1755$.getDynamicValue(var17)) {
                var22 = var19;
    ...
    public static SubLObject f20780(final SubLObject var16, final SubLObject var2, SubLObject var9) {
        ...
        if (NIL != var17) {
            final SubLObject var18 = Sequences.nreverse(module0035.f2399(var16, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
            SubLObject var19 = (SubLObject)NIL;
            SubLObject var20 = (SubLObject)NIL;
            SubLObject var21 = var18;
            SubLObject var22 = (SubLObject)NIL;
            var22 = var21.first();
            while (NIL != var21) {
                if (NIL != module0035.f2428(var22, var17, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED)) {}
    ...
    public static SubLObject f20776(final SubLObject var16, final SubLObject var2, SubLObject var9) {
        ...
        if (NIL != var18) {
            ...
            if (NIL != var21 && NIL != module0144.$g1757$.getDynamicValue(var17)) {
                var22 = var19;
                var23 = (SubLObject)NIL;
                var23 = var22.first();
                while (NIL != var22) {
    ...
    public static SubLObject f20797(final SubLObject var117, final SubLObject var16, final SubLObject var2) {
        ...
        if (NIL != var119) {
            ...
            try {
                ...
                final SubLObject var123 = module0204.f13087(var16, module0201.f12583(var117), (SubLObject)UNPROVIDED);
                final SubLObject var11_140 = module0144.$g1801$.currentBinding(var118);
                try {
                    module0144.$g1801$.bind((SubLObject)makeBoolean((NIL != var122 && NIL != var119) || NIL != conses_high.second(var122)), var118);
                    if (NIL != module0035.f2428(var117, var119, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED) || NIL == module0004.f104(var117, var123, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        ...
                        var125 = var124.first();
                        while (NIL != var124) {
                            if (NIL != module0202.f12903(var125)) {
                                final SubLObject var126 = module0202.f12832(var125, (SubLObject)UNPROVIDED);
                                final SubLObject var127 = module0202.f12906(var125);
                                final SubLObject var128 = module0202.f12887(var125);
                                final SubLObject var129 = (NIL != module0269.f17707(var127)) ? var127 : var2;
                                if (NIL == module0018.f979() || NIL != module0269.f17707(var127)) {
                                    var120 = ConsesLow.nconc(var120, f20803(var117, var128, var129, f20804(var126, (SubLObject)TWO_INTEGER, var129)));
                                }
                            }
                    ...
                    if (NIL != module0035.f2428(var117, var119, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED) || NIL == module0004.f104(var117, var123, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        ...
                        while (NIL != var124) {
                            if (NIL != module0202.f12903(var125)) {
                                ...
                                final SubLObject var129 = (NIL != module0269.f17707(var127)) ? var127 : var2;
                                if (NIL == module0018.f979() || NIL != module0269.f17707(var127)) {
                                    var120 = ConsesLow.nconc(var120, f20807(var117, var128, var129, f20804(var126, (SubLObject)TWO_INTEGER, var129)));
                                }
                            }
                    ...
                    if (NIL != module0035.f2428(var117, var119, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED) || NIL == module0004.f104(var117, var123, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        ...
                        while (NIL != var124) {
                            if (NIL != module0202.f12903(var125)) {
                                ...
                                final SubLObject var129 = (NIL != module0269.f17707(var127)) ? var127 : var2;
                                if (NIL == module0018.f979() || NIL != module0269.f17707(var127)) {
                                    var120 = ConsesLow.nconc(var120, f20810(var117, var128, var129, f20804(var126, (SubLObject)TWO_INTEGER, var2)));
                                }
                            }
    ...
    public static SubLObject f20793(final SubLObject var117, final SubLObject var5, final SubLObject var137, final SubLObject var2) {
        ...
        if (NIL == var137 && NIL != module0035.f1997(var5) && NIL != module0204.f13051(var5.first())) {
            return (SubLObject)NIL;
        }
        SubLObject var139 = conses_high.assoc(var117, var137, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED).rest();
    ...
    public static SubLObject f20812(final SubLObject var117, final SubLObject var16, final SubLObject var2) {
        final SubLThread var118 = SubLProcess.currentSubLThread();
        if (NIL != module0204.f13051(var16) && NIL == module0144.$g1848$.getDynamicValue(var118)) {
            return (SubLObject)NIL;
        }
        final SubLObject var119 = module0232.f15308(var16);
        SubLObject var120 = (SubLObject)NIL;
        if (NIL != var119) {
            ...
            final SubLObject var122 = module0204.f13087(var16, module0201.f12583(var117), (SubLObject)UNPROVIDED);
            final SubLObject var123 = module0144.$g1801$.currentBinding(var118);
            try {
                module0144.$g1801$.bind((SubLObject)makeBoolean((NIL != var121 && NIL != var119) || NIL != conses_high.second(var121)), var118);
                if (NIL != module0035.f2428(var117, var119, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED) || NIL == module0004.f104(var117, var122, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                    ...
                    while (NIL != var124) {
                        if (NIL != module0202.f12903(var125)) {
                            ...
                            final SubLObject var129 = (NIL != module0269.f17707(var127)) ? var127 : var2;
                            if (NIL == module0018.f979() || NIL != module0269.f17707(var127)) {
                                var120 = ConsesLow.nconc(var120, f20815(var117, var128, var129, f20804(var126, (SubLObject)TWO_INTEGER, var129)));
                            }
                        }
    ...
    public static SubLObject f20813(final SubLObject var117, final SubLObject var16, final SubLObject var2) {
        final SubLThread var118 = SubLProcess.currentSubLThread();
        if (NIL != module0204.f13051(var16) && NIL == module0144.$g1849$.getDynamicValue(var118)) {
            return (SubLObject)NIL;
        }
        final SubLObject var119 = module0232.f15308(var16);
        SubLObject var120 = (SubLObject)NIL;
                ...
                if (NIL != module0035.f2428(var117, var119, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED) || NIL == module0004.f104(var117, var122, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                    ...
                    while (NIL != var124) {
                        if (NIL != module0202.f12903(var125)) {
                            ...
                            final SubLObject var129 = (NIL != module0269.f17707(var127)) ? var127 : var2;
                            if (NIL == module0018.f979() || NIL != module0269.f17707(var127)) {
                                var120 = ConsesLow.nconc(var120, f20818(var117, var128, var129, f20804(var126, (SubLObject)TWO_INTEGER, var129)));
                            }
                        }
    ...
    public static SubLObject f20785(final SubLObject var5, final SubLObject var90, final SubLObject var2, SubLObject var9) {
        ...
        var92 = var91.first();
        while (NIL != var91) {
            if (NIL == f20789(var92, var90, var2, var9)) {
                return (SubLObject)NIL;
            }
            var91 = var91.rest();
            var92 = var91.first();
    ...
    public static SubLObject f20789(final SubLObject var16, final SubLObject var90, final SubLObject var2, SubLObject var9) {
        ...
        SubLObject var92 = (SubLObject)NIL;
        if (NIL != var90 && NIL != module0144.$g1755$.getDynamicValue(var91) && NIL == module0204.f13051(var16)) {
            ...
            try {
                ...
                SubLObject var117;
                SubLObject var118;
                for (var97 = (SubLObject)NIL, var97 = module0232.f15308(var16); NIL == var92 && NIL != var97; var97 = var97.rest()) {
                    var98 = var97.first();
                    var99 = module0205.f13333(var98);
                    var100 = (SubLObject)((NIL != module0173.f10955(var99)) ? makeBoolean(NIL != module0260.f17006(var99, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0260.f17008(var99, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) : NIL);
                    ...
                    try {
                        ...
                        module0144.$g1843$.bind((SubLObject)makeBoolean(NIL != module0144.$g1781$.getDynamicValue(var91) && NIL != var100), var91);
                        module0144.$g1844$.bind((SubLObject)makeBoolean(NIL != module0144.$g1782$.getDynamicValue(var91) && NIL != var100), var91);
                        var101 = (SubLObject)ZERO_INTEGER;
                        var102 = module0205.f13207(var98, (SubLObject)$ic28$);
                        for (var150_159 = (SubLObject)NIL, var150_159 = var102; NIL == var92 && NIL != var150_159; var150_159 = var150_159.rest()) {
                            var103 = var150_159.first();
                            var101 = Numbers.add(var101, (SubLObject)ONE_INTEGER);
                            var104 = module0035.f2293(var90, var103, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                            if (NIL != var104) {
                                var105 = (SubLObject)ZERO_INTEGER;
                                var158_163 = module0205.f13207(var98, (SubLObject)$ic28$);
                                for (var150_160 = (SubLObject)NIL, var150_160 = var158_163; NIL == var92 && NIL != var150_160; var150_160 = var150_160.rest()) {
                                    var106 = var150_160.first();
                                    var105 = Numbers.add(var105, (SubLObject)ONE_INTEGER);
                                    if (!var101.numE(var105) && NIL != module0202.f12689(var106, var9)) {
                                        var107 = (SubLObject)NIL;
                                        if (NIL == var92) {
                                            var108 = var104;
                                            var109 = (SubLObject)NIL;
                                            var109 = var108.first();
                                            while (NIL == var92 && NIL != var108) {
                                                var110 = f20820(var99, var105, var109, var101);
                                                if (var110.isVector()) {
                                                    var111 = var110;
                                                    var112 = (SubLObject)NIL;
                                                    for (var113 = Sequences.length(var111), var114 = (SubLObject)NIL, var114 = (SubLObject)ZERO_INTEGER; var114.numL(var113); var114 = Numbers.add(var114, (SubLObject)ONE_INTEGER)) {
                                                        var115 = ((NIL != var112) ? Numbers.subtract(var113, var114, (SubLObject)ONE_INTEGER) : var114);
                                        ...
                                        if (NIL != module0259.f16910(var106, var107, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                                            module0303.f20203((SubLObject)ConsesLow.list((SubLObject)$ic29$, var106, ConsesLow.append(var107, module0259.f16821(var106, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)), var2));
                                            var92 = (SubLObject)T;
                                        }
                                    }
                                }
        ...
        return (SubLObject)makeBoolean(NIL == var92);
    }
    ...
    public static SubLObject f20771(final SubLObject var23, final SubLObject var2, SubLObject var9) {
        ...
        return module0276.f18305(module0276.f18280(Sequences.nreverse(var24), (SubLObject)UNPROVIDED), var9);
    }
    ...
    public static SubLObject f20773(final SubLObject var23, final SubLObject var2, SubLObject var9) {
        ...
        final SubLObject var24 = Sequences.nreverse(module0035.f2399(var23, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        final SubLObject var25 = Hashtables.make_hash_table(Sequences.length(var24), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        final SubLObject var26 = Hashtables.make_hash_table(Sequences.length(var24), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        SubLObject var27 = (SubLObject)NIL;
        ...
        while (NIL != var28) {
            ...
            while (NIL != var19_175) {
                ...
                Hashtables.sethash(var31, var25, ConsesLow.append(var32, Hashtables.gethash(var31, var25, (SubLObject)UNPROVIDED)));
            ...
            while (NIL != var19_176) {
                ...
                Hashtables.sethash(var31, var26, ConsesLow.append(var34, Hashtables.gethash(var31, var26, (SubLObject)UNPROVIDED)));
        ...
        try {
            while (Hashtables.iteratorHasNext(var37)) {
                ...
                SubLObject var39 = module0256.f16538(Sequences.remove_duplicates(var36, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var2, (SubLObject)UNPROVIDED);
                SubLObject var40 = (SubLObject)NIL;
                var40 = var39.first();
                while (NIL != var39) {
                    var27 = (SubLObject)ConsesLow.cons(module0202.f12768($ic21$, var35, var40), var27);
                    var39 = var39.rest();
                    var40 = var39.first();
                }
            }
        ...
        try {
            while (Hashtables.iteratorHasNext(var37)) {
                ...
                SubLObject var39 = module0256.f16538(Sequences.remove_duplicates(var41, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var2, (SubLObject)UNPROVIDED);
                SubLObject var42 = (SubLObject)NIL;
                var42 = var39.first();
                while (NIL != var39) {
                    var27 = (SubLObject)ConsesLow.cons(module0202.f12768($ic22$, var35, var42), var27);
                    var39 = var39.rest();
                    var42 = var39.first();
                }
            }
        ...
        return module0276.f18304(module0276.f18287(Sequences.nreverse(var27), (SubLObject)UNPROVIDED), var9);
    }
    ...
    public static SubLObject f20821(final SubLObject var81, final SubLObject var2, SubLObject var9) {
        ...
        while (NIL != var83) {
            ...
            while (NIL != var19_177) {
                var82 = (SubLObject)ConsesLow.cons(module0202.f12768($ic21$, var85, var87), var82);
        ...
        while (NIL != var83) {
            ...
            while (NIL != var19_178) {
                var82 = (SubLObject)ConsesLow.cons(module0202.f12768($ic22$, var85, var90), var82);
        ...
        if (NIL != module0035.f1997(var82)) {
            return var82.first();
        }
        return module0276.f18287(Sequences.nreverse(var82), (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f20758(final SubLObject var23, final SubLObject var2, SubLObject var9) {
        ...
        return (SubLObject)makeBoolean(NIL != f20784(f20824(var23, var2, var9), (SubLObject)$ic25$, var2) && NIL != f20784(f20825(var23, var2, var9), (SubLObject)$ic27$, var2));
    }
    ...
    public static SubLObject f20824(final SubLObject var23, final SubLObject var2, SubLObject var9) {
        ...
        SubLObject var26 = (SubLObject)NIL;
        SubLObject var28;
        final SubLObject var27 = var28 = Sequences.nreverse(module0035.f2399(var23, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        SubLObject var29 = (SubLObject)NIL;
        var29 = var28.first();
        while (NIL != var28) {
        ...
        if (NIL != var26 && NIL != module0144.$g1755$.getDynamicValue(var24)) {
            var28 = var27;
    ...
    public static SubLObject f20825(final SubLObject var23, final SubLObject var2, SubLObject var9) {
        ...
        if (NIL != var26 && NIL != module0144.$g1757$.getDynamicValue(var24)) {
            var28 = var27;
            var29 = (SubLObject)NIL;
            var29 = var28.first();
            while (NIL != var28) {
    ...
    public static SubLObject f20830(final SubLObject var81, SubLObject var9) {
        ...
        SubLObject var83 = (SubLObject)NIL;
        SubLObject var85;
        final SubLObject var84 = var85 = Sequences.nreverse(module0035.f2399(var81, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        SubLObject var86 = (SubLObject)NIL;
        var86 = var85.first();
        while (NIL != var85) {
    ...
    public static SubLObject f20832(final SubLObject var117, final SubLObject var23, final SubLObject var2, SubLObject var9) {
        ...
        return conses_high.assoc(var117, f20824(var23, var2, var9), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED).rest();
    }
    ...
    public static SubLObject f20833(final SubLObject var117, final SubLObject var23, final SubLObject var2, SubLObject var9) {
        ...
        return conses_high.assoc(var117, f20825(var23, var2, var9), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED).rest();
    }
    ...
    public static SubLObject f20822(final SubLObject var81, final SubLObject var2, SubLObject var9) {
        ...
        SubLObject var84 = (SubLObject)NIL;
        SubLObject var86;
        final SubLObject var85 = var86 = Sequences.nreverse(module0035.f2399(var81, var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        SubLObject var87 = (SubLObject)NIL;
        var87 = var86.first();
        while (NIL != var86) {
        ...
        if (NIL != var84 && NIL != module0144.$g1755$.getDynamicValue(var82)) {
            var86 = var85;
    ...
    public static SubLObject f20823(final SubLObject var81, final SubLObject var2, SubLObject var9) {
        ...
        if (NIL != var84 && NIL != module0144.$g1757$.getDynamicValue(var82)) {
            var86 = var85;
            var87 = (SubLObject)NIL;
            var87 = var86.first();
            while (NIL != var86) {
    ...
    public static SubLObject f20834(final SubLObject var117, final SubLObject var81, final SubLObject var2) {
        ...
        if (NIL != var119) {
            ...
            try {
                ...
                final SubLObject var123 = module0204.f13087(var81, module0201.f12583(var117), (SubLObject)UNPROVIDED);
                final SubLObject var11_181 = module0144.$g1801$.currentBinding(var118);
                try {
                    module0144.$g1801$.bind((SubLObject)makeBoolean((NIL != var122 && NIL != var119) || NIL != conses_high.second(var122) || NIL != conses_high.second(var119)), var118);
                    if (NIL != module0035.f2428(var117, var119, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED) || NIL == module0004.f104(var117, var123, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        SubLObject var124 = var122;
                        SubLObject var125 = (SubLObject)NIL;
                        var125 = var124.first();
                        ...
                        if (NIL != Sequences.find_if((SubLObject)$ic30$, var119, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                            var124 = module0035.remove_if_not((SubLObject)$ic30$, var119, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                            SubLObject var130 = (SubLObject)NIL;
                            var130 = var124.first();
                            while (NIL != var124) {
                                final SubLObject var131 = module0205.f13387(var130, (SubLObject)UNPROVIDED);
                                if (var117.eql(var131)) {
                                    final SubLObject var132 = module0205.f13388(var130, (SubLObject)UNPROVIDED);
                                    SubLObject var19_185 = var119;
                                    SubLObject var133 = (SubLObject)NIL;
                                    var133 = var19_185.first();
                                    while (NIL != var19_185) {
                                        if (NIL != module0202.f12865(var133)) {
                                            final SubLObject var134 = module0205.f13387(var133, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f20831(final SubLObject var117, final SubLObject var189) {
        ...
        final SubLObject var192 = module0067.f4880(Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED);
        if (NIL != var191) {
            ...
            try {
                ...
                final SubLObject var195 = module0204.f13087(var189, module0201.f12583(var117), (SubLObject)UNPROVIDED);
                final SubLObject var11_191 = module0144.$g1801$.currentBinding(var190);
                try {
                    module0144.$g1801$.bind((SubLObject)makeBoolean((NIL != var194 && NIL != var191) || NIL != conses_high.second(var194) || NIL != conses_high.second(var191)), var190);
                    if (NIL != module0035.f2428(var117, var191, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED) || NIL == module0004.f104(var117, var195, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        ...
                        while (NIL != var196) {
                            ...
                            cdestructuring_bind.destructuring_bind_must_consp(var199, var198, (SubLObject)$ic31$);
                            var200 = var199.first();
                            var199 = var199.rest();
                            cdestructuring_bind.destructuring_bind_must_consp(var199, var198, (SubLObject)$ic31$);
                            var201 = var199.first();
                            ...
                            if (NIL == var199) {
                                ...
                                cdestructuring_bind.cdestructuring_bind_error(var198, (SubLObject)$ic31$);
                            }
                            var196 = var196.rest();
                            var197 = var196.first();
                        }
                        ...
                        while (NIL != var196) {
                            ...
                            SubLObject var200 = (SubLObject)NIL;
                            SubLObject var201 = (SubLObject)NIL;
                            cdestructuring_bind.destructuring_bind_must_consp(var204, var203, (SubLObject)$ic31$);
                            var200 = var204.first();
                            var204 = var204.rest();
                            cdestructuring_bind.destructuring_bind_must_consp(var204, var203, (SubLObject)$ic31$);
                            var201 = var204.first();
                            ...
                            if (NIL == var204) {
                                ...
                                cdestructuring_bind.cdestructuring_bind_error(var203, (SubLObject)$ic31$);
                            }
                            var196 = var196.rest();
                            var197 = var196.first();
                        }
                        if (NIL != Sequences.find_if((SubLObject)$ic32$, var191, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                            var196 = module0035.remove_if_not((SubLObject)$ic32$, var191, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                            ...
                            while (NIL != var196) {
                                ...
                                cdestructuring_bind.destructuring_bind_must_consp(var207, var206, (SubLObject)$ic33$);
                                var208 = var207.first();
                                var207 = var207.rest();
                                cdestructuring_bind.destructuring_bind_must_consp(var207, var206, (SubLObject)$ic33$);
                                var209 = var207.first();
                                var207 = var207.rest();
                                if (NIL == var207) {
                                    final SubLObject var210 = module0205.f13387(var209, (SubLObject)UNPROVIDED);
                                    if (var117.eql(var210)) {
                                        final SubLObject var211 = module0205.f13388(var209, (SubLObject)UNPROVIDED);
                                        ...
                                        while (NIL != var19_197) {
                                            ...
                                            cdestructuring_bind.destructuring_bind_must_consp(var206_207, var204_205, (SubLObject)$ic34$);
                                            ...
                                            var206_207 = var206_207.rest();
                                            if (NIL == var206_207) {
                                                if (NIL != module0202.f12865(var214)) {
                                                    final SubLObject var215 = module0205.f13387(var214, (SubLObject)UNPROVIDED);
                                                    if (var211.eql(var215) && NIL != module0161.f10514(var208, var213)) {
                                                        final SubLObject var216 = module0205.f13388(var214, (SubLObject)UNPROVIDED);
                                                        if (NIL != module0173.f10955(var216)) {
                                                ...
                                                cdestructuring_bind.cdestructuring_bind_error(var204_205, (SubLObject)$ic34$);
                                            }
                                    ...
                                    cdestructuring_bind.cdestructuring_bind_error(var206, (SubLObject)$ic33$);
                                }
                                var196 = var196.rest();
                                var205 = var196.first();
                            }
        ...
        SubLObject var218;
        for (var218 = module0066.f4838(module0067.f4891(var192)); NIL == module0066.f4841(var218); var218 = module0066.f4840(var218)) {
    ...
    public static SubLObject f20843(final SubLObject var210) {
        if (NIL != module0362.f24432(var210)) {
    ...
    public static SubLObject f20848(final SubLObject var117, final SubLObject var81, final SubLObject var2) {
        ...
        if (NIL != var119) {
            ...
            final SubLObject var122 = module0204.f13087(var81, module0201.f12583(var117), (SubLObject)UNPROVIDED);
            final SubLObject var123 = module0144.$g1801$.currentBinding(var118);
            try {
                module0144.$g1801$.bind((SubLObject)makeBoolean((NIL != var121 && NIL != var119) || NIL != conses_high.second(var121) || NIL != conses_high.second(var119) || NIL != module0144.$g1801$.getDynamicValue(var118)), var118);
                if (NIL != module0035.f2428(var117, var119, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED) || NIL == module0004.f104(var117, var122, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                    SubLObject var124 = var121;
                    SubLObject var125 = (SubLObject)NIL;
                    var125 = var124.first();
    ...
    public static SubLObject f20849(final SubLObject var117, final SubLObject var81, final SubLObject var2) {
        ...
        if (NIL != var119) {
            ...
            final SubLObject var123 = module0144.$g1801$.currentBinding(var118);
            try {
                module0144.$g1801$.bind((SubLObject)makeBoolean((NIL != var121 && NIL != var119) || NIL != conses_high.second(var121) || NIL != conses_high.second(var119)), var118);
                if (NIL != module0035.f2428(var117, var119, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED) || NIL == module0004.f104(var117, var122, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                    SubLObject var124 = var121;
                    SubLObject var125 = (SubLObject)NIL;
                    var125 = var124.first();
    ...
    public static SubLObject f20850(final SubLObject var117, final SubLObject var141, final SubLObject var2) {
        ...
        if (NIL != module0144.$g1783$.getDynamicValue(var142) && NIL != module0202.f12859(var141)) {
            final SubLObject var144 = f20856(module0202.f12834(var141, (SubLObject)UNPROVIDED));
            final SubLObject var145 = module0205.f13327(module0202.f12835(var141, (SubLObject)UNPROVIDED));
            if (var117.eql(var144)) {
                if (NIL != module0269.f17705(var145)) {
                    var143 = (SubLObject)ConsesLow.cons(var145, var143);
                }
                else if (NIL != module0210.f13598(var145)) {
                    if (NIL != module0202.f12689(var145, (SubLObject)UNPROVIDED)) {
        ...
        else if (NIL != module0202.f12871(var141) || NIL != module0202.f12877(var141, (SubLObject)UNPROVIDED)) {
            final SubLObject var144 = f20856(module0202.f12834(var141, (SubLObject)UNPROVIDED));
            if (var117.eql(var144)) {
                var143 = ConsesLow.nconc(var143, module0226.f14990(module0205.f13276(module0202.f12835(var141, (SubLObject)UNPROVIDED)), var2));
            }
        }
    ...
    public static SubLObject f20851(final SubLObject var117, final SubLObject var141, final SubLObject var2) {
        ...
        if (NIL != module0144.$g1783$.getDynamicValue(var142) && NIL != module0202.f12864(var141)) {
            final SubLObject var144 = f20856(module0202.f12834(var141, (SubLObject)UNPROVIDED));
            final SubLObject var145 = module0205.f13327(module0202.f12835(var141, (SubLObject)UNPROVIDED));
            if (var117.eql(var144)) {
                if (NIL != module0269.f17705(var145)) {
            ...
            final SubLObject var144 = f20856(module0202.f12834(var141, (SubLObject)UNPROVIDED));
            if (var117.eql(var144)) {
                final SubLObject var146 = module0205.f13276(module0202.f12835(var141, (SubLObject)UNPROVIDED));
    ...
    public static SubLObject f20852(final SubLObject var117, final SubLObject var141, final SubLObject var2) {
        ...
        if (NIL != module0144.$g1784$.getDynamicValue(var142) && NIL != module0202.f12865(var141)) {
            final SubLObject var144 = f20856(module0202.f12834(var141, (SubLObject)UNPROVIDED));
            final SubLObject var145 = module0205.f13327(module0202.f12835(var141, (SubLObject)UNPROVIDED));
            if (var117.eql(var144)) {
                if (NIL != module0269.f17705(var145)) {
                    ...
                    var143 = ConsesLow.nconc(var143, module0226.f15014(module0205.f13276(var145), var2, (SubLObject)UNPROVIDED));
                }
            }
        }
        else if (NIL != module0202.f12871(var141) || NIL != module0202.f12877(var141, (SubLObject)UNPROVIDED)) {
            final SubLObject var144 = f20856(module0202.f12834(var141, (SubLObject)UNPROVIDED));
            if (var117.eql(var144)) {
                var143 = ConsesLow.nconc(var143, module0226.f15014(module0205.f13276(module0202.f12835(var141, (SubLObject)UNPROVIDED)), var2, (SubLObject)UNPROVIDED));
            }
        }
        var143 = module0035.f2273(var143);
        return var143;
    ...
    public static SubLObject f20853(final SubLObject var117, final SubLObject var141, final SubLObject var2) {
        if (NIL != module0035.f2428(var117, var141, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f20858(final SubLObject var117, final SubLObject var141, final SubLObject var2) {
        final SubLThread var142 = SubLProcess.currentSubLThread();
        SubLObject var143 = module0202.f12832(var141, (SubLObject)UNPROVIDED);
        SubLObject var144 = (SubLObject)NIL;
        if (NIL == module0173.f10955(var143)) {
            var143 = module0205.f13328(var143);
        }
        final SubLObject var145 = (SubLObject)((NIL != module0173.f10955(var143)) ? module0226.f15099(var143, var2) : NIL);
        ...
        try {
            ...
            final SubLObject var149 = (SubLObject)((NIL != module0173.f10955(var143)) ? makeBoolean(NIL != module0260.f17006(var143, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0260.f17008(var143, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) : NIL);
            ...
            try {
                ...
                module0144.$g1843$.bind((SubLObject)makeBoolean(NIL != module0144.$g1781$.getDynamicValue(var142) && NIL != var149), var142);
                module0144.$g1844$.bind((SubLObject)makeBoolean(NIL != module0144.$g1782$.getDynamicValue(var142) && NIL != var149), var142);
                if (var117.eql(f20856(var143))) {
                    SubLObject var151 = (SubLObject)NIL;
                    SubLObject var152 = (SubLObject)NIL;
                    final SubLObject var153 = module0205.f13207(var141, (SubLObject)$ic28$);
                    SubLObject var154;
                    SubLObject var155;
                    for (var154 = (SubLObject)NIL, var154 = var153; NIL == var151 && NIL != var154; var154 = var154.rest()) {
                        var155 = var154.first();
                        if (NIL != module0210.f13606(var155, (SubLObject)UNPROVIDED)) {
                            var151 = (SubLObject)T;
                            var152 = (SubLObject)T;
                        }
                    }
                    if (NIL != var152) {
                        var144 = (SubLObject)ConsesLow.cons($ic36$, var144);
                    }
                    else {
                        var144 = (SubLObject)ConsesLow.cons($ic37$, var144);
                    }
                }
                SubLObject var156 = module0202.f12829(var141, (SubLObject)$ic41$);
                SubLObject var157 = (SubLObject)NIL;
                var157 = var156.first();
                while (NIL != var156) {
                    var146 = Numbers.add(var146, (SubLObject)ONE_INTEGER);
                    if (NIL == module0004.f104(var146, var145, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        if (NIL == module0206.f13470(var157)) {
                            if (NIL == module0279.f18445(var143, var146, var2)) {
                                if (var117.equal(var157)) {
                                    var144 = ConsesLow.nconc(var144, f20859(var143, var146));
                                }
                                else if (NIL == f20860(var143, var146, var2)) {
                                    if (NIL != module0210.f13589(var157)) {
                                        if (var117.eql(module0205.f13368(var157, (SubLObject)UNPROVIDED))) {
                                            var144 = f20859(var143, var146);
                                        }
                                        final SubLObject var158 = module0287.f19158(var157);
                                        if (NIL != module0035.f2428(var117, var158, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                                            var144 = ConsesLow.nconc(var144, f20861(var117, var158, var2));
                                        }
                                    }
                                    else if (NIL != module0279.f18462(var143, var146, var2)) {
                                        if (NIL != module0279.f18483(var143, var146, var2)) {
                                            if (NIL != module0202.f12903(var141)) {
                                                final SubLObject var159 = module0202.f12906(var141);
                                                final SubLObject var160 = module0202.f12887(var141);
                                                final SubLObject var161 = (NIL != module0269.f17707(var159)) ? var159 : var2;
                                                if (NIL == module0018.f979() || NIL != module0269.f17707(var159)) {
                                                    var144 = ConsesLow.nconc(var144, f20803(var117, var160, var161, f20804(var143, (SubLObject)TWO_INTEGER, var161)));
                                                }
                                            }
                                            else {
                                    ...
                                    else if (NIL == module0202.f12982(var143, var146)) {
                                        if (NIL != module0202.f12674(var157) && NIL != module0202.f12715(var157) && NIL != module0035.f2169(var117, var157)) {
                                            final SubLObject var162 = Sequences.substitute((SubLObject)$ic38$, var157, var141, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                            SubLObject var19_226;
                                            final SubLObject var163 = var19_226 = f20803((SubLObject)$ic38$, var162, var2, (SubLObject)UNPROVIDED);
                                            SubLObject var164 = (SubLObject)NIL;
                                            var164 = var19_226.first();
                                            while (NIL != var19_226) {
                                                if (NIL != module0206.f13453(var164)) {
                                                    final SubLObject var165 = module0205.f13276(var164);
                                                    final SubLObject var166 = module0205.f13277(var164, (SubLObject)UNPROVIDED);
                                                    if ($ic39$.eql(var165) && NIL != module0173.f10955(var166)) {
                                            ...
                                            if (NIL == var144) {
                                                var144 = (SubLObject)ConsesLow.list($ic40$);
                                            }
                                        }
                                        else if (NIL != module0035.f2428(var117, var157, (SubLObject)EQUAL, (SubLObject)UNPROVIDED)) {
                                            ...
                                            if (var167.isVector()) {
                                                ...
                                                SubLObject var172;
                                                SubLObject var173;
                                                for (var170 = Sequences.length(var168), var171 = (SubLObject)NIL, var171 = (SubLObject)ZERO_INTEGER; var171.numL(var170); var171 = Numbers.add(var171, (SubLObject)ONE_INTEGER)) {
                                                    var172 = ((NIL != var169) ? Numbers.subtract(var170, var171, (SubLObject)ONE_INTEGER) : var171);
    ...
    public static SubLObject f20857(final SubLObject var117, final SubLObject var141, final SubLObject var2) {
        ...
        var144 = module0034.f1857(var143, (SubLObject)$ic35$, (SubLObject)UNPROVIDED);
        if (NIL == var144) {
            var144 = module0034.f1807(module0034.f1842(var143), (SubLObject)$ic35$, (SubLObject)THREE_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var143, (SubLObject)$ic35$, var144);
        }
            ...
            while (NIL != var147) {
                ...
                if (var117.equal(var149.first())) {
                    ...
                    if (var141.equal(var149.first())) {
                        var149 = var149.rest();
                        if (NIL != var149 && NIL == var149.rest() && var2.equal(var149.first())) {
    ...
    public static SubLObject f20854(final SubLObject var117, final SubLObject var141, final SubLObject var2) {
        ...
        try {
            ...
            try {
                ...
                module0144.$g1843$.bind((SubLObject)makeBoolean(NIL != module0144.$g1781$.getDynamicValue(var142) && NIL != var149), var142);
                module0144.$g1844$.bind((SubLObject)makeBoolean(NIL != module0144.$g1782$.getDynamicValue(var142) && NIL != var149), var142);
                SubLObject var151 = module0202.f12829(var141, (SubLObject)$ic41$);
                SubLObject var152 = (SubLObject)NIL;
                var152 = var151.first();
                while (NIL != var151) {
                    var146 = Numbers.add(var146, (SubLObject)ONE_INTEGER);
                    if (NIL == module0004.f104(var146, var145, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        if (NIL == module0206.f13470(var152)) {
                            if (NIL == module0279.f18445(var143, var146, var2)) {
                                if (var117.equal(var152)) {
                                    var144 = ConsesLow.nconc(var144, f20862(var143, var146));
                                }
                                else if (NIL == f20860(var143, var146, var2)) {
                                    if (NIL != module0210.f13589(var152)) {
                                        if (var117.eql(module0205.f13368(var152, (SubLObject)UNPROVIDED))) {
                                            var144 = f20862(var143, var146);
                                        }
                                        final SubLObject var153 = module0287.f19158(var152);
                                        if (NIL != module0035.f2428(var117, var153, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                                        ...
                                        if (NIL != module0279.f18483(var143, var146, var2)) {
                                            if (NIL != module0202.f12903(var141)) {
                                                ...
                                                final SubLObject var156 = (NIL != module0269.f17707(var154)) ? var154 : var2;
                                                if (NIL == module0018.f979() || NIL != module0269.f17707(var154)) {
                                                    var144 = ConsesLow.nconc(var144, f20807(var117, var155, var156, f20804(var143, (SubLObject)TWO_INTEGER, var156)));
                                                }
                                            }
                                            else {
                                        ...
                                        if (NIL != module0035.f2428(var117, var152, (SubLObject)EQUAL, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f20855(final SubLObject var117, final SubLObject var141, final SubLObject var2) {
        ...
        SubLObject var143 = module0202.f12832(var141, (SubLObject)UNPROVIDED);
        SubLObject var144 = (SubLObject)NIL;
        if (NIL == module0173.f10955(var143) && NIL != module0210.f13595(var143, (SubLObject)UNPROVIDED)) {
                            ...
                            if (NIL == module0279.f18445(var143, var146, var2)) {
                                if (var117.equal(var152)) {
                                    ...
                                    if (NIL != module0210.f13589(var152)) {
                                        ...
                                        if (NIL != module0202.f12674(var152) && NIL != module0202.f12715(var152) && NIL != module0035.f2169(var117, var152)) {
                                            final SubLObject var157 = Sequences.substitute((SubLObject)$ic38$, var152, var141, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                            SubLObject var19_239;
                                            final SubLObject var158 = var19_239 = f20803((SubLObject)$ic38$, var157, var2, (SubLObject)UNPROVIDED);
                                            SubLObject var159 = (SubLObject)NIL;
                                            var159 = var19_239.first();
                                            while (NIL != var19_239) {
                                                if (NIL != module0206.f13453(var159)) {
                                                    final SubLObject var160 = module0205.f13276(var159);
                                                    final SubLObject var161 = module0205.f13277(var159, (SubLObject)UNPROVIDED);
                                                    if ($ic42$.eql(var160) && NIL != module0173.f10955(var161)) {
                                                        var144 = (SubLObject)ConsesLow.cons(var161, var144);
                                                    }
                                                    else if ($ic39$.eql(var160) && $ic43$.eql(module0205.f13276(var161)) && NIL != module0173.f10955(module0205.f13277(var161, (SubLObject)UNPROVIDED))) {
                                                        var144 = (SubLObject)ConsesLow.cons(module0205.f13277(var161, (SubLObject)UNPROVIDED), var144);
                                                    }
                                                }
                                        ...
                                        else if (NIL != module0035.f2428(var117, var152, (SubLObject)EQUAL, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f20816(final SubLObject var117, final SubLObject var141, final SubLObject var2) {
        ...
        final SubLObject var145 = module0202.f12839(var141, (SubLObject)UNPROVIDED);
        SubLObject var146 = (SubLObject)ZERO_INTEGER;
        final SubLObject var147 = (SubLObject)((NIL != module0173.f10955(var143)) ? module0226.f15099(var143, var2) : NIL);
        ...
        try {
            module0147.$g2094$.bind(module0147.f9531(var2), var142);
            module0147.$g2095$.bind(module0147.f9534(var2), var142);
            final SubLObject var150 = (SubLObject)((NIL != module0173.f10955(var143)) ? makeBoolean(NIL != module0260.f17006(var143, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0260.f17008(var143, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) : NIL);
            ...
            try {
                module0144.$g1831$.bind(var143, var142);
                module0144.$g1843$.bind((SubLObject)makeBoolean(NIL != module0144.$g1781$.getDynamicValue(var142) && NIL != var150), var142);
                module0144.$g1844$.bind((SubLObject)makeBoolean(NIL != module0144.$g1782$.getDynamicValue(var142) && NIL != var150), var142);
                SubLObject var152 = module0202.f12829(var141, (SubLObject)$ic41$);
                SubLObject var153 = (SubLObject)NIL;
                var153 = var152.first();
                while (NIL != var152) {
                    var146 = Numbers.add(var146, (SubLObject)ONE_INTEGER);
                    if (NIL == module0004.f104(var146, var147, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        if (NIL == module0206.f13470(var153)) {
                            if (NIL == module0279.f18445(var143, var146, var2)) {
                                if (var117.equal(f20856(var153))) {
                                    final SubLObject var11_242 = module0144.$g1845$.currentBinding(var142);
                                    try {
                                        module0144.$g1845$.bind((SubLObject)(var117.equal(module0144.$g1845$.getDynamicValue(var142)) ? module0144.$g1845$.getDynamicValue(var142) : NIL), var142);
                                        SubLObject var154;
                                        SubLObject var155;
                                        SubLObject var156;
                                        SubLObject var19_245;
                                        SubLObject var157;
                                        for (var154 = (SubLObject)NIL, var154 = (SubLObject)ZERO_INTEGER; var154.numL(var145); var154 = Numbers.add(var154, (SubLObject)ONE_INTEGER)) {
                                            var155 = Numbers.add(var154, (SubLObject)ONE_INTEGER);
                                            if (!var146.numE(var155)) {
                                                var156 = module0202.f12831(var141, var155, (SubLObject)UNPROVIDED);
                                                if (NIL != var156) {
                                                    if (NIL != f20866(var156)) {
                                                        var144 = ConsesLow.nconc(var144, f20867(var143, var146, var156, var155));
                                                    }
                                                    else {
                                                        var19_245 = module0035.f2293(module0144.$g1848$.getDynamicValue(var142), var156, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                    ...
                                    if (NIL == module0210.f13589(var153)) {
                                        if (NIL != module0279.f18462(var143, var146, var2)) {
                                            if (NIL != module0279.f18483(var143, var146, var2)) {
                                                if (NIL != module0202.f12903(var141)) {
                                                    final SubLObject var158 = module0202.f12906(var141);
                                                    final SubLObject var159 = module0202.f12887(var141);
                                                    final SubLObject var160 = (NIL != module0269.f17707(var158)) ? var158 : var2;
                                                    if (NIL == module0018.f979() || NIL != module0269.f17707(var158)) {
                                                        var144 = ConsesLow.nconc(var144, f20815(var117, var159, var160, f20804(var143, (SubLObject)TWO_INTEGER, var160)));
                                                    }
                                                }
                                                else {
                                            ...
                                            if (NIL != module0035.f2428(var117, var153, (SubLObject)EQUAL, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f20866(final SubLObject var210) {
        return (SubLObject)makeBoolean(NIL != module0173.f10955(var210) || NIL != module0210.f13598(var210));
    }
    
    public static SubLObject f20819(final SubLObject var117, final SubLObject var141, final SubLObject var2) {
        final SubLThread var142 = SubLProcess.currentSubLThread();
        SubLObject var143 = module0202.f12832(var141, (SubLObject)UNPROVIDED);
        final SubLObject var144 = module0202.f12839(var141, (SubLObject)UNPROVIDED);
        SubLObject var145 = (SubLObject)ZERO_INTEGER;
        SubLObject var146 = (SubLObject)NIL;
        SubLObject var147 = (SubLObject)NIL;
        if (NIL == module0173.f10955(var143)) {
            var143 = module0205.f13328(var143);
        }
        var146 = (SubLObject)((NIL != module0173.f10955(var143)) ? module0226.f15099(var143, var2) : NIL);
        final SubLObject var148 = module0147.$g2094$.currentBinding(var142);
        final SubLObject var149 = module0147.$g2095$.currentBinding(var142);
        try {
            module0147.$g2094$.bind(module0147.f9531(var2), var142);
            ...
            try {
                ...
                var153 = var152.first();
                while (NIL != var152) {
                    var145 = Numbers.add(var145, (SubLObject)ONE_INTEGER);
                    if (NIL == module0004.f104(var145, var146, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        if (NIL == module0206.f13470(var153)) {
                            if (NIL == module0279.f18445(var143, var145, var2)) {
                                if (var117.equal(f20856(var153))) {
                                    ...
                                    try {
                                        ...
                                        SubLObject var157;
                                        for (var154 = (SubLObject)NIL, var154 = (SubLObject)ZERO_INTEGER; var154.numL(var144); var154 = Numbers.add(var154, (SubLObject)ONE_INTEGER)) {
                                            var155 = Numbers.add(var154, (SubLObject)ONE_INTEGER);
                                            if (!var145.numE(var155)) {
                                                var156 = module0202.f12831(var141, var155, (SubLObject)UNPROVIDED);
                                                if (NIL != var156) {
                                                    if (NIL != module0173.f10955(var156) || NIL != module0210.f13598(var156)) {
                                                        var147 = ConsesLow.nconc(var147, f20869(var143, var145, var156, var155));
                                                    }
                                                    else {
                                                        var19_250 = conses_high.assoc(var156, module0144.$g1849$.getDynamicValue(var142), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                                        var157 = (SubLObject)NIL;
                                ...
                                else if (NIL == f20860(var143, var145, var2)) {
                                    if (NIL == module0210.f13589(var153)) {
                                        if (NIL != module0279.f18462(var143, var145, var2)) {
                                            if (NIL != module0279.f18483(var143, var145, var2)) {
                                                if (NIL != module0202.f12903(var141)) {
                                                    final SubLObject var158 = module0202.f12906(var141);
                                                    final SubLObject var159 = module0202.f12887(var141);
                                                    final SubLObject var160 = (NIL != module0269.f17707(var158)) ? var158 : var2;
                                                    if (NIL == module0018.f979() || NIL != module0269.f17707(var158)) {
                                                        var147 = ConsesLow.nconc(var147, f20818(var117, var159, var160, f20804(var143, (SubLObject)TWO_INTEGER, var160)));
                                                    }
                                                }
                                                else {
                                        ...
                                        else if (NIL == module0202.f12982(var143, var145)) {
                                            if (NIL != module0035.f2428(var117, var153, (SubLObject)EQUAL, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f20803(final SubLObject var117, final SubLObject var3, final SubLObject var2, SubLObject var251) {
        if (var251 == UNPROVIDED) {
            var251 = (SubLObject)$ic44$;
        }
        return f20872(var117, var3, (SubLObject)$ic25$, var2, var251);
    }
    ...
    public static SubLObject f20807(final SubLObject var117, final SubLObject var3, final SubLObject var2, SubLObject var251) {
        ...
        return f20872(var117, var3, (SubLObject)$ic26$, var2, var251);
    }
    ...
    public static SubLObject f20810(final SubLObject var117, final SubLObject var3, final SubLObject var2, SubLObject var251) {
        ...
        return f20872(var117, var3, (SubLObject)$ic27$, var2, var251);
    }
    ...
    public static SubLObject f20872(final SubLObject var117, final SubLObject var3, final SubLObject var252, final SubLObject var2, SubLObject var251) {
        ...
        if (var253.eql((SubLObject)$ic45$)) {
            return f20873(var117, var3, var252, var2);
        }
        if (var253.eql((SubLObject)$ic44$)) {
    ...
    public static SubLObject f20873(final SubLObject var117, final SubLObject var3, final SubLObject var253, final SubLObject var2) {
        ...
        if (!var3.isAtom()) {
            ...
            if (var253.eql((SubLObject)$ic25$)) {
                var257 = f20777(f20792(var117, var255, var256), var256);
            }
            else if (var253.eql((SubLObject)$ic26$)) {
                var257 = f20777(f20794(var117, var255, var256), var256);
            }
            else if (var253.eql((SubLObject)$ic27$)) {
    ...
    public static SubLObject f20874(final SubLObject var117, final SubLObject var3, final SubLObject var253, final SubLObject var2) {
        ...
        if (!var3.isAtom()) {
            var254.resetMultipleValues();
            final SubLObject var255 = f20743(var3, var2, (SubLObject)NIL);
            final SubLObject var256 = var254.secondMultipleValue();
            var254.resetMultipleValues();
            SubLObject var257 = (SubLObject)NIL;
            if (var255.isCons()) {
                ...
                if (NIL != var257) {
                    if (NIL != module0035.f1997(var255)) {
                        return var257;
                    }
                    return module0256.f16637(var257, (SubLObject)NIL, var2, (SubLObject)UNPROVIDED);
                }
            }
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f20815(final SubLObject var117, final SubLObject var3, final SubLObject var2, SubLObject var251) {
        ...
        return f20875(var117, var3, (SubLObject)$ic25$, var2, var251);
    }
    ...
    public static SubLObject f20818(final SubLObject var117, final SubLObject var3, final SubLObject var2, SubLObject var251) {
        ...
        return f20875(var117, var3, (SubLObject)$ic27$, var2, var251);
    }
    ...
    public static SubLObject f20876(final SubLObject var117, final SubLObject var3, final SubLObject var253, final SubLObject var254) {
        ...
        if (!var3.isAtom()) {
            ...
            if (var253.eql((SubLObject)$ic25$)) {
                ...
                try {
                    module0144.$g1755$.bind((SubLObject)NIL, var255);
                    var258 = f20786(var256, var257, (SubLObject)$ic2$);
                ...
                try {
                    module0144.$g1757$.bind((SubLObject)NIL, var255);
                    var258 = f20788(var256, var257, (SubLObject)$ic2$);
    ...
    public static SubLObject f20877(final SubLObject var117, final SubLObject var3, final SubLObject var253, final SubLObject var254) {
        ...
        if (!var3.isAtom()) {
            var255.resetMultipleValues();
            final SubLObject var256 = f20743(var3, var254, (SubLObject)NIL);
            final SubLObject var257 = var255.secondMultipleValue();
            var255.resetMultipleValues();
            SubLObject var258 = (SubLObject)NIL;
            SubLObject var259 = (SubLObject)NIL;
            if (var256.isCons()) {
                if (var253.eql((SubLObject)$ic25$)) {
                    ...
                    try {
                        module0144.$g1755$.bind((SubLObject)NIL, var255);
                        var258 = f20824(var256, var257, (SubLObject)$ic2$);
                    ...
                    try {
                        module0144.$g1757$.bind((SubLObject)NIL, var255);
                        var258 = f20825(var256, var257, (SubLObject)$ic2$);
                ...
                if (NIL != var259) {
                    if (NIL != module0035.f1997(var256)) {
                        return var259;
                    }
                    return module0256.f16637(var259, (SubLObject)NIL, var257, (SubLObject)UNPROVIDED);
                }
            }
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f20861(final SubLObject var117, final SubLObject var3, final SubLObject var2) {
        final SubLThread var118 = SubLProcess.currentSubLThread();
        if (NIL != module0202.f12932(var3)) {
            SubLObject var119 = module0205.f13136(var3);
            SubLObject var120 = (SubLObject)NIL;
            SubLObject var121 = (SubLObject)NIL;
            if (var117.eql(var119)) {
                var121 = (SubLObject)ConsesLow.cons($ic46$, var121);
            }
            else if (!var119.isAtom()) {
                var119 = module0172.f10922(var119);
            }
            var120 = (SubLObject)((NIL != module0173.f10955(var119)) ? module0226.f15099(var119, var2) : NIL);
            ...
            try {
                ...
                final SubLObject var124 = (SubLObject)((NIL != module0173.f10955(var119)) ? makeBoolean(NIL != module0260.f17006(var119, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0260.f17008(var119, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) : NIL);
                ...
                try {
                    ...
                    module0144.$g1843$.bind((SubLObject)makeBoolean(NIL != module0144.$g1781$.getDynamicValue(var118) && NIL != var124), var118);
                    module0144.$g1844$.bind((SubLObject)makeBoolean(NIL != module0144.$g1782$.getDynamicValue(var118) && NIL != var124), var118);
                    SubLObject var126 = (SubLObject)ZERO_INTEGER;
                    SubLObject var128;
                    final SubLObject var127 = var128 = module0205.f13207(var3, (SubLObject)$ic41$);
                    SubLObject var129 = (SubLObject)NIL;
                    var129 = var128.first();
                    while (NIL != var128) {
                        var126 = Numbers.add(var126, (SubLObject)ONE_INTEGER);
                        if (NIL == module0004.f104(var126, var120, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                            if (NIL == module0279.f18445(var119, var126, var2)) {
                                if (var117.equal(var129)) {
                                    var121 = ConsesLow.nconc(var121, f20859(var119, var126));
                                }
                                else if (NIL == f20860(var119, var126, var2)) {
                                    if (NIL != module0279.f18462(var119, var126, var2)) {
                                        if (NIL != module0279.f18483(var119, var126, var2)) {
                                            var121 = ConsesLow.nconc(var121, f20803(var117, var129, var2, f20804(var119, var126, var2)));
                                        }
                                    }
                                    else if (NIL == module0210.f13589(var129)) {
                                        if (NIL == module0202.f12982(var119, var126)) {
                                            if (NIL != module0035.f2428(var117, var129, (SubLObject)EQUAL, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f20865(final SubLObject var117, final SubLObject var3, final SubLObject var2) {
        ...
        if (NIL != module0202.f12932(var3)) {
            SubLObject var119 = module0205.f13136(var3);
            SubLObject var120 = (SubLObject)ZERO_INTEGER;
            SubLObject var121 = (SubLObject)NIL;
            SubLObject var122 = (SubLObject)NIL;
            if (!var119.isAtom()) {
                var119 = module0172.f10922(var119);
            }
            var121 = (SubLObject)((NIL != module0173.f10955(var119)) ? module0226.f15099(var119, var2) : NIL);
            ...
            try {
                module0147.$g2094$.bind(module0147.f9531(var2), var118);
                module0147.$g2095$.bind(module0147.f9534(var2), var118);
                final SubLObject var125 = (SubLObject)((NIL != module0173.f10955(var119)) ? makeBoolean(NIL != module0260.f17006(var119, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0260.f17008(var119, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) : NIL);
                ...
                try {
                    module0144.$g1831$.bind(var119, var118);
                    module0144.$g1843$.bind((SubLObject)makeBoolean(NIL != module0144.$g1781$.getDynamicValue(var118) && NIL != var125), var118);
                    module0144.$g1844$.bind((SubLObject)makeBoolean(NIL != module0144.$g1782$.getDynamicValue(var118) && NIL != var125), var118);
                    SubLObject var128;
                    final SubLObject var127 = var128 = module0205.f13207(var3, (SubLObject)$ic41$);
                    SubLObject var129 = (SubLObject)NIL;
                    var129 = var128.first();
                    while (NIL != var128) {
                        var120 = Numbers.add(var120, (SubLObject)ONE_INTEGER);
                        if (NIL == module0004.f104(var120, var121, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                            if (NIL == module0279.f18445(var119, var120, var2)) {
                                if (var117.equal(var129)) {
                                    var122 = ConsesLow.nconc(var122, f20864(var119, var120));
                                }
                                else if (NIL == f20860(var119, var120, var2)) {
                                    if (NIL != module0279.f18462(var119, var120, var2)) {
                                        if (NIL != module0279.f18483(var119, var120, var2)) {
                                            var122 = ConsesLow.nconc(var122, f20810(var117, var129, var2, f20804(var119, var120, var2)));
                                        }
                                    }
                                    else if (NIL == module0210.f13589(var129)) {
                                        if (NIL == module0202.f12982(var119, var120)) {
                                            if (NIL != module0035.f2428(var117, var129, (SubLObject)EQUAL, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f20868(final SubLObject var117, final SubLObject var3, final SubLObject var2) {
        final SubLThread var118 = SubLProcess.currentSubLThread();
        if (NIL != module0210.f13571(var3)) {
            SubLObject var119 = module0205.f13136(var3);
            final SubLObject var120 = module0202.f12725(var3, (SubLObject)UNPROVIDED);
            SubLObject var121 = (SubLObject)ZERO_INTEGER;
            SubLObject var122 = (SubLObject)NIL;
            SubLObject var123 = (SubLObject)NIL;
            if (!var119.isAtom()) {
                var119 = module0172.f10922(var119);
            }
            var122 = (SubLObject)((NIL != module0173.f10955(var119)) ? module0226.f15099(var119, var2) : NIL);
            ...
            try {
                module0147.$g2094$.bind(module0147.f9531(var2), var118);
                module0147.$g2095$.bind(module0147.f9534(var2), var118);
                final SubLObject var126 = (SubLObject)((NIL != module0173.f10955(var119)) ? makeBoolean(NIL != module0260.f17006(var119, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0260.f17008(var119, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) : NIL);
                ...
                try {
                    module0144.$g1831$.bind(var119, var118);
                    module0144.$g1843$.bind((SubLObject)makeBoolean(NIL != module0144.$g1781$.getDynamicValue(var118) && NIL != var126), var118);
                    module0144.$g1844$.bind((SubLObject)makeBoolean(NIL != module0144.$g1782$.getDynamicValue(var118) && NIL != var126), var118);
                    SubLObject var129;
                    final SubLObject var128 = var129 = module0205.f13207(var3, (SubLObject)$ic41$);
                    SubLObject var130 = (SubLObject)NIL;
                    var130 = var129.first();
                    while (NIL != var129) {
                        var121 = Numbers.add(var121, (SubLObject)ONE_INTEGER);
                        if (NIL == module0004.f104(var121, var122, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                            if (NIL == module0279.f18445(var119, var121, var2)) {
                                if (var117.equal(var130)) {
                                    ...
                                    SubLObject var134;
                                    for (var131 = (SubLObject)NIL, var131 = (SubLObject)ZERO_INTEGER; var131.numL(var120); var131 = Numbers.add(var131, (SubLObject)ONE_INTEGER)) {
                                        var132 = Numbers.add(var131, (SubLObject)ONE_INTEGER);
                                        if (!var121.numE(var132)) {
                                            var133 = module0205.f13134(var3, var132, (SubLObject)UNPROVIDED);
                                            if (NIL != var133) {
                                                if (NIL != module0173.f10955(var133) || NIL != module0210.f13598(var133)) {
                                                    var123 = ConsesLow.nconc(var123, f20867(var119, var121, var133, var132));
                                                }
                                                else {
                                                    var19_266 = conses_high.assoc(var133, module0144.$g1848$.getDynamicValue(var118), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                ...
                                else if (NIL == f20860(var119, var121, var2)) {
                                    if (NIL != module0279.f18462(var119, var121, var2)) {
                                        if (NIL != module0279.f18483(var119, var121, var2)) {
                                            var123 = ConsesLow.nconc(var123, f20815(var117, var130, var2, f20804(var119, var121, var2)));
                                        }
                                    }
                                    else if (NIL == module0210.f13589(var130)) {
                                        if (NIL == module0202.f12982(var119, var121)) {
                                            if (NIL != module0035.f2428(var117, var130, (SubLObject)EQUAL, (SubLObject)UNPROVIDED)) {
                                        ...
                                        if (!var121.numE(var132)) {
                                            ...
                                            if (NIL != var133) {
                                                if (NIL != module0173.f10955(var133) || NIL != module0210.f13598(var133)) {
                                                    ...
                                                    var19_269 = conses_high.assoc(var133, module0144.$g1849$.getDynamicValue(var118), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                                    var134 = (SubLObject)NIL;
    ...
    public static SubLObject f20777(final SubLObject var138, final SubLObject var2) {
        ...
        return conses_high.copy_list(f20878(module0213.f13926(var138, (SubLObject)T, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var2));
    }
    
    public static SubLObject f20879(final SubLObject var138, final SubLObject var2) {
        return module0256.f16529(var138, var2, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f20878(final SubLObject var138, final SubLObject var2) {
        ...
        var141 = module0034.f1857(var140, (SubLObject)$ic47$, (SubLObject)UNPROVIDED);
        if (NIL == var141) {
            var141 = module0034.f1807(module0034.f1842(var140), (SubLObject)$ic47$, (SubLObject)TWO_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var140, (SubLObject)$ic47$, var141);
        }
        ...
        if (var143 != $ic9$) {
            ...
            while (NIL != var144) {
                ...
                if (var138.equal(var146.first())) {
                    var146 = var146.rest();
                    if (NIL != var146 && NIL == var146.rest() && var2.equal(var146.first())) {
    ...
    public static SubLObject f20880(final SubLObject var270, final SubLObject var66, final SubLObject var2) {
        if (var66.isInteger() && var66.numG((SubLObject)ZERO_INTEGER)) {
            SubLObject var271 = (SubLObject)NIL;
            if (NIL == var271) {
                SubLObject var272;
                SubLObject var273;
                for (var272 = module0226.f14882(var270, var66, var2), var273 = (SubLObject)NIL, var273 = var272.first(); NIL == var271 && NIL != var272; var271 = f20881(var273, var2), var272 = var272.rest(), var273 = var272.first()) {}
            }
            if (NIL == var271) {
                SubLObject var272;
                SubLObject var273;
                for (var272 = module0226.f14895(var270, var66, var2), var273 = (SubLObject)NIL, var273 = var272.first(); NIL == var271 && NIL != var272; var271 = f20881(var273, var2), var272 = var272.rest(), var273 = var272.first()) {}
            }
            return var271;
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f20881(final SubLObject var272, final SubLObject var2) {
        return module0004.f104((SubLObject)$ic48$, module0226.f14977(var272, var2), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f20804(final SubLObject var270, final SubLObject var66, final SubLObject var2) {
        if (NIL != f20880(var270, var66, var2)) {
            return (SubLObject)$ic44$;
        }
        if (NIL != module0210.f13570(var270)) {
            return (SubLObject)$ic45$;
        }
        if (NIL != module0279.f18462(var270, var66, var2)) {
            return (SubLObject)$ic44$;
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f20859(final SubLObject var257, final SubLObject var66) {
        ...
        try {
            module0144.$g1825$.bind((SubLObject)$ic25$, var258);
            module0018.$g604$.bind((SubLObject)$ic49$, var258);
            var259 = f20882(var257, var66, (SubLObject)NIL, (SubLObject)NIL, (SubLObject)$ic50$, (SubLObject)TWO_INTEGER);
        }
        finally {
    ...
    public static SubLObject f20862(final SubLObject var257, final SubLObject var66) {
        ...
        try {
            module0144.$g1825$.bind((SubLObject)$ic25$, var258);
            module0018.$g604$.bind((SubLObject)$ic49$, var258);
            var259 = f20882(var257, var66, (SubLObject)NIL, (SubLObject)NIL, (SubLObject)$ic51$, (SubLObject)TWO_INTEGER);
        }
        finally {
            module0018.$g604$.rebind(var261, var258);
            module0144.$g1825$.rebind(var260, var258);
    ...
    public static SubLObject f20864(final SubLObject var257, final SubLObject var66) {
        ...
        final SubLObject var261 = module0018.$g604$.currentBinding(var258);
        try {
            module0144.$g1825$.bind((SubLObject)$ic27$, var258);
            module0018.$g604$.bind((SubLObject)$ic49$, var258);
            var259 = f20882(var257, var66, (SubLObject)NIL, (SubLObject)NIL, (SubLObject)$ic52$, (SubLObject)TWO_INTEGER);
        }
        finally {
            module0018.$g604$.rebind(var261, var258);
            module0144.$g1825$.rebind(var260, var258);
    ...
    public static SubLObject f20867(final SubLObject var257, final SubLObject var66, final SubLObject var160, final SubLObject var157) {
        return f20882(var257, var66, var160, var157, (SubLObject)$ic53$, (SubLObject)FOUR_INTEGER);
    }
    ...
    public static SubLObject f20869(final SubLObject var257, final SubLObject var66, final SubLObject var160, final SubLObject var157) {
        return f20882(var257, var66, var160, var157, (SubLObject)$ic54$, (SubLObject)FOUR_INTEGER);
    }
    ...
    public static SubLObject f20820(final SubLObject var257, final SubLObject var66, final SubLObject var246, final SubLObject var157) {
        SubLObject var258 = (SubLObject)NIL;
        if (NIL != module0210.f13565(var246)) {
            var258 = f20882(var257, var66, var246, var157, (SubLObject)$ic55$, (SubLObject)FOUR_INTEGER);
        }
        else {
    ...
    public static SubLObject f20870(final SubLObject var257, final SubLObject var66, final SubLObject var246, final SubLObject var157) {
        SubLObject var258 = (SubLObject)NIL;
        if (NIL != module0210.f13565(var246)) {
            var258 = f20882(var257, var66, var246, var157, (SubLObject)$ic56$, (SubLObject)FOUR_INTEGER);
        }
        else {
            var258 = (SubLObject)NIL;
        }
    ...
    public static SubLObject f20882(final SubLObject var257, final SubLObject var66, final SubLObject var160, final SubLObject var157, final SubLObject var273, final SubLObject var274) {
        return conses_high.copy_list(f20883(var257, var66, var160, var157, var273, var274, module0147.f9552((SubLObject)UNPROVIDED)));
    }
    
    public static SubLObject f20884() {
        final SubLObject var44 = $g2787$.getGlobalValue();
        if (NIL != var44) {
            module0034.f1818(var44);
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f20885(final SubLObject var257, final SubLObject var66, final SubLObject var160, final SubLObject var157, final SubLObject var273, final SubLObject var274, final SubLObject var275) {
        return module0034.f1829($g2787$.getGlobalValue(), (SubLObject)ConsesLow.list(var257, var66, var160, var157, var273, var274, var275), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f20886(final SubLObject var257, final SubLObject var66, final SubLObject var160, final SubLObject var157, final SubLObject var273, final SubLObject var274, final SubLObject var275) {
        ...
        if (NIL != module0144.f9458() || NIL != module0144.f9459()) {
            var276 = f20887(var273, var274, var257, var66, var160, var157);
            if (NIL != module0144.f9458()) {
                SubLObject var277 = module0260.f17037(var257, (SubLObject)NIL, (SubLObject)NIL);
            ...
            if (NIL != module0144.f9459()) {
                SubLObject var277 = module0260.f17038(var257, (SubLObject)NIL, (SubLObject)NIL);
        ...
        else if (NIL != module0210.f13575(var257)) {
            var276 = f20887(var273, var274, var257, var66, var160, var157);
        }
        return var276;
    }
    ...
    public static SubLObject f20883(final SubLObject var257, final SubLObject var66, final SubLObject var160, final SubLObject var157, final SubLObject var273, final SubLObject var274, final SubLObject var275) {
        SubLObject var276 = $g2787$.getGlobalValue();
        if (NIL == var276) {
            var276 = module0034.f1934((SubLObject)$ic57$, (SubLObject)$ic58$, (SubLObject)$ic8$, (SubLObject)EQL, (SubLObject)SEVEN_INTEGER, (SubLObject)ZERO_INTEGER);
            module0034.f1940((SubLObject)$ic59$);
        }
        final SubLObject var277 = module0034.f1777(var257, var66, var160, var157, var273, var274, var275);
        final SubLObject var278 = module0034.f1814(var276, var277, (SubLObject)UNPROVIDED);
        if (var278 != $ic9$) {
                            ...
                            if (var157.eql(var281.first())) {
                                ...
                                if (var273.eql(var281.first())) {
                                    ...
                                    if (var274.eql(var281.first())) {
                                        var281 = var281.rest();
                                        if (NIL != var281 && NIL == var281.rest() && var275.eql(var281.first())) {
    ...
    public static SubLObject f20887(final SubLObject var273, final SubLObject var274, final SubLObject var257, final SubLObject var222, final SubLObject var160, final SubLObject var157) {
        ...
        if (var274.eql((SubLObject)TWO_INTEGER)) {
            if (var273.eql((SubLObject)$ic50$)) {
                var275 = module0226.f14882(var257, var222, (SubLObject)UNPROVIDED);
            }
            else if (var273.eql((SubLObject)$ic52$)) {
                var275 = module0226.f14935(var257, var222, (SubLObject)UNPROVIDED);
            }
            else {
                var275 = Functions.funcall(var273, var257, var222);
            }
        }
        else if (var274.eql((SubLObject)FOUR_INTEGER)) {
            if (var273.eql((SubLObject)$ic53$)) {
                var275 = f20888(var257, var222, var160, var157);
            }
            else if (var273.eql((SubLObject)$ic54$)) {
                var275 = f20889(var257, var222, var160, var157);
            }
            else if (var273.eql((SubLObject)$ic55$)) {
                var275 = f20890(var257, var222, var160, var157);
            }
            else if (var273.eql((SubLObject)$ic56$)) {
            ...
            module0303.f20193((SubLObject)$ic60$, var273, var274, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return var275;
    }
    ...
    public static SubLObject f20888(final SubLObject var257, final SubLObject var66, final SubLObject var160, final SubLObject var157) {
        ...
        if (NIL != var258) {
            return f20892((SubLObject)$ic25$, var257, var66, var160, var258);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f20889(final SubLObject var257, final SubLObject var66, final SubLObject var160, final SubLObject var157) {
        ...
        if (NIL != var258) {
            return f20892((SubLObject)$ic27$, var257, var66, var160, var258);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f20892(final SubLObject var253, final SubLObject var257, final SubLObject var66, final SubLObject var160, final SubLObject var279) {
        SubLObject var280 = (SubLObject)NIL;
        if (NIL != module0158.f10010(var257, (SubLObject)ONE_INTEGER, var279)) {
            final SubLObject var281 = module0158.f10011(var257, (SubLObject)ONE_INTEGER, var279);
            SubLObject var282 = (SubLObject)NIL;
            final SubLObject var283 = (SubLObject)NIL;
            while (NIL == var282) {
                final SubLObject var284 = module0052.f3695(var281, var283);
                final SubLObject var285 = (SubLObject)makeBoolean(!var283.eql(var284));
                if (NIL != var285) {
                    SubLObject var286 = (SubLObject)NIL;
                    try {
                        var286 = module0158.f10316(var284, (SubLObject)$ic61$, (SubLObject)$ic62$, (SubLObject)NIL);
                        SubLObject var283_288 = (SubLObject)NIL;
                        final SubLObject var284_289 = (SubLObject)NIL;
                        while (NIL == var283_288) {
                            final SubLObject var287 = module0052.f3695(var286, var284_289);
                            final SubLObject var286_291 = (SubLObject)makeBoolean(!var284_289.eql(var287));
                            if (NIL != var286_291) {
                            ...
                            var283_288 = (SubLObject)makeBoolean(NIL == var286_291);
                        }
                    }
                    finally {
                ...
                var282 = (SubLObject)makeBoolean(NIL == var285);
            }
        }
        if (NIL != var280) {
    ...
    public static SubLObject f20893(final SubLObject var280, final SubLObject var160, final SubLObject var66, final SubLObject var253) {
        ...
        SubLObject var282 = (SubLObject)NIL;
        final SubLObject var283 = Mapping.mapcar(Symbols.symbol_function((SubLObject)$ic63$), var280);
        final SubLObject var284 = (var253 == $ic25$) ? module0259.f16857(var160, var283, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) : module0256.f16575(var160, var283, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        if (NIL != var284) {
            ...
            while (NIL != var285) {
                ...
                cdestructuring_bind.destructuring_bind_must_consp(var288, var287, (SubLObject)$ic64$);
                var289 = var288.first();
                var288 = var288.rest();
                cdestructuring_bind.destructuring_bind_must_consp(var288, var287, (SubLObject)$ic64$);
                var290 = var288.first();
                ...
                var288 = var288.rest();
                if (NIL == var288) {
                    if (NIL != module0004.f104(var289, var284, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        module0303.f20257((SubLObject)FIVE_INTEGER, (SubLObject)$ic65$, var253, var66, module0144.$g1832$.getDynamicValue(var281), var291, (SubLObject)UNPROVIDED);
                    ...
                    cdestructuring_bind.cdestructuring_bind_error(var287, (SubLObject)$ic64$);
                }
                var285 = var285.rest();
                var286 = var285.first();
            }
    ...
    public static SubLObject f20890(final SubLObject var257, final SubLObject var66, final SubLObject var246, final SubLObject var157) {
        final SubLObject var258 = module0303.f20126(var157, var66);
        if (NIL != var258) {
            return f20892((SubLObject)$ic27$, var257, var66, var246, var258);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f20784(final SubLObject var299, SubLObject var253, SubLObject var2) {
        ...
        if (var301.eql((SubLObject)$ic66$)) {
            return f20895(var299, var253, var2);
        }
        if (var301.eql((SubLObject)$ic67$)) {
    ...
    public static SubLObject f20895(final SubLObject var299, SubLObject var253, SubLObject var2) {
        ...
        if (NIL == var300) {
            ...
            var304 = var303.first();
            while (NIL == var300 && NIL != var303) {
                var302 = module0257.f16688(var304.rest(), var2);
                if (NIL != var302) {
                    var301 = (SubLObject)T;
                    var300 = module0303.f20199((SubLObject)T);
        ...
        return (SubLObject)makeBoolean(NIL == var301);
    }
    ...
    public static SubLObject f20897(final SubLObject var253, final SubLObject var303, final SubLObject var304, final SubLObject var2) {
        ...
        if (var253.eql((SubLObject)$ic25$)) {
            var306 = (SubLObject)$ic29$;
        }
        else if (var253.eql((SubLObject)$ic26$)) {
            var306 = (SubLObject)$ic68$;
        }
        else if (var253.eql((SubLObject)$ic27$)) {
            var306 = (SubLObject)$ic69$;
        }
        if (NIL == module0152.f9715()) {
            var305 = module0302.f20041();
        }
        return (SubLObject)ConsesLow.listS(var306, var303, var304, var2, ConsesLow.append(var305, (SubLObject)NIL));
    }
        ...
        if (NIL == var300) {
            ...
            while (NIL == var300 && NIL != var303) {
                ...
                if (NIL != var302) {
                    ...
                    if (var305.eql((SubLObject)$ic25$)) {
                        module0303.f20203((SubLObject)ConsesLow.list((SubLObject)$ic29$, var304.first(), var302, var2));
                    }
                    else if (var305.eql((SubLObject)$ic26$)) {
                        module0303.f20203((SubLObject)ConsesLow.list((SubLObject)$ic68$, var304.first(), var302, var2));
                    }
                    else if (var305.eql((SubLObject)$ic27$)) {
                        module0303.f20203((SubLObject)ConsesLow.list((SubLObject)$ic69$, var304.first(), var302, var2));
                    }
                }
                var303 = var303.rest();
                var304 = var303.first();
    ...
    public static SubLObject f20860(final SubLObject var257, final SubLObject var244, SubLObject var2) {
        ...
        if (NIL != module0173.f10955(var257)) {
            return (SubLObject)makeBoolean(NIL != module0222.f14635($ic70$, var257, (SubLObject)ONE_INTEGER, (SubLObject)UNPROVIDED) && NIL != module0220.f14582($ic70$, var257, var244, var2, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f20899() {
        $g2785$ = SubLFiles.deflexical("S#23523", (SubLObject)NIL);
        $g2786$ = SubLFiles.defparameter("S#23524", (SubLObject)$ic11$);
        $g2787$ = SubLFiles.deflexical("S#23525", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f20900() {
        ...
        module0034.f1895((SubLObject)$ic47$);
    ...
    static {
        ...
        $g2786$ = null;
        $g2787$ = null;
        $ic0$ = makeSymbol("??PRED-MUFFET-212");
        $ic1$ = makeSymbol("EL-VAR?");
        $ic2$ = makeSymbol("S#12629", "CYC");
        $ic3$ = makeSymbol("S#15529", "CYC");
        $ic4$ = makeKeyword("BAD-EXPONENTIAL-CONJUNCTION");
        $ic5$ = makeSymbol("S#23390", "CYC");
        $ic6$ = makeSymbol("S#21748", "CYC");
        $ic7$ = makeSymbol("S#23523", "CYC");
        $ic8$ = makeInteger(1024);
        $ic9$ = makeKeyword("&MEMOIZED-ITEM-NOT-FOUND&");
        $ic10$ = makeKeyword("BAD-EXPONENTIAL-DISJUNCTION");
        $ic11$ = makeKeyword("UNINITIALIZED");
        $ic12$ = constant_handles_oc.f8479((SubLObject)makeString("pragmaticRequirement"));
        $ic13$ = constant_handles_oc.f8479((SubLObject)makeString("trueSentence"));
        $ic14$ = makeSymbol("S#23394", "CYC");
        $ic15$ = makeSymbol("S#23396", "CYC");
        $ic16$ = makeSymbol("S#23397", "CYC");
        $ic17$ = constant_handles_oc.f8479((SubLObject)makeString("termChosen"));
        $ic18$ = constant_handles_oc.f8479((SubLObject)makeString("and"));
        $ic19$ = makeKeyword("RECURSION-LIMIT-EXCEEDED");
        $ic20$ = makeKeyword("INVALID-EXPANSION");
        $ic21$ = constant_handles_oc.f8479((SubLObject)makeString("isa"));
        $ic22$ = constant_handles_oc.f8479((SubLObject)makeString("genls"));
        $ic23$ = constant_handles_oc.f8479((SubLObject)makeString("quotedIsa"));
        $ic24$ = makeSymbol("VARIABLE-P");
        $ic25$ = makeKeyword("ISA");
        $ic26$ = makeKeyword("QUOTED-ISA");
        $ic27$ = makeKeyword("GENLS");
        $ic28$ = makeKeyword("IGNORE");
        $ic29$ = makeKeyword("DISJOINT-ARG-ISA");
        $ic30$ = makeSymbol("S#15755", "CYC");
        $ic31$ = ConsesLow.list((SubLObject)makeSymbol("S#11445", "CYC"), (SubLObject)makeSymbol("S#13100", "CYC"));
        $ic32$ = makeSymbol("S#23381", "CYC");
        $ic33$ = ConsesLow.list((SubLObject)makeSymbol("S#18763", "CYC"), (SubLObject)makeSymbol("S#23526", "CYC"));
        $ic34$ = ConsesLow.list((SubLObject)makeSymbol("S#23527", "CYC"), (SubLObject)makeSymbol("S#23528", "CYC"));
        $ic35$ = makeSymbol("S#23477", "CYC");
        $ic36$ = constant_handles_oc.f8479((SubLObject)makeString("TruthFunction"));
        $ic37$ = constant_handles_oc.f8479((SubLObject)makeString("Predicate"));
        $ic38$ = makeSymbol("?DUMMY");
        $ic39$ = constant_handles_oc.f8479((SubLObject)makeString("ListOfTypeFn"));
        $ic40$ = constant_handles_oc.f8479((SubLObject)makeString("Thing"));
        $ic41$ = makeKeyword("REGULARIZE");
        $ic42$ = constant_handles_oc.f8479((SubLObject)makeString("ListOfSpecsFn"));
        $ic43$ = constant_handles_oc.f8479((SubLObject)makeString("SpecsFn"));
        $ic44$ = makeKeyword("DNF");
        $ic45$ = makeKeyword("CNF");
        $ic46$ = constant_handles_oc.f8479((SubLObject)makeString("Relation"));
        $ic47$ = makeSymbol("S#23495", "CYC");
        $ic48$ = makeSymbol("CYC-QUERY?");
        $ic49$ = makeSymbol("S#22840", "CYC");
        $ic50$ = makeSymbol("ARGN-ISA");
        $ic51$ = makeSymbol("ARGN-QUOTED-ISA");
        $ic52$ = makeSymbol("ARGN-GENL");
        $ic53$ = makeSymbol("S#23511", "CYC");
        $ic54$ = makeSymbol("S#23512", "CYC");
        $ic55$ = makeSymbol("S#23515", "CYC");
        $ic56$ = makeSymbol("S#23516", "CYC");
        $ic57$ = makeSymbol("S#23509", "CYC");
        $ic58$ = makeSymbol("S#23525", "CYC");
        $ic59$ = makeSymbol("S#23382", "CYC");
        $ic60$ = makeString("got an unexpected function ~s with arity ~s~%");
        $ic61$ = makeKeyword("GAF");
        $ic62$ = makeKeyword("TRUE");
        $ic63$ = makeSymbol("FIRST");
        $ic64$ = ConsesLow.list((SubLObject)makeSymbol("S#23529", "CYC"), (SubLObject)makeSymbol("S#23530", "CYC"), (SubLObject)makeSymbol("ASSERTION", "CYC"));
        $ic65$ = makeString("~%at var ~a test: arg ~s ~s; constraint ~s");
        $ic66$ = makeKeyword("NOT-DISJOINT");
        $ic67$ = makeKeyword("NEGLITS-SUBSUME-POSLITS");
        $ic68$ = makeKeyword("DISJOINT-ARG-QUOTED-ISA");
        $ic69$ = makeKeyword("DISJOINT-ARG-GENL");
        $ic70$ = constant_handles_oc.f8479((SubLObject)makeString("modalInArg"));
    }
