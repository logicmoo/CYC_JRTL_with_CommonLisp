...
public final class module0286 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic3$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("ISA"), (SubLObject)SubLObjectFactory.makeSymbol("VAR", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#12455", "CYC"))), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#21723", "CYC"))));
        $ic4$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("requiredArg1Pred"));
        $ic5$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("requiredArg2Pred"));
        ...
        $ic8$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("ISA"), (SubLObject)SubLObjectFactory.makeSymbol("VAR", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#12455", "CYC"))), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#21728", "CYC"))), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#21729", "CYC")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#21730", "CYC"))));
        $ic9$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExists"));
        $ic10$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsMin"));
        $ic11$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsMax"));
        $ic12$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsCount"));
        $ic13$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsAll"));
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsMinAll"));
        $ic15$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsMaxAll"));
        $ic16$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsCountAll"));
        ...
        $ic19$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genls"));
        $ic20$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlPreds"));
        $ic21$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlInverse"));
        ...
        $ic25$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("negationPreds"));
        $ic26$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("negationInverse"));
        $ic27$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg1Isa"));
        $ic28$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2Isa"));
        $ic29$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa"));
        $ic30$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ReflexiveBinaryPredicate"));
        $ic31$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IrreflexiveBinaryPredicate"));
        $ic32$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TransitiveBinaryPredicate"));
        $ic33$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SymmetricBinaryPredicate"));
        $ic34$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AsymmetricBinaryPredicate"));
    }
}
