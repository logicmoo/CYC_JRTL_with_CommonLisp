...
public final class module0567 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic0$ = ConsesLow.list(new SubLObject[] { constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Individual")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Relation")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TruthFunction")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Predicate")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Function-Denotational")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("LinguisticObject")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Event")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Agent-Generic")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Place-NonAgent")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SetOrCollection")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Collection")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FirstOrderCollection")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CollectionType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FacetingCollectionType")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Set-Mathematical")) });
        $ic1$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DocumentationConstant")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ImplementationConstant")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeDimensionRelatedConstant")));
        $ic2$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Agent-Generic")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Event")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Place-NonAgent")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Collection")));
        $ic3$ = SubLObjectFactory.makeSymbol("?MT");
        $ic4$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?MT"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Microtheory")));
