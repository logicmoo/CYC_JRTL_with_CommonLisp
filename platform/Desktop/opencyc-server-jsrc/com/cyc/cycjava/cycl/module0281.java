...
public final class module0281 extends SubLTranslatedFile
{
    ...
    public static SubLObject f18658(SubLObject var1, final SubLObject var2) {
        if (NIL == module0035.f2439((SubLObject)$ic0$, module0205.f13377(var1, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED)) {
            return Values.values(var1, var2);
        }
        if (NIL != module0202.f12595(var1)) {
            SubLObject var3 = (SubLObject)NIL;
            SubLObject var5;
            final SubLObject var4 = var5 = module0205.f13207(var1, (SubLObject)$ic1$);
    ...
    public static SubLObject f18659(SubLObject var1, final SubLObject var2) {
        ...
        if (NIL != module0202.f12594(var1)) {
            ...
            SubLObject var7;
            final SubLObject var6 = var7 = module0205.f13207(var1, (SubLObject)$ic1$);
            SubLObject var8 = (SubLObject)NIL;
            var8 = var7.first();
            while (NIL != var7) {
                if (NIL != module0202.f12592(var8) && NIL != module0202.f12653(module0205.f13379(var8, (SubLObject)UNPROVIDED))) {
                    final SubLObject var9 = module0205.f13379(module0205.f13379(var8, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED);
                    var5 = module0285.f18906(var9, (SubLObject)UNPROVIDED);
                    if (NIL == module0035.f1997(var5)) {
                        if (NIL != module0151.f9690() && NIL != module0152.$g2115$.getDynamicValue(var3)) {
                            module0274.f18082((SubLObject)ConsesLow.list((SubLObject)$ic2$, var9, module0282.f18729(), module0282.f18730()));
                            return Values.values(var1, var2);
                        }
    ...
    static {
        ...
        $ic0$ = makeSymbol("S#15484", "CYC");
        $ic1$ = makeKeyword("IGNORE");
        $ic2$ = makeKeyword("DISJUNCT-IN-PRAGMATIC-REQUIREMENT");
        $ic3$ = ConsesLow.list((SubLObject)makeSymbol("NEG-LITS"), (SubLObject)makeSymbol("POS-LITS"));
    }
}
