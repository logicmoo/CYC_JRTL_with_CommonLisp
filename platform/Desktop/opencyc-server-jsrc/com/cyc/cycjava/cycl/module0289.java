...
public final class module0289 extends SubLTranslatedFile
{
    ...
    public static SubLObject f19396(SubLObject var7) {
        final SubLThread var8 = SubLProcess.currentSubLThread();
        assert module0289.NIL != module0174.f11035(var7) : var7;
    ...
    static {
        ...
        $ic4$ = SubLObjectFactory.makeSymbol("S#54", "CYC");
        $ic5$ = SubLObjectFactory.makeSymbol("S#15982", "CYC");
        $ic6$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#22077", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#54", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#54", "CYC")));
        ...
        $ic13$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#12582", "CYC"));
        ...
        $ic15$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#12582", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("ASSERTION-P")));
        ...
        $ic25$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("evaluate"));
        $ic26$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("equals"));
        $ic27$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SkolemFunctionFn"));
        $ic28$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("trueSentence"));
        $ic29$ = ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("IntervalStartedByFn")));
        ...
        $ic35$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("TREE-FIND"), (SubLObject)ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("UncanonicalizerAssertionFn")), (SubLObject)ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("SubLQuoteFn")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("BIND"), (SubLObject)SubLObjectFactory.makeSymbol("S#22101", "CYC")))));
        $ic36$ = SubLObjectFactory.makeSymbol("S#22101", "CYC");
        $ic37$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("UncanonicalizerAssertionFn"));
        $ic38$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SubLQuoteFn"));
        ...
        $ic43$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("meetsPragmaticRequirement"));
        $ic44$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("NEG-LITS"), (SubLObject)SubLObjectFactory.makeSymbol("POS-LITS"));
        $ic45$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#22102", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#16446", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#12582", "CYC"));
        $ic46$ = SubLObjectFactory.makeSymbol("NEGATE");
        $ic47$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("and"));
        $ic48$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ist"));
        $ic49$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("pragmaticRequirement"));
        $ic50$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("abnormal"));
        $ic51$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#22103", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#22104", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#12582", "CYC"));
        $ic52$ = SubLObjectFactory.makeSymbol("S#12629", "CYC");
        $ic53$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("exceptFor"));
        $ic54$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("exceptWhen"));
        $ic55$ = SubLObjectFactory.makeSymbol("NEG-LITS");
        $ic56$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("implies"));
        $ic57$ = SubLObjectFactory.makeSymbol("S#16020", "CYC");
        $ic58$ = SubLObjectFactory.makeSymbol("S#22030", "CYC");
        $ic59$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#22105", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#54", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#22106", "CYC"));
        $ic60$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#22105", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#770", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#54", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#22106", "CYC"));
        ...
        $ic66$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("forAll"));
        $ic67$ = SubLObjectFactory.makeSymbol("S#22034", "CYC");
        $ic68$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("BaseKB"));
        $ic69$ = SubLObjectFactory.makeSymbol("S#15529", "CYC");
        $ic70$ = SubLObjectFactory.makeSymbol("S#22042", "CYC");
        $ic71$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("thereExists"));
        $ic72$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("IntervalMinFn"));
        $ic73$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("thereExistAtLeast"));
        $ic74$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("IntervalMaxFn"));
        $ic75$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("thereExistAtMost"));
        $ic76$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Integer"));
        $ic77$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("thereExistExactly"));
        $ic78$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Unity"));
        ...
        $ic80$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("PlusInfinity"));
        $ic81$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("or"));
