...
public final class module0764 extends SubLTranslatedFile
{
            ...
            if (module0764.NIL != module0578.f35473()) {
                ...
                try {
                    ...
                    if (module0764.NIL == var177 && module0764.NIL != module0206.f13453(var1)) {
                        ...
                        if (module0764.NIL != var211 && module0764.NIL != constant_handles_oc.f8463(module0764.$ic85$, (SubLObject)module0764.UNPROVIDED)) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (module0764.NIL == var177 && module0764.NIL != module0206.f13453(var1)) {
                                    ...
                                    if (module0764.NIL != var240 && module0764.NIL != constant_handles_oc.f8463(module0764.$ic85$, (SubLObject)module0764.UNPROVIDED)) {
    ...
    public static SubLObject f48474(final SubLObject var5, SubLObject var23, SubLObject var284) {
        ...
        final SubLObject var287 = (module0764.NIL != constants_high_oc.f10737((SubLObject)module0764.$ic136$) && module0764.NIL != var284) ? constants_high_oc.f10737((SubLObject)module0764.$ic136$) : ((module0764.NIL != constants_high_oc.f10737((SubLObject)module0764.$ic137$) && module0764.NIL != var284) ? constants_high_oc.f10737((SubLObject)module0764.$ic137$) : ((module0764.NIL != constants_high_oc.f10737((SubLObject)module0764.$ic138$)) ? constants_high_oc.f10737((SubLObject)module0764.$ic138$) : module0764.$ic139$));
    ...
    static {
        ...
        $ic1$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genPhrase"));
        $ic2$ = SubLObjectFactory.makeSymbol("S#52897", "CYC");
        $ic3$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("preferredGenUnit"));
        ...
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nounStrings"));
        ...
        $ic20$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("chemicalFormulaString"));
        ...
        $ic26$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestNLWordFormOfLexemeFn-Constrained"));
        ...
        $ic29$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Adjective"));
        $ic30$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nonGradableAdjectiveForm")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("regularDegree")));
        $ic31$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Adverb"));
        $ic32$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("regularAdverb")));
        $ic33$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Determiner"));
        $ic34$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Verb"));
        $ic35$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("verbStrings")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("gerund")));
        $ic36$ = SubLObjectFactory.makeString("Filtered V-bar preds to ~S~%");
        $ic37$ = SubLObjectFactory.makeSymbol("SPEC-POS-PRED?");
        $ic38$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestNLWordFormOfLexemeFn"));
        $ic39$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HeadWordOfPhraseFn"));
        $ic40$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("hyphenString"));
        $ic41$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BestSymbolPhraseFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Hyphen-TheSymbol")));
        $ic42$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ConcatenatePhrasesFn-NoSpaces"));
        $ic43$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ConcatenatePhrasesFn"));
        $ic44$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Collection"));
        $ic45$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nounStrings")));
        $ic46$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("regularDegree")));
        ...
        $ic48$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Thing"));
        ...
        $ic63$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("multiWordString-Speculative"));
        $ic64$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("denotation"));
        $ic65$ = SubLObjectFactory.makeSymbol("S#52966", "CYC");
        $ic66$ = SubLObjectFactory.makeSymbol("S#50999", "CYC");
        $ic67$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DenotesArgInRelnPredicate"));
        ...
        $ic74$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CollectionLexificationPredicate-Required"));
        $ic75$ = SubLObjectFactory.makeString("ALL-PHRASES-FOR-TERM doesn't know what to do with filters like ~S. Ignoring it.");
        $ic76$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtUnionFn"));
        $ic77$ = SubLObjectFactory.makeKeyword("ABBREVS");
        $ic78$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("scientificName"));
        $ic79$ = SubLObjectFactory.makeSymbol("S#51473", "CYC");
        $ic80$ = SubLObjectFactory.makeKeyword("ACRONYMS");
        $ic81$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("acronymString"));
        $ic82$ = SubLObjectFactory.makeSymbol("S#51008", "CYC");
        $ic83$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("abbreviationString-PN"));
        $ic84$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("rdfs:label"));
        $ic85$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("resultNamedByArg"));
        ...
        $ic95$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("termStrings"));
        $ic96$ = SubLObjectFactory.makeKeyword("DEPTH");
        $ic97$ = SubLObjectFactory.makeKeyword("STACK");
        $ic98$ = SubLObjectFactory.makeKeyword("QUEUE");
        $ic99$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("True-JustificationTruth"));
        ...
        $ic108$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlPreds"));
        ...
        $ic113$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EverythingPSC"));
        $ic114$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("GeneralEnglishMt"));
        $ic115$ = SubLObjectFactory.makeSymbol("S#52937", "CYC");
        $ic116$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("VulgarSpeech")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RudeSpeech")));
        $ic117$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InformalSpeech")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ArchaicSpeech")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BabyTalk")));
        $ic118$ = SubLObjectFactory.makeString("Empty NL preds list");
        $ic119$ = SubLObjectFactory.makeKeyword("ON");
        $ic120$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("wordStrings")));
        ...
        $ic132$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("properNounStrings"));
        ...
        $ic139$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("paraphraseCoercionAllowedFrom"));
        ...
        $ic143$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("regularSuffix"));
        $ic144$ = ConsesLow.list((SubLObject)module0764.TWO_INTEGER, (SubLObject)module0764.THREE_INTEGER);
        $ic145$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLPersonAttribute"));
        $ic146$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLNumberAttribute"));
        $ic147$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLGenderAttribute"));
        $ic148$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Singular-NLAttr"));
        $ic149$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ThirdPerson-NLAttr"));
        $ic150$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Ungendered-NLAttr"));
        ...
        $ic156$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("pronounStrings")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nounStrings")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("properNameStrings")));
        $ic157$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PhraseFn"));
        $ic158$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ReflexivePronoun"));
        ...
        $ic163$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Pronoun"));
        $ic164$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("singular-Generic"));
        $ic165$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("plural-Generic"));
        $ic166$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("That-TheWord")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("This-TheWord")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Those-TheWord")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("These-TheWord")));
        ...
        $ic171$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Neuter-NLAttr"));
        $ic172$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SecondPerson-NLAttr"));
        $ic173$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PronounFn"));
        $ic174$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SubjectPronoun"));
        $ic175$ = SubLObjectFactory.makeKeyword("GENITIVE");
        $ic176$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PossessivePronoun-Pre"));
        $ic177$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ObjectPronoun"));
        ...
        $ic183$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("determinerStrings")));
    }
