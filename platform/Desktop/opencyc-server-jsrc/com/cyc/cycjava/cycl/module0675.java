...
public final class module0675 extends SubLTranslatedFile
{
    ...
    public static SubLObject f41254(final SubLObject var1) {
        ...
        final SubLObject var5 = constants_high_oc.f10740(var4, (SubLObject)module0675.$ic4$, (SubLObject)module0675.$ic4$, (SubLObject)(var3.equalp((SubLObject)module0675.$ic5$) ? module0675.$ic6$ : module0675.$ic7$), (SubLObject)module0675.UNPROVIDED, (SubLObject)module0675.UNPROVIDED);
    ...
    static {
        ...
        $ic9$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EnglishMt"));
        ...
        $ic13$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Collection")));
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genls"));
        $ic15$ = SubLObjectFactory.makeString("spec-mt");
        $ic16$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Microtheory")));
        $ic17$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt"));
        $ic18$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlMt"));
        ...
        $ic22$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Predicate")));
        $ic23$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlPreds"));
        $ic24$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argIsa"));
        $ic25$ = SubLObjectFactory.makeKeyword("GAF");
        $ic26$ = SubLObjectFactory.makeSymbol("?X");
        $ic27$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and"));
        $ic28$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?X"));
        $ic29$ = ConsesLow.list((SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?X"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PredicateTypeByArity"))));
        $ic30$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AtemporalNecessarilyEssentialCollectionType"));
        $ic31$ = SubLObjectFactory.makeSymbol("?MT");
        $ic32$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("defaultDefiningMtForInstances"));
        $ic33$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?MT"));
        $ic34$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BaseKB"));
        $ic35$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("defaultDefiningMtForSpecs"));
        ...
        $ic40$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genStringAssertion"));
        $ic41$ = SubLObjectFactory.makeSymbol("XML-SET-LEXICAL-MAPPING-STRENGTH");
        $ic42$ = SubLObjectFactory.makeString("strength");
        $ic43$ = ConsesLow.list((SubLObject)ConsesLow.cons((SubLObject)SubLObjectFactory.makeString("context"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ContextuallyDependentLexicalMapping"))), (SubLObject)ConsesLow.cons((SubLObject)SubLObjectFactory.makeString("primary"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("PrimaryLexicalMapping"))), (SubLObject)ConsesLow.cons((SubLObject)SubLObjectFactory.makeString("default"), (SubLObject)SubLObjectFactory.makeKeyword("DEFAULT")), (SubLObject)ConsesLow.cons((SubLObject)SubLObjectFactory.makeString("vanishing"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("VanishinglyRareLexicalMapping"))));
        $ic44$ = SubLObjectFactory.makeKeyword("DEFAULT");
        $ic45$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("strengthOfLexicalMapping"));
