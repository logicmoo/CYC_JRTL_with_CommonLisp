...
public final class module0326 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic2$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MonotonicallyTrue"));
        $ic3$ = SubLObjectFactory.makeKeyword("STRICT");
        $ic4$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("strict-HL-TimePrecedence"));
        $ic5$ = SubLObjectFactory.makeKeyword("WEAK-SUCCESSOR");
        $ic6$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("weakSuccessor-HL-TimePrecedence"));
        $ic7$ = SubLObjectFactory.makeKeyword("SUCCESSOR-STRICT");
        $ic8$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("successorStrict-HL-TimePrecedence"));
        ...
        $ic19$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("True-JustificationTruth"));
