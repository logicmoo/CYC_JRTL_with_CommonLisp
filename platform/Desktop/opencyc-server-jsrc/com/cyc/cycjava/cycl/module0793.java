...
public final class module0793 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic2$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ParsingTemplateCategory"));
        ...
        $ic6$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLPattern-Template"));
        $ic7$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TokenTemplate"));
        $ic8$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLPattern-Word"));
        $ic9$ = SubLObjectFactory.makeSymbol("*");
        $ic10$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("OptionalSome"));
        $ic11$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("OptionalOne"));
        $ic12$ = SubLObjectFactory.makeSymbol("+");
        $ic13$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RequireSome"));
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RequireOne"));
        $ic15$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("OptionalOne")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("OptionalSome")));
        $ic16$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RequireOne")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RequireSome")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("OptionalOne")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("OptionalSome")));
        $ic17$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("WordSequence"));
        $ic18$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLPattern-Exact"));
        $ic19$ = SubLObjectFactory.makeKeyword("SEQUENCE");
        $ic20$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TermPOSPair"));
        $ic21$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLPattern-Term"));
        $ic22$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLPattern-Term-Optional"));
        $ic23$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLPattern-TermPred"));
        $ic24$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLPatternList"));
        $ic25$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLParsingSlot"));
        ...
        $ic28$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SpeechPartPredicate"));
        $ic29$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("LexicalWord"));
        $ic30$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLWordForm"));
        $ic31$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TemplateSententialMarker"));
        $ic32$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLPattern-POS"));
        $ic33$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLPattern-Agr"));
    }
}
