...
public final class module0754 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic2$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("VAR", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("TYPE"), (SubLObject)SubLObjectFactory.makeSymbol("S#22105", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#51821", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#33826", "CYC"));
        ...
        $ic31$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Thing"));
        ...
        $ic39$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ExistentialQuantifier"));
        ...
        $ic49$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("VAR", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#51822", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("&OPTIONAL"), (SubLObject)SubLObjectFactory.makeSymbol("S#51823", "CYC")), (SubLObject)SubLObjectFactory.makeSymbol("&BODY"), (SubLObject)SubLObjectFactory.makeSymbol("S#5", "CYC"));
        ...
        $ic59$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Pronoun"));
        ...
        $ic70$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeKeyword("ANYTHING"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("TEST"), (SubLObject)SubLObjectFactory.makeSymbol("S#50952", "CYC")));
        $ic71$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("quotedCollection"));
        ...
        $ic79$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CycLVariable"));
        ...
        $ic86$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FamilyRelationSlot"));
        $ic87$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Agent-Generic"));
        ...
        $ic91$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("forAll")));
        $ic92$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheSetOf")));
        $ic93$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("extentCardinality"));
        $ic94$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("trueSentence"));
        $ic95$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("holdsSometimeDuring"));
        $ic96$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ist"));
