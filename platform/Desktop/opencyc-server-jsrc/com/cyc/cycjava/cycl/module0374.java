...
public final class module0374 extends SubLTranslatedFile
{
    ...
    public static SubLObject f26530(final SubLObject var2) {
        assert NIL != inference_datastructures_inference_oc.f25275(var2) : var2;
        final SubLObject var3 = f26531(var2);
        inference_datastructures_inference_oc.f25555(var2, var3);
        return var3;
    }
    
    public static SubLObject f26531(final SubLObject var2) {
        final SubLObject var3 = inference_datastructures_inference_oc.f25488(var2);
        final SubLObject var4 = module0364.f24730(var2, (SubLObject)$ic0$);
        f26532(var4, var3);
        return var4;
    }
    
    public static SubLObject f26533(final SubLObject var3) {
        assert NIL != f26529(var3) : var3;
    ...
    public static SubLObject f26532(final SubLObject var3, final SubLObject var5) {
        assert NIL != f26529(var3) : var3;
        assert NIL != module0362.f24447(var5) : var5;
    ...
    public static SubLObject f26539(final SubLObject var3) {
        return Equality.eq((SubLObject)$ic4$, f26536(var3));
    }
    ...
    static {
        ...
        $ic0$ = makeKeyword("ANSWER");
        $ic1$ = makeSymbol("INFERENCE-P");
        $ic2$ = makeSymbol("S#27371", "CYC");
        $ic3$ = makeSymbol("S#27307", "CYC");
        $ic4$ = makeKeyword("ALL");
    }
}
