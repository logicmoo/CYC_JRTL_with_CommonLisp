...
public final class module0599 extends SubLTranslatedFile
{
    ...
    public static SubLObject f36672(final SubLObject var1) {
        return module0274.f18188(module0538.f33478(var1, (SubLObject)UNPROVIDED), module0178.f11287(var1), (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f36673(final SubLObject var1) {
        if (NIL != assertion_handles_oc.f11035(var1)) {
            return (SubLObject)makeBoolean($ic0$.eql(assertions_low_oc.f11163(var1)) || $ic0$.eql(module0178.f11287(var1)));
        }
    ...
    public static SubLObject f36674(final SubLObject var1) {
        if (NIL != assertion_handles_oc.f11035(var1)) {
            return Equality.eql((SubLObject)$ic1$, assertions_low_oc.f11163(var1));
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f36675(final SubLObject var2, final SubLObject var3, SubLObject var4, SubLObject var5) {
        ...
        if (var6.eql((SubLObject)$ic5$)) {
            return f36676(var2, var3, var4);
        }
        if (var6.eql((SubLObject)$ic6$)) {
    ...
    public static SubLObject f36676(final SubLObject var7, final SubLObject var8, SubLObject var4) {
        ...
        if (NIL != module0161.f10513((SubLObject)$ic2$, var4)) {
            final SubLObject var11 = module0147.$g2094$.currentBinding(var9);
            final SubLObject var12 = module0147.$g2095$.currentBinding(var9);
            try {
                module0147.$g2094$.bind((SubLObject)$ic12$, var9);
                module0147.$g2095$.bind($ic13$, var9);
                var10 = f36679(var7, var8, (SubLObject)UNPROVIDED);
            }
            finally {
        ...
        else if (NIL != module0161.f10481(var4)) {
    ...
    public static SubLObject f36679(final SubLObject var7, final SubLObject var8, SubLObject var4) {
        ...
        try {
            ...
            try {
                ...
                try {
                    module0139.$g1630$.bind((SubLObject)NIL, var9);
                    ...
                    try {
                        ...
                        try {
                            module0141.$g1670$.bind(module0137.f8955($ic14$), var9);
                            module0141.$g1671$.bind(module0244.f15739(module0137.f8955($ic14$)), var9);
                            module0141.$g1672$.bind(module0244.f15746(module0137.f8955($ic14$)), var9);
                            module0141.$g1674$.bind((SubLObject)NIL, var9);
                            module0137.$g1605$.bind(module0137.f8955($ic14$), var9);
        ...
        if (NIL != module0141.$g1709$.getDynamicValue(var9)) {
            return module0260.f17085(var10, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        if (NIL != module0141.$g1708$.getDynamicValue(var9)) {
            return module0260.f17027(var10, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return var10;
    }
    ...
    public static SubLObject f36680(final SubLObject var7, final SubLObject var8) {
        ...
        try {
            ...
            try {
                ...
                module0251.f16232(module0137.f8955($ic14$), var7, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            ...
            try {
                ...
                module0251.f16236(module0137.f8955($ic14$), var7, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            }
            finally {
    ...
    public static SubLObject f36681(final SubLObject var7, final SubLObject var8) {
        ...
        try {
            ...
            try {
                ...
                module0251.f16232(module0137.f8955($ic14$), var8, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            ...
            try {
                Threads.$is_thread_performing_cleanupP$.bind((SubLObject)T, var9);
                module0251.f16236(module0137.f8955($ic14$), var8, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            }
            finally {
                Threads.$is_thread_performing_cleanupP$.rebind(var12, var9);
            }
    ...
    public static SubLObject f36682(final SubLObject var7, final SubLObject var8) {
        ...
        try {
            ...
            var12 = var11.first();
            while (NIL != var11) {
                module0251.f16232(module0137.f8955($ic14$), var12, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                var11 = var11.rest();
                var12 = var11.first();
            }
            final SubLObject var13 = module0141.$g1691$.currentBinding(var9);
            try {
                module0141.$g1691$.bind((SubLObject)NIL, var9);
                try {
                    module0256.f16587((SubLObject)ConsesLow.list(var7, var8), Symbols.symbol_function((SubLObject)$ic15$), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                }
                finally {
            ...
            try {
                ...
                if (NIL != module0141.$g1709$.getDynamicValue(var9)) {
                    ...
                    var16 = var15.first();
                    while (NIL != var15) {
                        module0251.f16236(module0137.f8955($ic16$), var16, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                        var15 = var15.rest();
                        var16 = var15.first();
                    }
                }
                ...
                var17 = var15.first();
                while (NIL != var15) {
                    module0251.f16236(module0137.f8955($ic14$), var17, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    var15 = var15.rest();
                    var17 = var15.first();
                }
            }
    ...
    public static SubLObject f36684(final SubLObject var33, SubLObject var4) {
        ...
        assert NIL != module0173.f10955(var33) : var33;
        ...
        if (NIL != module0161.f10513((SubLObject)$ic2$, var4)) {
            ...
            try {
                module0147.$g2094$.bind((SubLObject)$ic12$, var34);
                module0147.$g2095$.bind($ic13$, var34);
                var35 = f36685(var33);
            }
            finally {
    ...
    public static SubLObject f36685(final SubLObject var33) {
        ...
        try {
            module0018.$g584$.bind(Hashtables.make_hash_table((SubLObject)$ic17$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var34);
            final SubLObject var11_35 = module0139.$g1659$.currentBinding(var34);
            try {
                module0139.$g1659$.bind(module0139.f9007(), var34);
                module0256.f16585(Symbols.symbol_function((SubLObject)$ic18$), var33, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f36686(final SubLObject var33) {
        module0219.f14477(Symbols.symbol_function((SubLObject)$ic19$), var33, (SubLObject)THREE_INTEGER, $ic20$, (SubLObject)$ic21$, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f36687(final SubLObject var1) {
        ...
        if (NIL != module0178.f11284(var1)) {
            ...
            final SubLObject var4 = (SubLObject)((NIL != module0173.f10955(var3)) ? module0178.f11335(var1) : NIL);
            final SubLObject var5 = (SubLObject)(var4.isInteger() ? module0178.f11336(var1) : NIL);
            if (NIL != module0173.f10955(var5) && NIL != module0210.f13568(var3)) {
                module0030.f1600(var3, var4, module0018.$g584$.getDynamicValue(var2), (SubLObject)UNPROVIDED);
            }
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f36688(final SubLObject var2, final SubLObject var3, SubLObject var4) {
        ...
        if (NIL != module0161.f10513((SubLObject)$ic2$, var4)) {
            ...
            try {
                module0147.$g2094$.bind((SubLObject)$ic12$, var5);
                module0147.$g2095$.bind($ic13$, var5);
    ...
    public static SubLObject f36689(final SubLObject var38, final SubLObject var39) {
        ...
        try {
            ...
            try {
                ...
                module0251.f16232(module0137.f8955($ic22$), var38, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                ...
                try {
                    ...
                    try {
                        ...
                        module0251.f16232(module0137.f8955($ic22$), var39, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                        final SubLObject var11_43 = $g4646$.currentBinding(var40);
                        final SubLObject var43 = $g4647$.currentBinding(var40);
                        final SubLObject var44 = $g4648$.currentBinding(var40);
                        try {
                            $g4646$.bind(Hashtables.make_hash_table((SubLObject)$ic17$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var40);
                            $g4647$.bind(Hashtables.make_hash_table((SubLObject)$ic17$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var40);
                            $g4648$.bind(Hashtables.make_hash_table((SubLObject)$ic17$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var40);
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        module0139.$g1659$.bind(module0139.f9007(), var40);
                                        module0259.f16852(Symbols.symbol_function((SubLObject)$ic23$), var38, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                    ...
                                    try {
                                        module0139.$g1659$.bind(module0139.f9007(), var40);
                                        module0259.f16852(Symbols.symbol_function((SubLObject)$ic23$), var39, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                        module0139.f9011(module0139.$g1659$.getDynamicValue(var40));
                                    }
                                    finally {
                            ...
                            final SubLObject var45 = $g4648$.getDynamicValue(var40);
                            ...
                            try {
                                while (Hashtables.iteratorHasNext(var48)) {
                                    ...
                                    final SubLObject var50 = Hashtables.gethash(var46, $g4646$.getDynamicValue(var40), (SubLObject)UNPROVIDED);
                                    final SubLObject var51 = (SubLObject)((NIL != var50) ? Hashtables.gethash(var46, $g4647$.getDynamicValue(var40), (SubLObject)UNPROVIDED) : NIL);
                                    final SubLObject var52 = (SubLObject)((NIL != var51) ? makeBoolean(NIL != conses_high.second(var50) || NIL != conses_high.second(var51) || !var50.first().eql(var51.first())) : NIL);
                                    if (NIL != var52) {
                            ...
                            $g4648$.rebind(var44, var40);
                            $g4647$.rebind(var43, var40);
                            $g4646$.rebind(var11_43, var40);
                        }
                    }
                    finally {
    ...
    public static SubLObject f36690(final SubLObject var56) {
        ...
        if (NIL == module0251.f16239(var56, module0139.$g1641$.getDynamicValue(var57))) {
            module0251.f16238(var56, module0139.$g1641$.getDynamicValue(var57));
            module0219.f14477(Symbols.symbol_function((SubLObject)$ic24$), var56, (SubLObject)THREE_INTEGER, $ic20$, (SubLObject)$ic21$, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        module0139.$g1640$.bind(module0139.$g1659$.getDynamicValue(var40), var40);
                        module0251.f16232(module0137.f8955($ic22$), var39, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                        final SubLObject var11_60 = $g4646$.currentBinding(var40);
                        final SubLObject var43 = $g4647$.currentBinding(var40);
                        final SubLObject var44 = $g4648$.currentBinding(var40);
                        try {
                            $g4646$.bind(Hashtables.make_hash_table((SubLObject)$ic17$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var40);
                            $g4647$.bind(Hashtables.make_hash_table((SubLObject)$ic17$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var40);
                            $g4648$.bind(Hashtables.make_hash_table((SubLObject)$ic17$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var40);
                            module0219.f14478(Symbols.symbol_function((SubLObject)$ic24$), $ic20$, (SubLObject)$ic21$, (SubLObject)UNPROVIDED);
                            final SubLObject var45 = $g4648$.getDynamicValue(var40);
                            SubLObject var46 = (SubLObject)NIL;
                            SubLObject var47 = (SubLObject)NIL;
                            final Iterator var48 = Hashtables.getEntrySetIterator(var45);
    ...
    public static SubLObject f36693(final SubLObject var1) {
        ...
        if (NIL != module0178.f11284(var1)) {
            ...
            SubLObject var6 = (SubLObject)NIL;
            if (NIL != module0173.f10955(var5) && NIL != module0210.f13568(var3)) {
                if (NIL != module0251.f16239(var5, module0139.$g1639$.getDynamicValue(var2))) {
                    module0030.f1600(var3, var4, $g4646$.getDynamicValue(var2), (SubLObject)UNPROVIDED);
                    var6 = (SubLObject)T;
                }
                if (NIL != module0139.f9079(module0139.$g1640$.getDynamicValue(var2)) && NIL != module0251.f16239(var5, module0139.$g1640$.getDynamicValue(var2))) {
                    module0030.f1600(var3, var4, $g4647$.getDynamicValue(var2), (SubLObject)UNPROVIDED);
                    var6 = (SubLObject)T;
                }
                if (NIL != var6) {
                    Hashtables.sethash(var3, $g4648$.getDynamicValue(var2), (SubLObject)T);
                }
            }
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f36677(final SubLObject var2, final SubLObject var3, SubLObject var4) {
        ...
        if (NIL != module0161.f10513((SubLObject)$ic2$, var4)) {
            ...
            try {
                module0147.$g2094$.bind((SubLObject)$ic12$, var5);
                module0147.$g2095$.bind($ic13$, var5);
                var6 = f36694(var2, var3, (SubLObject)UNPROVIDED);
            }
            finally {
                module0147.$g2095$.rebind(var8, var5);
                module0147.$g2094$.rebind(var7, var5);
    ...
    public static SubLObject f36694(final SubLObject var2, final SubLObject var3, SubLObject var4) {
        ...
        try {
            ...
            try {
                ...
                try {
                    module0139.$g1630$.bind((SubLObject)NIL, var5);
                    ...
                    try {
                        ...
                        try {
                            module0141.$g1670$.bind(module0137.f8955($ic14$), var5);
                            module0141.$g1671$.bind(module0244.f15739(module0137.f8955($ic14$)), var5);
                            module0141.$g1672$.bind(module0244.f15746(module0137.f8955($ic14$)), var5);
        ...
        if (NIL != module0141.$g1709$.getDynamicValue(var5)) {
            return module0260.f17085(var6, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        if (NIL != module0141.$g1708$.getDynamicValue(var5)) {
            return module0260.f17027(var6, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return var6;
    }
    ...
    public static SubLObject f36695(final SubLObject var2, final SubLObject var3) {
        ...
        try {
            ...
            try {
                ...
                module0251.f16232(module0137.f8955($ic22$), var2, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            ...
            try {
                ...
                module0251.f16236(module0137.f8955($ic22$), var2, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            }
            finally {
    ...
    public static SubLObject f36696(final SubLObject var2, final SubLObject var3) {
        ...
        try {
            ...
            try {
                ...
                module0251.f16232(module0137.f8955($ic22$), var3, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            ...
            try {
                Threads.$is_thread_performing_cleanupP$.bind((SubLObject)T, var4);
                module0251.f16236(module0137.f8955($ic22$), var3, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            }
            finally {
                Threads.$is_thread_performing_cleanupP$.rebind(var7, var4);
            }
    ...
    public static SubLObject f36697(final SubLObject var2, final SubLObject var3) {
        ...
        try {
            ...
            try {
                ...
                module0251.f16232(module0137.f8955($ic14$), var2, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            ...
            try {
                Threads.$is_thread_performing_cleanupP$.bind((SubLObject)T, var4);
                module0251.f16236(module0137.f8955($ic14$), var2, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            }
            finally {
                Threads.$is_thread_performing_cleanupP$.rebind(var7, var4);
            }
    ...
    public static SubLObject f36698(final SubLObject var2, final SubLObject var3) {
        ...
        try {
            ...
            try {
                ...
                module0251.f16232(module0137.f8955($ic14$), var3, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            ...
            try {
                Threads.$is_thread_performing_cleanupP$.bind((SubLObject)T, var4);
                module0251.f16236(module0137.f8955($ic14$), var3, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            }
            finally {
                Threads.$is_thread_performing_cleanupP$.rebind(var7, var4);
            }
    ...
    public static SubLObject f36699(final SubLObject var2, final SubLObject var3) {
        ...
        try {
            ...
            try {
                ...
                var9 = var8.first();
                while (NIL != var8) {
                    module0251.f16232(module0137.f8955($ic14$), var9, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    var8 = var8.rest();
                    var9 = var8.first();
                }
                final SubLObject var11_73 = module0141.$g1691$.currentBinding(var4);
                try {
                    module0141.$g1691$.bind((SubLObject)NIL, var4);
                    try {
                        if (NIL != module0144.$g1857$.getDynamicValue(var4)) {
                            module0305.f20436(Symbols.symbol_function((SubLObject)$ic25$));
                        }
                        module0256.f16587((SubLObject)ConsesLow.cons(var2, (SubLObject)ConsesLow.cons(var3, ConsesLow.nconc(module0259.f16821(var2, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), module0259.f16821(var3, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)))), Symbols.symbol_function((SubLObject)$ic26$), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    }
                    finally {
            ...
            try {
                Threads.$is_thread_performing_cleanupP$.bind((SubLObject)T, var4);
                f36683();
                if (NIL != module0141.$g1709$.getDynamicValue(var4)) {
                    SubLObject var11 = var5;
                    SubLObject var12 = (SubLObject)NIL;
                    var12 = var11.first();
                    while (NIL != var11) {
                        module0251.f16236(module0137.f8955($ic16$), var12, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                        var11 = var11.rest();
                        var12 = var11.first();
                    }
                }
                ...
                var13 = var11.first();
                while (NIL != var11) {
                    module0251.f16236(module0137.f8955($ic14$), var13, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    var11 = var11.rest();
                    var13 = var11.first();
                }
                if (NIL != module0144.$g1857$.getDynamicValue(var4)) {
                    ...
                    try {
                        module0141.$g1670$.bind(module0137.f8955($ic14$), var4);
                        module0141.$g1671$.bind(module0244.f15739(module0137.f8955($ic14$)), var4);
                        module0141.$g1672$.bind(module0244.f15746(module0137.f8955($ic14$)), var4);
                        module0141.$g1674$.bind((SubLObject)NIL, var4);
                        module0137.$g1605$.bind(module0137.f8955($ic14$), var4);
                        module0305.f20436(Symbols.symbol_function((SubLObject)$ic27$));
                    }
                    finally {
    ...
    public static SubLObject f36678(final SubLObject var2, final SubLObject var3, final SubLObject var4) {
        ...
        if (NIL != module0161.f10513((SubLObject)$ic2$, var4)) {
            ...
            try {
                module0147.$g2094$.bind((SubLObject)$ic12$, var5);
                module0147.$g2095$.bind($ic13$, var5);
                var6 = f36700(var2, var3, (SubLObject)UNPROVIDED);
            }
            finally {
                module0147.$g2095$.rebind(var8, var5);
                module0147.$g2094$.rebind(var7, var5);
    ...
    public static SubLObject f36706(final SubLObject var56, final SubLObject var90) {
        ...
        if (NIL == module0251.f16239(var56, (SubLObject)UNPROVIDED)) {
            ...
            try {
                ...
                var92 = (SubLObject)makeBoolean(NIL != module0305.f20364(var56, module0144.$g1834$.getDynamicValue(var91), var90, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0305.f20364(var56, module0144.$g1835$.getDynamicValue(var91), var90, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
            ...
            if (NIL != var92) {
                module0256.f16585(Symbols.symbol_function((SubLObject)$ic26$), var56, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            }
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f36707(final SubLObject var56) {
        ...
        try {
            module0018.$g590$.bind((SubLObject)ONE_INTEGER, var57);
            module0144.$g1749$.bind((SubLObject)T, var57);
            module0144.$g1748$.bind((SubLObject)NIL, var57);
            SubLObject var61 = module0259.f16850($ic29$);
            SubLObject var62 = (SubLObject)NIL;
            var62 = var61.first();
            while (NIL != var61) {
                module0219.f14477(Symbols.symbol_function((SubLObject)$ic28$), var56, (SubLObject)TWO_INTEGER, var62, (SubLObject)$ic21$, (SubLObject)UNPROVIDED);
                var61 = var61.rest();
                var62 = var61.first();
            }
        }
    ...
    public static SubLObject f36708(final SubLObject var56) {
        ...
        try {
            ...
            try {
                module0144.$g1749$.bind((SubLObject)T, var57);
                SubLObject var59 = module0259.f16850($ic29$);
                SubLObject var60 = (SubLObject)NIL;
                var60 = var59.first();
                while (NIL != var59) {
                    module0219.f14477(Symbols.symbol_function((SubLObject)$ic28$), var56, (SubLObject)TWO_INTEGER, var60, (SubLObject)$ic21$, (SubLObject)UNPROVIDED);
                    var59 = var59.rest();
                    var60 = var59.first();
                }
            }
            ...
            try {
                module0144.$g1748$.bind((SubLObject)T, var57);
                SubLObject var59 = module0259.f16850($ic30$);
                SubLObject var61 = (SubLObject)NIL;
                var61 = var59.first();
                while (NIL != var59) {
                    module0219.f14477(Symbols.symbol_function((SubLObject)$ic28$), var56, (SubLObject)TWO_INTEGER, var61, (SubLObject)$ic21$, (SubLObject)UNPROVIDED);
                    var59 = var59.rest();
                    var61 = var59.first();
                }
            }
    ...
    public static SubLObject f36709(final SubLObject var1) {
        ...
        if (NIL != module0178.f11284(var1)) {
            ...
            if (NIL != module0173.f10955(var3) && NIL == module0251.f16239(var3, (SubLObject)UNPROVIDED) && NIL != module0210.f13568(var3) && NIL != f36710(var3)) {
                module0141.$g1691$.setDynamicValue((SubLObject)ConsesLow.cons(var3, module0141.$g1691$.getDynamicValue(var2)), var2);
                if (NIL != module0141.$g1709$.getDynamicValue(var2)) {
                    module0251.f16232(module0137.f8955($ic16$), var3, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                }
            }
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f36710(final SubLObject var32) {
        ...
        return (SubLObject)makeBoolean((NIL == module0144.$g1749$.getDynamicValue(var33) || NIL != f36713(var32)) && (NIL == module0144.$g1748$.getDynamicValue(var33) || NIL != f36714(var32)));
    }
    
    public static SubLObject f36711() {
        final SubLObject var96 = $g4649$.getGlobalValue();
        if (NIL != var96) {
    ...
    public static SubLObject f36715(final SubLObject var32) {
        return module0034.f1829($g4649$.getGlobalValue(), (SubLObject)ConsesLow.list(var32), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f36716(final SubLObject var32) {
        return f36717(var32, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f36713(final SubLObject var32) {
        SubLObject var33 = $g4649$.getGlobalValue();
        if (NIL == var33) {
            var33 = module0034.f1934((SubLObject)$ic31$, (SubLObject)$ic32$, (SubLObject)$ic33$, (SubLObject)EQL, (SubLObject)ONE_INTEGER, (SubLObject)$ic34$);
        }
        SubLObject var34 = module0034.f1814(var33, var32, (SubLObject)$ic35$);
        if (var34 == $ic35$) {
    ...
    public static SubLObject f36717(final SubLObject var32, SubLObject var99, SubLObject var100) {
        ...
        if (NIL != module0225.f14775(var32)) {
            SubLObject var102 = (SubLObject)NIL;
            if (NIL == var102) {
                SubLObject var103 = module0226.f14888(var32, (SubLObject)UNPROVIDED);
                ...
                while (NIL == var102 && NIL != var103) {
                    ...
                    try {
                        ...
                        if (NIL == module0251.f16239(var104, (SubLObject)UNPROVIDED)) {
                            var102 = (SubLObject)T;
                        }
                    }
                    finally {
        ...
        if (NIL != module0202.f12909(var107) && NIL == var106) {
            ...
            while (NIL == var106 && NIL != var108) {
                if (var109.numLE(var107)) {
                    ...
                    try {
                        ...
                        if (NIL != f36718(var32, module0226.f14903(var109, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), (SubLObject)ONE_INTEGER, (SubLObject)TWO_INTEGER, var99, (SubLObject)UNPROVIDED) && NIL == var106) {
                            SubLObject var102_107 = module0146.$g1959$.getGlobalValue();
                            SubLObject var111 = (SubLObject)NIL;
                            var111 = var102_107.first();
                            while (NIL == var106 && NIL != var102_107) {
                                if (var111.numLE(var107) && !var109.numE(var111)) {
                                    ...
                                    try {
                                        ...
                                        var106 = f36718(var32, module0226.f14903(var111, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), (SubLObject)ONE_INTEGER, (SubLObject)TWO_INTEGER, var100, (SubLObject)UNPROVIDED);
                                    }
                                    finally {
    ...
    public static SubLObject f36712() {
        final SubLObject var96 = $g4650$.getGlobalValue();
        if (NIL != var96) {
            module0034.f1818(var96);
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f36719(final SubLObject var32) {
        return module0034.f1829($g4650$.getGlobalValue(), (SubLObject)ConsesLow.list(var32), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f36720(final SubLObject var32) {
        return f36721(var32, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f36714(final SubLObject var32) {
        SubLObject var33 = $g4650$.getGlobalValue();
        if (NIL == var33) {
            var33 = module0034.f1934((SubLObject)$ic36$, (SubLObject)$ic37$, (SubLObject)$ic33$, (SubLObject)EQL, (SubLObject)ONE_INTEGER, (SubLObject)$ic34$);
        }
        SubLObject var34 = module0034.f1814(var33, var32, (SubLObject)$ic35$);
        if (var34 == $ic35$) {
    ...
    public static SubLObject f36721(final SubLObject var32, SubLObject var110, SubLObject var111) {
        ...
        if (NIL != module0225.f14775(var32)) {
            ...
            if (NIL == var113) {
                SubLObject var114 = module0226.f14941(var32, (SubLObject)UNPROVIDED);
                SubLObject var115 = (SubLObject)NIL;
                var115 = var114.first();
                while (NIL == var113 && NIL != var114) {
                    SubLObject var116 = module0139.$g1659$.currentBinding(var112);
                    try {
                        module0139.$g1659$.bind(var110, var112);
                        if (NIL == module0251.f16239(var115, (SubLObject)UNPROVIDED)) {
                            var113 = (SubLObject)T;
                        }
                    }
                    finally {
            ...
            while (NIL == var117 && NIL != var119) {
                if (var120.numLE(var118)) {
                    ...
                    try {
                        ...
                        if (NIL != f36718(var32, module0226.f14947(var120, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), (SubLObject)ONE_INTEGER, (SubLObject)TWO_INTEGER, var110, (SubLObject)UNPROVIDED) && NIL == var117) {
                            SubLObject var102_113 = module0146.$g1959$.getGlobalValue();
                            SubLObject var122 = (SubLObject)NIL;
                            var122 = var102_113.first();
                            while (NIL == var117 && NIL != var102_113) {
                                if (var122.numLE(var118) && !var120.numE(var122)) {
                                    ...
                                    try {
                                        ...
                                        var117 = f36718(var32, module0226.f14947(var122, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), (SubLObject)ONE_INTEGER, (SubLObject)TWO_INTEGER, var111, (SubLObject)UNPROVIDED);
                                    }
                                    finally {
    ...
    public static SubLObject f36718(final SubLObject var115, final SubLObject var32, final SubLObject var116, final SubLObject var117, final SubLObject var118, SubLObject var119) {
        ...
        try {
            ...
            module0018.$g584$.bind((SubLObject)NIL, var120);
            module0018.$g590$.bind(var117, var120);
            module0219.f14477(Symbols.symbol_function((SubLObject)$ic38$), var115, var116, var32, var119, (SubLObject)UNPROVIDED);
        ...
        return (SubLObject)makeBoolean(NIL == var121);
    }
    
    public static SubLObject f36722(final SubLObject var1) {
        final SubLThread var2 = SubLProcess.currentSubLThread();
        if (NIL == module0251.f16239(module0178.f11331(var1, module0018.$g590$.getDynamicValue(var2)), (SubLObject)UNPROVIDED) && NIL == ((NIL != module0144.$g1832$.getDynamicValue(var2) && NIL != module0144.$g1857$.getDynamicValue(var2)) ? module0305.f20337(module0178.f11331(var1, module0018.$g590$.getDynamicValue(var2)), module0144.$g1832$.getDynamicValue(var2), (SubLObject)UNPROVIDED) : NIL)) {
            module0018.$g584$.setDynamicValue((SubLObject)T, var2);
            module0012.f425();
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f36729(final SubLObject var120, final SubLObject var37, final SubLObject var125, final SubLObject var126, SubLObject var4) {
        ...
        final SubLObject var127 = module0035.f2269(var125, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        final SubLObject var128 = module0035.f2269(var126, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        final SubLObject var129 = module0035.f2220(var127, var128, (SubLObject)UNPROVIDED);
        return (SubLObject)makeBoolean(NIL == var129 || NIL == conses_high.subsetp(var129, f36728(var120, var37, ConsesLow.append(var129, var128), var4), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
    }
    ...
    public static SubLObject f36724(final SubLObject var36, final SubLObject var37, SubLObject var4) {
        ...
        return module0220.f14597(var36, $ic39$, var37, var4, (SubLObject)ONE_INTEGER, (SubLObject)THREE_INTEGER, (SubLObject)TWO_INTEGER, (SubLObject)$ic21$);
    }
    ...
    public static SubLObject f36726(final SubLObject var36, final SubLObject var37, SubLObject var4) {
        ...
        return module0220.f14597(var36, $ic40$, var37, var4, (SubLObject)ONE_INTEGER, (SubLObject)THREE_INTEGER, (SubLObject)TWO_INTEGER, (SubLObject)$ic21$);
    }
    ...
    public static SubLObject f36725(final SubLObject var120, final SubLObject var130, SubLObject var4) {
        ...
        if (NIL != module0244.f15730(var120)) {
            final SubLObject var131 = module0252.f16260(module0137.f8955(var120), var130, var4, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            return var131;
        }
        if (NIL != module0226.f14800(var120)) {
            return module0315.f21322(var120, var130, var4, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f36727(final SubLObject var120, final SubLObject var130, SubLObject var4) {
        ...
        if (NIL != module0244.f15730(var120)) {
            final SubLObject var131 = module0252.f16262(module0137.f8955(var120), var130, var4, (SubLObject)UNPROVIDED);
            return var131;
        }
        if (NIL != module0226.f14800(var120)) {
    ...
    public static SubLObject f36731() {
        $g4646$ = SubLFiles.defparameter("S#40531", (SubLObject)NIL);
        $g4647$ = SubLFiles.defparameter("S#40532", (SubLObject)NIL);
        $g4648$ = SubLFiles.defparameter("S#40533", (SubLObject)NIL);
        $g4649$ = SubLFiles.deflexical("S#40534", (SubLObject)NIL);
        $g4650$ = SubLFiles.deflexical("S#40535", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f36732() {
        module0012.f368((SubLObject)$ic7$, (SubLObject)$ic8$, (SubLObject)$ic9$, (SubLObject)$ic10$, (SubLObject)$ic11$);
    ...
    static {
        ...
        $g4649$ = null;
        $g4650$ = null;
        $ic0$ = makeKeyword("BOGUS");
        $ic1$ = makeKeyword("FREE");
        $ic2$ = makeKeyword("ALL");
        $ic3$ = makeKeyword("MIXED");
        $ic4$ = makeSymbol("FORT-P");
        $ic5$ = makeKeyword("FIGURATIVE");
        $ic6$ = makeKeyword("LITERAL");
        $ic7$ = makeSymbol("PREDS-FOR-PAIR");
        $ic8$ = ConsesLow.list((SubLObject)makeSymbol("S#12115", "CYC"), (SubLObject)makeSymbol("S#12116", "CYC"), (SubLObject)makeSymbol("&OPTIONAL"), (SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#11445", "CYC"), (SubLObject)makeKeyword("ALL")), (SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#4785", "CYC"), (SubLObject)makeKeyword("MIXED")));
        $ic9$ = makeString("Return a list of the predicates relevant to relating FORT-1 and FORT-2.\nMODE may be :figurative (instances of collections), \n:literal (constants), or \n:mixed (referents).");
        $ic10$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#12115", "CYC"), (SubLObject)makeSymbol("FORT-P")), (SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#12116", "CYC"), (SubLObject)makeSymbol("FORT-P")));
        $ic11$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)makeSymbol("LIST"), (SubLObject)makeSymbol("FORT-P")));
        ...
        $ic15$ = makeSymbol("S#40510", "CYC");
        $ic16$ = constant_handles_oc.f8479((SubLObject)makeString("genlPreds"));
        $ic17$ = makeInteger(512);
        $ic18$ = makeSymbol("S#40488", "CYC");
        $ic19$ = makeSymbol("S#40489", "CYC");
        $ic20$ = constant_handles_oc.f8479((SubLObject)makeString("argIsa"));
        $ic21$ = makeKeyword("TRUE");
        $ic22$ = constant_handles_oc.f8479((SubLObject)makeString("isa"));
        $ic23$ = makeSymbol("S#40491", "CYC");
        $ic24$ = makeSymbol("S#40494", "CYC");
        $ic25$ = makeSymbol("S#40509", "CYC");
        $ic26$ = makeSymbol("S#40511", "CYC");
        $ic27$ = makeSymbol("S#18973", "CYC");
        $ic28$ = makeSymbol("S#40512", "CYC");
        $ic29$ = constant_handles_oc.f8479((SubLObject)makeString("ArgIsaBinaryPredicate"));
        $ic30$ = constant_handles_oc.f8479((SubLObject)makeString("ArgGenlBinaryPredicate"));
        $ic31$ = makeSymbol("S#40518", "CYC");
        $ic32$ = makeSymbol("S#40534", "CYC");
        $ic33$ = makeInteger(4096);
        $ic34$ = makeInteger(2048);
        $ic35$ = makeKeyword("&MEMOIZED-ITEM-NOT-FOUND&");
        $ic36$ = makeSymbol("S#40523", "CYC");
        $ic37$ = makeSymbol("S#40535", "CYC");
        $ic38$ = makeSymbol("S#40526", "CYC");
        $ic39$ = constant_handles_oc.f8479((SubLObject)makeString("transitiveViaArg"));
        $ic40$ = constant_handles_oc.f8479((SubLObject)makeString("transitiveViaArgInverse"));
    }
}
