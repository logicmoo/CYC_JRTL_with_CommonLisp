...
public final class module0066 extends SubLTranslatedFile
{
    ...
    public static SubLObject f4812(final SubLObject var1) {
        if (module0066.NIL != module0035.f2292(var1)) {
            return (SubLObject)module0066.$ic3$;
        }
        if (var1.isHashtable()) {
            return (SubLObject)module0066.$ic4$;
        }
        return (SubLObject)module0066.$ic5$;
    }
    
    public static SubLObject f4813(final SubLObject var1) {
        return Errors.error((SubLObject)module0066.$ic6$, f4812(var1));
    }
    ...
    public static SubLObject f4817(SubLObject var1, final SubLObject var2, final SubLObject var5, final SubLObject var3) {
        final SubLObject var6 = conses_high.assoc(var2, var1, var3, (SubLObject)module0066.UNPROVIDED);
        if (module0066.NIL != var6) {
            ConsesLow.rplacd(var6, var5);
        }
        else {
            var1 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.cons(var2, var5), var1);
            if (Sequences.length(var1).numG(module0066.$g1083$.getGlobalValue())) {
    ...
    public static SubLObject f4822(SubLObject var1, final SubLObject var2) {
        ...
        if (Hashtables.hash_table_count(var1).numL(module0066.$g1084$.getGlobalValue())) {
    ...
    public static SubLObject f4823(final SubLObject var7) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0066.NIL != module0035.f2292(var7) || var7.isHashtable());
    }
    
    public static SubLObject f4824(SubLObject var8, SubLObject var3) {
        if (var8 == module0066.UNPROVIDED) {
            var8 = (SubLObject)module0066.ZERO_INTEGER;
        }
        if (var3 == module0066.UNPROVIDED) {
            var3 = Symbols.symbol_function((SubLObject)module0066.EQL);
        }
        if (var8.numG(module0066.$g1083$.getGlobalValue())) {
            return Hashtables.make_hash_table(var8, var3, (SubLObject)module0066.UNPROVIDED);
        }
        return (SubLObject)module0066.NIL;
    }
    
    public static SubLObject f4825(final SubLObject var1) {
        final SubLObject var2 = f4812(var1);
        if (var2.eql((SubLObject)module0066.$ic3$)) {
            return conses_high.copy_alist(var1);
        }
        if (var2.eql((SubLObject)module0066.$ic4$)) {
            return module0030.f1611(var1, (SubLObject)module0066.UNPROVIDED);
        }
        return f4813(var1);
    }
    ...
    public static SubLObject f4828(final SubLObject var7) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0066.NIL != f4823(var7) && module0066.NIL == f4827(var7));
    }
    
    public static SubLObject f4829(final SubLObject var1, final SubLObject var2, final SubLObject var3) {
        return Values.nth_value_step_2(Values.nth_value_step_1((SubLObject)module0066.ONE_INTEGER), f4830(var1, var2, var3, (SubLObject)module0066.UNPROVIDED));
    }
    
    public static SubLObject f4830(final SubLObject var1, final SubLObject var2, final SubLObject var3, SubLObject var4) {
        if (var4 == module0066.UNPROVIDED) {
            var4 = (SubLObject)module0066.NIL;
        }
        final SubLObject var5 = f4812(var1);
        if (var5.eql((SubLObject)module0066.$ic3$)) {
            return f4814(var1, var2, var3, var4);
        }
        if (var5.eql((SubLObject)module0066.$ic4$)) {
    ...
    public static SubLObject f4833(final SubLObject var1, final SubLObject var2, final SubLObject var5, final SubLObject var3) {
        ...
        if (var6.eql((SubLObject)module0066.$ic3$)) {
            return f4817(var1, var2, var5, var3);
        }
        if (var6.eql((SubLObject)module0066.$ic4$)) {
    ...
    public static SubLObject f4834(final SubLObject var1, final SubLObject var2, final SubLObject var3) {
        ...
        if (var4.eql((SubLObject)module0066.$ic3$)) {
            return f4818(var1, var2, var3);
        }
        if (var4.eql((SubLObject)module0066.$ic4$)) {
    ...
    public static SubLObject f4835(final SubLObject var1) {
        ...
        return f4824((SubLObject)module0066.ZERO_INTEGER, (SubLObject)module0066.UNPROVIDED);
    }
    ...
    public static SubLObject f4837(final SubLObject var10, final SubLObject var11) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var13, var12, (SubLObject)module0066.$ic9$);
        final SubLObject var14 = var13.rest();
        var13 = var13.first();
        SubLObject var15 = (SubLObject)module0066.NIL;
        SubLObject var16 = (SubLObject)module0066.NIL;
        SubLObject var17 = (SubLObject)module0066.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var13, var12, (SubLObject)module0066.$ic9$);
        var15 = var13.first();
        var13 = var13.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var13, var12, (SubLObject)module0066.$ic9$);
        ...
        var17 = var13.first();
        var13 = var13.rest();
        SubLObject var18 = (SubLObject)module0066.NIL;
        SubLObject var19 = var13;
        SubLObject var20 = (SubLObject)module0066.NIL;
        SubLObject var18_19 = (SubLObject)module0066.NIL;
        while (module0066.NIL != var19) {
            cdestructuring_bind.destructuring_bind_must_consp(var19, var12, (SubLObject)module0066.$ic9$);
            var18_19 = var19.first();
            var19 = var19.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var19, var12, (SubLObject)module0066.$ic9$);
            if (module0066.NIL == conses_high.member(var18_19, (SubLObject)module0066.$ic10$, (SubLObject)module0066.UNPROVIDED, (SubLObject)module0066.UNPROVIDED)) {
                var20 = (SubLObject)module0066.T;
            }
            if (var18_19 == module0066.$ic11$) {
                var18 = var19.first();
            }
            var19 = var19.rest();
        }
        if (module0066.NIL != var20 && module0066.NIL == var18) {
            cdestructuring_bind.cdestructuring_bind_error(var12, (SubLObject)module0066.$ic9$);
        }
        final SubLObject var21 = cdestructuring_bind.property_list_member((SubLObject)module0066.$ic12$, var13);
        final SubLObject var22 = (SubLObject)((module0066.NIL != var21) ? conses_high.cadr(var21) : module0066.NIL);
        final SubLObject var23;
        var13 = (var23 = var14);
        final SubLObject var24 = (SubLObject)module0066.$ic13$;
        return (SubLObject)ConsesLow.list((SubLObject)module0066.$ic14$, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(var24, (SubLObject)ConsesLow.list((SubLObject)module0066.$ic15$, var17))), (SubLObject)ConsesLow.list((SubLObject)module0066.$ic16$, (SubLObject)ConsesLow.list((SubLObject)module0066.$ic17$, var22, (SubLObject)ConsesLow.list((SubLObject)module0066.$ic18$, var24)), (SubLObject)ConsesLow.listS((SubLObject)module0066.$ic19$, (SubLObject)ConsesLow.list(var15, var16), (SubLObject)ConsesLow.list((SubLObject)module0066.$ic20$, var24), ConsesLow.append(var23, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)module0066.$ic21$, var24, (SubLObject)ConsesLow.list((SubLObject)module0066.$ic22$, var24)))))), (SubLObject)ConsesLow.list((SubLObject)module0066.$ic23$, var24));
    }
    ...
    public static SubLObject f4842(final SubLObject var24) {
        if (module0066.NIL != hashtables_high.hash_table_iterator_p(var24)) {
    ...
    public static SubLObject f4843(final SubLObject var1, final SubLObject var26, SubLObject var27) {
        if (var27 == module0066.UNPROVIDED) {
            var27 = (SubLObject)module0066.NIL;
        }
        final SubLThread var28 = SubLProcess.currentSubLThread();
        SubLObject var29;
        for (var29 = f4838(var1); module0066.NIL == f4841(var29); var29 = f4840(var29)) {
    ...
    public static SubLObject f4846(final SubLObject var1) {
        ...
        SubLObject var4;
        SubLObject var5;
        for (var3 = (SubLObject)module0066.NIL, var4 = f4838(var1); module0066.NIL == var3 && module0066.NIL == f4841(var4); var3 = var5, var4 = f4840(var4)) {
    ...
    public static SubLObject f4848() {
        module0066.$g1083$ = SubLFiles.deflexical("S#6420", (SubLObject)module0066.$ic0$);
        module0066.$g1084$ = SubLFiles.deflexical("S#6421", (SubLObject)module0066.$ic1$);
        return (SubLObject)module0066.NIL;
    }
    
    public static SubLObject f4849() {
        SubLSpecialOperatorDeclarations.proclaim((SubLObject)module0066.$ic2$);
        SubLSpecialOperatorDeclarations.proclaim((SubLObject)module0066.$ic7$);
        SubLSpecialOperatorDeclarations.proclaim((SubLObject)module0066.$ic8$);
        module0002.f50((SubLObject)module0066.$ic15$, (SubLObject)module0066.$ic24$);
        module0002.f50((SubLObject)module0066.$ic20$, (SubLObject)module0066.$ic25$);
        module0002.f50((SubLObject)module0066.$ic22$, (SubLObject)module0066.$ic25$);
        module0002.f50((SubLObject)module0066.$ic18$, (SubLObject)module0066.$ic25$);
        module0002.f50((SubLObject)module0066.$ic23$, (SubLObject)module0066.$ic25$);
        return (SubLObject)module0066.NIL;
    }
    ...
    static {
        ...
        module0066.$g1083$ = null;
        module0066.$g1084$ = null;
        $ic0$ = SubLObjectFactory.makeInteger(40);
        $ic1$ = SubLObjectFactory.makeInteger(30);
        $ic2$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("INLINE"), (SubLObject)SubLObjectFactory.makeSymbol("S#6385", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#6386", "CYC"));
        $ic3$ = SubLObjectFactory.makeKeyword("ALIST");
        $ic4$ = SubLObjectFactory.makeKeyword("HASHTABLE");
        $ic5$ = SubLObjectFactory.makeKeyword("UNKNOWN");
        $ic6$ = SubLObjectFactory.makeString("Corrupted dictionary-contents; unsupported style ~S.~%");
        $ic7$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("INLINE"), (SubLObject)SubLObjectFactory.makeSymbol("S#6387", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#6388", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#6390", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#6391", "CYC"));
        $ic8$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("INLINE"), (SubLObject)SubLObjectFactory.makeSymbol("S#6392", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#6393", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#6394", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#6395", "CYC"));
        $ic9$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#131", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#132", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#6422", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("&KEY"), (SubLObject)SubLObjectFactory.makeSymbol("S#127", "CYC")), (SubLObject)SubLObjectFactory.makeSymbol("&BODY"), (SubLObject)SubLObjectFactory.makeSymbol("S#5", "CYC"));
        $ic10$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("DONE"));
        $ic11$ = SubLObjectFactory.makeKeyword("ALLOW-OTHER-KEYS");
        $ic12$ = SubLObjectFactory.makeKeyword("DONE");
        $ic13$ = SubLObjectFactory.makeUninternedSymbol("US#6C9EB35");
        $ic14$ = SubLObjectFactory.makeSymbol("CLET");
        $ic15$ = SubLObjectFactory.makeSymbol("S#6411", "CYC");
        $ic16$ = SubLObjectFactory.makeSymbol("UNTIL");
        $ic17$ = SubLObjectFactory.makeSymbol("COR");
        $ic18$ = SubLObjectFactory.makeSymbol("S#6414", "CYC");
        $ic19$ = SubLObjectFactory.makeSymbol("CMULTIPLE-VALUE-BIND");
        $ic20$ = SubLObjectFactory.makeSymbol("S#6412", "CYC");
        $ic21$ = SubLObjectFactory.makeSymbol("CSETQ");
        $ic22$ = SubLObjectFactory.makeSymbol("S#6413", "CYC");
        $ic23$ = SubLObjectFactory.makeSymbol("S#6415", "CYC");
        $ic24$ = SubLObjectFactory.makeSymbol("S#6410", "CYC");
        $ic25$ = SubLObjectFactory.makeSymbol("DO-DICTIONARY");
    }
}
...
/*
	...
	Decompiled from: G:\opt\CYC_JRTL_with_CommonLisp\platform\lib\cyc-oc4.0-unzipped/com/cyc/cycjava/cycl/module0066.class
	Total time: 107 ms
