...
public final class module0728 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic16$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("comparativeDegree"));
        $ic17$ = SubLObjectFactory.makeSymbol("S#48657", "CYC");
        $ic18$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("superlativeDegree"));
        $ic19$ = SubLObjectFactory.makeSymbol("S#48659", "CYC");
        $ic20$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("comparativeAdverb"));
        $ic21$ = SubLObjectFactory.makeSymbol("S#48658", "CYC");
        $ic22$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("superlativeAdverb"));
        ...
        $ic27$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("regularSuffix"));
        ...
        $ic31$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("plural-Generic"));
        $ic32$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("singular-Generic"));
        $ic33$ = ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("plural")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("pnPlural")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("agentive-Pl")));
        $ic34$ = SubLObjectFactory.makeString("z");
        $ic35$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("EnglishLexiconMt"));
        $ic36$ = ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("regularDegree")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("regularAdverb")));
        $ic37$ = ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("comparativeDegree")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("superlativeDegree")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("comparativeAdverb")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("superlativeAdverb")));
        ...
        $ic90$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("pastTense-Universal"));
        $ic91$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("infinitive"));
        $ic92$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("gerund"));
        $ic93$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("thirdPersonSg-Present"));
        $ic94$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("plural"));
        $ic95$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("singular"));
        $ic96$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("EnglishMt"));
        $ic97$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("presentParticiple"));
        ...
        $ic103$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("QuantifyingIndexical"));
        $ic104$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("GeographicalRegion"));
        $ic105$ = SubLObjectFactory.makeString("in");
        $ic106$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SurfaceRegion-Underspecified"));
        ...
        $ic128$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Verb"));
        $ic129$ = SubLObjectFactory.makeString("en");
        $ic130$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CountNoun"));
        $ic131$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Number-SP"));
        $ic132$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ProperCountNoun"));
        $ic133$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Adjective"));
        $ic134$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Adverb"));
        ...
        $ic192$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("pnSingular"));
        $ic193$ = SubLObjectFactory.makeKeyword("NOUN");
        $ic194$ = SubLObjectFactory.makeKeyword("ADJECTIVE");
        $ic195$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("regularDegree"));
        $ic196$ = SubLObjectFactory.makeKeyword("ADVERB");
        $ic197$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("regularAdverb"));
        $ic198$ = SubLObjectFactory.makeKeyword("PREPOSITION");
        $ic199$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("prepositionStrings"));
        ...
        $ic203$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("GeneralEnglishMt"));
        $ic204$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Be-Contracted"));
        $ic205$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Be-TheWord"));
        $ic206$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Will-Contracted"));
        $ic207$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Will-TheModal"));
        $ic208$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Have-Contracted"));
        $ic209$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Have-TheWord"));
        $ic210$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Would-Contracted"));
        $ic211$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Would-TheWord"));
    }
