...
public final class module0776 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic5$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("True-JustificationTruth"));
        ...
        $ic26$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NCPOSConstraintFn"));
        $ic27$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NCPOSPredConstraintFn"));
        $ic28$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NCEqualsConstraintFn"));
        $ic29$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NCGenlsConstraintFn"));
        $ic30$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NCIsaConstraintFn"));
        $ic31$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheNCModifier"));
        $ic32$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TheNCHead"));
        $ic33$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NounCompoundRule"));
        $ic34$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ncRuleTemplate"));
        $ic35$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ncRuleConstraint"));
        $ic36$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("GeneralLexiconMt"));
        ...
        $ic43$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CountNoun"));
        ...
        $ic48$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EverythingPSC"));
