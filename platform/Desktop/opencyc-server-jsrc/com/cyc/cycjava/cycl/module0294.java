...
public final class module0294 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic10$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("EverythingPSC"));
        $ic11$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ReformulatorTestCase"));
        ...
        $ic22$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("reformulatorTestCaseModuleTested"));
        ...
        $ic28$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("reformulatorTestCaseInputExpression"));
        $ic29$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("ANSWER"));
        $ic30$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("reformulatorTestCaseOutputExpression"));
        $ic31$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("reformulatorTestCaseMicrotheory"));
        $ic32$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("reformulatorTestCaseSettings"));
        $ic33$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("reformulatorTestCaseRequiresRecursion"));
