...
public final class module0269 extends SubLTranslatedFile
{
    ...
    public static SubLObject f17837(final SubLObject var1) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0269.NIL != module0128.f8449(var1) && module0269.NIL == f17836(var1));
    }
    ...
    static {
        ...
        $ic4$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Collection"));
        $ic5$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Function-Denotational"));
        $ic6$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Predicate"));
        $ic7$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Microtheory"));
        ...
        $ic11$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Relation"));
        $ic12$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SententialRelation"));
        $ic13$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("AntiSymmetricBinaryPredicate"));
        $ic14$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("AntiTransitiveBinaryPredicate"));
        $ic15$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ArgTypeBinaryPredicate"));
        $ic16$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ArgQuotedIsaBinaryPredicate"));
        $ic17$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ArgFormatBinaryPredicate"));
        $ic18$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ArgTypeTernaryPredicate"));
        $ic19$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ArgQuotedIsaTernaryPredicate"));
        $ic20$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ArgFormatTernaryPredicate"));
        $ic21$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("AsymmetricBinaryPredicate"));
        $ic22$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("BookkeepingPredicate"));
        $ic23$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("UnderspecifiedPredicate"));
        $ic24$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("BroadMicrotheory"));
        ...
        $ic29$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CommutativeRelation"));
        $ic30$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CommutativePredicate"));
        $ic31$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("DistributingMetaKnowledgePredicate"));
        $ic32$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ELRelation"));
        $ic33$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("EvaluatableFunction"));
        $ic34$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("EvaluatablePredicate"));
        $ic35$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ExistentialQuantifier"));
        $ic36$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("IrreflexiveBinaryPredicate"));
        $ic37$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("LogicalConnective"));
        $ic38$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("MicrotheoryDesignatingRelation"));
        $ic39$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("PartiallyCommutativeRelation"));
        $ic40$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("PartiallyCommutativePredicate"));
        $ic41$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ProblemSolvingCntxt"));
        $ic42$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Quantifier"));
        $ic43$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ReflexiveBinaryPredicate"));
        $ic44$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ReifiableFunction"));
        $ic45$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("RuleMacroPredicate"));
        $ic46$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ScopingRelation"));
        $ic47$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SiblingDisjointCollectionType"));
        $ic48$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("DisjointCollectionType"));
        $ic49$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SkolemFunction"));
        $ic50$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SymmetricBinaryPredicate"));
        $ic51$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TransitiveBinaryPredicate"));
        $ic52$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("VariableArityRelation"));
        $ic53$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("DocumentationPredicate"));
        $ic54$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SKSIContentMicrotheory"));
        $ic55$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SKSIExternalTermDenotingFunction"));
        $ic56$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SKSISupportedComparisonPredicate"));
        $ic57$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SKSISupportedFunction"));
        $ic58$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CSQLComparisonPredicate"));
        $ic59$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("SKSISupportedConstant"));
        $ic60$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CSQLFunction"));
        $ic61$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CSQLLogicalConnective"));
        $ic62$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CSQLQuantifier"));
        $ic63$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CSQLConstantFunction"));
        $ic64$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("NLDefinitenessAttribute"));
        $ic65$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("NLQuantAttribute"));
        $ic66$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ExistentialQuantifier-Bounded"));
        $ic67$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("EvaluatableRelation-Contextualized"));
        $ic68$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("PublicConstant"));
        $ic69$ = SubLObjectFactory.makeSymbol("S#20372", "CYC");
        $ic70$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ProprietaryConstant"));
        ...
        $ic75$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ProprietaryTerm"));
        ...
        $ic79$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("City"));
        $ic80$ = SubLObjectFactory.makeSymbol("S#20380", "CYC");
        $ic81$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("GeographicalRegion"));
        $ic82$ = SubLObjectFactory.makeSymbol("S#20382", "CYC");
        $ic83$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Country"));
    }
