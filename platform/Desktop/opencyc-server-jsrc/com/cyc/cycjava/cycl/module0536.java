...
public final class module0536 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic3$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nonAbducibleSentence"));
        $ic4$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NonAbducibleRelation"));
        $ic5$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NonAbduciblePredicate"));
        $ic6$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NonAbducibleCollection"));
        $ic7$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("notAbducibleForArg"));
        $ic8$ = SubLObjectFactory.makeKeyword("TRUE");
        $ic9$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("notAbducibleWRTValueInArg"));
        ...
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("notAbducibleWRTTypeInArg"));
