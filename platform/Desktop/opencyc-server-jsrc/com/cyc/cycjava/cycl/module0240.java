...
public final class module0240 extends SubLTranslatedFile
{
    ...
    public static SubLObject f15606(final SubLObject var1, final SubLObject var2) {
        ...
        SubLObject var5 = (SubLObject)module0240.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var4, var3, (SubLObject)module0240.$ic0$);
        var5 = var4.first();
        final SubLObject var6;
        var4 = (var6 = var4.rest());
        return (SubLObject)ConsesLow.listS((SubLObject)module0240.$ic1$, (SubLObject)ConsesLow.list(reader.bq_cons(var5, (SubLObject)module0240.$ic2$)), ConsesLow.append(var6, (SubLObject)module0240.NIL));
    }
    ...
    public static SubLObject f15607(final SubLObject var1, final SubLObject var2) {
        ...
        final SubLObject var3 = var4 = var1.rest();
        SubLObject var5 = (SubLObject)module0240.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var4, var3, (SubLObject)module0240.$ic3$);
        var5 = var4.first();
        final SubLObject var6;
        var4 = (var6 = var4.rest());
        return (SubLObject)ConsesLow.list((SubLObject)module0240.$ic1$, (SubLObject)module0240.$ic4$, (SubLObject)ConsesLow.listS((SubLObject)module0240.$ic5$, var5, ConsesLow.append(var6, (SubLObject)module0240.NIL)));
    }
    ...
    public static SubLObject f15608(final SubLObject var1, final SubLObject var2) {
        ...
        return (SubLObject)ConsesLow.listS((SubLObject)module0240.$ic1$, (SubLObject)module0240.$ic4$, ConsesLow.append(var5, (SubLObject)module0240.NIL));
    }
    
    public static SubLObject f15609(final SubLObject var1, final SubLObject var2) {
        SubLObject var4;
        final SubLObject var3 = var4 = var1.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var4, var3, (SubLObject)module0240.$ic6$);
        final SubLObject var5 = var4.rest();
        var4 = var4.first();
        SubLObject var6 = (SubLObject)module0240.NIL;
        SubLObject var7 = (SubLObject)module0240.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var4, var3, (SubLObject)module0240.$ic6$);
        var6 = var4.first();
        var4 = var4.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var4, var3, (SubLObject)module0240.$ic6$);
        var7 = var4.first();
        var4 = var4.rest();
        if (module0240.NIL == var4) {
            final SubLObject var8;
            var4 = (var8 = var5);
            return (SubLObject)ConsesLow.listS((SubLObject)module0240.$ic7$, (SubLObject)ConsesLow.listS(var6, var7, (SubLObject)module0240.$ic2$), ConsesLow.append(var8, (SubLObject)module0240.NIL));
        }
        cdestructuring_bind.cdestructuring_bind_error(var3, (SubLObject)module0240.$ic6$);
        return (SubLObject)module0240.NIL;
    }
    
    public static SubLObject f15610() {
        final SubLThread var17 = SubLProcess.currentSubLThread();
        SubLObject var18 = (SubLObject)module0240.NIL;
        final SubLObject var19 = module0240.$g2447$.getDynamicValue(var17);
        SubLObject var20 = (SubLObject)module0240.NIL;
        SubLObject var21 = (SubLObject)module0240.NIL;
    ...
    public static SubLObject f15611() {
        return Hashtables.make_hash_table((SubLObject)module0240.$ic8$, (SubLObject)module0240.UNPROVIDED, (SubLObject)module0240.UNPROVIDED);
    }
    
    public static SubLObject f15612(final SubLObject var24, final SubLObject var20) {
        return Hashtables.gethash(var20, module0134.f8744(var24), (SubLObject)module0240.UNPROVIDED);
    }
    
    public static SubLObject f15613(final SubLObject var24, final SubLObject var20) {
        return Hashtables.gethash(var20, module0134.f8745(var24), (SubLObject)module0240.UNPROVIDED);
    }
    ...
    public static SubLObject f15616(final SubLObject var20, final SubLObject var25) {
        return module0035.sublisp_boolean(Hashtables.gethash(var20, var25, (SubLObject)module0240.UNPROVIDED));
    }
    ...
    public static SubLObject f15620(final SubLObject var20, final SubLObject var26) {
        ...
        f15617(var20, var26, module0240.$g2447$.getDynamicValue(var27));
        return (SubLObject)module0240.NIL;
    }
    
    public static SubLObject f15621(final SubLObject var24, final SubLObject var20) {
        f15618(var24, var20, (SubLObject)module0240.NIL);
        return (SubLObject)module0240.NIL;
    }
    ...
    public static SubLObject f15625(final SubLObject var24, final SubLObject var20) {
        f15619(var24, var20, (SubLObject)module0240.T);
        return (SubLObject)module0240.NIL;
    }
    ...
    public static SubLObject f15628() {
        module0240.$g2447$ = SubLFiles.defparameter("S#18386", (SubLObject)module0240.NIL);
        return (SubLObject)module0240.NIL;
    }
    ...
    static {
        ...
        $ic4$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#18386", "CYC"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#18370", "CYC"))));
        $ic5$ = SubLObjectFactory.makeSymbol("S#18365", "CYC");
        $ic6$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#148", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#11393", "CYC")), (SubLObject)SubLObjectFactory.makeSymbol("&BODY"), (SubLObject)SubLObjectFactory.makeSymbol("S#5", "CYC"));
        $ic7$ = SubLObjectFactory.makeSymbol("CDOHASH");
...
/*
	...
	Decompiled from: G:\opt\CYC_JRTL_with_CommonLisp\platform\lib\cyc-oc4.0-unzipped/com/cyc/cycjava/cycl/module0240.class
	Total time: 64 ms
