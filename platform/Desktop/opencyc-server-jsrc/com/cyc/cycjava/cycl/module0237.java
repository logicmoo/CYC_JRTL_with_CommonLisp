...
public final class module0237 extends SubLTranslatedFile
{
    ...
    public static SubLObject f15573(final SubLObject var3, final SubLObject var4) {
        ...
        return (SubLObject)ConsesLow.listS((SubLObject)$ic0$, (SubLObject)$ic1$, ConsesLow.append(var7, (SubLObject)NIL));
    }
    
    public static SubLObject f15574() {
        $g2444$.setDynamicValue((SubLObject)T);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f15575() {
        $g2444$.setDynamicValue((SubLObject)NIL);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f15576(final SubLObject var8) {
        return (SubLObject)makeBoolean(NIL != module0133.f8675(var8) && (NIL == module0133.f8673(var8) || NIL != module0133.f8662(var8)));
    }
    ...
    public static SubLObject f15578() {
        $g2444$ = SubLFiles.defparameter("S#18341", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g2444$ = null;
        $ic0$ = makeSymbol("CLET");
        $ic1$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#18341", "CYC"), (SubLObject)NIL));
    }
}
