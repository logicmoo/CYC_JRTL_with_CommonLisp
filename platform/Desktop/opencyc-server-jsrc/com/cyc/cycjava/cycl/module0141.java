...
public final class module0141 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic48$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("genlPreds"));
        $ic49$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("negationInverse"));
        $ic50$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("negationPreds"));
        ...
        $ic64$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#11624", "CYC"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("FIF"), (SubLObject)ConsesLow.list((SubLObject)module0141.EQL, (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#11101", "CYC"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#11495", "CYC"))), module0128.f8479((SubLObject)SubLObjectFactory.makeString("negationInverse"))), (SubLObject)module0141.T, (SubLObject)SubLObjectFactory.makeSymbol("S#11624", "CYC"))));
        ...
        $ic72$ = ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("genlInverse")));
        ...
        $ic140$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#11660", "CYC"), module0128.f8479((SubLObject)SubLObjectFactory.makeString("True-JustificationTruth"))));
        $ic141$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#11660", "CYC"), module0128.f8479((SubLObject)SubLObjectFactory.makeString("False-JustificationTruth"))));
        $ic142$ = ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("MonotonicallyTrue")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("DefaultTrue")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("MonotonicallyFalse")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("DefaultFalse")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("True-JustificationTruth")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("False-JustificationTruth")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("ArbitraryTruth-JustificationTruth")));
        $ic143$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("True-JustificationTruth"));
        $ic144$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("False-JustificationTruth"));
        $ic145$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("MonotonicallyTrue"));
        $ic146$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("DefaultTrue"));
        $ic147$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ArbitraryTruth-JustifactionTruth"));
        $ic148$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ArbitraryTruth-JustificationTruth"));
        $ic149$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("MonotonicallyFalse"));
        $ic150$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("DefaultFalse"));
        $ic151$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("JustifactionTruth"));
        $ic152$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Unknown-JustificationTruth"));
