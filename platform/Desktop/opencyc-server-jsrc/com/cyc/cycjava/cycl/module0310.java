...
public final class module0310 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic4$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argIsa"));
        $ic5$ = SubLObjectFactory.makeKeyword("GAF");
        $ic6$ = SubLObjectFactory.makeKeyword("TRUE");
        $ic7$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argGenl"));
        $ic8$ = SubLObjectFactory.makeKeyword("ARG-GENL");
        $ic9$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argQuotedIsa"));
        $ic10$ = SubLObjectFactory.makeKeyword("ARG-QUOTED-ISA");
        $ic11$ = SubLObjectFactory.makeKeyword("ARG-GENL-HORIZON");
        $ic12$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Predicate"));
        $ic13$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Function-Denotational"));
        ...
        $ic28$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InferencePSC"));
