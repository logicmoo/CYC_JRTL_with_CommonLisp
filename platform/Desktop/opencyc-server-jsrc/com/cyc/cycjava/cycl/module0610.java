...
public final class module0610 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic0$ = ConsesLow.list(new SubLObject[] { module0128.f8479((SubLObject)SubLObjectFactory.makeString("IntervalMinFn")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("IntervalMaxFn")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("Unity")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("UnitOfMeasure")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("maxQuantValue")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("minQuantValue")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("unitMultiplicationFactor")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("multiplicationUnits")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("PerFn")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("TheSet")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("TheSetOf")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("thereExistAtLeast")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("thereExistAtMost")), module0128.f8479((SubLObject)SubLObjectFactory.makeString("thereExistExactly")) });
        $ic1$ = SubLObjectFactory.makeSymbol("VALID-CONSTANT?");
        $ic2$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ScalarInterval"));
        ...
        $ic5$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Unity"));
        $ic6$ = SubLObjectFactory.makeSymbol("FORT-P");
        $ic7$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("maxQuantValue"));
        $ic8$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("minQuantValue"));
        $ic9$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("unitAbsoluteScaleOffset"));
        ...
        $ic16$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("unitMultiplicationFactor"));
        ...
        $ic20$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("multiplicationUnits"));
        $ic21$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("PerFn"));
        ...
        $ic25$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("integerRange"));
        $ic26$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("quantitySubsumes"));
        $ic27$ = SubLObjectFactory.makeSymbol("CYC-NUMBER-RANGE");
        $ic28$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("numberRange"));
        ...
        $ic33$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("PlusFn"));
        $ic34$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("IntervalOnNumberLine"));
        ...
        $ic37$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TimesFn"));
        $ic38$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("IntegerExtent"));
        $ic39$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("ScalarPointValue"));
        ...
        $ic44$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("quantityCongruenceBase"));
        $ic45$ = SubLObjectFactory.makeKeyword("TRUE");
        $ic46$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("MeasurableQuantityType"));
        ...
        $ic81$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("Radian"));
        ...
        $ic101$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("greaterThan"));
        $ic102$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("followingValue"));
        $ic103$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("greaterThanOrEqualTo"));
        ...
        $ic143$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("TheEmptySet"));
        ...
        $ic156$ = ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("and")), (SubLObject)ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?U"), module0128.f8479((SubLObject)SubLObjectFactory.makeString("UnitOfMeasureNoPrefix"))), (SubLObject)ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?UT"), module0128.f8479((SubLObject)SubLObjectFactory.makeString("InterconvertibleUnitType"))), (SubLObject)ConsesLow.list(module0128.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?U"), (SubLObject)SubLObjectFactory.makeSymbol("?UT")));
        $ic157$ = module0128.f8479((SubLObject)SubLObjectFactory.makeString("CurrentWorldDataCollectorMt-NonHomocentric"));
