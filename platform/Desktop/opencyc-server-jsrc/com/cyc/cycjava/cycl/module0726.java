...
public final class module0726 extends SubLTranslatedFile
{
    ...
    public static SubLObject f44382(final SubLObject var1) {
        ...
        if (NIL != module0584.f35775(module0584.$g4392$.getDynamicValue(var2)) && NIL != module0731.f44840(var1)) {
            return (SubLObject)NIL;
        }
        if (NIL != module0584.f35775(module0584.$g4393$.getDynamicValue(var2)) && $ic0$.eql(var1)) {
            return (SubLObject)NIL;
        }
        if (NIL != module0584.f35775(module0584.$g4394$.getDynamicValue(var2)) && $ic1$.eql(var1)) {
            return (SubLObject)NIL;
        }
        return (SubLObject)T;
    }
    ...
    static {
        ...
        $ic0$ = constant_handles_oc.f8479((SubLObject)makeString("SlangSpeech"));
        $ic1$ = constant_handles_oc.f8479((SubLObject)makeString("ArchaicSpeech"));
    }
}
