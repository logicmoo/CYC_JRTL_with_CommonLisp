...
public final class module0641 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic8$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("thereExists"));
        $ic9$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and"));
        $ic10$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("or"));
        $ic11$ = SubLObjectFactory.makeSymbol("EL-VARIABLE-P");
        $ic12$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Collection"));
        $ic13$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Individual"));
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Predicate"));
        $ic15$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("assertedSentence"));
        $ic16$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genls"));
        ...
        $ic40$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Terrorism-Topic")));
        ...
        $ic45$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Terrorism-Topic"));
        $ic46$ = SubLObjectFactory.makeSymbol("CDAR");
        $ic47$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtTopic"));
        $ic48$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("?M"));
        $ic49$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TKBSourceSpindle"));
        $ic50$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtSpindleMember"));
        $ic51$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("salientSpecForCollectionInTopic"));
        $ic52$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("salientPredicateSpaceForTopic"));
        $ic53$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("salientCollectionSpaceForTopic"));
        $ic54$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("salientIndividualForMt"));
        ...
        $ic58$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtUnionFn"));
