...
public final class module0161 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic4$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimePoint"));
        $ic5$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Always-TimeInterval"));
        $ic6$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtSpace"));
        $ic7$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeWithGranularityDimFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeDimFn")));
        $ic8$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("MONAD"), (SubLObject)SubLObjectFactory.makeKeyword("TIME"));
        $ic9$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtDim")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeDimFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeWithGranularityDimFn")));
        $ic10$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AnytimePSC"));
        $ic11$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AnytimeDuringPSCFn"));
        $ic12$ = ConsesLow.list(new SubLObject[] { constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtSpace")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtDim")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeDimFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeWithGranularityDimFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtTimeIndex")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtTimeParameter")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtMonad")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Always-TimeInterval")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Null-TimeParameter")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimePoint")) });
        $ic13$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtUnionFn"));
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeWithGranularityDimFn"));
        $ic15$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeDimFn"));
        ...
        $ic20$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InferencePSC"));
        $ic21$ = SubLObjectFactory.makeSymbol("S#13364", "CYC");
        $ic22$ = SubLObjectFactory.makeSymbol("HLMT-MONAD-MT");
        $ic23$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MicrotheoryDimensionPredicate"));
        ...
        $ic50$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtDim"));
        $ic51$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtMonad"));
        $ic52$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtTimeIndex"));
        $ic53$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtTimeParameter"));
        ...
        $ic60$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Microtheory"));
        $ic61$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtTimeIndex")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("mtTimeParameter")));
        $ic62$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeInterval"));
        $ic63$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TemporalThing"));
        $ic64$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeParameter"));
        $ic65$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SomeTimeInIntervalFn"));
