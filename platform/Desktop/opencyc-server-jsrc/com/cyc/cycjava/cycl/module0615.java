...
public final class module0615 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic0$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimePoint"));
        $ic1$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ConventionallyClassifiedTimeIntervalSeries"));
        ...
        $ic4$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("durationOfType"));
        $ic5$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeKeyword("PERIOD"));
        $ic6$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarCoveringType"));
        $ic7$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ConventionallyClassifiedTimeIntervalSeries-DisjointWithGaps"));
        $ic8$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("periodOfTimeIntervalSeries"));
        $ic9$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MonthOfYearType"));
        $ic10$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DayOfYearType"));
        $ic11$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DayOfWeekType"));
        $ic12$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HourOfDayType"));
        $ic13$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SameLengthTimeIntervalTypeFn"));
        $ic14$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Null-TimeParameter"));
        $ic15$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SecondsDuration")), (SubLObject)module0615.ONE_INTEGER);
        $ic16$ = ConsesLow.list(new SubLObject[] { constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SecondsDuration")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MinutesDuration")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HoursDuration")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DaysDuration")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("WeeksDuration")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MonthsDuration")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("QuartersDuration")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearsDuration")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DecadesDuration")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CenturiesDuration")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MillenniaDuration")) });
        $ic17$ = SubLObjectFactory.makeKeyword("A-LONG-TIME");
        $ic18$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SecondsDuration"));
        $ic19$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MinutesDuration"));
        $ic20$ = SubLObjectFactory.makeInteger(60);
        $ic21$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HoursDuration"));
        $ic22$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DaysDuration"));
        $ic23$ = SubLObjectFactory.makeInteger(24);
        $ic24$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("WeeksDuration"));
        $ic25$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MonthsDuration"));
        $ic26$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("QuartersDuration"));
        $ic27$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearsDuration"));
        $ic28$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DecadesDuration"));
        $ic29$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CenturiesDuration"));
        $ic30$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MillenniaDuration"));
        $ic31$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SecondsDuration")), (SubLObject)module0615.ZERO_INTEGER);
        ...
        $ic35$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalEndedByFn"));
        $ic36$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Always-TimeInterval"));
        $ic37$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IntervalStartedByFn"));
        $ic38$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DayOfYearFn"));
        $ic39$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarSecond"));
        $ic40$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarMinute"));
        $ic41$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarHour"));
        $ic42$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarDay"));
        $ic43$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarMonth"));
        $ic44$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarYear"));
        $ic45$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarWeek"));
        $ic46$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarQuarter"));
        $ic47$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarDecade"));
        $ic48$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarHalfCentury"));
        $ic49$ = SubLObjectFactory.makeInteger(50);
        $ic50$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarCentury"));
        $ic51$ = SubLObjectFactory.makeInteger(100);
        $ic52$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarMillennium"));
        $ic53$ = SubLObjectFactory.makeInteger(1000);
        $ic54$ = SubLObjectFactory.makeString("Unknown time type ~a.");
        $ic55$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Sunday"));
        $ic56$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DaysDuration")), (SubLObject)module0615.SIX_INTEGER);
        $ic57$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TimeIntervalInclusiveFn"));
        ...
        $ic63$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("YearFn"));
        $ic64$ = SubLObjectFactory.makeInteger(999);
        $ic65$ = SubLObjectFactory.makeString("No support for type ~a.");
        $ic66$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarWorkWeek"));
        $ic67$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Monday"));
        $ic68$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DaysDuration")), (SubLObject)module0615.FOUR_INTEGER);
        $ic69$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CalendarWeekend"));
        $ic70$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Saturday"));
        $ic71$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DaysDuration")), (SubLObject)module0615.ONE_INTEGER);
        $ic72$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Weekday"));
        $ic73$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HourFn"));
        $ic74$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Friday"));
        $ic75$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("DaysDuration")), (SubLObject)module0615.TWO_INTEGER);
    }
}
