...
public final class module0043 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic11$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#154", "CYC"));
        $ic12$ = SubLObjectFactory.makeSymbol("RET");
        $ic13$ = SubLObjectFactory.makeSymbol("CAND");
        $ic14$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("VECTORP"), (SubLObject)SubLObjectFactory.makeSymbol("S#154", "CYC"));
        $ic15$ = SubLObjectFactory.makeSymbol("=");
        $ic16$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("LENGTH"), (SubLObject)SubLObjectFactory.makeSymbol("S#154", "CYC")));
        $ic17$ = SubLObjectFactory.makeSymbol("QUOTE");
        $ic18$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("AREF"), (SubLObject)SubLObjectFactory.makeSymbol("S#154", "CYC"), (SubLObject)module0043.ZERO_INTEGER));
        $ic19$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("CONSP"), (SubLObject)SubLObjectFactory.makeSymbol("S#154", "CYC"));
        $ic20$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("CAR"), (SubLObject)SubLObjectFactory.makeSymbol("S#154", "CYC")));
        $ic21$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#2028", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#154", "CYC"));
        ...
        $ic26$ = SubLObjectFactory.makeSymbol("S#154", "CYC");
        $ic27$ = SubLObjectFactory.makeSymbol("AREF");
        $ic28$ = SubLObjectFactory.makeSymbol("NTH");
        $ic29$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#154", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("S#132", "CYC"));
        $ic30$ = SubLObjectFactory.makeSymbol("SET-AREF");
        $ic31$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#132", "CYC"));
        $ic32$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("RET"), (SubLObject)SubLObjectFactory.makeSymbol("S#154", "CYC")));
