...
public final class module0663 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic34$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("UniversalVocabularyMt"));
        $ic35$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa"));
        ...
        $ic41$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("functionCorrespondingPredicate-Canonical"));
        ...
        $ic45$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("EverythingPSC"));
        ...
        $ic49$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("salientAssertions"));
