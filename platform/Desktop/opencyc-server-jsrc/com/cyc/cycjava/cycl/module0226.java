...
public final class module0226 extends SubLTranslatedFile
{
    ...
    public static SubLObject f15153(final SubLObject var6) {
        return (SubLObject)SubLObjectFactory.makeBoolean(module0226.NIL != constant_handles_oc.f8449(var6) && module0226.NIL != module0222.f14635(module0226.$ic361$, var6, (SubLObject)module0226.ONE_INTEGER, (SubLObject)module0226.UNPROVIDED));
    }
    ...
    static {
        ...
        $ic6$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("AtemporalNecessarilyEssentialCollectionType"));
        ...
        $ic25$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Cyclist"));
        $ic26$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HumanCyclist"));
        ...
        $ic30$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Set-Mathematical"));
        ...
        $ic33$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Individual"));
        $ic34$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SetOrCollection"));
        $ic35$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FirstOrderCollection"));
        $ic36$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Thing"));
        $ic37$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SubcollectionRelationFunction"));
        $ic38$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("decontextualizedPredicate"));
        $ic39$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("predicateConventionMt"));
        $ic40$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("decontextualizedCollection"));
        $ic41$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("collectionConventionMt"));
        ...
        $ic44$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("quotedCollection"));
        $ic45$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("quotedArgument"));
        $ic46$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("opaqueArgument"));
        $ic47$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("minimizeCollectionExtent"));
        $ic48$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("minimizeExtent"));
        $ic49$ = SubLObjectFactory.makeSymbol("FORT-P");
        $ic50$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completeExtentAsserted"));
        $ic51$ = SubLObjectFactory.makeSymbol("NON-NEGATIVE-INTEGER-P");
        $ic52$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completeExtentAssertedForValueInArg"));
        $ic53$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completeExtentEnumerable"));
        $ic54$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completeExtentEnumerableViaBackchain"));
        $ic55$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completeExtentDecidable"));
        $ic56$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completeExtentEnumerableForArg"));
        $ic57$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completeExtentEnumerableForValueInArg"));
        $ic58$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completeExtentDecidableForValueInArg"));
        $ic59$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completelyEnumerableCollection"));
        $ic60$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("collectionCompletelyEnumerableViaBackchain"));
        $ic61$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("completelyDecidableCollection"));
        $ic62$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("backchainRequired"));
        $ic63$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("backchainEncouraged"));
        $ic64$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("backchainDiscouraged"));
        $ic65$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("backchainForbidden"));
        $ic66$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("collectionIsaBackchainRequired"));
        $ic67$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("collectionGenlsBackchainRequired"));
        $ic68$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("collectionBackchainRequired"));
        $ic69$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("collectionIsaBackchainEncouraged"));
        $ic70$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("collectionGenlsBackchainEncouraged"));
        $ic71$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("collectionBackchainEncouraged"));
        $ic72$ = SubLObjectFactory.makeKeyword("TRUE");
        $ic73$ = SubLObjectFactory.makeSymbol("<");
        $ic74$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("highlyRelevantTerm"));
        $ic75$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("irrelevantTerm"));
        $ic76$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("skolemizeForward"));
        $ic77$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("forwardReificationRule"));
        $ic78$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argsIsa"));
        $ic79$ = SubLObjectFactory.makeSymbol("S#12629", "CYC");
        $ic80$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argsQuotedIsa"));
        $ic81$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argAndRestIsa"));
        $ic82$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argAndRestQuotedIsa"));
        ...
        $ic89$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CycLSentence-Assertible"));
        $ic90$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CycLVariable"));
        $ic91$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ArgQuotedIsaBinaryPredicate"));
        $ic92$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ArgQuotedIsaTernaryPredicate"));
        ...
        $ic95$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg1Isa"));
        $ic96$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2Isa"));
        $ic97$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg3Isa"));
        $ic98$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg4Isa"));
        $ic99$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg5Isa"));
        $ic100$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg6Isa"));
        ...
        $ic103$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg1NotIsa"));
        $ic104$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2NotIsa"));
        $ic105$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg3NotIsa"));
        $ic106$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg4NotIsa"));
        $ic107$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg5NotIsa"));
        $ic108$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argsNotIsa"));
        ...
        $ic111$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg1QuotedIsa"));
        $ic112$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2QuotedIsa"));
        $ic113$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg3QuotedIsa"));
        $ic114$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg4QuotedIsa"));
        $ic115$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg5QuotedIsa"));
        $ic116$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg6QuotedIsa"));
        ...
        $ic120$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg1Genl"));
        $ic121$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2Genl"));
        $ic122$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg3Genl"));
        $ic123$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg4Genl"));
        $ic124$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg5Genl"));
        $ic125$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg6Genl"));
        $ic126$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argsGenl"));
        ...
        $ic133$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argIsa"));
        ...
        $ic137$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ArgGenlBinaryPredicate"));
        $ic138$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ArgGenlTernaryPredicate"));
        ...
        $ic142$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argAndRestGenl"));
        ...
        $ic149$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("argGenl"));
        ...
        $ic152$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-2"));
        ...
        $ic157$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-1"));
        $ic158$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-1"));
        $ic159$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-1"));
        $ic160$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-1"));
        $ic161$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-2"));
        $ic162$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-2"));
        $ic163$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-2"));
        $ic164$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-3"));
        $ic165$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-3"));
        $ic166$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-3"));
        $ic167$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-3"));
        $ic168$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-4"));
        $ic169$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-4"));
        $ic170$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-4"));
        $ic171$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-4"));
        $ic172$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-5"));
        $ic173$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-5"));
        $ic174$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-5"));
        $ic175$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-5"));
        $ic176$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-1")));
        $ic177$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-2")));
        $ic178$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-3")));
        $ic179$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-4")));
        $ic180$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-5")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-5")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-5")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-5")));
        $ic181$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa1-5")));
        $ic182$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa2-5")));
        $ic183$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa3-5")));
        $ic184$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa4-5")));
        $ic185$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgIsa5-4")));
        $ic186$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("defnIff"));
        $ic187$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("defnSufficient"));
        $ic188$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("defnNecessary"));
        $ic189$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("quotedDefnIff"));
        $ic190$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("quotedDefnSufficient"));
        $ic191$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("quotedDefnNecessary"));
        ...
        $ic201$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("resultIsa"));
        $ic202$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("resultIsaArg"));
        $ic203$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("resultIsaArgIsa"));
        $ic204$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("closedUnder"));
        $ic205$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FormulaArgFn"));
        $ic206$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("FunctionToArg"));
        $ic207$ = SubLObjectFactory.makeSymbol("PRED-U-V-HOLDS-IN-RELEVANT-MTS");
        $ic208$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllInstance"));
        $ic209$ = SubLObjectFactory.makeSymbol("S#1772", "CYC");
        $ic210$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("evaluationResultQuotedIsa"));
        $ic211$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("resultQuotedIsa"));
        $ic212$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("resultGenl"));
        $ic213$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("resultGenlArg"));
        ...
        $ic217$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgResultIsa"));
        ...
        $ic219$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgResultIsaReln"));
        ...
        $ic227$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgResultGenl"));
        $ic228$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgResultGenlReln"));
        $ic229$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg1Format"));
        $ic230$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg2Format"));
        $ic231$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg3Format"));
        $ic232$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg4Format"));
        $ic233$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg5Format"));
        $ic234$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("arg6Format"));
        $ic235$ = SubLObjectFactory.makeString("illegal arg specification for argn-format-pred: ~s");
        $ic236$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("singleEntryFormatInArgs"));
        $ic237$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("SingleEntry"));
        $ic238$ = ConsesLow.list((SubLObject)module0226.ONE_INTEGER, (SubLObject)module0226.TWO_INTEGER);
        $ic239$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat1-2"));
        $ic240$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat2-1"));
        $ic241$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat2-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat3-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat4-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat5-1")));
        $ic242$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat1-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat3-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat4-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat5-2")));
        $ic243$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat1-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat2-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat4-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat5-3")));
        $ic244$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat1-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat2-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat3-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat5-4")));
        $ic245$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat1-5")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat2-5")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat3-5")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat4-5")));
        $ic246$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat1-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat1-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat1-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat1-5")));
        $ic247$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat2-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat2-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat2-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat2-5")));
        $ic248$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat3-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat3-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat3-4")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat3-5")));
        $ic249$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat4-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat4-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat4-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat4-5")));
        $ic250$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat5-1")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat5-2")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat5-3")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("interArgFormat5-4")));
        $ic251$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("requiredArg1Pred"));
        $ic252$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("requiredArg2Pred"));
        ...
        $ic255$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("requiredArg1Pred")));
        $ic256$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("requiredArg2Pred")));
        $ic257$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAll")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExists")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsCount")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsMany")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsMax")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsMin")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllInstance")));
        $ic258$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsAll")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsCountAll")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsMaxAll")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsMinAll")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceAll")));
        $ic259$ = ConsesLow.list(new SubLObject[] { constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsAll")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsAllMany")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsCountAll")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsCountInstance")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsExists")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsInstance")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsMaxAll")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsMaxInstance")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsMinAll")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsMinInstance")) });
        $ic260$ = ConsesLow.list(new SubLObject[] { constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExists")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsCount")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsMany")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsMax")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExistsMin")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationExistsExists")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceExists")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceExistsCount")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceExistsMany")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceExistsMax")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationInstanceExistsMin")) });
        $ic261$ = SubLObjectFactory.makeSymbol("S#17832", "CYC");
        $ic262$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("ArgTypePredicate"));
        $ic263$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("genlMt"));
        $ic264$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("fanOutArg"));
        $ic265$ = SubLObjectFactory.makeKeyword("SUPERIOR?");
        $ic266$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("coExtensional"));
        $ic267$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BookkeepingMt"));
        $ic268$ = SubLObjectFactory.makeSymbol("S#12263", "CYC");
        $ic269$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("myReviewer"));
        $ic270$ = SubLObjectFactory.makeSymbol("REVIEWER");
        $ic271$ = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#10466", "CYC"), (SubLObject)SubLObjectFactory.makeSymbol("&OPTIONAL"), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("S#11445", "CYC"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("BookkeepingMt"))));
        ...
        $ic275$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("comment"));
        ...
        $ic283$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("cyclistNotes"));
        ...
        $ic300$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("comment")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("cyclistNotes")));
        ...
        $ic305$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("scopingArg"));
        $ic306$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("InferencePSC"));
        ...
        $ic318$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("retainTerm"));
        ...
        $ic358$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("relationAllExists"));
        $ic359$ = SubLObjectFactory.makeSymbol("S#17904", "CYC");
        $ic360$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("definingMt"));
        $ic361$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("hypotheticalTerm"));
        $ic362$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("notAssertible"));
        $ic363$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("notAssertibleCollection"));
        $ic364$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("notAssertibleMt"));
        $ic365$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IndexicalConcept"));
        $ic366$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RelationAllExistsFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RelationExistsAllFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RelationInstanceExistsFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("RelationExistsInstanceFn")));
        $ic367$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IndeterminateTermDenotingFunction"));
        $ic368$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("IndeterminateTerm"));
        $ic369$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NonSkolemIndeterminateTerm"));
        $ic370$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("nonAbducibleRule"));
        $ic371$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("TermExemptFromUniqueNamesAssumption"));
        $ic372$ = SubLObjectFactory.makeString("@cyc.com");
        $ic373$ = SubLObjectFactory.makeString("Can't get the email address of a non-fort: ~s");
        $ic374$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("preferredEMailAddressText"));
        $ic375$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("localEMailAddressText"));
        $ic376$ = SubLObjectFactory.makeSymbol("S#17923", "CYC");
        $ic377$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtSpace")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("CyclistsMt")), (SubLObject)ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("MtTimeDimFn")), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Now"))));
        $ic378$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("and"));
        $ic379$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("isa")), (SubLObject)SubLObjectFactory.makeSymbol("?CYCLIST"), constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("HumanCyclist")));
