...
public final class module0430 extends SubLTranslatedFile
{
    ...
    public static SubLObject f30426() {
        final SubLObject var1 = $g3504$.getGlobalValue();
        if (NIL != var1) {
    ...
    public static SubLObject f30427(final SubLObject var2) {
        return module0034.f1829($g3504$.getGlobalValue(), (SubLObject)ConsesLow.list(var2), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f30428(final SubLObject var2) {
        if (NIL != module0202.f12589(var2, $ic1$)) {
            return module0256.f16552(module0205.f13203(var2, (SubLObject)UNPROVIDED), module0429.$g3496$.getGlobalValue(), (SubLObject)UNPROVIDED);
        }
        assert NIL != module0173.f10955(var2) : var2;
        return module0259.f16846(var2, module0429.$g3496$.getGlobalValue(), (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f30429(final SubLObject var2) {
        SubLObject var3 = $g3504$.getGlobalValue();
        if (NIL == var3) {
            var3 = module0034.f1934((SubLObject)$ic0$, (SubLObject)$ic3$, (SubLObject)NIL, (SubLObject)EQ, (SubLObject)ONE_INTEGER, (SubLObject)ZERO_INTEGER);
        }
        SubLObject var4 = module0034.f1814(var3, var2, (SubLObject)$ic4$);
        if (var4 == $ic4$) {
    ...
    public static SubLObject f30430() {
        final SubLObject var1 = $g3505$.getGlobalValue();
        if (NIL != var1) {
            module0034.f1818(var1);
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f30431(final SubLObject var2) {
        return module0034.f1829($g3505$.getGlobalValue(), (SubLObject)ConsesLow.list(var2), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f30432(final SubLObject var2) {
        if (NIL != module0202.f12589(var2, $ic1$)) {
            return module0256.f16580((SubLObject)$ic6$, module0205.f13203(var2, (SubLObject)UNPROVIDED), module0429.$g3496$.getGlobalValue(), (SubLObject)UNPROVIDED);
        }
        assert NIL != module0173.f10955(var2) : var2;
        return module0259.f16862((SubLObject)$ic6$, var2, module0429.$g3496$.getGlobalValue(), (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f30433(final SubLObject var2) {
        SubLObject var3 = $g3505$.getGlobalValue();
        if (NIL == var3) {
            var3 = module0034.f1934((SubLObject)$ic5$, (SubLObject)$ic7$, (SubLObject)NIL, (SubLObject)EQ, (SubLObject)ONE_INTEGER, (SubLObject)ZERO_INTEGER);
        }
        SubLObject var4 = module0034.f1814(var3, var2, (SubLObject)$ic4$);
        if (var4 == $ic4$) {
    ...
    public static SubLObject f30434() {
        final SubLObject var1 = $g3506$.getGlobalValue();
        if (NIL != var1) {
            module0034.f1818(var1);
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f30435() {
        return module0034.f1829($g3506$.getGlobalValue(), (SubLObject)ConsesLow.list(EMPTY_SUBL_OBJECT_ARRAY), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f30436() {
        ...
        try {
            ...
            try {
                module0137.$g1605$.bind(module0137.f8955($ic9$), var5);
                module0139.$g1636$.bind(module0139.f9007(), var5);
                SubLObject var14_15 = var11;
                final SubLObject var12 = (SubLObject)$ic12$;
                ...
                try {
                    ...
                    try {
                        module0141.$g1714$.bind((NIL != var14) ? var14 : module0141.f9283(), var5);
                        module0141.$g1715$.bind((SubLObject)((NIL != var14) ? $ic13$ : module0141.$g1715$.getDynamicValue(var5)), var5);
                        if (NIL != var14 && NIL != module0136.f8864() && NIL == module0141.f9279(var14)) {
                            final SubLObject var15 = module0136.$g1591$.getDynamicValue(var5);
                            if (var15.eql((SubLObject)$ic14$)) {
                                module0136.f8870((SubLObject)ONE_INTEGER, (SubLObject)$ic15$, var14, (SubLObject)$ic16$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                            }
                            else if (var15.eql((SubLObject)$ic17$)) {
                                module0136.f8871((SubLObject)ONE_INTEGER, (SubLObject)$ic18$, (SubLObject)$ic15$, var14, (SubLObject)$ic16$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                            }
                            else if (var15.eql((SubLObject)$ic19$)) {
                                Errors.warn((SubLObject)$ic15$, var14, (SubLObject)$ic16$);
                            }
                            else {
                                Errors.warn((SubLObject)$ic20$, module0136.$g1591$.getDynamicValue(var5));
                                Errors.cerror((SubLObject)$ic18$, (SubLObject)$ic15$, var14, (SubLObject)$ic16$);
                            }
                        }
                        ...
                        try {
                            module0141.$g1670$.bind(module0244.f15771(module0137.f8955($ic9$)), var5);
                            module0141.$g1671$.bind(module0244.f15739(module0244.f15771(module0137.f8955($ic9$))), var5);
                            module0141.$g1672$.bind(module0244.f15746(module0244.f15771(module0137.f8955($ic9$))), var5);
                            module0141.$g1674$.bind((SubLObject)NIL, var5);
                            module0137.$g1605$.bind(module0244.f15771(module0137.f8955($ic9$)), var5);
                            if (NIL != module0136.f8865() || NIL != module0244.f15795(var11, module0137.f8955((SubLObject)UNPROVIDED))) {
                                ...
                                try {
                                    ...
                                    module0138.$g1619$.bind(module0244.f15782(module0141.f9210(), module0244.f15771(module0137.f8955($ic9$))), var5);
                                    module0141.$g1674$.bind((SubLObject)NIL, var5);
                                    module0249.f16055(var14_15, (SubLObject)UNPROVIDED);
                                    while (NIL != var14_15) {
                                        final SubLObject var18 = var14_15;
                                        SubLObject var20;
                                        final SubLObject var19 = var20 = module0200.f12443(module0137.f8955($ic9$));
                                        ...
                                        while (NIL != var20) {
                                            ...
                                            try {
                                                ...
                                                if (NIL != module0138.f8992(var22)) {
                                                    ...
                                                    if (NIL != var23) {
                                                        final SubLObject var24 = module0245.f15834(var23, module0244.f15780(module0137.f8955($ic9$)), module0137.f8955((SubLObject)UNPROVIDED));
                                                        if (NIL != var24) {
                                                            SubLObject var25;
                                                            for (var25 = module0066.f4838(module0067.f4891(var24)); NIL == module0066.f4841(var25); var25 = module0066.f4840(var25)) {
                                                                ...
                                                                if (NIL != module0147.f9507(var26)) {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        SubLObject var40_44;
                                                                        for (var40_44 = module0066.f4838(module0067.f4891(var27)); NIL == module0066.f4841(var40_44); var40_44 = module0066.f4840(var40_44)) {
                                                                            var5.resetMultipleValues();
                                                                                ...
                                                                                try {
                                                                                    ...
                                                                                    if (NIL != module0077.f5302(var30)) {
                                                                                        ...
                                                                                        for (var32 = module0032.f1741(var31), var33 = (SubLObject)NIL, var33 = module0032.f1742(var32, var31); NIL == module0032.f1744(var32, var33); var33 = module0032.f1743(var33)) {
                                                                                            ...
                                                                                            if (NIL != module0032.f1746(var33, var34) && NIL == module0249.f16059(var34, module0139.$g1636$.getDynamicValue(var5))) {
                                                                                                module0249.f16055(var34, module0139.$g1636$.getDynamicValue(var5));
                                                                                                if (NIL != module0173.f10955(var34) && !module0429.f30408(var34).eql(module0429.$g3494$.getGlobalValue())) {
                                                                                        ...
                                                                                        var36 = var35.first();
                                                                                        while (NIL != var35) {
                                                                                            if (NIL == module0249.f16059(var36, module0139.$g1636$.getDynamicValue(var5))) {
                                                                                                module0249.f16055(var36, module0139.$g1636$.getDynamicValue(var5));
                                                                                                if (NIL != module0173.f10955(var36) && !module0429.f30408(var36).eql(module0429.$g3494$.getGlobalValue())) {
                                                                                        ...
                                                                                        Errors.error((SubLObject)$ic21$, var30);
                                                                                    }
                                                                                }
                                                                                finally {
                                                    ...
                                                    if (NIL != module0200.f12419(var22, module0137.f8955((SubLObject)UNPROVIDED))) {
                                                        ...
                                                        while (NIL != var37) {
                                                            ...
                                                            cdestructuring_bind.destructuring_bind_must_consp(var40, var39, (SubLObject)$ic23$);
                                                            var41 = var40.first();
                                                            var40 = var40.rest();
                                                            cdestructuring_bind.destructuring_bind_must_consp(var40, var39, (SubLObject)$ic23$);
                                                            var42 = var40.first();
                                                            ...
                                                            if (NIL == var40) {
                                                                ...
                                                                cdestructuring_bind.cdestructuring_bind_error(var39, (SubLObject)$ic23$);
                                                            }
                                                            var37 = var37.rest();
                                                            var38 = var37.first();
                                                        }
                                                    ...
                                                    SubLObject var33_64;
                                                    final SubLObject var45 = var33_64 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0244.f15780(module0137.f8955($ic9$)), module0141.$g1714$.getDynamicValue(var5), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0244.f15780(module0137.f8955($ic9$)), module0141.$g1714$.getDynamicValue(var5), module0137.f8955((SubLObject)UNPROVIDED)));
                                                        ...
                                                        try {
                                                            ...
                                                            if (NIL != module0077.f5302(var48)) {
                                                                ...
                                                                for (var50 = module0032.f1741(var49), var51 = (SubLObject)NIL, var51 = module0032.f1742(var50, var49); NIL == module0032.f1744(var50, var51); var51 = module0032.f1743(var51)) {
                                                                    ...
                                                                    if (NIL != module0032.f1746(var51, var52) && NIL == module0249.f16059(var52, module0139.$g1636$.getDynamicValue(var5))) {
                                                                        module0249.f16055(var52, module0139.$g1636$.getDynamicValue(var5));
                                                                        if (NIL != module0173.f10955(var52) && !module0429.f30408(var52).eql(module0429.$g3494$.getGlobalValue())) {
                                                                ...
                                                                var54 = var53.first();
                                                                while (NIL != var53) {
                                                                    if (NIL == module0249.f16059(var54, module0139.$g1636$.getDynamicValue(var5))) {
                                                                        module0249.f16055(var54, module0139.$g1636$.getDynamicValue(var5));
                                                                        if (NIL != module0173.f10955(var54) && !module0429.f30408(var54).eql(module0429.$g3494$.getGlobalValue())) {
                                                                ...
                                                                Errors.error((SubLObject)$ic21$, var48);
                                                            }
                                                        }
                                                        finally {
                                        ...
                                        SubLObject var56;
                                        final SubLObject var55 = var56 = module0200.f12443(module0244.f15771(module0137.f8955($ic9$)));
                                        ...
                                        while (NIL != var56) {
                                            ...
                                            try {
                                                ...
                                                if (NIL != module0138.f8992(var58)) {
                                                            ...
                                                            for (var61 = module0066.f4838(module0067.f4891(var60)); NIL == module0066.f4841(var61); var61 = module0066.f4840(var61)) {
                                                                ...
                                                                if (NIL != module0147.f9507(var62)) {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        SubLObject var40_45;
                                                                        for (var40_45 = module0066.f4838(module0067.f4891(var63)); NIL == module0066.f4841(var40_45); var40_45 = module0066.f4840(var40_45)) {
                                                                            var5.resetMultipleValues();
                                                                            ...
                                                                            if (NIL != module0141.f9289(var64)) {
                                                                                ...
                                                                                try {
                                                                                    ...
                                                                                    if (NIL != module0077.f5302(var66)) {
                                                                                        ...
                                                                                        Errors.error((SubLObject)$ic21$, var66);
                                                                                    }
                                                                                }
                                                                                finally {
                                                    ...
                                                    SubLObject var33_65;
                                                    final SubLObject var73 = var33_65 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var5), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var5), module0137.f8955((SubLObject)UNPROVIDED)));
                                                    ...
                                                    while (NIL != var33_65) {
                                                        ...
                                                        try {
                                                            ...
                                                            if (NIL != module0077.f5302(var76)) {
                                                                ...
                                                                Errors.error((SubLObject)$ic21$, var76);
                                                            }
                                                        }
                                                        finally {
                                ...
                                module0136.f8872((SubLObject)TWO_INTEGER, (SubLObject)$ic24$, var11, module0244.f15748(module0137.f8955((SubLObject)UNPROVIDED)), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                            }
                        }
                        finally {
    ...
    public static SubLObject f30437() {
        SubLObject var3 = $g3506$.getGlobalValue();
        if (NIL == var3) {
            var3 = module0034.f1934((SubLObject)$ic8$, (SubLObject)$ic25$, (SubLObject)NIL, (SubLObject)EQ, (SubLObject)ZERO_INTEGER, (SubLObject)ZERO_INTEGER);
        }
    ...
    public static SubLObject f30440() {
        $g3504$ = SubLFiles.deflexical("S#33673", (SubLObject)NIL);
        $g3505$ = SubLFiles.deflexical("S#33674", (SubLObject)NIL);
        $g3506$ = SubLFiles.deflexical("S#33675", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g3505$ = null;
        $g3506$ = null;
        $ic0$ = makeSymbol("S#33603", "CYC");
        $ic1$ = constant_handles_oc.f8479((SubLObject)makeString("SpecsFn"));
        $ic2$ = makeSymbol("FORT-P");
        $ic3$ = makeSymbol("S#33673", "CYC");
        $ic4$ = makeKeyword("&MEMOIZED-ITEM-NOT-FOUND&");
        $ic5$ = makeSymbol("S#33604", "CYC");
        $ic6$ = makeSymbol("S#33645", "CYC");
        $ic7$ = makeSymbol("S#33674", "CYC");
        $ic8$ = makeSymbol("S#33602", "CYC");
        $ic9$ = constant_handles_oc.f8479((SubLObject)makeString("isa"));
        $ic10$ = makeKeyword("BREADTH");
        $ic11$ = makeKeyword("QUEUE");
        $ic12$ = makeKeyword("STACK");
        $ic13$ = makeSymbol("S#11450", "CYC");
        $ic14$ = makeKeyword("ERROR");
        $ic15$ = makeString("~A is not a ~A");
        $ic16$ = makeSymbol("S#11592", "CYC");
        $ic17$ = makeKeyword("CERROR");
        $ic18$ = makeString("continue anyway");
        $ic19$ = makeKeyword("WARN");
        $ic20$ = makeString("~A is not a valid *sbhl-type-error-action* value");
        ...
        $ic23$ = ConsesLow.list((SubLObject)makeUninternedSymbol("US#4D5E436"), (SubLObject)makeUninternedSymbol("US#1526883"), (SubLObject)makeUninternedSymbol("US#15AA083"));
        $ic24$ = makeString("Node ~a does not pass sbhl-type-test ~a~%");
        $ic25$ = makeSymbol("S#33675", "CYC");
    }
}
