...
public final class module0759 extends SubLTranslatedFile
{
    ...
    static {
        ...
        $ic4$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("NLSentence"));
        ...
        $ic9$ = constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("Pronoun"));
        ...
        $ic13$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)SubLObjectFactory.makeString("infinitive")));
