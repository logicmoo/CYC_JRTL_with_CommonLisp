...
public class UpdateZip {
     ...
     * @throws IOException
     */
    public synchronized static void updateUnits() throws MalformedURLException, IOException {
        if (didUpdateUnits)
            return;
        didUpdateUnits = true;
        ...
        if (!testfile.exists() || true) {
            ...
            // dmiles machine url = new URL("http://10.0.0.180/downloads/units5022.zip");
