...
*/
	...
	*/
	...
	{
		URL url = Class.class.getResource("/java/lang/String.class");
		//System.err.println("getRTJarPath.url="+url);
		String urlString =
			url.toExternalForm();
		//getRTJarPath.urlString=file:/C:/.virtual-ikvm-home/assembly/IKVM.OpenJDK.Core__8.1.5717.0__13235d27fcbfff58/classes/java/lang/String.class
		//System.err.println("getRTJarPath.urlString="+urlString);
		Object foo = null;
		//((sun.management.RuntimeImpl)foo).getBootClassPath();
	...
	*/
	...
	void startClassMapping() {
		if ( mappingFeedbackListener != null )
			...
			println( "Start ClassPath Mapping" );
	}
	...
	void endClassMapping() {
		if ( mappingFeedbackListener != null )
			...
			println( "End ClassPath Mapping" );
	}

	private void println(String string) {
		// TODO Auto-generated method stub
		//if(true) Errors.unimplementedMethod("Auto-generated method stub:  BshClassPath.println");
