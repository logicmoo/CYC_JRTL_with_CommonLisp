...
public interface KBTransaction {
     ...
     */
    void noteForAssertion(String sentence, ELMt mt, boolean bookkeeping, boolean transcripting, boolean wffCheckingDisabled, List<CycFort> templates);
     ...
     */
    void noteCreation(CycFort term);
}
