package System::Cyc::OpenCyc::Java::CycAccess;
...
has 'cyc' =>
  (
   is      => 'rw',
   lazy    => 1,
   default => sub { System::Cyc::OpenCyc::Java::CycAccess::org::opencyc::api::CycAccess->new() },
   handles => {
...
System::Cyc::OpenCyc::Java::CycAccess - A wrapper for the Cyc API

=head1 SYNOPSIS

  use System::Cyc::OpenCyc::Java::CycAccess;
  my $cyc = System::Cyc::OpenCyc::Java::CycAccess->new;


=head1 DESCRIPTION

System::Cyc::OpenCyc::Java::CycAccess is a wrapper for the Cyc API
