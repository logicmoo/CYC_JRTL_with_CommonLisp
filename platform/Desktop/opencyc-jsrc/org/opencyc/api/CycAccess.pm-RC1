package System::Cyc::ResearchCyc1_0::Java::CycAccess;

# see System::Cyc::Java::CycAccess;
...
//      else 
 ...
 protected void reEstablishCycConnection()  throws IOException, UnknownHostException, CycApiException {
  ...
  public HashMap createInferenceParams() {
...
END_OF_JAVA_CODE
  AUTOSTUDY => 1,
  CLASSPATH => '/var/lib/myfrdcsa/sandbox/researchcyc-1.0/researchcyc-1.0/api/java/build/OpenCyc.jar:/var/lib/myfrdcsa/sandbox/researchcyc-1.0/researchcyc-1.0/api/java/lib/jakarta-oro-2.0.4.jar',
  EXTRA_JAVA_ARGS => '-Djava.library.path=/var/lib/myfrdcsa/sandbox/researchcyc-1.0/researchcyc-1.0/api/java/src',
...
has 'cyc' =>
  (
   is      => 'rw',
   lazy    => 1,
   default => sub { System::Cyc::ResearchCyc1_0::Java::CycAccess::org::opencyc::api::CycAccess->new() },
   handles => {
...
sub isResearchCyc1_0 {
  my ($self) = @_;
  my $isResearchCyc1_0;

  try {
    # FIXME: try using *CYC-PRODUCT-DEFINITIONS* instead of
    # cyc-researchcyc-feature, as cyc-researchcyc-feature doesn't
    # discriminate between 1.0 and later editions: can probably do
    # using subl query interface, just post the variable and it should
    # return the value
    $isResearchCyc1_0 = $self->cyc->converseBoolean("(cyc-researchcyc-feature)");
  }
    catch {
      System::Cyc::Exception->throw('false');
    };

  return $isResearchCyc1_0;
}
...
=pod
  ...
  System::Cyc::ResearchCyc1_0::Java::CycAccess - A wrapper for the Cyc API

  =head1 SYNOPSIS

  use System::Cyc::ResearchCyc1_0::Java::CycAccess;
my $cyc = System::Cyc::ResearchCyc1_0::Java::CycAccess->new;


=head1 DESCRIPTION

  System::Cyc::ResearchCyc1_0::Java::CycAccess is a wrapper for the Cyc API
