package System::Cyc::EnterpriseCyc::Java::CycAccess;
...
has 'cyc' =>
  (
   is      => 'rw',
   lazy    => 1,
   default => sub { System::Cyc::EnterpriseCyc::Java::CycAccess::org::opencyc::api::CycAccess->new() },
   handles => {
...
System::Cyc::EnterpriseCyc::Java::CycAccess - A wrapper for the Cyc API

=head1 SYNOPSIS

  use System::Cyc::EnterpriseCyc::Java::CycAccess;
  my $cyc = System::Cyc::EnterpriseCyc::Java::CycAccess->new;


=head1 DESCRIPTION

System::Cyc::EnterpriseCyc::Java::CycAccess is a wrapper for the Cyc API
