...
public abstract class AbstractMode implements Constants, Mode
{
	...
	public void populateMenu(Editor editor, Menu menu)
    {
        ...
        if (text == "File")
        	...
        	populatePrologMenu(editor, menu);
         else if (text == "Lisp")
    ...
    public void populatePrologMenu(Editor editor, Menu menu)
    {
        //menu.add(editor, "Run Prolog as Separate Process", 'L', "swipl-win");
        menu.add(editor, "Run Embedded Prolog", 'E', "prolog");
    }
