...
public final class kb_indexing_datastructures extends SubLTranslatedFile
{
    ...
    public static SubLObject setup_indexing_tables(final SubLObject estimated_size) {
        final SubLObject estimated_assertion_count = Numbers.multiply((SubLObject)TEN_INTEGER, estimated_size);
    ...
    public static SubLObject assertion_indexing_store_initial_size(SubLObject estimated_assertion_count) {
        if (estimated_assertion_count == UNPROVIDED) {
            estimated_assertion_count = (SubLObject)NIL;
        }
        if (NIL != estimated_assertion_count) {
            return Numbers.round(Numbers.multiply(estimated_assertion_count, $meta_assertion_frequency$.getGlobalValue()), (SubLObject)UNPROVIDED);
        }
        if (NIL != control_vars.kb_loaded()) {
            return Numbers.round(Numbers.multiply(assertion_handles.assertion_count(), $meta_assertion_frequency$.getGlobalValue()), (SubLObject)UNPROVIDED);
        }
        return (SubLObject)$int2$64;
    }
    ...
    public static SubLObject assertion_indexing_store_initialize(SubLObject estimated_assertion_count) {
        ...
        assertion_indexing_store_reset(Hashtables.make_hash_table(initial_size, Symbols.symbol_function((SubLObject)EQL), (SubLObject)UNPROVIDED));
        return $assertion_indexing_store$.getGlobalValue();
    }
	...
	public static SubLObject assertion_indexing_store_set(final SubLObject assertion, final SubLObject index)
	{
		try
		{
			...
			if (index.eql(new_simple_index)) { return assertion_indexing_store_remove(assertion); }
    ...
    public static SubLObject do_assertions_with_meta_assertions(final SubLObject macroform, final SubLObject environment) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list3);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject assertion_var = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list3);
        ...
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list3);
        ...
        if (NIL != bad && NIL == allow_other_keys_p) {
            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list3);
        }
        ...
        final SubLObject progress_message_tail = cdestructuring_bind.property_list_member((SubLObject)$kw7$PROGRESS_MESSAGE, current);
        ...
        if (!progress_message.isAtom()) {
            final SubLObject progress_message_var = (SubLObject)$sym8$PROGRESS_MESSAGE_VAR;
            ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(progress_message_var, progress_message)), (SubLObject)ConsesLow.listS((SubLObject)$sym10$DO_ASSERTIONS_WITH_META_ASSERTIONS, (SubLObject)ConsesLow.list(assertion_var, (SubLObject)$kw6$DONE, done, (SubLObject)$kw7$PROGRESS_MESSAGE, progress_message_var), ConsesLow.append(body, (SubLObject)NIL)));
        }
        if (NIL != progress_message) {
            final SubLObject sofar = (SubLObject)$sym11$SOFAR;
            final SubLObject total = (SubLObject)$sym12$TOTAL;
            return (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list(reader.bq_cons(total, (SubLObject)$list13), reader.bq_cons(sofar, (SubLObject)$list14)), (SubLObject)ConsesLow.list((SubLObject)$sym15$NOTING_PERCENT_PROGRESS, progress_message, (SubLObject)ConsesLow.listS((SubLObject)$sym10$DO_ASSERTIONS_WITH_META_ASSERTIONS, (SubLObject)ConsesLow.list(assertion_var, (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym16$CINC, sofar), (SubLObject)ConsesLow.list((SubLObject)$sym17$NOTE_PERCENT_PROGRESS, sofar, total))))));
        }
        return (SubLObject)ConsesLow.listS((SubLObject)$sym18$DO_ITERATOR, (SubLObject)ConsesLow.list(assertion_var, (SubLObject)$list19, (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL));
    }
    ...
    public static SubLObject unindexed_syntax_constant_p(final SubLObject v_object) {
        return subl_promotions.memberP(v_object, $unindexed_syntax_constants$.getGlobalValue(), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject indexed_term_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != cycl_utilities.reified_term_p(v_object) || NIL != indexed_unrepresented_term_p(v_object));
    }
    ...
    public static SubLObject valid_indexed_termP(final SubLObject v_object) {
        ...
        if (NIL != assertion_handles.assertion_p(v_object)) {
            return assertion_handles.valid_assertionP(v_object, (SubLObject)UNPROVIDED);
        }
    ...
    public static SubLObject invalid_indexed_termP(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != indexed_term_p(v_object) && NIL == valid_indexed_termP(v_object));
    }
    ...
    public static SubLObject invalid_indexed_term_robustP(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != indexed_term_p(v_object) && NIL == valid_indexed_term_robustP(v_object));
    }
    ...
    public static SubLObject sort_of_indexed_term_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != indexed_term_p(v_object) || NIL != hlmt.hlmt_p(v_object));
    }
    ...
    public static SubLObject fully_indexed_term_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != indexed_term_p(v_object) && NIL == unindexed_syntax_constant_p(v_object));
    }
    ...
    public static SubLObject valid_fully_indexed_term_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != valid_indexed_termP(v_object) && NIL == unindexed_syntax_constant_p(v_object));
    }
    ...
    public static SubLObject do_indexed_terms(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list26);
        final SubLObject temp = current.rest();
        current = current.first();
        ...
        var = current.first();
        current = current.rest();
        final SubLObject message = (SubLObject)(current.isCons() ? current.first() : $str27$mapping_Cyc_indexed_terms);
        cdestructuring_bind.destructuring_bind_must_listp(current, datum, (SubLObject)$list26);
        current = current.rest();
        if (NIL == current) {
            final SubLObject body;
            current = (body = temp);
            return (SubLObject)ConsesLow.list((SubLObject)$sym28$PROGN, (SubLObject)ConsesLow.listS((SubLObject)$sym29$DO_FORTS, (SubLObject)ConsesLow.list(var, (SubLObject)ConsesLow.list((SubLObject)$sym30$FORMAT, (SubLObject)NIL, (SubLObject)$str31$_A__forts_, message)), ConsesLow.append(body, (SubLObject)NIL)), (SubLObject)ConsesLow.listS((SubLObject)$sym32$DO_ASSERTIONS, (SubLObject)ConsesLow.list(var, (SubLObject)ConsesLow.list((SubLObject)$sym30$FORMAT, (SubLObject)NIL, (SubLObject)$str33$_A__assertions_, message)), ConsesLow.append(body, (SubLObject)NIL)), (SubLObject)ConsesLow.listS((SubLObject)$sym34$DO_KB_UNREPRESENTED_TERMS, (SubLObject)ConsesLow.list(var, (SubLObject)$kw7$PROGRESS_MESSAGE, (SubLObject)ConsesLow.list((SubLObject)$sym30$FORMAT, (SubLObject)NIL, (SubLObject)$str35$_A__unrepresented_terms_, message)), ConsesLow.append(body, (SubLObject)NIL)));
        }
        cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list26);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject index_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != simple_index_p(v_object) || NIL != complex_index_p(v_object));
    }
    ...
    public static SubLObject term_index(final SubLObject v_term) {
        if (NIL != constant_handles.constant_p(v_term)) {
            if (NIL != constant_handles.valid_constantP(v_term, (SubLObject)UNPROVIDED)) {
                return constants_low.constant_index(v_term);
            }
        }
        else if (NIL != nart_handles.nart_p(v_term)) {
            if (NIL != nart_handles.valid_nartP(v_term, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject reset_term_index(final SubLObject v_term, final SubLObject index) {
        if (NIL != forts.fort_p(v_term)) {
            ...
            if (NIL != assertion_handles.assertion_p(v_term)) {
                ...
                unrepresented_terms.reset_unrepresented_term_index(v_term, index, (SubLObject)T);
            }
            else if (NIL != auxiliary_indexing.auxiliary_index_p(v_term)) {
                auxiliary_indexing.reset_auxiliary_index(v_term, index);
            }
            else {
                Errors.error((SubLObject)$str36$_S_is_not_indexed, v_term);
            }
        }
        return v_term;
    }
    ...
    public static SubLObject simple_index_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(v_object.isList() && NIL == complex_index_p(v_object));
    }
    ...
    public static SubLObject simple_index_not_hosed_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != simple_index_p(v_object) && NIL != list_utilities.every_in_list(Symbols.symbol_function((SubLObject)$sym37$INDEXING_LEAF_INSTALLED_P), v_object, (SubLObject)UNPROVIDED));
    }
    ...
    public static SubLObject simple_index_memberP(final SubLObject simple_index, final SubLObject leaf) {
        return subl_promotions.memberP(leaf, simple_index, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject simple_index_delete(final SubLObject simple_index, final SubLObject leaf) {
        if (NIL != simple_index_memberP(simple_index, leaf)) {
            return list_utilities.delete_first(leaf, simple_index, (SubLObject)UNPROVIDED);
        }
        return simple_index;
    }
    ...
    public static SubLObject with_current_complex_index_path(final SubLObject macroform, final SubLObject environment) {
        ...
        SubLObject keys = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list42);
        ...
        if (NIL == current) {
            final SubLObject body;
            current = (body = temp);
            return (SubLObject)ConsesLow.listS((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym43$_CURRENT_COMPLEX_INDEX_TERM_, v_term), (SubLObject)ConsesLow.list((SubLObject)$sym44$_CURRENT_COMPLEX_INDEX_KEYS_, keys)), ConsesLow.append(body, (SubLObject)NIL));
        }
        cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list42);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject merge_complex_indices(final SubLObject complex_base, final SubLObject complex_augment) {
        ...
        try {
            $current_complex_index_keys$.bind((SubLObject)NIL, thread);
            $current_complex_index_keys_in_orderP$.bind((SubLObject)NIL, thread);
    ...
    public static SubLObject term_complex_index_set(final SubLObject v_term, final SubLObject key, final SubLObject value) {
        ...
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && NIL != value && NIL == subindex_p(value)) {
            Errors.error((SubLObject)$str47$_s_is_not_a_SUBINDEX_P, value);
        }
        final SubLObject index = term_index(v_term);
    ...
    public static SubLObject reserve_final_topn_index_for_term(final SubLObject v_term, final SubLObject keys) {
        ...
        SubLObject key_history = (SubLObject)NIL;
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && NIL == complex_index_p(index)) {
            Errors.error((SubLObject)$str49$Cannot_reserve_a_TOP_N_index_for_, v_term);
        }
        SubLObject list_var = (SubLObject)NIL;
        SubLObject key = (SubLObject)NIL;
        SubLObject key_number = (SubLObject)NIL;
        list_var = keys;
        key = list_var.first();
        for (key_number = (SubLObject)ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), key = list_var.first(), key_number = Numbers.add((SubLObject)ONE_INTEGER, key_number)) {
            key_history = ConsesLow.nconc(key_history, (SubLObject)ConsesLow.list(key));
            if (Numbers.add((SubLObject)ONE_INTEGER, key_number).numL(key_count)) {
                index = intermediate_index_lookup_or_create_intermediate(index, key, key_history);
            }
            else {
                intermediate_index_set(index, key, new_final_topn_index(v_term, keys, (SubLObject)ZERO_INTEGER));
            }
        }
        return v_term;
    }
    ...
    public static SubLObject subindex_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != intermediate_index_p(v_object) || NIL != final_index_p(v_object));
    }
    ...
    public static SubLObject merge_sub_indices(final SubLObject subindex_base, final SubLObject subindex_augment) {
        ...
        if (NIL != intermediate_index_p(subindex_base)) {
            if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && NIL == intermediate_index_p(subindex_augment)) {
                Errors.error((SubLObject)$str50$Cannot_merge__A_onto__A__incommen, subindex_augment, subindex_base);
            }
        ...
        return Errors.error((SubLObject)$str51$Dont_know_how_to_merge_sub_index_, subindex_base, subindex_augment);
    }
    ...
    public static SubLObject intermediate_index_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(v_object.isCons() && v_object.first().isInteger() && NIL != map_utilities.map_p(v_object.rest()));
    }
    ...
    public static SubLObject new_intermediate_index(final SubLObject test_function) {
        return (SubLObject)ConsesLow.cons((SubLObject)ZERO_INTEGER, dictionary.new_dictionary(test_function, (SubLObject)UNPROVIDED));
    }
    ...
    public static SubLObject clone_intermediate_index(final SubLObject intermediate_index) {
        ...
        return (SubLObject)ConsesLow.cons(intermediate_index_leaf_count(intermediate_index), dictionary.new_dictionary(index_test, (SubLObject)UNPROVIDED));
    }
    ...
    public static SubLObject do_intermediate_index(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list52);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject key_var = (SubLObject)NIL;
        SubLObject subindex_var = (SubLObject)NIL;
        SubLObject intermediate_index = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list52);
        ...
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list52);
            current_$2 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list52);
            if (NIL == conses_high.member(current_$2, (SubLObject)$list53, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                bad = (SubLObject)T;
            }
        ...
        if (NIL != bad && NIL == allow_other_keys_p) {
            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list52);
        }
        final SubLObject done_tail = cdestructuring_bind.property_list_member((SubLObject)$kw6$DONE, current);
        final SubLObject done = (SubLObject)((NIL != done_tail) ? conses_high.cadr(done_tail) : NIL);
        final SubLObject body;
        current = (body = temp);
        final SubLObject index = (SubLObject)$sym54$INDEX;
        return (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(index, intermediate_index)), (SubLObject)ConsesLow.list((SubLObject)$sym55$PWHEN, (SubLObject)ConsesLow.list((SubLObject)$sym56$DO_INTERMEDIATE_INDEX_VALID_INDEX_P, index), (SubLObject)ConsesLow.listS((SubLObject)$sym57$DO_MAP, (SubLObject)ConsesLow.list(key_var, subindex_var, (SubLObject)ConsesLow.list((SubLObject)$sym58$INTERMEDIATE_INDEX_MAP, index), (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL))));
    }
    ...
    public static SubLObject do_intermediate_index_valid_index_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != v_object);
    }
    ...
    public static SubLObject capture_changed_index_entry_hints(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list60);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject v_set = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list60);
        v_set = current.first();
        current = current.rest();
        if (NIL == current) {
            final SubLObject body;
            current = (body = temp);
            return (SubLObject)ConsesLow.listS((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym61$_CHANGED_INDEX_ENTRY_HINTS_, v_set)), ConsesLow.append(body, (SubLObject)NIL));
        }
        cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list60);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject do_changed_intermediate_index(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list62);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject key_var = (SubLObject)NIL;
        SubLObject subindex_var = (SubLObject)NIL;
        SubLObject intermediate_index = (SubLObject)NIL;
        SubLObject unchanged_part = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list62);
        key_var = current.first();
        current = current.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list62);
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)NIL;
        SubLObject current_$3 = (SubLObject)NIL;
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list62);
            current_$3 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list62);
            if (NIL == conses_high.member(current_$3, (SubLObject)$list53, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                bad = (SubLObject)T;
            }
        ...
        if (NIL != bad && NIL == allow_other_keys_p) {
            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list62);
        }
        final SubLObject done_tail = cdestructuring_bind.property_list_member((SubLObject)$kw6$DONE, current);
        final SubLObject done = (SubLObject)((NIL != done_tail) ? conses_high.cadr(done_tail) : NIL);
        final SubLObject body;
        current = (body = temp);
        final SubLObject index = (SubLObject)$sym63$INDEX;
        final SubLObject key_set = (SubLObject)$sym64$KEY_SET;
        return (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(index, intermediate_index)), (SubLObject)ConsesLow.list((SubLObject)$sym55$PWHEN, (SubLObject)ConsesLow.list((SubLObject)$sym56$DO_INTERMEDIATE_INDEX_VALID_INDEX_P, index), (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list(key_set), (SubLObject)ConsesLow.list((SubLObject)$sym65$CMULTIPLE_VALUE_SETQ, (SubLObject)ConsesLow.list(key_set, unchanged_part), (SubLObject)ConsesLow.list((SubLObject)$sym66$SEGREGATE_INDEX_CHANGES_AND_PRISTINES, index)), (SubLObject)ConsesLow.list((SubLObject)$sym67$CSOME, (SubLObject)ConsesLow.list(key_var, key_set, done), (SubLObject)ConsesLow.listS((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(subindex_var, (SubLObject)ConsesLow.list((SubLObject)$sym68$INTERMEDIATE_INDEX_LOOKUP, index, key_var))), ConsesLow.append(body, (SubLObject)NIL))))));
    }
    ...
    public static SubLObject intermediate_index_lookup(final SubLObject intermediate_index, final SubLObject key) {
        ...
        return map_utilities.map_get_without_values(map, key, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject intermediate_index_leaves(final SubLObject intermediate_index) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != intermediate_index_p(intermediate_index) : intermediate_index;
        SubLObject leaves = (SubLObject)NIL;
        if (NIL != do_intermediate_index_valid_index_p(intermediate_index)) {
            ...
            SubLObject valid;
            for (SubLObject done_var = (SubLObject)NIL; NIL == done_var; done_var = (SubLObject)SubLObjectFactory.makeBoolean(NIL == valid)) {
                thread.resetMultipleValues();
                ...
                if (NIL != valid) {
                    ...
                    SubLObject key = (SubLObject)NIL;
                    SubLObject subindex = (SubLObject)NIL;
                    cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list70);
                    key = current.first();
                    current = current.rest();
                    cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list70);
                    ...
                    if (NIL == current) {
                        ...
                        SubLObject leaf = (SubLObject)NIL;
                        ...
                        cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list70);
                    }
                }
            }
        }
    ...
    public static SubLObject upgrade_final_indexP(final SubLObject subindex) {
        ...
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != use_final_topn_indicesP() && $final_topn_index_cutoff_size$.getGlobalValue().numL(final_index_leaf_count(subindex)));
    }
    ...
    public static SubLObject upgrade_combined_indices_to_final_indexP(final SubLObject subindex_base, final SubLObject subindex_augment) {
        ...
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != use_final_topn_indicesP() && $final_topn_index_cutoff_size$.getGlobalValue().numL(Numbers.add(final_index_leaf_count(subindex_base), final_index_leaf_count(subindex_augment))));
    }
    ...
    public static SubLObject intermediate_index_insert(final SubLObject intermediate_index, final SubLObject keys, final SubLObject leaf) {
        assert NIL != intermediate_index_p(intermediate_index) : intermediate_index;
        return intermediate_index_insert_int(intermediate_index, keys, leaf, (SubLObject)NIL);
    }
    ...
    public static SubLObject intermediate_index_insert_int(final SubLObject intermediate_index, final SubLObject keys, final SubLObject leaf, final SubLObject key_history) {
        SubLObject key = (SubLObject)NIL;
        SubLObject rest_keys = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(keys, keys, (SubLObject)$list73);
        key = keys.first();
        ...
        if (NIL != rest_keys) {
            ...
            if (NIL != intermediate_index_insert_int(subindex, rest_keys, leaf, new_key_history)) {
                ...
                intermediate_index_leaf_count_inc(intermediate_index, (SubLObject)ONE_INTEGER);
                return (SubLObject)T;
            }
        }
        else {
    ...
    public static SubLObject intermediate_index_delete(final SubLObject intermediate_index, final SubLObject keys, final SubLObject leaf) {
        ...
        if (NIL != subindex) {
            if (NIL != rest_keys) {
                ...
                if (NIL != result) {
                    intermediate_index_touch(intermediate_index, key);
                    intermediate_index_leaf_count_inc(intermediate_index, (SubLObject)MINUS_ONE_INTEGER);
                }
            }
            else {
    ...
    public static SubLObject merge_intermediate_indices(final SubLObject base, final SubLObject augment) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLObject base_count = (SubLObject)NIL;
        SubLObject base_map = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(base, base, (SubLObject)$list75);
        base_count = base.first();
        final SubLObject current = base_map = base.rest();
        SubLObject augment_count = (SubLObject)NIL;
        SubLObject augment_map = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(augment, augment, (SubLObject)$list76);
        ...
        for (SubLObject done_var = (SubLObject)NIL; NIL == done_var; done_var = (SubLObject)SubLObjectFactory.makeBoolean(NIL == valid)) {
            ...
            if (NIL != valid) {
                ...
                SubLObject aug_key = (SubLObject)NIL;
                SubLObject aug_index = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(current_$6, datum_$6, (SubLObject)$list77);
                ...
                if (NIL == current_$6) {
                    if (NIL != map_utilities.map_has_keyP(base_map, aug_key)) {
                        final SubLObject _prev_bind_0 = $current_complex_index_keys$.currentBinding(thread);
                        try {
                            $current_complex_index_keys$.bind((SubLObject)ConsesLow.cons(aug_key, $current_complex_index_keys$.getDynamicValue(thread)), thread);
                            final SubLObject best_index = merge_sub_indices(map_utilities.map_get(base_map, aug_key, (SubLObject)UNPROVIDED), aug_index);
                    ...
                    cdestructuring_bind.cdestructuring_bind_error(datum_$6, (SubLObject)$list77);
                }
            }
        }
        base_count = Numbers.add(base_count, augment_count);
        ConsesLow.set_nth((SubLObject)ZERO_INTEGER, base, base_count);
        return base;
    }
    ...
    public static SubLObject initialize_term_intermediate_index(final SubLObject v_term) {
        return reset_term_index(v_term, new_intermediate_index(Symbols.symbol_function((SubLObject)EQ)));
    }
    ...
    public static SubLObject final_index_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != final_unified_index_p(v_object) || NIL != final_sharded_index_p(v_object) || NIL != final_topn_index_p(v_object));
    }
    ...
    public static SubLObject do_final_index(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list78);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject leaf_var = (SubLObject)NIL;
        SubLObject final_index = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list78);
        ...
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list78);
            current_$8 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list78);
            if (NIL == conses_high.member(current_$8, (SubLObject)$list53, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                bad = (SubLObject)T;
            }
        ...
        if (NIL != bad && NIL == allow_other_keys_p) {
            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list78);
        }
        final SubLObject done_tail = cdestructuring_bind.property_list_member((SubLObject)$kw6$DONE, current);
        final SubLObject done = (SubLObject)((NIL != done_tail) ? conses_high.cadr(done_tail) : NIL);
        final SubLObject body;
        current = (body = temp);
        final SubLObject index = (SubLObject)$sym79$INDEX;
        return (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(index, final_index)), (SubLObject)ConsesLow.list((SubLObject)$sym80$PCOND, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym81$NULL, index)), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym82$FINAL_UNIFIED_INDEX_P, index), (SubLObject)ConsesLow.listS((SubLObject)$sym83$DO_FINAL_UNIFIED_INDEX_INTERNAL, (SubLObject)ConsesLow.list(leaf_var, index, (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL))), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym84$FINAL_SHARDED_INDEX_P, index), (SubLObject)ConsesLow.listS((SubLObject)$sym85$DO_FINAL_SHARDED_INDEX_INTERNAL, (SubLObject)ConsesLow.list(leaf_var, index, (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL))), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym86$FINAL_TOPN_INDEX_P, index), (SubLObject)ConsesLow.listS((SubLObject)$sym87$DO_FINAL_TOPN_INDEX_INTERNAL, (SubLObject)ConsesLow.list(leaf_var, index, (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL))), (SubLObject)ConsesLow.list((SubLObject)T, (SubLObject)ConsesLow.listS((SubLObject)$sym88$ENFORCE_TYPE, index, (SubLObject)$list89))));
    }
    ...
    public static SubLObject do_ordered_final_index(final SubLObject macroform, final SubLObject environment) {
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)NIL;
        SubLObject current_$9 = (SubLObject)NIL;
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list78);
            current_$9 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list78);
            if (NIL == conses_high.member(current_$9, (SubLObject)$list53, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                bad = (SubLObject)T;
            }
        ...
        final SubLObject body;
        current = (body = temp);
        final SubLObject index = (SubLObject)$sym90$INDEX;
        return (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(index, final_index)), (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)$list91, (SubLObject)ConsesLow.list((SubLObject)$sym80$PCOND, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym81$NULL, index)), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym82$FINAL_UNIFIED_INDEX_P, index), (SubLObject)ConsesLow.listS((SubLObject)$sym92$DO_ORDERED_FINAL_UNIFIED_INDEX_INTERNAL, (SubLObject)ConsesLow.list(leaf_var, index, (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL))), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym84$FINAL_SHARDED_INDEX_P, index), (SubLObject)ConsesLow.listS((SubLObject)$sym93$DO_ORDERED_FINAL_SHARDED_INDEX_INTERNAL, (SubLObject)ConsesLow.list(leaf_var, index, (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL))), (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$sym86$FINAL_TOPN_INDEX_P, index), (SubLObject)ConsesLow.listS((SubLObject)$sym94$DO_ORDERED_FINAL_TOPN_INDEX_INTERNAL, (SubLObject)ConsesLow.list(leaf_var, index, (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL))), (SubLObject)ConsesLow.list((SubLObject)T, (SubLObject)ConsesLow.listS((SubLObject)$sym88$ENFORCE_TYPE, index, (SubLObject)$list89)))));
    }
    ...
    public static SubLObject new_final_unified_index() {
        return set.new_set((SubLObject)EQL, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject do_final_unified_index_internal(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list95);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject leaf_var = (SubLObject)NIL;
        SubLObject final_unified_index = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list95);
        leaf_var = current.first();
        current = current.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list95);
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)NIL;
        SubLObject current_$10 = (SubLObject)NIL;
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list95);
            current_$10 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list95);
            if (NIL == conses_high.member(current_$10, (SubLObject)$list53, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                bad = (SubLObject)T;
            }
        ...
        if (NIL != bad && NIL == allow_other_keys_p) {
            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list95);
        }
        final SubLObject done_tail = cdestructuring_bind.property_list_member((SubLObject)$kw6$DONE, current);
        final SubLObject done = (SubLObject)((NIL != done_tail) ? conses_high.cadr(done_tail) : NIL);
        final SubLObject body;
        current = (body = temp);
        return (SubLObject)ConsesLow.listS((SubLObject)$sym96$DO_SET, (SubLObject)ConsesLow.list(leaf_var, (SubLObject)ConsesLow.list((SubLObject)$sym97$FINAL_UNIFIED_INDEX_SET, final_unified_index), (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL));
    }
    ...
    public static SubLObject do_ordered_final_unified_index_internal(final SubLObject macroform, final SubLObject environment) {
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)NIL;
        SubLObject current_$11 = (SubLObject)NIL;
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list95);
            current_$11 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list95);
            if (NIL == conses_high.member(current_$11, (SubLObject)$list53, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                bad = (SubLObject)T;
            }
        ...
        final SubLObject body;
        current = (body = temp);
        final SubLObject leaf_items = (SubLObject)$sym98$LEAF_ITEMS;
        return (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(leaf_items, (SubLObject)ConsesLow.list((SubLObject)$sym99$SET_ELEMENT_LIST, (SubLObject)ConsesLow.list((SubLObject)$sym97$FINAL_UNIFIED_INDEX_SET, final_unified_index)))), (SubLObject)ConsesLow.list((SubLObject)$sym100$CSETQ, leaf_items, (SubLObject)ConsesLow.list((SubLObject)$sym101$SORT_ASSERTIONS, leaf_items)), (SubLObject)ConsesLow.listS((SubLObject)$sym67$CSOME, (SubLObject)ConsesLow.list(leaf_var, leaf_items, done), ConsesLow.append(body, (SubLObject)NIL)));
    }
    ...
    public static SubLObject set_finshard_index_leaf_count(final SubLObject index, final SubLObject count) {
        ConsesLow.set_nth((SubLObject)ZERO_INTEGER, index, count);
        return index;
    }
    ...
    public static SubLObject set_finshard_index_keys(final SubLObject index, final SubLObject new_keys) {
        ConsesLow.set_nth((SubLObject)ONE_INTEGER, index, new_keys);
        return index;
    }
    ...
    public static SubLObject set_finshard_index_map(final SubLObject index, final SubLObject new_map) {
        ConsesLow.set_nth((SubLObject)TWO_INTEGER, index, new_map);
        return index;
    }
    ...
    public static SubLObject final_sharded_index_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != list_utilities.proper_list_p(v_object) && NIL != subl_promotions.non_negative_integer_p(finshard_index_leaf_count(v_object)) && finshard_index_keys(v_object).isVector() && NIL != map_utilities.map_p(finshard_index_map(v_object)) && NIL == conses_high.fourth(v_object));
    }
    ...
    public static SubLObject final_sharded_index_empty_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(NIL != final_sharded_index_p(v_object) && NIL != map_utilities.map_empty_p(finshard_index_map(v_object)));
    }
    ...
    public static SubLObject final_sharded_index_leaves(final SubLObject final_sharded_index) {
        ...
        SubLObject cursor;
        final SubLObject leaves = cursor = (SubLObject)ConsesLow.make_list(leaf_count, (SubLObject)UNPROVIDED);
        ...
        for (SubLObject done_var = (SubLObject)NIL; NIL == done_var; done_var = (SubLObject)SubLObjectFactory.makeBoolean(NIL == valid)) {
            ...
            if (NIL != valid) {
                ...
                final SubLObject datum = current = var;
                SubLObject key = (SubLObject)NIL;
                SubLObject shard = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list105);
                key = current.first();
                current = current.rest();
                cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list105);
                shard = current.first();
                ...
                if (NIL == current) {
                    ...
                    cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list105);
                }
            }
        }
        return leaves;
    ...
    public static SubLObject finshard_index_find_shard(final SubLObject final_sharded_index, final SubLObject leaf) {
        ...
        if (NIL != subl_promotions.non_negative_integer_p(key_index)) {
            ...
            return map_utilities.map_get(finshard_index_map(final_sharded_index), covering_key, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject finshard_index_find_shard_key_index(final SubLObject final_sharded_index, final SubLObject leaf) {
        ...
        SubLObject right_wall = Numbers.subtract(Sequences.length(keys), (SubLObject)ONE_INTEGER);
        final SubLObject max_shard_suid = Vectors.aref(keys, right_wall);
        if (max_shard_suid.numL(leaf_suid)) {
            return (SubLObject)NIL;
        }
        SubLObject left_wall = (SubLObject)ZERO_INTEGER;
        while (left_wall.numLE(right_wall)) {
            final SubLObject mid = Numbers.integerDivide(Numbers.add(left_wall, right_wall), (SubLObject)TWO_INTEGER);
            final SubLObject mid_shard_suid = Vectors.aref(keys, mid);
            if (mid_shard_suid.numL(leaf_suid)) {
                left_wall = Numbers.add((SubLObject)ONE_INTEGER, mid);
            }
            else {
                if (!mid_shard_suid.numG(leaf_suid)) {
                    return mid;
                }
                right_wall = Numbers.subtract(mid, (SubLObject)ONE_INTEGER);
            }
        }
        return (SubLObject)(left_wall.numL(Sequences.length(keys)) ? left_wall : NIL);
    }
    ...
    public static SubLObject final_sharded_index_arbitrary_leaf(final SubLObject final_sharded_index) {
        ...
        final SubLObject leaf_key = map_utilities.map_arbitrary_key(shard_map, (SubLObject)UNPROVIDED);
        final SubLObject leaf = set_utilities.set_arbitrary_element(map_utilities.map_get(shard_map, leaf_key, (SubLObject)UNPROVIDED));
        return leaf;
    }
    ...
    public static SubLObject do_final_sharded_index_internal(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list106);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject leaf_var = (SubLObject)NIL;
        SubLObject final_sharded_index = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list106);
        leaf_var = current.first();
        current = current.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list106);
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)NIL;
        SubLObject current_$12 = (SubLObject)NIL;
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list106);
            current_$12 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list106);
            if (NIL == conses_high.member(current_$12, (SubLObject)$list53, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                bad = (SubLObject)T;
            }
        ...
        if (NIL != bad && NIL == allow_other_keys_p) {
            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list106);
        }
        final SubLObject done_tail = cdestructuring_bind.property_list_member((SubLObject)$kw6$DONE, current);
        final SubLObject done = (SubLObject)((NIL != done_tail) ? conses_high.cadr(done_tail) : NIL);
        final SubLObject body;
        current = (body = temp);
        final SubLObject ignored_key = (SubLObject)$sym107$IGNORED_KEY;
        final SubLObject shard = (SubLObject)$sym108$SHARD;
        return (SubLObject)ConsesLow.list((SubLObject)$sym57$DO_MAP, (SubLObject)ConsesLow.list(ignored_key, shard, (SubLObject)ConsesLow.list((SubLObject)$sym109$FINAL_SHARDED_INDEX_SHARD_MAP, final_sharded_index), (SubLObject)$kw6$DONE, done), (SubLObject)ConsesLow.list((SubLObject)$sym110$IGNORE, ignored_key), (SubLObject)ConsesLow.listS((SubLObject)$sym96$DO_SET, (SubLObject)ConsesLow.list(leaf_var, shard, (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL)));
    }
    ...
    public static SubLObject do_ordered_final_sharded_index_internal(final SubLObject macroform, final SubLObject environment) {
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)NIL;
        SubLObject current_$13 = (SubLObject)NIL;
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list106);
            current_$13 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list106);
            if (NIL == conses_high.member(current_$13, (SubLObject)$list53, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                bad = (SubLObject)T;
            }
        ...
        final SubLObject body;
        current = (body = temp);
        final SubLObject shard_key_list = (SubLObject)$sym111$SHARD_KEY_LIST;
        final SubLObject key = (SubLObject)$sym112$KEY;
        final SubLObject shard = (SubLObject)$sym113$SHARD;
        final SubLObject shard_contents = (SubLObject)$sym114$SHARD_CONTENTS;
        return (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(shard_key_list, (SubLObject)ConsesLow.listS((SubLObject)$sym115$SORT, (SubLObject)ConsesLow.list((SubLObject)$sym116$MAP_KEYS, (SubLObject)ConsesLow.list((SubLObject)$sym109$FINAL_SHARDED_INDEX_SHARD_MAP, final_sharded_index)), (SubLObject)$list117)), (SubLObject)ConsesLow.list(shard_contents)), (SubLObject)ConsesLow.list((SubLObject)$sym67$CSOME, (SubLObject)ConsesLow.list(key, shard_key_list, done), (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(shard, (SubLObject)ConsesLow.list((SubLObject)$sym118$MAP_GET, (SubLObject)ConsesLow.list((SubLObject)$sym109$FINAL_SHARDED_INDEX_SHARD_MAP, final_sharded_index), key))), (SubLObject)ConsesLow.list((SubLObject)$sym100$CSETQ, shard_contents, (SubLObject)ConsesLow.list((SubLObject)$sym119$ORDERED_FINAL_SHARDED_INDEX_EXTRACT_CONTENTS, shard, shard_contents)), (SubLObject)ConsesLow.list((SubLObject)$sym120$DO_VECTOR, (SubLObject)ConsesLow.list(leaf_var, shard_contents, (SubLObject)$kw6$DONE, done), (SubLObject)ConsesLow.listS((SubLObject)$sym55$PWHEN, (SubLObject)ConsesLow.list((SubLObject)$sym121$ASSERTION_P, leaf_var), ConsesLow.append(body, (SubLObject)NIL))))));
    }
    ...
    public static SubLObject ordered_final_sharded_index_extract_contents(final SubLObject shard, SubLObject contents) {
        SubLObject contents_size = (SubLObject)(contents.isVector() ? ZERO_INTEGER : Sequences.length(contents));
        final SubLObject shard_size = set.set_size(shard);
        if (contents_size.numL(shard_size)) {
            contents_size = shard_size;
            contents = Vectors.make_vector(shard_size, (SubLObject)UNPROVIDED);
        }
        ...
        while (index.numL(contents_size)) {
            Vectors.set_aref(contents, index, (SubLObject)NIL);
            index = Numbers.add(index, (SubLObject)ONE_INTEGER);
        }
        Sort.sort(contents, (SubLObject)$sym122$POSSIBLE_ASSERTION_, (SubLObject)UNPROVIDED);
        return contents;
    }
    ...
    public static SubLObject append_finshard_index_keys(final SubLObject index, final SubLObject new_key) {
        final SubLObject bigger_keys = vector_utilities.extend_vector(finshard_index_keys(index), (SubLObject)ONE_INTEGER, new_key);
    ...
    public static SubLObject final_sharded_index_insert_internal(final SubLObject final_sharded_index, final SubLObject leaf) {
        ...
        if (NIL != shard_key_index) {
            ...
            return final_sharded_index_insert_into_shard(final_sharded_index, leaf, map_utilities.map_get(shard_map, shard_key, (SubLObject)UNPROVIDED));
        }
        final SubLObject right_wall = Numbers.subtract(Sequences.length(keys), (SubLObject)ONE_INTEGER);
        final SubLObject last_key = Vectors.aref(keys, right_wall);
        final SubLObject shard = map_utilities.map_get(shard_map, last_key, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject final_sharded_index_insert_into_shard(final SubLObject final_sharded_index, final SubLObject leaf, final SubLObject shard) {
        ...
        if (!pre_size.numE(set.set_size(shard))) {
            increment_finshard_index_leaf_count(final_sharded_index, (SubLObject)UNPROVIDED);
        }
        return final_sharded_index;
    }
    ...
    public static SubLObject final_sharded_index_delete(final SubLObject final_sharded_index, final SubLObject leaf) {
        ...
        final SubLObject shard_map = finshard_index_map(final_sharded_index);
        final SubLObject shard_key_index = finshard_index_find_shard_key_index(final_sharded_index, leaf);
        final SubLObject shard_key = (SubLObject)((NIL != shard_key_index) ? Vectors.aref(keys, shard_key_index) : NIL);
        final SubLObject shard = map_utilities.map_get(shard_map, shard_key, (SubLObject)UNPROVIDED);
        if (NIL != set.set_p(shard)) {
            final SubLObject pre_size = set.set_size(shard);
            set.set_remove(leaf, shard);
            if (!pre_size.numE(set.set_size(shard))) {
                map_utilities.map_touch(shard_map, shard_key);
                decrement_finshard_index_leaf_count(final_sharded_index, (SubLObject)UNPROVIDED);
            }
        }
        return final_sharded_index;
    }
    ...
    public static SubLObject reshard_final_sharded_index(final SubLObject final_sharded_index) {
        ...
        final SubLObject leaves = Vectors.make_vector(leaf_count, (SubLObject)UNPROVIDED);
        SubLObject cursor = (SubLObject)ZERO_INTEGER;
        final SubLObject iterator = map_utilities.new_map_iterator(finshard_index_map(final_sharded_index));
        SubLObject valid;
        for (SubLObject done_var = (SubLObject)NIL; NIL == done_var; done_var = (SubLObject)SubLObjectFactory.makeBoolean(NIL == valid)) {
            thread.resetMultipleValues();
                ...
                if (NIL == current) {
                    ...
                    for (basis_object = set_contents.do_set_contents_basis_object(set_contents_var), state = (SubLObject)NIL, state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); NIL == set_contents.do_set_contents_doneP(basis_object, state); state = set_contents.do_set_contents_update_state(state)) {
                        ...
                        if (NIL != set_contents.do_set_contents_element_validP(state, leaf)) {
                            ...
                            cursor = Numbers.add(cursor, (SubLObject)ONE_INTEGER);
                        }
                    }
                }
                else {
        ...
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && !cursor.numE(leaf_count)) {
            Errors.error((SubLObject)$str123$Index_count_was__A__yet_we_copied, leaf_count, cursor);
        }
    ...
    public static SubLObject ncreate_final_sharded_index(final SubLObject leaves) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        final SubLObject ordered_leaves = Sort.sort(leaves, (SubLObject)$sym124$_, (SubLObject)$sym125$INDEXING_LEAF_SUID);
        ...
        final SubLObject shard_map = dictionary.new_dictionary((SubLObject)EQL, shard_count);
        SubLObject shard = new_final_unified_index();
        SubLObject last_leaf = (SubLObject)NIL;
        for (SubLObject sequence_var = ordered_leaves, end_index = (SubLObject)(sequence_var.isList() ? NIL : Sequences.length(sequence_var)), element_num = (SubLObject)ZERO_INTEGER, sequence_doneP = subl_macros.do_sequence_index_doneP(element_num, end_index, sequence_var); NIL == sequence_doneP; sequence_doneP = subl_macros.do_sequence_index_doneP(element_num, end_index, sequence_var)) {
            ...
            element_num = Numbers.add(element_num, (SubLObject)ONE_INTEGER);
        }
        ...
        final SubLObject keys = Sort.sort(list_utilities.list2vector(map_utilities.map_keys(shard_map)), (SubLObject)$sym124$_, (SubLObject)UNPROVIDED);
        final SubLObject key_count = Sequences.length(keys);
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && !key_count.numE(shard_count)) {
            Errors.error((SubLObject)$str126$Implementation_error__shard_count, shard_count, key_count);
        }
    ...
    public static SubLObject reorganize_modified_final_sharded_index(final SubLObject final_sharded_index) {
        ...
        final SubLObject shard_map = dictionary.new_dictionary((SubLObject)EQL, map_utilities.map_size(old_shard_map));
        SubLObject cdolist_list_var;
        final SubLObject changed_keys = cdolist_list_var = map_utilities.map_change_set(old_shard_map, shard_map);
        SubLObject changed_key = (SubLObject)NIL;
        changed_key = cdolist_list_var.first();
        while (NIL != cdolist_list_var) {
            final SubLObject changed_value = map_utilities.map_get(old_shard_map, changed_key, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject final_sharded_index_to_fvector_backed_sharded_index(final SubLObject final_sharded_index, final SubLObject fvector, final SubLObject indexical) {
        final SubLObject paged_map = file_vector_utilities.convert_map_to_file_vector_backed_map(finshard_index_map(final_sharded_index), fvector, (SubLObject)$kw127$SWAPPED_OUT, (SubLObject)$kw128$COMPACT);
    ...
    public static SubLObject update_fvector_backed_final_sharded_index(final SubLObject final_sharded_index, final SubLObject fvector, final SubLObject indexical) {
        final SubLObject paged_map = file_vector_utilities.upgrade_map_to_file_vector_backed_map(finshard_index_map(final_sharded_index), fvector, (SubLObject)$kw127$SWAPPED_OUT);
        final SubLObject backed_map = file_vector_utilities.new_indexical_backed_map(paged_map, indexical);
        set_finshard_index_map(final_sharded_index, backed_map);
        return final_sharded_index;
    }
    ...
    public static SubLObject validate_final_sharded_index(final SubLObject final_sharded_index) {
        ...
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && !shard_count.numE(keys_lenght)) {
            Errors.error((SubLObject)$str129$Shard_count_of__A_does_not_match_, shard_count, keys_lenght);
        }
        SubLObject test_keys = map_utilities.map_keys(shard_map);
        test_keys = Sort.sort(test_keys, (SubLObject)$sym124$_, (SubLObject)UNPROVIDED);
        SubLObject i;
        SubLObject expected_key;
        SubLObject actual_key;
        for (i = (SubLObject)NIL, i = (SubLObject)ZERO_INTEGER; i.numL(shard_count); i = Numbers.add(i, (SubLObject)ONE_INTEGER)) {
            ...
            if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && !expected_key.numE(actual_key)) {
                Errors.error((SubLObject)$str130$Shard_key___A_is_wrong____we_expe, i, expected_key, actual_key);
            }
        }
        ...
        for (SubLObject done_var = (SubLObject)NIL; NIL == done_var; done_var = (SubLObject)SubLObjectFactory.makeBoolean(NIL == valid)) {
            ...
            if (NIL != valid) {
                SubLObject current;
                final SubLObject datum = current = var;
                SubLObject max_suid = (SubLObject)NIL;
                SubLObject shard = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list131);
                    ...
                    for (basis_object = set_contents.do_set_contents_basis_object(set_contents_var), state = (SubLObject)NIL, state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); NIL == set_contents.do_set_contents_doneP(basis_object, state); state = set_contents.do_set_contents_update_state(state)) {
                        ...
                        if (NIL != set_contents.do_set_contents_element_validP(state, leaf)) {
                            ...
                            if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && !leaf_suid.numLE(max_suid)) {
                                Errors.error((SubLObject)$str132$Shard_with_max_ID__A_contains_lea, max_suid, leaf, leaf_suid);
                            }
                            leaf_count = Numbers.subtract(leaf_count, (SubLObject)ONE_INTEGER);
                        }
                    }
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list131);
                }
            }
        }
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && !leaf_count.isZero()) {
            Errors.error((SubLObject)$str133$We_expected_to_find__A_leaves__bu, final_sharded_index_leaf_count(final_sharded_index), leaf_count);
        }
        return final_sharded_index;
    }
    ...
    public static SubLObject new_final_sharded_index_iterator(final SubLObject final_sharded_index) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        final SubLObject shard_map = finshard_index_map(final_sharded_index);
        SubLObject iterators = (SubLObject)NIL;
        final SubLObject iterator = map_utilities.new_map_iterator(shard_map);
        SubLObject valid;
        for (SubLObject done_var = (SubLObject)NIL; NIL == done_var; done_var = (SubLObject)SubLObjectFactory.makeBoolean(NIL == valid)) {
            thread.resetMultipleValues();
    ...
    public static SubLObject with_final_topn_index_tracking(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list136);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject newbies = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list136);
        ...
        if (NIL == current) {
            final SubLObject body;
            current = (body = temp);
            return (SubLObject)ConsesLow.list((SubLObject)$sym9$CLET, (SubLObject)$list137, reader.bq_cons((SubLObject)$sym28$PROGN, ConsesLow.append(body, (SubLObject)NIL)), (SubLObject)ConsesLow.listS((SubLObject)$sym100$CSETQ, newbies, (SubLObject)$list138));
        }
        cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list136);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject without_final_topn_index_tracking(final SubLObject macroform, final SubLObject environment) {
        ...
        return (SubLObject)ConsesLow.listS((SubLObject)$sym9$CLET, (SubLObject)$list139, ConsesLow.append(body, (SubLObject)NIL));
    }
    ...
    public static SubLObject possibly_note_new_final_topn_index(final SubLObject v_term, final SubLObject key_path) {
        ...
        if (NIL != $with_final_topn_index_tracking$.getDynamicValue(thread)) {
            $recent_final_topn_indices$.setDynamicValue((SubLObject)ConsesLow.cons((SubLObject)ConsesLow.cons(v_term, key_path), $recent_final_topn_indices$.getDynamicValue(thread)), thread);
        }
        return v_term;
    }
    ...
    public static SubLObject final_topn_index_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(v_object.isCons() && NIL != list_utilities.lengthE(v_object, (SubLObject)THREE_INTEGER, (SubLObject)UNPROVIDED) && NIL != subl_promotions.non_negative_integer_p(v_object.first()) && NIL != indexed_term_p(conses_high.second(v_object)) && conses_high.third(v_object).isCons());
    }
    ...
    public static SubLObject final_topn_index_count(final SubLObject final_topn_index) {
        return ConsesLow.nth((SubLObject)ZERO_INTEGER, final_topn_index);
    }
    ...
    public static SubLObject set_final_topn_index_count(final SubLObject final_topn_index, final SubLObject number) {
        ...
        ConsesLow.set_nth((SubLObject)ZERO_INTEGER, final_topn_index, number);
    ...
    public static SubLObject final_topn_index_term(final SubLObject final_topn_index) {
        return ConsesLow.nth((SubLObject)ONE_INTEGER, final_topn_index);
    }
    ...
    public static SubLObject final_topn_index_key_path(final SubLObject final_topn_index) {
        return ConsesLow.nth((SubLObject)TWO_INTEGER, final_topn_index);
    }
    ...
    public static SubLObject new_final_topn_index(final SubLObject v_term, final SubLObject key_path, SubLObject count) {
        if (count == UNPROVIDED) {
            count = (SubLObject)ZERO_INTEGER;
        }
        final SubLObject topn_index = (SubLObject)ConsesLow.list(count, v_term, key_path);
        if (count.isZero()) {
            Errors.warn((SubLObject)$str141$__Creating_empty_TOP_N_index__A_o, key_path, v_term);
        }
    ...
    public static SubLObject upgrade_final_index(final SubLObject final_index) {
        ...
        Errors.warn((SubLObject)$str142$Upgrading_index__A_on__A___A_item, key_path, v_term, count);
    ...
    public static SubLObject new_final_topn_index_iterator(final SubLObject final_topn_index) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLObject msg = (SubLObject)NIL;
        try {
            thread.throwStack.push(subl_macro_promotions.$catch_error_message_target$.getGlobalValue());
            final SubLObject _prev_bind_0 = Errors.$error_handler$.currentBinding(thread);
            try {
                Errors.$error_handler$.bind((SubLObject)$sym143$CATCH_ERROR_MESSAGE_HANDLER, thread);
                try {
                    Errors.error((SubLObject)$str144$Final_Top_N_index_iterator_for__A, final_topn_index);
                }
                catch (Throwable catch_var) {
                    Errors.handleThrowable(catch_var, (SubLObject)NIL);
                }
            }
            finally {
        ...
        Errors.warn((SubLObject)$str145$_A__, msg);
        return iteration.new_filter_iterator(assertion_handles.new_assertions_iterator(), (SubLObject)$sym146$ASSERTION_MATCHES_FINAL_TOPN_INDEXKEY_PATH_, final_topn_index_iterator_build_filter_args(final_topn_index));
    }
    ...
    public static SubLObject final_topn_index_iterator_build_filter_args(final SubLObject final_topn_index) {
        ...
        final SubLObject matcher_fn = kb_indexing_declarations.get_index_prop(index, (SubLObject)$kw147$SIMPLE_MATCH_FUNCTION);
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && !matcher_fn.isFunctionSpec()) {
            Errors.error((SubLObject)$str148$No_match_function_available_for_d, keys, v_term);
        }
    ...
    public static SubLObject do_final_topn_index_internal(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list149);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject leaf_var = (SubLObject)NIL;
        SubLObject final_topn_index = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list149);
        leaf_var = current.first();
        current = current.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list149);
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)NIL;
        SubLObject current_$14 = (SubLObject)NIL;
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list149);
            current_$14 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list149);
            if (NIL == conses_high.member(current_$14, (SubLObject)$list53, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                bad = (SubLObject)T;
            }
        ...
        if (NIL != bad && NIL == allow_other_keys_p) {
            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list149);
        }
        final SubLObject done_tail = cdestructuring_bind.property_list_member((SubLObject)$kw6$DONE, current);
        final SubLObject done = (SubLObject)((NIL != done_tail) ? conses_high.cadr(done_tail) : NIL);
        final SubLObject body;
        current = (body = temp);
        return (SubLObject)ConsesLow.listS((SubLObject)$sym18$DO_ITERATOR, (SubLObject)ConsesLow.list(leaf_var, (SubLObject)ConsesLow.list((SubLObject)$sym150$NEW_FINAL_TOPN_INDEX_ITERATOR, final_topn_index), (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL));
    }
    ...
    public static SubLObject do_ordered_final_topn_index_internal(final SubLObject macroform, final SubLObject environment) {
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)NIL;
        SubLObject current_$15 = (SubLObject)NIL;
        while (NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list149);
            current_$15 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)$list149);
            if (NIL == conses_high.member(current_$15, (SubLObject)$list53, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                bad = (SubLObject)T;
            }
        ...
        final SubLObject body;
        current = (body = temp);
        return (SubLObject)ConsesLow.listS((SubLObject)$sym18$DO_ITERATOR, (SubLObject)ConsesLow.list(leaf_var, (SubLObject)ConsesLow.list((SubLObject)$sym151$NEW_ORDERED_FINAL_TOPN_INDEX_ITERATOR, final_topn_index), (SubLObject)$kw6$DONE, done), ConsesLow.append(body, (SubLObject)NIL));
    }
    ...
    public static SubLObject final_topn_index_memberP(final SubLObject final_topn_index, final SubLObject leaf) {
        ...
        SubLObject matcher_fn = (SubLObject)NIL;
        SubLObject args = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list152);
        ...
        cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list152);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject final_topn_index_insert(final SubLObject final_topn_index, final SubLObject leaf) {
        inc_final_topn_index_count(final_topn_index, (SubLObject)UNPROVIDED);
        return final_topn_index;
    }
    ...
    public static SubLObject final_topn_index_delete(final SubLObject final_topn_index, final SubLObject leaf) {
        dec_final_topn_index_count(final_topn_index, (SubLObject)UNPROVIDED);
        return final_topn_index;
    }
    ...
    public static SubLObject indexing_leaf_installed_p(final SubLObject v_object) {
        return assertions_high.valid_assertion(v_object, (SubLObject)NIL);
    }
    ...
    public static SubLObject indexing_leaf_not_hosed_p(final SubLObject v_object) {
        return assertions_high.valid_assertion(v_object, (SubLObject)T);
    }
    ...
    public static SubLObject merge_final_indices(final SubLObject base, final SubLObject augment) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLObject best_index = (SubLObject)NIL;
        SubLObject msg = (SubLObject)NIL;
        SubLObject flippedP = (SubLObject)NIL;
        try {
            thread.throwStack.push(subl_macro_promotions.$catch_error_message_target$.getGlobalValue());
            final SubLObject _prev_bind_0 = Errors.$error_handler$.currentBinding(thread);
            try {
        ...
        if (msg.isString()) {
            Errors.error((SubLObject)$str153$Could_not_merge_final_indices__A_, (NIL != flippedP) ? augment : base, (NIL != flippedP) ? base : augment, msg);
        }
        return best_index;
    }
    ...
    public static SubLObject merge_final_indices_internal(final SubLObject base, final SubLObject augment) {
        ...
        if (NIL != upgrade_combined_indices_to_final_indexP(base, augment)) {
            ...
            Errors.warn((SubLObject)$str154$Merging_indices__A_on__A___A_item, new SubLObject[] { key_path, v_term, base_count, augment_count });
            ...
            if (NIL != final_unified_index_p(augment)) {
                ...
                for (SubLObject done_var = (SubLObject)NIL; NIL == done_var; done_var = (SubLObject)SubLObjectFactory.makeBoolean(NIL == valid)) {
                    ...
                    if (NIL != valid) {
                        SubLObject current;
                        final SubLObject datum = current = var;
                        SubLObject ignored_key = (SubLObject)NIL;
                        SubLObject shard = (SubLObject)NIL;
                        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)$list155);
                        ...
                        if (NIL == current) {
                            ...
                            SubLObject state2;
                            SubLObject leaf2;
                            for (basis_object2 = set_contents.do_set_contents_basis_object(set_contents_var2), state2 = (SubLObject)NIL, state2 = set_contents.do_set_contents_initial_state(basis_object2, set_contents_var2); NIL == set_contents.do_set_contents_doneP(basis_object2, state2); state2 = set_contents.do_set_contents_update_state(state2)) {
                            ...
                            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)$list155);
                        }
                    }
                }
            }
    ...
    public static SubLObject init_kb_indexing_datastructures_file() {
        $assertion_indexing_store$ = SubLFiles.deflexical("*ASSERTION-INDEXING-STORE*", (SubLObject)((NIL != Symbols.boundp((SubLObject)$sym0$_ASSERTION_INDEXING_STORE_)) ? $assertion_indexing_store$.getGlobalValue() : NIL));
        $meta_assertion_frequency$ = SubLFiles.deflexical("*META-ASSERTION-FREQUENCY*", (SubLObject)$float1$0_05);
        $unindexed_syntax_constants$ = SubLFiles.deflexical("*UNINDEXED-SYNTAX-CONSTANTS*", (SubLObject)$list21);
        $current_complex_index_term$ = SubLFiles.defparameter("*CURRENT-COMPLEX-INDEX-TERM*", (SubLObject)NIL);
        $current_complex_index_keys$ = SubLFiles.defparameter("*CURRENT-COMPLEX-INDEX-KEYS*", (SubLObject)NIL);
        $current_complex_index_keys_in_orderP$ = SubLFiles.defparameter("*CURRENT-COMPLEX-INDEX-KEYS-IN-ORDER?*", (SubLObject)T);
        $changed_index_entry_hints$ = SubLFiles.defparameter("*CHANGED-INDEX-ENTRY-HINTS*", (SubLObject)NIL);
        $final_topn_index_cutoff_size$ = SubLFiles.deflexical("*FINAL-TOPN-INDEX-CUTOFF-SIZE*", (SubLObject)NIL);
        $ordered_final_index_resource$ = SubLFiles.defparameter("*ORDERED-FINAL-INDEX-RESOURCE*", (SubLObject)NIL);
        $final_sharded_index_shard_size$ = SubLFiles.deflexical("*FINAL-SHARDED-INDEX-SHARD-SIZE*", (SubLObject)((NIL != Symbols.boundp((SubLObject)$sym103$_FINAL_SHARDED_INDEX_SHARD_SIZE_)) ? $final_sharded_index_shard_size$.getGlobalValue() : $int104$1000));
        $recent_final_topn_indices$ = SubLFiles.defparameter("*RECENT-FINAL-TOPN-INDICES*", (SubLObject)NIL);
        $with_final_topn_index_tracking$ = SubLFiles.defparameter("*WITH-FINAL-TOPN-INDEX-TRACKING*", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    
    public static SubLObject setup_kb_indexing_datastructures_file() {
        subl_macro_promotions.declare_defglobal((SubLObject)$sym0$_ASSERTION_INDEXING_STORE_);
        access_macros.register_macro_helper((SubLObject)$sym20$NEW_ASSERTIONS_WITH_META_ASSERTIONS_ITERATOR, (SubLObject)$sym10$DO_ASSERTIONS_WITH_META_ASSERTIONS);
        utilities_macros.register_cyc_api_function((SubLObject)$sym22$INDEXED_TERM_P, (SubLObject)$list23, (SubLObject)$str24$Returns_T_iff_OBJECT_is_an_indexe, (SubLObject)NIL, (SubLObject)$list25);
        access_macros.register_macro_helper((SubLObject)$sym39$DO_SIMPLE_INDEX_TERM_ASSERTION_LIST, (SubLObject)$sym40$DO_SIMPLE_INDEX);
        access_macros.register_macro_helper((SubLObject)$sym56$DO_INTERMEDIATE_INDEX_VALID_INDEX_P, (SubLObject)$sym59$DO_INTERMEDIATE_INDEX);
        access_macros.register_macro_helper((SubLObject)$sym66$SEGREGATE_INDEX_CHANGES_AND_PRISTINES, (SubLObject)$sym69$DO_CHANGED_INTERMEDIATE_INDEX);
        access_macros.register_external_symbol((SubLObject)$sym72$_FINAL_TOPN_INDEX_CUTOFF_SIZE_);
        access_macros.register_macro_helper((SubLObject)$sym58$INTERMEDIATE_INDEX_MAP, (SubLObject)$sym59$DO_INTERMEDIATE_INDEX);
        access_macros.register_macro_helper((SubLObject)$sym97$FINAL_UNIFIED_INDEX_SET, (SubLObject)$sym102$DO_FINAL_UNIFIED_INDEX);
        subl_macro_promotions.declare_defglobal((SubLObject)$sym103$_FINAL_SHARDED_INDEX_SHARD_SIZE_);
        access_macros.register_macro_helper((SubLObject)$sym109$FINAL_SHARDED_INDEX_SHARD_MAP, (SubLObject)$sym85$DO_FINAL_SHARDED_INDEX_INTERNAL);
        access_macros.register_macro_helper((SubLObject)$sym119$ORDERED_FINAL_SHARDED_INDEX_EXTRACT_CONTENTS, (SubLObject)$sym85$DO_FINAL_SHARDED_INDEX_INTERNAL);
        access_macros.register_macro_helper((SubLObject)$sym134$FINAL_SHARDED_INDEX_SET, (SubLObject)$sym135$DO_FINAL_SHARDED_INDEX);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $list14 = ConsesLow.list((SubLObject)ZERO_INTEGER);
        ...
        $list137 = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("*RECENT-FINAL-TOPN-INDICES*")), (SubLObject)ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("*WITH-FINAL-TOPN-INDEX-TRACKING*"), (SubLObject)T));
