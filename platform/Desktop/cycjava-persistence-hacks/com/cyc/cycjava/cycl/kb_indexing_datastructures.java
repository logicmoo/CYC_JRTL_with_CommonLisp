...
public final class kb_indexing_datastructures extends SubLTranslatedFile
{
  ...
  @SubLTranslatedFile.SubL(
    source = "cycl/kb-indexing-datastructures.lisp",
    position = 1640L)
  ...
  public static SubLObject do_assertions_with_meta_assertions(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( !progress_message.isAtom() )
    {
      ...
      ConsesLow.list( $sym9$CLET, ConsesLow.list( ConsesLow.list( progress_message_var, progress_message ) ), ConsesLow.listS(
          $sym10$DO_ASSERTIONS_WITH_META_ASSERTIONS, ConsesLow.list( assertion_var, $kw6$DONE, done, $kw7$PROGRESS_MESSAGE, progress_message_var ), ConsesLow.append(
              body, NIL ) ) );
    }
    if( NIL != progress_message )
    {
      ...
      return ConsesLow.list( $sym9$CLET, ConsesLow.list( reader.bq_cons( total, $list13 ), reader.bq_cons( sofar, $list14 ) ), ConsesLow.list(
          $sym15$NOTING_PERCENT_PROGRESS, progress_message, ConsesLow.listS( $sym10$DO_ASSERTIONS_WITH_META_ASSERTIONS, ConsesLow.list( assertion_var,
              $kw6$DONE, done ), ConsesLow.append( body, ConsesLow.list( ConsesLow.list( $sym16$CINC, sofar ), ConsesLow.list(
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != cycl_utilities.reified_term_p( v_object ) || NIL != indexed_unrepresented_term_p( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != indexed_term_p( v_object ) && NIL == valid_indexed_termP( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != indexed_term_p( v_object ) && NIL == valid_indexed_term_robustP( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != indexed_term_p( v_object ) || NIL != hlmt.hlmt_p( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != indexed_term_p( v_object ) && NIL == unindexed_syntax_constant_p( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != valid_indexed_termP( v_object ) && NIL == unindexed_syntax_constant_p( v_object ) );
  }
  ...
  public static SubLObject do_indexed_terms(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.list( $sym28$PROGN, ConsesLow.listS( $sym29$DO_FORTS, ConsesLow.list( var, ConsesLow.list( $sym30$FORMAT,
          NIL, $str31$_A__forts_, message ) ), ConsesLow.append( body, NIL ) ), ConsesLow.listS( $sym32$DO_ASSERTIONS, ConsesLow.list( var,
              ConsesLow.list( $sym30$FORMAT, NIL, $str33$_A__assertions_, message ) ), ConsesLow.append( body, NIL ) ), ConsesLow.listS(
                  $sym34$DO_KB_UNREPRESENTED_TERMS, ConsesLow.list( var, $kw7$PROGRESS_MESSAGE, ConsesLow.list( $sym30$FORMAT, NIL,
                      $str35$_A__unrepresented_terms_, message ) ), ConsesLow.append( body, NIL ) ) );
    }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != simple_index_p( v_object ) || NIL != complex_index_p( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( v_object.isList() && NIL == complex_index_p( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != simple_index_p( v_object ) && NIL != list_utilities.every_in_list( Symbols.symbol_function( $sym37$INDEXING_LEAF_INSTALLED_P ), v_object,
        UNPROVIDED ) );
  }
  ...
  public static SubLObject with_current_complex_index_path(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.listS( $sym9$CLET, ConsesLow.list( ConsesLow.list( $sym43$_CURRENT_COMPLEX_INDEX_TERM_, v_term ), ConsesLow.list(
          $sym44$_CURRENT_COMPLEX_INDEX_KEYS_, keys ) ), ConsesLow.append( body, NIL ) );
    }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != intermediate_index_p( v_object ) || NIL != final_index_p( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( v_object.isCons() && v_object.first().isInteger() && NIL != map_utilities.map_p( v_object.rest() ) );
  }
  ...
  public static SubLObject do_intermediate_index(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.list( $sym9$CLET, ConsesLow.list( ConsesLow.list( index, intermediate_index ) ), ConsesLow.list( $sym55$PWHEN,
        ConsesLow.list( $sym56$DO_INTERMEDIATE_INDEX_VALID_INDEX_P, index ), ConsesLow.listS( $sym57$DO_MAP, ConsesLow.list( key_var, subindex_var,
            ConsesLow.list( $sym58$INTERMEDIATE_INDEX_MAP, index ), $kw6$DONE, done ), ConsesLow.append( body, NIL ) ) ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != v_object );
  }
  ...
  public static SubLObject capture_changed_index_entry_hints(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.listS( $sym9$CLET, ConsesLow.list( ConsesLow.list( $sym61$_CHANGED_INDEX_ENTRY_HINTS_, v_set ) ), ConsesLow.append( body,
          NIL ) );
    }
  ...
  public static SubLObject do_changed_intermediate_index(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.list( $sym9$CLET, ConsesLow.list( ConsesLow.list( index, intermediate_index ) ), ConsesLow.list( $sym55$PWHEN,
        ConsesLow.list( $sym56$DO_INTERMEDIATE_INDEX_VALID_INDEX_P, index ), ConsesLow.list( $sym9$CLET, ConsesLow.list( key_set ), ConsesLow
            .list( $sym65$CMULTIPLE_VALUE_SETQ, ConsesLow.list( key_set, unchanged_part ), ConsesLow.list( $sym66$SEGREGATE_INDEX_CHANGES_AND_PRISTINES, index ) ),
            ConsesLow.list( $sym67$CSOME, ConsesLow.list( key_var, key_set, done ), ConsesLow.listS( $sym9$CLET, ConsesLow.list(
                ConsesLow.list( subindex_var, ConsesLow.list( $sym68$INTERMEDIATE_INDEX_LOOKUP, index, key_var ) ) ), ConsesLow.append( body, NIL ) ) ) ) ) );
  }
  ...
  public static SubLObject upgrade_final_indexP(final SubLObject subindex)
  {
    ...
    return SubLObjectFactory.makeBoolean( NIL != use_final_topn_indicesP() && $final_topn_index_cutoff_size$.getGlobalValue().numL( final_index_leaf_count( subindex ) ) );
  }
  ...
  public static SubLObject upgrade_combined_indices_to_final_indexP(final SubLObject subindex_base, final SubLObject subindex_augment)
  {
    ...
    return SubLObjectFactory.makeBoolean( NIL != use_final_topn_indicesP() && $final_topn_index_cutoff_size$.getGlobalValue().numL( Numbers.add( final_index_leaf_count( subindex_base ),
        final_index_leaf_count( subindex_augment ) ) ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != final_unified_index_p( v_object ) || NIL != final_sharded_index_p( v_object ) || NIL != final_topn_index_p( v_object ) );
  }
  ...
  public static SubLObject do_final_index(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.list( $sym9$CLET, ConsesLow.list( ConsesLow.list( index, final_index ) ), ConsesLow.list( $sym80$PCOND,
        ConsesLow.list( ConsesLow.list( $sym81$NULL, index ) ), ConsesLow.list( ConsesLow.list( $sym82$FINAL_UNIFIED_INDEX_P, index ),
            ConsesLow.listS( $sym83$DO_FINAL_UNIFIED_INDEX_INTERNAL, ConsesLow.list( leaf_var, index, $kw6$DONE, done ), ConsesLow.append( body, NIL ) ) ),
        ConsesLow.list( ConsesLow.list( $sym84$FINAL_SHARDED_INDEX_P, index ), ConsesLow.listS( $sym85$DO_FINAL_SHARDED_INDEX_INTERNAL,
            ConsesLow.list( leaf_var, index, $kw6$DONE, done ), ConsesLow.append( body, NIL ) ) ), ConsesLow.list( ConsesLow.list(
                $sym86$FINAL_TOPN_INDEX_P, index ), ConsesLow.listS( $sym87$DO_FINAL_TOPN_INDEX_INTERNAL, ConsesLow.list( leaf_var, index, $kw6$DONE,
                    done ), ConsesLow.append( body, NIL ) ) ), ConsesLow.list( T, ConsesLow.listS( $sym88$ENFORCE_TYPE, index,
                        $list89 ) ) ) );
  }
  ...
  public static SubLObject do_ordered_final_index(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.list( $sym9$CLET, ConsesLow.list( ConsesLow.list( index, final_index ) ), ConsesLow.list( $sym9$CLET,
        $list91, ConsesLow.list( $sym80$PCOND, ConsesLow.list( ConsesLow.list( $sym81$NULL, index ) ), ConsesLow.list(
            ConsesLow.list( $sym82$FINAL_UNIFIED_INDEX_P, index ), ConsesLow.listS( $sym92$DO_ORDERED_FINAL_UNIFIED_INDEX_INTERNAL, ConsesLow.list(
                leaf_var, index, $kw6$DONE, done ), ConsesLow.append( body, NIL ) ) ), ConsesLow.list( ConsesLow.list( $sym84$FINAL_SHARDED_INDEX_P,
                    index ), ConsesLow.listS( $sym93$DO_ORDERED_FINAL_SHARDED_INDEX_INTERNAL, ConsesLow.list( leaf_var, index, $kw6$DONE, done ), ConsesLow.append(
                        body, NIL ) ) ), ConsesLow.list( ConsesLow.list( $sym86$FINAL_TOPN_INDEX_P, index ), ConsesLow.listS(
                            $sym94$DO_ORDERED_FINAL_TOPN_INDEX_INTERNAL, ConsesLow.list( leaf_var, index, $kw6$DONE, done ), ConsesLow.append( body, NIL ) ) ),
            ConsesLow.list( T, ConsesLow.listS( $sym88$ENFORCE_TYPE, index, $list89 ) ) ) ) );
  }
  ...
  public static SubLObject do_final_unified_index_internal(final SubLObject macroform, final SubLObject environment)
  {
    ...
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( $sym96$DO_SET, ConsesLow.list( leaf_var, ConsesLow.list( $sym97$FINAL_UNIFIED_INDEX_SET, final_unified_index ),
        $kw6$DONE, done ), ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject do_ordered_final_unified_index_internal(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.list( $sym9$CLET, ConsesLow.list( ConsesLow.list( leaf_items, ConsesLow.list( $sym99$SET_ELEMENT_LIST,
        ConsesLow.list( $sym97$FINAL_UNIFIED_INDEX_SET, final_unified_index ) ) ) ), ConsesLow.list( $sym100$CSETQ, leaf_items, ConsesLow.list(
            $sym101$SORT_ASSERTIONS, leaf_items ) ), ConsesLow.listS( $sym67$CSOME, ConsesLow.list( leaf_var, leaf_items, done ), ConsesLow.append( body,
                NIL ) ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != list_utilities.proper_list_p( v_object ) && NIL != subl_promotions.non_negative_integer_p( finshard_index_leaf_count( v_object ) ) && finshard_index_keys(
        v_object ).isVector() && NIL != map_utilities.map_p( finshard_index_map( v_object ) ) && NIL == conses_high.fourth( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( NIL != final_sharded_index_p( v_object ) && NIL != map_utilities.map_empty_p( finshard_index_map( v_object ) ) );
  }
  ...
  public static SubLObject do_final_sharded_index_internal(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.list( $sym57$DO_MAP, ConsesLow.list( ignored_key, shard, ConsesLow.list( $sym109$FINAL_SHARDED_INDEX_SHARD_MAP, final_sharded_index ),
        $kw6$DONE, done ), ConsesLow.list( $sym110$IGNORE, ignored_key ), ConsesLow.listS( $sym96$DO_SET, ConsesLow.list( leaf_var, shard,
            $kw6$DONE, done ), ConsesLow.append( body, NIL ) ) );
  }
  ...
  public static SubLObject do_ordered_final_sharded_index_internal(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.list( $sym9$CLET, ConsesLow.list( ConsesLow.list( shard_key_list, ConsesLow.listS( $sym115$SORT, ConsesLow
        .list( $sym116$MAP_KEYS, ConsesLow.list( $sym109$FINAL_SHARDED_INDEX_SHARD_MAP, final_sharded_index ) ), $list117 ) ), ConsesLow.list(
            shard_contents ) ), ConsesLow.list( $sym67$CSOME, ConsesLow.list( key, shard_key_list, done ), ConsesLow.list( $sym9$CLET,
                ConsesLow.list( ConsesLow.list( shard, ConsesLow.list( $sym118$MAP_GET, ConsesLow.list( $sym109$FINAL_SHARDED_INDEX_SHARD_MAP,
                    final_sharded_index ), key ) ) ), ConsesLow.list( $sym100$CSETQ, shard_contents, ConsesLow.list(
                        $sym119$ORDERED_FINAL_SHARDED_INDEX_EXTRACT_CONTENTS, shard, shard_contents ) ), ConsesLow.list( $sym120$DO_VECTOR, ConsesLow.list( leaf_var,
                            shard_contents, $kw6$DONE, done ), ConsesLow.listS( $sym55$PWHEN, ConsesLow.list( $sym121$ASSERTION_P, leaf_var ), ConsesLow
                                .append( body, NIL ) ) ) ) ) );
  }
  ...
  public static SubLObject ncreate_final_sharded_index(final SubLObject leaves)
  {
    ...
    for( SubLObject sequence_var = ordered_leaves, end_index = sequence_var.isList() ? NIL : Sequences.length( sequence_var ), element_num = ZERO_INTEGER, sequence_doneP = subl_macros
        .do_sequence_index_doneP( element_num, end_index, sequence_var ); NIL == sequence_doneP; sequence_doneP = subl_macros.do_sequence_index_doneP( element_num, end_index, sequence_var ) )
    {
  ...
  public static SubLObject with_final_topn_index_tracking(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.list( $sym9$CLET, $list137, reader.bq_cons( $sym28$PROGN, ConsesLow.append( body, NIL ) ), ConsesLow.listS(
          $sym100$CSETQ, newbies, $list138 ) );
    }
  ...
  {
    return SubLObjectFactory.makeBoolean( v_object.isCons() && NIL != list_utilities.lengthE( v_object, THREE_INTEGER, UNPROVIDED ) && NIL != subl_promotions.non_negative_integer_p(
        v_object.first() ) && NIL != indexed_term_p( conses_high.second( v_object ) ) && conses_high.third( v_object ).isCons() );
  }
  ...
  public static SubLObject do_final_topn_index_internal(final SubLObject macroform, final SubLObject environment)
  {
    ...
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( $sym18$DO_ITERATOR, ConsesLow.list( leaf_var, ConsesLow.list( $sym150$NEW_FINAL_TOPN_INDEX_ITERATOR, final_topn_index ),
        $kw6$DONE, done ), ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject do_ordered_final_topn_index_internal(final SubLObject macroform, final SubLObject environment)
  {
    ...
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( $sym18$DO_ITERATOR, ConsesLow.list( leaf_var, ConsesLow.list( $sym151$NEW_ORDERED_FINAL_TOPN_INDEX_ITERATOR,
        final_topn_index ), $kw6$DONE, done ), ConsesLow.append( body, NIL ) );
  }
  ...
  {
    SubLFiles.declareFunction( myName, "setup_indexing_tables", "SETUP-INDEXING-TABLES", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_indexing_store", "ASSERTION-INDEXING-STORE", 0, 0, false );
    SubLFiles.declareFunction( myName, "assertions_with_meta_assertions_count", "ASSERTIONS-WITH-META-ASSERTIONS-COUNT", 0, 0, false );
    SubLFiles.declareFunction( myName, "assertion_indexing_store_reset", "ASSERTION-INDEXING-STORE-RESET", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_indexing_store_initial_size", "ASSERTION-INDEXING-STORE-INITIAL-SIZE", 0, 1, false );
    SubLFiles.declareFunction( myName, "assertion_indexing_store_initialize", "ASSERTION-INDEXING-STORE-INITIALIZE", 0, 1, false );
    SubLFiles.declareFunction( myName, "clear_assertion_indexing", "CLEAR-ASSERTION-INDEXING", 0, 0, false );
    SubLFiles.declareFunction( myName, "clear_assertion_indexing_store", "CLEAR-ASSERTION-INDEXING-STORE", 0, 0, false );
    SubLFiles.declareFunction( myName, "assertion_indexing_store_get", "ASSERTION-INDEXING-STORE-GET", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_indexing_store_remove", "ASSERTION-INDEXING-STORE-REMOVE", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_indexing_store_set", "ASSERTION-INDEXING-STORE-SET", 2, 0, false );
    ...
    SubLFiles.declareFunction( myName, "new_assertions_with_meta_assertions_iterator", "NEW-ASSERTIONS-WITH-META-ASSERTIONS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( myName, "unindexed_syntax_constants", "UNINDEXED-SYNTAX-CONSTANTS", 0, 0, false );
    SubLFiles.declareFunction( myName, "unindexed_syntax_constant_p", "UNINDEXED-SYNTAX-CONSTANT-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "indexed_term_p", "INDEXED-TERM-P", 1, 0, false );
    new $indexed_term_p$UnaryFunction();
    SubLFiles.declareFunction( myName, "indexed_unrepresented_term_p", "INDEXED-UNREPRESENTED-TERM-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "valid_indexed_termP", "VALID-INDEXED-TERM?", 1, 0, false );
    SubLFiles.declareFunction( myName, "valid_indexed_term_robustP", "VALID-INDEXED-TERM-ROBUST?", 1, 0, false );
    SubLFiles.declareFunction( myName, "invalid_indexed_termP", "INVALID-INDEXED-TERM?", 1, 0, false );
    new $invalid_indexed_termP$UnaryFunction();
    SubLFiles.declareFunction( myName, "invalid_indexed_term_robustP", "INVALID-INDEXED-TERM-ROBUST?", 1, 0, false );
    SubLFiles.declareFunction( myName, "sort_of_indexed_term_p", "SORT-OF-INDEXED-TERM-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "fully_indexed_term_p", "FULLY-INDEXED-TERM-P", 1, 0, false );
    new $fully_indexed_term_p$UnaryFunction();
    SubLFiles.declareFunction( myName, "valid_fully_indexed_term_p", "VALID-FULLY-INDEXED-TERM-P", 1, 0, false );
    SubLFiles.declareMacro( "com.cyc.cycjava.cycl.kb_indexing_datastructures", "do_indexed_terms", "DO-INDEXED-TERMS" );
    SubLFiles.declareFunction( myName, "index_p", "INDEX-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "index_installed_p", "INDEX-INSTALLED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "index_not_hosed_p", "INDEX-NOT-HOSED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "index_leaves", "INDEX-LEAVES", 1, 0, false );
    SubLFiles.declareFunction( myName, "index_leaf_count", "INDEX-LEAF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "term_index", "TERM-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "term_index_swapped_inP", "TERM-INDEX-SWAPPED-IN?", 1, 0, false );
    SubLFiles.declareFunction( myName, "reset_term_index", "RESET-TERM-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "clear_term_index", "CLEAR-TERM-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "free_index", "FREE-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "free_term_index", "FREE-TERM-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "simple_index_p", "SIMPLE-INDEX-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "simple_index_installed_p", "SIMPLE-INDEX-INSTALLED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "simple_index_not_hosed_p", "SIMPLE-INDEX-NOT-HOSED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "simple_indexed_term_p", "SIMPLE-INDEXED-TERM-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "new_simple_index", "NEW-SIMPLE-INDEX", 0, 0, false );
    SubLFiles.declareFunction( myName, "simple_index_leaves", "SIMPLE-INDEX-LEAVES", 1, 0, false );
    SubLFiles.declareFunction( myName, "simple_index_leaf_count", "SIMPLE-INDEX-LEAF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "simple_index_memberP", "SIMPLE-INDEX-MEMBER?", 2, 0, false );
    SubLFiles.declareFunction( myName, "simple_num_index", "SIMPLE-NUM-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "simple_term_assertion_list", "SIMPLE-TERM-ASSERTION-LIST", 1, 0, false );
    SubLFiles.declareFunction( myName, "do_simple_index_term_assertion_list", "DO-SIMPLE-INDEX-TERM-ASSERTION-LIST", 1, 0, false );
    SubLFiles.declareFunction( myName, "reset_term_simple_index", "RESET-TERM-SIMPLE-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "simple_index_insert", "SIMPLE-INDEX-INSERT", 2, 0, false );
    SubLFiles.declareFunction( myName, "simple_index_delete", "SIMPLE-INDEX-DELETE", 2, 0, false );
    SubLFiles.declareFunction( myName, "free_simple_index", "FREE-SIMPLE-INDEX", 1, 0, false );
    ...
    SubLFiles.declareFunction( myName, "current_complex_index_keys", "CURRENT-COMPLEX-INDEX-KEYS", 0, 0, false );
    SubLFiles.declareFunction( myName, "copy_current_complex_index_keys", "COPY-CURRENT-COMPLEX-INDEX-KEYS", 0, 0, false );
    SubLFiles.declareFunction( myName, "current_complex_index_term", "CURRENT-COMPLEX-INDEX-TERM", 0, 0, false );
    SubLFiles.declareFunction( myName, "complex_index_keys_defined_p", "COMPLEX-INDEX-KEYS-DEFINED-P", 0, 0, false );
    SubLFiles.declareFunction( myName, "complex_index_p", "COMPLEX-INDEX-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "complex_index_installed_p", "COMPLEX-INDEX-INSTALLED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "complex_index_not_hosed_p", "COMPLEX-INDEX-NOT-HOSED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "complex_indexed_term_p", "COMPLEX-INDEXED-TERM-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "complex_index_leaves", "COMPLEX-INDEX-LEAVES", 1, 0, false );
    SubLFiles.declareFunction( myName, "complex_index_leaf_count", "COMPLEX-INDEX-LEAF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "complex_index_lookup", "COMPLEX-INDEX-LOOKUP", 2, 0, false );
    SubLFiles.declareFunction( myName, "term_complex_index_lookup", "TERM-COMPLEX-INDEX-LOOKUP", 2, 0, false );
    SubLFiles.declareFunction( myName, "initialize_term_complex_index", "INITIALIZE-TERM-COMPLEX-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "merge_complex_indices", "MERGE-COMPLEX-INDICES", 2, 0, false );
    SubLFiles.declareFunction( myName, "term_complex_index_set", "TERM-COMPLEX-INDEX-SET", 3, 0, false );
    SubLFiles.declareFunction( myName, "term_complex_index_delete_key", "TERM-COMPLEX-INDEX-DELETE-KEY", 2, 0, false );
    SubLFiles.declareFunction( myName, "reserve_final_topn_index_for_term", "RESERVE-FINAL-TOPN-INDEX-FOR-TERM", 2, 0, false );
    SubLFiles.declareFunction( myName, "free_complex_index", "FREE-COMPLEX-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "subindex_p", "SUBINDEX-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "subindex_installed_p", "SUBINDEX-INSTALLED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "subindex_not_hosed_p", "SUBINDEX-NOT-HOSED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "subindex_lookup", "SUBINDEX-LOOKUP", 2, 0, false );
    SubLFiles.declareFunction( myName, "subindex_leaves", "SUBINDEX-LEAVES", 1, 0, false );
    SubLFiles.declareFunction( myName, "subindex_leaf_count", "SUBINDEX-LEAF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "initialize_term_subindex", "INITIALIZE-TERM-SUBINDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "free_subindex", "FREE-SUBINDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "merge_sub_indices", "MERGE-SUB-INDICES", 2, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_p", "INTERMEDIATE-INDEX-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_installed_p", "INTERMEDIATE-INDEX-INSTALLED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_not_hosed_p", "INTERMEDIATE-INDEX-NOT-HOSED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "new_intermediate_index", "NEW-INTERMEDIATE-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "clone_intermediate_index", "CLONE-INTERMEDIATE-INDEX", 1, 0, false );
    SubLFiles.declareMacro( "com.cyc.cycjava.cycl.kb_indexing_datastructures", "do_intermediate_index", "DO-INTERMEDIATE-INDEX" );
    SubLFiles.declareFunction( myName, "do_intermediate_index_valid_index_p", "DO-INTERMEDIATE-INDEX-VALID-INDEX-P", 1, 0, false );
    ...
    SubLFiles.declareFunction( myName, "segregate_index_changes_and_pristines", "SEGREGATE-INDEX-CHANGES-AND-PRISTINES", 1, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_lookup", "INTERMEDIATE-INDEX-LOOKUP", 2, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_keys", "INTERMEDIATE-INDEX-KEYS", 1, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_leaf_count", "INTERMEDIATE-INDEX-LEAF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_leaves", "INTERMEDIATE-INDEX-LEAVES", 1, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_set", "INTERMEDIATE-INDEX-SET", 3, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_replace_map", "INTERMEDIATE-INDEX-REPLACE-MAP", 2, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_touch", "INTERMEDIATE-INDEX-TOUCH", 2, 0, false );
    SubLFiles.declareFunction( myName, "use_final_topn_indicesP", "USE-FINAL-TOPN-INDICES?", 0, 0, false );
    SubLFiles.declareFunction( myName, "upgrade_final_indexP", "UPGRADE-FINAL-INDEX?", 1, 0, false );
    SubLFiles.declareFunction( myName, "upgrade_combined_indices_to_final_indexP", "UPGRADE-COMBINED-INDICES-TO-FINAL-INDEX?", 2, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_insert", "INTERMEDIATE-INDEX-INSERT", 3, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_insert_int", "INTERMEDIATE-INDEX-INSERT-INT", 4, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_delete", "INTERMEDIATE-INDEX-DELETE", 3, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_delete_key", "INTERMEDIATE-INDEX-DELETE-KEY", 2, 0, false );
    SubLFiles.declareFunction( myName, "merge_intermediate_indices", "MERGE-INTERMEDIATE-INDICES", 2, 0, false );
    SubLFiles.declareFunction( myName, "initialize_term_intermediate_index", "INITIALIZE-TERM-INTERMEDIATE-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "free_intermediate_index", "FREE-INTERMEDIATE-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_leaf_count_reset", "INTERMEDIATE-INDEX-LEAF-COUNT-RESET", 2, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_leaf_count_inc", "INTERMEDIATE-INDEX-LEAF-COUNT-INC", 2, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_lookup_or_create_intermediate", "INTERMEDIATE-INDEX-LOOKUP-OR-CREATE-INTERMEDIATE", 3, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_lookup_or_create_final", "INTERMEDIATE-INDEX-LOOKUP-OR-CREATE-FINAL", 2, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_map", "INTERMEDIATE-INDEX-MAP", 1, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_map_set", "INTERMEDIATE-INDEX-MAP-SET", 3, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_map_delete_key", "INTERMEDIATE-INDEX-MAP-DELETE-KEY", 2, 0, false );
    SubLFiles.declareFunction( myName, "intermediate_index_map_touch", "INTERMEDIATE-INDEX-MAP-TOUCH", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_index_p", "FINAL-INDEX-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_index_installed_p", "FINAL-INDEX-INSTALLED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_index_not_hosed_p", "FINAL-INDEX-NOT-HOSED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "new_final_index", "NEW-FINAL-INDEX", 0, 0, false );
    ...
    SubLFiles.declareFunction( myName, "final_index_leaf_count", "FINAL-INDEX-LEAF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_index_leaves", "FINAL-INDEX-LEAVES", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_index_memberP", "FINAL-INDEX-MEMBER?", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_index_arbitrary_leaf", "FINAL-INDEX-ARBITRARY-LEAF", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_index_leaves_reset", "FINAL-INDEX-LEAVES-RESET", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_index_insert", "FINAL-INDEX-INSERT", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_index_delete", "FINAL-INDEX-DELETE", 2, 0, false );
    SubLFiles.declareFunction( myName, "new_final_index_base_iterator", "NEW-FINAL-INDEX-BASE-ITERATOR", 1, 0, false );
    SubLFiles.declareFunction( myName, "free_final_index", "FREE-FINAL-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_p", "FINAL-UNIFIED-INDEX-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_installed_p", "FINAL-UNIFIED-INDEX-INSTALLED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_not_hosed_p", "FINAL-UNIFIED-INDEX-NOT-HOSED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "new_final_unified_index", "NEW-FINAL-UNIFIED-INDEX", 0, 0, false );
    ...
    SubLFiles.declareFunction( myName, "final_unified_index_leaf_count", "FINAL-UNIFIED-INDEX-LEAF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_leaves", "FINAL-UNIFIED-INDEX-LEAVES", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_memberP", "FINAL-UNIFIED-INDEX-MEMBER?", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_arbitrary_leaf", "FINAL-UNIFIED-INDEX-ARBITRARY-LEAF", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_leaves_reset", "FINAL-UNIFIED-INDEX-LEAVES-RESET", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_insert", "FINAL-UNIFIED-INDEX-INSERT", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_delete", "FINAL-UNIFIED-INDEX-DELETE", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_is_shardableP", "FINAL-UNIFIED-INDEX-IS-SHARDABLE?", 1, 0, false );
    SubLFiles.declareFunction( myName, "new_final_unified_index_iterator", "NEW-FINAL-UNIFIED-INDEX-ITERATOR", 1, 0, false );
    SubLFiles.declareFunction( myName, "free_final_unified_index", "FREE-FINAL-UNIFIED-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_unified_index_set", "FINAL-UNIFIED-INDEX-SET", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_index_set_is_shardableP", "FINAL-INDEX-SET-IS-SHARDABLE?", 1, 0, false );
    SubLFiles.declareFunction( myName, "new_final_sharded_index", "NEW-FINAL-SHARDED-INDEX", 3, 0, false );
    SubLFiles.declareFunction( myName, "finshard_index_leaf_count", "FINSHARD-INDEX-LEAF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "set_finshard_index_leaf_count", "SET-FINSHARD-INDEX-LEAF-COUNT", 2, 0, false );
    SubLFiles.declareFunction( myName, "finshard_index_keys", "FINSHARD-INDEX-KEYS", 1, 0, false );
    SubLFiles.declareFunction( myName, "set_finshard_index_keys", "SET-FINSHARD-INDEX-KEYS", 2, 0, false );
    SubLFiles.declareFunction( myName, "finshard_index_map", "FINSHARD-INDEX-MAP", 1, 0, false );
    SubLFiles.declareFunction( myName, "set_finshard_index_map", "SET-FINSHARD-INDEX-MAP", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_p", "FINAL-SHARDED-INDEX-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_empty_p", "FINAL-SHARDED-INDEX-EMPTY-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_leaf_count", "FINAL-SHARDED-INDEX-LEAF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_leaves", "FINAL-SHARDED-INDEX-LEAVES", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_memberP", "FINAL-SHARDED-INDEX-MEMBER?", 2, 0, false );
    SubLFiles.declareFunction( myName, "finshard_index_find_shard", "FINSHARD-INDEX-FIND-SHARD", 2, 0, false );
    SubLFiles.declareFunction( myName, "finshard_index_find_shard_key_index", "FINSHARD-INDEX-FIND-SHARD-KEY-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_arbitrary_leaf", "FINAL-SHARDED-INDEX-ARBITRARY-LEAF", 1, 0, false );
    ...
    SubLFiles.declareFunction( myName, "final_sharded_index_shard_map", "FINAL-SHARDED-INDEX-SHARD-MAP", 1, 0, false );
    SubLFiles.declareFunction( myName, "ordered_final_sharded_index_extract_contents", "ORDERED-FINAL-SHARDED-INDEX-EXTRACT-CONTENTS", 2, 0, false );
    SubLFiles.declareFunction( myName, "possible_assertionL", "POSSIBLE-ASSERTION<", 2, 0, false );
    SubLFiles.declareFunction( myName, "increment_finshard_index_leaf_count", "INCREMENT-FINSHARD-INDEX-LEAF-COUNT", 1, 1, false );
    SubLFiles.declareFunction( myName, "decrement_finshard_index_leaf_count", "DECREMENT-FINSHARD-INDEX-LEAF-COUNT", 1, 1, false );
    SubLFiles.declareFunction( myName, "append_finshard_index_keys", "APPEND-FINSHARD-INDEX-KEYS", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_leaves_reset", "FINAL-SHARDED-INDEX-LEAVES-RESET", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_insert", "FINAL-SHARDED-INDEX-INSERT", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_insert_internal", "FINAL-SHARDED-INDEX-INSERT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_insert_into_shard", "FINAL-SHARDED-INDEX-INSERT-INTO-SHARD", 3, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_delete", "FINAL-SHARDED-INDEX-DELETE", 2, 0, false );
    SubLFiles.declareFunction( myName, "reshard_final_sharded_index", "RESHARD-FINAL-SHARDED-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "convert_final_simple_index_to_sharded_index", "CONVERT-FINAL-SIMPLE-INDEX-TO-SHARDED-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "create_final_sharded_index", "CREATE-FINAL-SHARDED-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "ncreate_final_sharded_index", "NCREATE-FINAL-SHARDED-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "reorganize_modified_final_sharded_index", "REORGANIZE-MODIFIED-FINAL-SHARDED-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_to_fvector_backed_sharded_index", "FINAL-SHARDED-INDEX-TO-FVECTOR-BACKED-SHARDED-INDEX", 3, 0, false );
    SubLFiles.declareFunction( myName, "update_fvector_backed_final_sharded_index", "UPDATE-FVECTOR-BACKED-FINAL-SHARDED-INDEX", 3, 0, false );
    SubLFiles.declareFunction( myName, "validate_final_sharded_index", "VALIDATE-FINAL-SHARDED-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "new_final_sharded_index_iterator", "NEW-FINAL-SHARDED-INDEX-ITERATOR", 1, 0, false );
    SubLFiles.declareFunction( myName, "free_final_sharded_index", "FREE-FINAL-SHARDED-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_sharded_index_set", "FINAL-SHARDED-INDEX-SET", 1, 0, false );
    ...
    SubLFiles.declareFunction( myName, "possibly_note_new_final_topn_index", "POSSIBLY-NOTE-NEW-FINAL-TOPN-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_p", "FINAL-TOPN-INDEX-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_count", "FINAL-TOPN-INDEX-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "set_final_topn_index_count", "SET-FINAL-TOPN-INDEX-COUNT", 2, 0, false );
    SubLFiles.declareFunction( myName, "inc_final_topn_index_count", "INC-FINAL-TOPN-INDEX-COUNT", 1, 1, false );
    SubLFiles.declareFunction( myName, "dec_final_topn_index_count", "DEC-FINAL-TOPN-INDEX-COUNT", 1, 1, false );
    SubLFiles.declareFunction( myName, "final_topn_index_term", "FINAL-TOPN-INDEX-TERM", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_key_path", "FINAL-TOPN-INDEX-KEY-PATH", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_installed_p", "FINAL-TOPN-INDEX-INSTALLED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_not_hosed_p", "FINAL-TOPN-INDEX-NOT-HOSED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "new_final_topn_index", "NEW-FINAL-TOPN-INDEX", 2, 1, false );
    SubLFiles.declareFunction( myName, "upgrade_final_index", "UPGRADE-FINAL-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "new_final_topn_index_iterator", "NEW-FINAL-TOPN-INDEX-ITERATOR", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_iterator_build_filter_args", "FINAL-TOPN-INDEX-ITERATOR-BUILD-FILTER-ARGS", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_matches_final_topn_indexkey_pathP", "ASSERTION-MATCHES-FINAL-TOPN-INDEXKEY-PATH?", 3, 0, false );
    SubLFiles.declareFunction( myName, "new_ordered_final_topn_index_iterator", "NEW-ORDERED-FINAL-TOPN-INDEX-ITERATOR", 1, 0, false );
    ...
    SubLFiles.declareFunction( myName, "final_topn_index_leaf_count", "FINAL-TOPN-INDEX-LEAF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_leaves", "FINAL-TOPN-INDEX-LEAVES", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_memberP", "FINAL-TOPN-INDEX-MEMBER?", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_arbitrary_leaf", "FINAL-TOPN-INDEX-ARBITRARY-LEAF", 1, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_leaves_reset", "FINAL-TOPN-INDEX-LEAVES-RESET", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_insert", "FINAL-TOPN-INDEX-INSERT", 2, 0, false );
    SubLFiles.declareFunction( myName, "final_topn_index_delete", "FINAL-TOPN-INDEX-DELETE", 2, 0, false );
    SubLFiles.declareFunction( myName, "free_final_topn_index", "FREE-FINAL-TOPN-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "indexing_leaf_p", "INDEXING-LEAF-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "indexing_leaf_installed_p", "INDEXING-LEAF-INSTALLED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "indexing_leaf_not_hosed_p", "INDEXING-LEAF-NOT-HOSED-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "indexing_leaf_suid", "INDEXING-LEAF-SUID", 1, 0, false );
    SubLFiles.declareFunction( myName, "merge_final_indices", "MERGE-FINAL-INDICES", 2, 0, false );
    SubLFiles.declareFunction( myName, "merge_final_indices_internal", "MERGE-FINAL-INDICES-INTERNAL", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_kb_indexing_datastructures_file()
  {
    $assertion_indexing_store$ = SubLFiles.deflexical( "*ASSERTION-INDEXING-STORE*", ( NIL != Symbols.boundp( $sym0$_ASSERTION_INDEXING_STORE_ ) ) ? $assertion_indexing_store$.getGlobalValue()
        : NIL );
    ...
    $final_sharded_index_shard_size$ = SubLFiles.deflexical( "*FINAL-SHARDED-INDEX-SHARD-SIZE*", ( NIL != Symbols.boundp( $sym103$_FINAL_SHARDED_INDEX_SHARD_SIZE_ ) )
        ? $final_sharded_index_shard_size$.getGlobalValue()
        : $int104$1000 );
  ...
  static
  {
    ...
    $float1$0_05 = SubLObjectFactory.makeDouble( 0.05 );
    $int2$64 = SubLObjectFactory.makeInteger( 64 );
    $list3 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "ASSERTION-VAR" ), SubLObjectFactory.makeSymbol( "&KEY" ), SubLObjectFactory.makeSymbol(
        "DONE" ), SubLObjectFactory.makeSymbol( "PROGRESS-MESSAGE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    $list4 = ConsesLow.list( SubLObjectFactory.makeKeyword( "DONE" ), SubLObjectFactory.makeKeyword( "PROGRESS-MESSAGE" ) );
    ...
    $list13 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "ASSERTIONS-WITH-META-ASSERTIONS-COUNT" ) ) );
    ...
    $list19 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NEW-ASSERTIONS-WITH-META-ASSERTIONS-ITERATOR" ) );
    ...
    $list21 = ConsesLow.list( constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "implies" ) ), constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString(
        "and" ) ), constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "or" ) ), constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "not" ) ) );
    $sym22$INDEXED_TERM_P = SubLObjectFactory.makeSymbol( "INDEXED-TERM-P" );
    $list23 = ConsesLow.list( SubLObjectFactory.makeSymbol( "OBJECT" ) );
    ...
    $list25 = ConsesLow.list( SubLObjectFactory.makeSymbol( "BOOLEANP" ) );
    $list26 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "VAR" ), SubLObjectFactory.makeSymbol( "&OPTIONAL" ), ConsesLow.list(
        SubLObjectFactory.makeSymbol( "MESSAGE" ), SubLObjectFactory.makeString( "mapping Cyc indexed terms" ) ) ), SubLObjectFactory.makeSymbol( "&BODY" ),
    ...
    $list42 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "TERM" ), SubLObjectFactory.makeSymbol( "KEYS" ) ), SubLObjectFactory.makeSymbol( "&BODY" ),
        SubLObjectFactory.makeSymbol( "BODY" ) );
    ...
    $list52 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "KEY-VAR" ), SubLObjectFactory.makeSymbol( "SUBINDEX-VAR" ), SubLObjectFactory.makeSymbol(
        "INTERMEDIATE-INDEX" ), SubLObjectFactory.makeSymbol( "&KEY" ), SubLObjectFactory.makeSymbol( "DONE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ),
        SubLObjectFactory.makeSymbol( "BODY" ) );
    $list53 = ConsesLow.list( SubLObjectFactory.makeKeyword( "DONE" ) );
    ...
    $list60 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "SET" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol(
        "BODY" ) );
    $sym61$_CHANGED_INDEX_ENTRY_HINTS_ = SubLObjectFactory.makeSymbol( "*CHANGED-INDEX-ENTRY-HINTS*" );
    $list62 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "KEY-VAR" ), SubLObjectFactory.makeSymbol( "SUBINDEX-VAR" ), SubLObjectFactory.makeSymbol(
        "INTERMEDIATE-INDEX" ), SubLObjectFactory.makeSymbol( "UNCHANGED-PART" ), SubLObjectFactory.makeSymbol( "&KEY" ), SubLObjectFactory.makeSymbol( "DONE" ) ),
    ...
    $list70 = ConsesLow.list( SubLObjectFactory.makeSymbol( "KEY" ), SubLObjectFactory.makeSymbol( "SUBINDEX" ) );
    ...
    $list73 = ConsesLow.cons( SubLObjectFactory.makeSymbol( "KEY" ), SubLObjectFactory.makeSymbol( "REST-KEYS" ) );
    $sym74$FINAL_INDEX_P = SubLObjectFactory.makeSymbol( "FINAL-INDEX-P" );
    $list75 = ConsesLow.cons( SubLObjectFactory.makeSymbol( "BASE-COUNT" ), SubLObjectFactory.makeSymbol( "BASE-MAP" ) );
    $list76 = ConsesLow.cons( SubLObjectFactory.makeSymbol( "AUGMENT-COUNT" ), SubLObjectFactory.makeSymbol( "AUGMENT-MAP" ) );
    $list77 = ConsesLow.list( SubLObjectFactory.makeSymbol( "AUG-KEY" ), SubLObjectFactory.makeSymbol( "AUG-INDEX" ) );
    $list78 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "LEAF-VAR" ), SubLObjectFactory.makeSymbol( "FINAL-INDEX" ), SubLObjectFactory.makeSymbol(
        "&KEY" ), SubLObjectFactory.makeSymbol( "DONE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    ...
    $list89 = ConsesLow.list( SubLObjectFactory.makeSymbol( "FINAL-INDEX-P" ) );
    $sym90$INDEX = SubLObjectFactory.makeUninternedSymbol( "INDEX" );
    $list91 = ConsesLow.list( SubLObjectFactory.makeSymbol( "*ORDERED-FINAL-INDEX-RESOURCE*" ) );
    ...
    $list95 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "LEAF-VAR" ), SubLObjectFactory.makeSymbol( "FINAL-UNIFIED-INDEX" ), SubLObjectFactory
    ...
    $list105 = ConsesLow.list( SubLObjectFactory.makeSymbol( "KEY" ), SubLObjectFactory.makeSymbol( "SHARD" ) );
    $list106 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "LEAF-VAR" ), SubLObjectFactory.makeSymbol( "FINAL-SHARDED-INDEX" ), SubLObjectFactory
        .makeSymbol( "&KEY" ), SubLObjectFactory.makeSymbol( "DONE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    ...
    $list117 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "QUOTE" ), SubLObjectFactory.makeSymbol( "<" ) ) );
    ...
    $list131 = ConsesLow.list( SubLObjectFactory.makeSymbol( "MAX-SUID" ), SubLObjectFactory.makeSymbol( "SHARD" ) );
    ...
    $list136 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "NEWBIES" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol(
        "BODY" ) );
    $list137 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "*RECENT-FINAL-TOPN-INDICES*" ) ), ConsesLow.list( SubLObjectFactory.makeSymbol(
        "*WITH-FINAL-TOPN-INDEX-TRACKING*" ), T ) );
    $list138 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "COPY-TREE" ), SubLObjectFactory.makeSymbol( "*RECENT-FINAL-TOPN-INDICES*" ) ) );
    $list139 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "*WITH-FINAL-TOPN-INDEX-TRACKING*" ) ) );
    ...
    $list149 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "LEAF-VAR" ), SubLObjectFactory.makeSymbol( "FINAL-TOPN-INDEX" ), SubLObjectFactory
        .makeSymbol( "&KEY" ), SubLObjectFactory.makeSymbol( "DONE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    ...
    $list152 = ConsesLow.list( SubLObjectFactory.makeSymbol( "MATCHER-FN" ), SubLObjectFactory.makeSymbol( "ARGS" ) );
    ...
    $list155 = ConsesLow.list( SubLObjectFactory.makeUninternedSymbol( "IGNORED-KEY" ), SubLObjectFactory.makeUninternedSymbol( "SHARD" ) );
  }
