...
public final class constants_low extends SubLTranslatedFile
{
  ...
  @SubLTranslatedFile.SubL(
    source = "cycl/constants-low.lisp",
    position = 940L)
  ...
  {
    SubLObject setupP = constants_low.NIL;
    if( constants_low.NIL == id_index.id_index_p( constants_low.$constant_guid_table$.getGlobalValue() ) )
    {
      constants_low.$constant_guid_table$.setGlobalValue( id_index.new_id_index( size, constants_low.ZERO_INTEGER ) );
      setupP = constants_low.T;
    }
    if( constants_low.NIL == id_index.id_index_p( constants_low.$constant_merged_guid_table$.getGlobalValue() ) )
    {
      constants_low.$constant_merged_guid_table$.setGlobalValue( id_index.new_id_index( constants_low.$int4$750, constants_low.ZERO_INTEGER ) );
      setupP = constants_low.T;
    }
    if( !constants_low.$constant_from_guid$.getGlobalValue().isHashtable() )
    {
      constants_low.$constant_from_guid$.setGlobalValue( Hashtables.make_hash_table( size, Symbols.symbol_function( constants_low.EQUALP ), constants_low.UNPROVIDED ) );
      setupP = constants_low.T;
    }
    return setupP;
  }
  ...
  {
    return id_index.id_index_lookup( constants_low.$constant_guid_table$.getGlobalValue(), id, constants_low.UNPROVIDED );
  }
  ...
  {
    return id_index.id_index_lookup( constants_low.$constant_merged_guid_table$.getGlobalValue(), id, constants_low.UNPROVIDED );
  }
  ...
  {
    return Hashtables.gethash_without_values( guid, constants_low.$constant_from_guid$.getGlobalValue(), constants_low.UNPROVIDED );
  }
  ...
  public static SubLObject kb_create_constant_kb_store(final SubLObject name, final SubLObject external_id)
  {
    ...
    constant = constant_handles.make_constant_shell( name, constants_low.T );
  ...
  {
    final SubLObject constant = constant_handles.make_constant_shell( name, constants_low.T );
  ...
  {
    SubLObject guid = constants_low.NIL;
  ...
  public static SubLObject kb_new_constant_info_iterator_internal()
  {
    ...
    return iteration.new_indirect_iterator( input_iterator, constants_low.$sym5$CONSTANT_INFO, constants_low.UNPROVIDED );
  }
  ...
  public static SubLObject constant_info(final SubLObject constant)
  {
    final SubLObject suid = constant_handles.constant_suid( constant );
    final SubLObject name = constant_name_internal( constant );
    final SubLObject guid = suid.isInteger() ? constant_guid_internal( constant ) : constants_low.NIL;
  ...
  public static SubLObject kb_rename_constant_internal(final SubLObject constant, final SubLObject new_name)
  {
    ...
    {
      Errors.error( constants_low.$str6$A_constant_with_the_name__s_alrea, new_name );
    }
  ...
  public static SubLObject random_constant_internal(SubLObject test)
  {
    ...
    {
      test = Symbols.symbol_function( constants_low.$sym9$TRUE );
    }
    if( constant_handles.constant_count().numG( constants_low.ZERO_INTEGER ) )
    {
      final SubLObject max_id = constant_handles.next_constant_suid();
      SubLObject v_answer;
      SubLObject candidate;
      for( v_answer = constants_low.NIL; constants_low.NIL == v_answer; v_answer = candidate )
      {
  ...
  {
    SubLFiles.declareFunction( myName, "setup_constant_guid_table", "SETUP-CONSTANT-GUID-TABLE", 2, 0, false );
    SubLFiles.declareFunction( myName, "lookup_constant_guid", "LOOKUP-CONSTANT-GUID", 1, 0, false );
    SubLFiles.declareFunction( myName, "lookup_constant_merged_guid", "LOOKUP-CONSTANT-MERGED-GUID", 1, 0, false );
    SubLFiles.declareFunction( myName, "lookup_constant_by_guid", "LOOKUP-CONSTANT-BY-GUID", 1, 0, false );
    SubLFiles.declareFunction( myName, "register_constant_guid", "REGISTER-CONSTANT-GUID", 3, 0, false );
    SubLFiles.declareFunction( myName, "register_constant_merged_guid", "REGISTER-CONSTANT-MERGED-GUID", 3, 0, false );
    SubLFiles.declareFunction( myName, "deregister_constant_guid", "DEREGISTER-CONSTANT-GUID", 2, 0, false );
    SubLFiles.declareFunction( myName, "deregister_constant_merged_guid", "DEREGISTER-CONSTANT-MERGED-GUID", 2, 0, false );
    SubLFiles.declareFunction( myName, "clear_constant_guid_table", "CLEAR-CONSTANT-GUID-TABLE", 0, 0, false );
    SubLFiles.declareFunction( myName, "kb_create_constant_kb_store", "KB-CREATE-CONSTANT-KB-STORE", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_create_constant_int", "KB-CREATE-CONSTANT-INT", 3, 0, false );
    SubLFiles.declareFunction( myName, "kb_create_constant_cyc", "KB-CREATE-CONSTANT-CYC", 2, 0, false );
    SubLFiles.declareFunction( myName, "install_constant_external_id", "INSTALL-CONSTANT-EXTERNAL-ID", 2, 0, false );
    SubLFiles.declareFunction( myName, "install_constant_internal_id", "INSTALL-CONSTANT-INTERNAL-ID", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_remove_constant_internal", "KB-REMOVE-CONSTANT-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( myName, "deregister_constant_guts", "DEREGISTER-CONSTANT-GUTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "deregister_constant_ids", "DEREGISTER-CONSTANT-IDS", 1, 0, false );
    SubLFiles.declareFunction( myName, "constant_guid_internal", "CONSTANT-GUID-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( myName, "constant_merged_guid_internal", "CONSTANT-MERGED-GUID-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( myName, "constant_name_internal", "CONSTANT-NAME-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( myName, "constant_index", "CONSTANT-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "constant_index_swapped_inP", "CONSTANT-INDEX-SWAPPED-IN?", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_new_constant_info_iterator_internal", "KB-NEW-CONSTANT-INFO-ITERATOR-INTERNAL", 0, 0, false );
    SubLFiles.declareFunction( myName, "constant_info", "CONSTANT-INFO", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_rename_constant_internal", "KB-RENAME-CONSTANT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( myName, "reset_constant_name", "RESET-CONSTANT-NAME", 2, 0, false );
    SubLFiles.declareFunction( myName, "reset_constant_index", "RESET-CONSTANT-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "install_constant_guid", "INSTALL-CONSTANT-GUID", 2, 0, false );
    SubLFiles.declareFunction( myName, "reset_constant_guid", "RESET-CONSTANT-GUID", 2, 0, false );
    SubLFiles.declareFunction( myName, "install_constant_merged_guid", "INSTALL-CONSTANT-MERGED-GUID", 2, 0, false );
    SubLFiles.declareFunction( myName, "uninstall_constant_merged_guid", "UNINSTALL-CONSTANT-MERGED-GUID", 2, 0, false );
    SubLFiles.declareFunction( myName, "random_constant_internal", "RANDOM-CONSTANT-INTERNAL", 0, 1, false );
    SubLFiles.declareFunction( myName, "load_install_constant_ids", "LOAD-INSTALL-CONSTANT-IDS", 3, 0, false );
    return constants_low.NIL;
  }

  public static SubLObject init_constants_low_file()
  {
    constants_low.$constant_guid_table$ = SubLFiles.deflexical( "*CONSTANT-GUID-TABLE*", ( maybeDefault( constants_low.$sym0$_CONSTANT_GUID_TABLE_, constants_low.$constant_guid_table$,
        constants_low.$kw1$UNINITIALIZED ) ) );
    constants_low.$constant_merged_guid_table$ = SubLFiles.deflexical( "*CONSTANT-MERGED-GUID-TABLE*", ( maybeDefault( constants_low.$sym2$_CONSTANT_MERGED_GUID_TABLE_,
        constants_low.$constant_merged_guid_table$, constants_low.$kw1$UNINITIALIZED ) ) );
    constants_low.$constant_from_guid$ = SubLFiles.deflexical( "*CONSTANT-FROM-GUID*", ( maybeDefault( constants_low.$sym3$_CONSTANT_FROM_GUID_, constants_low.$constant_from_guid$,
        constants_low.NIL ) ) );
    return constants_low.NIL;
  }
  ...
  {
    subl_macro_promotions.declare_defglobal( constants_low.$sym0$_CONSTANT_GUID_TABLE_ );
    subl_macro_promotions.declare_defglobal( constants_low.$sym2$_CONSTANT_MERGED_GUID_TABLE_ );
    subl_macro_promotions.declare_defglobal( constants_low.$sym3$_CONSTANT_FROM_GUID_ );
    return constants_low.NIL;
  }
