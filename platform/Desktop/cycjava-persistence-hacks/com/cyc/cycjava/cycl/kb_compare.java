...
public final class kb_compare extends SubLTranslatedFile
{
  ...
  public static SubLObject with_new_kb_compare_connection(final SubLObject macroform, final SubLObject environment)
  {
    ...
    SubLObject v_remote_image = kb_compare.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list2 );
    v_remote_image = current.first();
    final SubLObject body;
    current = ( body = current.rest() );
    return ConsesLow.list( kb_compare.$sym3$WITH_NEW_REMOTE_IMAGE_CONNECTION, v_remote_image, ConsesLow.list( kb_compare.$sym4$CLET, kb_compare.$list5,
        kb_compare.$list6, ConsesLow.listS( kb_compare.$sym7$WITH_CFASL_COMMON_SYMBOLS, kb_compare.$sym8$_KB_COMPARE_COMMON_SYMBOLS_, ConsesLow.append( body,
            kb_compare.NIL ) ) ) );
  }
  ...
  public static SubLObject set_kb_compare_connection_common_symbols()
  {
    ...
    if( kb_compare.NIL != connection )
    {
      ...
      {
        SubLObject ignore_errors_tag = kb_compare.NIL;
        try
        {
          ...
          try
          {
            Errors.$error_handler$.bind( Symbols.symbol_function( kb_compare.$sym13$IGNORE_ERRORS_HANDLER ), thread );
            try
            {
              remote_image.remote_image_connection_eval( connection, ConsesLow.listS( kb_compare.$sym14$PROGN, ConsesLow.list(
                  kb_compare.$sym15$CFASL_SET_COMMON_SYMBOLS, ConsesLow.list( kb_compare.$sym16$QUOTE, kb_compare.$kb_compare_common_symbols$.getDynamicValue( thread ) ) ),
                  kb_compare.$list17 ) );
            }
            catch( final Throwable catch_var )
            {
              Errors.handleThrowable( catch_var, kb_compare.NIL );
            }
          }
          finally
          {
        ...
        {
          ignore_errors_tag = Errors.handleThrowable( ccatch_env_var, kb_compare.$kw12$IGNORE_ERRORS_TARGET );
        }
        finally
        {
      ...
      {
        kb_compare.$kb_compare_common_symbols$.setDynamicValue( kb_compare.NIL, thread );
      }
    }
    return kb_compare.NIL;
  }
  ...
  {
    print_kb_intersection( v_object, stream, kb_compare.ZERO_INTEGER );
    return kb_compare.NIL;
  }
  ...
  {
    return ( v_object.getClass() == $kb_intersection_native.class ) ? kb_compare.T : kb_compare.NIL;
  }
  ...
  public static SubLObject make_kb_intersection(SubLObject arglist)
  {
    ...
    for( next = kb_compare.NIL, next = arglist; kb_compare.NIL != next; next = conses_high.cddr( next ) )
    {
      current_arg = next.first();
      current_value = conses_high.cadr( next );
      pcase_var = current_arg;
      if( pcase_var.eql( kb_compare.$kw37$REMOTE_IMAGE ) )
      {
        _csetf_kb_intrsct_remote_image( v_new, current_value );
      }
      else if( pcase_var.eql( kb_compare.$kw38$CONSTANT_INDEX ) )
      {
        _csetf_kb_intrsct_constant_index( v_new, current_value );
      }
      else if( pcase_var.eql( kb_compare.$kw39$NART_INDEX ) )
      {
        _csetf_kb_intrsct_nart_index( v_new, current_value );
      }
      else if( pcase_var.eql( kb_compare.$kw40$ASSERTION_INDEX ) )
      {
        _csetf_kb_intrsct_assertion_index( v_new, current_value );
      }
      else if( pcase_var.eql( kb_compare.$kw41$DEDUCTION_INDEX ) )
      {
        _csetf_kb_intrsct_deduction_index( v_new, current_value );
      }
      else
      {
        Errors.error( kb_compare.$str42$Invalid_slot__S_for_construction_, current_arg );
      }
    }
    return v_new;
  }
  ...
  {
    Functions.funcall( visitor_fn, obj, kb_compare.$kw43$BEGIN, kb_compare.$sym44$MAKE_KB_INTERSECTION, kb_compare.FIVE_INTEGER );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw37$REMOTE_IMAGE, kb_intrsct_remote_image( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw38$CONSTANT_INDEX, kb_intrsct_constant_index( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw39$NART_INDEX, kb_intrsct_nart_index( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw40$ASSERTION_INDEX, kb_intrsct_assertion_index( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw41$DEDUCTION_INDEX, kb_intrsct_deduction_index( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw46$END, kb_compare.$sym44$MAKE_KB_INTERSECTION, kb_compare.FIVE_INTEGER );
    return obj;
  }
  ...
  {
    PrintLow.format( stream, kb_compare.$str48$_KB_INTERSECTION_to__a_, kb_intersection_remote_image( v_object ) );
    return kb_compare.NIL;
  }
  ...
  {
    final SubLObject intersection = make_kb_intersection( kb_compare.UNPROVIDED );
  ...
  public static SubLObject destroy_kb_intersection(final SubLObject intersection)
  {
    ...
    _csetf_kb_intrsct_remote_image( intersection, kb_compare.$kw49$FREE );
    _csetf_kb_intrsct_constant_index( intersection, kb_compare.NIL );
    _csetf_kb_intrsct_nart_index( intersection, kb_compare.NIL );
    _csetf_kb_intrsct_assertion_index( intersection, kb_compare.NIL );
    _csetf_kb_intrsct_deduction_index( intersection, kb_compare.NIL );
    return intersection;
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( kb_compare.NIL != constant_handles.constant_p( constant ) && kb_compare.NIL != list_utilities.sublisp_boolean( kb_intersection_constant_remote_id( intersection,
        constant ) ) );
  }
  ...
  public static SubLObject kb_intersection_constant_remote_id(final SubLObject intersection, final SubLObject constant)
  {
    ...
    {
      return id_index.id_index_lookup( index, local_id, kb_compare.UNPROVIDED );
    }
    return kb_compare.NIL;
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( kb_compare.NIL != nart_handles.nart_p( nart ) && kb_compare.NIL != list_utilities.sublisp_boolean( kb_intersection_nart_remote_id( intersection, nart ) ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( kb_compare.NIL != assertion_handles.assertion_p( assertion ) && kb_compare.NIL != list_utilities.sublisp_boolean( kb_intersection_assertion_remote_id( intersection,
        assertion ) ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( kb_compare.NIL != deduction_handles.deduction_p( deduction ) && kb_compare.NIL != list_utilities.sublisp_boolean( kb_intersection_deduction_remote_id( intersection,
        deduction ) ) );
  }
  ...
  public static SubLObject do_kb_intersection_constants(final SubLObject macroform, final SubLObject environment)
  {
    SubLObject current;
    final SubLObject datum = current = macroform.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list57 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject constant = kb_compare.NIL;
    SubLObject intersection = kb_compare.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list57 );
    ...
    current = current.rest();
    SubLObject allow_other_keys_p = kb_compare.NIL;
    SubLObject rest = current;
    SubLObject bad = kb_compare.NIL;
    SubLObject current_$1 = kb_compare.NIL;
    while ( kb_compare.NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list57 );
      current_$1 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list57 );
      if( kb_compare.NIL == conses_high.member( current_$1, kb_compare.$list58, kb_compare.UNPROVIDED, kb_compare.UNPROVIDED ) )
      {
        bad = kb_compare.T;
      }
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( datum, kb_compare.$list57 );
    }
    final SubLObject progress_message_tail = cdestructuring_bind.property_list_member( kb_compare.$kw60$PROGRESS_MESSAGE, current );
    final SubLObject progress_message = ( kb_compare.NIL != progress_message_tail ) ? conses_high.cadr( progress_message_tail ) : kb_compare.NIL;
    final SubLObject body;
    current = ( body = temp );
    final SubLObject internal_id = kb_compare.$sym61$INTERNAL_ID;
    final SubLObject remote_id = kb_compare.$sym62$REMOTE_ID;
    return ConsesLow.list( kb_compare.$sym63$DO_ID_INDEX, ConsesLow.list( internal_id, remote_id, ConsesLow.list(
        kb_compare.$sym50$KB_INTERSECTION_CONSTANT_INDEX, intersection ), kb_compare.$kw60$PROGRESS_MESSAGE, progress_message ), ConsesLow.list(
            kb_compare.$sym64$IGNORE, remote_id ), ConsesLow.listS( kb_compare.$sym4$CLET, ConsesLow.list( ConsesLow.list( constant, ConsesLow
                .list( kb_compare.$sym65$FIND_CONSTANT_BY_INTERNAL_ID, internal_id ) ) ), ConsesLow.append( body, kb_compare.NIL ) ) );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject impossible = kb_compare.NIL;
    try
    {
      ...
      try
      {
        ...
        list_utilities.tree_map( kb_compare.$sym67$KB_INTERSECTION_NART_IMPOSSIBLE_INT, cycl_utilities.nart_cons( nart ), kb_compare.UNPROVIDED );
      }
      finally
      {
    ...
    {
      impossible = Errors.handleThrowable( ccatch_env_var, kb_compare.$kw66$IMPOSSIBLE );
    }
    finally
    {
      thread.throwStack.pop();
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( ( kb_compare.NIL != constant_handles.constant_p( v_object ) && kb_compare.NIL == kb_intersection_constantP( kb_compare.$kb_intersection$.getDynamicValue( thread ), v_object ) ) || ( kb_compare.NIL != nart_handles
        .nart_p( v_object ) && kb_compare.NIL != kb_intersection_nart_impossibleP( kb_compare.$kb_intersection$.getDynamicValue( thread ), v_object ) ) )
    {
      Dynamic.sublisp_throw( kb_compare.$kw66$IMPOSSIBLE, kb_compare.T );
    }
    return kb_compare.NIL;
  }
  ...
  public static SubLObject kb_intersection_assertion_impossibleP(final SubLObject intersection, final SubLObject assertion)
  {
    ...
    try
    {
      ...
      {
        kb_compare.$kb_intersection$.bind( intersection, thread );
        list_utilities.tree_map( kb_compare.$sym68$KB_INTERSECTION_ASSERTION_IMPOSSIBLE_INT, assertions_high.assertion_cons( assertion ), kb_compare.UNPROVIDED );
        cycl_utilities.expression_map( kb_compare.$sym68$KB_INTERSECTION_ASSERTION_IMPOSSIBLE_INT, assertions_high.assertion_mt( assertion ), kb_compare.T, kb_compare.UNPROVIDED );
      }
      finally
      {
        kb_compare.$kb_intersection$.rebind( _prev_bind_0, thread );
  ...
  public static SubLObject kb_intersection_assertion_impossible_int(final SubLObject v_object)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( ( kb_compare.NIL != constant_handles.constant_p( v_object ) && kb_compare.NIL == kb_intersection_constantP( kb_compare.$kb_intersection$.getDynamicValue( thread ), v_object ) ) || ( kb_compare.NIL != nart_handles
        .nart_p( v_object ) && kb_compare.NIL == kb_intersection_nartP( kb_compare.$kb_intersection$.getDynamicValue( thread ), v_object ) ) || ( kb_compare.NIL != assertion_handles.assertion_p( v_object )
  ...
  public static SubLObject kb_intersection_deduction_impossibleP(final SubLObject intersection, final SubLObject deduction)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        SubLObject support = kb_compare.NIL;
        ...
        while ( kb_compare.NIL != cdolist_list_var)
        {
          ...
          {
            list_utilities.tree_map( kb_compare.$sym69$KB_INTERSECTION_DEDUCTION_IMPOSSIBLE_INT, arguments.support_cons( support ), kb_compare.UNPROVIDED );
            cycl_utilities.expression_map( kb_compare.$sym69$KB_INTERSECTION_DEDUCTION_IMPOSSIBLE_INT, arguments.support_mt( support ), kb_compare.T, kb_compare.UNPROVIDED );
          }
  ...
  public static SubLObject kb_intersection_deduction_impossible_int(final SubLObject v_object)
  {
    ...
    if( ( kb_compare.NIL != constant_handles.constant_p( v_object ) && kb_compare.NIL == kb_intersection_constantP( kb_compare.$kb_intersection$.getDynamicValue( thread ), v_object ) ) || ( kb_compare.NIL != nart_handles
        .nart_p( v_object ) && kb_compare.NIL == kb_intersection_nartP( kb_compare.$kb_intersection$.getDynamicValue( thread ), v_object ) ) || ( kb_compare.NIL != assertion_handles.assertion_p( v_object )
            && kb_compare.NIL == kb_intersection_assertionP( kb_compare.$kb_intersection$.getDynamicValue( thread ), v_object ) ) )
    {
      Dynamic.sublisp_throw( kb_compare.$kw66$IMPOSSIBLE, kb_compare.T );
    }
    return kb_compare.NIL;
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject stream = kb_compare.NIL;
    try
    {
      final SubLObject _prev_bind_0 = stream_macros.$stream_requires_locking$.currentBinding( thread );
      try
      {
        stream_macros.$stream_requires_locking$.bind( kb_compare.NIL, thread );
        stream = compatibility.open_text( file, kb_compare.$kw70$OUTPUT );
      }
      finally
      {
      ...
      if( !stream.isStream() )
      {
        Errors.error( kb_compare.$str71$Unable_to_open__S, file );
      }
    ...
    finally
    {
      ...
      try
      {
        Threads.$is_thread_performing_cleanupP$.bind( kb_compare.T, thread );
        final SubLObject _values = Values.getValuesAsVector();
        if( stream.isStream() )
        {
          streams_high.close( stream, kb_compare.UNPROVIDED );
        }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject kb_intersection = kb_compare.NIL;
    SubLObject stream = kb_compare.NIL;
    try
    {
      final SubLObject _prev_bind_0 = stream_macros.$stream_requires_locking$.currentBinding( thread );
      ...
      {
        stream_macros.$stream_requires_locking$.bind( kb_compare.NIL, thread );
        stream = compatibility.open_text( file, kb_compare.$kw72$INPUT );
      }
      finally
      {
        stream_macros.$stream_requires_locking$.rebind( _prev_bind_0, thread );
  ...
  public static SubLObject save_kb_intersection_information(final SubLObject kb_intersection, final SubLObject stream)
  {
    ...
    cfasl.cfasl_output( kb_compare.$kw73$CONSTANTS, stream );
    save_kb_intersection_id_index( kb_intrsct_constant_index( kb_intersection ), stream, kb_compare.$str74$Constants );
    cfasl.cfasl_output( kb_compare.$kw75$NARTS, stream );
    save_kb_intersection_id_index( kb_intrsct_nart_index( kb_intersection ), stream, kb_compare.$str76$NARTs );
    cfasl.cfasl_output( kb_compare.$kw77$ASSERTIONS, stream );
    save_kb_intersection_id_index( kb_intrsct_assertion_index( kb_intersection ), stream, kb_compare.$str78$Assertions );
    cfasl.cfasl_output( kb_compare.$kw79$DEDUCTIONS, stream );
    save_kb_intersection_id_index( kb_intrsct_deduction_index( kb_intersection ), stream, kb_compare.$str80$Deductions );
    return kb_intersection;
  }
  ...
  public static SubLObject load_kb_intersection_information(final SubLObject v_remote_image, final SubLObject stream)
  {
    ...
    _csetf_kb_intrsct_constant_index( kb_intersection, load_kb_intersection_id_index( kb_compare.$kw73$CONSTANTS, stream ) );
    _csetf_kb_intrsct_nart_index( kb_intersection, load_kb_intersection_id_index( kb_compare.$kw75$NARTS, stream ) );
    _csetf_kb_intrsct_assertion_index( kb_intersection, load_kb_intersection_id_index( kb_compare.$kw77$ASSERTIONS, stream ) );
    _csetf_kb_intrsct_deduction_index( kb_intersection, load_kb_intersection_id_index( kb_compare.$kw79$DEDUCTIONS, stream ) );
    return kb_intersection;
  }
  ...
  public static SubLObject save_kb_intersection_id_index(final SubLObject v_id_index, final SubLObject stream, final SubLObject type)
  {
    ...
    final SubLObject message = str = Sequences.cconcatenate( kb_compare.$str81$Saving_KB_, new SubLObject[] { format_nil.format_nil_a_no_copy( type ), kb_compare.$str82$_Intersection_ID_Index_____
    } );
    ...
    try
    {
      ...
      utilities_macros.$progress_notification_count$.bind( kb_compare.ZERO_INTEGER, thread );
      utilities_macros.$progress_pacifications_since_last_nl$.bind( kb_compare.ZERO_INTEGER, thread );
      utilities_macros.$progress_count$.bind( kb_compare.ZERO_INTEGER, thread );
      utilities_macros.$is_noting_progressP$.bind( kb_compare.T, thread );
      utilities_macros.$silent_progressP$.bind( ( kb_compare.NIL != str ) ? utilities_macros.$silent_progressP$.getDynamicValue( thread ) : kb_compare.T, thread );
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject message = Sequences.cconcatenate( kb_compare.$str83$Loading_KB_, new SubLObject[] { format_nil.format_nil_a_no_copy( type ), kb_compare.$str82$_Intersection_ID_Index_____
    } );
    final SubLObject marker = cfasl.cfasl_input( stream, kb_compare.UNPROVIDED, kb_compare.UNPROVIDED );
    SubLObject v_id_index = kb_compare.NIL;
    if( kb_compare.NIL == Errors.$ignore_mustsP$.getDynamicValue( thread ) && !type.eql( marker ) )
    {
      Errors.error( kb_compare.$str84$Error_in_KB_Intersection_ID_index, type, marker );
    }
    ...
    try
    {
      ...
      utilities_macros.$silent_progressP$.bind( ( kb_compare.NIL != str ) ? utilities_macros.$silent_progressP$.getDynamicValue( thread ) : kb_compare.T, thread );
      utilities_macros.noting_progress_preamble( str );
      v_id_index = cfasl.cfasl_input( stream, kb_compare.UNPROVIDED, kb_compare.UNPROVIDED );
      if( kb_compare.NIL == Errors.$ignore_mustsP$.getDynamicValue( thread ) && kb_compare.NIL == id_index.id_index_p( v_id_index ) )
      {
        Errors.error( kb_compare.$str85$Expected_a_KB_Intersection_ID_ind, v_id_index );
      }
      utilities_macros.noting_progress_postamble();
    }
    finally
  ...
  public static SubLObject invert_kb_intersection_id_index(final SubLObject v_id_index)
  {
    ...
    if( kb_compare.NIL == id_index.id_index_objects_empty_p( v_id_index, kb_compare.$kw86$SKIP ) )
    {
      if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( v_id_index, kb_compare.$kw86$SKIP ) )
      {
        final SubLObject vector_var = id_index.id_index_dense_objects( v_id_index );
        final SubLObject backwardP_var = kb_compare.NIL;
        SubLObject length;
        SubLObject v_iteration;
        SubLObject id;
        SubLObject v_object;
        for( length = Sequences.length( vector_var ), v_iteration = kb_compare.NIL, v_iteration = kb_compare.ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration,
            kb_compare.ONE_INTEGER ) )
        {
          id = ( ( kb_compare.NIL != backwardP_var ) ? Numbers.subtract( length, v_iteration, kb_compare.ONE_INTEGER ) : v_iteration );
          v_object = Vectors.aref( vector_var, id );
          if( kb_compare.NIL == id_index.id_index_tombstone_p( v_object ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
          {
            if( kb_compare.NIL != id_index.id_index_tombstone_p( v_object ) )
            {
              v_object = kb_compare.$kw86$SKIP;
            }
            ...
            {
              Errors.error( kb_compare.$str87$This_ID_index_cannot_be_inverted_, id, v_object );
            }
      ...
      if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( v_id_index ) )
      {
        ...
        SubLObject id2 = kb_compare.NIL;
        SubLObject v_object2 = kb_compare.NIL;
        ...
        try
        {
          while ( Hashtables.iteratorHasNext( cdohash_iterator ))
          {
            ...
            {
              Errors.error( kb_compare.$str87$This_ID_index_cannot_be_inverted_, id2, v_object2 );
            }
  ...
  {
    print_kb_difference( v_object, stream, kb_compare.ZERO_INTEGER );
    return kb_compare.NIL;
  }
  ...
  {
    return ( v_object.getClass() == $kb_difference_native.class ) ? kb_compare.T : kb_compare.NIL;
  }
  ...
  public static SubLObject make_kb_difference(SubLObject arglist)
  {
    ...
    for( next = kb_compare.NIL, next = arglist; kb_compare.NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      current_value = conses_high.cadr( next );
      pcase_var = current_arg;
      if( pcase_var.eql( kb_compare.$kw109$COMMON_INTERSECTION ) )
      {
        _csetf_kb_diff_common_intersection( v_new, current_value );
      }
      else if( pcase_var.eql( kb_compare.$kw110$RENAMED_CONSTANTS ) )
      {
        _csetf_kb_diff_renamed_constants( v_new, current_value );
      }
      else if( pcase_var.eql( kb_compare.$kw73$CONSTANTS ) )
      {
        _csetf_kb_diff_constants( v_new, current_value );
      }
      else if( pcase_var.eql( kb_compare.$kw75$NARTS ) )
      {
        _csetf_kb_diff_narts( v_new, current_value );
      }
      else if( pcase_var.eql( kb_compare.$kw77$ASSERTIONS ) )
      {
        _csetf_kb_diff_assertions( v_new, current_value );
      }
      else if( pcase_var.eql( kb_compare.$kw79$DEDUCTIONS ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, kb_compare.$kw43$BEGIN, kb_compare.$sym111$MAKE_KB_DIFFERENCE, kb_compare.SIX_INTEGER );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw109$COMMON_INTERSECTION, kb_diff_common_intersection( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw110$RENAMED_CONSTANTS, kb_diff_renamed_constants( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw73$CONSTANTS, kb_diff_constants( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw75$NARTS, kb_diff_narts( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw77$ASSERTIONS, kb_diff_assertions( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw45$SLOT, kb_compare.$kw79$DEDUCTIONS, kb_diff_deductions( obj ) );
    Functions.funcall( visitor_fn, obj, kb_compare.$kw46$END, kb_compare.$sym111$MAKE_KB_DIFFERENCE, kb_compare.SIX_INTEGER );
    return obj;
  }
  ...
  {
    PrintLow.format( stream, kb_compare.$str113$_KB_DIFFERENCE_using__a_, kb_difference_common_intersection( v_object ) );
    return kb_compare.NIL;
  }
  ...
  {
    final SubLObject difference = make_kb_difference( kb_compare.UNPROVIDED );
    _csetf_kb_diff_common_intersection( difference, intersection );
    _csetf_kb_diff_renamed_constants( difference, dictionary.new_dictionary( Symbols.symbol_function( kb_compare.EQL ), kb_compare.UNPROVIDED ) );
    _csetf_kb_diff_constants( difference, set.new_set( Symbols.symbol_function( kb_compare.EQL ), kb_compare.UNPROVIDED ) );
    _csetf_kb_diff_narts( difference, set.new_set( Symbols.symbol_function( kb_compare.EQL ), kb_compare.UNPROVIDED ) );
    _csetf_kb_diff_assertions( difference, set.new_set( Symbols.symbol_function( kb_compare.EQL ), kb_compare.UNPROVIDED ) );
    _csetf_kb_diff_deductions( difference, set.new_set( Symbols.symbol_function( kb_compare.EQL ), kb_compare.UNPROVIDED ) );
    return difference;
  }
  ...
  public static SubLObject destroy_kb_difference(final SubLObject difference)
  {
    ...
    _csetf_kb_diff_common_intersection( difference, kb_compare.$kw49$FREE );
    _csetf_kb_diff_renamed_constants( difference, kb_compare.NIL );
    _csetf_kb_diff_constants( difference, kb_compare.NIL );
    _csetf_kb_diff_narts( difference, kb_compare.NIL );
    _csetf_kb_diff_assertions( difference, kb_compare.NIL );
    _csetf_kb_diff_deductions( difference, kb_compare.NIL );
    return difference;
  }
  ...
  public static SubLObject do_kb_difference_renamed_constants(final SubLObject macroform, final SubLObject environment)
  {
    SubLObject current;
    final SubLObject datum = current = macroform.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list124 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject constant = kb_compare.NIL;
    SubLObject remote_name = kb_compare.NIL;
    SubLObject difference = kb_compare.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list124 );
    constant = current.first();
    current = current.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list124 );
    ...
    SubLObject rest = current;
    SubLObject bad = kb_compare.NIL;
    SubLObject current_$4 = kb_compare.NIL;
    while ( kb_compare.NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list124 );
      current_$4 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list124 );
      if( kb_compare.NIL == conses_high.member( current_$4, kb_compare.$list125, kb_compare.UNPROVIDED, kb_compare.UNPROVIDED ) )
      {
        bad = kb_compare.T;
      }
    ...
    if( kb_compare.NIL != bad && kb_compare.NIL == allow_other_keys_p )
    {
      cdestructuring_bind.cdestructuring_bind_error( datum, kb_compare.$list124 );
    }
    final SubLObject done_tail = cdestructuring_bind.property_list_member( kb_compare.$kw126$DONE, current );
    final SubLObject done = ( kb_compare.NIL != done_tail ) ? conses_high.cadr( done_tail ) : kb_compare.NIL;
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( kb_compare.$sym127$DO_DICTIONARY, ConsesLow.list( constant, remote_name, ConsesLow.list(
        kb_compare.$sym114$KB_DIFFERENCE_RENAMED_CONSTANTS, difference ), kb_compare.$kw126$DONE, done ), ConsesLow.append( body, kb_compare.NIL ) );
  }
  ...
  public static SubLObject do_kb_difference_constants(final SubLObject macroform, final SubLObject environment)
  {
    SubLObject current;
    final SubLObject datum = current = macroform.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list128 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject constant = kb_compare.NIL;
    SubLObject difference = kb_compare.NIL;
    ...
    SubLObject rest = current;
    SubLObject bad = kb_compare.NIL;
    SubLObject current_$5 = kb_compare.NIL;
    while ( kb_compare.NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list128 );
      current_$5 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list128 );
      if( kb_compare.NIL == conses_high.member( current_$5, kb_compare.$list125, kb_compare.UNPROVIDED, kb_compare.UNPROVIDED ) )
      {
        bad = kb_compare.T;
      }
    ...
    if( kb_compare.NIL != bad && kb_compare.NIL == allow_other_keys_p )
    {
      cdestructuring_bind.cdestructuring_bind_error( datum, kb_compare.$list128 );
    }
    final SubLObject done_tail = cdestructuring_bind.property_list_member( kb_compare.$kw126$DONE, current );
    final SubLObject done = ( kb_compare.NIL != done_tail ) ? conses_high.cadr( done_tail ) : kb_compare.NIL;
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( kb_compare.$sym129$DO_SET, ConsesLow.list( constant, ConsesLow.list( kb_compare.$sym116$KB_DIFFERENCE_CONSTANTS, difference ),
        kb_compare.$kw126$DONE, done ), ConsesLow.append( body, kb_compare.NIL ) );
  }
  ...
  public static SubLObject do_kb_difference_narts(final SubLObject macroform, final SubLObject environment)
  {
    SubLObject current;
    final SubLObject datum = current = macroform.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list130 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject nart = kb_compare.NIL;
    SubLObject difference = kb_compare.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list130 );
    nart = current.first();
    current = current.rest();
    ...
    SubLObject rest = current;
    SubLObject bad = kb_compare.NIL;
    SubLObject current_$6 = kb_compare.NIL;
    while ( kb_compare.NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list130 );
      current_$6 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list130 );
      if( kb_compare.NIL == conses_high.member( current_$6, kb_compare.$list125, kb_compare.UNPROVIDED, kb_compare.UNPROVIDED ) )
      {
        bad = kb_compare.T;
      }
    ...
    if( kb_compare.NIL != bad && kb_compare.NIL == allow_other_keys_p )
    {
      cdestructuring_bind.cdestructuring_bind_error( datum, kb_compare.$list130 );
    }
    final SubLObject done_tail = cdestructuring_bind.property_list_member( kb_compare.$kw126$DONE, current );
    final SubLObject done = ( kb_compare.NIL != done_tail ) ? conses_high.cadr( done_tail ) : kb_compare.NIL;
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( kb_compare.$sym129$DO_SET, ConsesLow.list( nart, ConsesLow.list( kb_compare.$sym118$KB_DIFFERENCE_NARTS, difference ),
        kb_compare.$kw126$DONE, done ), ConsesLow.append( body, kb_compare.NIL ) );
  }
  ...
  public static SubLObject do_kb_difference_assertions(final SubLObject macroform, final SubLObject environment)
  {
    SubLObject current;
    final SubLObject datum = current = macroform.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list131 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject assertion = kb_compare.NIL;
    SubLObject difference = kb_compare.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list131 );
    ...
    SubLObject rest = current;
    SubLObject bad = kb_compare.NIL;
    SubLObject current_$7 = kb_compare.NIL;
    while ( kb_compare.NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list131 );
      current_$7 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list131 );
      if( kb_compare.NIL == conses_high.member( current_$7, kb_compare.$list125, kb_compare.UNPROVIDED, kb_compare.UNPROVIDED ) )
      {
        bad = kb_compare.T;
      }
    ...
    if( kb_compare.NIL != bad && kb_compare.NIL == allow_other_keys_p )
    {
      cdestructuring_bind.cdestructuring_bind_error( datum, kb_compare.$list131 );
    }
    final SubLObject done_tail = cdestructuring_bind.property_list_member( kb_compare.$kw126$DONE, current );
    final SubLObject done = ( kb_compare.NIL != done_tail ) ? conses_high.cadr( done_tail ) : kb_compare.NIL;
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( kb_compare.$sym129$DO_SET, ConsesLow.list( assertion, ConsesLow.list( kb_compare.$sym120$KB_DIFFERENCE_ASSERTIONS,
        difference ), kb_compare.$kw126$DONE, done ), ConsesLow.append( body, kb_compare.NIL ) );
  }
  ...
  public static SubLObject do_kb_difference_deductions(final SubLObject macroform, final SubLObject environment)
  {
    SubLObject current;
    final SubLObject datum = current = macroform.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list132 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject deduction = kb_compare.NIL;
    SubLObject difference = kb_compare.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list132 );
    ...
    SubLObject rest = current;
    SubLObject bad = kb_compare.NIL;
    SubLObject current_$8 = kb_compare.NIL;
    while ( kb_compare.NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list132 );
      current_$8 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, kb_compare.$list132 );
      if( kb_compare.NIL == conses_high.member( current_$8, kb_compare.$list125, kb_compare.UNPROVIDED, kb_compare.UNPROVIDED ) )
      {
        bad = kb_compare.T;
      }
    ...
    if( kb_compare.NIL != bad && kb_compare.NIL == allow_other_keys_p )
    {
      cdestructuring_bind.cdestructuring_bind_error( datum, kb_compare.$list132 );
    }
    final SubLObject done_tail = cdestructuring_bind.property_list_member( kb_compare.$kw126$DONE, current );
    final SubLObject done = ( kb_compare.NIL != done_tail ) ? conses_high.cadr( done_tail ) : kb_compare.NIL;
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( kb_compare.$sym129$DO_SET, ConsesLow.list( deduction, ConsesLow.list( kb_compare.$sym122$KB_DIFFERENCE_DEDUCTIONS,
        difference ), kb_compare.$kw126$DONE, done ), ConsesLow.append( body, kb_compare.NIL ) );
  }
  ...
  {
    return Sort.sort( dictionary.dictionary_keys( kb_diff_renamed_constants( difference ) ), Symbols.symbol_function( kb_compare.$sym134$_ ), kb_compare.$sym135$CONSTANT_INTERNAL_ID );
  }
  ...
  {
    return Sort.sort( set.set_element_list( kb_diff_constants( difference ) ), Symbols.symbol_function( kb_compare.$sym134$_ ), kb_compare.$sym135$CONSTANT_INTERNAL_ID );
  }
  ...
  {
    return Sort.sort( set.set_element_list( kb_diff_narts( difference ) ), Symbols.symbol_function( kb_compare.$sym134$_ ), kb_compare.$sym136$NART_ID );
  }
  ...
  {
    return Sort.sort( set.set_element_list( kb_diff_deductions( difference ) ), Symbols.symbol_function( kb_compare.$sym134$_ ), kb_compare.$sym137$DEDUCTION_ID );
  }
  ...
  public static SubLObject kb_intersection_compute(final SubLObject intersection)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          cfasl.$cfasl_common_symbols$.bind( kb_compare.NIL, thread );
  ...
  public static SubLObject kb_intersection_compute_constants(final SubLObject intersection)
  {
    ...
    if( kb_compare.NIL != compute_remote_image_old_constants_congruentP() )
    {
      ...
      SubLObject sofar = kb_compare.ZERO_INTEGER;
      ...
      try
      {
        utilities_macros.$last_percent_progress_index$.bind( kb_compare.ZERO_INTEGER, thread );
        utilities_macros.$last_percent_progress_prediction$.bind( kb_compare.NIL, thread );
        utilities_macros.$within_noting_percent_progress$.bind( kb_compare.T, thread );
        utilities_macros.$percent_progress_start_time$.bind( Time.get_universal_time(), thread );
        try
        {
          utilities_macros.noting_percent_progress_preamble( kb_compare.$str138$KB_Intersection___Examining_new_c );
          SubLObject end_var;
          SubLObject end;
          SubLObject id;
          SubLObject constant;
          for( end = ( end_var = id_index.id_index_next_id( table_var ) ), id = kb_compare.NIL, id = start; !id.numGE( end_var ); id = number_utilities.f_1X( id ) )
          {
            constant = id_index.id_index_lookup( table_var, id, kb_compare.UNPROVIDED );
            if( kb_compare.NIL != constant )
            {
              utilities_macros.note_percent_progress( sofar, total );
              sofar = Numbers.add( sofar, kb_compare.ONE_INTEGER );
    ...
    else
    {
      ...
      final SubLObject mess = kb_compare.$str139$KB_Intersection___Examining_const;
      ...
      try
      {
        ...
        try
        {
          ...
          if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$11, kb_compare.$kw86$SKIP ) )
          {
            final SubLObject idx_$12 = idx_$11;
            if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$12, kb_compare.$kw86$SKIP ) )
            {
              ...
              for( length = Sequences.length( vector_var ), v_iteration = kb_compare.NIL, v_iteration = kb_compare.ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add(
                  v_iteration, kb_compare.ONE_INTEGER ) )
              {
                id2 = ( ( kb_compare.NIL != backwardP_var ) ? Numbers.subtract( length, v_iteration, kb_compare.ONE_INTEGER ) : v_iteration );
                constant2 = Vectors.aref( vector_var, id2 );
                if( kb_compare.NIL == id_index.id_index_tombstone_p( constant2 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
                {
                  if( kb_compare.NIL != id_index.id_index_tombstone_p( constant2 ) )
                  {
                    constant2 = kb_compare.$kw86$SKIP;
                  }
            ...
            if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$13 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
            {
              ...
              final SubLObject v_default = ( kb_compare.NIL != id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) ) ? kb_compare.NIL : kb_compare.$kw86$SKIP;
              while ( id3.numL( end_id ))
              {
                final SubLObject constant3 = Hashtables.gethash_without_values( id3, sparse, v_default );
                if( kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) || kb_compare.NIL == id_index.id_index_tombstone_p( constant3 ) )
                {
                  kb_intersection_compute_constant( intersection, constant3 );
                  sofar = Numbers.add( sofar, kb_compare.ONE_INTEGER );
                  utilities_macros.note_percent_progress( sofar, total );
                }
                id3 = Numbers.add( id3, kb_compare.ONE_INTEGER );
              }
            }
          }
        }
  ...
  public static SubLObject kb_intersection_compute_congruent_old_constants(final SubLObject intersection)
  {
    ...
    final SubLObject missing_set = set_utilities.construct_set_from_list( missing_remote_ids, Symbols.symbol_function( kb_compare.EQL ), kb_compare.UNPROVIDED );
    final SubLObject threshold = constant_handles.new_constant_suid_threshold();
    final SubLObject past_ids = kb_compare.NIL;
    SubLObject my_done = kb_compare.NIL;
    final SubLObject idx = constant_handles.do_constants_table();
    final SubLObject mess = kb_compare.$str140$KB_Intersection___Examining_old_c;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = kb_compare.ZERO_INTEGER;
    assert kb_compare.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$15, kb_compare.$kw86$SKIP ) )
        {
          final SubLObject idx_$16 = idx_$15;
          if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$16, kb_compare.$kw86$SKIP ) )
          {
            final SubLObject vector_var = id_index.id_index_dense_objects( idx_$16 );
            final SubLObject backwardP_var = kb_compare.NIL;
            final SubLObject length = Sequences.length( vector_var );
            SubLObject current;
            final SubLObject datum = current = ( kb_compare.NIL != backwardP_var ) ? ConsesLow.list( Numbers.subtract( length, kb_compare.ONE_INTEGER ),
                kb_compare.MINUS_ONE_INTEGER, kb_compare.MINUS_ONE_INTEGER ) : ConsesLow.list( kb_compare.ZERO_INTEGER, length, kb_compare.ONE_INTEGER );
            SubLObject start = kb_compare.NIL;
            SubLObject end = kb_compare.NIL;
            SubLObject delta = kb_compare.NIL;
            cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list141 );
            start = current.first();
            current = current.rest();
            cdestructuring_bind.destructuring_bind_must_consp( current, datum, kb_compare.$list141 );
            end = current.first();
            ...
            if( kb_compare.NIL == current )
            {
              if( kb_compare.NIL == my_done )
              {
                ...
                for( end_var = end, id = kb_compare.NIL, id = start; kb_compare.NIL == my_done && kb_compare.NIL == subl_macros.do_numbers_endtest( id, delta, end_var ); id = Numbers.add( id, delta ) )
                {
                  constant = Vectors.aref( vector_var, id );
                  if( kb_compare.NIL == id_index.id_index_tombstone_p( constant ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
                  {
                    if( kb_compare.NIL != id_index.id_index_tombstone_p( constant ) )
                    {
                      constant = kb_compare.$kw86$SKIP;
                    }
            ...
            {
              cdestructuring_bind.cdestructuring_bind_error( datum, kb_compare.$list141 );
            }
          }
          final SubLObject idx_$17 = idx_$15;
          if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$17 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
          {
            ...
            while ( id2.numL( end_id ) && kb_compare.NIL == my_done)
            {
              ...
              if( kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) || kb_compare.NIL == id_index.id_index_tombstone_p( constant2 ) )
              {
              ...
              id2 = Numbers.add( id2, kb_compare.ONE_INTEGER );
            }
          }
        }
      }
  ...
  public static SubLObject kb_intersection_compute_narts(final SubLObject intersection)
  {
    ...
    if( kb_compare.NIL != compute_remote_image_old_narts_congruentP() )
    {
      ...
      try
      {
        ...
        try
        {
          utilities_macros.noting_percent_progress_preamble( kb_compare.$str142$KB_Intersection___Examining_new_n );
          SubLObject end_var;
          SubLObject end;
          SubLObject id;
          SubLObject nart;
          for( end = ( end_var = id_index.id_index_next_id( table_var ) ), id = kb_compare.NIL, id = start; !id.numGE( end_var ); id = number_utilities.f_1X( id ) )
          {
            nart = id_index.id_index_lookup( table_var, id, kb_compare.UNPROVIDED );
    ...
    else
    {
      ...
      final SubLObject mess = kb_compare.$str143$KB_Intersection___Examining_narts;
      final SubLObject total = id_index.id_index_count( idx );
      SubLObject sofar = kb_compare.ZERO_INTEGER;
      assert kb_compare.NIL != Types.stringp( mess ) : mess;
      final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
      ...
      try
      {
        ...
        try
        {
          ...
          if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$22, kb_compare.$kw86$SKIP ) )
          {
            final SubLObject idx_$23 = idx_$22;
            if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$23, kb_compare.$kw86$SKIP ) )
            {
                  ...
                  v_iteration, kb_compare.ONE_INTEGER ) )
              {
                ...
                if( kb_compare.NIL == id_index.id_index_tombstone_p( nart2 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
                {
                  if( kb_compare.NIL != id_index.id_index_tombstone_p( nart2 ) )
                  {
                    nart2 = kb_compare.$kw86$SKIP;
                  }
            ...
            if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$24 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
            {
              ...
              while ( id3.numL( end_id ))
              {
                ...
                if( kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) || kb_compare.NIL == id_index.id_index_tombstone_p( nart3 ) )
                {
  ...
  public static SubLObject kb_intersection_compute_congruent_old_narts(final SubLObject intersection)
  {
    ...
    SubLObject my_done = kb_compare.NIL;
    final SubLObject idx = nart_handles.do_narts_table();
    final SubLObject mess = kb_compare.$str144$KB_Intersection___Examining_old_n;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = kb_compare.ZERO_INTEGER;
    assert kb_compare.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$26, kb_compare.$kw86$SKIP ) )
        {
          final SubLObject idx_$27 = idx_$26;
          if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$27, kb_compare.$kw86$SKIP ) )
          {
            ...
            if( kb_compare.NIL == current )
            {
              if( kb_compare.NIL == my_done )
              {
                ...
                for( end_var = end, id = kb_compare.NIL, id = start; kb_compare.NIL == my_done && kb_compare.NIL == subl_macros.do_numbers_endtest( id, delta, end_var ); id = Numbers.add( id, delta ) )
                {
                  ...
                  if( kb_compare.NIL == id_index.id_index_tombstone_p( nart ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
                  {
                    if( kb_compare.NIL != id_index.id_index_tombstone_p( nart ) )
                    {
                      nart = kb_compare.$kw86$SKIP;
                    }
          ...
          if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$28 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
          {
            ...
            while ( id2.numL( end_id ) && kb_compare.NIL == my_done)
            {
              ...
              if( kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) || kb_compare.NIL == id_index.id_index_tombstone_p( nart2 ) )
              {
  ...
  public static SubLObject kb_intersection_compute_assertions(final SubLObject intersection)
  {
    ...
    if( kb_compare.NIL != compute_remote_image_old_assertions_congruentP() )
    {
      ...
      try
      {
        ...
        try
        {
          utilities_macros.noting_percent_progress_preamble( kb_compare.$str145$KB_Intersection___Examining_new_a );
          SubLObject end_var;
          SubLObject end;
          SubLObject id;
          ...
          for( end = ( end_var = id_index.id_index_next_id( table_var ) ), id = kb_compare.NIL, id = start; !id.numGE( end_var ); id = number_utilities.f_1X( id ) )
          {
            assertion = id_index.id_index_lookup( table_var, id, kb_compare.UNPROVIDED );
    ...
    else
    {
      ...
      final SubLObject mess = kb_compare.$str146$KB_Intersection___Examining_asser;
      final SubLObject total = id_index.id_index_count( idx );
      SubLObject sofar = kb_compare.ZERO_INTEGER;
      assert kb_compare.NIL != Types.stringp( mess ) : mess;
      final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
      ...
      try
      {
        ...
        try
        {
          ...
          if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$33, kb_compare.$kw86$SKIP ) )
          {
            final SubLObject idx_$34 = idx_$33;
            if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$34, kb_compare.$kw86$SKIP ) )
            {
              ...
              for( length = Sequences.length( vector_var ), v_iteration = kb_compare.NIL, v_iteration = kb_compare.ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add(
                  v_iteration, kb_compare.ONE_INTEGER ) )
              {
                a_id = ( ( kb_compare.NIL != backwardP_var ) ? Numbers.subtract( length, v_iteration, kb_compare.ONE_INTEGER ) : v_iteration );
                a_handle = Vectors.aref( vector_var, a_id );
                if( kb_compare.NIL == id_index.id_index_tombstone_p( a_handle ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
                {
                  if( kb_compare.NIL != id_index.id_index_tombstone_p( a_handle ) )
                  {
                    a_handle = kb_compare.$kw86$SKIP;
                  }
            ...
            if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$35 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
            {
              ...
              while ( a_id2.numL( end_id ))
              {
                ...
                if( kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) || kb_compare.NIL == id_index.id_index_tombstone_p( a_handle2 ) )
                {
                ...
                a_id2 = Numbers.add( a_id2, kb_compare.ONE_INTEGER );
              }
            }
          }
        }
  ...
  public static SubLObject kb_intersection_compute_congruent_old_assertions(final SubLObject intersection)
  {
    ...
    SubLObject my_done = kb_compare.NIL;
    final SubLObject idx = assertion_handles.do_assertions_table();
    final SubLObject mess = kb_compare.$str147$KB_Intersection___Examining_old_a;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = kb_compare.ZERO_INTEGER;
    assert kb_compare.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$37, kb_compare.$kw86$SKIP ) )
        {
          final SubLObject idx_$38 = idx_$37;
          if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$38, kb_compare.$kw86$SKIP ) )
          {
            ...
            if( kb_compare.NIL == current )
            {
              if( kb_compare.NIL == my_done )
              {
                ...
                for( end_var = end, id = kb_compare.NIL, id = start; kb_compare.NIL == my_done && kb_compare.NIL == subl_macros.do_numbers_endtest( id, delta, end_var ); id = Numbers.add( id, delta ) )
                {
                  ...
                  if( kb_compare.NIL == id_index.id_index_tombstone_p( assertion ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
                  {
                    if( kb_compare.NIL != id_index.id_index_tombstone_p( assertion ) )
                    {
                      assertion = kb_compare.$kw86$SKIP;
                    }
          ...
          if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$39 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
          {
            ...
            while ( id2.numL( end_id ) && kb_compare.NIL == my_done)
            {
              ...
              if( kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) || kb_compare.NIL == id_index.id_index_tombstone_p( assertion2 ) )
              {
  ...
  public static SubLObject kb_intersection_compute_deductions(final SubLObject intersection)
  {
    ...
    if( kb_compare.NIL != compute_remote_image_old_deductions_congruentP() )
    {
      ...
      try
      {
        ...
        try
        {
          utilities_macros.noting_percent_progress_preamble( kb_compare.$str148$KB_Intersection___Examining_new_d );
          SubLObject end_var;
          SubLObject end;
          SubLObject id;
          ...
          for( end = ( end_var = id_index.id_index_next_id( table_var ) ), id = kb_compare.NIL, id = start; !id.numGE( end_var ); id = number_utilities.f_1X( id ) )
          {
            deduction = id_index.id_index_lookup( table_var, id, kb_compare.UNPROVIDED );
    ...
    else
    {
      ...
      final SubLObject mess = kb_compare.$str149$KB_Intersection___Examining_deduc;
      final SubLObject total = id_index.id_index_count( idx );
      SubLObject sofar = kb_compare.ZERO_INTEGER;
      assert kb_compare.NIL != Types.stringp( mess ) : mess;
      final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
      ...
      try
      {
        ...
        try
        {
          ...
          if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$44, kb_compare.$kw86$SKIP ) )
          {
            final SubLObject idx_$45 = idx_$44;
            if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$45, kb_compare.$kw86$SKIP ) )
            {
              ...
              for( length = Sequences.length( vector_var ), v_iteration = kb_compare.NIL, v_iteration = kb_compare.ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add(
                  v_iteration, kb_compare.ONE_INTEGER ) )
              {
                d_id = ( ( kb_compare.NIL != backwardP_var ) ? Numbers.subtract( length, v_iteration, kb_compare.ONE_INTEGER ) : v_iteration );
                d_handle = Vectors.aref( vector_var, d_id );
                if( kb_compare.NIL == id_index.id_index_tombstone_p( d_handle ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
                {
                  if( kb_compare.NIL != id_index.id_index_tombstone_p( d_handle ) )
                  {
                    d_handle = kb_compare.$kw86$SKIP;
                  }
                  deduction2 = deduction_handles.resolve_deduction_id_value_pair( d_id, d_handle );
                  if( kb_compare.NIL != deduction_handles.valid_deduction( deduction2, kb_compare.T ) )
                  {
            ...
            if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$46 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
            {
              ...
              while ( d_id2.numL( end_id ))
              {
                ...
                if( kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) || kb_compare.NIL == id_index.id_index_tombstone_p( d_handle2 ) )
                {
                  final SubLObject deduction3 = deduction_handles.resolve_deduction_id_value_pair( d_id2, d_handle2 );
                  if( kb_compare.NIL != deduction_handles.valid_deduction( deduction3, kb_compare.T ) )
                  {
                ...
                d_id2 = Numbers.add( d_id2, kb_compare.ONE_INTEGER );
              }
            }
          }
        }
  ...
  public static SubLObject kb_intersection_compute_congruent_old_deductions(final SubLObject intersection)
  {
    ...
    SubLObject my_done = kb_compare.NIL;
    final SubLObject idx = deduction_handles.do_deductions_table();
    final SubLObject mess = kb_compare.$str150$KB_Intersection___Examining_old_d;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = kb_compare.ZERO_INTEGER;
    assert kb_compare.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$48, kb_compare.$kw86$SKIP ) )
        {
          final SubLObject idx_$49 = idx_$48;
          if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$49, kb_compare.$kw86$SKIP ) )
          {
            ...
            if( kb_compare.NIL == current )
            {
              if( kb_compare.NIL == my_done )
              {
                ...
                for( end_var = end, id = kb_compare.NIL, id = start; kb_compare.NIL == my_done && kb_compare.NIL == subl_macros.do_numbers_endtest( id, delta, end_var ); id = Numbers.add( id, delta ) )
                {
                  ...
                  if( kb_compare.NIL == id_index.id_index_tombstone_p( deduction ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
                  {
                    if( kb_compare.NIL != id_index.id_index_tombstone_p( deduction ) )
                    {
                      deduction = kb_compare.$kw86$SKIP;
                    }
          ...
          if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$50 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
          {
            ...
            while ( id2.numL( end_id ) && kb_compare.NIL == my_done)
            {
              ...
              if( kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) || kb_compare.NIL == id_index.id_index_tombstone_p( deduction2 ) )
              {
  ...
  public static SubLObject kb_difference_compute_renamed_constants(final SubLObject difference)
  {
    ...
    final SubLObject message = kb_compare.$str151$KB_DIFFERENCE___Examining_constan;
    ...
    try
    {
      ...
      try
      {
        ...
        if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$55, kb_compare.$kw86$SKIP ) )
        {
          final SubLObject idx_$56 = idx_$55;
          if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$56, kb_compare.$kw86$SKIP ) )
          {
            ...
            for( length = Sequences.length( vector_var ), v_iteration = kb_compare.NIL, v_iteration = kb_compare.ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration,
                kb_compare.ONE_INTEGER ) )
            {
              internal_id = ( ( kb_compare.NIL != backwardP_var ) ? Numbers.subtract( length, v_iteration, kb_compare.ONE_INTEGER ) : v_iteration );
              remote_id = Vectors.aref( vector_var, internal_id );
              if( kb_compare.NIL == id_index.id_index_tombstone_p( remote_id ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
              {
                if( kb_compare.NIL != id_index.id_index_tombstone_p( remote_id ) )
                {
                  remote_id = kb_compare.$kw86$SKIP;
                }
          ...
          if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$57 ) )
          {
            ...
            SubLObject internal_id2 = kb_compare.NIL;
            SubLObject remote_id2 = kb_compare.NIL;
            final Iterator cdohash_iterator = Hashtables.getEntrySetIterator( cdohash_table );
            try
            {
              while ( Hashtables.iteratorHasNext( cdohash_iterator ))
  ...
  public static SubLObject kb_difference_compute_constants(final SubLObject difference)
  {
    ...
    final SubLObject intersection = kb_difference_common_intersection( difference );
    final SubLObject idx = constant_handles.do_constants_table();
    final SubLObject mess = kb_compare.$str152$KB_DIFFERENCE___Examining_constan;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = kb_compare.ZERO_INTEGER;
    assert kb_compare.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$61, kb_compare.$kw86$SKIP ) )
        {
          final SubLObject idx_$62 = idx_$61;
          if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$62, kb_compare.$kw86$SKIP ) )
          {
          ...
          if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$63 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
          {
  ...
  public static SubLObject kb_difference_compute_narts(final SubLObject difference)
  {
    ...
    final SubLObject intersection = kb_difference_common_intersection( difference );
    final SubLObject idx = nart_handles.do_narts_table();
    final SubLObject mess = kb_compare.$str153$KB_DIFFERENCE___Examining_narts;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = kb_compare.ZERO_INTEGER;
    assert kb_compare.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$65, kb_compare.$kw86$SKIP ) )
        {
          final SubLObject idx_$66 = idx_$65;
          if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$66, kb_compare.$kw86$SKIP ) )
          {
          ...
          if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$67 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
          {
  ...
  public static SubLObject kb_difference_compute_assertions(final SubLObject difference)
  {
    ...
    final SubLObject intersection = kb_difference_common_intersection( difference );
    final SubLObject idx = assertion_handles.do_assertions_table();
    final SubLObject mess = kb_compare.$str154$KB_DIFFERENCE___Examining_asserti;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = kb_compare.ZERO_INTEGER;
    assert kb_compare.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$69, kb_compare.$kw86$SKIP ) )
        {
          final SubLObject idx_$70 = idx_$69;
          if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$70, kb_compare.$kw86$SKIP ) )
          {
          ...
          if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$71 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
          {
  ...
  public static SubLObject kb_difference_compute_deductions(final SubLObject difference)
  {
    ...
    final SubLObject intersection = kb_difference_common_intersection( difference );
    final SubLObject idx = deduction_handles.do_deductions_table();
    final SubLObject mess = kb_compare.$str155$KB_DIFFERENCE___Examining_deducti;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = kb_compare.ZERO_INTEGER;
    assert kb_compare.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( kb_compare.NIL == id_index.id_index_objects_empty_p( idx_$73, kb_compare.$kw86$SKIP ) )
        {
          final SubLObject idx_$74 = idx_$73;
          if( kb_compare.NIL == id_index.id_index_dense_objects_empty_p( idx_$74, kb_compare.$kw86$SKIP ) )
          {
          ...
          if( kb_compare.NIL == id_index.id_index_sparse_objects_empty_p( idx_$75 ) || kb_compare.NIL == id_index.id_index_skip_tombstones_p( kb_compare.$kw86$SKIP ) )
          {
  ...
  public static SubLObject compute_remote_image_kb_intersection(final SubLObject machine, final SubLObject port, SubLObject protocol)
  {
    ...
    {
      protocol = kb_compare.$kw11$CFASL;
    }
  ...
  public static SubLObject show_kb_difference(final SubLObject difference, SubLObject stream)
  {
    ...
    {
      PrintLow.format( stream, kb_compare.$str156$___No_Difference___ );
    }
    else
    {
      if( kb_compare.NIL != renamed_constants )
      {
        PrintLow.format( stream, kb_compare.$str157$___Renamed_Constants____ );
        ...
        while ( kb_compare.NIL != cdolist_list_var)
        {
          ...
          PrintLow.format( stream, kb_compare.$str158$_S_renamed_to__S__, constant, remote_name );
          cdolist_list_var = cdolist_list_var.rest();
          constant = cdolist_list_var.first();
        }
      ...
      {
        PrintLow.format( stream, kb_compare.$str159$___Constants____ );
        SubLObject cdolist_list_var = constants;
        SubLObject constant = kb_compare.NIL;
        constant = cdolist_list_var.first();
        while ( kb_compare.NIL != cdolist_list_var)
        {
          PrintLow.format( stream, kb_compare.$str160$_S__, constant );
          cdolist_list_var = cdolist_list_var.rest();
          constant = cdolist_list_var.first();
        }
        streams_high.terpri( stream );
      ...
      {
        PrintLow.format( stream, kb_compare.$str161$___Narts____ );
        SubLObject cdolist_list_var = narts;
        SubLObject nart = kb_compare.NIL;
        nart = cdolist_list_var.first();
        while ( kb_compare.NIL != cdolist_list_var)
        {
          PrintLow.format( stream, kb_compare.$str160$_S__, nart );
          cdolist_list_var = cdolist_list_var.rest();
          nart = cdolist_list_var.first();
        }
        streams_high.terpri( stream );
      ...
      {
        PrintLow.format( stream, kb_compare.$str162$___Assertions____ );
        SubLObject cdolist_list_var = assertions;
        SubLObject assertion = kb_compare.NIL;
        assertion = cdolist_list_var.first();
        while ( kb_compare.NIL != cdolist_list_var)
        {
          PrintLow.format( stream, kb_compare.$str160$_S__, assertion );
          cdolist_list_var = cdolist_list_var.rest();
          assertion = cdolist_list_var.first();
        }
        streams_high.terpri( stream );
      ...
      {
        PrintLow.format( stream, kb_compare.$str163$___Deductions____ );
        ...
        while ( kb_compare.NIL != cdolist_list_var)
        {
          ...
          PrintLow.format( stream, kb_compare.$str164$_S__supports___, supported_object );
          ...
          {
            PrintLow.format( stream, kb_compare.$str160$_S__, support );
  ...
  public static SubLObject compute_remote_image_old_constants_congruentP()
  {
    ...
    return remote_image.current_remote_image_connection_eval( ConsesLow.listS( kb_compare.$sym165$_, old_constant_count, kb_compare.$list166 ) );
  }
  ...
  {
    return remote_image.current_remote_image_connection_eval( kb_compare.$list167 );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject error = kb_compare.NIL;
    SubLObject result = kb_compare.NIL;
    try
    {
      ...
      try
      {
        Errors.$error_handler$.bind( kb_compare.$sym168$CATCH_ERROR_MESSAGE_HANDLER, thread );
        try
        {
          result = remote_image.current_remote_image_connection_eval( ConsesLow.list( kb_compare.$sym169$CONSTANT_INTERNAL_ID_FROM_EXTERNAL_ID, ConsesLow.list(
              kb_compare.$sym16$QUOTE, constants_high.constant_external_id( constant ) ) ) );
        }
        catch( final Throwable catch_var )
        {
          Errors.handleThrowable( catch_var, kb_compare.NIL );
    ...
    if( error.isString() )
    {
      Errors.error( kb_compare.$str170$Could_not_compute_remote_ID_for__, constant, error );
    }
    return result;
  }
  ...
  {
    return remote_image.current_remote_image_connection_eval( ConsesLow.list( kb_compare.$sym171$CONSTANT_NAME_FROM_INTERNAL_ID, remote_id ) );
  }
  ...
  public static SubLObject compute_remote_image_old_narts_congruentP()
  {
    ...
    return remote_image.current_remote_image_connection_eval( ConsesLow.listS( kb_compare.$sym165$_, old_nart_count, kb_compare.$list172 ) );
  }
  ...
  {
    return remote_image.current_remote_image_connection_eval( kb_compare.$list173 );
  }
  ...
  public static SubLObject compute_nart_remote_id(final SubLObject nart)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          result = remote_image.current_remote_image_connection_eval( ConsesLow.list( kb_compare.$sym174$NART_ID_FROM_RECIPE, ConsesLow.list( kb_compare.$sym16$QUOTE,
    ...
    if( error.isString() )
    {
      Errors.error( kb_compare.$str170$Could_not_compute_remote_ID_for__, nart, error );
    }
    return result;
  }
  ...
  public static SubLObject compute_remote_image_old_assertions_congruentP()
  {
    ...
    return remote_image.current_remote_image_connection_eval( ConsesLow.listS( kb_compare.$sym165$_, old_assertion_count, kb_compare.$list175 ) );
  }
  ...
  {
    return remote_image.current_remote_image_connection_eval( kb_compare.$list176 );
  }
  ...
  public static SubLObject compute_assertion_remote_id(final SubLObject assertion)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          result = remote_image.current_remote_image_connection_eval( ConsesLow.list( kb_compare.$sym177$ASSERTION_ID_FROM_RECIPE, ConsesLow.list(
              kb_compare.$sym16$QUOTE, assertions_high.assertion_cnf( assertion ) ), ConsesLow.list( kb_compare.$sym16$QUOTE, assertions_high.assertion_mt( assertion ) ) ) );
        }
        catch( final Throwable catch_var )
        {
          Errors.handleThrowable( catch_var, kb_compare.NIL );
    ...
    if( error.isString() )
    {
      Errors.error( kb_compare.$str170$Could_not_compute_remote_ID_for__, assertion, error );
    }
    return result;
  }
  ...
  public static SubLObject compute_remote_image_old_deductions_congruentP()
  {
    ...
    return remote_image.current_remote_image_connection_eval( ConsesLow.listS( kb_compare.$sym165$_, old_deduction_count, kb_compare.$list178 ) );
  }
  ...
  {
    return remote_image.current_remote_image_connection_eval( kb_compare.$list179 );
  }
  ...
  public static SubLObject compute_deduction_remote_id(final SubLObject deduction)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          result = remote_image.current_remote_image_connection_eval( ConsesLow.list( kb_compare.$sym180$DEDUCTION_ID_FROM_RECIPE, list_utilities.quotify( deductions_high
              .deduction_supported_object( deduction ) ), ConsesLow.list( kb_compare.$sym16$QUOTE, deductions_high.deduction_supports( deduction ) ), arguments.argument_truth( deduction ) ) );
        }
        catch( final Throwable catch_var )
        {
          Errors.handleThrowable( catch_var, kb_compare.NIL );
    ...
    if( error.isString() )
    {
      Errors.error( kb_compare.$str170$Could_not_compute_remote_ID_for__, deduction, error );
    }
    return result;
  }
  ...
  public static SubLObject declare_kb_compare_file()
  {
    ...
    SubLFiles.declareFunction( myName, "set_kb_compare_connection_common_symbols", "SET-KB-COMPARE-CONNECTION-COMMON-SYMBOLS", 0, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_print_function_trampoline", "KB-INTERSECTION-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_p", "KB-INTERSECTION-P", 1, 0, false );
    new $kb_intersection_p$UnaryFunction();
    SubLFiles.declareFunction( myName, "kb_intrsct_remote_image", "KB-INTRSCT-REMOTE-IMAGE", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intrsct_constant_index", "KB-INTRSCT-CONSTANT-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intrsct_nart_index", "KB-INTRSCT-NART-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intrsct_assertion_index", "KB-INTRSCT-ASSERTION-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intrsct_deduction_index", "KB-INTRSCT-DEDUCTION-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_intrsct_remote_image", "_CSETF-KB-INTRSCT-REMOTE-IMAGE", 2, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_intrsct_constant_index", "_CSETF-KB-INTRSCT-CONSTANT-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_intrsct_nart_index", "_CSETF-KB-INTRSCT-NART-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_intrsct_assertion_index", "_CSETF-KB-INTRSCT-ASSERTION-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_intrsct_deduction_index", "_CSETF-KB-INTRSCT-DEDUCTION-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "make_kb_intersection", "MAKE-KB-INTERSECTION", 0, 1, false );
    SubLFiles.declareFunction( myName, "visit_defstruct_kb_intersection", "VISIT-DEFSTRUCT-KB-INTERSECTION", 2, 0, false );
    SubLFiles.declareFunction( myName, "visit_defstruct_object_kb_intersection_method", "VISIT-DEFSTRUCT-OBJECT-KB-INTERSECTION-METHOD", 2, 0, false );
    SubLFiles.declareFunction( myName, "print_kb_intersection", "PRINT-KB-INTERSECTION", 3, 0, false );
    SubLFiles.declareFunction( myName, "new_kb_intersection", "NEW-KB-INTERSECTION", 1, 0, false );
    SubLFiles.declareFunction( myName, "destroy_kb_intersection", "DESTROY-KB-INTERSECTION", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_remote_image", "KB-INTERSECTION-REMOTE-IMAGE", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_constant_index", "KB-INTERSECTION-CONSTANT-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_add_constant", "KB-INTERSECTION-ADD-CONSTANT", 3, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_add_nart", "KB-INTERSECTION-ADD-NART", 3, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_add_assertion", "KB-INTERSECTION-ADD-ASSERTION", 3, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_add_deduction", "KB-INTERSECTION-ADD-DEDUCTION", 3, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_remote_image_machine", "KB-INTERSECTION-REMOTE-IMAGE-MACHINE", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_remote_image_port", "KB-INTERSECTION-REMOTE-IMAGE-PORT", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_remote_image_protocol", "KB-INTERSECTION-REMOTE-IMAGE-PROTOCOL", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_constantP", "KB-INTERSECTION-CONSTANT?", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_constant_remote_id", "KB-INTERSECTION-CONSTANT-REMOTE-ID", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_nartP", "KB-INTERSECTION-NART?", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_nart_remote_id", "KB-INTERSECTION-NART-REMOTE-ID", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_assertionP", "KB-INTERSECTION-ASSERTION?", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_assertion_remote_id", "KB-INTERSECTION-ASSERTION-REMOTE-ID", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_deductionP", "KB-INTERSECTION-DEDUCTION?", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_deduction_remote_id", "KB-INTERSECTION-DEDUCTION-REMOTE-ID", 2, 0, false );
    SubLFiles.declareMacro( "com.cyc.cycjava.cycl.kb_compare", "do_kb_intersection_constants", "DO-KB-INTERSECTION-CONSTANTS" );
    SubLFiles.declareFunction( myName, "kb_intersection_nart_impossibleP", "KB-INTERSECTION-NART-IMPOSSIBLE?", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_nart_impossible_int", "KB-INTERSECTION-NART-IMPOSSIBLE-INT", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_assertion_impossibleP", "KB-INTERSECTION-ASSERTION-IMPOSSIBLE?", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_assertion_impossible_int", "KB-INTERSECTION-ASSERTION-IMPOSSIBLE-INT", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_deduction_impossibleP", "KB-INTERSECTION-DEDUCTION-IMPOSSIBLE?", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_deduction_impossible_int", "KB-INTERSECTION-DEDUCTION-IMPOSSIBLE-INT", 1, 0, false );
    SubLFiles.declareFunction( myName, "save_kb_intersection_information_to_file", "SAVE-KB-INTERSECTION-INFORMATION-TO-FILE", 2, 0, false );
    SubLFiles.declareFunction( myName, "load_kb_intersection_information_from_file", "LOAD-KB-INTERSECTION-INFORMATION-FROM-FILE", 2, 0, false );
    SubLFiles.declareFunction( myName, "save_kb_intersection_information", "SAVE-KB-INTERSECTION-INFORMATION", 2, 0, false );
    SubLFiles.declareFunction( myName, "load_kb_intersection_information", "LOAD-KB-INTERSECTION-INFORMATION", 2, 0, false );
    SubLFiles.declareFunction( myName, "save_kb_intersection_id_index", "SAVE-KB-INTERSECTION-ID-INDEX", 3, 0, false );
    SubLFiles.declareFunction( myName, "load_kb_intersection_id_index", "LOAD-KB-INTERSECTION-ID-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "invert_kb_intersection_id_index", "INVERT-KB-INTERSECTION-ID-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_print_function_trampoline", "KB-DIFFERENCE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_p", "KB-DIFFERENCE-P", 1, 0, false );
    new $kb_difference_p$UnaryFunction();
    SubLFiles.declareFunction( myName, "kb_diff_common_intersection", "KB-DIFF-COMMON-INTERSECTION", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_diff_renamed_constants", "KB-DIFF-RENAMED-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_diff_constants", "KB-DIFF-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_diff_narts", "KB-DIFF-NARTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_diff_assertions", "KB-DIFF-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_diff_deductions", "KB-DIFF-DEDUCTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_diff_common_intersection", "_CSETF-KB-DIFF-COMMON-INTERSECTION", 2, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_diff_renamed_constants", "_CSETF-KB-DIFF-RENAMED-CONSTANTS", 2, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_diff_constants", "_CSETF-KB-DIFF-CONSTANTS", 2, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_diff_narts", "_CSETF-KB-DIFF-NARTS", 2, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_diff_assertions", "_CSETF-KB-DIFF-ASSERTIONS", 2, 0, false );
    SubLFiles.declareFunction( myName, "_csetf_kb_diff_deductions", "_CSETF-KB-DIFF-DEDUCTIONS", 2, 0, false );
    SubLFiles.declareFunction( myName, "make_kb_difference", "MAKE-KB-DIFFERENCE", 0, 1, false );
    SubLFiles.declareFunction( myName, "visit_defstruct_kb_difference", "VISIT-DEFSTRUCT-KB-DIFFERENCE", 2, 0, false );
    SubLFiles.declareFunction( myName, "visit_defstruct_object_kb_difference_method", "VISIT-DEFSTRUCT-OBJECT-KB-DIFFERENCE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( myName, "print_kb_difference", "PRINT-KB-DIFFERENCE", 3, 0, false );
    SubLFiles.declareFunction( myName, "new_kb_difference", "NEW-KB-DIFFERENCE", 1, 0, false );
    SubLFiles.declareFunction( myName, "destroy_kb_difference", "DESTROY-KB-DIFFERENCE", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_common_intersection", "KB-DIFFERENCE-COMMON-INTERSECTION", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_renamed_constants", "KB-DIFFERENCE-RENAMED-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_constants", "KB-DIFFERENCE-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_narts", "KB-DIFFERENCE-NARTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_assertions", "KB-DIFFERENCE-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_deductions", "KB-DIFFERENCE-DEDUCTIONS", 1, 0, false );
    ...
    SubLFiles.declareFunction( myName, "kb_difference_add_renamed_constant", "KB-DIFFERENCE-ADD-RENAMED-CONSTANT", 3, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_add_constant", "KB-DIFFERENCE-ADD-CONSTANT", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_add_nart", "KB-DIFFERENCE-ADD-NART", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_add_assertion", "KB-DIFFERENCE-ADD-ASSERTION", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_add_deduction", "KB-DIFFERENCE-ADD-DEDUCTION", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_remote_image", "KB-DIFFERENCE-REMOTE-IMAGE", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_remote_image_machine", "KB-DIFFERENCE-REMOTE-IMAGE-MACHINE", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_remote_image_port", "KB-DIFFERENCE-REMOTE-IMAGE-PORT", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_remote_image_protocol", "KB-DIFFERENCE-REMOTE-IMAGE-PROTOCOL", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_constant_remote_name", "KB-DIFFERENCE-CONSTANT-REMOTE-NAME", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_all_renamed_constants", "KB-DIFFERENCE-ALL-RENAMED-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_all_constants", "KB-DIFFERENCE-ALL-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_all_narts", "KB-DIFFERENCE-ALL-NARTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_all_assertions", "KB-DIFFERENCE-ALL-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_all_deductions", "KB-DIFFERENCE-ALL-DEDUCTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute", "KB-INTERSECTION-COMPUTE", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_constants", "KB-INTERSECTION-COMPUTE-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_congruent_old_constants", "KB-INTERSECTION-COMPUTE-CONGRUENT-OLD-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_constant", "KB-INTERSECTION-COMPUTE-CONSTANT", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_narts", "KB-INTERSECTION-COMPUTE-NARTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_congruent_old_narts", "KB-INTERSECTION-COMPUTE-CONGRUENT-OLD-NARTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_nart", "KB-INTERSECTION-COMPUTE-NART", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_assertions", "KB-INTERSECTION-COMPUTE-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_congruent_old_assertions", "KB-INTERSECTION-COMPUTE-CONGRUENT-OLD-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_assertion", "KB-INTERSECTION-COMPUTE-ASSERTION", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_deductions", "KB-INTERSECTION-COMPUTE-DEDUCTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_congruent_old_deductions", "KB-INTERSECTION-COMPUTE-CONGRUENT-OLD-DEDUCTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_intersection_compute_deduction", "KB-INTERSECTION-COMPUTE-DEDUCTION", 2, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_compute", "KB-DIFFERENCE-COMPUTE", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_compute_renamed_constants", "KB-DIFFERENCE-COMPUTE-RENAMED-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_compute_constants", "KB-DIFFERENCE-COMPUTE-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_compute_narts", "KB-DIFFERENCE-COMPUTE-NARTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_compute_assertions", "KB-DIFFERENCE-COMPUTE-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "kb_difference_compute_deductions", "KB-DIFFERENCE-COMPUTE-DEDUCTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "compute_remote_image_kb_intersection", "COMPUTE-REMOTE-IMAGE-KB-INTERSECTION", 2, 1, false );
    SubLFiles.declareFunction( myName, "compute_remote_image_kb_difference", "COMPUTE-REMOTE-IMAGE-KB-DIFFERENCE", 2, 1, false );
    SubLFiles.declareFunction( myName, "show_kb_difference", "SHOW-KB-DIFFERENCE", 1, 1, false );
    SubLFiles.declareFunction( myName, "compute_remote_image_old_constants_congruentP", "COMPUTE-REMOTE-IMAGE-OLD-CONSTANTS-CONGRUENT?", 0, 0, false );
    SubLFiles.declareFunction( myName, "compute_missing_old_constant_remote_ids", "COMPUTE-MISSING-OLD-CONSTANT-REMOTE-IDS", 0, 0, false );
    SubLFiles.declareFunction( myName, "compute_constant_remote_id", "COMPUTE-CONSTANT-REMOTE-ID", 1, 0, false );
    SubLFiles.declareFunction( myName, "compute_constant_remote_name", "COMPUTE-CONSTANT-REMOTE-NAME", 1, 0, false );
    SubLFiles.declareFunction( myName, "compute_remote_image_old_narts_congruentP", "COMPUTE-REMOTE-IMAGE-OLD-NARTS-CONGRUENT?", 0, 0, false );
    SubLFiles.declareFunction( myName, "compute_missing_old_nart_remote_ids", "COMPUTE-MISSING-OLD-NART-REMOTE-IDS", 0, 0, false );
    SubLFiles.declareFunction( myName, "compute_nart_remote_id", "COMPUTE-NART-REMOTE-ID", 1, 0, false );
    SubLFiles.declareFunction( myName, "compute_remote_image_old_assertions_congruentP", "COMPUTE-REMOTE-IMAGE-OLD-ASSERTIONS-CONGRUENT?", 0, 0, false );
    SubLFiles.declareFunction( myName, "compute_missing_old_assertion_remote_ids", "COMPUTE-MISSING-OLD-ASSERTION-REMOTE-IDS", 0, 0, false );
    SubLFiles.declareFunction( myName, "compute_assertion_remote_id", "COMPUTE-ASSERTION-REMOTE-ID", 1, 0, false );
    SubLFiles.declareFunction( myName, "compute_remote_image_old_deductions_congruentP", "COMPUTE-REMOTE-IMAGE-OLD-DEDUCTIONS-CONGRUENT?", 0, 0, false );
    SubLFiles.declareFunction( myName, "compute_missing_old_deduction_remote_ids", "COMPUTE-MISSING-OLD-DEDUCTION-REMOTE-IDS", 0, 0, false );
    SubLFiles.declareFunction( myName, "compute_deduction_remote_id", "COMPUTE-DEDUCTION-REMOTE-ID", 1, 0, false );
    return kb_compare.NIL;
  }

  public static SubLObject init_kb_compare_file()
  {
    kb_compare.$kb_compare_common_symbols$ = SubLFiles.defparameter( "*KB-COMPARE-COMMON-SYMBOLS*", ConsesLow.append( kb_compare.$list0, kb_compare.$list1, ConsesLow.append( enumeration_types
        .valid_truths(), enumeration_types.valid_hl_truth_values(), hl_supports.hl_support_modules() ) ) );
    kb_compare.$dtp_kb_intersection$ = SubLFiles.defconstant( "*DTP-KB-INTERSECTION*", kb_compare.$sym18$KB_INTERSECTION );
    kb_compare.$kb_intersection$ = SubLFiles.defparameter( "*KB-INTERSECTION*", kb_compare.NIL );
    kb_compare.$dtp_kb_difference$ = SubLFiles.defconstant( "*DTP-KB-DIFFERENCE*", kb_compare.$sym88$KB_DIFFERENCE );
    return kb_compare.NIL;
  }

  public static SubLObject setup_kb_compare_file()
  {
    access_macros.register_macro_helper( kb_compare.$sym9$SET_KB_COMPARE_CONNECTION_COMMON_SYMBOLS, kb_compare.$sym10$WITH_NEW_KB_COMPARE_CONNECTION );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), kb_compare.$dtp_kb_intersection$.getGlobalValue(), Symbols.symbol_function(
        kb_compare.$sym25$KB_INTERSECTION_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( kb_compare.$list26 );
    Structures.def_csetf( kb_compare.$sym27$KB_INTRSCT_REMOTE_IMAGE, kb_compare.$sym28$_CSETF_KB_INTRSCT_REMOTE_IMAGE );
    Structures.def_csetf( kb_compare.$sym29$KB_INTRSCT_CONSTANT_INDEX, kb_compare.$sym30$_CSETF_KB_INTRSCT_CONSTANT_INDEX );
    Structures.def_csetf( kb_compare.$sym31$KB_INTRSCT_NART_INDEX, kb_compare.$sym32$_CSETF_KB_INTRSCT_NART_INDEX );
    Structures.def_csetf( kb_compare.$sym33$KB_INTRSCT_ASSERTION_INDEX, kb_compare.$sym34$_CSETF_KB_INTRSCT_ASSERTION_INDEX );
    Structures.def_csetf( kb_compare.$sym35$KB_INTRSCT_DEDUCTION_INDEX, kb_compare.$sym36$_CSETF_KB_INTRSCT_DEDUCTION_INDEX );
    Equality.identity( kb_compare.$sym18$KB_INTERSECTION );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), kb_compare.$dtp_kb_intersection$.getGlobalValue(), Symbols.symbol_function(
        kb_compare.$sym47$VISIT_DEFSTRUCT_OBJECT_KB_INTERSECTION_METHOD ) );
    access_macros.register_macro_helper( kb_compare.$sym50$KB_INTERSECTION_CONSTANT_INDEX, kb_compare.$sym51$DO_KB_INTERSECTION_CONSTANTS );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), kb_compare.$dtp_kb_difference$.getGlobalValue(), Symbols.symbol_function(
        kb_compare.$sym95$KB_DIFFERENCE_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( kb_compare.$list96 );
    Structures.def_csetf( kb_compare.$sym97$KB_DIFF_COMMON_INTERSECTION, kb_compare.$sym98$_CSETF_KB_DIFF_COMMON_INTERSECTION );
    Structures.def_csetf( kb_compare.$sym99$KB_DIFF_RENAMED_CONSTANTS, kb_compare.$sym100$_CSETF_KB_DIFF_RENAMED_CONSTANTS );
    Structures.def_csetf( kb_compare.$sym101$KB_DIFF_CONSTANTS, kb_compare.$sym102$_CSETF_KB_DIFF_CONSTANTS );
    Structures.def_csetf( kb_compare.$sym103$KB_DIFF_NARTS, kb_compare.$sym104$_CSETF_KB_DIFF_NARTS );
    Structures.def_csetf( kb_compare.$sym105$KB_DIFF_ASSERTIONS, kb_compare.$sym106$_CSETF_KB_DIFF_ASSERTIONS );
    Structures.def_csetf( kb_compare.$sym107$KB_DIFF_DEDUCTIONS, kb_compare.$sym108$_CSETF_KB_DIFF_DEDUCTIONS );
    Equality.identity( kb_compare.$sym88$KB_DIFFERENCE );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), kb_compare.$dtp_kb_difference$.getGlobalValue(), Symbols.symbol_function(
        kb_compare.$sym112$VISIT_DEFSTRUCT_OBJECT_KB_DIFFERENCE_METHOD ) );
    access_macros.register_macro_helper( kb_compare.$sym114$KB_DIFFERENCE_RENAMED_CONSTANTS, kb_compare.$sym115$DO_KB_DIFFERENCE_RENAMED_CONSTANTS );
    access_macros.register_macro_helper( kb_compare.$sym116$KB_DIFFERENCE_CONSTANTS, kb_compare.$sym117$DO_KB_DIFFERENCE_CONSTANTS );
    access_macros.register_macro_helper( kb_compare.$sym118$KB_DIFFERENCE_NARTS, kb_compare.$sym119$DO_KB_DIFFERENCE_NARTS );
    access_macros.register_macro_helper( kb_compare.$sym120$KB_DIFFERENCE_ASSERTIONS, kb_compare.$sym121$DO_KB_DIFFERENCE_ASSERTIONS );
    access_macros.register_macro_helper( kb_compare.$sym122$KB_DIFFERENCE_DEDUCTIONS, kb_compare.$sym123$DO_KB_DIFFERENCE_DEDUCTIONS );
    return kb_compare.NIL;
  }
  ...
  static
  {
    ...
    $list0 = ConsesLow.list( kb_compare.T );
    $list1 = ConsesLow.list( SubLObjectFactory.makeSymbol( "ASSERTION-ID-FROM-RECIPE" ), SubLObjectFactory.makeSymbol( "DEDUCTION-ID-FROM-RECIPE" ), SubLObjectFactory.makeSymbol(
        "CONSTANT-INTERNAL-ID-FROM-EXTERNAL-ID" ), SubLObjectFactory.makeSymbol( "CONSTANT-NAME-FROM-INTERNAL-ID" ), SubLObjectFactory.makeSymbol( "NART-ID-FROM-RECIPE" ) );
    $list2 = ConsesLow.list( SubLObjectFactory.makeSymbol( "REMOTE-IMAGE" ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    ...
    $list5 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "*KB-COMPARE-COMMON-SYMBOLS*" ), SubLObjectFactory.makeSymbol( "*KB-COMPARE-COMMON-SYMBOLS*" ) ) );
    $list6 = ConsesLow.list( SubLObjectFactory.makeSymbol( "SET-KB-COMPARE-CONNECTION-COMMON-SYMBOLS" ) );
    ...
    $list17 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "ERROR" ), SubLObjectFactory.makeString( "hack" ) ) );
    ...
    $list20 = ConsesLow.list( SubLObjectFactory.makeSymbol( "REMOTE-IMAGE" ), SubLObjectFactory.makeSymbol( "CONSTANT-INDEX" ), SubLObjectFactory.makeSymbol( "NART-INDEX" ),
        SubLObjectFactory.makeSymbol( "ASSERTION-INDEX" ), SubLObjectFactory.makeSymbol( "DEDUCTION-INDEX" ) );
    $list21 = ConsesLow.list( SubLObjectFactory.makeKeyword( "REMOTE-IMAGE" ), SubLObjectFactory.makeKeyword( "CONSTANT-INDEX" ), SubLObjectFactory.makeKeyword( "NART-INDEX" ),
        SubLObjectFactory.makeKeyword( "ASSERTION-INDEX" ), SubLObjectFactory.makeKeyword( "DEDUCTION-INDEX" ) );
    $list22 = ConsesLow.list( SubLObjectFactory.makeSymbol( "KB-INTRSCT-REMOTE-IMAGE" ), SubLObjectFactory.makeSymbol( "KB-INTRSCT-CONSTANT-INDEX" ), SubLObjectFactory.makeSymbol(
        "KB-INTRSCT-NART-INDEX" ), SubLObjectFactory.makeSymbol( "KB-INTRSCT-ASSERTION-INDEX" ), SubLObjectFactory.makeSymbol( "KB-INTRSCT-DEDUCTION-INDEX" ) );
    $list23 = ConsesLow.list( SubLObjectFactory.makeSymbol( "_CSETF-KB-INTRSCT-REMOTE-IMAGE" ), SubLObjectFactory.makeSymbol( "_CSETF-KB-INTRSCT-CONSTANT-INDEX" ), SubLObjectFactory
        .makeSymbol( "_CSETF-KB-INTRSCT-NART-INDEX" ), SubLObjectFactory.makeSymbol( "_CSETF-KB-INTRSCT-ASSERTION-INDEX" ), SubLObjectFactory.makeSymbol( "_CSETF-KB-INTRSCT-DEDUCTION-INDEX" ) );
    ...
    $list26 = ConsesLow.list( SubLObjectFactory.makeSymbol( "OPTIMIZE-FUNCALL" ), SubLObjectFactory.makeSymbol( "KB-INTERSECTION-P" ) );
    ...
    $list57 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "CONSTANT" ), SubLObjectFactory.makeSymbol( "INTERSECTION" ), SubLObjectFactory.makeSymbol(
        "&KEY" ), SubLObjectFactory.makeSymbol( "PROGRESS-MESSAGE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    $list58 = ConsesLow.list( SubLObjectFactory.makeKeyword( "PROGRESS-MESSAGE" ) );
    ...
    $list90 = ConsesLow.list( SubLObjectFactory.makeSymbol( "COMMON-INTERSECTION" ), SubLObjectFactory.makeSymbol( "RENAMED-CONSTANTS" ), SubLObjectFactory.makeSymbol(
        "CONSTANTS" ), SubLObjectFactory.makeSymbol( "NARTS" ), SubLObjectFactory.makeSymbol( "ASSERTIONS" ), SubLObjectFactory.makeSymbol( "DEDUCTIONS" ) );
    $list91 = ConsesLow.list( SubLObjectFactory.makeKeyword( "COMMON-INTERSECTION" ), SubLObjectFactory.makeKeyword( "RENAMED-CONSTANTS" ), SubLObjectFactory.makeKeyword(
    ...
    $list92 = ConsesLow.list( SubLObjectFactory.makeSymbol( "KB-DIFF-COMMON-INTERSECTION" ), SubLObjectFactory.makeSymbol( "KB-DIFF-RENAMED-CONSTANTS" ), SubLObjectFactory
        .makeSymbol( "KB-DIFF-CONSTANTS" ), SubLObjectFactory.makeSymbol( "KB-DIFF-NARTS" ), SubLObjectFactory.makeSymbol( "KB-DIFF-ASSERTIONS" ), SubLObjectFactory.makeSymbol(
            "KB-DIFF-DEDUCTIONS" ) );
    $list93 = ConsesLow.list( SubLObjectFactory.makeSymbol( "_CSETF-KB-DIFF-COMMON-INTERSECTION" ), SubLObjectFactory.makeSymbol( "_CSETF-KB-DIFF-RENAMED-CONSTANTS" ),
        SubLObjectFactory.makeSymbol( "_CSETF-KB-DIFF-CONSTANTS" ), SubLObjectFactory.makeSymbol( "_CSETF-KB-DIFF-NARTS" ), SubLObjectFactory.makeSymbol(
            "_CSETF-KB-DIFF-ASSERTIONS" ), SubLObjectFactory.makeSymbol( "_CSETF-KB-DIFF-DEDUCTIONS" ) );
    ...
    $list96 = ConsesLow.list( SubLObjectFactory.makeSymbol( "OPTIMIZE-FUNCALL" ), SubLObjectFactory.makeSymbol( "KB-DIFFERENCE-P" ) );
    ...
    $list124 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "CONSTANT" ), SubLObjectFactory.makeSymbol( "REMOTE-NAME" ), SubLObjectFactory.makeSymbol(
        "DIFFERENCE" ), SubLObjectFactory.makeSymbol( "&KEY" ), SubLObjectFactory.makeSymbol( "DONE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory
            .makeSymbol( "BODY" ) );
    $list125 = ConsesLow.list( SubLObjectFactory.makeKeyword( "DONE" ) );
    $kw126$DONE = SubLObjectFactory.makeKeyword( "DONE" );
    $sym127$DO_DICTIONARY = SubLObjectFactory.makeSymbol( "DO-DICTIONARY" );
    $list128 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "CONSTANT" ), SubLObjectFactory.makeSymbol( "DIFFERENCE" ), SubLObjectFactory.makeSymbol(
    ...
    $list130 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "NART" ), SubLObjectFactory.makeSymbol( "DIFFERENCE" ), SubLObjectFactory.makeSymbol(
        "&KEY" ), SubLObjectFactory.makeSymbol( "DONE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    $list131 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "ASSERTION" ), SubLObjectFactory.makeSymbol( "DIFFERENCE" ), SubLObjectFactory.makeSymbol(
        "&KEY" ), SubLObjectFactory.makeSymbol( "DONE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    $list132 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "DEDUCTION" ), SubLObjectFactory.makeSymbol( "DIFFERENCE" ), SubLObjectFactory.makeSymbol(
        "&KEY" ), SubLObjectFactory.makeSymbol( "DONE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    ...
    $list141 = ConsesLow.list( SubLObjectFactory.makeUninternedSymbol( "START" ), SubLObjectFactory.makeUninternedSymbol( "END" ), SubLObjectFactory.makeUninternedSymbol(
        "DELTA" ) );
    ...
    $list166 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "OLD-CONSTANT-COUNT" ) ) );
    $list167 = ConsesLow.list( SubLObjectFactory.makeSymbol( "MISSING-OLD-CONSTANT-INTERNAL-IDS" ) );
    ...
    $list172 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "OLD-NART-COUNT" ) ) );
    $list173 = ConsesLow.list( SubLObjectFactory.makeSymbol( "MISSING-OLD-NART-IDS" ) );
    $sym174$NART_ID_FROM_RECIPE = SubLObjectFactory.makeSymbol( "NART-ID-FROM-RECIPE" );
    $list175 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "OLD-ASSERTION-COUNT" ) ) );
    $list176 = ConsesLow.list( SubLObjectFactory.makeSymbol( "MISSING-OLD-ASSERTION-IDS" ) );
    $sym177$ASSERTION_ID_FROM_RECIPE = SubLObjectFactory.makeSymbol( "ASSERTION-ID-FROM-RECIPE" );
    $list178 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "OLD-DEDUCTION-COUNT" ) ) );
    $list179 = ConsesLow.list( SubLObjectFactory.makeSymbol( "MISSING-OLD-DEDUCTION-IDS" ) );
  ...
  public static final class $kb_intersection_native extends SubLStructNative
  {
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $kb_intersection_native.class, kb_compare.$sym18$KB_INTERSECTION, kb_compare.$sym19$KB_INTERSECTION_P, kb_compare.$list20, kb_compare.$list21, new String[] {
        "$remote_image", "$constant_index", "$nart_index", "$assertion_index", "$deduction_index"
      }, kb_compare.$list22, kb_compare.$list23, kb_compare.$sym24$PRINT_KB_INTERSECTION );
    }
  }
  ...
  public static final class $kb_difference_native extends SubLStructNative
  {
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $kb_difference_native.class, kb_compare.$sym88$KB_DIFFERENCE, kb_compare.$sym89$KB_DIFFERENCE_P, kb_compare.$list90, kb_compare.$list91, new String[] {
        "$common_intersection", "$renamed_constants", "$constants", "$narts", "$assertions", "$deductions"
      }, kb_compare.$list92, kb_compare.$list93, kb_compare.$sym94$PRINT_KB_DIFFERENCE );
    }
  }
