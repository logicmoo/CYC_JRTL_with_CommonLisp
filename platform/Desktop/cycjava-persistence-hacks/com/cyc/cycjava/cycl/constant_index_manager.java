...
public final class constant_index_manager extends SubLTranslatedFile
{
  ...
  @SubLTranslatedFile.SubL(
    source = "cycl/constant-index-manager.lisp",
    position = 1476L)
  ...
  {
    constant_index_manager.$constant_index_manager$.setGlobalValue( kb_object_manager.new_kb_object_manager( constant_index_manager.$str3$constant_index, size,
        constant_index_manager.$constant_index_lru_size_percentage$.getGlobalValue(), constant_index_manager.$constant_index_lru_size_max$.getGlobalValue(),
        constant_index_manager.$sym4$LOAD_CONSTANT_INDEX_FROM_CACHE, exactP ) );
    return constant_index_manager.T;
  }
  ...
  public static SubLObject resize_constant_index_kbom_lru(SubLObject percentage, SubLObject max)
  {
    ...
    {
      percentage = constant_index_manager.NIL;
    }
    if( max == constant_index_manager.UNPROVIDED )
    {
      max = constant_index_manager.NIL;
    }
  ...
  public static SubLObject lookup_constant_index(final SubLObject id)
  {
    ...
    try
    {
      kb_storage_logging.$kb_storage_client$.bind( kb_storage_logging.add_kb_storage_logging_add_tag( constant_index_manager.$kw5$CIM ), thread );
  ...
  public static SubLObject with_constant_index_fully_loaded(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.listS( constant_index_manager.$sym7$WITH_KBOM_FULLY_LOADED, constant_index_manager.$list8, ConsesLow.append( body, constant_index_manager.NIL ) );
  }
  ...
  {
    final SubLObject result = kb_object_manager.initialize_kb_object_hl_store_cache( constant_index_manager.$constant_index_manager$.getGlobalValue(), constant_index_manager.$str9$indices,
        constant_index_manager.$str10$indices_index, constant_index_manager.$str11$constant_complex_indices, constant_index_manager.$str12$constant_complex_indices_index );
    kb_storage_logging.register_kb_storage_logging_tag( kb_object_manager.kb_object_manager_file_vector( constant_index_manager.$constant_index_manager$.getGlobalValue() ),
        constant_index_manager.$str13$cim );
    ...
    {
      kb_storage_logging.register_kb_storage_logging_tag( sub_fvector, constant_index_manager.$str14$ccim );
      file_vector_utilities.register_indexical_file_vector_reference( constant_index_manager.$kw15$CONSTANT_INDEX, sub_fvector );
    }
    return result;
  }
  ...
  {
    SubLFiles.declareFunction( myName, "setup_constant_index_table", "SETUP-CONSTANT-INDEX-TABLE", 2, 0, false );
    SubLFiles.declareFunction( myName, "resize_constant_index_kbom_lru", "RESIZE-CONSTANT-INDEX-KBOM-LRU", 0, 2, false );
    SubLFiles.declareFunction( myName, "optimize_constant_index_table", "OPTIMIZE-CONSTANT-INDEX-TABLE", 1, 0, false );
    SubLFiles.declareFunction( myName, "clear_constant_index_table", "CLEAR-CONSTANT-INDEX-TABLE", 0, 0, false );
    SubLFiles.declareFunction( myName, "maintain_constant_index_usage_counts", "MAINTAIN-CONSTANT-INDEX-USAGE-COUNTS", 0, 0, false );
    SubLFiles.declareFunction( myName, "dont_maintain_constant_index_usage_counts", "DONT-MAINTAIN-CONSTANT-INDEX-USAGE-COUNTS", 0, 0, false );
    SubLFiles.declareFunction( myName, "constant_index_usage_counts_enabled_p", "CONSTANT-INDEX-USAGE-COUNTS-ENABLED-P", 0, 0, false );
    SubLFiles.declareFunction( myName, "cached_constant_index_count", "CACHED-CONSTANT-INDEX-COUNT", 0, 0, false );
    SubLFiles.declareFunction( myName, "constant_indices_completely_cachedP", "CONSTANT-INDICES-COMPLETELY-CACHED?", 0, 0, false );
    SubLFiles.declareFunction( myName, "lookup_constant_index", "LOOKUP-CONSTANT-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "constant_index_cachedP", "CONSTANT-INDEX-CACHED?", 1, 0, false );
    SubLFiles.declareFunction( myName, "get_file_backed_constant_internal_id_threshold", "GET-FILE-BACKED-CONSTANT-INTERNAL-ID-THRESHOLD", 0, 0, false );
    SubLFiles.declareFunction( myName, "new_muted_constant_index_iterator", "NEW-MUTED-CONSTANT-INDEX-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( myName, "constant_index_dont_maintain_usages_counts", "CONSTANT-INDEX-DONT-MAINTAIN-USAGES-COUNTS", 0, 0, false );
    SubLFiles.declareFunction( myName, "constant_index_maintain_usage_counts", "CONSTANT-INDEX-MAINTAIN-USAGE-COUNTS", 0, 0, false );
    SubLFiles.declareFunction( myName, "constant_index_usage_counts_enabledP", "CONSTANT-INDEX-USAGE-COUNTS-ENABLED?", 0, 0, false );
    SubLFiles.declareFunction( myName, "constant_indexchange_stream_buffer_sizes", "CONSTANT-INDEXCHANGE-STREAM-BUFFER-SIZES", 2, 0, false );
    SubLFiles.declareFunction( myName, "constant_index_enable_memory_mapping", "CONSTANT-INDEX-ENABLE-MEMORY-MAPPING", 0, 0, false );
    SubLFiles.declareFunction( myName, "constant_index_memory_mappedP", "CONSTANT-INDEX-MEMORY-MAPPED?", 0, 0, false );
    ...
    SubLFiles.declareFunction( myName, "register_constant_index", "REGISTER-CONSTANT-INDEX", 2, 0, false );
    SubLFiles.declareFunction( myName, "deregister_constant_index", "DEREGISTER-CONSTANT-INDEX", 1, 0, false );
    SubLFiles.declareFunction( myName, "mark_constant_index_as_muted", "MARK-CONSTANT-INDEX-AS-MUTED", 1, 0, false );
    SubLFiles.declareFunction( myName, "mark_constant_index_as_permanently_cached", "MARK-CONSTANT-INDEX-AS-PERMANENTLY-CACHED", 1, 0, false );
    SubLFiles.declareFunction( myName, "meter_constant_index_swap_time", "METER-CONSTANT-INDEX-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction( myName, "dont_meter_constant_index_swap_time", "DONT-METER-CONSTANT-INDEX-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction( myName, "clear_constant_index_swap_time", "CLEAR-CONSTANT-INDEX-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction( myName, "current_constant_index_swap_time", "CURRENT-CONSTANT-INDEX-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction( myName, "swap_out_all_pristine_constant_indices", "SWAP-OUT-ALL-PRISTINE-CONSTANT-INDICES", 0, 0, false );
    SubLFiles.declareFunction( myName, "initialize_constant_index_hl_store_cache", "INITIALIZE-CONSTANT-INDEX-HL-STORE-CACHE", 0, 0, false );
    SubLFiles.declareFunction( myName, "wide_constant_index_hl_store_cacheP", "WIDE-CONSTANT-INDEX-HL-STORE-CACHE?", 0, 0, false );
    SubLFiles.declareFunction( myName, "wide_constant_complex_index_hl_store_cacheP", "WIDE-CONSTANT-COMPLEX-INDEX-HL-STORE-CACHE?", 0, 0, false );
    return constant_index_manager.NIL;
  }

  public static SubLObject init_constant_index_manager_file()
  {
    constant_index_manager.$constant_index_manager$ = SubLFiles.deflexical( "*CONSTANT-INDEX-MANAGER*", ( maybeDefault( constant_index_manager.$sym0$_CONSTANT_INDEX_MANAGER_,
        constant_index_manager.$constant_index_manager$, constant_index_manager.$kw1$UNINITIALIZED ) ) );
    constant_index_manager.$constant_index_lru_size_percentage$ = SubLFiles.deflexical( "*CONSTANT-INDEX-LRU-SIZE-PERCENTAGE*", constant_index_manager.SIXTEEN_INTEGER );
    constant_index_manager.$constant_index_lru_size_max$ = SubLFiles.deflexical( "*CONSTANT-INDEX-LRU-SIZE-MAX*", constant_index_manager.$int2$20000 );
    return constant_index_manager.NIL;
  }

  public static SubLObject setup_constant_index_manager_file()
  {
    subl_macro_promotions.declare_defglobal( constant_index_manager.$sym0$_CONSTANT_INDEX_MANAGER_ );
    return constant_index_manager.NIL;
  }
  ...
  static
  {
    ...
    $list8 = ConsesLow.list( SubLObjectFactory.makeSymbol( "*CONSTANT-INDEX-MANAGER*" ) );
