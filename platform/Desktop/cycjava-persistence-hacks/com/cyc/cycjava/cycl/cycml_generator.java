      ...
      SubLTranslatedFile
{
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    print_high.print( supports, UNPROVIDED );
    cycml.emit_cycml_prologue( UNPROVIDED );
    if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
    {
      PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
      cycml.cycml_indent();
      final SubLObject name_var = $str7$justification;
      xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
      final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
      try
      {
  ...
  public static SubLObject cycml_serialize_truth(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str8$truth, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_nonnegativeinteger(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str12$nonnegativeinteger, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_positiveinteger(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str13$positiveinteger, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_date(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str15$date, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_time(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str16$time, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_sublsymbol(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str19$sublsymbol, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_sublstring(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str20$sublstring, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_sublrealnumber(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str21$sublrealnumber, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_cyclvariable(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str22$cyclvariable, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_uri(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str23$uri, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_namespace(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str24$namespace, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_false(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str25$false, body, attributes );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_true(final SubLObject body, SubLObject attributes)
  {
    ...
    cycml.cycml_serialize_primitive( $str26$true, body, attributes );
    return NIL;
  }
  ...
  {
    assert NIL != cycml_kp_info_p( v_object ) : v_object;
  ...
  public static SubLObject make_cycml_kp_info(SubLObject arglist)
  {
    ...
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      if( pcase_var.eql( $kw42$KNOWLEDGE_PACKAGE_ID ) )
      {
        _csetf_cycml_kp_info_knowledge_package_id( v_new, current_value );
      }
      else if( pcase_var.eql( $kw43$KNOWLEDGE_PACKAGE_DEPENDENCIES ) )
      {
        _csetf_cycml_kp_info_knowledge_package_dependencies( v_new, current_value );
      }
      else if( pcase_var.eql( $kw44$OPERATIONS ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw46$BEGIN, $sym47$MAKE_CYCML_KP_INFO, THREE_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw48$SLOT, $kw42$KNOWLEDGE_PACKAGE_ID, cycml_kp_info_knowledge_package_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw48$SLOT, $kw43$KNOWLEDGE_PACKAGE_DEPENDENCIES, cycml_kp_info_knowledge_package_dependencies( obj ) );
    Functions.funcall( visitor_fn, obj, $kw48$SLOT, $kw44$OPERATIONS, cycml_kp_info_operations( obj ) );
    Functions.funcall( visitor_fn, obj, $kw49$END, $sym47$MAKE_CYCML_KP_INFO, THREE_INTEGER );
    return obj;
  }
  ...
  {
    streams_high.write_string( $str51$__CYCML_KP_INFO_, stream, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject cycml_add_create_constant_oper(final SubLObject cycml_kp_info, final SubLObject constant, SubLObject cyclist, SubLObject cyc_image_id, SubLObject operation_time, SubLObject operation_second,
      SubLObject purpose)
  {
    ...
    assert NIL != cycml_kp_info_p( cycml_kp_info ) : cycml_kp_info;
    assert NIL != cycl_grammar.cycl_constant_p( constant ) : constant;
    if( NIL != cyclist && !assertionsDisabledInClass && NIL == cycl_grammar.cycl_fort_p( cyclist ) )
    {
      throw new AssertionError( cyclist );
    }
    if( NIL != cyc_image_id && !assertionsDisabledInClass && NIL == Types.stringp( cyc_image_id ) )
    {
      throw new AssertionError( cyc_image_id );
    }
    if( NIL != operation_time && !assertionsDisabledInClass && NIL == Types.integerp( operation_time ) )
    {
      throw new AssertionError( operation_time );
    }
    if( NIL != operation_second && !assertionsDisabledInClass && NIL == Types.integerp( operation_second ) )
    {
      throw new AssertionError( operation_second );
    }
    if( NIL != purpose && !assertionsDisabledInClass && NIL == cycl_grammar.cycl_fort_p( purpose ) )
    {
      throw new AssertionError( purpose );
    }
    SubLObject operations = cycml_kp_info_operations( cycml_kp_info );
    operations = ConsesLow.cons( ConsesLow.list( $kw54$CREATE, constant, cyclist, cyc_image_id, operation_time, operation_second, purpose ), operations );
  ...
  public static SubLObject cycml_add_find_or_create_constant_oper(final SubLObject cycml_kp_info, final SubLObject constant, SubLObject cyclist, SubLObject cyc_image_id, SubLObject operation_time,
      SubLObject operation_second, SubLObject purpose)
  {
    if( cyclist == UNPROVIDED )
    {
      cyclist = NIL;
    ...
    SubLObject operations = cycml_kp_info_operations( cycml_kp_info );
    operations = ConsesLow.cons( ConsesLow.list( $kw55$FIND_OR_CREATE, constant, cyclist, cyc_image_id, operation_time, operation_second, purpose ), operations );
    _csetf_cycml_kp_info_operations( cycml_kp_info, operations );
    return NIL;
  }
  ...
  public static SubLObject cycml_add_rename_constant_oper(final SubLObject cycml_kp_info, final SubLObject constant, final SubLObject new_name, SubLObject cyc_image_id, SubLObject operation_time)
  {
    ...
    assert NIL != cycml_kp_info_p( cycml_kp_info ) : cycml_kp_info;
    assert NIL != cycl_grammar.cycl_constant_p( constant ) : constant;
    assert NIL != constant_completion_high.valid_constant_name_p( new_name ) : new_name;
    if( NIL != cyc_image_id && !assertionsDisabledInClass && NIL == Types.stringp( cyc_image_id ) )
    {
      throw new AssertionError( cyc_image_id );
    }
    ...
    SubLObject operations = cycml_kp_info_operations( cycml_kp_info );
    operations = ConsesLow.cons( ConsesLow.list( $kw57$RENAME, constant, new_name, cyc_image_id, operation_time ), operations );
    _csetf_cycml_kp_info_operations( cycml_kp_info, operations );
    return NIL;
  }
  ...
  public static SubLObject cycml_add_merge_fort_oper(final SubLObject cycml_kp_info, final SubLObject fort_1, final SubLObject fort_2, SubLObject cyc_image_id, SubLObject operation_time)
  {
    ...
    assert NIL != cycml_kp_info_p( cycml_kp_info ) : cycml_kp_info;
    assert NIL != cycl_grammar.cycl_fort_p( fort_1 ) : fort_1;
    assert NIL != cycl_grammar.cycl_fort_p( fort_2 ) : fort_2;
    if( NIL != cyc_image_id && !assertionsDisabledInClass && NIL == Types.stringp( cyc_image_id ) )
    {
      throw new AssertionError( cyc_image_id );
    }
    ...
    SubLObject operations = cycml_kp_info_operations( cycml_kp_info );
    operations = ConsesLow.cons( ConsesLow.list( $kw58$MERGE, fort_1, fort_2, cyc_image_id, operation_time ), operations );
    _csetf_cycml_kp_info_operations( cycml_kp_info, operations );
    return NIL;
  }
  ...
  public static SubLObject cycml_add_kill_fort_oper(final SubLObject cycml_kp_info, final SubLObject fort, SubLObject cyclist, SubLObject cyc_image_id, SubLObject operation_time)
  {
    ...
    assert NIL != cycml_kp_info_p( cycml_kp_info ) : cycml_kp_info;
    assert NIL != cycl_grammar.cycl_fort_p( fort ) : fort;
    if( NIL != cyclist && !assertionsDisabledInClass && NIL == cycl_grammar.cycl_fort_p( cyclist ) )
    {
      throw new AssertionError( cyclist );
    }
    ...
    SubLObject operations = cycml_kp_info_operations( cycml_kp_info );
    operations = ConsesLow.cons( ConsesLow.list( $kw59$KILL, fort, cyclist, cyc_image_id, operation_time ), operations );
    _csetf_cycml_kp_info_operations( cycml_kp_info, operations );
    return NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/cycml-generator.lisp", position = 9965L)
  public static SubLObject cycml_add_assert_oper(final SubLObject cycml_kp_info, final SubLObject assertion, SubLObject mt, SubLObject strength, SubLObject direction, SubLObject cyclist, SubLObject cyc_image_id,
      SubLObject operation_time, SubLObject operation_second, SubLObject purpose)
  {
    if( mt == UNPROVIDED )
    {
      mt = NIL;
    ...
    assert NIL != cycml_kp_info_p( cycml_kp_info ) : cycml_kp_info;
    assert NIL != cycl_grammar.cycl_sentence_p( assertion ) : assertion;
    if( NIL != mt && !assertionsDisabledInClass && NIL == cycl_grammar.cycl_fort_p( mt ) )
    {
      throw new AssertionError( mt );
    }
    if( NIL != strength && !assertionsDisabledInClass && NIL == enumeration_types.el_strength_p( strength ) )
    {
      throw new AssertionError( strength );
    }
    if( NIL != direction && !assertionsDisabledInClass && NIL == enumeration_types.direction_p( direction ) )
    {
    ...
    SubLObject operations = cycml_kp_info_operations( cycml_kp_info );
    operations = ConsesLow.cons( ConsesLow.list( new SubLObject[] { $kw63$ASSERT, assertion, mt, strength, direction, cyclist, cyc_image_id, operation_time, operation_second, purpose
    } ), operations );
    _csetf_cycml_kp_info_operations( cycml_kp_info, operations );
    return NIL;
  }
  ...
  public static SubLObject cycml_add_reassert_oper(final SubLObject cycml_kp_info, final SubLObject assertion, SubLObject mt, SubLObject strength, SubLObject direction, SubLObject cyclist, SubLObject cyc_image_id,
      SubLObject operation_time, SubLObject operation_second, SubLObject purpose)
  {
    if( mt == UNPROVIDED )
    {
    ...
    SubLObject operations = cycml_kp_info_operations( cycml_kp_info );
    operations = ConsesLow.cons( ConsesLow.list( new SubLObject[] { $kw64$REASSERT, assertion, mt, strength, direction, cyclist, cyc_image_id, operation_time, operation_second, purpose
    } ), operations );
    _csetf_cycml_kp_info_operations( cycml_kp_info, operations );
    return NIL;
  }
  ...
  public static SubLObject cycml_add_unassert_oper(final SubLObject cycml_kp_info, final SubLObject assertion, SubLObject mt, SubLObject cyclist, SubLObject cyc_image_id, SubLObject operation_time)
  {
    ...
    SubLObject operations = cycml_kp_info_operations( cycml_kp_info );
    operations = ConsesLow.cons( ConsesLow.list( $kw65$UNASSERT, assertion, mt, cyclist, cyc_image_id, operation_time ), operations );
    _csetf_cycml_kp_info_operations( cycml_kp_info, operations );
    return NIL;
  }
  ...
  public static SubLObject cycml_add_blast_assertion_oper(final SubLObject cycml_kp_info, final SubLObject assertion, SubLObject mt, SubLObject cyclist, SubLObject cyc_image_id, SubLObject operation_time)
  {
    ...
    SubLObject operations = cycml_kp_info_operations( cycml_kp_info );
    operations = ConsesLow.cons( ConsesLow.list( $kw66$BLAST, assertion, mt, cyclist, cyc_image_id, operation_time ), operations );
    _csetf_cycml_kp_info_operations( cycml_kp_info, operations );
    return NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/cycml-generator.lisp", position = 17645L)
  public static SubLObject cycml_add_create_skolem_oper(final SubLObject cycml_kp_info, final SubLObject external_id, final SubLObject unreified_sk_term, final SubLObject mt, final SubLObject cnfs,
      final SubLObject arg_types, final SubLObject cyclist, final SubLObject cyc_image_id, final SubLObject operation_time)
  {
    assert NIL != cycml_kp_info_p( cycml_kp_info ) : cycml_kp_info;
    assert NIL != constants_high.constant_external_id_p( external_id ) : external_id;
    assert NIL != Types.consp( unreified_sk_term ) : unreified_sk_term;
    assert NIL != cycl_grammar.cycl_fort_p( mt ) : mt;
    assert NIL != Types.listp( cnfs ) : cnfs;
    assert NIL != Types.listp( arg_types ) : arg_types;
    if( NIL != cyclist && !assertionsDisabledInClass && NIL == cycl_grammar.cycl_fort_p( cyclist ) )
    {
      throw new AssertionError( cyclist );
    }
    ...
    SubLObject operations = cycml_kp_info_operations( cycml_kp_info );
    operations = ConsesLow.cons( ConsesLow.list( new SubLObject[] { $kw69$CREATE_SKOLEM, external_id, unreified_sk_term, mt, cnfs, arg_types, cyclist, cyc_image_id, operation_time
    } ), operations );
    _csetf_cycml_kp_info_operations( cycml_kp_info, operations );
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_knowledge_package(final SubLObject cycml_kp_info)
  {
    ...
    if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
    {
      PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
      cycml.cycml_indent();
      final SubLObject name_var = $str70$cycml;
      xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
      final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
      try
      {
        ...
        try
        {
          ...
          if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
          {
            PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
            cycml.cycml_indent();
            final SubLObject name_var_$12 = $str73$operations;
  ...
  public static SubLObject cycml_serialize_create_constant_oper(final SubLObject parms)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( parms, parms, $list74 );
    constant = parms.first();
    SubLObject current = parms.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, parms, $list74 );
    ...
    if( NIL == current )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str75$create;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( parms, $list74 );
    }
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_rename_constant_oper(final SubLObject parms)
  {
    ...
    SubLObject cyc_image_id = NIL;
    SubLObject operation_time = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( parms, parms, $list77 );
    constant = parms.first();
    SubLObject current = parms.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, parms, $list77 );
    ...
    if( NIL == current )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str78$rename;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( parms, $list77 );
    }
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_merge_forts_oper(final SubLObject parms)
  {
    ...
    SubLObject cyc_image_id = NIL;
    SubLObject operation_time = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( parms, parms, $list79 );
    fort_1 = parms.first();
    SubLObject current = parms.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, parms, $list79 );
    ...
    if( NIL == current )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str80$merge;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( parms, $list79 );
    }
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_kill_fort_oper(final SubLObject parms)
  {
    ...
    SubLObject cyc_image_id = NIL;
    SubLObject operation_time = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( parms, parms, $list81 );
    fort = parms.first();
    SubLObject current = parms.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, parms, $list81 );
    cyclist = current.first();
    current = current.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, parms, $list81 );
    cyc_image_id = current.first();
    ...
    if( NIL == current )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str82$kill;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( parms, $list81 );
    }
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_assert_oper(final SubLObject parms)
  {
    ...
    SubLObject operation_second = NIL;
    SubLObject purpose = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( parms, parms, $list83 );
    assertion = parms.first();
    SubLObject current = parms.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, parms, $list83 );
    mt = current.first();
    current = current.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, parms, $list83 );
    ...
    if( NIL == current )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str84$assert;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( parms, $list83 );
    }
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_reassert_oper(final SubLObject parms)
  {
    ...
    if( NIL == current )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str86$reassert;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
  ...
  public static SubLObject cycml_serialize_unassert_oper(final SubLObject parms)
  {
    ...
    SubLObject cyc_image_id = NIL;
    SubLObject operation_time = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( parms, parms, $list87 );
    assertion = parms.first();
    SubLObject current = parms.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, parms, $list87 );
    mt = current.first();
    current = current.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, parms, $list87 );
    cyclist = current.first();
    ...
    if( NIL == current )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str88$unassert;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( parms, $list87 );
    }
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_blast_assertion_oper(final SubLObject parms)
  {
    ...
    if( NIL == current )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str89$blast;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
  ...
  public static SubLObject cycml_serialize_create_skolem_oper(final SubLObject parms)
  {
    ...
    SubLObject cyc_image_id = NIL;
    SubLObject operation_time = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( parms, parms, $list90 );
    external_id = parms.first();
    SubLObject current = parms.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, parms, $list90 );
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( parms, $list90 );
    }
    return NIL;
  }
  ...
  public static SubLObject cycml_serialize_bookkeeping(final SubLObject cyclist, final SubLObject cyc_image_id, final SubLObject operation_time, final SubLObject operation_second, final SubLObject purpose)
  {
    ...
    if( NIL != operation_second && !assertionsDisabledInClass && NIL == numeric_date_utilities.universal_second_p( operation_second ) )
    {
      throw new AssertionError( operation_second );
    }
    if( NIL != purpose && !assertionsDisabledInClass && NIL == cycl_grammar.cycl_fort_p( purpose ) )
      ...
      try
      {
        ...
        try
        {
          ...
          if( NIL != cyclist && NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
          {
            PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
            cycml.cycml_indent();
            final SubLObject name_var_$39 = $str97$Cyclist;
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != cycl_grammar.cycl_fort_p( el_or_hl_fort ) : el_or_hl_fort;
    if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
    {
      PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
      cycml.cycml_indent();
      final SubLObject name_var = $str98$Microtheory;
      xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
      final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
      try
      {
  ...
  public static SubLObject cycml_serialize_fort(final SubLObject el_or_hl_fort)
  {
    ...
    else if( NIL != nart_handles.nart_p( el_or_hl_fort ) )
    {
  ...
  public static SubLObject cycml_serialize_cyclconstant(final SubLObject constant)
  {
    ...
    if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
    {
      PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
      cycml.cycml_indent();
      final SubLObject name_var = $str99$CycLConstant;
      xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
      final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
      try
      {
        ...
        try
        {
          ...
          cycml_serialize_uri( Sequences.cconcatenate( $str100$urn_uuid_, Guids.guid_to_string( constants_high.constant_guid( constant ) ) ), UNPROVIDED );
        }
        finally
        {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != cycl_grammar.cycl_nart_p( el_or_hl_nart ) : el_or_hl_nart;
    ...
    if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
    {
      PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
      cycml.cycml_indent();
      final SubLObject name_var = $str103$CycLReifiedNonAtomicTerm;
      xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
      final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
      try
      {
  ...
  public static SubLObject cycml_serialize_cyclreifiablenonatomicterm(final SubLObject el_or_hl_nart)
  {
    ...
    if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
    {
      PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
      cycml.cycml_indent();
      final SubLObject name_var = $str106$CycLReifiableNonAtomicTerm;
      xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
      final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
      try
      {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != cycl_grammar.cycl_nat_p( el_nat ) : el_nat;
    if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
    {
      PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
      cycml.cycml_indent();
      final SubLObject name_var = $str108$ELNonAtomicTerm;
      xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
      final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
      try
      {
  ...
  public static SubLObject within_cycl_atomic_sentence(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.listS( $sym109$CLET, $list110, ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject cycml_serialize_object(final SubLObject obj)
  {
    ...
    else if( obj.eql( $const111$True ) )
    {
      cycml_serialize_true( $str112$, UNPROVIDED );
    }
    else if( obj.eql( $const113$False ) )
    {
      cycml_serialize_false( $str112$, UNPROVIDED );
    }
    else if( NIL != cycl_grammar.cycl_constant_p( obj ) )
    {
      cycml_serialize_cyclconstant( obj );
    }
    else if( !obj.isList() && NIL != cycl_grammar.cycl_nat_p( obj ) )
    {
    ...
    else if( obj.isList() && NIL != el_grammar.el_sentence_p( obj ) )
    {
  ...
  public static SubLObject cycml_serialize_subllist(final SubLObject list)
  {
    ...
    if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
    {
      PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
      cycml.cycml_indent();
      final SubLObject name_var = $str116$SubLList;
      xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
      final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
      try
      {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != cycl_grammar.cycl_sentence_p( el_or_hl_formula ) : el_or_hl_formula;
    final SubLObject arg0 = cycl_utilities.cycl_formula_arg0( el_or_hl_formula );
    if( arg0.eql( $const118$not ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str119$not;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    else if( arg0.eql( $const120$and ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str121$and;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    else if( arg0.eql( $const122$or ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str123$or;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    else if( arg0.eql( $const124$xor ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str125$xor;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    else if( arg0.eql( $const126$implies ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str127$implies;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    else if( arg0.eql( $const128$equiv ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str129$equiv;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    else if( arg0.eql( $const130$forAll ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str131$forAll;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    else if( arg0.eql( $const132$thereExists ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str133$thereExists;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    else if( arg0.eql( $const134$thereExistExactly ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str135$thereExistExactly;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    else if( arg0.eql( $const136$thereExistAtMost ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str137$thereExistAtMost;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
    ...
    else if( arg0.eql( $const138$thereExistAtLeast ) )
    {
      if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str139$thereExistAtLeast;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
        try
        {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != cycl_grammar.cycl_atomic_sentence_p( el_or_hl_atomic_sentence ) : el_or_hl_atomic_sentence;
    ...
    try
    {
      ...
      if( NIL != isa.isaP( pred, $const141$OpenCycDefinitionalPredicate, UNPROVIDED, UNPROVIDED ) )
      {
        if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
        {
          PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
      ...
      else if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
      {
        PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
        cycml.cycml_indent();
        final SubLObject name_var = $str142$CycLAtomicSentence;
        xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
        ...
        try
        {
          ...
          try
          {
            ...
            if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
            {
              PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
              cycml.cycml_indent();
              final SubLObject name_var_$84 = $str143$Predicate;
  ...
  public static SubLObject cycml_serialize_purpose(final SubLObject purpose)
  {
    ...
    if( NIL != cycml.$cycml_indent_mode_on$.getDynamicValue( thread ) )
    {
      PrintLow.format( xml_vars.$xml_stream$.getDynamicValue( thread ), $str3$__ );
      cycml.cycml_indent();
      final SubLObject name_var = $str144$purpose;
      xml_utilities.xml_start_tag_internal( name_var, NIL, NIL, NIL, xml_vars.cycml_namespace() );
      final SubLObject _prev_bind_0 = xml_vars.$xml_default_namespace$.currentBinding( thread );
      try
      {
  ...
  public static SubLObject cycml_serialize_universal_date(final SubLObject universal_date)
  {
    ...
    thread.resetMultipleValues();
    final SubLObject formatted_date = PrintLow.format( NIL, $str145$_A__A__A, new SubLObject[] { year, month, day
    } );
  ...
  {
    assert NIL != numeric_date_utilities.universal_second_p( universal_second ) : universal_second;
    final SubLObject formatted_second = PrintLow.format( NIL, $str146$_6__0D, universal_second );
  ...
  {
    SubLFiles.declareFunction(me, "cycml_serialize_knowledge_package_info", "CYCML-SERIALIZE-KNOWLEDGE-PACKAGE-INFO", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_api_request", "CYCML-SERIALIZE-API-REQUEST", 5, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_justification", "CYCML-SERIALIZE-JUSTIFICATION", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_truth", "CYCML-SERIALIZE-TRUTH", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_api_request_requestor", "CYCML-SERIALIZE-API-REQUEST-REQUESTOR", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_api_request_priority", "CYCML-SERIALIZE-API-REQUEST-PRIORITY", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_api_request_id", "CYCML-SERIALIZE-API-REQUEST-ID", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_nonnegativeinteger", "CYCML-SERIALIZE-NONNEGATIVEINTEGER", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_positiveinteger", "CYCML-SERIALIZE-POSITIVEINTEGER", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_new_name", "CYCML-SERIALIZE-NEW-NAME", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_date", "CYCML-SERIALIZE-DATE", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_time", "CYCML-SERIALIZE-TIME", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_cyc_image_id", "CYCML-SERIALIZE-CYC-IMAGE-ID", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_knowledge_package_id", "CYCML-SERIALIZE-KNOWLEDGE-PACKAGE-ID", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_sublsymbol", "CYCML-SERIALIZE-SUBLSYMBOL", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_sublstring", "CYCML-SERIALIZE-SUBLSTRING", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_sublrealnumber", "CYCML-SERIALIZE-SUBLREALNUMBER", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_cyclvariable", "CYCML-SERIALIZE-CYCLVARIABLE", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_uri", "CYCML-SERIALIZE-URI", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_namespace", "CYCML-SERIALIZE-NAMESPACE", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_false", "CYCML-SERIALIZE-FALSE", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_serialize_true", "CYCML-SERIALIZE-TRUE", 1, 1, false );
    SubLFiles.declareFunction(me, "cycml_kp_info_print_function_trampoline", "CYCML-KP-INFO-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction(me, "cycml_kp_info_p", "CYCML-KP-INFO-P", 1, 0, false );
    new $cycml_kp_info_p$UnaryFunction();
    SubLFiles.declareFunction(me, "cycml_kp_info_knowledge_package_id", "CYCML-KP-INFO-KNOWLEDGE-PACKAGE-ID", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_kp_info_knowledge_package_dependencies", "CYCML-KP-INFO-KNOWLEDGE-PACKAGE-DEPENDENCIES", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_kp_info_operations", "CYCML-KP-INFO-OPERATIONS", 1, 0, false );
    SubLFiles.declareFunction(me, "_csetf_cycml_kp_info_knowledge_package_id", "_CSETF-CYCML-KP-INFO-KNOWLEDGE-PACKAGE-ID", 2, 0, false );
    SubLFiles.declareFunction(me, "_csetf_cycml_kp_info_knowledge_package_dependencies", "_CSETF-CYCML-KP-INFO-KNOWLEDGE-PACKAGE-DEPENDENCIES", 2, 0, false );
    SubLFiles.declareFunction(me, "_csetf_cycml_kp_info_operations", "_CSETF-CYCML-KP-INFO-OPERATIONS", 2, 0, false );
    SubLFiles.declareFunction(me, "make_cycml_kp_info", "MAKE-CYCML-KP-INFO", 0, 1, false );
    SubLFiles.declareFunction(me, "visit_defstruct_cycml_kp_info", "VISIT-DEFSTRUCT-CYCML-KP-INFO", 2, 0, false );
    SubLFiles.declareFunction(me, "visit_defstruct_object_cycml_kp_info_method", "VISIT-DEFSTRUCT-OBJECT-CYCML-KP-INFO-METHOD", 2, 0, false );
    SubLFiles.declareFunction(me, "print_cycml_kp_info", "PRINT-CYCML-KP-INFO", 3, 0, false );
    SubLFiles.declareFunction(me, "cycml_add_create_constant_oper", "CYCML-ADD-CREATE-CONSTANT-OPER", 2, 5, false );
    SubLFiles.declareFunction(me, "cycml_add_find_or_create_constant_oper", "CYCML-ADD-FIND-OR-CREATE-CONSTANT-OPER", 2, 5, false );
    SubLFiles.declareFunction(me, "cycml_add_rename_constant_oper", "CYCML-ADD-RENAME-CONSTANT-OPER", 3, 2, false );
    SubLFiles.declareFunction(me, "cycml_add_merge_fort_oper", "CYCML-ADD-MERGE-FORT-OPER", 3, 2, false );
    SubLFiles.declareFunction(me, "cycml_add_kill_fort_oper", "CYCML-ADD-KILL-FORT-OPER", 2, 3, false );
    SubLFiles.declareFunction(me, "cycml_add_assert_oper", "CYCML-ADD-ASSERT-OPER", 2, 8, false );
    SubLFiles.declareFunction(me, "cycml_add_reassert_oper", "CYCML-ADD-REASSERT-OPER", 2, 8, false );
    SubLFiles.declareFunction(me, "cycml_add_unassert_oper", "CYCML-ADD-UNASSERT-OPER", 2, 4, false );
    SubLFiles.declareFunction(me, "cycml_add_blast_assertion_oper", "CYCML-ADD-BLAST-ASSERTION-OPER", 2, 4, false );
    SubLFiles.declareFunction(me, "cycml_add_create_skolem_oper", "CYCML-ADD-CREATE-SKOLEM-OPER", 9, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_knowledge_package", "CYCML-SERIALIZE-KNOWLEDGE-PACKAGE", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_operation", "CYCML-SERIALIZE-OPERATION", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_create_constant_oper", "CYCML-SERIALIZE-CREATE-CONSTANT-OPER", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_find_or_create_constant_oper", "CYCML-SERIALIZE-FIND-OR-CREATE-CONSTANT-OPER", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_rename_constant_oper", "CYCML-SERIALIZE-RENAME-CONSTANT-OPER", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_merge_forts_oper", "CYCML-SERIALIZE-MERGE-FORTS-OPER", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_kill_fort_oper", "CYCML-SERIALIZE-KILL-FORT-OPER", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_assert_oper", "CYCML-SERIALIZE-ASSERT-OPER", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_reassert_oper", "CYCML-SERIALIZE-REASSERT-OPER", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_unassert_oper", "CYCML-SERIALIZE-UNASSERT-OPER", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_blast_assertion_oper", "CYCML-SERIALIZE-BLAST-ASSERTION-OPER", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_create_skolem_oper", "CYCML-SERIALIZE-CREATE-SKOLEM-OPER", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_bookkeeping", "CYCML-SERIALIZE-BOOKKEEPING", 5, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_microtheory", "CYCML-SERIALIZE-MICROTHEORY", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_fort", "CYCML-SERIALIZE-FORT", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_cyclconstant", "CYCML-SERIALIZE-CYCLCONSTANT", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_cyclreifiednonatomicterm", "CYCML-SERIALIZE-CYCLREIFIEDNONATOMICTERM", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_cyclreifiablenonatomicterm", "CYCML-SERIALIZE-CYCLREIFIABLENONATOMICTERM", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_elnonatomicterm", "CYCML-SERIALIZE-ELNONATOMICTERM", 1, 0, false );
    SubLFiles.declareMacro(me, "within_cycl_atomic_sentence", "WITHIN-CYCL-ATOMIC-SENTENCE" );
    SubLFiles.declareFunction(me, "cycml_serialize_object", "CYCML-SERIALIZE-OBJECT", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_object_to_string", "CYCML-SERIALIZE-OBJECT-TO-STRING", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_subllist", "CYCML-SERIALIZE-SUBLLIST", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_cyclsentence", "CYCML-SERIALIZE-CYCLSENTENCE", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_cyclatomicsentence", "CYCML-SERIALIZE-CYCLATOMICSENTENCE", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_purpose", "CYCML-SERIALIZE-PURPOSE", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_universal_date", "CYCML-SERIALIZE-UNIVERSAL-DATE", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_universal_second", "CYCML-SERIALIZE-UNIVERSAL-SECOND", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_support", "CYCML-SERIALIZE-SUPPORT", 1, 0, false );
    SubLFiles.declareFunction(me, "cycml_serialize_hl_support", "CYCML-SERIALIZE-HL-SUPPORT", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_cycml_generator_file()
  {
    $dtp_cycml_kp_info$ = SubLFiles.defconstant( "*DTP-CYCML-KP-INFO*", $sym27$CYCML_KP_INFO );
    $within_cycl_atomic_sentenceP$ = SubLFiles.defparameter( "*WITHIN-CYCL-ATOMIC-SENTENCE?*", NIL );
    return NIL;
  }
  ...
  public static SubLObject setup_cycml_generator_file()
  {
    ...
    Structures.def_csetf( $sym36$CYCML_KP_INFO_KNOWLEDGE_PACKAGE_ID, $sym37$_CSETF_CYCML_KP_INFO_KNOWLEDGE_PACKAGE_ID );
    Structures.def_csetf( $sym38$CYCML_KP_INFO_KNOWLEDGE_PACKAGE_DEPENDENCIES, $sym39$_CSETF_CYCML_KP_INFO_KNOWLEDGE_PACKAGE_DEPENDENCIES );
    Structures.def_csetf( $sym40$CYCML_KP_INFO_OPERATIONS, $sym41$_CSETF_CYCML_KP_INFO_OPERATIONS );
    Equality.identity( $sym27$CYCML_KP_INFO );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_cycml_kp_info$.getGlobalValue(), Symbols.symbol_function( $sym50$VISIT_DEFSTRUCT_OBJECT_CYCML_KP_INFO_METHOD ) );
    access_macros.register_external_symbol( $sym115$CYCML_SERIALIZE_OBJECT_TO_STRING );
    return NIL;
  }
  ...
  static
  {
    me = new cycml_generator();
    $dtp_cycml_kp_info$ = null;
    $within_cycl_atomic_sentenceP$ = null;
    $sym0$CONSP = makeSymbol( "CONSP" );
    $sym1$INTEGERP = makeSymbol( "INTEGERP" );
    $sym2$STRINGP = makeSymbol( "STRINGP" );
    $str3$__ = makeString( "~&" );
    $str4$api_request_message = makeString( "api-request-message" );
    $str5$api_request = makeString( "api-request" );
    $str6$api_request_bindings = makeString( "api-request-bindings" );
    $str7$justification = makeString( "justification" );
    $str8$truth = makeString( "truth" );
    $str9$api_request_requestor = makeString( "api-request-requestor" );
    $str10$api_request_priority = makeString( "api-request-priority" );
    $str11$api_request_id = makeString( "api-request-id" );
    $str12$nonnegativeinteger = makeString( "nonnegativeinteger" );
    $str13$positiveinteger = makeString( "positiveinteger" );
    $str14$new_name = makeString( "new-name" );
    $str15$date = makeString( "date" );
    $str16$time = makeString( "time" );
    $str17$cyc_image_id = makeString( "cyc-image-id" );
    $str18$knowledge_package_id = makeString( "knowledge-package-id" );
    $str19$sublsymbol = makeString( "sublsymbol" );
    $str20$sublstring = makeString( "sublstring" );
    $str21$sublrealnumber = makeString( "sublrealnumber" );
    $str22$cyclvariable = makeString( "cyclvariable" );
    $str23$uri = makeString( "uri" );
    $str24$namespace = makeString( "namespace" );
    $str25$false = makeString( "false" );
    $str26$true = makeString( "true" );
    $sym27$CYCML_KP_INFO = makeSymbol( "CYCML-KP-INFO" );
    $sym28$CYCML_KP_INFO_P = makeSymbol( "CYCML-KP-INFO-P" );
    $list29 = ConsesLow.list( makeSymbol( "KNOWLEDGE-PACKAGE-ID" ), makeSymbol( "KNOWLEDGE-PACKAGE-DEPENDENCIES" ), makeSymbol( "OPERATIONS" ) );
    $list30 = ConsesLow.list( makeKeyword( "KNOWLEDGE-PACKAGE-ID" ), makeKeyword( "KNOWLEDGE-PACKAGE-DEPENDENCIES" ), makeKeyword( "OPERATIONS" ) );
    $list31 = ConsesLow.list( makeSymbol( "CYCML-KP-INFO-KNOWLEDGE-PACKAGE-ID" ), makeSymbol( "CYCML-KP-INFO-KNOWLEDGE-PACKAGE-DEPENDENCIES" ), makeSymbol( "CYCML-KP-INFO-OPERATIONS" ) );
    $list32 = ConsesLow.list( makeSymbol( "_CSETF-CYCML-KP-INFO-KNOWLEDGE-PACKAGE-ID" ), makeSymbol( "_CSETF-CYCML-KP-INFO-KNOWLEDGE-PACKAGE-DEPENDENCIES" ), makeSymbol( "_CSETF-CYCML-KP-INFO-OPERATIONS" ) );
    $sym33$PRINT_CYCML_KP_INFO = makeSymbol( "PRINT-CYCML-KP-INFO" );
    $sym34$CYCML_KP_INFO_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "CYCML-KP-INFO-PRINT-FUNCTION-TRAMPOLINE" );
    $list35 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "CYCML-KP-INFO-P" ) );
    $sym36$CYCML_KP_INFO_KNOWLEDGE_PACKAGE_ID = makeSymbol( "CYCML-KP-INFO-KNOWLEDGE-PACKAGE-ID" );
    $sym37$_CSETF_CYCML_KP_INFO_KNOWLEDGE_PACKAGE_ID = makeSymbol( "_CSETF-CYCML-KP-INFO-KNOWLEDGE-PACKAGE-ID" );
    $sym38$CYCML_KP_INFO_KNOWLEDGE_PACKAGE_DEPENDENCIES = makeSymbol( "CYCML-KP-INFO-KNOWLEDGE-PACKAGE-DEPENDENCIES" );
    $sym39$_CSETF_CYCML_KP_INFO_KNOWLEDGE_PACKAGE_DEPENDENCIES = makeSymbol( "_CSETF-CYCML-KP-INFO-KNOWLEDGE-PACKAGE-DEPENDENCIES" );
    $sym40$CYCML_KP_INFO_OPERATIONS = makeSymbol( "CYCML-KP-INFO-OPERATIONS" );
    $sym41$_CSETF_CYCML_KP_INFO_OPERATIONS = makeSymbol( "_CSETF-CYCML-KP-INFO-OPERATIONS" );
    $kw42$KNOWLEDGE_PACKAGE_ID = makeKeyword( "KNOWLEDGE-PACKAGE-ID" );
    $kw43$KNOWLEDGE_PACKAGE_DEPENDENCIES = makeKeyword( "KNOWLEDGE-PACKAGE-DEPENDENCIES" );
    $kw44$OPERATIONS = makeKeyword( "OPERATIONS" );
    $str45$Invalid_slot__S_for_construction_ = makeString( "Invalid slot ~S for construction function" );
    $kw46$BEGIN = makeKeyword( "BEGIN" );
    $sym47$MAKE_CYCML_KP_INFO = makeSymbol( "MAKE-CYCML-KP-INFO" );
    $kw48$SLOT = makeKeyword( "SLOT" );
    $kw49$END = makeKeyword( "END" );
    $sym50$VISIT_DEFSTRUCT_OBJECT_CYCML_KP_INFO_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-CYCML-KP-INFO-METHOD" );
    $str51$__CYCML_KP_INFO_ = makeString( "#<CYCML-KP-INFO:" );
    $sym52$CYCL_CONSTANT_P = makeSymbol( "CYCL-CONSTANT-P" );
    $sym53$CYCL_FORT_P = makeSymbol( "CYCL-FORT-P" );
    $kw54$CREATE = makeKeyword( "CREATE" );
    $kw55$FIND_OR_CREATE = makeKeyword( "FIND-OR-CREATE" );
    $sym56$VALID_CONSTANT_NAME_P = makeSymbol( "VALID-CONSTANT-NAME-P" );
    $kw57$RENAME = makeKeyword( "RENAME" );
    $kw58$MERGE = makeKeyword( "MERGE" );
    $kw59$KILL = makeKeyword( "KILL" );
    $sym60$CYCL_SENTENCE_P = makeSymbol( "CYCL-SENTENCE-P" );
    $sym61$EL_STRENGTH_P = makeSymbol( "EL-STRENGTH-P" );
    $sym62$DIRECTION_P = makeSymbol( "DIRECTION-P" );
    $kw63$ASSERT = makeKeyword( "ASSERT" );
    $kw64$REASSERT = makeKeyword( "REASSERT" );
    $kw65$UNASSERT = makeKeyword( "UNASSERT" );
    $kw66$BLAST = makeKeyword( "BLAST" );
    $sym67$CONSTANT_EXTERNAL_ID_P = makeSymbol( "CONSTANT-EXTERNAL-ID-P" );
    $sym68$LISTP = makeSymbol( "LISTP" );
    $kw69$CREATE_SKOLEM = makeKeyword( "CREATE-SKOLEM" );
    $str70$cycml = makeString( "cycml" );
    $str71$knowledge_package = makeString( "knowledge-package" );
    $str72$knowledge_package_dependencies = makeString( "knowledge-package-dependencies" );
    $str73$operations = makeString( "operations" );
    $list74 = ConsesLow.list( makeSymbol( "CONSTANT" ), makeSymbol( "CYCLIST" ), makeSymbol( "CYC-IMAGE-ID" ), makeSymbol( "OPERATION-TIME" ), makeSymbol( "OPERATION-SECOND" ), makeSymbol( "PURPOSE" ) );
    $str75$create = makeString( "create" );
    $str76$find_or_create = makeString( "find-or-create" );
    $list77 = ConsesLow.list( makeSymbol( "CONSTANT" ), makeSymbol( "NEW-NAME" ), makeSymbol( "CYC-IMAGE-ID" ), makeSymbol( "OPERATION-TIME" ) );
    $str78$rename = makeString( "rename" );
    $list79 = ConsesLow.list( makeSymbol( "FORT-1" ), makeSymbol( "FORT-2" ), makeSymbol( "CYC-IMAGE-ID" ), makeSymbol( "OPERATION-TIME" ) );
    $str80$merge = makeString( "merge" );
    $list81 = ConsesLow.list( makeSymbol( "FORT" ), makeSymbol( "CYCLIST" ), makeSymbol( "CYC-IMAGE-ID" ), makeSymbol( "OPERATION-TIME" ) );
    $str82$kill = makeString( "kill" );
    $list83 = ConsesLow.list( new SubLObject[] { makeSymbol( "ASSERTION" ), makeSymbol( "MT" ), makeSymbol( "STRENGTH" ), makeSymbol( "DIRECTION" ), makeSymbol( "CYCLIST" ), makeSymbol( "CYC-IMAGE-ID" ), makeSymbol(
        "OPERATION-TIME" ), makeSymbol( "OPERATION-SECOND" ), makeSymbol( "PURPOSE" )
    } );
    $str84$assert = makeString( "assert" );
    $list85 = ConsesLow.list( makeString( "lang" ), makeString( "en" ) );
    $str86$reassert = makeString( "reassert" );
    $list87 = ConsesLow.list( makeSymbol( "ASSERTION" ), makeSymbol( "MT" ), makeSymbol( "CYCLIST" ), makeSymbol( "CYC-IMAGE-ID" ), makeSymbol( "OPERATION-TIME" ) );
    $str88$unassert = makeString( "unassert" );
    $str89$blast = makeString( "blast" );
    $list90 = ConsesLow.list( makeSymbol( "EXTERNAL-ID" ), makeSymbol( "UNREIFIED-SK-TERM" ), makeSymbol( "MT" ), makeSymbol( "CNFS" ), makeSymbol( "ARG-TYPES" ), makeSymbol( "CYCLIST" ), makeSymbol( "CYC-IMAGE-ID" ),
        makeSymbol( "OPERATION-TIME" ) );
    $str91$create_skolem = makeString( "create-skolem" );
    $str92$skolem_unreified_term = makeString( "skolem-unreified-term" );
    $str93$skolem_conjunctive_normal_form = makeString( "skolem-conjunctive-normal-form" );
    $str94$skolem_arg_types = makeString( "skolem-arg-types" );
    $sym95$UNIVERSAL_SECOND_P = makeSymbol( "UNIVERSAL-SECOND-P" );
    $str96$bookkeeping_info = makeString( "bookkeeping-info" );
    $str97$Cyclist = makeString( "Cyclist" );
    $str98$Microtheory = makeString( "Microtheory" );
    $str99$CycLConstant = makeString( "CycLConstant" );
    $str100$urn_uuid_ = makeString( "urn:uuid:" );
    $sym101$CYCL_NART_P = makeSymbol( "CYCL-NART-P" );
    $str102$_S_is_not_a_reified_nart = makeString( "~S is not a reified nart" );
    $str103$CycLReifiedNonAtomicTerm = makeString( "CycLReifiedNonAtomicTerm" );
    $str104$Function_Denotational = makeString( "Function-Denotational" );
    $str105$argument_list = makeString( "argument-list" );
    $str106$CycLReifiableNonAtomicTerm = makeString( "CycLReifiableNonAtomicTerm" );
    $sym107$CYCL_NAT_P = makeSymbol( "CYCL-NAT-P" );
    $str108$ELNonAtomicTerm = makeString( "ELNonAtomicTerm" );
    $sym109$CLET = makeSymbol( "CLET" );
    $list110 = ConsesLow.list( ConsesLow.list( makeSymbol( "*WITHIN-CYCL-ATOMIC-SENTENCE?*" ), T ) );
    $const111$True = constant_handles.reader_make_constant_shell( makeString( "True" ) );
    $str112$ = makeString( "" );
    $const113$False = constant_handles.reader_make_constant_shell( makeString( "False" ) );
    $str114$__is_unknown_type_for_CycML_seria = makeString( "~ is unknown type for CycML serialization." );
    $sym115$CYCML_SERIALIZE_OBJECT_TO_STRING = makeSymbol( "CYCML-SERIALIZE-OBJECT-TO-STRING" );
    $str116$SubLList = makeString( "SubLList" );
    $str117$dotted_item = makeString( "dotted-item" );
    $const118$not = constant_handles.reader_make_constant_shell( makeString( "not" ) );
    $str119$not = makeString( "not" );
    $const120$and = constant_handles.reader_make_constant_shell( makeString( "and" ) );
    $str121$and = makeString( "and" );
    $const122$or = constant_handles.reader_make_constant_shell( makeString( "or" ) );
    $str123$or = makeString( "or" );
    $const124$xor = constant_handles.reader_make_constant_shell( makeString( "xor" ) );
    $str125$xor = makeString( "xor" );
    $const126$implies = constant_handles.reader_make_constant_shell( makeString( "implies" ) );
    $str127$implies = makeString( "implies" );
    $const128$equiv = constant_handles.reader_make_constant_shell( makeString( "equiv" ) );
    $str129$equiv = makeString( "equiv" );
    $const130$forAll = constant_handles.reader_make_constant_shell( makeString( "forAll" ) );
    $str131$forAll = makeString( "forAll" );
    $const132$thereExists = constant_handles.reader_make_constant_shell( makeString( "thereExists" ) );
    $str133$thereExists = makeString( "thereExists" );
    $const134$thereExistExactly = constant_handles.reader_make_constant_shell( makeString( "thereExistExactly" ) );
    $str135$thereExistExactly = makeString( "thereExistExactly" );
    $const136$thereExistAtMost = constant_handles.reader_make_constant_shell( makeString( "thereExistAtMost" ) );
    $str137$thereExistAtMost = makeString( "thereExistAtMost" );
    $const138$thereExistAtLeast = constant_handles.reader_make_constant_shell( makeString( "thereExistAtLeast" ) );
    $str139$thereExistAtLeast = makeString( "thereExistAtLeast" );
    $sym140$CYCL_ATOMIC_SENTENCE_P = makeSymbol( "CYCL-ATOMIC-SENTENCE-P" );
    $const141$OpenCycDefinitionalPredicate = constant_handles.reader_make_constant_shell( makeString( "OpenCycDefinitionalPredicate" ) );
    $str142$CycLAtomicSentence = makeString( "CycLAtomicSentence" );
    $str143$Predicate = makeString( "Predicate" );
    $str144$purpose = makeString( "purpose" );
    $str145$_A__A__A = makeString( "~A-~A-~A" );
    $str146$_6__0D = makeString( "~6,'0D" );
    $str147$hl_support = makeString( "hl-support" );
    $str148$module_token = makeString( "module-token" );
  }

  public static final class $cycml_kp_info_native
      extends
        SubLStructNative
  {
    ...
    {
      return $cycml_kp_info_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $cycml_kp_info_native.class, $sym27$CYCML_KP_INFO, $sym28$CYCML_KP_INFO_P, $list29, $list30, new String[] { "$knowledge_package_id", "$knowledge_package_dependencies",
        "$operations"
      }, $list31, $list32, $sym33$PRINT_CYCML_KP_INFO );
    }
  }

  public static final class $cycml_kp_info_p$UnaryFunction
      extends
        UnaryFunction
  {
