...
public final class assertion_utilities extends SubLTranslatedFile
{
  ...
  @SubLTranslatedFile.SubL(
    source = "cycl/assertion-utilities.lisp",
    position = 16957L)
  ...
  public static SubLObject do_rules(final SubLObject macroform, final SubLObject environment)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, assertion_utilities.$list0 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject rule_var = assertion_utilities.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, assertion_utilities.$list0 );
    rule_var = current.first();
    current = current.rest();
    SubLObject allow_other_keys_p = assertion_utilities.NIL;
    SubLObject rest = current;
    SubLObject bad = assertion_utilities.NIL;
    SubLObject current_$1 = assertion_utilities.NIL;
    while ( assertion_utilities.NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, assertion_utilities.$list0 );
      current_$1 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, assertion_utilities.$list0 );
      if( assertion_utilities.NIL == conses_high.member( current_$1, assertion_utilities.$list1, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED ) )
      {
        bad = assertion_utilities.T;
      }
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( datum, assertion_utilities.$list0 );
    }
    final SubLObject progress_message_tail = cdestructuring_bind.property_list_member( assertion_utilities.$kw3$PROGRESS_MESSAGE, current );
    final SubLObject progress_message = ( assertion_utilities.NIL != progress_message_tail ) ? conses_high.cadr( progress_message_tail ) : assertion_utilities.$str4$mapping_Cyc_rules;
    final SubLObject done_tail = cdestructuring_bind.property_list_member( assertion_utilities.$kw5$DONE, current );
    final SubLObject done = ( assertion_utilities.NIL != done_tail ) ? conses_high.cadr( done_tail ) : assertion_utilities.NIL;
    final SubLObject body;
    current = ( body = temp );
    if( assertion_utilities.NIL == progress_message )
    {
      return ConsesLow.listS( assertion_utilities.$sym6$DO_ITERATOR, ConsesLow.list( rule_var, assertion_utilities.$list7, assertion_utilities.$kw5$DONE,
          done ), ConsesLow.append( body, assertion_utilities.NIL ) );
    }
    final SubLObject message_var = assertion_utilities.$sym8$MESSAGE_VAR;
    final SubLObject total = assertion_utilities.$sym9$TOTAL;
    final SubLObject sofar = assertion_utilities.$sym10$SOFAR;
    return ConsesLow.list( assertion_utilities.$sym11$CLET, ConsesLow.list( ConsesLow.list( message_var, progress_message ), reader.bq_cons( total,
        assertion_utilities.$list12 ), reader.bq_cons( sofar, assertion_utilities.$list13 ) ), ConsesLow.list( assertion_utilities.$sym14$NOTING_PERCENT_PROGRESS,
            message_var, ConsesLow.listS( assertion_utilities.$sym15$DO_RULES, ConsesLow.list( rule_var, assertion_utilities.$kw3$PROGRESS_MESSAGE,
                assertion_utilities.NIL, assertion_utilities.$kw5$DONE, done ), ConsesLow.list( assertion_utilities.$sym16$CINC, sofar ), ConsesLow.list(
                    assertion_utilities.$sym17$NOTE_PERCENT_PROGRESS, sofar, total ), ConsesLow.append( body, assertion_utilities.NIL ) ) ) );
  }
  ...
  public static SubLObject do_gafs(final SubLObject macroform, final SubLObject environment)
  {
    SubLObject current;
    final SubLObject datum = current = macroform.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, assertion_utilities.$list18 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject gaf_var = assertion_utilities.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, assertion_utilities.$list18 );
    ...
    SubLObject rest = current;
    SubLObject bad = assertion_utilities.NIL;
    SubLObject current_$2 = assertion_utilities.NIL;
    while ( assertion_utilities.NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, assertion_utilities.$list18 );
      current_$2 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, assertion_utilities.$list18 );
      if( assertion_utilities.NIL == conses_high.member( current_$2, assertion_utilities.$list1, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED ) )
      {
        bad = assertion_utilities.T;
      }
    ...
    if( assertion_utilities.NIL != bad && assertion_utilities.NIL == allow_other_keys_p )
    {
      cdestructuring_bind.cdestructuring_bind_error( datum, assertion_utilities.$list18 );
    }
    final SubLObject progress_message_tail = cdestructuring_bind.property_list_member( assertion_utilities.$kw3$PROGRESS_MESSAGE, current );
    final SubLObject progress_message = ( assertion_utilities.NIL != progress_message_tail ) ? conses_high.cadr( progress_message_tail ) : assertion_utilities.$str19$mapping_Cyc_GAFs;
    final SubLObject done_tail = cdestructuring_bind.property_list_member( assertion_utilities.$kw5$DONE, current );
    final SubLObject done = ( assertion_utilities.NIL != done_tail ) ? conses_high.cadr( done_tail ) : assertion_utilities.NIL;
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.list( assertion_utilities.$sym20$DO_ASSERTIONS, ConsesLow.list( gaf_var, progress_message, assertion_utilities.$kw5$DONE, done ),
        ConsesLow.listS( assertion_utilities.$sym21$PWHEN, ConsesLow.list( assertion_utilities.$sym22$GAF_ASSERTION_, gaf_var ), ConsesLow.append( body,
            assertion_utilities.NIL ) ) );
  }
  ...
  public static SubLObject do_assertions_backwards(final SubLObject macroform, final SubLObject environment)
  {
    SubLObject current;
    final SubLObject datum = current = macroform.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, assertion_utilities.$list23 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject assertion_var = assertion_utilities.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, assertion_utilities.$list23 );
    ...
    SubLObject rest = current;
    SubLObject bad = assertion_utilities.NIL;
    SubLObject current_$3 = assertion_utilities.NIL;
    while ( assertion_utilities.NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, assertion_utilities.$list23 );
      current_$3 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, assertion_utilities.$list23 );
      if( assertion_utilities.NIL == conses_high.member( current_$3, assertion_utilities.$list1, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED ) )
      {
        bad = assertion_utilities.T;
      }
    ...
    if( assertion_utilities.NIL != bad && assertion_utilities.NIL == allow_other_keys_p )
    {
      cdestructuring_bind.cdestructuring_bind_error( datum, assertion_utilities.$list23 );
    }
    final SubLObject progress_message_tail = cdestructuring_bind.property_list_member( assertion_utilities.$kw3$PROGRESS_MESSAGE, current );
    final SubLObject progress_message = ( assertion_utilities.NIL != progress_message_tail ) ? conses_high.cadr( progress_message_tail ) : assertion_utilities.NIL;
    final SubLObject done_tail = cdestructuring_bind.property_list_member( assertion_utilities.$kw5$DONE, current );
    final SubLObject done = ( assertion_utilities.NIL != done_tail ) ? conses_high.cadr( done_tail ) : assertion_utilities.NIL;
    final SubLObject body;
    current = ( body = temp );
    ...
    {
      final SubLObject progress_message_var = assertion_utilities.$sym24$PROGRESS_MESSAGE_VAR;
      return ConsesLow.list( assertion_utilities.$sym11$CLET, ConsesLow.list( ConsesLow.list( progress_message_var, progress_message ) ), ConsesLow.listS(
          assertion_utilities.$sym25$DO_ASSERTIONS_BACKWARDS, ConsesLow.list( assertion_var, assertion_utilities.$kw3$PROGRESS_MESSAGE, progress_message_var,
              assertion_utilities.$kw5$DONE, done ), ConsesLow.append( body, assertion_utilities.NIL ) ) );
    }
    if( assertion_utilities.NIL != progress_message )
    {
      final SubLObject sofar_var = assertion_utilities.$sym26$SOFAR_VAR;
      final SubLObject total_var = assertion_utilities.$sym27$TOTAL_VAR;
      return ConsesLow.list( assertion_utilities.$sym11$CLET, ConsesLow.list( reader.bq_cons( total_var, assertion_utilities.$list28 ), reader.bq_cons( sofar_var,
          assertion_utilities.$list13 ) ), ConsesLow.list( assertion_utilities.$sym14$NOTING_PERCENT_PROGRESS, progress_message, ConsesLow.listS(
              assertion_utilities.$sym25$DO_ASSERTIONS_BACKWARDS, ConsesLow.list( assertion_var, assertion_utilities.$kw5$DONE, done ), ConsesLow.list(
                  assertion_utilities.$sym17$NOTE_PERCENT_PROGRESS, sofar_var, total_var ), ConsesLow.list( assertion_utilities.$sym16$CINC, sofar_var ), ConsesLow.append( body,
                      assertion_utilities.NIL ) ) ) );
    }
    final SubLObject id_var = assertion_utilities.$sym29$ID_VAR;
    return ConsesLow.list( assertion_utilities.$sym30$DO_NUMBERS, ConsesLow.list( new SubLObject[] { id_var, assertion_utilities.$kw31$START, assertion_utilities.$list32,
      assertion_utilities.$kw33$END, assertion_utilities.MINUS_ONE_INTEGER, assertion_utilities.$kw34$DELTA, assertion_utilities.MINUS_ONE_INTEGER, assertion_utilities.$kw5$DONE, done
    } ), ConsesLow.list( assertion_utilities.$sym11$CLET, ConsesLow.list( ConsesLow.list( assertion_var, ConsesLow.list(
        assertion_utilities.$sym35$FIND_ASSERTION_BY_ID, id_var ) ) ), ConsesLow.listS( assertion_utilities.$sym21$PWHEN, assertion_var, ConsesLow.append( body,
            assertion_utilities.NIL ) ) ) );
  }
  ...
  public static SubLObject do_assertion_dependent_assertions(final SubLObject macroform, final SubLObject environment)
  {
    SubLObject current;
    final SubLObject datum = current = macroform.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, assertion_utilities.$list36 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject dependent_assertion = assertion_utilities.NIL;
    SubLObject assertion = assertion_utilities.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, assertion_utilities.$list36 );
    ...
    if( assertion_utilities.NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      final SubLObject deduction = assertion_utilities.$sym37$DEDUCTION;
      return ConsesLow.list( assertion_utilities.$sym38$DO_ASSERTION_DEPENDENTS, ConsesLow.list( deduction, assertion ), ConsesLow.list(
          assertion_utilities.$sym11$CLET, ConsesLow.list( ConsesLow.list( dependent_assertion, ConsesLow.list(
              assertion_utilities.$sym39$DEDUCTION_ASSERTION, deduction ) ) ), ConsesLow.listS( assertion_utilities.$sym21$PWHEN, ConsesLow.list(
                  assertion_utilities.$sym40$ASSERTION_P, dependent_assertion ), ConsesLow.append( body, assertion_utilities.NIL ) ) ) );
    }
    cdestructuring_bind.cdestructuring_bind_error( datum, assertion_utilities.$list36 );
    return assertion_utilities.NIL;
  }
  ...
  public static SubLObject do_assertion_supporting_assertions(final SubLObject macroform, final SubLObject environment)
  {
    SubLObject current;
    final SubLObject datum = current = macroform.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, assertion_utilities.$list41 );
    final SubLObject temp = current.rest();
    current = current.first();
    SubLObject supporting_assertion = assertion_utilities.NIL;
    SubLObject assertion = assertion_utilities.NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, assertion_utilities.$list41 );
    ...
    SubLObject rest = current;
    SubLObject bad = assertion_utilities.NIL;
    SubLObject current_$4 = assertion_utilities.NIL;
    while ( assertion_utilities.NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, assertion_utilities.$list41 );
      current_$4 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, assertion_utilities.$list41 );
      if( assertion_utilities.NIL == conses_high.member( current_$4, assertion_utilities.$list42, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED ) )
      {
        bad = assertion_utilities.T;
      }
    ...
    if( assertion_utilities.NIL != bad && assertion_utilities.NIL == allow_other_keys_p )
    {
      cdestructuring_bind.cdestructuring_bind_error( datum, assertion_utilities.$list41 );
    }
    final SubLObject done_tail = cdestructuring_bind.property_list_member( assertion_utilities.$kw5$DONE, current );
    final SubLObject done = ( assertion_utilities.NIL != done_tail ) ? conses_high.cadr( done_tail ) : assertion_utilities.NIL;
    final SubLObject body;
    current = ( body = temp );
    final SubLObject argument = assertion_utilities.$sym43$ARGUMENT;
    return ConsesLow.list( assertion_utilities.$sym44$DO_ASSERTION_ARGUMENTS, ConsesLow.list( argument, assertion, assertion_utilities.$kw5$DONE, done ),
        ConsesLow.list( assertion_utilities.$sym21$PWHEN, ConsesLow.list( assertion_utilities.$sym45$DEDUCTION_P, argument ), ConsesLow.list(
            assertion_utilities.$sym46$DO_DEDUCTION_SUPPORTS, ConsesLow.list( supporting_assertion, argument, assertion_utilities.$kw5$DONE, done ), ConsesLow.listS(
                assertion_utilities.$sym21$PWHEN, ConsesLow.list( assertion_utilities.$sym40$ASSERTION_P, supporting_assertion ), ConsesLow.append( body,
                    assertion_utilities.NIL ) ) ) ) );
  }
  ...
  public static SubLObject assertion_list_p(final SubLObject v_object)
  {
    if( assertion_utilities.NIL != list_utilities.non_dotted_list_p( v_object ) )
    {
      ...
      SubLObject subobject = assertion_utilities.NIL;
  ...
  public static SubLObject assertion_dependent_assertions(final SubLObject assertion)
  {
    ...
    {
      SubLObject result_set = set_contents.new_set_contents( assertions_high.assertion_dependent_count( assertion ), Symbols.symbol_function( assertion_utilities.EQL ) );
      ...
      for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = assertion_utilities.NIL, state = set_contents.do_set_contents_initial_state( basis_object,
          set_contents_var ); assertion_utilities.NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        if( assertion_utilities.NIL != set_contents.do_set_contents_element_validP( state, deduction ) )
        {
          ...
          {
            result_set = set_contents.set_contents_add( dependent_supported_object, result_set, Symbols.symbol_function( assertion_utilities.EQL ) );
          }
        }
      }
  ...
  public static SubLObject remove_relevant_assertions_dependents(final SubLObject assertions, final SubLObject possibly_relevant_mt)
  {
    ...
    SubLObject checked_deduction_count = assertion_utilities.ZERO_INTEGER;
    SubLObject removed_deduction_count = assertion_utilities.ZERO_INTEGER;
    SubLObject checked_deductions = set_contents.new_set_contents( assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED );
    SubLObject deductions_to_check = assertion_utilities.NIL;
    SubLObject deductions_to_remove = assertion_utilities.NIL;
    ...
    while ( assertion_utilities.NIL != cdolist_list_var)
    {
          ...
          set_contents_var ); assertion_utilities.NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        {
          item_var = dependent;
          if( assertion_utilities.NIL == conses_high.member( item_var, deductions_to_check, Symbols.symbol_function( assertion_utilities.EQL ), Symbols.symbol_function(
              assertion_utilities.IDENTITY ) ) )
          {
    ...
    try
    {
      utilities_macros.$percent_progress_delayed_mode_seconds$.bind( assertion_utilities.THREE_INTEGER, thread );
      utilities_macros.$percent_progress_delayed_mode_string$.bind( Sequences.cconcatenate( assertion_utilities.$str47$Gathering_mt_relevant_dependents_, new SubLObject[] { format_nil.format_nil_a_no_copy(
          Sequences.length( assertions ) ), assertion_utilities.$str48$_assertions
      } ), thread );
      utilities_macros.$last_percent_progress_index$.bind( assertion_utilities.ZERO_INTEGER, thread );
      utilities_macros.$last_percent_progress_prediction$.bind( assertion_utilities.NIL, thread );
      utilities_macros.$within_noting_percent_progress$.bind( assertion_utilities.T, thread );
      utilities_macros.$percent_progress_start_time$.bind( Time.get_universal_time(), thread );
      try
      {
        utilities_macros.noting_percent_progress_preamble( Sequences.cconcatenate( assertion_utilities.$str47$Gathering_mt_relevant_dependents_, new SubLObject[] { format_nil.format_nil_a_no_copy( Sequences
            .length( assertions ) ), assertion_utilities.$str48$_assertions
        } ) );
        while ( assertion_utilities.NIL != deductions_to_check)
        {
          ...
          if( assertion_utilities.NIL != assertion_handles.assertion_p( deductions_high.deduction_supported_object( deduction ) ) && assertion_utilities.NIL != sksi_infrastructure_utilities.mt_relevant_to_mt_memoizedP(
              deductions_high.deduction_mt( deduction ), possibly_relevant_mt, assertion_utilities.UNPROVIDED ) )
          {
            final SubLObject possible_assertion = deductions_high.deduction_supported_object( deduction );
            SubLObject deduction_excepting_its_own_supportP = assertion_utilities.NIL;
            if( assertion_utilities.NIL != assertion_handles.assertion_p( possible_assertion ) && assertion_utilities.NIL != gaf_assertion_with_pred_p( possible_assertion, assertion_utilities.$const49$except )
                && assertion_utilities.NIL != list_utilities.member_equalP( assertions_high.gaf_arg1( possible_assertion ), deductions_high.deduction_supports( deduction ) ) )
            {
              deduction_excepting_its_own_supportP = assertion_utilities.T;
            }
          ...
          SubLObject sub_deduction = assertion_utilities.NIL;
          sub_deduction = cdolist_list_var2.first();
          while ( assertion_utilities.NIL != cdolist_list_var2)
          {
            if( assertion_utilities.NIL == set_contents.set_contents_memberP( sub_deduction, checked_deductions, assertion_utilities.UNPROVIDED ) )
            {
          ...
          checked_deductions = set_contents.set_contents_add( deduction, checked_deductions, assertion_utilities.UNPROVIDED );
          checked_deduction_count = Numbers.add( checked_deduction_count, assertion_utilities.ONE_INTEGER );
      ...
      finally
      {
        ...
        try
        {
          Threads.$is_thread_performing_cleanupP$.bind( assertion_utilities.T, thread );
    ...
    {
      utilities_macros.$percent_progress_delayed_mode_seconds$.bind( assertion_utilities.THREE_INTEGER, thread );
      utilities_macros.$percent_progress_delayed_mode_string$.bind( Sequences.cconcatenate( assertion_utilities.$str50$Removing_, new SubLObject[] { format_nil.format_nil_a_no_copy( Sequences.length(
          deductions_to_remove ) ), assertion_utilities.$str51$_mt_relevant_dependents
      } ), thread );
      utilities_macros.$last_percent_progress_index$.bind( assertion_utilities.ZERO_INTEGER, thread );
      utilities_macros.$last_percent_progress_prediction$.bind( assertion_utilities.NIL, thread );
      utilities_macros.$within_noting_percent_progress$.bind( assertion_utilities.T, thread );
      ...
      try
      {
        utilities_macros.noting_percent_progress_preamble( Sequences.cconcatenate( assertion_utilities.$str50$Removing_, new SubLObject[] { format_nil.format_nil_a_no_copy( Sequences.length(
            deductions_to_remove ) ), assertion_utilities.$str51$_mt_relevant_dependents
        } ) );
        SubLObject cdolist_list_var3 = deductions_to_remove;
        SubLObject deduction2 = assertion_utilities.NIL;
        deduction2 = cdolist_list_var3.first();
        while ( assertion_utilities.NIL != cdolist_list_var3)
        {
          if( assertion_utilities.NIL != deduction_handles.valid_deductionP( deduction2, assertion_utilities.UNPROVIDED ) )
          {
            tms.tms_remove_deduction( deduction2 );
            removed_deduction_count = Numbers.add( removed_deduction_count, assertion_utilities.ONE_INTEGER );
          }
  ...
  public static SubLObject deduction_dependent_deductions(final SubLObject deduction)
  {
    ...
    {
      Errors.warn( assertion_utilities.$str53$deduction_dependent_deductions_ca, deduction_handles.deduction_id( deduction ), supported_object );
      return assertion_utilities.NIL;
    }
    ...
    {
      Errors.warn( assertion_utilities.$str52$Deduction__A_supporting_missing_K, deduction, supported_object );
      return assertion_utilities.NIL;
    }
  ...
  public static SubLObject assertion_dependent_supported_object_counts(final SubLObject assertion)
  {
    if( assertion_utilities.NIL != assertions_high.assertion_has_dependents_p( assertion ) )
    {
      SubLObject assertion_set = set_contents.new_set_contents( assertion_utilities.ZERO_INTEGER, Symbols.symbol_function( assertion_utilities.EQL ) );
      SubLObject kb_hl_support_set = set_contents.new_set_contents( assertion_utilities.ZERO_INTEGER, Symbols.symbol_function( assertion_utilities.EQUAL ) );
      SubLObject clause_struct_set = set_contents.new_set_contents( assertion_utilities.ZERO_INTEGER, Symbols.symbol_function( assertion_utilities.EQL ) );
      final SubLObject set_contents_var = assertions_high.assertion_dependents( assertion );
      SubLObject basis_object;
      SubLObject state;
      SubLObject deduction;
          ...
          set_contents_var ); assertion_utilities.NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        if( assertion_utilities.NIL != set_contents.do_set_contents_element_validP( state, deduction ) )
        {
          ...
          if( assertion_utilities.NIL != assertion_handles.assertion_p( dependent_supported_object ) )
          {
            assertion_set = set_contents.set_contents_add( dependent_supported_object, assertion_set, Symbols.symbol_function( assertion_utilities.EQL ) );
            clause_struct = assertions_low.assertion_clause_struc( dependent_supported_object );
            if( assertion_utilities.NIL != clause_struct )
            {
              clause_struct_set = set_contents.set_contents_add( clause_struct, clause_struct_set, assertion_utilities.UNPROVIDED );
            }
            else
            {
              clause_struct_set = set_contents.set_contents_add( dependent_supported_object, clause_struct_set, assertion_utilities.UNPROVIDED );
            }
          }
          else if( assertion_utilities.NIL != kb_hl_support_handles.kb_hl_support_p( dependent_supported_object ) )
          {
            kb_hl_support_set = set_contents.set_contents_add( dependent_supported_object, kb_hl_support_set, Symbols.symbol_function( assertion_utilities.EQUAL ) );
          }
    ...
    return Values.values( assertion_utilities.ZERO_INTEGER, assertion_utilities.ZERO_INTEGER, assertion_utilities.ZERO_INTEGER );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertion_handles.assertion_p( assertion ) && assertion_utilities.NIL != assertions_high.assertion_has_truthP( assertion,
        assertion_utilities.$kw54$TRUE ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertion_handles.assertion_p( assertion ) && assertion_utilities.NIL != assertions_high.assertion_has_truthP( assertion,
        assertion_utilities.$kw55$FALSE ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertion_handles.assertion_p( assertion ) && assertion_utilities.NIL != assertions_high.assertion_has_truthP( assertion,
        assertion_utilities.$kw56$UNKNOWN ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertions_high.gaf_assertionP( v_object ) && assertion_utilities.NIL != true_assertionP( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertions_high.gaf_assertionP( v_object ) && assertion_utilities.NIL != false_assertionP( v_object ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertion_handles.assertion_p( assertion ) && assertion_utilities.NIL != isa.isa_in_any_mtP( cycl_utilities.formula_operator(
        assertions_high.assertion_formula( assertion ) ), assertion_utilities.$const57$NLSemanticPredicate ) );
  }
  ...
  public static SubLObject obsolete_ruleP(final SubLObject assertion)
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( assertion_utilities.$sym58$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( assertion_utilities.$const59$EverythingPSC, thread );
      return Numbers.numG( kb_indexing.num_gaf_arg_index( assertion, assertion_utilities.ONE_INTEGER, assertion_utilities.$const61$obsoleteRule, assertion_utilities.UNPROVIDED ),
          assertion_utilities.ZERO_INTEGER );
    }
    finally
    {
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL == type_spec || assertion_utilities.NIL != assertions_high.assertion_has_typeP( assertion, type_spec ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL == truth_spec || assertion_utilities.NIL != assertions_high.assertion_has_truth( assertion, truth_spec ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL == direction_spec || assertion_utilities.NIL != assertions_high.assertion_has_direction( assertion, direction_spec ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertion_matches_truthP( assertion, truth_spec ) && assertion_utilities.NIL != assertion_matches_directionP( assertion,
        direction_spec ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertion_matches_typeP( assertion, type_spec ) && assertion_utilities.NIL != assertion_matches_truthP( assertion, truth_spec )
        && assertion_utilities.NIL != assertion_matches_directionP( assertion, direction_spec ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != true_assertionP( assertion ) && pred.eql( assertions_high.gaf_predicate( assertion ) ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertions_high.gaf_assertionP( assertion ) && pred.eql( assertions_high.gaf_predicate( assertion ) ) );
  }
  ...
  public static SubLObject gaf_assertion_with_any_of_preds_p(final SubLObject assertion, final SubLObject pred_list)
  {
    ...
    {
      return subl_promotions.memberP( assertions_high.gaf_predicate( assertion ), pred_list, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED );
    }
    return assertion_utilities.NIL;
  }
  ...
  public static SubLObject except_when_rule_p(final SubLObject v_object)
  {
    if( assertion_utilities.NIL != assertions_high.rule_assertionP( v_object ) )
    {
      ...
      SubLObject pos_lit = assertion_utilities.NIL;
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != except_when_rule_p( v_object ) || assertion_utilities.NIL != except_for_gaf_p( v_object ) );
  }
  ...
  public static SubLObject somewhere_excepted_assertionP(final SubLObject assertion, SubLObject justifyP)
  {
    ...
    {
      justifyP = assertion_utilities.NIL;
    }
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject result = assertion_utilities.NIL;
    final SubLObject _prev_bind_0 = mt_relevance_macros.$relevant_mt_function$.currentBinding( thread );
    final SubLObject _prev_bind_2 = mt_relevance_macros.$mt$.currentBinding( thread );
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( assertion_utilities.$sym58$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( assertion_utilities.$const59$EverythingPSC, thread );
      result = excepted_assertionP_int( assertion, assertion_utilities.NIL, justifyP, assertion_utilities.UNPROVIDED );
    }
    finally
    {
      mt_relevance_macros.$mt$.rebind( _prev_bind_2, thread );
  ...
  public static SubLObject excepted_assertionP(final SubLObject assertion, SubLObject justifyP, SubLObject depth)
  {
    ...
    return excepted_assertionP_int( assertion, assertion_utilities.NIL, justifyP, depth );
  }
  ...
  public static SubLObject excepted_assertionP_int(final SubLObject assertion, SubLObject checked_assertions, SubLObject justifyP, SubLObject depth)
  {
    ...
    {
      checked_assertions = assertion_utilities.NIL;
    }
    if( justifyP == assertion_utilities.UNPROVIDED )
    {
      justifyP = assertion_utilities.NIL;
    ...
    if( depth == assertion_utilities.UNPROVIDED )
    {
      depth = assertion_utilities.NIL;
    }
    assert assertion_utilities.NIL != assertion_handles.assertion_p( assertion ) : assertion;
    if( depth.isInteger() && depth.numLE( assertion_utilities.ZERO_INTEGER ) )
    {
      return assertion_utilities.NIL;
    }
    if( assertion_utilities.NIL == assertion_handles.valid_assertionP( assertion, assertion_utilities.UNPROVIDED ) )
    {
      return assertion_utilities.NIL;
    }
    if( assertion_utilities.NIL == checked_assertions )
    {
      checked_assertions = set.new_set( Symbols.symbol_function( assertion_utilities.EQL ), assertion_utilities.ZERO_INTEGER );
    }
    ...
    SubLObject excepted_assertionP = assertion_utilities.NIL;
    SubLObject justification = assertion_utilities.NIL;
    final SubLObject mt = assertions_high.assertion_mt( assertion );
    if( assertion_utilities.NIL != forts.fort_p( mt ) && assertion_utilities.NIL != somewhere_cache.some_pred_assertion_somewhereP( assertion_utilities.$const65$exceptMt, mt, assertion_utilities.ONE_INTEGER,
        assertion_utilities.UNPROVIDED ) )
    {
      final SubLObject exceptions = kb_mapping_utilities.pred_value_gafs( mt, assertion_utilities.$const65$exceptMt, assertion_utilities.ONE_INTEGER, assertion_utilities.UNPROVIDED );
      if( assertion_utilities.NIL == excepted_assertionP )
      {
        SubLObject csome_list_var = exceptions;
        SubLObject exception = assertion_utilities.NIL;
        exception = csome_list_var.first();
        while ( assertion_utilities.NIL == excepted_assertionP && assertion_utilities.NIL != csome_list_var)
        {
          if( assertion_utilities.NIL == excepted_assertionP_int( exception, checked_assertions, assertion_utilities.NIL, depth.isInteger() ? Numbers.subtract( depth,
              assertion_utilities.ONE_INTEGER ) : assertion_utilities.NIL ) )
          {
            excepted_assertionP = assertion_utilities.T;
            final SubLObject item_var = exception;
            if( assertion_utilities.NIL == conses_high.member( item_var, justification, Symbols.symbol_function( assertion_utilities.EQL ), Symbols.symbol_function(
                assertion_utilities.IDENTITY ) ) )
            {
    ...
    if( assertion_utilities.NIL == excepted_assertionP && assertion_utilities.NIL != somewhere_cache.some_pred_assertion_somewhereP( assertion_utilities.$const49$except, assertion,
        assertion_utilities.ONE_INTEGER, assertion_utilities.UNPROVIDED ) )
    {
      final SubLObject exceptions = kb_mapping_utilities.pred_value_gafs( assertion, assertion_utilities.$const49$except, assertion_utilities.ONE_INTEGER, assertion_utilities.UNPROVIDED );
      if( assertion_utilities.NIL == excepted_assertionP )
      {
        SubLObject csome_list_var = exceptions;
        SubLObject exception = assertion_utilities.NIL;
    ...
    if( assertion_utilities.NIL == excepted_assertionP )
    {
      SubLObject non_excepted_support_foundP = assertion_utilities.NIL;
      SubLObject some_excepted_support_justification = assertion_utilities.NIL;
      SubLObject rest;
      SubLObject argument;
      ...
      for( rest = assertion_utilities.NIL, rest = assertions_high.assertion_arguments( assertion ); assertion_utilities.NIL == non_excepted_support_foundP && assertion_utilities.NIL != rest; rest = rest
          .rest() )
      {
        argument = rest.first();
        if( assertion_utilities.NIL != arguments.asserted_argument_p( argument ) )
        {
          non_excepted_support_foundP = assertion_utilities.T;
        }
        else
        {
          for( excepted_support_foundP = assertion_utilities.NIL, rest_$7 = assertion_utilities.NIL, rest_$7 = deductions_high.deduction_supports(
              argument ); assertion_utilities.NIL == excepted_support_foundP && assertion_utilities.NIL != rest_$7; rest_$7 = rest_$7.rest() )
          {
            support = rest_$7.first();
            if( assertion_utilities.NIL != assertion_handles.assertion_p( support ) )
            {
              excepted_supportP = excepted_assertionP_int( support, checked_assertions, justifyP, depth.isInteger() ? Numbers.subtract( depth, assertion_utilities.ONE_INTEGER )
                  : assertion_utilities.NIL );
              if( assertion_utilities.NIL != excepted_supportP )
              {
                excepted_support_foundP = assertion_utilities.T;
      ...
      excepted_assertionP = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == non_excepted_support_foundP && assertion_utilities.NIL != some_excepted_support_justification );
  ...
  public static SubLObject doomed_assertionP(final SubLObject assertion, SubLObject justifyP, SubLObject depth)
  {
    ...
    return doomed_assertionP_int( assertion, assertion_utilities.NIL, justifyP, depth );
  }
  ...
  public static SubLObject doomed_assertionP_int(final SubLObject assertion, SubLObject checked_assertions, SubLObject justifyP, SubLObject depth)
  {
    ...
    set.set_add( assertion, checked_assertions );
    SubLObject doomed_assertionP = assertion_utilities.NIL;
    SubLObject justification = assertion_utilities.NIL;
    if( assertion_utilities.NIL == doomed_assertionP && assertion_utilities.NIL == assertions_high.assertion_arguments( assertion ) )
    {
      doomed_assertionP = assertion_utilities.T;
      if( assertion_utilities.NIL == conses_high.member( assertion, justification, Symbols.symbol_function( assertion_utilities.EQL ), Symbols.symbol_function( assertion_utilities.IDENTITY ) ) )
      {
    ...
    {
      SubLObject csome_list_var = cycl_utilities.expression_gather( assertions_high.assertion_cnf( assertion ), assertion_utilities.$sym40$ASSERTION_P, assertion_utilities.UNPROVIDED,
          assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED );
      SubLObject sub_assertion = assertion_utilities.NIL;
      sub_assertion = csome_list_var.first();
      while ( assertion_utilities.NIL == doomed_assertionP && assertion_utilities.NIL != csome_list_var)
      {
        final SubLObject doomed_supportP = doomed_assertionP_int( sub_assertion, checked_assertions, justifyP, depth.isInteger() ? Numbers.subtract( depth, assertion_utilities.ONE_INTEGER )
            : assertion_utilities.NIL );
    ...
    {
      SubLObject non_doomed_support_foundP = assertion_utilities.NIL;
      SubLObject some_doomed_support_justification = assertion_utilities.NIL;
      SubLObject rest;
      SubLObject argument;
      ...
      for( rest = assertion_utilities.NIL, rest = assertions_high.assertion_arguments( assertion ); assertion_utilities.NIL == non_doomed_support_foundP && assertion_utilities.NIL != rest; rest = rest
          .rest() )
      {
        argument = rest.first();
        if( assertion_utilities.NIL != arguments.asserted_argument_p( argument ) )
        {
          non_doomed_support_foundP = assertion_utilities.T;
        }
        else
        {
          for( doomed_support_foundP = assertion_utilities.NIL, rest_$8 = assertion_utilities.NIL, rest_$8 = deductions_high.deduction_supports(
              argument ); assertion_utilities.NIL == doomed_support_foundP && assertion_utilities.NIL != rest_$8; rest_$8 = rest_$8.rest() )
          {
            support = rest_$8.first();
            if( assertion_utilities.NIL != assertion_handles.assertion_p( support ) )
            {
              doomed_supportP2 = doomed_assertionP_int( support, checked_assertions, justifyP, depth.isInteger() ? Numbers.subtract( depth, assertion_utilities.ONE_INTEGER )
                  : assertion_utilities.NIL );
              if( assertion_utilities.NIL != doomed_supportP2 )
              {
                doomed_support_foundP = assertion_utilities.T;
      ...
      doomed_assertionP = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == non_doomed_support_foundP && assertion_utilities.NIL != some_doomed_support_justification );
  ...
  public static SubLObject assertion_has_deduction_with_supportP(final SubLObject assertion, final SubLObject support)
  {
    ...
    SubLObject deduction = assertion_utilities.NIL;
    ...
    while ( assertion_utilities.NIL != cdolist_list_var)
    {
      if( assertion_utilities.NIL != deduction_handles.deduction_p( deduction ) )
      {
        ...
        SubLObject deduction_support = assertion_utilities.NIL;
  ...
  public static SubLObject assertion_has_dependent_with_supportP(final SubLObject assertion, final SubLObject support)
  {
        ...
        set_contents_var ); assertion_utilities.NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( assertion_utilities.NIL != set_contents.do_set_contents_element_validP( state, deduction ) )
      {
        ...
        deduction_support = assertion_utilities.NIL;
  ...
  public static SubLObject assertion_has_dependent_with_supportP_kb_hl_support_aware_version(final SubLObject assertion, final SubLObject support)
  {
        ...
        set_contents_var ); assertion_utilities.NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( assertion_utilities.NIL != set_contents.do_set_contents_element_validP( state, deduction ) )
      {
        ...
        else
        {
          ...
          dependent_deduction = assertion_utilities.NIL;
          dependent_deduction = cdolist_list_var.first();
          while ( assertion_utilities.NIL != cdolist_list_var)
          {
            item_var2 = dependent_deduction;
            if( assertion_utilities.NIL == conses_high.member( item_var2, deductions_to_check, Symbols.symbol_function( assertion_utilities.EQL ), Symbols.symbol_function(
                assertion_utilities.IDENTITY ) ) )
            {
    ...
    SubLObject deduction_to_check = assertion_utilities.NIL;
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertion_handles.assertion_p( assertion ) && assertion_utilities.NIL != cycl_utilities.assertion_find(
        assertion_utilities.$const67$assertedMoreSpecifically, assertion, assertion_utilities.NIL, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED ) );
  }
  ...
  {
    if( assertion_utilities.NIL != list_utilities.lengthG( terms, assertion_utilities.$assertion_mentions_any_of_terms_set_watermark$.getGlobalValue(), assertion_utilities.UNPROVIDED ) )
    {
      final SubLObject term_set = set_utilities.construct_set_from_list( terms, Symbols.symbol_function( assertion_utilities.EQUAL ), assertion_utilities.UNPROVIDED );
      return assertion_mentions_any_of_terms_in_setP( assertion, term_set );
    }
    SubLObject cdolist_list_var = terms;
    SubLObject v_term = assertion_utilities.NIL;
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject resultP = assertion_utilities.NIL;
    ...
    try
    {
      ...
      resultP = list_utilities.sublisp_boolean( cycl_utilities.assertion_find_if( assertion_utilities.$sym69$ASSERTION_MENTIONS_ANY_OF_TERMS_IN_SET_LAMBDA, assertion, assertion_utilities.T,
          assertion_utilities.UNPROVIDED ) );
    }
    finally
    {
  ...
  public static SubLObject assertion_mentions_any_of_terms_in_dictionary_keysP(final SubLObject assertion, final SubLObject term_dictionary)
  {
    ...
    try
    {
      ...
      resultP = list_utilities.sublisp_boolean( cycl_utilities.assertion_find_if( assertion_utilities.$sym70$ASSERTION_MENTIONS_ANY_OF_TERMS_IN_DICT_LAMBDA, assertion, assertion_utilities.T,
          assertion_utilities.UNPROVIDED ) );
    }
    finally
    {
  ...
  public static SubLObject random_gaf_with_predicate(final SubLObject pred)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject result = assertion_utilities.NIL;
    if( kb_indexing.num_predicate_extent_index( pred, assertion_utilities.UNPROVIDED ).numG( assertion_utilities.$int71$10000 ) )
    {
      while ( assertion_utilities.NIL == gaf_assertion_with_pred_p( result, pred ))
      {
        result = assertions_high.random_assertion( assertion_utilities.UNPROVIDED );
      }
    }
    else
    {
      final SubLObject total = kb_indexing.num_predicate_extent_index( pred, assertion_utilities.UNPROVIDED );
      final SubLObject i = random.random( total );
      SubLObject count = assertion_utilities.ZERO_INTEGER;
      SubLObject result_$11 = assertion_utilities.NIL;
      final SubLObject _prev_bind_0 = mt_relevance_macros.$relevant_mt_function$.currentBinding( thread );
      final SubLObject _prev_bind_2 = mt_relevance_macros.$mt$.currentBinding( thread );
      try
      {
        ...
        {
          final SubLObject str = assertion_utilities.NIL;
          ...
          try
          {
            ...
            utilities_macros.$progress_notification_count$.bind( assertion_utilities.ZERO_INTEGER, thread );
            utilities_macros.$progress_pacifications_since_last_nl$.bind( assertion_utilities.ZERO_INTEGER, thread );
            utilities_macros.$progress_count$.bind( assertion_utilities.ZERO_INTEGER, thread );
            utilities_macros.$is_noting_progressP$.bind( assertion_utilities.T, thread );
            utilities_macros.$silent_progressP$.bind( ( assertion_utilities.NIL != str ) ? utilities_macros.$silent_progressP$.getDynamicValue( thread ) : assertion_utilities.T, thread );
            ...
            final SubLObject token_var = assertion_utilities.NIL;
            while ( assertion_utilities.NIL == done_var)
            {
              ...
              if( assertion_utilities.NIL != valid )
              {
                ...
                SubLObject final_index_iterator = assertion_utilities.NIL;
                try
                {
                  final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, assertion_utilities.$kw72$GAF, assertion_utilities.NIL,
                      assertion_utilities.NIL );
                  SubLObject done_var_$14 = result_$11;
                  final SubLObject token_var_$15 = assertion_utilities.NIL;
                  while ( assertion_utilities.NIL == done_var_$14)
                  {
                    ...
                    final SubLObject valid_$16 = SubLObjectFactory.makeBoolean( !token_var_$15.eql( gaf ) );
                    if( assertion_utilities.NIL != valid_$16 )
                    {
                      ...
                      {
                        count = Numbers.add( count, assertion_utilities.ONE_INTEGER );
                      }
                    }
                    done_var_$14 = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid_$16 || assertion_utilities.NIL != result_$11 );
                  }
                }
                finally
                {
              ...
              done_var = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid || assertion_utilities.NIL != result_$11 );
            }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject total = kb_indexing.num_gaf_arg_index( arg, argnum, pred, assertion_utilities.UNPROVIDED );
    final SubLObject i = random.random( total );
    SubLObject count = assertion_utilities.ZERO_INTEGER;
    SubLObject result = assertion_utilities.NIL;
    final SubLObject _prev_bind_0 = mt_relevance_macros.$relevant_mt_function$.currentBinding( thread );
      ...
      if( assertion_utilities.NIL != kb_mapping_macros.do_gaf_arg_index_key_validator( arg, argnum, pred ) )
      {
        ...
        while ( assertion_utilities.NIL == done_var)
        {
          ...
          if( assertion_utilities.NIL != valid )
          {
            ...
            try
            {
              final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, assertion_utilities.$kw72$GAF, assertion_utilities.NIL, assertion_utilities.NIL );
              SubLObject done_var_$18 = result;
              final SubLObject token_var_$19 = assertion_utilities.NIL;
              while ( assertion_utilities.NIL == done_var_$18)
              {
                ...
                final SubLObject valid_$20 = SubLObjectFactory.makeBoolean( !token_var_$19.eql( gaf ) );
                ...
                done_var_$18 = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid_$20 || assertion_utilities.NIL != result );
              }
            }
            finally
            {
          ...
          done_var = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid || assertion_utilities.NIL != result );
        }
      }
    }
    finally
  ...
  {
    SubLObject result = assertion_utilities.NIL;
    if( assertion_utilities.NIL != kb_mapping_macros.do_term_index_key_validator( fort, assertion_utilities.$kw73$RULE ) )
    {
      final SubLObject iterator_var = kb_mapping_macros.new_term_final_index_spec_iterator( fort, assertion_utilities.$kw73$RULE );
      SubLObject done_var = assertion_utilities.NIL;
      final SubLObject token_var = assertion_utilities.NIL;
      while ( assertion_utilities.NIL == done_var)
      {
        final SubLObject final_index_spec = iteration.iteration_next_without_values_macro_helper( iterator_var, token_var );
        ...
        if( assertion_utilities.NIL != valid )
        {
          ...
          try
          {
            final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, assertion_utilities.$kw73$RULE, assertion_utilities.NIL, assertion_utilities.NIL );
            SubLObject done_var_$22 = assertion_utilities.NIL;
            final SubLObject token_var_$23 = assertion_utilities.NIL;
            while ( assertion_utilities.NIL == done_var_$22)
            {
              ...
              final SubLObject valid_$24 = SubLObjectFactory.makeBoolean( !token_var_$23.eql( ass ) );
              ...
              done_var_$22 = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid_$24 );
            }
          }
          finally
          {
            ...
            try
            {
              Dynamic.bind( Threads.$is_thread_performing_cleanupP$, assertion_utilities.T );
              final SubLObject _values = Values.getValuesAsVector();
              if( assertion_utilities.NIL != final_index_iterator )
              {
                kb_mapping_macros.destroy_final_index_iterator( final_index_iterator );
        ...
        done_var = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid );
      }
    }
    ...
    if( assertion_utilities.NIL != kb_mapping_macros.do_term_index_key_validator( fort, assertion_utilities.$kw73$RULE ) )
    {
      ...
      while ( assertion_utilities.NIL == done_var)
      {
        ...
        if( assertion_utilities.NIL != valid )
        {
          ...
          {
            final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, assertion_utilities.$kw73$RULE, assertion_utilities.NIL, assertion_utilities.NIL );
            SubLObject done_var_$25 = assertion_utilities.NIL;
            final SubLObject token_var_$26 = assertion_utilities.NIL;
            while ( assertion_utilities.NIL == done_var_$25)
            {
              ...
              final SubLObject valid_$27 = SubLObjectFactory.makeBoolean( !token_var_$26.eql( ass ) );
              ...
              done_var_$25 = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid_$27 );
            }
          }
          finally
          {
  ...
  public static SubLObject random_assertions(final SubLObject n)
  {
    SubLObject result = assertion_utilities.NIL;
    SubLObject i;
    for( i = assertion_utilities.NIL, i = assertion_utilities.ZERO_INTEGER; i.numL( n ); i = Numbers.add( i, assertion_utilities.ONE_INTEGER ) )
    {
      result = ConsesLow.cons( assertions_high.random_assertion( assertion_utilities.UNPROVIDED ), result );
    }
    return result;
  }
  ...
  public static SubLObject earliest_assertion(final SubLObject assertions)
  {
    ...
    final SubLObject dates = Mapping.mapcar( assertion_utilities.$sym74$ASSERTED_WHEN, assertions );
    if( assertion_utilities.NIL == list_utilities.every_in_list( assertion_utilities.$sym75$INTEGERP, dates, assertion_utilities.UNPROVIDED ) )
    {
      return assertion_utilities.NIL;
    }
    final SubLObject earliest_date = number_utilities.minimum( dates, assertion_utilities.UNPROVIDED );
    SubLObject earliest_date_assertions = assertion_utilities.NIL;
    SubLObject cdolist_list_var = assertions;
    SubLObject ass = assertion_utilities.NIL;
    ...
    final SubLObject times = Mapping.mapcar( assertion_utilities.$sym76$ASSERTED_SECOND, earliest_date_assertions );
    if( assertion_utilities.NIL == list_utilities.every_in_list( assertion_utilities.$sym75$INTEGERP, times, assertion_utilities.UNPROVIDED ) )
    {
      return assertion_utilities.NIL;
    }
    final SubLObject earliest_time = number_utilities.minimum( times, assertion_utilities.UNPROVIDED );
    SubLObject earliest_time_assertions = assertion_utilities.NIL;
    SubLObject cdolist_list_var2 = earliest_date_assertions;
    SubLObject ass2 = assertion_utilities.NIL;
  ...
  public static SubLObject rename_assertion_variables(final SubLObject assertion, final SubLObject rename_variable_map)
  {
    ...
    final SubLObject assertion_new_el_variable_names = Mapping.mapcar( assertion_utilities.$sym77$EL_VAR_NAME, assertion_new_el_variables );
  ...
  public static SubLObject assertion_antecedent_query_formula(final SubLObject assertion)
  {
    ...
    final SubLObject antecedent_dnf = clauses.make_dnf( assertion_utilities.NIL, antecedent_lits );
  ...
  public static SubLObject assertion_known_extent_query_formula_int(final SubLObject assertion, final SubLObject known_pred)
  {
    ...
    final SubLObject consequent_dnf = clauses.make_dnf( assertion_utilities.NIL, consequent_lits );
    ...
    final SubLObject query_hl_formula = simplifier.simplify_cycl_sentence( el_utilities.make_conjunction( ConsesLow.list( antecedent_hl_formula, known_consequent_formula ) ),
        assertion_utilities.UNPROVIDED );
  ...
  {
    return ConsesLow.list( fi.assertion_hl_formula( assertion, assertion_utilities.UNPROVIDED ), assertions_high.assertion_mt( assertion ), assertions_high.cyc_assertion_tv( assertion ),
        assertions_high.assertion_direction( assertion ), assertions_high.assertion_arguments( assertion ), assertions_high.gaf_assertionP( assertion ) );
  }
  ...
  public static SubLObject assertion_literal_count(final SubLObject assertion)
  {
    if( assertion_utilities.NIL != assertions_high.gaf_assertionP( assertion ) )
    {
      return assertion_utilities.ONE_INTEGER;
    }
  ...
  public static SubLObject assertion_supporting_assertions(final SubLObject assertion)
  {
    SubLObject result = assertion_utilities.NIL;
    SubLObject cdolist_list_var = assertions_high.assertion_arguments( assertion );
    SubLObject argument = assertion_utilities.NIL;
  ...
  {
    return list_utilities.remove_if_not( assertion_utilities.$sym80$FORWARD_ASSERTION_, assertion_supporting_assertions( assertion ), assertion_utilities.UNPROVIDED,
        assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED );
  }
  ...
  public static SubLObject assertion_cheapest_forward_supporting_assertion(final SubLObject assertion)
  {
    ...
    return ( assertion_utilities.NIL != supporting_forward_assertions ) ? number_utilities.minimum( supporting_forward_assertions, assertion_utilities.$sym81$ASSERTION_DEPENDENT_COUNT )
        : assertion_utilities.NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject v_answer = assertion_utilities.NIL;
    final SubLObject _prev_bind_0 = assertion_utilities.$newest_constant_of_assertions$.currentBinding( thread );
    try
    {
      assertion_utilities.$newest_constant_of_assertions$.bind( assertion_utilities.NIL, thread );
      initialize_newest_constant_table();
      final SubLObject idx = constant_handles.do_constants_table();
      final SubLObject mess = assertion_utilities.$str82$Sorting_newest_constants___Part_2;
      final SubLObject total = id_index.id_index_count( idx );
      SubLObject sofar = assertion_utilities.ZERO_INTEGER;
      ...
      try
      {
        ...
        try
        {
          ...
          if( assertion_utilities.NIL == id_index.id_index_objects_empty_p( idx_$30, assertion_utilities.$kw84$SKIP ) )
          {
            final SubLObject idx_$31 = idx_$30;
            if( assertion_utilities.NIL == id_index.id_index_dense_objects_empty_p( idx_$31, assertion_utilities.$kw84$SKIP ) )
            {
              final SubLObject vector_var = id_index.id_index_dense_objects( idx_$31 );
              final SubLObject backwardP_var = assertion_utilities.NIL;
              SubLObject length;
              ...
              SubLObject ass;
              for( length = Sequences.length( vector_var ), v_iteration = assertion_utilities.NIL, v_iteration = assertion_utilities.ZERO_INTEGER; v_iteration.numL(
                  length ); v_iteration = Numbers.add( v_iteration, assertion_utilities.ONE_INTEGER ) )
              {
                id = ( ( assertion_utilities.NIL != backwardP_var ) ? Numbers.subtract( length, v_iteration, assertion_utilities.ONE_INTEGER ) : v_iteration );
                constant = Vectors.aref( vector_var, id );
                if( assertion_utilities.NIL == id_index.id_index_tombstone_p( constant ) || assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) )
                {
                  if( assertion_utilities.NIL != id_index.id_index_tombstone_p( constant ) )
                  {
                    constant = assertion_utilities.$kw84$SKIP;
                  }
                  assertions = ( cdolist_list_var = Hashtables.gethash( constant, assertion_utilities.$newest_constant_of_assertions$.getDynamicValue( thread ), assertion_utilities.NIL ) );
                  ass = assertion_utilities.NIL;
                  ass = cdolist_list_var.first();
                  while ( assertion_utilities.NIL != cdolist_list_var)
                  {
                  ...
                  sofar = Numbers.add( sofar, assertion_utilities.ONE_INTEGER );
                  utilities_macros.note_percent_progress( sofar, total );
                }
              }
            }
            final SubLObject idx_$32 = idx_$30;
            if( assertion_utilities.NIL == id_index.id_index_sparse_objects_empty_p( idx_$32 ) || assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) )
            {
              ...
              final SubLObject v_default = ( assertion_utilities.NIL != id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) ) ? assertion_utilities.NIL
                  : assertion_utilities.$kw84$SKIP;
              while ( id2.numL( end_id ))
              {
                final SubLObject constant2 = Hashtables.gethash_without_values( id2, sparse, v_default );
                if( assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) || assertion_utilities.NIL == id_index.id_index_tombstone_p( constant2 ) )
                {
                  SubLObject cdolist_list_var2;
                  final SubLObject assertions2 = cdolist_list_var2 = Hashtables.gethash( constant2, assertion_utilities.$newest_constant_of_assertions$.getDynamicValue( thread ), assertion_utilities.NIL );
                  SubLObject ass2 = assertion_utilities.NIL;
                  ass2 = cdolist_list_var2.first();
                  while ( assertion_utilities.NIL != cdolist_list_var2)
                  {
                ...
                id2 = Numbers.add( id2, assertion_utilities.ONE_INTEGER );
              }
            }
          }
        }
  ...
  {
    SubLObject newest_suid = assertion_utilities.MINUS_ONE_INTEGER;
    SubLObject cdolist_list_var;
    final SubLObject constants = cdolist_list_var = assertions_high.assertion_constants( assertion );
    SubLObject constant = assertion_utilities.NIL;
    constant = cdolist_list_var.first();
    while ( assertion_utilities.NIL != cdolist_list_var)
    {
      if( assertion_utilities.NIL != constant_handles.valid_constantP( constant, assertion_utilities.UNPROVIDED ) )
      {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    assertion_utilities.$newest_constant_of_assertions$.setDynamicValue( Hashtables.make_hash_table( constant_handles.constant_count(), Symbols.symbol_function( assertion_utilities.EQL ),
        assertion_utilities.UNPROVIDED ), thread );
    final SubLObject idx = assertion_handles.do_assertions_table();
    final SubLObject mess = assertion_utilities.$str85$Computing_newest_constants;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = assertion_utilities.ZERO_INTEGER;
    assert assertion_utilities.NIL != Types.stringp( mess ) : mess;
    ...
    try
    {
      ...
      try
      {
        ...
        if( assertion_utilities.NIL == id_index.id_index_objects_empty_p( idx_$34, assertion_utilities.$kw84$SKIP ) )
        {
          final SubLObject idx_$35 = idx_$34;
          if( assertion_utilities.NIL == id_index.id_index_dense_objects_empty_p( idx_$35, assertion_utilities.$kw84$SKIP ) )
          {
            ...
            for( length = Sequences.length( vector_var ), v_iteration = assertion_utilities.NIL, v_iteration = assertion_utilities.ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers
                .add( v_iteration, assertion_utilities.ONE_INTEGER ) )
            {
              a_id = ( ( assertion_utilities.NIL != backwardP_var ) ? Numbers.subtract( length, v_iteration, assertion_utilities.ONE_INTEGER ) : v_iteration );
              a_handle = Vectors.aref( vector_var, a_id );
              if( assertion_utilities.NIL == id_index.id_index_tombstone_p( a_handle ) || assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) )
              {
                if( assertion_utilities.NIL != id_index.id_index_tombstone_p( a_handle ) )
                {
                  a_handle = assertion_utilities.$kw84$SKIP;
                }
                ass = assertion_handles.resolve_assertion_id_value_pair( a_id, a_handle );
                newest_constant = assertion_newest_constant( ass );
                Hashtables.sethash( newest_constant, assertion_utilities.$newest_constant_of_assertions$.getDynamicValue( thread ), ConsesLow.cons( ass, Hashtables.gethash( newest_constant,
                    assertion_utilities.$newest_constant_of_assertions$.getDynamicValue( thread ), assertion_utilities.NIL ) ) );
                sofar = Numbers.add( sofar, assertion_utilities.ONE_INTEGER );
                utilities_macros.note_percent_progress( sofar, total );
              }
            }
          ...
          if( assertion_utilities.NIL == id_index.id_index_sparse_objects_empty_p( idx_$36 ) || assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) )
          {
            ...
            while ( a_id2.numL( end_id ))
            {
              ...
              if( assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) || assertion_utilities.NIL == id_index.id_index_tombstone_p( a_handle2 ) )
              {
                ...
                Hashtables.sethash( newest_constant2, assertion_utilities.$newest_constant_of_assertions$.getDynamicValue( thread ), ConsesLow.cons( ass2, Hashtables.gethash( newest_constant2,
                    assertion_utilities.$newest_constant_of_assertions$.getDynamicValue( thread ), assertion_utilities.NIL ) ) );
                sofar = Numbers.add( sofar, assertion_utilities.ONE_INTEGER );
                utilities_macros.note_percent_progress( sofar, total );
              }
              a_id2 = Numbers.add( a_id2, assertion_utilities.ONE_INTEGER );
            }
          }
        }
      }
    ...
    try
    {
      utilities_macros.$progress_note$.bind( assertion_utilities.$str86$Sorting_newest_constants___Part_1, thread );
      utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
      utilities_macros.$progress_total$.bind( Hashtables.hash_table_count( table_var ), thread );
      utilities_macros.$progress_sofar$.bind( assertion_utilities.ZERO_INTEGER, thread );
      utilities_macros.$last_percent_progress_index$.bind( assertion_utilities.ZERO_INTEGER, thread );
      utilities_macros.$last_percent_progress_prediction$.bind( assertion_utilities.NIL, thread );
      utilities_macros.$within_noting_percent_progress$.bind( assertion_utilities.T, thread );
      utilities_macros.$percent_progress_start_time$.bind( Time.get_universal_time(), thread );
      try
      {
        ...
        SubLObject constant = assertion_utilities.NIL;
        SubLObject assertions = assertion_utilities.NIL;
        ...
        try
        {
          while ( Hashtables.iteratorHasNext( cdohash_iterator ))
          {
            ...
            utilities_macros.$progress_sofar$.setDynamicValue( Numbers.add( utilities_macros.$progress_sofar$.getDynamicValue( thread ), assertion_utilities.ONE_INTEGER ), thread );
  ...
  public static SubLObject all_meta_assertions(final SubLObject assertion)
  {
    ...
    final SubLObject meta_assertions = kb_accessors.all_term_assertions( assertion, assertion_utilities.UNPROVIDED );
    return Sequences.delete_duplicates( ConsesLow.nconc( meta_assertions, Mapping.mapcan( Symbols.symbol_function( assertion_utilities.$sym92$ALL_META_ASSERTIONS ), meta_assertions,
        assertion_utilities.EMPTY_SUBL_OBJECT_ARRAY ) ), assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED,
        assertion_utilities.UNPROVIDED );
  }
  ...
  public static SubLObject meta_assertion_list_for_editing(final SubLObject assertion)
  {
    ...
    SubLObject meta_assertion_list = assertion_utilities.NIL;
    SubLObject cdolist_list_var = meta_assertions;
    SubLObject meta_assertion = assertion_utilities.NIL;
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertion_handles.assertion_p( assertion ) && assertion_utilities.NIL != cycl_utilities.assertion_find_if(
        assertion_utilities.$sym40$ASSERTION_P, assertion, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertion_handles.assertion_p( assertion ) && assertion_utilities.NIL != cycl_utilities.assertion_find_if(
        assertion_utilities.$sym93$RULE_ASSERTION_, assertion, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED ) );
  }
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != assertions_high.rule_assertionP( assertion ) && assertion_utilities.NIL != rule_meta_assertion_p( assertion )
        && assertion_utilities.NIL != removal_modules_formula_arg_n.formula_has_operatorP( clauses.pos_lits( assertions_high.assertion_cnf( assertion ) ).first(),
            assertion_utilities.$const94$meetsPragmaticRequirement ) );
  }
  ...
  public static SubLObject meta_assertion_el_formula(final SubLObject meta_assertion, final SubLObject assertion, final SubLObject assertion_indexical)
  {
    ...
    if( assertion_utilities.NIL != cycl_utilities.expression_find( assertion, assertions_high.assertion_cons( meta_assertion ), assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED,
        assertion_utilities.UNPROVIDED ) )
    {
      if( assertion_utilities.NIL != hlmt.hlmt_equal( assertions_high.assertion_mt( assertion ), assertions_high.assertion_mt( meta_assertion ) ) )
      {
        ...
        meta_assertion_el_formula = cycl_utilities.expression_subst( assertion_indexical, assertion_el_formula, meta_assertion_el_formula, Symbols.symbol_function( assertion_utilities.EQUAL ),
            assertion_utilities.UNPROVIDED );
      }
      else
      {
        final SubLObject assertion_el_ist_formula = uncanonicalizer.assertion_el_ist_formula( assertion );
        meta_assertion_el_formula = cycl_utilities.expression_subst( assertion_indexical, assertion_el_ist_formula, meta_assertion_el_formula, Symbols.symbol_function( assertion_utilities.EQUAL ),
            assertion_utilities.UNPROVIDED );
      }
    }
  ...
  public static SubLObject mt_of_assertions_p(final SubLObject mt, final SubLObject assertions)
  {
    ...
    SubLObject mal_mtP = assertion_utilities.NIL;
    if( assertion_utilities.NIL == mal_mtP )
    {
      SubLObject csome_list_var;
      SubLObject assertion;
      for( csome_list_var = assertions, assertion = assertion_utilities.NIL, assertion = csome_list_var.first(); assertion_utilities.NIL == mal_mtP
          && assertion_utilities.NIL != csome_list_var; mal_mtP = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == hlmt.hlmt_equal( mt, assertions_high.assertion_mt(
              assertion ) ) ), csome_list_var = csome_list_var.rest(), assertion = csome_list_var.first() )
      {
      }
    }
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL == mal_mtP );
  }
  ...
  public static SubLObject mts_of_assertions(final SubLObject assertions)
  {
    ...
    return list_utilities.fast_delete_duplicates( result, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED,
        assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED );
  }
  ...
  {
    final SubLObject mts = genl_mts.min_mts( Mapping.mapcar( assertion_utilities.$sym98$ASSERTION_MT, assertions ), assertion_utilities.UNPROVIDED );
  ...
  {
    return Sort.sort( assertions, Symbols.symbol_function( assertion_utilities.$sym99$SAFE__ ), Symbols.symbol_function( assertion_utilities.$sym100$ASSERTION_ID ) );
  }
  ...
  public static SubLObject sort_gafs_by_term(SubLObject gafs, SubLObject term_sort_func, SubLObject pred_sort_func)
  {
    ...
    {
      term_sort_func = assertion_utilities.$sym101$TERM__;
    }
    if( pred_sort_func == assertion_utilities.UNPROVIDED )
    {
      pred_sort_func = assertion_utilities.$sym102$DEFINITIONAL_PRED__;
    }
    gafs = sort_assertions( gafs );
    gafs = Sort.stable_sort( gafs, pred_sort_func, Symbols.symbol_function( assertion_utilities.$sym103$GAF_PREDICATE ) );
    gafs = Sort.stable_sort( gafs, term_sort_func, Symbols.symbol_function( assertion_utilities.$sym104$GAF_ARG1 ) );
    return gafs;
  }
  ...
  public static SubLObject rule_type_constraints(final SubLObject rule)
  {
    ...
    SubLObject constraints = assertion_utilities.NIL;
    ...
    try
    {
      at_vars.$at_check_inter_arg_isaP$.bind( assertion_utilities.T, thread );
      at_vars.$at_check_inter_arg_genlP$.bind( assertion_utilities.T, thread );
    ...
    constraints = Sequences.remove_if( assertion_utilities.$sym105$ISA_HL_VAR_THING_LIT_, constraints, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED,
        assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED );
    if( assertion_utilities.NIL != constraints && assertion_utilities.NIL != cycl_utilities.formula_args( constraints, assertion_utilities.UNPROVIDED ) )
    {
      ...
      {
        Errors.warn( assertion_utilities.$str106$Type_constraint__Mt_should_be_can, mt, new_mt );
      }
      ...
      {
        Errors.error( assertion_utilities.$str107$Expected_a_single_DNF_clause_of_c, rule, dnf_constraint_clauses );
      }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( assertion_utilities.$cached_self_looping_rule_assertionP_caching_state$.getGlobalValue(), ConsesLow.list( rule ),
        assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED );
  }
  ...
  public static SubLObject cached_self_looping_rule_assertionP_internal(final SubLObject rule)
  {
    ...
    while ( assertion_utilities.NIL != cdolist_list_var)
    {
      ...
      SubLObject neg_lit = assertion_utilities.NIL;
  ...
  public static SubLObject cached_self_looping_rule_assertionP(final SubLObject rule)
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( assertion_utilities.$sym108$CACHED_SELF_LOOPING_RULE_ASSERTION_,
          assertion_utilities.$sym109$_CACHED_SELF_LOOPING_RULE_ASSERTION__CACHING_STATE_, assertion_utilities.NIL, assertion_utilities.EQL,
          assertion_utilities.ONE_INTEGER, assertion_utilities.ZERO_INTEGER );
    }
    ...
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      ...
      memoization_state.caching_state_put( caching_state, rule, results, assertion_utilities.UNPROVIDED );
    }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( assertion_utilities.$cached_self_expanding_rule_assertionP_caching_state$.getGlobalValue(), ConsesLow.list( rule ),
        assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED );
  }
  ...
  public static SubLObject cached_self_expanding_rule_assertionP_internal(final SubLObject rule)
  {
    ...
    SubLObject cdolist_list_var;
    SubLObject neg_lit;
    for( witness = assertion_utilities.NIL, rest = assertion_utilities.NIL, rest = clauses.pos_lits( cnf ); assertion_utilities.NIL == witness && assertion_utilities.NIL != rest; rest = rest
        .rest() )
    {
      pos_lit = rest.first();
      count = assertion_utilities.ZERO_INTEGER;
      cdolist_list_var = clauses.neg_lits( cnf );
      neg_lit = assertion_utilities.NIL;
      ...
      if( count.numGE( assertion_utilities.TWO_INTEGER ) )
      {
        witness = pos_lit;
      }
    }
  ...
  public static SubLObject cached_self_expanding_rule_assertionP(final SubLObject rule)
  {
    ...
    if( assertion_utilities.NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( assertion_utilities.$sym110$CACHED_SELF_EXPANDING_RULE_ASSERTION_,
          assertion_utilities.$sym111$_CACHED_SELF_EXPANDING_RULE_ASSERTION__CACHING_STATE_, assertion_utilities.NIL, assertion_utilities.EQL,
          assertion_utilities.ONE_INTEGER, assertion_utilities.ZERO_INTEGER );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, rule, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
  ...
  public static SubLObject safe_all_forward_rules_relevant_to_term(final SubLObject fort)
  {
    ...
    SubLObject rules = assertion_utilities.NIL;
    SubLObject threshold_exceededP = assertion_utilities.NIL;
    try
    {
      ...
      try
      {
        assertion_utilities.$within_safe_all_forward_rules_relevant_to_termP$.bind( assertion_utilities.T, thread );
    ...
    {
      threshold_exceededP = Errors.handleThrowable( ccatch_env_var, assertion_utilities.$kw114$ALL_FORWARD_RULES_RELEVANT_TO_TERMS_THRESHOLD_EXCEEDED );
    }
    finally
    {
      thread.throwStack.pop();
    }
    rules = Sort.sort( rules, Symbols.symbol_function( assertion_utilities.$sym115$_ ), Symbols.symbol_function( assertion_utilities.$sym81$ASSERTION_DEPENDENT_COUNT ) );
    if( assertion_utilities.NIL != threshold_exceededP )
    {
      return assertion_utilities.$kw116$ALL;
    }
    return rules;
  }
  ...
  {
    return possibly_safe_all_forward_rules_relevant_to_terms( v_forts, assertion_utilities.T );
  }
  ...
  {
    return possibly_safe_all_forward_rules_relevant_to_terms( v_forts, assertion_utilities.NIL );
  }
  ...
  public static SubLObject possibly_safe_all_forward_rules_relevant_to_terms(final SubLObject v_forts, final SubLObject safeP)
  {
    ...
    SubLObject elem = assertion_utilities.NIL;
    ...
    SubLObject fort = assertion_utilities.NIL;
    fort = cdolist_list_var.first();
    while ( assertion_utilities.NIL != cdolist_list_var)
    {
      SubLObject cdolist_list_var_$40 = possibly_safe_all_forward_rules_relevant_to_term( fort, safeP );
      SubLObject rule = assertion_utilities.NIL;
      rule = cdolist_list_var_$40.first();
      while ( assertion_utilities.NIL != cdolist_list_var_$40)
      {
        final SubLObject item_var = rule;
        if( assertion_utilities.NIL == conses_high.member( item_var, rules, Symbols.symbol_function( assertion_utilities.EQL ), Symbols.symbol_function( assertion_utilities.IDENTITY ) ) )
        {
  ...
  {
    SubLObject forward_rules = assertion_utilities.NIL;
    SubLObject cdolist_list_var = deductions_high.deduction_supports( deduction );
    SubLObject support = assertion_utilities.NIL;
  ...
  public static SubLObject all_forward_rules_relevant_to_term_int(final SubLObject fort)
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( assertion_utilities.$sym58$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( assertion_utilities.$const59$EverythingPSC, thread );
      assertion_utilities.$all_forward_rules_relevant_to_term_argument_set$.bind( set.new_set( Symbols.symbol_function( assertion_utilities.EQL ), assertion_utilities.UNPROVIDED ), thread );
      assertion_utilities.$all_forward_rules_relevant_to_term_dependent_set$.bind( set.new_set( Symbols.symbol_function( assertion_utilities.EQL ), assertion_utilities.UNPROVIDED ), thread );
      assertion_utilities.$all_forward_rules_relevant_to_term_nart_set$.bind( set.new_set( Symbols.symbol_function( assertion_utilities.EQL ), assertion_utilities.UNPROVIDED ), thread );
      assertion_utilities.$all_forward_rules_relevant_to_term_result_set$.bind( set.new_set( Symbols.symbol_function( assertion_utilities.EQL ), assertion_utilities.UNPROVIDED ), thread );
      compute_all_forward_rules_relevant_to_term( fort, assertion_utilities.$list118 );
  ...
  {
    if( assertion_utilities.NIL != kb_mapping_macros.do_term_index_key_validator( fort, assertion_utilities.NIL ) )
    {
      final SubLObject iterator_var = kb_mapping_macros.new_term_final_index_spec_iterator( fort, assertion_utilities.NIL );
      SubLObject done_var = assertion_utilities.NIL;
      final SubLObject token_var = assertion_utilities.NIL;
      while ( assertion_utilities.NIL == done_var)
      {
        ...
        if( assertion_utilities.NIL != valid )
        {
          ...
          try
          {
            final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, assertion_utilities.NIL, assertion_utilities.NIL, assertion_utilities.NIL );
            SubLObject done_var_$41 = assertion_utilities.NIL;
            final SubLObject token_var_$42 = assertion_utilities.NIL;
            while ( assertion_utilities.NIL == done_var_$41)
            {
              ...
              if( assertion_utilities.NIL != valid_$43 && assertion_utilities.NIL != kb_mapping_macros.do_term_index_assertion_match_p( assertion, final_index_spec ) )
              {
                ...
                SubLObject walk_direction = assertion_utilities.NIL;
              ...
              done_var_$41 = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid_$43 );
            }
          }
          finally
          {
  ...
  public static SubLObject compute_all_forward_rules_relevant_to_assertion(final SubLObject assertion, final SubLObject walk_direction)
  {
    ...
    if( assertion_utilities.NIL == assertions_high.forward_deduced_assertionP( assertion, assertion_utilities.NIL ) )
    {
      return assertion_utilities.NIL;
    }
    if( walk_direction.eql( assertion_utilities.$kw120$ARGUMENT_ ) )
    {
    ...
    else if( walk_direction.eql( assertion_utilities.$kw121$DEPENDENT_ ) )
    {
    ...
    SubLObject cdolist_list_var = cycl_utilities.expression_narts( assertion, assertion_utilities.T, assertion_utilities.UNPROVIDED );
    SubLObject nart = assertion_utilities.NIL;
  ...
  public static SubLObject compute_all_forward_rules_relevant_to_assertion_int(final SubLObject assertion, final SubLObject walk_direction)
  {
    ...
    while ( assertion_utilities.NIL != cdolist_list_var)
    {
      if( assertion_utilities.NIL != deduction_handles.deduction_p( argument ) )
      {
        ...
        if( assertion_utilities.NIL != assertion_utilities.$within_safe_all_forward_rules_relevant_to_termP$.getDynamicValue( thread ) )
        {
          ...
          {
            Dynamic.sublisp_throw( assertion_utilities.$kw114$ALL_FORWARD_RULES_RELEVANT_TO_TERMS_THRESHOLD_EXCEEDED, size );
          }
        }
      }
      cdolist_list_var = cdolist_list_var.rest();
    ...
    if( walk_direction.eql( assertion_utilities.$kw120$ARGUMENT_ ) )
    {
      ...
      SubLObject argument2 = assertion_utilities.NIL;
  ...
  public static SubLObject deduction_asserted_assertion_supports(final SubLObject deduction, SubLObject depth_limit)
  {
    ...
    {
      depth_limit = assertion_utilities.ZERO_INTEGER;
    }
    final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    try
    {
      assertion_utilities.$deduction_asserted_assertion_supports_deductions_processed$.bind( dictionary.new_dictionary( assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED ),
          thread );
      assertion_utilities.$deduction_asserted_assertion_counts$.bind( dictionary.new_dictionary( assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED ), thread );
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( assertion_utilities.NIL != dictionary.dictionary_lookup( assertion_utilities.$deduction_asserted_assertion_supports_deductions_processed$.getDynamicValue( thread ), deduction,
        assertion_utilities.UNPROVIDED ) )
    {
      return assertion_utilities.NIL;
    }
    dictionary.dictionary_enter( assertion_utilities.$deduction_asserted_assertion_supports_deductions_processed$.getDynamicValue( thread ), deduction, assertion_utilities.T );
    SubLObject supports_to_descend = deductions_high.deduction_supports( deduction );
    SubLObject deductions_to_descend = assertion_utilities.NIL;
    SubLObject done_supports = assertion_utilities.NIL;
    SubLObject support = assertion_utilities.NIL;
    while ( assertion_utilities.NIL != supports_to_descend)
    {
      ...
      {
        dictionary_utilities.dictionary_increment( assertion_utilities.$deduction_asserted_assertion_counts$.getDynamicValue( thread ), support, assertion_utilities.UNPROVIDED );
      }
      else if( assertion_utilities.NIL != assertion_handles.assertion_p( support ) && assertion_utilities.NIL != assertions_high.deduced_assertionP( support ) )
      {
        ...
        while ( assertion_utilities.NIL != cdolist_list_var)
        {
          ...
          else if( assertion_utilities.NIL != deduction_handles.deduction_p( argument ) )
          {
            ...
            if( assertion_utilities.NIL == conses_high.member( item_var, deductions_to_descend, Symbols.symbol_function( assertion_utilities.EQL ), Symbols.symbol_function(
                assertion_utilities.IDENTITY ) ) )
            {
          ...
          {
            Errors.sublisp_break( assertion_utilities.$str122$can_t_handle_argument__S_yet, new SubLObject[] { argument
            } );
          }
          cdolist_list_var = cdolist_list_var.rest();
          argument = cdolist_list_var.first();
      ...
      else
      {
        ...
        SubLObject sub_support = assertion_utilities.NIL;
        ...
        while ( assertion_utilities.NIL != cdolist_list_var)
        {
          ...
          else if( assertion_utilities.NIL != arguments.support_p( sub_support ) )
          {
            ...
            {
              final SubLObject item_var = sub_support;
              if( assertion_utilities.NIL == conses_high.member( item_var, supports_to_descend, Symbols.symbol_function( assertion_utilities.EQL ), Symbols.symbol_function(
                  assertion_utilities.IDENTITY ) ) )
              {
          ...
          {
            Errors.sublisp_break( assertion_utilities.$str123$can_t_handle_sub_support__S_yet, new SubLObject[] { sub_support
            } );
          }
          cdolist_list_var = cdolist_list_var.rest();
          sub_support = cdolist_list_var.first();
      ...
      if( assertion_utilities.NIL == conses_high.member( item_var2, done_supports, Symbols.symbol_function( assertion_utilities.EQL ), Symbols.symbol_function( assertion_utilities.IDENTITY ) ) )
      {
        done_supports = ConsesLow.cons( item_var2, done_supports );
      }
    }
    if( !depth_limit.eql( assertion_utilities.ONE_INTEGER ) )
    {
      SubLObject cdolist_list_var = deductions_to_descend;
      SubLObject deduction_to_descend = assertion_utilities.NIL;
      deduction_to_descend = cdolist_list_var.first();
      while ( assertion_utilities.NIL != cdolist_list_var)
      {
        deduction_asserted_assertion_supports_int( deduction_to_descend, Numbers.subtract( depth_limit, assertion_utilities.ONE_INTEGER ) );
        cdolist_list_var = cdolist_list_var.rest();
        deduction_to_descend = cdolist_list_var.first();
      }
    }
  ...
  public static SubLObject assertion_asserted_assertion_supports(final SubLObject assertion, SubLObject depth_limit)
  {
    ...
    final SubLObject result = set.new_set( Symbols.symbol_function( assertion_utilities.EQUAL ), assertion_utilities.UNPROVIDED );
  ...
  public static SubLObject gather_all_exception_rules(SubLObject mt)
  {
    ...
    {
      mt = assertion_utilities.NIL;
    }
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject exceptions = set.new_set( Symbols.symbol_function( assertion_utilities.EQL ), assertion_utilities.UNPROVIDED );
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      final SubLObject message_var = assertion_utilities.$str124$gathering_exception_rules;
      ...
      try
      {
        ...
        try
        {
          ...
          SubLObject valid;
          for( SubLObject done_var = assertion_utilities.NIL; assertion_utilities.NIL == done_var; done_var = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid ) )
          {
            thread.resetMultipleValues();
            ...
            if( assertion_utilities.NIL != valid )
            {
              sofar = Numbers.add( sofar, assertion_utilities.ONE_INTEGER );
              utilities_macros.note_percent_progress( sofar, total );
              if( assertion_utilities.NIL != abnormal.rule_has_exceptionsP( rule ) && assertion_utilities.NIL != kb_mapping_macros.do_exception_rule_index_key_validator( rule, assertion_utilities.NIL ) )
              {
                final SubLObject iterator_var_$48 = kb_mapping_macros.new_exception_rule_final_index_spec_iterator( rule, assertion_utilities.NIL );
                SubLObject done_var_$49 = assertion_utilities.NIL;
                final SubLObject token_var = assertion_utilities.NIL;
                while ( assertion_utilities.NIL == done_var_$49)
                {
                  ...
                  final SubLObject valid_$50 = SubLObjectFactory.makeBoolean( !token_var.eql( final_index_spec ) );
                  if( assertion_utilities.NIL != valid_$50 )
                  {
                    SubLObject final_index_iterator = assertion_utilities.NIL;
                    try
                    {
                      final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, assertion_utilities.$kw73$RULE, assertion_utilities.NIL,
                          assertion_utilities.NIL );
                      SubLObject done_var_$50 = assertion_utilities.NIL;
                      final SubLObject token_var_$52 = assertion_utilities.NIL;
                      while ( assertion_utilities.NIL == done_var_$50)
                      {
                        ...
                        final SubLObject valid_$51 = SubLObjectFactory.makeBoolean( !token_var_$52.eql( except ) );
                        if( assertion_utilities.NIL != valid_$51 )
                        {
                          set.set_add( except, exceptions );
                        }
                        done_var_$50 = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid_$51 );
                      }
                    }
                    finally
                    {
                  ...
                  done_var_$49 = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid_$50 );
                }
              }
            }
          }
  ...
  public static SubLObject gather_all_pragma_rules(SubLObject mt)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject pragmas = set.new_set( Symbols.symbol_function( assertion_utilities.EQL ), assertion_utilities.UNPROVIDED );
    final SubLObject mt_var = mt;
    final SubLObject _prev_bind_0 = mt_relevance_macros.$mt$.currentBinding( thread );
    final SubLObject _prev_bind_2 = mt_relevance_macros.$relevant_mt_function$.currentBinding( thread );
    final SubLObject _prev_bind_3 = mt_relevance_macros.$relevant_mts$.currentBinding( thread );
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      final SubLObject message_var = assertion_utilities.$str125$gathering_pragma_rules;
      final SubLObject total = assertions_low.rule_count();
      SubLObject sofar = assertion_utilities.ZERO_INTEGER;
        ...
        try
        {
          ...
          for( SubLObject done_var = assertion_utilities.NIL; assertion_utilities.NIL == done_var; done_var = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid ) )
          {
            ...
            if( assertion_utilities.NIL != valid )
            {
              sofar = Numbers.add( sofar, assertion_utilities.ONE_INTEGER );
              utilities_macros.note_percent_progress( sofar, total );
              if( assertion_utilities.NIL != inference_worker_transformation.rule_assertion_has_some_pragmatic_requirementP( rule, assertion_utilities.UNPROVIDED )
                  && assertion_utilities.NIL != kb_mapping_macros.do_pragma_rule_index_key_validator( rule, assertion_utilities.NIL ) )
              {
                final SubLObject iterator_var_$59 = kb_mapping_macros.new_pragma_rule_final_index_spec_iterator( rule, assertion_utilities.NIL );
                SubLObject done_var_$60 = assertion_utilities.NIL;
                final SubLObject token_var = assertion_utilities.NIL;
                while ( assertion_utilities.NIL == done_var_$60)
                {
                  ...
                  final SubLObject valid_$61 = SubLObjectFactory.makeBoolean( !token_var.eql( final_index_spec ) );
                  if( assertion_utilities.NIL != valid_$61 )
                  {
                    ...
                    try
                    {
                      final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, assertion_utilities.$kw73$RULE, assertion_utilities.NIL,
                          assertion_utilities.NIL );
                      SubLObject done_var_$61 = assertion_utilities.NIL;
                      final SubLObject token_var_$63 = assertion_utilities.NIL;
                      while ( assertion_utilities.NIL == done_var_$61)
                      {
                        ...
                        final SubLObject valid_$62 = SubLObjectFactory.makeBoolean( !token_var_$63.eql( pragma ) );
                        if( assertion_utilities.NIL != valid_$62 )
                        {
                          set.set_add( pragma, pragmas );
                        }
                        done_var_$61 = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid_$62 );
                      }
                    }
                    finally
                    {
                  ...
                  done_var_$60 = SubLObjectFactory.makeBoolean( assertion_utilities.NIL == valid_$61 );
                }
              }
            }
          }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject lifting_rules = set.new_set( Symbols.symbol_function( assertion_utilities.EQL ), assertion_utilities.UNPROVIDED );
    final SubLObject _prev_bind_0 = mt_relevance_macros.$relevant_mt_function$.currentBinding( thread );
    final SubLObject _prev_bind_2 = mt_relevance_macros.$mt$.currentBinding( thread );
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( assertion_utilities.$sym58$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( assertion_utilities.$const59$EverythingPSC, thread );
      final SubLObject message_var = assertion_utilities.$str126$gathering_lifting_rules;
      final SubLObject total = assertions_low.rule_count();
      SubLObject sofar = assertion_utilities.ZERO_INTEGER;
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL != lifting_consequent_ruleP( rule ) && assertion_utilities.NIL != kb_mapping_utilities.fpred_value_in_any_mt( rule,
        assertion_utilities.$const128$universalLiftingRule, assertion_utilities.ONE_INTEGER, assertion_utilities.ONE_INTEGER, assertion_utilities.UNPROVIDED ) );
  }
  ...
  public static SubLObject rule_has_unlabelled_dont_care_variableP(final SubLObject rule)
  {
    ...
    SubLObject list_var = assertion_utilities.NIL;
    SubLObject name = assertion_utilities.NIL;
    SubLObject id = assertion_utilities.NIL;
    list_var = names;
    name = list_var.first();
    for( id = assertion_utilities.ZERO_INTEGER; assertion_utilities.NIL != list_var; list_var = list_var.rest(), name = list_var.first(), id = Numbers.add( assertion_utilities.ONE_INTEGER,
        id ) )
    {
      final SubLObject variable = variables.find_variable_by_id( id );
      SubLObject lit_count = assertion_utilities.ZERO_INTEGER;
      SubLObject cdolist_list_var = clauses.neg_lits( cnf );
      SubLObject lit = assertion_utilities.NIL;
      lit = cdolist_list_var.first();
      while ( assertion_utilities.NIL != cdolist_list_var)
      {
        if( assertion_utilities.NIL != cycl_utilities.expression_find( variable, lit, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED,
            assertion_utilities.UNPROVIDED ) )
        {
          lit_count = Numbers.add( lit_count, assertion_utilities.ONE_INTEGER );
        }
        cdolist_list_var = cdolist_list_var.rest();
        lit = cdolist_list_var.first();
      }
      cdolist_list_var = clauses.pos_lits( cnf );
      lit = assertion_utilities.NIL;
      lit = cdolist_list_var.first();
      while ( assertion_utilities.NIL != cdolist_list_var)
      {
        if( assertion_utilities.NIL != cycl_utilities.expression_find( variable, lit, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED,
      ...
      if( assertion_utilities.ONE_INTEGER.numE( lit_count ) && assertion_utilities.NIL == string_utilities.starts_with( name, assertion_utilities.$str129$__ ) )
      {
        return variable;
      }
    }
  ...
  public static SubLObject rule_unlabelled_dont_care_variables(final SubLObject rule)
  {
    ...
    final SubLObject cnf = assertions_high.assertion_cnf( rule );
    final SubLObject names = assertions_high.assertion_variable_names( rule );
    SubLObject unlabelled_dont_care_variables = assertion_utilities.NIL;
    final SubLObject _prev_bind_0 = cycl_utilities.$opaque_arg_function$.currentBinding( thread );
    try
    {
      cycl_utilities.$opaque_arg_function$.bind( assertion_utilities.$sym130$FALSE, thread );
      SubLObject list_var = assertion_utilities.NIL;
      SubLObject name = assertion_utilities.NIL;
      SubLObject id = assertion_utilities.NIL;
      list_var = names;
  ...
  public static SubLObject embedded_assertions(final SubLObject assertion, SubLObject include_selfP, SubLObject penetrate_hl_structuresP)
  {
    ...
    {
      include_selfP = assertion_utilities.NIL;
    }
    if( penetrate_hl_structuresP == assertion_utilities.UNPROVIDED )
    {
      penetrate_hl_structuresP = assertion_utilities.NIL;
    }
    final SubLObject embedded_assertions = ( assertion_utilities.NIL != include_selfP ) ? cycl_utilities.expression_gather( assertion, assertion_utilities.$sym40$ASSERTION_P,
        assertion_utilities.T, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED )
        : cycl_utilities.expression_gather( fi.assertion_hl_formula( assertion, assertion_utilities.UNPROVIDED ), assertion_utilities.$sym40$ASSERTION_P, penetrate_hl_structuresP,
            assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED );
  ...
  public static SubLObject embedded_assertions_findable_by_idP(final SubLObject assertion, SubLObject include_selfP)
  {
    ...
    SubLObject cdolist_list_var;
    final SubLObject embedded_assertions = cdolist_list_var = embedded_assertions( assertion, include_selfP, assertion_utilities.UNPROVIDED );
    SubLObject embedded_assertion = assertion_utilities.NIL;
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject hosed_assertions = assertion_utilities.NIL;
    final SubLObject idx = assertion_handles.do_assertions_table();
    final SubLObject mess = assertion_utilities.$str131$Verifying_that_all_embedded_asser;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = assertion_utilities.ZERO_INTEGER;
    assert assertion_utilities.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( assertion_utilities.NIL == id_index.id_index_objects_empty_p( idx_$70, assertion_utilities.$kw84$SKIP ) )
        {
          final SubLObject idx_$71 = idx_$70;
          if( assertion_utilities.NIL == id_index.id_index_dense_objects_empty_p( idx_$71, assertion_utilities.$kw84$SKIP ) )
          {
                ...
                .add( v_iteration, assertion_utilities.ONE_INTEGER ) )
            {
              ...
              if( assertion_utilities.NIL == id_index.id_index_tombstone_p( a_handle ) || assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) )
              {
                ...
                ass = assertion_handles.resolve_assertion_id_value_pair( a_id, a_handle );
                if( assertion_utilities.NIL != meta_assertion_p( ass ) && assertion_utilities.NIL == embedded_assertions_findable_by_idP( ass, assertion_utilities.NIL ) )
                {
          ...
          if( assertion_utilities.NIL == id_index.id_index_sparse_objects_empty_p( idx_$72 ) || assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) )
          {
            ...
            while ( a_id2.numL( end_id ))
            {
              ...
              {
                final SubLObject ass2 = assertion_handles.resolve_assertion_id_value_pair( a_id2, a_handle2 );
                if( assertion_utilities.NIL != meta_assertion_p( ass2 ) && assertion_utilities.NIL == embedded_assertions_findable_by_idP( ass2, assertion_utilities.NIL ) )
                {
  ...
  public static SubLObject assertions_with_no_arguments(SubLObject verboseP)
  {
    ...
    {
      verboseP = assertion_utilities.T;
    }
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject assertions = assertion_utilities.NIL;
    final SubLObject idx = assertion_handles.do_assertions_table();
    final SubLObject mess = assertion_utilities.$str132$Looking_for_assertions_with_no_ar;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = assertion_utilities.ZERO_INTEGER;
    assert assertion_utilities.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( assertion_utilities.NIL == id_index.id_index_objects_empty_p( idx_$74, assertion_utilities.$kw84$SKIP ) )
        {
          final SubLObject idx_$75 = idx_$74;
          if( assertion_utilities.NIL == id_index.id_index_dense_objects_empty_p( idx_$75, assertion_utilities.$kw84$SKIP ) )
          {
                ...
                .add( v_iteration, assertion_utilities.ONE_INTEGER ) )
            {
              ...
              if( assertion_utilities.NIL == id_index.id_index_tombstone_p( a_handle ) || assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) )
              {
                ...
                if( assertion_utilities.NIL == assertions_high.assertion_arguments( ass ) )
                {
                  ...
                  {
                    print_high.print( ass, assertion_utilities.UNPROVIDED );
                    streams_high.force_output( assertion_utilities.UNPROVIDED );
                  }
          ...
          if( assertion_utilities.NIL == id_index.id_index_sparse_objects_empty_p( idx_$76 ) || assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) )
          {
            ...
            while ( a_id2.numL( end_id ))
            {
              ...
              if( assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) || assertion_utilities.NIL == id_index.id_index_tombstone_p( a_handle2 ) )
              {
                ...
                if( assertion_utilities.NIL == assertions_high.assertion_arguments( ass2 ) )
                {
                  if( assertion_utilities.NIL != verboseP )
                  {
                    print_high.print( ass2, assertion_utilities.UNPROVIDED );
                    streams_high.force_output( assertion_utilities.UNPROVIDED );
                  }
  ...
  public static SubLObject syntactically_ill_formed_assertion_count()
  {
    ...
    SubLObject count = assertion_utilities.ZERO_INTEGER;
    final SubLObject idx = assertion_handles.do_assertions_table();
    final SubLObject mess = assertion_utilities.$str133$mapping_Cyc_assertions;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = assertion_utilities.ZERO_INTEGER;
    assert assertion_utilities.NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( assertion_utilities.NIL == id_index.id_index_objects_empty_p( idx_$78, assertion_utilities.$kw84$SKIP ) )
        {
          final SubLObject idx_$79 = idx_$78;
          if( assertion_utilities.NIL == id_index.id_index_dense_objects_empty_p( idx_$79, assertion_utilities.$kw84$SKIP ) )
          {
          ...
          if( assertion_utilities.NIL == id_index.id_index_sparse_objects_empty_p( idx_$80 ) || assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) )
          {
  ...
  public static SubLObject syntactically_ill_formed_assertions()
  {
    ...
    try
    {
      ...
      try
      {
        ...
        if( assertion_utilities.NIL == id_index.id_index_objects_empty_p( idx_$82, assertion_utilities.$kw84$SKIP ) )
        {
          final SubLObject idx_$83 = idx_$82;
          if( assertion_utilities.NIL == id_index.id_index_dense_objects_empty_p( idx_$83, assertion_utilities.$kw84$SKIP ) )
          {
          ...
          if( assertion_utilities.NIL == id_index.id_index_sparse_objects_empty_p( idx_$84 ) || assertion_utilities.NIL == id_index.id_index_skip_tombstones_p( assertion_utilities.$kw84$SKIP ) )
          {
  ...
  {
    return SubLObjectFactory.makeBoolean( assertion_utilities.NIL == cycl_grammar.cycl_sentence_p( fi.assertion_hl_formula( ass, assertion_utilities.UNPROVIDED ) ) );
  }
  ...
  public static SubLObject assertion_rarest_term(final SubLObject assertion)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject v_term = assertion_utilities.NIL;
    SubLObject count = assertion_utilities.NIL;
    ...
    try
    {
      assertion_utilities.$rarest_term$.bind( assertion_utilities.$kw134$UNSPECIFIED, thread );
      assertion_utilities.$rarest_count$.bind( Numbers.$most_positive_fixnum$.getGlobalValue(), thread );
      cycl_utilities.assertion_map( Symbols.symbol_function( assertion_utilities.$sym135$UPDATE_RAREST_TERM ), assertion, assertion_utilities.UNPROVIDED,
          assertion_utilities.UNPROVIDED );
  ...
  public static SubLObject sort_assertions_via_term_rarity(SubLObject assertions)
  {
    ...
    final SubLObject state = local_state = memoization_state.new_memoization_state( assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED, assertion_utilities.UNPROVIDED,
        assertion_utilities.UNPROVIDED );
    ...
    try
    {
      ...
      try
      {
        assertions = Sort.stable_sort( assertions, Symbols.symbol_function( assertion_utilities.$sym136$_ ), Symbols.symbol_function(
            assertion_utilities.$sym137$MEMOIZED_ASSERTION_TERM_RARITY ) );
      }
      finally
      {
  ...
  public static SubLObject memoized_assertion_term_rarity(final SubLObject assertion)
  {
    ...
    SubLObject caching_state = assertion_utilities.NIL;
    if( assertion_utilities.NIL == v_memoization_state )
    {
      return memoized_assertion_term_rarity_internal( assertion );
    }
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, assertion_utilities.$sym137$MEMOIZED_ASSERTION_TERM_RARITY, assertion_utilities.UNPROVIDED );
    if( assertion_utilities.NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), assertion_utilities.$sym137$MEMOIZED_ASSERTION_TERM_RARITY,
          assertion_utilities.ONE_INTEGER, assertion_utilities.NIL, assertion_utilities.EQL, assertion_utilities.UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, assertion_utilities.$sym137$MEMOIZED_ASSERTION_TERM_RARITY, caching_state );
    }
    ...
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      ...
      memoization_state.caching_state_put( caching_state, assertion, results, assertion_utilities.UNPROVIDED );
    }
    return memoization_state.caching_results( results );
  }
  ...
  public static SubLObject declare_assertion_utilities_file()
  {
    ...
    SubLFiles.declareFunction( myName, "assertion_list_p", "ASSERTION-LIST-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "list_of_rule_assertion_p", "LIST-OF-RULE-ASSERTION-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_dependent_assertions", "ASSERTION-DEPENDENT-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "remove_relevant_assertion_dependents", "REMOVE-RELEVANT-ASSERTION-DEPENDENTS", 2, 0, false );
    SubLFiles.declareFunction( myName, "remove_relevant_assertions_dependents", "REMOVE-RELEVANT-ASSERTIONS-DEPENDENTS", 2, 0, false );
    SubLFiles.declareFunction( myName, "deduction_dependent_deductions", "DEDUCTION-DEPENDENT-DEDUCTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_dependent_supported_object_counts", "ASSERTION-DEPENDENT-SUPPORTED-OBJECT-COUNTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "true_assertionP", "TRUE-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "false_assertionP", "FALSE-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "unknown_assertionP", "UNKNOWN-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "true_gaf_assertionP", "TRUE-GAF-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "false_gaf_assertionP", "FALSE-GAF-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "nl_semantic_assertionP", "NL-SEMANTIC-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "obsolete_ruleP", "OBSOLETE-RULE?", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_matches_typeP", "ASSERTION-MATCHES-TYPE?", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_matches_truthP", "ASSERTION-MATCHES-TRUTH?", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_matches_directionP", "ASSERTION-MATCHES-DIRECTION?", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_matches_truth_and_directionP", "ASSERTION-MATCHES-TRUTH-AND-DIRECTION?", 3, 0, false );
    SubLFiles.declareFunction( myName, "assertion_matches_type_truth_and_directionP", "ASSERTION-MATCHES-TYPE-TRUTH-AND-DIRECTION?", 4, 0, false );
    SubLFiles.declareFunction( myName, "gaf_has_term_in_argnumP", "GAF-HAS-TERM-IN-ARGNUM?", 3, 0, false );
    SubLFiles.declareFunction( myName, "gaf_has_term_in_some_argnumP", "GAF-HAS-TERM-IN-SOME-ARGNUM?", 2, 0, false );
    SubLFiles.declareFunction( myName, "true_gaf_assertion_with_pred_p", "TRUE-GAF-ASSERTION-WITH-PRED-P", 2, 0, false );
    SubLFiles.declareFunction( myName, "gaf_assertion_with_pred_p", "GAF-ASSERTION-WITH-PRED-P", 2, 0, false );
    SubLFiles.declareFunction( myName, "gaf_assertion_has_pred_p", "GAF-ASSERTION-HAS-PRED-P", 2, 0, false );
    SubLFiles.declareFunction( myName, "gaf_assertion_with_any_of_preds_p", "GAF-ASSERTION-WITH-ANY-OF-PREDS-P", 2, 0, false );
    SubLFiles.declareFunction( myName, "isa_gaf_p", "ISA-GAF-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "genls_gaf_p", "GENLS-GAF-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_cnf_with_el_vars_only", "ASSERTION-CNF-WITH-EL-VARS-ONLY", 1, 0, false );
    SubLFiles.declareFunction( myName, "except_when_rule_p", "EXCEPT-WHEN-RULE-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "except_for_gaf_p", "EXCEPT-FOR-GAF-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "abnormal_assertion_p", "ABNORMAL-ASSERTION-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "abnormal_literal_from_assertion", "ABNORMAL-LITERAL-FROM-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( myName, "somewhere_excepted_assertionP", "SOMEWHERE-EXCEPTED-ASSERTION?", 1, 1, false );
    SubLFiles.declareFunction( myName, "excepted_assertionP", "EXCEPTED-ASSERTION?", 1, 2, false );
    SubLFiles.declareFunction( myName, "excepted_assertion_in_any_mtP", "EXCEPTED-ASSERTION-IN-ANY-MT?", 1, 2, false );
    SubLFiles.declareFunction( myName, "excepted_assertionP_int", "EXCEPTED-ASSERTION?-INT", 1, 3, false );
    SubLFiles.declareFunction( myName, "excepted_assertion_in_mtP", "EXCEPTED-ASSERTION-IN-MT?", 2, 2, false );
    SubLFiles.declareFunction( myName, "excepted_assertion_in_mtP_shallow", "EXCEPTED-ASSERTION-IN-MT?-SHALLOW", 2, 1, false );
    SubLFiles.declareFunction( myName, "doomed_assertionP", "DOOMED-ASSERTION?", 1, 2, false );
    SubLFiles.declareFunction( myName, "doomed_assertionP_int", "DOOMED-ASSERTION?-INT", 1, 3, false );
    SubLFiles.declareFunction( myName, "assertion_matches_mtP", "ASSERTION-MATCHES-MT?", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_has_argumentsP", "ASSERTION-HAS-ARGUMENTS?", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_argument_count", "ASSERTION-ARGUMENT-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_has_deduction_with_supportP", "ASSERTION-HAS-DEDUCTION-WITH-SUPPORT?", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_has_dependent_with_supportP", "ASSERTION-HAS-DEPENDENT-WITH-SUPPORT?", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_has_dependent_with_supportP_kb_hl_support_aware_version", "ASSERTION-HAS-DEPENDENT-WITH-SUPPORT?-KB-HL-SUPPORT-AWARE-VERSION", 2, 0,
        false );
    SubLFiles.declareFunction( myName, "assertion_mentions_asserted_more_specificallyP", "ASSERTION-MENTIONS-ASSERTED-MORE-SPECIFICALLY?", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_mentions_any_of_termsP", "ASSERTION-MENTIONS-ANY-OF-TERMS?", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_mentions_any_of_terms_in_set_lambda", "ASSERTION-MENTIONS-ANY-OF-TERMS-IN-SET-LAMBDA", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_mentions_any_of_terms_in_setP", "ASSERTION-MENTIONS-ANY-OF-TERMS-IN-SET?", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_mentions_any_of_terms_in_dict_lambda", "ASSERTION-MENTIONS-ANY-OF-TERMS-IN-DICT-LAMBDA", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_mentions_any_of_terms_in_dictionary_keysP", "ASSERTION-MENTIONS-ANY-OF-TERMS-IN-DICTIONARY-KEYS?", 2, 0, false );
    SubLFiles.declareFunction( myName, "random_gaf_with_pred", "RANDOM-GAF-WITH-PRED", 1, 0, false );
    SubLFiles.declareFunction( myName, "random_gaf_with_predicate", "RANDOM-GAF-WITH-PREDICATE", 1, 0, false );
    SubLFiles.declareFunction( myName, "random_gaf_with_predicate_and_arg", "RANDOM-GAF-WITH-PREDICATE-AND-ARG", 3, 0, false );
    SubLFiles.declareFunction( myName, "random_rule_mentioning", "RANDOM-RULE-MENTIONING", 1, 0, false );
    SubLFiles.declareFunction( myName, "rules_mentioning", "RULES-MENTIONING", 1, 0, false );
    SubLFiles.declareFunction( myName, "rule_count_mentioning", "RULE-COUNT-MENTIONING", 1, 0, false );
    SubLFiles.declareFunction( myName, "random_assertions", "RANDOM-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_earlierP", "ASSERTION-EARLIER?", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_laterP", "ASSERTION-LATER?", 2, 0, false );
    SubLFiles.declareFunction( myName, "earliest_assertion", "EARLIEST-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( myName, "rename_assertion_variables", "RENAME-ASSERTION-VARIABLES", 2, 0, false );
    SubLFiles.declareFunction( myName, "possibly_rename_assertion_variables", "POSSIBLY-RENAME-ASSERTION-VARIABLES", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_antecedent_query_formula", "ASSERTION-ANTECEDENT-QUERY-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_known_extent_query_formula", "ASSERTION-KNOWN-EXTENT-QUERY-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_unknown_extent_query_formula", "ASSERTION-UNKNOWN-EXTENT-QUERY-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_known_extent_query_formula_int", "ASSERTION-KNOWN-EXTENT-QUERY-FORMULA-INT", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_info", "ASSERTION-INFO", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_literal_count", "ASSERTION-LITERAL-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "rule_literal_count", "RULE-LITERAL-COUNT", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_supporting_assertions", "ASSERTION-SUPPORTING-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_supporting_forward_assertions", "ASSERTION-SUPPORTING-FORWARD-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_cheapest_forward_supporting_assertion", "ASSERTION-CHEAPEST-FORWARD-SUPPORTING-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_universal_time", "ASSERTION-UNIVERSAL-TIME", 1, 0, false );
    SubLFiles.declareFunction( myName, "all_assertions_sorted_by_creation_time_estimate", "ALL-ASSERTIONS-SORTED-BY-CREATION-TIME-ESTIMATE", 0, 0, false );
    SubLFiles.declareFunction( myName, "assertion_newest_constant", "ASSERTION-NEWEST-CONSTANT", 1, 0, false );
    SubLFiles.declareFunction( myName, "initialize_newest_constant_table", "INITIALIZE-NEWEST-CONSTANT-TABLE", 0, 0, false );
    SubLFiles.declareFunction( myName, "assertion_has_meta_assertionsP", "ASSERTION-HAS-META-ASSERTIONS?", 1, 0, false );
    SubLFiles.declareFunction( myName, "all_meta_assertions", "ALL-META-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "meta_assertion_list_for_editing", "META-ASSERTION-LIST-FOR-EDITING", 1, 0, false );
    SubLFiles.declareFunction( myName, "meta_assertion_p", "META-ASSERTION-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "rule_meta_assertion_p", "RULE-META-ASSERTION-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "pragmatic_requirement_rule_p", "PRAGMATIC-REQUIREMENT-RULE-P", 1, 0, false );
    SubLFiles.declareFunction( myName, "meta_assertion_el_formula", "META-ASSERTION-EL-FORMULA", 3, 0, false );
    SubLFiles.declareFunction( myName, "mt_of_assertions_p", "MT-OF-ASSERTIONS-P", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertions_of_mt", "ASSERTIONS-OF-MT", 2, 0, false );
    SubLFiles.declareFunction( myName, "mts_of_assertions", "MTS-OF-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertions_min_mt", "ASSERTIONS-MIN-MT", 1, 0, false );
    SubLFiles.declareFunction( myName, "sort_assertions", "SORT-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( myName, "sort_gafs_by_term", "SORT-GAFS-BY-TERM", 1, 2, false );
    SubLFiles.declareFunction( myName, "rule_type_constraints", "RULE-TYPE-CONSTRAINTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "self_looping_ruleP", "SELF-LOOPING-RULE?", 1, 0, false );
    SubLFiles.declareFunction( myName, "clear_cached_self_looping_rule_assertionP", "CLEAR-CACHED-SELF-LOOPING-RULE-ASSERTION?", 0, 0, false );
    SubLFiles.declareFunction( myName, "remove_cached_self_looping_rule_assertionP", "REMOVE-CACHED-SELF-LOOPING-RULE-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "cached_self_looping_rule_assertionP_internal", "CACHED-SELF-LOOPING-RULE-ASSERTION?-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( myName, "cached_self_looping_rule_assertionP", "CACHED-SELF-LOOPING-RULE-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "self_expanding_ruleP", "SELF-EXPANDING-RULE?", 1, 0, false );
    SubLFiles.declareFunction( myName, "clear_cached_self_expanding_rule_assertionP", "CLEAR-CACHED-SELF-EXPANDING-RULE-ASSERTION?", 0, 0, false );
    SubLFiles.declareFunction( myName, "remove_cached_self_expanding_rule_assertionP", "REMOVE-CACHED-SELF-EXPANDING-RULE-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "cached_self_expanding_rule_assertionP_internal", "CACHED-SELF-EXPANDING-RULE-ASSERTION?-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( myName, "cached_self_expanding_rule_assertionP", "CACHED-SELF-EXPANDING-RULE-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "safe_all_forward_rules_relevant_to_term", "SAFE-ALL-FORWARD-RULES-RELEVANT-TO-TERM", 1, 0, false );
    SubLFiles.declareFunction( myName, "all_forward_rules_relevant_to_term", "ALL-FORWARD-RULES-RELEVANT-TO-TERM", 1, 0, false );
    SubLFiles.declareFunction( myName, "safe_all_forward_rules_relevant_to_terms", "SAFE-ALL-FORWARD-RULES-RELEVANT-TO-TERMS", 1, 0, false );
    SubLFiles.declareFunction( myName, "all_forward_rules_relevant_to_terms", "ALL-FORWARD-RULES-RELEVANT-TO-TERMS", 1, 0, false );
    SubLFiles.declareFunction( myName, "possibly_safe_all_forward_rules_relevant_to_term", "POSSIBLY-SAFE-ALL-FORWARD-RULES-RELEVANT-TO-TERM", 2, 0, false );
    SubLFiles.declareFunction( myName, "possibly_safe_all_forward_rules_relevant_to_terms", "POSSIBLY-SAFE-ALL-FORWARD-RULES-RELEVANT-TO-TERMS", 2, 0, false );
    SubLFiles.declareFunction( myName, "deduction_forward_rule_supports", "DEDUCTION-FORWARD-RULE-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( myName, "all_forward_rules_relevant_to_term_int", "ALL-FORWARD-RULES-RELEVANT-TO-TERM-INT", 1, 0, false );
    SubLFiles.declareFunction( myName, "compute_all_forward_rules_relevant_to_term", "COMPUTE-ALL-FORWARD-RULES-RELEVANT-TO-TERM", 2, 0, false );
    SubLFiles.declareFunction( myName, "compute_all_forward_rules_relevant_to_assertion", "COMPUTE-ALL-FORWARD-RULES-RELEVANT-TO-ASSERTION", 2, 0, false );
    SubLFiles.declareFunction( myName, "compute_all_forward_rules_relevant_to_assertion_int", "COMPUTE-ALL-FORWARD-RULES-RELEVANT-TO-ASSERTION-INT", 2, 0, false );
    SubLFiles.declareFunction( myName, "deduction_asserted_assertion_supports", "DEDUCTION-ASSERTED-ASSERTION-SUPPORTS", 1, 1, false );
    SubLFiles.declareFunction( myName, "deduction_asserted_assertion_supports_int", "DEDUCTION-ASSERTED-ASSERTION-SUPPORTS-INT", 2, 0, false );
    SubLFiles.declareFunction( myName, "assertion_asserted_assertion_supports", "ASSERTION-ASSERTED-ASSERTION-SUPPORTS", 1, 1, false );
    SubLFiles.declareFunction( myName, "gather_all_exception_rules", "GATHER-ALL-EXCEPTION-RULES", 0, 1, false );
    SubLFiles.declareFunction( myName, "gather_all_pragma_rules", "GATHER-ALL-PRAGMA-RULES", 0, 1, false );
    SubLFiles.declareFunction( myName, "gather_all_lifting_rules", "GATHER-ALL-LIFTING-RULES", 0, 0, false );
    SubLFiles.declareFunction( myName, "lifting_ruleP", "LIFTING-RULE?", 1, 0, false );
    SubLFiles.declareFunction( myName, "lifting_consequent_ruleP", "LIFTING-CONSEQUENT-RULE?", 1, 0, false );
    SubLFiles.declareFunction( myName, "universal_lifting_ruleP", "UNIVERSAL-LIFTING-RULE?", 1, 0, false );
    SubLFiles.declareFunction( myName, "rule_has_unlabelled_dont_care_variableP", "RULE-HAS-UNLABELLED-DONT-CARE-VARIABLE?", 1, 0, false );
    SubLFiles.declareFunction( myName, "rule_unlabelled_dont_care_variables", "RULE-UNLABELLED-DONT-CARE-VARIABLES", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_findable_by_idP", "ASSERTION-FINDABLE-BY-ID?", 1, 0, false );
    SubLFiles.declareFunction( myName, "embedded_assertions", "EMBEDDED-ASSERTIONS", 1, 2, false );
    SubLFiles.declareFunction( myName, "embedded_assertions_findable_by_idP", "EMBEDDED-ASSERTIONS-FINDABLE-BY-ID?", 1, 1, false );
    SubLFiles.declareFunction( myName, "assertions_containing_assertions_not_findable_by_id", "ASSERTIONS-CONTAINING-ASSERTIONS-NOT-FINDABLE-BY-ID", 0, 0, false );
    SubLFiles.declareFunction( myName, "assertions_with_no_arguments", "ASSERTIONS-WITH-NO-ARGUMENTS", 0, 1, false );
    SubLFiles.declareFunction( myName, "syntactically_ill_formed_assertion_count", "SYNTACTICALLY-ILL-FORMED-ASSERTION-COUNT", 0, 0, false );
    SubLFiles.declareFunction( myName, "syntactically_ill_formed_assertions", "SYNTACTICALLY-ILL-FORMED-ASSERTIONS", 0, 0, false );
    SubLFiles.declareFunction( myName, "syntactically_ill_formed_assertionP", "SYNTACTICALLY-ILL-FORMED-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_rarest_term", "ASSERTION-RAREST-TERM", 1, 0, false );
    SubLFiles.declareFunction( myName, "assertion_term_rarity", "ASSERTION-TERM-RARITY", 1, 0, false );
    SubLFiles.declareFunction( myName, "sort_assertions_via_term_rarity", "SORT-ASSERTIONS-VIA-TERM-RARITY", 1, 0, false );
    SubLFiles.declareFunction( myName, "update_rarest_term", "UPDATE-RAREST-TERM", 1, 0, false );
    SubLFiles.declareFunction( myName, "memoized_assertion_term_rarity_internal", "MEMOIZED-ASSERTION-TERM-RARITY-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( myName, "memoized_assertion_term_rarity", "MEMOIZED-ASSERTION-TERM-RARITY", 1, 0, false );
    return assertion_utilities.NIL;
  }

  public static SubLObject init_assertion_utilities_file()
  {
    assertion_utilities.$excepted_assertion_max_depth$ = SubLFiles.defparameter( "*EXCEPTED-ASSERTION-MAX-DEPTH*", assertion_utilities.NIL );
    assertion_utilities.$excepted_assertion_shallow_max_depth$ = SubLFiles.defparameter( "*EXCEPTED-ASSERTION-SHALLOW-MAX-DEPTH*", assertion_utilities.FIVE_INTEGER );
    assertion_utilities.$doomed_assertion_max_depth$ = SubLFiles.defparameter( "*DOOMED-ASSERTION-MAX-DEPTH*", assertion_utilities.NIL );
    assertion_utilities.$assertion_mentions_any_of_terms_set_watermark$ = SubLFiles.deflexical( "*ASSERTION-MENTIONS-ANY-OF-TERMS-SET-WATERMARK*", assertion_utilities.$int68$30 );
    assertion_utilities.$assertion_mentions_any_of_terms_set_lambda$ = SubLFiles.defparameter( "*ASSERTION-MENTIONS-ANY-OF-TERMS-SET-LAMBDA*", assertion_utilities.NIL );
    assertion_utilities.$assertion_mentions_any_of_terms_dict_lambda$ = SubLFiles.defparameter( "*ASSERTION-MENTIONS-ANY-OF-TERMS-DICT-LAMBDA*", assertion_utilities.NIL );
    assertion_utilities.$newest_constant_of_assertions$ = SubLFiles.defparameter( "*NEWEST-CONSTANT-OF-ASSERTIONS*", assertion_utilities.NIL );
    assertion_utilities.$cached_self_looping_rule_assertionP_caching_state$ = SubLFiles.deflexical( "*CACHED-SELF-LOOPING-RULE-ASSERTION?-CACHING-STATE*", assertion_utilities.NIL );
    assertion_utilities.$cached_self_expanding_rule_assertionP_caching_state$ = SubLFiles.deflexical( "*CACHED-SELF-EXPANDING-RULE-ASSERTION?-CACHING-STATE*", assertion_utilities.NIL );
    assertion_utilities.$all_forward_rules_relevant_to_term_threshold$ = SubLFiles.defparameter( "*ALL-FORWARD-RULES-RELEVANT-TO-TERM-THRESHOLD*", assertion_utilities.$int112$212 );
    assertion_utilities.$within_safe_all_forward_rules_relevant_to_termP$ = SubLFiles.defparameter( "*WITHIN-SAFE-ALL-FORWARD-RULES-RELEVANT-TO-TERM?*", assertion_utilities.NIL );
    assertion_utilities.$all_forward_rules_relevant_to_term_argument_set$ = SubLFiles.defparameter( "*ALL-FORWARD-RULES-RELEVANT-TO-TERM-ARGUMENT-SET*", assertion_utilities.NIL );
    assertion_utilities.$all_forward_rules_relevant_to_term_dependent_set$ = SubLFiles.defparameter( "*ALL-FORWARD-RULES-RELEVANT-TO-TERM-DEPENDENT-SET*", assertion_utilities.NIL );
    assertion_utilities.$all_forward_rules_relevant_to_term_nart_set$ = SubLFiles.defparameter( "*ALL-FORWARD-RULES-RELEVANT-TO-TERM-NART-SET*", assertion_utilities.NIL );
    assertion_utilities.$all_forward_rules_relevant_to_term_result_set$ = SubLFiles.defparameter( "*ALL-FORWARD-RULES-RELEVANT-TO-TERM-RESULT-SET*", assertion_utilities.NIL );
    assertion_utilities.$deduction_asserted_assertion_supports_deductions_processed$ = SubLFiles.defparameter( "*DEDUCTION-ASSERTED-ASSERTION-SUPPORTS-DEDUCTIONS-PROCESSED*", assertion_utilities.NIL );
    assertion_utilities.$deduction_asserted_assertion_counts$ = SubLFiles.defparameter( "*DEDUCTION-ASSERTED-ASSERTION-COUNTS*", assertion_utilities.NIL );
    assertion_utilities.$rarest_term$ = SubLFiles.defparameter( "*RAREST-TERM*", assertion_utilities.NIL );
    assertion_utilities.$rarest_count$ = SubLFiles.defparameter( "*RAREST-COUNT*", assertion_utilities.NIL );
    return assertion_utilities.NIL;
  }

  public static SubLObject setup_assertion_utilities_file()
  {
    utilities_macros.register_cyc_api_function( assertion_utilities.$sym87$ASSERTION_HAS_META_ASSERTIONS_, assertion_utilities.$list88,
        assertion_utilities.$str89$Return_T_iff_ASSERTION_has_some_m, assertion_utilities.$list90, assertion_utilities.$list91 );
    memoization_state.note_globally_cached_function( assertion_utilities.$sym108$CACHED_SELF_LOOPING_RULE_ASSERTION_ );
    memoization_state.note_globally_cached_function( assertion_utilities.$sym110$CACHED_SELF_EXPANDING_RULE_ASSERTION_ );
    memoization_state.note_memoized_function( assertion_utilities.$sym137$MEMOIZED_ASSERTION_TERM_RARITY );
    return assertion_utilities.NIL;
  }
  ...
  static
  {
    ...
    $list0 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "RULE-VAR" ), SubLObjectFactory.makeSymbol( "&KEY" ), ConsesLow.list(
        SubLObjectFactory.makeSymbol( "PROGRESS-MESSAGE" ), SubLObjectFactory.makeString( "mapping Cyc rules" ) ), SubLObjectFactory.makeSymbol( "DONE" ) ),
        SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    $list1 = ConsesLow.list( SubLObjectFactory.makeKeyword( "PROGRESS-MESSAGE" ), SubLObjectFactory.makeKeyword( "DONE" ) );
    ...
    $list7 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NEW-RULE-ITERATOR" ) );
    ...
    $list12 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "RULE-COUNT" ) ) );
    $list13 = ConsesLow.list( assertion_utilities.ZERO_INTEGER );
    ...
    $list18 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "GAF-VAR" ), SubLObjectFactory.makeSymbol( "&KEY" ), ConsesLow.list(
        SubLObjectFactory.makeSymbol( "PROGRESS-MESSAGE" ), SubLObjectFactory.makeString( "mapping Cyc GAFs" ) ), SubLObjectFactory.makeSymbol( "DONE" ) ),
        SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    ...
    $list23 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "ASSERTION-VAR" ), SubLObjectFactory.makeSymbol( "&KEY" ), SubLObjectFactory.makeSymbol(
    ...
    $list28 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "ASSERTION-COUNT" ) ) );
    ...
    $list32 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NEXT-ASSERTION-ID" ) );
    ...
    $list36 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "DEPENDENT-ASSERTION" ), SubLObjectFactory.makeSymbol( "ASSERTION" ) ), SubLObjectFactory
    ...
    $list41 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "SUPPORTING-ASSERTION" ), SubLObjectFactory.makeSymbol( "ASSERTION" ), SubLObjectFactory
        .makeSymbol( "&KEY" ), SubLObjectFactory.makeSymbol( "DONE" ) ), SubLObjectFactory.makeSymbol( "&BODY" ), SubLObjectFactory.makeSymbol( "BODY" ) );
    $list42 = ConsesLow.list( SubLObjectFactory.makeKeyword( "DONE" ) );
    ...
    $const49$except = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "except" ) );
    ...
    $const57$NLSemanticPredicate = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "NLSemanticPredicate" ) );
    $sym58$RELEVANT_MT_IS_EVERYTHING = SubLObjectFactory.makeSymbol( "RELEVANT-MT-IS-EVERYTHING" );
    $const59$EverythingPSC = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "EverythingPSC" ) );
    $sym60$_EXIT = SubLObjectFactory.makeSymbol( "%EXIT" );
    $const61$obsoleteRule = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "obsoleteRule" ) );
    $const62$isa = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "isa" ) );
    $const63$genls = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "genls" ) );
    $sym64$ABNORMAL_ASSERTION_P = SubLObjectFactory.makeSymbol( "ABNORMAL-ASSERTION-P" );
    $const65$exceptMt = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "exceptMt" ) );
    $sym66$SUPPORT_P = SubLObjectFactory.makeSymbol( "SUPPORT-P" );
    $const67$assertedMoreSpecifically = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "assertedMoreSpecifically" ) );
    ...
    $const78$knownSentence = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "knownSentence" ) );
    $const79$unknownSentence = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "unknownSentence" ) );
    ...
    $list88 = ConsesLow.list( SubLObjectFactory.makeSymbol( "ASSERTION" ) );
    $str89$Return_T_iff_ASSERTION_has_some_m = SubLObjectFactory.makeString( "Return T iff ASSERTION has some meta-assertions." );
    $list90 = ConsesLow.list( ConsesLow.list( SubLObjectFactory.makeSymbol( "ASSERTION" ), SubLObjectFactory.makeSymbol( "ASSERTION-P" ) ) );
    $list91 = ConsesLow.list( SubLObjectFactory.makeSymbol( "BOOLEANP" ) );
    ...
    $const94$meetsPragmaticRequirement = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "meetsPragmaticRequirement" ) );
    ...
    $list118 = ConsesLow.list( SubLObjectFactory.makeKeyword( "ARGUMENT*" ), SubLObjectFactory.makeKeyword( "DEPENDENT*" ) );
    $const119$trueRule = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "trueRule" ) );
    ...
    $const127$ist = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "ist" ) );
    $const128$universalLiftingRule = constant_handles.reader_make_constant_shell( SubLObjectFactory.makeString( "universalLiftingRule" ) );
