...
public final class assertion_handles extends SubLTranslatedFile
{
    ...
    public static SubLObject new_assertions_iterator() {
        return iteration.new_indirect_iterator(id_index.new_id_index_iterator(assertion_handles.$assertion_from_id$.getGlobalValue()), (SubLObject)assertion_handles.$sym1$ASSERTIONS_TABLE_TUPLE_TO_ASSERTION, (SubLObject)assertion_handles.UNPROVIDED);
    }
    ...
    public static SubLObject do_assertions(final SubLObject macroform, final SubLObject environment) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)assertion_handles.$list2);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject var = (SubLObject)assertion_handles.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)assertion_handles.$list2);
        var = current.first();
        current = current.rest();
        final SubLObject progress_message = (SubLObject)(current.isCons() ? current.first() : assertion_handles.$str3$mapping_Cyc_assertions);
        cdestructuring_bind.destructuring_bind_must_listp(current, datum, (SubLObject)assertion_handles.$list2);
        current = current.rest();
        SubLObject allow_other_keys_p = (SubLObject)assertion_handles.NIL;
        SubLObject rest = current;
        SubLObject bad = (SubLObject)assertion_handles.NIL;
        SubLObject current_$1 = (SubLObject)assertion_handles.NIL;
        while (assertion_handles.NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)assertion_handles.$list2);
            current_$1 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)assertion_handles.$list2);
            if (assertion_handles.NIL == conses_high.member(current_$1, (SubLObject)assertion_handles.$list4, (SubLObject)assertion_handles.UNPROVIDED, (SubLObject)assertion_handles.UNPROVIDED)) {
                bad = (SubLObject)assertion_handles.T;
            }
        ...
        if (assertion_handles.NIL != bad && assertion_handles.NIL == allow_other_keys_p) {
            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)assertion_handles.$list2);
        }
        final SubLObject done_tail = cdestructuring_bind.property_list_member((SubLObject)assertion_handles.$kw6$DONE, current);
        final SubLObject done = (SubLObject)((assertion_handles.NIL != done_tail) ? conses_high.cadr(done_tail) : assertion_handles.NIL);
        final SubLObject body;
        current = (body = temp);
        final SubLObject a_id = (SubLObject)assertion_handles.$sym7$A_ID;
        final SubLObject a_handle = (SubLObject)assertion_handles.$sym8$A_HANDLE;
        return (SubLObject)ConsesLow.list((SubLObject)assertion_handles.$sym9$DO_ID_INDEX, (SubLObject)ConsesLow.list(new SubLObject[] { a_id, a_handle, assertion_handles.$list10, assertion_handles.$kw11$PROGRESS_MESSAGE, progress_message, assertion_handles.$kw12$ORDERED, assertion_handles.T, assertion_handles.$kw6$DONE, done }), (SubLObject)ConsesLow.listS((SubLObject)assertion_handles.$sym13$CLET, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(var, (SubLObject)ConsesLow.list((SubLObject)assertion_handles.$sym14$RESOLVE_ASSERTION_ID_VALUE_PAIR, a_id, a_handle))), ConsesLow.append(body, (SubLObject)assertion_handles.NIL)));
    }
    ...
    public static SubLObject new_new_assertions_iterator() {
        return iteration.new_indirect_iterator(iteration.new_filter_iterator(id_index.new_id_index_ordered_iterator(do_assertions_table()), (SubLObject)assertion_handles.$sym19$NEW_ASSERTIONS_TABLE_ENTRY_, (SubLObject)ConsesLow.list(new_assertion_id_threshold())), (SubLObject)assertion_handles.$sym1$ASSERTIONS_TABLE_TUPLE_TO_ASSERTION, (SubLObject)assertion_handles.UNPROVIDED);
    }
    ...
    public static SubLObject new_assertions_table_entryP(final SubLObject tuple, final SubLObject id_threshold) {
        SubLObject id = (SubLObject)assertion_handles.NIL;
        SubLObject payload = (SubLObject)assertion_handles.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(tuple, tuple, (SubLObject)assertion_handles.$list20);
        id = tuple.first();
        SubLObject current = tuple.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, tuple, (SubLObject)assertion_handles.$list20);
        payload = current.first();
        current = current.rest();
        if (assertion_handles.NIL == current) {
            return Numbers.numGE(id, id_threshold);
        }
        cdestructuring_bind.cdestructuring_bind_error(tuple, (SubLObject)assertion_handles.$list20);
    ...
    public static SubLObject setup_assertion_table(final SubLObject size, final SubLObject exactP) {
        ...
        assertion_handles.$assertion_from_id$.setGlobalValue(id_index.new_id_index(size, (SubLObject)assertion_handles.ZERO_INTEGER));
        return (SubLObject)assertion_handles.T;
    }
    ...
    public static SubLObject finalize_assertions(SubLObject max_assertion_id) {
        if (max_assertion_id == assertion_handles.UNPROVIDED) {
            max_assertion_id = (SubLObject)assertion_handles.NIL;
        }
    ...
    public static SubLObject optimize_assertion_table() {
        ...
        try {
            ...
            id_index.optimize_id_index(assertion_handles.$assertion_from_id$.getGlobalValue(), (SubLObject)assertion_handles.UNPROVIDED);
        }
        finally {
    ...
    public static SubLObject assertion_count() {
        if (assertion_handles.NIL == assertion_handles.$assertion_from_id$.getGlobalValue()) {
            return (SubLObject)assertion_handles.ZERO_INTEGER;
        }
    ...
    public static SubLObject lookup_assertion(final SubLObject id) {
        final SubLObject assertion = id_index.id_index_lookup(assertion_handles.$assertion_from_id$.getGlobalValue(), id, (SubLObject)assertion_handles.UNPROVIDED);
    ...
    public static SubLObject new_assertion_id_threshold() {
        return (assertion_handles.NIL != assertion_handles.$new_assertion_id_threshold$.getGlobalValue()) ? assertion_handles.$new_assertion_id_threshold$.getGlobalValue() : assertion_manager.get_file_backed_assertion_id_threshold();
    }
    
    @SubLTranslatedFile.SubL(source = "cycl/assertion-handles.lisp", position = 6466L)
    public static SubLObject old_assertion_count() {
        return Values.nth_value_step_2(Values.nth_value_step_1((SubLObject)assertion_handles.ZERO_INTEGER), id_index.id_index_old_and_new_object_counts(do_assertions_table(), new_assertion_id_threshold()));
    }
    
    @SubLTranslatedFile.SubL(source = "cycl/assertion-handles.lisp", position = 6616L)
    public static SubLObject new_assertion_count() {
        return Values.nth_value_step_2(Values.nth_value_step_1((SubLObject)assertion_handles.ONE_INTEGER), id_index.id_index_old_and_new_object_counts(do_assertions_table(), new_assertion_id_threshold()));
    }
    ...
    public static SubLObject missing_old_assertion_ids() {
        ...
        return id_index.id_index_missing_ids(do_assertions_table(), (SubLObject)assertion_handles.$kw27$DENSE, id_limit);
    }
    ...
    public static SubLObject missing_assertion_id_set() {
        return set_utilities.construct_set_from_list(id_index.id_index_missing_ids(do_assertions_table(), (SubLObject)assertion_handles.$kw28$ALL, (SubLObject)assertion_handles.UNPROVIDED), (SubLObject)assertion_handles.EQL, (SubLObject)assertion_handles.UNPROVIDED);
    }
    ...
    public static SubLObject deleted_assertion_id_iterator() {
        return iteration.new_list_iterator(id_index.id_index_missing_ids(do_assertions_table(), (SubLObject)assertion_handles.$kw28$ALL, (SubLObject)assertion_handles.UNPROVIDED));
    }
    ...
    public static SubLObject do_deleted_assertion_ids(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)assertion_handles.$list29);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject id = (SubLObject)assertion_handles.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)assertion_handles.$list29);
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)assertion_handles.NIL;
        SubLObject current_$2 = (SubLObject)assertion_handles.NIL;
        while (assertion_handles.NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)assertion_handles.$list29);
            current_$2 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)assertion_handles.$list29);
            if (assertion_handles.NIL == conses_high.member(current_$2, (SubLObject)assertion_handles.$list4, (SubLObject)assertion_handles.UNPROVIDED, (SubLObject)assertion_handles.UNPROVIDED)) {
                bad = (SubLObject)assertion_handles.T;
            }
        ...
        if (assertion_handles.NIL != bad && assertion_handles.NIL == allow_other_keys_p) {
            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)assertion_handles.$list29);
        }
        final SubLObject done_tail = cdestructuring_bind.property_list_member((SubLObject)assertion_handles.$kw6$DONE, current);
        final SubLObject done = (SubLObject)((assertion_handles.NIL != done_tail) ? conses_high.cadr(done_tail) : assertion_handles.NIL);
        final SubLObject body;
        current = (body = temp);
        final SubLObject iterator = (SubLObject)assertion_handles.$sym30$ITERATOR;
        return (SubLObject)ConsesLow.list((SubLObject)assertion_handles.$sym13$CLET, (SubLObject)ConsesLow.list(reader.bq_cons(iterator, (SubLObject)assertion_handles.$list31)), (SubLObject)ConsesLow.listS((SubLObject)assertion_handles.$sym32$DO_ITERATOR, (SubLObject)ConsesLow.list(id, iterator, (SubLObject)assertion_handles.$kw6$DONE, done), ConsesLow.append(body, (SubLObject)assertion_handles.NIL)));
    }
    ...
    public static SubLObject set_next_assertion_id(SubLObject max_assertion_id) {
        ...
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLObject max = (SubLObject)assertion_handles.MINUS_ONE_INTEGER;
        if (assertion_handles.NIL != max_assertion_id) {
            max = max_assertion_id;
        }
        else {
            final SubLObject idx = do_assertions_table();
            final SubLObject mess = (SubLObject)assertion_handles.$str33$Determining_maximum_assertion_ID;
            final SubLObject total = id_index.id_index_count(idx);
            SubLObject sofar = (SubLObject)assertion_handles.ZERO_INTEGER;
            ...
            try {
                utilities_macros.$last_percent_progress_index$.bind((SubLObject)assertion_handles.ZERO_INTEGER, thread);
                utilities_macros.$last_percent_progress_prediction$.bind((SubLObject)assertion_handles.NIL, thread);
                utilities_macros.$within_noting_percent_progress$.bind((SubLObject)assertion_handles.T, thread);
                utilities_macros.$percent_progress_start_time$.bind(Time.get_universal_time(), thread);
                try {
                    utilities_macros.noting_percent_progress_preamble(mess);
                    final SubLObject idx_$3 = idx;
                    if (assertion_handles.NIL == id_index.id_index_objects_empty_p(idx_$3, (SubLObject)assertion_handles.$kw35$SKIP)) {
                        final SubLObject idx_$4 = idx_$3;
                        if (assertion_handles.NIL == id_index.id_index_dense_objects_empty_p(idx_$4, (SubLObject)assertion_handles.$kw35$SKIP)) {
                            final SubLObject vector_var = id_index.id_index_dense_objects(idx_$4);
                            final SubLObject backwardP_var = (SubLObject)assertion_handles.NIL;
                            SubLObject length;
                            SubLObject v_iteration;
                            SubLObject a_id;
                            SubLObject a_handle;
                            SubLObject assertion;
                            for (length = Sequences.length(vector_var), v_iteration = (SubLObject)assertion_handles.NIL, v_iteration = (SubLObject)assertion_handles.ZERO_INTEGER; v_iteration.numL(length); v_iteration = Numbers.add(v_iteration, (SubLObject)assertion_handles.ONE_INTEGER)) {
                                a_id = ((assertion_handles.NIL != backwardP_var) ? Numbers.subtract(length, v_iteration, (SubLObject)assertion_handles.ONE_INTEGER) : v_iteration);
                                a_handle = Vectors.aref(vector_var, a_id);
                                if (assertion_handles.NIL == id_index.id_index_tombstone_p(a_handle) || assertion_handles.NIL == id_index.id_index_skip_tombstones_p((SubLObject)assertion_handles.$kw35$SKIP)) {
                                    if (assertion_handles.NIL != id_index.id_index_tombstone_p(a_handle)) {
                                        a_handle = (SubLObject)assertion_handles.$kw35$SKIP;
                                    }
                                    assertion = resolve_assertion_id_value_pair(a_id, a_handle);
                                    max = Numbers.max(max, assertion_id(assertion));
                                    sofar = Numbers.add(sofar, (SubLObject)assertion_handles.ONE_INTEGER);
                                    utilities_macros.note_percent_progress(sofar, total);
                                }
                            }
                        }
                        final SubLObject idx_$5 = idx_$3;
                        if (assertion_handles.NIL == id_index.id_index_sparse_objects_empty_p(idx_$5) || assertion_handles.NIL == id_index.id_index_skip_tombstones_p((SubLObject)assertion_handles.$kw35$SKIP)) {
                            ...
                            final SubLObject v_default = (SubLObject)((assertion_handles.NIL != id_index.id_index_skip_tombstones_p((SubLObject)assertion_handles.$kw35$SKIP)) ? assertion_handles.NIL : assertion_handles.$kw35$SKIP);
                            while (a_id2.numL(end_id)) {
                                final SubLObject a_handle2 = Hashtables.gethash_without_values(a_id2, sparse, v_default);
                                if (assertion_handles.NIL == id_index.id_index_skip_tombstones_p((SubLObject)assertion_handles.$kw35$SKIP) || assertion_handles.NIL == id_index.id_index_tombstone_p(a_handle2)) {
                                    final SubLObject assertion2 = resolve_assertion_id_value_pair(a_id2, a_handle2);
                                    max = Numbers.max(max, assertion_id(assertion2));
                                    sofar = Numbers.add(sofar, (SubLObject)assertion_handles.ONE_INTEGER);
                                    utilities_macros.note_percent_progress(sofar, total);
                                }
                                a_id2 = Numbers.add(a_id2, (SubLObject)assertion_handles.ONE_INTEGER);
                            }
                        }
                    }
                }
                    ...
                    try {
                        Threads.$is_thread_performing_cleanupP$.bind((SubLObject)assertion_handles.T, thread);
        ...
        final SubLObject next_id = Numbers.add(max, (SubLObject)assertion_handles.ONE_INTEGER);
    ...
    public static SubLObject do_old_assertions(final SubLObject macroform, final SubLObject environment) {
        SubLObject current;
        final SubLObject datum = current = macroform.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)assertion_handles.$list36);
        final SubLObject temp = current.rest();
        current = current.first();
        SubLObject assertion = (SubLObject)assertion_handles.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)assertion_handles.$list36);
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)assertion_handles.NIL;
        SubLObject current_$7 = (SubLObject)assertion_handles.NIL;
        while (assertion_handles.NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)assertion_handles.$list36);
            current_$7 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)assertion_handles.$list36);
            if (assertion_handles.NIL == conses_high.member(current_$7, (SubLObject)assertion_handles.$list37, (SubLObject)assertion_handles.UNPROVIDED, (SubLObject)assertion_handles.UNPROVIDED)) {
                bad = (SubLObject)assertion_handles.T;
            }
        ...
        if (assertion_handles.NIL != bad && assertion_handles.NIL == allow_other_keys_p) {
            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)assertion_handles.$list36);
        }
        final SubLObject progress_message_tail = cdestructuring_bind.property_list_member((SubLObject)assertion_handles.$kw11$PROGRESS_MESSAGE, current);
        final SubLObject progress_message = (SubLObject)((assertion_handles.NIL != progress_message_tail) ? conses_high.cadr(progress_message_tail) : assertion_handles.NIL);
        final SubLObject done_tail = cdestructuring_bind.property_list_member((SubLObject)assertion_handles.$kw6$DONE, current);
        final SubLObject done = (SubLObject)((assertion_handles.NIL != done_tail) ? conses_high.cadr(done_tail) : assertion_handles.NIL);
        final SubLObject body;
        current = (body = temp);
        final SubLObject threshold = (SubLObject)assertion_handles.$sym38$THRESHOLD;
        return (SubLObject)ConsesLow.list((SubLObject)assertion_handles.$sym13$CLET, (SubLObject)ConsesLow.list(reader.bq_cons(threshold, (SubLObject)assertion_handles.$list39)), (SubLObject)ConsesLow.listS((SubLObject)assertion_handles.$sym40$DO_KB_SUID_TABLE_UPTO_EXCLUDING_ID, (SubLObject)ConsesLow.list(assertion, (SubLObject)assertion_handles.$list10, threshold, (SubLObject)assertion_handles.$kw11$PROGRESS_MESSAGE, progress_message, (SubLObject)assertion_handles.$kw6$DONE, done), ConsesLow.append(body, (SubLObject)assertion_handles.NIL)));
    }
    ...
    public static SubLObject do_new_assertions(final SubLObject macroform, final SubLObject environment) {
        ...
        SubLObject rest = current;
        SubLObject bad = (SubLObject)assertion_handles.NIL;
        SubLObject current_$8 = (SubLObject)assertion_handles.NIL;
        while (assertion_handles.NIL != rest) {
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)assertion_handles.$list36);
            current_$8 = rest.first();
            rest = rest.rest();
            cdestructuring_bind.destructuring_bind_must_consp(rest, datum, (SubLObject)assertion_handles.$list36);
            if (assertion_handles.NIL == conses_high.member(current_$8, (SubLObject)assertion_handles.$list37, (SubLObject)assertion_handles.UNPROVIDED, (SubLObject)assertion_handles.UNPROVIDED)) {
                bad = (SubLObject)assertion_handles.T;
            }
        ...
        final SubLObject body;
        current = (body = temp);
        final SubLObject start = (SubLObject)assertion_handles.$sym41$START;
        return (SubLObject)ConsesLow.list((SubLObject)assertion_handles.$sym13$CLET, (SubLObject)ConsesLow.list(reader.bq_cons(start, (SubLObject)assertion_handles.$list39)), (SubLObject)ConsesLow.listS((SubLObject)assertion_handles.$sym42$DO_KB_SUID_TABLE_STARTING_AT_ID, (SubLObject)ConsesLow.list(assertion, (SubLObject)assertion_handles.$list10, start, (SubLObject)assertion_handles.$kw11$PROGRESS_MESSAGE, progress_message, (SubLObject)assertion_handles.$kw6$DONE, done), ConsesLow.append(body, (SubLObject)assertion_handles.NIL)));
    }
    ...
    public static SubLObject assertion_print_function_trampoline(final SubLObject v_object, final SubLObject stream) {
        print_assertion(v_object, stream, (SubLObject)assertion_handles.ZERO_INTEGER);
        return (SubLObject)assertion_handles.NIL;
    }
    
    @SubLTranslatedFile.SubL(source = "cycl/assertion-handles.lisp", position = 11034L)
    public static SubLObject assertion_p(final SubLObject v_object) {
        return (SubLObject)((v_object.getClass() == $assertion_native.class) ? assertion_handles.T : assertion_handles.NIL);
    }
    ...
    public static SubLObject make_assertion(SubLObject arglist) {
        if (arglist == assertion_handles.UNPROVIDED) {
            arglist = (SubLObject)assertion_handles.NIL;
        }
        ...
        for (next = (SubLObject)assertion_handles.NIL, next = arglist; assertion_handles.NIL != next; next = conses_high.cddr(next)) {
            current_arg = next.first();
            current_value = conses_high.cadr(next);
            pcase_var = current_arg;
            if (pcase_var.eql((SubLObject)assertion_handles.$kw55$ID)) {
                _csetf_as_id(v_new, current_value);
            }
            else {
                Errors.error((SubLObject)assertion_handles.$str56$Invalid_slot__S_for_construction_, current_arg);
            }
        }
        return v_new;
    }
    ...
    public static SubLObject visit_defstruct_assertion(final SubLObject obj, final SubLObject visitor_fn) {
        Functions.funcall(visitor_fn, obj, (SubLObject)assertion_handles.$kw57$BEGIN, (SubLObject)assertion_handles.$sym58$MAKE_ASSERTION, (SubLObject)assertion_handles.ONE_INTEGER);
        Functions.funcall(visitor_fn, obj, (SubLObject)assertion_handles.$kw59$SLOT, (SubLObject)assertion_handles.$kw55$ID, as_id(obj));
        Functions.funcall(visitor_fn, obj, (SubLObject)assertion_handles.$kw60$END, (SubLObject)assertion_handles.$sym58$MAKE_ASSERTION, (SubLObject)assertion_handles.ONE_INTEGER);
        return obj;
    }
    ...
    public static SubLObject print_assertion(final SubLObject v_object, final SubLObject stream, final SubLObject depth) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        if (assertion_handles.NIL != valid_assertionP(v_object, (SubLObject)assertion_handles.UNPROVIDED)) {
            ...
            if (assertion_handles.NIL != cnf) {
                ...
                try {
                    ...
                    final SubLObject formula_data = (assertion_handles.NIL != assertion_handles.$print_assertions_in_cnf$.getDynamicValue(thread)) ? czer_utilities.possibly_escape_quote_hl_vars(cnf, (SubLObject)assertion_handles.UNPROVIDED) : clauses.cnf_formula(cnf, control_vars.$assertion_truth$.getDynamicValue(thread));
                    final SubLObject formula_mt = assertions_high.assertion_mt(v_object);
                    PrintLow.format(stream, (SubLObject)assertion_handles.$str62$__AS__S__S_, formula_data, formula_mt);
                }
                finally {
                ...
                PrintLow.format(stream, (SubLObject)assertion_handles.$str63$__AS__S_, assertion_id);
            }
        }
        else if (v_object.eql(cfasl_kb_methods.cfasl_invalid_assertion())) {
            PrintLow.format(stream, (SubLObject)assertion_handles.$str64$_The_CFASL_invalid_assertion_);
        }
        else {
    ...
    public static SubLObject free_assertion(final SubLObject assertion) {
        _csetf_as_id(assertion, (SubLObject)assertion_handles.NIL);
        return assertion;
    }
    ...
    public static SubLObject valid_assertion_handleP(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(assertion_handles.NIL != assertion_p(v_object) && assertion_handles.NIL != assertion_handle_validP(v_object));
    }
    ...
    public static SubLObject valid_assertionP(final SubLObject assertion, SubLObject robustP) {
        if (robustP == assertion_handles.UNPROVIDED) {
            robustP = (SubLObject)assertion_handles.NIL;
        }
    ...
    public static SubLObject assertion_has_contentP(final SubLObject assertion) {
        return (SubLObject)SubLObjectFactory.makeBoolean(assertion_handles.NIL != valid_assertion_handleP(assertion) && assertion_handles.NIL != list_utilities.sublisp_boolean(assertion_manager.lookup_assertion_content(assertion_id(assertion))));
    }
    ...
    public static SubLObject mark_available_assertions(final SubLObject max_id, SubLObject deleted_set) {
        if (deleted_set == assertion_handles.UNPROVIDED) {
            deleted_set = (SubLObject)assertion_handles.NIL;
        }
        id_index.fill_id_index_dense_space(assertion_handles.$assertion_from_id$.getGlobalValue(), (SubLObject)assertion_handles.$kw17$PAGED_OUT, max_id);
        if (assertion_handles.NIL != set.set_p(deleted_set)) {
            ...
            for (basis_object = set_contents.do_set_contents_basis_object(set_contents_var), state = (SubLObject)assertion_handles.NIL, state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); assertion_handles.NIL == set_contents.do_set_contents_doneP(basis_object, state); state = set_contents.do_set_contents_update_state(state)) {
    ...
    public static SubLObject make_assertion_shell(SubLObject id) {
        if (id == assertion_handles.UNPROVIDED) {
            id = (SubLObject)assertion_handles.NIL;
        }
    ...
    public static SubLObject partition_create_invalid_assertion() {
        return make_assertion_shell((SubLObject)assertion_handles.UNPROVIDED);
    }
    ...
    public static SubLObject free_all_assertions() {
        final SubLThread thread = SubLProcess.currentSubLThread();
        final SubLObject idx = do_assertions_table();
        final SubLObject mess = (SubLObject)assertion_handles.$str71$Freeing_assertions;
        final SubLObject total = id_index.id_index_count(idx);
        SubLObject sofar = (SubLObject)assertion_handles.ZERO_INTEGER;
        assert assertion_handles.NIL != Types.stringp(mess) : mess;
        final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding(thread);
        ...
        try {
            ...
            try {
                ...
                if (assertion_handles.NIL == id_index.id_index_objects_empty_p(idx_$9, (SubLObject)assertion_handles.$kw35$SKIP)) {
                    final SubLObject idx_$10 = idx_$9;
                    if (assertion_handles.NIL == id_index.id_index_dense_objects_empty_p(idx_$10, (SubLObject)assertion_handles.$kw35$SKIP)) {
                    ...
                    if (assertion_handles.NIL == id_index.id_index_sparse_objects_empty_p(idx_$11) || assertion_handles.NIL == id_index.id_index_skip_tombstones_p((SubLObject)assertion_handles.$kw35$SKIP)) {
    ...
    public static SubLObject setup_assertion_handles_file() {
        subl_macro_promotions.declare_defglobal((SubLObject)assertion_handles.$sym0$_ASSERTION_FROM_ID_);
        utilities_macros.register_cyc_api_macro((SubLObject)assertion_handles.$sym15$DO_ASSERTIONS, (SubLObject)assertion_handles.$list2, (SubLObject)assertion_handles.$str16$Iterate_over_all_HL_assertion_dat);
        access_macros.register_macro_helper((SubLObject)assertion_handles.$sym14$RESOLVE_ASSERTION_ID_VALUE_PAIR, (SubLObject)assertion_handles.$sym15$DO_ASSERTIONS);
        access_macros.register_macro_helper((SubLObject)assertion_handles.$sym18$DO_ASSERTIONS_TABLE, (SubLObject)assertion_handles.$sym15$DO_ASSERTIONS);
        utilities_macros.note_funcall_helper_function((SubLObject)assertion_handles.$sym19$NEW_ASSERTIONS_TABLE_ENTRY_);
        utilities_macros.note_funcall_helper_function((SubLObject)assertion_handles.$sym1$ASSERTIONS_TABLE_TUPLE_TO_ASSERTION);
        access_macros.register_macro_helper((SubLObject)assertion_handles.$sym21$CREATE_ASSERTION_DUMP_ID_TABLE, (SubLObject)assertion_handles.$sym22$WITH_ASSERTION_DUMP_ID_TABLE);
        utilities_macros.register_cyc_api_function((SubLObject)assertion_handles.$sym23$ASSERTION_COUNT, (SubLObject)assertion_handles.NIL, (SubLObject)assertion_handles.$str24$Return_the_total_number_of_assert, (SubLObject)assertion_handles.NIL, (SubLObject)assertion_handles.$list25);
        subl_macro_promotions.declare_defglobal((SubLObject)assertion_handles.$sym26$_NEW_ASSERTION_ID_THRESHOLD_);
        Structures.register_method(print_high.$print_object_method_table$.getGlobalValue(), assertion_handles.$dtp_assertion$.getGlobalValue(), Symbols.symbol_function((SubLObject)assertion_handles.$sym51$ASSERTION_PRINT_FUNCTION_TRAMPOLINE));
        SubLSpecialOperatorDeclarations.proclaim((SubLObject)assertion_handles.$list52);
        Structures.def_csetf((SubLObject)assertion_handles.$sym53$AS_ID, (SubLObject)assertion_handles.$sym54$_CSETF_AS_ID);
        Equality.identity((SubLObject)assertion_handles.$sym43$ASSERTION);
        Structures.register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), assertion_handles.$dtp_assertion$.getGlobalValue(), Symbols.symbol_function((SubLObject)assertion_handles.$sym61$VISIT_DEFSTRUCT_OBJECT_ASSERTION_METHOD));
        Structures.register_method(Sxhash.$sxhash_method_table$.getGlobalValue(), assertion_handles.$dtp_assertion$.getGlobalValue(), Symbols.symbol_function((SubLObject)assertion_handles.$sym66$SXHASH_ASSERTION_METHOD));
        utilities_macros.register_cyc_api_function((SubLObject)assertion_handles.$sym44$ASSERTION_P, (SubLObject)assertion_handles.$list67, (SubLObject)assertion_handles.$str68$Return_T_iff_OBJECT_is_an_HL_asse, (SubLObject)assertion_handles.NIL, (SubLObject)assertion_handles.$list69);
        utilities_macros.register_cyc_api_function((SubLObject)assertion_handles.$sym72$ASSERTION_ID, (SubLObject)assertion_handles.$list73, (SubLObject)assertion_handles.$str74$Return_the_id_of_this_ASSERTION_, (SubLObject)assertion_handles.$list75, (SubLObject)assertion_handles.$list25);
        utilities_macros.register_cyc_api_function((SubLObject)assertion_handles.$sym77$FIND_ASSERTION_BY_ID, (SubLObject)assertion_handles.$list46, (SubLObject)assertion_handles.$str78$Return_the_assertion_with_ID__or_, (SubLObject)assertion_handles.$list79, (SubLObject)assertion_handles.$list80);
        return (SubLObject)assertion_handles.NIL;
    }
