...
public final class evaluation_defns extends SubLTranslatedFile
{
    ...
    public static SubLObject init_evaluation_defns_file() {
        ...
        evaluation_defns.$use_new_nl_generation_api_for_generate_phrase_fnP$ = SubLFiles.deflexical("*USE-NEW-NL-GENERATION-API-FOR-GENERATE-PHRASE-FN?*", (SubLObject)((evaluation_defns.NIL != Symbols.boundp((SubLObject)evaluation_defns.$sym204$_USE_NEW_NL_GENERATION_API_FOR_GENERATE_PHRASE_FN__)) ? evaluation_defns.$use_new_nl_generation_api_for_generate_phrase_fnP$.getGlobalValue() : evaluation_defns.NIL));
        ...
        evaluation_defns.$term_to_isg_table$ = SubLFiles.deflexical("*TERM-TO-ISG-TABLE*", (evaluation_defns.NIL != Symbols.boundp((SubLObject)evaluation_defns.$sym303$_TERM_TO_ISG_TABLE_)) ? evaluation_defns.$term_to_isg_table$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)evaluation_defns.EQUAL), (SubLObject)evaluation_defns.UNPROVIDED));
        ...
        evaluation_defns.$term_to_isg_wXstart_table$ = SubLFiles.deflexical("*TERM-TO-ISG-W/START-TABLE*", (evaluation_defns.NIL != Symbols.boundp((SubLObject)evaluation_defns.$sym306$_TERM_TO_ISG_W_START_TABLE_)) ? evaluation_defns.$term_to_isg_wXstart_table$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)evaluation_defns.EQUAL), (SubLObject)evaluation_defns.UNPROVIDED));
        return (SubLObject)evaluation_defns.NIL;
    }
