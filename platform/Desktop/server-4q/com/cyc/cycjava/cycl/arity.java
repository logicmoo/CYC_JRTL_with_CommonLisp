      ...
      SubLTranslatedFile
{
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 711L)
  private static SubLSymbol $kb_arity_table_equality_test$;
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 856L)
  private static SubLSymbol $kb_arity_table$;
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 4870L)
  private static SubLSymbol $kb_arity_min_table$;
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 8623L)
  ...
  {
    $kb_arity_table$.setGlobalValue( Hashtables.make_hash_table( cardinality_estimates.instance_cardinality( $const1$Relation ), $kb_arity_table_equality_test$.getGlobalValue(), UNPROVIDED ) );
    return $kb_arity_table$.getGlobalValue();
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 1115L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 1248L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 1500L)
  public static SubLObject arity(final SubLObject relation)
  {
    ...
    if( NIL != obsolete.reifiable_natP( relation, Symbols.symbol_function( $sym3$CYC_VAR_ ), mt_vars.$anect_mt$.getGlobalValue() ) )
    {
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 1924L)
  public static SubLObject arity_robust(final SubLObject relation)
  {
    ...
    {
      final SubLObject query_results = ask_utilities.query_template( $sym7$_X, ConsesLow.listS( $const8$arity, relation, $list9 ), $const10$InferencePSC, $list11 );
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 2323L)
  ...
  public static SubLObject initialize_arities()
  {
    ...
    {
      Hashtables.clrhash( $kb_arity_table$.getGlobalValue() );
    }
    else
    {
    ...
    try
    {
      ...
      final SubLObject pred_var = $const8$arity;
      if( NIL != kb_mapping_macros.do_predicate_extent_index_key_validator( pred_var ) )
      {
        final SubLObject pred_var_$1 = $const8$arity;
    ...
    return Hashtables.hash_table_count( $kb_arity_table$.getGlobalValue() );
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 2824L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 3062L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 3188L)
  public static SubLObject initialize_arity_for_relation(final SubLObject relation)
  {
    final SubLObject v_arity = kb_mapping_utilities.fpred_value_in_any_mt( relation, $const8$arity, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL == v_arity )
    {
      return NIL;
    }
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 3407L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 3663L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 3876L)
  ...
  {
    $kb_arity_min_table$.setGlobalValue( Hashtables.make_hash_table( cardinality_estimates.instance_cardinality( $const20$VariableArityRelation ), $kb_arity_table_equality_test$.getGlobalValue(), UNPROVIDED ) );
    return $kb_arity_min_table$.getGlobalValue();
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 5169L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 5310L)
  public static SubLObject set_arity_min(final SubLObject relation, final SubLObject arity_min)
  {
    assert NIL != forts.fort_p( relation ) : relation;
    return Hashtables.sethash( relation, $kb_arity_min_table$.getGlobalValue(), arity_min );
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 5452L)
  public static SubLObject rem_arity_min(final SubLObject relation)
  {
    Hashtables.remhash( relation, $kb_arity_min_table$.getGlobalValue() );
    return relation;
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 5586L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 5748L)
  ...
  public static SubLObject initialize_min_arities()
  {
    ...
    {
      Hashtables.clrhash( $kb_arity_min_table$.getGlobalValue() );
    }
    else
    {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym13$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( $const14$EverythingPSC, thread );
      final SubLObject pred_var = $const21$arityMin;
      if( NIL != kb_mapping_macros.do_predicate_extent_index_key_validator( pred_var ) )
      {
        final SubLObject pred_var_$11 = $const21$arityMin;
    ...
    return Hashtables.hash_table_count( $kb_arity_min_table$.getGlobalValue() );
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 6613L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 6867L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 7001L)
  public static SubLObject initialize_arity_min_for_relation(final SubLObject relation)
  {
    final SubLObject arity_min = kb_mapping_utilities.fpred_value_in_any_mt( relation, $const21$arityMin, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL == arity_min )
    {
      return NIL;
    }
  ...
  public static SubLObject initialize_arity_min_for_relation_guts(final SubLObject relation, SubLObject arity_min)
  {
    ...
    assert NIL != Types.integerp( arity_min ) : arity_min;
    set_arity_min( relation, arity_min );
    return arity_min;
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 7531L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 7985L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 8322L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 8709L)
  public static SubLObject initialize_arity_max_table()
  {
    $kb_arity_max_table$.setGlobalValue( Hashtables.make_hash_table( cardinality_estimates.instance_cardinality( $const20$VariableArityRelation ), $kb_arity_table_equality_test$.getGlobalValue(), UNPROVIDED ) );
    return $kb_arity_max_table$.getGlobalValue();
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 8922L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 9063L)
  public static SubLObject set_arity_max(final SubLObject relation, final SubLObject arity_max)
  {
    assert NIL != forts.fort_p( relation ) : relation;
    return Hashtables.sethash( relation, $kb_arity_max_table$.getGlobalValue(), arity_max );
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 9205L)
  public static SubLObject rem_arity_max(final SubLObject relation)
  {
    Hashtables.remhash( relation, $kb_arity_max_table$.getGlobalValue() );
    return relation;
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 9339L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 9903L)
  public static SubLObject initialize_max_arities()
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( NIL != $kb_arity_max_table$.getGlobalValue() )
    {
      Hashtables.clrhash( $kb_arity_max_table$.getGlobalValue() );
    }
    else
    {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym13$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( $const14$EverythingPSC, thread );
      final SubLObject pred_var = $const25$arityMax;
      if( NIL != kb_mapping_macros.do_predicate_extent_index_key_validator( pred_var ) )
      {
        final SubLObject pred_var_$21 = $const25$arityMax;
    ...
    return Hashtables.hash_table_count( $kb_arity_max_table$.getGlobalValue() );
  }
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 10496L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 10630L)
  public static SubLObject initialize_arity_max_for_relation(final SubLObject relation)
  {
    final SubLObject arity_max = kb_mapping_utilities.fpred_value_in_any_mt( relation, $const25$arityMax, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL == arity_max )
    {
      return NIL;
    }
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 10872L)
  public static SubLObject initialize_arity_max_for_relation_guts(final SubLObject relation, SubLObject arity_max)
  {
    ...
    assert NIL != Types.integerp( arity_max ) : arity_max;
    set_arity_max( relation, arity_max );
    return arity_max;
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 11160L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 11614L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 12019L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 12319L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 12583L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 13509L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 13961L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 14458L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 15016L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 15622L)
  public static SubLObject binaryP(final SubLObject relation)
  {
    return Equality.eql( arity( relation ), TWO_INTEGER );
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 15746L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 15850L)
  public static SubLObject logical_operator_arity(final SubLObject v_object)
  {
    if( NIL != el_utilities.cyc_const_unary_logical_op_p( v_object ) )
    {
      return ONE_INTEGER;
    }
    if( NIL != el_utilities.cyc_const_binary_logical_op_p( v_object ) )
    {
      return TWO_INTEGER;
    }
    if( NIL != el_utilities.cyc_const_ternary_logical_op_p( v_object ) )
    {
      return THREE_INTEGER;
    }
    if( NIL != el_utilities.cyc_const_quaternary_logical_op_p( v_object ) )
    {
      return FOUR_INTEGER;
    }
    if( NIL != el_utilities.cyc_const_quintary_logical_op_p( v_object ) )
    {
      return FIVE_INTEGER;
    }
    return NIL;
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 16335L)
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 16438L)
  public static SubLObject relation_arity_constraint_sentences(final SubLObject relation)
  {
    ...
    if( NIL != fort_types_interface.variable_arity_relation_p( relation ) )
    {
      ...
      arity_constraints = ConsesLow.cons( ConsesLow.list( $const21$arityMin, relation, min_arity ), arity_constraints );
      if( NIL != max_arity )
      {
        arity_constraints = ConsesLow.cons( ConsesLow.list( $const25$arityMax, relation, max_arity ), arity_constraints );
      }
      return Sequences.nreverse( arity_constraints );
    }
    return ConsesLow.list( ConsesLow.list( $const8$arity, relation, arity( relation ) ) );
  }
  ...
  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 17288L)
  public static SubLObject rebuild_arity_cache()
  {
    return initialize_all_arities();
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 17364L)
  public static SubLObject dump_arity_cache_to_stream(final SubLObject stream)
  {
    cfasl.cfasl_output( $kb_arity_table$.getGlobalValue(), stream );
    cfasl.cfasl_output( $kb_arity_min_table$.getGlobalValue(), stream );
    cfasl.cfasl_output( $kb_arity_max_table$.getGlobalValue(), stream );
    cfasl.cfasl_output( NIL, stream );
    return NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/lisp", position = 17624L)
  ...
  {
    SubLFiles.declareFunction( me, "initialize_arity_table", "INITIALIZE-ARITY-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "arity_lookup", "ARITY-LOOKUP", 1, 0, false );
    SubLFiles.declareFunction( me, "set_arity", "SET-ARITY", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_arity", "REM-ARITY", 1, 0, false );
    SubLFiles.declareFunction( me, "arity", "ARITY", 1, 0, false );
    new $arity$UnaryFunction();
    SubLFiles.declareFunction( me, "arity_robust", "ARITY-ROBUST", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_all_arities", "INITIALIZE-ALL-ARITIES", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_arities", "INITIALIZE-ARITIES", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_from_formula", "INITIALIZE-ARITY-FROM-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_from_assertion", "INITIALIZE-ARITY-FROM-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_for_relation", "INITIALIZE-ARITY-FOR-RELATION", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_for_relation_guts", "INITIALIZE-ARITY-FOR-RELATION-GUTS", 2, 0, false );
    SubLFiles.declareFunction( me, "possibly_simplify_arity", "POSSIBLY-SIMPLIFY-ARITY", 1, 0, false );
    SubLFiles.declareFunction( me, "maybe_add_arity_for_relation", "MAYBE-ADD-ARITY-FOR-RELATION", 2, 0, false );
    SubLFiles.declareFunction( me, "maybe_remove_arity_for_relation", "MAYBE-REMOVE-ARITY-FOR-RELATION", 2, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_min_table", "INITIALIZE-ARITY-MIN-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "arity_min_lookup", "ARITY-MIN-LOOKUP", 1, 0, false );
    SubLFiles.declareFunction( me, "set_arity_min", "SET-ARITY-MIN", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_arity_min", "REM-ARITY-MIN", 1, 0, false );
    SubLFiles.declareFunction( me, "arity_min", "ARITY-MIN", 1, 0, false );
    SubLFiles.declareFunction( me, "arity_min_int", "ARITY-MIN-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_min_arities", "INITIALIZE-MIN-ARITIES", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_min_from_formula", "INITIALIZE-ARITY-MIN-FROM-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_min_from_assertion", "INITIALIZE-ARITY-MIN-FROM-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_min_for_relation", "INITIALIZE-ARITY-MIN-FOR-RELATION", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_min_for_relation_guts", "INITIALIZE-ARITY-MIN-FOR-RELATION-GUTS", 2, 0, false );
    SubLFiles.declareFunction( me, "maybe_add_arity_min_for_relation", "MAYBE-ADD-ARITY-MIN-FOR-RELATION", 2, 0, false );
    SubLFiles.declareFunction( me, "maybe_remove_arity_min_for_relation", "MAYBE-REMOVE-ARITY-MIN-FOR-RELATION", 1, 0, false );
    SubLFiles.declareFunction( me, "min_arity", "MIN-ARITY", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_max_table", "INITIALIZE-ARITY-MAX-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "arity_max_lookup", "ARITY-MAX-LOOKUP", 1, 0, false );
    SubLFiles.declareFunction( me, "set_arity_max", "SET-ARITY-MAX", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_arity_max", "REM-ARITY-MAX", 1, 0, false );
    SubLFiles.declareFunction( me, "arity_max", "ARITY-MAX", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_max_arities", "INITIALIZE-MAX-ARITIES", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_max_from_formula", "INITIALIZE-ARITY-MAX-FROM-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_max_from_assertion", "INITIALIZE-ARITY-MAX-FROM-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_max_for_relation", "INITIALIZE-ARITY-MAX-FOR-RELATION", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_arity_max_for_relation_guts", "INITIALIZE-ARITY-MAX-FOR-RELATION-GUTS", 2, 0, false );
    SubLFiles.declareFunction( me, "maybe_add_arity_max_for_relation", "MAYBE-ADD-ARITY-MAX-FOR-RELATION", 2, 0, false );
    SubLFiles.declareFunction( me, "maybe_remove_arity_max_for_relation", "MAYBE-REMOVE-ARITY-MAX-FOR-RELATION", 1, 0, false );
    SubLFiles.declareFunction( me, "max_arity", "MAX-ARITY", 1, 0, false );
    SubLFiles.declareFunction( me, "valid_relation_argnumP", "VALID-RELATION-ARGNUM?", 2, 0, false );
    SubLFiles.declareFunction( me, "arity_admitsP", "ARITY-ADMITS?", 2, 0, false );
    SubLFiles.declareFunction( me, "any_arity_admitsP", "ANY-ARITY-ADMITS?", 2, 0, false );
    SubLFiles.declareFunction( me, "arity_admitsGE", "ARITY-ADMITS>=", 2, 0, false );
    SubLFiles.declareFunction( me, "arity_admitsG", "ARITY-ADMITS>", 2, 0, false );
    SubLFiles.declareFunction( me, "arity_admitsLE", "ARITY-ADMITS<=", 2, 0, false );
    SubLFiles.declareFunction( me, "arity_admitsL", "ARITY-ADMITS<", 2, 0, false );
    SubLFiles.declareFunction( me, "binaryP", "BINARY?", 1, 0, false );
    SubLFiles.declareFunction( me, "binary_arg_swap", "BINARY-ARG-SWAP", 1, 0, false );
    SubLFiles.declareFunction( me, "logical_operator_arity", "LOGICAL-OPERATOR-ARITY", 1, 0, false );
    SubLFiles.declareFunction( me, "variable_arityP", "VARIABLE-ARITY?", 1, 0, false );
    SubLFiles.declareFunction( me, "relation_arity_constraint_sentences", "RELATION-ARITY-CONSTRAINT-SENTENCES", 1, 0, false );
    SubLFiles.declareFunction( me, "arity_cache_unbuiltP", "ARITY-CACHE-UNBUILT?", 0, 0, false );
    SubLFiles.declareFunction( me, "rebuild_arity_cache", "REBUILD-ARITY-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "dump_arity_cache_to_stream", "DUMP-ARITY-CACHE-TO-STREAM", 1, 0, false );
    SubLFiles.declareFunction( me, "load_arity_cache_from_stream", "LOAD-ARITY-CACHE-FROM-STREAM", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_arity_file()
  {
    $kb_arity_table_equality_test$ = SubLFiles.deflexical( "*KB-ARITY-TABLE-EQUALITY-TEST*", Symbols.symbol_function( EQL ) );
    $kb_arity_table$ = SubLFiles.deflexical( "*KB-ARITY-TABLE*", ( maybeDefault( $sym0$_KB_ARITY_TABLE_, $kb_arity_table$, NIL ) ) );
    $kb_arity_min_table$ = SubLFiles.deflexical( "*KB-ARITY-MIN-TABLE*", ( maybeDefault( $sym19$_KB_ARITY_MIN_TABLE_, $kb_arity_min_table$, NIL ) ) );
    $kb_arity_max_table$ = SubLFiles.deflexical( "*KB-ARITY-MAX-TABLE*", ( maybeDefault( $sym24$_KB_ARITY_MAX_TABLE_, $kb_arity_max_table$, NIL ) ) );
    return NIL;
  }
  ...
  public static SubLObject setup_arity_file()
  {
    ...
    access_macros.register_external_symbol( $sym23$MIN_ARITY );
    subl_macro_promotions.declare_defglobal( $sym24$_KB_ARITY_MAX_TABLE_ );
    access_macros.register_external_symbol( $sym27$MAX_ARITY );
    generic_testing.define_test_case_table_int( $sym29$ARITY_ADMITS_, ConsesLow.list( new SubLObject[] { $kw30$TEST, NIL, $kw31$OWNER, NIL, $kw32$CLASSES, NIL, $kw33$KB, $kw34$TINY, $kw35$WORKING_, T
    } ), $list36 );
    generic_testing.define_test_case_table_int( $sym37$ARITY_ADMITS__, ConsesLow.list( new SubLObject[] { $kw30$TEST, NIL, $kw31$OWNER, NIL, $kw32$CLASSES, NIL, $kw33$KB, $kw34$TINY, $kw35$WORKING_, T
    } ), $list38 );
    generic_testing.define_test_case_table_int( $sym39$ARITY_ADMITS_, ConsesLow.list( new SubLObject[] { $kw30$TEST, NIL, $kw31$OWNER, NIL, $kw32$CLASSES, NIL, $kw33$KB, $kw34$TINY, $kw35$WORKING_, T
    } ), $list40 );
    generic_testing.define_test_case_table_int( $sym41$ARITY_ADMITS__, ConsesLow.list( new SubLObject[] { $kw30$TEST, NIL, $kw31$OWNER, NIL, $kw32$CLASSES, NIL, $kw33$KB, $kw34$TINY, $kw35$WORKING_, T
    } ), $list42 );
    generic_testing.define_test_case_table_int( $sym43$ARITY_ADMITS_, ConsesLow.list( new SubLObject[] { $kw30$TEST, NIL, $kw31$OWNER, NIL, $kw32$CLASSES, NIL, $kw33$KB, $kw34$TINY, $kw35$WORKING_, T
    } ), $list44 );
    generic_testing.define_test_case_table_int( $sym45$RELATION_ARITY_CONSTRAINT_SENTENCES, ConsesLow.list( new SubLObject[] { $kw30$TEST, NIL, $kw31$OWNER, NIL, $kw32$CLASSES, NIL, $kw33$KB, $kw46$FULL, $kw35$WORKING_,
      T
    } ), $list47 );
    return NIL;
  }
  ...
  {
    me = new arity();
    $kb_arity_table_equality_test$ = null;
    $kb_arity_table$ = null;
    $kb_arity_min_table$ = null;
    $kb_arity_max_table$ = null;
    $sym0$_KB_ARITY_TABLE_ = makeSymbol( "*KB-ARITY-TABLE*" );
    $const1$Relation = constant_handles.reader_make_constant_shell( makeString( "Relation" ) );
    $sym2$FORT_P = makeSymbol( "FORT-P" );
    $sym3$CYC_VAR_ = makeSymbol( "CYC-VAR?" );
    $sym4$ARITY = makeSymbol( "ARITY" );
    $list5 = ConsesLow.list( makeSymbol( "RELATION" ) );
    $str6$Return_the_arity_for_relation_con = makeString( "Return the arity for relation constant RELATION." );
    $sym7$_X = makeSymbol( "?X" );
    $const8$arity = constant_handles.reader_make_constant_shell( makeString( "arity" ) );
    $list9 = ConsesLow.list( makeSymbol( "?X" ) );
    $const10$InferencePSC = constant_handles.reader_make_constant_shell( makeString( "InferencePSC" ) );
    $list11 = ConsesLow.list( makeKeyword( "ALLOW-INDETERMINATE-RESULTS?" ), NIL );
    $str12$Initializing_all_arities___ = makeString( "Initializing all arities..." );
    ...
    $str18$Trying_to_overload_arity_for__A_f = makeString( "Trying to overload arity for ~A from ~A to ~A" );
    $sym19$_KB_ARITY_MIN_TABLE_ = makeSymbol( "*KB-ARITY-MIN-TABLE*" );
    $const20$VariableArityRelation = constant_handles.reader_make_constant_shell( makeString( "VariableArityRelation" ) );
    $const21$arityMin = constant_handles.reader_make_constant_shell( makeString( "arityMin" ) );
    $str22$Trying_to_overload_arityMin_for__ = makeString( "Trying to overload arityMin for ~A from ~A to ~A" );
    $sym23$MIN_ARITY = makeSymbol( "MIN-ARITY" );
    $sym24$_KB_ARITY_MAX_TABLE_ = makeSymbol( "*KB-ARITY-MAX-TABLE*" );
    $const25$arityMax = constant_handles.reader_make_constant_shell( makeString( "arityMax" ) );
    $str26$Trying_to_overload_arityMax_for__ = makeString( "Trying to overload arityMax for ~A from ~A to ~A" );
    $sym27$MAX_ARITY = makeSymbol( "MAX-ARITY" );
    $sym28$RELATION_P = makeSymbol( "RELATION-P" );
    $sym29$ARITY_ADMITS_ = makeSymbol( "ARITY-ADMITS?" );
    $kw30$TEST = makeKeyword( "TEST" );
    $kw31$OWNER = makeKeyword( "OWNER" );
    $kw32$CLASSES = makeKeyword( "CLASSES" );
    $kw33$KB = makeKeyword( "KB" );
    $kw34$TINY = makeKeyword( "TINY" );
    $kw35$WORKING_ = makeKeyword( "WORKING?" );
    $list36 = ConsesLow.list( ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "commutativeInArgs" ) ), TWO_INTEGER ), NIL ), ConsesLow.list( ConsesLow.list( constant_handles
        .reader_make_constant_shell( makeString( "commutativeInArgs" ) ), THREE_INTEGER ), T ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "commutativeInArgs" ) ),
            FOUR_INTEGER ), T ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "commutativeInArgs" ) ), FIVE_INTEGER ), T ) );
    $sym37$ARITY_ADMITS__ = makeSymbol( "ARITY-ADMITS>=" );
    $list38 = ConsesLow.list( ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "commutativeInArgs" ) ), makeInteger( 212 ) ), T ) );
    $sym39$ARITY_ADMITS_ = makeSymbol( "ARITY-ADMITS>" );
    $list40 = ConsesLow.list( ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "commutativeInArgs" ) ), ONE_INTEGER ), T ), ConsesLow.list( ConsesLow.list( constant_handles
        .reader_make_constant_shell( makeString( "commutativeInArgs" ) ), SEVEN_INTEGER ), T ) );
    $sym41$ARITY_ADMITS__ = makeSymbol( "ARITY-ADMITS<=" );
    $list42 = ConsesLow.list( ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "commutativeInArgs" ) ), THREE_INTEGER ), T ), ConsesLow.list( ConsesLow.list( constant_handles
        .reader_make_constant_shell( makeString( "commutativeInArgs" ) ), FOUR_INTEGER ), T ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "commutativeInArgs" ) ),
            TWO_INTEGER ), NIL ) );
    $sym43$ARITY_ADMITS_ = makeSymbol( "ARITY-ADMITS<" );
    $list44 = ConsesLow.list( ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "commutativeInArgs" ) ), SEVEN_INTEGER ), T ), ConsesLow.list( ConsesLow.list( constant_handles
        .reader_make_constant_shell( makeString( "commutativeInArgs" ) ), ONE_INTEGER ), NIL ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "commutativeInArgs" ) ),
            FOUR_INTEGER ), T ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "commutativeInArgs" ) ), THREE_INTEGER ), NIL ) );
    $sym45$RELATION_ARITY_CONSTRAINT_SENTENCES = makeSymbol( "RELATION-ARITY-CONSTRAINT-SENTENCES" );
    $kw46$FULL = makeKeyword( "FULL" );
    $list47 = ConsesLow.list( ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "isa" ) ) ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString(
        "arity" ) ), constant_handles.reader_make_constant_shell( makeString( "isa" ) ), TWO_INTEGER ) ) ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "different" ) ) ),
            ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "arityMin" ) ), constant_handles.reader_make_constant_shell( makeString( "different" ) ), TWO_INTEGER ) ) ), ConsesLow
                .list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "Percent" ) ) ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "arityMin" ) ),
                    constant_handles.reader_make_constant_shell( makeString( "Percent" ) ), ONE_INTEGER ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "arityMax" ) ), constant_handles
                        .reader_make_constant_shell( makeString( "Percent" ) ), TWO_INTEGER ) ) ) );
  }

  public static final class $arity$UnaryFunction
      extends
        UnaryFunction
  {
