...
public final class ql_index_support extends SubLTranslatedFile
{
    ...
    public static SubLObject init_ql_index_support_file() {
        ...
        ql_index_support.$ql_index_update_procedure$ = SubLFiles.deflexical("*QL-INDEX-UPDATE-PROCEDURE*", (SubLObject)(maybeDefault((SubLObject)ql_index_support.$sym46$_QL_INDEX_UPDATE_PROCEDURE_, ql_index_support.$ql_index_update_procedure$, ql_index_support.$sym47$ENQUEUE_FOR_QL_INDEXING)));
        ql_index_support.$ql_index_update_queue$ = SubLFiles.deflexical("*QL-INDEX-UPDATE-QUEUE*", (SubLObject)(maybeDefault((SubLObject)ql_index_support.$sym50$_QL_INDEX_UPDATE_QUEUE_, ql_index_support.$ql_index_update_queue$, ql_index_support.NIL)));
        ql_index_support.$ql_index_dequeue_procedure$ = SubLFiles.deflexical("*QL-INDEX-DEQUEUE-PROCEDURE*", (SubLObject)(maybeDefault((SubLObject)ql_index_support.$sym52$_QL_INDEX_DEQUEUE_PROCEDURE_, ql_index_support.$ql_index_dequeue_procedure$, ql_index_support.$sym53$PROCESS_QL_INDEX_QUEUE_ENTRIES)));
        ql_index_support.$ql_index_update_process$ = SubLFiles.deflexical("*QL-INDEX-UPDATE-PROCESS*", (SubLObject)(maybeDefault((SubLObject)ql_index_support.$sym54$_QL_INDEX_UPDATE_PROCESS_, ql_index_support.$ql_index_update_process$, ql_index_support.$str55$The_process_object_responsible_fo)));
        return (SubLObject)ql_index_support.NIL;
    }
