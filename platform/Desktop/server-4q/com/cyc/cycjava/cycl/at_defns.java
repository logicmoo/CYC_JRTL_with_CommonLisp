      ...
      SubLTranslatedFile
{
  ...
  {
    final SubLObject new_val = suf_defn_sort( ConsesLow.cons( assertion, defns.defns_cache_gethash_without_values( col, defns.$suf_defn_cache_index$.getGlobalValue() ) ) );
    if( NIL != new_val )
    {
  ...
  {
    final SubLObject new_val = suf_defn_sort( Sequences.delete( assertion, defns.defns_cache_gethash_without_values( col, defns.$suf_defn_cache_index$.getGlobalValue() ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED,
        UNPROVIDED ) );
    if( NIL != new_val )
    {
      defns.defns_cache_sethash( col, defns.$suf_defn_cache_index$.getGlobalValue(), new_val );
  ...
  {
    return defns.defns_cache_sethash( collection, defns.$suf_defn_cache_index$.getGlobalValue(), suf_defn_sort( conses_high.nunion( defns.defns_cache_gethash_without_values( collection, defns.$suf_defn_cache_index$
        .getGlobalValue() ), conses_high.copy_list( defn_assertions ), UNPROVIDED, UNPROVIDED ) ) );
  }
    ...
    if( NIL == defn_genl_searchedP( collection ) )
    {
      ...
      if( NIL != assertions )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          {
            assertions_to_remove = ConsesLow.cons( assertion, assertions_to_remove );
          }
        ...
        final SubLObject new_value = suf_defn_sort( conses_high.nset_difference( assertions, assertions_to_remove, UNPROVIDED, UNPROVIDED ) );
        if( NIL != new_value )
        {
  ...
  {
    final SubLObject new_val = suf_defn_sort( ConsesLow.cons( assertion, defns.defns_cache_gethash_without_values( col, defns.$suf_quoted_defn_cache_index$.getGlobalValue() ) ) );
    if( NIL != new_val )
    {
  ...
  {
    final SubLObject new_val = suf_defn_sort( Sequences.delete( assertion, defns.defns_cache_gethash_without_values( col, defns.$suf_quoted_defn_cache_index$.getGlobalValue() ), UNPROVIDED, UNPROVIDED, UNPROVIDED,
  ...
  {
    return defns.defns_cache_sethash( collection, defns.$suf_quoted_defn_cache_index$.getGlobalValue(), suf_defn_sort( conses_high.nunion( defns.defns_cache_gethash_without_values( collection,
        defns.$suf_quoted_defn_cache_index$.getGlobalValue() ), conses_high.copy_list( defn_assertions ), UNPROVIDED, UNPROVIDED ) ) );
  }
  ...
  public static SubLObject at_defns_admitP(final SubLObject collection)
  {
    ...
    if( NIL != admitsP )
    {
      set_defn_col_history( collection, $kw1$ADMITTED );
    }
    else
    {
      set_defn_col_history( collection, $kw2$REJECTED );
    }
    return admitsP;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $old_defns_admitP_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $old_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $old_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $old_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $old_defns_admitP_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $old_defns_admitP_meters$.getDynamicValue( thread ), $sym11$OLD_DEFNS_ADMIT_ );
    return NIL;
  }
  ...
  public static SubLObject old_defns_admitP_metered(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        {
          admittedP = makeBoolean( NIL != suf_defn_assertions( collection ) && ( NIL == at_vars.$at_apply_necessary_defnsP$.getDynamicValue( thread ) || NIL != necessary_defns_permitP( collection, v_term, mt ) )
              && NIL != sufficient_defns_admitP( collection, v_term, mt ) );
        }
      }
      finally
      {
  ...
  public static SubLObject old_defns_admitP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      Hashtables.sethash( $kw4$CALLS, $old_defns_admitP_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $old_defns_admitP_meters$.getDynamicValue( thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $old_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $old_defns_admitP_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $old_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $old_defns_admitP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $old_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS, $old_defns_admitP_meters$
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $old_defns_rejectP_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $old_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $old_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $old_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $old_defns_rejectP_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $old_defns_rejectP_meters$.getDynamicValue( thread ), $sym15$OLD_DEFNS_REJECT_ );
    return NIL;
  }
  ...
  public static SubLObject old_defns_rejectP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $old_defns_rejectP_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $old_defns_rejectP_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $old_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $old_defns_rejectP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $old_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $old_defns_rejectP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $old_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS, $old_defns_rejectP_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  public static SubLObject defining_defns_admitP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    return Equality.eq( $kw1$ADMITTED, result );
  }
  ...
  public static SubLObject defining_defns_rejectP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    return Equality.eq( $kw2$REJECTED, result );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $defining_defns_status_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $defining_defns_status_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $defining_defns_status_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $defining_defns_status_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $defining_defns_status_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $defining_defns_status_meters$.getDynamicValue( thread ), $sym18$DEFINING_DEFNS_STATUS );
    return NIL;
  }
  ...
  public static SubLObject defining_defns_status_metered(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject defn = el_utilities.cycl_subl_symbol_symbol( kb_mapping_utilities.fpred_value_in_relevant_mts( collection, $const20$defnIff, mt, ONE_INTEGER, TWO_INTEGER, $kw21$TRUE ) );
  ...
  public static SubLObject defining_defns_status(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $defining_defns_status_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $defining_defns_status_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $defining_defns_status_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $defining_defns_status_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $defining_defns_status_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $defining_defns_status_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $defining_defns_status_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS, $defining_defns_status_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  public static SubLObject defining_defn_violation_data(final SubLObject collection, final SubLObject v_term, final SubLObject defn, final SubLObject quotedP, SubLObject mt)
  {
    ...
    {
      data = ConsesLow.cons( ConsesLow.list( $kw22$VIA_GENL_PRED, at_vars.$at_source$.getDynamicValue( thread ) ), data );
    }
    if( NIL != at_vars.$include_at_constraint_gafP$.getDynamicValue( thread ) && NIL != at_vars.$at_constraint_gaf$.getDynamicValue( thread ) )
    {
      data = ConsesLow.cons( ConsesLow.list( $kw23$AT_CONSTRAINT_GAF, at_vars.$at_constraint_gaf$.getDynamicValue( thread ) ), data );
    }
    if( NIL != mt )
    {
    ...
    if( NIL != quotedP )
    {
      return ConsesLow.listS( $kw24$MAL_ARG_WRT_QUOTED_IFF_DEFN, new SubLObject[] { v_term, at_vars.$at_reln$.getDynamicValue( thread ), at_vars.$at_argnum$.getDynamicValue( thread ), collection, defn, data
      } );
    }
    return ConsesLow.listS( $kw25$MAL_ARG_WRT_IFF_DEFN, new SubLObject[] { v_term, at_vars.$at_reln$.getDynamicValue( thread ), at_vars.$at_argnum$.getDynamicValue( thread ), collection, defn, data
    } );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), $sym27$SUFFICIENT_DEFNS_ADMIT_ );
    return NIL;
  }
  ...
  public static SubLObject sufficient_defns_admitP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $sufficient_defns_admitP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $sufficient_defns_admitP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $sufficient_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS, $sufficient_defns_admitP_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
              ...
              if( NIL != mt_relevance_macros.relevant_mtP( defn_mt ) && NIL != genls.genlP( at_vars.$defn_collection$.getDynamicValue( thread ), collection, mt, UNPROVIDED ) )
              {
                ...
                if( NIL != viable_defnP( defn, at_vars.$defn_collection$.getDynamicValue( thread ) ) )
                {
                  ...
                  try
                  {
                    ...
                    else if( NIL != quotedP && NIL != quoted_defn_admitsP( defn, v_term, collection, mt ) )
                    {
                      admittedP = T;
                    }
                  }
                  ...
                  if( NIL == admittedP && NIL != at_vars.$noting_at_violationsP$.getDynamicValue( thread ) )
                  {
                    ...
                    if( NIL == conses_high.member( item_var, failing_defns, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
                    {
                      failing_defns = ConsesLow.cons( item_var, failing_defns );
                    }
                  }
                }
              }
                ...
                try
                {
                  ...
                  if( NIL != mt_relevance_macros.relevant_mtP( defn_mt ) )
                  {
                    ...
                    if( NIL != viable_defnP( defn, at_vars.$defn_collection$.getDynamicValue( thread ) ) )
                    {
                      ...
                      else if( NIL != quiet_defn_admitsP( defn, v_term, collection, mt ) )
                      {
                        ...
                        just = ConsesLow.cons( ConsesLow.list( assertions_high.assertion_formula( assertion ), $kw21$TRUE ), just );
                      }
                    }
                  }
                }
  ...
  public static SubLObject sufficient_defn_violation_data(final SubLObject collection, final SubLObject v_term, final SubLObject v_defns, final SubLObject quotedP, SubLObject mt)
  {
    ...
    if( NIL != quotedP )
    {
      return ConsesLow.listS( $kw29$MAL_ARG_WRT_QUOTED_SUF_DEFNS, new SubLObject[] { v_term, at_vars.$at_reln$.getDynamicValue( thread ), at_vars.$at_argnum$.getDynamicValue( thread ), collection, v_defns, data
      } );
    }
    return ConsesLow.listS( $kw30$MAL_ARG_WRT_SUF_DEFNS, new SubLObject[] { v_term, at_vars.$at_reln$.getDynamicValue( thread ), at_vars.$at_argnum$.getDynamicValue( thread ), collection, v_defns, data
    } );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), $sym32$NECESSARY_DEFNS_REJECT_ );
    return NIL;
  }
          ...
          try
          {
            ...
            try
            {
              ...
              try
              {
                                    ...
                                    .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                {
                                  ...
                                  if( NIL != mt_relevance_macros.relevant_mtP( mt_$27 ) )
                                  {
                                    ...
                                    try
                                    {
                                      ...
                                      for( iteration_state_$29 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == doneP && NIL == dictionary_contents
                ...
                {
                  sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str49$Node__a_does_not_pass_sbhl_type_t, collection, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED,
                      UNPROVIDED, UNPROVIDED );
                }
              }
              finally
  ...
  public static SubLObject necessary_defns_rejectP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $necessary_defns_rejectP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $necessary_defns_rejectP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $necessary_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS, $necessary_defns_rejectP_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
    ...
    if( NIL != kb_mapping_macros.do_gaf_arg_index_key_validator( genl, ONE_INTEGER, defn_pred ) )
    {
      ...
      while ( NIL == done_var)
      {
        ...
        if( NIL != valid )
        {
          ...
          try
          {
            final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, $kw50$GAF, $kw21$TRUE, NIL );
            ...
            while ( NIL == done_var_$34)
            {
              ...
              if( NIL != valid_$36 )
              {
                ...
                if( NIL != viable_defnP( defn, at_vars.$defn_collection$.getDynamicValue( thread ) ) )
                {
                  ...
                  else if( NIL != quotedP && NIL == quoted_defn_admitsP( defn, v_term, collection, UNPROVIDED ) )
                  {
                    rejectedP = T;
                  }
  ...
  public static SubLObject denotational_term_admitted_by_defn_via_isaP(final SubLObject v_term, final SubLObject collection, SubLObject mt)
  {
    ...
    if( NIL != at_vars.permitting_denotational_terms_admitted_by_defn_via_isaP() )
    {
      ...
      try
      {
        ...
        try
        {
          admittedP = makeBoolean( NIL != at_denotational_term_p( v_term, UNPROVIDED ) && ( NIL != isa.isaP( v_term, collection, mt, UNPROVIDED ) || ( NIL != assertions_high.gaf_assertionP(
              sbhl_link_vars.$added_assertion$.getDynamicValue( thread ) ) && NIL != el_utilities.isa_litP( assertions_high.gaf_formula( sbhl_link_vars.$added_assertion$.getDynamicValue( thread ) ) ) && v_term.equal(
                  assertions_high.gaf_arg1( sbhl_link_vars.$added_assertion$.getDynamicValue( thread ) ) ) && NIL != genls.genlsP( assertions_high.gaf_arg2( sbhl_link_vars.$added_assertion$.getDynamicValue( thread ) ),
                      collection, mt, UNPROVIDED ) ) || ( NIL != wff_macros.within_wffP() && NIL != control_vars.within_assertP() && NIL != el_utilities.isa_litP( wff_vars.wff_formula() ) && v_term.equal( cycl_utilities
                          .sentence_arg1( wff_vars.wff_formula(), UNPROVIDED ) ) && NIL != term.el_fort_p( cycl_utilities.sentence_arg2( wff_vars.wff_formula(), UNPROVIDED ) ) && NIL != genls.genlsP( cycl_utilities
                              .sentence_arg2( wff_vars.wff_formula(), UNPROVIDED ), collection, mt, UNPROVIDED ) && NIL == el_utilities.el_negation_p( wff_vars.wff_formula() ) ) ) );
        }
        finally
        {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), $sym52$REJECTED_BY_NECESSARY_DEFNS );
    return NIL;
  }
                ...
                if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( collection, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                {
                  ...
                  try
                  {
                    ...
                    while ( NIL != node_var)
                    {
                      ...
                      {
                        at_vars.$defn_collection$.bind( genl, thread );
                        final SubLObject pred_var = $const54$defnNecessary;
                                ...
                                while ( NIL == done_var_$48)
                                {
                                  ...
                                  if( NIL != valid_$50 )
                                  {
                                    ...
                                    if( NIL != viable_defnP( defn, at_vars.$defn_collection$.getDynamicValue( thread ) ) && NIL == defn_admitsP( defn, v_term, collection, UNPROVIDED ) )
                                    {
                                      ...
                                      if( NIL == conses_high.member( item_var, rejected_by, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
                                      {
                                        rejected_by = ConsesLow.cons( item_var, rejected_by );
                                      }
                                    }
                                  }
                                    ...
                                    iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                {
                                  ...
                                  if( NIL != mt_relevance_macros.relevant_mtP( mt_$54 ) )
                                  {
                                    ...
                                    try
                                    {
                                      ...
                                      for( iteration_state_$56 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
  ...
  public static SubLObject rejected_by_necessary_defns(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ),
          UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $rejected_by_necessary_defns_meters$.getDynamicValue(
          thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $rejected_by_necessary_defns_meters$.getDynamicValue(
          thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS,
          $rejected_by_necessary_defns_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
                            ...
                            try
                            {
                              ...
                              if( NIL != sbhl_link_vars.sbhl_node_object_p( node ) )
                              {
                                ...
                                if( NIL != d_link )
                                {
                                  ...
                                  if( NIL != mt_links )
                                  {
                                    for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( mt_links ) ); NIL == just && NIL == dictionary_contents
                                        .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                    {
                                      thread.resetMultipleValues();
                                      ...
                                      if( NIL != mt_relevance_macros.relevant_mtP( mt_$81 ) )
                                      {
                                        ...
                                        try
                                        {
                                          ...
                                          for( iteration_state_$83 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == just && NIL == dictionary_contents
                                            ...
                                            if( NIL != sbhl_search_vars.relevant_sbhl_tvP( tv ) )
                                            {
                                              ...
                                              try
                                              {
                                                ...
                                                if( NIL != set.set_p( sol ) )
                                                {
                                                  set_contents_var = set.do_set_internal( sol );
                                                  for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object,
                                                      set_contents_var ); NIL == just && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
                                                  {
                                                    node_vars_link_node = set_contents.do_set_contents_next( basis_object, state );
                                ...
                                for( rest_$85 = NIL, rest_$85 = new_list; NIL == just && NIL != rest_$85; rest_$85 = rest_$85.rest() )
                                {
                                  ...
                                  try
                                  {
                                    ...
                                    if( NIL != set.set_p( sol2 ) )
                                    {
                                      set_contents_var2 = set.do_set_internal( sol2 );
                                      for( basis_object2 = set_contents.do_set_contents_basis_object( set_contents_var2 ), state2 = NIL, state2 = set_contents.do_set_contents_initial_state( basis_object2,
                                          set_contents_var2 ); NIL == just && NIL == set_contents.do_set_contents_doneP( basis_object2, state2 ); state2 = set_contents.do_set_contents_update_state( state2 ) )
                                      {
                                        node_vars_link_node3 = set_contents.do_set_contents_next( basis_object2, state2 );
                                        if( NIL != set_contents.do_set_contents_element_validP( state2, node_vars_link_node3 ) && NIL == sbhl_marking_utilities.sbhl_search_path_termination_p( node_vars_link_node3,
                                            UNPROVIDED ) )
  ...
  public static SubLObject necessary_defn_violation_data(final SubLObject collection, final SubLObject v_term, final SubLObject defn_col, final SubLObject defn, final SubLObject quotedP, SubLObject mt)
  {
    ...
    if( NIL != quotedP )
    {
      return ConsesLow.listS( $kw55$MAL_ARG_WRT_QUOTED_NEC_DEFN, new SubLObject[] { v_term, at_vars.$at_reln$.getDynamicValue( thread ), at_vars.$at_argnum$.getDynamicValue( thread ), collection, defn_col, defn, data
      } );
    }
    return ConsesLow.listS( $kw56$MAL_ARG_WRT_NEC_DEFN, new SubLObject[] { v_term, at_vars.$at_reln$.getDynamicValue( thread ), at_vars.$at_argnum$.getDynamicValue( thread ), collection, defn_col, defn, data
    } );
  }
  ...
  public static SubLObject at_quoted_defns_admitP(final SubLObject collection)
  {
    ...
    if( NIL != admitsP )
    {
      set_quoted_defn_fn_history( collection, $kw1$ADMITTED );
    }
    else
    {
      set_quoted_defn_fn_history( collection, $kw2$REJECTED );
    }
    return admitsP;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), $sym58$OLD_QUOTED_DEFNS_ADMIT_ );
    return NIL;
  }
  ...
  public static SubLObject old_quoted_defns_admitP_metered(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        {
          admittedP = makeBoolean( NIL != suf_quoted_defn_assertions( collection ) && ( NIL == at_vars.$at_apply_necessary_defnsP$.getDynamicValue( thread ) || NIL != quoted_necessary_defns_permitP( collection, v_term,
              mt ) ) && NIL != quoted_sufficient_defns_admitP( collection, v_term, mt ) );
        }
      }
      finally
      {
  ...
  public static SubLObject old_quoted_defns_admitP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $old_quoted_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS, $old_quoted_defns_admitP_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), $sym61$OLD_QUOTED_DEFNS_REJECT_ );
    return NIL;
  }
  ...
  public static SubLObject old_quoted_defns_rejectP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $old_quoted_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS, $old_quoted_defns_rejectP_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $quoted_defining_defns_status_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $quoted_defining_defns_status_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $quoted_defining_defns_status_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $quoted_defining_defns_status_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $quoted_defining_defns_status_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $quoted_defining_defns_status_meters$.getDynamicValue( thread ), $sym64$QUOTED_DEFINING_DEFNS_STATUS );
    return NIL;
  }
  ...
  public static SubLObject quoted_defining_defns_status_metered(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject defn = el_utilities.cycl_subl_symbol_symbol( kb_mapping_utilities.fpred_value_in_relevant_mts( collection, $const66$quotedDefnIff, mt, ONE_INTEGER, TWO_INTEGER, $kw21$TRUE ) );
    SubLObject status = NIL;
    if( NIL != viable_defnP( defn, collection ) )
    {
      final SubLObject _prev_bind_0 = at_vars.$defn_collection$.currentBinding( thread );
  ...
  public static SubLObject quoted_defining_defns_status(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $quoted_defining_defns_status_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $quoted_defining_defns_status_meters$.getDynamicValue( thread ),
          UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $quoted_defining_defns_status_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $quoted_defining_defns_status_meters$.getDynamicValue(
          thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $quoted_defining_defns_status_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $quoted_defining_defns_status_meters$.getDynamicValue(
          thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $quoted_defining_defns_status_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS,
          $quoted_defining_defns_status_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), $sym68$QUOTED_SUFFICIENT_DEFNS_ADMIT_ );
    return NIL;
  }
  ...
  public static SubLObject quoted_sufficient_defns_admitP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ),
          UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $quoted_sufficient_defns_admitP_meters$.getDynamicValue(
          thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $quoted_sufficient_defns_admitP_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS,
          $quoted_sufficient_defns_admitP_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), $sym71$QUOTED_NECESSARY_DEFNS_REJECT_ );
    return NIL;
  }
                                    ...
                                    .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                {
                                  ...
                                  if( NIL != mt_relevance_macros.relevant_mtP( mt_$105 ) )
                                  {
                                    ...
                                    try
                                    {
                                      ...
                                      for( iteration_state_$107 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == doneP && NIL == dictionary_contents
  ...
  public static SubLObject quoted_necessary_defns_rejectP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ),
          UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $quoted_necessary_defns_rejectP_meters$.getDynamicValue(
          thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $quoted_necessary_defns_rejectP_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS,
          $quoted_necessary_defns_rejectP_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  public static SubLObject denotational_term_admitted_by_quoted_defn_via_quoted_isaP(final SubLObject v_term, final SubLObject collection, SubLObject mt)
  {
    ...
    if( NIL != at_vars.permitting_denotational_terms_admitted_by_defn_via_isaP() )
    {
      ...
      try
      {
        ...
        try
        {
          admittedP = makeBoolean( NIL != at_denotational_term_p( v_term, UNPROVIDED ) && ( NIL != isa.quoted_isaP( v_term, collection, mt, UNPROVIDED ) || ( NIL != assertions_high.gaf_assertionP(
              sbhl_link_vars.$added_assertion$.getDynamicValue( thread ) ) && NIL != el_utilities.quoted_isa_litP( assertions_high.gaf_formula( sbhl_link_vars.$added_assertion$.getDynamicValue( thread ) ) ) && v_term
                  .equal( assertions_high.gaf_arg1( sbhl_link_vars.$added_assertion$.getDynamicValue( thread ) ) ) && NIL != genls.genlsP( assertions_high.gaf_arg2( sbhl_link_vars.$added_assertion$.getDynamicValue(
                      thread ) ), collection, mt, UNPROVIDED ) ) || ( NIL != wff_macros.within_wffP() && NIL != control_vars.within_assertP() && NIL != el_utilities.quoted_isa_litP( wff_vars.wff_formula() ) && v_term
                          .equal( cycl_utilities.sentence_arg1( wff_vars.wff_formula(), UNPROVIDED ) ) && NIL != term.el_fort_p( cycl_utilities.sentence_arg2( wff_vars.wff_formula(), UNPROVIDED ) ) && NIL != genls
                              .genlsP( cycl_utilities.sentence_arg2( wff_vars.wff_formula(), UNPROVIDED ), collection, mt, UNPROVIDED ) && NIL == el_utilities.el_negation_p( wff_vars.wff_formula() ) ) ) );
        }
        finally
        {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), $list9 );
    Hashtables.sethash( $kw10$FUNCTION, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), $sym75$REJECTED_BY_QUOTED_NECESSARY_DEFNS );
    return NIL;
  }
                ...
                if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( collection, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                {
                  ...
                  try
                  {
                    ...
                    while ( NIL != node_var)
                    {
                      ...
                      {
                        at_vars.$defn_collection$.bind( genl, thread );
                        final SubLObject pred_var = $const77$quotedDefnNecessary;
                        if( NIL != kb_mapping_macros.do_gaf_arg_index_key_validator( genl, ONE_INTEGER, pred_var ) )
                        {
                          final SubLObject iterator_var = kb_mapping_macros.new_gaf_arg_final_index_spec_iterator( genl, ONE_INTEGER, pred_var );
                          SubLObject done_var = NIL;
                      ...
                      while ( NIL != cdolist_list_var)
                      {
                        ...
                        try
                        {
                          ...
                          else if( NIL != obsolete.cnat_p( node, UNPROVIDED ) )
                          {
                            ...
                            final SubLObject new_list = cdolist_list_var_$133 = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities
                                .get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module(
                                    UNPROVIDED ) ) )
                                : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars
                                    .get_sbhl_module( UNPROVIDED ) ) );
  ...
  public static SubLObject rejected_by_quoted_necessary_defns(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue(
          thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $rejected_by_quoted_necessary_defns_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $rejected_by_quoted_necessary_defns_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( collection, v_term, mt ), Hashtables.gethash( $kw7$ARGS,
          $rejected_by_quoted_necessary_defns_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
                                        ...
                                        .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                    {
                                      ...
                                      if( NIL != mt_relevance_macros.relevant_mtP( mt_$156 ) )
                                      {
                                        ...
                                        try
                                        {
                                          ...
                                          for( iteration_state_$158 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == just && NIL == dictionary_contents
  ...
  public static SubLObject recursive_defn_callP(final SubLObject defn, final SubLObject v_term)
  {
    ...
    {
      final SubLObject term_stack = Hashtables.gethash_without_values( defn, at_vars.$defn_stack$.getDynamicValue( thread ), UNPROVIDED );
  ...
  public static SubLObject get_defn_col_history(final SubLObject collection)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject result = NIL;
    result = Hashtables.gethash_without_values( collection, at_vars.$defn_col_history$.getDynamicValue( thread ), UNPROVIDED );
    return result;
  }
  ...
  public static SubLObject get_quoted_defn_col_history(final SubLObject collection)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject result = NIL;
    result = Hashtables.gethash_without_values( collection, at_vars.$quoted_defn_col_history$.getDynamicValue( thread ), UNPROVIDED );
    return result;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $defn_admits_intP_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $defn_admits_intP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $defn_admits_intP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $defn_admits_intP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $defn_admits_intP_meters$.getDynamicValue( thread ), $list81 );
    Hashtables.sethash( $kw10$FUNCTION, $defn_admits_intP_meters$.getDynamicValue( thread ), $sym82$DEFN_ADMITS_INT_ );
    return NIL;
  }
  ...
  public static SubLObject defn_admits_intP_metered(final SubLObject defn, final SubLObject v_term, final SubLObject collection)
  {
    ...
    if( collection.eql( at_vars.$defn_collection$.getDynamicValue( thread ) ) )
    {
      defn_note( FIVE_INTEGER, $str84$__defn_test__term__s__defn__s_of_, v_term, defn, collection, ( NIL != admitsP ) ? $kw1$ADMITTED : $kw2$REJECTED, UNPROVIDED, UNPROVIDED );
    }
    else
    {
      defn_note( FIVE_INTEGER, $str85$__defn_test__term__s__defn__s_of_, v_term, defn, collection, at_vars.$defn_collection$.getDynamicValue( thread ), ( NIL != admitsP ) ? $kw1$ADMITTED : $kw2$REJECTED, UNPROVIDED );
    }
    return admitsP;
  }
  ...
  public static SubLObject defn_admits_intP(final SubLObject defn, final SubLObject v_term, final SubLObject collection)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $defn_admits_intP_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $defn_admits_intP_meters$.getDynamicValue( thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $defn_admits_intP_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $defn_admits_intP_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $defn_admits_intP_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $defn_admits_intP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $defn_admits_intP_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( defn, v_term, collection ), Hashtables.gethash( $kw7$ARGS, $defn_admits_intP_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), $list81 );
    Hashtables.sethash( $kw10$FUNCTION, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), $sym88$QUOTED_DEFN_ADMITS_INT_ );
    return NIL;
  }
  ...
  public static SubLObject quoted_defn_admits_intP(final SubLObject defn, final SubLObject v_term, final SubLObject collection)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $quoted_defn_admits_intP_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( defn, v_term, collection ), Hashtables.gethash( $kw7$ARGS, $quoted_defn_admits_intP_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $defn_cyc_evaluate_caching_state$.getGlobalValue(), ConsesLow.list( v_term ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject defn_cyc_evaluate(final SubLObject v_term)
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym90$DEFN_CYC_EVALUATE, $sym91$_DEFN_CYC_EVALUATE_CACHING_STATE_, NIL, EQUAL, ONE_INTEGER, $int92$24 );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, v_term, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( defn_cyc_evaluate_internal( v_term ) ) );
  ...
  public static SubLObject at_denotational_term_p(final SubLObject v_term, SubLObject varP)
  {
    if( varP == UNPROVIDED )
    {
      varP = Symbols.symbol_function( $sym97$CYC_VAR_ );
    }
  ...
  public static SubLObject quiet_has_any_typeP(final SubLObject v_term, final SubLObject collections, SubLObject mt)
  {
    ...
    try
    {
      ...
      if( NIL == result )
      {
        ...
        for( csome_list_var = collections, collection = NIL, collection = csome_list_var.first(); NIL == result && NIL != csome_list_var; result = quiet_defns_admitP( collection, v_term,
  ...
  public static SubLObject quiet_has_type_among(final SubLObject v_term, final SubLObject collections, SubLObject mt)
  {
    ...
    try
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        {
          result = ConsesLow.cons( collection, result );
        }
        cdolist_list_var = cdolist_list_var.rest();
        collection = cdolist_list_var.first();
      }
  ...
  public static SubLObject quiet_has_type_memoizedP(final SubLObject v_term, final SubLObject collection, SubLObject mt, SubLObject mt_info)
  {
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( quiet_has_type_memoizedP_internal( v_term, collection, mt, mt_info ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( v_term, collection, mt, mt_info ) );
  ...
  public static SubLObject quick_quiet_has_typeP_fort(final SubLObject v_term, final SubLObject collection, final SubLObject mt)
  {
    ...
    try
    {
      ...
      else if( NIL != el_utilities.possibly_fo_naut_p( v_term ) && NIL != isa.isaP( v_term.first(), $const102$Function_Denotational, UNPROVIDED, UNPROVIDED ) && NIL != isa.nat_isaP( v_term, collection, UNPROVIDED,
          UNPROVIDED ) )
      {
        ans = T;
      }
  ...
  {
    if( NIL != cycl_utilities.naut_with_functor_p( collection, $const103$SpecsFn ) && NIL != term.el_fort_p( v_term ) && NIL != genls.genlP( v_term, cycl_utilities.nat_arg1( collection, UNPROVIDED ), mt, UNPROVIDED ) )
    {
      return T;
    }
  ...
  {
    if( collection.eql( $const104$Thing ) )
    {
      return $list105;
    }
            ...
            try
            {
              ...
              if( NIL != viable_defnP( defn, at_vars.$defn_collection$.getDynamicValue( thread ) ) )
              {
                ...
                try
                {
                  ...
                  if( NIL != quiet_defn_admitsP( defn, v_term, collection, UNPROVIDED ) && ( NIL == at_vars.$at_apply_necessary_defnsP$.getDynamicValue( thread ) || NIL != necessary_defns_permitP( collection, v_term,
                      UNPROVIDED ) ) )
                  {
                ...
                try
                {
                  ...
                  if( NIL != mt_relevance_macros.relevant_mtP( defn_mt ) )
                  {
                    ...
                    if( NIL != viable_defnP( defn, at_vars.$defn_collection$.getDynamicValue( thread ) ) )
                    {
                      if( NIL != isa.isaP( v_term, at_vars.$defn_collection$.getDynamicValue( thread ), UNPROVIDED, UNPROVIDED ) )
                      {
                        supports = ConsesLow.cons( arguments.make_hl_support( $kw108$ISA, ConsesLow.list( $const109$isa, v_term, collection ), UNPROVIDED, UNPROVIDED ), supports );
                      }
                      else if( NIL != quiet_defn_admitsP( defn, v_term, collection, mt ) )
                      {
                        if( !collection.eql( at_vars.$defn_collection$.getDynamicValue( thread ) ) )
                        {
                          supports = ConsesLow.cons( arguments.make_hl_support( $kw110$GENLS, ConsesLow.list( $const45$genls, at_vars.$defn_collection$.getDynamicValue( thread ), collection ), UNPROVIDED, UNPROVIDED ),
                              supports );
                        }
                                          ...
                                          while ( NIL == done_var_$198)
                                          {
                                            ...
                                            if( NIL != valid_$200 )
                                            {
                                              ...
                                              if( NIL != viable_defnP( defn, at_vars.$defn_collection$.getDynamicValue( thread ) ) && NIL == quiet_defn_admitsP( defn, v_term, collection, mt ) )
                                              {
                                                if( !collection.eql( at_vars.$defn_collection$.getDynamicValue( thread ) ) )
                                                {
                                                  supports = ConsesLow.cons( arguments.make_hl_support( $kw110$GENLS, ConsesLow.list( $const45$genls, collection, at_vars.$defn_collection$.getDynamicValue( thread ) ),
                                                      UNPROVIDED, UNPROVIDED ), supports );
                                                }
                                                supports = ConsesLow.cons( assertion, supports );
                                              }
                                            }
                                          ...
                                          .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                      {
                                        ...
                                        if( NIL != mt_relevance_macros.relevant_mtP( mt_$204 ) )
                                        {
                                          ...
                                          try
                                          {
                                            ...
                                            for( iteration_state_$206 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == supports && NIL == dictionary_contents
                                                .do_dictionary_contents_doneP( iteration_state_$206 ); iteration_state_$206 = dictionary_contents.do_dictionary_contents_next( iteration_state_$206 ) )
                                            {
                                              thread.resetMultipleValues();
                                              ...
                                              if( NIL != sbhl_search_vars.relevant_sbhl_tvP( tv ) )
                                              {
                                                ...
                                                try
                                                {
                                                  ...
                                                  if( NIL != set.set_p( sol ) )
                                                  {
                                                    set_contents_var = set.do_set_internal( sol );
                                                    for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object,
                                                        set_contents_var ); NIL == supports && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state(
                                                            state ) )
                                                    {
                                                      node_vars_link_node = set_contents.do_set_contents_next( basis_object, state );
                                                      if( NIL != set_contents.do_set_contents_element_validP( state, node_vars_link_node ) && NIL == sbhl_marking_utilities.sbhl_search_path_termination_p(
            ...
            try
            {
              ...
              if( NIL == supports )
              {
                ...
                while ( NIL == supports && NIL != csome_list_var4)
                {
                  ...
                  {
                    supports = ConsesLow.list( arguments.make_hl_support( $kw111$DEFN, ConsesLow.list( $const109$isa, v_term, disjoint_col ), UNPROVIDED, UNPROVIDED ), arguments.make_hl_support( $kw112$DISJOINTWITH,
                        ConsesLow.list( $const113$disjointWith, collection, disjoint_col ), UNPROVIDED, UNPROVIDED ) );
                  }
                                          ...
                                          .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                      {
                                        ...
                                        if( NIL != mt_relevance_macros.relevant_mtP( mt_$239 ) )
                                        {
                                          ...
                                          try
                                          {
                                            ...
                                            for( iteration_state_$241 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == supports && NIL == dictionary_contents
                                                .do_dictionary_contents_doneP( iteration_state_$241 ); iteration_state_$241 = dictionary_contents.do_dictionary_contents_next( iteration_state_$241 ) )
                                            {
                                              thread.resetMultipleValues();
            ...
            try
            {
              ...
              if( NIL == supports )
              {
                ...
                while ( NIL == supports && NIL != csome_list_var4)
                {
                  ...
                  {
                    supports = ConsesLow.list( arguments.make_hl_support( $kw111$DEFN, ConsesLow.list( $const114$quotedIsa, v_term, disjoint_col ), UNPROVIDED, UNPROVIDED ), arguments.make_hl_support(
                        $kw112$DISJOINTWITH, ConsesLow.list( $const113$disjointWith, collection, disjoint_col ), UNPROVIDED, UNPROVIDED ) );
                  }
                  csome_list_var4 = csome_list_var4.rest();
                  disjoint_col = csome_list_var4.first();
                }
  ...
  public static SubLObject collection_rejects_via_disjoint_defnsP(final SubLObject collection, final SubLObject v_term, SubLObject mt)
  {
    ...
    try
    {
      ...
      if( NIL == rejectP )
      {
        ...
        for( csome_list_var = disjoint_with.max_all_disjoint_with( collection, mt, UNPROVIDED ), disjoint_col = NIL, disjoint_col = csome_list_var.first(); NIL == rejectP && NIL != csome_list_var; rejectP = defns_admitP(
    ...
    try
    {
      ...
      if( NIL == just )
      {
        ...
        while ( NIL == just && NIL != csome_list_var)
        {
          ...
          {
            just = ConsesLow.nconc( disjoint_with.why_disjoint_withP( collection, disjoint_col, mt, UNPROVIDED, UNPROVIDED ), why_sufficient_defns_admitP( disjoint_col, v_term, mt ) );
          }
          csome_list_var = csome_list_var.rest();
          disjoint_col = csome_list_var.first();
        }
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          control_vars.$mapping_answer$.bind( Hashtables.make_hash_table( $int115$64, UNPROVIDED, UNPROVIDED ), thread );
          $cat_defns_failing$.bind( Hashtables.make_hash_table( $int115$64, UNPROVIDED, UNPROVIDED ), thread );
          genl_predicates.map_all_spec_preds( $const116$defnSufficient, $sym117$COLLECTIONS_ADMITTING_TERM_VIA_DEFNS_1, UNPROVIDED, UNPROVIDED );
          ...
          try
          {
            while ( Hashtables.iteratorHasNext( cdohash_iterator ))
            {
              ...
              result = conses_high.nunion( result, cols, UNPROVIDED, UNPROVIDED );
            }
          }
          finally
          {
        ...
        try
        {
          ...
          try
          {
            while ( Hashtables.iteratorHasNext( cdohash_iterator ))
            {
              ...
              defn = Hashtables.getEntryKey( cdohash_entry );
              cols = Hashtables.getEntryValue( cdohash_entry );
              result = conses_high.nunion( result, genls.max_cols( cols, UNPROVIDED, UNPROVIDED ), UNPROVIDED, UNPROVIDED );
            }
          }
          finally
          {
  ...
  public static SubLObject collections_admitting_term_via_defns_1(final SubLObject suff_defn_pred)
  {
    ...
    {
      kb_mapping.map_predicate_extent_index( $sym118$GATHER_COLLECTIONS_ADMITTING_VIA_DEFNS, suff_defn_pred, UNPROVIDED, UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject gather_collections_admitting_via_defns(final SubLObject suff_defn_assertion)
  {
    ...
    if( NIL != assertions_high.gaf_assertionP( suff_defn_assertion ) )
    {
      ...
      try
      {
        ...
        if( NIL != viable_defnP( defn, at_vars.$defn_collection$.getDynamicValue( thread ) ) )
        {
          if( NIL != Hashtables.gethash_without_values( defn, control_vars.$mapping_answer$.getDynamicValue( thread ), UNPROVIDED ) )
          {
            hash_table_utilities.pushnew_hash( defn, at_vars.$defn_collection$.getDynamicValue( thread ), control_vars.$mapping_answer$.getDynamicValue( thread ), UNPROVIDED );
          }
          else if( NIL == Hashtables.gethash_without_values( defn, $cat_defns_failing$.getDynamicValue( thread ), UNPROVIDED ) )
          {
            if( NIL != quiet_defn_admitsP( defn, control_vars.$mapping_data_1$.getDynamicValue( thread ), at_vars.$defn_collection$.getDynamicValue( thread ), UNPROVIDED ) )
            {
              hash_table_utilities.pushnew_hash( defn, at_vars.$defn_collection$.getDynamicValue( thread ), control_vars.$mapping_answer$.getDynamicValue( thread ), UNPROVIDED );
            }
            else
            {
              Hashtables.sethash( defn, $cat_defns_failing$.getDynamicValue( thread ), T );
            }
          }
        }
      }
  ...
  public static SubLObject defn_error(final SubLObject level, final SubLObject format_str, SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4, SubLObject arg5)
  {
    ...
    if( at_vars.$defn_trace_level$.getDynamicValue( thread ).numGE( level ) )
    {
      Errors.cerror( $str42$continue_anyway, format_str, new SubLObject[] { arg1, arg2, arg3, arg4, arg5
      } );
    }
    else if( Numbers.add( TWO_INTEGER, at_vars.$defn_trace_level$.getDynamicValue( thread ) ).numGE( level ) )
    {
      PrintLow.format( T, Sequences.cconcatenate( $str119$__warn__, format_str ), new SubLObject[] { arg1, arg2, arg3, arg4, arg5
      } );
    }
    return NIL;
  }
  ...
  public static SubLObject defn_warn(final SubLObject level, final SubLObject format_str, SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4, SubLObject arg5)
  {
    ...
    if( at_vars.$defn_trace_level$.getDynamicValue( thread ).numGE( level ) )
    {
      Functions.apply( $sym120$WARN, format_str, new SubLObject[] { arg1, arg2, arg3, arg4, arg5
      } );
      return NIL;
    }
    return NIL;
  ...
  public static SubLObject reset_defn_meters()
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      Functions.funcall( Hashtables.gethash( $kw12$RESET, meter_cache, UNPROVIDED ) );
      cdolist_list_var = cdolist_list_var.rest();
      meter_cache = cdolist_list_var.first();
    }
    return NIL;
  ...
  public static SubLObject report_defn_meters(SubLObject stream)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( Hashtables.gethash( $kw4$CALLS, meter_cache, UNPROVIDED ).numG( ZERO_INTEGER ) )
      {
  ...
  public static SubLObject summarize_defn_meter_cache_header(SubLObject fn_col_width, SubLObject stream)
  {
    ...
    PrintLow.format( stream, $str121$____defn_module_meters_ );
    string_utilities.tab( Numbers.add( fn_col_width, $int122$27 ), stream, NIL, $str123$_, UNPROVIDED );
    PrintLow.format( stream, $str124$_____a__, string_utilities.right_justify( $str125$function, fn_col_width, UNPROVIDED ) );
    PrintLow.format( stream, $str126$___calls___ );
    PrintLow.format( stream, $str127$___total_time___ );
    PrintLow.format( stream, $str128$____avg_time____ );
    return NIL;
  }
  ...
  public static SubLObject summarize_defn_meter_cache(final SubLObject meter_cache, SubLObject fn_col_width, SubLObject stream)
  {
    ...
    final SubLObject name = PrintLow.format( NIL, $str129$_s, Hashtables.gethash( $kw10$FUNCTION, meter_cache, UNPROVIDED ) );
    final SubLObject calls = Hashtables.gethash( $kw4$CALLS, meter_cache, UNPROVIDED );
    if( NIL != calls && calls.numG( ZERO_INTEGER ) )
    {
      final SubLObject times = ( NIL != calls && calls.numG( ZERO_INTEGER ) ) ? Hashtables.gethash( $kw5$TIMES, meter_cache, UNPROVIDED ) : NIL;
      final SubLObject total = ( NIL != times ) ? Functions.apply( Symbols.symbol_function( $sym130$_ ), times ) : NIL;
      final SubLObject avg = ( NIL != total ) ? Numbers.divide( total, calls ) : NIL;
      PrintLow.format( stream, $str124$_____a__, string_utilities.right_justify( Strings.string_downcase( name, UNPROVIDED, UNPROVIDED ), fn_col_width, UNPROVIDED ) );
      PrintLow.format( stream, $str131$____a___, string_utilities.left_justify( string_utilities.right_justify( string_utilities.str( calls ), FOUR_INTEGER, UNPROVIDED ), FIVE_INTEGER, UNPROVIDED ) );
      if( NIL != total )
      {
        PrintLow.format( stream, $str131$____a___, string_utilities.align_char( PrintLow.format( NIL, $str132$_a, number_utilities.float_n( total, TWO_INTEGER ) ), string_utilities.$point_char$.getGlobalValue(),
            TEN_INTEGER, SEVEN_INTEGER, UNPROVIDED ) );
      }
      else
      {
        string_utilities.tab( SIXTEEN_INTEGER, stream, NIL, $str133$_, UNPROVIDED );
      }
      if( NIL != avg )
      {
        PrintLow.format( stream, $str131$____a___, string_utilities.align_char( string_utilities.str( number_utilities.float_n( avg, TWO_INTEGER ) ), string_utilities.$point_char$.getGlobalValue(), TEN_INTEGER,
            SEVEN_INTEGER, UNPROVIDED ) );
      }
      else
      {
        string_utilities.tab( SIXTEEN_INTEGER, stream, NIL, $str133$_, UNPROVIDED );
  ...
  public static SubLObject summarize_defn_meter_cache_trailer(SubLObject fn_col_width, SubLObject stream)
  {
    ...
    string_utilities.tab( Numbers.add( fn_col_width, $int134$46 ), stream, T, $str123$_, UNPROVIDED );
    return NIL;
  }
  ...
  public static SubLObject report_defn_meter_cache(final SubLObject meter_cache, SubLObject stream)
  {
    ...
    SubLObject n;
    for( cdotimes_end_var = Hashtables.gethash( $kw4$CALLS, meter_cache, UNPROVIDED ), n = NIL, n = ZERO_INTEGER; n.numL( cdotimes_end_var ); n = Numbers.add( n, ONE_INTEGER ) )
    {
      report_defn_meter_cache_call( meter_cache, Numbers.add( ONE_INTEGER, n ), meter_col_widths, stream );
    }
  ...
  public static SubLObject report_defn_meter_cache_header(final SubLObject meter_cache, SubLObject col_widths, SubLObject stream)
  {
    ...
    final SubLObject name = PrintLow.format( NIL, $str135$_s_, Hashtables.gethash( $kw10$FUNCTION, meter_cache, UNPROVIDED ) );
    final SubLObject length = Sequences.length( name );
    PrintLow.format( stream, $str136$_____a, Strings.string_downcase( name, UNPROVIDED, UNPROVIDED ) );
    SubLObject cdolist_list_var = col_widths;
    SubLObject width = NIL;
    width = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      string_utilities.tab( Numbers.add( SIX_INTEGER, width ), stream, NIL, $str123$_, UNPROVIDED );
      cdolist_list_var = cdolist_list_var.rest();
      width = cdolist_list_var.first();
    }
    string_utilities.tab( Numbers.subtract( $int137$37, length ), stream, NIL, $str123$_, UNPROVIDED );
    PrintLow.format( stream, $str138$______call__ );
    SubLObject m = ZERO_INTEGER;
    SubLObject cdolist_list_var2 = Hashtables.gethash( $kw8$ARG_LIST, meter_cache, UNPROVIDED );
    SubLObject arg = NIL;
    arg = cdolist_list_var2.first();
    while ( NIL != cdolist_list_var2)
    {
      final SubLObject name_$260 = Strings.string_downcase( PrintLow.format( NIL, $str129$_s, arg ), UNPROVIDED, UNPROVIDED );
      final SubLObject width2 = ConsesLow.nth( m, col_widths );
      final SubLObject label = string_utilities.substring( name_$260, ZERO_INTEGER, Numbers.min( width2, Sequences.length( name_$260 ) ) );
      PrintLow.format( stream, $str139$____a___, string_utilities.center_string( label, width2, UNPROVIDED ) );
      m = Numbers.add( m, ONE_INTEGER );
      cdolist_list_var2 = cdolist_list_var2.rest();
      arg = cdolist_list_var2.first();
    }
    PrintLow.format( stream, $str140$____result____ );
    PrintLow.format( stream, $str141$_____time_____ );
    return NIL;
  }
  ...
  public static SubLObject report_defn_meter_cache_trailer(final SubLObject meter_cache, SubLObject col_widths, SubLObject stream)
  {
    ...
    final SubLObject length = Sequences.length( PrintLow.format( NIL, $str135$_s_, Hashtables.gethash( $kw10$FUNCTION, meter_cache, UNPROVIDED ) ) );
  ...
  public static SubLObject report_defn_meter_cache_call(final SubLObject meter_cache, final SubLObject n, SubLObject col_widths, SubLObject stream)
  {
    ...
    PrintLow.format( stream, $str142$____a, string_utilities.center_string( PrintLow.format( NIL, $str132$_a, n ), NINE_INTEGER, UNPROVIDED ) );
    SubLObject m = ZERO_INTEGER;
    SubLObject cdolist_list_var = ConsesLow.nth( Numbers.subtract( n, ONE_INTEGER ), Hashtables.gethash( $kw7$ARGS, meter_cache, UNPROVIDED ) );
    SubLObject arg = NIL;
    arg = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      final SubLObject name = PrintLow.format( NIL, $str129$_s, arg );
      final SubLObject width = ConsesLow.nth( m, col_widths );
      final SubLObject label = string_utilities.substring( name, ZERO_INTEGER, Numbers.min( width, Sequences.length( name ) ) );
      PrintLow.format( stream, $str139$____a___, string_utilities.center_string( label, width, UNPROVIDED ) );
      m = Numbers.add( m, ONE_INTEGER );
      cdolist_list_var = cdolist_list_var.rest();
      arg = cdolist_list_var.first();
    }
    PrintLow.format( stream, $str139$____a___, string_utilities.center_string( PrintLow.format( NIL, $str132$_a, ConsesLow.nth( Numbers.subtract( n, ONE_INTEGER ), Hashtables.gethash( $kw6$RESULTS, meter_cache,
        UNPROVIDED ) ) ), EIGHT_INTEGER, UNPROVIDED ) );
    PrintLow.format( stream, $str139$____a___, string_utilities.center_string( PrintLow.format( NIL, $str132$_a, number_utilities.float_n( ConsesLow.nth( Numbers.subtract( n, ONE_INTEGER ), Hashtables.gethash(
        $kw5$TIMES, meter_cache, UNPROVIDED ) ), FOUR_INTEGER ) ), EIGHT_INTEGER, UNPROVIDED ) );
    return NIL;
  }
  ...
  public static SubLObject report_defn_meter_cache_total(final SubLObject meter_cache, SubLObject col_widths, SubLObject stream)
  {
    ...
    PrintLow.format( stream, $str142$____a, string_utilities.center_string( $str143$total, NINE_INTEGER, UNPROVIDED ) );
    SubLObject cdolist_list_var = col_widths;
    SubLObject width = NIL;
    width = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      string_utilities.tab( Numbers.add( SIX_INTEGER, width ), stream, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      cdolist_list_var = cdolist_list_var.rest();
      width = cdolist_list_var.first();
    }
    string_utilities.tab( FOURTEEN_INTEGER, stream, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    final SubLObject times = Hashtables.gethash( $kw5$TIMES, meter_cache, UNPROVIDED );
    final SubLObject total = ( NIL != times ) ? Functions.apply( Symbols.symbol_function( $sym130$_ ), times ) : NIL;
    if( NIL != total )
    {
      PrintLow.format( stream, $str139$____a___, string_utilities.center_string( PrintLow.format( NIL, $str132$_a, number_utilities.float_n( total, FOUR_INTEGER ) ), EIGHT_INTEGER, UNPROVIDED ) );
    }
    else
    {
      string_utilities.tab( FOURTEEN_INTEGER, stream, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject function_col_width(final SubLObject meter_caches)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( Hashtables.gethash( $kw4$CALLS, meter_cache, UNPROVIDED ).numG( ZERO_INTEGER ) )
      {
        if( NIL != width )
        {
          width = Numbers.max( width, string_utilities.print_length( Hashtables.gethash( $kw10$FUNCTION, meter_cache, UNPROVIDED ) ) );
        }
        else
        {
          width = string_utilities.print_length( Hashtables.gethash( $kw10$FUNCTION, meter_cache, UNPROVIDED ) );
        }
      }
      cdolist_list_var = cdolist_list_var.rest();
      meter_cache = cdolist_list_var.first();
  ...
  {
    final SubLObject titles = Hashtables.gethash( $kw8$ARG_LIST, meter_cache, UNPROVIDED );
    final SubLObject data = Hashtables.gethash( $kw7$ARGS, meter_cache, UNPROVIDED );
    final SubLObject calls = Hashtables.gethash( $kw4$CALLS, meter_cache, UNPROVIDED );
    ...
    SubLObject width;
    SubLObject m;
    for( cdotimes_end_var = Sequences.length( titles ), n = NIL, n = ZERO_INTEGER; n.numL( cdotimes_end_var ); n = Numbers.add( n, ONE_INTEGER ) )
    {
      width = string_utilities.print_length( ConsesLow.nth( n, titles ) );
      for( m = NIL, m = ZERO_INTEGER; m.numL( calls ); m = Numbers.add( m, ONE_INTEGER ) )
      {
        width = Numbers.max( width, string_utilities.print_length( ConsesLow.nth( n, ConsesLow.nth( m, data ) ) ) );
      }
      widths = ConsesLow.cons( Numbers.min( FIFTEEN_INTEGER, Numbers.add( TWO_INTEGER, width ) ), widths );
    }
  ...
  {
    return subl_promotions.memberP( assertion, suf_defn_cache_get( col ), Symbols.symbol_function( $sym144$KBEQ ), UNPROVIDED );
  }
  ...
  public static SubLObject old_add_suf_defn(SubLObject source, final SubLObject assertion)
  {
    ...
    try
    {
      ...
      final SubLObject defn = el_utilities.cycl_subl_symbol_symbol( assertions_high.gaf_arg2( assertion ) );
      if( NIL != control_vars.$bootstrapping_kbP$.getDynamicValue( thread ) && NIL != forts.fort_p( col ) && defn.isSymbol() )
      {
      ...
      else
      {
        ...
        try
        {
          mt_relevance_macros.$relevant_mt_function$.bind( $sym147$RELEVANT_MT_IS_GENL_MT, thread );
          ...
          else if( NIL == collectionP )
          {
            defn_cerror( ONE_INTEGER, $str148$skip_defn_op, $str149$_s_is_not_a_collection_in__s, col, mt, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          }
          else if( NIL == valid_defnP )
          {
            defn_cerror( ONE_INTEGER, $str148$skip_defn_op, $str150$_s_is_not_a_symbol, defn, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          }
        }
        finally
        {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $cache_suf_defn_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $cache_suf_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $cache_suf_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $cache_suf_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $cache_suf_defn_meters$.getDynamicValue( thread ), $list156 );
    Hashtables.sethash( $kw10$FUNCTION, $cache_suf_defn_meters$.getDynamicValue( thread ), $sym157$CACHE_SUF_DEFN );
    return NIL;
  }
  ...
  public static SubLObject cache_suf_defn(final SubLObject col, final SubLObject assertion)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $cache_suf_defn_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $cache_suf_defn_meters$.getDynamicValue( thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $cache_suf_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $cache_suf_defn_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $cache_suf_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $cache_suf_defn_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $cache_suf_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( col, assertion ), Hashtables.gethash( $kw7$ARGS, $cache_suf_defn_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $uncache_suf_defn_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $uncache_suf_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $uncache_suf_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $uncache_suf_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $uncache_suf_defn_meters$.getDynamicValue( thread ), $list156 );
    Hashtables.sethash( $kw10$FUNCTION, $uncache_suf_defn_meters$.getDynamicValue( thread ), $sym160$UNCACHE_SUF_DEFN );
    return NIL;
  }
  ...
  public static SubLObject uncache_suf_defn(final SubLObject col, final SubLObject assertion)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $uncache_suf_defn_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $uncache_suf_defn_meters$.getDynamicValue( thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $uncache_suf_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $uncache_suf_defn_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $uncache_suf_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $uncache_suf_defn_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $uncache_suf_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( col, assertion ), Hashtables.gethash( $kw7$ARGS, $uncache_suf_defn_meters$.getDynamicValue(
          thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), $list165 );
    Hashtables.sethash( $kw10$FUNCTION, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), $sym166$OLD_HANDLE_ADDED_GENL_FOR_SUF_DEFNS );
    return NIL;
  }
  ...
  public static SubLObject old_handle_added_genl_for_suf_defns(final SubLObject spec, final SubLObject genl)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue(
          thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $old_handle_added_genl_for_suf_defns_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $old_handle_added_genl_for_suf_defns_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( spec, genl ), Hashtables.gethash( $kw7$ARGS,
          $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), $list165 );
    Hashtables.sethash( $kw10$FUNCTION, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), $sym169$OLD_HANDLE_REMOVED_GENL_FOR_SUF_DEFNS );
    return NIL;
  }
          ...
          try
          {
            ...
            try
            {
              ...
              try
              {
                ...
                sbhl_marking_methods.sbhl_record_all_forward_true_nodes( sbhl_module_vars.get_sbhl_module( $const45$genls ), spec, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject old_handle_removed_genl_for_suf_defns(final SubLObject spec, final SubLObject genl)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue(
          thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $old_handle_removed_genl_for_suf_defns_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $old_handle_removed_genl_for_suf_defns_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( spec, genl ), Hashtables.gethash( $kw7$ARGS,
          $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  public static SubLObject propagate_added_suf_defn(final SubLObject collection, final SubLObject defn_assertion)
  {
    ...
    try
    {
      ...
      genls.map_all_genls( Symbols.symbol_function( $sym171$ADD_SUF_DEFN_ASSERTION ), collection, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
  ...
  public static SubLObject propagate_removed_suf_defn(final SubLObject collection, final SubLObject defn_assertion)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$mt$.bind( $const107$EverythingPSC, thread );
      at_vars.$at_defn$.bind( defn_assertion, thread );
      genls.map_all_genls( Symbols.symbol_function( $sym172$REMOVE_SUF_DEFN_ASSERTION ), collection, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
      at_vars.$at_defn$.rebind( _prev_bind_3, thread );
  ...
  public static SubLObject propagate_added_suf_defns(final SubLObject collection, final SubLObject defn_assertions)
  {
    ...
    try
    {
      ...
      genls.map_all_genls( Symbols.symbol_function( $sym173$MERGE_SUF_DEFN_ASSERTIONS ), collection, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
  ...
  public static SubLObject propagate_removed_suf_defns(final SubLObject collection, final SubLObject defn_assertions)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$mt$.bind( $const107$EverythingPSC, thread );
      at_vars.$at_defns$.bind( defn_assertions, thread );
      genls.map_all_genls( Symbols.symbol_function( $sym174$REMOVE_SUF_DEFN_ASSERTIONS ), collection, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
      at_vars.$at_defns$.rebind( _prev_bind_3, thread );
  ...
  public static SubLObject suf_defn_sort(SubLObject assertions)
  {
    ...
    assertions = list_utilities.delete_if_not( Symbols.symbol_function( $sym175$VALID_ASSERTION ), assertions, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    return Sort.sort( assertions, Symbols.symbol_function( $sym176$_ ), Symbols.symbol_function( $sym177$ARG1_SPEC_CARDINALITY ) );
  }
  ...
  {
    return subl_promotions.memberP( assertion, suf_quoted_defn_cache_get( col ), Symbols.symbol_function( $sym144$KBEQ ), UNPROVIDED );
  }
    ...
    try
    {
      ...
      else
      {
        ...
        try
        {
          ...
          {
            defn_cerror( ONE_INTEGER, $str182$skip_quoted_defn_op, $str149$_s_is_not_a_collection_in__s, col, mt, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          }
          else if( NIL == valid_defnP )
          {
            defn_cerror( ONE_INTEGER, $str182$skip_quoted_defn_op, $str150$_s_is_not_a_symbol, defn, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          }
        }
        finally
        {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), $list156 );
    Hashtables.sethash( $kw10$FUNCTION, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), $sym188$CACHE_SUF_QUOTED_DEFN );
    return NIL;
  }
  ...
  public static SubLObject cache_suf_quoted_defn(final SubLObject col, final SubLObject assertion)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $cache_suf_quoted_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( col, assertion ), Hashtables.gethash( $kw7$ARGS, $cache_suf_quoted_defn_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), $list156 );
    Hashtables.sethash( $kw10$FUNCTION, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), $sym191$UNCACHE_SUF_QUOTED_DEFN );
    return NIL;
  }
  ...
  public static SubLObject uncache_suf_quoted_defn(final SubLObject col, final SubLObject assertion)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $uncache_suf_quoted_defn_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( col, assertion ), Hashtables.gethash( $kw7$ARGS, $uncache_suf_quoted_defn_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), $list165 );
    Hashtables.sethash( $kw10$FUNCTION, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), $sym197$OLD_HANDLE_ADDED_GENL_FOR_SUF_QUOTED_DEFNS );
    return NIL;
  }
  ...
  public static SubLObject old_handle_added_genl_for_suf_quoted_defns(final SubLObject spec, final SubLObject genl)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $old_handle_added_genl_for_suf_quoted_defns_meters$
          .getDynamicValue( thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES,
          $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS,
          $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( spec, genl ), Hashtables.gethash( $kw7$ARGS,
          $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), $list165 );
    Hashtables.sethash( $kw10$FUNCTION, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), $sym200$OLD_HANDLE_REMOVED_GENL_FOR_SUF_QUOTED_DEFNS );
    return NIL;
  }
  ...
  public static SubLObject old_handle_removed_genl_for_suf_quoted_defns(final SubLObject spec, final SubLObject genl)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $old_handle_removed_genl_for_suf_quoted_defns_meters$
          .getDynamicValue( thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES,
          $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS,
          $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( spec, genl ), Hashtables.gethash( $kw7$ARGS,
          $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  public static SubLObject propagate_added_suf_quoted_defn(final SubLObject collection, final SubLObject defn_assertion)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$mt$.bind( $const107$EverythingPSC, thread );
      at_vars.$at_defn$.bind( defn_assertion, thread );
      genls.map_all_genls( Symbols.symbol_function( $sym202$ADD_SUF_QUOTED_DEFN_ASSERTION ), collection, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
      at_vars.$at_defn$.rebind( _prev_bind_3, thread );
  ...
  public static SubLObject propagate_removed_suf_quoted_defn(final SubLObject collection, final SubLObject defn_assertion)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$mt$.bind( $const107$EverythingPSC, thread );
      at_vars.$at_defn$.bind( defn_assertion, thread );
      genls.map_all_genls( Symbols.symbol_function( $sym203$REMOVE_SUF_QUOTED_DEFN_ASSERTION ), collection, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
      at_vars.$at_defn$.rebind( _prev_bind_3, thread );
  ...
  public static SubLObject propagate_added_suf_quoted_defns(final SubLObject collection, final SubLObject defn_assertions)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$mt$.bind( $const107$EverythingPSC, thread );
      at_vars.$at_defns$.bind( defn_assertions, thread );
      genls.map_all_genls( Symbols.symbol_function( $sym204$MERGE_SUF_QUOTED_DEFN_ASSERTIONS ), collection, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
      at_vars.$at_defns$.rebind( _prev_bind_3, thread );
  ...
  public static SubLObject propagate_removed_suf_quoted_defns(final SubLObject collection, final SubLObject defn_assertions)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$mt$.bind( $const107$EverythingPSC, thread );
      at_vars.$at_defns$.bind( defn_assertions, thread );
      genls.map_all_genls( Symbols.symbol_function( $sym205$REMOVE_SUF_QUOTED_DEFN_ASSERTIONS ), collection, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
      at_vars.$at_defns$.rebind( _prev_bind_3, thread );
  ...
  public static SubLObject any_sufficient_functionP(final SubLObject collection, SubLObject mt)
  {
    ...
    return any_sufficient_functionP_int( collection, mt, $kw108$ISA );
  }
  ...
  public static SubLObject any_sufficient_quoted_functionP(final SubLObject collection, SubLObject mt)
  {
    ...
    return any_sufficient_functionP_int( collection, mt, $kw208$QUOTED_ISA );
  }
  ...
  public static SubLObject any_sufficient_functionP_int(final SubLObject collection, final SubLObject mt, final SubLObject type)
  {
    ...
    try
    {
      ...
      if( NIL == foundP )
      {
        ...
        while ( NIL == foundP && NIL != csome_list_var)
        {
          if( NIL != assertions_high.valid_assertion( assertion, UNPROVIDED ) && NIL != mt_relevance_macros.relevant_assertionP( assertion ) && NIL != genls.genlP( assertions_high.gaf_arg2( assertion ), collection,
              UNPROVIDED, UNPROVIDED ) )
          {
            foundP = T;
          }
  ...
  {
    return subl_promotions.memberP( assertion, get_suf_function_assertions( col, type ), Symbols.symbol_function( $sym144$KBEQ ), UNPROVIDED );
  }
    ...
    try
    {
      ...
      try
      {
        while ( Hashtables.iteratorHasNext( cdohash_iterator ))
        {
          ...
          if( NIL != foundP )
          {
            collections = ConsesLow.cons( col, collections );
          }
        }
      }
      finally
  ...
  {
    return add_suf_function_int( source, assertion, $kw108$ISA );
  }
  ...
  {
    return remove_suf_function_int( source, assertion, $kw108$ISA );
  }
  ...
  {
    return add_suf_function_int( source, assertion, $kw208$QUOTED_ISA );
  }
  ...
  {
    return remove_suf_function_int( source, assertion, $kw208$QUOTED_ISA );
  }
  ...
  public static SubLObject add_suf_function_int(SubLObject source, final SubLObject assertion, final SubLObject type)
  {
    ...
    try
    {
      ...
      if( NIL != control_vars.$bootstrapping_kbP$.getDynamicValue( thread ) && NIL != forts.fort_p( col ) && NIL != forts.fort_p( function ) )
      {
      ...
      else
      {
        ...
        try
        {
          ...
          if( type == $kw208$QUOTED_ISA && NIL != assertion_utilities.gaf_assertion_has_pred_p( assertion, $const213$evaluationResultQuotedIsa ) && NIL == fort_types_interface.evaluatable_function_p( function ) )
          {
          ...
          else if( NIL != collectionP && NIL != functionP )
          {
            cache_suf_function( col, assertion, type );
          }
          else if( NIL == collectionP )
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $cache_suf_function_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $cache_suf_function_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $cache_suf_function_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $cache_suf_function_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $cache_suf_function_meters$.getDynamicValue( thread ), $list220 );
    Hashtables.sethash( $kw10$FUNCTION, $cache_suf_function_meters$.getDynamicValue( thread ), $sym221$CACHE_SUF_FUNCTION );
    return NIL;
  }
  ...
  public static SubLObject cache_suf_function(final SubLObject col, final SubLObject assertion, final SubLObject type)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $cache_suf_function_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $cache_suf_function_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $cache_suf_function_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $cache_suf_function_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $cache_suf_function_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $cache_suf_function_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $cache_suf_function_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( col, assertion, type ), Hashtables.gethash( $kw7$ARGS, $cache_suf_function_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $uncache_suf_function_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $uncache_suf_function_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $uncache_suf_function_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $uncache_suf_function_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $uncache_suf_function_meters$.getDynamicValue( thread ), $list220 );
    Hashtables.sethash( $kw10$FUNCTION, $uncache_suf_function_meters$.getDynamicValue( thread ), $sym224$UNCACHE_SUF_FUNCTION );
    return NIL;
  }
  ...
  public static SubLObject uncache_suf_function(final SubLObject col, final SubLObject assertion, final SubLObject type)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $uncache_suf_function_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $uncache_suf_function_meters$.getDynamicValue( thread ), UNPROVIDED ),
          ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $uncache_suf_function_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $uncache_suf_function_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $uncache_suf_function_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $uncache_suf_function_meters$.getDynamicValue( thread ),
          UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $uncache_suf_function_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( col, assertion, type ), Hashtables.gethash( $kw7$ARGS, $uncache_suf_function_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  public static SubLObject cache_suf_function_int(final SubLObject col, final SubLObject assertion, final SubLObject type, SubLObject propagateP)
  {
    ...
    defn_note( FOUR_INTEGER, $str226$____a__a__a_, ( type == $kw108$ISA ) ? $str227$add_sufficient_function : $str228$add_sufficient_quoted_function, col, assertion, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    final SubLObject new_val = suf_function_sort( ConsesLow.cons( assertion, get_suf_function_assertions( col, type ) ) );
    if( NIL != new_val )
    {
  ...
  public static SubLObject uncache_suf_function_int(final SubLObject col, final SubLObject assertion, final SubLObject type, SubLObject propagateP)
  {
    ...
    defn_note( FOUR_INTEGER, $str226$____a__a__a_, ( type == $kw108$ISA ) ? $str230$remove_sufficient_function : $str231$remove_sufficient_quoted_function, col, assertion, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    final SubLObject new_val = suf_function_sort( Sequences.delete( assertion, get_suf_function_assertions( col, type ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    if( NIL != new_val )
    {
      set_suf_function_assertions( col, new_val, type );
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), $list165 );
    Hashtables.sethash( $kw10$FUNCTION, $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), $sym233$HANDLE_ADDED_GENL_FOR_SUF_FUNCTIONS );
    return NIL;
  }
  ...
  public static SubLObject handle_added_genl_for_suf_functions(final SubLObject spec, final SubLObject genl)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $handle_added_genl_for_suf_functions_meters$.getDynamicValue(
          thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $handle_added_genl_for_suf_functions_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $handle_added_genl_for_suf_functions_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( spec, genl ), Hashtables.gethash( $kw7$ARGS,
          $handle_added_genl_for_suf_functions_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    Hashtables.sethash( $kw4$CALLS, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), ZERO_INTEGER );
    Hashtables.sethash( $kw5$TIMES, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw6$RESULTS, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw7$ARGS, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), NIL );
    Hashtables.sethash( $kw8$ARG_LIST, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), $list165 );
    Hashtables.sethash( $kw10$FUNCTION, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), $sym237$HANDLE_REMOVED_GENL_FOR_SUF_FUNCTIONS );
    return NIL;
  }
  ...
  public static SubLObject handle_removed_genl_for_suf_functions(final SubLObject spec, final SubLObject genl)
  {
    ...
    if( NIL != at_vars.$defn_metersP$.getDynamicValue( thread ) )
    {
      ...
      run_time = Numbers.divide( Numbers.subtract( Time.get_internal_real_time(), time_var ), time_high.$internal_time_units_per_second$.getGlobalValue() );
      Hashtables.sethash( $kw4$CALLS, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), Numbers.add( Hashtables.gethash( $kw4$CALLS, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue(
          thread ), UNPROVIDED ), ONE_INTEGER ) );
      Hashtables.sethash( $kw5$TIMES, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), ConsesLow.cons( run_time, Hashtables.gethash( $kw5$TIMES, $handle_removed_genl_for_suf_functions_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw6$RESULTS, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), ConsesLow.cons( result, Hashtables.gethash( $kw6$RESULTS, $handle_removed_genl_for_suf_functions_meters$
          .getDynamicValue( thread ), UNPROVIDED ) ) );
      Hashtables.sethash( $kw7$ARGS, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), ConsesLow.cons( ConsesLow.list( spec, genl ), Hashtables.gethash( $kw7$ARGS,
          $handle_removed_genl_for_suf_functions_meters$.getDynamicValue( thread ), UNPROVIDED ) ) );
      return result;
    }
  ...
  public static SubLObject propagate_added_suf_function(final SubLObject collection, final SubLObject function_assertion, final SubLObject type)
  {
    ...
    try
    {
      ...
      if( type.eql( $kw108$ISA ) )
      {
        genls.map_all_genls( Symbols.symbol_function( $sym239$ADD_SUF_FUNCTION_ASSERTION ), collection, UNPROVIDED, UNPROVIDED );
      }
      else if( type.eql( $kw208$QUOTED_ISA ) )
      {
        genls.map_all_genls( Symbols.symbol_function( $sym240$ADD_SUF_QUOTED_FUNCTION_ASSERTION ), collection, UNPROVIDED, UNPROVIDED );
      }
    }
    finally
    {
  ...
  public static SubLObject propagate_removed_suf_function(final SubLObject collection, final SubLObject function_assertion, final SubLObject type)
  {
    ...
    try
    {
      ...
      if( type.eql( $kw108$ISA ) )
      {
        genls.map_all_genls( Symbols.symbol_function( $sym241$REMOVE_SUF_FUNCTION_ASSERTION ), collection, UNPROVIDED, UNPROVIDED );
      }
      else if( type.eql( $kw208$QUOTED_ISA ) )
      {
        genls.map_all_genls( Symbols.symbol_function( $sym242$REMOVE_SUF_QUOTED_FUNCTION_ASSERTION ), collection, UNPROVIDED, UNPROVIDED );
      }
    }
    finally
    {
  ...
  public static SubLObject propagate_added_suf_functions(final SubLObject collection, final SubLObject function_assertions, final SubLObject type)
  {
    ...
    try
    {
      ...
      if( type.eql( $kw108$ISA ) )
      {
        genls.map_all_genls( Symbols.symbol_function( $sym243$MERGE_SUF_FUNCTION_ASSERTIONS ), collection, UNPROVIDED, UNPROVIDED );
      }
      else if( type.eql( $kw208$QUOTED_ISA ) )
      {
        genls.map_all_genls( Symbols.symbol_function( $sym244$MERGE_SUF_QUOTED_FUNCTION_ASSERTIONS ), collection, UNPROVIDED, UNPROVIDED );
      }
    }
    finally
    {
  ...
  public static SubLObject propagate_removed_suf_functions(final SubLObject collection, final SubLObject function_assertions, final SubLObject type)
  {
    ...
    try
    {
      ...
      if( type.eql( $kw108$ISA ) )
      {
        genls.map_all_genls( Symbols.symbol_function( $sym245$REMOVE_SUF_FUNCTION_ASSERTIONS ), collection, UNPROVIDED, UNPROVIDED );
      }
      else if( type.eql( $kw208$QUOTED_ISA ) )
      {
        genls.map_all_genls( Symbols.symbol_function( $sym246$REMOVE_SUF_QUOTED_FUNCTION_ASSERTIONS ), collection, UNPROVIDED, UNPROVIDED );
      }
    }
    finally
    {
  ...
  public static SubLObject add_suf_function_assertion(final SubLObject collection, SubLObject function_assertion)
  {
    ...
    return cache_suf_function_int( collection, function_assertion, $kw108$ISA, NIL );
  }
  ...
  public static SubLObject remove_suf_function_assertion(final SubLObject collection, SubLObject function_assertion)
  {
    ...
    return uncache_suf_function_int( collection, function_assertion, $kw108$ISA, NIL );
  }
  ...
  public static SubLObject merge_suf_function_assertions(final SubLObject collection, SubLObject function_assertions)
  {
    ...
    return merge_suf_function_assertions_int( collection, function_assertions, $kw108$ISA );
  }
  ...
  public static SubLObject remove_suf_function_assertions(final SubLObject collection, SubLObject function_assertions)
  {
    ...
    return remove_suf_function_assertions_int( collection, function_assertions, $kw108$ISA );
  }
  ...
  public static SubLObject add_suf_quoted_function_assertion(final SubLObject collection, SubLObject function_assertion)
  {
    ...
    return cache_suf_function_int( collection, function_assertion, $kw208$QUOTED_ISA, NIL );
  }
  ...
  public static SubLObject remove_suf_quoted_function_assertion(final SubLObject collection, SubLObject function_assertion)
  {
    ...
    return uncache_suf_function_int( collection, function_assertion, $kw208$QUOTED_ISA, NIL );
  }
  ...
  public static SubLObject merge_suf_quoted_function_assertions(final SubLObject collection, SubLObject function_assertions)
  {
    ...
    return merge_suf_function_assertions_int( collection, function_assertions, $kw208$QUOTED_ISA );
  }
  ...
  public static SubLObject remove_suf_quoted_function_assertions(final SubLObject collection, SubLObject function_assertions)
  {
    ...
    return remove_suf_function_assertions_int( collection, function_assertions, $kw208$QUOTED_ISA );
  }
  ...
  public static SubLObject merge_suf_function_assertions_int(final SubLObject collection, final SubLObject function_assertions, final SubLObject type)
  {
    ...
    return set_suf_function_assertions( collection, suf_function_sort( list_utilities.hash_delete_duplicates( ConsesLow.nconc( get_suf_function_assertions( collection, type ), conses_high.copy_list(
        function_assertions ) ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ), type );
  }
    ...
    if( NIL == function_genl_searchedP( collection ) )
    {
      ...
      if( NIL != assertions )
      {
        ...
        if( at_vars.$defn_trace_level$.getDynamicValue( thread ).numGE( FOUR_INTEGER ) )
        {
          ...
          while ( NIL != cdolist_list_var)
          {
            defn_note( FOUR_INTEGER, $str226$____a__a__a_, ( type == $kw108$ISA ) ? $str248$remove_sufficent_function : $str231$remove_sufficient_quoted_function, collection, assertion, UNPROVIDED, UNPROVIDED,
                UNPROVIDED );
            cdolist_list_var = cdolist_list_var.rest();
            assertion = cdolist_list_var.first();
          }
        }
        final SubLObject new_value = suf_function_sort( conses_high.nset_difference( assertions, assertions_to_remove, UNPROVIDED, UNPROVIDED ) );
        if( NIL != new_value )
        {
  ...
  public static SubLObject suf_function_sort(final SubLObject assertions)
  {
    ...
    return Sort.sort( conses_high.copy_list( assertions ), Symbols.symbol_function( $sym249$SUF_FUNCTION_SORT_PRED ), Symbols.symbol_function( $sym250$GAF_ARG2 ) );
  }
  ...
  {
    defns.defns_cache_clrhash( suf_function_cache( $kw108$ISA ) );
    return NIL;
  }
  ...
  {
    defns.defns_cache_clrhash( suf_function_cache( $kw208$QUOTED_ISA ) );
    return NIL;
  }
  ...
  public static SubLObject initialize_sufficient_functions_cache()
  {
    ...
    try
    {
      ...
      utilities_macros.$silent_progressP$.bind( ( NIL != str ) ? utilities_macros.$silent_progressP$.getDynamicValue( thread ) : T, thread );
      utilities_macros.noting_progress_preamble( str );
      reset_all_suf_functions( $kw108$ISA, T, UNPROVIDED );
      utilities_macros.noting_progress_postamble();
    }
    finally
    {
  ...
  public static SubLObject initialize_sufficient_quoted_functions_cache()
  {
    ...
    try
    {
      ...
      utilities_macros.$silent_progressP$.bind( ( NIL != str ) ? utilities_macros.$silent_progressP$.getDynamicValue( thread ) : T, thread );
      utilities_macros.noting_progress_preamble( str );
      reset_all_suf_functions( $kw208$QUOTED_ISA, T, UNPROVIDED );
      utilities_macros.noting_progress_postamble();
    }
    finally
    {
  ...
  public static SubLObject sufficient_function_cache_mal_assertions_coerce(SubLObject v_cache)
  {
    ...
    if( NIL != defns.defns_cache_index_p( v_cache ) )
    {
      ...
      try
      {
        utilities_macros.$progress_note$.bind( $str255$cdohash, thread );
        utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
        ...
        try
        {
          ...
          try
          {
            while ( Hashtables.iteratorHasNext( cdohash_iterator ))
            {
              ...
              print_high.print( key, UNPROVIDED );
              fi.fi_kill_int( key );
              final SubLObject mal_assertions = sufficient_function_cache_mal_assertions( UNPROVIDED );
              if( NIL != mal_assertions )
              {
                print_high.print( mal_assertions, UNPROVIDED );
                Errors.sublisp_break( $str256$stop, EMPTY_SUBL_OBJECT_ARRAY );
              }
  ...
  public static SubLObject assertion_referenced_in_sufficient_function_cacheP(final SubLObject assertion, final SubLObject type)
  {
    ...
    try
    {
      thread.throwStack.push( $kw257$MAPPING_DONE );
      final SubLObject cdohash_table = suf_function_cache( type );
      SubLObject key = NIL;
      SubLObject value = NIL;
      final Iterator cdohash_iterator = Hashtables.getEntrySetIterator( cdohash_table );
      try
      {
        while ( Hashtables.iteratorHasNext( cdohash_iterator ))
        {
          ...
          key = Hashtables.getEntryKey( cdohash_entry );
          value = Hashtables.getEntryValue( cdohash_entry );
          if( NIL != subl_promotions.memberP( assertion, value, Symbols.symbol_function( $sym144$KBEQ ), UNPROVIDED ) )
          {
            v_answer = T;
    ...
    {
      catch_var = Errors.handleThrowable( ccatch_env_var, $kw257$MAPPING_DONE );
    }
    finally
    {
  ...
  public static SubLObject diagnose_sufficient_functions_cache(final SubLObject type, SubLObject statusP, SubLObject stream)
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym106$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( $const107$EverythingPSC, thread );
      SubLObject cdolist_list_var = ( type == $kw108$ISA ) ? $list251 : $list252;
      SubLObject function_pred = NIL;
      function_pred = cdolist_list_var.first();
      while ( NIL != cdolist_list_var)
      {
                  ...
                  try
                  {
                    ...
                    while ( NIL == done_var_$348)
                    {
                      ...
                      if( NIL != valid_$350 )
                      {
                        ...
                        {
                          $suf_function_cache_awol_direct_assertions$.setDynamicValue( ConsesLow.cons( assertion, $suf_function_cache_awol_direct_assertions$.getDynamicValue( thread ) ), thread );
                        }
                      }
      ...
      try
      {
        utilities_macros.$progress_note$.bind( $str258$diagnostics__sufficient_functions, thread );
        utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
        utilities_macros.$progress_total$.bind( Hashtables.hash_table_count( table_var ), thread );
        utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
        utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
          ...
          try
          {
            while ( Hashtables.iteratorHasNext( cdohash_iterator ))
            {
              ...
              try
              {
                ...
                {
                  $suf_function_cache_mal_keys$.setDynamicValue( ConsesLow.cons( fort, $suf_function_cache_mal_keys$.getDynamicValue( thread ) ), thread );
                }
                if( NIL == assertions )
                {
                  $suf_function_cache_key_wXo_value$.setDynamicValue( ConsesLow.cons( fort, $suf_function_cache_key_wXo_value$.getDynamicValue( thread ) ), thread );
                }
                ...
                if( NIL == mal_assertionP )
                {
                  ...
                  for( csome_list_var = assertions, assertion2 = NIL, assertion2 = csome_list_var.first(); NIL == mal_assertionP && NIL != csome_list_var; mal_assertionP = makeBoolean( NIL == assertions_high
                      .valid_assertion( assertion2, UNPROVIDED ) ), csome_list_var = csome_list_var.rest(), assertion2 = csome_list_var.first() )
                  {
                  }
                }
                if( NIL != mal_assertionP )
                {
                  $suf_function_cache_key_wXmal_value$.setDynamicValue( ConsesLow.cons( fort, $suf_function_cache_key_wXmal_value$.getDynamicValue( thread ) ), thread );
                }
                mal_assertionP = NIL;
                if( NIL == mal_assertionP )
                {
                ...
                if( NIL != mal_assertionP )
                {
                  $suf_function_cache_key_wXstale_value$.setDynamicValue( ConsesLow.cons( fort, $suf_function_cache_key_wXstale_value$.getDynamicValue( thread ) ), thread );
                }
                if( NIL != assertions )
                {
                  ...
                  while ( NIL != cdolist_list_var2)
                  {
                    if( NIL != conses_high.set_difference( assertions, get_suf_function_assertions( genl, type ), UNPROVIDED, UNPROVIDED ) )
                    {
                      final SubLObject item_var = genl;
                      if( NIL == conses_high.member( item_var, $suf_function_cache_keys_wXo_inerited_value$.getDynamicValue( thread ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
                      {
                        $suf_function_cache_keys_wXo_inerited_value$.setDynamicValue( ConsesLow.cons( item_var, $suf_function_cache_keys_wXo_inerited_value$.getDynamicValue( thread ) ), thread );
                      }
                    }
                    cdolist_list_var2 = cdolist_list_var2.rest();
                    genl = cdolist_list_var2.first();
  ...
  public static SubLObject kbi_sfc_status(SubLObject stream)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    PrintLow.format( stream, $str259$___suf_function_cache_mal_keys___, Sequences.length( $suf_function_cache_mal_keys$.getDynamicValue( thread ) ) );
    PrintLow.format( stream, $str260$___suf_function_cache_key_w_o_val, Sequences.length( $suf_function_cache_key_wXo_value$.getDynamicValue( thread ) ) );
    PrintLow.format( stream, $str261$___suf_function_cache_key_w_mal_v, Sequences.length( $suf_function_cache_key_wXmal_value$.getDynamicValue( thread ) ) );
    PrintLow.format( stream, $str262$___suf_function_cache_key_w_stale, Sequences.length( $suf_function_cache_key_wXstale_value$.getDynamicValue( thread ) ) );
    PrintLow.format( stream, $str263$___suf_function_cache_keys_w_o_in, Sequences.length( $suf_function_cache_keys_wXo_inerited_value$.getDynamicValue( thread ) ) );
    PrintLow.format( stream, $str264$___suf_function_cache_awol_direct, Sequences.length( $suf_function_cache_awol_direct_assertions$.getDynamicValue( thread ) ) );
    return T;
  }
  ...
  public static SubLObject sfc_cleanup(final SubLObject type)
  {
    ...
    try
    {
      ...
      v_skolems = ( list_var = isa.all_fort_instances( $const265$SkolemFunction, UNPROVIDED, UNPROVIDED ) );
      ...
      try
      {
        utilities_macros.$progress_note$.bind( $str266$mapping_skolems, thread );
        utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
        ...
        try
        {
          ...
          while ( NIL != csome_list_var)
          {
            ...
            while ( NIL != cdolist_list_var)
            {
              ...
              while ( NIL != cdolist_list_var_$359)
              {
                if( NIL == assertions_high.valid_assertion( assertion, T ) )
                {
                  ...
                  print_high.print( ConsesLow.list( skolem, collection ), UNPROVIDED );
                  Errors.sublisp_break( $str256$stop, EMPTY_SUBL_OBJECT_ARRAY );
                }
            ...
            PrintLow.format( T, $str268$_a_, n );
            utilities_macros.$progress_sofar$.setDynamicValue( Numbers.add( utilities_macros.$progress_sofar$.getDynamicValue( thread ), ONE_INTEGER ), thread );
            utilities_macros.note_percent_progress( utilities_macros.$progress_sofar$.getDynamicValue( thread ), utilities_macros.$progress_total$.getDynamicValue( thread ) );
            csome_list_var = csome_list_var.rest();
            skolem = csome_list_var.first();
        ...
        try
        {
          while ( Hashtables.iteratorHasNext( cdohash_iterator ))
          {
            ...
            while ( NIL != cdolist_list_var)
            {
              ...
              {
                print_high.print( assertion, UNPROVIDED );
                print_high.print( fort, UNPROVIDED );
                Errors.sublisp_break( $str256$stop, EMPTY_SUBL_OBJECT_ARRAY );
              }
              cdolist_list_var = cdolist_list_var.rest();
              assertion = cdolist_list_var.first();
  ...
  {
    SubLFiles.declareFunction( me, "suf_defn_cache_as_alist", "SUF-DEFN-CACHE-AS-ALIST", 0, 0, false );
    SubLFiles.declareFunction( me, "suf_defn_cache_get", "SUF-DEFN-CACHE-GET", 1, 0, false );
    SubLFiles.declareFunction( me, "suf_defn_cache_add", "SUF-DEFN-CACHE-ADD", 2, 0, false );
    SubLFiles.declareFunction( me, "suf_defn_cache_rem", "SUF-DEFN-CACHE-REM", 2, 0, false );
    SubLFiles.declareFunction( me, "suf_defn_cache_merge", "SUF-DEFN-CACHE-MERGE", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_suf_defn_assertions", "REMOVE-SUF-DEFN-ASSERTIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "clear_suf_defns", "CLEAR-SUF-DEFNS", 0, 0, false );
    SubLFiles.declareFunction( me, "sort_suf_defn_cache", "SORT-SUF-DEFN-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "suf_quoted_defn_cache_as_alist", "SUF-QUOTED-DEFN-CACHE-AS-ALIST", 0, 0, false );
    SubLFiles.declareFunction( me, "suf_quoted_defn_cache_get", "SUF-QUOTED-DEFN-CACHE-GET", 1, 0, false );
    SubLFiles.declareFunction( me, "suf_quoted_defn_cache_add", "SUF-QUOTED-DEFN-CACHE-ADD", 2, 0, false );
    SubLFiles.declareFunction( me, "suf_quoted_defn_cache_rem", "SUF-QUOTED-DEFN-CACHE-REM", 2, 0, false );
    SubLFiles.declareFunction( me, "suf_quoted_defn_cache_merge", "SUF-QUOTED-DEFN-CACHE-MERGE", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_suf_quoted_defn_assertions", "REMOVE-SUF-QUOTED-DEFN-ASSERTIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "clear_suf_quoted_defns", "CLEAR-SUF-QUOTED-DEFNS", 0, 0, false );
    SubLFiles.declareFunction( me, "sort_suf_quoted_defn_cache", "SORT-SUF-QUOTED-DEFN-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "at_defns_admitP", "AT-DEFNS-ADMIT?", 1, 0, false );
    SubLFiles.declareFunction( me, "at_defns_rejectP", "AT-DEFNS-REJECT?", 1, 0, false );
    SubLFiles.declareFunction( me, "defns_admitP", "DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_old_defns_admitP_meters", "RESET-OLD-DEFNS-ADMIT?-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "old_defns_admitP_metered", "OLD-DEFNS-ADMIT?-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "old_defns_admitP", "OLD-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "defns_rejectP", "DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_old_defns_rejectP_meters", "RESET-OLD-DEFNS-REJECT?-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "old_defns_rejectP_metered", "OLD-DEFNS-REJECT?-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "old_defns_rejectP", "OLD-DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "defining_defns_admitP", "DEFINING-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "defining_defns_rejectP", "DEFINING-DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_defining_defns_status_meters", "RESET-DEFINING-DEFNS-STATUS-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "defining_defns_status_metered", "DEFINING-DEFNS-STATUS-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "defining_defns_status", "DEFINING-DEFNS-STATUS", 2, 1, false );
    SubLFiles.declareFunction( me, "defining_defn_violation_data", "DEFINING-DEFN-VIOLATION-DATA", 4, 1, false );
    SubLFiles.declareFunction( me, "reset_sufficient_defns_admitP_meters", "RESET-SUFFICIENT-DEFNS-ADMIT?-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "sufficient_defns_admitP_metered", "SUFFICIENT-DEFNS-ADMIT?-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "sufficient_defns_admitP", "SUFFICIENT-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "sufficient_defns_admit_int", "SUFFICIENT-DEFNS-ADMIT-INT", 3, 2, false );
    SubLFiles.declareFunction( me, "why_sufficient_defns_admitP", "WHY-SUFFICIENT-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "sufficient_defn_violation_data", "SUFFICIENT-DEFN-VIOLATION-DATA", 4, 1, false );
    SubLFiles.declareFunction( me, "necessary_defns_permitP", "NECESSARY-DEFNS-PERMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_necessary_defns_rejectP_meters", "RESET-NECESSARY-DEFNS-REJECT?-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "necessary_defns_rejectP_metered", "NECESSARY-DEFNS-REJECT?-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "necessary_defns_rejectP", "NECESSARY-DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "necessary_defns_rejectP_int", "NECESSARY-DEFNS-REJECT?-INT", 5, 1, false );
    SubLFiles.declareFunction( me, "denotational_term_admitted_by_defn_via_isaP", "DENOTATIONAL-TERM-ADMITTED-BY-DEFN-VIA-ISA?", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_rejected_by_necessary_defns_meters", "RESET-REJECTED-BY-NECESSARY-DEFNS-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "rejected_by_necessary_defns_metered", "REJECTED-BY-NECESSARY-DEFNS-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "rejected_by_necessary_defns", "REJECTED-BY-NECESSARY-DEFNS", 2, 1, false );
    SubLFiles.declareFunction( me, "why_defns_rejectP", "WHY-DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "necessary_defn_violation_data", "NECESSARY-DEFN-VIOLATION-DATA", 5, 1, false );
    SubLFiles.declareFunction( me, "at_quoted_defns_admitP", "AT-QUOTED-DEFNS-ADMIT?", 1, 0, false );
    SubLFiles.declareFunction( me, "at_quoted_defns_rejectP", "AT-QUOTED-DEFNS-REJECT?", 1, 0, false );
    SubLFiles.declareFunction( me, "quoted_defns_admitP", "QUOTED-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_old_quoted_defns_admitP_meters", "RESET-OLD-QUOTED-DEFNS-ADMIT?-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "old_quoted_defns_admitP_metered", "OLD-QUOTED-DEFNS-ADMIT?-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "old_quoted_defns_admitP", "OLD-QUOTED-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "quoted_defns_rejectP", "QUOTED-DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_old_quoted_defns_rejectP_meters", "RESET-OLD-QUOTED-DEFNS-REJECT?-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "old_quoted_defns_rejectP_metered", "OLD-QUOTED-DEFNS-REJECT?-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "old_quoted_defns_rejectP", "OLD-QUOTED-DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_quoted_defining_defns_status_meters", "RESET-QUOTED-DEFINING-DEFNS-STATUS-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "quoted_defining_defns_status_metered", "QUOTED-DEFINING-DEFNS-STATUS-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "quoted_defining_defns_status", "QUOTED-DEFINING-DEFNS-STATUS", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_quoted_sufficient_defns_admitP_meters", "RESET-QUOTED-SUFFICIENT-DEFNS-ADMIT?-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "quoted_sufficient_defns_admitP_metered", "QUOTED-SUFFICIENT-DEFNS-ADMIT?-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "quoted_sufficient_defns_admitP", "QUOTED-SUFFICIENT-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "quoted_necessary_defns_permitP", "QUOTED-NECESSARY-DEFNS-PERMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_quoted_necessary_defns_rejectP_meters", "RESET-QUOTED-NECESSARY-DEFNS-REJECT?-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "quoted_necessary_defns_rejectP_metered", "QUOTED-NECESSARY-DEFNS-REJECT?-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "quoted_necessary_defns_rejectP", "QUOTED-NECESSARY-DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "denotational_term_admitted_by_quoted_defn_via_quoted_isaP", "DENOTATIONAL-TERM-ADMITTED-BY-QUOTED-DEFN-VIA-QUOTED-ISA?", 2, 1, false );
    SubLFiles.declareFunction( me, "reset_rejected_by_quoted_necessary_defns_meters", "RESET-REJECTED-BY-QUOTED-NECESSARY-DEFNS-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "rejected_by_quoted_necessary_defns_metered", "REJECTED-BY-QUOTED-NECESSARY-DEFNS-METERED", 2, 1, false );
    SubLFiles.declareFunction( me, "rejected_by_quoted_necessary_defns", "REJECTED-BY-QUOTED-NECESSARY-DEFNS", 2, 1, false );
    SubLFiles.declareFunction( me, "why_quoted_defns_rejectP", "WHY-QUOTED-DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "new_defn_stack", "NEW-DEFN-STACK", 0, 0, false );
    SubLFiles.declareFunction( me, "defn_stack_push", "DEFN-STACK-PUSH", 2, 0, false );
    SubLFiles.declareFunction( me, "defn_stack_pop", "DEFN-STACK-POP", 2, 0, false );
    SubLFiles.declareFunction( me, "recursive_defn_callP", "RECURSIVE-DEFN-CALL?", 2, 0, false );
    SubLFiles.declareFunction( me, "get_defn_col_history", "GET-DEFN-COL-HISTORY", 1, 0, false );
    SubLFiles.declareFunction( me, "set_defn_col_history", "SET-DEFN-COL-HISTORY", 2, 0, false );
    SubLFiles.declareFunction( me, "get_defn_fn_history", "GET-DEFN-FN-HISTORY", 1, 0, false );
    SubLFiles.declareFunction( me, "set_defn_fn_history", "SET-DEFN-FN-HISTORY", 2, 0, false );
    SubLFiles.declareFunction( me, "get_quoted_defn_fn_history", "GET-QUOTED-DEFN-FN-HISTORY", 1, 0, false );
    SubLFiles.declareFunction( me, "set_quoted_defn_fn_history", "SET-QUOTED-DEFN-FN-HISTORY", 2, 0, false );
    SubLFiles.declareFunction( me, "get_quoted_defn_col_history", "GET-QUOTED-DEFN-COL-HISTORY", 1, 0, false );
    SubLFiles.declareFunction( me, "set_quoted_defn_col_history", "SET-QUOTED-DEFN-COL-HISTORY", 2, 0, false );
    SubLFiles.declareFunction( me, "quiet_defns_admitP", "QUIET-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_sufficient_defns_admitP", "QUIET-SUFFICIENT-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_defns_rejectP", "QUIET-DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_defn_admitsP", "QUIET-DEFN-ADMITS?", 3, 1, false );
    SubLFiles.declareFunction( me, "defn_admitsP", "DEFN-ADMITS?", 3, 1, false );
    SubLFiles.declareFunction( me, "collection_specific_defnP", "COLLECTION-SPECIFIC-DEFN?", 1, 0, false );
    SubLFiles.declareFunction( me, "defn_history", "DEFN-HISTORY", 1, 0, false );
    SubLFiles.declareFunction( me, "reset_defn_admits_intP_meters", "RESET-DEFN-ADMITS-INT?-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "defn_admits_intP_metered", "DEFN-ADMITS-INT?-METERED", 3, 0, false );
    SubLFiles.declareFunction( me, "defn_admits_intP", "DEFN-ADMITS-INT?", 3, 0, false );
    SubLFiles.declareFunction( me, "quiet_quoted_defns_admitP", "QUIET-QUOTED-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_quoted_sufficient_defns_admitP", "QUIET-QUOTED-SUFFICIENT-DEFNS-ADMIT?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_quoted_defns_rejectP", "QUIET-QUOTED-DEFNS-REJECT?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_quoted_defn_admitsP", "QUIET-QUOTED-DEFN-ADMITS?", 3, 1, false );
    SubLFiles.declareFunction( me, "quoted_defn_admitsP", "QUOTED-DEFN-ADMITS?", 3, 1, false );
    SubLFiles.declareFunction( me, "quoted_defn_history", "QUOTED-DEFN-HISTORY", 1, 0, false );
    SubLFiles.declareFunction( me, "reset_quoted_defn_admits_intP_meters", "RESET-QUOTED-DEFN-ADMITS-INT?-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "quoted_defn_admits_intP_metered", "QUOTED-DEFN-ADMITS-INT?-METERED", 3, 0, false );
    SubLFiles.declareFunction( me, "quoted_defn_admits_intP", "QUOTED-DEFN-ADMITS-INT?", 3, 0, false );
    SubLFiles.declareFunction( me, "clear_defn_cyc_evaluate", "CLEAR-DEFN-CYC-EVALUATE", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_defn_cyc_evaluate", "REMOVE-DEFN-CYC-EVALUATE", 1, 0, false );
    SubLFiles.declareFunction( me, "defn_cyc_evaluate_internal", "DEFN-CYC-EVALUATE-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "defn_cyc_evaluate", "DEFN-CYC-EVALUATE", 1, 0, false );
    SubLFiles.declareFunction( me, "valid_defnP", "VALID-DEFN?", 1, 1, false );
    SubLFiles.declareFunction( me, "viable_defnP", "VIABLE-DEFN?", 1, 1, false );
    SubLFiles.declareFunction( me, "defn_funcall", "DEFN-FUNCALL", 2, 0, false );
    SubLFiles.declareFunction( me, "at_denotational_term_p", "AT-DENOTATIONAL-TERM-P", 1, 1, false );
    SubLFiles.declareFunction( me, "clear_defn_space", "CLEAR-DEFN-SPACE", 0, 0, false );
    SubLFiles.declareFunction( me, "map_sufficient_defn_cols", "MAP-SUFFICIENT-DEFN-COLS", 1, 0, false );
    SubLFiles.declareFunction( me, "has_typeP", "HAS-TYPE?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_has_typeP", "QUIET-HAS-TYPE?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_has_any_typeP", "QUIET-HAS-ANY-TYPE?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_has_type_among", "QUIET-HAS-TYPE-AMONG", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_has_type_memoizedP_internal", "QUIET-HAS-TYPE-MEMOIZED?-INTERNAL", 2, 2, false );
    SubLFiles.declareFunction( me, "quiet_has_type_memoizedP", "QUIET-HAS-TYPE-MEMOIZED?", 2, 2, false );
    SubLFiles.declareFunction( me, "not_has_type_by_extent_knownP", "NOT-HAS-TYPE-BY-EXTENT-KNOWN?", 2, 1, false );
    SubLFiles.declareFunction( me, "not_has_typeP", "NOT-HAS-TYPE?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_not_has_typeP", "QUIET-NOT-HAS-TYPE?", 2, 1, false );
    SubLFiles.declareFunction( me, "quick_quiet_has_typeP", "QUICK-QUIET-HAS-TYPE?", 2, 1, false );
    SubLFiles.declareFunction( me, "quick_quiet_has_typeP_fort", "QUICK-QUIET-HAS-TYPE?-FORT", 3, 0, false );
    SubLFiles.declareFunction( me, "quick_quiet_has_typeP_naut", "QUICK-QUIET-HAS-TYPE?-NAUT", 3, 0, false );
    SubLFiles.declareFunction( me, "quick_quiet_has_typeP_collection_union", "QUICK-QUIET-HAS-TYPE?-COLLECTION-UNION", 3, 0, false );
    SubLFiles.declareFunction( me, "quick_quiet_has_typeP_collection_intersection", "QUICK-QUIET-HAS-TYPE?-COLLECTION-INTERSECTION", 3, 0, false );
    SubLFiles.declareFunction( me, "max_mts_of_admitting_defns", "MAX-MTS-OF-ADMITTING-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "mts_of_admitting_sufficient_defns", "MTS-OF-ADMITTING-SUFFICIENT-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "old_mts_of_admitting_sufficient_defns", "OLD-MTS-OF-ADMITTING-SUFFICIENT-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "max_mts_of_admitting_quoted_defns", "MAX-MTS-OF-ADMITTING-QUOTED-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "mts_of_admitting_sufficient_quoted_defns", "MTS-OF-ADMITTING-SUFFICIENT-QUOTED-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "isa_via_defnsP", "ISA-VIA-DEFNS?", 2, 1, false );
    SubLFiles.declareFunction( me, "hl_justify_isa_via_defns", "HL-JUSTIFY-ISA-VIA-DEFNS", 2, 1, false );
    SubLFiles.declareFunction( me, "old_hl_justify_isa_via_defns", "OLD-HL-JUSTIFY-ISA-VIA-DEFNS", 2, 1, false );
    SubLFiles.declareFunction( me, "not_isa_via_defnsP", "NOT-ISA-VIA-DEFNS?", 2, 1, false );
    SubLFiles.declareFunction( me, "why_not_isa_via_defnsP", "WHY-NOT-ISA-VIA-DEFNS?", 2, 1, false );
    SubLFiles.declareFunction( me, "hl_justify_not_isa_via_defns", "HL-JUSTIFY-NOT-ISA-VIA-DEFNS", 2, 1, false );
    SubLFiles.declareFunction( me, "hl_justify_not_quoted_isa_via_defns", "HL-JUSTIFY-NOT-QUOTED-ISA-VIA-DEFNS", 2, 1, false );
    SubLFiles.declareFunction( me, "collection_rejects_via_disjoint_defnsP", "COLLECTION-REJECTS-VIA-DISJOINT-DEFNS?", 2, 1, false );
    SubLFiles.declareFunction( me, "why_collection_rejects_via_disjoint_defnsP", "WHY-COLLECTION-REJECTS-VIA-DISJOINT-DEFNS?", 2, 1, false );
    SubLFiles.declareFunction( me, "collections_admitting_term_via_defns", "COLLECTIONS-ADMITTING-TERM-VIA-DEFNS", 1, 0, false );
    SubLFiles.declareFunction( me, "min_max_collections_admitting_term_via_defns", "MIN-MAX-COLLECTIONS-ADMITTING-TERM-VIA-DEFNS", 1, 1, false );
    SubLFiles.declareFunction( me, "collections_admitting_term_via_defns_1", "COLLECTIONS-ADMITTING-TERM-VIA-DEFNS-1", 1, 0, false );
    SubLFiles.declareFunction( me, "gather_collections_admitting_via_defns", "GATHER-COLLECTIONS-ADMITTING-VIA-DEFNS", 1, 0, false );
    SubLFiles.declareFunction( me, "defn_note", "DEFN-NOTE", 2, 6, false );
    SubLFiles.declareFunction( me, "defn_error", "DEFN-ERROR", 2, 5, false );
    SubLFiles.declareFunction( me, "defn_cerror", "DEFN-CERROR", 3, 5, false );
    SubLFiles.declareFunction( me, "defn_warn", "DEFN-WARN", 2, 5, false );
    SubLFiles.declareFunction( me, "reset_defn_meters", "RESET-DEFN-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "report_defn_meters", "REPORT-DEFN-METERS", 0, 1, false );
    SubLFiles.declareFunction( me, "summarize_defn_meters", "SUMMARIZE-DEFN-METERS", 0, 1, false );
    SubLFiles.declareFunction( me, "summarize_defn_meter_cache_header", "SUMMARIZE-DEFN-METER-CACHE-HEADER", 0, 2, false );
    SubLFiles.declareFunction( me, "summarize_defn_meter_cache", "SUMMARIZE-DEFN-METER-CACHE", 1, 2, false );
    SubLFiles.declareFunction( me, "summarize_defn_meter_cache_trailer", "SUMMARIZE-DEFN-METER-CACHE-TRAILER", 0, 2, false );
    SubLFiles.declareFunction( me, "report_defn_meter_cache", "REPORT-DEFN-METER-CACHE", 1, 1, false );
    SubLFiles.declareFunction( me, "report_defn_meter_cache_header", "REPORT-DEFN-METER-CACHE-HEADER", 1, 2, false );
    SubLFiles.declareFunction( me, "report_defn_meter_cache_trailer", "REPORT-DEFN-METER-CACHE-TRAILER", 1, 2, false );
    SubLFiles.declareFunction( me, "report_defn_meter_cache_call", "REPORT-DEFN-METER-CACHE-CALL", 2, 2, false );
    SubLFiles.declareFunction( me, "report_defn_meter_cache_total", "REPORT-DEFN-METER-CACHE-TOTAL", 1, 2, false );
    SubLFiles.declareFunction( me, "function_col_width", "FUNCTION-COL-WIDTH", 1, 0, false );
    SubLFiles.declareFunction( me, "meter_col_widths", "METER-COL-WIDTHS", 1, 0, false );
    SubLFiles.declareFunction( me, "suf_defn_assertions", "SUF-DEFN-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "suf_defnP", "SUF-DEFN?", 2, 0, false );
    SubLFiles.declareFunction( me, "old_suf_defnP", "OLD-SUF-DEFN?", 2, 0, false );
    SubLFiles.declareFunction( me, "any_sufficient_defn_anywhereP", "ANY-SUFFICIENT-DEFN-ANYWHERE?", 1, 0, false );
    SubLFiles.declareFunction( me, "old_any_sufficient_defn_anywhereP", "OLD-ANY-SUFFICIENT-DEFN-ANYWHERE?", 1, 0, false );
    SubLFiles.declareFunction( me, "suf_defn_assertionP", "SUF-DEFN-ASSERTION?", 2, 0, false );
    SubLFiles.declareFunction( me, "add_suf_defn", "ADD-SUF-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "add_iff_defn", "ADD-IFF-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "old_add_suf_defn", "OLD-ADD-SUF-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_suf_defn", "REMOVE-SUF-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_iff_defn", "REMOVE-IFF-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "old_remove_suf_defn", "OLD-REMOVE-SUF-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "reset_cache_suf_defn_meters", "RESET-CACHE-SUF-DEFN-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "cache_suf_defn_metered", "CACHE-SUF-DEFN-METERED", 2, 0, false );
    SubLFiles.declareFunction( me, "cache_suf_defn", "CACHE-SUF-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "reset_uncache_suf_defn_meters", "RESET-UNCACHE-SUF-DEFN-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "uncache_suf_defn_metered", "UNCACHE-SUF-DEFN-METERED", 2, 0, false );
    SubLFiles.declareFunction( me, "uncache_suf_defn", "UNCACHE-SUF-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "cache_suf_defn_int", "CACHE-SUF-DEFN-INT", 2, 1, false );
    SubLFiles.declareFunction( me, "uncache_suf_defn_int", "UNCACHE-SUF-DEFN-INT", 2, 1, false );
    SubLFiles.declareFunction( me, "handle_added_genl_for_suf_defns", "HANDLE-ADDED-GENL-FOR-SUF-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "reset_old_handle_added_genl_for_suf_defns_meters", "RESET-OLD-HANDLE-ADDED-GENL-FOR-SUF-DEFNS-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "old_handle_added_genl_for_suf_defns_metered", "OLD-HANDLE-ADDED-GENL-FOR-SUF-DEFNS-METERED", 2, 0, false );
    SubLFiles.declareFunction( me, "old_handle_added_genl_for_suf_defns", "OLD-HANDLE-ADDED-GENL-FOR-SUF-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "handle_removed_genl_for_suf_defns", "HANDLE-REMOVED-GENL-FOR-SUF-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "reset_old_handle_removed_genl_for_suf_defns_meters", "RESET-OLD-HANDLE-REMOVED-GENL-FOR-SUF-DEFNS-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "old_handle_removed_genl_for_suf_defns_metered", "OLD-HANDLE-REMOVED-GENL-FOR-SUF-DEFNS-METERED", 2, 0, false );
    SubLFiles.declareFunction( me, "old_handle_removed_genl_for_suf_defns", "OLD-HANDLE-REMOVED-GENL-FOR-SUF-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "propagate_added_suf_defn", "PROPAGATE-ADDED-SUF-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "propagate_removed_suf_defn", "PROPAGATE-REMOVED-SUF-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "propagate_added_suf_defns", "PROPAGATE-ADDED-SUF-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "propagate_removed_suf_defns", "PROPAGATE-REMOVED-SUF-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "add_suf_defn_assertion", "ADD-SUF-DEFN-ASSERTION", 1, 1, false );
    SubLFiles.declareFunction( me, "remove_suf_defn_assertion", "REMOVE-SUF-DEFN-ASSERTION", 1, 1, false );
    SubLFiles.declareFunction( me, "merge_suf_defn_assertions", "MERGE-SUF-DEFN-ASSERTIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "defn_genl_searchedP", "DEFN-GENL-SEARCHED?", 1, 0, false );
    SubLFiles.declareFunction( me, "arg1_spec_cardinality", "ARG1-SPEC-CARDINALITY", 1, 0, false );
    SubLFiles.declareFunction( me, "suf_defn_sort", "SUF-DEFN-SORT", 1, 0, false );
    SubLFiles.declareFunction( me, "reset_col_suf_defns", "RESET-COL-SUF-DEFNS", 1, 0, false );
    SubLFiles.declareFunction( me, "reset_all_suf_defns", "RESET-ALL-SUF-DEFNS", 0, 2, false );
    SubLFiles.declareFunction( me, "initialize_sufficient_defns_cache", "INITIALIZE-SUFFICIENT-DEFNS-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "suf_quoted_defn_assertions", "SUF-QUOTED-DEFN-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "suf_quoted_defnP", "SUF-QUOTED-DEFN?", 2, 0, false );
    SubLFiles.declareFunction( me, "any_sufficient_quoted_defnP", "ANY-SUFFICIENT-QUOTED-DEFN?", 1, 1, false );
    SubLFiles.declareFunction( me, "any_sufficient_quoted_defn_anywhereP", "ANY-SUFFICIENT-QUOTED-DEFN-ANYWHERE?", 1, 0, false );
    SubLFiles.declareFunction( me, "old_any_sufficient_quoted_defn_anywhereP", "OLD-ANY-SUFFICIENT-QUOTED-DEFN-ANYWHERE?", 1, 0, false );
    SubLFiles.declareFunction( me, "suf_quoted_defn_assertionP", "SUF-QUOTED-DEFN-ASSERTION?", 2, 0, false );
    SubLFiles.declareFunction( me, "quoted_has_typeP", "QUOTED-HAS-TYPE?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_quoted_has_typeP", "QUIET-QUOTED-HAS-TYPE?", 2, 1, false );
    SubLFiles.declareFunction( me, "not_quoted_has_type_by_extent_knownP", "NOT-QUOTED-HAS-TYPE-BY-EXTENT-KNOWN?", 2, 1, false );
    SubLFiles.declareFunction( me, "not_quoted_has_typeP", "NOT-QUOTED-HAS-TYPE?", 2, 1, false );
    SubLFiles.declareFunction( me, "quiet_not_quoted_has_typeP", "QUIET-NOT-QUOTED-HAS-TYPE?", 2, 1, false );
    SubLFiles.declareFunction( me, "add_suf_quoted_defn", "ADD-SUF-QUOTED-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "add_iff_quoted_defn", "ADD-IFF-QUOTED-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "old_add_suf_quoted_defn", "OLD-ADD-SUF-QUOTED-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_suf_quoted_defn", "REMOVE-SUF-QUOTED-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_iff_quoted_defn", "REMOVE-IFF-QUOTED-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "old_remove_suf_quoted_defn", "OLD-REMOVE-SUF-QUOTED-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "reset_cache_suf_quoted_defn_meters", "RESET-CACHE-SUF-QUOTED-DEFN-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "cache_suf_quoted_defn_metered", "CACHE-SUF-QUOTED-DEFN-METERED", 2, 0, false );
    SubLFiles.declareFunction( me, "cache_suf_quoted_defn", "CACHE-SUF-QUOTED-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "reset_uncache_suf_quoted_defn_meters", "RESET-UNCACHE-SUF-QUOTED-DEFN-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "uncache_suf_quoted_defn_metered", "UNCACHE-SUF-QUOTED-DEFN-METERED", 2, 0, false );
    SubLFiles.declareFunction( me, "uncache_suf_quoted_defn", "UNCACHE-SUF-QUOTED-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "cache_suf_quoted_defn_int", "CACHE-SUF-QUOTED-DEFN-INT", 2, 1, false );
    SubLFiles.declareFunction( me, "uncache_suf_quoted_defn_int", "UNCACHE-SUF-QUOTED-DEFN-INT", 2, 1, false );
    SubLFiles.declareFunction( me, "handle_added_genl_for_suf_quoted_defns", "HANDLE-ADDED-GENL-FOR-SUF-QUOTED-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "reset_old_handle_added_genl_for_suf_quoted_defns_meters", "RESET-OLD-HANDLE-ADDED-GENL-FOR-SUF-QUOTED-DEFNS-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "old_handle_added_genl_for_suf_quoted_defns_metered", "OLD-HANDLE-ADDED-GENL-FOR-SUF-QUOTED-DEFNS-METERED", 2, 0, false );
    SubLFiles.declareFunction( me, "old_handle_added_genl_for_suf_quoted_defns", "OLD-HANDLE-ADDED-GENL-FOR-SUF-QUOTED-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "handle_removed_genl_for_suf_quoted_defns", "HANDLE-REMOVED-GENL-FOR-SUF-QUOTED-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "reset_old_handle_removed_genl_for_suf_quoted_defns_meters", "RESET-OLD-HANDLE-REMOVED-GENL-FOR-SUF-QUOTED-DEFNS-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "old_handle_removed_genl_for_suf_quoted_defns_metered", "OLD-HANDLE-REMOVED-GENL-FOR-SUF-QUOTED-DEFNS-METERED", 2, 0, false );
    SubLFiles.declareFunction( me, "old_handle_removed_genl_for_suf_quoted_defns", "OLD-HANDLE-REMOVED-GENL-FOR-SUF-QUOTED-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "propagate_added_suf_quoted_defn", "PROPAGATE-ADDED-SUF-QUOTED-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "propagate_removed_suf_quoted_defn", "PROPAGATE-REMOVED-SUF-QUOTED-DEFN", 2, 0, false );
    SubLFiles.declareFunction( me, "propagate_added_suf_quoted_defns", "PROPAGATE-ADDED-SUF-QUOTED-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "propagate_removed_suf_quoted_defns", "PROPAGATE-REMOVED-SUF-QUOTED-DEFNS", 2, 0, false );
    SubLFiles.declareFunction( me, "add_suf_quoted_defn_assertion", "ADD-SUF-QUOTED-DEFN-ASSERTION", 1, 1, false );
    SubLFiles.declareFunction( me, "remove_suf_quoted_defn_assertion", "REMOVE-SUF-QUOTED-DEFN-ASSERTION", 1, 1, false );
    SubLFiles.declareFunction( me, "merge_suf_quoted_defn_assertions", "MERGE-SUF-QUOTED-DEFN-ASSERTIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "reset_col_suf_quoted_defns", "RESET-COL-SUF-QUOTED-DEFNS", 1, 0, false );
    SubLFiles.declareFunction( me, "reset_all_suf_quoted_defns", "RESET-ALL-SUF-QUOTED-DEFNS", 0, 2, false );
    SubLFiles.declareFunction( me, "initialize_sufficient_quoted_defns_cache", "INITIALIZE-SUFFICIENT-QUOTED-DEFNS-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "suf_function_cache", "SUF-FUNCTION-CACHE", 1, 0, false );
    SubLFiles.declareFunction( me, "get_suf_function_assertions", "GET-SUF-FUNCTION-ASSERTIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "set_suf_function_assertions", "SET-SUF-FUNCTION-ASSERTIONS", 3, 0, false );
    SubLFiles.declareFunction( me, "rem_suf_function_assertions", "REM-SUF-FUNCTION-ASSERTIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "suf_function_assertions", "SUF-FUNCTION-ASSERTIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "suf_functionP", "SUF-FUNCTION?", 3, 0, false );
    SubLFiles.declareFunction( me, "any_sufficient_functionP", "ANY-SUFFICIENT-FUNCTION?", 1, 1, false );
    SubLFiles.declareFunction( me, "any_sufficient_quoted_functionP", "ANY-SUFFICIENT-QUOTED-FUNCTION?", 1, 1, false );
    SubLFiles.declareFunction( me, "any_sufficient_functionP_int", "ANY-SUFFICIENT-FUNCTION?-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "any_sufficient_non_reified_functionP", "ANY-SUFFICIENT-NON-REIFIED-FUNCTION?", 2, 1, false );
    SubLFiles.declareFunction( me, "suf_function_assertionP", "SUF-FUNCTION-ASSERTION?", 3, 0, false );
    SubLFiles.declareFunction( me, "sufficient_function_of", "SUFFICIENT-FUNCTION-OF", 2, 1, false );
    SubLFiles.declareFunction( me, "add_suf_function", "ADD-SUF-FUNCTION", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_suf_function", "REMOVE-SUF-FUNCTION", 2, 0, false );
    SubLFiles.declareFunction( me, "add_suf_quoted_function", "ADD-SUF-QUOTED-FUNCTION", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_suf_quoted_function", "REMOVE-SUF-QUOTED-FUNCTION", 2, 0, false );
    SubLFiles.declareFunction( me, "add_suf_function_int", "ADD-SUF-FUNCTION-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "remove_suf_function_int", "REMOVE-SUF-FUNCTION-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "reset_cache_suf_function_meters", "RESET-CACHE-SUF-FUNCTION-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "cache_suf_function_metered", "CACHE-SUF-FUNCTION-METERED", 3, 0, false );
    SubLFiles.declareFunction( me, "cache_suf_function", "CACHE-SUF-FUNCTION", 3, 0, false );
    SubLFiles.declareFunction( me, "reset_uncache_suf_function_meters", "RESET-UNCACHE-SUF-FUNCTION-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "uncache_suf_function_metered", "UNCACHE-SUF-FUNCTION-METERED", 3, 0, false );
    SubLFiles.declareFunction( me, "uncache_suf_function", "UNCACHE-SUF-FUNCTION", 3, 0, false );
    SubLFiles.declareFunction( me, "cache_suf_function_int", "CACHE-SUF-FUNCTION-INT", 3, 1, false );
    SubLFiles.declareFunction( me, "uncache_suf_function_int", "UNCACHE-SUF-FUNCTION-INT", 3, 1, false );
    SubLFiles.declareFunction( me, "reset_handle_added_genl_for_suf_functions_meters", "RESET-HANDLE-ADDED-GENL-FOR-SUF-FUNCTIONS-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "handle_added_genl_for_suf_functions_metered", "HANDLE-ADDED-GENL-FOR-SUF-FUNCTIONS-METERED", 2, 0, false );
    SubLFiles.declareFunction( me, "handle_added_genl_for_suf_functions", "HANDLE-ADDED-GENL-FOR-SUF-FUNCTIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "reset_handle_removed_genl_for_suf_functions_meters", "RESET-HANDLE-REMOVED-GENL-FOR-SUF-FUNCTIONS-METERS", 0, 0, false );
    SubLFiles.declareFunction( me, "handle_removed_genl_for_suf_functions_metered", "HANDLE-REMOVED-GENL-FOR-SUF-FUNCTIONS-METERED", 2, 0, false );
    SubLFiles.declareFunction( me, "handle_removed_genl_for_suf_functions", "HANDLE-REMOVED-GENL-FOR-SUF-FUNCTIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "propagate_added_suf_function", "PROPAGATE-ADDED-SUF-FUNCTION", 3, 0, false );
    SubLFiles.declareFunction( me, "propagate_removed_suf_function", "PROPAGATE-REMOVED-SUF-FUNCTION", 3, 0, false );
    SubLFiles.declareFunction( me, "propagate_added_suf_functions", "PROPAGATE-ADDED-SUF-FUNCTIONS", 3, 0, false );
    SubLFiles.declareFunction( me, "propagate_removed_suf_functions", "PROPAGATE-REMOVED-SUF-FUNCTIONS", 3, 0, false );
    SubLFiles.declareFunction( me, "add_suf_function_assertion", "ADD-SUF-FUNCTION-ASSERTION", 1, 1, false );
    SubLFiles.declareFunction( me, "remove_suf_function_assertion", "REMOVE-SUF-FUNCTION-ASSERTION", 1, 1, false );
    SubLFiles.declareFunction( me, "merge_suf_function_assertions", "MERGE-SUF-FUNCTION-ASSERTIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "remove_suf_function_assertions", "REMOVE-SUF-FUNCTION-ASSERTIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "add_suf_quoted_function_assertion", "ADD-SUF-QUOTED-FUNCTION-ASSERTION", 1, 1, false );
    SubLFiles.declareFunction( me, "remove_suf_quoted_function_assertion", "REMOVE-SUF-QUOTED-FUNCTION-ASSERTION", 1, 1, false );
    SubLFiles.declareFunction( me, "merge_suf_quoted_function_assertions", "MERGE-SUF-QUOTED-FUNCTION-ASSERTIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "remove_suf_quoted_function_assertions", "REMOVE-SUF-QUOTED-FUNCTION-ASSERTIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "merge_suf_function_assertions_int", "MERGE-SUF-FUNCTION-ASSERTIONS-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "remove_suf_function_assertions_int", "REMOVE-SUF-FUNCTION-ASSERTIONS-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "function_genl_searchedP", "FUNCTION-GENL-SEARCHED?", 1, 0, false );
    SubLFiles.declareFunction( me, "suf_function_sort", "SUF-FUNCTION-SORT", 1, 0, false );
    SubLFiles.declareFunction( me, "suf_function_sort_pred", "SUF-FUNCTION-SORT-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_suf_functions", "CLEAR-SUF-FUNCTIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "clear_suf_quoted_functions", "CLEAR-SUF-QUOTED-FUNCTIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "reset_col_suf_functions", "RESET-COL-SUF-FUNCTIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "reset_all_suf_functions", "RESET-ALL-SUF-FUNCTIONS", 1, 2, false );
    SubLFiles.declareFunction( me, "initialize_sufficient_functions_cache", "INITIALIZE-SUFFICIENT-FUNCTIONS-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_sufficient_quoted_functions_cache", "INITIALIZE-SUFFICIENT-QUOTED-FUNCTIONS-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "sufficient_function_cache_mal_assertions", "SUFFICIENT-FUNCTION-CACHE-MAL-ASSERTIONS", 0, 1, false );
    SubLFiles.declareFunction( me, "sufficient_function_cache_mal_assertions_coerce", "SUFFICIENT-FUNCTION-CACHE-MAL-ASSERTIONS-COERCE", 0, 1, false );
    SubLFiles.declareFunction( me, "assertion_referenced_in_sufficient_function_cacheP", "ASSERTION-REFERENCED-IN-SUFFICIENT-FUNCTION-CACHE?", 2, 0, false );
    SubLFiles.declareFunction( me, "diagnose_sufficient_functions_cache", "DIAGNOSE-SUFFICIENT-FUNCTIONS-CACHE", 1, 2, false );
    SubLFiles.declareFunction( me, "kbi_sfc_status", "KBI-SFC-STATUS", 0, 1, false );
    SubLFiles.declareFunction( me, "sfc_cleanup", "SFC-CLEANUP", 1, 0, false );
    SubLFiles.declareFunction( me, "sfc_mal_assertions", "SFC-MAL-ASSERTIONS", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_at_defns_file()
  {
    $use_new_defns_functionsP$ = SubLFiles.defvar( "*USE-NEW-DEFNS-FUNCTIONS?*", T );
    $old_defns_admitP_meters$ = SubLFiles.defparameter( "*OLD-DEFNS-ADMIT?-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $old_defns_rejectP_meters$ = SubLFiles.defparameter( "*OLD-DEFNS-REJECT?-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $defining_defns_status_meters$ = SubLFiles.defparameter( "*DEFINING-DEFNS-STATUS-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $sufficient_defns_admitP_meters$ = SubLFiles.defparameter( "*SUFFICIENT-DEFNS-ADMIT?-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $necessary_defns_rejectP_meters$ = SubLFiles.defparameter( "*NECESSARY-DEFNS-REJECT?-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $rejected_by_necessary_defns_meters$ = SubLFiles.defparameter( "*REJECTED-BY-NECESSARY-DEFNS-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $old_quoted_defns_admitP_meters$ = SubLFiles.defparameter( "*OLD-QUOTED-DEFNS-ADMIT?-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $old_quoted_defns_rejectP_meters$ = SubLFiles.defparameter( "*OLD-QUOTED-DEFNS-REJECT?-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $quoted_defining_defns_status_meters$ = SubLFiles.defparameter( "*QUOTED-DEFINING-DEFNS-STATUS-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $quoted_sufficient_defns_admitP_meters$ = SubLFiles.defparameter( "*QUOTED-SUFFICIENT-DEFNS-ADMIT?-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $quoted_necessary_defns_rejectP_meters$ = SubLFiles.defparameter( "*QUOTED-NECESSARY-DEFNS-REJECT?-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $rejected_by_quoted_necessary_defns_meters$ = SubLFiles.defparameter( "*REJECTED-BY-QUOTED-NECESSARY-DEFNS-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $defn_admits_intP_meters$ = SubLFiles.defparameter( "*DEFN-ADMITS-INT?-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $quoted_defn_admits_intP_meters$ = SubLFiles.defparameter( "*QUOTED-DEFN-ADMITS-INT?-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $defn_cyc_evaluate_caching_state$ = SubLFiles.deflexical( "*DEFN-CYC-EVALUATE-CACHING-STATE*", NIL );
    $cat_defns_failing$ = SubLFiles.defparameter( "*CAT-DEFNS-FAILING*", NIL );
    $cache_suf_defn_meters$ = SubLFiles.defparameter( "*CACHE-SUF-DEFN-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $uncache_suf_defn_meters$ = SubLFiles.defparameter( "*UNCACHE-SUF-DEFN-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $old_handle_added_genl_for_suf_defns_meters$ = SubLFiles.defparameter( "*OLD-HANDLE-ADDED-GENL-FOR-SUF-DEFNS-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $old_handle_removed_genl_for_suf_defns_meters$ = SubLFiles.defparameter( "*OLD-HANDLE-REMOVED-GENL-FOR-SUF-DEFNS-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $cache_suf_quoted_defn_meters$ = SubLFiles.defparameter( "*CACHE-SUF-QUOTED-DEFN-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $uncache_suf_quoted_defn_meters$ = SubLFiles.defparameter( "*UNCACHE-SUF-QUOTED-DEFN-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $old_handle_added_genl_for_suf_quoted_defns_meters$ = SubLFiles.defparameter( "*OLD-HANDLE-ADDED-GENL-FOR-SUF-QUOTED-DEFNS-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $old_handle_removed_genl_for_suf_quoted_defns_meters$ = SubLFiles.defparameter( "*OLD-HANDLE-REMOVED-GENL-FOR-SUF-QUOTED-DEFNS-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $cache_suf_function_meters$ = SubLFiles.defparameter( "*CACHE-SUF-FUNCTION-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $uncache_suf_function_meters$ = SubLFiles.defparameter( "*UNCACHE-SUF-FUNCTION-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $handle_added_genl_for_suf_functions_meters$ = SubLFiles.defparameter( "*HANDLE-ADDED-GENL-FOR-SUF-FUNCTIONS-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $handle_removed_genl_for_suf_functions_meters$ = SubLFiles.defparameter( "*HANDLE-REMOVED-GENL-FOR-SUF-FUNCTIONS-METERS*", Hashtables.make_hash_table( EIGHT_INTEGER, UNPROVIDED, UNPROVIDED ) );
    $suf_function_cache_mal_keys$ = SubLFiles.defparameter( "*SUF-FUNCTION-CACHE-MAL-KEYS*", NIL );
    $suf_function_cache_key_wXo_value$ = SubLFiles.defparameter( "*SUF-FUNCTION-CACHE-KEY-W/O-VALUE*", NIL );
    $suf_function_cache_key_wXmal_value$ = SubLFiles.defparameter( "*SUF-FUNCTION-CACHE-KEY-W/MAL-VALUE*", NIL );
    $suf_function_cache_key_wXstale_value$ = SubLFiles.defparameter( "*SUF-FUNCTION-CACHE-KEY-W/STALE-VALUE*", NIL );
    $suf_function_cache_keys_wXo_inerited_value$ = SubLFiles.defparameter( "*SUF-FUNCTION-CACHE-KEYS-W/O-INERITED-VALUE*", NIL );
    $suf_function_cache_awol_direct_assertions$ = SubLFiles.defparameter( "*SUF-FUNCTION-CACHE-AWOL-DIRECT-ASSERTIONS*", NIL );
    return NIL;
  }
  ...
  public static SubLObject setup_at_defns_file()
  {
    ...
    Hashtables.sethash( $kw12$RESET, $old_defns_admitP_meters$.getDynamicValue(), $sym13$RESET_OLD_DEFNS_ADMIT__METERS );
    ...
    while ( NIL != cdolist_list_var)
    {
      if( $sym11$OLD_DEFNS_ADMIT_ == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $old_defns_admitP_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    ...
    Hashtables.sethash( $kw12$RESET, $old_defns_rejectP_meters$.getDynamicValue(), $sym16$RESET_OLD_DEFNS_REJECT__METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym15$OLD_DEFNS_REJECT_ == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $old_defns_rejectP_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym17$_DEFINING_DEFNS_STATUS_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_defining_defns_status_meters();
    Hashtables.sethash( $kw12$RESET, $defining_defns_status_meters$.getDynamicValue(), $sym19$RESET_DEFINING_DEFNS_STATUS_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym18$DEFINING_DEFNS_STATUS == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $defining_defns_status_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    ...
    Hashtables.sethash( $kw12$RESET, $sufficient_defns_admitP_meters$.getDynamicValue(), $sym28$RESET_SUFFICIENT_DEFNS_ADMIT__METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym27$SUFFICIENT_DEFNS_ADMIT_ == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $sufficient_defns_admitP_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    ...
    Hashtables.sethash( $kw12$RESET, $necessary_defns_rejectP_meters$.getDynamicValue(), $sym33$RESET_NECESSARY_DEFNS_REJECT__METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym32$NECESSARY_DEFNS_REJECT_ == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $necessary_defns_rejectP_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym51$_REJECTED_BY_NECESSARY_DEFNS_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_rejected_by_necessary_defns_meters();
    Hashtables.sethash( $kw12$RESET, $rejected_by_necessary_defns_meters$.getDynamicValue(), $sym53$RESET_REJECTED_BY_NECESSARY_DEFNS_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym52$REJECTED_BY_NECESSARY_DEFNS == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $rejected_by_necessary_defns_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    ...
    Hashtables.sethash( $kw12$RESET, $old_quoted_defns_admitP_meters$.getDynamicValue(), $sym59$RESET_OLD_QUOTED_DEFNS_ADMIT__METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym58$OLD_QUOTED_DEFNS_ADMIT_ == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $old_quoted_defns_admitP_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    ...
    Hashtables.sethash( $kw12$RESET, $old_quoted_defns_rejectP_meters$.getDynamicValue(), $sym62$RESET_OLD_QUOTED_DEFNS_REJECT__METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym61$OLD_QUOTED_DEFNS_REJECT_ == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $old_quoted_defns_rejectP_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym63$_QUOTED_DEFINING_DEFNS_STATUS_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_quoted_defining_defns_status_meters();
    Hashtables.sethash( $kw12$RESET, $quoted_defining_defns_status_meters$.getDynamicValue(), $sym65$RESET_QUOTED_DEFINING_DEFNS_STATUS_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym64$QUOTED_DEFINING_DEFNS_STATUS == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $quoted_defining_defns_status_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    ...
    Hashtables.sethash( $kw12$RESET, $quoted_sufficient_defns_admitP_meters$.getDynamicValue(), $sym69$RESET_QUOTED_SUFFICIENT_DEFNS_ADMIT__METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym68$QUOTED_SUFFICIENT_DEFNS_ADMIT_ == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $quoted_sufficient_defns_admitP_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    ...
    Hashtables.sethash( $kw12$RESET, $quoted_necessary_defns_rejectP_meters$.getDynamicValue(), $sym72$RESET_QUOTED_NECESSARY_DEFNS_REJECT__METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym71$QUOTED_NECESSARY_DEFNS_REJECT_ == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $quoted_necessary_defns_rejectP_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym74$_REJECTED_BY_QUOTED_NECESSARY_DEFNS_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_rejected_by_quoted_necessary_defns_meters();
    Hashtables.sethash( $kw12$RESET, $rejected_by_quoted_necessary_defns_meters$.getDynamicValue(), $sym76$RESET_REJECTED_BY_QUOTED_NECESSARY_DEFNS_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym75$REJECTED_BY_QUOTED_NECESSARY_DEFNS == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $rejected_by_quoted_necessary_defns_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    ...
    Hashtables.sethash( $kw12$RESET, $defn_admits_intP_meters$.getDynamicValue(), $sym83$RESET_DEFN_ADMITS_INT__METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym82$DEFN_ADMITS_INT_ == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $defn_admits_intP_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    ...
    Hashtables.sethash( $kw12$RESET, $quoted_defn_admits_intP_meters$.getDynamicValue(), $sym89$RESET_QUOTED_DEFN_ADMITS_INT__METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym88$QUOTED_DEFN_ADMITS_INT_ == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $quoted_defn_admits_intP_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    memoization_state.note_globally_cached_function( $sym90$DEFN_CYC_EVALUATE );
    memoization_state.note_memoized_function( $sym100$QUIET_HAS_TYPE_MEMOIZED_ );
    utilities_macros.register_kb_function( $sym145$ADD_SUF_DEFN );
    utilities_macros.register_kb_function( $sym146$ADD_IFF_DEFN );
    utilities_macros.register_kb_function( $sym151$OLD_ADD_SUF_DEFN );
    utilities_macros.register_kb_function( $sym152$REMOVE_SUF_DEFN );
    utilities_macros.register_kb_function( $sym153$REMOVE_IFF_DEFN );
    utilities_macros.register_kb_function( $sym154$OLD_REMOVE_SUF_DEFN );
    item_var = $sym155$_CACHE_SUF_DEFN_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_cache_suf_defn_meters();
    Hashtables.sethash( $kw12$RESET, $cache_suf_defn_meters$.getDynamicValue(), $sym158$RESET_CACHE_SUF_DEFN_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym157$CACHE_SUF_DEFN == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $cache_suf_defn_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym159$_UNCACHE_SUF_DEFN_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_uncache_suf_defn_meters();
    Hashtables.sethash( $kw12$RESET, $uncache_suf_defn_meters$.getDynamicValue(), $sym161$RESET_UNCACHE_SUF_DEFN_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym160$UNCACHE_SUF_DEFN == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $uncache_suf_defn_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym164$_OLD_HANDLE_ADDED_GENL_FOR_SUF_DEFNS_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_old_handle_added_genl_for_suf_defns_meters();
    Hashtables.sethash( $kw12$RESET, $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue(), $sym167$RESET_OLD_HANDLE_ADDED_GENL_FOR_SUF_DEFNS_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym166$OLD_HANDLE_ADDED_GENL_FOR_SUF_DEFNS == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $old_handle_added_genl_for_suf_defns_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym168$_OLD_HANDLE_REMOVED_GENL_FOR_SUF_DEFNS_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_old_handle_removed_genl_for_suf_defns_meters();
    Hashtables.sethash( $kw12$RESET, $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue(), $sym170$RESET_OLD_HANDLE_REMOVED_GENL_FOR_SUF_DEFNS_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym169$OLD_HANDLE_REMOVED_GENL_FOR_SUF_DEFNS == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $old_handle_removed_genl_for_suf_defns_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    utilities_macros.register_kb_function( $sym180$ADD_SUF_QUOTED_DEFN );
    utilities_macros.register_kb_function( $sym181$ADD_IFF_QUOTED_DEFN );
    utilities_macros.register_kb_function( $sym183$OLD_ADD_SUF_QUOTED_DEFN );
    utilities_macros.register_kb_function( $sym184$REMOVE_SUF_QUOTED_DEFN );
    utilities_macros.register_kb_function( $sym185$REMOVE_IFF_QUOTED_DEFN );
    utilities_macros.register_kb_function( $sym186$OLD_REMOVE_SUF_QUOTED_DEFN );
    item_var = $sym187$_CACHE_SUF_QUOTED_DEFN_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_cache_suf_quoted_defn_meters();
    Hashtables.sethash( $kw12$RESET, $cache_suf_quoted_defn_meters$.getDynamicValue(), $sym189$RESET_CACHE_SUF_QUOTED_DEFN_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym188$CACHE_SUF_QUOTED_DEFN == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $cache_suf_quoted_defn_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym190$_UNCACHE_SUF_QUOTED_DEFN_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_uncache_suf_quoted_defn_meters();
    Hashtables.sethash( $kw12$RESET, $uncache_suf_quoted_defn_meters$.getDynamicValue(), $sym192$RESET_UNCACHE_SUF_QUOTED_DEFN_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym191$UNCACHE_SUF_QUOTED_DEFN == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $uncache_suf_quoted_defn_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym196$_OLD_HANDLE_ADDED_GENL_FOR_SUF_QUOTED_DEFNS_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_old_handle_added_genl_for_suf_quoted_defns_meters();
    Hashtables.sethash( $kw12$RESET, $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue(), $sym198$RESET_OLD_HANDLE_ADDED_GENL_FOR_SUF_QUOTED_DEFNS_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym197$OLD_HANDLE_ADDED_GENL_FOR_SUF_QUOTED_DEFNS == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $old_handle_added_genl_for_suf_quoted_defns_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym199$_OLD_HANDLE_REMOVED_GENL_FOR_SUF_QUOTED_DEFNS_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_old_handle_removed_genl_for_suf_quoted_defns_meters();
    Hashtables.sethash( $kw12$RESET, $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue(), $sym201$RESET_OLD_HANDLE_REMOVED_GENL_FOR_SUF_QUOTED_DEFNS_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym200$OLD_HANDLE_REMOVED_GENL_FOR_SUF_QUOTED_DEFNS == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $old_handle_removed_genl_for_suf_quoted_defns_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    utilities_macros.register_kb_function( $sym209$ADD_SUF_FUNCTION );
    utilities_macros.register_kb_function( $sym210$REMOVE_SUF_FUNCTION );
    utilities_macros.register_kb_function( $sym211$ADD_SUF_QUOTED_FUNCTION );
    utilities_macros.register_kb_function( $sym212$REMOVE_SUF_QUOTED_FUNCTION );
    utilities_macros.register_kb_function( $sym217$ADD_SUF_FUNCTION_INT );
    utilities_macros.register_kb_function( $sym218$REMOVE_SUF_FUNCTION_INT );
    item_var = $sym219$_CACHE_SUF_FUNCTION_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_cache_suf_function_meters();
    Hashtables.sethash( $kw12$RESET, $cache_suf_function_meters$.getDynamicValue(), $sym222$RESET_CACHE_SUF_FUNCTION_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym221$CACHE_SUF_FUNCTION == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $cache_suf_function_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym223$_UNCACHE_SUF_FUNCTION_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_uncache_suf_function_meters();
    Hashtables.sethash( $kw12$RESET, $uncache_suf_function_meters$.getDynamicValue(), $sym225$RESET_UNCACHE_SUF_FUNCTION_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym224$UNCACHE_SUF_FUNCTION == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $uncache_suf_function_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym232$_HANDLE_ADDED_GENL_FOR_SUF_FUNCTIONS_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_handle_added_genl_for_suf_functions_meters();
    Hashtables.sethash( $kw12$RESET, $handle_added_genl_for_suf_functions_meters$.getDynamicValue(), $sym234$RESET_HANDLE_ADDED_GENL_FOR_SUF_FUNCTIONS_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym233$HANDLE_ADDED_GENL_FOR_SUF_FUNCTIONS == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $handle_added_genl_for_suf_functions_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    item_var = $sym236$_HANDLE_REMOVED_GENL_FOR_SUF_FUNCTIONS_METERS_;
    if( NIL == conses_high.member( item_var, utilities_macros.$defn_state_variables$.getGlobalValue(), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
    {
      utilities_macros.$defn_state_variables$.setGlobalValue( ConsesLow.cons( item_var, utilities_macros.$defn_state_variables$.getGlobalValue() ) );
    }
    reset_handle_removed_genl_for_suf_functions_meters();
    Hashtables.sethash( $kw12$RESET, $handle_removed_genl_for_suf_functions_meters$.getDynamicValue(), $sym238$RESET_HANDLE_REMOVED_GENL_FOR_SUF_FUNCTIONS_METERS );
    cdolist_list_var = at_vars.$defn_meter_caches$.getDynamicValue();
    v_cache = NIL;
    v_cache = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( $sym237$HANDLE_REMOVED_GENL_FOR_SUF_FUNCTIONS == Hashtables.gethash( $kw10$FUNCTION, v_cache, UNPROVIDED ) )
      {
        at_vars.$defn_meter_caches$.setDynamicValue( Sequences.delete( v_cache, at_vars.$defn_meter_caches$.getDynamicValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        Hashtables.clrhash( v_cache );
      }
    ...
    at_vars.$defn_meter_caches$.setDynamicValue( ConsesLow.cons( $handle_removed_genl_for_suf_functions_meters$.getDynamicValue(), at_vars.$defn_meter_caches$.getDynamicValue() ) );
    return NIL;
  }
  ...
  {
    me = new at_defns();
    $use_new_defns_functionsP$ = null;
    $old_defns_admitP_meters$ = null;
    $old_defns_rejectP_meters$ = null;
    $defining_defns_status_meters$ = null;
    $sufficient_defns_admitP_meters$ = null;
    $necessary_defns_rejectP_meters$ = null;
    $rejected_by_necessary_defns_meters$ = null;
    $old_quoted_defns_admitP_meters$ = null;
    $old_quoted_defns_rejectP_meters$ = null;
    $quoted_defining_defns_status_meters$ = null;
    $quoted_sufficient_defns_admitP_meters$ = null;
    $quoted_necessary_defns_rejectP_meters$ = null;
    $rejected_by_quoted_necessary_defns_meters$ = null;
    $defn_admits_intP_meters$ = null;
    $quoted_defn_admits_intP_meters$ = null;
    $defn_cyc_evaluate_caching_state$ = null;
    $cat_defns_failing$ = null;
    $cache_suf_defn_meters$ = null;
    $uncache_suf_defn_meters$ = null;
    $old_handle_added_genl_for_suf_defns_meters$ = null;
    $old_handle_removed_genl_for_suf_defns_meters$ = null;
    $cache_suf_quoted_defn_meters$ = null;
    $uncache_suf_quoted_defn_meters$ = null;
    $old_handle_added_genl_for_suf_quoted_defns_meters$ = null;
    $old_handle_removed_genl_for_suf_quoted_defns_meters$ = null;
    $cache_suf_function_meters$ = null;
    $uncache_suf_function_meters$ = null;
    $handle_added_genl_for_suf_functions_meters$ = null;
    $handle_removed_genl_for_suf_functions_meters$ = null;
    $suf_function_cache_mal_keys$ = null;
    $suf_function_cache_key_wXo_value$ = null;
    $suf_function_cache_key_wXmal_value$ = null;
    $suf_function_cache_key_wXstale_value$ = null;
    $suf_function_cache_keys_wXo_inerited_value$ = null;
    $suf_function_cache_awol_direct_assertions$ = null;
    $str0$___remove_sufficent_defn__a__a_ = makeString( "~%(remove-sufficent-defn ~a ~a)" );
    $kw1$ADMITTED = makeKeyword( "ADMITTED" );
    $kw2$REJECTED = makeKeyword( "REJECTED" );
    $sym3$_OLD_DEFNS_ADMIT__METERS_ = makeSymbol( "*OLD-DEFNS-ADMIT?-METERS*" );
    $kw4$CALLS = makeKeyword( "CALLS" );
    $kw5$TIMES = makeKeyword( "TIMES" );
    $kw6$RESULTS = makeKeyword( "RESULTS" );
    $kw7$ARGS = makeKeyword( "ARGS" );
    $kw8$ARG_LIST = makeKeyword( "ARG-LIST" );
    $list9 = ConsesLow.list( makeSymbol( "COLLECTION" ), makeSymbol( "TERM" ), makeSymbol( "MT" ) );
    $kw10$FUNCTION = makeKeyword( "FUNCTION" );
    $sym11$OLD_DEFNS_ADMIT_ = makeSymbol( "OLD-DEFNS-ADMIT?" );
    $kw12$RESET = makeKeyword( "RESET" );
    $sym13$RESET_OLD_DEFNS_ADMIT__METERS = makeSymbol( "RESET-OLD-DEFNS-ADMIT?-METERS" );
    $sym14$_OLD_DEFNS_REJECT__METERS_ = makeSymbol( "*OLD-DEFNS-REJECT?-METERS*" );
    $sym15$OLD_DEFNS_REJECT_ = makeSymbol( "OLD-DEFNS-REJECT?" );
    $sym16$RESET_OLD_DEFNS_REJECT__METERS = makeSymbol( "RESET-OLD-DEFNS-REJECT?-METERS" );
    $sym17$_DEFINING_DEFNS_STATUS_METERS_ = makeSymbol( "*DEFINING-DEFNS-STATUS-METERS*" );
    $sym18$DEFINING_DEFNS_STATUS = makeSymbol( "DEFINING-DEFNS-STATUS" );
    $sym19$RESET_DEFINING_DEFNS_STATUS_METERS = makeSymbol( "RESET-DEFINING-DEFNS-STATUS-METERS" );
    $const20$defnIff = constant_handles.reader_make_constant_shell( makeString( "defnIff" ) );
    $kw21$TRUE = makeKeyword( "TRUE" );
    $kw22$VIA_GENL_PRED = makeKeyword( "VIA-GENL-PRED" );
    $kw23$AT_CONSTRAINT_GAF = makeKeyword( "AT-CONSTRAINT-GAF" );
    $kw24$MAL_ARG_WRT_QUOTED_IFF_DEFN = makeKeyword( "MAL-ARG-WRT-QUOTED-IFF-DEFN" );
    $kw25$MAL_ARG_WRT_IFF_DEFN = makeKeyword( "MAL-ARG-WRT-IFF-DEFN" );
    $sym26$_SUFFICIENT_DEFNS_ADMIT__METERS_ = makeSymbol( "*SUFFICIENT-DEFNS-ADMIT?-METERS*" );
    $sym27$SUFFICIENT_DEFNS_ADMIT_ = makeSymbol( "SUFFICIENT-DEFNS-ADMIT?" );
    $sym28$RESET_SUFFICIENT_DEFNS_ADMIT__METERS = makeSymbol( "RESET-SUFFICIENT-DEFNS-ADMIT?-METERS" );
    $kw29$MAL_ARG_WRT_QUOTED_SUF_DEFNS = makeKeyword( "MAL-ARG-WRT-QUOTED-SUF-DEFNS" );
    $kw30$MAL_ARG_WRT_SUF_DEFNS = makeKeyword( "MAL-ARG-WRT-SUF-DEFNS" );
    $sym31$_NECESSARY_DEFNS_REJECT__METERS_ = makeSymbol( "*NECESSARY-DEFNS-REJECT?-METERS*" );
    $sym32$NECESSARY_DEFNS_REJECT_ = makeSymbol( "NECESSARY-DEFNS-REJECT?" );
    $sym33$RESET_NECESSARY_DEFNS_REJECT__METERS = makeSymbol( "RESET-NECESSARY-DEFNS-REJECT?-METERS" );
    ...
    $list46 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "defnIff" ) ), constant_handles.reader_make_constant_shell( makeString( "defnNecessary" ) ) );
    ...
    $sym51$_REJECTED_BY_NECESSARY_DEFNS_METERS_ = makeSymbol( "*REJECTED-BY-NECESSARY-DEFNS-METERS*" );
    $sym52$REJECTED_BY_NECESSARY_DEFNS = makeSymbol( "REJECTED-BY-NECESSARY-DEFNS" );
    $sym53$RESET_REJECTED_BY_NECESSARY_DEFNS_METERS = makeSymbol( "RESET-REJECTED-BY-NECESSARY-DEFNS-METERS" );
    $const54$defnNecessary = constant_handles.reader_make_constant_shell( makeString( "defnNecessary" ) );
    $kw55$MAL_ARG_WRT_QUOTED_NEC_DEFN = makeKeyword( "MAL-ARG-WRT-QUOTED-NEC-DEFN" );
    $kw56$MAL_ARG_WRT_NEC_DEFN = makeKeyword( "MAL-ARG-WRT-NEC-DEFN" );
    $sym57$_OLD_QUOTED_DEFNS_ADMIT__METERS_ = makeSymbol( "*OLD-QUOTED-DEFNS-ADMIT?-METERS*" );
    $sym58$OLD_QUOTED_DEFNS_ADMIT_ = makeSymbol( "OLD-QUOTED-DEFNS-ADMIT?" );
    $sym59$RESET_OLD_QUOTED_DEFNS_ADMIT__METERS = makeSymbol( "RESET-OLD-QUOTED-DEFNS-ADMIT?-METERS" );
    $sym60$_OLD_QUOTED_DEFNS_REJECT__METERS_ = makeSymbol( "*OLD-QUOTED-DEFNS-REJECT?-METERS*" );
    $sym61$OLD_QUOTED_DEFNS_REJECT_ = makeSymbol( "OLD-QUOTED-DEFNS-REJECT?" );
    $sym62$RESET_OLD_QUOTED_DEFNS_REJECT__METERS = makeSymbol( "RESET-OLD-QUOTED-DEFNS-REJECT?-METERS" );
    $sym63$_QUOTED_DEFINING_DEFNS_STATUS_METERS_ = makeSymbol( "*QUOTED-DEFINING-DEFNS-STATUS-METERS*" );
    $sym64$QUOTED_DEFINING_DEFNS_STATUS = makeSymbol( "QUOTED-DEFINING-DEFNS-STATUS" );
    $sym65$RESET_QUOTED_DEFINING_DEFNS_STATUS_METERS = makeSymbol( "RESET-QUOTED-DEFINING-DEFNS-STATUS-METERS" );
    $const66$quotedDefnIff = constant_handles.reader_make_constant_shell( makeString( "quotedDefnIff" ) );
    $sym67$_QUOTED_SUFFICIENT_DEFNS_ADMIT__METERS_ = makeSymbol( "*QUOTED-SUFFICIENT-DEFNS-ADMIT?-METERS*" );
    $sym68$QUOTED_SUFFICIENT_DEFNS_ADMIT_ = makeSymbol( "QUOTED-SUFFICIENT-DEFNS-ADMIT?" );
    $sym69$RESET_QUOTED_SUFFICIENT_DEFNS_ADMIT__METERS = makeSymbol( "RESET-QUOTED-SUFFICIENT-DEFNS-ADMIT?-METERS" );
    $sym70$_QUOTED_NECESSARY_DEFNS_REJECT__METERS_ = makeSymbol( "*QUOTED-NECESSARY-DEFNS-REJECT?-METERS*" );
    $sym71$QUOTED_NECESSARY_DEFNS_REJECT_ = makeSymbol( "QUOTED-NECESSARY-DEFNS-REJECT?" );
    $sym72$RESET_QUOTED_NECESSARY_DEFNS_REJECT__METERS = makeSymbol( "RESET-QUOTED-NECESSARY-DEFNS-REJECT?-METERS" );
    $list73 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "quotedDefnIff" ) ), constant_handles.reader_make_constant_shell( makeString( "quotedDefnNecessary" ) ) );
    $sym74$_REJECTED_BY_QUOTED_NECESSARY_DEFNS_METERS_ = makeSymbol( "*REJECTED-BY-QUOTED-NECESSARY-DEFNS-METERS*" );
    $sym75$REJECTED_BY_QUOTED_NECESSARY_DEFNS = makeSymbol( "REJECTED-BY-QUOTED-NECESSARY-DEFNS" );
    $sym76$RESET_REJECTED_BY_QUOTED_NECESSARY_DEFNS_METERS = makeSymbol( "RESET-REJECTED-BY-QUOTED-NECESSARY-DEFNS-METERS" );
    $const77$quotedDefnNecessary = constant_handles.reader_make_constant_shell( makeString( "quotedDefnNecessary" ) );
    $str78$defn_stack_consistency_error___Ex = makeString( "defn-stack consistency error.  Expected ~s to be on the top of the stack, but instead got ~s." );
    $str79$recursive_call_of_defn__a_with_ar = makeString( "recursive call of defn ~a with argument ~a" );
    $sym80$_DEFN_ADMITS_INT__METERS_ = makeSymbol( "*DEFN-ADMITS-INT?-METERS*" );
    $list81 = ConsesLow.list( makeSymbol( "DEFN" ), makeSymbol( "TERM" ), makeSymbol( "COLLECTION" ) );
    $sym82$DEFN_ADMITS_INT_ = makeSymbol( "DEFN-ADMITS-INT?" );
    $sym83$RESET_DEFN_ADMITS_INT__METERS = makeSymbol( "RESET-DEFN-ADMITS-INT?-METERS" );
    $str84$__defn_test__term__s__defn__s_of_ = makeString( "~%defn test: term ~s; defn ~s of collection ~s: ~s" );
    $str85$__defn_test__term__s__defn__s_of_ = makeString( "~%defn test: term ~s; defn ~s of collection ~s (via ~s): ~s" );
    $str86$recursive_call_of_quoted_defn__a_ = makeString( "recursive call of quoted defn ~a with argument ~a" );
    $sym87$_QUOTED_DEFN_ADMITS_INT__METERS_ = makeSymbol( "*QUOTED-DEFN-ADMITS-INT?-METERS*" );
    $sym88$QUOTED_DEFN_ADMITS_INT_ = makeSymbol( "QUOTED-DEFN-ADMITS-INT?" );
    $sym89$RESET_QUOTED_DEFN_ADMITS_INT__METERS = makeSymbol( "RESET-QUOTED-DEFN-ADMITS-INT?-METERS" );
    $sym90$DEFN_CYC_EVALUATE = makeSymbol( "DEFN-CYC-EVALUATE" );
    $sym91$_DEFN_CYC_EVALUATE_CACHING_STATE_ = makeSymbol( "*DEFN-CYC-EVALUATE-CACHING-STATE*" );
    $int92$24 = makeInteger( 24 );
    $str93$_s_has_invalid_defn___s = makeString( "~s has invalid defn: ~s" );
    $str94$invalid_defn___s = makeString( "invalid defn: ~s" );
    $str95$_s_has_non_viable_defn___s = makeString( "~s has non-viable defn: ~s" );
    $str96$non_viable_defn___s = makeString( "non-viable defn: ~s" );
    $sym97$CYC_VAR_ = makeSymbol( "CYC-VAR?" );
    $list98 = ConsesLow.cons( makeSymbol( "COL" ), makeSymbol( "DEFN-ASSERTIONS" ) );
    $sym99$_EXIT = makeSymbol( "%EXIT" );
    $sym100$QUIET_HAS_TYPE_MEMOIZED_ = makeSymbol( "QUIET-HAS-TYPE-MEMOIZED?" );
    $const101$InferencePSC = constant_handles.reader_make_constant_shell( makeString( "InferencePSC" ) );
    $const102$Function_Denotational = constant_handles.reader_make_constant_shell( makeString( "Function-Denotational" ) );
    $const103$SpecsFn = constant_handles.reader_make_constant_shell( makeString( "SpecsFn" ) );
    $const104$Thing = constant_handles.reader_make_constant_shell( makeString( "Thing" ) );
    $list105 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "BaseKB" ) ) );
    $sym106$RELEVANT_MT_IS_EVERYTHING = makeSymbol( "RELEVANT-MT-IS-EVERYTHING" );
    $const107$EverythingPSC = constant_handles.reader_make_constant_shell( makeString( "EverythingPSC" ) );
    $kw108$ISA = makeKeyword( "ISA" );
    $const109$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $kw110$GENLS = makeKeyword( "GENLS" );
    $kw111$DEFN = makeKeyword( "DEFN" );
    $kw112$DISJOINTWITH = makeKeyword( "DISJOINTWITH" );
    $const113$disjointWith = constant_handles.reader_make_constant_shell( makeString( "disjointWith" ) );
    $const114$quotedIsa = constant_handles.reader_make_constant_shell( makeString( "quotedIsa" ) );
    $int115$64 = makeInteger( 64 );
    $const116$defnSufficient = constant_handles.reader_make_constant_shell( makeString( "defnSufficient" ) );
    $sym117$COLLECTIONS_ADMITTING_TERM_VIA_DEFNS_1 = makeSymbol( "COLLECTIONS-ADMITTING-TERM-VIA-DEFNS-1" );
    $sym118$GATHER_COLLECTIONS_ADMITTING_VIA_DEFNS = makeSymbol( "GATHER-COLLECTIONS-ADMITTING-VIA-DEFNS" );
    $str119$__warn__ = makeString( "~%warn: " );
    $sym120$WARN = makeSymbol( "WARN" );
    $str121$____defn_module_meters_ = makeString( "~%~%defn module meters " );
    $int122$27 = makeInteger( 27 );
    $str123$_ = makeString( "*" );
    $str124$_____a__ = makeString( "~%  ~a :" );
    $str125$function = makeString( "function" );
    $str126$___calls___ = makeString( " [ calls ] " );
    $str127$___total_time___ = makeString( " [ total time ] " );
    $str128$____avg_time____ = makeString( " [  avg time  ] " );
    $str129$_s = makeString( "~s" );
    $sym130$_ = makeSymbol( "+" );
    $str131$____a___ = makeString( "   ~a   " );
    $str132$_a = makeString( "~a" );
    $str133$_ = makeString( " " );
    $int134$46 = makeInteger( 46 );
    $str135$_s_ = makeString( "~s " );
    $str136$_____a = makeString( "~%~%~a" );
    $int137$37 = makeInteger( 37 );
    $str138$______call__ = makeString( "~%  [ call ]" );
    $str139$____a___ = makeString( " [ ~a ] " );
    $str140$____result____ = makeString( " [  result  ] " );
    $str141$_____time_____ = makeString( " [   time   ] " );
    $str142$____a = makeString( "~% ~a" );
    $str143$total = makeString( "total" );
    $sym144$KBEQ = makeSymbol( "KBEQ" );
    $sym145$ADD_SUF_DEFN = makeSymbol( "ADD-SUF-DEFN" );
    $sym146$ADD_IFF_DEFN = makeSymbol( "ADD-IFF-DEFN" );
    $sym147$RELEVANT_MT_IS_GENL_MT = makeSymbol( "RELEVANT-MT-IS-GENL-MT" );
    $str148$skip_defn_op = makeString( "skip defn op" );
    $str149$_s_is_not_a_collection_in__s = makeString( "~s is not a collection in ~s" );
    $str150$_s_is_not_a_symbol = makeString( "~s is not a symbol" );
    $sym151$OLD_ADD_SUF_DEFN = makeSymbol( "OLD-ADD-SUF-DEFN" );
    $sym152$REMOVE_SUF_DEFN = makeSymbol( "REMOVE-SUF-DEFN" );
    $sym153$REMOVE_IFF_DEFN = makeSymbol( "REMOVE-IFF-DEFN" );
    $sym154$OLD_REMOVE_SUF_DEFN = makeSymbol( "OLD-REMOVE-SUF-DEFN" );
    $sym155$_CACHE_SUF_DEFN_METERS_ = makeSymbol( "*CACHE-SUF-DEFN-METERS*" );
    $list156 = ConsesLow.list( makeSymbol( "COL" ), makeSymbol( "ASSERTION" ) );
    $sym157$CACHE_SUF_DEFN = makeSymbol( "CACHE-SUF-DEFN" );
    $sym158$RESET_CACHE_SUF_DEFN_METERS = makeSymbol( "RESET-CACHE-SUF-DEFN-METERS" );
    $sym159$_UNCACHE_SUF_DEFN_METERS_ = makeSymbol( "*UNCACHE-SUF-DEFN-METERS*" );
    $sym160$UNCACHE_SUF_DEFN = makeSymbol( "UNCACHE-SUF-DEFN" );
    $sym161$RESET_UNCACHE_SUF_DEFN_METERS = makeSymbol( "RESET-UNCACHE-SUF-DEFN-METERS" );
    $str162$___add_sufficent_defn__a__a_ = makeString( "~%(add-sufficent-defn ~a ~a)" );
    $str163$removed_sufficient_defn_not_found = makeString( "removed sufficient defn not found in cache: ~s" );
    $sym164$_OLD_HANDLE_ADDED_GENL_FOR_SUF_DEFNS_METERS_ = makeSymbol( "*OLD-HANDLE-ADDED-GENL-FOR-SUF-DEFNS-METERS*" );
    $list165 = ConsesLow.list( makeSymbol( "SPEC" ), makeSymbol( "GENL" ) );
    $sym166$OLD_HANDLE_ADDED_GENL_FOR_SUF_DEFNS = makeSymbol( "OLD-HANDLE-ADDED-GENL-FOR-SUF-DEFNS" );
    $sym167$RESET_OLD_HANDLE_ADDED_GENL_FOR_SUF_DEFNS_METERS = makeSymbol( "RESET-OLD-HANDLE-ADDED-GENL-FOR-SUF-DEFNS-METERS" );
    $sym168$_OLD_HANDLE_REMOVED_GENL_FOR_SUF_DEFNS_METERS_ = makeSymbol( "*OLD-HANDLE-REMOVED-GENL-FOR-SUF-DEFNS-METERS*" );
    $sym169$OLD_HANDLE_REMOVED_GENL_FOR_SUF_DEFNS = makeSymbol( "OLD-HANDLE-REMOVED-GENL-FOR-SUF-DEFNS" );
    $sym170$RESET_OLD_HANDLE_REMOVED_GENL_FOR_SUF_DEFNS_METERS = makeSymbol( "RESET-OLD-HANDLE-REMOVED-GENL-FOR-SUF-DEFNS-METERS" );
    $sym171$ADD_SUF_DEFN_ASSERTION = makeSymbol( "ADD-SUF-DEFN-ASSERTION" );
    $sym172$REMOVE_SUF_DEFN_ASSERTION = makeSymbol( "REMOVE-SUF-DEFN-ASSERTION" );
    $sym173$MERGE_SUF_DEFN_ASSERTIONS = makeSymbol( "MERGE-SUF-DEFN-ASSERTIONS" );
    $sym174$REMOVE_SUF_DEFN_ASSERTIONS = makeSymbol( "REMOVE-SUF-DEFN-ASSERTIONS" );
    $sym175$VALID_ASSERTION = makeSymbol( "VALID-ASSERTION" );
    $sym176$_ = makeSymbol( ">" );
    $sym177$ARG1_SPEC_CARDINALITY = makeSymbol( "ARG1-SPEC-CARDINALITY" );
    $list178 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "defnIff" ) ), constant_handles.reader_make_constant_shell( makeString( "defnSufficient" ) ) );
    $str179$Initializing_sufficient_defns_cac = makeString( "Initializing sufficient defns cache..." );
    $sym180$ADD_SUF_QUOTED_DEFN = makeSymbol( "ADD-SUF-QUOTED-DEFN" );
    $sym181$ADD_IFF_QUOTED_DEFN = makeSymbol( "ADD-IFF-QUOTED-DEFN" );
    $str182$skip_quoted_defn_op = makeString( "skip quoted defn op" );
    $sym183$OLD_ADD_SUF_QUOTED_DEFN = makeSymbol( "OLD-ADD-SUF-QUOTED-DEFN" );
    $sym184$REMOVE_SUF_QUOTED_DEFN = makeSymbol( "REMOVE-SUF-QUOTED-DEFN" );
    $sym185$REMOVE_IFF_QUOTED_DEFN = makeSymbol( "REMOVE-IFF-QUOTED-DEFN" );
    $sym186$OLD_REMOVE_SUF_QUOTED_DEFN = makeSymbol( "OLD-REMOVE-SUF-QUOTED-DEFN" );
    $sym187$_CACHE_SUF_QUOTED_DEFN_METERS_ = makeSymbol( "*CACHE-SUF-QUOTED-DEFN-METERS*" );
    $sym188$CACHE_SUF_QUOTED_DEFN = makeSymbol( "CACHE-SUF-QUOTED-DEFN" );
    $sym189$RESET_CACHE_SUF_QUOTED_DEFN_METERS = makeSymbol( "RESET-CACHE-SUF-QUOTED-DEFN-METERS" );
    $sym190$_UNCACHE_SUF_QUOTED_DEFN_METERS_ = makeSymbol( "*UNCACHE-SUF-QUOTED-DEFN-METERS*" );
    $sym191$UNCACHE_SUF_QUOTED_DEFN = makeSymbol( "UNCACHE-SUF-QUOTED-DEFN" );
    $sym192$RESET_UNCACHE_SUF_QUOTED_DEFN_METERS = makeSymbol( "RESET-UNCACHE-SUF-QUOTED-DEFN-METERS" );
    $str193$___add_sufficent_quoted_defn__a__ = makeString( "~%(add-sufficent-quoted-defn ~a ~a)" );
    $str194$removed_sufficient_quoted_defn_no = makeString( "removed sufficient quoted defn not found in cache: ~s" );
    $str195$___remove_sufficent_quoted_defn__ = makeString( "~%(remove-sufficent-quoted-defn ~a ~a)" );
    $sym196$_OLD_HANDLE_ADDED_GENL_FOR_SUF_QUOTED_DEFNS_METERS_ = makeSymbol( "*OLD-HANDLE-ADDED-GENL-FOR-SUF-QUOTED-DEFNS-METERS*" );
    $sym197$OLD_HANDLE_ADDED_GENL_FOR_SUF_QUOTED_DEFNS = makeSymbol( "OLD-HANDLE-ADDED-GENL-FOR-SUF-QUOTED-DEFNS" );
    $sym198$RESET_OLD_HANDLE_ADDED_GENL_FOR_SUF_QUOTED_DEFNS_METERS = makeSymbol( "RESET-OLD-HANDLE-ADDED-GENL-FOR-SUF-QUOTED-DEFNS-METERS" );
    $sym199$_OLD_HANDLE_REMOVED_GENL_FOR_SUF_QUOTED_DEFNS_METERS_ = makeSymbol( "*OLD-HANDLE-REMOVED-GENL-FOR-SUF-QUOTED-DEFNS-METERS*" );
    $sym200$OLD_HANDLE_REMOVED_GENL_FOR_SUF_QUOTED_DEFNS = makeSymbol( "OLD-HANDLE-REMOVED-GENL-FOR-SUF-QUOTED-DEFNS" );
    $sym201$RESET_OLD_HANDLE_REMOVED_GENL_FOR_SUF_QUOTED_DEFNS_METERS = makeSymbol( "RESET-OLD-HANDLE-REMOVED-GENL-FOR-SUF-QUOTED-DEFNS-METERS" );
    $sym202$ADD_SUF_QUOTED_DEFN_ASSERTION = makeSymbol( "ADD-SUF-QUOTED-DEFN-ASSERTION" );
    $sym203$REMOVE_SUF_QUOTED_DEFN_ASSERTION = makeSymbol( "REMOVE-SUF-QUOTED-DEFN-ASSERTION" );
    $sym204$MERGE_SUF_QUOTED_DEFN_ASSERTIONS = makeSymbol( "MERGE-SUF-QUOTED-DEFN-ASSERTIONS" );
    $sym205$REMOVE_SUF_QUOTED_DEFN_ASSERTIONS = makeSymbol( "REMOVE-SUF-QUOTED-DEFN-ASSERTIONS" );
    $list206 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "quotedDefnIff" ) ), constant_handles.reader_make_constant_shell( makeString( "quotedDefnSufficient" ) ) );
    $str207$Initializing_sufficient_quoted_de = makeString( "Initializing sufficient quoted defns cache..." );
    $kw208$QUOTED_ISA = makeKeyword( "QUOTED-ISA" );
    $sym209$ADD_SUF_FUNCTION = makeSymbol( "ADD-SUF-FUNCTION" );
    $sym210$REMOVE_SUF_FUNCTION = makeSymbol( "REMOVE-SUF-FUNCTION" );
    $sym211$ADD_SUF_QUOTED_FUNCTION = makeSymbol( "ADD-SUF-QUOTED-FUNCTION" );
    $sym212$REMOVE_SUF_QUOTED_FUNCTION = makeSymbol( "REMOVE-SUF-QUOTED-FUNCTION" );
    $const213$evaluationResultQuotedIsa = constant_handles.reader_make_constant_shell( makeString( "evaluationResultQuotedIsa" ) );
    $str214$oh_well___ = makeString( "oh well..." );
    $str215$_s_is_not_a_evaluatable_functor_i = makeString( "~s is not a evaluatable functor in ~s" );
    $str216$_s_is_not_a_functor_in__s = makeString( "~s is not a functor in ~s" );
    $sym217$ADD_SUF_FUNCTION_INT = makeSymbol( "ADD-SUF-FUNCTION-INT" );
    $sym218$REMOVE_SUF_FUNCTION_INT = makeSymbol( "REMOVE-SUF-FUNCTION-INT" );
    $sym219$_CACHE_SUF_FUNCTION_METERS_ = makeSymbol( "*CACHE-SUF-FUNCTION-METERS*" );
    $list220 = ConsesLow.list( makeSymbol( "COL" ), makeSymbol( "ASSERTION" ), makeSymbol( "TYPE" ) );
    $sym221$CACHE_SUF_FUNCTION = makeSymbol( "CACHE-SUF-FUNCTION" );
    $sym222$RESET_CACHE_SUF_FUNCTION_METERS = makeSymbol( "RESET-CACHE-SUF-FUNCTION-METERS" );
    $sym223$_UNCACHE_SUF_FUNCTION_METERS_ = makeSymbol( "*UNCACHE-SUF-FUNCTION-METERS*" );
    $sym224$UNCACHE_SUF_FUNCTION = makeSymbol( "UNCACHE-SUF-FUNCTION" );
    $sym225$RESET_UNCACHE_SUF_FUNCTION_METERS = makeSymbol( "RESET-UNCACHE-SUF-FUNCTION-METERS" );
    $str226$____a__a__a_ = makeString( "~%(~a ~a ~a)" );
    $str227$add_sufficient_function = makeString( "add-sufficient-function" );
    $str228$add_sufficient_quoted_function = makeString( "add-sufficient-quoted-function" );
    $str229$removed_sufficient_function_not_f = makeString( "removed sufficient function not found in cache: ~s" );
    $str230$remove_sufficient_function = makeString( "remove-sufficient-function" );
    $str231$remove_sufficient_quoted_function = makeString( "remove-sufficient-quoted-function" );
    $sym232$_HANDLE_ADDED_GENL_FOR_SUF_FUNCTIONS_METERS_ = makeSymbol( "*HANDLE-ADDED-GENL-FOR-SUF-FUNCTIONS-METERS*" );
    $sym233$HANDLE_ADDED_GENL_FOR_SUF_FUNCTIONS = makeSymbol( "HANDLE-ADDED-GENL-FOR-SUF-FUNCTIONS" );
    $sym234$RESET_HANDLE_ADDED_GENL_FOR_SUF_FUNCTIONS_METERS = makeSymbol( "RESET-HANDLE-ADDED-GENL-FOR-SUF-FUNCTIONS-METERS" );
    $list235 = ConsesLow.list( makeKeyword( "ISA" ), makeKeyword( "QUOTED-ISA" ) );
    $sym236$_HANDLE_REMOVED_GENL_FOR_SUF_FUNCTIONS_METERS_ = makeSymbol( "*HANDLE-REMOVED-GENL-FOR-SUF-FUNCTIONS-METERS*" );
    $sym237$HANDLE_REMOVED_GENL_FOR_SUF_FUNCTIONS = makeSymbol( "HANDLE-REMOVED-GENL-FOR-SUF-FUNCTIONS" );
    $sym238$RESET_HANDLE_REMOVED_GENL_FOR_SUF_FUNCTIONS_METERS = makeSymbol( "RESET-HANDLE-REMOVED-GENL-FOR-SUF-FUNCTIONS-METERS" );
    $sym239$ADD_SUF_FUNCTION_ASSERTION = makeSymbol( "ADD-SUF-FUNCTION-ASSERTION" );
    $sym240$ADD_SUF_QUOTED_FUNCTION_ASSERTION = makeSymbol( "ADD-SUF-QUOTED-FUNCTION-ASSERTION" );
    $sym241$REMOVE_SUF_FUNCTION_ASSERTION = makeSymbol( "REMOVE-SUF-FUNCTION-ASSERTION" );
    $sym242$REMOVE_SUF_QUOTED_FUNCTION_ASSERTION = makeSymbol( "REMOVE-SUF-QUOTED-FUNCTION-ASSERTION" );
    $sym243$MERGE_SUF_FUNCTION_ASSERTIONS = makeSymbol( "MERGE-SUF-FUNCTION-ASSERTIONS" );
    $sym244$MERGE_SUF_QUOTED_FUNCTION_ASSERTIONS = makeSymbol( "MERGE-SUF-QUOTED-FUNCTION-ASSERTIONS" );
    $sym245$REMOVE_SUF_FUNCTION_ASSERTIONS = makeSymbol( "REMOVE-SUF-FUNCTION-ASSERTIONS" );
    $sym246$REMOVE_SUF_QUOTED_FUNCTION_ASSERTIONS = makeSymbol( "REMOVE-SUF-QUOTED-FUNCTION-ASSERTIONS" );
    $str247$___add_sufficent_function__a__a_ = makeString( "~%(add-sufficent-function ~a ~a)" );
    $str248$remove_sufficent_function = makeString( "remove-sufficent-function" );
    $sym249$SUF_FUNCTION_SORT_PRED = makeSymbol( "SUF-FUNCTION-SORT-PRED" );
    $sym250$GAF_ARG2 = makeSymbol( "GAF-ARG2" );
    $list251 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "resultIsa" ) ) );
    $list252 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "evaluationResultQuotedIsa" ) ), constant_handles.reader_make_constant_shell( makeString( "resultQuotedIsa" ) ) );
    $str253$Initializing_sufficient_functions = makeString( "Initializing sufficient functions cache..." );
    $str254$Initializing_sufficient_quoted_fu = makeString( "Initializing sufficient quoted functions cache..." );
    $str255$cdohash = makeString( "cdohash" );
    $str256$stop = makeString( "stop" );
    $kw257$MAPPING_DONE = makeKeyword( "MAPPING-DONE" );
    $str258$diagnostics__sufficient_functions = makeString( "diagnostics: sufficient-functions-cache" );
    $str259$___suf_function_cache_mal_keys___ = makeString( "~%*suf-function-cache-mal-keys* : ~a" );
    $str260$___suf_function_cache_key_w_o_val = makeString( "~%*suf-function-cache-key-w/o-value* : ~a" );
    $str261$___suf_function_cache_key_w_mal_v = makeString( "~%*suf-function-cache-key-w/mal-value* : ~a" );
    $str262$___suf_function_cache_key_w_stale = makeString( "~%*suf-function-cache-key-w/stale-value* : ~a" );
    $str263$___suf_function_cache_keys_w_o_in = makeString( "~%*suf-function-cache-keys-w/o-inerited-value* : ~a" );
    $str264$___suf_function_cache_awol_direct = makeString( "~%*suf-function-cache-awol-direct-assertions* : ~a" );
    $const265$SkolemFunction = constant_handles.reader_make_constant_shell( makeString( "SkolemFunction" ) );
    $str266$mapping_skolems = makeString( "mapping skolems" );
    $str267$cdolist = makeString( "cdolist" );
    $str268$_a_ = makeString( "~a " );
  }
}
/*
 * 
