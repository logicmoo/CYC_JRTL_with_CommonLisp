...
public final class pph_data_structures extends SubLTranslatedFile
{
    ...
    public static SubLObject init_pph_data_structures_file() {
        ...
        pph_data_structures.$gen_template_store$ = SubLFiles.deflexical("*GEN-TEMPLATE-STORE*", maybeDefault((SubLObject)pph_data_structures.$sym2$_GEN_TEMPLATE_STORE_, pph_data_structures.$gen_template_store$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)pph_data_structures.EQ), pph_data_structures.$relation_cardinality$.getGlobalValue()))));
        pph_data_structures.$gen_template_store_initializedP$ = SubLFiles.deflexical("*GEN-TEMPLATE-STORE-INITIALIZED?*", (SubLObject)(maybeDefault((SubLObject)pph_data_structures.$sym3$_GEN_TEMPLATE_STORE_INITIALIZED__, pph_data_structures.$gen_template_store_initializedP$, pph_data_structures.NIL)));
        ...
        pph_data_structures.$pph_phrase_id_index$ = SubLFiles.deflexical("*PPH-PHRASE-ID-INDEX*", maybeDefault((SubLObject)pph_data_structures.$sym159$_PPH_PHRASE_ID_INDEX_, pph_data_structures.$pph_phrase_id_index$, ()->(id_index.new_id_index((SubLObject)pph_data_structures.UNPROVIDED, (SubLObject)pph_data_structures.UNPROVIDED))));
        ...
        pph_data_structures.$free_pph_phrase_template_generators$ = SubLFiles.deflexical("*FREE-PPH-PHRASE-TEMPLATE-GENERATORS*", maybeDefault((SubLObject)pph_data_structures.$sym236$_FREE_PPH_PHRASE_TEMPLATE_GENERATORS_, pph_data_structures.$free_pph_phrase_template_generators$, ()->(queues.create_queue((SubLObject)pph_data_structures.UNPROVIDED))));
