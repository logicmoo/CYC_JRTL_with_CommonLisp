...
public final class rtp_datastructures extends SubLTranslatedFile
{
    ...
    public static SubLObject init_rtp_datastructures_file() {
        ...
        rtp_datastructures.$template_meta_marker_mappings$ = SubLFiles.deflexical("*TEMPLATE-META-MARKER-MAPPINGS*", (rtp_datastructures.NIL != Symbols.boundp((SubLObject)rtp_datastructures.$sym0$_TEMPLATE_META_MARKER_MAPPINGS_)) ? rtp_datastructures.$template_meta_marker_mappings$.getGlobalValue() : dictionary.new_dictionary((SubLObject)rtp_datastructures.UNPROVIDED, (SubLObject)rtp_datastructures.UNPROVIDED));
        ...
        rtp_datastructures.$template_category_fill_words$ = SubLFiles.deflexical("*TEMPLATE-CATEGORY-FILL-WORDS*", (rtp_datastructures.NIL != Symbols.boundp((SubLObject)rtp_datastructures.$sym6$_TEMPLATE_CATEGORY_FILL_WORDS_)) ? rtp_datastructures.$template_category_fill_words$.getGlobalValue() : dictionary.new_dictionary((SubLObject)rtp_datastructures.UNPROVIDED, (SubLObject)rtp_datastructures.UNPROVIDED));
        ...
        rtp_datastructures.$use_better_template_rule_sxhashP$ = SubLFiles.deflexical("*USE-BETTER-TEMPLATE-RULE-SXHASH?*", (SubLObject)((rtp_datastructures.NIL != Symbols.boundp((SubLObject)rtp_datastructures.$sym54$_USE_BETTER_TEMPLATE_RULE_SXHASH__)) ? rtp_datastructures.$use_better_template_rule_sxhashP$.getGlobalValue() : rtp_datastructures.NIL));
        ...
        rtp_datastructures.$template_rule_isg$ = SubLFiles.deflexical("*TEMPLATE-RULE-ISG*", (rtp_datastructures.NIL != Symbols.boundp((SubLObject)rtp_datastructures.$sym62$_TEMPLATE_RULE_ISG_)) ? rtp_datastructures.$template_rule_isg$.getGlobalValue() : integer_sequence_generator.new_integer_sequence_generator((SubLObject)rtp_datastructures.UNPROVIDED, (SubLObject)rtp_datastructures.UNPROVIDED, (SubLObject)rtp_datastructures.UNPROVIDED));
        ...
        rtp_datastructures.$rtp_rules$ = SubLFiles.deflexical("*RTP-RULES*", (SubLObject)((rtp_datastructures.NIL != Symbols.boundp((SubLObject)rtp_datastructures.$sym115$_RTP_RULES_)) ? rtp_datastructures.$rtp_rules$.getGlobalValue() : rtp_datastructures.NIL));
        ...
        rtp_datastructures.$template_rules_master_index$ = SubLFiles.deflexical("*TEMPLATE-RULES-MASTER-INDEX*", (SubLObject)((rtp_datastructures.NIL != Symbols.boundp((SubLObject)rtp_datastructures.$sym120$_TEMPLATE_RULES_MASTER_INDEX_)) ? rtp_datastructures.$template_rules_master_index$.getGlobalValue() : rtp_datastructures.NIL));
        ...
        rtp_datastructures.$template_mts$ = SubLFiles.deflexical("*TEMPLATE-MTS*", (SubLObject)((rtp_datastructures.NIL != Symbols.boundp((SubLObject)rtp_datastructures.$sym160$_TEMPLATE_MTS_)) ? rtp_datastructures.$template_mts$.getGlobalValue() : rtp_datastructures.NIL));
