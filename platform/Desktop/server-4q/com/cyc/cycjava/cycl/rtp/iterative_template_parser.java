...
public final class iterative_template_parser extends SubLTranslatedFile
{
    ...
    public static SubLObject init_iterative_template_parser_file() {
        ...
        iterative_template_parser.$rtp_component_tokenizations$ = SubLFiles.deflexical("*RTP-COMPONENT-TOKENIZATIONS*", (iterative_template_parser.NIL != Symbols.boundp((SubLObject)iterative_template_parser.$sym102$_RTP_COMPONENT_TOKENIZATIONS_)) ? iterative_template_parser.$rtp_component_tokenizations$.getGlobalValue() : dictionary.new_dictionary((SubLObject)iterative_template_parser.EQUAL, (SubLObject)iterative_template_parser.UNPROVIDED));
