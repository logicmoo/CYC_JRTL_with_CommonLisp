...
public final class rtp_constituent_weeders extends SubLTranslatedFile
{
    ...
    public static SubLObject init_rtp_constituent_weeders_file() {
        ...
        rtp_constituent_weeders.$cat_prior$ = SubLFiles.deflexical("*CAT-PRIOR*", (SubLObject)(maybeDefault((SubLObject)rtp_constituent_weeders.$sym9$_CAT_PRIOR_, rtp_constituent_weeders.$cat_prior$, rtp_constituent_weeders.NIL)));
        rtp_constituent_weeders.$tag1_cond_cat$ = SubLFiles.deflexical("*TAG1-COND-CAT*", (SubLObject)(maybeDefault((SubLObject)rtp_constituent_weeders.$sym10$_TAG1_COND_CAT_, rtp_constituent_weeders.$tag1_cond_cat$, rtp_constituent_weeders.NIL)));
        rtp_constituent_weeders.$tag2_cond_cat_tag1$ = SubLFiles.deflexical("*TAG2-COND-CAT-TAG1*", (SubLObject)(maybeDefault((SubLObject)rtp_constituent_weeders.$sym11$_TAG2_COND_CAT_TAG1_, rtp_constituent_weeders.$tag2_cond_cat_tag1$, rtp_constituent_weeders.NIL)));
        rtp_constituent_weeders.$tag3_cond_cat_tag12$ = SubLFiles.deflexical("*TAG3-COND-CAT-TAG12*", (SubLObject)(maybeDefault((SubLObject)rtp_constituent_weeders.$sym12$_TAG3_COND_CAT_TAG12_, rtp_constituent_weeders.$tag3_cond_cat_tag12$, rtp_constituent_weeders.NIL)));
        rtp_constituent_weeders.$tag_cond_tag$ = SubLFiles.deflexical("*TAG-COND-TAG*", (SubLObject)(maybeDefault((SubLObject)rtp_constituent_weeders.$sym13$_TAG_COND_TAG_, rtp_constituent_weeders.$tag_cond_tag$, rtp_constituent_weeders.NIL)));
        rtp_constituent_weeders.$cat_cond_last_tag$ = SubLFiles.deflexical("*CAT-COND-LAST-TAG*", (SubLObject)(maybeDefault((SubLObject)rtp_constituent_weeders.$sym14$_CAT_COND_LAST_TAG_, rtp_constituent_weeders.$cat_cond_last_tag$, rtp_constituent_weeders.NIL)));
        rtp_constituent_weeders.$tagger$ = SubLFiles.deflexical("*TAGGER*", (SubLObject)(maybeDefault((SubLObject)rtp_constituent_weeders.$sym15$_TAGGER_, rtp_constituent_weeders.$tagger$, rtp_constituent_weeders.NIL)));
        ...
        rtp_constituent_weeders.$quantity_strings$ = SubLFiles.deflexical("*QUANTITY-STRINGS*", (SubLObject)(maybeDefault((SubLObject)rtp_constituent_weeders.$sym81$_QUANTITY_STRINGS_, rtp_constituent_weeders.$quantity_strings$, rtp_constituent_weeders.NIL)));
