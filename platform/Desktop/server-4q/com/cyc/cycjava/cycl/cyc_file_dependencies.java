...
public final class cyc_file_dependencies extends SubLTranslatedFile
{
    ...
    public static SubLObject init_cyc_file_dependencies_file() {
        cyc_file_dependencies.$external_file_definitions$ = SubLFiles.deflexical("*EXTERNAL-FILE-DEFINITIONS*", (cyc_file_dependencies.NIL != Symbols.boundp((SubLObject)cyc_file_dependencies.$sym0$_EXTERNAL_FILE_DEFINITIONS_)) ? cyc_file_dependencies.$external_file_definitions$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)cyc_file_dependencies.$int1$64, (SubLObject)cyc_file_dependencies.UNPROVIDED, (SubLObject)cyc_file_dependencies.UNPROVIDED));
        ...
        cyc_file_dependencies.$html_icon_definitions$ = SubLFiles.deflexical("*HTML-ICON-DEFINITIONS*", (cyc_file_dependencies.NIL != Symbols.boundp((SubLObject)cyc_file_dependencies.$sym49$_HTML_ICON_DEFINITIONS_)) ? cyc_file_dependencies.$html_icon_definitions$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)cyc_file_dependencies.$int50$32, (SubLObject)cyc_file_dependencies.UNPROVIDED, (SubLObject)cyc_file_dependencies.UNPROVIDED));
        ...
        cyc_file_dependencies.$cb_help_definitions$ = SubLFiles.deflexical("*CB-HELP-DEFINITIONS*", (cyc_file_dependencies.NIL != Symbols.boundp((SubLObject)cyc_file_dependencies.$sym79$_CB_HELP_DEFINITIONS_)) ? cyc_file_dependencies.$cb_help_definitions$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)cyc_file_dependencies.$int50$32, (SubLObject)cyc_file_dependencies.UNPROVIDED, (SubLObject)cyc_file_dependencies.UNPROVIDED));
        ...
        cyc_file_dependencies.$cb_icon_definitions$ = SubLFiles.deflexical("*CB-ICON-DEFINITIONS*", (cyc_file_dependencies.NIL != Symbols.boundp((SubLObject)cyc_file_dependencies.$sym83$_CB_ICON_DEFINITIONS_)) ? cyc_file_dependencies.$cb_icon_definitions$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)cyc_file_dependencies.$int50$32, (SubLObject)cyc_file_dependencies.UNPROVIDED, (SubLObject)cyc_file_dependencies.UNPROVIDED));
