...
public final class somewhere_cache extends SubLTranslatedFile
{
    ...
    public static SubLObject init_somewhere_cache_file() {
        ...
        somewhere_cache.$some_pred_assertion_somewhere_cache$ = SubLFiles.deflexical("*SOME-PRED-ASSERTION-SOMEWHERE-CACHE*", (SubLObject)((somewhere_cache.NIL != Symbols.boundp((SubLObject)somewhere_cache.$sym30$_SOME_PRED_ASSERTION_SOMEWHERE_CACHE_)) ? somewhere_cache.$some_pred_assertion_somewhere_cache$.getGlobalValue() : somewhere_cache.$kw31$UNINITIALIZED));
        somewhere_cache.$somewhere_cached_pred_argnum_dict$ = SubLFiles.deflexical("*SOMEWHERE-CACHED-PRED-ARGNUM-DICT*", (SubLObject)((somewhere_cache.NIL != Symbols.boundp((SubLObject)somewhere_cache.$sym32$_SOMEWHERE_CACHED_PRED_ARGNUM_DICT_)) ? somewhere_cache.$somewhere_cached_pred_argnum_dict$.getGlobalValue() : somewhere_cache.$kw31$UNINITIALIZED));
        ...
        somewhere_cache.$inter_arg_result_isa_somewhere_cache$ = SubLFiles.deflexical("*INTER-ARG-RESULT-ISA-SOMEWHERE-CACHE*", (somewhere_cache.NIL != Symbols.boundp((SubLObject)somewhere_cache.$sym44$_INTER_ARG_RESULT_ISA_SOMEWHERE_CACHE_)) ? somewhere_cache.$inter_arg_result_isa_somewhere_cache$.getGlobalValue() : misc_utilities.uninitialized());
        return (SubLObject)somewhere_cache.NIL;
    }
