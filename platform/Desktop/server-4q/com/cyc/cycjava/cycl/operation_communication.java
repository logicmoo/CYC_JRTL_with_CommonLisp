...
public final class operation_communication extends SubLTranslatedFile
{
    ...
    public static SubLObject init_operation_communication_file() {
        ...
        operation_communication.$allow_transmitting$ = SubLFiles.deflexical("*ALLOW-TRANSMITTING*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym14$_ALLOW_TRANSMITTING_, operation_communication.$allow_transmitting$, operation_communication.T)));
        operation_communication.$kb_full_transcript_loaded$ = SubLFiles.deflexical("*KB-FULL-TRANSCRIPT-LOADED*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym15$_KB_FULL_TRANSCRIPT_LOADED_, operation_communication.$kb_full_transcript_loaded$, operation_communication.NIL)));
        ...
        operation_communication.$receiving_remote_operationsP$ = SubLFiles.deflexical("*RECEIVING-REMOTE-OPERATIONS?*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym20$_RECEIVING_REMOTE_OPERATIONS__, operation_communication.$receiving_remote_operationsP$, operation_communication.T)));
        operation_communication.$process_local_operationsP$ = SubLFiles.deflexical("*PROCESS-LOCAL-OPERATIONS?*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym21$_PROCESS_LOCAL_OPERATIONS__, operation_communication.$process_local_operationsP$, operation_communication.T)));
        operation_communication.$process_auxiliary_operationsP$ = SubLFiles.deflexical("*PROCESS-AUXILIARY-OPERATIONS?*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym22$_PROCESS_AUXILIARY_OPERATIONS__, operation_communication.$process_auxiliary_operationsP$, operation_communication.T)));
        operation_communication.$total_remote_operations_run$ = SubLFiles.deflexical("*TOTAL-REMOTE-OPERATIONS-RUN*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym23$_TOTAL_REMOTE_OPERATIONS_RUN_, operation_communication.$total_remote_operations_run$, operation_communication.ZERO_INTEGER)));
        operation_communication.$total_auxiliary_operations_run$ = SubLFiles.deflexical("*TOTAL-AUXILIARY-OPERATIONS-RUN*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym24$_TOTAL_AUXILIARY_OPERATIONS_RUN_, operation_communication.$total_auxiliary_operations_run$, operation_communication.ZERO_INTEGER)));
        operation_communication.$total_local_operations_recorded$ = SubLFiles.deflexical("*TOTAL-LOCAL-OPERATIONS-RECORDED*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym25$_TOTAL_LOCAL_OPERATIONS_RECORDED_, operation_communication.$total_local_operations_recorded$, operation_communication.ZERO_INTEGER)));
        operation_communication.$total_local_operations_transmitted$ = SubLFiles.deflexical("*TOTAL-LOCAL-OPERATIONS-TRANSMITTED*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym26$_TOTAL_LOCAL_OPERATIONS_TRANSMITTED_, operation_communication.$total_local_operations_transmitted$, operation_communication.ZERO_INTEGER)));
        operation_communication.$read_master_transcript_op_number$ = SubLFiles.deflexical("*READ-MASTER-TRANSCRIPT-OP-NUMBER*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym27$_READ_MASTER_TRANSCRIPT_OP_NUMBER_, operation_communication.$read_master_transcript_op_number$, operation_communication.ZERO_INTEGER)));
        operation_communication.$total_master_transcript_operations_processed$ = SubLFiles.deflexical("*TOTAL-MASTER-TRANSCRIPT-OPERATIONS-PROCESSED*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym28$_TOTAL_MASTER_TRANSCRIPT_OPERATIONS_PROCESSED_, operation_communication.$total_master_transcript_operations_processed$, operation_communication.ZERO_INTEGER)));
        ...
        operation_communication.$transcript_read_attempted$ = SubLFiles.deflexical("*TRANSCRIPT-READ-ATTEMPTED*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym103$_TRANSCRIPT_READ_ATTEMPTED_, operation_communication.$transcript_read_attempted$, operation_communication.NIL)));
        operation_communication.$initial_read_transcript_size$ = SubLFiles.deflexical("*INITIAL-READ-TRANSCRIPT-SIZE*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym104$_INITIAL_READ_TRANSCRIPT_SIZE_, operation_communication.$initial_read_transcript_size$, operation_communication.ZERO_INTEGER)));
        ...
        operation_communication.$remote_operations_kb_check_point$ = SubLFiles.deflexical("*REMOTE-OPERATIONS-KB-CHECK-POINT*", (SubLObject)(maybeDefault((SubLObject)operation_communication.$sym239$_REMOTE_OPERATIONS_KB_CHECK_POINT_, operation_communication.$remote_operations_kb_check_point$, operation_communication.NIL)));
        return (SubLObject)operation_communication.NIL;
    }
