...
public final class lexification_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_lexification_utilities_file() {
        ...
        lexification_utilities.$lexification_check_max_days$ = SubLFiles.deflexical("*LEXIFICATION-CHECK-MAX-DAYS*", (SubLObject)(maybeDefault((SubLObject)lexification_utilities.$sym0$_LEXIFICATION_CHECK_MAX_DAYS_, lexification_utilities.$lexification_check_max_days$, lexification_utilities.$int1$30)));
        ...
        lexification_utilities.$num_predicate_examples$ = SubLFiles.deflexical("*NUM-PREDICATE-EXAMPLES*", (SubLObject)(maybeDefault((SubLObject)lexification_utilities.$sym4$_NUM_PREDICATE_EXAMPLES_, lexification_utilities.$num_predicate_examples$, lexification_utilities.THREE_INTEGER)));
