...
public final class sksi_hl_support_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sksi_hl_support_utilities_file() {
        ...
        sksi_hl_support_utilities.$schema_object_fn_identity_rule$ = SubLFiles.deflexical("*SCHEMA-OBJECT-FN-IDENTITY-RULE*", (SubLObject)((sksi_hl_support_utilities.NIL != Symbols.boundp((SubLObject)sksi_hl_support_utilities.$sym9$_SCHEMA_OBJECT_FN_IDENTITY_RULE_)) ? sksi_hl_support_utilities.$schema_object_fn_identity_rule$.getGlobalValue() : sksi_hl_support_utilities.$list10));
        sksi_hl_support_utilities.$source_schema_object_fn_identity_rule$ = SubLFiles.deflexical("*SOURCE-SCHEMA-OBJECT-FN-IDENTITY-RULE*", (SubLObject)((sksi_hl_support_utilities.NIL != Symbols.boundp((SubLObject)sksi_hl_support_utilities.$sym11$_SOURCE_SCHEMA_OBJECT_FN_IDENTITY_RULE_)) ? sksi_hl_support_utilities.$source_schema_object_fn_identity_rule$.getGlobalValue() : sksi_hl_support_utilities.$list12));
        sksi_hl_support_utilities.$schema_object_id_fn_sks_code_mapping_rule$ = SubLFiles.deflexical("*SCHEMA-OBJECT-ID-FN-SKS-CODE-MAPPING-RULE*", (SubLObject)((sksi_hl_support_utilities.NIL != Symbols.boundp((SubLObject)sksi_hl_support_utilities.$sym13$_SCHEMA_OBJECT_ID_FN_SKS_CODE_MAPPING_RULE_)) ? sksi_hl_support_utilities.$schema_object_id_fn_sks_code_mapping_rule$.getGlobalValue() : sksi_hl_support_utilities.$list14));
        sksi_hl_support_utilities.$source_schema_object_id_fn_sks_code_mapping_rule$ = SubLFiles.deflexical("*SOURCE-SCHEMA-OBJECT-ID-FN-SKS-CODE-MAPPING-RULE*", (SubLObject)((sksi_hl_support_utilities.NIL != Symbols.boundp((SubLObject)sksi_hl_support_utilities.$sym15$_SOURCE_SCHEMA_OBJECT_ID_FN_SKS_CODE_MAPPING_RULE_)) ? sksi_hl_support_utilities.$source_schema_object_id_fn_sks_code_mapping_rule$.getGlobalValue() : sksi_hl_support_utilities.$list16));
