...
public final class sksi_tva_utilities
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject sksi_pred_and_relevance_p(final SubLObject predicate)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym0$SKSI_PRED_AND_RELEVANCE_P, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym0$SKSI_PRED_AND_RELEVANCE_P, ONE_INTEGER, NIL, EQ, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym0$SKSI_PRED_AND_RELEVANCE_P, caching_state );
    }
    ...
    {
      results = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( sksi_pred_and_relevance_p_internal( predicate ) ) );
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return ( NIL != ghl_search_vars.$sksi_gt_search_pred$.getDynamicValue( thread ) ) ? ghl_link_iterators.gt_relevant_predP( pred, ghl_search_vars.$sksi_gt_search_pred$.getDynamicValue( thread ) )
        : pred_relevance_macros.relevant_predP( pred );
  }
  ...
  public static SubLObject sksi_record_all_backward_true_nodes(final SubLObject module, final SubLObject node, SubLObject mt, SubLObject tv)
  {
    ...
    final SubLObject backward_nodes = cdolist_list_var = sksi_sks_mapping_utilities.gather_sksi_gaf_arg_index_values( node, TWO_INTEGER, ONE_INTEGER, module, $kw1$TRUE );
  ...
  public static SubLObject sksi_record_all_forward_true_nodes(final SubLObject module, final SubLObject node, SubLObject mt, SubLObject tv)
  {
    ...
    SubLObject cdolist_list_var;
    final SubLObject forward_nodes = cdolist_list_var = sksi_sks_mapping_utilities.gather_sksi_gaf_arg_index_values( node, ONE_INTEGER, TWO_INTEGER, module, $kw1$TRUE );
  ...
  public static SubLObject sksi_inverse_cardinality(final SubLObject pred, final SubLObject node, SubLObject mt_info)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym2$SKSI_INVERSE_CARDINALITY, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym2$SKSI_INVERSE_CARDINALITY, THREE_INTEGER, NIL, EQ, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym2$SKSI_INVERSE_CARDINALITY, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( sksi_inverse_cardinality_internal( pred, node, mt_info ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( pred, node, mt_info ) );
  ...
  public static SubLObject sksi_predicate_cardinality(final SubLObject pred, final SubLObject node, SubLObject mt_info)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym3$SKSI_PREDICATE_CARDINALITY, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym3$SKSI_PREDICATE_CARDINALITY, THREE_INTEGER, NIL, EQ, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym3$SKSI_PREDICATE_CARDINALITY, caching_state );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_3( pred, node, mt_info );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    if( !collisions.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( sksi_predicate_cardinality_internal( pred, node, mt_info ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( pred, node, mt_info ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  {
    SubLFiles.declareFunction( me, "sksi_pred_and_relevance_p_internal", "SKSI-PRED-AND-RELEVANCE-P-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "sksi_pred_and_relevance_p", "SKSI-PRED-AND-RELEVANCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "sksi_gaf_arg_impossible_p", "SKSI-GAF-ARG-IMPOSSIBLE-P", 3, 0, false );
    SubLFiles.declareFunction( me, "sksi_gaf_arg_possible_p", "SKSI-GAF-ARG-POSSIBLE-P", 3, 0, false );
    SubLFiles.declareFunction( me, "sksi_transitivity_possibleP", "SKSI-TRANSITIVITY-POSSIBLE?", 0, 0, false );
    SubLFiles.declareFunction( me, "sksi_gt_relevant_predP", "SKSI-GT-RELEVANT-PRED?", 1, 0, false );
    SubLFiles.declareFunction( me, "sksi_record_all_backward_true_nodes", "SKSI-RECORD-ALL-BACKWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sksi_record_all_forward_true_nodes", "SKSI-RECORD-ALL-FORWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sksi_inverse_cardinality_internal", "SKSI-INVERSE-CARDINALITY-INTERNAL", 2, 1, false );
    SubLFiles.declareFunction( me, "sksi_inverse_cardinality", "SKSI-INVERSE-CARDINALITY", 2, 1, false );
    SubLFiles.declareFunction( me, "sksi_predicate_cardinality_internal", "SKSI-PREDICATE-CARDINALITY-INTERNAL", 2, 1, false );
    SubLFiles.declareFunction( me, "sksi_predicate_cardinality", "SKSI-PREDICATE-CARDINALITY", 2, 1, false );
    return NIL;
  }
  ...
  {
    memoization_state.note_memoized_function( $sym0$SKSI_PRED_AND_RELEVANCE_P );
    memoization_state.note_memoized_function( $sym2$SKSI_INVERSE_CARDINALITY );
    memoization_state.note_memoized_function( $sym3$SKSI_PREDICATE_CARDINALITY );
    return NIL;
  }
  ...
  static
  {
    me = new sksi_tva_utilities();
    $sym0$SKSI_PRED_AND_RELEVANCE_P = makeSymbol( "SKSI-PRED-AND-RELEVANCE-P" );
    $kw1$TRUE = makeKeyword( "TRUE" );
    $sym2$SKSI_INVERSE_CARDINALITY = makeSymbol( "SKSI-INVERSE-CARDINALITY" );
    $sym3$SKSI_PREDICATE_CARDINALITY = makeSymbol( "SKSI-PREDICATE-CARDINALITY" );
  }
}
/*
 * 
