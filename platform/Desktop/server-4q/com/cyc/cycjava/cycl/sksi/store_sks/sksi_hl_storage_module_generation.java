...
public final class sksi_hl_storage_module_generation extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sksi_hl_storage_module_generation_file() {
        sksi_hl_storage_module_generation.$sksi_hl_storage_modules$ = SubLFiles.deflexical("*SKSI-HL-STORAGE-MODULES*", (sksi_hl_storage_module_generation.NIL != Symbols.boundp((SubLObject)sksi_hl_storage_module_generation.$sym0$_SKSI_HL_STORAGE_MODULES_)) ? sksi_hl_storage_module_generation.$sksi_hl_storage_modules$.getGlobalValue() : set.new_set((SubLObject)sksi_hl_storage_module_generation.UNPROVIDED, (SubLObject)sksi_hl_storage_module_generation.UNPROVIDED));
        sksi_hl_storage_module_generation.$sksi_hl_storage_modules_by_sks$ = SubLFiles.deflexical("*SKSI-HL-STORAGE-MODULES-BY-SKS*", (sksi_hl_storage_module_generation.NIL != Symbols.boundp((SubLObject)sksi_hl_storage_module_generation.$sym6$_SKSI_HL_STORAGE_MODULES_BY_SKS_)) ? sksi_hl_storage_module_generation.$sksi_hl_storage_modules_by_sks$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sksi_hl_storage_module_generation.EQ), (SubLObject)sksi_hl_storage_module_generation.UNPROVIDED));
