...
public final class sksi_sks_manager extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sksi_sks_manager_file() {
        ...
        sksi_sks_manager.$sksi_removal_modules_registered_knowledge_sources$ = SubLFiles.deflexical("*SKSI-REMOVAL-MODULES-REGISTERED-KNOWLEDGE-SOURCES*", (SubLObject)(maybeDefault((SubLObject)sksi_sks_manager.$sym11$_SKSI_REMOVAL_MODULES_REGISTERED_KNOWLEDGE_SOURCES_, sksi_sks_manager.$sksi_removal_modules_registered_knowledge_sources$, sksi_sks_manager.NIL)));
        sksi_sks_manager.$sksi_content_mts_with_registered_removal_module$ = SubLFiles.deflexical("*SKSI-CONTENT-MTS-WITH-REGISTERED-REMOVAL-MODULE*", (SubLObject)(maybeDefault((SubLObject)sksi_sks_manager.$sym14$_SKSI_CONTENT_MTS_WITH_REGISTERED_REMOVAL_MODULE_, sksi_sks_manager.$sksi_content_mts_with_registered_removal_module$, sksi_sks_manager.NIL)));
        sksi_sks_manager.$sksi_storage_modules_registered_knowledge_sources$ = SubLFiles.deflexical("*SKSI-STORAGE-MODULES-REGISTERED-KNOWLEDGE-SOURCES*", (SubLObject)(maybeDefault((SubLObject)sksi_sks_manager.$sym23$_SKSI_STORAGE_MODULES_REGISTERED_KNOWLEDGE_SOURCES_, sksi_sks_manager.$sksi_storage_modules_registered_knowledge_sources$, sksi_sks_manager.NIL)));
        sksi_sks_manager.$sksi_content_mts_with_registered_storage_module$ = SubLFiles.deflexical("*SKSI-CONTENT-MTS-WITH-REGISTERED-STORAGE-MODULE*", (SubLObject)(maybeDefault((SubLObject)sksi_sks_manager.$sym24$_SKSI_CONTENT_MTS_WITH_REGISTERED_STORAGE_MODULE_, sksi_sks_manager.$sksi_content_mts_with_registered_storage_module$, sksi_sks_manager.NIL)));
        sksi_sks_manager.$sksi_expanded_knowledge_sources$ = SubLFiles.deflexical("*SKSI-EXPANDED-KNOWLEDGE-SOURCES*", (SubLObject)(maybeDefault((SubLObject)sksi_sks_manager.$sym29$_SKSI_EXPANDED_KNOWLEDGE_SOURCES_, sksi_sks_manager.$sksi_expanded_knowledge_sources$, sksi_sks_manager.NIL)));
