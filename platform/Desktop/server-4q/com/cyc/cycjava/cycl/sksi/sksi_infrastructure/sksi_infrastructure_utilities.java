...
public final class sksi_infrastructure_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sksi_infrastructure_utilities_file() {
        ...
        sksi_infrastructure_utilities.$sksi_non_thelogicalfieldvaluefn_lfi_fort_cache$ = SubLFiles.deflexical("*SKSI-NON-THELOGICALFIELDVALUEFN-LFI-FORT-CACHE*", maybeDefault((SubLObject)sksi_infrastructure_utilities.$sym2$_SKSI_NON_THELOGICALFIELDVALUEFN_LFI_FORT_CACHE_, sksi_infrastructure_utilities.$sksi_non_thelogicalfieldvaluefn_lfi_fort_cache$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sksi_infrastructure_utilities.EQ), (SubLObject)sksi_infrastructure_utilities.UNPROVIDED))));
        ...
        sksi_infrastructure_utilities.$external_sources_activated_in_image$ = SubLFiles.deflexical("*EXTERNAL-SOURCES-ACTIVATED-IN-IMAGE*", maybeDefault((SubLObject)sksi_infrastructure_utilities.$sym73$_EXTERNAL_SOURCES_ACTIVATED_IN_IMAGE_, sksi_infrastructure_utilities.$external_sources_activated_in_image$, ()->(set.new_set(Symbols.symbol_function((SubLObject)sksi_infrastructure_utilities.EQ), (SubLObject)sksi_infrastructure_utilities.UNPROVIDED))));
        return (SubLObject)sksi_infrastructure_utilities.NIL;
    }
