...
public final class sksi_csql_oracle_sparql_interpretation
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject csql_to_oracle_sparql(final SubLObject csql, final SubLObject access_path)
  {
    ...
    try
    {
      ...
      SubLObject from = NIL;
      cdestructuring_bind.destructuring_bind_must_consp( csql, csql, $list0 );
      select_keyword = csql.first();
      SubLObject current = csql.rest();
      cdestructuring_bind.destructuring_bind_must_consp( current, csql, $list0 );
      ...
      cdestructuring_bind.destructuring_bind_must_listp( current, csql, $list0 );
      current = current.rest();
      ...
      if( NIL == current )
      {
        ...
        final SubLObject was_appendingP = Eval.eval( $sym1$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__ );
        Eval.eval( $list2 );
        try
        {
          try
          {
            ...
            try
            {
              ...
              try
              {
                if( NIL == Errors.$ignore_mustsP$.getDynamicValue( thread ) && $kw4$SELECT != select_keyword )
                {
        ...
        finally
        {
          ...
          try
          {
            ...
            Eval.eval( ConsesLow.list( $sym6$CSETQ, $sym1$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__, was_appendingP ) );
        ...
        streams_high.write_string( $str8$SELECT_, stream, UNPROVIDED, UNPROVIDED );
        streams_high.write_string( fields_string, stream, UNPROVIDED, UNPROVIDED );
        streams_high.terpri( stream );
        streams_high.write_string( $str9$FROM_TABLE_SEM_MATCH_, stream, UNPROVIDED, UNPROVIDED );
        streams_high.terpri( stream );
        streams_high.write_string( $str10$__, stream, UNPROVIDED, UNPROVIDED );
        streams_high.terpri( stream );
        streams_high.write_string( where_string, stream, UNPROVIDED, UNPROVIDED );
        streams_high.write_string( $str11$___, stream, UNPROVIDED, UNPROVIDED );
        streams_high.terpri( stream );
        streams_high.write_string( $str12$SEM_MODELS__CCF___, stream, UNPROVIDED, UNPROVIDED );
        streams_high.terpri( stream );
        streams_high.write_string( $str13$null_, stream, UNPROVIDED, UNPROVIDED );
        streams_high.terpri( stream );
        streams_high.write_string( alias_string, stream, UNPROVIDED, UNPROVIDED );
        streams_high.write_string( $str14$_, stream, UNPROVIDED, UNPROVIDED );
        streams_high.terpri( stream );
        streams_high.write_string( $str15$null___, stream, UNPROVIDED, UNPROVIDED );
      }
      else
      {
        cdestructuring_bind.cdestructuring_bind_error( csql, $list0 );
      }
  ...
  public static SubLObject csql_to_sparql_oracle_fields(final SubLObject fields)
  {
    ...
    else if( NIL != sksi_csql_sparql_interpretation.csql_variables_fields_p( fields ) )
    {
      SubLObject variables_keyword = NIL;
      cdestructuring_bind.destructuring_bind_must_consp( fields, fields, $list17 );
      variables_keyword = fields.first();
      final SubLObject v_variables;
      final SubLObject current = v_variables = fields.rest();
      if( NIL == Errors.$ignore_mustsP$.getDynamicValue( thread ) && $kw18$VARIABLES != variables_keyword )
      {
      ...
      else
      {
        ...
        try
        {
          ...
          for( index = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), variable = list_var.first(), index = Numbers.add( ONE_INTEGER, index ) )
          {
            if( !index.isZero() )
            {
              streams_high.write_string( $str20$__, stream, UNPROVIDED, UNPROVIDED );
            }
            final SubLObject variable_name = Symbols.symbol_name( variable );
            streams_high.write_string( variable_name, stream, ONE_INTEGER, UNPROVIDED );
          }
    ...
    else
    {
      ...
      try
      {
        ...
        for( index2 = ZERO_INTEGER; NIL != list_var2; list_var2 = list_var2.rest(), field = list_var2.first(), index2 = Numbers.add( ONE_INTEGER, index2 ) )
        {
          if( !index2.isZero() )
          {
            streams_high.write_string( $str20$__, stream2, UNPROVIDED, UNPROVIDED );
          }
          final SubLObject variable_name2 = sksi_csql_sparql_interpretation.sparql_field_variable_name( field );
          streams_high.write_string( variable_name2, stream2, ONE_INTEGER, UNPROVIDED );
        }
  ...
  public static SubLObject sparql_oracle_compute_alias(final SubLObject access_path)
  {
    ...
    {
      stream = streams_high.make_private_string_output_stream();
      streams_high.write_string( $str21$SEM_ALIASES_, stream, UNPROVIDED, UNPROVIDED );
      streams_high.terpri( stream );
  ...
  {
    streams_high.write_string( $str25$_SEM_ALIAS_, stream, UNPROVIDED, UNPROVIDED );
    streams_high.write_string( $str26$_, stream, UNPROVIDED, UNPROVIDED );
    streams_high.write_string( prefix, stream, UNPROVIDED, UNPROVIDED );
    streams_high.write_string( $str26$_, stream, UNPROVIDED, UNPROVIDED );
    streams_high.write_string( $str20$__, stream, UNPROVIDED, UNPROVIDED );
    streams_high.write_string( $str26$_, stream, UNPROVIDED, UNPROVIDED );
    streams_high.write_string( uri, stream, UNPROVIDED, UNPROVIDED );
    streams_high.write_string( $str26$_, stream, UNPROVIDED, UNPROVIDED );
    streams_high.write_string( $str24$_, stream, UNPROVIDED, UNPROVIDED );
    return NIL;
  }
  ...
  {
    SubLFiles.declareFunction( me, "csql_to_oracle_sparql", "CSQL-TO-ORACLE-SPARQL", 2, 0, false );
    SubLFiles.declareFunction( me, "csql_to_sparql_oracle_fields", "CSQL-TO-SPARQL-ORACLE-FIELDS", 1, 0, false );
    SubLFiles.declareFunction( me, "csql_to_sparql_oracle_where", "CSQL-TO-SPARQL-ORACLE-WHERE", 2, 0, false );
    SubLFiles.declareFunction( me, "sparql_oracle_compute_alias", "SPARQL-ORACLE-COMPUTE-ALIAS", 1, 0, false );
    SubLFiles.declareFunction( me, "write_sparql_oracle_alias", "WRITE-SPARQL-ORACLE-ALIAS", 3, 0, false );
    SubLFiles.declareFunction( me, "test_csql_to_oracle_sparql", "TEST-CSQL-TO-ORACLE-SPARQL", 2, 0, false );
    return NIL;
  }
  ...
  {
    generic_testing.define_test_case_table_int( $sym27$TEST_CSQL_TO_ORACLE_SPARQL, ConsesLow.list( new SubLObject[] { $kw28$TEST, Symbols.symbol_function( EQUAL ), $kw29$OWNER, NIL, $kw30$CLASSES, NIL, $kw31$KB,
      $kw32$FULL, $kw33$WORKING_, T
    } ), $list34 );
    return NIL;
  }
  ...
  static
  {
    me = new sksi_csql_oracle_sparql_interpretation();
    $list0 = ConsesLow.list( makeSymbol( "SELECT-KEYWORD" ), makeSymbol( "FIELDS" ), makeSymbol( "FROM" ), makeSymbol( "&OPTIONAL" ), makeSymbol( "WHERE" ), makeSymbol( "LIMIT" ), makeSymbol( "OFFSET" ) );
    $sym1$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__ = makeSymbol( "*APPEND-STACK-TRACES-TO-ERROR-MESSAGES?*" );
    $list2 = ConsesLow.list( makeSymbol( "CSETQ" ), makeSymbol( "*APPEND-STACK-TRACES-TO-ERROR-MESSAGES?*" ), NIL );
    $sym3$CATCH_ERROR_MESSAGE_HANDLER = makeSymbol( "CATCH-ERROR-MESSAGE-HANDLER" );
    $kw4$SELECT = makeKeyword( "SELECT" );
    $str5$malformed_csql_expression__a__exp = makeString( "malformed csql expression ~a, expected :select" );
    $sym6$CSETQ = makeSymbol( "CSETQ" );
    $str7$_A = makeString( "~A" );
    $str8$SELECT_ = makeString( "SELECT " );
    $str9$FROM_TABLE_SEM_MATCH_ = makeString( "FROM TABLE(SEM_MATCH(" );
    $str10$__ = makeString( "'{" );
    $str11$___ = makeString( "}'," );
    $str12$SEM_MODELS__CCF___ = makeString( "SEM_MODELS('CCF')," );
    $str13$null_ = makeString( "null," );
    $str14$_ = makeString( "," );
    $str15$null___ = makeString( "null));" );
    $str16$_ = makeString( "*" );
    $list17 = ConsesLow.list( makeSymbol( "VARIABLES-KEYWORD" ), makeSymbol( "&REST" ), makeSymbol( "VARIABLES" ) );
    $kw18$VARIABLES = makeKeyword( "VARIABLES" );
    $str19$malformed_csql_expression__a__exp = makeString( "malformed csql expression ~a, expected :variables" );
    $str20$__ = makeString( ", " );
    $str21$SEM_ALIASES_ = makeString( "SEM_ALIASES(" );
    $str22$ = makeString( "" );
    $list23 = ConsesLow.cons( makeSymbol( "PREFIX" ), makeSymbol( "PREFIX-URI" ) );
    $str24$_ = makeString( ")" );
    $str25$_SEM_ALIAS_ = makeString( " SEM_ALIAS(" );
    $str26$_ = makeString( "'" );
    $sym27$TEST_CSQL_TO_ORACLE_SPARQL = makeSymbol( "TEST-CSQL-TO-ORACLE-SPARQL" );
    $kw28$TEST = makeKeyword( "TEST" );
    $kw29$OWNER = makeKeyword( "OWNER" );
    $kw30$CLASSES = makeKeyword( "CLASSES" );
    $kw31$KB = makeKeyword( "KB" );
    $kw32$FULL = makeKeyword( "FULL" );
    $kw33$WORKING_ = makeKeyword( "WORKING?" );
    $list34 = ConsesLow.list( ConsesLow.list( ConsesLow.list( ConsesLow.list( makeKeyword( "SELECT" ), ConsesLow.list( ConsesLow.list( makeKeyword( "FIELD" ), makeString( "subject" ), makeString( "default" ) ) ),
        ConsesLow.list( makeKeyword( "FROM" ), ConsesLow.list( ConsesLow.list( makeKeyword( "TABLE" ), makeString( "default" ) ) ) ), ConsesLow.list( makeKeyword( "WHERE" ), ConsesLow.list( ConsesLow.list(
            constant_handles.reader_make_constant_shell( makeString( "CSQLEquals" ) ), ConsesLow.list( makeKeyword( "FIELD" ), makeString( "predicate" ), makeString( "default" ) ), makeString( "rdf:type" ) ), ConsesLow
                .list( constant_handles.reader_make_constant_shell( makeString( "CSQLEquals" ) ), ConsesLow.list( makeKeyword( "FIELD" ), makeString( "object" ), makeString( "default" ) ), makeString( "foo" ) ) ) ) ),
        ConsesLow.list( ConsesLow.cons( constant_handles.reader_make_constant_shell( makeString( "baseNamespaceForSKS" ) ), makeString( "http://www.clevelandclinic.org/heartcenter/ontologies/DataNodes.owl#" ) ),
            ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "nameSpacePrefixForSKS" ) ), ConsesLow.cons( makeString( "owl" ), makeString( "http://www/w3.org/2000/07/owl#" ) ), ConsesLow.cons(
                makeString( "ptrec" ), makeString( "http://clevelandclinicfoundation.org/cidr/patientrecord#" ) ), ConsesLow.cons( makeString( "rdf" ), makeString( "http://www/w3.org/2000/02/22-rdf-syntax-ns#" ) ),
                ConsesLow.cons( makeString( "rdfs" ), makeString( "http://www/w3.org/2000/01/rdf-schema#" ) ), ConsesLow.cons( makeString( "xsd" ), makeString( "http://www.w3.org/2001/XMLSchema#" ) ) ) ) ), makeString(
