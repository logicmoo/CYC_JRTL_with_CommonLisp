...
public final class sksi_database_fusion extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sksi_database_fusion_file() {
        ...
        sksi_database_fusion.$sksi_database_fusion_table_info_isg$ = SubLFiles.deflexical("*SKSI-DATABASE-FUSION-TABLE-INFO-ISG*", maybeDefault((SubLObject)sksi_database_fusion.$sym0$_SKSI_DATABASE_FUSION_TABLE_INFO_ISG_, sksi_database_fusion.$sksi_database_fusion_table_info_isg$, ()->(integer_sequence_generator.new_integer_sequence_generator((SubLObject)sksi_database_fusion.UNPROVIDED, (SubLObject)sksi_database_fusion.UNPROVIDED, (SubLObject)sksi_database_fusion.UNPROVIDED))));
        ...
        sksi_database_fusion.$last_db_info$ = SubLFiles.deflexical("*LAST-DB-INFO*", (SubLObject)(maybeDefault((SubLObject)sksi_database_fusion.$sym175$_LAST_DB_INFO_, sksi_database_fusion.$last_db_info$, sksi_database_fusion.NIL)));
