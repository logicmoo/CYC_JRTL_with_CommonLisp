...
public final class metadata_parser
    extends
      SubLTranslatedFile
{
  ...
  {
    return ConsesLow.list( $kw0$METADATA, access_path, tables_meta_data );
  }
  ...
  {
    return makeBoolean( NIL != list_utilities.list_of_length_p( v_object, THREE_INTEGER, UNPROVIDED ) && $kw0$METADATA == v_object.first() );
  }
  ...
  {
    return conses_high.getf( table_metadata, $kw1$TABLE_NAME, UNPROVIDED );
  }
  ...
  {
    return conses_high.getf( table_metadata, $kw2$COLUMN_METADATA, UNPROVIDED );
  }
  ...
  {
    return conses_high.getf( table_metadata, $kw3$EXPORTED_KEYS_INFO, UNPROVIDED );
  }
  ...
  {
    return conses_high.getf( table_metadata, $kw4$PRIMARY_KEY_INFO, UNPROVIDED );
  }
  ...
  public static SubLObject table_metadata_primary_key_column_names(final SubLObject table_metadata)
  {
    ...
    {
      if( NIL != conses_high.getf( pkey_info, $kw5$COLUMN_NAME, UNPROVIDED ) )
      {
        column_names = ConsesLow.cons( conses_high.getf( pkey_info, $kw5$COLUMN_NAME, UNPROVIDED ), column_names );
      }
  ...
  {
    return conses_high.getf( table_metadata, $kw6$IMPORTED_KEYS_INFO, UNPROVIDED );
  }
  ...
  public static SubLObject table_metadata_imported_key_column_names(final SubLObject table_metadata)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != conses_high.getf( ikey_info, $kw7$FKCOLUMN_NAME, UNPROVIDED ) )
      {
        column_names = ConsesLow.cons( conses_high.getf( ikey_info, $kw7$FKCOLUMN_NAME, UNPROVIDED ), column_names );
      }
      cdolist_list_var = cdolist_list_var.rest();
      ikey_info = cdolist_list_var.first();
    }
  ...
  {
    return conses_high.getf( column_metadata, $kw5$COLUMN_NAME, UNPROVIDED );
  }
  ...
  {
    return conses_high.getf( column_metadata, $kw8$TYPE_NAME, UNPROVIDED );
  }
  ...
  {
    return conses_high.getf( column_metadata, $kw9$COLUMN_SIZE, UNPROVIDED );
  }
  ...
  public static SubLObject semantic_etl_acquire_metadata_list(final SubLObject access_paths)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      metadata_list = ConsesLow.cons( metadata, metadata_list );
      cdolist_list_var = cdolist_list_var.rest();
      access_path = cdolist_list_var.first();
    }
  ...
  public static SubLObject semantic_etl_acquire_metadata(final SubLObject access_path)
  {
    ...
    try
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        final SubLObject table_name = conses_high.getf( table_meta_data, $kw1$TABLE_NAME, UNPROVIDED );
        ...
        final SubLObject more_table_meta_data = ConsesLow.list( new SubLObject[] { $kw14$ROW_COUNT, row_count, $kw2$COLUMN_METADATA, columns_meta_data, $kw4$PRIMARY_KEY_INFO, primary_keys_meta_data,
          $kw3$EXPORTED_KEYS_INFO, exported_keys_meta_data, $kw6$IMPORTED_KEYS_INFO, imported_keys_meta_data, $kw15$INDEX_INFO, indices_meta_data
        } );
        new_tables_meta_data = ConsesLow.cons( list_utilities.merge_plist( table_meta_data, more_table_meta_data ), new_tables_meta_data );
        cdolist_list_var = cdolist_list_var.rest();
        table_meta_data = cdolist_list_var.first();
      }
  ...
  public static SubLObject semantic_etl_parse_metadata_list_first_pass(final SubLObject metadata_list, SubLObject parse_column_names)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      semantics_list = ConsesLow.cons( semantic_etl_parse_metadata_first_pass( metadata, parse_column_names ), semantics_list );
      cdolist_list_var = cdolist_list_var.rest();
      metadata = cdolist_list_var.first();
    }
  ...
  public static SubLObject semantic_etl_parse_metadata_first_pass(final SubLObject metadata, SubLObject parse_metadata)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      final SubLObject table_parses = ( NIL != parse_metadata ) ? semantic_etl_parse_table_name( table_name ) : $kw16$UNDETERMINED;
      ...
      while ( NIL != cdolist_list_var_$1)
      {
        ...
        final SubLObject column_parses = ( NIL != parse_metadata ) ? semantic_etl_parse_column_name( column_name, table_parses ) : $kw16$UNDETERMINED;
        ...
        column_semantics_list = ConsesLow.cons( semantic_etl_bus.new_column_semantics( column_name, column_parses, column_type, column_size ), column_semantics_list );
      ...
      {
        final SubLObject primary_key_column = Sequences.find( primary_key_column_name, column_semantics_list, EQUAL, $sym17$COLUMN_SEMANTICS_COLUMN_NAME, UNPROVIDED, UNPROVIDED );
        if( NIL != primary_key_column )
        {
          primary_key_columns = ConsesLow.cons( primary_key_column, primary_key_columns );
        }
        cdolist_list_var_$2 = cdolist_list_var_$2.rest();
        primary_key_column_name = cdolist_list_var_$2.first();
      }
      table_semantics_list = ConsesLow.cons( semantic_etl_bus.new_table_semantics( table_name, table_parses, Sequences.nreverse( column_semantics_list ), primary_key_columns ), table_semantics_list );
      cdolist_list_var = cdolist_list_var.rest();
      table_metadata = cdolist_list_var.first();
    }
  ...
  {
    final SubLObject normalized = string_utilities.string_subst( $str18$_, $str19$_, table_name, UNPROVIDED );
    return Sequences.remove_if( $sym20$NON_RELATION_INDIVIDUAL_P, data_parser.etl_parse_value_trampoline( normalized, T, UNPROVIDED ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject semantic_etl_parse_column_name(final SubLObject column_name, SubLObject table_parses)
  {
    ...
    final SubLObject normalized = string_utilities.string_subst( $str18$_, $str19$_, column_name, UNPROVIDED );
    return Sequences.remove_if( $sym20$NON_RELATION_INDIVIDUAL_P, data_parser.etl_parse_value_trampoline( normalized, T, UNPROVIDED ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject semantic_etl_parse_xref_metadata(final SubLObject metadata, final SubLObject semantics)
  {
    ...
    while ( NIL != table_semantics || NIL != table_metadata)
    {
      ...
      assert NIL != Types.integerp( table_id ) : table_id;
      if( NIL != table_metadata_primary_key_info( table_metadata_$5 ) )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          constraints = ConsesLow.cons( create_constraint_from_primary_key_info( primary_key_info, table_semantics_$6 ), constraints );
          cdolist_list_var = cdolist_list_var.rest();
          primary_key_info = cdolist_list_var.first();
        }
      }
      ...
      while ( NIL != cdolist_list_var)
      {
        final SubLObject foreign_table_name = conses_high.getf( exported_key_info, $kw23$FKTABLE_NAME, UNPROVIDED );
        final SubLObject constraint = create_constraint_from_exported_key_info( exported_key_info, semantics );
        assert NIL != Types.stringp( foreign_table_name ) : foreign_table_name;
        ...
        assert NIL != Types.integerp( foreign_table_id ) : foreign_table_id;
        links = ConsesLow.cons( ConsesLow.list( table_id, foreign_table_id ), links );
        cdolist_list_var = cdolist_list_var.rest();
        exported_key_info = cdolist_list_var.first();
      }
  ...
  public static SubLObject semantics_add_table_links(final SubLObject semantics, final SubLObject links, final SubLObject dict)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        ...
        if( NIL == conses_high.member( item_var, points_to_ids, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
        {
          points_to_ids = ConsesLow.cons( item_var, points_to_ids );
        }
        item_var = points_to_id;
        if( NIL == conses_high.member( item_var, pointed_to_by_ids, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
        {
          pointed_to_by_ids = ConsesLow.cons( item_var, pointed_to_by_ids );
        }
  ...
  {
    assert NIL != semantic_etl_bus.table_semantics_p( table_semantics ) : table_semantics;
    final SubLObject column_name = conses_high.getf( primary_key_info, $kw5$COLUMN_NAME, UNPROVIDED );
    final SubLObject table_name = conses_high.getf( primary_key_info, $kw1$TABLE_NAME, UNPROVIDED );
    ...
    final SubLObject constraint_name = conses_high.getf( primary_key_info, $kw27$PK_NAME, UNPROVIDED );
  ...
  public static SubLObject create_constraint_from_exported_key_info(final SubLObject exported_key_info, final SubLObject semantics)
  {
    ...
    final SubLObject constraint_name = conses_high.getf( exported_key_info, $kw29$FK_NAME, UNPROVIDED );
    final SubLObject constrained_table_name = conses_high.getf( exported_key_info, $kw23$FKTABLE_NAME, UNPROVIDED );
    final SubLObject constrained_column_name = conses_high.getf( exported_key_info, $kw7$FKCOLUMN_NAME, UNPROVIDED );
    final SubLObject constraining_table_name = conses_high.getf( exported_key_info, $kw30$PKTABLE_NAME, UNPROVIDED );
    final SubLObject constraining_column_name = conses_high.getf( exported_key_info, $kw31$PKCOLUMN_NAME, UNPROVIDED );
  ...
  {
    SubLFiles.declareFunction( me, "semantic_etl_parse_metadata", "SEMANTIC-ETL-PARSE-METADATA", 1, 0, false );
    SubLFiles.declareFunction( me, "new_metadata", "NEW-METADATA", 2, 0, false );
    SubLFiles.declareFunction( me, "metadata_p", "METADATA-P", 1, 0, false );
    SubLFiles.declareFunction( me, "metadata_access_path", "METADATA-ACCESS-PATH", 1, 0, false );
    SubLFiles.declareFunction( me, "metadata_tables_meta_data", "METADATA-TABLES-META-DATA", 1, 0, false );
    SubLFiles.declareFunction( me, "table_metadata_table_name", "TABLE-METADATA-TABLE-NAME", 1, 0, false );
    SubLFiles.declareFunction( me, "table_metadata_column_metadata", "TABLE-METADATA-COLUMN-METADATA", 1, 0, false );
    SubLFiles.declareFunction( me, "table_metadata_exported_keys_info", "TABLE-METADATA-EXPORTED-KEYS-INFO", 1, 0, false );
    SubLFiles.declareFunction( me, "table_metadata_primary_key_info", "TABLE-METADATA-PRIMARY-KEY-INFO", 1, 0, false );
    SubLFiles.declareFunction( me, "table_metadata_primary_key_column_names", "TABLE-METADATA-PRIMARY-KEY-COLUMN-NAMES", 1, 0, false );
    SubLFiles.declareFunction( me, "table_metadata_imported_key_info", "TABLE-METADATA-IMPORTED-KEY-INFO", 1, 0, false );
    SubLFiles.declareFunction( me, "table_metadata_imported_key_column_names", "TABLE-METADATA-IMPORTED-KEY-COLUMN-NAMES", 1, 0, false );
    SubLFiles.declareFunction( me, "column_metadata_column_name", "COLUMN-METADATA-COLUMN-NAME", 1, 0, false );
    SubLFiles.declareFunction( me, "column_metadata_column_type", "COLUMN-METADATA-COLUMN-TYPE", 1, 0, false );
    SubLFiles.declareFunction( me, "column_metadata_column_size", "COLUMN-METADATA-COLUMN-SIZE", 1, 0, false );
    SubLFiles.declareFunction( me, "semantic_etl_acquire_metadata_list", "SEMANTIC-ETL-ACQUIRE-METADATA-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "semantic_etl_acquire_metadata", "SEMANTIC-ETL-ACQUIRE-METADATA", 1, 0, false );
    SubLFiles.declareFunction( me, "semantic_etl_convert_metadata_to_semantics", "SEMANTIC-ETL-CONVERT-METADATA-TO-SEMANTICS", 1, 0, false );
    SubLFiles.declareFunction( me, "semantic_etl_parse_metadata_list_first_pass", "SEMANTIC-ETL-PARSE-METADATA-LIST-FIRST-PASS", 1, 1, false );
    SubLFiles.declareFunction( me, "semantic_etl_parse_metadata_first_pass", "SEMANTIC-ETL-PARSE-METADATA-FIRST-PASS", 1, 1, false );
    SubLFiles.declareFunction( me, "semantic_etl_parse_table_name", "SEMANTIC-ETL-PARSE-TABLE-NAME", 1, 0, false );
    SubLFiles.declareFunction( me, "semantic_etl_parse_column_name", "SEMANTIC-ETL-PARSE-COLUMN-NAME", 1, 1, false );
    SubLFiles.declareFunction( me, "non_relation_individual_p", "NON-RELATION-INDIVIDUAL-P", 1, 0, false );
    SubLFiles.declareFunction( me, "semantic_etl_parse_xref_metadata_list", "SEMANTIC-ETL-PARSE-XREF-METADATA-LIST", 2, 0, false );
    SubLFiles.declareFunction( me, "semantic_etl_parse_xref_metadata", "SEMANTIC-ETL-PARSE-XREF-METADATA", 2, 0, false );
    SubLFiles.declareFunction( me, "semantics_add_table_links", "SEMANTICS-ADD-TABLE-LINKS", 3, 0, false );
    SubLFiles.declareFunction( me, "create_constraint_from_primary_key_info", "CREATE-CONSTRAINT-FROM-PRIMARY-KEY-INFO", 2, 0, false );
    SubLFiles.declareFunction( me, "create_constraint_from_exported_key_info", "CREATE-CONSTRAINT-FROM-EXPORTED-KEY-INFO", 2, 0, false );
    return NIL;
  }
  ...
  static
  {
    me = new metadata_parser();
    $kw0$METADATA = makeKeyword( "METADATA" );
    $kw1$TABLE_NAME = makeKeyword( "TABLE-NAME" );
    $kw2$COLUMN_METADATA = makeKeyword( "COLUMN-METADATA" );
    $kw3$EXPORTED_KEYS_INFO = makeKeyword( "EXPORTED-KEYS-INFO" );
    $kw4$PRIMARY_KEY_INFO = makeKeyword( "PRIMARY-KEY-INFO" );
    $kw5$COLUMN_NAME = makeKeyword( "COLUMN-NAME" );
    $kw6$IMPORTED_KEYS_INFO = makeKeyword( "IMPORTED-KEYS-INFO" );
    $kw7$FKCOLUMN_NAME = makeKeyword( "FKCOLUMN-NAME" );
    $kw8$TYPE_NAME = makeKeyword( "TYPE-NAME" );
    $kw9$COLUMN_SIZE = makeKeyword( "COLUMN-SIZE" );
    $str10$Problem_opening_connection_to_dat = makeString( "Problem opening connection to database ~s" );
    $str11$ = makeString( "" );
    $str12$_ = makeString( "%" );
    $list13 = ConsesLow.list( makeString( "TABLE" ) );
    $kw14$ROW_COUNT = makeKeyword( "ROW-COUNT" );
    $kw15$INDEX_INFO = makeKeyword( "INDEX-INFO" );
    $kw16$UNDETERMINED = makeKeyword( "UNDETERMINED" );
    $sym17$COLUMN_SEMANTICS_COLUMN_NAME = makeSymbol( "COLUMN-SEMANTICS-COLUMN-NAME" );
    $str18$_ = makeString( " " );
    $str19$_ = makeString( "_" );
    $sym20$NON_RELATION_INDIVIDUAL_P = makeSymbol( "NON-RELATION-INDIVIDUAL-P" );
    $str21$Table_name_mismatch___s_vs___s = makeString( "Table name mismatch: ~s vs. ~s" );
    $sym22$INTEGERP = makeSymbol( "INTEGERP" );
    $kw23$FKTABLE_NAME = makeKeyword( "FKTABLE-NAME" );
    $sym24$STRINGP = makeSymbol( "STRINGP" );
    $list25 = ConsesLow.list( makeSymbol( "POINTED-TO-ID" ), makeSymbol( "POINTS-TO-ID" ) );
    $sym26$TABLE_SEMANTICS_P = makeSymbol( "TABLE-SEMANTICS-P" );
    $kw27$PK_NAME = makeKeyword( "PK-NAME" );
    $sym28$SEMANTICS_P = makeSymbol( "SEMANTICS-P" );
    $kw29$FK_NAME = makeKeyword( "FK-NAME" );
    $kw30$PKTABLE_NAME = makeKeyword( "PKTABLE-NAME" );
    $kw31$PKCOLUMN_NAME = makeKeyword( "PKCOLUMN-NAME" );
  }
}
/*
 * 
