...
public final class semantic_etl_bus extends SubLTranslatedFile
{
    ...
    public static SubLObject init_semantic_etl_bus_file() {
        ...
        semantic_etl_bus.$database_output_specs$ = SubLFiles.deflexical("*DATABASE-OUTPUT-SPECS*", maybeDefault((SubLObject)semantic_etl_bus.$sym6$_DATABASE_OUTPUT_SPECS_, semantic_etl_bus.$database_output_specs$, ()->(dictionary.new_dictionary((SubLObject)semantic_etl_bus.EQL, (SubLObject)semantic_etl_bus.UNPROVIDED))));
        semantic_etl_bus.$database_output_specs_lock$ = SubLFiles.deflexical("*DATABASE-OUTPUT-SPECS-LOCK*", maybeDefault((SubLObject)semantic_etl_bus.$sym7$_DATABASE_OUTPUT_SPECS_LOCK_, semantic_etl_bus.$database_output_specs_lock$, ()->(Locks.make_lock((SubLObject)semantic_etl_bus.$str8$Database_Output_Specs))));
        ...
        semantic_etl_bus.$semantic_etl_table_isg$ = SubLFiles.deflexical("*SEMANTIC-ETL-TABLE-ISG*", maybeDefault((SubLObject)semantic_etl_bus.$sym103$_SEMANTIC_ETL_TABLE_ISG_, semantic_etl_bus.$semantic_etl_table_isg$, ()->(integer_sequence_generator.new_integer_sequence_generator((SubLObject)semantic_etl_bus.UNPROVIDED, (SubLObject)semantic_etl_bus.UNPROVIDED, (SubLObject)semantic_etl_bus.UNPROVIDED))));
        ...
        semantic_etl_bus.$db_output_spec_isg$ = SubLFiles.deflexical("*DB-OUTPUT-SPEC-ISG*", maybeDefault((SubLObject)semantic_etl_bus.$sym224$_DB_OUTPUT_SPEC_ISG_, semantic_etl_bus.$db_output_spec_isg$, ()->(integer_sequence_generator.new_integer_sequence_generator((SubLObject)semantic_etl_bus.UNPROVIDED, (SubLObject)semantic_etl_bus.UNPROVIDED, (SubLObject)semantic_etl_bus.UNPROVIDED))));
        ...
        semantic_etl_bus.$access_path_map$ = SubLFiles.deflexical("*ACCESS-PATH-MAP*", (SubLObject)(maybeDefault((SubLObject)semantic_etl_bus.$sym791$_ACCESS_PATH_MAP_, semantic_etl_bus.$access_path_map$, semantic_etl_bus.NIL)));
        semantic_etl_bus.$bln1_access_path$ = SubLFiles.deflexical("*BLN1-ACCESS-PATH*", (SubLObject)(maybeDefault((SubLObject)semantic_etl_bus.$sym795$_BLN1_ACCESS_PATH_, semantic_etl_bus.$bln1_access_path$, semantic_etl_bus.NIL)));
        semantic_etl_bus.$bln2_access_path$ = SubLFiles.deflexical("*BLN2-ACCESS-PATH*", (SubLObject)(maybeDefault((SubLObject)semantic_etl_bus.$sym796$_BLN2_ACCESS_PATH_, semantic_etl_bus.$bln2_access_path$, semantic_etl_bus.NIL)));
        semantic_etl_bus.$usgs_access_path$ = SubLFiles.deflexical("*USGS-ACCESS-PATH*", (SubLObject)(maybeDefault((SubLObject)semantic_etl_bus.$sym797$_USGS_ACCESS_PATH_, semantic_etl_bus.$usgs_access_path$, semantic_etl_bus.NIL)));
        semantic_etl_bus.$nga_access_path$ = SubLFiles.deflexical("*NGA-ACCESS-PATH*", (SubLObject)(maybeDefault((SubLObject)semantic_etl_bus.$sym798$_NGA_ACCESS_PATH_, semantic_etl_bus.$nga_access_path$, semantic_etl_bus.NIL)));
        semantic_etl_bus.$gndb_access_path$ = SubLFiles.deflexical("*GNDB-ACCESS-PATH*", (SubLObject)(maybeDefault((SubLObject)semantic_etl_bus.$sym799$_GNDB_ACCESS_PATH_, semantic_etl_bus.$gndb_access_path$, semantic_etl_bus.NIL)));
        semantic_etl_bus.$bathymetric_data_access_path$ = SubLFiles.deflexical("*BATHYMETRIC-DATA-ACCESS-PATH*", (SubLObject)(maybeDefault((SubLObject)semantic_etl_bus.$sym800$_BATHYMETRIC_DATA_ACCESS_PATH_, semantic_etl_bus.$bathymetric_data_access_path$, semantic_etl_bus.NIL)));
        semantic_etl_bus.$bathymetric_header_access_path$ = SubLFiles.deflexical("*BATHYMETRIC-HEADER-ACCESS-PATH*", (SubLObject)(maybeDefault((SubLObject)semantic_etl_bus.$sym801$_BATHYMETRIC_HEADER_ACCESS_PATH_, semantic_etl_bus.$bathymetric_header_access_path$, semantic_etl_bus.NIL)));
        semantic_etl_bus.$sporting_goods_access_path$ = SubLFiles.deflexical("*SPORTING-GOODS-ACCESS-PATH*", (SubLObject)(maybeDefault((SubLObject)semantic_etl_bus.$sym802$_SPORTING_GOODS_ACCESS_PATH_, semantic_etl_bus.$sporting_goods_access_path$, semantic_etl_bus.NIL)));
        semantic_etl_bus.$northwind_access_path$ = SubLFiles.deflexical("*NORTHWIND-ACCESS-PATH*", (SubLObject)(maybeDefault((SubLObject)semantic_etl_bus.$sym803$_NORTHWIND_ACCESS_PATH_, semantic_etl_bus.$northwind_access_path$, semantic_etl_bus.NIL)));
        return (SubLObject)semantic_etl_bus.NIL;
    }
