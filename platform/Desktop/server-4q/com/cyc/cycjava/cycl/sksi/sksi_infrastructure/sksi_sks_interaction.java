...
public final class sksi_sks_interaction extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sksi_sks_interaction_file() {
        ...
        sksi_sks_interaction.$result_set_sql_connection_statement_cache$ = SubLFiles.deflexical("*RESULT-SET-SQL-CONNECTION-STATEMENT-CACHE*", maybeDefault((SubLObject)sksi_sks_interaction.$sym132$_RESULT_SET_SQL_CONNECTION_STATEMENT_CACHE_, sksi_sks_interaction.$result_set_sql_connection_statement_cache$, ()->(dictionary_utilities.new_synchronized_dictionary(Symbols.symbol_function((SubLObject)sksi_sks_interaction.EQ), (SubLObject)sksi_sks_interaction.UNPROVIDED))));
        ...
        sksi_sks_interaction.$access_path$ = SubLFiles.deflexical("*ACCESS-PATH*", (SubLObject)(maybeDefault((SubLObject)sksi_sks_interaction.$sym183$_ACCESS_PATH_, sksi_sks_interaction.$access_path$, sksi_sks_interaction.NIL)));
        ...
        sksi_sks_interaction.$sksi_resourcing_cache$ = SubLFiles.deflexical("*SKSI-RESOURCING-CACHE*", (SubLObject)(maybeDefault((SubLObject)sksi_sks_interaction.$sym212$_SKSI_RESOURCING_CACHE_, sksi_sks_interaction.$sksi_resourcing_cache$, sksi_sks_interaction.NIL)));
        ...
        sksi_sks_interaction.$sksi_connection_global_cache_lock$ = SubLFiles.deflexical("*SKSI-CONNECTION-GLOBAL-CACHE-LOCK*", maybeDefault((SubLObject)sksi_sks_interaction.$sym253$_SKSI_CONNECTION_GLOBAL_CACHE_LOCK_, sksi_sks_interaction.$sksi_connection_global_cache_lock$, ()->(Locks.make_lock(Strings.string(Symbols.gensym((SubLObject)sksi_sks_interaction.$str254$SKSI_SQL_global_connection_cache_))))));
