...
public final class sksi_removal_module_generation extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sksi_removal_module_generation_file() {
        sksi_removal_module_generation.$sksi_modules$ = SubLFiles.deflexical("*SKSI-MODULES*", maybeDefault((SubLObject)sksi_removal_module_generation.$sym0$_SKSI_MODULES_, sksi_removal_module_generation.$sksi_modules$, ()->(set.new_set((SubLObject)sksi_removal_module_generation.UNPROVIDED, (SubLObject)sksi_removal_module_generation.UNPROVIDED))));
        ...
        sksi_removal_module_generation.$sksi_module_supports$ = SubLFiles.deflexical("*SKSI-MODULE-SUPPORTS*", maybeDefault((SubLObject)sksi_removal_module_generation.$sym6$_SKSI_MODULE_SUPPORTS_, sksi_removal_module_generation.$sksi_module_supports$, ()->(dictionary.new_dictionary((SubLObject)sksi_removal_module_generation.UNPROVIDED, (SubLObject)sksi_removal_module_generation.UNPROVIDED))));
        sksi_removal_module_generation.$sksi_module_simple_required_pattern$ = SubLFiles.deflexical("*SKSI-MODULE-SIMPLE-REQUIRED-PATTERN*", maybeDefault((SubLObject)sksi_removal_module_generation.$sym7$_SKSI_MODULE_SIMPLE_REQUIRED_PATTERN_, sksi_removal_module_generation.$sksi_module_simple_required_pattern$, ()->(dictionary.new_dictionary((SubLObject)sksi_removal_module_generation.UNPROVIDED, (SubLObject)sksi_removal_module_generation.UNPROVIDED))));
        sksi_removal_module_generation.$sks_multiply_indexed_conditional_meaning_sentence_cache$ = SubLFiles.deflexical("*SKS-MULTIPLY-INDEXED-CONDITIONAL-MEANING-SENTENCE-CACHE*", maybeDefault((SubLObject)sksi_removal_module_generation.$sym8$_SKS_MULTIPLY_INDEXED_CONDITIONAL_MEANING_SENTENCE_CACHE_, sksi_removal_module_generation.$sks_multiply_indexed_conditional_meaning_sentence_cache$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sksi_removal_module_generation.EQ), (SubLObject)sksi_removal_module_generation.UNPROVIDED))));
        sksi_removal_module_generation.$sksi_module_multiply_indexed_conditional_meaning_sentence_cache$ = SubLFiles.deflexical("*SKSI-MODULE-MULTIPLY-INDEXED-CONDITIONAL-MEANING-SENTENCE-CACHE*", maybeDefault((SubLObject)sksi_removal_module_generation.$sym9$_SKSI_MODULE_MULTIPLY_INDEXED_CONDITIONAL_MEANING_SENTENCE_CACHE_, sksi_removal_module_generation.$sksi_module_multiply_indexed_conditional_meaning_sentence_cache$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sksi_removal_module_generation.EQ), (SubLObject)sksi_removal_module_generation.UNPROVIDED))));
        sksi_removal_module_generation.$sksi_modules_by_sks$ = SubLFiles.deflexical("*SKSI-MODULES-BY-SKS*", maybeDefault((SubLObject)sksi_removal_module_generation.$sym10$_SKSI_MODULES_BY_SKS_, sksi_removal_module_generation.$sksi_modules_by_sks$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sksi_removal_module_generation.EQ), (SubLObject)sksi_removal_module_generation.UNPROVIDED))));
        sksi_removal_module_generation.$sksi_code_mapping_sks_cache$ = SubLFiles.deflexical("*SKSI-CODE-MAPPING-SKS-CACHE*", maybeDefault((SubLObject)sksi_removal_module_generation.$sym13$_SKSI_CODE_MAPPING_SKS_CACHE_, sksi_removal_module_generation.$sksi_code_mapping_sks_cache$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sksi_removal_module_generation.EQ), (SubLObject)sksi_removal_module_generation.UNPROVIDED))));
        sksi_removal_module_generation.$isa_sks_term_to_cycl_term_mts$ = SubLFiles.deflexical("*ISA-SKS-TERM-TO-CYCL-TERM-MTS*", (SubLObject)(maybeDefault((SubLObject)sksi_removal_module_generation.$sym28$_ISA_SKS_TERM_TO_CYCL_TERM_MTS_, sksi_removal_module_generation.$isa_sks_term_to_cycl_term_mts$, sksi_removal_module_generation.NIL)));
        sksi_removal_module_generation.$isa_sks_term_to_cycl_term_store$ = SubLFiles.deflexical("*ISA-SKS-TERM-TO-CYCL-TERM-STORE*", (SubLObject)(maybeDefault((SubLObject)sksi_removal_module_generation.$sym30$_ISA_SKS_TERM_TO_CYCL_TERM_STORE_, sksi_removal_module_generation.$isa_sks_term_to_cycl_term_store$, sksi_removal_module_generation.NIL)));
        ...
        sksi_removal_module_generation.$meaning_sentence_mts$ = SubLFiles.deflexical("*MEANING-SENTENCE-MTS*", (SubLObject)(maybeDefault((SubLObject)sksi_removal_module_generation.$sym35$_MEANING_SENTENCE_MTS_, sksi_removal_module_generation.$meaning_sentence_mts$, sksi_removal_module_generation.NIL)));
        sksi_removal_module_generation.$meaning_sentence_pred_store$ = SubLFiles.deflexical("*MEANING-SENTENCE-PRED-STORE*", (SubLObject)(maybeDefault((SubLObject)sksi_removal_module_generation.$sym36$_MEANING_SENTENCE_PRED_STORE_, sksi_removal_module_generation.$meaning_sentence_pred_store$, sksi_removal_module_generation.NIL)));
        ...
        sksi_removal_module_generation.$virtual_assertion_count$ = SubLFiles.deflexical("*VIRTUAL-ASSERTION-COUNT*", (SubLObject)(maybeDefault((SubLObject)sksi_removal_module_generation.$sym204$_VIRTUAL_ASSERTION_COUNT_, sksi_removal_module_generation.$virtual_assertion_count$, sksi_removal_module_generation.ZERO_INTEGER)));
        sksi_removal_module_generation.$mt_virtual_assertion_count_table$ = SubLFiles.deflexical("*MT-VIRTUAL-ASSERTION-COUNT-TABLE*", maybeDefault((SubLObject)sksi_removal_module_generation.$sym205$_MT_VIRTUAL_ASSERTION_COUNT_TABLE_, sksi_removal_module_generation.$mt_virtual_assertion_count_table$, ()->(Hashtables.make_hash_table((SubLObject)sksi_removal_module_generation.SIXTEEN_INTEGER, (SubLObject)sksi_removal_module_generation.UNPROVIDED, (SubLObject)sksi_removal_module_generation.UNPROVIDED))));
        sksi_removal_module_generation.$sksi_module_code_mapping_terms_cache$ = SubLFiles.deflexical("*SKSI-MODULE-CODE-MAPPING-TERMS-CACHE*", maybeDefault((SubLObject)sksi_removal_module_generation.$sym206$_SKSI_MODULE_CODE_MAPPING_TERMS_CACHE_, sksi_removal_module_generation.$sksi_module_code_mapping_terms_cache$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sksi_removal_module_generation.EQ), (SubLObject)sksi_removal_module_generation.UNPROVIDED))));
        sksi_removal_module_generation.$sksi_module_logical_schemas_cache$ = SubLFiles.deflexical("*SKSI-MODULE-LOGICAL-SCHEMAS-CACHE*", maybeDefault((SubLObject)sksi_removal_module_generation.$sym207$_SKSI_MODULE_LOGICAL_SCHEMAS_CACHE_, sksi_removal_module_generation.$sksi_module_logical_schemas_cache$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sksi_removal_module_generation.EQ), (SubLObject)sksi_removal_module_generation.UNPROVIDED))));
