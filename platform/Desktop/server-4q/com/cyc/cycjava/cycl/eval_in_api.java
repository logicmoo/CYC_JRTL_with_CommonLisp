...
public final class eval_in_api extends SubLTranslatedFile
{
    ...
    public static SubLObject init_eval_in_api_file() {
        ...
        eval_in_api.$eval_in_api_mutable_globals$ = SubLFiles.deflexical("*EVAL-IN-API-MUTABLE-GLOBALS*", (SubLObject)(maybeDefault((SubLObject)eval_in_api.$sym1$_EVAL_IN_API_MUTABLE_GLOBALS_, eval_in_api.$eval_in_api_mutable_globals$, eval_in_api.NIL)));
        eval_in_api.$eval_in_api_immutable_globals$ = SubLFiles.deflexical("*EVAL-IN-API-IMMUTABLE-GLOBALS*", (SubLObject)(maybeDefault((SubLObject)eval_in_api.$sym2$_EVAL_IN_API_IMMUTABLE_GLOBALS_, eval_in_api.$eval_in_api_immutable_globals$, eval_in_api.NIL)));
        eval_in_api.$eval_in_api_env$ = SubLFiles.defparameter("*EVAL-IN-API-ENV*", (SubLObject)eval_in_api.NIL);
        eval_in_api.$api_special_verify_table$ = SubLFiles.deflexical("*API-SPECIAL-VERIFY-TABLE*", maybeDefault((SubLObject)eval_in_api.$sym3$_API_SPECIAL_VERIFY_TABLE_, eval_in_api.$api_special_verify_table$, ()->(Hashtables.make_hash_table((SubLObject)eval_in_api.TEN_INTEGER, Symbols.symbol_function((SubLObject)eval_in_api.EQ), (SubLObject)eval_in_api.UNPROVIDED))));
        eval_in_api.$api_function_table$ = SubLFiles.deflexical("*API-FUNCTION-TABLE*", maybeDefault((SubLObject)eval_in_api.$sym4$_API_FUNCTION_TABLE_, eval_in_api.$api_function_table$, ()->(Hashtables.make_hash_table((SubLObject)eval_in_api.$int5$100, Symbols.symbol_function((SubLObject)eval_in_api.EQ), (SubLObject)eval_in_api.UNPROVIDED))));
        eval_in_api.$api_macro_table$ = SubLFiles.deflexical("*API-MACRO-TABLE*", maybeDefault((SubLObject)eval_in_api.$sym6$_API_MACRO_TABLE_, eval_in_api.$api_macro_table$, ()->(Hashtables.make_hash_table((SubLObject)eval_in_api.TEN_INTEGER, Symbols.symbol_function((SubLObject)eval_in_api.EQ), (SubLObject)eval_in_api.UNPROVIDED))));
        eval_in_api.$subl_eval_method$ = SubLFiles.deflexical("*SUBL-EVAL-METHOD*", (SubLObject)(maybeDefault((SubLObject)eval_in_api.$sym19$_SUBL_EVAL_METHOD_, eval_in_api.$subl_eval_method$, eval_in_api.$sym20$EVAL)));
