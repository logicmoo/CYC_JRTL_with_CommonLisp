...
public final class hl_storage_modules extends SubLTranslatedFile
{
    ...
    public static SubLObject init_hl_storage_modules_file() {
        hl_storage_modules.$hl_storage_modules$ = SubLFiles.deflexical("*HL-STORAGE-MODULES*", maybeDefault((SubLObject)hl_storage_modules.$sym0$_HL_STORAGE_MODULES_, hl_storage_modules.$hl_storage_modules$, ()->(set.new_set(Symbols.symbol_function((SubLObject)hl_storage_modules.EQL), (SubLObject)hl_storage_modules.UNPROVIDED))));
        hl_storage_modules.$predicate_generic_hl_storage_modules$ = SubLFiles.deflexical("*PREDICATE-GENERIC-HL-STORAGE-MODULES*", maybeDefault((SubLObject)hl_storage_modules.$sym1$_PREDICATE_GENERIC_HL_STORAGE_MODULES_, hl_storage_modules.$predicate_generic_hl_storage_modules$, ()->(set.new_set(Symbols.symbol_function((SubLObject)hl_storage_modules.EQL), (SubLObject)hl_storage_modules.UNPROVIDED))));
        hl_storage_modules.$predicate_specific_hl_storage_modules_table$ = SubLFiles.deflexical("*PREDICATE-SPECIFIC-HL-STORAGE-MODULES-TABLE*", maybeDefault((SubLObject)hl_storage_modules.$sym2$_PREDICATE_SPECIFIC_HL_STORAGE_MODULES_TABLE_, hl_storage_modules.$predicate_specific_hl_storage_modules_table$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)hl_storage_modules.EQL), (SubLObject)hl_storage_modules.UNPROVIDED))));
        hl_storage_modules.$argument_type_specific_hl_storage_modules_table$ = SubLFiles.deflexical("*ARGUMENT-TYPE-SPECIFIC-HL-STORAGE-MODULES-TABLE*", maybeDefault((SubLObject)hl_storage_modules.$sym3$_ARGUMENT_TYPE_SPECIFIC_HL_STORAGE_MODULES_TABLE_, hl_storage_modules.$argument_type_specific_hl_storage_modules_table$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)hl_storage_modules.EQL), (SubLObject)hl_storage_modules.UNPROVIDED))));
        ...
        hl_storage_modules.$solely_specific_hl_storage_module_predicate_store$ = SubLFiles.deflexical("*SOLELY-SPECIFIC-HL-STORAGE-MODULE-PREDICATE-STORE*", maybeDefault((SubLObject)hl_storage_modules.$sym51$_SOLELY_SPECIFIC_HL_STORAGE_MODULE_PREDICATE_STORE_, hl_storage_modules.$solely_specific_hl_storage_module_predicate_store$, ()->(set.new_set((SubLObject)hl_storage_modules.EQL, (SubLObject)hl_storage_modules.$int52$50))));
        ...
        hl_storage_modules.$dummy_asserted_argument_spec$ = SubLFiles.deflexical("*DUMMY-ASSERTED-ARGUMENT-SPEC*", maybeDefault((SubLObject)hl_storage_modules.$sym90$_DUMMY_ASSERTED_ARGUMENT_SPEC_, hl_storage_modules.$dummy_asserted_argument_spec$, ()->(arguments.create_asserted_argument_spec((SubLObject)hl_storage_modules.$kw91$UNSPECIFIED))));
        return (SubLObject)hl_storage_modules.NIL;
    }
