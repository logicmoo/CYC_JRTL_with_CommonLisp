...
public final class sdbc extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sdbc_file() {
        ...
        sdbc.$sdbc_database_connection_url_descriptions$ = SubLFiles.deflexical("*SDBC-DATABASE-CONNECTION-URL-DESCRIPTIONS*", maybeDefault((SubLObject)sdbc.$sym282$_SDBC_DATABASE_CONNECTION_URL_DESCRIPTIONS_, sdbc.$sdbc_database_connection_url_descriptions$, ()->(dictionary.new_dictionary((SubLObject)sdbc.EQUAL, (SubLObject)sdbc.UNPROVIDED))));
        sdbc.$sdbc_db2_port$ = SubLFiles.deflexical("*SDBC-DB2-PORT*", (SubLObject)(maybeDefault((SubLObject)sdbc.$sym331$_SDBC_DB2_PORT_, sdbc.$sdbc_db2_port$, sdbc.$int332$50001)));
        sdbc.$sdbc_sybase_iq_port$ = SubLFiles.deflexical("*SDBC-SYBASE-IQ-PORT*", (SubLObject)(maybeDefault((SubLObject)sdbc.$sym338$_SDBC_SYBASE_IQ_PORT_, sdbc.$sdbc_sybase_iq_port$, sdbc.$int339$2638)));
