...
public final class rkf_scenario_manipulator extends SubLTranslatedFile
{
    ...
    public static SubLObject init_rkf_scenario_manipulator_file() {
        ...
        rkf_scenario_manipulator.$sm_isg$ = SubLFiles.deflexical("*SM-ISG*", (rkf_scenario_manipulator.NIL != Symbols.boundp((SubLObject)rkf_scenario_manipulator.$sym3$_SM_ISG_)) ? rkf_scenario_manipulator.$sm_isg$.getGlobalValue() : integer_sequence_generator.new_integer_sequence_generator((SubLObject)rkf_scenario_manipulator.UNPROVIDED, (SubLObject)rkf_scenario_manipulator.UNPROVIDED, (SubLObject)rkf_scenario_manipulator.UNPROVIDED));
        rkf_scenario_manipulator.$sm_index$ = SubLFiles.deflexical("*SM-INDEX*", (rkf_scenario_manipulator.NIL != Symbols.boundp((SubLObject)rkf_scenario_manipulator.$sym4$_SM_INDEX_)) ? rkf_scenario_manipulator.$sm_index$.getGlobalValue() : dictionary.new_dictionary((SubLObject)rkf_scenario_manipulator.UNPROVIDED, (SubLObject)rkf_scenario_manipulator.UNPROVIDED));
