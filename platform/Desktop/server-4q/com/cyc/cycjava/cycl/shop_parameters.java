...
public final class shop_parameters
    extends
      SubLTranslatedFile
{
  ...
  {
    SubLFiles.declareFunction( me, "shop_ask_dynamic_predicateP", "SHOP-ASK-DYNAMIC-PREDICATE?", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_shop_parameters_file()
  {
    $shop_heuristics$ = SubLFiles.deflexical( "*SHOP-HEURISTICS*", dictionary.new_dictionary( Symbols.symbol_function( EQ ), TEN_INTEGER ) );
    $shop_default_depth_limit$ = SubLFiles.defparameter( "*SHOP-DEFAULT-DEPTH-LIMIT*", $int0$500 );
    $shop_default_time_limit$ = SubLFiles.defparameter( "*SHOP-DEFAULT-TIME-LIMIT*", NIL );
    $shop_default_number_limit$ = SubLFiles.defparameter( "*SHOP-DEFAULT-NUMBER-LIMIT*", NIL );
    $shop_use_real_canonicalization$ = SubLFiles.defparameter( "*SHOP-USE-REAL-CANONICALIZATION*", NIL );
    $shop_inference_intermediate_step_validation_level$ = SubLFiles.defparameter( "*SHOP-INFERENCE-INTERMEDIATE-STEP-VALIDATION-LEVEL*", $kw1$NONE );
    $shop_method_cycle_checking_enabledP$ = SubLFiles.defparameter( "*SHOP-METHOD-CYCLE-CHECKING-ENABLED?*", T );
    $shop_use_multibindingsP$ = SubLFiles.defparameter( "*SHOP-USE-MULTIBINDINGS?*", T );
    $shop_hypothesize_modeP$ = SubLFiles.defparameter( "*SHOP-HYPOTHESIZE-MODE?*", NIL );
    $shop_use_mt_world_statesP$ = SubLFiles.defparameter( "*SHOP-USE-MT-WORLD-STATES?*", NIL );
    $shop_infer_complete_preconditionsP$ = SubLFiles.defparameter( "*SHOP-INFER-COMPLETE-PRECONDITIONS?*", T );
    $shop_use_inference_supportsP$ = SubLFiles.defparameter( "*SHOP-USE-INFERENCE-SUPPORTS?*", T );
    $shop_use_shop_askP$ = SubLFiles.defparameter( "*SHOP-USE-SHOP-ASK?*", NIL );
    $shop_object_indexingP$ = SubLFiles.defparameter( "*SHOP-OBJECT-INDEXING?*", T );
    $shop_use_precondition_for_methodP$ = SubLFiles.defparameter( "*SHOP-USE-PRECONDITION-FOR-METHOD?*", T );
    $shop_ask_plan_state$ = SubLFiles.defparameter( "*SHOP-ASK-PLAN-STATE*", NIL );
    $shop_ask_dynamic_predicates$ = SubLFiles.defparameter( "*SHOP-ASK-DYNAMIC-PREDICATES*", NIL );
    $shop_ask_multibinding$ = SubLFiles.defparameter( "*SHOP-ASK-MULTIBINDING*", NIL );
    return NIL;
  }
  ...
  static
  {
    me = new shop_parameters();
    $shop_heuristics$ = null;
    $shop_default_depth_limit$ = null;
    $shop_default_time_limit$ = null;
    $shop_default_number_limit$ = null;
    $shop_use_real_canonicalization$ = null;
    $shop_inference_intermediate_step_validation_level$ = null;
    $shop_method_cycle_checking_enabledP$ = null;
    $shop_use_multibindingsP$ = null;
    $shop_hypothesize_modeP$ = null;
    $shop_use_mt_world_statesP$ = null;
    $shop_infer_complete_preconditionsP$ = null;
    $shop_use_inference_supportsP$ = null;
    $shop_use_shop_askP$ = null;
    $shop_object_indexingP$ = null;
    $shop_use_precondition_for_methodP$ = null;
    $shop_ask_plan_state$ = null;
    $shop_ask_dynamic_predicates$ = null;
    $shop_ask_multibinding$ = null;
    $int0$500 = makeInteger( 500 );
