...
public final class subl_identifier extends SubLTranslatedFile
{
    ...
    public static SubLObject init_subl_identifier_file() {
        subl_identifier.$sublid_domain_to_forts_table$ = SubLFiles.deflexical("*SUBLID-DOMAIN-TO-FORTS-TABLE*", (subl_identifier.NIL != Symbols.boundp((SubLObject)subl_identifier.$sym0$_SUBLID_DOMAIN_TO_FORTS_TABLE_)) ? subl_identifier.$sublid_domain_to_forts_table$.getGlobalValue() : dictionary.new_dictionary((SubLObject)subl_identifier.UNPROVIDED, (SubLObject)subl_identifier.UNPROVIDED));
        subl_identifier.$sublid_id_to_forts_table$ = SubLFiles.deflexical("*SUBLID-ID-TO-FORTS-TABLE*", (subl_identifier.NIL != Symbols.boundp((SubLObject)subl_identifier.$sym1$_SUBLID_ID_TO_FORTS_TABLE_)) ? subl_identifier.$sublid_id_to_forts_table$.getGlobalValue() : dictionary.new_dictionary((SubLObject)subl_identifier.UNPROVIDED, (SubLObject)subl_identifier.UNPROVIDED));
        subl_identifier.$sublid_fort_to_id_table$ = SubLFiles.deflexical("*SUBLID-FORT-TO-ID-TABLE*", (subl_identifier.NIL != Symbols.boundp((SubLObject)subl_identifier.$sym2$_SUBLID_FORT_TO_ID_TABLE_)) ? subl_identifier.$sublid_fort_to_id_table$.getGlobalValue() : dictionary.new_dictionary((SubLObject)subl_identifier.UNPROVIDED, (SubLObject)subl_identifier.UNPROVIDED));
