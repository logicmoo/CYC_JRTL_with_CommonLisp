...
public final class cb_translation_browser
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject cb_td_document(final SubLObject macroform, final SubLObject environment)
  {
    ...
    final SubLObject title_tail = cdestructuring_bind.property_list_member( $kw3$TITLE, current );
    final SubLObject title = ( NIL != title_tail ) ? conses_high.cadr( title_tail ) : NIL;
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.list( $sym4$HTML_DOCUMENT, reader.bq_cons( $sym5$CB_HEAD, ConsesLow.append( ( NIL != title ) ? ConsesLow.list( ConsesLow.list( $sym6$HTML_TITLE, ConsesLow.list( $sym7$HTML_PRINC, title ) ) ) : NIL,
        NIL ) ), ConsesLow.listS( $sym8$HTML_FANCY_BODY, $list9, ConsesLow.append( body, NIL ) ) );
  }
  ...
  public static SubLObject cb_td_show_method(final SubLObject symbol)
  {
    ...
    cb_utilities.cb_link( $kw10$TD_METHOD, symbol, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  {
    html_utilities.html_markup( html_macros.$html_teletype_head$.getGlobalValue() );
    cb_utilities.cb_link( $kw11$TD_GLOBAL, symbol, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    html_utilities.html_markup( html_macros.$html_teletype_tail$.getGlobalValue() );
    return symbol;
  }
  ...
  {
    html_utilities.html_markup( html_macros.$html_teletype_head$.getGlobalValue() );
    cb_utilities.cb_link( $kw12$TD_MODULE, module, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    html_utilities.html_markup( html_macros.$html_teletype_tail$.getGlobalValue() );
    return module;
  }
  ...
  public static SubLObject cb_td_show_access_hint(final SubLObject access)
  {
    ...
    try
    {
      ...
      html_utilities.html_glyph( $kw13$NBSP, UNPROVIDED );
    }
    finally
    {
  ...
  {
    return conses_high.second( conses_high.assoc( access, $cb_td_access_color_map$.getGlobalValue(), UNPROVIDED, UNPROVIDED ) );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject frame_name_var = cb_utilities.cb_frame_name( $kw17$MAIN );
    html_utilities.html_markup( html_macros.$html_anchor_head$.getGlobalValue() );
    html_utilities.html_markup( html_macros.$html_anchor_href$.getGlobalValue() );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    html_utilities.html_princ( $str18$cb_td_tool );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
  ...
  public static SubLObject cb_link_td_search(SubLObject linktext)
  {
    ...
    final SubLObject frame_name_var = cb_utilities.cb_frame_name( $kw23$SELF );
    html_utilities.html_markup( html_macros.$html_anchor_head$.getGlobalValue() );
    html_utilities.html_markup( html_macros.$html_anchor_href$.getGlobalValue() );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    html_utilities.html_princ( $str24$cb_td_search );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    if( NIL != frame_name_var )
    {
      html_utilities.html_markup( html_macros.$html_anchor_target$.getGlobalValue() );
  ...
  public static SubLObject cb_td_search_guts()
  {
    ...
    {
      return cb_utilities.cb_error( $str27$There_is_no_current_SubL_translat, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
    ...
    try
    {
      ...
      html_utilities.html_princ( $str32$Translation_Database_Browser );
      ...
      try
      {
        ...
        try
        {
          ...
          html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
          html_utilities.html_markup( $str33$post );
          html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
          if( NIL != frame_name_var )
          {
          ...
          try
          {
            ...
            html_utilities.html_hidden_input( $str34$cb_td_handle_search, T, UNPROVIDED );
            html_utilities.html_princ_strong( $str32$Translation_Database_Browser );
            html_utilities.html_newline( TWO_INTEGER );
            cb_utilities.cb_link( $kw35$TD_SUMMARY, $str36$_Current_Translation_Summary_, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
            html_utilities.html_newline( TWO_INTEGER );
            ...
            try
            {
              ...
              try
              {
                ...
                html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                html_utilities.html_markup( html_utilities.html_align( $kw38$CENTER ) );
                html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                ...
                {
                  html_macros.$html_safe_print$.bind( T, thread );
                  html_utilities.html_princ( $str39$Find_a_ );
                }
                finally
                {
                ...
                try
                {
                  ...
                  html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                  html_utilities.html_markup( $str40$kind );
                  html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                  ...
                  try
                  {
                    ...
                    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                    html_utilities.html_markup( $str41$method );
                    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                    html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                    ...
                    {
                      html_macros.$html_safe_print$.bind( T, thread );
                      html_utilities.html_princ( $str42$function_or_macro );
                    }
                    finally
                    {
                    ...
                    html_utilities.html_markup( html_macros.$html_option_value$.getGlobalValue() );
                    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                    html_utilities.html_markup( $str43$global );
                    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                    html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                    ...
                    {
                      html_macros.$html_safe_print$.bind( T, thread );
                      html_utilities.html_princ( $str44$global_variable );
                    }
                    finally
                    {
                    ...
                    html_utilities.html_markup( html_macros.$html_option_value$.getGlobalValue() );
                    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                    html_utilities.html_markup( $str45$module );
                    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                    html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                    ...
                    {
                      html_macros.$html_safe_print$.bind( T, thread );
                      html_utilities.html_princ( $str46$source_file );
                    }
                    finally
                    {
                ...
                {
                  html_macros.$html_safe_print$.bind( T, thread );
                  html_utilities.html_princ( $str47$_called );
                }
                finally
                {
            ...
            html_utilities.html_text_input( $str48$name, NIL, $int49$40 );
            html_utilities.html_newline( TWO_INTEGER );
            html_utilities.html_submit_input( $str50$Find_now, UNPROVIDED, UNPROVIDED );
            html_utilities.html_indent( UNPROVIDED );
            html_script_utilities.html_clear_input_button( $str48$name, $str51$Clear_Input, UNPROVIDED );
            html_utilities.html_indent( UNPROVIDED );
  ...
  {
    final SubLObject kind = html_utilities.html_extract_input( $str40$kind, args );
    final SubLObject name = html_utilities.html_extract_input( $str48$name, args );
    if( $str41$method.equal( kind ) )
    {
      return cb_td_method_guts( reader.read_from_string_ignoring_errors( name, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    if( $str43$global.equal( kind ) )
    {
      return cb_td_global_guts( reader.read_from_string_ignoring_errors( name, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    if( $str45$module.equal( kind ) )
    {
  ...
  public static SubLObject cb_link_td_summary(SubLObject linktext)
  {
    ...
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    html_utilities.html_princ( $str55$cb_td_summary );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    if( NIL != frame_name_var )
    {
      html_utilities.html_markup( html_macros.$html_anchor_target$.getGlobalValue() );
  ...
  public static SubLObject cb_td_summary_guts()
  {
    ...
    try
    {
      ...
      html_utilities.html_source_readability_terpri( UNPROVIDED );
      html_utilities.html_markup( html_macros.$html_title_head$.getGlobalValue() );
      html_utilities.html_princ( $str57$Translation_Summary );
      html_utilities.html_markup( html_macros.$html_title_tail$.getGlobalValue() );
      html_utilities.html_markup( html_macros.$html_head_tail$.getGlobalValue() );
      html_utilities.html_source_readability_terpri( UNPROVIDED );
      ...
      try
      {
        ...
        try
        {
          ...
          cb_utilities.cb_link( $kw35$TD_SUMMARY, $str57$Translation_Summary, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          html_utilities.html_markup( html_macros.$html_strong_tail$.getGlobalValue() );
          html_utilities.html_indent( FOUR_INTEGER );
          cb_utilities.cb_link( $kw25$TD_SEARCH, $str58$_Search_Page_, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          html_utilities.html_newline( TWO_INTEGER );
          html_utilities.html_princ( $str59$Features___ );
          ...
          try
          {
            ...
            try
            {
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                html_utilities.html_princ( $str60$Module );
              }
              finally
              {
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                html_utilities.html_princ( $str61$Features );
              }
              finally
              {
            ...
            while ( NIL != cdolist_list_var)
            {
              ...
              try
              {
                ...
                html_utilities.html_markup( html_macros.$html_table_data_valign$.getGlobalValue() );
                html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                html_utilities.html_markup( html_utilities.html_align( $kw62$TOP ) );
                html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
  ...
  public static SubLObject cb_td_show_feature_expression(final SubLObject feature_expression)
  {
    ...
    else
    {
      ...
      cdestructuring_bind.destructuring_bind_must_consp( feature_expression, feature_expression, $list63 );
      operator = feature_expression.first();
      final SubLObject current = sub_expressions = feature_expression.rest();
      html_utilities.html_princ( $str64$_ );
  ...
  public static SubLObject cb_link_td_module(final SubLObject module, SubLObject linktext)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != translator_utilities.td_module_p( module ) : module;
    if( NIL == linktext )
    {
      linktext = module;
    }
    ...
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    html_utilities.html_princ( $str69$cb_td_module_ );
  ...
  public static SubLObject cb_td_module_guts(final SubLObject module)
  {
    ...
    final SubLObject title = PrintLow.format( NIL, $str71$Module____A, module );
    html_utilities.html_markup( $str28$__DOCTYPE_html_PUBLIC_____W3C__DT );
    if( NIL != html_macros.$html_force_ie_standards_mode$.getDynamicValue( thread ) )
    {
      html_utilities.html_source_readability_terpri( UNPROVIDED );
    ...
    try
    {
      ...
      try
      {
        ...
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_princ_strong( $str72$Module___ );
          cb_td_show_module( module );
          html_utilities.html_indent( FOUR_INTEGER );
          cb_utilities.cb_link( $kw25$TD_SEARCH, $str58$_Search_Page_, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          html_utilities.html_newline( TWO_INTEGER );
          html_utilities.html_princ_strong( $str73$Properties );
          ...
          {
            html_utilities.html_hr( UNPROVIDED, UNPROVIDED );
            html_utilities.html_princ_strong( $str74$Definitions );
            html_utilities.html_newline( UNPROVIDED );
            if( NIL != globals )
            {
              html_utilities.html_newline( UNPROVIDED );
              cb_td_show_globals_table( globals, $str75$Globals_defined_in_this_module, $str76$Attributes, $sym77$CB_TD_SHOW_GLOBAL_DEFINITION_ATTRIBUTES );
            }
            if( NIL != v_methods )
            {
              html_utilities.html_newline( UNPROVIDED );
              cb_td_show_methods_table( v_methods, $str78$Methods_defined_in_this_module, $str76$Attributes, $sym79$CB_TD_SHOW_METHOD_DEFINITION_ATTRIBUTES );
            }
          }
          ...
          {
            html_utilities.html_hr( UNPROVIDED, UNPROVIDED );
            html_utilities.html_princ_strong( $str80$Top_Level_References );
            if( NIL != v_methods2 )
            {
              v_methods2 = xref_database.xref_sort_called_methods( v_methods2 );
              html_utilities.html_newline( TWO_INTEGER );
              html_utilities.html_princ( $str81$Methods_called_by_top_level_forms );
            ...
            if( NIL != globals2 )
            {
              ...
              html_utilities.html_newline( TWO_INTEGER );
              html_utilities.html_princ( $str82$Globals_called_by_top_level_forms );
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          html_utilities.html_princ( $str83$Methods );
        ...
        try
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
          html_utilities.html_princ( $str84$File_positions );
          html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
        }
        finally
        {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
          html_utilities.html_princ( $str85$Globals );
          html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
        }
        finally
        {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
          html_utilities.html_princ_strong( $str86$Callers__ );
          html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
        }
        finally
        {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
          html_utilities.html_princ_strong( $str88$Calls__ );
          html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
        }
        finally
        {
  ...
  public static SubLObject cb_td_global(final SubLObject args)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( args, args, $list89 );
    package_string = args.first();
    SubLObject current = args.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, args, $list89 );
    ...
    cdestructuring_bind.cdestructuring_bind_error( args, $list89 );
    return NIL;
  }
  ...
  public static SubLObject cb_link_td_global(final SubLObject symbol, SubLObject linktext)
  {
    ...
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    html_utilities.html_princ( $str92$cb_td_global_ );
    html_utilities.html_url_princ( package_terse_name( Symbols.symbol_package( symbol ) ) );
    html_utilities.html_princ( $str93$_ );
  ...
  public static SubLObject cb_td_global_guts(final SubLObject symbol)
  {
    ...
    final SubLObject title = PrintLow.format( NIL, $str95$Global____S, symbol );
    html_utilities.html_markup( $str28$__DOCTYPE_html_PUBLIC_____W3C__DT );
    if( NIL != html_macros.$html_force_ie_standards_mode$.getDynamicValue( thread ) )
    {
      html_utilities.html_source_readability_terpri( UNPROVIDED );
    ...
    try
    {
      ...
      try
      {
        ...
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_princ_strong( $str96$Global_Variable___ );
          cb_td_show_global( symbol );
          html_utilities.html_indent( FOUR_INTEGER );
          html_utilities.html_princ( $str97$Access___ );
          ...
          html_utilities.html_newline( TWO_INTEGER );
          html_utilities.html_princ_strong( $str98$Definition );
          html_utilities.html_newline( UNPROVIDED );
          if( NIL != module )
          {
            cb_td_show_module_section( module, position );
          }
          else if( NIL != Symbols.boundp( symbol ) )
          {
            html_utilities.html_princ( $str99$Internal_variable );
          }
          else
          {
            html_utilities.html_princ( $str100$Undefined_variable );
          }
          ...
          if( NIL != v_methods || NIL != globals || NIL != v_modules )
          {
            ...
            if( NIL != v_methods )
            {
              ...
              html_utilities.html_newline( UNPROVIDED );
              cb_td_show_methods_table( v_methods, $str101$Methods_that_reference_this_globa, $str60$Module, $sym102$CB_TD_SHOW_METHOD_DEFINING_MODULE );
            }
            if( NIL != globals )
            {
              globals = xref_database.xref_sort_calling_globals( globals );
              html_utilities.html_newline( UNPROVIDED );
              cb_td_show_globals_table( globals, $str103$Globals_whose_initialization_refe, $str60$Module, $sym104$CB_TD_SHOW_GLOBAL_DEFINING_MODULE );
            }
            if( NIL != v_modules )
            {
          ...
          if( NIL != v_methods || NIL != globals )
          {
            ...
            if( NIL != v_methods )
            {
              ...
              html_utilities.html_newline( UNPROVIDED );
              cb_td_show_methods_table( v_methods, $str106$Methods_called_in_the_initializat, $str60$Module, $sym102$CB_TD_SHOW_METHOD_DEFINING_MODULE );
            }
            if( NIL != globals )
            {
              globals = xref_database.xref_sort_called_globals( globals );
              html_utilities.html_newline( UNPROVIDED );
              cb_td_show_globals_table( globals, $str107$Globals_referenced_in_the_initial, $str60$Module, $sym104$CB_TD_SHOW_GLOBAL_DEFINING_MODULE );
            }
          }
          html_utilities.html_source_readability_terpri( UNPROVIDED );
          html_utilities.html_copyright_notice();
  ...
  public static SubLObject cb_link_td_method(final SubLObject symbol, SubLObject linktext)
  {
    ...
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    html_utilities.html_princ( $str109$cb_td_method_ );
    html_utilities.html_url_princ( package_terse_name( Symbols.symbol_package( symbol ) ) );
    html_utilities.html_princ( $str93$_ );
    html_utilities.html_url_princ( Symbols.symbol_name( symbol ) );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
  ...
  public static SubLObject cb_td_method_guts(final SubLObject symbol)
  {
    ...
    final SubLObject title = PrintLow.format( NIL, $str111$Method____S, symbol );
    html_utilities.html_markup( $str28$__DOCTYPE_html_PUBLIC_____W3C__DT );
    if( NIL != html_macros.$html_force_ie_standards_mode$.getDynamicValue( thread ) )
    {
      html_utilities.html_source_readability_terpri( UNPROVIDED );
    ...
    try
    {
      ...
      try
      {
        ...
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_princ_strong( $str112$Method___ );
          ...
          html_utilities.html_newline( UNPROVIDED );
          html_utilities.html_glyph( $kw13$NBSP, UNPROVIDED );
          html_utilities.html_princ( $str113$Arglist___ );
          html_utilities.html_markup( html_macros.$html_code_head$.getGlobalValue() );
          cb_utilities.cb_form( translator_utilities.td_method_formal_arglist( symbol ), UNPROVIDED, UNPROVIDED );
          ...
          else if( NIL != Symbols.fboundp( symbol ) )
          {
            html_utilities.html_princ( $str114$Internal_method );
          }
          else
          {
            html_utilities.html_princ( $str115$Undefined_method );
          }
          ...
          if( NIL != v_methods || NIL != globals || NIL != v_modules )
          {
            ...
            if( NIL != v_methods )
            {
              v_methods = xref_database.xref_sort_calling_methods( v_methods );
              html_utilities.html_newline( UNPROVIDED );
              cb_td_show_methods_table( v_methods, $str116$Methods_that_call_this_method, $str60$Module, $sym102$CB_TD_SHOW_METHOD_DEFINING_MODULE );
            }
            if( NIL != globals )
            {
              globals = xref_database.xref_sort_calling_globals( globals );
              html_utilities.html_newline( UNPROVIDED );
              cb_td_show_globals_table( globals, $str117$Globals_whose_initialization_call, $str60$Module, $sym104$CB_TD_SHOW_GLOBAL_DEFINING_MODULE );
            }
            if( NIL != v_modules )
            {
          ...
          if( NIL != v_methods || NIL != globals )
          {
            ...
            if( NIL != v_methods )
            {
              v_methods = xref_database.xref_sort_called_methods( v_methods );
              html_utilities.html_newline( UNPROVIDED );
              cb_td_show_methods_table( v_methods, $str119$Methods_called_by_this_method, $str60$Module, $sym102$CB_TD_SHOW_METHOD_DEFINING_MODULE );
            }
            if( NIL != globals )
            {
              globals = xref_database.xref_sort_called_globals( globals );
              html_utilities.html_newline( UNPROVIDED );
              cb_td_show_globals_table( globals, $str120$Globals_referenced_by_this_method, $str60$Module, $sym104$CB_TD_SHOW_GLOBAL_DEFINING_MODULE );
            }
          }
          html_utilities.html_source_readability_terpri( UNPROVIDED );
          html_utilities.html_copyright_notice();
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $package_terse_name_caching_state$.getGlobalValue(), ConsesLow.list( v_package ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/cb-translation-browser.lisp", position = 20936L)
  public static SubLObject package_terse_name_internal(final SubLObject v_package)
  {
    assert NIL != Types.packagep( v_package ) : v_package;
  ...
  public static SubLObject package_terse_name(final SubLObject v_package)
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym121$PACKAGE_TERSE_NAME, $sym123$_PACKAGE_TERSE_NAME_CACHING_STATE_, NIL, EQ, ONE_INTEGER, TEN_INTEGER );
    }
    ...
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( package_terse_name_internal( v_package ) ) );
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $prin1_symbol_to_string_caching_state$.getGlobalValue(), ConsesLow.list( symbol ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject prin1_symbol_to_string_internal(final SubLObject symbol)
  {
    ...
    if( NIL == v_package )
    {
      return PrintLow.format( NIL, $str125$___A, Symbols.symbol_name( symbol ) );
    }
    return PrintLow.format( NIL, $str126$_A___A, package_terse_name( v_package ), Symbols.symbol_name( symbol ) );
  }
  ...
  public static SubLObject prin1_symbol_to_string(final SubLObject symbol)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym124$PRIN1_SYMBOL_TO_STRING, $sym127$_PRIN1_SYMBOL_TO_STRING_CACHING_STATE_, NIL, EQ, ONE_INTEGER, TEN_INTEGER );
    }
    ...
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( prin1_symbol_to_string_internal( symbol ) ) );
    ...
    if( NIL != module )
    {
      ...
      try
      {
        ...
        try
        {
          ...
          {
            html_macros.$html_safe_print$.bind( T, thread );
            html_utilities.html_princ( $str72$Module___ );
          }
          finally
          {
        ...
        if( NIL != position )
        {
          ...
          try
          {
            ...
            {
              html_macros.$html_safe_print$.bind( T, thread );
              html_utilities.html_princ( $str128$Position___ );
            }
            finally
            {
        ...
        if( NIL != pathname )
        {
          ...
          try
          {
            ...
            {
              html_macros.$html_safe_print$.bind( T, thread );
              html_utilities.html_princ( $str129$Pathname___ );
            }
            finally
            {
  ...
  public static SubLObject cb_td_show_methods_table(final SubLObject v_methods, final SubLObject method_title, final SubLObject value_title, final SubLObject value_function)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_glyph( $kw13$NBSP, TWO_INTEGER );
        }
        finally
        {
  ...
  public static SubLObject cb_td_show_method_definition_attributes(final SubLObject method)
  {
    ...
    {
      attributes = ConsesLow.cons( $str130$macro, attributes );
    }
    if( NIL != translator_utilities.td_method_unused_p( method ) )
    {
      attributes = ConsesLow.cons( $str131$no_callers, attributes );
    }
    else if( NIL != translator_utilities.td_method_potentially_private_p( method ) )
    {
      attributes = ConsesLow.cons( $str132$no_external_callers, attributes );
    }
  ...
  public static SubLObject cb_td_show_global_definition_attributes(final SubLObject global)
  {
    ...
    if( pcase_var.eql( $kw133$CONSTANT ) )
    {
      attributes = ConsesLow.cons( $str134$constant, attributes );
    }
    else if( pcase_var.eql( $kw135$LEXICAL ) )
    {
      attributes = ConsesLow.cons( $str136$lexical, attributes );
    }
    else if( pcase_var.eql( $kw137$SPECIAL ) )
    {
      attributes = ConsesLow.cons( $str138$special, attributes );
    }
    if( NIL != translator_utilities.td_global_unused_p( global ) )
    {
      attributes = ConsesLow.cons( $str131$no_callers, attributes );
    }
    else if( NIL != translator_utilities.td_global_potentially_private_p( global ) )
    {
      attributes = ConsesLow.cons( $str132$no_external_callers, attributes );
    }
    attributes = Sequences.nreverse( attributes );
  ...
  {
    SubLFiles.declareMacro( me, "cb_td_document", "CB-TD-DOCUMENT" );
    SubLFiles.declareFunction( me, "cb_td_show_method", "CB-TD-SHOW-METHOD", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_global", "CB-TD-SHOW-GLOBAL", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_module", "CB-TD-SHOW-MODULE", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_faccess", "CB-TD-SHOW-FACCESS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_vaccess", "CB-TD-SHOW-VACCESS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_faccess_hint", "CB-TD-SHOW-FACCESS-HINT", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_vaccess_hint", "CB-TD-SHOW-VACCESS-HINT", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_access_hint", "CB-TD-SHOW-ACCESS-HINT", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_access_color", "CB-TD-ACCESS-COLOR", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_module_pathname", "CB-TD-SHOW-MODULE-PATHNAME", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_tool", "CB-TD-TOOL", 0, 1, false );
    SubLFiles.declareFunction( me, "cb_link_td_tool", "CB-LINK-TD-TOOL", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_search", "CB-TD-SEARCH", 0, 1, false );
    SubLFiles.declareFunction( me, "cb_link_td_search", "CB-LINK-TD-SEARCH", 0, 1, false );
    SubLFiles.declareFunction( me, "cb_td_search_guts", "CB-TD-SEARCH-GUTS", 0, 0, false );
    SubLFiles.declareFunction( me, "cb_td_handle_search", "CB-TD-HANDLE-SEARCH", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_summary", "CB-TD-SUMMARY", 0, 1, false );
    SubLFiles.declareFunction( me, "cb_link_td_summary", "CB-LINK-TD-SUMMARY", 0, 1, false );
    SubLFiles.declareFunction( me, "cb_td_summary_guts", "CB-TD-SUMMARY-GUTS", 0, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_translation_features", "CB-TD-SHOW-TRANSLATION-FEATURES", 0, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_module_features", "CB-TD-SHOW-MODULE-FEATURES", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_feature_expression", "CB-TD-SHOW-FEATURE-EXPRESSION", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_module", "CB-TD-MODULE", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_td_module", "CB-LINK-TD-MODULE", 1, 1, false );
    SubLFiles.declareFunction( me, "cb_td_module_guts", "CB-TD-MODULE-GUTS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_top_level_methods_table", "CB-TD-SHOW-TOP-LEVEL-METHODS-TABLE", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_top_level_globals_table", "CB-TD-SHOW-TOP-LEVEL-GLOBALS-TABLE", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_referenced_by_module_section", "CB-TD-SHOW-REFERENCED-BY-MODULE-SECTION", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_module_referenced_by_module", "CB-TD-SHOW-MODULE-REFERENCED-BY-MODULE", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_references_module_section", "CB-TD-SHOW-REFERENCES-MODULE-SECTION", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_module_references_module", "CB-TD-SHOW-MODULE-REFERENCES-MODULE", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_td_global", "CB-TD-GLOBAL", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_td_global", "CB-LINK-TD-GLOBAL", 1, 1, false );
    SubLFiles.declareFunction( me, "cb_td_global_guts", "CB-TD-GLOBAL-GUTS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_method", "CB-TD-METHOD", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_td_method", "CB-LINK-TD-METHOD", 1, 1, false );
    SubLFiles.declareFunction( me, "cb_td_method_guts", "CB-TD-METHOD-GUTS", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_package_terse_name", "CLEAR-PACKAGE-TERSE-NAME", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_package_terse_name", "REMOVE-PACKAGE-TERSE-NAME", 1, 0, false );
    SubLFiles.declareFunction( me, "package_terse_name_internal", "PACKAGE-TERSE-NAME-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "package_terse_name", "PACKAGE-TERSE-NAME", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_prin1_symbol_to_string", "CLEAR-PRIN1-SYMBOL-TO-STRING", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_prin1_symbol_to_string", "REMOVE-PRIN1-SYMBOL-TO-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "prin1_symbol_to_string_internal", "PRIN1-SYMBOL-TO-STRING-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "prin1_symbol_to_string", "PRIN1-SYMBOL-TO-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_module_section", "CB-TD-SHOW-MODULE-SECTION", 1, 1, false );
    SubLFiles.declareFunction( me, "cb_td_show_module_properties", "CB-TD-SHOW-MODULE-PROPERTIES", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_methods_table", "CB-TD-SHOW-METHODS-TABLE", 4, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_globals_table", "CB-TD-SHOW-GLOBALS-TABLE", 4, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_modules_table", "CB-TD-SHOW-MODULES-TABLE", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_method_defining_module", "CB-TD-SHOW-METHOD-DEFINING-MODULE", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_global_defining_module", "CB-TD-SHOW-GLOBAL-DEFINING-MODULE", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_method_definition_attributes", "CB-TD-SHOW-METHOD-DEFINITION-ATTRIBUTES", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_global_definition_attributes", "CB-TD-SHOW-GLOBAL-DEFINITION-ATTRIBUTES", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_td_show_attribute_list", "CB-TD-SHOW-ATTRIBUTE-LIST", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_cb_translation_browser_file()
  {
    $cb_td_access_color_map$ = SubLFiles.deflexical( "*CB-TD-ACCESS-COLOR-MAP*", $list14 );
    $package_terse_name_caching_state$ = SubLFiles.deflexical( "*PACKAGE-TERSE-NAME-CACHING-STATE*", NIL );
    $prin1_symbol_to_string_caching_state$ = SubLFiles.deflexical( "*PRIN1-SYMBOL-TO-STRING-CACHING-STATE*", NIL );
    return NIL;
  }

  public static SubLObject setup_cb_translation_browser_file()
  {
    html_macros.note_cgi_handler_function( $sym15$CB_TD_TOOL, $kw16$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw19$TD_TOOL, $sym20$CB_LINK_TD_TOOL, ONE_INTEGER );
    html_macros.note_cgi_handler_function( $sym21$CB_TD_SEARCH, $kw16$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw25$TD_SEARCH, $sym26$CB_LINK_TD_SEARCH, ONE_INTEGER );
    html_macros.note_cgi_handler_function( $sym52$CB_TD_HANDLE_SEARCH, $kw16$HTML_HANDLER );
    html_macros.note_cgi_handler_function( $sym53$CB_TD_SUMMARY, $kw16$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw35$TD_SUMMARY, $sym56$CB_LINK_TD_SUMMARY, ONE_INTEGER );
    html_macros.note_cgi_handler_function( $sym67$CB_TD_MODULE, $kw16$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw12$TD_MODULE, $sym70$CB_LINK_TD_MODULE, TWO_INTEGER );
    html_macros.note_cgi_handler_function( $sym90$CB_TD_GLOBAL, $kw16$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw11$TD_GLOBAL, $sym94$CB_LINK_TD_GLOBAL, TWO_INTEGER );
    html_macros.note_cgi_handler_function( $sym108$CB_TD_METHOD, $kw16$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw10$TD_METHOD, $sym110$CB_LINK_TD_METHOD, TWO_INTEGER );
    memoization_state.note_globally_cached_function( $sym121$PACKAGE_TERSE_NAME );
    memoization_state.note_globally_cached_function( $sym124$PRIN1_SYMBOL_TO_STRING );
    return NIL;
  }
  ...
  static
  {
    me = new cb_translation_browser();
    $cb_td_access_color_map$ = null;
    $package_terse_name_caching_state$ = null;
    $prin1_symbol_to_string_caching_state$ = null;
    $list0 = ConsesLow.list( ConsesLow.list( makeSymbol( "&KEY" ), makeSymbol( "TITLE" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $list1 = ConsesLow.list( makeKeyword( "TITLE" ) );
    $kw2$ALLOW_OTHER_KEYS = makeKeyword( "ALLOW-OTHER-KEYS" );
    $kw3$TITLE = makeKeyword( "TITLE" );
    $sym4$HTML_DOCUMENT = makeSymbol( "HTML-DOCUMENT" );
    $sym5$CB_HEAD = makeSymbol( "CB-HEAD" );
    $sym6$HTML_TITLE = makeSymbol( "HTML-TITLE" );
    $sym7$HTML_PRINC = makeSymbol( "HTML-PRINC" );
    $sym8$HTML_FANCY_BODY = makeSymbol( "HTML-FANCY-BODY" );
    $list9 = ConsesLow.list( makeKeyword( "SHOW-COPYRIGHT" ), T );
    $kw10$TD_METHOD = makeKeyword( "TD-METHOD" );
    $kw11$TD_GLOBAL = makeKeyword( "TD-GLOBAL" );
    $kw12$TD_MODULE = makeKeyword( "TD-MODULE" );
    $kw13$NBSP = makeKeyword( "NBSP" );
    $list14 = ConsesLow.list( ConsesLow.list( makeSymbol( "PRIVATE" ), makeString( "FF7F7F" ) ), ConsesLow.list( makeSymbol( "PROTECTED" ), makeString( "FFFF7F" ) ), ConsesLow.list( makeSymbol( "PUBLIC" ), makeString(
        "7FFF7F" ) ) );
    $sym15$CB_TD_TOOL = makeSymbol( "CB-TD-TOOL" );
    $kw16$HTML_HANDLER = makeKeyword( "HTML-HANDLER" );
    $kw17$MAIN = makeKeyword( "MAIN" );
    $str18$cb_td_tool = makeString( "cb-td-tool" );
    $kw19$TD_TOOL = makeKeyword( "TD-TOOL" );
    $sym20$CB_LINK_TD_TOOL = makeSymbol( "CB-LINK-TD-TOOL" );
    $sym21$CB_TD_SEARCH = makeSymbol( "CB-TD-SEARCH" );
    $str22$_Translation_Database_Browser_ = makeString( "[Translation Database Browser]" );
    $kw23$SELF = makeKeyword( "SELF" );
    $str24$cb_td_search = makeString( "cb-td-search" );
    $kw25$TD_SEARCH = makeKeyword( "TD-SEARCH" );
    $sym26$CB_LINK_TD_SEARCH = makeSymbol( "CB-LINK-TD-SEARCH" );
    $str27$There_is_no_current_SubL_translat = makeString( "There is no current SubL translation state." );
    ...
    $str32$Translation_Database_Browser = makeString( "Translation Database Browser" );
    $str33$post = makeString( "post" );
    $str34$cb_td_handle_search = makeString( "cb-td-handle-search" );
    $kw35$TD_SUMMARY = makeKeyword( "TD-SUMMARY" );
    $str36$_Current_Translation_Summary_ = makeString( "[Current Translation Summary]" );
    $kw37$LEFT = makeKeyword( "LEFT" );
    $kw38$CENTER = makeKeyword( "CENTER" );
    $str39$Find_a_ = makeString( "Find a " );
    $str40$kind = makeString( "kind" );
    $str41$method = makeString( "method" );
    $str42$function_or_macro = makeString( "function or macro" );
    $str43$global = makeString( "global" );
    $str44$global_variable = makeString( "global variable" );
    $str45$module = makeString( "module" );
    $str46$source_file = makeString( "source file" );
    $str47$_called = makeString( " called" );
    $str48$name = makeString( "name" );
    $int49$40 = makeInteger( 40 );
    $str50$Find_now = makeString( "Find now" );
    $str51$Clear_Input = makeString( "Clear Input" );
    $sym52$CB_TD_HANDLE_SEARCH = makeSymbol( "CB-TD-HANDLE-SEARCH" );
    $sym53$CB_TD_SUMMARY = makeSymbol( "CB-TD-SUMMARY" );
    $str54$_Summary_ = makeString( "[Summary]" );
    $str55$cb_td_summary = makeString( "cb-td-summary" );
    $sym56$CB_LINK_TD_SUMMARY = makeSymbol( "CB-LINK-TD-SUMMARY" );
    $str57$Translation_Summary = makeString( "Translation Summary" );
    $str58$_Search_Page_ = makeString( "[Search Page]" );
    $str59$Features___ = makeString( "Features : " );
    $str60$Module = makeString( "Module" );
    $str61$Features = makeString( "Features" );
    $kw62$TOP = makeKeyword( "TOP" );
    $list63 = ConsesLow.cons( makeSymbol( "OPERATOR" ), makeSymbol( "SUB-EXPRESSIONS" ) );
    $str64$_ = makeString( "(" );
    $str65$_ = makeString( ")" );
    $list66 = ConsesLow.list( makeSymbol( "MODULE" ) );
    $sym67$CB_TD_MODULE = makeSymbol( "CB-TD-MODULE" );
    $sym68$TD_MODULE_P = makeSymbol( "TD-MODULE-P" );
    $str69$cb_td_module_ = makeString( "cb-td-module|" );
    $sym70$CB_LINK_TD_MODULE = makeSymbol( "CB-LINK-TD-MODULE" );
    $str71$Module____A = makeString( "Module : ~A" );
    $str72$Module___ = makeString( "Module : " );
    $str73$Properties = makeString( "Properties" );
    $str74$Definitions = makeString( "Definitions" );
    $str75$Globals_defined_in_this_module = makeString( "Globals defined in this module" );
    $str76$Attributes = makeString( "Attributes" );
    $sym77$CB_TD_SHOW_GLOBAL_DEFINITION_ATTRIBUTES = makeSymbol( "CB-TD-SHOW-GLOBAL-DEFINITION-ATTRIBUTES" );
    $str78$Methods_defined_in_this_module = makeString( "Methods defined in this module" );
    $sym79$CB_TD_SHOW_METHOD_DEFINITION_ATTRIBUTES = makeSymbol( "CB-TD-SHOW-METHOD-DEFINITION-ATTRIBUTES" );
    $str80$Top_Level_References = makeString( "Top-Level References" );
    $str81$Methods_called_by_top_level_forms = makeString( "Methods called by top-level forms in this module" );
    $str82$Globals_called_by_top_level_forms = makeString( "Globals called by top-level forms in this module" );
    $str83$Methods = makeString( "Methods" );
    $str84$File_positions = makeString( "File positions" );
    $str85$Globals = makeString( "Globals" );
    $str86$Callers__ = makeString( "Callers :" );
    $str87$__ = makeString( ", " );
    $str88$Calls__ = makeString( "Calls :" );
    $list89 = ConsesLow.list( makeSymbol( "PACKAGE-STRING" ), makeSymbol( "SYMBOL-STRING" ) );
    $sym90$CB_TD_GLOBAL = makeSymbol( "CB-TD-GLOBAL" );
    $sym91$SYMBOLP = makeSymbol( "SYMBOLP" );
    $str92$cb_td_global_ = makeString( "cb-td-global|" );
    $str93$_ = makeString( "|" );
    $sym94$CB_LINK_TD_GLOBAL = makeSymbol( "CB-LINK-TD-GLOBAL" );
    $str95$Global____S = makeString( "Global : ~S" );
    $str96$Global_Variable___ = makeString( "Global Variable : " );
    $str97$Access___ = makeString( "Access : " );
    $str98$Definition = makeString( "Definition" );
    $str99$Internal_variable = makeString( "Internal variable" );
    $str100$Undefined_variable = makeString( "Undefined variable" );
    $str101$Methods_that_reference_this_globa = makeString( "Methods that reference this global" );
    $sym102$CB_TD_SHOW_METHOD_DEFINING_MODULE = makeSymbol( "CB-TD-SHOW-METHOD-DEFINING-MODULE" );
    $str103$Globals_whose_initialization_refe = makeString( "Globals whose initialization references this global" );
    $sym104$CB_TD_SHOW_GLOBAL_DEFINING_MODULE = makeSymbol( "CB-TD-SHOW-GLOBAL-DEFINING-MODULE" );
    $str105$Modules_that_reference_this_globa = makeString( "Modules that reference this global from top-level forms" );
    $str106$Methods_called_in_the_initializat = makeString( "Methods called in the initialization of this global" );
    $str107$Globals_referenced_in_the_initial = makeString( "Globals referenced in the initialization of this global" );
    $sym108$CB_TD_METHOD = makeSymbol( "CB-TD-METHOD" );
    $str109$cb_td_method_ = makeString( "cb-td-method|" );
    $sym110$CB_LINK_TD_METHOD = makeSymbol( "CB-LINK-TD-METHOD" );
    $str111$Method____S = makeString( "Method : ~S" );
    $str112$Method___ = makeString( "Method : " );
    $str113$Arglist___ = makeString( "Arglist : " );
    $str114$Internal_method = makeString( "Internal method" );
    $str115$Undefined_method = makeString( "Undefined method" );
    $str116$Methods_that_call_this_method = makeString( "Methods that call this method" );
    $str117$Globals_whose_initialization_call = makeString( "Globals whose initialization calls this method" );
    $str118$Modules_that_call_this_method_fro = makeString( "Modules that call this method from top-level forms" );
    $str119$Methods_called_by_this_method = makeString( "Methods called by this method" );
    $str120$Globals_referenced_by_this_method = makeString( "Globals referenced by this method" );
    $sym121$PACKAGE_TERSE_NAME = makeSymbol( "PACKAGE-TERSE-NAME" );
    $sym122$PACKAGEP = makeSymbol( "PACKAGEP" );
    $sym123$_PACKAGE_TERSE_NAME_CACHING_STATE_ = makeSymbol( "*PACKAGE-TERSE-NAME-CACHING-STATE*" );
    $sym124$PRIN1_SYMBOL_TO_STRING = makeSymbol( "PRIN1-SYMBOL-TO-STRING" );
    $str125$___A = makeString( "#:~A" );
    $str126$_A___A = makeString( "~A::~A" );
    $sym127$_PRIN1_SYMBOL_TO_STRING_CACHING_STATE_ = makeSymbol( "*PRIN1-SYMBOL-TO-STRING-CACHING-STATE*" );
    $str128$Position___ = makeString( "Position : " );
    $str129$Pathname___ = makeString( "Pathname : " );
    $str130$macro = makeString( "macro" );
    $str131$no_callers = makeString( "no callers" );
    $str132$no_external_callers = makeString( "no external callers" );
    $kw133$CONSTANT = makeKeyword( "CONSTANT" );
    $str134$constant = makeString( "constant" );
    $kw135$LEXICAL = makeKeyword( "LEXICAL" );
    $str136$lexical = makeString( "lexical" );
    $kw137$SPECIAL = makeKeyword( "SPECIAL" );
    $str138$special = makeString( "special" );
  }
}
/*
 * 
