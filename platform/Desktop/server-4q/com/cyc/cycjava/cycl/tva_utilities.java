...
public final class tva_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_tva_utilities_file() {
        ...
        tva_utilities.$tva_precomputes_sksi_closuresP$ = SubLFiles.deflexical("*TVA-PRECOMPUTES-SKSI-CLOSURES?*", (SubLObject)(maybeDefault((SubLObject)tva_utilities.$sym7$_TVA_PRECOMPUTES_SKSI_CLOSURES__, tva_utilities.$tva_precomputes_sksi_closuresP$, tva_utilities.NIL)));
        tva_utilities.$tva_iterates_kb_predicate_extentP$ = SubLFiles.deflexical("*TVA-ITERATES-KB-PREDICATE-EXTENT?*", (SubLObject)(maybeDefault((SubLObject)tva_utilities.$sym8$_TVA_ITERATES_KB_PREDICATE_EXTENT__, tva_utilities.$tva_iterates_kb_predicate_extentP$, tva_utilities.T)));
        tva_utilities.$tva_iterates_sksi_predicate_extentP$ = SubLFiles.deflexical("*TVA-ITERATES-SKSI-PREDICATE-EXTENT?*", (SubLObject)(maybeDefault((SubLObject)tva_utilities.$sym9$_TVA_ITERATES_SKSI_PREDICATE_EXTENT__, tva_utilities.$tva_iterates_sksi_predicate_extentP$, tva_utilities.NIL)));
