...
public final class folification extends SubLTranslatedFile
{
    ...
    public static SubLObject init_folification_file() {
        ...
        folification.$tptp_long_symbol_name_cache$ = SubLFiles.deflexical("*TPTP-LONG-SYMBOL-NAME-CACHE*", maybeDefault((SubLObject)folification.$sym334$_TPTP_LONG_SYMBOL_NAME_CACHE_, folification.$tptp_long_symbol_name_cache$, ()->(Hashtables.make_hash_table((SubLObject)folification.$int335$256, Symbols.symbol_function((SubLObject)folification.EQUAL), (SubLObject)folification.UNPROVIDED))));
