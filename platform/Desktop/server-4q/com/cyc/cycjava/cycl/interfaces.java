...
public final class interfaces extends SubLTranslatedFile
{
    ...
    public static SubLObject init_interfaces_file() {
        ...
        interfaces.$interfaces_interface_table$ = SubLFiles.deflexical("*INTERFACES-INTERFACE-TABLE*", (interfaces.NIL != Symbols.boundp((SubLObject)interfaces.$sym2$_INTERFACES_INTERFACE_TABLE_)) ? interfaces.$interfaces_interface_table$.getGlobalValue() : Hashtables.make_hash_table(interfaces.$interfaces_initial_hashtable_size$.getGlobalValue(), (SubLObject)interfaces.UNPROVIDED, (SubLObject)interfaces.UNPROVIDED));
        interfaces.$interfaces_alist_of_all_interfaces$ = SubLFiles.deflexical("*INTERFACES-ALIST-OF-ALL-INTERFACES*", (SubLObject)((interfaces.NIL != Symbols.boundp((SubLObject)interfaces.$sym3$_INTERFACES_ALIST_OF_ALL_INTERFACES_)) ? interfaces.$interfaces_alist_of_all_interfaces$.getGlobalValue() : interfaces.NIL));
