...
public final class random_thought_generator extends SubLTranslatedFile
{
    ...
    public static SubLObject init_random_thought_generator_file() {
        ...
        random_thought_generator.$remote_random_thought_image$ = SubLFiles.deflexical("*REMOTE-RANDOM-THOUGHT-IMAGE*", (SubLObject)(maybeDefault((SubLObject)random_thought_generator.$sym41$_REMOTE_RANDOM_THOUGHT_IMAGE_, random_thought_generator.$remote_random_thought_image$, random_thought_generator.NIL)));
        random_thought_generator.$remote_random_thought_connection_pool$ = SubLFiles.deflexical("*REMOTE-RANDOM-THOUGHT-CONNECTION-POOL*", maybeDefault((SubLObject)random_thought_generator.$sym43$_REMOTE_RANDOM_THOUGHT_CONNECTION_POOL_, random_thought_generator.$remote_random_thought_connection_pool$, ()->(queues.create_queue((SubLObject)random_thought_generator.UNPROVIDED))));
        ...
        random_thought_generator.$random_thought_generators_for_users$ = SubLFiles.deflexical("*RANDOM-THOUGHT-GENERATORS-FOR-USERS*", maybeDefault((SubLObject)random_thought_generator.$sym55$_RANDOM_THOUGHT_GENERATORS_FOR_USERS_, random_thought_generator.$random_thought_generators_for_users$, ()->(dictionary.new_dictionary((SubLObject)random_thought_generator.UNPROVIDED, (SubLObject)random_thought_generator.UNPROVIDED))));
