...
public final class rkf_query_constructor extends SubLTranslatedFile
{
    ...
    public static SubLObject init_rkf_query_constructor_file() {
        ...
        rkf_query_constructor.$qc_isg$ = SubLFiles.deflexical("*QC-ISG*", maybeDefault((SubLObject)rkf_query_constructor.$sym3$_QC_ISG_, rkf_query_constructor.$qc_isg$, ()->(integer_sequence_generator.new_integer_sequence_generator((SubLObject)rkf_query_constructor.UNPROVIDED, (SubLObject)rkf_query_constructor.UNPROVIDED, (SubLObject)rkf_query_constructor.UNPROVIDED))));
        rkf_query_constructor.$qc_index$ = SubLFiles.deflexical("*QC-INDEX*", maybeDefault((SubLObject)rkf_query_constructor.$sym4$_QC_INDEX_, rkf_query_constructor.$qc_index$, ()->(dictionary.new_dictionary((SubLObject)rkf_query_constructor.UNPROVIDED, (SubLObject)rkf_query_constructor.UNPROVIDED))));
