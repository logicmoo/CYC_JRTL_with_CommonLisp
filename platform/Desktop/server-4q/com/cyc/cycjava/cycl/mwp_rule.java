...
public final class mwp_rule extends SubLTranslatedFile
{
    ...
    public static SubLObject init_mwp_rule_file() {
        mwp_rule.$mwp_rule_constraint_table_deriv$ = SubLFiles.deflexical("*MWP-RULE-CONSTRAINT-TABLE-DERIV*", maybeDefault((SubLObject)mwp_rule.$sym8$_MWP_RULE_CONSTRAINT_TABLE_DERIV_, mwp_rule.$mwp_rule_constraint_table_deriv$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)mwp_rule.EQL), (SubLObject)mwp_rule.$int9$256))));
        mwp_rule.$mwp_rule_constraint_table_infl$ = SubLFiles.deflexical("*MWP-RULE-CONSTRAINT-TABLE-INFL*", maybeDefault((SubLObject)mwp_rule.$sym10$_MWP_RULE_CONSTRAINT_TABLE_INFL_, mwp_rule.$mwp_rule_constraint_table_infl$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)mwp_rule.EQL), (SubLObject)mwp_rule.$int9$256))));
        ...
        mwp_rule.$mwp_rule_spec_table_deriv$ = SubLFiles.deflexical("*MWP-RULE-SPEC-TABLE-DERIV*", maybeDefault((SubLObject)mwp_rule.$sym24$_MWP_RULE_SPEC_TABLE_DERIV_, mwp_rule.$mwp_rule_spec_table_deriv$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)mwp_rule.EQL), (SubLObject)mwp_rule.$int9$256))));
        mwp_rule.$mwp_rule_spec_table_infl$ = SubLFiles.deflexical("*MWP-RULE-SPEC-TABLE-INFL*", maybeDefault((SubLObject)mwp_rule.$sym25$_MWP_RULE_SPEC_TABLE_INFL_, mwp_rule.$mwp_rule_spec_table_infl$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)mwp_rule.EQL), (SubLObject)mwp_rule.$int9$256))));
