...
public final class tva_cache extends SubLTranslatedFile
{
    ...
    public static SubLObject init_tva_cache_file() {
        ...
        tva_cache.$swappable_tva_cache_lock$ = SubLFiles.deflexical("*SWAPPABLE-TVA-CACHE-LOCK*", (SubLObject)(maybeDefault((SubLObject)tva_cache.$sym53$_SWAPPABLE_TVA_CACHE_LOCK_, tva_cache.$swappable_tva_cache_lock$, tva_cache.NIL)));
        tva_cache.$tva_cache_registry$ = SubLFiles.deflexical("*TVA-CACHE-REGISTRY*", maybeDefault((SubLObject)tva_cache.$sym56$_TVA_CACHE_REGISTRY_, tva_cache.$tva_cache_registry$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)tva_cache.EQL), (SubLObject)tva_cache.UNPROVIDED))));
        ...
        tva_cache.$tva_cache_spec_pred_stats$ = SubLFiles.deflexical("*TVA-CACHE-SPEC-PRED-STATS*", maybeDefault((SubLObject)tva_cache.$sym77$_TVA_CACHE_SPEC_PRED_STATS_, tva_cache.$tva_cache_spec_pred_stats$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)tva_cache.EQUAL), (SubLObject)tva_cache.UNPROVIDED))));
