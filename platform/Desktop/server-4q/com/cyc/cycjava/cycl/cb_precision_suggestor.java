...
public final class cb_precision_suggestor extends SubLTranslatedFile
{
    ...
    public static SubLObject init_cb_precision_suggestor_file() {
        ...
        cb_precision_suggestor.$cb_current_precision_suggestion_implementation$ = SubLFiles.deflexical("*CB-CURRENT-PRECISION-SUGGESTION-IMPLEMENTATION*", (SubLObject)((cb_precision_suggestor.NIL != Symbols.boundp((SubLObject)cb_precision_suggestor.$sym121$_CB_CURRENT_PRECISION_SUGGESTION_IMPLEMENTATION_)) ? cb_precision_suggestor.$cb_current_precision_suggestion_implementation$.getGlobalValue() : cb_precision_suggestor.$kw122$CB_RKF_PRECISION_SUGGESTION_IMPLEMENTATION));
        cb_precision_suggestor.$cb_precision_suggestion_implementations$ = SubLFiles.deflexical("*CB-PRECISION-SUGGESTION-IMPLEMENTATIONS*", (SubLObject)((cb_precision_suggestor.NIL != Symbols.boundp((SubLObject)cb_precision_suggestor.$sym123$_CB_PRECISION_SUGGESTION_IMPLEMENTATIONS_)) ? cb_precision_suggestor.$cb_precision_suggestion_implementations$.getGlobalValue() : cb_precision_suggestor.NIL));
