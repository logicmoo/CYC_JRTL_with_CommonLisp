...
public final class rkf_scenario_constructor extends SubLTranslatedFile
{
    ...
    public static SubLObject init_rkf_scenario_constructor_file() {
        ...
        rkf_scenario_constructor.$sc_isg$ = SubLFiles.deflexical("*SC-ISG*", maybeDefault((SubLObject)rkf_scenario_constructor.$sym7$_SC_ISG_, rkf_scenario_constructor.$sc_isg$, ()->(integer_sequence_generator.new_integer_sequence_generator((SubLObject)rkf_scenario_constructor.UNPROVIDED, (SubLObject)rkf_scenario_constructor.UNPROVIDED, (SubLObject)rkf_scenario_constructor.UNPROVIDED))));
        rkf_scenario_constructor.$sc_index$ = SubLFiles.deflexical("*SC-INDEX*", maybeDefault((SubLObject)rkf_scenario_constructor.$sym8$_SC_INDEX_, rkf_scenario_constructor.$sc_index$, ()->(dictionary.new_dictionary((SubLObject)rkf_scenario_constructor.UNPROVIDED, (SubLObject)rkf_scenario_constructor.UNPROVIDED))));
