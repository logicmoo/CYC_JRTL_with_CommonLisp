...
public final class commander extends SubLTranslatedFile
{
    ...
    public static SubLObject init_commander_file() {
        ...
        commander.$commander_input_processor_threads$ = SubLFiles.deflexical("*COMMANDER-INPUT-PROCESSOR-THREADS*", (commander.NIL != Symbols.boundp((SubLObject)commander.$sym18$_COMMANDER_INPUT_PROCESSOR_THREADS_)) ? commander.$commander_input_processor_threads$.getGlobalValue() : dictionary_utilities.new_synchronized_dictionary(Symbols.symbol_function((SubLObject)commander.EQUAL), (SubLObject)commander.UNPROVIDED));
        commander.$commander_current_tasks$ = SubLFiles.deflexical("*COMMANDER-CURRENT-TASKS*", (commander.NIL != Symbols.boundp((SubLObject)commander.$sym19$_COMMANDER_CURRENT_TASKS_)) ? commander.$commander_current_tasks$.getGlobalValue() : dictionary_utilities.new_synchronized_dictionary(Symbols.symbol_function((SubLObject)commander.EQUAL), (SubLObject)commander.UNPROVIDED));
        commander.$commander_input_queues$ = SubLFiles.deflexical("*COMMANDER-INPUT-QUEUES*", (commander.NIL != Symbols.boundp((SubLObject)commander.$sym20$_COMMANDER_INPUT_QUEUES_)) ? commander.$commander_input_queues$.getGlobalValue() : dictionary_utilities.new_synchronized_dictionary(Symbols.symbol_function((SubLObject)commander.EQUAL), (SubLObject)commander.UNPROVIDED));
        commander.$commander_input_queue_lock$ = SubLFiles.deflexical("*COMMANDER-INPUT-QUEUE-LOCK*", (commander.NIL != Symbols.boundp((SubLObject)commander.$sym21$_COMMANDER_INPUT_QUEUE_LOCK_)) ? commander.$commander_input_queue_lock$.getGlobalValue() : Locks.make_lock((SubLObject)commander.$str22$commander_input_queue_lock));
        commander.$commander_input_queue_semaphores$ = SubLFiles.deflexical("*COMMANDER-INPUT-QUEUE-SEMAPHORES*", (commander.NIL != Symbols.boundp((SubLObject)commander.$sym23$_COMMANDER_INPUT_QUEUE_SEMAPHORES_)) ? commander.$commander_input_queue_semaphores$.getGlobalValue() : dictionary_utilities.new_synchronized_dictionary(Symbols.symbol_function((SubLObject)commander.EQUAL), (SubLObject)commander.UNPROVIDED));
        commander.$commander_output_queues$ = SubLFiles.deflexical("*COMMANDER-OUTPUT-QUEUES*", (commander.NIL != Symbols.boundp((SubLObject)commander.$sym24$_COMMANDER_OUTPUT_QUEUES_)) ? commander.$commander_output_queues$.getGlobalValue() : dictionary_utilities.new_synchronized_dictionary(Symbols.symbol_function((SubLObject)commander.EQUAL), (SubLObject)commander.UNPROVIDED));
        return (SubLObject)commander.NIL;
    }
