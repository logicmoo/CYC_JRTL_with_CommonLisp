...
public final class psp_rules extends SubLTranslatedFile
{
    ...
    public static SubLObject init_psp_rules_file() {
        ...
        psp_rules.$psp_traced_rules$ = SubLFiles.deflexical("*PSP-TRACED-RULES*", (SubLObject)((psp_rules.NIL != Symbols.boundp((SubLObject)psp_rules.$sym95$_PSP_TRACED_RULES_)) ? psp_rules.$psp_traced_rules$.getGlobalValue() : psp_rules.NIL));
        psp_rules.$psp_syntactic_constraint_types$ = SubLFiles.deflexical("*PSP-SYNTACTIC-CONSTRAINT-TYPES*", (SubLObject)((psp_rules.NIL != Symbols.boundp((SubLObject)psp_rules.$sym111$_PSP_SYNTACTIC_CONSTRAINT_TYPES_)) ? psp_rules.$psp_syntactic_constraint_types$.getGlobalValue() : psp_rules.NIL));
        psp_rules.$psp_semantic_constraint_types$ = SubLFiles.deflexical("*PSP-SEMANTIC-CONSTRAINT-TYPES*", (SubLObject)((psp_rules.NIL != Symbols.boundp((SubLObject)psp_rules.$sym114$_PSP_SEMANTIC_CONSTRAINT_TYPES_)) ? psp_rules.$psp_semantic_constraint_types$.getGlobalValue() : psp_rules.NIL));
