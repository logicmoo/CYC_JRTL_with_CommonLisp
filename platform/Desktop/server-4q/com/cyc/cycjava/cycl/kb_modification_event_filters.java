...
public final class kb_modification_event_filters extends SubLTranslatedFile
{
    ...
    public static SubLObject init_kb_modification_event_filters_file() {
        ...
        kb_modification_event_filters.$event_filter_registration$ = SubLFiles.deflexical("*EVENT-FILTER-REGISTRATION*", maybeDefault((SubLObject)kb_modification_event_filters.$sym88$_EVENT_FILTER_REGISTRATION_, kb_modification_event_filters.$event_filter_registration$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)kb_modification_event_filters.EQUALP), (SubLObject)kb_modification_event_filters.UNPROVIDED))));
        kb_modification_event_filters.$event_filter_registration_lock$ = SubLFiles.deflexical("*EVENT-FILTER-REGISTRATION-LOCK*", maybeDefault((SubLObject)kb_modification_event_filters.$sym89$_EVENT_FILTER_REGISTRATION_LOCK_, kb_modification_event_filters.$event_filter_registration_lock$, ()->(Locks.make_lock((SubLObject)kb_modification_event_filters.$str90$Event_Filter_Registration))));
        kb_modification_event_filters.$event_filter_pattern_id$ = SubLFiles.deflexical("*EVENT-FILTER-PATTERN-ID*", maybeDefault((SubLObject)kb_modification_event_filters.$sym91$_EVENT_FILTER_PATTERN_ID_, kb_modification_event_filters.$event_filter_pattern_id$, ()->(integer_sequence_generator.new_integer_sequence_generator((SubLObject)kb_modification_event_filters.ONE_INTEGER, (SubLObject)kb_modification_event_filters.UNPROVIDED, (SubLObject)kb_modification_event_filters.UNPROVIDED))));
        kb_modification_event_filters.$kb_modification_event_to_filter_mapping$ = SubLFiles.deflexical("*KB-MODIFICATION-EVENT-TO-FILTER-MAPPING*", maybeDefault((SubLObject)kb_modification_event_filters.$sym96$_KB_MODIFICATION_EVENT_TO_FILTER_MAPPING_, kb_modification_event_filters.$kb_modification_event_to_filter_mapping$, ()->(dictionary.new_dictionary((SubLObject)kb_modification_event_filters.UNPROVIDED, (SubLObject)kb_modification_event_filters.UNPROVIDED))));
        kb_modification_event_filters.$kb_modification_event_to_filter_mapping_lock$ = SubLFiles.deflexical("*KB-MODIFICATION-EVENT-TO-FILTER-MAPPING-LOCK*", maybeDefault((SubLObject)kb_modification_event_filters.$sym97$_KB_MODIFICATION_EVENT_TO_FILTER_MAPPING_LOCK_, kb_modification_event_filters.$kb_modification_event_to_filter_mapping_lock$, ()->(Locks.make_lock((SubLObject)kb_modification_event_filters.$str98$KB_Modification_Event_to_Filter_M))));
        kb_modification_event_filters.$kb_modification_event_internal_listener_table$ = SubLFiles.deflexical("*KB-MODIFICATION-EVENT-INTERNAL-LISTENER-TABLE*", maybeDefault((SubLObject)kb_modification_event_filters.$sym99$_KB_MODIFICATION_EVENT_INTERNAL_LISTENER_TABLE_, kb_modification_event_filters.$kb_modification_event_internal_listener_table$, ()->(dictionary.new_dictionary((SubLObject)kb_modification_event_filters.UNPROVIDED, (SubLObject)kb_modification_event_filters.UNPROVIDED))));
        ...
        kb_modification_event_filters.$kb_modification_filter_event_fired_listener$ = SubLFiles.deflexical("*KB-MODIFICATION-FILTER-EVENT-FIRED-LISTENER*", maybeDefault((SubLObject)kb_modification_event_filters.$sym116$_KB_MODIFICATION_FILTER_EVENT_FIRED_LISTENER_, kb_modification_event_filters.$kb_modification_filter_event_fired_listener$, ()->(event_broker.describe_funcall_listener((SubLObject)kb_modification_event_filters.$kw110$KB_MODIFICATION_FILTER_FIRED, (SubLObject)kb_modification_event_filters.$sym117$HANDLE_KB_MODIFICATION_FILTER_FIRED, (SubLObject)kb_modification_event_filters.UNPROVIDED, (SubLObject)kb_modification_event_filters.UNPROVIDED))));
        ...
        kb_modification_event_filters.$event_filter_listener_registration$ = SubLFiles.deflexical("*EVENT-FILTER-LISTENER-REGISTRATION*", maybeDefault((SubLObject)kb_modification_event_filters.$sym133$_EVENT_FILTER_LISTENER_REGISTRATION_, kb_modification_event_filters.$event_filter_listener_registration$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)kb_modification_event_filters.EQUALP), (SubLObject)kb_modification_event_filters.UNPROVIDED))));
        kb_modification_event_filters.$event_filter_listener_registration_lock$ = SubLFiles.deflexical("*EVENT-FILTER-LISTENER-REGISTRATION-LOCK*", maybeDefault((SubLObject)kb_modification_event_filters.$sym134$_EVENT_FILTER_LISTENER_REGISTRATION_LOCK_, kb_modification_event_filters.$event_filter_listener_registration_lock$, ()->(Locks.make_lock((SubLObject)kb_modification_event_filters.$str135$Event_Filter_Listener_Registratio))));
        kb_modification_event_filters.$event_filter_listener_id$ = SubLFiles.deflexical("*EVENT-FILTER-LISTENER-ID*", maybeDefault((SubLObject)kb_modification_event_filters.$sym136$_EVENT_FILTER_LISTENER_ID_, kb_modification_event_filters.$event_filter_listener_id$, ()->(integer_sequence_generator.new_integer_sequence_generator((SubLObject)kb_modification_event_filters.ONE_INTEGER, (SubLObject)kb_modification_event_filters.UNPROVIDED, (SubLObject)kb_modification_event_filters.UNPROVIDED))));
        ...
        kb_modification_event_filters.$kb_modification_event_mailbox_suite$ = SubLFiles.deflexical("*KB-MODIFICATION-EVENT-MAILBOX-SUITE*", maybeDefault((SubLObject)kb_modification_event_filters.$sym149$_KB_MODIFICATION_EVENT_MAILBOX_SUITE_, kb_modification_event_filters.$kb_modification_event_mailbox_suite$, ()->(message_mailboxes.new_message_mailbox_suite())));
        ...
        kb_modification_event_filters.$active_external_kb_modification_event_filters$ = SubLFiles.deflexical("*ACTIVE-EXTERNAL-KB-MODIFICATION-EVENT-FILTERS*", maybeDefault((SubLObject)kb_modification_event_filters.$sym179$_ACTIVE_EXTERNAL_KB_MODIFICATION_EVENT_FILTERS_, kb_modification_event_filters.$active_external_kb_modification_event_filters$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)kb_modification_event_filters.EQUALP), (SubLObject)kb_modification_event_filters.UNPROVIDED))));
        kb_modification_event_filters.$external_kb_modification_event_listeners_for_filters$ = SubLFiles.deflexical("*EXTERNAL-KB-MODIFICATION-EVENT-LISTENERS-FOR-FILTERS*", maybeDefault((SubLObject)kb_modification_event_filters.$sym180$_EXTERNAL_KB_MODIFICATION_EVENT_LISTENERS_FOR_FILTERS_, kb_modification_event_filters.$external_kb_modification_event_listeners_for_filters$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)kb_modification_event_filters.EQUALP), (SubLObject)kb_modification_event_filters.UNPROVIDED))));
