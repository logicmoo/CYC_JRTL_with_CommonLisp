...
public final class agenda extends SubLTranslatedFile {
    ...
    public static SubLObject initialize_agenda() {
        ...
        operation_communication
                .set_communication_mode(operation_communication.$startup_communication_mode$.getDynamicValue(thread));
    ...
    public static SubLObject agenda_top_level() {
        SubLObject retval = agenda_top_level0();
        return retval;
    }
        ...
        if (NIL != current_process_is_agenda()) {
            ...
            try {
                ...
                try {
                    ...
                    final SubLObject already_resourcing_p = sbhl_marking_vars.$resourcing_sbhl_marking_spaces_p$
                            .getDynamicValue(thread);
                    final SubLObject _prev_bind_0_$1 = sbhl_marking_vars.$resourced_sbhl_marking_space_limit$
                            .currentBinding(thread);
                    final SubLObject _prev_bind_2 = sbhl_marking_vars.$resourced_sbhl_marking_spaces$
                            .currentBinding(thread);
                    final SubLObject _prev_bind_3 = sbhl_marking_vars.$resourcing_sbhl_marking_spaces_p$
                            .currentBinding(thread);
                    try {
                        sbhl_marking_vars.$resourced_sbhl_marking_space_limit$.bind(sbhl_marking_vars
                                .determine_resource_limit(already_resourcing_p, $agenda_resourcing_spaces$
                                        .getDynamicValue(thread)), thread);
                        sbhl_marking_vars.$resourced_sbhl_marking_spaces$
                                .bind(sbhl_marking_vars.possibly_new_marking_resource(already_resourcing_p), thread);
    ...
    public static SubLObject wait_for_agenda_not_running(SubLObject wait_time) {
        ...
        return SubLObjectFactory.makeBoolean(NIL == agenda_running());
    }
    ...
    public static SubLObject agenda_idleP() {
        return SubLObjectFactory
                .makeBoolean(NIL != agenda_running() && NIL != process_utilities.process_idleP(agenda_process()));
    }

    @SubLTranslatedFile.SubL(source = "cycl/agenda.lisp", position = 5461L)
    public static SubLObject agenda_busyP() {
        return SubLObjectFactory
                .makeBoolean(NIL != agenda_running() && NIL != process_utilities.process_busyP(agenda_process()));
    }
    ...
    public static SubLObject spurious_agenda_processes() {
        ...
        process = cdolist_list_var.first();
        while (NIL != cdolist_list_var) {
            if ($agenda_process_name$.getGlobalValue().equal(Threads.process_name(process))
                    && !process.eql(agenda_process())) {
    ...
    public static SubLObject declare_agenda_task(final SubLObject test, final SubLObject action,
            final SubLObject priority) {
        ...
        try {
            ...
            $agenda_action_table$.setGlobalValue(list_utilities
                    .splice_into_sorted_list(ConsesLow.list(test, action, priority), $agenda_action_table$
                            .getGlobalValue(), Symbols
                                    .symbol_function($sym21$_), Symbols.symbol_function($sym22$AGENDA_TASK_PRIORITY)));
        } finally {
            if (NIL != release) {
    ...
    public static SubLObject undeclare_agenda_task(final SubLObject test) {
        ...
        try {
            release = Locks.seize_lock($agenda_action_table_lock$.getGlobalValue());
            $agenda_action_table$.setGlobalValue(Sequences.delete(test, $agenda_action_table$.getGlobalValue(), Symbols
                    .symbol_function(EQL), Symbols.symbol_function($sym23$FIRST), UNPROVIDED, UNPROVIDED, UNPROVIDED));
        } finally {
            if (NIL != release) {
                Locks.release_lock($agenda_action_table_lock$.getGlobalValue());
            }
    ...
    public static SubLObject save_operationsP() {
        return SubLObjectFactory.makeBoolean(NIL != operation_communication.saving_operationsP()
                && ((NIL != Time.time_has_arrivedP($next_save_transcript_time$.getGlobalValue())
                        ...
                        || operation_queues.transcript_queue_size()
                                .numG($transcript_queue_worry_size$.getGlobalValue())));
    }
    ...
    public static SubLObject save_local_operations() {
        $next_save_transcript_time$.setGlobalValue(numeric_date_utilities
                .time_from_now(Numbers.add($save_transcript_quantum$.getGlobalValue(), random.random(TWENTY_INTEGER))));
    ...
    public static SubLObject worry_transmit_operationsP() {
        return SubLObjectFactory.makeBoolean(NIL != operation_communication.allow_transmitting()
    ...
    public static SubLObject worry_transmit_operations() {
        $next_worry_transmit_time$.setGlobalValue(numeric_date_utilities
                .time_from_now(Numbers.add($worry_transmit_quantum$.getGlobalValue(), random.random(TWENTY_INTEGER))));
    ...
    public static SubLObject run_auxiliary_opP() {
        return SubLObjectFactory.makeBoolean(NIL != operation_communication.process_auxiliary_operationsP()
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    error_message = Errors
                            .handleThrowable(ccatch_env_var, subl_macro_promotions.$catch_error_message_target$
                                    .getGlobalValue());
                } finally {
                    thread.throwStack.pop();
                }
            ...
            if (NIL == error_message) {
                try {
                    ...
                    error_message = Errors
                            .handleThrowable(ccatch_env_var2, subl_macro_promotions.$catch_error_message_target$
                                    .getGlobalValue());
                } finally {
                    thread.throwStack.pop();
                }
    ...
    public static SubLObject handle_agenda_fi_error_state() {
        ...
        try {
            if (NIL != fi.fi_error_signaledP()) {
                ...
                Functions.apply(Symbols.symbol_function($sym43$CERROR), $str44$Continue_the_agenda, new SubLObject[] {
                        Sequences.cconcatenate($str45$__Last_operation___S____, (NIL != format_string) ? format_string
                                : PrintLow.format(NIL, $str46$FI_error___A, error)),
                        agenda_form_to_show(), args });
                fi.reset_fi_error();
            } else if (NIL != control_vars.$agenda_display_fi_warnings$.getDynamicValue(thread)
                    && NIL == Errors.$ignore_warnsP$.getDynamicValue(thread) && NIL != fi.fi_warning_signaledP()) {
                SubLObject current;
                ...
                final SubLObject args;
                current = (args = current.rest());
                Functions.apply(Symbols.symbol_function($sym48$WARN), Sequences
                        .cconcatenate($str45$__Last_operation___S____, (NIL != format_string) ? format_string
            ...
            try {
                ...
                final SubLObject _values = Values.getValuesAsVector();
                Eval.eval(ConsesLow
                        .list($sym50$CSETQ, $sym40$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__, was_appendingP));
                Values.restoreValuesFromVector(_values);
            } finally {
    ...
    public static SubLObject run_local_opP() {
        return SubLObjectFactory.makeBoolean(NIL != operation_communication.process_local_operationsP()
                && NIL == operation_queues.local_queue_empty());
    }
        ...
        try {
            ...
            if (pcase_var.eql($kw51$DEBUG)) {
                try {
                    ...
                    try {
                        Errors.$error_abort_handler$
                                .bind(Symbols.symbol_function($sym53$AGENDA_THROW_ERROR_MESSAGE), thread);
    ...
    public static SubLObject log_agenda_error(final SubLObject form) {
        ...
        final SubLObject output_op = ConsesLow
                .list(encapsulation.encapsulate(cyclist), control_vars.cyc_image_id(), date, form);
        final SubLObject output_timestamp = ConsesLow
                .list(encapsulation.encapsulate(cyclist), control_vars.cyc_image_id(), date, timestamp);
    ...
    public static SubLObject timestamp_operation_p(final SubLObject operation) {
        return SubLObjectFactory.makeBoolean(operation.isList() && operation.first() == $sym61$FI_TIMESTAMP_ASSERTION);
    }
    ...
    public static SubLObject normal_transmit_operationsP() {
        return SubLObjectFactory.makeBoolean(NIL != Time.time_has_arrivedP($next_normal_transmit_time$.getGlobalValue())
                && NIL == operation_queues.transmit_queue_empty() && NIL != operation_communication.allow_transmitting()
    ...
    public static SubLObject normal_transmit_operations() {
        $next_normal_transmit_time$.setGlobalValue(numeric_date_utilities
                .time_from_now(Numbers.add($normal_transmit_quantum$.getGlobalValue(), random.random(TWENTY_INTEGER))));
        operation_communication.send_local_transcript();
        return NIL;
    }
    ...
    public static SubLObject load_remote_operations() {
        $next_load_transcript_time$.setGlobalValue(numeric_date_utilities
                .time_from_now(((NIL == control_vars.caught_up_on_master_transcript()) ? ZERO_INTEGER
    ...
    public static SubLObject save_experienceP() {
        return SubLObjectFactory.makeBoolean(NIL != $save_recent_experienceP$.getGlobalValue()
    ...
    public static SubLObject save_local_experience() {
        $next_save_experience_transcript_time$.setGlobalValue(numeric_date_utilities
                .time_from_now($save_experience_transcript_quantum$.getGlobalValue()));
    ...
    public static SubLObject auto_flush_logsP() {
        return SubLObjectFactory.makeBoolean(NIL != $auto_flush_logsP$.getGlobalValue()
                && NIL != Time.time_has_arrivedP($next_auto_flush_logs_transcript_time$.getGlobalValue()));
    }

    @SubLTranslatedFile.SubL(source = "cycl/agenda.lisp", position = 21032L)
    public static SubLObject auto_flush_logs() {
        $next_auto_flush_logs_transcript_time$.setGlobalValue(numeric_date_utilities
                .time_from_now($auto_flush_logs_transcript_quantum$.getGlobalValue()));
    ...
    public static SubLObject agenda_save_asked_queriesP() {
        return SubLObjectFactory.makeBoolean(NIL != control_vars.save_asked_queriesP()
    ...
    public static SubLObject save_local_asked_queries() {
        $next_save_asked_queries_transcript_time$.setGlobalValue(numeric_date_utilities
                .time_from_now($save_asked_queries_transcript_quantum$.getGlobalValue()));
        return inference_analysis.possibly_save_recent_asked_queries();
    }

    @SubLTranslatedFile.SubL(source = "cycl/agenda.lisp", position = 21924L)
    public static SubLObject monitor_sksi_global_resourcingP() {
        return SubLObjectFactory.makeBoolean(NIL != sksi_sks_interaction.within_sksi_global_resourcingP()
                && NIL != sksi_sks_interaction.sksi_global_resourcing_initializedP()
                && NIL != Time.time_has_arrivedP($next_sksi_global_resourcing_monitor_time$.getGlobalValue()));
    }

    @SubLTranslatedFile.SubL(source = "cycl/agenda.lisp", position = 21924L)
    public static SubLObject monitor_sksi_global_resourcing() {
        $next_sksi_global_resourcing_monitor_time$.setGlobalValue(numeric_date_utilities
                .time_from_now($sksi_monitor_global_resourcing_time_delta$.getGlobalValue()));
    ...
    public static SubLObject enable_agenda_daily_gc(final SubLObject hour, final SubLObject minute,
            final SubLObject second) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread)
                && (!hour.isInteger() || !ZERO_INTEGER.numLE(hour) || !hour.numLE($int96$23))) {
            Errors.error($str97$Hour_must_be_an_integer_in_the_ra);
        }
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread)
                && (!minute.isInteger() || !ZERO_INTEGER.numLE(minute) || !minute.numLE($int98$59))) {
            Errors.error($str99$Minute_must_be_an_integer_in_the_);
        }
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread)
                && (!second.isInteger() || !ZERO_INTEGER.numLE(second) || !second.numLE($int98$59))) {
    ...
    public static SubLObject agenda_daily_gc_ready_p() {
        return SubLObjectFactory.makeBoolean(NIL != $agenda_daily_gc_enabled$.getGlobalValue()
    ...
    public static SubLObject do_agenda_daily_gc() {
        final SubLObject message = Sequences.cconcatenate($str102$Doing_Agenda_Daily_GC_at_, format_nil
                .format_nil_a_no_copy(numeric_date_utilities.timestring(UNPROVIDED)));
    ...
    public static SubLObject set_next_agenda_daily_gc_time() {
        ...
        current = current.rest();
        if (NIL == current) {
            $next_agenda_daily_gc_time$
                    .setGlobalValue(numeric_date_utilities.get_universal_time_within_next_day(second, minute, hour));
        } else {
    ...
    public static SubLObject init_agenda_file() {
        $agenda_should_quit$ = SubLFiles
                .deflexical("*AGENDA-SHOULD-QUIT*", ((NIL != Symbols.boundp($sym0$_AGENDA_SHOULD_QUIT_))
                        ? $agenda_should_quit$.getGlobalValue()
                        : NIL));
        $restart_agenda_flag$ = SubLFiles
                .deflexical("*RESTART-AGENDA-FLAG*", ((NIL != Symbols.boundp($sym1$_RESTART_AGENDA_FLAG_))
                        ? $restart_agenda_flag$.getGlobalValue()
                        : NIL));
        ...
        $agenda_process$ = SubLFiles.deflexical("*AGENDA-PROCESS*", ((NIL != Symbols.boundp($sym7$_AGENDA_PROCESS_))
                ? $agenda_process$.getGlobalValue()
                : NIL));
        $agenda_process_lock$ = SubLFiles
                .deflexical("*AGENDA-PROCESS-LOCK*", Locks.make_lock($str10$Agenda_Process_Lock));
        $agenda_error_modes$ = SubLFiles.deflexical("*AGENDA-ERROR-MODES*", $list13);
        $agenda_error_mode$ = SubLFiles
                .deflexical("*AGENDA-ERROR-MODE*", ((NIL != Symbols.boundp($sym14$_AGENDA_ERROR_MODE_))
                        ? $agenda_error_mode$.getGlobalValue()
                        : $kw15$HALT));
        $agenda_log_file$ = SubLFiles.defvar("*AGENDA-LOG-FILE*", NIL);
        $agenda_action_table$ = SubLFiles
                .deflexical("*AGENDA-ACTION-TABLE*", ((NIL != Symbols.boundp($sym17$_AGENDA_ACTION_TABLE_))
                        ? $agenda_action_table$.getGlobalValue()
                        : NIL));
        $agenda_action_table_lock$ = SubLFiles
                .deflexical("*AGENDA-ACTION-TABLE-LOCK*", Locks.make_lock($str18$Agenda_Action_Table_Lock));
        ...
        $next_save_transcript_time$ = SubLFiles
                .deflexical("*NEXT-SAVE-TRANSCRIPT-TIME*", (NIL != Symbols.boundp($sym28$_NEXT_SAVE_TRANSCRIPT_TIME_))
                        ? $next_save_transcript_time$.getGlobalValue()
                        : Time.get_universal_time());
        $worry_transmit_quantum$ = SubLFiles
                .deflexical("*WORRY-TRANSMIT-QUANTUM*", Numbers.multiply(TEN_INTEGER, $int27$60));
        $worry_transmit_size$ = SubLFiles.deflexical("*WORRY-TRANSMIT-SIZE*", $int31$1000);
        $next_worry_transmit_time$ = SubLFiles
                .deflexical("*NEXT-WORRY-TRANSMIT-TIME*", (NIL != Symbols.boundp($sym32$_NEXT_WORRY_TRANSMIT_TIME_))
                        ? $next_worry_transmit_time$.getGlobalValue()
                        : Time.get_universal_time());
        $normal_transmit_quantum$ = SubLFiles.deflexical("*NORMAL-TRANSMIT-QUANTUM*", $int64$120);
        $next_normal_transmit_time$ = SubLFiles
                .deflexical("*NEXT-NORMAL-TRANSMIT-TIME*", (NIL != Symbols.boundp($sym65$_NEXT_NORMAL_TRANSMIT_TIME_))
                        ? $next_normal_transmit_time$.getGlobalValue()
                        : Time.get_universal_time());
        $load_transcript_quantum$ = SubLFiles.deflexical("*LOAD-TRANSCRIPT-QUANTUM*", $int64$120);
        $next_load_transcript_time$ = SubLFiles
                .deflexical("*NEXT-LOAD-TRANSCRIPT-TIME*", (NIL != Symbols.boundp($sym73$_NEXT_LOAD_TRANSCRIPT_TIME_))
                        ? $next_load_transcript_time$.getGlobalValue()
                        : Time.get_universal_time());
        $last_receiving_remote_operationsP$ = SubLFiles
                .deflexical("*LAST-RECEIVING-REMOTE-OPERATIONS?*", ((NIL != Symbols
                        .boundp($sym74$_LAST_RECEIVING_REMOTE_OPERATIONS__))
                                ? $last_receiving_remote_operationsP$.getGlobalValue()
                                : NIL));
        $save_recent_experienceP$ = SubLFiles.deflexical("*SAVE-RECENT-EXPERIENCE?*", T);
        $save_experience_transcript_quantum$ = SubLFiles
                .deflexical("*SAVE-EXPERIENCE-TRANSCRIPT-QUANTUM*", Numbers.multiply($int27$60, TEN_INTEGER));
        $next_save_experience_transcript_time$ = SubLFiles
                .deflexical("*NEXT-SAVE-EXPERIENCE-TRANSCRIPT-TIME*", (NIL != Symbols
                        .boundp($sym78$_NEXT_SAVE_EXPERIENCE_TRANSCRIPT_TIME_))
                                ? $next_save_experience_transcript_time$.getGlobalValue()
                                : Time.get_universal_time());
        $auto_flush_logsP$ = SubLFiles.deflexical("*AUTO-FLUSH-LOGS?*", T);
        $auto_flush_logs_transcript_quantum$ = SubLFiles
                .deflexical("*AUTO-FLUSH-LOGS-TRANSCRIPT-QUANTUM*", Numbers.multiply($int27$60, FIVE_INTEGER));
        $next_auto_flush_logs_transcript_time$ = SubLFiles
                .deflexical("*NEXT-AUTO-FLUSH-LOGS-TRANSCRIPT-TIME*", (NIL != Symbols
                        .boundp($sym81$_NEXT_AUTO_FLUSH_LOGS_TRANSCRIPT_TIME_))
                                ? $next_auto_flush_logs_transcript_time$.getGlobalValue()
                                : Time.get_universal_time());
        $save_asked_queries_transcript_quantum$ = SubLFiles
                .deflexical("*SAVE-ASKED-QUERIES-TRANSCRIPT-QUANTUM*", Numbers.multiply($int27$60, ONE_INTEGER));
        $next_save_asked_queries_transcript_time$ = SubLFiles
                .deflexical("*NEXT-SAVE-ASKED-QUERIES-TRANSCRIPT-TIME*", (NIL != Symbols
                        .boundp($sym84$_NEXT_SAVE_ASKED_QUERIES_TRANSCRIPT_TIME_))
                                ? $next_save_asked_queries_transcript_time$.getGlobalValue()
                                : Time.get_universal_time());
        $next_sksi_global_resourcing_monitor_time$ = SubLFiles
                .deflexical("*NEXT-SKSI-GLOBAL-RESOURCING-MONITOR-TIME*", (NIL != Symbols
                        .boundp($sym88$_NEXT_SKSI_GLOBAL_RESOURCING_MONITOR_TIME_))
                                ? $next_sksi_global_resourcing_monitor_time$.getGlobalValue()
                                : Time.get_universal_time());
        $sksi_monitor_global_resourcing_time_delta$ = SubLFiles
                .deflexical("*SKSI-MONITOR-GLOBAL-RESOURCING-TIME-DELTA*", Numbers.multiply($int27$60, TWO_INTEGER));
        $agenda_daily_gc_lock$ = SubLFiles
                .deflexical("*AGENDA-DAILY-GC-LOCK*", Locks.make_lock($str92$Agenda_Daily_GC));
        $agenda_daily_gc_enabled$ = SubLFiles
                .deflexical("*AGENDA-DAILY-GC-ENABLED*", ((NIL != Symbols.boundp($sym93$_AGENDA_DAILY_GC_ENABLED_))
                        ? $agenda_daily_gc_enabled$.getGlobalValue()
                        : NIL));
        $agenda_daily_gc_time_of_day$ = SubLFiles.deflexical("*AGENDA-DAILY-GC-TIME-OF-DAY*", ((NIL != Symbols
                .boundp($sym94$_AGENDA_DAILY_GC_TIME_OF_DAY_)) ? $agenda_daily_gc_time_of_day$.getGlobalValue()
                        : $list95));
        $next_agenda_daily_gc_time$ = SubLFiles
                .deflexical("*NEXT-AGENDA-DAILY-GC-TIME*", ((NIL != Symbols.boundp($sym101$_NEXT_AGENDA_DAILY_GC_TIME_))
                        ? $next_agenda_daily_gc_time$.getGlobalValue()
                        : NIL));
        return NIL;
    }
    ...
    static {
        ...
        $list13 = ConsesLow.list(SubLObjectFactory.makeKeyword("IGNORE"), SubLObjectFactory
                .makeKeyword("HALT"), SubLObjectFactory.makeKeyword("DEBUG"), SubLObjectFactory.makeKeyword("LOG"));
        ...
        $sym40$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__ = SubLObjectFactory
                .makeSymbol("*APPEND-STACK-TRACES-TO-ERROR-MESSAGES?*");
        $list41 = ConsesLow.list(SubLObjectFactory.makeSymbol("CSETQ"), SubLObjectFactory
                .makeSymbol("*APPEND-STACK-TRACES-TO-ERROR-MESSAGES?*"), NIL);
        $list42 = ConsesLow.list(SubLObjectFactory.makeSymbol("ERROR"), SubLObjectFactory
                .makeSymbol("&OPTIONAL"), SubLObjectFactory.makeSymbol("FORMAT-STRING"), SubLObjectFactory
                        .makeSymbol("&REST"), SubLObjectFactory.makeSymbol("ARGS"));
        ...
        $list47 = ConsesLow.list(SubLObjectFactory.makeSymbol("WARNING"), SubLObjectFactory
                .makeSymbol("&OPTIONAL"), SubLObjectFactory.makeSymbol("FORMAT-STRING"), SubLObjectFactory
                        .makeSymbol("&REST"), SubLObjectFactory.makeSymbol("ARGS"));
        ...
        $const62$Guest = constant_handles.reader_make_constant_shell(SubLObjectFactory.makeString("Guest"));
        ...
        $sym74$_LAST_RECEIVING_REMOTE_OPERATIONS__ = SubLObjectFactory
                .makeSymbol("*LAST-RECEIVING-REMOTE-OPERATIONS?*");
        ...
        $sym78$_NEXT_SAVE_EXPERIENCE_TRANSCRIPT_TIME_ = SubLObjectFactory
                .makeSymbol("*NEXT-SAVE-EXPERIENCE-TRANSCRIPT-TIME*");
        ...
        $sym81$_NEXT_AUTO_FLUSH_LOGS_TRANSCRIPT_TIME_ = SubLObjectFactory
                .makeSymbol("*NEXT-AUTO-FLUSH-LOGS-TRANSCRIPT-TIME*");
        ...
        $sym84$_NEXT_SAVE_ASKED_QUERIES_TRANSCRIPT_TIME_ = SubLObjectFactory
                .makeSymbol("*NEXT-SAVE-ASKED-QUERIES-TRANSCRIPT-TIME*");
        ...
        $sym88$_NEXT_SKSI_GLOBAL_RESOURCING_MONITOR_TIME_ = SubLObjectFactory
                .makeSymbol("*NEXT-SKSI-GLOBAL-RESOURCING-MONITOR-TIME*");
        ...
        $str97$Hour_must_be_an_integer_in_the_ra = SubLObjectFactory
                .makeString("Hour must be an integer in the range 0 - 23");
        $int98$59 = SubLObjectFactory.makeInteger(59);
        $str99$Minute_must_be_an_integer_in_the_ = SubLObjectFactory
                .makeString("Minute must be an integer in the range 0 - 59");
        $str100$Second_must_be_an_integer_in_the_ = SubLObjectFactory
                .makeString("Second must be an integer in the range 0 - 59");
        ...
        $list105 = ConsesLow.list(SubLObjectFactory.makeSymbol("HOUR"), SubLObjectFactory
                .makeSymbol("MINUTE"), SubLObjectFactory.makeSymbol("SECOND"));
    }
