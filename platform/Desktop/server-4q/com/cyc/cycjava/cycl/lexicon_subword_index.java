...
public final class lexicon_subword_index extends SubLTranslatedFile
{
    ...
    public static SubLObject init_lexicon_subword_index_file() {
        ...
        lexicon_subword_index.$nl_trie_subword_index$ = SubLFiles.deflexical("*NL-TRIE-SUBWORD-INDEX*", (SubLObject)(maybeDefault((SubLObject)lexicon_subword_index.$sym1$_NL_TRIE_SUBWORD_INDEX_, lexicon_subword_index.$nl_trie_subword_index$, lexicon_subword_index.NIL)));
        lexicon_subword_index.$nl_trie_subword_cache_initialization_lock$ = SubLFiles.deflexical("*NL-TRIE-SUBWORD-CACHE-INITIALIZATION-LOCK*", maybeDefault((SubLObject)lexicon_subword_index.$sym3$_NL_TRIE_SUBWORD_CACHE_INITIALIZATION_LOCK_, lexicon_subword_index.$nl_trie_subword_cache_initialization_lock$, ()->(Locks.make_lock((SubLObject)lexicon_subword_index.$str4$_nl_trie_subword_cache_initializa))));
