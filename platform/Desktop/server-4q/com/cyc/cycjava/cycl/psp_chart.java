      ...
      SubLTranslatedFile
{
  ...
  {
    return ( v_object.getClass() == $phrase_structure_parser_chart_native.class ) ? T : NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/psp-chart.lisp", position = 946L)
  public static SubLObject psp_chart_id(final SubLObject v_object)
  {
    assert NIL != phrase_structure_parser_chart_p( v_object ) : v_object;
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw49$BEGIN, $sym50$MAKE_PHRASE_STRUCTURE_PARSER_CHART, THIRTEEN_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw35$ID, psp_chart_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw36$INPUT_STRING, psp_chart_input_string( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw37$LENGTH, psp_chart_length( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw38$SPANS_TO_EDGES, psp_chart_spans_to_edges( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw39$GAP_TYPE, psp_chart_gap_type( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw40$MEMOIZATION_STATE, psp_chart_memoization_state( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw41$EDGE_ID_INDEX, psp_chart_edge_id_index( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw42$EDGES_TO_NODES, psp_chart_edges_to_nodes( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw43$MAX_EDGES_PER_SPAN, psp_chart_max_edges_per_span( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw44$MAX_EDGES, psp_chart_max_edges( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw45$MAXED_OUT_SPANS, psp_chart_maxed_out_spans( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw46$MAXED_OUT_, psp_chart_maxed_outP( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw47$PARSED_LEXICAL_SPANS, psp_chart_parsed_lexical_spans( obj ) );
    Functions.funcall( visitor_fn, obj, $kw52$END, $sym50$MAKE_PHRASE_STRUCTURE_PARSER_CHART, THIRTEEN_INTEGER );
    return obj;
  }
  ...
  public static SubLObject pprint_psp_chart(final SubLObject v_psp_chart, SubLObject stream, SubLObject depth)
  {
    ...
    PrintLow.format( stream, $str55$__PSP_CHART__S__S_, psp_chart_id( v_psp_chart ), psp_chart_input_string( v_psp_chart ) );
    return v_psp_chart;
  }
  ...
  public static SubLObject new_psp_chart(SubLObject input_string, SubLObject length)
  {
    ...
    $psp_chart_id_counter$.setGlobalValue( Numbers.add( $psp_chart_id_counter$.getGlobalValue(), ONE_INTEGER ) );
    ...
    {
      _csetf_psp_chart_edge_id_index( chart, id_index.new_id_index( UNPROVIDED, UNPROVIDED ) );
    }
    else
    {
    ...
    _csetf_psp_chart_maxed_out_spans( chart, set.new_set( Symbols.symbol_function( EQ ), UNPROVIDED ) );
    _csetf_psp_chart_maxed_outP( chart, NIL );
    _csetf_psp_chart_parsed_lexical_spans( chart, set.new_set( Symbols.symbol_function( EQ ), UNPROVIDED ) );
    return chart;
  }
  ...
  public static SubLObject psp_chart_new_edge_id(final SubLObject chart)
  {
    ...
    if( NIL != id_index.id_index_p( id_index_or_counter ) )
    {
    ...
    if( id_index_or_counter.isInteger() )
    {
      ...
      _csetf_psp_chart_edge_id_index( chart, Numbers.add( psp_chart_edge_id_index( chart ), ONE_INTEGER ) );
      return id;
    }
    return NIL;
  }
  ...
  public static SubLObject psp_find_edge_by_id(final SubLObject suid, SubLObject chart)
  {
    ...
    final SubLObject v_id_index = psp_chart_edge_id_index( chart );
    return id_index.id_index_lookup( v_id_index, suid, UNPROVIDED );
  }
  ...
  {
    return ( v_object.getClass() == $phrase_structure_parser_phrasal_edge_native.class ) ? T : NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/psp-chart.lisp", position = 5420L)
  public static SubLObject psp_phrasal_edge_weight(final SubLObject v_object)
  {
    assert NIL != phrase_structure_parser_phrasal_edge_p( v_object ) : v_object;
    return v_object.getField2();
  }
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw49$BEGIN, $sym105$MAKE_PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE, TWELVE_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw94$WEIGHT, psp_phrasal_edge_weight( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw95$STRING, psp_phrasal_edge_string( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw96$SPAN, psp_phrasal_edge_span( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw97$CATEGORY, psp_phrasal_edge_category( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw98$POS_PRED, psp_phrasal_edge_pos_pred( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw99$CYCLS, psp_phrasal_edge_cycls( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw100$RULE, psp_phrasal_edge_rule( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw101$NEW_DTR_CONSTRAINTS, psp_phrasal_edge_new_dtr_constraints( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw102$HEAD_DTR, psp_phrasal_edge_head_dtr( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw103$NON_HEAD_DTRS, psp_phrasal_edge_non_head_dtrs( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw35$ID, psp_phrasal_edge_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw104$CHART, psp_phrasal_edge_chart( obj ) );
    Functions.funcall( visitor_fn, obj, $kw52$END, $sym105$MAKE_PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE, TWELVE_INTEGER );
    return obj;
  }
  ...
  public static SubLObject pprint_psp_phrasal_edge(final SubLObject psp_phrasal_edge, SubLObject stream, SubLObject depth)
  {
    ...
    PrintLow.format( stream, $str108$__PSP_PHRASAL_EDGE__S__S__S_, new SubLObject[] { psp_phrasal_edge_id( psp_phrasal_edge ), psp_phrasal_edge_string( psp_phrasal_edge ), psp_phrasal_edge_rule( psp_phrasal_edge )
    } );
  ...
  {
    return ( v_object.getClass() == $phrase_structure_parser_lexical_edge_native.class ) ? T : NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/psp-chart.lisp", position = 6864L)
  public static SubLObject psp_lexical_edge_weight(final SubLObject v_object)
  {
    assert NIL != phrase_structure_parser_lexical_edge_p( v_object ) : v_object;
    return v_object.getField2();
  }
  ...
  public static SubLObject make_phrase_structure_parser_lexical_edge(SubLObject arglist)
  {
    ...
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      else if( pcase_var.eql( $kw138$WU ) )
      {
        _csetf_psp_lexical_edge_wu( v_new, current_value );
      }
      else if( pcase_var.eql( $kw139$FRAME ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw49$BEGIN, $sym140$MAKE_PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE, TEN_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw94$WEIGHT, psp_lexical_edge_weight( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw95$STRING, psp_lexical_edge_string( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw96$SPAN, psp_lexical_edge_span( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw97$CATEGORY, psp_lexical_edge_category( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw98$POS_PRED, psp_lexical_edge_pos_pred( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw99$CYCLS, psp_lexical_edge_cycls( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw138$WU, psp_lexical_edge_wu( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw139$FRAME, psp_lexical_edge_frame( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw35$ID, psp_lexical_edge_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw51$SLOT, $kw104$CHART, psp_lexical_edge_chart( obj ) );
    Functions.funcall( visitor_fn, obj, $kw52$END, $sym140$MAKE_PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE, TEN_INTEGER );
    return obj;
  }
  ...
  public static SubLObject psp_chart_spans(SubLObject chart, SubLObject start, SubLObject end)
  {
    ...
    for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( psp_chart_spans_to_edges( chart ) ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      ...
      {
        spans = ConsesLow.cons( span, spans );
      }
    }
  ...
  public static SubLObject pprint_psp_lexical_edge(final SubLObject psp_lexical_edge, SubLObject stream, SubLObject depth)
  {
    ...
    PrintLow.format( stream, $str143$__PSP_LEXICAL_EDGE__S__S__S__S_W_, new SubLObject[] { psp_lexical_edge_id( psp_lexical_edge ), psp_lexical_edge_string( psp_lexical_edge ), get_psp_edge_category( psp_lexical_edge ),
      ( NIL != dictionary.dictionary_p( cycls ) ) ? dictionary.dictionary_values( cycls ) : string_utilities.$empty_string$.getGlobalValue(), psp_lexical_edge_weight( psp_lexical_edge )
    } );
  ...
  public static SubLObject psp_format_edge(final SubLObject edge, SubLObject stream)
  {
    ...
    if( NIL != semx )
    {
      PrintLow.format( stream, $str144$___S___S______S__, new SubLObject[] { get_psp_edge_category( edge ), get_psp_edge_pos_pred( edge ), semx
      } );
    }
    return NIL;
  }
  ...
  public static SubLObject get_psp_edge_string(final SubLObject edge)
  {
    if( NIL != phrase_structure_parser_phrasal_edge_p( edge ) )
    {
      ...
      if( NIL == string )
      {
        ...
        {
          dtr_strings = ConsesLow.cons( get_psp_edge_string( dtr ), dtr_strings );
          csome_list_var = csome_list_var.rest();
          dtr = csome_list_var.first();
        }
        string = string_utilities.bunge( Sequences.nreverse( dtr_strings ), UNPROVIDED );
  ...
  public static SubLObject psp_do_spans(final SubLObject macroform, final SubLObject environment)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_listp( current, datum, $list147 );
    current = current.rest();
    ...
    if( NIL == current )
    {
      ...
      return ConsesLow.list( $sym149$CLET, ConsesLow.list( ConsesLow.list( chart_to_use, ConsesLow.listS( $sym150$FIRST_OF, chart, $list151 ) ) ), ConsesLow.listS( $sym152$CHECK_TYPE, chart_to_use, $list153 ), ConsesLow
          .listS( $sym154$DO_DICTIONARY_KEYS, ConsesLow.list( span_var, ConsesLow.list( $sym15$PSP_CHART_SPANS_TO_EDGES, chart_to_use ), $kw155$DONE, done ), ConsesLow.append( body, NIL ) ) );
    }
  ...
  public static SubLObject psp_do_edges_for_span(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.list( $sym159$CSOME, ConsesLow.list( edge_var, ConsesLow.list( $sym160$PSP_EDGES_WITH_SPAN, span, chart ), done ), ConsesLow.listS( $sym161$PWHEN, ConsesLow.list( $sym162$PSP_DO_EDGE_OK_, edge_var,
          category, complete_onlyP ), ConsesLow.append( body, NIL ) ) );
    }
  ...
  public static SubLObject psp_do_lexical_edges_for_span(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.list( $sym159$CSOME, ConsesLow.list( edge_var, ConsesLow.list( $sym164$PSP_LEXICAL_EDGES_WITH_SPAN, span, chart ), done ), ConsesLow.listS( $sym161$PWHEN, ConsesLow.list( $sym162$PSP_DO_EDGE_OK_,
          edge_var, category, complete_onlyP ), ConsesLow.append( body, NIL ) ) );
    }
    cdestructuring_bind.cdestructuring_bind_error( datum, $list158 );
    return NIL;
  }
  ...
  {
    return makeBoolean( ( NIL == complete_onlyP || NIL == psp_incomplete_edgeP( edge ) ) && ( category == $kw165$ANY || NIL != psp_rules.psp_valid_constituent_typeP( get_psp_edge_category( edge ), category ) ) );
  }
  ...
  public static SubLObject psp_do_edges(final SubLObject macroform, final SubLObject environment)
  {
    ...
    while ( NIL != rest)
    {
      ...
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, $list166 );
      if( NIL == conses_high.member( current_$2, $list167, UNPROVIDED, UNPROVIDED ) )
      {
        bad = T;
      }
      if( current_$2 == $kw168$ALLOW_OTHER_KEYS )
      {
    ...
    final SubLObject chart_tail = cdestructuring_bind.property_list_member( $kw104$CHART, current );
    final SubLObject chart = ( NIL != chart_tail ) ? conses_high.cadr( chart_tail ) : NIL;
    final SubLObject category_tail = cdestructuring_bind.property_list_member( $kw97$CATEGORY, current );
    final SubLObject category = ( NIL != category_tail ) ? conses_high.cadr( category_tail ) : $kw165$ANY;
    final SubLObject span_tail = cdestructuring_bind.property_list_member( $kw96$SPAN, current );
    final SubLObject span = ( NIL != span_tail ) ? conses_high.cadr( span_tail ) : $kw165$ANY;
    final SubLObject complete_onlyP_tail = cdestructuring_bind.property_list_member( $kw169$COMPLETE_ONLY_, current );
    final SubLObject complete_onlyP = ( NIL != complete_onlyP_tail ) ? conses_high.cadr( complete_onlyP_tail ) : T;
    final SubLObject type_tail = cdestructuring_bind.property_list_member( $kw170$TYPE, current );
    final SubLObject type = ( NIL != type_tail ) ? conses_high.cadr( type_tail ) : $kw165$ANY;
    final SubLObject done_tail = cdestructuring_bind.property_list_member( $kw155$DONE, current );
    ...
    if( NIL == current )
    {
      ...
      return ConsesLow.list( $sym149$CLET, ConsesLow.list( ConsesLow.list( chart_to_use, ConsesLow.listS( $sym150$FIRST_OF, chart, $list151 ) ) ), ConsesLow.listS( $sym152$CHECK_TYPE, chart_to_use, $list153 ), ConsesLow
          .list( $sym173$PCOND, ConsesLow.list( ConsesLow.listS( EQ, span, $list174 ), ConsesLow.list( $sym175$PCASE, type, ConsesLow.list( $kw165$ANY, ConsesLow.list( $sym176$PSP_DO_SPANS, ConsesLow.list( span_to_do,
              done, chart_to_use ), ConsesLow.listS( $sym156$PSP_DO_EDGES_FOR_SPAN, ConsesLow.list( edge_var, chart_to_use, category, span_to_do, complete_onlyP, done ), ConsesLow.append( body, NIL ) ) ) ), ConsesLow
                  .list( $kw177$LEXICAL, ConsesLow.list( $sym176$PSP_DO_SPANS, ConsesLow.list( span_to_do, done, chart_to_use ), ConsesLow.listS( $sym163$PSP_DO_LEXICAL_EDGES_FOR_SPAN, ConsesLow.list( edge_var,
                      chart_to_use, category, span_to_do, complete_onlyP, done ), ConsesLow.append( body, NIL ) ) ) ) ) ), ConsesLow.list( ConsesLow.list( $sym178$INTERVAL_SPAN_P, span ), ConsesLow.list( $sym175$PCASE,
                          type, ConsesLow.list( $kw165$ANY, ConsesLow.listS( $sym156$PSP_DO_EDGES_FOR_SPAN, ConsesLow.list( edge_var, chart_to_use, category, span, complete_onlyP, done ), ConsesLow.append( body,
                              NIL ) ) ), ConsesLow.list( $kw177$LEXICAL, ConsesLow.listS( $sym163$PSP_DO_LEXICAL_EDGES_FOR_SPAN, ConsesLow.list( edge_var, chart_to_use, category, span, complete_onlyP, done ), ConsesLow
                                  .append( body, NIL ) ) ) ) ) ) );
    }
    cdestructuring_bind.cdestructuring_bind_error( datum, $list166 );
    return NIL;
  ...
  {
    return makeBoolean( NIL != psp_unknown_weight_p( obj ) || ( NIL != possibly_psp_known_weight_p( obj ) && obj.numLE( parsing_vars.$psp_max_weight$.getGlobalValue() ) && obj.numGE( parsing_vars.$psp_min_weight$
        .getGlobalValue() ) ) );
  }
  ...
  {
    return Equality.eq( obj, $psp_unknown_weight$.getGlobalValue() );
  }
  ...
  public static SubLObject possibly_psp_known_weight_p(final SubLObject obj)
  {
    ...
    if( pcase_var.eql( $kw180$INTEGER ) )
    {
      return Types.integerp( obj );
    }
    if( pcase_var.eql( $kw181$FLOAT ) )
    {
  ...
  public static SubLObject psp_weight_G(final SubLObject weight1, final SubLObject weight2, SubLObject margin_of_error)
  {
    ...
    {
      margin_of_error = $float182$0_0;
    }
    assert NIL != psp_weight_p( weight1 ) : weight1;
    assert NIL != psp_weight_p( weight2 ) : weight2;
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $psp_np_gap_semx_caching_state$.getGlobalValue(), ConsesLow.list( EMPTY_SUBL_OBJECT_ARRAY ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject psp_np_gap_semx()
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym188$PSP_NP_GAP_SEMX, $sym189$_PSP_NP_GAP_SEMX_CACHING_STATE_, NIL, EQL, ZERO_INTEGER, ZERO_INTEGER );
    }
    SubLObject results = memoization_state.caching_state_get_zero_arg_results( caching_state, UNPROVIDED );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( psp_np_gap_semx_internal() ) );
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject phrasalP = Numbers.numG( lexicon_utilities.bar_level( category, UNPROVIDED ), ONE_INTEGER );
    final SubLObject constructor = ( NIL != phrasalP ) ? $sym191$NEW_PSP_PHRASAL_EDGE : $sym192$NEW_PSP_LEXICAL_EDGE;
    final SubLObject new_edge = Functions.funcall( constructor, new SubLObject[] { parsing_vars.$psp_chart$.getDynamicValue( thread ), interval_span.get_interval_span( index, index ), $str193$, category, NIL, $kw194$NEW,
      $psp_gap_edge_weight$.getGlobalValue()
    } );
    if( category.eql( $const195$Preposition ) && NIL != psp_pp_gap_string() )
    {
      set_psp_edge_wu( new_edge, lexicon_accessors.words_of_stringXspeech_part( psp_pp_gap_string(), $const195$Preposition, UNPROVIDED, UNPROVIDED, UNPROVIDED ).first() );
    }
    else if( NIL != lexicon_accessors.npP( category ) )
    {
  ...
  {
    return makeBoolean( NIL != psp_gap_edge_p( edge ) && get_psp_edge_category( edge ).eql( $const195$Preposition ) );
  }
  ...
  {
    return makeBoolean( NIL != conses_high.member( obj, $list196, UNPROVIDED, UNPROVIDED ) || NIL != psp_pp_gap_constraint_p( obj ) );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( parsing_vars.$psp_gap_type_allowed$.getDynamicValue( thread ) == $kw197$NP )
    {
      return $const198$NounPhrase;
    }
    if( NIL != psp_pp_gap_allowedP() )
    {
      return $const195$Preposition;
    }
    return $kw199$NONE;
  }
  ...
  public static SubLObject psp_edge_has_pp_gapP(final SubLObject edge)
  {
    ...
    dtr = list_var.first();
    for( i = ZERO_INTEGER; NIL == ans && NIL != list_var; list_var = list_var.rest(), dtr = list_var.first(), i = Numbers.add( ONE_INTEGER, i ) )
    {
      ...
      else if( NIL != psp_edge_has_pp_gapP( dtr ) )
      {
        return T;
      }
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return makeBoolean( parsing_vars.$psp_gap_type_allowed$.getDynamicValue( thread ) != $kw199$NONE );
  }
  ...
  {
    return makeBoolean( obj.isCons() && obj.first() == $kw200$PP && obj.rest().isString() );
  }
  ...
  public static SubLObject new_psp_phrasal_edge(final SubLObject chart, final SubLObject span, final SubLObject string, SubLObject category, SubLObject pos_pred, SubLObject cycls, SubLObject weight, SubLObject rule,
      SubLObject new_dtr_constraints, SubLObject head_dtr, SubLObject non_head_dtrs)
  {
    ...
    if( NIL != cycls && !assertionsDisabledInClass && NIL == dictionary.dictionary_p( cycls ) )
    {
    ...
    _csetf_psp_phrasal_edge_weight( edge, ( NIL != weight ) ? weight
        : ( ( NIL != head_dtr || NIL != non_head_dtrs ) ? psp_edge_weight_from_dtrs( head_dtr, non_head_dtrs, rule ) : $psp_unknown_weight$.getGlobalValue() ) );
    return edge;
  }
  ...
  public static SubLObject psp_maybe_setify_dtrs(final SubLObject head_dtr, final SubLObject non_head_dtrs)
  {
    ...
    if( NIL != parsing_vars.$psp_chart_consolidate_edgesP$.getDynamicValue( thread ) )
    {
      return Values.values( ConsesLow.list( head_dtr ), Mapping.mapcar( $sym203$LIST, non_head_dtrs ) );
    }
    return Values.values( head_dtr, non_head_dtrs );
  }

  @SubLTranslatedFile.SubL(source = "cycl/psp-chart.lisp", position = 29229L)
  public static SubLObject new_psp_lexical_edge(final SubLObject chart, final SubLObject span, final SubLObject string, SubLObject category, SubLObject pos_pred, SubLObject cycls, SubLObject weight, SubLObject wu,
      SubLObject frame)
  {
    if( category == UNPROVIDED )
    {
    ...
    assert NIL != interval_span.interval_span_p( span ) : span;
    if( NIL != category && NIL != string_utilities.non_empty_string_p( string ) && !assertionsDisabledInClass && NIL == fort_types_interface.predicate_p( pos_pred ) )
    {
  ...
  public static SubLObject sentence_set_words_from_string_list(final SubLObject sentence, final SubLObject strings, final SubLObject sentence_string)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      offset = Sequences.search( string, sentence_string, Symbols.symbol_function( EQUAL ), Symbols.symbol_function( IDENTITY ), ZERO_INTEGER, NIL, offset, UNPROVIDED );
      if( NIL == offset && NIL == list_utilities.empty_list_p( words ) )
      {
        offset = Numbers.add( ONE_INTEGER, document.word_offset( words.first() ), document.word_length( words.first() ) );
      }
      else if( NIL == offset )
      {
        offset = ZERO_INTEGER;
      }
      words = ConsesLow.cons( document.new_word( ConsesLow.list( $kw95$STRING, string, $kw206$OFFSET, offset ) ), words );
      cdolist_list_var = cdolist_list_var.rest();
      string = cdolist_list_var.first();
    }
    words = Functions.apply( $sym207$VECTOR, Sequences.nreverse( words ) );
    document.sign_update( sentence, ConsesLow.list( $kw208$CONSTITUENTS, words ) );
    return sentence;
  }
  ...
  public static SubLObject initialize_psp_chart(SubLObject input_string, SubLObject chart, SubLObject lexicon, SubLObject gap_type)
  {
    ...
    try
    {
      ...
      try
      {
        document.sign_update( sentence, ConsesLow.list( $kw95$STRING, input_string ) );
  ...
  public static SubLObject psp_add_edges_from_sentence(final SubLObject sentence, final SubLObject mode, final SubLObject lexicon, final SubLObject chart)
  {
    ...
    try
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        if( mode != $kw214$DILIGENT || NIL == psp_chart_has_better_edgeP( chart, edge ) )
        {
  ...
  {
    return lexicon_accessors.genl_posP( get_psp_edge_category( edge ), $const216$ClosedClassWord, UNPROVIDED );
  }
  ...
  {
    assert NIL != psp_tokenization_mode_p( mode ) : mode;
    return ( mode == $kw218$GREEDY ) ? $psp_edge_greedy_weight$.getGlobalValue() : $psp_edge_dispreferred_weight$.getGlobalValue();
  }
  ...
  public static SubLObject psp_sentence_edgify(final SubLObject sentence, SubLObject mode, SubLObject lexicon)
  {
    ...
    final SubLObject all_edges = Vectors.make_vector( document.sentence_length( sentence ), UNPROVIDED );
    SubLObject edges = NIL;
    SubLObject cdotimes_end_var;
    SubLObject i;
    for( cdotimes_end_var = document.sentence_length( sentence ), i = NIL, i = ZERO_INTEGER; i.numL( cdotimes_end_var ); i = Numbers.add( i, ONE_INTEGER ) )
    {
      Vectors.set_aref( all_edges, i, set.new_set( EQUAL, UNPROVIDED ) );
    }
    ...
    else if( pcase_var.eql( $kw214$DILIGENT ) )
    {
  ...
  public static SubLObject psp_add_lexicon_edges(final SubLObject all_edges, final SubLObject original_sentence, SubLObject lexicon)
  {
    ...
    final SubLObject lexified_sentence = methods.funcall_instance_method_with_1_args( lexicon, $sym220$LEXIFY_SENTENCE, sentence );
    ...
    while ( NIL != signs)
    {
      ...
      else
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          SubLObject cdolist_list_var_$8 = ( NIL != fscp_multi_parse_category_p( document.sign_category( sign_$7 ) ) ) ? document.sign_info( sign_$7 ) : ConsesLow.list( document.sign_info( sign_$7 ) );
          SubLObject cycl = NIL;
          cycl = cdolist_list_var_$8.first();
          while ( NIL != cdolist_list_var_$8)
          {
            if( NIL != Functions.funcall( filter_fn, cycl ) && NIL == Strings.stringE( document.sign_string( sign_$7 ), $str222$a, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) )
            {
              final SubLObject cycls = psp_new_cycls( cycl, UNPROVIDED );
              psp_add_edge_to_result_vector( new_psp_lexical_edge( parsing_vars.$psp_chart$.getDynamicValue( thread ), interval_span.get_interval_span( standard_tokenization.interval_token_start( fscp_constituent ),
                  standard_tokenization.interval_token_end( fscp_constituent ) ), document.sign_string( sign_$7 ), pos, pred, cycls, weight, UNPROVIDED, UNPROVIDED ), all_edges );
            }
  ...
  public static SubLObject psp_sentence_copy(final SubLObject sentence)
  {
    ...
    final SubLObject new_words = Vectors.make_vector( Sequences.length( document.sentence_constituents( sentence ) ), UNPROVIDED );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      word_num = Numbers.add( word_num, ONE_INTEGER );
      cdolist_list_var = cdolist_list_var.rest();
      word = cdolist_list_var.first();
    }
  ...
  {
    assert NIL != document.word_p( word ) : word;
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    psp_add_fscp_edges( all_edges, sentence, numeral_parser.$english_interval_parser$.getDynamicValue( thread ), $const224$Number_SP, $const225$partOfSpeech, $sym226$PSP_SCALAR_INTERVAL_ );
    return all_edges;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    psp_add_fscp_edges( all_edges, sentence, numeral_parser.$digit_interval_parser$.getDynamicValue( thread ), $const224$Number_SP, $const225$partOfSpeech, $sym227$IBQE_ );
    return all_edges;
  }
  ...
  {
    psp_add_fscp_edges( all_edges, sentence, english_quantity_parser.english_quantity_parser(), $const198$NounPhrase, $const228$simpleNounStrings, $sym226$PSP_SCALAR_INTERVAL_ );
    return all_edges;
  }
  ...
  public static SubLObject psp_add_guessed_edges(final SubLObject all_edges, final SubLObject words)
  {
    ...
    SubLObject string;
    for( cdotimes_end_var = Sequences.length( words ), start = NIL, start = ZERO_INTEGER; start.numL( cdotimes_end_var ); start = Numbers.add( start, ONE_INTEGER ) )
    {
      if( NIL == psp_edge_covering_startP( all_edges, start ) )
      {
        empty_starts = ConsesLow.cons( start, empty_starts );
        guess_end = number_utilities.f_1X( start );
        for( guess_start = start; NIL != conses_high.member( guess_start, empty_starts, UNPROVIDED, UNPROVIDED ); guess_start = Numbers.subtract( guess_start, ONE_INTEGER ) )
        {
          string = string_utilities.bunge( Mapping.mapcar( Symbols.symbol_function( $sym229$WORD_STRING ), Sequences.subseq( words, guess_start, guess_end ) ), UNPROVIDED );
  ...
  public static SubLObject psp_add_guessed_edge(final SubLObject start, final SubLObject end, final SubLObject all_edges, final SubLObject string)
  {
    ...
    thread.resetMultipleValues();
    final SubLObject guessed_edge = new_psp_lexical_edge( parsing_vars.$psp_chart$.getDynamicValue( thread ), interval_span.get_interval_span( start, end ), string, category, pos_pred, cycls, psp_guessed_word_weight,
  ...
  {
    SubLObject foundP = makeBoolean( NIL == set.set_emptyP( Vectors.aref( edges, start ) ) );
    if( NIL == foundP )
    {
      SubLObject csome_list_var;
      SubLObject span;
      for( csome_list_var = psp_spans_starting_at_start( start, UNPROVIDED ), span = NIL, span = csome_list_var.first(); NIL == foundP && NIL != csome_list_var; foundP = psp_span_has_edges_p( span,
          UNPROVIDED ), csome_list_var = csome_list_var.rest(), span = csome_list_var.first() )
      {
      }
    }
    SubLObject lookup;
  ...
  public static SubLObject psp_spans_starting_at_start(final SubLObject start, SubLObject chart)
  {
    ...
    return list_utilities.find_all( start, psp_chart_spans( chart, UNPROVIDED, UNPROVIDED ), Symbols.symbol_function( $sym230$_ ), $sym231$INTERVAL_SPAN_START );
  }
  ...
  public static SubLObject psp_add_indexical_edges(final SubLObject all_edges, final SubLObject words)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      for( start = NIL, start = ZERO_INTEGER; NIL == list_utilities.lengthLE( words, start, UNPROVIDED ); start = number_utilities.f_1X( start ) )
      {
        ...
        if( Mapping.mapcar( Symbols.symbol_function( $sym229$WORD_STRING ), Sequences.subseq( words, start, end ) ).equalp( indexical_strings ) )
        {
          span = interval_span.get_interval_span( start, end );
          category = $const198$NounPhrase;
          pos_pred = $const233$nameString;
  ...
  public static SubLObject psp_maybe_guess_info_for_unknown_string(final SubLObject string, final SubLObject start, final SubLObject end)
  {
    ...
    if( NIL != parsing_vars.$guess_semantics_for_unknown_wordsP$.getDynamicValue( thread ) )
    {
      ...
      psp_add_cycl_to_cycls( ConsesLow.list( $const234$InstanceNamedFn, string, type ), cycls, UNPROVIDED );
    }
  ...
  {
    return makeBoolean( obj.isNumber() || NIL != at_defns.quiet_has_typeP( obj, $const236$ScalarInterval, UNPROVIDED ) );
  }
  ...
  public static SubLObject filter_prefixes_by_mt(final SubLObject prefixes, final SubLObject mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        filtered = ConsesLow.cons( filtered_prefix, filtered );
      }
      cdolist_list_var = cdolist_list_var.rest();
      prefix = cdolist_list_var.first();
    }
  ...
  {
    return $const237$passiveParticiple;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( NIL == frame || !pos_pred.eql( $const238$perfect ) )
    {
      return NIL;
    }
    ...
    {
      new_edges = ConsesLow.cons( new_psp_lexical_edge( parsing_vars.$psp_chart$.getDynamicValue( thread ), span, token_string, pos, psp_passive_marker(), cycls, NIL, wu, ConsesLow.list( $kw239$PASSIVE, frame ) ),
          new_edges );
      new_edges = ConsesLow.cons( new_psp_lexical_edge( parsing_vars.$psp_chart$.getDynamicValue( thread ), span, token_string, pos, psp_passive_marker(), cycls, NIL, wu, ConsesLow.list( $kw240$PASSIVE_WITH_BY,
          frame ) ), new_edges );
    }
    return new_edges;
  }
  ...
  public static SubLObject psp_deverbal_edges(final SubLObject span, final SubLObject token_string, final SubLObject pos, final SubLObject pos_pred, final SubLObject cycls, final SubLObject weight, final SubLObject wu)
  {
    ...
    SubLObject new_edges = NIL;
    if( NIL != Sequences.find( $const241$TransitiveNPFrame, lexicon_accessors.frames_of_wordXpos( wu, $const242$Verb ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) )
    {
      new_edges = ConsesLow.cons( new_psp_lexical_edge( parsing_vars.$psp_chart$.getDynamicValue( thread ), span, token_string, pos, pos_pred, cycls, weight, wu, narts_high.find_nart( $list243 ) ), new_edges );
    }
    return new_edges;
  }
  ...
  {
    return makeBoolean( NIL != psp_semantics.psp_genl_posP( pos, $const244$MassNoun, UNPROVIDED ) || NIL != psp_semantics.psp_genl_posP( pos, $const245$GerundiveNoun, UNPROVIDED ) );
  }
  ...
  public static SubLObject psp_frame_passivizableP(final SubLObject frame)
  {
    ...
    try
    {
      ...
      okP = makeBoolean( NIL != forts.fort_p( frame ) && NIL != isa.isaP( frame, $const246$PassivizableFrame, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
  ...
  public static SubLObject psp_edge_cycl_passes_name_checkP(final SubLObject token_string, final SubLObject cycl)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject passP;
    final SubLObject exemptP = passP = makeBoolean( NIL == kb_indexing_datastructures.indexed_term_p( cycl ) );
    final SubLObject eq_test = ( NIL != lexicon_accessors.closed_lexical_class_stringP( token_string, UNPROVIDED ) ) ? Symbols.symbol_function( EQUAL ) : Symbols.symbol_function( EQUALP );
        ...
        if( denot_$9.equalp( cycl ) && NIL == passP )
        {
          ...
          while ( NIL == passP && NIL != csome_list_var)
          {
            ...
            try
            {
              ...
              if( NIL != conses_high.member( unquoted_string, asserted_strings, eq_test, UNPROVIDED ) )
              {
                passP = T;
              }
              else if( NIL == precise_with_theP )
              {
                final SubLObject starts_with_theP = nl_trie_accessors.starts_with_theP( unquoted_string );
                final SubLObject the_less_token_string = ( NIL != starts_with_theP ) ? string_utilities.pre_remove( unquoted_string, $str247$the_, Symbols.symbol_function( EQUALP ) ) : unquoted_string;
                if( NIL == passP )
                {
                  ...
                  while ( NIL == passP && NIL != csome_list_var_$11)
                  {
                    ...
                    {
                      passP = Functions.funcall( eq_test, unquoted_string, string_utilities.pre_remove( asserted_string, $str247$the_, Symbols.symbol_function( EQUALP ) ) );
                    }
  ...
  {
    return list_utilities.sublisp_boolean( lexicon_accessors.denots_of_string( string, NIL, $kw248$DENOT, NIL, T, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject psp_chart_add_edge(final SubLObject edge, SubLObject chart)
  {
    ...
    {
      PrintLow.format( T, $str249$__Adding_new_edge_____S__Looking_, edge, get_psp_edge_new_dtr_constraints( edge ) );
    }
    return $kw215$ADDED;
  }
  ...
  public static SubLObject psp_edge_set_lookup_node(final SubLObject edge_set, SubLObject not_found)
  {
    ...
    SubLObject state;
    SubLObject edge;
    for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object, set_contents_var ); NIL == node && NIL == set_contents
  ...
  public static SubLObject psp_longest_edges(final SubLObject edges)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, edge ) )
      {
        ...
        {
          longest = ConsesLow.cons( edge, longest );
        }
        else if( length.numG( maxlength ) )
        {
          maxlength = length;
          longest = ConsesLow.list( edge );
        }
      }
    }
    return longest;
  ...
  public static SubLObject psp_edge_next_dtr_constraints(final SubLObject edge)
  {
    ...
    if( pcase_var.eql( $kw179$UNKNOWN ) )
    {
      return $kw179$UNKNOWN;
    }
    return ndcs.first();
  }
  ...
  public static SubLObject psp_edge_dtrs(final SubLObject edge)
  {
    ...
    if( NIL != head_dtr )
    {
      all_dtrs = ConsesLow.append( list_utilities.first_n( number_utilities.f_1_( head_dtr_num ), non_head_dtrs ), ConsesLow.cons( head_dtr, conses_high.nthcdr( number_utilities.f_1_( head_dtr_num ), non_head_dtrs ) ) );
    }
    else
    {
  ...
  {
    return makeBoolean( get_psp_edge_span( edge1 ).equalp( get_psp_edge_span( edge2 ) ) && get_psp_edge_category( edge1 ).equalp( get_psp_edge_category( edge2 ) ) && get_psp_edge_pos_pred( edge1 ).equalp(
        get_psp_edge_pos_pred( edge2 ) ) && get_psp_edge_cycls( edge1 ).equalp( get_psp_edge_cycls( edge2 ) ) );
  }
  ...
  public static SubLObject psp_chart_max_span()
  {
    ...
    final SubLObject end_index = ( NIL != parsing_vars.$psp_chart_end_index$.getDynamicValue( thread ) ) ? parsing_vars.$psp_chart_end_index$.getDynamicValue( thread )
        : psp_chart_length( parsing_vars.$psp_chart$.getDynamicValue( thread ) );
  ...
  public static SubLObject psp_all_complete_edges(SubLObject non_trivialP)
  {
    ...
    assert NIL != phrase_structure_parser_chart_p( chart_to_use ) : chart_to_use;
    SubLObject iteration_state;
    for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( psp_chart_spans_to_edges( chart_to_use ) ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      thread.resetMultipleValues();
      final SubLObject span = dictionary_contents.do_dictionary_contents_key_value( iteration_state );
    ...
    dictionary_contents.do_dictionary_contents_finalize( iteration_state );
    return ( NIL != non_trivialP ) ? Sequences.remove_if( $sym251$PSP_LEXICAL_EDGE_, edges, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) : edges;
  }
  ...
  public static SubLObject psp_complete_edges_for_span(final SubLObject span)
  {
    ...
    final SubLObject complete_edges = Sequences.remove_if( $sym253$PSP_INCOMPLETE_EDGE_, all_edges, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject psp_chart_has_unknown_stringsP(SubLObject chart)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != phrase_structure_parser_chart_p( chart ) : chart;
    ...
    if( NIL == unknownP )
    {
      ...
      for( end_var = psp_chart_length( chart ), i = NIL, i = ZERO_INTEGER; NIL == unknownP && !i.numGE( end_var ); unknownP = makeBoolean( NIL == knownP ), i = number_utilities.f_1X( i ) )
      {
        ...
        assert NIL != phrase_structure_parser_chart_p( chart_to_use ) : chart_to_use;
        for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( psp_chart_spans_to_edges( chart_to_use ) ) ); NIL == knownP && NIL == dictionary_contents
            .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
        {
          ...
          if( NIL != interval_span.interval_span_subsumesP( span, ispan ) && NIL == knownP )
          {
            ...
            {
              if( NIL != psp_do_edge_okP( edge, $kw165$ANY, T ) && NIL == dictionary.dictionary_empty_p( get_psp_edge_cycls( edge ) ) )
              {
                knownP = T;
              }
              csome_list_var = csome_list_var.rest();
  ...
  public static SubLObject psp_np_edges()
  {
    ...
    final SubLObject comp_edges = Sequences.remove_if( $sym253$PSP_INCOMPLETE_EDGE_, edges, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject cache_psp_frame_info()
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      final SubLObject frames = isa.all_fort_instances( $const255$SubcategorizationFrame, UNPROVIDED, UNPROVIDED );
      ...
      try
      {
        ...
        try
        {
          utilities_macros.noting_percent_progress_preamble( $str256$Initializing_Subcategorization_Fr );
          SubLObject list_var = NIL;
          SubLObject frame = NIL;
          SubLObject sofar = NIL;
          list_var = frames;
          frame = list_var.first();
          for( sofar = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), frame = list_var.first(), sofar = Numbers.add( ONE_INTEGER, sofar ) )
          {
  ...
  public static SubLObject remove_psp_bindings_from_frame_int(final SubLObject frame, SubLObject mt)
  {
    ...
    return memoization_state.caching_state_remove_function_results_with_args( $psp_bindings_from_frame_int_caching_state$.getGlobalValue(), ConsesLow.list( frame, mt ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject psp_bindings_from_frame_int_internal(final SubLObject frame, final SubLObject mt)
  {
    ...
    SubLObject cdolist_list_var = ask_utilities.ask_template( $list262, ConsesLow.listS( $const263$subcatFrameDependentKeyword, frame, $list262 ), mt, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    SubLObject binding = NIL;
    binding = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      ConsesLow.rplaca( binding, number_utilities.f_1X( binding.first() ) );
      v_bindings = ConsesLow.cons( ConsesLow.cons( $kw261$INSTANCE, binding ), v_bindings );
      cdolist_list_var = cdolist_list_var.rest();
      binding = cdolist_list_var.first();
    }
    return v_bindings;
  ...
  public static SubLObject psp_bindings_from_frame_int(final SubLObject frame, SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym260$PSP_BINDINGS_FROM_FRAME_INT, $sym264$_PSP_BINDINGS_FROM_FRAME_INT_CACHING_STATE_, NIL, EQL, TWO_INTEGER, $int265$128 );
    }
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( psp_bindings_from_frame_int_internal( frame, mt ) ) );
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $psp_predicative_frameP_caching_state$.getGlobalValue(), ConsesLow.list( frame ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/psp-chart.lisp", position = 66887L)
  public static SubLObject psp_predicative_frameP_internal(final SubLObject frame)
  {
    return makeBoolean( NIL != forts.fort_p( frame ) && NIL != isa.isa_in_any_mtP( frame, $const267$PredicativeFrame ) );
  }
  ...
  public static SubLObject psp_predicative_frameP(final SubLObject frame)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym266$PSP_PREDICATIVE_FRAME_, $sym268$_PSP_PREDICATIVE_FRAME__CACHING_STATE_, NIL, EQL, ONE_INTEGER, $int265$128 );
    }
    ...
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( psp_predicative_frameP_internal( frame ) ) );
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $psp_keywords_for_frame_caching_state$.getGlobalValue(), ConsesLow.list( frame ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject psp_keywords_for_frame_internal(final SubLObject frame)
  {
    ...
    return ask_utilities.ask_variable( $sym270$_KEYWORD, ConsesLow.listS( $const271$subcatFrameKeywords, frame, $list272 ), $const273$InferencePSC, FIVE_INTEGER, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject psp_keywords_for_frame(final SubLObject frame)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym269$PSP_KEYWORDS_FOR_FRAME, $sym274$_PSP_KEYWORDS_FOR_FRAME_CACHING_STATE_, NIL, EQL, ONE_INTEGER, $int265$128 );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, frame, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( psp_keywords_for_frame_internal( frame ) ) );
      memoization_state.caching_state_put( caching_state, frame, results, UNPROVIDED );
    }
    return memoization_state.caching_results( results );
  }
  ...
  public static SubLObject remove_psp_constrained_frameP(final SubLObject frame, SubLObject mt)
  {
    ...
    return memoization_state.caching_state_remove_function_results_with_args( $psp_constrained_frameP_caching_state$.getGlobalValue(), ConsesLow.list( frame, mt ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject psp_constrained_frameP_internal(final SubLObject frame, final SubLObject mt)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      ans = makeBoolean( NIL != intransitive_frameP( frame, UNPROVIDED ) || NIL != kb_mapping_utilities.some_pred_value( frame, $const276$subcatFrameDependentConstraint, ONE_INTEGER, $kw277$TRUE ) );
    }
    finally
    {
      mt_relevance_macros.$relevant_mts$.rebind( _prev_bind_3, thread );
  ...
  public static SubLObject psp_constrained_frameP(final SubLObject frame, SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym275$PSP_CONSTRAINED_FRAME_, $sym278$_PSP_CONSTRAINED_FRAME__CACHING_STATE_, NIL, EQL, TWO_INTEGER, $int265$128 );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_2( frame, mt );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    if( !collisions.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( psp_constrained_frameP_internal( frame, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( frame, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject remove_psp_devisable_verb_frames(SubLObject mt)
  {
    ...
    return memoization_state.caching_state_remove_function_results_with_args( $psp_devisable_verb_frames_caching_state$.getGlobalValue(), ConsesLow.list( mt ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject psp_devisable_verb_frames(SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym279$PSP_DEVISABLE_VERB_FRAMES, $sym281$_PSP_DEVISABLE_VERB_FRAMES_CACHING_STATE_, NIL, EQL, ONE_INTEGER, SIXTEEN_INTEGER );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, mt, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( psp_devisable_verb_frames_internal( mt ) ) );
  ...
  public static SubLObject remove_transitive_np_comp_frameP(final SubLObject frame, SubLObject mt)
  {
    ...
    return memoization_state.caching_state_remove_function_results_with_args( $transitive_np_comp_frameP_caching_state$.getGlobalValue(), ConsesLow.list( frame, mt ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/psp-chart.lisp", position = 68163L)
  public static SubLObject transitive_np_comp_frameP_internal(final SubLObject frame, final SubLObject mt)
  {
    return at_defns.quick_quiet_has_typeP( frame, $const283$TransitiveNPFrameType, mt );
  }
  ...
  public static SubLObject transitive_np_comp_frameP(final SubLObject frame, SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym282$TRANSITIVE_NP_COMP_FRAME_, $sym284$_TRANSITIVE_NP_COMP_FRAME__CACHING_STATE_, NIL, EQL, TWO_INTEGER, $int265$128 );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_2( frame, mt );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    if( !collisions.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( transitive_np_comp_frameP_internal( frame, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( frame, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject remove_intransitive_frameP(final SubLObject frame, SubLObject mt)
  {
    ...
    return memoization_state.caching_state_remove_function_results_with_args( $intransitive_frameP_caching_state$.getGlobalValue(), ConsesLow.list( frame, mt ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/psp-chart.lisp", position = 68354L)
  public static SubLObject intransitive_frameP_internal(final SubLObject frame, final SubLObject mt)
  {
    return list_utilities.sublisp_boolean( backward.removal_ask( ConsesLow.listS( $const286$subcatFrameArity, frame, $list287 ), mt, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject intransitive_frameP(final SubLObject frame, SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym285$INTRANSITIVE_FRAME_, $sym288$_INTRANSITIVE_FRAME__CACHING_STATE_, NIL, EQL, TWO_INTEGER, $int265$128 );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_2( frame, mt );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    if( !collisions.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( intransitive_frameP_internal( frame, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( frame, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $psp_frame_has_typeP_caching_state$.getGlobalValue(), ConsesLow.list( frame, type ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject psp_frame_has_typeP(final SubLObject frame, final SubLObject type)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym289$PSP_FRAME_HAS_TYPE_, $sym290$_PSP_FRAME_HAS_TYPE__CACHING_STATE_, NIL, EQL, TWO_INTEGER, $int265$128 );
    }
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( psp_frame_has_typeP_internal( frame, type ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( frame, type ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject remove_psp_passivized_dtr_num(final SubLObject frame, SubLObject mt)
  {
    ...
    return memoization_state.caching_state_remove_function_results_with_args( $psp_passivized_dtr_num_caching_state$.getGlobalValue(), ConsesLow.list( frame, mt ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject psp_passivized_dtr_num_internal(final SubLObject frame, final SubLObject mt)
  {
    ...
    final SubLObject ask_result = ask_utilities.ask_template( $sym292$_N, ConsesLow.list( $const293$and, ConsesLow.listS( $const294$isa, fort_frame, $list295 ), ConsesLow.listS( $const276$subcatFrameDependentConstraint,
        fort_frame, $list296 ) ), mt, ONE_INTEGER, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    final SubLObject nums = list_utilities.remove_if_not( $sym297$INTEGERP, ask_result, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject psp_passivized_dtr_num(final SubLObject frame, SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym291$PSP_PASSIVIZED_DTR_NUM, $sym298$_PSP_PASSIVIZED_DTR_NUM_CACHING_STATE_, NIL, EQL, TWO_INTEGER, $int265$128 );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_2( frame, mt );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    if( !collisions.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( psp_passivized_dtr_num_internal( frame, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( frame, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject psp_passivized_dtr_keyword(final SubLObject frame)
  {
    ...
    final SubLObject binding_list = Sequences.find( p_dtr_num, v_bindings, Symbols.symbol_function( EQL ), Symbols.symbol_function( $sym299$SECOND ), UNPROVIDED, UNPROVIDED );
  ...
  {
    return makeBoolean( frame.isCons() && NIL != conses_high.member( frame.first(), $psp_passive_keys$.getGlobalValue(), UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject psp_passivize_bindings(final SubLObject v_bindings, final SubLObject passive_frame)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        ...
        {
          new_bindings = ConsesLow.cons( ConsesLow.list( type_$16, number_utilities.f_1_( n ), keyword ), new_bindings );
        }
      }
      else
      {
    ...
    if( type == $kw240$PASSIVE_WITH_BY )
    {
      new_bindings = ConsesLow.cons( psp_by_subject_binding( active_frame ), new_bindings );
    }
    return new_bindings;
  }
  ...
  public static SubLObject psp_by_subject_binding(final SubLObject active_frame)
  {
    ...
    final SubLObject by_obj_num = Numbers.add( TWO_INTEGER, frame_arity );
    return ConsesLow.listS( $kw261$INSTANCE, by_obj_num, $list303 );
  }
  ...
  public static SubLObject psp_new_cycls(SubLObject initial_cycl, SubLObject type)
  {
    ...
    final SubLObject cycls = dictionary.new_dictionary( Symbols.symbol_function( EQ ), ZERO_INTEGER );
    if( NIL != initial_cycl )
    {
  ...
  public static SubLObject build_psp_edges_from_lex_entries(final SubLObject start, final SubLObject end, final SubLObject words, final SubLObject edge_string, final SubLObject lex_entries)
  {
    ...
    SubLObject edges = NIL;
    if( NIL != $psp_parse_wh_wordsP$.getGlobalValue() || NIL == lexicon_accessors.string_is_posP( edge_string, $const306$WHWord, UNPROVIDED, UNPROVIDED, UNPROVIDED ) )
    {
      if( NIL != lex_entries )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          while ( NIL != cdolist_list_var_$17)
          {
            ...
            if( NIL == conses_high.member( item_var, edges, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
            {
              edges = ConsesLow.cons( item_var, edges );
            }
      ...
      else if( NIL != list_utilities.singletonP( words ) )
      {
        final SubLObject word = words.first();
        edges = ConsesLow.cons( new_psp_lexical_edge( parsing_vars.$psp_chart$.getDynamicValue( thread ), span, edge_string, psp_find_constant( document.word_category( word ).first() ), psp_find_constant( conses_high
            .second( document.word_category( word ) ) ), numeral_parser.string_to_interval( document.word_string( word ) ), UNPROVIDED, UNPROVIDED, UNPROVIDED ), edges );
      }
    }
    return edges;
  }
  ...
  public static SubLObject build_psp_edges_from_lex_entry(final SubLObject lex_entry, final SubLObject span, final SubLObject edge_string)
  {
    ...
    final SubLObject cat = methods.funcall_instance_method_with_1_args( lex_entry, $sym307$GET, $kw308$CYC_CATEGORY );
    final SubLObject wu = methods.funcall_instance_method_with_1_args( lex_entry, $sym307$GET, $kw309$WORD_UNIT );
    SubLObject cdolist_list_var;
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != psp_term_passes_constraintsP( cycl, UNPROVIDED ) )
      {
        ...
        if( cycl != $kw310$NO_DENOT )
        {
          psp_add_cycl_to_cycls( cycl, cycls, UNPROVIDED );
        }
        if( NIL != wu && NIL != subl_promotions.memberP( $const311$RegularNounFrame, frames, UNPROVIDED, UNPROVIDED ) )
        {
        ...
        while ( NIL != cdolist_list_var_$19)
        {
          ...
          edges = ConsesLow.cons( new_psp_lexical_edge( parsing_vars.$psp_chart$.getDynamicValue( thread ), span, edge_string, cat, pos_pred, cycls, weight, wu, frame ), edges );
  ...
  {
    return methods.funcall_instance_method_with_1_args( lex_entry, $sym307$GET, $kw312$TRIE_ENTRY );
  }
  ...
  public static SubLObject lex_entry_preferred_denots(final SubLObject lex_entry)
  {
    ...
    return ( NIL != nl_trie_entry ) ? nl_trie.nl_trie_entry_preferred_denots( nl_trie_entry ) : ConsesLow.list( methods.funcall_instance_method_with_1_args( lex_entry, $sym307$GET, $kw248$DENOT ) );
  }
  ...
  {
    return ( NIL == methods.funcall_instance_method_with_1_args( lex_entry, $sym307$GET, $kw309$WORD_UNIT ) && NIL != methods.funcall_instance_method_with_1_args( lex_entry, $sym307$GET, $kw313$PREDICATE ) ) ? ConsesLow
        .list( methods.funcall_instance_method_with_1_args( lex_entry, $sym307$GET, $kw313$PREDICATE ) ) : methods.funcall_instance_method_with_1_args( lex_entry, $sym307$GET, $kw314$INFLECTIONS );
  }
  ...
  public static SubLObject titles_conventionally_quoted()
  {
    ...
    final SubLObject pred = constants_high.find_constant( $str315$titlesConventionallyQuoted );
  ...
  {
    if( NIL != subl_promotions.memberP( cycl, preferred_denots, Symbols.symbol_function( EQUAL ), UNPROVIDED ) )
    {
      return Numbers.minus( $psp_preferred_denot_preference_factor$.getGlobalValue() );
    }
    if( NIL != lexicon_accessors.genl_pos_predP( pos_pred, $const316$titleOfWork, UNPROVIDED ) && NIL != cyc_kernel.closed_query_success_result_p( inference_kernel.new_cyc_query( ConsesLow.list(
        titles_conventionally_quoted(), cycl ), parsing_utilities.psp_lexicon_root_mt( UNPROVIDED ), UNPROVIDED ) ) )
    {
      return TWO_INTEGER;
    }
    return ZERO_INTEGER;
  ...
  public static SubLObject psp_disprefer_weight(final SubLObject entry_weight, SubLObject disprefer_level)
  {
    ...
    {
      SubLObject i;
      for( i = NIL, i = ZERO_INTEGER; i.numL( disprefer_level ); i = Numbers.add( i, ONE_INTEGER ) )
      {
        weight = psp_weight_compose_two( weight, $psp_edge_dispreferred_weight$.getGlobalValue() );
      }
    }
    else if( NIL != subl_promotions.negative_integer_p( disprefer_level ) )
    {
  ...
  public static SubLObject psp_reprefer_weight(final SubLObject entry_weight, SubLObject reprefer_level)
  {
    ...
    SubLObject i;
    SubLObject delta;
    for( i = NIL, i = ZERO_INTEGER; i.numL( reprefer_level ); i = Numbers.add( i, ONE_INTEGER ) )
    {
      delta = ( ( parsing_vars.$psp_weight_type$.getGlobalValue() == $kw180$INTEGER ) ? Numbers.integerDivide( Numbers.subtract( parsing_vars.$psp_max_weight$.getGlobalValue(), weight ), FOUR_INTEGER )
          : Numbers.divide( Numbers.subtract( parsing_vars.$psp_max_weight$.getGlobalValue(), weight ), FOUR_INTEGER ) );
  ...
  public static SubLObject psp_term_has_preferred_lexificationsP(final SubLObject cycl)
  {
    ...
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( psp_term_has_preferred_lexificationsP_internal( cycl ) ) );
  ...
  public static SubLObject psp_filter_lexical_quads(final SubLObject quads, final SubLObject quad_string)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        good_quads = ConsesLow.cons( quad, good_quads );
      }
      cdolist_list_var = cdolist_list_var.rest();
      quad = cdolist_list_var.first();
    }
  ...
  public static SubLObject psp_good_lexical_quadP(final SubLObject quad, final SubLObject quad_string)
  {
    ...
    SubLObject pos_pred = NIL;
    SubLObject wu = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( quad, quad, $list318 );
    cycl = quad.first();
    SubLObject current = quad.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, quad, $list318 );
    pos = current.first();
    current = current.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, quad, $list318 );
    ...
    if( NIL == current )
    {
      return makeBoolean( NIL == parsing_utilities.blacklisted_cycl_for_parsersP( cycl ) && ( NIL == lexicon_vars.name_string_predP( pos_pred ) || NIL != psp_edge_cycl_passes_name_checkP( quad_string, cycl ) )
          && ( NIL == psp_semantics.psp_genl_posP( pos, $const216$ClosedClassWord, UNPROVIDED ) || NIL != lexicon_accessors.closed_lexical_class_stringP( quad_string, UNPROVIDED ) ) && NIL != psp_ok_pos_predP(
              pos_pred ) );
    }
    cdestructuring_bind.cdestructuring_bind_error( quad, $list318 );
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return makeBoolean( NIL == parsing_vars.$psp_pos_pred_filterP$.getDynamicValue( thread ) || NIL == conses_high.member( pos_pred, parsing_vars.$psp_pos_pred_filter_preds$.getDynamicValue( thread ), UNPROVIDED,
        UNPROVIDED ) );
  }
  ...
  public static SubLObject psp_adjust_edge_weight(final SubLObject edge, final SubLObject edges)
  {
    ...
    if( NIL != lexicon_accessors.genl_pos_predP( pos_pred, $const316$titleOfWork, UNPROVIDED ) )
    {
      ...
      if( NIL == dispreference_level )
      {
        ...
        {
          if( !other_edge.eql( edge ) && NIL != lexicon_accessors.genl_pos_predP( get_psp_edge_pos_pred( other_edge ), $const233$nameString, UNPROVIDED ) && NIL == dispreference_level )
          {
            SubLObject csome_list_var_$20 = psp_edge_lookup_semx( other_edge, $kw304$DENOT_GROUND );
            SubLObject cycl = NIL;
            cycl = csome_list_var_$20.first();
            while ( NIL == dispreference_level && NIL != csome_list_var_$20)
            {
              if( NIL == psp_rules.psp_isaP( cycl, $const319$FictionalCharacter ) && NIL == psp_rules.psp_isaP( cycl, $const320$ConceptualWork ) )
              {
  ...
  public static SubLObject psp_consolidate_edges(final SubLObject edges)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == prior_edge || NIL == dictionary.dictionary_empty_p( edge_cycls ) )
      {
        ...
        {
          SubLObject iteration_state;
          for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( edge_cycls ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
              iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
          {
            thread.resetMultipleValues();
        ...
        {
          output_edges = ConsesLow.cons( edge, output_edges );
        }
      }
      cdolist_list_var = cdolist_list_var.rest();
      edge = cdolist_list_var.first();
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject subsumedP = makeBoolean( NIL == psp_edge_weightierP( edge, other_edge, UNPROVIDED ) && NIL != psp_edge_pos_pred_subsumedP( edge, other_edge ) && NIL != psp_edge_category_subsumedP( edge, other_edge )
        && NIL != psp_edge_frame_subsumedP( edge, other_edge ) && NIL != psp_edge_cycls_subsumedP( edge, other_edge ) );
    if( NIL != parsing_vars.$psp_verboseP$.getDynamicValue( thread ) && NIL != subsumedP )
    {
      PrintLow.format( T, $str322$__Removing_edge_____S__is_subsume, edge, other_edge );
    }
    return subsumedP;
  }
  ...
  public static SubLObject psp_cycls_subsumedP(final SubLObject cycls, final SubLObject other_cycls)
  {
    ...
    if( NIL == differentP )
    {
      ...
      for( key = NIL, key_$22 = NIL, other_key = NIL, other_key_$23 = NIL, key = dictionary.dictionary_keys( cycls ), key_$22 = key.first(), other_key = dictionary.dictionary_keys(
          other_cycls ), other_key_$23 = other_key.first(); NIL == differentP && ( NIL != other_key || NIL != key ); differentP = makeBoolean( NIL == psp_cycls_subsumedP_int( dictionary.dictionary_lookup( cycls, key_$22,
              UNPROVIDED ), dictionary.dictionary_lookup( other_cycls, other_key_$23, UNPROVIDED ) ) ), key = key.rest(), key_$22 = key.first(), other_key = other_key.rest(), other_key_$23 = other_key.first() )
      {
      }
    }
  ...
  public static SubLObject psp_cycls_subsumedP_int(final SubLObject cycls, final SubLObject other_cycls)
  {
    ...
    if( NIL == problemP )
    {
      ...
      {
        if( NIL == subl_promotions.memberP( cycl, other_cycls, Symbols.symbol_function( EQUAL ), UNPROVIDED ) )
        {
          problemP = T;
        }
        csome_list_var = csome_list_var.rest();
  ...
  {
    return makeBoolean( get_psp_edge_pos_pred( edge ).eql( get_psp_edge_pos_pred( other_edge ) ) && get_psp_edge_category( edge ).eql( get_psp_edge_category( other_edge ) ) && get_psp_edge_frame( edge ).eql(
        get_psp_edge_frame( other_edge ) ) && NIL != psp_edge_weights_equalP( edge, other_edge, ZERO_INTEGER ) );
  }
  ...
  public static SubLObject psp_find_frames_internal(final SubLObject wu, final SubLObject pos, final SubLObject denot, SubLObject mt)
  {
    ...
    if( NIL != wu && NIL != pos )
    {
      ...
      if( denot != $kw310$NO_DENOT )
      {
        frames = conses_high.union( frames, lexicon_accessors.frames_of_word_posXdenot( wu, pos, denot ), UNPROVIDED, UNPROVIDED );
      }
    }
    if( NIL != psp_semantics.psp_genl_posP( pos, $const324$Noun, UNPROVIDED ) )
    {
      final SubLObject item_var = $const311$RegularNounFrame;
      if( NIL == conses_high.member( item_var, frames, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        frames = ConsesLow.cons( item_var, frames );
      }
    }
    else if( NIL == frames && NIL != psp_semantics.psp_genl_posP( pos, $const325$Adjective, UNPROVIDED ) )
    {
      final SubLObject item_var = $const326$RegularAdjFrame;
      if( NIL == conses_high.member( item_var, frames, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        frames = ConsesLow.cons( item_var, frames );
      }
    }
    else if( NIL == frames && denot != $kw310$NO_DENOT && NIL != psp_semantics.psp_genl_posP( pos, $const242$Verb, UNPROVIDED ) )
    {
  ...
  public static SubLObject psp_find_frames(final SubLObject wu, final SubLObject pos, final SubLObject denot, SubLObject mt)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym323$PSP_FIND_FRAMES, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym323$PSP_FIND_FRAMES, FOUR_INTEGER, NIL, EQUAL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym323$PSP_FIND_FRAMES, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( psp_find_frames_internal( wu, pos, denot, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( wu, pos, denot, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  {
    if( output_type == $kw328$DENOT_TEMPLATE )
    {
      return NIL;
    }
  ...
  public static SubLObject psp_edge_to_pph_phrase(final SubLObject edge)
  {
    ...
    pph_phrase.pph_phrase_set_agr( ans, pph_data_structures.new_pph_phrase_agr( pph_utilities.new_pph_agr_constraint( $kw98$POS_PRED, get_psp_edge_pos_pred( edge ) ), UNPROVIDED ), UNPROVIDED );
    ...
    pph_phrase.set_pph_phrase_dtrs_from_list( ans, Mapping.mapcar( $sym329$PSP_EDGE_TO_PPH_PHRASE, dtr_list ), UNPROVIDED );
  ...
  {
    SubLFiles.declareFunction( me, "phrase_structure_parser_chart_print_function_trampoline", "PHRASE-STRUCTURE-PARSER-CHART-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "phrase_structure_parser_chart_p", "PHRASE-STRUCTURE-PARSER-CHART-P", 1, 0, false );
    new $phrase_structure_parser_chart_p$UnaryFunction();
    SubLFiles.declareFunction( me, "psp_chart_id", "PSP-CHART-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_input_string", "PSP-CHART-INPUT-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_length", "PSP-CHART-LENGTH", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_spans_to_edges", "PSP-CHART-SPANS-TO-EDGES", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_gap_type", "PSP-CHART-GAP-TYPE", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_memoization_state", "PSP-CHART-MEMOIZATION-STATE", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_edge_id_index", "PSP-CHART-EDGE-ID-INDEX", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_edges_to_nodes", "PSP-CHART-EDGES-TO-NODES", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_max_edges_per_span", "PSP-CHART-MAX-EDGES-PER-SPAN", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_max_edges", "PSP-CHART-MAX-EDGES", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_maxed_out_spans", "PSP-CHART-MAXED-OUT-SPANS", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_maxed_outP", "PSP-CHART-MAXED-OUT?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_parsed_lexical_spans", "PSP-CHART-PARSED-LEXICAL-SPANS", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_id", "_CSETF-PSP-CHART-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_input_string", "_CSETF-PSP-CHART-INPUT-STRING", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_length", "_CSETF-PSP-CHART-LENGTH", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_spans_to_edges", "_CSETF-PSP-CHART-SPANS-TO-EDGES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_gap_type", "_CSETF-PSP-CHART-GAP-TYPE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_memoization_state", "_CSETF-PSP-CHART-MEMOIZATION-STATE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_edge_id_index", "_CSETF-PSP-CHART-EDGE-ID-INDEX", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_edges_to_nodes", "_CSETF-PSP-CHART-EDGES-TO-NODES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_max_edges_per_span", "_CSETF-PSP-CHART-MAX-EDGES-PER-SPAN", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_max_edges", "_CSETF-PSP-CHART-MAX-EDGES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_maxed_out_spans", "_CSETF-PSP-CHART-MAXED-OUT-SPANS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_maxed_outP", "_CSETF-PSP-CHART-MAXED-OUT?", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_chart_parsed_lexical_spans", "_CSETF-PSP-CHART-PARSED-LEXICAL-SPANS", 2, 0, false );
    SubLFiles.declareFunction( me, "make_phrase_structure_parser_chart", "MAKE-PHRASE-STRUCTURE-PARSER-CHART", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_phrase_structure_parser_chart", "VISIT-DEFSTRUCT-PHRASE-STRUCTURE-PARSER-CHART", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_phrase_structure_parser_chart_method", "VISIT-DEFSTRUCT-OBJECT-PHRASE-STRUCTURE-PARSER-CHART-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "pprint_psp_chart", "PPRINT-PSP-CHART", 1, 2, false );
    SubLFiles.declareFunction( me, "new_psp_chart", "NEW-PSP-CHART", 0, 2, false );
    SubLFiles.declareFunction( me, "destroy_psp_chart", "DESTROY-PSP-CHART", 0, 1, false );
    SubLFiles.declareFunction( me, "psp_chart_clear", "PSP-CHART-CLEAR", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_set_string", "PSP-CHART-SET-STRING", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_new_edge_id", "PSP-CHART-NEW-EDGE-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_index_edgesP", "PSP-CHART-INDEX-EDGES?", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_find_edge_by_id", "PSP-FIND-EDGE-BY-ID", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_chart_set_gap_type", "PSP-CHART-SET-GAP-TYPE", 2, 0, false );
    SubLFiles.declareFunction( me, "phrase_structure_parser_phrasal_edge_print_function_trampoline", "PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "phrase_structure_parser_phrasal_edge_p", "PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE-P", 1, 0, false );
    new $phrase_structure_parser_phrasal_edge_p$UnaryFunction();
    SubLFiles.declareFunction( me, "psp_phrasal_edge_weight", "PSP-PHRASAL-EDGE-WEIGHT", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_string", "PSP-PHRASAL-EDGE-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_span", "PSP-PHRASAL-EDGE-SPAN", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_category", "PSP-PHRASAL-EDGE-CATEGORY", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_pos_pred", "PSP-PHRASAL-EDGE-POS-PRED", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_cycls", "PSP-PHRASAL-EDGE-CYCLS", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_rule", "PSP-PHRASAL-EDGE-RULE", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_new_dtr_constraints", "PSP-PHRASAL-EDGE-NEW-DTR-CONSTRAINTS", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_head_dtr", "PSP-PHRASAL-EDGE-HEAD-DTR", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_non_head_dtrs", "PSP-PHRASAL-EDGE-NON-HEAD-DTRS", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_id", "PSP-PHRASAL-EDGE-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edge_chart", "PSP-PHRASAL-EDGE-CHART", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_weight", "_CSETF-PSP-PHRASAL-EDGE-WEIGHT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_string", "_CSETF-PSP-PHRASAL-EDGE-STRING", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_span", "_CSETF-PSP-PHRASAL-EDGE-SPAN", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_category", "_CSETF-PSP-PHRASAL-EDGE-CATEGORY", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_pos_pred", "_CSETF-PSP-PHRASAL-EDGE-POS-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_cycls", "_CSETF-PSP-PHRASAL-EDGE-CYCLS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_rule", "_CSETF-PSP-PHRASAL-EDGE-RULE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_new_dtr_constraints", "_CSETF-PSP-PHRASAL-EDGE-NEW-DTR-CONSTRAINTS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_head_dtr", "_CSETF-PSP-PHRASAL-EDGE-HEAD-DTR", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_non_head_dtrs", "_CSETF-PSP-PHRASAL-EDGE-NON-HEAD-DTRS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_id", "_CSETF-PSP-PHRASAL-EDGE-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_phrasal_edge_chart", "_CSETF-PSP-PHRASAL-EDGE-CHART", 2, 0, false );
    SubLFiles.declareFunction( me, "make_phrase_structure_parser_phrasal_edge", "MAKE-PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_phrase_structure_parser_phrasal_edge", "VISIT-DEFSTRUCT-PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_phrase_structure_parser_phrasal_edge_method", "VISIT-DEFSTRUCT-OBJECT-PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "sxhash_phrase_structure_parser_phrasal_edge_method", "SXHASH-PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE-METHOD", 1, 0, false );
    SubLFiles.declareFunction( me, "pprint_psp_phrasal_edge", "PPRINT-PSP-PHRASAL-EDGE", 1, 2, false );
    SubLFiles.declareFunction( me, "phrase_structure_parser_lexical_edge_print_function_trampoline", "PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "phrase_structure_parser_lexical_edge_p", "PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE-P", 1, 0, false );
    new $phrase_structure_parser_lexical_edge_p$UnaryFunction();
    SubLFiles.declareFunction( me, "psp_lexical_edge_weight", "PSP-LEXICAL-EDGE-WEIGHT", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_lexical_edge_string", "PSP-LEXICAL-EDGE-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_lexical_edge_span", "PSP-LEXICAL-EDGE-SPAN", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_lexical_edge_category", "PSP-LEXICAL-EDGE-CATEGORY", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_lexical_edge_pos_pred", "PSP-LEXICAL-EDGE-POS-PRED", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_lexical_edge_cycls", "PSP-LEXICAL-EDGE-CYCLS", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_lexical_edge_wu", "PSP-LEXICAL-EDGE-WU", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_lexical_edge_frame", "PSP-LEXICAL-EDGE-FRAME", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_lexical_edge_id", "PSP-LEXICAL-EDGE-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_lexical_edge_chart", "PSP-LEXICAL-EDGE-CHART", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_lexical_edge_weight", "_CSETF-PSP-LEXICAL-EDGE-WEIGHT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_lexical_edge_string", "_CSETF-PSP-LEXICAL-EDGE-STRING", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_lexical_edge_span", "_CSETF-PSP-LEXICAL-EDGE-SPAN", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_lexical_edge_category", "_CSETF-PSP-LEXICAL-EDGE-CATEGORY", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_lexical_edge_pos_pred", "_CSETF-PSP-LEXICAL-EDGE-POS-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_lexical_edge_cycls", "_CSETF-PSP-LEXICAL-EDGE-CYCLS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_lexical_edge_wu", "_CSETF-PSP-LEXICAL-EDGE-WU", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_lexical_edge_frame", "_CSETF-PSP-LEXICAL-EDGE-FRAME", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_lexical_edge_id", "_CSETF-PSP-LEXICAL-EDGE-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_psp_lexical_edge_chart", "_CSETF-PSP-LEXICAL-EDGE-CHART", 2, 0, false );
    SubLFiles.declareFunction( me, "make_phrase_structure_parser_lexical_edge", "MAKE-PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_phrase_structure_parser_lexical_edge", "VISIT-DEFSTRUCT-PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_phrase_structure_parser_lexical_edge_method", "VISIT-DEFSTRUCT-OBJECT-PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "sxhash_psp_edge", "SXHASH-PSP-EDGE", 1, 0, false );
    SubLFiles.declareFunction( me, "sxhash_phrase_structure_parser_lexical_edge_method", "SXHASH-PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE-METHOD", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_spans", "PSP-CHART-SPANS", 0, 3, false );
    SubLFiles.declareFunction( me, "pprint_psp_lexical_edge", "PPRINT-PSP-LEXICAL-EDGE", 1, 2, false );
    SubLFiles.declareFunction( me, "psp_format_edge", "PSP-FORMAT-EDGE", 1, 1, false );
    SubLFiles.declareFunction( me, "phrase_structure_parser_edge_p", "PHRASE-STRUCTURE-PARSER-EDGE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_weight", "GET-PSP-EDGE-WEIGHT", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_string", "GET-PSP-EDGE-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_span", "GET-PSP-EDGE-SPAN", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_category", "GET-PSP-EDGE-CATEGORY", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_pos_pred", "GET-PSP-EDGE-POS-PRED", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_cycls", "GET-PSP-EDGE-CYCLS", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_rule", "GET-PSP-EDGE-RULE", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_new_dtr_constraints", "GET-PSP-EDGE-NEW-DTR-CONSTRAINTS", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_head_dtr", "GET-PSP-EDGE-HEAD-DTR", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_non_head_dtrs", "GET-PSP-EDGE-NON-HEAD-DTRS", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_wu", "GET-PSP-EDGE-WU", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_frame", "GET-PSP-EDGE-FRAME", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_id", "GET-PSP-EDGE-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_chart", "GET-PSP-EDGE-CHART", 1, 0, false );
    SubLFiles.declareFunction( me, "get_psp_edge_head_lexeme", "GET-PSP-EDGE-HEAD-LEXEME", 1, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_weight", "SET-PSP-EDGE-WEIGHT", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_string", "SET-PSP-EDGE-STRING", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_span", "SET-PSP-EDGE-SPAN", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_category", "SET-PSP-EDGE-CATEGORY", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_pos_pred", "SET-PSP-EDGE-POS-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_cycls", "SET-PSP-EDGE-CYCLS", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_rule", "SET-PSP-EDGE-RULE", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_new_dtr_constraints", "SET-PSP-EDGE-NEW-DTR-CONSTRAINTS", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_head_dtr", "SET-PSP-EDGE-HEAD-DTR", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_non_head_dtrs", "SET-PSP-EDGE-NON-HEAD-DTRS", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_wu", "SET-PSP-EDGE-WU", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_frame", "SET-PSP-EDGE-FRAME", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_id", "SET-PSP-EDGE-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "set_psp_edge_chart", "SET-PSP-EDGE-CHART", 2, 0, false );
    SubLFiles.declareMacro( me, "psp_do_spans", "PSP-DO-SPANS" );
    SubLFiles.declareMacro( me, "psp_do_edges_for_span", "PSP-DO-EDGES-FOR-SPAN" );
    SubLFiles.declareMacro( me, "psp_do_lexical_edges_for_span", "PSP-DO-LEXICAL-EDGES-FOR-SPAN" );
    SubLFiles.declareFunction( me, "psp_do_edge_okP", "PSP-DO-EDGE-OK?", 3, 0, false );
    SubLFiles.declareMacro( me, "psp_do_edges", "PSP-DO-EDGES" );
    SubLFiles.declareFunction( me, "psp_weight_p", "PSP-WEIGHT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_unknown_weight_p", "PSP-UNKNOWN-WEIGHT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "possibly_psp_known_weight_p", "POSSIBLY-PSP-KNOWN-WEIGHT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_weight_G", "PSP-WEIGHT->", 2, 1, false );
    SubLFiles.declareFunction( me, "psp_weight_L", "PSP-WEIGHT-<", 2, 1, false );
    SubLFiles.declareFunction( me, "psp_weight_compose", "PSP-WEIGHT-COMPOSE", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_weight_compose_two", "PSP-WEIGHT-COMPOSE-TWO", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_weight_unknown_p", "PSP-EDGE-WEIGHT-UNKNOWN-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_weight_from_dtrs", "PSP-EDGE-WEIGHT-FROM-DTRS", 3, 0, false );
    SubLFiles.declareFunction( me, "clear_psp_np_gap_semx", "CLEAR-PSP-NP-GAP-SEMX", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_psp_np_gap_semx", "REMOVE-PSP-NP-GAP-SEMX", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_np_gap_semx_internal", "PSP-NP-GAP-SEMX-INTERNAL", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_np_gap_semx", "PSP-NP-GAP-SEMX", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_np_gap_referent", "PSP-NP-GAP-REFERENT", 0, 0, false );
    SubLFiles.declareFunction( me, "new_psp_gap_edge", "NEW-PSP-GAP-EDGE", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_gap_edge_p", "PSP-GAP-EDGE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_np_gap_edge_p", "PSP-NP-GAP-EDGE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_preposition_gap_edge_p", "PSP-PREPOSITION-GAP-EDGE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_pp_gap_edge_p", "PSP-PP-GAP-EDGE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_gap_constraint_p", "PSP-GAP-CONSTRAINT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_allowed_gap_category", "PSP-ALLOWED-GAP-CATEGORY", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_already_has_gapP", "PSP-EDGE-ALREADY-HAS-GAP?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_has_np_gapP", "PSP-EDGE-HAS-NP-GAP?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_has_pp_gapP", "PSP-EDGE-HAS-PP-GAP?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_gap_allowedP", "PSP-GAP-ALLOWED?", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_pp_gap_allowedP", "PSP-PP-GAP-ALLOWED?", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_pp_gap_constraint_p", "PSP-PP-GAP-CONSTRAINT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_pp_gap_string", "PSP-PP-GAP-STRING", 0, 0, false );
    SubLFiles.declareFunction( me, "new_psp_phrasal_edge", "NEW-PSP-PHRASAL-EDGE", 3, 8, false );
    SubLFiles.declareFunction( me, "psp_maybe_setify_dtrs", "PSP-MAYBE-SETIFY-DTRS", 2, 0, false );
    SubLFiles.declareFunction( me, "new_psp_lexical_edge", "NEW-PSP-LEXICAL-EDGE", 3, 6, false );
    SubLFiles.declareFunction( me, "psp_tokenization_mode_p", "PSP-TOKENIZATION-MODE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "sentence_set_words_from_string_list", "SENTENCE-SET-WORDS-FROM-STRING-LIST", 3, 0, false );
    SubLFiles.declareFunction( me, "initialize_psp_chart", "INITIALIZE-PSP-CHART", 1, 3, false );
    SubLFiles.declareFunction( me, "psp_add_edges_from_sentence", "PSP-ADD-EDGES-FROM-SENTENCE", 4, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_adjust_weight_for_mode", "PSP-EDGE-ADJUST-WEIGHT-FOR-MODE", 2, 0, false );
    SubLFiles.declareFunction( me, "closed_lexical_class_edgeP", "CLOSED-LEXICAL-CLASS-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_default_weight_for_mode", "PSP-DEFAULT-WEIGHT-FOR-MODE", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_has_better_edgeP", "PSP-CHART-HAS-BETTER-EDGE?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_better_edgeP", "PSP-BETTER-EDGE?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edges_same_except_for_weightP", "PSP-EDGES-SAME-EXCEPT-FOR-WEIGHT?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_weightierP", "PSP-EDGE-WEIGHTIER?", 2, 1, false );
    SubLFiles.declareFunction( me, "psp_edge_weights_equalP", "PSP-EDGE-WEIGHTS-EQUAL?", 2, 1, false );
    SubLFiles.declareFunction( me, "psp_string_tokenize", "PSP-STRING-TOKENIZE", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_sentence_edgify", "PSP-SENTENCE-EDGIFY", 1, 2, false );
    SubLFiles.declareFunction( me, "psp_add_edge_to_result_vector", "PSP-ADD-EDGE-TO-RESULT-VECTOR", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_add_lexicon_edges", "PSP-ADD-LEXICON-EDGES", 2, 1, false );
    SubLFiles.declareFunction( me, "get_raw_word_count_from_word", "GET-RAW-WORD-COUNT-FROM-WORD", 1, 0, false );
    SubLFiles.declareFunction( me, "fscp_multi_parse_category_p", "FSCP-MULTI-PARSE-CATEGORY-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_add_fscp_edges", "PSP-ADD-FSCP-EDGES", 6, 0, false );
    SubLFiles.declareFunction( me, "psp_sentence_copy", "PSP-SENTENCE-COPY", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_word_copy", "PSP-WORD-COPY", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_add_english_number_edges", "PSP-ADD-ENGLISH-NUMBER-EDGES", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_add_digit_edges", "PSP-ADD-DIGIT-EDGES", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_add_quantity_edges", "PSP-ADD-QUANTITY-EDGES", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_add_guessed_edges", "PSP-ADD-GUESSED-EDGES", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_add_guessed_edge", "PSP-ADD-GUESSED-EDGE", 4, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_covering_startP", "PSP-EDGE-COVERING-START?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_spans_starting_at_start", "PSP-SPANS-STARTING-AT-START", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_add_indexical_edges", "PSP-ADD-INDEXICAL-EDGES", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_maybe_guess_info_for_unknown_string", "PSP-MAYBE-GUESS-INFO-FOR-UNKNOWN-STRING", 3, 0, false );
    SubLFiles.declareFunction( me, "psp_type_for_unknown_string", "PSP-TYPE-FOR-UNKNOWN-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_scalar_intervalP", "PSP-SCALAR-INTERVAL?", 1, 0, false );
    SubLFiles.declareFunction( me, "filter_prefixes_by_mt", "FILTER-PREFIXES-BY-MT", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_passive_marker", "PSP-PASSIVE-MARKER", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_passive_edges", "PSP-PASSIVE-EDGES", 7, 0, false );
    SubLFiles.declareFunction( me, "psp_deverbal_edges", "PSP-DEVERBAL-EDGES", 7, 0, false );
    SubLFiles.declareFunction( me, "deverbal_noun_posP", "DEVERBAL-NOUN-POS?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_frame_passivizableP", "PSP-FRAME-PASSIVIZABLE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_cycl_passes_name_checkP", "PSP-EDGE-CYCL-PASSES-NAME-CHECK?", 2, 0, false );
    SubLFiles.declareFunction( me, "string_has_non_name_denotsP", "STRING-HAS-NON-NAME-DENOTS?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_add_edge", "PSP-CHART-ADD-EDGE", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_edge_set_lookup_node", "PSP-EDGE-SET-LOOKUP-NODE", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_edge_set_note_node", "PSP-EDGE-SET-NOTE-NODE", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_lookup_node", "PSP-EDGE-LOOKUP-NODE", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_edge_note_node", "PSP-EDGE-NOTE-NODE", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_rule_struct", "PSP-EDGE-RULE-STRUCT", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_rule_fort", "PSP-EDGE-RULE-FORT", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_longest_edges", "PSP-LONGEST-EDGES", 1, 0, false );
    SubLFiles.declareFunction( me, "best_cycl_for_edge", "BEST-CYCL-FOR-EDGE", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edges_with_span", "PSP-EDGES-WITH-SPAN", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_lexical_edges_with_span", "PSP-LEXICAL-EDGES-WITH-SPAN", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_completed_edgeP", "PSP-COMPLETED-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_incomplete_edgeP", "PSP-INCOMPLETE-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_lexical_edgeP", "PSP-LEXICAL-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_might_have_dtrs_p", "PSP-EDGE-MIGHT-HAVE-DTRS-P", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_phrasal_edgeP", "PSP-PHRASAL-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_adjp_edgeP", "PSP-ADJP-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_predicative_adjp_edgeP", "PSP-PREDICATIVE-ADJP-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_vbar_edgeP", "PSP-VBAR-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_nbar_edgeP", "PSP-NBAR-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_np_edgeP", "PSP-NP-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_starts_with_detpP", "PSP-EDGE-STARTS-WITH-DETP?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_pp_edgeP", "PSP-PP-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_passive_edgeP", "PSP-PASSIVE-EDGE?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_meets_pos_pred_constraintP", "PSP-EDGE-MEETS-POS-PRED-CONSTRAINT?", 2, 0, false );
    SubLFiles.declareFunction( me, "first_edge_matching_pos_pred", "FIRST-EDGE-MATCHING-POS-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_next_dtr_constraints", "PSP-EDGE-NEXT-DTR-CONSTRAINTS", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_later_dtr_constraints", "PSP-EDGE-LATER-DTR-CONSTRAINTS", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_head_dtr_num", "PSP-EDGE-HEAD-DTR-NUM", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_dtr_count", "PSP-EDGE-DTR-COUNT", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_dtrs", "PSP-EDGE-DTRS", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_non_branching_descendentP", "PSP-EDGE-NON-BRANCHING-DESCENDENT?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_sem_head_dtr", "PSP-EDGE-SEM-HEAD-DTR", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_lexical_head_dtr", "PSP-EDGE-LEXICAL-HEAD-DTR", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_nth_dtr", "PSP-EDGE-NTH-DTR", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_sole_dtr", "PSP-EDGE-SOLE-DTR", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_precedesP", "PSP-EDGE-PRECEDES?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_equalP", "PSP-EDGE-EQUAL?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_start_index", "PSP-EDGE-START-INDEX", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_end_index", "PSP-EDGE-END-INDEX", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_chart_max_span", "PSP-CHART-MAX-SPAN", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_all_complete_edges", "PSP-ALL-COMPLETE-EDGES", 0, 1, false );
    SubLFiles.declareFunction( me, "psp_input_spanning_edges", "PSP-INPUT-SPANNING-EDGES", 0, 1, false );
    SubLFiles.declareFunction( me, "psp_complete_edges_for_span", "PSP-COMPLETE-EDGES-FOR-SPAN", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_count", "PSP-EDGE-COUNT", 0, 1, false );
    SubLFiles.declareFunction( me, "psp_chart_has_unknown_stringsP", "PSP-CHART-HAS-UNKNOWN-STRINGS?", 0, 1, false );
    SubLFiles.declareFunction( me, "psp_edge_count_for_span", "PSP-EDGE-COUNT-FOR-SPAN", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_span_has_edges_p", "PSP-SPAN-HAS-EDGES-P", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_chart_too_many_edgesP", "PSP-CHART-TOO-MANY-EDGES?", 0, 1, false );
    SubLFiles.declareFunction( me, "psp_span_too_many_edgesP", "PSP-SPAN-TOO-MANY-EDGES?", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_span_too_many_edgesP_int", "PSP-SPAN-TOO-MANY-EDGES?-INT", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_lexical_span_parsedP", "PSP-LEXICAL-SPAN-PARSED?", 1, 1, false );
    SubLFiles.declareFunction( me, "note_psp_lexical_span_parsed", "NOTE-PSP-LEXICAL-SPAN-PARSED", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_np_edges", "PSP-NP-EDGES", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_input_spanning_edge_count", "PSP-INPUT-SPANNING-EDGE-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_bindings_from_head", "PSP-BINDINGS-FROM-HEAD", 1, 0, false );
    SubLFiles.declareFunction( me, "cache_psp_frame_info", "CACHE-PSP-FRAME-INFO", 0, 0, false );
    SubLFiles.declareFunction( me, "recache_psp_frame_info", "RECACHE-PSP-FRAME-INFO", 0, 0, false );
    SubLFiles.declareFunction( me, "clear_psp_frame_info", "CLEAR-PSP-FRAME-INFO", 0, 0, false );
    SubLFiles.declareFunction( me, "add_subcat_frame_info", "ADD-SUBCAT-FRAME-INFO", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_subcat_frame_info", "REMOVE-SUBCAT-FRAME-INFO", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_bindings_from_frame", "PSP-BINDINGS-FROM-FRAME", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_psp_bindings_from_frame_int", "CLEAR-PSP-BINDINGS-FROM-FRAME-INT", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_psp_bindings_from_frame_int", "REMOVE-PSP-BINDINGS-FROM-FRAME-INT", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_bindings_from_frame_int_internal", "PSP-BINDINGS-FROM-FRAME-INT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_bindings_from_frame_int", "PSP-BINDINGS-FROM-FRAME-INT", 1, 1, false );
    SubLFiles.declareFunction( me, "clear_psp_predicative_frameP", "CLEAR-PSP-PREDICATIVE-FRAME?", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_psp_predicative_frameP", "REMOVE-PSP-PREDICATIVE-FRAME?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_predicative_frameP_internal", "PSP-PREDICATIVE-FRAME?-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_predicative_frameP", "PSP-PREDICATIVE-FRAME?", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_psp_keywords_for_frame", "CLEAR-PSP-KEYWORDS-FOR-FRAME", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_psp_keywords_for_frame", "REMOVE-PSP-KEYWORDS-FOR-FRAME", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_keywords_for_frame_internal", "PSP-KEYWORDS-FOR-FRAME-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_keywords_for_frame", "PSP-KEYWORDS-FOR-FRAME", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_psp_constrained_frameP", "CLEAR-PSP-CONSTRAINED-FRAME?", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_psp_constrained_frameP", "REMOVE-PSP-CONSTRAINED-FRAME?", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_constrained_frameP_internal", "PSP-CONSTRAINED-FRAME?-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_constrained_frameP", "PSP-CONSTRAINED-FRAME?", 1, 1, false );
    SubLFiles.declareFunction( me, "clear_psp_devisable_verb_frames", "CLEAR-PSP-DEVISABLE-VERB-FRAMES", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_psp_devisable_verb_frames", "REMOVE-PSP-DEVISABLE-VERB-FRAMES", 0, 1, false );
    SubLFiles.declareFunction( me, "psp_devisable_verb_frames_internal", "PSP-DEVISABLE-VERB-FRAMES-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_devisable_verb_frames", "PSP-DEVISABLE-VERB-FRAMES", 0, 1, false );
    SubLFiles.declareFunction( me, "clear_transitive_np_comp_frameP", "CLEAR-TRANSITIVE-NP-COMP-FRAME?", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_transitive_np_comp_frameP", "REMOVE-TRANSITIVE-NP-COMP-FRAME?", 1, 1, false );
    SubLFiles.declareFunction( me, "transitive_np_comp_frameP_internal", "TRANSITIVE-NP-COMP-FRAME?-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "transitive_np_comp_frameP", "TRANSITIVE-NP-COMP-FRAME?", 1, 1, false );
    SubLFiles.declareFunction( me, "clear_intransitive_frameP", "CLEAR-INTRANSITIVE-FRAME?", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_intransitive_frameP", "REMOVE-INTRANSITIVE-FRAME?", 1, 1, false );
    SubLFiles.declareFunction( me, "intransitive_frameP_internal", "INTRANSITIVE-FRAME?-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "intransitive_frameP", "INTRANSITIVE-FRAME?", 1, 1, false );
    SubLFiles.declareFunction( me, "clear_psp_frame_has_typeP", "CLEAR-PSP-FRAME-HAS-TYPE?", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_psp_frame_has_typeP", "REMOVE-PSP-FRAME-HAS-TYPE?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_frame_has_typeP_internal", "PSP-FRAME-HAS-TYPE?-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_frame_has_typeP", "PSP-FRAME-HAS-TYPE?", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_psp_passivized_dtr_num", "CLEAR-PSP-PASSIVIZED-DTR-NUM", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_psp_passivized_dtr_num", "REMOVE-PSP-PASSIVIZED-DTR-NUM", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_passivized_dtr_num_internal", "PSP-PASSIVIZED-DTR-NUM-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_passivized_dtr_num", "PSP-PASSIVIZED-DTR-NUM", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_passivized_dtr_keyword", "PSP-PASSIVIZED-DTR-KEYWORD", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_passive_frameP", "PSP-PASSIVE-FRAME?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_active_frame", "PSP-ACTIVE-FRAME", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_passive_frame_type", "PSP-PASSIVE-FRAME-TYPE", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_passivize_bindings", "PSP-PASSIVIZE-BINDINGS", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_by_subject_binding", "PSP-BY-SUBJECT-BINDING", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_add_cycl_to_cycls", "PSP-ADD-CYCL-TO-CYCLS", 2, 1, false );
    SubLFiles.declareFunction( me, "psp_new_cycls", "PSP-NEW-CYCLS", 0, 2, false );
    SubLFiles.declareFunction( me, "build_psp_edges_from_lex_entries", "BUILD-PSP-EDGES-FROM-LEX-ENTRIES", 5, 0, false );
    SubLFiles.declareFunction( me, "build_psp_edges_from_lex_entry", "BUILD-PSP-EDGES-FROM-LEX-ENTRY", 3, 0, false );
    SubLFiles.declareFunction( me, "lex_entry_get_trie_entry", "LEX-ENTRY-GET-TRIE-ENTRY", 1, 0, false );
    SubLFiles.declareFunction( me, "lex_entry_preferred_denots", "LEX-ENTRY-PREFERRED-DENOTS", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_pos_preds_from_lex_entry", "PSP-POS-PREDS-FROM-LEX-ENTRY", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_term_passes_constraintsP", "PSP-TERM-PASSES-CONSTRAINTS?", 1, 1, false );
    SubLFiles.declareFunction( me, "titles_conventionally_quoted", "TITLES-CONVENTIONALLY-QUOTED", 0, 0, false );
    SubLFiles.declareFunction( me, "psp_dispreference_level", "PSP-DISPREFERENCE-LEVEL", 3, 0, false );
    SubLFiles.declareFunction( me, "psp_disprefer_weight", "PSP-DISPREFER-WEIGHT", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_reprefer_weight", "PSP-REPREFER-WEIGHT", 1, 1, false );
    SubLFiles.declareFunction( me, "psp_weight_for_lex_entry", "PSP-WEIGHT-FOR-LEX-ENTRY", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_weight_for_trie_entry", "PSP-WEIGHT-FOR-TRIE-ENTRY", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_disprefer_trie_entry_for_stringP", "PSP-DISPREFER-TRIE-ENTRY-FOR-STRING?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_term_has_preferred_lexificationsP_internal", "PSP-TERM-HAS-PREFERRED-LEXIFICATIONS?-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_term_has_preferred_lexificationsP", "PSP-TERM-HAS-PREFERRED-LEXIFICATIONS?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_filter_lexical_quads", "PSP-FILTER-LEXICAL-QUADS", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_good_lexical_quadP", "PSP-GOOD-LEXICAL-QUAD?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_ok_pos_predP", "PSP-OK-POS-PRED?", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_adjust_edge_weights", "PSP-ADJUST-EDGE-WEIGHTS", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_adjust_edge_weight", "PSP-ADJUST-EDGE-WEIGHT", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_consolidate_edges", "PSP-CONSOLIDATE-EDGES", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_add_cycl", "PSP-EDGE-ADD-CYCL", 2, 1, false );
    SubLFiles.declareFunction( me, "psp_delete_subsumed_edges", "PSP-DELETE-SUBSUMED-EDGES", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_subsumesP", "PSP-EDGE-SUBSUMES?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_subsumedP", "PSP-EDGE-SUBSUMED?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_pos_pred_subsumedP", "PSP-EDGE-POS-PRED-SUBSUMED?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_category_subsumedP", "PSP-EDGE-CATEGORY-SUBSUMED?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_frame_subsumedP", "PSP-EDGE-FRAME-SUBSUMED?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_frame_subsumedP", "PSP-FRAME-SUBSUMED?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_cycls_subsumedP", "PSP-EDGE-CYCLS-SUBSUMED?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_cycls_subsumedP", "PSP-CYCLS-SUBSUMED?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_cycls_subsumedP_int", "PSP-CYCLS-SUBSUMED?-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_find_matching_edge", "PSP-FIND-MATCHING-EDGE", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edges_matchP", "PSP-EDGES-MATCH?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_find_frames_internal", "PSP-FIND-FRAMES-INTERNAL", 3, 1, false );
    SubLFiles.declareFunction( me, "psp_find_frames", "PSP-FIND-FRAMES", 3, 1, false );
    SubLFiles.declareFunction( me, "psp_find_constant", "PSP-FIND-CONSTANT", 1, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_semx_doneP", "PSP-EDGE-SEMX-DONE?", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_lookup_semx", "PSP-EDGE-LOOKUP-SEMX", 2, 0, false );
    SubLFiles.declareFunction( me, "psp_edge_to_pph_phrase", "PSP-EDGE-TO-PPH-PHRASE", 1, 0, false );
    SubLFiles.declareFunction( me, "test_sentence_set_words_from_string_list", "TEST-SENTENCE-SET-WORDS-FROM-STRING-LIST", 2, 0, false );
    SubLFiles.declareFunction( me, "word_offsets_equal", "WORD-OFFSETS-EQUAL", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_psp_chart_file()
  {
    $psp_parse_wh_wordsP$ = SubLFiles.deflexical( "*PSP-PARSE-WH-WORDS?*", NIL );
    $dtp_phrase_structure_parser_chart$ = SubLFiles.defconstant( "*DTP-PHRASE-STRUCTURE-PARSER-CHART*", $sym0$PHRASE_STRUCTURE_PARSER_CHART );
    $psp_chart_id_counter$ = SubLFiles.deflexical( "*PSP-CHART-ID-COUNTER*", ( maybeDefault( $sym54$_PSP_CHART_ID_COUNTER_, $psp_chart_id_counter$, ZERO_INTEGER ) ) );
    $psp_chart_index_edgesP$ = SubLFiles.deflexical( "*PSP-CHART-INDEX-EDGES?*", NIL );
    $dtp_phrase_structure_parser_phrasal_edge$ = SubLFiles.defconstant( "*DTP-PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE*", $sym61$PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE );
    $dtp_phrase_structure_parser_lexical_edge$ = SubLFiles.defconstant( "*DTP-PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE*", $sym109$PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE );
    $psp_unknown_weight$ = SubLFiles.defconstant( "*PSP-UNKNOWN-WEIGHT*", $kw179$UNKNOWN );
    $psp_edge_default_weight$ = SubLFiles.defconstant( "*PSP-EDGE-DEFAULT-WEIGHT*", parsing_utilities.psp_weight_from_float( $float184$0_85 ) );
    $psp_edge_greedy_weight$ = SubLFiles.defconstant( "*PSP-EDGE-GREEDY-WEIGHT*", parsing_utilities.psp_weight_from_float( $float185$1_0 ) );
    $psp_edge_dispreferred_weight$ = SubLFiles.defconstant( "*PSP-EDGE-DISPREFERRED-WEIGHT*", parsing_utilities.psp_weight_from_float( $float186$0_75 ) );
    $psp_gap_edge_weight$ = SubLFiles.defconstant( "*PSP-GAP-EDGE-WEIGHT*", parsing_utilities.psp_weight_from_float( $float187$0_9 ) );
    $psp_np_gap_semx_caching_state$ = SubLFiles.deflexical( "*PSP-NP-GAP-SEMX-CACHING-STATE*", NIL );
    $psp_tokenization_modes$ = SubLFiles.defconstant( "*PSP-TOKENIZATION-MODES*", $list205 );
    $psp_use_term_lexiconP$ = SubLFiles.defparameter( "*PSP-USE-TERM-LEXICON?*", NIL );
    $fscp_multi_parse_categories$ = SubLFiles.deflexical( "*FSCP-MULTI-PARSE-CATEGORIES*", $list221 );
    $psp_bindings_from_frame_int_caching_state$ = SubLFiles.deflexical( "*PSP-BINDINGS-FROM-FRAME-INT-CACHING-STATE*", NIL );
    $psp_predicative_frameP_caching_state$ = SubLFiles.deflexical( "*PSP-PREDICATIVE-FRAME?-CACHING-STATE*", NIL );
    $psp_keywords_for_frame_caching_state$ = SubLFiles.deflexical( "*PSP-KEYWORDS-FOR-FRAME-CACHING-STATE*", NIL );
    $psp_constrained_frameP_caching_state$ = SubLFiles.deflexical( "*PSP-CONSTRAINED-FRAME?-CACHING-STATE*", NIL );
    $psp_devisable_verb_frames_caching_state$ = SubLFiles.deflexical( "*PSP-DEVISABLE-VERB-FRAMES-CACHING-STATE*", NIL );
    $transitive_np_comp_frameP_caching_state$ = SubLFiles.deflexical( "*TRANSITIVE-NP-COMP-FRAME?-CACHING-STATE*", NIL );
    $intransitive_frameP_caching_state$ = SubLFiles.deflexical( "*INTRANSITIVE-FRAME?-CACHING-STATE*", NIL );
    $psp_frame_has_typeP_caching_state$ = SubLFiles.deflexical( "*PSP-FRAME-HAS-TYPE?-CACHING-STATE*", NIL );
    $psp_passivized_dtr_num_caching_state$ = SubLFiles.deflexical( "*PSP-PASSIVIZED-DTR-NUM-CACHING-STATE*", NIL );
    $psp_passive_keys$ = SubLFiles.defconstant( "*PSP-PASSIVE-KEYS*", $list300 );
    $titles_conventionally_quoted$ = SubLFiles.deflexical( "*TITLES-CONVENTIONALLY-QUOTED*", NIL );
    $psp_preferred_denot_preference_factor$ = SubLFiles.deflexical( "*PSP-PREFERRED-DENOT-PREFERENCE-FACTOR*", ONE_INTEGER );
    return NIL;
  }

  public static SubLObject setup_psp_chart_file()
  {
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_phrase_structure_parser_chart$.getGlobalValue(), Symbols.symbol_function(
        $sym7$PHRASE_STRUCTURE_PARSER_CHART_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list8 );
    Structures.def_csetf( $sym9$PSP_CHART_ID, $sym10$_CSETF_PSP_CHART_ID );
    Structures.def_csetf( $sym11$PSP_CHART_INPUT_STRING, $sym12$_CSETF_PSP_CHART_INPUT_STRING );
    Structures.def_csetf( $sym13$PSP_CHART_LENGTH, $sym14$_CSETF_PSP_CHART_LENGTH );
    Structures.def_csetf( $sym15$PSP_CHART_SPANS_TO_EDGES, $sym16$_CSETF_PSP_CHART_SPANS_TO_EDGES );
    Structures.def_csetf( $sym17$PSP_CHART_GAP_TYPE, $sym18$_CSETF_PSP_CHART_GAP_TYPE );
    Structures.def_csetf( $sym19$PSP_CHART_MEMOIZATION_STATE, $sym20$_CSETF_PSP_CHART_MEMOIZATION_STATE );
    Structures.def_csetf( $sym21$PSP_CHART_EDGE_ID_INDEX, $sym22$_CSETF_PSP_CHART_EDGE_ID_INDEX );
    Structures.def_csetf( $sym23$PSP_CHART_EDGES_TO_NODES, $sym24$_CSETF_PSP_CHART_EDGES_TO_NODES );
    Structures.def_csetf( $sym25$PSP_CHART_MAX_EDGES_PER_SPAN, $sym26$_CSETF_PSP_CHART_MAX_EDGES_PER_SPAN );
    Structures.def_csetf( $sym27$PSP_CHART_MAX_EDGES, $sym28$_CSETF_PSP_CHART_MAX_EDGES );
    Structures.def_csetf( $sym29$PSP_CHART_MAXED_OUT_SPANS, $sym30$_CSETF_PSP_CHART_MAXED_OUT_SPANS );
    Structures.def_csetf( $sym31$PSP_CHART_MAXED_OUT_, $sym32$_CSETF_PSP_CHART_MAXED_OUT_ );
    Structures.def_csetf( $sym33$PSP_CHART_PARSED_LEXICAL_SPANS, $sym34$_CSETF_PSP_CHART_PARSED_LEXICAL_SPANS );
    Equality.identity( $sym0$PHRASE_STRUCTURE_PARSER_CHART );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_phrase_structure_parser_chart$.getGlobalValue(), Symbols.symbol_function(
        $sym53$VISIT_DEFSTRUCT_OBJECT_PHRASE_STRUCTURE_PARSER_CHART_METHOD ) );
    subl_macro_promotions.declare_defglobal( $sym54$_PSP_CHART_ID_COUNTER_ );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_phrase_structure_parser_phrasal_edge$.getGlobalValue(), Symbols.symbol_function(
        $sym68$PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list69 );
    Structures.def_csetf( $sym70$PSP_PHRASAL_EDGE_WEIGHT, $sym71$_CSETF_PSP_PHRASAL_EDGE_WEIGHT );
    Structures.def_csetf( $sym72$PSP_PHRASAL_EDGE_STRING, $sym73$_CSETF_PSP_PHRASAL_EDGE_STRING );
    Structures.def_csetf( $sym74$PSP_PHRASAL_EDGE_SPAN, $sym75$_CSETF_PSP_PHRASAL_EDGE_SPAN );
    Structures.def_csetf( $sym76$PSP_PHRASAL_EDGE_CATEGORY, $sym77$_CSETF_PSP_PHRASAL_EDGE_CATEGORY );
    Structures.def_csetf( $sym78$PSP_PHRASAL_EDGE_POS_PRED, $sym79$_CSETF_PSP_PHRASAL_EDGE_POS_PRED );
    Structures.def_csetf( $sym80$PSP_PHRASAL_EDGE_CYCLS, $sym81$_CSETF_PSP_PHRASAL_EDGE_CYCLS );
    Structures.def_csetf( $sym82$PSP_PHRASAL_EDGE_RULE, $sym83$_CSETF_PSP_PHRASAL_EDGE_RULE );
    Structures.def_csetf( $sym84$PSP_PHRASAL_EDGE_NEW_DTR_CONSTRAINTS, $sym85$_CSETF_PSP_PHRASAL_EDGE_NEW_DTR_CONSTRAINTS );
    Structures.def_csetf( $sym86$PSP_PHRASAL_EDGE_HEAD_DTR, $sym87$_CSETF_PSP_PHRASAL_EDGE_HEAD_DTR );
    Structures.def_csetf( $sym88$PSP_PHRASAL_EDGE_NON_HEAD_DTRS, $sym89$_CSETF_PSP_PHRASAL_EDGE_NON_HEAD_DTRS );
    Structures.def_csetf( $sym90$PSP_PHRASAL_EDGE_ID, $sym91$_CSETF_PSP_PHRASAL_EDGE_ID );
    Structures.def_csetf( $sym92$PSP_PHRASAL_EDGE_CHART, $sym93$_CSETF_PSP_PHRASAL_EDGE_CHART );
    Equality.identity( $sym61$PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_phrase_structure_parser_phrasal_edge$.getGlobalValue(), Symbols.symbol_function(
        $sym106$VISIT_DEFSTRUCT_OBJECT_PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE_METHO ) );
    Structures.register_method( Sxhash.$sxhash_method_table$.getGlobalValue(), $dtp_phrase_structure_parser_phrasal_edge$.getGlobalValue(), Symbols.symbol_function(
        $sym107$SXHASH_PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE_METHOD ) );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_phrase_structure_parser_lexical_edge$.getGlobalValue(), Symbols.symbol_function(
        $sym116$PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list117 );
    Structures.def_csetf( $sym118$PSP_LEXICAL_EDGE_WEIGHT, $sym119$_CSETF_PSP_LEXICAL_EDGE_WEIGHT );
    Structures.def_csetf( $sym120$PSP_LEXICAL_EDGE_STRING, $sym121$_CSETF_PSP_LEXICAL_EDGE_STRING );
    Structures.def_csetf( $sym122$PSP_LEXICAL_EDGE_SPAN, $sym123$_CSETF_PSP_LEXICAL_EDGE_SPAN );
    Structures.def_csetf( $sym124$PSP_LEXICAL_EDGE_CATEGORY, $sym125$_CSETF_PSP_LEXICAL_EDGE_CATEGORY );
    Structures.def_csetf( $sym126$PSP_LEXICAL_EDGE_POS_PRED, $sym127$_CSETF_PSP_LEXICAL_EDGE_POS_PRED );
    Structures.def_csetf( $sym128$PSP_LEXICAL_EDGE_CYCLS, $sym129$_CSETF_PSP_LEXICAL_EDGE_CYCLS );
    Structures.def_csetf( $sym130$PSP_LEXICAL_EDGE_WU, $sym131$_CSETF_PSP_LEXICAL_EDGE_WU );
    Structures.def_csetf( $sym132$PSP_LEXICAL_EDGE_FRAME, $sym133$_CSETF_PSP_LEXICAL_EDGE_FRAME );
    Structures.def_csetf( $sym134$PSP_LEXICAL_EDGE_ID, $sym135$_CSETF_PSP_LEXICAL_EDGE_ID );
    Structures.def_csetf( $sym136$PSP_LEXICAL_EDGE_CHART, $sym137$_CSETF_PSP_LEXICAL_EDGE_CHART );
    Equality.identity( $sym109$PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_phrase_structure_parser_lexical_edge$.getGlobalValue(), Symbols.symbol_function(
        $sym141$VISIT_DEFSTRUCT_OBJECT_PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE_METHO ) );
    Structures.register_method( Sxhash.$sxhash_method_table$.getGlobalValue(), $dtp_phrase_structure_parser_lexical_edge$.getGlobalValue(), Symbols.symbol_function(
        $sym142$SXHASH_PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE_METHOD ) );
    access_macros.register_macro_helper( $sym156$PSP_DO_EDGES_FOR_SPAN, $sym157$PSP_DO_EDGES );
    access_macros.register_macro_helper( $sym163$PSP_DO_LEXICAL_EDGES_FOR_SPAN, $sym157$PSP_DO_EDGES );
    access_macros.register_macro_helper( $sym162$PSP_DO_EDGE_OK_, $sym156$PSP_DO_EDGES_FOR_SPAN );
    memoization_state.note_globally_cached_function( $sym188$PSP_NP_GAP_SEMX );
    utilities_macros.register_kb_function( $sym258$ADD_SUBCAT_FRAME_INFO );
    utilities_macros.register_kb_function( $sym259$REMOVE_SUBCAT_FRAME_INFO );
    memoization_state.note_globally_cached_function( $sym260$PSP_BINDINGS_FROM_FRAME_INT );
    memoization_state.note_globally_cached_function( $sym266$PSP_PREDICATIVE_FRAME_ );
    memoization_state.note_globally_cached_function( $sym269$PSP_KEYWORDS_FOR_FRAME );
    memoization_state.note_globally_cached_function( $sym275$PSP_CONSTRAINED_FRAME_ );
    memoization_state.note_globally_cached_function( $sym279$PSP_DEVISABLE_VERB_FRAMES );
    ...
    memoization_state.note_globally_cached_function( $sym291$PSP_PASSIVIZED_DTR_NUM );
    memoization_state.note_memoized_function( $sym317$PSP_TERM_HAS_PREFERRED_LEXIFICATIONS_ );
    memoization_state.note_memoized_function( $sym323$PSP_FIND_FRAMES );
    generic_testing.define_test_case_table_int( $sym330$TEST_SENTENCE_SET_WORDS_FROM_STRING_LIST, ConsesLow.list( new SubLObject[] { $kw331$TEST, $sym332$WORD_OFFSETS_EQUAL, $kw333$OWNER, NIL, $kw334$CLASSES, NIL,
      $kw335$KB, $kw336$FULL, $kw337$WORKING_, T
    } ), $list338 );
    return NIL;
  }
  ...
  {
    me = new psp_chart();
    $psp_parse_wh_wordsP$ = null;
    $dtp_phrase_structure_parser_chart$ = null;
    $psp_chart_id_counter$ = null;
    $psp_chart_index_edgesP$ = null;
    $dtp_phrase_structure_parser_phrasal_edge$ = null;
    $dtp_phrase_structure_parser_lexical_edge$ = null;
    $psp_unknown_weight$ = null;
    $psp_edge_default_weight$ = null;
    $psp_edge_greedy_weight$ = null;
    $psp_edge_dispreferred_weight$ = null;
    $psp_gap_edge_weight$ = null;
    $psp_np_gap_semx_caching_state$ = null;
    $psp_tokenization_modes$ = null;
    $psp_use_term_lexiconP$ = null;
    $fscp_multi_parse_categories$ = null;
    $psp_bindings_from_frame_int_caching_state$ = null;
    $psp_predicative_frameP_caching_state$ = null;
    $psp_keywords_for_frame_caching_state$ = null;
    $psp_constrained_frameP_caching_state$ = null;
    $psp_devisable_verb_frames_caching_state$ = null;
    $transitive_np_comp_frameP_caching_state$ = null;
    $intransitive_frameP_caching_state$ = null;
    $psp_frame_has_typeP_caching_state$ = null;
    $psp_passivized_dtr_num_caching_state$ = null;
    $psp_passive_keys$ = null;
    $titles_conventionally_quoted$ = null;
    $psp_preferred_denot_preference_factor$ = null;
    $sym0$PHRASE_STRUCTURE_PARSER_CHART = makeSymbol( "PHRASE-STRUCTURE-PARSER-CHART" );
    $sym1$PHRASE_STRUCTURE_PARSER_CHART_P = makeSymbol( "PHRASE-STRUCTURE-PARSER-CHART-P" );
    $list2 = ConsesLow.list( new SubLObject[] { makeSymbol( "ID" ), makeSymbol( "INPUT-STRING" ), makeSymbol( "LENGTH" ), makeSymbol( "SPANS-TO-EDGES" ), makeSymbol( "GAP-TYPE" ), makeSymbol( "MEMOIZATION-STATE" ),
      makeSymbol( "EDGE-ID-INDEX" ), makeSymbol( "EDGES-TO-NODES" ), makeSymbol( "MAX-EDGES-PER-SPAN" ), makeSymbol( "MAX-EDGES" ), makeSymbol( "MAXED-OUT-SPANS" ), makeSymbol( "MAXED-OUT?" ), makeSymbol(
          "PARSED-LEXICAL-SPANS" )
    } );
    $list3 = ConsesLow.list( new SubLObject[] { makeKeyword( "ID" ), makeKeyword( "INPUT-STRING" ), makeKeyword( "LENGTH" ), makeKeyword( "SPANS-TO-EDGES" ), makeKeyword( "GAP-TYPE" ), makeKeyword( "MEMOIZATION-STATE" ),
      makeKeyword( "EDGE-ID-INDEX" ), makeKeyword( "EDGES-TO-NODES" ), makeKeyword( "MAX-EDGES-PER-SPAN" ), makeKeyword( "MAX-EDGES" ), makeKeyword( "MAXED-OUT-SPANS" ), makeKeyword( "MAXED-OUT?" ), makeKeyword(
          "PARSED-LEXICAL-SPANS" )
    } );
    $list4 = ConsesLow.list( new SubLObject[] { makeSymbol( "PSP-CHART-ID" ), makeSymbol( "PSP-CHART-INPUT-STRING" ), makeSymbol( "PSP-CHART-LENGTH" ), makeSymbol( "PSP-CHART-SPANS-TO-EDGES" ), makeSymbol(
        "PSP-CHART-GAP-TYPE" ), makeSymbol( "PSP-CHART-MEMOIZATION-STATE" ), makeSymbol( "PSP-CHART-EDGE-ID-INDEX" ), makeSymbol( "PSP-CHART-EDGES-TO-NODES" ), makeSymbol( "PSP-CHART-MAX-EDGES-PER-SPAN" ), makeSymbol(
            "PSP-CHART-MAX-EDGES" ), makeSymbol( "PSP-CHART-MAXED-OUT-SPANS" ), makeSymbol( "PSP-CHART-MAXED-OUT?" ), makeSymbol( "PSP-CHART-PARSED-LEXICAL-SPANS" )
    } );
    $list5 = ConsesLow.list( new SubLObject[] { makeSymbol( "_CSETF-PSP-CHART-ID" ), makeSymbol( "_CSETF-PSP-CHART-INPUT-STRING" ), makeSymbol( "_CSETF-PSP-CHART-LENGTH" ), makeSymbol(
        "_CSETF-PSP-CHART-SPANS-TO-EDGES" ), makeSymbol( "_CSETF-PSP-CHART-GAP-TYPE" ), makeSymbol( "_CSETF-PSP-CHART-MEMOIZATION-STATE" ), makeSymbol( "_CSETF-PSP-CHART-EDGE-ID-INDEX" ), makeSymbol(
            "_CSETF-PSP-CHART-EDGES-TO-NODES" ), makeSymbol( "_CSETF-PSP-CHART-MAX-EDGES-PER-SPAN" ), makeSymbol( "_CSETF-PSP-CHART-MAX-EDGES" ), makeSymbol( "_CSETF-PSP-CHART-MAXED-OUT-SPANS" ), makeSymbol(
                "_CSETF-PSP-CHART-MAXED-OUT?" ), makeSymbol( "_CSETF-PSP-CHART-PARSED-LEXICAL-SPANS" )
    } );
    $sym6$PPRINT_PSP_CHART = makeSymbol( "PPRINT-PSP-CHART" );
    $sym7$PHRASE_STRUCTURE_PARSER_CHART_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "PHRASE-STRUCTURE-PARSER-CHART-PRINT-FUNCTION-TRAMPOLINE" );
    $list8 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "PHRASE-STRUCTURE-PARSER-CHART-P" ) );
    $sym9$PSP_CHART_ID = makeSymbol( "PSP-CHART-ID" );
    $sym10$_CSETF_PSP_CHART_ID = makeSymbol( "_CSETF-PSP-CHART-ID" );
    $sym11$PSP_CHART_INPUT_STRING = makeSymbol( "PSP-CHART-INPUT-STRING" );
    $sym12$_CSETF_PSP_CHART_INPUT_STRING = makeSymbol( "_CSETF-PSP-CHART-INPUT-STRING" );
    $sym13$PSP_CHART_LENGTH = makeSymbol( "PSP-CHART-LENGTH" );
    $sym14$_CSETF_PSP_CHART_LENGTH = makeSymbol( "_CSETF-PSP-CHART-LENGTH" );
    $sym15$PSP_CHART_SPANS_TO_EDGES = makeSymbol( "PSP-CHART-SPANS-TO-EDGES" );
    $sym16$_CSETF_PSP_CHART_SPANS_TO_EDGES = makeSymbol( "_CSETF-PSP-CHART-SPANS-TO-EDGES" );
    $sym17$PSP_CHART_GAP_TYPE = makeSymbol( "PSP-CHART-GAP-TYPE" );
    $sym18$_CSETF_PSP_CHART_GAP_TYPE = makeSymbol( "_CSETF-PSP-CHART-GAP-TYPE" );
    $sym19$PSP_CHART_MEMOIZATION_STATE = makeSymbol( "PSP-CHART-MEMOIZATION-STATE" );
    $sym20$_CSETF_PSP_CHART_MEMOIZATION_STATE = makeSymbol( "_CSETF-PSP-CHART-MEMOIZATION-STATE" );
    $sym21$PSP_CHART_EDGE_ID_INDEX = makeSymbol( "PSP-CHART-EDGE-ID-INDEX" );
    $sym22$_CSETF_PSP_CHART_EDGE_ID_INDEX = makeSymbol( "_CSETF-PSP-CHART-EDGE-ID-INDEX" );
    $sym23$PSP_CHART_EDGES_TO_NODES = makeSymbol( "PSP-CHART-EDGES-TO-NODES" );
    $sym24$_CSETF_PSP_CHART_EDGES_TO_NODES = makeSymbol( "_CSETF-PSP-CHART-EDGES-TO-NODES" );
    $sym25$PSP_CHART_MAX_EDGES_PER_SPAN = makeSymbol( "PSP-CHART-MAX-EDGES-PER-SPAN" );
    $sym26$_CSETF_PSP_CHART_MAX_EDGES_PER_SPAN = makeSymbol( "_CSETF-PSP-CHART-MAX-EDGES-PER-SPAN" );
    $sym27$PSP_CHART_MAX_EDGES = makeSymbol( "PSP-CHART-MAX-EDGES" );
    $sym28$_CSETF_PSP_CHART_MAX_EDGES = makeSymbol( "_CSETF-PSP-CHART-MAX-EDGES" );
    $sym29$PSP_CHART_MAXED_OUT_SPANS = makeSymbol( "PSP-CHART-MAXED-OUT-SPANS" );
    $sym30$_CSETF_PSP_CHART_MAXED_OUT_SPANS = makeSymbol( "_CSETF-PSP-CHART-MAXED-OUT-SPANS" );
    $sym31$PSP_CHART_MAXED_OUT_ = makeSymbol( "PSP-CHART-MAXED-OUT?" );
    $sym32$_CSETF_PSP_CHART_MAXED_OUT_ = makeSymbol( "_CSETF-PSP-CHART-MAXED-OUT?" );
    $sym33$PSP_CHART_PARSED_LEXICAL_SPANS = makeSymbol( "PSP-CHART-PARSED-LEXICAL-SPANS" );
    $sym34$_CSETF_PSP_CHART_PARSED_LEXICAL_SPANS = makeSymbol( "_CSETF-PSP-CHART-PARSED-LEXICAL-SPANS" );
    $kw35$ID = makeKeyword( "ID" );
    $kw36$INPUT_STRING = makeKeyword( "INPUT-STRING" );
    $kw37$LENGTH = makeKeyword( "LENGTH" );
    $kw38$SPANS_TO_EDGES = makeKeyword( "SPANS-TO-EDGES" );
    $kw39$GAP_TYPE = makeKeyword( "GAP-TYPE" );
    $kw40$MEMOIZATION_STATE = makeKeyword( "MEMOIZATION-STATE" );
    $kw41$EDGE_ID_INDEX = makeKeyword( "EDGE-ID-INDEX" );
    $kw42$EDGES_TO_NODES = makeKeyword( "EDGES-TO-NODES" );
    $kw43$MAX_EDGES_PER_SPAN = makeKeyword( "MAX-EDGES-PER-SPAN" );
    $kw44$MAX_EDGES = makeKeyword( "MAX-EDGES" );
    $kw45$MAXED_OUT_SPANS = makeKeyword( "MAXED-OUT-SPANS" );
    $kw46$MAXED_OUT_ = makeKeyword( "MAXED-OUT?" );
    $kw47$PARSED_LEXICAL_SPANS = makeKeyword( "PARSED-LEXICAL-SPANS" );
    $str48$Invalid_slot__S_for_construction_ = makeString( "Invalid slot ~S for construction function" );
    $kw49$BEGIN = makeKeyword( "BEGIN" );
    $sym50$MAKE_PHRASE_STRUCTURE_PARSER_CHART = makeSymbol( "MAKE-PHRASE-STRUCTURE-PARSER-CHART" );
    $kw51$SLOT = makeKeyword( "SLOT" );
    $kw52$END = makeKeyword( "END" );
    $sym53$VISIT_DEFSTRUCT_OBJECT_PHRASE_STRUCTURE_PARSER_CHART_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-PHRASE-STRUCTURE-PARSER-CHART-METHOD" );
    $sym54$_PSP_CHART_ID_COUNTER_ = makeSymbol( "*PSP-CHART-ID-COUNTER*" );
    $str55$__PSP_CHART__S__S_ = makeString( "#<PSP-CHART ~S ~S>" );
    $kw56$DESTROYED = makeKeyword( "DESTROYED" );
    $kw57$CLEARED = makeKeyword( "CLEARED" );
    $kw58$SET = makeKeyword( "SET" );
    $str59$Not_indexing_PSP_edges__Can_t_fin = makeString( "Not indexing PSP edges. Can't find edges by IDs." );
    $str60$_S_is_not_a_PSP_chart__Can_t_find = makeString( "~S is not a PSP chart. Can't find edges by IDs." );
    $sym61$PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE = makeSymbol( "PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE" );
    $sym62$PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE_P = makeSymbol( "PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE-P" );
    $list63 = ConsesLow.list( new SubLObject[] { makeSymbol( "WEIGHT" ), makeSymbol( "STRING" ), makeSymbol( "SPAN" ), makeSymbol( "CATEGORY" ), makeSymbol( "POS-PRED" ), makeSymbol( "CYCLS" ), makeSymbol( "RULE" ),
      makeSymbol( "NEW-DTR-CONSTRAINTS" ), makeSymbol( "HEAD-DTR" ), makeSymbol( "NON-HEAD-DTRS" ), makeSymbol( "ID" ), makeSymbol( "CHART" )
    } );
    $list64 = ConsesLow.list( new SubLObject[] { makeKeyword( "WEIGHT" ), makeKeyword( "STRING" ), makeKeyword( "SPAN" ), makeKeyword( "CATEGORY" ), makeKeyword( "POS-PRED" ), makeKeyword( "CYCLS" ), makeKeyword(
        "RULE" ), makeKeyword( "NEW-DTR-CONSTRAINTS" ), makeKeyword( "HEAD-DTR" ), makeKeyword( "NON-HEAD-DTRS" ), makeKeyword( "ID" ), makeKeyword( "CHART" )
    } );
    $list65 = ConsesLow.list( new SubLObject[] { makeSymbol( "PSP-PHRASAL-EDGE-WEIGHT" ), makeSymbol( "PSP-PHRASAL-EDGE-STRING" ), makeSymbol( "PSP-PHRASAL-EDGE-SPAN" ), makeSymbol( "PSP-PHRASAL-EDGE-CATEGORY" ),
      makeSymbol( "PSP-PHRASAL-EDGE-POS-PRED" ), makeSymbol( "PSP-PHRASAL-EDGE-CYCLS" ), makeSymbol( "PSP-PHRASAL-EDGE-RULE" ), makeSymbol( "PSP-PHRASAL-EDGE-NEW-DTR-CONSTRAINTS" ), makeSymbol(
          "PSP-PHRASAL-EDGE-HEAD-DTR" ), makeSymbol( "PSP-PHRASAL-EDGE-NON-HEAD-DTRS" ), makeSymbol( "PSP-PHRASAL-EDGE-ID" ), makeSymbol( "PSP-PHRASAL-EDGE-CHART" )
    } );
    $list66 = ConsesLow.list( new SubLObject[] { makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-WEIGHT" ), makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-STRING" ), makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-SPAN" ), makeSymbol(
        "_CSETF-PSP-PHRASAL-EDGE-CATEGORY" ), makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-POS-PRED" ), makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-CYCLS" ), makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-RULE" ), makeSymbol(
            "_CSETF-PSP-PHRASAL-EDGE-NEW-DTR-CONSTRAINTS" ), makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-HEAD-DTR" ), makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-NON-HEAD-DTRS" ), makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-ID" ),
      makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-CHART" )
    } );
    $sym67$PPRINT_PSP_PHRASAL_EDGE = makeSymbol( "PPRINT-PSP-PHRASAL-EDGE" );
    $sym68$PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE-PRINT-FUNCTION-TRAMPOLINE" );
    $list69 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE-P" ) );
    $sym70$PSP_PHRASAL_EDGE_WEIGHT = makeSymbol( "PSP-PHRASAL-EDGE-WEIGHT" );
    $sym71$_CSETF_PSP_PHRASAL_EDGE_WEIGHT = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-WEIGHT" );
    $sym72$PSP_PHRASAL_EDGE_STRING = makeSymbol( "PSP-PHRASAL-EDGE-STRING" );
    $sym73$_CSETF_PSP_PHRASAL_EDGE_STRING = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-STRING" );
    $sym74$PSP_PHRASAL_EDGE_SPAN = makeSymbol( "PSP-PHRASAL-EDGE-SPAN" );
    $sym75$_CSETF_PSP_PHRASAL_EDGE_SPAN = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-SPAN" );
    $sym76$PSP_PHRASAL_EDGE_CATEGORY = makeSymbol( "PSP-PHRASAL-EDGE-CATEGORY" );
    $sym77$_CSETF_PSP_PHRASAL_EDGE_CATEGORY = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-CATEGORY" );
    $sym78$PSP_PHRASAL_EDGE_POS_PRED = makeSymbol( "PSP-PHRASAL-EDGE-POS-PRED" );
    $sym79$_CSETF_PSP_PHRASAL_EDGE_POS_PRED = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-POS-PRED" );
    $sym80$PSP_PHRASAL_EDGE_CYCLS = makeSymbol( "PSP-PHRASAL-EDGE-CYCLS" );
    $sym81$_CSETF_PSP_PHRASAL_EDGE_CYCLS = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-CYCLS" );
    $sym82$PSP_PHRASAL_EDGE_RULE = makeSymbol( "PSP-PHRASAL-EDGE-RULE" );
    $sym83$_CSETF_PSP_PHRASAL_EDGE_RULE = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-RULE" );
    $sym84$PSP_PHRASAL_EDGE_NEW_DTR_CONSTRAINTS = makeSymbol( "PSP-PHRASAL-EDGE-NEW-DTR-CONSTRAINTS" );
    $sym85$_CSETF_PSP_PHRASAL_EDGE_NEW_DTR_CONSTRAINTS = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-NEW-DTR-CONSTRAINTS" );
    $sym86$PSP_PHRASAL_EDGE_HEAD_DTR = makeSymbol( "PSP-PHRASAL-EDGE-HEAD-DTR" );
    $sym87$_CSETF_PSP_PHRASAL_EDGE_HEAD_DTR = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-HEAD-DTR" );
    $sym88$PSP_PHRASAL_EDGE_NON_HEAD_DTRS = makeSymbol( "PSP-PHRASAL-EDGE-NON-HEAD-DTRS" );
    $sym89$_CSETF_PSP_PHRASAL_EDGE_NON_HEAD_DTRS = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-NON-HEAD-DTRS" );
    $sym90$PSP_PHRASAL_EDGE_ID = makeSymbol( "PSP-PHRASAL-EDGE-ID" );
    $sym91$_CSETF_PSP_PHRASAL_EDGE_ID = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-ID" );
    $sym92$PSP_PHRASAL_EDGE_CHART = makeSymbol( "PSP-PHRASAL-EDGE-CHART" );
    $sym93$_CSETF_PSP_PHRASAL_EDGE_CHART = makeSymbol( "_CSETF-PSP-PHRASAL-EDGE-CHART" );
    $kw94$WEIGHT = makeKeyword( "WEIGHT" );
    $kw95$STRING = makeKeyword( "STRING" );
    $kw96$SPAN = makeKeyword( "SPAN" );
    $kw97$CATEGORY = makeKeyword( "CATEGORY" );
    $kw98$POS_PRED = makeKeyword( "POS-PRED" );
    $kw99$CYCLS = makeKeyword( "CYCLS" );
    $kw100$RULE = makeKeyword( "RULE" );
    $kw101$NEW_DTR_CONSTRAINTS = makeKeyword( "NEW-DTR-CONSTRAINTS" );
    $kw102$HEAD_DTR = makeKeyword( "HEAD-DTR" );
    $kw103$NON_HEAD_DTRS = makeKeyword( "NON-HEAD-DTRS" );
    $kw104$CHART = makeKeyword( "CHART" );
    $sym105$MAKE_PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE = makeSymbol( "MAKE-PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE" );
    $sym106$VISIT_DEFSTRUCT_OBJECT_PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE_METHO = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE-METHOD" );
    $sym107$SXHASH_PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE_METHOD = makeSymbol( "SXHASH-PHRASE-STRUCTURE-PARSER-PHRASAL-EDGE-METHOD" );
    $str108$__PSP_PHRASAL_EDGE__S__S__S_ = makeString( "#<PSP-PHRASAL-EDGE ~S ~S ~S>" );
    $sym109$PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE = makeSymbol( "PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE" );
    $sym110$PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE_P = makeSymbol( "PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE-P" );
    $list111 = ConsesLow.list( new SubLObject[] { makeSymbol( "WEIGHT" ), makeSymbol( "STRING" ), makeSymbol( "SPAN" ), makeSymbol( "CATEGORY" ), makeSymbol( "POS-PRED" ), makeSymbol( "CYCLS" ), makeSymbol( "WU" ),
      makeSymbol( "FRAME" ), makeSymbol( "ID" ), makeSymbol( "CHART" )
    } );
    $list112 = ConsesLow.list( new SubLObject[] { makeKeyword( "WEIGHT" ), makeKeyword( "STRING" ), makeKeyword( "SPAN" ), makeKeyword( "CATEGORY" ), makeKeyword( "POS-PRED" ), makeKeyword( "CYCLS" ), makeKeyword(
        "WU" ), makeKeyword( "FRAME" ), makeKeyword( "ID" ), makeKeyword( "CHART" )
    } );
    $list113 = ConsesLow.list( new SubLObject[] { makeSymbol( "PSP-LEXICAL-EDGE-WEIGHT" ), makeSymbol( "PSP-LEXICAL-EDGE-STRING" ), makeSymbol( "PSP-LEXICAL-EDGE-SPAN" ), makeSymbol( "PSP-LEXICAL-EDGE-CATEGORY" ),
      makeSymbol( "PSP-LEXICAL-EDGE-POS-PRED" ), makeSymbol( "PSP-LEXICAL-EDGE-CYCLS" ), makeSymbol( "PSP-LEXICAL-EDGE-WU" ), makeSymbol( "PSP-LEXICAL-EDGE-FRAME" ), makeSymbol( "PSP-LEXICAL-EDGE-ID" ), makeSymbol(
          "PSP-LEXICAL-EDGE-CHART" )
    } );
    $list114 = ConsesLow.list( new SubLObject[] { makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-WEIGHT" ), makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-STRING" ), makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-SPAN" ), makeSymbol(
        "_CSETF-PSP-LEXICAL-EDGE-CATEGORY" ), makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-POS-PRED" ), makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-CYCLS" ), makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-WU" ), makeSymbol(
            "_CSETF-PSP-LEXICAL-EDGE-FRAME" ), makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-ID" ), makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-CHART" )
    } );
    $sym115$PPRINT_PSP_LEXICAL_EDGE = makeSymbol( "PPRINT-PSP-LEXICAL-EDGE" );
    $sym116$PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE-PRINT-FUNCTION-TRAMPOLINE" );
    $list117 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE-P" ) );
    $sym118$PSP_LEXICAL_EDGE_WEIGHT = makeSymbol( "PSP-LEXICAL-EDGE-WEIGHT" );
    $sym119$_CSETF_PSP_LEXICAL_EDGE_WEIGHT = makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-WEIGHT" );
    $sym120$PSP_LEXICAL_EDGE_STRING = makeSymbol( "PSP-LEXICAL-EDGE-STRING" );
    $sym121$_CSETF_PSP_LEXICAL_EDGE_STRING = makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-STRING" );
    $sym122$PSP_LEXICAL_EDGE_SPAN = makeSymbol( "PSP-LEXICAL-EDGE-SPAN" );
    $sym123$_CSETF_PSP_LEXICAL_EDGE_SPAN = makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-SPAN" );
    $sym124$PSP_LEXICAL_EDGE_CATEGORY = makeSymbol( "PSP-LEXICAL-EDGE-CATEGORY" );
    $sym125$_CSETF_PSP_LEXICAL_EDGE_CATEGORY = makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-CATEGORY" );
    $sym126$PSP_LEXICAL_EDGE_POS_PRED = makeSymbol( "PSP-LEXICAL-EDGE-POS-PRED" );
    $sym127$_CSETF_PSP_LEXICAL_EDGE_POS_PRED = makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-POS-PRED" );
    $sym128$PSP_LEXICAL_EDGE_CYCLS = makeSymbol( "PSP-LEXICAL-EDGE-CYCLS" );
    $sym129$_CSETF_PSP_LEXICAL_EDGE_CYCLS = makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-CYCLS" );
    $sym130$PSP_LEXICAL_EDGE_WU = makeSymbol( "PSP-LEXICAL-EDGE-WU" );
    $sym131$_CSETF_PSP_LEXICAL_EDGE_WU = makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-WU" );
    $sym132$PSP_LEXICAL_EDGE_FRAME = makeSymbol( "PSP-LEXICAL-EDGE-FRAME" );
    $sym133$_CSETF_PSP_LEXICAL_EDGE_FRAME = makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-FRAME" );
    $sym134$PSP_LEXICAL_EDGE_ID = makeSymbol( "PSP-LEXICAL-EDGE-ID" );
    $sym135$_CSETF_PSP_LEXICAL_EDGE_ID = makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-ID" );
    $sym136$PSP_LEXICAL_EDGE_CHART = makeSymbol( "PSP-LEXICAL-EDGE-CHART" );
    $sym137$_CSETF_PSP_LEXICAL_EDGE_CHART = makeSymbol( "_CSETF-PSP-LEXICAL-EDGE-CHART" );
    $kw138$WU = makeKeyword( "WU" );
    $kw139$FRAME = makeKeyword( "FRAME" );
    $sym140$MAKE_PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE = makeSymbol( "MAKE-PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE" );
    $sym141$VISIT_DEFSTRUCT_OBJECT_PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE_METHO = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE-METHOD" );
    $sym142$SXHASH_PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE_METHOD = makeSymbol( "SXHASH-PHRASE-STRUCTURE-PARSER-LEXICAL-EDGE-METHOD" );
    $str143$__PSP_LEXICAL_EDGE__S__S__S__S_W_ = makeString( "#<PSP-LEXICAL-EDGE ~S ~S ~S ~S W=~S>" );
    $str144$___S___S______S__ = makeString( "~&~S (~S):~% ~S~%" );
    $str145$_S_is_not_a_PSP_edge_ = makeString( "~S is not a PSP edge." );
    $str146$Headless_edge___S = makeString( "Headless edge: ~S" );
    $list147 = ConsesLow.list( ConsesLow.list( makeSymbol( "SPAN-VAR" ), makeSymbol( "&OPTIONAL" ), makeSymbol( "DONE" ), makeSymbol( "CHART" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym148$CHART_TO_USE = makeUninternedSymbol( "CHART-TO-USE" );
    $sym149$CLET = makeSymbol( "CLET" );
    $sym150$FIRST_OF = makeSymbol( "FIRST-OF" );
    $list151 = ConsesLow.list( makeSymbol( "*PSP-CHART*" ) );
    $sym152$CHECK_TYPE = makeSymbol( "CHECK-TYPE" );
    $list153 = ConsesLow.list( makeSymbol( "PHRASE-STRUCTURE-PARSER-CHART-P" ) );
    $sym154$DO_DICTIONARY_KEYS = makeSymbol( "DO-DICTIONARY-KEYS" );
    $kw155$DONE = makeKeyword( "DONE" );
    $sym156$PSP_DO_EDGES_FOR_SPAN = makeSymbol( "PSP-DO-EDGES-FOR-SPAN" );
    $sym157$PSP_DO_EDGES = makeSymbol( "PSP-DO-EDGES" );
    $list158 = ConsesLow.list( ConsesLow.list( makeSymbol( "EDGE-VAR" ), makeSymbol( "CHART" ), makeSymbol( "CATEGORY" ), makeSymbol( "SPAN" ), makeSymbol( "COMPLETE-ONLY?" ), makeSymbol( "DONE" ) ), makeSymbol(
        "&BODY" ), makeSymbol( "BODY" ) );
    $sym159$CSOME = makeSymbol( "CSOME" );
    $sym160$PSP_EDGES_WITH_SPAN = makeSymbol( "PSP-EDGES-WITH-SPAN" );
    $sym161$PWHEN = makeSymbol( "PWHEN" );
    $sym162$PSP_DO_EDGE_OK_ = makeSymbol( "PSP-DO-EDGE-OK?" );
    $sym163$PSP_DO_LEXICAL_EDGES_FOR_SPAN = makeSymbol( "PSP-DO-LEXICAL-EDGES-FOR-SPAN" );
    $sym164$PSP_LEXICAL_EDGES_WITH_SPAN = makeSymbol( "PSP-LEXICAL-EDGES-WITH-SPAN" );
    $kw165$ANY = makeKeyword( "ANY" );
    $list166 = ConsesLow.list( ConsesLow.list( makeSymbol( "EDGE-VAR" ), ConsesLow.list( makeSymbol( "&KEY" ), ConsesLow.list( makeSymbol( "CHART" ), NIL ), ConsesLow.list( makeSymbol( "CATEGORY" ), makeKeyword(
        "ANY" ) ), ConsesLow.list( makeSymbol( "SPAN" ), makeKeyword( "ANY" ) ), ConsesLow.list( makeSymbol( "COMPLETE-ONLY?" ), T ), ConsesLow.list( makeSymbol( "TYPE" ), makeKeyword( "ANY" ) ), ConsesLow.list(
            makeSymbol( "DONE" ), NIL ) ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $list167 = ConsesLow.list( makeKeyword( "CHART" ), makeKeyword( "CATEGORY" ), makeKeyword( "SPAN" ), makeKeyword( "COMPLETE-ONLY?" ), makeKeyword( "TYPE" ), makeKeyword( "DONE" ) );
    $kw168$ALLOW_OTHER_KEYS = makeKeyword( "ALLOW-OTHER-KEYS" );
    $kw169$COMPLETE_ONLY_ = makeKeyword( "COMPLETE-ONLY?" );
    $kw170$TYPE = makeKeyword( "TYPE" );
    $sym171$SPAN_TO_DO = makeUninternedSymbol( "SPAN-TO-DO" );
    $sym172$CHART_TO_USE = makeUninternedSymbol( "CHART-TO-USE" );
    $sym173$PCOND = makeSymbol( "PCOND" );
    $list174 = ConsesLow.list( makeKeyword( "ANY" ) );
    $sym175$PCASE = makeSymbol( "PCASE" );
    $sym176$PSP_DO_SPANS = makeSymbol( "PSP-DO-SPANS" );
    $kw177$LEXICAL = makeKeyword( "LEXICAL" );
    $sym178$INTERVAL_SPAN_P = makeSymbol( "INTERVAL-SPAN-P" );
    $kw179$UNKNOWN = makeKeyword( "UNKNOWN" );
    $kw180$INTEGER = makeKeyword( "INTEGER" );
    $kw181$FLOAT = makeKeyword( "FLOAT" );
    $float182$0_0 = makeDouble( 0.0 );
    $sym183$PSP_WEIGHT_P = makeSymbol( "PSP-WEIGHT-P" );
    $float184$0_85 = makeDouble( 0.85 );
    $float185$1_0 = makeDouble( 1.0 );
    $float186$0_75 = makeDouble( 0.75 );
    $float187$0_9 = makeDouble( 0.9 );
    $sym188$PSP_NP_GAP_SEMX = makeSymbol( "PSP-NP-GAP-SEMX" );
    $sym189$_PSP_NP_GAP_SEMX_CACHING_STATE_ = makeSymbol( "*PSP-NP-GAP-SEMX-CACHING-STATE*" );
    $const190$TheGappedTerm = constant_handles.reader_make_constant_shell( makeString( "TheGappedTerm" ) );
    $sym191$NEW_PSP_PHRASAL_EDGE = makeSymbol( "NEW-PSP-PHRASAL-EDGE" );
    $sym192$NEW_PSP_LEXICAL_EDGE = makeSymbol( "NEW-PSP-LEXICAL-EDGE" );
    $str193$ = makeString( "" );
    $kw194$NEW = makeKeyword( "NEW" );
    $const195$Preposition = constant_handles.reader_make_constant_shell( makeString( "Preposition" ) );
    $list196 = ConsesLow.list( makeKeyword( "NP" ), makeKeyword( "NONE" ) );
    $kw197$NP = makeKeyword( "NP" );
    $const198$NounPhrase = constant_handles.reader_make_constant_shell( makeString( "NounPhrase" ) );
    $kw199$NONE = makeKeyword( "NONE" );
    $kw200$PP = makeKeyword( "PP" );
    $sym201$STRINGP = makeSymbol( "STRINGP" );
    $sym202$DICTIONARY_P = makeSymbol( "DICTIONARY-P" );
    $sym203$LIST = makeSymbol( "LIST" );
    $sym204$PREDICATE_P = makeSymbol( "PREDICATE-P" );
    $list205 = ConsesLow.list( makeKeyword( "GREEDY" ), makeKeyword( "DILIGENT" ) );
    $kw206$OFFSET = makeKeyword( "OFFSET" );
    $sym207$VECTOR = makeSymbol( "VECTOR" );
    $kw208$CONSTITUENTS = makeKeyword( "CONSTITUENTS" );
    $sym209$PSP_LEXICON_P = makeSymbol( "PSP-LEXICON-P" );
    $str210$_ = makeString( "'" );
    $str211$___ = makeString( " ' " );
    $kw212$INITIALIZED = makeKeyword( "INITIALIZED" );
    $sym213$SENTENCE_P = makeSymbol( "SENTENCE-P" );
    $kw214$DILIGENT = makeKeyword( "DILIGENT" );
    $kw215$ADDED = makeKeyword( "ADDED" );
    $const216$ClosedClassWord = constant_handles.reader_make_constant_shell( makeString( "ClosedClassWord" ) );
    $sym217$PSP_TOKENIZATION_MODE_P = makeSymbol( "PSP-TOKENIZATION-MODE-P" );
    $kw218$GREEDY = makeKeyword( "GREEDY" );
    $str219$Failed_to_get_bigger_than__S__Lon = makeString( "Failed to get bigger than ~S. Longest edge:~% ~S (span: ~S)~%" );
    $sym220$LEXIFY_SENTENCE = makeSymbol( "LEXIFY-SENTENCE" );
    $list221 = ConsesLow.list( makeKeyword( "QUANTITY" ), makeKeyword( "UNIT-OF-MEASURE" ) );
    $str222$a = makeString( "a" );
    $sym223$WORD_P = makeSymbol( "WORD-P" );
    $const224$Number_SP = constant_handles.reader_make_constant_shell( makeString( "Number-SP" ) );
    $const225$partOfSpeech = constant_handles.reader_make_constant_shell( makeString( "partOfSpeech" ) );
    $sym226$PSP_SCALAR_INTERVAL_ = makeSymbol( "PSP-SCALAR-INTERVAL?" );
    $sym227$IBQE_ = makeSymbol( "IBQE?" );
    $const228$simpleNounStrings = constant_handles.reader_make_constant_shell( makeString( "simpleNounStrings" ) );
    $sym229$WORD_STRING = makeSymbol( "WORD-STRING" );
    $sym230$_ = makeSymbol( "=" );
    $sym231$INTERVAL_SPAN_START = makeSymbol( "INTERVAL-SPAN-START" );
    $list232 = ConsesLow.cons( makeSymbol( "INDEXICAL-STRING" ), makeSymbol( "DENOT" ) );
    $const233$nameString = constant_handles.reader_make_constant_shell( makeString( "nameString" ) );
    $const234$InstanceNamedFn = constant_handles.reader_make_constant_shell( makeString( "InstanceNamedFn" ) );
    $const235$Thing = constant_handles.reader_make_constant_shell( makeString( "Thing" ) );
    $const236$ScalarInterval = constant_handles.reader_make_constant_shell( makeString( "ScalarInterval" ) );
    $const237$passiveParticiple = constant_handles.reader_make_constant_shell( makeString( "passiveParticiple" ) );
    $const238$perfect = constant_handles.reader_make_constant_shell( makeString( "perfect" ) );
    $kw239$PASSIVE = makeKeyword( "PASSIVE" );
    $kw240$PASSIVE_WITH_BY = makeKeyword( "PASSIVE-WITH-BY" );
    $const241$TransitiveNPFrame = constant_handles.reader_make_constant_shell( makeString( "TransitiveNPFrame" ) );
    $const242$Verb = constant_handles.reader_make_constant_shell( makeString( "Verb" ) );
    $list243 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "PPCompFrameFn" ) ), constant_handles.reader_make_constant_shell( makeString( "TransitivePPFrameType" ) ), constant_handles
        .reader_make_constant_shell( makeString( "Of-TheWord" ) ) );
    $const244$MassNoun = constant_handles.reader_make_constant_shell( makeString( "MassNoun" ) );
    $const245$GerundiveNoun = constant_handles.reader_make_constant_shell( makeString( "GerundiveNoun" ) );
    $const246$PassivizableFrame = constant_handles.reader_make_constant_shell( makeString( "PassivizableFrame" ) );
    $str247$the_ = makeString( "the " );
    $kw248$DENOT = makeKeyword( "DENOT" );
    $str249$__Adding_new_edge_____S__Looking_ = makeString( "~&Adding new edge:~% ~S~%Looking for dtrs:~% ~S~%" );
    $kw250$NOT_FOUND = makeKeyword( "NOT-FOUND" );
    $sym251$PSP_LEXICAL_EDGE_ = makeSymbol( "PSP-LEXICAL-EDGE?" );
    $list252 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "PhraseFn" ) ), constant_handles.reader_make_constant_shell( makeString( "Determiner" ) ) );
    $sym253$PSP_INCOMPLETE_EDGE_ = makeSymbol( "PSP-INCOMPLETE-EDGE?" );
    $sym254$PSP_NP_EDGE_ = makeSymbol( "PSP-NP-EDGE?" );
    $const255$SubcategorizationFrame = constant_handles.reader_make_constant_shell( makeString( "SubcategorizationFrame" ) );
    $str256$Initializing_Subcategorization_Fr = makeString( "Initializing Subcategorization Frames..." );
    $kw257$CACHED = makeKeyword( "CACHED" );
    $sym258$ADD_SUBCAT_FRAME_INFO = makeSymbol( "ADD-SUBCAT-FRAME-INFO" );
    $sym259$REMOVE_SUBCAT_FRAME_INFO = makeSymbol( "REMOVE-SUBCAT-FRAME-INFO" );
    $sym260$PSP_BINDINGS_FROM_FRAME_INT = makeSymbol( "PSP-BINDINGS-FROM-FRAME-INT" );
    $kw261$INSTANCE = makeKeyword( "INSTANCE" );
    $list262 = ConsesLow.list( makeSymbol( "?NUM" ), makeSymbol( "?KEY" ) );
    $const263$subcatFrameDependentKeyword = constant_handles.reader_make_constant_shell( makeString( "subcatFrameDependentKeyword" ) );
    $sym264$_PSP_BINDINGS_FROM_FRAME_INT_CACHING_STATE_ = makeSymbol( "*PSP-BINDINGS-FROM-FRAME-INT-CACHING-STATE*" );
    $int265$128 = makeInteger( 128 );
    $sym266$PSP_PREDICATIVE_FRAME_ = makeSymbol( "PSP-PREDICATIVE-FRAME?" );
    $const267$PredicativeFrame = constant_handles.reader_make_constant_shell( makeString( "PredicativeFrame" ) );
    $sym268$_PSP_PREDICATIVE_FRAME__CACHING_STATE_ = makeSymbol( "*PSP-PREDICATIVE-FRAME?-CACHING-STATE*" );
    $sym269$PSP_KEYWORDS_FOR_FRAME = makeSymbol( "PSP-KEYWORDS-FOR-FRAME" );
    $sym270$_KEYWORD = makeSymbol( "?KEYWORD" );
    $const271$subcatFrameKeywords = constant_handles.reader_make_constant_shell( makeString( "subcatFrameKeywords" ) );
    $list272 = ConsesLow.list( makeSymbol( "?KEYWORD" ) );
    $const273$InferencePSC = constant_handles.reader_make_constant_shell( makeString( "InferencePSC" ) );
    $sym274$_PSP_KEYWORDS_FOR_FRAME_CACHING_STATE_ = makeSymbol( "*PSP-KEYWORDS-FOR-FRAME-CACHING-STATE*" );
    $sym275$PSP_CONSTRAINED_FRAME_ = makeSymbol( "PSP-CONSTRAINED-FRAME?" );
    $const276$subcatFrameDependentConstraint = constant_handles.reader_make_constant_shell( makeString( "subcatFrameDependentConstraint" ) );
    $kw277$TRUE = makeKeyword( "TRUE" );
    $sym278$_PSP_CONSTRAINED_FRAME__CACHING_STATE_ = makeSymbol( "*PSP-CONSTRAINED-FRAME?-CACHING-STATE*" );
    $sym279$PSP_DEVISABLE_VERB_FRAMES = makeSymbol( "PSP-DEVISABLE-VERB-FRAMES" );
    $sym280$DEVISABLE_VERB_FRAME_ = makeSymbol( "DEVISABLE-VERB-FRAME?" );
    $sym281$_PSP_DEVISABLE_VERB_FRAMES_CACHING_STATE_ = makeSymbol( "*PSP-DEVISABLE-VERB-FRAMES-CACHING-STATE*" );
    $sym282$TRANSITIVE_NP_COMP_FRAME_ = makeSymbol( "TRANSITIVE-NP-COMP-FRAME?" );
    $const283$TransitiveNPFrameType = constant_handles.reader_make_constant_shell( makeString( "TransitiveNPFrameType" ) );
    $sym284$_TRANSITIVE_NP_COMP_FRAME__CACHING_STATE_ = makeSymbol( "*TRANSITIVE-NP-COMP-FRAME?-CACHING-STATE*" );
    $sym285$INTRANSITIVE_FRAME_ = makeSymbol( "INTRANSITIVE-FRAME?" );
    $const286$subcatFrameArity = constant_handles.reader_make_constant_shell( makeString( "subcatFrameArity" ) );
    $list287 = ConsesLow.list( ZERO_INTEGER );
    $sym288$_INTRANSITIVE_FRAME__CACHING_STATE_ = makeSymbol( "*INTRANSITIVE-FRAME?-CACHING-STATE*" );
    $sym289$PSP_FRAME_HAS_TYPE_ = makeSymbol( "PSP-FRAME-HAS-TYPE?" );
    $sym290$_PSP_FRAME_HAS_TYPE__CACHING_STATE_ = makeSymbol( "*PSP-FRAME-HAS-TYPE?-CACHING-STATE*" );
    $sym291$PSP_PASSIVIZED_DTR_NUM = makeSymbol( "PSP-PASSIVIZED-DTR-NUM" );
    $sym292$_N = makeSymbol( "?N" );
    $const293$and = constant_handles.reader_make_constant_shell( makeString( "and" ) );
    $const294$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $list295 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "FrameForVerbs" ) ) );
    $list296 = ConsesLow.list( makeSymbol( "?N" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "PhraseFn" ) ), constant_handles.reader_make_constant_shell( makeString( "Noun" ) ) ) );
    $sym297$INTEGERP = makeSymbol( "INTEGERP" );
    $sym298$_PSP_PASSIVIZED_DTR_NUM_CACHING_STATE_ = makeSymbol( "*PSP-PASSIVIZED-DTR-NUM-CACHING-STATE*" );
    $sym299$SECOND = makeSymbol( "SECOND" );
    $list300 = ConsesLow.list( makeKeyword( "PASSIVE" ), makeKeyword( "PASSIVE-WITH-BY" ) );
    $str301$Don_t_know_how_to_passivize__S___ = makeString( "Don't know how to passivize ~S.~%" );
    $list302 = ConsesLow.list( makeSymbol( "TYPE" ), makeSymbol( "N" ), makeSymbol( "KEYWORD" ) );
    $list303 = ConsesLow.list( makeKeyword( "BY-SUBJECT" ) );
    $kw304$DENOT_GROUND = makeKeyword( "DENOT-GROUND" );
    $sym305$PSP_CYCL__ = makeSymbol( "PSP-CYCL-=" );
    $const306$WHWord = constant_handles.reader_make_constant_shell( makeString( "WHWord" ) );
    $sym307$GET = makeSymbol( "GET" );
    $kw308$CYC_CATEGORY = makeKeyword( "CYC-CATEGORY" );
    $kw309$WORD_UNIT = makeKeyword( "WORD-UNIT" );
    $kw310$NO_DENOT = makeKeyword( "NO-DENOT" );
    $const311$RegularNounFrame = constant_handles.reader_make_constant_shell( makeString( "RegularNounFrame" ) );
    $kw312$TRIE_ENTRY = makeKeyword( "TRIE-ENTRY" );
    $kw313$PREDICATE = makeKeyword( "PREDICATE" );
    $kw314$INFLECTIONS = makeKeyword( "INFLECTIONS" );
    $str315$titlesConventionallyQuoted = makeString( "titlesConventionallyQuoted" );
    $const316$titleOfWork = constant_handles.reader_make_constant_shell( makeString( "titleOfWork" ) );
    $sym317$PSP_TERM_HAS_PREFERRED_LEXIFICATIONS_ = makeSymbol( "PSP-TERM-HAS-PREFERRED-LEXIFICATIONS?" );
    $list318 = ConsesLow.list( makeSymbol( "CYCL" ), makeSymbol( "POS" ), makeSymbol( "POS-PRED" ), makeSymbol( "WU" ) );
    $const319$FictionalCharacter = constant_handles.reader_make_constant_shell( makeString( "FictionalCharacter" ) );
    $const320$ConceptualWork = constant_handles.reader_make_constant_shell( makeString( "ConceptualWork" ) );
    $sym321$PSP_EDGE_SUBSUMES_ = makeSymbol( "PSP-EDGE-SUBSUMES?" );
    $str322$__Removing_edge_____S__is_subsume = makeString( "~&Removing edge:~% ~S~%is subsumed by~% ~S~%~%" );
    $sym323$PSP_FIND_FRAMES = makeSymbol( "PSP-FIND-FRAMES" );
    $const324$Noun = constant_handles.reader_make_constant_shell( makeString( "Noun" ) );
    $const325$Adjective = constant_handles.reader_make_constant_shell( makeString( "Adjective" ) );
    $const326$RegularAdjFrame = constant_handles.reader_make_constant_shell( makeString( "RegularAdjFrame" ) );
    $list327 = ConsesLow.list( NIL );
    $kw328$DENOT_TEMPLATE = makeKeyword( "DENOT-TEMPLATE" );
    $sym329$PSP_EDGE_TO_PPH_PHRASE = makeSymbol( "PSP-EDGE-TO-PPH-PHRASE" );
    $sym330$TEST_SENTENCE_SET_WORDS_FROM_STRING_LIST = makeSymbol( "TEST-SENTENCE-SET-WORDS-FROM-STRING-LIST" );
    $kw331$TEST = makeKeyword( "TEST" );
    $sym332$WORD_OFFSETS_EQUAL = makeSymbol( "WORD-OFFSETS-EQUAL" );
    $kw333$OWNER = makeKeyword( "OWNER" );
    $kw334$CLASSES = makeKeyword( "CLASSES" );
    $kw335$KB = makeKeyword( "KB" );
    $kw336$FULL = makeKeyword( "FULL" );
    $kw337$WORKING_ = makeKeyword( "WORKING?" );
    $list338 = ConsesLow.list( ConsesLow.list( ConsesLow.list( ConsesLow.list( makeString( "6" ), makeString( "degrees" ), makeString( "per" ), makeString( "second" ), makeString( "per" ), makeString( "second" ) ),
        makeString( "6 degrees per second per  second" ) ), ConsesLow.list( ZERO_INTEGER, TWO_INTEGER, TEN_INTEGER, FOURTEEN_INTEGER, makeInteger( 21 ), makeInteger( 26 ) ) ), ConsesLow.list( ConsesLow.list( ConsesLow
            .list( makeString( "6" ), makeString( "degrees" ), makeString( "per" ), makeString( "second" ), makeString( "per" ), makeString( "second" ) ), makeString( "6 degrees per second per second" ) ), ConsesLow
                .list( ZERO_INTEGER, TWO_INTEGER, TEN_INTEGER, FOURTEEN_INTEGER, makeInteger( 21 ), makeInteger( 25 ) ) ) );
  }

  public static final class $phrase_structure_parser_chart_native
      extends
        SubLStructNative
  {
    ...
    public $phrase_structure_parser_chart_native()
    {
      ...
      this.$spans_to_edges = CommonSymbols.NIL;
      this.$gap_type = CommonSymbols.NIL;
      this.$memoization_state = CommonSymbols.NIL;
      this.$edge_id_index = CommonSymbols.NIL;
      this.$edges_to_nodes = CommonSymbols.NIL;
      this.$max_edges_per_span = CommonSymbols.NIL;
      this.$max_edges = CommonSymbols.NIL;
      this.$maxed_out_spans = CommonSymbols.NIL;
      this.$maxed_outP = CommonSymbols.NIL;
      this.$parsed_lexical_spans = CommonSymbols.NIL;
    }

    @Override
    public SubLStructDecl getStructDecl()
    {
      return $phrase_structure_parser_chart_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $phrase_structure_parser_chart_native.class, $sym0$PHRASE_STRUCTURE_PARSER_CHART, $sym1$PHRASE_STRUCTURE_PARSER_CHART_P, $list2, $list3, new String[] { "$id",
        "$input_string", "$length", "$spans_to_edges", "$gap_type", "$memoization_state", "$edge_id_index", "$edges_to_nodes", "$max_edges_per_span", "$max_edges", "$maxed_out_spans", "$maxed_outP",
        "$parsed_lexical_spans"
      }, $list4, $list5, $sym6$PPRINT_PSP_CHART );
    }
  }

  public static final class $phrase_structure_parser_chart_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $phrase_structure_parser_phrasal_edge_native
      extends
        SubLStructNative
  {
    ...
    public $phrase_structure_parser_phrasal_edge_native()
    {
      ...
      this.$pos_pred = CommonSymbols.NIL;
      this.$cycls = CommonSymbols.NIL;
      this.$rule = CommonSymbols.NIL;
      this.$new_dtr_constraints = CommonSymbols.NIL;
      this.$head_dtr = CommonSymbols.NIL;
      this.$non_head_dtrs = CommonSymbols.NIL;
      this.$id = CommonSymbols.NIL;
    ...
    public SubLStructDecl getStructDecl()
    {
      return $phrase_structure_parser_phrasal_edge_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $phrase_structure_parser_phrasal_edge_native.class, $sym61$PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE, $sym62$PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE_P, $list63, $list64,
          new String[]
          { "$weight", "$string", "$span", "$category", "$pos_pred", "$cycls", "$rule", "$new_dtr_constraints", "$head_dtr", "$non_head_dtrs", "$id", "$chart"
          }, $list65, $list66, $sym67$PPRINT_PSP_PHRASAL_EDGE );
    }
  }

  public static final class $phrase_structure_parser_phrasal_edge_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $phrase_structure_parser_lexical_edge_native
      extends
        SubLStructNative
  {
    public SubLObject $weight;
    ...
    public $phrase_structure_parser_lexical_edge_native()
    {
      ...
      this.$pos_pred = CommonSymbols.NIL;
      this.$cycls = CommonSymbols.NIL;
      this.$wu = CommonSymbols.NIL;
      this.$frame = CommonSymbols.NIL;
      this.$id = CommonSymbols.NIL;
      this.$chart = CommonSymbols.NIL;
    }
    ...
    public SubLStructDecl getStructDecl()
    {
      return $phrase_structure_parser_lexical_edge_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $phrase_structure_parser_lexical_edge_native.class, $sym109$PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE, $sym110$PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE_P, $list111, $list112,
          new String[]
          { "$weight", "$string", "$span", "$category", "$pos_pred", "$cycls", "$wu", "$frame", "$id", "$chart"
          }, $list113, $list114, $sym115$PPRINT_PSP_LEXICAL_EDGE );
    }
  }

  public static final class $phrase_structure_parser_lexical_edge_p$UnaryFunction
      extends
        UnaryFunction
  {
