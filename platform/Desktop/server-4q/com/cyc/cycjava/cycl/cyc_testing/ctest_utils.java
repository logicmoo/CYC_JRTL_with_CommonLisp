...
public final class ctest_utils extends SubLTranslatedFile
{
    ...
    public static SubLObject init_ctest_utils_file() {
        ctest_utils.$default_email_notify_style_id$ = SubLFiles.deflexical("*DEFAULT-EMAIL-NOTIFY-STYLE-ID*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym0$_DEFAULT_EMAIL_NOTIFY_STYLE_ID_)) ? ctest_utils.$default_email_notify_style_id$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_test_id$ = SubLFiles.deflexical("*DEFAULT-TEST-ID*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym1$_DEFAULT_TEST_ID_)) ? ctest_utils.$default_test_id$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_string_binding_set$ = SubLFiles.deflexical("*DEFAULT-STRING-BINDING-SET*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym2$_DEFAULT_STRING_BINDING_SET_)) ? ctest_utils.$default_string_binding_set$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_binding_set$ = SubLFiles.deflexical("*DEFAULT-BINDING-SET*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym3$_DEFAULT_BINDING_SET_)) ? ctest_utils.$default_binding_set$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_binding_set2$ = SubLFiles.deflexical("*DEFAULT-BINDING-SET2*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym4$_DEFAULT_BINDING_SET2_)) ? ctest_utils.$default_binding_set2$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_set_of_binding_sets$ = SubLFiles.deflexical("*DEFAULT-SET-OF-BINDING-SETS*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym5$_DEFAULT_SET_OF_BINDING_SETS_)) ? ctest_utils.$default_set_of_binding_sets$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_set_of_binding_sets2$ = SubLFiles.deflexical("*DEFAULT-SET-OF-BINDING-SETS2*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym6$_DEFAULT_SET_OF_BINDING_SETS2_)) ? ctest_utils.$default_set_of_binding_sets2$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_set_of_binding_sets3$ = SubLFiles.deflexical("*DEFAULT-SET-OF-BINDING-SETS3*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym7$_DEFAULT_SET_OF_BINDING_SETS3_)) ? ctest_utils.$default_set_of_binding_sets3$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_module_sentence$ = SubLFiles.deflexical("*DEFAULT-MODULE-SENTENCE*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym8$_DEFAULT_MODULE_SENTENCE_)) ? ctest_utils.$default_module_sentence$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_module_mt$ = SubLFiles.deflexical("*DEFAULT-MODULE-MT*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym9$_DEFAULT_MODULE_MT_)) ? ctest_utils.$default_module_mt$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_module_mt2$ = SubLFiles.deflexical("*DEFAULT-MODULE-MT2*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym10$_DEFAULT_MODULE_MT2_)) ? ctest_utils.$default_module_mt2$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_dependency_test_id$ = SubLFiles.deflexical("*DEFAULT-DEPENDENCY-TEST-ID*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym11$_DEFAULT_DEPENDENCY_TEST_ID_)) ? ctest_utils.$default_dependency_test_id$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_dependency_test_id2$ = SubLFiles.deflexical("*DEFAULT-DEPENDENCY-TEST-ID2*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym12$_DEFAULT_DEPENDENCY_TEST_ID2_)) ? ctest_utils.$default_dependency_test_id2$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_isa_id$ = SubLFiles.deflexical("*DEFAULT-ISA-ID*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym13$_DEFAULT_ISA_ID_)) ? ctest_utils.$default_isa_id$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_isa_id2$ = SubLFiles.deflexical("*DEFAULT-ISA-ID2*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym14$_DEFAULT_ISA_ID2_)) ? ctest_utils.$default_isa_id2$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_test_query$ = SubLFiles.deflexical("*DEFAULT-TEST-QUERY*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym15$_DEFAULT_TEST_QUERY_)) ? ctest_utils.$default_test_query$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_test_mt$ = SubLFiles.deflexical("*DEFAULT-TEST-MT*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym16$_DEFAULT_TEST_MT_)) ? ctest_utils.$default_test_mt$.getGlobalValue() : ctest_utils.NIL));
        ctest_utils.$default_collection_id$ = SubLFiles.deflexical("*DEFAULT-COLLECTION-ID*", (SubLObject)((ctest_utils.NIL != Symbols.boundp((SubLObject)ctest_utils.$sym17$_DEFAULT_COLLECTION_ID_)) ? ctest_utils.$default_collection_id$.getGlobalValue() : ctest_utils.NIL));
