...
public final class cyc_testing extends SubLTranslatedFile
{
    ...
    public static SubLObject init_cyc_testing_file() {
        ...
        cyc_testing.$cyc_test_by_name$ = SubLFiles.deflexical("*CYC-TEST-BY-NAME*", (cyc_testing.NIL != Symbols.boundp((SubLObject)cyc_testing.$sym21$_CYC_TEST_BY_NAME_)) ? cyc_testing.$cyc_test_by_name$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)cyc_testing.$int22$212, Symbols.symbol_function((SubLObject)cyc_testing.EQUAL), (SubLObject)cyc_testing.UNPROVIDED));
        cyc_testing.$cyc_test_by_dwimmed_name$ = SubLFiles.deflexical("*CYC-TEST-BY-DWIMMED-NAME*", (cyc_testing.NIL != Symbols.boundp((SubLObject)cyc_testing.$sym23$_CYC_TEST_BY_DWIMMED_NAME_)) ? cyc_testing.$cyc_test_by_dwimmed_name$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)cyc_testing.$int22$212, Symbols.symbol_function((SubLObject)cyc_testing.EQUAL), (SubLObject)cyc_testing.UNPROVIDED));
        ...
        cyc_testing.$cyc_test_files$ = SubLFiles.deflexical("*CYC-TEST-FILES*", (SubLObject)((cyc_testing.NIL != Symbols.boundp((SubLObject)cyc_testing.$sym93$_CYC_TEST_FILES_)) ? cyc_testing.$cyc_test_files$.getGlobalValue() : cyc_testing.NIL));
        cyc_testing.$dtp_cyc_test_file$ = SubLFiles.defconstant("*DTP-CYC-TEST-FILE*", (SubLObject)cyc_testing.$sym100$CYC_TEST_FILE);
        cyc_testing.$most_recent_cyc_test_runs$ = SubLFiles.deflexical("*MOST-RECENT-CYC-TEST-RUNS*", (SubLObject)((cyc_testing.NIL != Symbols.boundp((SubLObject)cyc_testing.$sym119$_MOST_RECENT_CYC_TEST_RUNS_)) ? cyc_testing.$most_recent_cyc_test_runs$.getGlobalValue() : cyc_testing.NIL));
        cyc_testing.$most_recent_cyc_test_file_load_failures$ = SubLFiles.deflexical("*MOST-RECENT-CYC-TEST-FILE-LOAD-FAILURES*", (SubLObject)((cyc_testing.NIL != Symbols.boundp((SubLObject)cyc_testing.$sym120$_MOST_RECENT_CYC_TEST_FILE_LOAD_FAILURES_)) ? cyc_testing.$most_recent_cyc_test_file_load_failures$.getGlobalValue() : cyc_testing.NIL));
        return (SubLObject)cyc_testing.NIL;
    }
