...
public final class predicate_relevance_cache extends SubLTranslatedFile
{
    ...
    public static SubLObject init_predicate_relevance_cache_file() {
        ...
        predicate_relevance_cache.$spec_pred_fort_cache$ = SubLFiles.deflexical("*SPEC-PRED-FORT-CACHE*", (predicate_relevance_cache.NIL != Symbols.boundp((SubLObject)predicate_relevance_cache.$sym1$_SPEC_PRED_FORT_CACHE_)) ? predicate_relevance_cache.$spec_pred_fort_cache$.getGlobalValue() : cache.new_cache(predicate_relevance_cache.$pred_relevance_cache_size$.getGlobalValue(), Symbols.symbol_function((SubLObject)predicate_relevance_cache.EQUAL)));
        predicate_relevance_cache.$spec_inverse_fort_cache$ = SubLFiles.deflexical("*SPEC-INVERSE-FORT-CACHE*", (predicate_relevance_cache.NIL != Symbols.boundp((SubLObject)predicate_relevance_cache.$sym2$_SPEC_INVERSE_FORT_CACHE_)) ? predicate_relevance_cache.$spec_inverse_fort_cache$.getGlobalValue() : cache.new_cache(predicate_relevance_cache.$pred_relevance_cache_size$.getGlobalValue(), Symbols.symbol_function((SubLObject)predicate_relevance_cache.EQUAL)));
        predicate_relevance_cache.$genl_pred_fort_cache$ = SubLFiles.deflexical("*GENL-PRED-FORT-CACHE*", (predicate_relevance_cache.NIL != Symbols.boundp((SubLObject)predicate_relevance_cache.$sym3$_GENL_PRED_FORT_CACHE_)) ? predicate_relevance_cache.$genl_pred_fort_cache$.getGlobalValue() : cache.new_cache(predicate_relevance_cache.$pred_relevance_cache_size$.getGlobalValue(), Symbols.symbol_function((SubLObject)predicate_relevance_cache.EQUAL)));
        predicate_relevance_cache.$genl_inverse_fort_cache$ = SubLFiles.deflexical("*GENL-INVERSE-FORT-CACHE*", (predicate_relevance_cache.NIL != Symbols.boundp((SubLObject)predicate_relevance_cache.$sym4$_GENL_INVERSE_FORT_CACHE_)) ? predicate_relevance_cache.$genl_inverse_fort_cache$.getGlobalValue() : cache.new_cache(predicate_relevance_cache.$pred_relevance_cache_size$.getGlobalValue(), Symbols.symbol_function((SubLObject)predicate_relevance_cache.EQUAL)));
        predicate_relevance_cache.$spec_pred_naut_cache$ = SubLFiles.deflexical("*SPEC-PRED-NAUT-CACHE*", (predicate_relevance_cache.NIL != Symbols.boundp((SubLObject)predicate_relevance_cache.$sym5$_SPEC_PRED_NAUT_CACHE_)) ? predicate_relevance_cache.$spec_pred_naut_cache$.getGlobalValue() : cache.new_cache(predicate_relevance_cache.$pred_relevance_cache_size$.getGlobalValue(), Symbols.symbol_function((SubLObject)predicate_relevance_cache.EQUAL)));
        predicate_relevance_cache.$spec_inverse_naut_cache$ = SubLFiles.deflexical("*SPEC-INVERSE-NAUT-CACHE*", (predicate_relevance_cache.NIL != Symbols.boundp((SubLObject)predicate_relevance_cache.$sym6$_SPEC_INVERSE_NAUT_CACHE_)) ? predicate_relevance_cache.$spec_inverse_naut_cache$.getGlobalValue() : cache.new_cache(predicate_relevance_cache.$pred_relevance_cache_size$.getGlobalValue(), Symbols.symbol_function((SubLObject)predicate_relevance_cache.EQUAL)));
        predicate_relevance_cache.$genl_pred_naut_cache$ = SubLFiles.deflexical("*GENL-PRED-NAUT-CACHE*", (predicate_relevance_cache.NIL != Symbols.boundp((SubLObject)predicate_relevance_cache.$sym7$_GENL_PRED_NAUT_CACHE_)) ? predicate_relevance_cache.$genl_pred_naut_cache$.getGlobalValue() : cache.new_cache(predicate_relevance_cache.$pred_relevance_cache_size$.getGlobalValue(), Symbols.symbol_function((SubLObject)predicate_relevance_cache.EQUAL)));
        predicate_relevance_cache.$genl_inverse_naut_cache$ = SubLFiles.deflexical("*GENL-INVERSE-NAUT-CACHE*", (predicate_relevance_cache.NIL != Symbols.boundp((SubLObject)predicate_relevance_cache.$sym8$_GENL_INVERSE_NAUT_CACHE_)) ? predicate_relevance_cache.$genl_inverse_naut_cache$.getGlobalValue() : cache.new_cache(predicate_relevance_cache.$pred_relevance_cache_size$.getGlobalValue(), Symbols.symbol_function((SubLObject)predicate_relevance_cache.EQUAL)));
        return (SubLObject)predicate_relevance_cache.NIL;
    }
