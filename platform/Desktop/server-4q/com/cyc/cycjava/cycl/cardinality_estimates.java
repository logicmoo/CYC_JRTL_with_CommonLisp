...
public final class cardinality_estimates extends SubLTranslatedFile
{
    ...
    public static SubLObject init_cardinality_estimates_file() {
        cardinality_estimates.$local_instance_cardinality$ = SubLFiles.deflexical("*LOCAL-INSTANCE-CARDINALITY*", (SubLObject)((cardinality_estimates.NIL != Symbols.boundp((SubLObject)cardinality_estimates.$sym7$_LOCAL_INSTANCE_CARDINALITY_)) ? cardinality_estimates.$local_instance_cardinality$.getGlobalValue() : cardinality_estimates.NIL));
        cardinality_estimates.$local_quoted_instance_cardinality$ = SubLFiles.deflexical("*LOCAL-QUOTED-INSTANCE-CARDINALITY*", (SubLObject)((cardinality_estimates.NIL != Symbols.boundp((SubLObject)cardinality_estimates.$sym8$_LOCAL_QUOTED_INSTANCE_CARDINALITY_)) ? cardinality_estimates.$local_quoted_instance_cardinality$.getGlobalValue() : cardinality_estimates.NIL));
        cardinality_estimates.$local_spec_cardinality$ = SubLFiles.deflexical("*LOCAL-SPEC-CARDINALITY*", (SubLObject)((cardinality_estimates.NIL != Symbols.boundp((SubLObject)cardinality_estimates.$sym9$_LOCAL_SPEC_CARDINALITY_)) ? cardinality_estimates.$local_spec_cardinality$.getGlobalValue() : cardinality_estimates.NIL));
        cardinality_estimates.$total_instance_cardinality$ = SubLFiles.deflexical("*TOTAL-INSTANCE-CARDINALITY*", (SubLObject)((cardinality_estimates.NIL != Symbols.boundp((SubLObject)cardinality_estimates.$sym10$_TOTAL_INSTANCE_CARDINALITY_)) ? cardinality_estimates.$total_instance_cardinality$.getGlobalValue() : cardinality_estimates.NIL));
        cardinality_estimates.$total_quoted_instance_cardinality$ = SubLFiles.deflexical("*TOTAL-QUOTED-INSTANCE-CARDINALITY*", (SubLObject)((cardinality_estimates.NIL != Symbols.boundp((SubLObject)cardinality_estimates.$sym11$_TOTAL_QUOTED_INSTANCE_CARDINALITY_)) ? cardinality_estimates.$total_quoted_instance_cardinality$.getGlobalValue() : cardinality_estimates.NIL));
        cardinality_estimates.$total_spec_cardinality$ = SubLFiles.deflexical("*TOTAL-SPEC-CARDINALITY*", (SubLObject)((cardinality_estimates.NIL != Symbols.boundp((SubLObject)cardinality_estimates.$sym12$_TOTAL_SPEC_CARDINALITY_)) ? cardinality_estimates.$total_spec_cardinality$.getGlobalValue() : cardinality_estimates.NIL));
        cardinality_estimates.$total_genl_cardinality$ = SubLFiles.deflexical("*TOTAL-GENL-CARDINALITY*", (SubLObject)((cardinality_estimates.NIL != Symbols.boundp((SubLObject)cardinality_estimates.$sym13$_TOTAL_GENL_CARDINALITY_)) ? cardinality_estimates.$total_genl_cardinality$.getGlobalValue() : cardinality_estimates.NIL));
        cardinality_estimates.$generality_estimate_table$ = SubLFiles.deflexical("*GENERALITY-ESTIMATE-TABLE*", (SubLObject)((cardinality_estimates.NIL != Symbols.boundp((SubLObject)cardinality_estimates.$sym14$_GENERALITY_ESTIMATE_TABLE_)) ? cardinality_estimates.$generality_estimate_table$.getGlobalValue() : cardinality_estimates.NIL));
