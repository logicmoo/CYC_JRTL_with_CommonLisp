...
public final class wff_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_wff_utilities_file() {
        ...
        wff_utilities.$non_wff_list$ = SubLFiles.deflexical("*NON-WFF-LIST*", (SubLObject)(maybeDefault((SubLObject)wff_utilities.$sym2$_NON_WFF_LIST_, wff_utilities.$non_wff_list$, wff_utilities.NIL)));
        wff_utilities.$num_assertions_checked$ = SubLFiles.deflexical("*NUM-ASSERTIONS-CHECKED*", (SubLObject)(maybeDefault((SubLObject)wff_utilities.$sym3$_NUM_ASSERTIONS_CHECKED_, wff_utilities.$num_assertions_checked$, wff_utilities.ZERO_INTEGER)));
        wff_utilities.$last_checked_assertion_id$ = SubLFiles.deflexical("*LAST-CHECKED-ASSERTION-ID*", (SubLObject)(maybeDefault((SubLObject)wff_utilities.$sym4$_LAST_CHECKED_ASSERTION_ID_, wff_utilities.$last_checked_assertion_id$, wff_utilities.ZERO_INTEGER)));
        wff_utilities.$non_wff_error$ = SubLFiles.deflexical("*NON-WFF-ERROR*", (SubLObject)(maybeDefault((SubLObject)wff_utilities.$sym5$_NON_WFF_ERROR_, wff_utilities.$non_wff_error$, wff_utilities.NIL)));
        wff_utilities.$non_wff_error_list$ = SubLFiles.deflexical("*NON-WFF-ERROR-LIST*", (SubLObject)(maybeDefault((SubLObject)wff_utilities.$sym6$_NON_WFF_ERROR_LIST_, wff_utilities.$non_wff_error_list$, wff_utilities.NIL)));
        wff_utilities.$pre_wff_hash$ = SubLFiles.deflexical("*PRE-WFF-HASH*", (SubLObject)(maybeDefault((SubLObject)wff_utilities.$sym13$_PRE_WFF_HASH_, wff_utilities.$pre_wff_hash$, wff_utilities.NIL)));
        wff_utilities.$post_wff_hash$ = SubLFiles.deflexical("*POST-WFF-HASH*", (SubLObject)(maybeDefault((SubLObject)wff_utilities.$sym14$_POST_WFF_HASH_, wff_utilities.$post_wff_hash$, wff_utilities.NIL)));
        ...
        wff_utilities.$non_wff_start$ = SubLFiles.deflexical("*NON-WFF-START*", (SubLObject)(maybeDefault((SubLObject)wff_utilities.$sym21$_NON_WFF_START_, wff_utilities.$non_wff_start$, wff_utilities.NIL)));
        wff_utilities.$non_wff_end$ = SubLFiles.deflexical("*NON-WFF-END*", (SubLObject)(maybeDefault((SubLObject)wff_utilities.$sym22$_NON_WFF_END_, wff_utilities.$non_wff_end$, wff_utilities.NIL)));
