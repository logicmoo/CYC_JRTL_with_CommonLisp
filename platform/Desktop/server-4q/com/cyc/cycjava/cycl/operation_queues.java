...
public final class operation_queues extends SubLTranslatedFile
{
    ...
    public static SubLObject init_operation_queues_file() {
        operation_queues.$local_queue$ = SubLFiles.deflexical("*LOCAL-QUEUE*", maybeDefault((SubLObject)operation_queues.$sym0$_LOCAL_QUEUE_, operation_queues.$local_queue$, ()->(queues.create_queue((SubLObject)operation_queues.UNPROVIDED))));
        ...
        operation_queues.$remote_queue$ = SubLFiles.deflexical("*REMOTE-QUEUE*", maybeDefault((SubLObject)operation_queues.$sym3$_REMOTE_QUEUE_, operation_queues.$remote_queue$, ()->(queues.create_queue((SubLObject)operation_queues.UNPROVIDED))));
        ...
        operation_queues.$transcript_queue$ = SubLFiles.deflexical("*TRANSCRIPT-QUEUE*", maybeDefault((SubLObject)operation_queues.$sym5$_TRANSCRIPT_QUEUE_, operation_queues.$transcript_queue$, ()->(queues.create_queue((SubLObject)operation_queues.UNPROVIDED))));
        ...
        operation_queues.$hl_transcript_queue$ = SubLFiles.deflexical("*HL-TRANSCRIPT-QUEUE*", maybeDefault((SubLObject)operation_queues.$sym7$_HL_TRANSCRIPT_QUEUE_, operation_queues.$hl_transcript_queue$, ()->(queues.create_queue((SubLObject)operation_queues.UNPROVIDED))));
        ...
        operation_queues.$auxiliary_queue$ = SubLFiles.deflexical("*AUXILIARY-QUEUE*", maybeDefault((SubLObject)operation_queues.$sym9$_AUXILIARY_QUEUE_, operation_queues.$auxiliary_queue$, ()->(queues.create_queue((SubLObject)operation_queues.UNPROVIDED))));
        ...
        operation_queues.$transmit_queue$ = SubLFiles.deflexical("*TRANSMIT-QUEUE*", maybeDefault((SubLObject)operation_queues.$sym11$_TRANSMIT_QUEUE_, operation_queues.$transmit_queue$, ()->(queues.create_queue((SubLObject)operation_queues.UNPROVIDED))));
        ...
        operation_queues.$local_operation_storage_queue$ = SubLFiles.deflexical("*LOCAL-OPERATION-STORAGE-QUEUE*", maybeDefault((SubLObject)operation_queues.$sym14$_LOCAL_OPERATION_STORAGE_QUEUE_, operation_queues.$local_operation_storage_queue$, ()->(queues.create_queue((SubLObject)operation_queues.UNPROVIDED))));
