...
public final class cyc_navigator_internals extends SubLTranslatedFile
{
    ...
    public static SubLObject init_cyc_navigator_internals_file() {
        ...
        cyc_navigator_internals.$navigator_link_definition_table$ = SubLFiles.deflexical("*NAVIGATOR-LINK-DEFINITION-TABLE*", (cyc_navigator_internals.NIL != Symbols.boundp((SubLObject)cyc_navigator_internals.$sym6$_NAVIGATOR_LINK_DEFINITION_TABLE_)) ? cyc_navigator_internals.$navigator_link_definition_table$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)cyc_navigator_internals.$int7$100, (SubLObject)cyc_navigator_internals.UNPROVIDED, (SubLObject)cyc_navigator_internals.UNPROVIDED));
        cyc_navigator_internals.$navigator_link_category_table$ = SubLFiles.deflexical("*NAVIGATOR-LINK-CATEGORY-TABLE*", (cyc_navigator_internals.NIL != Symbols.boundp((SubLObject)cyc_navigator_internals.$sym8$_NAVIGATOR_LINK_CATEGORY_TABLE_)) ? cyc_navigator_internals.$navigator_link_category_table$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)cyc_navigator_internals.$int9$50, (SubLObject)cyc_navigator_internals.UNPROVIDED, (SubLObject)cyc_navigator_internals.UNPROVIDED));
