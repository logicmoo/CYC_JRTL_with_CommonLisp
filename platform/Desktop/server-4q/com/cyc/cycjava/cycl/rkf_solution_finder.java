...
public final class rkf_solution_finder extends SubLTranslatedFile
{
    ...
    public static SubLObject init_rkf_solution_finder_file() {
        ...
        rkf_solution_finder.$sf_isg$ = SubLFiles.deflexical("*SF-ISG*", maybeDefault((SubLObject)rkf_solution_finder.$sym4$_SF_ISG_, rkf_solution_finder.$sf_isg$, ()->(integer_sequence_generator.new_integer_sequence_generator((SubLObject)rkf_solution_finder.UNPROVIDED, (SubLObject)rkf_solution_finder.UNPROVIDED, (SubLObject)rkf_solution_finder.UNPROVIDED))));
        rkf_solution_finder.$sf_index$ = SubLFiles.deflexical("*SF-INDEX*", maybeDefault((SubLObject)rkf_solution_finder.$sym5$_SF_INDEX_, rkf_solution_finder.$sf_index$, ()->(dictionary.new_dictionary((SubLObject)rkf_solution_finder.UNPROVIDED, (SubLObject)rkf_solution_finder.UNPROVIDED))));
