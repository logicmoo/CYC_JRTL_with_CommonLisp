...
public final class lexification_wizard extends SubLTranslatedFile
{
    ...
    public static SubLObject init_lexification_wizard_file() {
        ...
        lexification_wizard.$main_lexification_parts_of_speech$ = SubLFiles.deflexical("*MAIN-LEXIFICATION-PARTS-OF-SPEECH*", (SubLObject)((lexification_wizard.NIL != Symbols.boundp((SubLObject)lexification_wizard.$sym109$_MAIN_LEXIFICATION_PARTS_OF_SPEECH_)) ? lexification_wizard.$main_lexification_parts_of_speech$.getGlobalValue() : lexification_wizard.NIL));
        lexification_wizard.$all_lexification_parts_of_speech_labels$ = SubLFiles.deflexical("*ALL-LEXIFICATION-PARTS-OF-SPEECH-LABELS*", (SubLObject)((lexification_wizard.NIL != Symbols.boundp((SubLObject)lexification_wizard.$sym110$_ALL_LEXIFICATION_PARTS_OF_SPEECH_LABELS_)) ? lexification_wizard.$all_lexification_parts_of_speech_labels$.getGlobalValue() : lexification_wizard.NIL));
        lexification_wizard.$lexification_proper_name_predicate_names$ = SubLFiles.deflexical("*LEXIFICATION-PROPER-NAME-PREDICATE-NAMES*", (SubLObject)((lexification_wizard.NIL != Symbols.boundp((SubLObject)lexification_wizard.$sym111$_LEXIFICATION_PROPER_NAME_PREDICATE_NAMES_)) ? lexification_wizard.$lexification_proper_name_predicate_names$.getGlobalValue() : lexification_wizard.NIL));
        lexification_wizard.$lexification_proper_name_predicate_constraints$ = SubLFiles.deflexical("*LEXIFICATION-PROPER-NAME-PREDICATE-CONSTRAINTS*", (SubLObject)((lexification_wizard.NIL != Symbols.boundp((SubLObject)lexification_wizard.$sym112$_LEXIFICATION_PROPER_NAME_PREDICATE_CONSTRAINTS_)) ? lexification_wizard.$lexification_proper_name_predicate_constraints$.getGlobalValue() : lexification_wizard.NIL));
        lexification_wizard.$lexification_mts$ = SubLFiles.deflexical("*LEXIFICATION-MTS*", (SubLObject)((lexification_wizard.NIL != Symbols.boundp((SubLObject)lexification_wizard.$sym113$_LEXIFICATION_MTS_)) ? lexification_wizard.$lexification_mts$.getGlobalValue() : lexification_wizard.NIL));
        ...
        lexification_wizard.$lexification_object_table$ = SubLFiles.deflexical("*LEXIFICATION-OBJECT-TABLE*", (lexification_wizard.NIL != Symbols.boundp((SubLObject)lexification_wizard.$sym116$_LEXIFICATION_OBJECT_TABLE_)) ? lexification_wizard.$lexification_object_table$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)lexification_wizard.$int117$256, Symbols.symbol_function((SubLObject)lexification_wizard.EQUAL), (SubLObject)lexification_wizard.UNPROVIDED));
        ...
        lexification_wizard.$lexification_template_mts$ = SubLFiles.deflexical("*LEXIFICATION-TEMPLATE-MTS*", (SubLObject)((lexification_wizard.NIL != Symbols.boundp((SubLObject)lexification_wizard.$sym118$_LEXIFICATION_TEMPLATE_MTS_)) ? lexification_wizard.$lexification_template_mts$.getGlobalValue() : lexification_wizard.NIL));
