...
public final class red_infrastructure extends SubLTranslatedFile
{
    ...
    public static SubLObject init_red_infrastructure_file() {
        red_infrastructure.$red_variables_dictionary$ = SubLFiles.deflexical("*RED-VARIABLES-DICTIONARY*", (red_infrastructure.NIL != Symbols.boundp((SubLObject)red_infrastructure.$sym0$_RED_VARIABLES_DICTIONARY_)) ? red_infrastructure.$red_variables_dictionary$.getGlobalValue() : dictionary.new_dictionary((SubLObject)red_infrastructure.UNPROVIDED, (SubLObject)red_infrastructure.UNPROVIDED));
        red_infrastructure.$red_symbols_list$ = SubLFiles.deflexical("*RED-SYMBOLS-LIST*", (SubLObject)((red_infrastructure.NIL != Symbols.boundp((SubLObject)red_infrastructure.$sym1$_RED_SYMBOLS_LIST_)) ? red_infrastructure.$red_symbols_list$.getGlobalValue() : red_infrastructure.NIL));
        red_infrastructure.$red_keys_dictionary$ = SubLFiles.deflexical("*RED-KEYS-DICTIONARY*", (red_infrastructure.NIL != Symbols.boundp((SubLObject)red_infrastructure.$sym2$_RED_KEYS_DICTIONARY_)) ? red_infrastructure.$red_keys_dictionary$.getGlobalValue() : dictionary.new_dictionary((SubLObject)red_infrastructure.UNPROVIDED, (SubLObject)red_infrastructure.UNPROVIDED));
        red_infrastructure.$red_reload_callback_moniker_dictionary$ = SubLFiles.deflexical("*RED-RELOAD-CALLBACK-MONIKER-DICTIONARY*", (red_infrastructure.NIL != Symbols.boundp((SubLObject)red_infrastructure.$sym3$_RED_RELOAD_CALLBACK_MONIKER_DICTIONARY_)) ? red_infrastructure.$red_reload_callback_moniker_dictionary$.getGlobalValue() : dictionary.new_dictionary((SubLObject)red_infrastructure.UNPROVIDED, (SubLObject)red_infrastructure.UNPROVIDED));
        red_infrastructure.$repositories_loaded$ = SubLFiles.deflexical("*REPOSITORIES-LOADED*", (SubLObject)((red_infrastructure.NIL != Symbols.boundp((SubLObject)red_infrastructure.$sym4$_REPOSITORIES_LOADED_)) ? red_infrastructure.$repositories_loaded$.getGlobalValue() : red_infrastructure.NIL));
