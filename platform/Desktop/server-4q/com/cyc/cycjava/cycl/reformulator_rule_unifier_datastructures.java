...
public final class reformulator_rule_unifier_datastructures extends SubLTranslatedFile
{
    ...
    public static SubLObject init_reformulator_rule_unifier_datastructures_file() {
        ...
        reformulator_rule_unifier_datastructures.$reformulator_rules$ = SubLFiles.deflexical("*REFORMULATOR-RULES*", (SubLObject)(maybeDefault((SubLObject)reformulator_rule_unifier_datastructures.$sym73$_REFORMULATOR_RULES_, reformulator_rule_unifier_datastructures.$reformulator_rules$, reformulator_rule_unifier_datastructures.NIL)));
        reformulator_rule_unifier_datastructures.$fort_reformulator_rule_table$ = SubLFiles.deflexical("*FORT-REFORMULATOR-RULE-TABLE*", (SubLObject)(maybeDefault((SubLObject)reformulator_rule_unifier_datastructures.$sym74$_FORT_REFORMULATOR_RULE_TABLE_, reformulator_rule_unifier_datastructures.$fort_reformulator_rule_table$, reformulator_rule_unifier_datastructures.NIL)));
        reformulator_rule_unifier_datastructures.$constant_reformulator_rule_table$ = SubLFiles.deflexical("*CONSTANT-REFORMULATOR-RULE-TABLE*", (SubLObject)(maybeDefault((SubLObject)reformulator_rule_unifier_datastructures.$sym75$_CONSTANT_REFORMULATOR_RULE_TABLE_, reformulator_rule_unifier_datastructures.$constant_reformulator_rule_table$, reformulator_rule_unifier_datastructures.NIL)));
        reformulator_rule_unifier_datastructures.$nart_reformulator_rule_table$ = SubLFiles.deflexical("*NART-REFORMULATOR-RULE-TABLE*", (SubLObject)(maybeDefault((SubLObject)reformulator_rule_unifier_datastructures.$sym76$_NART_REFORMULATOR_RULE_TABLE_, reformulator_rule_unifier_datastructures.$nart_reformulator_rule_table$, reformulator_rule_unifier_datastructures.NIL)));
        reformulator_rule_unifier_datastructures.$unassociated_reformulator_rules$ = SubLFiles.deflexical("*UNASSOCIATED-REFORMULATOR-RULES*", (SubLObject)(maybeDefault((SubLObject)reformulator_rule_unifier_datastructures.$sym77$_UNASSOCIATED_REFORMULATOR_RULES_, reformulator_rule_unifier_datastructures.$unassociated_reformulator_rules$, reformulator_rule_unifier_datastructures.NIL)));
