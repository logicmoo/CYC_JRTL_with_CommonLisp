...
public final class unrepresented_terms extends SubLTranslatedFile
{
    ...
    public static SubLObject init_unrepresented_terms_file() {
        unrepresented_terms.$unrepresented_term_to_suid$ = SubLFiles.deflexical("*UNREPRESENTED-TERM-TO-SUID*", (SubLObject)((unrepresented_terms.NIL != Symbols.boundp((SubLObject)unrepresented_terms.$sym54$_UNREPRESENTED_TERM_TO_SUID_)) ? unrepresented_terms.$unrepresented_term_to_suid$.getGlobalValue() : unrepresented_terms.NIL));
        unrepresented_terms.$unrepresented_term_from_suid$ = SubLFiles.deflexical("*UNREPRESENTED-TERM-FROM-SUID*", (SubLObject)((unrepresented_terms.NIL != Symbols.boundp((SubLObject)unrepresented_terms.$sym55$_UNREPRESENTED_TERM_FROM_SUID_)) ? unrepresented_terms.$unrepresented_term_from_suid$.getGlobalValue() : unrepresented_terms.NIL));
        unrepresented_terms.$use_fht_approach_to_unrepresented_termsP$ = SubLFiles.deflexical("*USE-FHT-APPROACH-TO-UNREPRESENTED-TERMS?*", (SubLObject)((unrepresented_terms.NIL != Symbols.boundp((SubLObject)unrepresented_terms.$sym62$_USE_FHT_APPROACH_TO_UNREPRESENTED_TERMS__)) ? unrepresented_terms.$use_fht_approach_to_unrepresented_termsP$.getGlobalValue() : unrepresented_terms.NIL));
        unrepresented_terms.$unrepresented_term_fht$ = SubLFiles.deflexical("*UNREPRESENTED-TERM-FHT*", (SubLObject)((unrepresented_terms.NIL != Symbols.boundp((SubLObject)unrepresented_terms.$sym63$_UNREPRESENTED_TERM_FHT_)) ? unrepresented_terms.$unrepresented_term_fht$.getGlobalValue() : unrepresented_terms.NIL));
        unrepresented_terms.$unrepresented_term_isg$ = SubLFiles.deflexical("*UNREPRESENTED-TERM-ISG*", (SubLObject)((unrepresented_terms.NIL != Symbols.boundp((SubLObject)unrepresented_terms.$sym64$_UNREPRESENTED_TERM_ISG_)) ? unrepresented_terms.$unrepresented_term_isg$.getGlobalValue() : unrepresented_terms.NIL));
        unrepresented_terms.$unrepresented_term_change_set$ = SubLFiles.deflexical("*UNREPRESENTED-TERM-CHANGE-SET*", (SubLObject)((unrepresented_terms.NIL != Symbols.boundp((SubLObject)unrepresented_terms.$sym65$_UNREPRESENTED_TERM_CHANGE_SET_)) ? unrepresented_terms.$unrepresented_term_change_set$.getGlobalValue() : unrepresented_terms.NIL));
        unrepresented_terms.$unrepresented_term_fht_lock$ = SubLFiles.deflexical("*UNREPRESENTED-TERM-FHT-LOCK*", (unrepresented_terms.NIL != Symbols.boundp((SubLObject)unrepresented_terms.$sym66$_UNREPRESENTED_TERM_FHT_LOCK_)) ? unrepresented_terms.$unrepresented_term_fht_lock$.getGlobalValue() : Locks.make_lock((SubLObject)unrepresented_terms.$str67$Unrepresented_Terms_FHT_Lock));
        ...
        unrepresented_terms.$new_unrepresented_term_id_threshold$ = SubLFiles.deflexical("*NEW-UNREPRESENTED-TERM-ID-THRESHOLD*", (SubLObject)((unrepresented_terms.NIL != Symbols.boundp((SubLObject)unrepresented_terms.$sym75$_NEW_UNREPRESENTED_TERM_ID_THRESHOLD_)) ? unrepresented_terms.$new_unrepresented_term_id_threshold$.getGlobalValue() : unrepresented_terms.NIL));
