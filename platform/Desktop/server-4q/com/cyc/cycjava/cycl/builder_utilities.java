...
public final class builder_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_builder_utilities_file() {
        ...
        builder_utilities.$cyc_product$ = SubLFiles.deflexical("*CYC-PRODUCT*", (SubLObject)((builder_utilities.NIL != Symbols.boundp((SubLObject)builder_utilities.$sym117$_CYC_PRODUCT_)) ? builder_utilities.$cyc_product$.getGlobalValue() : builder_utilities.NIL));
        builder_utilities.$code_product$ = SubLFiles.defconstant("*CODE-PRODUCT*", (SubLObject)builder_utilities.$kw110$STANDARD);
        builder_utilities.$kb_product$ = SubLFiles.deflexical("*KB-PRODUCT*", (SubLObject)((builder_utilities.NIL != Symbols.boundp((SubLObject)builder_utilities.$sym118$_KB_PRODUCT_)) ? builder_utilities.$kb_product$.getGlobalValue() : builder_utilities.NIL));
