      ...
      SubLTranslatedFile
{
  ...
  public static SubLObject with_opaque_arg_function(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.listS( $sym3$CLET, ConsesLow.list( ConsesLow.list( $sym4$_OPAQUE_ARG_FUNCTION_, func ) ), ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject with_opaque_seqvar_function(final SubLObject macroform, final SubLObject environment)
  {
    ...
    final SubLObject body;
    current = ( body = current.rest() );
    return ConsesLow.listS( $sym3$CLET, ConsesLow.list( ConsesLow.list( $sym5$_OPAQUE_SEQVAR_FUNCTION_, func ) ), ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject maybe_some_opaque_argP(final SubLObject expression)
  {
    ...
    return makeBoolean( $opaque_arg_function$.getDynamicValue( thread ) != $sym0$DEFAULT_OPAQUE_ARG_ || NIL != el_utilities.subl_escape_p( expression ) || NIL != el_utilities.formula_with_sequence_termP( expression ) );
  }
  ...
  public static SubLObject opaque_argP_int(final SubLObject formula, final SubLObject argnum, final SubLObject opaque_arg_function)
  {
    ...
    else if( opaque_arg_function.eql( $sym6$OPAQUE_ARG_WRT_EL_TEMPLATE_ ) )
    {
  ...
  {
    if( TWO_INTEGER.eql( argnum ) && NIL != el_utilities.el_formula_with_operator_p( formula, $const7$SkolemFunctionFn ) )
    {
      return T;
    }
    if( NIL != el_utilities.formula_arityL( formula, argnum, UNPROVIDED ) )
  ...
  {
    return makeBoolean( NIL != default_opaque_argP( formula, argnum ) || ( NIL == el_utilities.tou_litP( formula ) && ( NIL != cycl_grammar.fast_quote_term_p( formula_arg( formula, argnum, UNPROVIDED ) )
  ...
  {
    if( NIL != el_utilities.el_formula_with_operator_p( formula, $const8$trueSentence ) || NIL != el_utilities.cyc_const_logical_operator_p( formula_operator( formula ) ) || NIL != el_utilities.cyc_const_quantifier_p(
  ...
  {
    return makeBoolean( NIL != default_opaque_argP( formula, argnum ) || NIL != el_utilities.tou_asentP( formula ) );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( NIL == expression_find_if( Symbols.symbol_function( $sym9$HL_TERM_WITH_EL_COUNTERPART_P ), hl_expression, NIL, UNPROVIDED ) )
    {
    ...
    try
    {
      thread.throwStack.push( $kw10$TRANSFORMATION_LIMIT_EXCEEDED );
      result = unrename_default_el_vars( expression_transform( rename_default_el_vars( hl_expression ), Symbols.symbol_function( $sym9$HL_TERM_WITH_EL_COUNTERPART_P ), Symbols.symbol_function(
          $sym11$HL_TERM_TO_EL_TERM ), T, UNPROVIDED ) );
    }
    catch( final Throwable ccatch_env_var )
    {
      error = Errors.handleThrowable( ccatch_env_var, $kw10$TRANSFORMATION_LIMIT_EXCEEDED );
    }
    finally
    {
    ...
    if( NIL != error )
    {
      Errors.warn( $str12$Recursion_limit_reached___el_to_h, el_utilities.sefify( hl_expression ) );
  ...
  public static SubLObject hl_to_el_destructive(final SubLObject hl_expression)
  {
    ...
    return unrename_default_el_vars_destructive( expression_ntransform( rename_default_el_vars_destructive( hl_expression ), Symbols.symbol_function( $sym9$HL_TERM_WITH_EL_COUNTERPART_P ), Symbols.symbol_function(
        $sym13$CAREFUL_HL_TERM_TO_EL_TERM ), T, UNPROVIDED ) );
  }
  ...
  public static SubLObject hl_to_el_preserve_el_vars(final SubLObject hl_expression)
  {
    ...
    return expression_transform( hl_expression, Symbols.symbol_function( $sym9$HL_TERM_WITH_EL_COUNTERPART_P ), Symbols.symbol_function( $sym11$HL_TERM_TO_EL_TERM ), T, UNPROVIDED );
  }
  ...
  {
    if( NIL == list_utilities.tree_find_if( Symbols.symbol_function( $sym9$HL_TERM_WITH_EL_COUNTERPART_P ), binding_lists, UNPROVIDED ) )
    {
  ...
  {
    if( NIL != constant_handles.constant_p( form ) )
    {
      return form;
    }
    if( form.isString() )
  ...
  {
    return ConsesLow.cons( rf_type( rf ), rf_raw_id( rf ) );
  }
  ...
  public static SubLObject find_rf_by_id(final SubLObject rf_id)
  {
    ...
    if( raw_id.isInteger() )
    {
      ...
      if( pcase_var.eql( $kw14$NART ) )
      {
        return nart_handles.find_nart_by_id( raw_id );
      }
      if( pcase_var.eql( $kw15$ASSERTION ) )
      {
  ...
  public static SubLObject rf_narts(final SubLObject rf, SubLObject penetrate_hl_structuresP)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    return formula_narts( Functions.funcall( czer_vars.$rf_key$.getDynamicValue( thread ), rf ), penetrate_hl_structuresP, UNPROVIDED );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return transform_list_utilities.transform( formula, Symbols.symbol_function( $sym16$RF_P ), czer_vars.$rf_key$.getDynamicValue( thread ), UNPROVIDED );
  }
  ...
  public static SubLObject subrfs(final SubLObject rf, final SubLObject penetrate_hl_structuresP)
  {
    ...
    return ConsesLow.nconc( formula_narts( formula, penetrate_hl_structuresP, UNPROVIDED ), formula_sub_assertions( formula, penetrate_hl_structuresP, UNPROVIDED ) );
  }
  ...
  {
    return ConsesLow.nconc( ( NIL != nart_handles.nart_p( rf ) ) ? indexing_utilities.dependent_narts( rf ) : NIL, kb_accessors.all_term_assertions( rf, T ) );
  }
  ...
  {
    return ConsesLow.cons( rf, subrfs( rf, T ) );
  }
  ...
  {
    SubLObject result = ( NIL != Functions.funcall( pred, Functions.funcall( key, expression ) ) ) ? ConsesLow.list( expression ) : NIL;
    if( NIL != subs_tooP || NIL == result )
    {
      ...
      else if( NIL != el_utilities.el_formula_p( expression ) )
      {
        ...
        final SubLObject terms = formula_terms( expression, $kw17$REGULARIZE );
  ...
  public static SubLObject expression_count(final SubLObject item, final SubLObject list, SubLObject penetrate_hl_structuresP, SubLObject test, SubLObject subs_tooP)
  {
    ...
    try
    {
      ...
      result = Sequences.length( expression_gather_int_2( list, $sym19$EXPRESSION_COUNT_HELPER, penetrate_hl_structuresP, Symbols.symbol_function( IDENTITY ), subs_tooP ) );
    }
    finally
    {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return Functions.funcall( $expression_count_test$.getDynamicValue( thread ), $expression_count_item$.getDynamicValue( thread ), list_expression );
  }
  ...
  public static SubLObject expression_forts(final SubLObject expression, SubLObject penetrate_hl_structuresP, SubLObject subs_tooP, SubLObject delete_duplicatesP)
  {
    ...
    return ( NIL != delete_duplicatesP ) ? expression_gather_int( expression, Symbols.symbol_function( $sym21$FORT_P ), penetrate_hl_structuresP, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ),
        subs_tooP ) : expression_gather_int_2( expression, Symbols.symbol_function( $sym21$FORT_P ), penetrate_hl_structuresP, Symbols.symbol_function( IDENTITY ), subs_tooP );
  }
  ...
  public static SubLObject expression_list_forts(final SubLObject expression_list, SubLObject penetrate_hl_structuresP, SubLObject subs_tooP)
  {
    ...
    return expression_list_gather( expression_list, Symbols.symbol_function( $sym21$FORT_P ), penetrate_hl_structuresP, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ), subs_tooP );
  }
  ...
  public static SubLObject expression_constants(final SubLObject expression, SubLObject penetrate_hl_structuresP)
  {
    ...
    return expression_gather_int( expression, Symbols.symbol_function( $sym22$CONSTANT_P ), penetrate_hl_structuresP, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ), NIL );
  }
  ...
  public static SubLObject expression_list_constants(final SubLObject expression_list, SubLObject penetrate_hl_structuresP)
  {
    ...
    return expression_list_gather( expression_list, Symbols.symbol_function( $sym22$CONSTANT_P ), penetrate_hl_structuresP, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject expression_narts(final SubLObject expression, SubLObject penetrate_hl_structuresP, SubLObject subs_tooP)
  {
    ...
    return expression_gather_int( expression, Symbols.symbol_function( $sym23$NART_P ), penetrate_hl_structuresP, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ), subs_tooP );
  }
  ...
  public static SubLObject expression_list_narts(final SubLObject expression_list, SubLObject penetrate_hl_structuresP, SubLObject subs_tooP)
  {
    ...
    return expression_list_gather( expression_list, Symbols.symbol_function( $sym23$NART_P ), penetrate_hl_structuresP, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ), subs_tooP );
  }
  ...
  public static SubLObject expression_sub_assertions(final SubLObject expression, SubLObject penetrate_hl_structuresP, SubLObject subs_tooP)
  {
    ...
    return expression_gather_int( expression, Symbols.symbol_function( $sym18$ASSERTION_P ), penetrate_hl_structuresP, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ), subs_tooP );
  }
  ...
  public static SubLObject expression_list_sub_assertions(final SubLObject expression_list, SubLObject penetrate_hl_structuresP, SubLObject subs_tooP)
  {
    ...
    return expression_list_gather( expression_list, Symbols.symbol_function( $sym18$ASSERTION_P ), penetrate_hl_structuresP, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ), subs_tooP );
  }
  ...
  public static SubLObject all_formula_terms(final SubLObject formula, SubLObject penetrate_hl_structuresP)
  {
    ...
    if( !formula.isAtom() )
    {
      ...
      if( NIL != el_utilities.el_conjunction_p( formula ) || NIL != el_utilities.el_disjunction_p( formula ) )
      {
        ...
        final SubLObject terms = cdolist_list_var = formula_terms( formula, $kw24$IGNORE );
        SubLObject v_term = NIL;
        v_term = cdolist_list_var.first();
        while ( NIL != cdolist_list_var)
        {
          result = ConsesLow.cons( all_formula_terms( v_term, penetrate_hl_structuresP ), result );
          cdolist_list_var = cdolist_list_var.rest();
          v_term = cdolist_list_var.first();
        }
        return result;
      ...
      {
        return conses_high.union( all_formula_terms( formula_arg1( formula, UNPROVIDED ), penetrate_hl_structuresP ), all_formula_terms( formula_arg2( formula, UNPROVIDED ), penetrate_hl_structuresP ), UNPROVIDED,
            UNPROVIDED );
      }
      ...
      if( NIL != el_utilities.el_universal_p( formula ) || NIL != el_utilities.el_existential_p( formula ) )
      {
        return conses_high.adjoin( formula_arg1( formula, UNPROVIDED ), all_formula_terms( formula_arg2( formula, UNPROVIDED ), penetrate_hl_structuresP ), UNPROVIDED, UNPROVIDED );
      }
      if( NIL != el_utilities.el_bounded_existential_p( formula ) )
      {
        return conses_high.adjoin( formula_arg2( formula, UNPROVIDED ), all_formula_terms( formula_arg3( formula, UNPROVIDED ), penetrate_hl_structuresP ), UNPROVIDED, UNPROVIDED );
      }
      if( NIL != el_utilities.mt_designating_literalP( formula ) )
      {
        ...
        return conses_high.adjoin( mt, result2, UNPROVIDED, UNPROVIDED );
      }
      if( NIL != el_utilities.atomic_sentenceP( formula ) )
      {
        return all_literal_terms( formula, penetrate_hl_structuresP );
      }
      el_utilities.el_error( FOUR_INTEGER, $str25$_S_is_not_well_formed_, formula, UNPROVIDED, UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject all_literal_terms(final SubLObject literal, SubLObject penetrate_hl_structuresP)
  {
    ...
    SubLObject cdolist_list_var;
    final SubLObject args = cdolist_list_var = formula_args( literal, $kw24$IGNORE );
    SubLObject v_term = NIL;
    v_term = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( NIL != forts.fort_p( v_term ) )
      {
        ...
        {
          ans = list_utilities.fast_delete_duplicates( ConsesLow.append( ans, all_literal_terms( Functions.funcall( czer_vars.$nart_key$.getDynamicValue( thread ), v_term ), T ) ), UNPROVIDED, UNPROVIDED, UNPROVIDED,
              UNPROVIDED, UNPROVIDED );
        }
      }
      else if( NIL != penetrate_hl_structuresP && NIL != assertion_handles.assertion_p( v_term ) )
      {
        ans = list_utilities.fast_delete_duplicates( ConsesLow.append( ans, all_formula_terms( Functions.funcall( czer_vars.$assertion_key$.getDynamicValue( thread ), v_term ), T ) ), UNPROVIDED, UNPROVIDED, UNPROVIDED,
            UNPROVIDED, UNPROVIDED );
      }
      else if( NIL != cycl_variables.kb_variableP( v_term ) )
      {
        final SubLObject item_var = v_term;
        if( NIL == conses_high.member( item_var, ans, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
        {
      ...
      else if( NIL != collection_defns.el_variableP( v_term ) )
      {
        final SubLObject item_var = v_term;
        if( NIL == conses_high.member( item_var, ans, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
        {
      ...
      {
        el_utilities.el_error( FOUR_INTEGER, $str25$_S_is_not_well_formed_, literal, UNPROVIDED, UNPROVIDED );
      }
  ...
  public static SubLObject top_level_predicates_int(final SubLObject sentence)
  {
    ...
    if( NIL != el_utilities.cyc_const_logical_operator_p( truth_function ) )
    {
      SubLObject cdolist_list_var;
      final SubLObject args = cdolist_list_var = formula_args( sentence, $kw24$IGNORE );
    ...
    else if( NIL != fort_types_interface.predicateP( truth_function ) )
    {
  ...
  public static SubLObject containing_subexpressions(final SubLObject v_term, final SubLObject formula)
  {
    ...
    try
    {
      ...
      expressions = expression_gather( formula, $sym26$CONTAINING_SUBEXPRESSIONS_LAMBDA_FN, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
  ...
  public static SubLObject expression_contains_keywordp(final SubLObject formula, SubLObject penetrate_hl_structuresP)
  {
    ...
    return list_utilities.sublisp_boolean( expression_find_if( $sym27$KEYWORDP, formula, penetrate_hl_structuresP, UNPROVIDED ) );
  }
  ...
  {
    final SubLObject transformed_expression = Symbols.symbol_function( IDENTITY ).eql( key ) ? expression : Functions.funcall( key, expression );
  ...
  {
    if( NIL != Functions.funcall( test, v_object, Functions.funcall( key, expression ) ) )
    {
      return expression;
    }
    if( NIL != penetrate_hl_structuresP && NIL != hl_term_with_el_counterpart_p( expression ) )
  ...
  public static SubLObject expression_list_find(final SubLObject v_object, final SubLObject expression_list, SubLObject penetrate_hl_structuresP, SubLObject test, SubLObject key)
  {
    ...
    assert NIL != Types.listp( expression_list ) : expression_list;
    SubLObject cdolist_list_var = expression_list;
    SubLObject expression = NIL;
    expression = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
  ...
  public static SubLObject expression_ntransform_int(final SubLObject expression, final SubLObject pred, final SubLObject transform, final SubLObject transform_sequence_variablesP, final SubLObject transformation_limit,
      final SubLObject transformation_level, final SubLObject test_pred_on_transformation_resultP, final SubLObject negate_predP)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( transformation_level.numG( transformation_limit ) )
    {
      Dynamic.sublisp_throw( $kw10$TRANSFORMATION_LIMIT_EXCEEDED, transformation_limit );
    }
    ...
    if( NIL != test_pred_on_transformation_resultP )
    {
      ...
      if( !makeBoolean( NIL == negate_predP ).eql( makeBoolean( NIL == Functions.funcall( pred, transform_result ) ) ) )
      {
        transformed_expression = expression_ntransform_int( transform_result, pred, transform, transform_sequence_variablesP, transformation_limit, number_utilities.f_1X( transformation_level ),
            test_pred_on_transformation_resultP, negate_predP );
      }
      else
      {
    ...
    else if( !makeBoolean( NIL == negate_predP ).eql( makeBoolean( NIL == Functions.funcall( pred, expression ) ) ) )
    {
      final SubLObject transform_result = Functions.funcall( transform, expression );
    ...
    final SubLObject transformed_seqvar = ( NIL != possible_seqvar && NIL != cycl_variables.cyc_varP( possible_seqvar ) && NIL != transform_sequence_variablesP && NIL == opaque_seqvarP( transformed_expression ) )
        ? expression_ntransform_int( possible_seqvar, pred, transform, T, transformation_limit, number_utilities.f_1X( transformation_level ), test_pred_on_transformation_resultP, negate_predP )
        : NIL;
    final SubLObject new_seq_term = ( NIL != transformed_seqvar ) ? transformed_seqvar : possible_seqvar;
    final SubLObject ist_sentenceP = el_utilities.ist_sentence_p( transformed_expression, UNPROVIDED );
    ...
    for( argnum = ZERO_INTEGER; rest_of_expression.rest().isCons(); rest_of_expression = rest_of_expression.rest(), v_term = rest_of_expression.first(), argnum = Numbers.add( ONE_INTEGER, argnum ) )
    {
      ...
      try
      {
        ...
        {
          ConsesLow.rplaca( rest_of_expression, expression_ntransform_int( v_term, pred, transform, transform_sequence_variablesP, transformation_limit, number_utilities.f_1X( transformation_level ),
              test_pred_on_transformation_resultP, negate_predP ) );
  ...
  public static SubLObject formula_transform(final SubLObject formula, final SubLObject pred, final SubLObject transform, SubLObject transform_sequence_variablesP, SubLObject transformation_limit)
  {
    ...
    assert NIL != el_utilities.el_formula_p( formula ) : formula;
    return expression_ntransform_int( el_utilities.copy_formula( formula ), pred, transform, transform_sequence_variablesP, transformation_limit, ZERO_INTEGER, NIL, NIL );
  }
  ...
  public static SubLObject expression_transform_if(final SubLObject expression, final SubLObject pred, final SubLObject transform, SubLObject transform_sequence_variablesP, SubLObject transformation_limit)
  {
    ...
    return expression_ntransform_int( el_utilities.copy_expression( expression ), pred, transform, transform_sequence_variablesP, transformation_limit, ZERO_INTEGER, T, NIL );
  }
  ...
  public static SubLObject formula_transform_if(final SubLObject formula, final SubLObject pred, final SubLObject transform, SubLObject transform_sequence_variablesP, SubLObject transformation_limit)
  {
    ...
    assert NIL != el_utilities.el_formula_p( formula ) : formula;
    return expression_ntransform_int( el_utilities.copy_formula( formula ), pred, transform, transform_sequence_variablesP, transformation_limit, ZERO_INTEGER, T, NIL );
  }
  ...
  public static SubLObject expression_transform_if_not(final SubLObject expression, final SubLObject pred, final SubLObject transform, SubLObject transform_sequence_variablesP, SubLObject transformation_limit)
  {
    ...
    return expression_ntransform_int( el_utilities.copy_expression( expression ), pred, transform, transform_sequence_variablesP, transformation_limit, ZERO_INTEGER, T, T );
  }
  ...
  public static SubLObject formula_transform_if_not(final SubLObject formula, final SubLObject pred, final SubLObject transform, SubLObject transform_sequence_variablesP, SubLObject transformation_limit)
  {
    ...
    assert NIL != el_utilities.el_formula_p( formula ) : formula;
    return expression_ntransform_int( el_utilities.copy_formula( formula ), pred, transform, transform_sequence_variablesP, transformation_limit, ZERO_INTEGER, T, T );
  }
  ...
  public static SubLObject sentence_and_mt_transform(final SubLObject sentence, final SubLObject mt, final SubLObject pred, final SubLObject transform, SubLObject transform_sequence_variablesP,
  ...
  public static SubLObject sentence_and_mt_ntransform(final SubLObject sentence, final SubLObject mt, final SubLObject pred, final SubLObject transform, SubLObject transform_sequence_variablesP,
      SubLObject transformation_limit)
  {
    if( transform_sequence_variablesP == UNPROVIDED )
    {
    ...
    else
    {
      ...
      if( NIL != cycl_grammar.fast_quote_term_p( expression ) )
      {
        ...
        try
        {
          ...
          result = el_utilities.make_unary_formula( $const31$Quote, expression_nsubst_free_vars_int( v_new, old, formula_arg1( expression, UNPROVIDED ), test ) );
        }
        finally
        {
          czer_vars.$inside_quote$.rebind( _prev_bind_0, thread );
      ...
      if( NIL != el_utilities.expand_subl_fn_p( expression ) && NIL != subl_promotions.memberP( old, formula_arg1( expression, UNPROVIDED ), test, UNPROVIDED ) )
      {
        return el_utilities.make_binary_formula( $const32$ExpandSubLFn, conses_high.subst( v_new, old, formula_arg1( expression, UNPROVIDED ), test, UNPROVIDED ), expression_nsubst_free_vars_int( v_new, old,
            formula_arg2( expression, UNPROVIDED ), test ) );
      }
      final SubLObject seqvar = el_utilities.sequence_var( expression, UNPROVIDED );
  ...
  {
    if( NIL != Functions.funcall( test, Functions.funcall( key, expression ), old ) )
    {
      return v_new;
    }
    if( NIL == el_utilities.el_formula_p( expression ) )
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject oldXnew = conses_high.assoc( expression, alist, test, UNPROVIDED );
    if( NIL != oldXnew )
    {
      if( NIL != czer_vars.$inside_quote$.getDynamicValue( thread ) )
      {
    ...
    else
    {
      ...
      if( NIL != cycl_grammar.fast_quote_term_p( expression ) )
      {
        ...
        {
          czer_vars.$inside_quote$.bind( T, thread );
          result = el_utilities.make_unary_formula( $const31$Quote, expression_nsublis_free_vars_int( alist, formula_arg1( expression, UNPROVIDED ), test ) );
        }
        finally
        {
          czer_vars.$inside_quote$.rebind( _prev_bind_0, thread );
      ...
      if( NIL != el_utilities.expand_subl_fn_p( expression ) )
      {
        final SubLObject arg1 = formula_arg1( expression, UNPROVIDED );
        final SubLObject vars = expression_gather( arg1, Symbols.symbol_function( $sym35$CYC_VAR_ ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
        ...
        if( NIL != vars )
        {
          ...
          while ( NIL != cdolist_list_var)
          {
            final SubLObject oldXnew2 = conses_high.assoc( var, alist, test, UNPROVIDED );
            if( NIL != oldXnew2 )
            {
              non_opaque_var_list = ConsesLow.cons( oldXnew2, non_opaque_var_list );
            }
            cdolist_list_var = cdolist_list_var.rest();
            var = cdolist_list_var.first();
          }
          ...
          {
            expression = el_utilities.make_binary_formula( $const32$ExpandSubLFn, expression_nsublis_free_vars_int( alist, arg1, test ), expression_nsublis_free_vars_int( non_opaque_var_list, formula_arg2( expression,
                UNPROVIDED ), test ) );
          }
        }
        return expression;
  ...
  {
    final SubLObject oldXnew = conses_high.assoc( Functions.funcall( key, expression ), alist, test, UNPROVIDED );
    if( NIL != oldXnew )
    {
      return oldXnew.rest();
    }
  ...
  public static SubLObject expression_nsublis_el_variables(final SubLObject expression, final SubLObject el_variables)
  {
    ...
    for( n = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), el_var = list_var.first(), n = Numbers.add( ONE_INTEGER, n ) )
    {
      ...
      alist = ConsesLow.cons( ConsesLow.cons( variable, el_var ), alist );
    }
  ...
  public static SubLObject expression_nsublis_hl_variables(final SubLObject expression)
  {
    ...
    return Values.values( expression_nsublis( alist, expression, UNPROVIDED, UNPROVIDED ), alist );
  }
  ...
  public static SubLObject permute_formula(final SubLObject source_formula, final SubLObject argnums_to_permute, final SubLObject argnum_permutation)
  {
    ...
    for( index = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), target_argnum = list_var.first(), index = Numbers.add( ONE_INTEGER, index ) )
    {
  ...
  public static SubLObject formula_permutations(final SubLObject source_formula, final SubLObject argnums_to_permute)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      target_formulas = ConsesLow.cons( target_formula, target_formulas );
      cdolist_list_var = cdolist_list_var.rest();
      argnum_permutation = cdolist_list_var.first();
    }
  ...
  {
    SubLObject target_formulas = ConsesLow.list( el_utilities.copy_formula( source_formula ) );
    SubLObject argnum = ZERO_INTEGER;
    SubLObject cdolist_list_var;
    final SubLObject args = cdolist_list_var = formula_args( source_formula, $kw24$IGNORE );
    SubLObject arg = NIL;
    arg = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == el_utilities.subl_escape_p( arg ) )
      {
        if( NIL != term.nautP( arg, UNPROVIDED ) )
        {
          ...
          while ( NIL != cdolist_list_var_$8)
          {
            ...
            {
              target_formulas = ConsesLow.cons( el_utilities.nreplace_formula_arg( argnum, arg_permutation, el_utilities.copy_formula( source_formula ) ), target_formulas );
            }
        ...
        else if( NIL != el_utilities.el_relation_expressionP( arg ) )
        {
          ...
          while ( NIL != cdolist_list_var_$9)
          {
            ...
            {
              target_formulas = ConsesLow.cons( el_utilities.nreplace_formula_arg( argnum, formula_permutation, el_utilities.copy_formula( source_formula ) ), target_formulas );
            }
  ...
  public static SubLObject nat_commutative_permutations(final SubLObject nat)
  {
    ...
    if( NIL != czer_main.unary_function_commutes_with_its_argumentP( nat ) )
    {
      ...
      permutations = ConsesLow.cons( nat, permutations );
      permutations = ConsesLow.cons( el_utilities.make_unary_nat_formula( inner_func, el_utilities.make_unary_nat_formula( function, arg ) ), permutations );
    }
    else if( NIL != kb_accessors.commutative_functionP( function ) || NIL != fort_types_interface.partially_commutative_relation_p( function ) )
    {
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $permute_list_cached_caching_state$.getGlobalValue(), ConsesLow.list( list ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject permute_list_cached(final SubLObject list)
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym37$PERMUTE_LIST_CACHED, $sym38$_PERMUTE_LIST_CACHED_CACHING_STATE_, NIL, EQUAL, ONE_INTEGER, ZERO_INTEGER );
    }
    ...
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( permute_list_cached_internal( list ) ) );
  ...
  public static SubLObject formula_commutative_permutations(final SubLObject formula, SubLObject penetrate_argsP)
  {
    ...
    SubLObject target_formulas = ( NIL != penetrate_argsP ) ? formula_arg_permutations( formula ) : ConsesLow.list( formula );
  ...
  public static SubLObject canonical_commutative_permutations(final SubLObject formula, SubLObject varP, SubLObject penetrate_argsP)
  {
    if( varP == UNPROVIDED )
    {
      varP = Symbols.symbol_function( $sym35$CYC_VAR_ );
    }
    if( penetrate_argsP == UNPROVIDED )
    {
      penetrate_argsP = NIL;
    ...
    {
      return ConsesLow.list( czer_main.canonicalize_literal_commutative_terms( formula ) );
    }
    final SubLObject variable_argnums = variable_argnums( formula, varP );
    SubLObject target_formulas = NIL;
    if( NIL == penetrate_argsP && NIL == variable_argnums )
    {
      target_formulas = ConsesLow.list( czer_main.canonicalize_literal_commutative_args( formula ) );
      return target_formulas;
    }
    if( NIL != penetrate_argsP && NIL == variable_argnums )
    {
  ...
  public static SubLObject variable_argnums(final SubLObject formula, SubLObject varP)
  {
    ...
    SubLObject argnum = ZERO_INTEGER;
    SubLObject cdolist_list_var;
    final SubLObject args = cdolist_list_var = formula_args( formula, $kw24$IGNORE );
    SubLObject arg = NIL;
    arg = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
  ...
  {
    SubLObject target_formulas = ConsesLow.list( el_utilities.copy_formula( formula ) );
    SubLObject argnum = ZERO_INTEGER;
    SubLObject cdolist_list_var;
    final SubLObject args = cdolist_list_var = formula_args( formula, $kw24$IGNORE );
    SubLObject arg = NIL;
      ...
      if( NIL == el_utilities.subl_escape_p( arg ) )
      {
        if( NIL != term.nautP( arg, varP ) )
        {
          ...
          while ( NIL != cdolist_list_var_$10)
          {
            if( !arg_permutation.equal( arg ) )
            {
              target_formulas = ConsesLow.cons( el_utilities.nreplace_formula_arg( argnum, arg_permutation, el_utilities.copy_formula( formula ) ), target_formulas );
            }
        ...
        else if( NIL != el_utilities.el_relation_expressionP( arg ) )
        {
          ...
          while ( NIL != cdolist_list_var_$11)
          {
            if( !formula_permutation.equal( arg ) )
            {
              target_formulas = ConsesLow.cons( el_utilities.nreplace_formula_arg( argnum, formula_permutation, el_utilities.copy_formula( formula ) ), target_formulas );
            }
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      while ( NIL != cdolist_list_var_$12)
      {
        ...
        if( NIL != argnums_to_permute )
        {
          ...
          {
            target_formulas = ConsesLow.cons( canonical_permute_formula( source_formula, commutative_argnums, argnum_permutation ), target_formulas );
        ...
        {
          target_formulas = ConsesLow.cons( source_formula, target_formulas );
        }
  ...
  public static SubLObject canonical_permute_formula(final SubLObject source_formula, final SubLObject argnums_to_permute, final SubLObject argnum_permutation)
  {
    ...
    for( index = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), source_argnum = list_var.first(), index = Numbers.add( ONE_INTEGER, index ) )
    {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject splits = ConsesLow.list( reader.bq_cons( l, $list39 ) );
    SubLObject end_var;
    SubLObject length;
    SubLObject i;
    SubLObject list1;
    SubLObject list2;
    for( length = ( end_var = Sequences.length( l ) ), i = NIL, i = ONE_INTEGER; !i.numGE( end_var ); i = number_utilities.f_1X( i ) )
    {
      thread.resetMultipleValues();
      list1 = list_utilities.split_list( l, i );
      list2 = thread.secondMultipleValue();
      thread.resetMultipleValues();
      splits = ConsesLow.cons( ConsesLow.list( list1, list2 ), splits );
    }
    return splits;
  }
      ...
      if( NIL == current )
      {
        ...
        while ( NIL != cdolist_list_var_$14)
        {
          ...
          while ( NIL != cdolist_list_var_$15)
          {
            ...
            if( NIL == current_$17 )
            {
              merged = ConsesLow.cons( ConsesLow.append( front1, front2, rest1, rest2 ), merged );
              merged = ConsesLow.cons( ConsesLow.append( front2, front1, rest2, rest1 ), merged );
            }
            else
            {
  ...
  public static SubLObject formula_operator_recursive(final SubLObject formula)
  {
    ...
    if( NIL != el_utilities.el_formula_p( result ) )
    {
  ...
  {
    final SubLObject default_el_vars = clausifier.sort_vars( expression_gather( expression, Symbols.symbol_function( $sym42$DEFAULT_EL_VAR_ ), NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    final SubLObject already_renamed_default_el_vars = clausifier.sort_vars( expression_gather( expression, Symbols.symbol_function( $sym43$RENAMED_DEFAULT_EL_VAR_P ), NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    ...
    while ( NIL != cdolist_list_var)
    {
      alist = ConsesLow.cons( ConsesLow.cons( var, get_renamed_default_el_var( curr_renamed_default_el_var_num ) ), alist );
      curr_renamed_default_el_var_num = Numbers.add( curr_renamed_default_el_var_num, ONE_INTEGER );
      cdolist_list_var = cdolist_list_var.rest();
      var = cdolist_list_var.first();
    }
  ...
  {
    final SubLObject renamed_default_el_vars = clausifier.sort_vars( expression_gather( expression, Symbols.symbol_function( $sym43$RENAMED_DEFAULT_EL_VAR_P ), NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    final SubLObject default_el_vars = clausifier.sort_vars( expression_gather( expression, Symbols.symbol_function( $sym42$DEFAULT_EL_VAR_ ), NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    ...
    while ( NIL != cdolist_list_var)
    {
      alist = ConsesLow.cons( ConsesLow.cons( var, variables.get_default_el_var( curr_default_el_var_num ) ), alist );
      curr_default_el_var_num = Numbers.add( curr_default_el_var_num, ONE_INTEGER );
      cdolist_list_var = cdolist_list_var.rest();
      var = cdolist_list_var.first();
    }
    return ( NIL != destructiveP ) ? expression_nsublis( alist, expression, UNPROVIDED, UNPROVIDED ) : expression_sublis( alist, expression, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject renamed_default_el_var_num(final SubLObject v_object)
  {
    ...
    if( NIL != cycl_variables.el_varP( v_object ) )
    {
      ...
      {
        final SubLObject tail = string_utilities.substring( name, Sequences.length( $renamed_default_el_var_prefix$.getDynamicValue( thread ) ), UNPROVIDED );
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return cycl_variables.make_el_var( Sequences.cconcatenate( $renamed_default_el_var_prefix$.getDynamicValue( thread ), string_utilities.object_to_string( num ) ) );
  }
  ...
  public static SubLObject non_indexed_fort_p(final SubLObject fort)
  {
    ...
    return subl_promotions.memberP( fort, $non_indexed_constants$.getGlobalValue(), Symbols.symbol_function( $sym45$KBEQ ), UNPROVIDED );
  }
  ...
  {
    return makeBoolean( NIL != forts.fort_p( v_object ) || ( NIL != el_utilities.possibly_naut_p( v_object ) && NIL != fort_types_interface.functorP( nat_functor( v_object ) ) ) );
  }
  ...
  {
    return expression_transform( v_object, $sym23$NART_P, $sym46$NART_EL_FORMULA, UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject collection_intersection_natP(final SubLObject v_object)
  {
    if( NIL != cycl_grammar.cycl_nat_p( v_object ) )
    {
      ...
      return makeBoolean( functor.eql( $const47$CollectionIntersectionFn ) || functor.eql( $const48$CollectionIntersection2Fn ) );
    }
    return NIL;
  }
  ...
  {
    return cycl_nat_with_functor_p( v_object, $const49$CollectionUnionFn );
  }
  ...
  public static SubLObject collection_intersection(final SubLObject collections)
  {
    ...
    return ConsesLow.list( $const47$CollectionIntersectionFn, ConsesLow.cons( $const50$TheSet, collections ) );
  }
  ...
  public static SubLObject collection_union(final SubLObject collections)
  {
    ...
    return ConsesLow.list( $const49$CollectionUnionFn, ConsesLow.cons( $const50$TheSet, collections ) );
  }
  ...
  {
    assert NIL != collection_intersection_natP( collection_intersection_nat ) : collection_intersection_nat;
    final SubLObject pcase_var = nat_functor( collection_intersection_nat );
    if( pcase_var.eql( $const47$CollectionIntersectionFn ) )
    {
      return quantities.set_extent( nat_arg1( collection_intersection_nat, UNPROVIDED ), UNPROVIDED, UNPROVIDED );
    }
    if( pcase_var.eql( $const48$CollectionIntersection2Fn ) )
    {
  ...
  {
    assert NIL != collection_union_natP( collection_union_nat ) : collection_union_nat;
  ...
  public static SubLObject find_denotational_term(final SubLObject string)
  {
    ...
    try
    {
      ...
      final SubLObject clipped_string = ( NIL != list_utilities.lengthG( string, $int53$5000, UNPROVIDED ) ) ? Sequences.subseq( string, ZERO_INTEGER, $int53$5000 ) : string;
      final SubLObject v_term = reader.read_from_string_ignoring_errors( string_utilities.cyclify_string( clipped_string ), NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  {
    if( NIL != constant_handles.constant_p( cycl ) )
    {
  ...
  {
    return Sort.sort( constant_list( expression, NIL ), Symbols.symbol_function( $sym58$CONSTANT_EXTERNAL_ID__ ), UNPROVIDED );
  }
  ...
  {
    return Sort.sort( Mapping.mapcar( Symbols.symbol_function( $sym59$CONSTANT_EXTERNAL_ID ), constant_list( expression, NIL ) ), Symbols.symbol_function( $sym60$GUID_ ), UNPROVIDED );
  }
  ...
  {
    return Sort.sort( Mapping.mapcar( Symbols.symbol_function( $sym61$CONSTANT_INTERNAL_ID ), constant_list( expression, NIL ) ), Symbols.symbol_function( $sym62$_ ), UNPROVIDED );
  }
  ...
  public static SubLObject constant_list(final SubLObject expression, SubLObject penetrate_hl_structuresP)
  {
    ...
    return expression_gather( expression, Symbols.symbol_function( $sym22$CONSTANT_P ), penetrate_hl_structuresP, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return Sort.sort( nat_list( expression ), Symbols.symbol_function( $sym62$_ ), Symbols.symbol_function( $sym63$NART_ID ) );
  }
  ...
  {
    return expression_gather( expression, Symbols.symbol_function( $sym23$NART_P ), T, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return expression_gather( expression, Symbols.symbol_function( $sym18$ASSERTION_P ), T, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return Sort.sort( Mapping.mapcar( Symbols.symbol_function( $sym64$FORT_INTERNAL_ID ), list_utilities.tree_gather( expression, Symbols.symbol_function( $sym21$FORT_P ), UNPROVIDED, UNPROVIDED, UNPROVIDED ) ), Symbols
        .symbol_function( $sym62$_ ), UNPROVIDED );
  }
  ...
  {
    assert NIL != somewhere_cache.valid_somewhere_cache_itemP( pred ) : pred;
    return makeBoolean( NIL != somewhere_cache.some_pred_assertion_somewhereP( $const66$functionalInArgs, pred, ONE_INTEGER, UNPROVIDED ) || NIL != somewhere_cache.some_pred_assertion_somewhereP(
        $const67$strictlyFunctionalInArgs, pred, ONE_INTEGER, UNPROVIDED ) );
  }
  ...
  public static SubLObject functional_in_arg_positions_internal(final SubLObject pred, SubLObject assume_pred_has_functional_argsP)
  {
    ...
    assert NIL != kb_indexing_datastructures.indexed_term_p( pred ) : pred;
    ...
    {
      return list_utilities.fast_delete_duplicates( ConsesLow.append( kb_mapping_utilities.pred_values_in_any_mt( pred, $const66$functionalInArgs, UNPROVIDED, UNPROVIDED, UNPROVIDED ), kb_mapping_utilities
          .pred_values_in_any_mt( pred, $const67$strictlyFunctionalInArgs, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject functional_in_arg_positions(final SubLObject pred, SubLObject assume_pred_has_functional_argsP)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym68$FUNCTIONAL_IN_ARG_POSITIONS, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym68$FUNCTIONAL_IN_ARG_POSITIONS, TWO_INTEGER, $int70$100, EQL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym68$FUNCTIONAL_IN_ARG_POSITIONS, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( functional_in_arg_positions_internal( pred, assume_pred_has_functional_argsP ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( pred, assume_pred_has_functional_argsP ) );
  ...
  {
    assert NIL != somewhere_cache.valid_somewhere_cache_itemP( pred ) : pred;
    return somewhere_cache.some_pred_assertion_somewhereP( $const67$strictlyFunctionalInArgs, pred, ONE_INTEGER, UNPROVIDED );
  }
  ...
  public static SubLObject strictly_functional_in_arg_positions_internal(final SubLObject pred, SubLObject assume_pred_has_functional_argsP)
  {
    ...
    if( NIL != forts.fort_p( pred ) )
    {
      return list_utilities.fast_delete_duplicates( kb_mapping_utilities.pred_values_in_any_mt( pred, $const67$strictlyFunctionalInArgs, UNPROVIDED, UNPROVIDED, UNPROVIDED ), UNPROVIDED, UNPROVIDED, UNPROVIDED,
          UNPROVIDED, UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject strictly_functional_in_arg_positions(final SubLObject pred, SubLObject assume_pred_has_functional_argsP)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym71$STRICTLY_FUNCTIONAL_IN_ARG_POSITIONS, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym71$STRICTLY_FUNCTIONAL_IN_ARG_POSITIONS, TWO_INTEGER, $int70$100, EQL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym71$STRICTLY_FUNCTIONAL_IN_ARG_POSITIONS, caching_state );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_2( pred, assume_pred_has_functional_argsP );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    if( !collisions.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( strictly_functional_in_arg_positions_internal( pred, assume_pred_has_functional_argsP ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( pred, assume_pred_has_functional_argsP ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject lookup_all_narts(final SubLObject expression)
  {
    ...
    try
    {
      ...
      result = expression_transform_if( expression, Symbols.symbol_function( $sym23$NART_P ), $sym73$NART_LOOKUP, NIL, UNPROVIDED );
    }
    finally
    {
  ...
  public static SubLObject reify_all_existing_narts(final SubLObject expression)
  {
    ...
    {
      $opaque_arg_function$.bind( $sym72$OPAQUE_ARG_WRT_NAT_REIFICATION_, thread );
      result = expression_transform_if_not( expression, Symbols.symbol_function( $sym74$NULL ), $sym75$EL_FIND_IF_NART, NIL, UNPROVIDED );
    }
    finally
    {
      $opaque_arg_function$.rebind( _prev_bind_0, thread );
  ...
  {
    return makeBoolean( NIL != default_opaque_argP( formula, argnum ) || NIL != el_utilities.arg_types_of_expression_prescribe_unreifiedP( formula, argnum ) );
  }
  ...
  public static SubLObject reify_when_closed_naut(final SubLObject v_object)
  {
    ...
    {
      if( NIL != el_utilities.el_formulaP( v_object ) )
      {
        SubLObject result = NIL;
        SubLObject cdotimes_end_var;
        SubLObject psn;
        for( cdotimes_end_var = el_utilities.formula_length( v_object, $kw24$IGNORE ), psn = NIL, psn = ZERO_INTEGER; psn.numL( cdotimes_end_var ); psn = Numbers.add( psn, ONE_INTEGER ) )
        {
          result = ConsesLow.cons( reify_arg_when_closed_naut( v_object, psn ), result );
        }
        return Sequences.nreverse( result );
      }
      return v_object;
  ...
  {
    return el_utilities.groundP( hl_formula, Symbols.symbol_function( $sym76$VARIABLE_P ) );
  }
  ...
  {
    return makeBoolean( NIL != el_utilities.possibly_atomic_sentence_p( asent ) && NIL != kb_utilities.kbeq( pred, atomic_sentence_predicate( asent ) ) );
  }
  ...
  {
    return makeBoolean( NIL != el_utilities.possibly_atomic_sentence_p( asent ) && NIL != list_utilities.member_kbeqP( atomic_sentence_predicate( asent ), preds ) );
  }
  ...
  {
    return makeBoolean( NIL == v_object || NIL != kb_utilities.kbeq( $const77$False, v_object ) );
  }
  ...
  {
    return makeBoolean( NIL != el_utilities.el_formula_p( v_object ) || NIL != nart_handles.nart_p( v_object ) || NIL != assertion_handles.assertion_p( v_object ) );
  }
  ...
  {
    return makeBoolean( v_object.isCons() && v_object.first().eql( $const78$not ) && Sequences.length( v_object ).numE( TWO_INTEGER ) );
  }
  ...
  {
    enforceType( form, $sym83$POSSIBLY_SENTENCE_OR_VARIABLE_P );
    if( NIL != negatedP( form ) )
    {
      return formula_arg1( form, UNPROVIDED );
    }
    return ConsesLow.list( $const78$not, form );
  }
  ...
  public static SubLObject formula_arg(final SubLObject formula, final SubLObject argnum, SubLObject seqvar_handling)
  {
    ...
    {
      return conses_high.copy_tree( el_formula_arg( assertions_high.gaf_el_formula( formula ), argnum, UNPROVIDED ) );
    }
  ...
  public static SubLObject el_formula_arg(final SubLObject el_formula, final SubLObject argnum, SubLObject seqvar_handling)
  {
    ...
    assert NIL != el_utilities.el_formula_p( el_formula ) : el_formula;
  ...
  {
    return Equality.equal( v_term, el_formula_arg( el_formula, argnum, UNPROVIDED ) );
  }
  ...
  {
    assert NIL != cycl_grammar.cycl_sentence_p( cycl_sentence ) : cycl_sentence;
  ...
  public static SubLObject formula_terms_int_one_pass(final SubLObject formula, final SubLObject seqvar_handling)
  {
    ...
    if( formula.isCons() )
    {
      ...
      if( NIL != consP )
      {
        return subl_promotions.values2( ConsesLow.cons( formula.first(), subformula ), T );
      }
    ...
    else
    {
      ...
      {
        el_utilities.el_error( THREE_INTEGER, $str97$formula_terms_int_got_a_non_el_va, formula, UNPROVIDED, UNPROVIDED );
        return subl_promotions.values2( NIL, T );
      }
      if( seqvar_handling.eql( $kw24$IGNORE ) )
      {
        return subl_promotions.values2( NIL, T );
      }
      if( seqvar_handling.eql( $kw17$REGULARIZE ) )
      {
        return subl_promotions.values2( ConsesLow.list( formula ), T );
      }
      if( seqvar_handling.eql( $kw96$INCLUDE ) )
      {
        return subl_promotions.values2( formula, NIL );
      }
      return subl_promotions.values2( NIL, T );
  ...
  public static SubLObject el_formula_arg_positions(final SubLObject el_formula, final SubLObject arg, SubLObject test)
  {
    ...
    assert NIL != el_utilities.el_formula_p( el_formula ) : el_formula;
    SubLObject result = NIL;
    final SubLObject terms = formula_terms( el_formula, $kw24$IGNORE );
    SubLObject list_var = NIL;
    SubLObject v_term = NIL;
    SubLObject argnum = NIL;
    list_var = terms;
    ...
    for( argnum = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), v_term = list_var.first(), argnum = number_utilities.f_1X( argnum ) )
    {
      if( NIL != Functions.funcall( test, v_term, arg ) )
      {
  ...
  public static SubLObject possibly_conjuncts(final SubLObject el_formula)
  {
    ...
    return ConsesLow.list( el_formula );
  }
  ...
  public static SubLObject naut_args(final SubLObject naut, SubLObject seqvar_handling)
  {
    ...
    assert NIL != el_utilities.possibly_naut_p( naut ) : naut;
  ...
  {
    return makeBoolean( NIL != el_utilities.possibly_nat_p( v_object ) && nat_functor( v_object ).eql( functor ) );
  }
  ...
  {
    return list_utilities.non_empty_list_of_type_p( Symbols.symbol_function( $sym106$FIXNUMP ), v_object );
  }
  ...
  {
    assert NIL != el_utilities.el_formula_p( formula ) : formula;
    for( SubLObject argpos = arg_position; NIL != argpos; argpos = conses_high.butlast( argpos, UNPROVIDED ) )
    {
  ...
  {
    return makeBoolean( NIL != el_utilities.el_formula_with_operator_p( v_object, $const107$FormulaArgPositionFn ) && NIL != arg_position_p( formula_args( v_object, UNPROVIDED ) ) );
  }
  ...
  {
    assert NIL != arg_position_p( arg_position ) : arg_position;
    return el_utilities.make_el_formula( $const107$FormulaArgPositionFn, arg_position, UNPROVIDED );
  }
  ...
  {
    assert NIL != cycl_arg_position_p( cycl_arg_position ) : cycl_arg_position;
  ...
  public static SubLObject formula_cycl_arg_position(final SubLObject formula, final SubLObject argpos, SubLObject v_default)
  {
    ...
    assert NIL != el_utilities.el_formula_p( formula ) : formula;
    assert NIL != cycl_arg_position_p( argpos ) : argpos;
  ...
  public static SubLObject substitute_terms_into_positions(final SubLObject terms, final SubLObject arg_positions, final SubLObject formula)
  {
    ...
    assert NIL != list_utilities.non_dotted_list_p( arg_positions ) : arg_positions;
    SubLObject cdolist_list_var = arg_positions;
    SubLObject elem = NIL;
    elem = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      assert NIL != cycl_arg_position_p( elem ) : elem;
      cdolist_list_var = cdolist_list_var.rest();
      elem = cdolist_list_var.first();
    }
    assert NIL != el_utilities.el_formula_p( formula ) : formula;
  ...
  {
    SubLFiles.declareMacro( me, "with_opaque_arg_function", "WITH-OPAQUE-ARG-FUNCTION" );
    SubLFiles.declareMacro( me, "with_opaque_seqvar_function", "WITH-OPAQUE-SEQVAR-FUNCTION" );
    SubLFiles.declareFunction( me, "maybe_some_opaque_argP", "MAYBE-SOME-OPAQUE-ARG?", 1, 0, false );
    SubLFiles.declareFunction( me, "opaque_argP", "OPAQUE-ARG?", 2, 0, false );
    SubLFiles.declareFunction( me, "opaque_argP_int", "OPAQUE-ARG?-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "opaque_seqvarP", "OPAQUE-SEQVAR?", 1, 0, false );
    SubLFiles.declareFunction( me, "default_opaque_argP", "DEFAULT-OPAQUE-ARG?", 2, 0, false );
    SubLFiles.declareFunction( me, "opaque_arg_wrt_free_varsP", "OPAQUE-ARG-WRT-FREE-VARS?", 2, 0, false );
    SubLFiles.declareFunction( me, "opaque_arg_wrt_el_templateP", "OPAQUE-ARG-WRT-EL-TEMPLATE?", 2, 0, false );
    SubLFiles.declareFunction( me, "opaque_arg_wrt_quotingP", "OPAQUE-ARG-WRT-QUOTING?", 2, 0, false );
    new $opaque_arg_wrt_quotingP$BinaryFunction();
    SubLFiles.declareFunction( me, "opaque_arg_wrt_quoting_not_counting_logical_opsP", "OPAQUE-ARG-WRT-QUOTING-NOT-COUNTING-LOGICAL-OPS?", 2, 0, false );
    SubLFiles.declareFunction( me, "opaque_arg_wrt_quoteP", "OPAQUE-ARG-WRT-QUOTE?", 2, 0, false );
    SubLFiles.declareFunction( me, "opaque_arg_wrt_el_template_or_quoteP", "OPAQUE-ARG-WRT-EL-TEMPLATE-OR-QUOTE?", 2, 0, false );
    SubLFiles.declareFunction( me, "opaque_arg_wrt_skolemP", "OPAQUE-ARG-WRT-SKOLEM?", 2, 0, false );
    SubLFiles.declareFunction( me, "default_opaque_seqvarP", "DEFAULT-OPAQUE-SEQVAR?", 1, 0, false );
    SubLFiles.declareFunction( me, "hl_term_with_el_counterpart_p", "HL-TERM-WITH-EL-COUNTERPART-P", 1, 0, false );
    new $hl_term_with_el_counterpart_p$UnaryFunction();
    SubLFiles.declareFunction( me, "hl_term_to_el_term", "HL-TERM-TO-EL-TERM", 1, 0, false );
    new $hl_term_to_el_term$UnaryFunction();
    SubLFiles.declareFunction( me, "careful_hl_term_to_el_term", "CAREFUL-HL-TERM-TO-EL-TERM", 1, 0, false );
    SubLFiles.declareFunction( me, "hl_to_el", "HL-TO-EL", 1, 0, false );
    SubLFiles.declareFunction( me, "hl_to_el_destructive", "HL-TO-EL-DESTRUCTIVE", 1, 0, false );
    SubLFiles.declareFunction( me, "hl_to_el_preserve_el_vars", "HL-TO-EL-PRESERVE-EL-VARS", 1, 0, false );
    SubLFiles.declareFunction( me, "binding_lists_hl_to_el", "BINDING-LISTS-HL-TO-EL", 1, 0, false );
    SubLFiles.declareFunction( me, "transform_hl_to_el", "TRANSFORM-HL-TO-EL", 1, 0, false );
    SubLFiles.declareFunction( me, "reified_term_p", "REIFIED-TERM-P", 1, 0, false );
    SubLFiles.declareFunction( me, "atomic_reified_term_p", "ATOMIC-REIFIED-TERM-P", 1, 0, false );
    SubLFiles.declareFunction( me, "reified_formula_p", "REIFIED-FORMULA-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rf_p", "RF-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rf_type", "RF-TYPE", 1, 0, false );
    SubLFiles.declareFunction( me, "rf_raw_id", "RF-RAW-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "rf_id", "RF-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "find_rf_by_id", "FIND-RF-BY-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "find_rf", "FIND-RF", 1, 0, false );
    SubLFiles.declareFunction( me, "robustly_find_rf", "ROBUSTLY-FIND-RF", 1, 0, false );
    SubLFiles.declareFunction( me, "rf_formula", "RF-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( me, "rf_expand", "RF-EXPAND", 1, 0, false );
    SubLFiles.declareFunction( me, "rf_narts", "RF-NARTS", 1, 1, false );
    SubLFiles.declareFunction( me, "rf_assertions", "RF-ASSERTIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "wf_rf_syntaxP", "WF-RF-SYNTAX?", 1, 0, false );
    SubLFiles.declareFunction( me, "valid_rfP", "VALID-RF?", 1, 0, false );
    SubLFiles.declareFunction( me, "all_rfs", "ALL-RFS", 0, 0, false );
    SubLFiles.declareFunction( me, "unreify_rfs", "UNREIFY-RFS", 1, 0, false );
    SubLFiles.declareFunction( me, "rf_count", "RF-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "subrfs", "SUBRFS", 2, 0, false );
    SubLFiles.declareFunction( me, "super_rfs", "SUPER-RFS", 1, 0, false );
    SubLFiles.declareFunction( me, "inclusive_subrfs", "INCLUSIVE-SUBRFS", 1, 0, false );
    SubLFiles.declareFunction( me, "expression_gather_int_2", "EXPRESSION-GATHER-INT-2", 5, 0, false );
    SubLFiles.declareFunction( me, "expression_gather_int", "EXPRESSION-GATHER-INT", 6, 0, false );
    SubLFiles.declareFunction( me, "expression_gather_with_duplicates", "EXPRESSION-GATHER-WITH-DUPLICATES", 2, 4, false );
    SubLFiles.declareFunction( me, "expression_gather", "EXPRESSION-GATHER", 2, 4, false );
    SubLFiles.declareFunction( me, "assertion_gather", "ASSERTION-GATHER", 2, 4, false );
    SubLFiles.declareFunction( me, "expression_count", "EXPRESSION-COUNT", 2, 3, false );
    SubLFiles.declareFunction( me, "expression_count_helper", "EXPRESSION-COUNT-HELPER", 1, 0, false );
    SubLFiles.declareFunction( me, "expression_list_gather", "EXPRESSION-LIST-GATHER", 2, 4, false );
    SubLFiles.declareFunction( me, "formula_gather", "FORMULA-GATHER", 2, 4, false );
    SubLFiles.declareFunction( me, "expression_forts", "EXPRESSION-FORTS", 1, 3, false );
    SubLFiles.declareFunction( me, "expression_list_forts", "EXPRESSION-LIST-FORTS", 1, 2, false );
    SubLFiles.declareFunction( me, "formula_forts", "FORMULA-FORTS", 1, 3, false );
    SubLFiles.declareFunction( me, "expression_constants", "EXPRESSION-CONSTANTS", 1, 1, false );
    SubLFiles.declareFunction( me, "expression_list_constants", "EXPRESSION-LIST-CONSTANTS", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_constants", "FORMULA-CONSTANTS", 1, 1, false );
    SubLFiles.declareFunction( me, "expression_narts", "EXPRESSION-NARTS", 1, 2, false );
    SubLFiles.declareFunction( me, "expression_list_narts", "EXPRESSION-LIST-NARTS", 1, 2, false );
    SubLFiles.declareFunction( me, "formula_narts", "FORMULA-NARTS", 1, 2, false );
    SubLFiles.declareFunction( me, "expression_sub_assertions", "EXPRESSION-SUB-ASSERTIONS", 1, 2, false );
    SubLFiles.declareFunction( me, "expression_list_sub_assertions", "EXPRESSION-LIST-SUB-ASSERTIONS", 1, 2, false );
    SubLFiles.declareFunction( me, "formula_sub_assertions", "FORMULA-SUB-ASSERTIONS", 1, 2, false );
    SubLFiles.declareFunction( me, "assertion_sub_assertions", "ASSERTION-SUB-ASSERTIONS", 1, 2, false );
    SubLFiles.declareFunction( me, "nart_sub_assertions", "NART-SUB-ASSERTIONS", 1, 2, false );
    SubLFiles.declareFunction( me, "subnarts", "SUBNARTS", 1, 2, false );
    SubLFiles.declareFunction( me, "all_formula_terms", "ALL-FORMULA-TERMS", 1, 1, false );
    SubLFiles.declareFunction( me, "all_literal_terms", "ALL-LITERAL-TERMS", 1, 1, false );
    SubLFiles.declareFunction( me, "top_level_predicates", "TOP-LEVEL-PREDICATES", 1, 1, false );
    SubLFiles.declareFunction( me, "top_level_predicates_int", "TOP-LEVEL-PREDICATES-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "containing_subexpressions", "CONTAINING-SUBEXPRESSIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "containing_subexpressions_lambda_fn", "CONTAINING-SUBEXPRESSIONS-LAMBDA-FN", 1, 0, false );
    SubLFiles.declareFunction( me, "expression_contains_keywordp", "EXPRESSION-CONTAINS-KEYWORDP", 1, 1, false );
    SubLFiles.declareFunction( me, "expression_find_if_int", "EXPRESSION-FIND-IF-INT", 4, 0, false );
    SubLFiles.declareFunction( me, "expression_find_if", "EXPRESSION-FIND-IF", 2, 2, false );
    SubLFiles.declareFunction( me, "formula_find_if", "FORMULA-FIND-IF", 2, 2, false );
    SubLFiles.declareFunction( me, "assertion_find_if", "ASSERTION-FIND-IF", 2, 2, false );
    SubLFiles.declareFunction( me, "nart_find_if", "NART-FIND-IF", 2, 2, false );
    SubLFiles.declareFunction( me, "expression_find_int", "EXPRESSION-FIND-INT", 5, 0, false );
    SubLFiles.declareFunction( me, "expression_find", "EXPRESSION-FIND", 2, 3, false );
    SubLFiles.declareFunction( me, "formula_find", "FORMULA-FIND", 2, 3, false );
    SubLFiles.declareFunction( me, "assertion_find", "ASSERTION-FIND", 2, 3, false );
    SubLFiles.declareFunction( me, "nart_find", "NART-FIND", 2, 3, false );
    SubLFiles.declareFunction( me, "expression_list_find", "EXPRESSION-LIST-FIND", 2, 3, false );
    SubLFiles.declareFunction( me, "remove_if_not_in_expression", "REMOVE-IF-NOT-IN-EXPRESSION", 2, 3, false );
    SubLFiles.declareFunction( me, "expression_find_any", "EXPRESSION-FIND-ANY", 2, 3, false );
    SubLFiles.declareFunction( me, "expression_map_int", "EXPRESSION-MAP-INT", 4, 0, false );
    SubLFiles.declareFunction( me, "expression_map", "EXPRESSION-MAP", 2, 2, false );
    SubLFiles.declareFunction( me, "formula_map", "FORMULA-MAP", 2, 2, false );
    SubLFiles.declareFunction( me, "assertion_map", "ASSERTION-MAP", 2, 2, false );
    SubLFiles.declareFunction( me, "nart_map", "NART-MAP", 2, 2, false );
    SubLFiles.declareFunction( me, "expression_ntransform_int", "EXPRESSION-NTRANSFORM-INT", 8, 0, false );
    SubLFiles.declareFunction( me, "expression_transform", "EXPRESSION-TRANSFORM", 3, 2, false );
    SubLFiles.declareFunction( me, "expression_ntransform", "EXPRESSION-NTRANSFORM", 3, 2, false );
    SubLFiles.declareFunction( me, "formula_transform", "FORMULA-TRANSFORM", 3, 2, false );
    SubLFiles.declareFunction( me, "formula_ntransform", "FORMULA-NTRANSFORM", 3, 2, false );
    SubLFiles.declareFunction( me, "expression_transform_if", "EXPRESSION-TRANSFORM-IF", 3, 2, false );
    SubLFiles.declareFunction( me, "expression_ntransform_if", "EXPRESSION-NTRANSFORM-IF", 3, 2, false );
    SubLFiles.declareFunction( me, "formula_transform_if", "FORMULA-TRANSFORM-IF", 3, 2, false );
    SubLFiles.declareFunction( me, "formula_ntransform_if", "FORMULA-NTRANSFORM-IF", 3, 2, false );
    SubLFiles.declareFunction( me, "expression_transform_if_not", "EXPRESSION-TRANSFORM-IF-NOT", 3, 2, false );
    SubLFiles.declareFunction( me, "expression_ntransform_if_not", "EXPRESSION-NTRANSFORM-IF-NOT", 3, 2, false );
    SubLFiles.declareFunction( me, "formula_transform_if_not", "FORMULA-TRANSFORM-IF-NOT", 3, 2, false );
    SubLFiles.declareFunction( me, "formula_ntransform_if_not", "FORMULA-NTRANSFORM-IF-NOT", 3, 2, false );
    SubLFiles.declareFunction( me, "formula_and_mt_transform", "FORMULA-AND-MT-TRANSFORM", 4, 2, false );
    SubLFiles.declareFunction( me, "formula_and_mt_ntransform", "FORMULA-AND-MT-NTRANSFORM", 4, 2, false );
    SubLFiles.declareFunction( me, "sentence_and_mt_transform", "SENTENCE-AND-MT-TRANSFORM", 4, 2, false );
    SubLFiles.declareFunction( me, "sentence_and_mt_ntransform", "SENTENCE-AND-MT-NTRANSFORM", 4, 2, false );
    SubLFiles.declareFunction( me, "expression_nsubst_free_vars_int", "EXPRESSION-NSUBST-FREE-VARS-INT", 4, 0, false );
    SubLFiles.declareFunction( me, "expression_nsubst_free_vars", "EXPRESSION-NSUBST-FREE-VARS", 3, 1, false );
    SubLFiles.declareFunction( me, "expression_nsubst_int", "EXPRESSION-NSUBST-INT", 5, 0, false );
    SubLFiles.declareFunction( me, "expression_subst", "EXPRESSION-SUBST", 3, 2, false );
    SubLFiles.declareFunction( me, "expression_nsubst", "EXPRESSION-NSUBST", 3, 2, false );
    SubLFiles.declareFunction( me, "formula_subst", "FORMULA-SUBST", 3, 2, false );
    SubLFiles.declareFunction( me, "formula_nsubst", "FORMULA-NSUBST", 3, 2, false );
    SubLFiles.declareFunction( me, "expression_nsublis_free_vars_int", "EXPRESSION-NSUBLIS-FREE-VARS-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "expression_nsublis_free_vars", "EXPRESSION-NSUBLIS-FREE-VARS", 2, 1, false );
    SubLFiles.declareFunction( me, "expression_nsublis_int", "EXPRESSION-NSUBLIS-INT", 4, 0, false );
    SubLFiles.declareFunction( me, "expression_sublis", "EXPRESSION-SUBLIS", 2, 2, false );
    SubLFiles.declareFunction( me, "expression_nsublis", "EXPRESSION-NSUBLIS", 2, 2, false );
    SubLFiles.declareFunction( me, "formula_sublis", "FORMULA-SUBLIS", 2, 2, false );
    SubLFiles.declareFunction( me, "formula_nsublis", "FORMULA-NSUBLIS", 2, 2, false );
    SubLFiles.declareFunction( me, "expression_nsublis_el_variables", "EXPRESSION-NSUBLIS-EL-VARIABLES", 2, 0, false );
    SubLFiles.declareFunction( me, "expression_sublis_el_variables", "EXPRESSION-SUBLIS-EL-VARIABLES", 2, 0, false );
    SubLFiles.declareFunction( me, "expression_nsublis_hl_variables", "EXPRESSION-NSUBLIS-HL-VARIABLES", 1, 0, false );
    SubLFiles.declareFunction( me, "expression_sublis_hl_variables", "EXPRESSION-SUBLIS-HL-VARIABLES", 1, 0, false );
    SubLFiles.declareFunction( me, "cnf_nsublis_el_variables", "CNF-NSUBLIS-EL-VARIABLES", 2, 0, false );
    SubLFiles.declareFunction( me, "cnf_sublis_el_variables", "CNF-SUBLIS-EL-VARIABLES", 2, 0, false );
    SubLFiles.declareFunction( me, "formula_arg_position_subst", "FORMULA-ARG-POSITION-SUBST", 3, 0, false );
    SubLFiles.declareFunction( me, "formula_arg_position_nsubst", "FORMULA-ARG-POSITION-NSUBST", 3, 0, false );
    SubLFiles.declareFunction( me, "permute_formula", "PERMUTE-FORMULA", 3, 0, false );
    SubLFiles.declareFunction( me, "formula_permutations", "FORMULA-PERMUTATIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "formulas_permutations", "FORMULAS-PERMUTATIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "formula_arg_permutations", "FORMULA-ARG-PERMUTATIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "nat_commutative_permutations", "NAT-COMMUTATIVE-PERMUTATIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_permute_list_cached", "CLEAR-PERMUTE-LIST-CACHED", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_permute_list_cached", "REMOVE-PERMUTE-LIST-CACHED", 1, 0, false );
    SubLFiles.declareFunction( me, "permute_list_cached_internal", "PERMUTE-LIST-CACHED-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "permute_list_cached", "PERMUTE-LIST-CACHED", 1, 0, false );
    SubLFiles.declareFunction( me, "formula_commutative_permutations", "FORMULA-COMMUTATIVE-PERMUTATIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "canonical_commutative_permutations", "CANONICAL-COMMUTATIVE-PERMUTATIONS", 1, 2, false );
    SubLFiles.declareFunction( me, "variable_argnums", "VARIABLE-ARGNUMS", 1, 1, false );
    SubLFiles.declareFunction( me, "args_canonical_commutative_permutations", "ARGS-CANONICAL-COMMUTATIVE-PERMUTATIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "formulas_canonical_permutations", "FORMULAS-CANONICAL-PERMUTATIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "canonical_permute_formula", "CANONICAL-PERMUTE-FORMULA", 3, 0, false );
    SubLFiles.declareFunction( me, "nat_canonical_commutative_permutations", "NAT-CANONICAL-COMMUTATIVE-PERMUTATIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "split_list_set", "SPLIT-LIST-SET", 1, 0, false );
    SubLFiles.declareFunction( me, "permutations_merge", "PERMUTATIONS-MERGE", 2, 0, false );
    SubLFiles.declareFunction( me, "formula_operator_recursive", "FORMULA-OPERATOR-RECURSIVE", 1, 0, false );
    SubLFiles.declareFunction( me, "rename_default_el_vars_int", "RENAME-DEFAULT-EL-VARS-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "rename_default_el_vars", "RENAME-DEFAULT-EL-VARS", 1, 0, false );
    SubLFiles.declareFunction( me, "rename_default_el_vars_destructive", "RENAME-DEFAULT-EL-VARS-DESTRUCTIVE", 1, 0, false );
    SubLFiles.declareFunction( me, "unrename_default_el_vars_int", "UNRENAME-DEFAULT-EL-VARS-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "unrename_default_el_vars", "UNRENAME-DEFAULT-EL-VARS", 1, 0, false );
    SubLFiles.declareFunction( me, "unrename_default_el_vars_destructive", "UNRENAME-DEFAULT-EL-VARS-DESTRUCTIVE", 1, 0, false );
    SubLFiles.declareFunction( me, "renamed_default_el_var_num", "RENAMED-DEFAULT-EL-VAR-NUM", 1, 0, false );
    SubLFiles.declareFunction( me, "renamed_default_el_var_p", "RENAMED-DEFAULT-EL-VAR-P", 1, 0, false );
    new $renamed_default_el_var_p$UnaryFunction();
    SubLFiles.declareFunction( me, "get_renamed_default_el_var", "GET-RENAMED-DEFAULT-EL-VAR", 1, 0, false );
    SubLFiles.declareFunction( me, "non_indexed_fort_p", "NON-INDEXED-FORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "fort_or_naut_p", "FORT-OR-NAUT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "fort_or_possibly_naut_p", "FORT-OR-POSSIBLY-NAUT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "naut_substitute", "NAUT-SUBSTITUTE", 1, 0, false );
    SubLFiles.declareFunction( me, "collection_intersection_natP", "COLLECTION-INTERSECTION-NAT?", 1, 0, false );
    SubLFiles.declareFunction( me, "collection_union_natP", "COLLECTION-UNION-NAT?", 1, 0, false );
    SubLFiles.declareFunction( me, "collection_intersection", "COLLECTION-INTERSECTION", 1, 0, false );
    SubLFiles.declareFunction( me, "collection_union", "COLLECTION-UNION", 1, 0, false );
    SubLFiles.declareFunction( me, "collection_intersection_intersectees", "COLLECTION-INTERSECTION-INTERSECTEES", 1, 0, false );
    SubLFiles.declareFunction( me, "collection_union_united_collections", "COLLECTION-UNION-UNITED-COLLECTIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "find_denotational_term", "FIND-DENOTATIONAL-TERM", 1, 0, false );
    SubLFiles.declareFunction( me, "denotational_term_name", "DENOTATIONAL-TERM-NAME", 1, 0, false );
    SubLFiles.declareFunction( me, "denotational_term_name_for_alpha_sort", "DENOTATIONAL-TERM-NAME-FOR-ALPHA-SORT", 1, 0, false );
    SubLFiles.declareFunction( me, "sorted_constant_list", "SORTED-CONSTANT-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "sorted_constant_external_id_list", "SORTED-CONSTANT-EXTERNAL-ID-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "sorted_constant_internal_id_list", "SORTED-CONSTANT-INTERNAL-ID-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "constant_list", "CONSTANT-LIST", 1, 1, false );
    SubLFiles.declareFunction( me, "sorted_nat_list", "SORTED-NAT-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "nat_list", "NAT-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "sorted_assertion_list", "SORTED-ASSERTION-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "assertion_list", "ASSERTION-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "sorted_fort_id_list", "SORTED-FORT-ID-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "functional_in_some_argP", "FUNCTIONAL-IN-SOME-ARG?", 1, 0, false );
    SubLFiles.declareFunction( me, "functional_in_arg_positions_internal", "FUNCTIONAL-IN-ARG-POSITIONS-INTERNAL", 1, 1, false );
    SubLFiles.declareFunction( me, "functional_in_arg_positions", "FUNCTIONAL-IN-ARG-POSITIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "strictly_functional_in_some_argP", "STRICTLY-FUNCTIONAL-IN-SOME-ARG?", 1, 0, false );
    SubLFiles.declareFunction( me, "strictly_functional_in_arg_positions_internal", "STRICTLY-FUNCTIONAL-IN-ARG-POSITIONS-INTERNAL", 1, 1, false );
    SubLFiles.declareFunction( me, "strictly_functional_in_arg_positions", "STRICTLY-FUNCTIONAL-IN-ARG-POSITIONS", 1, 1, false );
    SubLFiles.declareFunction( me, "nart_cons", "NART-CONS", 1, 0, false );
    SubLFiles.declareFunction( me, "lookup_all_narts", "LOOKUP-ALL-NARTS", 1, 0, false );
    SubLFiles.declareFunction( me, "reify_all_existing_narts", "REIFY-ALL-EXISTING-NARTS", 1, 0, false );
    SubLFiles.declareFunction( me, "opaque_arg_wrt_nat_reificationP", "OPAQUE-ARG-WRT-NAT-REIFICATION?", 2, 0, false );
    SubLFiles.declareFunction( me, "reify_arg_when_closed_naut", "REIFY-ARG-WHEN-CLOSED-NAUT", 2, 0, false );
    SubLFiles.declareFunction( me, "reify_when_closed_naut", "REIFY-WHEN-CLOSED-NAUT", 1, 0, false );
    SubLFiles.declareFunction( me, "find_when_closed_naut", "FIND-WHEN-CLOSED-NAUT", 1, 0, false );
    SubLFiles.declareFunction( me, "find_closed_naut", "FIND-CLOSED-NAUT", 1, 0, false );
    SubLFiles.declareFunction( me, "find_when_ground_naut", "FIND-WHEN-GROUND-NAUT", 1, 0, false );
    SubLFiles.declareFunction( me, "find_ground_naut", "FIND-GROUND-NAUT", 1, 0, false );
    SubLFiles.declareFunction( me, "ground_hl_formulaP", "GROUND-HL-FORMULA?", 1, 0, false );
    SubLFiles.declareFunction( me, "atomic_sentence_with_pred_p", "ATOMIC-SENTENCE-WITH-PRED-P", 2, 0, false );
    SubLFiles.declareFunction( me, "atomic_sentence_with_any_of_preds_p", "ATOMIC-SENTENCE-WITH-ANY-OF-PREDS-P", 2, 0, false );
    SubLFiles.declareFunction( me, "null_or_falseP", "NULL-OR-FALSE?", 1, 0, false );
    SubLFiles.declareFunction( me, "possibly_cycl_formula_p", "POSSIBLY-CYCL-FORMULA-P", 1, 0, false );
    SubLFiles.declareFunction( me, "negatedP", "NEGATED?", 1, 0, false );
    SubLFiles.declareFunction( me, "negate", "NEGATE", 1, 0, false );
    SubLFiles.declareFunction( me, "possibly_negate", "POSSIBLY-NEGATE", 2, 0, false );
    SubLFiles.declareFunction( me, "formula_arg", "FORMULA-ARG", 2, 1, false );
    SubLFiles.declareFunction( me, "el_formula_arg", "EL-FORMULA-ARG", 2, 1, false );
    SubLFiles.declareFunction( me, "el_formula_has_argP", "EL-FORMULA-HAS-ARG?", 3, 0, false );
    SubLFiles.declareFunction( me, "formula_arg0", "FORMULA-ARG0", 1, 0, false );
    SubLFiles.declareFunction( me, "formula_operator", "FORMULA-OPERATOR", 1, 0, false );
    SubLFiles.declareFunction( me, "el_formula_operator", "EL-FORMULA-OPERATOR", 1, 0, false );
    SubLFiles.declareFunction( me, "el_formula_arg1", "EL-FORMULA-ARG1", 1, 1, false );
    SubLFiles.declareFunction( me, "el_formula_arg2", "EL-FORMULA-ARG2", 1, 1, false );
    SubLFiles.declareFunction( me, "el_formula_arg3", "EL-FORMULA-ARG3", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_arg1", "FORMULA-ARG1", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_arg2", "FORMULA-ARG2", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_arg3", "FORMULA-ARG3", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_arg4", "FORMULA-ARG4", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_arg5", "FORMULA-ARG5", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_arg6", "FORMULA-ARG6", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_args", "FORMULA-ARGS", 1, 1, false );
    SubLFiles.declareFunction( me, "el_formula_args", "EL-FORMULA-ARGS", 1, 1, false );
    SubLFiles.declareFunction( me, "cycl_formula_args", "CYCL-FORMULA-ARGS", 1, 0, false );
    SubLFiles.declareFunction( me, "cycl_formula_arg0", "CYCL-FORMULA-ARG0", 1, 0, false );
    SubLFiles.declareFunction( me, "cycl_formula_arg1", "CYCL-FORMULA-ARG1", 1, 0, false );
    SubLFiles.declareFunction( me, "cycl_formula_arg2", "CYCL-FORMULA-ARG2", 1, 0, false );
    SubLFiles.declareFunction( me, "cycl_formula_arg3", "CYCL-FORMULA-ARG3", 1, 0, false );
    SubLFiles.declareFunction( me, "formula_terms", "FORMULA-TERMS", 1, 1, false );
    SubLFiles.declareFunction( me, "el_formula_terms", "EL-FORMULA-TERMS", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_terms_int", "FORMULA-TERMS-INT", 2, 1, false );
    SubLFiles.declareFunction( me, "formula_terms_int_two_pass", "FORMULA-TERMS-INT-TWO-PASS", 2, 0, false );
    SubLFiles.declareFunction( me, "formula_terms_int_one_pass", "FORMULA-TERMS-INT-ONE-PASS", 2, 0, false );
    SubLFiles.declareFunction( me, "formula_arg_positions", "FORMULA-ARG-POSITIONS", 2, 1, false );
    SubLFiles.declareFunction( me, "el_formula_arg_positions", "EL-FORMULA-ARG-POSITIONS", 2, 1, false );
    SubLFiles.declareFunction( me, "possibly_conjuncts", "POSSIBLY-CONJUNCTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nat_arity", "NAT-ARITY", 1, 1, false );
    SubLFiles.declareFunction( me, "nat_args", "NAT-ARGS", 1, 1, false );
    SubLFiles.declareFunction( me, "naut_args", "NAUT-ARGS", 1, 1, false );
    SubLFiles.declareFunction( me, "nat_arg", "NAT-ARG", 2, 1, false );
    SubLFiles.declareFunction( me, "naut_arg", "NAUT-ARG", 2, 1, false );
    SubLFiles.declareFunction( me, "nat_function", "NAT-FUNCTION", 1, 0, false );
    SubLFiles.declareFunction( me, "nat_functor", "NAT-FUNCTOR", 1, 0, false );
    SubLFiles.declareFunction( me, "naut_functor", "NAUT-FUNCTOR", 1, 0, false );
    SubLFiles.declareFunction( me, "nat_arg0", "NAT-ARG0", 1, 0, false );
    SubLFiles.declareFunction( me, "nat_arg1", "NAT-ARG1", 1, 1, false );
    SubLFiles.declareFunction( me, "naut_arg1", "NAUT-ARG1", 1, 1, false );
    SubLFiles.declareFunction( me, "nat_arg2", "NAT-ARG2", 1, 1, false );
    SubLFiles.declareFunction( me, "naut_arg2", "NAUT-ARG2", 1, 1, false );
    SubLFiles.declareFunction( me, "nat_arg3", "NAT-ARG3", 1, 1, false );
    SubLFiles.declareFunction( me, "naut_arg3", "NAUT-ARG3", 1, 1, false );
    SubLFiles.declareFunction( me, "nat_arg4", "NAT-ARG4", 1, 1, false );
    SubLFiles.declareFunction( me, "nat_arg5", "NAT-ARG5", 1, 1, false );
    SubLFiles.declareFunction( me, "nat_with_functor_p", "NAT-WITH-FUNCTOR-P", 2, 0, false );
    SubLFiles.declareFunction( me, "naut_with_functor_p", "NAUT-WITH-FUNCTOR-P", 2, 0, false );
    SubLFiles.declareFunction( me, "naut_with_any_of_functors_p", "NAUT-WITH-ANY-OF-FUNCTORS-P", 2, 0, false );
    SubLFiles.declareFunction( me, "cycl_nat_with_functor_p", "CYCL-NAT-WITH-FUNCTOR-P", 2, 0, false );
    SubLFiles.declareFunction( me, "sentence_arg", "SENTENCE-ARG", 2, 1, false );
    SubLFiles.declareFunction( me, "sentence_args", "SENTENCE-ARGS", 1, 1, false );
    SubLFiles.declareFunction( me, "sentence_truth_function", "SENTENCE-TRUTH-FUNCTION", 1, 0, false );
    SubLFiles.declareFunction( me, "sentence_arg0", "SENTENCE-ARG0", 1, 0, false );
    SubLFiles.declareFunction( me, "sentence_arg1", "SENTENCE-ARG1", 1, 1, false );
    SubLFiles.declareFunction( me, "sentence_arg2", "SENTENCE-ARG2", 1, 1, false );
    SubLFiles.declareFunction( me, "sentence_arg3", "SENTENCE-ARG3", 1, 1, false );
    SubLFiles.declareFunction( me, "sentence_arg4", "SENTENCE-ARG4", 1, 1, false );
    SubLFiles.declareFunction( me, "sentence_arg5", "SENTENCE-ARG5", 1, 1, false );
    SubLFiles.declareFunction( me, "atomic_sentence_arg", "ATOMIC-SENTENCE-ARG", 2, 1, false );
    SubLFiles.declareFunction( me, "atomic_sentence_args", "ATOMIC-SENTENCE-ARGS", 1, 1, false );
    SubLFiles.declareFunction( me, "atomic_sentence_predicate", "ATOMIC-SENTENCE-PREDICATE", 1, 0, false );
    new $atomic_sentence_predicate$UnaryFunction();
    SubLFiles.declareFunction( me, "atomic_sentence_arg0", "ATOMIC-SENTENCE-ARG0", 1, 0, false );
    SubLFiles.declareFunction( me, "atomic_sentence_arg1", "ATOMIC-SENTENCE-ARG1", 1, 1, false );
    SubLFiles.declareFunction( me, "atomic_sentence_arg2", "ATOMIC-SENTENCE-ARG2", 1, 1, false );
    SubLFiles.declareFunction( me, "atomic_sentence_arg3", "ATOMIC-SENTENCE-ARG3", 1, 1, false );
    SubLFiles.declareFunction( me, "atomic_sentence_arg4", "ATOMIC-SENTENCE-ARG4", 1, 1, false );
    SubLFiles.declareFunction( me, "atomic_sentence_arg5", "ATOMIC-SENTENCE-ARG5", 1, 1, false );
    SubLFiles.declareFunction( me, "atomic_sentence_arg6", "ATOMIC-SENTENCE-ARG6", 1, 1, false );
    SubLFiles.declareFunction( me, "arg_position_p", "ARG-POSITION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "formula_arg_position", "FORMULA-ARG-POSITION", 2, 1, false );
    SubLFiles.declareFunction( me, "get_nested_nth_arg", "GET-NESTED-NTH-ARG", 2, 1, false );
    SubLFiles.declareFunction( me, "arg_positions_dfs", "ARG-POSITIONS-DFS", 2, 1, false );
    SubLFiles.declareFunction( me, "arg_positions_bfs", "ARG-POSITIONS-BFS", 2, 1, false );
    SubLFiles.declareFunction( me, "arg_positions_if_dfs", "ARG-POSITIONS-IF-DFS", 2, 1, false );
    SubLFiles.declareFunction( me, "arg_positions_if_bfs", "ARG-POSITIONS-IF-BFS", 2, 1, false );
    SubLFiles.declareFunction( me, "smallest_enclosing_cycl_sentence", "SMALLEST-ENCLOSING-CYCL-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cycl_arg_position_p", "CYCL-ARG-POSITION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "make_cycl_arg_position", "MAKE-CYCL-ARG-POSITION", 1, 0, false );
    SubLFiles.declareFunction( me, "cycl_arg_position_to_arg_position", "CYCL-ARG-POSITION-TO-ARG-POSITION", 1, 0, false );
    SubLFiles.declareFunction( me, "formula_cycl_arg_position", "FORMULA-CYCL-ARG-POSITION", 2, 1, false );
    SubLFiles.declareFunction( me, "cycl_arg_position_nsubst", "CYCL-ARG-POSITION-NSUBST", 3, 0, false );
    SubLFiles.declareFunction( me, "substitute_terms_into_positions", "SUBSTITUTE-TERMS-INTO-POSITIONS", 3, 0, false );
    return NIL;
  }

  public static SubLObject init_cycl_utilities_file()
  {
    $opaque_arg_function$ = SubLFiles.defparameter( "*OPAQUE-ARG-FUNCTION*", $sym0$DEFAULT_OPAQUE_ARG_ );
    $opaque_seqvar_function$ = SubLFiles.defparameter( "*OPAQUE-SEQVAR-FUNCTION*", $sym1$DEFAULT_OPAQUE_SEQVAR_ );
    $expression_count_item$ = SubLFiles.defparameter( "*EXPRESSION-COUNT-ITEM*", NIL );
    $expression_count_test$ = SubLFiles.defparameter( "*EXPRESSION-COUNT-TEST*", NIL );
    $containing_subexpressions_lambda_term$ = SubLFiles.defparameter( "*CONTAINING-SUBEXPRESSIONS-LAMBDA-TERM*", NIL );
    $default_transformation_limit$ = SubLFiles.deflexical( "*DEFAULT-TRANSFORMATION-LIMIT*", $int30$212 );
    $permute_list_cached_caching_state$ = SubLFiles.deflexical( "*PERMUTE-LIST-CACHED-CACHING-STATE*", NIL );
    $renamed_default_el_var_prefix$ = SubLFiles.defparameter( "*RENAMED-DEFAULT-EL-VAR-PREFIX*", $str44$_RENAMED_VAR );
    $non_indexed_constants$ = SubLFiles.deflexical( "*NON-INDEXED-CONSTANTS*", ConsesLow.append( new SubLObject[] { el_utilities.$cyc_const_unary_logical_ops$.getGlobalValue(), el_utilities.$cyc_const_binary_logical_ops$
        .getGlobalValue(), el_utilities.$cyc_const_ternary_logical_ops$.getGlobalValue(), el_utilities.$cyc_const_quaternary_logical_ops$.getGlobalValue(), el_utilities.$cyc_const_quintary_logical_ops$.getGlobalValue(),
      el_utilities.$cyc_const_variable_arity_logical_ops$.getGlobalValue(), el_utilities.$cyc_const_regular_quantifiers$.getGlobalValue(), el_utilities.$cyc_const_bounded_existentials$.getGlobalValue(),
      el_utilities.$cyc_const_exception_operators$.getGlobalValue(), el_utilities.$cyc_const_pragmatic_requirement_operators$.getGlobalValue()
    } ) );
    return NIL;
  }
  ...
  {
    access_macros.register_external_symbol( $sym28$EXPRESSION_FIND_IF );
    access_macros.register_external_symbol( $sym33$EXPRESSION_SUBST );
    access_macros.register_external_symbol( $sym34$FORMULA_SUBST );
    memoization_state.note_globally_cached_function( $sym37$PERMUTE_LIST_CACHED );
    memoization_state.note_memoized_function( $sym68$FUNCTIONAL_IN_ARG_POSITIONS );
    memoization_state.note_memoized_function( $sym71$STRICTLY_FUNCTIONAL_IN_ARG_POSITIONS );
    utilities_macros.register_cyc_api_function( $sym79$NEGATED_, $list80, $str81$Return_T_iff_OBJECT_is_a_negated_, NIL, $list82 );
    utilities_macros.register_cyc_api_function( $sym84$NEGATE, $list85, $str86$Assuming_FORM_is_a_valid_CycL_for, $list87, $list88 );
    SubLSpecialOperatorDeclarations.proclaim( $list92 );
    access_macros.register_external_symbol( $sym93$FORMULA_OPERATOR );
    ...
    sunit_external.define_test_category( $str112$CycL_Utilities_Subcategory, ConsesLow.list( $str111$CycL_Utilities_Module_Supercatego ) );
    sunit_external.define_test_suite( $str113$CycL_Utilities_Testing_Suite, ConsesLow.list( $str111$CycL_Utilities_Module_Supercatego ), UNPROVIDED, UNPROVIDED );
    return NIL;
  }
  ...
  static
  {
    me = new cycl_utilities();
    $opaque_arg_function$ = null;
    $opaque_seqvar_function$ = null;
    $expression_count_item$ = null;
    $expression_count_test$ = null;
    $containing_subexpressions_lambda_term$ = null;
    $default_transformation_limit$ = null;
    $permute_list_cached_caching_state$ = null;
    $renamed_default_el_var_prefix$ = null;
    $non_indexed_constants$ = null;
    $sym0$DEFAULT_OPAQUE_ARG_ = makeSymbol( "DEFAULT-OPAQUE-ARG?" );
    $sym1$DEFAULT_OPAQUE_SEQVAR_ = makeSymbol( "DEFAULT-OPAQUE-SEQVAR?" );
    $list2 = ConsesLow.list( makeSymbol( "FUNC" ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym3$CLET = makeSymbol( "CLET" );
    $sym4$_OPAQUE_ARG_FUNCTION_ = makeSymbol( "*OPAQUE-ARG-FUNCTION*" );
    $sym5$_OPAQUE_SEQVAR_FUNCTION_ = makeSymbol( "*OPAQUE-SEQVAR-FUNCTION*" );
    $sym6$OPAQUE_ARG_WRT_EL_TEMPLATE_ = makeSymbol( "OPAQUE-ARG-WRT-EL-TEMPLATE?" );
    $const7$SkolemFunctionFn = constant_handles.reader_make_constant_shell( makeString( "SkolemFunctionFn" ) );
    $const8$trueSentence = constant_handles.reader_make_constant_shell( makeString( "trueSentence" ) );
    $sym9$HL_TERM_WITH_EL_COUNTERPART_P = makeSymbol( "HL-TERM-WITH-EL-COUNTERPART-P" );
    $kw10$TRANSFORMATION_LIMIT_EXCEEDED = makeKeyword( "TRANSFORMATION-LIMIT-EXCEEDED" );
    $sym11$HL_TERM_TO_EL_TERM = makeSymbol( "HL-TERM-TO-EL-TERM" );
    $str12$Recursion_limit_reached___el_to_h = makeString( "Recursion limit reached: (el-to-hl ~S)" );
    $sym13$CAREFUL_HL_TERM_TO_EL_TERM = makeSymbol( "CAREFUL-HL-TERM-TO-EL-TERM" );
    $kw14$NART = makeKeyword( "NART" );
    $kw15$ASSERTION = makeKeyword( "ASSERTION" );
    $sym16$RF_P = makeSymbol( "RF-P" );
    $kw17$REGULARIZE = makeKeyword( "REGULARIZE" );
    $sym18$ASSERTION_P = makeSymbol( "ASSERTION-P" );
    $sym19$EXPRESSION_COUNT_HELPER = makeSymbol( "EXPRESSION-COUNT-HELPER" );
    $sym20$EL_FORMULA_P = makeSymbol( "EL-FORMULA-P" );
    $sym21$FORT_P = makeSymbol( "FORT-P" );
    $sym22$CONSTANT_P = makeSymbol( "CONSTANT-P" );
    $sym23$NART_P = makeSymbol( "NART-P" );
    $kw24$IGNORE = makeKeyword( "IGNORE" );
    $str25$_S_is_not_well_formed_ = makeString( "~S is not well formed." );
    $sym26$CONTAINING_SUBEXPRESSIONS_LAMBDA_FN = makeSymbol( "CONTAINING-SUBEXPRESSIONS-LAMBDA-FN" );
    $sym27$KEYWORDP = makeSymbol( "KEYWORDP" );
    $sym28$EXPRESSION_FIND_IF = makeSymbol( "EXPRESSION-FIND-IF" );
    $sym29$LISTP = makeSymbol( "LISTP" );
    $int30$212 = makeInteger( 212 );
    $const31$Quote = constant_handles.reader_make_constant_shell( makeString( "Quote" ) );
    $const32$ExpandSubLFn = constant_handles.reader_make_constant_shell( makeString( "ExpandSubLFn" ) );
    $sym33$EXPRESSION_SUBST = makeSymbol( "EXPRESSION-SUBST" );
    $sym34$FORMULA_SUBST = makeSymbol( "FORMULA-SUBST" );
    $sym35$CYC_VAR_ = makeSymbol( "CYC-VAR?" );
    $sym36$EL_VAR_ = makeSymbol( "EL-VAR?" );
    $sym37$PERMUTE_LIST_CACHED = makeSymbol( "PERMUTE-LIST-CACHED" );
    $sym38$_PERMUTE_LIST_CACHED_CACHING_STATE_ = makeSymbol( "*PERMUTE-LIST-CACHED-CACHING-STATE*" );
    $list39 = ConsesLow.list( NIL );
    $list40 = ConsesLow.list( makeSymbol( "FRONT1" ), makeSymbol( "REST1" ) );
    $list41 = ConsesLow.list( makeSymbol( "FRONT2" ), makeSymbol( "REST2" ) );
    $sym42$DEFAULT_EL_VAR_ = makeSymbol( "DEFAULT-EL-VAR?" );
    $sym43$RENAMED_DEFAULT_EL_VAR_P = makeSymbol( "RENAMED-DEFAULT-EL-VAR-P" );
    $str44$_RENAMED_VAR = makeString( "?RENAMED-VAR" );
    $sym45$KBEQ = makeSymbol( "KBEQ" );
    $sym46$NART_EL_FORMULA = makeSymbol( "NART-EL-FORMULA" );
    $const47$CollectionIntersectionFn = constant_handles.reader_make_constant_shell( makeString( "CollectionIntersectionFn" ) );
    $const48$CollectionIntersection2Fn = constant_handles.reader_make_constant_shell( makeString( "CollectionIntersection2Fn" ) );
    $const49$CollectionUnionFn = constant_handles.reader_make_constant_shell( makeString( "CollectionUnionFn" ) );
    $const50$TheSet = constant_handles.reader_make_constant_shell( makeString( "TheSet" ) );
    $sym51$COLLECTION_INTERSECTION_NAT_ = makeSymbol( "COLLECTION-INTERSECTION-NAT?" );
    $sym52$COLLECTION_UNION_NAT_ = makeSymbol( "COLLECTION-UNION-NAT?" );
    $int53$5000 = makeInteger( 5000 );
    $sym54$_EXIT = makeSymbol( "%EXIT" );
    $str55$ = makeString( "" );
    $str56$__ = makeString( "#$" );
    $list57 = ConsesLow.list( ConsesLow.cons( makeString( "(" ), makeString( "" ) ), ConsesLow.cons( makeString( ")" ), makeString( "" ) ) );
    $sym58$CONSTANT_EXTERNAL_ID__ = makeSymbol( "CONSTANT-EXTERNAL-ID-<" );
    $sym59$CONSTANT_EXTERNAL_ID = makeSymbol( "CONSTANT-EXTERNAL-ID" );
    $sym60$GUID_ = makeSymbol( "GUID<" );
    $sym61$CONSTANT_INTERNAL_ID = makeSymbol( "CONSTANT-INTERNAL-ID" );
    $sym62$_ = makeSymbol( "<" );
    $sym63$NART_ID = makeSymbol( "NART-ID" );
    $sym64$FORT_INTERNAL_ID = makeSymbol( "FORT-INTERNAL-ID" );
    $sym65$VALID_SOMEWHERE_CACHE_ITEM_ = makeSymbol( "VALID-SOMEWHERE-CACHE-ITEM?" );
    $const66$functionalInArgs = constant_handles.reader_make_constant_shell( makeString( "functionalInArgs" ) );
    $const67$strictlyFunctionalInArgs = constant_handles.reader_make_constant_shell( makeString( "strictlyFunctionalInArgs" ) );
    $sym68$FUNCTIONAL_IN_ARG_POSITIONS = makeSymbol( "FUNCTIONAL-IN-ARG-POSITIONS" );
    $sym69$INDEXED_TERM_P = makeSymbol( "INDEXED-TERM-P" );
    $int70$100 = makeInteger( 100 );
    $sym71$STRICTLY_FUNCTIONAL_IN_ARG_POSITIONS = makeSymbol( "STRICTLY-FUNCTIONAL-IN-ARG-POSITIONS" );
    $sym72$OPAQUE_ARG_WRT_NAT_REIFICATION_ = makeSymbol( "OPAQUE-ARG-WRT-NAT-REIFICATION?" );
    $sym73$NART_LOOKUP = makeSymbol( "NART-LOOKUP" );
    $sym74$NULL = makeSymbol( "NULL" );
    $sym75$EL_FIND_IF_NART = makeSymbol( "EL-FIND-IF-NART" );
    $sym76$VARIABLE_P = makeSymbol( "VARIABLE-P" );
    $const77$False = constant_handles.reader_make_constant_shell( makeString( "False" ) );
    $const78$not = constant_handles.reader_make_constant_shell( makeString( "not" ) );
    $sym79$NEGATED_ = makeSymbol( "NEGATED?" );
    $list80 = ConsesLow.list( makeSymbol( "OBJECT" ) );
    $str81$Return_T_iff_OBJECT_is_a_negated_ = makeString( "Return T iff OBJECT is a negated EL formula." );
    $list82 = ConsesLow.list( makeSymbol( "BOOLEANP" ) );
    $sym83$POSSIBLY_SENTENCE_OR_VARIABLE_P = makeSymbol( "POSSIBLY-SENTENCE-OR-VARIABLE-P" );
    $sym84$NEGATE = makeSymbol( "NEGATE" );
    $list85 = ConsesLow.list( makeSymbol( "FORM" ) );
    $str86$Assuming_FORM_is_a_valid_CycL_for = makeString( "Assuming FORM is a valid CycL formula, return a negated version of it." );
    $list87 = ConsesLow.list( ConsesLow.list( makeSymbol( "FORM" ), makeSymbol( "POSSIBLY-SENTENCE-OR-VARIABLE-P" ) ) );
    $list88 = ConsesLow.list( makeSymbol( "EL-FORMULA-P" ) );
    $sym89$TRUTH_P = makeSymbol( "TRUTH-P" );
    $kw90$TRUE = makeKeyword( "TRUE" );
    $sym91$NON_NEGATIVE_INTEGER_P = makeSymbol( "NON-NEGATIVE-INTEGER-P" );
    $list92 = ConsesLow.list( makeSymbol( "INLINE" ), makeSymbol( "FORMULA-OPERATOR" ) );
    $sym93$FORMULA_OPERATOR = makeSymbol( "FORMULA-OPERATOR" );
    $list94 = ConsesLow.list( makeSymbol( "INLINE" ), makeSymbol( "EL-FORMULA-OPERATOR" ) );
    $sym95$CYCL_SENTENCE_P = makeSymbol( "CYCL-SENTENCE-P" );
    $kw96$INCLUDE = makeKeyword( "INCLUDE" );
    $str97$formula_terms_int_got_a_non_el_va = makeString( "formula-terms-int got a non-el-variable or cons: ~A~%" );
    $sym98$POSSIBLY_NAUT_P = makeSymbol( "POSSIBLY-NAUT-P" );
    $list99 = ConsesLow.list( makeSymbol( "INLINE" ), makeSymbol( "NAT-FUNCTION" ) );
    $list100 = ConsesLow.list( makeSymbol( "INLINE" ), makeSymbol( "NAT-FUNCTOR" ) );
    $list101 = ConsesLow.list( makeSymbol( "INLINE" ), makeSymbol( "NAUT-FUNCTOR" ) );
    $list102 = ConsesLow.list( makeSymbol( "INLINE" ), makeSymbol( "SENTENCE-TRUTH-FUNCTION" ) );
    $list103 = ConsesLow.list( makeSymbol( "INLINE" ), makeSymbol( "SENTENCE-ARG0" ) );
    $list104 = ConsesLow.list( makeSymbol( "INLINE" ), makeSymbol( "ATOMIC-SENTENCE-PREDICATE" ) );
    $list105 = ConsesLow.list( makeSymbol( "INLINE" ), makeSymbol( "ATOMIC-SENTENCE-ARG0" ) );
    $sym106$FIXNUMP = makeSymbol( "FIXNUMP" );
    $const107$FormulaArgPositionFn = constant_handles.reader_make_constant_shell( makeString( "FormulaArgPositionFn" ) );
    $sym108$ARG_POSITION_P = makeSymbol( "ARG-POSITION-P" );
    $sym109$CYCL_ARG_POSITION_P = makeSymbol( "CYCL-ARG-POSITION-P" );
    $sym110$NON_DOTTED_LIST_P = makeSymbol( "NON-DOTTED-LIST-P" );
    $str111$CycL_Utilities_Module_Supercatego = makeString( "CycL-Utilities Module Supercategory" );
    $str112$CycL_Utilities_Subcategory = makeString( "CycL Utilities Subcategory" );
    $str113$CycL_Utilities_Testing_Suite = makeString( "CycL Utilities Testing Suite" );
  }

  public static final class $opaque_arg_wrt_quotingP$BinaryFunction
      extends
        BinaryFunction
  {
  ...
  public static final class $hl_term_with_el_counterpart_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $hl_term_to_el_term$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $renamed_default_el_var_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $atomic_sentence_predicate$UnaryFunction
      extends
        UnaryFunction
  {
