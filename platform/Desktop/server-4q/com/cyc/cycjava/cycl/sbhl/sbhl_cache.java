...
public final class sbhl_cache extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sbhl_cache_file() {
        sbhl_cache.$sbhl_caches_initializedP$ = SubLFiles.deflexical("*SBHL-CACHES-INITIALIZED?*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym0$_SBHL_CACHES_INITIALIZED__)) ? sbhl_cache.$sbhl_caches_initializedP$.getGlobalValue() : sbhl_cache.NIL));
        ...
        sbhl_cache.$genl_predicate_cache$ = SubLFiles.deflexical("*GENL-PREDICATE-CACHE*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym2$_GENL_PREDICATE_CACHE_)) ? sbhl_cache.$genl_predicate_cache$.getGlobalValue() : sbhl_cache.NIL));
        sbhl_cache.$genl_inverse_cache$ = SubLFiles.deflexical("*GENL-INVERSE-CACHE*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym3$_GENL_INVERSE_CACHE_)) ? sbhl_cache.$genl_inverse_cache$.getGlobalValue() : sbhl_cache.NIL));
        sbhl_cache.$all_mts_genl_predicate_cache$ = SubLFiles.deflexical("*ALL-MTS-GENL-PREDICATE-CACHE*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym4$_ALL_MTS_GENL_PREDICATE_CACHE_)) ? sbhl_cache.$all_mts_genl_predicate_cache$.getGlobalValue() : sbhl_cache.NIL));
        sbhl_cache.$all_mts_genl_inverse_cache$ = SubLFiles.deflexical("*ALL-MTS-GENL-INVERSE-CACHE*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym5$_ALL_MTS_GENL_INVERSE_CACHE_)) ? sbhl_cache.$all_mts_genl_inverse_cache$.getGlobalValue() : sbhl_cache.NIL));
        ...
        sbhl_cache.$genls_cache$ = SubLFiles.deflexical("*GENLS-CACHE*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym7$_GENLS_CACHE_)) ? sbhl_cache.$genls_cache$.getGlobalValue() : sbhl_cache.NIL));
        sbhl_cache.$all_mts_genls_cache$ = SubLFiles.deflexical("*ALL-MTS-GENLS-CACHE*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym8$_ALL_MTS_GENLS_CACHE_)) ? sbhl_cache.$all_mts_genls_cache$.getGlobalValue() : sbhl_cache.NIL));
        ...
        sbhl_cache.$isa_cache$ = SubLFiles.deflexical("*ISA-CACHE*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym15$_ISA_CACHE_)) ? sbhl_cache.$isa_cache$.getGlobalValue() : sbhl_cache.NIL));
        sbhl_cache.$implicit_fort_type_mapping$ = SubLFiles.deflexical("*IMPLICIT-FORT-TYPE-MAPPING*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym16$_IMPLICIT_FORT_TYPE_MAPPING_)) ? sbhl_cache.$implicit_fort_type_mapping$.getGlobalValue() : sbhl_cache.NIL));
        sbhl_cache.$all_mts_isa_cache$ = SubLFiles.deflexical("*ALL-MTS-ISA-CACHE*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym17$_ALL_MTS_ISA_CACHE_)) ? sbhl_cache.$all_mts_isa_cache$.getGlobalValue() : sbhl_cache.NIL));
        ...
        sbhl_cache.$quoted_isa_cache$ = SubLFiles.deflexical("*QUOTED-ISA-CACHE*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym20$_QUOTED_ISA_CACHE_)) ? sbhl_cache.$quoted_isa_cache$.getGlobalValue() : sbhl_cache.NIL));
        sbhl_cache.$all_mts_quoted_isa_cache$ = SubLFiles.deflexical("*ALL-MTS-QUOTED-ISA-CACHE*", (SubLObject)((sbhl_cache.NIL != Symbols.boundp((SubLObject)sbhl_cache.$sym21$_ALL_MTS_QUOTED_ISA_CACHE_)) ? sbhl_cache.$all_mts_quoted_isa_cache$.getGlobalValue() : sbhl_cache.NIL));
