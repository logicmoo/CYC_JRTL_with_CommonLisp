...
public final class sbhl_graphs extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sbhl_graphs_file() {
        ...
        sbhl_graphs.$sbhl_backing_file_vector$ = SubLFiles.deflexical("*SBHL-BACKING-FILE-VECTOR*", (SubLObject)(maybeDefault((SubLObject)sbhl_graphs.$sym0$_SBHL_BACKING_FILE_VECTOR_, sbhl_graphs.$sbhl_backing_file_vector$, sbhl_graphs.NIL)));
        sbhl_graphs.$sbhl_backing_file_vector_caches_for_modules$ = SubLFiles.deflexical("*SBHL-BACKING-FILE-VECTOR-CACHES-FOR-MODULES*", (SubLObject)(maybeDefault((SubLObject)sbhl_graphs.$sym1$_SBHL_BACKING_FILE_VECTOR_CACHES_FOR_MODULES_, sbhl_graphs.$sbhl_backing_file_vector_caches_for_modules$, sbhl_graphs.NIL)));
        ...
        sbhl_graphs.$sbhl_file_vector_data_stream_lock$ = SubLFiles.deflexical("*SBHL-FILE-VECTOR-DATA-STREAM-LOCK*", maybeDefault((SubLObject)sbhl_graphs.$sym3$_SBHL_FILE_VECTOR_DATA_STREAM_LOCK_, sbhl_graphs.$sbhl_file_vector_data_stream_lock$, ()->(Locks.make_lock((SubLObject)sbhl_graphs.$str4$SBHL_File_Vector_Data_Stream_lock))));
