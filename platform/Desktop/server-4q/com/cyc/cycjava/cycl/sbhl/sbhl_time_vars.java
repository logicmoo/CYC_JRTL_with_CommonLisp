...
public final class sbhl_time_vars extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sbhl_time_vars_file() {
        ...
        sbhl_time_vars.$sbhl_temporal_link_support_table$ = SubLFiles.deflexical("*SBHL-TEMPORAL-LINK-SUPPORT-TABLE*", (sbhl_time_vars.NIL != Symbols.boundp((SubLObject)sbhl_time_vars.$sym15$_SBHL_TEMPORAL_LINK_SUPPORT_TABLE_)) ? sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)sbhl_time_vars.$int16$40000, Symbols.symbol_function((SubLObject)sbhl_time_vars.EQUAL), (SubLObject)sbhl_time_vars.UNPROVIDED));
        sbhl_time_vars.$sbhl_temporal_link_disjunction_support_table$ = SubLFiles.deflexical("*SBHL-TEMPORAL-LINK-DISJUNCTION-SUPPORT-TABLE*", (sbhl_time_vars.NIL != Symbols.boundp((SubLObject)sbhl_time_vars.$sym17$_SBHL_TEMPORAL_LINK_DISJUNCTION_SUPPORT_TABLE_)) ? sbhl_time_vars.$sbhl_temporal_link_disjunction_support_table$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)sbhl_time_vars.$int18$4000, Symbols.symbol_function((SubLObject)sbhl_time_vars.EQUAL), (SubLObject)sbhl_time_vars.UNPROVIDED));
        sbhl_time_vars.$sbhl_temporal_link_disjunction_term_table$ = SubLFiles.deflexical("*SBHL-TEMPORAL-LINK-DISJUNCTION-TERM-TABLE*", (sbhl_time_vars.NIL != Symbols.boundp((SubLObject)sbhl_time_vars.$sym19$_SBHL_TEMPORAL_LINK_DISJUNCTION_TERM_TABLE_)) ? sbhl_time_vars.$sbhl_temporal_link_disjunction_term_table$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)sbhl_time_vars.$int18$4000, (SubLObject)sbhl_time_vars.UNPROVIDED, (SubLObject)sbhl_time_vars.UNPROVIDED));
        sbhl_time_vars.$sbhl_extended_universal_date_list$ = SubLFiles.deflexical("*SBHL-EXTENDED-UNIVERSAL-DATE-LIST*", (SubLObject)((sbhl_time_vars.NIL != Symbols.boundp((SubLObject)sbhl_time_vars.$sym20$_SBHL_EXTENDED_UNIVERSAL_DATE_LIST_)) ? sbhl_time_vars.$sbhl_extended_universal_date_list$.getGlobalValue() : sbhl_time_vars.NIL));
        sbhl_time_vars.$sbhl_time_predicates$ = SubLFiles.deflexical("*SBHL-TIME-PREDICATES*", (SubLObject)((sbhl_time_vars.NIL != Symbols.boundp((SubLObject)sbhl_time_vars.$sym21$_SBHL_TIME_PREDICATES_)) ? sbhl_time_vars.$sbhl_time_predicates$.getGlobalValue() : sbhl_time_vars.NIL));
        sbhl_time_vars.$sbhl_time_modules$ = SubLFiles.deflexical("*SBHL-TIME-MODULES*", (sbhl_time_vars.NIL != Symbols.boundp((SubLObject)sbhl_time_vars.$sym22$_SBHL_TIME_MODULES_)) ? sbhl_time_vars.$sbhl_time_modules$.getGlobalValue() : dictionary.new_dictionary((SubLObject)sbhl_time_vars.UNPROVIDED, (SubLObject)sbhl_time_vars.UNPROVIDED));
