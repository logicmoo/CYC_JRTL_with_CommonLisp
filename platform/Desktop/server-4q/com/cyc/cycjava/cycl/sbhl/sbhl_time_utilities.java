...
public final class sbhl_time_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sbhl_time_utilities_file() {
        ...
        sbhl_time_utilities.$hl_start_table_lock$ = SubLFiles.deflexical("*HL-START-TABLE-LOCK*", (sbhl_time_utilities.NIL != Symbols.boundp((SubLObject)sbhl_time_utilities.$sym2$_HL_START_TABLE_LOCK_)) ? sbhl_time_utilities.$hl_start_table_lock$.getGlobalValue() : Locks.make_lock((SubLObject)sbhl_time_utilities.$str3$_hl_start_table_lock_));
        sbhl_time_utilities.$hl_start_table$ = SubLFiles.deflexical("*HL-START-TABLE*", (sbhl_time_utilities.NIL != Symbols.boundp((SubLObject)sbhl_time_utilities.$sym4$_HL_START_TABLE_)) ? sbhl_time_utilities.$hl_start_table$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)sbhl_time_utilities.$int5$100, Symbols.symbol_function((SubLObject)sbhl_time_utilities.EQUAL), (SubLObject)sbhl_time_utilities.UNPROVIDED));
        sbhl_time_utilities.$hl_end_table_lock$ = SubLFiles.deflexical("*HL-END-TABLE-LOCK*", (sbhl_time_utilities.NIL != Symbols.boundp((SubLObject)sbhl_time_utilities.$sym6$_HL_END_TABLE_LOCK_)) ? sbhl_time_utilities.$hl_end_table_lock$.getGlobalValue() : Locks.make_lock((SubLObject)sbhl_time_utilities.$str7$_hl_end_table_lock_));
        sbhl_time_utilities.$hl_end_table$ = SubLFiles.deflexical("*HL-END-TABLE*", (sbhl_time_utilities.NIL != Symbols.boundp((SubLObject)sbhl_time_utilities.$sym8$_HL_END_TABLE_)) ? sbhl_time_utilities.$hl_end_table$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)sbhl_time_utilities.$int5$100, Symbols.symbol_function((SubLObject)sbhl_time_utilities.EQUAL), (SubLObject)sbhl_time_utilities.UNPROVIDED));
