      ...
      SubLTranslatedFile
{
  ...
  public static SubLObject determine_sbhl_terminating_marking_space(final SubLObject search_behavior)
  {
    ...
    if( search_behavior.eql( $sym1$SBHL_SIMPLE_TRUE_SEARCH ) )
    {
      return sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread );
    }
    if( search_behavior.eql( $sym2$SBHL_SIMPLE_FALSE_SEARCH ) )
    {
      return sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread );
    }
    if( search_behavior.eql( $sym3$SBHL_STEP_AND_SWEEP_WITH_TT_MODULE ) )
    {
      return sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread );
    }
    if( search_behavior.eql( $sym4$SBHL_SWEEP_WITH_TT_MODULE_CARRY_STEP ) )
    {
      return sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread );
    }
    if( search_behavior.eql( $sym5$SBHL_SWEEP_STEP_DISJOINS_AND_SWEEP_AGAIN ) )
    {
      return sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread );
    }
  ...
  public static SubLObject hl_default_tv(final SubLObject tv)
  {
    ...
    if( tv.eql( $kw10$FALSE ) )
    {
      return $kw11$FALSE_DEF;
    }
    return $kw9$TRUE_DEF;
  }
  ...
  public static SubLObject sbhl_find_gaf(final SubLObject gaf_formula, final SubLObject mt, final SubLObject tv)
  {
    ...
    else if( NIL == sbhl_module_utilities.sbhl_module_directed_linksP( sbhl_module_vars.get_sbhl_module( pred ) ) )
    {
      ...
      SubLObject arg1 = NIL;
      SubLObject arg2 = NIL;
      cdestructuring_bind.destructuring_bind_must_consp( gaf_formula, gaf_formula, $list12 );
      pred_$1 = gaf_formula.first();
      SubLObject current = gaf_formula.rest();
      cdestructuring_bind.destructuring_bind_must_consp( current, gaf_formula, $list12 );
      arg1 = current.first();
      ...
      if( NIL == current )
      {
        final SubLObject sym_formula = ConsesLow.list( pred_$1, arg2, arg1 );
      ...
      {
        cdestructuring_bind.cdestructuring_bind_error( gaf_formula, $list12 );
      }
    }
    else
    {
  ...
  public static SubLObject sbhl_assemble_justification_step(final SubLObject just_step, SubLObject mt)
  {
    ...
    if( pcase_var.eql( $kw15$VERBOSE ) )
    {
      return just_step;
    }
    if( pcase_var.eql( $kw13$OLD ) )
    {
      return ( NIL != sbhl_search_vars.sbhl_justification_defaulted_old_p() ) ? ConsesLow.list( sbhl_just_gaf( just_step ), tv )
          : ConsesLow.list( sbhl_just_gaf( just_step ), sbhl_search_vars.sbhl_possibly_translate_tv( sbhl_just_tv( just_step ) ) );
    }
  ...
  public static SubLObject sbhl_assemble_justification(final SubLObject just_path, SubLObject mt)
  {
    ...
    {
      result = ConsesLow.cons( sbhl_assemble_justification_step( just_step, mt ), result );
  ...
  public static SubLObject sbhl_handle_justification(final SubLObject method, final SubLObject module, final SubLObject node1, final SubLObject node2, SubLObject mt, SubLObject tv, SubLObject behavior,
    ...
    try
    {
      ...
      if( NIL != behavior )
      {
        ...
        try
        {
          ...
          {
            just = ConsesLow.list( arguments.make_hl_support( $kw17$REFLEXIVE, el_utilities.make_binary_formula( sbhl_module_utilities.get_sbhl_link_pred( module ), node1, node2 ), UNPROVIDED, UNPROVIDED ) );
          }
          else if( NIL != justify_node_equalityP && node1.equal( node2 ) && NIL != sbhl_module_utilities.sbhl_time_module_p( module ) && NIL != sbhl_time_vars.sbhl_succession_depth_non_negative_p() )
          {
            just = ConsesLow.list( ConsesLow.list( $const18$equals, node1, node2 ), mt, $const19$MonotonicallyTrue );
          }
          else
          {
            ...
            try
            {
              ...
              sbhl_search_vars.$sbhl_unwind_function$.bind( ( NIL != sbhl_module_utilities.sbhl_time_search_p() ) ? $sym20$SBHL_TEMPORAL_JUSTIFICATION_UNWIND : $sym21$SBHL_PUSH_UNWIND_ONTO_RESULT, thread );
  ...
  {
    sbhl_search_vars.$sbhl_justification_result$.setDynamicValue( ConsesLow.list( ConsesLow.list( ConsesLow.list( $const24$disjointWith, node, node ), NIL, $kw8$TRUE ) ) );
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return ConsesLow.list( sbhl_module_utilities.get_sbhl_module_tag( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), node, link_node, sbhl_link_vars.$sbhl_link_mt$.getDynamicValue( thread ) );
  }
  ...
  public static SubLObject any_support_chain_of_temporal_link(final SubLObject link)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject result = NIL;
    final SubLObject supports = Hashtables.gethash( link, sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue(), UNPROVIDED );
    if( NIL == result )
    {
      ...
      while ( NIL == result && NIL != csome_list_var)
      {
        if( support.isKeyword() )
        {
          ...
          {
            result = ConsesLow.cons( link, result );
          }
          else
          {
            result = ConsesLow.cons( ConsesLow.list( link, supports.first() ), result );
          }
        }
        else if( NIL != assertions_high.valid_assertion( support, UNPROVIDED ) )
        {
          if( NIL != sbhl_time_vars.$sbhl_temporality_verbose_justsP$.getDynamicValue( thread ) )
          {
            if( NIL != sbhl_time_vars.$sbhl_temporality_include_only_links_in_verbose_justsP$.getDynamicValue( thread ) )
            ...
            {
              result = ConsesLow.cons( ConsesLow.list( link, support ), result );
            }
          }
          else
          {
  ...
  public static SubLObject any_support_chain_of_link_disjunction_consequent(final SubLObject link_disjunction, final SubLObject link)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject result = NIL;
    final SubLObject supports = Hashtables.gethash( link_disjunction, sbhl_time_vars.$sbhl_temporal_link_disjunction_support_table$.getGlobalValue(), UNPROVIDED );
    final SubLObject consequent = Hashtables.gethash( link_disjunction, sbhl_time_vars.$sbhl_temporal_link_disjunction_consequent_table$.getDynamicValue( thread ), UNPROVIDED );
    ...
    try
    {
      sbhl_time_vars.$sbhl_temporality_consequent_links_search_passed_through$.bind( ConsesLow.cons( link, sbhl_time_vars.$sbhl_temporality_consequent_links_search_passed_through$.getDynamicValue( thread ) ), thread );
      if( NIL == result )
      {
        SubLObject csome_list_var = supports;
        SubLObject support = NIL;
        ...
        while ( NIL == result && NIL != csome_list_var)
        {
          if( NIL != assertions_high.valid_assertion( support, UNPROVIDED ) )
          {
            if( NIL != sbhl_time_vars.$sbhl_temporality_verbose_justsP$.getDynamicValue( thread ) )
            {
              if( NIL != sbhl_time_vars.$sbhl_temporality_include_only_links_in_verbose_justsP$.getDynamicValue( thread ) )
              {
                result = ConsesLow.cons( ConsesLow.list( link, link_disjunction ), result );
              }
              else
              {
                result = ConsesLow.cons( ConsesLow.list( link, ConsesLow.list( link_disjunction, support ) ), result );
              }
            }
            else
            {
  ...
  public static SubLObject sbhl_node_valid_for_temporal_search_result_p(final SubLObject node)
  {
    ...
    if( NIL != sbhl_marking_vars.sbhl_temporality_search_checks_nodes_in_target_space_p() )
    {
      return makeBoolean( NIL != sbhl_marking_utilities.sbhl_nodes_marking_non_negative_p( node, UNPROVIDED ) && NIL != sbhl_marking_utilities.sbhl_current_temporal_node_not_yet_considered_p()
          && NIL != sbhl_marking_utilities.sbhl_nodes_marking_non_negative_p( node, sbhl_marking_vars.$sbhl_target_space$.getDynamicValue( thread ) ) && NIL != sbhl_time_utilities
              .sbhl_node_passes_temporality_all_accesses_filtersP( node ) );
    }
    return makeBoolean( NIL != sbhl_marking_utilities.sbhl_nodes_marking_non_negative_p( node, UNPROVIDED ) && NIL != sbhl_marking_utilities.sbhl_current_temporal_node_not_yet_considered_p() && NIL != sbhl_time_utilities
        .sbhl_node_passes_temporality_all_accesses_filtersP( node ) );
  }
  ...
  {
    if( test_fn.eql( $sym25$NOT_GENL_INVERSE_MODE_P ) )
    {
      return sbhl_search_vars.not_genl_inverse_mode_p();
    }
    if( test_fn.eql( $sym26$GENL_INVERSE_MODE_P ) )
    {
      return sbhl_search_vars.genl_inverse_mode_p();
    }
    if( test_fn.eql( $sym27$NON_EMPTY_EXTENT ) )
    {
      return T;
    }
    if( test_fn.eql( $sym28$SBHL_NODE_VALID_FOR_TEMPORAL_SEARCH_RESULT_P ) )
    {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_search_vars.$sbhl_result$.setDynamicValue( ConsesLow.cons( node, sbhl_search_vars.$sbhl_result$.getDynamicValue( thread ) ), thread );
    return NIL;
  }
  ...
  public static SubLObject sbhl_push_unwind_onto_result(final SubLObject nodelist)
  {
    ...
    else
    {
      ...
      final SubLObject node1 = ( NIL != forwardP ) ? nodelist.first() : conses_high.second( nodelist );
      final SubLObject node2 = ( NIL != forwardP ) ? conses_high.second( nodelist ) : nodelist.first();
      if( NIL != forts.fort_p( node1 ) || NIL == forwardP )
      {
        sbhl_search_vars.$sbhl_justification_result$.setDynamicValue( ConsesLow.cons( ConsesLow.list( ConsesLow.list( sbhl_module_utilities.get_sbhl_link_pred( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), node1,
            node2 ), sbhl_link_vars.get_sbhl_link_mt(), sbhl_link_vars.get_sbhl_link_tv() ), sbhl_search_vars.$sbhl_justification_result$.getDynamicValue( thread ) ), thread );
      }
      else
      {
        sbhl_search_vars.$sbhl_justification_result$.setDynamicValue( ConsesLow.cons( sbhl_nat_utilities.sbhl_determine_naut_just_step( node1, node2, sbhl_link_vars.get_sbhl_link_generator() ),
            sbhl_search_vars.$sbhl_justification_result$.getDynamicValue( thread ) ), thread );
      }
    }
    return NIL;
  }
  ...
  public static SubLObject sbhl_temporal_justification_unwind(final SubLObject nodelist)
  {
    ...
    if( NIL == sbhl_time_vars.$sbhl_temporality_justification_gathering_passed_through_dateP$.getDynamicValue( thread ) || NIL == sbhl_time_vars.$sbhl_temporality_search_passed_through_dateP$.getDynamicValue( thread )
        || NIL != sbhl_time_vars.$sbhl_temporality_verbose_justsP$.getDynamicValue( thread ) )
    {
      final SubLObject support = any_support_chain_of_temporal_link( faux_link );
      if( NIL != support )
      {
        sbhl_search_vars.$sbhl_result$.setDynamicValue( ConsesLow.cons( support, sbhl_search_vars.$sbhl_result$.getDynamicValue( thread ) ), thread );
      }
    }
    return NIL;
  }
  ...
  public static SubLObject sbhl_apply_compose_fn_if(final SubLObject node)
  {
    ...
    if( NIL != sbhl_marking_vars.sbhl_suspend_new_spaces_during_mappingP() )
    {
      ...
      try
      {
        ...
        sbhl_marking_vars.$sbhl_gather_space$.bind( sbhl_marking_vars.$sbhl_mapping_gather_marking_space$.getDynamicValue( thread ), thread );
        sbhl_marking_vars.$sbhl_suspend_new_spacesP$.bind( T, thread );
        if( NIL != Functions.funcall( test_fn, node ) )
        {
          Functions.funcall( compose_fn, node );
        }
      }
    ...
    else if( NIL != Functions.funcall( test_fn, node ) )
    {
      Functions.funcall( compose_fn, node );
    }
    return NIL;
  ...
  public static SubLObject apply_sbhl_consider_node_fn(final SubLObject fn, final SubLObject node)
  {
    ...
    {
      if( fn.eql( $sym32$SBHL_PUSH_ONTO_RESULT ) )
      {
        sbhl_push_onto_result( node );
      }
      else if( fn.eql( $sym33$SBHL_PUSH_ONTO_RESULT_WITH_PRUNE ) )
      {
        sbhl_push_onto_result_with_prune( node );
      }
      else if( fn.eql( $sym34$SBHL_NODE_IS_GOAL_NODE ) )
      {
        sbhl_node_is_goal_node( node );
      }
      else if( fn.eql( $sym35$SBHL_NODE_MARKED_AS_GOAL_NODE ) )
      {
        sbhl_node_marked_as_goal_node( node );
      }
      else if( fn.eql( $sym36$SBHL_GATHER_FIRST_NON_NIL_RESULT ) )
      {
        sbhl_gather_first_non_nil_result( node );
      }
      else if( fn.eql( $sym37$SBHL_GATHER_FIRST_NON_NIL_RESULT_WITH_PRUNE ) )
      {
        sbhl_gather_first_non_nil_result_with_prune( node );
      }
      else if( fn.eql( $sym38$SBHL_APPLY_COMPOSE_FN ) )
      {
        sbhl_apply_compose_fn( node );
      }
      else if( fn.eql( $sym39$SBHL_APPLY_COMPOSE_FN_AND_COMBINE_WITH_RESULT ) )
      {
        sbhl_apply_compose_fn_and_combine_with_result( node );
      }
      else if( fn.eql( $sym40$SBHL_GATHER_DEAD_END_NODES ) )
      {
        sbhl_search_methods.sbhl_gather_dead_end_nodes( node );
      }
      else if( fn.eql( $sym41$SBHL_GATHER_FIRST_DEAD_END_NODE_AND_ENQUEUE_OTHERS ) )
      {
  ...
  public static SubLObject sbhl_consider_any_node(final SubLObject node)
  {
    ...
    if( pcase_var.eql( $sym35$SBHL_NODE_MARKED_AS_GOAL_NODE ) )
    {
      sbhl_node_marked_as_goal_node( node );
    }
    else
      ...
      if( NIL == sbhl_search_vars.sbhl_stop_search_path_p() )
      {
        ...
        for( rest = NIL, rest = accessible_modules; NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != rest; rest = rest.rest() )
        {
          ...
          try
          {
                      ...
                      && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                  {
                    ...
                    if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                    {
                      ...
                      try
                      {
                        ...
                        for( iteration_state_$15 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread )
                            && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state_$15 ); iteration_state_$15 = dictionary_contents.do_dictionary_contents_next( iteration_state_$15 ) )
                        {
                          thread.resetMultipleValues();
                              ...
                              if( NIL != set.set_p( sol ) )
                              {
                                        ...
                                        .do_set_contents_update_state( state ) )
                                {
                                  ...
                                  if( NIL != set_contents.do_set_contents_element_validP( state, link_node ) )
                                  {
                                    ...
                                    {
                                      sbhl_apply_unwind_function( ConsesLow.list( node, link_node ) );
                                    }
                                  }
                                }
                              }
                              else if( sol.isList() )
                              {
                                if( NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) )
                                {
                                  ...
                                  while ( NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != csome_list_var)
                                  {
                                    ...
                                    if( NIL != sbhl_search_vars.sbhl_apply_unwind_function_p() )
                                    {
                                      sbhl_apply_unwind_function( ConsesLow.list( node, link_node2 ) );
                                    }
                                    csome_list_var = csome_list_var.rest();
                                    link_node2 = csome_list_var.first();
                                  }
            ...
            else if( NIL != obsolete.cnat_p( node_$13, UNPROVIDED ) )
            {
                  ...
                  if( NIL != set.set_p( sol2 ) )
                  {
                            ...
                            .do_set_contents_update_state( state2 ) )
                    {
                      ...
                      if( NIL != set_contents.do_set_contents_element_validP( state2, link_node3 ) )
                      {
                        ...
                        if( NIL != sbhl_search_vars.sbhl_apply_unwind_function_p() )
                        {
                          sbhl_apply_unwind_function( ConsesLow.list( node, link_node3 ) );
                        }
                      }
                    }
                  }
                  else if( sol2.isList() )
                  {
                    if( NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) )
                    {
                      ...
                      while ( NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != csome_list_var2)
                      {
                        ...
                        if( NIL != sbhl_search_vars.sbhl_apply_unwind_function_p() )
                        {
                          sbhl_apply_unwind_function( ConsesLow.list( node, link_node4 ) );
                        }
      ...
      if( NIL == sbhl_search_vars.sbhl_stop_search_path_p() )
      {
        ...
        for( rest = NIL, rest = accessible_modules; NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != rest; rest = rest.rest() )
        {
          ...
          try
          {
                ...
                if( NIL != mt_links )
                {
                      ...
                      && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                  {
                    ...
                    if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                    {
                      ...
                      {
                        sbhl_link_vars.$sbhl_link_mt$.bind( mt, thread );
                        for( iteration_state_$21 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread )
            ...
            else if( NIL != obsolete.cnat_p( node_$19, UNPROVIDED ) )
            {
              new_list = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars
                  .get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                  : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module(
      ...
      if( NIL == sbhl_search_vars.sbhl_stop_search_path_p() )
      {
        ...
        for( rest = NIL, rest = accessible_modules; NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != rest; rest = rest.rest() )
        {
          ...
          try
          {
                ...
                if( NIL != mt_links )
                {
                      ...
                      && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                  {
                    ...
                    if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                    {
                      ...
                      {
                        sbhl_link_vars.$sbhl_link_mt$.bind( mt, thread );
                        for( iteration_state_$31 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread )
                            && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state_$31 ); iteration_state_$31 = dictionary_contents.do_dictionary_contents_next( iteration_state_$31 ) )
                        {
                          thread.resetMultipleValues();
            ...
            else if( NIL != obsolete.cnat_p( node_$29, UNPROVIDED ) )
            {
              new_list = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars
                  .get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                  : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module(
      ...
      if( NIL == sbhl_search_vars.sbhl_stop_search_path_p() )
      {
        ...
        for( rest = NIL, rest = accessible_modules; NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != rest; rest = rest.rest() )
        {
          ...
          try
          {
                ...
                if( NIL != mt_links )
                {
                      ...
                      && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                  {
                    ...
                    if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                    {
                      ...
                      {
                        sbhl_link_vars.$sbhl_link_mt$.bind( mt, thread );
                        for( iteration_state_$37 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread )
                              ...
                              if( NIL != set.set_p( sol ) )
                              {
                                        ...
                                        .do_set_contents_update_state( state ) )
                                {
                                  ...
                                  if( NIL != set_contents.do_set_contents_element_validP( state, link_node ) )
                                  {
                                    ...
                                    {
                                      sbhl_search_vars.$sbhl_search_parent_marking$.bind( sbhl_search_vars.$sbhl_search_parent_marking$.getDynamicValue( thread ), thread );
                                      sbhl_time_vars.$sbhl_temporality_search_passed_through_dateP$.bind( ( NIL != sbhl_search_vars.sbhl_justification_search_p() ) ? makeBoolean( NIL != sbhl_time_utilities
                                          .hl_date_point_p( node ) || NIL != sbhl_time_vars.$sbhl_temporality_search_passed_through_dateP$.getDynamicValue( thread ) ) : NIL, thread );
                                      if( NIL == sbhl_search_vars.sbhl_justification_search_p() || NIL == sbhl_time_vars.sbhl_temporality_consequent_links_search_passed_through_link_p( sbhl_temporal_faux_link( node,
                                          link_node ) ) )
                                      {
            ...
            else if( NIL != obsolete.cnat_p( node_$35, UNPROVIDED ) )
            {
              new_list = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars
                  .get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                  : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module(
                  ...
                  if( NIL != set.set_p( sol2 ) )
                  {
                            ...
                            .do_set_contents_update_state( state2 ) )
                    {
                      ...
                      if( NIL != set_contents.do_set_contents_element_validP( state2, link_node3 ) )
                      {
                        ...
                        {
                          sbhl_search_vars.$sbhl_search_parent_marking$.bind( sbhl_search_vars.$sbhl_search_parent_marking$.getDynamicValue( thread ), thread );
                          sbhl_time_vars.$sbhl_temporality_search_passed_through_dateP$.bind( ( NIL != sbhl_search_vars.sbhl_justification_search_p() ) ? makeBoolean( NIL != sbhl_time_utilities.hl_date_point_p( node )
                              || NIL != sbhl_time_vars.$sbhl_temporality_search_passed_through_dateP$.getDynamicValue( thread ) ) : NIL, thread );
  ...
  public static SubLObject sbhl_step_and_suspend_mark(final SubLObject node, final SubLObject suspend_test_p)
  {
    ...
    for( rest = NIL, rest = accessible_modules; NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != rest; rest = rest.rest() )
    {
      ...
      try
      {
            ...
            if( NIL != mt_links )
            {
                  ...
                  && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
              {
                ...
                if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                {
                  ...
                  {
                    sbhl_link_vars.$sbhl_link_mt$.bind( mt, thread );
                    for( iteration_state_$51 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread )
                        && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state_$51 ); iteration_state_$51 = dictionary_contents.do_dictionary_contents_next( iteration_state_$51 ) )
                    {
                      thread.resetMultipleValues();
        ...
        else if( NIL != obsolete.cnat_p( node_$49, UNPROVIDED ) )
        {
  ...
  public static SubLObject sbhl_step_and_suspend_unmark(final SubLObject node)
  {
    ...
    for( rest = NIL, rest = accessible_modules; NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != rest; rest = rest.rest() )
    {
      ...
      try
      {
            ...
            if( NIL != mt_links )
            {
                  ...
                  && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
              {
                ...
                if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                {
                  ...
                  {
                    sbhl_link_vars.$sbhl_link_mt$.bind( mt, thread );
                    for( iteration_state_$57 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread )
                        && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state_$57 ); iteration_state_$57 = dictionary_contents.do_dictionary_contents_next( iteration_state_$57 ) )
                    {
                      thread.resetMultipleValues();
        ...
        else if( NIL != obsolete.cnat_p( node_$55, UNPROVIDED ) )
        {
          new_list = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(),
              sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
              : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module(
  ...
  public static SubLObject sbhl_step_and_mark(final SubLObject node)
  {
    ...
    for( rest = NIL, rest = accessible_modules; NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != rest; rest = rest.rest() )
    {
      ...
      try
      {
            ...
            if( NIL != mt_links )
            {
                  ...
                  && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
              {
                ...
                if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                {
                  ...
                  {
                    sbhl_link_vars.$sbhl_link_mt$.bind( mt, thread );
                    for( iteration_state_$63 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread )
                        && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state_$63 ); iteration_state_$63 = dictionary_contents.do_dictionary_contents_next( iteration_state_$63 ) )
                    {
                      thread.resetMultipleValues();
                  ...
                  try
                  {
                    ...
                    if( NIL != sbhl_search_vars.relevant_sbhl_tvP( tv2 ) )
                    {
                      ...
                      try
                      {
                        ...
                        link_nodes2 = ( sol = ConsesLow.list( link_node3 ) );
                        if( NIL != set.set_p( sol ) )
                        {
                          set_contents_var = set.do_set_internal( sol );
                          for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object,
                                  ...
                                  .do_set_contents_update_state( state ) )
                          {
                            ...
                            if( NIL != set_contents.do_set_contents_element_validP( state, link_node_$67 ) )
                            {
                              ...
                              if( NIL != sbhl_search_vars.sbhl_apply_unwind_function_p() )
                              {
                                sbhl_apply_unwind_function( ConsesLow.list( node, link_node_$67 ) );
                              }
                            }
                          }
                        }
                        else if( sol.isList() )
                        {
                          if( NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) )
                          {
                            ...
                            while ( NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != csome_list_var_$68)
                            {
                              ...
                              if( NIL != sbhl_search_vars.sbhl_apply_unwind_function_p() )
                              {
                                sbhl_apply_unwind_function( ConsesLow.list( node, link_node_$68 ) );
                              }
        ...
        else if( NIL != obsolete.cnat_p( node_$61, UNPROVIDED ) )
        {
          new_list = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(),
              sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
              : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module(
              ...
              else if( sol2.isList() )
              {
                if( NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) )
                {
                  ...
                  while ( NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != csome_list_var3)
                  {
                    ...
                    if( NIL != sbhl_search_vars.sbhl_apply_unwind_function_p() )
                    {
                      sbhl_apply_unwind_function( ConsesLow.list( node, link_node5 ) );
                    }
  ...
  public static SubLObject sbhl_step_and_unmark(final SubLObject node)
  {
    ...
    for( rest = NIL, rest = accessible_modules; NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != rest; rest = rest.rest() )
    {
      ...
      try
      {
            ...
            if( NIL != mt_links )
            {
                  ...
                  && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
              {
                ...
                if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                {
                  ...
                  {
                    sbhl_link_vars.$sbhl_link_mt$.bind( mt, thread );
                    for( iteration_state_$74 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread )
                        && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state_$74 ); iteration_state_$74 = dictionary_contents.do_dictionary_contents_next( iteration_state_$74 ) )
                    {
                      thread.resetMultipleValues();
        ...
        else if( NIL != obsolete.cnat_p( node_$72, UNPROVIDED ) )
        {
          new_list = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(),
              sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
              : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module(
  ...
  public static SubLObject sbhl_sweep_and_unwind(final SubLObject module, final SubLObject link_direction, final SubLObject tv, final SubLObject space, final SubLObject map_fn, final SubLObject node,
  ...
  public static SubLObject sbhl_step(final SubLObject module, final SubLObject link_direction, final SubLObject tv, final SubLObject space, final SubLObject map_fn, final SubLObject node, SubLObject suspend_marking_p,
  ...
  public static SubLObject sbhl_step_and_perform_marking(final SubLObject module, final SubLObject link_direction, final SubLObject tv, final SubLObject space, final SubLObject map_fn, final SubLObject node,
      SubLObject unmarkingP)
  {
    if( unmarkingP == UNPROVIDED )
    {
  ...
  public static SubLObject sbhl_unmark_step(final SubLObject module, final SubLObject link_direction, final SubLObject tv, final SubLObject space, final SubLObject map_fn, final SubLObject node,
  ...
  {
    if( behavior.eql( $sym1$SBHL_SIMPLE_TRUE_SEARCH ) )
    {
      sbhl_simple_true_search( node );
    }
    else if( behavior.eql( $sym2$SBHL_SIMPLE_FALSE_SEARCH ) )
    {
      sbhl_simple_false_search( node );
    }
    else if( behavior.eql( $sym3$SBHL_STEP_AND_SWEEP_WITH_TT_MODULE ) )
    {
      sbhl_step_and_sweep_with_tt_module( node );
    }
    else if( behavior.eql( $sym4$SBHL_SWEEP_WITH_TT_MODULE_CARRY_STEP ) )
    {
      sbhl_sweep_with_tt_module_carry_step( node );
    }
    else if( behavior.eql( $sym5$SBHL_SWEEP_STEP_DISJOINS_AND_SWEEP_AGAIN ) )
    {
      sbhl_sweep_step_disjoins_and_sweep_again( node );
    }
    else if( behavior.eql( $sym45$SBHL_SIMPLE_TRUE_SEARCH_AND_UNWIND ) )
    {
      sbhl_simple_true_search_and_unwind( node );
    }
    else if( behavior.eql( $sym46$SBHL_LEAF_INSTANCES_SWEEP ) )
    {
  ...
  public static SubLObject apply_sbhl_mapping_function(final SubLObject node)
  {
    ...
    if( pcase_var.eql( $sym48$SBHL_CONSIDER_NODE ) )
    {
      sbhl_consider_node( node );
    }
    else if( pcase_var.eql( $sym49$SBHL_CONSIDER_UNMARKED_NODE ) )
    {
      sbhl_consider_unmarked_node( node );
    }
    else if( pcase_var.eql( $sym50$SBHL_SWEEP_WITH_CARRYING_MODULE ) )
    {
      sbhl_sweep_with_carrying_module( node );
    }
    else if( pcase_var.eql( $sym51$SBHL_STEP_WITH_CARRIED_MODULE ) )
    {
      sbhl_step_with_carried_module( node );
    }
    else if( pcase_var.eql( $sym52$SBHL_STEP_DISJOINS_AND_SWEEP_INHERITED ) )
    {
      sbhl_step_disjoins_and_sweep_inherited( node );
    }
    else if( pcase_var.eql( $sym53$SBHL_SWEEP_INHERITED_DISJOINS ) )
    {
      sbhl_sweep_inherited_disjoins( node );
    }
    else if( pcase_var.eql( $sym54$SBHL_STEP_AND_CHECK_MARKINGS ) )
    {
      sbhl_step_and_check_markings( node );
    }
    else if( pcase_var.eql( $sym55$SBHL_STEP_FALSE_AND_SWEEP_OPPOSITE ) )
    {
      sbhl_step_false_and_sweep_opposite( node );
    }
    else if( pcase_var.eql( $sym56$SBHL_SWEEP_OPPOSITE_FOR_FALSE ) )
    {
      sbhl_sweep_opposite_for_false( node );
    }
    else if( pcase_var.eql( $sym57$SBHL_CHECK_CUTOFF ) )
    {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_sweep( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ),
        $sym48$SBHL_CONSIDER_NODE, node, sbhl_search_vars.sbhl_unmarking_search_p() );
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_sweep_and_unwind( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ),
        $sym48$SBHL_CONSIDER_NODE, node, sbhl_search_vars.sbhl_unmarking_search_p() );
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_sweep( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_opposite_link_direction(), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ),
        $sym55$SBHL_STEP_FALSE_AND_SWEEP_OPPOSITE, node, sbhl_search_vars.sbhl_unmarking_search_p() );
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_step_and_test( sbhl_search_vars.get_sbhl_search_module(), sbhl_module_utilities.sbhl_search_direction_to_link_direction( sbhl_search_vars.get_sbhl_search_direction(), sbhl_module_vars.get_sbhl_module(
        UNPROVIDED ) ), sbhl_search_vars.sbhl_search_false_tv(), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ), $sym56$SBHL_SWEEP_OPPOSITE_FOR_FALSE, node, UNPROVIDED );
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_sweep( sbhl_search_vars.get_sbhl_search_gather_module(), sbhl_link_vars.get_sbhl_opposite_link_direction(), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(
        thread ), $sym48$SBHL_CONSIDER_NODE, node, sbhl_search_vars.sbhl_unmarking_search_p() );
    return NIL;
  }
  ...
  public static SubLObject sbhl_step_and_sweep_with_tt_module(final SubLObject node)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_step_and_test( sbhl_search_vars.get_sbhl_search_module(), sbhl_module_utilities.sbhl_search_direction_to_link_direction( sbhl_search_vars.get_sbhl_search_direction(), sbhl_module_vars.get_sbhl_module(
        UNPROVIDED ) ), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ), $sym50$SBHL_SWEEP_WITH_CARRYING_MODULE, node, UNPROVIDED );
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_sweep( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), ( NIL != sbhl_search_vars.sbhl_true_search_p() ) ? sbhl_link_vars.get_sbhl_link_direction()
        : sbhl_link_vars.get_sbhl_opposite_link_direction(), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ), $sym48$SBHL_CONSIDER_NODE, node, sbhl_search_vars
  ...
  public static SubLObject sbhl_sweep_with_tt_module_carry_step(final SubLObject node)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_sweep( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), ( NIL != sbhl_search_vars.sbhl_true_search_p() ) ? sbhl_link_vars.get_sbhl_link_direction()
        : sbhl_link_vars.get_sbhl_opposite_link_direction(), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ), $sym51$SBHL_STEP_WITH_CARRIED_MODULE, node, sbhl_search_vars
            .sbhl_unmarking_search_p() );
    return NIL;
  }
  ...
  public static SubLObject sbhl_step_with_carried_module(final SubLObject node)
  {
    ...
    sbhl_step_and_perform_marking( sbhl_search_vars.get_sbhl_search_module(), sbhl_module_utilities.sbhl_search_direction_to_link_direction( sbhl_search_vars.get_sbhl_search_direction(), sbhl_module_vars.get_sbhl_module(
        UNPROVIDED ) ), ( NIL != sbhl_search_vars.sbhl_true_search_p() ) ? sbhl_search_vars.sbhl_search_true_tv() : sbhl_search_vars.sbhl_search_false_tv(), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(
            thread ), $sym48$SBHL_CONSIDER_NODE, node, sbhl_search_vars.sbhl_unmarking_search_p() );
    return NIL;
  }
  ...
  public static SubLObject sbhl_sweep_step_disjoins_and_sweep_again(final SubLObject node)
  {
    ...
    else
    {
      ...
      sbhl_sweep( tt_module, ( NIL != sbhl_search_vars.sbhl_true_search_p() ) ? sbhl_module_utilities.get_sbhl_module_forward_direction( tt_module )
          : sbhl_module_utilities.get_sbhl_module_backward_direction( tt_module ), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ), ( NIL != sbhl_search_vars
              .sbhl_true_search_p() ) ? ( ( NIL != sbhl_search_vars.sbhl_boolean_search_p() ) ? $sym54$SBHL_STEP_AND_CHECK_MARKINGS : $sym52$SBHL_STEP_DISJOINS_AND_SWEEP_INHERITED )
                  : $sym58$SBHL_SWEEP_FORWARD_STEP_FALSE_DISJOINS_AND_SWEEP_FORWARD_NOTS, node, sbhl_search_vars.sbhl_unmarking_search_p() );
    }
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_step_and_test( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_undirected_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_marking_vars.$sbhl_gather_space$
        .getDynamicValue( thread ), $sym53$SBHL_SWEEP_INHERITED_DISJOINS, node, UNPROVIDED );
    return NIL;
  }
  ...
  public static SubLObject sbhl_sweep_inherited_disjoins(final SubLObject node)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject tt_module = sbhl_module_utilities.get_sbhl_disjoins_search_tt_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) );
    sbhl_sweep( tt_module, ( NIL != sbhl_search_vars.sbhl_true_search_p() ) ? sbhl_module_utilities.get_sbhl_module_backward_direction( tt_module ) : sbhl_module_utilities.get_sbhl_module_forward_direction( tt_module ),
        sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ), $sym48$SBHL_CONSIDER_NODE, node, sbhl_search_vars.sbhl_unmarking_search_p() );
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_step_through( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_undirected_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_marking_vars.$sbhl_space$.getDynamicValue(
        thread ), $sym59$SBHL_CONSIDER_ANY_NODE, node );
    return NIL;
  }
  ...
  public static SubLObject sbhl_empty_extent_p(final SubLObject node)
  {
    ...
    {
      return sbhl_search_methods.sbhl_gather_first_among_all_forward_true_nodes( sbhl_module_utilities.get_sbhl_disjoins_search_tt_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), node,
          $sym60$SBHL_NODE_LOCALLY_DISJOINT_WITH_SELF_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject sbhl_sweep_forward_step_false_disjoins_and_sweep_forward_nots(final SubLObject node)
  {
    ...
    {
      sbhl_sweep( tt_module, sbhl_module_utilities.get_sbhl_module_forward_direction( tt_module ), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ),
          $sym48$SBHL_CONSIDER_NODE, node, UNPROVIDED );
    }
    sbhl_step_and_test( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_undirected_direction(), sbhl_search_vars.sbhl_search_false_tv(), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ),
        $sym61$SBHL_SWEEP_FORWARD_NOTS, node, UNPROVIDED );
    return NIL;
  }
  ...
  public static SubLObject sbhl_sweep_and_gather_disjoins(final SubLObject node)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject tt_module = sbhl_module_utilities.get_sbhl_disjoins_search_tt_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) );
    sbhl_sweep( tt_module, ( NIL != sbhl_search_vars.sbhl_true_search_p() ) ? sbhl_module_utilities.get_sbhl_module_forward_direction( tt_module ) : sbhl_module_utilities.get_sbhl_module_backward_direction( tt_module ),
        sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ), $sym62$SBHL_STEP_GATHER_DISJOINS, node, UNPROVIDED );
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_step_and_perform_marking( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_undirected_direction(), ( NIL != sbhl_search_vars.sbhl_true_search_p() ) ? sbhl_search_vars.sbhl_search_true_tv()
        : sbhl_search_vars.sbhl_search_false_tv(), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ), $sym48$SBHL_CONSIDER_NODE, node, sbhl_search_vars.sbhl_unmarking_search_p() );
    return NIL;
  }
  ...
  public static SubLObject sbhl_sweep_and_gather_first_disjoin(final SubLObject node)
  {
    ...
    final SubLObject tt_module = sbhl_module_utilities.get_sbhl_disjoins_search_tt_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) );
    sbhl_sweep( tt_module, ( NIL != sbhl_search_vars.sbhl_true_search_p() ) ? sbhl_module_utilities.get_sbhl_module_forward_direction( tt_module ) : sbhl_module_utilities.get_sbhl_module_backward_direction( tt_module ),
        sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ), $sym63$SBHL_STEP_GATHER_FIRST_DISJOIN, node, UNPROVIDED );
    return NIL;
  }
  ...
  public static SubLObject sbhl_step_gather_first_disjoin(final SubLObject node)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_step_and_perform_marking( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_undirected_direction(), ( NIL != sbhl_search_vars.sbhl_true_search_p() ) ? sbhl_search_vars.sbhl_search_true_tv()
        : sbhl_search_vars.sbhl_search_false_tv(), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ), $sym59$SBHL_CONSIDER_ANY_NODE, node, sbhl_search_vars.sbhl_unmarking_search_p() );
    return NIL;
  }
  ...
  public static SubLObject determine_sbhl_sample_leaf_consider_fn(SubLObject different_leavesP)
  {
    ...
    {
      return $sym41$SBHL_GATHER_FIRST_DEAD_END_NODE_AND_ENQUEUE_OTHERS;
    }
    ...
    {
      return $sym64$SBHL_GATHER_FIRST_TARGET_UNMARKED_NODE;
    }
    return $sym65$SBHL_GATHER_FIRST_NODE;
  }
  ...
  public static SubLObject sbhl_leaf_instances_sweep(final SubLObject node)
  {
    ...
    try
    {
      sbhl_search_vars.$sbhl_unwind_function$.bind( $sym67$SBHL_LEAF_INSTANCES_STEP, thread );
      sbhl_search_vars.$sbhl_apply_unwind_function_p$.bind( T, thread );
      sbhl_sweep_and_unwind( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.sbhl_search_true_tv(),
          sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ), $sym68$SBHL_ENQUEUE_NODE_IN_LEAF_QUEUE, node, NIL );
    }
    finally
    {
  ...
  public static SubLObject sbhl_leaf_instances_step(final SubLObject node)
  {
    ...
    try
    {
      ...
      if( NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) )
      {
        sbhl_step_and_perform_marking( sbhl_search_vars.get_sbhl_search_module(), sbhl_module_utilities.sbhl_search_direction_to_link_direction( sbhl_search_vars.get_sbhl_search_direction(), sbhl_module_vars
            .get_sbhl_module( UNPROVIDED ) ), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ), $sym48$SBHL_CONSIDER_NODE, node, NIL );
        if( NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) )
        {
      ...
      if( NIL != sbhl_search_vars.sbhl_extremal_test_fn_p( node ) )
      {
        ...
        for( rest = NIL, rest = accessible_modules; NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL != rest; rest = rest.rest() )
        {
          ...
          try
          {
                ...
                if( NIL != mt_links )
                {
                      ...
                      && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                  {
                    ...
                    if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                    {
                      ...
                      {
                        sbhl_link_vars.$sbhl_link_mt$.bind( mt, thread );
                        for( iteration_state_$80 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread )
                            && NIL == dictionary_contents.do_dictionary_contents_doneP( iteration_state_$80 ); iteration_state_$80 = dictionary_contents.do_dictionary_contents_next( iteration_state_$80 ) )
                        {
                          thread.resetMultipleValues();
            ...
            else if( NIL != obsolete.cnat_p( node_$78, UNPROVIDED ) )
            {
              new_list = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars
                  .get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                  : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module(
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          sbhl_search_vars.$relevant_sbhl_tv_function$.bind( ( NIL != tv_var ) ? $sym69$RELEVANT_SBHL_TV_IS_GENERAL_TV : sbhl_search_vars.$relevant_sbhl_tv_function$.getDynamicValue( thread ), thread );
          if( NIL != tv_var && NIL != sbhl_paranoia.sbhl_object_type_checking_p() && NIL == sbhl_search_vars.sbhl_true_tv_p( tv_var ) )
          {
            final SubLObject pcase_var = sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread );
            if( pcase_var.eql( $kw70$ERROR ) )
            {
              sbhl_paranoia.sbhl_error( ONE_INTEGER, $str71$_A_is_not_a__A, tv_var, $sym72$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
            }
            else if( pcase_var.eql( $kw73$CERROR ) )
            {
              sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str74$continue_anyway, $str71$_A_is_not_a__A, tv_var, $sym72$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
            }
            else if( pcase_var.eql( $kw75$WARN ) )
            {
              Errors.warn( $str71$_A_is_not_a__A, tv_var, $sym72$SBHL_TRUE_TV_P );
            }
            else
            {
              Errors.warn( $str76$_A_is_not_a_valid__sbhl_type_erro, sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread ) );
              Errors.cerror( $str74$continue_anyway, $str71$_A_is_not_a__A, tv_var, $sym72$SBHL_TRUE_TV_P );
            }
          }
          ...
          try
          {
            sbhl_search_vars.$sbhl_search_truth$.bind( $const77$True_JustificationTruth, thread );
            ...
            try
            {
              sbhl_marking_vars.$sbhl_space$.bind( ( source == $kw13$OLD ) ? sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ) : sbhl_marking_vars.sbhl_get_new_space( source ), thread );
              final SubLObject _prev_bind_0_$88 = sbhl_marking_vars.$sbhl_gather_space$.currentBinding( thread );
              try
              {
                sbhl_marking_vars.$sbhl_gather_space$.bind( ( source == $kw13$OLD ) ? sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) : sbhl_marking_vars.sbhl_get_new_space( source ), thread );
  ...
  public static SubLObject sbhl_extremal_independent_nodes_such_that(final SubLObject node, final SubLObject function)
  {
    ...
    try
    {
      sbhl_search_vars.$sbhl_unwind_function$.bind( $sym79$SBHL_TEST_FOR_PREVIOUS_EXTREMAL_PATHS, thread );
  ...
  public static SubLObject sbhl_test_for_previous_extremal_paths(final SubLObject node)
  {
    ...
    if( NIL != sbhl_module_utilities.sbhl_module_indicates_predicate_search_p( sbhl_search_vars.get_sbhl_search_module() ) )
    {
      ...
      {
        sbhl_search_vars.$sbhl_result$.setDynamicValue( list_utilities.assoc_push( sbhl_module_vars.get_sbhl_module( $const80$genlInverse ), node, sbhl_search_vars.$sbhl_result$.getDynamicValue( thread ), UNPROVIDED ),
            thread );
      }
      else
      {
        sbhl_search_vars.$sbhl_result$.setDynamicValue( list_utilities.assoc_push( sbhl_module_vars.get_sbhl_module( $const81$genlPreds ), node, sbhl_search_vars.$sbhl_result$.getDynamicValue( thread ), UNPROVIDED ),
            thread );
      }
    }
    else
  ...
  public static SubLObject sbhl_check_disjoins_of_all_backward_nodes(final SubLObject node)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject tt_module = sbhl_module_utilities.get_sbhl_disjoins_search_tt_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) );
    sbhl_sweep( tt_module, sbhl_module_utilities.get_sbhl_module_backward_direction( tt_module ), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ),
        $sym82$SBHL_TARGET_SWEEP_STEP_DISJOINS_AND_CHECK, node, UNPROVIDED );
    return NIL;
  }
  ...
  public static SubLObject sbhl_target_sweep_step_disjoins_and_check(final SubLObject node)
  {
    ...
    try
    {
      ...
      final SubLObject tt_module = sbhl_module_utilities.get_sbhl_disjoins_search_tt_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) );
      sbhl_sweep( tt_module, sbhl_module_utilities.get_sbhl_module_forward_direction( tt_module ), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ),
          $sym54$SBHL_STEP_AND_CHECK_MARKINGS, node, UNPROVIDED );
    }
    finally
    {
      sbhl_marking_vars.$sbhl_space$.rebind( _prev_bind_0, thread );
  ...
  public static SubLObject note_kb_access_sbhl_link(final SubLObject node, final SubLObject link_node)
  {
    ...
    {
      final SubLObject formula = ( direction == $kw85$INVERSE ) ? el_utilities.make_binary_formula( predicate, link_node, node ) : el_utilities.make_binary_formula( predicate, node, link_node );
  ...
  {
    SubLFiles.declareFunction( me, "determine_sbhl_search_behavior", "DETERMINE-SBHL-SEARCH-BEHAVIOR", 3, 0, false );
    SubLFiles.declareFunction( me, "determine_sbhl_terminating_marking_space", "DETERMINE-SBHL-TERMINATING-MARKING-SPACE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_module_premarks_gather_nodes_p", "SBHL-MODULE-PREMARKS-GATHER-NODES-P", 0, 0, false );
    SubLFiles.declareFunction( me, "sbhl_just_gaf", "SBHL-JUST-GAF", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_just_mt", "SBHL-JUST-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_possibly_just_mt", "SBHL-POSSIBLY-JUST-MT", 1, 1, false );
    SubLFiles.declareFunction( me, "sbhl_just_tv", "SBHL-JUST-TV", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_gaf_pred", "SBHL-GAF-PRED", 1, 0, false );
    SubLFiles.declareFunction( me, "hl_default_tv", "HL-DEFAULT-TV", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_find_first_matching_gaf", "SBHL-FIND-FIRST-MATCHING-GAF", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_find_gaf", "SBHL-FIND-GAF", 3, 0, false );
    SubLFiles.declareFunction( me, "sbhl_assemble_justification_step", "SBHL-ASSEMBLE-JUSTIFICATION-STEP", 1, 1, false );
    SubLFiles.declareFunction( me, "sbhl_assemble_justification", "SBHL-ASSEMBLE-JUSTIFICATION", 1, 1, false );
    SubLFiles.declareFunction( me, "sbhl_handle_justification", "SBHL-HANDLE-JUSTIFICATION", 4, 4, false );
    SubLFiles.declareFunction( me, "sbhl_module_transitivity_support", "SBHL-MODULE-TRANSITIVITY-SUPPORT", 1, 1, false );
    SubLFiles.declareFunction( me, "sbhl_set_empty_extent_justification", "SBHL-SET-EMPTY-EXTENT-JUSTIFICATION", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_temporal_faux_link", "SBHL-TEMPORAL-FAUX-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "any_support_chain_of_temporal_link", "ANY-SUPPORT-CHAIN-OF-TEMPORAL-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "any_support_chain_of_link_disjunction_consequent", "ANY-SUPPORT-CHAIN-OF-LINK-DISJUNCTION-CONSEQUENT", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_node_valid_for_temporal_search_result_p", "SBHL-NODE-VALID-FOR-TEMPORAL-SEARCH-RESULT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "apply_sbhl_add_node_test", "APPLY-SBHL-ADD-NODE-TEST", 2, 0, false );
    SubLFiles.declareFunction( me, "apply_sbhl_add_unmarked_node_test", "APPLY-SBHL-ADD-UNMARKED-NODE-TEST", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_push_onto_result", "SBHL-PUSH-ONTO-RESULT", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_push_onto_result_if", "SBHL-PUSH-ONTO-RESULT-IF", 1, 0, false );
    new $sbhl_push_onto_result_if$UnaryFunction();
    SubLFiles.declareFunction( me, "sbhl_push_onto_result_if_and_stop_unless", "SBHL-PUSH-ONTO-RESULT-IF-AND-STOP-UNLESS", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_push_onto_result_with_prune", "SBHL-PUSH-ONTO-RESULT-WITH-PRUNE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_push_unwind_onto_result", "SBHL-PUSH-UNWIND-ONTO-RESULT", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_temporal_justification_unwind", "SBHL-TEMPORAL-JUSTIFICATION-UNWIND", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_apply_compose_fn", "SBHL-APPLY-COMPOSE-FN", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_apply_compose_fn_if", "SBHL-APPLY-COMPOSE-FN-IF", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_apply_compose_fn_and_combine_with_result", "SBHL-APPLY-COMPOSE-FN-AND-COMBINE-WITH-RESULT", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_non_nil_result", "SBHL-GATHER-FIRST-NON-NIL-RESULT", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_non_nil_result_with_prune", "SBHL-GATHER-FIRST-NON-NIL-RESULT-WITH-PRUNE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_dead_end_node_and_enqueue_others", "SBHL-GATHER-FIRST-DEAD-END-NODE-AND-ENQUEUE-OTHERS", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_node", "SBHL-GATHER-FIRST-NODE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_target_unmarked_node", "SBHL-GATHER-FIRST-TARGET-UNMARKED-NODE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_search_has_multiple_goals_p", "SBHL-SEARCH-HAS-MULTIPLE-GOALS-P", 0, 0, false );
    SubLFiles.declareFunction( me, "set_sbhl_boolean_goal_conditions", "SET-SBHL-BOOLEAN-GOAL-CONDITIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "sbhl_node_marked_as_goal_node", "SBHL-NODE-MARKED-AS-GOAL-NODE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_node_is_goal_node", "SBHL-NODE-IS-GOAL-NODE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_node_is_a_goal_node", "SBHL-NODE-IS-A-GOAL-NODE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_reached_cutoff_p", "SBHL-REACHED-CUTOFF-P", 0, 0, false );
    SubLFiles.declareFunction( me, "sbhl_check_cutoff", "SBHL-CHECK-CUTOFF", 1, 0, false );
    new $sbhl_check_cutoff$UnaryFunction();
    SubLFiles.declareFunction( me, "apply_sbhl_consider_node_fn", "APPLY-SBHL-CONSIDER-NODE-FN", 2, 0, false );
    SubLFiles.declareFunction( me, "apply_sbhl_consider_unmarked_node_fn", "APPLY-SBHL-CONSIDER-UNMARKED-NODE-FN", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_consider_node", "SBHL-CONSIDER-NODE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_consider_any_node", "SBHL-CONSIDER-ANY-NODE", 1, 0, false );
    new $sbhl_consider_any_node$UnaryFunction();
    SubLFiles.declareFunction( me, "sbhl_consider_unmarked_node", "SBHL-CONSIDER-UNMARKED-NODE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_mark_and_sweep", "SBHL-MARK-AND-SWEEP", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_and_sweep", "SBHL-UNMARK-AND-SWEEP", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_mark_sweep_and_unwind", "SBHL-MARK-SWEEP-AND-UNWIND", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_time_mark_and_sweep", "SBHL-TIME-MARK-AND-SWEEP", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_and_suspend_mark", "SBHL-STEP-AND-SUSPEND-MARK", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_and_suspend_unmark", "SBHL-STEP-AND-SUSPEND-UNMARK", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_and_mark", "SBHL-STEP-AND-MARK", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_and_unmark", "SBHL-STEP-AND-UNMARK", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_sweep", "SBHL-SWEEP", 6, 1, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_sweep", "SBHL-UNMARK-SWEEP", 6, 0, false );
    SubLFiles.declareFunction( me, "sbhl_sweep_and_unwind", "SBHL-SWEEP-AND-UNWIND", 6, 1, false );
    SubLFiles.declareFunction( me, "sbhl_step", "SBHL-STEP", 6, 2, false );
    SubLFiles.declareFunction( me, "sbhl_step_through", "SBHL-STEP-THROUGH", 6, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_and_test", "SBHL-STEP-AND-TEST", 6, 1, false );
    SubLFiles.declareFunction( me, "sbhl_step_and_perform_marking", "SBHL-STEP-AND-PERFORM-MARKING", 6, 1, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_step", "SBHL-UNMARK-STEP", 6, 1, false );
    SubLFiles.declareFunction( me, "apply_sbhl_search_behavior", "APPLY-SBHL-SEARCH-BEHAVIOR", 2, 0, false );
    SubLFiles.declareFunction( me, "apply_sbhl_mapping_function", "APPLY-SBHL-MAPPING-FUNCTION", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_apply_unwind_function", "SBHL-APPLY-UNWIND-FUNCTION", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_simple_true_search", "SBHL-SIMPLE-TRUE-SEARCH", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_simple_true_search_and_unwind", "SBHL-SIMPLE-TRUE-SEARCH-AND-UNWIND", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_simple_false_search", "SBHL-SIMPLE-FALSE-SEARCH", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_false_and_sweep_opposite", "SBHL-STEP-FALSE-AND-SWEEP-OPPOSITE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_sweep_opposite_for_false", "SBHL-SWEEP-OPPOSITE-FOR-FALSE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_and_sweep_with_tt_module", "SBHL-STEP-AND-SWEEP-WITH-TT-MODULE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_sweep_with_carrying_module", "SBHL-SWEEP-WITH-CARRYING-MODULE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_sweep_with_tt_module_carry_step", "SBHL-SWEEP-WITH-TT-MODULE-CARRY-STEP", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_with_carried_module", "SBHL-STEP-WITH-CARRIED-MODULE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_sweep_step_disjoins_and_sweep_again", "SBHL-SWEEP-STEP-DISJOINS-AND-SWEEP-AGAIN", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_disjoins_and_sweep_inherited", "SBHL-STEP-DISJOINS-AND-SWEEP-INHERITED", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_sweep_inherited_disjoins", "SBHL-SWEEP-INHERITED-DISJOINS", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_and_check_markings", "SBHL-STEP-AND-CHECK-MARKINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_node_locally_disjoint_with_self_p", "SBHL-NODE-LOCALLY-DISJOINT-WITH-SELF-P", 1, 0, false );
    new $sbhl_node_locally_disjoint_with_self_p$UnaryFunction();
    SubLFiles.declareFunction( me, "sbhl_empty_extent_p", "SBHL-EMPTY-EXTENT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_goal_empty_extent_p", "SBHL-GOAL-EMPTY-EXTENT-P", 0, 0, false );
    SubLFiles.declareFunction( me, "sbhl_sweep_forward_step_false_disjoins_and_sweep_forward_nots", "SBHL-SWEEP-FORWARD-STEP-FALSE-DISJOINS-AND-SWEEP-FORWARD-NOTS", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_sweep_forward_nots", "SBHL-SWEEP-FORWARD-NOTS", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_sweep_and_gather_disjoins", "SBHL-SWEEP-AND-GATHER-DISJOINS", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_gather_disjoins", "SBHL-STEP-GATHER-DISJOINS", 1, 0, false );
    new $sbhl_step_gather_disjoins$UnaryFunction();
    SubLFiles.declareFunction( me, "sbhl_sweep_and_gather_first_disjoin", "SBHL-SWEEP-AND-GATHER-FIRST-DISJOIN", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_step_gather_first_disjoin", "SBHL-STEP-GATHER-FIRST-DISJOIN", 1, 0, false );
    SubLFiles.declareFunction( me, "determine_sbhl_sample_leaf_consider_fn", "DETERMINE-SBHL-SAMPLE-LEAF-CONSIDER-FN", 0, 1, false );
    SubLFiles.declareFunction( me, "sbhl_enqueue_node_in_leaf_queue", "SBHL-ENQUEUE-NODE-IN-LEAF-QUEUE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_leaf_instances_sweep", "SBHL-LEAF-INSTANCES-SWEEP", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_leaf_instances_step", "SBHL-LEAF-INSTANCES-STEP", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_mark_and_sweep_extremal_independent_nodes", "SBHL-MARK-AND-SWEEP-EXTREMAL-INDEPENDENT-NODES", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_min_backward_true_nodes_such_that", "SBHL-MIN-BACKWARD-TRUE-NODES-SUCH-THAT", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_extremal_independent_nodes_such_that", "SBHL-EXTREMAL-INDEPENDENT-NODES-SUCH-THAT", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_test_for_previous_extremal_paths", "SBHL-TEST-FOR-PREVIOUS-EXTREMAL-PATHS", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_check_disjoins_of_all_backward_nodes", "SBHL-CHECK-DISJOINS-OF-ALL-BACKWARD-NODES", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_target_sweep_step_disjoins_and_check", "SBHL-TARGET-SWEEP-STEP-DISJOINS-AND-CHECK", 1, 0, false );
    SubLFiles.declareFunction( me, "note_kb_access_sbhl_link", "NOTE-KB-ACCESS-SBHL-LINK", 2, 0, false );
    return NIL;
  }
  ...
  static
  {
    me = new sbhl_search_utilities();
    $sym0$SBHL_MODULE_P = makeSymbol( "SBHL-MODULE-P" );
    $sym1$SBHL_SIMPLE_TRUE_SEARCH = makeSymbol( "SBHL-SIMPLE-TRUE-SEARCH" );
    $sym2$SBHL_SIMPLE_FALSE_SEARCH = makeSymbol( "SBHL-SIMPLE-FALSE-SEARCH" );
    $sym3$SBHL_STEP_AND_SWEEP_WITH_TT_MODULE = makeSymbol( "SBHL-STEP-AND-SWEEP-WITH-TT-MODULE" );
    $sym4$SBHL_SWEEP_WITH_TT_MODULE_CARRY_STEP = makeSymbol( "SBHL-SWEEP-WITH-TT-MODULE-CARRY-STEP" );
    $sym5$SBHL_SWEEP_STEP_DISJOINS_AND_SWEEP_AGAIN = makeSymbol( "SBHL-SWEEP-STEP-DISJOINS-AND-SWEEP-AGAIN" );
    $str6$Search_behavior_not_recognized__S = makeString( "Search behavior not recognized. Sorry." );
    $str7$Search_Behavior_not_recognized___ = makeString( "Search Behavior not recognized: ~a" );
    $kw8$TRUE = makeKeyword( "TRUE" );
    $kw9$TRUE_DEF = makeKeyword( "TRUE-DEF" );
    $kw10$FALSE = makeKeyword( "FALSE" );
    $kw11$FALSE_DEF = makeKeyword( "FALSE-DEF" );
    $list12 = ConsesLow.list( makeSymbol( "PRED" ), makeSymbol( "ARG1" ), makeSymbol( "ARG2" ) );
    $kw13$OLD = makeKeyword( "OLD" );
    $kw14$ASSERTION = makeKeyword( "ASSERTION" );
    $kw15$VERBOSE = makeKeyword( "VERBOSE" );
    $str16$incorrect_justification_assembly_ = makeString( "incorrect justification assembly ~a" );
    $kw17$REFLEXIVE = makeKeyword( "REFLEXIVE" );
    $const18$equals = constant_handles.reader_make_constant_shell( makeString( "equals" ) );
    $const19$MonotonicallyTrue = constant_handles.reader_make_constant_shell( makeString( "MonotonicallyTrue" ) );
    $sym20$SBHL_TEMPORAL_JUSTIFICATION_UNWIND = makeSymbol( "SBHL-TEMPORAL-JUSTIFICATION-UNWIND" );
    $sym21$SBHL_PUSH_UNWIND_ONTO_RESULT = makeSymbol( "SBHL-PUSH-UNWIND-ONTO-RESULT" );
    $str22$_S_is_not_a_transitive_module = makeString( "~S is not a transitive module" );
    $const23$UniversalVocabularyMt = constant_handles.reader_make_constant_shell( makeString( "UniversalVocabularyMt" ) );
    $const24$disjointWith = constant_handles.reader_make_constant_shell( makeString( "disjointWith" ) );
    $sym25$NOT_GENL_INVERSE_MODE_P = makeSymbol( "NOT-GENL-INVERSE-MODE-P" );
    $sym26$GENL_INVERSE_MODE_P = makeSymbol( "GENL-INVERSE-MODE-P" );
    $sym27$NON_EMPTY_EXTENT = makeSymbol( "NON-EMPTY-EXTENT" );
    $sym28$SBHL_NODE_VALID_FOR_TEMPORAL_SEARCH_RESULT_P = makeSymbol( "SBHL-NODE-VALID-FOR-TEMPORAL-SEARCH-RESULT-P" );
    $str29$Using_potentially_unsupported_gat = makeString( "Using potentially unsupported gather gating behavior: ~a" );
    $str30$Using_potentially_unsupported_unm = makeString( "Using potentially unsupported unmark gather gating behavior: ~a" );
    $list31 = ConsesLow.list( makeSymbol( "RESULT" ), makeSymbol( "DONE?" ) );
    $sym32$SBHL_PUSH_ONTO_RESULT = makeSymbol( "SBHL-PUSH-ONTO-RESULT" );
    $sym33$SBHL_PUSH_ONTO_RESULT_WITH_PRUNE = makeSymbol( "SBHL-PUSH-ONTO-RESULT-WITH-PRUNE" );
    $sym34$SBHL_NODE_IS_GOAL_NODE = makeSymbol( "SBHL-NODE-IS-GOAL-NODE" );
    $sym35$SBHL_NODE_MARKED_AS_GOAL_NODE = makeSymbol( "SBHL-NODE-MARKED-AS-GOAL-NODE" );
    $sym36$SBHL_GATHER_FIRST_NON_NIL_RESULT = makeSymbol( "SBHL-GATHER-FIRST-NON-NIL-RESULT" );
    $sym37$SBHL_GATHER_FIRST_NON_NIL_RESULT_WITH_PRUNE = makeSymbol( "SBHL-GATHER-FIRST-NON-NIL-RESULT-WITH-PRUNE" );
    $sym38$SBHL_APPLY_COMPOSE_FN = makeSymbol( "SBHL-APPLY-COMPOSE-FN" );
    $sym39$SBHL_APPLY_COMPOSE_FN_AND_COMBINE_WITH_RESULT = makeSymbol( "SBHL-APPLY-COMPOSE-FN-AND-COMBINE-WITH-RESULT" );
    $sym40$SBHL_GATHER_DEAD_END_NODES = makeSymbol( "SBHL-GATHER-DEAD-END-NODES" );
    $sym41$SBHL_GATHER_FIRST_DEAD_END_NODE_AND_ENQUEUE_OTHERS = makeSymbol( "SBHL-GATHER-FIRST-DEAD-END-NODE-AND-ENQUEUE-OTHERS" );
    ...
    $list44 = ConsesLow.list( makeUninternedSymbol( "LINK-NODE" ), makeUninternedSymbol( "MT" ), makeUninternedSymbol( "TV" ) );
    $sym45$SBHL_SIMPLE_TRUE_SEARCH_AND_UNWIND = makeSymbol( "SBHL-SIMPLE-TRUE-SEARCH-AND-UNWIND" );
    $sym46$SBHL_LEAF_INSTANCES_SWEEP = makeSymbol( "SBHL-LEAF-INSTANCES-SWEEP" );
    $str47$attempt_to_call_unsupported_sbhl_ = makeString( "attempt to call unsupported sbhl search behavior: ~a~%" );
    $sym48$SBHL_CONSIDER_NODE = makeSymbol( "SBHL-CONSIDER-NODE" );
    $sym49$SBHL_CONSIDER_UNMARKED_NODE = makeSymbol( "SBHL-CONSIDER-UNMARKED-NODE" );
    $sym50$SBHL_SWEEP_WITH_CARRYING_MODULE = makeSymbol( "SBHL-SWEEP-WITH-CARRYING-MODULE" );
    $sym51$SBHL_STEP_WITH_CARRIED_MODULE = makeSymbol( "SBHL-STEP-WITH-CARRIED-MODULE" );
    $sym52$SBHL_STEP_DISJOINS_AND_SWEEP_INHERITED = makeSymbol( "SBHL-STEP-DISJOINS-AND-SWEEP-INHERITED" );
    $sym53$SBHL_SWEEP_INHERITED_DISJOINS = makeSymbol( "SBHL-SWEEP-INHERITED-DISJOINS" );
    $sym54$SBHL_STEP_AND_CHECK_MARKINGS = makeSymbol( "SBHL-STEP-AND-CHECK-MARKINGS" );
    $sym55$SBHL_STEP_FALSE_AND_SWEEP_OPPOSITE = makeSymbol( "SBHL-STEP-FALSE-AND-SWEEP-OPPOSITE" );
    $sym56$SBHL_SWEEP_OPPOSITE_FOR_FALSE = makeSymbol( "SBHL-SWEEP-OPPOSITE-FOR-FALSE" );
    $sym57$SBHL_CHECK_CUTOFF = makeSymbol( "SBHL-CHECK-CUTOFF" );
    $sym58$SBHL_SWEEP_FORWARD_STEP_FALSE_DISJOINS_AND_SWEEP_FORWARD_NOTS = makeSymbol( "SBHL-SWEEP-FORWARD-STEP-FALSE-DISJOINS-AND-SWEEP-FORWARD-NOTS" );
    $sym59$SBHL_CONSIDER_ANY_NODE = makeSymbol( "SBHL-CONSIDER-ANY-NODE" );
    $sym60$SBHL_NODE_LOCALLY_DISJOINT_WITH_SELF_P = makeSymbol( "SBHL-NODE-LOCALLY-DISJOINT-WITH-SELF-P" );
    $sym61$SBHL_SWEEP_FORWARD_NOTS = makeSymbol( "SBHL-SWEEP-FORWARD-NOTS" );
    $sym62$SBHL_STEP_GATHER_DISJOINS = makeSymbol( "SBHL-STEP-GATHER-DISJOINS" );
    $sym63$SBHL_STEP_GATHER_FIRST_DISJOIN = makeSymbol( "SBHL-STEP-GATHER-FIRST-DISJOIN" );
    $sym64$SBHL_GATHER_FIRST_TARGET_UNMARKED_NODE = makeSymbol( "SBHL-GATHER-FIRST-TARGET-UNMARKED-NODE" );
    $sym65$SBHL_GATHER_FIRST_NODE = makeSymbol( "SBHL-GATHER-FIRST-NODE" );
    $str66$invalid_module_type__a = makeString( "invalid module type ~a" );
    $sym67$SBHL_LEAF_INSTANCES_STEP = makeSymbol( "SBHL-LEAF-INSTANCES-STEP" );
    $sym68$SBHL_ENQUEUE_NODE_IN_LEAF_QUEUE = makeSymbol( "SBHL-ENQUEUE-NODE-IN-LEAF-QUEUE" );
    $sym69$RELEVANT_SBHL_TV_IS_GENERAL_TV = makeSymbol( "RELEVANT-SBHL-TV-IS-GENERAL-TV" );
    $kw70$ERROR = makeKeyword( "ERROR" );
    $str71$_A_is_not_a__A = makeString( "~A is not a ~A" );
    $sym72$SBHL_TRUE_TV_P = makeSymbol( "SBHL-TRUE-TV-P" );
    $kw73$CERROR = makeKeyword( "CERROR" );
    $str74$continue_anyway = makeString( "continue anyway" );
    $kw75$WARN = makeKeyword( "WARN" );
    $str76$_A_is_not_a_valid__sbhl_type_erro = makeString( "~A is not a valid *sbhl-type-error-action* value" );
    $const77$True_JustificationTruth = constant_handles.reader_make_constant_shell( makeString( "True-JustificationTruth" ) );
    $kw78$RESOURCE = makeKeyword( "RESOURCE" );
    $sym79$SBHL_TEST_FOR_PREVIOUS_EXTREMAL_PATHS = makeSymbol( "SBHL-TEST-FOR-PREVIOUS-EXTREMAL-PATHS" );
    $const80$genlInverse = constant_handles.reader_make_constant_shell( makeString( "genlInverse" ) );
    $const81$genlPreds = constant_handles.reader_make_constant_shell( makeString( "genlPreds" ) );
    $sym82$SBHL_TARGET_SWEEP_STEP_DISJOINS_AND_CHECK = makeSymbol( "SBHL-TARGET-SWEEP-STEP-DISJOINS-AND-CHECK" );
    $list83 = ConsesLow.list( makeKeyword( "PREDICATE" ), makeKeyword( "INVERSE" ) );
    $str84$Unexpected_direction____S = makeString( "Unexpected direction : ~S" );
    $kw85$INVERSE = makeKeyword( "INVERSE" );
    $str86$KB_access_missed_for_SBHL__S_to__ = makeString( "KB access missed for SBHL ~S to ~S for ~S" );
    $str87$KB_access_missed_for_SBHL__S_to__ = makeString( "KB access missed for SBHL ~S to ~S" );
  }

  public static final class $sbhl_push_onto_result_if$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $sbhl_check_cutoff$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $sbhl_consider_any_node$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $sbhl_node_locally_disjoint_with_self_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $sbhl_step_gather_disjoins$UnaryFunction
      extends
        UnaryFunction
  {
