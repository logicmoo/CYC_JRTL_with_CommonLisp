      ...
      SubLTranslatedFile
{
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          sbhl_search_vars.$relevant_sbhl_tv_function$.bind( ( NIL != tv_var ) ? $sym1$RELEVANT_SBHL_TV_IS_GENERAL_TV : sbhl_search_vars.$relevant_sbhl_tv_function$.getDynamicValue( thread ), thread );
          ...
          try
          {
            ...
            try
            {
              sbhl_marking_vars.$sbhl_space$.bind( ( source == $kw10$OLD ) ? sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ) : sbhl_marking_vars.sbhl_get_new_space( source ), thread );
              final SubLObject _prev_bind_0_$5 = sbhl_marking_vars.$sbhl_gather_space$.currentBinding( thread );
              try
              {
                sbhl_marking_vars.$sbhl_gather_space$.bind( ( source == $kw10$OLD ) ? sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) : sbhl_marking_vars.sbhl_get_new_space( source ), thread );
      ...
      try
      {
        ...
        try
        {
          ...
          if( NIL != tv_var && NIL != sbhl_paranoia.sbhl_object_type_checking_p() && NIL == sbhl_search_vars.sbhl_false_tv_p( tv_var ) )
          {
            ...
            {
              sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str6$continue_anyway, $str3$_A_is_not_a__A, tv_var, $sym13$SBHL_FALSE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
            }
            else if( pcase_var.eql( $kw7$WARN ) )
            {
  ...
  public static SubLObject sbhl_transitive_closure(final SubLObject node)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        {
          sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str15$Node__a_does_not_pass_sbhl_type_t, node, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED, UNPROVIDED,
              UNPROVIDED );
        }
      }
      finally
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym16$SBHL_PUSH_ONTO_RESULT_WITH_PRUNE, thread );
                      result = sbhl_transitive_closure( node );
                    }
                    finally
                    {
  ...
  public static SubLObject sbhl_extremes(final SubLObject node)
  {
    ...
    try
    {
      sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym18$SBHL_GATHER_DEAD_END_NODES, thread );
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      try
                      {
                        ...
                        {
                          sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str15$Node__a_does_not_pass_sbhl_type_t, node, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED,
              ...
              try
              {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      sbhl_search_vars.$sbhl_compose_fn$.bind( Symbols.symbol_function( IDENTITY ), thread );
              ...
              try
              {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    {
                      sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str15$Node__a_does_not_pass_sbhl_type_t, start_node, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED,
                          UNPROVIDED, UNPROVIDED );
                    }
                  }
                  finally
  ...
  public static SubLObject sbhl_sample_extremal_nodes(final SubLObject start_node, final SubLObject samples, SubLObject different_leavesP)
  {
    ...
    try
    {
      ...
      try
      {
        sbhl_search_vars.$sbhl_sample_leaf_queues$.bind( ConsesLow.list( queue ), thread );
        sbhl_search_vars.$sbhl_search_behavior$.bind( ( NIL != sbhl_module_utilities.sbhl_transfers_through_module_p( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) ) ? $sym20$SBHL_LEAF_INSTANCES_SWEEP
          ...
          try
          {
            ...
            while ( NIL != sbhl_search_vars.$sbhl_sample_leaf_queues$.getDynamicValue( thread ) && NIL == leaf)
            {
              ...
              try
              {
                ...
                if( NIL != leaf )
                {
                  result = ConsesLow.cons( leaf, result );
                }
                if( NIL != leaf )
                {
                  ConsesLow.rplacd( conses_high.last( sbhl_search_vars.$sbhl_sample_leaf_queues$.getDynamicValue( thread ), UNPROVIDED ), ConsesLow.list( queue_$276, sbhl_search_vars.$sbhl_current_leaf_queue$
              ...
              sbhl_search_vars.$sbhl_sample_leaf_queues$.setDynamicValue( Sequences.remove_if( $sym22$QUEUE_EMPTY_P, sbhl_search_vars.$sbhl_sample_leaf_queues$.getDynamicValue( thread ), UNPROVIDED, UNPROVIDED,
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    if( NIL != sbhl_paranoia.sbhl_object_type_checking_p() && !function.isFunctionSpec() )
                    {
                      ...
                      else if( pcase_var2.eql( $kw7$WARN ) )
                      {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    if( NIL != sbhl_paranoia.sbhl_object_type_checking_p() && !fn.isFunctionSpec() )
                    {
                      ...
                      {
                        sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str6$continue_anyway, $str3$_A_is_not_a__A, fn, $sym23$FUNCTION_SPEC_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      }
                      else if( pcase_var2.eql( $kw7$WARN ) )
                      {
                    ...
                    if( NIL != sbhl_paranoia.sbhl_object_type_checking_p() && !test_fn.isFunctionSpec() )
                    {
                      ...
                      if( pcase_var2.eql( $kw2$ERROR ) )
                      {
                        sbhl_paranoia.sbhl_error( ONE_INTEGER, $str3$_A_is_not_a__A, test_fn, $sym23$FUNCTION_SPEC_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      }
                      else if( pcase_var2.eql( $kw5$CERROR ) )
                      {
                        sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str6$continue_anyway, $str3$_A_is_not_a__A, test_fn, $sym23$FUNCTION_SPEC_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      }
                      else if( pcase_var2.eql( $kw7$WARN ) )
                      {
                        Errors.warn( $str3$_A_is_not_a__A, test_fn, $sym23$FUNCTION_SPEC_P );
                      }
                      else
                      {
                        Errors.warn( $str8$_A_is_not_a_valid__sbhl_type_erro, sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread ) );
                        Errors.cerror( $str6$continue_anyway, $str3$_A_is_not_a__A, test_fn, $sym23$FUNCTION_SPEC_P );
                      }
                    }
                    ...
                    try
                    {
                      ...
                      sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym25$SBHL_APPLY_COMPOSE_FN_IF, thread );
                      sbhl_search_vars.$sbhl_search_type$.bind( $kw17$CLOSURE, thread );
                      if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( node, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                      {
                        sbhl_search_utilities.apply_sbhl_search_behavior( sbhl_search_vars.get_sbhl_search_behavior(), node );
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      sbhl_search_vars.$sbhl_unwind_function$.bind( $sym26$SBHL_PUSH_UNWIND_ONTO_RESULT, thread );
                      sbhl_search_vars.$sbhl_search_type$.bind( $kw17$CLOSURE, thread );
                      final SubLObject behavior = sbhl_search_vars.get_sbhl_search_behavior();
                      SubLObject cdolist_list_var = nodes;
                      SubLObject node = NIL;
  ...
  public static SubLObject sbhl_closure_if(final SubLObject node, final SubLObject fn)
  {
    ...
    try
    {
      sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym29$SBHL_PUSH_ONTO_RESULT_IF, thread );
      sbhl_search_vars.$sbhl_compose_fn$.bind( fn, thread );
      result = sbhl_transitive_closure( node );
    }
    finally
  ...
  public static SubLObject sbhl_closure_if_and_stop_unless(final SubLObject node, final SubLObject fn)
  {
    ...
    try
    {
      sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym30$SBHL_PUSH_ONTO_RESULT_IF_AND_STOP_UNLESS, thread );
      sbhl_search_vars.$sbhl_compose_fn$.bind( fn, thread );
      result = sbhl_transitive_closure( node );
    }
    finally
                      ...
                      try
                      {
                        ...
                        if( NIL != sbhl_marking_utilities.sbhl_search_path_termination_p( node, UNPROVIDED ) )
                        {
                          ...
                          try
                          {
                            ...
                            if( NIL != result )
                            {
                              cycles = ConsesLow.cons( result, cycles );
                            }
                          }
                          finally
                          {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      while ( NIL != cdolist_list_var)
                      {
                        ...
                        try
                        {
                          sbhl_marking_vars.$sbhl_space$.bind( ( source_$715 == $kw10$OLD ) ? sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ) : sbhl_marking_vars.sbhl_get_new_space( source_$715 ), thread );
                          final SubLObject _prev_bind_0_$706 = sbhl_marking_vars.$sbhl_gather_space$.currentBinding( thread );
                          try
                          {
                            sbhl_marking_vars.$sbhl_gather_space$.bind( ( source_$715 == $kw10$OLD ) ? sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread )
                                : sbhl_marking_vars.sbhl_get_new_space( source_$715 ), thread );
                            ...
                            try
                            {
                              ...
                              try
                              {
                                ...
                                final SubLObject cyclic_nodes = conses_high.member( node, cycles, $sym32$MEMBER_, UNPROVIDED ).first();
                                SubLObject other_nodes = NIL;
                                other_nodes = ( ( NIL != cyclic_nodes ) ? conses_high.set_difference( unique_nodes, cyclic_nodes, UNPROVIDED, UNPROVIDED )
                                    : Sequences.remove( node, unique_nodes, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
                                if( NIL == subl_promotions.memberP( node, visited_nodes, UNPROVIDED, UNPROVIDED ) )
                                {
                                  ...
                                  if( NIL == sbhl_path_from_node_to_any_of_nodes_p( node, other_nodes ) )
                                  {
                                    ...
                                    {
                                      max_nodes = ConsesLow.cons( node, max_nodes );
                                    }
                                  }
                                }
                              }
  ...
  {
    final SubLObject others = Numbers.subtract( Sequences.length( nodes ), ONE_INTEGER );
  ...
  public static SubLObject sbhl_min_forward_true_link_nodes(final SubLObject module, final SubLObject node, SubLObject mt, SubLObject tv)
  {
    ...
    if( NIL == local_forwards )
    {
      ...
      return ( NIL != root ) ? ConsesLow.list( root ) : NIL;
    }
  ...
  public static SubLObject sbhl_mark_closure_up_to_horizon(final SubLObject node)
  {
    ...
    try
    {
      sbhl_search_vars.$sbhl_search_behavior$.bind( sbhl_search_utilities.determine_sbhl_search_behavior( sbhl_search_vars.get_sbhl_search_module(), sbhl_search_vars.get_sbhl_search_direction(), sbhl_search_vars
          .get_sbhl_tv() ), thread );
      sbhl_marking_vars.$sbhl_terminating_marking_space$.bind( sbhl_search_utilities.determine_sbhl_terminating_marking_space( sbhl_search_vars.$sbhl_search_behavior$.getDynamicValue( thread ) ), thread );
      sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym35$SBHL_STOP_AT_HORIZON, thread );
  ...
  public static SubLObject sbhl_common_horizon(SubLObject nodes, SubLObject candidates)
  {
    ...
    final SubLObject redux_module = ( NIL != transfers_through_searchP ) ? sbhl_module_utilities.get_sbhl_reductions_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) )
        : sbhl_module_vars.$sbhl_module$.getDynamicValue( thread );
            ...
            if( NIL == empty_intersectionP )
            {
              ...
              try
              {
                while ( Hashtables.iteratorHasNext( cdohash_iterator ))
                {
                  ...
                  {
                    result = ConsesLow.cons( node2, result );
                  }
                }
              }
              finally
    ...
    if( NIL != candidates )
    {
      return conses_high.intersection( nodes, candidates, UNPROVIDED, UNPROVIDED );
    }
    return nodes;
  }
                                ...
                                try
                                {
                                  ...
                                  if( NIL != sbhl_marking_utilities.sbhl_search_path_termination_p( node, UNPROVIDED ) )
                                  {
                                    ...
                                    while ( NIL != cdolist_list_var_$773)
                                    {
                                      ...
                                      {
                                        pushedP = T;
                                        result = ConsesLow.cons( cycle_node, result );
                                      }
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      while ( NIL != cdolist_list_var)
                      {
                        ...
                        try
                        {
                          sbhl_search_vars.$genl_inverse_mode_p$.bind( sbhl_module_vars.get_sbhl_module_link_pred( module ).eql( $const36$genlInverse ) ? T : NIL, thread );
      ...
      try
      {
        ...
        try
        {
          sbhl_search_vars.$sbhl_search_behavior$.bind( sbhl_search_utilities.determine_sbhl_search_behavior( sbhl_search_vars.get_sbhl_search_module(), sbhl_search_vars.get_sbhl_search_direction(), sbhl_search_vars
              .get_sbhl_tv() ), thread );
          sbhl_marking_vars.$sbhl_terminating_marking_space$.bind( sbhl_search_utilities.determine_sbhl_terminating_marking_space( sbhl_search_vars.$sbhl_search_behavior$.getDynamicValue( thread ) ), thread );
          sbhl_search_vars.$sbhl_compose_fn$.bind( $sym31$SBHL_MARKED_IN_TARGET_SPACE_P, thread );
          sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym19$SBHL_GATHER_FIRST_NON_NIL_RESULT, thread );
          result = sbhl_transitive_closure( node );
        }
        finally
  ...
  public static SubLObject sbhl_all_goals_with_no_path_from_nodes(final SubLObject nodes, final SubLObject goals)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        result = ConsesLow.cons( goal, result );
      }
      cdolist_list_var = cdolist_list_var.rest();
      goal = cdolist_list_var.first();
    }
  ...
  public static SubLObject sbhl_all_backward_true_nodes_among(final SubLObject module, final SubLObject node, final SubLObject nodes, SubLObject mt, SubLObject tv)
  {
    ...
    if( NIL != nodes )
    {
      if( NIL != list_utilities.every_in_list( $sym37$FORT_P, nodes, UNPROVIDED ) && Functions.apply( $sym38$_, Mapping.mapcar( $sym39$GENL_CARDINALITY, nodes ) ).numL( cardinality_estimates.spec_cardinality( node ) ) )
      {
        SubLObject cdolist_list_var = nodes;
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          {
            result = ConsesLow.cons( backward_node, result );
          }
          cdolist_list_var = cdolist_list_var.rest();
          backward_node = cdolist_list_var.first();
        }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_search_utilities.sbhl_sweep( sbhl_module_vars.get_sbhl_module( UNPROVIDED ), sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.get_sbhl_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ),
        $sym40$SBHL_PUSH_DEPENDENT_NODES_ONTO_RESULT, node, UNPROVIDED );
    return NIL;
  }
      ...
      try
      {
        ...
        try
        {
          ...
          try
          {
            sbhl_search_vars.$sbhl_finishedP$.bind( NIL, thread );
            sbhl_search_vars.$sbhl_stop_search_pathP$.bind( NIL, thread );
            sbhl_search_utilities.sbhl_sweep( sbhl_module_vars.get_sbhl_module( UNPROVIDED ), sbhl_link_vars.get_sbhl_opposite_link_direction(), sbhl_search_vars.get_sbhl_tv(), sbhl_marking_vars.$sbhl_gather_space$
                .getDynamicValue( thread ), $sym41$SBHL_CHECK_TARGET_MARKING_FOR_DEPENDENCE, node, UNPROVIDED );
          }
          finally
          {
            sbhl_search_vars.$sbhl_stop_search_pathP$.rebind( _prev_bind_2, thread );
  ...
  public static SubLObject sbhl_check_target_marking_for_dependence(final SubLObject node)
  {
    ...
    else if( NIL != sbhl_search_vars.sbhl_dependents_cut_node_p( node ) )
    {
      sbhl_search_vars.sbhl_stop_search_path();
    }
    return NIL;
  ...
  public static SubLObject sbhl_predicate_relation_p(final SubLObject module, final SubLObject node1, final SubLObject node2, SubLObject mt, SubLObject tv)
  {
    ...
    if( NIL != sbhl_cache.sbhl_cache_use_possible_p( pred, node1, node2 ) )
    {
      ...
      if( NIL != $debug_sbhl_cache_inconsistency_problemP$.getDynamicValue( thread ) )
      {
        ...
        {
          PrintLow.format( T, $str42$__sbhl_predicate_relation_p__cach, result, non_cached_result );
          PrintLow.format( T, $str43$_______cached___S__clet__cached_r, new SubLObject[] { result, mt, pred, node1, node2
          } );
          PrintLow.format( T, $str44$___non_cached___S__clet__non_cach, new SubLObject[] { non_cached_result, pred, mt, tv, node1, node2
          } );
        }
      }
    }
          ...
          try
          {
            ...
            try
            {
              ...
              try
              {
                ...
                sbhl_search_vars.$relevant_sbhl_tv_function$.bind( ( NIL != tv_var2 ) ? $sym1$RELEVANT_SBHL_TV_IS_GENERAL_TV : sbhl_search_vars.$relevant_sbhl_tv_function$.getDynamicValue( thread ), thread );
                if( NIL != tv_var2 && NIL != sbhl_paranoia.sbhl_object_type_checking_p() && NIL == sbhl_search_vars.sbhl_true_tv_p( tv_var2 ) )
                {
                  final SubLObject pcase_var2 = sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread );
                  if( pcase_var2.eql( $kw2$ERROR ) )
                  {
                    sbhl_paranoia.sbhl_error( ONE_INTEGER, $str3$_A_is_not_a__A, tv_var2, $sym4$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                  }
                  else if( pcase_var2.eql( $kw5$CERROR ) )
                  {
                    sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str6$continue_anyway, $str3$_A_is_not_a__A, tv_var2, $sym4$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                  }
                  else if( pcase_var2.eql( $kw7$WARN ) )
                  {
                    Errors.warn( $str3$_A_is_not_a__A, tv_var2, $sym4$SBHL_TRUE_TV_P );
                  }
                  else
                  {
                    Errors.warn( $str8$_A_is_not_a_valid__sbhl_type_erro, sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread ) );
                    Errors.cerror( $str6$continue_anyway, $str3$_A_is_not_a__A, tv_var2, $sym4$SBHL_TRUE_TV_P );
                  }
                }
                ...
                try
                {
                  ...
                  try
                  {
                    sbhl_marking_vars.$sbhl_space$.bind( ( source2 == $kw10$OLD ) ? sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ) : sbhl_marking_vars.sbhl_get_new_space( source2 ), thread );
                    final SubLObject _prev_bind_0_$992 = sbhl_marking_vars.$sbhl_gather_space$.currentBinding( thread );
                    try
                    {
                      sbhl_marking_vars.$sbhl_gather_space$.bind( ( source2 == $kw10$OLD ) ? sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) : sbhl_marking_vars.sbhl_get_new_space( source2 ), thread );
  ...
  public static SubLObject sbhl_predicate_relation_within_multiple_searches_p(final SubLObject module, final SubLObject node, final SubLObject goal, final SubLObject fail_space, final SubLObject goal_space)
  {
    ...
    try
    {
      ...
      if( NIL != result )
      {
        ...
        sbhl_marking_methods.sbhl_unmark_all_backward_true_nodes_and_map( $sym45$SBHL_MARK_NODE_IN_PRECOMPUTE_SPACE, goal );
      }
    }
    finally
    {
  ...
  public static SubLObject sbhl_path_from_node_to_node_p(final SubLObject node1, final SubLObject node2)
  {
    ...
    try
    {
      sbhl_search_vars.$sbhl_search_type$.bind( $kw46$BOOLEAN, thread );
      sbhl_search_vars.$sbhl_search_behavior$.bind( sbhl_search_utilities.determine_sbhl_search_behavior( sbhl_search_vars.get_sbhl_search_module(), sbhl_search_vars.get_sbhl_search_direction(), sbhl_search_vars
          .get_sbhl_tv() ), thread );
      sbhl_marking_vars.$sbhl_terminating_marking_space$.bind( sbhl_search_utilities.determine_sbhl_terminating_marking_space( sbhl_search_vars.$sbhl_search_behavior$.getDynamicValue( thread ) ), thread );
      final SubLObject premarkingP = sbhl_search_utilities.sbhl_module_premarks_gather_nodes_p();
      SubLObject goal_fn = $sym47$SBHL_NODE_IS_GOAL_NODE;
      ...
      if( NIL != premarkingP )
      {
        ...
        try
        {
          ...
          sbhl_search_vars.$genl_inverse_mode_p$.bind( sbhl_module_utilities.get_sbhl_link_pred( sbhl_search_vars.get_sbhl_search_module() ).eql( $const48$negationInverse ) ? T
        ...
        goal_fn = $sym49$SBHL_NODE_MARKED_AS_GOAL_NODE;
  ...
  public static SubLObject why_sbhl_predicate_relation_p(final SubLObject module, final SubLObject node1, final SubLObject node2, SubLObject mt, SubLObject tv, SubLObject behavior)
  {
    ...
    assert NIL != sbhl_module_vars.sbhl_module_p( module ) : module;
    return sbhl_search_utilities.sbhl_handle_justification( $sym50$SBHL_PREDICATE_RELATION_P, module, node1, node2, mt, tv, behavior, T );
  }
  ...
  public static SubLObject why_sbhl_false_predicate_relation_p(final SubLObject module, final SubLObject node1, final SubLObject node2, SubLObject mt, SubLObject tv, SubLObject behavior)
  {
    ...
    assert NIL != sbhl_module_vars.sbhl_module_p( module ) : module;
    return sbhl_search_utilities.sbhl_handle_justification( $sym51$SBHL_FALSE_PREDICATE_RELATION_P, module, node1, node2, mt, tv, behavior, NIL );
  }
  ...
  public static SubLObject why_sbhl_relationP(final SubLObject module, final SubLObject node1, final SubLObject node2, SubLObject mt, SubLObject tv, SubLObject behavior)
  {
    ...
    if( NIL != sbhl_search_vars.sbhl_true_tv_p( tv ) || ( NIL == tv && NIL != sbhl_search_vars.sbhl_true_tv_p( sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ) ) ) )
    {
      ...
      {
        bool_fn = $sym50$SBHL_PREDICATE_RELATION_P;
      }
      else if( NIL != sbhl_module_utilities.sbhl_disjoins_module_p( module ) )
      {
        bool_fn = $sym52$SBHL_IMPLIED_DISJOINS_RELATION_P;
      }
      else if( NIL != sbhl_module_utilities.sbhl_time_module_p( module ) )
      {
      }
    }
    else if( NIL != sbhl_search_vars.sbhl_false_tv_p( tv ) || ( NIL == tv && NIL != sbhl_search_vars.sbhl_false_tv_p( sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ) ) ) )
    {
      if( NIL != sbhl_module_utilities.sbhl_simple_module_p( module ) || NIL != sbhl_module_utilities.sbhl_transfers_through_module_p( module ) )
      {
        bool_fn = $sym53$SBHL_IMPLIED_FALSE_PREDICATE_RELATION_P;
      }
      else if( NIL != sbhl_module_utilities.sbhl_disjoins_module_p( module ) )
      {
        bool_fn = $sym51$SBHL_FALSE_PREDICATE_RELATION_P;
      }
      else if( NIL != sbhl_module_utilities.sbhl_time_module_p( module ) )
      {
      }
  ...
  public static SubLObject why_some_sbhl_predicate_relation_among_p(final SubLObject module, final SubLObject node, final SubLObject nodes, SubLObject mt, SubLObject tv, SubLObject behavior)
  {
    ...
    assert NIL != sbhl_module_vars.sbhl_module_p( module ) : module;
    return sbhl_search_utilities.sbhl_handle_justification( $sym55$SBHL_PREDICATE_RELATION_WITH_ANY_P, module, node, nodes, mt, tv, behavior, T );
  }
        ...
        try
        {
          ...
          try
          {
            ...
            try
            {
              ...
              sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym49$SBHL_NODE_MARKED_AS_GOAL_NODE, thread );
              sbhl_search_vars.$sbhl_search_type$.bind( $kw46$BOOLEAN, thread );
              result = sbhl_transitive_closure( node );
            }
            finally
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL != set.set_p( nodes ) )
        {
          ...
          SubLObject state;
          SubLObject goal;
          for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object, set_contents_var ); NIL == not_all_nodesP
      ...
      try
      {
        ...
        else if( nodes.isList() )
        {
          if( NIL == result )
          {
            ...
            SubLObject subnode2;
            for( csome_list_var = nodes, subnode2 = NIL, subnode2 = csome_list_var.first(); NIL == result && NIL != csome_list_var; result = sbhl_cache.sbhl_cached_predicate_relation_p( pred, subnode2, node,
                UNPROVIDED ), csome_list_var = csome_list_var.rest(), subnode2 = csome_list_var.first() )
            {
            }
          }
        }
  ...
  public static SubLObject sbhl_path_from_any_of_nodes_to_node_p(final SubLObject nodes, final SubLObject node)
  {
    ...
    try
    {
      ...
      else
      {
        ...
        try
        {
          sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym47$SBHL_NODE_IS_GOAL_NODE, thread );
          if( NIL != set.set_p( nodes ) )
          {
  ...
  public static SubLObject sbhl_path_from_all_of_nodes_to_node_p(final SubLObject nodes, final SubLObject node)
  {
    ...
    try
    {
      ...
      if( NIL != set.set_p( nodes ) )
      {
        ...
        SubLObject state;
        SubLObject start2;
        for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object, set_contents_var ); NIL == any_missedP
            && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
        {
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL != set.set_p( nodes1 ) )
        {
          ...
          for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object,
              set_contents_var ); NIL == sbhl_search_vars.$sbhl_finishedP$.getDynamicValue( thread ) && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state(
                  state ) )
          {
            ...
            try
            {
              ...
              try
              {
                ...
                while ( NIL != cdolist_list_var_$1272)
                {
                  if( NIL == sbhl_marking_utilities.sbhl_marked_in_terminating_space_p( candidate ) )
                  {
                    goals = Sequences.remove( candidate, goals, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                  }
  ...
  public static SubLObject sbhl_any_predicate_relation_with_all_p(final SubLObject module, final SubLObject nodes1, final SubLObject nodes2, SubLObject mt, SubLObject tv)
  {
    ...
    if( NIL != set.set_p( nodes1 ) )
    {
      ...
      SubLObject state;
      SubLObject node1;
      for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object, set_contents_var ); NIL == path_to_allP
          && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
  ...
  {
    final SubLObject pred = sbhl_module_vars.get_sbhl_module_link_pred( module );
    if( pred.eql( $const57$incompatibleMt ) || pred.eql( $const58$intensionallyIncompatibleMt ) )
    {
      return T;
    }
    return NIL;
  ...
  {
    SubLFiles.declareFunction( me, "sbhl_all_forward_true_nodes", "SBHL-ALL-FORWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_forward_false_nodes", "SBHL-ALL-FORWARD-FALSE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_backward_true_nodes", "SBHL-ALL-BACKWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_backward_false_nodes", "SBHL-ALL-BACKWARD-FALSE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_transitive_closure", "SBHL-TRANSITIVE-CLOSURE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_all_forward_true_nodes_with_prune", "SBHL-ALL-FORWARD-TRUE-NODES-WITH-PRUNE", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_backward_true_nodes_with_prune", "SBHL-ALL-BACKWARD-TRUE-NODES-WITH-PRUNE", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_union_all_forward_true_nodes", "SBHL-UNION-ALL-FORWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_union_all_backward_true_nodes", "SBHL-UNION-ALL-BACKWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_union_nodes_transitive_closures", "SBHL-UNION-NODES-TRANSITIVE-CLOSURES", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_gather_dead_end_nodes", "SBHL-GATHER-DEAD-END-NODES", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_extremes", "SBHL-EXTREMES", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_leaf_nodes", "SBHL-LEAF-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_root_nodes", "SBHL-ROOT-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_max_true_disjoins", "SBHL-MAX-TRUE-DISJOINS", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_min_asserted_false_disjoins", "SBHL-MIN-ASSERTED-FALSE-DISJOINS", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_min_implied_false_disjoins", "SBHL-MIN-IMPLIED-FALSE-DISJOINS", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_implied_min_false_disjoins", "SBHL-IMPLIED-MIN-FALSE-DISJOINS", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_true_disjoin", "SBHL-GATHER-FIRST-TRUE-DISJOIN", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_sample_leaf_nodes", "SBHL-SAMPLE-LEAF-NODES", 2, 3, false );
    SubLFiles.declareFunction( me, "sbhl_sample_different_leaf_nodes", "SBHL-SAMPLE-DIFFERENT-LEAF-NODES", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_sample_extremal_nodes", "SBHL-SAMPLE-EXTREMAL-NODES", 2, 1, false );
    SubLFiles.declareFunction( me, "sbhl_map_all_forward_true_nodes", "SBHL-MAP-ALL-FORWARD-TRUE-NODES", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_map_all_forward_true_nodes_if", "SBHL-MAP-ALL-FORWARD-TRUE-NODES-IF", 4, 2, false );
    SubLFiles.declareFunction( me, "sbhl_map_and_mark_forward_true_nodes_in_space", "SBHL-MAP-AND-MARK-FORWARD-TRUE-NODES-IN-SPACE", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_map_all_backward_true_nodes", "SBHL-MAP-ALL-BACKWARD-TRUE-NODES", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_simply_map_all_backward_true_nodes", "SBHL-SIMPLY-MAP-ALL-BACKWARD-TRUE-NODES", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_map_union_all_forward_true_nodes", "SBHL-MAP-UNION-ALL-FORWARD-TRUE-NODES", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_map_union_all_backward_true_nodes", "SBHL-MAP-UNION-ALL-BACKWARD-TRUE-NODES", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_simply_union_all_backward_true_nodes", "SBHL-SIMPLY-UNION-ALL-BACKWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_union_simply_all_backward_true_edges", "SBHL-UNION-SIMPLY-ALL-BACKWARD-TRUE-EDGES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_simply_union_all_backward_true_nodes_such_that", "SBHL-SIMPLY-UNION-ALL-BACKWARD-TRUE-NODES-SUCH-THAT", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_gather_all_forward_true_nodes", "SBHL-GATHER-ALL-FORWARD-TRUE-NODES", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_gather_all_backward_true_nodes", "SBHL-GATHER-ALL-BACKWARD-TRUE-NODES", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_gather_closure", "SBHL-GATHER-CLOSURE", 3, 0, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_among_all_forward_true_nodes", "SBHL-GATHER-FIRST-AMONG-ALL-FORWARD-TRUE-NODES", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_among_forward_true_nodes_in_space", "SBHL-GATHER-FIRST-AMONG-FORWARD-TRUE-NODES-IN-SPACE", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_among_all_backward_true_nodes", "SBHL-GATHER-FIRST-AMONG-ALL-BACKWARD-TRUE-NODES", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_simply_gather_first_among_all_forward_true_nodes", "SBHL-SIMPLY-GATHER-FIRST-AMONG-ALL-FORWARD-TRUE-NODES", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_simply_gather_first_among_all_backward_true_nodes", "SBHL-SIMPLY-GATHER-FIRST-AMONG-ALL-BACKWARD-TRUE-NODES", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_among_closure", "SBHL-GATHER-FIRST-AMONG-CLOSURE", 3, 0, false );
    SubLFiles.declareFunction( me, "sbhl_simply_gather_first_among_all_forward_true_nodes_with_prune", "SBHL-SIMPLY-GATHER-FIRST-AMONG-ALL-FORWARD-TRUE-NODES-WITH-PRUNE", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_simply_gather_first_among_all_backward_true_nodes_with_prune", "SBHL-SIMPLY-GATHER-FIRST-AMONG-ALL-BACKWARD-TRUE-NODES-WITH-PRUNE", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_among_closure_with_prune", "SBHL-GATHER-FIRST-AMONG-CLOSURE-WITH-PRUNE", 3, 0, false );
    SubLFiles.declareFunction( me, "sbhl_all_forward_true_nodes_if", "SBHL-ALL-FORWARD-TRUE-NODES-IF", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_backward_true_nodes_if", "SBHL-ALL-BACKWARD-TRUE-NODES-IF", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_closure_if", "SBHL-CLOSURE-IF", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_all_forward_true_nodes_if_with_pruning", "SBHL-ALL-FORWARD-TRUE-NODES-IF-WITH-PRUNING", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_backward_true_nodes_if_with_pruning", "SBHL-ALL-BACKWARD-TRUE-NODES-IF-WITH-PRUNING", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_closure_if_and_stop_unless", "SBHL-CLOSURE-IF-AND-STOP-UNLESS", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_extremal_nodes", "SBHL-EXTREMAL-NODES", 1, 0, false );
    SubLFiles.declareFunction( me, "max_nodes_backward", "MAX-NODES-BACKWARD", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_independent_cycles", "SBHL-INDEPENDENT-CYCLES", 1, 0, false );
    SubLFiles.declareFunction( me, "max_nodes_forward", "MAX-NODES-FORWARD", 2, 2, false );
    SubLFiles.declareFunction( me, "max_nodes_direction", "MAX-NODES-DIRECTION", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_min_nodes", "SBHL-MIN-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_max_nodes", "SBHL-MAX-NODES", 2, 3, false );
    SubLFiles.declareFunction( me, "sbhl_min_forward_true_link_nodes", "SBHL-MIN-FORWARD-TRUE-LINK-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_max_forward_true_link_nodes", "SBHL-MAX-FORWARD-TRUE-LINK-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_min_forward_false_link_nodes", "SBHL-MIN-FORWARD-FALSE-LINK-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_max_forward_false_link_nodes", "SBHL-MAX-FORWARD-FALSE-LINK-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_min_backward_true_link_nodes", "SBHL-MIN-BACKWARD-TRUE-LINK-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_max_backward_true_link_nodes", "SBHL-MAX-BACKWARD-TRUE-LINK-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_min_backward_false_link_nodes", "SBHL-MIN-BACKWARD-FALSE-LINK-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_max_backward_false_link_nodes", "SBHL-MAX-BACKWARD-FALSE-LINK-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_stop_at_horizon", "SBHL-STOP-AT-HORIZON", 1, 0, false );
    new $sbhl_stop_at_horizon$UnaryFunction();
    SubLFiles.declareFunction( me, "sbhl_mark_closure_up_to_horizon", "SBHL-MARK-CLOSURE-UP-TO-HORIZON", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_common_horizon", "SBHL-COMMON-HORIZON", 1, 1, false );
    SubLFiles.declareFunction( me, "sbhl_min_ceilings", "SBHL-MIN-CEILINGS", 2, 3, false );
    SubLFiles.declareFunction( me, "sbhl_max_floors", "SBHL-MAX-FLOORS", 2, 4, false );
    SubLFiles.declareFunction( me, "sbhl_max_floors_pruning_cycles", "SBHL-MAX-FLOORS-PRUNING-CYCLES", 2, 3, false );
    SubLFiles.declareFunction( me, "sbhl_prune_unwanted_extremal_cycles", "SBHL-PRUNE-UNWANTED-EXTREMAL-CYCLES", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_ceilings", "SBHL-CEILINGS", 2, 3, false );
    SubLFiles.declareFunction( me, "sbhl_floors", "SBHL-FLOORS", 2, 3, false );
    SubLFiles.declareFunction( me, "sbhl_predicate_relation_to_which", "SBHL-PREDICATE-RELATION-TO-WHICH", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_which_with_predicate_relation", "SBHL-WHICH-WITH-PREDICATE-RELATION", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_predicate_relation_to_which_excluding_link_node", "SBHL-PREDICATE-RELATION-TO-WHICH-EXCLUDING-LINK-NODE", 4, 2, false );
    SubLFiles.declareFunction( me, "sbhl_inverse_relation_to_which", "SBHL-INVERSE-RELATION-TO-WHICH", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_gather_first_target_marked_node", "SBHL-GATHER-FIRST-TARGET-MARKED-NODE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_first_common_horizon", "SBHL-FIRST-COMMON-HORIZON", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_first_floor_of_node_pair", "SBHL-FIRST-FLOOR-OF-NODE-PAIR", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_first_ceiling_of_node_pair", "SBHL-FIRST-CEILING-OF-NODE-PAIR", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_forward_true_goals_with_no_path_from_nodes", "SBHL-FORWARD-TRUE-GOALS-WITH-NO-PATH-FROM-NODES", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_goals_with_no_path_from_nodes", "SBHL-ALL-GOALS-WITH-NO-PATH-FROM-NODES", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_all_forward_true_nodes_between", "SBHL-ALL-FORWARD-TRUE-NODES-BETWEEN", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_closure_between", "SBHL-CLOSURE-BETWEEN", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_all_forward_true_nodes_among", "SBHL-ALL-FORWARD-TRUE-NODES-AMONG", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_backward_true_nodes_among", "SBHL-ALL-BACKWARD-TRUE-NODES-AMONG", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_closure_among", "SBHL-CLOSURE-AMONG", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_gather_dependent_nodes", "SBHL-GATHER-DEPENDENT-NODES", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_push_dependent_nodes_onto_result", "SBHL-PUSH-DEPENDENT-NODES-ONTO-RESULT", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_check_target_marking_for_dependence", "SBHL-CHECK-TARGET-MARKING-FOR-DEPENDENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_dependent_nodes", "SBHL-DEPENDENT-NODES", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_all_dependent_backward_true_nodes", "SBHL-ALL-DEPENDENT-BACKWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_predicate_relation_p", "SBHL-PREDICATE-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_predicate_relation_in_space_p", "SBHL-PREDICATE-RELATION-IN-SPACE-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_non_justifying_predicate_relation_p", "SBHL-NON-JUSTIFYING-PREDICATE-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_predicate_relation_within_multiple_searches_p", "SBHL-PREDICATE-RELATION-WITHIN-MULTIPLE-SEARCHES-P", 5, 0, false );
    SubLFiles.declareFunction( me, "sbhl_inverse_relation_p", "SBHL-INVERSE-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_false_predicate_relation_p", "SBHL-FALSE-PREDICATE-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_false_inverse_relation_p", "SBHL-FALSE-INVERSE-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_path_from_node_to_node_p", "SBHL-PATH-FROM-NODE-TO-NODE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_disjoins_relation_p", "SBHL-DISJOINS-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "why_sbhl_predicate_relation_p", "WHY-SBHL-PREDICATE-RELATION-P", 3, 3, false );
    SubLFiles.declareFunction( me, "why_sbhl_false_predicate_relation_p", "WHY-SBHL-FALSE-PREDICATE-RELATION-P", 3, 3, false );
    SubLFiles.declareFunction( me, "why_sbhl_relationP", "WHY-SBHL-RELATION?", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_predicate_relation_with_any_p", "SBHL-PREDICATE-RELATION-WITH-ANY-P", 3, 2, false );
    SubLFiles.declareFunction( me, "why_some_sbhl_predicate_relation_among_p", "WHY-SOME-SBHL-PREDICATE-RELATION-AMONG-P", 3, 3, false );
    SubLFiles.declareFunction( me, "sbhl_inverse_relation_with_any_p", "SBHL-INVERSE-RELATION-WITH-ANY-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_false_predicate_relation_with_any_p", "SBHL-FALSE-PREDICATE-RELATION-WITH-ANY-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_premark_union_nodes_closures", "SBHL-PREMARK-UNION-NODES-CLOSURES", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_path_from_node_to_any_of_nodes_p", "SBHL-PATH-FROM-NODE-TO-ANY-OF-NODES-P", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_disjoins_relation_with_any_p", "SBHL-DISJOINS-RELATION-WITH-ANY-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_predicate_relation_with_all_p", "SBHL-PREDICATE-RELATION-WITH-ALL-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_path_from_node_to_all_of_nodes_p", "SBHL-PATH-FROM-NODE-TO-ALL-OF-NODES-P", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_any_with_predicate_relation_p", "SBHL-ANY-WITH-PREDICATE-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_any_with_false_inverse_relation_p", "SBHL-ANY-WITH-FALSE-INVERSE-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_premark_node_closure", "SBHL-PREMARK-NODE-CLOSURE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_path_from_any_of_nodes_to_node_p", "SBHL-PATH-FROM-ANY-OF-NODES-TO-NODE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_any_with_disjoins_relation_p", "SBHL-ANY-WITH-DISJOINS-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_with_predicate_relation_p", "SBHL-ALL-WITH-PREDICATE-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_with_false_predicate_relation_p", "SBHL-ALL-WITH-FALSE-PREDICATE-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_all_with_false_inverse_relation_p", "SBHL-ALL-WITH-FALSE-INVERSE-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_path_from_all_of_nodes_to_node_p", "SBHL-PATH-FROM-ALL-OF-NODES-TO-NODE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_all_with_disjoins_relation_p", "SBHL-ALL-WITH-DISJOINS-RELATION-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_predicate_relation_between_any_p", "SBHL-PREDICATE-RELATION-BETWEEN-ANY-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_path_from_any_of_nodes_to_any_of_nodes_p", "SBHL-PATH-FROM-ANY-OF-NODES-TO-ANY-OF-NODES-P", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_all_with_predicate_relation_with_any_p", "SBHL-ALL-WITH-PREDICATE-RELATION-WITH-ANY-P", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_path_from_all_of_nodes_to_any_of_nodes_p", "SBHL-PATH-FROM-ALL-OF-NODES-TO-ANY-OF-NODES-P", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_any_predicate_relation_with_all_p", "SBHL-ANY-PREDICATE-RELATION-WITH-ALL-P", 3, 2, false );
    SubLFiles.declareFunction( me, "incompatible_mt_related_moduleP", "INCOMPATIBLE-MT-RELATED-MODULE?", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_sbhl_search_methods_file()
  {
    $sbhl_search_self_incompatibility_check_disabledP$ = SubLFiles.defparameter( "*SBHL-SEARCH-SELF-INCOMPATIBILITY-CHECK-DISABLED?*", NIL );
    $debug_sbhl_cache_inconsistency_problemP$ = SubLFiles.defparameter( "*DEBUG-SBHL-CACHE-INCONSISTENCY-PROBLEM?*", NIL );
    return NIL;
  }
  ...
  static
  {
    me = new sbhl_search_methods();
    $sbhl_search_self_incompatibility_check_disabledP$ = null;
    $debug_sbhl_cache_inconsistency_problemP$ = null;
    $sym0$SBHL_MODULE_P = makeSymbol( "SBHL-MODULE-P" );
    $sym1$RELEVANT_SBHL_TV_IS_GENERAL_TV = makeSymbol( "RELEVANT-SBHL-TV-IS-GENERAL-TV" );
    $kw2$ERROR = makeKeyword( "ERROR" );
    $str3$_A_is_not_a__A = makeString( "~A is not a ~A" );
    $sym4$SBHL_TRUE_TV_P = makeSymbol( "SBHL-TRUE-TV-P" );
    $kw5$CERROR = makeKeyword( "CERROR" );
    $str6$continue_anyway = makeString( "continue anyway" );
    $kw7$WARN = makeKeyword( "WARN" );
    $str8$_A_is_not_a_valid__sbhl_type_erro = makeString( "~A is not a valid *sbhl-type-error-action* value" );
    $const9$True_JustificationTruth = constant_handles.reader_make_constant_shell( makeString( "True-JustificationTruth" ) );
    $kw10$OLD = makeKeyword( "OLD" );
    $sym11$SBHL_PUSH_ONTO_RESULT = makeSymbol( "SBHL-PUSH-ONTO-RESULT" );
    $kw12$RESOURCE = makeKeyword( "RESOURCE" );
    $sym13$SBHL_FALSE_TV_P = makeSymbol( "SBHL-FALSE-TV-P" );
    $const14$False_JustificationTruth = constant_handles.reader_make_constant_shell( makeString( "False-JustificationTruth" ) );
    $str15$Node__a_does_not_pass_sbhl_type_t = makeString( "Node ~a does not pass sbhl-type-test ~a~%" );
    $sym16$SBHL_PUSH_ONTO_RESULT_WITH_PRUNE = makeSymbol( "SBHL-PUSH-ONTO-RESULT-WITH-PRUNE" );
    $kw17$CLOSURE = makeKeyword( "CLOSURE" );
    $sym18$SBHL_GATHER_DEAD_END_NODES = makeSymbol( "SBHL-GATHER-DEAD-END-NODES" );
    $sym19$SBHL_GATHER_FIRST_NON_NIL_RESULT = makeSymbol( "SBHL-GATHER-FIRST-NON-NIL-RESULT" );
    $sym20$SBHL_LEAF_INSTANCES_SWEEP = makeSymbol( "SBHL-LEAF-INSTANCES-SWEEP" );
    $sym21$SBHL_SIMPLE_TRUE_SEARCH_AND_UNWIND = makeSymbol( "SBHL-SIMPLE-TRUE-SEARCH-AND-UNWIND" );
    $sym22$QUEUE_EMPTY_P = makeSymbol( "QUEUE-EMPTY-P" );
    $sym23$FUNCTION_SPEC_P = makeSymbol( "FUNCTION-SPEC-P" );
    $sym24$SBHL_APPLY_COMPOSE_FN = makeSymbol( "SBHL-APPLY-COMPOSE-FN" );
    $sym25$SBHL_APPLY_COMPOSE_FN_IF = makeSymbol( "SBHL-APPLY-COMPOSE-FN-IF" );
    $sym26$SBHL_PUSH_UNWIND_ONTO_RESULT = makeSymbol( "SBHL-PUSH-UNWIND-ONTO-RESULT" );
    $sym27$SBHL_APPLY_COMPOSE_FN_AND_COMBINE_WITH_RESULT = makeSymbol( "SBHL-APPLY-COMPOSE-FN-AND-COMBINE-WITH-RESULT" );
    $sym28$SBHL_GATHER_FIRST_NON_NIL_RESULT_WITH_PRUNE = makeSymbol( "SBHL-GATHER-FIRST-NON-NIL-RESULT-WITH-PRUNE" );
    $sym29$SBHL_PUSH_ONTO_RESULT_IF = makeSymbol( "SBHL-PUSH-ONTO-RESULT-IF" );
    $sym30$SBHL_PUSH_ONTO_RESULT_IF_AND_STOP_UNLESS = makeSymbol( "SBHL-PUSH-ONTO-RESULT-IF-AND-STOP-UNLESS" );
    $sym31$SBHL_MARKED_IN_TARGET_SPACE_P = makeSymbol( "SBHL-MARKED-IN-TARGET-SPACE-P" );
    $sym32$MEMBER_ = makeSymbol( "MEMBER?" );
    $kw33$FORWARD = makeKeyword( "FORWARD" );
    $kw34$BACKWARD = makeKeyword( "BACKWARD" );
    $sym35$SBHL_STOP_AT_HORIZON = makeSymbol( "SBHL-STOP-AT-HORIZON" );
    $const36$genlInverse = constant_handles.reader_make_constant_shell( makeString( "genlInverse" ) );
    $sym37$FORT_P = makeSymbol( "FORT-P" );
    $sym38$_ = makeSymbol( "+" );
    $sym39$GENL_CARDINALITY = makeSymbol( "GENL-CARDINALITY" );
    $sym40$SBHL_PUSH_DEPENDENT_NODES_ONTO_RESULT = makeSymbol( "SBHL-PUSH-DEPENDENT-NODES-ONTO-RESULT" );
    $sym41$SBHL_CHECK_TARGET_MARKING_FOR_DEPENDENCE = makeSymbol( "SBHL-CHECK-TARGET-MARKING-FOR-DEPENDENCE" );
    $str42$__sbhl_predicate_relation_p__cach = makeString( "~&sbhl-predicate-relation-p: cache ~S differs from sbhl ~S!~%" );
    $str43$_______cached___S__clet__cached_r = makeString(
        "~&     cached: ~S (clet (cached-result) (possibly-with-sbhl-mt-relevance ~S (csetq cached-result (sbhl-cached-predicate-relation-p ~S ~S ~S))) cached-result)~%" );
    $str44$___non_cached___S__clet__non_cach = makeString(
        "~& non-cached: ~S (clet (non-cached-result) (with-new-sbhl-space (with-sbhl-search-module (get-sbhl-module ~S) (with-sbhl-forward-true-search ~S ~S (csetq non-cached-result (sbhl-path-from-node-to-node-p ~S ~S))))) non-cached-result)~%" );
    $sym45$SBHL_MARK_NODE_IN_PRECOMPUTE_SPACE = makeSymbol( "SBHL-MARK-NODE-IN-PRECOMPUTE-SPACE" );
    $kw46$BOOLEAN = makeKeyword( "BOOLEAN" );
    $sym47$SBHL_NODE_IS_GOAL_NODE = makeSymbol( "SBHL-NODE-IS-GOAL-NODE" );
    $const48$negationInverse = constant_handles.reader_make_constant_shell( makeString( "negationInverse" ) );
    $sym49$SBHL_NODE_MARKED_AS_GOAL_NODE = makeSymbol( "SBHL-NODE-MARKED-AS-GOAL-NODE" );
    $sym50$SBHL_PREDICATE_RELATION_P = makeSymbol( "SBHL-PREDICATE-RELATION-P" );
    $sym51$SBHL_FALSE_PREDICATE_RELATION_P = makeSymbol( "SBHL-FALSE-PREDICATE-RELATION-P" );
    $sym52$SBHL_IMPLIED_DISJOINS_RELATION_P = makeSymbol( "SBHL-IMPLIED-DISJOINS-RELATION-P" );
    $sym53$SBHL_IMPLIED_FALSE_PREDICATE_RELATION_P = makeSymbol( "SBHL-IMPLIED-FALSE-PREDICATE-RELATION-P" );
    $str54$Invalid_TV_argument__a__or__sbhl_ = makeString( "Invalid TV argument ~a, or *sbhl-tv* ~a" );
    $sym55$SBHL_PREDICATE_RELATION_WITH_ANY_P = makeSymbol( "SBHL-PREDICATE-RELATION-WITH-ANY-P" );
    $str56$_A_is_neither_SET_P_nor_LISTP_ = makeString( "~A is neither SET-P nor LISTP." );
    $const57$incompatibleMt = constant_handles.reader_make_constant_shell( makeString( "incompatibleMt" ) );
    $const58$intensionallyIncompatibleMt = constant_handles.reader_make_constant_shell( makeString( "intensionallyIncompatibleMt" ) );
  }

  public static final class $sbhl_stop_at_horizon$UnaryFunction
      extends
        UnaryFunction
  {
