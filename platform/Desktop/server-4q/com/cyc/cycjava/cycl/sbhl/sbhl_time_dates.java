...
public final class sbhl_time_dates extends SubLTranslatedFile
{
    ...
    public static SubLObject init_sbhl_time_dates_file() {
        sbhl_time_dates.$sbhl_time_date_graph$ = SubLFiles.deflexical("*SBHL-TIME-DATE-GRAPH*", (sbhl_time_dates.NIL != Symbols.boundp((SubLObject)sbhl_time_dates.$sym0$_SBHL_TIME_DATE_GRAPH_)) ? sbhl_time_dates.$sbhl_time_date_graph$.getGlobalValue() : binary_tree.new_avl_tree((SubLObject)sbhl_time_dates.$sym1$SBHL_DATE_));
        sbhl_time_dates.$sbhl_time_date_object_predicate_links$ = SubLFiles.deflexical("*SBHL-TIME-DATE-OBJECT-PREDICATE-LINKS*", (sbhl_time_dates.NIL != Symbols.boundp((SubLObject)sbhl_time_dates.$sym15$_SBHL_TIME_DATE_OBJECT_PREDICATE_LINKS_)) ? sbhl_time_dates.$sbhl_time_date_object_predicate_links$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sbhl_time_dates.EQL), (SubLObject)sbhl_time_dates.$int16$1000));
        sbhl_time_dates.$sbhl_time_date_object_inverse_links$ = SubLFiles.deflexical("*SBHL-TIME-DATE-OBJECT-INVERSE-LINKS*", (sbhl_time_dates.NIL != Symbols.boundp((SubLObject)sbhl_time_dates.$sym17$_SBHL_TIME_DATE_OBJECT_INVERSE_LINKS_)) ? sbhl_time_dates.$sbhl_time_date_object_inverse_links$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sbhl_time_dates.EQL), (SubLObject)sbhl_time_dates.$int16$1000));
        sbhl_time_dates.$sbhl_time_object_date_predicate_links$ = SubLFiles.deflexical("*SBHL-TIME-OBJECT-DATE-PREDICATE-LINKS*", (sbhl_time_dates.NIL != Symbols.boundp((SubLObject)sbhl_time_dates.$sym18$_SBHL_TIME_OBJECT_DATE_PREDICATE_LINKS_)) ? sbhl_time_dates.$sbhl_time_object_date_predicate_links$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sbhl_time_dates.EQL), (SubLObject)sbhl_time_dates.$int16$1000));
        sbhl_time_dates.$sbhl_time_object_date_inverse_links$ = SubLFiles.deflexical("*SBHL-TIME-OBJECT-DATE-INVERSE-LINKS*", (sbhl_time_dates.NIL != Symbols.boundp((SubLObject)sbhl_time_dates.$sym19$_SBHL_TIME_OBJECT_DATE_INVERSE_LINKS_)) ? sbhl_time_dates.$sbhl_time_object_date_inverse_links$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)sbhl_time_dates.EQL), (SubLObject)sbhl_time_dates.$int16$1000));
        return (SubLObject)sbhl_time_dates.NIL;
    }
