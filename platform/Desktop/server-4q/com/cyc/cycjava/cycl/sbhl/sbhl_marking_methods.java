      ...
      SubLTranslatedFile
{
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    sbhl_search_utilities.sbhl_sweep( sbhl_module_vars.get_sbhl_module( UNPROVIDED ), sbhl_module_utilities.sbhl_search_direction_to_link_direction( sbhl_premark_direction( sbhl_module_vars.get_sbhl_module(
        UNPROVIDED ) ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ), $sym0$SBHL_CHECK_CUTOFF, node,
    ...
    if( NIL != sbhl_module_utilities.sbhl_module_indicates_predicate_search_p( sbhl_search_vars.get_sbhl_search_module() ) )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        try
        {
          ...
          sbhl_search_vars.$genl_inverse_mode_p$.bind( Equality.eql( pred, $const1$genlInverse ), thread );
          sbhl_search_vars.$sbhl_consider_node_fn$.bind( ( NIL != sbhl_search_utilities.sbhl_search_has_multiple_goals_p() ) ? $sym2$SBHL_NODE_IS_A_GOAL_NODE : $sym3$SBHL_NODE_IS_GOAL_NODE, thread );
          sbhl_search_utilities.sbhl_unmark_sweep( module, sbhl_module_utilities.get_sbhl_module_backward_direction( module ), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_goal_space$.getDynamicValue(
              thread ), $sym4$SBHL_CONSIDER_NODE, node );
        }
        finally
        {
      ...
      try
      {
        ...
        try
        {
          ...
          try
          {
            ...
            try
            {
              sbhl_marking_vars.$sbhl_space$.bind( ( source == $kw15$OLD ) ? sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ) : sbhl_marking_vars.sbhl_get_new_space( source ), thread );
              final SubLObject _prev_bind_0_$6 = sbhl_marking_vars.$sbhl_gather_space$.currentBinding( thread );
              try
              {
                sbhl_marking_vars.$sbhl_gather_space$.bind( ( source == $kw15$OLD ) ? sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) : sbhl_marking_vars.sbhl_get_new_space( source ), thread );
  ...
  public static SubLObject sbhl_mark_closure_as_marked(final SubLObject node)
  {
    ...
    {
      sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str17$Node__a_does_not_pass_sbhl_type_t, node, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED, UNPROVIDED,
          UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject sbhl_mark_proper_closure_as_marked(final SubLObject node)
  {
    ...
    {
      sbhl_search_utilities.sbhl_step( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.get_sbhl_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue( thread ),
          $sym19$SBHL_MARK_CLOSURE_AS_MARKED, node, T, UNPROVIDED );
    }
    else
    {
      sbhl_mark_closure_as_marked( node );
      ...
      if( NIL != sbhl_module_utilities.sbhl_module_indicates_predicate_search_p( sbhl_search_vars.get_sbhl_search_module() ) )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          try
          {
            sbhl_search_vars.$sbhl_add_unmarked_node_to_result_test$.bind( sbhl_module_utilities.get_sbhl_add_node_to_result_test( sbhl_module_vars.get_sbhl_module( pred ) ), thread );
            sbhl_search_vars.$genl_inverse_mode_p$.bind( Equality.eql( pred, $const1$genlInverse ), thread );
            sbhl_search_utilities.sbhl_unmark_step( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.get_sbhl_tv(), sbhl_marking_vars.$sbhl_space$.getDynamicValue(
                thread ), $sym20$SBHL_UNMARK_INITIALIZED_MARKED_CLOSURE, node, UNPROVIDED );
          }
          finally
          {
            sbhl_search_vars.$genl_inverse_mode_p$.rebind( _prev_bind_2, thread );
              ...
              try
              {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym21$SBHL_APPLY_COMPOSE_FN, thread );
                    if( NIL != sbhl_module_utilities.sbhl_module_indicates_predicate_search_p( sbhl_search_vars.get_sbhl_search_module() ) )
                    {
                      SubLObject cdolist_list_var = sbhl_marking_utilities.sbhl_marked_with( node, UNPROVIDED );
                      SubLObject pred = NIL;
  ...
  public static SubLObject sbhl_unmark_marked_closure_and_gather(final SubLObject node)
  {
    ...
    {
      sbhl_search_vars.$sbhl_unmarking_search_p$.bind( T, thread );
      sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym22$SBHL_PUSH_ONTO_RESULT, thread );
      if( NIL != sbhl_module_utilities.sbhl_module_indicates_predicate_search_p( sbhl_search_vars.get_sbhl_search_module() ) )
      {
        SubLObject cdolist_list_var = sbhl_marking_utilities.sbhl_marked_with( node, UNPROVIDED );
        SubLObject pred = NIL;
  ...
  public static SubLObject sbhl_unmark_marked_closure_and_mark_in_space(final SubLObject node, final SubLObject space)
  {
    ...
    try
    {
      ...
      sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym24$SBHL_APPLY_MARK_IN_SPACE, thread );
      if( NIL != sbhl_module_utilities.sbhl_module_indicates_predicate_search_p( sbhl_search_vars.get_sbhl_search_module() ) )
      {
        SubLObject cdolist_list_var = sbhl_marking_utilities.sbhl_marked_with( node, UNPROVIDED );
        SubLObject pred = NIL;
  ...
  public static SubLObject sbhl_unmark_marked_closure_and_unmark_in_space(final SubLObject node, final SubLObject space)
  {
    ...
    try
    {
      sbhl_search_vars.$sbhl_unmarking_search_p$.bind( T, thread );
      sbhl_marking_vars.$sbhl_apply_marking_space$.bind( space, thread );
      sbhl_search_vars.$sbhl_consider_node_fn$.bind( $sym25$SBHL_APPLY_UNMARK_IN_SPACE, thread );
      if( NIL != sbhl_module_utilities.sbhl_module_indicates_predicate_search_p( sbhl_search_vars.get_sbhl_search_module() ) )
      {
        SubLObject cdolist_list_var = sbhl_marking_utilities.sbhl_marked_with( node, UNPROVIDED );
        SubLObject pred = NIL;
  ...
  public static SubLObject sbhl_unmark_marked_closure_and_target_mark_closure(final SubLObject node)
  {
    ...
    try
    {
      ...
      sbhl_search_vars.$sbhl_add_node_to_result_test$.bind( sbhl_module_utilities.get_sbhl_add_node_to_result_test( sbhl_module_utilities.get_sbhl_reductions_module( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) ),
          thread );
      sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
      ...
      if( NIL != sbhl_module_utilities.sbhl_module_indicates_predicate_search_p( sbhl_search_vars.get_sbhl_search_module() ) )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          try
          {
            sbhl_search_vars.$sbhl_add_unmarked_node_to_result_test$.bind( sbhl_module_utilities.get_sbhl_add_node_to_result_test( sbhl_module_vars.get_sbhl_module( pred ) ), thread );
            sbhl_search_vars.$genl_inverse_mode_p$.bind( Equality.eql( pred, $const1$genlInverse ), thread );
            sbhl_search_utilities.sbhl_sweep( ( NIL != sbhl_module_utilities.sbhl_transfers_through_module_p( sbhl_search_vars.get_sbhl_search_module() ) ) ? sbhl_module_utilities.get_sbhl_transfers_through_module(
                sbhl_search_vars.get_sbhl_search_module() ) : sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_space$
                    .getDynamicValue( thread ), $sym29$SBHL_MARK_CLOSURE_IN_TARGET_SPACE, node, T );
          }
          finally
          {
  ...
  public static SubLObject sbhl_mark_closure_in_target_space(final SubLObject node)
  {
    ...
    try
    {
      ...
      {
        sbhl_search_utilities.sbhl_sweep( sbhl_module_vars.get_sbhl_module( UNPROVIDED ), sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_gather_space$
            .getDynamicValue( thread ), ( NIL != sbhl_module_utilities.sbhl_transfers_through_module_p( sbhl_search_vars.get_sbhl_search_module() ) ) ? $sym30$SBHL_MARK_NODE_AND_INSTANCES_IN_TARGET_SPACE
                : $sym4$SBHL_CONSIDER_NODE, node, NIL );
      }
    }
    finally
    {
  ...
  public static SubLObject sbhl_mark_node_and_instances_in_target_space(final SubLObject node)
  {
    ...
    sbhl_search_utilities.sbhl_step( sbhl_search_vars.get_sbhl_search_module(), sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.sbhl_search_true_tv(), sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(
        thread ), $sym4$SBHL_CONSIDER_NODE, node, UNPROVIDED, UNPROVIDED );
    return NIL;
  }
  ...
  public static SubLObject sbhl_record_closure(final SubLObject module, final SubLObject node, final SubLObject direction, SubLObject mt, SubLObject tv)
  {
    ...
    else if( NIL != sbhl_link_vars.sbhl_backward_directed_direction_p( direction ) )
    {
  ...
  public static SubLObject unrecord_all_superiors_as_unsearched_ignore_arg2(final SubLObject node, SubLObject ignore)
  {
    ...
    if( NIL != sbhl_paranoia.sbhl_object_type_checking_p() && NIL == sbhl_module_vars.sbhl_predicate_object_p( search_module ) )
    {
      ...
      if( pcase_var.eql( $kw7$ERROR ) )
      {
        sbhl_paranoia.sbhl_error( ONE_INTEGER, $str8$_A_is_not_a__A, search_module, $sym32$SBHL_PREDICATE_OBJECT_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
      else if( pcase_var.eql( $kw10$CERROR ) )
      {
        sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str11$continue_anyway, $str8$_A_is_not_a__A, search_module, $sym32$SBHL_PREDICATE_OBJECT_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
      else if( pcase_var.eql( $kw12$WARN ) )
      {
        Errors.warn( $str8$_A_is_not_a__A, search_module, $sym32$SBHL_PREDICATE_OBJECT_P );
      }
      else
      {
        Errors.warn( $str13$_A_is_not_a_valid__sbhl_type_erro, sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread ) );
        Errors.cerror( $str11$continue_anyway, $str8$_A_is_not_a__A, search_module, $sym32$SBHL_PREDICATE_OBJECT_P );
      }
    }
  ...
  {
    SubLFiles.declareFunction( me, "sbhl_premark_goal_nodes", "SBHL-PREMARK-GOAL-NODES", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_premark_direction", "SBHL-PREMARK-DIRECTION", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_premark_gather_nodes", "SBHL-PREMARK-GATHER-NODES", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_gather_premarked_justifications", "SBHL-GATHER-PREMARKED-JUSTIFICATIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_mark_all_forward_true_nodes", "SBHL-MARK-ALL-FORWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_mark_all_backward_true_nodes", "SBHL-MARK-ALL-BACKWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_mark_closure_as_marked", "SBHL-MARK-CLOSURE-AS-MARKED", 1, 0, false );
    new $sbhl_mark_closure_as_marked$UnaryFunction();
    SubLFiles.declareFunction( me, "sbhl_mark_closure_in_space", "SBHL-MARK-CLOSURE-IN-SPACE", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_mark_forward_true_nodes_in_space", "SBHL-MARK-FORWARD-TRUE-NODES-IN-SPACE", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_mark_backward_true_nodes_in_space", "SBHL-MARK-BACKWARD-TRUE-NODES-IN-SPACE", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_mark_proper_all_forward_true_nodes", "SBHL-MARK-PROPER-ALL-FORWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_mark_proper_closure_as_marked", "SBHL-MARK-PROPER-CLOSURE-AS-MARKED", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_all_marked_forward_true_nodes", "SBHL-UNMARK-ALL-MARKED-FORWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_all_marked_backward_true_nodes", "SBHL-UNMARK-ALL-MARKED-BACKWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_marked_closure", "SBHL-UNMARK-MARKED-CLOSURE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_initialized_marked_closure", "SBHL-UNMARK-INITIALIZED-MARKED-CLOSURE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_proper_marked_closure", "SBHL-UNMARK-PROPER-MARKED-CLOSURE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_all_backward_true_nodes_and_map", "SBHL-UNMARK-ALL-BACKWARD-TRUE-NODES-AND-MAP", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_marked_closure_and_gather", "SBHL-UNMARK-MARKED-CLOSURE-AND-GATHER", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_marked_closure_and_gather_if", "SBHL-UNMARK-MARKED-CLOSURE-AND-GATHER-IF", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_marked_closure_and_mark_in_space", "SBHL-UNMARK-MARKED-CLOSURE-AND-MARK-IN-SPACE", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_marked_closure_and_unmark_in_space", "SBHL-UNMARK-MARKED-CLOSURE-AND-UNMARK-IN-SPACE", 2, 0, false );
    SubLFiles.declareFunction( me, "sbhl_mark_cyclic_closure", "SBHL-MARK-CYCLIC-CLOSURE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_cyclic_closure", "SBHL-UNMARK-CYCLIC-CLOSURE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_mark_max_true_disjoins", "SBHL-MARK-MAX-TRUE-DISJOINS", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_mark_extremal_disjoins", "SBHL-MARK-EXTREMAL-DISJOINS", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_max_true_disjoins", "SBHL-UNMARK-MAX-TRUE-DISJOINS", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_extremal_disjoins", "SBHL-UNMARK-EXTREMAL-DISJOINS", 1, 0, false );
    SubLFiles.declareFunction( me, "determine_sbhl_mark_between_consider_fn", "DETERMINE-SBHL-MARK-BETWEEN-CONSIDER-FN", 0, 0, false );
    SubLFiles.declareFunction( me, "sbhl_mark_forward_true_nodes_between_and_all_their_inherited_nodes", "SBHL-MARK-FORWARD-TRUE-NODES-BETWEEN-AND-ALL-THEIR-INHERITED-NODES", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_unmark_marked_closure_and_target_mark_closure", "SBHL-UNMARK-MARKED-CLOSURE-AND-TARGET-MARK-CLOSURE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_mark_closure_in_target_space", "SBHL-MARK-CLOSURE-IN-TARGET-SPACE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_mark_node_and_instances_in_target_space", "SBHL-MARK-NODE-AND-INSTANCES-IN-TARGET-SPACE", 1, 0, false );
    SubLFiles.declareFunction( me, "sbhl_record_closure", "SBHL-RECORD-CLOSURE", 3, 2, false );
    SubLFiles.declareFunction( me, "sbhl_record_all_forward_true_nodes", "SBHL-RECORD-ALL-FORWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_record_all_backward_true_nodes", "SBHL-RECORD-ALL-BACKWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_record_max_true_disjoins", "SBHL-RECORD-MAX-TRUE-DISJOINS", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_unrecord_max_true_disjoins", "SBHL-UNRECORD-MAX-TRUE-DISJOINS", 2, 2, false );
    SubLFiles.declareFunction( me, "sbhl_unrecord_all_recorded_forward_true_nodes", "SBHL-UNRECORD-ALL-RECORDED-FORWARD-TRUE-NODES", 2, 2, false );
    SubLFiles.declareFunction( me, "unrecord_all_superiors_as_unsearched_ignore_arg2", "UNRECORD-ALL-SUPERIORS-AS-UNSEARCHED-IGNORE-ARG2", 1, 1, false );
    SubLFiles.declareFunction( me, "sbhl_record_node", "SBHL-RECORD-NODE", 1, 1, false );
    SubLFiles.declareFunction( me, "sbhl_recorded_node_p", "SBHL-RECORDED-NODE-P", 1, 1, false );
    SubLFiles.declareFunction( me, "sbhl_unrecorded_node_p", "SBHL-UNRECORDED-NODE-P", 1, 1, false );
    SubLFiles.declareFunction( me, "sbhl_record_proper_all_forward_true_nodes", "SBHL-RECORD-PROPER-ALL-FORWARD-TRUE-NODES", 2, 2, false );
    return NIL;
  }
  ...
  static
  {
    me = new sbhl_marking_methods();
    $sym0$SBHL_CHECK_CUTOFF = makeSymbol( "SBHL-CHECK-CUTOFF" );
    $const1$genlInverse = constant_handles.reader_make_constant_shell( makeString( "genlInverse" ) );
    $sym2$SBHL_NODE_IS_A_GOAL_NODE = makeSymbol( "SBHL-NODE-IS-A-GOAL-NODE" );
    $sym3$SBHL_NODE_IS_GOAL_NODE = makeSymbol( "SBHL-NODE-IS-GOAL-NODE" );
    $sym4$SBHL_CONSIDER_NODE = makeSymbol( "SBHL-CONSIDER-NODE" );
    ...
    $kw15$OLD = makeKeyword( "OLD" );
    $kw16$RESOURCE = makeKeyword( "RESOURCE" );
    $str17$Node__a_does_not_pass_sbhl_type_t = makeString( "Node ~a does not pass sbhl-type-test ~a~%" );
    $str18$marking_space____S__ = makeString( "marking-space = ~S~%" );
    $sym19$SBHL_MARK_CLOSURE_AS_MARKED = makeSymbol( "SBHL-MARK-CLOSURE-AS-MARKED" );
    $sym20$SBHL_UNMARK_INITIALIZED_MARKED_CLOSURE = makeSymbol( "SBHL-UNMARK-INITIALIZED-MARKED-CLOSURE" );
    $sym21$SBHL_APPLY_COMPOSE_FN = makeSymbol( "SBHL-APPLY-COMPOSE-FN" );
    $sym22$SBHL_PUSH_ONTO_RESULT = makeSymbol( "SBHL-PUSH-ONTO-RESULT" );
    $sym23$SBHL_PUSH_ONTO_RESULT_IF = makeSymbol( "SBHL-PUSH-ONTO-RESULT-IF" );
    $sym24$SBHL_APPLY_MARK_IN_SPACE = makeSymbol( "SBHL-APPLY-MARK-IN-SPACE" );
    $sym25$SBHL_APPLY_UNMARK_IN_SPACE = makeSymbol( "SBHL-APPLY-UNMARK-IN-SPACE" );
    $sym26$SBHL_MARK_IN_TARGET_SPACE = makeSymbol( "SBHL-MARK-IN-TARGET-SPACE" );
    $sym27$SBHL_MARK_IN_TARGET_GATHER_SPACE = makeSymbol( "SBHL-MARK-IN-TARGET-GATHER-SPACE" );
    $str28$invalid_module_type__a = makeString( "invalid module type ~a" );
    $sym29$SBHL_MARK_CLOSURE_IN_TARGET_SPACE = makeSymbol( "SBHL-MARK-CLOSURE-IN-TARGET-SPACE" );
    $sym30$SBHL_MARK_NODE_AND_INSTANCES_IN_TARGET_SPACE = makeSymbol( "SBHL-MARK-NODE-AND-INSTANCES-IN-TARGET-SPACE" );
    $str31$Error_in_direction__a = makeString( "Error in direction ~a" );
    $sym32$SBHL_PREDICATE_OBJECT_P = makeSymbol( "SBHL-PREDICATE-OBJECT-P" );
  }

  public static final class $sbhl_mark_closure_as_marked$UnaryFunction
      extends
        UnaryFunction
  {
