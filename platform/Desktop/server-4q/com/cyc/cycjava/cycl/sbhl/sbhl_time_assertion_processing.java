...
public final class sbhl_time_assertion_processing
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject add_temporal_relation(SubLObject source, final SubLObject assertion, SubLObject source_must_be_uniqueP)
  {
    ...
    if( NIL != sbhl_time_vars.sbhl_temporality_activeP() && ( NIL == source_must_be_uniqueP || NIL == subl_promotions.memberP( source, assertions_high.assertion_arguments( assertion ), Symbols.symbol_function(
        $sym4$NOT_EQL ), UNPROVIDED ) ) )
    {
      ...
      try
      {
        ...
        try
        {
          mt_relevance_macros.$relevant_mt_function$.bind( $sym5$RELEVANT_MT_IS_GENL_MT, thread );
          mt_relevance_macros.$mt$.bind( mt, thread );
          if( NIL == sbhl_time_utilities.sbhl_time_predicate_p( pred ) )
          {
            sbhl_paranoia.sbhl_cerror( THREE_INTEGER, $str6$skip_subsumption_op, $str7$_s_is_not_a_sbhl_time_predicate_p, pred, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          }
          else if( NIL == sbhl_time_utilities.sbhl_time_arg_p( arg1 ) )
          {
            sbhl_paranoia.sbhl_cerror( THREE_INTEGER, $str6$skip_subsumption_op, $str8$_s_is_not_a_sbhl_time_arg_p, arg1, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          }
          else if( NIL == sbhl_time_utilities.sbhl_time_arg_p( arg2 ) )
          {
            sbhl_paranoia.sbhl_cerror( THREE_INTEGER, $str6$skip_subsumption_op, $str8$_s_is_not_a_sbhl_time_arg_p, arg2, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          }
          else if( NIL == sbhl_assimilable_temporality_gafP( pred, arg1, arg2 ) )
          {
            sbhl_paranoia.sbhl_cerror( FOUR_INTEGER, $str6$skip_subsumption_op, $str9$gaf_is_effectively_date_date_asse, ConsesLow.list( pred, arg1, arg2 ), truth, mt, UNPROVIDED, UNPROVIDED );
          }
          else
          {
            ...
            try
            {
              ...
              {
                handle_temporal_relation_literal_conflict( pred, arg1, arg2, sense, mt, $kw10$ADD );
              }
              else
              {
  ...
  public static SubLObject remove_temporal_relation(SubLObject source, final SubLObject assertion, SubLObject warn_when_assertion_existsP)
  {
    ...
    if( NIL != sbhl_time_vars.sbhl_temporality_activeP() )
    {
      ...
      try
      {
        ...
        else if( NIL == sbhl_time_utilities.sbhl_time_predicate_p( pred ) )
        {
          sbhl_paranoia.sbhl_cerror( THREE_INTEGER, $str6$skip_subsumption_op, $str7$_s_is_not_a_sbhl_time_predicate_p, pred, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
        }
        else if( NIL == sbhl_time_utilities.sbhl_time_arg_p( arg1 ) )
  ...
  public static SubLObject sbhl_assimilable_temporality_gafP(final SubLObject pred, final SubLObject arg1, final SubLObject arg2)
  {
    ...
    final SubLObject conjunction_fn = sbhl_time_modules.get_sbhl_time_module( pred, $kw15$CONJUNCTION_FN, UNPROVIDED );
    ...
    if( NIL == not_date_date_quasi_linkP )
    {
      ...
      SubLObject conjunct;
      for( csome_list_var = conjuncts, conjunct = NIL, conjunct = csome_list_var.first(); NIL == not_date_date_quasi_linkP && NIL != csome_list_var; not_date_date_quasi_linkP = makeBoolean(
          NIL == sbhl_time_query_processing.date_date_quasi_link_p( conjunct ) ), csome_list_var = csome_list_var.rest(), conjunct = csome_list_var.first() )
      {
      }
    }
  ...
  public static SubLObject add_temporal_relation_literal(final SubLObject support, final SubLObject pred, final SubLObject arg1, final SubLObject arg2, final SubLObject sense, final SubLObject mt)
  {
    ...
    if( sense.eql( $kw16$POS ) )
    {
      ...
      else if( NIL != sbhl_time_utilities.disjunctive_temporal_relation_predP( pred ) )
      {
        add_temporal_quasi_link_conjunction_negation( support, conjuncts, mt );
      }
    }
    else if( sense.eql( $kw17$NEG ) )
    {
      if( NIL != sbhl_time_utilities.conjunctive_temporal_relation_predP( pred ) )
      {
        add_temporal_quasi_link_conjunction_negation( support, conjuncts, mt );
  ...
  public static SubLObject add_hl_start_for_non_date(final SubLObject time)
  {
    ...
    add_temporal_link( $kw20$DEFINITIONAL, $kw21$WEAK, start, end, $sbhl_time_default_link_mt$.getGlobalValue() );
    add_temporal_link( $kw20$DEFINITIONAL, $kw21$WEAK, sbhl_time_utilities.hl_end( $kw22$BEGINNING_OF_TIME ), start, $sbhl_time_default_link_mt$.getGlobalValue() );
    add_temporal_link( $kw20$DEFINITIONAL, $kw21$WEAK, end, sbhl_time_utilities.hl_start( $kw23$END_OF_TIME ), $sbhl_time_default_link_mt$.getGlobalValue() );
    return NIL;
  }
  ...
  public static SubLObject add_hl_start_for_extended_universal_date(final SubLObject eu_date)
  {
    ...
    {
      if( NIL == subl_promotions.memberP( eu_date, sbhl_time_vars.$sbhl_extended_universal_date_list$.getGlobalValue(), Symbols.symbol_function( EQL ), UNPROVIDED ) )
      {
        sbhl_time_vars.$sbhl_extended_universal_date_list$.setGlobalValue( Sort.cmerge( conses_high.copy_list( sbhl_time_vars.$sbhl_extended_universal_date_list$.getGlobalValue() ), ConsesLow.list( eu_date ),
            $sym24$EXTENDED_UNIVERSAL_DATE_, UNPROVIDED ) );
      }
      final SubLObject end = sbhl_time_utilities.hl_end( eu_date );
      final SubLObject n = Sequences.position( eu_date, sbhl_time_vars.$sbhl_extended_universal_date_list$.getGlobalValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      final SubLObject date_list_last_position = Numbers.subtract( Sequences.length( sbhl_time_vars.$sbhl_extended_universal_date_list$.getGlobalValue() ), ONE_INTEGER );
      ...
      {
        eu_date_before = ConsesLow.nth( Numbers.subtract( n, ONE_INTEGER ), sbhl_time_vars.$sbhl_extended_universal_date_list$.getGlobalValue() );
        date_point_before = closest_hl_point_node_at_or_before_end( eu_date_before );
      }
      if( n.numL( date_list_last_position ) )
      {
        eu_date_after = ConsesLow.nth( Numbers.add( n, ONE_INTEGER ), sbhl_time_vars.$sbhl_extended_universal_date_list$.getGlobalValue() );
      ...
      if( NIL != date_point_before )
      {
        ...
        {
          add_temporal_link( $kw20$DEFINITIONAL, $kw25$SUCCESSOR, date_point_before, start, $sbhl_time_default_link_mt$.getGlobalValue() );
        }
        else
        {
          add_temporal_link( $kw20$DEFINITIONAL, $kw26$SUCCESSOR_STRICT, date_point_before, start, $sbhl_time_default_link_mt$.getGlobalValue() );
        }
      }
      if( NIL != sbhl_time_utilities.sbhl_temporal_node_p( end ) )
      {
        add_temporal_link( $kw20$DEFINITIONAL, $kw26$SUCCESSOR_STRICT, start, end, $sbhl_time_default_link_mt$.getGlobalValue() );
      }
      else if( NIL != date_point_after )
      {
        add_temporal_link( $kw20$DEFINITIONAL, $kw26$SUCCESSOR_STRICT, start, date_point_after, $sbhl_time_default_link_mt$.getGlobalValue() );
      }
      if( NIL != date_point_before )
      {
        if( NIL != sbhl_time_utilities.sbhl_temporal_node_p( end ) )
        {
          remove_temporal_link( $kw20$DEFINITIONAL, $kw26$SUCCESSOR_STRICT, date_point_before, end, $sbhl_time_default_link_mt$.getGlobalValue() );
        }
        else if( NIL != date_point_after )
        {
          remove_temporal_link( $kw20$DEFINITIONAL, $kw26$SUCCESSOR_STRICT, date_point_before, date_point_after, $sbhl_time_default_link_mt$.getGlobalValue() );
        }
      }
    }
    return NIL;
  ...
  public static SubLObject add_hl_end_for_extended_universal_date(final SubLObject eu_date)
  {
    ...
    if( NIL == sbhl_time_utilities.sbhl_temporal_node_p( end ) )
    {
      ...
      else if( NIL != date_point_before )
      {
        add_temporal_link( $kw20$DEFINITIONAL, $kw26$SUCCESSOR_STRICT, date_point_before, end, $sbhl_time_default_link_mt$.getGlobalValue() );
      }
      if( NIL != date_point_after )
      {
        ...
        {
          add_temporal_link( $kw20$DEFINITIONAL, $kw25$SUCCESSOR, end, date_point_after, $sbhl_time_default_link_mt$.getGlobalValue() );
        }
        else
        {
          add_temporal_link( $kw20$DEFINITIONAL, $kw26$SUCCESSOR_STRICT, end, date_point_after, $sbhl_time_default_link_mt$.getGlobalValue() );
        }
      }
      if( NIL != date_point_after )
      {
        if( NIL != sbhl_time_utilities.sbhl_temporal_node_p( start ) )
        {
          remove_temporal_link( $kw20$DEFINITIONAL, $kw26$SUCCESSOR_STRICT, start, date_point_after, $sbhl_time_default_link_mt$.getGlobalValue() );
        }
        else if( NIL != date_point_before )
        {
          remove_temporal_link( $kw20$DEFINITIONAL, $kw26$SUCCESSOR_STRICT, date_point_before, date_point_after, $sbhl_time_default_link_mt$.getGlobalValue() );
  ...
  public static SubLObject add_temporal_link(final SubLObject support, final SubLObject val, final SubLObject before, final SubLObject after, final SubLObject mt)
  {
    ...
    if( !before.eql( after ) && NIL != sbhl_time_utilities.hl_endpoint_p( before ) && NIL != sbhl_time_utilities.hl_endpoint_p( after ) )
    {
      ...
      else if( val == $kw28$COORDINATE )
      {
        link_addedP = add_temporal_link_int( support, $kw21$WEAK, before, after, mt );
        link_addedP = makeBoolean( NIL != add_temporal_link_int( support, $kw21$WEAK, after, before, mt ) || NIL != link_addedP );
      }
      else if( val == $kw25$SUCCESSOR )
      {
        link_addedP = add_temporal_link_int( support, $kw29$STRICT, before, after, mt );
        link_addedP = makeBoolean( NIL != add_temporal_link_int( support, $kw30$WEAK_SUCCESSOR, after, before, mt ) || NIL != link_addedP );
      }
    }
    return link_addedP;
  }
  ...
  public static SubLObject remove_temporal_link(final SubLObject support, final SubLObject val, final SubLObject before, final SubLObject after, final SubLObject mt)
  {
    if( NIL != sbhl_time_utilities.hl_endpoint_p( before ) && NIL != sbhl_time_utilities.hl_endpoint_p( after ) )
    {
      ...
      {
        remove_temporal_link_int( support, $kw21$WEAK, before, after, mt );
        remove_temporal_link_int( support, $kw21$WEAK, after, before, mt );
      }
      else if( val == $kw25$SUCCESSOR )
      {
        remove_temporal_link_int( support, $kw29$STRICT, before, after, mt );
        remove_temporal_link_int( support, $kw30$WEAK_SUCCESSOR, after, before, mt );
      }
    }
    return NIL;
  }
  ...
  {
    return existing_temporal_link_object_supportP( ConsesLow.list( val, before, after, mt ), sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue() );
  }
  ...
  {
    final SubLObject value = Hashtables.gethash_without_values( link_object, table, UNPROVIDED );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        supports = Sequences.remove( support, supports, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
      cdolist_list_var = cdolist_list_var.rest();
      support = cdolist_list_var.first();
    }
  ...
  {
    return add_temporal_link_object_support( support, ConsesLow.list( val, before, after, mt ), sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue() );
  }
  ...
  {
    hash_table_utilities.pushnew_hash( link_object, support, table, Symbols.symbol_function( EQUAL ) );
    return NIL;
  }
  ...
  {
    final SubLObject link = ConsesLow.list( val, before, after, mt );
    SubLObject supports = Hashtables.gethash_without_values( link, sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue(), UNPROVIDED );
    SubLObject cdolist_list_var;
    supports = ( cdolist_list_var = Sequences.remove( support, supports, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        supports = Sequences.remove( new_support, supports, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
      cdolist_list_var = cdolist_list_var.rest();
      new_support = cdolist_list_var.first();
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( NIL != sbhl_time_utilities.hl_endpoint_p( temporal_point ) && NIL == sbhl_time_utilities.sbhl_temporal_node_p( temporal_point ) && NIL == Hashtables.gethash_without_values( temporal_point,
        sbhl_time_vars.$sbhl_temporal_link_disjunction_term_table$.getGlobalValue(), UNPROVIDED ) && NIL == subl_promotions.memberP( temporal_point, sbhl_time_vars.$sbhl_temporal_points_being_removed$.getDynamicValue(
            thread ), Symbols.symbol_function( EQL ), UNPROVIDED ) )
    {
      final SubLObject _prev_bind_0 = sbhl_time_vars.$sbhl_temporal_points_being_removed$.currentBinding( thread );
      try
      {
        sbhl_time_vars.$sbhl_temporal_points_being_removed$.bind( ConsesLow.cons( temporal_point, sbhl_time_vars.$sbhl_temporal_points_being_removed$.getDynamicValue( thread ) ), thread );
  ...
  public static SubLObject consider_removing_definitional_links_for_date_point(final SubLObject point)
  {
        ...
        try
        {
          ...
          if( NIL != d_link )
          {
            for( rest_$8 = NIL, rest_$8 = sbhl_module_utilities.get_relevant_sbhl_directions( module_$7 ); NIL == do_not_removeP && NIL != rest_$8; rest_$8 = rest_$8.rest() )
            {
              ...
              {
                for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( mt_links ) ); NIL == do_not_removeP && NIL == dictionary_contents.do_dictionary_contents_doneP(
                    iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                {
                  ...
                  thread.resetMultipleValues();
                  for( iteration_state_$9 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == do_not_removeP && NIL == dictionary_contents
                      .do_dictionary_contents_doneP( iteration_state_$9 ); iteration_state_$9 = dictionary_contents.do_dictionary_contents_next( iteration_state_$9 ) )
                  {
                    thread.resetMultipleValues();
                    ...
                    if( NIL != sbhl_search_vars.sbhl_true_tv_p( tv ) )
                    {
                      ...
                      if( NIL != set.set_p( sol ) )
                      {
                        ...
                        for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object,
                            set_contents_var ); NIL == do_not_removeP && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
                        {
            ...
            for( rest_$9 = NIL, rest_$9 = sbhl_module_utilities.get_relevant_sbhl_directions( module_$7 ); NIL == do_not_removeP && NIL != rest_$9; rest_$9 = rest_$9.rest() )
            {
              ...
              if( NIL != mt_links && direction.eql( sbhl_module_utilities.get_sbhl_module_backward_direction( module_$7 ) ) )
              {
                    ...
                    iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                {
                  ...
                  tv_links = thread.secondMultipleValue();
                  thread.resetMultipleValues();
                  for( iteration_state_$10 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == do_not_removeP && NIL == dictionary_contents
                      .do_dictionary_contents_doneP( iteration_state_$10 ); iteration_state_$10 = dictionary_contents.do_dictionary_contents_next( iteration_state_$10 ) )
                  {
                    thread.resetMultipleValues();
    ...
    final SubLObject before_link = ConsesLow.list( before_link_tag, before, point, $sbhl_time_default_link_mt$.getGlobalValue() );
    final SubLObject before_supports = Hashtables.gethash_without_values( before_link, sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue(), UNPROVIDED );
    if( !before_supports.eql( $list33 ) )
    {
      return NIL;
    }
    final SubLObject after_link = ConsesLow.list( after_link_tag, point, after, $sbhl_time_default_link_mt$.getGlobalValue() );
    final SubLObject after_supports = Hashtables.gethash_without_values( after_link, sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue(), UNPROVIDED );
    if( !after_supports.eql( $list33 ) )
    {
      return NIL;
    }
    SubLObject pcase_var = before_link_tag;
    if( pcase_var.eql( $kw29$STRICT ) )
    {
      preceding_link_tag = $kw25$SUCCESSOR;
      preceding_node = before;
    }
    else if( pcase_var.eql( $kw26$SUCCESSOR_STRICT ) )
    {
      preceding_link_tag = $kw26$SUCCESSOR_STRICT;
      preceding_node = before;
    }
    pcase_var = after_link_tag;
    if( pcase_var.eql( $kw29$STRICT ) )
    {
      succeeding_link_tag = $kw25$SUCCESSOR;
      succeeding_node = after;
    }
    else if( pcase_var.eql( $kw26$SUCCESSOR_STRICT ) )
    {
      succeeding_link_tag = $kw26$SUCCESSOR_STRICT;
      succeeding_node = after;
    }
    if( NIL != preceding_node && NIL != succeeding_node )
    {
      add_temporal_link( $kw20$DEFINITIONAL, $kw26$SUCCESSOR_STRICT, preceding_node, succeeding_node, $sbhl_time_default_link_mt$.getGlobalValue() );
      remove_temporal_link( $kw20$DEFINITIONAL, preceding_link_tag, preceding_node, point, $sbhl_time_default_link_mt$.getGlobalValue() );
      remove_temporal_link( $kw20$DEFINITIONAL, succeeding_link_tag, point, succeeding_node, $sbhl_time_default_link_mt$.getGlobalValue() );
    }
    else if( NIL != preceding_node )
    {
      remove_temporal_link( $kw20$DEFINITIONAL, preceding_link_tag, preceding_node, point, $sbhl_time_default_link_mt$.getGlobalValue() );
    }
    else if( NIL != succeeding_node )
    {
      remove_temporal_link( $kw20$DEFINITIONAL, succeeding_link_tag, point, succeeding_node, $sbhl_time_default_link_mt$.getGlobalValue() );
    }
    sbhl_time_vars.$sbhl_extended_universal_date_list$.setGlobalValue( Sequences.remove( eu_date, sbhl_time_vars.$sbhl_extended_universal_date_list$.getGlobalValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED,
        UNPROVIDED ) );
    return NIL;
  }
  ...
  {
    assert NIL != Types.symbolp( link_type_symbol ) : link_type_symbol;
    ...
    {
      return $kw30$WEAK_SUCCESSOR;
    }
    if( link_type_symbol.eql( $sym38$__ ) )
    {
      return $kw26$SUCCESSOR_STRICT;
    }
    return NIL;
  }
  ...
  public static SubLObject consider_removing_definitional_links_for_non_date_point(final SubLObject temporal_point)
  {
    ...
    else if( NIL != sbhl_time_utilities.hl_end_p( temporal_point ) )
    {
  ...
  public static SubLObject consider_removing_definitional_links_for_non_date_point_start(final SubLObject before)
  {
            ...
            for( rest_$13 = NIL, rest_$13 = sbhl_module_utilities.get_relevant_sbhl_directions( module_$12 ); NIL == do_not_removeP && NIL != rest_$13; rest_$13 = rest_$13.rest() )
            {
              ...
              if( NIL != mt_links && direction.eql( sbhl_module_utilities.get_sbhl_module_backward_direction( module_$12 ) ) )
              {
                    ...
                    iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                {
                  ...
                  tv_links = thread.secondMultipleValue();
                  thread.resetMultipleValues();
                  for( iteration_state_$14 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == do_not_removeP && NIL == dictionary_contents
                      .do_dictionary_contents_doneP( iteration_state_$14 ); iteration_state_$14 = dictionary_contents.do_dictionary_contents_next( iteration_state_$14 ) )
                  {
                    thread.resetMultipleValues();
            ...
            for( rest_$14 = NIL, rest_$14 = sbhl_module_utilities.get_relevant_sbhl_directions( module_$12 ); NIL == do_not_removeP && NIL != rest_$14; rest_$14 = rest_$14.rest() )
            {
              ...
              if( NIL != mt_links && direction.eql( sbhl_module_utilities.get_sbhl_module_forward_direction( module_$12 ) ) )
              {
                    ...
                    iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                {
                  ...
                  tv_links = thread.secondMultipleValue();
                  thread.resetMultipleValues();
                  for( iteration_state_$15 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == do_not_removeP && NIL == dictionary_contents
    ...
    final SubLObject after_link = ConsesLow.list( after_link_tag, before, after, $sbhl_time_default_link_mt$.getGlobalValue() );
    final SubLObject supports = Hashtables.gethash_without_values( after_link, sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue(), UNPROVIDED );
    if( !supports.equal( $list33 ) )
    {
      return NIL;
    }
    remove_temporal_link( $kw20$DEFINITIONAL, after_link_tag, before, after, $sbhl_time_default_link_mt$.getGlobalValue() );
    return NIL;
  }
  ...
  public static SubLObject consider_removing_definitional_links_for_non_date_point_end(final SubLObject after)
  {
            ...
            for( rest_$18 = NIL, rest_$18 = sbhl_module_utilities.get_relevant_sbhl_directions( module_$17 ); NIL == do_not_removeP && NIL != rest_$18; rest_$18 = rest_$18.rest() )
            {
              ...
              if( NIL != mt_links && direction.eql( sbhl_module_utilities.get_sbhl_module_forward_direction( module_$17 ) ) )
              {
                    ...
                    iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                {
                  ...
                  tv_links = thread.secondMultipleValue();
                  thread.resetMultipleValues();
                  for( iteration_state_$19 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == do_not_removeP && NIL == dictionary_contents
            ...
            for( rest_$19 = NIL, rest_$19 = sbhl_module_utilities.get_relevant_sbhl_directions( module_$17 ); NIL == do_not_removeP && NIL != rest_$19; rest_$19 = rest_$19.rest() )
            {
              ...
              if( NIL != mt_links && direction.eql( sbhl_module_utilities.get_sbhl_module_backward_direction( module_$17 ) ) )
              {
                    ...
                    iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                {
                  ...
                  tv_links = thread.secondMultipleValue();
                  thread.resetMultipleValues();
                  for( iteration_state_$20 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == do_not_removeP && NIL == dictionary_contents
    ...
    final SubLObject before_link = ConsesLow.list( before_link_tag, before, after, $sbhl_time_default_link_mt$.getGlobalValue() );
    final SubLObject supports = Hashtables.gethash_without_values( before_link, sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue(), UNPROVIDED );
    if( !supports.equal( $list33 ) )
    {
      return NIL;
    }
    remove_temporal_link( $kw20$DEFINITIONAL, before_link_tag, before, after, $sbhl_time_default_link_mt$.getGlobalValue() );
    return NIL;
  }
  ...
  {
    final SubLObject link_disjunction = ConsesLow.list( disjuncts, mt );
  ...
  {
    remove_temporal_link_disjunction_support( support, ConsesLow.list( disjuncts, mt ) );
    return NIL;
  }
  ...
  {
    SubLObject supports = Hashtables.gethash_without_values( link_disjunction, sbhl_time_vars.$sbhl_temporal_link_disjunction_support_table$.getGlobalValue(), UNPROVIDED );
    SubLObject cdolist_list_var;
    supports = ( cdolist_list_var = Sequences.remove( support, supports, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    SubLObject new_support = NIL;
    new_support = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
  ...
  {
    SubLObject supports = Hashtables.gethash_without_values( temporal_point, sbhl_time_vars.$sbhl_temporal_link_disjunction_term_table$.getGlobalValue(), UNPROVIDED );
    supports = Sequences.remove( support, supports, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL != supports )
    {
  ...
  public static SubLObject remove_fort_from_sbhl_temporality_structures(final SubLObject fort)
  {
    ...
    if( NIL != sbhl_time_utilities.time_stored_in_hl_p( fort ) )
    {
      ...
      if( NIL == subl_promotions.memberP( hl_start, sbhl_time_vars.$sbhl_temporal_points_being_removed$.getDynamicValue( thread ), Symbols.symbol_function( EQL ), UNPROVIDED ) )
      {
        final SubLObject _prev_bind_0 = sbhl_time_vars.$sbhl_temporal_points_being_removed$.currentBinding( thread );
        try
        {
          sbhl_time_vars.$sbhl_temporal_points_being_removed$.bind( ConsesLow.cons( hl_start, sbhl_time_vars.$sbhl_temporal_points_being_removed$.getDynamicValue( thread ) ), thread );
          SubLObject cdolist_list_var;
      ...
      if( NIL == subl_promotions.memberP( hl_end, sbhl_time_vars.$sbhl_temporal_points_being_removed$.getDynamicValue( thread ), Symbols.symbol_function( EQL ), UNPROVIDED ) )
      {
        final SubLObject _prev_bind_0 = sbhl_time_vars.$sbhl_temporal_points_being_removed$.currentBinding( thread );
        try
        {
          sbhl_time_vars.$sbhl_temporal_points_being_removed$.bind( ConsesLow.cons( hl_end, sbhl_time_vars.$sbhl_temporal_points_being_removed$.getDynamicValue( thread ) ), thread );
          SubLObject cdolist_list_var;
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject link_disjunctions = Hashtables.gethash_without_values( point, sbhl_time_vars.$sbhl_temporal_link_disjunction_term_table$.getGlobalValue(), UNPROVIDED );
                    ...
                    if( NIL != sbhl_search_vars.sbhl_true_tv_p( tv ) )
                    {
                      ...
                      if( NIL != set.set_p( sol ) )
                      {
                            ...
                            set_contents_var ); NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
                        {
                          ...
                          {
                            supports = ( cdolist_list_var_$33 = Hashtables.gethash_without_values( ConsesLow.list( tag, point, after, mt ), sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue(),
                                UNPROVIDED ) );
                            support = NIL;
                      ...
                      else if( sol.isList() )
                      {
                        ...
                        while ( NIL != csome_list_var)
                        {
                          ...
                          final SubLObject supports2 = cdolist_list_var_$34 = Hashtables.gethash_without_values( ConsesLow.list( tag, point, after2, mt ), sbhl_time_vars.$sbhl_temporal_link_support_table$
                    ...
                    if( NIL != sbhl_search_vars.sbhl_true_tv_p( tv ) )
                    {
                      ...
                      if( NIL != set.set_p( sol ) )
                      {
                            ...
                            set_contents_var ); NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
                        {
                          ...
                          {
                            supports = ( cdolist_list_var_$36 = Hashtables.gethash_without_values( ConsesLow.list( tag, before, point, mt ), sbhl_time_vars.$sbhl_temporal_link_support_table$.getGlobalValue(),
                                UNPROVIDED ) );
                            support = NIL;
                      ...
                      else if( sol.isList() )
                      {
                        ...
                        while ( NIL != csome_list_var)
                        {
                          ...
                          final SubLObject supports2 = cdolist_list_var_$37 = Hashtables.gethash_without_values( ConsesLow.list( tag, before2, point, mt ), sbhl_time_vars.$sbhl_temporal_link_support_table$
                              .getGlobalValue(), UNPROVIDED );
                          SubLObject support2 = NIL;
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      final SubLObject link_disjunction_supports = cdolist_list_var_$38 = Hashtables.gethash_without_values( link_disjunction, sbhl_time_vars.$sbhl_temporal_link_disjunction_support_table$.getGlobalValue(), UNPROVIDED );
      ...
      while ( NIL != cdolist_list_var_$38)
      {
        if( NIL != assertions_high.valid_assertion( support3, UNPROVIDED ) )
        {
          ...
          if( NIL == conses_high.member( item_var3, assertions, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
          {
            assertions = ConsesLow.cons( item_var3, assertions );
          }
        }
  ...
  public static SubLObject handle_temporal_relation_literal_conflict(final SubLObject pred, final SubLObject arg1, final SubLObject arg2, final SubLObject sense, final SubLObject mt, SubLObject op)
  {
    ...
    final SubLObject gaf = narts_high.nart_expand( fi.assertion_expand( ConsesLow.list( pred, arg1, arg2 ) ) );
    final SubLObject truth = enumeration_types.sense_truth( sense );
    if( NIL == control_vars.$suppress_conflict_noticesP$.getDynamicValue( thread ) )
    {
      Errors.warn( $str43$sbhl_conflict___s__a__a__, gaf, truth, mt );
      if( NIL == control_vars.$ignore_conflictsP$.getDynamicValue( thread ) )
      {
        ...
        conflicts.$current_conflicts$.setGlobalValue( ConsesLow.cons( ConsesLow.list( gaf, mt, truth, op ), conflicts.$current_conflicts$.getGlobalValue() ) );
        conflicts.$mt_conflicts$.setGlobalValue( ConsesLow.cons( ConsesLow.list( gaf, mt, truth, op ), conflicts.$mt_conflicts$.getGlobalValue() ) );
      }
    }
    return NIL;
  }
  ...
  {
    SubLFiles.declareFunction( me, "add_temporal_relation", "ADD-TEMPORAL-RELATION", 2, 1, false );
    SubLFiles.declareFunction( me, "add_wff_temporal_relation", "ADD-WFF-TEMPORAL-RELATION", 2, 1, false );
    SubLFiles.declareFunction( me, "remove_temporal_relation", "REMOVE-TEMPORAL-RELATION", 2, 1, false );
    SubLFiles.declareFunction( me, "sbhl_assimilable_temporality_gafP", "SBHL-ASSIMILABLE-TEMPORALITY-GAF?", 3, 0, false );
    SubLFiles.declareFunction( me, "add_temporal_relation_literal", "ADD-TEMPORAL-RELATION-LITERAL", 6, 0, false );
    SubLFiles.declareFunction( me, "remove_temporal_relation_literal", "REMOVE-TEMPORAL-RELATION-LITERAL", 6, 0, false );
    SubLFiles.declareFunction( me, "add_temporal_quasi_link_conjunction", "ADD-TEMPORAL-QUASI-LINK-CONJUNCTION", 3, 0, false );
    SubLFiles.declareFunction( me, "remove_temporal_quasi_link_conjunction", "REMOVE-TEMPORAL-QUASI-LINK-CONJUNCTION", 3, 0, false );
    SubLFiles.declareFunction( me, "find_or_create_hl_temporal_point", "FIND-OR-CREATE-HL-TEMPORAL-POINT", 1, 0, false );
    SubLFiles.declareFunction( me, "find_hl_temporal_point", "FIND-HL-TEMPORAL-POINT", 1, 0, false );
    SubLFiles.declareFunction( me, "add_hl_start_for_non_date", "ADD-HL-START-FOR-NON-DATE", 1, 0, false );
    SubLFiles.declareFunction( me, "find_or_create_hl_start", "FIND-OR-CREATE-HL-START", 1, 0, false );
    SubLFiles.declareFunction( me, "add_hl_end_for_non_date", "ADD-HL-END-FOR-NON-DATE", 1, 0, false );
    SubLFiles.declareFunction( me, "find_or_create_hl_end", "FIND-OR-CREATE-HL-END", 1, 0, false );
    SubLFiles.declareFunction( me, "add_hl_start_for_extended_universal_date", "ADD-HL-START-FOR-EXTENDED-UNIVERSAL-DATE", 1, 0, false );
    SubLFiles.declareFunction( me, "add_hl_end_for_extended_universal_date", "ADD-HL-END-FOR-EXTENDED-UNIVERSAL-DATE", 1, 0, false );
    SubLFiles.declareFunction( me, "closest_hl_point_node_at_or_after_start", "CLOSEST-HL-POINT-NODE-AT-OR-AFTER-START", 1, 0, false );
    SubLFiles.declareFunction( me, "closest_hl_point_node_at_or_before_end", "CLOSEST-HL-POINT-NODE-AT-OR-BEFORE-END", 1, 0, false );
    SubLFiles.declareFunction( me, "add_temporal_link", "ADD-TEMPORAL-LINK", 5, 0, false );
    SubLFiles.declareFunction( me, "remove_temporal_link", "REMOVE-TEMPORAL-LINK", 5, 0, false );
    SubLFiles.declareFunction( me, "add_temporal_link_int", "ADD-TEMPORAL-LINK-INT", 5, 0, false );
    SubLFiles.declareFunction( me, "remove_temporal_link_int", "REMOVE-TEMPORAL-LINK-INT", 5, 0, false );
    SubLFiles.declareFunction( me, "existing_temporal_link_supportP", "EXISTING-TEMPORAL-LINK-SUPPORT?", 4, 0, false );
    SubLFiles.declareFunction( me, "existing_temporal_link_object_supportP", "EXISTING-TEMPORAL-LINK-OBJECT-SUPPORT?", 2, 0, false );
    SubLFiles.declareFunction( me, "add_temporal_link_support", "ADD-TEMPORAL-LINK-SUPPORT", 5, 0, false );
    SubLFiles.declareFunction( me, "add_temporal_link_object_support", "ADD-TEMPORAL-LINK-OBJECT-SUPPORT", 3, 0, false );
    SubLFiles.declareFunction( me, "remove_temporal_link_support", "REMOVE-TEMPORAL-LINK-SUPPORT", 5, 0, false );
    SubLFiles.declareFunction( me, "consider_removing_temporal_point", "CONSIDER-REMOVING-TEMPORAL-POINT", 1, 0, false );
    SubLFiles.declareFunction( me, "consider_removing_definitional_links", "CONSIDER-REMOVING-DEFINITIONAL-LINKS", 1, 0, false );
    SubLFiles.declareFunction( me, "consider_removing_definitional_links_for_date_point", "CONSIDER-REMOVING-DEFINITIONAL-LINKS-FOR-DATE-POINT", 1, 0, false );
    SubLFiles.declareFunction( me, "link_type_keyword_for_symbol", "LINK-TYPE-KEYWORD-FOR-SYMBOL", 1, 0, false );
    SubLFiles.declareFunction( me, "consider_removing_definitional_links_for_non_date_point", "CONSIDER-REMOVING-DEFINITIONAL-LINKS-FOR-NON-DATE-POINT", 1, 0, false );
    SubLFiles.declareFunction( me, "consider_removing_definitional_links_for_non_date_point_start", "CONSIDER-REMOVING-DEFINITIONAL-LINKS-FOR-NON-DATE-POINT-START", 1, 0, false );
    SubLFiles.declareFunction( me, "consider_removing_definitional_links_for_non_date_point_end", "CONSIDER-REMOVING-DEFINITIONAL-LINKS-FOR-NON-DATE-POINT-END", 1, 0, false );
    SubLFiles.declareFunction( me, "add_temporal_quasi_link_conjunction_negation", "ADD-TEMPORAL-QUASI-LINK-CONJUNCTION-NEGATION", 3, 0, false );
    SubLFiles.declareFunction( me, "remove_temporal_quasi_link_conjunction_negation", "REMOVE-TEMPORAL-QUASI-LINK-CONJUNCTION-NEGATION", 3, 0, false );
    SubLFiles.declareFunction( me, "add_temporal_link_disjunction", "ADD-TEMPORAL-LINK-DISJUNCTION", 3, 0, false );
    SubLFiles.declareFunction( me, "remove_temporal_link_disjunction", "REMOVE-TEMPORAL-LINK-DISJUNCTION", 3, 0, false );
    SubLFiles.declareFunction( me, "existing_temporal_link_disjunction_supportP", "EXISTING-TEMPORAL-LINK-DISJUNCTION-SUPPORT?", 1, 0, false );
    SubLFiles.declareFunction( me, "add_temporal_link_disjunction_support", "ADD-TEMPORAL-LINK-DISJUNCTION-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_temporal_link_disjunction_support", "REMOVE-TEMPORAL-LINK-DISJUNCTION-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "add_note_of_temporal_link_disjunction_terms", "ADD-NOTE-OF-TEMPORAL-LINK-DISJUNCTION-TERMS", 1, 0, false );
    SubLFiles.declareFunction( me, "remove_note_of_temporal_link_disjunction_terms", "REMOVE-NOTE-OF-TEMPORAL-LINK-DISJUNCTION-TERMS", 1, 0, false );
    SubLFiles.declareFunction( me, "add_temporal_link_disjunction_term_support", "ADD-TEMPORAL-LINK-DISJUNCTION-TERM-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_temporal_link_disjunction_term_support", "REMOVE-TEMPORAL-LINK-DISJUNCTION-TERM-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_fort_from_sbhl_temporality_structures", "REMOVE-FORT-FROM-SBHL-TEMPORALITY-STRUCTURES", 1, 0, false );
    SubLFiles.declareFunction( me, "temporal_point_assertion_supports", "TEMPORAL-POINT-ASSERTION-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "handle_temporal_relation_literal_conflict", "HANDLE-TEMPORAL-RELATION-LITERAL-CONFLICT", 5, 1, false );
    SubLFiles.declareFunction( me, "sbhl_temporality_conflict_notify", "SBHL-TEMPORALITY-CONFLICT-NOTIFY", 4, 1, false );
    return NIL;
  }

  public static SubLObject init_sbhl_time_assertion_processing_file()
  {
    $sbhl_time_default_link_mt$ = SubLFiles.deflexical( "*SBHL-TIME-DEFAULT-LINK-MT*", maybeDefault( $sym0$_SBHL_TIME_DEFAULT_LINK_MT_, $sbhl_time_default_link_mt$, $const1$BaseKB ) );
    $hl_start_end_fn_defining_mt$ = SubLFiles.deflexical( "*HL-START-END-FN-DEFINING-MT*", maybeDefault( $sym2$_HL_START_END_FN_DEFINING_MT_, $hl_start_end_fn_defining_mt$, $const1$BaseKB ) );
    return NIL;
  }

  public static SubLObject setup_sbhl_time_assertion_processing_file()
  {
    subl_macro_promotions.declare_defglobal( $sym0$_SBHL_TIME_DEFAULT_LINK_MT_ );
    mt_vars.note_mt_var( $sym0$_SBHL_TIME_DEFAULT_LINK_MT_, NIL );
    subl_macro_promotions.declare_defglobal( $sym2$_HL_START_END_FN_DEFINING_MT_ );
    mt_vars.note_mt_var( $sym2$_HL_START_END_FN_DEFINING_MT_, $const3$HL_StartFn );
    utilities_macros.register_kb_function( $sym11$ADD_TEMPORAL_RELATION );
    utilities_macros.register_kb_function( $sym14$REMOVE_TEMPORAL_RELATION );
    return NIL;
  }
  ...
  static
  {
    me = new sbhl_time_assertion_processing();
    $sbhl_time_default_link_mt$ = null;
    $hl_start_end_fn_defining_mt$ = null;
    $sym0$_SBHL_TIME_DEFAULT_LINK_MT_ = makeSymbol( "*SBHL-TIME-DEFAULT-LINK-MT*" );
    $const1$BaseKB = constant_handles.reader_make_constant_shell( makeString( "BaseKB" ) );
    $sym2$_HL_START_END_FN_DEFINING_MT_ = makeSymbol( "*HL-START-END-FN-DEFINING-MT*" );
    $const3$HL_StartFn = constant_handles.reader_make_constant_shell( makeString( "HL-StartFn" ) );
    $sym4$NOT_EQL = makeSymbol( "NOT-EQL" );
    $sym5$RELEVANT_MT_IS_GENL_MT = makeSymbol( "RELEVANT-MT-IS-GENL-MT" );
    $str6$skip_subsumption_op = makeString( "skip subsumption op" );
    $str7$_s_is_not_a_sbhl_time_predicate_p = makeString( "~s is not a sbhl-time-predicate-p" );
    $str8$_s_is_not_a_sbhl_time_arg_p = makeString( "~s is not a sbhl-time-arg-p" );
    $str9$gaf_is_effectively_date_date_asse = makeString( "gaf is effectively date-date assertion: ~s ~a ~a~%" );
    $kw10$ADD = makeKeyword( "ADD" );
    $sym11$ADD_TEMPORAL_RELATION = makeSymbol( "ADD-TEMPORAL-RELATION" );
    $sym12$RELEVANT_MT_IS_EQ = makeSymbol( "RELEVANT-MT-IS-EQ" );
    $str13$_sbhl__genls__skipping_remove_op_ = makeString( "[sbhl :genls] skipping remove op; assertion still there: ~%~s" );
    $sym14$REMOVE_TEMPORAL_RELATION = makeSymbol( "REMOVE-TEMPORAL-RELATION" );
    $kw15$CONJUNCTION_FN = makeKeyword( "CONJUNCTION-FN" );
    $kw16$POS = makeKeyword( "POS" );
    $kw17$NEG = makeKeyword( "NEG" );
    $kw18$START = makeKeyword( "START" );
    $kw19$END = makeKeyword( "END" );
    $kw20$DEFINITIONAL = makeKeyword( "DEFINITIONAL" );
    $kw21$WEAK = makeKeyword( "WEAK" );
    $kw22$BEGINNING_OF_TIME = makeKeyword( "BEGINNING-OF-TIME" );
    $kw23$END_OF_TIME = makeKeyword( "END-OF-TIME" );
    $sym24$EXTENDED_UNIVERSAL_DATE_ = makeSymbol( "EXTENDED-UNIVERSAL-DATE<" );
    $kw25$SUCCESSOR = makeKeyword( "SUCCESSOR" );
    $kw26$SUCCESSOR_STRICT = makeKeyword( "SUCCESSOR-STRICT" );
    $list27 = ConsesLow.list( makeKeyword( "WEAK" ), makeKeyword( "STRICT" ), makeKeyword( "WEAK-SUCCESSOR" ), makeKeyword( "SUCCESSOR-STRICT" ) );
    $kw28$COORDINATE = makeKeyword( "COORDINATE" );
    $kw29$STRICT = makeKeyword( "STRICT" );
    $kw30$WEAK_SUCCESSOR = makeKeyword( "WEAK-SUCCESSOR" );
    $list31 = ConsesLow.cons( makeUninternedSymbol( "KEY" ), makeUninternedSymbol( "MODULE" ) );
    $str32$_A_is_neither_SET_P_nor_LISTP_ = makeString( "~A is neither SET-P nor LISTP." );
    $list33 = ConsesLow.list( makeKeyword( "DEFINITIONAL" ) );
    $sym34$SYMBOLP = makeSymbol( "SYMBOLP" );
    $sym35$__ = makeSymbol( "<=" );
    $sym36$_ = makeSymbol( "<" );
    $sym37$____ = makeSymbol( "<=<=" );
    $sym38$__ = makeSymbol( "<<" );
    ...
    $str43$sbhl_conflict___s__a__a__ = makeString( "sbhl conflict: ~s ~a ~a~%" );
    $str44$sbhl_conflict___s__a__a________be = makeString( "sbhl conflict: ~s ~a ~a~%      because:" );
    $str45$__a = makeString( " ~a" );
    $kw46$IGNORE = makeKeyword( "IGNORE" );
    $kw47$HALT = makeKeyword( "HALT" );
    $kw48$DEBUG = makeKeyword( "DEBUG" );
    $str49$leave_the_kb_inconsistent_for_now = makeString( "leave the kb inconsistent for now and resolve the conflict later" );
  }
}
/*
 * 
