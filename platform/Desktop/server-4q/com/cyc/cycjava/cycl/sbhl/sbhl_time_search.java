...
public final class sbhl_time_search extends SubLTranslatedFile
{
    ...
    public static SubLObject add_precedence_link(final SubLObject inferior, final SubLObject mt, final SubLObject val, final SubLObject superior) {
        ...
        if (val.eql((SubLObject)sbhl_time_search.$kw0$WEAK)) {
            final SubLObject _prev_bind_0 = sbhl_module_vars.$sbhl_module$.currentBinding(thread);
            try {
                sbhl_module_vars.$sbhl_module$.bind(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), thread);
                sbhl_link_methods.add_sbhl_link(inferior, superior, mt, sbhl_time_search.$const2$MonotonicallyTrue);
            }
            finally {
                sbhl_module_vars.$sbhl_module$.rebind(_prev_bind_0, thread);
            }
        }
        else if (val.eql((SubLObject)sbhl_time_search.$kw3$STRICT)) {
            final SubLObject _prev_bind_0 = sbhl_module_vars.$sbhl_module$.currentBinding(thread);
            try {
                sbhl_module_vars.$sbhl_module$.bind(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const4$strict_HL_TimePrecedence), thread);
                sbhl_link_methods.add_sbhl_link(inferior, superior, mt, sbhl_time_search.$const2$MonotonicallyTrue);
            }
            finally {
                sbhl_module_vars.$sbhl_module$.rebind(_prev_bind_0, thread);
        ...
        else if (val.eql((SubLObject)sbhl_time_search.$kw5$WEAK_SUCCESSOR)) {
            final SubLObject _prev_bind_0 = sbhl_module_vars.$sbhl_module$.currentBinding(thread);
            try {
                sbhl_module_vars.$sbhl_module$.bind(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const6$weakSuccessor_HL_TimePrecedence), thread);
                sbhl_link_methods.add_sbhl_link(inferior, superior, mt, sbhl_time_search.$const2$MonotonicallyTrue);
            }
            finally {
                sbhl_module_vars.$sbhl_module$.rebind(_prev_bind_0, thread);
        ...
        else if (val.eql((SubLObject)sbhl_time_search.$kw7$SUCCESSOR_STRICT)) {
            final SubLObject _prev_bind_0 = sbhl_module_vars.$sbhl_module$.currentBinding(thread);
            try {
                sbhl_module_vars.$sbhl_module$.bind(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const8$successorStrict_HL_TimePrecedence), thread);
                sbhl_link_methods.add_sbhl_link(inferior, superior, mt, sbhl_time_search.$const2$MonotonicallyTrue);
            }
            finally {
                sbhl_module_vars.$sbhl_module$.rebind(_prev_bind_0, thread);
        ...
        return (SubLObject)sbhl_time_search.NIL;
    }
    ...
    public static SubLObject remove_precedence_link(final SubLObject inferior, final SubLObject mt, final SubLObject val, final SubLObject superior) {
        ...
        if (val.eql((SubLObject)sbhl_time_search.$kw0$WEAK)) {
            ...
            try {
                sbhl_module_vars.$sbhl_module$.bind(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), thread);
                sbhl_link_methods.remove_sbhl_link(inferior, superior, mt, sbhl_time_search.$const2$MonotonicallyTrue);
            }
            finally {
                sbhl_module_vars.$sbhl_module$.rebind(_prev_bind_0, thread);
            }
    ...
    public static SubLObject weakly_precedesP(final SubLObject before, final SubLObject after, SubLObject mt) {
        if (mt == sbhl_time_search.UNPROVIDED) {
            mt = (SubLObject)sbhl_time_search.NIL;
        }
        if (before.eql(after)) {
            return (SubLObject)sbhl_time_search.T;
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before) && sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.ZERO_INTEGER);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.ZERO_INTEGER);
        }
        return precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.ZERO_INTEGER);
    }
    ...
    public static SubLObject strictly_precedesP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER);
        }
        return precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER);
    }
    ...
    public static SubLObject weakly_precedes_successorP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.ONE_INTEGER);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.ONE_INTEGER);
        }
        return precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.ONE_INTEGER);
    }
    ...
    public static SubLObject successor_strictly_precedesP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.$int9$_2);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.$int9$_2);
        }
        return precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.$int9$_2);
    }
    ...
    public static SubLObject weakly_precedes_successors_successorP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.TWO_INTEGER);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.TWO_INTEGER);
        }
        return precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.TWO_INTEGER);
    }
    ...
    public static SubLObject weakly_precedes_successors_successors_successorP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.THREE_INTEGER);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.THREE_INTEGER);
        }
        return precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.THREE_INTEGER);
    }
    ...
    public static SubLObject successors_successor_strictly_precedesP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.$int10$_3);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.$int10$_3);
        }
        return precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.$int10$_3);
    }
    ...
    public static SubLObject coordinateP(final SubLObject node1, final SubLObject node2, SubLObject mt) {
        ...
        return (SubLObject)SubLObjectFactory.makeBoolean(sbhl_time_search.NIL != weakly_precedesP(node1, node2, mt) && sbhl_time_search.NIL != weakly_precedesP(node2, node1, mt));
    }
    ...
    public static SubLObject successorP(final SubLObject node, final SubLObject successor, SubLObject mt) {
        ...
        return (SubLObject)SubLObjectFactory.makeBoolean(sbhl_time_search.NIL != strictly_precedesP(node, successor, mt) && sbhl_time_search.NIL != weakly_precedes_successorP(successor, node, mt));
    }
    ...
    public static SubLObject successors_successorP(final SubLObject node, final SubLObject successors_successor, SubLObject mt) {
        ...
        return (SubLObject)SubLObjectFactory.makeBoolean(sbhl_time_search.NIL != successor_strictly_precedesP(node, successors_successor, mt) && sbhl_time_search.NIL != weakly_precedes_successors_successorP(successors_successor, node, mt));
    }
    ...
    public static SubLObject precedesP_date_before(final SubLObject before, final SubLObject after, final SubLObject mt, final SubLObject depth) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLObject successP = (SubLObject)sbhl_time_search.NIL;
        ...
        try {
            sbhl_search_vars.$sbhl_search_module$.bind(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), thread);
            sbhl_search_vars.$sbhl_search_module_type$.bind(sbhl_module_utilities.get_sbhl_module_type(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence)), thread);
            sbhl_search_vars.$sbhl_add_node_to_result_test$.bind(sbhl_module_utilities.get_sbhl_add_node_to_result_test(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence)), thread);
            sbhl_search_vars.$genl_inverse_mode_p$.bind((SubLObject)sbhl_time_search.NIL, thread);
            sbhl_module_vars.$sbhl_module$.bind(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), thread);
            ...
            try {
                ...
                final SubLObject tv_var = (SubLObject)sbhl_time_search.NIL;
                ...
                try {
                    sbhl_search_vars.$sbhl_tv$.bind((sbhl_time_search.NIL != tv_var) ? tv_var : sbhl_search_vars.get_sbhl_true_tv(), thread);
                    sbhl_search_vars.$relevant_sbhl_tv_function$.bind((SubLObject)((sbhl_time_search.NIL != tv_var) ? sbhl_time_search.$sym11$RELEVANT_SBHL_TV_IS_GENERAL_TV : sbhl_search_vars.$relevant_sbhl_tv_function$.getDynamicValue(thread)), thread);
                    if (sbhl_time_search.NIL != tv_var && sbhl_time_search.NIL != sbhl_paranoia.sbhl_object_type_checking_p() && sbhl_time_search.NIL == sbhl_search_vars.sbhl_true_tv_p(tv_var)) {
                        final SubLObject pcase_var = sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue(thread);
                        if (pcase_var.eql((SubLObject)sbhl_time_search.$kw12$ERROR)) {
                            sbhl_paranoia.sbhl_error((SubLObject)sbhl_time_search.ONE_INTEGER, (SubLObject)sbhl_time_search.$str13$_A_is_not_a__A, tv_var, (SubLObject)sbhl_time_search.$sym14$SBHL_TRUE_TV_P, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
                        }
                        else if (pcase_var.eql((SubLObject)sbhl_time_search.$kw15$CERROR)) {
                            sbhl_paranoia.sbhl_cerror((SubLObject)sbhl_time_search.ONE_INTEGER, (SubLObject)sbhl_time_search.$str16$continue_anyway, (SubLObject)sbhl_time_search.$str13$_A_is_not_a__A, tv_var, (SubLObject)sbhl_time_search.$sym14$SBHL_TRUE_TV_P, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
                        }
                        else if (pcase_var.eql((SubLObject)sbhl_time_search.$kw17$WARN)) {
                            Errors.warn((SubLObject)sbhl_time_search.$str13$_A_is_not_a__A, tv_var, (SubLObject)sbhl_time_search.$sym14$SBHL_TRUE_TV_P);
                        }
                        else {
                            Errors.warn((SubLObject)sbhl_time_search.$str18$_A_is_not_a_valid__sbhl_type_erro, sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue(thread));
                            Errors.cerror((SubLObject)sbhl_time_search.$str16$continue_anyway, (SubLObject)sbhl_time_search.$str13$_A_is_not_a__A, tv_var, (SubLObject)sbhl_time_search.$sym14$SBHL_TRUE_TV_P);
                        }
                    }
                    ...
                    try {
                        sbhl_search_vars.$sbhl_search_truth$.bind(sbhl_time_search.$const19$True_JustificationTruth, thread);
                        sbhl_search_vars.$sbhl_search_direction$.bind(sbhl_search_vars.get_sbhl_backward_search_direction(), thread);
                        sbhl_link_vars.$sbhl_link_direction$.bind(sbhl_module_utilities.get_sbhl_module_backward_direction(sbhl_module_vars.get_sbhl_module((SubLObject)sbhl_time_search.UNPROVIDED)), thread);
                        ...
                        try {
                            sbhl_marking_vars.$sbhl_space$.bind((source == sbhl_time_search.$kw20$OLD) ? sbhl_marking_vars.$sbhl_space$.getDynamicValue(thread) : sbhl_marking_vars.sbhl_get_new_space(source), thread);
                            final SubLObject _prev_bind_0_$5 = sbhl_marking_vars.$sbhl_gather_space$.currentBinding(thread);
                            try {
                                sbhl_marking_vars.$sbhl_gather_space$.bind((source == sbhl_time_search.$kw20$OLD) ? sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue(thread) : sbhl_marking_vars.sbhl_get_new_space(source), thread);
                                ...
                                try {
                                    sbhl_search_vars.$sbhl_finishedP$.bind((SubLObject)sbhl_time_search.NIL, thread);
                                    sbhl_search_vars.$sbhl_stop_search_pathP$.bind((SubLObject)sbhl_time_search.NIL, thread);
                                    sbhl_search_vars.$sbhl_search_parent_marking$.bind((SubLObject)sbhl_time_search.NIL, thread);
                                    sbhl_search_vars.$sbhl_nodes_previous_marking$.bind((SubLObject)sbhl_time_search.NIL, thread);
                                    sbhl_search_vars.$genl_inverse_mode_p$.bind((SubLObject)sbhl_time_search.NIL, thread);
                                    final SubLObject rw_lock_var = sbhl_link_vars.$sbhl_rw_lock$.getGlobalValue();
                                    SubLObject needs_to_releaseP = (SubLObject)sbhl_time_search.NIL;
                                    try {
                                        needs_to_releaseP = ReadWriteLocks.rw_lock_seize_read_lock(rw_lock_var);
                                        successP = precedesP_node_date(after, sbhl_time_utilities.hl_interval_of_endpoint(before), mt, depth);
                                    }
                                    finally {
                                        if (sbhl_time_search.NIL != needs_to_releaseP) {
                                ...
                                if (source == sbhl_time_search.$kw21$RESOURCE) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        sbhl_link_vars.$sbhl_link_direction$.bind(sbhl_module_utilities.get_sbhl_module_forward_direction(sbhl_module_vars.get_sbhl_module((SubLObject)sbhl_time_search.UNPROVIDED)), thread);
                        final SubLObject source = sbhl_marking_vars.sbhl_new_space_source();
    ...
    public static SubLObject precedesP_node_date(final SubLObject node, final SubLObject date, final SubLObject mt, final SubLObject depth) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLObject successP = (SubLObject)sbhl_time_search.NIL;
        SubLObject doneP = (SubLObject)sbhl_time_search.NIL;
        if (sbhl_time_search.NIL == doneP) {
            SubLObject csome_list_var;
            SubLObject search_depth;
            SubLObject search_node;
            SubLObject search_date;
            SubLObject search_tag;
            for (csome_list_var = sbhl_time_search.$sbhl_time_precedes_depths$.getGlobalValue(), search_depth = (SubLObject)sbhl_time_search.NIL, search_depth = csome_list_var.first(); sbhl_time_search.NIL == doneP && sbhl_time_search.NIL != csome_list_var; doneP = (SubLObject)SubLObjectFactory.makeBoolean(sbhl_time_search.NIL != successP || search_depth.eql(depth)), csome_list_var = csome_list_var.rest(), search_depth = csome_list_var.first()) {
    ...
    public static SubLObject precedesP_node_node(final SubLObject before, final SubLObject after, final SubLObject mt, final SubLObject depth) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLObject successP = (SubLObject)sbhl_time_search.NIL;
        assert sbhl_time_search.NIL != Types.integerp(depth) : depth;
        ...
        try {
            ...
            successP = sbhl_search_methods.sbhl_predicate_relation_p(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), before, after, mt, (SubLObject)sbhl_time_search.UNPROVIDED);
        }
        finally {
            sbhl_time_vars.$sbhl_temporality_succession_depth$.rebind(_prev_bind_0, thread);
        }
        if (sbhl_time_search.NIL == successP) {
            _prev_bind_0 = sbhl_module_vars.$sbhl_module$.currentBinding(thread);
            try {
                sbhl_module_vars.$sbhl_module$.bind(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), thread);
                SubLObject before_doneP = (SubLObject)sbhl_time_search.NIL;
                if (sbhl_time_search.NIL == before_doneP) {
                    SubLObject csome_list_var;
                    ...
                    for (csome_list_var = sbhl_time_search.$sbhl_time_precedes_depths$.getGlobalValue(), before_depth = (SubLObject)sbhl_time_search.NIL, before_depth = csome_list_var.first(); sbhl_time_search.NIL == before_doneP && sbhl_time_search.NIL != csome_list_var; before_doneP = (SubLObject)SubLObjectFactory.makeBoolean(sbhl_time_search.NIL != successP || before_depth.eql(depth)), csome_list_var = csome_list_var.rest(), before_depth = csome_list_var.first()) {
                        before_node = (SubLObject)sbhl_time_search.NIL;
                        before_date = (SubLObject)sbhl_time_search.NIL;
                        before_tag = (SubLObject)sbhl_time_search.NIL;
                        ...
                        if (sbhl_time_search.NIL != before_date) {
                            after_doneP = (SubLObject)sbhl_time_search.NIL;
                            if (sbhl_time_search.NIL == after_doneP) {
                                for (csome_list_var_$35 = sbhl_time_search.$sbhl_time_precedes_depths$.getGlobalValue(), after_depth = (SubLObject)sbhl_time_search.NIL, after_depth = csome_list_var_$35.first(); sbhl_time_search.NIL == after_doneP && sbhl_time_search.NIL != csome_list_var_$35; after_doneP = (SubLObject)SubLObjectFactory.makeBoolean(sbhl_time_search.NIL != successP || after_depth.eql(depth)), csome_list_var_$35 = csome_list_var_$35.rest(), after_depth = csome_list_var_$35.first()) {
                                    after_node = (SubLObject)sbhl_time_search.NIL;
                                    after_date = (SubLObject)sbhl_time_search.NIL;
                                    after_tag = (SubLObject)sbhl_time_search.NIL;
    ...
    public static SubLObject all_weakly_precedes(final SubLObject before, SubLObject mt) {
        ...
        return (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) ? all_forward_precedes_date(before, mt, (SubLObject)sbhl_time_search.ZERO_INTEGER) : all_forward_precedes_node(before, mt, (SubLObject)sbhl_time_search.ZERO_INTEGER);
    }
    ...
    public static SubLObject all_weakly_precedes_inverse(final SubLObject after, SubLObject mt) {
        ...
        return (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) ? all_backward_precedes_date(after, mt, (SubLObject)sbhl_time_search.ZERO_INTEGER) : all_backward_precedes_node(after, mt, (SubLObject)sbhl_time_search.ZERO_INTEGER);
    }
    ...
    public static SubLObject all_strictly_precedes(final SubLObject before, SubLObject mt) {
        ...
        return (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) ? all_forward_precedes_date(before, mt, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER) : all_forward_precedes_node(before, mt, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER);
    }
    ...
    public static SubLObject all_strictly_precedes_inverse(final SubLObject after, SubLObject mt) {
        ...
        return (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) ? all_backward_precedes_date(after, mt, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER) : all_backward_precedes_node(after, mt, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER);
    }
    ...
    public static SubLObject all_weakly_precedes_successor(final SubLObject before, SubLObject mt) {
        ...
        return (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) ? all_forward_precedes_date(before, mt, (SubLObject)sbhl_time_search.ONE_INTEGER) : all_forward_precedes_node(before, mt, (SubLObject)sbhl_time_search.ONE_INTEGER);
    }
    ...
    public static SubLObject all_weakly_precedes_successor_inverse(final SubLObject after, SubLObject mt) {
        ...
        return (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) ? all_backward_precedes_date(after, mt, (SubLObject)sbhl_time_search.ONE_INTEGER) : all_backward_precedes_node(after, mt, (SubLObject)sbhl_time_search.ONE_INTEGER);
    }
    ...
    public static SubLObject all_successor_strictly_precedes(final SubLObject before, SubLObject mt) {
        ...
        return (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) ? all_forward_precedes_date(before, mt, (SubLObject)sbhl_time_search.$int9$_2) : all_forward_precedes_node(before, mt, (SubLObject)sbhl_time_search.$int9$_2);
    }
    ...
    public static SubLObject all_successor_strictly_precedes_inverse(final SubLObject after, SubLObject mt) {
        ...
        return (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) ? all_backward_precedes_date(after, mt, (SubLObject)sbhl_time_search.$int9$_2) : all_backward_precedes_node(after, mt, (SubLObject)sbhl_time_search.$int9$_2);
    }
    ...
    public static SubLObject all_weakly_precedes_successors_successor(final SubLObject before, SubLObject mt) {
        ...
        return (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) ? all_forward_precedes_date(before, mt, (SubLObject)sbhl_time_search.TWO_INTEGER) : all_forward_precedes_node(before, mt, (SubLObject)sbhl_time_search.TWO_INTEGER);
    }
    ...
    public static SubLObject all_weakly_precedes_successors_successor_inverse(final SubLObject after, SubLObject mt) {
        ...
        return (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) ? all_backward_precedes_date(after, mt, (SubLObject)sbhl_time_search.TWO_INTEGER) : all_backward_precedes_node(after, mt, (SubLObject)sbhl_time_search.TWO_INTEGER);
    }
    ...
    public static SubLObject all_forward_precedes_date(final SubLObject before, final SubLObject mt, final SubLObject depth) {
        ...
        SubLObject results = (SubLObject)sbhl_time_search.NIL;
        final SubLObject _prev_bind_0 = sbhl_search_vars.$sbhl_search_module$.currentBinding(thread);
        final SubLObject _prev_bind_2 = sbhl_search_vars.$sbhl_search_module_type$.currentBinding(thread);
        final SubLObject _prev_bind_3 = sbhl_search_vars.$sbhl_add_node_to_result_test$.currentBinding(thread);
        final SubLObject _prev_bind_4 = sbhl_search_vars.$genl_inverse_mode_p$.currentBinding(thread);
    ...
    public static SubLObject all_precedes_date(final SubLObject date, final SubLObject depth) {
        ...
        try {
            ...
            sbhl_search_vars.$sbhl_consider_node_fn$.bind((SubLObject)sbhl_time_search.$sym24$SBHL_PUSH_ONTO_RESULT, thread);
            SubLObject date2 = (SubLObject)sbhl_time_search.NIL;
            SubLObject date3 = (SubLObject)sbhl_time_search.NIL;
            if (sbhl_time_search.NIL != sbhl_link_vars.sbhl_forward_directed_direction_p(sbhl_link_vars.get_sbhl_link_direction())) {
                date2 = date;
                date3 = (SubLObject)sbhl_time_search.NIL;
            }
            else {
                date2 = (SubLObject)sbhl_time_search.NIL;
                date3 = date;
            }
            ...
            for (SubLObject done_var = (SubLObject)sbhl_time_search.NIL; sbhl_time_search.NIL == done_var; done_var = Types.sublisp_null(raw_links)) {
                raw_links = sbhl_iteration.sbhl_iteration_next(iterator);
                if (sbhl_time_search.NIL != raw_links) {
                    SubLObject current;
                    final SubLObject datum = current = raw_links;
                    SubLObject link0 = (SubLObject)sbhl_time_search.NIL;
                    SubLObject link2 = (SubLObject)sbhl_time_search.NIL;
                    cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)sbhl_time_search.$list25);
                    link0 = current.first();
                    current = current.rest();
                    cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)sbhl_time_search.$list25);
                    link2 = current.first();
                    current = current.rest();
                    if (sbhl_time_search.NIL == current) {
                        SubLObject current_$101;
                        final SubLObject datum_$100 = current_$101 = link0;
                        SubLObject date_tag = (SubLObject)sbhl_time_search.NIL;
                        SubLObject date_mt = (SubLObject)sbhl_time_search.NIL;
                        SubLObject link_date = (SubLObject)sbhl_time_search.NIL;
                        cdestructuring_bind.destructuring_bind_must_consp(current_$101, datum_$100, (SubLObject)sbhl_time_search.$list26);
                        ...
                        current_$101 = current_$101.rest();
                        final SubLObject link_supports = (SubLObject)(current_$101.isCons() ? current_$101.first() : sbhl_time_search.NIL);
                        cdestructuring_bind.destructuring_bind_must_listp(current_$101, datum_$100, (SubLObject)sbhl_time_search.$list26);
                        current_$101 = current_$101.rest();
                        if (sbhl_time_search.NIL == current_$101) {
                            SubLObject current_$102;
                            final SubLObject datum_$101 = current_$102 = link2;
                            SubLObject node_tag = (SubLObject)sbhl_time_search.NIL;
                            SubLObject node_mt = (SubLObject)sbhl_time_search.NIL;
                            SubLObject node = (SubLObject)sbhl_time_search.NIL;
                            cdestructuring_bind.destructuring_bind_must_consp(current_$102, datum_$101, (SubLObject)sbhl_time_search.$list27);
                            ...
                            current_$102 = current_$102.rest();
                            final SubLObject link_supports_$104 = (SubLObject)(current_$102.isCons() ? current_$102.first() : sbhl_time_search.NIL);
                            cdestructuring_bind.destructuring_bind_must_listp(current_$102, datum_$101, (SubLObject)sbhl_time_search.$list27);
                            current_$102 = current_$102.rest();
                            if (sbhl_time_search.NIL == current_$102) {
                                final SubLObject succession_depth = (sbhl_time_search.NIL != sbhl_time_dates.sbhl_dateE(date, link_date)) ? Numbers.add(depth, sbhl_marking_utilities.sbhl_temporal_tag_increment(node_tag)) : sbhl_time_vars.sbhl_temporality_date_succession();
                                assert sbhl_time_search.NIL != Types.integerp(succession_depth) : succession_depth;
                                ...
                                cdestructuring_bind.cdestructuring_bind_error(datum_$101, (SubLObject)sbhl_time_search.$list27);
                            }
                        }
                        else {
                            cdestructuring_bind.cdestructuring_bind_error(datum_$100, (SubLObject)sbhl_time_search.$list26);
                        }
                    }
                    else {
                        cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)sbhl_time_search.$list25);
                    }
                }
            }
        }
    ...
    public static SubLObject all_precedes_node(final SubLObject node, final SubLObject depth) {
        ...
        try {
            ...
            thread.resetMultipleValues();
            final SubLObject initial_node = sbhl_time_dates.sbhl_time_date_find_search_node(node, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
            final SubLObject initial_date = thread.secondMultipleValue();
            final SubLObject initial_tag = thread.thirdMultipleValue();
            thread.resetMultipleValues();
            if (sbhl_time_search.NIL != initial_node) {
                final SubLObject iterator = sbhl_time_dates.new_sbhl_time_date_link_iterator(initial_node, sbhl_link_vars.get_sbhl_link_direction(), (SubLObject)sbhl_time_search.NIL, (SubLObject)sbhl_time_search.NIL);
                SubLObject raw_links;
                for (SubLObject done_var = (SubLObject)sbhl_time_search.NIL; sbhl_time_search.NIL == done_var; done_var = Types.sublisp_null(raw_links)) {
                    raw_links = sbhl_iteration.sbhl_iteration_next(iterator);
                    if (sbhl_time_search.NIL != raw_links) {
                        ...
                        SubLObject link0 = (SubLObject)sbhl_time_search.NIL;
                        SubLObject link2 = (SubLObject)sbhl_time_search.NIL;
                        SubLObject link3 = (SubLObject)sbhl_time_search.NIL;
                        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)sbhl_time_search.$list28);
                        link0 = current.first();
                        current = current.rest();
                        cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)sbhl_time_search.$list28);
                        link2 = current.first();
                        ...
                        if (sbhl_time_search.NIL == current) {
                            ...
                            SubLObject date_tag = (SubLObject)sbhl_time_search.NIL;
                            SubLObject date_mt = (SubLObject)sbhl_time_search.NIL;
                            SubLObject date_date = (SubLObject)sbhl_time_search.NIL;
                            cdestructuring_bind.destructuring_bind_must_consp(current_$109, datum_$108, (SubLObject)sbhl_time_search.$list29);
                            ...
                            current_$109 = current_$109.rest();
                            final SubLObject link_supports = (SubLObject)(current_$109.isCons() ? current_$109.first() : sbhl_time_search.NIL);
                            cdestructuring_bind.destructuring_bind_must_listp(current_$109, datum_$108, (SubLObject)sbhl_time_search.$list29);
                            current_$109 = current_$109.rest();
                            if (sbhl_time_search.NIL == current_$109) {
                                SubLObject current_$110;
                                final SubLObject datum_$109 = current_$110 = link2;
                                SubLObject int_tag = (SubLObject)sbhl_time_search.NIL;
                                SubLObject int_mt = (SubLObject)sbhl_time_search.NIL;
                                SubLObject int_date = (SubLObject)sbhl_time_search.NIL;
                                cdestructuring_bind.destructuring_bind_must_consp(current_$110, datum_$109, (SubLObject)sbhl_time_search.$list30);
                                ...
                                current_$110 = current_$110.rest();
                                final SubLObject link_supports_$112 = (SubLObject)(current_$110.isCons() ? current_$110.first() : sbhl_time_search.NIL);
                                cdestructuring_bind.destructuring_bind_must_listp(current_$110, datum_$109, (SubLObject)sbhl_time_search.$list30);
                                current_$110 = current_$110.rest();
                                if (sbhl_time_search.NIL == current_$110) {
                                    SubLObject current_$111;
                                    final SubLObject datum_$110 = current_$111 = link3;
                                    SubLObject link_tag = (SubLObject)sbhl_time_search.NIL;
                                    SubLObject link_mt = (SubLObject)sbhl_time_search.NIL;
                                    SubLObject link_node = (SubLObject)sbhl_time_search.NIL;
                                    cdestructuring_bind.destructuring_bind_must_consp(current_$111, datum_$110, (SubLObject)sbhl_time_search.$list31);
                                    ...
                                    current_$111 = current_$111.rest();
                                    final SubLObject link_supports_$113 = (SubLObject)(current_$111.isCons() ? current_$111.first() : sbhl_time_search.NIL);
                                    cdestructuring_bind.destructuring_bind_must_listp(current_$111, datum_$110, (SubLObject)sbhl_time_search.$list31);
                                    current_$111 = current_$111.rest();
                                    if (sbhl_time_search.NIL == current_$111) {
                                        final SubLObject succession_depth = (sbhl_time_search.NIL != sbhl_time_dates.sbhl_dateE(date_date, int_date)) ? Numbers.add(depth, sbhl_marking_utilities.sbhl_temporal_tag_increment(date_tag), sbhl_marking_utilities.sbhl_temporal_tag_increment(link_tag)) : sbhl_time_vars.sbhl_temporality_date_succession();
                                        assert sbhl_time_search.NIL != Types.integerp(succession_depth) : succession_depth;
                                        ...
                                        cdestructuring_bind.cdestructuring_bind_error(datum_$110, (SubLObject)sbhl_time_search.$list31);
                                    }
                                }
                                else {
                                    cdestructuring_bind.cdestructuring_bind_error(datum_$109, (SubLObject)sbhl_time_search.$list30);
                                }
                            }
                            else {
                                cdestructuring_bind.cdestructuring_bind_error(datum_$108, (SubLObject)sbhl_time_search.$list29);
                            }
                        }
                        else {
                            cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)sbhl_time_search.$list28);
                        }
                    }
                }
            }
    ...
    public static SubLObject all_coordinate(final SubLObject node, SubLObject mt) {
        ...
        return sbhl_temporality_all_forward_nodes_between(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), (SubLObject)sbhl_time_search.ZERO_INTEGER, node, node, mt, (SubLObject)sbhl_time_search.UNPROVIDED);
    }
    ...
    public static SubLObject all_successors(final SubLObject node, SubLObject mt) {
        ...
        return sbhl_temporality_all_forward_nodes_between(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER, node, node, mt, (SubLObject)sbhl_time_search.UNPROVIDED);
    }
    ...
    public static SubLObject all_predecessors(final SubLObject node, SubLObject mt) {
        ...
        return sbhl_temporality_all_backward_nodes_between(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER, node, node, mt, (SubLObject)sbhl_time_search.UNPROVIDED);
    }
    ...
    public static SubLObject all_successors_successors(final SubLObject node, SubLObject mt) {
        ...
        return sbhl_temporality_all_forward_nodes_between(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), (SubLObject)sbhl_time_search.$int9$_2, node, node, mt, (SubLObject)sbhl_time_search.UNPROVIDED);
    }
    ...
    public static SubLObject all_predecessors_predecessors(final SubLObject node, SubLObject mt) {
        ...
        return sbhl_temporality_all_backward_nodes_between(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), (SubLObject)sbhl_time_search.$int9$_2, node, node, mt, (SubLObject)sbhl_time_search.UNPROVIDED);
    }
    ...
    public static SubLObject all_between(final SubLObject marking_depth, final SubLObject searching_depth, final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        return sbhl_temporality_all_forward_nodes_between(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), marking_depth, before, after, mt, searching_depth);
    }
    ...
    public static SubLObject sbhl_temporality_all_forward_nodes_between(final SubLObject module, final SubLObject depth, final SubLObject node1, final SubLObject node2, SubLObject mt, SubLObject search_depth) {
        ...
        if (search_depth == sbhl_time_search.UNPROVIDED) {
            search_depth = (SubLObject)sbhl_time_search.NIL;
        }
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert sbhl_time_search.NIL != sbhl_module_vars.sbhl_module_p(module) : module;
        SubLObject result = (SubLObject)sbhl_time_search.NIL;
        final SubLObject _prev_bind_0 = sbhl_search_vars.$sbhl_search_module$.currentBinding(thread);
        final SubLObject _prev_bind_2 = sbhl_search_vars.$sbhl_search_module_type$.currentBinding(thread);
        final SubLObject _prev_bind_3 = sbhl_search_vars.$sbhl_add_node_to_result_test$.currentBinding(thread);
        final SubLObject _prev_bind_4 = sbhl_search_vars.$genl_inverse_mode_p$.currentBinding(thread);
    ...
    public static SubLObject sbhl_temporality_all_nodes_accessed_between(final SubLObject depth, final SubLObject node1, final SubLObject node2, SubLObject search_depth) {
        ...
        if (sbhl_time_search.NIL == search_depth) {
            search_depth = Numbers.minus(depth);
        }
        final SubLObject node1_date = (SubLObject)((sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(node1)) ? sbhl_time_utilities.hl_interval_of_endpoint(node1) : sbhl_time_search.NIL);
        final SubLObject node2_date = (SubLObject)((sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(node2)) ? sbhl_time_utilities.hl_interval_of_endpoint(node2) : sbhl_time_search.NIL);
        if (sbhl_time_search.NIL != node1_date && sbhl_time_search.NIL != node2_date) {
            return sbhl_temporality_all_nodes_accessed_between_dates(depth, node1_date, node2_date, search_depth);
        }
        if (sbhl_time_search.NIL != node1_date) {
            return sbhl_temporality_all_nodes_accessed_between_date_node(depth, node1_date, node2, search_depth);
        }
        if (sbhl_time_search.NIL != node2_date) {
    ...
    public static SubLObject sbhl_temporality_all_nodes_accessed_between_dates(final SubLObject depth, final SubLObject date1, final SubLObject date2, final SubLObject search_depth) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Threads.$is_thread_performing_cleanupP$.bind((SubLObject)sbhl_time_search.T, thread);
    ...
    public static SubLObject sbhl_temporality_all_nodes_accessed_between_dates_int(final SubLObject depth, final SubLObject date1, final SubLObject date2, final SubLObject search_depth) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLObject results = (SubLObject)sbhl_time_search.NIL;
        if ((sbhl_time_search.NIL != sbhl_link_vars.sbhl_forward_directed_direction_p(sbhl_link_vars.get_sbhl_link_direction()) && sbhl_time_search.NIL != sbhl_time_dates.sbhl_dateLE(date1, date2)) || (sbhl_time_search.NIL != sbhl_link_vars.sbhl_backward_directed_direction_p(sbhl_link_vars.get_sbhl_link_direction()) && sbhl_time_search.NIL != sbhl_time_dates.sbhl_dateGE(date1, date2))) {
            thread.resetMultipleValues();
            final SubLObject earlier = (sbhl_time_search.NIL != sbhl_time_dates.sbhl_dateLE(date1, date2)) ? Values.values(date1, date2) : Values.values(date2, date1);
            ...
            for (SubLObject done_var = (SubLObject)sbhl_time_search.NIL; sbhl_time_search.NIL == done_var; done_var = Types.sublisp_null(raw_links)) {
                ...
                if (sbhl_time_search.NIL != raw_links) {
                    ...
                    if (sbhl_time_search.NIL == current) {
                        ...
                        SubLObject date_mt = (SubLObject)sbhl_time_search.NIL;
                        SubLObject date3 = (SubLObject)sbhl_time_search.NIL;
                        cdestructuring_bind.destructuring_bind_must_consp(current_$151, datum_$150, (SubLObject)sbhl_time_search.$list33);
                        ...
                        current_$151 = current_$151.rest();
                        final SubLObject link_supports = (SubLObject)(current_$151.isCons() ? current_$151.first() : sbhl_time_search.NIL);
                        cdestructuring_bind.destructuring_bind_must_listp(current_$151, datum_$150, (SubLObject)sbhl_time_search.$list33);
                        current_$151 = current_$151.rest();
                        if (sbhl_time_search.NIL == current_$151) {
                            SubLObject current_$152;
                            final SubLObject datum_$151 = current_$152 = link2;
                            SubLObject node_tag = (SubLObject)sbhl_time_search.NIL;
                            SubLObject node_mt = (SubLObject)sbhl_time_search.NIL;
                            SubLObject node = (SubLObject)sbhl_time_search.NIL;
                            cdestructuring_bind.destructuring_bind_must_consp(current_$152, datum_$151, (SubLObject)sbhl_time_search.$list27);
                            ...
                            current_$152 = current_$152.rest();
                            final SubLObject link_supports_$154 = (SubLObject)(current_$152.isCons() ? current_$152.first() : sbhl_time_search.NIL);
                            cdestructuring_bind.destructuring_bind_must_listp(current_$152, datum_$151, (SubLObject)sbhl_time_search.$list27);
                            current_$152 = current_$152.rest();
                            if (sbhl_time_search.NIL == current_$152) {
                                final SubLObject succession_depth = (sbhl_time_search.NIL != sbhl_time_dates.sbhl_date_betweenP(date3, earlier, later, (SubLObject)sbhl_time_search.T)) ? sbhl_time_vars.sbhl_temporality_date_succession() : Numbers.add(depth, sbhl_marking_utilities.sbhl_temporal_tag_increment(node_tag));
                                assert sbhl_time_search.NIL != Types.integerp(succession_depth) : succession_depth;
                                ...
                                cdestructuring_bind.cdestructuring_bind_error(datum_$151, (SubLObject)sbhl_time_search.$list27);
                            }
                        }
                        else {
                            cdestructuring_bind.cdestructuring_bind_error(datum_$150, (SubLObject)sbhl_time_search.$list33);
                        }
                    }
                    else {
                        cdestructuring_bind.cdestructuring_bind_error(datum, (SubLObject)sbhl_time_search.$list25);
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                sbhl_marking_vars.$sbhl_temporality_search_checks_nodes_in_target_space_p$.bind((SubLObject)sbhl_time_search.T, thread);
                                sbhl_search_vars.$sbhl_consider_node_fn$.bind((SubLObject)sbhl_time_search.$sym24$SBHL_PUSH_ONTO_RESULT, thread);
                                ...
                                for (SubLObject done_var2 = (SubLObject)sbhl_time_search.NIL; sbhl_time_search.NIL == done_var2; done_var2 = Types.sublisp_null(raw_links2)) {
                                    raw_links2 = sbhl_iteration.sbhl_iteration_next(iterator2);
                                    if (sbhl_time_search.NIL != raw_links2) {
                                        SubLObject current2;
                                        final SubLObject datum2 = current2 = raw_links2;
                                        SubLObject link3 = (SubLObject)sbhl_time_search.NIL;
                                        SubLObject link4 = (SubLObject)sbhl_time_search.NIL;
                                        cdestructuring_bind.destructuring_bind_must_consp(current2, datum2, (SubLObject)sbhl_time_search.$list25);
                                        link3 = current2.first();
                                        current2 = current2.rest();
                                        cdestructuring_bind.destructuring_bind_must_consp(current2, datum2, (SubLObject)sbhl_time_search.$list25);
                                        link4 = current2.first();
                                        current2 = current2.rest();
                                        if (sbhl_time_search.NIL == current2) {
                                            SubLObject current_$153;
                                            final SubLObject datum_$152 = current_$153 = link3;
                                            SubLObject date_tag2 = (SubLObject)sbhl_time_search.NIL;
                                            SubLObject date_mt2 = (SubLObject)sbhl_time_search.NIL;
                                            SubLObject date4 = (SubLObject)sbhl_time_search.NIL;
                                            cdestructuring_bind.destructuring_bind_must_consp(current_$153, datum_$152, (SubLObject)sbhl_time_search.$list33);
                                            ...
                                            current_$153 = current_$153.rest();
                                            final SubLObject link_supports2 = (SubLObject)(current_$153.isCons() ? current_$153.first() : sbhl_time_search.NIL);
                                            cdestructuring_bind.destructuring_bind_must_listp(current_$153, datum_$152, (SubLObject)sbhl_time_search.$list33);
                                            current_$153 = current_$153.rest();
                                            if (sbhl_time_search.NIL == current_$153) {
                                                SubLObject current_$154;
                                                final SubLObject datum_$153 = current_$154 = link4;
                                                SubLObject node_tag2 = (SubLObject)sbhl_time_search.NIL;
                                                SubLObject node_mt2 = (SubLObject)sbhl_time_search.NIL;
                                                SubLObject node2 = (SubLObject)sbhl_time_search.NIL;
                                                cdestructuring_bind.destructuring_bind_must_consp(current_$154, datum_$153, (SubLObject)sbhl_time_search.$list27);
                                                ...
                                                current_$154 = current_$154.rest();
                                                final SubLObject link_supports_$155 = (SubLObject)(current_$154.isCons() ? current_$154.first() : sbhl_time_search.NIL);
                                                cdestructuring_bind.destructuring_bind_must_listp(current_$154, datum_$153, (SubLObject)sbhl_time_search.$list27);
                                                current_$154 = current_$154.rest();
                                                if (sbhl_time_search.NIL == current_$154) {
                                                    final SubLObject succession_depth2 = (sbhl_time_search.NIL != sbhl_time_dates.sbhl_date_betweenP(date4, earlier, later, (SubLObject)sbhl_time_search.T)) ? sbhl_time_vars.sbhl_temporality_date_succession() : Numbers.add(search_depth, sbhl_marking_utilities.sbhl_temporal_tag_increment(node_tag2));
                                                    assert sbhl_time_search.NIL != Types.integerp(succession_depth2) : succession_depth2;
                                                    ...
                                                    cdestructuring_bind.cdestructuring_bind_error(datum_$153, (SubLObject)sbhl_time_search.$list27);
                                                }
                                            }
                                            else {
                                                cdestructuring_bind.cdestructuring_bind_error(datum_$152, (SubLObject)sbhl_time_search.$list33);
                                            }
                                        }
                                        else {
                                            cdestructuring_bind.cdestructuring_bind_error(datum2, (SubLObject)sbhl_time_search.$list25);
                                        }
                                    }
                                }
                            }
        ...
        return list_utilities.fast_delete_duplicates(results, Symbols.symbol_function((SubLObject)sbhl_time_search.EQUAL), (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    thread.resetMultipleValues();
                    final SubLObject search_node = sbhl_time_dates.sbhl_time_date_find_search_node(node, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    SubLObject node1_node = (SubLObject)sbhl_time_search.NIL;
                    SubLObject node1_date = (SubLObject)sbhl_time_search.NIL;
                    SubLObject node1_tag = (SubLObject)sbhl_time_search.NIL;
                    SubLObject node2_node = (SubLObject)sbhl_time_search.NIL;
                    SubLObject node2_date = (SubLObject)sbhl_time_search.NIL;
                    SubLObject node2_tag = (SubLObject)sbhl_time_search.NIL;
                    thread.resetMultipleValues();
                    final SubLObject node1_node_$173 = sbhl_time_dates.sbhl_time_date_find_search_node(node1, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
                    ...
                    try {
                        sbhl_link_vars.$sbhl_link_direction$.bind(sbhl_link_vars.get_sbhl_opposite_link_direction(), thread);
                        thread.resetMultipleValues();
                        final SubLObject node2_node_$177 = sbhl_time_dates.sbhl_time_date_find_search_node(node2, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        sbhl_search_vars.$sbhl_search_parent_marking$.bind((SubLObject)sbhl_time_search.NIL, thread);
                                        assert sbhl_time_search.NIL != Types.integerp(search_depth) : search_depth;
    ...
    public static SubLObject why_weakly_precedesP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return why_precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.ZERO_INTEGER);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return why_precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.ZERO_INTEGER);
        }
        return why_precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.ZERO_INTEGER);
    }
    ...
    public static SubLObject why_strictly_precedesP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return why_precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return why_precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER);
        }
        return why_precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER);
    }
    ...
    public static SubLObject why_weakly_precedes_successorP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return why_precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.ONE_INTEGER);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return why_precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.ONE_INTEGER);
        }
        return why_precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.ONE_INTEGER);
    }
    ...
    public static SubLObject why_successor_strictly_precedesP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return why_precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.$int9$_2);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return why_precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.$int9$_2);
        }
        return why_precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.$int9$_2);
    }
    ...
    public static SubLObject why_weakly_precedes_successors_successorP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return why_precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.TWO_INTEGER);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return why_precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.TWO_INTEGER);
        }
        return why_precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.TWO_INTEGER);
    }
    ...
    public static SubLObject why_weakly_precedes_successors_successors_successorP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return why_precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.THREE_INTEGER);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return why_precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.THREE_INTEGER);
        }
        return why_precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.THREE_INTEGER);
    }
    ...
    public static SubLObject why_successors_successor_strictly_precedesP(final SubLObject before, final SubLObject after, SubLObject mt) {
        ...
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(before)) {
            return why_precedesP_date_before(before, after, mt, (SubLObject)sbhl_time_search.$int10$_3);
        }
        if (sbhl_time_search.NIL != sbhl_time_utilities.hl_date_point_p(after)) {
            return why_precedesP_date_after(before, after, mt, (SubLObject)sbhl_time_search.$int10$_3);
        }
        return why_precedesP_node_node(before, after, mt, (SubLObject)sbhl_time_search.$int10$_3);
    }
    ...
    public static SubLObject why_coordinateP(final SubLObject node1, final SubLObject node2, SubLObject mt) {
        ...
        SubLObject just_first_half = (SubLObject)sbhl_time_search.NIL;
        SubLObject just_second_half = (SubLObject)sbhl_time_search.NIL;
        just_first_half = why_weakly_precedesP(node1, node2, mt);
        if (sbhl_time_search.NIL != just_first_half) {
            just_second_half = why_weakly_precedesP(node2, node1, mt);
        }
        return (SubLObject)((sbhl_time_search.NIL != just_first_half && sbhl_time_search.NIL != just_second_half) ? ConsesLow.append(just_first_half, just_second_half) : sbhl_time_search.NIL);
    }
    ...
    public static SubLObject why_precedesP_date_before(final SubLObject before, final SubLObject after, final SubLObject mt, final SubLObject depth) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLObject just = (SubLObject)sbhl_time_search.NIL;
        final SubLObject _prev_bind_0 = sbhl_search_vars.$sbhl_search_module$.currentBinding(thread);
        final SubLObject _prev_bind_2 = sbhl_search_vars.$sbhl_search_module_type$.currentBinding(thread);
        final SubLObject _prev_bind_3 = sbhl_search_vars.$sbhl_add_node_to_result_test$.currentBinding(thread);
        final SubLObject _prev_bind_4 = sbhl_search_vars.$genl_inverse_mode_p$.currentBinding(thread);
    ...
    public static SubLObject why_precedesP_node_date(final SubLObject node, final SubLObject date, final SubLObject mt, final SubLObject depth) {
        ...
        if (sbhl_time_search.NIL == doneP) {
            ...
            SubLObject supports;
            for (csome_list_var = sbhl_time_search.$sbhl_time_precedes_depths$.getGlobalValue(), search_depth = (SubLObject)sbhl_time_search.NIL, search_depth = csome_list_var.first(); sbhl_time_search.NIL == doneP && sbhl_time_search.NIL != csome_list_var; doneP = (SubLObject)SubLObjectFactory.makeBoolean(sbhl_time_search.NIL != just || search_depth.eql(depth)), csome_list_var = csome_list_var.rest(), search_depth = csome_list_var.first()) {
                thread.resetMultipleValues();
                search_node = sbhl_time_dates.sbhl_time_date_find_search_node(node, mt, search_depth);
                search_date = thread.secondMultipleValue();
                search_tag = thread.thirdMultipleValue();
                thread.resetMultipleValues();
                if (sbhl_time_search.NIL != search_node && sbhl_time_search.NIL != ((sbhl_time_search.NIL != sbhl_link_vars.sbhl_forward_directed_direction_p(sbhl_link_vars.get_sbhl_link_direction())) ? (Numbers.add(depth, Numbers.minus(search_depth), sbhl_marking_utilities.sbhl_temporal_tag_increment(search_tag)).isNegative() ? sbhl_time_dates.sbhl_dateL(search_date, date) : sbhl_time_dates.sbhl_dateLE(search_date, date)) : (Numbers.add(depth, Numbers.minus(search_depth), sbhl_marking_utilities.sbhl_temporal_tag_increment(search_tag)).isNegative() ? sbhl_time_dates.sbhl_dateG(search_date, date) : sbhl_time_dates.sbhl_dateGE(search_date, date)))) {
                    if (!node.eql(search_node)) {
                        ...
                        try {
                            sbhl_time_vars.$sbhl_temporality_justification_gathering_passed_through_dateP$.bind((SubLObject)sbhl_time_search.NIL, thread);
                            sbhl_time_vars.$sbhl_temporality_search_passed_through_dateP$.bind((SubLObject)sbhl_time_search.NIL, thread);
                            assert sbhl_time_search.NIL != Types.integerp(Numbers.subtract(depth, sbhl_marking_utilities.sbhl_temporal_tag_increment(search_tag))) : Numbers.subtract(depth, sbhl_marking_utilities.sbhl_temporal_tag_increment(search_tag));
                            ...
                            try {
                                ...
                                just = ((sbhl_time_search.NIL != sbhl_link_vars.sbhl_forward_directed_direction_p(sbhl_link_vars.get_sbhl_link_direction())) ? why_sbhl_time_predicate_relation_p(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), node, search_node, mt, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED) : why_sbhl_time_predicate_relation_p(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), search_node, node, mt, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED));
                            }
                            finally {
                    ...
                    if (sbhl_time_search.NIL != supports) {
                        just = ConsesLow.append(just, supports);
                    }
                }
            }
        }
        return list_utilities.fast_delete_duplicates(just, Symbols.symbol_function((SubLObject)sbhl_time_search.EQUAL), (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
    }
    ...
    public static SubLObject why_precedesP_node_node(final SubLObject before, final SubLObject after, final SubLObject mt, final SubLObject depth) {
        ...
        try {
            ...
            try {
                sbhl_time_vars.$sbhl_temporality_succession_depth$.bind(depth, thread);
                just = why_sbhl_time_predicate_relation_p(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), before, after, mt, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
            }
            finally {
        ...
        if (sbhl_time_search.NIL == just) {
            ...
            try {
                ...
                if (sbhl_time_search.NIL == before_doneP) {
                    ...
                    for (csome_list_var = sbhl_time_search.$sbhl_time_precedes_depths$.getGlobalValue(), before_depth = (SubLObject)sbhl_time_search.NIL, before_depth = csome_list_var.first(); sbhl_time_search.NIL == before_doneP && sbhl_time_search.NIL != csome_list_var; before_doneP = (SubLObject)SubLObjectFactory.makeBoolean(sbhl_time_search.NIL != just || before_depth.eql(depth)), csome_list_var = csome_list_var.rest(), before_depth = csome_list_var.first()) {
                        before_node = (SubLObject)sbhl_time_search.NIL;
                        before_date = (SubLObject)sbhl_time_search.NIL;
                        before_tag = (SubLObject)sbhl_time_search.NIL;
                        ...
                        if (sbhl_time_search.NIL != before_date) {
                            after_doneP = (SubLObject)sbhl_time_search.NIL;
                            if (sbhl_time_search.NIL == after_doneP) {
                                for (csome_list_var_$225 = sbhl_time_search.$sbhl_time_precedes_depths$.getGlobalValue(), after_depth = (SubLObject)sbhl_time_search.NIL, after_depth = csome_list_var_$225.first(); sbhl_time_search.NIL == after_doneP && sbhl_time_search.NIL != csome_list_var_$225; after_doneP = (SubLObject)SubLObjectFactory.makeBoolean(sbhl_time_search.NIL != just || after_depth.eql(depth)), csome_list_var_$225 = csome_list_var_$225.rest(), after_depth = csome_list_var_$225.first()) {
                                    after_node = (SubLObject)sbhl_time_search.NIL;
                                    after_date = (SubLObject)sbhl_time_search.NIL;
                                    after_tag = (SubLObject)sbhl_time_search.NIL;
                                    ...
                                    if (sbhl_time_search.NIL != after_date && sbhl_time_search.NIL != (Numbers.add(new SubLObject[] { depth, Numbers.minus(before_depth), Numbers.minus(after_depth), sbhl_marking_utilities.sbhl_temporal_tag_increment(before_tag), sbhl_marking_utilities.sbhl_temporal_tag_increment(after_tag) }).isNegative() ? sbhl_time_dates.sbhl_dateL(before_date, after_date) : sbhl_time_dates.sbhl_dateLE(before_date, after_date))) {
                                        if (!before.eql(before_node)) {
                                            ...
                                            try {
                                                sbhl_time_vars.$sbhl_temporality_justification_gathering_passed_through_dateP$.bind((SubLObject)sbhl_time_search.NIL, thread);
                                                sbhl_time_vars.$sbhl_temporality_search_passed_through_dateP$.bind((SubLObject)sbhl_time_search.NIL, thread);
                                                assert sbhl_time_search.NIL != Types.integerp(before_depth) : before_depth;
                                                ...
                                                try {
                                                    ...
                                                    just = why_sbhl_time_predicate_relation_p(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), before, before_node, mt, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
                                                }
                                                finally {
                                        ...
                                        if (!after_node.eql(after)) {
                                            ...
                                            try {
                                                sbhl_time_vars.$sbhl_temporality_justification_gathering_passed_through_dateP$.bind((SubLObject)sbhl_time_search.NIL, thread);
                                                sbhl_time_vars.$sbhl_temporality_search_passed_through_dateP$.bind((SubLObject)sbhl_time_search.NIL, thread);
                                                assert sbhl_time_search.NIL != Types.integerp(after_depth) : after_depth;
                                                ...
                                                try {
                                                    ...
                                                    just = ConsesLow.append(just, why_sbhl_time_predicate_relation_p(sbhl_module_vars.get_sbhl_module(sbhl_time_search.$const1$weak_HL_TimePrecedence), after_node, after, mt, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED));
                                                }
                                                finally {
    ...
    public static SubLObject why_sbhl_time_predicate_relation_p(final SubLObject module, final SubLObject node1, final SubLObject node2, SubLObject mt, SubLObject tv, SubLObject behavior) {
        ...
        if (tv == sbhl_time_search.UNPROVIDED) {
            tv = (SubLObject)sbhl_time_search.NIL;
        }
        if (behavior == sbhl_time_search.UNPROVIDED) {
            behavior = (SubLObject)sbhl_time_search.NIL;
        }
        return list_utilities.fast_delete_duplicates(Functions.apply(Symbols.symbol_function((SubLObject)sbhl_time_search.$sym34$APPEND), sbhl_search_methods.why_sbhl_predicate_relation_p(module, node1, node2, mt, tv, behavior)), Symbols.symbol_function((SubLObject)sbhl_time_search.EQUAL), (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED, (SubLObject)sbhl_time_search.UNPROVIDED);
    }
    
    public static SubLObject declare_sbhl_time_search_file() {
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "add_precedence_link", "ADD-PRECEDENCE-LINK", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "remove_precedence_link", "REMOVE-PRECEDENCE-LINK", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "weakly_precedesP", "WEAKLY-PRECEDES?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "strictly_precedesP", "STRICTLY-PRECEDES?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "weakly_precedes_successorP", "WEAKLY-PRECEDES-SUCCESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "successor_strictly_precedesP", "SUCCESSOR-STRICTLY-PRECEDES?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "weakly_precedes_successors_successorP", "WEAKLY-PRECEDES-SUCCESSORS-SUCCESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "weakly_precedes_successors_successors_successorP", "WEAKLY-PRECEDES-SUCCESSORS-SUCCESSORS-SUCCESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "successors_successor_strictly_precedesP", "SUCCESSORS-SUCCESSOR-STRICTLY-PRECEDES?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "coordinateP", "COORDINATE?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "successorP", "SUCCESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "predecessorP", "PREDECESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "successors_successorP", "SUCCESSORS-SUCCESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "precedesP_date_before", "PRECEDES?-DATE-BEFORE", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "precedesP_date_after", "PRECEDES?-DATE-AFTER", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "precedesP_node_date", "PRECEDES?-NODE-DATE", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "precedesP_node_node", "PRECEDES?-NODE-NODE", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_weakly_precedes", "ALL-WEAKLY-PRECEDES", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_weakly_precedes_inverse", "ALL-WEAKLY-PRECEDES-INVERSE", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_strictly_precedes", "ALL-STRICTLY-PRECEDES", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_strictly_precedes_inverse", "ALL-STRICTLY-PRECEDES-INVERSE", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_weakly_precedes_successor", "ALL-WEAKLY-PRECEDES-SUCCESSOR", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_weakly_precedes_successor_inverse", "ALL-WEAKLY-PRECEDES-SUCCESSOR-INVERSE", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_successor_strictly_precedes", "ALL-SUCCESSOR-STRICTLY-PRECEDES", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_successor_strictly_precedes_inverse", "ALL-SUCCESSOR-STRICTLY-PRECEDES-INVERSE", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_weakly_precedes_successors_successor", "ALL-WEAKLY-PRECEDES-SUCCESSORS-SUCCESSOR", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_weakly_precedes_successors_successor_inverse", "ALL-WEAKLY-PRECEDES-SUCCESSORS-SUCCESSOR-INVERSE", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_forward_precedes_date", "ALL-FORWARD-PRECEDES-DATE", 3, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_backward_precedes_date", "ALL-BACKWARD-PRECEDES-DATE", 3, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_forward_precedes_node", "ALL-FORWARD-PRECEDES-NODE", 3, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_backward_precedes_node", "ALL-BACKWARD-PRECEDES-NODE", 3, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_precedes_date", "ALL-PRECEDES-DATE", 2, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_precedes_node", "ALL-PRECEDES-NODE", 2, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_coordinate", "ALL-COORDINATE", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_successors", "ALL-SUCCESSORS", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_predecessors", "ALL-PREDECESSORS", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_successors_successors", "ALL-SUCCESSORS-SUCCESSORS", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_predecessors_predecessors", "ALL-PREDECESSORS-PREDECESSORS", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "all_between", "ALL-BETWEEN", 4, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "sbhl_temporality_all_forward_nodes_between", "SBHL-TEMPORALITY-ALL-FORWARD-NODES-BETWEEN", 4, 2, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "sbhl_temporality_all_backward_nodes_between", "SBHL-TEMPORALITY-ALL-BACKWARD-NODES-BETWEEN", 4, 2, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "sbhl_temporality_all_nodes_accessed_between", "SBHL-TEMPORALITY-ALL-NODES-ACCESSED-BETWEEN", 3, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "sbhl_temporality_all_nodes_accessed_between_dates", "SBHL-TEMPORALITY-ALL-NODES-ACCESSED-BETWEEN-DATES", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "sbhl_temporality_all_nodes_accessed_between_dates_int", "SBHL-TEMPORALITY-ALL-NODES-ACCESSED-BETWEEN-DATES-INT", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "sbhl_temporality_all_nodes_accessed_between_date_node", "SBHL-TEMPORALITY-ALL-NODES-ACCESSED-BETWEEN-DATE-NODE", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "sbhl_temporality_all_nodes_accessed_between_node_date", "SBHL-TEMPORALITY-ALL-NODES-ACCESSED-BETWEEN-NODE-DATE", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "sbhl_temporality_all_nodes_accessed_between_nodes", "SBHL-TEMPORALITY-ALL-NODES-ACCESSED-BETWEEN-NODES", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_weakly_precedesP", "WHY-WEAKLY-PRECEDES?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_strictly_precedesP", "WHY-STRICTLY-PRECEDES?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_weakly_precedes_successorP", "WHY-WEAKLY-PRECEDES-SUCCESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_successor_strictly_precedesP", "WHY-SUCCESSOR-STRICTLY-PRECEDES?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_weakly_precedes_successors_successorP", "WHY-WEAKLY-PRECEDES-SUCCESSORS-SUCCESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_weakly_precedes_successors_successors_successorP", "WHY-WEAKLY-PRECEDES-SUCCESSORS-SUCCESSORS-SUCCESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_successors_successor_strictly_precedesP", "WHY-SUCCESSORS-SUCCESSOR-STRICTLY-PRECEDES?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_coordinateP", "WHY-COORDINATE?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_successorP", "WHY-SUCCESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_predecessorP", "WHY-PREDECESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_successors_successorP", "WHY-SUCCESSORS-SUCCESSOR?", 2, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_precedesP_date_before", "WHY-PRECEDES?-DATE-BEFORE", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_precedesP_date_after", "WHY-PRECEDES?-DATE-AFTER", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_precedesP_node_date", "WHY-PRECEDES?-NODE-DATE", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_precedesP_node_node", "WHY-PRECEDES?-NODE-NODE", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.sbhl.sbhl_time_search", "why_sbhl_time_predicate_relation_p", "WHY-SBHL-TIME-PREDICATE-RELATION-P", 3, 3, false);
        return (SubLObject)sbhl_time_search.NIL;
    }
    
    public static SubLObject init_sbhl_time_search_file() {
        sbhl_time_search.$sbhl_time_precedes_depths$ = SubLFiles.deflexical("*SBHL-TIME-PRECEDES-DEPTHS*", (SubLObject)sbhl_time_search.$list22);
        return (SubLObject)sbhl_time_search.NIL;
    }
    ...
    static {
        me = (SubLFile)new sbhl_time_search();
        sbhl_time_search.$sbhl_time_precedes_depths$ = null;
        ...
        $const2$MonotonicallyTrue = constant_handles.reader_make_constant_shell((SubLObject)SubLObjectFactory.makeString("MonotonicallyTrue"));
        $kw3$STRICT = SubLObjectFactory.makeKeyword("STRICT");
        $const4$strict_HL_TimePrecedence = constant_handles.reader_make_constant_shell((SubLObject)SubLObjectFactory.makeString("strict-HL-TimePrecedence"));
        $kw5$WEAK_SUCCESSOR = SubLObjectFactory.makeKeyword("WEAK-SUCCESSOR");
        $const6$weakSuccessor_HL_TimePrecedence = constant_handles.reader_make_constant_shell((SubLObject)SubLObjectFactory.makeString("weakSuccessor-HL-TimePrecedence"));
        $kw7$SUCCESSOR_STRICT = SubLObjectFactory.makeKeyword("SUCCESSOR-STRICT");
        $const8$successorStrict_HL_TimePrecedence = constant_handles.reader_make_constant_shell((SubLObject)SubLObjectFactory.makeString("successorStrict-HL-TimePrecedence"));
        $int9$_2 = SubLObjectFactory.makeInteger(-2);
        $int10$_3 = SubLObjectFactory.makeInteger(-3);
        ...
        $const19$True_JustificationTruth = constant_handles.reader_make_constant_shell((SubLObject)SubLObjectFactory.makeString("True-JustificationTruth"));
        $kw20$OLD = SubLObjectFactory.makeKeyword("OLD");
        $kw21$RESOURCE = SubLObjectFactory.makeKeyword("RESOURCE");
        $list22 = ConsesLow.list((SubLObject)sbhl_time_search.ZERO_INTEGER, (SubLObject)sbhl_time_search.MINUS_ONE_INTEGER, (SubLObject)SubLObjectFactory.makeInteger(-2), (SubLObject)sbhl_time_search.ONE_INTEGER, (SubLObject)sbhl_time_search.TWO_INTEGER, (SubLObject)sbhl_time_search.THREE_INTEGER);
        $sym23$INTEGERP = SubLObjectFactory.makeSymbol("INTEGERP");
        $sym24$SBHL_PUSH_ONTO_RESULT = SubLObjectFactory.makeSymbol("SBHL-PUSH-ONTO-RESULT");
        $list25 = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("LINK0"), (SubLObject)SubLObjectFactory.makeSymbol("LINK1"));
        $list26 = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("DATE-TAG"), (SubLObject)SubLObjectFactory.makeSymbol("DATE-MT"), (SubLObject)SubLObjectFactory.makeSymbol("LINK-DATE"), (SubLObject)SubLObjectFactory.makeSymbol("&OPTIONAL"), (SubLObject)SubLObjectFactory.makeUninternedSymbol("LINK-SUPPORTS"));
        $list27 = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("NODE-TAG"), (SubLObject)SubLObjectFactory.makeSymbol("NODE-MT"), (SubLObject)SubLObjectFactory.makeSymbol("NODE"), (SubLObject)SubLObjectFactory.makeSymbol("&OPTIONAL"), (SubLObject)SubLObjectFactory.makeUninternedSymbol("LINK-SUPPORTS"));
        $list28 = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("LINK0"), (SubLObject)SubLObjectFactory.makeSymbol("LINK1"), (SubLObject)SubLObjectFactory.makeSymbol("LINK2"));
        $list29 = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("DATE-TAG"), (SubLObject)SubLObjectFactory.makeSymbol("DATE-MT"), (SubLObject)SubLObjectFactory.makeSymbol("DATE-DATE"), (SubLObject)SubLObjectFactory.makeSymbol("&OPTIONAL"), (SubLObject)SubLObjectFactory.makeUninternedSymbol("LINK-SUPPORTS"));
        $list30 = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("INT-TAG"), (SubLObject)SubLObjectFactory.makeSymbol("INT-MT"), (SubLObject)SubLObjectFactory.makeSymbol("INT-DATE"), (SubLObject)SubLObjectFactory.makeSymbol("&OPTIONAL"), (SubLObject)SubLObjectFactory.makeUninternedSymbol("LINK-SUPPORTS"));
        $list31 = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("LINK-TAG"), (SubLObject)SubLObjectFactory.makeSymbol("LINK-MT"), (SubLObject)SubLObjectFactory.makeSymbol("LINK-NODE"), (SubLObject)SubLObjectFactory.makeSymbol("&OPTIONAL"), (SubLObject)SubLObjectFactory.makeUninternedSymbol("LINK-SUPPORTS"));
        $sym32$SBHL_MODULE_P = SubLObjectFactory.makeSymbol("SBHL-MODULE-P");
        $list33 = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("DATE-TAG"), (SubLObject)SubLObjectFactory.makeSymbol("DATE-MT"), (SubLObject)SubLObjectFactory.makeSymbol("DATE"), (SubLObject)SubLObjectFactory.makeSymbol("&OPTIONAL"), (SubLObject)SubLObjectFactory.makeUninternedSymbol("LINK-SUPPORTS"));
        $sym34$APPEND = SubLObjectFactory.makeSymbol("APPEND");
    }
}
