...
public final class method_listeners
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject method_listeners_valid_demon_type_p(final SubLObject v_object)
  {
    ...
    return ( NIL != conses_high.member( v_object, $method_listeners_demon_types$.getDynamicValue( thread ), UNPROVIDED, UNPROVIDED ) ) ? T : NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return ( NIL != conses_high.member( v_object, $method_listeners_registry_types$.getDynamicValue( thread ), UNPROVIDED, UNPROVIDED ) ) ? T : NIL;
  }
  ...
  public static SubLObject method_listeners_call_listener(final SubLObject method_listener, final SubLObject instance_or_class, final SubLObject args, SubLObject return_value)
  {
    ...
    {
      return_value = $kw8$METHOD_LISTENERS_NO_VALUE;
    }
    if( NIL != subloop_structures.method_listener_p( method_listener ) )
    {
      ...
      if( NIL != subloop_structures.function_detail_p( detail ) )
      {
        ...
        {
          if( return_value == $kw8$METHOD_LISTENERS_NO_VALUE )
          {
      ...
      else if( NIL != subloop_structures.method_detail_p( detail ) )
      {
  ...
  public static SubLObject new_method_based_method_listener(final SubLObject monitored_method, final SubLObject monitored_class, final SubLObject new_demon_type, final SubLObject monitoring_method,
      final SubLObject monitoring_class_or_instance)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( NIL == Errors.$ignore_mustsP$.getDynamicValue( thread ) && ( NIL == monitored_method || !monitored_method.isSymbol() ) )
    {
    ...
    try
    {
      ...
      try
      {
        ...
        final SubLObject monitoring_class = ( NIL != subloop_structures.class_p( monitoring_class_or_instance ) ) ? monitoring_class_or_instance
            : ( ( NIL != subloop_structures.instance_p( monitoring_class_or_instance ) ) ? subloop_structures.instance_class( monitoring_class_or_instance ) : NIL );
  ...
  public static SubLObject method_listeners_invoke_before_method_listeners(final SubLObject method, final SubLObject class_or_instance, final SubLObject args)
  {
    ...
    {
      return method_listeners_invoke_method_listeners_private( method, $kw9$BEFORE, class_or_instance, args, UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject method_listeners_invoke_after_method_listeners(final SubLObject method, final SubLObject class_or_instance, final SubLObject args, final SubLObject return_value)
  {
    if( NIL != subloop_structures.method_p( method ) )
    {
      return method_listeners_invoke_method_listeners_private( method, $kw10$AFTER, class_or_instance, args, return_value );
    }
    return NIL;
  }
  ...
  public static SubLObject method_listeners_add_listener(final SubLObject class_name, final SubLObject method, final SubLObject type, final SubLObject function_or_method, SubLObject class_or_instance_if_method)
  {
    ...
    if( type.eql( $kw9$BEFORE ) )
    {
      ...
      if( NIL != class_or_instance_if_method )
      {
        ...
        try
        {
          before_listeners = ConsesLow.nconc( before_listeners, ConsesLow.list( new_method_based_method_listener( name, class_name_$7, $kw9$BEFORE, function_or_method, class_or_instance_if_method ) ) );
        }
        finally
        {
      ...
      try
      {
        before_listeners = ConsesLow.nconc( before_listeners, ConsesLow.list( new_function_based_method_listener( name, class_name_$8, $kw9$BEFORE, function_or_method ) ) );
      }
      finally
      {
    ...
    else
    {
      ...
      if( NIL != class_or_instance_if_method )
      {
        ...
        try
        {
          after_listeners = ConsesLow.cons( new_method_based_method_listener( name, class_name_$9, $kw10$AFTER, function_or_method, class_or_instance_if_method ), after_listeners );
        }
        finally
        {
      ...
      try
      {
        after_listeners2 = ConsesLow.cons( new_function_based_method_listener( method, class_name_$10, $kw10$AFTER, function_or_method ), after_listeners2 );
      }
      finally
      {
  ...
  public static SubLObject method_listeners_add_before_listener(final SubLObject class_name, final SubLObject method_name, final SubLObject function_or_method, SubLObject class_or_instance_if_method)
  {
    ...
    if( NIL != v_class )
    {
      ...
      if( NIL != method )
      {
        return method_listeners_add_listener( class_name, method, $kw9$BEFORE, function_or_method, class_or_instance_if_method );
      }
    }
    return NIL;
  }
  ...
  public static SubLObject method_listeners_add_after_listener(final SubLObject class_name, final SubLObject method_name, final SubLObject function_or_method, SubLObject class_or_instance_if_method)
  {
    ...
    if( NIL != v_class )
    {
      ...
      if( NIL != method )
      {
        return method_listeners_add_listener( class_name, method, $kw10$AFTER, function_or_method, class_or_instance_if_method );
      }
    }
    return NIL;
  }
      ...
      try
      {
        if( monitored_class_name.eql( class_name ) )
        {
          ...
          while ( NIL != cdolist_list_var_$19)
          {
            ...
            {
              new_listeners = ConsesLow.cons( listener, new_listeners );
            }
  ...
  public static SubLObject method_listeners_remove_all_method_listeners(final SubLObject monitored_instance, SubLObject target_class_or_instance, SubLObject method_name)
  {
    ...
    if( NIL == Errors.$ignore_mustsP$.getDynamicValue( thread ) && NIL != target_class_or_instance && NIL == subloop_structures.class_p( target_class_or_instance ) && NIL == subloop_structures.instance_p(
        target_class_or_instance ) )
    {
  ...
  {
    final SubLObject v_class = ( NIL != subloop_structures.class_p( class_instance_or_class_name ) ) ? class_instance_or_class_name
        : ( ( NIL != subloop_structures.instance_p( class_instance_or_class_name ) ) ? subloop_structures.instance_class( class_instance_or_class_name )
            : ( class_instance_or_class_name.isSymbol() ? classes.classes_retrieve_class( class_instance_or_class_name ) : NIL ) );
    if( NIL == v_class )
    {
      return NIL;
    }
  ...
  public static SubLObject with_instance_method_listener_registry(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      ...
      current = ( forms = temp );
      return ConsesLow.listS( $sym12$WITH_METHOD_LISTENER_REGISTRY, ConsesLow.list( $sym13$METHOD_LISTENERS_FIND_REGISTRY, instance, registry_type ), forms );
    }
  ...
  public static SubLObject with_instance_method_listener_registry_private(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject forms;
      current = ( forms = temp );
      return ConsesLow.listS( $sym14$WITH_METHOD_LISTENER_REGISTRY_PRIVATE, ConsesLow.list( $sym13$METHOD_LISTENERS_FIND_REGISTRY, instance, registry_type ), forms );
    }
    cdestructuring_bind.cdestructuring_bind_error( datum, $list11 );
    return NIL;
  }
  ...
  public static SubLObject method_listeners_add_instance_specific_listener(final SubLObject target_instance, final SubLObject method, final SubLObject type, final SubLObject function_or_method,
      SubLObject class_or_instance_if_method)
  {
    if( class_or_instance_if_method == UNPROVIDED )
    {
      class_or_instance_if_method = NIL;
  ...
  public static SubLObject method_listeners_add_instance_specific_before_listener(final SubLObject instance, final SubLObject method_name, final SubLObject function_or_method, SubLObject class_or_instance_if_method)
  {
    ...
    method_listeners_add_instance_specific_listener( instance, method_name, $kw9$BEFORE, function_or_method, class_or_instance_if_method );
    return NIL;
  }

  public static SubLObject declare_method_listeners_file()
  {
    SubLFiles.declareFunction( me, "method_listeners_valid_demon_type_p", "METHOD-LISTENERS-VALID-DEMON-TYPE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_valid_registry_type_p", "METHOD-LISTENERS-VALID-REGISTRY-TYPE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_call_listener", "METHOD-LISTENERS-CALL-LISTENER", 3, 1, false );
    SubLFiles.declareFunction( me, "new_function_based_method_listener", "NEW-FUNCTION-BASED-METHOD-LISTENER", 4, 0, false );
    SubLFiles.declareFunction( me, "new_method_based_method_listener", "NEW-METHOD-BASED-METHOD-LISTENER", 5, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_get_listeners", "METHOD-LISTENERS-GET-LISTENERS", 2, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_invoke_method_listeners_private", "METHOD-LISTENERS-INVOKE-METHOD-LISTENERS-PRIVATE", 4, 1, false );
    SubLFiles.declareFunction( me, "method_listeners_invoke_before_method_listeners", "METHOD-LISTENERS-INVOKE-BEFORE-METHOD-LISTENERS", 3, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_invoke_after_method_listeners", "METHOD-LISTENERS-INVOKE-AFTER-METHOD-LISTENERS", 4, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_invoke_before_listeners", "METHOD-LISTENERS-INVOKE-BEFORE-LISTENERS", 3, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_invoke_after_listeners", "METHOD-LISTENERS-INVOKE-AFTER-LISTENERS", 4, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_add_listener", "METHOD-LISTENERS-ADD-LISTENER", 4, 1, false );
    SubLFiles.declareFunction( me, "method_listeners_add_before_listener", "METHOD-LISTENERS-ADD-BEFORE-LISTENER", 3, 1, false );
    SubLFiles.declareFunction( me, "method_listeners_add_after_listener", "METHOD-LISTENERS-ADD-AFTER-LISTENER", 3, 1, false );
    SubLFiles.declareFunction( me, "method_listeners_remove_all_method_listeners_private", "METHOD-LISTENERS-REMOVE-ALL-METHOD-LISTENERS-PRIVATE", 1, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_remove_all_method_listeners_with_target", "METHOD-LISTENERS-REMOVE-ALL-METHOD-LISTENERS-WITH-TARGET", 2, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_remove_all_method_listeners_with_target_and_method_internal", "METHOD-LISTENERS-REMOVE-ALL-METHOD-LISTENERS-WITH-TARGET-AND-METHOD-INTERNAL", 3, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_remove_all_method_listeners", "METHOD-LISTENERS-REMOVE-ALL-METHOD-LISTENERS", 1, 2, false );
    SubLFiles.declareFunction( me, "method_listeners_filtered_lambda_list", "METHOD-LISTENERS-FILTERED-LAMBDA-LIST", 2, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_add_registry", "METHOD-LISTENERS-ADD-REGISTRY", 2, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_get_registry", "METHOD-LISTENERS-GET-REGISTRY", 2, 0, false );
    SubLFiles.declareFunction( me, "method_listeners_find_registry", "METHOD-LISTENERS-FIND-REGISTRY", 2, 0, false );
    SubLFiles.declareMacro( me, "with_instance_method_listener_registry", "WITH-INSTANCE-METHOD-LISTENER-REGISTRY" );
    SubLFiles.declareMacro( me, "with_instance_method_listener_registry_private", "WITH-INSTANCE-METHOD-LISTENER-REGISTRY-PRIVATE" );
    SubLFiles.declareFunction( me, "method_listeners_add_instance_specific_listener", "METHOD-LISTENERS-ADD-INSTANCE-SPECIFIC-LISTENER", 4, 1, false );
    SubLFiles.declareFunction( me, "method_listeners_add_instance_specific_before_listener", "METHOD-LISTENERS-ADD-INSTANCE-SPECIFIC-BEFORE-LISTENER", 3, 1, false );
    return NIL;
  }

  public static SubLObject init_method_listeners_file()
  {
    $method_listeners_illegal_demon_type_message$ = SubLFiles.defconstant( "*METHOD-LISTENERS-ILLEGAL-DEMON-TYPE-MESSAGE*", $str0$_S_is_not_a_legal_demon_type___Me );
    $method_listeners_illegal_method_message$ = SubLFiles.defconstant( "*METHOD-LISTENERS-ILLEGAL-METHOD-MESSAGE*", $str1$_S_is_not_a_legal_method___A_meth );
    $method_listeners_illegal_function_message$ = SubLFiles.defconstant( "*METHOD-LISTENERS-ILLEGAL-FUNCTION-MESSAGE*", $str2$_S_is_not_a_legal_function___A_fu );
    $method_listeners_illegal_class_name_message$ = SubLFiles.defconstant( "*METHOD-LISTENERS-ILLEGAL-CLASS-NAME-MESSAGE*", $str3$_S_is_not_a_legal_class_name___A_ );
    $method_listeners_illegal_class_or_instance_message$ = SubLFiles.defconstant( "*METHOD-LISTENERS-ILLEGAL-CLASS-OR-INSTANCE-MESSAGE*", $str4$_S_is_not_a_legal_class_or_instan );
    $method_listeners_illegal_instance_method$ = SubLFiles.defconstant( "*METHOD-LISTENERS-ILLEGAL-INSTANCE-METHOD*", $str5$_S_is_not_a_legal_instance_ );
    $method_listeners_demon_types$ = SubLFiles.defparameter( "*METHOD-LISTENERS-DEMON-TYPES*", $list6 );
    $method_listeners_registry_types$ = SubLFiles.defparameter( "*METHOD-LISTENERS-REGISTRY-TYPES*", $list7 );
    return NIL;
  }
  ...
  static
  {
    me = new method_listeners();
    $method_listeners_illegal_demon_type_message$ = null;
    $method_listeners_illegal_method_message$ = null;
    $method_listeners_illegal_function_message$ = null;
    $method_listeners_illegal_class_name_message$ = null;
    $method_listeners_illegal_class_or_instance_message$ = null;
    $method_listeners_illegal_instance_method$ = null;
    $method_listeners_demon_types$ = null;
    $method_listeners_registry_types$ = null;
    $str0$_S_is_not_a_legal_demon_type___Me = makeString( "~S is not a legal demon type.  Method listener demon types must be one of :before or :after." );
    $str1$_S_is_not_a_legal_method___A_meth = makeString( "~S is not a legal method.  A method must be a non-nil symbol." );
    $str2$_S_is_not_a_legal_function___A_fu = makeString( "~S is not a legal function.  A function must be a non-nil symbol." );
    $str3$_S_is_not_a_legal_class_name___A_ = makeString( "~S is not a legal class name.  A class name must be a non-nil symbol." );
    $str4$_S_is_not_a_legal_class_or_instan = makeString( "~S is not a legal class or instance." );
    $str5$_S_is_not_a_legal_instance_ = makeString( "~S is not a legal instance." );
    $list6 = ConsesLow.list( makeKeyword( "BEFORE" ), makeKeyword( "AFTER" ) );
    $list7 = ConsesLow.list( makeKeyword( "BEFORE-METHOD-REGISTRY" ), makeKeyword( "AFTER-METHOD-REGISTRY" ) );
    $kw8$METHOD_LISTENERS_NO_VALUE = makeKeyword( "METHOD-LISTENERS-NO-VALUE" );
    $kw9$BEFORE = makeKeyword( "BEFORE" );
    $kw10$AFTER = makeKeyword( "AFTER" );
    $list11 = ConsesLow.list( ConsesLow.list( makeSymbol( "INSTANCE" ), makeSymbol( "REGISTRY-TYPE" ) ), makeSymbol( "&BODY" ), makeSymbol( "FORMS" ) );
    $sym12$WITH_METHOD_LISTENER_REGISTRY = makeSymbol( "WITH-METHOD-LISTENER-REGISTRY" );
    $sym13$METHOD_LISTENERS_FIND_REGISTRY = makeSymbol( "METHOD-LISTENERS-FIND-REGISTRY" );
    $sym14$WITH_METHOD_LISTENER_REGISTRY_PRIVATE = makeSymbol( "WITH-METHOD-LISTENER-REGISTRY-PRIVATE" );
  }
}
/*
 * 
