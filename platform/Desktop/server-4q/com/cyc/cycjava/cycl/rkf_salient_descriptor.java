...
public final class rkf_salient_descriptor extends SubLTranslatedFile
{
    ...
    public static SubLObject init_rkf_salient_descriptor_file() {
        ...
        rkf_salient_descriptor.$rkf_salient_descriptor_cache$ = SubLFiles.deflexical("*RKF-SALIENT-DESCRIPTOR-CACHE*", (rkf_salient_descriptor.NIL != Symbols.boundp((SubLObject)rkf_salient_descriptor.$sym202$_RKF_SALIENT_DESCRIPTOR_CACHE_)) ? rkf_salient_descriptor.$rkf_salient_descriptor_cache$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)rkf_salient_descriptor.TEN_INTEGER, Symbols.symbol_function((SubLObject)rkf_salient_descriptor.EQUAL), (SubLObject)rkf_salient_descriptor.UNPROVIDED));
        ...
        rkf_salient_descriptor.$rkf_salient_descriptor_ignore_cache$ = SubLFiles.deflexical("*RKF-SALIENT-DESCRIPTOR-IGNORE-CACHE*", (rkf_salient_descriptor.NIL != Symbols.boundp((SubLObject)rkf_salient_descriptor.$sym204$_RKF_SALIENT_DESCRIPTOR_IGNORE_CACHE_)) ? rkf_salient_descriptor.$rkf_salient_descriptor_ignore_cache$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)rkf_salient_descriptor.TEN_INTEGER, Symbols.symbol_function((SubLObject)rkf_salient_descriptor.EQUAL), (SubLObject)rkf_salient_descriptor.UNPROVIDED));
