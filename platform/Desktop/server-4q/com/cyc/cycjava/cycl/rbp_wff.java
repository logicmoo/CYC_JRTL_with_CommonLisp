...
public final class rbp_wff extends SubLTranslatedFile
{
    ...
    public static SubLObject init_rbp_wff_file() {
        ...
        rbp_wff.$rbp_wff_validation_count$ = SubLFiles.deflexical("*RBP-WFF-VALIDATION-COUNT*", (SubLObject)((rbp_wff.NIL != Symbols.boundp((SubLObject)rbp_wff.$sym0$_RBP_WFF_VALIDATION_COUNT_)) ? rbp_wff.$rbp_wff_validation_count$.getGlobalValue() : rbp_wff.ZERO_INTEGER));
        rbp_wff.$rbp_wff_validation_false_pos$ = SubLFiles.deflexical("*RBP-WFF-VALIDATION-FALSE-POS*", (SubLObject)((rbp_wff.NIL != Symbols.boundp((SubLObject)rbp_wff.$sym1$_RBP_WFF_VALIDATION_FALSE_POS_)) ? rbp_wff.$rbp_wff_validation_false_pos$.getGlobalValue() : rbp_wff.NIL));
        rbp_wff.$rbp_wff_validation_false_neg$ = SubLFiles.deflexical("*RBP-WFF-VALIDATION-FALSE-NEG*", (SubLObject)((rbp_wff.NIL != Symbols.boundp((SubLObject)rbp_wff.$sym2$_RBP_WFF_VALIDATION_FALSE_NEG_)) ? rbp_wff.$rbp_wff_validation_false_neg$.getGlobalValue() : rbp_wff.NIL));
        rbp_wff.$rbp_wff_validate_setting$ = SubLFiles.deflexical("*RBP-WFF-VALIDATE-SETTING*", (SubLObject)((rbp_wff.NIL != Symbols.boundp((SubLObject)rbp_wff.$sym3$_RBP_WFF_VALIDATE_SETTING_)) ? rbp_wff.$rbp_wff_validate_setting$.getGlobalValue() : rbp_wff.NIL));
        rbp_wff.$rbp_vocabulary_mts$ = SubLFiles.deflexical("*RBP-VOCABULARY-MTS*", (SubLObject)((rbp_wff.NIL != Symbols.boundp((SubLObject)rbp_wff.$sym4$_RBP_VOCABULARY_MTS_)) ? rbp_wff.$rbp_vocabulary_mts$.getGlobalValue() : rbp_wff.$kw5$UNINITIALIZED));
        rbp_wff.$rbp_wff_quaternary_rmps$ = SubLFiles.deflexical("*RBP-WFF-QUATERNARY-RMPS*", (SubLObject)((rbp_wff.NIL != Symbols.boundp((SubLObject)rbp_wff.$sym6$_RBP_WFF_QUATERNARY_RMPS_)) ? rbp_wff.$rbp_wff_quaternary_rmps$.getGlobalValue() : rbp_wff.$kw5$UNINITIALIZED));
        ...
        rbp_wff.$inter_arg_isa_predicate_mt$ = SubLFiles.deflexical("*INTER-ARG-ISA-PREDICATE-MT*", (rbp_wff.NIL != Symbols.boundp((SubLObject)rbp_wff.$sym117$_INTER_ARG_ISA_PREDICATE_MT_)) ? rbp_wff.$inter_arg_isa_predicate_mt$.getGlobalValue() : rbp_wff.$const109$BaseKB);
        rbp_wff.$arg_not_isa_predicate_mt$ = SubLFiles.deflexical("*ARG-NOT-ISA-PREDICATE-MT*", (rbp_wff.NIL != Symbols.boundp((SubLObject)rbp_wff.$sym119$_ARG_NOT_ISA_PREDICATE_MT_)) ? rbp_wff.$arg_not_isa_predicate_mt$.getGlobalValue() : rbp_wff.$const109$BaseKB);
