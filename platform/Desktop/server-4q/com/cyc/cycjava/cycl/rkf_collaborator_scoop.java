...
public final class rkf_collaborator_scoop extends SubLTranslatedFile
{
    ...
    public static SubLObject init_rkf_collaborator_scoop_file() {
        ...
        rkf_collaborator_scoop.$scoop_definitions$ = SubLFiles.deflexical("*SCOOP-DEFINITIONS*", (SubLObject)((rkf_collaborator_scoop.NIL != Symbols.boundp((SubLObject)rkf_collaborator_scoop.$sym9$_SCOOP_DEFINITIONS_)) ? rkf_collaborator_scoop.$scoop_definitions$.getGlobalValue() : rkf_collaborator_scoop.NIL));
        rkf_collaborator_scoop.$scoop_members$ = SubLFiles.deflexical("*SCOOP-MEMBERS*", (SubLObject)((rkf_collaborator_scoop.NIL != Symbols.boundp((SubLObject)rkf_collaborator_scoop.$sym10$_SCOOP_MEMBERS_)) ? rkf_collaborator_scoop.$scoop_members$.getGlobalValue() : rkf_collaborator_scoop.NIL));
