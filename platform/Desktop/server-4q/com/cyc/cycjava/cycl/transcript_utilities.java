...
public final class transcript_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_transcript_utilities_file() {
        ...
        transcript_utilities.$local_transcript_version$ = SubLFiles.deflexical("*LOCAL-TRANSCRIPT-VERSION*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym2$_LOCAL_TRANSCRIPT_VERSION_, transcript_utilities.$local_transcript_version$, transcript_utilities.ZERO_INTEGER)));
        transcript_utilities.$local_transcript_history$ = SubLFiles.deflexical("*LOCAL-TRANSCRIPT-HISTORY*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym3$_LOCAL_TRANSCRIPT_HISTORY_, transcript_utilities.$local_transcript_history$, transcript_utilities.NIL)));
        transcript_utilities.$local_hl_transcript_version$ = SubLFiles.deflexical("*LOCAL-HL-TRANSCRIPT-VERSION*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym4$_LOCAL_HL_TRANSCRIPT_VERSION_, transcript_utilities.$local_hl_transcript_version$, transcript_utilities.ZERO_INTEGER)));
        transcript_utilities.$local_hl_transcript_history$ = SubLFiles.deflexical("*LOCAL-HL-TRANSCRIPT-HISTORY*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym5$_LOCAL_HL_TRANSCRIPT_HISTORY_, transcript_utilities.$local_hl_transcript_history$, transcript_utilities.NIL)));
        transcript_utilities.$read_transcript_position$ = SubLFiles.deflexical("*READ-TRANSCRIPT-POSITION*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym6$_READ_TRANSCRIPT_POSITION_, transcript_utilities.$read_transcript_position$, transcript_utilities.ZERO_INTEGER)));
        ...
        transcript_utilities.$local_transcript$ = SubLFiles.deflexical("*LOCAL-TRANSCRIPT*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym8$_LOCAL_TRANSCRIPT_, transcript_utilities.$local_transcript$, transcript_utilities.NIL)));
        transcript_utilities.$read_transcript$ = SubLFiles.deflexical("*READ-TRANSCRIPT*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym14$_READ_TRANSCRIPT_, transcript_utilities.$read_transcript$, transcript_utilities.NIL)));
        transcript_utilities.$master_transcript$ = SubLFiles.deflexical("*MASTER-TRANSCRIPT*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym15$_MASTER_TRANSCRIPT_, transcript_utilities.$master_transcript$, transcript_utilities.NIL)));
        transcript_utilities.$local_hl_transcript$ = SubLFiles.deflexical("*LOCAL-HL-TRANSCRIPT*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym16$_LOCAL_HL_TRANSCRIPT_, transcript_utilities.$local_hl_transcript$, transcript_utilities.NIL)));
        transcript_utilities.$count_ops_table$ = SubLFiles.deflexical("*COUNT-OPS-TABLE*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym26$_COUNT_OPS_TABLE_, transcript_utilities.$count_ops_table$, transcript_utilities.NIL)));
        transcript_utilities.$transcript_rename_hash$ = SubLFiles.deflexical("*TRANSCRIPT-RENAME-HASH*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym55$_TRANSCRIPT_RENAME_HASH_, transcript_utilities.$transcript_rename_hash$, transcript_utilities.NIL)));
        transcript_utilities.$transcript_create_hash$ = SubLFiles.deflexical("*TRANSCRIPT-CREATE-HASH*", (SubLObject)(maybeDefault((SubLObject)transcript_utilities.$sym59$_TRANSCRIPT_CREATE_HASH_, transcript_utilities.$transcript_create_hash$, transcript_utilities.NIL)));
        return (SubLObject)transcript_utilities.NIL;
    }
