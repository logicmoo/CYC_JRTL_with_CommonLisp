...
public final class cfasl_compression extends SubLTranslatedFile
{
    ...
    public static SubLObject init_cfasl_compression_file() {
        ...
        cfasl_compression.$cfasl_decompression_index$ = SubLFiles.deflexical("*CFASL-DECOMPRESSION-INDEX*", maybeDefault((SubLObject)cfasl_compression.$sym8$_CFASL_DECOMPRESSION_INDEX_, cfasl_compression.$cfasl_decompression_index$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)cfasl_compression.EQ), (SubLObject)cfasl_compression.UNPROVIDED))));
        cfasl_compression.$cfasl_compression_not_found$ = SubLFiles.deflexical("*CFASL-COMPRESSION-NOT-FOUND*", maybeDefault((SubLObject)cfasl_compression.$sym9$_CFASL_COMPRESSION_NOT_FOUND_, cfasl_compression.$cfasl_compression_not_found$, ()->(Symbols.make_symbol((SubLObject)cfasl_compression.$str10$NOT_FOUND))));
