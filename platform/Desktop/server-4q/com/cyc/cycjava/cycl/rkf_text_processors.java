...
public final class rkf_text_processors extends SubLTranslatedFile
{
    ...
    public static SubLObject init_rkf_text_processors_file() {
        ...
        rkf_text_processors.$rkf_terms_forager_lock$ = SubLFiles.deflexical("*RKF-TERMS-FORAGER-LOCK*", (rkf_text_processors.NIL != Symbols.boundp((SubLObject)rkf_text_processors.$sym67$_RKF_TERMS_FORAGER_LOCK_)) ? rkf_text_processors.$rkf_terms_forager_lock$.getGlobalValue() : Locks.make_lock((SubLObject)rkf_text_processors.$str68$Terms_Forager));
        ...
        rkf_text_processors.$rkf_uttrdr_known_parsers$ = SubLFiles.deflexical("*RKF-UTTRDR-KNOWN-PARSERS*", (SubLObject)((rkf_text_processors.NIL != Symbols.boundp((SubLObject)rkf_text_processors.$sym128$_RKF_UTTRDR_KNOWN_PARSERS_)) ? rkf_text_processors.$rkf_uttrdr_known_parsers$.getGlobalValue() : rkf_text_processors.NIL));
