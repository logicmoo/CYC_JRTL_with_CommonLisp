...
public final class utilities_macros extends SubLTranslatedFile
{
    ...
    public static SubLObject init_utilities_macros_file() {
        utilities_macros.$api_special_table$ = SubLFiles.deflexical("*API-SPECIAL-TABLE*", maybeDefault((SubLObject)utilities_macros.$sym15$_API_SPECIAL_TABLE_, utilities_macros.$api_special_table$, ()->(Hashtables.make_hash_table((SubLObject)utilities_macros.TEN_INTEGER, Symbols.symbol_function((SubLObject)utilities_macros.EQ), (SubLObject)utilities_macros.UNPROVIDED))));
        utilities_macros.$api_predefined_function_table$ = SubLFiles.deflexical("*API-PREDEFINED-FUNCTION-TABLE*", maybeDefault((SubLObject)utilities_macros.$sym17$_API_PREDEFINED_FUNCTION_TABLE_, utilities_macros.$api_predefined_function_table$, ()->(Hashtables.make_hash_table((SubLObject)utilities_macros.$int18$1000, Symbols.symbol_function((SubLObject)utilities_macros.EQ), (SubLObject)utilities_macros.UNPROVIDED))));
        utilities_macros.$api_predefined_host_function_table$ = SubLFiles.deflexical("*API-PREDEFINED-HOST-FUNCTION-TABLE*", maybeDefault((SubLObject)utilities_macros.$sym19$_API_PREDEFINED_HOST_FUNCTION_TABLE_, utilities_macros.$api_predefined_host_function_table$, ()->(Hashtables.make_hash_table((SubLObject)utilities_macros.$int20$100, Symbols.symbol_function((SubLObject)utilities_macros.EQ), (SubLObject)utilities_macros.UNPROVIDED))));
        utilities_macros.$api_predefined_macro_table$ = SubLFiles.deflexical("*API-PREDEFINED-MACRO-TABLE*", maybeDefault((SubLObject)utilities_macros.$sym21$_API_PREDEFINED_MACRO_TABLE_, utilities_macros.$api_predefined_macro_table$, ()->(Hashtables.make_hash_table((SubLObject)utilities_macros.$int20$100, Symbols.symbol_function((SubLObject)utilities_macros.EQ), (SubLObject)utilities_macros.UNPROVIDED))));
        utilities_macros.$api_predefined_host_macro_table$ = SubLFiles.deflexical("*API-PREDEFINED-HOST-MACRO-TABLE*", maybeDefault((SubLObject)utilities_macros.$sym22$_API_PREDEFINED_HOST_MACRO_TABLE_, utilities_macros.$api_predefined_host_macro_table$, ()->(Hashtables.make_hash_table((SubLObject)utilities_macros.TEN_INTEGER, Symbols.symbol_function((SubLObject)utilities_macros.EQ), (SubLObject)utilities_macros.UNPROVIDED))));
        utilities_macros.$api_symbols$ = SubLFiles.deflexical("*API-SYMBOLS*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym23$_API_SYMBOLS_, utilities_macros.$api_symbols$, utilities_macros.NIL)));
        utilities_macros.$api_types$ = SubLFiles.deflexical("*API-TYPES*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym29$_API_TYPES_, utilities_macros.$api_types$, utilities_macros.NIL)));
        utilities_macros.$kb_function_table$ = SubLFiles.deflexical("*KB-FUNCTION-TABLE*", maybeDefault((SubLObject)utilities_macros.$sym58$_KB_FUNCTION_TABLE_, utilities_macros.$kb_function_table$, ()->(Hashtables.make_hash_table((SubLObject)utilities_macros.$int59$400, Symbols.symbol_function((SubLObject)utilities_macros.EQ), (SubLObject)utilities_macros.UNPROVIDED))));
        utilities_macros.$funcall_helper_property$ = SubLFiles.deflexical("*FUNCALL-HELPER-PROPERTY*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym65$_FUNCALL_HELPER_PROPERTY_, utilities_macros.$funcall_helper_property$, utilities_macros.$kw66$FUNCALL_HELPER)));
        utilities_macros.$unprovided$ = SubLFiles.deflexical("*UNPROVIDED*", maybeDefault((SubLObject)utilities_macros.$sym68$_UNPROVIDED_, utilities_macros.$unprovided$, ()->(Symbols.make_symbol((SubLObject)utilities_macros.$str69$UNPROVIDED))));
        utilities_macros.$cfasl_stream$ = SubLFiles.defparameter("*CFASL-STREAM*", (SubLObject)utilities_macros.NIL);
        utilities_macros.$global_locks$ = SubLFiles.deflexical("*GLOBAL-LOCKS*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym98$_GLOBAL_LOCKS_, utilities_macros.$global_locks$, utilities_macros.NIL)));
        utilities_macros.$fi_state_variables$ = SubLFiles.deflexical("*FI-STATE-VARIABLES*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym106$_FI_STATE_VARIABLES_, utilities_macros.$fi_state_variables$, utilities_macros.NIL)));
        utilities_macros.$html_state_variables$ = SubLFiles.deflexical("*HTML-STATE-VARIABLES*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym113$_HTML_STATE_VARIABLES_, utilities_macros.$html_state_variables$, utilities_macros.NIL)));
        utilities_macros.$html_interface_variables$ = SubLFiles.deflexical("*HTML-INTERFACE-VARIABLES*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym117$_HTML_INTERFACE_VARIABLES_, utilities_macros.$html_interface_variables$, utilities_macros.NIL)));
        utilities_macros.$gt_state_variables$ = SubLFiles.deflexical("*GT-STATE-VARIABLES*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym142$_GT_STATE_VARIABLES_, utilities_macros.$gt_state_variables$, utilities_macros.NIL)));
        utilities_macros.$at_state_variables$ = SubLFiles.deflexical("*AT-STATE-VARIABLES*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym144$_AT_STATE_VARIABLES_, utilities_macros.$at_state_variables$, utilities_macros.NIL)));
        utilities_macros.$defn_state_variables$ = SubLFiles.deflexical("*DEFN-STATE-VARIABLES*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym145$_DEFN_STATE_VARIABLES_, utilities_macros.$defn_state_variables$, utilities_macros.NIL)));
        utilities_macros.$kbp_state_variables$ = SubLFiles.deflexical("*KBP-STATE-VARIABLES*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym148$_KBP_STATE_VARIABLES_, utilities_macros.$kbp_state_variables$, utilities_macros.NIL)));
        ...
        utilities_macros.$kb_var_initializations$ = SubLFiles.deflexical("*KB-VAR-INITIALIZATIONS*", (SubLObject)(maybeDefault((SubLObject)utilities_macros.$sym510$_KB_VAR_INITIALIZATIONS_, utilities_macros.$kb_var_initializations$, utilities_macros.NIL)));
