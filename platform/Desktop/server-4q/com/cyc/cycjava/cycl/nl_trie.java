      ...
      SubLTranslatedFile
{
  ...
  public static SubLObject with_nl_trie_cache_strategy(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.listS( $sym5$WITH_BACKED_MAP_CACHE_STRATEGY, $list6, ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject without_nl_trie_cache_strategy(final SubLObject macroform, final SubLObject environment)
  {
    ...
    final SubLObject body;
    final SubLObject current = body = datum;
    return ConsesLow.listS( $sym5$WITH_BACKED_MAP_CACHE_STRATEGY, $list7, ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject with_nl_trie_lock_held(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.list( $sym11$WITH_LOCK_HELD, ConsesLow.list( $sym8$_NL_TRIE_LOCK_, $kw12$WHOSTATE, reason ), ConsesLow.listS( $sym13$WITH_FILE_VECTOR_BACKED_MAP_STREAM_LOCK, $list14, ConsesLow.append( body,
          NIL ) ) );
    }
  ...
  public static SubLObject nl_trie_term_phrases_entry_p(final SubLObject obj, SubLObject robustP)
  {
    ...
    return makeBoolean( NIL != assertion_handles.assertion_p( obj ) && ( NIL == robustP || NIL != assertion_handles.valid_assertionP( obj, UNPROVIDED ) ) && NIL != assertions_high.gaf_assertionP( obj ) && assertions_high
        .gaf_arg0( obj ).eql( $const15$termPhrases ) );
  }
  ...
  public static SubLObject validate_nl_trie_entry(final SubLObject obj)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym16$VALIDATE_NL_TRIE_ENTRY, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym16$VALIDATE_NL_TRIE_ENTRY, ONE_INTEGER, $int17$200, EQL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym16$VALIDATE_NL_TRIE_ENTRY, caching_state );
    }
    ...
    {
      results = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( validate_nl_trie_entry_internal( obj ) ) );
  ...
  {
    return methods.funcall_instance_method_with_1_args( entry, $sym18$GET, slot );
  }
  ...
  public static SubLObject nl_trie_entry_string(final SubLObject entry)
  {
    ...
    {
      return cycl_string.cycl_string_to_utf8_string( nl_trie_lex_entry_get( entry, $kw21$STRING ) );
    }
    return NIL;
  }
  ...
  public static SubLObject nl_trie_entry_keys(final SubLObject entry, SubLObject consider_adding_theP)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != nl_trie_name_p( entry, T ) )
      {
        ...
        try
        {
          lexicon_macros.$nl_trie_accessor_default_case_sensitivity$.bind( $kw23$OFF, thread );
          if( NIL != list_utilities.lengthG( raw_key, ONE_INTEGER, UNPROVIDED ) && raw_key.first().equalp( $english_definite_determiner$.getGlobalValue() ) && !conses_high.second( raw_key ).equalp(
              $english_definite_determiner$.getGlobalValue() ) )
          {
            ans = ConsesLow.cons( raw_key.rest(), ans );
          }
          else if( NIL != consider_adding_theP && NIL != nl_trie_name_ok_for_adding_theP( entry, entry_mt, raw_key ) )
          {
            final SubLObject the_ful = ConsesLow.cons( $english_definite_determiner$.getGlobalValue(), raw_key );
            ans = ConsesLow.cons( the_ful, ans );
          }
        }
        finally
        {
  ...
  public static SubLObject do_nl_trie_names_with_added_the(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      ...
      return ConsesLow.list( $sym28$WITH_NL_TRIE_CACHE_STRATEGY, ConsesLow.list( $sym29$CLET, ConsesLow.list( reader.bq_cons( v_strie, $list30 ) ), ConsesLow.list( $sym31$WITH_NL_TRIE_LOCK_HELD, $list32, ConsesLow.list(
          $sym33$DO_STRIE_PROGRESS, ConsesLow.listS( key, entries, v_strie, $list34 ), ConsesLow.list( $sym35$CDOLIST, ConsesLow.list( name, entries ), ConsesLow.listS( $sym36$PWHEN, ConsesLow.list( $sym37$CAND,
              ConsesLow.list( $sym38$NL_TRIE_NAME_P, name ), ConsesLow.list( $sym39$CNOT, ConsesLow.listS( $sym40$SUBSTRING_MATCH_, ConsesLow.list( $sym41$NL_TRIE_NAME_STRING, name ), $list42 ) ) ), ConsesLow.append(
                  body, NIL ) ) ) ) ) ) );
    }
  ...
  public static SubLObject nl_trie_name_ok_for_adding_theP(final SubLObject entry, final SubLObject entry_mt, final SubLObject raw_key)
  {
    ...
    {
      lexicon_macros.$nl_trie_accessor_default_case_sensitivity$.bind( $kw23$OFF, thread );
      add_theP = makeBoolean( NIL != lexicon_accessors.speech_partP( $const43$Noun, UNPROVIDED ) && NIL != list_utilities.lengthG( raw_key, ONE_INTEGER, UNPROVIDED ) && NIL != string_is_non_name_nounP( list_utilities
          .last_one( raw_key ), entry_mt ) && NIL != lexicon_utilities.lexical_assertion_of_lexiconP( $const44$EnglishLexiconMt, entry, entry_mt ) && NIL != nl_trie_name_pred_ok_for_adding_theP( nl_trie_name_pred(
              entry ), entry_mt ) && NIL != nl_trie_name_denot_ok_for_adding_theP( nl_trie_name_denot( entry ), entry_mt ) );
    }
    finally
    {
      lexicon_macros.$nl_trie_accessor_default_case_sensitivity$.rebind( _prev_bind_0, thread );
  ...
  public static SubLObject string_is_non_name_nounP(final SubLObject string, SubLObject mt)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject noun_preds = Values.nth_value_step_2( Values.nth_value_step_1( ONE_INTEGER ), lexicon_accessors.words_of_stringXspeech_part( string, $const43$Noun, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    ...
    try
    {
      ...
      noun_preds = Sequences.remove( $const45$properNounStrings, noun_preds, $sym46$SPEC_PREDICATE_, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
  ...
  {
    return ask_utilities.ask_variable( $sym48$_COLLECTION, $list49, hlmt_czer.canonicalize_hlmt( el_utilities.make_binary_formula( $const50$MtUnionFn, $const51$EnglishMt, mt ) ), UNPROVIDED, UNPROVIDED, UNPROVIDED,
        UNPROVIDED );
  }
  ...
  public static SubLObject nl_trie_dont_add_the_categories(final SubLObject mt)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym47$NL_TRIE_DONT_ADD_THE_CATEGORIES, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym47$NL_TRIE_DONT_ADD_THE_CATEGORIES, ONE_INTEGER, NIL, EQL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym47$NL_TRIE_DONT_ADD_THE_CATEGORIES, caching_state );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, mt, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_dont_add_the_categories_internal( mt ) ) );
  ...
  public static SubLObject nl_trie_name_denot_ok_for_adding_theP(final SubLObject name_denot, final SubLObject mt)
  {
    ...
    if( NIL == badP )
    {
      ...
      SubLObject category;
      for( csome_list_var = nl_trie_dont_add_the_categories( mt ), category = NIL, category = csome_list_var.first(); NIL == badP && NIL != csome_list_var; badP = isa.isa_in_any_mtP( name_denot,
          category ), csome_list_var = csome_list_var.rest(), category = csome_list_var.first() )
      {
      }
    }
  ...
  public static SubLObject nl_trie_dont_add_the_terms(final SubLObject mt)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym52$NL_TRIE_DONT_ADD_THE_TERMS, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym52$NL_TRIE_DONT_ADD_THE_TERMS, ONE_INTEGER, NIL, EQL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym52$NL_TRIE_DONT_ADD_THE_TERMS, caching_state );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, mt, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_dont_add_the_terms_internal( mt ) ) );
      memoization_state.caching_state_put( caching_state, mt, results, UNPROVIDED );
    }
    return memoization_state.caching_results( results );
  }
  ...
  {
    return makeBoolean( NIL == cyc_kernel.closed_query_success_result_p( inference_kernel.new_cyc_query( ConsesLow.list( $const56$dontAddTheToNamesWithPred, name_pred ), hlmt_czer.canonicalize_hlmt( el_utilities
        .make_binary_formula( $const50$MtUnionFn, $const51$EnglishMt, mt ) ), UNPROVIDED ) ) );
  }
  ...
  public static SubLObject nl_trie_name_pred_ok_for_adding_theP(final SubLObject name_pred, final SubLObject mt)
  {
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_name_pred_ok_for_adding_theP_internal( name_pred, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( name_pred, mt ) );
  ...
  public static SubLObject nl_trie_entry_pos(final SubLObject entry)
  {
    ...
    if( NIL != nl_trie_term_phrases_entry_p( entry, T ) )
    {
      ...
      return ( NIL != lexicon_accessors.speech_partP( constraint, UNPROVIDED ) ) ? constraint
          : ( ( NIL != lexicon_accessors.speech_part_predP( constraint, UNPROVIDED ) ) ? lexicon_accessors.pos_of_pred( constraint ) : NIL );
    }
    if( NIL != nl_trie_word_p( entry, UNPROVIDED ) )
    {
    ...
    if( NIL != nl_trie_lex_entry_p( entry, UNPROVIDED ) )
    {
      return nl_trie_lex_entry_get( entry, $kw57$CYC_POS );
    }
    return NIL;
  }
  ...
  public static SubLObject nl_trie_entry_pos_preds(final SubLObject entry)
  {
    ...
    {
      final SubLObject constraint = assertions_high.gaf_arg2( entry );
      return ( NIL != lexicon_accessors.speech_part_predP( constraint, UNPROVIDED ) ) ? ConsesLow.list( constraint )
          : ( ( NIL != lexicon_accessors.speech_partP( constraint, UNPROVIDED ) ) ? lexicon_accessors.max_preds_of_pos( constraint ) : NIL );
    }
    if( NIL != nl_trie_word_p( entry, UNPROVIDED ) )
    {
    ...
    if( NIL != nl_trie_lex_entry_p( entry, UNPROVIDED ) )
    {
      return ConsesLow.list( nl_trie_lex_entry_get( entry, $kw58$PREDICATE ) );
    }
    return NIL;
  }
  ...
  public static SubLObject nl_trie_entry_denots(final SubLObject entry)
  {
    if( NIL != nl_trie_name_p( entry, T ) )
    {
      return ConsesLow.list( nl_trie_name_denot( entry ) );
    }
    if( NIL != nl_trie_term_phrases_entry_p( entry, T ) )
    {
      return ConsesLow.list( assertions_high.gaf_arg1( entry ) );
    }
    if( NIL != nl_trie_word_p( entry, UNPROVIDED ) )
    {
    ...
    if( NIL != nl_trie_lex_entry_p( entry, UNPROVIDED ) )
    {
      return nl_trie_lex_entry_get( entry, $kw59$DENOTS );
    }
    return NIL;
  }
  ...
  public static SubLObject do_nl_trie_entry_denots(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.listS( $sym61$PCOND, ConsesLow.list( ConsesLow.listS( $sym38$NL_TRIE_NAME_P, entry, $list62 ), ConsesLow.listS( $sym29$CLET, ConsesLow.list( ConsesLow.list( denot, ConsesLow.list(
          $sym63$NL_TRIE_NAME_DENOT, entry ) ) ), ConsesLow.append( body, NIL ) ) ), ConsesLow.list( ConsesLow.listS( $sym64$NL_TRIE_TERM_PHRASES_ENTRY_P, entry, $list62 ), ConsesLow.listS( $sym29$CLET, ConsesLow.list(
              ConsesLow.list( denot, ConsesLow.list( $sym65$GAF_ARG1, entry ) ) ), ConsesLow.append( body, NIL ) ) ), ConsesLow.list( ConsesLow.list( $sym66$NL_TRIE_WORD_P, entry ), ConsesLow.listS(
                  $sym67$DO_NL_TRIE_WORD_DENOTS, ConsesLow.list( denot, entry ), ConsesLow.append( body, NIL ) ) ), ConsesLow.append( ( NIL != subl_promotions.memberP( $kw68$CYC_SUBLOOP, reader.$features$
                      .getDynamicValue( thread ), UNPROVIDED, UNPROVIDED ) && NIL != conses_high.member( $kw69$CYC_NL, reader.$features$.getDynamicValue( thread ), UNPROVIDED, UNPROVIDED ) ) ? ConsesLow.list( ConsesLow
                          .list( ConsesLow.list( $sym70$LEX_ENTRY_P, entry ), ConsesLow.listS( $sym35$CDOLIST, ConsesLow.list( denot, ConsesLow.listS( $sym71$NL_TRIE_LEX_ENTRY_GET, entry, $list72 ) ), ConsesLow.append(
                              body, NIL ) ) ) ) : NIL, NIL ) );
    }
  ...
  public static SubLObject do_nl_trie_entry_strings(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.listS( $sym61$PCOND, ConsesLow.list( ConsesLow.listS( $sym38$NL_TRIE_NAME_P, entry, $list62 ), ConsesLow.listS( $sym29$CLET, ConsesLow.list( ConsesLow.list( string, ConsesLow.list(
          $sym74$NL_TRIE_NAME_STRING_MACRO_HELPER, entry ) ) ), ConsesLow.append( body, NIL ) ) ), ConsesLow.list( ConsesLow.listS( $sym64$NL_TRIE_TERM_PHRASES_ENTRY_P, entry, $list62 ), ConsesLow.listS( $sym29$CLET,
              ConsesLow.list( ConsesLow.list( string, ConsesLow.list( $sym75$GAF_ARG3, entry ) ) ), ConsesLow.append( body, NIL ) ) ), ConsesLow.list( ConsesLow.list( $sym66$NL_TRIE_WORD_P, entry ), ConsesLow.listS(
                  $sym76$DO_NL_TRIE_WORD_STRINGS, ConsesLow.list( string, entry ), ConsesLow.append( body, NIL ) ) ), ConsesLow.append( ( NIL != subl_promotions.memberP( $kw68$CYC_SUBLOOP, reader.$features$
                      .getDynamicValue( thread ), UNPROVIDED, UNPROVIDED ) && NIL != conses_high.member( $kw69$CYC_NL, reader.$features$.getDynamicValue( thread ), UNPROVIDED, UNPROVIDED ) ) ? ConsesLow.list( ConsesLow
                          .list( ConsesLow.list( $sym70$LEX_ENTRY_P, entry ), ConsesLow.listS( $sym29$CLET, ConsesLow.list( ConsesLow.list( string, ConsesLow.listS( $sym71$NL_TRIE_LEX_ENTRY_GET, entry, $list77 ) ) ),
                              ConsesLow.append( body, NIL ) ) ) ) : NIL, NIL ) );
    }
  ...
  public static SubLObject do_nl_trie_word_syntactic_supports(final SubLObject macroform, final SubLObject environment)
  {
    ...
    while ( NIL != rest)
    {
      ...
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, $list79 );
      if( NIL == conses_high.member( current_$2, $list80, UNPROVIDED, UNPROVIDED ) )
      {
        bad = T;
      }
      if( current_$2 == $kw81$ALLOW_OTHER_KEYS )
      {
    ...
    final SubLObject done_tail = cdestructuring_bind.property_list_member( $kw82$DONE, current );
    final SubLObject done = ( NIL != done_tail ) ? conses_high.cadr( done_tail ) : NIL;
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( $sym83$DO_SET, ConsesLow.list( support, ConsesLow.list( $sym84$NL_TRIE_WORD_SYNTACTIC_SUPPORT_SET, word ), $kw82$DONE, done ), ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject do_nl_trie_word_semantic_supports(final SubLObject macroform, final SubLObject environment)
  {
    ...
    while ( NIL != rest)
    {
      ...
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, $list79 );
      if( NIL == conses_high.member( current_$3, $list80, UNPROVIDED, UNPROVIDED ) )
      {
        bad = T;
      }
      if( current_$3 == $kw81$ALLOW_OTHER_KEYS )
      {
        allow_other_keys_p = rest.first();
      }
      rest = rest.rest();
    ...
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( $sym83$DO_SET, ConsesLow.list( support, ConsesLow.list( $sym85$NL_TRIE_WORD_SEMANTIC_SUPPORT_SET, word ), $kw82$DONE, done ), ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject nl_trie_entry_semantic_pred(final SubLObject entry, SubLObject use_abbrev_predP)
  {
    ...
    if( NIL != nl_trie_lex_entry_p( entry, UNPROVIDED ) )
    {
      return nl_trie_lex_entry_get( entry, $kw58$PREDICATE );
    }
    return NIL;
  }
  ...
  public static SubLObject nl_trie_entry_mt(final SubLObject entry)
  {
    ...
    if( NIL != nl_trie_lex_entry_p( entry, UNPROVIDED ) )
    {
      return nl_trie_lex_entry_get( entry, $kw86$MT );
    }
    return NIL;
  }
  ...
  public static SubLObject nl_trie_delete_entry(final SubLObject v_nl_trie, final SubLObject key0, final SubLObject entry)
  {
    ...
    else if( NIL != nl_trie_name_p( entry, UNPROVIDED ) )
    {
      nl_trie_delete_name( v_nl_trie, key, entry );
    }
    else if( NIL != nl_trie_entry_p( entry ) )
    {
  ...
  public static SubLObject nl_trie_entry_pragmatics(final SubLObject entry)
  {
    ...
    if( NIL != nl_trie_lex_entry_p( entry, UNPROVIDED ) )
    {
      return nl_trie_lex_entry_get( entry, $kw87$PRAGMATICS );
    }
    return NIL;
  }
  ...
  {
    assert NIL != nl_trie_entry_p( nl_trie_entry ) : nl_trie_entry;
    ...
    while ( NIL != cdolist_list_var)
    {
      final SubLObject java_item = ConsesLow.list( ConsesLow.list( string, ConsesLow.list( pph_utilities.new_pph_javalist_item( string, denot, NIL, NIL, NIL, ZERO_INTEGER ) ) ), denot );
      SubLObject cdolist_list_var_$4;
      final SubLObject java_list = cdolist_list_var_$4 = ConsesLow.list( java_item );
      SubLObject java_list_item = NIL;
      java_list_item = cdolist_list_var_$4.first();
      while ( NIL != cdolist_list_var_$4)
      {
        javalists = ConsesLow.cons( java_list_item, javalists );
    ...
    javalists = Sequences.delete_duplicates( javalists, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject has_bad_syntactic_support_p(final SubLObject word)
  {
    ...
    SubLObject state;
    SubLObject support;
    for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object, set_contents_var ); NIL == badP && NIL == set_contents
  ...
  public static SubLObject validate_nl_trie_word(final SubLObject word, SubLObject robustP)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      {
        bad_syntactic_supports = ConsesLow.cons( syntactic_support, bad_syntactic_supports );
      }
    }
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      {
        bad_semantic_supports = ConsesLow.cons( semantic_support, bad_semantic_supports );
      }
    }
  ...
  {
    return makeBoolean( NIL != nl_trie_word_struc_p( word ) && NIL != nl_trie_word_valid_syntactic_support_set_p( nl_trie_word_syntactic_support_set( word ) ) && NIL != nl_trie_word_valid_semantic_support_set_p(
        nl_trie_word_semantic_support_set( word ) ) );
  }
  ...
  public static SubLObject nl_trie_word_struc_valid_p(final SubLObject word)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym91$NL_TRIE_WORD_STRUC_VALID_P, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym91$NL_TRIE_WORD_STRUC_VALID_P, ONE_INTEGER, $int17$200, EQL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym91$NL_TRIE_WORD_STRUC_VALID_P, caching_state );
    }
    ...
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_word_struc_valid_p_internal( word ) ) );
  ...
  public static SubLObject nl_trie_valid_assertionP_memoized(final SubLObject assertion, SubLObject robustP)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym92$NL_TRIE_VALID_ASSERTION__MEMOIZED, TWO_INTEGER, $int93$500, EQL, UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_valid_assertionP_memoized_internal( assertion, robustP ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( assertion, robustP ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject nl_trie_word_hl_syntactic_support_p(final SubLObject v_object, SubLObject robustP)
  {
    ...
    return makeBoolean( v_object.isCons() && NIL != el_utilities.el_formula_p( v_object.first() ) && ( NIL == robustP || NIL == list_utilities.tree_find_if( $sym94$INVALID_FORT_, v_object, UNPROVIDED ) ) && NIL != hlmt
        .hlmt_p( v_object.rest() ) );
  }
  ...
  public static SubLObject nl_trie_justify_hl_syntactic_support(final SubLObject support)
  {
    ...
    SubLObject mt = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( support, support, $list95 );
    ...
    try
    {
      ...
      if( NIL != el_utilities.formula_arityE( sentence, TWO_INTEGER, UNPROVIDED ) )
      {
        ...
        SubLObject word = NIL;
        SubLObject string = NIL;
        cdestructuring_bind.destructuring_bind_must_consp( current_$6, datum_$5, $list96 );
        ...
        if( NIL == current_$6 )
        {
          if( NIL == meta_supports )
          {
            ...
            while ( NIL == meta_supports && NIL != csome_list_var)
            {
              ...
              cdestructuring_bind.destructuring_bind_must_consp( current_$7, datum_$6, $list97 );
        ...
        {
          cdestructuring_bind.cdestructuring_bind_error( datum_$5, $list96 );
        }
      }
    }
    finally
  ...
  {
    return makeBoolean( v_object.isVector() && ( NIL == Vectors.aref( v_object, ONE_INTEGER ) || NIL != hlmt.hlmt_p( Vectors.aref( v_object, ONE_INTEGER ) ) ) );
  }
  ...
  public static SubLObject valid_nl_trie_word_hl_semantic_support_p(final SubLObject v_object, SubLObject robustP)
  {
    ...
    return makeBoolean( v_object.isVector() && NIL != set.set_p( Vectors.aref( v_object, ZERO_INTEGER ) ) && $nl_trie_denot_set_test$.getGlobalValue().eql( set.set_test( Vectors.aref( v_object, ZERO_INTEGER ) ) )
        && ( NIL == Vectors.aref( v_object, ONE_INTEGER ) || NIL != hlmt.hlmt_p( Vectors.aref( v_object, ONE_INTEGER ) ) ) && ( NIL == robustP || NIL != valid_nl_trie_word_denot_set_p( Vectors.aref( v_object,
            ZERO_INTEGER ) ) ) );
  }
  ...
  public static SubLObject validate_nl_trie_word_hl_semantic_support(final SubLObject v_object, SubLObject robustP)
  {
    ...
    return makeBoolean( v_object.isVector() && NIL != set.set_p( Vectors.aref( v_object, ZERO_INTEGER ) ) && $nl_trie_denot_set_test$.getGlobalValue().eql( set.set_test( Vectors.aref( v_object, ZERO_INTEGER ) ) )
        && ( NIL == Vectors.aref( v_object, ONE_INTEGER ) || NIL != hlmt.hlmt_p( Vectors.aref( v_object, ONE_INTEGER ) ) ) && ( NIL == robustP || NIL != validate_nl_trie_word_denot_set( Vectors.aref( v_object,
            ZERO_INTEGER ) ) ) );
  }
  ...
  public static SubLObject invalid_nl_trie_word_denotP(final SubLObject denot)
  {
    ...
    if( NIL == badP )
    {
      ...
      {
        if( NIL != Functions.funcall( test, denot ) )
        {
          badP = T;
        }
        csome_list_var = csome_list_var.rest();
    ...
    if( entries.isList() && NIL == matching_syn_support )
    {
      ...
      while ( NIL == matching_syn_support && NIL != csome_list_var)
      {
        if( NIL != nl_trie_word_p( entry, UNPROVIDED ) && mt.eql( nl_trie_word_syntax_mt( entry ) ) )
        {
          ...
          for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object, set_contents_var ); NIL == matching_syn_support
  ...
  {
    return ConsesLow.cons( sentence, mt );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != set.set_p( denots ) : denots;
  ...
  {
    final SubLObject support = Vectors.make_vector( TWO_INTEGER, UNPROVIDED );
    nl_trie_word_hl_semantic_support_set_denots( support, denots );
    Vectors.set_aref( support, ONE_INTEGER, mt );
    return support;
  }
  ...
  public static SubLObject nl_trie_word_support_mt(final SubLObject support)
  {
    ...
    if( NIL != nl_trie_word_hl_semantic_support_p( support ) )
    {
      return Vectors.aref( support, ONE_INTEGER );
    }
    return NIL;
  }
  ...
  {
    return ( v_object.getClass() == $nl_trie_word_struc_native.class ) ? T : NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/nl-trie.lisp", position = 32752L)
  public static SubLObject nl_trie_word_struc_syntactic_supports(final SubLObject v_object)
  {
    assert NIL != nl_trie_word_struc_p( v_object ) : v_object;
  ...
  public static SubLObject make_nl_trie_word_struc(SubLObject arglist)
  {
    ...
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      if( pcase_var.eql( $kw120$SYNTACTIC_SUPPORTS ) )
      {
        _csetf_nl_trie_word_struc_syntactic_supports( v_new, current_value );
      }
      else if( pcase_var.eql( $kw121$SEMANTIC_SUPPORTS ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw123$BEGIN, $sym124$MAKE_NL_TRIE_WORD_STRUC, TWO_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw125$SLOT, $kw120$SYNTACTIC_SUPPORTS, nl_trie_word_struc_syntactic_supports( obj ) );
    Functions.funcall( visitor_fn, obj, $kw125$SLOT, $kw121$SEMANTIC_SUPPORTS, nl_trie_word_struc_semantic_supports( obj ) );
    Functions.funcall( visitor_fn, obj, $kw126$END, $sym124$MAKE_NL_TRIE_WORD_STRUC, TWO_INTEGER );
    return obj;
  }
  ...
  {
    return Numbers.logxor( new SubLObject[] { $int128$509, Sxhash.sxhash( nl_trie_word_struc_syntactic_supports( v_object ) ), Sxhash.sxhash( nl_trie_word_struc_semantic_supports( v_object ) )
    } );
  }
  ...
  {
    print_high.princ( $str130$_NL_TRIE_WORD, stream );
    SubLObject set_var = nl_trie_word_syntactic_support_set( word );
    SubLObject set_contents_var = set.do_set_internal( set_var );
    SubLObject basis_object;
    SubLObject state;
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, support ) )
      {
        PrintLow.format( stream, $str131$____S, support );
      }
    }
    set_var = nl_trie_word_semantic_support_set( word );
    set_contents_var = set.do_set_internal( set_var );
    ...
    print_high.princ( $str132$_, stream );
    return word;
  }
  ...
  {
    cfasl.cfasl_raw_write_byte( $cfasl_opcode_nl_trie_word_struc$.getGlobalValue(), stream );
  ...
  {
    return makeBoolean( NIL != set.set_p( v_object ) && set.set_test( v_object ).eql( $nl_trie_word_semantic_support_set_test$.getGlobalValue() ) && NIL == set_utilities.set_find_if_not(
        $sym136$NL_TRIE_VALID_SEMANTIC_SUPPORT_P, v_object, UNPROVIDED ) );
  }
  ...
  {
    return makeBoolean( NIL != set.set_p( v_object ) && set.set_test( v_object ).eql( $nl_trie_word_syntactic_support_set_test$.getGlobalValue() ) && NIL == set_utilities.set_find_if_not(
        $sym137$NL_TRIE_SYNTACTIC_SUPPORT_P, v_object, UNPROVIDED ) );
  }
  ...
  public static SubLObject new_nl_trie_word(final SubLObject syntactic_supports, SubLObject semantic_supports)
  {
    ...
    assert NIL != nl_trie_word_valid_syntactic_support_set_p( syntactic_supports ) : syntactic_supports;
    assert NIL != nl_trie_word_valid_semantic_support_set_p( semantic_supports ) : semantic_supports;
    return make_nl_trie_word_struc( ConsesLow.list( $kw120$SYNTACTIC_SUPPORTS, syntactic_supports, $kw121$SEMANTIC_SUPPORTS, semantic_supports ) );
  }
  ...
  {
    assert NIL != nl_trie_word_struc_p( word ) : word;
    assert NIL != nl_trie_word_valid_syntactic_support_set_p( syn_supports ) : syn_supports;
  ...
  {
    assert NIL != nl_trie_word_struc_p( word ) : word;
    assert NIL != nl_trie_word_valid_semantic_support_set_p( sem_supports ) : sem_supports;
  ...
  {
    return makeBoolean( $const140$partOfSpeech.eql( obj ) || NIL != lexicon_accessors.speech_part_predP( obj, UNPROVIDED ) || NIL != nl_trie_abbreviation_pred_p( obj ) );
  }
  ...
  public static SubLObject nl_trie_word_arbitrary_syntactic_support(final SubLObject word)
  {
    ...
    while ( NIL == doneP)
    {
      ...
      else if( NIL != valid_nl_trie_word_syntactic_support_p( support ) )
      {
        doneP = T;
      }
      else if( NIL != support )
  ...
  public static SubLObject nl_trie_word_arbitrary_semantic_support(final SubLObject word)
  {
    ...
    while ( NIL == doneP)
    {
      ...
      else if( NIL != valid_nl_trie_word_semantic_support_p( support ) )
      {
        doneP = T;
      }
      else if( NIL != support )
  ...
  public static SubLObject nl_trie_word_has_syntactic_support_p(final SubLObject word, final SubLObject support, SubLObject strictP)
  {
        ...
        && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, existing_support ) && nl_trie_word_support_sentence( existing_support ).equal( support_sentence ) && nl_trie_word_support_mt( existing_support ).equal(
          support_mt ) )
      {
        foundP = T;
      }
  ...
  public static SubLObject nl_trie_word_add_syntactic_support(final SubLObject word, final SubLObject support, SubLObject check_for_impliedP)
  {
    ...
    assert NIL != nl_trie_word_p( word, UNPROVIDED ) : word;
    return ( NIL != newP ) ? $kw145$ADDED : $kw146$ALREADY_PRESENT;
  }
  ...
  public static SubLObject nl_trie_word_remove_implied_hl_syntactic_supports(final SubLObject word)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, support ) && NIL != nl_trie_word_hl_syntactic_support_p( support, UNPROVIDED ) )
      {
        ...
        if( NIL == not_implied )
        {
          ...
          while ( NIL == not_implied && NIL != csome_list_var)
          {
            ...
            for( basis_object_$10 = set_contents.do_set_contents_basis_object( set_contents_var_$9 ), state_$11 = NIL, state_$11 = set_contents.do_set_contents_initial_state( basis_object_$10,
                set_contents_var_$9 ); NIL == implied_by && NIL == set_contents.do_set_contents_doneP( basis_object_$10, state_$11 ); state_$11 = set_contents.do_set_contents_update_state( state_$11 ) )
            {
              existing_support = set_contents.do_set_contents_next( basis_object_$10, state_$11 );
              if( NIL != set_contents.do_set_contents_element_validP( state_$11, existing_support ) && !existing_support.eql( support ) && NIL != lexicon_accessors.genl_pos_predP( nl_trie_word_support_predicate(
                  existing_support ), pred, UNPROVIDED ) )
              {
        ...
        if( NIL == not_implied )
        {
          implied_supports = ConsesLow.cons( support, implied_supports );
        }
      }
    }
  ...
  public static SubLObject nl_trie_word_remove_syntactic_support(final SubLObject word, final SubLObject support)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      {
        matching_supports = ConsesLow.cons( existing_support, matching_supports );
      }
    }
    ...
    assert NIL != nl_trie_word_p( word, UNPROVIDED ) : word;
    return ( NIL != was_thereP ) ? $kw147$REMOVED : $kw148$NOT_FOUND;
  }
  ...
  public static SubLObject nl_trie_word_add_semantic_support(final SubLObject word, final SubLObject support)
  {
    ...
    if( NIL != nl_trie_word_spliceable_semantic_support_p( support ) )
    {
      ...
      SubLObject denot;
      for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object, set_contents_var ); NIL == splicedP
          && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        existing_support = set_contents.do_set_contents_next( basis_object, state );
        if( NIL != set_contents.do_set_contents_element_validP( state, existing_support ) && NIL != nl_trie_word_hl_semantic_supports_unifiable_p( existing_support, support ) )
        {
          ...
          for( basis_object_$14 = set_contents.do_set_contents_basis_object( set_contents_var_$13 ), state_$15 = NIL, state_$15 = set_contents.do_set_contents_initial_state( basis_object_$14,
              set_contents_var_$13 ); NIL == set_contents.do_set_contents_doneP( basis_object_$14, state_$15 ); state_$15 = set_contents.do_set_contents_update_state( state_$15 ) )
          {
  ...
  {
    return Vectors.aref( support, ZERO_INTEGER );
  }
  ...
  {
    assert NIL != set.set_p( denots ) : denots;
    Vectors.set_aref( support, ZERO_INTEGER, denots );
    return support;
  }
  ...
  public static SubLObject nl_trie_word_semantic_support_denots_internal(final SubLObject support, SubLObject denot_arg)
  {
    ...
    if( NIL != nl_trie_valid_assertionP( support ) )
    {
      ...
      if( denot_arg.isInteger() )
      {
        ...
        return ( NIL != okP ) ? ConsesLow.list( ConsesLow.nth( denot_arg, terms ) ) : NIL;
      }
    }
    else if( NIL != nl_trie_word_hl_semantic_support_p( support ) )
    {
  ...
  public static SubLObject nl_trie_word_semantic_support_denots(final SubLObject support, SubLObject denot_arg)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym149$NL_TRIE_WORD_SEMANTIC_SUPPORT_DENOTS, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym149$NL_TRIE_WORD_SEMANTIC_SUPPORT_DENOTS, TWO_INTEGER, NIL, EQUALP, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym149$NL_TRIE_WORD_SEMANTIC_SUPPORT_DENOTS, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_word_semantic_support_denots_internal( support, denot_arg ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( support, denot_arg ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject nl_trie_word_semantic_support_semtrans_templates_internal(final SubLObject support, SubLObject semtrans_template_arg)
  {
    ...
    if( NIL != nl_trie_valid_assertionP( support ) )
    {
      return ( NIL != assertions_high.gaf_assertionP( support ) ) ? ConsesLow.list( lexicon_accessors.semtrans_template_from_assertion( support, semtrans_template_arg ) ) : NIL;
    }
    return NIL;
  }
  ...
  public static SubLObject nl_trie_word_semantic_support_semtrans_templates(final SubLObject support, SubLObject semtrans_template_arg)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym151$NL_TRIE_WORD_SEMANTIC_SUPPORT_SEMTRANS_TEMPLATES, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym151$NL_TRIE_WORD_SEMANTIC_SUPPORT_SEMTRANS_TEMPLATES, TWO_INTEGER, NIL, EQUALP,
          UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym151$NL_TRIE_WORD_SEMANTIC_SUPPORT_SEMTRANS_TEMPLATES, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_word_semantic_support_semtrans_templates_internal( support, semtrans_template_arg ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( support, semtrans_template_arg ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject nl_trie_word_remove_semantic_support(final SubLObject word, final SubLObject support)
  {
    ...
    return ( NIL != was_thereP ) ? word : $kw148$NOT_FOUND;
  }
  ...
  public static SubLObject remove_nl_trie_closed_class_pos_preds(final SubLObject pos, SubLObject mt)
  {
    ...
    return memoization_state.caching_state_remove_function_results_with_args( $nl_trie_closed_class_pos_preds_caching_state$.getGlobalValue(), ConsesLow.list( pos, mt ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject nl_trie_closed_class_pos_preds_internal(final SubLObject pos, final SubLObject mt)
  {
    ...
    if( NIL == too_generalP )
    {
      ...
      final SubLObject deck_type = $kw156$STACK;
      ...
      try
      {
        ...
        try
        {
          ...
          try
          {
            ...
            final SubLObject tv_var = $const157$True_JustificationTruth;
            ...
            try
            {
              ...
              sbhl_search_vars.$relevant_sbhl_tv_function$.bind( ( NIL != tv_var ) ? $sym158$RELEVANT_SBHL_TV_IS_GENERAL_TV : sbhl_search_vars.$relevant_sbhl_tv_function$.getDynamicValue( thread ), thread );
              if( NIL != tv_var && NIL != sbhl_paranoia.sbhl_object_type_checking_p() && NIL == sbhl_search_vars.sbhl_true_tv_p( tv_var ) )
              {
                final SubLObject pcase_var = sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread );
                if( pcase_var.eql( $kw159$ERROR ) )
                {
                  sbhl_paranoia.sbhl_error( ONE_INTEGER, $str160$_A_is_not_a__A, tv_var, $sym161$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                }
                else if( pcase_var.eql( $kw162$CERROR ) )
                {
                  sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str163$continue_anyway, $str160$_A_is_not_a__A, tv_var, $sym161$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                }
                else if( pcase_var.eql( $kw164$WARN ) )
                {
                  Errors.warn( $str160$_A_is_not_a__A, tv_var, $sym161$SBHL_TRUE_TV_P );
                }
                else
                {
                  Errors.warn( $str165$_A_is_not_a_valid__sbhl_type_erro, sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread ) );
                  Errors.cerror( $str163$continue_anyway, $str160$_A_is_not_a__A, tv_var, $sym161$SBHL_TRUE_TV_P );
                }
              }
              ...
              try
              {
                sbhl_search_vars.$sbhl_search_module$.bind( sbhl_module_vars.get_sbhl_module( $const166$genls ), thread );
                sbhl_search_vars.$sbhl_search_module_type$.bind( sbhl_module_utilities.get_sbhl_module_type( sbhl_module_vars.get_sbhl_module( $const166$genls ) ), thread );
                sbhl_search_vars.$sbhl_add_node_to_result_test$.bind( sbhl_module_utilities.get_sbhl_add_node_to_result_test( sbhl_module_vars.get_sbhl_module( $const166$genls ) ), thread );
                sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                sbhl_module_vars.$sbhl_module$.bind( sbhl_module_vars.get_sbhl_module( $const166$genls ), thread );
                if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( pos, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                {
                  ...
                  try
                  {
                    ...
                    while ( NIL != node_var && NIL == too_generalP)
                    {
                      ...
                      else if( NIL != lexicon_accessors.genl_posP( genl_pos, $const167$ClosedClassWord, UNPROVIDED ) )
                      {
                      ...
                      final SubLObject accessible_modules = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_vars.get_sbhl_module( $const166$genls ) );
                      SubLObject rest;
                        ...
                        try
                        {
                          ...
                          if( NIL != sbhl_link_vars.sbhl_node_object_p( node ) )
                          {
                            ...
                            if( NIL != d_link )
                            {
                              ...
                              if( NIL != mt_links )
                              {
                                for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( mt_links ) ); NIL == too_generalP && NIL == dictionary_contents
                                    .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                {
                                  ...
                                  if( NIL != mt_relevance_macros.relevant_mtP( mt_$27 ) )
                                  {
                                    ...
                                    try
                                    {
                                      ...
                                      for( iteration_state_$29 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == too_generalP && NIL == dictionary_contents
                                          ...
                                          try
                                          {
                                            ...
                                            if( NIL != set.set_p( sol ) )
                                            {
                                              ...
                                              for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object,
                                                  set_contents_var ); NIL == too_generalP && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
                                              {
                              ...
                              try
                              {
                                ...
                                if( NIL != set.set_p( sol2 ) )
                                {
                                  ...
                                  for( basis_object2 = set_contents.do_set_contents_basis_object( set_contents_var2 ), state2 = NIL, state2 = set_contents.do_set_contents_initial_state( basis_object2,
                                      set_contents_var2 ); NIL == too_generalP && NIL == set_contents.do_set_contents_doneP( basis_object2, state2 ); state2 = set_contents.do_set_contents_update_state( state2 ) )
                                  {
                ...
                {
                  sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str170$Node__a_does_not_pass_sbhl_type_t, pos, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED, UNPROVIDED,
                      UNPROVIDED );
                }
              }
              finally
  ...
  public static SubLObject nl_trie_closed_class_pos_preds(final SubLObject pos, SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym153$NL_TRIE_CLOSED_CLASS_POS_PREDS, $sym171$_NL_TRIE_CLOSED_CLASS_POS_PREDS_CACHING_STATE_, $int172$64, EQL, TWO_INTEGER, ZERO_INTEGER );
      memoization_state.register_genls_dependent_cache_clear_callback( $sym173$CLEAR_NL_TRIE_CLOSED_CLASS_POS_PREDS );
    }
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( nl_trie_closed_class_pos_preds_internal( pos, mt ) ) );
  ...
  public static SubLObject nl_trie_const_arg_of_pred(final SubLObject pred)
  {
    ...
    if( pred.eql( $const174$abbreviationForLexicalWord ) )
    {
      return TWO_INTEGER;
    }
  ...
  {
    if( pred.eql( $const140$partOfSpeech ) )
    {
      return THREE_INTEGER;
    }
  ...
  public static SubLObject nl_trie_word_pos_internal(final SubLObject word)
  {
    ...
    final SubLObject sem_support = pred.eql( $const176$gerund ) ? NIL : set_utilities.set_find_if( $sym177$ASSERTION_P, nl_trie_word_semantic_support_set( word ), UNPROVIDED );
  ...
  public static SubLObject nl_trie_word_pos(final SubLObject word)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym175$NL_TRIE_WORD_POS, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym175$NL_TRIE_WORD_POS, ONE_INTEGER, $int178$1000, EQL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym175$NL_TRIE_WORD_POS, caching_state );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, word, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_word_pos_internal( word ) ) );
      memoization_state.caching_state_put( caching_state, word, results, UNPROVIDED );
    }
    return memoization_state.caching_results( results );
  }
  ...
  public static SubLObject do_nl_trie_word_denots(final SubLObject macroform, final SubLObject environment)
  {
    ...
    while ( NIL != rest)
    {
      ...
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, $list179 );
      if( NIL == conses_high.member( current_$34, $list180, UNPROVIDED, UNPROVIDED ) )
      {
        bad = T;
      }
      if( current_$34 == $kw81$ALLOW_OTHER_KEYS )
      {
        allow_other_keys_p = rest.first();
      }
      rest = rest.rest();
    ...
    final SubLObject preferred_onlyP_tail = cdestructuring_bind.property_list_member( $kw181$PREFERRED_ONLY_, current );
    final SubLObject preferred_onlyP = ( NIL != preferred_onlyP_tail ) ? conses_high.cadr( preferred_onlyP_tail ) : NIL;
    final SubLObject body;
    current = ( body = temp );
    ...
    return ConsesLow.list( $sym29$CLET, ConsesLow.list( ConsesLow.list( pred, ConsesLow.listS( $sym185$NL_TRIE_WORD_SEM_PRED, entry, $list7 ) ), ConsesLow.list( denot_arg, ConsesLow.list( $sym186$FWHEN, ConsesLow.list(
        $sym187$INDEXED_TERM_P, pred ), ConsesLow.list( $sym188$DENOTATUM_ARG_OF_PRED_CACHED, pred ) ) ) ), ConsesLow.list( $sym36$PWHEN, ConsesLow.list( $sym189$INTEGERP, denot_arg ), ConsesLow.list( $sym83$DO_SET,
            ConsesLow.list( semantic_support, ConsesLow.list( $sym85$NL_TRIE_WORD_SEMANTIC_SUPPORT_SET, entry ) ), ConsesLow.list( $sym36$PWHEN, ConsesLow.list( $sym190$FIMPLIES, preferred_onlyP, ConsesLow.list(
                $sym191$NL_TRIE_PREFERRED_SEMANTIC_SUPPORT_, semantic_support ) ), ConsesLow.listS( $sym35$CDOLIST, ConsesLow.list( denot, ConsesLow.list( $sym149$NL_TRIE_WORD_SEMANTIC_SUPPORT_DENOTS, semantic_support,
                    denot_arg ) ), ConsesLow.append( body, NIL ) ) ) ) ) );
  }
  ...
  public static SubLObject nl_trie_preferred_semantic_supportP(final SubLObject semantic_support)
  {
    ...
    else if( NIL != nl_trie_preferred_lexical_assertionP( semantic_support ) )
    {
      preferredP = T;
    }
    return preferredP;
  ...
  {
    return makeBoolean( NIL != assertions_high.gaf_assertionP( meta_assertion ) && NIL != genl_predicates.genl_predicateP( assertions_high.gaf_arg0( meta_assertion ), $const193$preferredLexification, UNPROVIDED,
        UNPROVIDED ) );
  }
  ...
  public static SubLObject do_nl_trie_word_semtrans_templates(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      ...
      return ConsesLow.list( $sym29$CLET, ConsesLow.list( ConsesLow.list( pred, ConsesLow.listS( $sym185$NL_TRIE_WORD_SEM_PRED, entry, $list7 ) ), ConsesLow.list( semtrans_template_arg, ConsesLow.list( $sym186$FWHEN,
          ConsesLow.list( $sym187$INDEXED_TERM_P, pred ), ConsesLow.list( $sym199$SEMTRANS_ARG_OF_PRED_CACHED, pred ) ) ), reader.bq_cons( invalid_supports, $list7 ) ), ConsesLow.list( $sym36$PWHEN, ConsesLow.list(
              $sym189$INTEGERP, semtrans_template_arg ), ConsesLow.list( $sym83$DO_SET, ConsesLow.list( semantic_support, ConsesLow.list( $sym85$NL_TRIE_WORD_SEMANTIC_SUPPORT_SET, entry ) ), ConsesLow.list( $sym200$PIF,
                  ConsesLow.list( $sym201$VALID_NL_TRIE_WORD_SEMANTIC_SUPPORT_P, semantic_support ), ConsesLow.listS( $sym35$CDOLIST, ConsesLow.list( semtrans_template, ConsesLow.list(
                      $sym151$NL_TRIE_WORD_SEMANTIC_SUPPORT_SEMTRANS_TEMPLATES, semantic_support, semtrans_template_arg ) ), ConsesLow.append( body, NIL ) ), ConsesLow.list( $sym202$CPUSH, semantic_support,
                          invalid_supports ) ) ), ConsesLow.list( $sym35$CDOLIST, ConsesLow.list( semantic_support, invalid_supports ), ConsesLow.list( $sym203$NL_TRIE_WORD_REMOVE_SEMANTIC_SUPPORT, entry,
                              semantic_support ) ) ) );
    }
  ...
  public static SubLObject do_nl_trie_word_strings(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      ...
      return ConsesLow.list( $sym29$CLET, ConsesLow.list( ConsesLow.list( head_string, ConsesLow.list( $sym209$NL_TRIE_WORD_HEAD_STRING_MACRO_HELPER, word_entry ) ) ), ConsesLow.list(
          $sym210$DO_NL_TRIE_WORD_SEMANTIC_SUPPORTS, ConsesLow.list( semantic_support, word_entry ), ConsesLow.listS( $sym29$CLET, ConsesLow.list( ConsesLow.list( leading_strings, ConsesLow.list(
              $sym211$NL_TRIE_WORD_LEADING_STRINGS_FROM_SUPPORT_MACRO_HELPER, semantic_support ) ), ConsesLow.list( following_strings, ConsesLow.list( $sym212$NL_TRIE_WORD_FOLLOWING_STRINGS_FROM_SUPPORT_MACRO_HELPER,
                  semantic_support ) ), ConsesLow.list( string, ConsesLow.list( $sym213$NL_TRIE_ASSEMBLE_STRINGS_MACRO_HELPER, leading_strings, head_string, following_strings ) ) ), ConsesLow.append( body, NIL ) ) ) );
    }
  ...
  public static SubLObject nl_trie_head_locations_in_lexical_string(final SubLObject v_cycl_string)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != nl_trie_word_p( entry, UNPROVIDED ) )
      {
        ...
        if( NIL != var )
        {
          locations = ConsesLow.cons( var, locations );
        }
      }
      cdolist_list_var = cdolist_list_var.rest();
      entry = cdolist_list_var.first();
    }
    return Sequences.remove_duplicates( locations, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
    ...
    if( denot_arg.isInteger() )
    {
          ...
          .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        if( NIL != set_contents.do_set_contents_element_validP( state, semantic_support ) )
        {
          ...
          while ( NIL != cdolist_list_var)
          {
            denots = ConsesLow.cons( denot, denots );
            cdolist_list_var = cdolist_list_var.rest();
            denot = cdolist_list_var.first();
          }
        }
  ...
  public static SubLObject nl_trie_word_semtrans_templates(final SubLObject word)
  {
    ...
    final SubLObject pred = nl_trie_word_sem_pred( word, NIL );
    final SubLObject semtrans_template_arg = ( NIL != kb_indexing_datastructures.indexed_term_p( pred ) ) ? lexicon_utilities.semtrans_arg_of_pred_cached( pred ) : NIL;
          ...
          .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        if( NIL != set_contents.do_set_contents_element_validP( state, semantic_support ) )
        {
          if( NIL != valid_nl_trie_word_semantic_support_p( semantic_support ) )
          {
            ...
            while ( NIL != cdolist_list_var)
            {
              semtrans_templates = ConsesLow.cons( semtrans_template, semtrans_templates );
              cdolist_list_var = cdolist_list_var.rest();
              semtrans_template = cdolist_list_var.first();
            }
          }
          ...
          {
            invalid_supports = ConsesLow.cons( semantic_support, invalid_supports );
          }
        }
      }
  ...
  {
    PrintLow.format( stream, $str214$__NL_TRIE_WORD_Word_unit______S__, nl_trie_word_word_unit( word, UNPROVIDED ) );
    PrintLow.format( stream, $str215$_______________POS____________S__, nl_trie_word_pos( word ) );
    PrintLow.format( stream, $str216$_______________POS_Preds______S__, nl_trie_word_pos_preds( word ) );
    PrintLow.format( stream, $str217$_______________Lexical_Pred___S__, nl_trie_entry_semantic_pred( word, UNPROVIDED ) );
    PrintLow.format( stream, $str218$_______________Denotations____S__, nl_trie_entry_denots( word ) );
    PrintLow.format( stream, $str219$_______________Pragmatics_____S__, nl_trie_entry_pragmatics( word ) );
    PrintLow.format( stream, $str220$_______________Microtheory____S__, nl_trie_entry_mt( word ) );
    return word;
  }
  ...
  {
    PrintLow.format( stream, $str221$__NL_TRIE_NAME_Namestring_Pred___, nl_trie_entry_semantic_pred( name, UNPROVIDED ) );
    PrintLow.format( stream, $str222$_______________Denotations_______, nl_trie_entry_denots( name ) );
    PrintLow.format( stream, $str223$_______________Pragmatics________, nl_trie_entry_pragmatics( name ) );
    PrintLow.format( stream, $str224$_______________Microtheory_______, nl_trie_entry_mt( name ) );
    return name;
  }
  ...
  public static SubLObject nl_trie_name_p(final SubLObject obj, SubLObject robustP)
  {
    ...
    return makeBoolean( NIL != nart_handles.nart_p( obj ) || ( NIL != assertion_handles.assertion_p( obj ) && NIL == nl_trie_term_phrases_entry_p( obj, NIL ) && ( NIL != lexicon_macros.assume_nl_trie_validP()
        || NIL == robustP || ( NIL != assertions_high.gaf_assertionP( obj ) && NIL != nl_trie_name_string_predP( assertions_high.gaf_arg0( obj ) ) ) ) ) );
  }
  ...
  public static SubLObject nl_trie_name_preferred_denots(final SubLObject name)
  {
    ...
    {
      return ConsesLow.list( nl_trie_name_denot( name ) );
    }
    return NIL;
  }
  ...
  public static SubLObject nl_trie_record_p(final SubLObject obj)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym227$NL_TRIE_RECORD_P, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym227$NL_TRIE_RECORD_P, ONE_INTEGER, NIL, EQUALP, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym227$NL_TRIE_RECORD_P, caching_state );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, obj, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_record_p_internal( obj ) ) );
      memoization_state.caching_state_put( caching_state, obj, results, UNPROVIDED );
    }
    return memoization_state.caching_results( results );
  }
  ...
  {
    assert NIL != valid_nl_trie_record_key_p( key ) : key;
    assert NIL != valid_nl_trie_record_entries_p( entries ) : entries;
    return ConsesLow.cons( unicode_nauts.convert_unicode_nauts_to_utf8_strings( key ), entries );
  }
  ...
  {
    assert NIL != nl_trie_record_p( record ) : record;
    return record.first();
  }
  ...
  {
    return makeBoolean( obj.isList() && NIL == list_utilities.find_if_not( $sym230$CYCL_STRING_P, obj, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  {
    return makeBoolean( obj.isList() && NIL == list_utilities.find_if_not( $sym88$NL_TRIE_ENTRY_P, obj, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject initializing_nl_trie(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.list( $sym29$CLET, ConsesLow.list( ConsesLow.list( $sym241$_NL_TRIES_BEING_INITIALIZED_, ConsesLow.listS( $sym242$CONS, v_nl_trie, $list243 ) ) ), ConsesLow.listS( $sym31$WITH_NL_TRIE_LOCK_HELD,
          $list244, ConsesLow.append( body, NIL ) ) );
    }
  ...
  public static SubLObject do_nl_trie(final SubLObject macroform, final SubLObject environment)
  {
    ...
    while ( NIL != rest)
    {
      ...
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, $list247 );
      if( NIL == conses_high.member( current_$35, $list80, UNPROVIDED, UNPROVIDED ) )
      {
        bad = T;
      }
      if( current_$35 == $kw81$ALLOW_OTHER_KEYS )
      {
        allow_other_keys_p = rest.first();
      }
      rest = rest.rest();
    ...
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.list( $sym31$WITH_NL_TRIE_LOCK_HELD, $list248, ConsesLow.list( $sym28$WITH_NL_TRIE_CACHE_STRATEGY, ConsesLow.listS( $sym249$DO_STRIE, ConsesLow.list( key, entries, $list250, $kw82$DONE, done ),
  ...
  public static SubLObject do_nl_trie_progress(final SubLObject macroform, final SubLObject environment)
  {
    ...
    while ( NIL != rest)
    {
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, $list251 );
      current_$36 = rest.first();
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, $list251 );
      if( NIL == conses_high.member( current_$36, $list252, UNPROVIDED, UNPROVIDED ) )
      {
        bad = T;
      }
      if( current_$36 == $kw81$ALLOW_OTHER_KEYS )
      {
        allow_other_keys_p = rest.first();
      }
      rest = rest.rest();
    ...
    final SubLObject done_tail = cdestructuring_bind.property_list_member( $kw82$DONE, current );
    final SubLObject done = ( NIL != done_tail ) ? conses_high.cadr( done_tail ) : NIL;
    final SubLObject progress_note_tail = cdestructuring_bind.property_list_member( $kw253$PROGRESS_NOTE, current );
    final SubLObject progress_note = ( NIL != progress_note_tail ) ? conses_high.cadr( progress_note_tail ) : $str254$Mapping_NL_trie___;
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.list( $sym31$WITH_NL_TRIE_LOCK_HELD, $list255, ConsesLow.list( $sym28$WITH_NL_TRIE_CACHE_STRATEGY, ConsesLow.listS( $sym33$DO_STRIE_PROGRESS, ConsesLow.list( key, entries, $list250, $kw82$DONE, done,
        $kw253$PROGRESS_NOTE, progress_note ), ConsesLow.append( body, NIL ) ) ) );
  }
  ...
  public static SubLObject nl_trie_entry_count(SubLObject string)
  {
    ...
    {
      final SubLObject entries = nl_trie_search( string, UNPROVIDED, UNPROVIDED );
      return entries.isList() ? Sequences.length( entries ) : ZERO_INTEGER;
    }
    SubLObject count = ZERO_INTEGER;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $nl_trie_lock$.getGlobalValue() );
      ...
      try
      {
        ...
        for( SubLObject done_var = NIL; NIL == done_var; done_var = makeBoolean( NIL == valid ) )
        {
          ...
          if( NIL != valid )
          {
            ...
            cdestructuring_bind.destructuring_bind_must_consp( current, datum, $list256 );
            ...
            {
              cdestructuring_bind.cdestructuring_bind_error( datum, $list256 );
            }
          }
        }
        while ( NIL == stacks.stack_empty_p( stack ))
        {
          ...
          for( SubLObject done_var2 = NIL; NIL == done_var2; done_var2 = makeBoolean( NIL == valid2 ) )
          {
            ...
            if( NIL != valid2 )
            {
              ...
              cdestructuring_bind.destructuring_bind_must_consp( current2, datum2, $list256 );
              ...
              {
                cdestructuring_bind.cdestructuring_bind_error( datum2, $list256 );
              }
            }
          }
        }
    ...
    finally
    {
      if( NIL != release )
      {
        Locks.release_lock( $nl_trie_lock$.getGlobalValue() );
      }
    }
    return count;
  }
    ...
    else
    {
      ...
      for( SubLObject done_var3 = NIL; NIL == done_var3; done_var3 = makeBoolean( NIL == valid3 ) )
      {
        ...
        if( NIL != valid3 )
        {
          ...
          cdestructuring_bind.destructuring_bind_must_consp( current3, datum3, $list256 );
          ...
          {
            cdestructuring_bind.cdestructuring_bind_error( datum3, $list256 );
          }
        }
      }
      while ( NIL == stacks.stack_empty_p( stack2 ))
      {
        ...
        for( SubLObject done_var4 = NIL; NIL == done_var4; done_var4 = makeBoolean( NIL == valid4 ) )
        {
          ...
          if( NIL != valid4 )
          {
            ...
            cdestructuring_bind.destructuring_bind_must_consp( current4, datum4, $list256 );
            ...
            {
              cdestructuring_bind.cdestructuring_bind_error( datum4, $list256 );
            }
          }
        }
      }
  ...
  public static SubLObject clear_nl_trie(SubLObject v_nl_trie)
  {
    ...
    if( $nl_trie$.getGlobalValue().eql( v_nl_trie ) )
    {
      ...
      try
      {
        ...
        {
          file_vector_utilities.$file_vector_backed_map_read_lock$.bind( $nl_trie_lock$.getGlobalValue(), thread );
          PrintLow.format( T, $str258$__Clearing_the_present_contents_o, v_nl_trie );
  ...
  public static SubLObject initialize_nl_trie(SubLObject v_nl_trie, SubLObject init_nl_trie_syntactic_predsP, SubLObject init_nl_trie_denot_predsP, SubLObject init_nl_trie_other_predsP,
      SubLObject init_nl_trie_pragmatic_predsP)
  {
    if( v_nl_trie == UNPROVIDED )
    {
      v_nl_trie = $nl_trie$.getGlobalValue();
    ...
    if( NIL != nl_trie_presentP( v_nl_trie ) )
    {
      ...
      try
      {
        lexicon_vars.$parse_morphologically$.bind( $kw260$NEVER, thread );
        $nl_tries_being_initialized$.bind( ConsesLow.cons( v_nl_trie, $nl_tries_being_initialized$.getDynamicValue( thread ) ), thread );
        SubLObject release = NIL;
        try
        {
          release = Locks.seize_lock( $nl_trie_lock$.getGlobalValue() );
  ...
  public static SubLObject nl_trie_case_sensitive_p(SubLObject v_nl_trie)
  {
    ...
    return Equality.eql( Symbols.symbol_function( EQUAL ), strie.strie_test( v_nl_trie ) );
  }
  ...
  {
    return nl_trie_search_int( string, v_nl_trie, $kw262$ON );
  }
  ...
  public static SubLObject nl_trie_search_case_sensitive(final SubLObject string, final SubLObject v_nl_trie)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym265$NL_TRIE_SEARCH_CASE_SENSITIVE, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym265$NL_TRIE_SEARCH_CASE_SENSITIVE, TWO_INTEGER, $int266$48, EQUAL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym265$NL_TRIE_SEARCH_CASE_SENSITIVE, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_search_case_sensitive_internal( string, v_nl_trie ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( string, v_nl_trie ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  {
    return nl_trie_search_int( string, v_nl_trie, $kw23$OFF );
  }
  ...
  public static SubLObject nl_trie_search_case_insensitive(final SubLObject string, final SubLObject v_nl_trie)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym267$NL_TRIE_SEARCH_CASE_INSENSITIVE, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym267$NL_TRIE_SEARCH_CASE_INSENSITIVE, TWO_INTEGER, $int266$48, EQUALP, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym267$NL_TRIE_SEARCH_CASE_INSENSITIVE, caching_state );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_2( string, v_nl_trie );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    if( !collisions.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_search_case_insensitive_internal( string, v_nl_trie ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( string, v_nl_trie ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  {
    return nl_trie_search_int( string, v_nl_trie, $kw263$PREFERRED );
  }
  ...
  public static SubLObject nl_trie_search_case_sensitive_preferred(final SubLObject string, final SubLObject v_nl_trie)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym268$NL_TRIE_SEARCH_CASE_SENSITIVE_PREFERRED, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym268$NL_TRIE_SEARCH_CASE_SENSITIVE_PREFERRED, TWO_INTEGER, $int266$48, EQUALP,
          UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym268$NL_TRIE_SEARCH_CASE_SENSITIVE_PREFERRED, caching_state );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_2( string, v_nl_trie );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    if( !collisions.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( nl_trie_search_case_sensitive_preferred_internal( string, v_nl_trie ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( string, v_nl_trie ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject nl_trie_search_int(final SubLObject string, SubLObject v_nl_trie, SubLObject case_sensitivity)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        else if( NIL != empty_nl_trieP( v_nl_trie ) )
        {
          nl_trie_warn( ONE_INTEGER, $str269$NL_Trie_empty_, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          ans = NIL;
        }
        else if( v_nl_trie.eql( $nl_trie$.getGlobalValue() ) && NIL != nl_trie_staleness_test.nl_trie_unfinishedP() && NIL == nl_trie_being_initializedP( $nl_trie$.getGlobalValue() ) )
        {
        ...
        else if( v_nl_trie.eql( $nl_trie$.getGlobalValue() ) && NIL == nl_trie_staleness_test.nl_trie_staleness_acceptableP() && NIL != nl_trie_staleness_test.nl_trie_revisions_staleP() )
        {
        ...
        else
        {
          ...
          while ( NIL != cdolist_list_var)
          {
            ans = conses_high.union( ans, ( NIL != key ) ? nl_trie_remove_invalid_entries( nl_trie_lookup( v_nl_trie, key, case_sensitivity ), v_nl_trie, key ) : NIL, EQUAL, UNPROVIDED );
            cdolist_list_var = cdolist_list_var.rest();
            key = cdolist_list_var.first();
          }
        }
  ...
  public static SubLObject augment_nl_trie_semantic(final SubLObject assertion, SubLObject v_nl_trie)
  {
    ...
    nl_trie_warn_bad_add( assertion );
    return Values.values( $kw272$NOT_ADDED, NIL );
  }
  ...
  public static SubLObject prune_nl_trie_semantic(final SubLObject assertion, SubLObject v_nl_trie)
  {
    ...
    nl_trie_warn_bad_remove( assertion );
    return Values.values( $kw273$NOT_REMOVED, NIL );
  }
  ...
  public static SubLObject retriefy_semantic_assertion(final SubLObject assertion, SubLObject v_nl_trie)
  {
    ...
    if( NIL != nl_trie_semantic_assertionP( assertion ) )
    {
      ...
      return $kw274$RETRIEFIED;
    }
    return $kw275$NOT_RETRIEFIED;
  }
  ...
  public static SubLObject nl_trie_carefully_load_global(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      ...
      return ConsesLow.list( $sym29$CLET, ConsesLow.list( ConsesLow.list( top, ConsesLow.listS( $sym278$CFASL_INPUT, stream, $list279 ) ) ), ConsesLow.list( $sym200$PIF, ConsesLow.list( $sym37$CAND, ConsesLow.list(
          $sym39$CNOT, ConsesLow.listS( EQ, top, $list280 ) ), ConsesLow.list( type, top ) ), ConsesLow.list( $sym281$CSETQ, global, top ), ConsesLow.list( $sym282$WARN, $str283$___S_is_not_the_right_type_of_obj, top,
              ConsesLow.list( $sym284$QUOTE, global ), ConsesLow.list( $sym284$QUOTE, type ) ) ) );
    }
  ...
  {
    final SubLObject top = cfasl.cfasl_input( stream, NIL, $kw285$EOF );
    if( top != $kw285$EOF && NIL != map_utilities.map_p( top ) )
    {
      $nl_trie$.setGlobalValue( top );
    }
    else
    {
      Errors.warn( $str283$___S_is_not_the_right_type_of_obj, top, $sym245$_NL_TRIE_, $sym286$MAP_P );
    }
    return stream;
  }
  ...
  {
    cfasl.cfasl_output( $nl_trie$.getGlobalValue(), stream );
    return stream;
  }
  ...
  public static SubLObject load_nl_trie_completion_index(final SubLObject stream)
  {
    ...
    {
      Errors.warn( $str283$___S_is_not_the_right_type_of_obj, top, $sym287$_NL_TRIE_COMPLETION_INDEX_, $sym286$MAP_P );
    }
    return stream;
  }
  ...
  {
    return hierarchical_visitor.new_hiearchical_visitor( $sym290$DUMP_SWAPPABLE_NL_TRIE_VISITOR_BEGIN_VISIT, $sym291$DUMP_SWAPPABLE_NL_TRIE_VISITOR_BEGIN_PATH, $sym292$DUMP_SWAPPABLE_NL_TRIE_VISITOR_ACCEPT_NODE,
        $sym293$DUMP_SWAPPABLE_NL_TRIE_VISITOR_END_PATH, $sym294$DUMP_SWAPPABLE_NL_TRIE_VISITOR_END_VISIT, v_context );
  }
  ...
  public static SubLObject dump_swappable_nl_trie_visitor_end_path(final SubLObject visitor, final SubLObject path)
  {
    ...
    final SubLObject modified_map = file_vector_utilities.convert_map_to_file_vector_backed_map( curr_map, fvector, $kw297$SWAPPED_OUT, $kw298$COMPACT );
    if( NIL == path )
    {
  ...
  public static SubLObject dump_swappable_nl_trie_visitor_accept_node(final SubLObject visitor, final SubLObject node)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( node, node, $list299 );
    map_key = node.first();
  ...
  {
    return list_utilities.make_plist( ConsesLow.list( $kw300$FILE_VECTOR, $kw301$MAP_STACK ), ConsesLow.list( fvector, stacks.create_stack() ) );
  }
  ...
  {
    return makeBoolean( NIL != list_utilities.property_list_p( v_context ) && NIL != file_vector.file_vector_p( conses_high.getf( v_context, $kw300$FILE_VECTOR, UNPROVIDED ) ) && NIL != stacks.stack_empty_p( conses_high
        .getf( v_context, $kw301$MAP_STACK, UNPROVIDED ) ) );
  }
  ...
  {
    return makeBoolean( NIL != list_utilities.property_list_p( v_context ) && NIL != file_vector.file_vector_p( conses_high.getf( v_context, $kw300$FILE_VECTOR, UNPROVIDED ) ) && ONE_INTEGER.numE( stacks.stack_size(
        conses_high.getf( v_context, $kw301$MAP_STACK, UNPROVIDED ) ) ) );
  }
  ...
  {
    final SubLObject map_stack = conses_high.getf( v_context, $kw301$MAP_STACK, UNPROVIDED );
  ...
  {
    return conses_high.getf( v_context, $kw300$FILE_VECTOR, UNPROVIDED );
  }
  ...
  public static SubLObject nl_trie_lookup(final SubLObject v_nl_trie, final SubLObject key0, SubLObject case_sensitivity)
  {
    ...
    if( NIL != nl_trie_case_sensitive_p( v_nl_trie ) || case_sensitivity.eql( $kw23$OFF ) )
    {
      return raw_entries;
    }
    if( case_sensitivity.eql( $kw262$ON ) )
    ...
    if( case_sensitivity == $kw263$PREFERRED )
    {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject str = $str303$Validating_all_NL_trie_entries;
  ...
  public static SubLObject nl_trie_remove_invalid_entries(final SubLObject raw_entries, final SubLObject v_nl_trie, final SubLObject key0)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == validP )
      {
        bad_entries = ConsesLow.cons( entry, bad_entries );
  ...
  {
    return conses_high.set_difference( raw_entries, bad_entries, UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject nl_trie_filter_entries_for_case(final SubLObject raw_entries, final SubLObject key0)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        good_entries = ConsesLow.cons( raw_entry, good_entries );
      }
      else
      {
        ...
        try
        {
          $nl_trie_entry_filter_stack$.bind( ConsesLow.cons( raw_entry, $nl_trie_entry_filter_stack$.getDynamicValue( thread ) ), thread );
  ...
  public static SubLObject nl_trie_entry_case_matches_keyP(final SubLObject entry, final SubLObject key0)
  {
    ...
    final SubLObject consider_adding_theP = Equality.equalp( key.first(), $english_definite_determiner$.getGlobalValue() );
    if( NIL == matchP )
    {
      SubLObject csome_list_var;
      SubLObject entry_key;
      for( csome_list_var = nl_trie_entry_keys( entry, consider_adding_theP ), entry_key = NIL, entry_key = csome_list_var.first(); NIL == matchP && NIL != csome_list_var; matchP = Equality.equal( entry_key,
          key ), csome_list_var = csome_list_var.rest(), entry_key = csome_list_var.first() )
      {
      }
    }
    return matchP;
  ...
  public static SubLObject initialize_nl_trie_syntactic_predicates()
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym53$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( $const54$EverythingPSC, thread );
      final SubLObject raw_preds = ConsesLow.cons( $const140$partOfSpeech, lexicon_accessors.all_speech_part_preds( $nl_trie_lexical_mt$.getGlobalValue() ) );
  ...
  public static SubLObject initialize_nl_trie_other_predicates()
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym53$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( $const54$EverythingPSC, thread );
      $nl_trie_abbreviation_predicates$.setGlobalValue( ConsesLow.cons( $const174$abbreviationForLexicalWord, nl_trie_multi_word_abbreviation_preds() ) );
      $nl_trie_arg_in_reln_predicates$.setGlobalValue( isa.all_fort_instances( $const309$DenotesArgInRelnPredicate, UNPROVIDED, UNPROVIDED ) );
      $nl_trie_semtrans_predicates$.setGlobalValue( isa.all_fort_instances( $const310$SemTransPred, UNPROVIDED, UNPROVIDED ) );
      $nl_trie_semtrans_predicates$.setGlobalValue( list_utilities.delete_if_not( $sym311$NL_TRIE_SEMTRANS_PRED_HAS_POS_SPECIFICATION_, $nl_trie_semtrans_predicates$.getGlobalValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED,
          UNPROVIDED ) );
    }
    finally
    {
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $nl_trie_multi_word_abbreviation_preds_caching_state$.getGlobalValue(), ConsesLow.list( EMPTY_SUBL_OBJECT_ARRAY ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/nl-trie.lisp", position = 98878L)
  public static SubLObject nl_trie_multi_word_abbreviation_preds_internal()
  {
    return isa.all_fort_instances_in_all_mts( $const313$MultiWordForStringPred );
  }
  ...
  public static SubLObject nl_trie_multi_word_abbreviation_preds()
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym312$NL_TRIE_MULTI_WORD_ABBREVIATION_PREDS, $sym314$_NL_TRIE_MULTI_WORD_ABBREVIATION_PREDS_CACHING_STATE_, NIL, EQL, ZERO_INTEGER,
          ZERO_INTEGER );
    }
    SubLObject results = memoization_state.caching_state_get_zero_arg_results( caching_state, UNPROVIDED );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( nl_trie_multi_word_abbreviation_preds_internal() ) );
  ...
  public static SubLObject initialize_nl_trie_pragmatic_predicates()
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym53$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( $const54$EverythingPSC, thread );
      $nl_trie_pragmatic_predicates$.setGlobalValue( isa.all_fort_instances( $const315$NLPragmaticPredicate_New, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      mt_relevance_macros.$mt$.rebind( _prev_bind_2, thread );
  ...
  public static SubLObject nl_trie_syntactic_assertionP(final SubLObject assertion)
  {
    if( NIL != ok_assertion_for_nl_trieP( assertion ) )
    {
      ...
      return makeBoolean( NIL != subl_promotions.memberP( assertion_pred, nl_trie_syntactic_predicates(), UNPROVIDED, UNPROVIDED ) || NIL != conses_high.member( assertion_pred, nl_trie_arg_in_reln_predicates(),
          UNPROVIDED, UNPROVIDED ) || NIL != nl_trie_abbreviation_pred_p( assertion_pred ) );
    }
    return NIL;
  }
  ...
  public static SubLObject nl_trie_semantic_assertionP(final SubLObject assertion)
  {
    ...
    {
      final SubLObject assertion_pred = assertions_high.gaf_arg0( assertion );
      return makeBoolean( assertion_pred.eql( $const15$termPhrases ) || NIL != subl_promotions.memberP( assertion_pred, nl_trie_denotation_predicates(), UNPROVIDED, UNPROVIDED ) || NIL != conses_high.member(
          assertion_pred, nl_trie_semtrans_predicates(), UNPROVIDED, UNPROVIDED ) || ( NIL != nl_trie_name_string_predP( assertion_pred ) && NIL != cycl_string.cycl_string_p( assertions_high.gaf_arg2( assertion ) ) )
          || NIL != conses_high.member( assertion_pred, nl_trie_arg_in_reln_predicates(), UNPROVIDED, UNPROVIDED ) );
    }
    return NIL;
  }
  ...
  public static SubLObject initialize_nl_trie_int(SubLObject v_nl_trie)
  {
    ...
    PrintLow.format( T, $str316$__Initializing_NL_Trie_____ );
    streams_high.force_output( UNPROVIDED );
    PrintLow.format( T, $str317$__Triefying_the_syntactic_predica );
    nl_triefy_preds( $kw318$SYNTACTIC, v_nl_trie );
    PrintLow.format( T, $str319$__Triefying_the_semantic_predicat );
    nl_triefy_preds( $kw320$SEMANTIC, v_nl_trie );
    return T;
  }
  ...
  public static SubLObject nl_triefy_preds(final SubLObject init_type, SubLObject v_nl_trie)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject preds_to_use = list_utilities.remove_if_not( $sym321$VALID_CONSTANT_, ( init_type == $kw318$SYNTACTIC ) ? ConsesLow.append( nl_trie_syntactic_predicates(), nl_trie_abbreviation_predicates() )
        : ConsesLow.cons( $const15$termPhrases, nl_trie_name_string_preds() ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    ...
    try
    {
      ...
      try
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          final SubLObject progress_note = PrintLow.format( NIL, $str322$____D__D__Triefying__S_assertions, new SubLObject[] { number_utilities.f_1X( count_preds_done ), total_preds, pred
          } );
          nl_triefy_pred( pred, NIL, init_type, v_nl_trie, progress_note );
          count_preds_done = Numbers.add( count_preds_done, ONE_INTEGER );
          cdolist_list_var = cdolist_list_var.rest();
          pred = cdolist_list_var.first();
        }
      }
  ...
  public static SubLObject triefy_mt(final SubLObject mt, SubLObject v_nl_trie)
  {
    ...
    triefy_mt_int( mt, isa.all_fort_instances( $const323$NLSyntacticPredicate, UNPROVIDED, UNPROVIDED ), v_nl_trie );
    triefy_mt_int( mt, isa.all_fort_instances( $const324$NLSemanticPredicate, UNPROVIDED, UNPROVIDED ), v_nl_trie );
    return T;
  }
  ...
  public static SubLObject triefy_mt_int(final SubLObject mt, SubLObject preds_to_use, SubLObject v_nl_trie)
  {
    ...
    final SubLObject total_preds = Sequences.length( preds_to_use );
    SubLObject count_preds_done = ZERO_INTEGER;
    final SubLObject progress_message = PrintLow.format( NIL, $str325$Triefying__S, mt );
    ...
    try
    {
      ...
      try
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          final SubLObject init_type = ( NIL != Sequences.find( pred, nl_trie_syntactic_predicates(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) ? $kw318$SYNTACTIC : $kw320$SEMANTIC;
          final SubLObject mt_var = mt_relevance_macros.with_inference_mt_relevance_validate( mt );
              ...
              try
              {
                ...
                while ( NIL == done_var)
                {
                  ...
                  if( NIL != valid )
                  {
                    ...
                    try
                    {
                      final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, $kw326$GAF, $kw327$TRUE, NIL );
                      ...
                      while ( NIL == done_var_$54)
                      {
                        ...
                        if( NIL != valid_$56 )
                        {
                          ...
                          if( pcase_var.eql( $kw318$SYNTACTIC ) )
                          {
                            update_nl_trie_syntactic( assertion, v_nl_trie, UNPROVIDED );
                          }
                          else if( pcase_var.eql( $kw320$SEMANTIC ) )
                          {
  ...
  public static SubLObject nl_triefy_pred(final SubLObject pred, SubLObject clear_firstP, SubLObject init_type, SubLObject v_nl_trie, SubLObject progress_note)
  {
    ...
    {
      progress_note = PrintLow.format( NIL, $str328$Triefying__S_assertions___, pred );
    }
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( NIL != clear_firstP )
    {
    ...
    if( NIL == init_type )
    {
      init_type = ( NIL != Sequences.find( pred, nl_trie_syntactic_predicates(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) ? $kw318$SYNTACTIC : $kw320$SEMANTIC;
    }
    SubLObject total = ZERO_INTEGER;
    SubLObject sofar = ZERO_INTEGER;
    final SubLObject threshold = $int178$1000;
                  ...
                  try
                  {
                    ...
                    while ( NIL == done_var_$65)
                    {
                      ...
                      if( NIL != valid_$67 )
                      {
                        ...
                        else if( pcase_var.eql( $kw320$SEMANTIC ) && NIL != nl_trie_semantic_assertionP( assertion ) )
                        {
  ...
  public static SubLObject nl_trie_remove_entries_wXpred(final SubLObject entries, final SubLObject pred)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      else if( nl_trie_entry_semantic_pred( entry, UNPROVIDED ).eql( pred ) )
      {
        changedP = T;
      }
      else
      {
        ans = ConsesLow.cons( entry, ans );
      }
      cdolist_list_var = cdolist_list_var.rest();
      entry = cdolist_list_var.first();
    }
  ...
  public static SubLObject nl_trie_return_keyword(final SubLObject removeP, SubLObject successP)
  {
    ...
    if( NIL != removeP )
    {
      return ( NIL != successP ) ? $kw147$REMOVED : $kw273$NOT_REMOVED;
    }
    return ( NIL != successP ) ? $kw145$ADDED : $kw272$NOT_ADDED;
  }
  ...
  public static SubLObject update_nl_trie_syntactic(final SubLObject assertion, SubLObject v_nl_trie, SubLObject removeP)
  {
    ...
    if( NIL != $catch_nl_trie_errorsP$.getDynamicValue( thread ) )
    {
      try
      {
        ...
        try
        {
          Errors.$error_handler$.bind( $sym330$CATCH_ERROR_MESSAGE_HANDLER, thread );
          try
          {
            SubLObject release = NIL;
            try
            {
              ...
              try
              {
                ...
                else if( NIL != nl_trie_abbreviation_pred_p( pred ) )
                {
                  final SubLObject pcase_var = pred;
                  if( pcase_var.eql( $const174$abbreviationForLexicalWord ) )
                  {
                    result = nl_triefy_abbr_lex_word_assertion( assertion, v_nl_trie, removeP );
                  }
                  else if( pcase_var.eql( $const331$abbreviationForMultiWordString ) )
                  {
                    result = nl_triefy_abbr_mws_assertion( assertion, v_nl_trie, removeP );
                  }
                  else if( pcase_var.eql( $const332$abbreviationForCompoundString ) )
                  {
    ...
    else
    {
      ...
      try
      {
        release2 = Locks.seize_lock( $nl_trie_lock$.getGlobalValue() );
        ...
        try
        {
          ...
          else if( NIL != nl_trie_abbreviation_pred_p( pred ) )
          {
            ...
            if( pcase_var2.eql( $const174$abbreviationForLexicalWord ) )
            {
              result = nl_triefy_abbr_lex_word_assertion( assertion, v_nl_trie, removeP );
            }
            else if( pcase_var2.eql( $const331$abbreviationForMultiWordString ) )
            {
              result = nl_triefy_abbr_mws_assertion( assertion, v_nl_trie, removeP );
            }
            else if( pcase_var2.eql( $const332$abbreviationForCompoundString ) )
            {
              result = nl_triefy_abbr_cps_assertion( assertion, v_nl_trie, removeP );
            }
          }
  ...
  public static SubLObject nl_triefy_spp_assertion(final SubLObject assertion, final SubLObject v_nl_trie, final SubLObject removeP)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        final SubLObject pred = ( NIL != fort_types_interface.predicate_p( constraint ) ) ? constraint : $const140$partOfSpeech;
    ...
    update_nl_trie_semantic_on_wu( wu, v_nl_trie, assertion_mt, removeP, ConsesLow.cons( ConsesLow.list( ConsesLow.list( string ), spp_pred, assertion_mt ), mod_list ) );
  ...
  public static SubLObject unique_irregular_form_assertionP(final SubLObject assertion)
  {
    ...
    SubLObject word = NIL;
    SubLObject string = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( current, datum, $list337 );
    ...
    {
      final SubLObject assertion_mt = assertions_high.assertion_mt( assertion );
      return makeBoolean( NIL != lexicon_accessors.derived_predP( spp_pred, assertion_mt ) && NIL == Sequences.remove( string, nl_trie_get_irregular_forms( word, spp_pred, assertion_mt ), Symbols.symbol_function(
          EQUALP ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    cdestructuring_bind.cdestructuring_bind_error( datum, $list337 );
    return NIL;
  }
  ...
  public static SubLObject nl_trie_get_irregular_forms(final SubLObject wu, final SubLObject pred, final SubLObject mt)
  {
    ...
    return Sequences.delete_duplicates( forms, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $nl_trie_spec_predicates_caching_state$.getGlobalValue(), ConsesLow.list( pred, mt ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject nl_trie_spec_predicates(final SubLObject pred, final SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym338$NL_TRIE_SPEC_PREDICATES, $sym339$_NL_TRIE_SPEC_PREDICATES_CACHING_STATE_, $int340$256, EQL, TWO_INTEGER, ZERO_INTEGER );
      memoization_state.register_genl_preds_dependent_cache_clear_callback( $sym341$CLEAR_NL_TRIE_SPEC_PREDICATES );
    }
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( nl_trie_spec_predicates_internal( pred, mt ) ) );
          ...
          if( !regular_form.equal( string ) )
          {
            if( NIL != removeP )
            {
              if( NIL == lexicon_accessors.string_is_pred_on_wuP( regular_form, word, sp_pred, assertion_mt, UNPROVIDED ) )
              {
                ...
                cleaned_up_forms = ConsesLow.cons( regular_form, cleaned_up_forms );
              }
            }
            else if( NIL == nl_trie_asserted_word_formP( sp_pred, word, regular_form, assertion_mt ) )
            {
              nl_trie_clean_up_one_regular_form( regular_form, assertion, v_nl_trie, removeP );
              cleaned_up_forms = ConsesLow.cons( regular_form, cleaned_up_forms );
            }
      ...
      if( NIL != kb_mapping_macros.do_gaf_arg_index_key_validator( word, NIL, sp_pred ) )
      {
        ...
        while ( NIL == done_var)
        {
          ...
          if( NIL != valid )
          {
            ...
            try
            {
              final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, $kw326$GAF, NIL, NIL );
  ...
  public static SubLObject nl_trie_clean_up_one_regular_form(final SubLObject regular_form, final SubLObject assertion, final SubLObject v_nl_trie, final SubLObject removeP)
  {
    ...
    if( NIL == current )
    {
      ...
      {
        final SubLObject new_mod_list = find_mod_list( ConsesLow.list( ConsesLow.list( ConsesLow.list( regular_form ), spp_pred ) ), assertion_mt );
  ...
  public static SubLObject find_mod_list(final SubLObject str_pred_list, final SubLObject assertion_mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        mod_list = ConsesLow.cons( ConsesLow.list( mod_str_list, pred, assertion_mt ), mod_list );
      }
      else
      {
  ...
  public static SubLObject nl_triefy_pos_assertion(final SubLObject assertion, final SubLObject v_nl_trie, final SubLObject removeP)
  {
    ...
    if( NIL == current )
    {
      final SubLObject string = cycl_string.cycl_string_to_utf8_string( v_cycl_string );
      final SubLObject assertion_mt = assertions_high.assertion_mt( assertion );
      final SubLObject mod_list = ConsesLow.list( ConsesLow.list( ConsesLow.list( string ), pos, assertion_mt ) );
  ...
  public static SubLObject update_nl_trie_semantic_on_wu(final SubLObject wu, final SubLObject v_nl_trie, final SubLObject syntactic_mt, final SubLObject removeP, SubLObject mod_list)
  {
    ...
    SubLObject cdolist_list_var;
    final SubLObject semantic_preds_to_use = cdolist_list_var = Sequences.remove_duplicates( ConsesLow.append( nl_trie_arg_in_reln_predicates(), nl_trie_denotation_predicates(), nl_trie_semtrans_predicates() ),
  ...
  public static SubLObject update_nl_trie_semantic_assertion(final SubLObject assertion, final SubLObject syntactic_mt, final SubLObject pos_index, final SubLObject mod_list, final SubLObject v_nl_trie,
      final SubLObject removeP)
  {
    if( NIL != ok_assertion_for_nl_trieP( assertion ) && ( NIL != lexicon_accessors.genl_lexicon_mtP( assertions_high.assertion_mt( assertion ), syntactic_mt ) || NIL != lexicon_accessors.genl_lexicon_mtP( syntactic_mt,
  ...
  public static SubLObject remove_nl_trie_pos_for_semtrans_pred(final SubLObject pred, SubLObject mt)
  {
    ...
    return memoization_state.caching_state_remove_function_results_with_args( $nl_trie_pos_for_semtrans_pred_caching_state$.getGlobalValue(), ConsesLow.list( pred, mt ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject nl_trie_pos_for_semtrans_pred(final SubLObject pred, SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym346$NL_TRIE_POS_FOR_SEMTRANS_PRED, $sym347$_NL_TRIE_POS_FOR_SEMTRANS_PRED_CACHING_STATE_, $int348$128, EQL, TWO_INTEGER, ZERO_INTEGER );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_2( pred, mt );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    if( !collisions.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( nl_trie_pos_for_semtrans_pred_internal( pred, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( pred, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject filter_mod_list_for_pos(final SubLObject mod_list, final SubLObject pos)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      else if( NIL != fort_types_interface.predicate_p( constraint ) )
      {
        okP = nl_trie_pred_ok_for_posP( constraint, pos );
      }
      if( NIL != okP )
      {
        new_mod_list = ConsesLow.cons( item, new_mod_list );
      }
      cdolist_list_var = cdolist_list_var.rest();
      item = cdolist_list_var.first();
    }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $nl_trie_pred_ok_for_posP_caching_state$.getGlobalValue(), ConsesLow.list( pred, pos ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/nl-trie.lisp", position = 119504L)
  public static SubLObject nl_trie_pred_ok_for_posP_internal(final SubLObject pred, final SubLObject pos)
  {
    return makeBoolean( pred.eql( $const140$partOfSpeech ) || NIL != conses_high.member( pos, nl_trie_pos_of_pred( pred ), $sym350$GENL_POS_, UNPROVIDED ) || NIL != conses_high.member( pred,
        nl_trie_preds_licensed_by_pos( pos ), $sym351$GENL_POS_PRED_, UNPROVIDED ) );
  }
  ...
  public static SubLObject nl_trie_pred_ok_for_posP(final SubLObject pred, final SubLObject pos)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym349$NL_TRIE_PRED_OK_FOR_POS_, $sym352$_NL_TRIE_PRED_OK_FOR_POS__CACHING_STATE_, $int353$1024, EQL, TWO_INTEGER, ZERO_INTEGER );
    }
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( nl_trie_pred_ok_for_posP_internal( pred, pos ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( pred, pos ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $nl_trie_preds_licensed_by_pos_caching_state$.getGlobalValue(), ConsesLow.list( pos ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/nl-trie.lisp", position = 119759L)
  public static SubLObject nl_trie_preds_licensed_by_pos_internal(final SubLObject pos)
  {
    return conses_high.intersection( nl_trie_preds_of_pos( pos ), lexicon_utilities.preds_licensed_by_pos( pos ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject nl_trie_preds_licensed_by_pos(final SubLObject pos)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym354$NL_TRIE_PREDS_LICENSED_BY_POS, $sym355$_NL_TRIE_PREDS_LICENSED_BY_POS_CACHING_STATE_, $int340$256, EQL, ONE_INTEGER, $int356$32 );
    }
    ...
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( nl_trie_preds_licensed_by_pos_internal( pos ) ) );
  ...
  public static SubLObject update_nl_trie_semantic(final SubLObject assertion, SubLObject v_nl_trie, SubLObject removeP, SubLObject mod_list)
  {
    ...
    try
    {
      ...
      {
        file_vector_utilities.$file_vector_backed_map_read_lock$.bind( $nl_trie_lock$.getGlobalValue(), thread );
        if( pred.eql( $const15$termPhrases ) )
        {
          thread.resetMultipleValues();
        ...
        else if( NIL != conses_high.member( pred, nl_trie_denotation_predicates(), UNPROVIDED, UNPROVIDED ) )
        {
          thread.resetMultipleValues();
        ...
        else if( NIL != conses_high.member( pred, nl_trie_semtrans_predicates(), UNPROVIDED, UNPROVIDED ) )
        {
          thread.resetMultipleValues();
        ...
        else if( NIL != nl_trie_name_string_predP( pred ) )
        {
          thread.resetMultipleValues();
        ...
        else if( NIL != conses_high.member( pred, nl_trie_arg_in_reln_predicates(), UNPROVIDED, UNPROVIDED ) )
        {
          thread.resetMultipleValues();
      ...
      while ( NIL != cdolist_list_var2)
      {
        ...
        while ( NIL != cdolist_list_var_$93)
        {
          ...
          if( desired_result.eql( result2 ) )
          {
            ...
            if( NIL == conses_high.member( item_var2, strings, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
            {
  ...
  public static SubLObject nl_triefy_term_phrases_assertion(final SubLObject assertion, final SubLObject v_nl_trie, final SubLObject removeP)
  {
    ...
    return Values.values( nl_trie_return_keyword( removeP, successP ), ConsesLow.list( string ) );
  }
  ...
  public static SubLObject nl_trie_semantic_support_pos(final SubLObject sem_support)
  {
    if( NIL != assertion_handles.assertion_p( sem_support ) )
    {
      ...
      return Values.nth_value_step_2( Values.nth_value_step_1( THREE_INTEGER ), nl_trie_get_morpho_syntax_from_formula( formula ) );
    }
    return NIL;
  }
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        if( NIL == current )
        {
          ...
          while ( NIL != cdolist_list_var_$94)
          {
            ...
            final SubLObject entry = new_nl_trie_word( set_utilities.new_singleton_set( syntactic_support, Symbols.symbol_function( EQUALP ) ), set_utilities.new_singleton_set( semantic_as, Symbols.symbol_function(
                EQUALP ) ) );
  ...
  public static SubLObject inc_sem_from_preds_syntactic_supports(final SubLObject preds, final SubLObject wu, final SubLObject assertion_mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      final SubLObject supported_wu_strings = cdolist_list_var_$95 = nl_trie_strings_of_word_unit( wu, ConsesLow.list( pred ), assertion_mt, T );
      ...
      while ( NIL != cdolist_list_var_$95)
      {
        ...
        if( NIL == conses_high.member( item_var, syntactic_supports, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
        {
          syntactic_supports = ConsesLow.cons( item_var, syntactic_supports );
        }
              ...
              try
              {
                ...
                while ( NIL == done_var_$96)
                {
                  ...
                  if( NIL != valid_$98 )
                  {
                    ...
                    {
                      final SubLObject item_var2 = ConsesLow.list( ConsesLow.list( string ), pred );
                      if( NIL == conses_high.member( item_var2, str_pred_list, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
                      {
                        str_pred_list = ConsesLow.cons( item_var2, str_pred_list );
                      }
                      ...
                      while ( NIL != cdolist_list_var_$96)
                      {
                        ...
                        cdestructuring_bind.destructuring_bind_must_consp( current2, datum2, $list361 );
                        ...
                        if( NIL == current2 )
                        {
                          ...
                          while ( NIL != cdolist_list_var_$97)
                          {
                            ...
                            if( NIL == conses_high.member( item_var3, syntactic_supports, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
                            {
                              syntactic_supports = ConsesLow.cons( item_var3, syntactic_supports );
                            }
                        ...
                        {
                          cdestructuring_bind.cdestructuring_bind_error( datum2, $list361 );
                        }
  ...
  public static SubLObject inc_sem_from_pos_new(final SubLObject pos, final SubLObject wu, final SubLObject semantic_assertion)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        final SubLObject sentence = el_utilities.make_ternary_formula( $const140$partOfSpeech, wu, pos, string );
        final SubLObject syntactic_support = find_or_create_nl_trie_word_syn_support( sentence, mt, string );
        final SubLObject entry = new_nl_trie_word( set_utilities.new_singleton_set( syntactic_support, Symbols.symbol_function( EQUALP ) ), set_utilities.new_singleton_set( semantic_assertion, Symbols.symbol_function(
            EQUALP ) ) );
        words = ConsesLow.cons( entry, words );
      }
      else
  ...
  public static SubLObject find_string_mt_pairs_for_closed_class_word(final SubLObject wu, final SubLObject pos, final SubLObject semantic_mt)
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym53$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( $const54$EverythingPSC, thread );
      SubLObject cdolist_list_var = kb_mapping.gather_gaf_arg_index( wu, ONE_INTEGER, $const140$partOfSpeech, UNPROVIDED, UNPROVIDED );
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        {
          SubLObject cdolist_list_var_$102 = genl_mts.max_floor_mts( ConsesLow.list( pos_mt, semantic_mt ), UNPROVIDED, UNPROVIDED );
          SubLObject floor_mt = NIL;
          floor_mt = cdolist_list_var_$102.first();
          while ( NIL != cdolist_list_var_$102)
          {
            final SubLObject item_var = ConsesLow.list( string, floor_mt );
  ...
  public static SubLObject nl_triefy_arg_in_reln_assertion(final SubLObject assertion, final SubLObject v_nl_trie, final SubLObject removeP, SubLObject mod_list)
  {
    ...
    {
      final SubLObject denot_list = lexicon_accessors.relational_noun_denots( leading_strings, head_word, following_strings, pos, $kw364$UNDETERMINED, denoted_reln, assertion_mt, assertion_mt );
  ...
  public static SubLObject nl_triefy_arg_in_reln_wX_mod_list(final SubLObject semantic_support, final SubLObject leading_strings, final SubLObject head_word, final SubLObject following_strings, final SubLObject pos,
      final SubLObject v_nl_trie, final SubLObject removeP, final SubLObject mod_list)
  {
    SubLObject successP = NIL;
    SubLObject strings = NIL;
    SubLObject cdolist_list_var = mod_list;
      ...
      if( NIL == current )
      {
        ...
        if( ( NIL != lexicon_accessors.speech_part_predP( pred, UNPROVIDED ) && pos.eql( lexicon_accessors.pos_of_pred( pred ) ) ) || constraint.eql( pos ) )
        {
          ...
          while ( NIL != cdolist_list_var_$109)
          {
            ...
            final SubLObject nl_trie_word = new_nl_trie_word( set_utilities.new_singleton_set( syntactic_support, Symbols.symbol_function( EQUALP ) ), set_utilities.new_singleton_set( semantic_support, Symbols
                .symbol_function( EQUALP ) ) );
            successP = T;
            strings = ConsesLow.cons( big_string, strings );
  ...
  public static SubLObject nl_triefy_arg_in_reln_wXo_mod_list(final SubLObject semantic_support, final SubLObject leading_strings, final SubLObject head_word, final SubLObject following_strings, final SubLObject pos,
      final SubLObject v_nl_trie, final SubLObject removeP, final SubLObject mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      final SubLObject nl_trie_word = new_nl_trie_word( set_utilities.new_singleton_set( syntactic_support, $nl_trie_word_syntactic_support_set_test$.getGlobalValue() ), set_utilities.new_singleton_set( semantic_support,
          $nl_trie_word_semantic_support_set_test$.getGlobalValue() ) );
      successP = T;
      strings = ConsesLow.cons( big_string, strings );
      ...
      while ( NIL != cdolist_list_var_$112)
      {
        ...
        final SubLObject nl_trie_word2 = new_nl_trie_word( set_utilities.new_singleton_set( syntactic_support2, Symbols.symbol_function( EQUALP ) ), set_utilities.new_singleton_set( semantic_support, Symbols
            .symbol_function( EQUALP ) ) );
        final SubLObject big_string2 = nl_trie_assemble_strings( leading_strings, derived_head_string, following_strings );
        successP = T;
        strings = ConsesLow.cons( big_string2, strings );
  ...
  public static SubLObject nl_triefy_abbr_lex_word_assertion(final SubLObject assertion, final SubLObject v_nl_trie, final SubLObject removeP)
  {
    ...
    if( NIL == current )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        final SubLObject sentence = ConsesLow.list( abbrev_pred, wu, pos_pred, cycl_abbr );
        ...
        update_nl_trie_semantic_on_wu( wu, v_nl_trie, assertion_mt, NIL, ConsesLow.list( ConsesLow.list( ConsesLow.list( cycl_abbr ), pos_pred, assertion_mt ) ) );
        cdolist_list_var = cdolist_list_var.rest();
        pos_pred = cdolist_list_var.first();
      }
  ...
  public static SubLObject get_denot_for_abbr_lex_word_assertion(final SubLObject wu, final SubLObject apos, final SubLObject mt)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      pred_relevance_macros.$relevant_pred_function$.bind( $sym367$RELEVANT_PRED_IS_EQ, thread );
      pred_relevance_macros.$pred$.bind( $const105$denotation, thread );
  ...
  public static SubLObject nl_triefy_abbr_cps_assertion(final SubLObject assertion, final SubLObject v_nl_trie, final SubLObject removeP)
  {
    ...
    if( NIL == current )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        final SubLObject sentence = ConsesLow.list( abbrev_pred, wu, mw_str, pos_pred, abbr );
  ...
  public static SubLObject get_denot_for_abbr_cps_assertion(final SubLObject amw_str, final SubLObject word, final SubLObject apos, final SubLObject mt)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      pred_relevance_macros.$relevant_pred_function$.bind( $sym367$RELEVANT_PRED_IS_EQ, thread );
      pred_relevance_macros.$pred$.bind( $const369$compoundString, thread );
      final SubLObject pred_var = NIL;
  ...
  public static SubLObject nl_triefy_abbr_mws_assertion(final SubLObject assertion, final SubLObject v_nl_trie, final SubLObject removeP)
  {
    ...
    if( NIL == current )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        final SubLObject sentence = ConsesLow.list( abbrev_pred, mw_str, wu, pos_pred, abbr );
        final SubLObject syntactic_support = find_or_create_nl_trie_word_syn_support( sentence, assertion_mt, abbr );
        set.set_add( syntactic_support, syntactic_supports );
        cdolist_list_var = cdolist_list_var.rest();
        pos_pred = cdolist_list_var.first();
  ...
  public static SubLObject get_denot_for_abbr_mws_assertion(final SubLObject amw_str, final SubLObject word, final SubLObject apos, final SubLObject mt)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      pred_relevance_macros.$relevant_pred_function$.bind( $sym367$RELEVANT_PRED_IS_EQ, thread );
      pred_relevance_macros.$pred$.bind( $const371$multiWordString, thread );
      final SubLObject pred_var = NIL;
  ...
  public static SubLObject nl_triefy_name_string(final SubLObject content, final SubLObject v_nl_trie, final SubLObject removeP)
  {
    ...
    SubLObject result = NIL;
    SubLObject entry_strings = ConsesLow.list( string );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        final SubLObject item_var = Sequences.cconcatenate( $english_definite_determiner$.getGlobalValue(), new SubLObject[] { $str372$_, string
        } );
        if( NIL == conses_high.member( item_var, entry_strings, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
        {
          entry_strings = ConsesLow.cons( item_var, entry_strings );
        }
      }
  ...
  public static SubLObject add_or_remove_nl_trie_word(final SubLObject v_nl_trie, final SubLObject key0, final SubLObject word, final SubLObject removeP)
  {
    ...
    nl_trie_accessors.update_nl_trie_rotation_index( ConsesLow.list( word ), removeP, UNPROVIDED );
  ...
  {
    final SubLObject key = unicode_nauts.convert_unicode_nauts_to_utf8_strings( key0 );
    final SubLObject exist_entries = nl_trie_lookup( v_nl_trie, key, $kw23$OFF );
  ...
  public static SubLObject nl_trie_delete_word(final SubLObject v_nl_trie, final SubLObject key, final SubLObject del_word)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != nl_trie_word_p( exist_entry, UNPROVIDED ) )
      {
        ...
        SubLObject sem_support;
        for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object, set_contents_var ); NIL == unassociateP
            && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
        {
          syn_support = set_contents.do_set_contents_next( basis_object, state );
          if( NIL != set_contents.do_set_contents_element_validP( state, syn_support ) && NIL != nl_trie_word_has_syntactic_support_p( exist_entry, syn_support, NIL ) )
          {
            ...
            else
            {
              ...
              for( basis_object_$127 = set_contents.do_set_contents_basis_object( set_contents_var_$126 ), state_$128 = NIL, state_$128 = set_contents.do_set_contents_initial_state( basis_object_$127,
                  set_contents_var_$126 ); NIL == set_contents.do_set_contents_doneP( basis_object_$127, state_$128 ); state_$128 = set_contents.do_set_contents_update_state( state_$128 ) )
              {
    ...
    return ( NIL != foundP ) ? $kw147$REMOVED : $kw148$NOT_FOUND;
  }
  ...
  public static SubLObject unifiable_word_entriesP(final SubLObject word1, final SubLObject word2, SubLObject check_pragmaticsP)
  {
    ...
    return makeBoolean( NIL != nl_trie_syntax_unifiable_p( word1, word2 ) && NIL != nl_trie_semantics_unifiable_p( word1, word2 ) && ( NIL == check_pragmaticsP || NIL != nl_trie_pragmatics_unifiable_p( word1, word2 ) )
        && NIL != nl_trie_words_case_identicalP( word1, word2 ) );
  }
  ...
  {
    return makeBoolean( NIL != nl_trie_frame_unifiable_p( word1, word2 ) && NIL != nl_trie_pos_unifiable_p( word1, word2 ) && ( NIL != nl_trie_no_new_syntax_p( word1, word2 ) || ( NIL != nl_trie_wu_unifiable_p( word1,
        word2 ) && NIL != nl_trie_syntax_mt_unifiable_p( word1, word2 ) ) ) );
  }
  ...
  {
    return makeBoolean( NIL == nl_trie_entry_semantic_pred( word1, UNPROVIDED ) || NIL == nl_trie_entry_semantic_pred( word2, UNPROVIDED ) || nl_trie_entry_semantic_pred( word1, UNPROVIDED ).equal(
        nl_trie_entry_semantic_pred( word2, UNPROVIDED ) ) );
  }
  ...
  {
    return makeBoolean( NIL != set.set_emptyP( nl_trie_word_syntactic_support_set( word1 ) ) || NIL != set.set_emptyP( nl_trie_word_syntactic_support_set( word2 ) ) || NIL != set_utilities.sets_coextensionalP(
        nl_trie_word_syntactic_support_set( word1 ), nl_trie_word_syntactic_support_set( word2 ) ) );
  }
  ...
  {
    return makeBoolean( NIL != set.set_emptyP( nl_trie_word_semantic_support_set( word1 ) ) || NIL != set.set_emptyP( nl_trie_word_semantic_support_set( word2 ) ) || NIL != set_utilities.sets_coextensionalP(
        nl_trie_word_semantic_support_set( word1 ), nl_trie_word_semantic_support_set( word2 ) ) );
  }
  ...
  {
    return Equality.equal( nl_trie_word_word_unit( word1, UNPROVIDED ), nl_trie_word_word_unit( word2, UNPROVIDED ) );
  }
  ...
  public static SubLObject update_nl_trie_name(final SubLObject v_nl_trie, final SubLObject key, final SubLObject name, final SubLObject removeP)
  {
    ...
    SubLObject cdolist_list_var;
    final SubLObject keys = cdolist_list_var = ( NIL != key ) ? ConsesLow.list( key ) : nl_trie_string_tokenize_multiple( nl_trie_name_string( name ) );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      nl_trie_accessors.update_nl_trie_rotation_index( ConsesLow.list( name ), removeP, UNPROVIDED );
      if( !desired_result.eql( result ) )
      {
        success = NIL;
      }
  ...
  public static SubLObject nl_trie_name_redundantP(final SubLObject focus, final SubLObject referent)
  {
    return makeBoolean( NIL != assertions_high.gaf_assertionP( referent ) && NIL != assertions_high.gaf_assertionP( focus ) && assertions_high.gaf_arg1( referent ).equal( assertions_high.gaf_arg1( focus ) )
        && assertions_high.gaf_arg2( referent ).equal( assertions_high.gaf_arg2( focus ) ) && nl_trie_entry_mt( focus ).eql( nl_trie_entry_mt( referent ) ) && nl_trie_entry_semantic_pred( referent, UNPROVIDED ).eql(
            nl_trie_entry_semantic_pred( focus, UNPROVIDED ) ) );
  }
  ...
  {
    if( NIL != genls.genl_ofP( $const167$ClosedClassWord, pos, mt, UNPROVIDED ) )
    {
      SubLObject ans = NIL;
      SubLObject cdolist_list_var = kb_mapping.gather_gaf_arg_index( wu, ONE_INTEGER, $const140$partOfSpeech, mt, UNPROVIDED );
      SubLObject as = NIL;
    ...
    return lexicon_accessors.get_strings_of_type( wu, pos, $kw375$ALL, NIL, mt );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $nl_trie_preds_of_pos_caching_state$.getGlobalValue(), ConsesLow.list( pos ), UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject preds = list_utilities.remove_if_not( $sym307$NL_TRIE_SYNTACTIC_PRED_, kb_mapping_utilities.pred_values_in_any_mt( pos, $const377$speechPartPreds, UNPROVIDED, UNPROVIDED, UNPROVIDED ), UNPROVIDED,
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym53$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( $const54$EverythingPSC, thread );
      if( NIL != lexicon_accessors.genl_posP( $const378$Verb, pos, UNPROVIDED ) )
      {
        final SubLObject item_var = $const176$gerund;
        if( NIL == conses_high.member( item_var, preds, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
        {
          preds = ConsesLow.cons( item_var, preds );
        }
  ...
  public static SubLObject nl_trie_preds_of_pos(final SubLObject pos)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym376$NL_TRIE_PREDS_OF_POS, $sym379$_NL_TRIE_PREDS_OF_POS_CACHING_STATE_, $int348$128, EQL, ONE_INTEGER, $int356$32 );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, pos, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( nl_trie_preds_of_pos_internal( pos ) ) );
      memoization_state.caching_state_put( caching_state, pos, results, UNPROVIDED );
    }
    return memoization_state.caching_results( results );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $nl_trie_pos_of_pred_caching_state$.getGlobalValue(), ConsesLow.list( pred ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/nl-trie.lisp", position = 165515L)
  public static SubLObject nl_trie_pos_of_pred_internal(final SubLObject pred)
  {
    return ( NIL != lexicon_accessors.speech_part_predP( pred, UNPROVIDED ) ) ? kb_mapping_utilities.pred_values_in_any_mt( pred, $const377$speechPartPreds, TWO_INTEGER, ONE_INTEGER, UNPROVIDED ) : NIL;
  }
  ...
  public static SubLObject nl_trie_pos_of_pred(final SubLObject pred)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym380$NL_TRIE_POS_OF_PRED, $sym381$_NL_TRIE_POS_OF_PRED_CACHING_STATE_, $int348$128, EQL, ONE_INTEGER, $int172$64 );
    }
    ...
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( nl_trie_pos_of_pred_internal( pred ) ) );
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject tokens = ( NIL != nl_trie_single_token_stringP( string ) ) ? ConsesLow.list( string )
        : string_utilities.nl_string_tokenize( string, string_utilities.whitespace_chars(), NIL, NIL, NIL, NIL, $nl_trie_break_list$.getDynamicValue( thread ) );
    SubLObject ans = NIL;
    ...
    return ( NIL != ans ) ? ans : ConsesLow.list( string );
  }
  ...
  public static SubLObject nl_trie_string_tokenize_multiple(final SubLObject string)
  {
    ...
    return ( NIL != ans ) ? ans : ConsesLow.list( ConsesLow.list( string ) );
  }
  ...
  {
    return makeBoolean( NIL == Sequences.find( Characters.CHAR_space, string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) && NIL == Sequences.find_if( $sym383$NL_TRIE_BREAK_CHAR_P, string, UNPROVIDED, UNPROVIDED,
        UNPROVIDED ) );
  }
  ...
  public static SubLObject nl_trie_standardize_strings(final SubLObject strings)
  {
    ...
    {
      return Values.values( ConsesLow.list( strings ), ConsesLow.list( NIL ) );
    }
  ...
  public static SubLObject nl_trie_standardize_strings_int(final SubLObject strings)
  {
    ...
    while ( NIL != substring_removal_list || NIL != removal_list)
    {
      ...
      for( i = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), string = list_var.first(), i = Numbers.add( ONE_INTEGER, i ) )
      {
        ...
        {
          stack = ConsesLow.cons( string, stack );
        }
        else if( NIL != conses_high.member( string, removal_list_$130, Symbols.symbol_function( EQUAL ), UNPROVIDED ) )
        {
          alterations = list_utilities.alist_enter( alterations, i, ZERO_INTEGER, UNPROVIDED );
        }
        else if( NIL != nl_trie_break_char_exception_string_p( string ) )
        {
          stack = ConsesLow.cons( string, stack );
        }
        else if( NIL != string_utilities.ends_with( string, $str386$_, UNPROVIDED ) )
        {
          stack = ConsesLow.cons( string, stack );
        }
        else if( NIL != Sequences.find_if( $sym387$DIGIT_CHAR_P, string, UNPROVIDED, UNPROVIDED, UNPROVIDED ) )
        {
          stack = ConsesLow.cons( string, stack );
        }
        else
        {
          final SubLObject no_dots = Sequences.remove( Characters.CHAR_period, string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          ...
          {
            alterations = list_utilities.alist_enter( alterations, i, Sequences.length( substrings ), UNPROVIDED );
          }
          ...
          while ( NIL != cdolist_list_var)
          {
            stack = ConsesLow.cons( substring, stack );
            cdolist_list_var = cdolist_list_var.rest();
            substring = cdolist_list_var.first();
          }
        }
      ...
      if( NIL != $nl_trie_use_two_letter_stringsP$.getDynamicValue( thread ) )
      {
        ...
        while ( NIL != cdolist_list_var2)
        {
          ...
          {
            new_stack = ConsesLow.cons( string_utilities.char_list_to_string( ConsesLow.list( string_utilities.first_char( string2 ), string_utilities.last_char( string2 ) ) ), new_stack );
          }
          else
          {
            new_stack = ConsesLow.cons( string2, new_stack );
          }
          cdolist_list_var2 = cdolist_list_var2.rest();
          string2 = cdolist_list_var2.first();
        }
      ...
      {
        standardized_lists = ConsesLow.cons( stack, standardized_lists );
        alterations_lists = ConsesLow.cons( alterations, alterations_lists );
      }
  ...
  public static SubLObject nl_trie_break_char_exception_string_p(final SubLObject string)
  {
    ...
    if( NIL == exceptionP )
    {
      ...
      if( NIL == unexceptionalP )
      {
        ...
        SubLObject char_num;
        SubLObject v_char;
        for( end_var_$132 = end_var, char_num = NIL, char_num = ONE_INTEGER; NIL == unexceptionalP && !char_num.numGE( end_var_$132 ); unexceptionalP = makeBoolean( !nl_trie_break_char_p( v_char ).eql(
            first_char_result ) ), char_num = number_utilities.f_1X( char_num ) )
        {
  ...
  {
    return makeBoolean( NIL != Characters.charE( v_char, Characters.CHAR_hyphen ) || NIL != Characters.charE( v_char, Characters.CHAR_period ) || NIL != Characters.charE( v_char, Characters.CHAR_slash )
        || NIL != Characters.charE( v_char, Characters.CHAR_quote ) || NIL != string_utilities.whitespace_charP( v_char ) || NIL != string_utilities.grammatical_punctuation_charP( v_char ) );
  }
  ...
  public static SubLObject nl_trie_error(final SubLObject format_string, SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4)
  {
    ...
    {
      nl_trie_warn( ONE_INTEGER, Sequences.cconcatenate( $str392$error_, format_string ), arg1, arg2, arg3, arg4 );
    }
    return NIL;
  }
  ...
  {
    return conses_high.intersection( nl_trie_preds_of_pos( pos ), nl_trie_syntactic_predicates(), UNPROVIDED, UNPROVIDED );
  }
    ...
    if( NIL != $nl_trie_include_derived_formsP$.getDynamicValue( thread ) )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        if( NIL != lexicon_cache.ok_to_derive_word_form_from_predP( wu, pred, spp_pred, mt ) )
        {
          ...
          if( NIL != dep_str_list )
          {
            str_pred_list = ConsesLow.cons( ConsesLow.list( dep_str_list, pred ), str_pred_list );
          }
        }
        cdolist_list_var = cdolist_list_var.rest();
        pred = cdolist_list_var.first();
              ...
              try
              {
                ...
                while ( NIL == done_var_$133)
                {
                  ...
                  if( NIL != valid_$135 )
                  {
                    ...
                    final SubLObject prag_feat = cycl_utilities.formula_arg0( prag_req ).eql( $const394$pragmaticallyAcceptable ) ? cycl_utilities.formula_arg1( prag_req, UNPROVIDED ) : NIL;
                    final SubLObject prag_mt = assertions_high.assertion_mt( meta_assertion );
                    result = ConsesLow.cons( ConsesLow.list( prag_feat, prag_mt ), result );
                  }
              ...
              try
              {
                ...
                while ( NIL == done_var_$134)
                {
                  ...
                  if( NIL != valid_$136 )
                  {
                    ...
                    result = ConsesLow.cons( ConsesLow.list( prag_feat2, prag_mt2 ), result );
                  }
  ...
  public static SubLObject find_pos_preds_for_lex_const_internal(final SubLObject v_const)
  {
    ...
    {
      return ConsesLow.list( v_const );
    }
    if( NIL != lexicon_accessors.speech_partP( v_const, UNPROVIDED ) )
    {
      return remove_genl_pos_preds( Sequences.nreverse( lexicon_utilities.preds_of_pos( v_const, UNPROVIDED ) ) );
    }
    return NIL;
  }
  ...
  public static SubLObject find_pos_preds_for_lex_const(final SubLObject v_const)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym395$FIND_POS_PREDS_FOR_LEX_CONST, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym395$FIND_POS_PREDS_FOR_LEX_CONST, ONE_INTEGER, NIL, EQL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym395$FIND_POS_PREDS_FOR_LEX_CONST, caching_state );
    }
    ...
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( find_pos_preds_for_lex_const_internal( v_const ) ) );
  ...
  public static SubLObject remove_genl_pos_preds(final SubLObject preds)
  {
    ...
    for( remain = NIL, remain = preds; NIL != remain; remain = remain.rest() )
    {
      ...
      if( NIL == subl_promotions.memberP( now, later, $sym397$SPEC_POS_PRED_, UNPROVIDED ) && NIL == conses_high.member( now, ans, $sym397$SPEC_POS_PRED_, UNPROVIDED ) )
      {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return makeBoolean( fort.eql( $const140$partOfSpeech ) || ( NIL != lexicon_accessors.speech_part_predP( fort, lexicon_vars.$lexicon_lookup_mt$.getDynamicValue( thread ) ) && NIL != has_pos_of_predP( fort ) ) );
  }
  ...
  {
    return lexicon_accessors.genl_lexicon_mtP( mt, $const44$EnglishLexiconMt );
  }
  ...
  {
    return isa.isa_in_any_mtP( fort, $const324$NLSemanticPredicate );
  }
  ...
  {
    return isa.isa_in_any_mtP( fort, $const315$NLPragmaticPredicate_New );
  }
  ...
  {
    return Mapping.mapcar( $sym401$TRIEFY_NART, function_terms.narts_of_function( function ) );
  }
  ...
  public static SubLObject new_nl_trie_iterator(SubLObject v_nl_trie)
  {
    ...
    assert NIL != nl_trie_p( v_nl_trie, UNPROVIDED ) : v_nl_trie;
    return iteration.new_iterator( make_nl_trie_iterator_state( v_nl_trie ), $sym403$NL_TRIE_ITERATOR_DONE, $sym404$NL_TRIE_ITERATOR_NEXT, UNPROVIDED );
  }
  ...
  public static SubLObject make_nl_trie_iterator_state(final SubLObject v_nl_trie)
  {
    ...
    return ConsesLow.list( iterator, is_current_nl_trie_p );
  }
  ...
  public static SubLObject nl_trie_iterator_done(final SubLObject state)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( state, state, $list405 );
    iterator = state.first();
    SubLObject current = state.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, state, $list405 );
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( state, $list405 );
    }
    return result;
  }
  ...
  public static SubLObject test_swappable_nl_trie_dump(final SubLObject key_list)
  {
    ...
    list_var = key_list;
    key = list_var.first();
    for( index = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), key = list_var.first(), index = Numbers.add( ONE_INTEGER, index ) )
    {
      strie.strie_insert( v_strie, key, index );
    }
    final SubLObject temp_index_file = file_utilities.make_prefixed_temp_filename( $str418$index, UNPROVIDED );
    final SubLObject temp_data_file = file_utilities.make_prefixed_temp_filename( $str419$data, UNPROVIDED );
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          try
          {
            fvector = file_vector.new_file_vector( temp_data_file, temp_index_file, $kw420$OUTPUT, file_utilities.$default_big_stream_buffer_size$.getDynamicValue( thread ),
    ...
    try
    {
      thread.throwStack.push( $kw421$IGNORE_ERRORS_TARGET );
      final SubLObject _prev_bind_2 = Errors.$error_handler$.currentBinding( thread );
      try
      {
        Errors.$error_handler$.bind( Symbols.symbol_function( $sym422$IGNORE_ERRORS_HANDLER ), thread );
        try
        {
    ...
    {
      ignore_errors_tag = Errors.handleThrowable( ccatch_env_var2, $kw421$IGNORE_ERRORS_TARGET );
    }
    finally
    {
      thread.throwStack.pop();
    ...
    return $kw424$SUCCESS;
  }

  public static SubLObject declare_nl_trie_file()
  {
    SubLFiles.declareMacro( me, "with_nl_trie_cache_strategy", "WITH-NL-TRIE-CACHE-STRATEGY" );
    SubLFiles.declareMacro( me, "without_nl_trie_cache_strategy", "WITHOUT-NL-TRIE-CACHE-STRATEGY" );
    SubLFiles.declareMacro( me, "with_nl_trie_lock_held", "WITH-NL-TRIE-LOCK-HELD" );
    SubLFiles.declareFunction( me, "nl_trie_entry_p", "NL-TRIE-ENTRY-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_term_phrases_entry_p", "NL-TRIE-TERM-PHRASES-ENTRY-P", 1, 1, false );
    SubLFiles.declareFunction( me, "valid_nl_trie_entry_p", "VALID-NL-TRIE-ENTRY-P", 1, 0, false );
    SubLFiles.declareFunction( me, "validate_nl_trie_entry_internal", "VALIDATE-NL-TRIE-ENTRY-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "validate_nl_trie_entry", "VALIDATE-NL-TRIE-ENTRY", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_lex_entry_p", "NL-TRIE-LEX-ENTRY-P", 1, 1, false );
    SubLFiles.declareFunction( me, "validate_nl_trie_lex_entry", "VALIDATE-NL-TRIE-LEX-ENTRY", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_lex_entry_get", "NL-TRIE-LEX-ENTRY-GET", 2, 0, false );
    SubLFiles.declareFunction( me, "print_nl_trie_entry", "PRINT-NL-TRIE-ENTRY", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_type", "NL-TRIE-ENTRY-TYPE", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_string", "NL-TRIE-ENTRY-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_keys", "NL-TRIE-ENTRY-KEYS", 1, 1, false );
    SubLFiles.declareMacro( me, "do_nl_trie_names_with_added_the", "DO-NL-TRIE-NAMES-WITH-ADDED-THE" );
    SubLFiles.declareFunction( me, "nl_trie_name_ok_for_adding_theP", "NL-TRIE-NAME-OK-FOR-ADDING-THE?", 3, 0, false );
    SubLFiles.declareFunction( me, "string_is_non_name_nounP", "STRING-IS-NON-NAME-NOUN?", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_dont_add_the_categories_internal", "NL-TRIE-DONT-ADD-THE-CATEGORIES-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_dont_add_the_categories", "NL-TRIE-DONT-ADD-THE-CATEGORIES", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_denot_ok_for_adding_theP", "NL-TRIE-NAME-DENOT-OK-FOR-ADDING-THE?", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_dont_add_the_term_p", "NL-TRIE-DONT-ADD-THE-TERM-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_dont_add_the_terms_internal", "NL-TRIE-DONT-ADD-THE-TERMS-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_dont_add_the_terms", "NL-TRIE-DONT-ADD-THE-TERMS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_pred_ok_for_adding_theP_internal", "NL-TRIE-NAME-PRED-OK-FOR-ADDING-THE?-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_pred_ok_for_adding_theP", "NL-TRIE-NAME-PRED-OK-FOR-ADDING-THE?", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_pos", "NL-TRIE-ENTRY-POS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_pos_preds", "NL-TRIE-ENTRY-POS-PREDS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_denots", "NL-TRIE-ENTRY-DENOTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_preferred_denots", "NL-TRIE-ENTRY-PREFERRED-DENOTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_semtrans_templates", "NL-TRIE-ENTRY-SEMTRANS-TEMPLATES", 1, 0, false );
    SubLFiles.declareMacro( me, "do_nl_trie_entry_denots", "DO-NL-TRIE-ENTRY-DENOTS" );
    SubLFiles.declareMacro( me, "do_nl_trie_entry_strings", "DO-NL-TRIE-ENTRY-STRINGS" );
    SubLFiles.declareFunction( me, "nl_trie_name_string_macro_helper", "NL-TRIE-NAME-STRING-MACRO-HELPER", 1, 0, false );
    SubLFiles.declareMacro( me, "do_nl_trie_word_syntactic_supports", "DO-NL-TRIE-WORD-SYNTACTIC-SUPPORTS" );
    SubLFiles.declareMacro( me, "do_nl_trie_word_semantic_supports", "DO-NL-TRIE-WORD-SEMANTIC-SUPPORTS" );
    SubLFiles.declareFunction( me, "nl_trie_entry_semantic_pred", "NL-TRIE-ENTRY-SEMANTIC-PRED", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_mt", "NL-TRIE-ENTRY-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_semantic_mt", "NL-TRIE-ENTRY-SEMANTIC-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_semantic_support_set", "NL-TRIE-ENTRY-SEMANTIC-SUPPORT-SET", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_semantic_support_list", "NL-TRIE-ENTRY-SEMANTIC-SUPPORT-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_insert_entry", "NL-TRIE-INSERT-ENTRY", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_delete_entry", "NL-TRIE-DELETE-ENTRY", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_pragmatics", "NL-TRIE-ENTRY-PRAGMATICS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_support_pragmatics", "NL-TRIE-WORD-SEMANTIC-SUPPORT-PRAGMATICS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_to_javalists", "NL-TRIE-ENTRY-TO-JAVALISTS", 1, 0, false );
    SubLFiles.declareFunction( me, "javalist_string", "JAVALIST-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_p", "NL-TRIE-WORD-P", 1, 1, false );
    SubLFiles.declareFunction( me, "has_bad_syntactic_support_p", "HAS-BAD-SYNTACTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_copy", "NL-TRIE-WORD-COPY", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_support_p", "NL-TRIE-WORD-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "validate_nl_trie_word", "VALIDATE-NL-TRIE-WORD", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_struc_valid_p_internal", "NL-TRIE-WORD-STRUC-VALID-P-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_struc_valid_p", "NL-TRIE-WORD-STRUC-VALID-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_valid_assertionP", "NL-TRIE-VALID-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_valid_assertionP_memoized_internal", "NL-TRIE-VALID-ASSERTION?-MEMOIZED-INTERNAL", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_valid_assertionP_memoized", "NL-TRIE-VALID-ASSERTION?-MEMOIZED", 1, 1, false );
    SubLFiles.declareFunction( me, "valid_nl_trie_word_syntactic_support_p", "VALID-NL-TRIE-WORD-SYNTACTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "valid_nl_trie_word_semantic_support_p", "VALID-NL-TRIE-WORD-SEMANTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_support_p", "NL-TRIE-WORD-SEMANTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_syntactic_support_p", "NL-TRIE-WORD-SYNTACTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "validate_nl_trie_word_semantic_support", "VALIDATE-NL-TRIE-WORD-SEMANTIC-SUPPORT", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_hl_support_p", "NL-TRIE-WORD-HL-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "valid_nl_trie_word_hl_syntactic_support_p", "VALID-NL-TRIE-WORD-HL-SYNTACTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_hl_syntactic_support_p", "NL-TRIE-WORD-HL-SYNTACTIC-SUPPORT-P", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_justify_hl_syntactic_support", "NL-TRIE-JUSTIFY-HL-SYNTACTIC-SUPPORT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_hl_semantic_support_p", "NL-TRIE-WORD-HL-SEMANTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "valid_nl_trie_word_hl_semantic_support_p", "VALID-NL-TRIE-WORD-HL-SEMANTIC-SUPPORT-P", 1, 1, false );
    SubLFiles.declareFunction( me, "valid_nl_trie_word_denot_set_p", "VALID-NL-TRIE-WORD-DENOT-SET-P", 1, 0, false );
    SubLFiles.declareFunction( me, "validate_nl_trie_word_hl_semantic_support", "VALIDATE-NL-TRIE-WORD-HL-SEMANTIC-SUPPORT", 1, 1, false );
    SubLFiles.declareFunction( me, "validate_nl_trie_word_denot_set", "VALIDATE-NL-TRIE-WORD-DENOT-SET", 1, 0, false );
    SubLFiles.declareFunction( me, "invalid_nl_trie_word_denotP", "INVALID-NL-TRIE-WORD-DENOT?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_denot_has_invalid_constantP", "NL-TRIE-DENOT-HAS-INVALID-CONSTANT?", 1, 0, false );
    SubLFiles.declareFunction( me, "find_or_create_nl_trie_word_syn_support", "FIND-OR-CREATE-NL-TRIE-WORD-SYN-SUPPORT", 2, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_find_syntactic_support", "NL-TRIE-FIND-SYNTACTIC-SUPPORT", 3, 0, false );
    SubLFiles.declareFunction( me, "new_nl_trie_word_hl_syn_support", "NEW-NL-TRIE-WORD-HL-SYN-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "make_nl_trie_word_hl_syn_support", "MAKE-NL-TRIE-WORD-HL-SYN-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "new_nl_trie_word_hl_sem_support", "NEW-NL-TRIE-WORD-HL-SEM-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_semantic_support_from_denots", "NL-TRIE-SEMANTIC-SUPPORT-FROM-DENOTS", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_support_sentence", "NL-TRIE-WORD-SUPPORT-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_support_mt", "NL-TRIE-WORD-SUPPORT-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_support_predicate", "NL-TRIE-WORD-SUPPORT-PREDICATE", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_struc_print_function_trampoline", "NL-TRIE-WORD-STRUC-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_struc_p", "NL-TRIE-WORD-STRUC-P", 1, 0, false );
    new $nl_trie_word_struc_p$UnaryFunction();
    SubLFiles.declareFunction( me, "nl_trie_word_struc_syntactic_supports", "NL-TRIE-WORD-STRUC-SYNTACTIC-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_struc_semantic_supports", "NL-TRIE-WORD-STRUC-SEMANTIC-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_nl_trie_word_struc_syntactic_supports", "_CSETF-NL-TRIE-WORD-STRUC-SYNTACTIC-SUPPORTS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_nl_trie_word_struc_semantic_supports", "_CSETF-NL-TRIE-WORD-STRUC-SEMANTIC-SUPPORTS", 2, 0, false );
    SubLFiles.declareFunction( me, "make_nl_trie_word_struc", "MAKE-NL-TRIE-WORD-STRUC", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_nl_trie_word_struc", "VISIT-DEFSTRUCT-NL-TRIE-WORD-STRUC", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_nl_trie_word_struc_method", "VISIT-DEFSTRUCT-OBJECT-NL-TRIE-WORD-STRUC-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "sxhash_nl_trie_word_struc_method", "SXHASH-NL-TRIE-WORD-STRUC-METHOD", 1, 0, false );
    new $sxhash_nl_trie_word_struc_method$UnaryFunction();
    SubLFiles.declareFunction( me, "pprint_nl_trie_word_struc", "PPRINT-NL-TRIE-WORD-STRUC", 3, 0, false );
    SubLFiles.declareFunction( me, "cfasl_input_nl_trie_word_struc", "CFASL-INPUT-NL-TRIE-WORD-STRUC", 1, 0, false );
    new $cfasl_input_nl_trie_word_struc$UnaryFunction();
    SubLFiles.declareFunction( me, "cfasl_output_nl_trie_word_struc", "CFASL-OUTPUT-NL-TRIE-WORD-STRUC", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_output_object_nl_trie_word_struc_method", "CFASL-OUTPUT-OBJECT-NL-TRIE-WORD-STRUC-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_valid_semantic_support_set_p", "NL-TRIE-WORD-VALID-SEMANTIC-SUPPORT-SET-P", 1, 0, false );
    SubLFiles.declareFunction( me, "new_nl_trie_word_semantic_support_set", "NEW-NL-TRIE-WORD-SEMANTIC-SUPPORT-SET", 0, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_valid_syntactic_support_set_p", "NL-TRIE-WORD-VALID-SYNTACTIC-SUPPORT-SET-P", 1, 0, false );
    SubLFiles.declareFunction( me, "new_nl_trie_word_syntactic_support_set", "NEW-NL-TRIE-WORD-SYNTACTIC-SUPPORT-SET", 0, 1, false );
    SubLFiles.declareFunction( me, "new_nl_trie_word_for_syntactic_support", "NEW-NL-TRIE-WORD-FOR-SYNTACTIC-SUPPORT", 1, 0, false );
    SubLFiles.declareFunction( me, "new_nl_trie_word", "NEW-NL-TRIE-WORD", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_set_syn_supports", "NL-TRIE-WORD-SET-SYN-SUPPORTS", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_set_sem_supports", "NL-TRIE-WORD-SET-SEM-SUPPORTS", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_syntactic_support_p", "NL-TRIE-SYNTACTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_valid_syntactic_support_pred_p", "NL-TRIE-VALID-SYNTACTIC-SUPPORT-PRED-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_semantic_support_p", "NL-TRIE-SEMANTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_valid_semantic_support_p", "NL-TRIE-VALID-SEMANTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_arbitrary_syntactic_support", "NL-TRIE-WORD-ARBITRARY-SYNTACTIC-SUPPORT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_syntactic_support_list", "NL-TRIE-WORD-SYNTACTIC-SUPPORT-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_syntactic_support_set", "NL-TRIE-WORD-SYNTACTIC-SUPPORT-SET", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_syntactic_supports", "NL-TRIE-WORD-SYNTACTIC-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_support_list", "NL-TRIE-WORD-SEMANTIC-SUPPORT-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_support_set", "NL-TRIE-WORD-SEMANTIC-SUPPORT-SET", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_supports", "NL-TRIE-WORD-SEMANTIC-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_arbitrary_semantic_support", "NL-TRIE-WORD-ARBITRARY-SEMANTIC-SUPPORT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_has_syntactic_support_p", "NL-TRIE-WORD-HAS-SYNTACTIC-SUPPORT-P", 2, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_add_syntactic_support", "NL-TRIE-WORD-ADD-SYNTACTIC-SUPPORT", 2, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_remove_implied_hl_syntactic_supports", "NL-TRIE-WORD-REMOVE-IMPLIED-HL-SYNTACTIC-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_remove_syntactic_support", "NL-TRIE-WORD-REMOVE-SYNTACTIC-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_has_semantic_support_p", "NL-TRIE-WORD-HAS-SEMANTIC-SUPPORT-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_support_equalP", "NL-TRIE-WORD-SEMANTIC-SUPPORT-EQUAL?", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_add_semantic_support", "NL-TRIE-WORD-ADD-SEMANTIC-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_spliceable_semantic_support_p", "NL-TRIE-WORD-SPLICEABLE-SEMANTIC-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "do_nl_trie_word_add_semantic_support", "DO-NL-TRIE-WORD-ADD-SEMANTIC-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_hl_semantic_supports_unifiable_p", "NL-TRIE-WORD-HL-SEMANTIC-SUPPORTS-UNIFIABLE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_hl_semantic_support_denots", "NL-TRIE-WORD-HL-SEMANTIC-SUPPORT-DENOTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_hl_semantic_support_set_denots", "NL-TRIE-WORD-HL-SEMANTIC-SUPPORT-SET-DENOTS", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_support_denots_internal", "NL-TRIE-WORD-SEMANTIC-SUPPORT-DENOTS-INTERNAL", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_support_denots", "NL-TRIE-WORD-SEMANTIC-SUPPORT-DENOTS", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_support_semtrans_templates_internal", "NL-TRIE-WORD-SEMANTIC-SUPPORT-SEMTRANS-TEMPLATES-INTERNAL", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_support_semtrans_templates", "NL-TRIE-WORD-SEMANTIC-SUPPORT-SEMTRANS-TEMPLATES", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_remove_semantic_support", "NL-TRIE-WORD-REMOVE-SEMANTIC-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_pos_preds", "NL-TRIE-WORD-POS-PREDS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_syntactic_support_abbreviation_p", "NL-TRIE-WORD-SYNTACTIC-SUPPORT-ABBREVIATION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_syntactic_support_pos_preds", "NL-TRIE-WORD-SYNTACTIC-SUPPORT-POS-PREDS", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie_closed_class_pos_preds", "CLEAR-NL-TRIE-CLOSED-CLASS-POS-PREDS", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_nl_trie_closed_class_pos_preds", "REMOVE-NL-TRIE-CLOSED-CLASS-POS-PREDS", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_closed_class_pos_preds_internal", "NL-TRIE-CLOSED-CLASS-POS-PREDS-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_closed_class_pos_preds", "NL-TRIE-CLOSED-CLASS-POS-PREDS", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_const_arg_of_pred", "NL-TRIE-CONST-ARG-OF-PRED", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_syn_pred_string_arg", "NL-TRIE-WORD-SYN-PRED-STRING-ARG", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_abbr_arg_of_pred", "NL-TRIE-ABBR-ARG-OF-PRED", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_pos_internal", "NL-TRIE-WORD-POS-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_pos", "NL-TRIE-WORD-POS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_word_unit", "NL-TRIE-WORD-WORD-UNIT", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_frame", "NL-TRIE-WORD-FRAME", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantic_support_frame", "NL-TRIE-WORD-SEMANTIC-SUPPORT-FRAME", 1, 0, false );
    SubLFiles.declareMacro( me, "do_nl_trie_word_denots", "DO-NL-TRIE-WORD-DENOTS" );
    SubLFiles.declareFunction( me, "nl_trie_preferred_semantic_supportP", "NL-TRIE-PREFERRED-SEMANTIC-SUPPORT?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_preferred_semantic_predicate_p", "NL-TRIE-PREFERRED-SEMANTIC-PREDICATE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_preferred_lexical_assertionP", "NL-TRIE-PREFERRED-LEXICAL-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_preferred_meta_assertionP", "NL-TRIE-PREFERRED-META-ASSERTION?", 1, 0, false );
    SubLFiles.declareMacro( me, "do_nl_trie_word_semtrans_templates", "DO-NL-TRIE-WORD-SEMTRANS-TEMPLATES" );
    SubLFiles.declareMacro( me, "do_nl_trie_word_strings", "DO-NL-TRIE-WORD-STRINGS" );
    SubLFiles.declareFunction( me, "nl_trie_word_head_string_macro_helper", "NL-TRIE-WORD-HEAD-STRING-MACRO-HELPER", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_leading_strings_from_support_macro_helper", "NL-TRIE-WORD-LEADING-STRINGS-FROM-SUPPORT-MACRO-HELPER", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_following_strings_from_support_macro_helper", "NL-TRIE-WORD-FOLLOWING-STRINGS-FROM-SUPPORT-MACRO-HELPER", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_assemble_strings_macro_helper", "NL-TRIE-ASSEMBLE-STRINGS-MACRO-HELPER", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_string", "NL-TRIE-WORD-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_head_string", "NL-TRIE-WORD-HEAD-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_syntactic_support_string", "NL-TRIE-SYNTACTIC-SUPPORT-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_leading_strings", "NL-TRIE-WORD-LEADING-STRINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_leading_strings_from_support", "NL-TRIE-WORD-LEADING-STRINGS-FROM-SUPPORT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_following_strings", "NL-TRIE-WORD-FOLLOWING-STRINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_following_strings_from_support", "NL-TRIE-WORD-FOLLOWING-STRINGS-FROM-SUPPORT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_head_onlyP", "NL-TRIE-WORD-HEAD-ONLY?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_head_locations_in_lexical_string", "NL-TRIE-HEAD-LOCATIONS-IN-LEXICAL-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_sem_pred", "NL-TRIE-WORD-SEM-PRED", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_word_denots", "NL-TRIE-WORD-DENOTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_preferred_denots", "NL-TRIE-WORD-PREFERRED-DENOTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semtrans_templates", "NL-TRIE-WORD-SEMTRANS-TEMPLATES", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_syntax_mt", "NL-TRIE-WORD-SYNTAX-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_word_semantics_mt", "NL-TRIE-WORD-SEMANTICS-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "print_nl_trie_word", "PRINT-NL-TRIE-WORD", 3, 0, false );
    SubLFiles.declareFunction( me, "print_nl_trie_name", "PRINT-NL-TRIE-NAME", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_p", "NL-TRIE-NAME-P", 1, 1, false );
    SubLFiles.declareFunction( me, "validate_nl_trie_name", "VALIDATE-NL-TRIE-NAME", 1, 0, false );
    SubLFiles.declareFunction( me, "validate_nl_trie_term_phrases_entry", "VALIDATE-NL-TRIE-TERM-PHRASES-ENTRY", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_pred", "NL-TRIE-NAME-PRED", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_denot", "NL-TRIE-NAME-DENOT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_preferred_denots", "NL-TRIE-NAME-PREFERRED-DENOTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_string", "NL-TRIE-NAME-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_record_p_internal", "NL-TRIE-RECORD-P-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_record_p", "NL-TRIE-RECORD-P", 1, 0, false );
    SubLFiles.declareFunction( me, "new_nl_trie_record", "NEW-NL-TRIE-RECORD", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_record_key", "NL-TRIE-RECORD-KEY", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_record_entries", "NL-TRIE-RECORD-ENTRIES", 1, 0, false );
    SubLFiles.declareFunction( me, "valid_nl_trie_record_key_p", "VALID-NL-TRIE-RECORD-KEY-P", 1, 0, false );
    SubLFiles.declareFunction( me, "valid_nl_trie_record_entries_p", "VALID-NL-TRIE-RECORD-ENTRIES-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_syntactic_predicates", "NL-TRIE-SYNTACTIC-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_denotation_predicates", "NL-TRIE-DENOTATION-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_semtrans_predicates", "NL-TRIE-SEMTRANS-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_abbreviation_predicates", "NL-TRIE-ABBREVIATION-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_arg_in_reln_predicates", "NL-TRIE-ARG-IN-RELN-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_pragmatic_predicates", "NL-TRIE-PRAGMATIC-PREDICATES", 0, 0, false );
    SubLFiles.declareMacro( me, "initializing_nl_trie", "INITIALIZING-NL-TRIE" );
    SubLFiles.declareFunction( me, "nl_trie_being_initializedP", "NL-TRIE-BEING-INITIALIZED?", 0, 1, false );
    SubLFiles.declareFunction( me, "new_nl_trie", "NEW-NL-TRIE", 0, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_p", "NL-TRIE-P", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_presentP", "NL-TRIE-PRESENT?", 0, 1, false );
    SubLFiles.declareFunction( me, "get_nl_trie", "GET-NL-TRIE", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_size", "NL-TRIE-SIZE", 0, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_keys", "NL-TRIE-KEYS", 0, 1, false );
    SubLFiles.declareFunction( me, "empty_nl_trieP", "EMPTY-NL-TRIE?", 0, 1, false );
    SubLFiles.declareMacro( me, "do_nl_trie", "DO-NL-TRIE" );
    SubLFiles.declareMacro( me, "do_nl_trie_progress", "DO-NL-TRIE-PROGRESS" );
    SubLFiles.declareFunction( me, "nl_trie_entry_count", "NL-TRIE-ENTRY-COUNT", 0, 1, false );
    SubLFiles.declareFunction( me, "copy_nl_trie", "COPY-NL-TRIE", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie", "CLEAR-NL-TRIE", 0, 1, false );
    SubLFiles.declareFunction( me, "swap_out_all_pristine_nl_trie_entries", "SWAP-OUT-ALL-PRISTINE-NL-TRIE-ENTRIES", 0, 2, false );
    SubLFiles.declareFunction( me, "initialize_nl_trie", "INITIALIZE-NL-TRIE", 0, 5, false );
    SubLFiles.declareFunction( me, "nl_trie_entries_for_string", "NL-TRIE-ENTRIES-FOR-STRING", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_search", "NL-TRIE-SEARCH", 1, 2, false );
    SubLFiles.declareFunction( me, "nl_trie_case_sensitive_p", "NL-TRIE-CASE-SENSITIVE-P", 0, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_search_case_sensitive_internal", "NL-TRIE-SEARCH-CASE-SENSITIVE-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_search_case_sensitive", "NL-TRIE-SEARCH-CASE-SENSITIVE", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_search_case_insensitive_internal", "NL-TRIE-SEARCH-CASE-INSENSITIVE-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_search_case_insensitive", "NL-TRIE-SEARCH-CASE-INSENSITIVE", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_search_case_sensitive_preferred_internal", "NL-TRIE-SEARCH-CASE-SENSITIVE-PREFERRED-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_search_case_sensitive_preferred", "NL-TRIE-SEARCH-CASE-SENSITIVE-PREFERRED", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_search_int", "NL-TRIE-SEARCH-INT", 1, 2, false );
    SubLFiles.declareFunction( me, "augment_nl_trie_syntactic", "AUGMENT-NL-TRIE-SYNTACTIC", 1, 1, false );
    SubLFiles.declareFunction( me, "prune_nl_trie_syntactic", "PRUNE-NL-TRIE-SYNTACTIC", 1, 1, false );
    SubLFiles.declareFunction( me, "augment_nl_trie_semantic", "AUGMENT-NL-TRIE-SEMANTIC", 1, 1, false );
    SubLFiles.declareFunction( me, "prune_nl_trie_semantic", "PRUNE-NL-TRIE-SEMANTIC", 1, 1, false );
    SubLFiles.declareFunction( me, "retriefy_semantic_assertion", "RETRIEFY-SEMANTIC-ASSERTION", 1, 1, false );
    SubLFiles.declareMacro( me, "nl_trie_carefully_load_global", "NL-TRIE-CAREFULLY-LOAD-GLOBAL" );
    SubLFiles.declareFunction( me, "load_nl_trie_from_lexicon_cache", "LOAD-NL-TRIE-FROM-LEXICON-CACHE", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_nl_trie_to_lexicon_cache", "DUMP-NL-TRIE-TO-LEXICON-CACHE", 1, 0, false );
    SubLFiles.declareFunction( me, "load_nl_trie_completion_index", "LOAD-NL-TRIE-COMPLETION-INDEX", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_nl_trie_completion_index", "DUMP-NL-TRIE-COMPLETION-INDEX", 1, 0, false );
    SubLFiles.declareFunction( me, "reconnect_nl_trie_backing", "RECONNECT-NL-TRIE-BACKING", 2, 0, false );
    SubLFiles.declareFunction( me, "reconnect_nl_trie_to_file_vector_files", "RECONNECT-NL-TRIE-TO-FILE-VECTOR-FILES", 2, 1, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_to_lexicon_cache", "DUMP-SWAPPABLE-NL-TRIE-TO-LEXICON-CACHE", 2, 0, false );
    SubLFiles.declareFunction( me, "new_swappable_nl_trie_dump_visitor", "NEW-SWAPPABLE-NL-TRIE-DUMP-VISITOR", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_visitor_begin_visit", "DUMP-SWAPPABLE-NL-TRIE-VISITOR-BEGIN-VISIT", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_visitor_end_visit", "DUMP-SWAPPABLE-NL-TRIE-VISITOR-END-VISIT", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_visitor_begin_path", "DUMP-SWAPPABLE-NL-TRIE-VISITOR-BEGIN-PATH", 2, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_visitor_end_path", "DUMP-SWAPPABLE-NL-TRIE-VISITOR-END-PATH", 2, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_visitor_accept_node", "DUMP-SWAPPABLE-NL-TRIE-VISITOR-ACCEPT-NODE", 2, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_new_context", "DUMP-SWAPPABLE-NL-TRIE-NEW-CONTEXT", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_valid_initial_context", "DUMP-SWAPPABLE-NL-TRIE-VALID-INITIAL-CONTEXT", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_valid_final_context", "DUMP-SWAPPABLE-NL-TRIE-VALID-FINAL-CONTEXT", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_get_current_map", "DUMP-SWAPPABLE-NL-TRIE-GET-CURRENT-MAP", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_get_file_vector", "DUMP-SWAPPABLE-NL-TRIE-GET-FILE-VECTOR", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_pop_current_map", "DUMP-SWAPPABLE-NL-TRIE-POP-CURRENT-MAP", 2, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_push_new_current_map", "DUMP-SWAPPABLE-NL-TRIE-PUSH-NEW-CURRENT-MAP", 2, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_get_final_result", "DUMP-SWAPPABLE-NL-TRIE-GET-FINAL-RESULT", 1, 0, false );
    SubLFiles.declareFunction( me, "dump_swappable_nl_trie_set_final_result", "DUMP-SWAPPABLE-NL-TRIE-SET-FINAL-RESULT", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_lookup", "NL-TRIE-LOOKUP", 2, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_validate_all_entries", "NL-TRIE-VALIDATE-ALL-ENTRIES", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_remove_invalid_entries", "NL-TRIE-REMOVE-INVALID-ENTRIES", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_remaining_entries", "NL-TRIE-REMAINING-ENTRIES", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_filter_entries_for_case", "NL-TRIE-FILTER-ENTRIES-FOR-CASE", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_case_matches_keyP", "NL-TRIE-ENTRY-CASE-MATCHES-KEY?", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie_caches", "CLEAR-NL-TRIE-CACHES", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_nl_trie_control_vars", "INITIALIZE-NL-TRIE-CONTROL-VARS", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_nl_trie_syntactic_predicates", "INITIALIZE-NL-TRIE-SYNTACTIC-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_nl_trie_denotation_predicates", "INITIALIZE-NL-TRIE-DENOTATION-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_nl_trie_other_predicates", "INITIALIZE-NL-TRIE-OTHER-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_semtrans_pred_has_pos_specificationP", "NL-TRIE-SEMTRANS-PRED-HAS-POS-SPECIFICATION?", 1, 0, false );
    new $nl_trie_semtrans_pred_has_pos_specificationP$UnaryFunction();
    SubLFiles.declareFunction( me, "nl_trie_abbreviation_pred_p", "NL-TRIE-ABBREVIATION-PRED-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_multi_word_abbreviation_pred_p", "NL-TRIE-MULTI-WORD-ABBREVIATION-PRED-P", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie_multi_word_abbreviation_preds", "CLEAR-NL-TRIE-MULTI-WORD-ABBREVIATION-PREDS", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_nl_trie_multi_word_abbreviation_preds", "REMOVE-NL-TRIE-MULTI-WORD-ABBREVIATION-PREDS", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_multi_word_abbreviation_preds_internal", "NL-TRIE-MULTI-WORD-ABBREVIATION-PREDS-INTERNAL", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_multi_word_abbreviation_preds", "NL-TRIE-MULTI-WORD-ABBREVIATION-PREDS", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_nl_trie_pragmatic_predicates", "INITIALIZE-NL-TRIE-PRAGMATIC-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_syntactic_assertionP", "NL-TRIE-SYNTACTIC-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_semantic_assertionP", "NL-TRIE-SEMANTIC-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_nl_trie_int", "INITIALIZE-NL-TRIE-INT", 0, 1, false );
    SubLFiles.declareFunction( me, "nl_triefy_preds", "NL-TRIEFY-PREDS", 1, 1, false );
    SubLFiles.declareFunction( me, "triefy_mt", "TRIEFY-MT", 1, 1, false );
    SubLFiles.declareFunction( me, "triefy_mt_int", "TRIEFY-MT-INT", 2, 1, false );
    SubLFiles.declareFunction( me, "nl_triefy_pred", "NL-TRIEFY-PRED", 1, 4, false );
    SubLFiles.declareFunction( me, "nl_trie_clear_pred", "NL-TRIE-CLEAR-PRED", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_remove_entries_wXpred", "NL-TRIE-REMOVE-ENTRIES-W/PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "ok_assertion_for_nl_trieP", "OK-ASSERTION-FOR-NL-TRIE?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_return_keyword", "NL-TRIE-RETURN-KEYWORD", 1, 1, false );
    SubLFiles.declareFunction( me, "update_nl_trie_syntactic", "UPDATE-NL-TRIE-SYNTACTIC", 1, 2, false );
    SubLFiles.declareFunction( me, "nl_trie_ok_trie_and_assertionP", "NL-TRIE-OK-TRIE-AND-ASSERTION?", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_triefy_spp_assertion", "NL-TRIEFY-SPP-ASSERTION", 3, 0, false );
    SubLFiles.declareFunction( me, "unique_irregular_form_assertionP", "UNIQUE-IRREGULAR-FORM-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_get_irregular_forms", "NL-TRIE-GET-IRREGULAR-FORMS", 3, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie_spec_predicates", "CLEAR-NL-TRIE-SPEC-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_nl_trie_spec_predicates", "REMOVE-NL-TRIE-SPEC-PREDICATES", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_spec_predicates_internal", "NL-TRIE-SPEC-PREDICATES-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_spec_predicates", "NL-TRIE-SPEC-PREDICATES", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_clean_up_regular_forms", "NL-TRIE-CLEAN-UP-REGULAR-FORMS", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_asserted_word_formP", "NL-TRIE-ASSERTED-WORD-FORM?", 4, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_clean_up_one_regular_form", "NL-TRIE-CLEAN-UP-ONE-REGULAR-FORM", 4, 0, false );
    SubLFiles.declareFunction( me, "find_mod_list", "FIND-MOD-LIST", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_triefy_pos_assertion", "NL-TRIEFY-POS-ASSERTION", 3, 0, false );
    SubLFiles.declareFunction( me, "update_nl_trie_semantic_on_wu", "UPDATE-NL-TRIE-SEMANTIC-ON-WU", 4, 1, false );
    SubLFiles.declareFunction( me, "update_nl_trie_semantic_on_wu_for_pred", "UPDATE-NL-TRIE-SEMANTIC-ON-WU-FOR-PRED", 6, 0, false );
    SubLFiles.declareFunction( me, "update_nl_trie_semantic_assertion", "UPDATE-NL-TRIE-SEMANTIC-ASSERTION", 6, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie_pos_for_semtrans_pred", "CLEAR-NL-TRIE-POS-FOR-SEMTRANS-PRED", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_nl_trie_pos_for_semtrans_pred", "REMOVE-NL-TRIE-POS-FOR-SEMTRANS-PRED", 1, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_pos_for_semtrans_pred_internal", "NL-TRIE-POS-FOR-SEMTRANS-PRED-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_pos_for_semtrans_pred", "NL-TRIE-POS-FOR-SEMTRANS-PRED", 1, 1, false );
    SubLFiles.declareFunction( me, "filter_mod_list_for_pos", "FILTER-MOD-LIST-FOR-POS", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie_pred_ok_for_posP", "CLEAR-NL-TRIE-PRED-OK-FOR-POS?", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_nl_trie_pred_ok_for_posP", "REMOVE-NL-TRIE-PRED-OK-FOR-POS?", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_pred_ok_for_posP_internal", "NL-TRIE-PRED-OK-FOR-POS?-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_pred_ok_for_posP", "NL-TRIE-PRED-OK-FOR-POS?", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie_preds_licensed_by_pos", "CLEAR-NL-TRIE-PREDS-LICENSED-BY-POS", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_nl_trie_preds_licensed_by_pos", "REMOVE-NL-TRIE-PREDS-LICENSED-BY-POS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_preds_licensed_by_pos_internal", "NL-TRIE-PREDS-LICENSED-BY-POS-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_preds_licensed_by_pos", "NL-TRIE-PREDS-LICENSED-BY-POS", 1, 0, false );
    SubLFiles.declareFunction( me, "update_nl_trie_semantic", "UPDATE-NL-TRIE-SEMANTIC", 1, 3, false );
    SubLFiles.declareFunction( me, "nl_triefy_semantic_assertion", "NL-TRIEFY-SEMANTIC-ASSERTION", 4, 0, false );
    SubLFiles.declareFunction( me, "nl_triefy_term_phrases_assertion", "NL-TRIEFY-TERM-PHRASES-ASSERTION", 3, 0, false );
    SubLFiles.declareFunction( me, "add_or_remove_term_phrases_entry", "ADD-OR-REMOVE-TERM-PHRASES-ENTRY", 4, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_insert_term_phrases_entry", "NL-TRIE-INSERT-TERM-PHRASES-ENTRY", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_remove_term_phrases_entry", "NL-TRIE-REMOVE-TERM-PHRASES-ENTRY", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_get_morpho_syntax_from_formula", "NL-TRIE-GET-MORPHO-SYNTAX-FROM-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_semantic_support_pos", "NL-TRIE-SEMANTIC-SUPPORT-POS", 1, 0, false );
    SubLFiles.declareFunction( me, "semantic_update_triggered_by_syntactic_update_new", "SEMANTIC-UPDATE-TRIGGERED-BY-SYNTACTIC-UPDATE-NEW", 3, 0, false );
    SubLFiles.declareFunction( me, "make_nl_trie_syntactic_support_sentence", "MAKE-NL-TRIE-SYNTACTIC-SUPPORT-SENTENCE", 4, 0, false );
    SubLFiles.declareFunction( me, "semantic_update_triggered_by_incremental_semantic_update_new", "SEMANTIC-UPDATE-TRIGGERED-BY-INCREMENTAL-SEMANTIC-UPDATE-NEW", 3, 0, false );
    SubLFiles.declareFunction( me, "inc_sem_from_preds_new", "INC-SEM-FROM-PREDS-NEW", 3, 0, false );
    SubLFiles.declareFunction( me, "inc_sem_from_preds_syntactic_supports", "INC-SEM-FROM-PREDS-SYNTACTIC-SUPPORTS", 3, 0, false );
    SubLFiles.declareFunction( me, "inc_sem_from_pos_new", "INC-SEM-FROM-POS-NEW", 3, 0, false );
    SubLFiles.declareFunction( me, "find_string_mt_pairs_for_closed_class_word", "FIND-STRING-MT-PAIRS-FOR-CLOSED-CLASS-WORD", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_assemble_strings", "NL-TRIE-ASSEMBLE-STRINGS", 3, 0, false );
    SubLFiles.declareFunction( me, "new_nl_trie_denot_set", "NEW-NL-TRIE-DENOT-SET", 0, 1, false );
    SubLFiles.declareFunction( me, "nl_triefy_arg_in_reln_assertion", "NL-TRIEFY-ARG-IN-RELN-ASSERTION", 3, 1, false );
    SubLFiles.declareFunction( me, "nl_triefy_arg_in_reln_wX_mod_list", "NL-TRIEFY-ARG-IN-RELN-W/-MOD-LIST", 8, 0, false );
    SubLFiles.declareFunction( me, "nl_triefy_arg_in_reln_wXo_mod_list", "NL-TRIEFY-ARG-IN-RELN-W/O-MOD-LIST", 8, 0, false );
    SubLFiles.declareFunction( me, "nl_triefy_abbr_lex_word_assertion", "NL-TRIEFY-ABBR-LEX-WORD-ASSERTION", 3, 0, false );
    SubLFiles.declareFunction( me, "get_denot_for_abbr_lex_word_assertion", "GET-DENOT-FOR-ABBR-LEX-WORD-ASSERTION", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_triefy_abbr_cps_assertion", "NL-TRIEFY-ABBR-CPS-ASSERTION", 3, 0, false );
    SubLFiles.declareFunction( me, "get_denot_for_abbr_cps_assertion", "GET-DENOT-FOR-ABBR-CPS-ASSERTION", 4, 0, false );
    SubLFiles.declareFunction( me, "nl_triefy_abbr_mws_assertion", "NL-TRIEFY-ABBR-MWS-ASSERTION", 3, 0, false );
    SubLFiles.declareFunction( me, "get_denot_for_abbr_mws_assertion", "GET-DENOT-FOR-ABBR-MWS-ASSERTION", 4, 0, false );
    SubLFiles.declareFunction( me, "nl_triefy_name_string", "NL-TRIEFY-NAME-STRING", 3, 0, false );
    SubLFiles.declareFunction( me, "add_or_remove_nl_trie_word", "ADD-OR-REMOVE-NL-TRIE-WORD", 4, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_insert_low", "NL-TRIE-INSERT-LOW", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_eqify_key", "NL-TRIE-EQIFY-KEY", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_insert_word", "NL-TRIE-INSERT-WORD", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_closed_lexical_class_entryP", "NL-TRIE-CLOSED-LEXICAL-CLASS-ENTRY?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_entry_case_matches_stringP", "NL-TRIE-ENTRY-CASE-MATCHES-STRING?", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_augment_word", "NL-TRIE-AUGMENT-WORD", 2, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_delete_word", "NL-TRIE-DELETE-WORD", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_unassociate", "NL-TRIE-UNASSOCIATE", 2, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_syntactic_orphanP", "NL-TRIE-SYNTACTIC-ORPHAN?", 2, 0, false );
    SubLFiles.declareFunction( me, "unifiable_word_entriesP", "UNIFIABLE-WORD-ENTRIES?", 2, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_words_case_identicalP", "NL-TRIE-WORDS-CASE-IDENTICAL?", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_syntax_unifiable_p", "NL-TRIE-SYNTAX-UNIFIABLE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_semantics_unifiable_p", "NL-TRIE-SEMANTICS-UNIFIABLE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_pragmatics_unifiable_p", "NL-TRIE-PRAGMATICS-UNIFIABLE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_semantic_pred_unifiable_p", "NL-TRIE-SEMANTIC-PRED-UNIFIABLE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_semantics_mt_unifiable_p", "NL-TRIE-SEMANTICS-MT-UNIFIABLE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_no_new_syntax_p", "NL-TRIE-NO-NEW-SYNTAX-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_no_new_semantics_p", "NL-TRIE-NO-NEW-SEMANTICS-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_pos_unifiable_p", "NL-TRIE-POS-UNIFIABLE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_frame_unifiable_p", "NL-TRIE-FRAME-UNIFIABLE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_wu_unifiable_p", "NL-TRIE-WU-UNIFIABLE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_syntax_mt_unifiable_p", "NL-TRIE-SYNTAX-MT-UNIFIABLE-P", 2, 0, false );
    SubLFiles.declareFunction( me, "update_nl_trie_name", "UPDATE-NL-TRIE-NAME", 4, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_insert_name", "NL-TRIE-INSERT-NAME", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_redundantP", "NL-TRIE-NAME-REDUNDANT?", 2, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_delete_name", "NL-TRIE-DELETE-NAME", 3, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_strings_of_wuXpos", "NL-TRIE-STRINGS-OF-WU&POS", 3, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie_preds_of_pos", "CLEAR-NL-TRIE-PREDS-OF-POS", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_nl_trie_preds_of_pos", "REMOVE-NL-TRIE-PREDS-OF-POS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_preds_of_pos_internal", "NL-TRIE-PREDS-OF-POS-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_preds_of_pos", "NL-TRIE-PREDS-OF-POS", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie_pos_of_pred", "CLEAR-NL-TRIE-POS-OF-PRED", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_nl_trie_pos_of_pred", "REMOVE-NL-TRIE-POS-OF-PRED", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_pos_of_pred_internal", "NL-TRIE-POS-OF-PRED-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_pos_of_pred", "NL-TRIE-POS-OF-PRED", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_strings_of_word_unit", "NL-TRIE-STRINGS-OF-WORD-UNIT", 3, 1, false );
    SubLFiles.declareFunction( me, "nl_trie_string_tokenize", "NL-TRIE-STRING-TOKENIZE", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_string_tokenize_multiple", "NL-TRIE-STRING-TOKENIZE-MULTIPLE", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_single_token_stringP", "NL-TRIE-SINGLE-TOKEN-STRING?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_strings_keys", "NL-TRIE-STRINGS-KEYS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_standardize_strings", "NL-TRIE-STANDARDIZE-STRINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_standardize_strings_int", "NL-TRIE-STANDARDIZE-STRINGS-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_break_char_exception_string_p", "NL-TRIE-BREAK-CHAR-EXCEPTION-STRING-P", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_break_char_p", "NL-TRIE-BREAK-CHAR-P", 1, 0, false );
    new $nl_trie_break_char_p$UnaryFunction();
    SubLFiles.declareFunction( me, "nl_trie_not_present_message", "NL-TRIE-NOT-PRESENT-MESSAGE", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_warn_bad_add", "NL-TRIE-WARN-BAD-ADD", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_warn_bad_remove", "NL-TRIE-WARN-BAD-REMOVE", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_warn", "NL-TRIE-WARN", 2, 4, false );
    SubLFiles.declareFunction( me, "nl_trie_error", "NL-TRIE-ERROR", 1, 4, false );
    SubLFiles.declareFunction( me, "nl_trie_syntactic_preds_for_pos", "NL-TRIE-SYNTACTIC-PREDS-FOR-POS", 1, 0, false );
    SubLFiles.declareFunction( me, "find_morphologically_derivable_strings", "FIND-MORPHOLOGICALLY-DERIVABLE-STRINGS", 4, 0, false );
    SubLFiles.declareFunction( me, "get_nl_trie_name_pragmatic_features", "GET-NL-TRIE-NAME-PRAGMATIC-FEATURES", 1, 0, false );
    SubLFiles.declareFunction( me, "get_assertion_pragmatic_features", "GET-ASSERTION-PRAGMATIC-FEATURES", 1, 0, false );
    SubLFiles.declareFunction( me, "get_pragmatic_features", "GET-PRAGMATIC-FEATURES", 2, 0, false );
    SubLFiles.declareFunction( me, "find_pos_preds_for_lex_const_internal", "FIND-POS-PREDS-FOR-LEX-CONST-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "find_pos_preds_for_lex_const", "FIND-POS-PREDS-FOR-LEX-CONST", 1, 0, false );
    SubLFiles.declareFunction( me, "remove_genl_pos_preds", "REMOVE-GENL-POS-PREDS", 1, 0, false );
    SubLFiles.declareFunction( me, "find_pos_for_lex_const", "FIND-POS-FOR-LEX-CONST", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_syntactic_predP", "NL-TRIE-SYNTACTIC-PRED?", 1, 0, false );
    new $nl_trie_syntactic_predP$UnaryFunction();
    SubLFiles.declareFunction( me, "english_lexical_mtP", "ENGLISH-LEXICAL-MT?", 1, 0, false );
    SubLFiles.declareFunction( me, "has_pos_of_predP", "HAS-POS-OF-PRED?", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_semantic_predP", "NL-TRIE-SEMANTIC-PRED?", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_nl_trie_name_string_preds", "CLEAR-NL-TRIE-NAME-STRING-PREDS", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_nl_trie_name_string_preds", "INITIALIZE-NL-TRIE-NAME-STRING-PREDS", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_string_preds", "NL-TRIE-NAME-STRING-PREDS", 0, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_name_string_predP", "NL-TRIE-NAME-STRING-PRED?", 1, 0, false );
    new $nl_trie_name_string_predP$UnaryFunction();
    SubLFiles.declareFunction( me, "nl_trie_pragmatic_predP", "NL-TRIE-PRAGMATIC-PRED?", 1, 0, false );
    SubLFiles.declareFunction( me, "triefy_reifiable_function_extent", "TRIEFY-REIFIABLE-FUNCTION-EXTENT", 1, 0, false );
    SubLFiles.declareFunction( me, "triefy_nart", "TRIEFY-NART", 1, 0, false );
    SubLFiles.declareFunction( me, "new_nl_trie_iterator", "NEW-NL-TRIE-ITERATOR", 0, 1, false );
    SubLFiles.declareFunction( me, "make_nl_trie_iterator_state", "MAKE-NL-TRIE-ITERATOR-STATE", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_iterator_done", "NL-TRIE-ITERATOR-DONE", 1, 0, false );
    SubLFiles.declareFunction( me, "nl_trie_iterator_next", "NL-TRIE-ITERATOR-NEXT", 1, 0, false );
    SubLFiles.declareFunction( me, "test_swappable_nl_trie_dump", "TEST-SWAPPABLE-NL-TRIE-DUMP", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_nl_trie_file()
  {
    $nl_trie_default_test$ = SubLFiles.deflexical( "*NL-TRIE-DEFAULT-TEST*", Symbols.symbol_function( EQUALP ) );
    $default_nl_trie_cache_strategy_size$ = SubLFiles.deflexical( "*DEFAULT-NL-TRIE-CACHE-STRATEGY-SIZE*", $int3$6000 );
    $nl_trie_cache_strategy$ = SubLFiles.deflexical( "*NL-TRIE-CACHE-STRATEGY*", maybeDefault( $sym4$_NL_TRIE_CACHE_STRATEGY_, $nl_trie_cache_strategy$, () -> ( cache_utilities.new_metered_preallocated_cache(
        $default_nl_trie_cache_strategy_size$.getGlobalValue(), $nl_trie_default_test$.getGlobalValue() ) ) ) );
    $nl_trie_lock$ = SubLFiles.deflexical( "*NL-TRIE-LOCK*", maybeDefault( $sym8$_NL_TRIE_LOCK_, $nl_trie_lock$, () -> ( Locks.make_lock( $str9$NL_Trie_Lock ) ) ) );
    $english_definite_determiner$ = SubLFiles.defconstant( "*ENGLISH-DEFINITE-DETERMINER*", $str22$the );
    $nl_trie_word_denot_invalidity_tests$ = SubLFiles.deflexical( "*NL-TRIE-WORD-DENOT-INVALIDITY-TESTS*", $list99 );
    $dtp_nl_trie_word_struc$ = SubLFiles.defconstant( "*DTP-NL-TRIE-WORD-STRUC*", $sym106$NL_TRIE_WORD_STRUC );
    $cfasl_opcode_nl_trie_word_struc$ = SubLFiles.defconstant( "*CFASL-OPCODE-NL-TRIE-WORD-STRUC*", $int133$71 );
    $nl_trie_word_semantic_support_set_test$ = SubLFiles.deflexical( "*NL-TRIE-WORD-SEMANTIC-SUPPORT-SET-TEST*", Symbols.symbol_function( EQUALP ) );
    $nl_trie_word_syntactic_support_set_test$ = SubLFiles.deflexical( "*NL-TRIE-WORD-SYNTACTIC-SUPPORT-SET-TEST*", Symbols.symbol_function( EQUALP ) );
    $call_to_nl_trie_word_syntactic_supports_licensedP$ = SubLFiles.defparameter( "*CALL-TO-NL-TRIE-WORD-SYNTACTIC-SUPPORTS-LICENSED?*", NIL );
    $call_to_nl_trie_word_semantic_supports_licensedP$ = SubLFiles.defparameter( "*CALL-TO-NL-TRIE-WORD-SEMANTIC-SUPPORTS-LICENSED?*", NIL );
    $nl_trie_closed_class_pos_preds_caching_state$ = SubLFiles.deflexical( "*NL-TRIE-CLOSED-CLASS-POS-PREDS-CACHING-STATE*", NIL );
    $nl_trie_preferred_semantic_predicates$ = SubLFiles.deflexical( "*NL-TRIE-PREFERRED-SEMANTIC-PREDICATES*", $list192 );
    $nl_trie_lexical_mt$ = SubLFiles.deflexical( "*NL-TRIE-LEXICAL-MT*", maybeDefault( $sym231$_NL_TRIE_LEXICAL_MT_, $nl_trie_lexical_mt$, $const232$AllLexicalMicrotheoryPSC ) );
    $nl_trie_syntactic_predicates$ = SubLFiles.deflexical( "*NL-TRIE-SYNTACTIC-PREDICATES*", ( maybeDefault( $sym233$_NL_TRIE_SYNTACTIC_PREDICATES_, $nl_trie_syntactic_predicates$, $kw234$UNINITIALIZED ) ) );
    $nl_trie_denotation_predicates$ = SubLFiles.deflexical( "*NL-TRIE-DENOTATION-PREDICATES*", ( maybeDefault( $sym235$_NL_TRIE_DENOTATION_PREDICATES_, $nl_trie_denotation_predicates$, $kw234$UNINITIALIZED ) ) );
    $nl_trie_semtrans_predicates$ = SubLFiles.deflexical( "*NL-TRIE-SEMTRANS-PREDICATES*", ( maybeDefault( $sym236$_NL_TRIE_SEMTRANS_PREDICATES_, $nl_trie_semtrans_predicates$, $kw234$UNINITIALIZED ) ) );
    $nl_trie_abbreviation_predicates$ = SubLFiles.deflexical( "*NL-TRIE-ABBREVIATION-PREDICATES*", ( maybeDefault( $sym237$_NL_TRIE_ABBREVIATION_PREDICATES_, $nl_trie_abbreviation_predicates$, $kw234$UNINITIALIZED ) ) );
    $nl_trie_arg_in_reln_predicates$ = SubLFiles.deflexical( "*NL-TRIE-ARG-IN-RELN-PREDICATES*", ( maybeDefault( $sym238$_NL_TRIE_ARG_IN_RELN_PREDICATES_, $nl_trie_arg_in_reln_predicates$, $kw234$UNINITIALIZED ) ) );
    $nl_trie_pragmatic_predicates$ = SubLFiles.deflexical( "*NL-TRIE-PRAGMATIC-PREDICATES*", ( maybeDefault( $sym239$_NL_TRIE_PRAGMATIC_PREDICATES_, $nl_trie_pragmatic_predicates$, $kw234$UNINITIALIZED ) ) );
    $nl_tries_being_initialized$ = SubLFiles.defparameter( "*NL-TRIES-BEING-INITIALIZED*", NIL );
    $nl_trie$ = SubLFiles.deflexical( "*NL-TRIE*", maybeDefault( $sym245$_NL_TRIE_, $nl_trie$, () -> ( new_nl_trie( UNPROVIDED ) ) ) );
    $nl_trie_entry_filter_stack$ = SubLFiles.defparameter( "*NL-TRIE-ENTRY-FILTER-STACK*", NIL );
    $nl_trie_multi_word_abbreviation_preds_caching_state$ = SubLFiles.deflexical( "*NL-TRIE-MULTI-WORD-ABBREVIATION-PREDS-CACHING-STATE*", NIL );
    $catch_nl_trie_errorsP$ = SubLFiles.defparameter( "*CATCH-NL-TRIE-ERRORS?*", T );
    $nl_trie_spec_predicates_caching_state$ = SubLFiles.deflexical( "*NL-TRIE-SPEC-PREDICATES-CACHING-STATE*", NIL );
    $nl_trie_pos_for_semtrans_pred_caching_state$ = SubLFiles.deflexical( "*NL-TRIE-POS-FOR-SEMTRANS-PRED-CACHING-STATE*", NIL );
    $nl_trie_pred_ok_for_posP_caching_state$ = SubLFiles.deflexical( "*NL-TRIE-PRED-OK-FOR-POS?-CACHING-STATE*", NIL );
    $nl_trie_preds_licensed_by_pos_caching_state$ = SubLFiles.deflexical( "*NL-TRIE-PREDS-LICENSED-BY-POS-CACHING-STATE*", NIL );
    $nl_trie_denot_set_test$ = SubLFiles.deflexical( "*NL-TRIE-DENOT-SET-TEST*", Symbols.symbol_function( EQUALP ) );
    $nl_trie_preds_of_pos_caching_state$ = SubLFiles.deflexical( "*NL-TRIE-PREDS-OF-POS-CACHING-STATE*", NIL );
    $nl_trie_pos_of_pred_caching_state$ = SubLFiles.deflexical( "*NL-TRIE-POS-OF-PRED-CACHING-STATE*", NIL );
    $nl_trie_break_list$ = SubLFiles.defparameter( "*NL-TRIE-BREAK-LIST*", $list382 );
    $nl_trie_use_two_letter_stringsP$ = SubLFiles.defparameter( "*NL-TRIE-USE-TWO-LETTER-STRINGS?*", NIL );
    $nl_trie_warning_level$ = SubLFiles.defparameter( "*NL-TRIE-WARNING-LEVEL*", ONE_INTEGER );
    $nl_trie_break_on_errorP$ = SubLFiles.defparameter( "*NL-TRIE-BREAK-ON-ERROR?*", NIL );
    $nl_trie_include_derived_formsP$ = SubLFiles.defparameter( "*NL-TRIE-INCLUDE-DERIVED-FORMS?*", T );
    $nl_trie_name_string_preds_set$ = SubLFiles.deflexical( "*NL-TRIE-NAME-STRING-PREDS-SET*", maybeDefault( $sym398$_NL_TRIE_NAME_STRING_PREDS_SET_, $nl_trie_name_string_preds_set$, () -> ( lexicon_vars
        .new_lex_pred_set() ) ) );
    return NIL;
  }
  ...
  public static SubLObject setup_nl_trie_file()
  {
    ...
    lexicon_vars.declare_noop_updates_for_lexicon_global( $sym1$_NL_TRIE_CODE_REVISION_, $list2 );
    subl_macro_promotions.declare_defglobal( $sym4$_NL_TRIE_CACHE_STRATEGY_ );
    subl_macro_promotions.declare_defglobal( $sym8$_NL_TRIE_LOCK_ );
    memoization_state.note_memoized_function( $sym16$VALIDATE_NL_TRIE_ENTRY );
    memoization_state.note_memoized_function( $sym47$NL_TRIE_DONT_ADD_THE_CATEGORIES );
    memoization_state.note_memoized_function( $sym52$NL_TRIE_DONT_ADD_THE_TERMS );
    memoization_state.note_memoized_function( $sym55$NL_TRIE_NAME_PRED_OK_FOR_ADDING_THE_ );
    access_macros.register_macro_helper( $sym74$NL_TRIE_NAME_STRING_MACRO_HELPER, $sym78$DO_NL_TRIE_ENTRY_STRINGS );
    memoization_state.note_memoized_function( $sym91$NL_TRIE_WORD_STRUC_VALID_P );
    memoization_state.note_memoized_function( $sym92$NL_TRIE_VALID_ASSERTION__MEMOIZED );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_nl_trie_word_struc$.getGlobalValue(), Symbols.symbol_function( $sym114$NL_TRIE_WORD_STRUC_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list115 );
    Structures.def_csetf( $sym116$NL_TRIE_WORD_STRUC_SYNTACTIC_SUPPORTS, $sym117$_CSETF_NL_TRIE_WORD_STRUC_SYNTACTIC_SUPPORTS );
    Structures.def_csetf( $sym118$NL_TRIE_WORD_STRUC_SEMANTIC_SUPPORTS, $sym119$_CSETF_NL_TRIE_WORD_STRUC_SEMANTIC_SUPPORTS );
    Equality.identity( $sym106$NL_TRIE_WORD_STRUC );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_nl_trie_word_struc$.getGlobalValue(), Symbols.symbol_function(
        $sym127$VISIT_DEFSTRUCT_OBJECT_NL_TRIE_WORD_STRUC_METHOD ) );
    Structures.register_method( Sxhash.$sxhash_method_table$.getGlobalValue(), $dtp_nl_trie_word_struc$.getGlobalValue(), Symbols.symbol_function( $sym129$SXHASH_NL_TRIE_WORD_STRUC_METHOD ) );
    cfasl.register_cfasl_input_function( $cfasl_opcode_nl_trie_word_struc$.getGlobalValue(), $sym134$CFASL_INPUT_NL_TRIE_WORD_STRUC );
    Structures.register_method( cfasl.$cfasl_output_object_method_table$.getGlobalValue(), $dtp_nl_trie_word_struc$.getGlobalValue(), Symbols.symbol_function( $sym135$CFASL_OUTPUT_OBJECT_NL_TRIE_WORD_STRUC_METHOD ) );
    memoization_state.note_memoized_function( $sym149$NL_TRIE_WORD_SEMANTIC_SUPPORT_DENOTS );
    memoization_state.note_memoized_function( $sym151$NL_TRIE_WORD_SEMANTIC_SUPPORT_SEMTRANS_TEMPLATES );
    memoization_state.note_globally_cached_function( $sym153$NL_TRIE_CLOSED_CLASS_POS_PREDS );
    memoization_state.note_memoized_function( $sym175$NL_TRIE_WORD_POS );
    access_macros.register_macro_helper( $sym191$NL_TRIE_PREFERRED_SEMANTIC_SUPPORT_, $sym67$DO_NL_TRIE_WORD_DENOTS );
    access_macros.register_macro_helper( $sym209$NL_TRIE_WORD_HEAD_STRING_MACRO_HELPER, $sym76$DO_NL_TRIE_WORD_STRINGS );
    access_macros.register_macro_helper( $sym211$NL_TRIE_WORD_LEADING_STRINGS_FROM_SUPPORT_MACRO_HELPER, $sym76$DO_NL_TRIE_WORD_STRINGS );
    access_macros.register_macro_helper( $sym212$NL_TRIE_WORD_FOLLOWING_STRINGS_FROM_SUPPORT_MACRO_HELPER, $sym76$DO_NL_TRIE_WORD_STRINGS );
    access_macros.register_macro_helper( $sym213$NL_TRIE_ASSEMBLE_STRINGS_MACRO_HELPER, $sym76$DO_NL_TRIE_WORD_STRINGS );
    memoization_state.note_memoized_function( $sym227$NL_TRIE_RECORD_P );
    subl_macro_promotions.declare_defglobal( $sym231$_NL_TRIE_LEXICAL_MT_ );
    subl_macro_promotions.declare_defglobal( $sym233$_NL_TRIE_SYNTACTIC_PREDICATES_ );
    subl_macro_promotions.declare_defglobal( $sym235$_NL_TRIE_DENOTATION_PREDICATES_ );
    subl_macro_promotions.declare_defglobal( $sym236$_NL_TRIE_SEMTRANS_PREDICATES_ );
    subl_macro_promotions.declare_defglobal( $sym237$_NL_TRIE_ABBREVIATION_PREDICATES_ );
    subl_macro_promotions.declare_defglobal( $sym238$_NL_TRIE_ARG_IN_RELN_PREDICATES_ );
    subl_macro_promotions.declare_defglobal( $sym239$_NL_TRIE_PRAGMATIC_PREDICATES_ );
    subl_macro_promotions.declare_defglobal( $sym245$_NL_TRIE_ );
    memoization_state.note_memoized_function( $sym265$NL_TRIE_SEARCH_CASE_SENSITIVE );
    memoization_state.note_memoized_function( $sym267$NL_TRIE_SEARCH_CASE_INSENSITIVE );
    memoization_state.note_memoized_function( $sym268$NL_TRIE_SEARCH_CASE_SENSITIVE_PREFERRED );
    memoization_state.note_globally_cached_function( $sym312$NL_TRIE_MULTI_WORD_ABBREVIATION_PREDS );
    memoization_state.note_globally_cached_function( $sym338$NL_TRIE_SPEC_PREDICATES );
    memoization_state.note_globally_cached_function( $sym346$NL_TRIE_POS_FOR_SEMTRANS_PRED );
    memoization_state.note_globally_cached_function( $sym349$NL_TRIE_PRED_OK_FOR_POS_ );
    memoization_state.note_globally_cached_function( $sym354$NL_TRIE_PREDS_LICENSED_BY_POS );
    memoization_state.note_globally_cached_function( $sym376$NL_TRIE_PREDS_OF_POS );
    memoization_state.note_globally_cached_function( $sym380$NL_TRIE_POS_OF_PRED );
    memoization_state.note_memoized_function( $sym395$FIND_POS_PREDS_FOR_LEX_CONST );
    subl_macro_promotions.declare_defglobal( $sym398$_NL_TRIE_NAME_STRING_PREDS_SET_ );
    generic_testing.define_test_case_table_int( $sym406$NL_TRIE_STRING_TOKENIZE, ConsesLow.list( new SubLObject[] { $kw407$TEST, EQUAL, $kw408$OWNER, NIL, $kw409$CLASSES, $list410, $kw411$KB, $kw412$FULL,
      $kw413$WORKING_, T
    } ), $list414 );
    generic_testing.define_test_case_table_int( $sym415$TEST_SWAPPABLE_NL_TRIE_DUMP, ConsesLow.list( new SubLObject[] { $kw407$TEST, NIL, $kw408$OWNER, NIL, $kw409$CLASSES, NIL, $kw411$KB, $kw416$TINY, $kw413$WORKING_, T
    } ), $list417 );
    return NIL;
  }
  ...
  {
    me = new nl_trie();
    $nl_trie_default_test$ = null;
    $default_nl_trie_cache_strategy_size$ = null;
    $nl_trie_cache_strategy$ = null;
    $nl_trie_lock$ = null;
    $english_definite_determiner$ = null;
    $nl_trie_word_denot_invalidity_tests$ = null;
    $dtp_nl_trie_word_struc$ = null;
    $cfasl_opcode_nl_trie_word_struc$ = null;
    $nl_trie_word_semantic_support_set_test$ = null;
    $nl_trie_word_syntactic_support_set_test$ = null;
    $call_to_nl_trie_word_syntactic_supports_licensedP$ = null;
    $call_to_nl_trie_word_semantic_supports_licensedP$ = null;
    $nl_trie_closed_class_pos_preds_caching_state$ = null;
    $nl_trie_preferred_semantic_predicates$ = null;
    $nl_trie_lexical_mt$ = null;
    $nl_trie_syntactic_predicates$ = null;
    $nl_trie_denotation_predicates$ = null;
    $nl_trie_semtrans_predicates$ = null;
    $nl_trie_abbreviation_predicates$ = null;
    $nl_trie_arg_in_reln_predicates$ = null;
    $nl_trie_pragmatic_predicates$ = null;
    $nl_tries_being_initialized$ = null;
    $nl_trie$ = null;
    $nl_trie_entry_filter_stack$ = null;
    $nl_trie_multi_word_abbreviation_preds_caching_state$ = null;
    $catch_nl_trie_errorsP$ = null;
    $nl_trie_spec_predicates_caching_state$ = null;
    $nl_trie_pos_for_semtrans_pred_caching_state$ = null;
    $nl_trie_pred_ok_for_posP_caching_state$ = null;
    $nl_trie_preds_licensed_by_pos_caching_state$ = null;
    $nl_trie_denot_set_test$ = null;
    $nl_trie_preds_of_pos_caching_state$ = null;
    $nl_trie_pos_of_pred_caching_state$ = null;
    $nl_trie_break_list$ = null;
    $nl_trie_use_two_letter_stringsP$ = null;
    $nl_trie_warning_level$ = null;
    $nl_trie_break_on_errorP$ = null;
    $nl_trie_include_derived_formsP$ = null;
    $nl_trie_name_string_preds_set$ = null;
    $str0$_Revision__142735__ = makeString( "$Revision: 142735 $" );
    $sym1$_NL_TRIE_CODE_REVISION_ = makeSymbol( "*NL-TRIE-CODE-REVISION*" );
    $list2 = ConsesLow.list( new SubLObject[] { ConsesLow.list( makeString( "1.195" ), makeString( "1.196" ) ), ConsesLow.list( makeString( "1.196" ), makeString( "1.197" ) ), ConsesLow.list( makeString( "1.197" ),
        makeString( "1.198" ) ), ConsesLow.list( makeString( "1.198" ), makeString( "1.199" ) ), ConsesLow.list( makeString( "1.199" ), makeString( "1.200" ) ), ConsesLow.list( makeString( "1.200" ), makeString(
            "1.201" ) ), ConsesLow.list( makeString( "1.201" ), makeString( "1.202" ) ), ConsesLow.list( makeString( "1.202" ), makeString( "1.203" ) ), ConsesLow.list( makeString( "1.203" ), makeString( "1.204" ) ),
      ConsesLow.list( makeString( "1.204" ), makeString( "1.205" ) ), ConsesLow.list( makeString( "1.205" ), makeString( "1.206" ) ), ConsesLow.list( makeString( "1.206" ), makeString( "1.207" ) ), ConsesLow.list(
          makeString( "1.207" ), makeString( "1.208" ) ), ConsesLow.list( makeString( "1.219" ), makeString( "1.220" ) ), ConsesLow.list( makeString( "1.222" ), makeString( "1.223" ) ), ConsesLow.list( makeString(
              "1.228" ), makeString( "1.229" ) )
    } );
    $int3$6000 = makeInteger( 6000 );
    $sym4$_NL_TRIE_CACHE_STRATEGY_ = makeSymbol( "*NL-TRIE-CACHE-STRATEGY*" );
    $sym5$WITH_BACKED_MAP_CACHE_STRATEGY = makeSymbol( "WITH-BACKED-MAP-CACHE-STRATEGY" );
    $list6 = ConsesLow.list( makeSymbol( "*NL-TRIE-CACHE-STRATEGY*" ) );
    $list7 = ConsesLow.list( NIL );
    $sym8$_NL_TRIE_LOCK_ = makeSymbol( "*NL-TRIE-LOCK*" );
    $str9$NL_Trie_Lock = makeString( "NL Trie Lock" );
    $list10 = ConsesLow.list( ConsesLow.list( makeSymbol( "REASON" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym11$WITH_LOCK_HELD = makeSymbol( "WITH-LOCK-HELD" );
    $kw12$WHOSTATE = makeKeyword( "WHOSTATE" );
    $sym13$WITH_FILE_VECTOR_BACKED_MAP_STREAM_LOCK = makeSymbol( "WITH-FILE-VECTOR-BACKED-MAP-STREAM-LOCK" );
    $list14 = ConsesLow.list( makeSymbol( "*NL-TRIE-LOCK*" ) );
    $const15$termPhrases = constant_handles.reader_make_constant_shell( makeString( "termPhrases" ) );
    $sym16$VALIDATE_NL_TRIE_ENTRY = makeSymbol( "VALIDATE-NL-TRIE-ENTRY" );
    $int17$200 = makeInteger( 200 );
    $sym18$GET = makeSymbol( "GET" );
    $kw19$NAME = makeKeyword( "NAME" );
    $kw20$WORD = makeKeyword( "WORD" );
    $kw21$STRING = makeKeyword( "STRING" );
    $str22$the = makeString( "the" );
    $kw23$OFF = makeKeyword( "OFF" );
    $list24 = ConsesLow.list( ConsesLow.list( makeSymbol( "NAME" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym25$STRIE = makeUninternedSymbol( "STRIE" );
    $sym26$KEY = makeUninternedSymbol( "KEY" );
    $sym27$ENTRIES = makeUninternedSymbol( "ENTRIES" );
    $sym28$WITH_NL_TRIE_CACHE_STRATEGY = makeSymbol( "WITH-NL-TRIE-CACHE-STRATEGY" );
    $sym29$CLET = makeSymbol( "CLET" );
    $list30 = ConsesLow.list( ConsesLow.list( makeSymbol( "MAP-GET" ), ConsesLow.list( makeSymbol( "GET-NL-TRIE" ) ), makeString( "the" ) ) );
    $sym31$WITH_NL_TRIE_LOCK_HELD = makeSymbol( "WITH-NL-TRIE-LOCK-HELD" );
    $list32 = ConsesLow.list( makeString( "NL Trie Names with Added The" ) );
    $sym33$DO_STRIE_PROGRESS = makeSymbol( "DO-STRIE-PROGRESS" );
    $list34 = ConsesLow.list( makeKeyword( "PROGRESS-NOTE" ), makeString( "Finding NL trie names with added 'the'..." ) );
    $sym35$CDOLIST = makeSymbol( "CDOLIST" );
    $sym36$PWHEN = makeSymbol( "PWHEN" );
    $sym37$CAND = makeSymbol( "CAND" );
    $sym38$NL_TRIE_NAME_P = makeSymbol( "NL-TRIE-NAME-P" );
    $sym39$CNOT = makeSymbol( "CNOT" );
    $sym40$SUBSTRING_MATCH_ = makeSymbol( "SUBSTRING-MATCH?" );
    $sym41$NL_TRIE_NAME_STRING = makeSymbol( "NL-TRIE-NAME-STRING" );
    $list42 = ConsesLow.list( makeString( "the " ), ZERO_INTEGER, ConsesLow.list( makeSymbol( "FUNCTION" ), EQUALP ) );
    $const43$Noun = constant_handles.reader_make_constant_shell( makeString( "Noun" ) );
    $const44$EnglishLexiconMt = constant_handles.reader_make_constant_shell( makeString( "EnglishLexiconMt" ) );
    $const45$properNounStrings = constant_handles.reader_make_constant_shell( makeString( "properNounStrings" ) );
    $sym46$SPEC_PREDICATE_ = makeSymbol( "SPEC-PREDICATE?" );
    $sym47$NL_TRIE_DONT_ADD_THE_CATEGORIES = makeSymbol( "NL-TRIE-DONT-ADD-THE-CATEGORIES" );
    $sym48$_COLLECTION = makeSymbol( "?COLLECTION" );
    $list49 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "dontAddTheToNamesOfInstances" ) ), makeSymbol( "?COLLECTION" ) );
    $const50$MtUnionFn = constant_handles.reader_make_constant_shell( makeString( "MtUnionFn" ) );
    $const51$EnglishMt = constant_handles.reader_make_constant_shell( makeString( "EnglishMt" ) );
    $sym52$NL_TRIE_DONT_ADD_THE_TERMS = makeSymbol( "NL-TRIE-DONT-ADD-THE-TERMS" );
    ...
    $sym55$NL_TRIE_NAME_PRED_OK_FOR_ADDING_THE_ = makeSymbol( "NL-TRIE-NAME-PRED-OK-FOR-ADDING-THE?" );
    $const56$dontAddTheToNamesWithPred = constant_handles.reader_make_constant_shell( makeString( "dontAddTheToNamesWithPred" ) );
    $kw57$CYC_POS = makeKeyword( "CYC-POS" );
    $kw58$PREDICATE = makeKeyword( "PREDICATE" );
    $kw59$DENOTS = makeKeyword( "DENOTS" );
    $list60 = ConsesLow.list( ConsesLow.list( makeSymbol( "DENOT" ), makeSymbol( "ENTRY" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym61$PCOND = makeSymbol( "PCOND" );
    $list62 = ConsesLow.list( T );
    $sym63$NL_TRIE_NAME_DENOT = makeSymbol( "NL-TRIE-NAME-DENOT" );
    $sym64$NL_TRIE_TERM_PHRASES_ENTRY_P = makeSymbol( "NL-TRIE-TERM-PHRASES-ENTRY-P" );
    $sym65$GAF_ARG1 = makeSymbol( "GAF-ARG1" );
    $sym66$NL_TRIE_WORD_P = makeSymbol( "NL-TRIE-WORD-P" );
    $sym67$DO_NL_TRIE_WORD_DENOTS = makeSymbol( "DO-NL-TRIE-WORD-DENOTS" );
    $kw68$CYC_SUBLOOP = makeKeyword( "CYC-SUBLOOP" );
    $kw69$CYC_NL = makeKeyword( "CYC-NL" );
    $sym70$LEX_ENTRY_P = makeSymbol( "LEX-ENTRY-P" );
    $sym71$NL_TRIE_LEX_ENTRY_GET = makeSymbol( "NL-TRIE-LEX-ENTRY-GET" );
    $list72 = ConsesLow.list( makeKeyword( "DENOTS" ) );
    $list73 = ConsesLow.list( ConsesLow.list( makeSymbol( "STRING" ), makeSymbol( "ENTRY" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym74$NL_TRIE_NAME_STRING_MACRO_HELPER = makeSymbol( "NL-TRIE-NAME-STRING-MACRO-HELPER" );
    $sym75$GAF_ARG3 = makeSymbol( "GAF-ARG3" );
    $sym76$DO_NL_TRIE_WORD_STRINGS = makeSymbol( "DO-NL-TRIE-WORD-STRINGS" );
    $list77 = ConsesLow.list( makeKeyword( "STRING" ) );
    $sym78$DO_NL_TRIE_ENTRY_STRINGS = makeSymbol( "DO-NL-TRIE-ENTRY-STRINGS" );
    $list79 = ConsesLow.list( ConsesLow.list( makeSymbol( "SUPPORT" ), makeSymbol( "WORD" ), makeSymbol( "&KEY" ), makeSymbol( "DONE" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $list80 = ConsesLow.list( makeKeyword( "DONE" ) );
    $kw81$ALLOW_OTHER_KEYS = makeKeyword( "ALLOW-OTHER-KEYS" );
    $kw82$DONE = makeKeyword( "DONE" );
    $sym83$DO_SET = makeSymbol( "DO-SET" );
    $sym84$NL_TRIE_WORD_SYNTACTIC_SUPPORT_SET = makeSymbol( "NL-TRIE-WORD-SYNTACTIC-SUPPORT-SET" );
    $sym85$NL_TRIE_WORD_SEMANTIC_SUPPORT_SET = makeSymbol( "NL-TRIE-WORD-SEMANTIC-SUPPORT-SET" );
    $kw86$MT = makeKeyword( "MT" );
    $kw87$PRAGMATICS = makeKeyword( "PRAGMATICS" );
    $sym88$NL_TRIE_ENTRY_P = makeSymbol( "NL-TRIE-ENTRY-P" );
    $str89$Removing_bad_syntactic_support___ = makeString( "Removing bad syntactic support: ~S~% from ~S" );
    $str90$Removing_bad_semantic_support___S = makeString( "Removing bad semantic support: ~S~% from ~S" );
    $sym91$NL_TRIE_WORD_STRUC_VALID_P = makeSymbol( "NL-TRIE-WORD-STRUC-VALID-P" );
    $sym92$NL_TRIE_VALID_ASSERTION__MEMOIZED = makeSymbol( "NL-TRIE-VALID-ASSERTION?-MEMOIZED" );
    $int93$500 = makeInteger( 500 );
    $sym94$INVALID_FORT_ = makeSymbol( "INVALID-FORT?" );
    $list95 = ConsesLow.cons( makeSymbol( "SENTENCE" ), makeSymbol( "MT" ) );
    $list96 = ConsesLow.list( makeSymbol( "PRED" ), makeSymbol( "WORD" ), makeSymbol( "STRING" ) );
    $list97 = ConsesLow.cons( makeSymbol( "THIS-STRING" ), makeSymbol( "SUPPORTS" ) );
    $str98$Removing_invalid_denot___S = makeString( "Removing invalid denot: ~S" );
    $list99 = ConsesLow.list( makeSymbol( "NL-TRIE-DENOT-HAS-INVALID-CONSTANT?" ) );
    $sym100$INVALID_CONSTANT_ = makeSymbol( "INVALID-CONSTANT?" );
    $sym101$EL_FORMULA_P = makeSymbol( "EL-FORMULA-P" );
    $sym102$HLMT_P = makeSymbol( "HLMT-P" );
    $sym103$SET_P = makeSymbol( "SET-P" );
    $str104$_S___is_not_a_valid_NL_trie_denot = makeString( "~S~% is not a valid NL trie denot set. Test must be ~S." );
    $const105$denotation = constant_handles.reader_make_constant_shell( makeString( "denotation" ) );
    $sym106$NL_TRIE_WORD_STRUC = makeSymbol( "NL-TRIE-WORD-STRUC" );
    $sym107$NL_TRIE_WORD_STRUC_P = makeSymbol( "NL-TRIE-WORD-STRUC-P" );
    $int108$166 = makeInteger( 166 );
    $list109 = ConsesLow.list( makeSymbol( "SYNTACTIC-SUPPORTS" ), makeSymbol( "SEMANTIC-SUPPORTS" ) );
    $list110 = ConsesLow.list( makeKeyword( "SYNTACTIC-SUPPORTS" ), makeKeyword( "SEMANTIC-SUPPORTS" ) );
    $list111 = ConsesLow.list( makeSymbol( "NL-TRIE-WORD-STRUC-SYNTACTIC-SUPPORTS" ), makeSymbol( "NL-TRIE-WORD-STRUC-SEMANTIC-SUPPORTS" ) );
    $list112 = ConsesLow.list( makeSymbol( "_CSETF-NL-TRIE-WORD-STRUC-SYNTACTIC-SUPPORTS" ), makeSymbol( "_CSETF-NL-TRIE-WORD-STRUC-SEMANTIC-SUPPORTS" ) );
    $sym113$PPRINT_NL_TRIE_WORD_STRUC = makeSymbol( "PPRINT-NL-TRIE-WORD-STRUC" );
    $sym114$NL_TRIE_WORD_STRUC_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "NL-TRIE-WORD-STRUC-PRINT-FUNCTION-TRAMPOLINE" );
    $list115 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "NL-TRIE-WORD-STRUC-P" ) );
    $sym116$NL_TRIE_WORD_STRUC_SYNTACTIC_SUPPORTS = makeSymbol( "NL-TRIE-WORD-STRUC-SYNTACTIC-SUPPORTS" );
    $sym117$_CSETF_NL_TRIE_WORD_STRUC_SYNTACTIC_SUPPORTS = makeSymbol( "_CSETF-NL-TRIE-WORD-STRUC-SYNTACTIC-SUPPORTS" );
    $sym118$NL_TRIE_WORD_STRUC_SEMANTIC_SUPPORTS = makeSymbol( "NL-TRIE-WORD-STRUC-SEMANTIC-SUPPORTS" );
    $sym119$_CSETF_NL_TRIE_WORD_STRUC_SEMANTIC_SUPPORTS = makeSymbol( "_CSETF-NL-TRIE-WORD-STRUC-SEMANTIC-SUPPORTS" );
    $kw120$SYNTACTIC_SUPPORTS = makeKeyword( "SYNTACTIC-SUPPORTS" );
    $kw121$SEMANTIC_SUPPORTS = makeKeyword( "SEMANTIC-SUPPORTS" );
    $str122$Invalid_slot__S_for_construction_ = makeString( "Invalid slot ~S for construction function" );
    $kw123$BEGIN = makeKeyword( "BEGIN" );
    $sym124$MAKE_NL_TRIE_WORD_STRUC = makeSymbol( "MAKE-NL-TRIE-WORD-STRUC" );
    $kw125$SLOT = makeKeyword( "SLOT" );
    $kw126$END = makeKeyword( "END" );
    $sym127$VISIT_DEFSTRUCT_OBJECT_NL_TRIE_WORD_STRUC_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-NL-TRIE-WORD-STRUC-METHOD" );
    $int128$509 = makeInteger( 509 );
    $sym129$SXHASH_NL_TRIE_WORD_STRUC_METHOD = makeSymbol( "SXHASH-NL-TRIE-WORD-STRUC-METHOD" );
    $str130$_NL_TRIE_WORD = makeString( "<NL-TRIE-WORD" );
    $str131$____S = makeString( "~% ~S" );
    $str132$_ = makeString( ">" );
    $int133$71 = makeInteger( 71 );
    $sym134$CFASL_INPUT_NL_TRIE_WORD_STRUC = makeSymbol( "CFASL-INPUT-NL-TRIE-WORD-STRUC" );
    $sym135$CFASL_OUTPUT_OBJECT_NL_TRIE_WORD_STRUC_METHOD = makeSymbol( "CFASL-OUTPUT-OBJECT-NL-TRIE-WORD-STRUC-METHOD" );
    $sym136$NL_TRIE_VALID_SEMANTIC_SUPPORT_P = makeSymbol( "NL-TRIE-VALID-SEMANTIC-SUPPORT-P" );
    $sym137$NL_TRIE_SYNTACTIC_SUPPORT_P = makeSymbol( "NL-TRIE-SYNTACTIC-SUPPORT-P" );
    $sym138$NL_TRIE_WORD_VALID_SYNTACTIC_SUPPORT_SET_P = makeSymbol( "NL-TRIE-WORD-VALID-SYNTACTIC-SUPPORT-SET-P" );
    $sym139$NL_TRIE_WORD_VALID_SEMANTIC_SUPPORT_SET_P = makeSymbol( "NL-TRIE-WORD-VALID-SEMANTIC-SUPPORT-SET-P" );
    $const140$partOfSpeech = constant_handles.reader_make_constant_shell( makeString( "partOfSpeech" ) );
    $str141$Couldn_t_find_valid_arbitrary_syn = makeString( "Couldn't find valid arbitrary syntactic support in~% ~S~%" );
    $str142$Illicit_call_to_NL_TRIE_WORD_SYNT = makeString( "Illicit call to NL-TRIE-WORD-SYNTACTIC-SUPPORTS." );
    $str143$Illicit_call_to_NL_TRIE_WORD_SEMA = makeString( "Illicit call to NL-TRIE-WORD-SEMANTIC-SUPPORTS." );
    $str144$Couldn_t_find_valid_arbitrary_sem = makeString( "Couldn't find valid arbitrary semantic support in~% ~S~%" );
    $kw145$ADDED = makeKeyword( "ADDED" );
    $kw146$ALREADY_PRESENT = makeKeyword( "ALREADY-PRESENT" );
    $kw147$REMOVED = makeKeyword( "REMOVED" );
    $kw148$NOT_FOUND = makeKeyword( "NOT-FOUND" );
    $sym149$NL_TRIE_WORD_SEMANTIC_SUPPORT_DENOTS = makeSymbol( "NL-TRIE-WORD-SEMANTIC-SUPPORT-DENOTS" );
    $str150$Can_t_get_arg__S_of__S = makeString( "Can't get arg ~S of ~S" );
    $sym151$NL_TRIE_WORD_SEMANTIC_SUPPORT_SEMTRANS_TEMPLATES = makeSymbol( "NL-TRIE-WORD-SEMANTIC-SUPPORT-SEMTRANS-TEMPLATES" );
    $list152 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "wordStrings" ) ) );
    $sym153$NL_TRIE_CLOSED_CLASS_POS_PREDS = makeSymbol( "NL-TRIE-CLOSED-CLASS-POS-PREDS" );
    $kw154$BREADTH = makeKeyword( "BREADTH" );
    $kw155$QUEUE = makeKeyword( "QUEUE" );
    $kw156$STACK = makeKeyword( "STACK" );
    $const157$True_JustificationTruth = constant_handles.reader_make_constant_shell( makeString( "True-JustificationTruth" ) );
    $sym158$RELEVANT_SBHL_TV_IS_GENERAL_TV = makeSymbol( "RELEVANT-SBHL-TV-IS-GENERAL-TV" );
    $kw159$ERROR = makeKeyword( "ERROR" );
    $str160$_A_is_not_a__A = makeString( "~A is not a ~A" );
    $sym161$SBHL_TRUE_TV_P = makeSymbol( "SBHL-TRUE-TV-P" );
    $kw162$CERROR = makeKeyword( "CERROR" );
    $str163$continue_anyway = makeString( "continue anyway" );
    $kw164$WARN = makeKeyword( "WARN" );
    $str165$_A_is_not_a_valid__sbhl_type_erro = makeString( "~A is not a valid *sbhl-type-error-action* value" );
    $const166$genls = constant_handles.reader_make_constant_shell( makeString( "genls" ) );
    $const167$ClosedClassWord = constant_handles.reader_make_constant_shell( makeString( "ClosedClassWord" ) );
    $str168$_A_is_neither_SET_P_nor_LISTP_ = makeString( "~A is neither SET-P nor LISTP." );
    $str169$attempting_to_bind_direction_link = makeString( "attempting to bind direction link variable, to NIL. macro body not executed." );
    $str170$Node__a_does_not_pass_sbhl_type_t = makeString( "Node ~a does not pass sbhl-type-test ~a~%" );
    $sym171$_NL_TRIE_CLOSED_CLASS_POS_PREDS_CACHING_STATE_ = makeSymbol( "*NL-TRIE-CLOSED-CLASS-POS-PREDS-CACHING-STATE*" );
    $int172$64 = makeInteger( 64 );
    $sym173$CLEAR_NL_TRIE_CLOSED_CLASS_POS_PREDS = makeSymbol( "CLEAR-NL-TRIE-CLOSED-CLASS-POS-PREDS" );
    $const174$abbreviationForLexicalWord = constant_handles.reader_make_constant_shell( makeString( "abbreviationForLexicalWord" ) );
    $sym175$NL_TRIE_WORD_POS = makeSymbol( "NL-TRIE-WORD-POS" );
    $const176$gerund = constant_handles.reader_make_constant_shell( makeString( "gerund" ) );
    $sym177$ASSERTION_P = makeSymbol( "ASSERTION-P" );
    $int178$1000 = makeInteger( 1000 );
    $list179 = ConsesLow.list( ConsesLow.list( makeSymbol( "DENOT" ), makeSymbol( "ENTRY" ), makeSymbol( "&KEY" ), makeSymbol( "PREFERRED-ONLY?" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $list180 = ConsesLow.list( makeKeyword( "PREFERRED-ONLY?" ) );
    $kw181$PREFERRED_ONLY_ = makeKeyword( "PREFERRED-ONLY?" );
    $sym182$PRED = makeUninternedSymbol( "PRED" );
    $sym183$DENOT_ARG = makeUninternedSymbol( "DENOT-ARG" );
    $sym184$SEMANTIC_SUPPORT = makeUninternedSymbol( "SEMANTIC-SUPPORT" );
    $sym185$NL_TRIE_WORD_SEM_PRED = makeSymbol( "NL-TRIE-WORD-SEM-PRED" );
    $sym186$FWHEN = makeSymbol( "FWHEN" );
    $sym187$INDEXED_TERM_P = makeSymbol( "INDEXED-TERM-P" );
    $sym188$DENOTATUM_ARG_OF_PRED_CACHED = makeSymbol( "DENOTATUM-ARG-OF-PRED-CACHED" );
    $sym189$INTEGERP = makeSymbol( "INTEGERP" );
    $sym190$FIMPLIES = makeSymbol( "FIMPLIES" );
    $sym191$NL_TRIE_PREFERRED_SEMANTIC_SUPPORT_ = makeSymbol( "NL-TRIE-PREFERRED-SEMANTIC-SUPPORT?" );
    $list192 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "preferredNameString" ) ), constant_handles.reader_make_constant_shell( makeString( "preferredTermStrings" ) ) );
    $const193$preferredLexification = constant_handles.reader_make_constant_shell( makeString( "preferredLexification" ) );
    $list194 = ConsesLow.list( ConsesLow.list( makeSymbol( "SEMTRANS-TEMPLATE" ), makeSymbol( "ENTRY" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym195$PRED = makeUninternedSymbol( "PRED" );
    $sym196$SEMTRANS_TEMPLATE_ARG = makeUninternedSymbol( "SEMTRANS-TEMPLATE-ARG" );
    $sym197$SEMANTIC_SUPPORT = makeUninternedSymbol( "SEMANTIC-SUPPORT" );
    $sym198$INVALID_SUPPORTS = makeUninternedSymbol( "INVALID-SUPPORTS" );
    $sym199$SEMTRANS_ARG_OF_PRED_CACHED = makeSymbol( "SEMTRANS-ARG-OF-PRED-CACHED" );
    $sym200$PIF = makeSymbol( "PIF" );
    $sym201$VALID_NL_TRIE_WORD_SEMANTIC_SUPPORT_P = makeSymbol( "VALID-NL-TRIE-WORD-SEMANTIC-SUPPORT-P" );
    $sym202$CPUSH = makeSymbol( "CPUSH" );
    $sym203$NL_TRIE_WORD_REMOVE_SEMANTIC_SUPPORT = makeSymbol( "NL-TRIE-WORD-REMOVE-SEMANTIC-SUPPORT" );
    $list204 = ConsesLow.list( ConsesLow.list( makeSymbol( "STRING" ), makeSymbol( "WORD-ENTRY" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym205$SEMANTIC_SUPPORT = makeUninternedSymbol( "SEMANTIC-SUPPORT" );
    $sym206$LEADING_STRINGS = makeUninternedSymbol( "LEADING-STRINGS" );
    $sym207$HEAD_STRING = makeUninternedSymbol( "HEAD-STRING" );
    $sym208$FOLLOWING_STRINGS = makeUninternedSymbol( "FOLLOWING-STRINGS" );
    $sym209$NL_TRIE_WORD_HEAD_STRING_MACRO_HELPER = makeSymbol( "NL-TRIE-WORD-HEAD-STRING-MACRO-HELPER" );
    $sym210$DO_NL_TRIE_WORD_SEMANTIC_SUPPORTS = makeSymbol( "DO-NL-TRIE-WORD-SEMANTIC-SUPPORTS" );
    $sym211$NL_TRIE_WORD_LEADING_STRINGS_FROM_SUPPORT_MACRO_HELPER = makeSymbol( "NL-TRIE-WORD-LEADING-STRINGS-FROM-SUPPORT-MACRO-HELPER" );
    $sym212$NL_TRIE_WORD_FOLLOWING_STRINGS_FROM_SUPPORT_MACRO_HELPER = makeSymbol( "NL-TRIE-WORD-FOLLOWING-STRINGS-FROM-SUPPORT-MACRO-HELPER" );
    $sym213$NL_TRIE_ASSEMBLE_STRINGS_MACRO_HELPER = makeSymbol( "NL-TRIE-ASSEMBLE-STRINGS-MACRO-HELPER" );
    $str214$__NL_TRIE_WORD_Word_unit______S__ = makeString( "#<NL-TRIE-WORD:Word-unit:    ~S~%" );
    $str215$_______________POS____________S__ = makeString( "               POS:          ~S~%" );
    $str216$_______________POS_Preds______S__ = makeString( "               POS Preds:    ~S~%" );
    $str217$_______________Lexical_Pred___S__ = makeString( "               Lexical Pred: ~S~%" );
    $str218$_______________Denotations____S__ = makeString( "               Denotations:  ~S~%" );
    $str219$_______________Pragmatics_____S__ = makeString( "               Pragmatics:   ~S~%" );
    $str220$_______________Microtheory____S__ = makeString( "               Microtheory:  ~S>~%" );
    $str221$__NL_TRIE_NAME_Namestring_Pred___ = makeString( "#<NL-TRIE-NAME:Namestring Pred: ~S~%" );
    $str222$_______________Denotations_______ = makeString( "               Denotations:     ~S~%" );
    $str223$_______________Pragmatics________ = makeString( "               Pragmatics:      ~S~%" );
    $str224$_______________Microtheory_______ = makeString( "               Microtheory:     ~S>~%" );
    $str225$Invalid_NL_trie_name___S = makeString( "Invalid NL trie name: ~S" );
    $str226$Invalid_NL_trie_tp_entry___S = makeString( "Invalid NL trie tp-entry: ~S" );
    $sym227$NL_TRIE_RECORD_P = makeSymbol( "NL-TRIE-RECORD-P" );
    $sym228$VALID_NL_TRIE_RECORD_KEY_P = makeSymbol( "VALID-NL-TRIE-RECORD-KEY-P" );
    $sym229$VALID_NL_TRIE_RECORD_ENTRIES_P = makeSymbol( "VALID-NL-TRIE-RECORD-ENTRIES-P" );
    $sym230$CYCL_STRING_P = makeSymbol( "CYCL-STRING-P" );
    $sym231$_NL_TRIE_LEXICAL_MT_ = makeSymbol( "*NL-TRIE-LEXICAL-MT*" );
    $const232$AllLexicalMicrotheoryPSC = constant_handles.reader_make_constant_shell( makeString( "AllLexicalMicrotheoryPSC" ) );
    $sym233$_NL_TRIE_SYNTACTIC_PREDICATES_ = makeSymbol( "*NL-TRIE-SYNTACTIC-PREDICATES*" );
    $kw234$UNINITIALIZED = makeKeyword( "UNINITIALIZED" );
    $sym235$_NL_TRIE_DENOTATION_PREDICATES_ = makeSymbol( "*NL-TRIE-DENOTATION-PREDICATES*" );
    $sym236$_NL_TRIE_SEMTRANS_PREDICATES_ = makeSymbol( "*NL-TRIE-SEMTRANS-PREDICATES*" );
    $sym237$_NL_TRIE_ABBREVIATION_PREDICATES_ = makeSymbol( "*NL-TRIE-ABBREVIATION-PREDICATES*" );
    $sym238$_NL_TRIE_ARG_IN_RELN_PREDICATES_ = makeSymbol( "*NL-TRIE-ARG-IN-RELN-PREDICATES*" );
    $sym239$_NL_TRIE_PRAGMATIC_PREDICATES_ = makeSymbol( "*NL-TRIE-PRAGMATIC-PREDICATES*" );
    $list240 = ConsesLow.list( ConsesLow.list( makeSymbol( "NL-TRIE" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym241$_NL_TRIES_BEING_INITIALIZED_ = makeSymbol( "*NL-TRIES-BEING-INITIALIZED*" );
    $sym242$CONS = makeSymbol( "CONS" );
    $list243 = ConsesLow.list( makeSymbol( "*NL-TRIES-BEING-INITIALIZED*" ) );
    $list244 = ConsesLow.list( makeString( "Initialize NL Trie" ) );
    $sym245$_NL_TRIE_ = makeSymbol( "*NL-TRIE*" );
    $kw246$ABORTED = makeKeyword( "ABORTED" );
    $list247 = ConsesLow.list( ConsesLow.list( makeSymbol( "KEY" ), makeSymbol( "ENTRIES" ), makeSymbol( "&KEY" ), makeSymbol( "DONE" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $list248 = ConsesLow.list( makeString( "Do NL Trie" ) );
    $sym249$DO_STRIE = makeSymbol( "DO-STRIE" );
    $list250 = ConsesLow.list( makeSymbol( "GET-NL-TRIE" ) );
    $list251 = ConsesLow.list( ConsesLow.list( makeSymbol( "KEY" ), makeSymbol( "ENTRIES" ), makeSymbol( "&KEY" ), makeSymbol( "DONE" ), ConsesLow.list( makeSymbol( "PROGRESS-NOTE" ), makeString(
        "Mapping NL trie..." ) ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $list252 = ConsesLow.list( makeKeyword( "DONE" ), makeKeyword( "PROGRESS-NOTE" ) );
    $kw253$PROGRESS_NOTE = makeKeyword( "PROGRESS-NOTE" );
    $str254$Mapping_NL_trie___ = makeString( "Mapping NL trie..." );
    $list255 = ConsesLow.list( makeString( "Do NL Trie Progress" ) );
    $list256 = ConsesLow.list( makeUninternedSymbol( "DICT-KEY" ), makeUninternedSymbol( "DICT-VALUE" ) );
    $kw257$COPIED = makeKeyword( "COPIED" );
    $str258$__Clearing_the_present_contents_o = makeString( "~%Clearing the present contents of ~a ...~%" );
    $kw259$CLEARED = makeKeyword( "CLEARED" );
    $kw260$NEVER = makeKeyword( "NEVER" );
    $kw261$INITIALIZED = makeKeyword( "INITIALIZED" );
    $kw262$ON = makeKeyword( "ON" );
    $kw263$PREFERRED = makeKeyword( "PREFERRED" );
    $str264$Didn_t_recognize_NL_Trie_case_sen = makeString( "Didn't recognize NL Trie case-sensitivity setting ~S" );
    $sym265$NL_TRIE_SEARCH_CASE_SENSITIVE = makeSymbol( "NL-TRIE-SEARCH-CASE-SENSITIVE" );
    $int266$48 = makeInteger( 48 );
    $sym267$NL_TRIE_SEARCH_CASE_INSENSITIVE = makeSymbol( "NL-TRIE-SEARCH-CASE-INSENSITIVE" );
    $sym268$NL_TRIE_SEARCH_CASE_SENSITIVE_PREFERRED = makeSymbol( "NL-TRIE-SEARCH-CASE-SENSITIVE-PREFERRED" );
    $str269$NL_Trie_empty_ = makeString( "NL Trie empty." );
    $str270$NL_Trie_incompletely_built_ = makeString( "NL Trie incompletely built." );
    $str271$NL_trie_built_with_stale_code__ = makeString( "NL trie built with stale code~%" );
    $kw272$NOT_ADDED = makeKeyword( "NOT-ADDED" );
    $kw273$NOT_REMOVED = makeKeyword( "NOT-REMOVED" );
    $kw274$RETRIEFIED = makeKeyword( "RETRIEFIED" );
    $kw275$NOT_RETRIEFIED = makeKeyword( "NOT-RETRIEFIED" );
    $list276 = ConsesLow.list( makeSymbol( "STREAM" ), makeSymbol( "GLOBAL" ), makeSymbol( "TYPE" ) );
    $sym277$TOP = makeUninternedSymbol( "TOP" );
    $sym278$CFASL_INPUT = makeSymbol( "CFASL-INPUT" );
    $list279 = ConsesLow.list( NIL, makeKeyword( "EOF" ) );
    $list280 = ConsesLow.list( makeKeyword( "EOF" ) );
    $sym281$CSETQ = makeSymbol( "CSETQ" );
    $sym282$WARN = makeSymbol( "WARN" );
    $str283$___S_is_not_the_right_type_of_obj = makeString( "~&~S is not the right type of object for ~S (expected a ~S)." );
    $sym284$QUOTE = makeSymbol( "QUOTE" );
    $kw285$EOF = makeKeyword( "EOF" );
    $sym286$MAP_P = makeSymbol( "MAP-P" );
    $sym287$_NL_TRIE_COMPLETION_INDEX_ = makeSymbol( "*NL-TRIE-COMPLETION-INDEX*" );
    $str288$Mismatch_between_world_and_HL_cac = makeString( "Mismatch between world and HL caches: no ~A and ~A to reconnect NL trie with." );
    $str289$Reconnecting_to_legacy_unit_files = makeString( "Reconnecting to legacy unit files w/out NL trie contents in ~A and ~A." );
    $sym290$DUMP_SWAPPABLE_NL_TRIE_VISITOR_BEGIN_VISIT = makeSymbol( "DUMP-SWAPPABLE-NL-TRIE-VISITOR-BEGIN-VISIT" );
    $sym291$DUMP_SWAPPABLE_NL_TRIE_VISITOR_BEGIN_PATH = makeSymbol( "DUMP-SWAPPABLE-NL-TRIE-VISITOR-BEGIN-PATH" );
    $sym292$DUMP_SWAPPABLE_NL_TRIE_VISITOR_ACCEPT_NODE = makeSymbol( "DUMP-SWAPPABLE-NL-TRIE-VISITOR-ACCEPT-NODE" );
    $sym293$DUMP_SWAPPABLE_NL_TRIE_VISITOR_END_PATH = makeSymbol( "DUMP-SWAPPABLE-NL-TRIE-VISITOR-END-PATH" );
    $sym294$DUMP_SWAPPABLE_NL_TRIE_VISITOR_END_VISIT = makeSymbol( "DUMP-SWAPPABLE-NL-TRIE-VISITOR-END-VISIT" );
    $str295$The_NL_trie_visitor_is_not_proper = makeString( "The NL trie visitor is not properly setup; initial context ~A is bogus." );
    $str296$The_NL_trie_visitor_did_nto_compl = makeString( "The NL trie visitor did nto complete properly; final context ~A is bogus." );
    $kw297$SWAPPED_OUT = makeKeyword( "SWAPPED-OUT" );
    $kw298$COMPACT = makeKeyword( "COMPACT" );
    $list299 = ConsesLow.cons( makeSymbol( "MAP-KEY" ), makeSymbol( "PAYLOAD" ) );
    $kw300$FILE_VECTOR = makeKeyword( "FILE-VECTOR" );
    $kw301$MAP_STACK = makeKeyword( "MAP-STACK" );
    $str302$Invalid_case_sensitivity_setting_ = makeString( "Invalid case-sensitivity setting ~S for trie ~S, whose test function is ~S" );
    $str303$Validating_all_NL_trie_entries = makeString( "Validating all NL trie entries" );
    $kw304$VALIDATED = makeKeyword( "VALIDATED" );
    $str305$Removing_bad_NL_trie_entry_for__S = makeString( "Removing bad NL trie entry for ~S:~% ~S~% from ~S~%" );
    $str306$Remaining_entries_____S__ = makeString( "Remaining entries:~% ~S~%" );
    $sym307$NL_TRIE_SYNTACTIC_PRED_ = makeSymbol( "NL-TRIE-SYNTACTIC-PRED?" );
    $list308 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "denotation" ) ), constant_handles.reader_make_constant_shell( makeString( "denotationRelatedTo" ) ), constant_handles
        .reader_make_constant_shell( makeString( "denotationPlaceholder" ) ), constant_handles.reader_make_constant_shell( makeString( "multiWordString" ) ), constant_handles.reader_make_constant_shell( makeString(
            "compoundString" ) ), constant_handles.reader_make_constant_shell( makeString( "multiWordString-Speculative" ) ), constant_handles.reader_make_constant_shell( makeString( "headMedialString" ) ) );
    $const309$DenotesArgInRelnPredicate = constant_handles.reader_make_constant_shell( makeString( "DenotesArgInRelnPredicate" ) );
    $const310$SemTransPred = constant_handles.reader_make_constant_shell( makeString( "SemTransPred" ) );
    $sym311$NL_TRIE_SEMTRANS_PRED_HAS_POS_SPECIFICATION_ = makeSymbol( "NL-TRIE-SEMTRANS-PRED-HAS-POS-SPECIFICATION?" );
    $sym312$NL_TRIE_MULTI_WORD_ABBREVIATION_PREDS = makeSymbol( "NL-TRIE-MULTI-WORD-ABBREVIATION-PREDS" );
    $const313$MultiWordForStringPred = constant_handles.reader_make_constant_shell( makeString( "MultiWordForStringPred" ) );
    $sym314$_NL_TRIE_MULTI_WORD_ABBREVIATION_PREDS_CACHING_STATE_ = makeSymbol( "*NL-TRIE-MULTI-WORD-ABBREVIATION-PREDS-CACHING-STATE*" );
    $const315$NLPragmaticPredicate_New = constant_handles.reader_make_constant_shell( makeString( "NLPragmaticPredicate-New" ) );
    $str316$__Initializing_NL_Trie_____ = makeString( "~%Initializing NL Trie...~%" );
    $str317$__Triefying_the_syntactic_predica = makeString( "~%Triefying the syntactic predicates ...~%" );
    $kw318$SYNTACTIC = makeKeyword( "SYNTACTIC" );
    $str319$__Triefying_the_semantic_predicat = makeString( "~%Triefying the semantic predicates ...~%" );
    $kw320$SEMANTIC = makeKeyword( "SEMANTIC" );
    $sym321$VALID_CONSTANT_ = makeSymbol( "VALID-CONSTANT?" );
    $str322$____D__D__Triefying__S_assertions = makeString( "~%[~D/~D] Triefying ~S assertions..." );
    $const323$NLSyntacticPredicate = constant_handles.reader_make_constant_shell( makeString( "NLSyntacticPredicate" ) );
    $const324$NLSemanticPredicate = constant_handles.reader_make_constant_shell( makeString( "NLSemanticPredicate" ) );
    $str325$Triefying__S = makeString( "Triefying ~S" );
    $kw326$GAF = makeKeyword( "GAF" );
    $kw327$TRUE = makeKeyword( "TRUE" );
    $str328$Triefying__S_assertions___ = makeString( "Triefying ~S assertions..." );
    $str329$Got_failure_result__S_when_triefy = makeString( "Got failure result ~S when triefying~% ~S" );
    $sym330$CATCH_ERROR_MESSAGE_HANDLER = makeSymbol( "CATCH-ERROR-MESSAGE-HANDLER" );
    $const331$abbreviationForMultiWordString = constant_handles.reader_make_constant_shell( makeString( "abbreviationForMultiWordString" ) );
    $const332$abbreviationForCompoundString = constant_handles.reader_make_constant_shell( makeString( "abbreviationForCompoundString" ) );
    $str333$Caught_error_in_UPDATE_NL_TRIE_SY = makeString( "Caught error in UPDATE-NL-TRIE-SYNTACTIC for~% ~S:~% ~S" );
    $str334$Trie_not_present___S = makeString( "Trie not present: ~S" );
    $str335$Assertion_fails_OK_ASSERTION_FOR_ = makeString( "Assertion fails OK-ASSERTION-FOR-NL-TRIE?~% ~S" );
    $list336 = ConsesLow.list( makeSymbol( "MOD-STR-LIST" ), makeSymbol( "CONSTRAINT" ), makeSymbol( "MT" ) );
    $list337 = ConsesLow.list( makeSymbol( "SPP-PRED" ), makeSymbol( "WORD" ), makeSymbol( "STRING" ) );
    $sym338$NL_TRIE_SPEC_PREDICATES = makeSymbol( "NL-TRIE-SPEC-PREDICATES" );
    $sym339$_NL_TRIE_SPEC_PREDICATES_CACHING_STATE_ = makeSymbol( "*NL-TRIE-SPEC-PREDICATES-CACHING-STATE*" );
    $int340$256 = makeInteger( 256 );
    $sym341$CLEAR_NL_TRIE_SPEC_PREDICATES = makeSymbol( "CLEAR-NL-TRIE-SPEC-PREDICATES" );
    $list342 = ConsesLow.list( makeSymbol( "SP-PRED" ), makeSymbol( "WORD" ), makeSymbol( "STRING" ) );
    $list343 = ConsesLow.list( makeSymbol( "SPP-PRED" ), makeSymbol( "WU" ), makeSymbol( "IRREGULAR-STRING" ) );
    $list344 = ConsesLow.list( makeSymbol( "MOD-STR-LIST" ), makeSymbol( "PRED" ) );
    $list345 = ConsesLow.list( makeSymbol( "WORD" ), makeSymbol( "POS" ), makeSymbol( "CYCL-STRING" ) );
    $sym346$NL_TRIE_POS_FOR_SEMTRANS_PRED = makeSymbol( "NL-TRIE-POS-FOR-SEMTRANS-PRED" );
    $sym347$_NL_TRIE_POS_FOR_SEMTRANS_PRED_CACHING_STATE_ = makeSymbol( "*NL-TRIE-POS-FOR-SEMTRANS-PRED-CACHING-STATE*" );
    $int348$128 = makeInteger( 128 );
    $sym349$NL_TRIE_PRED_OK_FOR_POS_ = makeSymbol( "NL-TRIE-PRED-OK-FOR-POS?" );
    $sym350$GENL_POS_ = makeSymbol( "GENL-POS?" );
    $sym351$GENL_POS_PRED_ = makeSymbol( "GENL-POS-PRED?" );
    $sym352$_NL_TRIE_PRED_OK_FOR_POS__CACHING_STATE_ = makeSymbol( "*NL-TRIE-PRED-OK-FOR-POS?-CACHING-STATE*" );
    $int353$1024 = makeInteger( 1024 );
    $sym354$NL_TRIE_PREDS_LICENSED_BY_POS = makeSymbol( "NL-TRIE-PREDS-LICENSED-BY-POS" );
    $sym355$_NL_TRIE_PREDS_LICENSED_BY_POS_CACHING_STATE_ = makeSymbol( "*NL-TRIE-PREDS-LICENSED-BY-POS-CACHING-STATE*" );
    $int356$32 = makeInteger( 32 );
    $str357$Caught_error_in_NL_TRIEFY_SEMANTI = makeString( "Caught error in NL-TRIEFY-SEMANTIC-ASSERTION for~% ~S:~% ~S" );
    $list358 = ConsesLow.list( makeSymbol( "STRING-LIST" ), makeSymbol( "CONSTRAINT" ), makeSymbol( "MT" ) );
    $str359$Couldn_t_find_any_string_nl_trie_ = makeString( "Couldn't find any string-nl-trie-word pairs for ~S with ~S from ~S" );
    $list360 = ConsesLow.cons( makeSymbol( "WU-STRING" ), makeSymbol( "SUPPORTS" ) );
    $list361 = ConsesLow.list( makeSymbol( "EACH-STR-LIST" ), makeSymbol( "EACH-PRED" ) );
    $list362 = ConsesLow.list( makeSymbol( "STRING" ), makeSymbol( "MT" ) );
    $sym363$GAF_ASSERTION_ = makeSymbol( "GAF-ASSERTION?" );
    $kw364$UNDETERMINED = makeKeyword( "UNDETERMINED" );
    $list365 = ConsesLow.list( makeSymbol( "HEAD-STRINGS" ), makeSymbol( "CONSTRAINT" ), makeSymbol( "MT" ) );
    $list366 = ConsesLow.list( makeSymbol( "ABBREV-PRED" ), makeSymbol( "WU" ), makeSymbol( "CONST" ), makeSymbol( "CYCL-ABBR" ) );
    $sym367$RELEVANT_PRED_IS_EQ = makeSymbol( "RELEVANT-PRED-IS-EQ" );
    $list368 = ConsesLow.list( makeSymbol( "ABBREV-PRED" ), makeSymbol( "WU" ), makeSymbol( "CYCL-MW-STR" ), makeSymbol( "CONST" ), makeSymbol( "ABBR" ) );
    $const369$compoundString = constant_handles.reader_make_constant_shell( makeString( "compoundString" ) );
    $list370 = ConsesLow.list( makeSymbol( "ABBREV-PRED" ), makeSymbol( "CYCL-MW-STR" ), makeSymbol( "WU" ), makeSymbol( "CONST" ), makeSymbol( "CYCL-ABBR" ) );
    $const371$multiWordString = constant_handles.reader_make_constant_shell( makeString( "multiWordString" ) );
    $str372$_ = makeString( " " );
    $kw373$AUGMENTED = makeKeyword( "AUGMENTED" );
    $kw374$REDUNDANT = makeKeyword( "REDUNDANT" );
    $kw375$ALL = makeKeyword( "ALL" );
    $sym376$NL_TRIE_PREDS_OF_POS = makeSymbol( "NL-TRIE-PREDS-OF-POS" );
    $const377$speechPartPreds = constant_handles.reader_make_constant_shell( makeString( "speechPartPreds" ) );
    $const378$Verb = constant_handles.reader_make_constant_shell( makeString( "Verb" ) );
    $sym379$_NL_TRIE_PREDS_OF_POS_CACHING_STATE_ = makeSymbol( "*NL-TRIE-PREDS-OF-POS-CACHING-STATE*" );
    $sym380$NL_TRIE_POS_OF_PRED = makeSymbol( "NL-TRIE-POS-OF-PRED" );
    $sym381$_NL_TRIE_POS_OF_PRED_CACHING_STATE_ = makeSymbol( "*NL-TRIE-POS-OF-PRED-CACHING-STATE*" );
    $list382 = ConsesLow.list( new SubLObject[] { Characters.CHAR_comma, Characters.CHAR_question, Characters.CHAR_exclamation, Characters.CHAR_ampersand, Characters.CHAR_backslash, Characters.CHAR_slash,
      Characters.CHAR_quotation, Characters.CHAR_semicolon, Characters.CHAR_colon, Characters.CHAR_lparen, Characters.CHAR_rparen, Characters.CHAR_plus, Characters.CHAR_hyphen
    } );
    $sym383$NL_TRIE_BREAK_CHAR_P = makeSymbol( "NL-TRIE-BREAK-CHAR-P" );
    $list384 = ConsesLow.list( ConsesLow.list( makeString( "-" ), makeString( "" ), makeString( "." ) ), ConsesLow.list( makeString( "" ), makeString( "." ) ) );
    $list385 = ConsesLow.list( ConsesLow.list( makeString( "-" ) ), NIL );
    $str386$_ = makeString( "-" );
    $sym387$DIGIT_CHAR_P = makeSymbol( "DIGIT-CHAR-P" );
    $list388 = ConsesLow.list( makeString( "'" ) );
    $str389$_a_is_not_currently_an_NL_Trie_ = makeString( "~a is not currently an NL Trie." );
    $str390$Couldn_t_find_any_strings_to_add_ = makeString( "Couldn't find any strings to add to trie:~% ~S" );
    $str391$Couldn_t_find_any_strings_to_remo = makeString( "Couldn't find any strings to remove from trie:~% ~S" );
    $str392$error_ = makeString( "error " );
    $str393$Unable_to_determine_pragmatic_fea = makeString( "Unable to determine pragmatic features for ~A" );
    $const394$pragmaticallyAcceptable = constant_handles.reader_make_constant_shell( makeString( "pragmaticallyAcceptable" ) );
    $sym395$FIND_POS_PREDS_FOR_LEX_CONST = makeSymbol( "FIND-POS-PREDS-FOR-LEX-CONST" );
    $list396 = ConsesLow.cons( makeSymbol( "NOW" ), makeSymbol( "LATER" ) );
    $sym397$SPEC_POS_PRED_ = makeSymbol( "SPEC-POS-PRED?" );
    $sym398$_NL_TRIE_NAME_STRING_PREDS_SET_ = makeSymbol( "*NL-TRIE-NAME-STRING-PREDS-SET*" );
    $list399 = ConsesLow.list( makeSymbol( "PRED" ), makeSymbol( "VALUE" ) );
    $sym400$_EXIT = makeSymbol( "%EXIT" );
    $sym401$TRIEFY_NART = makeSymbol( "TRIEFY-NART" );
    $sym402$NL_TRIE_P = makeSymbol( "NL-TRIE-P" );
    $sym403$NL_TRIE_ITERATOR_DONE = makeSymbol( "NL-TRIE-ITERATOR-DONE" );
    $sym404$NL_TRIE_ITERATOR_NEXT = makeSymbol( "NL-TRIE-ITERATOR-NEXT" );
    $list405 = ConsesLow.list( makeSymbol( "ITERATOR" ), makeSymbol( "IS-CURRENT-NL-TRIE-P" ) );
    $sym406$NL_TRIE_STRING_TOKENIZE = makeSymbol( "NL-TRIE-STRING-TOKENIZE" );
    $kw407$TEST = makeKeyword( "TEST" );
    $kw408$OWNER = makeKeyword( "OWNER" );
    $kw409$CLASSES = makeKeyword( "CLASSES" );
    $list410 = ConsesLow.list( makeSymbol( "NL-TRIE-TEST-CASE-TABLES" ) );
    $kw411$KB = makeKeyword( "KB" );
    $kw412$FULL = makeKeyword( "FULL" );
    $kw413$WORKING_ = makeKeyword( "WORKING?" );
    $list414 = ConsesLow.list( ConsesLow.list( ConsesLow.list( makeString( "George Bush, president of the United States" ) ), ConsesLow.list( makeString( "George" ), makeString( "Bush" ), makeString( "," ), makeString(
        "president" ), makeString( "of" ), makeString( "the" ), makeString( "United" ), makeString( "States" ) ) ), ConsesLow.list( ConsesLow.list( makeString( "George Bush" ) ), ConsesLow.list( makeString( "George" ),
            makeString( "Bush" ) ) ), ConsesLow.list( ConsesLow.list( makeString( "Mr. Bush" ) ), ConsesLow.list( makeString( "Mr" ), makeString( "Bush" ) ) ), ConsesLow.list( ConsesLow.list( makeString(
                "I met George Bush." ) ), ConsesLow.list( makeString( "I" ), makeString( "met" ), makeString( "George" ), makeString( "Bush" ) ) ), ConsesLow.list( ConsesLow.list( makeString( "3.6 kilos" ) ), ConsesLow
                    .list( makeString( "3.6" ), makeString( "kilos" ) ) ) );
    $sym415$TEST_SWAPPABLE_NL_TRIE_DUMP = makeSymbol( "TEST-SWAPPABLE-NL-TRIE-DUMP" );
    $kw416$TINY = makeKeyword( "TINY" );
    $list417 = ConsesLow.list( ConsesLow.list( ConsesLow.list( ConsesLow.list( new SubLObject[] { ConsesLow.list( makeString( "North" ), makeString( "Dartmouth" ), makeString( "," ), makeString( "Massachusetts" ) ),
      ConsesLow.list( makeString( "North" ), makeString( "Vancouver" ) ), ConsesLow.list( makeString( "North" ), makeString( "Anna" ), makeString( "nuclear" ), makeString( "power" ), makeString( "plant" ) ), ConsesLow
          .list( makeString( "North" ), makeString( "East" ), makeString( "optic" ), makeString( "network" ), makeString( "(" ), makeString( "NOPT" ), makeString( ")" ) ), ConsesLow.list( makeString( "North" ),
              makeString( "central" ), makeString( "intercollegiate" ), makeString( "athletic" ), makeString( "conference" ) ), ConsesLow.list( makeString( "North" ), makeString( "sea" ) ), ConsesLow.list( makeString(
                  "North" ), makeString( "valley" ), makeString( "Bancorp" ), makeString( "(" ), makeString( "Nasdaq" ), makeString( ":" ), makeString( "Novb" ), makeString( ")" ) ), ConsesLow.list( makeString(
                      "North" ), makeString( "Sea" ), makeString( "Brent" ), makeString( "crude" ) ), ConsesLow.list( makeString( "North" ), makeString( "Rolandsay" ) ), ConsesLow.list( makeString( "North" ), makeString(
                          "county" ), makeString( "Bancorp" ), makeString( "(" ), makeString( "Nasdaq" ), makeString( ":" ), makeString( "NCBH" ), makeString( ")" ) ), ConsesLow.list( makeString( "North" ), makeString(
                              "GOA" ), makeString( "district" ) ), ConsesLow.list( new SubLObject[]
                              { makeString( "North" ), makeString( "point" ), makeString( "communications" ), makeString( "group" ), makeString( "," ), makeString( "inc" ), makeString( "(" ), makeString( "Nasdaq" ),
                                makeString( ":" ), makeString( "NPNT" ), makeString( ")" )
      } ), ConsesLow.list( makeString( "North" ), makeString( "fork" ), makeString( "ranger" ), makeString( "district" ) ), ConsesLow.list( makeString( "North" ), makeString( "Carolina" ), makeString( "a" ), makeString(
          "&" ), makeString( "t" ), makeString( "football" ), makeString( "team" ) )
    } ) ), makeKeyword( "SUCCESS" ) ) );
    $str418$index = makeString( "index" );
    $str419$data = makeString( "data" );
    $kw420$OUTPUT = makeKeyword( "OUTPUT" );
    $kw421$IGNORE_ERRORS_TARGET = makeKeyword( "IGNORE-ERRORS-TARGET" );
    $sym422$IGNORE_ERRORS_HANDLER = makeSymbol( "IGNORE-ERRORS-HANDLER", "SUBLISP" );
    $str423$_A = makeString( "~A" );
    $kw424$SUCCESS = makeKeyword( "SUCCESS" );
  }

  public static final class $nl_trie_word_struc_native
      extends
        SubLStructNative
  {
    ...
    {
      this.$syntactic_supports = CommonSymbols.NIL;
      this.$semantic_supports = CommonSymbols.NIL;
    }

    @Override
    public SubLStructDecl getStructDecl()
    {
      return $nl_trie_word_struc_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $nl_trie_word_struc_native.class, $sym106$NL_TRIE_WORD_STRUC, $sym107$NL_TRIE_WORD_STRUC_P, $list109, $list110, new String[] { "$syntactic_supports",
        "$semantic_supports"
      }, $list111, $list112, $sym113$PPRINT_NL_TRIE_WORD_STRUC );
    }
  }

  public static final class $nl_trie_word_struc_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $sxhash_nl_trie_word_struc_method$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $cfasl_input_nl_trie_word_struc$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $nl_trie_semtrans_pred_has_pos_specificationP$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $nl_trie_break_char_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $nl_trie_syntactic_predP$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $nl_trie_name_string_predP$UnaryFunction
      extends
        UnaryFunction
  {
