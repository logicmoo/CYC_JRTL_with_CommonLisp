...
public final class cb_proof_view extends SubLTranslatedFile
{
    ...
    public static SubLObject init_cb_proof_view_file() {
        ...
        cb_proof_view.$cb_proof_view_destroyer$ = SubLFiles.deflexical("*CB-PROOF-VIEW-DESTROYER*", maybeDefault((SubLObject)cb_proof_view.$sym166$_CB_PROOF_VIEW_DESTROYER_, cb_proof_view.$cb_proof_view_destroyer$, ()->(delayed_processor.new_delayed_processor((SubLObject)cb_proof_view.$int167$1200, (SubLObject)cb_proof_view.$sym168$VALID_PROOF_VIEW_P, (SubLObject)cb_proof_view.$sym169$DESTROY_PROOF_VIEW))));
        return (SubLObject)cb_proof_view.NIL;
    }
