...
public final class lexicon_vars extends SubLTranslatedFile
{
    ...
    public static SubLObject init_lexicon_vars_file() {
        ...
        lexicon_vars.$semtrans_preds$ = SubLFiles.deflexical("*SEMTRANS-PREDS*", (lexicon_vars.NIL != Symbols.boundp((SubLObject)lexicon_vars.$sym11$_SEMTRANS_PREDS_)) ? lexicon_vars.$semtrans_preds$.getGlobalValue() : new_lex_pred_set());
        ...
        lexicon_vars.$abbreviation_predicates$ = SubLFiles.deflexical("*ABBREVIATION-PREDICATES*", (lexicon_vars.NIL != Symbols.boundp((SubLObject)lexicon_vars.$sym17$_ABBREVIATION_PREDICATES_)) ? lexicon_vars.$abbreviation_predicates$.getGlobalValue() : new_lex_pred_set());
        lexicon_vars.$acronym_predicates$ = SubLFiles.deflexical("*ACRONYM-PREDICATES*", (lexicon_vars.NIL != Symbols.boundp((SubLObject)lexicon_vars.$sym19$_ACRONYM_PREDICATES_)) ? lexicon_vars.$acronym_predicates$.getGlobalValue() : new_lex_pred_set());
        lexicon_vars.$proper_name_predicates_from_kb$ = SubLFiles.deflexical("*PROPER-NAME-PREDICATES-FROM-KB*", (lexicon_vars.NIL != Symbols.boundp((SubLObject)lexicon_vars.$sym21$_PROPER_NAME_PREDICATES_FROM_KB_)) ? lexicon_vars.$proper_name_predicates_from_kb$.getGlobalValue() : new_lex_pred_set());
        lexicon_vars.$term_strings_preds$ = SubLFiles.deflexical("*TERM-STRINGS-PREDS*", (lexicon_vars.NIL != Symbols.boundp((SubLObject)lexicon_vars.$sym24$_TERM_STRINGS_PREDS_)) ? lexicon_vars.$term_strings_preds$.getGlobalValue() : new_lex_pred_set());
        ...
        lexicon_vars.$lexicon_cache_code_revision$ = SubLFiles.deflexical("*LEXICON-CACHE-CODE-REVISION*", (SubLObject)((lexicon_vars.NIL != Symbols.boundp((SubLObject)lexicon_vars.$sym51$_LEXICON_CACHE_CODE_REVISION_)) ? lexicon_vars.$lexicon_cache_code_revision$.getGlobalValue() : lexicon_vars.NIL));
        lexicon_vars.$morphology_code_revision$ = SubLFiles.deflexical("*MORPHOLOGY-CODE-REVISION*", (SubLObject)((lexicon_vars.NIL != Symbols.boundp((SubLObject)lexicon_vars.$sym52$_MORPHOLOGY_CODE_REVISION_)) ? lexicon_vars.$morphology_code_revision$.getGlobalValue() : lexicon_vars.NIL));
        lexicon_vars.$nl_trie_code_revision$ = SubLFiles.deflexical("*NL-TRIE-CODE-REVISION*", (SubLObject)((lexicon_vars.NIL != Symbols.boundp((SubLObject)lexicon_vars.$sym53$_NL_TRIE_CODE_REVISION_)) ? lexicon_vars.$nl_trie_code_revision$.getGlobalValue() : lexicon_vars.NIL));
        lexicon_vars.$noop_updates_for_lexicon_globals$ = SubLFiles.deflexical("*NOOP-UPDATES-FOR-LEXICON-GLOBALS*", (SubLObject)((lexicon_vars.NIL != Symbols.boundp((SubLObject)lexicon_vars.$sym54$_NOOP_UPDATES_FOR_LEXICON_GLOBALS_)) ? lexicon_vars.$noop_updates_for_lexicon_globals$.getGlobalValue() : lexicon_vars.NIL));
