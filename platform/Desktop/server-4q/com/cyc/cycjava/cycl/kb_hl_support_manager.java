...
public final class kb_hl_support_manager
    extends
      SubLTranslatedFile
{
  ...
  {
    $kb_hl_support_content_manager$.setGlobalValue( kb_object_manager.new_kb_object_manager( $str3$kb_hl_support, size, $kb_hl_support_lru_size_percentage$.getGlobalValue(), $kb_hl_support_lru_size_max$.getGlobalValue(),
        $sym4$LOAD_KB_HL_SUPPORT_DEF_FROM_CACHE, exactP ) );
    return T;
  }
  ...
  public static SubLObject lookup_kb_hl_support_content(final SubLObject id)
  {
    ...
    try
    {
      kb_storage_logging.$kb_storage_client$.bind( kb_storage_logging.add_kb_storage_logging_add_tag( $kw5$KHM ), thread );
  ...
  {
    if( $kw1$UNINITIALIZED == $kb_hl_support_content_manager$.getGlobalValue() )
    {
      final SubLObject size = id_index.id_index_sparse_id_threshold( $kb_hl_support_contents_from_ids$.getGlobalValue() );
      final SubLObject lru_size = Numbers.min( $kb_hl_support_lru_size_max$.getGlobalValue(), Numbers.multiply( Numbers.integerDivide( size, $int10$100 ), $kb_hl_support_lru_size_percentage$.getGlobalValue() ) );
      final SubLObject lru_information = cache.new_cache( lru_size, UNPROVIDED );
      $kb_hl_support_content_manager$.setGlobalValue( kb_object_manager.new_legacy_kb_object_manager( $str3$kb_hl_support, $kb_hl_support_lru_size_percentage$.getGlobalValue(), $kb_hl_support_lru_size_max$
          .getGlobalValue(), $kb_hl_support_contents_from_ids$.getGlobalValue(), lru_information, $kw1$UNINITIALIZED, $sym4$LOAD_KB_HL_SUPPORT_DEF_FROM_CACHE ) );
      return T;
    }
    return NIL;
  }
  ...
  public static SubLObject with_kb_hl_support_content_index_fully_loaded(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.listS( $sym11$WITH_KBOM_FULLY_LOADED, $list12, ConsesLow.append( body, NIL ) );
  }

  public static SubLObject declare_kb_hl_support_manager_file()
  {
    SubLFiles.declareFunction( me, "setup_kb_hl_support_content_table", "SETUP-KB-HL-SUPPORT-CONTENT-TABLE", 2, 0, false );
    SubLFiles.declareFunction( me, "resize_kb_hl_support_content_kbom_lru", "RESIZE-KB-HL-SUPPORT-CONTENT-KBOM-LRU", 0, 2, false );
    SubLFiles.declareFunction( me, "optimize_kb_hl_support_content_table", "OPTIMIZE-KB-HL-SUPPORT-CONTENT-TABLE", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_kb_hl_support_content_table", "CLEAR-KB-HL-SUPPORT-CONTENT-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "maintain_kb_hl_support_usage_counts", "MAINTAIN-KB-HL-SUPPORT-USAGE-COUNTS", 0, 0, false );
    SubLFiles.declareFunction( me, "dont_maintain_kb_hl_support_usage_counts", "DONT-MAINTAIN-KB-HL-SUPPORT-USAGE-COUNTS", 0, 0, false );
    SubLFiles.declareFunction( me, "kb_hl_support_usage_counts_enabled_p", "KB-HL-SUPPORT-USAGE-COUNTS-ENABLED-P", 0, 0, false );
    SubLFiles.declareFunction( me, "cached_kb_hl_support_count", "CACHED-KB-HL-SUPPORT-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "kb_hl_support_content_completely_cachedP", "KB-HL-SUPPORT-CONTENT-COMPLETELY-CACHED?", 0, 0, false );
    SubLFiles.declareFunction( me, "kb_hl_support_content_cached_p", "KB-HL-SUPPORT-CONTENT-CACHED-P", 1, 0, false );
    SubLFiles.declareFunction( me, "lookup_kb_hl_support_content", "LOOKUP-KB-HL-SUPPORT-CONTENT", 1, 0, false );
    SubLFiles.declareFunction( me, "get_file_backed_kb_hl_support_id_threshold", "GET-FILE-BACKED-KB-HL-SUPPORT-ID-THRESHOLD", 0, 0, false );
    SubLFiles.declareFunction( me, "register_kb_hl_support_content", "REGISTER-KB-HL-SUPPORT-CONTENT", 2, 0, false );
    SubLFiles.declareFunction( me, "deregister_kb_hl_support_content", "DEREGISTER-KB-HL-SUPPORT-CONTENT", 1, 0, false );
    SubLFiles.declareFunction( me, "mark_kb_hl_support_content_as_muted", "MARK-KB-HL-SUPPORT-CONTENT-AS-MUTED", 1, 0, false );
    SubLFiles.declareFunction( me, "meter_kb_hl_support_content_swap_time", "METER-KB-HL-SUPPORT-CONTENT-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction( me, "dont_meter_kb_hl_support_content_swap_time", "DONT-METER-KB-HL-SUPPORT-CONTENT-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction( me, "clear_kb_hl_support_content_swap_time", "CLEAR-KB-HL-SUPPORT-CONTENT-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction( me, "current_kb_hl_support_content_swap_time", "CURRENT-KB-HL-SUPPORT-CONTENT-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction( me, "swap_out_all_pristine_kb_hl_supports", "SWAP-OUT-ALL-PRISTINE-KB-HL-SUPPORTS", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_kb_hl_support_hl_store_cache", "INITIALIZE-KB-HL-SUPPORT-HL-STORE-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "verify_kb_hl_support_content_table_int", "VERIFY-KB-HL-SUPPORT-CONTENT-TABLE-INT", 1, 1, false );
    SubLFiles.declareFunction( me, "possibly_initialize_kb_hl_support_manager_from_legacy_world", "POSSIBLY-INITIALIZE-KB-HL-SUPPORT-MANAGER-FROM-LEGACY-WORLD", 0, 0, false );
    SubLFiles.declareFunction( me, "kb_hl_support_content_change_stream_buffer_sizes", "KB-HL-SUPPORT-CONTENT-CHANGE-STREAM-BUFFER-SIZES", 2, 0, false );
    SubLFiles.declareFunction( me, "kb_hl_support_content_index_enable_memory_mapping", "KB-HL-SUPPORT-CONTENT-INDEX-ENABLE-MEMORY-MAPPING", 0, 0, false );
    SubLFiles.declareFunction( me, "kb_hl_support_content_index_memory_mappedP", "KB-HL-SUPPORT-CONTENT-INDEX-MEMORY-MAPPED?", 0, 0, false );
    SubLFiles.declareMacro( me, "with_kb_hl_support_content_index_fully_loaded", "WITH-KB-HL-SUPPORT-CONTENT-INDEX-FULLY-LOADED" );
    return NIL;
  }

  public static SubLObject init_kb_hl_support_manager_file()
  {
    $kb_hl_support_content_manager$ = SubLFiles.deflexical( "*KB-HL-SUPPORT-CONTENT-MANAGER*", ( maybeDefault( $sym0$_KB_HL_SUPPORT_CONTENT_MANAGER_, $kb_hl_support_content_manager$, $kw1$UNINITIALIZED ) ) );
    $kb_hl_support_lru_size_percentage$ = SubLFiles.deflexical( "*KB-HL-SUPPORT-LRU-SIZE-PERCENTAGE*", FIVE_INTEGER );
    $kb_hl_support_lru_size_max$ = SubLFiles.deflexical( "*KB-HL-SUPPORT-LRU-SIZE-MAX*", $int2$10000 );
    $kb_hl_support_contents_from_ids$ = SubLFiles.deflexical( "*KB-HL-SUPPORT-CONTENTS-FROM-IDS*", ( maybeDefault( $sym8$_KB_HL_SUPPORT_CONTENTS_FROM_IDS_, $kb_hl_support_contents_from_ids$, NIL ) ) );
    return NIL;
  }
  ...
  public static SubLObject setup_kb_hl_support_manager_file()
  {
    ...
    subl_macro_promotions.declare_defglobal( $sym8$_KB_HL_SUPPORT_CONTENTS_FROM_IDS_ );
    access_macros.define_obsolete_register( $sym9$POSSIBLY_INITIALIZE_KB_HL_SUPPORT_MANAGER_FROM_LEGACY_WORLD, NIL );
    return NIL;
  }
  ...
  static
  {
    me = new kb_hl_support_manager();
    $kb_hl_support_content_manager$ = null;
    $kb_hl_support_lru_size_percentage$ = null;
    $kb_hl_support_lru_size_max$ = null;
    $kb_hl_support_contents_from_ids$ = null;
    $sym0$_KB_HL_SUPPORT_CONTENT_MANAGER_ = makeSymbol( "*KB-HL-SUPPORT-CONTENT-MANAGER*" );
    $kw1$UNINITIALIZED = makeKeyword( "UNINITIALIZED" );
    $int2$10000 = makeInteger( 10000 );
    $str3$kb_hl_support = makeString( "kb-hl-support" );
    $sym4$LOAD_KB_HL_SUPPORT_DEF_FROM_CACHE = makeSymbol( "LOAD-KB-HL-SUPPORT-DEF-FROM-CACHE" );
    $kw5$KHM = makeKeyword( "KHM" );
    $sym6$_EXIT = makeSymbol( "%EXIT" );
    $str7$kb_hl_support_index = makeString( "kb-hl-support-index" );
    $sym8$_KB_HL_SUPPORT_CONTENTS_FROM_IDS_ = makeSymbol( "*KB-HL-SUPPORT-CONTENTS-FROM-IDS*" );
    $sym9$POSSIBLY_INITIALIZE_KB_HL_SUPPORT_MANAGER_FROM_LEGACY_WORLD = makeSymbol( "POSSIBLY-INITIALIZE-KB-HL-SUPPORT-MANAGER-FROM-LEGACY-WORLD" );
    $int10$100 = makeInteger( 100 );
    $sym11$WITH_KBOM_FULLY_LOADED = makeSymbol( "WITH-KBOM-FULLY-LOADED" );
    $list12 = ConsesLow.list( makeSymbol( "*KB-HL-SUPPORT-CONTENT-MANAGER*" ) );
  }
}
/*
 * 
