...
public final class misc_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_misc_utilities_file() {
        ...
        misc_utilities.$system_code_initializations_marker$ = SubLFiles.deflexical("*SYSTEM-CODE-INITIALIZATIONS-MARKER*", (misc_utilities.NIL != Symbols.boundp((SubLObject)misc_utilities.$sym2$_SYSTEM_CODE_INITIALIZATIONS_MARKER_)) ? misc_utilities.$system_code_initializations_marker$.getGlobalValue() : Environment.get_process_id((SubLObject)misc_utilities.UNPROVIDED));
        misc_utilities.$system_code_initializations_lock$ = SubLFiles.deflexical("*SYSTEM-CODE-INITIALIZATIONS-LOCK*", (misc_utilities.NIL != Symbols.boundp((SubLObject)misc_utilities.$sym3$_SYSTEM_CODE_INITIALIZATIONS_LOCK_)) ? misc_utilities.$system_code_initializations_lock$.getGlobalValue() : Locks.make_lock((SubLObject)misc_utilities.$str4$System_Code_Initializations_Lock));
        ...
        misc_utilities.$hl_store_caches_directory$ = SubLFiles.deflexical("*HL-STORE-CACHES-DIRECTORY*", (SubLObject)((misc_utilities.NIL != Symbols.boundp((SubLObject)misc_utilities.$sym38$_HL_STORE_CACHES_DIRECTORY_)) ? misc_utilities.$hl_store_caches_directory$.getGlobalValue() : misc_utilities.NIL));
        misc_utilities.$hl_store_caches_shared_symbols$ = SubLFiles.deflexical("*HL-STORE-CACHES-SHARED-SYMBOLS*", (SubLObject)((misc_utilities.NIL != Symbols.boundp((SubLObject)misc_utilities.$sym39$_HL_STORE_CACHES_SHARED_SYMBOLS_)) ? misc_utilities.$hl_store_caches_shared_symbols$.getGlobalValue() : misc_utilities.NIL));
        misc_utilities.$hl_store_caches_shared_symbols_simple$ = SubLFiles.deflexical("*HL-STORE-CACHES-SHARED-SYMBOLS-SIMPLE*", (SubLObject)((misc_utilities.NIL != Symbols.boundp((SubLObject)misc_utilities.$sym40$_HL_STORE_CACHES_SHARED_SYMBOLS_SIMPLE_)) ? misc_utilities.$hl_store_caches_shared_symbols_simple$.getGlobalValue() : misc_utilities.NIL));
