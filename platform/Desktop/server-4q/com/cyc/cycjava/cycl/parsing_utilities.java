...
public final class parsing_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_parsing_utilities_file() {
        ...
        parsing_utilities.$spps_to_nl_numbers$ = SubLFiles.deflexical("*SPPS-TO-NL-NUMBERS*", maybeDefault((SubLObject)parsing_utilities.$sym81$_SPPS_TO_NL_NUMBERS_, parsing_utilities.$spps_to_nl_numbers$, ()->(Hashtables.make_hash_table((SubLObject)parsing_utilities.$int82$128, (SubLObject)parsing_utilities.UNPROVIDED, (SubLObject)parsing_utilities.UNPROVIDED))));
        ...
        parsing_utilities.$penntag_phrase_categories$ = SubLFiles.deflexical("*PENNTAG-PHRASE-CATEGORIES*", (SubLObject)(maybeDefault((SubLObject)parsing_utilities.$sym203$_PENNTAG_PHRASE_CATEGORIES_, parsing_utilities.$penntag_phrase_categories$, parsing_utilities.$kw89$UNINITIALIZED)));
        parsing_utilities.$penntag_forts$ = SubLFiles.deflexical("*PENNTAG-FORTS*", (SubLObject)(maybeDefault((SubLObject)parsing_utilities.$sym208$_PENNTAG_FORTS_, parsing_utilities.$penntag_forts$, parsing_utilities.$kw89$UNINITIALIZED)));
