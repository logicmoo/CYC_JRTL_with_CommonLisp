...
public final class proof_view_populator extends SubLTranslatedFile
{
    ...
    public static SubLObject init_proof_view_populator_file() {
        ...
        proof_view_populator.$proof_view_special_sections$ = SubLFiles.deflexical("*PROOF-VIEW-SPECIAL-SECTIONS*", maybeDefault((SubLObject)proof_view_populator.$sym59$_PROOF_VIEW_SPECIAL_SECTIONS_, proof_view_populator.$proof_view_special_sections$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)proof_view_populator.EQL), (SubLObject)proof_view_populator.UNPROVIDED))));
        proof_view_populator.$proof_view_special_section_terms$ = SubLFiles.deflexical("*PROOF-VIEW-SPECIAL-SECTION-TERMS*", maybeDefault((SubLObject)proof_view_populator.$sym60$_PROOF_VIEW_SPECIAL_SECTION_TERMS_, proof_view_populator.$proof_view_special_section_terms$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)proof_view_populator.EQL), (SubLObject)proof_view_populator.UNPROVIDED))));
        proof_view_populator.$proof_conclusion_proof_view_counts$ = SubLFiles.deflexical("*PROOF-CONCLUSION-PROOF-VIEW-COUNTS*", maybeDefault((SubLObject)proof_view_populator.$sym68$_PROOF_CONCLUSION_PROOF_VIEW_COUNTS_, proof_view_populator.$proof_conclusion_proof_view_counts$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)proof_view_populator.EQUAL), (SubLObject)proof_view_populator.UNPROVIDED))));
