...
public final class subloop_class_properties
    extends
      SubLTranslatedFile
{
  ...
  {
    subloop_structures._csetf_class_class_properties( class_structure, bytes.dpb( ( NIL != new_value ) ? ONE_INTEGER : ZERO_INTEGER, bytes.sublisp_byte( ONE_INTEGER, ZERO_INTEGER ), subloop_structures
        .class_class_properties( class_structure ) ) );
    return new_value;
  }

  public static SubLObject declare_subloop_class_properties_file()
  {
    SubLFiles.declareFunction( me, "get_subloop_class_property_abstract_p", "GET-SUBLOOP-CLASS-PROPERTY-ABSTRACT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "set_subloop_class_property_abstract_p", "SET-SUBLOOP-CLASS-PROPERTY-ABSTRACT-P", 2, 0, false );
    return NIL;
  }
  ...
  static
  {
    me = new subloop_class_properties();
  }
}
/*
 * 
