...
public final class cb_system_tools extends SubLTranslatedFile
{
    ...
    public static SubLObject init_cb_system_tools_file() {
        ...
        cb_system_tools.$cb_mode_checkpoint_collection$ = SubLFiles.deflexical("*CB-MODE-CHECKPOINT-COLLECTION*", (cb_system_tools.NIL != Symbols.boundp((SubLObject)cb_system_tools.$sym72$_CB_MODE_CHECKPOINT_COLLECTION_)) ? cb_system_tools.$cb_mode_checkpoint_collection$.getGlobalValue() : cb_system_tools.$const73$Cyc_BasedProject);
        cb_system_tools.$oe_patch_messages_enabledP$ = SubLFiles.deflexical("*OE-PATCH-MESSAGES-ENABLED?*", (SubLObject)((cb_system_tools.NIL != Symbols.boundp((SubLObject)cb_system_tools.$sym74$_OE_PATCH_MESSAGES_ENABLED__)) ? cb_system_tools.$oe_patch_messages_enabledP$.getGlobalValue() : cb_system_tools.NIL));
        cb_system_tools.$default_oe_patch_message_recipient$ = SubLFiles.deflexical("*DEFAULT-OE-PATCH-MESSAGE-RECIPIENT*", (SubLObject)((cb_system_tools.NIL != Symbols.boundp((SubLObject)cb_system_tools.$sym82$_DEFAULT_OE_PATCH_MESSAGE_RECIPIENT_)) ? cb_system_tools.$default_oe_patch_message_recipient$.getGlobalValue() : cb_system_tools.$str83$));
        cb_system_tools.$oe_patch_message_smtp_host$ = SubLFiles.deflexical("*OE-PATCH-MESSAGE-SMTP-HOST*", (SubLObject)((cb_system_tools.NIL != Symbols.boundp((SubLObject)cb_system_tools.$sym84$_OE_PATCH_MESSAGE_SMTP_HOST_)) ? cb_system_tools.$oe_patch_message_smtp_host$.getGlobalValue() : cb_system_tools.$str83$));
