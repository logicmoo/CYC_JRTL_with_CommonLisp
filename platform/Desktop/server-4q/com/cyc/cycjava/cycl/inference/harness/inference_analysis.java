...
public final class inference_analysis extends SubLTranslatedFile
{
    ...
    public static SubLObject init_inference_analysis_file() {
        inference_analysis.$transformation_rule_statistics_table$ = SubLFiles.deflexical("*TRANSFORMATION-RULE-STATISTICS-TABLE*", maybeDefault((SubLObject)inference_analysis.$sym0$_TRANSFORMATION_RULE_STATISTICS_TABLE_, inference_analysis.$transformation_rule_statistics_table$, ()->(Hashtables.make_hash_table((SubLObject)inference_analysis.$int1$64, Symbols.symbol_function((SubLObject)inference_analysis.EQL), (SubLObject)inference_analysis.UNPROVIDED))));
        inference_analysis.$transformation_rule_statistics_lock$ = SubLFiles.deflexical("*TRANSFORMATION-RULE-STATISTICS-LOCK*", maybeDefault((SubLObject)inference_analysis.$sym2$_TRANSFORMATION_RULE_STATISTICS_LOCK_, inference_analysis.$transformation_rule_statistics_lock$, ()->(Locks.make_lock((SubLObject)inference_analysis.$str3$Transformation_Rule_Statistics_Lo))));
        inference_analysis.$transformation_rule_statistics_filename_load_history$ = SubLFiles.deflexical("*TRANSFORMATION-RULE-STATISTICS-FILENAME-LOAD-HISTORY*", (SubLObject)(maybeDefault((SubLObject)inference_analysis.$sym4$_TRANSFORMATION_RULE_STATISTICS_FILENAME_LOAD_HISTORY_, inference_analysis.$transformation_rule_statistics_filename_load_history$, inference_analysis.NIL)));
        inference_analysis.$transformation_rule_statistics_received_filename_load_history$ = SubLFiles.deflexical("*TRANSFORMATION-RULE-STATISTICS-RECEIVED-FILENAME-LOAD-HISTORY*", (SubLObject)(maybeDefault((SubLObject)inference_analysis.$sym5$_TRANSFORMATION_RULE_STATISTICS_RECEIVED_FILENAME_LOAD_HISTORY_, inference_analysis.$transformation_rule_statistics_received_filename_load_history$, inference_analysis.NIL)));
        ...
        inference_analysis.$transformation_rule_historical_connectivity_graph$ = SubLFiles.deflexical("*TRANSFORMATION-RULE-HISTORICAL-CONNECTIVITY-GRAPH*", maybeDefault((SubLObject)inference_analysis.$sym72$_TRANSFORMATION_RULE_HISTORICAL_CONNECTIVITY_GRAPH_, inference_analysis.$transformation_rule_historical_connectivity_graph$, ()->(Hashtables.make_hash_table((SubLObject)inference_analysis.$int73$256, Symbols.symbol_function((SubLObject)inference_analysis.EQL), (SubLObject)inference_analysis.UNPROVIDED))));
        inference_analysis.$transformation_rule_historical_connectivity_graph_lock$ = SubLFiles.deflexical("*TRANSFORMATION-RULE-HISTORICAL-CONNECTIVITY-GRAPH-LOCK*", maybeDefault((SubLObject)inference_analysis.$sym74$_TRANSFORMATION_RULE_HISTORICAL_CONNECTIVITY_GRAPH_LOCK_, inference_analysis.$transformation_rule_historical_connectivity_graph_lock$, ()->(Locks.make_lock((SubLObject)inference_analysis.$str75$Rule_Historical_Connectivity_Grap))));
        ...
        inference_analysis.$asked_queries_queue$ = SubLFiles.deflexical("*ASKED-QUERIES-QUEUE*", maybeDefault((SubLObject)inference_analysis.$sym87$_ASKED_QUERIES_QUEUE_, inference_analysis.$asked_queries_queue$, ()->(queues.create_queue((SubLObject)inference_analysis.UNPROVIDED))));
        ...
        inference_analysis.$asked_query_common_symbols$ = SubLFiles.deflexical("*ASKED-QUERY-COMMON-SYMBOLS*", (SubLObject)(maybeDefault((SubLObject)inference_analysis.$sym99$_ASKED_QUERY_COMMON_SYMBOLS_, inference_analysis.$asked_query_common_symbols$, inference_analysis.NIL)));
        inference_analysis.$asked_query_common_symbols_simple$ = SubLFiles.deflexical("*ASKED-QUERY-COMMON-SYMBOLS-SIMPLE*", (SubLObject)(maybeDefault((SubLObject)inference_analysis.$sym100$_ASKED_QUERY_COMMON_SYMBOLS_SIMPLE_, inference_analysis.$asked_query_common_symbols_simple$, inference_analysis.NIL)));
        return (SubLObject)inference_analysis.NIL;
    }
