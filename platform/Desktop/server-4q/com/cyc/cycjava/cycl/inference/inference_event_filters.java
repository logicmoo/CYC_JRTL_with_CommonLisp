...
public final class inference_event_filters extends SubLTranslatedFile
{
    ...
    public static SubLObject init_inference_event_filters_file() {
        inference_event_filters.$inference_event_filter_lock$ = SubLFiles.deflexical("*INFERENCE-EVENT-FILTER-LOCK*", (inference_event_filters.NIL != Symbols.boundp((SubLObject)inference_event_filters.$sym0$_INFERENCE_EVENT_FILTER_LOCK_)) ? inference_event_filters.$inference_event_filter_lock$.getGlobalValue() : Locks.make_lock((SubLObject)inference_event_filters.$str1$Inference_Event_Filter_Lock));
        inference_event_filters.$inference_event_filter_listeners$ = SubLFiles.deflexical("*INFERENCE-EVENT-FILTER-LISTENERS*", (inference_event_filters.NIL != Symbols.boundp((SubLObject)inference_event_filters.$sym2$_INFERENCE_EVENT_FILTER_LISTENERS_)) ? inference_event_filters.$inference_event_filter_listeners$.getGlobalValue() : dictionary.new_dictionary((SubLObject)inference_event_filters.UNPROVIDED, (SubLObject)inference_event_filters.UNPROVIDED));
        inference_event_filters.$inference_event_filter_relayer$ = SubLFiles.deflexical("*INFERENCE-EVENT-FILTER-RELAYER*", (inference_event_filters.NIL != Symbols.boundp((SubLObject)inference_event_filters.$sym5$_INFERENCE_EVENT_FILTER_RELAYER_)) ? inference_event_filters.$inference_event_filter_relayer$.getGlobalValue() : event_broker.describe_funcall_listener((SubLObject)inference_event_filters.$kw6$INFERENCE_EVENT, (SubLObject)inference_event_filters.$sym7$RELAY_INFERENCE_EVENT, (SubLObject)inference_event_filters.UNPROVIDED, (SubLObject)inference_event_filters.UNPROVIDED));
