...
public final class preference_modules extends SubLTranslatedFile
{
    ...
    public static SubLObject init_preference_modules_file() {
        ...
        preference_modules.$preference_modules_by_name$ = SubLFiles.deflexical("*PREFERENCE-MODULES-BY-NAME*", maybeDefault((SubLObject)preference_modules.$sym18$_PREFERENCE_MODULES_BY_NAME_, preference_modules.$preference_modules_by_name$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)preference_modules.EQ), (SubLObject)preference_modules.UNPROVIDED))));
        preference_modules.$generic_preference_modules$ = SubLFiles.deflexical("*GENERIC-PREFERENCE-MODULES*", maybeDefault((SubLObject)preference_modules.$sym5$_GENERIC_PREFERENCE_MODULES_, preference_modules.$generic_preference_modules$, ()->(set.new_set(Symbols.symbol_function((SubLObject)preference_modules.EQ), (SubLObject)preference_modules.UNPROVIDED))));
        preference_modules.$specific_preference_modules$ = SubLFiles.deflexical("*SPECIFIC-PREFERENCE-MODULES*", maybeDefault((SubLObject)preference_modules.$sym82$_SPECIFIC_PREFERENCE_MODULES_, preference_modules.$specific_preference_modules$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)preference_modules.EQL), (SubLObject)preference_modules.UNPROVIDED))));
        preference_modules.$preference_module_supplants$ = SubLFiles.deflexical("*PREFERENCE-MODULE-SUPPLANTS*", maybeDefault((SubLObject)preference_modules.$sym83$_PREFERENCE_MODULE_SUPPLANTS_, preference_modules.$preference_module_supplants$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)preference_modules.EQ), (SubLObject)preference_modules.UNPROVIDED))));
        ...
        preference_modules.$doom_module_store$ = SubLFiles.deflexical("*DOOM-MODULE-STORE*", maybeDefault((SubLObject)preference_modules.$sym157$_DOOM_MODULE_STORE_, preference_modules.$doom_module_store$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)preference_modules.EQUAL), (SubLObject)preference_modules.UNPROVIDED))));
        return (SubLObject)preference_modules.NIL;
    }
