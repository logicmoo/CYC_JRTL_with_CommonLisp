...
public final class inference_modules extends SubLTranslatedFile
{
    ...
    public static SubLObject init_inference_modules_file() {
        inference_modules.$meta_removal_modules$ = SubLFiles.deflexical("*META-REMOVAL-MODULES*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym0$_META_REMOVAL_MODULES_, inference_modules.$meta_removal_modules$, inference_modules.NIL)));
        ...
        inference_modules.$hl_module_store$ = SubLFiles.deflexical("*HL-MODULE-STORE*", maybeDefault((SubLObject)inference_modules.$sym84$_HL_MODULE_STORE_, inference_modules.$hl_module_store$, ()->(Hashtables.make_hash_table((SubLObject)inference_modules.$int85$212, Symbols.symbol_function((SubLObject)inference_modules.EQUAL), (SubLObject)inference_modules.UNPROVIDED))));
        inference_modules.$removal_modules$ = SubLFiles.deflexical("*REMOVAL-MODULES*", maybeDefault((SubLObject)inference_modules.$sym146$_REMOVAL_MODULES_, inference_modules.$removal_modules$, ()->(set.new_set(Symbols.symbol_function((SubLObject)inference_modules.EQL), (SubLObject)inference_modules.UNPROVIDED))));
        inference_modules.$removal_modules_external$ = SubLFiles.deflexical("*REMOVAL-MODULES-EXTERNAL*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym152$_REMOVAL_MODULES_EXTERNAL_, inference_modules.$removal_modules_external$, inference_modules.NIL)));
        inference_modules.$removal_modules_generic$ = SubLFiles.deflexical("*REMOVAL-MODULES-GENERIC*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym153$_REMOVAL_MODULES_GENERIC_, inference_modules.$removal_modules_generic$, inference_modules.NIL)));
        inference_modules.$removal_modules_universal$ = SubLFiles.deflexical("*REMOVAL-MODULES-UNIVERSAL*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym155$_REMOVAL_MODULES_UNIVERSAL_, inference_modules.$removal_modules_universal$, inference_modules.NIL)));
        inference_modules.$removal_modules_specific$ = SubLFiles.deflexical("*REMOVAL-MODULES-SPECIFIC*", maybeDefault((SubLObject)inference_modules.$sym156$_REMOVAL_MODULES_SPECIFIC_, inference_modules.$removal_modules_specific$, ()->(Hashtables.make_hash_table((SubLObject)inference_modules.$int157$32, (SubLObject)inference_modules.UNPROVIDED, (SubLObject)inference_modules.UNPROVIDED))));
        inference_modules.$removal_modules_specific_use_generic$ = SubLFiles.deflexical("*REMOVAL-MODULES-SPECIFIC-USE-GENERIC*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym159$_REMOVAL_MODULES_SPECIFIC_USE_GENERIC_, inference_modules.$removal_modules_specific_use_generic$, inference_modules.NIL)));
        inference_modules.$removal_modules_specific_use_meta_removal$ = SubLFiles.deflexical("*REMOVAL-MODULES-SPECIFIC-USE-META-REMOVAL*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym160$_REMOVAL_MODULES_SPECIFIC_USE_META_REMOVAL_, inference_modules.$removal_modules_specific_use_meta_removal$, inference_modules.NIL)));
        inference_modules.$removal_modules_specific_dont_use_universal$ = SubLFiles.deflexical("*REMOVAL-MODULES-SPECIFIC-DONT-USE-UNIVERSAL*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym161$_REMOVAL_MODULES_SPECIFIC_DONT_USE_UNIVERSAL_, inference_modules.$removal_modules_specific_dont_use_universal$, inference_modules.NIL)));
        inference_modules.$solely_specific_removal_module_predicate_store$ = SubLFiles.deflexical("*SOLELY-SPECIFIC-REMOVAL-MODULE-PREDICATE-STORE*", maybeDefault((SubLObject)inference_modules.$sym162$_SOLELY_SPECIFIC_REMOVAL_MODULE_PREDICATE_STORE_, inference_modules.$solely_specific_removal_module_predicate_store$, ()->(set.new_set((SubLObject)inference_modules.EQL, (SubLObject)inference_modules.$int163$50))));
        ...
        inference_modules.$conjunctive_removal_modules$ = SubLFiles.deflexical("*CONJUNCTIVE-REMOVAL-MODULES*", maybeDefault((SubLObject)inference_modules.$sym173$_CONJUNCTIVE_REMOVAL_MODULES_, inference_modules.$conjunctive_removal_modules$, ()->(set.new_set(Symbols.symbol_function((SubLObject)inference_modules.EQL), (SubLObject)inference_modules.UNPROVIDED))));
        inference_modules.$transformation_modules$ = SubLFiles.deflexical("*TRANSFORMATION-MODULES*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym183$_TRANSFORMATION_MODULES_, inference_modules.$transformation_modules$, inference_modules.NIL)));
        inference_modules.$meta_transformation_modules$ = SubLFiles.deflexical("*META-TRANSFORMATION-MODULES*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym188$_META_TRANSFORMATION_MODULES_, inference_modules.$meta_transformation_modules$, inference_modules.NIL)));
        inference_modules.$rewrite_modules$ = SubLFiles.deflexical("*REWRITE-MODULES*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym193$_REWRITE_MODULES_, inference_modules.$rewrite_modules$, inference_modules.NIL)));
        inference_modules.$structural_modules$ = SubLFiles.deflexical("*STRUCTURAL-MODULES*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym199$_STRUCTURAL_MODULES_, inference_modules.$structural_modules$, inference_modules.NIL)));
        inference_modules.$meta_structural_modules$ = SubLFiles.deflexical("*META-STRUCTURAL-MODULES*", (SubLObject)(maybeDefault((SubLObject)inference_modules.$sym201$_META_STRUCTURAL_MODULES_, inference_modules.$meta_structural_modules$, inference_modules.NIL)));
