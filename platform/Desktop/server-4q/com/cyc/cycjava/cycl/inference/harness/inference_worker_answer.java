...
public final class inference_worker_answer extends SubLTranslatedFile
{
    ...
    public static SubLObject answer_link_p(final SubLObject v_object) {
        return (SubLObject)SubLObjectFactory.makeBoolean(inference_worker_answer.NIL != inference_datastructures_problem_link.problem_link_p(v_object) && inference_worker_answer.$kw0$ANSWER == inference_datastructures_problem_link.problem_link_type(v_object));
    }
    ...
    public static SubLObject new_answer_link(final SubLObject inference) {
        assert inference_worker_answer.NIL != inference_datastructures_inference.inference_p(inference) : inference;
    ...
    public static SubLObject new_answer_link_int(final SubLObject inference) {
        ...
        final SubLObject answer_link = inference_datastructures_problem_link.new_problem_link_int(inference, (SubLObject)inference_worker_answer.$kw0$ANSWER);
    ...
    public static SubLObject answer_link_supported_inference(final SubLObject answer_link) {
        assert inference_worker_answer.NIL != answer_link_p(answer_link) : answer_link;
    ...
    public static SubLObject set_answer_link_explanatory_subquery(final SubLObject answer_link, final SubLObject subquery) {
        assert inference_worker_answer.NIL != answer_link_p(answer_link) : answer_link;
        assert inference_worker_answer.NIL != inference_datastructures_problem_query.explanatory_subquery_spec_p(subquery) : subquery;
    ...
    public static SubLObject answer_link_supporting_problem_wholly_explanatoryP(final SubLObject answer_link) {
        return Equality.eq((SubLObject)inference_worker_answer.$kw4$ALL, answer_link_explanatory_subquery(answer_link));
    }
    
    public static SubLObject declare_inference_worker_answer_file() {
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "answer_link_p", "ANSWER-LINK-P", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "new_answer_link", "NEW-ANSWER-LINK", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "new_answer_link_int", "NEW-ANSWER-LINK-INT", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "answer_link_supported_inference", "ANSWER-LINK-SUPPORTED-INFERENCE", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "answer_link_propagatedP", "ANSWER-LINK-PROPAGATED?", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "answer_link_supporting_mapped_problem", "ANSWER-LINK-SUPPORTING-MAPPED-PROBLEM", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "answer_link_explanatory_subquery", "ANSWER-LINK-EXPLANATORY-SUBQUERY", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "set_answer_link_explanatory_subquery", "SET-ANSWER-LINK-EXPLANATORY-SUBQUERY", 2, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "note_answer_link_propagated", "NOTE-ANSWER-LINK-PROPAGATED", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "answer_link_supporting_problem", "ANSWER-LINK-SUPPORTING-PROBLEM", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.harness.inference_worker_answer", "answer_link_supporting_problem_wholly_explanatoryP", "ANSWER-LINK-SUPPORTING-PROBLEM-WHOLLY-EXPLANATORY?", 1, 0, false);
    ...
    static {
        me = (SubLFile)new inference_worker_answer();
        $kw0$ANSWER = SubLObjectFactory.makeKeyword("ANSWER");
        $sym1$INFERENCE_P = SubLObjectFactory.makeSymbol("INFERENCE-P");
        $sym2$ANSWER_LINK_P = SubLObjectFactory.makeSymbol("ANSWER-LINK-P");
        $sym3$EXPLANATORY_SUBQUERY_SPEC_P = SubLObjectFactory.makeSymbol("EXPLANATORY-SUBQUERY-SPEC-P");
