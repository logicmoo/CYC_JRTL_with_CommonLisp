...
public final class cb_query_browser extends SubLTranslatedFile
{
    ...
    public static SubLObject cb_show_inference_el_query(final SubLObject inference, SubLObject show_mtP) {
        if (show_mtP == cb_query_browser.UNPROVIDED) {
            show_mtP = (SubLObject)cb_query_browser.T;
        }
        SubLObject el_query = inference_datastructures_inference.inference_input_el_query(inference);
        if (cb_query_browser.NIL == el_query) {
        ...
        if (cb_query_browser.NIL != show_mtP) {
            final SubLObject mt = inference_datastructures_inference.inference_input_mt(inference);
            if (cb_query_browser.NIL != mt) {
                html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str2$Mt__);
                html_utilities.html_indent((SubLObject)cb_query_browser.UNPROVIDED);
                cb_utilities.cb_show_term(mt, (SubLObject)cb_query_browser.ZERO_INTEGER, (SubLObject)cb_query_browser.NIL);
                html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
            }
        }
        html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str3$EL_Query__);
        html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
        cb_utilities.cb_form(el_query, (SubLObject)cb_query_browser.ZERO_INTEGER, (SubLObject)cb_query_browser.T);
        ...
        if (cb_query_browser.NIL != non_explanatory_el_query) {
            html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str4$Pragmatics__);
            html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
            cb_utilities.cb_form(non_explanatory_el_query, (SubLObject)cb_query_browser.ZERO_INTEGER, (SubLObject)cb_query_browser.T);
        }
        return inference;
    }
    ...
    public static SubLObject cb_show_inference_status(final SubLObject status) {
        assert cb_query_browser.NIL != inference_datastructures_enumerated_types.inference_status_p(status) : status;
        if (status.eql((SubLObject)cb_query_browser.$kw6$NEW)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str7$New);
        }
        else if (status.eql((SubLObject)cb_query_browser.$kw8$PREPARED)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str9$Prepared);
        }
        else if (status.eql((SubLObject)cb_query_browser.$kw10$READY)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str11$Ready);
        }
        else if (status.eql((SubLObject)cb_query_browser.$kw12$RUNNING)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str13$Running);
        }
        else if (status.eql((SubLObject)cb_query_browser.$kw14$SUSPENDED)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str15$Suspended);
        }
        else if (status.eql((SubLObject)cb_query_browser.$kw16$DEAD)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str17$Dead);
        }
        else if (status.eql((SubLObject)cb_query_browser.$kw18$TAUTOLOGY)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str19$Tautology);
        }
        else if (status.eql((SubLObject)cb_query_browser.$kw20$CONTRADICTION)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str21$Contradiction);
        }
        else if (status.eql((SubLObject)cb_query_browser.$kw22$ILL_FORMED)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str23$Ill_Formed);
        }
        else {
    ...
    public static SubLObject cb_show_inference_suspend_status(final SubLObject suspend_status) {
        assert cb_query_browser.NIL != inference_datastructures_enumerated_types.inference_suspend_status_p(suspend_status) : suspend_status;
        if (suspend_status.eql((SubLObject)cb_query_browser.$kw25$ABORT)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str26$Abort);
        }
        else if (suspend_status.eql((SubLObject)cb_query_browser.$kw27$INTERRUPT)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str28$Interrupt);
        }
        else if (suspend_status.eql((SubLObject)cb_query_browser.$kw29$MAX_NUMBER)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str30$Max_Number);
        }
        else if (suspend_status.eql((SubLObject)cb_query_browser.$kw31$MAX_TIME)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str32$Max_Time);
        }
        else if (suspend_status.eql((SubLObject)cb_query_browser.$kw33$MAX_STEP)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str34$Max_Step);
        }
        else if (suspend_status.eql((SubLObject)cb_query_browser.$kw35$MAX_PROBLEM_COUNT)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str36$Max_Problem_Count);
        }
        else if (suspend_status.eql((SubLObject)cb_query_browser.$kw37$PROBABLY_APPROXIMATELY_DONE)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str38$Probably_Approximately_Done);
        }
        else if (suspend_status.eql((SubLObject)cb_query_browser.$kw39$EXHAUST)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str40$Exhaust);
        }
        else if (suspend_status.eql((SubLObject)cb_query_browser.$kw41$EXHAUST_TOTAL)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str42$Exhaust_Total);
        }
        else {
    ...
    public static SubLObject cb_inference_answer(final SubLObject args) {
        SubLObject store_id_string = (SubLObject)cb_query_browser.NIL;
        SubLObject inference_id_string = (SubLObject)cb_query_browser.NIL;
        SubLObject answer_id_string = (SubLObject)cb_query_browser.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(args, args, (SubLObject)cb_query_browser.$list43);
        store_id_string = args.first();
        SubLObject current = args.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, args, (SubLObject)cb_query_browser.$list43);
        inference_id_string = current.first();
        current = current.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, args, (SubLObject)cb_query_browser.$list43);
        answer_id_string = current.first();
        current = current.rest();
        if (cb_query_browser.NIL != current) {
            cdestructuring_bind.cdestructuring_bind_error(args, (SubLObject)cb_query_browser.$list43);
            return (SubLObject)cb_query_browser.NIL;
        }
        final SubLObject v_answer = cb_guess_inference_answer(store_id_string, inference_id_string, answer_id_string);
        if (cb_query_browser.NIL == inference_datastructures_inference.inference_answer_p(v_answer)) {
            return cb_utilities.cb_error((SubLObject)cb_query_browser.$str44$_A_did_not_specify_an_inference_a, args, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
        }
    ...
    public static SubLObject cb_link_inference_answer(final SubLObject v_answer, SubLObject verbosity, SubLObject linktext, SubLObject target) {
        if (verbosity == cb_query_browser.UNPROVIDED) {
            verbosity = (SubLObject)cb_query_browser.NIL;
        }
        if (linktext == cb_query_browser.UNPROVIDED) {
            linktext = (SubLObject)cb_query_browser.NIL;
        }
        if (target == cb_query_browser.UNPROVIDED) {
            target = (SubLObject)cb_query_browser.NIL;
        }
        final SubLThread thread = SubLProcess.currentSubLThread();
        if (cb_query_browser.NIL == target) {
            target = (SubLObject)cb_query_browser.$kw47$MAIN;
        }
        if (cb_query_browser.NIL == verbosity) {
            verbosity = (SubLObject)cb_query_browser.$kw48$TERSE;
        }
        ...
        if (cb_query_browser.NIL == linktext) {
            final SubLObject pcase_var = verbosity;
            if (pcase_var.eql((SubLObject)cb_query_browser.$kw49$MINIMAL)) {
                linktext = PrintLow.format((SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.$str50$__A__A__A_, new SubLObject[] { store_id, inference_id, answer_id });
            }
            else if (pcase_var.eql((SubLObject)cb_query_browser.$kw48$TERSE)) {
                linktext = PrintLow.format((SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.$str51$_Inference_Answer__A__A__A_, new SubLObject[] { store_id, inference_id, answer_id });
            }
            else if (pcase_var.eql((SubLObject)cb_query_browser.$kw52$VERBOSE)) {
                linktext = PrintLow.format((SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.$str53$_Inference_Answer__A__A__A__A_, new SubLObject[] { store_id, inference_id, answer_id, v_bindings });
            }
        }
        html_utilities.html_markup(html_macros.$html_no_break_head$.getGlobalValue());
        if (cb_query_browser.NIL != cb_parameters.$cb_use_dynamic_table_for_inference_results$.getDynamicValue(thread)) {
            html_utilities.html_markup(html_macros.$html_span_head$.getGlobalValue());
            if (cb_query_browser.NIL != answer_id) {
                html_utilities.html_markup(html_macros.$html_attribute_title$.getGlobalValue());
                html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                html_utilities.html_markup(answer_id);
                html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
            }
            html_utilities.html_char((SubLObject)Characters.CHAR_greater, (SubLObject)cb_query_browser.UNPROVIDED);
            final SubLObject _prev_bind_0 = html_macros.$html_safe_print$.currentBinding(thread);
            try {
                html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
            }
            finally {
        ...
        PrintLow.format(html_macros.$html_stream$.getDynamicValue(thread), (SubLObject)cb_query_browser.$str54$cb_inference_answer__A__A__A, new SubLObject[] { store_id, inference_id, answer_id });
        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
        if (cb_query_browser.NIL != frame_name_var) {
        ...
        try {
            ...
            if (cb_query_browser.NIL != cb_parameters.$cb_use_dynamic_table_for_inference_results$.getDynamicValue(thread)) {
                ...
                html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                html_utilities.html_markup((SubLObject)cb_query_browser.$str55$button);
                html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                if (cb_query_browser.NIL != answer_id) {
                ...
                if (cb_query_browser.NIL != html_macros.$html_input_disabledP$.getDynamicValue(thread)) {
    ...
    public static SubLObject cb_form_inference_answer_method(final SubLObject v_object, SubLObject depth, SubLObject wrap_axiomsP) {
        if (depth == cb_query_browser.UNPROVIDED) {
            depth = (SubLObject)cb_query_browser.NIL;
        }
        if (wrap_axiomsP == cb_query_browser.UNPROVIDED) {
            wrap_axiomsP = (SubLObject)cb_query_browser.NIL;
        }
        cb_utilities.cb_link((SubLObject)cb_query_browser.$kw56$INFERENCE_ANSWER, v_object, (SubLObject)cb_query_browser.$kw52$VERBOSE, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
        return v_object;
    }
    ...
    public static SubLObject cb_show_inference_answer_summary(final SubLObject v_answer) {
        cb_utilities.cb_link((SubLObject)cb_query_browser.$kw56$INFERENCE_ANSWER, v_answer, (SubLObject)cb_query_browser.$kw48$TERSE, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
        html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
        final SubLObject v_bindings = inference_datastructures_inference.inference_answer_bindings(v_answer);
        cb_show_bindings(v_bindings, (SubLObject)cb_query_browser.UNPROVIDED);
        return v_answer;
    }
    ...
    public static SubLObject cb_inference_answer_guts(final SubLObject v_answer) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        html_utilities.html_markup((SubLObject)cb_query_browser.$str59$__DOCTYPE_html_PUBLIC_____W3C__DT);
        if (cb_query_browser.NIL != html_macros.$html_force_ie_standards_mode$.getDynamicValue(thread)) {
            html_utilities.html_source_readability_terpri((SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_markup((SubLObject)cb_query_browser.$str60$_meta_http_equiv__X_UA_Compatible);
        }
        html_utilities.html_source_readability_terpri((SubLObject)cb_query_browser.UNPROVIDED);
        final SubLObject _prev_bind_0 = cyc_file_dependencies.$html_emitted_file_dependencies$.currentBinding(thread);
        try {
            cyc_file_dependencies.$html_emitted_file_dependencies$.bind((SubLObject)((cyc_file_dependencies.$html_emitted_file_dependencies$.getDynamicValue(thread) == cb_query_browser.$kw61$UNINITIALIZED) ? ConsesLow.list(cb_query_browser.EMPTY_SUBL_OBJECT_ARRAY) : cyc_file_dependencies.$html_emitted_file_dependencies$.getDynamicValue(thread)), thread);
            html_utilities.html_markup(html_macros.$html_html_head$.getGlobalValue());
            html_utilities.html_markup(html_macros.$html_head_head$.getGlobalValue());
            html_macros.html_head_content_type();
            html_utilities.html_source_readability_terpri((SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_markup(html_macros.$html_title_head$.getGlobalValue());
            html_utilities.html_princ((SubLObject)cb_query_browser.$str62$Inference_Answer);
            ...
            try {
                html_macros.$html_id_space_id_generator$.bind((cb_query_browser.NIL != integer_sequence_generator.integer_sequence_generator_p(html_macros.$html_id_space_id_generator$.getDynamicValue(thread))) ? html_macros.$html_id_space_id_generator$.getDynamicValue(thread) : integer_sequence_generator.new_integer_sequence_generator((SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED), thread);
                html_macros.$html_inside_bodyP$.bind((SubLObject)cb_query_browser.T, thread);
                ...
                try {
                    ...
                    html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str62$Inference_Answer);
                    html_utilities.html_indent((SubLObject)cb_query_browser.UNPROVIDED);
                    cb_utilities.cb_link((SubLObject)cb_query_browser.$kw56$INFERENCE_ANSWER, v_answer, (SubLObject)cb_query_browser.$kw48$TERSE, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_princ((SubLObject)cb_query_browser.$str63$_for_);
                    cb_utilities.cb_link((SubLObject)cb_query_browser.$kw64$INFERENCE, inference_datastructures_inference.inference_answer_inference(v_answer), (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_princ((SubLObject)cb_query_browser.$str65$_in_);
                    cb_utilities.cb_link((SubLObject)cb_query_browser.$kw66$PROBLEM_STORE, inference_datastructures_inference.inference_answer_problem_store(v_answer), (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_indent((SubLObject)cb_query_browser.FOUR_INTEGER);
                    cb_utilities.cb_link((SubLObject)cb_query_browser.$kw67$SOCRATIC_QUERY_FROM_ANSWER, v_answer, (SubLObject)cb_query_browser.$str68$_Socratic_Query_, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_indent((SubLObject)cb_query_browser.TWO_INTEGER);
                    html_utilities.html_hr((SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                    cb_show_inference_el_query(inference_datastructures_inference.inference_answer_inference(v_answer), (SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_newline((SubLObject)cb_query_browser.TWO_INTEGER);
                    html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str69$Creation_Time____);
                    cb_show_inference_answer_creation_time(v_answer);
                    html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str70$Steps_to_This_Answer____);
                    ...
                    html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str71$Answer_Bindings__);
                    html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
                    cb_show_inference_answer_bindings(v_bindings, free_el_vars);
                    if (cb_query_browser.NIL != cb_query_browser.$cb_inference_browser_show_answer_max_floor_mtsP$.getDynamicValue(thread)) {
                        final SubLObject mts = inference_analysis.max_floor_mts_of_inference_answer(v_answer, (SubLObject)cb_query_browser.UNPROVIDED);
                        html_utilities.html_princ_strong(PrintLow.format((SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.$str72$Answer_Mt_p___, Sequences.length(mts)));
                        if (cb_query_browser.NIL != mts) {
                            SubLObject cdolist_list_var = mts;
                            SubLObject mt = (SubLObject)cb_query_browser.NIL;
                            mt = cdolist_list_var.first();
                            while (cb_query_browser.NIL != cdolist_list_var) {
                                cb_utilities.cb_form(mt, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                                html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
                            ...
                            html_utilities.html_princ((SubLObject)cb_query_browser.$str73$None_found);
                            html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
                        }
                    }
                    html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str74$Justifications__);
                    SubLObject cdolist_list_var2 = inference_datastructures_inference.inference_answer_justifications(v_answer);
                    SubLObject justification = (SubLObject)cb_query_browser.NIL;
                    justification = cdolist_list_var2.first();
                    while (cb_query_browser.NIL != cdolist_list_var2) {
                        html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
    ...
    public static SubLObject cb_show_inference_answer_creation_time(final SubLObject v_answer) {
        ...
        final SubLObject elapsed_creation_time = inference_datastructures_inference.inference_answer_elapsed_time(v_answer, (SubLObject)cb_query_browser.NIL);
        html_utilities.html_princ((SubLObject)cb_query_browser.$str75$after);
        html_utilities.html_princ(numeric_date_utilities.elapsed_seconds_string(elapsed_creation_time));
        html_utilities.html_princ((SubLObject)cb_query_browser.$str76$__at_);
        cb_show_universal_time(creation_time);
        html_utilities.html_princ((SubLObject)cb_query_browser.$str77$_);
        return (SubLObject)cb_query_browser.NIL;
    }
    ...
    public static SubLObject cb_show_universal_time(SubLObject universal_time) {
        if (universal_time == cb_query_browser.UNPROVIDED) {
            universal_time = Time.get_universal_time();
        }
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert cb_query_browser.NIL != numeric_date_utilities.universal_time_p(universal_time) : universal_time;
        ...
        if (universal_date.numE(numeric_date_utilities.today())) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str79$_today);
        }
        else {
            PrintLow.format(html_macros.$html_stream$.getDynamicValue(thread), (SubLObject)cb_query_browser.$str80$_on__A, numeric_date_utilities.datestring(universal_date));
        }
        return (SubLObject)cb_query_browser.NIL;
    }
    ...
    public static SubLObject cb_socratic_query_from_answer(final SubLObject args) {
        ...
        if (cb_query_browser.NIL == inference_datastructures_inference.inference_answer_p(inference_answer)) {
            return cb_utilities.cb_error((SubLObject)cb_query_browser.$str44$_A_did_not_specify_an_inference_a, args, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
        }
    ...
    public static SubLObject cb_link_socratic_query_from_answer(final SubLObject inference_answer, SubLObject linktext) {
        ...
        final SubLThread thread = SubLProcess.currentSubLThread();
        if (cb_query_browser.NIL == linktext) {
            linktext = (SubLObject)cb_query_browser.$str68$_Socratic_Query_;
        }
        ...
        final SubLObject store = inference_datastructures_inference.inference_problem_store(inference);
        final SubLObject store_id = inference_datastructures_problem_store.problem_store_suid(store);
        final SubLObject frame_name_var = cb_utilities.cb_frame_name((SubLObject)cb_query_browser.$kw82$SELF);
        html_utilities.html_markup(html_macros.$html_anchor_head$.getGlobalValue());
        html_utilities.html_markup(html_macros.$html_anchor_href$.getGlobalValue());
        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
        cb_parameters.cyc_cgi_url_int();
        PrintLow.format(html_macros.$html_stream$.getDynamicValue(thread), (SubLObject)cb_query_browser.$str83$cb_socratic_query_from_answer__A_, new SubLObject[] { store_id, inference_id, answer_id });
        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
        if (cb_query_browser.NIL != frame_name_var) {
            html_utilities.html_markup(html_macros.$html_anchor_target$.getGlobalValue());
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
    ...
    public static SubLObject cb_inference_answer_full_justification(final SubLObject args) {
        ...
        SubLObject inference_id_string = (SubLObject)cb_query_browser.NIL;
        SubLObject answer_id_string = (SubLObject)cb_query_browser.NIL;
        SubLObject justification_id_string = (SubLObject)cb_query_browser.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(args, args, (SubLObject)cb_query_browser.$list85);
        store_id_string = args.first();
        SubLObject current = args.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, args, (SubLObject)cb_query_browser.$list85);
        inference_id_string = current.first();
        current = current.rest();
        cdestructuring_bind.destructuring_bind_must_consp(current, args, (SubLObject)cb_query_browser.$list85);
        answer_id_string = current.first();
        ...
        current = current.rest();
        if (cb_query_browser.NIL != current) {
            cdestructuring_bind.cdestructuring_bind_error(args, (SubLObject)cb_query_browser.$list85);
            return (SubLObject)cb_query_browser.NIL;
        }
        ...
        if (cb_query_browser.NIL == inference_datastructures_inference.inference_answer_justification_p(justification)) {
            return cb_utilities.cb_error((SubLObject)cb_query_browser.$str86$_A_did_not_specify_an_inference_a, args, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
        }
    ...
    public static SubLObject cb_link_inference_answer_full_justification(final SubLObject justification, SubLObject verbosity, SubLObject linktext, SubLObject target) {
        ...
        if (cb_query_browser.NIL == linktext) {
            final SubLObject pcase_var = verbosity;
            if (pcase_var.eql((SubLObject)cb_query_browser.$kw49$MINIMAL)) {
                linktext = PrintLow.format((SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.$str88$__A__A__A__A_, new SubLObject[] { store_id, inference_id, answer_id, justification_id });
            }
            else if (pcase_var.eql((SubLObject)cb_query_browser.$kw48$TERSE)) {
                linktext = PrintLow.format((SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.$str89$_Inference_Answer__A__A__A__A_, new SubLObject[] { store_id, inference_id, answer_id, justification_id });
            }
            else if (pcase_var.eql((SubLObject)cb_query_browser.$kw52$VERBOSE)) {
                linktext = PrintLow.format((SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.$str90$_Inference_Answer__A__A__A__A__A_, new SubLObject[] { store_id, inference_id, answer_id, justification_id, v_bindings });
            }
        }
        html_utilities.html_markup(html_macros.$html_no_break_head$.getGlobalValue());
        final SubLObject frame_name_var = cb_utilities.cb_frame_name(target);
        ...
        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
        cb_parameters.cyc_cgi_url_int();
        PrintLow.format(html_macros.$html_stream$.getDynamicValue(thread), (SubLObject)cb_query_browser.$str91$cb_inference_answer_full_justific, new SubLObject[] { store_id, inference_id, answer_id, justification_id });
        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
        if (cb_query_browser.NIL != frame_name_var) {
            html_utilities.html_markup(html_macros.$html_anchor_target$.getGlobalValue());
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
    ...
    public static SubLObject inference_answer_justification_suid(final SubLObject justification) {
        ...
        return Sequences.position(justification, justifications, Symbols.symbol_function((SubLObject)cb_query_browser.EQ), (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
    }
    ...
    public static SubLObject cb_guess_inference_answer_justification(final SubLObject store_id_string, final SubLObject inference_id_string, final SubLObject answer_id_string, final SubLObject justification_id_string) {
        final SubLObject v_answer = cb_guess_inference_answer(store_id_string, inference_id_string, answer_id_string);
        if (cb_query_browser.NIL != inference_datastructures_inference.inference_answer_p(v_answer)) {
            final SubLObject just_id = reader.read_from_string_ignoring_errors(justification_id_string, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
            if (cb_query_browser.NIL != subl_promotions.non_negative_integer_p(just_id)) {
    ...
    public static SubLObject cb_inference_answer_full_justification_guts(final SubLObject justification) {
        ...
        final SubLObject inference = inference_datastructures_inference.inference_answer_inference(v_answer);
        final SubLObject store = inference_datastructures_inference.inference_problem_store(inference);
        final SubLObject title_var = (SubLObject)cb_query_browser.$str94$;
        ...
        try {
            ...
            try {
                ...
                cyc_file_dependencies.css((SubLObject)cb_query_browser.$kw95$CB_CYC);
                dhtml_macros.html_basic_cb_scripts();
                if (cb_query_browser.NIL != title_var) {
                    html_utilities.html_source_readability_terpri((SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_markup(html_macros.$html_title_head$.getGlobalValue());
                ...
                try {
                    html_macros.$html_inside_bodyP$.bind((SubLObject)cb_query_browser.T, thread);
                    html_utilities.html_markup(html_macros.$html_body_head$.getGlobalValue());
                    if (cb_query_browser.NIL != html_macros.$html_default_bgcolor$.getDynamicValue(thread)) {
                    ...
                    html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_markup((SubLObject)cb_query_browser.$str98$yui_skin_sam);
                    html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_char((SubLObject)Characters.CHAR_greater, (SubLObject)cb_query_browser.UNPROVIDED);
                    ...
                    try {
                        ...
                        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                        html_utilities.html_markup((SubLObject)cb_query_browser.$str99$reloadFrameButton);
                        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                        html_utilities.html_char((SubLObject)Characters.CHAR_greater, (SubLObject)cb_query_browser.UNPROVIDED);
                        ...
                        try {
                            ...
                            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                            html_utilities.html_markup((SubLObject)cb_query_browser.$str100$reload);
                            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                            html_utilities.html_markup(html_macros.$html_input_value$.getGlobalValue());
                            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                            html_utilities.html_princ((SubLObject)cb_query_browser.$str101$Refresh_Frames);
                            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                            if (cb_query_browser.NIL != html_macros.$html_input_disabledP$.getDynamicValue(thread)) {
                                html_utilities.html_simple_attribute(html_macros.$html_input_disabled$.getGlobalValue());
                            }
                        ...
                        if (cb_query_browser.NIL != title_var) {
                            ...
                            html_utilities.html_markup((SubLObject)cb_query_browser.TWO_INTEGER);
                            html_utilities.html_char((SubLObject)Characters.CHAR_greater, (SubLObject)cb_query_browser.UNPROVIDED);
                            html_utilities.html_princ(title_var);
                        ...
                        html_script_utilities.cb_hoverover_page_init();
                        html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str102$Inference_Answer_Full_Justificati);
                        html_utilities.html_indent((SubLObject)cb_query_browser.UNPROVIDED);
                        cb_utilities.cb_link((SubLObject)cb_query_browser.$kw92$INFERENCE_ANSWER_FULL_JUSTIFICATION, justification, (SubLObject)cb_query_browser.$kw49$MINIMAL, (SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.$kw82$SELF, (SubLObject)cb_query_browser.UNPROVIDED);
                        html_utilities.html_princ((SubLObject)cb_query_browser.$str103$_for_answer_);
                        cb_utilities.cb_link((SubLObject)cb_query_browser.$kw56$INFERENCE_ANSWER, v_answer, (SubLObject)cb_query_browser.$kw49$MINIMAL, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                        html_utilities.html_hr((SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                        cb_show_inference_el_query(inference, (SubLObject)cb_query_browser.UNPROVIDED);
                        html_utilities.html_newline((SubLObject)cb_query_browser.TWO_INTEGER);
                        final SubLObject v_bindings = inference_datastructures_inference.inference_answer_bindings(v_answer);
                        final SubLObject free_el_vars = inference_datastructures_inference.inference_answer_free_el_vars(v_answer);
                        html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str71$Answer_Bindings__);
                        ...
                        final SubLObject mts = genl_mts.max_floor_mts(list_utilities.fast_delete_duplicates(Mapping.mapcar((SubLObject)cb_query_browser.$sym104$SUPPORT_MT, full_justification), Symbols.symbol_function((SubLObject)cb_query_browser.EQUAL), (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED), (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                        html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
                        html_utilities.html_princ_strong(PrintLow.format((SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.$str105$Answer_Justification_Mt_p___, Sequences.length(mts)));
                        if (cb_query_browser.NIL != mts) {
                            SubLObject cdolist_list_var = mts;
                            SubLObject mt = (SubLObject)cb_query_browser.NIL;
                            mt = cdolist_list_var.first();
                        ...
                        html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
                        html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str106$Full_Justification__);
    ...
    public static SubLObject cb_show_inference_answer_justification(final SubLObject justification) {
        ...
        try {
            ...
            try {
                ...
                html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                html_utilities.html_markup(html_utilities.html_align((SubLObject)cb_query_browser.$kw107$LEFT));
                html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                html_utilities.html_markup(html_macros.$html_table_data_valign$.getGlobalValue());
                html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                html_utilities.html_markup(html_utilities.html_align((SubLObject)cb_query_browser.$kw108$TOP));
                html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                html_utilities.html_char((SubLObject)Characters.CHAR_greater, (SubLObject)cb_query_browser.UNPROVIDED);
                ...
                try {
                    html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                    cb_utilities.cb_link((SubLObject)cb_query_browser.$kw92$INFERENCE_ANSWER_FULL_JUSTIFICATION, justification, (SubLObject)cb_query_browser.$kw48$TERSE, (SubLObject)cb_query_browser.$str109$_Full_Justification_, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                    html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
                    cb_query.cb_princ_with_inference_doc_more_link((SubLObject)cb_query_browser.$str110$Proofs__, (SubLObject)cb_query_browser.$str111$proofs, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                    final SubLObject v_answer = inference_datastructures_inference.inference_answer_justification_answer(justification);
                    SubLObject cdolist_list_var = inference_datastructures_inference.inference_answer_justification_proofs(justification);
                    SubLObject proof = (SubLObject)cb_query_browser.NIL;
                    proof = cdolist_list_var.first();
                    while (cb_query_browser.NIL != cdolist_list_var) {
                        html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
                        cb_utilities.cb_link((SubLObject)cb_query_browser.$kw112$PROOF, proof, (SubLObject)cb_query_browser.$kw48$TERSE, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                        html_utilities.html_newline((SubLObject)cb_query_browser.UNPROVIDED);
                        cb_utilities.cb_link((SubLObject)cb_query_browser.$kw113$SIMPLE_PROOF_VIEW, proof, v_answer, (SubLObject)cb_query_browser.$str114$_Show_Proof_View_, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
                        cdolist_list_var = cdolist_list_var.rest();
                        proof = cdolist_list_var.first();
                    }
                }
    ...
    public static SubLObject cb_inference_fancy_table_js(final SubLObject var_count, final SubLObject nanswers) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        cyc_file_dependencies.web_bundle((SubLObject)cb_query_browser.$kw115$DATA_TABLES);
        SubLObject column_type_spec_json = (SubLObject)cb_query_browser.$str116$_;
        final SubLObject pixel_height = (SubLObject)(nanswers.numG((SubLObject)cb_query_browser.TWENTY_INTEGER) ? cb_query_browser.$int117$600 : (nanswers.numL((SubLObject)cb_query_browser.SEVEN_INTEGER) ? cb_query_browser.$int118$200 : Numbers.multiply(nanswers, (SubLObject)cb_query_browser.$int119$30)));
        SubLObject n;
        for (n = (SubLObject)cb_query_browser.NIL, n = (SubLObject)cb_query_browser.ZERO_INTEGER; n.numL(var_count); n = Numbers.add(n, (SubLObject)cb_query_browser.ONE_INTEGER)) {
            column_type_spec_json = Sequences.cconcatenate(column_type_spec_json, (SubLObject)cb_query_browser.$str120$__null);
        }
        column_type_spec_json = Sequences.copy_seq((SubLObject)cb_query_browser.$str121$_columnDefs_____type____num_html_);
        html_utilities.html_source_readability_terpri((SubLObject)cb_query_browser.UNPROVIDED);
        ...
        try {
            html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
            PrintLow.format(html_macros.$html_stream$.getDynamicValue(thread), (SubLObject)cb_query_browser.$str122$__document__ready_function_______, pixel_height, column_type_spec_json);
            html_utilities.html_source_readability_terpri((SubLObject)cb_query_browser.UNPROVIDED);
        }
        finally {
            html_macros.$html_safe_print$.rebind(_prev_bind_0, thread);
    ...
    public static SubLObject cb_inference_fancy_table_all_answers_js(final SubLObject var_count) {
        ...
        column_type_spec_json = Sequences.copy_seq((SubLObject)cb_query_browser.$str123$_columnDefs_____type____num_html_);
        html_utilities.html_source_readability_terpri((SubLObject)cb_query_browser.UNPROVIDED);
        html_utilities.html_markup(html_macros.$html_script_head$.getGlobalValue());
        html_utilities.html_markup(html_macros.$html_script_language$.getGlobalValue());
        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
        ...
        try {
            html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
            PrintLow.format(html_macros.$html_stream$.getDynamicValue(thread), (SubLObject)cb_query_browser.$str124$__document__ready_function_______, column_type_spec_json);
            html_utilities.html_source_readability_terpri((SubLObject)cb_query_browser.UNPROVIDED);
        }
        finally {
            html_macros.$html_safe_print$.rebind(_prev_bind_0, thread);
    ...
    public static SubLObject cb_show_fully_bound_answer(final SubLObject inference, final SubLObject answer_count, final SubLObject current_answers, final SubLObject inference_new_justification_set) {
        if (answer_count.isZero()) {
            if (cb_query_browser.NIL != inference_datastructures_inference.running_inference_p(inference)) {
                html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str125$Query_was_not_yet_proven);
            }
            else {
                html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str126$Query_was_not_proven);
            }
        }
        else {
            final SubLObject v_answer = current_answers.first();
            html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str127$Query_was_proven);
            html_utilities.html_indent((SubLObject)cb_query_browser.UNPROVIDED);
            cb_utilities.cb_show_term(cb_query_browser.$const128$True, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_indent((SubLObject)cb_query_browser.UNPROVIDED);
    ...
    public static SubLObject cb_show_inference_answer_section(final SubLObject inference, final SubLObject answer_limit) {
        ...
        final SubLObject is_running = Equality.eq(inference_datastructures_inference.inference_status(inference), (SubLObject)cb_query_browser.$kw12$RUNNING);
        final SubLObject my_answer_limit = (SubLObject)((cb_query_browser.NIL == is_running && cb_query_browser.NIL != cb_parameters.$cb_use_dynamic_table_for_inference_results$.getDynamicValue(thread)) ? cb_query_browser.$int129$2100 : answer_limit);
        if (cb_query_browser.NIL == free_el_variables) {
            ...
            html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str130$No_answers);
            if (cb_query_browser.NIL != is_running) {
                html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str131$_yet_);
            }
        }
        else {
            SubLObject index = (SubLObject)cb_query_browser.ZERO_INTEGER;
            SubLObject answer_limit_exceededP = (SubLObject)cb_query_browser.NIL;
            html_utilities.html_markup(html_macros.$html_table_head$.getGlobalValue());
            html_utilities.html_markup(html_macros.$html_attribute_class$.getGlobalValue());
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_markup((SubLObject)cb_query_browser.$str132$display);
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_markup(html_macros.$html_attribute_id$.getGlobalValue());
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_markup((SubLObject)cb_query_browser.$str133$inferenceresults);
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_markup(html_macros.$html_table_border$.getGlobalValue());
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_markup((SubLObject)cb_query_browser.ZERO_INTEGER);
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                            html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str134$Answer);
                        }
                        finally {
                            html_macros.$html_safe_print$.rebind(_prev_bind_0_$13, thread);
                        }
                        html_utilities.html_markup(html_macros.$html_table_header_tail$.getGlobalValue());
                        cb_show_bindings_horizontal_variable_row(free_el_variables, (SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.T);
                        if (cb_query_browser.NIL != cb_query_browser.$cb_inference_browser_show_answer_max_floor_mtsP$.getDynamicValue(thread)) {
                            html_utilities.html_markup(html_macros.$html_table_data_head$.getGlobalValue());
                            html_utilities.html_markup(html_macros.$html_table_data_align$.getGlobalValue());
                            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                            ...
                            try {
                                html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                                html_utilities.html_princ_strong((SubLObject)cb_query_browser.$str135$Answer_Mt);
                            }
                            finally {
                ...
                try {
                    html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                    if (cb_query_browser.NIL == answer_limit_exceededP) {
                        SubLObject csome_list_var = current_answers;
                        SubLObject v_answer = (SubLObject)cb_query_browser.NIL;
                        v_answer = csome_list_var.first();
                        while (cb_query_browser.NIL == answer_limit_exceededP && cb_query_browser.NIL != csome_list_var) {
                            if (cb_query_browser.NIL != my_answer_limit && index.numGE(my_answer_limit)) {
                                answer_limit_exceededP = (SubLObject)cb_query_browser.T;
                            }
                            else {
                                index = Numbers.add(index, (SubLObject)cb_query_browser.ONE_INTEGER);
                                html_utilities.html_markup(html_macros.$html_table_row_head$.getGlobalValue());
                                html_utilities.html_char((SubLObject)Characters.CHAR_greater, (SubLObject)cb_query_browser.UNPROVIDED);
                                ...
                                try {
                                    ...
                                    html_utilities.html_markup(html_macros.$html_table_data_align$.getGlobalValue());
                                    html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                                    html_utilities.html_markup(html_utilities.html_align((SubLObject)cb_query_browser.$kw136$RIGHT));
                                    html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                                    html_utilities.html_markup(html_macros.$html_table_data_valign$.getGlobalValue());
                                    html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
                                    html_utilities.html_markup(html_utilities.html_align((SubLObject)cb_query_browser.$kw108$TOP));
                                    ...
                                    if (cb_query_browser.NIL != cb_query_browser.$cb_inference_browser_show_answer_max_floor_mtsP$.getDynamicValue(thread)) {
                                        ...
                                        try {
                                            html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                                            final SubLObject mts = inference_analysis.max_floor_mts_of_inference_answer(v_answer, (SubLObject)cb_query_browser.T);
                                            if (cb_query_browser.NIL != mts) {
                                                SubLObject cdolist_list_var = mts;
                                                SubLObject mt = (SubLObject)cb_query_browser.NIL;
                                                mt = cdolist_list_var.first();
            ...
            html_utilities.html_markup(html_macros.$html_table_tail$.getGlobalValue());
            if (cb_query_browser.NIL != cb_parameters.$cb_use_dynamic_table_for_inference_results$.getDynamicValue(thread) && cb_query_browser.NIL == answer_limit_exceededP && cb_query_browser.NIL == is_running) {
                if (cb_query_browser.NIL == answer_limit) {
            ...
            if (cb_query_browser.NIL != cb_parameters.$cb_perform_argumentation_for_closed_queryP$.getDynamicValue(thread) && cb_query_browser.NIL != inference_utilities.inference_requires_argumentationP(inference)) {
    ...
    public static SubLObject cb_show_inference_answer_section_answer_number(final SubLObject v_answer, final SubLObject inference_new_justification_set, final SubLObject answer_count) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLObject linktext = (SubLObject)(cb_query_browser.ONE_INTEGER.numE(answer_count) ? cb_query_browser.$str137$Explain : PrintLow.format((SubLObject)cb_query_browser.NIL, (SubLObject)cb_query_browser.$str138$Explain___A, inference_datastructures_inference.inference_answer_suid(v_answer)));
        final SubLObject newness = cb_determine_inference_answer_newness(v_answer, inference_new_justification_set);
        if (cb_query_browser.NIL == cb_parameters.$cb_use_dynamic_table_for_inference_results$.getDynamicValue(thread)) {
            linktext = Sequences.cconcatenate((SubLObject)cb_query_browser.$str139$_, new SubLObject[] { linktext, cb_query_browser.$str140$_ });
        }
    ...
    public static SubLObject cb_show_normal_inference_answer_justification_button(final SubLObject newness, final SubLObject v_answer, final SubLObject hover) {
        ...
        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
        html_utilities.html_markup((SubLObject)cb_query_browser.$str141$display_none);
        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
        html_utilities.html_char((SubLObject)Characters.CHAR_greater, (SubLObject)cb_query_browser.UNPROVIDED);
        final SubLObject _prev_bind_0 = html_macros.$html_safe_print$.currentBinding(thread);
        try {
            html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
            PrintLow.format(html_macros.$html_stream$.getDynamicValue(thread), (SubLObject)cb_query_browser.$str142$_A, inference_datastructures_inference.inference_answer_suid(v_answer));
        }
        finally {
            html_macros.$html_safe_print$.rebind(_prev_bind_0, thread);
        }
        ...
        cb_utilities.cb_link((SubLObject)cb_query_browser.$kw56$INFERENCE_ANSWER, v_answer, (SubLObject)cb_query_browser.$kw49$MINIMAL, hover, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
        return (SubLObject)cb_query_browser.NIL;
    }
    ...
    public static SubLObject cb_determine_inference_answer_newness(final SubLObject v_answer, final SubLObject inference_new_justification_set) {
        if (cb_query_browser.NIL != inference_datastructures_inference.inference_answer_newP(v_answer)) {
            return (SubLObject)cb_query_browser.$kw143$NEW_ANSWER;
        }
        if (cb_query_browser.NIL != cb_inference_answer_has_new_justificationP(v_answer, inference_new_justification_set)) {
            return (SubLObject)cb_query_browser.$kw144$NEW_JUSTIFICATION;
        }
        return (SubLObject)cb_query_browser.$kw145$OLD;
    }
    ...
    public static SubLObject cb_show_inference_answer_newness_token(final SubLObject newness) {
        ...
        SubLObject explanation = (SubLObject)cb_query_browser.NIL;
        if (newness.eql((SubLObject)cb_query_browser.$kw145$OLD)) {
            explanation = (SubLObject)cb_query_browser.$str146$Old_answer;
        }
        else if (newness.eql((SubLObject)cb_query_browser.$kw143$NEW_ANSWER)) {
            explanation = (SubLObject)cb_query_browser.$str147$New_answer;
        }
        else if (newness.eql((SubLObject)cb_query_browser.$kw144$NEW_JUSTIFICATION)) {
            explanation = (SubLObject)cb_query_browser.$str148$Old_answer_with_a_new_justificati;
        }
        if (cb_query_browser.$kw145$OLD != newness) {
            ...
            try {
                html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                cb_query.cb_princ_with_explanation((SubLObject)cb_query_browser.$str149$_, explanation, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
            }
            finally {
                html_macros.$html_safe_print$.rebind(_prev_bind_0, thread);
            }
    ...
    public static SubLObject cb_inference_answer_has_new_justificationP(final SubLObject v_answer, final SubLObject new_justification_set) {
        ...
        while (cb_query_browser.NIL != cdolist_list_var) {
            if (cb_query_browser.NIL != set.set_memberP(justification, new_justification_set)) {
                return (SubLObject)cb_query_browser.T;
            }
            cdolist_list_var = cdolist_list_var.rest();
            justification = cdolist_list_var.first();
        }
    ...
    public static SubLObject cb_determine_inference_answer_bgcolor(final SubLObject newness) {
        ...
        if (newness.eql((SubLObject)cb_query_browser.$kw143$NEW_ANSWER)) {
            return (SubLObject)cb_query_browser.$kw150$YELLOW;
        }
        if (newness.eql((SubLObject)cb_query_browser.$kw144$NEW_JUSTIFICATION)) {
            return (SubLObject)cb_query_browser.$kw151$GREEN;
        }
        return (SubLObject)cb_query_browser.NIL;
    }
    ...
    public static SubLObject cb_inference_current_answers(final SubLObject inference) {
        ...
        final SubLObject inference_new_justification_set = set.new_set(Symbols.symbol_function((SubLObject)cb_query_browser.EQ), inference_datastructures_inference.inference_new_justification_count(inference));
        ...
        SubLObject current_answers = (SubLObject)cb_query_browser.NIL;
        final SubLObject idx = inference_datastructures_inference.inference_answer_id_index(inference);
        if (cb_query_browser.NIL == id_index.id_index_objects_empty_p(idx, (SubLObject)cb_query_browser.$kw152$SKIP)) {
            final SubLObject idx_$19 = idx;
            if (cb_query_browser.NIL == id_index.id_index_dense_objects_empty_p(idx_$19, (SubLObject)cb_query_browser.$kw152$SKIP)) {
                final SubLObject vector_var = id_index.id_index_dense_objects(idx_$19);
                final SubLObject backwardP_var = (SubLObject)cb_query_browser.NIL;
                SubLObject length;
                SubLObject v_iteration;
                SubLObject id;
                SubLObject v_answer;
                for (length = Sequences.length(vector_var), v_iteration = (SubLObject)cb_query_browser.NIL, v_iteration = (SubLObject)cb_query_browser.ZERO_INTEGER; v_iteration.numL(length); v_iteration = Numbers.add(v_iteration, (SubLObject)cb_query_browser.ONE_INTEGER)) {
                    id = ((cb_query_browser.NIL != backwardP_var) ? Numbers.subtract(length, v_iteration, (SubLObject)cb_query_browser.ONE_INTEGER) : v_iteration);
                    v_answer = Vectors.aref(vector_var, id);
                    if (cb_query_browser.NIL == id_index.id_index_tombstone_p(v_answer) || cb_query_browser.NIL == id_index.id_index_skip_tombstones_p((SubLObject)cb_query_browser.$kw152$SKIP)) {
                        if (cb_query_browser.NIL != id_index.id_index_tombstone_p(v_answer)) {
                            v_answer = (SubLObject)cb_query_browser.$kw152$SKIP;
                        }
            ...
            if (cb_query_browser.NIL == id_index.id_index_sparse_objects_empty_p(idx_$20)) {
                final SubLObject cdohash_table = id_index.id_index_sparse_objects(idx_$20);
                SubLObject id2 = (SubLObject)cb_query_browser.NIL;
                SubLObject v_answer2 = (SubLObject)cb_query_browser.NIL;
        ...
        current_answers = Sort.sort(current_answers, Symbols.symbol_function((SubLObject)cb_query_browser.$sym153$_), Symbols.symbol_function((SubLObject)cb_query_browser.$sym154$INFERENCE_ANSWER_SUID));
    ...
    public static SubLObject cb_show_argumentation_result(final SubLObject inference) {
        ...
        html_utilities.html_princ((SubLObject)cb_query_browser.$str155$Weighing_these_arguments_yields_a);
    ...
    public static SubLObject cb_show_tv(final SubLObject tv) {
        if (tv.eql((SubLObject)cb_query_browser.$kw156$TRUE_DEF)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str157$True__default_);
        }
        else if (tv.eql((SubLObject)cb_query_browser.$kw158$TRUE_MON)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str159$True__monotonic_);
        }
        else if (tv.eql((SubLObject)cb_query_browser.$kw160$FALSE_DEF)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str161$False__default_);
        }
        else if (tv.eql((SubLObject)cb_query_browser.$kw162$FALSE_MON)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str163$False__monotonic_);
        }
        else if (tv.eql((SubLObject)cb_query_browser.$kw164$UNKNOWN)) {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str165$Unknown);
        }
        else {
            html_utilities.html_princ((SubLObject)cb_query_browser.$str166$___);
        }
        return (SubLObject)cb_query_browser.NIL;
    }
    ...
    public static SubLObject cb_show_bindings(final SubLObject v_bindings, SubLObject selected_variables) {
        if (selected_variables == cb_query_browser.UNPROVIDED) {
            selected_variables = (SubLObject)cb_query_browser.$kw167$ALL;
        }
        html_utilities.html_princ((SubLObject)cb_query_browser.$str168$_);
        if (cb_query_browser.$kw167$ALL == selected_variables) {
            SubLObject cdolist_list_var = v_bindings;
            SubLObject binding = (SubLObject)cb_query_browser.NIL;
            ...
            SubLObject some_binding_shownP = (SubLObject)cb_query_browser.NIL;
            SubLObject cdolist_list_var2 = selected_variables;
            SubLObject selected_variable = (SubLObject)cb_query_browser.NIL;
            ...
            while (cb_query_browser.NIL != cdolist_list_var2) {
                ...
                if (cb_query_browser.NIL != binding2) {
                    if (cb_query_browser.NIL != some_binding_shownP) {
                        html_utilities.html_indent((SubLObject)cb_query_browser.UNPROVIDED);
                    }
                    else {
                        some_binding_shownP = (SubLObject)cb_query_browser.T;
                    }
                    html_utilities.html_markup(html_macros.$html_no_break_head$.getGlobalValue());
    ...
    public static SubLObject cb_show_binding(final SubLObject binding) {
        SubLObject variable = (SubLObject)cb_query_browser.NIL;
        SubLObject value = (SubLObject)cb_query_browser.NIL;
        cdestructuring_bind.destructuring_bind_must_consp(binding, binding, (SubLObject)cb_query_browser.$list169);
        variable = binding.first();
        final SubLObject current = value = binding.rest();
        html_utilities.html_princ((SubLObject)cb_query_browser.$str168$_);
        cb_utilities.cb_show_term(variable, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
        html_utilities.html_princ((SubLObject)cb_query_browser.$str170$___);
        cb_utilities.cb_show_term(value, (SubLObject)cb_query_browser.UNPROVIDED, (SubLObject)cb_query_browser.UNPROVIDED);
        html_utilities.html_princ((SubLObject)cb_query_browser.$str77$_);
        return binding;
    }
    ...
    public static SubLObject cb_show_binding_vertical(final SubLObject binding) {
        ...
        try {
            ...
            try {
                html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                cb_utilities.cb_show_term(variable, (SubLObject)cb_query_browser.ZERO_INTEGER, (SubLObject)cb_query_browser.UNPROVIDED);
            }
            finally {
            ...
            html_utilities.html_markup(html_macros.$html_table_data_align$.getGlobalValue());
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_markup(html_utilities.html_align((SubLObject)cb_query_browser.$kw171$CENTER));
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_markup(html_macros.$html_table_data_valign$.getGlobalValue());
            html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
            html_utilities.html_markup(html_utilities.html_align((SubLObject)cb_query_browser.$kw108$TOP));
            ...
            try {
                html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                html_utilities.html_glyph((SubLObject)cb_query_browser.$kw172$NBSP, (SubLObject)cb_query_browser.UNPROVIDED);
                html_utilities.html_glyph((SubLObject)cb_query_browser.$kw173$RIGHTWARDS_ARROW, (SubLObject)cb_query_browser.UNPROVIDED);
                html_utilities.html_glyph((SubLObject)cb_query_browser.$kw172$NBSP, (SubLObject)cb_query_browser.UNPROVIDED);
            }
            finally {
            ...
            try {
                html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                cb_utilities.cb_show_term(value, (SubLObject)cb_query_browser.ZERO_INTEGER, (SubLObject)cb_query_browser.T);
            }
            finally {
    ...
    public static SubLObject cb_show_bindings_horizontal(final SubLObject v_bindings, SubLObject selected_variables) {
        ...
        html_utilities.html_markup(html_macros.$html_table_cellspacing$.getGlobalValue());
        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
        html_utilities.html_markup((SubLObject)cb_query_browser.FOUR_INTEGER);
        html_utilities.html_char((SubLObject)Characters.CHAR_quotation, (SubLObject)cb_query_browser.UNPROVIDED);
        html_utilities.html_char((SubLObject)Characters.CHAR_greater, (SubLObject)cb_query_browser.UNPROVIDED);
        final SubLObject _prev_bind_0 = html_macros.$html_safe_print$.currentBinding(thread);
        try {
            ...
            try {
                html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                cb_show_bindings_horizontal_variable_row(selected_variables, v_bindings, (SubLObject)cb_query_browser.UNPROVIDED);
            }
            finally {
    ...
    public static SubLObject cb_show_bindings_horizontal_variable_row(final SubLObject selected_variables, SubLObject v_bindings, SubLObject strongP) {
        if (v_bindings == cb_query_browser.UNPROVIDED) {
            v_bindings = (SubLObject)cb_query_browser.NIL;
        }
        if (strongP == cb_query_browser.UNPROVIDED) {
            strongP = (SubLObject)cb_query_browser.NIL;
        }
        if (cb_query_browser.$kw167$ALL == selected_variables) {
            SubLObject cdolist_list_var = v_bindings;
            SubLObject binding = (SubLObject)cb_query_browser.NIL;
    ...
    public static SubLObject cb_show_binding_variable_horizontal(final SubLObject variable, SubLObject strongP) {
        ...
        try {
            html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
            if (cb_query_browser.NIL != strongP) {
                html_utilities.html_markup(html_macros.$html_strong_head$.getGlobalValue());
                cb_utilities.cb_show_term(variable, (SubLObject)cb_query_browser.ZERO_INTEGER, (SubLObject)cb_query_browser.NIL);
                html_utilities.html_markup(html_macros.$html_strong_tail$.getGlobalValue());
            }
            else {
                cb_utilities.cb_show_term(variable, (SubLObject)cb_query_browser.ZERO_INTEGER, (SubLObject)cb_query_browser.NIL);
    ...
    public static SubLObject cb_show_binding_value_horizontal(final SubLObject value) {
        ...
        try {
            html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
            if (cb_query_browser.NIL != cb_query_browser.$cb_show_inference_results_in_nlP$.getDynamicValue(thread)) {
                cb_utilities.cb_show_term_in_nl(value, (SubLObject)cb_query_browser.UNPROVIDED);
            }
            else {
                cb_utilities.cb_show_term(value, (SubLObject)cb_query_browser.ZERO_INTEGER, (SubLObject)cb_query_browser.T);
            }
    ...
    public static SubLObject cb_variable_map_horizontal(final SubLObject variable_map) {
        ...
        try {
            ...
            try {
                html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                SubLObject list_var = (SubLObject)cb_query_browser.NIL;
                SubLObject variable_map_binding = (SubLObject)cb_query_browser.NIL;
                SubLObject index = (SubLObject)cb_query_browser.NIL;
                list_var = variable_map;
                variable_map_binding = list_var.first();
                for (index = (SubLObject)cb_query_browser.ZERO_INTEGER; cb_query_browser.NIL != list_var; list_var = list_var.rest(), variable_map_binding = list_var.first(), index = Numbers.add((SubLObject)cb_query_browser.ONE_INTEGER, index)) {
                    if (!index.isZero()) {
                        html_utilities.html_markup(html_macros.$html_table_data_head$.getGlobalValue());
                        html_utilities.html_simple_attribute(html_macros.$html_table_data_nowrap$.getGlobalValue());
                        html_utilities.html_markup(html_macros.$html_table_data_align$.getGlobalValue());
                    ...
                    SubLObject from_variable = (SubLObject)cb_query_browser.NIL;
                    SubLObject to_variable = (SubLObject)cb_query_browser.NIL;
                    cdestructuring_bind.destructuring_bind_must_consp(current, datum, (SubLObject)cb_query_browser.$list175);
                    ...
                    try {
                        html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                        cb_utilities.cb_form(to_variable, (SubLObject)cb_query_browser.ZERO_INTEGER, (SubLObject)cb_query_browser.NIL);
                    }
                    finally {
            ...
            try {
                ...
                for (index = (SubLObject)cb_query_browser.ZERO_INTEGER; cb_query_browser.NIL != list_var; list_var = list_var.rest(), variable_map_binding = list_var.first(), index = Numbers.add((SubLObject)cb_query_browser.ONE_INTEGER, index)) {
                    ...
                    try {
                        html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                        html_utilities.html_glyph((SubLObject)cb_query_browser.$kw176$UPWARDS_ARROW, (SubLObject)cb_query_browser.UNPROVIDED);
                    }
                    finally {
            ...
            try {
                ...
                for (index = (SubLObject)cb_query_browser.ZERO_INTEGER; cb_query_browser.NIL != list_var; list_var = list_var.rest(), variable_map_binding = list_var.first(), index = Numbers.add((SubLObject)cb_query_browser.ONE_INTEGER, index)) {
                    ...
                    try {
                        html_macros.$html_safe_print$.bind((SubLObject)cb_query_browser.T, thread);
                        cb_utilities.cb_form(from_variable, (SubLObject)cb_query_browser.ZERO_INTEGER, (SubLObject)cb_query_browser.NIL);
                    }
                    finally {
    ...
    public static SubLObject declare_cb_query_browser_file() {
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_el_query", "CB-SHOW-INFERENCE-EL-QUERY", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_status", "CB-SHOW-INFERENCE-STATUS", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_suspend_status", "CB-SHOW-INFERENCE-SUSPEND-STATUS", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_inference_answer", "CB-INFERENCE-ANSWER", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_link_inference_answer", "CB-LINK-INFERENCE-ANSWER", 1, 3, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_form_inference_answer_method", "CB-FORM-INFERENCE-ANSWER-METHOD", 1, 2, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_guess_inference_answer", "CB-GUESS-INFERENCE-ANSWER", 3, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_answer_bindings", "CB-SHOW-INFERENCE-ANSWER-BINDINGS", 2, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_answer_summary", "CB-SHOW-INFERENCE-ANSWER-SUMMARY", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_inference_answer_guts", "CB-INFERENCE-ANSWER-GUTS", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_answer_creation_time", "CB-SHOW-INFERENCE-ANSWER-CREATION-TIME", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_universal_time", "CB-SHOW-UNIVERSAL-TIME", 0, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_answer_step_count", "CB-SHOW-INFERENCE-ANSWER-STEP-COUNT", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_socratic_query_from_answer", "CB-SOCRATIC-QUERY-FROM-ANSWER", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_link_socratic_query_from_answer", "CB-LINK-SOCRATIC-QUERY-FROM-ANSWER", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_inference_answer_full_justification", "CB-INFERENCE-ANSWER-FULL-JUSTIFICATION", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_link_inference_answer_full_justification", "CB-LINK-INFERENCE-ANSWER-FULL-JUSTIFICATION", 1, 3, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "inference_answer_justification_suid", "INFERENCE-ANSWER-JUSTIFICATION-SUID", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_guess_inference_answer_justification", "CB-GUESS-INFERENCE-ANSWER-JUSTIFICATION", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_inference_answer_full_justification_guts", "CB-INFERENCE-ANSWER-FULL-JUSTIFICATION-GUTS", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_answer_justification", "CB-SHOW-INFERENCE-ANSWER-JUSTIFICATION", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_inference_fancy_table_js", "CB-INFERENCE-FANCY-TABLE-JS", 2, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_inference_fancy_table_all_answers_js", "CB-INFERENCE-FANCY-TABLE-ALL-ANSWERS-JS", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_fully_bound_answer", "CB-SHOW-FULLY-BOUND-ANSWER", 4, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_streamed_inference_answer_section", "CB-SHOW-STREAMED-INFERENCE-ANSWER-SECTION", 2, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_answer_section", "CB-SHOW-INFERENCE-ANSWER-SECTION", 2, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_answer_section_answer_number", "CB-SHOW-INFERENCE-ANSWER-SECTION-ANSWER-NUMBER", 3, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_normal_inference_answer_justification_button", "CB-SHOW-NORMAL-INFERENCE-ANSWER-JUSTIFICATION-BUTTON", 3, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_determine_inference_answer_newness", "CB-DETERMINE-INFERENCE-ANSWER-NEWNESS", 2, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_answer_newness_token", "CB-SHOW-INFERENCE-ANSWER-NEWNESS-TOKEN", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_inference_answer_has_new_justificationP", "CB-INFERENCE-ANSWER-HAS-NEW-JUSTIFICATION?", 2, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_determine_inference_answer_bgcolor", "CB-DETERMINE-INFERENCE-ANSWER-BGCOLOR", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_inference_current_answers", "CB-INFERENCE-CURRENT-ANSWERS", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_inference_answer_section_bindings", "CB-SHOW-INFERENCE-ANSWER-SECTION-BINDINGS", 2, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_argumentation_result", "CB-SHOW-ARGUMENTATION-RESULT", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_tv", "CB-SHOW-TV", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_bindings", "CB-SHOW-BINDINGS", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_binding", "CB-SHOW-BINDING", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_bindings_vertical", "CB-SHOW-BINDINGS-VERTICAL", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_binding_vertical", "CB-SHOW-BINDING-VERTICAL", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_bindings_horizontal", "CB-SHOW-BINDINGS-HORIZONTAL", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_bindings_horizontal_variable_row", "CB-SHOW-BINDINGS-HORIZONTAL-VARIABLE-ROW", 1, 2, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_bindings_horizontal_value_row", "CB-SHOW-BINDINGS-HORIZONTAL-VALUE-ROW", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_binding_variable_horizontal", "CB-SHOW-BINDING-VARIABLE-HORIZONTAL", 1, 1, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_binding_value_horizontal", "CB-SHOW-BINDING-VALUE-HORIZONTAL", 1, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_show_missing_binding_value_horizontal", "CB-SHOW-MISSING-BINDING-VALUE-HORIZONTAL", 0, 0, false);
        SubLFiles.declareFunction("com.cyc.cycjava.cycl.inference.browser.cb_query_browser", "cb_variable_map_horizontal", "CB-VARIABLE-MAP-HORIZONTAL", 1, 0, false);
        return (SubLObject)cb_query_browser.NIL;
    }
    
    public static SubLObject init_cb_query_browser_file() {
        cb_query_browser.$cb_inference_browser_show_answer_max_floor_mtsP$ = SubLFiles.defparameter("*CB-INFERENCE-BROWSER-SHOW-ANSWER-MAX-FLOOR-MTS?*", (SubLObject)cb_query_browser.NIL);
        cb_query_browser.$cb_show_inference_results_in_nlP$ = SubLFiles.defparameter("*CB-SHOW-INFERENCE-RESULTS-IN-NL?*", (SubLObject)cb_query_browser.NIL);
        return (SubLObject)cb_query_browser.NIL;
    }
    
    public static SubLObject setup_cb_query_browser_file() {
        html_macros.note_cgi_handler_function((SubLObject)cb_query_browser.$sym45$CB_INFERENCE_ANSWER, (SubLObject)cb_query_browser.$kw46$HTML_HANDLER);
        cb_utilities.setup_cb_link_method((SubLObject)cb_query_browser.$kw56$INFERENCE_ANSWER, (SubLObject)cb_query_browser.$sym57$CB_LINK_INFERENCE_ANSWER, (SubLObject)cb_query_browser.FOUR_INTEGER);
        Structures.register_method(cb_utilities.$cb_form_method_table$.getGlobalValue(), inference_datastructures_inference.$dtp_inference_answer$.getGlobalValue(), Symbols.symbol_function((SubLObject)cb_query_browser.$sym58$CB_FORM_INFERENCE_ANSWER_METHOD));
        html_macros.note_cgi_handler_function((SubLObject)cb_query_browser.$sym81$CB_SOCRATIC_QUERY_FROM_ANSWER, (SubLObject)cb_query_browser.$kw46$HTML_HANDLER);
        cb_utilities.setup_cb_link_method((SubLObject)cb_query_browser.$kw67$SOCRATIC_QUERY_FROM_ANSWER, (SubLObject)cb_query_browser.$sym84$CB_LINK_SOCRATIC_QUERY_FROM_ANSWER, (SubLObject)cb_query_browser.TWO_INTEGER);
        html_macros.note_cgi_handler_function((SubLObject)cb_query_browser.$sym87$CB_INFERENCE_ANSWER_FULL_JUSTIFICATION, (SubLObject)cb_query_browser.$kw46$HTML_HANDLER);
        cb_utilities.setup_cb_link_method((SubLObject)cb_query_browser.$kw92$INFERENCE_ANSWER_FULL_JUSTIFICATION, (SubLObject)cb_query_browser.$sym93$CB_LINK_INFERENCE_ANSWER_FULL_JUSTIFICATION, (SubLObject)cb_query_browser.FOUR_INTEGER);
        utilities_macros.register_html_state_variable((SubLObject)cb_query_browser.$sym174$_CB_SHOW_INFERENCE_RESULTS_IN_NL__);
        utilities_macros.register_html_interface_variable((SubLObject)cb_query_browser.$sym174$_CB_SHOW_INFERENCE_RESULTS_IN_NL__);
        return (SubLObject)cb_query_browser.NIL;
    }
    ...
    static {
        ...
        cb_query_browser.$cb_inference_browser_show_answer_max_floor_mtsP$ = null;
        cb_query_browser.$cb_show_inference_results_in_nlP$ = null;
        ...
        $list43 = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("STORE-ID-STRING"), (SubLObject)SubLObjectFactory.makeSymbol("INFERENCE-ID-STRING"), (SubLObject)SubLObjectFactory.makeSymbol("ANSWER-ID-STRING"));
        ...
        $list85 = ConsesLow.list((SubLObject)SubLObjectFactory.makeSymbol("STORE-ID-STRING"), (SubLObject)SubLObjectFactory.makeSymbol("INFERENCE-ID-STRING"), (SubLObject)SubLObjectFactory.makeSymbol("ANSWER-ID-STRING"), (SubLObject)SubLObjectFactory.makeSymbol("JUSTIFICATION-ID-STRING"));
        ...
        $str122$__document__ready_function_______ = SubLObjectFactory.makeString("$(document).ready(function() {\n                   var oTable=$('#inferenceresults').DataTable(\n    {   'autoWidth':      false,\n        'scrollY':        '~Apx',\n        'scrollX':        false,\n        'scrollCollapse': true,\n        'paging':         false,\n        'dom': 'Rtif',\n        'language': {\n\t       'search': 'Filter Answers:' \n\t },\n         ~A\n    } \n                   )  } );");
        $str123$_columnDefs_____type____num_html_ = SubLObjectFactory.makeString("'columnDefs':[{'type': 'num-html', targets: 0, width: 1}]");
        $str124$__document__ready_function_______ = SubLObjectFactory.makeString("$(document).ready(function() {\n                   var oTable=$('#inferenceresults').DataTable(\n    {\n        'autoWidth': false,\n        'paging'   : false,\n        'dom'      : 'Rfti',\n        'language' : {\n\t       'search': 'Filter Answers:'\n\t },\n         ~A\n    } \n                   )  } );");
