...
public final class new_root_tactician_execution
    extends
      SubLTranslatedFile
{
  ...
  {
    SubLObject result;
    for( result = $kw1$UNINTERESTING; $kw1$UNINTERESTING == result; result = new_root_strategy_do_one_step_int( strategy ) )
    {
    }
  ...
  {
    SubLFiles.declareFunction( me, "new_root_strategy_doneP", "NEW-ROOT-STRATEGY-DONE?", 1, 0, false );
    SubLFiles.declareFunction( me, "new_root_strategy_do_one_step", "NEW-ROOT-STRATEGY-DO-ONE-STEP", 1, 0, false );
    SubLFiles.declareFunction( me, "new_root_strategy_do_one_step_int", "NEW-ROOT-STRATEGY-DO-ONE-STEP-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "new_root_strategy_select_best_strategem", "NEW-ROOT-STRATEGY-SELECT-BEST-STRATEGEM", 1, 0, false );
    SubLFiles.declareFunction( me, "new_root_strategy_peek_next_strategem", "NEW-ROOT-STRATEGY-PEEK-NEXT-STRATEGEM", 1, 0, false );
    SubLFiles.declareFunction( me, "new_root_strategy_select_best_strategem_int", "NEW-ROOT-STRATEGY-SELECT-BEST-STRATEGEM-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "new_root_strategy_quiesce", "NEW-ROOT-STRATEGY-QUIESCE", 1, 0, false );
    SubLFiles.declareFunction( me, "new_root_strategy_execute_strategem", "NEW-ROOT-STRATEGY-EXECUTE-STRATEGEM", 2, 0, false );
    return NIL;
  }
  ...
  static
  {
    ...
    $kw7$INTERESTING = makeKeyword( "INTERESTING" );
