...
public final class removal_modules_min_quant_value extends SubLTranslatedFile
{
    ...
    public static SubLObject init_removal_modules_min_quant_value_file() {
        removal_modules_min_quant_value.$min_quant_value_defining_mt$ = SubLFiles.deflexical("*MIN-QUANT-VALUE-DEFINING-MT*", maybeDefault((SubLObject)removal_modules_min_quant_value.$sym3$_MIN_QUANT_VALUE_DEFINING_MT_, removal_modules_min_quant_value.$min_quant_value_defining_mt$, removal_modules_min_quant_value.$const4$UniversalVocabularyMt));
        removal_modules_min_quant_value.$max_quant_value_defining_mt$ = SubLFiles.deflexical("*MAX-QUANT-VALUE-DEFINING-MT*", maybeDefault((SubLObject)removal_modules_min_quant_value.$sym9$_MAX_QUANT_VALUE_DEFINING_MT_, removal_modules_min_quant_value.$max_quant_value_defining_mt$, removal_modules_min_quant_value.$const4$UniversalVocabularyMt));
        removal_modules_min_quant_value.$quantity_unit_defining_mt$ = SubLFiles.deflexical("*QUANTITY-UNIT-DEFINING-MT*", maybeDefault((SubLObject)removal_modules_min_quant_value.$sym15$_QUANTITY_UNIT_DEFINING_MT_, removal_modules_min_quant_value.$quantity_unit_defining_mt$, removal_modules_min_quant_value.$const4$UniversalVocabularyMt));
        removal_modules_min_quant_value.$quantity_measure_defining_mt$ = SubLFiles.deflexical("*QUANTITY-MEASURE-DEFINING-MT*", maybeDefault((SubLObject)removal_modules_min_quant_value.$sym20$_QUANTITY_MEASURE_DEFINING_MT_, removal_modules_min_quant_value.$quantity_measure_defining_mt$, removal_modules_min_quant_value.$const4$UniversalVocabularyMt));
        removal_modules_min_quant_value.$multiplication_units_defining_mt$ = SubLFiles.deflexical("*MULTIPLICATION-UNITS-DEFINING-MT*", maybeDefault((SubLObject)removal_modules_min_quant_value.$sym24$_MULTIPLICATION_UNITS_DEFINING_MT_, removal_modules_min_quant_value.$multiplication_units_defining_mt$, removal_modules_min_quant_value.$const4$UniversalVocabularyMt));
        return (SubLObject)removal_modules_min_quant_value.NIL;
    }
