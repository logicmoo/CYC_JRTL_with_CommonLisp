...
public final class removal_modules_relation_instance_exists extends SubLTranslatedFile
{
    ...
    public static SubLObject init_removal_modules_relation_instance_exists_file() {
        ...
        removal_modules_relation_instance_exists.$relation_exists_instance_defining_mt$ = SubLFiles.deflexical("*RELATION-EXISTS-INSTANCE-DEFINING-MT*", maybeDefault((SubLObject)removal_modules_relation_instance_exists.$sym41$_RELATION_EXISTS_INSTANCE_DEFINING_MT_, removal_modules_relation_instance_exists.$relation_exists_instance_defining_mt$, removal_modules_relation_instance_exists.$const7$BaseKB));
