...
public final class scheduled_queries extends SubLTranslatedFile
{
    ...
    public static SubLObject init_scheduled_queries_file() {
        ...
        scheduled_queries.$scheduled_query_index$ = SubLFiles.deflexical("*SCHEDULED-QUERY-INDEX*", maybeDefault((SubLObject)scheduled_queries.$sym99$_SCHEDULED_QUERY_INDEX_, scheduled_queries.$scheduled_query_index$, ()->(dictionary.new_dictionary(Symbols.symbol_function((SubLObject)scheduled_queries.EQUAL), (SubLObject)scheduled_queries.UNPROVIDED))));
        ...
        scheduled_queries.$max_number_of_simultaneous_scheduled_queries$ = SubLFiles.deflexical("*MAX-NUMBER-OF-SIMULTANEOUS-SCHEDULED-QUERIES*", (SubLObject)(maybeDefault((SubLObject)scheduled_queries.$sym113$_MAX_NUMBER_OF_SIMULTANEOUS_SCHEDULED_QUERIES_, scheduled_queries.$max_number_of_simultaneous_scheduled_queries$, scheduled_queries.ONE_INTEGER)));
        scheduled_queries.$active_scheduled_queries$ = SubLFiles.deflexical("*ACTIVE-SCHEDULED-QUERIES*", (SubLObject)(maybeDefault((SubLObject)scheduled_queries.$sym114$_ACTIVE_SCHEDULED_QUERIES_, scheduled_queries.$active_scheduled_queries$, scheduled_queries.NIL)));
        scheduled_queries.$aborted_scheduled_queries$ = SubLFiles.deflexical("*ABORTED-SCHEDULED-QUERIES*", (SubLObject)(maybeDefault((SubLObject)scheduled_queries.$sym123$_ABORTED_SCHEDULED_QUERIES_, scheduled_queries.$aborted_scheduled_queries$, scheduled_queries.NIL)));
        ...
        scheduled_queries.$scheduled_query_daemon$ = SubLFiles.deflexical("*SCHEDULED-QUERY-DAEMON*", maybeDefault((SubLObject)scheduled_queries.$sym187$_SCHEDULED_QUERY_DAEMON_, scheduled_queries.$scheduled_query_daemon$, ()->(misc_utilities.uninitialized())));
        ...
        scheduled_queries.$run_scheduled_queries_on_this_imageP$ = SubLFiles.deflexical("*RUN-SCHEDULED-QUERIES-ON-THIS-IMAGE?*", (SubLObject)(maybeDefault((SubLObject)scheduled_queries.$sym189$_RUN_SCHEDULED_QUERIES_ON_THIS_IMAGE__, scheduled_queries.$run_scheduled_queries_on_this_imageP$, scheduled_queries.NIL)));
