...
public final class open_cyc_inference_api extends SubLTranslatedFile
{
    ...
    public static SubLObject init_open_cyc_inference_api_file() {
        ...
        open_cyc_inference_api.$inference_to_ipc_queue_map$ = SubLFiles.deflexical("*INFERENCE-TO-IPC-QUEUE-MAP*", (open_cyc_inference_api.NIL != Symbols.boundp((SubLObject)open_cyc_inference_api.$sym7$_INFERENCE_TO_IPC_QUEUE_MAP_)) ? open_cyc_inference_api.$inference_to_ipc_queue_map$.getGlobalValue() : dictionary_utilities.new_synchronized_dictionary((SubLObject)open_cyc_inference_api.UNPROVIDED, (SubLObject)open_cyc_inference_api.UNPROVIDED));
        open_cyc_inference_api.$opencyc_inference_output$ = SubLFiles.deflexical("*OPENCYC-INFERENCE-OUTPUT*", (open_cyc_inference_api.NIL != Symbols.boundp((SubLObject)open_cyc_inference_api.$sym8$_OPENCYC_INFERENCE_OUTPUT_)) ? open_cyc_inference_api.$opencyc_inference_output$.getGlobalValue() : StreamsLow.$standard_output$.getDynamicValue());
        open_cyc_inference_api.$synch_format_lock$ = SubLFiles.deflexical("*SYNCH-FORMAT-LOCK*", (open_cyc_inference_api.NIL != Symbols.boundp((SubLObject)open_cyc_inference_api.$sym9$_SYNCH_FORMAT_LOCK_)) ? open_cyc_inference_api.$synch_format_lock$.getGlobalValue() : Locks.make_lock((SubLObject)open_cyc_inference_api.$str10$_synch_format_lock_));
        open_cyc_inference_api.$client_to_problem_stores_map$ = SubLFiles.deflexical("*CLIENT-TO-PROBLEM-STORES-MAP*", (open_cyc_inference_api.NIL != Symbols.boundp((SubLObject)open_cyc_inference_api.$sym19$_CLIENT_TO_PROBLEM_STORES_MAP_)) ? open_cyc_inference_api.$client_to_problem_stores_map$.getGlobalValue() : dictionary_utilities.new_synchronized_dictionary(Symbols.symbol_function((SubLObject)open_cyc_inference_api.EQUAL), (SubLObject)open_cyc_inference_api.UNPROVIDED));
        return (SubLObject)open_cyc_inference_api.NIL;
    }
