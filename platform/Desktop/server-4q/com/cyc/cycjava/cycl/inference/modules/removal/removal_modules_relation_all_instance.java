...
public final class removal_modules_relation_all_instance extends SubLTranslatedFile
{
    ...
    public static SubLObject init_removal_modules_relation_all_instance_file() {
        ...
        removal_modules_relation_all_instance.$relation_all_instance_defining_mt$ = SubLFiles.deflexical("*RELATION-ALL-INSTANCE-DEFINING-MT*", maybeDefault((SubLObject)removal_modules_relation_all_instance.$sym10$_RELATION_ALL_INSTANCE_DEFINING_MT_, removal_modules_relation_all_instance.$relation_all_instance_defining_mt$, removal_modules_relation_all_instance.$const11$BaseKB));
        ...
        removal_modules_relation_all_instance.$relation_instance_all_defining_mt$ = SubLFiles.deflexical("*RELATION-INSTANCE-ALL-DEFINING-MT*", maybeDefault((SubLObject)removal_modules_relation_all_instance.$sym42$_RELATION_INSTANCE_ALL_DEFINING_MT_, removal_modules_relation_all_instance.$relation_instance_all_defining_mt$, removal_modules_relation_all_instance.$const11$BaseKB));
