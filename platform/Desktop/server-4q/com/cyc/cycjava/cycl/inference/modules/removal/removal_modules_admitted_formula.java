...
public final class removal_modules_admitted_formula
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject removal_admitted_sentence_pos_expand(final SubLObject asent, SubLObject sense)
  {
    ...
    if( NIL != admitted )
    {
      backward.removal_add_node( arguments.make_hl_support( $kw3$ADMIT, asent, UNPROVIDED, UNPROVIDED ), UNPROVIDED, UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject inference_admitted_formula(final SubLObject formula, SubLObject mt)
  {
    ...
    if( NIL != el_utilities.el_formula_p( formula ) )
    {
      if( NIL == el_utilities.contains_subformula_p( formula ) )
      {
        ...
        final SubLObject args = cdolist_list_var = cycl_utilities.formula_args( formula, $kw6$IGNORE );
        SubLObject arg = NIL;
    ...
    return Equality.eql( $const7$True, formula );
  }
  ...
  public static SubLObject inference_admitted_sentence(final SubLObject sentence, SubLObject mt)
  {
    ...
    if( NIL != el_utilities.el_formula_p( sentence ) )
    {
      if( NIL == el_utilities.contains_subformula_p( sentence ) )
      {
        ...
        SubLObject argnum = ZERO_INTEGER;
        SubLObject cdolist_list_var;
        final SubLObject args = cdolist_list_var = cycl_utilities.formula_args( sentence, $kw6$IGNORE );
        SubLObject arg = NIL;
        arg = cdolist_list_var.first();
        while ( NIL != cdolist_list_var)
        {
    ...
    return Equality.eql( $const7$True, sentence );
  }
  ...
  public static SubLObject removal_admitted_sentence_neg_expand(final SubLObject asent, SubLObject sense)
  {
    ...
    if( NIL == admitted )
    {
      backward.removal_add_node( arguments.make_hl_support( $kw3$ADMIT, cycl_utilities.negate( asent ), UNPROVIDED, UNPROVIDED ), UNPROVIDED, UNPROVIDED );
    }
    return NIL;
  }
              ...
              try
              {
                ...
                while ( NIL == done_var_$1)
                {
                  ...
                  if( NIL != valid_$3 )
                  {
                    ...
                    if( NIL != forts.fort_p( arg_isa ) && !arg_isa.eql( $const16$Thing ) && NIL == isa.isaP( v_term, arg_isa, mt, UNPROVIDED ) && NIL == at_defns.defns_admitP( arg_isa, v_term, mt ) )
                    {
                      rejected = T;
                    }
                  }
              ...
              try
              {
                ...
                while ( NIL == done_var_$2)
                {
                  ...
                  if( NIL != valid_$4 )
                  {
                    ...
                    if( NIL != forts.fort_p( arg_genl ) && !arg_genl.eql( $const16$Thing ) && NIL == genls.genlsP( v_term, arg_genl, mt, UNPROVIDED ) )
                    {
                      rejected = T;
                    }
                  }
  ...
  {
    SubLFiles.declareFunction( me, "removal_admitted_sentence_pos_expand", "REMOVAL-ADMITTED-SENTENCE-POS-EXPAND", 1, 1, false );
    SubLFiles.declareFunction( me, "inference_admitted_formula", "INFERENCE-ADMITTED-FORMULA", 1, 1, false );
    SubLFiles.declareFunction( me, "inference_admitted_sentence", "INFERENCE-ADMITTED-SENTENCE", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_admitted_sentence_neg_expand", "REMOVAL-ADMITTED-SENTENCE-NEG-EXPAND", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_admitted_argument_check_pos_expand", "REMOVAL-ADMITTED-ARGUMENT-CHECK-POS-EXPAND", 1, 1, false );
    SubLFiles.declareFunction( me, "inference_admitted_argument", "INFERENCE-ADMITTED-ARGUMENT", 3, 1, false );
    SubLFiles.declareFunction( me, "removal_admitted_argument_check_neg_expand", "REMOVAL-ADMITTED-ARGUMENT-CHECK-NEG-EXPAND", 1, 1, false );
    return NIL;
  }

  public static SubLObject init_removal_modules_admitted_formula_file()
  {
    $default_removal_admitted_formula_cost$ = SubLFiles.defparameter( "*DEFAULT-REMOVAL-ADMITTED-FORMULA-COST*", ONE_INTEGER );
    $default_removal_admitted_argument_check_cost$ = SubLFiles.defparameter( "*DEFAULT-REMOVAL-ADMITTED-ARGUMENT-CHECK-COST*", $float13$0_9 );
    return NIL;
  }

  public static SubLObject setup_removal_modules_admitted_formula_file()
  {
    inference_modules.register_solely_specific_removal_module_predicate( $const0$admittedSentence );
    inference_modules.inference_removal_module_dont_use_universal( $const0$admittedSentence, $kw1$REMOVAL_NON_WFF_CHECK_NEG );
    preference_modules.doomed_unless_all_args_bindable( $kw2$BOTH, $const0$admittedSentence );
    inference_modules.inference_removal_module( $kw4$REMOVAL_ADMITTED_SENTENCE_POS, $list5 );
    inference_modules.inference_removal_module( $kw8$REMOVAL_ADMITTED_SENTENCE_NEG, $list9 );
    inference_modules.register_solely_specific_removal_module_predicate( $const10$admittedArgument );
    inference_modules.inference_removal_module_dont_use_universal( $const10$admittedArgument, $kw1$REMOVAL_NON_WFF_CHECK_NEG );
    preference_modules.doomed_unless_all_args_bindable( $kw2$BOTH, $const10$admittedArgument );
    inference_modules.inference_removal_module( $kw11$REMOVAL_ADMITTED_ARGUMENT_CHECK_POS, $list12 );
    inference_modules.inference_removal_module( $kw17$REMOVAL_ADMITTED_ARGUMENT_CHECK_NEG, $list18 );
    return NIL;
  }
  ...
  static
  {
    ...
    $const0$admittedSentence = constant_handles.reader_make_constant_shell( makeString( "admittedSentence" ) );
    $kw1$REMOVAL_NON_WFF_CHECK_NEG = makeKeyword( "REMOVAL-NON-WFF-CHECK-NEG" );
    $kw2$BOTH = makeKeyword( "BOTH" );
    $kw3$ADMIT = makeKeyword( "ADMIT" );
    $kw4$REMOVAL_ADMITTED_SENTENCE_POS = makeKeyword( "REMOVAL-ADMITTED-SENTENCE-POS" );
    $list5 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "admittedSentence" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "admittedSentence" ) ), makeKeyword( "FULLY-BOUND" ) ), makeKeyword( "COST-EXPRESSION" ), makeSymbol(
            "*DEFAULT-REMOVAL-ADMITTED-FORMULA-COST*" ), makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ), makeKeyword( "EXPAND" ), makeSymbol( "REMOVAL-ADMITTED-SENTENCE-POS-EXPAND" ), makeKeyword(
                "DOCUMENTATION" ), makeString( "(#$admittedSentence <fully-bound>)\nby checking that the formula is syntactically and semantically well-formed" ), makeKeyword( "EXAMPLE" ), makeString(
                    "(#$admittedSentence (#$bordersOn #$Canada #$France))" )
    } );
    $kw6$IGNORE = makeKeyword( "IGNORE" );
    $const7$True = constant_handles.reader_make_constant_shell( makeString( "True" ) );
    $kw8$REMOVAL_ADMITTED_SENTENCE_NEG = makeKeyword( "REMOVAL-ADMITTED-SENTENCE-NEG" );
    $list9 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "NEG" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "admittedSentence" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "admittedSentence" ) ), makeKeyword( "FULLY-BOUND" ) ), makeKeyword( "COST-EXPRESSION" ), makeSymbol(
            "*DEFAULT-REMOVAL-ADMITTED-FORMULA-COST*" ), makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ), makeKeyword( "EXPAND" ), makeSymbol( "REMOVAL-ADMITTED-SENTENCE-NEG-EXPAND" ), makeKeyword(
                "DOCUMENTATION" ), makeString( "(#$not (#$admittedSentence <fully-bound>))\nby checking that the formula is not both syntactically and semantically well-formed" ), makeKeyword( "EXAMPLE" ), makeString(
                    "(#$not (#$admittedSentence (#$genls #$Canada #$Country)))" )
    } );
    $const10$admittedArgument = constant_handles.reader_make_constant_shell( makeString( "admittedArgument" ) );
    $kw11$REMOVAL_ADMITTED_ARGUMENT_CHECK_POS = makeKeyword( "REMOVAL-ADMITTED-ARGUMENT-CHECK-POS" );
    $list12 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "admittedArgument" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "admittedArgument" ) ), makeKeyword( "FULLY-BOUND" ), makeKeyword( "INTEGER" ), makeKeyword( "FORT" ) ), makeKeyword(
            "COST-EXPRESSION" ), makeSymbol( "*DEFAULT-REMOVAL-ADMITTED-ARGUMENT-CHECK-COST*" ), makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ), makeKeyword( "EXPAND" ), makeSymbol(
                "REMOVAL-ADMITTED-ARGUMENT-CHECK-POS-EXPAND" ), makeKeyword( "DOCUMENTATION" ), makeString(
                    "(#$admittedArgument <fully-bound> <integer> <fort>)\nby checking that the argument is syntactically and semantically well-formed" ), makeKeyword( "EXAMPLE" ), makeString(
                        "(#$admittedArgument #$Canada 1 #$bordersOn)\n (#$admittedArgument #$Dog 1 #$JuvenileFn)" )
    } );
    $float13$0_9 = makeDouble( 0.9 );
    ...
    $kw17$REMOVAL_ADMITTED_ARGUMENT_CHECK_NEG = makeKeyword( "REMOVAL-ADMITTED-ARGUMENT-CHECK-NEG" );
    $list18 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "NEG" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "admittedArgument" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "admittedArgument" ) ), makeKeyword( "FULLY-BOUND" ), makeKeyword( "INTEGER" ), makeKeyword( "FORT" ) ), makeKeyword(
            "COST-EXPRESSION" ), makeSymbol( "*DEFAULT-REMOVAL-ADMITTED-ARGUMENT-CHECK-COST*" ), makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ), makeKeyword( "EXPAND" ), makeSymbol(
                "REMOVAL-ADMITTED-ARGUMENT-CHECK-NEG-EXPAND" ), makeKeyword( "DOCUMENTATION" ), makeString(
                    "(#$not (#$admittedArgument <fully-bound> <integer> <fort>))\nby checking that the argument is not both syntactically and semantically well-formed" ), makeKeyword( "EXAMPLE" ), makeString(
                        "(#$not (#$admittedArgument #$Canada 1 #$genls))\n (#$not (#$admittedArgument #$Dog 1 #$LeftFn))" )
    } );
  }
}
/*
