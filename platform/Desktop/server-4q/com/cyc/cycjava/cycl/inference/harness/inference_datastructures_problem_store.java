...
public final class inference_datastructures_problem_store extends SubLTranslatedFile
{
    ...
    public static SubLObject init_inference_datastructures_problem_store_file() {
        ...
        inference_datastructures_problem_store.$problem_store_id_index$ = SubLFiles.deflexical("*PROBLEM-STORE-ID-INDEX*", (inference_datastructures_problem_store.NIL != Symbols.boundp((SubLObject)inference_datastructures_problem_store.$sym0$_PROBLEM_STORE_ID_INDEX_)) ? inference_datastructures_problem_store.$problem_store_id_index$.getGlobalValue() : id_index.new_id_index((SubLObject)inference_datastructures_problem_store.UNPROVIDED, (SubLObject)inference_datastructures_problem_store.UNPROVIDED));
        ...
        inference_datastructures_problem_store.$problem_store_id_to_name_table$ = SubLFiles.deflexical("*PROBLEM-STORE-ID-TO-NAME-TABLE*", (inference_datastructures_problem_store.NIL != Symbols.boundp((SubLObject)inference_datastructures_problem_store.$sym350$_PROBLEM_STORE_ID_TO_NAME_TABLE_)) ? inference_datastructures_problem_store.$problem_store_id_to_name_table$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)inference_datastructures_problem_store.ONE_INTEGER, Symbols.symbol_function((SubLObject)inference_datastructures_problem_store.EQL), (SubLObject)inference_datastructures_problem_store.UNPROVIDED));
        inference_datastructures_problem_store.$problem_store_name_to_id_table$ = SubLFiles.deflexical("*PROBLEM-STORE-NAME-TO-ID-TABLE*", (inference_datastructures_problem_store.NIL != Symbols.boundp((SubLObject)inference_datastructures_problem_store.$sym351$_PROBLEM_STORE_NAME_TO_ID_TABLE_)) ? inference_datastructures_problem_store.$problem_store_name_to_id_table$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)inference_datastructures_problem_store.ONE_INTEGER, Symbols.symbol_function((SubLObject)inference_datastructures_problem_store.EQUAL), (SubLObject)inference_datastructures_problem_store.UNPROVIDED));
