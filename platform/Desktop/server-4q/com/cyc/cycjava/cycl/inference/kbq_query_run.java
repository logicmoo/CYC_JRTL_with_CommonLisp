...
public final class kbq_query_run extends SubLTranslatedFile
{
    ...
    public static SubLObject init_kbq_query_run_file() {
        ...
        kbq_query_run.$last_query_set_run$ = SubLFiles.deflexical("*LAST-QUERY-SET-RUN*", (SubLObject)(maybeDefault((SubLObject)kbq_query_run.$sym219$_LAST_QUERY_SET_RUN_, kbq_query_run.$last_query_set_run$, kbq_query_run.NIL)));
        kbq_query_run.$last_test_set_run$ = SubLFiles.deflexical("*LAST-TEST-SET-RUN*", (SubLObject)(maybeDefault((SubLObject)kbq_query_run.$sym241$_LAST_TEST_SET_RUN_, kbq_query_run.$last_test_set_run$, kbq_query_run.NIL)));
        kbq_query_run.$runstate_isg$ = SubLFiles.deflexical("*RUNSTATE-ISG*", maybeDefault((SubLObject)kbq_query_run.$sym260$_RUNSTATE_ISG_, kbq_query_run.$runstate_isg$, ()->(integer_sequence_generator.new_integer_sequence_generator((SubLObject)kbq_query_run.UNPROVIDED, (SubLObject)kbq_query_run.UNPROVIDED, (SubLObject)kbq_query_run.UNPROVIDED))));
        kbq_query_run.$runstate_index$ = SubLFiles.deflexical("*RUNSTATE-INDEX*", maybeDefault((SubLObject)kbq_query_run.$sym261$_RUNSTATE_INDEX_, kbq_query_run.$runstate_index$, ()->(dictionary.new_dictionary((SubLObject)kbq_query_run.UNPROVIDED, (SubLObject)kbq_query_run.UNPROVIDED))));
