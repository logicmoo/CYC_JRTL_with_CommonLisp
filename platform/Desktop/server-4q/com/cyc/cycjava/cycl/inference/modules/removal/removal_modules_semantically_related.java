      ...
      SubLTranslatedFile
{
  ...
  static
  {
    ...
    $const1$or = constant_handles.reader_make_constant_shell( makeString( "or" ) );
    $const2$geographicalSubRegions = constant_handles.reader_make_constant_shell( makeString( "geographicalSubRegions" ) );
    $const3$geopoliticalSubdivision = constant_handles.reader_make_constant_shell( makeString( "geopoliticalSubdivision" ) );
    $const4$genls = constant_handles.reader_make_constant_shell( makeString( "genls" ) );
    $kw5$GENLS = makeKeyword( "GENLS" );
    $const6$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $kw7$ISA = makeKeyword( "ISA" );
    $kw8$OPAQUE = makeKeyword( "OPAQUE" );
    $const9$mutuallyCoherent = constant_handles.reader_make_constant_shell( makeString( "mutuallyCoherent" ) );
    $kw10$POS = makeKeyword( "POS" );
    $kw11$REMOVAL_MUTUALLY_COHERENT = makeKeyword( "REMOVAL-MUTUALLY-COHERENT" );
    $list12 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "mutuallyCoherent" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "mutuallyCoherent" ) ), makeKeyword( "FORT" ), makeKeyword( "FULLY-BOUND" ) ), makeKeyword( "COST-EXPRESSION" ),
