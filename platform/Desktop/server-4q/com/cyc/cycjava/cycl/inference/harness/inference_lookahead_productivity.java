...
public final class inference_lookahead_productivity
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject memoized_problem_max_removal_productivity_int(final SubLObject problem, final SubLObject strategic_context)
  {
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( memoized_problem_max_removal_productivity_int_internal( problem, strategic_context ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( problem, strategic_context ) );
  ...
  public static SubLObject problem_max_removal_productivity(final SubLObject problem, SubLObject strategic_context)
  {
    ...
    if( NIL != striping_tactician.striping_tactician_p( strategic_context ) )
    {
      ...
      {
        strategic_context = $kw2$TACTICAL;
      }
    }
  ...
  public static SubLObject problem_relevant_tactics_wrt_removal(final SubLObject problem, final SubLObject strategic_context)
  {
    ...
    if( $kw2$TACTICAL == strategic_context )
    {
  ...
  public static SubLObject problem_tactically_relevant_tactics_wrt_removal(final SubLObject problem)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != inference_datastructures_problem.do_problem_tactics_type_match( tactic, $kw5$REMOVAL ) )
      {
        result = ConsesLow.cons( tactic, result );
      }
      cdolist_list_var = cdolist_list_var.rest();
      tactic = cdolist_list_var.first();
    }
  ...
  {
    SubLFiles.declareFunction( me, "memoized_problem_max_removal_productivity", "MEMOIZED-PROBLEM-MAX-REMOVAL-PRODUCTIVITY", 2, 0, false );
    SubLFiles.declareFunction( me, "memoized_problem_max_removal_productivity_int_internal", "MEMOIZED-PROBLEM-MAX-REMOVAL-PRODUCTIVITY-INT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "memoized_problem_max_removal_productivity_int", "MEMOIZED-PROBLEM-MAX-REMOVAL-PRODUCTIVITY-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "problem_max_removal_productivity", "PROBLEM-MAX-REMOVAL-PRODUCTIVITY", 2, 0, false );
    SubLFiles.declareFunction( me, "tactic_max_removal_productivity", "TACTIC-MAX-REMOVAL-PRODUCTIVITY", 2, 0, false );
    SubLFiles.declareFunction( me, "problem_relevant_tactics_wrt_removal", "PROBLEM-RELEVANT-TACTICS-WRT-REMOVAL", 2, 0, false );
    SubLFiles.declareFunction( me, "strategy_relevant_tactics_wrt_removal", "STRATEGY-RELEVANT-TACTICS-WRT-REMOVAL", 2, 0, false );
    SubLFiles.declareFunction( me, "problem_tactically_relevant_tactics_wrt_removal", "PROBLEM-TACTICALLY-RELEVANT-TACTICS-WRT-REMOVAL", 1, 0, false );
    return NIL;
  }
  ...
  static
  {
    ...
    $kw2$TACTICAL = makeKeyword( "TACTICAL" );
    $str3$Unexpected_removal_relevant_tacti = makeString( "Unexpected removal-relevant tactic ~S" );
    $kw4$RELEVANT_TACTICS_WRT_REMOVAL = makeKeyword( "RELEVANT-TACTICS-WRT-REMOVAL" );
    $kw5$REMOVAL = makeKeyword( "REMOVAL" );
  }
}
/*
 * 
