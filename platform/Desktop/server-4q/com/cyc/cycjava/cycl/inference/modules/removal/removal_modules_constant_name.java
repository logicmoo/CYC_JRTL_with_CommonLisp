...
public final class removal_modules_constant_name extends SubLTranslatedFile
{
    ...
    public static SubLObject init_removal_modules_constant_name_file() {
        removal_modules_constant_name.$constant_name_defining_mt$ = SubLFiles.deflexical("*CONSTANT-NAME-DEFINING-MT*", (removal_modules_constant_name.NIL != Symbols.boundp((SubLObject)removal_modules_constant_name.$sym3$_CONSTANT_NAME_DEFINING_MT_)) ? removal_modules_constant_name.$constant_name_defining_mt$.getGlobalValue() : removal_modules_constant_name.$const4$BaseKB);
        ...
        removal_modules_constant_name.$denotational_term_defining_mt$ = SubLFiles.deflexical("*DENOTATIONAL-TERM-DEFINING-MT*", (removal_modules_constant_name.NIL != Symbols.boundp((SubLObject)removal_modules_constant_name.$sym14$_DENOTATIONAL_TERM_DEFINING_MT_)) ? removal_modules_constant_name.$denotational_term_defining_mt$.getGlobalValue() : removal_modules_constant_name.$const4$BaseKB);
        ...
        removal_modules_constant_name.$constant_id_defining_mt$ = SubLFiles.deflexical("*CONSTANT-ID-DEFINING-MT*", (removal_modules_constant_name.NIL != Symbols.boundp((SubLObject)removal_modules_constant_name.$sym24$_CONSTANT_ID_DEFINING_MT_)) ? removal_modules_constant_name.$constant_id_defining_mt$.getGlobalValue() : removal_modules_constant_name.$const4$BaseKB);
        ...
        removal_modules_constant_name.$constant_guid_defining_mt$ = SubLFiles.deflexical("*CONSTANT-GUID-DEFINING-MT*", (removal_modules_constant_name.NIL != Symbols.boundp((SubLObject)removal_modules_constant_name.$sym36$_CONSTANT_GUID_DEFINING_MT_)) ? removal_modules_constant_name.$constant_guid_defining_mt$.getGlobalValue() : removal_modules_constant_name.$const4$BaseKB);
