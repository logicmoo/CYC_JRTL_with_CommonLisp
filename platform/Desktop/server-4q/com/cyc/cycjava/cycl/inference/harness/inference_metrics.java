...
public final class inference_metrics extends SubLTranslatedFile
{
    ...
    public static SubLObject init_inference_metrics_file() {
        ...
        inference_metrics.$inference_metrics_store$ = SubLFiles.deflexical("*INFERENCE-METRICS-STORE*", (inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym38$_INFERENCE_METRICS_STORE_)) ? inference_metrics.$inference_metrics_store$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)inference_metrics.EQ), (SubLObject)inference_metrics.UNPROVIDED));
        ...
        inference_metrics.$problem_store_historical_count$ = SubLFiles.deflexical("*PROBLEM-STORE-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym284$_PROBLEM_STORE_HISTORICAL_COUNT_)) ? inference_metrics.$problem_store_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$forward_problem_store_historical_count$ = SubLFiles.deflexical("*FORWARD-PROBLEM-STORE-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym285$_FORWARD_PROBLEM_STORE_HISTORICAL_COUNT_)) ? inference_metrics.$forward_problem_store_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$maximum_problem_store_historical_problem_count$ = SubLFiles.deflexical("*MAXIMUM-PROBLEM-STORE-HISTORICAL-PROBLEM-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym286$_MAXIMUM_PROBLEM_STORE_HISTORICAL_PROBLEM_COUNT_)) ? inference_metrics.$maximum_problem_store_historical_problem_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$maximum_forward_problem_store_historical_problem_count$ = SubLFiles.deflexical("*MAXIMUM-FORWARD-PROBLEM-STORE-HISTORICAL-PROBLEM-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym287$_MAXIMUM_FORWARD_PROBLEM_STORE_HISTORICAL_PROBLEM_COUNT_)) ? inference_metrics.$maximum_forward_problem_store_historical_problem_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        ...
        inference_metrics.$problem_historical_count$ = SubLFiles.deflexical("*PROBLEM-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym290$_PROBLEM_HISTORICAL_COUNT_)) ? inference_metrics.$problem_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$good_problem_historical_count$ = SubLFiles.deflexical("*GOOD-PROBLEM-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym291$_GOOD_PROBLEM_HISTORICAL_COUNT_)) ? inference_metrics.$good_problem_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$no_good_problem_historical_count$ = SubLFiles.deflexical("*NO-GOOD-PROBLEM-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym292$_NO_GOOD_PROBLEM_HISTORICAL_COUNT_)) ? inference_metrics.$no_good_problem_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$forward_problem_historical_count$ = SubLFiles.deflexical("*FORWARD-PROBLEM-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym293$_FORWARD_PROBLEM_HISTORICAL_COUNT_)) ? inference_metrics.$forward_problem_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$single_literal_problem_historical_count$ = SubLFiles.deflexical("*SINGLE-LITERAL-PROBLEM-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym294$_SINGLE_LITERAL_PROBLEM_HISTORICAL_COUNT_)) ? inference_metrics.$single_literal_problem_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$problem_link_historical_count$ = SubLFiles.deflexical("*PROBLEM-LINK-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym295$_PROBLEM_LINK_HISTORICAL_COUNT_)) ? inference_metrics.$problem_link_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$structural_link_historical_count$ = SubLFiles.deflexical("*STRUCTURAL-LINK-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym296$_STRUCTURAL_LINK_HISTORICAL_COUNT_)) ? inference_metrics.$structural_link_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$content_link_historical_count$ = SubLFiles.deflexical("*CONTENT-LINK-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym297$_CONTENT_LINK_HISTORICAL_COUNT_)) ? inference_metrics.$content_link_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$removal_link_historical_count$ = SubLFiles.deflexical("*REMOVAL-LINK-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym298$_REMOVAL_LINK_HISTORICAL_COUNT_)) ? inference_metrics.$removal_link_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$transformation_link_historical_count$ = SubLFiles.deflexical("*TRANSFORMATION-LINK-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym299$_TRANSFORMATION_LINK_HISTORICAL_COUNT_)) ? inference_metrics.$transformation_link_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$dependent_link_historical_count$ = SubLFiles.deflexical("*DEPENDENT-LINK-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym303$_DEPENDENT_LINK_HISTORICAL_COUNT_)) ? inference_metrics.$dependent_link_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$single_literal_problem_dependent_link_historical_count$ = SubLFiles.deflexical("*SINGLE-LITERAL-PROBLEM-DEPENDENT-LINK-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym304$_SINGLE_LITERAL_PROBLEM_DEPENDENT_LINK_HISTORICAL_COUNT_)) ? inference_metrics.$single_literal_problem_dependent_link_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$tactic_historical_count$ = SubLFiles.deflexical("*TACTIC-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym305$_TACTIC_HISTORICAL_COUNT_)) ? inference_metrics.$tactic_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$executed_tactic_historical_count$ = SubLFiles.deflexical("*EXECUTED-TACTIC-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym306$_EXECUTED_TACTIC_HISTORICAL_COUNT_)) ? inference_metrics.$executed_tactic_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$discarded_tactic_historical_count$ = SubLFiles.deflexical("*DISCARDED-TACTIC-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym307$_DISCARDED_TACTIC_HISTORICAL_COUNT_)) ? inference_metrics.$discarded_tactic_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$unification_attempt_historical_count$ = SubLFiles.deflexical("*UNIFICATION-ATTEMPT-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym308$_UNIFICATION_ATTEMPT_HISTORICAL_COUNT_)) ? inference_metrics.$unification_attempt_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$unification_success_historical_count$ = SubLFiles.deflexical("*UNIFICATION-SUCCESS-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym309$_UNIFICATION_SUCCESS_HISTORICAL_COUNT_)) ? inference_metrics.$unification_success_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$sbhl_cache_attempt_historical_count$ = SubLFiles.deflexical("*SBHL-CACHE-ATTEMPT-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym310$_SBHL_CACHE_ATTEMPT_HISTORICAL_COUNT_)) ? inference_metrics.$sbhl_cache_attempt_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$sbhl_cache_success_historical_count$ = SubLFiles.deflexical("*SBHL-CACHE-SUCCESS-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym311$_SBHL_CACHE_SUCCESS_HISTORICAL_COUNT_)) ? inference_metrics.$sbhl_cache_success_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$sbhl_graph_attempt_historical_count$ = SubLFiles.deflexical("*SBHL-GRAPH-ATTEMPT-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym312$_SBHL_GRAPH_ATTEMPT_HISTORICAL_COUNT_)) ? inference_metrics.$sbhl_graph_attempt_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$sbhl_graph_success_historical_count$ = SubLFiles.deflexical("*SBHL-GRAPH-SUCCESS-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym313$_SBHL_GRAPH_SUCCESS_HISTORICAL_COUNT_)) ? inference_metrics.$sbhl_graph_success_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$sbhl_link_historical_count$ = SubLFiles.deflexical("*SBHL-LINK-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym314$_SBHL_LINK_HISTORICAL_COUNT_)) ? inference_metrics.$sbhl_link_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$proof_historical_count$ = SubLFiles.deflexical("*PROOF-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym315$_PROOF_HISTORICAL_COUNT_)) ? inference_metrics.$proof_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$inference_historical_count$ = SubLFiles.deflexical("*INFERENCE-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym316$_INFERENCE_HISTORICAL_COUNT_)) ? inference_metrics.$inference_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$successful_inference_historical_count$ = SubLFiles.deflexical("*SUCCESSFUL-INFERENCE-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym317$_SUCCESSFUL_INFERENCE_HISTORICAL_COUNT_)) ? inference_metrics.$successful_inference_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$forward_inference_historical_count$ = SubLFiles.deflexical("*FORWARD-INFERENCE-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym318$_FORWARD_INFERENCE_HISTORICAL_COUNT_)) ? inference_metrics.$forward_inference_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        inference_metrics.$successful_forward_inference_historical_count$ = SubLFiles.deflexical("*SUCCESSFUL-FORWARD-INFERENCE-HISTORICAL-COUNT*", (SubLObject)((inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym319$_SUCCESSFUL_FORWARD_INFERENCE_HISTORICAL_COUNT_)) ? inference_metrics.$successful_forward_inference_historical_count$.getGlobalValue() : inference_metrics.ZERO_INTEGER));
        ...
        inference_metrics.$forward_inference_metrics_time_index$ = SubLFiles.deflexical("*FORWARD-INFERENCE-METRICS-TIME-INDEX*", (inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym361$_FORWARD_INFERENCE_METRICS_TIME_INDEX_)) ? inference_metrics.$forward_inference_metrics_time_index$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)inference_metrics.EQ), (SubLObject)inference_metrics.UNPROVIDED));
        inference_metrics.$forward_inference_metrics_count_index$ = SubLFiles.deflexical("*FORWARD-INFERENCE-METRICS-COUNT-INDEX*", (inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym362$_FORWARD_INFERENCE_METRICS_COUNT_INDEX_)) ? inference_metrics.$forward_inference_metrics_count_index$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)inference_metrics.EQ), (SubLObject)inference_metrics.UNPROVIDED));
        inference_metrics.$forward_inference_metrics_inference_index$ = SubLFiles.deflexical("*FORWARD-INFERENCE-METRICS-INFERENCE-INDEX*", (inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym363$_FORWARD_INFERENCE_METRICS_INFERENCE_INDEX_)) ? inference_metrics.$forward_inference_metrics_inference_index$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)inference_metrics.EQ), (SubLObject)inference_metrics.UNPROVIDED));
        inference_metrics.$forward_inference_metrics_gaf_index$ = SubLFiles.deflexical("*FORWARD-INFERENCE-METRICS-GAF-INDEX*", (inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym365$_FORWARD_INFERENCE_METRICS_GAF_INDEX_)) ? inference_metrics.$forward_inference_metrics_gaf_index$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)inference_metrics.EQ), (SubLObject)inference_metrics.UNPROVIDED));
        inference_metrics.$forward_inference_metrics_successful_rule_index$ = SubLFiles.deflexical("*FORWARD-INFERENCE-METRICS-SUCCESSFUL-RULE-INDEX*", (inference_metrics.NIL != Symbols.boundp((SubLObject)inference_metrics.$sym366$_FORWARD_INFERENCE_METRICS_SUCCESSFUL_RULE_INDEX_)) ? inference_metrics.$forward_inference_metrics_successful_rule_index$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)inference_metrics.EQ), (SubLObject)inference_metrics.UNPROVIDED));
