...
public final class removal_modules_equals extends SubLTranslatedFile
{
    ...
    public static SubLObject init_removal_modules_equals_file() {
        ...
        removal_modules_equals.$equal_symbols_defining_mt$ = SubLFiles.deflexical("*EQUAL-SYMBOLS-DEFINING-MT*", (removal_modules_equals.NIL != Symbols.boundp((SubLObject)removal_modules_equals.$sym25$_EQUAL_SYMBOLS_DEFINING_MT_)) ? removal_modules_equals.$equal_symbols_defining_mt$.getGlobalValue() : removal_modules_equals.$const26$BaseKB);
        ...
        removal_modules_equals.$equal_strings_case_insensitive_defining_mt$ = SubLFiles.deflexical("*EQUAL-STRINGS-CASE-INSENSITIVE-DEFINING-MT*", (removal_modules_equals.NIL != Symbols.boundp((SubLObject)removal_modules_equals.$sym37$_EQUAL_STRINGS_CASE_INSENSITIVE_DEFINING_MT_)) ? removal_modules_equals.$equal_strings_case_insensitive_defining_mt$.getGlobalValue() : removal_modules_equals.$const26$BaseKB);
