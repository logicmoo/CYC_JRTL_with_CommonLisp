...
public final class forward extends SubLTranslatedFile
{
    ...
    public static SubLObject init_forward_file() {
        ...
        forward.$global_forward_inference_environment_lock$ = SubLFiles.deflexical("*GLOBAL-FORWARD-INFERENCE-ENVIRONMENT-LOCK*", (forward.NIL != Symbols.boundp((SubLObject)forward.$sym6$_GLOBAL_FORWARD_INFERENCE_ENVIRONMENT_LOCK_)) ? forward.$global_forward_inference_environment_lock$.getGlobalValue() : Locks.make_lock((SubLObject)forward.$str7$Global_forward_inference_environm));
        ...
        forward.$currently_forward_propagating_supports$ = SubLFiles.deflexical("*CURRENTLY-FORWARD-PROPAGATING-SUPPORTS*", (forward.NIL != Symbols.boundp((SubLObject)forward.$sym8$_CURRENTLY_FORWARD_PROPAGATING_SUPPORTS_)) ? forward.$currently_forward_propagating_supports$.getGlobalValue() : set.new_set(Symbols.symbol_function((SubLObject)forward.EQUAL), (SubLObject)forward.UNPROVIDED));
