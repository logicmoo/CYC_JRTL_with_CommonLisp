...
public final class rkf_sentence_communicator
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject rkf_sentence_phrase(final SubLObject sentence, final SubLObject language_mt, final SubLObject domain_mt, SubLObject paraphrase_mode)
  {
    ...
    try
    {
      ...
      phrase = rkf_concept_communicator.rkf_term_phrase( sentence, language_mt, domain_mt, $kw1$DECLARATIVE, paraphrase_mode );
    }
    finally
    {
  ...
  public static SubLObject rkf_query_phrase(final SubLObject query, final SubLObject language_mt, final SubLObject domain_mt, SubLObject paraphrase_mode, SubLObject use_blanksP)
  {
    ...
    try
    {
      ...
      phrase = rkf_concept_communicator.rkf_term_phrase( query, language_mt, domain_mt, $kw3$QUESTION, paraphrase_mode );
    }
    finally
    {
  ...
  public static SubLObject rkf_imperative_phrase(final SubLObject imperative, final SubLObject language_mt, final SubLObject domain_mt, SubLObject paraphrase_mode, SubLObject use_blanksP)
  {
    ...
    try
    {
      pph_vars.$rkf_prefer_nouns_for_termsP$.bind( NIL, thread );
      pph_vars.$pph_blanks_for_varsP$.bind( use_blanksP, thread );
      phrase = rkf_concept_communicator.rkf_term_phrase( imperative, language_mt, domain_mt, $kw4$IMPERATIVE, paraphrase_mode );
    }
    finally
    {
      pph_vars.$pph_blanks_for_varsP$.rebind( _prev_bind_2, thread );
  ...
  public static SubLObject rkf_html_sentence_phrase(final SubLObject sentence, final SubLObject generation_mt, final SubLObject domain_mt, SubLObject function, SubLObject target)
  {
    ...
    try
    {
      ...
      phrase = rkf_sentence_phrase( sentence, generation_mt, domain_mt, $kw5$HTML );
    }
    finally
    {
  ...
  public static SubLObject rkf_html_query_phrase(final SubLObject query, final SubLObject generation_mt, final SubLObject domain_mt, SubLObject function, SubLObject target, SubLObject use_blanksP)
  {
    ...
    try
    {
      pph_vars.$constant_link_function$.bind( ( NIL != function ) ? function : pph_vars.$constant_link_function$.getDynamicValue( thread ), thread );
      pph_vars.$html_generation_target$.bind( ( NIL != target ) ? target : pph_vars.$html_generation_target$.getDynamicValue( thread ), thread );
      phrase = rkf_query_phrase( query, generation_mt, domain_mt, $kw5$HTML, use_blanksP );
    }
    finally
    {
      pph_vars.$html_generation_target$.rebind( _prev_bind_2, thread );
  ...
  public static SubLObject rkf_html_imperative_phrase(final SubLObject imperative, final SubLObject generation_mt, final SubLObject domain_mt, SubLObject function, SubLObject target, SubLObject use_blanksP)
  {
    ...
    try
    {
      pph_vars.$constant_link_function$.bind( ( NIL != function ) ? function : pph_vars.$constant_link_function$.getDynamicValue( thread ), thread );
      pph_vars.$html_generation_target$.bind( ( NIL != target ) ? target : pph_vars.$html_generation_target$.getDynamicValue( thread ), thread );
      phrase = rkf_imperative_phrase( imperative, generation_mt, domain_mt, $kw5$HTML, use_blanksP );
    }
    finally
    {
      pph_vars.$html_generation_target$.rebind( _prev_bind_2, thread );
  ...
  {
    SubLFiles.declareFunction( me, "rkf_sentence_phrase", "RKF-SENTENCE-PHRASE", 3, 1, false );
    SubLFiles.declareFunction( me, "rkf_sentence_phrase_precise", "RKF-SENTENCE-PHRASE-PRECISE", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_query_phrase", "RKF-QUERY-PHRASE", 3, 2, false );
    SubLFiles.declareFunction( me, "rkf_imperative_phrase", "RKF-IMPERATIVE-PHRASE", 3, 2, false );
    SubLFiles.declareFunction( me, "rkf_html_sentence_phrase", "RKF-HTML-SENTENCE-PHRASE", 3, 2, false );
    SubLFiles.declareFunction( me, "rkf_html_sentence_phrase_precise", "RKF-HTML-SENTENCE-PHRASE-PRECISE", 3, 2, false );
    SubLFiles.declareFunction( me, "rkf_html_query_phrase", "RKF-HTML-QUERY-PHRASE", 3, 3, false );
    SubLFiles.declareFunction( me, "rkf_html_imperative_phrase", "RKF-HTML-IMPERATIVE-PHRASE", 3, 3, false );
    SubLFiles.declareFunction( me, "rkf_formula_string", "RKF-FORMULA-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_support_string", "RKF-SUPPORT-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_assertion_string", "RKF-ASSERTION-STRING", 1, 0, false );
    return NIL;
  }
  ...
  static
  {
    me = new rkf_sentence_communicator();
    $kw0$TEXT = makeKeyword( "TEXT" );
    $kw1$DECLARATIVE = makeKeyword( "DECLARATIVE" );
    $sym2$PPH_PRECISION_P = makeSymbol( "PPH-PRECISION-P" );
    $kw3$QUESTION = makeKeyword( "QUESTION" );
    $kw4$IMPERATIVE = makeKeyword( "IMPERATIVE" );
    $kw5$HTML = makeKeyword( "HTML" );
    $sym6$SUPPORT_P = makeSymbol( "SUPPORT-P" );
