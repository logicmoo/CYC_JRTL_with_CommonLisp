...
public final class user_interaction_agenda extends SubLTranslatedFile
{
    ...
    public static SubLObject init_user_interaction_agenda_file() {
        user_interaction_agenda.$uia_lock$ = SubLFiles.deflexical("*UIA-LOCK*", maybeDefault((SubLObject)user_interaction_agenda.$sym0$_UIA_LOCK_, user_interaction_agenda.$uia_lock$, ()->(Locks.make_lock((SubLObject)user_interaction_agenda.$str1$User_Interaction_Agenda_lock))));
        ...
        user_interaction_agenda.$uimma$ = SubLFiles.deflexical("*UIMMA*", (SubLObject)(maybeDefault((SubLObject)user_interaction_agenda.$sym185$_UIMMA_, user_interaction_agenda.$uimma$, user_interaction_agenda.NIL)));
        user_interaction_agenda.$uimma_default_locale$ = SubLFiles.deflexical("*UIMMA-DEFAULT-LOCALE*", maybeDefault((SubLObject)user_interaction_agenda.$sym186$_UIMMA_DEFAULT_LOCALE_, user_interaction_agenda.$uimma_default_locale$, ()->(((user_interaction_agenda.NIL != system_info.cycorp_execution_context_p()) ? user_interaction_agenda.$const187$EnglishLanguage : user_interaction_agenda.$const187$EnglishLanguage))));
        user_interaction_agenda.$uimma_default_generation_mt$ = SubLFiles.deflexical("*UIMMA-DEFAULT-GENERATION-MT*", maybeDefault((SubLObject)user_interaction_agenda.$sym188$_UIMMA_DEFAULT_GENERATION_MT_, user_interaction_agenda.$uimma_default_generation_mt$, user_interaction_agenda.$const148$EnglishParaphraseMt));
        user_interaction_agenda.$uimma_default_domain_mt$ = SubLFiles.deflexical("*UIMMA-DEFAULT-DOMAIN-MT*", maybeDefault((SubLObject)user_interaction_agenda.$sym189$_UIMMA_DEFAULT_DOMAIN_MT_, user_interaction_agenda.$uimma_default_domain_mt$, user_interaction_agenda.$const190$EverythingPSC));
