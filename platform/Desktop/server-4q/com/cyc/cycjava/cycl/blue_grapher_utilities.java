...
public final class blue_grapher_utilities
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject define_blue_filter_fn(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.list( $sym2$PROGN, ConsesLow.list( $sym3$SETHASH, ConsesLow.list( $sym4$QUOTE, name ), $sym0$_BLUE_FILTER_FNS_, ConsesLow.list( $sym4$QUOTE, deflist ) ), ConsesLow.listS( $sym5$DEFINE_PROTECTED,
        name, arglist, ConsesLow.append( body, NIL ) ), ConsesLow.list( $sym6$REGISTER_API_PREDEFINED_FUNCTION, ConsesLow.list( $sym4$QUOTE, name ) ) );
  }
  ...
  public static SubLObject get_blue_filter_fn_data(final SubLObject blue_filter_fn)
  {
    ...
    final SubLObject blue_filter_fn_data = Hashtables.gethash( blue_filter_fn, $blue_filter_fns$.getGlobalValue(), UNPROVIDED );
  ...
  public static SubLObject get_blue_filter_fn_cost(final SubLObject blue_filter_fn)
  {
    ...
    final SubLObject cost = conses_high.getf( filter_fn_data, $kw8$COST, UNPROVIDED );
  ...
  {
    final SubLObject filter_fn_data = get_blue_filter_fn_data( blue_filter_fn );
    final SubLObject strength = conses_high.getf( filter_fn_data, $kw10$STRENGTH, UNPROVIDED );
  ...
  {
    final SubLObject filter_fn_data = get_blue_filter_fn_data( blue_filter_fn );
    final SubLObject type = conses_high.getf( filter_fn_data, $kw12$TYPE, UNPROVIDED );
  ...
  public static SubLObject blue_filter_fns_sorted(SubLObject blue_filter_fns)
  {
    ...
    return Sort.sort( blue_filter_fns, Symbols.symbol_function( $sym14$_ ), Symbols.symbol_function( $sym15$GET_BLUE_FILTER_FN_STRENGTH ) );
  }
  ...
  public static SubLObject blue_filter_fn_keys(SubLObject blue_filter_fns)
  {
    ...
    return Mapping.mapcar( Symbols.symbol_function( $sym16$MAKE_KEYWORD ), blue_filter_fns_sorted( blue_filter_fns ) );
  }
  ...
  {
    final SubLObject poss_function_spec = Packages.intern( string_utilities.string_from_keyword( bbf_key ), UNPROVIDED );
    if( NIL != Hashtables.gethash( poss_function_spec, $blue_filter_fns$.getGlobalValue(), UNPROVIDED ) && poss_function_spec.isFunctionSpec() )
    {
  ...
  public static SubLObject bff_arbitrary_unions(final SubLObject terms, final SubLObject mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL == isa.isa_in_any_mtP( v_term, $const19$ArbitraryUnion ) )
      {
  ...
  public static SubLObject bff_cyc_kb_subset_collections(final SubLObject terms, final SubLObject mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL == isa.isa_in_any_mtP( v_term, $const21$CycKBSubsetCollection ) )
      {
        result = ConsesLow.cons( v_term, result );
      }
      cdolist_list_var = cdolist_list_var.rest();
  ...
  {
    return list_utilities.first_n( FIVE_INTEGER, Sort.sort( terms, Symbols.symbol_function( $sym24$GENERALITY_ESTIMATE_ ), UNPROVIDED ) );
  }
  ...
  {
    return list_utilities.first_n( TEN_INTEGER, Sort.sort( terms, Symbols.symbol_function( $sym24$GENERALITY_ESTIMATE_ ), UNPROVIDED ) );
  }
  ...
  {
    return list_utilities.first_n( TWENTY_INTEGER, Sort.sort( terms, Symbols.symbol_function( $sym24$GENERALITY_ESTIMATE_ ), UNPROVIDED ) );
  }
  ...
  public static SubLObject define_blue_builder_fn(final SubLObject macroform, final SubLObject environment)
  {
    ...
    final SubLObject body;
    current = ( body = current.rest() );
    return ConsesLow.list( $sym2$PROGN, ConsesLow.listS( $sym3$SETHASH, ConsesLow.list( $sym4$QUOTE, name ), $list31 ), ConsesLow.list( $sym3$SETHASH, ConsesLow.list( $sym4$QUOTE, name ),
        $sym30$_BLUE_BUILDER_FN_TO_DEFLIST_HASH_, ConsesLow.list( $sym4$QUOTE, deflist ) ), ConsesLow.listS( $sym5$DEFINE_PROTECTED, name, arglist, ConsesLow.append( body, NIL ) ), ConsesLow.list(
            $sym6$REGISTER_API_PREDEFINED_FUNCTION, ConsesLow.list( $sym4$QUOTE, name ) ) );
  }
  ...
  public static SubLObject get_blue_builder_fn_data(final SubLObject blue_builder_fn)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    thread.resetMultipleValues();
    final SubLObject blue_builder_fn_data = Hashtables.gethash( blue_builder_fn, $blue_builder_fns$.getGlobalValue(), UNPROVIDED );
    final SubLObject foundP = thread.secondMultipleValue();
    thread.resetMultipleValues();
  ...
  {
    return Mapping.mapcar( Symbols.symbol_function( $sym16$MAKE_KEYWORD ), Sort.sort( hash_table_utilities.hash_table_keys( $blue_builder_fns$.getGlobalValue() ), $sym33$STRING_, $sym34$SYMBOL_NAME ) );
  }
  ...
  {
    final SubLObject poss_function_spec = Packages.intern( string_utilities.string_from_keyword( bbf_key ), UNPROVIDED );
    if( NIL != Hashtables.gethash( poss_function_spec, $blue_builder_fns$.getGlobalValue(), UNPROVIDED ) && poss_function_spec.isFunctionSpec() )
    {
      return poss_function_spec;
    }
    return NIL;
  ...
  public static SubLObject get_blue_builder_fn_def_value(final SubLObject bbf_key, final SubLObject def_key)
  {
    ...
    {
      return conses_high.getf( Hashtables.gethash( bbf, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), UNPROVIDED ), def_key, UNPROVIDED );
    }
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject preds = conses_high.getf( arg_plist, $kw37$PREDS, UNPROVIDED );
    final SubLObject v_forts = conses_high.getf( arg_plist, $kw38$FORTS, UNPROVIDED );
    final SubLObject mt = conses_high.getf( arg_plist, $kw39$MT, UNPROVIDED );
    final SubLObject filter_fns = conses_high.getf( arg_plist, $kw40$FILTER_FNS, UNPROVIDED );
    final SubLObject depth = conses_high.getf( arg_plist, $kw41$DEPTH, UNPROVIDED );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      while ( NIL != cdolist_list_var_$1)
      {
        ...
        {
          result_nodes = ConsesLow.cons( bbf_make_node( protonode, UNPROVIDED, UNPROVIDED ), result_nodes );
        ...
        {
          result_edges = ConsesLow.cons( bbf_make_edge( pred, protoedge.first(), conses_high.second( protoedge ), mt, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), result_edges );
    ...
    return bbf_make_graph( result_nodes, result_edges, ConsesLow.list( $kw39$MT, mt ) );
  }
  ...
  public static SubLObject bbf_forward_true_internal(final SubLObject pred, final SubLObject tail_node, final SubLObject mt, final SubLObject filter_fns, SubLObject depth, SubLObject done_tail_nodes)
  {
    ...
    head_nodes = ( ( NIL != kb_accessors.transitive_predicateP( pred ) ) ? gt_methods.gt_superiors( pred, tail_node, mt )
        : kb_mapping_utilities.pred_values_in_mt( tail_node, pred, mt, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    if( NIL != head_nodes )
    {
      head_nodes = blue_apply_filter_fns( head_nodes, filter_fns, mt, UNPROVIDED );
      if( NIL != head_nodes )
      {
        coextensional_head_nodes = conses_high.intersection( head_nodes, ( NIL != kb_accessors.transitive_predicateP( pred ) ) ? gt_methods.gt_inferiors( pred, tail_node, mt )
            : kb_mapping_utilities.pred_values_in_mt( tail_node, pred, mt, TWO_INTEGER, ONE_INTEGER, UNPROVIDED ), UNPROVIDED, UNPROVIDED );
        head_nodes = conses_high.set_difference( head_nodes, coextensional_head_nodes, UNPROVIDED, UNPROVIDED );
        coextensional_head_nodes = conses_high.set_difference( coextensional_head_nodes, ConsesLow.list( tail_node ), UNPROVIDED, UNPROVIDED );
      }
    }
    SubLObject cdolist_list_var;
    head_nodes = ( cdolist_list_var = blue_apply_filter_fns( head_nodes, filter_fns, mt, $kw42$POST_MINIMIZATION ) );
    SubLObject head_node = NIL;
    head_node = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      protoedges = ConsesLow.cons( ConsesLow.list( tail_node, head_node ), protoedges );
      cdolist_list_var = cdolist_list_var.rest();
      head_node = cdolist_list_var.first();
    }
    ...
    while ( NIL != cdolist_list_var)
    {
      protoedges = ConsesLow.cons( ConsesLow.list( tail_node, coextensional_head_node ), protoedges );
      protoedges = ConsesLow.cons( ConsesLow.list( coextensional_head_node, tail_node ), protoedges );
      ...
      while ( NIL != cdolist_list_var_$4)
      {
        ...
        {
          protoedges = ConsesLow.cons( ConsesLow.list( coextensional_head_node, another_coextensional_head_node ), protoedges );
        }
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        protoedges = ConsesLow.cons( ConsesLow.list( coextensional_head_node2, head_node ), protoedges );
    ...
    if( NIL != recurseP )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        if( NIL == subl_promotions.memberP( recurse_tail_node, done_tail_nodes, Symbols.symbol_function( EQUAL ), UNPROVIDED ) )
        {
          done_tail_nodes = ConsesLow.cons( recurse_tail_node, done_tail_nodes );
          thread.resetMultipleValues();
          ...
          recurse_protoedges = ( cdolist_list_var_$6 = Sequences.remove_duplicates( recurse_protoedges, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
          SubLObject recurse_protoedge = NIL;
          recurse_protoedge = cdolist_list_var_$6.first();
          while ( NIL != cdolist_list_var_$6)
          {
            protoedges = ConsesLow.cons( recurse_protoedge, protoedges );
  ...
  public static SubLObject bbf_backward_true_internal(final SubLObject pred, final SubLObject head_node, final SubLObject mt, final SubLObject filter_fns, SubLObject depth, SubLObject done_head_nodes)
  {
    ...
    tail_nodes = ( ( NIL != kb_accessors.transitive_predicateP( pred ) ) ? gt_methods.gt_inferiors( pred, head_node, mt )
        : kb_mapping_utilities.pred_values_in_mt( head_node, pred, mt, TWO_INTEGER, ONE_INTEGER, UNPROVIDED ) );
    if( NIL != tail_nodes )
    {
      tail_nodes = blue_apply_filter_fns( tail_nodes, filter_fns, mt, UNPROVIDED );
      if( NIL != tail_nodes )
      {
        coextensional_tail_nodes = conses_high.intersection( tail_nodes, ( NIL != kb_accessors.transitive_predicateP( pred ) ) ? gt_methods.gt_superiors( pred, head_node, mt )
            : kb_mapping_utilities.pred_values_in_mt( head_node, pred, mt, ONE_INTEGER, TWO_INTEGER, UNPROVIDED ), UNPROVIDED, UNPROVIDED );
        tail_nodes = conses_high.set_difference( tail_nodes, coextensional_tail_nodes, UNPROVIDED, UNPROVIDED );
        coextensional_tail_nodes = conses_high.set_difference( coextensional_tail_nodes, ConsesLow.list( head_node ), UNPROVIDED, UNPROVIDED );
      }
    }
    SubLObject cdolist_list_var;
    tail_nodes = ( cdolist_list_var = blue_apply_filter_fns( tail_nodes, filter_fns, mt, $kw42$POST_MINIMIZATION ) );
    ...
    while ( NIL != cdolist_list_var)
    {
      protoedges = ConsesLow.cons( ConsesLow.list( head_node, coextensional_tail_node ), protoedges );
      protoedges = ConsesLow.cons( ConsesLow.list( coextensional_tail_node, head_node ), protoedges );
      cdolist_list_var = cdolist_list_var.rest();
      coextensional_tail_node = cdolist_list_var.first();
    }
    if( depth.numE( ONE_INTEGER ) )
    ...
    if( NIL != recurseP )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        if( NIL == subl_promotions.memberP( recurse_head_node, done_head_nodes, Symbols.symbol_function( EQUAL ), UNPROVIDED ) )
        {
          done_head_nodes = ConsesLow.cons( recurse_head_node, done_head_nodes );
          thread.resetMultipleValues();
          ...
          recurse_protoedges = ( cdolist_list_var_$10 = Sequences.remove_duplicates( recurse_protoedges, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
          SubLObject recurse_protoedge = NIL;
    ...
    if( NIL != sbhl_module_utilities.sbhl_predicate_p( pred ) )
    {
      ...
      if( NIL != head_nodes )
      {
        ...
        if( NIL != head_nodes )
        {
          ...
          head_nodes = conses_high.set_difference( head_nodes, coextensional_head_nodes, UNPROVIDED, UNPROVIDED );
          coextensional_head_nodes = conses_high.set_difference( coextensional_head_nodes, ConsesLow.list( tail_node ), UNPROVIDED, UNPROVIDED );
          if( Sequences.length( head_nodes ).numG( ONE_INTEGER ) )
          {
          ...
          if( Sequences.length( coextensional_head_nodes ).numG( ONE_INTEGER ) )
          {
    ...
    if( NIL != recurseP )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        if( NIL == subl_promotions.memberP( recurse_tail_node, done_tail_nodes, Symbols.symbol_function( EQUAL ), UNPROVIDED ) )
        {
          ...
          recurse_protoedges = ( cdolist_list_var_$16 = Sequences.remove_duplicates( recurse_protoedges, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
          SubLObject recurse_protoedge = NIL;
    ...
    if( NIL != sbhl_module_utilities.sbhl_predicate_p( pred ) )
    {
      ...
      if( NIL != tail_nodes )
      {
        ...
        if( NIL != tail_nodes )
        {
          ...
          tail_nodes = conses_high.set_difference( tail_nodes, coextensional_tail_nodes, UNPROVIDED, UNPROVIDED );
          coextensional_tail_nodes = conses_high.set_difference( coextensional_tail_nodes, ConsesLow.list( head_node ), UNPROVIDED, UNPROVIDED );
          if( Sequences.length( tail_nodes ).numG( ONE_INTEGER ) )
          {
          ...
          if( Sequences.length( coextensional_tail_nodes ).numG( ONE_INTEGER ) )
          {
            coextensional_tail_nodes = sbhl_search_methods.sbhl_max_nodes( sbhl_module_utilities.get_sbhl_reductions_module( sbhl_module_vars.get_sbhl_module( pred ) ), coextensional_tail_nodes, mt, UNPROVIDED,
                UNPROVIDED );
          }
        }
      }
    ...
    if( NIL != recurseP )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        if( NIL == subl_promotions.memberP( recurse_head_node, done_head_nodes, Symbols.symbol_function( EQUAL ), UNPROVIDED ) )
        {
          ...
          recurse_protoedges = ( cdolist_list_var_$20 = Sequences.remove_duplicates( recurse_protoedges, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
          SubLObject recurse_protoedge = NIL;
  ...
  public static SubLObject bbf_min_ceilings_forward_true_internal(final SubLObject pred, final SubLObject arg_ins, final SubLObject mt, final SubLObject filter_fns, SubLObject depth, SubLObject done_arg_ins)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( NIL == arg_ins || Sequences.length( arg_ins ).numLE( ONE_INTEGER ) )
    {
      return Values.values( NIL, done_arg_ins );
    }
    SubLObject recurseP = NIL;
    SubLObject protoedges = NIL;
    ...
    if( NIL != sbhl_module_utilities.sbhl_predicate_p( pred ) )
    {
      ...
      for( arg_ins_copy = arg_ins.rest(); NIL != arg_ins_copy; arg_ins_copy = arg_ins_copy.rest() )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          local_arg_outs = sbhl_search_methods.sbhl_ceilings( sbhl_module_vars.get_sbhl_module( pred ), ConsesLow.list( arg_in_1, arg_in_2 ), NIL, mt, $const51$True_JustificationTruth );
          if( NIL != local_arg_outs )
          {
            local_arg_outs = blue_apply_filter_fns( local_arg_outs, filter_fns, mt, UNPROVIDED );
            local_arg_outs = conses_high.set_difference( local_arg_outs, arg_ins, UNPROVIDED, UNPROVIDED );
            if( Sequences.length( local_arg_outs ).numG( ONE_INTEGER ) )
            {
              local_arg_outs = sbhl_search_methods.sbhl_min_nodes( sbhl_module_utilities.get_sbhl_reductions_module( sbhl_module_vars.get_sbhl_module( pred ) ), local_arg_outs, mt, $const51$True_JustificationTruth );
            }
          }
          SubLObject cdolist_list_var_$23;
          local_arg_outs = ( cdolist_list_var_$23 = blue_apply_filter_fns( local_arg_outs, filter_fns, mt, $kw42$POST_MINIMIZATION ) );
          SubLObject local_arg_out = NIL;
          local_arg_out = cdolist_list_var_$23.first();
          while ( NIL != cdolist_list_var_$23)
          {
            arg_outs = ConsesLow.cons( local_arg_out, arg_outs );
            protoedges = ConsesLow.cons( ConsesLow.list( arg_in_1, local_arg_out ), protoedges );
            protoedges = ConsesLow.cons( ConsesLow.list( arg_in_2, local_arg_out ), protoedges );
      ...
      protoedges = Sequences.remove_duplicates( protoedges, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
      arg_outs = Sequences.remove_duplicates( arg_outs, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
    if( depth.numE( ONE_INTEGER ) )
    {
      recurseP = NIL;
    ...
    if( NIL != recurseP )
    {
      ...
      thread.resetMultipleValues();
      SubLObject cdolist_list_var;
      recurse_protoedges = ( cdolist_list_var = Sequences.remove_duplicates( recurse_protoedges, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
      SubLObject recurse_protoedge = NIL;
  ...
  public static SubLObject bbf_min_forward_and_backward_true(final SubLObject arg_plist)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      result_edges = ConsesLow.cons( bbf_make_edge( protoedge.first(), conses_high.second( protoedge ), conses_high.third( protoedge ), mt, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), result_edges );
      cdolist_list_var = cdolist_list_var.rest();
      protoedge = cdolist_list_var.first();
    }
    return bbf_make_graph( result_nodes, result_edges, ConsesLow.list( $kw39$MT, mt ) );
  ...
  public static SubLObject bbf_min_forward_and_backward_true_internal(final SubLObject preds, final SubLObject mt, final SubLObject filter_fns, final SubLObject depth, final SubLObject args)
  {
    ...
    final SubLObject arg_step_map = ConsesLow.list( args );
    thread.resetMultipleValues();
    ...
    try
    {
      while ( Hashtables.iteratorHasNext( cdohash_iterator ))
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          protoedges = ConsesLow.cons( ConsesLow.list( pred, arg_out, arg_in ), protoedges );
          cdolist_list_var = cdolist_list_var.rest();
          pred_arg_out = cdolist_list_var.first();
        }
      }
    ...
    try
    {
      while ( Hashtables.iteratorHasNext( cdohash_iterator_$24 ))
      {
        ...
        protonodes = ConsesLow.cons( ConsesLow.list( arg, arg_depth ), protonodes );
      }
    }
    finally
    {
  ...
  public static SubLObject bbf_min_forward_and_backward_true_internal_internal(final SubLObject preds, final SubLObject mt, final SubLObject filter_fns, SubLObject depth, SubLObject arg_step_map, SubLObject arg_edge_map,
      SubLObject arg_depth_map)
  {
    ...
    {
      arg_edge_map = Hashtables.make_hash_table( $int54$32, UNPROVIDED, UNPROVIDED );
    }
    if( !arg_depth_map.isHashtable() )
    {
      arg_depth_map = Hashtables.make_hash_table( $int54$32, UNPROVIDED, UNPROVIDED );
      ...
      if( NIL != sbhl_module_utilities.sbhl_predicate_p( pred ) )
      {
        ...
        while ( NIL != cdolist_list_var_$26)
        {
          ...
          if( NIL != arg_outs )
          {
            ...
            if( Sequences.length( arg_outs ).numG( ONE_INTEGER ) )
            {
          ...
          {
            hash_table_utilities.pushnew_hash( arg, ConsesLow.list( pred, arg_out ), arg_edge_map, UNPROVIDED );
            cdolist_list_var_$27 = cdolist_list_var_$27.rest();
            arg_out = cdolist_list_var_$27.first();
          }
          arg_nexts_list = ConsesLow.cons( arg_outs, arg_nexts_list );
          ...
          if( NIL != arg_ins )
          {
            ...
            if( Sequences.length( arg_ins ).numG( ONE_INTEGER ) )
            {
          ...
          {
            hash_table_utilities.push_hash( arg_in, ConsesLow.list( pred, arg ), arg_edge_map );
            cdolist_list_var_$28 = cdolist_list_var_$28.rest();
            arg_in = cdolist_list_var_$28.first();
          }
          arg_nexts_list = ConsesLow.cons( arg_ins, arg_nexts_list );
    ...
    arg_nexts = Sequences.remove_duplicates( Functions.apply( Symbols.symbol_function( $sym55$APPEND ), arg_nexts_list ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    arg_nexts = Sequences.remove_duplicates( arg_nexts, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    arg_nexts = blue_apply_filter_fns( arg_nexts, filter_fns, mt, $kw42$POST_MINIMIZATION );
    arg_nexts = conses_high.set_difference( arg_nexts, Functions.apply( Symbols.symbol_function( $sym55$APPEND ), arg_step_map ), UNPROVIDED, UNPROVIDED );
    arg_step_map = ConsesLow.cons( arg_nexts, arg_step_map );
    ...
    while ( NIL != cdolist_list_var2)
    {
      final SubLObject arg_depth = Hashtables.gethash( arg_next, arg_depth_map, UNPROVIDED );
  ...
  public static SubLObject bbf_script(final SubLObject arg_plist)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject v_forts = conses_high.getf( arg_plist, $kw38$FORTS, UNPROVIDED );
    SubLObject mt = conses_high.getf( arg_plist, $kw39$MT, UNPROVIDED );
    ...
    try
    {
      ...
      SubLObject cdolist_list_var = list_utilities.remove_if_not( $sym61$TERNARY_PREDICATE_, isa.all_fort_instances( $const62$QuasiTemporalSubSituationTypesPre, UNPROVIDED, UNPROVIDED ), UNPROVIDED, UNPROVIDED,
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        while ( NIL != cdolist_list_var_$29)
        {
          ...
          final SubLObject node2 = bbf_make_node( scene2, $const59$Situation, UNPROVIDED );
          final SubLObject node3 = bbf_make_node( scene3, $const59$Situation, UNPROVIDED );
          result_nodes = ConsesLow.cons( node3, result_nodes );
          result_nodes = ConsesLow.cons( node2, result_nodes );
          result_edges = ConsesLow.cons( bbf_make_edge_with_nodes( quasi_temporal_pred, node3, node2, mt, NIL, UNPROVIDED ), result_edges );
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        while ( NIL != cdolist_list_var_$30)
        {
          ...
          final SubLObject tailnode = bbf_make_node( scene4, $const59$Situation, UNPROVIDED );
          final SubLObject headnode = bbf_make_node( ConsesLow.list( actor, role, scene4 ), $const63$SomethingExisting, ConsesLow.list( $kw64$ACTOR, actor, $kw65$ROLE, role, $kw66$SCENE, scene4 ) );
          result_nodes = ConsesLow.cons( tailnode, result_nodes );
          result_nodes = ConsesLow.cons( headnode, result_nodes );
          result_edges = ConsesLow.cons( bbf_make_edge_with_nodes( role, tailnode, headnode, mt, NIL, ConsesLow.list( $kw67$ORIGINAL_PREDICATE, actor_scene_role_pred ) ), result_edges );
      ...
      while ( NIL != cdolist_list_var2)
      {
        ...
        if( NIL == headnode )
        {
          headnode = bbf_make_node( ConsesLow.list( actor, role, scene4 ), $const71$Individual, ConsesLow.list( $kw64$ACTOR, actor, $kw65$ROLE, role, $kw66$SCENE, scene4 ) );
          dictionary.dictionary_enter( headnodes, actor, headnode );
        }
        result_nodes = ConsesLow.cons( tailnode, result_nodes );
        result_nodes = ConsesLow.cons( headnode, result_nodes );
        result_edges = ConsesLow.cons( bbf_make_edge_with_nodes( role, tailnode, headnode, mt, NIL, ConsesLow.list( $kw67$ORIGINAL_PREDICATE, actor_scene_role_pred2 ) ), result_edges );
        cdolist_list_var2 = cdolist_list_var2.rest();
        actor_scene_role = cdolist_list_var2.first();
      }
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        {
          result_nodes = ConsesLow.cons( bbf_make_node( scene5, $const59$Situation, UNPROVIDED ), result_nodes );
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        while ( NIL != cdolist_list_var_$32)
        {
          ...
          final SubLObject tailnode2 = bbf_make_node( ConsesLow.list( type, role2, scene6 ), $const63$SomethingExisting, ConsesLow.list( $kw64$ACTOR, type, $kw65$ROLE, role2, $kw66$SCENE, scene6 ) );
          final SubLObject headnode2 = bbf_make_node( ConsesLow.list( type, role3, scene7 ), $const63$SomethingExisting, ConsesLow.list( $kw64$ACTOR, type, $kw65$ROLE, role3, $kw66$SCENE, scene7 ) );
          ...
          result_nodes = ConsesLow.cons( tailnode2, result_nodes );
          result_nodes = ConsesLow.cons( headnode2, result_nodes );
          result_edges = ConsesLow.cons( edge, result_edges );
      ...
      while ( NIL != cdolist_list_var3)
      {
        ...
        {
          if( conses_high.getf( edge_1, $kw75$HEAD, UNPROVIDED ).equal( conses_high.getf( edge_2, $kw75$HEAD, UNPROVIDED ) ) && conses_high.getf( edge_1, $kw76$TAIL, UNPROVIDED ).equal( conses_high.getf( edge_2,
              $kw76$TAIL, UNPROVIDED ) ) && !conses_high.getf( edge_1, $kw77$RELATION, UNPROVIDED ).equal( conses_high.getf( edge_2, $kw77$RELATION, UNPROVIDED ) ) )
          {
            if( NIL != genl_predicates.genl_predicateP( conses_high.getf( edge_1, $kw77$RELATION, UNPROVIDED ), conses_high.getf( edge_2, $kw77$RELATION, UNPROVIDED ), UNPROVIDED, UNPROVIDED ) )
            {
              final SubLObject item_var = edge_2;
              if( NIL == conses_high.member( item_var, removed_result_edges, EQUAL, Symbols.symbol_function( IDENTITY ) ) )
              {
                removed_result_edges = ConsesLow.cons( item_var, removed_result_edges );
              }
            }
            else
            {
      ...
      while ( NIL != cdolist_list_var2)
      {
        ...
        {
          new_result_edges = ConsesLow.cons( edge2, new_result_edges );
        }
        cdolist_list_var2 = cdolist_list_var2.rest();
        edge2 = cdolist_list_var2.first();
      }
    ...
    return bbf_make_graph( list_utilities.hash_remove_duplicates( result_nodes, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), list_utilities.hash_remove_duplicates( result_edges, UNPROVIDED, UNPROVIDED, UNPROVIDED,
        UNPROVIDED ), mt.eql( $const78$EverythingPSC ) ? NIL : ConsesLow.list( $kw39$MT, mt ) );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject params = conses_high.getf( arg_plist, $kw81$PARAMS, UNPROVIDED );
    final SubLObject inference_store_id = conses_high.getf( params, $kw82$INFERENCE_STORE_ID, UNPROVIDED );
    final SubLObject inference_id = conses_high.getf( params, $kw83$INFERENCE_ID, UNPROVIDED );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        final SubLObject pred = ( NIL != cycl_variables.el_varP( conses_high.third( var_var_pred ) ) ) ? list_utilities.alist_lookup( v_bindings, conses_high.third( var_var_pred ), UNPROVIDED, UNPROVIDED )
            : conses_high.third( var_var_pred );
        ...
        final SubLObject node_out = bbf_make_node( list_utilities.alist_lookup( v_bindings, conses_high.second( var_var_pred ), UNPROVIDED, UNPROVIDED ), UNPROVIDED, UNPROVIDED );
        final SubLObject mt = conses_high.fourth( var_var_pred );
        final SubLObject type = NIL;
        final SubLObject v_properties = ( NIL != fort_types_interface.commutative_relationP( pred ) ) ? ConsesLow.list( $kw84$DIRECTION, $kw85$UNDIRECTED ) : NIL;
        result_edges = ConsesLow.cons( bbf_make_edge_with_nodes( pred, node_in, node_out, mt, type, v_properties ), result_edges );
    ...
    return bbf_make_graph( list_utilities.hash_remove_duplicates( result_nodes, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), list_utilities.hash_remove_duplicates( result_edges, UNPROVIDED, UNPROVIDED, UNPROVIDED,
        UNPROVIDED ), ( NIL != inference_datastructures_inference.inference_mt( inference ) ) ? ConsesLow.list( $kw39$MT, inference_datastructures_inference.inference_mt( inference ) ) : NIL );
  }
  ...
  public static SubLObject determine_edge_templates_for_inference(final SubLObject inference)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      while ( NIL != cdolist_list_var_$35)
      {
        ...
        if( NIL != forts.fort_p( pred ) && kb_mapping_utilities.fpred_value_in_any_mt( pred, $const87$arg1Isa, UNPROVIDED, UNPROVIDED, UNPROVIDED ).eql( $const88$CycLSentence_Assertible ) )
        {
        ...
        arg1 = list_var.first();
        for( arg1_pos = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), arg1 = list_var.first(), arg1_pos = Numbers.add( ONE_INTEGER, arg1_pos ) )
        {
          ...
          for( arg2_pos = ZERO_INTEGER; NIL != list_var_$36; list_var_$36 = list_var_$36.rest(), arg2 = list_var_$36.first(), arg2_pos = Numbers.add( ONE_INTEGER, arg2_pos ) )
          {
            if( arg1_pos.numL( arg2_pos ) && NIL != cycl_grammar.hl_variable_p( arg1 ) && NIL != cycl_grammar.hl_variable_p( arg2 ) )
            {
              ...
              {
                SubLObject pred_$37 = ( NIL != cycl_grammar.hl_variable_p( cycl_utilities.sentence_arg0( lit_asent ) ) ) ? list_utilities.alist_reverse_lookup( el_bindings, cycl_utilities.sentence_arg0( lit_asent ),
                    UNPROVIDED, UNPROVIDED ) : cycl_utilities.sentence_arg0( lit_asent );
                if( pred_$37.eql( $const89$different ) )
                {
                  pred_$37 = $inference_answers_default_undetermined_relation$.getGlobalValue();
                }
                var_var_pred_map = ConsesLow.cons( ConsesLow.list( el_var1, el_var2, pred_$37, lit_mt ), var_var_pred_map );
              }
            }
          }
        }
      ...
      while ( NIL != cdolist_list_var_$36)
      {
        ...
        for( arg1_pos = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), arg1 = list_var.first(), arg1_pos = Numbers.add( ONE_INTEGER, arg1_pos ) )
        {
          ...
          for( arg2_pos = ZERO_INTEGER; NIL != list_var_$37; list_var_$37 = list_var_$37.rest(), arg2 = list_var_$37.first(), arg2_pos = Numbers.add( ONE_INTEGER, arg2_pos ) )
          {
            if( arg1_pos.numL( arg2_pos ) && NIL != cycl_grammar.hl_variable_p( arg1 ) && NIL != cycl_grammar.hl_variable_p( arg2 ) )
            {
              final SubLObject el_var1 = list_utilities.alist_reverse_lookup( el_bindings, arg1, UNPROVIDED, UNPROVIDED );
              ...
              if( NIL != subl_promotions.memberP( el_var1, free_el_variables, UNPROVIDED, UNPROVIDED ) && NIL != subl_promotions.memberP( el_var2, free_el_variables, UNPROVIDED, UNPROVIDED ) )
              {
                SubLObject pred_$38 = ( NIL != cycl_grammar.hl_variable_p( cycl_utilities.sentence_arg0( lit_asent ) ) ) ? list_utilities.alist_reverse_lookup( el_bindings, cycl_utilities.sentence_arg0( lit_asent ),
                    UNPROVIDED, UNPROVIDED ) : cycl_utilities.sentence_arg0( lit_asent );
                if( pred_$38.eql( $const89$different ) )
                {
                  pred_$38 = $inference_answers_default_undetermined_relation$.getGlobalValue();
                }
                var_var_pred_map = ConsesLow.cons( ConsesLow.list( el_var1, el_var2, pred_$38, lit_mt ), var_var_pred_map );
              }
            }
          }
        }
    ...
    if( NIL == var_var_pred_map )
    {
      ...
      while ( NIL != cdolist_list_var2)
      {
        var_var_pred_map = ConsesLow.cons( ConsesLow.list( focus_el_var, other_el_var, $inference_answers_default_undetermined_relation$.getGlobalValue(), $const78$EverythingPSC ), var_var_pred_map );
        cdolist_list_var2 = cdolist_list_var2.rest();
        other_el_var = cdolist_list_var2.first();
      }
    }
  ...
  public static SubLObject html_determine_edge_templates_for_inference(final SubLObject inference)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_markup( html_utilities.html_align( $kw90$LEFT ) );
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
        ...
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_princ( $str91$Query );
        }
        finally
        {
        ...
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_glyph( $kw92$NBSP, THREE_INTEGER );
        }
        finally
        {
        ...
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_princ( $str93$Edge_Templates );
        }
        finally
        {
      ...
      try
      {
        ...
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_markup( html_utilities.html_align( $kw94$TOP ) );
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
        ...
        try
        {
          ...
          try
          {
            ...
            while ( NIL != cdolist_list_var)
            {
              ...
              cb_utilities.cb_form( var_var_pred.first(), UNPROVIDED, UNPROVIDED );
              html_utilities.html_princ( $str95$_____ );
              cb_utilities.cb_form( conses_high.third( var_var_pred ), UNPROVIDED, UNPROVIDED );
              if( NIL != fort_types_interface.commutative_relationP( conses_high.third( var_var_pred ) ) )
              {
                html_utilities.html_princ( $str95$_____ );
              }
              else
              {
                html_utilities.html_princ( $str96$______ );
              }
              cb_utilities.cb_form( conses_high.second( var_var_pred ), UNPROVIDED, UNPROVIDED );
  ...
  {
    final SubLObject params = conses_high.getf( arg_plist, $kw81$PARAMS, UNPROVIDED );
    final SubLObject store_suid = conses_high.getf( params, $kw99$STORE_SUID, UNPROVIDED );
    final SubLObject inference_suid = conses_high.getf( params, $kw100$INFERENCE_SUID, UNPROVIDED );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      while ( NIL != cdolist_list_var_$51)
      {
        ...
        if( NIL == current )
        {
          result_edges = ConsesLow.cons( blue_literal_to_edge( asent, hl_to_el_var_list, mt ), result_edges );
        }
        else
        {
    ...
    return bbf_make_graph( list_utilities.hash_remove_duplicates( result_nodes, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), list_utilities.hash_remove_duplicates( result_edges, UNPROVIDED, UNPROVIDED, UNPROVIDED,
        UNPROVIDED ), ConsesLow.list( $kw39$MT, inference_mt ) );
  }
  ...
  {
    final SubLObject assertions = conses_high.getf( arg_plist, $kw107$ASSERTIONS, UNPROVIDED );
    SubLObject mt = NIL;
    final SubLObject result_nodes = NIL;
    SubLObject result_edges = NIL;
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        result_edges = ConsesLow.cons( blue_literal_to_edge( neg_lit, hl_to_el_var_list, mt ), result_edges );
      ...
      {
        result_edges = ConsesLow.cons( blue_literal_to_edge( pos_lit, hl_to_el_var_list, mt ), result_edges );
    ...
    return bbf_make_graph( list_utilities.hash_remove_duplicates( result_nodes, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), list_utilities.hash_remove_duplicates( result_edges, UNPROVIDED, UNPROVIDED, UNPROVIDED,
        UNPROVIDED ), ConsesLow.list( $kw39$MT, mt ) );
  }
  ...
  {
    if( NIL != el_utilities.unary_lit_p( lit ) )
    {
      return NIL;
    }
    final SubLObject predicate = cycl_utilities.formula_arg0( lit );
    SubLObject arg1 = el_utilities.literal_arg1( lit, UNPROVIDED );
    SubLObject arg2 = ( NIL != el_utilities.binary_lit_p( lit ) ) ? el_utilities.literal_arg2( lit, UNPROVIDED ) : el_utilities.literal_args( lit, UNPROVIDED ).rest();
    SubLObject list_var = NIL;
    ...
    for( hl_var_id = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), el_var = list_var.first(), hl_var_id = Numbers.add( ONE_INTEGER, hl_var_id ) )
    {
      ...
      arg1 = list_utilities.tree_substitute( ConsesLow.list( arg1 ), hl_var, el_var ).first();
      arg2 = list_utilities.tree_substitute( ConsesLow.list( arg2 ), hl_var, el_var ).first();
    }
  ...
  public static SubLObject make_inference_hl_to_el_var_list(final SubLObject inference)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      final SubLObject hl_var_pos = Numbers.add( ONE_INTEGER, variables.variable_id( hl_var ) );
    ...
    result = ConsesLow.make_list( list_length, UNPROVIDED );
  ...
  {
    return Mapping.mapcar( $sym109$INTERN_EL_VAR, assertions_high.assertion_variable_names( assertion ) );
  }
  ...
  public static SubLObject bbf_make_edge_from_assertion(final SubLObject assertion)
  {
    ...
    return bbf_make_edge( cycl_utilities.formula_arg0( formula ), cycl_utilities.formula_arg1( formula, UNPROVIDED ), cycl_utilities.formula_arg2( formula, UNPROVIDED ), assertions_high.assertion_mt( assertion ),
  ...
  public static SubLObject bbf_make_graph(SubLObject nodes, final SubLObject edges, SubLObject v_properties)
  {
    ...
    if( NIL != edges && NIL == nodes )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        nodes = ConsesLow.cons( conses_high.getf( edge, $kw75$HEAD, UNPROVIDED ), nodes );
        nodes = ConsesLow.cons( conses_high.getf( edge, $kw76$TAIL, UNPROVIDED ), nodes );
        cdolist_list_var = cdolist_list_var.rest();
        edge = cdolist_list_var.first();
      }
      nodes = list_utilities.hash_remove_duplicates( nodes, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
    return ConsesLow.list( $kw110$NODES, nodes, $kw111$EDGES, edges, $kw112$PROPERTIES, v_properties );
  }
  ...
  public static SubLObject bbf_make_edge(final SubLObject pred, final SubLObject arg_in, final SubLObject arg_out, SubLObject mt, SubLObject type, SubLObject arg_in_type, SubLObject arg_out_type, SubLObject v_properties)
  {
    ...
    final SubLObject possible_assertion = kb_indexing.find_gaf_genl_mts( ConsesLow.list( pred, arg_in, arg_out ), mt );
    SubLObject trueP = T;
    SubLObject assertedP = NIL;
    SubLObject strength = $kw113$DEFAULT;
    if( NIL != assertion_handles.assertion_p( possible_assertion ) )
    {
      trueP = ( assertions_high.assertion_truth( possible_assertion ) == $kw114$TRUE ) ? T : NIL;
    ...
    {
      mt = sbhl_search_what_mts.sbhl_max_floor_mts_of_predicate_paths( sbhl_module_vars.get_sbhl_module( pred ), arg_in, arg_out, $const51$True_JustificationTruth ).first();
    }
    return ConsesLow.list( new SubLObject[] { $kw77$RELATION, pred, $kw76$TAIL, bbf_make_node( arg_in, arg_in_type, UNPROVIDED ), $kw75$HEAD, bbf_make_node( arg_out, arg_out_type, UNPROVIDED ), $kw39$MT, mt,
      $kw115$TRUE_, trueP, $kw116$ASSERTED_, assertedP, $kw10$STRENGTH, strength, $kw12$TYPE, type, $kw112$PROPERTIES, v_properties
    } );
  }
  ...
  public static SubLObject bbf_make_edge_with_nodes(final SubLObject pred, final SubLObject node_in, final SubLObject node_out, final SubLObject mt, SubLObject type, SubLObject v_properties)
  {
    ...
    return ConsesLow.list( new SubLObject[] { $kw77$RELATION, pred, $kw76$TAIL, node_in, $kw75$HEAD, node_out, $kw39$MT, mt, $kw12$TYPE, type, $kw112$PROPERTIES, v_properties
    } );
  }
  ...
  public static SubLObject bbf_make_node(final SubLObject v_core, SubLObject type, SubLObject v_properties)
  {
    ...
    return ConsesLow.list( $kw117$CORE, v_core, $kw12$TYPE, type, $kw112$PROPERTIES, v_properties );
  }

  @SubLTranslatedFile.SubL(source = "cycl/blue-grapher-utilities.lisp", position = 46157L)
  public static SubLObject blue_event_dispatcher_runningP()
  {
    return event_utilities.generic_event_dispatcher_process_running_for_application_p( $sym122$_BLUE_EVENT_DISPATCHER_LISTENERS_ );
  }
  ...
  public static SubLObject register_listener_with_blue_event_dispatcher(final SubLObject listener_var)
  {
    ...
    try
    {
      release = Locks.seize_lock( $blue_event_dispatcher_lock$.getGlobalValue() );
      if( NIL == Sequences.find( listener_var, $blue_event_dispatcher_listeners$.getGlobalValue(), EQUALP, UNPROVIDED, UNPROVIDED, UNPROVIDED ) )
      {
        $blue_event_dispatcher_listeners$.setGlobalValue( ConsesLow.cons( listener_var, $blue_event_dispatcher_listeners$.getGlobalValue() ) );
        if( NIL != blue_event_dispatcher_runningP() )
        {
    ...
    finally
    {
      if( NIL != release )
      {
        Locks.release_lock( $blue_event_dispatcher_lock$.getGlobalValue() );
      }
    }
    return listener_var;
  }
  ...
  public static SubLObject deregister_listener_with_blue_event_dispatcher(final SubLObject listener_var)
  {
    ...
    {
      release = Locks.seize_lock( $blue_event_dispatcher_lock$.getGlobalValue() );
      $blue_event_dispatcher_listeners$.setGlobalValue( Sequences.remove( listener_var, $blue_event_dispatcher_listeners$.getGlobalValue(), EQUALP, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
      if( NIL != blue_event_dispatcher_runningP() )
      {
  ...
  {
    return event_utilities.stop_generic_event_dispatcher_process_for_application( $sym122$_BLUE_EVENT_DISPATCHER_LISTENERS_ );
  }

  @SubLTranslatedFile.SubL(source = "cycl/blue-grapher-utilities.lisp", position = 46157L)
  public static SubLObject start_blue_event_dispatcher()
  {
    return event_utilities.start_generic_event_dispatcher_process_for_application( $sym122$_BLUE_EVENT_DISPATCHER_LISTENERS_ );
  }
  ...
  public static SubLObject blue_event(final SubLObject signature, final SubLObject blue_event)
  {
    ...
    final SubLObject event = event_model.new_event( $kw120$BLUE_EVENT, blue_event, signature );
  ...
  {
    return ( v_object.getClass() == $blue_graph_native.class ) ? T : NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/blue-grapher-utilities.lisp", position = 48199L)
  public static SubLObject blue_graph_isg(final SubLObject v_object)
  {
    assert NIL != blue_graph_p( v_object ) : v_object;
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw157$BEGIN, $sym158$MAKE_BLUE_GRAPH, EIGHT_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw159$SLOT, $kw150$ISG, blue_graph_isg( obj ) );
    Functions.funcall( visitor_fn, obj, $kw159$SLOT, $kw151$NODE_LABEL_MAP, blue_graph_node_label_map( obj ) );
    Functions.funcall( visitor_fn, obj, $kw159$SLOT, $kw110$NODES, blue_graph_nodes( obj ) );
    Functions.funcall( visitor_fn, obj, $kw159$SLOT, $kw152$EDGE_LABEL_MAP, blue_graph_edge_label_map( obj ) );
    Functions.funcall( visitor_fn, obj, $kw159$SLOT, $kw111$EDGES, blue_graph_edges( obj ) );
    Functions.funcall( visitor_fn, obj, $kw159$SLOT, $kw153$NODE_DEFINITIONS, blue_graph_node_definitions( obj ) );
    Functions.funcall( visitor_fn, obj, $kw159$SLOT, $kw154$EDGE_DEFINITIONS, blue_graph_edge_definitions( obj ) );
    Functions.funcall( visitor_fn, obj, $kw159$SLOT, $kw155$OPTIONS, blue_graph_options( obj ) );
    Functions.funcall( visitor_fn, obj, $kw160$END, $sym158$MAKE_BLUE_GRAPH, EIGHT_INTEGER );
    return obj;
  }
  ...
  public static SubLObject blue_graph_add_node_type(final SubLObject blue_graph, final SubLObject type, final SubLObject color)
  {
    ...
    dictionary.dictionary_enter( node_definitions, type, ConsesLow.list( $kw162$COLOR, color ) );
    return blue_graph;
  }
  ...
  public static SubLObject blue_graph_add_edge_type(final SubLObject blue_graph, final SubLObject type, final SubLObject color, SubLObject orientation)
  {
    ...
    {
      orientation = $kw113$DEFAULT;
    }
    final SubLObject edge_definitions = blue_graph_edge_definitions( blue_graph );
    dictionary.dictionary_enter( edge_definitions, type, ConsesLow.list( $kw162$COLOR, color, $kw163$ORIENTATION, orientation ) );
    return blue_graph;
  }
  ...
  public static SubLObject blue_graph_add_node(final SubLObject blue_graph, SubLObject type, SubLObject label)
  {
    ...
    final SubLObject node = ConsesLow.list( $kw165$ID, new_id, $kw12$TYPE, type, $kw166$LABEL, label );
  ...
  {
    return conses_high.getf( node, $kw165$ID, UNPROVIDED );
  }
  ...
  {
    return conses_high.getf( node, $kw12$TYPE, $kw113$DEFAULT );
  }
  ...
  {
    return conses_high.getf( node, $kw166$LABEL, $str164$ );
  }
  ...
  {
    return conses_high.getf( edge, $kw167$FROM, UNPROVIDED );
  }
  ...
  {
    return conses_high.getf( edge, $kw168$TO, UNPROVIDED );
  }
  ...
  {
    return conses_high.getf( edge, $kw12$TYPE, $kw113$DEFAULT );
  }
  ...
  {
    return conses_high.getf( edge, $kw166$LABEL, $str164$ );
  }
  ...
  public static SubLObject blue_graph_add_edge(final SubLObject blue_graph, SubLObject from, SubLObject to, SubLObject type, SubLObject label)
  {
    ...
    edge = ConsesLow.list( $kw167$FROM, from, $kw168$TO, to, $kw12$TYPE, type, $kw166$LABEL, label );
  ...
  {
    return ConsesLow.listS( blue_graph_generate_definition_description( blue_graph ), blue_graph_generate_option_description( blue_graph ), ConsesLow.append( blue_graph_generate_node_description( blue_graph ),
        blue_graph_generate_edge_description( blue_graph ), NIL ) );
  }
  ...
  public static SubLObject blue_graph_generate_definition_description(final SubLObject blue_graph)
  {
    ...
    for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( blue_graph_node_definitions( blue_graph ) ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      ...
      thread.resetMultipleValues();
      definitions = ConsesLow.cons( ConsesLow.listS( $kw169$NODE_TYPE, type, ConsesLow.append( definition, NIL ) ), definitions );
    }
    dictionary_contents.do_dictionary_contents_finalize( iteration_state );
    for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( blue_graph_edge_definitions( blue_graph ) ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      thread.resetMultipleValues();
      final SubLObject type = dictionary_contents.do_dictionary_contents_key_value( iteration_state );
      final SubLObject definition = thread.secondMultipleValue();
      thread.resetMultipleValues();
      definitions = ConsesLow.cons( ConsesLow.listS( $kw170$EDGE_TYPE, type, ConsesLow.append( definition, NIL ) ), definitions );
    }
    dictionary_contents.do_dictionary_contents_finalize( iteration_state );
    return ConsesLow.list( $kw171$DEFINITIONS, definitions );
  }
  ...
  public static SubLObject blue_graph_generate_option_description(final SubLObject blue_graph)
  {
    ...
    SubLObject iteration_state;
    for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( blue_graph_options( blue_graph ) ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      thread.resetMultipleValues();
      ...
      thread.resetMultipleValues();
      options = ConsesLow.cons( ConsesLow.list( option, value ), options );
    }
    dictionary_contents.do_dictionary_contents_finalize( iteration_state );
    return ConsesLow.list( $kw155$OPTIONS, options );
  }
  ...
  public static SubLObject blue_graph_generate_node_description(final SubLObject blue_graph)
  {
    ...
    SubLObject iteration_state;
    for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( blue_graph_nodes( blue_graph ) ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      thread.resetMultipleValues();
      ...
      thread.resetMultipleValues();
      nodes = ConsesLow.cons( ConsesLow.list( $kw172$NODE, node ), nodes );
    }
    dictionary_contents.do_dictionary_contents_finalize( iteration_state );
    return nodes;
  }
  ...
  public static SubLObject blue_graph_generate_edge_description(final SubLObject blue_graph)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      edges = ConsesLow.cons( ConsesLow.list( $kw173$EDGE, edge ), edges );
      cdolist_list_var = cdolist_list_var.rest();
      edge = cdolist_list_var.first();
    }
    return edges;
  ...
  {
    final SubLObject params = conses_high.getf( arg_plist, $kw81$PARAMS, UNPROVIDED );
    final SubLObject formula = conses_high.getf( params, $kw176$FORMULA, UNPROVIDED );
    final SubLObject problem_store_id = conses_high.getf( params, $kw177$PROBLEM_STORE_ID, UNPROVIDED );
    final SubLObject inference_id = conses_high.getf( params, $kw83$INFERENCE_ID, UNPROVIDED );
    final SubLObject rtv_clause = list_utilities.tree_find_if( $sym178$RTV_CLAUSE_P, formula, UNPROVIDED );
    ...
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw179$SKIP ) )
    {
      final SubLObject idx_$55 = idx;
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$55, $kw179$SKIP ) )
      {
        ...
        for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
        {
          ...
          if( NIL == id_index.id_index_tombstone_p( inference_answer ) || NIL == id_index.id_index_skip_tombstones_p( $kw179$SKIP ) )
          {
            if( NIL != id_index.id_index_tombstone_p( inference_answer ) )
            {
              inference_answer = $kw179$SKIP;
            }
            ...
            while ( NIL != cdolist_list_var2)
            {
              ...
              while ( NIL != cdolist_list_var_$56)
              {
                ...
                {
                  bbf_edges = ConsesLow.cons( bbf_make_edge_from_assertion( fact ), bbf_edges );
                }
          ...
          while ( Hashtables.iteratorHasNext( cdohash_iterator ))
          {
            ...
            while ( NIL != cdolist_list_var3)
            {
              ...
              while ( NIL != cdolist_list_var_$57)
              {
                ...
                {
                  bbf_edges = ConsesLow.cons( bbf_make_edge_from_assertion( fact2 ), bbf_edges );
                }
    ...
    return bbf_make_graph( NIL, list_utilities.hash_remove_duplicates( bbf_edges, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), ConsesLow.list( $kw39$MT, mt ) );
  }
  ...
  public static SubLObject bbf_rtv_unbound(final SubLObject arg_plist)
  {
    ...
    final SubLObject mt = conses_high.getf( arg_plist, $kw39$MT, UNPROVIDED );
    final SubLObject formula = conses_high.getf( params, $kw176$FORMULA, UNPROVIDED );
    final SubLObject arg1_answers = conses_high.getf( params, $kw181$ARG1_ANSWERS, UNPROVIDED );
    final SubLObject arg2_answers = conses_high.getf( params, $kw182$ARG2_ANSWERS, UNPROVIDED );
    final SubLObject rtv_clause = list_utilities.tree_find_if( $sym178$RTV_CLAUSE_P, formula, UNPROVIDED );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      just_assertions = Sequences.remove_duplicates( removal_modules_rtv.rtv_all_edges_from_node_to_nodes_satisfying( fort, new_formula, preds, depth, mt ), Symbols.symbol_function( EQUAL ), Symbols.symbol_function(
          $sym183$ASSERTION_FORMULA ), UNPROVIDED, UNPROVIDED );
    ...
    return bbf_make_graph( NIL, set.set_element_list( result_links ), ConsesLow.list( $kw39$MT, mt ) );
  }
  ...
  public static SubLObject bbf_rtv_from_inference_new(final SubLObject arg_plist)
  {
    final SubLObject params = conses_high.getf( arg_plist, $kw81$PARAMS, UNPROVIDED );
    final SubLObject formula = conses_high.getf( params, $kw176$FORMULA, UNPROVIDED );
    final SubLObject answers = set_utilities.construct_set_from_list( conses_high.getf( params, $kw185$ANSWERS, UNPROVIDED ), UNPROVIDED, UNPROVIDED );
    final SubLObject problem_store_id = conses_high.getf( params, $kw177$PROBLEM_STORE_ID, UNPROVIDED );
    final SubLObject inference_id = conses_high.getf( params, $kw83$INFERENCE_ID, UNPROVIDED );
    final SubLObject rtv_clause = list_utilities.tree_find_if( $sym178$RTV_CLAUSE_P, formula, UNPROVIDED );
    final SubLObject rtv_preds_list = conses_high.fourth( rtv_clause );
    ...
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw179$SKIP ) )
    {
      ...
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$59, $kw179$SKIP ) )
      {
        ...
        for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
        {
          ...
          if( NIL == id_index.id_index_tombstone_p( inference_answer ) || NIL == id_index.id_index_skip_tombstones_p( $kw179$SKIP ) )
          {
            ...
            answer_terms_set = set_utilities.construct_set_from_list( Mapping.mapcar( Symbols.symbol_function( $sym186$CDR ), inference_datastructures_inference.inference_answer_bindings( inference_answer ) ),
                UNPROVIDED, UNPROVIDED );
            if( NIL != set.non_empty_set_p( set_utilities.set_intersection( ConsesLow.list( answers, answer_terms_set ), UNPROVIDED ) ) )
            {
      ...
      if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$60 ) )
      {
        ...
        try
        {
          while ( Hashtables.iteratorHasNext( cdohash_iterator ))
          {
            ...
            id2 = Hashtables.getEntryKey( cdohash_entry );
            inference_answer2 = Hashtables.getEntryValue( cdohash_entry );
            answer_terms_set = set_utilities.construct_set_from_list( Mapping.mapcar( Symbols.symbol_function( $sym186$CDR ), inference_datastructures_inference.inference_answer_bindings( inference_answer2 ) ),
                UNPROVIDED, UNPROVIDED );
            if( NIL != set.non_empty_set_p( set_utilities.set_intersection( ConsesLow.list( answers, answer_terms_set ), UNPROVIDED ) ) )
            {
    ...
    return bbf_make_graph( NIL, list_utilities.hash_remove_duplicates( set.set_element_list( bbf_edges ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), ConsesLow.list( $kw39$MT, mt ) );
  }
  ...
  {
    SubLFiles.declareMacro( me, "define_blue_filter_fn", "DEFINE-BLUE-FILTER-FN" );
    SubLFiles.declareFunction( me, "blue_filter_fns", "BLUE-FILTER-FNS", 0, 0, false );
    SubLFiles.declareFunction( me, "get_blue_filter_fn_data", "GET-BLUE-FILTER-FN-DATA", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_filter_fn_p", "BLUE-FILTER-FN-P", 1, 0, false );
    SubLFiles.declareFunction( me, "get_blue_filter_fn_cost", "GET-BLUE-FILTER-FN-COST", 1, 0, false );
    SubLFiles.declareFunction( me, "get_blue_filter_fn_strength", "GET-BLUE-FILTER-FN-STRENGTH", 1, 0, false );
    SubLFiles.declareFunction( me, "get_blue_filter_fn_type", "GET-BLUE-FILTER-FN-TYPE", 1, 0, false );
    SubLFiles.declareFunction( me, "apply_blue_filter_fn", "APPLY-BLUE-FILTER-FN", 3, 1, false );
    SubLFiles.declareFunction( me, "blue_filter_fns_sorted", "BLUE-FILTER-FNS-SORTED", 0, 1, false );
    SubLFiles.declareFunction( me, "blue_apply_filter_fns", "BLUE-APPLY-FILTER-FNS", 3, 1, false );
    SubLFiles.declareFunction( me, "blue_filter_fn_keys", "BLUE-FILTER-FN-KEYS", 0, 1, false );
    SubLFiles.declareFunction( me, "blue_filter_fn_by_key", "BLUE-FILTER-FN-BY-KEY", 1, 0, false );
    SubLFiles.declareFunction( me, "bff_arbitrary_unions", "BFF-ARBITRARY-UNIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "bff_cyc_kb_subset_collections", "BFF-CYC-KB-SUBSET-COLLECTIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "bff_most_general_5", "BFF-MOST-GENERAL-5", 2, 0, false );
    SubLFiles.declareFunction( me, "bff_most_general_10", "BFF-MOST-GENERAL-10", 2, 0, false );
    SubLFiles.declareFunction( me, "bff_most_general_20", "BFF-MOST-GENERAL-20", 2, 0, false );
    SubLFiles.declareMacro( me, "define_blue_builder_fn", "DEFINE-BLUE-BUILDER-FN" );
    SubLFiles.declareFunction( me, "get_blue_builder_fn_data", "GET-BLUE-BUILDER-FN-DATA", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_builder_fn_p", "BLUE-BUILDER-FN-P", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_builder", "BLUE-BUILDER", 2, 0, false );
    SubLFiles.declareFunction( me, "blue_builder_fn_keys", "BLUE-BUILDER-FN-KEYS", 0, 0, false );
    SubLFiles.declareFunction( me, "blue_builder_fn_by_key", "BLUE-BUILDER-FN-BY-KEY", 1, 0, false );
    SubLFiles.declareFunction( me, "get_blue_builder_fn_def_value", "GET-BLUE-BUILDER-FN-DEF-VALUE", 2, 0, false );
    SubLFiles.declareFunction( me, "bbf_forward_true", "BBF-FORWARD-TRUE", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_forward_true_internal", "BBF-FORWARD-TRUE-INTERNAL", 5, 1, false );
    SubLFiles.declareFunction( me, "bbf_backward_true", "BBF-BACKWARD-TRUE", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_backward_true_internal", "BBF-BACKWARD-TRUE-INTERNAL", 5, 1, false );
    SubLFiles.declareFunction( me, "bbf_min_forward_true", "BBF-MIN-FORWARD-TRUE", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_min_forward_true_internal", "BBF-MIN-FORWARD-TRUE-INTERNAL", 5, 1, false );
    SubLFiles.declareFunction( me, "bbf_min_backward_true", "BBF-MIN-BACKWARD-TRUE", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_min_backward_true_internal", "BBF-MIN-BACKWARD-TRUE-INTERNAL", 5, 1, false );
    SubLFiles.declareFunction( me, "bbf_min_ceilings_forward_true", "BBF-MIN-CEILINGS-FORWARD-TRUE", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_min_ceilings_forward_true_internal", "BBF-MIN-CEILINGS-FORWARD-TRUE-INTERNAL", 5, 1, false );
    SubLFiles.declareFunction( me, "bbf_min_forward_and_backward_true", "BBF-MIN-FORWARD-AND-BACKWARD-TRUE", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_min_forward_and_backward_true_internal", "BBF-MIN-FORWARD-AND-BACKWARD-TRUE-INTERNAL", 5, 0, false );
    SubLFiles.declareFunction( me, "bbf_min_forward_and_backward_true_internal_internal", "BBF-MIN-FORWARD-AND-BACKWARD-TRUE-INTERNAL-INTERNAL", 5, 2, false );
    SubLFiles.declareFunction( me, "bbf_script", "BBF-SCRIPT", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_inference_answers", "BBF-INFERENCE-ANSWERS", 1, 0, false );
    SubLFiles.declareFunction( me, "determine_edge_templates_for_inference", "DETERMINE-EDGE-TEMPLATES-FOR-INFERENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "html_determine_edge_templates_for_inference", "HTML-DETERMINE-EDGE-TEMPLATES-FOR-INFERENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_inference", "BBF-INFERENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_rule", "BBF-RULE", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_literal_to_edge", "BLUE-LITERAL-TO-EDGE", 3, 0, false );
    SubLFiles.declareFunction( me, "make_inference_hl_to_el_var_list", "MAKE-INFERENCE-HL-TO-EL-VAR-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "make_assertion_hl_to_el_var_list", "MAKE-ASSERTION-HL-TO-EL-VAR-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_make_edge_from_assertion", "BBF-MAKE-EDGE-FROM-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_make_graph", "BBF-MAKE-GRAPH", 2, 1, false );
    SubLFiles.declareFunction( me, "bbf_make_edge", "BBF-MAKE-EDGE", 4, 4, false );
    SubLFiles.declareFunction( me, "bbf_make_edge_with_nodes", "BBF-MAKE-EDGE-WITH-NODES", 4, 2, false );
    SubLFiles.declareFunction( me, "bbf_make_node", "BBF-MAKE-NODE", 1, 2, false );
    SubLFiles.declareFunction( me, "blue_event_dispatcher_runningP", "BLUE-EVENT-DISPATCHER-RUNNING?", 0, 0, false );
    SubLFiles.declareFunction( me, "ensure_blue_event_dispatcher_running", "ENSURE-BLUE-EVENT-DISPATCHER-RUNNING", 0, 0, false );
    SubLFiles.declareFunction( me, "register_listener_with_blue_event_dispatcher", "REGISTER-LISTENER-WITH-BLUE-EVENT-DISPATCHER", 1, 0, false );
    SubLFiles.declareFunction( me, "deregister_listener_with_blue_event_dispatcher", "DEREGISTER-LISTENER-WITH-BLUE-EVENT-DISPATCHER", 1, 0, false );
    SubLFiles.declareFunction( me, "stop_blue_event_dispatcher", "STOP-BLUE-EVENT-DISPATCHER", 0, 0, false );
    SubLFiles.declareFunction( me, "start_blue_event_dispatcher", "START-BLUE-EVENT-DISPATCHER", 0, 0, false );
    SubLFiles.declareFunction( me, "blue_event", "BLUE-EVENT", 2, 0, false );
    SubLFiles.declareFunction( me, "blue_fetch_event", "BLUE-FETCH-EVENT", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_fetch_uia_blue_event", "BLUE-FETCH-UIA-BLUE-EVENT", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_current_message_mailbox_suite", "BLUE-CURRENT-MESSAGE-MAILBOX-SUITE", 0, 0, false );
    SubLFiles.declareFunction( me, "blue_ensure_blue_event_address", "BLUE-ENSURE-BLUE-EVENT-ADDRESS", 1, 0, false );
    SubLFiles.declareFunction( me, "map_blue_event_to_mailbox", "MAP-BLUE-EVENT-TO-MAILBOX", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_map_event_to_blue_event", "BLUE-MAP-EVENT-TO-BLUE-EVENT", 1, 1, false );
    SubLFiles.declareFunction( me, "blue_graph_print_function_trampoline", "BLUE-GRAPH-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_p", "BLUE-GRAPH-P", 1, 0, false );
    new $blue_graph_p$UnaryFunction();
    SubLFiles.declareFunction( me, "blue_graph_isg", "BLUE-GRAPH-ISG", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_node_label_map", "BLUE-GRAPH-NODE-LABEL-MAP", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_nodes", "BLUE-GRAPH-NODES", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_edge_label_map", "BLUE-GRAPH-EDGE-LABEL-MAP", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_edges", "BLUE-GRAPH-EDGES", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_node_definitions", "BLUE-GRAPH-NODE-DEFINITIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_edge_definitions", "BLUE-GRAPH-EDGE-DEFINITIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_options", "BLUE-GRAPH-OPTIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_blue_graph_isg", "_CSETF-BLUE-GRAPH-ISG", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_blue_graph_node_label_map", "_CSETF-BLUE-GRAPH-NODE-LABEL-MAP", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_blue_graph_nodes", "_CSETF-BLUE-GRAPH-NODES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_blue_graph_edge_label_map", "_CSETF-BLUE-GRAPH-EDGE-LABEL-MAP", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_blue_graph_edges", "_CSETF-BLUE-GRAPH-EDGES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_blue_graph_node_definitions", "_CSETF-BLUE-GRAPH-NODE-DEFINITIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_blue_graph_edge_definitions", "_CSETF-BLUE-GRAPH-EDGE-DEFINITIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_blue_graph_options", "_CSETF-BLUE-GRAPH-OPTIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "make_blue_graph", "MAKE-BLUE-GRAPH", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_blue_graph", "VISIT-DEFSTRUCT-BLUE-GRAPH", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_blue_graph_method", "VISIT-DEFSTRUCT-OBJECT-BLUE-GRAPH-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "new_blue_graph", "NEW-BLUE-GRAPH", 0, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_add_node_type", "BLUE-GRAPH-ADD-NODE-TYPE", 3, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_add_edge_type", "BLUE-GRAPH-ADD-EDGE-TYPE", 3, 1, false );
    SubLFiles.declareFunction( me, "blue_graph_add_option", "BLUE-GRAPH-ADD-OPTION", 3, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_add_node", "BLUE-GRAPH-ADD-NODE", 1, 2, false );
    SubLFiles.declareFunction( me, "blue_graph_node_p", "BLUE-GRAPH-NODE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_maybe_add_node", "BLUE-GRAPH-MAYBE-ADD-NODE", 2, 1, false );
    SubLFiles.declareFunction( me, "blue_graph_node_get_id", "BLUE-GRAPH-NODE-GET-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_node_get_type", "BLUE-GRAPH-NODE-GET-TYPE", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_node_get_label", "BLUE-GRAPH-NODE-GET-LABEL", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_get_node", "BLUE-GRAPH-GET-NODE", 2, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_get_node_by_label", "BLUE-GRAPH-GET-NODE-BY-LABEL", 2, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_resolve_node_label_reference", "BLUE-GRAPH-RESOLVE-NODE-LABEL-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_edge_from", "BLUE-GRAPH-EDGE-FROM", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_edge_to", "BLUE-GRAPH-EDGE-TO", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_edge_get_type", "BLUE-GRAPH-EDGE-GET-TYPE", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_edge_get_label", "BLUE-GRAPH-EDGE-GET-LABEL", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_add_edge", "BLUE-GRAPH-ADD-EDGE", 3, 2, false );
    SubLFiles.declareFunction( me, "blue_graph_next_id", "BLUE-GRAPH-NEXT-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_generate_description", "BLUE-GRAPH-GENERATE-DESCRIPTION", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_generate_definition_description", "BLUE-GRAPH-GENERATE-DEFINITION-DESCRIPTION", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_generate_option_description", "BLUE-GRAPH-GENERATE-OPTION-DESCRIPTION", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_generate_node_description", "BLUE-GRAPH-GENERATE-NODE-DESCRIPTION", 1, 0, false );
    SubLFiles.declareFunction( me, "blue_graph_generate_edge_description", "BLUE-GRAPH-GENERATE-EDGE-DESCRIPTION", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_rtv_from_inference", "BBF-RTV-FROM-INFERENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_rtv_unbound", "BBF-RTV-UNBOUND", 1, 0, false );
    SubLFiles.declareFunction( me, "bbf_rtv_from_inference_new", "BBF-RTV-FROM-INFERENCE-NEW", 1, 0, false );
    SubLFiles.declareFunction( me, "valid_rtv_justificationP", "VALID-RTV-JUSTIFICATION?", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_rtv_irrelevant_justifications", "REMOVE-RTV-IRRELEVANT-JUSTIFICATIONS", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_blue_grapher_utilities_file()
  {
    $blue_filter_fns$ = SubLFiles.deflexical( "*BLUE-FILTER-FNS*", maybeDefault( $sym0$_BLUE_FILTER_FNS_, $blue_filter_fns$, () -> ( Hashtables.make_hash_table( SIXTEEN_INTEGER, UNPROVIDED, UNPROVIDED ) ) ) );
    $default_blue_filter_fn_cost$ = SubLFiles.deflexical( "*DEFAULT-BLUE-FILTER-FN-COST*", ( maybeDefault( $sym7$_DEFAULT_BLUE_FILTER_FN_COST_, $default_blue_filter_fn_cost$, ZERO_INTEGER ) ) );
    $default_blue_filter_fn_strength$ = SubLFiles.deflexical( "*DEFAULT-BLUE-FILTER-FN-STRENGTH*", ( maybeDefault( $sym9$_DEFAULT_BLUE_FILTER_FN_STRENGTH_, $default_blue_filter_fn_strength$, ZERO_INTEGER ) ) );
    $default_blue_filter_fn_type$ = SubLFiles.deflexical( "*DEFAULT-BLUE-FILTER-FN-TYPE*", ( maybeDefault( $sym11$_DEFAULT_BLUE_FILTER_FN_TYPE_, $default_blue_filter_fn_type$, NIL ) ) );
    $blue_builder_fns$ = SubLFiles.deflexical( "*BLUE-BUILDER-FNS*", maybeDefault( $sym29$_BLUE_BUILDER_FNS_, $blue_builder_fns$, () -> ( Hashtables.make_hash_table( SIXTEEN_INTEGER, UNPROVIDED, UNPROVIDED ) ) ) );
    $blue_builder_fn_to_deflist_hash$ = SubLFiles.deflexical( "*BLUE-BUILDER-FN-TO-DEFLIST-HASH*", maybeDefault( $sym30$_BLUE_BUILDER_FN_TO_DEFLIST_HASH_, $blue_builder_fn_to_deflist_hash$, () -> ( Hashtables
        .make_hash_table( SIXTEEN_INTEGER, UNPROVIDED, UNPROVIDED ) ) ) );
    $inference_answers_default_undetermined_relation$ = SubLFiles.deflexical( "*INFERENCE-ANSWERS-DEFAULT-UNDETERMINED-RELATION*", $const86$conceptuallyRelated );
    $blue_event_dispatcher_lock$ = SubLFiles.deflexical( "*BLUE-EVENT-DISPATCHER-LOCK*", Locks.make_lock( $str121$BLUE_EVENT_DISPATCHER_Lock ) );
    $blue_event_dispatcher_listeners$ = SubLFiles.deflexical( "*BLUE-EVENT-DISPATCHER-LISTENERS*", ( maybeDefault( $sym122$_BLUE_EVENT_DISPATCHER_LISTENERS_, $blue_event_dispatcher_listeners$, NIL ) ) );
    $blue_message_mailbox_suite$ = SubLFiles.defparameter( "*BLUE-MESSAGE-MAILBOX-SUITE*", message_mailboxes.new_message_mailbox_suite() );
    $blue_event_to_blue_event_listener$ = SubLFiles.deflexical( "*BLUE-EVENT-TO-BLUE-EVENT-LISTENER*", event_broker.describe_funcall_listener( $kw120$BLUE_EVENT, $sym124$BLUE_MAP_EVENT_TO_BLUE_EVENT, UNPROVIDED,
        UNPROVIDED ) );
    $dtp_blue_graph$ = SubLFiles.defconstant( "*DTP-BLUE-GRAPH*", $sym125$BLUE_GRAPH );
    return NIL;
  }

  public static SubLObject setup_blue_grapher_utilities_file()
  {
    subl_macro_promotions.declare_defglobal( $sym0$_BLUE_FILTER_FNS_ );
    subl_macro_promotions.declare_defglobal( $sym7$_DEFAULT_BLUE_FILTER_FN_COST_ );
    subl_macro_promotions.declare_defglobal( $sym9$_DEFAULT_BLUE_FILTER_FN_STRENGTH_ );
    subl_macro_promotions.declare_defglobal( $sym11$_DEFAULT_BLUE_FILTER_FN_TYPE_ );
    Hashtables.sethash( $sym17$BFF_ARBITRARY_UNIONS, $blue_filter_fns$.getGlobalValue(), $list18 );
    utilities_macros.register_api_predefined_function( $sym17$BFF_ARBITRARY_UNIONS );
    Hashtables.sethash( $sym20$BFF_CYC_KB_SUBSET_COLLECTIONS, $blue_filter_fns$.getGlobalValue(), $list18 );
    utilities_macros.register_api_predefined_function( $sym20$BFF_CYC_KB_SUBSET_COLLECTIONS );
    Hashtables.sethash( $sym22$BFF_MOST_GENERAL_5, $blue_filter_fns$.getGlobalValue(), $list23 );
    utilities_macros.register_api_predefined_function( $sym22$BFF_MOST_GENERAL_5 );
    Hashtables.sethash( $sym25$BFF_MOST_GENERAL_10, $blue_filter_fns$.getGlobalValue(), $list26 );
    utilities_macros.register_api_predefined_function( $sym25$BFF_MOST_GENERAL_10 );
    Hashtables.sethash( $sym27$BFF_MOST_GENERAL_20, $blue_filter_fns$.getGlobalValue(), $list28 );
    utilities_macros.register_api_predefined_function( $sym27$BFF_MOST_GENERAL_20 );
    subl_macro_promotions.declare_defglobal( $sym29$_BLUE_BUILDER_FNS_ );
    subl_macro_promotions.declare_defglobal( $sym30$_BLUE_BUILDER_FN_TO_DEFLIST_HASH_ );
    Hashtables.sethash( $sym35$BBF_FORWARD_TRUE, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym35$BBF_FORWARD_TRUE, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list36 );
    utilities_macros.register_api_predefined_function( $sym35$BBF_FORWARD_TRUE );
    Hashtables.sethash( $sym43$BBF_BACKWARD_TRUE, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym43$BBF_BACKWARD_TRUE, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list44 );
    utilities_macros.register_api_predefined_function( $sym43$BBF_BACKWARD_TRUE );
    Hashtables.sethash( $sym45$BBF_MIN_FORWARD_TRUE, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym45$BBF_MIN_FORWARD_TRUE, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list46 );
    utilities_macros.register_api_predefined_function( $sym45$BBF_MIN_FORWARD_TRUE );
    Hashtables.sethash( $sym47$BBF_MIN_BACKWARD_TRUE, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym47$BBF_MIN_BACKWARD_TRUE, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list48 );
    utilities_macros.register_api_predefined_function( $sym47$BBF_MIN_BACKWARD_TRUE );
    Hashtables.sethash( $sym49$BBF_MIN_CEILINGS_FORWARD_TRUE, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym49$BBF_MIN_CEILINGS_FORWARD_TRUE, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list50 );
    utilities_macros.register_api_predefined_function( $sym49$BBF_MIN_CEILINGS_FORWARD_TRUE );
    Hashtables.sethash( $sym52$BBF_MIN_FORWARD_AND_BACKWARD_TRUE, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym52$BBF_MIN_FORWARD_AND_BACKWARD_TRUE, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list53 );
    utilities_macros.register_api_predefined_function( $sym52$BBF_MIN_FORWARD_AND_BACKWARD_TRUE );
    Hashtables.sethash( $sym56$BBF_SCRIPT, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym56$BBF_SCRIPT, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list57 );
    utilities_macros.register_api_predefined_function( $sym56$BBF_SCRIPT );
    Hashtables.sethash( $sym79$BBF_INFERENCE_ANSWERS, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym79$BBF_INFERENCE_ANSWERS, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list80 );
    utilities_macros.register_api_predefined_function( $sym79$BBF_INFERENCE_ANSWERS );
    Hashtables.sethash( $sym97$BBF_INFERENCE, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym97$BBF_INFERENCE, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list98 );
    utilities_macros.register_api_predefined_function( $sym97$BBF_INFERENCE );
    Hashtables.sethash( $sym105$BBF_RULE, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym105$BBF_RULE, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list106 );
    utilities_macros.register_api_predefined_function( $sym105$BBF_RULE );
    event_model.register_event_class( $kw118$BLUE_GRAPHER_BASE_EVENT, $kw119$CYC_APPLICATION_EVENT, NIL );
    event_model.register_event_class( $kw120$BLUE_EVENT, $kw118$BLUE_GRAPHER_BASE_EVENT, NIL );
    subl_macro_promotions.declare_defglobal( $sym122$_BLUE_EVENT_DISPATCHER_LISTENERS_ );
    access_macros.register_external_symbol( $sym123$BLUE_FETCH_EVENT );
    register_listener_with_blue_event_dispatcher( $blue_event_to_blue_event_listener$.getGlobalValue() );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_blue_graph$.getGlobalValue(), Symbols.symbol_function( $sym132$BLUE_GRAPH_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list133 );
    Structures.def_csetf( $sym134$BLUE_GRAPH_ISG, $sym135$_CSETF_BLUE_GRAPH_ISG );
    Structures.def_csetf( $sym136$BLUE_GRAPH_NODE_LABEL_MAP, $sym137$_CSETF_BLUE_GRAPH_NODE_LABEL_MAP );
    Structures.def_csetf( $sym138$BLUE_GRAPH_NODES, $sym139$_CSETF_BLUE_GRAPH_NODES );
    Structures.def_csetf( $sym140$BLUE_GRAPH_EDGE_LABEL_MAP, $sym141$_CSETF_BLUE_GRAPH_EDGE_LABEL_MAP );
    Structures.def_csetf( $sym142$BLUE_GRAPH_EDGES, $sym143$_CSETF_BLUE_GRAPH_EDGES );
    Structures.def_csetf( $sym144$BLUE_GRAPH_NODE_DEFINITIONS, $sym145$_CSETF_BLUE_GRAPH_NODE_DEFINITIONS );
    Structures.def_csetf( $sym146$BLUE_GRAPH_EDGE_DEFINITIONS, $sym147$_CSETF_BLUE_GRAPH_EDGE_DEFINITIONS );
    Structures.def_csetf( $sym148$BLUE_GRAPH_OPTIONS, $sym149$_CSETF_BLUE_GRAPH_OPTIONS );
    Equality.identity( $sym125$BLUE_GRAPH );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_blue_graph$.getGlobalValue(), Symbols.symbol_function( $sym161$VISIT_DEFSTRUCT_OBJECT_BLUE_GRAPH_METHOD ) );
    Hashtables.sethash( $sym174$BBF_RTV_FROM_INFERENCE, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym174$BBF_RTV_FROM_INFERENCE, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list175 );
    utilities_macros.register_api_predefined_function( $sym174$BBF_RTV_FROM_INFERENCE );
    Hashtables.sethash( $sym180$BBF_RTV_UNBOUND, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym180$BBF_RTV_UNBOUND, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list175 );
    utilities_macros.register_api_predefined_function( $sym180$BBF_RTV_UNBOUND );
    Hashtables.sethash( $sym184$BBF_RTV_FROM_INFERENCE_NEW, $blue_builder_fns$.getGlobalValue(), T );
    Hashtables.sethash( $sym184$BBF_RTV_FROM_INFERENCE_NEW, $blue_builder_fn_to_deflist_hash$.getGlobalValue(), $list175 );
    utilities_macros.register_api_predefined_function( $sym184$BBF_RTV_FROM_INFERENCE_NEW );
    return NIL;
  }
  ...
  static
  {
    me = new blue_grapher_utilities();
    $blue_filter_fns$ = null;
    $default_blue_filter_fn_cost$ = null;
    $default_blue_filter_fn_strength$ = null;
    $default_blue_filter_fn_type$ = null;
    $blue_builder_fns$ = null;
    $blue_builder_fn_to_deflist_hash$ = null;
    $inference_answers_default_undetermined_relation$ = null;
    $blue_event_dispatcher_lock$ = null;
    $blue_event_dispatcher_listeners$ = null;
    $blue_message_mailbox_suite$ = null;
    $blue_event_to_blue_event_listener$ = null;
    $dtp_blue_graph$ = null;
    $sym0$_BLUE_FILTER_FNS_ = makeSymbol( "*BLUE-FILTER-FNS*" );
    $list1 = ConsesLow.list( makeSymbol( "NAME" ), makeSymbol( "ARGLIST" ), makeSymbol( "DEFLIST" ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym2$PROGN = makeSymbol( "PROGN" );
    $sym3$SETHASH = makeSymbol( "SETHASH" );
    $sym4$QUOTE = makeSymbol( "QUOTE" );
    $sym5$DEFINE_PROTECTED = makeSymbol( "DEFINE-PROTECTED" );
    $sym6$REGISTER_API_PREDEFINED_FUNCTION = makeSymbol( "REGISTER-API-PREDEFINED-FUNCTION" );
    $sym7$_DEFAULT_BLUE_FILTER_FN_COST_ = makeSymbol( "*DEFAULT-BLUE-FILTER-FN-COST*" );
    $kw8$COST = makeKeyword( "COST" );
    $sym9$_DEFAULT_BLUE_FILTER_FN_STRENGTH_ = makeSymbol( "*DEFAULT-BLUE-FILTER-FN-STRENGTH*" );
    $kw10$STRENGTH = makeKeyword( "STRENGTH" );
    $sym11$_DEFAULT_BLUE_FILTER_FN_TYPE_ = makeSymbol( "*DEFAULT-BLUE-FILTER-FN-TYPE*" );
    $kw12$TYPE = makeKeyword( "TYPE" );
    $str13$APPLY_BLUE_FILTER_FN___A_is_not_a = makeString( "APPLY-BLUE-FILTER-FN: ~A is not a blue-filter-fn-p" );
    $sym14$_ = makeSymbol( "<" );
    $sym15$GET_BLUE_FILTER_FN_STRENGTH = makeSymbol( "GET-BLUE-FILTER-FN-STRENGTH" );
    $sym16$MAKE_KEYWORD = makeSymbol( "MAKE-KEYWORD" );
    $sym17$BFF_ARBITRARY_UNIONS = makeSymbol( "BFF-ARBITRARY-UNIONS" );
    $list18 = ConsesLow.list( makeKeyword( "COST" ), ONE_INTEGER, makeKeyword( "STRENGTH" ), TEN_INTEGER );
    $const19$ArbitraryUnion = constant_handles.reader_make_constant_shell( makeString( "ArbitraryUnion" ) );
    $sym20$BFF_CYC_KB_SUBSET_COLLECTIONS = makeSymbol( "BFF-CYC-KB-SUBSET-COLLECTIONS" );
    $const21$CycKBSubsetCollection = constant_handles.reader_make_constant_shell( makeString( "CycKBSubsetCollection" ) );
    $sym22$BFF_MOST_GENERAL_5 = makeSymbol( "BFF-MOST-GENERAL-5" );
    $list23 = ConsesLow.list( makeKeyword( "COST" ), ONE_INTEGER, makeKeyword( "STRENGTH" ), makeInteger( 500 ), makeKeyword( "TYPE" ), makeKeyword( "POST-MINIMIZATION" ) );
    $sym24$GENERALITY_ESTIMATE_ = makeSymbol( "GENERALITY-ESTIMATE>" );
    $sym25$BFF_MOST_GENERAL_10 = makeSymbol( "BFF-MOST-GENERAL-10" );
    $list26 = ConsesLow.list( makeKeyword( "COST" ), ONE_INTEGER, makeKeyword( "STRENGTH" ), makeInteger( 1000 ), makeKeyword( "TYPE" ), makeKeyword( "POST-MINIMIZATION" ) );
    $sym27$BFF_MOST_GENERAL_20 = makeSymbol( "BFF-MOST-GENERAL-20" );
    $list28 = ConsesLow.list( makeKeyword( "COST" ), ONE_INTEGER, makeKeyword( "STRENGTH" ), makeInteger( 2000 ), makeKeyword( "TYPE" ), makeKeyword( "POST-MINIMIZATION" ) );
    $sym29$_BLUE_BUILDER_FNS_ = makeSymbol( "*BLUE-BUILDER-FNS*" );
    $sym30$_BLUE_BUILDER_FN_TO_DEFLIST_HASH_ = makeSymbol( "*BLUE-BUILDER-FN-TO-DEFLIST-HASH*" );
    $list31 = ConsesLow.list( makeSymbol( "*BLUE-BUILDER-FNS*" ), T );
    $str32$BLUE_BUILDER___A_is_not_a_blue_bu = makeString( "BLUE-BUILDER: ~A is not a blue-builder-fn-p" );
    $sym33$STRING_ = makeSymbol( "STRING<" );
    $sym34$SYMBOL_NAME = makeSymbol( "SYMBOL-NAME" );
    $sym35$BBF_FORWARD_TRUE = makeSymbol( "BBF-FORWARD-TRUE" );
    $list36 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString( "Show forward edges from FORTS (nodes) through PREDS (edges) in MT to DEPTH.  (Forts failing FILTER-FNS are not shown.)" ) );
    $kw37$PREDS = makeKeyword( "PREDS" );
    $kw38$FORTS = makeKeyword( "FORTS" );
    $kw39$MT = makeKeyword( "MT" );
    $kw40$FILTER_FNS = makeKeyword( "FILTER-FNS" );
    $kw41$DEPTH = makeKeyword( "DEPTH" );
    $kw42$POST_MINIMIZATION = makeKeyword( "POST-MINIMIZATION" );
    $sym43$BBF_BACKWARD_TRUE = makeSymbol( "BBF-BACKWARD-TRUE" );
    $list44 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString( "Show backward edges from FORTS (nodes) through PREDS (edges) in MT to DEPTH.  (Forts failing FILTER-FNS are not shown.)" ) );
    $sym45$BBF_MIN_FORWARD_TRUE = makeSymbol( "BBF-MIN-FORWARD-TRUE" );
    $list46 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString( "Show minimum forward edges from FORTS (nodes) through PREDS (edges) in MT to DEPTH.  (Forts failing FILTER-FNS are not shown.)" ) );
    $sym47$BBF_MIN_BACKWARD_TRUE = makeSymbol( "BBF-MIN-BACKWARD-TRUE" );
    $list48 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString( "Show minimum backward edges from FORTS (nodes) through PREDS (edges) in MT to DEPTH.  (Forts failing FILTER-FNS are not shown.)" ) );
    $sym49$BBF_MIN_CEILINGS_FORWARD_TRUE = makeSymbol( "BBF-MIN-CEILINGS-FORWARD-TRUE" );
    $list50 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString(
        "Show the minimal ceilings of all forward edges from FORTS (nodes) through PREDS (edges) in MT and iterate DEPTH times.  (Forts failing FILTER-FNS are not shown.) (EXPERIMENTAL)" ) );
    $const51$True_JustificationTruth = constant_handles.reader_make_constant_shell( makeString( "True-JustificationTruth" ) );
    $sym52$BBF_MIN_FORWARD_AND_BACKWARD_TRUE = makeSymbol( "BBF-MIN-FORWARD-AND-BACKWARD-TRUE" );
    $list53 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString(
        "Show minimum forward and backward edges from FORTS (nodes) through PREDS (edges) in MT to DEPTH.  (Forts failing FILTER-FNS are not shown.)  (Note that this is *expensive* for higher depths) (EXPERIMENTAL)" ) );
    $int54$32 = makeInteger( 32 );
    $sym55$APPEND = makeSymbol( "APPEND" );
    $sym56$BBF_SCRIPT = makeSymbol( "BBF-SCRIPT" );
    $list57 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString(
        "Create a graph representation of a script (a spec of #$Situation) that shows the temporal ordering of scenes and the actors and roles involved in each scene.  FORTS must be a singleton containing the script term." ) );
    $const58$CurrentWorldDataCollectorMt_NonHo = constant_handles.reader_make_constant_shell( makeString( "CurrentWorldDataCollectorMt-NonHomocentric" ) );
    $const59$Situation = constant_handles.reader_make_constant_shell( makeString( "Situation" ) );
    $list60 = ConsesLow.list( TWO_INTEGER, THREE_INTEGER );
    $sym61$TERNARY_PREDICATE_ = makeSymbol( "TERNARY-PREDICATE?" );
    $const62$QuasiTemporalSubSituationTypesPre = constant_handles.reader_make_constant_shell( makeString( "QuasiTemporalSubSituationTypesPredicate" ) );
    $const63$SomethingExisting = constant_handles.reader_make_constant_shell( makeString( "SomethingExisting" ) );
    $kw64$ACTOR = makeKeyword( "ACTOR" );
    $kw65$ROLE = makeKeyword( "ROLE" );
    $kw66$SCENE = makeKeyword( "SCENE" );
    $kw67$ORIGINAL_PREDICATE = makeKeyword( "ORIGINAL-PREDICATE" );
    $list68 = ConsesLow.list( TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER );
    $const69$SituationTypeRelation_BasicActorT = constant_handles.reader_make_constant_shell( makeString( "SituationTypeRelation-BasicActorTypesAndRolesForSubSitTypes" ) );
    $const70$individualPlaysRoleInSubSituation = constant_handles.reader_make_constant_shell( makeString( "individualPlaysRoleInSubSituationType" ) );
    $const71$Individual = constant_handles.reader_make_constant_shell( makeString( "Individual" ) );
    $const72$SituationTypeRelation_SitTypeToSu = constant_handles.reader_make_constant_shell( makeString( "SituationTypeRelation-SitTypeToSubSitTypeBasic" ) );
    $list73 = ConsesLow.list( TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER, FIVE_INTEGER, SIX_INTEGER );
    $const74$GraphicallyEditableRoleMappingPre = constant_handles.reader_make_constant_shell( makeString( "GraphicallyEditableRoleMappingPredicate" ) );
    $kw75$HEAD = makeKeyword( "HEAD" );
    $kw76$TAIL = makeKeyword( "TAIL" );
    $kw77$RELATION = makeKeyword( "RELATION" );
    $const78$EverythingPSC = constant_handles.reader_make_constant_shell( makeString( "EverythingPSC" ) );
    $sym79$BBF_INFERENCE_ANSWERS = makeSymbol( "BBF-INFERENCE-ANSWERS" );
    $list80 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString( "Graph the results of an inference by graphing the GAFs the result when filling in the bindings back into the query." ) );
    $kw81$PARAMS = makeKeyword( "PARAMS" );
    $kw82$INFERENCE_STORE_ID = makeKeyword( "INFERENCE-STORE-ID" );
    $kw83$INFERENCE_ID = makeKeyword( "INFERENCE-ID" );
    $kw84$DIRECTION = makeKeyword( "DIRECTION" );
    $kw85$UNDIRECTED = makeKeyword( "UNDIRECTED" );
    $const86$conceptuallyRelated = constant_handles.reader_make_constant_shell( makeString( "conceptuallyRelated" ) );
    $const87$arg1Isa = constant_handles.reader_make_constant_shell( makeString( "arg1Isa" ) );
    $const88$CycLSentence_Assertible = constant_handles.reader_make_constant_shell( makeString( "CycLSentence-Assertible" ) );
    $const89$different = constant_handles.reader_make_constant_shell( makeString( "different" ) );
    $kw90$LEFT = makeKeyword( "LEFT" );
    $str91$Query = makeString( "Query" );
    $kw92$NBSP = makeKeyword( "NBSP" );
    $str93$Edge_Templates = makeString( "Edge Templates" );
    $kw94$TOP = makeKeyword( "TOP" );
    $str95$_____ = makeString( " --- " );
    $str96$______ = makeString( " ---> " );
    $sym97$BBF_INFERENCE = makeSymbol( "BBF-INFERENCE" );
    $list98 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString( "Graph an inference query formula by taking the neg-lits and pos-lits, converting the HL vars to EL, then treating them as edges." ) );
    $kw99$STORE_SUID = makeKeyword( "STORE-SUID" );
    $kw100$INFERENCE_SUID = makeKeyword( "INFERENCE-SUID" );
    $str101$Inference_not_found_ = makeString( "Inference not found." );
    $kw102$NEG = makeKeyword( "NEG" );
    $list103 = ConsesLow.list( makeSymbol( "MT" ), makeSymbol( "ASENT" ) );
    $kw104$POS = makeKeyword( "POS" );
    $sym105$BBF_RULE = makeSymbol( "BBF-RULE" );
    $list106 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString( "Graph a rule by taking the neg-lits and pos-lits, converting the HL vars to EL, then treating them as edges." ) );
    $kw107$ASSERTIONS = makeKeyword( "ASSERTIONS" );
    $list108 = ConsesLow.cons( makeSymbol( "EL-VAR" ), makeSymbol( "HL-VAR" ) );
    $sym109$INTERN_EL_VAR = makeSymbol( "INTERN-EL-VAR" );
    $kw110$NODES = makeKeyword( "NODES" );
    $kw111$EDGES = makeKeyword( "EDGES" );
    $kw112$PROPERTIES = makeKeyword( "PROPERTIES" );
    $kw113$DEFAULT = makeKeyword( "DEFAULT" );
    $kw114$TRUE = makeKeyword( "TRUE" );
    $kw115$TRUE_ = makeKeyword( "TRUE?" );
    $kw116$ASSERTED_ = makeKeyword( "ASSERTED?" );
    $kw117$CORE = makeKeyword( "CORE" );
    $kw118$BLUE_GRAPHER_BASE_EVENT = makeKeyword( "BLUE-GRAPHER-BASE-EVENT" );
    $kw119$CYC_APPLICATION_EVENT = makeKeyword( "CYC-APPLICATION-EVENT" );
    $kw120$BLUE_EVENT = makeKeyword( "BLUE-EVENT" );
    $str121$BLUE_EVENT_DISPATCHER_Lock = makeString( "BLUE-EVENT-DISPATCHER Lock" );
    $sym122$_BLUE_EVENT_DISPATCHER_LISTENERS_ = makeSymbol( "*BLUE-EVENT-DISPATCHER-LISTENERS*" );
    $sym123$BLUE_FETCH_EVENT = makeSymbol( "BLUE-FETCH-EVENT" );
    $sym124$BLUE_MAP_EVENT_TO_BLUE_EVENT = makeSymbol( "BLUE-MAP-EVENT-TO-BLUE-EVENT" );
    $sym125$BLUE_GRAPH = makeSymbol( "BLUE-GRAPH" );
    $sym126$BLUE_GRAPH_P = makeSymbol( "BLUE-GRAPH-P" );
    $list127 = ConsesLow.list( makeSymbol( "ISG" ), makeSymbol( "NODE-LABEL-MAP" ), makeSymbol( "NODES" ), makeSymbol( "EDGE-LABEL-MAP" ), makeSymbol( "EDGES" ), makeSymbol( "NODE-DEFINITIONS" ), makeSymbol(
        "EDGE-DEFINITIONS" ), makeSymbol( "OPTIONS" ) );
    $list128 = ConsesLow.list( makeKeyword( "ISG" ), makeKeyword( "NODE-LABEL-MAP" ), makeKeyword( "NODES" ), makeKeyword( "EDGE-LABEL-MAP" ), makeKeyword( "EDGES" ), makeKeyword( "NODE-DEFINITIONS" ), makeKeyword(
        "EDGE-DEFINITIONS" ), makeKeyword( "OPTIONS" ) );
    $list129 = ConsesLow.list( makeSymbol( "BLUE-GRAPH-ISG" ), makeSymbol( "BLUE-GRAPH-NODE-LABEL-MAP" ), makeSymbol( "BLUE-GRAPH-NODES" ), makeSymbol( "BLUE-GRAPH-EDGE-LABEL-MAP" ), makeSymbol( "BLUE-GRAPH-EDGES" ),
        makeSymbol( "BLUE-GRAPH-NODE-DEFINITIONS" ), makeSymbol( "BLUE-GRAPH-EDGE-DEFINITIONS" ), makeSymbol( "BLUE-GRAPH-OPTIONS" ) );
    $list130 = ConsesLow.list( makeSymbol( "_CSETF-BLUE-GRAPH-ISG" ), makeSymbol( "_CSETF-BLUE-GRAPH-NODE-LABEL-MAP" ), makeSymbol( "_CSETF-BLUE-GRAPH-NODES" ), makeSymbol( "_CSETF-BLUE-GRAPH-EDGE-LABEL-MAP" ),
        makeSymbol( "_CSETF-BLUE-GRAPH-EDGES" ), makeSymbol( "_CSETF-BLUE-GRAPH-NODE-DEFINITIONS" ), makeSymbol( "_CSETF-BLUE-GRAPH-EDGE-DEFINITIONS" ), makeSymbol( "_CSETF-BLUE-GRAPH-OPTIONS" ) );
    $sym131$DEFAULT_STRUCT_PRINT_FUNCTION = makeSymbol( "DEFAULT-STRUCT-PRINT-FUNCTION" );
    $sym132$BLUE_GRAPH_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "BLUE-GRAPH-PRINT-FUNCTION-TRAMPOLINE" );
    $list133 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "BLUE-GRAPH-P" ) );
    $sym134$BLUE_GRAPH_ISG = makeSymbol( "BLUE-GRAPH-ISG" );
    $sym135$_CSETF_BLUE_GRAPH_ISG = makeSymbol( "_CSETF-BLUE-GRAPH-ISG" );
    $sym136$BLUE_GRAPH_NODE_LABEL_MAP = makeSymbol( "BLUE-GRAPH-NODE-LABEL-MAP" );
    $sym137$_CSETF_BLUE_GRAPH_NODE_LABEL_MAP = makeSymbol( "_CSETF-BLUE-GRAPH-NODE-LABEL-MAP" );
    $sym138$BLUE_GRAPH_NODES = makeSymbol( "BLUE-GRAPH-NODES" );
    $sym139$_CSETF_BLUE_GRAPH_NODES = makeSymbol( "_CSETF-BLUE-GRAPH-NODES" );
    $sym140$BLUE_GRAPH_EDGE_LABEL_MAP = makeSymbol( "BLUE-GRAPH-EDGE-LABEL-MAP" );
    $sym141$_CSETF_BLUE_GRAPH_EDGE_LABEL_MAP = makeSymbol( "_CSETF-BLUE-GRAPH-EDGE-LABEL-MAP" );
    $sym142$BLUE_GRAPH_EDGES = makeSymbol( "BLUE-GRAPH-EDGES" );
    $sym143$_CSETF_BLUE_GRAPH_EDGES = makeSymbol( "_CSETF-BLUE-GRAPH-EDGES" );
    $sym144$BLUE_GRAPH_NODE_DEFINITIONS = makeSymbol( "BLUE-GRAPH-NODE-DEFINITIONS" );
    $sym145$_CSETF_BLUE_GRAPH_NODE_DEFINITIONS = makeSymbol( "_CSETF-BLUE-GRAPH-NODE-DEFINITIONS" );
    $sym146$BLUE_GRAPH_EDGE_DEFINITIONS = makeSymbol( "BLUE-GRAPH-EDGE-DEFINITIONS" );
    $sym147$_CSETF_BLUE_GRAPH_EDGE_DEFINITIONS = makeSymbol( "_CSETF-BLUE-GRAPH-EDGE-DEFINITIONS" );
    $sym148$BLUE_GRAPH_OPTIONS = makeSymbol( "BLUE-GRAPH-OPTIONS" );
    $sym149$_CSETF_BLUE_GRAPH_OPTIONS = makeSymbol( "_CSETF-BLUE-GRAPH-OPTIONS" );
    $kw150$ISG = makeKeyword( "ISG" );
    $kw151$NODE_LABEL_MAP = makeKeyword( "NODE-LABEL-MAP" );
    $kw152$EDGE_LABEL_MAP = makeKeyword( "EDGE-LABEL-MAP" );
    $kw153$NODE_DEFINITIONS = makeKeyword( "NODE-DEFINITIONS" );
    $kw154$EDGE_DEFINITIONS = makeKeyword( "EDGE-DEFINITIONS" );
    $kw155$OPTIONS = makeKeyword( "OPTIONS" );
    $str156$Invalid_slot__S_for_construction_ = makeString( "Invalid slot ~S for construction function" );
    $kw157$BEGIN = makeKeyword( "BEGIN" );
    $sym158$MAKE_BLUE_GRAPH = makeSymbol( "MAKE-BLUE-GRAPH" );
    $kw159$SLOT = makeKeyword( "SLOT" );
    $kw160$END = makeKeyword( "END" );
    $sym161$VISIT_DEFSTRUCT_OBJECT_BLUE_GRAPH_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-BLUE-GRAPH-METHOD" );
    $kw162$COLOR = makeKeyword( "COLOR" );
    $kw163$ORIENTATION = makeKeyword( "ORIENTATION" );
    $str164$ = makeString( "" );
    $kw165$ID = makeKeyword( "ID" );
    $kw166$LABEL = makeKeyword( "LABEL" );
    $kw167$FROM = makeKeyword( "FROM" );
    $kw168$TO = makeKeyword( "TO" );
    $kw169$NODE_TYPE = makeKeyword( "NODE-TYPE" );
    $kw170$EDGE_TYPE = makeKeyword( "EDGE-TYPE" );
    $kw171$DEFINITIONS = makeKeyword( "DEFINITIONS" );
    $kw172$NODE = makeKeyword( "NODE" );
    $kw173$EDGE = makeKeyword( "EDGE" );
    $sym174$BBF_RTV_FROM_INFERENCE = makeSymbol( "BBF-RTV-FROM-INFERENCE" );
    $list175 = ConsesLow.list( makeKeyword( "HELP-STRING" ), makeString( "" ) );
    $kw176$FORMULA = makeKeyword( "FORMULA" );
    $kw177$PROBLEM_STORE_ID = makeKeyword( "PROBLEM-STORE-ID" );
    $sym178$RTV_CLAUSE_P = makeSymbol( "RTV-CLAUSE-P" );
    $kw179$SKIP = makeKeyword( "SKIP" );
    $sym180$BBF_RTV_UNBOUND = makeSymbol( "BBF-RTV-UNBOUND" );
    $kw181$ARG1_ANSWERS = makeKeyword( "ARG1-ANSWERS" );
    $kw182$ARG2_ANSWERS = makeKeyword( "ARG2-ANSWERS" );
    $sym183$ASSERTION_FORMULA = makeSymbol( "ASSERTION-FORMULA" );
    $sym184$BBF_RTV_FROM_INFERENCE_NEW = makeSymbol( "BBF-RTV-FROM-INFERENCE-NEW" );
    $kw185$ANSWERS = makeKeyword( "ANSWERS" );
    $sym186$CDR = makeSymbol( "CDR" );
  }

  public static final class $blue_graph_native
      extends
        SubLStructNative
  {
    ...
    public $blue_graph_native()
    {
      ...
      this.$node_label_map = CommonSymbols.NIL;
      this.$nodes = CommonSymbols.NIL;
      this.$edge_label_map = CommonSymbols.NIL;
      this.$edges = CommonSymbols.NIL;
      this.$node_definitions = CommonSymbols.NIL;
      this.$edge_definitions = CommonSymbols.NIL;
    ...
    {
      return $blue_graph_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $blue_graph_native.class, $sym125$BLUE_GRAPH, $sym126$BLUE_GRAPH_P, $list127, $list128, new String[] { "$isg", "$node_label_map", "$nodes", "$edge_label_map", "$edges",
        "$node_definitions", "$edge_definitions", "$options"
      }, $list129, $list130, $sym131$DEFAULT_STRUCT_PRINT_FUNCTION );
    }
  }

  public static final class $blue_graph_p$UnaryFunction
      extends
        UnaryFunction
  {
