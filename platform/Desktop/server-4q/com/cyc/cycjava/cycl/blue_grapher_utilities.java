...
public final class blue_grapher_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_blue_grapher_utilities_file() {
        blue_grapher_utilities.$blue_filter_fns$ = SubLFiles.deflexical("*BLUE-FILTER-FNS*", (blue_grapher_utilities.NIL != Symbols.boundp((SubLObject)blue_grapher_utilities.$sym0$_BLUE_FILTER_FNS_)) ? blue_grapher_utilities.$blue_filter_fns$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)blue_grapher_utilities.SIXTEEN_INTEGER, (SubLObject)blue_grapher_utilities.UNPROVIDED, (SubLObject)blue_grapher_utilities.UNPROVIDED));
        blue_grapher_utilities.$default_blue_filter_fn_cost$ = SubLFiles.deflexical("*DEFAULT-BLUE-FILTER-FN-COST*", (SubLObject)((blue_grapher_utilities.NIL != Symbols.boundp((SubLObject)blue_grapher_utilities.$sym7$_DEFAULT_BLUE_FILTER_FN_COST_)) ? blue_grapher_utilities.$default_blue_filter_fn_cost$.getGlobalValue() : blue_grapher_utilities.ZERO_INTEGER));
        blue_grapher_utilities.$default_blue_filter_fn_strength$ = SubLFiles.deflexical("*DEFAULT-BLUE-FILTER-FN-STRENGTH*", (SubLObject)((blue_grapher_utilities.NIL != Symbols.boundp((SubLObject)blue_grapher_utilities.$sym9$_DEFAULT_BLUE_FILTER_FN_STRENGTH_)) ? blue_grapher_utilities.$default_blue_filter_fn_strength$.getGlobalValue() : blue_grapher_utilities.ZERO_INTEGER));
        blue_grapher_utilities.$default_blue_filter_fn_type$ = SubLFiles.deflexical("*DEFAULT-BLUE-FILTER-FN-TYPE*", (SubLObject)((blue_grapher_utilities.NIL != Symbols.boundp((SubLObject)blue_grapher_utilities.$sym11$_DEFAULT_BLUE_FILTER_FN_TYPE_)) ? blue_grapher_utilities.$default_blue_filter_fn_type$.getGlobalValue() : blue_grapher_utilities.NIL));
        blue_grapher_utilities.$blue_builder_fns$ = SubLFiles.deflexical("*BLUE-BUILDER-FNS*", (blue_grapher_utilities.NIL != Symbols.boundp((SubLObject)blue_grapher_utilities.$sym29$_BLUE_BUILDER_FNS_)) ? blue_grapher_utilities.$blue_builder_fns$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)blue_grapher_utilities.SIXTEEN_INTEGER, (SubLObject)blue_grapher_utilities.UNPROVIDED, (SubLObject)blue_grapher_utilities.UNPROVIDED));
        blue_grapher_utilities.$blue_builder_fn_to_deflist_hash$ = SubLFiles.deflexical("*BLUE-BUILDER-FN-TO-DEFLIST-HASH*", (blue_grapher_utilities.NIL != Symbols.boundp((SubLObject)blue_grapher_utilities.$sym30$_BLUE_BUILDER_FN_TO_DEFLIST_HASH_)) ? blue_grapher_utilities.$blue_builder_fn_to_deflist_hash$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)blue_grapher_utilities.SIXTEEN_INTEGER, (SubLObject)blue_grapher_utilities.UNPROVIDED, (SubLObject)blue_grapher_utilities.UNPROVIDED));
        ...
        blue_grapher_utilities.$blue_event_dispatcher_listeners$ = SubLFiles.deflexical("*BLUE-EVENT-DISPATCHER-LISTENERS*", (SubLObject)((blue_grapher_utilities.NIL != Symbols.boundp((SubLObject)blue_grapher_utilities.$sym122$_BLUE_EVENT_DISPATCHER_LISTENERS_)) ? blue_grapher_utilities.$blue_event_dispatcher_listeners$.getGlobalValue() : blue_grapher_utilities.NIL));
