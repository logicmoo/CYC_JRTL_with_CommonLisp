...
public final class kb_control_vars extends SubLTranslatedFile
{
    ...
    public static SubLObject init_kb_control_vars_file() {
        kb_control_vars.$backchain_forbidden_unless_arg_chosen$ = SubLFiles.deflexical("*BACKCHAIN-FORBIDDEN-UNLESS-ARG-CHOSEN*", (kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym0$_BACKCHAIN_FORBIDDEN_UNLESS_ARG_CHOSEN_)) ? kb_control_vars.$backchain_forbidden_unless_arg_chosen$.getGlobalValue() : kb_control_vars.$const1$backchainForbiddenWhenUnboundInAr);
        kb_control_vars.$kb_features$ = SubLFiles.deflexical("*KB-FEATURES*", (SubLObject)kb_control_vars.NIL);
        kb_control_vars.$reformulator_kb_loadedP$ = SubLFiles.deflexical("*REFORMULATOR-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym3$_REFORMULATOR_KB_LOADED__)) ? kb_control_vars.$reformulator_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$sksi_kb_loadedP$ = SubLFiles.deflexical("*SKSI-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym4$_SKSI_KB_LOADED__)) ? kb_control_vars.$sksi_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$paraphrase_kb_loadedP$ = SubLFiles.deflexical("*PARAPHRASE-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym5$_PARAPHRASE_KB_LOADED__)) ? kb_control_vars.$paraphrase_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$nl_kb_loadedP$ = SubLFiles.deflexical("*NL-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym6$_NL_KB_LOADED__)) ? kb_control_vars.$nl_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$lexicon_kb_loadedP$ = SubLFiles.deflexical("*LEXICON-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym7$_LEXICON_KB_LOADED__)) ? kb_control_vars.$lexicon_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$rtp_kb_loadedP$ = SubLFiles.deflexical("*RTP-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym8$_RTP_KB_LOADED__)) ? kb_control_vars.$rtp_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$rkf_kb_loadedP$ = SubLFiles.deflexical("*RKF-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym9$_RKF_KB_LOADED__)) ? kb_control_vars.$rkf_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$thesaurus_kb_loadedP$ = SubLFiles.deflexical("*THESAURUS-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym10$_THESAURUS_KB_LOADED__)) ? kb_control_vars.$thesaurus_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$quant_kb_loadedP$ = SubLFiles.deflexical("*QUANT-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym11$_QUANT_KB_LOADED__)) ? kb_control_vars.$quant_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$time_kb_loadedP$ = SubLFiles.deflexical("*TIME-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym12$_TIME_KB_LOADED__)) ? kb_control_vars.$time_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$date_kb_loadedP$ = SubLFiles.deflexical("*DATE-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym13$_DATE_KB_LOADED__)) ? kb_control_vars.$date_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$fraction_kb_loadedP$ = SubLFiles.deflexical("*FRACTION-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym14$_FRACTION_KB_LOADED__)) ? kb_control_vars.$fraction_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$cyc_task_scheduler_kb_loadedP$ = SubLFiles.deflexical("*CYC-TASK-SCHEDULER-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym15$_CYC_TASK_SCHEDULER_KB_LOADED__)) ? kb_control_vars.$cyc_task_scheduler_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$wordnet_kb_loadedP$ = SubLFiles.deflexical("*WORDNET-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym16$_WORDNET_KB_LOADED__)) ? kb_control_vars.$wordnet_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$wordnet_import_kb_loadedP$ = SubLFiles.deflexical("*WORDNET-IMPORT-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym17$_WORDNET_IMPORT_KB_LOADED__)) ? kb_control_vars.$wordnet_import_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$cyc_secure_kb_loadedP$ = SubLFiles.deflexical("*CYC-SECURE-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym18$_CYC_SECURE_KB_LOADED__)) ? kb_control_vars.$cyc_secure_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$planner_kb_loadedP$ = SubLFiles.deflexical("*PLANNER-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym19$_PLANNER_KB_LOADED__)) ? kb_control_vars.$planner_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
        kb_control_vars.$kct_kb_loadedP$ = SubLFiles.deflexical("*KCT-KB-LOADED?*", (SubLObject)((kb_control_vars.NIL != Symbols.boundp((SubLObject)kb_control_vars.$sym20$_KCT_KB_LOADED__)) ? kb_control_vars.$kct_kb_loadedP$.getGlobalValue() : kb_control_vars.NIL));
