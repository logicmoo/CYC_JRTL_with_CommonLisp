...
public final class file_vector_utilities extends SubLTranslatedFile
{
    ...
    public static SubLObject init_file_vector_utilities_file() {
        ...
        file_vector_utilities.$file_vector_indexical_registry$ = SubLFiles.deflexical("*FILE-VECTOR-INDEXICAL-REGISTRY*", (file_vector_utilities.NIL != Symbols.boundp((SubLObject)file_vector_utilities.$sym77$_FILE_VECTOR_INDEXICAL_REGISTRY_)) ? file_vector_utilities.$file_vector_indexical_registry$.getGlobalValue() : dictionary.new_dictionary((SubLObject)file_vector_utilities.UNPROVIDED, (SubLObject)file_vector_utilities.UNPROVIDED));
        file_vector_utilities.$file_vector_indexical_lock_registry$ = SubLFiles.deflexical("*FILE-VECTOR-INDEXICAL-LOCK-REGISTRY*", (file_vector_utilities.NIL != Symbols.boundp((SubLObject)file_vector_utilities.$sym78$_FILE_VECTOR_INDEXICAL_LOCK_REGISTRY_)) ? file_vector_utilities.$file_vector_indexical_lock_registry$.getGlobalValue() : dictionary.new_dictionary((SubLObject)file_vector_utilities.UNPROVIDED, (SubLObject)file_vector_utilities.UNPROVIDED));
