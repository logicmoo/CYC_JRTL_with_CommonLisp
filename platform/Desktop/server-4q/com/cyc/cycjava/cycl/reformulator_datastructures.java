...
public final class reformulator_datastructures extends SubLTranslatedFile
{
    ...
    public static SubLObject init_reformulator_datastructures_file() {
        ...
        reformulator_datastructures.$default_reformulator_mode_precedence$ = SubLFiles.deflexical("*DEFAULT-REFORMULATOR-MODE-PRECEDENCE*", (SubLObject)(maybeDefault((SubLObject)reformulator_datastructures.$sym5$_DEFAULT_REFORMULATOR_MODE_PRECEDENCE_, reformulator_datastructures.$default_reformulator_mode_precedence$, reformulator_datastructures.NIL)));
        reformulator_datastructures.$default_reformulation_directions_in_modes_for_preds$ = SubLFiles.deflexical("*DEFAULT-REFORMULATION-DIRECTIONS-IN-MODES-FOR-PREDS*", (SubLObject)(maybeDefault((SubLObject)reformulator_datastructures.$sym6$_DEFAULT_REFORMULATION_DIRECTIONS_IN_MODES_FOR_PREDS_, reformulator_datastructures.$default_reformulation_directions_in_modes_for_preds$, reformulator_datastructures.NIL)));
        ...
        reformulator_datastructures.$reformulator_irrelevant_forts$ = SubLFiles.deflexical("*REFORMULATOR-IRRELEVANT-FORTS*", (SubLObject)(maybeDefault((SubLObject)reformulator_datastructures.$sym8$_REFORMULATOR_IRRELEVANT_FORTS_, reformulator_datastructures.$reformulator_irrelevant_forts$, reformulator_datastructures.NIL)));
        reformulator_datastructures.$reformulator_relevant_predicates$ = SubLFiles.deflexical("*REFORMULATOR-RELEVANT-PREDICATES*", (SubLObject)(maybeDefault((SubLObject)reformulator_datastructures.$sym9$_REFORMULATOR_RELEVANT_PREDICATES_, reformulator_datastructures.$reformulator_relevant_predicates$, reformulator_datastructures.NIL)));
        reformulator_datastructures.$reformulator_rule_predicates$ = SubLFiles.deflexical("*REFORMULATOR-RULE-PREDICATES*", (SubLObject)(maybeDefault((SubLObject)reformulator_datastructures.$sym10$_REFORMULATOR_RULE_PREDICATES_, reformulator_datastructures.$reformulator_rule_predicates$, reformulator_datastructures.NIL)));
        reformulator_datastructures.$reformulator_rule_spec_preds$ = SubLFiles.deflexical("*REFORMULATOR-RULE-SPEC-PREDS*", (SubLObject)(maybeDefault((SubLObject)reformulator_datastructures.$sym11$_REFORMULATOR_RULE_SPEC_PREDS_, reformulator_datastructures.$reformulator_rule_spec_preds$, reformulator_datastructures.NIL)));
