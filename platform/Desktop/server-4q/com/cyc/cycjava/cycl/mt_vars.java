...
public final class mt_vars extends SubLTranslatedFile
{
    ...
    public static SubLObject init_mt_vars_file() {
        ...
        mt_vars.$mt_root$ = SubLFiles.deflexical("*MT-ROOT*", maybeDefault((SubLObject)mt_vars.$sym6$_MT_ROOT_, mt_vars.$mt_root$, mt_vars.$const7$BaseKB));
        mt_vars.$theory_mt_root$ = SubLFiles.deflexical("*THEORY-MT-ROOT*", maybeDefault((SubLObject)mt_vars.$sym8$_THEORY_MT_ROOT_, mt_vars.$theory_mt_root$, mt_vars.$const7$BaseKB));
        mt_vars.$assertible_mt_root$ = SubLFiles.deflexical("*ASSERTIBLE-MT-ROOT*", maybeDefault((SubLObject)mt_vars.$sym9$_ASSERTIBLE_MT_ROOT_, mt_vars.$assertible_mt_root$, mt_vars.$const7$BaseKB));
        mt_vars.$assertible_theory_mt_root$ = SubLFiles.deflexical("*ASSERTIBLE-THEORY-MT-ROOT*", maybeDefault((SubLObject)mt_vars.$sym10$_ASSERTIBLE_THEORY_MT_ROOT_, mt_vars.$assertible_theory_mt_root$, mt_vars.$const7$BaseKB));
        mt_vars.$core_mt_floor$ = SubLFiles.deflexical("*CORE-MT-FLOOR*", maybeDefault((SubLObject)mt_vars.$sym11$_CORE_MT_FLOOR_, mt_vars.$core_mt_floor$, mt_vars.$const7$BaseKB));
        mt_vars.$mt_mt$ = SubLFiles.deflexical("*MT-MT*", maybeDefault((SubLObject)mt_vars.$sym12$_MT_MT_, mt_vars.$mt_mt$, mt_vars.$const13$UniversalVocabularyMt));
        mt_vars.$defining_mt_mt$ = SubLFiles.deflexical("*DEFINING-MT-MT*", maybeDefault((SubLObject)mt_vars.$sym15$_DEFINING_MT_MT_, mt_vars.$defining_mt_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$decontextualized_predicate_mt$ = SubLFiles.deflexical("*DECONTEXTUALIZED-PREDICATE-MT*", maybeDefault((SubLObject)mt_vars.$sym17$_DECONTEXTUALIZED_PREDICATE_MT_, mt_vars.$decontextualized_predicate_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$decontextualized_collection_mt$ = SubLFiles.deflexical("*DECONTEXTUALIZED-COLLECTION-MT*", maybeDefault((SubLObject)mt_vars.$sym19$_DECONTEXTUALIZED_COLLECTION_MT_, mt_vars.$decontextualized_collection_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$ephemeral_term_mt$ = SubLFiles.deflexical("*EPHEMERAL-TERM-MT*", maybeDefault((SubLObject)mt_vars.$sym21$_EPHEMERAL_TERM_MT_, mt_vars.$ephemeral_term_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$ist_mt$ = SubLFiles.deflexical("*IST-MT*", maybeDefault((SubLObject)mt_vars.$sym23$_IST_MT_, mt_vars.$ist_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$inference_related_bookkeeping_predicate_mt$ = SubLFiles.deflexical("*INFERENCE-RELATED-BOOKKEEPING-PREDICATE-MT*", maybeDefault((SubLObject)mt_vars.$sym25$_INFERENCE_RELATED_BOOKKEEPING_PREDICATE_MT_, mt_vars.$inference_related_bookkeeping_predicate_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$anect_mt$ = SubLFiles.deflexical("*ANECT-MT*", maybeDefault((SubLObject)mt_vars.$sym27$_ANECT_MT_, mt_vars.$anect_mt$, mt_vars.$const13$UniversalVocabularyMt));
        mt_vars.$broad_mt_mt$ = SubLFiles.deflexical("*BROAD-MT-MT*", maybeDefault((SubLObject)mt_vars.$sym29$_BROAD_MT_MT_, mt_vars.$broad_mt_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$psc_mt$ = SubLFiles.deflexical("*PSC-MT*", maybeDefault((SubLObject)mt_vars.$sym31$_PSC_MT_, mt_vars.$psc_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$tou_mt$ = SubLFiles.deflexical("*TOU-MT*", maybeDefault((SubLObject)mt_vars.$sym33$_TOU_MT_, mt_vars.$tou_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$skolem_mt$ = SubLFiles.deflexical("*SKOLEM-MT*", maybeDefault((SubLObject)mt_vars.$sym35$_SKOLEM_MT_, mt_vars.$skolem_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$thing_defining_mt$ = SubLFiles.deflexical("*THING-DEFINING-MT*", maybeDefault((SubLObject)mt_vars.$sym37$_THING_DEFINING_MT_, mt_vars.$thing_defining_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$relation_defining_mt$ = SubLFiles.deflexical("*RELATION-DEFINING-MT*", maybeDefault((SubLObject)mt_vars.$sym39$_RELATION_DEFINING_MT_, mt_vars.$relation_defining_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$equals_defining_mt$ = SubLFiles.deflexical("*EQUALS-DEFINING-MT*", maybeDefault((SubLObject)mt_vars.$sym41$_EQUALS_DEFINING_MT_, mt_vars.$equals_defining_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$element_of_defining_mt$ = SubLFiles.deflexical("*ELEMENT-OF-DEFINING-MT*", maybeDefault((SubLObject)mt_vars.$sym43$_ELEMENT_OF_DEFINING_MT_, mt_vars.$element_of_defining_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$subset_of_defining_mt$ = SubLFiles.deflexical("*SUBSET-OF-DEFINING-MT*", maybeDefault((SubLObject)mt_vars.$sym45$_SUBSET_OF_DEFINING_MT_, mt_vars.$subset_of_defining_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$arity_mt$ = SubLFiles.deflexical("*ARITY-MT*", maybeDefault((SubLObject)mt_vars.$sym47$_ARITY_MT_, mt_vars.$arity_mt$, mt_vars.$const13$UniversalVocabularyMt));
        mt_vars.$sublid_mt$ = SubLFiles.deflexical("*SUBLID-MT*", maybeDefault((SubLObject)mt_vars.$sym49$_SUBLID_MT_, mt_vars.$sublid_mt$, mt_vars.$const50$CycAPIMt));
        mt_vars.$not_assertible_mt_convention_mt$ = SubLFiles.deflexical("*NOT-ASSERTIBLE-MT-CONVENTION-MT*", maybeDefault((SubLObject)mt_vars.$sym52$_NOT_ASSERTIBLE_MT_CONVENTION_MT_, mt_vars.$not_assertible_mt_convention_mt$, mt_vars.$const13$UniversalVocabularyMt));
        mt_vars.$default_ask_mt$ = SubLFiles.deflexical("*DEFAULT-ASK-MT*", maybeDefault((SubLObject)mt_vars.$sym54$_DEFAULT_ASK_MT_, mt_vars.$default_ask_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$default_assert_mt$ = SubLFiles.deflexical("*DEFAULT-ASSERT-MT*", maybeDefault((SubLObject)mt_vars.$sym55$_DEFAULT_ASSERT_MT_, mt_vars.$default_assert_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$default_clone_mt$ = SubLFiles.deflexical("*DEFAULT-CLONE-MT*", maybeDefault((SubLObject)mt_vars.$sym56$_DEFAULT_CLONE_MT_, mt_vars.$default_clone_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$default_support_mt$ = SubLFiles.deflexical("*DEFAULT-SUPPORT-MT*", maybeDefault((SubLObject)mt_vars.$sym57$_DEFAULT_SUPPORT_MT_, mt_vars.$default_support_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$default_comment_mt$ = SubLFiles.deflexical("*DEFAULT-COMMENT-MT*", maybeDefault((SubLObject)mt_vars.$sym58$_DEFAULT_COMMENT_MT_, mt_vars.$default_comment_mt$, mt_vars.$const7$BaseKB));
        mt_vars.$default_convention_mt$ = SubLFiles.deflexical("*DEFAULT-CONVENTION-MT*", maybeDefault((SubLObject)mt_vars.$sym59$_DEFAULT_CONVENTION_MT_, mt_vars.$default_convention_mt$, mt_vars.$const13$UniversalVocabularyMt));
