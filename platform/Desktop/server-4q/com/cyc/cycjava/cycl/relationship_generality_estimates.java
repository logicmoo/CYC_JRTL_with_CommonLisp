...
public final class relationship_generality_estimates
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject relation_arg_cardinality(final SubLObject relation, final SubLObject argnum, SubLObject mt)
  {
    ...
    if( pcase_var.eql( $const0$argIsa ) )
    {
      return cardinality_estimates.instance_cardinality( collection );
    }
    if( pcase_var.eql( $const1$argGenl ) )
    {
      return cardinality_estimates.spec_cardinality( collection );
    }
    return cardinality_estimates.instance_cardinality( $const2$Thing );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $relation_generality_estimate_cached_caching_state$.getGlobalValue(), ConsesLow.list( relation ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject relation_generality_estimate_cached_internal(final SubLObject relation)
  {
    ...
    return Values.values( Numbers.truncate( Numbers.multiply( $int7$1000, Numbers.log( total, TWO_INTEGER ) ), UNPROVIDED ) );
  }
  ...
  public static SubLObject relation_generality_estimate_cached(final SubLObject relation)
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym3$RELATION_GENERALITY_ESTIMATE_CACHED, $sym8$_RELATION_GENERALITY_ESTIMATE_CACHED_CACHING_STATE_, NIL, EQL, ONE_INTEGER, $int9$100 );
    }
    ...
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( relation_generality_estimate_cached_internal( relation ) ) );
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $relation_most_restricted_arg_caching_state$.getGlobalValue(), ConsesLow.list( relation ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject relation_most_restricted_arg(final SubLObject relation)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym10$RELATION_MOST_RESTRICTED_ARG, $sym11$_RELATION_MOST_RESTRICTED_ARG_CACHING_STATE_, NIL, EQL, ONE_INTEGER, TEN_INTEGER );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, relation, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( relation_most_restricted_arg_internal( relation ) ) );
      memoization_state.caching_state_put( caching_state, relation, results, UNPROVIDED );
    }
    return memoization_state.caching_results( results );
  }
  ...
  public static SubLObject relation_most_restricted_arg_constraint(final SubLObject relation, final SubLObject argnum, SubLObject mt)
  {
    ...
    SubLObject best_collection = $const2$Thing;
    SubLObject best_constraint = $const0$argIsa;
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        best_collection = candidate;
        best_constraint = $const1$argGenl;
        best_count = count;
      }
      cdolist_list_var = cdolist_list_var.rest();
      candidate = cdolist_list_var.first();
  ...
  {
    SubLFiles.declareFunction( me, "relation_arg_cardinality", "RELATION-ARG-CARDINALITY", 2, 1, false );
    SubLFiles.declareFunction( me, "relation_generality_estimate", "RELATION-GENERALITY-ESTIMATE", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_relation_generality_estimate_cached", "CLEAR-RELATION-GENERALITY-ESTIMATE-CACHED", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_relation_generality_estimate_cached", "REMOVE-RELATION-GENERALITY-ESTIMATE-CACHED", 1, 0, false );
    SubLFiles.declareFunction( me, "relation_generality_estimate_cached_internal", "RELATION-GENERALITY-ESTIMATE-CACHED-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "relation_generality_estimate_cached", "RELATION-GENERALITY-ESTIMATE-CACHED", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_relation_most_restricted_arg", "CLEAR-RELATION-MOST-RESTRICTED-ARG", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_relation_most_restricted_arg", "REMOVE-RELATION-MOST-RESTRICTED-ARG", 1, 0, false );
    SubLFiles.declareFunction( me, "relation_most_restricted_arg_internal", "RELATION-MOST-RESTRICTED-ARG-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "relation_most_restricted_arg", "RELATION-MOST-RESTRICTED-ARG", 1, 0, false );
    SubLFiles.declareFunction( me, "relation_most_restricted_arg_constraint", "RELATION-MOST-RESTRICTED-ARG-CONSTRAINT", 2, 1, false );
    SubLFiles.declareFunction( me, "relation_generality_estimateL", "RELATION-GENERALITY-ESTIMATE<", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_relationship_generality_estimates_file()
  {
    $relation_generality_estimate_cached_caching_state$ = SubLFiles.deflexical( "*RELATION-GENERALITY-ESTIMATE-CACHED-CACHING-STATE*", NIL );
    $relation_most_restricted_arg_caching_state$ = SubLFiles.deflexical( "*RELATION-MOST-RESTRICTED-ARG-CACHING-STATE*", NIL );
    return NIL;
  }

  public static SubLObject setup_relationship_generality_estimates_file()
  {
    memoization_state.note_globally_cached_function( $sym3$RELATION_GENERALITY_ESTIMATE_CACHED );
    memoization_state.note_globally_cached_function( $sym10$RELATION_MOST_RESTRICTED_ARG );
    return NIL;
  }
  ...
  static
  {
    me = new relationship_generality_estimates();
    $relation_generality_estimate_cached_caching_state$ = null;
    $relation_most_restricted_arg_caching_state$ = null;
    $const0$argIsa = constant_handles.reader_make_constant_shell( makeString( "argIsa" ) );
    $const1$argGenl = constant_handles.reader_make_constant_shell( makeString( "argGenl" ) );
    $const2$Thing = constant_handles.reader_make_constant_shell( makeString( "Thing" ) );
    $sym3$RELATION_GENERALITY_ESTIMATE_CACHED = makeSymbol( "RELATION-GENERALITY-ESTIMATE-CACHED" );
    $float4$1_0 = makeDouble( 1.0 );
    ...
    $sym8$_RELATION_GENERALITY_ESTIMATE_CACHED_CACHING_STATE_ = makeSymbol( "*RELATION-GENERALITY-ESTIMATE-CACHED-CACHING-STATE*" );
    $int9$100 = makeInteger( 100 );
    $sym10$RELATION_MOST_RESTRICTED_ARG = makeSymbol( "RELATION-MOST-RESTRICTED-ARG" );
    $sym11$_RELATION_MOST_RESTRICTED_ARG_CACHING_STATE_ = makeSymbol( "*RELATION-MOST-RESTRICTED-ARG-CACHING-STATE*" );
  }
}
/*
 * 
