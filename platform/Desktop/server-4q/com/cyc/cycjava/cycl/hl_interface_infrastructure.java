...
public final class hl_interface_infrastructure extends SubLTranslatedFile
{
    ...
    public static SubLObject init_hl_interface_infrastructure_file() {
        ...
        hl_interface_infrastructure.$remote_hl_store_image$ = SubLFiles.deflexical("*REMOTE-HL-STORE-IMAGE*", (SubLObject)((hl_interface_infrastructure.NIL != Symbols.boundp((SubLObject)hl_interface_infrastructure.$sym8$_REMOTE_HL_STORE_IMAGE_)) ? hl_interface_infrastructure.$remote_hl_store_image$.getGlobalValue() : hl_interface_infrastructure.NIL));
        hl_interface_infrastructure.$remote_hl_store_connection_pool$ = SubLFiles.deflexical("*REMOTE-HL-STORE-CONNECTION-POOL*", (hl_interface_infrastructure.NIL != Symbols.boundp((SubLObject)hl_interface_infrastructure.$sym9$_REMOTE_HL_STORE_CONNECTION_POOL_)) ? hl_interface_infrastructure.$remote_hl_store_connection_pool$.getGlobalValue() : queues.create_queue((SubLObject)hl_interface_infrastructure.UNPROVIDED));
        ...
        hl_interface_infrastructure.$hl_store_iterators$ = SubLFiles.deflexical("*HL-STORE-ITERATORS*", (hl_interface_infrastructure.NIL != Symbols.boundp((SubLObject)hl_interface_infrastructure.$sym49$_HL_STORE_ITERATORS_)) ? hl_interface_infrastructure.$hl_store_iterators$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)hl_interface_infrastructure.EQL), (SubLObject)hl_interface_infrastructure.UNPROVIDED));
        hl_interface_infrastructure.$next_hl_store_iterator_id$ = SubLFiles.deflexical("*NEXT-HL-STORE-ITERATOR-ID*", (SubLObject)((hl_interface_infrastructure.NIL != Symbols.boundp((SubLObject)hl_interface_infrastructure.$sym50$_NEXT_HL_STORE_ITERATOR_ID_)) ? hl_interface_infrastructure.$next_hl_store_iterator_id$.getGlobalValue() : hl_interface_infrastructure.ZERO_INTEGER));
        ...
        hl_interface_infrastructure.$hl_transcript_stream$ = SubLFiles.deflexical("*HL-TRANSCRIPT-STREAM*", (SubLObject)((hl_interface_infrastructure.NIL != Symbols.boundp((SubLObject)hl_interface_infrastructure.$sym67$_HL_TRANSCRIPT_STREAM_)) ? hl_interface_infrastructure.$hl_transcript_stream$.getGlobalValue() : hl_interface_infrastructure.NIL));
        return (SubLObject)hl_interface_infrastructure.NIL;
    }
