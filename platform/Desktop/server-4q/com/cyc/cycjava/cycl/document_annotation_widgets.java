...
public final class document_annotation_widgets extends SubLTranslatedFile
{
    ...
    public static SubLObject init_document_annotation_widgets_file() {
        ...
        document_annotation_widgets.$document_interpretation_rules_by_mt$ = SubLFiles.deflexical("*DOCUMENT-INTERPRETATION-RULES-BY-MT*", (document_annotation_widgets.NIL != Symbols.boundp((SubLObject)document_annotation_widgets.$sym327$_DOCUMENT_INTERPRETATION_RULES_BY_MT_)) ? document_annotation_widgets.$document_interpretation_rules_by_mt$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)document_annotation_widgets.EQUAL), (SubLObject)document_annotation_widgets.UNPROVIDED));
