...
public final class lexicon_accessors extends SubLTranslatedFile
{
    ...
    public static SubLObject init_lexicon_accessors_file() {
        ...
        lexicon_accessors.$derived_preds$ = SubLFiles.deflexical("*DERIVED-PREDS*", (lexicon_accessors.NIL != Symbols.boundp((SubLObject)lexicon_accessors.$sym39$_DERIVED_PREDS_)) ? lexicon_accessors.$derived_preds$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)lexicon_accessors.$int40$256, (SubLObject)lexicon_accessors.UNPROVIDED, (SubLObject)lexicon_accessors.UNPROVIDED));
        lexicon_accessors.$speech_part_preds$ = SubLFiles.deflexical("*SPEECH-PART-PREDS*", (lexicon_accessors.NIL != Symbols.boundp((SubLObject)lexicon_accessors.$sym61$_SPEECH_PART_PREDS_)) ? lexicon_accessors.$speech_part_preds$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)lexicon_accessors.EQL), (SubLObject)lexicon_accessors.$int40$256));
        ...
        lexicon_accessors.$closed_lexical_class_strings$ = SubLFiles.deflexical("*CLOSED-LEXICAL-CLASS-STRINGS*", (lexicon_accessors.NIL != Symbols.boundp((SubLObject)lexicon_accessors.$sym152$_CLOSED_LEXICAL_CLASS_STRINGS_)) ? lexicon_accessors.$closed_lexical_class_strings$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)lexicon_accessors.$int25$512, Symbols.symbol_function((SubLObject)lexicon_accessors.EQUAL), (SubLObject)lexicon_accessors.UNPROVIDED));
        lexicon_accessors.$closed_lexical_class_strings_case_insensitive$ = SubLFiles.deflexical("*CLOSED-LEXICAL-CLASS-STRINGS-CASE-INSENSITIVE*", (lexicon_accessors.NIL != Symbols.boundp((SubLObject)lexicon_accessors.$sym153$_CLOSED_LEXICAL_CLASS_STRINGS_CASE_INSENSITIVE_)) ? lexicon_accessors.$closed_lexical_class_strings_case_insensitive$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)lexicon_accessors.$int25$512, Symbols.symbol_function((SubLObject)lexicon_accessors.EQUALP), (SubLObject)lexicon_accessors.UNPROVIDED));
        ...
        lexicon_accessors.$vulgar_words$ = SubLFiles.deflexical("*VULGAR-WORDS*", (lexicon_accessors.NIL != Symbols.boundp((SubLObject)lexicon_accessors.$sym166$_VULGAR_WORDS_)) ? lexicon_accessors.$vulgar_words$.getGlobalValue() : set.new_set((SubLObject)lexicon_accessors.UNPROVIDED, (SubLObject)lexicon_accessors.UNPROVIDED));
        ...
        lexicon_accessors.$speech_parts$ = SubLFiles.deflexical("*SPEECH-PARTS*", (lexicon_accessors.NIL != Symbols.boundp((SubLObject)lexicon_accessors.$sym274$_SPEECH_PARTS_)) ? lexicon_accessors.$speech_parts$.getGlobalValue() : dictionary.new_dictionary(Symbols.symbol_function((SubLObject)lexicon_accessors.EQL), (SubLObject)lexicon_accessors.$int40$256));
