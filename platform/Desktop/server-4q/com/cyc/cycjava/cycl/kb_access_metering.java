...
public final class kb_access_metering extends SubLTranslatedFile
{
    ...
    public static SubLObject init_kb_access_metering_file() {
        ...
        kb_access_metering.$arete_last_assertion_touched$ = SubLFiles.deflexical("*ARETE-LAST-ASSERTION-TOUCHED*", (SubLObject)((kb_access_metering.NIL != Symbols.boundp((SubLObject)kb_access_metering.$sym0$_ARETE_LAST_ASSERTION_TOUCHED_)) ? kb_access_metering.$arete_last_assertion_touched$.getGlobalValue() : kb_access_metering.NIL));
        kb_access_metering.$arete_last_term_touched$ = SubLFiles.deflexical("*ARETE-LAST-TERM-TOUCHED*", (SubLObject)((kb_access_metering.NIL != Symbols.boundp((SubLObject)kb_access_metering.$sym1$_ARETE_LAST_TERM_TOUCHED_)) ? kb_access_metering.$arete_last_term_touched$.getGlobalValue() : kb_access_metering.NIL));
        kb_access_metering.$arete_last_constant_touched$ = SubLFiles.deflexical("*ARETE-LAST-CONSTANT-TOUCHED*", (SubLObject)((kb_access_metering.NIL != Symbols.boundp((SubLObject)kb_access_metering.$sym2$_ARETE_LAST_CONSTANT_TOUCHED_)) ? kb_access_metering.$arete_last_constant_touched$.getGlobalValue() : kb_access_metering.NIL));
        kb_access_metering.$arete_last_nart_touched$ = SubLFiles.deflexical("*ARETE-LAST-NART-TOUCHED*", (SubLObject)((kb_access_metering.NIL != Symbols.boundp((SubLObject)kb_access_metering.$sym3$_ARETE_LAST_NART_TOUCHED_)) ? kb_access_metering.$arete_last_nart_touched$.getGlobalValue() : kb_access_metering.NIL));
        ...
        kb_access_metering.$kb_access_metering_enabledP$ = SubLFiles.deflexical("*KB-ACCESS-METERING-ENABLED?*", (SubLObject)((kb_access_metering.NIL != Symbols.boundp((SubLObject)kb_access_metering.$sym4$_KB_ACCESS_METERING_ENABLED__)) ? kb_access_metering.$kb_access_metering_enabledP$.getGlobalValue() : kb_access_metering.NIL));
