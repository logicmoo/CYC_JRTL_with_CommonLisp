...
public final class file_hash_table extends SubLTranslatedFile
{
    ...
    public static SubLObject init_file_hash_table_file() {
        ...
        file_hash_table.$fht_serialization_table$ = SubLFiles.deflexical("*FHT-SERIALIZATION-TABLE*", maybeDefault((SubLObject)file_hash_table.$sym202$_FHT_SERIALIZATION_TABLE_, file_hash_table.$fht_serialization_table$, ()->(dictionary.new_dictionary((SubLObject)file_hash_table.UNPROVIDED, (SubLObject)file_hash_table.UNPROVIDED))));
        file_hash_table.$fht_lookup_stream$ = SubLFiles.defparameter("*FHT-LOOKUP-STREAM*", (SubLObject)file_hash_table.NIL);
        file_hash_table.$fht_not_found$ = SubLFiles.deflexical("*FHT-NOT-FOUND*", maybeDefault((SubLObject)file_hash_table.$sym227$_FHT_NOT_FOUND_, file_hash_table.$fht_not_found$, ()->(Symbols.make_symbol((SubLObject)file_hash_table.$str228$FileHashTable_Not_Found))));
        file_hash_table.$not_in_fht$ = SubLFiles.deflexical("*NOT-IN-FHT*", maybeDefault((SubLObject)file_hash_table.$sym229$_NOT_IN_FHT_, file_hash_table.$not_in_fht$, ()->(Symbols.make_symbol((SubLObject)file_hash_table.$str230$Not_In_FHT))));
