      ...
      SubLTranslatedFile
{
  ...
  public static SubLObject forget_ephemeral_terms(SubLObject verboseP)
  {
    ...
    if( NIL != verboseP )
    {
      ...
      try
      {
        utilities_macros.$progress_note$.bind( ( NIL != Sequences.cconcatenate( $str0$Forgetting_, new SubLObject[] { format_nil.format_nil_a_no_copy( Sequences.length( ephemeral_terms ) ), $str1$_ephemeral_terms
        } ) ) ? Sequences.cconcatenate( $str0$Forgetting_, new SubLObject[] { format_nil.format_nil_a_no_copy( Sequences.length( ephemeral_terms ) ), $str1$_ephemeral_terms
        } ) : $str2$cdolist, thread );
  ...
  {
    return kb_indexing.num_predicate_extent_index( $const3$ephemeralTerm, UNPROVIDED );
  }
  ...
  {
    return makeBoolean( NIL != forts.fort_p( v_object ) && NIL != kb_mapping_utilities.fpred_value_in_any_mt( v_object, $const3$ephemeralTerm, ONE_INTEGER, ONE_INTEGER, UNPROVIDED ) );
  }

  @SubLTranslatedFile.SubL(source = "cycl/kb-cleanup.lisp", position = 3694L)
  public static SubLObject all_ephemeral_terms()
  {
    return list_utilities.fast_delete_duplicates( Sequences.cconcatenate( all_strictly_ephemeral_terms(), all_naked_in_progress_terms() ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/kb-cleanup.lisp", position = 3952L)
  public static SubLObject all_strictly_ephemeral_terms()
  {
    return kb_mapping_utilities.pred_refs_in_any_mt( $const3$ephemeralTerm, ONE_INTEGER, $kw4$TRUE );
  }
  ...
  {
    return makeBoolean( NIL != forts.fort_p( v_object ) && NIL != kb_mapping_utilities.fpred_value_in_any_mt( v_object, $const5$inProgressTerm, ONE_INTEGER, ONE_INTEGER, UNPROVIDED )
        && NIL != nothing_said_about_in_progress_termP( v_object ) );
  }
  ...
  {
    return Numbers.numE( kb_indexing.num_index( v_term ), ONE_INTEGER );
  }
  ...
  public static SubLObject all_naked_in_progress_terms_internal(final SubLObject accumulator)
  {
    ...
    try
    {
      ...
      final SubLObject pred_var = $const5$inProgressTerm;
        ...
        try
        {
          ...
          while ( NIL == done_var)
          {
            ...
            if( NIL != valid )
            {
              ...
              try
              {
                final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, $kw8$GAF, $kw4$TRUE, NIL );
  ...
  public static SubLObject forget_ill_formed_skolems()
  {
    ...
    SubLObject cdolist_list_var = isa.all_fort_instances( $const10$SkolemFunction, UNPROVIDED, UNPROVIDED );
  ...
  {
    return forget_narts( gather_useless_narts(), $str11$forgetting_useless_NARTs );
  }
  ...
  public static SubLObject gather_useless_narts()
  {
    ...
    final SubLObject mess = $str12$Gathering_useless_NARTs;
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL == id_index.id_index_objects_empty_p( idx_$8, $kw14$SKIP ) )
        {
          final SubLObject idx_$9 = idx_$8;
          if( NIL == id_index.id_index_dense_objects_empty_p( idx_$9, $kw14$SKIP ) )
          {
            ...
            for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
            {
              ...
              if( NIL == id_index.id_index_tombstone_p( nart ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
              {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      {
                        v_answer = ConsesLow.cons( nart, v_answer );
                      }
                    }
          ...
          if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$10 ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
          {
            ...
            while ( id2.numL( end_id ))
            {
              ...
              if( NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) || NIL == id_index.id_index_tombstone_p( nart2 ) )
              {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      {
                        v_answer = ConsesLow.cons( nart2, v_answer );
                      }
                    }
                ...
                {
                  ignore_errors_tag2 = Errors.handleThrowable( ccatch_env_var2, $kw15$IGNORE_ERRORS_TARGET );
                }
                finally
                {
                  thread.throwStack.pop();
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          try
          {
            utilities_macros.$progress_note$.bind( ( NIL != progress_message ) ? progress_message : $str2$cdolist, thread );
            utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      {
                        PrintLow.format( T, $str17$Forgetting_NART__S__, nart );
  ...
  {
    final SubLObject message = Sequences.cconcatenate( $str18$Forgetting_the_extent_of_, format_nil.format_nil_s_no_copy( function ) );
    final SubLObject narts = Mapping.mapcar( Symbols.symbol_function( $sym19$GAF_ARG1 ), kb_mapping.gather_function_extent_index( function ) );
  ...
  public static SubLObject forget_invalid_deductions_and_kb_hl_supports_until_quiesced(SubLObject only_newP, SubLObject max_iteration_count, SubLObject verboseP)
  {
    ...
    for( SubLObject doneP = NIL; NIL == doneP; doneP = T )
    {
      ...
      PrintLow.format( T, $str21$Iteration__A__Removed__A_deductio, new SubLObject[] { iteration_count, invalid_deduction_count, invalid_kb_hl_support_count
      } );
    ...
    PrintLow.format( T, $str23$Total__Removed__A_deductions_and_, removed_deduction_count, removed_kb_hl_support_count );
  ...
  public static SubLObject forget_syntactically_invalid_new_deductions()
  {
    ...
    try
    {
      ...
      try
      {
        utilities_macros.noting_percent_progress_preamble( $str24$Identifying_invalid_deductions );
        SubLObject end_var;
        SubLObject end;
        SubLObject id;
        SubLObject ded;
        ...
        {
          ded = id_index.id_index_lookup( table_var, id, UNPROVIDED );
          if( NIL != ded )
          {
            utilities_macros.note_percent_progress( sofar, total );
            sofar = Numbers.add( sofar, ONE_INTEGER );
            ...
            {
              invalid_deductions = ConsesLow.cons( ded, invalid_deductions );
            }
          }
        }
      }
    ...
    if( NIL != invalid_deductions )
    {
      ...
      try
      {
        utilities_macros.$progress_note$.bind( $str25$Removing_invalid_deductions, thread );
        utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
        utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
        utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
        utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
  ...
  public static SubLObject forget_syntactically_invalid_new_kb_hl_supports()
  {
    ...
    try
    {
      ...
      try
      {
        utilities_macros.noting_percent_progress_preamble( $str26$Identifying_invalid_kb_hl_support );
        SubLObject end_var;
        SubLObject end;
        SubLObject id;
        ...
        {
          kb_hl_support = id_index.id_index_lookup( table_var, id, UNPROVIDED );
          if( NIL != kb_hl_support )
          {
            ...
            {
              invalid_kb_hl_supports = ConsesLow.cons( kb_hl_support, invalid_kb_hl_supports );
            }
          }
        }
      }
    ...
    if( NIL != invalid_kb_hl_supports )
    {
      ...
      try
      {
        utilities_macros.$progress_note$.bind( $str27$Removing_invalid_kb_hl_supports, thread );
        utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
        utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
        utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
        utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
  ...
  {
    final SubLObject bad_deductions = process_utilities.new_ipc_queue( $str28$Invalid_Deductions );
  ...
  public static SubLObject forget_invalid_deductions_serial(final SubLObject invalid_deductions)
  {
    ...
    if( !process_utilities.ipc_current_queue_size( invalid_deductions ).isZero() )
    {
      ...
      final SubLObject msg = Sequences.cconcatenate( $str29$Removing_or_rejustifying_, new SubLObject[] { format_nil.format_nil_a_no_copy( Sequences.length( bad_deductions ) ), $str30$_invalid_deductions
      } );
      ...
      try
      {
        utilities_macros.$progress_note$.bind( ( NIL != msg ) ? msg : $str2$cdolist, thread );
        utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
        utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
        utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
        utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
        ...
        try
        {
          ...
          while ( NIL != csome_list_var)
          {
            format_nil.force_format( T, $str31$__Bad_deduction__S___S__S, deduction, deductions_high.deduction_supported_object( deduction ), deductions_high.deduction_supports( deduction ), UNPROVIDED, UNPROVIDED,
                UNPROVIDED, UNPROVIDED, UNPROVIDED );
            if( NIL != tms.tms_remove_deduction( deduction ) )
            {
              removed_deduction = Numbers.add( removed_deduction, ONE_INTEGER );
            }
            count = Numbers.add( count, ONE_INTEGER );
            utilities_macros.$progress_sofar$.setDynamicValue( Numbers.add( utilities_macros.$progress_sofar$.getDynamicValue( thread ), ONE_INTEGER ), thread );
            utilities_macros.note_percent_progress( utilities_macros.$progress_sofar$.getDynamicValue( thread ), utilities_macros.$progress_total$.getDynamicValue( thread ) );
  ...
  public static SubLObject identify_invalid_deductions_serial(final SubLObject bad_deductions)
  {
    ...
    final SubLObject mess = $str32$Finding_invalid_deductions;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = ZERO_INTEGER;
    assert NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL == id_index.id_index_objects_empty_p( idx_$28, $kw14$SKIP ) )
        {
          final SubLObject idx_$29 = idx_$28;
          if( NIL == id_index.id_index_dense_objects_empty_p( idx_$29, $kw14$SKIP ) )
          {
            ...
            for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
            {
              ...
              if( NIL == id_index.id_index_tombstone_p( d_handle ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
              {
                ...
                try
                {
                  ...
                  try
                  {
                    Errors.$error_handler$.bind( $sym33$CATCH_ERROR_MESSAGE_HANDLER, thread );
                    try
                    {
                ...
                if( msg.isString() )
                {
                  un_analyzable_deductions = Numbers.add( un_analyzable_deductions, ONE_INTEGER );
          ...
          if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$30 ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
          {
            ...
            while ( d_id2.numL( end_id ))
            {
              ...
              if( NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) || NIL == id_index.id_index_tombstone_p( d_handle2 ) )
              {
  ...
  public static SubLObject identify_invalid_deductions_n_way(final SubLObject bad_deductions, final SubLObject num_of_workers)
  {
    ...
    SubLObject clicker;
    SubLObject worker;
    for( slice_id = NIL, slice_id = ZERO_INTEGER; slice_id.numL( num_of_workers ); slice_id = Numbers.add( slice_id, ONE_INTEGER ) )
    {
      worker_name = Sequences.cconcatenate( $str36$Invalid_Deduction_Worker_, format_nil.format_nil_a_no_copy( Numbers.add( ONE_INTEGER, slice_id ) ) );
      clicker = Semaphores.new_semaphore( worker_name, ZERO_INTEGER );
      worker = subl_promotions.make_process_with_args( worker_name, $sym37$IDENTIFY_INVALID_DEDUCTIONS_WORKER, ConsesLow.list( bad_deductions, slice_id, num_of_workers, clicker ) );
      map_utilities.map_put( percentages, worker, clicker );
    }
    final SubLObject progress = Sequences.cconcatenate( $str38$Finding_invalid_deductions_using_, new SubLObject[] { format_nil.format_nil_a_no_copy( num_of_workers ), $str39$_workers_____
    } );
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    final SubLObject _prev_bind_2 = utilities_macros.$last_percent_progress_prediction$.currentBinding( thread );
    final SubLObject _prev_bind_3 = utilities_macros.$within_noting_percent_progress$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        utilities_macros.note_percent_progress( ZERO_INTEGER, $int40$100 );
        while ( NIL == map_utilities.map_empty_p( percentages ))
        {
          ...
          for( SubLObject done_var = NIL; NIL == done_var; done_var = makeBoolean( NIL == valid ) )
          {
            ...
            if( NIL != valid )
            {
              ...
              if( NIL == current )
              {
                if( NIL != Threads.valid_process_p( worker2 ) )
                {
                  Semaphores.semaphore_wait( clicker2 );
                }
                else
                {
                  stale_workers = ConsesLow.cons( worker2, stale_workers );
                }
              }
              else
              {
          ...
          percent = Numbers.add( percent, ONE_INTEGER );
          utilities_macros.note_percent_progress( percent, $int40$100 );
  ...
  public static SubLObject identify_invalid_deductions_worker(final SubLObject bad_deductions, final SubLObject slice_id, final SubLObject num_of_slices, final SubLObject clicker)
  {
    ...
    for( i = NIL, i = ZERO_INTEGER; i.numL( deductions ); i = Numbers.add( i, ONE_INTEGER ) )
    {
  ...
  public static SubLObject deduction_has_invalid_supportP(final SubLObject deduction)
  {
    ...
    if( NIL == mal )
    {
      ...
      SubLObject support;
      for( csome_list_var = supports, support = NIL, support = csome_list_var.first(); NIL == mal && NIL != csome_list_var; mal = arguments.ill_formed_hl_supportP( support ), csome_list_var = csome_list_var
  ...
  public static SubLObject forget_useless_kb_hl_supports(SubLObject verboseP)
  {
    ...
    SubLObject removed;
    for( SubLObject doneP = NIL; NIL == doneP; doneP = Numbers.zerop( removed ) )
    {
    ...
    {
      PrintLow.format( T, $str43$__Removed_a_total_of__A_useless_K, total_removed, pass );
    }
  ...
  public static SubLObject forget_useless_kb_hl_supports_impl(final SubLObject pass, SubLObject verboseP)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject map_msg = Sequences.cconcatenate( $str44$Pass_, new SubLObject[] { format_nil.format_nil_a_no_copy( pass ), $str45$__Identifying_useless_KB_HL_suppo
    } );
    final SubLObject reduce_msg = Sequences.cconcatenate( $str44$Pass_, new SubLObject[] { format_nil.format_nil_a_no_copy( pass ), $str46$__Removing_useless_KB_HL_supports
    } );
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL == id_index.id_index_objects_empty_p( idx_$35, $kw14$SKIP ) )
        {
          final SubLObject idx_$36 = idx_$35;
          if( NIL == id_index.id_index_dense_objects_empty_p( idx_$36, $kw14$SKIP ) )
          {
            ...
            for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
            {
              ...
              if( NIL == id_index.id_index_tombstone_p( s_handle ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
              {
                ...
                {
                  bad_hl_supports = ConsesLow.cons( kb_hl_support, bad_hl_supports );
                }
                sofar = Numbers.add( sofar, ONE_INTEGER );
                utilities_macros.note_percent_progress( sofar, total );
              }
          ...
          if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$37 ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
          {
            ...
            while ( s_id2.numL( end_id ))
            {
              ...
              if( NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) || NIL == id_index.id_index_tombstone_p( s_handle2 ) )
              {
                ...
                {
                  bad_hl_supports = ConsesLow.cons( kb_hl_support2, bad_hl_supports );
                }
                sofar = Numbers.add( sofar, ONE_INTEGER );
                utilities_macros.note_percent_progress( sofar, total );
              }
    ...
    try
    {
      utilities_macros.$progress_note$.bind( ( NIL != reduce_msg ) ? reduce_msg : $str2$cdolist, thread );
      utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
      utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
      utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
      utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
    ...
    {
      PrintLow.format( T, $str48$__Removed__A_useless_KB_HL_suppor, count, pass );
    }
    return count;
  }
  ...
  public static SubLObject forget_old_creation_seconds()
  {
    ...
    try
    {
      utilities_macros.$progress_note$.bind( $str49$Forgetting_old_creation_seconds, thread );
      utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
      utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
      utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
      utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
  ...
  public static SubLObject gather_old_creation_seconds()
  {
    ...
    final SubLObject total = kb_indexing.num_predicate_extent_index( $const50$myCreationSecond, UNPROVIDED );
    SubLObject sofar = ZERO_INTEGER;
    SubLObject v_answer = NIL;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    final SubLObject _prev_bind_2 = utilities_macros.$last_percent_progress_prediction$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        utilities_macros.noting_percent_progress_preamble( $str51$Examining_creation_seconds );
        ...
        try
        {
          mt_relevance_macros.$relevant_mt_function$.bind( $sym6$RELEVANT_MT_IS_EVERYTHING, thread );
          mt_relevance_macros.$mt$.bind( $const7$EverythingPSC, thread );
          final SubLObject pred_var = $const50$myCreationSecond;
          if( NIL != kb_mapping_macros.do_predicate_extent_index_key_validator( pred_var ) )
          {
            final SubLObject str = NIL;
  ...
  public static SubLObject clean_assertion_assert_info()
  {
    ...
    try
    {
      ...
      try
      {
        ...
        final SubLObject mess = $str52$Cleaning_KBS_assert_info;
        final SubLObject total = id_index.id_index_count( idx );
        SubLObject sofar = ZERO_INTEGER;
        assert NIL != Types.stringp( mess ) : mess;
        ...
        try
        {
          ...
          try
          {
            ...
            if( NIL == id_index.id_index_objects_empty_p( idx_$55, $kw14$SKIP ) )
            {
              final SubLObject idx_$56 = idx_$55;
              if( NIL == id_index.id_index_dense_objects_empty_p( idx_$56, $kw14$SKIP ) )
              {
                ...
                for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
                {
                  ...
                  if( NIL == id_index.id_index_tombstone_p( a_handle ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
                  {
                    ...
                    {
                      asserted_by_value = ( NIL != forts.invalid_fortP( assertions_high.asserted_by( assertion ) ) ) ? NIL : $kw53$UNCHANGED;
                      asserted_why_value = ( NIL != forts.invalid_fortP( assertions_high.asserted_why( assertion ) ) ) ? NIL : $kw53$UNCHANGED;
                      if( NIL == asserted_by_value || NIL == asserted_why_value )
                      {
                        ...
                        assertions_high.timestamp_asserted_assertion( assertion, asserted_by_value, $kw53$UNCHANGED, asserted_why_value, $kw53$UNCHANGED );
                      }
                    }
                    sofar = Numbers.add( sofar, ONE_INTEGER );
                    utilities_macros.note_percent_progress( sofar, total );
              ...
              if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$57 ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
              {
                ...
                while ( a_id2.numL( end_id ))
                {
                  ...
                  if( NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) || NIL == id_index.id_index_tombstone_p( a_handle2 ) )
                  {
                    ...
                    {
                      final SubLObject asserted_by_value2 = ( NIL != forts.invalid_fortP( assertions_high.asserted_by( assertion2 ) ) ) ? NIL : $kw53$UNCHANGED;
                      final SubLObject asserted_why_value2 = ( NIL != forts.invalid_fortP( assertions_high.asserted_why( assertion2 ) ) ) ? NIL : $kw53$UNCHANGED;
                      if( NIL == asserted_by_value2 || NIL == asserted_why_value2 )
                      {
                        ...
                        assertions_high.timestamp_asserted_assertion( assertion2, asserted_by_value2, $kw53$UNCHANGED, asserted_why_value2, $kw53$UNCHANGED );
                      }
                    }
                    sofar = Numbers.add( sofar, ONE_INTEGER );
                    utilities_macros.note_percent_progress( sofar, total );
  ...
  public static SubLObject duplicate_nart_tuples(SubLObject via_tou_assertionsP)
  {
    ...
    if( NIL != via_tou_assertionsP )
    {
      ...
      try
      {
        mt_relevance_macros.$relevant_mt_function$.bind( $sym54$RELEVANT_MT_IS_EQ, thread );
        mt_relevance_macros.$mt$.bind( mt_vars.$tou_mt$.getGlobalValue(), thread );
        final SubLObject pred_var = $const55$termOfUnit;
        if( NIL != kb_mapping_macros.do_predicate_extent_index_key_validator( pred_var ) )
        {
          final SubLObject str = NIL;
    ...
    else
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if( NIL == id_index.id_index_objects_empty_p( idx_$66, $kw14$SKIP ) )
          {
            final SubLObject idx_$67 = idx_$66;
            if( NIL == id_index.id_index_dense_objects_empty_p( idx_$67, $kw14$SKIP ) )
            {
              ...
              for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
              {
                ...
                if( NIL == id_index.id_index_tombstone_p( nart2 ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
                {
            ...
            if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$68 ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
            {
              ...
              while ( id2.numL( end_id ))
              {
                ...
                if( NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) || NIL == id_index.id_index_tombstone_p( nart3 ) )
                {
        ...
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      ...
      if( NIL == list_utilities.singletonP( narts ) )
      {
        ...
        tuples = ConsesLow.cons( Sequences.reverse( narts ), tuples );
      }
    }
  ...
  public static SubLObject duplicate_narts_to_kill()
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      final SubLObject keep_nart = number_utilities.maximum( narts, $sym58$NUM_INDEX );
      final SubLObject kill_narts = Sequences.remove( keep_nart, narts, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject duplicate_assertion_tuples(SubLObject ids)
  {
    ...
    {
      final SubLObject dict = dictionary.new_dictionary( Symbols.symbol_function( EQUAL ), UNPROVIDED );
      final SubLObject progress_message = Sequences.cconcatenate( $str59$Examining_, new SubLObject[] { format_nil.format_nil_a_no_copy( Sequences.length( ids ) ), $str60$_assertions_for_duplication
      } );
    ...
    final SubLObject mt_dict = dictionary.new_dictionary( Symbols.symbol_function( EQUAL ), UNPROVIDED );
    SubLObject tuples = NIL;
    final SubLObject idx = assertion_handles.do_assertions_table();
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL == id_index.id_index_objects_empty_p( idx_$71, $kw14$SKIP ) )
        {
          final SubLObject idx_$72 = idx_$71;
          if( NIL == id_index.id_index_dense_objects_empty_p( idx_$72, $kw14$SKIP ) )
          {
          ...
          if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$73 ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
          {
    ...
    try
    {
      ...
      try
      {
        utilities_macros.noting_percent_progress_preamble( $str62$Examining_all_assertions_for_dupl );
        SubLObject iteration_state;
        for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( mt_dict ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
            iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
        {
          thread.resetMultipleValues();
          final SubLObject key = dictionary_contents.do_dictionary_contents_key_value( iteration_state );
          ...
          thread.resetMultipleValues();
          final SubLObject dict_in_an_mt = dictionary.new_dictionary( Symbols.symbol_function( EQUAL ), UNPROVIDED );
          ...
          while ( NIL != cdolist_list_var)
          {
            ...
            assertion_num = Numbers.add( assertion_num, ONE_INTEGER );
  ...
  public static SubLObject consider_that_assertion_could_be_duplicate(final SubLObject ass, final SubLObject dict, final SubLObject consider_mtP)
  {
    ...
    {
      final SubLObject key = ( NIL != consider_mtP ) ? ConsesLow.cons( assertion_cnf_or_gaf_formula( ass ), assertions_high.assertion_mt( ass ) ) : assertion_cnf_or_gaf_formula( ass );
  ...
  public static SubLObject duplicate_tuples_from_dictionary(final SubLObject dict)
  {
        ...
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      ...
      if( NIL == list_utilities.singletonP( assertions ) )
      {
        ...
        tuples = ConsesLow.cons( sorted_assertions, tuples );
      }
    }
    dictionary_contents.do_dictionary_contents_finalize( iteration_state );
    return Sequences.nreverse( tuples );
  ...
  {
    final SubLObject clean = Sequences.remove_if( $sym63$CANONICALIZER_PROBLEM_, assertions, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL != clean )
    {
      return list_utilities.move_to_front( clean.first(), assertions, UNPROVIDED );
    }
    Errors.warn( $str64$could_not_find_an_obvious_keeper_, Mapping.mapcar( $sym65$ASSERTION_ID, assertions ) );
    return assertions;
  }
  ...
  public static SubLObject blast_duplicate_assertions(SubLObject ids)
  {
    ...
    final SubLObject progress_message = Sequences.cconcatenate( $str66$Blasting_approximately_, new SubLObject[] { format_nil.format_nil_a_no_copy( Sequences.length( tuples ) ), $str67$_duplicate_assertions
    } );
  ...
  public static SubLObject blast_duplicate_assertions_without_keepers(SubLObject ids)
  {
    ...
    SubLObject count = ZERO_INTEGER;
    final SubLObject tuples = duplicate_assertion_tuples( ids );
    final SubLObject progress_message = Sequences.cconcatenate( $str66$Blasting_approximately_, new SubLObject[] { format_nil.format_nil_a_no_copy( Numbers.multiply( TWO_INTEGER, Sequences.length( tuples ) ) ),
      $str67$_duplicate_assertions
    } );
    final SubLObject list_var = tuples;
    final SubLObject _prev_bind_0 = utilities_macros.$progress_note$.currentBinding( thread );
    final SubLObject _prev_bind_2 = utilities_macros.$progress_start_time$.currentBinding( thread );
  ...
  public static SubLObject reconsider_assertions_with_no_arguments_verbose(SubLObject return_idsP)
  {
    ...
    SubLObject cdolist_list_var;
    final SubLObject removed = cdolist_list_var = reconsider_assertions_with_no_arguments( $kw69$RETURN_IDS );
    SubLObject id = NIL;
    id = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      PrintLow.format( T, $str70$_______assertion__A_proved_unnece, id );
      cdolist_list_var = cdolist_list_var.rest();
      id = cdolist_list_var.first();
    }
    return ( NIL != return_idsP ) ? removed : Sequences.length( removed );
  }
  ...
  public static SubLObject reconsider_assertions_with_no_arguments(SubLObject return_idsP)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL == id_index.id_index_objects_empty_p( idx_$78, $kw14$SKIP ) )
        {
          final SubLObject idx_$79 = idx_$78;
          if( NIL == id_index.id_index_dense_objects_empty_p( idx_$79, $kw14$SKIP ) )
          {
          ...
          if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$80 ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
          {
  ...
  public static SubLObject detect_multiples_via_lexicon(final SubLObject type, SubLObject default_dupe_type, SubLObject mt, SubLObject preds)
  {
    ...
    {
      default_dupe_type = $kw72$SAME;
    }
    if( mt == UNPROVIDED )
    {
      mt = $const73$InferencePSC;
    }
    if( preds == UNPROVIDED )
    {
      preds = $list74;
    ...
    final SubLObject dupe_type = ( default_dupe_type == $kw72$SAME ) ? type : default_dupe_type;
    ...
    try
    {
      utilities_macros.$progress_note$.bind( $str2$cdolist, thread );
      utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
      utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
      utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
      utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
      ...
      try
      {
        ...
        while ( NIL != csome_list_var)
        {
          ...
          while ( NIL != cdolist_list_var)
          {
            ...
            final SubLObject other_denots = cdolist_list_var_$82 = Sequences.remove( instance, lexicon_accessors.typed_denots_of_string( name, dupe_type, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED,
    ...
    SubLObject iteration_state;
    for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( dups_dict ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      thread.resetMultipleValues();
      ...
      thread.resetMultipleValues();
      PrintLow.format( T, $str75$_S_____A__, string, denots );
    }
    dictionary_contents.do_dictionary_contents_finalize( iteration_state );
  ...
  public static SubLObject new_and_removed_infn_narts(final SubLObject old_kbnum, final SubLObject new_kbnum, SubLObject stream, SubLObject dir)
  {
    ...
    return new_and_removed_narts( $const76$InstanceNamedFn_Ternary, old_kbnum, new_kbnum, stream, dir );
  }
  ...
  public static SubLObject new_and_removed_narts(final SubLObject functor, final SubLObject old_kbnum, final SubLObject new_kbnum, SubLObject stream, SubLObject dir)
  {
    ...
    final SubLObject all_narts = set_utilities.set_union( ConsesLow.list( narts_in_old_kb, narts_in_new_kb ), EQUAL );
    final SubLObject common_narts = set_utilities.set_intersection( ConsesLow.list( narts_in_old_kb, narts_in_new_kb ), EQUAL );
    ...
    PrintLow.format( stream, $str78$_A_new_narts_added_between_KB__S_, new SubLObject[] { set.set_size( new_narts ), old_kbnum, new_kbnum
    } );
    PrintLow.format( stream, $str79$_A_narts_departed_between_KB__S_a, new SubLObject[] { set.set_size( departed_narts ), old_kbnum, new_kbnum
    } );
    PrintLow.format( stream, $str80$____________________New_NARTs____ );
    ...
    try
    {
          ...
          .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        {
          PrintLow.format( stream, $str81$_S__, nart );
        }
      }
      PrintLow.format( stream, $str82$____________________Departed_NART );
    ...
    return ConsesLow.list( set.set_size( new_narts ), set.set_size( departed_narts ) );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $functor_narts_in_kb_caching_state$.getGlobalValue(), ConsesLow.list( functor, kb_num, dir ), UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject nart_file = Sequences.cconcatenate( format_nil.format_nil_a_no_copy( dir ), new SubLObject[] { $str84$KB_, format_nil.format_nil_a_no_copy( kb_num ), $str85$_, format_nil.format_nil_a_no_copy(
        kb_paths.fort_name( functor ) ), $str86$_NARTS_txt
    } );
    ...
    try
    {
      ...
      try
      {
        ...
        stream = compatibility.open_text( nart_file, $kw88$INPUT );
      }
      finally
      {
      ...
      if( infile.isStream() )
      {
        ...
        {
          line_value = reader.read_from_string_ignoring_errors( line, NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject functor_narts_in_kb(final SubLObject functor, final SubLObject kb_num, final SubLObject dir)
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym83$FUNCTOR_NARTS_IN_KB, $sym90$_FUNCTOR_NARTS_IN_KB_CACHING_STATE_, NIL, EQUAL, THREE_INTEGER, ZERO_INTEGER );
    }
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( functor_narts_in_kb_internal( functor, kb_num, dir ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( functor, kb_num, dir ) );
  ...
  public static SubLObject fcp_sweep(final SubLObject filename)
  {
    ...
    try
    {
      stream = compatibility.open_text( filename, $kw92$OUTPUT );
      if( !stream.isStream() )
      {
        Errors.error( $str89$Unable_to_open__S, filename );
      }
      final SubLObject stream_$84 = stream;
      PrintLow.format( stream_$84, $str93$___functionCorrespondingPredicate, numeric_date_utilities.timestring( UNPROVIDED ) );
      final SubLObject list_var;
      ...
      try
      {
        utilities_macros.$progress_note$.bind( $str94$Writing_KE_text___, thread );
        utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
        utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
        utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
        utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
  ...
  public static SubLObject functions_for_fcp_sweep()
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym6$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( $const7$EverythingPSC, thread );
      final SubLObject list_var = isa.all_instances( $const95$UnaryFunction, UNPROVIDED, UNPROVIDED );
      ...
      try
      {
        utilities_macros.$progress_note$.bind( $str96$Gathering_functions___, thread );
        utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
        utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
        utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
        utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
        ...
        try
        {
          ...
          while ( NIL != csome_list_var)
          {
            if( NIL != constant_handles.constant_p( func ) && NIL == list_utilities.member_kbeqP( func, $functions_to_skip_for_fcp_sweep$.getGlobalValue() ) && NIL == relation_evaluation.evaluatable_functionP( func )
                && NIL == hl_prototypes.hl_prototypical_instanceP( func ) && NIL == inference_trivial.new_cyc_trivial_query( ConsesLow.listS( $const97$functionCorrespondingPredicate_Ge, func, $list98 ),
                    $const73$InferencePSC, $list99 ) )
            {
              result = ConsesLow.cons( func, result );
            }
            utilities_macros.$progress_sofar$.setDynamicValue( Numbers.add( utilities_macros.$progress_sofar$.getDynamicValue( thread ), ONE_INTEGER ), thread );
            utilities_macros.note_percent_progress( utilities_macros.$progress_sofar$.getDynamicValue( thread ), utilities_macros.$progress_total$.getDynamicValue( thread ) );
            csome_list_var = csome_list_var.rest();
  ...
  public static SubLObject ke_text_for_unary_function_fcp(final SubLObject func)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject result = NIL;
    final SubLObject mt_var = mt_relevance_macros.with_inference_mt_relevance_validate( $const101$UniversalVocabularyMt );
    final SubLObject _prev_bind_0 = mt_relevance_macros.$mt$.currentBinding( thread );
    final SubLObject _prev_bind_2 = mt_relevance_macros.$relevant_mt_function$.currentBinding( thread );
    final SubLObject _prev_bind_3 = mt_relevance_macros.$relevant_mts$.currentBinding( thread );
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      result = Sequences.cconcatenate( $str102$____, new SubLObject[] { format_nil.format_nil_a_no_copy( func ), $str103$_constant__, format_nil.format_nil_a_no_copy( fcp_name( func ) ), $str104$_, format_nil
          .format_nil_a_no_copy( fcp_blake_note( func ) ), $str105$_in_mt__UniversalVocabularyMt__is, format_nil.format_nil_a_no_copy( fcp_arg1_isa( func ) ), $str106$__arg2Isa__, format_nil.format_nil_a_no_copy(
              fcp_arg2_isa( func ) ), $str107$__arg2Format__singleEntryFormatIn, format_nil.format_nil_s_no_copy( fcp_comment( func ) ), $str108$__f___functionCorrespondingPredic, format_nil.format_nil_a_no_copy( func ),
        $str109$_, format_nil.format_nil_a_no_copy( fcp_name( func ) ), $str110$_2____
      } );
    }
    finally
    {
  ...
  public static SubLObject fcp_name(final SubLObject func)
  {
    ...
    final SubLObject new_name = Sequences.cconcatenate( fcp_name_int( func ), $str111$Of );
    if( NIL != constants_high.find_constant( new_name ) || NIL != constant_completion_high.constant_name_case_collision( new_name ) )
    {
      return Sequences.cconcatenate( $str112$blakePleaseRenameThis_ItsTheFunct, constants_high.constant_name( func ) );
    }
    return new_name;
  }
  ...
  {
    if( NIL != string_utilities.ends_with( constants_high.constant_name( func ), $str113$Fn, UNPROVIDED ) )
    {
    ...
    if( NIL != fcp_ends_with_fn_but_has_a_dashed_bit_at_the_endP( func ) )
    {
      ...
      final SubLObject dash_pos = Numbers.add( pos, TWO_INTEGER );
    ...
    if( NIL != isa.isaP( func, $const115$UnitOfMeasureConcept, UNPROVIDED, UNPROVIDED ) )
    {
      return string_utilities.uncapitalize_first( Sequences.cconcatenate( constants_high.constant_name( func ), $str116$versionOf ) );
    }
    return Sequences.cconcatenate( $str112$blakePleaseRenameThis_ItsTheFunct, constants_high.constant_name( func ) );
  }
  ...
  {
    return string_utilities.uncapitalize_first( string_utilities.substring( name, ZERO_INTEGER, Numbers.subtract( Sequences.length( name ), TWO_INTEGER ) ) );
  }
  ...
  {
    return Sequences.cconcatenate( $str119$A_predicate_corresponding_to_the_, new SubLObject[] { format_nil.format_nil_a_no_copy( func ), $str120$____code____, format_nil.format_nil_a_no_copy( fcp_name( func ) ),
      $str121$_X__, format_nil.format_nil_a_no_copy( func ), $str122$_X____code__will_always_be_true_f
    } );
  }
  ...
  {
    return string_utilities.substring( string, ONE_INTEGER, Numbers.subtract( Sequences.length( string ), ONE_INTEGER ) );
  }
  ...
  {
    return ConsesLow.list( func, fcp_name( func ) );
  }
  ...
  public static SubLObject assertions_with_more_than_one_belief()
  {
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL == id_index.id_index_objects_empty_p( idx_$89, $kw14$SKIP ) )
        {
          final SubLObject idx_$90 = idx_$89;
          if( NIL == id_index.id_index_dense_objects_empty_p( idx_$90, $kw14$SKIP ) )
          {
          ...
          if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$91 ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
          {
  ...
  {
    final SubLObject belief_count = Sequences.count_if( $sym125$BELIEF_P, assertions_high.assertion_arguments( assertion ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject fixed_arity_relations_without_arities()
  {
    ...
    final SubLObject node_var = $const126$FixedArityRelation;
    final SubLObject _prev_bind_0 = sbhl_module_vars.$sbhl_module$.currentBinding( thread );
    final SubLObject _prev_bind_2 = sbhl_marking_vars.$sbhl_gather_space$.currentBinding( thread );
    try
    {
      sbhl_module_vars.$sbhl_module$.bind( sbhl_module_vars.get_sbhl_module( $const127$isa ), thread );
      sbhl_marking_vars.$sbhl_gather_space$.bind( sbhl_marking_vars.get_sbhl_marking_space(), thread );
      try
      {
        SubLObject node_var_$93 = node_var;
        final SubLObject deck_type = $kw130$STACK;
        ...
        try
        {
          ...
          try
          {
            ...
            try
            {
              ...
              sbhl_search_vars.$relevant_sbhl_tv_function$.bind( ( NIL != tv_var ) ? $sym131$RELEVANT_SBHL_TV_IS_GENERAL_TV : sbhl_search_vars.$relevant_sbhl_tv_function$.getDynamicValue( thread ), thread );
              if( NIL != tv_var && NIL != sbhl_paranoia.sbhl_object_type_checking_p() && NIL == sbhl_search_vars.sbhl_true_tv_p( tv_var ) )
              {
                final SubLObject pcase_var = sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread );
                if( pcase_var.eql( $kw132$ERROR ) )
                {
                  sbhl_paranoia.sbhl_error( ONE_INTEGER, $str133$_A_is_not_a__A, tv_var, $sym134$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                }
                else if( pcase_var.eql( $kw135$CERROR ) )
                {
                  sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str136$continue_anyway, $str133$_A_is_not_a__A, tv_var, $sym134$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                }
                else if( pcase_var.eql( $kw137$WARN ) )
                {
                  Errors.warn( $str133$_A_is_not_a__A, tv_var, $sym134$SBHL_TRUE_TV_P );
                }
                else
                {
                  Errors.warn( $str138$_A_is_not_a_valid__sbhl_type_erro, sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread ) );
                  Errors.cerror( $str136$continue_anyway, $str133$_A_is_not_a__A, tv_var, $sym134$SBHL_TRUE_TV_P );
                }
              }
              ...
              try
              {
                sbhl_search_vars.$sbhl_search_module$.bind( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const127$isa ) ), thread );
                sbhl_search_vars.$sbhl_search_module_type$.bind( sbhl_module_utilities.get_sbhl_module_type( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const127$isa ) ) ),
                    thread );
                ...
                sbhl_module_vars.$sbhl_module$.bind( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const127$isa ) ), thread );
                if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( node_var, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                {
                  ...
                  try
                  {
                    ...
                    sbhl_link_vars.$sbhl_link_direction$.bind( sbhl_module_utilities.sbhl_search_direction_to_link_direction( sbhl_search_vars.get_sbhl_backward_search_direction(), sbhl_module_utilities
                        .get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const127$isa ) ) ), thread );
                    sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                    ...
                    while ( NIL != node_var_$93)
                    {
                      ...
                      SubLObject cdolist_list_var;
                      final SubLObject accessible_modules = cdolist_list_var = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_vars.get_sbhl_module( $const127$isa ) );
                      ...
                      while ( NIL != cdolist_list_var)
                      {
                        ...
                        try
                        {
                          ...
                          if( NIL != sbhl_link_vars.sbhl_node_object_p( node ) )
                          {
                            ...
                            if( NIL != d_link )
                            {
                              final SubLObject mt_links = sbhl_links.get_sbhl_mt_links( d_link, sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const127$isa ) ),
                                            ...
                                            if( NIL != set.set_p( sol ) )
                                            {
                                                  ...
                                                  set_contents_var ); NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
                                              {
                                                    ...
                                                    sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) ) )
                                                {
                                                  ...
                                                  {
                                                    relations = ConsesLow.cons( reln, relations );
                                                  }
                                                }
                                              }
                                            }
                                            else if( sol.isList() )
                                            {
                                              ...
                                              while ( NIL != csome_list_var)
                                              {
                                                if( NIL == sbhl_marking_utilities.sbhl_search_path_termination_p( reln2, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) ) )
                                                {
                                                  ...
                                                  {
                                                    relations = ConsesLow.cons( reln2, relations );
                                                  }
                                                }
                                                csome_list_var = csome_list_var.rest();
                                                reln2 = csome_list_var.first();
                          ...
                          else if( NIL != obsolete.cnat_p( node, UNPROVIDED ) )
                          {
                            ...
                            final SubLObject new_list = cdolist_list_var_$110 = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities
                                .get_sbhl_module_relevant_naut_link_generators( sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const127$isa ) ), sbhl_search_vars.$sbhl_tv$
                                    .getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                                : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const127$isa ) ),
                                ...
                                if( NIL != set.set_p( sol2 ) )
                                {
                                      ...
                                      set_contents_var2 ); NIL == set_contents.do_set_contents_doneP( basis_object2, state2 ); state2 = set_contents.do_set_contents_update_state( state2 ) )
                                  {
                                        ...
                                        .getDynamicValue( thread ) ) )
                                    {
                                      ...
                                      {
                                        relations = ConsesLow.cons( reln3, relations );
                                      }
                                    }
                                  }
                                }
                                else if( sol2.isList() )
                                {
                                  ...
                                  while ( NIL != csome_list_var3)
                                  {
                                    if( NIL == sbhl_marking_utilities.sbhl_search_path_termination_p( reln4, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) ) )
                                    {
                                      ...
                                      {
                                        relations = ConsesLow.cons( reln4, relations );
                                      }
                                    }
                      ...
                      while ( NIL != cdolist_list_var2)
                      {
                        ...
                        try
                        {
                                    ...
                                    iteration_state2 ); iteration_state2 = dictionary_contents.do_dictionary_contents_next( iteration_state2 ) )
                                {
                                  ...
                                  if( NIL != mt_relevance_macros.relevant_mtP( mt3 ) )
                                  {
                                    ...
                                    try
                                    {
                                      ...
                                      for( iteration_state_$106 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links2 ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
                                          iteration_state_$106 ); iteration_state_$106 = dictionary_contents.do_dictionary_contents_next( iteration_state_$106 ) )
                                      {
                                        thread.resetMultipleValues();
                          ...
                          else if( NIL != obsolete.cnat_p( node2, UNPROVIDED ) )
                          {
                            ...
                            final SubLObject new_list2 = cdolist_list_var_$111 = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities
                ...
                {
                  sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str142$Node__a_does_not_pass_sbhl_type_t, node_var, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED,
  ...
  public static SubLObject fix_fixed_arity_relations_without_arities()
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      SubLObject cdolist_list_var_$121 = kb_mapping_utilities.pred_value_gafs( relation, $const127$isa, UNPROVIDED, UNPROVIDED );
      SubLObject a = NIL;
      a = cdolist_list_var_$121.first();
      while ( NIL != cdolist_list_var_$121)
      {
        if( NIL != genls.genlsP( assertions_high.gaf_arg2( a ), $const126$FixedArityRelation, UNPROVIDED, UNPROVIDED ) )
        {
  ...
  {
    return makeBoolean( $kw4$TRUE == assertions_high.assertion_truth( tou_assertion ) && NIL != nart_handles.nart_p( assertions_high.gaf_arg1( tou_assertion ) ) );
  }
  ...
  {
    return makeBoolean( NIL != kb_mapping_utilities.fpred_value_in_any_mt( fort, $const143$genls, UNPROVIDED, UNPROVIDED, UNPROVIDED ) && NIL == fort_types_interface.collectionP( fort ) );
  }
        ...
        try
        {
          ...
          while ( NIL != cdolist_list_var)
          {
            ...
            if( NIL == id_index.id_index_objects_empty_p( idx, $kw14$SKIP ) )
            {
              ...
              if( NIL == id_index.id_index_dense_objects_empty_p( idx_$124, $kw14$SKIP ) )
              {
              ...
              if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$125 ) || NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) )
              {
                ...
                while ( id2.numL( end_id ))
                {
                  ...
                  if( NIL == id_index.id_index_skip_tombstones_p( $kw14$SKIP ) || NIL == id_index.id_index_tombstone_p( fort2 ) )
                  {
                    ...
                    {
                      final SubLObject pred_var2 = $const143$genls;
                      if( NIL != kb_mapping_macros.do_gaf_arg_index_key_validator( fort2, ONE_INTEGER, pred_var2 ) )
                      {
                        ...
                        while ( NIL == done_var2)
                        {
                          ...
                          if( NIL != valid2 )
                          {
                            ...
                            try
                            {
                              final_index_iterator2 = kb_mapping_macros.new_final_index_iterator( final_index_spec2, $kw8$GAF, NIL, NIL );
  ...
  {
    SubLFiles.declareFunction( me, "forget_unneeded_knowledge", "FORGET-UNNEEDED-KNOWLEDGE", 0, 1, false );
    SubLFiles.declareFunction( me, "forget_ephemeral_terms", "FORGET-EPHEMERAL-TERMS", 0, 1, false );
    SubLFiles.declareFunction( me, "ephemeral_term_count", "EPHEMERAL-TERM-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "ephemeral_termP", "EPHEMERAL-TERM?", 1, 0, false );
    SubLFiles.declareFunction( me, "strictly_ephemeral_term_count", "STRICTLY-EPHEMERAL-TERM-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "strictly_ephemeral_termP", "STRICTLY-EPHEMERAL-TERM?", 1, 0, false );
    SubLFiles.declareFunction( me, "all_ephemeral_terms", "ALL-EPHEMERAL-TERMS", 0, 0, false );
    SubLFiles.declareFunction( me, "all_strictly_ephemeral_terms", "ALL-STRICTLY-EPHEMERAL-TERMS", 0, 0, false );
    SubLFiles.declareFunction( me, "naked_in_progress_termP", "NAKED-IN-PROGRESS-TERM?", 1, 0, false );
    SubLFiles.declareFunction( me, "nothing_said_about_in_progress_termP", "NOTHING-SAID-ABOUT-IN-PROGRESS-TERM?", 1, 0, false );
    SubLFiles.declareFunction( me, "all_naked_in_progress_terms", "ALL-NAKED-IN-PROGRESS-TERMS", 0, 0, false );
    SubLFiles.declareFunction( me, "naked_in_progress_term_count", "NAKED-IN-PROGRESS-TERM-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "all_naked_in_progress_terms_internal", "ALL-NAKED-IN-PROGRESS-TERMS-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "forget_ephemeral_term", "FORGET-EPHEMERAL-TERM", 1, 0, false );
    SubLFiles.declareFunction( me, "forget_ill_formed_skolems", "FORGET-ILL-FORMED-SKOLEMS", 0, 0, false );
    SubLFiles.declareFunction( me, "forget_useless_skolems", "FORGET-USELESS-SKOLEMS", 0, 0, false );
    SubLFiles.declareFunction( me, "forget_useless_narts", "FORGET-USELESS-NARTS", 0, 0, false );
    SubLFiles.declareFunction( me, "gather_useless_narts", "GATHER-USELESS-NARTS", 0, 0, false );
    SubLFiles.declareFunction( me, "forget_narts", "FORGET-NARTS", 2, 0, false );
    SubLFiles.declareFunction( me, "forget_function_extent", "FORGET-FUNCTION-EXTENT", 1, 0, false );
    SubLFiles.declareFunction( me, "forget_invalid_deductions_and_kb_hl_supports_until_quiesced", "FORGET-INVALID-DEDUCTIONS-AND-KB-HL-SUPPORTS-UNTIL-QUIESCED", 0, 3, false );
    SubLFiles.declareFunction( me, "forget_syntactically_invalid_new_deductions", "FORGET-SYNTACTICALLY-INVALID-NEW-DEDUCTIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "forget_syntactically_invalid_new_kb_hl_supports", "FORGET-SYNTACTICALLY-INVALID-NEW-KB-HL-SUPPORTS", 0, 0, false );
    SubLFiles.declareFunction( me, "forget_invalid_deductions", "FORGET-INVALID-DEDUCTIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "forget_invalid_deductions_serial", "FORGET-INVALID-DEDUCTIONS-SERIAL", 1, 0, false );
    SubLFiles.declareFunction( me, "identify_invalid_deductions_serial", "IDENTIFY-INVALID-DEDUCTIONS-SERIAL", 1, 0, false );
    SubLFiles.declareFunction( me, "identify_invalid_deductions_n_way", "IDENTIFY-INVALID-DEDUCTIONS-N-WAY", 2, 0, false );
    SubLFiles.declareFunction( me, "identify_invalid_deductions_worker", "IDENTIFY-INVALID-DEDUCTIONS-WORKER", 4, 0, false );
    SubLFiles.declareFunction( me, "deduction_is_forgettableP", "DEDUCTION-IS-FORGETTABLE?", 1, 0, false );
    SubLFiles.declareFunction( me, "deduction_has_invalid_supportP", "DEDUCTION-HAS-INVALID-SUPPORT?", 1, 0, false );
    SubLFiles.declareFunction( me, "new_invalid_deduction_iterator", "NEW-INVALID-DEDUCTION-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "forget_useless_kb_hl_supports", "FORGET-USELESS-KB-HL-SUPPORTS", 0, 1, false );
    SubLFiles.declareFunction( me, "forget_useless_kb_hl_supports_impl", "FORGET-USELESS-KB-HL-SUPPORTS-IMPL", 1, 1, false );
    SubLFiles.declareFunction( me, "forget_old_creation_seconds", "FORGET-OLD-CREATION-SECONDS", 0, 0, false );
    SubLFiles.declareFunction( me, "forget_old_creation_second_date", "FORGET-OLD-CREATION-SECOND-DATE", 0, 0, false );
    SubLFiles.declareFunction( me, "gather_old_creation_seconds", "GATHER-OLD-CREATION-SECONDS", 0, 0, false );
    SubLFiles.declareFunction( me, "clean_assertion_assert_info", "CLEAN-ASSERTION-ASSERT-INFO", 0, 0, false );
    SubLFiles.declareFunction( me, "duplicate_nart_tuples", "DUPLICATE-NART-TUPLES", 0, 1, false );
    SubLFiles.declareFunction( me, "duplicate_narts_to_kill", "DUPLICATE-NARTS-TO-KILL", 0, 0, false );
    SubLFiles.declareFunction( me, "kill_duplicate_narts", "KILL-DUPLICATE-NARTS", 0, 0, false );
    SubLFiles.declareFunction( me, "duplicate_assertion_tuples", "DUPLICATE-ASSERTION-TUPLES", 0, 1, false );
    SubLFiles.declareFunction( me, "group_assertion_by_mt", "GROUP-ASSERTION-BY-MT", 2, 0, false );
    SubLFiles.declareFunction( me, "consider_that_assertion_could_be_duplicate", "CONSIDER-THAT-ASSERTION-COULD-BE-DUPLICATE", 3, 0, false );
    SubLFiles.declareFunction( me, "assertion_cnf_or_gaf_formula", "ASSERTION-CNF-OR-GAF-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( me, "duplicate_tuples_from_dictionary", "DUPLICATE-TUPLES-FROM-DICTIONARY", 1, 0, false );
    SubLFiles.declareFunction( me, "put_the_keeper_first", "PUT-THE-KEEPER-FIRST", 1, 0, false );
    SubLFiles.declareFunction( me, "blast_duplicate_assertions", "BLAST-DUPLICATE-ASSERTIONS", 0, 1, false );
    SubLFiles.declareFunction( me, "blast_duplicate_assertions_without_keepers", "BLAST-DUPLICATE-ASSERTIONS-WITHOUT-KEEPERS", 0, 1, false );
    SubLFiles.declareFunction( me, "reconsider_assertions_with_no_arguments_verbose", "RECONSIDER-ASSERTIONS-WITH-NO-ARGUMENTS-VERBOSE", 0, 1, false );
    SubLFiles.declareFunction( me, "reconsider_assertions_with_no_arguments", "RECONSIDER-ASSERTIONS-WITH-NO-ARGUMENTS", 0, 1, false );
    SubLFiles.declareFunction( me, "detect_multiples_via_lexicon", "DETECT-MULTIPLES-VIA-LEXICON", 1, 3, false );
    SubLFiles.declareFunction( me, "new_and_removed_infn_narts", "NEW-AND-REMOVED-INFN-NARTS", 2, 2, false );
    SubLFiles.declareFunction( me, "new_and_removed_psnfn_narts", "NEW-AND-REMOVED-PSNFN-NARTS", 2, 2, false );
    SubLFiles.declareFunction( me, "new_and_removed_narts", "NEW-AND-REMOVED-NARTS", 3, 2, false );
    SubLFiles.declareFunction( me, "clear_functor_narts_in_kb", "CLEAR-FUNCTOR-NARTS-IN-KB", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_functor_narts_in_kb", "REMOVE-FUNCTOR-NARTS-IN-KB", 3, 0, false );
    SubLFiles.declareFunction( me, "functor_narts_in_kb_internal", "FUNCTOR-NARTS-IN-KB-INTERNAL", 3, 0, false );
    SubLFiles.declareFunction( me, "functor_narts_in_kb", "FUNCTOR-NARTS-IN-KB", 3, 0, false );
    SubLFiles.declareFunction( me, "fcp_sweep", "FCP-SWEEP", 1, 0, false );
    SubLFiles.declareFunction( me, "functions_for_fcp_sweep", "FUNCTIONS-FOR-FCP-SWEEP", 0, 0, false );
    SubLFiles.declareFunction( me, "fcp_func_G", "FCP-FUNC->", 2, 0, false );
    SubLFiles.declareFunction( me, "ke_text_for_unary_function_fcp", "KE-TEXT-FOR-UNARY-FUNCTION-FCP", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_name", "FCP-NAME", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_name_clashP", "FCP-NAME-CLASH?", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_name_int", "FCP-NAME-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_blake_note", "FCP-BLAKE-NOTE", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_predify_function_name", "FCP-PREDIFY-FUNCTION-NAME", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_ends_with_fn_but_has_a_dashed_bit_at_the_endP", "FCP-ENDS-WITH-FN-BUT-HAS-A-DASHED-BIT-AT-THE-END?", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_arg1_isa", "FCP-ARG1-ISA", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_arg2_isa", "FCP-ARG2-ISA", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_comment", "FCP-COMMENT", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_arg1_isa_int", "FCP-ARG1-ISA-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "fcp_result_isa_int", "FCP-RESULT-ISA-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "strip_outer_parens", "STRIP-OUTER-PARENS", 1, 0, false );
    SubLFiles.declareFunction( me, "something", "SOMETHING", 1, 0, false );
    SubLFiles.declareFunction( me, "assertions_with_more_than_one_belief", "ASSERTIONS-WITH-MORE-THAN-ONE-BELIEF", 0, 0, false );
    SubLFiles.declareFunction( me, "assertion_has_more_than_one_belief", "ASSERTION-HAS-MORE-THAN-ONE-BELIEF", 1, 0, false );
    SubLFiles.declareFunction( me, "fixed_arity_relations_without_arities", "FIXED-ARITY-RELATIONS-WITHOUT-ARITIES", 0, 0, false );
    SubLFiles.declareFunction( me, "fix_fixed_arity_relations_without_arities", "FIX-FIXED-ARITY-RELATIONS-WITHOUT-ARITIES", 0, 0, false );
    SubLFiles.declareFunction( me, "tou_assertion_goodP", "TOU-ASSERTION-GOOD?", 1, 0, false );
    SubLFiles.declareFunction( me, "fort_has_genls_assertion_but_is_not_a_collectionP", "FORT-HAS-GENLS-ASSERTION-BUT-IS-NOT-A-COLLECTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "fix_forts_with_genls_but_not_collections", "FIX-FORTS-WITH-GENLS-BUT-NOT-COLLECTIONS", 0, 0, false );
    return NIL;
  }

  public static SubLObject init_kb_cleanup_file()
  {
    $forget_old_creation_second_months$ = SubLFiles.defparameter( "*FORGET-OLD-CREATION-SECOND-MONTHS*", TWELVE_INTEGER );
    $functor_narts_in_kb_caching_state$ = SubLFiles.deflexical( "*FUNCTOR-NARTS-IN-KB-CACHING-STATE*", NIL );
    $functions_to_skip_for_fcp_sweep$ = SubLFiles.deflexical( "*FUNCTIONS-TO-SKIP-FOR-FCP-SWEEP*", $list91 );
    $known_arityless_relations$ = SubLFiles.deflexical( "*KNOWN-ARITYLESS-RELATIONS*", NIL );
    return NIL;
  }

  public static SubLObject setup_kb_cleanup_file()
  {
    memoization_state.note_globally_cached_function( $sym83$FUNCTOR_NARTS_IN_KB );
    return NIL;
  }
  ...
  {
    me = new kb_cleanup();
    $forget_old_creation_second_months$ = null;
    $functor_narts_in_kb_caching_state$ = null;
    $functions_to_skip_for_fcp_sweep$ = null;
    $known_arityless_relations$ = null;
    $str0$Forgetting_ = makeString( "Forgetting " );
    $str1$_ephemeral_terms = makeString( " ephemeral terms" );
    $str2$cdolist = makeString( "cdolist" );
    $const3$ephemeralTerm = constant_handles.reader_make_constant_shell( makeString( "ephemeralTerm" ) );
    $kw4$TRUE = makeKeyword( "TRUE" );
    $const5$inProgressTerm = constant_handles.reader_make_constant_shell( makeString( "inProgressTerm" ) );
    ...
    $str11$forgetting_useless_NARTs = makeString( "forgetting useless NARTs" );
    $str12$Gathering_useless_NARTs = makeString( "Gathering useless NARTs" );
    ...
    $str17$Forgetting_NART__S__ = makeString( "Forgetting NART ~S~%" );
    $str18$Forgetting_the_extent_of_ = makeString( "Forgetting the extent of " );
    $sym19$GAF_ARG1 = makeSymbol( "GAF-ARG1" );
    $int20$32 = makeInteger( 32 );
    $str21$Iteration__A__Removed__A_deductio = makeString( "Iteration ~A: Removed ~A deductions and ~A KB HL supports~%" );
    $str22$forget_syntactically_invalid_new_ = makeString( "forget-syntactically-invalid-new-kb-hl-supports hit max-iteration-count of ~A" );
    $str23$Total__Removed__A_deductions_and_ = makeString( "Total: Removed ~A deductions and ~A KB HL supports in ~A passes iteration-count~%" );
    $str24$Identifying_invalid_deductions = makeString( "Identifying invalid deductions" );
    $str25$Removing_invalid_deductions = makeString( "Removing invalid deductions" );
    $str26$Identifying_invalid_kb_hl_support = makeString( "Identifying invalid kb-hl-supports" );
    $str27$Removing_invalid_kb_hl_supports = makeString( "Removing invalid kb-hl-supports" );
    $str28$Invalid_Deductions = makeString( "Invalid Deductions" );
    $str29$Removing_or_rejustifying_ = makeString( "Removing or rejustifying " );
    $str30$_invalid_deductions = makeString( " invalid deductions" );
    $str31$__Bad_deduction__S___S__S = makeString( "~&Bad deduction ~S: ~S ~S" );
    $str32$Finding_invalid_deductions = makeString( "Finding invalid deductions" );
    $sym33$CATCH_ERROR_MESSAGE_HANDLER = makeSymbol( "CATCH-ERROR-MESSAGE-HANDLER" );
    $str34$Deduction__A_is_is_such_bad_state = makeString( "Deduction ~A is is such bad state it cannot be analyzed: ~A~%" );
    $str35$There_were__A_deductions_that_cou = makeString( "There were ~A deductions that could not be analyzed ...." );
    $str36$Invalid_Deduction_Worker_ = makeString( "Invalid Deduction Worker " );
    $sym37$IDENTIFY_INVALID_DEDUCTIONS_WORKER = makeSymbol( "IDENTIFY-INVALID-DEDUCTIONS-WORKER" );
    $str38$Finding_invalid_deductions_using_ = makeString( "Finding invalid deductions using " );
    $str39$_workers_____ = makeString( " workers ...." );
    $int40$100 = makeInteger( 100 );
    $list41 = ConsesLow.list( makeSymbol( "WORKER" ), makeSymbol( "CLICKER" ) );
    $sym42$DEDUCTION_IS_FORGETTABLE_ = makeSymbol( "DEDUCTION-IS-FORGETTABLE?" );
    $str43$__Removed_a_total_of__A_useless_K = makeString( "~&Removed a total of ~A useless KB HL supports in ~A passes.~%" );
    $str44$Pass_ = makeString( "Pass " );
    $str45$__Identifying_useless_KB_HL_suppo = makeString( ": Identifying useless KB HL supports" );
    $str46$__Removing_useless_KB_HL_supports = makeString( ": Removing useless KB HL supports" );
    $str47$Failed_to_remove_HL_support__A___ = makeString( "Failed to remove HL support ~A ....~%   ~A~%" );
    $str48$__Removed__A_useless_KB_HL_suppor = makeString( "~&Removed ~A useless KB HL supports during pass ~A.~%" );
    $str49$Forgetting_old_creation_seconds = makeString( "Forgetting old creation seconds" );
    $const50$myCreationSecond = constant_handles.reader_make_constant_shell( makeString( "myCreationSecond" ) );
    $str51$Examining_creation_seconds = makeString( "Examining creation seconds" );
    $str52$Cleaning_KBS_assert_info = makeString( "Cleaning KBS assert info" );
    $kw53$UNCHANGED = makeKeyword( "UNCHANGED" );
    $sym54$RELEVANT_MT_IS_EQ = makeSymbol( "RELEVANT-MT-IS-EQ" );
    $const55$termOfUnit = constant_handles.reader_make_constant_shell( makeString( "termOfUnit" ) );
    $str56$Looking_for_duplicate_narts_with_ = makeString( "Looking for duplicate narts with the same HL formula" );
    $str57$__Duplicates_found___S = makeString( "~&Duplicates found: ~S" );
    $sym58$NUM_INDEX = makeSymbol( "NUM-INDEX" );
    $str59$Examining_ = makeString( "Examining " );
    $str60$_assertions_for_duplication = makeString( " assertions for duplication" );
    $str61$Examining_all_assertions_for_dupl = makeString( "Examining all assertions for duplication (1/2 grouping)" );
    $str62$Examining_all_assertions_for_dupl = makeString( "Examining all assertions for duplication (2/2 considering)" );
    $sym63$CANONICALIZER_PROBLEM_ = makeSymbol( "CANONICALIZER-PROBLEM?" );
    $str64$could_not_find_an_obvious_keeper_ = makeString( "could not find an obvious keeper in ~a" );
    $sym65$ASSERTION_ID = makeSymbol( "ASSERTION-ID" );
    $str66$Blasting_approximately_ = makeString( "Blasting approximately " );
    $str67$_duplicate_assertions = makeString( " duplicate assertions" );
    $str68$Could_not_kill__a = makeString( "Could not kill ~a" );
    $kw69$RETURN_IDS = makeKeyword( "RETURN-IDS" );
    $str70$_______assertion__A_proved_unnece = makeString( "~& ... assertion ~A proved unnecessary.~%" );
    $str71$Redoing_TMS_on_assertions_with_no = makeString( "Redoing TMS on assertions with no arguments" );
    $kw72$SAME = makeKeyword( "SAME" );
    $const73$InferencePSC = constant_handles.reader_make_constant_shell( makeString( "InferencePSC" ) );
    $list74 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "nicknames" ) ), constant_handles.reader_make_constant_shell( makeString( "formerName" ) ), constant_handles
        .reader_make_constant_shell( makeString( "preferredNameString" ) ), constant_handles.reader_make_constant_shell( makeString( "nameString" ) ), constant_handles.reader_make_constant_shell( makeString(
            "alias" ) ) );
    $str75$_S_____A__ = makeString( "~S -> ~A~%" );
    $const76$InstanceNamedFn_Ternary = constant_handles.reader_make_constant_shell( makeString( "InstanceNamedFn-Ternary" ) );
    $const77$ProperSubcollectionNamedFn_Ternar = constant_handles.reader_make_constant_shell( makeString( "ProperSubcollectionNamedFn-Ternary" ) );
    $str78$_A_new_narts_added_between_KB__S_ = makeString( "~A new narts added between KB ~S and ~S ~%" );
    $str79$_A_narts_departed_between_KB__S_a = makeString( "~A narts departed between KB ~S and ~S ~%" );
    $str80$____________________New_NARTs____ = makeString( "====================New NARTs======================~%" );
    $str81$_S__ = makeString( "~S~%" );
    $str82$____________________Departed_NART = makeString( "====================Departed NARTs======================~%" );
    $sym83$FUNCTOR_NARTS_IN_KB = makeSymbol( "FUNCTOR-NARTS-IN-KB" );
    $str84$KB_ = makeString( "KB-" );
    $str85$_ = makeString( "-" );
    $str86$_NARTS_txt = makeString( "-NARTS.txt" );
    $str87$Getting__A_narts_for_KB__S__ = makeString( "Getting ~A narts for KB ~S~%" );
    $kw88$INPUT = makeKeyword( "INPUT" );
    $str89$Unable_to_open__S = makeString( "Unable to open ~S" );
    $sym90$_FUNCTOR_NARTS_IN_KB_CACHING_STATE_ = makeSymbol( "*FUNCTOR-NARTS-IN-KB-CACHING-STATE*" );
    $list91 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "Quote" ) ), constant_handles.reader_make_constant_shell( makeString( "SubLQuoteFn" ) ), constant_handles.reader_make_constant_shell(
        makeString( "QuasiQuote" ) ), constant_handles.reader_make_constant_shell( makeString( "EscapeQuote" ) ) );
    $kw92$OUTPUT = makeKeyword( "OUTPUT" );
    $str93$___functionCorrespondingPredicate = makeString( ";; functionCorrespondingPredicate-Canonical sweep KE file, generated at ~a~%" );
    $str94$Writing_KE_text___ = makeString( "Writing KE text..." );
    $const95$UnaryFunction = constant_handles.reader_make_constant_shell( makeString( "UnaryFunction" ) );
    $str96$Gathering_functions___ = makeString( "Gathering functions..." );
    $const97$functionCorrespondingPredicate_Ge = constant_handles.reader_make_constant_shell( makeString( "functionCorrespondingPredicate-Generic" ) );
    $list98 = ConsesLow.list( makeSymbol( "?PRED" ), makeSymbol( "?ARGNUM" ) );
    $list99 = ConsesLow.list( makeKeyword( "MAX-NUMBER" ), ONE_INTEGER );
    $sym100$FCP_FUNC__ = makeSymbol( "FCP-FUNC->" );
    $const101$UniversalVocabularyMt = constant_handles.reader_make_constant_shell( makeString( "UniversalVocabularyMt" ) );
    $str102$____ = makeString( "\n;; " );
    $str103$_constant__ = makeString( "\nconstant: " );
    $str104$_ = makeString( "." );
    $str105$_in_mt__UniversalVocabularyMt__is = makeString( "\nin mt: UniversalVocabularyMt.\nisa: StrictlyFunctionalSlot.\nquotedIsa: ProposedPublicConstant.\narg1Isa: " );
    $str106$__arg2Isa__ = makeString( ".\narg2Isa: " );
    $str107$__arg2Format__singleEntryFormatIn = makeString( ".\narg2Format: singleEntryFormatInArgs.\nstrictlyFunctionalInArgs: 2.\ncomment: " );
    $str108$__f___functionCorrespondingPredic = makeString( ".\nf: (functionCorrespondingPredicate-Canonical " );
    $str109$_ = makeString( " " );
    $str110$_2____ = makeString( " 2).\n\n" );
    $str111$Of = makeString( "Of" );
    $str112$blakePleaseRenameThis_ItsTheFunct = makeString( "blakePleaseRenameThis-ItsTheFunctionCorrespondingPredicateFor" );
    $str113$Fn = makeString( "Fn" );
    $str114$Fn_ = makeString( "Fn-" );
    $const115$UnitOfMeasureConcept = constant_handles.reader_make_constant_shell( makeString( "UnitOfMeasureConcept" ) );
    $str116$versionOf = makeString( "versionOf" );
    $str117$____Blake__check_this_out_ = makeString( " ;; Blake, check this out." );
    $str118$ = makeString( "" );
    $str119$A_predicate_corresponding_to_the_ = makeString( "A predicate corresponding to the function " );
    $str120$____code____ = makeString( ".  <code>(#$" );
    $str121$_X__ = makeString( " X (" );
    $str122$_X____code__will_always_be_true_f = makeString( " X))</code> will always be true for <code>X</code> meeting the relevant arg constraints." );
    $list123 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "Thing" ) ) );
    $str124$Looking_for_assertions_with_more_ = makeString( "Looking for assertions with more than one belief" );
    $sym125$BELIEF_P = makeSymbol( "BELIEF-P" );
    $const126$FixedArityRelation = constant_handles.reader_make_constant_shell( makeString( "FixedArityRelation" ) );
    $const127$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $kw128$BREADTH = makeKeyword( "BREADTH" );
    $kw129$QUEUE = makeKeyword( "QUEUE" );
    $kw130$STACK = makeKeyword( "STACK" );
    $sym131$RELEVANT_SBHL_TV_IS_GENERAL_TV = makeSymbol( "RELEVANT-SBHL-TV-IS-GENERAL-TV" );
    $kw132$ERROR = makeKeyword( "ERROR" );
    $str133$_A_is_not_a__A = makeString( "~A is not a ~A" );
    $sym134$SBHL_TRUE_TV_P = makeSymbol( "SBHL-TRUE-TV-P" );
    $kw135$CERROR = makeKeyword( "CERROR" );
    $str136$continue_anyway = makeString( "continue anyway" );
    $kw137$WARN = makeKeyword( "WARN" );
    $str138$_A_is_not_a_valid__sbhl_type_erro = makeString( "~A is not a valid *sbhl-type-error-action* value" );
    $str139$_A_is_neither_SET_P_nor_LISTP_ = makeString( "~A is neither SET-P nor LISTP." );
    $str140$attempting_to_bind_direction_link = makeString( "attempting to bind direction link variable, to NIL. macro body not executed." );
    $list141 = ConsesLow.list( makeUninternedSymbol( "LINK-NODE" ), makeUninternedSymbol( "MT" ), makeUninternedSymbol( "TV" ) );
    $str142$Node__a_does_not_pass_sbhl_type_t = makeString( "Node ~a does not pass sbhl-type-test ~a~%" );
    $const143$genls = constant_handles.reader_make_constant_shell( makeString( "genls" ) );
    $str144$Fixing_all_FORTs_with___genls_ass = makeString( "Fixing all FORTs with #$genls assertions are not known to be collections" );
  }
}
/*
 * 
