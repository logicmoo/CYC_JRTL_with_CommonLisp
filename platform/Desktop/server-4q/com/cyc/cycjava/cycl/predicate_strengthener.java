...
public final class predicate_strengthener extends SubLTranslatedFile
{
    ...
    public static SubLObject init_predicate_strengthener_file() {
        ...
        predicate_strengthener.$reformulator_rules_to_use$ = SubLFiles.deflexical("*REFORMULATOR-RULES-TO-USE*", (SubLObject)((predicate_strengthener.NIL != Symbols.boundp((SubLObject)predicate_strengthener.$sym20$_REFORMULATOR_RULES_TO_USE_)) ? predicate_strengthener.$reformulator_rules_to_use$.getGlobalValue() : predicate_strengthener.NIL));
        predicate_strengthener.$reformulator_rules_to_ignore$ = SubLFiles.deflexical("*REFORMULATOR-RULES-TO-IGNORE*", (SubLObject)((predicate_strengthener.NIL != Symbols.boundp((SubLObject)predicate_strengthener.$sym26$_REFORMULATOR_RULES_TO_IGNORE_)) ? predicate_strengthener.$reformulator_rules_to_ignore$.getGlobalValue() : predicate_strengthener.NIL));
