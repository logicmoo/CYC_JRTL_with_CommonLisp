...
public final class cfasl_kb_methods extends SubLTranslatedFile
{
    ...
    public static SubLObject init_cfasl_kb_methods_file() {
        ...
        cfasl_kb_methods.$sample_invalid_constant$ = SubLFiles.deflexical("*SAMPLE-INVALID-CONSTANT*", maybeDefault((SubLObject)cfasl_kb_methods.$sym28$_SAMPLE_INVALID_CONSTANT_, cfasl_kb_methods.$sample_invalid_constant$, ()->(constant_handles.create_sample_invalid_constant())));
        cfasl_kb_methods.$cfasl_opcode_nart$ = SubLFiles.defconstant("*CFASL-OPCODE-NART*", (SubLObject)cfasl_kb_methods.$int33$31);
        cfasl_kb_methods.$sample_invalid_nart$ = SubLFiles.deflexical("*SAMPLE-INVALID-NART*", maybeDefault((SubLObject)cfasl_kb_methods.$sym37$_SAMPLE_INVALID_NART_, cfasl_kb_methods.$sample_invalid_nart$, ()->(nart_handles.create_sample_invalid_nart())));
        ...
        cfasl_kb_methods.$sample_invalid_assertion$ = SubLFiles.deflexical("*SAMPLE-INVALID-ASSERTION*", maybeDefault((SubLObject)cfasl_kb_methods.$sym48$_SAMPLE_INVALID_ASSERTION_, cfasl_kb_methods.$sample_invalid_assertion$, ()->(assertion_handles.create_sample_invalid_assertion())));
        ...
        cfasl_kb_methods.$sample_invalid_deduction$ = SubLFiles.deflexical("*SAMPLE-INVALID-DEDUCTION*", maybeDefault((SubLObject)cfasl_kb_methods.$sym61$_SAMPLE_INVALID_DEDUCTION_, cfasl_kb_methods.$sample_invalid_deduction$, ()->(deduction_handles.create_sample_invalid_deduction())));
        ...
        cfasl_kb_methods.$sample_invalid_kb_hl_support$ = SubLFiles.deflexical("*SAMPLE-INVALID-KB-HL-SUPPORT*", maybeDefault((SubLObject)cfasl_kb_methods.$sym73$_SAMPLE_INVALID_KB_HL_SUPPORT_, cfasl_kb_methods.$sample_invalid_kb_hl_support$, ()->(kb_hl_support_handles.create_sample_invalid_kb_hl_support())));
        ...
        cfasl_kb_methods.$sample_invalid_clause_struc$ = SubLFiles.deflexical("*SAMPLE-INVALID-CLAUSE-STRUC*", maybeDefault((SubLObject)cfasl_kb_methods.$sym82$_SAMPLE_INVALID_CLAUSE_STRUC_, cfasl_kb_methods.$sample_invalid_clause_struc$, ()->(clause_strucs.create_sample_invalid_clause_struc())));
