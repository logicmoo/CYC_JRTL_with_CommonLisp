...
public final class memoization_state extends SubLTranslatedFile
{
    ...
    public static SubLObject init_memoization_state_file() {
        ...
        memoization_state.$caching_mode_should_monitor$ = SubLFiles.deflexical("*CACHING-MODE-SHOULD-MONITOR*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym1$_CACHING_MODE_SHOULD_MONITOR_)) ? memoization_state.$caching_mode_should_monitor$.getGlobalValue() : memoization_state.NIL));
        memoization_state.$cache_monitor_hash$ = SubLFiles.deflexical("*CACHE-MONITOR-HASH*", (memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym2$_CACHE_MONITOR_HASH_)) ? memoization_state.$cache_monitor_hash$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)memoization_state.SIXTEEN_INTEGER, (SubLObject)memoization_state.UNPROVIDED, (SubLObject)memoization_state.UNPROVIDED));
        memoization_state.$cache_monitor_failure_hash$ = SubLFiles.deflexical("*CACHE-MONITOR-FAILURE-HASH*", (memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym3$_CACHE_MONITOR_FAILURE_HASH_)) ? memoization_state.$cache_monitor_failure_hash$.getGlobalValue() : Hashtables.make_hash_table((SubLObject)memoization_state.SIXTEEN_INTEGER, (SubLObject)memoization_state.UNPROVIDED, (SubLObject)memoization_state.UNPROVIDED));
        memoization_state.$allow_function_caching_to_be_disabled$ = SubLFiles.deflexical("*ALLOW-FUNCTION-CACHING-TO-BE-DISABLED*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym8$_ALLOW_FUNCTION_CACHING_TO_BE_DISABLED_)) ? memoization_state.$allow_function_caching_to_be_disabled$.getGlobalValue() : memoization_state.NIL));
        ...
        memoization_state.$memoized_functions$ = SubLFiles.deflexical("*MEMOIZED-FUNCTIONS*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym135$_MEMOIZED_FUNCTIONS_)) ? memoization_state.$memoized_functions$.getGlobalValue() : memoization_state.NIL));
        memoization_state.$globally_cached_functions$ = SubLFiles.deflexical("*GLOBALLY-CACHED-FUNCTIONS*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym200$_GLOBALLY_CACHED_FUNCTIONS_)) ? memoization_state.$globally_cached_functions$.getGlobalValue() : memoization_state.NIL));
        memoization_state.$cache_clear_triggers$ = SubLFiles.deflexical("*CACHE-CLEAR-TRIGGERS*", (SubLObject)memoization_state.$list215);
        memoization_state.$hl_store_cache_clear_callbacks$ = SubLFiles.deflexical("*HL-STORE-CACHE-CLEAR-CALLBACKS*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym250$_HL_STORE_CACHE_CLEAR_CALLBACKS_)) ? memoization_state.$hl_store_cache_clear_callbacks$.getGlobalValue() : memoization_state.NIL));
        memoization_state.$mt_dependent_cache_clear_callbacks$ = SubLFiles.deflexical("*MT-DEPENDENT-CACHE-CLEAR-CALLBACKS*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym251$_MT_DEPENDENT_CACHE_CLEAR_CALLBACKS_)) ? memoization_state.$mt_dependent_cache_clear_callbacks$.getGlobalValue() : memoization_state.NIL));
        ...
        memoization_state.$genl_preds_dependent_cache_clear_callbacks$ = SubLFiles.deflexical("*GENL-PREDS-DEPENDENT-CACHE-CLEAR-CALLBACKS*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym253$_GENL_PREDS_DEPENDENT_CACHE_CLEAR_CALLBACKS_)) ? memoization_state.$genl_preds_dependent_cache_clear_callbacks$.getGlobalValue() : memoization_state.NIL));
        memoization_state.$genls_dependent_cache_clear_callbacks$ = SubLFiles.deflexical("*GENLS-DEPENDENT-CACHE-CLEAR-CALLBACKS*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym254$_GENLS_DEPENDENT_CACHE_CLEAR_CALLBACKS_)) ? memoization_state.$genls_dependent_cache_clear_callbacks$.getGlobalValue() : memoization_state.NIL));
        memoization_state.$wff_constraint_dependent_cache_clear_callbacks$ = SubLFiles.deflexical("*WFF-CONSTRAINT-DEPENDENT-CACHE-CLEAR-CALLBACKS*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym255$_WFF_CONSTRAINT_DEPENDENT_CACHE_CLEAR_CALLBACKS_)) ? memoization_state.$wff_constraint_dependent_cache_clear_callbacks$.getGlobalValue() : memoization_state.NIL));
        memoization_state.$isa_dependent_cache_clear_callbacks$ = SubLFiles.deflexical("*ISA-DEPENDENT-CACHE-CLEAR-CALLBACKS*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym256$_ISA_DEPENDENT_CACHE_CLEAR_CALLBACKS_)) ? memoization_state.$isa_dependent_cache_clear_callbacks$.getGlobalValue() : memoization_state.NIL));
        memoization_state.$quoted_isa_dependent_cache_clear_callbacks$ = SubLFiles.deflexical("*QUOTED-ISA-DEPENDENT-CACHE-CLEAR-CALLBACKS*", (SubLObject)((memoization_state.NIL != Symbols.boundp((SubLObject)memoization_state.$sym257$_QUOTED_ISA_DEPENDENT_CACHE_CLEAR_CALLBACKS_)) ? memoization_state.$quoted_isa_dependent_cache_clear_callbacks$.getGlobalValue() : memoization_state.NIL));
