...
public final class kb_health_statistics extends SubLTranslatedFile
{
    ...
    public static SubLObject init_kb_health_statistics_file() {
        ...
        kb_health_statistics.$kb_health_issues_store_lock$ = SubLFiles.deflexical("*KB-HEALTH-ISSUES-STORE-LOCK*", maybeDefault((SubLObject)kb_health_statistics.$sym0$_KB_HEALTH_ISSUES_STORE_LOCK_, kb_health_statistics.$kb_health_issues_store_lock$, ()->(Locks.make_lock((SubLObject)kb_health_statistics.$str1$KB_Health_Issues_Store))));
        kb_health_statistics.$kb_health_issues_store$ = SubLFiles.deflexical("*KB-HEALTH-ISSUES-STORE*", maybeDefault((SubLObject)kb_health_statistics.$sym4$_KB_HEALTH_ISSUES_STORE_, kb_health_statistics.$kb_health_issues_store$, ()->(dictionary.new_dictionary(kb_health_statistics.$kb_health_issue_comparison_fn$.getGlobalValue(), (SubLObject)kb_health_statistics.UNPROVIDED))));
