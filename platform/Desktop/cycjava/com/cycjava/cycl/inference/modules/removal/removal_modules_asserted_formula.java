...
public  final class removal_modules_asserted_formula extends SubLTranslatedFile {
  ...
  public static final SubLObject init_removal_modules_asserted_formula_file() {
    $term_formulas_defining_mt$ = deflexical("*TERM-FORMULAS-DEFINING-MT*", ((NIL != Symbols.boundp($sym36$_TERM_FORMULAS_DEFINING_MT_)) ? ((SubLObject) $term_formulas_defining_mt$.getGlobalValue()) : $const37$BaseKB));
    return NIL;
  }
