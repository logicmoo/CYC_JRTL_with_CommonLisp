 ...
 * in the OpenCyc API. In particular, it provides support for asserting and
 ...
 * will still be removed in the event of a transaction rollback.  If the CycAccess connection is interrupted
...
public class SimpleKBTransaction implements KBTransaction {
    ...
    private List<CycFort> createdForts = new ArrayList<CycFort>();
    ...
    public void begin() {
        ...
        CycAccess.setCurrentTransaction(this);
    }
    ...
    public void commit() {
        try {
            ...
            try {
                ...
                CycAccess.getCurrent().edit(unassertConjunction.toString(), assertConjunction.toString(), mt, bookkeeping, transcripting, wffCheckingDisabled, templates);
            } catch (Exception ex) {
//                Logger.getLogger(SimpleKBTransaction.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void rollback() {
        for (CycFort createdFort : createdForts) {
            try {
                CycAccess.getCurrent().kill(createdFort, isBookkeeping(), isTranscripting());
            } catch (Exception ex) {
    ...
    public List<CycFort> getTemplates() {
        return new ArrayList<CycFort>(templates);
    }
    ...
    protected List<CycFort> getCreatedTerms() {
        return new ArrayList<CycFort>(createdForts);
    }
    /**
     * 
     ...
     */
    public void setTemplates(List<CycFort> templates) {
    ...
    @Override
    public void noteForAssertion(String sentence, ELMt mt, boolean bookkeeping, boolean transcripting, boolean wffCheckingDisabled, List<CycFort>templates) {
    ...
    @Override
    public void noteCreation(CycFort fort) {
    ...
    private void noteTemplates(List<CycFort> templates) {
