...
(DEFUN APPLY-GRAMMAR  (UNIT)
      ...
      (COND ((G3T UNIT 'INTERPRET) (INTERPRET UNIT))
       (T (EVAL (LIST UNIT)))))
...
(DEFUN PARSE2  (R3ST P)
      ...
      (PROG (UNIT CREATED-NODE END PARENT RE SPEZIAL NBB)
       ...
       DONE
       (OR  P
        (REBUILD (SETQ FE (G3T (CAR C) 'FEATURES)) ;REBUILDS THE HIGHER LEVEL NODE TO INCORPORATE
