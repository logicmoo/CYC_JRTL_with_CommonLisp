...
(DEFUN ANSCOMMAND (RSS)
       ...
       (PROG (EXP ANS SUCCESS PLAN PLAN2)
	     ...
	     (S3TF RSS 'PLNRCODE= EXP)			       ;APPROPRIATE PLANNER THANDS AND THORS.
	     (SETQ EXP (AMBPUT EXP))
...
(DEFUN ANSREL (RSS)
       ...
       (PROG (TYPE REL CODE PLAUS ANS PHRASE LENGTH NUM)
	     ...
	     (AND (EQ TYPE 'ALL)
		  (S3TF RSS 'NEGATIVE= T))		       ;"SAY" PHRASES WHICH THE OTHER PARTS GENERATE.
	     (S3TF RSS 'PLNRCODE=				       ;UNIVERSALS ARE CONVERTED TO NOT THERE EXISTS NOT.
	      (SETQ
	       CODE
	       (PLNR-FINDIFY 'ALL
			     (VARIABLE? REL)
