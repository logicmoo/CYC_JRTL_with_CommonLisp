...
;;;
;;; swank-larkc.lisp --- LarKC CL specific code for SLIME.
;;;
;;; Adapted from swank-abcl.lisp and
;;;         from swank-acl.lisp, Andras Simon, 2004
;;;
;;; This code has been placed in the Public Domain.  All warranties
;;; are disclaimed.
;;;

(pushnew :CYC-SWANK COMMON-LISP::*features*)
...
(eval-when (:compile-toplevel :load-toplevel :execute)
  ...
  (assert (>= (read-from-string (subseq (lisp-implementation-version) 0 4))
              0.22)
          () "This file needs LarKC version 0.22 or newer"))

(defimplementation gray-package-name ()
  "GRAY-STREAMS")

;; FIXME: switch to shared Gray stream implementation when bugs are
;; fixed in LarKC.  See: http://abcl.org/trac/ticket/373.
(progn
