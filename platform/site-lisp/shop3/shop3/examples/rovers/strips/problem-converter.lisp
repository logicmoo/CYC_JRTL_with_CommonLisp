...
#+nil
(convert-problems (directory (asdf:system-relative-pathname "shop3" "examples/rovers/strips/p??.pddl"))
                  :output-defaults
                  (make-pathname :directory (pathname-directory (asdf:system-relative-pathname "shop3"
