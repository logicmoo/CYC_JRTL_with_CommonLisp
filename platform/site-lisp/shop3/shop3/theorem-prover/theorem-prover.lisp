...
; file: /Users/rpg/projects/laplata/lmco-laplata/planner_distro/ext/shop3/theorem-prover/theorem-prover.lisp
; in: DEFUN STANDARD-SATISFIERS-FOR-ASSIGN*
;     (ITERATE:ITER
;       (ITERATE:FOR SHOP3.THEOREM-PROVER::ANS ITERATE:IN
;        SHOP3.THEOREM-PROVER::ANSWERS)
;       (ITERATE:WITH SHOP3.THEOREM-PROVER::RESULTING-ANSWERS)
;       (ITERATE:WITH SHOP3.THEOREM-PROVER::NEW-ANSWERS)
;       (ITERATE:WITH SHOP3.THEOREM-PROVER::RESULTING-DEPENDS)
;       (ITERATE:WITH SHOP3.THEOREM-PROVER::NEW-DEPENDS)
;       (WHEN
;           (OR (SHOP3.UNIFIER:VARIABLEP SHOP3.THEOREM-PROVER::VAR)
;               (EQUALP SHOP3.THEOREM-PROVER::VAR SHOP3.THEOREM-PROVER::ANS))
;         (MULTIPLE-VALUE-SETQ
;             (SHOP3.THEOREM-PROVER::NEW-ANSWERS SHOP3.THEOREM-PROVER::NEW-DEPENDS)
;           (SHOP3.THEOREM-PROVER::SEEK-SATISFIERS
;            (SHOP3.UNIFIER:APPLY-SUBSTITUTION SHOP3.THEOREM-PROVER::OTHER-GOALS #)
;            SHOP3.COMMON:STATE
;            (SHOP3.UNIFIER:APPLY-SUBSTITUTION SHOP3.THEOREM-PROVER::BINDINGS #)
;            SHOP3.THEOREM-PROVER::NEWLEVEL SHOP3.THEOREM-PROVER::JUST1 :DOMAIN
;            SHOP3.COMMON:DOMAIN :DEPENDENCIES
;            SHOP3.THEOREM-PROVER::DEPENDENCIES-IN)))
;       (WHEN SHOP3.THEOREM-PROVER::NEW-ANSWERS
;         (IF SHOP3.THEOREM-PROVER::JUST1
;             (RETURN-FROM SHOP3.THEOREM-PROVER::STANDARD-SATISFIERS-FOR-ASSIGN*
;               (VALUES SHOP3.THEOREM-PROVER::NEW-ANSWERS
;                       SHOP3.THEOREM-PROVER::NEW-DEPENDS))
;             (MULTIPLE-VALUE-SETQ
;                 (SHOP3.THEOREM-PROVER::RESULTING-ANSWERS
;                  SHOP3.THEOREM-PROVER::RESULTING-DEPENDS)
;               (SHOP3.THEOREM-PROVER::ANSWER-SET-UNION
;                SHOP3.THEOREM-PROVER::NEW-ANSWERS
;                SHOP3.THEOREM-PROVER::RESULTING-ANSWERS
;                SHOP3.THEOREM-PROVER::NEW-DEPENDS
;                SHOP3.THEOREM-PROVER::RESULTING-DEPENDS))))
;       (ITERATE:FINALLY
;        (RETURN-FROM SHOP3.THEOREM-PROVER::STANDARD-SATISFIERS-FOR-ASSIGN*
;          (VALUES SHOP3.THEOREM-PROVER::RESULTING-ANSWERS
;                  SHOP3.THEOREM-PROVER::RESULTING-DEPENDS))))
...
; ==>
;   SHOP3.THEOREM-PROVER::OTHER-GOALS
; 
...
; --> CONS IF 
; ==>
;   SHOP3.THEOREM-PROVER::BINDINGS
; 
; note: deleting unreachable code

; --> LET* BLOCK TAGBODY PROGN IF MULTIPLE-VALUE-SETQ VALUES PROG1 LET 
; --> SETF MULTIPLE-VALUE-BIND MULTIPLE-VALUE-CALL LET IF 
; --> SHOP3.THEOREM-PROVER::REAL-SEEK-SATISFIERS IF 
; ==>
;   SHOP3.THEOREM-PROVER::OTHER-GOALS
; 
; note: deleting unreachable code
