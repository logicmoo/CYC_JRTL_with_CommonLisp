...
(DEFPROBLEM ROVERPROB4123 ROVER
            ((OBJECTIVE OBJECTIVE1) (OBJECTIVE OBJECTIVE0)
             (CAMERA CAMERA1) (CAMERA CAMERA0) (WAYPOINT WAYPOINT5)
             (WAYPOINT WAYPOINT4) (WAYPOINT WAYPOINT3)
             (WAYPOINT WAYPOINT2) (WAYPOINT WAYPOINT1)
             (WAYPOINT WAYPOINT0) (STORE ROVER2STORE)
             (STORE ROVER1STORE) (STORE ROVER0STORE) (ROVER ROVER2)
             ...
             (VISIBLE WAYPOINT4 WAYPOINT5) (AT_SOIL_SAMPLE WAYPOINT1)
             ...
             (AT ROVER2 WAYPOINT4) (AVAILABLE ROVER2)
