...
will be system dependent) to shop3.asd.  Do NOT copy the file; link it.
...
shop3.lisp  The SHOP2 program; at the top of the program file
...
shop3-<foo>.pdf   The SHOP2 documentation (in Adobe Acrobat format)

shop3-<foo>.doc	  The SHOP2 documentation (in MS Word format)

install.lisp    This script compiles shop3.lisp into a
...
shop3.asd	ASDF system definition for SHOP2 system.  This is now
                the preferred means of loading shop2.  Other methods
                will soon be deleted unless someone else is interested
                in maintaining them.

shop3.system	MK-DEFSYSTEM system definition for SHOP2.  This
