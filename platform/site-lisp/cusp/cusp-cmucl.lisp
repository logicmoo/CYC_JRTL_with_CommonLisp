...
;;;; Introduction
;;;
;;; This is the CMUCL implementation of the `cusp-backend' package.

(in-package :cusp-backend)

(import-cusp-mop-symbols :pcl '(:slot-definition-documentation))
...
;;; `cusp-compile-file' will automatically clear out any old records
...
(progn
  (defimplementation initialize-multiprocessing (continuation) 
    ...
    (mp:make-process continuation :name "cusp")
...
(defun background-message (message)
  (funcall (find-symbol (string :background-message) :cusp)
           message))
