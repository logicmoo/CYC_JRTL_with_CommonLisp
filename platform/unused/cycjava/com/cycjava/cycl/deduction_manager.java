...
public  final class deduction_manager extends SubLTranslatedFile {
  ...
  public static final SubLObject init_deduction_manager_file() {
    $deduction_content_manager$ = deflexical("*DEDUCTION-CONTENT-MANAGER*", ((NIL != Symbols.boundp($sym0$_DEDUCTION_CONTENT_MANAGER_)) ? ((SubLObject) $deduction_content_manager$.getGlobalValue()) : $kw1$UNINITIALIZED));
