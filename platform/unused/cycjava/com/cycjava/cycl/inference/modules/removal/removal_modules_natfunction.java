...
public  final class removal_modules_natfunction extends SubLTranslatedFile {
  ...
  public static final SubLObject removal_nat_argument_lookup_cost(SubLObject asent, SubLObject sense) {
    ...
    }
    {
      ...
      if ((NIL != variables.variable_p(argnum))) {
        if ((NIL != functionP)) {
          return Numbers.add(kb_indexing.num_nart_arg_index(fort, UNPROVIDED, UNPROVIDED), Errors
				.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 12781"));
        } else {
          ...
          try {
            ...
            if ((NIL != functionP)) {
              if (((NIL != variables.variable_p(argnum))
                  || argnum.isZero())) {
                Errors
						.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 9450");
              }
            }
            if ((NIL != variables.variable_p(argnum))) {
  ...
  public static final SubLObject setup_removal_modules_natfunction_file() {
    // CVS_ID("Id: removal-modules-natfunction.lisp 126640 2008-12-04 13:39:36Z builder ");
  ...
  public static final SubLList $list24 = list(new SubLObject[] {makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), constant_handles.reader_make_constant_shell(makeString("natArgument")), makeKeyword("REQUIRED-PATTERN"), list(constant_handles.reader_make_constant_shell(makeString("natArgument")), makeKeyword("NART"), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("ANYTHING")), makeKeyword("COST"), makeSymbol("REMOVAL-NAT-ARGUMENT-ARG-UNIFY-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-NAT-ARGUMENT-ARG-UNIFY-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$natArgument <reified NAT> <not fully-bound> <anything>)"), makeKeyword("EXAMPLE"), makeString("(#$natArgument (#$JuvenileFn #$Dog) ?ARG ?WHAT)\n    (#$natArgument (#$JuvenileFn #$Dog) ?ARG #$Dog)")});
  ...
  public static final SubLList $list30 = list(new SubLObject[] {makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), constant_handles.reader_make_constant_shell(makeString("natArgumentsEqual")), makeKeyword("REQUIRED-PATTERN"), list(constant_handles.reader_make_constant_shell(makeString("natArgumentsEqual")), makeKeyword("NART"), makeKeyword("NART")), makeKeyword("REQUIRED"), makeSymbol("REMOVAL-NAT-ARGUMENTS-EQUAL-CHECK-POS-REQUIRED"), makeKeyword("COST"), makeSymbol("REMOVAL-NAT-ARGUMENTS-EQUAL-CHECK-POS-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-NAT-ARGUMENTS-EQUAL-CHECK-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$natArgumentsEqual <reified NAT> <reified NAT>)"), makeKeyword("EXAMPLE"), makeString("(#$natArgumentsEqual (#$LeftFn #$Leg) (#$RightFn #$Leg))")});
  public static final SubLList $list31 = list(constant_handles.reader_make_constant_shell(makeString("implies")), list(constant_handles.reader_make_constant_shell(makeString("and")), list(constant_handles.reader_make_constant_shell(makeString("termOfUnit")), makeSymbol("?NAT1"), makeSymbol("?FORMULA1")), list(constant_handles.reader_make_constant_shell(makeString("termOfUnit")), makeSymbol("?NAT2"), makeSymbol("?FORMULA2")), list(constant_handles.reader_make_constant_shell(makeString("evaluate")), makeSymbol("?ARGS-LIST"), list(constant_handles.reader_make_constant_shell(makeString("FormulaArgListFn")), makeSymbol("?FORMULA1"))), list(constant_handles.reader_make_constant_shell(makeString("evaluate")), makeSymbol("?ARGS-LIST"), list(constant_handles.reader_make_constant_shell(makeString("FormulaArgListFn")), makeSymbol("?FORMULA2")))), list(constant_handles.reader_make_constant_shell(makeString("natArgumentsEqual")), makeSymbol("?NAT1"), makeSymbol("?NAT2")));
