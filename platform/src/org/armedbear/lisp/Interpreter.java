...
//		}
    ...
    public static Interpreter createJLispInstance(
        InputStream in,
        OutputStream out,
    ...
    public static Interpreter createNewLispInstance(
            InputStream in,
            OutputStream out,
            String initialDirectory,
            String version)
		...
		try{
			synchronized(Interpreter.class) {
				...
				Main.passedArgs = null;
 	               ...
 	               if(globalInterpreter==null) globalInterpreter = interp;
 	               return initInstance(interp, new String[0],true);
    	}
    	} finally {
    		if(todo!=null)
	...
	public static void initializeJLisp()
    {
        ...
        if (!initialized) {
            ...
            catch (Throwable e) { e.printStackTrace();} // FIXME: what to do?
            initialized = true;
        }
    	}
    }
