...
public class ArrayFunctions {
	 ...
	 * @author Administrator
	 */
	public static class adjust_array extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject[] args) {
			return ArrayFunctions.adjust_array_execute(args);
		}
	}
	 ...
	 * @author Administrator
	 */
	public static class make_array extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject[] args) {
			return ArrayFunctions.make_array_execute(args);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf__array_row_major_index extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf__array_row_major_index_execute(first, second);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf__set_fill_pointer extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf__set_fill_pointer_execute(first, second);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_adjustable_array_p extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_adjustable_array_p_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_aref extends JavaPrimitive {
		...
		public SubLObject execute() {
			return ArrayFunctions.pf_aref_execute();
		}
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_aref_execute(arg);
		}
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf_aref_execute(first, second);
		}
		...
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions.pf_aref_execute(first, second, third);
		}
		 ...
		 */
		public SubLObject execute(SubLObject[] args) {
			return ArrayFunctions.pf_aref_execute(args);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_array_dimension extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf_array_dimension_execute(first, second);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_array_dimensions extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_array_dimensions_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_array_displacement extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_array_displacement_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_array_element_type extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_array_element_type_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_array_has_fill_pointer_p extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_array_has_fill_pointer_p_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_array_in_bounds_p extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject[] args) {
			return ArrayFunctions.pf_array_in_bounds_p_execute(args);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_array_rank extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_array_rank_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_array_total_size extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_array_total_size_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_arrayp extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_arrayp_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_aset extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf_aset_execute(first, second);
		}
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions.pf_aset_execute(first, second, third);
		}
		 ...
		 */
		public SubLObject execute(SubLObject[] args) {
			return ArrayFunctions.pf_aset_execute(args);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_bit_vector_p extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_bit_vector_p_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_fill_pointer extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_fill_pointer_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_row_major_aref extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf_row_major_aref_execute(first, second);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_shrink_vector extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf_shrink_vector_execute(first, second);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_simple_bit_vector_p extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_simple_bit_vector_p_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_simple_vector_p extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_simple_vector_p_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_simple_vector_search extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf_simple_vector_search_execute(first, second);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_upgraded_array_element_type extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_upgraded_array_element_type_execute(arg);
		}
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf_upgraded_array_element_type_execute(first, second);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_vector extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject[] args) {
			return ArrayFunctions.pf_vector_execute(args);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_vector_delete_eq extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject item, SubLObject vector) {
			return ArrayFunctions.pf_vector_delete_eq_execute(item, vector);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_vector_delete_eql extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject item, SubLObject vector) {
			return ArrayFunctions.pf_vector_delete_eql_execute(item, vector);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_vector_pop extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_vector_pop_execute(arg);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_vector_push extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf_vector_push_execute(first, second);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_vector_push_extend extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions.pf_vector_push_extend_execute(first, second);
		}
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions.pf_vector_push_extend_execute(first, second, third);
		}
	}
	 ...
	 * @author Administrator
	 */
	private static class pf_vectorp extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return ArrayFunctions.pf_vectorp_execute(arg);
		}
	}

	// ### arrayp
	private static Primitive ARRAYP = new pf_arrayp();

	// ### array-has-fill-pointer-p
	private static Primitive ARRAY_HAS_FILL_POINTER_P = new pf_array_has_fill_pointer_p();

	// ### vectorp
	private static Primitive VECTORP = new pf_vectorp();

	// ### simple-vector-p
	private static Primitive SIMPLE_VECTOR_P = new pf_simple_vector_p();

	// ### bit-vector-p
	private static Primitive BIT_VECTOR_P = new pf_bit_vector_p();

	// ### simple-bit-vector-p
	private static Primitive SIMPLE_BIT_VECTOR_P = new pf_simple_bit_vector_p();

	// ### shrink-vector vector new-size => vector
	// Destructively alters the vector, changing its length to NEW-SIZE, which
	// must be less than or equal to its current length.
	// shrink-vector vector new-size => vector
	private static Primitive SHRINK_VECTOR = new pf_shrink_vector();

	// ### vector-delete-eq item vector => result-vector
	private static Primitive VECTOR_DELETE_EQ = new pf_vector_delete_eq();

	// ### vector-delete-eql item vector => result-vector
	private static Primitive VECTOR_DELETE_EQL = new pf_vector_delete_eql();

	// ### simple-vector-search pattern vector => position
	// Searches vector for pattern.
	private static Primitive SIMPLE_VECTOR_SEARCH = new pf_simple_vector_search();
	...
	// => new-array
	private static Primitive _MAKE_ARRAY = new make_array();

	private static Primitive _ADJUST_ARRAY = new adjust_array();

	// ### upgraded-array-element-type typespec &optional environment
	// => upgraded-typespec
	private static Primitive UPGRADED_ARRAY_ELEMENT_TYPE = new pf_upgraded_array_element_type();

	// ### array-rank array => rank
	private static Primitive ARRAY_RANK = new pf_array_rank();

	// ### array-dimensions array => dimensions
	// Returns a list of integers. Fill pointer (if any) is ignored.
	private static Primitive ARRAY_DIMENSIONS = new pf_array_dimensions();

	// ### array-dimension array axis-number => dimension
	private static Primitive ARRAY_DIMENSION = new pf_array_dimension();

	// ### array-total-size array => size
	private static Primitive ARRAY_TOTAL_SIZE = new pf_array_total_size();

	// ### array-element-type
	// array-element-type array => typespec
	private static Primitive ARRAY_ELEMENT_TYPE = new pf_array_element_type();

	// ### adjustable-array-p
	private static Primitive ADJUSTABLE_ARRAY_P = new pf_adjustable_array_p();

	// ### array-displacement array => displaced-to, displaced-index-offset
	private static Primitive ARRAY_DISPLACEMENT = new pf_array_displacement();

	// ### array-in-bounds-p array &rest subscripts => generalized-boolean
	private static Primitive ARRAY_IN_BOUNDS_P = new pf_array_in_bounds_p();

	// ### %array-row-major-index array subscripts => index
	private static Primitive _ARRAY_ROW_MAJOR_INDEX = new pf__array_row_major_index();

	// ### aref array &rest subscripts => element
	private static Primitive AREF = new pf_aref();

	// ### aset array subscripts new-element => new-element
	private static Primitive ASET = new pf_aset();

	// ### row-major-aref array index => element
	private static Primitive ROW_MAJOR_AREF = new pf_row_major_aref();

	// ### vector
	private static Primitive VECTOR = new pf_vector();

	// ### fill-pointer
	private static Primitive FILL_POINTER = new pf_fill_pointer();

	// ### %set-fill-pointer vector new-fill-pointer
	private static Primitive _SET_FILL_POINTER = new pf__set_fill_pointer();

	// ### vector-push new-element vector => index-of-new-element
	private static Primitive VECTOR_PUSH = new pf_vector_push();

	// ### vector-push-extend new-element vector &optional extension
	// => index-of-new-element
	private static Primitive VECTOR_PUSH_EXTEND = new pf_vector_push_extend();

	// ### vector-pop vector => element
	private static Primitive VECTOR_POP = new pf_vector_pop();

	// ### %simple-bit-vector-bit-and
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_AND = new JavaPrimitive("%simple-bit-vector-bit-and",
			Lisp.PACKAGE_SYS, false, "bit-vector1 bit-vector2 result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_AND_execute(first, second, third);
		}
	};

	// ### %simple-bit-vector-bit-ior
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_IOR = new JavaPrimitive("%simple-bit-vector-bit-ior",
			Lisp.PACKAGE_SYS, false, "bit-vector1 bit-vector2 result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_IOR_execute(first, second, third);
		}
	};

	// ### %simple-bit-vector-bit-xor
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_XOR = new JavaPrimitive("%simple-bit-vector-bit-xor",
			Lisp.PACKAGE_SYS, false, "bit-vector1 bit-vector2 result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_XOR_execute(first, second, third);
		}
	};

	// ### %simple-bit-vector-bit-eqv
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_EQV = new JavaPrimitive("%simple-bit-vector-bit-eqv",
			Lisp.PACKAGE_SYS, false, "bit-vector1 bit-vector2 result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_EQV_execute(first, second, third);
		}
	};

	// ### %simple-bit-vector-bit-nand
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_NAND = new JavaPrimitive("%simple-bit-vector-bit-nand",
			Lisp.PACKAGE_SYS, false, "bit-vector1 bit-vector2 result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_NAND_execute(first, second, third);
		}
	};

	// ### %simple-bit-vector-bit-nor
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_NOR = new JavaPrimitive("%simple-bit-vector-bit-nor",
			Lisp.PACKAGE_SYS, false, "bit-vector1 bit-vector2 result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_NOR_execute(first, second, third);
		}
	};

	// ### %simple-bit-vector-bit-andc1
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_ANDC1 = new JavaPrimitive("%simple-bit-vector-bit-andc1",
			Lisp.PACKAGE_SYS, false, "bit-vector1 bit-vector2 result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_ANDC1_execute(first, second, third);
		}
	};

	// ### %simple-bit-vector-bit-andc2
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_ANDC2 = new JavaPrimitive("%simple-bit-vector-bit-andc2",
			Lisp.PACKAGE_SYS, false, "bit-vector1 bit-vector2 result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_ANDC2_execute(first, second, third);
		}
	};

	// ### %simple-bit-vector-bit-orc1
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_ORC1 = new JavaPrimitive("%simple-bit-vector-bit-orc1",
			Lisp.PACKAGE_SYS, false, "bit-vector1 bit-vector2 result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_ORC1_execute(first, second, third);
		}
	};

	// ### %simple-bit-vector-bit-orc2
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_ORC2 = new JavaPrimitive("%simple-bit-vector-bit-orc2",
			Lisp.PACKAGE_SYS, false, "bit-vector1 bit-vector2 result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_ORC2_execute(first, second, third);
		}
	};

	// ### %simple-bit-vector-bit-not
	private static Primitive _SIMPLE_BIT_VECTOR_BIT_NOT = new JavaPrimitive("%simple-bit-vector-bit-not",
			Lisp.PACKAGE_SYS, false, "bit-vector result-bit-vector") {
		// @override
		public SubLObject execute(SubLObject first, SubLObject second) {
			return ArrayFunctions._SIMPLE_BIT_VECTOR_BIT_NOT_execute(first, second);
		}
	};
	...
	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_AND_execute(SubLObject first, SubLObject second, SubLObject third) {
		return ArrayFunctions.checkBitVector(first).and(ArrayFunctions.checkBitVector(second),
				ArrayFunctions.checkBitVector(third));
	}

	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_ANDC1_execute(SubLObject first, SubLObject second,
			SubLObject third) {
		return ArrayFunctions.checkBitVector(first).andc1(ArrayFunctions.checkBitVector(second),
				ArrayFunctions.checkBitVector(third));
	}

	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_ANDC2_execute(SubLObject first, SubLObject second,
			SubLObject third) {
		return ArrayFunctions.checkBitVector(first).andc2(ArrayFunctions.checkBitVector(second),
				ArrayFunctions.checkBitVector(third));
	}

	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_EQV_execute(SubLObject first, SubLObject second, SubLObject third) {
		return ArrayFunctions.checkBitVector(first).eqv(ArrayFunctions.checkBitVector(second),
				ArrayFunctions.checkBitVector(third));
	}

	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_IOR_execute(SubLObject first, SubLObject second, SubLObject third) {
		return ArrayFunctions.checkBitVector(first).ior(ArrayFunctions.checkBitVector(second),
				ArrayFunctions.checkBitVector(third));
	}

	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_NAND_execute(SubLObject first, SubLObject second,
			SubLObject third) {
		return ArrayFunctions.checkBitVector(first).nand(ArrayFunctions.checkBitVector(second),
				ArrayFunctions.checkBitVector(third));
	}

	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_NOR_execute(SubLObject first, SubLObject second, SubLObject third) {
		return ArrayFunctions.checkBitVector(first).nor(ArrayFunctions.checkBitVector(second),
				ArrayFunctions.checkBitVector(third));
	}

	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_NOT_execute(SubLObject first, SubLObject second) {
		SimpleBitVector v = ArrayFunctions.checkBitVector(first);
		SimpleBitVector result = ArrayFunctions.checkBitVector(second);
	...
	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_ORC1_execute(SubLObject first, SubLObject second,
			SubLObject third) {
		return ArrayFunctions.checkBitVector(first).orc1(ArrayFunctions.checkBitVector(second),
				ArrayFunctions.checkBitVector(third));
	}

	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_ORC2_execute(SubLObject first, SubLObject second,
			SubLObject third) {
		return ArrayFunctions.checkBitVector(first).orc2(ArrayFunctions.checkBitVector(second),
				ArrayFunctions.checkBitVector(third));
	}

	@InlinableMethod
	static public SubLObject _SIMPLE_BIT_VECTOR_BIT_XOR_execute(SubLObject first, SubLObject second, SubLObject third) {
		return ArrayFunctions.checkBitVector(first).xor(ArrayFunctions.checkBitVector(second),
				ArrayFunctions.checkBitVector(third));
	}

	@InlinableMethod
	static public SubLObject adjust_array_execute(SubLObject[] args) {
		if (args.length != 10)
		...
		if (elementType != array.getElementType()
				&& Lisp.getUpgradedArrayElementType(elementType) != array.getElementType())
		...
		if (array.getRank() == 1) {
			...
			if (array instanceof AbstractVector) {
				...
				if (displacedTo != Lisp.NIL) {
					...
					if (displacedIndexOffset == Lisp.NIL)
						displacement = 0;
					else
	...
	@InlinableMethod
	static public SubLObject make_array_execute(SubLObject[] args) {
		if (args.length != 9)
			return InlinedPrimitiveRegistry.wrongNumberOfArguments();
		...
		if (initialElementProvided != Lisp.NIL && initialContents != Lisp.NIL)
			return Lisp
					.error(new LispError("MAKE-ARRAY: cannot specify both " + "initial element and initial contents."));
		final int rank = dimensions.isList() ? dimensions.cl_length() : 1;
		int[] dimv = new int[rank];
		if (dimensions.isList())
			for (int i = 0; i < rank; i++) {
		...
		if (displacedTo != Lisp.NIL) {
			...
			// displaced-to array.
			final AbstractArray array = Lisp.checkArray(displacedTo);
			...
			if (rank == 1) {
				...
				else if (arrayElementType.equal(Lisp.UNSIGNED_BYTE_8))
					v = new ComplexVector_UnsignedByte8(dimv[0], array, displacement);
				else if (arrayElementType.equal(Lisp.UNSIGNED_BYTE_32))
		...
		SubLObject upgradedType = Lisp.getUpgradedArrayElementType(elementType);
		if (rank == 0) {
			SubLObject data;
			if (initialElementProvided != Lisp.NIL)
				data = initialElement;
		...
		if (rank == 1) {
			...
			if (size < 0 || size >= Lisp.ARRAY_DIMENSION_MAX) {
				StringBuilder sb = new StringBuilder();
				sb.append("The size specified for this array (");
				sb.append(size);
				sb.append(')');
				if (size >= Lisp.ARRAY_DIMENSION_MAX) {
			...
			if (upgradedType == LispSymbols.CHARACTER) {
				if (fillPointer != Lisp.NIL || adjustable != Lisp.NIL)
					...
					v = LispObjectFactory.makeString(size);
			...
			else if (fillPointer != Lisp.NIL || adjustable != Lisp.NIL)
				v = new ComplexVector(size);
			else
				v = LispObjectFactory.makeSimpleVector(size);
			if (initialElementProvided != Lisp.NIL)
				...
				} else if (initialContents.isSequence())
					for (int i = 0; i < size; i++)
						v.aset(i, initialContents.elt(i));
				else
					return Lisp.type_error(initialContents, LispSymbols.SEQUENCE);
			if (fillPointer != Lisp.NIL)
				v.setFillPointer(fillPointer);
			return v;
		}
	...
	public SubLObject pf__set_fill_pointer_execute(SubLObject first, SubLObject second) {
		...
		return Lisp.type_error(first, Lisp.list(LispSymbols.AND, LispSymbols.VECTOR,
				Lisp.list(LispSymbols.SATISFIES, LispSymbols.ARRAY_HAS_FILL_POINTER_P)));
	}

	@InlinableMethod
	static public SubLObject pf_adjustable_array_p_execute(SubLObject arg) {
		return Lisp.checkArray(arg).isAdjustable() ? Lisp.T : Lisp.NIL;
	}

	@InlinableMethod
	static public SubLObject pf_aref_execute() {
		return InlinedPrimitiveRegistry.wrongNumberOfArguments();
	}

	@InlinableMethod
	static public SubLObject pf_aref_execute(SubLObject arg) {
		final AbstractArray array;
		array = Lisp.checkArray(arg);
		if (array.getRank() == 0)
			return array.AREF(0);
	...
	public SubLObject pf_aref_execute(SubLObject first, SubLObject second, SubLObject third) {
		return Lisp.checkArray(first).get(new int[] { second.intValue(), third.intValue() });
	}

	@InlinableMethod
	static public SubLObject pf_aref_execute(SubLObject[] args) {
		final AbstractArray array = Lisp.checkArray(args[0]);
	...
	public SubLObject pf_array_dimension_execute(SubLObject first, SubLObject second) {
		final AbstractArray array = Lisp.checkArray(first);
		return LispObjectFactory.makeInteger(array.getDimension(second.intValue()));
	}

	@InlinableMethod
	static public SubLObject pf_array_dimensions_execute(SubLObject arg) {
		return Lisp.checkArray(arg).getDimensions();
	}

	@InlinableMethod
	static public SubLObject pf_array_displacement_execute(SubLObject arg) {
		return Lisp.checkArray(arg).arrayDisplacement();
	}

	@InlinableMethod
	static public SubLObject pf_array_element_type_execute(SubLObject arg) {
		return Lisp.checkArray(arg).getElementType();
	}

	@InlinableMethod
	static public SubLObject pf_array_has_fill_pointer_p_execute(SubLObject arg) {
		return Lisp.checkArray(arg).hasFillPointer() ? Lisp.T : Lisp.NIL;
	}

	@InlinableMethod
	static public SubLObject pf_array_in_bounds_p_execute(SubLObject[] args) {
		if (args.length < 1)
			return InlinedPrimitiveRegistry.wrongNumberOfArguments();
		final AbstractArray array;
		SubLObject r = args[0];
		array = Lisp.checkArray(r);
		...
		for (int i = 0; i < rank; i++) {
			...
			if (arg instanceof Fixnum) {
				...
				Lisp.type_error(arg, LispSymbols.INTEGER);
		}
		return Lisp.T;
	}

	@InlinableMethod
	static public SubLObject pf_array_rank_execute(SubLObject arg) {
		return LispObjectFactory.makeInteger(Lisp.checkArray(arg).getRank());
	}

	@InlinableMethod
	static public SubLObject pf_array_total_size_execute(SubLObject arg) {
		return LispObjectFactory.makeInteger(Lisp.checkArray(arg).getTotalSize());
	}

	@InlinableMethod
	static public SubLObject pf_arrayp_execute(SubLObject arg) {
	...
	@InlinableMethod
	static public SubLObject pf_aset_execute(SubLObject[] args) {
		final AbstractArray array = Lisp.checkArray(args[0]);
	...
	@InlinableMethod
	static public SubLObject pf_bit_vector_p_execute(SubLObject arg) {
		return arg instanceof AbstractBitVector ? Lisp.T : Lisp.NIL;
	}

	@InlinableMethod
	static public SubLObject pf_fill_pointer_execute(SubLObject arg) {
		...
		return Lisp.type_error(arg, Lisp.list(LispSymbols.AND, LispSymbols.VECTOR,
				Lisp.list(LispSymbols.SATISFIES, LispSymbols.ARRAY_HAS_FILL_POINTER_P)));
	}
	...
	public SubLObject pf_row_major_aref_execute(SubLObject first, SubLObject second) {
		return Lisp.checkArray(first).AREF(second.intValue());
	}
	...
	public SubLObject pf_shrink_vector_execute(SubLObject first, SubLObject second) {
		Lisp.checkVector(first).shrink(second.intValue());
		return first;
	}

	@InlinableMethod
	static public SubLObject pf_simple_bit_vector_p_execute(SubLObject arg) {
		return arg.typep(LispSymbols.SIMPLE_BIT_VECTOR);
	}

	@InlinableMethod
	static public SubLObject pf_simple_vector_p_execute(SubLObject arg) {
		...
		if (first instanceof AbstractVector) {
			...
			for (int i = 0; i <= limit; i++)
				if (v.AREF(i).eql(element)) {
					...
					// We've already checked the first element.
					int j = i + 1;
					for (SubLObject rest = first.rest(); rest != Lisp.NIL; rest = rest.rest())
	...
	@InlinableMethod
	static public SubLObject pf_upgraded_array_element_type_execute(SubLObject arg) {
	...
	@InlinableMethod
	static public SubLObject pf_vector_execute(SubLObject[] args) {
		return LispObjectFactory.makeSimpleVector(args);
	}

	@InlinableMethod
	static public SubLObject pf_vector_pop_execute(SubLObject arg) {
		final AbstractVector v = Lisp.checkVector(arg);
	...
	public SubLObject pf_vector_push_execute(SubLObject first, SubLObject second) {
		final AbstractVector v = Lisp.checkVector(second);
		int fillPointer = v.getFillPointer();
		if (fillPointer < 0)
			v.noFillPointer();
	...
	@InlinableMethod
	static public SubLObject pf_vectorp_execute(SubLObject arg) {
		return arg.VECTORP();
	}
}
