...
public final class Keyword
{
    public static final Symbol
        ...
        CDR6                = internKeyword("CDR6");
        		...
        		public static SubLSymbol DIRECTION_KEYWORD = internKeyword("DIRECTION");
        		public static SubLSymbol INPUT_KEYWORD = internKeyword("INPUT");
        		public static SubLSymbol OUTPUT_KEYWORD = internKeyword("OUTPUT");
        		public static SubLSymbol CREATE_KEYWORD = internKeyword("CREATE");
        		public static SubLSymbol APPEND_KEYWORD = internKeyword("APPEND");
        		public static SubLSymbol IO_KEYWORD = internKeyword("IO");
