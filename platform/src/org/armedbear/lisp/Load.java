                                        ...
                                        LispObject externalFormat)
    {
        ...
        try {
            return loadFileFromStream(pathname, truename,
            		Stream.createStream(Symbol.SYSTEM_STREAM, in, Symbol.CHARACTER, externalFormat),
...

        {
           ...
           // @TODO @ERROR
            if(true) {
                ...
                return error(new SimpleError("FASL version mismatch; found '"
