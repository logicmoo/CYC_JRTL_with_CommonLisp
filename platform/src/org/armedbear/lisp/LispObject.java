      ...
      AbstractSubLObject
{
   ...
   * contains a decriptive string, and the cdr returns a subobject for
   * inspection.
   */
  ...
  static class LinkedIdentityHashSet
      extends
        AbstractList
  {
  ...
  public String printReadableObject(boolean quoted)
  {
     ...
     * *print-array*, and *print-gensym* were also true, and as if
  ...
  /**
   * Creates a non-readably (as per CLHS terminology) representation of the
   * 'this' object, using string 's'.
   *
