...
import org.logicmoo.system.JMultiSpecialOperator;
...
public final class Primitives {
	...
	private static final class pf_SPECIAL_METHOD_P extends Primitive {
		...
		public LispObject execute(LispObject arg) {
			...
			if (arg instanceof JMultiSpecialOperator) {
				return T;
			}
			return NIL;
		}
		...
		public LispObject execute(LispObject args, Environment env) {
			...
			while (args != NIL) {
				...
				if (!(clause instanceof Cons))
					return error(new ProgramError("COND clause is not a non-empty list: " + clause.princToString()));
	...
	// dmiles addded
	// ### import-package packages-to-import &optional package => t
	...
	private static final class pf_import_package extends Primitive {
		pf_import_package() {
			super("IMPORT-PACKAGE", PACKAGE_SYS, true, "packages-to-import override &optional package");
		}
	...
	private static final class sf_go extends SpecialOperator {
...

		{
			...
			if (binding == null)
				return error(new ControlError("No tag named " + args.car().princToString() + " is currently visible."));
	...
	private static final class pf_uptime extends Primitive {
		...
		@Override
		public LispObject execute() {
			return number(System.currentTimeMillis() - Startup.systemStartTimeMillis);
		}
	};
