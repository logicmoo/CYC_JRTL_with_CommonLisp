...
public final class socket_stream extends Primitive
{
...

    {
        ...
        try {
             Stream in =
            		 Stream.createStream(Symbol.SYSTEM_STREAM, socket.getInputStream(), elementType, third);
             Stream out =
            		 Stream.createStream(Symbol.SYSTEM_STREAM, socket.getOutputStream(), elementType, third);
