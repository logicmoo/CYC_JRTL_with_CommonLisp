...
public class Lisp {
        ...
        if (form instanceof Cons) {
            ...
            if (car instanceof Symbol) {
                ...
                if (obj instanceof MacroObject) {
                    ...
                    LispObject hook = coerceToFunction(Symbol.MACROEXPAND_HOOK.symbolValue(thread));
    ...
    private static final void pushJavaStackFrames() {
        ...
        if (frames.length > 5 && frames[3].getClassName().equals("org.armedbear.lisp.Lisp")
    ...
    private static SubLException conditionToSubLException(LispObject condition) {
        String msg = "" + condition.getClass() + " " + condition;
        if (condition instanceof Condition) {
            Condition condition2 = (Condition) condition;
            msg += " slots=" + Arrays.toString(condition2.getSlots());
        }
        return SubLObjectFactory.makeException(msg);
    }
    ...
    public static final LispObject type_error(LispObject abstractSubLObject, LispObject expectedType) {
        if (Main.isSubLisp()) {
    ...
    public static final LispObject eval(final LispObject obj, final Environment env)
    ...
    {
        if (tagbody == null)
            return error(new ControlError("Unmatched tag " + tag.princToString() + " for GO outside lexical extent."));
    ...
    static final LispObject nonLocalGo(Binding binding, LispObject tag) {
        if (binding.env.inactive)
            return error(new ControlError(
                    "Unmatched tag " + binding.symbol.princToString() + " for GO outside of lexical extent."));
...

    {
        if (blockId == null)
            return error(new ControlError(
                    "Unmatched block " + blockName.princToString() + " for " + "RETURN-FROM outside lexical extent."));
     ...
     * This version is used by the interpreter.
     */
    public static final LispObject nonLocalReturn(Binding binding, Symbol block, LispObject result) {
        if (binding == null) {
            return error(new LispError("No block named " + block.getName() + " is currently visible."));
        }

        if (binding.env.inactive)
            return error(new ControlError("Unmatched block " + binding.symbol.princToString()
            ...
            if (current instanceof Cons) {
                try {
                    ...
                    if (((Cons) current).car == Symbol.GO) {
                        ...
                        if (binding == null)
                            return error(new ControlError(
                                    "No tag named " + tag.princToString() + " is currently visible."));
    ...
    public static final void bindArg(LispObject ownSpecials, Symbol sym, LispObject value, Environment env,
            LispThread thread)
    ...
    public static final Cons list4(LispObject obj1, LispObject obj2, LispObject obj3, LispObject obj4) {
        return new Cons(obj1, new Cons(obj2, new Cons(obj3, new Cons(obj4))));
    }

    @Deprecated
    public static final Cons list5(LispObject obj1, LispObject obj2, LispObject obj3, LispObject obj4,
            LispObject obj5) {
        return new Cons(obj1, new Cons(obj2, new Cons(obj3, new Cons(obj4, new Cons(obj5)))));
    }

    @Deprecated
    public static final Cons list6(LispObject obj1, LispObject obj2, LispObject obj3, LispObject obj4, LispObject obj5,
            LispObject obj6) {
        return new Cons(obj1, new Cons(obj2, new Cons(obj3, new Cons(obj4, new Cons(obj5, new Cons(obj6))))));
    }

    @Deprecated
    public static final Cons list7(LispObject obj1, LispObject obj2, LispObject obj3, LispObject obj4, LispObject obj5,
            LispObject obj6, LispObject obj7) {
        return new Cons(obj1,
                new Cons(obj2, new Cons(obj3, new Cons(obj4, new Cons(obj5, new Cons(obj6, new Cons(obj7)))))));
    }

    @Deprecated
    public static final Cons list8(LispObject obj1, LispObject obj2, LispObject obj3, LispObject obj4, LispObject obj5,
            LispObject obj6, LispObject obj7, LispObject obj8) {
        return new Cons(obj1, new Cons(obj2,
                new Cons(obj3, new Cons(obj4, new Cons(obj5, new Cons(obj6, new Cons(obj7, new Cons(obj8))))))));
    }

    @Deprecated
    public static final Cons list9(LispObject obj1, LispObject obj2, LispObject obj3, LispObject obj4, LispObject obj5,
            LispObject obj6, LispObject obj7, LispObject obj8, LispObject obj9) {
        return new Cons(obj1, new Cons(obj2, new Cons(obj3,
                new Cons(obj4, new Cons(obj5, new Cons(obj6, new Cons(obj7, new Cons(obj8, new Cons(obj9)))))))));
    }
...

    {
        ...
        type_error(arg, list(Symbol.OR, Symbol.STRING, Symbol.SYMBOL, Symbol.CHARACTER));
        // Not reached.
        return null;
    }
    ...
    public static LispObject readObjectFromReader(Reader r) {
        ...
        try {
            ...
            return new Stream(Symbol.SYSTEM_STREAM, r)
                    .read(true, NIL, false, LispThread.currentThread(), Stream.faslReadtable);
        } finally {
    ...
    public static final LispObject FUNCTION_NAME = list(Symbol.OR, Symbol.SYMBOL, list(Symbol.CONS, list(Symbol.EQL, Symbol.SETF), list(Symbol.CONS, Symbol.SYMBOL, Symbol.NULL)));

    public static final LispObject UNSIGNED_BYTE_8 = list(Symbol.UNSIGNED_BYTE, Fixnum.constants[8]);

    public static final LispObject UNSIGNED_BYTE_16 = list(Symbol.UNSIGNED_BYTE, Fixnum.constants[16]);

    public static final LispObject UNSIGNED_BYTE_32 = list(Symbol.UNSIGNED_BYTE, Fixnum.constants[32]);

    public static final LispObject UNSIGNED_BYTE_32_MAX_VALUE = Bignum.getInstance(4294967296L);
...

    {
        ...
        if (stream.isCharacterInputStream())
            return stream;
        return (Stream) // Not reached.
        error(new TypeError("The value " + obj.princToString() + " is not a character input stream."));
    }
...

    {
        ...
        if (stream.isCharacterOutputStream())
            return stream;
        return (Stream) // Not reached.
        error(new TypeError("The value " + obj.princToString() + " is not a character output stream."));
    }
...

    {
        ...
        if (stream.isBinaryInputStream())
            return stream;
        return (Stream) // Not reached.
        error(new TypeError("The value " + obj.princToString() + " is not a binary input stream."));
    }
...

    {
        ...
        if (obj instanceof Cons && obj.car() == Symbol.NAMED_LAMBDA) {
            ...
            if (name instanceof Symbol || isValidSetfFunctionName(name)) {
                return new LambdaClosure(name, new Cons(Symbol.LAMBDA, obj.cddr()), Environment.newEnvironment());
            }
...

    {
        ...
        type_error(arg, list(Symbol.OR, Symbol.PATHNAME, Symbol.STRING, Symbol.FILE_STREAM, Symbol.JAR_STREAM, Symbol.URL_STREAM));
        // Not reached.
        return null;
    }
...

    {
        ...
        while (list != NIL) {
            ...
            if (list.cdr() instanceof Cons)
                ...
                return error(new TypeError("Malformed property list: " + plist.princToString()));
        }
        return defaultValue;
    }
...

    {
        ...
        // Not found.
        symbol.setPropertyList(new Cons(indicator, new Cons(value, symbol.getPropertyList())));
        return value;
    }
        ...
        while (list != NIL) {
            if (!(list.cdr() instanceof Cons))
                error(new ProgramError(
                        "The symbol " + symbol.princToString() + " has an odd number of items in its property list."));
            if (list.car() == indicator) {
                // Found it!
                if (prev != null)
    ...
    static final ConcurrentHashMap<String, LispObject> objectTable = new ConcurrentHashMap<String, LispObject>();
    ...
    public static final void resetIO() {
        resetIO(Stream.createStream(Symbol.SYSTEM_STREAM, SystemCurrent.in, Symbol.CHARACTER, true), Stream
                .createStream(Symbol.SYSTEM_STREAM, SystemCurrent.out, Symbol.CHARACTER, true));
    }

    // Used in org/armedbear/j/JLisp.java.
    public static final void setIO(final InputStream ins, final OutputStream outs) {
        resetIO(Stream.createStream(Symbol.SYSTEM_STREAM, ins, Symbol.CHARACTER, true), Stream
                .createStream(Symbol.SYSTEM_STREAM, outs, Symbol.CHARACTER, true));
    }
    ...
    static {
        ...
        // Common features
        LispObject featureList = list(Keyword.ARMEDBEAR, Keyword.ABCL, Keyword.COMMON_LISP, Keyword.ANSI_CL, Keyword.CDR6, Keyword.MOP, internKeyword("PACKAGE-LOCAL-NICKNAMES"));
        // OS type
        if (osName.startsWith("Linux"))
            featureList = Primitives.APPEND.execute(list(Keyword.UNIX, Keyword.LINUX), featureList);
        else if (osName.startsWith("SunOS"))
            featureList = Primitives.APPEND.execute(list(Keyword.UNIX, Keyword.SUNOS, Keyword.SOLARIS), featureList);
        else if (osName.startsWith("Mac OS X") || osName.startsWith("Darwin"))
            featureList = Primitives.APPEND.execute(list(Keyword.UNIX, Keyword.DARWIN), featureList);
        else if (osName.startsWith("FreeBSD"))
            featureList = Primitives.APPEND.execute(list(Keyword.UNIX, Keyword.FREEBSD), featureList);
        else if (osName.startsWith("OpenBSD"))
            featureList = Primitives.APPEND.execute(list(Keyword.UNIX, Keyword.OPENBSD), featureList);
        else if (osName.startsWith("NetBSD"))
            featureList = Primitives.APPEND.execute(list(Keyword.UNIX, Keyword.NETBSD), featureList);
    ...
    // internal symbol
    public static final Symbol DOUBLE_COLON_PACKAGE_SEPARATORS = internSpecial("*DOUBLE-COLON-PACKAGE-SEPARATORS*", PACKAGE_SYS, NIL);
    ...
    // ### *fasl-loader*
    public static final Symbol _FASL_LOADER_ = exportSpecial("*FASL-LOADER*", PACKAGE_SYS, NIL);
    ...
    // ### *preloading-cache*
    public static final Symbol AUTOLOADING_CACHE = internSpecial("*AUTOLOADING-CACHE*", PACKAGE_SYS, NIL);

    // ### *compile-file-type*
    public static final Symbol _COMPILE_FILE_TYPE_ = exportSpecial("*COMPILE-FILE-TYPE*", PACKAGE_SYS, new SimpleString(
            "abcl"));

    // ### *lisp-file-type*
    public static final Symbol _LISP_FILE_TYPE_ = exportSpecial("*LISP-FILE-TYPE*", PACKAGE_EXT, new SimpleString(
            "lisp"));

    // ### *lisp-file-type-list*
    public static final Symbol _LISP_FILE_TYPE_LIST_ = exportSpecial("*LISP-FILE-TYPE-LIST*", PACKAGE_EXT, list(new SimpleString(
            "lisp"), new SimpleString("cl"), new SimpleString("lsp")));

    // ### *compile-file-class-extension*
    public static final Symbol _COMPILE_FILE_CLASS_EXTENSION_ = exportSpecial("*COMPILE-FILE-CLASS-EXTENSION*", PACKAGE_SYS, new SimpleString(
            "cls"));
    ...
    static {
        Symbol.LAMBDA_LIST_KEYWORDS
                .initializeConstant(list(Symbol.AND_OPTIONAL, Symbol.AND_REST, Symbol.AND_KEY, Symbol.AND_AUX, Symbol.AND_BODY, Symbol.AND_WHOLE, Symbol.AND_ALLOW_OTHER_KEYS, Symbol.AND_ENVIRONMENT));
    }
    ...
    public static final Symbol _COMMAND_LINE_ARGUMENT_LIST_ = exportSpecial("*COMMAND-LINE-ARGUMENT-LIST*", PACKAGE_EXT, NIL);
    ...
    // ### *disassembler*
    public static final Symbol _DISASSEMBLER_ = exportSpecial("*DISASSEMBLER*", PACKAGE_EXT, new SimpleString(
            "jad -a -p")); // or "jad -dis -p"
    ...
    // ### *bq-vector-flag*
    public static final Symbol _BQ_VECTOR_FLAG_ = internSpecial("*BQ-VECTOR-FLAG*", PACKAGE_SYS, list(new Symbol(
            "bqv")));
    ...
    public static String getDotName(Class class1) {
        ...
        if (sirName.equals("Object"))
            return firstName;
        if (firstName.contains(sirName))
            return firstName;
        if (sirName.contains(firstName))
            return sirName;
    ...
    public static String getSimpleName(Class class1) {
        ...
        if (packString != null)
            simpleName = simpleName.substring(packString.length());
        if (sc != null)
            return getSimpleName(sc) + simpleName;
        return simpleName;
    }
    ...
    public static boolean isText(SubLObject elementType) {
        ...
        if (Symbol.CHARACTER.eql(elementType))
            return true;
        if (Keyword.TEXT_KEYWORD_CHARACTER.eql(elementType))
            return true;
        if (Symbol.BASE_CHAR.eql(elementType))
            return true;
        if (Symbol.CHAR.eql(elementType))
            return true;
    ...
    public static String objectFieldsString(Object thiz, Class exceptFor) {
        ...
        try {
            Lisp.didExtraInfo++;
            return (toString1(JavaObject
                    .getParts(thiz, thiz.getClass(), false, true, Collections.singleton(exceptFor))));
        } finally {
            didExtraInfo--;
        }
    }
