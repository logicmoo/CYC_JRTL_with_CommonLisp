...
public class Primitive1R extends Function
{
  ...
  public Primitive1R( String name, Package pkg, boolean exported, String arglist )
  {
    super( name, pkg, exported, arglist );
  }

  public Primitive1R( String name, Package pkg, boolean exported, String arglist, String docstring )
  {
  ...
  {
    return _execute( first, list6( second, third, fourth, fifth, sixth, seventh ) );
  }
  ...
  {
    return _execute( first, list7( second, third, fourth, fifth, sixth, seventh, eighth ) );
  }
  ...
  protected LispObject _execute(LispObject first, LispObject second) throws ConditionThrowable
  {
