 ...
 * $Id: SimpleArray_T.java 12431 2010-02-08 08:05:15Z mevenson $
 *
...
public class SimpleArray_T extends AbstractSimpleArray {
	...
	public SimpleArray_T(int rank, SubLObject initialContents)
	...
	public SimpleArray_T(int[] dimv, SubLObject elementType) {
		this.dimv = dimv;
	...
	public SimpleArray_T(int[] dimv, SubLObject elementType, SubLObject initialContents)
	...
	public SimpleArray_T(int[] dimv, SubLObject[] initialData, SubLObject elementType) {
		this.dimv = dimv;
		this.elementType = elementType;
...

	{
		...
		return new SimpleArray_T(dimv, this.data.clone(), this.elementType);
	}
	...
	public SubLObject typeOf() {
		return Lisp.list(LispSymbols.SIMPLE_ARRAY, this.elementType, this.getDimensions());
	}
