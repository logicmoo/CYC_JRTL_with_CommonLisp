...
and so should not be straightforwardly written to the HL transcript */
  ...
  public static final SubLObject declare_operation_queues_file() {
    declareFunction(myName, "local_queue_size", "LOCAL-QUEUE-SIZE", 0, 0, false);
    declareFunction(myName, "local_queue_empty", "LOCAL-QUEUE-EMPTY", 0, 0, false);
    declareFunction(myName, "clear_local_queue", "CLEAR-LOCAL-QUEUE", 0, 0, false);
    declareFunction(myName, "local_queue_enqueue", "LOCAL-QUEUE-ENQUEUE", 1, 0, false);
    declareFunction(myName, "local_queue_dequeue", "LOCAL-QUEUE-DEQUEUE", 0, 0, false);
    declareFunction(myName, "local_queue_peek", "LOCAL-QUEUE-PEEK", 0, 0, false);
    declareFunction(myName, "local_queue_contents", "LOCAL-QUEUE-CONTENTS", 0, 0, false);
    declareFunction(myName, "local_queue", "LOCAL-QUEUE", 0, 0, false);
    declareFunction(myName, "set_local_queue", "SET-LOCAL-QUEUE", 1, 0, false);
    declareFunction(myName, "remote_queue_size", "REMOTE-QUEUE-SIZE", 0, 0, false);
    declareFunction(myName, "remote_queue_empty", "REMOTE-QUEUE-EMPTY", 0, 0, false);
    declareFunction(myName, "clear_remote_queue", "CLEAR-REMOTE-QUEUE", 0, 0, false);
    declareFunction(myName, "remote_queue_enqueue", "REMOTE-QUEUE-ENQUEUE", 1, 0, false);
    declareFunction(myName, "remote_queue_dequeue", "REMOTE-QUEUE-DEQUEUE", 0, 0, false);
    declareFunction(myName, "transcript_queue_size", "TRANSCRIPT-QUEUE-SIZE", 0, 0, false);
    declareFunction(myName, "transcript_queue_empty", "TRANSCRIPT-QUEUE-EMPTY", 0, 0, false);
    declareFunction(myName, "clear_transcript_queue", "CLEAR-TRANSCRIPT-QUEUE", 0, 0, false);
    declareFunction(myName, "transcript_queue_enqueue", "TRANSCRIPT-QUEUE-ENQUEUE", 1, 0, false);
    declareFunction(myName, "transcript_queue_dequeue", "TRANSCRIPT-QUEUE-DEQUEUE", 0, 0, false);
    declareFunction(myName, "hl_transcript_queue_size", "HL-TRANSCRIPT-QUEUE-SIZE", 0, 0, false);
    declareFunction(myName, "hl_transcript_queue_emptyP", "HL-TRANSCRIPT-QUEUE-EMPTY?", 0, 0, false);
    declareFunction(myName, "clear_hl_transcript_queue", "CLEAR-HL-TRANSCRIPT-QUEUE", 0, 0, false);
    declareFunction(myName, "hl_transcript_queue_enqueue", "HL-TRANSCRIPT-QUEUE-ENQUEUE", 1, 0, false);
    declareFunction(myName, "hl_transcript_queue_dequeue", "HL-TRANSCRIPT-QUEUE-DEQUEUE", 0, 0, false);
    declareFunction(myName, "auxiliary_queue_size", "AUXILIARY-QUEUE-SIZE", 0, 0, false);
    declareFunction(myName, "auxiliary_queue_empty", "AUXILIARY-QUEUE-EMPTY", 0, 0, false);
    declareFunction(myName, "clear_auxiliary_queue", "CLEAR-AUXILIARY-QUEUE", 0, 0, false);
    declareFunction(myName, "auxiliary_queue_enqueue", "AUXILIARY-QUEUE-ENQUEUE", 1, 0, false);
    declareFunction(myName, "auxiliary_queue_dequeue", "AUXILIARY-QUEUE-DEQUEUE", 0, 0, false);
    declareFunction(myName, "transmit_queue_size", "TRANSMIT-QUEUE-SIZE", 0, 0, false);
    declareFunction(myName, "transmit_queue_empty", "TRANSMIT-QUEUE-EMPTY", 0, 0, false);
    declareFunction(myName, "clear_transmit_queue", "CLEAR-TRANSMIT-QUEUE", 0, 0, false);
    declareFunction(myName, "transmit_queue_enqueue", "TRANSMIT-QUEUE-ENQUEUE", 1, 0, false);
    declareFunction(myName, "transmit_queue_dequeue", "TRANSMIT-QUEUE-DEQUEUE", 0, 0, false);
    declareFunction(myName, "local_operation_storage_queue_size", "LOCAL-OPERATION-STORAGE-QUEUE-SIZE", 0, 0, false);
    declareFunction(myName, "local_operation_storage_queue_empty", "LOCAL-OPERATION-STORAGE-QUEUE-EMPTY", 0, 0, false);
    declareFunction(myName, "clear_local_operation_storage_queue", "CLEAR-LOCAL-OPERATION-STORAGE-QUEUE", 0, 0, false);
    declareFunction(myName, "local_operation_storage_queue_enqueue", "LOCAL-OPERATION-STORAGE-QUEUE-ENQUEUE", 1, 0, false);
    declareFunction(myName, "local_operation_storage_queue_dequeue", "LOCAL-OPERATION-STORAGE-QUEUE-DEQUEUE", 0, 0, false);
    declareFunction(myName, "local_operation_storage_queue_contents", "LOCAL-OPERATION-STORAGE-QUEUE-CONTENTS", 0, 0, false);
    declareFunction(myName, "local_operations_anywhere", "LOCAL-OPERATIONS-ANYWHERE", 0, 0, false);
    declareFunction(myName, "add_to_local_queue", "ADD-TO-LOCAL-QUEUE", 1, 1, false);
    declareFunction(myName, "run_one_local_op", "RUN-ONE-LOCAL-OP", 0, 0, false);
    declareFunction(myName, "add_to_remote_queue", "ADD-TO-REMOTE-QUEUE", 1, 0, false);
    declareFunction(myName, "within_a_remote_opP", "WITHIN-A-REMOTE-OP?", 0, 0, false);
    declareFunction(myName, "run_one_remote_op", "RUN-ONE-REMOTE-OP", 0, 0, false);
    declareFunction(myName, "run_one_remote_op_internal", "RUN-ONE-REMOTE-OP-INTERNAL", 1, 0, false);
    declareFunction(myName, "add_to_auxiliary_queue", "ADD-TO-AUXILIARY-QUEUE", 1, 0, false);
    declareFunction(myName, "run_one_auxiliary_op", "RUN-ONE-AUXILIARY-OP", 0, 0, false);
    declareFunction(myName, "add_to_transcript_queue", "ADD-TO-TRANSCRIPT-QUEUE", 1, 0, false);
    declareFunction(myName, "hl_transcript_formP", "HL-TRANSCRIPT-FORM?", 1, 0, false);
    declareFunction(myName, "add_to_hl_transcript_queue", "ADD-TO-HL-TRANSCRIPT-QUEUE", 1, 0, false);
    declareFunction(myName, "api_op_to_form", "API-OP-TO-FORM", 1, 0, false);
    declareFunction(myName, "form_to_api_op", "FORM-TO-API-OP", 1, 0, false);
    return NIL;
  }
