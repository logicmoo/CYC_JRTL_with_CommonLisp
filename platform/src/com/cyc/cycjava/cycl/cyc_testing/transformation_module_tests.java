...
public  final class transformation_module_tests extends SubLTranslatedFile {
  ...
  public static final SubLObject init_transformation_module_tests_file() {
    ...
    $transformation_module_tests$ = deflexical("*TRANSFORMATION-MODULE-TESTS*", ((NIL != Symbols.boundp($sym45$_TRANSFORMATION_MODULE_TESTS_)) ? ((SubLObject) $transformation_module_tests$.getGlobalValue()) : Hashtables.make_hash_table($int46$100, UNPROVIDED, UNPROVIDED)));
    return NIL;
  }
