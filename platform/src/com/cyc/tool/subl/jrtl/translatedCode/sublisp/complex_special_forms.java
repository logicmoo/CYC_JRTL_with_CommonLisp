...
import static com.cyc.tool.subl.jrtl.translatedCode.sublisp.complex_special_forms.*;
...
public class complex_special_forms extends SubLTrampolineFile {
    ...
    private static final SubLList $list44 = list(new SubLObject[]{ makeSymbol("&KEY"), makeSymbol("NAME"), makeSymbol("CONC-NAME"), makeSymbol("PRINT-FUNCTION"), makeSymbol("C-STRUCTURE-TAG"), makeSymbol("GENERATE-VISIT-FUNCTION?"), makeSymbol("PREDICATE"), makeSymbol("CONSTRUCTOR"), makeSymbol("HOST-FN-NAME"), makeSymbol("TYPE-VAR"), makeSymbol("SLOTS"), makeSymbol("SLOT-KEYWORDS"), makeSymbol("GETTERS"), makeSymbol("SETTERS") });

    private static final SubLList $list45 = list(new SubLObject[]{ makeKeyword("NAME"), makeKeyword("CONC-NAME"), makeKeyword("PRINT-FUNCTION"), makeKeyword("C-STRUCTURE-TAG"), makeKeyword("GENERATE-VISIT-FUNCTION?"), makeKeyword("PREDICATE"), makeKeyword("CONSTRUCTOR"), makeKeyword("HOST-FN-NAME"), makeKeyword("TYPE-VAR"), makeKeyword("SLOTS"), makeKeyword("SLOT-KEYWORDS"), makeKeyword("GETTERS"), makeKeyword("SETTERS") });
