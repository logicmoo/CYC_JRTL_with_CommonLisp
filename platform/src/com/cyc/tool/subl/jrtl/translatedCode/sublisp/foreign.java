...
import static com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign.*;
...
public class foreign extends SubLTranslatedFile {
    ...
    public static SubLObject declare_foreign_file() {
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "declare_foreign_shared_library", "DECLARE-FOREIGN-SHARED-LIBRARY", 2, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "find_foreign_shared_library_by_pathname", "FIND-FOREIGN-SHARED-LIBRARY-BY-PATHNAME", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "get_foreign_shared_library_pathname", "GET-FOREIGN-SHARED-LIBRARY-PATHNAME", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "get_foreign_shared_library_dependencies", "GET-FOREIGN-SHARED-LIBRARY-DEPENDENCIES", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "get_foreign_shared_library_property", "GET-FOREIGN-SHARED-LIBRARY-PROPERTY", 2, 1, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "foreign_shared_library_p", "FOREIGN-SHARED-LIBRARY-P", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "undeclare_foreign_shared_library", "UNDECLARE-FOREIGN-SHARED-LIBRARY", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "all_foreign_shared_libraries", "ALL-FOREIGN-SHARED-LIBRARIES", 0, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "foreign_shared_library_loadableP", "FOREIGN-SHARED-LIBRARY-LOADABLE?", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "find_foreign_shared_library_by_property", "FIND-FOREIGN-SHARED-LIBRARY-BY-PROPERTY", 2, 1, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "find_foreign_shared_library_int", "FIND-FOREIGN-SHARED-LIBRARY-INT", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "edit_foreign_shared_library", "EDIT-FOREIGN-SHARED-LIBRARY", 2, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "foreign_shared_library_accessibleP", "FOREIGN-SHARED-LIBRARY-ACCESSIBLE?", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "load_foreign_shared_library", "LOAD-FOREIGN-SHARED-LIBRARY", 1, 1, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "ensure_foreign_shared_library_loaded", "ENSURE-FOREIGN-SHARED-LIBRARY-LOADED", 1, 1, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "foreign_shared_library_loadedP", "FOREIGN-SHARED-LIBRARY-LOADED?", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "unload_foreign_shared_library", "UNLOAD-FOREIGN-SHARED-LIBRARY", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "foreign_shared_library_installedP", "FOREIGN-SHARED-LIBRARY-INSTALLED?", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "load_shared_library_int", "LOAD-SHARED-LIBRARY-INT", 3, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "unload_shared_library_int", "UNLOAD-SHARED-LIBRARY-INT", 2, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "foreign_shared_library_loaded_intP", "FOREIGN-SHARED-LIBRARY-LOADED-INT?", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "return_type_string_p", "RETURN-TYPE-STRING-P", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "return_type_pointer_p", "RETURN-TYPE-POINTER-P", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "default_return_value", "DEFAULT-RETURN-VALUE", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "make_helper_function_symbol", "MAKE-HELPER-FUNCTION-SYMBOL", 2, 0, false);
        declareMacro("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "define_foreign_function", "DEFINE-FOREIGN-FUNCTION");
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "analyze_define_foreign_function_arguments", "ANALYZE-DEFINE-FOREIGN-FUNCTION-ARGUMENTS", 3, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "generate_foreign_name_from_sublisp_symbol", "GENERATE-FOREIGN-NAME-FROM-SUBLISP-SYMBOL", 2, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "valid_arg_conversion_pattern", "VALID-ARG-CONVERSION-PATTERN", 1, 0, false);
        declareMacro("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "ffuncall", "FFUNCALL");
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "make_dummy_arg_list", "MAKE-DUMMY-ARG-LIST", 1, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "define_foreign_function_internal", "DEFINE-FOREIGN-FUNCTION-INTERNAL", 7, 0, false);
        declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "vector_for_marshalling", "VECTOR-FOR-MARSHALLING", 3, 0, false);
        return SubLNil.NIL;
    }
