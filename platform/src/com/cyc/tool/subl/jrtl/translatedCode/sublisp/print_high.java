...
public class print_high extends SubLTranslatedFile {
	...
	public static SubLObject with_printer_state(SubLObject macroform, SubLObject environment) {
		...
		return list(PROGN, list(CSETF, stream_var, list(OUTPUT_STREAM_DESIGNATOR_STREAM, stream_var)),
				list(PIF, $print_circle$, list(CLET, list(list(info, list(CDR, listS(ASSOC, stream_var, $list19)))), list(PIF, list(CAND, info, list(CNOT, newp)), bq_cons(PROGN, append(body, SubLNil.NIL)), list(CLET, list(bq_cons(table, $list22), list(saved_stream, stream_var), bq_cons(temp_stream, $list23)),
	...
	private static final SubLList $list36 = list(makeSymbol("&KEY"), list(makeSymbol("STREAM"), makeSymbol("*STANDARD-OUTPUT*")), list(list(makeKeyword("ARRAY"), makeSymbol("*PRINT-ARRAY*")), makeSymbol("*PRINT-ARRAY*")), list(list(makeKeyword("BASE"), makeSymbol("*PRINT-BASE*")), makeSymbol("*PRINT-BASE*")), list(list(makeKeyword("CASE"), makeSymbol("*PRINT-CASE*")), makeSymbol("*PRINT-CASE*")),
			list(list(makeKeyword("CIRCLE"), makeSymbol("*PRINT-CIRCLE*")), makeSymbol("*PRINT-CIRCLE*")), list(list(makeKeyword("ESCAPE"), makeSymbol("*PRINT-ESCAPE*")), makeSymbol("*PRINT-ESCAPE*")), list(list(makeKeyword("GENSYM"), makeSymbol("*PRINT-GENSYM*")), makeSymbol("*PRINT-GENSYM*")), list(list(makeKeyword("LENGTH"), makeSymbol("*PRINT-LENGTH*")), makeSymbol("*PRINT-LENGTH*")),
			list(list($LEVEL, makeSymbol("*PRINT-LEVEL*")), makeSymbol("*PRINT-LEVEL*")), list(list(makeKeyword("LINES"), makeSymbol("*PRINT-LINES*")), makeSymbol("*PRINT-LINES*")), list(list(makeKeyword("MISER-WIDTH"), makeSymbol("*PRINT-MISER-WIDTH*")), makeSymbol("*PRINT-MISER-WIDTH*")), list(list(makeKeyword("PPRINT-DISPATCH"), makeSymbol("*PRINT-PPRINT-DISPATCH*")), makeSymbol("*PRINT-PPRINT-DISPATCH*")),
			list(list(makeKeyword("PRETTY"), makeSymbol("*PRINT-PRETTY*")), makeSymbol("*PRINT-PRETTY*")), list(list(makeKeyword("RADIX"), makeSymbol("*PRINT-RADIX*")), makeSymbol("*PRINT-RADIX*")), list(list(makeKeyword("READABLY"), makeSymbol("*PRINT-READABLY*")), makeSymbol("*PRINT-READABLY*")), list(list(makeKeyword("RIGHT-MARGIN"), makeSymbol("*PRINT-RIGHT-MARGIN*")), makeSymbol("*PRINT-RIGHT-MARGIN*")));

	private static final SubLList $list37 = list(
			new SubLObject[] { makeKeyword("STREAM"), makeKeyword("ARRAY"), makeKeyword("BASE"), makeKeyword("CASE"), makeKeyword("CIRCLE"), makeKeyword("ESCAPE"), makeKeyword("GENSYM"), makeKeyword("LENGTH"), makeKeyword("LEVEL"), makeKeyword("LINES"), makeKeyword("MISER-WIDTH"), makeKeyword("PPRINT-DISPATCH"), makeKeyword("PRETTY"), makeKeyword("RADIX"), makeKeyword("READABLY"), makeKeyword("RIGHT-MARGIN") });
