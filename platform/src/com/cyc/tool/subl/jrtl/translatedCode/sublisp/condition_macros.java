...
public class condition_macros extends SubLTranslatedFile {
	...
	SubLFiles.declareMacro("com.cyc.tool.subl.jrtl.translatedCode.sublisp.condition_macros", "with_simple_restart", "WITH-SIMPLE-RESTART");
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.condition_macros", "with_simple_restart_internal", "WITH-SIMPLE-RESTART-INTERNAL", 4, 0, false);
	SubLFiles.declareMacro("com.cyc.tool.subl.jrtl.translatedCode.sublisp.condition_macros", "with_sublisp_error_handling", "WITH-SUBLISP-ERROR-HANDLING");
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.condition_macros", "with_sublisp_error_handling_internal", "WITH-SUBLISP-ERROR-HANDLING-INTERNAL", 1, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.condition_macros", "with_error_handler_internal", "WITH-ERROR-HANDLER-INTERNAL", 2, 0, false);
	SubLFiles.declareMacro("com.cyc.tool.subl.jrtl.translatedCode.sublisp.condition_macros", "ignore_errors", "IGNORE-ERRORS");
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.condition_macros", "ignore_errors_internal", "IGNORE-ERRORS-INTERNAL", 1, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.condition_macros", "ignore_errors_handler", "IGNORE-ERRORS-HANDLER", 0, 0, false);
	return SubLNil.NIL;
    }
	...
	return ConsesLow.list(condition_macros.$sym3$CLET, ConsesLow.list(tag),
		ConsesLow.list(condition_macros.$sym10$CCATCH, condition_macros.$kw14$IGNORE_ERRORS_TARGET, tag, ConsesLow.list(condition_macros.$sym5$IGNORE, tag), ConsesLow.listS(condition_macros.$sym15$WITH_ERROR_HANDLER, condition_macros.$list16, ConsesLow.append(body, SubLNil.NIL))));
    }
	...
	return ConsesLow.listS(condition_macros.$sym3$CLET, ConsesLow.list(ConsesLow.list(condition_macros.$sym12$_ERROR_HANDLER_, handler)), ConsesLow.append(body, SubLNil.NIL));
    }
	...
	return ConsesLow.list(condition_macros.$sym3$CLET, ConsesLow.list(ConsesLow.list(tag, SubLNil.NIL != name ? ConsesLow.list(condition_macros.$sym4$QUOTE, name) : ConsesLow.list(condition_macros.$sym4$QUOTE, tag)), dummy), ConsesLow.list(condition_macros.$sym5$IGNORE, dummy),
		ConsesLow.list(condition_macros.$sym3$CLET,
			ConsesLow.list(ConsesLow.list(condition_macros.$sym6$_RESTARTS_, ConsesLow.listS(condition_macros.$sym7$CONS, ConsesLow.listS(condition_macros.$sym8$LIST, tag, format_control, ConsesLow.append(format_arguments, SubLNil.NIL)), condition_macros.$list9))),
			ConsesLow.listS(condition_macros.$sym10$CCATCH, tag, dummy, ConsesLow.append(body, SubLNil.NIL))));
    }
	...
	$list0 = ConsesLow.list(ConsesLow.list(SubLObjectFactory.makeSymbol("NAME"), SubLObjectFactory.makeSymbol("FORMAT-CONTROL"), SubLObjectFactory.makeSymbol("&REST"), SubLObjectFactory.makeSymbol("FORMAT-ARGUMENTS")), SubLObjectFactory.makeSymbol("&BODY"), SubLObjectFactory.makeSymbol("BODY"));
	...
	$list16 = ConsesLow.list(SubLObjectFactory.makeSymbol("FUNCTION"), SubLObjectFactory.makeSymbol("IGNORE-ERRORS-HANDLER"));
    }
