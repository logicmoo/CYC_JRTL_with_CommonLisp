...
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.Characters.CHAR_y;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.Characters.CHAR_z;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.$int$32;
...
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.*;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.APPEND;
...
public class reader extends SubLTranslatedFile {
    ...
    public static SubLObject declare_reader_file() {
        declareMacro(myName, "loop", "LOOP");
        declareFunction(myName, "whitespace_1_char_p", "WHITESPACE-1-CHAR-P", 1, 0, false);
        declareFunction(myName, "whitespace_2_char_p", "WHITESPACE-2-CHAR-P", 1, 0, false);
        declareFunction(myName, "readtable_print_function_trampoline", "READTABLE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(myName, "readtable_p", "READTABLE-P", 1, 0, false);
        new reader.$readtable_p$UnaryFunction();
        declareFunction(myName, "readtable_case", "READTABLE-CASE", 1, 0, false);
        declareFunction(myName, "readtable_character_syntax", "READTABLE-CHARACTER-SYNTAX", 1, 0, false);
        declareFunction(myName, "readtable_single_byte_char_syntax", "READTABLE-SINGLE-BYTE-CHAR-SYNTAX", 1, 0, false);
        declareFunction(myName, "readtable_macro_functions", "READTABLE-MACRO-FUNCTIONS", 1, 0, false);
        declareFunction(myName, "readtable_single_byte_macro_functions", "READTABLE-SINGLE-BYTE-MACRO-FUNCTIONS", 1, 0, false);
        declareFunction(myName, "readtable_constituent_traits", "READTABLE-CONSTITUENT-TRAITS", 1, 0, false);
        declareFunction(myName, "readtable_single_byte_constit_traits", "READTABLE-SINGLE-BYTE-CONSTIT-TRAITS", 1, 0, false);
        declareFunction(myName, "readtable_dispatch_tables", "READTABLE-DISPATCH-TABLES", 1, 0, false);
        declareFunction(myName, "_csetf_readtable_case", "_CSETF-READTABLE-CASE", 2, 0, false);
        declareFunction(myName, "_csetf_readtable_character_syntax", "_CSETF-READTABLE-CHARACTER-SYNTAX", 2, 0, false);
        declareFunction(myName, "_csetf_readtable_single_byte_char_syntax", "_CSETF-READTABLE-SINGLE-BYTE-CHAR-SYNTAX", 2, 0, false);
        declareFunction(myName, "_csetf_readtable_macro_functions", "_CSETF-READTABLE-MACRO-FUNCTIONS", 2, 0, false);
        declareFunction(myName, "_csetf_readtable_single_byte_macro_functions", "_CSETF-READTABLE-SINGLE-BYTE-MACRO-FUNCTIONS", 2, 0, false);
        declareFunction(myName, "_csetf_readtable_constituent_traits", "_CSETF-READTABLE-CONSTITUENT-TRAITS", 2, 0, false);
        declareFunction(myName, "_csetf_readtable_single_byte_constit_traits", "_CSETF-READTABLE-SINGLE-BYTE-CONSTIT-TRAITS", 2, 0, false);
        declareFunction(myName, "_csetf_readtable_dispatch_tables", "_CSETF-READTABLE-DISPATCH-TABLES", 2, 0, false);
        declareFunction(myName, "make_readtable", "MAKE-READTABLE", 0, 1, false);
        declareFunction(myName, "visit_defstruct_readtable", "VISIT-DEFSTRUCT-READTABLE", 2, 0, false);
        declareFunction(myName, "visit_defstruct_object_readtable_method", "VISIT-DEFSTRUCT-OBJECT-READTABLE-METHOD", 2, 0, false);
        declareFunction(myName, "create_readtable", "CREATE-READTABLE", 0, 0, false);
        declareFunction(myName, "single_byte_p", "SINGLE-BYTE-P", 1, 0, false);
        declareMacro(myName, "character_syntax", "CHARACTER-SYNTAX");
        declareFunction(myName, "set_character_syntax", "SET-CHARACTER-SYNTAX", 2, 1, false);
        declareFunction(myName, "invalid_syntaxp", "INVALID-SYNTAXP", 1, 0, false);
        declareFunction(myName, "terminating_macro_syntaxp", "TERMINATING-MACRO-SYNTAXP", 1, 0, false);
        declareFunction(myName, "non_terminating_macro_syntaxp", "NON-TERMINATING-MACRO-SYNTAXP", 1, 0, false);
        declareFunction(myName, "multiple_escape_syntaxp", "MULTIPLE-ESCAPE-SYNTAXP", 1, 0, false);
        declareFunction(myName, "single_escape_syntaxp", "SINGLE-ESCAPE-SYNTAXP", 1, 0, false);
        declareFunction(myName, "whitespace_syntaxp", "WHITESPACE-SYNTAXP", 1, 0, false);
        declareFunction(myName, "constituent_syntaxp", "CONSTITUENT-SYNTAXP", 1, 0, false);
        declareFunction(myName, "character_function", "CHARACTER-FUNCTION", 1, 1, false);
        declareFunction(myName, "set_character_function", "SET-CHARACTER-FUNCTION", 2, 1, false);
        declareFunction(myName, "character_traits", "CHARACTER-TRAITS", 1, 1, false);
        declareMacro(myName, "has_traitp", "HAS-TRAITP");
        declareFunction(myName, "set_trait", "SET-TRAIT", 3, 0, false);
        declareFunction(myName, "reset_trait", "RESET-TRAIT", 1, 1, false);
        declareFunction(myName, "alphabetic_traitp", "ALPHABETIC-TRAITP", 1, 0, false);
        declareFunction(myName, "digit_traitp", "DIGIT-TRAITP", 1, 0, false);
        declareFunction(myName, "package_marker_traitp", "PACKAGE-MARKER-TRAITP", 1, 0, false);
        declareFunction(myName, "plus_sign_traitp", "PLUS-SIGN-TRAITP", 1, 0, false);
        declareFunction(myName, "minus_sign_traitp", "MINUS-SIGN-TRAITP", 1, 0, false);
        declareFunction(myName, "dot_traitp", "DOT-TRAITP", 1, 0, false);
        declareFunction(myName, "decimal_point_traitp", "DECIMAL-POINT-TRAITP", 1, 0, false);
        declareFunction(myName, "ratio_marker_traitp", "RATIO-MARKER-TRAITP", 1, 0, false);
        declareFunction(myName, "exponent_marker_traitp", "EXPONENT-MARKER-TRAITP", 1, 0, false);
        declareFunction(myName, "invalid_traitp", "INVALID-TRAITP", 1, 0, false);
        declareFunction(myName, "alphadigit_traitp", "ALPHADIGIT-TRAITP", 1, 0, false);
        declareFunction(myName, "Xcopy_hash_table", "%COPY-HASH-TABLE", 2, 0, false);
        declareFunction(myName, "copy_readtable", "COPY-READTABLE", 0, 2, false);
        declareFunction(myName, "make_dispatch_macro_character", "MAKE-DISPATCH-MACRO-CHARACTER", 1, 2, false);
        declareFunction(myName, "readtablep", "READTABLEP", 1, 0, false);
        declareFunction(myName, "set_dispatch_macro_character", "SET-DISPATCH-MACRO-CHARACTER", 3, 1, false);
        declareFunction(myName, "get_dispatch_macro_character", "GET-DISPATCH-MACRO-CHARACTER", 2, 1, false);
        declareFunction(myName, "get_macro_character", "GET-MACRO-CHARACTER", 1, 1, false);
        declareFunction(myName, "set_macro_character", "SET-MACRO-CHARACTER", 2, 2, false);
        declareFunction(myName, "set_syntax_from_char", "SET-SYNTAX-FROM-CHAR", 2, 2, false);
        declareFunction(myName, "set_syntax", "SET-SYNTAX", 3, 0, false);
        declareFunction(myName, "simple_reader_error", "SIMPLE-READER-ERROR", 2, 0, false);
        declareFunction(myName, "end_of_file_error", "END-OF-FILE-ERROR", 1, 0, false);
        declareFunction(myName, "invalid_token_syntax_error", "INVALID-TOKEN-SYNTAX-ERROR", 2, 0, false);
        declareFunction(myName, "unimplemented_reader_macro_error", "UNIMPLEMENTED-READER-MACRO-ERROR", 2, 0, false);
        declareFunction(myName, "unnecessary_argument_error", "UNNECESSARY-ARGUMENT-ERROR", 2, 0, false);
        declareFunction(myName, "illegal_argument_error", "ILLEGAL-ARGUMENT-ERROR", 3, 0, false);
        declareFunction(myName, "read_internal", "READ-INTERNAL", 1, 2, false);
        declareFunction(myName, "read_preserving_whitespace", "READ-PRESERVING-WHITESPACE", 0, 4, false);
        declareFunction(myName, "read", "READ", 0, 4, false);
        declareFunction(myName, "read_delimited_list", "READ-DELIMITED-LIST", 1, 2, false);
        declareFunction(myName, "read_from_string", "READ-FROM-STRING", 1, 5, false);
        declareMacro(myName, "with_standard_io_syntax", "WITH-STANDARD-IO-SYNTAX");
        declareMacro(myName, "with_special_reader_error_handling", "WITH-SPECIAL-READER-ERROR-HANDLING");
        declareFunction(myName, "read_ignoring_errors", "READ-IGNORING-ERRORS", 0, 3, false);
        declareFunction(myName, "read_from_string_ignoring_errors", "READ-FROM-STRING-IGNORING-ERRORS", 1, 4, false);
        declareFunction(myName, "read_token_print_function_trampoline", "READ-TOKEN-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(myName, "read_token_p", "READ-TOKEN-P", 1, 0, false);
        new reader.$read_token_p$UnaryFunction();
        declareFunction(myName, "read_token_pointer", "READ-TOKEN-POINTER", 1, 0, false);
        declareFunction(myName, "read_token_buffer", "READ-TOKEN-BUFFER", 1, 0, false);
        declareFunction(myName, "read_token_escapes", "READ-TOKEN-ESCAPES", 1, 0, false);
        declareFunction(myName, "_csetf_read_token_pointer", "_CSETF-READ-TOKEN-POINTER", 2, 0, false);
        declareFunction(myName, "_csetf_read_token_buffer", "_CSETF-READ-TOKEN-BUFFER", 2, 0, false);
        declareFunction(myName, "_csetf_read_token_escapes", "_CSETF-READ-TOKEN-ESCAPES", 2, 0, false);
        declareFunction(myName, "make_read_token", "MAKE-READ-TOKEN", 0, 1, false);
        declareFunction(myName, "visit_defstruct_read_token", "VISIT-DEFSTRUCT-READ-TOKEN", 2, 0, false);
        declareFunction(myName, "visit_defstruct_object_read_token_method", "VISIT-DEFSTRUCT-OBJECT-READ-TOKEN-METHOD", 2, 0, false);
        declareMacro(myName, "with_read_token", "WITH-READ-TOKEN");
        declareFunction(myName, "add_to_token", "ADD-TO-TOKEN", 3, 0, false);
        declareFunction(myName, "read_token_string", "READ-TOKEN-STRING", 1, 0, false);
        declareFunction(myName, "read_token", "READ-TOKEN", 3, 0, false);
        declareFunction(myName, "potential_number_p", "POTENTIAL-NUMBER-P", 2, 0, false);
        declareFunction(myName, "parse_token", "PARSE-TOKEN", 2, 0, false);
        declareFunction(myName, "symbol_escapep", "SYMBOL-ESCAPEP", 1, 0, false);
        declareFunction(myName, "reader_find_package", "READER-FIND-PACKAGE", 3, 0, false);
        declareFunction(myName, "frob_case", "FROB-CASE", 1, 0, false);
        declareFunction(myName, "parse_symbol_or_consing_dot", "PARSE-SYMBOL-OR-CONSING-DOT", 2, 0, false);
        declareFunction(myName, "float_parse_integer", "FLOAT-PARSE-INTEGER", 4, 0, false);
        declareFunction(myName, "parse_number", "PARSE-NUMBER", 2, 0, false);
        declareFunction(myName, "parse_integer", "PARSE-INTEGER", 1, 4, false);
        declareFunction(myName, "whitespace_rmf", "WHITESPACE-RMF", 2, 0, false);
        declareFunction(myName, "constituent_rmf", "CONSTITUENT-RMF", 2, 0, false);
        declareFunction(myName, "invalid_rmf", "INVALID-RMF", 2, 0, false);
        declareFunction(myName, "single_escape_rmf", "SINGLE-ESCAPE-RMF", 2, 0, false);
        declareFunction(myName, "multiple_escape_rmf", "MULTIPLE-ESCAPE-RMF", 2, 0, false);
        declareFunction(myName, "sharpsign_capital_g_rmf", "SHARPSIGN-CAPITAL-G-RMF", 3, 0, false);
        declareFunction(myName, "left_paren_rmf", "LEFT-PAREN-RMF", 2, 0, false);
        declareFunction(myName, "right_paren_rmf", "RIGHT-PAREN-RMF", 2, 0, false);
        declareFunction(myName, "single_quote_rmf", "SINGLE-QUOTE-RMF", 2, 0, false);
        declareFunction(myName, "semicolon_rmf", "SEMICOLON-RMF", 2, 0, false);
        declareFunction(myName, "double_quote_rmf", "DOUBLE-QUOTE-RMF", 2, 0, false);
        declareFunction(myName, "bq_cons", "BQ-CONS", 2, 0, false);
        declareMacro(myName, "bq_list", "BQ-LIST");
        declareMacro(myName, "bq_listX", "BQ-LIST*");
        declareMacro(myName, "bq_append", "BQ-APPEND");
        declareMacro(myName, "bq_nconc", "BQ-NCONC");
        declareFunction(myName, "bq_vector", "BQ-VECTOR", 1, 0, false);
        declareMacro(myName, "bq_vector_append", "BQ-VECTOR-APPEND");
        declareFunction(myName, "backquotify", "BACKQUOTIFY", 2, 0, false);
        declareFunction(myName, "comma", "COMMA", 1, 0, false);
        declareFunction(myName, "self_evaluating_atom_p", "SELF-EVALUATING-ATOM-P", 1, 0, false);
        declareFunction(myName, "backquotify_1", "BACKQUOTIFY-1", 2, 0, false);
        declareFunction(myName, "backquote_rmf", "BACKQUOTE-RMF", 2, 0, false);
        declareFunction(myName, "comma_rmf", "COMMA-RMF", 2, 0, false);
        declareFunction(myName, "dispatching_rmf", "DISPATCHING-RMF", 2, 0, false);
        declareFunction(myName, "sharpsign_backslash_rmf", "SHARPSIGN-BACKSLASH-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_single_quote_rmf", "SHARPSIGN-SINGLE-QUOTE-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_left_paren_rmf", "SHARPSIGN-LEFT-PAREN-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_asterisk_rmf", "SHARPSIGN-ASTERISK-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_colon_rmf", "SHARPSIGN-COLON-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_dot_rmf", "SHARPSIGN-DOT-RMF", 3, 0, false);
        declareFunction(myName, "read_number_in_radix", "READ-NUMBER-IN-RADIX", 2, 0, false);
        declareFunction(myName, "sharpsign_b_rmf", "SHARPSIGN-B-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_o_rmf", "SHARPSIGN-O-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_x_rmf", "SHARPSIGN-X-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_r_rmf", "SHARPSIGN-R-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_c_rmf", "SHARPSIGN-C-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_a_rmf", "SHARPSIGN-A-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_s_rmf", "SHARPSIGN-S-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_p_rmf", "SHARPSIGN-P-RMF", 3, 0, false);
        declareFunction(myName, "read_lookup", "READ-LOOKUP", 1, 0, false);
        declareFunction(myName, "set_read_lookup", "SET-READ-LOOKUP", 2, 0, false);
        declareFunction(myName, "sharpsign_equals_rmf", "SHARPSIGN-EQUALS-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_sharpsign_rmf", "SHARPSIGN-SHARPSIGN-RMF", 3, 0, false);
        declareFunction(myName, "features_match", "FEATURES-MATCH", 1, 0, false);
        declareFunction(myName, "fix_features", "FIX-FEATURES", 1, 0, false);
        declareFunction(myName, "read_features", "READ-FEATURES", 1, 0, false);
        declareFunction(myName, "sharpsign_plus_rmf", "SHARPSIGN-PLUS-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_minus_rmf", "SHARPSIGN-MINUS-RMF", 3, 0, false);
        declareFunction(myName, "sharpsign_vertical_bar_rmf", "SHARPSIGN-VERTICAL-BAR-RMF", 3, 0, false);
        return NIL;
    }
    ...
    public static SubLObject set_character_function(SubLObject ch, SubLObject func, SubLObject readtable) {
        ...
        sethash(ch, readtable_macro_functions(readtable), func);
        if (NIL != single_byte_p(ch))
