...
start reading from again or :ERROR if there was some kind of reader error. */
  ...
  public static final SubLObject declare_reader_file() {
    ...
    declareFunction(myName, "readtable_p", "READTABLE-P", 1, 0, false); new $readtable_p$UnaryFunction();
    ...
    declareFunction(myName, "read_token_p", "READ-TOKEN-P", 1, 0, false); new $read_token_p$UnaryFunction();
