...
public class conses_high extends SubLTranslatedFile {
    ...
    public static SubLObject _cons_length(SubLObject list) {
        ...
        SubLObject fast;
        SubLObject length;
        for (slow = SubLNil.NIL, fast = SubLNil.NIL, length = SubLNil.NIL, slow = list.rest(), fast = cddr(list), length = CommonSymbols.TWO_INTEGER; !fast.eql(slow); slow = slow
    ...
    public static SubLNil symbol_in_tree_p(SubLObject var74, SubLObject var10) {
        ...
        if (true)
            throw new AbstractMethodError("conses_high.symbol_in_tree_p");
        return null;
    }
    ...
    public static SubLObject _tree_equal_2(SubLObject tree1, SubLObject tree2) {
        ...
        if (tree1.isCons() && tree2.isCons()) {
            ...
            for (rest_tree1 = SubLNil.NIL, rest_tree2 = SubLNil.NIL, rest_tree1 = tree1, rest_tree2 = tree2; !rest_tree1.isAtom() && !rest_tree2.isAtom()
                    && SubLNil.NIL != _tree_equal_2(rest_tree1.first(), rest_tree2.first()); rest_tree1 = rest_tree1.rest(), rest_tree2 = rest_tree2.rest()) {
            }
    ...
    static {
        ...
        $list2 = ConsesLow.list(SubLObjectFactory.makeSymbol("INLINE"), SubLObjectFactory.makeSymbol("CAAR"), SubLObjectFactory.makeSymbol("CADR"), SubLObjectFactory
                .makeSymbol("CDAR"), SubLObjectFactory.makeSymbol("CDDR"));
        ...
        $list7 = ConsesLow.list(new SubLObject[] { SubLObjectFactory.makeSymbol("INLINE"), SubLObjectFactory.makeSymbol("FIRST"), SubLObjectFactory.makeSymbol("SECOND"),
                SubLObjectFactory.makeSymbol("THIRD"), SubLObjectFactory.makeSymbol("FOURTH"), SubLObjectFactory.makeSymbol("FIFTH"), SubLObjectFactory.makeSymbol("SIXTH"),
                SubLObjectFactory.makeSymbol("SEVENTH"), SubLObjectFactory.makeSymbol("EIGHTH"), SubLObjectFactory.makeSymbol("NINTH"), SubLObjectFactory.makeSymbol("TENTH") });
        ...
        $list29 = ConsesLow
                .list(SubLObjectFactory.makeSymbol("INLINE"), SubLObjectFactory.makeSymbol("_MEMBER-2"), SubLObjectFactory.makeSymbol("_MEMBER-3"), SubLObjectFactory.makeSymbol("_MEMBER-4"));
        ...
        $list37 = ConsesLow
                .list(SubLObjectFactory.makeSymbol("INLINE"), SubLObjectFactory.makeSymbol("_NUNION-2"), SubLObjectFactory.makeSymbol("_NUNION-3"), SubLObjectFactory.makeSymbol("_NUNION-4"));
        $list38 = ConsesLow.list(SubLObjectFactory.makeSymbol("NOTINLINE"), SubLObjectFactory.makeSymbol("INTERSECTION"));
        $list39 = ConsesLow.list(SubLObjectFactory.makeSymbol("INLINE"), SubLObjectFactory.makeSymbol("_INTERSECTION-2"), SubLObjectFactory.makeSymbol("_INTERSECTION-3"), SubLObjectFactory
                .makeSymbol("_INTERSECTION-4"));
        $list40 = ConsesLow.list(SubLObjectFactory.makeSymbol("NOTINLINE"), SubLObjectFactory.makeSymbol("NINTERSECTION"));
        $list41 = ConsesLow.list(SubLObjectFactory.makeSymbol("INLINE"), SubLObjectFactory.makeSymbol("_NINTERSECTION-2"), SubLObjectFactory.makeSymbol("_NINTERSECTION-3"), SubLObjectFactory
                .makeSymbol("_NINTERSECTION-4"));
        $list42 = ConsesLow.list(SubLObjectFactory.makeSymbol("NOTINLINE"), SubLObjectFactory.makeSymbol("SET-DIFFERENCE"));
        $list43 = ConsesLow.list(SubLObjectFactory.makeSymbol("INLINE"), SubLObjectFactory.makeSymbol("_SET-DIFFERENCE-2"), SubLObjectFactory.makeSymbol("_SET-DIFFERENCE-3"), SubLObjectFactory
                .makeSymbol("_SET-DIFFERENCE-4"));
        $list44 = ConsesLow.list(SubLObjectFactory.makeSymbol("NOTINLINE"), SubLObjectFactory.makeSymbol("NSET-DIFFERENCE"));
        $list45 = ConsesLow.list(SubLObjectFactory.makeSymbol("INLINE"), SubLObjectFactory.makeSymbol("_NSET-DIFFERENCE-2"), SubLObjectFactory.makeSymbol("_NSET-DIFFERENCE-3"), SubLObjectFactory
                .makeSymbol("_NSET-DIFFERENCE-4"));
        ...
        $list49 = ConsesLow
                .list(SubLObjectFactory.makeSymbol("INLINE"), SubLObjectFactory.makeSymbol("_SUBSETP-2"), SubLObjectFactory.makeSymbol("_SUBSETP-3"), SubLObjectFactory.makeSymbol("_SUBSETP-4"));
        ...
        $list57 = ConsesLow
                .list(SubLObjectFactory.makeSymbol("INLINE"), SubLObjectFactory.makeSymbol("_RASSOC-2"), SubLObjectFactory.makeSymbol("_RASSOC-3"), SubLObjectFactory.makeSymbol("_RASSOC-4"));
