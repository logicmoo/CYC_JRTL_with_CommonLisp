...
public class conses_high extends SubLTranslatedFile
{
  ...
  private static SubLObject $list391 = ConsesLow.list( (SubLObject) SubLObjectFactory.makeSymbol( "INLINE-SET-SYMBOL" ), (SubLObject) SubLObjectFactory.makeSymbol( "INLINE-GET-SYMBOL" ), (SubLObject) SubLObjectFactory
      .makeSymbol( "INLINE-METHOD" ) );

  @SubL(
    source = "sublisp/conses-high.lisp",
    position = 1939L)
  ...
  public static SubLObject _assoc_4(SubLObject item, SubLObject alist, SubLObject test, SubLObject key)
  {
    ...
    while ( SubLNil.NIL != rest)
    {
      if( SubLNil.NIL != entry && SubLNil.NIL != Functions.funcall( test, item, Functions.funcall( key, entry.first() ) ) )
        return entry;
      rest = rest.rest();
      entry = rest.first();
    }
  ...
  public static SubLObject _cons_length(SubLObject list)
  {
    ...
    SubLObject fast;
    SubLObject length;
    for( slow = SubLNil.NIL, fast = SubLNil.NIL, length = SubLNil.NIL, slow = list.rest(), fast = cddr( list ), length = CommonSymbols.TWO_INTEGER; !fast.eql( slow ); slow = slow.rest(), fast = cddr(
        fast ), length = Numbers.add( CommonSymbols.TWO_INTEGER, length ) )
    {
      if( fast.isAtom() )
        return length;
      if( fast.rest().isAtom() )
  ...
  public static SubLObject _rassoc_4(SubLObject item, SubLObject alist, SubLObject test, SubLObject key)
  {
    ...
    while ( SubLNil.NIL != rest)
    {
      if( SubLNil.NIL != entry && SubLNil.NIL != Functions.funcall( test, item, Functions.funcall( key, entry.rest() ) ) )
        return entry;
      rest = rest.rest();
      entry = rest.first();
    }
  ...
  {
    if( conses_high.NIL == tree )
    {
      return (SubLObject) conses_high.NIL;
    }
    if( tree.isSymbol() )
    {
    ...
    if( tree.isCons() )
    {
      return (SubLObject) SubLObjectFactory.makeBoolean( conses_high.NIL != symbol_in_tree_p( symbol, tree.first() ) || conses_high.NIL != symbol_in_tree_p( symbol, tree.rest() ) );
    }
    return (SubLObject) conses_high.NIL;
  }
  ...
  public static final SubLObject unquoted_symbol_in_tree_p(final SubLObject symbol, final SubLObject tree)
  {
    ...
    if( conses_high.NIL == member( tree.first(), (SubLObject) conses_high.$list391, (SubLObject) conses_high.UNPROVIDED, (SubLObject) conses_high.UNPROVIDED ) )
    {
      return (SubLObject) SubLObjectFactory.makeBoolean( conses_high.NIL != symbol_in_tree_p( symbol, tree.first() ) || conses_high.NIL != symbol_in_tree_p( symbol, tree.rest() ) );
    }
    if( tree.rest().isCons() && cadr( tree ).isCons() && cddr( tree ).isList() )
    {
      ...
      SubLObject arg = (SubLObject) conses_high.NIL;
      arg = cdolist_list_var.first();
      while ( conses_high.NIL != cdolist_list_var)
      {
        if( conses_high.NIL != unquoted_symbol_in_tree_p( symbol, arg ) )
        {
          return (SubLObject) conses_high.T;
        }
        cdolist_list_var = cdolist_list_var.rest();
        arg = cdolist_list_var.first();
      }
  ...
  public static SubLObject _tree_equal_2(SubLObject tree1, SubLObject tree2)
  {
    ...
    if( tree1.isCons() && tree2.isCons() )
    {
      ...
      for( rest_tree1 = SubLNil.NIL, rest_tree2 = SubLNil.NIL, rest_tree1 = tree1, rest_tree2 = tree2; !rest_tree1.isAtom() && !rest_tree2.isAtom() && SubLNil.NIL != _tree_equal_2( rest_tree1.first(), rest_tree2
          .first() ); rest_tree1 = rest_tree1.rest(), rest_tree2 = rest_tree2.rest() )
      {
      }
      return SubLObjectFactory.makeBoolean( rest_tree1.isAtom() && rest_tree2.isAtom() && SubLNil.NIL != _tree_equal_2( rest_tree1, rest_tree2 ) );
    }
    return SubLNil.NIL;
  }
  ...
  public static SubLObject _tree_equal_3(SubLObject tree1, SubLObject tree2, SubLObject test)
  {
    ...
    if( tree1.isCons() && tree2.isCons() )
    {
      SubLObject rest_tree1;
      SubLObject rest_tree2;
      for( rest_tree1 = SubLNil.NIL, rest_tree2 = SubLNil.NIL, rest_tree1 = tree1, rest_tree2 = tree2; !rest_tree1.isAtom() && !rest_tree2.isAtom() && SubLNil.NIL != _tree_equal_3( rest_tree1.first(), rest_tree2.first(),
          test ); rest_tree1 = rest_tree1.rest(), rest_tree2 = rest_tree2.rest() )
      {
      }
      return SubLObjectFactory.makeBoolean( rest_tree1.isAtom() && rest_tree2.isAtom() && SubLNil.NIL != _tree_equal_3( rest_tree1, rest_tree2, test ) );
    }
    return SubLNil.NIL;
  }
  ...
  public static SubLObject adjoin(SubLObject item, SubLObject list, SubLObject test, SubLObject key)
  {
    ...
    if( !key.eql( Symbols.symbol_function( CommonSymbols.IDENTITY ) ) )
      return SubLNil.NIL != _member_4( Functions.funcall( key, item ), list, test, key ) ? list : ConsesLow.cons( item, list );
  ...
  {
    return SubLObjectFactory.makeBoolean( object.isCons() && SubLNil.NIL == last( object, CommonSymbols.UNPROVIDED ) );
  }
  ...
  {
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_recons", "_RECONS", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_ncons", "_NCONS", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_cons_length", "_CONS-LENGTH", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "caar", "CAAR", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "cadr", "CADR", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "cdar", "CDAR", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "cddr", "CDDR", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_tree_equal_2", "_TREE-EQUAL-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_tree_equal_3", "_TREE-EQUAL-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "tree_equal", "TREE-EQUAL", 2, 1, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "endp", "ENDP", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "list_length", "LIST-LENGTH", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "first", "FIRST", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "second", "SECOND", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "third", "THIRD", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "fourth", "FOURTH", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "fifth", "FIFTH", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "sixth", "SIXTH", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "seventh", "SEVENTH", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "eighth", "EIGHTH", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "ninth", "NINTH", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "tenth", "TENTH", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "rest", "REST", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "nthcdr", "NTHCDR", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "copy_list", "COPY-LIST", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "copy_alist", "COPY-ALIST", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "copy_tree", "COPY-TREE", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "revappend", "REVAPPEND", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "nreconc", "NRECONC", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "ldiff", "LDIFF", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_subst_3", "_SUBST-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_subst_4", "_SUBST-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_subst_5", "_SUBST-5", 5, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "subst", "SUBST", 3, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_subst_if_3", "_SUBST-IF-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_subst_if_4", "_SUBST-IF-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "subst_if", "SUBST-IF", 3, 1, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nsubst_3", "_NSUBST-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nsubst_4", "_NSUBST-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nsubst_5", "_NSUBST-5", 5, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "nsubst", "NSUBST", 3, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nsubst_if_3", "_NSUBST-IF-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nsubst_if_4", "_NSUBST-IF-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "nsubst_if", "NSUBST-IF", 3, 1, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_sublis_2", "_SUBLIS-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_sublis_3", "_SUBLIS-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_sublis_4", "_SUBLIS-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "sublis", "SUBLIS", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nsublis_2", "_NSUBLIS-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nsublis_3", "_NSUBLIS-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nsublis_4", "_NSUBLIS-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "nsublis", "NSUBLIS", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_member_2", "_MEMBER-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_member_3", "_MEMBER-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_member_4", "_MEMBER-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "member", "MEMBER", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_member_if_2", "_MEMBER-IF-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_member_if_3", "_MEMBER-IF-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "member_if", "MEMBER-IF", 2, 1, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "tailp", "TAILP", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "adjoin", "ADJOIN", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_union_2", "_UNION-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_union_3", "_UNION-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_union_4", "_UNION-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "union", "UNION", 2, 2, false );
    new $union$BinaryFunction();
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nunion_2", "_NUNION-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nunion_3", "_NUNION-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nunion_4", "_NUNION-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "nunion", "NUNION", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_intersection_2", "_INTERSECTION-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_intersection_3", "_INTERSECTION-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_intersection_4", "_INTERSECTION-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "intersection", "INTERSECTION", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nintersection_2", "_NINTERSECTION-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nintersection_3", "_NINTERSECTION-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nintersection_4", "_NINTERSECTION-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "nintersection", "NINTERSECTION", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_set_difference_2", "_SET-DIFFERENCE-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_set_difference_3", "_SET-DIFFERENCE-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_set_difference_4", "_SET-DIFFERENCE-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "set_difference", "SET-DIFFERENCE", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nset_difference_2", "_NSET-DIFFERENCE-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nset_difference_3", "_NSET-DIFFERENCE-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_nset_difference_4", "_NSET-DIFFERENCE-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "nset_difference", "NSET-DIFFERENCE", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "set_exclusive_or", "SET-EXCLUSIVE-OR", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "nset_exclusive_or", "NSET-EXCLUSIVE-OR", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_subsetp_2", "_SUBSETP-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_subsetp_3", "_SUBSETP-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_subsetp_4", "_SUBSETP-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "subsetp", "SUBSETP", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "acons", "ACONS", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "pairlis", "PAIRLIS", 2, 1, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_assoc_2", "_ASSOC-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_assoc_3", "_ASSOC-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_assoc_4", "_ASSOC-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "assoc", "ASSOC", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "assoc_if", "ASSOC-IF", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_rassoc_2", "_RASSOC-2", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_rassoc_3", "_RASSOC-3", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "_rassoc_4", "_RASSOC-4", 4, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "rassoc", "RASSOC", 2, 2, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "rassoc_if", "RASSOC-IF", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "getf", "GETF", 2, 1, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "putf", "PUTF", 3, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "remf", "REMF", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "last", "LAST", 1, 1, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "circular_list_p", "CIRCULAR-LIST-P", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "non_circular_list_p", "NON-CIRCULAR-LIST-P", 1, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "butlast", "BUTLAST", 1, 1, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "nbutlast", "NBUTLAST", 1, 1, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "symbol_in_tree_p", "SYMBOL-IN-TREE-P", 2, 0, false );
    SubLFiles.declareFunction( "com.cyc.tool.subl.jrtl.translatedCode.sublisp.conses_high", "unquoted_symbol_in_tree_p", "UNQUOTED-SYMBOL-IN-TREE-P", 2, 0, false );
    return SubLNil.NIL;
  }
  ...
  public static SubLObject last(SubLObject list, SubLObject n)
  {
    ...
    SubLObject i;
    for( i = SubLNil.NIL, i = CommonSymbols.ZERO_INTEGER; i.numL( n ); i = Numbers.add( i, CommonSymbols.ONE_INTEGER ) )
    {
  ...
  static
  {
    ...
    $list0 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_RECONS" ), SubLObjectFactory.makeSymbol( "_NCONS" ) );
    $sym1$LISTP = SubLObjectFactory.makeSymbol( "LISTP" );
    $list2 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "CAAR" ), SubLObjectFactory.makeSymbol( "CADR" ), SubLObjectFactory.makeSymbol( "CDAR" ), SubLObjectFactory.makeSymbol(
        "CDDR" ) );
    ...
    $list7 = ConsesLow.list( new SubLObject[] { SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "FIRST" ), SubLObjectFactory.makeSymbol( "SECOND" ), SubLObjectFactory.makeSymbol( "THIRD" ),
      SubLObjectFactory.makeSymbol( "FOURTH" ), SubLObjectFactory.makeSymbol( "FIFTH" ), SubLObjectFactory.makeSymbol( "SIXTH" ), SubLObjectFactory.makeSymbol( "SEVENTH" ), SubLObjectFactory.makeSymbol( "EIGHTH" ),
    ...
    $list31 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_MEMBER-IF-2" ), SubLObjectFactory.makeSymbol( "_MEMBER-IF-3" ) );
    ...
    $list35 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_UNION-2" ), SubLObjectFactory.makeSymbol( "_UNION-3" ), SubLObjectFactory.makeSymbol( "_UNION-4" ) );
    $list36 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NOTINLINE" ), SubLObjectFactory.makeSymbol( "NUNION" ) );
    $list37 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_NUNION-2" ), SubLObjectFactory.makeSymbol( "_NUNION-3" ), SubLObjectFactory.makeSymbol( "_NUNION-4" ) );
    $list38 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NOTINLINE" ), SubLObjectFactory.makeSymbol( "INTERSECTION" ) );
    $list39 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_INTERSECTION-2" ), SubLObjectFactory.makeSymbol( "_INTERSECTION-3" ), SubLObjectFactory.makeSymbol(
        "_INTERSECTION-4" ) );
    $list40 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NOTINLINE" ), SubLObjectFactory.makeSymbol( "NINTERSECTION" ) );
    $list41 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_NINTERSECTION-2" ), SubLObjectFactory.makeSymbol( "_NINTERSECTION-3" ), SubLObjectFactory.makeSymbol(
        "_NINTERSECTION-4" ) );
    $list42 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NOTINLINE" ), SubLObjectFactory.makeSymbol( "SET-DIFFERENCE" ) );
    $list43 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_SET-DIFFERENCE-2" ), SubLObjectFactory.makeSymbol( "_SET-DIFFERENCE-3" ), SubLObjectFactory.makeSymbol(
        "_SET-DIFFERENCE-4" ) );
    $list44 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NOTINLINE" ), SubLObjectFactory.makeSymbol( "NSET-DIFFERENCE" ) );
    $list45 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_NSET-DIFFERENCE-2" ), SubLObjectFactory.makeSymbol( "_NSET-DIFFERENCE-3" ), SubLObjectFactory.makeSymbol(
        "_NSET-DIFFERENCE-4" ) );
    $list46 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "SET-EXCLUSIVE-OR" ) );
    $list47 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "NSET-EXCLUSIVE-OR" ) );
    $list48 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NOTINLINE" ), SubLObjectFactory.makeSymbol( "SUBSETP" ) );
    $list49 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_SUBSETP-2" ), SubLObjectFactory.makeSymbol( "_SUBSETP-3" ), SubLObjectFactory.makeSymbol( "_SUBSETP-4" ) );
    ...
    $str52$PAIRLIS_was_called_with_lists_of_ = SubLObjectFactory.makeString( "PAIRLIS was called with lists of different lengths" );
    $list53 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NOTINLINE" ), SubLObjectFactory.makeSymbol( "ASSOC" ) );
    $list54 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_ASSOC-2" ), SubLObjectFactory.makeSymbol( "_ASSOC-3" ), SubLObjectFactory.makeSymbol( "_ASSOC-4" ) );
    ...
    $list57 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "_RASSOC-2" ), SubLObjectFactory.makeSymbol( "_RASSOC-3" ), SubLObjectFactory.makeSymbol( "_RASSOC-4" ) );
    $list58 = ConsesLow.list( SubLObjectFactory.makeSymbol( "NOTINLINE" ), SubLObjectFactory.makeSymbol( "RASSOC-IF" ) );
    $str59$LAST_called_with_negative_index_o = SubLObjectFactory.makeString( "LAST called with negative index of ~S" );
    $list60 = ConsesLow.list( SubLObjectFactory.makeSymbol( "INLINE" ), SubLObjectFactory.makeSymbol( "BUTLAST" ) );
    $str61$NBUTLAST_called_with_negative_ind = SubLObjectFactory.makeString( "NBUTLAST called with negative index of ~S" );
