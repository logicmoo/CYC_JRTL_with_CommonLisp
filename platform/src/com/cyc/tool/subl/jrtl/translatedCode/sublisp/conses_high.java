...
public class conses_high extends SubLTranslatedFile {
	...
	public static SubLObject _tree_equal_3(SubLObject tree1, SubLObject tree2, SubLObject test) {
		...
		if (tree1.isCons() && tree2.isCons()) {
			SubLObject rest_tree1;
			SubLObject rest_tree2;
			for (rest_tree1 = SubLNil.NIL, rest_tree2 = SubLNil.NIL, rest_tree1 = tree1, rest_tree2 = tree2; ((!rest_tree1.isAtom()) && (!rest_tree2.isAtom())) && (SubLNil.NIL != _tree_equal_3(rest_tree1.first(), rest_tree2.first(), test)); rest_tree1 = rest_tree1.rest(), rest_tree2 = rest_tree2.rest()) {
			}
	...
	public static SubLObject cadr(SubLObject list) {
		final SubLObject rest2 = list.rest();
		return rest2.first();
	}
