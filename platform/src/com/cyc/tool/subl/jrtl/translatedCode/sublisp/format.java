...
public class format extends SubLTranslatedFile {
	...
	Errors.error(format.$str39$_S_is_not_a_recognized__S_control, Strings.sublisp_char(string, index), format.$sym38$FORMAT);
	return SubLNil.NIL;
    }
	...
	SubLObject new_args = Functions.funcall(Hashtables.gethash(ch, format.$format_directives$.getDynamicValue(thread), CommonSymbols.UNPROVIDED), new SubLObject[] { stream, string, start, end, args, all_args, parameters, at_sign_p, colonp });
	...
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_directive_p", "FORMAT-DIRECTIVE-P", 1, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "matching_bracket", "MATCHING-BRACKET", 1, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "call_format_directive", "CALL-FORMAT-DIRECTIVE", 10, 0, false);
	SubLFiles.declareMacro("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "defformat", "DEFFORMAT");
	SubLFiles.declareMacro("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "defformat_bracketed", "DEFFORMAT-BRACKETED");
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "unimplemented_format_directive", "UNIMPLEMENTED-FORMAT-DIRECTIVE", 1, 1, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "check_flags", "CHECK-FLAGS", 5, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_typep", "FORMAT-TYPEP", 2, 0, false);
	SubLFiles.declareMacro("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "with_format_parameters", "WITH-FORMAT-PARAMETERS");
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "illegal_directive", "ILLEGAL-DIRECTIVE", 2, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "bad_format_directive", "BAD-FORMAT-DIRECTIVE", 2, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "not_enough_format_arguments", "NOT-ENOUGH-FORMAT-ARGUMENTS", 1, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "matching_bracket_not_found", "MATCHING-BRACKET-NOT-FOUND", 3, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "not_a_list_argument", "NOT-A-LIST-ARGUMENT", 1, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "not_a_format_control", "NOT-A-FORMAT-CONTROL", 1, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "repitition_designator_value", "REPITITION-DESIGNATOR-VALUE", 1, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_repeat", "FORMAT-REPEAT", 3, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_padded", "FORMAT-PADDED", 7, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_c_directive", "FORMAT-C-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_percent_directive", "FORMAT-PERCENT-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_ampersand_directive", "FORMAT-AMPERSAND-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_vertical_bar_directive", "FORMAT-VERTICAL-BAR-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_tilde_directive", "FORMAT-TILDE-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_integer_internal", "FORMAT-INTEGER-INTERNAL", 2, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_integer", "FORMAT-INTEGER", 6, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "integer_truncate", "INTEGER-TRUNCATE", 2, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_cardinal_internal", "FORMAT-CARDINAL-INTERNAL", 4, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_cardinal", "FORMAT-CARDINAL", 2, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_ordinal", "FORMAT-ORDINAL", 2, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_r_directive", "FORMAT-R-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_d_directive", "FORMAT-D-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_b_directive", "FORMAT-B-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_o_directive", "FORMAT-O-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_x_directive", "FORMAT-X-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "split_flonum_digits", "SPLIT-FLONUM-DIGITS", 2, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "round_digits", "ROUND-DIGITS", 2, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "digits_add_1_int", "DIGITS-ADD-1-INT", 1, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "digits_add_1", "DIGITS-ADD-1", 1, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "round_decimal_digits", "ROUND-DECIMAL-DIGITS", 3, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_f_directive", "FORMAT-F-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_e_directive", "FORMAT-E-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_g_directive", "FORMAT-G-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_dollarsign_directive", "FORMAT-DOLLARSIGN-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_a_directive", "FORMAT-A-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_s_directive", "FORMAT-S-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_w_directive", "FORMAT-W-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_underscore_directive", "FORMAT-UNDERSCORE-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_i_directive", "FORMAT-I-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_slash_directive", "FORMAT-SLASH-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_t_directive", "FORMAT-T-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_less_than_directive", "FORMAT-LESS-THAN-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_greater_than_directive", "FORMAT-GREATER-THAN-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "backup_args", "BACKUP-ARGS", 3, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_asterisk_directive", "FORMAT-ASTERISK-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_left_bracket_directive", "FORMAT-LEFT-BRACKET-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_right_bracket_directive", "FORMAT-RIGHT-BRACKET-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_sublist_iteration", "FORMAT-SUBLIST-ITERATION", 7, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_iteration", "FORMAT-ITERATION", 7, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_left_brace_directive", "FORMAT-LEFT-BRACE-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_right_brace_directive", "FORMAT-RIGHT-BRACE-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_question_mark_directive", "FORMAT-QUESTION-MARK-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_left_paren_directive", "FORMAT-LEFT-PAREN-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_right_paren_directive", "FORMAT-RIGHT-PAREN-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_p_directive", "FORMAT-P-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_semicolon_directive", "FORMAT-SEMICOLON-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_circumflex_directive", "FORMAT-CIRCUMFLEX-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_newline_directive", "FORMAT-NEWLINE-DIRECTIVE", 9, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "really_format", "REALLY-FORMAT", 3, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "format_internal", "FORMAT-INTERNAL", 6, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "find_directive", "FIND-DIRECTIVE", 4, 0, false);
	SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.format", "parse_format_command", "PARSE-FORMAT-COMMAND", 3, 2, false);
	return SubLNil.NIL;
    }
	...
	return ConsesLow.list(format.$sym2$PROGN, ConsesLow.list(format.$sym3$DECLAIM, ConsesLow.list(format.$sym4$FACCESS, format.$sym5$PRIVATE, name)), ConsesLow.listS(format.$sym6$DEFINE, name, lambda_list, ConsesLow.append(body, SubLNil.NIL)),
		ConsesLow.list(format.$sym7$SETHASH, Characters.char_downcase(character), format.$sym8$_FORMAT_DIRECTIVES_, ConsesLow.list(format.$sym9$FUNCTION, name)),
		ConsesLow.list(format.$sym7$SETHASH, Characters.char_upcase(character), format.$sym8$_FORMAT_DIRECTIVES_, ConsesLow.list(format.$sym9$FUNCTION, name)));
    }
	...
	current = body = current.rest();
	return ConsesLow.list(format.$sym2$PROGN, ConsesLow.list(format.$sym3$DECLAIM, ConsesLow.list(format.$sym4$FACCESS, format.$sym5$PRIVATE, name)), ConsesLow.listS(format.$sym6$DEFINE, name, lambda_list, ConsesLow.append(body, SubLNil.NIL)),
		ConsesLow.list(format.$sym7$SETHASH, left, format.$sym8$_FORMAT_DIRECTIVES_, ConsesLow.list(format.$sym9$FUNCTION, name)), ConsesLow.list(format.$sym7$SETHASH, left, format.$sym11$_MATCHING_BRACKETS_, right));
    }
	...
	if (SubLNil.NIL == digits.rest()) {
	    ...
	    return Values.values(ConsesLow.cons(Numbers.add(CommonSymbols.ONE_INTEGER, digit), new_rest_digits), SubLNil.NIL);
	}
    }
	...
	while (true) {
	    thread.resetMultipleValues();
	    SubLObject ch = parse_format_command(string, start, end, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
	...
	try {
		...
		if (SubLNil.NIL == format_typep(mincol, format.$list54))
		    Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, mincol, format.$list54);
		colinc = tail.first();
		tail = tail.rest();
		...
		if (SubLNil.NIL == format_typep(minpad, format.$list54))
		    Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, minpad, format.$list54);
		padchar = tail.first();
		tail = tail.rest();
		if (SubLNil.NIL == padchar)
		    padchar = Characters.CHAR_space;
		if (SubLNil.NIL == format_typep(padchar, format.$sym20$CHARACTER))
		    Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, padchar, format.$sym20$CHARACTER);
		if (SubLNil.NIL != tail)
		    Errors.error(format.$str45$Too_many__S_parameters_, format.$sym38$FORMAT);
		Functions.funcall(Symbols.symbol_function(format.$sym94$FORMAT_PADDED), new SubLObject[] { stream, PrintLow.write_to_string(arg, SubLTranslatedFile.EMPTY_SUBL_OBJECT_ARRAY), at_sign_p, mincol, colinc, minpad, padchar });
	    } else
	...
	if (repeat.isPositive()) {
	    ...
	    SubLObject i;
	    for (cdotimes_end_var = Numbers.subtract(repeat, CommonSymbols.ONE_INTEGER), i = SubLNil.NIL, i = CommonSymbols.ZERO_INTEGER; i.numL(cdotimes_end_var); i = Numbers.add(i, CommonSymbols.ONE_INTEGER))
	...
	if (SubLNil.NIL != colonp)
	    return Values.values(backup_args(args, all_args, SubLNil.NIL != count ? count : CommonSymbols.ONE_INTEGER), start);
	if (SubLNil.NIL == count)
	...
	if (SubLNil.NIL != colonp)
	    streams_high.write_string(character_names.character_names(arg).first(), stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
	...
	if (group.numGE(length)) {
	    thread.resetMultipleValues();
	    SubLObject zillions = integer_truncate(integer, Numbers.expt(CommonSymbols.TEN_INTEGER, Numbers.multiply(length, CommonSymbols.THREE_INTEGER)));
	    SubLObject remainder = thread.secondMultipleValue();
	    thread.resetMultipleValues();
	    if (zillions.isPositive()) {
		format_cardinal_internal(stream, zillions, Numbers.add(group, length), SubLObjectFactory.makeBoolean(SubLNil.NIL != more || remainder.isPositive()));
		if (remainder.isPositive())
		    streams_high.write_char(Characters.CHAR_space, stream);
	    }
	    if (remainder.isPositive()) {
		format_cardinal(stream, remainder);
		streams_high.write_string(format.$str60$_times_ten_to_the_, stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
		format_ordinal(stream, Numbers.multiply(group, CommonSymbols.THREE_INTEGER));
		streams_high.write_string(format.$str61$_power, stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
		if (SubLNil.NIL != more)
		    streams_high.write_string(format.$str62$_plus, stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
	    }
	} else {
	    thread.resetMultipleValues();
	    SubLObject thousands = Numbers.truncate(integer, format.$int$1000);
	    SubLObject L1000 = thread.secondMultipleValue();
	    thread.resetMultipleValues();
	    if (thousands.isPositive()) {
		format_cardinal_internal(stream, thousands, Numbers.add(group, CommonSymbols.ONE_INTEGER), SubLObjectFactory.makeBoolean(SubLNil.NIL != more || L1000.isPositive()));
		if (L1000.isPositive())
		    streams_high.write_char(Characters.CHAR_space, stream);
	    }
	    if (L1000.isPositive()) {
		thread.resetMultipleValues();
		SubLObject hundreds = Numbers.truncate(L1000, format.$int$100);
		...
		if (hundreds.isPositive()) {
		    streams_high.write_string(Vectors.aref(format.$ic65, hundreds), stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
		    streams_high.write_string(format.$str66$_hundred, stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
		}
		if (tens.numE(CommonSymbols.ONE_INTEGER)) {
		    if (hundreds.isPositive())
			streams_high.write_char(Characters.CHAR_space, stream);
		    streams_high.write_string(Vectors.aref(format.$ic67, L1002), stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
		} else {
		    if (tens.isPositive()) {
			if (hundreds.isPositive())
			    streams_high.write_char(Characters.CHAR_space, stream);
			streams_high.write_string(Vectors.aref(format.$ic68, tens), stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
		    }
		    if (L1002.isPositive()) {
			if (tens.isPositive())
			    ...
			    streams_high.write_char(Characters.CHAR_space, stream);
			streams_high.write_string(Vectors.aref(format.$ic69, L1002), stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
		    }
		}
		streams_high.write_string(Vectors.aref(groups, group), stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
	    }
	}
	return SubLNil.NIL;
    }
	...
	if (pcase_var.eql(CommonSymbols.ZERO_INTEGER)) {
		...
		Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, x, format.$sym17$INTEGER);
	    if (SubLNil.NIL != tail)
		Errors.error(format.$str45$Too_many__S_parameters_, format.$sym38$FORMAT);
	    if (!x.isZero())
		return Values.values(args, start);
		...
		Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, x2, format.$sym17$INTEGER);
	    y = tail.first();
	    tail = tail.rest();
	    if (SubLNil.NIL == y)
		y = SubLNil.NIL;
	    if (SubLNil.NIL == format_typep(y, format.$sym17$INTEGER))
		Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, y, format.$sym17$INTEGER);
	    if (SubLNil.NIL != tail)
		Errors.error(format.$str45$Too_many__S_parameters_, format.$sym38$FORMAT);
	    if (!x2.numE(y))
		return Values.values(args, start);
		...
		Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, x3, format.$sym17$INTEGER);
	    y2 = tail.first();
	    tail = tail.rest();
	    if (SubLNil.NIL == y2)
		y2 = SubLNil.NIL;
	    if (SubLNil.NIL == format_typep(y2, format.$sym17$INTEGER))
		Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, y2, format.$sym17$INTEGER);
	    z = tail.first();
	    tail = tail.rest();
	    if (SubLNil.NIL == z)
		z = SubLNil.NIL;
	    if (SubLNil.NIL == format_typep(z, format.$sym17$INTEGER))
		Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, z, format.$sym17$INTEGER);
	    if (SubLNil.NIL != tail)
		Errors.error(format.$str45$Too_many__S_parameters_, format.$sym38$FORMAT);
	...
	try {
		...
		Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, k, format.$sym17$INTEGER);
		...
		Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, overflowchar, format.$list88);
	    padchar = tail.first();
	    tail = tail.rest();
	    if (SubLNil.NIL == padchar)
		padchar = Characters.CHAR_space;
		...
		else if (SubLNil.NIL == left && SubLNil.NIL != w && SubLNil.NIL != d && w.numE(Numbers.add(d, CommonSymbols.ONE_INTEGER)))
		    left_size = CommonSymbols.ZERO_INTEGER;
		else if (SubLNil.NIL == left && SubLNil.NIL == d)
		    left_size = CommonSymbols.ZERO_INTEGER;
		else
		    left_size = CommonSymbols.ONE_INTEGER;
		SubLObject except_for_right_size = Numbers.add(arg.isNegative() || SubLNil.NIL != at_sign_p ? CommonSymbols.ONE_INTEGER : CommonSymbols.ZERO_INTEGER, left_size, CommonSymbols.ONE_INTEGER);
		if (SubLNil.NIL != d)
		    right_size = d;
		else if (SubLNil.NIL != w) {
		    SubLObject remaining = Numbers.subtract(w, except_for_right_size);
		    if (remaining.isPositive())
			right_size = Numbers.max(Numbers.min(remaining, Sequences.length(right)), CommonSymbols.ONE_INTEGER);
		    else
			right_size = CommonSymbols.ZERO_INTEGER;
		} else
		    right_size = Numbers.max(Sequences.length(right), CommonSymbols.ONE_INTEGER);
		padding = SubLNil.NIL != w ? Numbers.subtract(w, Numbers.add(except_for_right_size, right_size)) : CommonSymbols.ZERO_INTEGER;
	...
	try {
		...
		if (SubLNil.NIL == format_typep(commachar, format.$sym20$CHARACTER))
		    Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, commachar, format.$sym20$CHARACTER);
		...
		if (SubLNil.NIL == format_typep(comma_interval, format.$list55))
		    Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, comma_interval, format.$list55);
		if (SubLNil.NIL != tail)
		    Errors.error(format.$str45$Too_many__S_parameters_, format.$sym38$FORMAT);
		if (integer.isInteger()) {
			...
			thread.resetMultipleValues();
			SubLObject new_output = Strings.make_string(Numbers.add(length, extras.isZero() ? Numbers.subtract(segments, CommonSymbols.ONE_INTEGER) : segments), CommonSymbols.UNPROVIDED);
			Sequences.replace(new_output, output, CommonSymbols.ZERO_INTEGER, extras, CommonSymbols.ZERO_INTEGER, CommonSymbols.UNPROVIDED);
			SubLObject idx = extras;
			SubLObject new_idx = extras;
			SubLObject i;
			for (i = SubLNil.NIL, i = CommonSymbols.ZERO_INTEGER; i.numL(segments); i = Numbers.add(i, CommonSymbols.ONE_INTEGER)) {
			    if (!new_idx.isZero()) {
				Strings.set_char(new_output, new_idx, commachar);
				new_idx = Numbers.add(new_idx, CommonSymbols.ONE_INTEGER);
			    }
			    Sequences.replace(new_output, output, new_idx, Numbers.add(new_idx, comma_interval), idx, CommonSymbols.UNPROVIDED);
		    ...
		    format_padded(stream, output, CommonSymbols.T, mincol, CommonSymbols.ONE_INTEGER, CommonSymbols.ZERO_INTEGER, padchar);
		} else
		    format_padded(stream, PrintLow.write_to_string(integer, SubLTranslatedFile.EMPTY_SUBL_OBJECT_ARRAY), CommonSymbols.T, mincol, CommonSymbols.ONE_INTEGER, CommonSymbols.ZERO_INTEGER, padchar);
	    } else {
		if (integer.isNegative())
		    streams_high.write_char(Characters.CHAR_hyphen, stream);
		else if (SubLNil.NIL != at_sign_p)
	...
	try {
	    ...
	    SubLObject count;
	    for (count = SubLNil.NIL, count = CommonSymbols.ZERO_INTEGER; (SubLNil.NIL == max || !count.numGE(max))
		    && (SubLNil.NIL != args || !count.numGE(min)); args = format_control.isFunction() ? Functions.apply(format_control, stream, args) : format_internal(stream, format_control, start, end, args, args), count = Numbers.add(count, CommonSymbols.ONE_INTEGER)) {
	    }
	...
	check_flags(Characters.CHAR_rbracket, expr_end_at_sign_p, SubLNil.NIL, expr_end_colonp, SubLNil.NIL);
	if (SubLNil.NIL != at_sign_p) {
	    if (SubLNil.NIL != parameters)
		Errors.error(format.$str45$Too_many__S_parameters_, format.$sym38$FORMAT);
		...
		Errors.error(format.$str107$No_clause_marker_found_for__S__S_, Characters.CHAR_lbracket, format.$sym38$FORMAT);
	    check_flags(Characters.CHAR_semicolon, separator_at_sign_p, SubLNil.NIL, separator_colonp, SubLNil.NIL);
	    if (SubLNil.NIL != args.first())
		...
		Errors.error(format.$str32$The__S_parameter__S_is_not_of_typ, format.$sym38$FORMAT, index, format.$list108);
	    if (SubLNil.NIL != tail)
		Errors.error(format.$str45$Too_many__S_parameters_, format.$sym38$FORMAT);
	    if (SubLNil.NIL == index) {
		index = args.first();
		...
		thread.resetMultipleValues();
		check_flags(Characters.CHAR_semicolon, separator_at_sign_p2, SubLNil.NIL, separator_colonp2, CommonSymbols.T);
		if (count.numE(index))
		    return Values.values(format_internal(stream, string, clause_start, SubLNil.NIL != separator_start2 ? separator_start2 : expr_end, args, all_args), new_start);
		count = Numbers.add(count, CommonSymbols.ONE_INTEGER);
	...
	if (SubLNil.NIL != at_sign_p && SubLNil.NIL != colonp)
	    ...
	    SubLObject done;
	    SubLObject i;
	    for (length = Sequences.length(output), done = SubLNil.NIL, i = SubLNil.NIL, i = CommonSymbols.ZERO_INTEGER; SubLNil.NIL == done && !i.numE(length); i = Numbers.add(i, CommonSymbols.ONE_INTEGER))
	...
	if (integer.isZero())
	    ...
	    thread.resetMultipleValues();
	    SubLObject hundreds = Numbers.truncate(integer, format.$int$100);
	    SubLObject remainder = thread.secondMultipleValue();
	    thread.resetMultipleValues();
	    if (!hundreds.isZero())
		...
		if (hundreds.isPositive())
		    streams_high.write_char(Characters.CHAR_space, stream);
		if (zeros.isZero())
		    streams_high.write_string(Vectors.aref(format.$ic73, tens), stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
		else if (tens.numE(CommonSymbols.ONE_INTEGER))
		    streams_high.write_string(Vectors.aref(format.$ic74, zeros), stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
		else {
		    if (tens.isPositive()) {
			format_cardinal(stream, Numbers.subtract(remainder, zeros));
			streams_high.write_char(Characters.CHAR_hyphen, stream);
		    }
		    streams_high.write_string(Vectors.aref(format.$ic75, zeros), stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
		}
	    } else
	...
	if (SubLNil.NIL != at_sign_p) {
		...
		streams_high.write_string(format.$str120$ies, stream, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED);
	...
	SubLObject padding = Numbers.add(minpad, length.numL(mincol) ? Numbers.multiply(Numbers.ceiling(Numbers.subtract(mincol, length), colinc), colinc) : CommonSymbols.ZERO_INTEGER);
	...
	SubLObject cdotimes_end_var;
	SubLObject i;
	for (cdotimes_end_var = repitition_designator_value(n), i = SubLNil.NIL, i = CommonSymbols.ZERO_INTEGER; i.numL(cdotimes_end_var); i = Numbers.add(i, CommonSymbols.ONE_INTEGER))
	    streams_high.terpri(stream);
	return Values.values(args, start);
    }
	...
	if (SubLNil.NIL != at_sign_p) {
	    ...
	    try {
		thread.throwStack.push(format.$sym112$UP_AND_OUT);
		new_args = format_internal(stream, string_$4, CommonSymbols.ZERO_INTEGER, Sequences.length(string_$4), args.rest(), all_args);
	    } catch (Throwable ccatch_env_var) {
		new_args = Errors.handleThrowable(ccatch_env_var, format.$sym112$UP_AND_OUT);
	    } finally {
		thread.throwStack.pop();
		...
		thread.throwStack.push(format.$sym112$UP_AND_OUT);
		if (format_control.isString())
		    format_internal(stream, format_control, CommonSymbols.ZERO_INTEGER, Sequences.length(format_control), sub_args, sub_args);
		else if (format_control.isFunction())
	...
	if (SubLNil.NIL != parameters) {
	    ...
	    if (!radix.isInteger() || !radix.numGE(CommonSymbols.TWO_INTEGER) || !radix.numLE(format.$int$36))
		...
		if (SubLNil.NIL != at_sign_p && SubLNil.NIL != colonp) {
			...
			SubLObject chars;
			SubLObject vals;
			for (chars = SubLNil.NIL, vals = SubLNil.NIL, chars = format.$list79, vals = format.$list80; !arg.isZero(); arg = Numbers.rem(arg, vals.first()), chars = chars.rest(), vals = vals.rest())
			    format_repeat(stream, chars.first(), Numbers.truncate(arg, vals.first()));
		    } else
			format_integer(stream, arg, CommonSymbols.TEN_INTEGER, SubLNil.NIL, SubLNil.NIL, SubLNil.NIL);
		} else if (SubLNil.NIL != at_sign_p) {
		    if (arg.isPositive()) {
	...
	SubLObject cdotimes_end_var;
	SubLObject i;
	for (cdotimes_end_var = repitition_designator_value(count), i = SubLNil.NIL, i = CommonSymbols.ZERO_INTEGER; i.numL(cdotimes_end_var); i = Numbers.add(i, CommonSymbols.ONE_INTEGER))
	...
	SubLObject slash_idx = Sequences.position(Characters.CHAR_slash, string, Symbols.symbol_function(format.$sym101$CHAR_), Symbols.symbol_function(CommonSymbols.IDENTITY), start, end);
	...
	try {
	    print_high.$print_pretty$.bind(SubLNil.NIL != colonp ? CommonSymbols.T : print_high.$print_pretty$.getDynamicValue(thread), thread);
	    print_high.$print_level$.bind(SubLNil.NIL != at_sign_p ? SubLNil.NIL : print_high.$print_level$.getDynamicValue(thread), thread);
	    print_high.$print_length$.bind(SubLNil.NIL != at_sign_p ? SubLNil.NIL : print_high.$print_length$.getDynamicValue(thread), thread);
	...
	Errors.error(format.$str37$Stray____C_directive_in__S_string, Strings.sublisp_char(string, Numbers.subtract(index, CommonSymbols.ONE_INTEGER)), format.$sym38$FORMAT, string);
	return SubLNil.NIL;
    }

    public static SubLObject init_format_file() {
	format.$format_directives$ = SubLFiles.defvar("*FORMAT-DIRECTIVES*", Hashtables.make_hash_table(format.$int$50, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED));
	format.$matching_brackets$ = SubLFiles.defvar("*MATCHING-BRACKETS*", Hashtables.make_hash_table(CommonSymbols.TEN_INTEGER, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED));
	...
	for (i = start; !i.numGE(end); i = Numbers.add(i, CommonSymbols.ONE_INTEGER)) {
		...
		if (SubLNil.NIL != Characters.charE(ch, Characters.CHAR_hash)) {
			...
			if (!parameter.isChar() && !parameter.isInteger() && SubLNil.NIL != parameter)
			    Errors.error(format.$str131$_S_parameter__S_is_not_a_characte, format.$sym38$FORMAT, parameter);
			...
			return Values.values(ch, tilde_idx, Numbers.add(i, CommonSymbols.ONE_INTEGER), at_sign_p, colonp, Sequences.nreverse(parameters), args);
		...
		if (SubLNil.NIL != Characters.digit_char_p(ch, CommonSymbols.TEN_INTEGER)) {
		    if (SubLNil.NIL != for_effect_p)
			number = Numbers.add(Numbers.multiply(number, CommonSymbols.TEN_INTEGER), Characters.digit_char_p(ch, CommonSymbols.TEN_INTEGER));
		    state = format.$kw136$NUMBER;
		} else
		    Errors.error(format.$str137$Bad__S_parameter_, format.$sym38$FORMAT);
	...
	return Values.values(SubLNil.NIL, SubLNil.NIL, i, SubLNil.NIL, SubLNil.NIL, SubLNil.NIL, args);
    }
	...
	try {
		...
		thread.throwStack.push(format.$sym111$UP_AND_ALL_THE_WAY_OUT);
		if (format_control.isString())
		    format_internal(stream, format_control, CommonSymbols.ZERO_INTEGER, Sequences.length(format_control), args, args);
		else if (format_control.isFunction())
	...
	SubLThread thread = SubLProcess.currentSubLThread();
	if (places.isZero())
	    return Values.values(SubLNil.NIL, SubLObjectFactory.makeBoolean(SubLNil.NIL != digits && digits.first().numGE(CommonSymbols.FIVE_INTEGER)));
	thread.resetMultipleValues();
	...
	return Values.values(ConsesLow.cons(Numbers.add(digit, CommonSymbols.ONE_INTEGER), new_digits), SubLNil.NIL);
    }

    public static SubLObject setup_format_file() {
	Hashtables.sethash(Characters.CHAR_c, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym48$FORMAT_C_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_C, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym48$FORMAT_C_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_percent, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym50$FORMAT_PERCENT_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_percent, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym50$FORMAT_PERCENT_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_ampersand, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym51$FORMAT_AMPERSAND_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_ampersand, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym51$FORMAT_AMPERSAND_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_vertical, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym52$FORMAT_VERTICAL_BAR_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_vertical, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym52$FORMAT_VERTICAL_BAR_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_tilde, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym53$FORMAT_TILDE_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_tilde, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym53$FORMAT_TILDE_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_r, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym83$FORMAT_R_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_R, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym83$FORMAT_R_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_d, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym84$FORMAT_D_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_D, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym84$FORMAT_D_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_b, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym85$FORMAT_B_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_B, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym85$FORMAT_B_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_o, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym86$FORMAT_O_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_O, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym86$FORMAT_O_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_x, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym87$FORMAT_X_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_X, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym87$FORMAT_X_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_f, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym89$FORMAT_F_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_F, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym89$FORMAT_F_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_e, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym90$FORMAT_E_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_E, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym90$FORMAT_E_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_g, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym91$FORMAT_G_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_G, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym91$FORMAT_G_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_dollar, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym92$FORMAT_DOLLARSIGN_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_dollar, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym92$FORMAT_DOLLARSIGN_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_a, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym95$FORMAT_A_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_A, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym95$FORMAT_A_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_s, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym96$FORMAT_S_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_S, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym96$FORMAT_S_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_w, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym98$FORMAT_W_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_W, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym98$FORMAT_W_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_underbar, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym99$FORMAT_UNDERSCORE_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_underbar, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym99$FORMAT_UNDERSCORE_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_i, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym100$FORMAT_I_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_I, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym100$FORMAT_I_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_slash, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym102$FORMAT_SLASH_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_slash, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym102$FORMAT_SLASH_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_t, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym103$FORMAT_T_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_T, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym103$FORMAT_T_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_less, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym104$FORMAT_LESS_THAN_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_less, format.$matching_brackets$.getDynamicValue(), Characters.CHAR_greater);
	Hashtables.sethash(Characters.CHAR_greater, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym105$FORMAT_GREATER_THAN_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_greater, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym105$FORMAT_GREATER_THAN_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_asterisk, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym106$FORMAT_ASTERISK_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_asterisk, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym106$FORMAT_ASTERISK_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_lbracket, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym109$FORMAT_LEFT_BRACKET_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_lbracket, format.$matching_brackets$.getDynamicValue(), Characters.CHAR_rbracket);
	Hashtables.sethash(Characters.CHAR_rbracket, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym110$FORMAT_RIGHT_BRACKET_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_rbracket, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym110$FORMAT_RIGHT_BRACKET_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_lbrace, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym113$FORMAT_LEFT_BRACE_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_lbrace, format.$matching_brackets$.getDynamicValue(), Characters.CHAR_rbrace);
	Hashtables.sethash(Characters.CHAR_rbrace, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym114$FORMAT_RIGHT_BRACE_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_rbrace, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym114$FORMAT_RIGHT_BRACE_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_question, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym117$FORMAT_QUESTION_MARK_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_question, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym117$FORMAT_QUESTION_MARK_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_lparen, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym118$FORMAT_LEFT_PAREN_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_lparen, format.$matching_brackets$.getDynamicValue(), Characters.CHAR_rparen);
	Hashtables.sethash(Characters.CHAR_rparen, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym119$FORMAT_RIGHT_PAREN_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_rparen, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym119$FORMAT_RIGHT_PAREN_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_p, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym121$FORMAT_P_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_P, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym121$FORMAT_P_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_semicolon, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym122$FORMAT_SEMICOLON_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_semicolon, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym122$FORMAT_SEMICOLON_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_caret, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym123$FORMAT_CIRCUMFLEX_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_caret, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym123$FORMAT_CIRCUMFLEX_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_newline, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym124$FORMAT_NEWLINE_DIRECTIVE));
	Hashtables.sethash(Characters.CHAR_newline, format.$format_directives$.getDynamicValue(), Symbols.symbol_function(format.$sym124$FORMAT_NEWLINE_DIRECTIVE));
	return SubLNil.NIL;
    }
	...
	if (scale.isPositive()) {
	    SubLObject i;
	    SubLObject digit;
	    for (i = SubLNil.NIL, i = CommonSymbols.ZERO_INTEGER; i.numL(scale); i = Numbers.add(i, CommonSymbols.ONE_INTEGER)) {
		digit = digits.first();
	    ...
	    SubLObject cdotimes_end_var;
	    SubLObject j;
	    for (cdotimes_end_var = Numbers.minus(scale), j = SubLNil.NIL, j = CommonSymbols.ZERO_INTEGER; j.numL(cdotimes_end_var); j = Numbers.add(j, CommonSymbols.ONE_INTEGER))
	...
	while (SubLNil.NIL != cdolist_list_var) {
		...
		code = ConsesLow.cons(
			ConsesLow.list(format.$sym2$PROGN, ConsesLow.list(format.$sym25$CSETF, var, ConsesLow.list(format.$sym26$CAR, tail)), ConsesLow.list(format.$sym27$CPOP, tail), ConsesLow.list(format.$sym28$PUNLESS, var, ConsesLow.list(format.$sym25$CSETF, var, init)), ConsesLow.list(
				format.$sym28$PUNLESS, ConsesLow.list(format.$sym29$FORMAT_TYPEP, var, ConsesLow.list(format.$sym30$QUOTE, type)), ConsesLow.list(format.$sym31$ERROR, format.$str32$The__S_parameter__S_is_not_of_typ, format.$list33, var, ConsesLow.list(format.$sym30$QUOTE, type)))),
			code);
	    } else
	...
	return ConsesLow.listS(format.$sym34$CLET, reader.bq_cons(ConsesLow.list(tail, parameters), ConsesLow.append(vars, SubLNil.NIL)), ConsesLow.append(Sequences.nreverse(code), reader.bq_cons(ConsesLow.listS(format.$sym35$PWHEN, tail, format.$list36), ConsesLow.append(body, SubLNil.NIL))));
    }
	...
	$list1 = ConsesLow.list(SubLObjectFactory.makeSymbol("NAME"), SubLObjectFactory.makeSymbol("CHARACTER"), SubLObjectFactory.makeSymbol("LAMBDA-LIST"), SubLObjectFactory.makeSymbol("&BODY"), SubLObjectFactory.makeSymbol("BODY"));
	...
	$list10 = ConsesLow.list(SubLObjectFactory.makeSymbol("NAME"), SubLObjectFactory.makeSymbol("LEFT"), SubLObjectFactory.makeSymbol("RIGHT"), SubLObjectFactory.makeSymbol("LAMBDA-LIST"), SubLObjectFactory.makeSymbol("&BODY"), SubLObjectFactory.makeSymbol("BODY"));
	$sym11$_MATCHING_BRACKETS_ = SubLObjectFactory.makeSymbol("*MATCHING-BRACKETS*");
	$str12$The__A_format_directive_is_not_ye = SubLObjectFactory.makeString("The ~A format directive is not yet ~@[fully ~]implemented.");
	$str13$The____C_format_directive_does_no = SubLObjectFactory.makeString("The ~~~C format directive does not take an at-sign modifier.");
	$str14$The____C_format_directive_does_no = SubLObjectFactory.makeString("The ~~~C format directive does not take an colon modifier.");
	$str15$The____C_format_directive_does_no = SubLObjectFactory.makeString("The ~~~C format directive does not take both an at-sign and colon modifier.");
	$sym16$OR = SubLObjectFactory.makeSymbol("OR");
	$sym17$INTEGER = SubLObjectFactory.makeSymbol("INTEGER");
	$list18 = ConsesLow.list(SubLObjectFactory.makeSymbol("&OPTIONAL"), SubLObjectFactory.makeSymbol("START"), SubLObjectFactory.makeSymbol("END"));
	...
	$list22 = ConsesLow.list(SubLObjectFactory.makeSymbol("PATTERN"), SubLObjectFactory.makeSymbol("PARAMETERS"), SubLObjectFactory.makeSymbol("&BODY"), SubLObjectFactory.makeSymbol("BODY"));
	$str23$TAIL = SubLObjectFactory.makeString("TAIL");
	$list24 = ConsesLow.list(SubLObjectFactory.makeSymbol("VAR"), SubLObjectFactory.makeSymbol("INIT"), SubLObjectFactory.makeSymbol("TYPE"));
	...
	$str32$The__S_parameter__S_is_not_of_typ = SubLObjectFactory.makeString("The ~S parameter ~S is not of type ~S.");
	...
	$list36 = ConsesLow.list(ConsesLow.list(SubLObjectFactory.makeSymbol("ERROR"), SubLObjectFactory.makeString("Too many ~S parameters."), ConsesLow.list(SubLObjectFactory.makeSymbol("QUOTE"), SubLObjectFactory.makeSymbol("FORMAT"))));
	$str37$Stray____C_directive_in__S_string = SubLObjectFactory.makeString("Stray ~~~C directive in ~S string ~S.");
	...
	$str40$_S_directive__S_ran_out_of_argume = SubLObjectFactory.makeString("~S directive ~S ran out of arguments.");
	$str41$No_matching__S_found_for__S_in__S = SubLObjectFactory.makeString("No matching ~S found for ~S in ~S.");
	$str42$The__S__S_directive_takes_a_list_ = SubLObjectFactory.makeString("The ~S ~S directive takes a list as an argument.");
	$str43$_S_is_not_a_valid__S_control_ = SubLObjectFactory.makeString("~S is not a valid ~S control.");
	$str44$_S_is_not_a_valid__S_repitition_s = SubLObjectFactory.makeString("~S is not a valid ~S repitition specifier.");
	...
	$list49 = ConsesLow.list(SubLObjectFactory.makeSymbol("OR"), SubLObjectFactory.makeSymbol("NULL"), ConsesLow.list(SubLObjectFactory.makeSymbol("INTEGER"), CommonSymbols.ZERO_INTEGER));
	...
	$ic59 = Vectors.vector(new SubLObject[] { SubLObjectFactory.makeString(""), SubLObjectFactory.makeString(" thousand"), SubLObjectFactory.makeString(" million"), SubLObjectFactory.makeString(" billion"), SubLObjectFactory.makeString(" trillion"), SubLObjectFactory.makeString(" quadrillion"),
		SubLObjectFactory.makeString(" quintillion"), SubLObjectFactory.makeString(" sextillion"), SubLObjectFactory.makeString(" septillion"), SubLObjectFactory.makeString(" octillion"), SubLObjectFactory.makeString(" nonillion"), SubLObjectFactory.makeString(" decillion"),
		SubLObjectFactory.makeString(" undecillion"), SubLObjectFactory.makeString(" duodecillion"), SubLObjectFactory.makeString(" tredecillion"), SubLObjectFactory.makeString(" quattuordecillion"), SubLObjectFactory.makeString(" quindecillion"),
		SubLObjectFactory.makeString(" sexdecillion"), SubLObjectFactory.makeString(" septendecillion"), SubLObjectFactory.makeString(" octodecillion"), SubLObjectFactory.makeString(" novemdecillion"), SubLObjectFactory.makeString(" vigintillion") });
	...
	$ic65 = Vectors.vector(new SubLObject[] { SubLNil.NIL, SubLObjectFactory.makeString("one"), SubLObjectFactory.makeString("two"), SubLObjectFactory.makeString("three"), SubLObjectFactory.makeString("four"), SubLObjectFactory.makeString("five"), SubLObjectFactory.makeString("six"),
		SubLObjectFactory.makeString("seven"), SubLObjectFactory.makeString("eight"), SubLObjectFactory.makeString("nine") });
	$str66$_hundred = SubLObjectFactory.makeString(" hundred");
	$ic67 = Vectors.vector(new SubLObject[] { SubLObjectFactory.makeString("ten"), SubLObjectFactory.makeString("eleven"), SubLObjectFactory.makeString("twelve"), SubLObjectFactory.makeString("thirteen"), SubLObjectFactory.makeString("fourteen"), SubLObjectFactory.makeString("fifteen"),
		SubLObjectFactory.makeString("sixteen"), SubLObjectFactory.makeString("seventeen"), SubLObjectFactory.makeString("eighteen"), SubLObjectFactory.makeString("nineteen") });
	$ic68 = Vectors.vector(new SubLObject[] { SubLNil.NIL, SubLNil.NIL, SubLObjectFactory.makeString("twenty"), SubLObjectFactory.makeString("thirty"), SubLObjectFactory.makeString("forty"), SubLObjectFactory.makeString("fifty"), SubLObjectFactory.makeString("sixty"),
		SubLObjectFactory.makeString("seventy"), SubLObjectFactory.makeString("eighty"), SubLObjectFactory.makeString("ninety") });
	$ic69 = Vectors.vector(new SubLObject[] { SubLNil.NIL, SubLObjectFactory.makeString("one"), SubLObjectFactory.makeString("two"), SubLObjectFactory.makeString("three"), SubLObjectFactory.makeString("four"), SubLObjectFactory.makeString("five"), SubLObjectFactory.makeString("six"),
		SubLObjectFactory.makeString("seven"), SubLObjectFactory.makeString("eight"), SubLObjectFactory.makeString("nine") });
	...
	$ic73 = Vectors.vector(new SubLObject[] { SubLNil.NIL, SubLObjectFactory.makeString("tenth"), SubLObjectFactory.makeString("twentieth"), SubLObjectFactory.makeString("thirtieth"), SubLObjectFactory.makeString("fortieth"), SubLObjectFactory.makeString("fiftieth"),
		SubLObjectFactory.makeString("sixtieth"), SubLObjectFactory.makeString("seventieth"), SubLObjectFactory.makeString("eightieth"), SubLObjectFactory.makeString("ninetieth") });
	$ic74 = Vectors.vector(new SubLObject[] { SubLNil.NIL, SubLObjectFactory.makeString("eleventh"), SubLObjectFactory.makeString("twelfth"), SubLObjectFactory.makeString("thirteenth"), SubLObjectFactory.makeString("fourteenth"), SubLObjectFactory.makeString("fifteenth"),
		SubLObjectFactory.makeString("sixteenth"), SubLObjectFactory.makeString("seventeenth"), SubLObjectFactory.makeString("eighteenth"), SubLObjectFactory.makeString("nineteenth") });
	$ic75 = Vectors.vector(new SubLObject[] { SubLNil.NIL, SubLObjectFactory.makeString("first"), SubLObjectFactory.makeString("second"), SubLObjectFactory.makeString("third"), SubLObjectFactory.makeString("fourth"), SubLObjectFactory.makeString("fifth"), SubLObjectFactory.makeString("sixth"),
		SubLObjectFactory.makeString("seventh"), SubLObjectFactory.makeString("eighth"), SubLObjectFactory.makeString("ninth") });
	...
	$list79 = ConsesLow.list(Characters.CHAR_M, Characters.CHAR_D, Characters.CHAR_C, Characters.CHAR_L, Characters.CHAR_X, Characters.CHAR_V, Characters.CHAR_I);
	$list80 = ConsesLow.list(SubLObjectFactory.makeInteger(1000), SubLObjectFactory.makeInteger(500), SubLObjectFactory.makeInteger(100), SubLObjectFactory.makeInteger(50), CommonSymbols.TEN_INTEGER, CommonSymbols.FIVE_INTEGER, CommonSymbols.ONE_INTEGER);
	$list81 = ConsesLow.list(SubLObjectFactory.makeInteger(900), SubLObjectFactory.makeInteger(400), SubLObjectFactory.makeInteger(90), SubLObjectFactory.makeInteger(40), CommonSymbols.NINE_INTEGER, CommonSymbols.FOUR_INTEGER);
	$list82 = ConsesLow.list(Characters.CHAR_C, Characters.CHAR_C, Characters.CHAR_X, Characters.CHAR_X, Characters.CHAR_I, Characters.CHAR_I);
	...
	$list88 = ConsesLow.list(SubLObjectFactory.makeSymbol("OR"), SubLObjectFactory.makeSymbol("NULL"), SubLObjectFactory.makeSymbol("CHARACTER"));
	...
	$str107$No_clause_marker_found_for__S__S_ = SubLObjectFactory.makeString("No clause marker found for ~S ~S directive.");
	$list108 = ConsesLow.list(SubLObjectFactory.makeSymbol("OR"), SubLObjectFactory.makeSymbol("NULL"), SubLObjectFactory.makeSymbol("INTEGER"));
	...
	$str125$_S_does_not_support_string_destin = SubLObjectFactory.makeString("~S does not support string destinations.");
	...
	$str131$_S_parameter__S_is_not_a_characte = SubLObjectFactory.makeString("~S parameter ~S is not a character, integer, or NIL.");
