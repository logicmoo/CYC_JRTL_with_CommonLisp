...
structure as in the DEFPOLYMORPHIC call. */
 ...
 (5) Reading of structures is not supported by the reader. */
  ...
  public static final SubLObject declare_complex_special_forms_file() {
    declareFunction("intern_accessor", "INTERN-ACCESSOR", 1, 0, false);
    declareMacro("defpolymorphic", "DEFPOLYMORPHIC");
    declareMacro("define_method", "DEFINE-METHOD");
    declareFunction("defpolymorphic_internal", "DEFPOLYMORPHIC-INTERNAL", 3, 0, false);
    declareFunction("define_method_internal", "DEFINE-METHOD-INTERNAL", 3, 0, false);
    declareFunction("build_regmethod_call", "BUILD-REGMETHOD-CALL", 3, 0, false);
    declareFunction("build_regmethod_list", "BUILD-REGMETHOD-LIST", 3, 0, false);
    declareFunction("method_table_var", "METHOD-TABLE-VAR", 1, 0, false);
    declareFunction("method_function_var", "METHOD-FUNCTION-VAR", 2, 0, false);
    declareFunction("dtp_var", "DTP-VAR", 1, 0, false);
    declareFunction("full_formal_parameter_list", "FULL-FORMAL-PARAMETER-LIST", 1, 0, false);
    declareMacro("defstruct", "DEFSTRUCT");
    declareFunction("defstruct_analyze", "DEFSTRUCT-ANALYZE", 3, 0, false);
    declareFunction("defstruct_conc_name", "DEFSTRUCT-CONC-NAME", 2, 0, false);
    declareFunction("defstruct_predicate", "DEFSTRUCT-PREDICATE", 1, 0, false);
    declareFunction("defstruct_constructor", "DEFSTRUCT-CONSTRUCTOR", 1, 0, false);
    declareFunction("defstruct_host_fn_name", "DEFSTRUCT-HOST-FN-NAME", 1, 0, false);
    declareFunction("defstruct_type_var", "DEFSTRUCT-TYPE-VAR", 1, 0, false);
    declareFunction("defstruct_slot_keywords", "DEFSTRUCT-SLOT-KEYWORDS", 1, 0, false);
    declareFunction("defstruct_getters", "DEFSTRUCT-GETTERS", 2, 0, false);
    declareFunction("defstruct_getter", "DEFSTRUCT-GETTER", 2, 0, false);
    declareFunction("defstruct_setters", "DEFSTRUCT-SETTERS", 1, 0, false);
    declareFunction("defstruct_setter", "DEFSTRUCT-SETTER", 1, 0, false);
    declareFunction("getter_package", "GETTER-PACKAGE", 1, 0, false);
    declareFunction("accessor_package", "ACCESSOR-PACKAGE", 1, 0, false);
    declareFunction("setter_from_accessor", "SETTER-FROM-ACCESSOR", 1, 0, false);
    declareFunction("defstruct_lisp_constructor", "DEFSTRUCT-LISP-CONSTRUCTOR", 1, 0, false);
    declareFunction("defstruct_expand", "DEFSTRUCT-EXPAND", 1, 0, false);
    declareMacro("_defstruct_object_p", "_DEFSTRUCT-OBJECT-P");
    declareMacro("_defstruct_get_slot", "_DEFSTRUCT-GET-SLOT");
    declareMacro("_defstruct_set_slot", "_DEFSTRUCT-SET-SLOT");
    declareMacro("_defstruct_construct", "_DEFSTRUCT-CONSTRUCT");
    declareFunction("defstruct_type_var_form", "DEFSTRUCT-TYPE-VAR-FORM", 3, 0, false);
    declareFunction("defstruct_print_method", "DEFSTRUCT-PRINT-METHOD", 2, 0, false);
    declareFunction("defstruct_print_forms", "DEFSTRUCT-PRINT-FORMS", 4, 0, false);
    declareFunction("defstruct_register_form", "DEFSTRUCT-REGISTER-FORM", 4, 0, false);
    declareFunction("defstruct_predicate_form", "DEFSTRUCT-PREDICATE-FORM", 4, 0, false);
    declareFunction("defstruct_predicate_arglist", "DEFSTRUCT-PREDICATE-ARGLIST", 1, 0, false);
    declareFunction("defstruct_predicate_variable", "DEFSTRUCT-PREDICATE-VARIABLE", 1, 0, false);
    declareFunction("defstruct_first_function_variable", "DEFSTRUCT-FIRST-FUNCTION-VARIABLE", 2, 0, false);
    declareFunction("defstruct_getter_forms", "DEFSTRUCT-GETTER-FORMS", 5, 0, false);
    declareFunction("defstruct_getter_form", "DEFSTRUCT-GETTER-FORM", 5, 0, false);
    declareFunction("defstruct_getter_arglist", "DEFSTRUCT-GETTER-ARGLIST", 1, 0, false);
    declareFunction("defstruct_getter_variable", "DEFSTRUCT-GETTER-VARIABLE", 1, 0, false);
    declareFunction("defstruct_setter_forms", "DEFSTRUCT-SETTER-FORMS", 5, 0, false);
    declareFunction("defstruct_setter_form", "DEFSTRUCT-SETTER-FORM", 5, 0, false);
    declareFunction("defstruct_setter_arglist", "DEFSTRUCT-SETTER-ARGLIST", 1, 0, false);
    declareFunction("defstruct_def_csetf_forms", "DEFSTRUCT-DEF-CSETF-FORMS", 2, 0, false);
    declareFunction("defstruct_constructor_form", "DEFSTRUCT-CONSTRUCTOR-FORM", 6, 0, false);
    declareFunction("defstruct_constructor_arglist", "DEFSTRUCT-CONSTRUCTOR-ARGLIST", 1, 0, false);
    declareFunction("defstruct_constructor_arglist_handler", "DEFSTRUCT-CONSTRUCTOR-ARGLIST-HANDLER", 4, 0, false);
    declareFunction("defstruct_host_function", "DEFSTRUCT-HOST-FUNCTION", 5, 0, false);
    declareFunction("defstruct_host_arglist", "DEFSTRUCT-HOST-ARGLIST", 0, 0, false);
    declareMacro("with_call_profiling", "WITH-CALL-PROFILING");
    declareFunction("possibly_note_function_entry", "POSSIBLY-NOTE-FUNCTION-ENTRY", 1, 0, false);
    declareFunction("initialize_call_profiling_table", "INITIALIZE-CALL-PROFILING-TABLE", 0, 0, false);
    declareFunction("finalize_call_profiling_table", "FINALIZE-CALL-PROFILING-TABLE", 1, 0, false);
    return NIL;
  }
