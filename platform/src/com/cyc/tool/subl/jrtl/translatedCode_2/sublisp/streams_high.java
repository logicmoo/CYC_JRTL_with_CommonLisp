...
public final class streams_high extends SubLTrampolineFile {
    ...
    public static final SubLObject read_byte(SubLObject stream, SubLObject eof_error_p, SubLObject eof_value) {
    ...
    public static final SubLObject read_char(SubLObject stream, SubLObject eof_error_p, SubLObject eof_value, SubLObject recursive_p) {
	if (stream == UNPROVIDED) {
    ...
    public static final SubLObject read_byte_sequence_into_string(SubLObject string, SubLObject stream, SubLObject eof_error_p, SubLObject eof_value) {
	if (stream == UNPROVIDED) {
	    stream = StreamsLow.$standard_input$.getDynamicValue();
	}
    ...
    public static final SubLObject read_byte_sequence_to_positive_integer(SubLObject byteCount, SubLObject stream, SubLObject eof_error_p, SubLObject eof_value) {
	if (stream == UNPROVIDED) {
	    stream = StreamsLow.$standard_input$.getDynamicValue();
	}
	long positiveInteger = stream.toInputBinaryStream().readByteSequenceToPositiveInteger(byteCount.intValue(), false);
    ...
    public static final SubLObject read_char_no_hang(SubLObject stream, SubLObject eof_error_p, SubLObject eof_value, SubLObject recursive_p) {
	if (stream == UNPROVIDED) {
	    stream = StreamsLow.$standard_input$.getDynamicValue();
	}
    ...
    public static final SubLObject read_line(SubLObject stream, SubLObject eof_error_p, SubLObject eof_value, SubLObject recursive_p) {
	if (stream == UNPROVIDED) {
	    stream = StreamsLow.$standard_input$.getValue();
	}
	...
	return Values.values(SubLObjectFactory.makeString(result), SubLObjectFactory.makeBoolean(currentChar == EOF_CHAR));
    }

    private static final SubLObject peekChar(SubLInputTextStream stream, SubLObject eof_error_p, SubLObject eof_value) {
    ...
    private static final SubLObject peekCharSkippingWS(SubLInputTextStream stream, SubLObject eof_error_p, SubLObject eof_value) {
	int theChar;
	do {
    ...
    private static final SubLObject peekCharSkippingChar(int charToSkip, SubLInputTextStream stream, SubLObject eof_error_p, SubLObject eof_value) {
	int theChar;
	do {
	    theChar = stream.readChar();
    ...
    public static final SubLObject peek_char(SubLObject peek_type, SubLObject stream, SubLObject eof_error_p, SubLObject eof_value, SubLObject recursivep) {
	if (stream == UNPROVIDED) {
	    stream = StreamsLow.$standard_input$.getDynamicValue();
	}
	if (eof_error_p == UNPROVIDED) {
