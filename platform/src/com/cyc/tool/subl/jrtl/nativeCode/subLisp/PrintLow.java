...
public class PrintLow extends SubLTrampolineFile {
	...
	SubLFiles.defparameter(PrintLow.me, "*PRINT-LEVEL*", SubLObjectFactory.makeInteger(50));
	SubLFiles.defparameter(PrintLow.me, "*PRINT-LENGTH*", SubLObjectFactory.makeInteger(100));
    }
