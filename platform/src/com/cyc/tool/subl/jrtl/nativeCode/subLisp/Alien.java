...
public class Alien implements SubLFile
{
  ...
  public static SubLObject def_foreign_function(SubLObject FOREIGN_SHARED_LIBRARY, SubLObject FOREIGN_NAME, SubLObject SYMBOL, SubLObject ARG_CONVERSION, SubLObject RET_TYPE, SubLObject CALLING_CONVENTION,
