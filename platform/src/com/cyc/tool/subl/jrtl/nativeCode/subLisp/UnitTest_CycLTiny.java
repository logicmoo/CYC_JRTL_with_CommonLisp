...
public class UnitTest_CycLTiny implements CommonSymbols {
	...
	try {
		...
		public void safeRun() {
			...
			SubLObject form2 = reader.read_from_string(SubLObjectFactory.makeString("(run-all-cyc-tests \"/cyc/top/tests/\")"), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
