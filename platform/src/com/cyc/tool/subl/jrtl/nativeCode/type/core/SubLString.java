...
abstract public class SubLString extends AbstractVector implements SubLObject, SubLSequence, Cloneable, CharSequence {
    ...
    public final int compare(SubLString compareString, LarKCCharacter.CharCompareDesc compareDesc, int start1,
            int start2, int end1, int end2) {
        int curIndex1;
    ...
    public final SubLInputBinaryStream toInputBinaryStream() {
        ...
        return SubLStreamFactory
                .makeInputBinaryStream(getStringValue(), CommonSymbols.OVERWRITE_KEYWORD, CommonSymbols.CREATE_KEYWORD);
    }
    ...
    public final SubLInputTextStream toInputTextStream() {
        ...
        return SubLStreamFactory
                .makeInputTextStream(getStringValue(), CommonSymbols.OVERWRITE_KEYWORD, CommonSymbols.CREATE_KEYWORD);
    }
    ...
    public final SubLOutputBinaryStream toOutputBinaryStream() {
        ...
        return SubLStreamFactory
                .makeOutputBinaryStream(getStringValue(), CommonSymbols.OVERWRITE_KEYWORD, CommonSymbols.CREATE_KEYWORD);
    }
    ...
    public final SubLOutputTextStream toOutputTextStream() {
        if ("/dev/null".equals(getStringValue()))
            return SubLStreamFactory.makeBroadcastStream();
        return SubLStreamFactory
                .makeOutputTextStream(getStringValue(), CommonSymbols.OVERWRITE_KEYWORD, CommonSymbols.CREATE_KEYWORD);
    }
    ...
    public final int indexOfMismatch(SubLSequence otherSeq) {
        return this
                .indexOfMismatch(otherSeq, EQL_TEST, IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE, 0, Integer.MAX_VALUE);
    }
    ...
    public final SubLSequence substitute(SubLObject newItem, SubLObject oldItem, boolean isDestructive) {
        return this
                .substitute(newItem, oldItem, isDestructive, EQL_TEST, IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE, Integer.MAX_VALUE);
    }
    ...
    public final SubLSequence substitute(SubLObject newItem, SubLObject oldItem, boolean isDestructive,
            BinaryFunction test) {
        return this
                .substitute(newItem, oldItem, isDestructive, test, IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE, Integer.MAX_VALUE);
    }
    ...
    public final SubLSequence substituteIf(SubLObject newItem, UnaryFunction test, boolean isDestructive) {
        return this
                .substituteIf(newItem, test, isDestructive, IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE, Integer.MAX_VALUE);
    }
