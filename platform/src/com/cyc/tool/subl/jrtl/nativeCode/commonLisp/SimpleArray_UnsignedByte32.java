...
public final class SimpleArray_UnsignedByte32 extends AbstractSimpleArray
{
    ...
    {
        return list(LispSymbols.SIMPLE_ARRAY, UNSIGNED_BYTE_32, getDimensions());
    }
