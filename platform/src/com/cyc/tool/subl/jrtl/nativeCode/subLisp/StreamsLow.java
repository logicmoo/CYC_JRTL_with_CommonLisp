...
/*		StreamsLow.originalInputStream =  SubLStreamFactory.makeInputTextStream(System.in);
		...
		StreamsLow.originalInputStream =  SubLStreamFactory.makeInputTextStream(SystemCurrent.in);
		StreamsLow.originalOutputStream = SubLStreamFactory.makeOutputTextStream(SystemCurrent.out);
		StreamsLow.originalErrorStream = SubLStreamFactory.makeOutputTextStream(SystemCurrent.err);
		...
		StreamsLow.$should_memory_map_files$ = SubLFiles.defvar(StreamsLow.me, "*SHOULD-MEMORY-MAP-FILES?*",
				SubLNil.NIL);
		Object o1 = $standard_output$.getValue(),
