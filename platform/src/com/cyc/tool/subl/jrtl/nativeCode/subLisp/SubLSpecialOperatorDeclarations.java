...
public class SubLSpecialOperatorDeclarations extends SubLTrampolineFile {
    ...
    public static SubLObject defmacro(SubLCons specialForm, SubLEnvironment env) {
        ...
        try {
            ...
            SubLSymbol name = iter.nextSubLObject().toSymbol();
            SubLList arglist = iter.nextSubLObject().toList();
            SubLCons lambdaExpression = ConsesLow.list(CommonSymbols.LAMBDA_SYMBOL, ConsesLow.list(CommonSymbols.MACRO_FORM, CommonSymbols.MACRO_ENV), SubLObjectFactory
                    .makeListS(CommonSymbols.CDESTRUCTURING_BIND, arglist, ConsesLow.list(CommonSymbols.CDR, CommonSymbols.MACRO_FORM), iter)).toCons();
