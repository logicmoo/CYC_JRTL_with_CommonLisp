...
public class EqualHashTable extends LispHashtable {
	private int mask;

	public EqualHashTable(int size, SubLObject rehashSize, SubLObject rehashThreshold) {
