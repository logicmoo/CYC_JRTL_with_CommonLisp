...
public class ConsesLow extends SubLSystemTrampolineFile {
    ...
    public static SubLList list(SubLObject object1, SubLObject object2, SubLObject object3, SubLObject object4, SubLObject object5) {
	return SubLObjectFactory.makeList(1, object5).push(object4).push(object3).push(object2).push(object1);
    }

    public static SubLList list(SubLObject object1, SubLObject object2, SubLObject object3, SubLObject object4, SubLObject object5, SubLObject object6) {
	return SubLObjectFactory.makeList(1, object6).push(object5).push(object4).push(object3).push(object2).push(object1);
    }

    public static SubLList list(SubLObject object1, SubLObject object2, SubLObject object3, SubLObject object4, SubLObject object5, SubLObject object6, SubLObject object7) {
	return SubLObjectFactory.makeList(1, object7).push(object6).push(object5).push(object4).push(object3).push(object2).push(object1);
    }

    public static SubLList list(SubLObject object1, SubLObject object2, SubLObject object3, SubLObject object4, SubLObject object5, SubLObject object6, SubLObject object7, SubLObject object8) {
	return SubLObjectFactory.makeList(1, object8).push(object7).push(object6).push(object5).push(object4).push(object3).push(object2).push(object1);
    }

    public static SubLList list(SubLObject object1, SubLObject object2, SubLObject object3, SubLObject object4, SubLObject object5, SubLObject object6, SubLObject object7, SubLObject object8, SubLObject... objects) {
	return SubLObjectFactory.makeList(objects).push(object8).push(object7).push(object6).push(object5).push(object4).push(object3).push(object2).push(object1);
    }
    ...
    public static SubLList listS(SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4, SubLObject finalCdr) {
	return SubLObjectFactory.makeListS(arg1, arg2, arg3, arg4, finalCdr);
    }

    public static SubLList listS(SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4, SubLObject arg5, SubLObject finalCdr) {
	...
	return SubLObjectFactory.makeList(size.intValue(), initialElement == CommonSymbols.UNPROVIDED ? SubLNil.NIL : initialElement);
    }
