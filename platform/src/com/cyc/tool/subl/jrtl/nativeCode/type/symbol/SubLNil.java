...
abstract public class SubLNil extends Symbol implements SubLList, SubLSymbol, SubLBoolean, IPrologifiable {

    /* (non-Javadoc)
     * @see com.cyc.tool.subl.jrtl.nativeCode.subLisp.PrologSync.IPrologifiable#toProlog(java.util.List)
     */
    @Override
    public Term toProlog(List circle) {
        return JPL.LIST_NIL;
    }
    ...
    private SubLList mapResult(BinaryFunction function, SubLList list2, boolean returnConsedResults) {
        ...
        for (SubLObject cur = this, cur2 = list2; cur != this && cur2 != this; cur = cur.rest(), cur2 = cur2.rest()) {
