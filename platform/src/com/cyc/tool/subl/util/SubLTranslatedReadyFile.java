 ...
 *
 */
public class SubLTranslatedReadyFile extends SubLTranslatedFile {
    /* (non-Javadoc)
     * @see com.cyc.tool.subl.util.SubLFile#declareFunctions()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.cyc.tool.subl.util.SubLFile#initializeVariables()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.cyc.tool.subl.util.SubLFile#runTopLevelForms()
     */
    @Override
