...
public final class module0780 extends SubLTranslatedFile
{
    ...
    public static SubLObject f50260(final SubLObject var4) {
        assert NIL != module0577.f35438(var4) : var4;
    ...
    public static SubLObject f50263(final SubLObject var1, SubLObject var5, SubLObject var2, SubLObject var3) {
        ...
        final SubLObject var7 = module0577.f35454((SubLObject)ConsesLow.list((SubLObject)$ic3$, var5, (SubLObject)$ic4$, (SubLObject)$ic5$, (SubLObject)$ic6$, var6));
        return var7;
    }
    ...
    public static SubLObject f50265(final SubLObject var9, final SubLObject var10) {
        ...
        final SubLObject var12 = (SubLObject)(var11.isList() ? conses_high.third(var11) : NIL);
        module0577.f35455(var10);
        if (module0778.f50163(var9) == $ic7$ && NIL != module0178.f11284(var12) && module0603.f36871(module0778.f50150(var9)).eql(module0178.f11334(var12)) && module0778.f50151(var9).equalp(module0178.f11335(var12))) {
    ...
    public static SubLObject f50266(SubLObject var5) {
        ...
        return module0577.f35462(var5, (SubLObject)$ic5$);
    }
    ...
    public static SubLObject f50268(final SubLObject var4) {
        ...
        return (SubLObject)makeBoolean(NIL == constant_handles_oc.f8467(var5, (SubLObject)UNPROVIDED) && NIL == module0172.f10918(var5, (SubLObject)UNPROVIDED) && (NIL != module0206.f13453(var5) || NIL != constant_handles_oc.f8449(var5)));
    }
    ...
    public static SubLObject f50271(final SubLObject var8) {
        return module0219.f14509(var8, (SubLObject)ONE_INTEGER, $g6285$.getGlobalValue(), $g6286$.getGlobalValue(), (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f50272(SubLObject var14, SubLObject var15, SubLObject var16, SubLObject var17, SubLObject var18) {
        ...
        return f50273(var19, (SubLObject)NIL, (SubLObject)NIL, var17, var18);
    }
    ...
    public static SubLObject f50274(SubLObject var20, SubLObject var17, SubLObject var18) {
        ...
        if (NIL == var23) {
            ...
            while (NIL == var23 && NIL != var24) {
                if (NIL != module0178.f11284(var25)) {
                    ...
                    var23 = (SubLObject)makeBoolean(NIL != var17 && var22.numGE(var17));
                }
                var24 = var24.rest();
                var25 = var24.first();
            }
    ...
    public static SubLObject f50273(final SubLObject var25, SubLObject var26, SubLObject var16, SubLObject var17, SubLObject var18) {
        ...
        if (NIL == var28) {
            ...
            while (NIL == var28 && NIL != var29) {
                if (NIL == var26 || NIL != module0777.f50031(var30, var16)) {
                    final SubLObject var31 = f50271(var30);
                    final SubLObject var32 = (SubLObject)((NIL != var31) ? var31.first() : NIL);
                    final SubLObject var33 = (SubLObject)((NIL != module0178.f11284(var32)) ? module0178.f11335(var32) : NIL);
                    if (NIL != f50263(var30, var18, var33, var32)) {
                        var27 = Numbers.add(var27, (SubLObject)ONE_INTEGER);
                        var28 = (SubLObject)makeBoolean(NIL != var17 && var27.numGE(var17));
                    }
                }
                var29 = var29.rest();
                var30 = var29.first();
    ...
    public static SubLObject f50275(final SubLObject var8, SubLObject var18) {
        ...
        return f50273((SubLObject)ConsesLow.list(var8), (SubLObject)NIL, (SubLObject)NIL, (SubLObject)NIL, var18);
    }
    ...
    public static SubLObject f50277(SubLObject var16, SubLObject var17, SubLObject var18) {
        ...
        final SubLObject var21 = (NIL != var17) ? var17 : module0173.f10962();
        ...
        try {
            ...
            if (NIL == module0065.f4772(var40_41, (SubLObject)$ic10$)) {
                final SubLObject var42_43 = var40_41;
                if (NIL == module0065.f4775(var42_43, (SubLObject)$ic10$)) {
                    ...
                    for (var32 = Sequences.length(var30), var33 = (SubLObject)NIL, var33 = (SubLObject)ZERO_INTEGER; var33.numL(var32); var33 = Numbers.add(var33, (SubLObject)ONE_INTEGER)) {
                        ...
                        if (NIL == module0065.f4749(var35) || NIL == module0065.f4773((SubLObject)$ic10$)) {
                            if (NIL != module0065.f4749(var35)) {
                                var35 = (SubLObject)$ic10$;
                            }
                            module0012.note_percent_progress(var25, var24);
                            var25 = Numbers.add(var25, (SubLObject)ONE_INTEGER);
                            if (NIL != module0777.f50031(var35, var16) && !var20.numGE(var21)) {
                                f50275(var35, var18);
                ...
                if (NIL == module0065.f4777(var49_50) || NIL == module0065.f4773((SubLObject)$ic10$)) {
                    ...
                    final SubLObject var39 = (SubLObject)((NIL != module0065.f4773((SubLObject)$ic10$)) ? NIL : $ic10$);
                    while (var37.numL(var38)) {
                        final SubLObject var40 = Hashtables.gethash_without_values(var37, var36, var39);
                        if (NIL == module0065.f4773((SubLObject)$ic10$) || NIL == module0065.f4749(var40)) {
                            module0012.note_percent_progress(var25, var24);
                            var25 = Numbers.add(var25, (SubLObject)ONE_INTEGER);
                            if (NIL != module0777.f50031(var40, var16) && !var20.numGE(var21)) {
                                f50275(var40, var18);
                                var20 = Numbers.add(var20, (SubLObject)ONE_INTEGER);
                            }
                        }
    ...
    public static SubLObject f50279() {
        $g6285$ = SubLFiles.deflexical("S#54847", $ic0$);
        $g6286$ = SubLFiles.deflexical("S#54848", $ic1$);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g6285$ = null;
        $g6286$ = null;
        $ic0$ = constant_handles_oc.f8479((SubLObject)makeString("termStrings-GuessedFromName"));
        $ic1$ = constant_handles_oc.f8479((SubLObject)makeString("TemporaryLexicalAssertions-GuessedMt"));
        $ic2$ = makeSymbol("S#38849", "CYC");
        $ic3$ = makeKeyword("CYCLIST");
        $ic4$ = makeKeyword("TYPE-KEY");
        $ic5$ = makeKeyword("LEXIFICATION-NEEDED");
        $ic6$ = makeKeyword("DATA");
        $ic7$ = makeKeyword("DONE");
        $ic8$ = makeString("Adding lexwiz reminders for unlexified terms ...");
