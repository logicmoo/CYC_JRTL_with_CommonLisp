...
public final class module0210 extends SubLTranslatedFile
{
    ...
    public static SubLObject f13565(final SubLObject var1) {
        return (SubLObject)makeBoolean(NIL != module0173.f10955(var1) || NIL == var1 || NIL != module0202.f12590(var1));
    }
    ...
    public static SubLObject f13567(final SubLObject var3) {
        return (SubLObject)makeBoolean(var3.isChar() || var3.isString() || var3.isNumber() || var3.isSymbol() || var3.isCons());
    }
    ...
    public static SubLObject f13570(final SubLObject var4) {
        return (SubLObject)makeBoolean(NIL != module0173.f10955(var4) && NIL != module0269.f17779(var4));
    }
    
    public static SubLObject f13569(final SubLObject var4) {
        if (NIL != var4) {
            return (SubLObject)makeBoolean(NIL != module0173.f10955(var4) || NIL != module0201.f12546(var4) || NIL != f13571(var4));
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f13572(final SubLObject var5) {
        return (SubLObject)makeBoolean(NIL != module0205.f13155(var5) || NIL != module0172.f10917(var5) || NIL != module0193.f12067(var5) || NIL != f13567(var5));
    }
    
    public static SubLObject f13573(final SubLObject var4) {
        return (SubLObject)makeBoolean(NIL != f13569(var4) || NIL != module0206.f13466(var4));
    }
    ...
    public static SubLObject f13574(final SubLObject var4, SubLObject var6) {
        ...
        return (SubLObject)makeBoolean(NIL != f13573(var4) || NIL != module0274.f18101(var4, var6));
    }
    ...
    public static SubLObject f13575(final SubLObject var1) {
        ...
        if (NIL != f13576(var1, (SubLObject)UNPROVIDED)) {
            return module0259.f16892(var1, $ic7$, module0132.$g1555$.getGlobalValue(), (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f13577(final SubLObject var4) {
        return (SubLObject)makeBoolean(NIL != module0202.f12590(var4) && NIL != f13578(module0205.f13132(var4)));
    }
    
    public static SubLObject f13579(final SubLObject var4) {
        return (SubLObject)makeBoolean(NIL != f13577(var4) && NIL == module0205.f13304(var4, (SubLObject)UNPROVIDED));
    }
    ...
    public static SubLObject f13582(final SubLObject var8, SubLObject var9, SubLObject var10) {
        ...
        if (NIL != module0173.f10955(var8)) {
            return (SubLObject)makeBoolean(NIL != module0269.f17801(var8) || NIL != ((NIL != var9) ? module0220.f14581($ic8$, var8, $ic9$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) : NIL) || NIL != ((NIL != var9) ? module0220.f14581($ic8$, var8, $ic10$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) : NIL) || NIL != ((NIL != var10) ? ((NIL != module0245.f15831(var8, $ic8$)) ? NIL : f13583(var8)) : NIL));
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f13583(final SubLObject var11) {
        if (NIL != constant_handles_oc.f8449(var11)) {
            ...
            if (var12.isString()) {
                return module0038.f2684(var12, (SubLObject)$ic11$);
            }
        }
    ...
    public static SubLObject f13584(final SubLObject var11) {
        ...
        if (NIL != constant_handles_oc.f8449(var11) && NIL != f13583(var11)) {
            return f13582(var11, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f13585(final SubLObject var4) {
        return (SubLObject)makeBoolean(NIL != module0167.f10813(var4) && NIL != f13578(module0205.f13276(var4)));
    }
    ...
    public static SubLObject f13587(final SubLObject var4) {
        return (SubLObject)makeBoolean(NIL != f13586(var4) || (NIL != module0172.f10917(var4) && NIL != f13583(module0205.f13276(var4))));
    }
    
    public static SubLObject f13588(final SubLObject var4) {
        return (SubLObject)makeBoolean(NIL != f13577(var4) || NIL != f13589(var4));
    }
    ...
    public static SubLObject f13590(final SubLObject var4) {
        if (NIL != module0035.f2014(var4) && Sequences.length(var4).numGE((SubLObject)FOUR_INTEGER) && Sequences.length(var4).numLE((SubLObject)FIVE_INTEGER)) {
            SubLObject var5 = (SubLObject)NIL;
            SubLObject var6 = (SubLObject)NIL;
            SubLObject var7 = (SubLObject)NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var4, var4, (SubLObject)$ic12$);
            var5 = var4.first();
            SubLObject var8 = var4.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var8, var4, (SubLObject)$ic12$);
            var6 = var8.first();
            var8 = var8.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var8, var4, (SubLObject)$ic12$);
            var7 = var8.first();
            var8 = var8.rest();
            final SubLObject var9 = (SubLObject)(var8.isCons() ? var8.first() : NIL);
            cdestructuring_bind.destructuring_bind_must_listp(var8, var4, (SubLObject)$ic12$);
            var8 = var8.rest();
            final SubLObject var10 = (SubLObject)(var8.isCons() ? var8.first() : NIL);
            cdestructuring_bind.destructuring_bind_must_listp(var8, var4, (SubLObject)$ic12$);
            var8 = var8.rest();
            if (NIL == var8) {
                return (SubLObject)makeBoolean(NIL != f13591(var5) && var6.isList() && NIL != module0201.f12546(var7));
            }
    ...
    public static SubLObject f13591(final SubLObject var3) {
        return module0004.f104(var3, module0146.$g1967$.getGlobalValue(), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f13593(final SubLObject var21, SubLObject var22) {
        if (var22 == UNPROVIDED) {
            var22 = Symbols.symbol_function((SubLObject)$ic13$);
        }
        if (NIL != module0202.f12659(var21) && NIL == module0202.f12707(var21, (SubLObject)UNPROVIDED) && NIL == module0035.f2438(var22, var21, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f13594(final SubLObject var1) {
        return f13593(var1, Symbols.symbol_function((SubLObject)$ic14$));
    }
    ...
    public static SubLObject f13595(final SubLObject var1, SubLObject var22) {
        ...
        return (SubLObject)makeBoolean(NIL != f13576(var1, var22) && NIL != module0202.f12691(var1, var22));
    }
    ...
    public static SubLObject f13597(final SubLObject var24, SubLObject var22) {
        if (var22 == UNPROVIDED) {
            var22 = Symbols.symbol_function((SubLObject)$ic15$);
        }
        return (SubLObject)makeBoolean(NIL != f13576(var24, var22) && NIL == f13593(var24, var22));
    }
    
    public static SubLObject f13598(final SubLObject var1) {
        return (SubLObject)makeBoolean(NIL != module0202.f12659(var1) && NIL != module0269.f17725(module0205.f13276(var1)));
    }
    
    public static SubLObject f13599(final SubLObject var24, SubLObject var22) {
        if (var22 == UNPROVIDED) {
            var22 = Symbols.symbol_function((SubLObject)$ic14$);
        }
    ...
    public static SubLObject f13576(final SubLObject var24, SubLObject var22) {
        ...
        if (NIL != module0202.f12659(var24)) {
            ...
            if (NIL == var27) {
                ...
                try {
                    ...
                    var27 = (SubLObject)makeBoolean(NIL != module0269.f17725(var26) || NIL != ((NIL != module0173.f10955(var26)) ? NIL : f13600(var26, (SubLObject)NIL)));
                }
                finally {
    ...
    public static SubLObject f13600(final SubLObject var13, SubLObject var6) {
        ...
        if (NIL != f13576(var13, (SubLObject)UNPROVIDED)) {
            return module0256.f16604($ic18$, module0226.f14990(module0205.f13276(var13), var6), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f13571(final SubLObject var4) {
        ...
        return (SubLObject)makeBoolean((NIL != f13601(var4, (SubLObject)UNPROVIDED) && (NIL != module0201.f12580(module0205.f13276(var4)) || NIL != f13602(module0205.f13276(var4))) && (NIL == module0152.$g2101$.getDynamicValue(var5) || NIL != f13603(var4))) || NIL != module0205.f13330(var4));
    }
    ...
    public static SubLObject f13603(final SubLObject var4) {
        ...
        var7 = module0034.f1857(var6, (SubLObject)$ic19$, (SubLObject)UNPROVIDED);
        if (NIL == var7) {
            var7 = module0034.f1807(module0034.f1842(var6), (SubLObject)$ic19$, (SubLObject)ONE_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var6, (SubLObject)$ic19$, var7);
        }
        SubLObject var8 = module0034.f1814(var7, var4, (SubLObject)$ic20$);
        if (var8 == $ic20$) {
    ...
    public static SubLObject f13605(final SubLObject var4) {
        final SubLThread var5 = SubLProcess.currentSubLThread();
        if (NIL != module0228.f15212(var4)) {
            return (SubLObject)T;
        }
        if (NIL != module0152.$g2101$.getDynamicValue(var5)) {
            module0274.f18082((SubLObject)ConsesLow.list((SubLObject)$ic21$, var4));
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f13606(final SubLObject var32, SubLObject var22) {
        ...
        if (NIL != module0202.f12660(var32)) {
            ...
            if (NIL == var35) {
                ...
                try {
                    module0147.$g2094$.bind((SubLObject)$ic16$, var33);
                    module0147.$g2095$.bind($ic17$, var33);
                    var35 = (SubLObject)makeBoolean(NIL != module0269.f17736(var34) || NIL != module0269.f17706(var34) || NIL != module0269.f17718(var34, (SubLObject)UNPROVIDED));
                }
                finally {
    ...
    public static SubLObject f13607(final SubLObject var1) {
        return (SubLObject)makeBoolean(NIL == module0205.f13145((SubLObject)$ic22$, var1, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
    }
    
    public static SubLObject f13608(final SubLObject var1) {
        return (SubLObject)makeBoolean(NIL != module0202.f12590(var1) && NIL != constant_handles_oc.f8449(module0205.f13136(var1)));
    }
    ...
    public static SubLObject f13610(final SubLObject var35) {
        ...
        var38 = var37.first();
        while (NIL != var37) {
            final SubLObject var39 = (SubLObject)$ic23$;
            if (NIL != f13611(var38)) {
                return (SubLObject)NIL;
            }
        ...
        var38 = var37.first();
        while (NIL != var37) {
            final SubLObject var39 = (SubLObject)$ic24$;
            if (NIL != f13611(var38)) {
                return (SubLObject)NIL;
            }
            var36 = Numbers.add(var36, (SubLObject)ONE_INTEGER);
    ...
    public static SubLObject f13611(final SubLObject var1) {
        return (SubLObject)makeBoolean(NIL == f13607(var1));
    }
    
    public static SubLObject f13613(final SubLObject var35) {
        return (SubLObject)makeBoolean(NIL == f13610(var35));
    }
    
    public static SubLObject f13614(final SubLObject var40) {
        return (SubLObject)makeBoolean(NIL == f13612(var40));
    }
    ...
    public static SubLObject f13601(final SubLObject var4, SubLObject var22) {
        ...
        return (SubLObject)makeBoolean((NIL != module0146.$g1981$.getDynamicValue(var23) && NIL != f13615(var4, var22) && NIL != module0202.f12933(var4)) || NIL != module0035.f2014(var4));
    }
    ...
    public static SubLObject f13616(final SubLObject var4, SubLObject var6) {
        ...
        return (SubLObject)makeBoolean(NIL != module0552.f34136(var4, var6) || (NIL != module0131.f8560() && NIL != module0259.f16854(var4, $ic25$, var6, (SubLObject)UNPROVIDED)));
    }
    ...
    public static SubLObject f13619(final SubLObject var1) {
        return module0202.f12691(var1, (SubLObject)$ic26$);
    }
    
    public static SubLObject f13620(final SubLObject var1) {
        return (SubLObject)makeBoolean(NIL != module0201.f12546(var1) || NIL != module0201.f12581(var1) || NIL != module0201.f12568(var1) || NIL != module0201.f12582(var1) || NIL != f13589(var1));
    }
    ...
    public static SubLObject f13621(final SubLObject var1, SubLObject var6) {
        ...
        return (SubLObject)makeBoolean(NIL != f13572(var1) || NIL != f13574(var1, var6));
    }
    ...
    public static SubLObject f13622(final SubLObject var1, SubLObject var22) {
        ...
        if (NIL != module0167.f10813(var1)) {
            return f13622(module0172.f10920(var1), (SubLObject)UNPROVIDED);
        }
        if (var1.isAtom()) {
            return (SubLObject)makeBoolean(NIL == Functions.funcall(var22, var1));
        }
        if (NIL != f13574(var1, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f13623(final SubLObject var1, SubLObject var22) {
        ...
        if (NIL != assertion_handles_oc.f11035(var1)) {
            return module0202.f12691(module0289.f19396(var1), (SubLObject)UNPROVIDED);
        }
        if (NIL != module0167.f10813(var1)) {
            return f13595(module0172.f10920(var1), (SubLObject)UNPROVIDED);
        }
        if (var1.isAtom()) {
            return (SubLObject)makeBoolean(NIL == Functions.funcall(var22, var1));
        }
    ...
    public static SubLObject f13624(final SubLObject var1, SubLObject var22) {
        ...
        if (NIL != assertion_handles_oc.f11035(var1)) {
            return (SubLObject)makeBoolean(NIL == module0202.f12691(module0289.f19396(var1), (SubLObject)UNPROVIDED));
        }
        if (NIL != module0167.f10813(var1)) {
            return (SubLObject)makeBoolean(NIL == f13595(module0172.f10920(var1), (SubLObject)UNPROVIDED));
        }
        if (var1.isAtom()) {
            return Functions.funcall(var22, var1);
        }
        if (NIL != f13574(var1, (SubLObject)UNPROVIDED)) {
            return (SubLObject)makeBoolean(NIL == module0202.f12691(var1, var22));
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f13627() {
        ...
        module0012.f368((SubLObject)$ic4$, (SubLObject)$ic5$, (SubLObject)$ic6$, (SubLObject)NIL, (SubLObject)$ic3$);
    ...
    static {
        ...
        $ic0$ = makeSymbol("EL-FORT-P");
        $ic1$ = ConsesLow.list((SubLObject)makeSymbol("OBJECT", "CYC"));
        $ic2$ = makeString("Returns t iff OBJECT is a fort or an EL formula.");
        $ic3$ = ConsesLow.list((SubLObject)makeSymbol("BOOLEANP"));
        $ic4$ = makeSymbol("HL-TERM-P");
        $ic5$ = ConsesLow.list((SubLObject)makeSymbol("S#671", "CYC"));
        $ic6$ = makeString("Returns T if the OBJ is a valid CycL HL term.");
        $ic7$ = constant_handles_oc.f8479((SubLObject)makeString("Relation"));
        $ic8$ = constant_handles_oc.f8479((SubLObject)makeString("isa"));
        $ic9$ = constant_handles_oc.f8479((SubLObject)makeString("SkolemFuncN"));
        $ic10$ = constant_handles_oc.f8479((SubLObject)makeString("SkolemFunction"));
        $ic11$ = makeString("SKF");
        $ic12$ = ConsesLow.list((SubLObject)makeSymbol("S#11675", "CYC"), (SubLObject)makeSymbol("S#16446", "CYC"), (SubLObject)makeSymbol("VAR", "CYC"), (SubLObject)makeSymbol("&OPTIONAL"), (SubLObject)makeSymbol("S#16447", "CYC"), (SubLObject)makeSymbol("S#1993", "CYC"));
        $ic13$ = makeSymbol("S#12629", "CYC");
        $ic14$ = makeSymbol("VARIABLE-P");
        $ic15$ = makeSymbol("EL-VAR?");
        $ic16$ = makeSymbol("S#12274", "CYC");
        $ic17$ = constant_handles_oc.f8479((SubLObject)makeString("EverythingPSC"));
        $ic18$ = constant_handles_oc.f8479((SubLObject)makeString("Function-Denotational"));
        $ic19$ = makeSymbol("S#16427", "CYC");
        $ic20$ = makeKeyword("&MEMOIZED-ITEM-NOT-FOUND&");
        $ic21$ = makeKeyword("MAL-FN-NESTING");
        $ic22$ = makeSymbol("S#16431", "CYC");
        $ic23$ = makeKeyword("NEG");
        $ic24$ = makeKeyword("POS");
        $ic25$ = constant_handles_oc.f8479((SubLObject)makeString("ScalarInterval"));
        $ic26$ = makeSymbol("S#15917", "CYC");
    }
    ...
    public static final class $f13595$UnaryFunction extends UnaryFunction
    {
        ...
        public SubLObject processItem(final SubLObject var2) {
            return f13595(var2, (SubLObject)$f13595$UnaryFunction.UNPROVIDED);
        }
    }
