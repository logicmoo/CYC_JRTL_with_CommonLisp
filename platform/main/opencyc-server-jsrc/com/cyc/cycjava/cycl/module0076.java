...
public final class module0076 extends SubLTranslatedFile
{
    ...
    public static SubLObject f5290(final SubLObject var15, final SubLObject var16, SubLObject var17, SubLObject var8, SubLObject var1) {
        ...
        if (var8 == UNPROVIDED) {
            var8 = Symbols.symbol_function((SubLObject)IDENTITY);
        }
        if (var1 == UNPROVIDED) {
            var1 = (SubLObject)NIL;
        }
        ...
        if (NIL != module0035.f1994(var15, module0035.$g892$.getDynamicValue(var18), (SubLObject)UNPROVIDED)) {
            return conses_high.intersection(var15, var16, var17, var8);
        }
        if (NIL != module0035.f1994(var16, module0035.$g892$.getDynamicValue(var18), (SubLObject)UNPROVIDED)) {
            return conses_high.intersection(var15, var16, var17, var8);
        }
        if (NIL != var1) {
            return f5291(var15, var16, var1, var8);
        }
        if (NIL != module0030.f1591(var17)) {
            return f5291(var15, var16, $g1140$.getDynamicValue(var18), var8);
        }
        return conses_high.intersection(var15, var16, var17, var8);
    }
    
    public static SubLObject f5292(final SubLObject var19, final SubLObject var20) {
        return f5290(var19, var20, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f5291(final SubLObject var15, final SubLObject var16, SubLObject var1, SubLObject var8) {
        if (var1 == UNPROVIDED) {
            var1 = $g1140$.getDynamicValue();
        }
        if (var8 == UNPROVIDED) {
            var8 = Symbols.symbol_function((SubLObject)IDENTITY);
        }
        final SubLThread var17 = SubLProcess.currentSubLThread();
        if (var1.eql($g1140$.getDynamicValue(var17))) {
            SubLObject var18 = (SubLObject)NIL;
            final SubLObject var19 = $g1141$.getDynamicValue(var17);
    ...
    public static SubLObject f5293(final SubLObject var15, final SubLObject var16, SubLObject var1, SubLObject var8) {
        ...
        assert NIL != Types.listp(var16) : var16;
        assert NIL != module0031.f1646(var1) : var1;
        if (var15.eql(var16)) {
            return var15;
        }
        SubLObject var17 = (SubLObject)NIL;
        module0031.f1686(var1);
        if (var8.eql(Symbols.symbol_function((SubLObject)IDENTITY)) || var8 == IDENTITY) {
            ...
            var19 = var18.first();
            while (NIL != var18) {
                if (NIL != module0031.f1688(var19, var1)) {
            ...
            var19 = var18.first();
            while (NIL != var18) {
                if (NIL != module0031.f1688(Functions.funcall(var8, var19), var1)) {
                    var17 = (SubLObject)ConsesLow.cons(var19, var17);
                }
                var18 = var18.rest();
                var19 = var18.first();
    ...
    public static SubLObject f5294(final SubLObject var15, final SubLObject var16, SubLObject var17, SubLObject var8, SubLObject var1) {
        ...
        if (NIL != module0030.f1591(var17)) {
            return f5295(var15, var16, $g1140$.getDynamicValue(var18), var8);
        }
        return module0035.f2180(var15, var16, var17, var8);
    }
    ...
    public static SubLObject f5296(final SubLObject var15, final SubLObject var16, SubLObject var1, SubLObject var8) {
        ...
        final SubLObject var18 = (NIL != var17) ? var16 : var15;
        final SubLObject var19 = (NIL != var17) ? var15 : var16;
        module0031.f1686(var1);
        if (var8.eql(Symbols.symbol_function((SubLObject)IDENTITY)) || var8 == IDENTITY) {
            ...
            var21 = var20.first();
            while (NIL != var20) {
                if (NIL != module0031.f1688(var21, var1)) {
                    return (SubLObject)T;
                }
                var20 = var20.rest();
                var21 = var20.first();
            ...
            var21 = var20.first();
            while (NIL != var20) {
                if (NIL != module0031.f1688(Functions.funcall(var8, var21), var1)) {
                    return (SubLObject)T;
                }
                var20 = var20.rest();
                var21 = var20.first();
    ...
    public static SubLObject f5298() {
        $g1140$ = SubLFiles.defparameter("S#6918", module0031.f1685((SubLObject)$ic0$, Symbols.symbol_function((SubLObject)EQUAL)));
        $g1141$ = SubLFiles.defparameter("S#6919", Locks.make_lock((SubLObject)$ic1$));
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g1141$ = null;
        $ic0$ = makeInteger(500);
        $ic1$ = makeString("Intersection table Lock");
        $ic2$ = makeSymbol("FUNCTION-SPEC-P");
        $ic3$ = makeSymbol("LISTP");
        $ic4$ = makeSymbol("S#2881", "CYC");
    }
}
