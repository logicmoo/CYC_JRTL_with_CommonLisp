...
public final class module0608 extends SubLTranslatedFile
{
    ...
    public static SubLObject f37152(final SubLObject var1) {
        return (SubLObject)makeBoolean(var1.isNumber() || NIL != module0606.f37086(var1));
    }
    
    public static SubLObject f37153(final SubLObject var2) {
        assert NIL != f37152(var2) : var2;
        if (NIL != module0606.f37086(var2)) {
    ...
    public static SubLObject f37160(final SubLObject var3, final SubLObject var4, SubLObject var5) {
        ...
        assert NIL != f37152(var3) : var3;
        assert NIL != f37152(var4) : var4;
        if (NIL != module0606.f37086(var3)) {
            if (NIL != module0606.f37086(var4)) {
                return module0607.f37114(var3, var4, var5);
            }
            if (var4.isInteger()) {
                return module0607.f37115(var3, var4, var5);
            }
            return module0607.f37114(var3, module0606.f37104(var4, (SubLObject)UNPROVIDED), var5);
        }
        else if (NIL != module0606.f37086(var4)) {
            if (var3.isInteger()) {
                return module0607.f37116(var3, var4, var5);
            }
            return module0607.f37114(module0606.f37104(var3, (SubLObject)UNPROVIDED), var4, (SubLObject)UNPROVIDED);
        }
        else {
            if (NIL != var5) {
    ...
    public static SubLObject f37161(final SubLObject var3, final SubLObject var4, SubLObject var5) {
        ...
        if (NIL != module0606.f37086(var3)) {
            ...
            return module0607.f37117(var3, module0606.f37104(var4, (SubLObject)UNPROVIDED), var5);
        }
        else if (NIL != module0606.f37086(var4)) {
            if (var3.isInteger()) {
                return module0607.f37119(var3, var4, (SubLObject)UNPROVIDED);
            }
            return module0607.f37117(module0606.f37104(var3, (SubLObject)UNPROVIDED), var4, var5);
        }
        else {
            if (NIL != var5) {
    ...
    public static SubLObject f37162(final SubLObject var3, final SubLObject var4, SubLObject var5) {
        ...
        if (NIL != module0606.f37086(var3)) {
            ...
            return module0607.f37120(var3, module0606.f37104(var4, (SubLObject)UNPROVIDED), var5);
        }
        else if (NIL != module0606.f37086(var4)) {
            if (var3.isInteger()) {
                return module0607.f37122(var3, var4, var5);
            }
            return module0607.f37120(module0606.f37104(var3, (SubLObject)UNPROVIDED), var4, var5);
        }
        else {
            if (NIL != var5) {
    ...
    public static SubLObject f37165(final SubLObject var3, final SubLObject var4) {
        ...
        if (NIL != module0606.f37086(var3)) {
            ...
            return module0607.f37129(var3, module0606.f37104(var4, (SubLObject)UNPROVIDED));
        }
        else {
            if (NIL == module0606.f37086(var4)) {
            ...
            return module0607.f37129(module0606.f37104(var3, (SubLObject)UNPROVIDED), var4);
        }
    }
    ...
    public static SubLObject f37166(final SubLObject var3, final SubLObject var4) {
        ...
        if (NIL != module0606.f37086(var3)) {
            ...
            return module0607.f37133(var3, module0606.f37104(var4, (SubLObject)UNPROVIDED));
        }
        else {
            if (NIL == module0606.f37086(var4)) {
            ...
            return module0607.f37133(module0606.f37104(var3, (SubLObject)UNPROVIDED), var4);
        }
    }
    ...
    public static SubLObject f37167(final SubLObject var3, final SubLObject var4) {
        ...
        if (NIL != module0606.f37086(var3)) {
            ...
            return module0607.f37136(var3, module0606.f37104(var4, (SubLObject)UNPROVIDED));
        }
        else {
            if (NIL != module0606.f37086(var4)) {
                return module0607.f37136(module0606.f37104(var3, (SubLObject)UNPROVIDED), var4);
            }
    ...
    public static SubLObject f37168(final SubLObject var3, final SubLObject var4) {
        ...
        if (NIL != module0606.f37086(var3)) {
            ...
            return module0607.f37139(var3, module0606.f37104(var4, (SubLObject)UNPROVIDED));
        }
        else {
            if (NIL != module0606.f37086(var4)) {
                return module0607.f37139(module0606.f37104(var3, (SubLObject)UNPROVIDED), var4);
            }
    ...
    public static SubLObject f37169(final SubLObject var6) {
        assert NIL != module0035.f2015(var6) : var6;
        SubLObject var7 = var6;
        SubLObject var8 = (SubLObject)NIL;
        var8 = var7.first();
        while (NIL != var7) {
            assert NIL != f37152(var8) : var8;
            var7 = var7.rest();
            var8 = var7.first();
        }
        ...
        var10 = var7.first();
        while (NIL != var7) {
            if (NIL != f37163(var10, var9, (SubLObject)UNPROVIDED)) {
                var9 = f37159(var10);
            }
            var7 = var7.rest();
            var10 = var7.first();
    ...
    public static SubLObject f37170(final SubLObject var6) {
        ...
        var10 = var7.first();
        while (NIL != var7) {
            if (NIL != f37161(var10, var9, (SubLObject)UNPROVIDED)) {
                var9 = f37159(var10);
            }
            var7 = var7.rest();
            var10 = var7.first();
    ...
    public static SubLObject f37173(final SubLObject var11, final SubLObject var2) {
        assert NIL != Types.numberp(var11) : var11;
        assert NIL != f37152(var2) : var2;
        if (NIL != module0606.f37086(var2)) {
    ...
    static {
        ...
        $ic0$ = makeSymbol("CYC-EXTENDED-NUMBER-P");
        $ic1$ = makeSymbol("S#4668", "CYC");
        $ic2$ = makeSymbol("S#747", "CYC");
