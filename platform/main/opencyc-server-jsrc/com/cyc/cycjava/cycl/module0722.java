...
public final class module0722 extends SubLTranslatedFile
{
    ...
    public static SubLObject f44228(final SubLObject var1, final SubLObject var2, final SubLObject var3) {
        if (NIL != module0161.f10482(var1) && NIL != module0035.f2192(Symbols.symbol_function((SubLObject)$ic0$), var3)) {
            return module0259.f16841(var1, var3, var2, (SubLObject)UNPROVIDED);
        }
        ...
        var6 = var5.first();
        while (NIL != var5) {
            if (NIL != module0731.f44785(var6, var1, var2)) {
    ...
    public static SubLObject f44229(final SubLObject var7, final SubLObject var8, final SubLObject var2, final SubLObject var9, SubLObject var10) {
        ...
        return f44230(module0205.f13394(var8, var7, (SubLObject)UNPROVIDED), var8, var2, var9);
    }
    ...
    public static SubLObject f44230(final SubLObject var6, final SubLObject var8, final SubLObject var2, final SubLObject var9) {
        ...
        final SubLObject var14 = (NIL != module0004.f104(var2, (SubLObject)$ic3$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) ? $ic4$ : var2;
        ...
        var10.resetMultipleValues();
        var13 = f44232(var15, $ic5$, var2);
        SubLObject var18 = var9;
        SubLObject var19 = (SubLObject)NIL;
        var19 = var18.first();
        while (NIL != var18) {
            if (NIL != var13 && NIL != module0269.f17713(var19, (SubLObject)UNPROVIDED)) {
                var12 = (SubLObject)ConsesLow.cons(var19, var12);
            }
            else if (NIL != f44233(var15, var19, var2)) {
                var12 = (SubLObject)ConsesLow.cons(var19, var12);
            }
            else if (NIL != module0257.f16693(var16, module0256.f16525(var19, var2, (SubLObject)UNPROVIDED), var14, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                var12 = (SubLObject)ConsesLow.cons(var19, var12);
            }
            else if (NIL != f44232(var15, $ic6$, var2) && NIL == module0612.f37382(var19)) {
                var12 = (SubLObject)ConsesLow.cons(var19, var12);
            }
            else if (NIL == module0259.f16858(var19, var15, var2) && (NIL != module0257.f16693(var15, f44234(var19, var2), var14, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != f44235(var15, var19, var2))) {
                var12 = (SubLObject)ConsesLow.cons(var19, var12);
            }
            else if (NIL != f44236(var17, var19, var2)) {
                var12 = (SubLObject)ConsesLow.cons(var19, var12);
            }
            else {
    ...
    public static SubLObject f44237(final SubLObject var6, final SubLObject var2) {
        SubLObject var7 = module0259.f16822(var6, var2, (SubLObject)UNPROVIDED);
        if (NIL == var7 && var6.isNumber()) {
            var7 = (SubLObject)ConsesLow.list($ic8$);
        }
        return var7;
    }
    ...
    public static SubLObject f44234(final SubLObject var6, final SubLObject var2) {
        ...
        var9 = module0034.f1857(var8, (SubLObject)$ic7$, (SubLObject)UNPROVIDED);
        if (NIL == var9) {
            var9 = module0034.f1807(module0034.f1842(var8), (SubLObject)$ic7$, (SubLObject)TWO_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var8, (SubLObject)$ic7$, var9);
        }
        ...
        if (var11 != $ic9$) {
            ...
            while (NIL != var12) {
                ...
                if (var6.equal(var14.first())) {
                    var14 = var14.rest();
                    if (NIL != var14 && NIL == var14.rest() && var2.equal(var14.first())) {
    ...
    public static SubLObject f44238(final SubLObject var15, final SubLObject var6, final SubLObject var2) {
        ...
        if (NIL == var16) {
            ...
            while (NIL == var16 && NIL != var17) {
                if (NIL != module0259.f16867(var6, var18, var2, (SubLObject)UNPROVIDED)) {
                    var16 = (SubLObject)T;
                }
                var17 = var17.rest();
                var18 = var17.first();
    ...
    public static SubLObject f44235(final SubLObject var15, final SubLObject var6, final SubLObject var2) {
        ...
        var18 = module0034.f1857(var17, (SubLObject)$ic10$, (SubLObject)UNPROVIDED);
        if (NIL == var18) {
            var18 = module0034.f1807(module0034.f1842(var17), (SubLObject)$ic10$, (SubLObject)THREE_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var17, (SubLObject)$ic10$, var18);
        }
            ...
            while (NIL != var21) {
                ...
                if (var15.equal(var23.first())) {
                    ...
                    if (var6.equal(var23.first())) {
                        var23 = var23.rest();
                        if (NIL != var23 && NIL == var23.rest() && var2.equal(var23.first())) {
    ...
    public static SubLObject f44239(final SubLObject var17, final SubLObject var6, final SubLObject var2) {
        ...
        if (NIL == var18) {
            ...
            while (NIL == var18 && NIL != var19) {
                if (NIL == module0305.f20527(var6, var20, var2)) {
                    var18 = (SubLObject)T;
                }
                var19 = var19.rest();
                var20 = var19.first();
    ...
    public static SubLObject f44236(final SubLObject var17, final SubLObject var6, final SubLObject var2) {
        ...
        var20 = module0034.f1857(var19, (SubLObject)$ic11$, (SubLObject)UNPROVIDED);
        if (NIL == var20) {
            var20 = module0034.f1807(module0034.f1842(var19), (SubLObject)$ic11$, (SubLObject)THREE_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var19, (SubLObject)$ic11$, var20);
        }
            ...
            while (NIL != var23) {
                ...
                if (var17.equal(var25.first())) {
                    ...
                    if (var6.equal(var25.first())) {
                        var25 = var25.rest();
                        if (NIL != var25 && NIL == var25.rest() && var2.equal(var25.first())) {
    ...
    public static SubLObject f44240(final SubLObject var15, final SubLObject var18, final SubLObject var2) {
        ...
        if (NIL == var19) {
            SubLObject var20;
            SubLObject var21;
            for (var20 = var15, var21 = (SubLObject)NIL, var21 = var20.first(); NIL == var19 && NIL != var20; var19 = module0305.f20340(var21, var18, var2), var20 = var20.rest(), var21 = var20.first()) {}
        }
        return var19;
    }
    ...
    public static SubLObject f44233(final SubLObject var15, final SubLObject var18, final SubLObject var2) {
        ...
        if (NIL == var21) {
            var21 = module0034.f1807(module0034.f1842(var20), (SubLObject)$ic12$, (SubLObject)THREE_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            ...
            while (NIL != var24) {
                ...
                if (var15.equal(var26.first())) {
                    ...
                    if (var18.equal(var26.first())) {
                        var26 = var26.rest();
                        if (NIL != var26 && NIL == var26.rest() && var2.equal(var26.first())) {
                            return module0034.f1959(var27);
                        }
                    }
                }
    ...
    public static SubLObject f44241(final SubLObject var3, final SubLObject var31, final SubLObject var2) {
        ...
        if (NIL == var32) {
            ...
            while (NIL == var32 && NIL != var33) {
                if (NIL != module0256.f16596(var34, var31, var2, (SubLObject)UNPROVIDED)) {
                    var32 = (SubLObject)T;
                }
                var33 = var33.rest();
                var34 = var33.first();
    ...
    public static SubLObject f44232(final SubLObject var3, final SubLObject var31, final SubLObject var2) {
        ...
        var34 = module0034.f1857(var33, (SubLObject)$ic13$, (SubLObject)UNPROVIDED);
        if (NIL == var34) {
            var34 = module0034.f1807(module0034.f1842(var33), (SubLObject)$ic13$, (SubLObject)THREE_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var33, (SubLObject)$ic13$, var34);
        }
        final SubLObject var35 = module0034.f1781(var3, var31, var2);
        final SubLObject var36 = module0034.f1814(var34, var35, (SubLObject)UNPROVIDED);
        if (var36 != $ic9$) {
            ...
            while (NIL != var37) {
                ...
                if (var3.equal(var39.first())) {
                    ...
                    if (var31.equal(var39.first())) {
                        var39 = var39.rest();
                        if (NIL != var39 && NIL == var39.rest() && var2.equal(var39.first())) {
    ...
    public static SubLObject f44242(final SubLObject var6, final SubLObject var8, final SubLObject var2) {
        final SubLObject var9 = module0279.f18513(var8, (SubLObject)UNPROVIDED);
        final SubLObject var10 = module0205.f13250(var9, var6, var8, (SubLObject)EQUALP, (SubLObject)UNPROVIDED);
        final SubLObject var11 = module0307.f20765(var10, var2, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        final SubLObject var12 = module0067.f4884(var11, var9, (SubLObject)UNPROVIDED);
        if (NIL != var12) {
            SubLObject var14;
            ...
            var14 = var14.rest();
            if (NIL == var14) {
                return Values.values(Sequences.remove_if((SubLObject)$ic16$, var15, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), Sequences.remove_if((SubLObject)$ic16$, var16, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var17);
            }
            cdestructuring_bind.cdestructuring_bind_error(var13, (SubLObject)$ic15$);
        }
    ...
    public static SubLObject f44231(final SubLObject var6, final SubLObject var8, final SubLObject var2) {
        ...
        var11 = module0034.f1857(var10, (SubLObject)$ic14$, (SubLObject)UNPROVIDED);
        if (NIL == var11) {
            var11 = module0034.f1807(module0034.f1842(var10), (SubLObject)$ic14$, (SubLObject)THREE_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var10, (SubLObject)$ic14$, var11);
        }
        final SubLObject var12 = module0034.f1781(var6, var8, var2);
        final SubLObject var13 = module0034.f1814(var11, var12, (SubLObject)UNPROVIDED);
        if (var13 != $ic9$) {
            ...
            while (NIL != var14) {
                ...
                if (var6.equal(var16.first())) {
                    ...
                    if (var8.equal(var16.first())) {
                        var16 = var16.rest();
                        if (NIL != var16 && NIL == var16.rest() && var2.equal(var16.first())) {
    ...
    public static SubLObject f44245() {
        ...
        module0034.f1895((SubLObject)$ic13$);
    ...
    static {
        ...
        $ic1$ = makeSymbol("FILTER-TERMS-FOR-ARG-CONSTRAINTS-AT-ARGPOS");
        $ic2$ = makeSymbol("FILTER-TERMS-FOR-ARG-CONSTRAINTS");
        $ic3$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)makeString("InferencePSC")), constant_handles_oc.f8479((SubLObject)makeString("EverythingPSC")));
        $ic4$ = constant_handles_oc.f8479((SubLObject)makeString("BaseKB"));
        $ic5$ = constant_handles_oc.f8479((SubLObject)makeString("Individual"));
        $ic6$ = constant_handles_oc.f8479((SubLObject)makeString("Date"));
        $ic7$ = makeSymbol("S#48412", "CYC");
        $ic8$ = constant_handles_oc.f8479((SubLObject)makeString("Number-General"));
        $ic9$ = makeKeyword("&MEMOIZED-ITEM-NOT-FOUND&");
        $ic10$ = makeSymbol("S#48414", "CYC");
        $ic11$ = makeSymbol("S#48416", "CYC");
        $ic12$ = makeSymbol("S#48418", "CYC");
        $ic13$ = makeSymbol("S#48420", "CYC");
        $ic14$ = makeSymbol("S#48422", "CYC");
        $ic15$ = ConsesLow.list((SubLObject)makeSymbol("S#36997", "CYC"), (SubLObject)makeSymbol("S#48423", "CYC"), (SubLObject)makeSymbol("S#37001", "CYC"));
        $ic16$ = makeSymbol("S#17632", "CYC");
    }
}
