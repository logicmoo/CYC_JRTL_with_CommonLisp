...
public class QuotedName {
	...
	public void errorTermTranslation1() {
		...
		t = new Compound("error", new Term[] { new Atom("existence_error"), new Atom("context") });
	...
	private Term quotedQuery(String name) {
		return new Compound(":", new Term[] { new Atom("jpl"), new Compound("quoted_name", new Term[] { new Atom(name), new Variable("S") }) });
