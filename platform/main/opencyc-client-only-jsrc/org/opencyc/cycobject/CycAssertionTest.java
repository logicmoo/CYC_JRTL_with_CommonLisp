...
import static org.opencyc.cycobject.UnitTest.*;
...
public class CycAssertionTest {
  ...
  public void setUp() throws IOException {
    assertion = getCyc().getRandomAssertion();
  }
  ...
  public void testEquals() {
    assertEquals(assertion, new CycAssertion(assertion.getFormula(), assertion.getMt()));
  }

  @Test
  public void testHashCode() {
    try {
      final CycAssertion assertion2 = new CycAssertion(assertion.getFormula(), assertion.getMt());
