package System::Cyc::ResearchCyc::Java::CycAccess;
...
public class CycAccess {
  ...
  */ 
  ...
  public static CycAccess getNewCycAccessInteractively() {
    ...
    CycServer server = new CycServer(hostname, ports[0]);
...
END_OF_JAVA_CODE
  AUTOSTUDY => 1,
  CLASSPATH => '/var/lib/myfrdcsa/sandbox/researchcyc-4.0q/researchcyc-4.0q/api/java/lib/opencyc-4.0q.152099.jar',
  EXTRA_JAVA_ARGS => '-Djava.library.path=/var/lib/myfrdcsa/sandbox/researchcyc-4.0q/researchcyc-4.0q/api/java/lib',
...
has 'cyc' =>
  (
   is      => 'rw',
   lazy    => 1,
   default => sub { System::Cyc::ResearchCyc::Java::CycAccess::org::opencyc::api::CycAccess->new() },
   handles => {
...
sub isResearchCyc {
  ...
  try {
    $isResearchCyc = $self->cyc->converseBoolean("(cyc-researchcyc-feature)");
  }
    catch {
      System::Cyc::Exception->throw('false');
    };

  return $isResearchCyc;
}
