                    ...
                    current = current.rest();
                    {
                        ...
                        }
                        {
                            ...
                            current = temp;
                            {
                                ...
                                return list(CLET, list(bq_cons(done_varP, $list_alt113), bq_cons(i, $list_alt31)), list(WITH_PRIVATE_BINARY_FILE, listS(input_stream, filename, $list_alt115), list(WITH_CFASL_COMMON_SYMBOLS, $list_alt117, list(UNTIL, done_varP, list(CLET, list(list(query_info_var, list(LOAD_ASKED_QUERY_FROM_STREAM, input_stream))), list(PCOND, list(list(EQ, $EOF, query_info_var), listS(CSETQ, done_varP, $list_alt122)), list(list(STRINGP, query_info_var), list(WARN, $str_alt125$Read_invalid_query_info__s, query_info_var)), list(T, NIL != element_num ? ((SubLObject) (listS(CLET, list(list(element_num, i)), append(body, NIL)))) : bq_cons(PROGN, append(body, NIL)), list(CINC, i)))), list(PWHEN, doneP, list(CSETQ, done_varP, doneP))))));
                            }
                        }
                    }
                }
