...
public final class removal_modules_negationpreds extends SubLTranslatedFile implements V12 {
    ...
    static private final SubLList $list6 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell("negationPreds"), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell("negationPreds"), $FORT, $FORT), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-NEGATIONPREDS-CHECK-COST*"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-NEGATIONPREDS-CHECK-EXPAND") });

    private static final SubLSymbol $REMOVAL_MAX_NEGATIONPREDS = makeKeyword("REMOVAL-MAX-NEGATIONPREDS");

    static private final SubLList $list8 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell("negationPreds"), makeKeyword("REQUIRED-PATTERN"), list(makeKeyword("OR"), list(reader_make_constant_shell("negationPreds"), $FORT, makeKeyword("VARIABLE")), list(reader_make_constant_shell("negationPreds"), makeKeyword("VARIABLE"), $FORT)), $COST, makeSymbol("REMOVAL-MAX-NEGATIONPREDS-COST"), makeKeyword("COMPLETENESS"), makeKeyword("GROSSLY-INCOMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-MAX-NEGATIONPREDS-EXPAND") });

    private static final SubLSymbol $MAX_NEGATION_PREDS_POS = makeKeyword("MAX-NEGATION-PREDS-POS");

    private static final SubLList $list10 = list(makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell("negationPreds"), makeKeyword("REQUIRED-PATTERN"), list(makeKeyword("OR"), list(reader_make_constant_shell("negationPreds"), $FORT, makeKeyword("NOT-FULLY-BOUND")), list(reader_make_constant_shell("negationPreds"), makeKeyword("NOT-FULLY-BOUND"), $FORT)), makeKeyword("PREFERENCE-LEVEL"), makeKeyword("GROSSLY-DISPREFERRED"));

    private static final SubLSymbol $REMOVAL_NOT_NEGATIONPREDS_CHECK = makeKeyword("REMOVAL-NOT-NEGATIONPREDS-CHECK");

    private static final SubLList $list13 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell("negationPreds"), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell("negationPreds"), $FORT, $FORT), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-NOT-NEGATIONPREDS-CHECK-COST*"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-NOT-NEGATIONPREDS-CHECK-EXPAND") });

    public static final SubLObject removal_negationpreds_check_expand_alt(SubLObject literal, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
    ...
    public static final SubLObject removal_max_negationpreds_cost_alt(SubLObject literal, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
    ...
    public static final SubLObject removal_max_negationpreds_expand_alt(SubLObject literal, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                ...
                SubLObject disjoint_terms = negation_predicate.max_negation_predicates(fort, UNPROVIDED);
                        ...
                        if (NIL != v_bindings) {
                            {
                                ...
                                SubLObject hl_support_formula = backward_utilities.inference_make_commutative_literal($$negationPreds, literal_args(subst_literal, UNPROVIDED));
    ...
    public static final SubLObject removal_not_negationpreds_check_expand_alt(SubLObject literal, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
    ...
    static private final SubLList $list_alt4 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell("negationPreds"), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell("negationPreds"), $FORT, $FORT), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-NEGATIONPREDS-CHECK-COST*"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-NEGATIONPREDS-CHECK-EXPAND") });
    ...
    static private final SubLList $list_alt6 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell("negationPreds"), makeKeyword("REQUIRED-PATTERN"), list(makeKeyword("OR"), list(reader_make_constant_shell("negationPreds"), $FORT, makeKeyword("VARIABLE")), list(reader_make_constant_shell("negationPreds"), makeKeyword("VARIABLE"), $FORT)), $COST, makeSymbol("REMOVAL-MAX-NEGATIONPREDS-COST"), makeKeyword("COMPLETENESS"), makeKeyword("GROSSLY-INCOMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-MAX-NEGATIONPREDS-EXPAND") });

    public static final SubLObject setup_removal_modules_negationpreds_file_alt() {
        inference_modules.register_solely_specific_removal_module_predicate($$negationPreds);
        inference_modules.inference_removal_module($REMOVAL_NEGATIONPREDS_CHECK, $list_alt4);
        inference_modules.inference_removal_module($REMOVAL_MAX_NEGATIONPREDS, $list_alt6);
        preference_modules.inference_preference_module($MAX_NEGATION_PREDS_POS, $list_alt8);
        inference_modules.inference_removal_module($REMOVAL_NOT_NEGATIONPREDS_CHECK, $list_alt11);
        return NIL;
    }
    ...
    public static SubLObject setup_removal_modules_negationpreds_file_Previous() {
        inference_modules.register_solely_specific_removal_module_predicate($$negationPreds);
        preference_modules.doomed_unless_either_arg_bindable($POS, $$negationPreds);
        preference_modules.doomed_unless_all_args_bindable($NEG, $$negationPreds);
        inference_modules.inference_removal_module($REMOVAL_NEGATIONPREDS_CHECK, $list6);
    ...
    static private final SubLList $list_alt8 = list(makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell("negationPreds"), makeKeyword("REQUIRED-PATTERN"), list(makeKeyword("OR"), list(reader_make_constant_shell("negationPreds"), $FORT, makeKeyword("NOT-FULLY-BOUND")), list(reader_make_constant_shell("negationPreds"), makeKeyword("NOT-FULLY-BOUND"), $FORT)), makeKeyword("PREFERENCE-LEVEL"), makeKeyword("GROSSLY-DISPREFERRED"));
    ...
    static private final SubLList $list_alt11 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell("negationPreds"), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell("negationPreds"), $FORT, $FORT), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-NOT-NEGATIONPREDS-CHECK-COST*"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-NOT-NEGATIONPREDS-CHECK-EXPAND") });
}
