      ...
      SubLTranslatedFile
{
  ...
  {
    $constant_index_manager$.setGlobalValue( kb_object_manager.new_kb_object_manager( $str3$constant_index, size, $constant_index_lru_size_percentage$.getGlobalValue(), $constant_index_lru_size_max$.getGlobalValue(),
        $sym4$LOAD_CONSTANT_INDEX_FROM_CACHE, exactP ) );
    return T;
  }
  ...
  public static SubLObject lookup_constant_index(final SubLObject id)
  {
    ...
    try
    {
      kb_storage_logging.$kb_storage_client$.bind( kb_storage_logging.add_kb_storage_logging_add_tag( $kw5$CIM ), thread );
  ...
  {
    final SubLObject result = kb_object_manager.initialize_kb_object_hl_store_cache( $constant_index_manager$.getGlobalValue(), $str9$indices, $str10$indices_index, $str11$constant_complex_indices,
        $str12$constant_complex_indices_index );
    kb_storage_logging.register_kb_storage_logging_tag( kb_object_manager.kb_object_manager_file_vector( $constant_index_manager$.getGlobalValue() ), $str13$cim );
    ...
    {
      kb_storage_logging.register_kb_storage_logging_tag( sub_fvector, $str14$ccim );
      file_vector_utilities.register_indexical_file_vector_reference( $kw15$CONSTANT_INDEX, sub_fvector );
    }
    return result;
  }
  ...
  {
    SubLFiles.declareFunction(me, "setup_constant_index_table", "SETUP-CONSTANT-INDEX-TABLE", 2, 0, false );
    SubLFiles.declareFunction(me, "resize_constant_index_kbom_lru", "RESIZE-CONSTANT-INDEX-KBOM-LRU", 0, 2, false );
    SubLFiles.declareFunction(me, "optimize_constant_index_table", "OPTIMIZE-CONSTANT-INDEX-TABLE", 1, 0, false );
    SubLFiles.declareFunction(me, "clear_constant_index_table", "CLEAR-CONSTANT-INDEX-TABLE", 0, 0, false );
    SubLFiles.declareFunction(me, "maintain_constant_index_usage_counts", "MAINTAIN-CONSTANT-INDEX-USAGE-COUNTS", 0, 0, false );
    SubLFiles.declareFunction(me, "dont_maintain_constant_index_usage_counts", "DONT-MAINTAIN-CONSTANT-INDEX-USAGE-COUNTS", 0, 0, false );
    SubLFiles.declareFunction(me, "constant_index_usage_counts_enabled_p", "CONSTANT-INDEX-USAGE-COUNTS-ENABLED-P", 0, 0, false );
    SubLFiles.declareFunction(me, "cached_constant_index_count", "CACHED-CONSTANT-INDEX-COUNT", 0, 0, false );
    SubLFiles.declareFunction(me, "constant_indices_completely_cachedP", "CONSTANT-INDICES-COMPLETELY-CACHED?", 0, 0, false );
    SubLFiles.declareFunction(me, "lookup_constant_index", "LOOKUP-CONSTANT-INDEX", 1, 0, false );
    SubLFiles.declareFunction(me, "constant_index_cachedP", "CONSTANT-INDEX-CACHED?", 1, 0, false );
    SubLFiles.declareFunction(me, "get_file_backed_constant_internal_id_threshold", "GET-FILE-BACKED-CONSTANT-INTERNAL-ID-THRESHOLD", 0, 0, false );
    SubLFiles.declareFunction(me, "new_muted_constant_index_iterator", "NEW-MUTED-CONSTANT-INDEX-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction(me, "constant_index_dont_maintain_usages_counts", "CONSTANT-INDEX-DONT-MAINTAIN-USAGES-COUNTS", 0, 0, false );
    SubLFiles.declareFunction(me, "constant_index_maintain_usage_counts", "CONSTANT-INDEX-MAINTAIN-USAGE-COUNTS", 0, 0, false );
    SubLFiles.declareFunction(me, "constant_index_usage_counts_enabledP", "CONSTANT-INDEX-USAGE-COUNTS-ENABLED?", 0, 0, false );
    SubLFiles.declareFunction(me, "constant_indexchange_stream_buffer_sizes", "CONSTANT-INDEXCHANGE-STREAM-BUFFER-SIZES", 2, 0, false );
    SubLFiles.declareFunction(me, "constant_index_enable_memory_mapping", "CONSTANT-INDEX-ENABLE-MEMORY-MAPPING", 0, 0, false );
    SubLFiles.declareFunction(me, "constant_index_memory_mappedP", "CONSTANT-INDEX-MEMORY-MAPPED?", 0, 0, false );
    SubLFiles.declareMacro(me, "with_constant_index_fully_loaded", "WITH-CONSTANT-INDEX-FULLY-LOADED" );
    SubLFiles.declareFunction(me, "register_constant_index", "REGISTER-CONSTANT-INDEX", 2, 0, false );
    SubLFiles.declareFunction(me, "deregister_constant_index", "DEREGISTER-CONSTANT-INDEX", 1, 0, false );
    SubLFiles.declareFunction(me, "mark_constant_index_as_muted", "MARK-CONSTANT-INDEX-AS-MUTED", 1, 0, false );
    SubLFiles.declareFunction(me, "mark_constant_index_as_permanently_cached", "MARK-CONSTANT-INDEX-AS-PERMANENTLY-CACHED", 1, 0, false );
    SubLFiles.declareFunction(me, "meter_constant_index_swap_time", "METER-CONSTANT-INDEX-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction(me, "dont_meter_constant_index_swap_time", "DONT-METER-CONSTANT-INDEX-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction(me, "clear_constant_index_swap_time", "CLEAR-CONSTANT-INDEX-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction(me, "current_constant_index_swap_time", "CURRENT-CONSTANT-INDEX-SWAP-TIME", 0, 0, false );
    SubLFiles.declareFunction(me, "swap_out_all_pristine_constant_indices", "SWAP-OUT-ALL-PRISTINE-CONSTANT-INDICES", 0, 0, false );
    SubLFiles.declareFunction(me, "initialize_constant_index_hl_store_cache", "INITIALIZE-CONSTANT-INDEX-HL-STORE-CACHE", 0, 0, false );
    SubLFiles.declareFunction(me, "wide_constant_index_hl_store_cacheP", "WIDE-CONSTANT-INDEX-HL-STORE-CACHE?", 0, 0, false );
    SubLFiles.declareFunction(me, "wide_constant_complex_index_hl_store_cacheP", "WIDE-CONSTANT-COMPLEX-INDEX-HL-STORE-CACHE?", 0, 0, false );
    return NIL;
  }

  public static SubLObject init_constant_index_manager_file()
  {
    $constant_index_manager$ = SubLFiles.deflexical( "*CONSTANT-INDEX-MANAGER*", ( maybeDefault( $sym0$_CONSTANT_INDEX_MANAGER_, $constant_index_manager$, $kw1$UNINITIALIZED ) ) );
    $constant_index_lru_size_percentage$ = SubLFiles.deflexical( "*CONSTANT-INDEX-LRU-SIZE-PERCENTAGE*", SIXTEEN_INTEGER );
    $constant_index_lru_size_max$ = SubLFiles.deflexical( "*CONSTANT-INDEX-LRU-SIZE-MAX*", $int2$20000 );
    return NIL;
  }
  ...
  static
  {
    me = new constant_index_manager();
    $constant_index_manager$ = null;
    $constant_index_lru_size_percentage$ = null;
    $constant_index_lru_size_max$ = null;
    $sym0$_CONSTANT_INDEX_MANAGER_ = makeSymbol( "*CONSTANT-INDEX-MANAGER*" );
    $kw1$UNINITIALIZED = makeKeyword( "UNINITIALIZED" );
    $int2$20000 = makeInteger( 20000 );
    $str3$constant_index = makeString( "constant-index" );
    $sym4$LOAD_CONSTANT_INDEX_FROM_CACHE = makeSymbol( "LOAD-CONSTANT-INDEX-FROM-CACHE" );
    $kw5$CIM = makeKeyword( "CIM" );
    $sym6$_EXIT = makeSymbol( "%EXIT" );
    $sym7$WITH_KBOM_FULLY_LOADED = makeSymbol( "WITH-KBOM-FULLY-LOADED" );
    $list8 = ConsesLow.list( makeSymbol( "*CONSTANT-INDEX-MANAGER*" ) );
    $str9$indices = makeString( "indices" );
    $str10$indices_index = makeString( "indices-index" );
    $str11$constant_complex_indices = makeString( "constant-complex-indices" );
    $str12$constant_complex_indices_index = makeString( "constant-complex-indices-index" );
    $str13$cim = makeString( "cim" );
    $str14$ccim = makeString( "ccim" );
    $kw15$CONSTANT_INDEX = makeKeyword( "CONSTANT-INDEX" );
  }
}
