 ...
 * <code>BorderLayout</code> and place <code>JAutoResizingTextArea</code> to the north or south side. Similarly, you can
...
public class JAutoResizingTextArea extends JEditorPane {
	...
	/**
	 * Create a new <code>JAutoResizingTextArea</code> with a height bounded by the provided minimum and maximum row
	...
	/**
	 * Create a new <code>JAutoResizingTextArea</code> using a <code>Document</code>. The document will be set to the
	...
	/**
	 * Constructs a new <code>JAutoResizingTextArea</code> with the specified number of rows and columns, and the given
