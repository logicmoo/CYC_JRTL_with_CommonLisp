...
public interface KBFunction extends Relation {
   ...
   * <code>KBFunction</code>. If no corresponding term exists in the Cyc KB, one
   * will be created.
   * <p>
   ...
   *
   * The
   * <code>O</code> parameter determines what class the returned Object
   * will be. For example, if creating
   * <code>(#$FruitFn #$AppleTree)</code>, the <code>O</code> should be
   ...
   *
   * @param retType	the class of type <code>O</code>, whose object instance is generated 
   * by this function. Must be a subclass of KBObject.
   * @param args	An array of arguments for the new functional term. Arguments
   * may include any subclass of KBObject and Java Language native objects, String, Number and Date.
   *
   ...
   *
   * @throws UnsupportedOperationException as a catch all, but normally should not happen
   * with KB API objects.
   */
   ...
   * <code>KBFunction</code> from the default context specified by {@link KBAPIDefaultContext#forQuery()}.
   *  Any functional term using this
   * <code>KBFunction</code> will be an instance of each of these Collections. The 
   * set of collections defines the Range of this function.
   * <p>
   *
   * @return	all <code>#$resultIsa</code> collections for
   * this <code>KBFunction</code>.
   */
  public Collection<KBCollection> getResultIsa();

  /**
   * Returns the
   * <code>#$resultIsa</code>as of this
   * <code>KBFunction</code> from the context <code>ctx</code>. Any functional term using this
   * <code>KBFunction</code> will be an instance of each of these Collections. The 
   * set of collections defines the Range of this function.
   * <p>
   *
   ...
   * Returns the
   * <code>#$resultIsa</code>s of this
   * <code>KBFunction</code> from the context. Any functional term using this
   * <code>KBFunction</code> will be an instance of each of these Collections.  The 
   * set of collections defines the Range of this function.
   * <p>
   *
   ...
   * <code>KBFunction</code> from the default context specified by {@link KBAPIDefaultContext#forQuery()}.
   * Any functional term using this
   * <code>KBFunction</code> will be a specialization of each of these
   * <code>KBCollection</code>s. The set of collections defines the Range of this
   * function.
   * <p>
   *
