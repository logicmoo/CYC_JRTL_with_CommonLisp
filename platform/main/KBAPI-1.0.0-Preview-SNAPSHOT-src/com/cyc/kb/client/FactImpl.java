 ...
 * 
 * @author Vijay Raj
 * @version $Id: FactImpl.java 151340 2014-05-19 15:55:29Z vijay $
 * @since 1.0
 */
...
public class FactImpl extends AssertionImpl implements Fact {
   ...
   */
  public FactImpl(String ctxStr, String factStr) throws KBApiException {
   ...
   * @throws KBApiException
   */
  public FactImpl(Context ctx, KBPredicate pred, Object... argList)
      throws KBApiException {
   ...
   * @throws KBApiException
   */
  public FactImpl(Context ctx, Sentence sentence) throws KBApiException {
  ...
  @SuppressWarnings("deprecation")
public FactImpl(boolean findOnly, Context ctx, KBPredicate pred, Object... argList)
      throws KBApiException {
    super();
    try {
      ...
      if (findOnly == false
          && (ctx.equals(Constants.everythingPSCMt()) || ctx.equals(Constants
              .inferencePSCMt()))) {
        findOnly = true;
        log.warning("Overriding 'findOnly' flag to true because Context is either EverythingPSC or InferencePSC");
      }
      ...
      // one...
      log.log(Level.FINE, "fact Sentence: {0}", factSentence);
  ...
  @SuppressWarnings("deprecation")
public FactImpl(boolean findOnly, Context ctx, Sentence factSentence)
      throws KBApiException {
    super();
    try {
      // Turn on the findOnly flag when Context is #$EverythingPSC or
...
public static FactImpl findOrCreate(Sentence formula, Context ctx, Strength s, Direction d) 
  ...
  public void delete() throws DeleteException {
    ...
    try {
      CycAccessManager.get().getCurrentAccess().getUnassertTool().unassertGaf(sentence, mt, true,
    ...
    try {
      if (findAssertion(sentence, CycAccessManager.get().getCurrentAccess().getObjectTool().makeELMt(mt)) instanceof CycAssertion) {
  ...
  public String toString() {
    ...
    if (ca.isGaf()) {
      retStr = "(ist " + ca.getMt().toString() + " " + ca.getGaf().toString()
          + ")";
      log.log(Level.FINE, "String API value of CycAssertion: {0}",
          ca.stringApiValue());
    } else {
  ...
  /**
   * This is not part of the KB API. Check that the candidate core object is
  ...
  /**
   * returns string "#$CycLGAFAssertion"
   */
  @Override
