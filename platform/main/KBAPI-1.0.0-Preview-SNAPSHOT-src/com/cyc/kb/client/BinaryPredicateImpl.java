 ...
 * 
 * @author Vijay Raj
 * @version $Id: BinaryPredicateImpl.java 151340 2014-05-19 15:55:29Z vijay $
 */
public class BinaryPredicateImpl extends KBPredicateImpl implements BinaryPredicate {
  ...
  private static final DenotationalTerm TYPE_CORE =
          new CycConstant("BinaryPredicate", new Guid("bd588102-9c29-11b1-9dad-c379636f7270"));
   ...
   * requested to be cast as an intance of BinaryPredicate.
   *
  ...
  /**
   * This is not part of the KB API. finds or creates an instance of #$BinaryPredicate represented
  ...
  /**
   * This is not part of the KB API. finds or creates; or finds an instance of #$BinaryPredicate
  ...
  public static KBStatus getStatus(CycObject object) {
    return KBObjectFactory.getStatus(object, BinaryPredicateImpl.class);
  }
