 ...
 *
 * @author Vijay Raj
 * @version	$Id: KBFunctionImpl.java 151340 2014-05-19 15:55:29Z vijay $
 */
  // @TODO: Add examples
public class KBFunctionImpl extends RelationImpl implements KBFunction {

  static final Logger log = Logger.getLogger(KBFunctionImpl.class.getName());
   ...
   * requested to be cast as an intance of KBFunction.
   *
  ...
  /**
   * This is not part of the KB API. finds or creates an instance of #$Function-Denotational represented
  ...
  /**
   * This is not part of the KB API. finds or creates; or finds an instance of #$Function-Denotational
   ...
   * @throws CreateException 
   */
  public static KBFunctionImpl findOrCreate(String nameOrId, KBCollection constraintCol, ContextImpl ctx) 
   ...
   * @throws CreateException 
   */
  public static KBFunctionImpl findOrCreate(String nameOrId, String constrainColStr, String ctxStr) throws CreateException, KBTypeException {
    return KBObjectFactory.findOrCreate(nameOrId, constrainColStr, ctxStr, KBFunctionImpl.class);
  }
...
//      LOG.fine("Cyclified Fort String: " + cyclifiedStr);
      ...
      CycObject co = null;
      if (this.isInstanceOf(KBCollectionImpl.get("ReifiableFunction"), Constants.uvMt())) {
        co = new CycNart(natArgs);
        ((Nart) co).ensureReified();
      } else {
  ...
  public Collection<KBCollection> getResultIsa(String ctxStr) {
    return (this.<KBCollection>getValues("resultIsa", 1, 2, ctxStr));
  }
  ...
  public Collection<KBCollection> getResultGenl(String ctxStr) {
    return (this.<KBCollection>getValues("resultGenl", 1, 2, ctxStr));
  }
  ...
  public KBFunction addResultGenl(String colStr, String ctxStr) throws KBTypeException, CreateException {
    KBCollection c = KBCollectionImpl.get(colStr);
    return addResultGenl(c, ContextImpl.get(ctxStr));
  }
