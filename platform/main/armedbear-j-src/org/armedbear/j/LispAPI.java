...
public final class LispAPI extends Lisp {
	...
	public static final Editor checkEditor(LispObject obj) throws ConditionThrowable {
		if (obj == null)
			throw new NullPointerException();
		try {
			return (Editor) ((JavaObject) obj).getObject();
		} catch (ClassCastException e) {
			error(new TypeError("The value " + obj.printObject() + " is not an editor."));
			// Not reached.
			return null;
		}
	}

	public static final Buffer checkBuffer(LispObject obj) throws ConditionThrowable {
		if (obj == null)
			throw new NullPointerException();
		if (obj == NIL)
		...
		try {
			...
			error(new TypeError("The value " + obj.printObject() + " is not a buffer."));
			// Not reached.
			return null;
		}
	}

	public static final KeyMap checkKeymap(LispObject obj) throws ConditionThrowable {
		if (obj == null)
			throw new NullPointerException();
		try {
			return (KeyMap) ((JavaObject) obj).getObject();
		} catch (ClassCastException e) {
			error(new TypeError("The value " + obj.printObject() + " is not a keymap."));
			// Not reached.
			return null;
		}
	}

	private static final Position checkMark(LispObject obj) throws ConditionThrowable {
		if (obj == null)
			throw new NullPointerException();
		try {
			return (Position) ((JavaObject) obj).getObject();
		} catch (ClassCastException e) {
			error(new TypeError("The value " + obj.printObject() + " is not a mark."));
			// Not reached.
			return null;
		}
	}

	public static final Line checkLine(LispObject obj) throws ConditionThrowable {
		if (obj == null)
			throw new NullPointerException();
		try {
			return (Line) ((JavaObject) obj).getObject();
		} catch (ClassCastException e) {
			error(new TypeError("The value " + obj.printObject() + " is not a line."));
			// Not reached.
			return null;
		}
	}
	...
	// ### current-editor
	private static final Primitive CURRENT_EDITOR = new Primitive("current-editor", PACKAGE_J, true, "", "Returns the current editor as a Lisp object.") {
		@Override
	...
	// ### %set-current-editor
	private static final Primitive _SET_CURRENT_EDITOR = new Primitive("%set-current-editor", PACKAGE_J, false, "(EDITOR)", "Makes EDITOR the current editor.") {
		@Override
	...
	// ### buffer-pathname
	private static final Primitive BUFFER_PATHNAME = new Primitive("buffer-pathname", PACKAGE_J, true, "&optional buffer") {
		@Override
	...
	// ### buffer-substring
	private static final Primitive BUFFER_SUBSTRING = new Primitive("buffer-substring", PACKAGE_J, true, "start end &optional buffer") {
		@Override
		public LispObject execute(LispObject first, LispObject second) throws ConditionThrowable {
	...
	private static final Primitive BUFFER_OFFSET = new Primitive("buffer-offset", PACKAGE_J, true, "mark &optional buffer") {
		@Override
		public LispObject execute(LispObject arg) throws ConditionThrowable {
	...
	private static final Primitive MOVE_TO_POSITION = new Primitive("move-to-position", PACKAGE_J, true, "mark charpos &optional line") {
		@Override
		public LispObject execute(LispObject mark, LispObject charpos) throws ConditionThrowable {
		...
		@Override
		public LispObject execute(LispObject mark, LispObject charpos, LispObject line) throws ConditionThrowable {
			Position pos = checkMark(mark);
			if (line == NIL)
				pos.setOffset(Fixnum.getValue(charpos));
			else
	...
	private static final Primitive FORWARD_CHAR = new Primitive("forward-char", PACKAGE_J, true, "mark &optional count") {
		@Override
		public LispObject execute(LispObject arg) throws ConditionThrowable {
	...
	private static final Primitive BACKWARD_CHAR = new Primitive("backward-char", PACKAGE_J, true, "mark &optional count") {
		@Override
		public LispObject execute(LispObject arg) throws ConditionThrowable {
			Position pos = checkMark(arg);
			return forwardChar(pos, -1);
	...
	private static final LispObject forwardChar(Position pos, int n) throws ConditionThrowable {
		if (n != 0) {
			if (pos != null) {
				if (n > 0) {
					while (n-- > 0) {
	...
	private static final Primitive DEFINE_KEY = new Primitive("define-key", PACKAGE_J, true, "keymap key-designator definition") {
		@Override
		public LispObject execute(LispObject first, LispObject second, LispObject third) throws ConditionThrowable {
	...
	private static final Primitive MAP_KEY_FOR_MODE = new Primitive("map-key-for-mode", PACKAGE_J, true, "key command mode") {
		@Override
		public LispObject execute(LispObject first, LispObject second, LispObject third) throws ConditionThrowable {
			String keyText = first.getStringValue();
			Object command;
	...
	private static final Primitive UNMAP_KEY_FOR_MODE = new Primitive("unmap-key-for-mode", PACKAGE_J, true, "key mode") {
		@Override
		public LispObject execute(LispObject first, LispObject second) throws ConditionThrowable {
			String keyText = first.getStringValue();
	...
	// ### set-global-property
	private static final Primitive SET_GLOBAL_PROPERTY = new Primitive("set-global-property", PACKAGE_J, true, "key value") {
		@Override
		public LispObject execute(LispObject first, LispObject second) throws ConditionThrowable {
			...
			if (property.isBooleanProperty()) {
				setProperty(property, (second == NIL) ? "false" : "true");
				return second;
			}
			if (property.isIntegerProperty()) {
				if (second instanceof Fixnum) {
					setProperty(property, String.valueOf(((Fixnum) second).value));
					return second;
				}
				if (second instanceof AbstractString) {
					int value;
					try {
						...
						return error(new LispError(second.printObject() + " cannot be converted to a Java integer."));
					}
	...
	// ### set-mode-property
	private static final Primitive SET_MODE_PROPERTY = new Primitive("set-mode-property", PACKAGE_J, true, "key value mode") {
		@Override
		public LispObject execute(LispObject first, LispObject second, LispObject third) throws ConditionThrowable {
			...
			if (mode == null)
				return error(new LispError(third.printObject() + " does not designate any mode."));
			Property property = Property.findProperty(key);
			if (property == null)
				// Not an advertised property.
				return error(new LispError(first.printObject() + " does not designate any property."));
			if (property.isBooleanProperty()) {
	...
	// ### set-buffer-property
	private static final Primitive SET_BUFFER_PROPERTY = new Primitive("set-buffer-property", PACKAGE_J, true, "key value &optional buffer") {
		@Override
		public LispObject execute(LispObject first, LispObject second) throws ConditionThrowable {
			return execute(first, second, createJavaObject(Editor.currentEditor().getBuffer()));
		}
	...
	private static final Primitive GET_GLOBAL_PROPERTY = new Primitive("get-global-property", PACKAGE_J, true, "key") {
		...
		public LispObject execute(LispObject arg) throws ConditionThrowable {
			...
			if (property == null) {
				// Not an advertised property.
				return error(new LispError(arg.printObject() + " does not designate a property."));
			}
			if (property.isBooleanProperty())
	...
	private static final Primitive GET_BUFFER_PROPERTY = new Primitive("get-buffer-property", PACKAGE_J, true, "key &optional buffer") {
		@Override
		public LispObject execute(LispObject arg) throws ConditionThrowable {
			return execute(arg, createJavaObject(Editor.currentEditor().getBuffer()));
		}
	...
	private static final Primitive END_COMPOUND_EDIT = new Primitive("end-compound-edit", PACKAGE_J, false) {
		...
		public LispObject execute(LispObject arg) throws ConditionThrowable {
			try {
				...
				return error(new LispError(arg.printObject() + " does not designate a compound edit."));
			}
		}
	};
	...
	// ### get-last-event-time
	private static final Primitive GET_LAST_EVENT_INTERNAL_TIME = new Primitive("get-last-event-internal-time", PACKAGE_J, true) {
		@Override
		public LispObject execute() throws ConditionThrowable {
	...
	public static void invokeOpenFileHook(Buffer buffer) {
		try {
			if (INVOKE_HOOK.fboundp())
				Primitives.FUNCALL.execute(INVOKE_HOOK, PACKAGE_J.intern("OPEN-FILE-HOOK"), createJavaObject(buffer));
		} catch (Throwable t) {
			Log.debug(t);
		}
	}
	...
	public static void invokeBufferActivatedHook(Buffer buffer) {
		if (buffer != null) {
			try {
				if (INVOKE_HOOK.fboundp())
					Primitives.FUNCALL.execute(INVOKE_HOOK, PACKAGE_J.intern("BUFFER-ACTIVATED-HOOK"), createJavaObject(buffer));
			} catch (Throwable t) {
				Log.debug(t);
			}
		}
	...
	public static void invokeAfterSaveHook(Buffer buffer) {
		try {
			if (INVOKE_HOOK.fboundp())
				Primitives.FUNCALL.execute(INVOKE_HOOK, PACKAGE_J.intern("AFTER-SAVE-HOOK"), createJavaObject(buffer));
		} catch (Throwable t) {
			Log.debug(t);
		}
	}
	...
	public static void invokeLispShellStartupHook(Buffer buffer, String command) {
		try {
			if (INVOKE_HOOK.fboundp())
				Primitives.FUNCALL.execute(INVOKE_HOOK, PACKAGE_J.intern("LISP-SHELL-STARTUP-HOOK"), createJavaObject(buffer), new SimpleString(command));
		} catch (Throwable t) {
			Log.debug(t);
		}
	}
	...
	private static final Primitive BUFFER_STREAM_BUFFER = new Primitive("buffer-stream-buffer", PACKAGE_J, true) {
		...
		public LispObject execute(LispObject arg) throws ConditionThrowable {
			...
			return error(new LispError(arg.printObject() + "does not designate a buffer stream."));
		}
	};
	...
	private static final Primitive SET_BUFFER_MODIFIED_P = new Primitive("set-buffer-modified-p", PACKAGE_J, true, "buffer flag") {
		@Override
		public LispObject execute(LispObject first, LispObject second) throws ConditionThrowable {
	...
	// ### %search
	private static final Primitive _SEARCH = new Primitive("%search", PACKAGE_J, false, "pattern direction regexp-p buffer start ignore-case-p whole-words-only-p") {
		@Override
		public LispObject execute(LispObject[] args) throws ConditionThrowable {
			if (args.length != 7)
	...
	private static final Primitive FIND_BEGINNING_OF_DEFUN = new Primitive("find-beginning-of-defun", PACKAGE_J, true, "&optional mark") {
		@Override
		public LispObject execute() throws ConditionThrowable {
