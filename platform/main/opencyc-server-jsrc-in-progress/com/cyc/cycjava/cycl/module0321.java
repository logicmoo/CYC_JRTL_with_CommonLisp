...
public final class module0321 extends SubLTranslatedFile
{
    ...
    public static SubLObject f21631(final SubLObject var1, final SubLObject var2) {
        f21632(var1, var2, (SubLObject)ZERO_INTEGER);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f21633(final SubLObject var1) {
        return (SubLObject)((var1.getClass() == $sX24186_native.class) ? T : NIL);
    }
    
    public static SubLObject f21634(final SubLObject var1) {
        assert NIL != f21633(var1) : var1;
    ...
    public static SubLObject f21659(final SubLObject var11, final SubLObject var12) {
        ...
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic33$, f21634(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic34$, f21635(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic35$, f21636(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic36$, f21637(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic37$, f21638(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic38$, f21639(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic39$, f21640(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic40$, f21641(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic41$, f21642(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic42$, f21643(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic43$, f21644(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic48$, (SubLObject)$ic44$, f21645(var11));
    ...
    public static SubLObject f21632(final SubLObject var13, final SubLObject var2, final SubLObject var14) {
        ...
        if (NIL != print_high.$print_readably$.getDynamicValue(var15)) {
            ...
            PrintLow.write((SubLObject)Types.type_of(var13), new SubLObject[] { $ic52$, var2 });
            streams_high.write_char((SubLObject)Characters.CHAR_space, var2);
            PrintLow.write(Equality.pointer(var13), new SubLObject[] { $ic52$, var2, $ic53$, SIXTEEN_INTEGER });
    ...
    public static SubLObject f21661(final SubLObject var19, final SubLObject var20, final SubLObject var21) {
        ...
        final SubLObject var23 = $g2817$.getDynamicValue(var22);
        ...
        f21652(var23, module0067.f4880((SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
        f21653(var23, module0067.f4880(Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED));
        f21654(var23, var20);
    ...
    public static SubLObject f21683(final SubLObject var29, final SubLObject var30) {
        ...
        return (SubLObject)ConsesLow.listS((SubLObject)$ic54$, (SubLObject)$ic55$, ConsesLow.append(var33, (SubLObject)NIL));
    }
    
    public static SubLObject f21684() {
        final SubLThread var15 = SubLProcess.currentSubLThread();
        return f21667($g2817$.getDynamicValue(var15));
    }
    
    public static SubLObject f21685() {
        final SubLThread var15 = SubLProcess.currentSubLThread();
        return f21671($g2817$.getDynamicValue(var15));
    }
    ...
    public static SubLObject f21699(final SubLObject var38, final SubLObject var39) {
        ...
        SubLObject var42 = module0067.f4884(f21697(), var41, (SubLObject)UNPROVIDED);
        if (NIL != var42) {
            return var42;
        }
        ...
        if (NIL != $g2818$.getDynamicValue(var40)) {
            f21698(var41, var42);
        }
        return var42;
    }
    ...
    public static SubLObject f21700() {
        final SubLThread var15 = SubLProcess.currentSubLThread();
        return f21677($g2817$.getDynamicValue(var15));
    }
    
    public static SubLObject f21701(final SubLObject var42) {
        final SubLThread var43 = SubLProcess.currentSubLThread();
        f21657($g2817$.getDynamicValue(var43), ConsesLow.nconc(var42, f21700()));
        return (SubLObject)NIL;
    }
    
    public static SubLObject f21664(final SubLObject var19) {
        SubLObject var20 = (SubLObject)NIL;
        SubLObject var21 = module0035.f2160(module0202.f12728(var19, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED).rest();
        SubLObject var22 = (SubLObject)NIL;
        var22 = var21.first();
        while (NIL != var21) {
            if (NIL != module0193.f12105(module0205.f13384(var19, var22, (SubLObject)UNPROVIDED))) {
    ...
    public static SubLObject f21665(final SubLObject var19) {
        ...
        var22 = var21.first();
        while (NIL != var21) {
            if (NIL != module0206.f13500(module0205.f13384(var19, var22, (SubLObject)UNPROVIDED))) {
                var20 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list(module0205.f13384(var19, var22, (SubLObject)UNPROVIDED), var22), var20);
            }
            var21 = var21.rest();
            var22 = var21.first();
        }
    ...
    public static SubLObject f21666(final SubLObject var19) {
        if (NIL != module0193.f12105(var19)) {
            return module0288.f19338(var19, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f21662(final SubLObject var19) {
        final SubLObject var20 = module0202.f12725(var19, (SubLObject)UNPROVIDED);
        final SubLObject var21 = Vectors.make_vector(var20, (SubLObject)UNPROVIDED);
        SubLObject var22;
        for (var22 = (SubLObject)NIL, var22 = (SubLObject)ZERO_INTEGER; var22.numL(var20); var22 = Numbers.add(var22, (SubLObject)ONE_INTEGER)) {
            Vectors.set_aref(var21, var22, module0205.f13384(var19, Numbers.add((SubLObject)ONE_INTEGER, var22), (SubLObject)UNPROVIDED));
        }
        return var21;
    }
    ...
    public static SubLObject f21702(final SubLObject var19, SubLObject var49, SubLObject var50, SubLObject var51, SubLObject var52, SubLObject var53, SubLObject var54) {
        ...
        if (NIL != var57) {
            ...
            final SubLObject var63 = $g2817$.currentBinding(var55);
            try {
                ...
                $g2817$.bind(f21658((SubLObject)UNPROVIDED), var55);
                f21661(var19, var50, var51);
                try {
                    var55.throwStack.push($ic58$);
                    ...
                    try {
                        module0141.$g1670$.bind(module0137.f8955($ic59$), var55);
                        module0141.$g1671$.bind(module0244.f15739(module0137.f8955($ic59$)), var55);
                        module0141.$g1672$.bind(module0244.f15746(module0137.f8955($ic59$)), var55);
                        module0141.$g1674$.bind((SubLObject)NIL, var55);
                        module0137.$g1605$.bind(module0137.f8955($ic59$), var55);
                        ...
                        try {
                            ...
                            try {
                                module0141.$g1714$.bind((NIL != var66) ? var66 : module0141.f9283(), var55);
                                module0141.$g1715$.bind((SubLObject)((NIL != var66) ? $ic60$ : module0141.$g1715$.getDynamicValue(var55)), var55);
                                if (NIL != var66 && NIL != module0136.f8864() && NIL == module0141.f9279(var66)) {
                                    ...
                                    if (var67.eql((SubLObject)$ic61$)) {
                                        module0136.f8870((SubLObject)ONE_INTEGER, (SubLObject)$ic62$, var66, (SubLObject)$ic63$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                    }
                                    else if (var67.eql((SubLObject)$ic64$)) {
                                        module0136.f8871((SubLObject)ONE_INTEGER, (SubLObject)$ic65$, (SubLObject)$ic62$, var66, (SubLObject)$ic63$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                    }
                                    else if (var67.eql((SubLObject)$ic66$)) {
                                        Errors.warn((SubLObject)$ic62$, var66, (SubLObject)$ic63$);
                                    }
                                    else {
                                        Errors.warn((SubLObject)$ic67$, module0136.$g1591$.getDynamicValue(var55));
                                        Errors.cerror((SubLObject)$ic65$, (SubLObject)$ic62$, var66, (SubLObject)$ic63$);
                                    }
                                }
                                ...
                                try {
                                    module0141.$g1710$.bind($ic68$, var55);
                                    module0141.$g1677$.bind(module0141.f9210(), var55);
                                    module0138.$g1619$.bind(module0244.f15780(module0137.f8955((SubLObject)UNPROVIDED)), var55);
                                    final SubLObject var68 = module0139.f9036();
                                    final SubLObject var59_68 = module0139.$g1635$.currentBinding(var55);
                                    try {
                                        module0139.$g1635$.bind((var68 == $ic69$) ? module0139.$g1635$.getDynamicValue(var55) : module0139.f9038(var68), var55);
                                        final SubLObject var59_69 = module0139.$g1636$.currentBinding(var55);
                                        try {
                                            module0139.$g1636$.bind((var68 == $ic69$) ? module0139.$g1636$.getDynamicValue(var55) : module0139.f9038(var68), var55);
                                            ...
                                            try {
                                                module0141.$g1685$.bind((SubLObject)NIL, var55);
                                                module0141.$g1686$.bind((SubLObject)NIL, var55);
                                                module0141.$g1683$.bind((SubLObject)NIL, var55);
                                                module0141.$g1684$.bind((SubLObject)NIL, var55);
                                                module0141.$g1674$.bind((SubLObject)NIL, var55);
                                                ...
                                                try {
                                                    ...
                                                    SubLObject var73;
                                                    SubLObject var74;
                                                    for (var73 = (SubLObject)NIL, var73 = var71; (NIL == f21692() || NIL == f21700()) && NIL != var73; var73 = var73.rest()) {
                                                        var74 = var73.first();
                                                        f21704(var74, var64);
                                                    }
                                                    final SubLObject var59_71 = module0141.$g1674$.currentBinding(var55);
                                                    try {
                                                        module0141.$g1674$.bind((SubLObject)T, var55);
                                                        SubLObject var75;
                                                        SubLObject var76;
                                                        for (var75 = (SubLObject)NIL, var75 = var72; (NIL == f21692() || NIL == f21700()) && NIL != var75; var75 = var75.rest()) {
                                                            var76 = var75.first();
                                                            f21704(var76, var64);
                                                        }
                                                    }
                    ...
                    var58 = Errors.handleThrowable(var77, (SubLObject)$ic58$);
                }
                finally {
                    var55.throwStack.pop();
                }
                var56 = module0035.f2269(f21700(), Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                if (NIL == var50) {
                    var56 = f21705(var56, var52);
                }
            }
            finally {
                $g2817$.rebind(var63, var55);
            ...
            final SubLObject var80 = (SubLObject)$ic73$;
            ...
            try {
                ...
                try {
                    module0141.$g1714$.bind((NIL != var84) ? var84 : module0141.f9283(), var55);
                    module0141.$g1715$.bind((SubLObject)((NIL != var84) ? $ic60$ : module0141.$g1715$.getDynamicValue(var55)), var55);
                    if (NIL != var84 && NIL != module0136.f8864() && NIL == module0141.f9279(var84)) {
                        final SubLObject var86 = module0136.$g1591$.getDynamicValue(var55);
                        if (var86.eql((SubLObject)$ic61$)) {
                            module0136.f8870((SubLObject)ONE_INTEGER, (SubLObject)$ic62$, var84, (SubLObject)$ic63$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                        }
                        else if (var86.eql((SubLObject)$ic64$)) {
                            module0136.f8871((SubLObject)ONE_INTEGER, (SubLObject)$ic65$, (SubLObject)$ic62$, var84, (SubLObject)$ic63$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                        }
                        else if (var86.eql((SubLObject)$ic66$)) {
                            Errors.warn((SubLObject)$ic62$, var84, (SubLObject)$ic63$);
                        }
                        else {
                            Errors.warn((SubLObject)$ic67$, module0136.$g1591$.getDynamicValue(var55));
                            Errors.cerror((SubLObject)$ic65$, (SubLObject)$ic62$, var84, (SubLObject)$ic63$);
                        }
                    }
                    ...
                    try {
                        ...
                        module0141.$g1674$.bind((SubLObject)NIL, var55);
                        module0137.$g1605$.bind(module0137.f8955($ic59$), var55);
                        if (NIL != module0136.f8865() || NIL != module0244.f15795(var78, module0137.f8955((SubLObject)UNPROVIDED))) {
                            ...
                            try {
                                module0141.$g1677$.bind(module0141.f9210(), var55);
                                module0138.$g1619$.bind(module0244.f15782(module0141.f9210(), module0137.f8955($ic59$)), var55);
                                module0141.$g1674$.bind((SubLObject)NIL, var55);
                                module0249.f16055(var79, (SubLObject)UNPROVIDED);
                                for (var82 = (SubLObject)ConsesLow.list(var78, module0141.f9195()); NIL != var82; var82 = module0056.f4150(var81)) {
                                    ...
                                    try {
                                        ...
                                        if (!var91.equal(var78) && NIL != module0318.f21438(var91)) {
                                            final SubLObject var93 = (NIL != var92) ? module0202.f12720(var91, Sequences.reverse(module0205.f13385(var19, (SubLObject)UNPROVIDED)), (SubLObject)UNPROVIDED) : module0202.f12817((SubLObject)ZERO_INTEGER, var91, var19);
                                            SubLObject var94 = f21702(var93, var49, var50, var51, var52, (SubLObject)T, (SubLObject)UNPROVIDED);
                                            SubLObject var95 = (SubLObject)NIL;
                                            var95 = var94.first();
                                            while (NIL != var94) {
                                                final SubLObject var96 = var95;
                                                if (NIL == conses_high.member(var96, var56, Symbols.symbol_function((SubLObject)EQUAL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                                        ...
                                        SubLObject var94;
                                        final SubLObject var97 = var94 = module0200.f12443(module0137.f8955($ic59$));
                                        ...
                                        while (NIL != var94) {
                                            ...
                                            try {
                                                ...
                                                if (NIL != module0138.f8992(var99)) {
                                                    final SubLObject var100 = module0242.f15664(var99, module0137.f8955((SubLObject)UNPROVIDED));
                                                    if (NIL != var100) {
                                                        final SubLObject var101 = module0245.f15834(var100, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                                                        if (NIL != var101) {
                                                            SubLObject var102;
                                                            for (var102 = module0066.f4838(module0067.f4891(var101)); NIL == module0066.f4841(var102); var102 = module0066.f4840(var102)) {
                                                                var55.resetMultipleValues();
                                                                final SubLObject var122_123 = module0066.f4839(var102);
                                                                final SubLObject var103 = var55.secondMultipleValue();
                                                                var55.resetMultipleValues();
                                                                if (NIL != module0147.f9507(var122_123)) {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        for (var121_126 = module0066.f4838(module0067.f4891(var103)); NIL == module0066.f4841(var121_126); var121_126 = module0066.f4840(var121_126)) {
                                                                            var55.resetMultipleValues();
                                                                            final SubLObject var104 = module0066.f4839(var121_126);
                                                                            final SubLObject var105 = var55.secondMultipleValue();
                                                                            var55.resetMultipleValues();
                                                                            if (NIL != module0141.f9289(var104)) {
                                                                                ...
                                                                                try {
                                                                                    ...
                                                                                    if (NIL != module0077.f5302(var106)) {
                                                                                        ...
                                                                                        SubLObject var109;
                                                                                        SubLObject var110;
                                                                                        for (var108 = module0032.f1741(var107), var109 = (SubLObject)NIL, var109 = module0032.f1742(var108, var107); NIL == module0032.f1744(var108, var109); var109 = module0032.f1743(var109)) {
                                                                                            var110 = module0032.f1745(var108, var109);
                                                                                            if (NIL != module0032.f1746(var109, var110) && NIL == module0249.f16059(var110, (SubLObject)UNPROVIDED)) {
                                                                                        ...
                                                                                        var112 = var111.first();
                                                                                        while (NIL != var111) {
                                                                                            if (NIL == module0249.f16059(var112, (SubLObject)UNPROVIDED)) {
                                                                                        ...
                                                                                        Errors.error((SubLObject)$ic74$, var106);
                                                                                    }
                                                                                }
                                                                                finally {
                                                        ...
                                                        module0136.f8870((SubLObject)FIVE_INTEGER, (SubLObject)$ic75$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                                    }
                                                }
                                                else if (NIL != module0155.f9785(var99, (SubLObject)UNPROVIDED)) {
                                                    SubLObject var44_136;
                                                    final SubLObject var113 = var44_136 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var55), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var55), module0137.f8955((SubLObject)UNPROVIDED)));
                                                    ...
                                                    while (NIL != var44_136) {
                                                        ...
                                                        try {
                                                            ...
                                                            if (NIL != module0077.f5302(var116)) {
                                                                ...
                                                                Errors.error((SubLObject)$ic74$, var116);
                                                            }
                                                        }
                                                        finally {
                            ...
                            module0136.f8872((SubLObject)TWO_INTEGER, (SubLObject)$ic76$, var78, module0244.f15748(module0137.f8955((SubLObject)UNPROVIDED)), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                        }
                    }
                    finally {
    ...
    public static SubLObject f21703(final SubLObject var19, final SubLObject var49, SubLObject var50, SubLObject var51) {
        ...
        if (NIL != module0322.f21736()) {
            ...
            try {
                ...
                final SubLObject var61 = module0205.f13207(var19, (SubLObject)$ic77$);
                SubLObject var62;
                SubLObject var63;
                SubLObject var64;
                SubLObject var65;
                ...
                SubLObject var71;
                SubLObject var72;
                for (var62 = (SubLObject)NIL, var62 = var61; NIL == var56 && NIL != var62; var62 = var62.rest()) {
                    var63 = var62.first();
                    var60 = Numbers.add(var60, (SubLObject)ONE_INTEGER);
                    if (NIL != module0193.f12105(var63) && NIL != module0322.f21730(var55, var60)) {
                        var64 = module0205.f13384(var19, Numbers.subtract((SubLObject)THREE_INTEGER, var60), (SubLObject)UNPROVIDED);
                        var65 = ((NIL != module0193.f12105(var64)) ? module0322.f21729(var63, var55, var60, var64, Symbols.symbol_function((SubLObject)EQUAL), var51) : module0322.f21725(var63, var55, var60, var51));
                        var59_145 = module0234.$g2436$.currentBinding(var52);
                        try {
                            module0234.$g2436$.bind(var51, var52);
                            for (var91_146 = (SubLObject)NIL, var91_146 = var65; NIL == var56 && NIL != var91_146; var91_146 = var91_146.rest()) {
                                var66 = var91_146.first();
                                var67 = (var68 = var66);
                                var69 = (SubLObject)NIL;
                                var70 = (SubLObject)NIL;
                                cdestructuring_bind.destructuring_bind_must_consp(var68, var67, (SubLObject)$ic78$);
                                var69 = var68.first();
                                var68 = (var70 = var68.rest());
                                var52.resetMultipleValues();
                                var71 = module0235.f15474(var64, var69, (SubLObject)T, (SubLObject)UNPROVIDED);
                                ...
                                if (NIL != module0193.f12105(var64) && NIL == var51) {
                                    var56 = (SubLObject)T;
                                }
                            }
                        }
    ...
    public static SubLObject f21705(final SubLObject var55, final SubLObject var52) {
        ...
        while (NIL != var57) {
            ...
            cdestructuring_bind.destructuring_bind_must_consp(var60, var59, (SubLObject)$ic79$);
            var61 = var60.first();
            var60 = var60.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var60, var59, (SubLObject)$ic79$);
            var62 = var60.first();
            ...
            if (NIL == var60) {
                ...
                while (NIL != var44_158) {
                    ...
                    while (NIL != var69) {
                        ...
                        SubLObject var44_159 = module0318.f21455(var70, f21684(), var67, (SubLObject)NIL);
                        SubLObject var72 = (SubLObject)NIL;
                        var72 = var44_159.first();
                        while (NIL != var44_159) {
                            if (var52 != $ic80$ || !var71.eql(module0134.f8805(var72))) {
                                SubLObject var44_160 = module0266.f17530(var72, var66, var71, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    ...
                    var63 = (SubLObject)ConsesLow.cons(module0035.f2269(var68, Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var63);
                    var44_158 = var44_158.rest();
                    var64 = var44_158.first();
                }
                SubLObject var44_161 = module0035.f2489(Sequences.nreverse(var63), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                ...
                cdestructuring_bind.cdestructuring_bind_error(var59, (SubLObject)$ic79$);
            }
            var57 = var57.rest();
            var58 = var57.first();
        }
        return module0035.f2269(ConsesLow.append(var55, var56), Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f21706(final SubLObject var92, final SubLObject var169) {
        SubLObject var170 = (SubLObject)NIL;
        if (NIL == var170) {
            SubLObject var171 = module0249.f16019(var92, (SubLObject)UNPROVIDED);
            SubLObject var172 = (SubLObject)NIL;
            var172 = var171.first();
            while (NIL == var170 && NIL != var171) {
                if (NIL != module0320.f21592(var172, var169)) {
                    var170 = (SubLObject)T;
                }
                var171 = var171.rest();
                var172 = var171.first();
    ...
    public static SubLObject f21707(final SubLObject var92, final SubLObject var63) {
        module0249.f16038(var92, var63, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21704(final SubLObject var92, final SubLObject var63) {
        ...
        if (NIL != $g2815$.getGlobalValue() && NIL != module0408.f28448()) {
            Dynamic.sublisp_throw((SubLObject)$ic58$, (SubLObject)T);
        }
        final SubLObject var94 = (SubLObject)makeBoolean(!module0320.f21587(var63).eql(module0141.f9195()));
        final SubLObject var95 = module0320.f21622(var92, var63, var94);
        if (NIL == f21706(var92, var95)) {
            f21707(var92, var95);
            if (NIL != module0320.f21561(var95)) {
                f21701(module0320.f21626(var95));
            }
            if (NIL != f21692() && NIL != f21700()) {
                module0141.$g1685$.setDynamicValue((SubLObject)T, var93);
            }
            if (NIL != module0320.f21561(var95)) {
                final SubLObject var96 = module0200.f12443(module0137.f8955((SubLObject)UNPROVIDED));
                SubLObject var97;
                SubLObject var98;
                SubLObject var99;
                SubLObject var100;
                ...
                SubLObject var124;
                SubLObject var125;
                for (var97 = (SubLObject)NIL, var97 = var96; NIL == module0141.$g1685$.getDynamicValue(var93) && NIL != var97; var97 = var97.rest()) {
                    var98 = var97.first();
                    var99 = module0137.$g1605$.currentBinding(var93);
                    var100 = module0141.$g1674$.currentBinding(var93);
                    try {
                        module0137.$g1605$.bind(var98, var93);
                        module0141.$g1674$.bind((SubLObject)((NIL != module0141.f9205((SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) ? makeBoolean(NIL == module0141.$g1674$.getDynamicValue(var93)) : module0141.$g1674$.getDynamicValue(var93)), var93);
                        var101 = module0228.f15229(var92);
                        if (NIL != module0138.f8992(var101)) {
                            var102 = module0242.f15664(var101, module0137.f8955((SubLObject)UNPROVIDED));
                            if (NIL != var102) {
                                var103 = module0245.f15834(var102, module0138.f8979(), module0137.f8955((SubLObject)UNPROVIDED));
                                if (NIL != var103) {
                                    for (var104 = module0066.f4838(module0067.f4891(var103)); NIL == module0141.$g1685$.getDynamicValue(var93) && NIL == module0066.f4841(var104); var104 = module0066.f4840(var104)) {
                                        var93.resetMultipleValues();
                                        var105 = module0066.f4839(var104);
                                        var106 = var93.secondMultipleValue();
                                        var93.resetMultipleValues();
                                        if (NIL != module0147.f9507(var105)) {
                                            var59_173 = module0138.$g1623$.currentBinding(var93);
                                            try {
                                                module0138.$g1623$.bind(var105, var93);
                                                for (var121_174 = module0066.f4838(module0067.f4891(var106)); NIL == module0141.$g1685$.getDynamicValue(var93) && NIL == module0066.f4841(var121_174); var121_174 = module0066.f4840(var121_174)) {
                                                    var93.resetMultipleValues();
                                                    var107 = module0066.f4839(var121_174);
                                                    var108 = var93.secondMultipleValue();
                                                    var93.resetMultipleValues();
                                                    if (NIL != module0141.f9289(var107)) {
                                                        ...
                                                        try {
                                                            ...
                                                            if (NIL != module0077.f5302(var109)) {
                                                                ...
                                                                for (var111 = module0032.f1741(var110), var112 = (SubLObject)NIL, var112 = module0032.f1742(var111, var110); NIL == module0141.$g1685$.getDynamicValue(var93) && NIL == module0032.f1744(var111, var112); var112 = module0032.f1743(var112)) {
                                                                ...
                                                                if (NIL == module0141.$g1685$.getDynamicValue(var93)) {
                                                                    var114 = var109;
                                                                    var115 = (SubLObject)NIL;
                                                                    var115 = var114.first();
                                                                    while (NIL == module0141.$g1685$.getDynamicValue(var93) && NIL != var114) {
                                                                        f21704(var115, var95);
                                                                        var114 = var114.rest();
                                                                        var115 = var114.first();
                                                                    }
                                                                ...
                                                                Errors.error((SubLObject)$ic74$, var109);
                                                            }
                                                        }
                                                        finally {
                        ...
                        else if (NIL != module0155.f9785(var101, (SubLObject)UNPROVIDED)) {
                            var116 = ((NIL != module0138.f8995()) ? module0035.f2097(module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var93), module0137.f8955((SubLObject)UNPROVIDED))) : module0244.f15760(module0138.f8979(), module0141.$g1714$.getDynamicValue(var93), module0137.f8955((SubLObject)UNPROVIDED)));
                            for (var91_177 = (SubLObject)NIL, var91_177 = var116; NIL == module0141.$g1685$.getDynamicValue(var93) && NIL != var91_177; var91_177 = var91_177.rest()) {
                                ...
                                try {
                                    ...
                                    if (NIL != module0077.f5302(var119)) {
                                        ...
                                        for (var121 = module0032.f1741(var120), var122 = (SubLObject)NIL, var122 = module0032.f1742(var121, var120); NIL == module0141.$g1685$.getDynamicValue(var93) && NIL == module0032.f1744(var121, var122); var122 = module0032.f1743(var122)) {
                                        ...
                                        if (NIL == module0141.$g1685$.getDynamicValue(var93)) {
                                            ...
                                            var125 = var124.first();
                                            while (NIL == module0141.$g1685$.getDynamicValue(var93) && NIL != var124) {
                                                f21704(var125, var95);
                                                var124 = var124.rest();
                                                var125 = var124.first();
                                            }
                                        ...
                                        Errors.error((SubLObject)$ic74$, var119);
                                    }
                                }
                                finally {
    ...
    public static SubLObject f21708(final SubLObject var19, SubLObject var49, SubLObject var52) {
        ...
        final SubLObject var60 = $g2817$.currentBinding(var53);
        try {
            ...
            $g2817$.bind(f21658((SubLObject)UNPROVIDED), var53);
            f21661(var19, (SubLObject)NIL, (SubLObject)NIL);
            try {
                var53.throwStack.push($ic58$);
                ...
                try {
                    module0141.$g1670$.bind(module0137.f8955($ic59$), var53);
                    module0141.$g1671$.bind(module0244.f15739(module0137.f8955($ic59$)), var53);
                    module0141.$g1672$.bind(module0244.f15746(module0137.f8955($ic59$)), var53);
                    module0141.$g1674$.bind((SubLObject)NIL, var53);
                    module0137.$g1605$.bind(module0137.f8955($ic59$), var53);
                    ...
                    try {
                        ...
                        try {
                            module0141.$g1714$.bind((NIL != var63) ? var63 : module0141.f9283(), var53);
                            module0141.$g1715$.bind((SubLObject)((NIL != var63) ? $ic60$ : module0141.$g1715$.getDynamicValue(var53)), var53);
                            if (NIL != var63 && NIL != module0136.f8864() && NIL == module0141.f9279(var63)) {
                                final SubLObject var64 = module0136.$g1591$.getDynamicValue(var53);
                                if (var64.eql((SubLObject)$ic61$)) {
                                    module0136.f8870((SubLObject)ONE_INTEGER, (SubLObject)$ic62$, var63, (SubLObject)$ic63$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                }
                                else if (var64.eql((SubLObject)$ic64$)) {
                                    module0136.f8871((SubLObject)ONE_INTEGER, (SubLObject)$ic65$, (SubLObject)$ic62$, var63, (SubLObject)$ic63$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                }
                                else if (var64.eql((SubLObject)$ic66$)) {
                                    Errors.warn((SubLObject)$ic62$, var63, (SubLObject)$ic63$);
                                }
                                else {
                                    Errors.warn((SubLObject)$ic67$, module0136.$g1591$.getDynamicValue(var53));
                                    Errors.cerror((SubLObject)$ic65$, (SubLObject)$ic62$, var63, (SubLObject)$ic63$);
                                }
                            }
                            ...
                            try {
                                module0141.$g1710$.bind($ic68$, var53);
                                module0141.$g1677$.bind(module0141.f9210(), var53);
                                module0138.$g1619$.bind(module0244.f15780(module0137.f8955((SubLObject)UNPROVIDED)), var53);
                                final SubLObject var65 = module0139.f9036();
                                final SubLObject var59_184 = module0139.$g1635$.currentBinding(var53);
                                try {
                                    module0139.$g1635$.bind((var65 == $ic69$) ? module0139.$g1635$.getDynamicValue(var53) : module0139.f9038(var65), var53);
                                    final SubLObject var59_185 = module0139.$g1636$.currentBinding(var53);
                                    try {
                                        module0139.$g1636$.bind((var65 == $ic69$) ? module0139.$g1636$.getDynamicValue(var53) : module0139.f9038(var65), var53);
                                        ...
                                        try {
                                            module0141.$g1685$.bind((SubLObject)NIL, var53);
                                            module0141.$g1686$.bind((SubLObject)NIL, var53);
                                            module0141.$g1683$.bind((SubLObject)NIL, var53);
                                            module0141.$g1684$.bind((SubLObject)NIL, var53);
                                            module0141.$g1674$.bind((SubLObject)NIL, var53);
                ...
                var55 = Errors.handleThrowable(var68, (SubLObject)$ic58$);
            }
            finally {
                var53.throwStack.pop();
            }
            var54 = f21709(module0035.f2269(f21700(), Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var52);
        }
        finally {
            $g2817$.rebind(var60, var53);
    ...
    public static SubLObject f21709(final SubLObject var200, final SubLObject var52) {
        return ($ic57$ == var52) ? module0052.f3709(var200) : module0052.f3689(f21710(var200, var52), (SubLObject)$ic81$, (SubLObject)$ic82$, (SubLObject)$ic83$);
    }
    
    public static SubLObject f21710(final SubLObject var200, final SubLObject var52) {
        final SubLObject var201 = module0067.f4880(Symbols.symbol_function((SubLObject)EQ), (SubLObject)UNPROVIDED);
        ...
        while (NIL != var202) {
            ...
            cdestructuring_bind.destructuring_bind_must_consp(var205, var204, (SubLObject)$ic84$);
            var206 = var205.first();
            var205 = var205.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var205, var204, (SubLObject)$ic84$);
            var207 = var205.first();
            ...
            if (NIL == var205) {
                ...
                while (NIL != var208) {
                    ...
                    SubLObject var44_205 = module0318.f21455(var209, f21684(), var207, (SubLObject)NIL);
                    SubLObject var211 = (SubLObject)NIL;
                    var211 = var44_205.first();
                    while (NIL != var44_205) {
                        if (var52 != $ic80$ || !var210.eql(module0134.f8805(var211))) {
                            module0084.f5765(var201, var206, (SubLObject)ConsesLow.list(var211, var210), Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED);
                        }
                ...
                cdestructuring_bind.cdestructuring_bind_error(var204, (SubLObject)$ic84$);
            }
            var202 = var202.rest();
            var203 = var202.first();
        }
        return (SubLObject)ConsesLow.list((SubLObject)NIL, var200, var201);
    }
    ...
    public static SubLObject f21711(final SubLObject var206) {
        ...
        SubLObject var209 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var206, var206, (SubLObject)$ic85$);
        var207 = var206.first();
        SubLObject var210 = var206.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var210, var206, (SubLObject)$ic85$);
        var208 = var210.first();
        var210 = var210.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var210, var206, (SubLObject)$ic85$);
        var209 = var210.first();
        var210 = var210.rest();
        if (NIL == var210) {
            return (SubLObject)makeBoolean(NIL == var208 && (NIL == var207 || NIL != module0052.f3687(var207)));
        }
        cdestructuring_bind.cdestructuring_bind_error(var206, (SubLObject)$ic85$);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21712(final SubLObject var206) {
        ...
        if (NIL == var210) {
            ...
            while (NIL == var211 && NIL == var212) {
                if (NIL == var207) {
                    var207 = f21713(var208.first(), var209);
                    ConsesLow.set_nth((SubLObject)ZERO_INTEGER, var206, var207);
                    ConsesLow.set_nth((SubLObject)ONE_INTEGER, var206, var208.rest());
                    if (NIL != module0052.f3674(var207)) {
                        continue;
                    }
                    var212 = (SubLObject)T;
                }
                else if (NIL != module0052.f3687(var207)) {
                    var207 = (SubLObject)NIL;
                    ConsesLow.set_nth((SubLObject)ZERO_INTEGER, var206, (SubLObject)NIL);
                }
                else {
                    var211 = module0052.f3694(var207, (SubLObject)UNPROVIDED);
                }
            }
    ...
    public static SubLObject f21713(final SubLObject var213, final SubLObject var201) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var213, var213, (SubLObject)$ic86$);
        var214 = var213.first();
        SubLObject var216 = var213.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var216, var213, (SubLObject)$ic86$);
        var215 = var216.first();
        var216 = var216.rest();
        if (NIL == var216) {
        ...
        cdestructuring_bind.cdestructuring_bind_error(var213, (SubLObject)$ic86$);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21715(final SubLObject var152, final SubLObject var201) {
        ...
        while (NIL != var203) {
            ...
            SubLObject var207 = (SubLObject)NIL;
            SubLObject var44_219 = module0067.f4885(var201, var205, (SubLObject)UNPROVIDED);
            SubLObject var208 = (SubLObject)NIL;
            ...
            while (NIL != var44_219) {
                ...
                SubLObject var211 = (SubLObject)NIL;
                SubLObject var212 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var210, var209, (SubLObject)$ic87$);
                var211 = var210.first();
                var210 = var210.rest();
                cdestructuring_bind.destructuring_bind_must_consp(var210, var209, (SubLObject)$ic87$);
                var212 = var210.first();
                var210 = var210.rest();
                if (NIL == var210) {
                    final SubLObject var213 = module0266.f17523(var211, var206, var212, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    final SubLObject var214 = f21716(var205, var213);
                    var207 = (SubLObject)ConsesLow.cons(var214, var207);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var209, (SubLObject)$ic87$);
                }
    ...
    public static SubLObject f21716(final SubLObject var34, final SubLObject var179) {
        return module0052.f3689((SubLObject)ConsesLow.list(var34, var179), (SubLObject)$ic88$, (SubLObject)$ic89$, (SubLObject)$ic90$);
    }
    
    public static SubLObject f21717(final SubLObject var206) {
        SubLObject var207 = (SubLObject)NIL;
        SubLObject var208 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var206, var206, (SubLObject)$ic91$);
        var207 = var206.first();
        SubLObject var209 = var206.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var209, var206, (SubLObject)$ic91$);
        var208 = var209.first();
        var209 = var209.rest();
        if (NIL == var209) {
            return module0052.f3687(var208);
        }
        cdestructuring_bind.cdestructuring_bind_error(var206, (SubLObject)$ic91$);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21718(final SubLObject var206) {
        ...
        var209 = var209.rest();
        if (NIL == var209) {
            final SubLObject var210 = module0052.f3694(var208, (SubLObject)UNPROVIDED);
            return (NIL != var210) ? Values.values(module0233.f15340(var207, var210), var206, (SubLObject)NIL) : Values.values((SubLObject)NIL, var206, (SubLObject)T);
        }
        cdestructuring_bind.cdestructuring_bind_error(var206, (SubLObject)$ic91$);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21721() {
        $g2815$ = SubLFiles.deflexical("S#24270", (SubLObject)T);
        $g2816$ = SubLFiles.defconstant("S#24271", (SubLObject)$ic0$);
        $g2817$ = SubLFiles.defparameter("S#24272", (SubLObject)NIL);
        $g2818$ = SubLFiles.defparameter("S#24273", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f21722() {
        Structures.register_method(print_high.$print_object_method_table$.getGlobalValue(), $g2816$.getGlobalValue(), Symbols.symbol_function((SubLObject)$ic7$));
        ...
        Structures.register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $g2816$.getGlobalValue(), Symbols.symbol_function((SubLObject)$ic50$));
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g2817$ = null;
        $g2818$ = null;
        $ic0$ = makeSymbol("S#24186", "CYC");
        $ic1$ = makeSymbol("S#24187", "CYC");
        $ic2$ = ConsesLow.list(new SubLObject[] { makeSymbol("S#24274", "CYC"), makeSymbol("S#24275", "CYC"), makeSymbol("S#24276", "CYC"), makeSymbol("S#24277", "CYC"), makeSymbol("S#24278", "CYC"), makeSymbol("S#24279", "CYC"), makeSymbol("S#24280", "CYC"), makeSymbol("S#24281", "CYC"), makeSymbol("S#24282", "CYC"), makeSymbol("S#10884", "CYC"), makeSymbol("S#24283", "CYC"), makeSymbol("S#24284", "CYC") });
        $ic3$ = ConsesLow.list(new SubLObject[] { makeKeyword("PROBLEM"), makeKeyword("ASENT-PRED"), makeKeyword("ASENT-ARGS"), makeKeyword("ARGS-ADMITTED"), makeKeyword("TERM-ARGNUMS"), makeKeyword("VAR-ARGNUMS"), makeKeyword("PRECOMPUTATIONS"), makeKeyword("REUSED-SPACES"), makeKeyword("ONE-ANSWER?"), makeKeyword("JUSTIFY?"), makeKeyword("RESTRICTED-ASSERTION"), makeKeyword("ANSWERS") });
        $ic4$ = ConsesLow.list(new SubLObject[] { makeSymbol("S#24194", "CYC"), makeSymbol("S#24195", "CYC"), makeSymbol("S#24196", "CYC"), makeSymbol("S#24197", "CYC"), makeSymbol("S#24198", "CYC"), makeSymbol("S#24199", "CYC"), makeSymbol("S#24200", "CYC"), makeSymbol("S#24201", "CYC"), makeSymbol("S#24202", "CYC"), makeSymbol("S#24203", "CYC"), makeSymbol("S#24204", "CYC"), makeSymbol("S#24205", "CYC") });
        $ic5$ = ConsesLow.list(new SubLObject[] { makeSymbol("S#24206", "CYC"), makeSymbol("S#24207", "CYC"), makeSymbol("S#24208", "CYC"), makeSymbol("S#24209", "CYC"), makeSymbol("S#24210", "CYC"), makeSymbol("S#24211", "CYC"), makeSymbol("S#24212", "CYC"), makeSymbol("S#24213", "CYC"), makeSymbol("S#24214", "CYC"), makeSymbol("S#24215", "CYC"), makeSymbol("S#24216", "CYC"), makeSymbol("S#24217", "CYC") });
        $ic6$ = makeSymbol("S#24221", "CYC");
        $ic7$ = makeSymbol("S#24193", "CYC");
        $ic8$ = ConsesLow.list((SubLObject)makeSymbol("OPTIMIZE-FUNCALL"), (SubLObject)makeSymbol("S#24187", "CYC"));
        $ic9$ = makeSymbol("S#24194", "CYC");
        $ic10$ = makeSymbol("S#24206", "CYC");
        $ic11$ = makeSymbol("S#24195", "CYC");
        $ic12$ = makeSymbol("S#24207", "CYC");
        $ic13$ = makeSymbol("S#24196", "CYC");
        $ic14$ = makeSymbol("S#24208", "CYC");
        $ic15$ = makeSymbol("S#24197", "CYC");
        $ic16$ = makeSymbol("S#24209", "CYC");
        $ic17$ = makeSymbol("S#24198", "CYC");
        $ic18$ = makeSymbol("S#24210", "CYC");
        $ic19$ = makeSymbol("S#24199", "CYC");
        $ic20$ = makeSymbol("S#24211", "CYC");
        $ic21$ = makeSymbol("S#24200", "CYC");
        $ic22$ = makeSymbol("S#24212", "CYC");
        $ic23$ = makeSymbol("S#24201", "CYC");
        $ic24$ = makeSymbol("S#24213", "CYC");
        $ic25$ = makeSymbol("S#24202", "CYC");
        $ic26$ = makeSymbol("S#24214", "CYC");
        $ic27$ = makeSymbol("S#24203", "CYC");
        $ic28$ = makeSymbol("S#24215", "CYC");
        $ic29$ = makeSymbol("S#24204", "CYC");
        $ic30$ = makeSymbol("S#24216", "CYC");
        $ic31$ = makeSymbol("S#24205", "CYC");
        $ic32$ = makeSymbol("S#24217", "CYC");
        $ic33$ = makeKeyword("PROBLEM");
        $ic34$ = makeKeyword("ASENT-PRED");
        $ic35$ = makeKeyword("ASENT-ARGS");
        $ic36$ = makeKeyword("ARGS-ADMITTED");
        $ic37$ = makeKeyword("TERM-ARGNUMS");
        $ic38$ = makeKeyword("VAR-ARGNUMS");
        $ic39$ = makeKeyword("PRECOMPUTATIONS");
        $ic40$ = makeKeyword("REUSED-SPACES");
        $ic41$ = makeKeyword("ONE-ANSWER?");
        $ic42$ = makeKeyword("JUSTIFY?");
        $ic43$ = makeKeyword("RESTRICTED-ASSERTION");
        $ic44$ = makeKeyword("ANSWERS");
        $ic45$ = makeString("Invalid slot ~S for construction function");
        $ic46$ = makeKeyword("BEGIN");
        $ic47$ = makeSymbol("S#24218", "CYC");
        $ic48$ = makeKeyword("SLOT");
        $ic49$ = makeKeyword("END");
        $ic50$ = makeSymbol("S#24220", "CYC");
        $ic51$ = makeString("#<");
        $ic52$ = makeKeyword("STREAM");
        $ic53$ = makeKeyword("BASE");
        $ic54$ = makeSymbol("CLET");
        $ic55$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#24272", "CYC"), (SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#24218", "CYC"))));
        $ic56$ = makeKeyword("FAIL");
        $ic57$ = makeKeyword("NONE");
        $ic58$ = makeKeyword("TVA-MAX-TIME");
        $ic59$ = constant_handles_oc.f8479((SubLObject)makeString("genlPreds"));
        $ic60$ = makeSymbol("S#11450", "CYC");
        $ic61$ = makeKeyword("ERROR");
        $ic62$ = makeString("~A is not a ~A");
        $ic63$ = makeSymbol("S#11592", "CYC");
        $ic64$ = makeKeyword("CERROR");
        $ic65$ = makeString("continue anyway");
        $ic66$ = makeKeyword("WARN");
        $ic67$ = makeString("~A is not a valid *sbhl-type-error-action* value");
        $ic68$ = constant_handles_oc.f8479((SubLObject)makeString("True-JustificationTruth"));
        $ic69$ = makeKeyword("OLD");
        $ic70$ = makeKeyword("RESOURCE");
        $ic71$ = makeKeyword("DEPTH");
        $ic72$ = makeKeyword("STACK");
        $ic73$ = makeKeyword("QUEUE");
        $ic74$ = makeString("~A is neither SET-P nor LISTP.");
        $ic75$ = makeString("attempting to bind direction link variable, to NIL. macro body not executed.");
        $ic76$ = makeString("Node ~a does not pass sbhl-type-test ~a~%");
        $ic77$ = makeKeyword("IGNORE");
        $ic78$ = (SubLList)ConsesLow.cons((SubLObject)makeSymbol("S#24285", "CYC"), (SubLObject)makeSymbol("S#14510", "CYC"));
        $ic79$ = ConsesLow.list((SubLObject)makeSymbol("S#713", "CYC"), (SubLObject)makeSymbol("S#14510", "CYC"));
        $ic80$ = makeKeyword("FOCUSED");
        $ic81$ = makeSymbol("S#24261", "CYC");
        $ic82$ = makeSymbol("S#24262", "CYC");
        $ic83$ = makeSymbol("S#24263", "CYC");
        $ic84$ = ConsesLow.list((SubLObject)makeSymbol("VAR", "CYC"), (SubLObject)makeSymbol("S#15200", "CYC"));
        $ic85$ = ConsesLow.list((SubLObject)makeSymbol("S#5090", "CYC"), (SubLObject)makeSymbol("S#24245", "CYC"), (SubLObject)makeSymbol("S#24286", "CYC"));
        $ic86$ = ConsesLow.list((SubLObject)makeSymbol("S#713", "CYC"), (SubLObject)makeSymbol("S#14595", "CYC"));
        $ic87$ = ConsesLow.list((SubLObject)makeSymbol("S#155", "CYC"), (SubLObject)makeSymbol("S#5432", "CYC"));
        $ic88$ = makeSymbol("S#24267", "CYC");
        $ic89$ = makeSymbol("S#24268", "CYC");
        $ic90$ = makeSymbol("S#24269", "CYC");
        $ic91$ = ConsesLow.list((SubLObject)makeSymbol("VAR", "CYC"), (SubLObject)makeSymbol("S#5090", "CYC"));
    }
    ...
    public static final class $sX24186_native extends SubLStructNative
    {
        ...
        static {
            structDecl = Structures.makeStructDeclNative((Class)$sX24186_native.class, $ic0$, $ic1$, $ic2$, $ic3$, new String[] { "$problem", "$asent_pred", "$asent_args", "$args_admitted", "$term_argnums", "$var_argnums", "$precomputations", "$reused_spaces", "$one_answerP", "$justifyP", "$restricted_assertion", "$answers" }, $ic4$, $ic5$, $ic6$);
        }
    }
