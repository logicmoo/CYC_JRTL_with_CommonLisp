...
public final class module0820 extends SubLTranslatedFile
{
    ...
    public static SubLObject f52653() {
        ...
        final SubLObject var3 = $g6524$.getDynamicValue(var2);
        if (var3.eql((SubLObject)$ic0$)) {
    ...
    public static SubLObject f52656() {
        ...
        var4 = module0034.f1857(var3, (SubLObject)$ic1$, (SubLObject)UNPROVIDED);
        if (NIL == var4) {
            var4 = module0034.f1807(module0034.f1842(var3), (SubLObject)$ic1$, (SubLObject)ZERO_INTEGER, (SubLObject)NIL, (SubLObject)EQ, (SubLObject)UNPROVIDED);
            module0034.f1860(var3, (SubLObject)$ic1$, var4);
        }
    ...
    public static SubLObject f52659(final SubLObject var1) {
        return Sequences.position(var1, f52656(), Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f52658(final SubLObject var1) {
        ...
        if (NIL == var4) {
            var4 = module0034.f1807(module0034.f1842(var3), (SubLObject)$ic3$, (SubLObject)ONE_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var3, (SubLObject)$ic3$, var4);
        }
        SubLObject var5 = module0034.f1814(var4, var1, (SubLObject)$ic2$);
        if (var5 == $ic2$) {
    ...
    public static SubLObject f52661(final SubLObject var11) {
        ...
        try {
            ...
            try {
                var13 = Sort.sort(conses_high.copy_list(var11), Symbols.symbol_function((SubLObject)$ic5$), (SubLObject)UNPROVIDED);
            }
            finally {
    ...
    public static SubLObject f52667(final SubLObject var19) {
        ...
        final SubLObject var21 = $g6524$.getDynamicValue(var20);
        if (var21.eql((SubLObject)$ic0$)) {
    ...
    public static SubLObject f52668(final SubLObject var20) {
        ...
        final SubLObject var22 = $g6524$.getDynamicValue(var21);
        if (var22.eql((SubLObject)$ic0$)) {
    ...
    public static SubLObject f52675(final SubLObject var20) {
        ...
        if (var22.eql((SubLObject)$ic8$)) {
            return (SubLObject)$ic9$;
        }
        if (var22.eql((SubLObject)$ic10$)) {
            return (SubLObject)NIL;
        }
        return var21;
    }
    ...
    public static SubLObject f52685(final SubLObject var22, final SubLObject var19) {
        ...
        assert NIL != Types.symbolp(var19) : var19;
        final SubLObject var24 = $g6524$.getDynamicValue(var23);
        if (var24.eql((SubLObject)$ic0$)) {
    ...
    public static SubLObject f52708(final SubLObject var23) {
        ...
        assert NIL != f52652(var23) : var23;
        final SubLObject var25 = $g6524$.getDynamicValue(var24);
    ...
    public static SubLObject f52709(final SubLObject var24) {
        ...
        assert NIL != f52652(var24) : var24;
        final SubLObject var26 = $g6524$.getDynamicValue(var25);
        if (var26.eql((SubLObject)$ic0$)) {
    ...
    public static SubLObject f52712(final SubLObject var29, SubLObject var11) {
        ...
        while (NIL != var30) {
            ...
            if (NIL == conses_high.member(var33, var11, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
    ...
    public static SubLObject f52713(final SubLObject var30) {
        ...
        while (NIL != var32) {
            ...
            while (NIL != var26_33) {
                ...
                if (NIL == conses_high.member(var36, var31, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
        ...
        return f52711(var31, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f52714(final SubLObject var35, SubLObject var36) {
        ...
        final SubLObject var37 = module0077.f5313(Symbols.symbol_function((SubLObject)EQUALP), (SubLObject)UNPROVIDED);
        ...
        while (NIL != var38) {
            ...
            if (NIL != f52652(var39)) {
                if (NIL != var36) {
                    PrintLow.format((SubLObject)T, (SubLObject)$ic11$, var39);
                }
                if (NIL != module0077.f5320(var39, var37)) {
                    continue;
                }
                ...
                var42 = var41.first();
                while (NIL != var41) {
                    if (NIL == module0077.f5320(var42, var37)) {
    ...
    public static SubLObject f52715(final SubLObject var42, SubLObject var43) {
        ...
        return conses_high.set_difference(f52716(var42, var43), var42, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f52719(final SubLObject var44, SubLObject var43) {
        ...
        while (NIL != var45) {
            ...
            while (NIL != var26_45) {
                ...
                if (NIL == conses_high.member(var49, var43, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
            ...
            while (NIL != var26_46) {
                ...
                if (NIL == conses_high.member(var51, var43, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
    ...
    public static SubLObject f52720(final SubLObject var49, final SubLObject var50) {
        ...
        while (NIL != var53) {
            ...
            while (NIL != var26_51) {
                if (NIL != Strings.string_equal(var50, f52670(var55), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                    final SubLObject var56 = var55;
                    if (NIL == conses_high.member(var56, var51, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
        ...
        while (NIL != var53) {
            ...
            while (NIL != var26_52) {
                if (NIL != Strings.string_equal(var50, f52670(var55), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                    final SubLObject var56 = var55;
                    if (NIL == conses_high.member(var56, var52, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
        ...
        while (NIL != var57) {
            ...
            if (NIL != var59) {
                if (NIL == var55) {
                    ...
                    var55 = conses_high.union(var59, var55, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                }
            }
            if (NIL != var60) {
                if (NIL == var56) {
                    ...
                    var56 = conses_high.union(var60, var56, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                }
            }
            var57 = var57.rest();
            var58 = var57.first();
    ...
    public static SubLObject f52722(final SubLObject var56) {
        ...
        final SubLObject var60 = $g6525$.currentBinding(var57);
        final SubLObject var61 = $g6526$.currentBinding(var57);
        try {
            $g6525$.bind(module0077.f5313(Symbols.symbol_function((SubLObject)EQ), (SubLObject)UNPROVIDED), var57);
            $g6526$.bind(module0077.f5313(Symbols.symbol_function((SubLObject)EQ), (SubLObject)UNPROVIDED), var57);
            ...
            var58 = module0077.f5312($g6525$.getDynamicValue(var57));
            var59 = module0077.f5312($g6526$.getDynamicValue(var57));
        }
        finally {
            $g6526$.rebind(var61, var57);
            $g6525$.rebind(var60, var57);
        }
        var58 = Sort.sort(var58, Symbols.symbol_function((SubLObject)$ic12$), Symbols.symbol_function((SubLObject)$ic13$));
        var59 = Sort.sort(var59, Symbols.symbol_function((SubLObject)$ic12$), Symbols.symbol_function((SubLObject)$ic13$));
    ...
    public static SubLObject f52725(final SubLObject var62) {
        ...
        final SubLObject var66 = $g6525$.currentBinding(var63);
        final SubLObject var67 = $g6526$.currentBinding(var63);
        try {
            $g6525$.bind(module0077.f5313(Symbols.symbol_function((SubLObject)EQ), (SubLObject)UNPROVIDED), var63);
            $g6526$.bind(module0077.f5313(Symbols.symbol_function((SubLObject)EQ), (SubLObject)UNPROVIDED), var63);
            ...
            var64 = module0077.f5312($g6525$.getDynamicValue(var63));
            var65 = module0077.f5312($g6526$.getDynamicValue(var63));
        }
        finally {
            $g6526$.rebind(var67, var63);
            $g6525$.rebind(var66, var63);
        }
        var64 = Sort.sort(var64, Symbols.symbol_function((SubLObject)$ic12$), Symbols.symbol_function((SubLObject)$ic13$));
        var65 = Sort.sort(var65, Symbols.symbol_function((SubLObject)$ic12$), Symbols.symbol_function((SubLObject)$ic13$));
        return Values.values(var64, var65);
    }
    
    public static SubLObject f52723(final SubLObject var19) {
        final SubLThread var20 = SubLProcess.currentSubLThread();
        if (NIL == module0077.f5320(var19, $g6525$.getDynamicValue(var20))) {
            module0077.f5326(var19, $g6525$.getDynamicValue(var20));
    ...
    public static SubLObject f52724(final SubLObject var20) {
        final SubLThread var21 = SubLProcess.currentSubLThread();
        if (NIL == module0077.f5320(var20, $g6526$.getDynamicValue(var21))) {
            module0077.f5326(var20, $g6526$.getDynamicValue(var21));
    ...
    public static SubLObject f52726(final SubLObject var56) {
        ...
        while (NIL != var61) {
            ...
            if (NIL != var63) {
                ...
                if (NIL == conses_high.member(var64, var60, Symbols.symbol_function((SubLObject)EQUAL), Symbols.symbol_function((SubLObject)IDENTITY))) {
        ...
        var60 = Sort.sort(var60, Symbols.symbol_function((SubLObject)$ic12$), (SubLObject)UNPROVIDED);
        return var60;
    }
    
    public static SubLObject f52727(final SubLObject var56) {
        final SubLObject var57 = f52726(var56);
        final SubLObject var58 = module0035.f2378(var57, Symbols.symbol_function((SubLObject)$ic14$), (SubLObject)UNPROVIDED);
        return var58;
    }
    ...
    public static SubLObject f52729(final SubLObject var66) {
        ...
        var69 = module0034.f1857(var68, (SubLObject)$ic15$, (SubLObject)UNPROVIDED);
        if (NIL == var69) {
            var69 = module0034.f1807(module0034.f1842(var68), (SubLObject)$ic15$, (SubLObject)ONE_INTEGER, (SubLObject)NIL, (SubLObject)EQ, (SubLObject)UNPROVIDED);
            module0034.f1860(var68, (SubLObject)$ic15$, var69);
        }
        SubLObject var70 = module0034.f1814(var69, var66, (SubLObject)$ic2$);
        if (var70 == $ic2$) {
            var70 = Values.arg2(var67.resetMultipleValues(), (SubLObject)Values.multiple_value_list(f52728(var66)));
            module0034.f1816(var69, var66, var70, (SubLObject)UNPROVIDED);
        }
    ...
    public static SubLObject f52731(final SubLObject var22, final SubLObject var69) {
        final SubLObject var70 = module0067.f4880(Symbols.symbol_function((SubLObject)EQ), (SubLObject)UNPROVIDED);
        final SubLObject var71 = module0055.f4017();
        SubLObject var72 = (SubLObject)NIL;
        module0067.f4886(var70, var22, (SubLObject)NIL);
        module0055.f4021(var22, var71);
        while (NIL == module0055.f4019(var71)) {
            ...
            if (NIL == var72) {
                ...
                while (NIL == var72 && NIL != var75) {
                    if ($ic16$ == module0067.f4885(var70, var76, (SubLObject)$ic16$)) {
        ...
        if (NIL != var72) {
            SubLObject var78;
            for (var78 = (SubLObject)NIL, var78 = var69; NIL != var78; var78 = module0067.f4885(var70, var78, (SubLObject)UNPROVIDED)) {
    ...
    public static SubLObject f52732(final SubLObject var62) {
        ...
        while (NIL != var67) {
            ...
            if (NIL != var69) {
                ...
                if (NIL == conses_high.member(var70, var66, Symbols.symbol_function((SubLObject)EQUAL), Symbols.symbol_function((SubLObject)IDENTITY))) {
        ...
        var66 = Sort.sort(var66, Symbols.symbol_function((SubLObject)$ic12$), (SubLObject)UNPROVIDED);
        return var66;
    }
    
    public static SubLObject f52733(final SubLObject var62) {
        final SubLObject var63 = f52732(var62);
        final SubLObject var64 = module0035.f2378(var63, Symbols.symbol_function((SubLObject)$ic14$), (SubLObject)UNPROVIDED);
        return var64;
    }
    ...
    public static SubLObject f52735(final SubLObject var75) {
        ...
        var78 = module0034.f1857(var77, (SubLObject)$ic17$, (SubLObject)UNPROVIDED);
        if (NIL == var78) {
            var78 = module0034.f1807(module0034.f1842(var77), (SubLObject)$ic17$, (SubLObject)ONE_INTEGER, (SubLObject)NIL, (SubLObject)EQ, (SubLObject)UNPROVIDED);
            module0034.f1860(var77, (SubLObject)$ic17$, var78);
        }
        SubLObject var79 = module0034.f1814(var78, var75, (SubLObject)$ic2$);
        if (var79 == $ic2$) {
    ...
    public static SubLObject f52737(final SubLObject var76, final SubLObject var77) {
        ...
        final SubLObject var81 = (SubLObject)ConsesLow.list((SubLObject)$ic18$, (SubLObject)ConsesLow.list((SubLObject)$ic19$, var79), var80);
        ...
        try {
            module0283.$g2626$.bind((SubLObject)$ic20$, var78);
            module0283.$g2627$.bind((SubLObject)$ic18$, var78);
            module0283.$g2628$.bind((SubLObject)$ic19$, var78);
            module0283.$g2629$.bind((SubLObject)T, var78);
            module0283.$g2630$.bind((SubLObject)NIL, var78);
    ...
    public static SubLObject f52738(final SubLObject var85) {
        return module0036.f2531(var85, Symbols.symbol_function((SubLObject)$ic21$), Symbols.symbol_function((SubLObject)$ic22$), (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f52739(final SubLObject var85) {
        return (SubLObject)makeBoolean(var85.isSymbol() && !var85.isKeyword() && var85 != T && var85 != NIL);
    }
    ...
    public static SubLObject f52741(SubLObject var11) {
        ...
        try {
            ...
            try {
                ...
                module0012.$g82$.setDynamicValue((SubLObject)$ic23$, var12);
    ...
    public static SubLObject f52742(final SubLObject var92) {
        ...
        while (NIL != var95) {
            ...
            while (NIL != var26_95) {
                ...
                if (NIL != var99) {
                    ...
                    if (NIL != var101) {
                        var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic24$, var96, var92, var93), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var98, var99, var100), var101), var94);
                    }
                }
            ...
            while (NIL != var26_96) {
                ...
                if (NIL != var99) {
                    ...
                    final SubLObject var101 = f52743(var93, var100);
                    if (NIL != var101) {
                        var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic24$, var96, var92, var93), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var103, var99, var100), var101), var94);
                    }
                }
        ...
        while (NIL != var95) {
            ...
            while (NIL != var26_97) {
                ...
                if (NIL != var99) {
                    ...
                    final SubLObject var101 = f52743(var93, var100);
                    if (NIL != var101) {
                        var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic25$, var104, var92, var93), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var98, var99, var100), var101), var94);
                    }
                }
            ...
            while (NIL != var26_98) {
                ...
                if (NIL != var99) {
                    ...
                    final SubLObject var101 = f52743(var93, var100);
                    if (NIL != var101) {
                        var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic25$, var104, var92, var93), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var103, var99, var100), var101), var94);
                    }
                }
        ...
        while (NIL != var106) {
            ...
            if (NIL != var108) {
                ...
                if (NIL != var110) {
                    var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic26$, var92, var93), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var107, var108, var109), var110), var94);
                }
            }
            var106 = var106.rest();
            var107 = var106.first();
        ...
        while (NIL != var106) {
            ...
            if (NIL != var108) {
                ...
                final SubLObject var110 = f52743(var93, var109);
                if (NIL != var110) {
                    var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic26$, var92, var93), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var112, var108, var109), var110), var94);
                }
            }
            var106 = var106.rest();
            var112 = var106.first();
    ...
    public static SubLObject f52743(final SubLObject var76, final SubLObject var77) {
        ...
        var80 = module0034.f1857(var79, (SubLObject)$ic27$, (SubLObject)UNPROVIDED);
        if (NIL == var80) {
            var80 = module0034.f1807(module0034.f1842(var79), (SubLObject)$ic27$, (SubLObject)TWO_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var79, (SubLObject)$ic27$, var80);
        }
        final SubLObject var81 = module0034.f1782(var76, var77);
        final SubLObject var82 = module0034.f1814(var80, var81, (SubLObject)UNPROVIDED);
        if (var82 != $ic2$) {
            ...
            while (NIL != var83) {
                ...
                if (var76.equal(var85.first())) {
                    var85 = var85.rest();
                    if (NIL != var85 && NIL == var85.rest() && var77.equal(var85.first())) {
    ...
    public static SubLObject f52745(SubLObject var110, SubLObject var111) {
        if (var110 == UNPROVIDED) {
            var110 = f52741((SubLObject)UNPROVIDED);
        }
    ...
    public static SubLObject f52746(final SubLObject var112, SubLObject var111) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var112, var112, (SubLObject)$ic28$);
        final SubLObject var113 = var112.rest();
        SubLObject var114 = var112.first();
        SubLObject var115 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var114, var112, (SubLObject)$ic28$);
        var115 = var114.first();
        ...
        if (NIL == var114) {
            ...
            if (var120.eql((SubLObject)$ic26$)) {
                ...
                cdestructuring_bind.destructuring_bind_must_consp(var124_125, var122_123, (SubLObject)$ic29$);
                ...
                var124_125 = var124_125.rest();
                if (NIL == var124_125) {
                    PrintLow.format(var111, (SubLObject)$ic30$, var121);
                    f52747(var122, var111);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var122_123, (SubLObject)$ic29$);
                }
            }
            else if (var120.eql((SubLObject)$ic24$)) {
                ...
                cdestructuring_bind.destructuring_bind_must_consp(var129_130, var127_128, (SubLObject)$ic31$);
                ...
                var129_130 = var129_130.rest();
                if (NIL == var129_130) {
                    PrintLow.format(var111, (SubLObject)$ic32$, var123, var124);
                    f52747(var125, var111);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var127_128, (SubLObject)$ic31$);
                }
            }
            else if (var120.eql((SubLObject)$ic25$)) {
                SubLObject var134_135;
                final SubLObject var132_133 = var134_135 = var116;
                SubLObject var123 = (SubLObject)NIL;
                SubLObject var124 = (SubLObject)NIL;
                SubLObject var125 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var134_135, var132_133, (SubLObject)$ic31$);
                ...
                var134_135 = var134_135.rest();
                if (NIL == var134_135) {
                    PrintLow.format(var111, (SubLObject)$ic33$, var123, var124);
                    f52747(var125, var111);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var132_133, (SubLObject)$ic31$);
                }
            }
            PrintLow.format(var111, (SubLObject)$ic34$);
            var120 = var117;
            if (var120.eql((SubLObject)$ic24$)) {
                ...
                cdestructuring_bind.destructuring_bind_must_consp(var138_139, var136_137, (SubLObject)$ic35$);
                ...
                var138_139 = var138_139.rest();
                if (NIL == var138_139) {
                    PrintLow.format(var111, (SubLObject)$ic36$, var126, var124);
                    f52747(var127, var111);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var136_137, (SubLObject)$ic35$);
                }
            }
            else if (var120.eql((SubLObject)$ic25$)) {
                ...
                SubLObject var124 = (SubLObject)NIL;
                SubLObject var127 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var144_145, var142_143, (SubLObject)$ic35$);
                ...
                var144_145 = var144_145.rest();
                if (NIL == var144_145) {
                    PrintLow.format(var111, (SubLObject)$ic37$, var126, var124);
                    f52747(var127, var111);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var142_143, (SubLObject)$ic35$);
                }
            }
            PrintLow.format(var111, (SubLObject)$ic38$, f52748(var119));
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var112, (SubLObject)$ic28$);
        }
        return var112;
    }
    
    public static SubLObject f52747(final SubLObject var146, final SubLObject var111) {
        return PrintLow.format(var111, (SubLObject)$ic39$, f52748(var146));
    }
    
    public static SubLObject f52748(final SubLObject var146) {
        return (SubLObject)((T == var146) ? $ic40$ : var146);
    }
    ...
    public static SubLObject f52749(SubLObject var11) {
        ...
        module0012.$g82$.setDynamicValue((SubLObject)$ic41$, var12);
        module0012.$g73$.setDynamicValue(Time.get_universal_time(), var12);
    ...
    public static SubLObject f52750(final SubLObject var92) {
        ...
        while (NIL != var94) {
            ...
            while (NIL != var26_150) {
                ...
                if (NIL != var98 && !var92.equal(var98) && NIL != module0811.f51804(var97)) {
                    var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic24$, var95, var92), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var97, var98)), var93);
                }
            ...
            while (NIL != var26_151) {
                ...
                if (NIL != var98 && !var92.equal(var98) && NIL != module0811.f51803(var100)) {
                    var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic24$, var95, var92), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var100, var98)), var93);
                }
        ...
        while (NIL != var94) {
            ...
            while (NIL != var26_152) {
                final SubLObject var98 = f52670(var97);
                if (NIL != var98 && !var92.equal(var98) && NIL != module0811.f51804(var97)) {
                    var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic25$, var101, var92), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var97, var98)), var93);
                }
            ...
            while (NIL != var26_153) {
                final SubLObject var98 = f52676(var100);
                if (NIL != var98 && !var92.equal(var98) && NIL != module0811.f51803(var100)) {
                    var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic25$, var101, var92), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var100, var98)), var93);
                }
        ...
        while (NIL != var103) {
            ...
            if (NIL != var105 && !var92.equal(var105) && NIL != module0811.f51804(var104)) {
                var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic26$, var92), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var104, var105)), var93);
            }
            var103 = var103.rest();
            var104 = var103.first();
        }
        ...
        while (NIL != var103) {
            ...
            if (NIL != var105 && !var92.equal(var105) && NIL != module0811.f51803(var107)) {
                var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic26$, var92), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var107, var105)), var93);
            }
            var103 = var103.rest();
            var107 = var103.first();
        }
    ...
    public static SubLObject f52751(SubLObject var154, SubLObject var111) {
        if (var154 == UNPROVIDED) {
            var154 = f52749((SubLObject)UNPROVIDED);
        }
        if (var111 == UNPROVIDED) {
            var111 = StreamsLow.$standard_output$.getDynamicValue();
        }
    ...
    public static SubLObject f52752(final SubLObject var155, SubLObject var111) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var155, var155, (SubLObject)$ic42$);
        final SubLObject var156 = var155.rest();
        SubLObject var157 = var155.first();
        SubLObject var158 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var157, var155, (SubLObject)$ic42$);
        var158 = var157.first();
        ...
        if (NIL == var157) {
            ...
            if (var162.eql((SubLObject)$ic26$)) {
                SubLObject var163_164;
                final SubLObject var161_162 = var163_164 = var159;
                SubLObject var163 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var163_164, var161_162, (SubLObject)$ic43$);
                var163 = var163_164.first();
                var163_164 = var163_164.rest();
                if (NIL == var163_164) {
                    PrintLow.format(var111, (SubLObject)$ic30$, var163);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var161_162, (SubLObject)$ic43$);
                }
            }
            else if (var162.eql((SubLObject)$ic24$)) {
                ...
                cdestructuring_bind.destructuring_bind_must_consp(var167_168, var165_166, (SubLObject)$ic44$);
                ...
                var167_168 = var167_168.rest();
                if (NIL == var167_168) {
                    PrintLow.format(var111, (SubLObject)$ic32$, var164, var165);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var165_166, (SubLObject)$ic44$);
                }
            }
            else if (var162.eql((SubLObject)$ic25$)) {
                SubLObject var171_172;
                final SubLObject var169_170 = var171_172 = var159;
                SubLObject var164 = (SubLObject)NIL;
                SubLObject var165 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var171_172, var169_170, (SubLObject)$ic44$);
                ...
                var171_172 = var171_172.rest();
                if (NIL == var171_172) {
                    PrintLow.format(var111, (SubLObject)$ic33$, var164, var165);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var169_170, (SubLObject)$ic44$);
                }
            }
            PrintLow.format(var111, (SubLObject)$ic45$);
            var162 = var160;
            if (var162.eql((SubLObject)$ic24$)) {
                SubLObject var175_176;
                final SubLObject var173_174 = var175_176 = var161;
                SubLObject var166 = (SubLObject)NIL;
                SubLObject var165 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var175_176, var173_174, (SubLObject)$ic46$);
                ...
                var175_176 = var175_176.rest();
                if (NIL == var175_176) {
                    PrintLow.format(var111, (SubLObject)$ic36$, var166, var165);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var173_174, (SubLObject)$ic46$);
                }
            }
            else if (var162.eql((SubLObject)$ic25$)) {
                ...
                SubLObject var166 = (SubLObject)NIL;
                SubLObject var165 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var179_180, var177_178, (SubLObject)$ic46$);
                ...
                var179_180 = var179_180.rest();
                if (NIL == var179_180) {
                    PrintLow.format(var111, (SubLObject)$ic37$, var166, var165);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var177_178, (SubLObject)$ic46$);
                }
            }
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var155, (SubLObject)$ic42$);
        }
        return var155;
    }
    ...
    public static SubLObject f52753(SubLObject var11) {
        ...
        try {
            ...
            try {
                final SubLObject var19 = var11;
                module0012.$g82$.setDynamicValue((SubLObject)$ic47$, var12);
                module0012.$g73$.setDynamicValue(Time.get_universal_time(), var12);
                module0012.$g83$.setDynamicValue(Sequences.length(var19), var12);
                module0012.$g84$.setDynamicValue((SubLObject)ZERO_INTEGER, var12);
        ...
        while (NIL != var94) {
            ...
            while (NIL != var26_188) {
                ...
                if (NIL != var99) {
                    ...
                    if (NIL != f52755(var92, var96, var99, var100, (SubLObject)$ic25$, var98)) {
                        var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic24$, var95, var92), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var98, var99)), var93);
                    }
                }
    ...
    public static SubLObject f52756(SubLObject var154, SubLObject var111) {
        if (var154 == UNPROVIDED) {
            var154 = f52753((SubLObject)UNPROVIDED);
        }
        if (var111 == UNPROVIDED) {
            var111 = StreamsLow.$standard_output$.getDynamicValue();
        }
    ...
    public static SubLObject f52757(final SubLObject var155, SubLObject var111) {
        ...
        if (NIL == var157) {
            ...
            if (var162.eql((SubLObject)$ic26$)) {
                ...
                SubLObject var163 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var198_199, var196_197, (SubLObject)$ic43$);
                ...
                if (NIL == var198_199) {
                    ...
                    cdestructuring_bind.cdestructuring_bind_error(var196_197, (SubLObject)$ic43$);
                }
            }
            else if (var162.eql((SubLObject)$ic24$)) {
                ...
                SubLObject var164 = (SubLObject)NIL;
                SubLObject var165 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var202_203, var200_201, (SubLObject)$ic44$);
                ...
                if (NIL == var202_203) {
                    ...
                    cdestructuring_bind.cdestructuring_bind_error(var200_201, (SubLObject)$ic44$);
                }
            }
            PrintLow.format(var111, (SubLObject)$ic48$);
            var162 = var160;
            if (var162.eql((SubLObject)$ic25$)) {
                SubLObject var206_207;
                final SubLObject var204_205 = var206_207 = var161;
                SubLObject var166 = (SubLObject)NIL;
                SubLObject var165 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var206_207, var204_205, (SubLObject)$ic46$);
                ...
                if (NIL == var206_207) {
                    ...
                    cdestructuring_bind.cdestructuring_bind_error(var204_205, (SubLObject)$ic46$);
                }
            }
            PrintLow.format(var111, (SubLObject)$ic49$);
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var155, (SubLObject)$ic42$);
        }
    ...
    public static SubLObject f52758(SubLObject var11) {
        ...
        try {
            ...
            try {
                final SubLObject var19 = var11;
                module0012.$g82$.setDynamicValue((SubLObject)$ic50$, var12);
                module0012.$g73$.setDynamicValue(Time.get_universal_time(), var12);
                module0012.$g83$.setDynamicValue(Sequences.length(var19), var12);
                module0012.$g84$.setDynamicValue((SubLObject)ZERO_INTEGER, var12);
    ...
    public static SubLObject f52759(final SubLObject var92) {
                ...
                if (NIL != f52669(var99)) {
                    ...
                    if (NIL != var100) {
                        ...
                        if (NIL != var102 || NIL != var103) {
                            var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic24$, var96, var92), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var99, var100), var102, var103), var94);
                        }
                    }
                }
        ...
        while (NIL != var95) {
            ...
            while (NIL != var26_214) {
                ...
                if (NIL != var100) {
                    final SubLObject var101 = f52671(var99);
                    var93.resetMultipleValues();
                    final SubLObject var102 = f52755(var92, var97, var100, var101, (SubLObject)$ic24$, var99);
                    final SubLObject var103 = var93.secondMultipleValue();
                    var93.resetMultipleValues();
                    if (NIL != var102 || NIL != var103) {
                        var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic25$, var104, var92), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var99, var100), var102, var103), var94);
                    }
                }
            ...
            while (NIL != var26_215) {
                ...
                if (NIL != var100) {
                    ...
                    var93.resetMultipleValues();
                    final SubLObject var102 = f52755(var92, var97, var100, var101, (SubLObject)$ic25$, var106);
                    final SubLObject var103 = var93.secondMultipleValue();
                    var93.resetMultipleValues();
                    if (NIL != var102 || NIL != var103) {
                        var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic25$, var104, var92), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var106, var100), var102, var103), var94);
                    }
                }
        ...
        while (NIL != var108) {
            ...
            if (NIL != var110) {
                ...
                while (NIL != var26_216) {
                    var93.resetMultipleValues();
                    final SubLObject var102 = f52755(var92, var113, var110, var111, (SubLObject)$ic24$, var109);
                    final SubLObject var103 = var93.secondMultipleValue();
                    var93.resetMultipleValues();
                    if (NIL != var102 || NIL != var103) {
                        var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic26$, var92, var113), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var109, var110), var102, var103), var94);
                    }
        ...
        while (NIL != var108) {
            ...
            if (NIL != var110) {
                ...
                while (NIL != var26_217) {
                    var93.resetMultipleValues();
                    final SubLObject var102 = f52755(var92, var113, var110, var111, (SubLObject)$ic25$, var115);
                    final SubLObject var103 = var93.secondMultipleValue();
                    var93.resetMultipleValues();
                    if (NIL != var102 || NIL != var103) {
                        var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic26$, var92, var113), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var115, var110), var102, var103), var94);
                    }
    ...
    public static SubLObject f52760(final SubLObject var220, final SubLObject var221, final SubLObject var222, final SubLObject var223, final SubLObject var224) {
        ...
        if (NIL != var228 && NIL == f52657(var228, var220)) {
        ...
        if ((NIL != f52660(var222, var220) || (var220.equal(var222) && var223.numG(var221))) && NIL == conses_high.member(var224, var226, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
    ...
    public static SubLObject f52755(final SubLObject var220, final SubLObject var221, final SubLObject var64, final SubLObject var190, final SubLObject var230, final SubLObject var231) {
        ...
        final SubLObject var235 = ($ic24$ == var230) ? f52729(var231) : f52735(var231);
        if (NIL != var235 && NIL == f52657(var235, var220)) {
            var232.resetMultipleValues();
            final SubLObject var236 = ($ic24$ == var230) ? f52730(var231, var235) : f52736(var231, var235);
            final SubLObject var237 = var232.secondMultipleValue();
            var232.resetMultipleValues();
            if (NIL != f52660(var235, var220)) {
                var233 = var236;
                var234 = var237;
            }
            else {
                ...
                while (NIL != var238) {
                    ...
                    if (var240.numG(var221)) {
                        ...
                        if (NIL == conses_high.member(var241, var233, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                ...
                while (NIL != var238) {
                    ...
                    if (var240.numG(var221)) {
                        ...
                        if (NIL == conses_high.member(var241, var234, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
        ...
        if ((NIL != f52660(var64, var220) || (var220.equal(var64) && var190.numG(var221))) && NIL == conses_high.member(var231, var233, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
    ...
    public static SubLObject f52761(final SubLObject var220, final SubLObject var221, final SubLObject var75) {
        ...
        if (NIL != var222) {
            ...
            return (SubLObject)makeBoolean(NIL != f52660(var222, var220) || (var220.equal(var222) && var223.numG(var221)));
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f52762(SubLObject var154, SubLObject var111) {
        if (var154 == UNPROVIDED) {
            var154 = f52758((SubLObject)UNPROVIDED);
        }
        if (var111 == UNPROVIDED) {
            var111 = StreamsLow.$standard_output$.getDynamicValue();
        }
    ...
    public static SubLObject f52763(final SubLObject var155, SubLObject var111) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var155, var155, (SubLObject)$ic51$);
        final SubLObject var156 = var155.rest();
        SubLObject var157 = var155.first();
        SubLObject var158 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var157, var155, (SubLObject)$ic51$);
        var158 = var157.first();
        final SubLObject var159;
        var157 = (var159 = var157.rest());
        var157 = var156;
        ...
        if (NIL == var157) {
            ...
            if (NIL == var157) {
                ...
                if (var165.eql((SubLObject)$ic26$)) {
                    SubLObject var245_246;
                    final SubLObject var243_244 = var245_246 = var159;
                    SubLObject var1_247 = (SubLObject)NIL;
                    SubLObject var166 = (SubLObject)NIL;
                    cdestructuring_bind.destructuring_bind_must_consp(var245_246, var243_244, (SubLObject)$ic52$);
                    ...
                    var245_246 = var245_246.rest();
                    if (NIL == var245_246) {
                        PrintLow.format(var111, (SubLObject)$ic53$, var1_247, var166);
                    }
                    else {
                        cdestructuring_bind.cdestructuring_bind_error(var243_244, (SubLObject)$ic52$);
                    }
                }
                else if (var165.eql((SubLObject)$ic24$)) {
                    SubLObject var251_252;
                    final SubLObject var249_250 = var251_252 = var159;
                    SubLObject var167 = (SubLObject)NIL;
                    SubLObject var1_248 = (SubLObject)NIL;
                    cdestructuring_bind.destructuring_bind_must_consp(var251_252, var249_250, (SubLObject)$ic44$);
                    ...
                    var251_252 = var251_252.rest();
                    if (NIL == var251_252) {
                        PrintLow.format(var111, (SubLObject)$ic32$, var167, var1_248);
                    }
                    else {
                        cdestructuring_bind.cdestructuring_bind_error(var249_250, (SubLObject)$ic44$);
                    }
                }
                else if (var165.eql((SubLObject)$ic25$)) {
                    SubLObject var256_257;
                    final SubLObject var254_255 = var256_257 = var159;
                    SubLObject var167 = (SubLObject)NIL;
                    SubLObject var1_249 = (SubLObject)NIL;
                    cdestructuring_bind.destructuring_bind_must_consp(var256_257, var254_255, (SubLObject)$ic44$);
                    ...
                    var256_257 = var256_257.rest();
                    if (NIL == var256_257) {
                        PrintLow.format(var111, (SubLObject)$ic33$, var167, var1_249);
                    }
                    else {
                        cdestructuring_bind.cdestructuring_bind_error(var254_255, (SubLObject)$ic44$);
                    }
                }
                PrintLow.format(var111, (SubLObject)$ic34$);
                var165 = var160;
                if (var165.eql((SubLObject)$ic24$)) {
                    PrintLow.format(var111, (SubLObject)$ic36$, var161, var162);
                }
                else if (var165.eql((SubLObject)$ic25$)) {
                    PrintLow.format(var111, (SubLObject)$ic37$, var161, var162);
                }
                PrintLow.format(var111, (SubLObject)$ic54$);
                if (NIL == var164 && NIL != module0035.f1997(var163) && var161.eql(var163.first())) {
                    PrintLow.format(var111, (SubLObject)$ic55$);
                }
                else {
                    PrintLow.format(var111, (SubLObject)$ic56$);
                    SubLObject var168 = var163;
                    SubLObject var169 = (SubLObject)NIL;
                    var169 = var168.first();
                    while (NIL != var168) {
                        PrintLow.format(var111, (SubLObject)$ic57$, var169);
                        var168 = var168.rest();
                        var169 = var168.first();
                    }
                    var168 = var164;
                    ...
                    var170 = var168.first();
                    while (NIL != var168) {
                        PrintLow.format(var111, (SubLObject)$ic58$, var170);
                        var168 = var168.rest();
                        var170 = var168.first();
                    }
                }
                ...
                cdestructuring_bind.cdestructuring_bind_error(var155, (SubLObject)$ic51$);
            }
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var155, (SubLObject)$ic51$);
    ...
    public static SubLObject f52764(SubLObject var11) {
        ...
        try {
            ...
            try {
                final SubLObject var19 = var11;
                module0012.$g82$.setDynamicValue((SubLObject)$ic59$, var12);
                module0012.$g73$.setDynamicValue(Time.get_universal_time(), var12);
                module0012.$g83$.setDynamicValue(Sequences.length(var19), var12);
                module0012.$g84$.setDynamicValue((SubLObject)ZERO_INTEGER, var12);
            ...
            if (NIL != f52669(var107)) {
                ...
                if (NIL != var108) {
                    ...
                    while (NIL != var26_268) {
                        ...
                        var93.resetMultipleValues();
                        if (NIL != var102 || NIL != var103) {
                            var94 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic26$, var92, var111), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var107, var108), var102, var103), var94);
                        }
    ...
    public static SubLObject f52766(SubLObject var154, SubLObject var111) {
        if (var154 == UNPROVIDED) {
            var154 = f52764((SubLObject)UNPROVIDED);
        }
        if (var111 == UNPROVIDED) {
            var111 = StreamsLow.$standard_output$.getDynamicValue();
        }
    ...
    public static SubLObject f52768(SubLObject var11) {
        ...
        try {
            ...
            try {
                final SubLObject var19 = var11;
                module0012.$g82$.setDynamicValue((SubLObject)$ic60$, var12);
                module0012.$g73$.setDynamicValue(Time.get_universal_time(), var12);
                module0012.$g83$.setDynamicValue(Sequences.length(var19), var12);
                module0012.$g84$.setDynamicValue((SubLObject)ZERO_INTEGER, var12);
    ...
    public static SubLObject f52769(final SubLObject var92) {
        ...
        while (NIL != var94) {
            ...
            while (NIL != var26_274) {
                if (NIL == f52667(var97)) {
                    final SubLObject var98 = f52670(var97);
                    if (NIL == var98) {
                        var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic24$, var95, var92), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var97)), var93);
                    }
                }
            ...
            while (NIL != var26_275) {
                if (NIL == f52668(var100)) {
                    final SubLObject var98 = f52676(var100);
                    if (NIL == var98) {
                        var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic24$, var95, var92), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var100)), var93);
                    }
                }
        ...
        while (NIL != var94) {
            ...
            while (NIL != var26_276) {
                if (NIL == f52667(var97)) {
                    final SubLObject var98 = f52670(var97);
                    if (NIL == var98) {
                        var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic25$, var101, var92), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var97)), var93);
                    }
                }
            ...
            while (NIL != var26_277) {
                if (NIL == f52668(var100)) {
                    final SubLObject var98 = f52676(var100);
                    if (NIL == var98) {
                        var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic25$, var101, var92), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var100)), var93);
                    }
                }
        ...
        var104 = var103.first();
        while (NIL != var103) {
            if (NIL == f52667(var104)) {
                final SubLObject var105 = f52670(var104);
                if (NIL == var105) {
                    var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic26$, var92), (SubLObject)ConsesLow.list((SubLObject)$ic24$, var104)), var93);
                }
            }
            var103 = var103.rest();
            var104 = var103.first();
        ...
        var107 = var103.first();
        while (NIL != var103) {
            if (NIL == f52668(var107)) {
                final SubLObject var105 = f52676(var107);
                if (NIL == var105) {
                    var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)$ic26$, var92), (SubLObject)ConsesLow.list((SubLObject)$ic25$, var107)), var93);
                }
            }
            var103 = var103.rest();
            var107 = var103.first();
    ...
    public static SubLObject f52770(SubLObject var278, SubLObject var111) {
        if (var278 == UNPROVIDED) {
            var278 = f52768((SubLObject)UNPROVIDED);
        }
        if (var111 == UNPROVIDED) {
            var111 = StreamsLow.$standard_output$.getDynamicValue();
        }
    ...
    public static SubLObject f52771(final SubLObject var279, SubLObject var111) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var279, var279, (SubLObject)$ic42$);
        final SubLObject var280 = var279.rest();
        SubLObject var281 = var279.first();
        SubLObject var282 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var281, var279, (SubLObject)$ic42$);
        var282 = var281.first();
        ...
        if (NIL == var281) {
            ...
            if (var286.eql((SubLObject)$ic26$)) {
                SubLObject var287_288;
                final SubLObject var285_286 = var287_288 = var283;
                SubLObject var287 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var287_288, var285_286, (SubLObject)$ic43$);
                var287 = var287_288.first();
                var287_288 = var287_288.rest();
                if (NIL == var287_288) {
                    PrintLow.format(var111, (SubLObject)$ic30$, var287);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var285_286, (SubLObject)$ic43$);
                }
            }
            else if (var286.eql((SubLObject)$ic24$)) {
                ...
                cdestructuring_bind.destructuring_bind_must_consp(var291_292, var289_290, (SubLObject)$ic44$);
                ...
                var291_292 = var291_292.rest();
                if (NIL == var291_292) {
                    PrintLow.format(var111, (SubLObject)$ic32$, var288, var289);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var289_290, (SubLObject)$ic44$);
                }
            }
            else if (var286.eql((SubLObject)$ic25$)) {
                SubLObject var295_296;
                final SubLObject var293_294 = var295_296 = var283;
                SubLObject var288 = (SubLObject)NIL;
                SubLObject var289 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var295_296, var293_294, (SubLObject)$ic44$);
                ...
                var295_296 = var295_296.rest();
                if (NIL == var295_296) {
                    PrintLow.format(var111, (SubLObject)$ic33$, var288, var289);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var293_294, (SubLObject)$ic44$);
                }
            }
            PrintLow.format(var111, (SubLObject)$ic61$);
            var286 = var284;
            if (var286.eql((SubLObject)$ic24$)) {
                SubLObject var299_300;
                final SubLObject var297_298 = var299_300 = var285;
                SubLObject var290 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var299_300, var297_298, (SubLObject)$ic62$);
                var290 = var299_300.first();
                var299_300 = var299_300.rest();
                if (NIL == var299_300) {
                    PrintLow.format(var111, (SubLObject)$ic63$, var290);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var297_298, (SubLObject)$ic62$);
                }
            }
            else if (var286.eql((SubLObject)$ic25$)) {
                ...
                SubLObject var290 = (SubLObject)NIL;
                cdestructuring_bind.destructuring_bind_must_consp(var303_304, var301_302, (SubLObject)$ic62$);
                var290 = var303_304.first();
                var303_304 = var303_304.rest();
                if (NIL == var303_304) {
                    PrintLow.format(var111, (SubLObject)$ic64$, var290);
                }
                else {
                    cdestructuring_bind.cdestructuring_bind_error(var301_302, (SubLObject)$ic62$);
                }
            }
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var279, (SubLObject)$ic42$);
        }
        return var279;
    }
            ...
            try {
                ...
                while (NIL != var19) {
                    ...
                    while (NIL != var26_307) {
                        ...
                        if (NIL == conses_high.member(var23, var13, Symbols.symbol_function((SubLObject)EQUAL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                            var13 = (SubLObject)ConsesLow.cons(var23, var13);
                        }
    ...
    public static SubLObject f52773(final SubLObject var92) {
        ...
        while (NIL != var94) {
            if (NIL != f52672(var95)) {
                ...
                var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic24$, var95, var96), var93);
            }
            var94 = var94.rest();
            var95 = var94.first();
        }
        ...
        while (NIL != var94) {
            if (NIL != f52678(var97)) {
                ...
                var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic25$, var97, var96), var93);
            }
            var94 = var94.rest();
            var97 = var94.first();
        }
    ...
    public static SubLObject f52774(SubLObject var311, SubLObject var111) {
        if (var311 == UNPROVIDED) {
            var311 = f52772((SubLObject)UNPROVIDED);
        }
        if (var111 == UNPROVIDED) {
            var111 = StreamsLow.$standard_output$.getDynamicValue();
        }
    ...
    public static SubLObject f52775(final SubLObject var312, SubLObject var111) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var312, var312, (SubLObject)$ic65$);
        var313 = var312.first();
        SubLObject var316 = var312.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var316, var312, (SubLObject)$ic65$);
        var314 = var316.first();
        var316 = var316.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var316, var312, (SubLObject)$ic65$);
        var315 = var316.first();
        ...
        if (NIL == var316) {
            ...
            if (var317.eql((SubLObject)$ic24$)) {
                PrintLow.format(var111, (SubLObject)$ic66$, var314);
            }
            else if (var317.eql((SubLObject)$ic25$)) {
                PrintLow.format(var111, (SubLObject)$ic67$, var314);
            }
            ...
            while (NIL != var318) {
                ...
                cdestructuring_bind.destructuring_bind_must_consp(var318_319, var316_317, (SubLObject)$ic68$);
                var320 = var318_319.first();
                var318_319 = (var321 = var318_319.rest());
                PrintLow.format(var111, (SubLObject)$ic69$, var320, var321);
                var318 = var318.rest();
                var319 = var318.first();
            }
            streams_high.terpri(var111);
            ...
            cdestructuring_bind.cdestructuring_bind_error(var312, (SubLObject)$ic65$);
        }
        return var312;
    }
    ...
    public static SubLObject f52777(final SubLObject var92) {
        final SubLObject var93 = (SubLObject)$ic70$;
        final SubLObject var94 = f52670(var93);
        if (NIL != f52657(var92, var94)) {
            SubLObject var95 = (SubLObject)NIL;
            SubLObject var96 = f52680(var92);
            SubLObject var97 = (SubLObject)NIL;
            var97 = var96.first();
            while (NIL != var96) {
                if (NIL != f52685(var93, var97)) {
                    var95 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic24$, var97, var92), var95);
                }
                var96 = var96.rest();
                var97 = var96.first();
            }
            ...
            var98 = var96.first();
            while (NIL != var96) {
                if (NIL != f52689(var93, var98)) {
                    var95 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic25$, var98, var92), var95);
                }
                var96 = var96.rest();
                var98 = var96.first();
            }
            if (NIL != f52693(var93, var92)) {
                var95 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic26$, var92), var95);
            }
    ...
    public static SubLObject f52778(SubLObject var278, SubLObject var111) {
        if (var278 == UNPROVIDED) {
            var278 = f52776((SubLObject)UNPROVIDED);
        }
        if (var111 == UNPROVIDED) {
            var111 = StreamsLow.$standard_output$.getDynamicValue();
        }
    ...
    public static SubLObject f52779(final SubLObject var279, SubLObject var111) {
        ...
        SubLObject var280 = (SubLObject)NIL;
        cdestructuring_bind.destructuring_bind_must_consp(var279, var279, (SubLObject)$ic71$);
        var280 = var279.first();
        final SubLObject var282;
        final SubLObject var281 = var282 = var279.rest();
        final SubLObject var283 = var280;
        if (var283.eql((SubLObject)$ic26$)) {
            SubLObject var330_331;
            final SubLObject var328_329 = var330_331 = var282;
            SubLObject var284 = (SubLObject)NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var330_331, var328_329, (SubLObject)$ic43$);
            var284 = var330_331.first();
            var330_331 = var330_331.rest();
            if (NIL == var330_331) {
                PrintLow.format(var111, (SubLObject)$ic30$, var284);
            }
            else {
                cdestructuring_bind.cdestructuring_bind_error(var328_329, (SubLObject)$ic43$);
            }
        }
        else if (var283.eql((SubLObject)$ic24$)) {
            ...
            cdestructuring_bind.destructuring_bind_must_consp(var334_335, var332_333, (SubLObject)$ic46$);
            ...
            var334_335 = var334_335.rest();
            if (NIL == var334_335) {
                PrintLow.format(var111, (SubLObject)$ic32$, var285, var286);
            }
            else {
                cdestructuring_bind.cdestructuring_bind_error(var332_333, (SubLObject)$ic46$);
            }
        }
        else if (var283.eql((SubLObject)$ic25$)) {
            SubLObject var338_339;
            final SubLObject var336_337 = var338_339 = var282;
            SubLObject var285 = (SubLObject)NIL;
            SubLObject var286 = (SubLObject)NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var338_339, var336_337, (SubLObject)$ic46$);
            ...
            var338_339 = var338_339.rest();
            if (NIL == var338_339) {
                PrintLow.format(var111, (SubLObject)$ic33$, var285, var286);
            }
            else {
                cdestructuring_bind.cdestructuring_bind_error(var336_337, (SubLObject)$ic46$);
            }
        }
        PrintLow.format(var111, (SubLObject)$ic72$);
        return var279;
    }
    ...
    public static SubLObject f52780(SubLObject var111) {
        ...
        if (NIL != var112) {
            final SubLObject var118 = (SubLObject)ConsesLow.list((SubLObject)$ic73$, var112);
    ...
    public static SubLObject f52783(final SubLObject var155, SubLObject var111) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var155, var155, (SubLObject)$ic74$);
        var156 = var155.first();
        final SubLObject var158 = var157 = var155.rest();
        PrintLow.format(var111, (SubLObject)$ic75$, var156, var157);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f52781(final SubLObject var341) {
        assert NIL != module0012.f381(var341) : var341;
        SubLObject var342 = (SubLObject)NIL;
        SubLObject var343 = f52784(var341);
        SubLObject var344 = (SubLObject)NIL;
        var344 = var343.first();
        while (NIL != var343) {
            if (NIL == module0012.f381(var344) && NIL == module0012.f380(var344)) {
    ...
    public static SubLObject f52785(SubLObject var11) {
        ...
        try {
            ...
            try {
                final SubLObject var19 = var11;
                module0012.$g82$.setDynamicValue((SubLObject)$ic77$, var12);
                module0012.$g73$.setDynamicValue(Time.get_universal_time(), var12);
                module0012.$g83$.setDynamicValue(Sequences.length(var19), var12);
                module0012.$g84$.setDynamicValue((SubLObject)ZERO_INTEGER, var12);
    ...
    public static SubLObject f52786(final SubLObject var92) {
        ...
        if (NIL != var94) {
            var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic78$, var94), var93);
        }
        final SubLObject var95 = f52769(var92);
        if (NIL != var95) {
            var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic79$, var95), var93);
        }
        final SubLObject var96 = f52750(var92);
        if (NIL != var96) {
            var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic80$, var96), var93);
        }
        final SubLObject var97 = f52777(var92);
        if (NIL != var97) {
            var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic81$, var97), var93);
        }
        final SubLObject var98 = f52759(var92);
        if (NIL != var98) {
            var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic82$, var98), var93);
        }
        final SubLObject var99 = f52754(var92);
        if (NIL != var99) {
            var93 = (SubLObject)ConsesLow.cons((SubLObject)ConsesLow.list((SubLObject)$ic83$, var99), var93);
        }
        return Sequences.nreverse(var93);
    }
    ...
    public static SubLObject f52787(SubLObject var354, SubLObject var111) {
        if (var354 == UNPROVIDED) {
            var354 = f52785((SubLObject)UNPROVIDED);
        }
        if (var111 == UNPROVIDED) {
            var111 = StreamsLow.$standard_output$.getDynamicValue();
        }
        if (NIL == var354) {
            PrintLow.format(var111, (SubLObject)$ic84$);
        }
        else {
    ...
    public static SubLObject f52782(final SubLObject var346, SubLObject var111) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var346, var346, (SubLObject)$ic85$);
        var347 = var346.first();
        SubLObject var349 = var346.rest();
        cdestructuring_bind.destructuring_bind_must_consp(var349, var346, (SubLObject)$ic85$);
        var348 = var349.first();
        var349 = var349.rest();
        if (NIL == var349) {
            final SubLObject var350 = var347;
            if (var350.eql((SubLObject)$ic78$)) {
            ...
            else if (var350.eql((SubLObject)$ic79$)) {
                SubLObject var351 = var348;
                SubLObject var352 = (SubLObject)NIL;
                var352 = var351.first();
                while (NIL != var351) {
            ...
            else if (var350.eql((SubLObject)$ic80$)) {
                SubLObject var351 = var348;
                SubLObject var352 = (SubLObject)NIL;
                var352 = var351.first();
                while (NIL != var351) {
            ...
            else if (var350.eql((SubLObject)$ic81$)) {
                SubLObject var351 = var348;
                SubLObject var352 = (SubLObject)NIL;
                var352 = var351.first();
                while (NIL != var351) {
            ...
            else if (var350.eql((SubLObject)$ic82$)) {
                SubLObject var351 = var348;
                SubLObject var352 = (SubLObject)NIL;
                var352 = var351.first();
                while (NIL != var351) {
            ...
            else if (var350.eql((SubLObject)$ic83$)) {
                SubLObject var351 = var348;
                SubLObject var352 = (SubLObject)NIL;
                var352 = var351.first();
                while (NIL != var351) {
            ...
            else if (var350.eql((SubLObject)$ic73$)) {
                SubLObject var351 = var348;
                SubLObject var352 = (SubLObject)NIL;
                var352 = var351.first();
                while (NIL != var351) {
                ...
                Errors.error((SubLObject)$ic86$, var347);
            }
        }
        else {
            cdestructuring_bind.cdestructuring_bind_error(var346, (SubLObject)$ic85$);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f52788(SubLObject var354) {
        ...
        SubLObject var355 = (SubLObject)ZERO_INTEGER;
        ...
        while (NIL != var356) {
            ...
            cdestructuring_bind.destructuring_bind_must_consp(var359, var358, (SubLObject)$ic85$);
            var360 = var359.first();
            var359 = var359.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var359, var358, (SubLObject)$ic85$);
            var361 = var359.first();
            ...
            if (NIL == var359) {
                ...
                cdestructuring_bind.cdestructuring_bind_error(var358, (SubLObject)$ic85$);
            }
            var356 = var356.rest();
            var357 = var356.first();
        }
    ...
    public static SubLObject f52789(SubLObject var354) {
        ...
        final SubLObject var355 = module0067.f4880(Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)ZERO_INTEGER);
        SubLObject var356 = var354;
        SubLObject var357 = (SubLObject)NIL;
        var357 = var356.first();
        while (NIL != var356) {
            ...
            if (NIL == var359) {
                ...
                final SubLObject var363 = module0035.f2439(Symbols.symbol_function((SubLObject)$ic87$), var362, (SubLObject)UNPROVIDED);
                if (var363.isString()) {
        ...
        var364 = Sort.sort(var364, Symbols.symbol_function((SubLObject)$ic88$), Symbols.symbol_function((SubLObject)$ic89$));
        return var364;
    }
    
    public static SubLObject f52790(final SubLObject var60) {
        SubLObject var61 = (SubLObject)$ic90$;
        ...
        while (NIL != var62) {
            ...
            if ($ic90$ == var61) {
                ...
                var61 = conses_high.nintersection(var61, conses_high.copy_list(var64), Symbols.symbol_function((SubLObject)EQ), (SubLObject)UNPROVIDED);
            }
            var62 = var62.rest();
            var63 = var62.first();
        }
        if ($ic90$ != var61) {
            return Sequences.delete(var60, var61, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f52792(final SubLObject var92) {
        ...
        var95 = var94.first();
        while (NIL != var94) {
            if (NIL == module0015.f874(var95) && NIL == module0012.f420(var95) && NIL == module0002.f40(var95) && NIL == f52698(var95) && NIL == module0038.f2684(Symbols.symbol_name(var95), (SubLObject)$ic91$) && NIL == module0038.f2684(Symbols.symbol_name(var95), (SubLObject)$ic92$)) {
    ...
    public static SubLObject f52794() {
        $g6524$ = SubLFiles.defvar("S#58141", (SubLObject)$ic0$);
        $g6525$ = SubLFiles.defparameter("S#58142", (SubLObject)NIL);
        $g6526$ = SubLFiles.defparameter("S#58143", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f52795() {
        ...
        module0034.f1895((SubLObject)$ic15$);
    ...
    static {
        ...
        $g6526$ = null;
        $ic0$ = makeKeyword("NEW");
        $ic1$ = makeSymbol("S#58004", "CYC");
        $ic2$ = makeKeyword("&MEMOIZED-ITEM-NOT-FOUND&");
        $ic3$ = makeSymbol("S#58007", "CYC");
        $ic4$ = makeString("Invalid attempt to reuse memoization state in multiple threads simultaneously.");
        $ic5$ = makeSymbol("S#58005", "CYC");
        $ic6$ = makeSymbol("S#58000", "CYC");
        $ic7$ = makeSymbol("SYMBOLP");
        $ic8$ = makeKeyword("DYNAMIC");
        $ic9$ = makeKeyword("SPECIAL");
        $ic10$ = makeKeyword("UNSPECIFIED");
        $ic11$ = makeString("Checking ~A for dependencies.~%");
        $ic12$ = makeSymbol("STRING-LESSP");
        $ic13$ = makeSymbol("SYMBOL-NAME");
        $ic14$ = makeSymbol("S#58008", "CYC");
        $ic15$ = makeSymbol("S#58077", "CYC");
        $ic16$ = makeKeyword("UNSEEN");
        $ic17$ = makeSymbol("S#58083", "CYC");
        $ic18$ = makeKeyword("OR");
        $ic19$ = makeKeyword("NOT");
        $ic20$ = makeKeyword("AND");
        $ic21$ = makeSymbol("S#58087", "CYC");
        $ic22$ = makeSymbol("S#58088", "CYC");
        $ic23$ = makeString("Identifying module-level feature problems");
        $ic24$ = makeKeyword("METHOD");
        $ic25$ = makeKeyword("GLOBAL");
        $ic26$ = makeKeyword("MODULE");
        $ic27$ = makeSymbol("S#58092", "CYC");
        $ic28$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#58144", "CYC"), (SubLObject)makeSymbol("&REST"), (SubLObject)makeSymbol("S#58145", "CYC")), (SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#58146", "CYC"), (SubLObject)makeSymbol("&REST"), (SubLObject)makeSymbol("S#58147", "CYC")), (SubLObject)makeSymbol("S#58148", "CYC"));
        $ic29$ = ConsesLow.list((SubLObject)makeSymbol("S#205", "CYC"), (SubLObject)makeSymbol("S#58149", "CYC"));
        $ic30$ = makeString("~%Top-level form in ~A~%");
        $ic31$ = ConsesLow.list((SubLObject)makeSymbol("S#58150", "CYC"), (SubLObject)makeSymbol("S#205", "CYC"), (SubLObject)makeSymbol("S#58149", "CYC"));
        $ic32$ = makeString("~%Method ~A in ~A~%");
        $ic33$ = makeString("~%Global ~A in ~A~%");
        $ic34$ = makeString(" references");
        $ic35$ = ConsesLow.list((SubLObject)makeSymbol("S#58151", "CYC"), (SubLObject)makeSymbol("S#205", "CYC"), (SubLObject)makeSymbol("S#58152", "CYC"));
        $ic36$ = makeString("~%method ~A from ~A~%");
        $ic37$ = makeString("~%global ~A from ~A~%");
        $ic38$ = makeString("~%which will have problems when :~%  ~A~%");
        $ic39$ = makeString("assuming ~A");
        $ic40$ = makeString("no features");
        $ic41$ = makeString("Identifying privacy violations");
        $ic42$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#58144", "CYC"), (SubLObject)makeSymbol("&REST"), (SubLObject)makeSymbol("S#58145", "CYC")), (SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#58146", "CYC"), (SubLObject)makeSymbol("&REST"), (SubLObject)makeSymbol("S#58147", "CYC")));
        $ic43$ = ConsesLow.list((SubLObject)makeSymbol("S#205", "CYC"));
        $ic44$ = ConsesLow.list((SubLObject)makeSymbol("S#58150", "CYC"), (SubLObject)makeSymbol("S#205", "CYC"));
        $ic45$ = makeString(" references private");
        $ic46$ = ConsesLow.list((SubLObject)makeSymbol("S#58151", "CYC"), (SubLObject)makeSymbol("S#205", "CYC"));
        $ic47$ = makeString("Identifying early rebinding violations");
        $ic48$ = makeString(" rebinds");
        $ic49$ = makeString(" before it is defined~%");
        $ic50$ = makeString("Identifying early reference violations");
        $ic51$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#58144", "CYC"), (SubLObject)makeSymbol("&REST"), (SubLObject)makeSymbol("S#58145", "CYC")), (SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#58146", "CYC"), (SubLObject)makeSymbol("S#58151", "CYC"), (SubLObject)makeSymbol("S#205", "CYC")), (SubLObject)makeSymbol("S#58153", "CYC"), (SubLObject)makeSymbol("S#58154", "CYC"));
        $ic52$ = ConsesLow.list((SubLObject)makeSymbol("S#205", "CYC"), (SubLObject)makeSymbol("POSITION"));
        $ic53$ = makeString("~%Top-level form in ~A at ~S~%");
        $ic54$ = makeString(" before it is");
        $ic55$ = makeString(" defined~%");
        $ic56$ = makeString(" completely defined due to~%");
        $ic57$ = makeString("method ~A~%");
        $ic58$ = makeString("global ~A~%");
        $ic59$ = makeString("Identifying early macro use violations");
        $ic60$ = makeString("Identifying undefined references");
        $ic61$ = makeString(" references undefined");
        $ic62$ = ConsesLow.list((SubLObject)makeSymbol("S#58151", "CYC"));
        $ic63$ = makeString("~%method ~A~%");
        $ic64$ = makeString("~%global ~A~%");
        $ic65$ = ConsesLow.list((SubLObject)makeSymbol("S#58144", "CYC"), (SubLObject)makeSymbol("S#58150", "CYC"), (SubLObject)makeSymbol("S#58155", "CYC"));
        $ic66$ = makeString("~%Method ~A has multiple definitions in");
        $ic67$ = makeString("~%Global ~A has multiple definitions in");
        $ic68$ = (SubLList)ConsesLow.cons((SubLObject)makeSymbol("S#205", "CYC"), (SubLObject)makeSymbol("FILE-POSITION"));
        $ic69$ = makeString("~%  ~A at position ~S");
        $ic70$ = makeSymbol("S#10575", "CYC");
        $ic71$ = ConsesLow.list((SubLObject)makeSymbol("S#58146", "CYC"), (SubLObject)makeSymbol("&REST"), (SubLObject)makeSymbol("S#58147", "CYC"));
        $ic72$ = makeString("references #$ before it is completely defined~%");
        $ic73$ = makeKeyword("API-MACRO-VISIBILITY");
        $ic74$ = (SubLList)ConsesLow.cons((SubLObject)makeSymbol("S#31", "CYC"), (SubLObject)makeSymbol("S#58156", "CYC"));
        $ic75$ = makeString("~&API macro ~A expands to non-API methods~% ~S~%");
        $ic76$ = makeSymbol("S#385", "CYC");
        $ic77$ = makeString("Determining build problems");
        $ic78$ = makeKeyword("MULTIPLE-DEFINITIONS");
        $ic79$ = makeKeyword("UNDEFINED-REFERENCES");
        $ic80$ = makeKeyword("PRIVACY-VIOLATIONS");
        $ic81$ = makeKeyword("EARLY-CONSTANT-REFERENCES");
        $ic82$ = makeKeyword("EARLY-REFERENCE-VIOLATIONS");
        $ic83$ = makeKeyword("EARLY-REBINDING-VIOLATIONS");
        $ic84$ = makeString("~%No build problems!");
        $ic85$ = ConsesLow.list((SubLObject)makeSymbol("S#58157", "CYC"), (SubLObject)makeSymbol("S#58158", "CYC"));
        $ic86$ = makeString("Unknown build problem class ~S");
        $ic87$ = makeSymbol("STRINGP");
        $ic88$ = makeSymbol(">");
        $ic89$ = makeSymbol("CDR");
        $ic90$ = makeKeyword("UNINITIALIZED");
        $ic91$ = makeString("CLEAR");
        $ic92$ = makeString("REMOVE");
    }
}
