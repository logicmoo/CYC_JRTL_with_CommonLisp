...
public final class module0382 extends SubLTranslatedFile
{
    ...
    public static SubLObject f27160(final SubLObject var1) {
        return (SubLObject)((var1.getClass() == $sX30281_native.class) ? T : NIL);
    }
    
    public static SubLObject f27161(final SubLObject var1) {
        assert NIL != f27160(var1) : var1;
    ...
    public static SubLObject f27168(final SubLObject var11, final SubLObject var12) {
        ...
        Functions.funcall(var12, var11, (SubLObject)$ic21$, (SubLObject)$ic15$, f27161(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic21$, (SubLObject)$ic16$, f27162(var11));
        Functions.funcall(var12, var11, (SubLObject)$ic21$, (SubLObject)$ic17$, f27163(var11));
    ...
    public static SubLObject f27170(final SubLObject var13) {
        return (SubLObject)makeBoolean(NIL != f27160(var13) && NIL != module0067.f4852(f27162(var13)));
    }
    
    public static SubLObject f27171(final SubLObject var14, final SubLObject var15) {
        final SubLObject var16 = f27167((SubLObject)UNPROVIDED);
        f27164(var16, f27172(var14, var15));
        f27165(var16, module0067.f4880(Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED));
        f27166(var16, module0067.f4880(Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED));
        return var16;
    }
    ...
    public static SubLObject f27174(final SubLObject var17, final SubLObject var18, final SubLObject var19) {
        ...
        for (var21 = module0032.f1741(var20), var22 = (SubLObject)NIL, var22 = module0032.f1742(var21, var20); NIL == module0032.f1744(var21, var22); var22 = module0032.f1743(var22)) {
            ...
            if (NIL != module0032.f1746(var22, var23) && NIL != module0364.f24748(var23, (SubLObject)$ic24$) && NIL != module0364.f24786(var18, f27175(var23)) && NIL != module0364.f24786(var19, f27176(var23))) {
                return var23;
            }
        }
    ...
    public static SubLObject f27177(final SubLObject var17, final SubLObject var18, final SubLObject var19) {
        assert NIL != module0364.f24774(var18) : var18;
        assert NIL != module0364.f24774(var19) : var19;
        final SubLObject var20 = module0364.f24729((SubLObject)$ic24$, var17);
    ...
    public static SubLObject f27180(final SubLObject var27, final SubLObject var28) {
        ...
        cdestructuring_bind.destructuring_bind_must_consp(var30, var29, (SubLObject)$ic27$);
        ...
        if (NIL == var30) {
            ...
            var30 = (var35 = var31);
            final SubLObject var36 = (SubLObject)$ic28$;
            final SubLObject var37 = (SubLObject)$ic29$;
            return (SubLObject)ConsesLow.list((SubLObject)$ic30$, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(var36, (SubLObject)ConsesLow.list((SubLObject)$ic31$, var34))), (SubLObject)ConsesLow.list((SubLObject)$ic32$, (SubLObject)ConsesLow.list(var32, var37, var36), (SubLObject)ConsesLow.listS((SubLObject)$ic33$, (SubLObject)ConsesLow.list(var33, var37), ConsesLow.append(var35, (SubLObject)NIL))));
        }
        cdestructuring_bind.cdestructuring_bind_error(var29, (SubLObject)$ic27$);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f27181(final SubLObject var27, final SubLObject var28) {
        ...
        if (NIL == var30) {
            final SubLObject var35;
            var30 = (var35 = var31);
            final SubLObject var36 = (SubLObject)$ic34$;
            final SubLObject var37 = (SubLObject)$ic35$;
            return (SubLObject)ConsesLow.list((SubLObject)$ic30$, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.list(var36, (SubLObject)ConsesLow.list((SubLObject)$ic36$, var34))), (SubLObject)ConsesLow.list((SubLObject)$ic32$, (SubLObject)ConsesLow.list(var32, var37, var36), (SubLObject)ConsesLow.listS((SubLObject)$ic33$, (SubLObject)ConsesLow.list(var33, var37), ConsesLow.append(var35, (SubLObject)NIL))));
        }
        cdestructuring_bind.cdestructuring_bind_error(var29, (SubLObject)$ic27$);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f27188(final SubLObject var25, final SubLObject var40) {
        return (NIL != var40) ? f27175(var25) : f27176(var25);
    }
    
    public static SubLObject f27189(final SubLObject var25, final SubLObject var40) {
        return (NIL != var40) ? f27176(var25) : f27175(var25);
    }
    ...
    public static SubLObject f27190(final SubLObject var25, final SubLObject var41) {
        ...
        final SubLObject var44 = module0067.f4884(var42, var43, (SubLObject)UNPROVIDED);
        return var44;
    }
    ...
    public static SubLObject f27192(final SubLObject var25, final SubLObject var45, final SubLObject var40) {
        return (NIL != var40) ? f27191(var25, var45) : f27190(var25, var45);
    }
    ...
    public static SubLObject f27194(final SubLObject var25) {
        ...
        if (NIL == module0363.f24685(module0364.f24725(var25))) {
            return Errors.error((SubLObject)$ic39$, var25);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f27179(final SubLObject var25) {
        ...
        var29 = var28.first();
        while (NIL != var28) {
            if (NIL != module0363.f24522(var29, $g3221$.getDynamicValue(var26)) && var25.eql(f27195(var29))) {
                return var29;
            }
            var28 = var28.rest();
            var29 = var28.first();
    ...
    public static SubLObject f27196(final SubLObject var25, final SubLObject var53, final SubLObject var54) {
        assert NIL != f27173(var25) : var25;
        assert NIL != module0366.f24916(var54) : var54;
    ...
    public static SubLObject f27197(final SubLObject var25, final SubLObject var53, final SubLObject var54) {
        ...
        final SubLObject var55 = f27183(var25);
        final SubLObject var56 = module0373.f26258(var53);
        module0084.f5772(var55, var56, var54, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        return var25;
    }
    ...
    public static SubLObject f27200(final SubLObject var25, final SubLObject var56, final SubLObject var40) {
        ...
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var57) && NIL == module0366.f24983(var56)) {
            Errors.error((SubLObject)$ic42$, var56);
        }
    ...
    public static SubLObject f27201(final SubLObject var25, final SubLObject var54, final SubLObject var53) {
        f27202(var25, var54, var53, (SubLObject)T);
        f27202(var25, var54, var53, (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f27172(final SubLObject var14, final SubLObject var15) {
        ...
        while (NIL != var19) {
            ...
            if (NIL != module0004.f104(var21, var18, Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)$ic43$))) {
    ...
    public static SubLObject f27206(final SubLObject var13) {
        ...
        return (SubLObject)makeBoolean(NIL != module0365.f24819(var13) && $g3221$.getDynamicValue(var14).eql(module0365.f24865(var13)));
    }
    ...
    public static SubLObject f27207(final SubLObject var25, final SubLObject var60) {
        ...
        final SubLObject var64 = module0365.f24854(var62, $g3221$.getDynamicValue(var61), var63);
        final SubLObject var65 = var62;
        final SubLObject var66 = module0363.f24507(var65);
        final SubLObject var67 = module0361.f24123(var66);
        if (NIL == module0065.f4772(var67, (SubLObject)$ic44$)) {
            final SubLObject var71_72 = var67;
            if (NIL == module0065.f4775(var71_72, (SubLObject)$ic44$)) {
                ...
                for (var70 = Sequences.length(var68), var71 = (SubLObject)NIL, var71 = (SubLObject)ZERO_INTEGER; var71.numL(var70); var71 = Numbers.add(var71, (SubLObject)ONE_INTEGER)) {
                    ...
                    if (NIL == module0065.f4749(var73) || NIL == module0065.f4773((SubLObject)$ic44$)) {
                        if (NIL != module0065.f4749(var73)) {
                            var73 = (SubLObject)$ic44$;
                        }
                        if (NIL != module0363.f24547(var65, var73)) {
                            var74 = var73;
                            var75 = module0077.f5333(inference_datastructures_inference_oc.f25473(var74));
            ...
            if (NIL == module0065.f4777(var81_82)) {
                ...
                try {
                    while (Hashtables.iteratorHasNext(var82)) {
                        ...
                        if (NIL != module0363.f24547(var65, var81)) {
                            final SubLObject var84 = var81;
                            final SubLObject var85 = module0077.f5333(inference_datastructures_inference_oc.f25473(var84));
                            SubLObject var86;
                            SubLObject var87;
                            SubLObject var88;
                            for (var86 = module0032.f1741(var85), var87 = (SubLObject)NIL, var87 = module0032.f1742(var86, var85); NIL == module0032.f1744(var86, var87); var87 = module0032.f1743(var87)) {
                                ...
                                if (NIL != module0032.f1746(var87, var88)) {
    ...
    public static SubLObject f27213(final SubLObject var17, final SubLObject var59) {
        if (NIL != module0204.f13077(var59) && NIL == module0349.f23461(var59)) {
            ...
            var63 = var62.first();
            while (NIL != var62) {
                final SubLObject var64 = (SubLObject)$ic45$;
                if (NIL == var60) {
            ...
            var63 = var62.first();
            while (NIL != var62) {
                final SubLObject var64 = (SubLObject)$ic46$;
                if (NIL == var60) {
                    final SubLObject var65 = module0204.f13103(var64, var61);
                    f27214(var17, var65, var59);
                    var60 = (SubLObject)T;
    ...
    public static SubLObject f27214(final SubLObject var17, final SubLObject var60, final SubLObject var59) {
        final SubLThread var61 = SubLProcess.currentSubLThread();
        assert NIL != module0204.f13097(var60) : var60;
    ...
    public static SubLObject f27215(final SubLObject var26, final SubLObject var80) {
        ...
        assert NIL != f27206(var26) : var26;
        assert NIL != module0367.f24997(var80) : var80;
        final SubLObject var82 = f27195(var26);
        final SubLObject var83 = f27175(var82);
        final SubLObject var84 = f27176(var82);
        if (NIL == module0358.f23680(module0365.f24868(var26))) {
            var81.resetMultipleValues();
            final SubLObject var85 = f27216(var83, var84, (SubLObject)$ic50$);
            final SubLObject var86 = var81.secondMultipleValue();
            var81.resetMultipleValues();
            module0365.f24873(var26, var85, var86);
            if ($ic51$ == var85) {
                module0373.f26390(var26, (SubLObject)$ic50$);
            }
        }
        var81.resetMultipleValues();
    ...
    public static SubLObject f27217(final SubLObject var14, final SubLObject var15, final SubLObject var80) {
        final SubLThread var81 = SubLProcess.currentSubLThread();
        assert NIL != module0364.f24774(var14) : var14;
        assert NIL != module0364.f24774(var15) : var15;
        assert NIL != module0367.f24997(var80) : var80;
        ...
        final SubLObject var87 = module0360.f23948(var86, $g3222$.getDynamicValue(var81));
        return var87;
    }
    ...
    public static SubLObject f27216(final SubLObject var14, final SubLObject var15, final SubLObject var98) {
        ...
        assert NIL != module0364.f24774(var14) : var14;
        assert NIL != module0364.f24774(var15) : var15;
        assert NIL != module0373.f26190(var98) : var98;
        ...
        var99.resetMultipleValues();
        if (var104 == $ic53$ && NIL != Strings.stringE(var105, (SubLObject)$ic54$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) && var106 == $ic53$ && NIL != Strings.stringE(var107, (SubLObject)$ic54$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
            return Values.values((SubLObject)$ic55$, (SubLObject)$ic56$);
        }
        if (NIL != module0358.f23663(var104, var106)) {
            final SubLObject var108 = Sequences.cconcatenate((SubLObject)$ic57$, var105);
            return Values.values(var104, var108);
        }
        final SubLObject var108 = Sequences.cconcatenate((SubLObject)$ic58$, var107);
    ...
    public static SubLObject f27218(final SubLObject var26) {
        ...
        if (NIL != module0384.f27362(var26, (SubLObject)$ic50$)) {
    ...
    public static SubLObject f27212(final SubLObject var26) {
        ...
        if (NIL == Errors.$ignore_mustsP$.getDynamicValue(var27) && NIL == module0035.f1997(var29)) {
            Errors.error((SubLObject)$ic59$, var26, var29);
        }
    ...
    public static SubLObject f27222(final SubLObject var109, final SubLObject var110, final SubLObject var25) {
        ...
        if (var112.eql(var113)) {
            ...
            if (NIL != module0233.f15364(var114, var110)) {
                return (SubLObject)T;
            }
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f27223(final SubLObject var107, final SubLObject var108, final SubLObject var25, final SubLObject var40) {
        ...
        if (NIL != var113) {
            ...
            final SubLObject var121 = (SubLObject)((NIL != var40) ? ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ConsesLow.cons(var107, var120)), var116) : ConsesLow.list(var116, (SubLObject)ConsesLow.list((SubLObject)ConsesLow.cons(var107, var120))));
            SubLObject var123;
            final SubLObject var122 = var123 = module0035.f2489(var121, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f27225() {
        $g3220$ = SubLFiles.defconstant("S#30332", (SubLObject)$ic0$);
        $g3221$ = SubLFiles.defparameter("S#30333", module0340.f22997((SubLObject)$ic24$, (SubLObject)UNPROVIDED));
        $g3222$ = SubLFiles.defparameter("S#30334", (SubLObject)EIGHT_INTEGER);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f27226() {
        Structures.register_method(print_high.$print_object_method_table$.getGlobalValue(), $g3220$.getGlobalValue(), Symbols.symbol_function((SubLObject)$ic7$));
        ...
        Structures.register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $g3220$.getGlobalValue(), Symbols.symbol_function((SubLObject)$ic23$));
        module0002.f50((SubLObject)$ic31$, (SubLObject)$ic37$);
        module0002.f50((SubLObject)$ic36$, (SubLObject)$ic38$);
        return (SubLObject)NIL;
    }
    ...
    static {
        ...
        $g3221$ = null;
        $g3222$ = null;
        $ic0$ = makeSymbol("S#30281", "CYC");
        $ic1$ = makeSymbol("S#30282", "CYC");
        $ic2$ = ConsesLow.list((SubLObject)makeSymbol("S#30335", "CYC"), (SubLObject)makeSymbol("S#30336", "CYC"), (SubLObject)makeSymbol("S#30337", "CYC"));
        $ic3$ = ConsesLow.list((SubLObject)makeKeyword("JOIN-VARS"), (SubLObject)makeKeyword("FIRST-PROOF-INDEX"), (SubLObject)makeKeyword("SECOND-PROOF-INDEX"));
        $ic4$ = ConsesLow.list((SubLObject)makeSymbol("S#30284", "CYC"), (SubLObject)makeSymbol("S#30285", "CYC"), (SubLObject)makeSymbol("S#30286", "CYC"));
        $ic5$ = ConsesLow.list((SubLObject)makeSymbol("S#30287", "CYC"), (SubLObject)makeSymbol("S#30288", "CYC"), (SubLObject)makeSymbol("S#30289", "CYC"));
        $ic6$ = makeSymbol("DEFAULT-STRUCT-PRINT-FUNCTION");
        $ic7$ = makeSymbol("S#30283", "CYC");
        $ic8$ = ConsesLow.list((SubLObject)makeSymbol("OPTIMIZE-FUNCALL"), (SubLObject)makeSymbol("S#30282", "CYC"));
        $ic9$ = makeSymbol("S#30284", "CYC");
        $ic10$ = makeSymbol("S#30287", "CYC");
        $ic11$ = makeSymbol("S#30285", "CYC");
        $ic12$ = makeSymbol("S#30288", "CYC");
        $ic13$ = makeSymbol("S#30286", "CYC");
        $ic14$ = makeSymbol("S#30289", "CYC");
        $ic15$ = makeKeyword("JOIN-VARS");
        $ic16$ = makeKeyword("FIRST-PROOF-INDEX");
        $ic17$ = makeKeyword("SECOND-PROOF-INDEX");
        $ic18$ = makeString("Invalid slot ~S for construction function");
        $ic19$ = makeKeyword("BEGIN");
        $ic20$ = makeSymbol("S#30290", "CYC");
        $ic21$ = makeKeyword("SLOT");
        $ic22$ = makeKeyword("END");
        $ic23$ = makeSymbol("S#30292", "CYC");
        $ic24$ = makeKeyword("JOIN");
        $ic25$ = makeSymbol("S#27608", "CYC");
        $ic26$ = makeKeyword("FREE");
        $ic27$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)makeSymbol("S#30274", "CYC"), (SubLObject)makeSymbol("S#25415", "CYC"), (SubLObject)makeSymbol("S#30338", "CYC")), (SubLObject)makeSymbol("&BODY"), (SubLObject)makeSymbol("S#5", "CYC"));
        $ic28$ = makeUninternedSymbol("US#13A64D7");
        $ic29$ = makeUninternedSymbol("US#D2A5C4");
        $ic30$ = makeSymbol("CLET");
        $ic31$ = makeSymbol("S#30300", "CYC");
        ...
        $ic36$ = makeSymbol("S#30301", "CYC");
        $ic37$ = makeSymbol("S#30297", "CYC");
        $ic38$ = makeSymbol("S#30298", "CYC");
        $ic39$ = makeString("couldn't find the join tactic for ~s");
        $ic40$ = makeSymbol("S#29225", "CYC");
        $ic41$ = makeSymbol("S#26816", "CYC");
        $ic42$ = makeString("~a was a rejected proof");
        $ic43$ = makeSymbol("S#17993", "CYC");
        $ic44$ = makeKeyword("SKIP");
        $ic45$ = makeKeyword("NEG");
        $ic46$ = makeKeyword("POS");
        $ic47$ = makeSymbol("S#15995", "CYC");
        $ic48$ = makeSymbol("S#27353", "CYC");
        $ic49$ = makeSymbol("S#27896", "CYC");
        $ic50$ = makeKeyword("TACTICAL");
        $ic51$ = makeKeyword("DOOMED");
        $ic52$ = makeSymbol("S#27373", "CYC");
        $ic53$ = makeKeyword("DISPREFERRED");
        $ic54$ = makeString("TVA-POS");
        $ic55$ = makeKeyword("GROSSLY-DISPREFERRED");
        $ic56$ = makeString("DOUBLE TVA-POS");
        $ic57$ = makeString("first problem: ");
        $ic58$ = makeString("second problem: ");
        $ic59$ = makeString("Join tactics like ~a must only apply to singleton problem queries, but ~s was not a singleton");
    }
    ...
    public static final class $sX30281_native extends SubLStructNative
    {
        ...
        static {
            structDecl = Structures.makeStructDeclNative((Class)$sX30281_native.class, $ic0$, $ic1$, $ic2$, $ic3$, new String[] { "$join_vars", "$first_proof_index", "$second_proof_index" }, $ic4$, $ic5$, $ic6$);
        }
    }
