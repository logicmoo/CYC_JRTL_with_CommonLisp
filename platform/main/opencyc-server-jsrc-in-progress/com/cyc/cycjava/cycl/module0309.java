...
public final class module0309 extends SubLTranslatedFile
{
    ...
    public static SubLObject f20930(final SubLObject var1, SubLObject var2) {
        ...
        try {
            ...
            module0152.$g2126$.bind((NIL != module0151.f9690() && NIL != module0152.f9724()) ? module0152.f9724() : var1, var3);
            module0144.$g1796$.bind((SubLObject)T, var3);
            module0144.$g1795$.bind((SubLObject)T, var3);
            module0152.$g2116$.bind((SubLObject)T, var3);
            module0152.$g2115$.bind((SubLObject)T, var3);
            f20927(var1, var2);
        }
        finally {
    ...
    public static SubLObject f20928(final SubLObject var10, final SubLObject var2) {
        ...
        if (NIL == module0201.f12580(var12)) {
    ...
    public static SubLObject f20931(final SubLObject var12) {
        if (NIL != module0202.f12977(var12) && NIL == module0202.f12589(var12, $ic0$) && NIL == module0202.f12589(var12, $ic1$)) {
            return module0202.f12947(var12, (SubLObject)UNPROVIDED);
        }
    ...
    public static SubLObject f20933() {
        final SubLThread var3 = SubLProcess.currentSubLThread();
        return (SubLObject)makeBoolean(NIL == module0144.$g1799$.getDynamicValue(var3) && NIL == module0144.$g1805$.getDynamicValue(var3) && NIL == module0144.$g1806$.getDynamicValue(var3) && NIL == module0279.f18527());
    }
    ...
    public static SubLObject f20929(final SubLObject var1, SubLObject var2) {
        ...
        final SubLThread var3 = SubLProcess.currentSubLThread();
        final SubLObject var4 = module0205.f13207(var1, (SubLObject)UNPROVIDED);
        final SubLObject var5 = module0202.f12707(var1, (SubLObject)UNPROVIDED);
        ...
        try {
            ...
            module0144.$g1833$.bind((SubLObject)ZERO_INTEGER, var3);
            final SubLObject var10 = Types.sublisp_null(module0202.f12911(var1, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED));
            ...
            try {
                module0144.$g1769$.bind((SubLObject)((NIL != module0144.$g1769$.getDynamicValue(var3)) ? ((NIL != module0144.$g1799$.getDynamicValue(var3) || NIL != module0144.$g1805$.getDynamicValue(var3) || NIL != module0144.$g1806$.getDynamicValue(var3) || NIL != module0279.f18527()) ? NIL : var10) : NIL), var3);
                module0144.$g1771$.bind((SubLObject)((NIL != module0144.$g1771$.getDynamicValue(var3)) ? ((NIL != module0144.$g1799$.getDynamicValue(var3) || NIL != module0144.$g1805$.getDynamicValue(var3) || NIL != module0144.$g1806$.getDynamicValue(var3) || NIL != module0279.f18527()) ? NIL : var10) : NIL), var3);
                ...
                if (NIL != module0004.f104(var5, module0146.$g1980$.getDynamicValue(var3), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                    module0274.f18082((SubLObject)ConsesLow.list((SubLObject)$ic2$, var5, var1));
                    var6 = (SubLObject)NIL;
                }
                if (NIL != module0173.f10955(module0144.$g1831$.getDynamicValue(var3))) {
                    var6 = (SubLObject)makeBoolean(NIL != f20934(module0144.$g1831$.getDynamicValue(var3), var2) && NIL != f20935(var1, (SubLObject)UNPROVIDED) && NIL != var6);
                    var7 = module0303.f20199((SubLObject)makeBoolean(NIL == var6));
                    ...
                    try {
                        ...
                        if (NIL == var7) {
                            ...
                            var15 = var14.first();
                            while (NIL == var7 && NIL != var14) {
                                module0144.$g1833$.setDynamicValue(Numbers.add(module0144.$g1833$.getDynamicValue(var3), (SubLObject)ONE_INTEGER), var3);
                                ...
                                try {
                                    ...
                                    var6 = (SubLObject)makeBoolean(NIL != f20944(module0144.$g1831$.getDynamicValue(var3), var15, module0144.$g1833$.getDynamicValue(var3), module0303.f20118(module0144.$g1831$.getDynamicValue(var3), var4, module0144.$g1833$.getDynamicValue(var3), var2)) && NIL != var6);
                                }
                                finally {
    ...
    public static SubLObject f20944(final SubLObject var12, final SubLObject var22, final SubLObject var31, SubLObject var2) {
        ...
        if (NIL != module0151.f9690() && NIL != module0269.f17737(var12)) {
            return (SubLObject)T;
        }
        ...
        try {
            module0152.$g2120$.bind((SubLObject)makeBoolean(NIL != module0152.$g2120$.getDynamicValue(var32) || NIL != module0279.f18444(var12, var31, var2)), var32);
            module0152.$g2121$.bind((SubLObject)makeBoolean(NIL != module0152.$g2121$.getDynamicValue(var32) || NIL != module0279.f18443(var12, var31, var2)), var32);
            if (NIL != f20945(var22)) {
    ...
    public static SubLObject f20948() {
        final SubLObject var32 = $g2793$.getGlobalValue();
        if (NIL != var32) {
    ...
    public static SubLObject f20949(final SubLObject var12, final SubLObject var22, final SubLObject var31, final SubLObject var2, final SubLObject var33, final SubLObject var34) {
        return module0034.f1829($g2793$.getGlobalValue(), (SubLObject)ConsesLow.list(var12, var22, var31, var2, var33, var34), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f20950(final SubLObject var12, final SubLObject var22, final SubLObject var31, final SubLObject var2, final SubLObject var33, final SubLObject var34) {
        ...
        return f20947(var12, var22, $g2792$.getDynamicValue(var35), var2);
    }
    ...
    public static SubLObject f20951(final SubLObject var12, final SubLObject var22, final SubLObject var31, final SubLObject var2, final SubLObject var33, final SubLObject var34) {
        SubLObject var35 = $g2793$.getGlobalValue();
        if (NIL == var35) {
            var35 = module0034.f1934((SubLObject)$ic3$, (SubLObject)$ic4$, (SubLObject)$ic5$, (SubLObject)EQUAL, (SubLObject)SIX_INTEGER, (SubLObject)ZERO_INTEGER);
            module0034.f1940((SubLObject)$ic6$);
        }
    ...
    public static SubLObject f20947(final SubLObject var12, final SubLObject var22, final SubLObject var31, SubLObject var2) {
        ...
        try {
            ...
            if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var33))) {
                if (NIL != f20952(var22)) {
                    var33 = (SubLObject)makeBoolean(NIL != f20953(var22, var31) && NIL != var33);
                }
                else if (NIL != f20954(var22)) {
                    var33 = (SubLObject)makeBoolean(NIL != f20955(var12, var22, var31, var2) && NIL != var33);
                }
                else if (NIL != f20956(var22)) {
                    var33 = (SubLObject)makeBoolean(NIL != f20957(var12, var22, var31, var2) && NIL != var33);
                }
                else if (NIL != f20958(var22)) {
                    var33 = (SubLObject)makeBoolean(NIL != f20959(var22, var31) && NIL != var33);
                }
                else if (NIL != f20960(var22)) {
                    var33 = (SubLObject)makeBoolean(NIL != f20961(var22, var31) && NIL != var33);
                }
                else if (NIL != f20962(var22, var2)) {
                    var33 = (SubLObject)makeBoolean(NIL != f20963(var12, var22, var31, var2) && NIL != var33);
                }
                else if (NIL != f20964(var22, (SubLObject)UNPROVIDED)) {
                    var33 = (SubLObject)makeBoolean(NIL != f20965(var12, var22, var31, var2) && NIL != var33);
                }
                else {
                    var33 = (SubLObject)makeBoolean(NIL != f20966(var12, var22, var31, var2) && NIL != var33);
                }
            }
        }
        finally {
    ...
    public static SubLObject f20936(final SubLObject var43, final SubLObject var22) {
        return (SubLObject)((var43.eql($ic8$) || (NIL != module0303.f20135(var43) && var22.eql((SubLObject)ONE_INTEGER))) ? makeBoolean(NIL == module0279.f18527()) : module0279.f18527());
    }
    ...
    public static SubLObject f20938(final SubLObject var43) {
        ...
        return (SubLObject)makeBoolean(NIL != module0144.$g1806$.getDynamicValue(var44) || NIL != module0202.f12921(var43, (SubLObject)UNPROVIDED));
    }
    ...
    public static SubLObject f20937(SubLObject var43) {
        ...
        final SubLThread var44 = SubLProcess.currentSubLThread();
        return (SubLObject)makeBoolean(NIL != module0144.$g1805$.getDynamicValue(var44) || NIL != module0269.f17724(var43));
    }
    ...
    public static SubLObject f20940(SubLObject var12, SubLObject var31, SubLObject var2) {
        ...
        final SubLThread var32 = SubLProcess.currentSubLThread();
        return (SubLObject)makeBoolean(NIL != module0144.$g1752$.getDynamicValue(var32) && (NIL == module0279.f18450(var12, var31, var2) || NIL == module0279.f18452(var12, var31, var2) || NIL != module0279.f18451(var12, var31, var2)));
    }
    
    public static SubLObject f20941(final SubLObject var1, final SubLObject var31) {
        final SubLThread var32 = SubLProcess.currentSubLThread();
        if (NIL != module0144.$g1753$.getDynamicValue(var32) && NIL != module0144.f9453()) {
            final SubLObject var33 = module0205.f13132(var1);
            if (NIL == module0173.f10955(var33)) {
                return (SubLObject)T;
            }
            if (NIL == module0226.f14837(var33, var31)) {
                return (SubLObject)T;
            }
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f20942(final SubLObject var1, SubLObject var2) {
        ...
        final SubLThread var3 = SubLProcess.currentSubLThread();
        if (NIL != module0144.$g1808$.getDynamicValue(var3) && NIL == module0279.f18534(var1, var2)) {
            return (SubLObject)makeBoolean(NIL != module0144.$g1799$.getDynamicValue(var3) || NIL != module0279.f18525());
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f20939(final SubLObject var1, final SubLObject var31) {
        return (SubLObject)makeBoolean(NIL != module0279.f18525() || (NIL != module0202.f12732(var1, (SubLObject)TWO_INTEGER, (SubLObject)UNPROVIDED) && NIL != ((NIL != module0279.f18527()) ? makeBoolean(NIL != module0202.f12595(var1) || (NIL != module0202.f12597(var1) && var31.eql((SubLObject)ONE_INTEGER))) : makeBoolean(NIL != module0202.f12594(var1) || NIL != module0202.f12597(var1) || NIL != module0202.f12874(var1) || NIL != module0202.f12648(var1)))));
    }
    
    public static SubLObject f20967(final SubLObject var44) {
        final SubLThread var45 = SubLProcess.currentSubLThread();
        if (NIL != module0144.$g1808$.getDynamicValue(var45)) {
            return (SubLObject)makeBoolean(NIL != module0144.$g1799$.getDynamicValue(var45) || (NIL != module0232.f15308(var44) && NIL != module0232.f15306(var44)));
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f20943(final SubLObject var1) {
        ...
        return (SubLObject)makeBoolean(NIL != module0144.$g1800$.getDynamicValue(var2) || NIL != module0226.f14824(var1));
    }
    ...
    public static SubLObject f20946(final SubLObject var12, final SubLObject var22, final SubLObject var31, SubLObject var2) {
        ...
        if (NIL == module0210.f13598(var22) || NIL != module0210.f13589(var22)) {
            return (SubLObject)T;
        }
        if (NIL != f20963(var12, var22, var31, var2)) {
            return (SubLObject)T;
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f20963(final SubLObject var12, final SubLObject var22, final SubLObject var31, final SubLObject var2) {
        ...
        else if (NIL == module0303.f20199((SubLObject)T)) {
            f20971(var22, var2);
        }
        if (NIL != var32) {
    ...
    public static SubLObject f20974(final SubLObject var45, SubLObject var2) {
        ...
        if (NIL != module0167.f10813(var45)) {
    ...
    public static SubLObject f20976(final SubLObject var46, final SubLObject var2) {
        return (SubLObject)makeBoolean(NIL != module0167.f10813(var46) || (NIL != module0131.f8587() && NIL != module0202.f12659(var46) && NIL != module0226.f14878(module0205.f13276(var46), var2)));
    }
    ...
    public static SubLObject f20953(final SubLObject var45, final SubLObject var31) {
        ...
        if (var31.eql((SubLObject)ONE_INTEGER)) {
            if (NIL != module0167.f10813(var45)) {
                return (SubLObject)T;
            }
            if (NIL != module0201.f12580(var45)) {
                return (SubLObject)makeBoolean(NIL != module0018.f979() || NIL != module0279.f18525() || NIL != module0144.$g1799$.getDynamicValue(var46));
            }
            if (NIL != module0210.f13576(var45, (SubLObject)UNPROVIDED)) {
                return f20977(var45);
            }
        }
        else if (var31.eql((SubLObject)TWO_INTEGER)) {
            if (NIL != module0210.f13576(var45, (SubLObject)UNPROVIDED)) {
                return f20977(var45);
            }
            if (NIL != module0201.f12580(var45)) {
    ...
    public static SubLObject f20959(final SubLObject var22, final SubLObject var31) {
        if (var31.eql((SubLObject)ONE_INTEGER)) {
            ...
            if (NIL != module0201.f12580(var22)) {
                return (SubLObject)T;
            }
            if (NIL != module0210.f13576(var22, (SubLObject)UNPROVIDED)) {
                return f20977(var22);
            }
        }
        else if (var31.eql((SubLObject)TWO_INTEGER)) {
            ...
            if (NIL != module0279.f18533(var22, (SubLObject)UNPROVIDED)) {
                return (SubLObject)T;
            }
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f20961(final SubLObject var22, final SubLObject var31) {
        if (var31.eql((SubLObject)ONE_INTEGER)) {
            ...
            if (var31.eql((SubLObject)TWO_INTEGER)) {
                return module0552.f34094(var22);
            }
            if (var31.eql((SubLObject)THREE_INTEGER)) {
                return (SubLObject)T;
            }
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f20977(final SubLObject var48) {
        ...
        if (NIL == var51) {
            ...
            try {
                module0147.$g2094$.bind((SubLObject)$ic11$, var49);
                module0147.$g2095$.bind($ic12$, var49);
                var51 = module0279.f18533(module0205.f13276(var48), (SubLObject)UNPROVIDED);
            }
            finally {
    ...
    public static SubLObject f20970(final SubLObject var48, SubLObject var2) {
        ...
        final SubLThread var49 = SubLProcess.currentSubLThread();
        if (NIL != module0210.f13571(var48)) {
            final SubLObject var50 = (SubLObject)T;
            final SubLObject var51 = module0205.f13276(var48);
            if (NIL != module0144.$g1747$.getDynamicValue(var49)) {
                if (NIL != module0173.f10955(var51)) {
                    return (SubLObject)T;
                }
                if (NIL != module0210.f13576(var51, (SubLObject)UNPROVIDED)) {
                    return (SubLObject)makeBoolean(NIL != f20970(var51, var2) && NIL != f20971(var51, var2));
                }
            }
            return var50;
        }
    ...
    public static SubLObject f20980(final SubLObject var48, SubLObject var2) {
        ...
        if (NIL != module0210.f13571(var48)) {
            ...
            try {
                module0152.$g2108$.bind((SubLObject)T, var49);
    ...
    public static SubLObject f20968(final SubLObject var50, final SubLObject var22, final SubLObject var31, SubLObject var2) {
        ...
        try {
            module0144.$g1769$.bind((SubLObject)NIL, var51);
    ...
    public static SubLObject f20969(final SubLObject var50, final SubLObject var22, final SubLObject var31, SubLObject var2) {
        ...
        final SubLThread var51 = SubLProcess.currentSubLThread();
        SubLObject var52 = (SubLObject)makeBoolean(NIL == module0144.$g1764$.getDynamicValue(var51));
        SubLObject var53 = (SubLObject)makeBoolean(NIL == module0144.$g1765$.getDynamicValue(var51));
        SubLObject var54 = (SubLObject)makeBoolean(NIL == module0144.$g1751$.getDynamicValue(var51));
        SubLObject var55 = (SubLObject)makeBoolean(NIL == module0144.$g1766$.getDynamicValue(var51));
        SubLObject var56 = (SubLObject)makeBoolean(NIL == module0144.$g1758$.getDynamicValue(var51));
        SubLObject var57 = (SubLObject)makeBoolean(NIL == module0144.$g1760$.getDynamicValue(var51));
        SubLObject var58 = (SubLObject)makeBoolean(NIL == module0144.$g1759$.getDynamicValue(var51));
        SubLObject var59 = (SubLObject)makeBoolean(NIL == module0144.$g1780$.getDynamicValue(var51));
        SubLObject var60 = (SubLObject)makeBoolean(NIL == module0144.$g1769$.getDynamicValue(var51));
        final SubLObject var61 = (SubLObject)((NIL != module0202.f12981(var50, var31)) ? NIL : module0205.f13329(var22));
        final SubLObject var62 = (SubLObject)makeBoolean(NIL != module0152.f9720() || (NIL != module0144.$g1811$.getDynamicValue(var51) && NIL != module0167.f10813(var22)));
        if (NIL != module0167.f10813(var61)) {
            return f20944(var50, var61, var31, var2);
        }
        if (NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57 || NIL == var58 || NIL == var59 || NIL == var60) {
            ...
            try {
                module0144.$g1796$.bind((SubLObject)NIL, var51);
                module0144.$g1795$.bind((SubLObject)NIL, var51);
                module0152.$g2116$.bind((SubLObject)NIL, var51);
                module0152.$g2115$.bind((SubLObject)NIL, var51);
                if (NIL != f20978(var50, var22, var31, var2)) {
                    return (SubLObject)T;
                }
            }
            finally {
            ...
            try {
                ...
                module0144.$g1826$.bind((SubLObject)$ic14$, var51);
                if (NIL == var52) {
                    if (NIL != var62 || NIL != module0259.f16821(var22, var2, (SubLObject)UNPROVIDED)) {
                        var52 = f20981(var50, var22, var31, (SubLObject)$ic15$);
                    }
                    else {
                        ...
                        try {
                            module0144.$g1750$.bind((SubLObject)NIL, var51);
                            module0144.$g1748$.bind((SubLObject)NIL, var51);
                            module0144.$g1769$.bind((SubLObject)NIL, var51);
                ...
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52)) && NIL == var53) {
                    if (NIL != var62 || NIL != module0259.f16972(var22, var2, (SubLObject)UNPROVIDED)) {
                        var53 = f20981(var50, var22, var31, (SubLObject)$ic16$);
                    }
                    else {
                        ...
                        try {
                            module0144.$g1749$.bind((SubLObject)NIL, var51);
                            module0144.$g1748$.bind((SubLObject)NIL, var51);
                            module0144.$g1769$.bind((SubLObject)NIL, var51);
                ...
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53)) && NIL == var54) {
                    var54 = f20981(var50, var22, var31, (SubLObject)$ic17$);
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54)) && NIL == var55) {
                    if (NIL != var62 || NIL != module0256.f16524(var22, var2, (SubLObject)UNPROVIDED)) {
                        var55 = f20981(var50, var22, var31, (SubLObject)$ic18$);
                    }
                    else {
                        var55 = f20981(var50, var22, var31, (SubLObject)$ic19$);
                    }
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55)) && NIL == var56) {
                    var56 = f20981(var50, var22, var31, (SubLObject)$ic20$);
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56)) && NIL == var57) {
                    var57 = f20981(var50, var22, var31, (SubLObject)$ic21$);
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57)) && NIL == var58) {
                    var58 = f20981(var50, var22, var31, (SubLObject)$ic22$);
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57 || NIL == var58)) && NIL == var59) {
                    var59 = f20981(var50, var22, var31, (SubLObject)$ic23$);
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57 || NIL == var58 || NIL == var59)) && NIL == var60) {
                    var60 = f20981(var50, var22, var31, (SubLObject)$ic24$);
                }
            }
            finally {
        ...
        return (SubLObject)makeBoolean(NIL != var52 && NIL != var53 && NIL != var54 && NIL != var55 && NIL != var56 && NIL != var57 && NIL != var58 && NIL != var59 && NIL != var60);
    }
    ...
    public static SubLObject f20972(final SubLObject var50, final SubLObject var22, final SubLObject var31, final SubLObject var2) {
        final SubLThread var51 = SubLProcess.currentSubLThread();
        assert NIL != module0202.f12659(var22) : var22;
        if (NIL != module0144.$g1810$.getDynamicValue(var51)) {
    ...
    public static SubLObject f20982(final SubLObject var50, final SubLObject var22, final SubLObject var31, final SubLObject var2) {
        ...
        SubLObject var58 = (SubLObject)makeBoolean(NIL == module0144.$g1759$.getDynamicValue(var51));
        SubLObject var59 = (SubLObject)makeBoolean(NIL == module0144.$g1780$.getDynamicValue(var51));
        SubLObject var60 = (SubLObject)T;
        SubLObject var61 = module0205.f13276(var22);
        final SubLObject var62 = (SubLObject)((NIL != module0202.f12981(var50, var31)) ? NIL : module0205.f13329(var22));
        if (NIL != module0167.f10813(var62)) {
        ...
        if (NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57 || NIL == var58 || NIL == var59 || NIL == var60) {
            ...
            try {
                ...
                module0144.$g1826$.bind((SubLObject)$ic26$, var51);
                if (NIL == var52) {
                    if (NIL != module0226.f14982(var61, var2) || NIL != module0226.f14985(var61, var2) || NIL != module0226.f14989(var22, var2)) {
                        var52 = f20981(var50, var22, var31, (SubLObject)$ic15$);
                    }
                    else {
                        ...
                        try {
                            ...
                            module0144.$g1748$.bind((SubLObject)NIL, var51);
                            module0144.$g1769$.bind((SubLObject)NIL, var51);
                            var52 = f20979(var50, var22, var31, (SubLObject)UNPROVIDED);
                        }
                        finally {
                ...
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52)) && NIL == var53) {
                    if (NIL != module0279.f18533(var61, var2) || NIL != module0226.f14991(var61, var2) || NIL != module0226.f14994(var61, var2)) {
                        var53 = f20981(var50, var22, var31, (SubLObject)$ic16$);
                    }
                    else {
                        ...
                        try {
                            ...
                            module0144.$g1748$.bind((SubLObject)NIL, var51);
                            module0144.$g1769$.bind((SubLObject)NIL, var51);
                            var53 = f20979(var50, var22, var31, (SubLObject)UNPROVIDED);
                        }
                        finally {
                ...
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54)) && NIL == var55) {
                    if (NIL != module0205.f13145((SubLObject)$ic27$, var22, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        var55 = (SubLObject)T;
                    }
                    else {
                        var55 = f20981(var50, var22, var31, (SubLObject)$ic18$);
                ...
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57)) && NIL == var58) {
                    var58 = f20981(var50, var22, var31, (SubLObject)$ic20$);
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57 || NIL == var58)) && NIL == var59) {
                    var59 = f20981(var50, var22, var31, (SubLObject)$ic23$);
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57 || NIL == var58 || NIL == var59)) && NIL == var60) {
                    ...
                    try {
                        module0144.$g1770$.bind((SubLObject)NIL, var51);
                        var60 = f20981(var50, var22, var31, (SubLObject)$ic24$);
                    }
                    finally {
    ...
    public static SubLObject f20983(final SubLObject var50, final SubLObject var22, final SubLObject var31, final SubLObject var2) {
        final SubLThread var51 = SubLProcess.currentSubLThread();
        SubLObject var52 = (SubLObject)makeBoolean(NIL == module0144.$g1749$.getDynamicValue(var51));
        SubLObject var53 = (SubLObject)makeBoolean(NIL == module0144.$g1750$.getDynamicValue(var51));
        SubLObject var54 = (SubLObject)makeBoolean(NIL == module0144.$g1751$.getDynamicValue(var51));
        SubLObject var55 = (SubLObject)makeBoolean(NIL == module0144.$g1748$.getDynamicValue(var51));
        SubLObject var56 = (SubLObject)makeBoolean(NIL == module0144.$g1758$.getDynamicValue(var51));
        SubLObject var57 = (SubLObject)makeBoolean(NIL == module0144.$g1760$.getDynamicValue(var51));
        SubLObject var58 = (SubLObject)makeBoolean(NIL == module0144.$g1759$.getDynamicValue(var51));
        SubLObject var59 = (SubLObject)makeBoolean(NIL == module0144.$g1780$.getDynamicValue(var51));
        ...
        if (NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57 || NIL == var58 || NIL == var59 || NIL == var60) {
            ...
            try {
                ...
                if (NIL == var52) {
                    if (NIL != module0226.f14982(var61, var2) || NIL != module0226.f14985(var61, var2) || NIL != module0226.f14989(var22, var2)) {
                        var52 = f20981(var50, var22, var31, (SubLObject)$ic28$);
                    }
                    else {
                ...
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52)) && NIL == var53) {
                    if (NIL != module0226.f14991(var61, var2) || NIL != module0226.f14994(var61, var2)) {
                        var53 = f20981(var50, var22, var31, (SubLObject)$ic29$);
                    }
                    else {
                ...
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54)) && NIL == var55) {
                    if (NIL != module0226.f14997(var61, (SubLObject)UNPROVIDED) || NIL != module0226.f14999(var61, (SubLObject)UNPROVIDED) || NIL != module0226.f15001(var22, var2)) {
                        var55 = f20981(var50, var22, var31, (SubLObject)$ic19$);
                    }
                    else if (NIL != module0205.f13215((SubLObject)$ic27$, var22, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        var55 = (SubLObject)T;
                    }
                    else {
                        final SubLObject var67 = (SubLObject)makeBoolean(NIL != module0256.f16596(var62, $ic30$, var2, (SubLObject)UNPROVIDED) || NIL != module0259.f16854(var61, $ic31$, var2, (SubLObject)UNPROVIDED));
                        ...
                        try {
                            module0139.$g1630$.bind((SubLObject)NIL, var51);
                            ...
                            try {
                                ...
                                if (NIL != var67) {
                                    module0251.f16238($ic32$, (SubLObject)UNPROVIDED);
                                }
                                final SubLObject var4_79 = module0144.$g1826$.currentBinding(var51);
                                try {
                                    module0144.$g1826$.bind((SubLObject)$ic33$, var51);
                                    var55 = f20981(var50, var22, var31, (SubLObject)$ic19$);
                                }
                                finally {
    ...
    public static SubLObject f20978(SubLObject var50, SubLObject var22, SubLObject var31, SubLObject var2) {
        ...
        SubLObject var57 = (SubLObject)makeBoolean(NIL == module0144.$g1760$.getDynamicValue(var51));
        SubLObject var58 = (SubLObject)makeBoolean(NIL == module0144.$g1759$.getDynamicValue(var51));
        SubLObject var59 = (SubLObject)makeBoolean(NIL == module0144.$g1769$.getDynamicValue(var51));
        SubLObject var60 = (SubLObject)makeBoolean(NIL == module0144.$g1780$.getDynamicValue(var51));
        if (NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57 || NIL == var58 || NIL == var59 || NIL == var60) {
            ...
            try {
                ...
                module0144.$g1826$.bind((SubLObject)$ic34$, var51);
                if (NIL == var52) {
                    var52 = f20981(var50, var22, var31, (SubLObject)$ic28$);
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52)) && NIL == var53) {
                ...
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var58 || NIL == var57)) && NIL == var59) {
                    var59 = f20981(var50, var22, var31, (SubLObject)$ic24$);
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var58 || NIL == var57 || NIL == var59)) && NIL == var60) {
                    var60 = f20981(var50, var22, var31, (SubLObject)$ic23$);
                }
            }
            finally {
        ...
        return (SubLObject)makeBoolean(NIL != var52 && NIL != var53 && NIL != var54 && NIL != var55 && NIL != var56 && NIL != var58 && NIL != var57 && NIL != var59 && NIL != var60 && (NIL == module0144.$g1772$.getDynamicValue(var51) || NIL != f20968(var50, var22, var31, var2)));
    }
    ...
    public static SubLObject f20979(SubLObject var50, SubLObject var22, SubLObject var31, SubLObject var2) {
        ...
        if (NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var57 || NIL == var58 || NIL == var59 || NIL == var60) {
            ...
            try {
                ...
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var55 || NIL == var58)) && NIL == var59) {
                    var59 = f20981(var50, var22, var31, (SubLObject)$ic24$);
                }
                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var52 || NIL == var53 || NIL == var54 || NIL == var55 || NIL == var56 || NIL == var55 || NIL == var58 || NIL == var59)) && NIL == var60) {
                    var60 = f20981(var50, var22, var31, (SubLObject)$ic23$);
                }
            }
            finally {
        ...
        return (SubLObject)makeBoolean(NIL != var52 && NIL != var53 && NIL != var54 && NIL != var55 && NIL != var56 && NIL != var55 && NIL != var58 && NIL != var59 && NIL != var60);
    }
    ...
    public static SubLObject f20984(SubLObject var50, SubLObject var93, SubLObject var31, SubLObject var2) {
        ...
        SubLObject var95 = (SubLObject)makeBoolean(NIL == module0144.$g1749$.getDynamicValue(var94));
        SubLObject var96 = (SubLObject)makeBoolean(NIL == module0144.$g1750$.getDynamicValue(var94));
        SubLObject var97 = (SubLObject)makeBoolean(NIL == module0144.$g1748$.getDynamicValue(var94));
        if (NIL == var95 || NIL == var96 || NIL == var97) {
            ...
            try {
                ...
                final SubLObject var102 = (SubLObject)((NIL != module0173.f10955(var50)) ? makeBoolean(NIL != module0260.f17006(var50, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) || NIL != module0260.f17008(var50, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) : NIL);
                ...
                try {
                    ...
                    module0144.$g1843$.bind((SubLObject)makeBoolean(NIL != module0144.$g1781$.getDynamicValue(var94) && NIL != var102), var94);
                    module0144.$g1844$.bind((SubLObject)makeBoolean(NIL != module0144.$g1782$.getDynamicValue(var94) && NIL != var102), var94);
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                module0144.$g1826$.bind((SubLObject)$ic34$, var94);
                                if (NIL == var95) {
                                    ...
                                    try {
                                        module0139.$g1630$.bind((SubLObject)NIL, var94);
                                        ...
                                        try {
                                            ...
                                            module0251.f16232(module0137.f8955($ic36$), var93, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                            var95 = f20981(var50, var93, var31, (SubLObject)$ic28$);
                                        }
                                        finally {
                                ...
                                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var95)) && NIL == var96) {
                                    var96 = f20981(var50, var93, var31, (SubLObject)$ic29$);
                                }
                                if (NIL == module0303.f20199((SubLObject)makeBoolean(NIL == var95 || NIL == var96)) && NIL == var97) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            var97 = f20981(var50, var93, var31, (SubLObject)$ic19$);
                                        }
                                        finally {
        ...
        return (SubLObject)makeBoolean(NIL != var95 && NIL != var96 && NIL != var97);
    }
    ...
    public static SubLObject f20981(final SubLObject var50, final SubLObject var22, final SubLObject var31, SubLObject var112) {
        ...
        if (var50.eql($ic37$)) {
            ...
            try {
                module0206.$g2330$.bind((SubLObject)T, var113);
                if ($ic33$ != module0144.$g1826$.getDynamicValue(var113) || NIL == module0144.$g1809$.getDynamicValue(var113) || NIL == module0152.f9726() || NIL == module0278.f18430(var22, (SubLObject)UNPROVIDED)) {
                    if (NIL != module0004.f104(var112, (SubLObject)$ic38$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        if (NIL != module0144.$g1755$.getDynamicValue(var113)) {
                            var114 = f20985(var50, var22, var31, var112);
                        }
                    }
                    else if (NIL != module0144.$g1756$.getDynamicValue(var113) && var112.eql((SubLObject)$ic17$)) {
                        var114 = f20985(var50, var22, var31, var112);
                    }
                    else if (NIL != module0144.$g1757$.getDynamicValue(var113) && NIL != module0004.f104(var112, (SubLObject)$ic39$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                        var114 = f20985(var50, var22, var31, var112);
                    }
                    else if (NIL != module0144.$g1758$.getDynamicValue(var113) && var112.eql((SubLObject)$ic20$)) {
                        var114 = f20985(var50, var22, var31, var112);
                    }
                    else if (NIL != module0144.$g1760$.getDynamicValue(var113) && var112.eql((SubLObject)$ic21$)) {
                        var114 = f20985(var50, var22, var31, var112);
                    }
                    else if (NIL != module0144.$g1759$.getDynamicValue(var113) && var112.eql((SubLObject)$ic22$)) {
                        var114 = f20985(var50, var22, var31, var112);
                    }
                    else if (NIL != module0144.$g1779$.getDynamicValue(var113) && var112.eql((SubLObject)$ic24$)) {
                        f20986();
                        var114 = f20985(var50, var22, var31, var112);
                    }
                    else if (NIL != module0144.$g1780$.getDynamicValue(var113) && var112.eql((SubLObject)$ic23$)) {
                        var114 = f20985(var50, var22, var31, var112);
                    }
                    if (NIL == module0303.f20199(var114)) {
                        var114 = (SubLObject)makeBoolean(NIL != f20987(var50, var22, var31, var112) || NIL != var114);
                    }
                }
            }
            finally {
        ...
        else if ($ic33$ != module0144.$g1826$.getDynamicValue(var113) || NIL == module0144.$g1809$.getDynamicValue(var113) || NIL == module0152.f9726() || NIL == module0278.f18430(var22, (SubLObject)UNPROVIDED)) {
            if (NIL != module0004.f104(var112, (SubLObject)$ic38$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                if (NIL != module0144.$g1755$.getDynamicValue(var113)) {
                    var114 = f20985(var50, var22, var31, var112);
                }
        ...
        return (SubLObject)makeBoolean(NIL == var114);
    }
    ...
    public static SubLObject f20985(final SubLObject var50, final SubLObject var22, final SubLObject var31, SubLObject var112) {
        ...
        if (NIL == var116) {
            SubLObject var117 = module0205.f13207(module0144.$g1828$.getDynamicValue(var113), (SubLObject)UNPROVIDED);
            SubLObject var118 = (SubLObject)NIL;
            var118 = var117.first();
            while (NIL == var116 && NIL != var117) {
                var114 = Numbers.add(var114, (SubLObject)ONE_INTEGER);
                if (!var31.eql(var114)) {
                    var115 = (SubLObject)makeBoolean(NIL != f20988(var50, var118, var114, var22, var31, var112) || NIL != var115);
    ...
    public static SubLObject f20987(final SubLObject var50, final SubLObject var22, final SubLObject var31, final SubLObject var112) {
        if (var112.eql((SubLObject)$ic28$)) {
            return module0302.f20034(var50, var22, var31);
        }
        if (var112.eql((SubLObject)$ic17$)) {
            return module0302.f20042(var50, var22, var31);
        }
        if (var112.eql((SubLObject)$ic29$)) {
            return module0302.f20051(var50, var22, var31);
        }
        if (var112.eql((SubLObject)$ic19$)) {
            return module0302.f20056(var50, var22, var31);
        }
        if (var112.eql((SubLObject)$ic15$)) {
            return module0302.f20047(var50, var22, var31);
        }
        if (var112.eql((SubLObject)$ic16$)) {
            return module0302.f20054(var50, var22, var31);
        }
        if (var112.eql((SubLObject)$ic18$)) {
            return module0302.f20059(var50, var22, var31);
        }
        if (var112.eql((SubLObject)$ic24$)) {
            return module0302.f20061(var50, var22, var31);
        }
        if (var112.eql((SubLObject)$ic23$)) {
            return (SubLObject)NIL;
        }
        module0202.f12747((SubLObject)THREE_INTEGER, (SubLObject)$ic40$, var112, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f20988(final SubLObject var50, final SubLObject var115, final SubLObject var114, final SubLObject var116, final SubLObject var117, final SubLObject var112) {
        ...
        if (var112.eql((SubLObject)$ic23$)) {
            return (SubLObject)makeBoolean(var114.numG(var117) && NIL != module0302.f20087(var50, var115, var114, var116, var117));
        }
        module0202.f12747((SubLObject)THREE_INTEGER, (SubLObject)$ic41$, var112, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f20934(final SubLObject var118, SubLObject var2) {
        ...
        if (NIL == module0173.f10955(var118) || NIL == module0144.f9454()) {
            return (SubLObject)T;
        }
    ...
    public static SubLObject f20989(final SubLObject var118, final SubLObject var2) {
        ...
        var121 = module0034.f1857(var120, (SubLObject)$ic42$, (SubLObject)UNPROVIDED);
        if (NIL == var121) {
            var121 = module0034.f1807(module0034.f1842(var120), (SubLObject)$ic42$, (SubLObject)TWO_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var120, (SubLObject)$ic42$, var121);
        }
        final SubLObject var122 = module0034.f1782(var118, var2);
        final SubLObject var123 = module0034.f1814(var121, var122, (SubLObject)UNPROVIDED);
        if (var123 != $ic7$) {
            ...
            while (NIL != var124) {
                ...
                if (var118.equal(var126.first())) {
                    var126 = var126.rest();
                    if (NIL != var126 && NIL == var126.rest() && var2.equal(var126.first())) {
    ...
    public static SubLObject f20990(final SubLObject var118, SubLObject var2) {
        ...
        final SubLObject var121 = (SubLObject)((NIL != module0144.$g1754$.getDynamicValue(var119)) ? ConsesLow.list(module0226.f15152(var118)) : NIL);
        if (NIL != var121 && NIL == module0262.f17342(var2, var121, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
            var120 = (SubLObject)NIL;
            if (NIL != module0144.$g1796$.getDynamicValue(var119)) {
                module0303.f20257((SubLObject)THREE_INTEGER, (SubLObject)$ic43$, var118, var2, var121, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                if (NIL != module0144.$g1794$.getDynamicValue(var119)) {
                    module0303.f20193((SubLObject)ONE_INTEGER, (SubLObject)$ic43$, var118, var2, var121, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                }
                module0303.f20203((SubLObject)ConsesLow.list((SubLObject)$ic44$, var118, var2, var121));
            }
        }
        return var120;
    }
    ...
    public static SubLObject f20935(final SubLObject var12, SubLObject var2) {
        ...
        SubLObject var15 = (SubLObject)T;
        if (NIL != module0144.$g1771$.getDynamicValue(var13)) {
            if (NIL != module0173.f10955(var14)) {
                if (NIL != module0210.f13568(var14)) {
    ...
    public static SubLObject f20992(final SubLObject var10, SubLObject var2) {
        ...
        final SubLThread var11 = SubLProcess.currentSubLThread();
        SubLObject var12 = (SubLObject)T;
        final SubLObject var13 = module0202.f12832(var10, (SubLObject)UNPROVIDED);
        ...
        if (NIL == var14) {
            ...
            try {
                module0144.$g1824$.bind((SubLObject)NIL, var11);
                ...
                while (NIL == var14 && NIL != var15) {
                    ...
                    if (var17.eql((SubLObject)$ic45$)) {
                        if (NIL != module0226.f14798(var13)) {
                            ...
                            try {
                                module0144.$g1789$.bind((SubLObject)T, var11);
                                module0144.$g1774$.bind((SubLObject)NIL, var11);
                                var12 = (SubLObject)makeBoolean(NIL != f20993(var10, var2) && NIL != var12);
                            }
                            finally {
                        ...
                        if (NIL != module0226.f14799(var13)) {
                            final SubLObject var4_128 = module0144.$g1789$.currentBinding(var11);
                            final SubLObject var18 = module0144.$g1774$.currentBinding(var11);
                            try {
                                module0144.$g1789$.bind((SubLObject)T, var11);
                                module0144.$g1774$.bind((SubLObject)NIL, var11);
                                var12 = (SubLObject)makeBoolean(NIL != f20994(var10, var2) && NIL != var12);
                            }
                            finally {
                                module0144.$g1774$.rebind(var18, var11);
                        ...
                        if (NIL != module0226.f14796(var13)) {
                            final SubLObject var4_129 = module0144.$g1789$.currentBinding(var11);
                            final SubLObject var18 = module0144.$g1774$.currentBinding(var11);
                            try {
                                module0144.$g1789$.bind((SubLObject)T, var11);
                                module0144.$g1774$.bind((SubLObject)NIL, var11);
                                var12 = (SubLObject)makeBoolean(NIL != f20995(var10, var2) && NIL != var12);
                            }
                            finally {
                                module0144.$g1774$.rebind(var18, var11);
                        ...
                        if (NIL != module0226.f14801(var13)) {
                            final SubLObject var4_130 = module0144.$g1789$.currentBinding(var11);
                            final SubLObject var18 = module0144.$g1774$.currentBinding(var11);
                            try {
                                module0144.$g1789$.bind((SubLObject)T, var11);
                                module0144.$g1774$.bind((SubLObject)NIL, var11);
                                var12 = (SubLObject)makeBoolean(NIL != f20996(var10, var2) && NIL != var12);
                            }
                            finally {
                                module0144.$g1774$.rebind(var18, var11);
                        ...
                        try {
                            module0144.$g1789$.bind((SubLObject)T, var11);
                            module0144.$g1774$.bind((SubLObject)NIL, var11);
                            var12 = (SubLObject)makeBoolean(NIL != f20997(var10, var2) && NIL != var12);
                        }
                        finally {
                            module0144.$g1774$.rebind(var18, var11);
                        ...
                        try {
                            module0144.$g1789$.bind((SubLObject)T, var11);
                            module0144.$g1774$.bind((SubLObject)NIL, var11);
                            var12 = (SubLObject)makeBoolean(NIL != f20998(var10, var2) && NIL != var12);
                        }
                        finally {
                            module0144.$g1774$.rebind(var18, var11);
                        ...
                        module0202.f12747((SubLObject)THREE_INTEGER, (SubLObject)$ic51$, module0144.$g1824$.getDynamicValue(var11), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    }
                    if (NIL == var12 && NIL == module0144.$g1795$.getDynamicValue(var11)) {
                        var14 = (SubLObject)T;
                    }
                    var15 = var15.rest();
                    module0144.$g1824$.setDynamicValue(var15.first(), var11);
    ...
    public static SubLObject f20993(final SubLObject var133, SubLObject var2) {
        ...
        if (NIL != var135) {
            ...
            try {
                module0144.$g1829$.bind($ic52$, var134);
                if (NIL != module0144.$g1829$.getDynamicValue(var134)) {
                    module0303.f20202($ic53$);
                }
            }
            finally {
    ...
    public static SubLObject f20999(final SubLObject var133, final SubLObject var2) {
        final SubLThread var134 = SubLProcess.currentSubLThread();
        final SubLObject var135 = module0205.f13326(var133, (SubLObject)ZERO_INTEGER);
        final SubLObject var136 = module0205.f13326(var133, (SubLObject)ONE_INTEGER);
        final SubLObject var137 = module0205.f13326(var133, (SubLObject)TWO_INTEGER);
    ...
    public static SubLObject f21000(final SubLObject var135, final SubLObject var136, final SubLObject var137) {
        ...
        try {
            module0018.$g584$.bind((SubLObject)NIL, var138);
            module0144.$g1834$.bind(var136, var138);
            module0144.$g1835$.bind(var137, var138);
            final SubLObject var143 = f21001(module0202.f12768(var135, var137, var136), (SubLObject)$ic54$, (SubLObject)$ic55$);
            final SubLObject var144 = module0217.f14398(var143);
            SubLObject var145 = (SubLObject)NIL;
            try {
                var138.throwStack.push($ic56$);
                final SubLObject var4_141 = module0144.$g1793$.currentBinding(var138);
                try {
                    module0144.$g1793$.bind((SubLObject)T, var138);
                    if (var144 == $ic57$) {
                        final SubLObject var146 = module0217.f14399(var143);
                        if (NIL != f21002(module0144.$g1828$.getDynamicValue(var138))) {
                            module0219.f14478((SubLObject)$ic58$, var146, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                        }
                    }
                    else if (var144 == $ic59$) {
                        ...
                        var138.resetMultipleValues();
                        module0221.f14612((SubLObject)$ic58$, var147, var148, var149);
                    }
                    else {
                        Errors.cerror((SubLObject)$ic60$, (SubLObject)$ic61$);
                    }
                }
                finally {
                ...
                var145 = Errors.handleThrowable(var150, (SubLObject)$ic56$);
            }
            finally {
    ...
    public static SubLObject f21003(final SubLObject var144) {
        ...
        if (NIL != module0178.f11284(var144)) {
            final SubLObject var146 = module0178.f11285(var144);
            if (module0144.$g1834$.getDynamicValue(var145).equal(module0202.f12831(var146, (SubLObject)TWO_INTEGER, (SubLObject)UNPROVIDED)) && module0144.$g1835$.getDynamicValue(var145).equal(module0202.f12831(var146, (SubLObject)ONE_INTEGER, (SubLObject)UNPROVIDED))) {
                module0018.$g584$.setDynamicValue((SubLObject)ConsesLow.cons(var144, module0018.$g584$.getDynamicValue(var145)), var145);
                if (NIL != module0144.$g1789$.getDynamicValue(var145) && NIL == conses_high.member(var144, module0144.$g1774$.getDynamicValue(var145), Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                    module0144.$g1774$.setDynamicValue((SubLObject)ConsesLow.cons(var144, module0144.$g1774$.getDynamicValue(var145)), var145);
                }
                if (NIL == module0144.$g1795$.getDynamicValue(var145)) {
                    module0303.f20201();
                }
            }
        }
    ...
    public static SubLObject f21004(final SubLObject var133, final SubLObject var2) {
        ...
        try {
            ...
            module0147.$g2094$.bind(module0147.f9546(var2), var134);
            module0147.$g2096$.bind(module0147.f9549(var2), var134);
            if (NIL == module0331.f22370(var136, var137, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                var138 = f21000(var135, var136, var137);
            }
        }
        finally {
    ...
    public static SubLObject f20995(final SubLObject var133, SubLObject var2) {
        ...
        try {
            ...
            if (NIL != var135 || NIL != module0144.$g1795$.getDynamicValue(var134)) {
                final SubLObject var142 = module0205.f13326(var133, (SubLObject)ZERO_INTEGER);
                if (NIL != module0226.f14800(var142) && NIL != module0316.f21362(var142, (SubLObject)$ic64$, var136, var137, var2, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                    var135 = (SubLObject)NIL;
                    if (NIL != module0144.$g1789$.getDynamicValue(var134)) {
                        module0144.$g1774$.setDynamicValue(module0316.f21362(var142, (SubLObject)$ic65$, var136, var137, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), var134);
                        if (NIL != module0144.$g1774$.getDynamicValue(var134)) {
                            module0144.$g1774$.setDynamicValue(ConsesLow.nconc(module0333.f22524(module0259.f16914(var142, $ic66$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), module0147.$g2095$.getDynamicValue(var134)), module0144.$g1774$.getDynamicValue(var134)), var134);
                        }
                    }
    ...
    public static SubLObject f20996(final SubLObject var133, SubLObject var2) {
        ...
        if (NIL != var135 && NIL != module0151.f9690()) {
            final SubLObject var136 = module0144.$g1829$.currentBinding(var134);
            try {
                module0144.$g1829$.bind($ic52$, var134);
                if (NIL != module0144.$g1829$.getDynamicValue(var134)) {
                    ...
                    try {
                        module0144.$g1833$.bind((SubLObject)ZERO_INTEGER, var134);
                        module0144.$g1812$.bind((SubLObject)NIL, var134);
                        module0303.f20202($ic67$);
                    }
                    finally {
    ...
    public static SubLObject f21005(final SubLObject var133, final SubLObject var2) {
        ...
        try {
            ...
            module0144.$g1834$.bind(module0205.f13326(var133, (SubLObject)ONE_INTEGER), var134);
            module0144.$g1835$.bind(module0205.f13326(var133, (SubLObject)TWO_INTEGER), var134);
    ...
    public static SubLObject f21006(final SubLObject var135, final SubLObject var136, final SubLObject var137) {
        ...
        try {
            module0018.$g584$.bind((SubLObject)NIL, var138);
            final SubLObject var141 = f21001(module0202.f12768(var135, var136, var137), (SubLObject)$ic54$, (SubLObject)$ic55$);
            ...
            try {
                ...
                try {
                    ...
                    if (var144.eql((SubLObject)$ic57$)) {
                        ...
                        try {
                            ...
                            if (NIL != f21002(module0144.$g1828$.getDynamicValue(var138))) {
                                ...
                                try {
                                    module0018.$g598$.bind((SubLObject)NIL, var138);
                                    module0018.$g599$.bind((SubLObject)NIL, var138);
                                    module0219.f14478((SubLObject)$ic68$, var145, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                                }
                                finally {
                    ...
                    else if (var144.eql((SubLObject)$ic59$)) {
                        var138.resetMultipleValues();
                            ...
                            if (var47_156.eql((SubLObject)ONE_INTEGER)) {
                                ...
                                try {
                                    ...
                                    while (NIL != var150) {
                                        ...
                                        try {
                                            module0018.$g589$.bind((SubLObject)NIL, var138);
                                            module0018.$g600$.bind((SubLObject)NIL, var138);
                                            module0018.$g588$.bind((SubLObject)NIL, var138);
                                            cdestructuring_bind.destructuring_bind_must_consp(var153, var152, (SubLObject)$ic69$);
                                            ...
                                            var153 = var153.rest();
                                            if (NIL == var153) {
                                                module0221.f14612((SubLObject)$ic70$, var147, module0018.$g589$.getDynamicValue(var138), module0018.$g585$.getDynamicValue(var138));
                                            }
                                            else {
                                                cdestructuring_bind.cdestructuring_bind_error(var152, (SubLObject)$ic69$);
                                            }
                                        }
                                        finally {
                                ...
                                try {
                                    ...
                                    while (NIL != var150) {
                                        ...
                                        try {
                                            ...
                                            module0018.$g600$.bind((SubLObject)NIL, var138);
                                            module0018.$g588$.bind((SubLObject)NIL, var138);
                                            cdestructuring_bind.destructuring_bind_must_consp(var157, var156, (SubLObject)$ic69$);
                                            ...
                                            if (NIL == var157) {
                                                ...
                                                cdestructuring_bind.cdestructuring_bind_error(var156, (SubLObject)$ic69$);
                                            }
                                        }
                                        finally {
                                            module0018.$g588$.rebind(var155, var138);
                ...
                var143 = Errors.handleThrowable(var158, (SubLObject)$ic56$);
            }
            finally {
                var138.throwStack.pop();
            }
    ...
    public static SubLObject f21007(final SubLObject var144) {
        final SubLThread var145 = SubLProcess.currentSubLThread();
        if (NIL != module0221.$g2399$.getDynamicValue(var145)) {
        ...
        if (NIL != module0178.f11284(var144)) {
            ...
            try {
                ...
                if (NIL != module0173.f10955(var147)) {
                    module0221.f14612((SubLObject)$ic73$, var147, module0018.$g600$.getDynamicValue(var145), module0018.$g585$.getDynamicValue(var145));
                }
            }
            finally {
    ...
    public static SubLObject f21008(final SubLObject var144) {
        ...
        if (NIL != module0178.f11284(var144)) {
            ...
            try {
                ...
                if (NIL != module0173.f10955(var147)) {
                    module0221.f14612((SubLObject)$ic73$, var147, var148, module0018.$g585$.getDynamicValue(var145));
                }
            }
            finally {
                module0018.$g597$.rebind(var146, var145);
    ...
    public static SubLObject f21010(final SubLObject var144) {
        ...
        if (NIL != module0178.f11284(var144)) {
            final SubLObject var146 = module0178.f11285(var144);
            final SubLObject var147 = (NIL != module0221.$g2399$.getDynamicValue(var145)) ? module0107.f7613(module0018.$g588$.getDynamicValue(var145)) : module0018.$g588$.getDynamicValue(var145);
            if (module0018.$g587$.getDynamicValue(var145).equal(module0202.f12831(var146, var147, (SubLObject)UNPROVIDED))) {
                module0018.$g584$.setDynamicValue((SubLObject)ConsesLow.cons(var144, module0018.$g584$.getDynamicValue(var145)), var145);
                if (NIL != module0144.$g1789$.getDynamicValue(var145)) {
                    if (!module0018.$g585$.getDynamicValue(var145).equal(module0202.f12832(var146, (SubLObject)UNPROVIDED))) {
                        SubLObject var149;
                        final SubLObject var148 = var149 = module0333.f22524(module0260.f17131(module0202.f12832(var146, (SubLObject)UNPROVIDED), module0018.$g585$.getDynamicValue(var145), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED), module0147.$g2095$.getDynamicValue(var145));
                        SubLObject var150 = (SubLObject)NIL;
                        var150 = var149.first();
                        while (NIL != var149) {
                            if (NIL != module0210.f13566(var150)) {
                                final SubLObject var151 = var150;
                                if (NIL == conses_high.member(var151, module0144.$g1774$.getDynamicValue(var145), Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                    ...
                    if (NIL == conses_high.member(var144, module0144.$g1774$.getDynamicValue(var145), Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                        module0144.$g1774$.setDynamicValue((SubLObject)ConsesLow.cons(var144, module0144.$g1774$.getDynamicValue(var145)), var145);
                    }
                    final SubLObject var152 = module0018.$g597$.getDynamicValue(var145);
                    if (NIL == conses_high.member(var152, module0144.$g1774$.getDynamicValue(var145), Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
    ...
    public static SubLObject f21011(final SubLObject var144) {
        ...
        if (NIL != module0178.f11284(var144)) {
            final SubLObject var146 = module0178.f11285(var144);
            final SubLObject var147 = module0202.f12833(var146, (SubLObject)UNPROVIDED);
            final SubLObject var148 = module0202.f12834(var146, (SubLObject)UNPROVIDED);
            final SubLObject var149 = module0202.f12835(var146, (SubLObject)UNPROVIDED);
            if (var148.equal(module0144.$g1834$.getDynamicValue(var145))) {
                ...
                if (NIL != module0004.f104(var149, module0018.$g599$.getDynamicValue(var145), Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED)) {
                    module0018.$g584$.setDynamicValue((SubLObject)ConsesLow.cons(var144, module0018.$g584$.getDynamicValue(var145)), var145);
                    if (NIL != module0144.$g1789$.getDynamicValue(var145)) {
                        if (NIL == conses_high.member(var144, module0144.$g1774$.getDynamicValue(var145), Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                            module0144.$g1774$.setDynamicValue((SubLObject)ConsesLow.cons(var144, module0144.$g1774$.getDynamicValue(var145)), var145);
                        ...
                        try {
                            module0144.$g1777$.bind((SubLObject)NIL, var145);
                            final SubLObject var151 = f21012((SubLObject)ConsesLow.list(var147, var149, module0144.$g1835$.getDynamicValue(var145)), (SubLObject)ZERO_INTEGER, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                            if (NIL != var151) {
            ...
            if (var149.equal(module0144.$g1835$.getDynamicValue(var145))) {
                ...
                if (NIL != module0004.f104(var148, module0018.$g598$.getDynamicValue(var145), Symbols.symbol_function((SubLObject)EQUAL), (SubLObject)UNPROVIDED)) {
                    module0018.$g584$.setDynamicValue((SubLObject)ConsesLow.cons(var144, module0018.$g584$.getDynamicValue(var145)), var145);
                    if (NIL != module0144.$g1789$.getDynamicValue(var145)) {
                        if (NIL == conses_high.member(var144, module0144.$g1774$.getDynamicValue(var145), Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                            module0144.$g1774$.setDynamicValue((SubLObject)ConsesLow.cons(var144, module0144.$g1774$.getDynamicValue(var145)), var145);
                        ...
                        try {
                            module0144.$g1777$.bind((SubLObject)NIL, var145);
                            final SubLObject var151 = f21012((SubLObject)ConsesLow.list(var147, module0144.$g1834$.getDynamicValue(var145), var148), (SubLObject)ZERO_INTEGER, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                            if (NIL != var151) {
                                final SubLObject var152 = var151;
                                if (NIL == conses_high.member(var152, module0144.$g1774$.getDynamicValue(var145), Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                                    module0144.$g1774$.setDynamicValue((SubLObject)ConsesLow.cons(var152, module0144.$g1774$.getDynamicValue(var145)), var145);
    ...
    public static SubLObject f21012(final SubLObject var174, SubLObject var175, SubLObject var2, SubLObject var167) {
        ...
        try {
            ...
            try {
                ...
                if (NIL == module0205.f13145((SubLObject)$ic74$, var174, (SubLObject)NIL, (SubLObject)UNPROVIDED)) {
                    ...
                    try {
                        module0148.$g2099$.bind((SubLObject)$ic75$, var176);
                        module0148.$g2097$.bind(module0205.f13333(var174), var176);
                        final SubLObject var182 = module0217.f14404(var181, var167, (SubLObject)NIL);
                        final SubLObject var184;
                        final SubLObject var183 = var184 = module0158.f10294(var182);
                        if (var184.eql((SubLObject)$ic59$)) {
                            ...
                            if (NIL != var186) {
                                if (NIL != var187) {
                                    ...
                                    if (NIL != module0158.f10010(var185, var186, var188)) {
                                        ...
                                        while (NIL == var190) {
                                            ...
                                            if (NIL != var193) {
                                                ...
                                                try {
                                                    var194 = module0158.f10316(var192, (SubLObject)$ic76$, var167, (SubLObject)NIL);
                                                    SubLObject var188_193 = var177;
                                                    final SubLObject var189_194 = (SubLObject)NIL;
                                                    while (NIL == var188_193) {
                                                        final SubLObject var195 = module0052.f3695(var194, var189_194);
                                                        final SubLObject var191_196 = (SubLObject)makeBoolean(!var189_194.eql(var195));
                                                        if (NIL != var191_196) {
                                                            var177 = f21013(var195);
                                                        }
                                                        var188_193 = (SubLObject)makeBoolean(NIL == var191_196 || NIL != var177);
                                                    }
                                                }
                                                finally {
                                            ...
                                            var190 = (SubLObject)makeBoolean(NIL == var193 || NIL != var177);
                                        }
                                    }
                                }
                                else {
                                        ...
                                        while (NIL == var190) {
                                            ...
                                            if (NIL != var193) {
                                                ...
                                                try {
                                                    ...
                                                    final SubLObject var189_195 = (SubLObject)NIL;
                                                    while (NIL == var188_194) {
                                                        final SubLObject var195 = module0052.f3695(var194, var189_195);
                                                        final SubLObject var191_197 = (SubLObject)makeBoolean(!var189_195.eql(var195));
                                                        if (NIL != var191_197) {
                                                            var177 = f21013(var195);
                                                        }
                                                        var188_194 = (SubLObject)makeBoolean(NIL == var191_197 || NIL != var177);
                                                    }
                                                }
                                                finally {
                                ...
                                final SubLObject var188 = var187;
                                if (NIL != module0158.f10010(var185, (SubLObject)NIL, var188)) {
                                    final SubLObject var189 = module0158.f10011(var185, (SubLObject)NIL, var188);
                                    SubLObject var190 = var177;
                                    final SubLObject var191 = (SubLObject)NIL;
                                    while (NIL == var190) {
                                        final SubLObject var192 = module0052.f3695(var189, var191);
                                        ...
                                        if (NIL != var193) {
                                            ...
                                            try {
                                                ...
                                                final SubLObject var189_196 = (SubLObject)NIL;
                                                while (NIL == var188_195) {
                                                    final SubLObject var195 = module0052.f3695(var194, var189_196);
                                                    final SubLObject var191_198 = (SubLObject)makeBoolean(!var189_196.eql(var195));
                                                    if (NIL != var191_198) {
                                                        var177 = f21013(var195);
                                                    }
                                                    var188_195 = (SubLObject)makeBoolean(NIL == var191_198 || NIL != var177);
                                                }
                                            }
                                            finally {
                                    ...
                                    while (NIL == var190) {
                                        ...
                                        if (NIL != var193) {
                                            ...
                                            try {
                                                ...
                                                final SubLObject var189_197 = (SubLObject)NIL;
                                                while (NIL == var188_196) {
                                                    final SubLObject var195 = module0052.f3695(var194, var189_197);
                                                    final SubLObject var191_199 = (SubLObject)makeBoolean(!var189_197.eql(var195));
                                                    if (NIL != var191_199) {
                                                        var177 = f21013(var195);
                                                    }
                                                    var188_196 = (SubLObject)makeBoolean(NIL == var191_199 || NIL != var177);
                                                }
                                            }
                                            finally {
                        ...
                        else if (var184.eql((SubLObject)$ic57$)) {
                            final SubLObject var196 = module0158.f10299(var182);
                            if (NIL != module0158.f10038(var196)) {
                                ...
                                try {
                                    ...
                                    module0012.$g67$.bind((SubLObject)ONE_INTEGER, var176);
                                    module0012.$g68$.bind((SubLObject)ZERO_INTEGER, var176);
                                    module0012.$g66$.bind((SubLObject)ZERO_INTEGER, var176);
                                    module0012.$g69$.bind((SubLObject)ZERO_INTEGER, var176);
                                    module0012.$g70$.bind((SubLObject)T, var176);
                                    module0012.$silent_progressP$.bind((SubLObject)((NIL != var197) ? module0012.$silent_progressP$.getDynamicValue(var176) : T), var176);
                                    ...
                                    while (NIL == var205) {
                                        ...
                                        final SubLObject var208 = (SubLObject)makeBoolean(!var206.eql(var207));
                                        if (NIL != var208) {
                                            module0012.f476();
                                            SubLObject var209 = (SubLObject)NIL;
                                            try {
                                                var209 = module0158.f10316(var207, (SubLObject)$ic76$, var167, (SubLObject)NIL);
                                                SubLObject var188_197 = var177;
                                                final SubLObject var189_198 = (SubLObject)NIL;
                                                while (NIL == var188_197) {
                                                    final SubLObject var210 = module0052.f3695(var209, var189_198);
                                                    final SubLObject var191_200 = (SubLObject)makeBoolean(!var189_198.eql(var210));
                                                    if (NIL != var191_200) {
                                                        var177 = f21013(var210);
                                                    }
                                                    var188_197 = (SubLObject)makeBoolean(NIL == var191_200 || NIL != var177);
                                                }
                                            }
                                            finally {
                                        ...
                                        var205 = (SubLObject)makeBoolean(NIL == var208 || NIL != var177);
                                    }
                                    module0012.f475();
                                }
                                finally {
                        ...
                        else if (var184.eql((SubLObject)$ic77$)) {
                            SubLObject var211;
                            SubLObject var212;
                            for (var211 = (SubLObject)NIL, var211 = module0218.f14453(module0158.f10301(var182), (SubLObject)UNPROVIDED); NIL == var177 && NIL != var211; var211 = var211.rest()) {
                                var212 = var211.first();
                                if (NIL == var167 || NIL != module0178.f11343(var212, var167)) {
    ...
    public static SubLObject f21013(final SubLObject var144) {
        ...
        if (NIL != module0178.f11284(var144)) {
            final SubLObject var146 = module0178.f11285(var144);
            if (module0202.f12829(module0018.$g587$.getDynamicValue(var145), (SubLObject)UNPROVIDED).equal(module0202.f12829(var146, (SubLObject)UNPROVIDED)) && (module0202.f12832(module0018.$g587$.getDynamicValue(var145), (SubLObject)UNPROVIDED).equal(module0202.f12832(var146, (SubLObject)UNPROVIDED)) || NIL != module0260.f17089(module0202.f12832(module0018.$g587$.getDynamicValue(var145), (SubLObject)UNPROVIDED), module0202.f12832(var146, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED))) {
                return var144;
            }
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f21014(final SubLObject var135, final SubLObject var136, final SubLObject var137) {
        ...
        final SubLObject var141 = Sequences.remove((SubLObject)NIL, (SubLObject)ConsesLow.list(var136, var137), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        if (NIL == var139) {
            SubLObject var142 = module0261.f17231(var135, (SubLObject)UNPROVIDED);
            SubLObject var143 = (SubLObject)NIL;
            var143 = var142.first();
            while (NIL == var139 && NIL != var142) {
                final SubLObject var144 = f21012(module0285.f18943(module0202.f12767(var143, var141, (SubLObject)UNPROVIDED)), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                if (NIL != module0210.f13566(var144)) {
                    ...
                    try {
                        module0144.$g1789$.bind((SubLObject)T, var138);
                        module0144.$g1774$.bind((SubLObject)NIL, var138);
                        final SubLObject var147 = var144;
                        if (NIL == conses_high.member(var147, module0144.$g1774$.getDynamicValue(var138), Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                        ...
                        try {
                            module0144.$g1829$.bind($ic78$, var138);
                            if (NIL != module0144.$g1829$.getDynamicValue(var138)) {
                    ...
                    if (NIL == module0144.$g1795$.getDynamicValue(var138)) {
                        var139 = (SubLObject)T;
                    }
                }
                var142 = var142.rest();
    ...
    public static SubLObject f21015(final SubLObject var135, final SubLObject var136, final SubLObject var137) {
        ...
        if (NIL != var136 && NIL != var137) {
            ...
            if (NIL == var139) {
                SubLObject var142 = module0261.f17234(var135, (SubLObject)UNPROVIDED);
                SubLObject var143 = (SubLObject)NIL;
                var143 = var142.first();
                while (NIL == var139 && NIL != var142) {
                    final SubLObject var144 = f21012(module0285.f18943(module0202.f12767(var143, var141, (SubLObject)UNPROVIDED)), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
                    if (NIL != module0210.f13566(var144)) {
                        ...
                        try {
                            ...
                            try {
                                module0144.$g1829$.bind($ic79$, var138);
                                if (NIL != module0144.$g1829$.getDynamicValue(var138)) {
                                    module0303.f20202(var143);
                                }
                            }
    ...
    public static SubLObject f20986() {
        final SubLObject var32 = $g2794$.getGlobalValue();
        if (NIL != var32) {
            module0034.f1818(var32);
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f21016(final SubLObject var224) {
        return module0034.f1829($g2794$.getGlobalValue(), (SubLObject)ConsesLow.list(var224), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f21017(final SubLObject var224) {
        return f21018(var224, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f21019(final SubLObject var224) {
        SubLObject var225 = $g2794$.getGlobalValue();
        if (NIL == var225) {
            var225 = module0034.f1934((SubLObject)$ic80$, (SubLObject)$ic81$, (SubLObject)$ic82$, (SubLObject)EQL, (SubLObject)ONE_INTEGER, (SubLObject)EIGHT_INTEGER);
        }
        SubLObject var226 = module0034.f1814(var225, var224, (SubLObject)$ic7$);
        if (var226 == $ic7$) {
            var226 = Values.arg2(Values.resetMultipleValues(), (SubLObject)Values.multiple_value_list(f21017(var224)));
            module0034.f1816(var225, var224, var226, (SubLObject)UNPROVIDED);
        }
    ...
    public static SubLObject f21021(final SubLObject var224, final SubLObject var10, final SubLObject var31, final SubLObject var2) {
        ...
        var227 = module0034.f1857(var226, (SubLObject)$ic83$, (SubLObject)UNPROVIDED);
        if (NIL == var227) {
            var227 = module0034.f1807(module0034.f1842(var226), (SubLObject)$ic83$, (SubLObject)FOUR_INTEGER, (SubLObject)NIL, (SubLObject)EQUAL, (SubLObject)UNPROVIDED);
            module0034.f1860(var226, (SubLObject)$ic83$, var227);
        }
        final SubLObject var228 = module0034.f1780(var224, var10, var31, var2);
        final SubLObject var229 = module0034.f1814(var227, var228, (SubLObject)UNPROVIDED);
        if (var229 != $ic7$) {
                ...
                if (var224.equal(var232.first())) {
                    ...
                    if (var10.equal(var232.first())) {
                        ...
                        if (var31.equal(var232.first())) {
                            var232 = var232.rest();
                            if (NIL != var232 && NIL == var232.rest() && var2.equal(var232.first())) {
    ...
    public static SubLObject f21018(final SubLObject var224, SubLObject var10, SubLObject var31, SubLObject var2) {
        ...
        module0202.f12747((SubLObject)THREE_INTEGER, (SubLObject)$ic93$, var224, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
        return (SubLObject)T;
    }
    
    public static SubLObject f21022(final SubLObject var10, final SubLObject var31, final SubLObject var2) {
        final SubLThread var32 = SubLProcess.currentSubLThread();
        if (NIL != module0144.$g1770$.getDynamicValue(var32)) {
    ...
    public static SubLObject f21030(final SubLObject var10, final SubLObject var31, final SubLObject var2, SubLObject var144) {
        ...
        try {
            module0144.$g1795$.bind((SubLObject)T, var145);
    ...
    public static SubLObject f21028(final SubLObject var10, final SubLObject var31, final SubLObject var2) {
        final SubLThread var32 = SubLProcess.currentSubLThread();
        SubLObject var33 = (SubLObject)NIL;
        final SubLObject var34 = module0035.f2151(var31, module0193.f12079((SubLObject)ZERO_INTEGER), var10);
        final SubLObject var35 = module0205.f13326(var10, var31);
        if (NIL == module0152.f9726() || NIL == module0235.f15475(module0152.f9728(), var34, (SubLObject)T, (SubLObject)UNPROVIDED)) {
            ...
            try {
                ...
                final SubLObject var39 = module0217.f14404(var34, (SubLObject)$ic54$, (SubLObject)$ic55$);
                final SubLObject var40 = module0217.f14398(var39);
                SubLObject var41 = (SubLObject)NIL;
                SubLObject var42 = (SubLObject)NIL;
                try {
                    var32.throwStack.push($ic56$);
                    final SubLObject var4_229 = module0144.$g1793$.currentBinding(var32);
                    try {
                        module0144.$g1793$.bind((SubLObject)T, var32);
                        final SubLObject var43 = var40;
                        if (var43.eql((SubLObject)$ic57$)) {
                            ...
                            if (NIL != f21002(var34)) {
                                ...
                                if (NIL != module0158.f10038(var45)) {
                                    ...
                                    try {
                                        ...
                                        module0012.$silent_progressP$.bind((SubLObject)((NIL != var46) ? module0012.$silent_progressP$.getDynamicValue(var32) : T), var32);
                                        ...
                                        while (NIL == var53) {
                                            ...
                                            if (NIL != var56) {
                                                ...
                                                try {
                                                    var57 = module0158.f10316(var55, (SubLObject)$ic76$, (SubLObject)NIL, (SubLObject)NIL);
                                                    SubLObject var188_233 = var41;
                                                    final SubLObject var189_234 = (SubLObject)NIL;
                                                    while (NIL == var188_233) {
                                                        final SubLObject var58 = module0052.f3695(var57, var189_234);
                                                        final SubLObject var191_235 = (SubLObject)makeBoolean(!var189_234.eql(var58));
                                                        if (NIL != var191_235 && NIL != f21031(var58, var34, var35, var31)) {
                                                            var33 = (SubLObject)ConsesLow.cons(var58, var33);
                                                            if (NIL == module0144.$g1795$.getDynamicValue(var32)) {
                                                                var41 = (SubLObject)T;
                                                            }
                                                        }
                                                        var188_233 = (SubLObject)makeBoolean(NIL == var191_235 || NIL != var41);
                                                    }
                                                }
                                                finally {
                                            ...
                                            var53 = (SubLObject)makeBoolean(NIL == var56 || NIL != var41);
                                        }
                                        module0012.f475();
                                    }
                                    finally {
                        ...
                        else if (var43.eql((SubLObject)$ic59$)) {
                            ...
                            if (NIL != module0158.f10010(var59, var60, var62)) {
                                ...
                                while (NIL == var64) {
                                    ...
                                    if (NIL != var67) {
                                        ...
                                        try {
                                            var68 = module0158.f10316(var66, (SubLObject)$ic76$, (SubLObject)NIL, (SubLObject)NIL);
                                            SubLObject var188_234 = var41;
                                            final SubLObject var189_235 = (SubLObject)NIL;
                                            while (NIL == var188_234) {
                                                final SubLObject var69 = module0052.f3695(var68, var189_235);
                                                final SubLObject var191_236 = (SubLObject)makeBoolean(!var189_235.eql(var69));
                                                if (NIL != var191_236 && NIL != f21031(var69, var34, var35, var31)) {
                                                    var33 = (SubLObject)ConsesLow.cons(var69, var33);
                                                    if (NIL == module0144.$g1795$.getDynamicValue(var32)) {
                                                        var41 = (SubLObject)T;
                                                    }
                                                }
                                                var188_234 = (SubLObject)makeBoolean(NIL == var191_236 || NIL != var41);
                                            }
                                        }
                                        finally {
                                    ...
                                    var64 = (SubLObject)makeBoolean(NIL == var67 || NIL != var41);
                                }
                            }
                        }
                    }
                    ...
                    var42 = Errors.handleThrowable(var70, (SubLObject)$ic56$);
                }
                finally {
    ...
    public static SubLObject f21002(final SubLObject var1) {
        final SubLThread var2 = SubLProcess.currentSubLThread();
        if (NIL != module0144.$g1775$.getDynamicValue(var2) && NIL != var1) {
            if (!module0144.$g1776$.getDynamicValue(var2).isNumber()) {
                return (SubLObject)T;
            }
            final SubLObject var3 = module0202.f12832(var1, (SubLObject)UNPROVIDED);
            final SubLObject var4 = (SubLObject)((NIL != module0173.f10955(var3)) ? module0217.f14249(var3) : NIL);
            if (var4.isNumber()) {
    ...
    public static SubLObject f21031(final SubLObject var144, final SubLObject var228, final SubLObject var22, final SubLObject var31) {
        ...
        if (NIL != module0178.f11284(var144) && NIL != module0211.f13635(var144)) {
            final SubLObject var230 = module0178.f11285(var144);
            if (NIL != module0235.f15475(var228, var230, (SubLObject)T, (SubLObject)UNPROVIDED) && NIL == module0331.f22370(var22, module0205.f13326(var230, var31), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
                if (NIL != module0144.$g1787$.getDynamicValue(var229) && NIL == conses_high.member(var144, module0144.$g1790$.getDynamicValue(var229), Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
    ...
    public static SubLObject f21032(final SubLObject var10, final SubLObject var31, final SubLObject var2) {
        ...
        if (NIL == module0152.f9726() || NIL == module0235.f15475(module0152.f9728(), var34, (SubLObject)T, (SubLObject)UNPROVIDED)) {
            ...
            try {
                ...
                if (var42.eql((SubLObject)$ic57$)) {
                    ...
                    if (NIL != f21002(var34)) {
                        ...
                        if (NIL != module0158.f10038(var44)) {
                            ...
                            try {
                                ...
                                module0012.$g69$.bind((SubLObject)ZERO_INTEGER, var32);
                                module0012.$g70$.bind((SubLObject)T, var32);
                                module0012.$silent_progressP$.bind((SubLObject)((NIL != var45) ? module0012.$silent_progressP$.getDynamicValue(var32) : T), var32);
                                ...
                                while (NIL == var52) {
                                    ...
                                    if (NIL != var55) {
                                        ...
                                        try {
                                            var56 = module0158.f10316(var54, (SubLObject)$ic76$, (SubLObject)NIL, (SubLObject)NIL);
                                            SubLObject var188_246 = var41;
                                            final SubLObject var189_247 = (SubLObject)NIL;
                                            while (NIL == var188_246) {
                                                final SubLObject var57 = module0052.f3695(var56, var189_247);
                                                final SubLObject var191_248 = (SubLObject)makeBoolean(!var189_247.eql(var57));
                                                if (NIL != var191_248 && NIL != f21033(var57, var34, var35, var31)) {
                                                    var33 = (SubLObject)ConsesLow.cons(var57, var33);
                                                    if (NIL == module0144.$g1795$.getDynamicValue(var32)) {
                                                        var41 = (SubLObject)T;
                                                    }
                                                }
                                                var188_246 = (SubLObject)makeBoolean(NIL == var191_248 || NIL != var41);
                                            }
                                        }
                                        finally {
                                    ...
                                    var52 = (SubLObject)makeBoolean(NIL == var55 || NIL != var41);
                                }
                                module0012.f475();
                            }
                            finally {
                ...
                else if (var42.eql((SubLObject)$ic59$)) {
                    var32.resetMultipleValues();
                    ...
                    if (NIL != module0158.f10010(var58, var59, var61)) {
                        ...
                        while (NIL == var63) {
                            ...
                            if (NIL != var66) {
                                ...
                                try {
                                    var67 = module0158.f10316(var65, (SubLObject)$ic76$, (SubLObject)NIL, (SubLObject)NIL);
                                    SubLObject var188_247 = var41;
                                    final SubLObject var189_248 = (SubLObject)NIL;
                                    while (NIL == var188_247) {
                                        final SubLObject var68 = module0052.f3695(var67, var189_248);
                                        final SubLObject var191_249 = (SubLObject)makeBoolean(!var189_248.eql(var68));
                                        if (NIL != var191_249 && NIL != f21033(var68, var34, var35, var31)) {
                                            var33 = (SubLObject)ConsesLow.cons(var68, var33);
                                            if (NIL == module0144.$g1795$.getDynamicValue(var32)) {
                                                var41 = (SubLObject)T;
                                            }
                                        }
                                        var188_247 = (SubLObject)makeBoolean(NIL == var191_249 || NIL != var41);
                                    }
                                }
                                finally {
                            ...
                            var63 = (SubLObject)makeBoolean(NIL == var66 || NIL != var41);
                        }
                    }
                }
            }
    ...
    public static SubLObject f21033(final SubLObject var144, final SubLObject var228, final SubLObject var22, final SubLObject var31) {
        ...
        if (NIL != module0178.f11284(var144)) {
            final SubLObject var230 = module0178.f11285(var144);
            if (NIL != module0235.f15475(var228, var230, (SubLObject)T, (SubLObject)UNPROVIDED) && NIL != module0328.f22230(var22, module0202.f12831(var230, var31, (SubLObject)UNPROVIDED), (SubLObject)UNPROVIDED)) {
                if (NIL != module0144.$g1787$.getDynamicValue(var229) && NIL == conses_high.member(var144, module0144.$g1790$.getDynamicValue(var229), Symbols.symbol_function((SubLObject)EQL), Symbols.symbol_function((SubLObject)IDENTITY))) {
                    module0144.$g1790$.setDynamicValue((SubLObject)ConsesLow.cons(var144, module0144.$g1790$.getDynamicValue(var229)), var229);
                }
                return (SubLObject)T;
    ...
    public static SubLObject f20945(final SubLObject var22) {
        ...
        if (NIL == module0152.$g2108$.getDynamicValue(var23)) {
            return (SubLObject)NIL;
        }
        if (NIL != f21037(var22)) {
            return (SubLObject)T;
        }
        if (NIL != module0210.f13598(var22) && (NIL != module0226.f14982(module0205.f13276(var22), (SubLObject)UNPROVIDED) || NIL != module0226.f14985(module0205.f13276(var22), (SubLObject)UNPROVIDED) || NIL != module0226.f14989(var22, (SubLObject)UNPROVIDED))) {
            return (SubLObject)NIL;
        }
        if (NIL != module0210.f13576(var22, (SubLObject)UNPROVIDED) && NIL != module0205.f13215((SubLObject)$ic27$, var22, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED)) {
            return (SubLObject)T;
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21037(final SubLObject var142) {
        ...
        return (SubLObject)makeBoolean(NIL != module0201.f12546(var142) || NIL != module0201.f12581(var142) || (NIL != module0152.$g2121$.getDynamicValue(var143) && NIL != module0304.f20296(var142)) || (NIL != module0152.$g2120$.getDynamicValue(var143) && var142.isKeyword()) || NIL != module0210.f13577(var142) || NIL != module0210.f13589(var142) || (NIL != module0131.$g1535$.getDynamicValue(var143) && NIL != module0167.f10813(var142)));
    }
    
    public static SubLObject f20962(final SubLObject var142, final SubLObject var2) {
        final SubLThread var143 = SubLProcess.currentSubLThread();
        return (SubLObject)makeBoolean((NIL != module0144.$g1800$.getDynamicValue(var143) && NIL != module0172.f10917(var142)) || (NIL == module0167.f10813(var142) && NIL != module0210.f13571(var142) && (NIL != module0173.f10955(module0205.f13276(var142)) || NIL == module0279.f18485(module0144.$g1831$.getDynamicValue(var143), module0144.$g1833$.getDynamicValue(var143), var2))));
    }
    
    public static SubLObject f20952(final SubLObject var142) {
        final SubLThread var143 = SubLProcess.currentSubLThread();
        return Equality.eql(module0144.$g1831$.getDynamicValue(var143), $ic10$);
    }
    
    public static SubLObject f20958(final SubLObject var142) {
        final SubLThread var143 = SubLProcess.currentSubLThread();
        return Equality.eql(module0144.$g1831$.getDynamicValue(var143), $ic94$);
    }
    
    public static SubLObject f20960(final SubLObject var142) {
        final SubLThread var143 = SubLProcess.currentSubLThread();
        return Equality.eql(module0144.$g1831$.getDynamicValue(var143), $ic95$);
    }
    ...
    public static SubLObject f20956(final SubLObject var142) {
        return (SubLObject)makeBoolean(NIL != module0173.f10955(var142) && NIL != module0152.f9720());
    }
    
    public static SubLObject f20954(final SubLObject var142) {
        final SubLThread var143 = SubLProcess.currentSubLThread();
        return (SubLObject)makeBoolean(((NIL != module0144.$g1799$.getDynamicValue(var143) || NIL != module0144.$g1800$.getDynamicValue(var143)) && NIL != module0173.f10955(var142)) || (NIL != module0144.$g1811$.getDynamicValue(var143) && (NIL != module0167.f10813(var142) || (NIL != module0279.f18539(var142, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED) && NIL != module0172.f10921(var142)))));
    }
    ...
    public static SubLObject f21038(final SubLObject var256, SubLObject var2, SubLObject var257) {
        ...
        if (var257 == UNPROVIDED) {
            var257 = (SubLObject)$ic96$;
        }
        final SubLThread var258 = SubLProcess.currentSubLThread();
        if (NIL != var256) {
            module0303.f20212((SubLObject)UNPROVIDED);
            SubLObject var259 = (SubLObject)NIL;
            SubLObject var260 = (SubLObject)NIL;
            cdestructuring_bind.destructuring_bind_must_consp(var256, var256, (SubLObject)$ic97$);
            var259 = var256.first();
            SubLObject var261 = var256.rest();
            cdestructuring_bind.destructuring_bind_must_consp(var261, var256, (SubLObject)$ic97$);
            var260 = var261.first();
            var261 = var261.rest();
            if (NIL == var261) {
                ...
                try {
                    module0144.$g1795$.bind((SubLObject)NIL, var258);
                    module0152.$g2131$.bind((SubLObject)NIL, var258);
                    if (NIL == var259) {
                        if (NIL == var262) {
                            SubLObject var265 = var260;
                            SubLObject var266 = (SubLObject)NIL;
                            var266 = var265.first();
                            while (NIL == var262 && NIL != var265) {
                                if (NIL == f21039(var266, var2, var257)) {
                                    var262 = (SubLObject)T;
                                }
                                var265 = var265.rest();
                                var266 = var265.first();
                        ...
                        if (NIL == var262 && NIL != module0271.$g2563$.getDynamicValue(var258)) {
                            var262 = (SubLObject)makeBoolean(NIL == module0307.f20758((SubLObject)ConsesLow.list(var256), var2, var257));
                        }
                    }
                }
                finally {
                ...
                return (SubLObject)makeBoolean(NIL == var262);
            }
            cdestructuring_bind.cdestructuring_bind_error(var256, (SubLObject)$ic97$);
        }
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21040(final SubLObject var256, SubLObject var2, SubLObject var257) {
        ...
        try {
            module0271.$g2562$.bind((SubLObject)NIL, var258);
            if (NIL == var259) {
                SubLObject var261;
                SubLObject var262;
                for (var261 = module0232.f15308(var256), var262 = (SubLObject)NIL, var262 = var261.first(); NIL == var259 && NIL != var261; var259 = (SubLObject)makeBoolean(NIL == f21039(var262, var2, var257)), var261 = var261.rest(), var262 = var261.first()) {}
            }
        }
        finally {
            module0271.$g2562$.rebind(var260, var258);
        }
        return (SubLObject)makeBoolean(NIL == var259);
    }
    ...
    public static SubLObject f21041(final SubLObject var10, SubLObject var2, SubLObject var257) {
        ...
        if (NIL != var259 && NIL != module0271.$g2563$.getDynamicValue(var258)) {
            var259 = module0307.f20758((SubLObject)ConsesLow.list(module0232.f15330((SubLObject)NIL, (SubLObject)ConsesLow.list(var10))), var2, var257);
        }
        return var259;
    }
    ...
    public static SubLObject f21039(final SubLObject var10, SubLObject var2, SubLObject var257) {
        ...
        final SubLThread var258 = SubLProcess.currentSubLThread();
        SubLObject var259 = (SubLObject)makeBoolean(NIL == module0271.$g2562$.getDynamicValue(var258) || NIL != f20927(var10, var2));
        if (NIL != var259 && NIL != module0144.$g1746$.getDynamicValue(var258)) {
            if (NIL != module0202.f12859(var10)) {
                if (NIL != module0202.f12691(var10, var257)) {
                    var259 = (SubLObject)makeBoolean(NIL != module0210.f13565(module0202.f12835(var10, (SubLObject)UNPROVIDED)) && NIL != module0259.f16854(module0202.f12834(var10, (SubLObject)UNPROVIDED), module0202.f12835(var10, (SubLObject)UNPROVIDED), var2, (SubLObject)UNPROVIDED));
                }
            }
            else if (NIL != module0202.f12865(var10) && NIL != module0202.f12691(var10, var257)) {
                var259 = (SubLObject)makeBoolean(NIL != module0210.f13565(module0202.f12834(var10, (SubLObject)UNPROVIDED)) && NIL != module0210.f13565(module0202.f12835(var10, (SubLObject)UNPROVIDED)) && NIL != module0256.f16596(module0202.f12834(var10, (SubLObject)UNPROVIDED), module0202.f12835(var10, (SubLObject)UNPROVIDED), var2, (SubLObject)UNPROVIDED));
            }
        }
        return var259;
    }
    ...
    public static SubLObject f21042(final SubLObject var144) {
        ...
        try {
            module0144.$g1795$.bind((SubLObject)T, var145);
            if (NIL != module0178.f11284(var144)) {
                f21041(module0178.f11328(var144), module0178.f11287(var144), (SubLObject)UNPROVIDED);
            }
            else {
    ...
    public static SubLObject f21044(final SubLObject var44, SubLObject var2) {
        ...
        try {
            module0144.$g1795$.bind((SubLObject)T, var45);
            f21043(var44, var2);
        }
        finally {
    ...
    public static SubLObject f21043(final SubLObject var44, final SubLObject var2) {
        ...
        var46 = var45.first();
        while (NIL != var45) {
            f21041(var46, var2, (SubLObject)UNPROVIDED);
            var45 = var45.rest();
            var46 = var45.first();
        }
    ...
    public static SubLObject f21045(final SubLObject var10, SubLObject var2) {
        ...
        try {
            module0144.$g1795$.bind((SubLObject)T, var11);
            f21041(var10, var2, (SubLObject)UNPROVIDED);
        }
        finally {
    ...
    public static SubLObject f21046(final SubLObject var265, final SubLObject var266) {
        f21047(var265, var266, (SubLObject)ZERO_INTEGER);
        return (SubLObject)NIL;
    }
    
    public static SubLObject f21048(final SubLObject var265) {
        return (SubLObject)((var265.getClass() == $sX23552_native.class) ? T : NIL);
    }
    
    public static SubLObject f21049(final SubLObject var265) {
        assert NIL != f21048(var265) : var265;
    ...
    public static SubLObject f21061(SubLObject var268) {
        ...
        SubLObject var272;
        SubLObject var273;
        for (var270 = (SubLObject)NIL, var270 = var268; NIL != var270; var270 = conses_high.cddr(var270)) {
            var271 = var270.first();
            var272 = conses_high.cadr(var270);
            var273 = var271;
            if (var273.eql((SubLObject)$ic119$)) {
                f21055(var269, var272);
            }
            else if (var273.eql((SubLObject)$ic120$)) {
                f21056(var269, var272);
            }
            else if (var273.eql((SubLObject)$ic121$)) {
                f21057(var269, var272);
            }
            else if (var273.eql((SubLObject)$ic122$)) {
                f21058(var269, var272);
            }
            else if (var273.eql((SubLObject)$ic123$)) {
                f21059(var269, var272);
            }
            else if (var273.eql((SubLObject)$ic124$)) {
                f21060(var269, var272);
            }
            else {
                Errors.error((SubLObject)$ic125$, var271);
            }
        }
        return var269;
    }
    ...
    public static SubLObject f21062(final SubLObject var273, final SubLObject var274) {
        Functions.funcall(var274, var273, (SubLObject)$ic126$, (SubLObject)$ic127$, (SubLObject)SIX_INTEGER);
        Functions.funcall(var274, var273, (SubLObject)$ic128$, (SubLObject)$ic119$, f21049(var273));
        Functions.funcall(var274, var273, (SubLObject)$ic128$, (SubLObject)$ic120$, f21050(var273));
        Functions.funcall(var274, var273, (SubLObject)$ic128$, (SubLObject)$ic121$, f21051(var273));
        Functions.funcall(var274, var273, (SubLObject)$ic128$, (SubLObject)$ic122$, f21052(var273));
        Functions.funcall(var274, var273, (SubLObject)$ic128$, (SubLObject)$ic123$, f21053(var273));
        Functions.funcall(var274, var273, (SubLObject)$ic128$, (SubLObject)$ic124$, f21054(var273));
        Functions.funcall(var274, var273, (SubLObject)$ic129$, (SubLObject)$ic127$, (SubLObject)SIX_INTEGER);
        return var273;
    }
    ...
    public static SubLObject f21047(final SubLObject var46, final SubLObject var266, final SubLObject var275) {
        ...
        if (NIL != $g2796$.getDynamicValue(var276)) {
            final SubLObject var279 = f21066(var46);
            final SubLObject var280 = f21067(var46);
            final SubLObject var281 = f21068(var46);
            PrintLow.format(var266, (SubLObject)$ic131$, new SubLObject[] { var281, var277, var278, var279, var280 });
        }
        else {
            PrintLow.format(var266, (SubLObject)$ic132$, var277, var278);
        }
        return (SubLObject)NIL;
    }
    
    public static SubLObject f21064(final SubLObject var280) {
        assert NIL != f21048(var280) : var280;
    ...
    public static SubLObject f21069(final SubLObject var280) {
        return (SubLObject)makeBoolean(NIL == f21053(var280));
    }
    ...
    public static SubLObject f21072(final SubLObject var280) {
        return (SubLObject)makeBoolean(NIL == f21054(var280));
    }
    
    public static SubLObject f21073(final SubLObject var280) {
        return (SubLObject)makeBoolean(NIL != f21070(var280) && NIL != f21071(var280));
    }
    
    public static SubLObject f21068(final SubLObject var280) {
        if (NIL != f21073(var280)) {
            return (SubLObject)$ic133$;
        }
        if (NIL != f21070(var280)) {
            return (SubLObject)$ic134$;
        }
        if (NIL != f21071(var280)) {
    ...
    public static SubLObject f21074(final SubLObject var276, final SubLObject var2, final SubLObject var277, final SubLObject var278, SubLObject var281, SubLObject var282) {
        if (var281 == UNPROVIDED) {
            var281 = (SubLObject)$ic137$;
        }
        if (var282 == UNPROVIDED) {
            var282 = (SubLObject)$ic137$;
        }
        final SubLObject var283 = f21061((SubLObject)UNPROVIDED);
    ...
    public static SubLObject f21075(final SubLObject var276, final SubLObject var281) {
        ...
        if (NIL != Types.booleanp(var281)) {
            ...
            try {
                module0147.$g2094$.bind((SubLObject)$ic11$, var282);
                module0147.$g2095$.bind($ic12$, var282);
                var283 = module0202.f12691(var276, (SubLObject)UNPROVIDED);
            }
            finally {
    ...
    public static SubLObject f21076(final SubLObject var276, final SubLObject var282) {
        SubLObject var283 = (SubLObject)NIL;
        if (NIL != Types.booleanp(var282)) {
            var283 = var282;
        }
        else {
            var283 = (SubLObject)makeBoolean(NIL == module0202.f12635(var276));
        }
        return var283;
    }
    
    public static SubLObject f21077(final SubLObject var286, final SubLObject var287, final SubLObject var2) {
        return f21074((SubLObject)ConsesLow.list($ic52$, var286, var287), var2, (SubLObject)$ic138$, (SubLObject)ConsesLow.list(var286, var287), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f21078(final SubLObject var288, final SubLObject var289, final SubLObject var2) {
        return f21074((SubLObject)ConsesLow.list($ic36$, var288, var289), var2, (SubLObject)$ic139$, (SubLObject)ConsesLow.list(var288, var289), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    
    public static SubLObject f21079() {
        final SubLObject var32 = $g2797$.getGlobalValue();
        if (NIL != var32) {
            module0034.f1818(var32);
        }
        return (SubLObject)NIL;
    ...
    public static SubLObject f21080() {
        return module0034.f1829($g2797$.getGlobalValue(), (SubLObject)ConsesLow.list(EMPTY_SUBL_OBJECT_ARRAY), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject f21081() {
        ...
        try {
            module0147.$g2094$.bind((SubLObject)$ic11$, var3);
            module0147.$g2095$.bind($ic12$, var3);
            final SubLObject var7 = (SubLObject)$ic141$;
            final SubLObject var8 = module0259.f16848($ic142$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            final SubLObject var9 = Sequences.delete_if((SubLObject)$ic143$, var8, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            final SubLObject var10 = conses_high.set_difference(var9, var7, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            final SubLObject var11 = module0259.f16848($ic144$, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            final SubLObject var12 = Sequences.delete_if((SubLObject)$ic143$, var11, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
            final SubLObject var13 = conses_high.set_difference(var12, ConsesLow.append(var7, var10), (SubLObject)UNPROVIDED, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f21082() {
        SubLObject var225 = $g2797$.getGlobalValue();
        if (NIL == var225) {
            var225 = module0034.f1934((SubLObject)$ic140$, (SubLObject)$ic145$, (SubLObject)NIL, (SubLObject)EQ, (SubLObject)ZERO_INTEGER, (SubLObject)ONE_INTEGER);
        }
        SubLObject var226 = module0034.f1810(var225, (SubLObject)UNPROVIDED);
        if (var226 == $ic7$) {
            var226 = Values.arg2(Values.resetMultipleValues(), (SubLObject)Values.multiple_value_list(f21081()));
            module0034.f1812(var225, var226, (SubLObject)UNPROVIDED);
        }
        return module0034.f1959(var226);
    }
    ...
    public static SubLObject f21083(final SubLObject var1) {
        ...
        while (NIL != var5) {
            ...
            if (NIL != module0158.f10010(var2, (SubLObject)ONE_INTEGER, var7)) {
                final SubLObject var8 = module0158.f10011(var2, (SubLObject)ONE_INTEGER, var7);
                SubLObject var9 = (SubLObject)NIL;
                final SubLObject var10 = (SubLObject)NIL;
                while (NIL == var9) {
                    final SubLObject var11 = module0052.f3695(var8, var10);
                    final SubLObject var12 = (SubLObject)makeBoolean(!var10.eql(var11));
                    if (NIL != var12) {
                        SubLObject var13 = (SubLObject)NIL;
                        try {
                            var13 = module0158.f10316(var11, (SubLObject)$ic76$, (SubLObject)$ic54$, (SubLObject)NIL);
                            SubLObject var188_302 = (SubLObject)NIL;
                            final SubLObject var189_303 = (SubLObject)NIL;
                            while (NIL == var188_302) {
                                final SubLObject var14 = module0052.f3695(var13, var189_303);
                                final SubLObject var191_305 = (SubLObject)makeBoolean(!var189_303.eql(var14));
                                if (NIL != var191_305) {
                                ...
                                var188_302 = (SubLObject)makeBoolean(NIL == var191_305);
                            }
                        }
                        finally {
                    ...
                    var9 = (SubLObject)makeBoolean(NIL == var12);
                }
            }
            var5 = var5.rest();
            var6 = var5.first();
    ...
    public static SubLObject f21086(final SubLObject var1) {
        ...
        SubLObject var4;
        final SubLObject var3 = var4 = module0205.f13207(var1, (SubLObject)$ic146$);
    ...
    public static SubLObject f21087(final SubLObject var280) {
        ...
        assert NIL != Types.function_spec_p(var281) : var281;
        assert NIL != Types.listp(var282) : var282;
    ...
    public static SubLObject f21084(final SubLObject var1) {
        ...
        final SubLObject var4 = f21077(var3, $ic149$, module0132.$g1561$.getGlobalValue());
        var2 = (SubLObject)ConsesLow.cons(var4, var2);
        SubLObject var6;
        final SubLObject var5 = var6 = module0205.f13207(var1, (SubLObject)$ic146$);
        SubLObject var7 = (SubLObject)NIL;
        var7 = var6.first();
        while (NIL != var6) {
            if (NIL == module0201.f12580(var7)) {
                final SubLObject var8 = f21077(var7, $ic32$, module0132.$g1560$.getGlobalValue());
    ...
    public static SubLObject f21085(final SubLObject var304, final SubLObject var1) {
        ...
        if (var307.eql($ic150$)) {
            ...
            final SubLObject var310 = module0205.f13134(var1, var308, (SubLObject)UNPROVIDED);
    ...
    public static SubLObject f21089() {
        $g2792$ = SubLFiles.defparameter("S#23694", (SubLObject)NIL);
        $g2793$ = SubLFiles.deflexical("S#23695", (SubLObject)NIL);
        $g2794$ = SubLFiles.deflexical("S#23696", (SubLObject)NIL);
        $g2795$ = SubLFiles.defconstant("S#23697", (SubLObject)$ic98$);
        $g2796$ = SubLFiles.defparameter("S#23698", (SubLObject)NIL);
        $g2797$ = SubLFiles.deflexical("S#23699", (SubLObject)NIL);
        return (SubLObject)NIL;
    }
    ...
    public static SubLObject f21090() {
        ...
        module0034.f1909((SubLObject)$ic80$);
        module0034.f1895((SubLObject)$ic83$);
        Structures.register_method(print_high.$print_object_method_table$.getGlobalValue(), $g2795$.getGlobalValue(), Symbols.symbol_function((SubLObject)$ic105$));
        ...
        Structures.register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $g2795$.getGlobalValue(), Symbols.symbol_function((SubLObject)$ic130$));
    ...
    static {
        ...
        $g2796$ = null;
        $g2797$ = null;
        $ic0$ = constant_handles_oc.f8479((SubLObject)makeString("forAll"));
        $ic1$ = constant_handles_oc.f8479((SubLObject)makeString("thereExists"));
        $ic2$ = makeKeyword("INHIBITED-SEQUENCE-VARIABLE");
        $ic3$ = makeSymbol("S#23562", "CYC");
        $ic4$ = makeSymbol("S#23695", "CYC");
        $ic5$ = makeInteger(1024);
        $ic6$ = makeSymbol("S#23548", "CYC");
        $ic7$ = makeKeyword("&MEMOIZED-ITEM-NOT-FOUND&");
        $ic8$ = constant_handles_oc.f8479((SubLObject)makeString("not"));
        $ic9$ = constant_handles_oc.f8479((SubLObject)makeString("ist"));
        ...
        $ic14$ = makeKeyword("WEAK-FORT");
        $ic15$ = makeKeyword("NOT-ISA-DISJOINT");
        $ic16$ = makeKeyword("NOT-QUOTED-ISA-DISJOINT");
        $ic17$ = makeKeyword("NOT-ISA");
        $ic18$ = makeKeyword("NOT-GENLS-DISJOINT");
        $ic19$ = makeKeyword("GENLS");
        $ic20$ = makeKeyword("NOT-GENLS");
        $ic21$ = makeKeyword("GENL-ISA");
        $ic22$ = makeKeyword("ISA-GENL");
        $ic23$ = makeKeyword("DIFFERENT");
        $ic24$ = makeKeyword("FORMAT");
        $ic25$ = makeSymbol("S#12761", "CYC");
        $ic26$ = makeKeyword("NAUT");
        $ic27$ = makeSymbol("S#22774", "CYC");
        $ic28$ = makeKeyword("ISA");
        $ic29$ = makeKeyword("QUOTED-ISA");
        $ic30$ = constant_handles_oc.f8479((SubLObject)makeString("Collection"));
        $ic31$ = constant_handles_oc.f8479((SubLObject)makeString("CollectionDenotingFunction"));
        $ic32$ = constant_handles_oc.f8479((SubLObject)makeString("Thing"));
        $ic33$ = makeKeyword("OPAQUE");
        $ic34$ = makeKeyword("STRONG-FORT");
        $ic35$ = makeSymbol("INTEGERP");
        $ic36$ = constant_handles_oc.f8479((SubLObject)makeString("genls"));
        $ic37$ = constant_handles_oc.f8479((SubLObject)makeString("Quote"));
        $ic38$ = ConsesLow.list((SubLObject)makeKeyword("ISA"), (SubLObject)makeKeyword("NOT-ISA-DISJOINT"));
        $ic39$ = ConsesLow.list((SubLObject)makeKeyword("GENLS"), (SubLObject)makeKeyword("NOT-GENLS-DISJOINT"));
        $ic40$ = makeString("invalid at test ~s in mal-intra-arg?");
        $ic41$ = makeString("invalid at test ~s in mal-inter-arg?");
        $ic42$ = makeSymbol("S#23594", "CYC");
        $ic43$ = makeString("~%at test fails: ~s in ~s fails #$definingMt constraint: ~s");
        $ic44$ = makeKeyword("DEFINING-MT-VIOLATION");
        $ic45$ = makeKeyword("ASYMMETRIC-PREDICATE");
        $ic46$ = makeKeyword("ANTI-SYMMETRIC-PREDICATE");
        $ic47$ = makeKeyword("IRREFLEXIVE-PREDICATE");
        $ic48$ = makeKeyword("ANTI-TRANSITIVE-PREDICATE");
        $ic49$ = makeKeyword("NEGATION-PREDS");
        $ic50$ = makeKeyword("NEGATION-INVERSES");
        $ic51$ = makeString("unknown predicate constraint: ~s");
        $ic52$ = constant_handles_oc.f8479((SubLObject)makeString("isa"));
        $ic53$ = constant_handles_oc.f8479((SubLObject)makeString("AsymmetricBinaryPredicate"));
        $ic54$ = makeKeyword("TRUE");
        $ic55$ = ConsesLow.list((SubLObject)makeKeyword("PREDICATE-EXTENT"), (SubLObject)makeKeyword("GAF-ARG"));
        $ic56$ = makeKeyword("AT-MAPPING-DONE");
        $ic57$ = makeKeyword("PREDICATE-EXTENT");
        $ic58$ = makeSymbol("S#23601", "CYC");
        $ic59$ = makeKeyword("GAF-ARG");
        $ic60$ = makeString("Ignore it");
        $ic61$ = makeString("Unexpected index type when gathering asymmetric violations");
        $ic62$ = constant_handles_oc.f8479((SubLObject)makeString("AntiSymmetricBinaryPredicate"));
        $ic63$ = constant_handles_oc.f8479((SubLObject)makeString("IrreflexiveBinaryPredicate"));
        $ic64$ = makeKeyword("COMPLETES-CYCLE?");
        $ic65$ = makeKeyword("WHY-COMPLETES-CYCLE?");
        $ic66$ = constant_handles_oc.f8479((SubLObject)makeString("TransitiveBinaryPredicate"));
        $ic67$ = constant_handles_oc.f8479((SubLObject)makeString("AntiTransitiveBinaryPredicate"));
        $ic68$ = makeSymbol("S#23612", "CYC");
        $ic69$ = ConsesLow.list((SubLObject)makeSymbol("S#1821", "CYC"), (SubLObject)makeSymbol("S#1832", "CYC"), (SubLObject)makeSymbol("S#1820", "CYC"));
        $ic70$ = makeSymbol("S#23608", "CYC");
        $ic71$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ONE_INTEGER, (SubLObject)TWO_INTEGER, (SubLObject)ONE_INTEGER), (SubLObject)ConsesLow.list((SubLObject)TWO_INTEGER, (SubLObject)ONE_INTEGER, (SubLObject)TWO_INTEGER), (SubLObject)ConsesLow.list((SubLObject)ONE_INTEGER, (SubLObject)ONE_INTEGER, (SubLObject)TWO_INTEGER));
        $ic72$ = ConsesLow.list((SubLObject)ConsesLow.list((SubLObject)ONE_INTEGER, (SubLObject)TWO_INTEGER, (SubLObject)ONE_INTEGER), (SubLObject)ConsesLow.list((SubLObject)TWO_INTEGER, (SubLObject)ONE_INTEGER, (SubLObject)TWO_INTEGER), (SubLObject)ConsesLow.list((SubLObject)TWO_INTEGER, (SubLObject)TWO_INTEGER, (SubLObject)ONE_INTEGER));
        $ic73$ = makeSymbol("S#23611", "CYC");
        $ic74$ = makeSymbol("S#15529", "CYC");
        $ic75$ = makeSymbol("S#12347", "CYC");
        $ic76$ = makeKeyword("GAF");
        $ic77$ = makeKeyword("OVERLAP");
        $ic78$ = constant_handles_oc.f8479((SubLObject)makeString("negationPreds"));
        $ic79$ = constant_handles_oc.f8479((SubLObject)makeString("negationInverse"));
        $ic80$ = makeSymbol("S#23622", "CYC");
        $ic81$ = makeSymbol("S#23696", "CYC");
        $ic82$ = makeInteger(128);
        $ic83$ = makeSymbol("S#22679", "CYC");
        $ic84$ = constant_handles_oc.f8479((SubLObject)makeString("SingleEntry"));
        $ic85$ = constant_handles_oc.f8479((SubLObject)makeString("IntervalEntry"));
        $ic86$ = constant_handles_oc.f8479((SubLObject)makeString("SetTheFormat"));
        $ic87$ = constant_handles_oc.f8479((SubLObject)makeString("singleEntryFormatInArgs"));
        $ic88$ = constant_handles_oc.f8479((SubLObject)makeString("intervalEntryFormatInArgs"));
        $ic89$ = constant_handles_oc.f8479((SubLObject)makeString("openEntryFormatInArgs"));
        $ic90$ = constant_handles_oc.f8479((SubLObject)makeString("temporallyIntersectingEntryFormatInArgs"));
        $ic91$ = constant_handles_oc.f8479((SubLObject)makeString("spatiallyIntersectingEntryFormatInArgs"));
        $ic92$ = constant_handles_oc.f8479((SubLObject)makeString("spatioTemporallyIntersectingEntryFormatInArgs"));
        $ic93$ = makeString("unknown entry format: ~s");
        $ic94$ = constant_handles_oc.f8479((SubLObject)makeString("natFunction"));
        $ic95$ = constant_handles_oc.f8479((SubLObject)makeString("natArgument"));
        $ic96$ = makeSymbol("VARIABLE-P");
        $ic97$ = ConsesLow.list((SubLObject)makeSymbol("NEG-LITS"), (SubLObject)makeSymbol("POS-LITS"));
        $ic98$ = makeSymbol("S#23552", "CYC");
        $ic99$ = makeSymbol("S#23553", "CYC");
        $ic100$ = ConsesLow.list((SubLObject)makeSymbol("S#14349", "CYC"), (SubLObject)makeSymbol("S#11445", "CYC"), (SubLObject)makeSymbol("S#2960", "CYC"), (SubLObject)makeSymbol("S#23700", "CYC"), (SubLObject)makeSymbol("S#15615", "CYC"), (SubLObject)makeSymbol("S#23701", "CYC"));
        $ic101$ = ConsesLow.list((SubLObject)makeKeyword("SENTENCE"), (SubLObject)makeKeyword("MT"), (SubLObject)makeKeyword("TEST-FUNCTION"), (SubLObject)makeKeyword("TEST-ARGS"), (SubLObject)makeKeyword("CLOSED?"), (SubLObject)makeKeyword("ATOMIC?"));
        $ic102$ = ConsesLow.list((SubLObject)makeSymbol("S#23656", "CYC"), (SubLObject)makeSymbol("S#23657", "CYC"), (SubLObject)makeSymbol("S#23658", "CYC"), (SubLObject)makeSymbol("S#23659", "CYC"), (SubLObject)makeSymbol("S#23660", "CYC"), (SubLObject)makeSymbol("S#23661", "CYC"));
        $ic103$ = ConsesLow.list((SubLObject)makeSymbol("S#23662", "CYC"), (SubLObject)makeSymbol("S#23663", "CYC"), (SubLObject)makeSymbol("S#23664", "CYC"), (SubLObject)makeSymbol("S#23665", "CYC"), (SubLObject)makeSymbol("S#23666", "CYC"), (SubLObject)makeSymbol("S#23667", "CYC"));
        $ic104$ = makeSymbol("S#23671", "CYC");
        $ic105$ = makeSymbol("S#23655", "CYC");
        $ic106$ = ConsesLow.list((SubLObject)makeSymbol("OPTIMIZE-FUNCALL"), (SubLObject)makeSymbol("S#23553", "CYC"));
        $ic107$ = makeSymbol("S#23656", "CYC");
        $ic108$ = makeSymbol("S#23662", "CYC");
        $ic109$ = makeSymbol("S#23657", "CYC");
        $ic110$ = makeSymbol("S#23663", "CYC");
        $ic111$ = makeSymbol("S#23658", "CYC");
        $ic112$ = makeSymbol("S#23664", "CYC");
        $ic113$ = makeSymbol("S#23659", "CYC");
        $ic114$ = makeSymbol("S#23665", "CYC");
        $ic115$ = makeSymbol("S#23660", "CYC");
        $ic116$ = makeSymbol("S#23666", "CYC");
        $ic117$ = makeSymbol("S#23661", "CYC");
        $ic118$ = makeSymbol("S#23667", "CYC");
        $ic119$ = makeKeyword("SENTENCE");
        $ic120$ = makeKeyword("MT");
        $ic121$ = makeKeyword("TEST-FUNCTION");
        $ic122$ = makeKeyword("TEST-ARGS");
        $ic123$ = makeKeyword("CLOSED?");
        $ic124$ = makeKeyword("ATOMIC?");
        $ic125$ = makeString("Invalid slot ~S for construction function");
        $ic126$ = makeKeyword("BEGIN");
        $ic127$ = makeSymbol("S#23668", "CYC");
        $ic128$ = makeKeyword("SLOT");
        $ic129$ = makeKeyword("END");
        $ic130$ = makeSymbol("S#23670", "CYC");
        $ic131$ = makeString("<~a ARG-CONSTRAINT:~a:~a:~a:~a>");
        $ic132$ = makeString("<ARG-CONSTRAINT:~a:~a>");
        $ic133$ = makeString("GAF");
        $ic134$ = makeString("GNAF");
        $ic135$ = makeString("OAF");
        $ic136$ = makeString("ONAF");
        $ic137$ = makeKeyword("UNKNOWN");
        $ic138$ = makeSymbol("ISA?");
        $ic139$ = makeSymbol("GENLS?");
        $ic140$ = makeSymbol("S#23690", "CYC");
        $ic141$ = ConsesLow.list(constant_handles_oc.f8479((SubLObject)makeString("argIsa")), constant_handles_oc.f8479((SubLObject)makeString("argGenl")));
        $ic142$ = constant_handles_oc.f8479((SubLObject)makeString("ArgTypePredicate"));
        $ic143$ = makeSymbol("S#17176", "CYC");
        $ic144$ = constant_handles_oc.f8479((SubLObject)makeString("ArgConstraintPredicate"));
        $ic145$ = makeSymbol("S#23699", "CYC");
        $ic146$ = makeKeyword("IGNORE");
        $ic147$ = makeSymbol("FUNCTION-SPEC-P");
        $ic148$ = makeSymbol("LISTP");
        $ic149$ = constant_handles_oc.f8479((SubLObject)makeString("Relation"));
        $ic150$ = constant_handles_oc.f8479((SubLObject)makeString("argIsa"));
        $ic151$ = constant_handles_oc.f8479((SubLObject)makeString("argGenl"));
    }
    ...
    public static final class $sX23552_native extends SubLStructNative
    {
        ...
        static {
            structDecl = Structures.makeStructDeclNative((Class)$sX23552_native.class, $ic98$, $ic99$, $ic100$, $ic101$, new String[] { "$sentence", "$mt", "$test_function", "$test_args", "$closedP", "$atomicP" }, $ic102$, $ic103$, $ic104$);
        }
    }
