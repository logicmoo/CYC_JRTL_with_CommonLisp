...
public final class module0154 extends SubLTranslatedFile
{
    ...
    public static SubLObject f9767(final SubLObject var1, final SubLObject var2) {
        ...
        var4 = var4.rest();
        if (NIL == var4) {
            return (SubLObject)ConsesLow.list((SubLObject)$ic1$, (SubLObject)$ic2$, (SubLObject)ConsesLow.list((SubLObject)$ic3$, var5));
        }
    ...
    static {
        ...
        $ic0$ = ConsesLow.list((SubLObject)makeSymbol("S#151", "CYC"));
        $ic1$ = makeSymbol("PWHEN");
        $ic2$ = makeSymbol("S#10711", "CYC");
        $ic3$ = makeSymbol("S#10685", "CYC");
    }
}
