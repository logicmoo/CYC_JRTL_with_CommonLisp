...
public class LHS implements ParserConstants, Serializable
{
   ...
   */
  static final int VARIABLE = 0, FIELD = 1, PROPERTY = 2, INDEX = 3, METHOD_EVAL = 4, LOOSETYPE_FIELD = 5, MAP_ENTRY = 6;
  int type;
  String varName;
  Object propName;
  Invocable field;
   ...
   */
  public LHS( Object object, Invocable field )
  {
    if( object == null )
   ...
   */
  public LHS( Object object, Object propName )
  {
    if( object == null )
      throw new NullPointerException( "constructed empty LHS" );
    type = PROPERTY;
  ...
  /**
   * Map Entry type LHS Constructor. The provided key is returned along with its
   * value as a Map.Entry entity during assignment.
   */
  public LHS( Object key )
  {
    type = MAP_ENTRY;
    this.object = key;
  }
  ...
  public Object assign(Object val, boolean strictJava) throws UtilEvalError
  {
    if( type == VARIABLE )
    {
      ...
      {
        throw new UtilEvalError( "LHS (" + field.getName() + ") not a static field.", e );
      }
      catch( ReflectiveOperationException e2 )
      {
        throw new UtilEvalError( "LHS (" + field.getName() + ") can't access field: " + e2, e2 );
      }
      catch( IllegalArgumentException e3 )
      {
        String type = val == null ? "null" : Types.getType( val ).getSimpleName();
        throw new UtilEvalError( "Argument type mismatch. " + type + " not assignable to field " + field.getName(), e3 );
      }
