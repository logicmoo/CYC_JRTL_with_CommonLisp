...
import org.opencyc.util.Hierarchy.Walker.Mode;

/**
 * A class for representing, generating and accessing hierarchies.
 *
 * @param <T> the type of object constituting the hierarchy.
 *
 * @author baxter
 */
public class Hierarchy<T> {
  ...
  public void printIndented(PrintStream stream) {
    ...
    for (final SortedWalker walker = new SortedWalker(this,
      ...
      final Node<Paraphrase<CycDenotationalTerm>> node = walker.next();
