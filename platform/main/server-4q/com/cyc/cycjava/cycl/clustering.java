...
public final class clustering extends SubLTranslatedFile {
    ...
    public static SubLObject cluster_p(final SubLObject v_object) {
        return v_object.getClass() == clustering.$cluster_native.class ? T : NIL;
    }

    public static SubLObject cluster_elements(final SubLObject v_object) {
        assert NIL != cluster_p(v_object) : "clustering.cluster_p(v_object) " + "CommonSymbols.NIL != clustering.cluster_p(v_object) " + v_object;
    ...
    public static SubLObject make_cluster(SubLObject arglist) {
        ...
        final SubLObject v_new = new clustering.$cluster_native();
        SubLObject next;
    ...
    public static final class $cluster_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(clustering.$cluster_native.class, CLUSTER, CLUSTER_P, $list3, $list4, new String[]{ "$elements", "$subclusters" }, $list5, $list6, PRINT_CLUSTER);
        }
    }
