...
import com.cyc.cycjava.cycl.heap;
...
import static com.cyc.cycjava.cycl.heap.*;
...
public final class heap extends SubLTranslatedFile {
    ...
    public static SubLObject heap_impl_p(final SubLObject v_object) {
        return v_object.getClass() == heap.$heap_impl_native.class ? T : NIL;
    }

    public static SubLObject heap_impl_next(final SubLObject v_object) {
        assert NIL != heap_impl_p(v_object) : "heap.heap_impl_p(v_object) " + "CommonSymbols.NIL != heap.heap_impl_p(v_object) " + v_object;
    ...
    public static SubLObject make_heap_impl(SubLObject arglist) {
        ...
        final SubLObject v_new = new heap.$heap_impl_native();
        SubLObject next;
    ...
    public static SubLObject heap_test_example_p(final SubLObject v_object) {
        return v_object.getClass() == heap.$heap_test_example_native.class ? T : NIL;
    }

    public static SubLObject heap_test_example_priority(final SubLObject v_object) {
        assert NIL != heap_test_example_p(v_object) : "heap.heap_test_example_p(v_object) " + "CommonSymbols.NIL != heap.heap_test_example_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_heap_test_example(SubLObject arglist) {
        ...
        final SubLObject v_new = new heap.$heap_test_example_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $heap_impl_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(heap.$heap_impl_native.class, HEAP_IMPL, HEAP_IMPL_P, $list2, $list3, new String[]{ "$next", "$nodes", "$predicate", "$key" }, $list4, $list5, PRINT_HEAP_IMPL);
        }
    }
    ...
    public static final class $heap_test_example_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(heap.$heap_test_example_native.class, HEAP_TEST_EXAMPLE, HEAP_TEST_EXAMPLE_P, $list73, $list74, new String[]{ "$priority", "$value" }, $list75, $list76, PRINT_HEAP_TEST_EXAMPLE);
        }
    }
