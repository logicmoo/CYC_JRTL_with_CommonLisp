...
import com.cyc.cycjava.cycl.ghl_graph_utilities;
import com.cyc.tool.subl.jrtl.nativeCode.type.core.SubLObject;
import com.cyc.tool.subl.jrtl.nativeCode.type.core.SubLString;
import com.cyc.tool.subl.util.SubLFile;
import com.cyc.tool.subl.util.SubLTranslatedFile;

import static com.cyc.cycjava.cycl.ghl_graph_utilities.*;
...
public final class ghl_graph_utilities extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLString $str0$Invalid_ghl_edge__a = makeString("Invalid ghl-edge ~a");
    ...
    public static SubLObject declare_ghl_graph_utilities_file() {
        declareFunction(me, "ghl_node_p", "GHL-NODE-P", 1, 0, false);
        declareFunction(me, "ghl_edge_p", "GHL-EDGE-P", 1, 0, false);
        declareFunction(me, "ghl_directed_edge_p", "GHL-DIRECTED-EDGE-P", 1, 0, false);
        declareFunction(me, "ghl_edge_label", "GHL-EDGE-LABEL", 1, 0, false);
        declareFunction(me, "hl_support_literal_predicate", "HL-SUPPORT-LITERAL-PREDICATE", 1, 0, false);
        declareFunction(me, "ghl_edge_start_node", "GHL-EDGE-START-NODE", 1, 0, false);
        declareFunction(me, "ghl_edge_end_node", "GHL-EDGE-END-NODE", 1, 0, false);
        declareFunction(me, "ghl_edge_mt", "GHL-EDGE-MT", 1, 0, false);
        return NIL;
    }
