...
public final class rkf_assisted_reader extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLString $$$Assisted_Reader_lock = makeString("Assisted Reader lock");



    public static final SubLList $list2 = list(makeSymbol("*AR-LOCK*"));

    public static final SubLSymbol AR_SENTENCE = makeSymbol("AR-SENTENCE");

    public static final SubLSymbol AR_SENTENCE_P = makeSymbol("AR-SENTENCE-P");

    public static final SubLList $list5 = list(makeSymbol("ID"), makeSymbol("PLAINTEXT"), makeSymbol("TOKEN-VECTOR"), makeSymbol("CLARIFICATIONS"), makeSymbol("SOURCE-SENTENCE"), makeSymbol("PHRASES"));

    public static final SubLList $list6 = list(makeKeyword("ID"), makeKeyword("PLAINTEXT"), makeKeyword("TOKEN-VECTOR"), makeKeyword("CLARIFICATIONS"), makeKeyword("SOURCE-SENTENCE"), makeKeyword("PHRASES"));

    public static final SubLList $list7 = list(makeSymbol("AR-SENTENCE-ID"), makeSymbol("AR-SENTENCE-PLAINTEXT"), makeSymbol("AR-SENTENCE-TOKEN-VECTOR"), makeSymbol("AR-SENTENCE-CLARIFICATIONS"), makeSymbol("AR-SENTENCE-SOURCE-SENTENCE"), makeSymbol("AR-SENTENCE-PHRASES"));

    public static final SubLList $list8 = list(makeSymbol("_CSETF-AR-SENTENCE-ID"), makeSymbol("_CSETF-AR-SENTENCE-PLAINTEXT"), makeSymbol("_CSETF-AR-SENTENCE-TOKEN-VECTOR"), makeSymbol("_CSETF-AR-SENTENCE-CLARIFICATIONS"), makeSymbol("_CSETF-AR-SENTENCE-SOURCE-SENTENCE"), makeSymbol("_CSETF-AR-SENTENCE-PHRASES"));



    public static final SubLSymbol AR_SENTENCE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("AR-SENTENCE-PRINT-FUNCTION-TRAMPOLINE");
    ...
    private static final SubLList $list42 = list(makeKeyword("ID"), makeKeyword("TEXT"), makeKeyword("SENTENCE"), makeKeyword("NUMBER"), makeKeyword("PHRASES"));
    ...
    private static final SubLList $list116 = list(new SubLObject[]{ makeKeyword("ID"), makeKeyword("CYCL"), makeKeyword("DISAMBIGUATION-TEXT"), makeKeyword("PHRASES"), makeKeyword("PARTS"), makeKeyword("AGGLOMERATIONS"), makeKeyword("FORCE"), makeKeyword("CONFIDENCE"), makeKeyword("OPEN-TERM-SCORE") });
    ...
    private static final SubLList $list281 = list(list(makeSymbol("RKF-QUESTION-READER"), reader_make_constant_shell(makeString("QuestionTemplate"))), list(makeSymbol("RKF-SENTENCE-READER"), reader_make_constant_shell(makeString("STemplate"))));
    ...
    private static final SubLList $list304 = list(reader_make_constant_shell(makeString("VariableFn")), reader_make_constant_shell(makeString("TheVPParse")), reader_make_constant_shell(makeString("SomeFn")), reader_make_constant_shell(makeString("TheActiveSubject")), reader_make_constant_shell(makeString("TheResultOfParsing")));
    ...
    private static final SubLList $list313 = list(reader_make_constant_shell(makeString("TheResultOfParsing")), reader_make_constant_shell(makeString("TheCoordinationSet")), reader_make_constant_shell(makeString("RewriteSequenceFn")), reader_make_constant_shell(makeString("TheSpec")), reader_make_constant_shell(makeString("TheInstance")), reader_make_constant_shell(makeString("The")));
    ...
    private static final SubLList $list316 = list(reader_make_constant_shell(makeString("TheSpec")), reader_make_constant_shell(makeString("TheInstance")));

    private static final SubLSymbol RKF_AR_CONTEXT_REFERENCE_P = makeSymbol("RKF-AR-CONTEXT-REFERENCE-P");

    private static final SubLObject $$TheSpec = reader_make_constant_shell(makeString("TheSpec"));
    ...
    public static SubLObject ar_sentence_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_assisted_reader.$ar_sentence_native.class ? T : NIL;
    }

    public static SubLObject ar_sentence_id(final SubLObject v_object) {
        assert NIL != ar_sentence_p(v_object) : "rkf_assisted_reader.ar_sentence_p(v_object) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_sentence_p(v_object) " + v_object;
    ...
    public static SubLObject make_ar_sentence(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_assisted_reader.$ar_sentence_native();
        SubLObject next;
    ...
    public static SubLObject note_ar_sentence_token_vector(final SubLObject sentence, final SubLObject token_vector) {
        assert NIL != ar_sentence_p(sentence) : "rkf_assisted_reader.ar_sentence_p(sentence) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_sentence_p(sentence) " + sentence;
        assert NIL != vectorp(token_vector) : "Types.vectorp(token_vector) " + "CommonSymbols.NIL != Types.vectorp(token_vector) " + token_vector;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject add_ar_sentence_phrase(final SubLObject sentence, final SubLObject phrase) {
        assert NIL != ar_sentence_p(sentence) : "rkf_assisted_reader.ar_sentence_p(sentence) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_sentence_p(sentence) " + sentence;
        assert NIL != ar_phrase_p(phrase) : "rkf_assisted_reader.ar_phrase_p(phrase) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_phrase_p(phrase) " + phrase;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject add_ar_sentence_clarification(final SubLObject sentence, final SubLObject clarification) {
        assert NIL != ar_sentence_p(sentence) : "rkf_assisted_reader.ar_sentence_p(sentence) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_sentence_p(sentence) " + sentence;
        assert NIL != ar_sentence_p(clarification) : "rkf_assisted_reader.ar_sentence_p(clarification) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_sentence_p(clarification) " + clarification;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject ar_token_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_assisted_reader.$ar_token_native.class ? T : NIL;
    }

    public static SubLObject ar_token_id(final SubLObject v_object) {
        assert NIL != ar_token_p(v_object) : "rkf_assisted_reader.ar_token_p(v_object) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_token_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_ar_token(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_assisted_reader.$ar_token_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject add_ar_token_phrase(final SubLObject token, final SubLObject phrase) {
        assert NIL != ar_token_p(token) : "rkf_assisted_reader.ar_token_p(token) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_token_p(token) " + token;
        assert NIL != ar_phrase_p(phrase) : "rkf_assisted_reader.ar_phrase_p(phrase) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_phrase_p(phrase) " + phrase;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject ar_phrase_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_assisted_reader.$ar_phrase_native.class ? T : NIL;
    }

    public static SubLObject ar_phrase_id(final SubLObject v_object) {
        assert NIL != ar_phrase_p(v_object) : "rkf_assisted_reader.ar_phrase_p(v_object) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_phrase_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_ar_phrase(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_assisted_reader.$ar_phrase_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject new_ar_phrase(final SubLObject state, final SubLObject sentence, final SubLObject token_list) {
        assert NIL != ar_sentence_p(sentence) : "rkf_assisted_reader.ar_sentence_p(sentence) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_sentence_p(sentence) " + sentence;
        assert NIL != listp(token_list) : "Types.listp(token_list) " + "CommonSymbols.NIL != Types.listp(token_list) " + token_list;
    ...
    public static SubLObject add_ar_phrase_concept(final SubLObject phrase, final SubLObject concept) {
        assert NIL != ar_phrase_p(phrase) : "rkf_assisted_reader.ar_phrase_p(phrase) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_phrase_p(phrase) " + phrase;
        assert NIL != ar_concept_p(concept) : "rkf_assisted_reader.ar_concept_p(concept) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_concept_p(concept) " + concept;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject note_ar_phrase_surrogate(final SubLObject phrase, final SubLObject surrogate) {
        assert NIL != ar_phrase_p(phrase) : "rkf_assisted_reader.ar_phrase_p(phrase) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_phrase_p(phrase) " + phrase;
        assert NIL != ar_concept_p(surrogate) : "rkf_assisted_reader.ar_concept_p(surrogate) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_concept_p(surrogate) " + surrogate;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject ar_concept_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_assisted_reader.$ar_concept_native.class ? T : NIL;
    }

    public static SubLObject ar_concept_id(final SubLObject v_object) {
        assert NIL != ar_concept_p(v_object) : "rkf_assisted_reader.ar_concept_p(v_object) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_concept_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_ar_concept(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_assisted_reader.$ar_concept_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject add_ar_concept_part(final SubLObject concept, final SubLObject part_concept) {
        assert NIL != ar_concept_p(concept) : "rkf_assisted_reader.ar_concept_p(concept) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_concept_p(concept) " + concept;
        assert NIL != ar_concept_p(part_concept) : "rkf_assisted_reader.ar_concept_p(part_concept) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_concept_p(part_concept) " + part_concept;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject add_ar_concept_agglomeration(final SubLObject concept, final SubLObject agglomeration) {
        assert NIL != ar_concept_p(concept) : "rkf_assisted_reader.ar_concept_p(concept) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_concept_p(concept) " + concept;
        assert NIL != ar_concept_p(agglomeration) : "rkf_assisted_reader.ar_concept_p(agglomeration) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_concept_p(agglomeration) " + agglomeration;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject ar_template_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_assisted_reader.$ar_template_native.class ? T : NIL;
    }

    public static SubLObject ar_template_id(final SubLObject v_object) {
        assert NIL != ar_template_p(v_object) : "rkf_assisted_reader.ar_template_p(v_object) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_template_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_ar_template(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_assisted_reader.$ar_template_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject note_ar_template_formula(final SubLObject template, final SubLObject formula) {
        assert NIL != ar_template_p(template) : "rkf_assisted_reader.ar_template_p(template) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_template_p(template) " + template;
        assert NIL != consp(formula) : "Types.consp(formula) " + "CommonSymbols.NIL != Types.consp(formula) " + formula;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject note_ar_template_prompt(final SubLObject template, final SubLObject prompt) {
        assert NIL != ar_template_p(template) : "rkf_assisted_reader.ar_template_p(template) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_template_p(template) " + template;
        assert NIL != consp(prompt) : "Types.consp(prompt) " + "CommonSymbols.NIL != Types.consp(prompt) " + prompt;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject note_ar_template_choice_table(final SubLObject template, final SubLObject choice_table) {
        assert NIL != ar_template_p(template) : "rkf_assisted_reader.ar_template_p(template) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_template_p(template) " + template;
        assert NIL != consp(choice_table) : "Types.consp(choice_table) " + "CommonSymbols.NIL != Types.consp(choice_table) " + choice_table;
        SubLObject release = NIL;
        try {
            release = seize_lock($ar_lock$.getGlobalValue());
    ...
    public static SubLObject ar_state_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_assisted_reader.$ar_state_native.class ? T : NIL;
    }

    public static SubLObject ar_state_isg(final SubLObject v_object) {
        assert NIL != ar_state_p(v_object) : "rkf_assisted_reader.ar_state_p(v_object) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_ar_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_assisted_reader.$ar_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject next_ar_state_id(final SubLObject state) {
        assert NIL != ar_state_p(state) : "rkf_assisted_reader.ar_state_p(state) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_state_p(state) " + state;
    ...
    public static SubLObject rkf_ar_act_add_source_texts(final SubLObject state, final SubLObject texts) {
        assert NIL != ar_state_p(state) : "rkf_assisted_reader.ar_state_p(state) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_state_p(state) " + state;
        assert NIL != listp(texts) : "Types.listp(texts) " + "CommonSymbols.NIL != Types.listp(texts) " + texts;
    ...
    public static SubLObject rkf_ar_act_add_text(final SubLObject state, final SubLObject text, SubLObject source_sentence, SubLObject v_parse_tree) {
        ...
        assert NIL != ar_state_p(state) : "rkf_assisted_reader.ar_state_p(state) " + "CommonSymbols.NIL != rkf_assisted_reader.ar_state_p(state) " + state;
        assert NIL != stringp(text) : "Types.stringp(text) " + "CommonSymbols.NIL != Types.stringp(text) " + text;
        assert NIL != listp(v_parse_tree) : "Types.listp(v_parse_tree) " + "CommonSymbols.NIL != Types.listp(v_parse_tree) " + v_parse_tree;
    ...
    public static SubLObject declare_rkf_assisted_reader_file() {
        declareMacro(me, "with_ar_lock", "WITH-AR-LOCK");
        declareFunction(me, "ar_sentence_print_function_trampoline", "AR-SENTENCE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "ar_sentence_p", "AR-SENTENCE-P", 1, 0, false);
        new rkf_assisted_reader.$ar_sentence_p$UnaryFunction();
        declareFunction(me, "ar_sentence_id", "AR-SENTENCE-ID", 1, 0, false);
        declareFunction(me, "ar_sentence_plaintext", "AR-SENTENCE-PLAINTEXT", 1, 0, false);
        declareFunction(me, "ar_sentence_token_vector", "AR-SENTENCE-TOKEN-VECTOR", 1, 0, false);
        declareFunction(me, "ar_sentence_clarifications", "AR-SENTENCE-CLARIFICATIONS", 1, 0, false);
        declareFunction(me, "ar_sentence_source_sentence", "AR-SENTENCE-SOURCE-SENTENCE", 1, 0, false);
        declareFunction(me, "ar_sentence_phrases", "AR-SENTENCE-PHRASES", 1, 0, false);
        declareFunction(me, "_csetf_ar_sentence_id", "_CSETF-AR-SENTENCE-ID", 2, 0, false);
        declareFunction(me, "_csetf_ar_sentence_plaintext", "_CSETF-AR-SENTENCE-PLAINTEXT", 2, 0, false);
        declareFunction(me, "_csetf_ar_sentence_token_vector", "_CSETF-AR-SENTENCE-TOKEN-VECTOR", 2, 0, false);
        declareFunction(me, "_csetf_ar_sentence_clarifications", "_CSETF-AR-SENTENCE-CLARIFICATIONS", 2, 0, false);
        declareFunction(me, "_csetf_ar_sentence_source_sentence", "_CSETF-AR-SENTENCE-SOURCE-SENTENCE", 2, 0, false);
        declareFunction(me, "_csetf_ar_sentence_phrases", "_CSETF-AR-SENTENCE-PHRASES", 2, 0, false);
        declareFunction(me, "make_ar_sentence", "MAKE-AR-SENTENCE", 0, 1, false);
        declareFunction(me, "visit_defstruct_ar_sentence", "VISIT-DEFSTRUCT-AR-SENTENCE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_ar_sentence_method", "VISIT-DEFSTRUCT-OBJECT-AR-SENTENCE-METHOD", 2, 0, false);
        declareFunction(me, "sxhash_ar_sentence_method", "SXHASH-AR-SENTENCE-METHOD", 1, 0, false);
        declareFunction(me, "new_ar_sentence", "NEW-AR-SENTENCE", 2, 0, false);
        declareFunction(me, "note_ar_sentence_token_vector", "NOTE-AR-SENTENCE-TOKEN-VECTOR", 2, 0, false);
        declareFunction(me, "add_ar_sentence_phrase", "ADD-AR-SENTENCE-PHRASE", 2, 0, false);
        declareFunction(me, "add_ar_sentence_clarification", "ADD-AR-SENTENCE-CLARIFICATION", 2, 0, false);
        declareFunction(me, "note_ar_sentence_source_sentence", "NOTE-AR-SENTENCE-SOURCE-SENTENCE", 2, 0, false);
        declareFunction(me, "ar_token_print_function_trampoline", "AR-TOKEN-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "ar_token_p", "AR-TOKEN-P", 1, 0, false);
        new rkf_assisted_reader.$ar_token_p$UnaryFunction();
        declareFunction(me, "ar_token_id", "AR-TOKEN-ID", 1, 0, false);
        declareFunction(me, "ar_token_text", "AR-TOKEN-TEXT", 1, 0, false);
        declareFunction(me, "ar_token_sentence", "AR-TOKEN-SENTENCE", 1, 0, false);
        declareFunction(me, "ar_token_number", "AR-TOKEN-NUMBER", 1, 0, false);
        declareFunction(me, "ar_token_phrases", "AR-TOKEN-PHRASES", 1, 0, false);
        declareFunction(me, "_csetf_ar_token_id", "_CSETF-AR-TOKEN-ID", 2, 0, false);
        declareFunction(me, "_csetf_ar_token_text", "_CSETF-AR-TOKEN-TEXT", 2, 0, false);
        declareFunction(me, "_csetf_ar_token_sentence", "_CSETF-AR-TOKEN-SENTENCE", 2, 0, false);
        declareFunction(me, "_csetf_ar_token_number", "_CSETF-AR-TOKEN-NUMBER", 2, 0, false);
        declareFunction(me, "_csetf_ar_token_phrases", "_CSETF-AR-TOKEN-PHRASES", 2, 0, false);
        declareFunction(me, "make_ar_token", "MAKE-AR-TOKEN", 0, 1, false);
        declareFunction(me, "visit_defstruct_ar_token", "VISIT-DEFSTRUCT-AR-TOKEN", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_ar_token_method", "VISIT-DEFSTRUCT-OBJECT-AR-TOKEN-METHOD", 2, 0, false);
        declareFunction(me, "print_ar_token", "PRINT-AR-TOKEN", 3, 0, false);
        declareFunction(me, "sxhash_ar_token_method", "SXHASH-AR-TOKEN-METHOD", 1, 0, false);
        declareFunction(me, "new_ar_token", "NEW-AR-TOKEN", 4, 0, false);
        declareFunction(me, "add_ar_token_phrase", "ADD-AR-TOKEN-PHRASE", 2, 0, false);
        declareFunction(me, "ar_phrase_print_function_trampoline", "AR-PHRASE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "ar_phrase_p", "AR-PHRASE-P", 1, 0, false);
        new rkf_assisted_reader.$ar_phrase_p$UnaryFunction();
        declareFunction(me, "ar_phrase_id", "AR-PHRASE-ID", 1, 0, false);
        declareFunction(me, "ar_phrase_status", "AR-PHRASE-STATUS", 1, 0, false);
        declareFunction(me, "ar_phrase_token_list", "AR-PHRASE-TOKEN-LIST", 1, 0, false);
        declareFunction(me, "ar_phrase_sentence", "AR-PHRASE-SENTENCE", 1, 0, false);
        declareFunction(me, "ar_phrase_concepts", "AR-PHRASE-CONCEPTS", 1, 0, false);
        declareFunction(me, "ar_phrase_rejected_concepts", "AR-PHRASE-REJECTED-CONCEPTS", 1, 0, false);
        declareFunction(me, "ar_phrase_disambiguated_concept", "AR-PHRASE-DISAMBIGUATED-CONCEPT", 1, 0, false);
        declareFunction(me, "ar_phrase_surrogate", "AR-PHRASE-SURROGATE", 1, 0, false);
        declareFunction(me, "ar_phrase_constraint", "AR-PHRASE-CONSTRAINT", 1, 0, false);
        declareFunction(me, "ar_phrase_force", "AR-PHRASE-FORCE", 1, 0, false);
        declareFunction(me, "_csetf_ar_phrase_id", "_CSETF-AR-PHRASE-ID", 2, 0, false);
        declareFunction(me, "_csetf_ar_phrase_status", "_CSETF-AR-PHRASE-STATUS", 2, 0, false);
        declareFunction(me, "_csetf_ar_phrase_token_list", "_CSETF-AR-PHRASE-TOKEN-LIST", 2, 0, false);
        declareFunction(me, "_csetf_ar_phrase_sentence", "_CSETF-AR-PHRASE-SENTENCE", 2, 0, false);
        declareFunction(me, "_csetf_ar_phrase_concepts", "_CSETF-AR-PHRASE-CONCEPTS", 2, 0, false);
        declareFunction(me, "_csetf_ar_phrase_rejected_concepts", "_CSETF-AR-PHRASE-REJECTED-CONCEPTS", 2, 0, false);
        declareFunction(me, "_csetf_ar_phrase_disambiguated_concept", "_CSETF-AR-PHRASE-DISAMBIGUATED-CONCEPT", 2, 0, false);
        declareFunction(me, "_csetf_ar_phrase_surrogate", "_CSETF-AR-PHRASE-SURROGATE", 2, 0, false);
        declareFunction(me, "_csetf_ar_phrase_constraint", "_CSETF-AR-PHRASE-CONSTRAINT", 2, 0, false);
        declareFunction(me, "_csetf_ar_phrase_force", "_CSETF-AR-PHRASE-FORCE", 2, 0, false);
        declareFunction(me, "make_ar_phrase", "MAKE-AR-PHRASE", 0, 1, false);
        declareFunction(me, "visit_defstruct_ar_phrase", "VISIT-DEFSTRUCT-AR-PHRASE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_ar_phrase_method", "VISIT-DEFSTRUCT-OBJECT-AR-PHRASE-METHOD", 2, 0, false);
        declareFunction(me, "print_ar_phrase", "PRINT-AR-PHRASE", 3, 0, false);
        declareFunction(me, "sxhash_ar_phrase_method", "SXHASH-AR-PHRASE-METHOD", 1, 0, false);
        declareFunction(me, "new_ar_phrase", "NEW-AR-PHRASE", 3, 0, false);
        declareFunction(me, "add_ar_phrase_concept", "ADD-AR-PHRASE-CONCEPT", 2, 0, false);
        declareFunction(me, "remove_ar_phrase_concept", "REMOVE-AR-PHRASE-CONCEPT", 2, 0, false);
        declareFunction(me, "add_ar_phrase_rejected_concept", "ADD-AR-PHRASE-REJECTED-CONCEPT", 2, 0, false);
        declareFunction(me, "clear_ar_phrase_disambiguated_concept", "CLEAR-AR-PHRASE-DISAMBIGUATED-CONCEPT", 1, 0, false);
        declareFunction(me, "note_ar_phrase_disambiguated_concept", "NOTE-AR-PHRASE-DISAMBIGUATED-CONCEPT", 2, 0, false);
        declareFunction(me, "note_ar_phrase_status", "NOTE-AR-PHRASE-STATUS", 2, 0, false);
        declareFunction(me, "note_ar_phrase_force", "NOTE-AR-PHRASE-FORCE", 2, 0, false);
        declareFunction(me, "note_ar_phrase_surrogate", "NOTE-AR-PHRASE-SURROGATE", 2, 0, false);
        declareFunction(me, "note_ar_phrase_constraint", "NOTE-AR-PHRASE-CONSTRAINT", 2, 0, false);
        declareFunction(me, "compute_ar_phrase_force", "COMPUTE-AR-PHRASE-FORCE", 1, 2, false);
        declareFunction(me, "ar_phrase_has_non_surrogate_conceptsP", "AR-PHRASE-HAS-NON-SURROGATE-CONCEPTS?", 1, 0, false);
        declareFunction(me, "ar_phrase_token_count", "AR-PHRASE-TOKEN-COUNT", 1, 0, false);
        declareFunction(me, "ar_concept_print_function_trampoline", "AR-CONCEPT-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "ar_concept_p", "AR-CONCEPT-P", 1, 0, false);
        new rkf_assisted_reader.$ar_concept_p$UnaryFunction();
        declareFunction(me, "ar_concept_id", "AR-CONCEPT-ID", 1, 0, false);
        declareFunction(me, "ar_concept_cycl", "AR-CONCEPT-CYCL", 1, 0, false);
        declareFunction(me, "ar_concept_disambiguation_text", "AR-CONCEPT-DISAMBIGUATION-TEXT", 1, 0, false);
        declareFunction(me, "ar_concept_phrases", "AR-CONCEPT-PHRASES", 1, 0, false);
        declareFunction(me, "ar_concept_parts", "AR-CONCEPT-PARTS", 1, 0, false);
        declareFunction(me, "ar_concept_agglomerations", "AR-CONCEPT-AGGLOMERATIONS", 1, 0, false);
        declareFunction(me, "ar_concept_force", "AR-CONCEPT-FORCE", 1, 0, false);
        declareFunction(me, "ar_concept_confidence", "AR-CONCEPT-CONFIDENCE", 1, 0, false);
        declareFunction(me, "ar_concept_open_term_score", "AR-CONCEPT-OPEN-TERM-SCORE", 1, 0, false);
        declareFunction(me, "_csetf_ar_concept_id", "_CSETF-AR-CONCEPT-ID", 2, 0, false);
        declareFunction(me, "_csetf_ar_concept_cycl", "_CSETF-AR-CONCEPT-CYCL", 2, 0, false);
        declareFunction(me, "_csetf_ar_concept_disambiguation_text", "_CSETF-AR-CONCEPT-DISAMBIGUATION-TEXT", 2, 0, false);
        declareFunction(me, "_csetf_ar_concept_phrases", "_CSETF-AR-CONCEPT-PHRASES", 2, 0, false);
        declareFunction(me, "_csetf_ar_concept_parts", "_CSETF-AR-CONCEPT-PARTS", 2, 0, false);
        declareFunction(me, "_csetf_ar_concept_agglomerations", "_CSETF-AR-CONCEPT-AGGLOMERATIONS", 2, 0, false);
        declareFunction(me, "_csetf_ar_concept_force", "_CSETF-AR-CONCEPT-FORCE", 2, 0, false);
        declareFunction(me, "_csetf_ar_concept_confidence", "_CSETF-AR-CONCEPT-CONFIDENCE", 2, 0, false);
        declareFunction(me, "_csetf_ar_concept_open_term_score", "_CSETF-AR-CONCEPT-OPEN-TERM-SCORE", 2, 0, false);
        declareFunction(me, "make_ar_concept", "MAKE-AR-CONCEPT", 0, 1, false);
        declareFunction(me, "visit_defstruct_ar_concept", "VISIT-DEFSTRUCT-AR-CONCEPT", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_ar_concept_method", "VISIT-DEFSTRUCT-OBJECT-AR-CONCEPT-METHOD", 2, 0, false);
        declareFunction(me, "print_ar_concept", "PRINT-AR-CONCEPT", 3, 0, false);
        declareFunction(me, "sxhash_ar_concept_method", "SXHASH-AR-CONCEPT-METHOD", 1, 0, false);
        declareFunction(me, "new_ar_concept", "NEW-AR-CONCEPT", 2, 0, false);
        declareFunction(me, "clone_ar_concept", "CLONE-AR-CONCEPT", 3, 0, false);
        declareFunction(me, "rkf_ar_act_clone_augment_concept", "RKF-AR-ACT-CLONE-AUGMENT-CONCEPT", 3, 0, false);
        declareFunction(me, "add_ar_concept_phrase", "ADD-AR-CONCEPT-PHRASE", 2, 0, false);
        declareFunction(me, "add_ar_concept_part", "ADD-AR-CONCEPT-PART", 2, 0, false);
        declareFunction(me, "rem_ar_concept_part", "REM-AR-CONCEPT-PART", 2, 0, false);
        declareFunction(me, "add_ar_concept_agglomeration", "ADD-AR-CONCEPT-AGGLOMERATION", 2, 0, false);
        declareFunction(me, "rem_ar_concept_agglomeration", "REM-AR-CONCEPT-AGGLOMERATION", 2, 0, false);
        declareFunction(me, "note_ar_concept_disambiguation_text", "NOTE-AR-CONCEPT-DISAMBIGUATION-TEXT", 2, 0, false);
        declareFunction(me, "replace_ar_concept_cycl", "REPLACE-AR-CONCEPT-CYCL", 2, 0, false);
        declareFunction(me, "subst_ar_concept_cycl", "SUBST-AR-CONCEPT-CYCL", 3, 0, false);
        declareFunction(me, "note_ar_concept_force", "NOTE-AR-CONCEPT-FORCE", 2, 0, false);
        declareFunction(me, "ar_concept_queryP", "AR-CONCEPT-QUERY?", 1, 0, false);
        declareFunction(me, "ar_concept_assertionP", "AR-CONCEPT-ASSERTION?", 1, 0, false);
        declareFunction(me, "note_ar_concept_confidence", "NOTE-AR-CONCEPT-CONFIDENCE", 2, 0, false);
        declareFunction(me, "note_ar_concept_open_term_score", "NOTE-AR-CONCEPT-OPEN-TERM-SCORE", 2, 0, false);
        declareFunction(me, "ar_template_print_function_trampoline", "AR-TEMPLATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "ar_template_p", "AR-TEMPLATE-P", 1, 0, false);
        new rkf_assisted_reader.$ar_template_p$UnaryFunction();
        declareFunction(me, "ar_template_id", "AR-TEMPLATE-ID", 1, 0, false);
        declareFunction(me, "ar_template_concept", "AR-TEMPLATE-CONCEPT", 1, 0, false);
        declareFunction(me, "ar_template_formula", "AR-TEMPLATE-FORMULA", 1, 0, false);
        declareFunction(me, "ar_template_prompt", "AR-TEMPLATE-PROMPT", 1, 0, false);
        declareFunction(me, "ar_template_choice_table", "AR-TEMPLATE-CHOICE-TABLE", 1, 0, false);
        declareFunction(me, "ar_template_agglomerations", "AR-TEMPLATE-AGGLOMERATIONS", 1, 0, false);
        declareFunction(me, "_csetf_ar_template_id", "_CSETF-AR-TEMPLATE-ID", 2, 0, false);
        declareFunction(me, "_csetf_ar_template_concept", "_CSETF-AR-TEMPLATE-CONCEPT", 2, 0, false);
        declareFunction(me, "_csetf_ar_template_formula", "_CSETF-AR-TEMPLATE-FORMULA", 2, 0, false);
        declareFunction(me, "_csetf_ar_template_prompt", "_CSETF-AR-TEMPLATE-PROMPT", 2, 0, false);
        declareFunction(me, "_csetf_ar_template_choice_table", "_CSETF-AR-TEMPLATE-CHOICE-TABLE", 2, 0, false);
        declareFunction(me, "_csetf_ar_template_agglomerations", "_CSETF-AR-TEMPLATE-AGGLOMERATIONS", 2, 0, false);
        declareFunction(me, "make_ar_template", "MAKE-AR-TEMPLATE", 0, 1, false);
        declareFunction(me, "visit_defstruct_ar_template", "VISIT-DEFSTRUCT-AR-TEMPLATE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_ar_template_method", "VISIT-DEFSTRUCT-OBJECT-AR-TEMPLATE-METHOD", 2, 0, false);
        declareFunction(me, "sxhash_ar_template_method", "SXHASH-AR-TEMPLATE-METHOD", 1, 0, false);
        declareFunction(me, "new_ar_template", "NEW-AR-TEMPLATE", 2, 0, false);
        declareFunction(me, "note_ar_template_formula", "NOTE-AR-TEMPLATE-FORMULA", 2, 0, false);
        declareFunction(me, "note_ar_template_prompt", "NOTE-AR-TEMPLATE-PROMPT", 2, 0, false);
        declareFunction(me, "note_ar_template_choice_table", "NOTE-AR-TEMPLATE-CHOICE-TABLE", 2, 0, false);
        declareFunction(me, "add_ar_template_agglomeration", "ADD-AR-TEMPLATE-AGGLOMERATION", 2, 0, false);
        declareFunction(me, "ar_state_print_function_trampoline", "AR-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "ar_state_p", "AR-STATE-P", 1, 0, false);
        new rkf_assisted_reader.$ar_state_p$UnaryFunction();
        declareFunction(me, "ar_state_isg", "AR-STATE-ISG", 1, 0, false);
        declareFunction(me, "ar_state_index", "AR-STATE-INDEX", 1, 0, false);
        declareFunction(me, "ar_state_source_sentences", "AR-STATE-SOURCE-SENTENCES", 1, 0, false);
        declareFunction(me, "ar_state_focus_sentence", "AR-STATE-FOCUS-SENTENCE", 1, 0, false);
        declareFunction(me, "ar_state_completed_sentences", "AR-STATE-COMPLETED-SENTENCES", 1, 0, false);
        declareFunction(me, "ar_state_unknown_phrases", "AR-STATE-UNKNOWN-PHRASES", 1, 0, false);
        declareFunction(me, "ar_state_rejected_phrases", "AR-STATE-REJECTED-PHRASES", 1, 0, false);
        declareFunction(me, "ar_state_irrelevant_phrases", "AR-STATE-IRRELEVANT-PHRASES", 1, 0, false);
        declareFunction(me, "ar_state_ambiguous_phrases", "AR-STATE-AMBIGUOUS-PHRASES", 1, 0, false);
        declareFunction(me, "ar_state_assumed_phrases", "AR-STATE-ASSUMED-PHRASES", 1, 0, false);
        declareFunction(me, "ar_state_pending_phrases", "AR-STATE-PENDING-PHRASES", 1, 0, false);
        declareFunction(me, "ar_state_accepted_phrases", "AR-STATE-ACCEPTED-PHRASES", 1, 0, false);
        declareFunction(me, "ar_state_pending_concepts", "AR-STATE-PENDING-CONCEPTS", 1, 0, false);
        declareFunction(me, "ar_state_accepted_concepts", "AR-STATE-ACCEPTED-CONCEPTS", 1, 0, false);
        declareFunction(me, "ar_state_candidate_cycls", "AR-STATE-CANDIDATE-CYCLS", 1, 0, false);
        declareFunction(me, "ar_state_asserted_assertions", "AR-STATE-ASSERTED-ASSERTIONS", 1, 0, false);
        declareFunction(me, "ar_state_term_templates", "AR-STATE-TERM-TEMPLATES", 1, 0, false);
        declareFunction(me, "ar_state_assert_templates", "AR-STATE-ASSERT-TEMPLATES", 1, 0, false);
        declareFunction(me, "_csetf_ar_state_isg", "_CSETF-AR-STATE-ISG", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_index", "_CSETF-AR-STATE-INDEX", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_source_sentences", "_CSETF-AR-STATE-SOURCE-SENTENCES", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_focus_sentence", "_CSETF-AR-STATE-FOCUS-SENTENCE", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_completed_sentences", "_CSETF-AR-STATE-COMPLETED-SENTENCES", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_unknown_phrases", "_CSETF-AR-STATE-UNKNOWN-PHRASES", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_rejected_phrases", "_CSETF-AR-STATE-REJECTED-PHRASES", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_irrelevant_phrases", "_CSETF-AR-STATE-IRRELEVANT-PHRASES", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_ambiguous_phrases", "_CSETF-AR-STATE-AMBIGUOUS-PHRASES", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_assumed_phrases", "_CSETF-AR-STATE-ASSUMED-PHRASES", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_pending_phrases", "_CSETF-AR-STATE-PENDING-PHRASES", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_accepted_phrases", "_CSETF-AR-STATE-ACCEPTED-PHRASES", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_pending_concepts", "_CSETF-AR-STATE-PENDING-CONCEPTS", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_accepted_concepts", "_CSETF-AR-STATE-ACCEPTED-CONCEPTS", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_candidate_cycls", "_CSETF-AR-STATE-CANDIDATE-CYCLS", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_asserted_assertions", "_CSETF-AR-STATE-ASSERTED-ASSERTIONS", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_term_templates", "_CSETF-AR-STATE-TERM-TEMPLATES", 2, 0, false);
        declareFunction(me, "_csetf_ar_state_assert_templates", "_CSETF-AR-STATE-ASSERT-TEMPLATES", 2, 0, false);
        declareFunction(me, "make_ar_state", "MAKE-AR-STATE", 0, 1, false);
        declareFunction(me, "visit_defstruct_ar_state", "VISIT-DEFSTRUCT-AR-STATE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_ar_state_method", "VISIT-DEFSTRUCT-OBJECT-AR-STATE-METHOD", 2, 0, false);
        declareFunction(me, "new_ar_state", "NEW-AR-STATE", 0, 0, false);
        declareFunction(me, "ar_reset", "AR-RESET", 1, 0, false);
        declareFunction(me, "next_ar_state_id", "NEXT-AR-STATE-ID", 1, 0, false);
        declareFunction(me, "add_ar_object_index", "ADD-AR-OBJECT-INDEX", 3, 0, false);
        declareFunction(me, "find_ar_object", "FIND-AR-OBJECT", 2, 0, false);
        declareFunction(me, "find_ar_sentence", "FIND-AR-SENTENCE", 2, 0, false);
        declareFunction(me, "find_ar_token", "FIND-AR-TOKEN", 2, 0, false);
        declareFunction(me, "find_ar_phrase", "FIND-AR-PHRASE", 2, 0, false);
        declareFunction(me, "find_ar_concept", "FIND-AR-CONCEPT", 2, 0, false);
        declareFunction(me, "find_ar_template", "FIND-AR-TEMPLATE", 2, 0, false);
        declareFunction(me, "add_ar_state_source_sentence", "ADD-AR-STATE-SOURCE-SENTENCE", 2, 0, false);
        declareFunction(me, "clear_ar_state_focus_sentence", "CLEAR-AR-STATE-FOCUS-SENTENCE", 1, 0, false);
        declareFunction(me, "note_ar_state_focus_sentence", "NOTE-AR-STATE-FOCUS-SENTENCE", 2, 0, false);
        declareFunction(me, "ar_state_force", "AR-STATE-FORCE", 1, 0, false);
        declareFunction(me, "ar_phrase_span_lengthG", "AR-PHRASE-SPAN-LENGTH>", 2, 0, false);
        declareFunction(me, "add_ar_state_completed_sentence", "ADD-AR-STATE-COMPLETED-SENTENCE", 2, 0, false);
        declareFunction(me, "add_ar_state_unknown_phrase", "ADD-AR-STATE-UNKNOWN-PHRASE", 2, 0, false);
        declareFunction(me, "rem_ar_state_unknown_phrase", "REM-AR-STATE-UNKNOWN-PHRASE", 2, 0, false);
        declareFunction(me, "add_ar_state_rejected_phrase", "ADD-AR-STATE-REJECTED-PHRASE", 2, 0, false);
        declareFunction(me, "rem_ar_state_rejected_phrase", "REM-AR-STATE-REJECTED-PHRASE", 2, 0, false);
        declareFunction(me, "add_ar_state_irrelevant_phrase", "ADD-AR-STATE-IRRELEVANT-PHRASE", 2, 0, false);
        declareFunction(me, "rem_ar_state_irrelevant_phrase", "REM-AR-STATE-IRRELEVANT-PHRASE", 2, 0, false);
        declareFunction(me, "add_ar_state_ambiguous_phrase", "ADD-AR-STATE-AMBIGUOUS-PHRASE", 2, 0, false);
        declareFunction(me, "rem_ar_state_ambiguous_phrase", "REM-AR-STATE-AMBIGUOUS-PHRASE", 2, 0, false);
        declareFunction(me, "add_ar_state_assumed_phrase", "ADD-AR-STATE-ASSUMED-PHRASE", 2, 0, false);
        declareFunction(me, "rem_ar_state_assumed_phrase", "REM-AR-STATE-ASSUMED-PHRASE", 2, 0, false);
        declareFunction(me, "add_ar_state_pending_phrase", "ADD-AR-STATE-PENDING-PHRASE", 2, 0, false);
        declareFunction(me, "rem_ar_state_pending_phrase", "REM-AR-STATE-PENDING-PHRASE", 2, 0, false);
        declareFunction(me, "add_ar_state_accepted_phrase", "ADD-AR-STATE-ACCEPTED-PHRASE", 2, 0, false);
        declareFunction(me, "rem_ar_state_accepted_phrase", "REM-AR-STATE-ACCEPTED-PHRASE", 2, 0, false);
        declareFunction(me, "add_ar_state_accepted_concept", "ADD-AR-STATE-ACCEPTED-CONCEPT", 2, 0, false);
        declareFunction(me, "rem_ar_state_accepted_concept", "REM-AR-STATE-ACCEPTED-CONCEPT", 2, 0, false);
        declareFunction(me, "add_ar_state_pending_concept", "ADD-AR-STATE-PENDING-CONCEPT", 2, 0, false);
        declareFunction(me, "rem_ar_state_pending_concept", "REM-AR-STATE-PENDING-CONCEPT", 2, 0, false);
        declareFunction(me, "ar_state_candidate_assertions", "AR-STATE-CANDIDATE-ASSERTIONS", 1, 0, false);
        declareFunction(me, "ar_state_candidate_queries", "AR-STATE-CANDIDATE-QUERIES", 1, 0, false);
        declareFunction(me, "add_ar_state_candidate_cycl", "ADD-AR-STATE-CANDIDATE-CYCL", 2, 0, false);
        declareFunction(me, "add_ar_state_candidate_assertion", "ADD-AR-STATE-CANDIDATE-ASSERTION", 2, 0, false);
        declareFunction(me, "add_ar_state_candidate_query", "ADD-AR-STATE-CANDIDATE-QUERY", 2, 0, false);
        declareFunction(me, "rem_ar_state_candidate_assertion", "REM-AR-STATE-CANDIDATE-ASSERTION", 2, 0, false);
        declareFunction(me, "rem_ar_state_candidate_query", "REM-AR-STATE-CANDIDATE-QUERY", 2, 0, false);
        declareFunction(me, "add_ar_state_asserted_assertion", "ADD-AR-STATE-ASSERTED-ASSERTION", 2, 0, false);
        declareFunction(me, "rem_ar_state_asserted_assertion", "REM-AR-STATE-ASSERTED-ASSERTION", 2, 0, false);
        declareFunction(me, "add_ar_state_term_template", "ADD-AR-STATE-TERM-TEMPLATE", 2, 0, false);
        declareFunction(me, "rem_ar_state_term_template", "REM-AR-STATE-TERM-TEMPLATE", 2, 0, false);
        declareFunction(me, "add_ar_state_assert_template", "ADD-AR-STATE-ASSERT-TEMPLATE", 2, 0, false);
        declareFunction(me, "rem_ar_state_assert_template", "REM-AR-STATE-ASSERT-TEMPLATE", 2, 0, false);
        declareFunction(me, "ar_state_top_level_parsesP", "AR-STATE-TOP-LEVEL-PARSES?", 1, 0, false);
        declareFunction(me, "ar_sentence_completed_p", "AR-SENTENCE-COMPLETED-P", 2, 0, false);
        declareFunction(me, "ar_source_sentence_p", "AR-SOURCE-SENTENCE-P", 1, 0, false);
        declareFunction(me, "ar_clarification_sentence_p", "AR-CLARIFICATION-SENTENCE-P", 1, 0, false);
        declareFunction(me, "ar_source_sentence_number", "AR-SOURCE-SENTENCE-NUMBER", 2, 0, false);
        declareFunction(me, "ar_clarification_sentence_number", "AR-CLARIFICATION-SENTENCE-NUMBER", 2, 0, false);
        declareFunction(me, "ar_determine_source_sentence", "AR-DETERMINE-SOURCE-SENTENCE", 1, 0, false);
        declareFunction(me, "ar_determine_concept_sentences", "AR-DETERMINE-CONCEPT-SENTENCES", 1, 0, false);
        declareFunction(me, "ar_determine_concept_sentences_recursive", "AR-DETERMINE-CONCEPT-SENTENCES-RECURSIVE", 2, 0, false);
        declareFunction(me, "ar_sentence_assumed_phrase_count", "AR-SENTENCE-ASSUMED-PHRASE-COUNT", 2, 0, false);
        declareFunction(me, "ar_state_next_assumed_phrase", "AR-STATE-NEXT-ASSUMED-PHRASE", 1, 0, false);
        declareFunction(me, "ar_state_next_unknown_phrase", "AR-STATE-NEXT-UNKNOWN-PHRASE", 1, 0, false);
        declareFunction(me, "ar_state_select_most_promising_unknown_phrase", "AR-STATE-SELECT-MOST-PROMISING-UNKNOWN-PHRASE", 1, 0, false);
        declareFunction(me, "ar_state_pending_implied_indexicals", "AR-STATE-PENDING-IMPLIED-INDEXICALS", 1, 0, false);
        declareFunction(me, "ar_state_next_implied_indexical", "AR-STATE-NEXT-IMPLIED-INDEXICAL", 1, 0, false);
        declareFunction(me, "ar_sentence_ambiguous_phrase_count", "AR-SENTENCE-AMBIGUOUS-PHRASE-COUNT", 2, 0, false);
        declareFunction(me, "ar_state_next_ambiguous_phrase", "AR-STATE-NEXT-AMBIGUOUS-PHRASE", 1, 0, false);
        declareFunction(me, "ar_sentence_candidate_assertion_count", "AR-SENTENCE-CANDIDATE-ASSERTION-COUNT", 2, 0, false);
        declareFunction(me, "ar_sentence_candidate_query_count", "AR-SENTENCE-CANDIDATE-QUERY-COUNT", 2, 0, false);
        declareFunction(me, "ar_sentence_asserted_assertion_count", "AR-SENTENCE-ASSERTED-ASSERTION-COUNT", 2, 0, false);
        declareFunction(me, "ar_state_determine_focus_sentence", "AR-STATE-DETERMINE-FOCUS-SENTENCE", 1, 0, false);
        declareFunction(me, "ar_surrogate_concept_p", "AR-SURROGATE-CONCEPT-P", 1, 0, false);
        declareFunction(me, "ar_concept_dependent_on_surrogate_p", "AR-CONCEPT-DEPENDENT-ON-SURROGATE-P", 1, 1, false);
        declareFunction(me, "current_ar_concept_grounding_map", "CURRENT-AR-CONCEPT-GROUNDING-MAP", 0, 0, false);
        declareFunction(me, "ensure_ar_concept_grounding_map", "ENSURE-AR-CONCEPT-GROUNDING-MAP", 0, 0, false);
        declareMacro(me, "with_new_ar_concept_grounding_map", "WITH-NEW-AR-CONCEPT-GROUNDING-MAP");
        declareFunction(me, "ar_concept_grounding_computedP", "AR-CONCEPT-GROUNDING-COMPUTED?", 2, 0, false);
        declareFunction(me, "ar_concept_grounding_groundedP", "AR-CONCEPT-GROUNDING-GROUNDED?", 2, 0, false);
        declareFunction(me, "ar_concept_grounding_ungroundedP", "AR-CONCEPT-GROUNDING-UNGROUNDED?", 2, 0, false);
        declareFunction(me, "ar_concept_grounding_in_progressP", "AR-CONCEPT-GROUNDING-IN-PROGRESS?", 2, 0, false);
        declareFunction(me, "ar_concept_grounding_map_mark", "AR-CONCEPT-GROUNDING-MAP-MARK", 3, 0, false);
        declareFunction(me, "ar_concept_dependent_on_ungrounded_surrogate_p", "AR-CONCEPT-DEPENDENT-ON-UNGROUNDED-SURROGATE-P", 1, 0, false);
        declareFunction(me, "ar_concept_dependent_on_ungrounded_surrogate_count", "AR-CONCEPT-DEPENDENT-ON-UNGROUNDED-SURROGATE-COUNT", 1, 0, false);
        declareFunction(me, "ar_phrase_dependent_on_ungrounded_surrogate_p", "AR-PHRASE-DEPENDENT-ON-UNGROUNDED-SURROGATE-P", 1, 0, false);
        declareFunction(me, "ar_phrase_divide_eq_best_lambda_substitute", "AR-PHRASE-DIVIDE-EQ-BEST-LAMBDA-SUBSTITUTE", 1, 0, false);
        declareFunction(me, "ar_phrase_divide_concepts", "AR-PHRASE-DIVIDE-CONCEPTS", 2, 0, false);
        declareFunction(me, "ar_concept_separate_out_forts", "AR-CONCEPT-SEPARATE-OUT-FORTS", 1, 0, false);
        declareFunction(me, "ar_concept_complexity", "AR-CONCEPT-COMPLEXITY", 1, 0, false);
        declareFunction(me, "ar_formula_complexity", "AR-FORMULA-COMPLEXITY", 1, 0, false);
        declareFunction(me, "ar_phrase_constraints_for_unknown", "AR-PHRASE-CONSTRAINTS-FOR-UNKNOWN", 3, 0, false);
        declareFunction(me, "rkf_ar_act_add_source_texts_background", "RKF-AR-ACT-ADD-SOURCE-TEXTS-BACKGROUND", 2, 0, false);
        declareFunction(me, "rkf_ar_act_add_source_texts_background_internal", "RKF-AR-ACT-ADD-SOURCE-TEXTS-BACKGROUND-INTERNAL", 3, 0, false);
        declareFunction(me, "rkf_ar_act_add_source_texts", "RKF-AR-ACT-ADD-SOURCE-TEXTS", 2, 0, false);
        declareFunction(me, "rkf_ar_act_add_rewrite_texts_background", "RKF-AR-ACT-ADD-REWRITE-TEXTS-BACKGROUND", 3, 0, false);
        declareFunction(me, "rkf_ar_act_add_rewrite_texts_background_internal", "RKF-AR-ACT-ADD-REWRITE-TEXTS-BACKGROUND-INTERNAL", 4, 0, false);
        declareFunction(me, "rkf_ar_act_add_rewrite_texts", "RKF-AR-ACT-ADD-REWRITE-TEXTS", 3, 0, false);
        declareFunction(me, "rkf_ar_act_add_source_text", "RKF-AR-ACT-ADD-SOURCE-TEXT", 2, 1, false);
        declareFunction(me, "rkf_ar_act_add_rewrite_text", "RKF-AR-ACT-ADD-REWRITE-TEXT", 3, 0, false);
        declareFunction(me, "rkf_ar_act_add_clarification", "RKF-AR-ACT-ADD-CLARIFICATION", 3, 0, false);
        declareFunction(me, "rkf_ar_select_processing_method", "RKF-AR-SELECT-PROCESSING-METHOD", 0, 0, false);
        declareFunction(me, "rkf_ar_act_process_input_sentence", "RKF-AR-ACT-PROCESS-INPUT-SENTENCE", 1, 0, false);
        declareFunction(me, "rkf_ar_template_category_for_processor", "RKF-AR-TEMPLATE-CATEGORY-FOR-PROCESSOR", 1, 0, false);
        declareFunction(me, "rkf_ar_act_add_text", "RKF-AR-ACT-ADD-TEXT", 2, 2, false);
        declareFunction(me, "rkf_ar_set_open_term_scores", "RKF-AR-SET-OPEN-TERM-SCORES", 1, 0, false);
        declareFunction(me, "rkf_ar_reset_open_term_counts_for_sentence", "RKF-AR-RESET-OPEN-TERM-COUNTS-FOR-SENTENCE", 1, 0, false);
        declareFunction(me, "rkf_ar_concept_check_trivial_differences", "RKF-AR-CONCEPT-CHECK-TRIVIAL-DIFFERENCES", 2, 0, false);
        declareFunction(me, "rkf_ar_mask_trivial_differences", "RKF-AR-MASK-TRIVIAL-DIFFERENCES", 1, 0, false);
        declareFunction(me, "rkf_ar_harvest_for_phrases_and_concepts", "RKF-AR-HARVEST-FOR-PHRASES-AND-CONCEPTS", 4, 0, false);
        declareFunction(me, "rkf_ar_transform_unknown_instances", "RKF-AR-TRANSFORM-UNKNOWN-INSTANCES", 1, 0, false);
        declareFunction(me, "rkf_ar_log_parsing_event", "RKF-AR-LOG-PARSING-EVENT", 3, 0, false);
        declareFunction(me, "rkf_ar_rank_parses", "RKF-AR-RANK-PARSES", 2, 0, false);
        declareFunction(me, "ar_concept_is_surrogateP", "AR-CONCEPT-IS-SURROGATE?", 1, 0, false);
        declareFunction(me, "rkf_ar_add_any_surrogates", "RKF-AR-ADD-ANY-SURROGATES", 4, 0, false);
        declareFunction(me, "rkf_ar_locate_appropriate_phrase", "RKF-AR-LOCATE-APPROPRIATE-PHRASE", 2, 0, false);
        declareFunction(me, "rkf_ar_check_for_existing_surrogate", "RKF-AR-CHECK-FOR-EXISTING-SURROGATE", 2, 0, false);
        declareFunction(me, "rkf_ar_update_surrogates", "RKF-AR-UPDATE-SURROGATES", 2, 0, false);
        declareFunction(me, "rkf_ar_add_surrogate_sans_children", "RKF-AR-ADD-SURROGATE-SANS-CHILDREN", 4, 0, false);
        declareFunction(me, "rkf_ar_act_focus_sentence", "RKF-AR-ACT-FOCUS-SENTENCE", 2, 0, false);
        declareFunction(me, "rkf_ar_ensure_focus_sentence", "RKF-AR-ENSURE-FOCUS-SENTENCE", 2, 0, false);
        declareFunction(me, "rkf_ar_act_augment_sentence", "RKF-AR-ACT-AUGMENT-SENTENCE", 3, 0, false);
        declareFunction(me, "rkf_ar_act_complete_augmentation", "RKF-AR-ACT-COMPLETE-AUGMENTATION", 1, 0, false);
        declareFunction(me, "rkf_ar_act_find_concept", "RKF-AR-ACT-FIND-CONCEPT", 2, 0, false);
        declareFunction(me, "rkf_ar_act_augment_phrase", "RKF-AR-ACT-AUGMENT-PHRASE", 3, 0, false);
        declareFunction(me, "rkf_ar_act_add_phrase", "RKF-AR-ACT-ADD-PHRASE", 2, 0, false);
        declareFunction(me, "rkf_ar_act_add_relevant_phrase", "RKF-AR-ACT-ADD-RELEVANT-PHRASE", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_irrelevant", "RKF-AR-ACT-NOTE-IRRELEVANT", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_assumed", "RKF-AR-ACT-NOTE-ASSUMED", 3, 0, false);
        declareFunction(me, "rkf_ar_act_note_ambiguous", "RKF-AR-ACT-NOTE-AMBIGUOUS", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_disambiguation", "RKF-AR-ACT-NOTE-DISAMBIGUATION", 3, 0, false);
        declareFunction(me, "rkf_ar_act_note_accept_assumed", "RKF-AR-ACT-NOTE-ACCEPT-ASSUMED", 2, 0, false);
        declareFunction(me, "rkf_ar_act_handle_accept_assumed", "RKF-AR-ACT-HANDLE-ACCEPT-ASSUMED", 3, 0, false);
        declareFunction(me, "rkf_ar_act_note_accepted_phrase", "RKF-AR-ACT-NOTE-ACCEPTED-PHRASE", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_rejected_phrase", "RKF-AR-ACT-NOTE-REJECTED-PHRASE", 2, 0, false);
        declareFunction(me, "rkf_ar_act_reconsider_irrelevant", "RKF-AR-ACT-RECONSIDER-IRRELEVANT", 2, 0, false);
        declareFunction(me, "rkf_ar_act_understand_unknown_phrase", "RKF-AR-ACT-UNDERSTAND-UNKNOWN-PHRASE", 3, 0, false);
        declareFunction(me, "rkf_ar_act_reject_unknown_phrase", "RKF-AR-ACT-REJECT-UNKNOWN-PHRASE", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_rewrite_sentence", "RKF-AR-ACT-NOTE-REWRITE-SENTENCE", 3, 0, false);
        declareFunction(me, "ar_sentence_rewrite_cycl_p", "AR-SENTENCE-REWRITE-CYCL-P", 1, 0, false);
        declareFunction(me, "ar_compute_sentence_rewrites", "AR-COMPUTE-SENTENCE-REWRITES", 1, 0, false);
        declareFunction(me, "rkf_ar_act_note_sentence_completed", "RKF-AR-ACT-NOTE-SENTENCE-COMPLETED", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_sentence_completed_and_refocus", "RKF-AR-ACT-NOTE-SENTENCE-COMPLETED-AND-REFOCUS", 1, 0, false);
        declareFunction(me, "rkf_ar_act_note_phrase_completed", "RKF-AR-ACT-NOTE-PHRASE-COMPLETED", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_concept_completed", "RKF-AR-ACT-NOTE-CONCEPT-COMPLETED", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_pending_concept", "RKF-AR-ACT-NOTE-PENDING-CONCEPT", 2, 0, false);
        declareFunction(me, "rkf_ar_ensure_relation_is_goodP", "RKF-AR-ENSURE-RELATION-IS-GOOD?", 1, 0, false);
        declareFunction(me, "rkf_ar_act_propagate_surrogate_constraint", "RKF-AR-ACT-PROPAGATE-SURROGATE-CONSTRAINT", 3, 0, false);
        declareFunction(me, "rkf_ar_act_propagate_one_surrogate_constraint", "RKF-AR-ACT-PROPAGATE-ONE-SURROGATE-CONSTRAINT", 4, 0, false);
        declareFunction(me, "rkf_ar_concept_is_nthfn_termP", "RKF-AR-CONCEPT-IS-NTHFN-TERM?", 1, 0, false);
        declareFunction(me, "rkf_ar_nthfn_termP", "RKF-AR-NTHFN-TERM?", 1, 0, false);
        declareFunction(me, "rkf_ar_unfailable_constraintP", "RKF-AR-UNFAILABLE-CONSTRAINT?", 1, 0, false);
        declareFunction(me, "rkf_ar_possibly_reformulatableP", "RKF-AR-POSSIBLY-REFORMULATABLE?", 1, 0, false);
        declareFunction(me, "rkf_reformulatable_termP", "RKF-REFORMULATABLE-TERM?", 1, 0, false);
        declareFunction(me, "initialize_rkf_reformulatable_terms", "INITIALIZE-RKF-REFORMULATABLE-TERMS", 0, 0, false);
        declareFunction(me, "rkf_ar_act_note_rejected_concepts", "RKF-AR-ACT-NOTE-REJECTED-CONCEPTS", 3, 0, false);
        declareFunction(me, "rkf_ar_act_note_surrogate_replacement", "RKF-AR-ACT-NOTE-SURROGATE-REPLACEMENT", 3, 0, false);
        declareFunction(me, "rkf_ar_act_note_one_surrogate_replacement", "RKF-AR-ACT-NOTE-ONE-SURROGATE-REPLACEMENT", 4, 0, false);
        declareFunction(me, "rkf_ar_act_propagate_surrogate_replacement", "RKF-AR-ACT-PROPAGATE-SURROGATE-REPLACEMENT", 4, 0, false);
        declareMacro(me, "rkf_ar_with_additional_constraints", "RKF-AR-WITH-ADDITIONAL-CONSTRAINTS");
        declareFunction(me, "rkf_ar_has_additional_constraintsP", "RKF-AR-HAS-ADDITIONAL-CONSTRAINTS?", 0, 0, false);
        declareFunction(me, "rkf_ar_act_note_accepted_concept", "RKF-AR-ACT-NOTE-ACCEPTED-CONCEPT", 2, 1, false);
        declareFunction(me, "rkf_ar_concept_covers_entire_phraseP", "RKF-AR-CONCEPT-COVERS-ENTIRE-PHRASE?", 2, 0, false);
        declareFunction(me, "rkf_ar_act_resolve_context_references", "RKF-AR-ACT-RESOLVE-CONTEXT-REFERENCES", 2, 0, false);
        declareFunction(me, "rkf_ar_act_optimize_concept_cycl", "RKF-AR-ACT-OPTIMIZE-CONCEPT-CYCL", 2, 0, false);
        declareFunction(me, "rkf_ar_act_instantiate_template", "RKF-AR-ACT-INSTANTIATE-TEMPLATE", 4, 0, false);
        declareFunction(me, "rkf_ar_act_add_template", "RKF-AR-ACT-ADD-TEMPLATE", 2, 0, false);
        declareFunction(me, "rkf_ar_formula_choice_template", "RKF-AR-FORMULA-CHOICE-TEMPLATE", 1, 0, false);
        declareFunction(me, "rkf_ar_act_update_templates", "RKF-AR-ACT-UPDATE-TEMPLATES", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_candidate_cycl", "RKF-AR-ACT-NOTE-CANDIDATE-CYCL", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_candidate_assertion", "RKF-AR-ACT-NOTE-CANDIDATE-ASSERTION", 2, 0, false);
        declareFunction(me, "rkf_ar_act_note_candidate_query", "RKF-AR-ACT-NOTE-CANDIDATE-QUERY", 2, 0, false);
        declareFunction(me, "rkf_ar_act_assert_concept", "RKF-AR-ACT-ASSERT-CONCEPT", 2, 0, false);
        declareFunction(me, "rkf_ar_act_reject_assert_concept", "RKF-AR-ACT-REJECT-ASSERT-CONCEPT", 2, 0, false);
        declareFunction(me, "ar_pragmatic_relation_p", "AR-PRAGMATIC-RELATION-P", 1, 0, false);
        declareFunction(me, "ar_sentence_tokens_from_index_list", "AR-SENTENCE-TOKENS-FROM-INDEX-LIST", 2, 0, false);
        declareFunction(me, "rkf_ar_some_subsuming_phrase", "RKF-AR-SOME-SUBSUMING-PHRASE", 2, 0, false);
        declareFunction(me, "rkf_ar_phrase_subsumed", "RKF-AR-PHRASE-SUBSUMED", 2, 0, false);
        declareFunction(me, "rkf_ar_assertible_concept", "RKF-AR-ASSERTIBLE-CONCEPT", 1, 1, false);
        declareFunction(me, "rkf_ar_assertible_cycl", "RKF-AR-ASSERTIBLE-CYCL", 2, 0, false);
        declareFunction(me, "rkf_relation_template", "RKF-RELATION-TEMPLATE", 1, 0, false);
        declareFunction(me, "rkf_ar_update_all_template_choices", "RKF-AR-UPDATE-ALL-TEMPLATE-CHOICES", 1, 0, false);
        declareFunction(me, "rkf_ar_update_template_choices_for_template", "RKF-AR-UPDATE-TEMPLATE-CHOICES-FOR-TEMPLATE", 2, 0, false);
        declareFunction(me, "rkf_ar_update_template_choices_for_concept", "RKF-AR-UPDATE-TEMPLATE-CHOICES-FOR-CONCEPT", 2, 0, false);
        declareFunction(me, "rkf_ar_update_template_choices_for_template_and_concept", "RKF-AR-UPDATE-TEMPLATE-CHOICES-FOR-TEMPLATE-AND-CONCEPT", 3, 0, false);
        declareFunction(me, "rkf_ar_resolve_context_references", "RKF-AR-RESOLVE-CONTEXT-REFERENCES", 2, 1, false);
        declareFunction(me, "rkf_ar_context_reference_p", "RKF-AR-CONTEXT-REFERENCE-P", 1, 0, false);
        declareFunction(me, "rkf_ar_contains_context_references", "RKF-AR-CONTAINS-CONTEXT-REFERENCES", 1, 0, false);
        declareFunction(me, "rkf_ar_gather_context_references", "RKF-AR-GATHER-CONTEXT-REFERENCES", 1, 0, false);
        declareFunction(me, "rkf_ar_resolve_one_context_reference", "RKF-AR-RESOLVE-ONE-CONTEXT-REFERENCE", 2, 1, false);
        declareFunction(me, "rkf_ar_resolve_the_spec_reference", "RKF-AR-RESOLVE-THE-SPEC-REFERENCE", 2, 1, false);
        declareFunction(me, "rkf_ar_resolve_the_instance_reference", "RKF-AR-RESOLVE-THE-INSTANCE-REFERENCE", 2, 1, false);
        declareFunction(me, "rkf_ar_term_agglomerator", "RKF-AR-TERM-AGGLOMERATOR", 1, 2, false);
        declareFunction(me, "rkf_ar_ta_internal", "RKF-AR-TA-INTERNAL", 3, 0, false);
        declareFunction(me, "rkf_ar_ta_new_relation", "RKF-AR-TA-NEW-RELATION", 3, 0, false);
        declareFunction(me, "rkf_ar_ta_new_term", "RKF-AR-TA-NEW-TERM", 4, 0, false);
        declareFunction(me, "rkf_ar_ta_new_relation_arg", "RKF-AR-TA-NEW-RELATION-ARG", 5, 0, false);
        declareFunction(me, "rkf_ar_ta_assign_args_recursive", "RKF-AR-TA-ASSIGN-ARGS-RECURSIVE", 5, 0, false);
        declareFunction(me, "rkf_ar_ta_answer", "RKF-AR-TA-ANSWER", 3, 0, false);
        declareFunction(me, "rkf_ar_ta_admitted_argument", "RKF-AR-TA-ADMITTED-ARGUMENT", 4, 0, false);
        declareFunction(me, "rkf_ar_ta_admitted_formula", "RKF-AR-TA-ADMITTED-FORMULA", 2, 0, false);
        declareFunction(me, "clear_relation_args_sorted_by_restriction", "CLEAR-RELATION-ARGS-SORTED-BY-RESTRICTION", 0, 0, false);
        declareFunction(me, "remove_relation_args_sorted_by_restriction", "REMOVE-RELATION-ARGS-SORTED-BY-RESTRICTION", 1, 0, false);
        declareFunction(me, "relation_args_sorted_by_restriction_internal", "RELATION-ARGS-SORTED-BY-RESTRICTION-INTERNAL", 1, 0, false);
        declareFunction(me, "relation_args_sorted_by_restriction", "RELATION-ARGS-SORTED-BY-RESTRICTION", 1, 0, false);
        declareFunction(me, "clear_all_relation_args", "CLEAR-ALL-RELATION-ARGS", 0, 0, false);
        declareFunction(me, "remove_all_relation_args", "REMOVE-ALL-RELATION-ARGS", 1, 0, false);
        declareFunction(me, "all_relation_args_internal", "ALL-RELATION-ARGS-INTERNAL", 1, 0, false);
        declareFunction(me, "all_relation_args", "ALL-RELATION-ARGS", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $ar_sentence_native extends SubLStructNative {
        ...
        public $ar_sentence_native() {
            this.$id = Lisp.NIL;
            this.$plaintext = Lisp.NIL;
            this.$token_vector = Lisp.NIL;
            this.$clarifications = Lisp.NIL;
            this.$source_sentence = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative(rkf_assisted_reader.$ar_sentence_native.class, AR_SENTENCE, AR_SENTENCE_P, $list5, $list6, new String[]{ "$id", "$plaintext", "$token_vector", "$clarifications", "$source_sentence", "$phrases" }, $list7, $list8, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $ar_token_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_assisted_reader.$ar_token_native.class, AR_TOKEN, AR_TOKEN_P, $list41, $list42, new String[]{ "$id", "$text", "$sentence", "$number", "$phrases" }, $list43, $list44, PRINT_AR_TOKEN);
        }
    }
    ...
    public static final class $ar_phrase_native extends SubLStructNative {
        ...
        public $ar_phrase_native() {
            ...
            this.$token_list = Lisp.NIL;
            this.$sentence = Lisp.NIL;
            this.$concepts = Lisp.NIL;
            this.$rejected_concepts = Lisp.NIL;
            this.$disambiguated_concept = Lisp.NIL;
            this.$surrogate = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative(rkf_assisted_reader.$ar_phrase_native.class, AR_PHRASE, AR_PHRASE_P, $list66, $list67, new String[]{ "$id", "$status", "$token_list", "$sentence", "$concepts", "$rejected_concepts", "$disambiguated_concept", "$surrogate", "$constraint", "$force" }, $list68, $list69, PRINT_AR_PHRASE);
        }
    }
    ...
    public static final class $ar_concept_native extends SubLStructNative {
        ...
        public $ar_concept_native() {
            this.$id = Lisp.NIL;
            this.$cycl = Lisp.NIL;
            this.$disambiguation_text = Lisp.NIL;
            this.$phrases = Lisp.NIL;
            this.$parts = Lisp.NIL;
            this.$agglomerations = Lisp.NIL;
            this.$force = Lisp.NIL;
            this.$confidence = Lisp.NIL;
            this.$open_term_score = Lisp.NIL;
        }
        ...
        static {
            structDecl = makeStructDeclNative(rkf_assisted_reader.$ar_concept_native.class, AR_CONCEPT, AR_CONCEPT_P, $list115, $list116, new String[]{ "$id", "$cycl", "$disambiguation_text", "$phrases", "$parts", "$agglomerations", "$force", "$confidence", "$open_term_score" }, $list117, $list118, PRINT_AR_CONCEPT);
        }
    }
    ...
    public static final class $ar_template_native extends SubLStructNative {
        ...
        public $ar_template_native() {
            this.$id = Lisp.NIL;
            this.$concept = Lisp.NIL;
            this.$formula = Lisp.NIL;
            this.$prompt = Lisp.NIL;
            this.$choice_table = Lisp.NIL;
            this.$agglomerations = Lisp.NIL;
        }
        ...
        static {
            structDecl = makeStructDeclNative(rkf_assisted_reader.$ar_template_native.class, AR_TEMPLATE, AR_TEMPLATE_P, $list153, $list154, new String[]{ "$id", "$concept", "$formula", "$prompt", "$choice_table", "$agglomerations" }, $list155, $list156, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $ar_state_native extends SubLStructNative {
        ...
        public $ar_state_native() {
            this.$isg = Lisp.NIL;
            this.$index = Lisp.NIL;
            this.$source_sentences = Lisp.NIL;
            this.$focus_sentence = Lisp.NIL;
            this.$completed_sentences = Lisp.NIL;
            this.$unknown_phrases = Lisp.NIL;
            this.$rejected_phrases = Lisp.NIL;
            this.$irrelevant_phrases = Lisp.NIL;
            this.$ambiguous_phrases = Lisp.NIL;
            this.$assumed_phrases = Lisp.NIL;
            this.$pending_phrases = Lisp.NIL;
            this.$accepted_phrases = Lisp.NIL;
            this.$pending_concepts = Lisp.NIL;
            this.$accepted_concepts = Lisp.NIL;
            this.$candidate_cycls = Lisp.NIL;
            this.$asserted_assertions = Lisp.NIL;
            this.$term_templates = Lisp.NIL;
            this.$assert_templates = Lisp.NIL;
        }
