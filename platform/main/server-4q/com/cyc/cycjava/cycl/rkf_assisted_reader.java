...
public final class rkf_assisted_reader
    extends
      SubLTranslatedFile
{
  ...
  {
    assert NIL != ar_sentence_p( v_object ) : v_object;
  ...
  public static SubLObject make_ar_sentence(SubLObject arglist)
  {
    ...
    final SubLObject v_new = new $ar_sentence_native();
    SubLObject next;
    ...
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      else if( pcase_var.eql( $kw25$PLAINTEXT ) )
      {
        _csetf_ar_sentence_plaintext( v_new, current_value );
      }
      else if( pcase_var.eql( $kw26$TOKEN_VECTOR ) )
      {
        _csetf_ar_sentence_token_vector( v_new, current_value );
      }
      else if( pcase_var.eql( $kw27$CLARIFICATIONS ) )
      {
        _csetf_ar_sentence_clarifications( v_new, current_value );
      }
      else if( pcase_var.eql( $kw28$SOURCE_SENTENCE ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw31$BEGIN, $sym32$MAKE_AR_SENTENCE, SIX_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw24$ID, ar_sentence_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw25$PLAINTEXT, ar_sentence_plaintext( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw26$TOKEN_VECTOR, ar_sentence_token_vector( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw27$CLARIFICATIONS, ar_sentence_clarifications( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw28$SOURCE_SENTENCE, ar_sentence_source_sentence( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw29$PHRASES, ar_sentence_phrases( obj ) );
    Functions.funcall( visitor_fn, obj, $kw34$END, $sym32$MAKE_AR_SENTENCE, SIX_INTEGER );
    return obj;
  }
  ...
  public static SubLObject new_ar_sentence(final SubLObject state, final SubLObject plaintext)
  {
    ...
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
    ...
    finally
    {
      if( NIL != release )
      {
        Locks.release_lock( $ar_lock$.getGlobalValue() );
      }
    }
    return sentence;
  }
  ...
  {
    assert NIL != ar_sentence_p( sentence ) : sentence;
    assert NIL != Types.vectorp( token_vector ) : token_vector;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
  ...
  {
    assert NIL != ar_sentence_p( sentence ) : sentence;
    assert NIL != ar_phrase_p( phrase ) : phrase;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( phrase, ar_sentence_phrases( sentence ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_sentence_phrases( sentence, ConsesLow.cons( phrase, ar_sentence_phrases( sentence ) ) );
      }
    }
    finally
    {
  ...
  {
    assert NIL != ar_sentence_p( sentence ) : sentence;
    assert NIL != ar_sentence_p( clarification ) : clarification;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( clarification, ar_sentence_clarifications( sentence ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_sentence_clarifications( sentence, ConsesLow.cons( clarification, ar_sentence_clarifications( sentence ) ) );
      }
    }
    finally
    {
  ...
  {
    assert NIL != ar_token_p( v_object ) : v_object;
    return v_object.getField2();
  }
  ...
  public static SubLObject make_ar_token(SubLObject arglist)
  {
    ...
    final SubLObject v_new = new $ar_token_native();
    SubLObject next;
    SubLObject current_arg;
    SubLObject current_value;
    SubLObject pcase_var;
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      else if( pcase_var.eql( $kw58$TEXT ) )
      {
        _csetf_ar_token_text( v_new, current_value );
      }
      else if( pcase_var.eql( $kw59$SENTENCE ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw31$BEGIN, $sym61$MAKE_AR_TOKEN, FIVE_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw24$ID, ar_token_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw58$TEXT, ar_token_text( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw59$SENTENCE, ar_token_sentence( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw60$NUMBER, ar_token_number( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw29$PHRASES, ar_token_phrases( obj ) );
    Functions.funcall( visitor_fn, obj, $kw34$END, $sym61$MAKE_AR_TOKEN, FIVE_INTEGER );
    return obj;
  }
  ...
  {
    PrintLow.format( stream, $str63$_A_, ar_token_text( v_object ) );
    return v_object;
  }
  ...
  {
    assert NIL != ar_token_p( token ) : token;
    assert NIL != ar_phrase_p( phrase ) : phrase;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( phrase, ar_token_phrases( token ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_token_phrases( token, ConsesLow.cons( phrase, ar_token_phrases( token ) ) );
      }
    }
    finally
    {
  ...
  {
    assert NIL != ar_phrase_p( v_object ) : v_object;
    return v_object.getField2();
  }
  ...
  public static SubLObject make_ar_phrase(SubLObject arglist)
  {
    ...
    final SubLObject v_new = new $ar_phrase_native();
    SubLObject next;
    SubLObject current_arg;
    SubLObject current_value;
    SubLObject pcase_var;
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      else if( pcase_var.eql( $kw93$STATUS ) )
      {
        _csetf_ar_phrase_status( v_new, current_value );
      }
      else if( pcase_var.eql( $kw94$TOKEN_LIST ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw31$BEGIN, $sym101$MAKE_AR_PHRASE, TEN_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw24$ID, ar_phrase_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw93$STATUS, ar_phrase_status( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw94$TOKEN_LIST, ar_phrase_token_list( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw59$SENTENCE, ar_phrase_sentence( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw95$CONCEPTS, ar_phrase_concepts( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw96$REJECTED_CONCEPTS, ar_phrase_rejected_concepts( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw97$DISAMBIGUATED_CONCEPT, ar_phrase_disambiguated_concept( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw98$SURROGATE, ar_phrase_surrogate( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw99$CONSTRAINT, ar_phrase_constraint( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw100$FORCE, ar_phrase_force( obj ) );
    Functions.funcall( visitor_fn, obj, $kw34$END, $sym101$MAKE_AR_PHRASE, TEN_INTEGER );
    return obj;
  }
  ...
  public static SubLObject print_ar_phrase(final SubLObject v_object, final SubLObject stream, final SubLObject depth)
  {
    ...
    PrintLow.format( stream, $str103$_AR_PHRASE__D_, ar_phrase_id( v_object ) );
    SubLObject cdolist_list_var = token_list;
    SubLObject token = NIL;
    token = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      streams_high.write_string( ar_token_text( token ), stream, UNPROVIDED, UNPROVIDED );
      streams_high.write_char( Characters.CHAR_space, stream );
      cdolist_list_var = cdolist_list_var.rest();
      token = cdolist_list_var.first();
    }
    streams_high.write_string( $str104$_, stream, UNPROVIDED, UNPROVIDED );
    return v_object;
  }
  ...
  {
    assert NIL != ar_sentence_p( sentence ) : sentence;
    assert NIL != Types.listp( token_list ) : token_list;
  ...
  {
    assert NIL != ar_phrase_p( phrase ) : phrase;
    assert NIL != ar_concept_p( concept ) : concept;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( concept, ar_phrase_concepts( phrase ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_phrase_concepts( phrase, ConsesLow.cons( concept, ar_phrase_concepts( phrase ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject remove_ar_phrase_concept(final SubLObject phrase, final SubLObject concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_phrase_concepts( phrase, Sequences.remove( concept, ar_phrase_concepts( phrase ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_phrase_rejected_concept(final SubLObject phrase, final SubLObject concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( concept, ar_phrase_rejected_concepts( phrase ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_phrase_rejected_concepts( phrase, ConsesLow.cons( concept, ar_phrase_rejected_concepts( phrase ) ) );
      }
    }
    finally
    {
  ...
  {
    assert NIL != ar_phrase_p( phrase ) : phrase;
    assert NIL != ar_concept_p( surrogate ) : surrogate;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      SubLObject surrogates = ar_phrase_surrogate( phrase );
      surrogates = ConsesLow.cons( surrogate, surrogates );
  ...
  public static SubLObject compute_ar_phrase_force(final SubLObject phrase, SubLObject default_sentenceP, SubLObject mt)
  {
    ...
    final SubLObject last_token = ar_token_text( conses_high.last( token_list, UNPROVIDED ).first() );
    ...
    try
    {
      ...
      {
        result = $kw110$QUESTION;
      }
      else if( NIL != string_utilities.ends_with( last_token, $str111$_, UNPROVIDED ) )
      {
        result = $kw112$DECLARATIVE;
      }
      else if( NIL != default_sentenceP && NIL != lexicon_accessors.string_is_form_of_aux_verbP( first_token, UNPROVIDED, UNPROVIDED ) )
      {
        result = $kw110$QUESTION;
      }
      else if( NIL != default_sentenceP )
      {
        result = $kw112$DECLARATIVE;
      }
      else
  ...
  {
    assert NIL != ar_concept_p( v_object ) : v_object;
    return v_object.getField2();
  }
  ...
  public static SubLObject make_ar_concept(SubLObject arglist)
  {
    ...
    final SubLObject v_new = new $ar_concept_native();
    SubLObject next;
    SubLObject current_arg;
    SubLObject current_value;
    SubLObject pcase_var;
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      else if( pcase_var.eql( $kw140$CYCL ) )
      {
        _csetf_ar_concept_cycl( v_new, current_value );
      }
      else if( pcase_var.eql( $kw141$DISAMBIGUATION_TEXT ) )
      {
      ...
      else if( pcase_var.eql( $kw142$PARTS ) )
      {
        _csetf_ar_concept_parts( v_new, current_value );
      }
      else if( pcase_var.eql( $kw143$AGGLOMERATIONS ) )
      {
      ...
      else if( pcase_var.eql( $kw144$CONFIDENCE ) )
      {
        _csetf_ar_concept_confidence( v_new, current_value );
      }
      else if( pcase_var.eql( $kw145$OPEN_TERM_SCORE ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw31$BEGIN, $sym146$MAKE_AR_CONCEPT, NINE_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw24$ID, ar_concept_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw140$CYCL, ar_concept_cycl( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw141$DISAMBIGUATION_TEXT, ar_concept_disambiguation_text( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw29$PHRASES, ar_concept_phrases( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw142$PARTS, ar_concept_parts( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw143$AGGLOMERATIONS, ar_concept_agglomerations( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw100$FORCE, ar_concept_force( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw144$CONFIDENCE, ar_concept_confidence( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw145$OPEN_TERM_SCORE, ar_concept_open_term_score( obj ) );
    Functions.funcall( visitor_fn, obj, $kw34$END, $sym146$MAKE_AR_CONCEPT, NINE_INTEGER );
    return obj;
  }
  ...
  {
    PrintLow.format( stream, $str148$__AR_CONCEPT__S__S_, ar_concept_id( v_object ), ar_concept_cycl( v_object ) );
    return v_object;
  }
  ...
  public static SubLObject rkf_ar_act_clone_augment_concept(final SubLObject state, final SubLObject src_concept, final SubLObject interpretation)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        things_to_toss = ConsesLow.cons( part, things_to_toss );
      }
      cdolist_list_var = cdolist_list_var.rest();
      part = cdolist_list_var.first();
    }
  ...
  public static SubLObject add_ar_concept_phrase(final SubLObject concept, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( phrase, ar_concept_phrases( concept ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_concept_phrases( concept, ConsesLow.cons( phrase, ar_concept_phrases( concept ) ) );
      }
    }
    finally
    {
  ...
  {
    assert NIL != ar_concept_p( concept ) : concept;
    assert NIL != ar_concept_p( part_concept ) : part_concept;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( part_concept, ar_concept_parts( concept ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_concept_parts( concept, ConsesLow.cons( part_concept, ar_concept_parts( concept ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_concept_part(final SubLObject concept, final SubLObject part_concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_concept_parts( concept, Sequences.delete( part_concept, ar_concept_parts( concept ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  {
    assert NIL != ar_concept_p( concept ) : concept;
    assert NIL != ar_concept_p( agglomeration ) : agglomeration;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( agglomeration, ar_concept_agglomerations( concept ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_concept_agglomerations( concept, ConsesLow.cons( agglomeration, ar_concept_agglomerations( concept ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_concept_agglomeration(final SubLObject concept, final SubLObject agglomeration)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_concept_agglomerations( concept, Sequences.delete( agglomeration, ar_concept_agglomerations( concept ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject subst_ar_concept_cycl(final SubLObject concept, final SubLObject v_new, final SubLObject old)
  {
    ...
    final SubLObject new_cycl = conses_high.subst( v_new, old, original_cycl, Symbols.symbol_function( EQUAL ), UNPROVIDED );
  ...
  {
    return ( ar_concept_force( concept ) == $kw110$QUESTION ) ? $kw110$QUESTION : NIL;
  }
  ...
  {
    return ( ar_concept_force( concept ) == $kw112$DECLARATIVE ) ? $kw112$DECLARATIVE : NIL;
  }
  ...
  {
    assert NIL != ar_template_p( v_object ) : v_object;
    return v_object.getField2();
  }
  ...
  public static SubLObject make_ar_template(SubLObject arglist)
  {
    ...
    final SubLObject v_new = new $ar_template_native();
    SubLObject next;
    SubLObject current_arg;
    SubLObject current_value;
    SubLObject pcase_var;
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      else if( pcase_var.eql( $kw171$CONCEPT ) )
      {
        _csetf_ar_template_concept( v_new, current_value );
      }
      else if( pcase_var.eql( $kw172$FORMULA ) )
      {
        _csetf_ar_template_formula( v_new, current_value );
      }
      else if( pcase_var.eql( $kw173$PROMPT ) )
      {
        _csetf_ar_template_prompt( v_new, current_value );
      }
      else if( pcase_var.eql( $kw174$CHOICE_TABLE ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw31$BEGIN, $sym175$MAKE_AR_TEMPLATE, SIX_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw24$ID, ar_template_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw171$CONCEPT, ar_template_concept( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw172$FORMULA, ar_template_formula( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw173$PROMPT, ar_template_prompt( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw174$CHOICE_TABLE, ar_template_choice_table( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw143$AGGLOMERATIONS, ar_template_agglomerations( obj ) );
    Functions.funcall( visitor_fn, obj, $kw34$END, $sym175$MAKE_AR_TEMPLATE, SIX_INTEGER );
    return obj;
  }
  ...
  {
    assert NIL != ar_template_p( template ) : template;
    assert NIL != Types.consp( formula ) : formula;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
  ...
  {
    assert NIL != ar_template_p( template ) : template;
    assert NIL != Types.consp( prompt ) : prompt;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
  ...
  {
    assert NIL != ar_template_p( template ) : template;
    assert NIL != Types.consp( choice_table ) : choice_table;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
  ...
  public static SubLObject add_ar_template_agglomeration(final SubLObject template, final SubLObject agglomeration)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( agglomeration, ar_template_agglomerations( template ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_template_agglomerations( template, ConsesLow.cons( agglomeration, ar_template_agglomerations( template ) ) );
      }
    }
    finally
    {
  ...
  {
    assert NIL != ar_state_p( v_object ) : v_object;
    return v_object.getField2();
  }
  ...
  public static SubLObject make_ar_state(SubLObject arglist)
  {
    ...
    final SubLObject v_new = new $ar_state_native();
    SubLObject next;
    SubLObject current_arg;
    SubLObject current_value;
    SubLObject pcase_var;
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw31$BEGIN, $sym241$MAKE_AR_STATE, EIGHTEEN_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw223$ISG, ar_state_isg( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw224$INDEX, ar_state_index( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw225$SOURCE_SENTENCES, ar_state_source_sentences( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw226$FOCUS_SENTENCE, ar_state_focus_sentence( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw227$COMPLETED_SENTENCES, ar_state_completed_sentences( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw228$UNKNOWN_PHRASES, ar_state_unknown_phrases( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw229$REJECTED_PHRASES, ar_state_rejected_phrases( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw230$IRRELEVANT_PHRASES, ar_state_irrelevant_phrases( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw231$AMBIGUOUS_PHRASES, ar_state_ambiguous_phrases( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw232$ASSUMED_PHRASES, ar_state_assumed_phrases( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw233$PENDING_PHRASES, ar_state_pending_phrases( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw234$ACCEPTED_PHRASES, ar_state_accepted_phrases( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw235$PENDING_CONCEPTS, ar_state_pending_concepts( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw236$ACCEPTED_CONCEPTS, ar_state_accepted_concepts( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw237$CANDIDATE_CYCLS, ar_state_candidate_cycls( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw238$ASSERTED_ASSERTIONS, ar_state_asserted_assertions( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw239$TERM_TEMPLATES, ar_state_term_templates( obj ) );
    Functions.funcall( visitor_fn, obj, $kw33$SLOT, $kw240$ASSERT_TEMPLATES, ar_state_assert_templates( obj ) );
    Functions.funcall( visitor_fn, obj, $kw34$END, $sym241$MAKE_AR_STATE, EIGHTEEN_INTEGER );
    return obj;
  }
  ...
  {
    assert NIL != ar_state_p( state ) : state;
  ...
  public static SubLObject add_ar_state_source_sentence(final SubLObject state, final SubLObject sentence)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( sentence, ar_state_source_sentences( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_source_sentences( state, ConsesLow.cons( sentence, ar_state_source_sentences( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject ar_state_force(final SubLObject state)
  {
    ...
    final SubLObject sorted_phrases = Sort.sort( conses_high.copy_list( phrases ), $sym243$AR_PHRASE_SPAN_LENGTH_, UNPROVIDED );
    if( NIL == force )
    {
      ...
      while ( NIL == force && NIL != csome_list_var)
      {
        ...
        if( NIL != phrase_force && phrase_force != $kw113$NONE )
        {
          force = phrase_force;
        }
  ...
  public static SubLObject add_ar_state_completed_sentence(final SubLObject state, final SubLObject sentence)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( sentence, ar_state_completed_sentences( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_completed_sentences( state, ConsesLow.cons( sentence, ar_state_completed_sentences( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject add_ar_state_unknown_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( phrase, ar_state_unknown_phrases( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_unknown_phrases( state, ConsesLow.cons( phrase, ar_state_unknown_phrases( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_unknown_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_unknown_phrases( state, Sequences.delete( phrase, ar_state_unknown_phrases( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_rejected_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( phrase, ar_state_rejected_phrases( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_rejected_phrases( state, ConsesLow.cons( phrase, ar_state_rejected_phrases( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_rejected_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_rejected_phrases( state, Sequences.delete( phrase, ar_state_rejected_phrases( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_irrelevant_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( phrase, ar_state_irrelevant_phrases( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_irrelevant_phrases( state, ConsesLow.cons( phrase, ar_state_irrelevant_phrases( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_irrelevant_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_irrelevant_phrases( state, Sequences.delete( phrase, ar_state_irrelevant_phrases( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_ambiguous_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( phrase, ar_state_ambiguous_phrases( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_ambiguous_phrases( state, ConsesLow.cons( phrase, ar_state_ambiguous_phrases( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_ambiguous_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_ambiguous_phrases( state, Sequences.delete( phrase, ar_state_ambiguous_phrases( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_assumed_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( phrase, ar_state_assumed_phrases( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_assumed_phrases( state, ConsesLow.cons( phrase, ar_state_assumed_phrases( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_assumed_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_assumed_phrases( state, Sequences.delete( phrase, ar_state_assumed_phrases( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_pending_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( phrase, ar_state_pending_phrases( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_pending_phrases( state, ConsesLow.cons( phrase, ar_state_pending_phrases( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_pending_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_pending_phrases( state, Sequences.delete( phrase, ar_state_pending_phrases( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_accepted_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( phrase, ar_state_accepted_phrases( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_accepted_phrases( state, ConsesLow.cons( phrase, ar_state_accepted_phrases( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_accepted_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_accepted_phrases( state, Sequences.delete( phrase, ar_state_accepted_phrases( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_accepted_concept(final SubLObject state, final SubLObject concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( concept, ar_state_accepted_concepts( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_accepted_concepts( state, ConsesLow.cons( concept, ar_state_accepted_concepts( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_accepted_concept(final SubLObject state, final SubLObject concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_accepted_concepts( state, Sequences.delete( concept, ar_state_accepted_concepts( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_pending_concept(final SubLObject state, final SubLObject concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( concept, ar_state_pending_concepts( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_pending_concepts( state, ConsesLow.cons( concept, ar_state_pending_concepts( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_pending_concept(final SubLObject state, final SubLObject concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_pending_concepts( state, Sequences.delete( concept, ar_state_pending_concepts( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_candidate_cycl(final SubLObject state, final SubLObject concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( concept, ar_state_candidate_cycls( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_candidate_cycls( state, ConsesLow.cons( concept, ar_state_candidate_cycls( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject add_ar_state_candidate_assertion(final SubLObject state, final SubLObject concept)
  {
    assert NIL != ar_state_p( state ) : state;
    assert NIL != ar_concept_p( concept ) : concept;
    _csetf_ar_concept_force( concept, $kw112$DECLARATIVE );
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
  ...
  public static SubLObject add_ar_state_candidate_query(final SubLObject state, final SubLObject concept)
  {
    assert NIL != ar_state_p( state ) : state;
    assert NIL != ar_concept_p( concept ) : concept;
    _csetf_ar_concept_force( concept, $kw110$QUESTION );
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
  ...
  public static SubLObject rem_ar_state_candidate_assertion(final SubLObject state, final SubLObject concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_candidate_cycls( state, Sequences.delete( concept, ar_state_candidate_cycls( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_asserted_assertion(final SubLObject state, final SubLObject concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( concept, ar_state_asserted_assertions( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_asserted_assertions( state, ConsesLow.cons( concept, ar_state_asserted_assertions( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_asserted_assertion(final SubLObject state, final SubLObject concept)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_asserted_assertions( state, Sequences.delete( concept, ar_state_asserted_assertions( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_term_template(final SubLObject state, final SubLObject template)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( template, ar_state_term_templates( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_term_templates( state, ConsesLow.cons( template, ar_state_term_templates( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_term_template(final SubLObject state, final SubLObject template)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_term_templates( state, Sequences.delete( template, ar_state_term_templates( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject add_ar_state_assert_template(final SubLObject state, final SubLObject template)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      if( NIL == conses_high.member( template, ar_state_assert_templates( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_ar_state_assert_templates( state, ConsesLow.cons( template, ar_state_assert_templates( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject rem_ar_state_assert_template(final SubLObject state, final SubLObject template)
  {
    ...
    {
      release = Locks.seize_lock( $ar_lock$.getGlobalValue() );
      _csetf_ar_state_assert_templates( state, Sequences.delete( template, ar_state_assert_templates( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  public static SubLObject ar_source_sentence_number(final SubLObject state, final SubLObject sentence)
  {
    if( NIL != ar_source_sentence_p( sentence ) )
    {
      ...
      return Numbers.subtract( total, Sequences.position( sentence, source_sentences, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    return NIL;
  }
  ...
  public static SubLObject ar_clarification_sentence_number(final SubLObject state, final SubLObject clarification)
  {
    if( NIL != ar_clarification_sentence_p( clarification ) )
    {
      ...
      return Numbers.subtract( total, Sequences.position( clarification, clarifications, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    return NIL;
  }
  ...
  public static SubLObject ar_determine_concept_sentences(final SubLObject concept)
  {
    ...
    sentences = Sort.sort( sentences, Symbols.symbol_function( $sym246$_ ), Symbols.symbol_function( $sym12$AR_SENTENCE_ID ) );
    return sentences;
  }
  ...
  public static SubLObject ar_determine_concept_sentences_recursive(final SubLObject concept, SubLObject sentences)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == conses_high.member( item_var, sentences, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
  ...
  {
    return Sequences.count( sentence, ar_state_assumed_phrases( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( $sym79$AR_PHRASE_SENTENCE ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject ar_state_next_assumed_phrase(final SubLObject state)
  {
    ...
    if( NIL != sentence )
    {
      ...
      if( NIL != Sequences.find( $kw247$ASSUMED, phrases, Symbols.symbol_function( EQL ), Symbols.symbol_function( $sym75$AR_PHRASE_STATUS ), UNPROVIDED, UNPROVIDED ) )
      {
        return list_utilities.extremal( Sequences.remove( $kw247$ASSUMED, phrases, Symbols.symbol_function( $sym248$NOT_EQL ), Symbols.symbol_function( $sym75$AR_PHRASE_STATUS ), UNPROVIDED, UNPROVIDED, UNPROVIDED ),
            Symbols.symbol_function( $sym246$_ ), Symbols.symbol_function( $sym73$AR_PHRASE_ID ) );
      }
    }
    return NIL;
  }
  ...
  public static SubLObject ar_state_next_unknown_phrase(final SubLObject state)
  {
    ...
    {
      final SubLObject phrases = ar_sentence_phrases( sentence );
      if( NIL != Sequences.find( $kw249$UNKNOWN, phrases, Symbols.symbol_function( EQL ), Symbols.symbol_function( $sym75$AR_PHRASE_STATUS ), UNPROVIDED, UNPROVIDED ) )
      {
        return list_utilities.extremal( Sequences.remove( $kw249$UNKNOWN, phrases, Symbols.symbol_function( $sym248$NOT_EQL ), Symbols.symbol_function( $sym75$AR_PHRASE_STATUS ), UNPROVIDED, UNPROVIDED, UNPROVIDED ),
            Symbols.symbol_function( $sym246$_ ), Symbols.symbol_function( $sym73$AR_PHRASE_ID ) );
      }
    }
    return NIL;
  ...
  public static SubLObject ar_state_select_most_promising_unknown_phrase(final SubLObject state)
  {
    ...
    if( NIL != sentence )
    {
      ...
      if( NIL != Sequences.find( $kw249$UNKNOWN, phrases, Symbols.symbol_function( EQL ), Symbols.symbol_function( $sym75$AR_PHRASE_STATUS ), UNPROVIDED, UNPROVIDED ) )
      {
        final SubLObject unknown_phrases = Sequences.remove( $kw249$UNKNOWN, phrases, Symbols.symbol_function( $sym248$NOT_EQL ), Symbols.symbol_function( $sym75$AR_PHRASE_STATUS ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
          ...
          while ( NIL != cdolist_list_var_$1)
          {
            ...
            while ( NIL != cdolist_list_var_$2)
            {
              if( NIL != subl_promotions.memberP( pending_concept, ar_concept_agglomerations( surrogate ), UNPROVIDED, UNPROVIDED ) )
              {
                ...
                if( NIL == conses_high.member( item_var, choices, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
                {
                  choices = ConsesLow.cons( item_var, choices );
                }
              }
  ...
  public static SubLObject ar_state_pending_implied_indexicals(final SubLObject state)
  {
    ...
    final SubLObject phrases = ar_sentence_phrases( sentence );
    if( NIL != Sequences.find( $kw251$PENDING, phrases, EQL, $sym75$AR_PHRASE_STATUS, UNPROVIDED, UNPROVIDED ) )
    {
      final SubLObject pending_phrases = Sequences.remove( $kw251$PENDING, phrases, $sym248$NOT_EQL, $sym75$AR_PHRASE_STATUS, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      SubLObject choices = NIL;
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        {
          choices = ConsesLow.cons( ConsesLow.list( concept, entity, rkf_discourse_tracking.rkf_disc_resolve_entity( entity, cycl, discourse_context ) ), choices );
        }
        cdolist_list_var = cdolist_list_var.rest();
        phrase = cdolist_list_var.first();
      }
  ...
  {
    return Sequences.count( sentence, ar_state_ambiguous_phrases( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( $sym79$AR_PHRASE_SENTENCE ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject ar_state_next_ambiguous_phrase(final SubLObject state)
  {
    ...
    {
      final SubLObject phrases = ar_sentence_phrases( sentence );
      if( NIL != Sequences.find( $kw253$AMBIGUOUS, phrases, Symbols.symbol_function( EQL ), Symbols.symbol_function( $sym75$AR_PHRASE_STATUS ), UNPROVIDED, UNPROVIDED ) )
      {
        return list_utilities.extremal( Sequences.remove( $kw253$AMBIGUOUS, phrases, Symbols.symbol_function( $sym248$NOT_EQL ), Symbols.symbol_function( $sym75$AR_PHRASE_STATUS ), UNPROVIDED, UNPROVIDED, UNPROVIDED ),
            Symbols.symbol_function( $sym246$_ ), Symbols.symbol_function( $sym73$AR_PHRASE_ID ) );
      }
    }
    return NIL;
  ...
  {
    return Sequences.count( sentence, ar_state_candidate_assertions( state ), Symbols.symbol_function( $sym254$MEMBER ), Symbols.symbol_function( $sym255$AR_DETERMINE_CONCEPT_SENTENCES ), UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return Sequences.count( sentence, ar_state_candidate_queries( state ), Symbols.symbol_function( $sym254$MEMBER ), Symbols.symbol_function( $sym255$AR_DETERMINE_CONCEPT_SENTENCES ), UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return Sequences.count( sentence, ar_state_asserted_assertions( state ), Symbols.symbol_function( $sym254$MEMBER ), Symbols.symbol_function( $sym255$AR_DETERMINE_CONCEPT_SENTENCES ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject ar_concept_dependent_on_surrogate_p(final SubLObject concept, SubLObject depth)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != ar_concept_dependent_on_surrogate_p( part, Numbers.add( ONE_INTEGER, depth ) ) )
      {
        return T;
      }
      cdolist_list_var = cdolist_list_var.rest();
  ...
  public static SubLObject with_new_ar_concept_grounding_map(final SubLObject macroform, final SubLObject environment)
  {
    ...
    final SubLObject body;
    final SubLObject current = body = datum;
    return ConsesLow.list( $sym256$CLET, $list257, $list258, reader.bq_cons( $sym259$PROGN, ConsesLow.append( body, NIL ) ) );
  }
  ...
  public static SubLObject ar_concept_grounding_computedP(final SubLObject map, final SubLObject concept)
  {
    ...
    return makeBoolean( $kw260$GROUNDED == mark || $kw261$UNGROUNDED == mark );
  }
  ...
  {
    return Equality.eq( $kw260$GROUNDED, dictionary.dictionary_lookup( map, concept, UNPROVIDED ) );
  }
  ...
  {
    return Equality.eq( $kw261$UNGROUNDED, dictionary.dictionary_lookup( map, concept, UNPROVIDED ) );
  }
  ...
  {
    return Equality.eq( $kw262$IN_PROGRESS, dictionary.dictionary_lookup( map, concept, UNPROVIDED ) );
  }
  ...
  public static SubLObject ar_concept_dependent_on_ungrounded_surrogate_count(final SubLObject concept)
  {
    ...
    final SubLObject cycl = ar_concept_cycl( concept );
    if( NIL == cycl_utilities.expression_find( $const264$TheResultOfParsing, cycl, UNPROVIDED, UNPROVIDED, UNPROVIDED ) )
    {
      ar_concept_grounding_map_mark( map, concept, $kw260$GROUNDED );
      return ZERO_INTEGER;
    }
    ...
    {
      ar_concept_grounding_map_mark( map, concept, $kw261$UNGROUNDED );
      return $ar_concept_cycle_count$.getGlobalValue();
    }
    ar_concept_grounding_map_mark( map, concept, $kw262$IN_PROGRESS );
    if( NIL != parsing_utilities.result_of_parsing_formulaP( cycl ) )
    {
      ...
      if( NIL == groundedP )
      {
        ...
        SubLObject phrase;
        for( csome_list_var = ar_concept_phrases( concept ), phrase = NIL, phrase = csome_list_var.first(); NIL == groundedP && NIL != csome_list_var; groundedP = makeBoolean(
            NIL == ar_phrase_dependent_on_ungrounded_surrogate_p( phrase ) ), csome_list_var = csome_list_var.rest(), phrase = csome_list_var.first() )
        {
        }
      }
      final SubLObject value = ( NIL != groundedP ) ? ZERO_INTEGER : ONE_INTEGER;
      final SubLObject mark = ( NIL != groundedP ) ? $kw260$GROUNDED : $kw261$UNGROUNDED;
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        ungrounded_part_count = Numbers.add( ungrounded_part_count, ONE_INTEGER );
      }
      cdolist_list_var = cdolist_list_var.rest();
      part = cdolist_list_var.first();
    }
    ar_concept_grounding_map_mark( map, concept, ungrounded_part_count.isZero() ? $kw260$GROUNDED : $kw261$UNGROUNDED );
  ...
  public static SubLObject ar_phrase_dependent_on_ungrounded_surrogate_p(final SubLObject phrase)
  {
    ...
    if( NIL == groundedP )
    {
      SubLObject csome_list_var;
      SubLObject concept;
      for( csome_list_var = Sequences.cconcatenate( ar_phrase_rejected_concepts( phrase ), ar_phrase_concepts( phrase ) ), concept = NIL, concept = csome_list_var.first(); NIL == groundedP
          && NIL != csome_list_var; groundedP = ar_concept_dependent_on_ungrounded_surrogate_p( concept ), groundedP = makeBoolean( NIL == groundedP ), csome_list_var = csome_list_var.rest(), concept = csome_list_var
              .first() )
      {
      }
    }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return Equality.eq( num, $ar_divide_best$.getDynamicValue( thread ) );
  }
  ...
  public static SubLObject ar_phrase_divide_concepts(final SubLObject phrase, final SubLObject indexicals)
  {
    ...
    sorted = Sort.stable_sort( conses_high.copy_list( ar_phrase_concepts( phrase ) ), $sym246$_, $sym136$AR_CONCEPT_CONFIDENCE );
    sorted = Sort.stable_sort( sorted, $sym265$_, $sym266$AR_CONCEPT_COMPLEXITY );
    sorted = Sort.stable_sort( sorted, $sym246$_, $sym138$AR_CONCEPT_OPEN_TERM_SCORE );
    if( NIL != indexicals )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        {
          nthfn_terms = ConsesLow.cons( concept, nthfn_terms );
        }
        else
        {
          temp_rest = ConsesLow.cons( concept, temp_rest );
        }
        cdolist_list_var = cdolist_list_var.rest();
        concept = cdolist_list_var.first();
      }
    ...
    if( NIL == likely )
    {
      ...
      try
      {
        ...
        final SubLObject best_index = list_utilities.position_if_not( $sym267$AR_PHRASE_DIVIDE_EQ_BEST_LAMBDA_SUBSTITUTE, sorted, $sym138$AR_CONCEPT_OPEN_TERM_SCORE, UNPROVIDED, UNPROVIDED );
        if( NIL != best_index )
        {
          likely = Sequences.subseq( sorted, ZERO_INTEGER, best_index );
          unlikely = Sequences.subseq( sorted, best_index, UNPROVIDED );
        }
        else
        {
          likely = sorted;
  ...
  public static SubLObject ar_concept_separate_out_forts(final SubLObject terms)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        v_forts = ConsesLow.cons( v_term, v_forts );
      }
      else
      {
        others = ConsesLow.cons( v_term, others );
      }
      cdolist_list_var = cdolist_list_var.rest();
      v_term = cdolist_list_var.first();
    }
    ...
    return Values.values( Sequences.nreverse( others ), NIL );
  }
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      while ( NIL != cdolist_list_var_$4)
      {
        if( NIL != subl_promotions.memberP( agglomerated, ar_state_pending_concepts( state ), UNPROVIDED, UNPROVIDED ) )
        {
          ...
          if( NIL == el_utilities.el_conjunction_p( constrained_by ) )
          {
            constrained_by = simplifier.nconjoin( ConsesLow.list( constrained_by ), UNPROVIDED );
          }
          SubLObject cdolist_list_var_$5;
          final SubLObject args = cdolist_list_var_$5 = cycl_utilities.formula_args( constrained_by, $kw268$IGNORE );
          SubLObject conjunct = NIL;
          conjunct = cdolist_list_var_$5.first();
          while ( NIL != cdolist_list_var_$5)
          {
            if( $const269$isa.equal( cycl_utilities.formula_arg0( conjunct ) ) )
            {
            ...
            else if( $const270$genls.equal( cycl_utilities.formula_arg0( conjunct ) ) )
            {
              final SubLObject collection = cycl_utilities.formula_arg2( conjunct, UNPROVIDED );
              if( NIL == rkf_relevance_utilities.rkf_irrelevant_arg_constraint( collection, domain_mt ) )
              {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    subl_promotions.make_process_with_args( $str271$Assisted_Reader_reading_texts, Symbols.symbol_function( $sym272$RKF_AR_ACT_ADD_SOURCE_TEXTS_BACKGROUND_INTERNAL ), ConsesLow.list( state, texts, $rkf_ar_parsing_mt$
  ...
  public static SubLObject rkf_ar_act_add_source_texts_background_internal(final SubLObject state, final SubLObject texts, final SubLObject mt)
  {
    ...
    try
    {
      thread.throwStack.push( $kw273$IGNORE_ERRORS_TARGET );
      final SubLObject _prev_bind_0 = Errors.$error_handler$.currentBinding( thread );
      try
      {
        Errors.$error_handler$.bind( Symbols.symbol_function( $sym274$IGNORE_ERRORS_HANDLER ), thread );
        try
        {
    ...
    {
      ignore_errors_tag = Errors.handleThrowable( ccatch_env_var, $kw273$IGNORE_ERRORS_TARGET );
    }
    finally
    {
  ...
  {
    assert NIL != ar_state_p( state ) : state;
    assert NIL != Types.listp( texts ) : texts;
  ...
  public static SubLObject rkf_ar_act_add_rewrite_texts_background(final SubLObject state, final SubLObject sentence, final SubLObject texts)
  {
    ...
    if( NIL != texts )
    {
      ...
      if( NIL != rest_texts )
      {
        subl_promotions.make_process_with_args( $str276$Assisted_Reader_rewriting_a_sente, Symbols.symbol_function( $sym277$RKF_AR_ACT_ADD_REWRITE_TEXTS_BACKGROUND_INTERNAL ), ConsesLow.list( state, sentence, rest_texts,
            $rkf_ar_parsing_mt$.getDynamicValue( thread ) ) );
      }
    }
    return NIL;
  }
  ...
  public static SubLObject rkf_ar_select_processing_method()
  {
    ...
    if( pcase_var.eql( $kw282$TEXT_PROCESSING ) )
    {
      return Values.values( $rkf_ar_text_processor$.getGlobalValue(), ConsesLow.list( $rkf_ar_parsing_mt$.getDynamicValue( thread ), $rkf_ar_semantics_mt$.getDynamicValue( thread ) ) );
    }
    if( pcase_var.eql( $kw283$QUESTION_PROCESSING ) )
    {
      return Values.values( $rkf_ar_question_processor$.getGlobalValue(), ConsesLow.list( $rkf_ar_parsing_mt$.getDynamicValue( thread ), $rkf_ar_semantics_mt$.getDynamicValue( thread ) ) );
    }
    return Values.values( $rkf_ar_concept_harvester$.getGlobalValue(), NIL );
  }
  ...
  public static SubLObject rkf_ar_act_process_input_sentence(final SubLObject text)
  {
    ...
    thread.resetMultipleValues();
    return Values.values( Functions.apply( function, ConsesLow.cons( text, args ) ), rkf_ar_template_category_for_processor( function ) );
  }
  ...
  public static SubLObject rkf_ar_template_category_for_processor(final SubLObject function)
  {
    ...
    return conses_high.second( conses_high.assoc( function, alist, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject rkf_ar_act_add_text(final SubLObject state, final SubLObject text, SubLObject source_sentence, SubLObject v_parse_tree)
  {
    ...
    assert NIL != ar_state_p( state ) : state;
    assert NIL != Types.stringp( text ) : text;
    assert NIL != Types.listp( v_parse_tree ) : v_parse_tree;
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      token_list = ConsesLow.cons( token, token_list );
      token_number = Numbers.add( token_number, ONE_INTEGER );
      cdolist_list_var = cdolist_list_var.rest();
      token_string = cdolist_list_var.first();
    }
    token_list = Sequences.nreverse( token_list );
    final SubLObject token_vector = Functions.apply( Symbols.symbol_function( $sym284$VECTOR ), token_list );
  ...
  public static SubLObject rkf_ar_concept_check_trivial_differences(SubLObject alist, final SubLObject concept)
  {
    ...
    final SubLObject associate = conses_high.assoc( cleaned_concept, alist, EQUALP, UNPROVIDED );
    if( NIL != associate )
    {
      ...
      else
      {
        ...
        ConsesLow.rplacd( associate, ConsesLow.list( concept ) );
      }
    }
    else
    {
      alist = ConsesLow.cons( ConsesLow.list( cleaned_concept, concept ), alist );
    }
    return alist;
  }
  ...
  {
    return conses_high.subst_if( $kw285$UNINTERESTING, $sym286$RTP_TEMPLATE_CATEGORY_, cycl, UNPROVIDED );
  }
  ...
  public static SubLObject rkf_ar_harvest_for_phrases_and_concepts(final SubLObject state, final SubLObject sentence, final SubLObject text, final SubLObject v_parse_tree)
  {
    ...
    final SubLObject visited = set.new_set( Symbols.symbol_function( EQUALP ), UNPROVIDED );
    SubLObject iterator_stack = ConsesLow.list( rtp_iterators.new_itp_root_children_iterator( result_iterator ) );
      ...
      if( NIL == rtp_iterators.itp_child_iterator_doneP( child_iterator ) )
      {
        ...
        while ( NIL == rtp_iterators.itp_child_iterator_doneP( child_iterator ))
        {
          ...
          while ( NIL != cdolist_list_var)
          {
            ...
            {
              iterator_stack = ConsesLow.cons( rtp_iterators.new_itp_child_iterator( result_iterator, rop_formula ), iterator_stack );
          ...
          new_concepts = ConsesLow.cons( concept, new_concepts );
          ...
          note_ar_phrase_status( phrase, $kw113$NONE );
  ...
  {
    return transform_list_utilities.transform( cycl, $sym288$UNKNOWN_INSTANCE_INDEXED_EXPRESSION_, $sym289$ROP_FROM_UNKNOWN_INSTANCE_INDEXED_FN, UNPROVIDED );
  }
      ...
      if( NIL != surrogate_cycl_terms )
      {
        ...
        while ( NIL != cdolist_list_var_$14)
        {
          ...
          if( NIL == surrogate )
          {
            ...
            new_surrogates = ConsesLow.cons( surrogate, new_surrogates );
  ...
  {
    return Sequences.find( tokens, new_phrases, Symbols.symbol_function( EQUAL ), Symbols.symbol_function( $sym77$AR_PHRASE_TOKEN_LIST ), UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return Sequences.find( surrogate_cycl, new_surrogates, Symbols.symbol_function( EQUALP ), Symbols.symbol_function( $sym124$AR_CONCEPT_CYCL ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject rkf_ar_update_surrogates(final SubLObject surrogate, final SubLObject phrase)
  {
    ...
    if( NIL != rkf_concept_harvester.rkf_ch_gather_parsing_surrogates( ar_concept_cycl( surrogate ) ) )
    {
      if( NIL == foundP )
      {
        SubLObject csome_list_var;
        SubLObject concept;
        for( csome_list_var = ar_phrase_concepts( phrase ), concept = NIL, concept = csome_list_var.first(); NIL == foundP && NIL != csome_list_var; foundP = Equality.equalp( ar_concept_cycl( surrogate ),
            ar_concept_cycl( concept ) ), csome_list_var = csome_list_var.rest(), concept = csome_list_var.first() )
        {
  ...
  public static SubLObject rkf_ar_add_surrogate_sans_children(final SubLObject state, final SubLObject sentence, final SubLObject surrogate_tokens, final SubLObject surrogate)
  {
    ...
    note_ar_phrase_status( unknown_phrase, $kw249$UNKNOWN );
        ...
        while ( NIL != cdolist_list_var_$15)
        {
          if( NIL != surrogate && NIL != rkf_concept_harvester.rkf_ch_parsing_surrogate_p( ar_concept_cycl( surrogate ) ) )
          {
            ...
            if( NIL != Strings.string_equal( utterance, string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) )
            {
              ...
              add_ar_phrase_concept( phrase, concept );
              if( $kw249$UNKNOWN == ar_phrase_status( phrase ) )
              {
  ...
  {
    if( ar_phrase_status( phrase ) == $kw247$ASSUMED )
    {
      rem_ar_state_assumed_phrase( state, phrase );
      rkf_ar_act_note_ambiguous( state, phrase );
    }
    if( ar_phrase_status( phrase ) == $kw253$AMBIGUOUS )
    {
    ...
    if( ar_phrase_status( phrase ) == $kw249$UNKNOWN )
    {
      rem_ar_state_unknown_phrase( state, phrase );
  ...
  {
    if( NIL != rkf_ar_some_subsuming_phrase( phrase, ar_state_accepted_phrases( state ) ) || NIL != rkf_ar_some_subsuming_phrase( phrase, ar_state_assumed_phrases( state ) ) || NIL != rkf_ar_some_subsuming_phrase(
        phrase, ar_state_ambiguous_phrases( state ) ) || NIL != rkf_ar_some_subsuming_phrase( phrase, ar_state_irrelevant_phrases( state ) ) || NIL != rkf_ar_some_subsuming_phrase( phrase, ar_state_pending_phrases(
            state ) ) )
    {
  ...
  {
    note_ar_phrase_status( phrase, $kw293$IRRELEVANT );
  ...
  {
    note_ar_phrase_disambiguated_concept( phrase, concept );
    note_ar_phrase_status( phrase, $kw247$ASSUMED );
    add_ar_state_assumed_phrase( state, phrase );
    return state;
  }
  ...
  {
    clear_ar_phrase_disambiguated_concept( phrase );
    note_ar_phrase_status( phrase, $kw253$AMBIGUOUS );
  ...
  public static SubLObject rkf_ar_act_note_accepted_phrase(final SubLObject state, final SubLObject phrase)
  {
    ...
    else if( NIL != ar_concept_dependent_on_surrogate_p( concept, UNPROVIDED ) )
    {
      ...
      note_ar_phrase_status( phrase, $kw251$PENDING );
    ...
    {
      note_ar_phrase_status( phrase, $kw294$ACCEPTED );
  ...
  {
    if( $kw247$ASSUMED == ar_phrase_status( phrase ) )
    {
      rem_ar_state_assumed_phrase( state, phrase );
      final SubLObject concepts = ar_phrase_concepts( phrase );
      if( NIL != list_utilities.singletonP( concepts ) )
      {
        clear_ar_phrase_disambiguated_concept( phrase );
        note_ar_phrase_status( phrase, $kw295$REJECTED );
    ...
    else if( $kw253$AMBIGUOUS == ar_phrase_status( phrase ) )
    {
      rem_ar_state_ambiguous_phrase( state, phrase );
      note_ar_phrase_status( phrase, $kw295$REJECTED );
      add_ar_state_rejected_phrase( state, phrase );
  ...
  public static SubLObject rkf_ar_act_reconsider_irrelevant(final SubLObject state, final SubLObject phrase)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        reconsider_phrases = ConsesLow.cons( irrelevant_phrase, reconsider_phrases );
      }
      cdolist_list_var = cdolist_list_var.rest();
      irrelevant_phrase = cdolist_list_var.first();
    }
  ...
  {
    return makeBoolean( cycl.isCons() && $const296$RewriteSequenceFn.eql( cycl_utilities.formula_operator( cycl ) ) );
  }
  ...
  public static SubLObject rkf_ar_act_note_phrase_completed(final SubLObject state, final SubLObject phrase)
  {
    ...
    if( pcase_var.eql( $kw249$UNKNOWN ) )
    {
      rem_ar_state_unknown_phrase( state, phrase );
    }
    else if( pcase_var.eql( $kw295$REJECTED ) )
    {
      rem_ar_state_rejected_phrase( state, phrase );
    }
    else if( pcase_var.eql( $kw293$IRRELEVANT ) )
    {
      rem_ar_state_irrelevant_phrase( state, phrase );
    }
    else if( pcase_var.eql( $kw253$AMBIGUOUS ) )
    {
      rem_ar_state_ambiguous_phrase( state, phrase );
    }
    else if( pcase_var.eql( $kw247$ASSUMED ) )
    {
      rem_ar_state_assumed_phrase( state, phrase );
    }
    else if( pcase_var.eql( $kw251$PENDING ) )
    {
      rem_ar_state_pending_phrase( state, phrase );
    }
    else if( pcase_var.eql( $kw294$ACCEPTED ) )
    {
  ...
  public static SubLObject rkf_ar_act_note_pending_concept(final SubLObject state, final SubLObject concept)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != ar_surrogate_concept_p( part ) )
      {
        ...
        if( NIL != ar_phrase_p( surrogate_phrase ) && $kw293$IRRELEVANT == ar_phrase_status( surrogate_phrase ) )
        {
  ...
  public static SubLObject rkf_ar_act_propagate_one_surrogate_constraint(final SubLObject state, final SubLObject phrase, final SubLObject agglomeration, final SubLObject surrogate)
  {
    ...
    if( $kw253$AMBIGUOUS == ar_phrase_status( phrase ) )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        if( NIL == rkf_ar_nthfn_termP( concept_cycl ) && NIL == rkf_ar_unfailable_constraintP( constraint ) && NIL == rkf_ar_possibly_reformulatableP( concept_cycl ) && NIL == rkf_ar_possibly_reformulatableP(
            agglomeration_cycl ) && NIL == backward.removal_ask( ConsesLow.list( $const297$elementOf, concept_cycl, constraint ), $rkf_ar_parsing_mt$.getDynamicValue( thread ), UNPROVIDED, UNPROVIDED ) )
        {
          rejected_concepts = ConsesLow.cons( concept, rejected_concepts );
        }
        cdolist_list_var = cdolist_list_var.rest();
        concept = cdolist_list_var.first();
      }
    ...
    {
      note_ar_phrase_status( phrase, $kw298$NO_DISAMBIGS );
    }
    return phrase;
  }
  ...
  public static SubLObject rkf_ar_nthfn_termP(final SubLObject cycl)
  {
    ...
    return Equality.eq( cycl_utilities.formula_arg0( formula ), $const299$TheNthFn );
  }
  ...
  {
    return makeBoolean( NIL != el_utilities.formula_arityE( constraint, TWO_INTEGER, UNPROVIDED ) && cycl_utilities.formula_arg0( constraint ).eql( $const300$TheSetOf ) && cycl_utilities.formula_arg0( cycl_utilities
        .formula_arg2( constraint, UNPROVIDED ) ).eql( $const269$isa ) && cycl_utilities.formula_arg2( cycl_utilities.formula_arg2( constraint, UNPROVIDED ), UNPROVIDED ).eql( $const301$Thing ) );
  }
  ...
  public static SubLObject initialize_rkf_reformulatable_terms()
  {
    ...
    try
    {
      ...
      SubLObject cdolist_list_var;
      final SubLObject terms = cdolist_list_var = ConsesLow.nconc( $list304, gt_methods.gt_all_inferiors( $const305$genlFunctions, $const306$NLTagFn, UNPROVIDED ), isa.all_fort_instances( $const307$NLUtteranceAttribute,
  ...
  public static SubLObject rkf_ar_with_additional_constraints(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      final SubLObject body;
      current = ( body = temp );
      return ConsesLow.listS( $sym256$CLET, ConsesLow.list( ConsesLow.list( $sym310$_RKF_AR_ADDITIONAL_CONSTRAINTS_, constraints ) ), ConsesLow.append( body, NIL ) );
    }
  ...
  public static SubLObject rkf_ar_act_note_accepted_concept(final SubLObject state, final SubLObject concept, SubLObject phrase)
  {
    ...
    if( NIL != list_utilities.singletonP( concepts ) )
    {
      ...
      final SubLObject existing = Sequences.find( cycl, ar_state_accepted_concepts( state ), Symbols.symbol_function( EQUAL ), Symbols.symbol_function( $sym124$AR_CONCEPT_CYCL ), UNPROVIDED, UNPROVIDED );
      if( NIL == existing )
      {
  ...
  public static SubLObject rkf_ar_act_resolve_context_references(final SubLObject state, final SubLObject concept)
  {
    ...
    if( NIL != el_utilities.el_formula_p( original_cycl ) )
    {
  ...
  public static SubLObject rkf_ar_act_optimize_concept_cycl(final SubLObject state, final SubLObject concept)
  {
    ...
    SubLObject concepts = ConsesLow.list( concept );
    ...
    if( NIL != el_utilities.el_formula_p( original_cycl ) )
    {
      ...
      {
        SubLObject optimizations = ( force == $kw110$QUESTION ) ? rkf_formula_optimizer.rkf_reformulate_query_formula( optimized_cycl, $rkf_ar_parsing_mt$.getDynamicValue( thread ), $rkf_ar_additional_constraints$
            .getDynamicValue( thread ) ) : rkf_formula_optimizer.rkf_reformulate_assert_formula( optimized_cycl, $rkf_ar_parsing_mt$.getDynamicValue( thread ), $rkf_ar_additional_constraints$.getDynamicValue( thread ) );
        SubLObject doneP = NIL;
        while ( NIL == doneP)
        {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          concepts = ConsesLow.cons( new_concept, concepts );
          cdolist_list_var = cdolist_list_var.rest();
          optimized = cdolist_list_var.first();
        }
      }
  ...
  public static SubLObject rkf_ar_formula_choice_template(final SubLObject formula)
  {
    ...
    {
      SubLObject choice_template = list_utilities.parse_to_list_of_strings( formatted_formula, Characters.CHAR_colon, Characters.CHAR_space );
      choice_template = transform_list_utilities.transform( choice_template, Symbols.symbol_function( $sym311$KEYWORD_IMPOSTOR_P ), Symbols.symbol_function( $sym312$KEYWORD_FROM_IMPOSTOR ), UNPROVIDED );
  ...
  {
    return Sequences.find( phrase, other_phrases, Symbols.symbol_function( $sym314$RKF_AR_PHRASE_SUBSUMED ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject rkf_ar_phrase_subsumed(final SubLObject phrase, final SubLObject other_phrase)
  {
    ...
    if( NIL != phrase_token_list )
    {
      ...
      {
        return conses_high.subsetp( phrase_token_list, other_phrase_token_list, UNPROVIDED, UNPROVIDED );
      }
    }
    return NIL;
  }
  ...
  {
    return makeBoolean( NIL != el_utilities.el_formula_p( v_term ) && NIL != isa.isaP( cycl_utilities.formula_arg0( v_term ), $const315$TruthFunction, mt, UNPROVIDED ) );
  }
  ...
  public static SubLObject rkf_ar_update_template_choices_for_template_and_concept(final SubLObject state, final SubLObject template, final SubLObject concept)
  {
    ...
    for( i = NIL, i = ZERO_INTEGER; i.numL( v_arity ); i = Numbers.add( i, ONE_INTEGER ) )
    {
      ...
      assoc_list_for_arg = conses_high.assoc( arg_keyword, old_choice_table, UNPROVIDED, UNPROVIDED );
      choice_table_list_for_arg = NIL;
      if( assoc_list_for_arg.isCons() )
      {
        choice_table_list_for_arg = conses_high.second( assoc_list_for_arg );
      }
      if( NIL != rkf_ar_ta_admitted_argument( v_term, arg, relation, $rkf_ar_parsing_mt$.getDynamicValue( thread ) ) && NIL == conses_high.member( concept, choice_table_list_for_arg, Symbols.symbol_function( EQL ),
          Symbols.symbol_function( IDENTITY ) ) )
      {
        choice_table_list_for_arg = ConsesLow.cons( concept, choice_table_list_for_arg );
      }
      new_choice_table = ConsesLow.cons( ConsesLow.list( arg_keyword, choice_table_list_for_arg ), new_choice_table );
    }
  ...
  public static SubLObject rkf_ar_resolve_context_references(final SubLObject state, SubLObject cycl, SubLObject mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL != referent )
      {
        cycl = conses_high.subst( referent, context_reference, cycl, Symbols.symbol_function( EQUAL ), UNPROVIDED );
      }
      cdolist_list_var = cdolist_list_var.rest();
      context_reference = cdolist_list_var.first();
    }
  ...
  {
    return list_utilities.tree_find_if( Symbols.symbol_function( $sym317$RKF_AR_CONTEXT_REFERENCE_P ), obj, UNPROVIDED );
  }
  ...
  {
    return list_utilities.tree_gather( obj, Symbols.symbol_function( $sym317$RKF_AR_CONTEXT_REFERENCE_P ), Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject rkf_ar_resolve_one_context_reference(final SubLObject state, final SubLObject context_reference, SubLObject mt)
  {
    ...
    if( pcase_var.eql( $const318$TheSpec ) )
    {
      return rkf_ar_resolve_the_spec_reference( state, context_reference, mt );
    }
    if( pcase_var.eql( $const319$TheInstance ) )
    {
        ...
        if( NIL == rkf_ar_assertible_cycl( new_term, mt ) || NIL == rkf_ar_ta_admitted_formula( new_term, mt ) )
        {
          ...
          else
          {
            ...
            while ( NIL != cdolist_list_var)
            {
              ...
              {
                final SubLObject other_terms = Sequences.remove( relation, old_terms, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject rkf_ar_ta_new_relation(final SubLObject relation, final SubLObject old_terms, final SubLObject mt)
  {
    ...
    if( NIL != arg )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        {
          final SubLObject other_terms = Sequences.remove( old_term, old_terms, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject rkf_ar_ta_new_relation_arg(final SubLObject relation, final SubLObject arg, final SubLObject v_term, final SubLObject other_terms, final SubLObject mt)
  {
    ...
    final SubLObject other_args = Sequences.remove( arg, relation_arguments, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    final SubLObject initial_assignments = ConsesLow.list( ConsesLow.cons( v_term, arg ) );
  ...
  public static SubLObject rkf_ar_ta_assign_args_recursive(final SubLObject relation, final SubLObject terms, final SubLObject args, final SubLObject assignments, final SubLObject mt)
  {
    ...
    else if( NIL != terms )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        {
          final SubLObject assignment = ConsesLow.cons( v_term, next_arg );
          final SubLObject other_terms = Sequences.remove( v_term, terms, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          final SubLObject new_assignments = ConsesLow.cons( assignment, assignments );
  ...
  public static SubLObject rkf_ar_ta_answer(final SubLObject relation, SubLObject assignments, final SubLObject mt)
  {
    ...
    assignments = Sort.sort( assignments, Symbols.symbol_function( $sym246$_ ), Symbols.symbol_function( $sym320$CDR ) );
    final SubLObject formula_args = Mapping.mapcar( Symbols.symbol_function( $sym321$CAR ), assignments );
    final SubLObject formula = el_utilities.make_el_formula( relation, formula_args, UNPROVIDED );
    if( NIL == list_utilities.tree_find( relation, formula_args, Symbols.symbol_function( EQUAL ), UNPROVIDED ) && NIL != rkf_ar_ta_admitted_formula( formula, mt ) )
    {
      control_vars.$mapping_answer$.setDynamicValue( ConsesLow.cons( formula, control_vars.$mapping_answer$.getDynamicValue( thread ) ), thread );
    }
    return NIL;
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $relation_args_sorted_by_restriction_caching_state$.getGlobalValue(), ConsesLow.list( relation ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject relation_args_sorted_by_restriction_internal(final SubLObject relation)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      arg_pairs = ConsesLow.cons( ConsesLow.list( arg, arg_generality ), arg_pairs );
      cdolist_list_var = cdolist_list_var.rest();
      arg = cdolist_list_var.first();
    }
    arg_pairs = Sort.sort( arg_pairs, Symbols.symbol_function( $sym246$_ ), Symbols.symbol_function( $sym323$SECOND ) );
  ...
  public static SubLObject relation_args_sorted_by_restriction(final SubLObject relation)
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym322$RELATION_ARGS_SORTED_BY_RESTRICTION, $sym324$_RELATION_ARGS_SORTED_BY_RESTRICTION_CACHING_STATE_, $int325$64, EQL, ONE_INTEGER,
          TEN_INTEGER );
    }
    ...
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( relation_args_sorted_by_restriction_internal( relation ) ) );
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $all_relation_args_caching_state$.getGlobalValue(), ConsesLow.list( relation ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject all_relation_args_internal(final SubLObject relation)
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym327$RELEVANT_MT_IS_EVERYTHING, thread );
      mt_relevance_macros.$mt$.bind( $const328$EverythingPSC, thread );
      SubLObject v_arity = arity.arity( relation );
      if( NIL == v_arity )
      {
        v_arity = arity.min_arity( relation );
      ...
      if( NIL != v_arity )
      {
        ...
        for( i = NIL, i = ZERO_INTEGER; i.numL( v_arity ); i = Numbers.add( i, ONE_INTEGER ) )
        {
          v_answer = ConsesLow.cons( Numbers.add( i, ONE_INTEGER ), v_answer );
        }
      }
    }
    finally
  ...
  public static SubLObject all_relation_args(final SubLObject relation)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym326$ALL_RELATION_ARGS, $sym329$_ALL_RELATION_ARGS_CACHING_STATE_, $int325$64, EQL, ONE_INTEGER, TEN_INTEGER );
    }
    SubLObject results = memoization_state.caching_state_lookup( caching_state, relation, memoization_state.$memoized_item_not_found$.getGlobalValue() );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( all_relation_args_internal( relation ) ) );
      memoization_state.caching_state_put( caching_state, relation, results, UNPROVIDED );
    }
    return memoization_state.caching_results( results );
  }
  ...
  {
    SubLFiles.declareMacro( me, "with_ar_lock", "WITH-AR-LOCK" );
    SubLFiles.declareFunction( me, "ar_sentence_print_function_trampoline", "AR-SENTENCE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_p", "AR-SENTENCE-P", 1, 0, false );
    new $ar_sentence_p$UnaryFunction();
    SubLFiles.declareFunction( me, "ar_sentence_id", "AR-SENTENCE-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_plaintext", "AR-SENTENCE-PLAINTEXT", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_token_vector", "AR-SENTENCE-TOKEN-VECTOR", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_clarifications", "AR-SENTENCE-CLARIFICATIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_source_sentence", "AR-SENTENCE-SOURCE-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_phrases", "AR-SENTENCE-PHRASES", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_sentence_id", "_CSETF-AR-SENTENCE-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_sentence_plaintext", "_CSETF-AR-SENTENCE-PLAINTEXT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_sentence_token_vector", "_CSETF-AR-SENTENCE-TOKEN-VECTOR", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_sentence_clarifications", "_CSETF-AR-SENTENCE-CLARIFICATIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_sentence_source_sentence", "_CSETF-AR-SENTENCE-SOURCE-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_sentence_phrases", "_CSETF-AR-SENTENCE-PHRASES", 2, 0, false );
    SubLFiles.declareFunction( me, "make_ar_sentence", "MAKE-AR-SENTENCE", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_ar_sentence", "VISIT-DEFSTRUCT-AR-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_ar_sentence_method", "VISIT-DEFSTRUCT-OBJECT-AR-SENTENCE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "sxhash_ar_sentence_method", "SXHASH-AR-SENTENCE-METHOD", 1, 0, false );
    SubLFiles.declareFunction( me, "new_ar_sentence", "NEW-AR-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_sentence_token_vector", "NOTE-AR-SENTENCE-TOKEN-VECTOR", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_sentence_phrase", "ADD-AR-SENTENCE-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_sentence_clarification", "ADD-AR-SENTENCE-CLARIFICATION", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_sentence_source_sentence", "NOTE-AR-SENTENCE-SOURCE-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_token_print_function_trampoline", "AR-TOKEN-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_token_p", "AR-TOKEN-P", 1, 0, false );
    new $ar_token_p$UnaryFunction();
    SubLFiles.declareFunction( me, "ar_token_id", "AR-TOKEN-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_token_text", "AR-TOKEN-TEXT", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_token_sentence", "AR-TOKEN-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_token_number", "AR-TOKEN-NUMBER", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_token_phrases", "AR-TOKEN-PHRASES", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_token_id", "_CSETF-AR-TOKEN-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_token_text", "_CSETF-AR-TOKEN-TEXT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_token_sentence", "_CSETF-AR-TOKEN-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_token_number", "_CSETF-AR-TOKEN-NUMBER", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_token_phrases", "_CSETF-AR-TOKEN-PHRASES", 2, 0, false );
    SubLFiles.declareFunction( me, "make_ar_token", "MAKE-AR-TOKEN", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_ar_token", "VISIT-DEFSTRUCT-AR-TOKEN", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_ar_token_method", "VISIT-DEFSTRUCT-OBJECT-AR-TOKEN-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "print_ar_token", "PRINT-AR-TOKEN", 3, 0, false );
    SubLFiles.declareFunction( me, "sxhash_ar_token_method", "SXHASH-AR-TOKEN-METHOD", 1, 0, false );
    SubLFiles.declareFunction( me, "new_ar_token", "NEW-AR-TOKEN", 4, 0, false );
    SubLFiles.declareFunction( me, "add_ar_token_phrase", "ADD-AR-TOKEN-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_print_function_trampoline", "AR-PHRASE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_p", "AR-PHRASE-P", 1, 0, false );
    new $ar_phrase_p$UnaryFunction();
    SubLFiles.declareFunction( me, "ar_phrase_id", "AR-PHRASE-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_status", "AR-PHRASE-STATUS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_token_list", "AR-PHRASE-TOKEN-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_sentence", "AR-PHRASE-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_concepts", "AR-PHRASE-CONCEPTS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_rejected_concepts", "AR-PHRASE-REJECTED-CONCEPTS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_disambiguated_concept", "AR-PHRASE-DISAMBIGUATED-CONCEPT", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_surrogate", "AR-PHRASE-SURROGATE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_constraint", "AR-PHRASE-CONSTRAINT", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_force", "AR-PHRASE-FORCE", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_phrase_id", "_CSETF-AR-PHRASE-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_phrase_status", "_CSETF-AR-PHRASE-STATUS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_phrase_token_list", "_CSETF-AR-PHRASE-TOKEN-LIST", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_phrase_sentence", "_CSETF-AR-PHRASE-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_phrase_concepts", "_CSETF-AR-PHRASE-CONCEPTS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_phrase_rejected_concepts", "_CSETF-AR-PHRASE-REJECTED-CONCEPTS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_phrase_disambiguated_concept", "_CSETF-AR-PHRASE-DISAMBIGUATED-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_phrase_surrogate", "_CSETF-AR-PHRASE-SURROGATE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_phrase_constraint", "_CSETF-AR-PHRASE-CONSTRAINT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_phrase_force", "_CSETF-AR-PHRASE-FORCE", 2, 0, false );
    SubLFiles.declareFunction( me, "make_ar_phrase", "MAKE-AR-PHRASE", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_ar_phrase", "VISIT-DEFSTRUCT-AR-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_ar_phrase_method", "VISIT-DEFSTRUCT-OBJECT-AR-PHRASE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "print_ar_phrase", "PRINT-AR-PHRASE", 3, 0, false );
    SubLFiles.declareFunction( me, "sxhash_ar_phrase_method", "SXHASH-AR-PHRASE-METHOD", 1, 0, false );
    SubLFiles.declareFunction( me, "new_ar_phrase", "NEW-AR-PHRASE", 3, 0, false );
    SubLFiles.declareFunction( me, "add_ar_phrase_concept", "ADD-AR-PHRASE-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_ar_phrase_concept", "REMOVE-AR-PHRASE-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_phrase_rejected_concept", "ADD-AR-PHRASE-REJECTED-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_ar_phrase_disambiguated_concept", "CLEAR-AR-PHRASE-DISAMBIGUATED-CONCEPT", 1, 0, false );
    SubLFiles.declareFunction( me, "note_ar_phrase_disambiguated_concept", "NOTE-AR-PHRASE-DISAMBIGUATED-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_phrase_status", "NOTE-AR-PHRASE-STATUS", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_phrase_force", "NOTE-AR-PHRASE-FORCE", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_phrase_surrogate", "NOTE-AR-PHRASE-SURROGATE", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_phrase_constraint", "NOTE-AR-PHRASE-CONSTRAINT", 2, 0, false );
    SubLFiles.declareFunction( me, "compute_ar_phrase_force", "COMPUTE-AR-PHRASE-FORCE", 1, 2, false );
    SubLFiles.declareFunction( me, "ar_phrase_has_non_surrogate_conceptsP", "AR-PHRASE-HAS-NON-SURROGATE-CONCEPTS?", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_token_count", "AR-PHRASE-TOKEN-COUNT", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_print_function_trampoline", "AR-CONCEPT-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_p", "AR-CONCEPT-P", 1, 0, false );
    new $ar_concept_p$UnaryFunction();
    SubLFiles.declareFunction( me, "ar_concept_id", "AR-CONCEPT-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_cycl", "AR-CONCEPT-CYCL", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_disambiguation_text", "AR-CONCEPT-DISAMBIGUATION-TEXT", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_phrases", "AR-CONCEPT-PHRASES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_parts", "AR-CONCEPT-PARTS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_agglomerations", "AR-CONCEPT-AGGLOMERATIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_force", "AR-CONCEPT-FORCE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_confidence", "AR-CONCEPT-CONFIDENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_open_term_score", "AR-CONCEPT-OPEN-TERM-SCORE", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_concept_id", "_CSETF-AR-CONCEPT-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_concept_cycl", "_CSETF-AR-CONCEPT-CYCL", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_concept_disambiguation_text", "_CSETF-AR-CONCEPT-DISAMBIGUATION-TEXT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_concept_phrases", "_CSETF-AR-CONCEPT-PHRASES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_concept_parts", "_CSETF-AR-CONCEPT-PARTS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_concept_agglomerations", "_CSETF-AR-CONCEPT-AGGLOMERATIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_concept_force", "_CSETF-AR-CONCEPT-FORCE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_concept_confidence", "_CSETF-AR-CONCEPT-CONFIDENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_concept_open_term_score", "_CSETF-AR-CONCEPT-OPEN-TERM-SCORE", 2, 0, false );
    SubLFiles.declareFunction( me, "make_ar_concept", "MAKE-AR-CONCEPT", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_ar_concept", "VISIT-DEFSTRUCT-AR-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_ar_concept_method", "VISIT-DEFSTRUCT-OBJECT-AR-CONCEPT-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "print_ar_concept", "PRINT-AR-CONCEPT", 3, 0, false );
    SubLFiles.declareFunction( me, "sxhash_ar_concept_method", "SXHASH-AR-CONCEPT-METHOD", 1, 0, false );
    SubLFiles.declareFunction( me, "new_ar_concept", "NEW-AR-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "clone_ar_concept", "CLONE-AR-CONCEPT", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_clone_augment_concept", "RKF-AR-ACT-CLONE-AUGMENT-CONCEPT", 3, 0, false );
    SubLFiles.declareFunction( me, "add_ar_concept_phrase", "ADD-AR-CONCEPT-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_concept_part", "ADD-AR-CONCEPT-PART", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_concept_part", "REM-AR-CONCEPT-PART", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_concept_agglomeration", "ADD-AR-CONCEPT-AGGLOMERATION", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_concept_agglomeration", "REM-AR-CONCEPT-AGGLOMERATION", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_concept_disambiguation_text", "NOTE-AR-CONCEPT-DISAMBIGUATION-TEXT", 2, 0, false );
    SubLFiles.declareFunction( me, "replace_ar_concept_cycl", "REPLACE-AR-CONCEPT-CYCL", 2, 0, false );
    SubLFiles.declareFunction( me, "subst_ar_concept_cycl", "SUBST-AR-CONCEPT-CYCL", 3, 0, false );
    SubLFiles.declareFunction( me, "note_ar_concept_force", "NOTE-AR-CONCEPT-FORCE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_queryP", "AR-CONCEPT-QUERY?", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_assertionP", "AR-CONCEPT-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "note_ar_concept_confidence", "NOTE-AR-CONCEPT-CONFIDENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_concept_open_term_score", "NOTE-AR-CONCEPT-OPEN-TERM-SCORE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_template_print_function_trampoline", "AR-TEMPLATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_template_p", "AR-TEMPLATE-P", 1, 0, false );
    new $ar_template_p$UnaryFunction();
    SubLFiles.declareFunction( me, "ar_template_id", "AR-TEMPLATE-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_template_concept", "AR-TEMPLATE-CONCEPT", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_template_formula", "AR-TEMPLATE-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_template_prompt", "AR-TEMPLATE-PROMPT", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_template_choice_table", "AR-TEMPLATE-CHOICE-TABLE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_template_agglomerations", "AR-TEMPLATE-AGGLOMERATIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_template_id", "_CSETF-AR-TEMPLATE-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_template_concept", "_CSETF-AR-TEMPLATE-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_template_formula", "_CSETF-AR-TEMPLATE-FORMULA", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_template_prompt", "_CSETF-AR-TEMPLATE-PROMPT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_template_choice_table", "_CSETF-AR-TEMPLATE-CHOICE-TABLE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_template_agglomerations", "_CSETF-AR-TEMPLATE-AGGLOMERATIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "make_ar_template", "MAKE-AR-TEMPLATE", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_ar_template", "VISIT-DEFSTRUCT-AR-TEMPLATE", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_ar_template_method", "VISIT-DEFSTRUCT-OBJECT-AR-TEMPLATE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "sxhash_ar_template_method", "SXHASH-AR-TEMPLATE-METHOD", 1, 0, false );
    SubLFiles.declareFunction( me, "new_ar_template", "NEW-AR-TEMPLATE", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_template_formula", "NOTE-AR-TEMPLATE-FORMULA", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_template_prompt", "NOTE-AR-TEMPLATE-PROMPT", 2, 0, false );
    SubLFiles.declareFunction( me, "note_ar_template_choice_table", "NOTE-AR-TEMPLATE-CHOICE-TABLE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_template_agglomeration", "ADD-AR-TEMPLATE-AGGLOMERATION", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_state_print_function_trampoline", "AR-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_state_p", "AR-STATE-P", 1, 0, false );
    new $ar_state_p$UnaryFunction();
    SubLFiles.declareFunction( me, "ar_state_isg", "AR-STATE-ISG", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_index", "AR-STATE-INDEX", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_source_sentences", "AR-STATE-SOURCE-SENTENCES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_focus_sentence", "AR-STATE-FOCUS-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_completed_sentences", "AR-STATE-COMPLETED-SENTENCES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_unknown_phrases", "AR-STATE-UNKNOWN-PHRASES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_rejected_phrases", "AR-STATE-REJECTED-PHRASES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_irrelevant_phrases", "AR-STATE-IRRELEVANT-PHRASES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_ambiguous_phrases", "AR-STATE-AMBIGUOUS-PHRASES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_assumed_phrases", "AR-STATE-ASSUMED-PHRASES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_pending_phrases", "AR-STATE-PENDING-PHRASES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_accepted_phrases", "AR-STATE-ACCEPTED-PHRASES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_pending_concepts", "AR-STATE-PENDING-CONCEPTS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_accepted_concepts", "AR-STATE-ACCEPTED-CONCEPTS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_candidate_cycls", "AR-STATE-CANDIDATE-CYCLS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_asserted_assertions", "AR-STATE-ASSERTED-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_term_templates", "AR-STATE-TERM-TEMPLATES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_assert_templates", "AR-STATE-ASSERT-TEMPLATES", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_isg", "_CSETF-AR-STATE-ISG", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_index", "_CSETF-AR-STATE-INDEX", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_source_sentences", "_CSETF-AR-STATE-SOURCE-SENTENCES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_focus_sentence", "_CSETF-AR-STATE-FOCUS-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_completed_sentences", "_CSETF-AR-STATE-COMPLETED-SENTENCES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_unknown_phrases", "_CSETF-AR-STATE-UNKNOWN-PHRASES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_rejected_phrases", "_CSETF-AR-STATE-REJECTED-PHRASES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_irrelevant_phrases", "_CSETF-AR-STATE-IRRELEVANT-PHRASES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_ambiguous_phrases", "_CSETF-AR-STATE-AMBIGUOUS-PHRASES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_assumed_phrases", "_CSETF-AR-STATE-ASSUMED-PHRASES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_pending_phrases", "_CSETF-AR-STATE-PENDING-PHRASES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_accepted_phrases", "_CSETF-AR-STATE-ACCEPTED-PHRASES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_pending_concepts", "_CSETF-AR-STATE-PENDING-CONCEPTS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_accepted_concepts", "_CSETF-AR-STATE-ACCEPTED-CONCEPTS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_candidate_cycls", "_CSETF-AR-STATE-CANDIDATE-CYCLS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_asserted_assertions", "_CSETF-AR-STATE-ASSERTED-ASSERTIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_term_templates", "_CSETF-AR-STATE-TERM-TEMPLATES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ar_state_assert_templates", "_CSETF-AR-STATE-ASSERT-TEMPLATES", 2, 0, false );
    SubLFiles.declareFunction( me, "make_ar_state", "MAKE-AR-STATE", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_ar_state", "VISIT-DEFSTRUCT-AR-STATE", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_ar_state_method", "VISIT-DEFSTRUCT-OBJECT-AR-STATE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "new_ar_state", "NEW-AR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "ar_reset", "AR-RESET", 1, 0, false );
    SubLFiles.declareFunction( me, "next_ar_state_id", "NEXT-AR-STATE-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "add_ar_object_index", "ADD-AR-OBJECT-INDEX", 3, 0, false );
    SubLFiles.declareFunction( me, "find_ar_object", "FIND-AR-OBJECT", 2, 0, false );
    SubLFiles.declareFunction( me, "find_ar_sentence", "FIND-AR-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "find_ar_token", "FIND-AR-TOKEN", 2, 0, false );
    SubLFiles.declareFunction( me, "find_ar_phrase", "FIND-AR-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "find_ar_concept", "FIND-AR-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "find_ar_template", "FIND-AR-TEMPLATE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_source_sentence", "ADD-AR-STATE-SOURCE-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_ar_state_focus_sentence", "CLEAR-AR-STATE-FOCUS-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "note_ar_state_focus_sentence", "NOTE-AR-STATE-FOCUS-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_state_force", "AR-STATE-FORCE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_span_lengthG", "AR-PHRASE-SPAN-LENGTH>", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_completed_sentence", "ADD-AR-STATE-COMPLETED-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_unknown_phrase", "ADD-AR-STATE-UNKNOWN-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_unknown_phrase", "REM-AR-STATE-UNKNOWN-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_rejected_phrase", "ADD-AR-STATE-REJECTED-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_rejected_phrase", "REM-AR-STATE-REJECTED-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_irrelevant_phrase", "ADD-AR-STATE-IRRELEVANT-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_irrelevant_phrase", "REM-AR-STATE-IRRELEVANT-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_ambiguous_phrase", "ADD-AR-STATE-AMBIGUOUS-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_ambiguous_phrase", "REM-AR-STATE-AMBIGUOUS-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_assumed_phrase", "ADD-AR-STATE-ASSUMED-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_assumed_phrase", "REM-AR-STATE-ASSUMED-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_pending_phrase", "ADD-AR-STATE-PENDING-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_pending_phrase", "REM-AR-STATE-PENDING-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_accepted_phrase", "ADD-AR-STATE-ACCEPTED-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_accepted_phrase", "REM-AR-STATE-ACCEPTED-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_accepted_concept", "ADD-AR-STATE-ACCEPTED-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_accepted_concept", "REM-AR-STATE-ACCEPTED-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_pending_concept", "ADD-AR-STATE-PENDING-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_pending_concept", "REM-AR-STATE-PENDING-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_state_candidate_assertions", "AR-STATE-CANDIDATE-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_candidate_queries", "AR-STATE-CANDIDATE-QUERIES", 1, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_candidate_cycl", "ADD-AR-STATE-CANDIDATE-CYCL", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_candidate_assertion", "ADD-AR-STATE-CANDIDATE-ASSERTION", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_candidate_query", "ADD-AR-STATE-CANDIDATE-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_candidate_assertion", "REM-AR-STATE-CANDIDATE-ASSERTION", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_candidate_query", "REM-AR-STATE-CANDIDATE-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_asserted_assertion", "ADD-AR-STATE-ASSERTED-ASSERTION", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_asserted_assertion", "REM-AR-STATE-ASSERTED-ASSERTION", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_term_template", "ADD-AR-STATE-TERM-TEMPLATE", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_term_template", "REM-AR-STATE-TERM-TEMPLATE", 2, 0, false );
    SubLFiles.declareFunction( me, "add_ar_state_assert_template", "ADD-AR-STATE-ASSERT-TEMPLATE", 2, 0, false );
    SubLFiles.declareFunction( me, "rem_ar_state_assert_template", "REM-AR-STATE-ASSERT-TEMPLATE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_state_top_level_parsesP", "AR-STATE-TOP-LEVEL-PARSES?", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_completed_p", "AR-SENTENCE-COMPLETED-P", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_source_sentence_p", "AR-SOURCE-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_clarification_sentence_p", "AR-CLARIFICATION-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_source_sentence_number", "AR-SOURCE-SENTENCE-NUMBER", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_clarification_sentence_number", "AR-CLARIFICATION-SENTENCE-NUMBER", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_determine_source_sentence", "AR-DETERMINE-SOURCE-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_determine_concept_sentences", "AR-DETERMINE-CONCEPT-SENTENCES", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_determine_concept_sentences_recursive", "AR-DETERMINE-CONCEPT-SENTENCES-RECURSIVE", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_assumed_phrase_count", "AR-SENTENCE-ASSUMED-PHRASE-COUNT", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_state_next_assumed_phrase", "AR-STATE-NEXT-ASSUMED-PHRASE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_next_unknown_phrase", "AR-STATE-NEXT-UNKNOWN-PHRASE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_select_most_promising_unknown_phrase", "AR-STATE-SELECT-MOST-PROMISING-UNKNOWN-PHRASE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_pending_implied_indexicals", "AR-STATE-PENDING-IMPLIED-INDEXICALS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_state_next_implied_indexical", "AR-STATE-NEXT-IMPLIED-INDEXICAL", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_ambiguous_phrase_count", "AR-SENTENCE-AMBIGUOUS-PHRASE-COUNT", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_state_next_ambiguous_phrase", "AR-STATE-NEXT-AMBIGUOUS-PHRASE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_candidate_assertion_count", "AR-SENTENCE-CANDIDATE-ASSERTION-COUNT", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_candidate_query_count", "AR-SENTENCE-CANDIDATE-QUERY-COUNT", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_asserted_assertion_count", "AR-SENTENCE-ASSERTED-ASSERTION-COUNT", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_state_determine_focus_sentence", "AR-STATE-DETERMINE-FOCUS-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_surrogate_concept_p", "AR-SURROGATE-CONCEPT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_dependent_on_surrogate_p", "AR-CONCEPT-DEPENDENT-ON-SURROGATE-P", 1, 1, false );
    SubLFiles.declareFunction( me, "current_ar_concept_grounding_map", "CURRENT-AR-CONCEPT-GROUNDING-MAP", 0, 0, false );
    SubLFiles.declareFunction( me, "ensure_ar_concept_grounding_map", "ENSURE-AR-CONCEPT-GROUNDING-MAP", 0, 0, false );
    SubLFiles.declareMacro( me, "with_new_ar_concept_grounding_map", "WITH-NEW-AR-CONCEPT-GROUNDING-MAP" );
    SubLFiles.declareFunction( me, "ar_concept_grounding_computedP", "AR-CONCEPT-GROUNDING-COMPUTED?", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_grounding_groundedP", "AR-CONCEPT-GROUNDING-GROUNDED?", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_grounding_ungroundedP", "AR-CONCEPT-GROUNDING-UNGROUNDED?", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_grounding_in_progressP", "AR-CONCEPT-GROUNDING-IN-PROGRESS?", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_grounding_map_mark", "AR-CONCEPT-GROUNDING-MAP-MARK", 3, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_dependent_on_ungrounded_surrogate_p", "AR-CONCEPT-DEPENDENT-ON-UNGROUNDED-SURROGATE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_dependent_on_ungrounded_surrogate_count", "AR-CONCEPT-DEPENDENT-ON-UNGROUNDED-SURROGATE-COUNT", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_dependent_on_ungrounded_surrogate_p", "AR-PHRASE-DEPENDENT-ON-UNGROUNDED-SURROGATE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_divide_eq_best_lambda_substitute", "AR-PHRASE-DIVIDE-EQ-BEST-LAMBDA-SUBSTITUTE", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_divide_concepts", "AR-PHRASE-DIVIDE-CONCEPTS", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_separate_out_forts", "AR-CONCEPT-SEPARATE-OUT-FORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_complexity", "AR-CONCEPT-COMPLEXITY", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_formula_complexity", "AR-FORMULA-COMPLEXITY", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_phrase_constraints_for_unknown", "AR-PHRASE-CONSTRAINTS-FOR-UNKNOWN", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_source_texts_background", "RKF-AR-ACT-ADD-SOURCE-TEXTS-BACKGROUND", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_source_texts_background_internal", "RKF-AR-ACT-ADD-SOURCE-TEXTS-BACKGROUND-INTERNAL", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_source_texts", "RKF-AR-ACT-ADD-SOURCE-TEXTS", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_rewrite_texts_background", "RKF-AR-ACT-ADD-REWRITE-TEXTS-BACKGROUND", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_rewrite_texts_background_internal", "RKF-AR-ACT-ADD-REWRITE-TEXTS-BACKGROUND-INTERNAL", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_rewrite_texts", "RKF-AR-ACT-ADD-REWRITE-TEXTS", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_source_text", "RKF-AR-ACT-ADD-SOURCE-TEXT", 2, 1, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_rewrite_text", "RKF-AR-ACT-ADD-REWRITE-TEXT", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_clarification", "RKF-AR-ACT-ADD-CLARIFICATION", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_select_processing_method", "RKF-AR-SELECT-PROCESSING-METHOD", 0, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_process_input_sentence", "RKF-AR-ACT-PROCESS-INPUT-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_template_category_for_processor", "RKF-AR-TEMPLATE-CATEGORY-FOR-PROCESSOR", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_text", "RKF-AR-ACT-ADD-TEXT", 2, 2, false );
    SubLFiles.declareFunction( me, "rkf_ar_set_open_term_scores", "RKF-AR-SET-OPEN-TERM-SCORES", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_reset_open_term_counts_for_sentence", "RKF-AR-RESET-OPEN-TERM-COUNTS-FOR-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_concept_check_trivial_differences", "RKF-AR-CONCEPT-CHECK-TRIVIAL-DIFFERENCES", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_mask_trivial_differences", "RKF-AR-MASK-TRIVIAL-DIFFERENCES", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_harvest_for_phrases_and_concepts", "RKF-AR-HARVEST-FOR-PHRASES-AND-CONCEPTS", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_transform_unknown_instances", "RKF-AR-TRANSFORM-UNKNOWN-INSTANCES", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_log_parsing_event", "RKF-AR-LOG-PARSING-EVENT", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_rank_parses", "RKF-AR-RANK-PARSES", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_concept_is_surrogateP", "AR-CONCEPT-IS-SURROGATE?", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_add_any_surrogates", "RKF-AR-ADD-ANY-SURROGATES", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_locate_appropriate_phrase", "RKF-AR-LOCATE-APPROPRIATE-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_check_for_existing_surrogate", "RKF-AR-CHECK-FOR-EXISTING-SURROGATE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_update_surrogates", "RKF-AR-UPDATE-SURROGATES", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_add_surrogate_sans_children", "RKF-AR-ADD-SURROGATE-SANS-CHILDREN", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_focus_sentence", "RKF-AR-ACT-FOCUS-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_ensure_focus_sentence", "RKF-AR-ENSURE-FOCUS-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_augment_sentence", "RKF-AR-ACT-AUGMENT-SENTENCE", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_complete_augmentation", "RKF-AR-ACT-COMPLETE-AUGMENTATION", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_find_concept", "RKF-AR-ACT-FIND-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_augment_phrase", "RKF-AR-ACT-AUGMENT-PHRASE", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_phrase", "RKF-AR-ACT-ADD-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_relevant_phrase", "RKF-AR-ACT-ADD-RELEVANT-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_irrelevant", "RKF-AR-ACT-NOTE-IRRELEVANT", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_assumed", "RKF-AR-ACT-NOTE-ASSUMED", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_ambiguous", "RKF-AR-ACT-NOTE-AMBIGUOUS", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_disambiguation", "RKF-AR-ACT-NOTE-DISAMBIGUATION", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_accept_assumed", "RKF-AR-ACT-NOTE-ACCEPT-ASSUMED", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_handle_accept_assumed", "RKF-AR-ACT-HANDLE-ACCEPT-ASSUMED", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_accepted_phrase", "RKF-AR-ACT-NOTE-ACCEPTED-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_rejected_phrase", "RKF-AR-ACT-NOTE-REJECTED-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_reconsider_irrelevant", "RKF-AR-ACT-RECONSIDER-IRRELEVANT", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_understand_unknown_phrase", "RKF-AR-ACT-UNDERSTAND-UNKNOWN-PHRASE", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_reject_unknown_phrase", "RKF-AR-ACT-REJECT-UNKNOWN-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_rewrite_sentence", "RKF-AR-ACT-NOTE-REWRITE-SENTENCE", 3, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_rewrite_cycl_p", "AR-SENTENCE-REWRITE-CYCL-P", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_compute_sentence_rewrites", "AR-COMPUTE-SENTENCE-REWRITES", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_sentence_completed", "RKF-AR-ACT-NOTE-SENTENCE-COMPLETED", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_sentence_completed_and_refocus", "RKF-AR-ACT-NOTE-SENTENCE-COMPLETED-AND-REFOCUS", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_phrase_completed", "RKF-AR-ACT-NOTE-PHRASE-COMPLETED", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_concept_completed", "RKF-AR-ACT-NOTE-CONCEPT-COMPLETED", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_pending_concept", "RKF-AR-ACT-NOTE-PENDING-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_ensure_relation_is_goodP", "RKF-AR-ENSURE-RELATION-IS-GOOD?", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_propagate_surrogate_constraint", "RKF-AR-ACT-PROPAGATE-SURROGATE-CONSTRAINT", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_propagate_one_surrogate_constraint", "RKF-AR-ACT-PROPAGATE-ONE-SURROGATE-CONSTRAINT", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_concept_is_nthfn_termP", "RKF-AR-CONCEPT-IS-NTHFN-TERM?", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_nthfn_termP", "RKF-AR-NTHFN-TERM?", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_unfailable_constraintP", "RKF-AR-UNFAILABLE-CONSTRAINT?", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_possibly_reformulatableP", "RKF-AR-POSSIBLY-REFORMULATABLE?", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_reformulatable_termP", "RKF-REFORMULATABLE-TERM?", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_rkf_reformulatable_terms", "INITIALIZE-RKF-REFORMULATABLE-TERMS", 0, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_rejected_concepts", "RKF-AR-ACT-NOTE-REJECTED-CONCEPTS", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_surrogate_replacement", "RKF-AR-ACT-NOTE-SURROGATE-REPLACEMENT", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_one_surrogate_replacement", "RKF-AR-ACT-NOTE-ONE-SURROGATE-REPLACEMENT", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_propagate_surrogate_replacement", "RKF-AR-ACT-PROPAGATE-SURROGATE-REPLACEMENT", 4, 0, false );
    SubLFiles.declareMacro( me, "rkf_ar_with_additional_constraints", "RKF-AR-WITH-ADDITIONAL-CONSTRAINTS" );
    SubLFiles.declareFunction( me, "rkf_ar_has_additional_constraintsP", "RKF-AR-HAS-ADDITIONAL-CONSTRAINTS?", 0, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_accepted_concept", "RKF-AR-ACT-NOTE-ACCEPTED-CONCEPT", 2, 1, false );
    SubLFiles.declareFunction( me, "rkf_ar_concept_covers_entire_phraseP", "RKF-AR-CONCEPT-COVERS-ENTIRE-PHRASE?", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_resolve_context_references", "RKF-AR-ACT-RESOLVE-CONTEXT-REFERENCES", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_optimize_concept_cycl", "RKF-AR-ACT-OPTIMIZE-CONCEPT-CYCL", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_instantiate_template", "RKF-AR-ACT-INSTANTIATE-TEMPLATE", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_add_template", "RKF-AR-ACT-ADD-TEMPLATE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_formula_choice_template", "RKF-AR-FORMULA-CHOICE-TEMPLATE", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_update_templates", "RKF-AR-ACT-UPDATE-TEMPLATES", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_candidate_cycl", "RKF-AR-ACT-NOTE-CANDIDATE-CYCL", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_candidate_assertion", "RKF-AR-ACT-NOTE-CANDIDATE-ASSERTION", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_note_candidate_query", "RKF-AR-ACT-NOTE-CANDIDATE-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_assert_concept", "RKF-AR-ACT-ASSERT-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_act_reject_assert_concept", "RKF-AR-ACT-REJECT-ASSERT-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "ar_pragmatic_relation_p", "AR-PRAGMATIC-RELATION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "ar_sentence_tokens_from_index_list", "AR-SENTENCE-TOKENS-FROM-INDEX-LIST", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_some_subsuming_phrase", "RKF-AR-SOME-SUBSUMING-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_phrase_subsumed", "RKF-AR-PHRASE-SUBSUMED", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_assertible_concept", "RKF-AR-ASSERTIBLE-CONCEPT", 1, 1, false );
    SubLFiles.declareFunction( me, "rkf_ar_assertible_cycl", "RKF-AR-ASSERTIBLE-CYCL", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_relation_template", "RKF-RELATION-TEMPLATE", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_update_all_template_choices", "RKF-AR-UPDATE-ALL-TEMPLATE-CHOICES", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_update_template_choices_for_template", "RKF-AR-UPDATE-TEMPLATE-CHOICES-FOR-TEMPLATE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_update_template_choices_for_concept", "RKF-AR-UPDATE-TEMPLATE-CHOICES-FOR-CONCEPT", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_update_template_choices_for_template_and_concept", "RKF-AR-UPDATE-TEMPLATE-CHOICES-FOR-TEMPLATE-AND-CONCEPT", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_resolve_context_references", "RKF-AR-RESOLVE-CONTEXT-REFERENCES", 2, 1, false );
    SubLFiles.declareFunction( me, "rkf_ar_context_reference_p", "RKF-AR-CONTEXT-REFERENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_contains_context_references", "RKF-AR-CONTAINS-CONTEXT-REFERENCES", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_gather_context_references", "RKF-AR-GATHER-CONTEXT-REFERENCES", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_resolve_one_context_reference", "RKF-AR-RESOLVE-ONE-CONTEXT-REFERENCE", 2, 1, false );
    SubLFiles.declareFunction( me, "rkf_ar_resolve_the_spec_reference", "RKF-AR-RESOLVE-THE-SPEC-REFERENCE", 2, 1, false );
    SubLFiles.declareFunction( me, "rkf_ar_resolve_the_instance_reference", "RKF-AR-RESOLVE-THE-INSTANCE-REFERENCE", 2, 1, false );
    SubLFiles.declareFunction( me, "rkf_ar_term_agglomerator", "RKF-AR-TERM-AGGLOMERATOR", 1, 2, false );
    SubLFiles.declareFunction( me, "rkf_ar_ta_internal", "RKF-AR-TA-INTERNAL", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_ta_new_relation", "RKF-AR-TA-NEW-RELATION", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_ta_new_term", "RKF-AR-TA-NEW-TERM", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_ta_new_relation_arg", "RKF-AR-TA-NEW-RELATION-ARG", 5, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_ta_assign_args_recursive", "RKF-AR-TA-ASSIGN-ARGS-RECURSIVE", 5, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_ta_answer", "RKF-AR-TA-ANSWER", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_ta_admitted_argument", "RKF-AR-TA-ADMITTED-ARGUMENT", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ar_ta_admitted_formula", "RKF-AR-TA-ADMITTED-FORMULA", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_relation_args_sorted_by_restriction", "CLEAR-RELATION-ARGS-SORTED-BY-RESTRICTION", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_relation_args_sorted_by_restriction", "REMOVE-RELATION-ARGS-SORTED-BY-RESTRICTION", 1, 0, false );
    SubLFiles.declareFunction( me, "relation_args_sorted_by_restriction_internal", "RELATION-ARGS-SORTED-BY-RESTRICTION-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "relation_args_sorted_by_restriction", "RELATION-ARGS-SORTED-BY-RESTRICTION", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_all_relation_args", "CLEAR-ALL-RELATION-ARGS", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_all_relation_args", "REMOVE-ALL-RELATION-ARGS", 1, 0, false );
    SubLFiles.declareFunction( me, "all_relation_args_internal", "ALL-RELATION-ARGS-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "all_relation_args", "ALL-RELATION-ARGS", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_rkf_assisted_reader_file()
  {
    $ar_lock$ = SubLFiles.deflexical( "*AR-LOCK*", Locks.make_lock( $str0$Assisted_Reader_lock ) );
    $dtp_ar_sentence$ = SubLFiles.defconstant( "*DTP-AR-SENTENCE*", $sym3$AR_SENTENCE );
    $dtp_ar_token$ = SubLFiles.defconstant( "*DTP-AR-TOKEN*", $sym39$AR_TOKEN );
    $dtp_ar_phrase$ = SubLFiles.defconstant( "*DTP-AR-PHRASE*", $sym65$AR_PHRASE );
    $dtp_ar_concept$ = SubLFiles.defconstant( "*DTP-AR-CONCEPT*", $sym114$AR_CONCEPT );
    $dtp_ar_template$ = SubLFiles.defconstant( "*DTP-AR-TEMPLATE*", $sym151$AR_TEMPLATE );
    $dtp_ar_state$ = SubLFiles.defconstant( "*DTP-AR-STATE*", $sym179$AR_STATE );
    $max_surrogate_chain_length$ = SubLFiles.defconstant( "*MAX-SURROGATE-CHAIN-LENGTH*", FIVE_INTEGER );
    $ar_concept_grounding_map$ = SubLFiles.defparameter( "*AR-CONCEPT-GROUNDING-MAP*", NIL );
    $ar_concept_cycle_count$ = SubLFiles.deflexical( "*AR-CONCEPT-CYCLE-COUNT*", $int263$10000 );
    $ar_divide_best$ = SubLFiles.defvar( "*AR-DIVIDE-BEST*", NIL );
    $rkf_ar_parsing_mt$ = SubLFiles.defparameter( "*RKF-AR-PARSING-MT*", NIL );
    $rkf_ar_semantics_mt$ = SubLFiles.defparameter( "*RKF-AR-SEMANTICS-MT*", NIL );
    $rkf_user$ = SubLFiles.defparameter( "*RKF-USER*", NIL );
    $rkf_ar_text_processor$ = SubLFiles.deflexical( "*RKF-AR-TEXT-PROCESSOR*", $sym278$RKF_SENTENCE_READER );
    $rkf_ar_question_processor$ = SubLFiles.deflexical( "*RKF-AR-QUESTION-PROCESSOR*", $sym279$RKF_QUESTION_READER );
    $rkf_ar_concept_harvester$ = SubLFiles.deflexical( "*RKF-AR-CONCEPT-HARVESTER*", $sym280$RKF_CONCEPT_HARVESTER );
    $rfk_ar_template_category_map$ = SubLFiles.deflexical( "*RFK-AR-TEMPLATE-CATEGORY-MAP*", $list281 );
    $rkf_ar_processing_mode$ = SubLFiles.defparameter( "*RKF-AR-PROCESSING-MODE*", $kw282$TEXT_PROCESSING );
    $rkf_ar_logging_default_parser$ = SubLFiles.defparameter( "*RKF-AR-LOGGING-DEFAULT-PARSER*", $sym290$ITP_SEQUEL );
    $rkf_ar_logging_default_project$ = SubLFiles.defparameter( "*RKF-AR-LOGGING-DEFAULT-PROJECT*", $str291$UIA_use );
    $rkf_ar_logging_default_priority$ = SubLFiles.defparameter( "*RKF-AR-LOGGING-DEFAULT-PRIORITY*", $str292$Medium );
    $rkf_reformulatable_terms$ = SubLFiles.defparameter( "*RKF-REFORMULATABLE-TERMS*", NIL );
    $rkf_ar_additional_constraints$ = SubLFiles.defparameter( "*RKF-AR-ADDITIONAL-CONSTRAINTS*", NIL );
    $ar_pragmatic_relations$ = SubLFiles.deflexical( "*AR-PRAGMATIC-RELATIONS*", $list313 );
    $relation_args_sorted_by_restriction_caching_state$ = SubLFiles.deflexical( "*RELATION-ARGS-SORTED-BY-RESTRICTION-CACHING-STATE*", NIL );
    $all_relation_args_caching_state$ = SubLFiles.deflexical( "*ALL-RELATION-ARGS-CACHING-STATE*", NIL );
    return NIL;
  }

  public static SubLObject setup_rkf_assisted_reader_file()
  {
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_ar_sentence$.getGlobalValue(), Symbols.symbol_function( $sym10$AR_SENTENCE_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list11 );
    Structures.def_csetf( $sym12$AR_SENTENCE_ID, $sym13$_CSETF_AR_SENTENCE_ID );
    Structures.def_csetf( $sym14$AR_SENTENCE_PLAINTEXT, $sym15$_CSETF_AR_SENTENCE_PLAINTEXT );
    Structures.def_csetf( $sym16$AR_SENTENCE_TOKEN_VECTOR, $sym17$_CSETF_AR_SENTENCE_TOKEN_VECTOR );
    Structures.def_csetf( $sym18$AR_SENTENCE_CLARIFICATIONS, $sym19$_CSETF_AR_SENTENCE_CLARIFICATIONS );
    Structures.def_csetf( $sym20$AR_SENTENCE_SOURCE_SENTENCE, $sym21$_CSETF_AR_SENTENCE_SOURCE_SENTENCE );
    Structures.def_csetf( $sym22$AR_SENTENCE_PHRASES, $sym23$_CSETF_AR_SENTENCE_PHRASES );
    Equality.identity( $sym3$AR_SENTENCE );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_ar_sentence$.getGlobalValue(), Symbols.symbol_function( $sym35$VISIT_DEFSTRUCT_OBJECT_AR_SENTENCE_METHOD ) );
    Structures.register_method( Sxhash.$sxhash_method_table$.getGlobalValue(), $dtp_ar_sentence$.getGlobalValue(), Symbols.symbol_function( $sym36$SXHASH_AR_SENTENCE_METHOD ) );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_ar_token$.getGlobalValue(), Symbols.symbol_function( $sym46$AR_TOKEN_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list47 );
    Structures.def_csetf( $sym48$AR_TOKEN_ID, $sym49$_CSETF_AR_TOKEN_ID );
    Structures.def_csetf( $sym50$AR_TOKEN_TEXT, $sym51$_CSETF_AR_TOKEN_TEXT );
    Structures.def_csetf( $sym52$AR_TOKEN_SENTENCE, $sym53$_CSETF_AR_TOKEN_SENTENCE );
    Structures.def_csetf( $sym54$AR_TOKEN_NUMBER, $sym55$_CSETF_AR_TOKEN_NUMBER );
    Structures.def_csetf( $sym56$AR_TOKEN_PHRASES, $sym57$_CSETF_AR_TOKEN_PHRASES );
    Equality.identity( $sym39$AR_TOKEN );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_ar_token$.getGlobalValue(), Symbols.symbol_function( $sym62$VISIT_DEFSTRUCT_OBJECT_AR_TOKEN_METHOD ) );
    Structures.register_method( Sxhash.$sxhash_method_table$.getGlobalValue(), $dtp_ar_token$.getGlobalValue(), Symbols.symbol_function( $sym64$SXHASH_AR_TOKEN_METHOD ) );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_ar_phrase$.getGlobalValue(), Symbols.symbol_function( $sym71$AR_PHRASE_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list72 );
    Structures.def_csetf( $sym73$AR_PHRASE_ID, $sym74$_CSETF_AR_PHRASE_ID );
    Structures.def_csetf( $sym75$AR_PHRASE_STATUS, $sym76$_CSETF_AR_PHRASE_STATUS );
    Structures.def_csetf( $sym77$AR_PHRASE_TOKEN_LIST, $sym78$_CSETF_AR_PHRASE_TOKEN_LIST );
    Structures.def_csetf( $sym79$AR_PHRASE_SENTENCE, $sym80$_CSETF_AR_PHRASE_SENTENCE );
    Structures.def_csetf( $sym81$AR_PHRASE_CONCEPTS, $sym82$_CSETF_AR_PHRASE_CONCEPTS );
    Structures.def_csetf( $sym83$AR_PHRASE_REJECTED_CONCEPTS, $sym84$_CSETF_AR_PHRASE_REJECTED_CONCEPTS );
    Structures.def_csetf( $sym85$AR_PHRASE_DISAMBIGUATED_CONCEPT, $sym86$_CSETF_AR_PHRASE_DISAMBIGUATED_CONCEPT );
    Structures.def_csetf( $sym87$AR_PHRASE_SURROGATE, $sym88$_CSETF_AR_PHRASE_SURROGATE );
    Structures.def_csetf( $sym89$AR_PHRASE_CONSTRAINT, $sym90$_CSETF_AR_PHRASE_CONSTRAINT );
    Structures.def_csetf( $sym91$AR_PHRASE_FORCE, $sym92$_CSETF_AR_PHRASE_FORCE );
    Equality.identity( $sym65$AR_PHRASE );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_ar_phrase$.getGlobalValue(), Symbols.symbol_function( $sym102$VISIT_DEFSTRUCT_OBJECT_AR_PHRASE_METHOD ) );
    Structures.register_method( Sxhash.$sxhash_method_table$.getGlobalValue(), $dtp_ar_phrase$.getGlobalValue(), Symbols.symbol_function( $sym105$SXHASH_AR_PHRASE_METHOD ) );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_ar_concept$.getGlobalValue(), Symbols.symbol_function( $sym120$AR_CONCEPT_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list121 );
    Structures.def_csetf( $sym122$AR_CONCEPT_ID, $sym123$_CSETF_AR_CONCEPT_ID );
    Structures.def_csetf( $sym124$AR_CONCEPT_CYCL, $sym125$_CSETF_AR_CONCEPT_CYCL );
    Structures.def_csetf( $sym126$AR_CONCEPT_DISAMBIGUATION_TEXT, $sym127$_CSETF_AR_CONCEPT_DISAMBIGUATION_TEXT );
    Structures.def_csetf( $sym128$AR_CONCEPT_PHRASES, $sym129$_CSETF_AR_CONCEPT_PHRASES );
    Structures.def_csetf( $sym130$AR_CONCEPT_PARTS, $sym131$_CSETF_AR_CONCEPT_PARTS );
    Structures.def_csetf( $sym132$AR_CONCEPT_AGGLOMERATIONS, $sym133$_CSETF_AR_CONCEPT_AGGLOMERATIONS );
    Structures.def_csetf( $sym134$AR_CONCEPT_FORCE, $sym135$_CSETF_AR_CONCEPT_FORCE );
    Structures.def_csetf( $sym136$AR_CONCEPT_CONFIDENCE, $sym137$_CSETF_AR_CONCEPT_CONFIDENCE );
    Structures.def_csetf( $sym138$AR_CONCEPT_OPEN_TERM_SCORE, $sym139$_CSETF_AR_CONCEPT_OPEN_TERM_SCORE );
    Equality.identity( $sym114$AR_CONCEPT );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_ar_concept$.getGlobalValue(), Symbols.symbol_function( $sym147$VISIT_DEFSTRUCT_OBJECT_AR_CONCEPT_METHOD ) );
    Structures.register_method( Sxhash.$sxhash_method_table$.getGlobalValue(), $dtp_ar_concept$.getGlobalValue(), Symbols.symbol_function( $sym149$SXHASH_AR_CONCEPT_METHOD ) );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_ar_template$.getGlobalValue(), Symbols.symbol_function( $sym157$AR_TEMPLATE_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list158 );
    Structures.def_csetf( $sym159$AR_TEMPLATE_ID, $sym160$_CSETF_AR_TEMPLATE_ID );
    Structures.def_csetf( $sym161$AR_TEMPLATE_CONCEPT, $sym162$_CSETF_AR_TEMPLATE_CONCEPT );
    Structures.def_csetf( $sym163$AR_TEMPLATE_FORMULA, $sym164$_CSETF_AR_TEMPLATE_FORMULA );
    Structures.def_csetf( $sym165$AR_TEMPLATE_PROMPT, $sym166$_CSETF_AR_TEMPLATE_PROMPT );
    Structures.def_csetf( $sym167$AR_TEMPLATE_CHOICE_TABLE, $sym168$_CSETF_AR_TEMPLATE_CHOICE_TABLE );
    Structures.def_csetf( $sym169$AR_TEMPLATE_AGGLOMERATIONS, $sym170$_CSETF_AR_TEMPLATE_AGGLOMERATIONS );
    Equality.identity( $sym151$AR_TEMPLATE );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_ar_template$.getGlobalValue(), Symbols.symbol_function( $sym176$VISIT_DEFSTRUCT_OBJECT_AR_TEMPLATE_METHOD ) );
    Structures.register_method( Sxhash.$sxhash_method_table$.getGlobalValue(), $dtp_ar_template$.getGlobalValue(), Symbols.symbol_function( $sym177$SXHASH_AR_TEMPLATE_METHOD ) );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_ar_state$.getGlobalValue(), Symbols.symbol_function( $sym185$AR_STATE_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list186 );
    Structures.def_csetf( $sym187$AR_STATE_ISG, $sym188$_CSETF_AR_STATE_ISG );
    Structures.def_csetf( $sym189$AR_STATE_INDEX, $sym190$_CSETF_AR_STATE_INDEX );
    Structures.def_csetf( $sym191$AR_STATE_SOURCE_SENTENCES, $sym192$_CSETF_AR_STATE_SOURCE_SENTENCES );
    Structures.def_csetf( $sym193$AR_STATE_FOCUS_SENTENCE, $sym194$_CSETF_AR_STATE_FOCUS_SENTENCE );
    Structures.def_csetf( $sym195$AR_STATE_COMPLETED_SENTENCES, $sym196$_CSETF_AR_STATE_COMPLETED_SENTENCES );
    Structures.def_csetf( $sym197$AR_STATE_UNKNOWN_PHRASES, $sym198$_CSETF_AR_STATE_UNKNOWN_PHRASES );
    Structures.def_csetf( $sym199$AR_STATE_REJECTED_PHRASES, $sym200$_CSETF_AR_STATE_REJECTED_PHRASES );
    Structures.def_csetf( $sym201$AR_STATE_IRRELEVANT_PHRASES, $sym202$_CSETF_AR_STATE_IRRELEVANT_PHRASES );
    Structures.def_csetf( $sym203$AR_STATE_AMBIGUOUS_PHRASES, $sym204$_CSETF_AR_STATE_AMBIGUOUS_PHRASES );
    Structures.def_csetf( $sym205$AR_STATE_ASSUMED_PHRASES, $sym206$_CSETF_AR_STATE_ASSUMED_PHRASES );
    Structures.def_csetf( $sym207$AR_STATE_PENDING_PHRASES, $sym208$_CSETF_AR_STATE_PENDING_PHRASES );
    Structures.def_csetf( $sym209$AR_STATE_ACCEPTED_PHRASES, $sym210$_CSETF_AR_STATE_ACCEPTED_PHRASES );
    Structures.def_csetf( $sym211$AR_STATE_PENDING_CONCEPTS, $sym212$_CSETF_AR_STATE_PENDING_CONCEPTS );
    Structures.def_csetf( $sym213$AR_STATE_ACCEPTED_CONCEPTS, $sym214$_CSETF_AR_STATE_ACCEPTED_CONCEPTS );
    Structures.def_csetf( $sym215$AR_STATE_CANDIDATE_CYCLS, $sym216$_CSETF_AR_STATE_CANDIDATE_CYCLS );
    Structures.def_csetf( $sym217$AR_STATE_ASSERTED_ASSERTIONS, $sym218$_CSETF_AR_STATE_ASSERTED_ASSERTIONS );
    Structures.def_csetf( $sym219$AR_STATE_TERM_TEMPLATES, $sym220$_CSETF_AR_STATE_TERM_TEMPLATES );
    Structures.def_csetf( $sym221$AR_STATE_ASSERT_TEMPLATES, $sym222$_CSETF_AR_STATE_ASSERT_TEMPLATES );
    Equality.identity( $sym179$AR_STATE );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_ar_state$.getGlobalValue(), Symbols.symbol_function( $sym242$VISIT_DEFSTRUCT_OBJECT_AR_STATE_METHOD ) );
    memoization_state.note_globally_cached_function( $sym322$RELATION_ARGS_SORTED_BY_RESTRICTION );
    memoization_state.note_globally_cached_function( $sym326$ALL_RELATION_ARGS );
    return NIL;
  }
  ...
  static
  {
    me = new rkf_assisted_reader();
    $ar_lock$ = null;
    $dtp_ar_sentence$ = null;
    $dtp_ar_token$ = null;
    $dtp_ar_phrase$ = null;
    $dtp_ar_concept$ = null;
    $dtp_ar_template$ = null;
    $dtp_ar_state$ = null;
    $max_surrogate_chain_length$ = null;
    $ar_concept_grounding_map$ = null;
    $ar_concept_cycle_count$ = null;
    $ar_divide_best$ = null;
    $rkf_ar_parsing_mt$ = null;
    $rkf_ar_semantics_mt$ = null;
    $rkf_user$ = null;
    $rkf_ar_text_processor$ = null;
    $rkf_ar_question_processor$ = null;
    $rkf_ar_concept_harvester$ = null;
    $rfk_ar_template_category_map$ = null;
    $rkf_ar_processing_mode$ = null;
    $rkf_ar_logging_default_parser$ = null;
    $rkf_ar_logging_default_project$ = null;
    $rkf_ar_logging_default_priority$ = null;
    $rkf_reformulatable_terms$ = null;
    $rkf_ar_additional_constraints$ = null;
    $ar_pragmatic_relations$ = null;
    $relation_args_sorted_by_restriction_caching_state$ = null;
    $all_relation_args_caching_state$ = null;
    $str0$Assisted_Reader_lock = makeString( "Assisted Reader lock" );
    $sym1$WITH_LOCK_HELD = makeSymbol( "WITH-LOCK-HELD" );
    $list2 = ConsesLow.list( makeSymbol( "*AR-LOCK*" ) );
    $sym3$AR_SENTENCE = makeSymbol( "AR-SENTENCE" );
    $sym4$AR_SENTENCE_P = makeSymbol( "AR-SENTENCE-P" );
    $list5 = ConsesLow.list( makeSymbol( "ID" ), makeSymbol( "PLAINTEXT" ), makeSymbol( "TOKEN-VECTOR" ), makeSymbol( "CLARIFICATIONS" ), makeSymbol( "SOURCE-SENTENCE" ), makeSymbol( "PHRASES" ) );
    $list6 = ConsesLow.list( makeKeyword( "ID" ), makeKeyword( "PLAINTEXT" ), makeKeyword( "TOKEN-VECTOR" ), makeKeyword( "CLARIFICATIONS" ), makeKeyword( "SOURCE-SENTENCE" ), makeKeyword( "PHRASES" ) );
    $list7 = ConsesLow.list( makeSymbol( "AR-SENTENCE-ID" ), makeSymbol( "AR-SENTENCE-PLAINTEXT" ), makeSymbol( "AR-SENTENCE-TOKEN-VECTOR" ), makeSymbol( "AR-SENTENCE-CLARIFICATIONS" ), makeSymbol(
        "AR-SENTENCE-SOURCE-SENTENCE" ), makeSymbol( "AR-SENTENCE-PHRASES" ) );
    $list8 = ConsesLow.list( makeSymbol( "_CSETF-AR-SENTENCE-ID" ), makeSymbol( "_CSETF-AR-SENTENCE-PLAINTEXT" ), makeSymbol( "_CSETF-AR-SENTENCE-TOKEN-VECTOR" ), makeSymbol( "_CSETF-AR-SENTENCE-CLARIFICATIONS" ),
        makeSymbol( "_CSETF-AR-SENTENCE-SOURCE-SENTENCE" ), makeSymbol( "_CSETF-AR-SENTENCE-PHRASES" ) );
    $sym9$DEFAULT_STRUCT_PRINT_FUNCTION = makeSymbol( "DEFAULT-STRUCT-PRINT-FUNCTION" );
    $sym10$AR_SENTENCE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "AR-SENTENCE-PRINT-FUNCTION-TRAMPOLINE" );
    $list11 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "AR-SENTENCE-P" ) );
    $sym12$AR_SENTENCE_ID = makeSymbol( "AR-SENTENCE-ID" );
    $sym13$_CSETF_AR_SENTENCE_ID = makeSymbol( "_CSETF-AR-SENTENCE-ID" );
    $sym14$AR_SENTENCE_PLAINTEXT = makeSymbol( "AR-SENTENCE-PLAINTEXT" );
    $sym15$_CSETF_AR_SENTENCE_PLAINTEXT = makeSymbol( "_CSETF-AR-SENTENCE-PLAINTEXT" );
    $sym16$AR_SENTENCE_TOKEN_VECTOR = makeSymbol( "AR-SENTENCE-TOKEN-VECTOR" );
    $sym17$_CSETF_AR_SENTENCE_TOKEN_VECTOR = makeSymbol( "_CSETF-AR-SENTENCE-TOKEN-VECTOR" );
    $sym18$AR_SENTENCE_CLARIFICATIONS = makeSymbol( "AR-SENTENCE-CLARIFICATIONS" );
    $sym19$_CSETF_AR_SENTENCE_CLARIFICATIONS = makeSymbol( "_CSETF-AR-SENTENCE-CLARIFICATIONS" );
    $sym20$AR_SENTENCE_SOURCE_SENTENCE = makeSymbol( "AR-SENTENCE-SOURCE-SENTENCE" );
    $sym21$_CSETF_AR_SENTENCE_SOURCE_SENTENCE = makeSymbol( "_CSETF-AR-SENTENCE-SOURCE-SENTENCE" );
    $sym22$AR_SENTENCE_PHRASES = makeSymbol( "AR-SENTENCE-PHRASES" );
    $sym23$_CSETF_AR_SENTENCE_PHRASES = makeSymbol( "_CSETF-AR-SENTENCE-PHRASES" );
    $kw24$ID = makeKeyword( "ID" );
    $kw25$PLAINTEXT = makeKeyword( "PLAINTEXT" );
    $kw26$TOKEN_VECTOR = makeKeyword( "TOKEN-VECTOR" );
    $kw27$CLARIFICATIONS = makeKeyword( "CLARIFICATIONS" );
    $kw28$SOURCE_SENTENCE = makeKeyword( "SOURCE-SENTENCE" );
    ...
    $sym32$MAKE_AR_SENTENCE = makeSymbol( "MAKE-AR-SENTENCE" );
    $kw33$SLOT = makeKeyword( "SLOT" );
    $kw34$END = makeKeyword( "END" );
    $sym35$VISIT_DEFSTRUCT_OBJECT_AR_SENTENCE_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-AR-SENTENCE-METHOD" );
    $sym36$SXHASH_AR_SENTENCE_METHOD = makeSymbol( "SXHASH-AR-SENTENCE-METHOD" );
    $sym37$VECTORP = makeSymbol( "VECTORP" );
    $sym38$AR_PHRASE_P = makeSymbol( "AR-PHRASE-P" );
    $sym39$AR_TOKEN = makeSymbol( "AR-TOKEN" );
    $sym40$AR_TOKEN_P = makeSymbol( "AR-TOKEN-P" );
    $list41 = ConsesLow.list( makeSymbol( "ID" ), makeSymbol( "TEXT" ), makeSymbol( "SENTENCE" ), makeSymbol( "NUMBER" ), makeSymbol( "PHRASES" ) );
    $list42 = ConsesLow.list( makeKeyword( "ID" ), makeKeyword( "TEXT" ), makeKeyword( "SENTENCE" ), makeKeyword( "NUMBER" ), makeKeyword( "PHRASES" ) );
    $list43 = ConsesLow.list( makeSymbol( "AR-TOKEN-ID" ), makeSymbol( "AR-TOKEN-TEXT" ), makeSymbol( "AR-TOKEN-SENTENCE" ), makeSymbol( "AR-TOKEN-NUMBER" ), makeSymbol( "AR-TOKEN-PHRASES" ) );
    $list44 = ConsesLow.list( makeSymbol( "_CSETF-AR-TOKEN-ID" ), makeSymbol( "_CSETF-AR-TOKEN-TEXT" ), makeSymbol( "_CSETF-AR-TOKEN-SENTENCE" ), makeSymbol( "_CSETF-AR-TOKEN-NUMBER" ), makeSymbol(
        "_CSETF-AR-TOKEN-PHRASES" ) );
    $sym45$PRINT_AR_TOKEN = makeSymbol( "PRINT-AR-TOKEN" );
    $sym46$AR_TOKEN_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "AR-TOKEN-PRINT-FUNCTION-TRAMPOLINE" );
    $list47 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "AR-TOKEN-P" ) );
    $sym48$AR_TOKEN_ID = makeSymbol( "AR-TOKEN-ID" );
    $sym49$_CSETF_AR_TOKEN_ID = makeSymbol( "_CSETF-AR-TOKEN-ID" );
    $sym50$AR_TOKEN_TEXT = makeSymbol( "AR-TOKEN-TEXT" );
    $sym51$_CSETF_AR_TOKEN_TEXT = makeSymbol( "_CSETF-AR-TOKEN-TEXT" );
    $sym52$AR_TOKEN_SENTENCE = makeSymbol( "AR-TOKEN-SENTENCE" );
    $sym53$_CSETF_AR_TOKEN_SENTENCE = makeSymbol( "_CSETF-AR-TOKEN-SENTENCE" );
    $sym54$AR_TOKEN_NUMBER = makeSymbol( "AR-TOKEN-NUMBER" );
    $sym55$_CSETF_AR_TOKEN_NUMBER = makeSymbol( "_CSETF-AR-TOKEN-NUMBER" );
    $sym56$AR_TOKEN_PHRASES = makeSymbol( "AR-TOKEN-PHRASES" );
    $sym57$_CSETF_AR_TOKEN_PHRASES = makeSymbol( "_CSETF-AR-TOKEN-PHRASES" );
    $kw58$TEXT = makeKeyword( "TEXT" );
    $kw59$SENTENCE = makeKeyword( "SENTENCE" );
    $kw60$NUMBER = makeKeyword( "NUMBER" );
    $sym61$MAKE_AR_TOKEN = makeSymbol( "MAKE-AR-TOKEN" );
    $sym62$VISIT_DEFSTRUCT_OBJECT_AR_TOKEN_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-AR-TOKEN-METHOD" );
    $str63$_A_ = makeString( "~A " );
    $sym64$SXHASH_AR_TOKEN_METHOD = makeSymbol( "SXHASH-AR-TOKEN-METHOD" );
    $sym65$AR_PHRASE = makeSymbol( "AR-PHRASE" );
    $list66 = ConsesLow.list( new SubLObject[] { makeSymbol( "ID" ), makeSymbol( "STATUS" ), makeSymbol( "TOKEN-LIST" ), makeSymbol( "SENTENCE" ), makeSymbol( "CONCEPTS" ), makeSymbol( "REJECTED-CONCEPTS" ), makeSymbol(
        "DISAMBIGUATED-CONCEPT" ), makeSymbol( "SURROGATE" ), makeSymbol( "CONSTRAINT" ), makeSymbol( "FORCE" )
    } );
    $list67 = ConsesLow.list( new SubLObject[] { makeKeyword( "ID" ), makeKeyword( "STATUS" ), makeKeyword( "TOKEN-LIST" ), makeKeyword( "SENTENCE" ), makeKeyword( "CONCEPTS" ), makeKeyword( "REJECTED-CONCEPTS" ),
      makeKeyword( "DISAMBIGUATED-CONCEPT" ), makeKeyword( "SURROGATE" ), makeKeyword( "CONSTRAINT" ), makeKeyword( "FORCE" )
    } );
    $list68 = ConsesLow.list( new SubLObject[] { makeSymbol( "AR-PHRASE-ID" ), makeSymbol( "AR-PHRASE-STATUS" ), makeSymbol( "AR-PHRASE-TOKEN-LIST" ), makeSymbol( "AR-PHRASE-SENTENCE" ), makeSymbol(
        "AR-PHRASE-CONCEPTS" ), makeSymbol( "AR-PHRASE-REJECTED-CONCEPTS" ), makeSymbol( "AR-PHRASE-DISAMBIGUATED-CONCEPT" ), makeSymbol( "AR-PHRASE-SURROGATE" ), makeSymbol( "AR-PHRASE-CONSTRAINT" ), makeSymbol(
            "AR-PHRASE-FORCE" )
    } );
    $list69 = ConsesLow.list( new SubLObject[] { makeSymbol( "_CSETF-AR-PHRASE-ID" ), makeSymbol( "_CSETF-AR-PHRASE-STATUS" ), makeSymbol( "_CSETF-AR-PHRASE-TOKEN-LIST" ), makeSymbol( "_CSETF-AR-PHRASE-SENTENCE" ),
      makeSymbol( "_CSETF-AR-PHRASE-CONCEPTS" ), makeSymbol( "_CSETF-AR-PHRASE-REJECTED-CONCEPTS" ), makeSymbol( "_CSETF-AR-PHRASE-DISAMBIGUATED-CONCEPT" ), makeSymbol( "_CSETF-AR-PHRASE-SURROGATE" ), makeSymbol(
          "_CSETF-AR-PHRASE-CONSTRAINT" ), makeSymbol( "_CSETF-AR-PHRASE-FORCE" )
    } );
    $sym70$PRINT_AR_PHRASE = makeSymbol( "PRINT-AR-PHRASE" );
    $sym71$AR_PHRASE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "AR-PHRASE-PRINT-FUNCTION-TRAMPOLINE" );
    $list72 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "AR-PHRASE-P" ) );
    $sym73$AR_PHRASE_ID = makeSymbol( "AR-PHRASE-ID" );
    $sym74$_CSETF_AR_PHRASE_ID = makeSymbol( "_CSETF-AR-PHRASE-ID" );
    $sym75$AR_PHRASE_STATUS = makeSymbol( "AR-PHRASE-STATUS" );
    $sym76$_CSETF_AR_PHRASE_STATUS = makeSymbol( "_CSETF-AR-PHRASE-STATUS" );
    $sym77$AR_PHRASE_TOKEN_LIST = makeSymbol( "AR-PHRASE-TOKEN-LIST" );
    $sym78$_CSETF_AR_PHRASE_TOKEN_LIST = makeSymbol( "_CSETF-AR-PHRASE-TOKEN-LIST" );
    $sym79$AR_PHRASE_SENTENCE = makeSymbol( "AR-PHRASE-SENTENCE" );
    $sym80$_CSETF_AR_PHRASE_SENTENCE = makeSymbol( "_CSETF-AR-PHRASE-SENTENCE" );
    $sym81$AR_PHRASE_CONCEPTS = makeSymbol( "AR-PHRASE-CONCEPTS" );
    $sym82$_CSETF_AR_PHRASE_CONCEPTS = makeSymbol( "_CSETF-AR-PHRASE-CONCEPTS" );
    $sym83$AR_PHRASE_REJECTED_CONCEPTS = makeSymbol( "AR-PHRASE-REJECTED-CONCEPTS" );
    $sym84$_CSETF_AR_PHRASE_REJECTED_CONCEPTS = makeSymbol( "_CSETF-AR-PHRASE-REJECTED-CONCEPTS" );
    $sym85$AR_PHRASE_DISAMBIGUATED_CONCEPT = makeSymbol( "AR-PHRASE-DISAMBIGUATED-CONCEPT" );
    $sym86$_CSETF_AR_PHRASE_DISAMBIGUATED_CONCEPT = makeSymbol( "_CSETF-AR-PHRASE-DISAMBIGUATED-CONCEPT" );
    $sym87$AR_PHRASE_SURROGATE = makeSymbol( "AR-PHRASE-SURROGATE" );
    $sym88$_CSETF_AR_PHRASE_SURROGATE = makeSymbol( "_CSETF-AR-PHRASE-SURROGATE" );
    $sym89$AR_PHRASE_CONSTRAINT = makeSymbol( "AR-PHRASE-CONSTRAINT" );
    $sym90$_CSETF_AR_PHRASE_CONSTRAINT = makeSymbol( "_CSETF-AR-PHRASE-CONSTRAINT" );
    $sym91$AR_PHRASE_FORCE = makeSymbol( "AR-PHRASE-FORCE" );
    $sym92$_CSETF_AR_PHRASE_FORCE = makeSymbol( "_CSETF-AR-PHRASE-FORCE" );
    $kw93$STATUS = makeKeyword( "STATUS" );
    $kw94$TOKEN_LIST = makeKeyword( "TOKEN-LIST" );
    $kw95$CONCEPTS = makeKeyword( "CONCEPTS" );
    $kw96$REJECTED_CONCEPTS = makeKeyword( "REJECTED-CONCEPTS" );
    $kw97$DISAMBIGUATED_CONCEPT = makeKeyword( "DISAMBIGUATED-CONCEPT" );
    $kw98$SURROGATE = makeKeyword( "SURROGATE" );
    $kw99$CONSTRAINT = makeKeyword( "CONSTRAINT" );
    $kw100$FORCE = makeKeyword( "FORCE" );
    $sym101$MAKE_AR_PHRASE = makeSymbol( "MAKE-AR-PHRASE" );
    $sym102$VISIT_DEFSTRUCT_OBJECT_AR_PHRASE_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-AR-PHRASE-METHOD" );
    $str103$_AR_PHRASE__D_ = makeString( "<AR-PHRASE ~D " );
    $str104$_ = makeString( ">" );
    $sym105$SXHASH_AR_PHRASE_METHOD = makeSymbol( "SXHASH-AR-PHRASE-METHOD" );
    $sym106$LISTP = makeSymbol( "LISTP" );
    $sym107$AR_CONCEPT_P = makeSymbol( "AR-CONCEPT-P" );
    $sym108$KEYWORDP = makeSymbol( "KEYWORDP" );
    $str109$_ = makeString( "?" );
    $kw110$QUESTION = makeKeyword( "QUESTION" );
    $str111$_ = makeString( "." );
    $kw112$DECLARATIVE = makeKeyword( "DECLARATIVE" );
    $kw113$NONE = makeKeyword( "NONE" );
    $sym114$AR_CONCEPT = makeSymbol( "AR-CONCEPT" );
    $list115 = ConsesLow.list( new SubLObject[] { makeSymbol( "ID" ), makeSymbol( "CYCL" ), makeSymbol( "DISAMBIGUATION-TEXT" ), makeSymbol( "PHRASES" ), makeSymbol( "PARTS" ), makeSymbol( "AGGLOMERATIONS" ), makeSymbol(
        "FORCE" ), makeSymbol( "CONFIDENCE" ), makeSymbol( "OPEN-TERM-SCORE" )
    } );
    $list116 = ConsesLow.list( new SubLObject[] { makeKeyword( "ID" ), makeKeyword( "CYCL" ), makeKeyword( "DISAMBIGUATION-TEXT" ), makeKeyword( "PHRASES" ), makeKeyword( "PARTS" ), makeKeyword( "AGGLOMERATIONS" ),
      makeKeyword( "FORCE" ), makeKeyword( "CONFIDENCE" ), makeKeyword( "OPEN-TERM-SCORE" )
    } );
    $list117 = ConsesLow.list( new SubLObject[] { makeSymbol( "AR-CONCEPT-ID" ), makeSymbol( "AR-CONCEPT-CYCL" ), makeSymbol( "AR-CONCEPT-DISAMBIGUATION-TEXT" ), makeSymbol( "AR-CONCEPT-PHRASES" ), makeSymbol(
        "AR-CONCEPT-PARTS" ), makeSymbol( "AR-CONCEPT-AGGLOMERATIONS" ), makeSymbol( "AR-CONCEPT-FORCE" ), makeSymbol( "AR-CONCEPT-CONFIDENCE" ), makeSymbol( "AR-CONCEPT-OPEN-TERM-SCORE" )
    } );
    $list118 = ConsesLow.list( new SubLObject[] { makeSymbol( "_CSETF-AR-CONCEPT-ID" ), makeSymbol( "_CSETF-AR-CONCEPT-CYCL" ), makeSymbol( "_CSETF-AR-CONCEPT-DISAMBIGUATION-TEXT" ), makeSymbol(
        "_CSETF-AR-CONCEPT-PHRASES" ), makeSymbol( "_CSETF-AR-CONCEPT-PARTS" ), makeSymbol( "_CSETF-AR-CONCEPT-AGGLOMERATIONS" ), makeSymbol( "_CSETF-AR-CONCEPT-FORCE" ), makeSymbol( "_CSETF-AR-CONCEPT-CONFIDENCE" ),
      makeSymbol( "_CSETF-AR-CONCEPT-OPEN-TERM-SCORE" )
    } );
    $sym119$PRINT_AR_CONCEPT = makeSymbol( "PRINT-AR-CONCEPT" );
    $sym120$AR_CONCEPT_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "AR-CONCEPT-PRINT-FUNCTION-TRAMPOLINE" );
    $list121 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "AR-CONCEPT-P" ) );
    $sym122$AR_CONCEPT_ID = makeSymbol( "AR-CONCEPT-ID" );
    $sym123$_CSETF_AR_CONCEPT_ID = makeSymbol( "_CSETF-AR-CONCEPT-ID" );
    $sym124$AR_CONCEPT_CYCL = makeSymbol( "AR-CONCEPT-CYCL" );
    $sym125$_CSETF_AR_CONCEPT_CYCL = makeSymbol( "_CSETF-AR-CONCEPT-CYCL" );
    $sym126$AR_CONCEPT_DISAMBIGUATION_TEXT = makeSymbol( "AR-CONCEPT-DISAMBIGUATION-TEXT" );
    $sym127$_CSETF_AR_CONCEPT_DISAMBIGUATION_TEXT = makeSymbol( "_CSETF-AR-CONCEPT-DISAMBIGUATION-TEXT" );
    $sym128$AR_CONCEPT_PHRASES = makeSymbol( "AR-CONCEPT-PHRASES" );
    $sym129$_CSETF_AR_CONCEPT_PHRASES = makeSymbol( "_CSETF-AR-CONCEPT-PHRASES" );
    $sym130$AR_CONCEPT_PARTS = makeSymbol( "AR-CONCEPT-PARTS" );
    $sym131$_CSETF_AR_CONCEPT_PARTS = makeSymbol( "_CSETF-AR-CONCEPT-PARTS" );
    $sym132$AR_CONCEPT_AGGLOMERATIONS = makeSymbol( "AR-CONCEPT-AGGLOMERATIONS" );
    $sym133$_CSETF_AR_CONCEPT_AGGLOMERATIONS = makeSymbol( "_CSETF-AR-CONCEPT-AGGLOMERATIONS" );
    $sym134$AR_CONCEPT_FORCE = makeSymbol( "AR-CONCEPT-FORCE" );
    $sym135$_CSETF_AR_CONCEPT_FORCE = makeSymbol( "_CSETF-AR-CONCEPT-FORCE" );
    $sym136$AR_CONCEPT_CONFIDENCE = makeSymbol( "AR-CONCEPT-CONFIDENCE" );
    $sym137$_CSETF_AR_CONCEPT_CONFIDENCE = makeSymbol( "_CSETF-AR-CONCEPT-CONFIDENCE" );
    $sym138$AR_CONCEPT_OPEN_TERM_SCORE = makeSymbol( "AR-CONCEPT-OPEN-TERM-SCORE" );
    $sym139$_CSETF_AR_CONCEPT_OPEN_TERM_SCORE = makeSymbol( "_CSETF-AR-CONCEPT-OPEN-TERM-SCORE" );
    $kw140$CYCL = makeKeyword( "CYCL" );
    $kw141$DISAMBIGUATION_TEXT = makeKeyword( "DISAMBIGUATION-TEXT" );
    $kw142$PARTS = makeKeyword( "PARTS" );
    $kw143$AGGLOMERATIONS = makeKeyword( "AGGLOMERATIONS" );
    $kw144$CONFIDENCE = makeKeyword( "CONFIDENCE" );
    $kw145$OPEN_TERM_SCORE = makeKeyword( "OPEN-TERM-SCORE" );
    $sym146$MAKE_AR_CONCEPT = makeSymbol( "MAKE-AR-CONCEPT" );
    $sym147$VISIT_DEFSTRUCT_OBJECT_AR_CONCEPT_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-AR-CONCEPT-METHOD" );
    $str148$__AR_CONCEPT__S__S_ = makeString( "#<AR-CONCEPT ~S ~S>" );
    $sym149$SXHASH_AR_CONCEPT_METHOD = makeSymbol( "SXHASH-AR-CONCEPT-METHOD" );
    $sym150$STRINGP = makeSymbol( "STRINGP" );
    $sym151$AR_TEMPLATE = makeSymbol( "AR-TEMPLATE" );
    $sym152$AR_TEMPLATE_P = makeSymbol( "AR-TEMPLATE-P" );
    $list153 = ConsesLow.list( makeSymbol( "ID" ), makeSymbol( "CONCEPT" ), makeSymbol( "FORMULA" ), makeSymbol( "PROMPT" ), makeSymbol( "CHOICE-TABLE" ), makeSymbol( "AGGLOMERATIONS" ) );
    $list154 = ConsesLow.list( makeKeyword( "ID" ), makeKeyword( "CONCEPT" ), makeKeyword( "FORMULA" ), makeKeyword( "PROMPT" ), makeKeyword( "CHOICE-TABLE" ), makeKeyword( "AGGLOMERATIONS" ) );
    $list155 = ConsesLow.list( makeSymbol( "AR-TEMPLATE-ID" ), makeSymbol( "AR-TEMPLATE-CONCEPT" ), makeSymbol( "AR-TEMPLATE-FORMULA" ), makeSymbol( "AR-TEMPLATE-PROMPT" ), makeSymbol( "AR-TEMPLATE-CHOICE-TABLE" ),
        makeSymbol( "AR-TEMPLATE-AGGLOMERATIONS" ) );
    $list156 = ConsesLow.list( makeSymbol( "_CSETF-AR-TEMPLATE-ID" ), makeSymbol( "_CSETF-AR-TEMPLATE-CONCEPT" ), makeSymbol( "_CSETF-AR-TEMPLATE-FORMULA" ), makeSymbol( "_CSETF-AR-TEMPLATE-PROMPT" ), makeSymbol(
        "_CSETF-AR-TEMPLATE-CHOICE-TABLE" ), makeSymbol( "_CSETF-AR-TEMPLATE-AGGLOMERATIONS" ) );
    $sym157$AR_TEMPLATE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "AR-TEMPLATE-PRINT-FUNCTION-TRAMPOLINE" );
    $list158 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "AR-TEMPLATE-P" ) );
    $sym159$AR_TEMPLATE_ID = makeSymbol( "AR-TEMPLATE-ID" );
    $sym160$_CSETF_AR_TEMPLATE_ID = makeSymbol( "_CSETF-AR-TEMPLATE-ID" );
    $sym161$AR_TEMPLATE_CONCEPT = makeSymbol( "AR-TEMPLATE-CONCEPT" );
    $sym162$_CSETF_AR_TEMPLATE_CONCEPT = makeSymbol( "_CSETF-AR-TEMPLATE-CONCEPT" );
    $sym163$AR_TEMPLATE_FORMULA = makeSymbol( "AR-TEMPLATE-FORMULA" );
    $sym164$_CSETF_AR_TEMPLATE_FORMULA = makeSymbol( "_CSETF-AR-TEMPLATE-FORMULA" );
    $sym165$AR_TEMPLATE_PROMPT = makeSymbol( "AR-TEMPLATE-PROMPT" );
    $sym166$_CSETF_AR_TEMPLATE_PROMPT = makeSymbol( "_CSETF-AR-TEMPLATE-PROMPT" );
    $sym167$AR_TEMPLATE_CHOICE_TABLE = makeSymbol( "AR-TEMPLATE-CHOICE-TABLE" );
    $sym168$_CSETF_AR_TEMPLATE_CHOICE_TABLE = makeSymbol( "_CSETF-AR-TEMPLATE-CHOICE-TABLE" );
    $sym169$AR_TEMPLATE_AGGLOMERATIONS = makeSymbol( "AR-TEMPLATE-AGGLOMERATIONS" );
    $sym170$_CSETF_AR_TEMPLATE_AGGLOMERATIONS = makeSymbol( "_CSETF-AR-TEMPLATE-AGGLOMERATIONS" );
    $kw171$CONCEPT = makeKeyword( "CONCEPT" );
    $kw172$FORMULA = makeKeyword( "FORMULA" );
    $kw173$PROMPT = makeKeyword( "PROMPT" );
    $kw174$CHOICE_TABLE = makeKeyword( "CHOICE-TABLE" );
    $sym175$MAKE_AR_TEMPLATE = makeSymbol( "MAKE-AR-TEMPLATE" );
    $sym176$VISIT_DEFSTRUCT_OBJECT_AR_TEMPLATE_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-AR-TEMPLATE-METHOD" );
    $sym177$SXHASH_AR_TEMPLATE_METHOD = makeSymbol( "SXHASH-AR-TEMPLATE-METHOD" );
    $sym178$CONSP = makeSymbol( "CONSP" );
    $sym179$AR_STATE = makeSymbol( "AR-STATE" );
    $sym180$AR_STATE_P = makeSymbol( "AR-STATE-P" );
    $list181 = ConsesLow.list( new SubLObject[] { makeSymbol( "ISG" ), makeSymbol( "INDEX" ), makeSymbol( "SOURCE-SENTENCES" ), makeSymbol( "FOCUS-SENTENCE" ), makeSymbol( "COMPLETED-SENTENCES" ), makeSymbol(
        "UNKNOWN-PHRASES" ), makeSymbol( "REJECTED-PHRASES" ), makeSymbol( "IRRELEVANT-PHRASES" ), makeSymbol( "AMBIGUOUS-PHRASES" ), makeSymbol( "ASSUMED-PHRASES" ), makeSymbol( "PENDING-PHRASES" ), makeSymbol(
            "ACCEPTED-PHRASES" ), makeSymbol( "PENDING-CONCEPTS" ), makeSymbol( "ACCEPTED-CONCEPTS" ), makeSymbol( "CANDIDATE-CYCLS" ), makeSymbol( "ASSERTED-ASSERTIONS" ), makeSymbol( "TERM-TEMPLATES" ), makeSymbol(
                "ASSERT-TEMPLATES" )
    } );
    $list182 = ConsesLow.list( new SubLObject[] { makeKeyword( "ISG" ), makeKeyword( "INDEX" ), makeKeyword( "SOURCE-SENTENCES" ), makeKeyword( "FOCUS-SENTENCE" ), makeKeyword( "COMPLETED-SENTENCES" ), makeKeyword(
        "UNKNOWN-PHRASES" ), makeKeyword( "REJECTED-PHRASES" ), makeKeyword( "IRRELEVANT-PHRASES" ), makeKeyword( "AMBIGUOUS-PHRASES" ), makeKeyword( "ASSUMED-PHRASES" ), makeKeyword( "PENDING-PHRASES" ), makeKeyword(
            "ACCEPTED-PHRASES" ), makeKeyword( "PENDING-CONCEPTS" ), makeKeyword( "ACCEPTED-CONCEPTS" ), makeKeyword( "CANDIDATE-CYCLS" ), makeKeyword( "ASSERTED-ASSERTIONS" ), makeKeyword( "TERM-TEMPLATES" ),
      makeKeyword( "ASSERT-TEMPLATES" )
    } );
    $list183 = ConsesLow.list( new SubLObject[] { makeSymbol( "AR-STATE-ISG" ), makeSymbol( "AR-STATE-INDEX" ), makeSymbol( "AR-STATE-SOURCE-SENTENCES" ), makeSymbol( "AR-STATE-FOCUS-SENTENCE" ), makeSymbol(
        "AR-STATE-COMPLETED-SENTENCES" ), makeSymbol( "AR-STATE-UNKNOWN-PHRASES" ), makeSymbol( "AR-STATE-REJECTED-PHRASES" ), makeSymbol( "AR-STATE-IRRELEVANT-PHRASES" ), makeSymbol( "AR-STATE-AMBIGUOUS-PHRASES" ),
      makeSymbol( "AR-STATE-ASSUMED-PHRASES" ), makeSymbol( "AR-STATE-PENDING-PHRASES" ), makeSymbol( "AR-STATE-ACCEPTED-PHRASES" ), makeSymbol( "AR-STATE-PENDING-CONCEPTS" ), makeSymbol( "AR-STATE-ACCEPTED-CONCEPTS" ),
      makeSymbol( "AR-STATE-CANDIDATE-CYCLS" ), makeSymbol( "AR-STATE-ASSERTED-ASSERTIONS" ), makeSymbol( "AR-STATE-TERM-TEMPLATES" ), makeSymbol( "AR-STATE-ASSERT-TEMPLATES" )
    } );
    $list184 = ConsesLow.list( new SubLObject[] { makeSymbol( "_CSETF-AR-STATE-ISG" ), makeSymbol( "_CSETF-AR-STATE-INDEX" ), makeSymbol( "_CSETF-AR-STATE-SOURCE-SENTENCES" ), makeSymbol(
        "_CSETF-AR-STATE-FOCUS-SENTENCE" ), makeSymbol( "_CSETF-AR-STATE-COMPLETED-SENTENCES" ), makeSymbol( "_CSETF-AR-STATE-UNKNOWN-PHRASES" ), makeSymbol( "_CSETF-AR-STATE-REJECTED-PHRASES" ), makeSymbol(
            "_CSETF-AR-STATE-IRRELEVANT-PHRASES" ), makeSymbol( "_CSETF-AR-STATE-AMBIGUOUS-PHRASES" ), makeSymbol( "_CSETF-AR-STATE-ASSUMED-PHRASES" ), makeSymbol( "_CSETF-AR-STATE-PENDING-PHRASES" ), makeSymbol(
                "_CSETF-AR-STATE-ACCEPTED-PHRASES" ), makeSymbol( "_CSETF-AR-STATE-PENDING-CONCEPTS" ), makeSymbol( "_CSETF-AR-STATE-ACCEPTED-CONCEPTS" ), makeSymbol( "_CSETF-AR-STATE-CANDIDATE-CYCLS" ), makeSymbol(
                    "_CSETF-AR-STATE-ASSERTED-ASSERTIONS" ), makeSymbol( "_CSETF-AR-STATE-TERM-TEMPLATES" ), makeSymbol( "_CSETF-AR-STATE-ASSERT-TEMPLATES" )
    } );
    $sym185$AR_STATE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "AR-STATE-PRINT-FUNCTION-TRAMPOLINE" );
    $list186 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "AR-STATE-P" ) );
    $sym187$AR_STATE_ISG = makeSymbol( "AR-STATE-ISG" );
    $sym188$_CSETF_AR_STATE_ISG = makeSymbol( "_CSETF-AR-STATE-ISG" );
    $sym189$AR_STATE_INDEX = makeSymbol( "AR-STATE-INDEX" );
    $sym190$_CSETF_AR_STATE_INDEX = makeSymbol( "_CSETF-AR-STATE-INDEX" );
    $sym191$AR_STATE_SOURCE_SENTENCES = makeSymbol( "AR-STATE-SOURCE-SENTENCES" );
    $sym192$_CSETF_AR_STATE_SOURCE_SENTENCES = makeSymbol( "_CSETF-AR-STATE-SOURCE-SENTENCES" );
    $sym193$AR_STATE_FOCUS_SENTENCE = makeSymbol( "AR-STATE-FOCUS-SENTENCE" );
    $sym194$_CSETF_AR_STATE_FOCUS_SENTENCE = makeSymbol( "_CSETF-AR-STATE-FOCUS-SENTENCE" );
    $sym195$AR_STATE_COMPLETED_SENTENCES = makeSymbol( "AR-STATE-COMPLETED-SENTENCES" );
    $sym196$_CSETF_AR_STATE_COMPLETED_SENTENCES = makeSymbol( "_CSETF-AR-STATE-COMPLETED-SENTENCES" );
    $sym197$AR_STATE_UNKNOWN_PHRASES = makeSymbol( "AR-STATE-UNKNOWN-PHRASES" );
    $sym198$_CSETF_AR_STATE_UNKNOWN_PHRASES = makeSymbol( "_CSETF-AR-STATE-UNKNOWN-PHRASES" );
    $sym199$AR_STATE_REJECTED_PHRASES = makeSymbol( "AR-STATE-REJECTED-PHRASES" );
    $sym200$_CSETF_AR_STATE_REJECTED_PHRASES = makeSymbol( "_CSETF-AR-STATE-REJECTED-PHRASES" );
    $sym201$AR_STATE_IRRELEVANT_PHRASES = makeSymbol( "AR-STATE-IRRELEVANT-PHRASES" );
    $sym202$_CSETF_AR_STATE_IRRELEVANT_PHRASES = makeSymbol( "_CSETF-AR-STATE-IRRELEVANT-PHRASES" );
    $sym203$AR_STATE_AMBIGUOUS_PHRASES = makeSymbol( "AR-STATE-AMBIGUOUS-PHRASES" );
    $sym204$_CSETF_AR_STATE_AMBIGUOUS_PHRASES = makeSymbol( "_CSETF-AR-STATE-AMBIGUOUS-PHRASES" );
    $sym205$AR_STATE_ASSUMED_PHRASES = makeSymbol( "AR-STATE-ASSUMED-PHRASES" );
    $sym206$_CSETF_AR_STATE_ASSUMED_PHRASES = makeSymbol( "_CSETF-AR-STATE-ASSUMED-PHRASES" );
    $sym207$AR_STATE_PENDING_PHRASES = makeSymbol( "AR-STATE-PENDING-PHRASES" );
    $sym208$_CSETF_AR_STATE_PENDING_PHRASES = makeSymbol( "_CSETF-AR-STATE-PENDING-PHRASES" );
    $sym209$AR_STATE_ACCEPTED_PHRASES = makeSymbol( "AR-STATE-ACCEPTED-PHRASES" );
    $sym210$_CSETF_AR_STATE_ACCEPTED_PHRASES = makeSymbol( "_CSETF-AR-STATE-ACCEPTED-PHRASES" );
    $sym211$AR_STATE_PENDING_CONCEPTS = makeSymbol( "AR-STATE-PENDING-CONCEPTS" );
    $sym212$_CSETF_AR_STATE_PENDING_CONCEPTS = makeSymbol( "_CSETF-AR-STATE-PENDING-CONCEPTS" );
    $sym213$AR_STATE_ACCEPTED_CONCEPTS = makeSymbol( "AR-STATE-ACCEPTED-CONCEPTS" );
    $sym214$_CSETF_AR_STATE_ACCEPTED_CONCEPTS = makeSymbol( "_CSETF-AR-STATE-ACCEPTED-CONCEPTS" );
    $sym215$AR_STATE_CANDIDATE_CYCLS = makeSymbol( "AR-STATE-CANDIDATE-CYCLS" );
    $sym216$_CSETF_AR_STATE_CANDIDATE_CYCLS = makeSymbol( "_CSETF-AR-STATE-CANDIDATE-CYCLS" );
    $sym217$AR_STATE_ASSERTED_ASSERTIONS = makeSymbol( "AR-STATE-ASSERTED-ASSERTIONS" );
    $sym218$_CSETF_AR_STATE_ASSERTED_ASSERTIONS = makeSymbol( "_CSETF-AR-STATE-ASSERTED-ASSERTIONS" );
    $sym219$AR_STATE_TERM_TEMPLATES = makeSymbol( "AR-STATE-TERM-TEMPLATES" );
    $sym220$_CSETF_AR_STATE_TERM_TEMPLATES = makeSymbol( "_CSETF-AR-STATE-TERM-TEMPLATES" );
    $sym221$AR_STATE_ASSERT_TEMPLATES = makeSymbol( "AR-STATE-ASSERT-TEMPLATES" );
    $sym222$_CSETF_AR_STATE_ASSERT_TEMPLATES = makeSymbol( "_CSETF-AR-STATE-ASSERT-TEMPLATES" );
    $kw223$ISG = makeKeyword( "ISG" );
    $kw224$INDEX = makeKeyword( "INDEX" );
    $kw225$SOURCE_SENTENCES = makeKeyword( "SOURCE-SENTENCES" );
    $kw226$FOCUS_SENTENCE = makeKeyword( "FOCUS-SENTENCE" );
    $kw227$COMPLETED_SENTENCES = makeKeyword( "COMPLETED-SENTENCES" );
    $kw228$UNKNOWN_PHRASES = makeKeyword( "UNKNOWN-PHRASES" );
    $kw229$REJECTED_PHRASES = makeKeyword( "REJECTED-PHRASES" );
    $kw230$IRRELEVANT_PHRASES = makeKeyword( "IRRELEVANT-PHRASES" );
    $kw231$AMBIGUOUS_PHRASES = makeKeyword( "AMBIGUOUS-PHRASES" );
    $kw232$ASSUMED_PHRASES = makeKeyword( "ASSUMED-PHRASES" );
    $kw233$PENDING_PHRASES = makeKeyword( "PENDING-PHRASES" );
    $kw234$ACCEPTED_PHRASES = makeKeyword( "ACCEPTED-PHRASES" );
    $kw235$PENDING_CONCEPTS = makeKeyword( "PENDING-CONCEPTS" );
    $kw236$ACCEPTED_CONCEPTS = makeKeyword( "ACCEPTED-CONCEPTS" );
    $kw237$CANDIDATE_CYCLS = makeKeyword( "CANDIDATE-CYCLS" );
    $kw238$ASSERTED_ASSERTIONS = makeKeyword( "ASSERTED-ASSERTIONS" );
    $kw239$TERM_TEMPLATES = makeKeyword( "TERM-TEMPLATES" );
    $kw240$ASSERT_TEMPLATES = makeKeyword( "ASSERT-TEMPLATES" );
    $sym241$MAKE_AR_STATE = makeSymbol( "MAKE-AR-STATE" );
    $sym242$VISIT_DEFSTRUCT_OBJECT_AR_STATE_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-AR-STATE-METHOD" );
    $sym243$AR_PHRASE_SPAN_LENGTH_ = makeSymbol( "AR-PHRASE-SPAN-LENGTH>" );
    $sym244$AR_CONCEPT_ASSERTION_ = makeSymbol( "AR-CONCEPT-ASSERTION?" );
    $sym245$AR_CONCEPT_QUERY_ = makeSymbol( "AR-CONCEPT-QUERY?" );
    $sym246$_ = makeSymbol( "<" );
    $kw247$ASSUMED = makeKeyword( "ASSUMED" );
    $sym248$NOT_EQL = makeSymbol( "NOT-EQL" );
    $kw249$UNKNOWN = makeKeyword( "UNKNOWN" );
    $str250$no_discourse_context = makeString( "no discourse-context" );
    $kw251$PENDING = makeKeyword( "PENDING" );
    $sym252$RKF_DISC_IMPLIED_INDEXICALS_FORMULA_ = makeSymbol( "RKF-DISC-IMPLIED-INDEXICALS-FORMULA?" );
    $kw253$AMBIGUOUS = makeKeyword( "AMBIGUOUS" );
    $sym254$MEMBER = makeSymbol( "MEMBER" );
    $sym255$AR_DETERMINE_CONCEPT_SENTENCES = makeSymbol( "AR-DETERMINE-CONCEPT-SENTENCES" );
    $sym256$CLET = makeSymbol( "CLET" );
    $list257 = ConsesLow.list( ConsesLow.list( makeSymbol( "*AR-CONCEPT-GROUNDING-MAP*" ), NIL ) );
    $list258 = ConsesLow.list( makeSymbol( "ENSURE-AR-CONCEPT-GROUNDING-MAP" ) );
    $sym259$PROGN = makeSymbol( "PROGN" );
    $kw260$GROUNDED = makeKeyword( "GROUNDED" );
    $kw261$UNGROUNDED = makeKeyword( "UNGROUNDED" );
    $kw262$IN_PROGRESS = makeKeyword( "IN-PROGRESS" );
    $int263$10000 = makeInteger( 10000 );
    $const264$TheResultOfParsing = constant_handles.reader_make_constant_shell( makeString( "TheResultOfParsing" ) );
    $sym265$_ = makeSymbol( ">" );
    $sym266$AR_CONCEPT_COMPLEXITY = makeSymbol( "AR-CONCEPT-COMPLEXITY" );
    $sym267$AR_PHRASE_DIVIDE_EQ_BEST_LAMBDA_SUBSTITUTE = makeSymbol( "AR-PHRASE-DIVIDE-EQ-BEST-LAMBDA-SUBSTITUTE" );
    $kw268$IGNORE = makeKeyword( "IGNORE" );
    $const269$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $const270$genls = constant_handles.reader_make_constant_shell( makeString( "genls" ) );
    $str271$Assisted_Reader_reading_texts = makeString( "Assisted Reader reading texts" );
    $sym272$RKF_AR_ACT_ADD_SOURCE_TEXTS_BACKGROUND_INTERNAL = makeSymbol( "RKF-AR-ACT-ADD-SOURCE-TEXTS-BACKGROUND-INTERNAL" );
    $kw273$IGNORE_ERRORS_TARGET = makeKeyword( "IGNORE-ERRORS-TARGET" );
    $sym274$IGNORE_ERRORS_HANDLER = makeSymbol( "IGNORE-ERRORS-HANDLER", "SUBLISP" );
    $sym275$HLMT_P = makeSymbol( "HLMT-P" );
    $str276$Assisted_Reader_rewriting_a_sente = makeString( "Assisted Reader rewriting a sentence" );
    $sym277$RKF_AR_ACT_ADD_REWRITE_TEXTS_BACKGROUND_INTERNAL = makeSymbol( "RKF-AR-ACT-ADD-REWRITE-TEXTS-BACKGROUND-INTERNAL" );
    $sym278$RKF_SENTENCE_READER = makeSymbol( "RKF-SENTENCE-READER" );
    $sym279$RKF_QUESTION_READER = makeSymbol( "RKF-QUESTION-READER" );
    $sym280$RKF_CONCEPT_HARVESTER = makeSymbol( "RKF-CONCEPT-HARVESTER" );
    $list281 = ConsesLow.list( ConsesLow.list( makeSymbol( "RKF-QUESTION-READER" ), constant_handles.reader_make_constant_shell( makeString( "QuestionTemplate" ) ) ), ConsesLow.list( makeSymbol( "RKF-SENTENCE-READER" ),
        constant_handles.reader_make_constant_shell( makeString( "STemplate" ) ) ) );
    $kw282$TEXT_PROCESSING = makeKeyword( "TEXT-PROCESSING" );
    $kw283$QUESTION_PROCESSING = makeKeyword( "QUESTION-PROCESSING" );
    $sym284$VECTOR = makeSymbol( "VECTOR" );
    $kw285$UNINTERESTING = makeKeyword( "UNINTERESTING" );
    $sym286$RTP_TEMPLATE_CATEGORY_ = makeSymbol( "RTP-TEMPLATE-CATEGORY?" );
    $const287$STemplate = constant_handles.reader_make_constant_shell( makeString( "STemplate" ) );
    $sym288$UNKNOWN_INSTANCE_INDEXED_EXPRESSION_ = makeSymbol( "UNKNOWN-INSTANCE-INDEXED-EXPRESSION?" );
    $sym289$ROP_FROM_UNKNOWN_INSTANCE_INDEXED_FN = makeSymbol( "ROP-FROM-UNKNOWN-INSTANCE-INDEXED-FN" );
    $sym290$ITP_SEQUEL = makeSymbol( "ITP-SEQUEL" );
    $str291$UIA_use = makeString( "UIA-use" );
    $str292$Medium = makeString( "Medium" );
    $kw293$IRRELEVANT = makeKeyword( "IRRELEVANT" );
    $kw294$ACCEPTED = makeKeyword( "ACCEPTED" );
    $kw295$REJECTED = makeKeyword( "REJECTED" );
    $const296$RewriteSequenceFn = constant_handles.reader_make_constant_shell( makeString( "RewriteSequenceFn" ) );
    $const297$elementOf = constant_handles.reader_make_constant_shell( makeString( "elementOf" ) );
    $kw298$NO_DISAMBIGS = makeKeyword( "NO-DISAMBIGS" );
    $const299$TheNthFn = constant_handles.reader_make_constant_shell( makeString( "TheNthFn" ) );
    $const300$TheSetOf = constant_handles.reader_make_constant_shell( makeString( "TheSetOf" ) );
    $const301$Thing = constant_handles.reader_make_constant_shell( makeString( "Thing" ) );
    $sym302$RKF_REFORMULATABLE_TERM_ = makeSymbol( "RKF-REFORMULATABLE-TERM?" );
    $sym303$RELEVANT_MT_IS_GENL_MT = makeSymbol( "RELEVANT-MT-IS-GENL-MT" );
    $list304 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "VariableFn" ) ), constant_handles.reader_make_constant_shell( makeString( "TheVPParse" ) ), constant_handles
        .reader_make_constant_shell( makeString( "SomeFn" ) ), constant_handles.reader_make_constant_shell( makeString( "TheActiveSubject" ) ), constant_handles.reader_make_constant_shell( makeString(
            "TheResultOfParsing" ) ) );
    $const305$genlFunctions = constant_handles.reader_make_constant_shell( makeString( "genlFunctions" ) );
    $const306$NLTagFn = constant_handles.reader_make_constant_shell( makeString( "NLTagFn" ) );
    $const307$NLUtteranceAttribute = constant_handles.reader_make_constant_shell( makeString( "NLUtteranceAttribute" ) );
    $kw308$INITIALIZED = makeKeyword( "INITIALIZED" );
    $list309 = ConsesLow.list( ConsesLow.list( makeSymbol( "CONSTRAINTS" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym310$_RKF_AR_ADDITIONAL_CONSTRAINTS_ = makeSymbol( "*RKF-AR-ADDITIONAL-CONSTRAINTS*" );
    $sym311$KEYWORD_IMPOSTOR_P = makeSymbol( "KEYWORD-IMPOSTOR-P" );
    $sym312$KEYWORD_FROM_IMPOSTOR = makeSymbol( "KEYWORD-FROM-IMPOSTOR" );
    $list313 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "TheResultOfParsing" ) ), constant_handles.reader_make_constant_shell( makeString( "TheCoordinationSet" ) ), constant_handles
        .reader_make_constant_shell( makeString( "RewriteSequenceFn" ) ), constant_handles.reader_make_constant_shell( makeString( "TheSpec" ) ), constant_handles.reader_make_constant_shell( makeString(
            "TheInstance" ) ), constant_handles.reader_make_constant_shell( makeString( "The" ) ) );
    $sym314$RKF_AR_PHRASE_SUBSUMED = makeSymbol( "RKF-AR-PHRASE-SUBSUMED" );
    $const315$TruthFunction = constant_handles.reader_make_constant_shell( makeString( "TruthFunction" ) );
    $list316 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "TheSpec" ) ), constant_handles.reader_make_constant_shell( makeString( "TheInstance" ) ) );
    $sym317$RKF_AR_CONTEXT_REFERENCE_P = makeSymbol( "RKF-AR-CONTEXT-REFERENCE-P" );
    $const318$TheSpec = constant_handles.reader_make_constant_shell( makeString( "TheSpec" ) );
    $const319$TheInstance = constant_handles.reader_make_constant_shell( makeString( "TheInstance" ) );
    $sym320$CDR = makeSymbol( "CDR" );
    $sym321$CAR = makeSymbol( "CAR" );
    $sym322$RELATION_ARGS_SORTED_BY_RESTRICTION = makeSymbol( "RELATION-ARGS-SORTED-BY-RESTRICTION" );
    $sym323$SECOND = makeSymbol( "SECOND" );
    $sym324$_RELATION_ARGS_SORTED_BY_RESTRICTION_CACHING_STATE_ = makeSymbol( "*RELATION-ARGS-SORTED-BY-RESTRICTION-CACHING-STATE*" );
    $int325$64 = makeInteger( 64 );
    $sym326$ALL_RELATION_ARGS = makeSymbol( "ALL-RELATION-ARGS" );
    $sym327$RELEVANT_MT_IS_EVERYTHING = makeSymbol( "RELEVANT-MT-IS-EVERYTHING" );
    $const328$EverythingPSC = constant_handles.reader_make_constant_shell( makeString( "EverythingPSC" ) );
    $sym329$_ALL_RELATION_ARGS_CACHING_STATE_ = makeSymbol( "*ALL-RELATION-ARGS-CACHING-STATE*" );
  }

  public static final class $ar_sentence_native
      extends
        SubLStructNative
  {
    ...
    public $ar_sentence_native()
    {
      ...
      this.$plaintext = CommonSymbols.NIL;
      this.$token_vector = CommonSymbols.NIL;
      this.$clarifications = CommonSymbols.NIL;
      this.$source_sentence = CommonSymbols.NIL;
    ...
    {
      return $ar_sentence_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $ar_sentence_native.class, $sym3$AR_SENTENCE, $sym4$AR_SENTENCE_P, $list5, $list6, new String[] { "$id", "$plaintext", "$token_vector", "$clarifications",
        "$source_sentence", "$phrases"
      }, $list7, $list8, $sym9$DEFAULT_STRUCT_PRINT_FUNCTION );
    }
  }

  public static final class $ar_sentence_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $ar_token_native
      extends
        SubLStructNative
  {
    public SubLObject $id;
    ...
    public SubLStructDecl getStructDecl()
    {
      return $ar_token_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $ar_token_native.class, $sym39$AR_TOKEN, $sym40$AR_TOKEN_P, $list41, $list42, new String[] { "$id", "$text", "$sentence", "$number", "$phrases"
      }, $list43, $list44, $sym45$PRINT_AR_TOKEN );
    }
  }

  public static final class $ar_token_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $ar_phrase_native
      extends
        SubLStructNative
  {
    public SubLObject $id;
    ...
    public $ar_phrase_native()
    {
      ...
      this.$token_list = CommonSymbols.NIL;
      this.$sentence = CommonSymbols.NIL;
      this.$concepts = CommonSymbols.NIL;
      this.$rejected_concepts = CommonSymbols.NIL;
      this.$disambiguated_concept = CommonSymbols.NIL;
      this.$surrogate = CommonSymbols.NIL;
    ...
    public SubLStructDecl getStructDecl()
    {
      return $ar_phrase_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $ar_phrase_native.class, $sym65$AR_PHRASE, $sym38$AR_PHRASE_P, $list66, $list67, new String[] { "$id", "$status", "$token_list", "$sentence", "$concepts",
        "$rejected_concepts", "$disambiguated_concept", "$surrogate", "$constraint", "$force"
      }, $list68, $list69, $sym70$PRINT_AR_PHRASE );
    }
  }

  public static final class $ar_phrase_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $ar_concept_native
      extends
        SubLStructNative
  {
    public SubLObject $id;
    ...
    public $ar_concept_native()
    {
      ...
      this.$disambiguation_text = CommonSymbols.NIL;
      this.$phrases = CommonSymbols.NIL;
      this.$parts = CommonSymbols.NIL;
      this.$agglomerations = CommonSymbols.NIL;
      this.$force = CommonSymbols.NIL;
      this.$confidence = CommonSymbols.NIL;
      this.$open_term_score = CommonSymbols.NIL;
    }

    @Override
    public SubLStructDecl getStructDecl()
    {
      return $ar_concept_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $ar_concept_native.class, $sym114$AR_CONCEPT, $sym107$AR_CONCEPT_P, $list115, $list116, new String[] { "$id", "$cycl", "$disambiguation_text", "$phrases", "$parts",
        "$agglomerations", "$force", "$confidence", "$open_term_score"
      }, $list117, $list118, $sym119$PRINT_AR_CONCEPT );
    }
  }

  public static final class $ar_concept_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $ar_template_native
      extends
        SubLStructNative
  {
    public SubLObject $id;
    ...
    {
      this.$id = CommonSymbols.NIL;
      this.$concept = CommonSymbols.NIL;
      this.$formula = CommonSymbols.NIL;
      this.$prompt = CommonSymbols.NIL;
      this.$choice_table = CommonSymbols.NIL;
      this.$agglomerations = CommonSymbols.NIL;
    }
    ...
    public SubLStructDecl getStructDecl()
    {
      return $ar_template_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $ar_template_native.class, $sym151$AR_TEMPLATE, $sym152$AR_TEMPLATE_P, $list153, $list154, new String[] { "$id", "$concept", "$formula", "$prompt", "$choice_table",
        "$agglomerations"
      }, $list155, $list156, $sym9$DEFAULT_STRUCT_PRINT_FUNCTION );
    }
  }

  public static final class $ar_template_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $ar_state_native
      extends
        SubLStructNative
  {
    ...
    public $ar_state_native()
    {
      ...
      this.$source_sentences = CommonSymbols.NIL;
      this.$focus_sentence = CommonSymbols.NIL;
      this.$completed_sentences = CommonSymbols.NIL;
      this.$unknown_phrases = CommonSymbols.NIL;
      this.$rejected_phrases = CommonSymbols.NIL;
      this.$irrelevant_phrases = CommonSymbols.NIL;
      this.$ambiguous_phrases = CommonSymbols.NIL;
      this.$assumed_phrases = CommonSymbols.NIL;
      this.$pending_phrases = CommonSymbols.NIL;
      this.$accepted_phrases = CommonSymbols.NIL;
      this.$pending_concepts = CommonSymbols.NIL;
      this.$accepted_concepts = CommonSymbols.NIL;
      this.$candidate_cycls = CommonSymbols.NIL;
      this.$asserted_assertions = CommonSymbols.NIL;
      this.$term_templates = CommonSymbols.NIL;
      this.$assert_templates = CommonSymbols.NIL;
    }

    @Override
    public SubLStructDecl getStructDecl()
    {
      return $ar_state_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $ar_state_native.class, $sym179$AR_STATE, $sym180$AR_STATE_P, $list181, $list182, new String[] { "$isg", "$index", "$source_sentences", "$focus_sentence",
        "$completed_sentences", "$unknown_phrases", "$rejected_phrases", "$irrelevant_phrases", "$ambiguous_phrases", "$assumed_phrases", "$pending_phrases", "$accepted_phrases", "$pending_concepts",
        "$accepted_concepts", "$candidate_cycls", "$asserted_assertions", "$term_templates", "$assert_templates"
      }, $list183, $list184, $sym9$DEFAULT_STRUCT_PRINT_FUNCTION );
    }
  }

  public static final class $ar_state_p$UnaryFunction
      extends
        UnaryFunction
  {
