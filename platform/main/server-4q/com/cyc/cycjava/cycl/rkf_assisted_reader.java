...
import static com.cyc.cycjava.cycl.rkf_assisted_reader.*; 
 public final class rkf_assisted_reader extends SubLTranslatedFile {
    ...
    public static SubLObject ar_sentence_id(final SubLObject v_object) {
        assert NIL != ar_sentence_p(v_object) : "rkf_assisted_reader.ar_sentence_p error :" + v_object;
    ...
    public static SubLObject ar_token_id(final SubLObject v_object) {
        assert NIL != ar_token_p(v_object) : "rkf_assisted_reader.ar_token_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject ar_phrase_id(final SubLObject v_object) {
        assert NIL != ar_phrase_p(v_object) : "rkf_assisted_reader.ar_phrase_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject ar_concept_id(final SubLObject v_object) {
        assert NIL != ar_concept_p(v_object) : "rkf_assisted_reader.ar_concept_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject ar_template_id(final SubLObject v_object) {
        assert NIL != ar_template_p(v_object) : "rkf_assisted_reader.ar_template_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject ar_state_isg(final SubLObject v_object) {
        assert NIL != ar_state_p(v_object) : "rkf_assisted_reader.ar_state_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $ar_sentence_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($ar_sentence_native.class, AR_SENTENCE, AR_SENTENCE_P, $list5, $list6, new String[]{ "$id", "$plaintext", "$token_vector", "$clarifications", "$source_sentence", "$phrases" }, $list7, $list8, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $ar_token_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($ar_token_native.class, AR_TOKEN, AR_TOKEN_P, $list41, $list42, new String[]{ "$id", "$text", "$sentence", "$number", "$phrases" }, $list43, $list44, PRINT_AR_TOKEN);
        }
    }
    ...
    public static final class $ar_phrase_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($ar_phrase_native.class, AR_PHRASE, AR_PHRASE_P, $list66, $list67, new String[]{ "$id", "$status", "$token_list", "$sentence", "$concepts", "$rejected_concepts", "$disambiguated_concept", "$surrogate", "$constraint", "$force" }, $list68, $list69, PRINT_AR_PHRASE);
        }
    }
    ...
    public static final class $ar_concept_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($ar_concept_native.class, AR_CONCEPT, AR_CONCEPT_P, $list115, $list116, new String[]{ "$id", "$cycl", "$disambiguation_text", "$phrases", "$parts", "$agglomerations", "$force", "$confidence", "$open_term_score" }, $list117, $list118, PRINT_AR_CONCEPT);
        }
    }
    ...
    public static final class $ar_template_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($ar_template_native.class, AR_TEMPLATE, AR_TEMPLATE_P, $list153, $list154, new String[]{ "$id", "$concept", "$formula", "$prompt", "$choice_table", "$agglomerations" }, $list155, $list156, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
