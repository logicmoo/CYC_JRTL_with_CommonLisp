...
public final class cb_phrase_structure_parser extends SubLTranslatedFile implements V02 {
										...
										}
										{
											...
											html_utilities.html_char(CHAR_greater, UNPROVIDED);
											{
												...
												try {
													...
													html_utilities.html_newline(UNPROVIDED);
													html_script_utilities.html_clear_input_button($$$phrase, UNPROVIDED, UNPROVIDED_SYM);
										...
										try {
											...
											html_utilities.html_char(CHAR_greater, UNPROVIDED);
											{
												...
												try {
													...
													final SubLObject nth2 = nth(count, paraphrases);
													SubLObject second2 = maybeSecond(nth2);
													html_utilities.html_markup(second2);
													html_utilities.html_princ($str_alt52$_);
												} finally {
	 ...
	 * @return
	 */
	private static SubLObject maybeSecond(final SubLObject nth2) {
		SubLObject second2 = nth2;
		if (nth2.isCons()) {
			second2 = nth2.rest();
			if (second2.isCons()) {
				second2 = nth2.first();
	...
	static private final SubLList $list_alt0 = list(cons(makeString("NP"), constant_handles.reader_make_constant_shell(makeString("NounPhrase"))), list(makeString("Nbar"), constant_handles.reader_make_constant_shell(makeString("PhraseFn-Bar1")), constant_handles.reader_make_constant_shell(makeString("Noun"))), cons(makeString("PP"), constant_handles.reader_make_constant_shell(makeString("PrepositionalPhrase"))),
			list(makeString("Vbar"), constant_handles.reader_make_constant_shell(makeString("PhraseFn-Bar1")), constant_handles.reader_make_constant_shell(makeString("Verb"))), cons(makeString("Noun"), constant_handles.reader_make_constant_shell(makeString("Noun"))), cons(makeString("Verb"), constant_handles.reader_make_constant_shell(makeString("Verb"))));
