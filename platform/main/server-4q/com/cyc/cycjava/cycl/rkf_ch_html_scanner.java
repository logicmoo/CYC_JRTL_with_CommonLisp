...
public final class rkf_ch_html_scanner extends SubLTranslatedFile {
    ...
    public static SubLObject file_content_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_ch_html_scanner.$file_content_native.class ? T : NIL;
    }

    public static SubLObject file_content_name(final SubLObject v_object) {
        assert NIL != file_content_p(v_object) : "rkf_ch_html_scanner.file_content_p(v_object) " + "CommonSymbols.NIL != rkf_ch_html_scanner.file_content_p(v_object) " + v_object;
    ...
    public static SubLObject make_file_content(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_ch_html_scanner.$file_content_native();
        SubLObject next;
    ...
    public static SubLObject file_paragraph_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_ch_html_scanner.$file_paragraph_native.class ? T : NIL;
    }

    public static SubLObject file_paragraph_file_context(final SubLObject v_object) {
        assert NIL != file_paragraph_p(v_object) : "rkf_ch_html_scanner.file_paragraph_p(v_object) " + "CommonSymbols.NIL != rkf_ch_html_scanner.file_paragraph_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_file_paragraph(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_ch_html_scanner.$file_paragraph_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject file_sentence_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_ch_html_scanner.$file_sentence_native.class ? T : NIL;
    }

    public static SubLObject file_sentence_paragraph(final SubLObject v_object) {
        assert NIL != file_sentence_p(v_object) : "rkf_ch_html_scanner.file_sentence_p(v_object) " + "CommonSymbols.NIL != rkf_ch_html_scanner.file_sentence_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_file_sentence(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_ch_html_scanner.$file_sentence_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $file_content_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_ch_html_scanner.$file_content_native.class, FILE_CONTENT, FILE_CONTENT_P, $list2, $list3, new String[]{ "$name", "$text" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $file_paragraph_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_ch_html_scanner.$file_paragraph_native.class, FILE_PARAGRAPH, FILE_PARAGRAPH_P, $list23, $list24, new String[]{ "$file_context", "$number", "$class", "$sentences" }, $list25, $list26, PRINT_FILE_PARAGRAPH);
        }
    }
    ...
    public static final class $file_sentence_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_ch_html_scanner.$file_sentence_native.class, FILE_SENTENCE, FILE_SENTENCE_P, $list49, $list50, new String[]{ "$paragraph", "$number", "$text" }, $list51, $list52, PRINT_FILE_SENTENCE);
        }
    }
