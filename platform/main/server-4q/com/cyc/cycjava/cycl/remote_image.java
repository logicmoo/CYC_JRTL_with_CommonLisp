...
public final class remote_image extends SubLTranslatedFile {
    ...
    public static SubLObject remote_image_p(final SubLObject v_object) {
        return v_object.getClass() == remote_image.$remote_image_native.class ? T : NIL;
    }

    public static SubLObject rmt_img_machine(final SubLObject v_object) {
        assert NIL != remote_image_p(v_object) : "remote_image.remote_image_p(v_object) " + "CommonSymbols.NIL != remote_image.remote_image_p(v_object) " + v_object;
    ...
    public static SubLObject make_remote_image(SubLObject arglist) {
        ...
        final SubLObject v_new = new remote_image.$remote_image_native();
        SubLObject next;
    ...
    public static SubLObject remote_image_connection_p(final SubLObject v_object) {
        return v_object.getClass() == remote_image.$remote_image_connection_native.class ? T : NIL;
    }

    public static SubLObject rmt_img_conn_image(final SubLObject v_object) {
        assert NIL != remote_image_connection_p(v_object) : "remote_image.remote_image_connection_p(v_object) " + "CommonSymbols.NIL != remote_image.remote_image_connection_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_remote_image_connection(SubLObject arglist) {
        ...
        final SubLObject v_new = new remote_image.$remote_image_connection_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $remote_image_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(remote_image.$remote_image_native.class, REMOTE_IMAGE, REMOTE_IMAGE_P, $list5, $list6, new String[]{ "$machine", "$port", "$protocol" }, $list7, $list8, PRINT_REMOTE_IMAGE);
        }
    }
    ...
    public static final class $remote_image_connection_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(remote_image.$remote_image_connection_native.class, REMOTE_IMAGE_CONNECTION, REMOTE_IMAGE_CONNECTION_P, $list30, $list31, new String[]{ "$image", "$channel" }, $list32, $list33, PRINT_REMOTE_IMAGE_CONNECTION);
        }
    }
