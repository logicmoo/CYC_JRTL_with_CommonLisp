...
public final class string_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject cyclify_status_p(final SubLObject v_object) {
        return v_object.getClass() == string_utilities.$cyclify_status_native.class ? T : NIL;
    }

    public static SubLObject cyclify_status_out_string_list(final SubLObject v_object) {
        assert NIL != cyclify_status_p(v_object) : "string_utilities.cyclify_status_p(v_object) " + "CommonSymbols.NIL != string_utilities.cyclify_status_p(v_object) " + v_object;
    ...
    public static SubLObject make_cyclify_status(SubLObject arglist) {
        ...
        final SubLObject v_new = new string_utilities.$cyclify_status_native();
        SubLObject next;
