...
import com.cyc.cycjava.cycl.reformulator_module_subcollection_processor;
...
import static com.cyc.cycjava.cycl.reformulator_module_subcollection_processor.*;
...
public final class reformulator_module_subcollection_processor extends SubLTranslatedFile {
    ...
    public static SubLObject rl_scfn_data_p(final SubLObject v_object) {
        return v_object.getClass() == reformulator_module_subcollection_processor.$rl_scfn_data_native.class ? T : NIL;
    }

    public static SubLObject rl_scfn_data_hierarchy_pred(final SubLObject v_object) {
        assert NIL != rl_scfn_data_p(v_object) : "reformulator_module_subcollection_processor.rl_scfn_data_p(v_object) " + "CommonSymbols.NIL != reformulator_module_subcollection_processor.rl_scfn_data_p(v_object) " + v_object;
    ...
    public static SubLObject make_rl_scfn_data(SubLObject arglist) {
        ...
        final SubLObject v_new = new reformulator_module_subcollection_processor.$rl_scfn_data_native();
        SubLObject next;
    ...
    public static final class $rl_scfn_data_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(reformulator_module_subcollection_processor.$rl_scfn_data_native.class, RL_SCFN_DATA, RL_SCFN_DATA_P, $list5, $list6, new String[]{ "$hierarchy_pred", "$var_name", "$naut", "$subcollection_fn", "$arg_from", "$pred", "$arg_to" }, $list7, $list8, PRINT_RL_SCFN_DATA);
        }
    }
