...
import com.cyc.cycjava.cycl.file_backed_cache_setup;
...
import static com.cyc.cycjava.cycl.file_backed_cache_setup.*;
...
public final class file_backed_cache_setup extends SubLTranslatedFile {
    ...
    public static SubLObject file_backed_cache_registration_p(final SubLObject v_object) {
        return v_object.getClass() == file_backed_cache_setup.$file_backed_cache_registration_native.class ? T : NIL;
    }

    public static SubLObject fbcr_generation_function(final SubLObject v_object) {
        assert NIL != file_backed_cache_registration_p(v_object) : "file_backed_cache_setup.file_backed_cache_registration_p(v_object) " + "CommonSymbols.NIL != file_backed_cache_setup.file_backed_cache_registration_p(v_object) " + v_object;
    ...
    public static SubLObject make_file_backed_cache_registration(SubLObject arglist) {
        ...
        final SubLObject v_new = new file_backed_cache_setup.$file_backed_cache_registration_native();
        SubLObject next;
    ...
    public static final class $file_backed_cache_registration_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(file_backed_cache_setup.$file_backed_cache_registration_native.class, FILE_BACKED_CACHE_REGISTRATION, FILE_BACKED_CACHE_REGISTRATION_P, $list5, $list6, new String[]{ "$generation_function", "$initialization_function", "$reset_function", "$default_fht_name_function", "$test_suite_name", "$module_name", "$system_name" }, $list7, $list8, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
