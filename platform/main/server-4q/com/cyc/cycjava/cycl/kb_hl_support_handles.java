...
import static com.cyc.cycjava.cycl.kb_hl_support_handles.*;
...
public final class kb_hl_support_handles extends SubLTranslatedFile {
    ...
    private static final SubLList $list3 = list(makeKeyword("PROGRESS-MESSAGE"), makeKeyword("DONE"));
    ...
    public static SubLObject kb_hl_support_p(final SubLObject v_object) {
        return v_object.getClass() == kb_hl_support_handles.$kb_hl_support_native.class ? T : NIL;
    }

    public static SubLObject kb_hls_id(final SubLObject v_object) {
        assert NIL != kb_hl_support_p(v_object) : "kb_hl_support_handles.kb_hl_support_p(v_object) " + "CommonSymbols.NIL != kb_hl_support_handles.kb_hl_support_p(v_object) " + v_object;
    ...
    public static SubLObject make_kb_hl_support(SubLObject arglist) {
        ...
        final SubLObject v_new = new kb_hl_support_handles.$kb_hl_support_native();
        SubLObject next;
    ...
    public static SubLObject declare_kb_hl_support_handles_file() {
        declareFunction(me, "new_kb_hl_supports_iterator", "NEW-KB-HL-SUPPORTS-ITERATOR", 0, 0, false);
        declareMacro(me, "do_kb_hl_supports", "DO-KB-HL-SUPPORTS");
        declareFunction(me, "resolve_kb_hl_support_id_value_pair", "RESOLVE-KB-HL-SUPPORT-ID-VALUE-PAIR", 2, 0, false);
        declareFunction(me, "do_kb_hl_supports_table", "DO-KB-HL-SUPPORTS-TABLE", 0, 0, false);
        declareFunction(me, "kb_hl_supports_table_tuple_to_kb_hl_support", "KB-HL-SUPPORTS-TABLE-TUPLE-TO-KB-HL-SUPPORT", 1, 0, false);
        declareFunction(me, "kb_hl_support_argument_int", "KB-HL-SUPPORT-ARGUMENT-INT", 1, 0, false);
        declareFunction(me, "kb_hl_support_arguments_int", "KB-HL-SUPPORT-ARGUMENTS-INT", 1, 0, false);
        declareFunction(me, "kb_hl_support_dependents_int", "KB-HL-SUPPORT-DEPENDENTS-INT", 1, 0, false);
        declareFunction(me, "setup_kb_hl_support_index_table", "SETUP-KB-HL-SUPPORT-INDEX-TABLE", 0, 0, false);
        declareFunction(me, "setup_kb_hl_support_id_tables", "SETUP-KB-HL-SUPPORT-ID-TABLES", 2, 0, false);
        declareFunction(me, "finalize_kb_hl_supports", "FINALIZE-KB-HL-SUPPORTS", 0, 1, false);
        declareFunction(me, "optimize_kb_hl_support_id_tables", "OPTIMIZE-KB-HL-SUPPORT-ID-TABLES", 0, 0, false);
        declareFunction(me, "clear_kb_hl_support_id_tables", "CLEAR-KB-HL-SUPPORT-ID-TABLES", 0, 0, false);
        declareFunction(me, "create_kb_hl_support_dump_id_table", "CREATE-KB-HL-SUPPORT-DUMP-ID-TABLE", 0, 0, false);
        declareFunction(me, "kb_hl_support_count", "KB-HL-SUPPORT-COUNT", 0, 0, false);
        declareFunction(me, "lookup_kb_hl_support_by_id", "LOOKUP-KB-HL-SUPPORT-BY-ID", 1, 0, false);
        declareFunction(me, "next_kb_hl_support_id", "NEXT-KB-HL-SUPPORT-ID", 0, 0, false);
        declareFunction(me, "new_kb_hl_support_id_threshold", "NEW-KB-HL-SUPPORT-ID-THRESHOLD", 0, 0, false);
        declareFunction(me, "set_new_kb_hl_support_id_threshold", "SET-NEW-KB-HL-SUPPORT-ID-THRESHOLD", 1, 0, false);
        declareFunction(me, "old_kb_hl_support_count", "OLD-KB-HL-SUPPORT-COUNT", 0, 0, false);
        declareFunction(me, "new_kb_hl_support_count", "NEW-KB-HL-SUPPORT-COUNT", 0, 0, false);
        declareFunction(me, "missing_kb_hl_support_id_set", "MISSING-KB-HL-SUPPORT-ID-SET", 0, 0, false);
        declareFunction(me, "set_next_kb_hl_support_id", "SET-NEXT-KB-HL-SUPPORT-ID", 0, 1, false);
        declareFunction(me, "register_kb_hl_support_id", "REGISTER-KB-HL-SUPPORT-ID", 2, 0, false);
        declareFunction(me, "deregister_kb_hl_support_id", "DEREGISTER-KB-HL-SUPPORT-ID", 1, 0, false);
        declareFunction(me, "make_kb_hl_support_id", "MAKE-KB-HL-SUPPORT-ID", 0, 0, false);
        declareMacro(me, "do_old_kb_hl_supports", "DO-OLD-KB-HL-SUPPORTS");
        declareMacro(me, "do_new_kb_hl_supports", "DO-NEW-KB-HL-SUPPORTS");
        declareFunction(me, "kb_hl_support_print_function_trampoline", "KB-HL-SUPPORT-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "kb_hl_support_p", "KB-HL-SUPPORT-P", 1, 0, false);
        new kb_hl_support_handles.$kb_hl_support_p$UnaryFunction();
        declareFunction(me, "kb_hls_id", "KB-HLS-ID", 1, 0, false);
        declareFunction(me, "_csetf_kb_hls_id", "_CSETF-KB-HLS-ID", 2, 0, false);
        declareFunction(me, "make_kb_hl_support", "MAKE-KB-HL-SUPPORT", 0, 1, false);
        declareFunction(me, "visit_defstruct_kb_hl_support", "VISIT-DEFSTRUCT-KB-HL-SUPPORT", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_kb_hl_support_method", "VISIT-DEFSTRUCT-OBJECT-KB-HL-SUPPORT-METHOD", 2, 0, false);
        declareFunction(me, "print_kb_hl_support", "PRINT-KB-HL-SUPPORT", 3, 0, false);
        declareFunction(me, "sxhash_kb_hl_support_method", "SXHASH-KB-HL-SUPPORT-METHOD", 1, 0, false);
        new kb_hl_support_handles.$sxhash_kb_hl_support_method$UnaryFunction();
        declareFunction(me, "get_kb_hl_support", "GET-KB-HL-SUPPORT", 0, 0, false);
        declareFunction(me, "new_kb_hl_support", "NEW-KB-HL-SUPPORT", 1, 0, false);
        declareFunction(me, "free_kb_hl_support", "FREE-KB-HL-SUPPORT", 1, 0, false);
        declareFunction(me, "kb_hl_support_get_id", "KB-HL-SUPPORT-GET-ID", 1, 0, false);
        declareFunction(me, "hl_justify_for_kb_hl_support", "HL-JUSTIFY-FOR-KB-HL-SUPPORT", 1, 0, false);
        declareFunction(me, "valid_kb_hl_support_handleP", "VALID-KB-HL-SUPPORT-HANDLE?", 1, 0, false);
        declareFunction(me, "valid_kb_hl_supportP", "VALID-KB-HL-SUPPORT?", 1, 1, false);
        declareFunction(me, "mark_available_kb_hl_supports", "MARK-AVAILABLE-KB-HL-SUPPORTS", 1, 1, false);
        declareFunction(me, "make_kb_hl_support_shell", "MAKE-KB-HL-SUPPORT-SHELL", 1, 0, false);
        declareFunction(me, "create_sample_invalid_kb_hl_support", "CREATE-SAMPLE-INVALID-KB-HL-SUPPORT", 0, 0, false);
        declareFunction(me, "partition_create_invalid_kb_hl_support", "PARTITION-CREATE-INVALID-KB-HL-SUPPORT", 0, 0, false);
        declareFunction(me, "free_all_kb_hl_support", "FREE-ALL-KB-HL-SUPPORT", 0, 0, false);
        declareFunction(me, "kb_hl_support_id", "KB-HL-SUPPORT-ID", 1, 0, false);
        declareFunction(me, "reset_kb_hl_support_id", "RESET-KB-HL-SUPPORT-ID", 2, 0, false);
        declareFunction(me, "kb_hl_support_handle_validP", "KB-HL-SUPPORT-HANDLE-VALID?", 1, 0, false);
        declareFunction(me, "find_kb_hl_support_by_id", "FIND-KB-HL-SUPPORT-BY-ID", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $kb_hl_support_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(kb_hl_support_handles.$kb_hl_support_native.class, KB_HL_SUPPORT, KB_HL_SUPPORT_P, $list32, $list33, new String[]{ "$id" }, $list34, $list35, PRINT_KB_HL_SUPPORT);
        }
    }
