...
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.$int$1000;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.$int$32;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.$int$64;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.*;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.CLET;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.CSETQ;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.CUNWIND_PROTECT;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.CVS_ID;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.DEFCONSTANT;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.DEFINE;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.DEFLEXICAL;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.DEFPARAMETER;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.DEFVAR;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.EQ;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.EQL;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.EQUAL;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.FIF;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.FIVE_INTEGER;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.FOUR_INTEGER;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.FWHEN;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.IDENTITY;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.MULTIPLE_VALUE_LIST;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.MUST;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.NIL;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.NTH_VALUE;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.NULL;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.ONE_INTEGER;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.PCOND;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.PROGN;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.QUOTE;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.RET;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.SECOND;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.SEVEN_INTEGER;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.SIX_INTEGER;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.STRINGP;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.SYMBOLP;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.T;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.THREE_INTEGER;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols.TRUE;
...
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$CONSTANT;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$DYNAMIC;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$ENDS_WITH;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$ERROR;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$EXTERNAL;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$GETTERS;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$HIGH;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$IMPORTED;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$LEXICAL;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$LOCAL;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$NAME;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$NONE;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$OUTPUT;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$PREDICATE;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$PRINT_FUNCTION;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$PUBLIC;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$SETTERS;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$SLOTS;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$SLOT_KEYWORDS;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$UNKNOWN;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.$UNSPECIFIED;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_KW.*;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.*;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.ARG1;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.ARG2;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.CCONCATENATE;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.CLET_BIND;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.DEFAULT_STRUCT_PRINT_FUNCTION;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.DOUBLE_FLOAT;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.FACCESS;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.FUNCALL;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.THIRD;
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.CommonSymbols_SYM.WHILE;
...
public final class java_backend extends SubLTranslatedFile {
                ...
                current = current.first();
                {
                    ...
                    if (NIL == current) {
                        current = temp;
                        {
                            ...
                            return com.cyc.cycjava.cycl.java_backend.java_backend_write_progn(list(PROGN, listS($sym129$_LOCAL, iterator_var, list($sym262$_CDOHASH_GET_ENTRY_SET_ITERATOR, table_var), $list_alt131), list($sym122$_TRY, listS(WHILE, list($sym263$_CDOHASH_ITERATOR_HAS_NEXT, iterator_var), listS($sym129$_LOCAL, entry_var, list($sym264$_CDOHASH_ITERATOR_NEXT_ENTRY, iterator_var), $list_alt265), list(CSETQ, key, list($sym266$_CDOHASH_GET_ENTRY_KEY, entry_var)), list(CSETQ, val, list($sym267$_CDOHASH_GET_ENTRY_VALUE, entry_var)), append(body, NIL)), NIL, list($sym268$_CDOHASH_RELEASE_ENTRY_SET_ITERATOR, iterator_var))), stream, depth);
                        }
                    } else {
    ...
    public static final SubLList $list_alt107 = list(new SubLObject[]{ cons(makeSymbol("%AND"), makeSymbol("JAVA-BACKEND-WRITE-%AND")), cons(makeSymbol("%CCATCH"), makeSymbol("JAVA-BACKEND-WRITE-%CCATCH")), cons(makeSymbol("%CDO-SYMBOLS"), makeSymbol("JAVA-BACKEND-WRITE-%CDO-SYMBOLS")), cons(makeSymbol("%CDOHASH"), makeSymbol("JAVA-BACKEND-WRITE-%CDOHASH")), cons(makeSymbol("CLET-BIND"), makeSymbol("JAVA-BACKEND-WRITE-CLET-BIND")), cons(makeSymbol("CLET-LOCAL"), makeSymbol("JAVA-BACKEND-WRITE-CLET-LOCAL")), cons(makeSymbol("CODE-COMMENT"), makeSymbol("JAVA-BACKEND-WRITE-CODE-COMMENT")), cons(makeSymbol("%CPROGV"), makeSymbol("JAVA-BACKEND-WRITE-%CPROGV")), cons(makeSymbol("CSETQ"), makeSymbol("JAVA-BACKEND-WRITE-CSETQ")), cons(makeSymbol("CSETQ-DYNAMIC"), makeSymbol("JAVA-BACKEND-WRITE-CSETQ-DYNAMIC")), cons(makeSymbol("CSETQ-LEXICAL"), makeSymbol("JAVA-BACKEND-WRITE-CSETQ-LEXICAL")), cons(makeSymbol("CSETQ-LOCAL"), makeSymbol("JAVA-BACKEND-WRITE-CSETQ-LOCAL")), cons(makeSymbol("%CUNWIND-PROTECT"), makeSymbol("JAVA-BACKEND-WRITE-%CUNWIND-PROTECT")), cons(makeSymbol("CVS-ID"), makeSymbol("JAVA-BACKEND-WRITE-CVS-ID")), cons(makeSymbol("DEFCONSTANT"), makeSymbol("JAVA-BACKEND-WRITE-DEFCONSTANT")), cons(makeSymbol("DEFINE"), makeSymbol("JAVA-BACKEND-WRITE-DEFINE")), cons(makeSymbol("DEFINE-MACROEXPANDER"), makeSymbol("JAVA-BACKEND-WRITE-DEFINE-MACROEXPANDER")), cons(makeSymbol("DEFLEXICAL"), makeSymbol("JAVA-BACKEND-WRITE-DEFLEXICAL")), cons(makeSymbol("DEFPARAMETER"), makeSymbol("JAVA-BACKEND-WRITE-DEFPARAMETER")), cons(makeSymbol("%DEFSTRUCT-CLASS"), makeSymbol("JAVA-BACKEND-WRITE-%DEFSTRUCT-CLASS")), cons(makeSymbol("_DEFSTRUCT-CONSTRUCT", "SUBLISP"), makeSymbol("JAVA-BACKEND-WRITE-DEFSTRUCT-CONSTRUCT")), cons(makeSymbol("_DEFSTRUCT-GET-SLOT", "SUBLISP"), makeSymbol("JAVA-BACKEND-WRITE-DEFSTRUCT-GET-SLOT")), cons(makeSymbol("_DEFSTRUCT-OBJECT-P", "SUBLISP"), makeSymbol("JAVA-BACKEND-WRITE-DEFSTRUCT-OBJECT-P")), cons(makeSymbol("_DEFSTRUCT-SET-SLOT", "SUBLISP"), makeSymbol("JAVA-BACKEND-WRITE-DEFSTRUCT-SET-SLOT")), cons(makeSymbol("DEFVAR"), makeSymbol("JAVA-BACKEND-WRITE-DEFVAR")), cons(makeSymbol("%DP-CHECK-TYPE"), makeSymbol("JAVA-BACKEND-WRITE-%DP-CHECK-TYPE")), cons(makeSymbol("%DP-ENFORCE-TYPE"), makeSymbol("JAVA-BACKEND-WRITE-%DP-ENFORCE-TYPE")), cons(makeSymbol("%ENTER"), makeSymbol("JAVA-BACKEND-WRITE-%ENTER")), cons(makeSymbol("FIF"), makeSymbol("JAVA-BACKEND-WRITE-FIF")), cons(makeSymbol("%FOR"), makeSymbol("JAVA-BACKEND-WRITE-%FOR")), cons(makeSymbol("%IC"), makeSymbol("JAVA-BACKEND-WRITE-%IC")), cons(makeSymbol("%INTERNAL-CONSTANT"), makeSymbol("JAVA-BACKEND-WRITE-%INTERNAL-CONSTANT")), cons(makeSymbol("%LF"), makeSymbol("JAVA-BACKEND-WRITE-%LF")), cons(makeSymbol("%LOCAL"), makeSymbol("JAVA-BACKEND-WRITE-%LOCAL")), cons(makeSymbol("MULTIPLE-VALUE-LIST"), makeSymbol("JAVA-BACKEND-WRITE-MULTIPLE-VALUE-LIST")), cons(makeSymbol("%NC"), makeSymbol("JAVA-BACKEND-WRITE-%NC")), cons(makeSymbol("%NOT"), makeSymbol("JAVA-BACKEND-WRITE-%NOT")), cons(makeSymbol("NTH-VALUE"), makeSymbol("JAVA-BACKEND-WRITE-NTH-VALUE")), cons(makeSymbol("%OR"), makeSymbol("JAVA-BACKEND-WRITE-%OR")), cons(makeSymbol("%PC"), makeSymbol("JAVA-BACKEND-WRITE-%PC")), cons(makeSymbol("PCOND"), makeSymbol("JAVA-BACKEND-WRITE-PCOND")), cons(makeSymbol("PROGN"), makeSymbol("JAVA-BACKEND-WRITE-PROGN")), cons(makeSymbol("%REGISTER-FUNCTION"), makeSymbol("JAVA-BACKEND-WRITE-%REGISTER-FUNCTION")), cons(makeSymbol("%REGISTER-GLOBAL"), makeSymbol("JAVA-BACKEND-WRITE-%REGISTER-GLOBAL")), cons(makeSymbol("%REGISTER-MACRO"), makeSymbol("JAVA-BACKEND-WRITE-%REGISTER-MACRO")), cons(RET, makeSymbol("JAVA-BACKEND-WRITE-RET")), cons(makeSymbol("WHILE"), makeSymbol("JAVA-BACKEND-WRITE-WHILE")), cons(makeSymbol("%WITH-CURRENT-THREAD"), makeSymbol("JAVA-BACKEND-WRITE-%WITH-CURRENT-THREAD")), cons(makeSymbol("%WITH-ERROR-HANDLER"), makeSymbol("JAVA-BACKEND-WRITE-%WITH-ERROR-HANDLER")), cons(makeSymbol("%WITH-PROCESS-RESOURCE-TRACKING"), makeSymbol("JAVA-BACKEND-WRITE-%WITH-PROCESS-RESOURCE-TRACKING")), cons(makeSymbol("%="), makeSymbol("JAVA-BACKEND-WRITE-%=")), cons(makeSymbol("%=="), makeSymbol("JAVA-BACKEND-WRITE-%==")), cons(makeSymbol("%NOT-%=="), makeSymbol("JAVA-BACKEND-WRITE-%NOT-%==")), cons(makeSymbol("%ANNOTATION"), makeSymbol("JAVA-BACKEND-WRITE-%ANNOTATION")), cons(makeSymbol("%BIND"), makeSymbol("JAVA-BACKEND-WRITE-%BIND")), cons(makeSymbol("%CAST"), makeSymbol("JAVA-BACKEND-WRITE-%CAST")), cons(makeSymbol("%CURRENT-BINDING"), makeSymbol("JAVA-BACKEND-WRITE-%CURRENT-BINDING")), cons(makeSymbol("%FIELD"), makeSymbol("JAVA-BACKEND-WRITE-%FIELD")), cons(makeSymbol("%IDENTIFIER"), makeSymbol("JAVA-BACKEND-WRITE-%IDENTIFIER")), cons(makeSymbol("%INIT-OPT-ARG"), makeSymbol("JAVA-BACKEND-WRITE-%INIT-OPT-ARG")), cons(makeSymbol("%INSTANCEOF"), makeSymbol("JAVA-BACKEND-WRITE-%INSTANCEOF")), cons(makeSymbol("%DYN"), makeSymbol("JAVA-BACKEND-WRITE-%DYN")), cons(makeSymbol("%LEX"), makeSymbol("JAVA-BACKEND-WRITE-%LEX")), cons(makeSymbol("%SET-DYN"), makeSymbol("JAVA-BACKEND-WRITE-%SET-DYN")), cons(makeSymbol("%SET-LEX"), makeSymbol("JAVA-BACKEND-WRITE-%SET-LEX")), cons(makeSymbol("%METHOD"), makeSymbol("JAVA-BACKEND-WRITE-%METHOD")), cons(makeSymbol("%MVAL"), makeSymbol("JAVA-BACKEND-WRITE-%MVAL")), cons(makeSymbol("%NEW"), makeSymbol("JAVA-BACKEND-WRITE-%NEW")), cons(makeSymbol("%NEW-ARRAY"), makeSymbol("JAVA-BACKEND-WRITE-%NEW-ARRAY")), cons(makeSymbol("%NOTE-SUPPLIED"), makeSymbol("JAVA-BACKEND-WRITE-%NOTE-SUPPLIED")), cons(makeSymbol("%REBIND"), makeSymbol("JAVA-BACKEND-WRITE-%REBIND")), cons(makeSymbol("%RESET-MVAL"), makeSymbol("JAVA-BACKEND-WRITE-%RESET-MVAL")), cons(makeSymbol("%THROW"), makeSymbol("JAVA-BACKEND-WRITE-%THROW")), cons(makeSymbol("%TRY"), makeSymbol("JAVA-BACKEND-WRITE-%TRY")) });
