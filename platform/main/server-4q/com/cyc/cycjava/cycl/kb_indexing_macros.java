...
import com.cyc.cycjava.cycl.kb_indexing_macros;
...
import static com.cyc.cycjava.cycl.kb_indexing_macros.*;
...
public final class kb_indexing_macros extends SubLTranslatedFile {
    ...
    public static final SubLSymbol SIMPLE_INDEXED_TERM_P = makeSymbol("SIMPLE-INDEXED-TERM-P");



    public static final SubLList $list8 = list(ZERO_INTEGER);

    public static final SubLSymbol DO_SIMPLE_INDEX = makeSymbol("DO-SIMPLE-INDEX");
    ...
    public static final SubLSymbol SET_RELEVANT_SIMPLE_INDEX_COUNT = makeSymbol("SET-RELEVANT-SIMPLE-INDEX-COUNT");

    public static final SubLSymbol SET_RELEVANT_NUM_ARBITRARY_INDEX = makeSymbol("SET-RELEVANT-NUM-ARBITRARY-INDEX");
    ...
    public static final SubLSymbol ASS = makeSymbol("ASS");

    public static final SubLList $list19 = list(makeSymbol("RELEVANT-MT?"), list(makeSymbol("ASSERTION-MT"), makeSymbol("ASS")));

    public static final SubLSymbol SET_RELEVANT_COMPLEX_INDEX_COUNT = makeSymbol("SET-RELEVANT-COMPLEX-INDEX-COUNT");
    ...
    public static final SubLSymbol NUMBER_OF_NON_NULL_ARGS_IN_ORDER = makeSymbol("NUMBER-OF-NON-NULL-ARGS-IN-ORDER");
    ...
    public static final SubLSymbol RELEVANT_MT_SUBINDEX_COUNT = makeSymbol("RELEVANT-MT-SUBINDEX-COUNT");

    public static final SubLSymbol LIST_OF_FIRST_N_ARGS = makeSymbol("LIST-OF-FIRST-N-ARGS");
    ...
    public static final SubLSymbol SET_RELEVANT_SIMPLE_INDEX_COUNT_WITH_CUTOFF = makeSymbol("SET-RELEVANT-SIMPLE-INDEX-COUNT-WITH-CUTOFF");
    ...
    public static final SubLSymbol SET_RELEVANT_COMPLEX_INDEX_COUNT_WITH_CUTOFF = makeSymbol("SET-RELEVANT-COMPLEX-INDEX-COUNT-WITH-CUTOFF");
    ...
    public static final SubLSymbol RELEVANT_MT_SUBINDEX_COUNT_WITH_CUTOFF = makeSymbol("RELEVANT-MT-SUBINDEX-COUNT-WITH-CUTOFF");
    ...
    public static final SubLSymbol NEXT_LEVEL_SUBINDEX = makeSymbol("NEXT-LEVEL-SUBINDEX");
    ...
    public static final SubLSymbol SET_RELEVANT_KEY_SIMPLE_INDEX = makeSymbol("SET-RELEVANT-KEY-SIMPLE-INDEX");

    public static final SubLSymbol SET_RELEVANT_KEY_ARBITRARY_INDEX = makeSymbol("SET-RELEVANT-KEY-ARBITRARY-INDEX");
    ...
    public static final SubLSymbol SET_RELEVANT_KEY_COMPLEX_INDEX = makeSymbol("SET-RELEVANT-KEY-COMPLEX-INDEX");
    ...
    public static final SubLSymbol RELEVANT_MT_SUBINDEX_KEYS = makeSymbol("RELEVANT-MT-SUBINDEX-KEYS");





    public static final SubLSymbol MT_KEY_LEVEL = makeSymbol("MT-KEY-LEVEL");
    ...
    public static final SubLSymbol TERM_GAF_ARG_INDEX = makeSymbol("TERM-GAF-ARG-INDEX");
    ...
    public static final SubLSymbol DO_GAF_ARG_INDICES = makeSymbol("DO-GAF-ARG-INDICES");





    public static final SubLSymbol TERM_NART_ARG_INDEX = makeSymbol("TERM-NART-ARG-INDEX");
    ...
    public static final SubLSymbol DO_NART_ARG_INDICES = makeSymbol("DO-NART-ARG-INDICES");
    ...
    public static final SubLSymbol TERM_PREDICATE_RULE_INDEX = makeSymbol("TERM-PREDICATE-RULE-INDEX");
    ...
    public static final SubLSymbol DO_PREDICATE_RULE_INDICES = makeSymbol("DO-PREDICATE-RULE-INDICES");



    public static final SubLSymbol TERM_DECONTEXTUALIZED_IST_PREDICATE_RULE_INDEX = makeSymbol("TERM-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX");

    public static final SubLSymbol $sym108$SUBINDEX = makeUninternedSymbol("SUBINDEX");

    public static final SubLSymbol DO_DECONTEXTUALIZED_IST_PREDICATE_RULE_INDICES = makeSymbol("DO-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDICES");
    ...
    public static final SubLSymbol TERM_ISA_RULE_INDEX = makeSymbol("TERM-ISA-RULE-INDEX");
    ...
    public static final SubLSymbol DO_ISA_RULE_INDICES = makeSymbol("DO-ISA-RULE-INDICES");



    public static final SubLSymbol TERM_GENLS_RULE_INDEX = makeSymbol("TERM-GENLS-RULE-INDEX");
    ...
    public static final SubLSymbol DO_GENLS_RULE_INDICES = makeSymbol("DO-GENLS-RULE-INDICES");



    public static final SubLSymbol TERM_GENL_MT_RULE_INDEX = makeSymbol("TERM-GENL-MT-RULE-INDEX");
    ...
    public static final SubLSymbol DO_GENL_MT_RULE_INDICES = makeSymbol("DO-GENL-MT-RULE-INDICES");
    ...
    public static SubLObject declare_kb_indexing_macros_file() {
        declareMacro(me, "set_num_arbitrary_index", "SET-NUM-ARBITRARY-INDEX");
        declareMacro(me, "set_relevant_simple_index_count", "SET-RELEVANT-SIMPLE-INDEX-COUNT");
        declareMacro(me, "set_relevant_complex_index_count", "SET-RELEVANT-COMPLEX-INDEX-COUNT");
        declareMacro(me, "set_relevant_num_arbitrary_index", "SET-RELEVANT-NUM-ARBITRARY-INDEX");
        declareFunction(me, "number_has_reached_cutoffP", "NUMBER-HAS-REACHED-CUTOFF?", 2, 0, false);
        declareMacro(me, "set_relevant_simple_index_count_with_cutoff", "SET-RELEVANT-SIMPLE-INDEX-COUNT-WITH-CUTOFF");
        declareMacro(me, "set_relevant_complex_index_count_with_cutoff", "SET-RELEVANT-COMPLEX-INDEX-COUNT-WITH-CUTOFF");
        declareMacro(me, "set_relevant_num_arbitrary_index_with_cutoff", "SET-RELEVANT-NUM-ARBITRARY-INDEX-WITH-CUTOFF");
        declareMacro(me, "set_key_arbitrary_index", "SET-KEY-ARBITRARY-INDEX");
        declareMacro(me, "set_relevant_key_simple_index", "SET-RELEVANT-KEY-SIMPLE-INDEX");
        declareMacro(me, "set_relevant_key_complex_index", "SET-RELEVANT-KEY-COMPLEX-INDEX");
        declareMacro(me, "set_relevant_key_arbitrary_index", "SET-RELEVANT-KEY-ARBITRARY-INDEX");
        declareFunction(me, "mt_key_level", "MT-KEY-LEVEL", 1, 0, false);
        declareFunction(me, "list_of_first_n_args", "LIST-OF-FIRST-N-ARGS", 1, 5, false);
        declareFunction(me, "number_of_non_null_args_in_order", "NUMBER-OF-NON-NULL-ARGS-IN-ORDER", 0, 5, false);
        declareMacro(me, "do_gaf_arg_indices", "DO-GAF-ARG-INDICES");
        declareMacro(me, "do_gaf_arg_index_keys", "DO-GAF-ARG-INDEX-KEYS");
        declareFunction(me, "term_gaf_arg_index", "TERM-GAF-ARG-INDEX", 1, 0, false);
        declareFunction(me, "valid_gaf_arg_index_keyP", "VALID-GAF-ARG-INDEX-KEY?", 1, 0, false);
        declareMacro(me, "do_nart_arg_indices", "DO-NART-ARG-INDICES");
        declareMacro(me, "do_nart_arg_index_keys", "DO-NART-ARG-INDEX-KEYS");
        declareFunction(me, "term_nart_arg_index", "TERM-NART-ARG-INDEX", 1, 0, false);
        declareFunction(me, "valid_nart_arg_index_keyP", "VALID-NART-ARG-INDEX-KEY?", 1, 0, false);
        declareMacro(me, "do_predicate_rule_indices", "DO-PREDICATE-RULE-INDICES");
        declareMacro(me, "do_predicate_rule_index_keys", "DO-PREDICATE-RULE-INDEX-KEYS");
        declareFunction(me, "term_predicate_rule_index", "TERM-PREDICATE-RULE-INDEX", 1, 0, false);
        declareFunction(me, "valid_predicate_rule_index_keyP", "VALID-PREDICATE-RULE-INDEX-KEY?", 1, 0, false);
        declareMacro(me, "do_decontextualized_ist_predicate_rule_indices", "DO-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDICES");
        declareMacro(me, "do_decontextualized_ist_predicate_rule_index_keys", "DO-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX-KEYS");
        declareFunction(me, "term_decontextualized_ist_predicate_rule_index", "TERM-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX", 1, 0, false);
        declareFunction(me, "valid_decontextualized_ist_predicate_rule_index_keyP", "VALID-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX-KEY?", 1, 0, false);
        declareMacro(me, "do_isa_rule_indices", "DO-ISA-RULE-INDICES");
        declareMacro(me, "do_isa_rule_index_keys", "DO-ISA-RULE-INDEX-KEYS");
        declareFunction(me, "term_isa_rule_index", "TERM-ISA-RULE-INDEX", 1, 0, false);
        declareFunction(me, "valid_isa_rule_index_keyP", "VALID-ISA-RULE-INDEX-KEY?", 1, 0, false);
        declareMacro(me, "do_genls_rule_indices", "DO-GENLS-RULE-INDICES");
        declareMacro(me, "do_genls_rule_index_keys", "DO-GENLS-RULE-INDEX-KEYS");
        declareFunction(me, "term_genls_rule_index", "TERM-GENLS-RULE-INDEX", 1, 0, false);
        declareFunction(me, "valid_genls_rule_index_keyP", "VALID-GENLS-RULE-INDEX-KEY?", 1, 0, false);
        declareMacro(me, "do_genl_mt_rule_indices", "DO-GENL-MT-RULE-INDICES");
        declareMacro(me, "do_genl_mt_rule_index_keys", "DO-GENL-MT-RULE-INDEX-KEYS");
        declareFunction(me, "term_genl_mt_rule_index", "TERM-GENL-MT-RULE-INDEX", 1, 0, false);
        declareFunction(me, "valid_genl_mt_rule_index_keyP", "VALID-GENL-MT-RULE-INDEX-KEY?", 1, 0, false);
        return NIL;
    }
