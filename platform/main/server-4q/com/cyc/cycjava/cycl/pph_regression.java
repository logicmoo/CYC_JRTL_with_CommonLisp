...
import com.cyc.cycjava.cycl.pph_regression;
...
import static com.cyc.cycjava.cycl.pph_regression.*;
...
public final class pph_regression extends SubLTranslatedFile {
    ...
    public static SubLObject pph_regression_item_p(final SubLObject v_object) {
        return v_object.getClass() == pph_regression.$pph_regression_item_native.class ? T : NIL;
    }

    public static SubLObject pph_regression_item_test_case(final SubLObject v_object) {
        assert NIL != pph_regression_item_p(v_object) : "pph_regression.pph_regression_item_p(v_object) " + "CommonSymbols.NIL != pph_regression.pph_regression_item_p(v_object) " + v_object;
    ...
    public static SubLObject make_pph_regression_item(SubLObject arglist) {
        ...
        final SubLObject v_new = new pph_regression.$pph_regression_item_native();
        SubLObject next;
    ...
    public static final class $pph_regression_item_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(pph_regression.$pph_regression_item_native.class, PPH_REGRESSION_ITEM, PPH_REGRESSION_ITEM_P, $list18, $list19, new String[]{ "$test_case", "$purpose", "$excused", "$language_mt", "$domain_mt" }, $list20, $list21, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
