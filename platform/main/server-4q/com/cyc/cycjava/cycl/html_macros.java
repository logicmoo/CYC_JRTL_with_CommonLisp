...
import static com.cyc.cycjava.cycl.html_utilities.html_meta_utf_8_content_type;
...
public final class html_macros extends SubLTranslatedFile {
	...
	public static final SubLList $list340 = list(new SubLObject[] { makeKeyword("ONABORT"), makeKeyword("ONBLUR"), makeKeyword("ONCHANGE"), makeKeyword("ONCLICK"), makeKeyword("ONDBLCLICK"), makeKeyword("ONDRAGDROP"), makeKeyword("ONERROR"), makeKeyword("ONFOCUS"), makeKeyword("ONKEYDOWN"), makeKeyword("ONKEYPRESS"), makeKeyword("ONKEYUP"), makeKeyword("ONLOAD"), makeKeyword("ONMOUSEDOWN"),
			makeKeyword("ONMOUSEMOVE"), makeKeyword("ONMOUSEOUT"), makeKeyword("ONMOUSEOVER"), makeKeyword("ONMOUSEUP"), makeKeyword("ONMOVE"), makeKeyword("ONRESET"), makeKeyword("ONRESIZE"), makeKeyword("ONSELECT"), makeKeyword("ONSUBMIT"), makeKeyword("ONUNLOAD") });
	...
	private static final SubLList $list359 = list(
			list(new SubLObject[] { makeSymbol("&KEY"), list(makeSymbol("SHOW-COPYRIGHT"), T), makeSymbol("BACKGROUND-IMAGE"), makeSymbol("BACKGROUND-COLOR"), makeSymbol("CLASS"), makeSymbol("TEXT-COLOR"), makeSymbol("LINK-COLOR"), makeSymbol("ACTIVE-LINK-COLOR"), makeSymbol("VISITED-LINK-COLOR"), makeSymbol("SCRIPT"), makeSymbol("ONLOAD"), makeSymbol("ONRESIZE"), makeSymbol("STYLE") }), makeSymbol("&BODY"),
			makeSymbol("BODY"));
	...
	public static final SubLList $list637 = list(new SubLObject[] { makeKeyword("ID"), makeKeyword("NAME"), makeKeyword("VALUE"), makeKeyword("CHECKED"), makeKeyword("DISABLED?"), makeKeyword("READONLY"), makeKeyword("SIZE"), makeKeyword("MAXLENGTH"), makeKeyword("SRC"), makeKeyword("ALIGN"), makeKeyword("BORDER"), makeKeyword("MIN"), makeKeyword("MAX"), makeKeyword("STEP"), makeKeyword("SCRIPT"),
			makeKeyword("STYLE"), makeKeyword("ONCHANGE"), makeKeyword("ONCLICK"), makeKeyword("ONBLUR"), makeKeyword("ONFOCUS"), makeKeyword("ONKEYUP"), makeKeyword("ONKEYDOWN"), makeKeyword("ONKEYPRESS"), makeKeyword("ALT"), makeKeyword("CLASS"), makeKeyword("TITLE") });
	...
	public static SubLObject html_autocomplete_textarea(final SubLObject macroform, final SubLObject environment) {
		...
		if (NIL == current) {
			...
			return list(PIF, $list986,
					list(CLET, list(bq_cons(id_num, $list987), list(autocomplete_id, list(FORMAT_NIL, $str989$autocomplete__A, id_num)), list(input_id, list(FORMAT_NIL, $str990$input__A, id_num)), list(result_id, list(FORMAT_NIL, $str991$autocomplete_results__A, id_num))),
							list(HTML_FANCY_DIV, listS($ID, autocomplete_id, $list993), listS(HTML_FANCY_TEXTAREA, listS(name, new SubLObject[] { $CLASS, $str994$yui_ac_input, $ID, input_id, $COLS, cols, $ROWS, rows, $list995 }), append(body, NIL)), list(HTML_FANCY_DIV, listS($ID, result_id, $list996))), list(HTML_PRINT_JS_AUTOCOMPLETE_SETUP_INT, input_id, result_id, TWENTY_INTEGER, THREE_INTEGER, NIL, cycl_type)),
					listS(HTML_FANCY_TEXTAREA, list(name, $COLS, cols, $ROWS, rows), append(body, NIL)));
		}
	...
	public static SubLObject with_html_state(final SubLObject macroform, final SubLObject environment) {
		...
		return list(CLET, list(list(state_var, list(HTML_MACHINE_STATE, machine)), list(lock_var, list(HTML_MACHINE_STATE_LOCK, state_var)), v_variables, values), list(WITH_LOCK_HELD, list(lock_var), list(CSETQ, v_variables, list(HTML_MACHINE_STATE_VARIABLES, state_var)), list(CSETQ, values, list(HTML_MACHINE_STATE_VALUES, state_var))),
				listS(CPROGV, v_variables, values, append(body, list(list(SNAPSHOT_HTML_STATE, state_var)))));
	}
	...
	public static SubLObject note_cgi_handler_function(final SubLObject symbol, SubLObject type_symbol) {
		if (type_symbol == UNPROVIDED) {
			type_symbol = makeKeyword("HTML-HANDLER");
		}
		put(symbol, $html_handler_property$.getGlobalValue(), T);
		final SubLObject get_handler_mime_type_hash = get_handler_mime_type_hash();
		Hashtables.sethash(symbol, get_handler_mime_type_hash, type_symbol);
		return T;
	}

	/**
	 * Note that SYMBOL has been defined via DEFINE-HTML-HANDLER
	 */
	@LispMethod(comment = "Note that SYMBOL has been defined via DEFINE-HTML-HANDLER")
	public static final SubLObject note_html_handler_function(SubLObject symbol) {
		return note_cgi_handler_function(symbol, UNPROVIDED);
	}

	public static SubLObject get_handler_mime_type_hash() {
		final SubLObject globalValue = $handler_mime_types$.getGlobalValue();
		final SubLObject dictionary_p2 = dictionary.dictionary_p(globalValue);
		if ((NIL == globalValue) || (NIL != dictionary_p2)) {
			final SubLObject make_hash_table2 = make_hash_table($int$200, EQ, UNPROVIDED);
			$handler_mime_types$.setGlobalValue(make_hash_table2);
			return make_hash_table2;
		}
		return globalValue;
	}
	...
	public static SubLObject cgi_handler_functionP(final SubLObject symbol) {
		final SubLObject get_handler_mime_type_hash = get_handler_mime_type_hash();
		final SubLObject gethash2 = gethash(symbol, get_handler_mime_type_hash, UNPROVIDED);
		return list_utilities.sublisp_boolean(gethash2);
	}
	...
	public static SubLObject init_html_macros_file() {
		...
		defparameter("*HTML-COLOR-MAP*",
				list(new SubLObject[] { bq_cons($BLACK, $html_color_black$.getGlobalValue()), bq_cons($BLUE, $html_color_sat_blue$.getGlobalValue()), bq_cons($GREEN, $html_color_sat_green$.getGlobalValue()), $list315, bq_cons($RED, $html_color_sat_red$.getGlobalValue()), $list317, bq_cons($YELLOW, $html_color_sat_yellow$.getGlobalValue()), bq_cons($WHITE, $html_color_white$.getGlobalValue()),
						bq_cons($DARK_BLUE, $html_color_dark_blue$.getGlobalValue()), $list321, bq_cons($LIGHTER_BLUE, $html_color_lighter_blue$.getGlobalValue()), bq_cons($DARK_RED, $html_color_dark_red$.getGlobalValue()), $list324, $list325, bq_cons($LIGHTER_RED, $html_color_lighter_red$.getGlobalValue()), bq_cons($DARK_YELLOW, $html_color_dark_yellow$.getGlobalValue()), $list328,
						bq_cons($LIGHTER_YELLOW, $html_color_lighter_yellow$.getGlobalValue()), bq_cons($DARK_GRAY, $html_color_dark_grey$.getGlobalValue()), $list331, bq_cons($LIGHT_GREY, $html_color_light_grey$.getGlobalValue()), bq_cons($LIGHTER_GRAY, $html_color_lighter_grey$.getGlobalValue()), bq_cons($LIGHTEST_GREY, $html_color_lightest_grey$.getGlobalValue()),
						bq_cons($DARK_PURPLE, $html_color_dark_purple$.getGlobalValue()), bq_cons($LIGHT_PURPLE, $html_color_light_purple$.getGlobalValue()), bq_cons($LIGHTER_PURPLE, $html_color_lighter_purple$.getGlobalValue()) }));
