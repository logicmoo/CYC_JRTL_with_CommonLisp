...
public final class rkf_relevance_utilities
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject rkf_irrelevant_precision_suggestion_from(final SubLObject to_term, final SubLObject from_term, final SubLObject domain_mt)
  {
    return makeBoolean( NIL != forts.fort_p( to_term ) && NIL != forts.fort_p( from_term ) && ( NIL != forts.invalid_fortP( to_term ) || NIL != forts.invalid_fortP( from_term )
        || NIL != cached_rkf_irrelevant_precision_suggestion_fort( to_term, domain_mt ) || NIL != rkf_irrelevant_precision_suggestion_fort_pairP( to_term, from_term, domain_mt ) ) );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $cached_rkf_irrelevant_precision_suggestion_fort_caching_state$.getGlobalValue(), ConsesLow.list( fort, domain_mt ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject cached_rkf_irrelevant_precision_suggestion_fort(final SubLObject fort, final SubLObject domain_mt)
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym0$CACHED_RKF_IRRELEVANT_PRECISION_SUGGESTION_FORT, $sym1$_CACHED_RKF_IRRELEVANT_PRECISION_SUGGESTION_FORT_CACHING_STATE_, NIL, EQL,
          TWO_INTEGER, TEN_INTEGER );
    }
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( cached_rkf_irrelevant_precision_suggestion_fort_internal( fort, domain_mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( fort, domain_mt ) );
  ...
  {
    return list_utilities.sublisp_boolean( backward.removal_ask( ConsesLow.list( $const2$keIrrelevantPrecisionSuggestion, fort ), domain_mt, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $cached_rkf_irrelevant_arg_constraint_fort_caching_state$.getGlobalValue(), ConsesLow.list( fort, domain_mt ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject cached_rkf_irrelevant_arg_constraint_fort(final SubLObject fort, final SubLObject domain_mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym3$CACHED_RKF_IRRELEVANT_ARG_CONSTRAINT_FORT, $sym4$_CACHED_RKF_IRRELEVANT_ARG_CONSTRAINT_FORT_CACHING_STATE_, NIL, EQL, TWO_INTEGER,
          TEN_INTEGER );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_2( fort, domain_mt );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( cached_rkf_irrelevant_arg_constraint_fort_internal( fort, domain_mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( fort, domain_mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  {
    return list_utilities.sublisp_boolean( backward.removal_ask( ConsesLow.list( $const5$keIrrelevantArgConstraint, fort ), domain_mt, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject rkf_irrelevant_term(final SubLObject v_term, final SubLObject domain_mt)
  {
    ...
    if( pcase_var.eql( $kw6$IRRELEVANT_EVERYWHERE ) )
    {
      return T;
    }
    if( pcase_var.eql( $kw7$IRRELEVANT_NOWHERE ) )
    {
      return NIL;
    }
    if( cached_result == $kw8$IRRELEVANT_SOMEWHERE && domain_mt.eql( $const9$InferencePSC ) )
    {
      return T;
    }
  ...
  public static SubLObject rkf_filter_irrelevant_formulas(final SubLObject formulas, final SubLObject domain_mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        v_answer = ConsesLow.cons( formula, v_answer );
      }
      cdolist_list_var = cdolist_list_var.rest();
      formula = cdolist_list_var.first();
    }
  ...
  public static SubLObject rkf_remove_irrelevant_clauses(final SubLObject formula, final SubLObject mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        ...
        {
          filtered_dnfs = ConsesLow.cons( clauses.make_clause( filtered_neg_lits, filtered_pos_lits ), filtered_dnfs );
        }
      }
      else
      {
  ...
  public static SubLObject compute_fort_irrelevant_everywhere_status(final SubLObject fort, SubLObject problem_store)
  {
    ...
    {
      return makeBoolean( NIL != fort_has_pro_irrelevant_argumentP( fort, $const12$BaseKB, problem_store ) && NIL == fort_has_con_irrelevant_argumentP( fort, $const9$InferencePSC, problem_store ) );
    }
    SubLObject ans = NIL;
  ...
  public static SubLObject compute_fort_irrelevant_nowhere_status(final SubLObject fort, SubLObject problem_store)
  {
    ...
    if( NIL != inference_datastructures_problem_store.valid_problem_store_p( problem_store ) )
    {
      return makeBoolean( NIL == fort_has_pro_irrelevant_argumentP( fort, $const9$InferencePSC, problem_store ) );
    }
    SubLObject ans = NIL;
    SubLObject store = NIL;
    try
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $cached_rkf_irrelevant_fort_caching_state$.getGlobalValue(), ConsesLow.list( fort, domain_mt ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject cached_rkf_irrelevant_fort(final SubLObject fort, final SubLObject domain_mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym13$CACHED_RKF_IRRELEVANT_FORT, $sym14$_CACHED_RKF_IRRELEVANT_FORT_CACHING_STATE_, NIL, EQL, TWO_INTEGER, TEN_INTEGER );
      memoization_state.register_hl_store_cache_clear_callback( $sym15$CLEAR_CACHED_RKF_IRRELEVANT_FORT );
    }
    final SubLObject sxhash = memoization_state.sxhash_calc_2( fort, domain_mt );
    final SubLObject collisions = memoization_state.caching_state_lookup( caching_state, sxhash, UNPROVIDED );
    if( !collisions.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( cached_rkf_irrelevant_fort_internal( fort, domain_mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( fort, domain_mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject rkf_irrelevant_fort_internal(final SubLObject fort, final SubLObject domain_mt)
  {
    ...
    {
      store = inference_datastructures_problem_store.new_problem_store( NIL );
      ans = makeBoolean( ( NIL != fort_has_pro_irrelevant_argumentP( fort, domain_mt, store ) && NIL == fort_has_con_irrelevant_argumentP( fort, domain_mt, store ) ) || ( NIL != nart_handles.nart_p( fort )
          && NIL != rkf_irrelevant_formula( function_terms.nart_to_naut( fort ), domain_mt ) ) );
    }
    finally
    {
      final SubLObject _prev_bind_0 = Dynamic.currentBinding( Threads.$is_thread_performing_cleanupP$ );
  ...
  {
    return ConsesLow.list( $const16$keIrrelevantTerm, fort );
  }
  ...
  {
    return ConsesLow.list( $kw17$INFERENCE_MODE, $kw18$MINIMAL, $kw19$ALLOWED_MODULES, ConsesLow.list( $kw20$NOT, $kw21$REMOVAL_RKF_IRRELEVANT_FORT_CACHE_CHECK_POS ), $kw22$PROBLEM_STORE, problem_store );
  }
  ...
  public static SubLObject rkf_quoted_term_formula(final SubLObject fort, final SubLObject formula)
  {
    ...
    if( pcase_var.eql( $const23$termOfUnit ) )
    {
      return T;
    }
    if( pcase_var.eql( $const24$sourceOfTerm ) )
    {
      return NIL;
    }
    if( pcase_var.eql( $const25$quotedIsa ) )
    {
      return T;
    }
    if( NIL != kb_accessors.some_quoted_argumentP( predicate ) )
    {
      ...
      final SubLObject args = cdolist_list_var = cycl_utilities.formula_args( formula, $kw26$IGNORE );
      SubLObject arg = NIL;
  ...
  {
    SubLFiles.declareFunction( me, "rkf_irrelevant_precision_suggestion", "RKF-IRRELEVANT-PRECISION-SUGGESTION", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_irrelevant_precision_suggestion_from", "RKF-IRRELEVANT-PRECISION-SUGGESTION-FROM", 3, 0, false );
    SubLFiles.declareFunction( me, "clear_cached_rkf_irrelevant_precision_suggestion_fort", "CLEAR-CACHED-RKF-IRRELEVANT-PRECISION-SUGGESTION-FORT", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_cached_rkf_irrelevant_precision_suggestion_fort", "REMOVE-CACHED-RKF-IRRELEVANT-PRECISION-SUGGESTION-FORT", 2, 0, false );
    SubLFiles.declareFunction( me, "cached_rkf_irrelevant_precision_suggestion_fort_internal", "CACHED-RKF-IRRELEVANT-PRECISION-SUGGESTION-FORT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "cached_rkf_irrelevant_precision_suggestion_fort", "CACHED-RKF-IRRELEVANT-PRECISION-SUGGESTION-FORT", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_irrelevant_precision_suggestion_fort_internal", "RKF-IRRELEVANT-PRECISION-SUGGESTION-FORT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_irrelevant_precision_suggestion_fort_pairP", "RKF-IRRELEVANT-PRECISION-SUGGESTION-FORT-PAIR?", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_irrelevant_arg_constraint", "RKF-IRRELEVANT-ARG-CONSTRAINT", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_cached_rkf_irrelevant_arg_constraint_fort", "CLEAR-CACHED-RKF-IRRELEVANT-ARG-CONSTRAINT-FORT", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_cached_rkf_irrelevant_arg_constraint_fort", "REMOVE-CACHED-RKF-IRRELEVANT-ARG-CONSTRAINT-FORT", 2, 0, false );
    SubLFiles.declareFunction( me, "cached_rkf_irrelevant_arg_constraint_fort_internal", "CACHED-RKF-IRRELEVANT-ARG-CONSTRAINT-FORT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "cached_rkf_irrelevant_arg_constraint_fort", "CACHED-RKF-IRRELEVANT-ARG-CONSTRAINT-FORT", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_irrelevant_arg_constraint_fort_internal", "RKF-IRRELEVANT-ARG-CONSTRAINT-FORT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_irrelevant_term", "RKF-IRRELEVANT-TERM", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_filter_irrelevant_terms", "RKF-FILTER-IRRELEVANT-TERMS", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_irrelevant_term_lambdaP", "RKF-IRRELEVANT-TERM-LAMBDA?", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_irrelevant_formula", "RKF-IRRELEVANT-FORMULA", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_filter_irrelevant_formulas", "RKF-FILTER-IRRELEVANT-FORMULAS", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_remove_irrelevant_clauses", "RKF-REMOVE-IRRELEVANT-CLAUSES", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_irrelevant_term_formula", "RKF-IRRELEVANT-TERM-FORMULA", 3, 0, false );
    SubLFiles.declareFunction( me, "compute_fort_irrelevant_everywhere_status", "COMPUTE-FORT-IRRELEVANT-EVERYWHERE-STATUS", 1, 1, false );
    SubLFiles.declareFunction( me, "compute_fort_irrelevant_nowhere_status", "COMPUTE-FORT-IRRELEVANT-NOWHERE-STATUS", 1, 1, false );
    SubLFiles.declareFunction( me, "clear_cached_rkf_irrelevant_fort", "CLEAR-CACHED-RKF-IRRELEVANT-FORT", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_cached_rkf_irrelevant_fort", "REMOVE-CACHED-RKF-IRRELEVANT-FORT", 2, 0, false );
    SubLFiles.declareFunction( me, "cached_rkf_irrelevant_fort_internal", "CACHED-RKF-IRRELEVANT-FORT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "cached_rkf_irrelevant_fort", "CACHED-RKF-IRRELEVANT-FORT", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_irrelevant_fort_internal", "RKF-IRRELEVANT-FORT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "irrelevance_sentence_for_fort", "IRRELEVANCE-SENTENCE-FOR-FORT", 1, 0, false );
    SubLFiles.declareFunction( me, "irrelevance_query_properties", "IRRELEVANCE-QUERY-PROPERTIES", 1, 0, false );
    SubLFiles.declareFunction( me, "fort_has_pro_irrelevant_argumentP", "FORT-HAS-PRO-IRRELEVANT-ARGUMENT?", 3, 0, false );
    SubLFiles.declareFunction( me, "fort_has_con_irrelevant_argumentP", "FORT-HAS-CON-IRRELEVANT-ARGUMENT?", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_quoted_term_formula", "RKF-QUOTED-TERM-FORMULA", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_rkf_relevance_utilities_file()
  {
    $cached_rkf_irrelevant_precision_suggestion_fort_caching_state$ = SubLFiles.deflexical( "*CACHED-RKF-IRRELEVANT-PRECISION-SUGGESTION-FORT-CACHING-STATE*", NIL );
    $cached_rkf_irrelevant_arg_constraint_fort_caching_state$ = SubLFiles.deflexical( "*CACHED-RKF-IRRELEVANT-ARG-CONSTRAINT-FORT-CACHING-STATE*", NIL );
    $rkf_irrelevant_term_lambda_domain_mt$ = SubLFiles.defparameter( "*RKF-IRRELEVANT-TERM-LAMBDA-DOMAIN-MT*", NIL );
    $cached_rkf_irrelevant_fort_caching_state$ = SubLFiles.deflexical( "*CACHED-RKF-IRRELEVANT-FORT-CACHING-STATE*", NIL );
    return NIL;
  }

  public static SubLObject setup_rkf_relevance_utilities_file()
  {
    memoization_state.note_globally_cached_function( $sym0$CACHED_RKF_IRRELEVANT_PRECISION_SUGGESTION_FORT );
    memoization_state.note_globally_cached_function( $sym3$CACHED_RKF_IRRELEVANT_ARG_CONSTRAINT_FORT );
    memoization_state.note_globally_cached_function( $sym13$CACHED_RKF_IRRELEVANT_FORT );
    return NIL;
  }
  ...
  static
  {
    me = new rkf_relevance_utilities();
    $cached_rkf_irrelevant_precision_suggestion_fort_caching_state$ = null;
    $cached_rkf_irrelevant_arg_constraint_fort_caching_state$ = null;
    $rkf_irrelevant_term_lambda_domain_mt$ = null;
    $cached_rkf_irrelevant_fort_caching_state$ = null;
    $sym0$CACHED_RKF_IRRELEVANT_PRECISION_SUGGESTION_FORT = makeSymbol( "CACHED-RKF-IRRELEVANT-PRECISION-SUGGESTION-FORT" );
    $sym1$_CACHED_RKF_IRRELEVANT_PRECISION_SUGGESTION_FORT_CACHING_STATE_ = makeSymbol( "*CACHED-RKF-IRRELEVANT-PRECISION-SUGGESTION-FORT-CACHING-STATE*" );
    $const2$keIrrelevantPrecisionSuggestion = constant_handles.reader_make_constant_shell( makeString( "keIrrelevantPrecisionSuggestion" ) );
    $sym3$CACHED_RKF_IRRELEVANT_ARG_CONSTRAINT_FORT = makeSymbol( "CACHED-RKF-IRRELEVANT-ARG-CONSTRAINT-FORT" );
    $sym4$_CACHED_RKF_IRRELEVANT_ARG_CONSTRAINT_FORT_CACHING_STATE_ = makeSymbol( "*CACHED-RKF-IRRELEVANT-ARG-CONSTRAINT-FORT-CACHING-STATE*" );
    $const5$keIrrelevantArgConstraint = constant_handles.reader_make_constant_shell( makeString( "keIrrelevantArgConstraint" ) );
    $kw6$IRRELEVANT_EVERYWHERE = makeKeyword( "IRRELEVANT-EVERYWHERE" );
    $kw7$IRRELEVANT_NOWHERE = makeKeyword( "IRRELEVANT-NOWHERE" );
    $kw8$IRRELEVANT_SOMEWHERE = makeKeyword( "IRRELEVANT-SOMEWHERE" );
    $const9$InferencePSC = constant_handles.reader_make_constant_shell( makeString( "InferencePSC" ) );
    $sym10$RKF_IRRELEVANT_TERM_LAMBDA_ = makeSymbol( "RKF-IRRELEVANT-TERM-LAMBDA?" );
    $list11 = ConsesLow.list( makeSymbol( "NEG-LITS" ), makeSymbol( "POS-LITS" ) );
    $const12$BaseKB = constant_handles.reader_make_constant_shell( makeString( "BaseKB" ) );
    $sym13$CACHED_RKF_IRRELEVANT_FORT = makeSymbol( "CACHED-RKF-IRRELEVANT-FORT" );
    $sym14$_CACHED_RKF_IRRELEVANT_FORT_CACHING_STATE_ = makeSymbol( "*CACHED-RKF-IRRELEVANT-FORT-CACHING-STATE*" );
    $sym15$CLEAR_CACHED_RKF_IRRELEVANT_FORT = makeSymbol( "CLEAR-CACHED-RKF-IRRELEVANT-FORT" );
    $const16$keIrrelevantTerm = constant_handles.reader_make_constant_shell( makeString( "keIrrelevantTerm" ) );
    $kw17$INFERENCE_MODE = makeKeyword( "INFERENCE-MODE" );
    $kw18$MINIMAL = makeKeyword( "MINIMAL" );
    $kw19$ALLOWED_MODULES = makeKeyword( "ALLOWED-MODULES" );
    $kw20$NOT = makeKeyword( "NOT" );
    $kw21$REMOVAL_RKF_IRRELEVANT_FORT_CACHE_CHECK_POS = makeKeyword( "REMOVAL-RKF-IRRELEVANT-FORT-CACHE-CHECK-POS" );
    ...
    $const24$sourceOfTerm = constant_handles.reader_make_constant_shell( makeString( "sourceOfTerm" ) );
    $const25$quotedIsa = constant_handles.reader_make_constant_shell( makeString( "quotedIsa" ) );
