...
public final class pph_question extends SubLTranslatedFile {
    ...
    public static final SubLSymbol $sym2$VALID_EXTERNAL_PPH_NL_PREDS_ = makeSymbol("VALID-EXTERNAL-PPH-NL-PREDS?");
    ...
    public static final SubLList $list11 = list(reader_make_constant_shell(makeString("tensed")));
    ...
    public static final SubLString $str19$__Leaving_PPH_POSSIBLY_BINDING_VA = makeString("~&Leaving PPH-POSSIBLY-BINDING-VARIABLES(~S), vars in local *pph-var-types* were ~s ");

    public static final SubLString $str20$______and__pph_var_types__are_now = makeString("~&... and *pph-var-types* are now ~S~%");
    ...
    public static final SubLString $$$if = makeString("if");

    public static final SubLList $list27 = list(ZERO_INTEGER);

    private static final SubLObject $$implies = reader_make_constant_shell(makeString("implies"));

    public static final SubLList $list29 = list(makeSymbol("GENERATE-QUESTION-FROM-GENQUESTION"), makeSymbol("GENERATE-WITH-SUBJ-AUX-INVERSION"));

    public static final SubLSymbol $sym30$PAST_TENSE_FORM_ = makeSymbol("PAST-TENSE-FORM?");

    private static final SubLObject $$pastTense_Generic = reader_make_constant_shell(makeString("pastTense-Generic"));

    public static final SubLSymbol $sym32$_PAST_TENSE_FORM__CACHING_STATE_ = makeSymbol("*PAST-TENSE-FORM?-CACHING-STATE*");
    ...
    public static final SubLString $str37$__Trying____S = makeString("~&Trying~% ~S");
    ...
    private static final SubLList $list93 = list(makeKeyword("BLANKS"), makeKeyword("VARS"));
    ...
    private static final SubLList $list108 = list(reader_make_constant_shell(makeString("plural-Generic")));
    ...
    private static final SubLObject $$Modal = reader_make_constant_shell(makeString("Modal"));
    ...
    public static SubLObject declare_pph_question_file() {
        declareFunction(me, "generate_question", "GENERATE-QUESTION", 1, 4, false);
        declareFunction(me, "pph_standardize_query_sentence", "PPH-STANDARDIZE-QUERY-SENTENCE", 1, 0, false);
        declareFunction(me, "pph_standardize_query_term", "PPH-STANDARDIZE-QUERY-TERM", 1, 0, false);
        declareFunction(me, "pph_default_question_preds", "PPH-DEFAULT-QUESTION-PREDS", 0, 0, false);
        declareFunction(me, "pph_question_clause", "PPH-QUESTION-CLAUSE", 2, 0, false);
        declareFunction(me, "pph_question_clause_memoized_internal", "PPH-QUESTION-CLAUSE-MEMOIZED-INTERNAL", 2, 3, false);
        declareFunction(me, "pph_question_clause_memoized", "PPH-QUESTION-CLAUSE-MEMOIZED", 2, 3, false);
        declareFunction(me, "pph_remove_hypothetical", "PPH-REMOVE-HYPOTHETICAL", 1, 1, false);
        declareFunction(me, "pph_hypothesize_antecedent_varsP", "PPH-HYPOTHESIZE-ANTECEDENT-VARS?", 1, 0, false);
        declareFunction(me, "pph_question_register_hypothetical_vars", "PPH-QUESTION-REGISTER-HYPOTHETICAL-VARS", 1, 0, false);
        declareFunction(me, "pph_add_hypothetical_paraphrase", "PPH-ADD-HYPOTHETICAL-PARAPHRASE", 7, 0, false);
        declareFunction(me, "generate_question_non_propositional", "GENERATE-QUESTION-NON-PROPOSITIONAL", 2, 0, false);
        declareFunction(me, "question_paraphrase_availableP", "QUESTION-PARAPHRASE-AVAILABLE?", 1, 3, false);
        declareFunction(me, "clear_past_tense_formP", "CLEAR-PAST-TENSE-FORM?", 0, 0, false);
        declareFunction(me, "remove_past_tense_formP", "REMOVE-PAST-TENSE-FORM?", 1, 1, false);
        declareFunction(me, "past_tense_formP_internal", "PAST-TENSE-FORM?-INTERNAL", 2, 0, false);
        declareFunction(me, "past_tense_formP", "PAST-TENSE-FORM?", 1, 1, false);
        declareFunction(me, "prefer_past_tense_formP", "PREFER-PAST-TENSE-FORM?", 1, 0, false);
        declareFunction(me, "generate_question_from_genquestion", "GENERATE-QUESTION-FROM-GENQUESTION", 1, 2, false);
        declareFunction(me, "pph_question_arg", "PPH-QUESTION-ARG", 1, 0, false);
        declareFunction(me, "get_genquestion_formula", "GET-GENQUESTION-FORMULA", 2, 0, false);
        declareFunction(me, "get_genq_bindings", "GET-GENQ-BINDINGS", 1, 0, false);
        declareFunction(me, "pph_blank_count", "PPH-BLANK-COUNT", 1, 0, false);
        declareFunction(me, "generate_question_from_query_template", "GENERATE-QUESTION-FROM-QUERY-TEMPLATE", 1, 2, false);
        declareFunction(me, "pph_phrase_ok_for_gtqsP", "PPH-PHRASE-OK-FOR-GTQS?", 2, 0, false);
        declareFunction(me, "clear_gen_template_query_sentence_index", "CLEAR-GEN-TEMPLATE-QUERY-SENTENCE-INDEX", 0, 0, false);
        declareFunction(me, "add_gen_template_query_sentence", "ADD-GEN-TEMPLATE-QUERY-SENTENCE", 2, 0, false);
        declareFunction(me, "remove_gen_template_query_sentence", "REMOVE-GEN-TEMPLATE-QUERY-SENTENCE", 2, 0, false);
        declareFunction(me, "initialize_gen_template_query_sentence_index", "INITIALIZE-GEN-TEMPLATE-QUERY-SENTENCE-INDEX", 0, 0, false);
        declareFunction(me, "gen_template_query_sentence_lookup", "GEN-TEMPLATE-QUERY-SENTENCE-LOOKUP", 1, 0, false);
        declareFunction(me, "pph_visible_lexical_assertionP", "PPH-VISIBLE-LEXICAL-ASSERTION?", 1, 0, false);
        declareFunction(me, "gen_template_query_sentence_candidates", "GEN-TEMPLATE-QUERY-SENTENCE-CANDIDATES", 1, 0, false);
        declareFunction(me, "gtqs_assertions_for_query_sentence", "GTQS-ASSERTIONS-FOR-QUERY-SENTENCE", 2, 0, false);
        declareFunction(me, "gtqs_assertion_constant_count", "GTQS-ASSERTION-CONSTANT-COUNT", 1, 0, false);
        declareFunction(me, "gtqs_assertion_matches_query_sentenceP", "GTQS-ASSERTION-MATCHES-QUERY-SENTENCE?", 2, 1, false);
        declareFunction(me, "gtqs_assertion_bindings_for_query_sentence_internal", "GTQS-ASSERTION-BINDINGS-FOR-QUERY-SENTENCE-INTERNAL", 2, 1, false);
        declareFunction(me, "gtqs_assertion_bindings_for_query_sentence", "GTQS-ASSERTION-BINDINGS-FOR-QUERY-SENTENCE", 2, 1, false);
        declareFunction(me, "hlify_gtqs_template_variables", "HLIFY-GTQS-TEMPLATE-VARIABLES", 1, 0, false);
        declareFunction(me, "non_hypothesized_el_varP", "NON-HYPOTHESIZED-EL-VAR?", 1, 0, false);
        declareFunction(me, "gtqs_bindings_from_unification_bindings", "GTQS-BINDINGS-FROM-UNIFICATION-BINDINGS", 4, 0, false);
        declareFunction(me, "gtqs_one_arg_position", "GTQS-ONE-ARG-POSITION", 2, 0, false);
        declareFunction(me, "gtqs_specified_arg_matchesP", "GTQS-SPECIFIED-ARG-MATCHES?", 4, 0, false);
        declareFunction(me, "pph_query_sentence_template_keywords", "PPH-QUERY-SENTENCE-TEMPLATE-KEYWORDS", 1, 0, false);
        declareFunction(me, "pph_query_sentence_template_vars", "PPH-QUERY-SENTENCE-TEMPLATE-VARS", 1, 0, false);
        declareFunction(me, "pph_question_template_unify", "PPH-QUESTION-TEMPLATE-UNIFY", 2, 0, false);
        declareFunction(me, "pph_hide_el_vars", "PPH-HIDE-EL-VARS", 1, 0, false);
        declareFunction(me, "pph_unhide_el_vars", "PPH-UNHIDE-EL-VARS", 1, 0, false);
        declareFunction(me, "pph_unify_possible_formula", "PPH-UNIFY-POSSIBLE-FORMULA", 2, 0, false);
        declareFunction(me, "pph_unify_possible_args", "PPH-UNIFY-POSSIBLE-ARGS", 2, 0, false);
        declareFunction(me, "pph_unify_check_recursion_depth", "PPH-UNIFY-CHECK-RECURSION-DEPTH", 0, 0, false);
        declareFunction(me, "pph_commutative_functor_p", "PPH-COMMUTATIVE-FUNCTOR-P", 1, 0, false);
        declareFunction(me, "pph_unify_gtqs", "PPH-UNIFY-GTQS", 2, 0, false);
        declareFunction(me, "pph_unify_formula_template", "PPH-UNIFY-FORMULA-TEMPLATE", 2, 1, false);
        declareFunction(me, "pph_unify_formula_template_memoized_internal", "PPH-UNIFY-FORMULA-TEMPLATE-MEMOIZED-INTERNAL", 3, 0, false);
        declareFunction(me, "pph_unify_formula_template_memoized", "PPH-UNIFY-FORMULA-TEMPLATE-MEMOIZED", 3, 0, false);
        declareFunction(me, "unification_bindings_from_result", "UNIFICATION-BINDINGS-FROM-RESULT", 1, 0, false);
        declareFunction(me, "pph_unify_args", "PPH-UNIFY-ARGS", 3, 0, false);
        declareFunction(me, "pph_unify_args_memoized_internal", "PPH-UNIFY-ARGS-MEMOIZED-INTERNAL", 4, 0, false);
        declareFunction(me, "pph_unify_args_memoized", "PPH-UNIFY-ARGS-MEMOIZED", 4, 0, false);
        declareFunction(me, "pph_unify_ordered_args", "PPH-UNIFY-ORDERED-ARGS", 3, 0, false);
        declareFunction(me, "pph_unify_args_permutations", "PPH-UNIFY-ARGS-PERMUTATIONS", 3, 0, false);
        declareFunction(me, "pph_arglist_permutations", "PPH-ARGLIST-PERMUTATIONS", 1, 0, false);
        declareFunction(me, "pph_phrase_for_query_sentence_from_gtqs_as", "PPH-PHRASE-FOR-QUERY-SENTENCE-FROM-GTQS-AS", 3, 0, false);
        declareFunction(me, "replace_gtqs_template_terms", "REPLACE-GTQS-TEMPLATE-TERMS", 4, 0, false);
        declareFunction(me, "dummy_query_sentence_for_gtqs_assertion", "DUMMY-QUERY-SENTENCE-FOR-GTQS-ASSERTION", 1, 0, false);
        declareFunction(me, "verify_all_gtqs_assertions", "VERIFY-ALL-GTQS-ASSERTIONS", 0, 1, false);
        declareFunction(me, "verify_one_gtqs_assertion", "VERIFY-ONE-GTQS-ASSERTION", 2, 0, false);
        declareFunction(me, "verify_one_gtqs_assertion_with_query_sentence", "VERIFY-ONE-GTQS-ASSERTION-WITH-QUERY-SENTENCE", 3, 0, false);
        declareFunction(me, "generate_question_bf", "GENERATE-QUESTION-BF", 1, 3, false);
        declareFunction(me, "pph_brute_force_yes_no_preamble_strings", "PPH-BRUTE-FORCE-YES-NO-PREAMBLE-STRINGS", 0, 2, false);
        declareFunction(me, "pph_brute_force_true_or_false_string", "PPH-BRUTE-FORCE-TRUE-OR-FALSE-STRING", 1, 0, false);
        declareFunction(me, "pph_brute_force_false_string", "PPH-BRUTE-FORCE-FALSE-STRING", 0, 0, false);
        declareFunction(me, "pph_brute_force_capitalize_false_string_p", "PPH-BRUTE-FORCE-CAPITALIZE-FALSE-STRING-P", 0, 0, false);
        declareFunction(me, "pph_brute_force_wh_preamble_olist", "PPH-BRUTE-FORCE-WH-PREAMBLE-OLIST", 5, 0, false);
        declareFunction(me, "pph_brute_force_wh_phrase_olist", "PPH-BRUTE-FORCE-WH-PHRASE-OLIST", 4, 0, false);
        declareFunction(me, "new_pph_phrase_filler_item", "NEW-PPH-PHRASE-FILLER-ITEM", 1, 0, false);
        declareFunction(me, "new_pph_phrase_filler_items", "NEW-PPH-PHRASE-FILLER-ITEMS", 1, 0, false);
        declareFunction(me, "pph_brute_force_olist_set_arg_positions", "PPH-BRUTE-FORCE-OLIST-SET-ARG-POSITIONS", 3, 0, false);
        declareFunction(me, "pph_brute_force_wh_lexify_query_varsP", "PPH-BRUTE-FORCE-WH-LEXIFY-QUERY-VARS?", 2, 0, false);
        declareFunction(me, "pph_question_declarative_string", "PPH-QUESTION-DECLARATIVE-STRING", 2, 3, false);
        declareFunction(me, "pph_remove_redundant_query_var_typing_clauses", "PPH-REMOVE-REDUNDANT-QUERY-VAR-TYPING-CLAUSES", 3, 0, false);
        declareFunction(me, "question_rop_formulaP", "QUESTION-ROP-FORMULA?", 1, 0, false);
        declareFunction(me, "rop_formulaP", "ROP-FORMULA?", 1, 0, false);
        declareFunction(me, "question_var_npP", "QUESTION-VAR-NP?", 1, 0, false);
        declareFunction(me, "pph_phrase_maybe_npP", "PPH-PHRASE-MAYBE-NP?", 1, 0, false);
        declareFunction(me, "el_var_det_nbarP", "EL-VAR-DET-NBAR?", 1, 0, false);
        declareFunction(me, "el_var_np_var", "EL-VAR-NP-VAR", 1, 0, false);
        declareFunction(me, "number_varP", "NUMBER-VAR?", 2, 0, false);
        declareFunction(me, "no_number_varsP", "NO-NUMBER-VARS?", 2, 0, false);
        declareFunction(me, "formula_ok_for_subj_aux_inversionP", "FORMULA-OK-FOR-SUBJ-AUX-INVERSION?", 1, 0, false);
        declareFunction(me, "rmp_formula_to_intermediate_cycl", "RMP-FORMULA-TO-INTERMEDIATE-CYCL", 1, 0, false);
        declareFunction(me, "op_ok_for_i_cyclP", "OP-OK-FOR-I-CYCL?", 1, 0, false);
        declareFunction(me, "remove_var_typing_clauses_from_question_phrase", "REMOVE-VAR-TYPING-CLAUSES-FROM-QUESTION-PHRASE", 1, 0, false);
        declareFunction(me, "generate_with_subj_aux_inversion", "GENERATE-WITH-SUBJ-AUX-INVERSION", 1, 2, false);
        declareFunction(me, "generate_phrase_with_subj_aux_inversion", "GENERATE-PHRASE-WITH-SUBJ-AUX-INVERSION", 4, 1, false);
        declareFunction(me, "find_head_clause", "FIND-HEAD-CLAUSE", 1, 0, false);
        declareFunction(me, "make_question_template", "MAKE-QUESTION-TEMPLATE", 2, 2, false);
        declareFunction(me, "pph_phrase_add_do_supportXinvert", "PPH-PHRASE-ADD-DO-SUPPORT&INVERT", 1, 0, false);
        declareFunction(me, "make_multi_word_perfect_verb", "MAKE-MULTI-WORD-PERFECT-VERB", 1, 0, false);
        declareFunction(me, "question_phraseP", "QUESTION-PHRASE?", 3, 0, false);
        declareFunction(me, "pph_temporal_location_var_phraseP", "PPH-TEMPORAL-LOCATION-VAR-PHRASE?", 1, 0, false);
        declareFunction(me, "find_question_subphrase", "FIND-QUESTION-SUBPHRASE", 1, 0, false);
        declareFunction(me, "find_question_subphrase_int", "FIND-QUESTION-SUBPHRASE-INT", 2, 0, false);
        declareFunction(me, "pph_subphrase_path_p", "PPH-SUBPHRASE-PATH-P", 1, 0, false);
        declareFunction(me, "pph_use_who_for_var_in_formulaP", "PPH-USE-WHO-FOR-VAR-IN-FORMULA?", 2, 0, false);
        declareFunction(me, "pph_use_when_for_phraseP", "PPH-USE-WHEN-FOR-PHRASE?", 1, 0, false);
        declareFunction(me, "string_for_var_in_question_phrase", "STRING-FOR-VAR-IN-QUESTION-PHRASE", 2, 0, false);
        declareFunction(me, "pph_use_whomP", "PPH-USE-WHOM?", 0, 0, false);
        declareFunction(me, "pph_use_whom_for_phraseP", "PPH-USE-WHOM-FOR-PHRASE?", 1, 0, false);
        declareFunction(me, "pph_phrase_set_who_or_whom", "PPH-PHRASE-SET-WHO-OR-WHOM", 1, 1, false);
        declareFunction(me, "pph_new_when_phrase_from_phrase", "PPH-NEW-WHEN-PHRASE-FROM-PHRASE", 1, 0, false);
        declareFunction(me, "pph_find_temporal_location_var_dtr", "PPH-FIND-TEMPORAL-LOCATION-VAR-DTR", 1, 0, false);
        declareFunction(me, "pph_single_entry_varP", "PPH-SINGLE-ENTRY-VAR?", 2, 0, false);
        declareFunction(me, "pph_disjoint_meta_isa_formulaP", "PPH-DISJOINT-META-ISA-FORMULA?", 2, 0, false);
        declareFunction(me, "pph_phrase_subject_head_verb_initialP", "PPH-PHRASE-SUBJECT-HEAD-VERB-INITIAL?", 1, 0, false);
        declareFunction(me, "clear_modal_strings", "CLEAR-MODAL-STRINGS", 0, 0, false);
        declareFunction(me, "remove_modal_strings", "REMOVE-MODAL-STRINGS", 0, 0, false);
        declareFunction(me, "modal_strings_internal", "MODAL-STRINGS-INTERNAL", 0, 0, false);
        declareFunction(me, "modal_strings", "MODAL-STRINGS", 0, 0, false);
        declareFunction(me, "clear_modal_words", "CLEAR-MODAL-WORDS", 0, 0, false);
        declareFunction(me, "remove_modal_words", "REMOVE-MODAL-WORDS", 0, 0, false);
        declareFunction(me, "modal_words_internal", "MODAL-WORDS-INTERNAL", 0, 0, false);
        declareFunction(me, "modal_words", "MODAL-WORDS", 0, 0, false);
        return NIL;
    }
