...
public final class pph_question
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject generate_question(final SubLObject formula, SubLObject language_mt, SubLObject domain_mt, SubLObject mode, SubLObject nl_preds)
  {
    ...
    if( $kw3$DEFAULT == nl_preds )
    {
      nl_preds = pph_utilities.pph_default_nl_preds( formula, $kw4$INTERROGATIVE, language_mt, domain_mt );
    }
        ...
        try
        {
          ...
          try
          {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      try
                      {
                        ...
                        try
                        {
                          ...
                          try
                          {
                            ...
                            try
                            {
                              pph_vars.$pph_cycls$.bind( ConsesLow.cons( pph_standardize_query_sentence( formula ), pph_vars.$pph_cycls$.getDynamicValue( thread ) ), thread );
                              thread.resetMultipleValues();
                              ...
                              {
                                olist = pph_phrase_resolution.pph_phrase_output_list_add_sentential_force( olist, $kw4$INTERROGATIVE );
                      ...
                      if( new_or_reused == $kw5$NEW && NIL != memoization_state.memoization_state_p( pph_macros.$pph_memoization_state$.getDynamicValue( thread ) ) )
                      {
            ...
            else
            {
                      ...
                      try
                      {
                        ...
                        try
                        {
                          ...
                          try
                          {
                            ...
                            if( new_or_reused2 == $kw5$NEW && NIL != memoization_state.memoization_state_p( pph_macros.$pph_memoization_state$.getDynamicValue( thread ) ) )
                            {
                              memoization_state.clear_all_memoization( pph_macros.$pph_memoization_state$.getDynamicValue( thread ) );
                            }
                          }
              ...
              {
                Errors.warn( Sequences.cconcatenate( pph_error_message_truncator.truncate_pph_error_message( error_message ), $str7$___Top_level_CycL___S ), pph_vars.pph_top_level_cycl() );
              }
            }
          }
          finally
    ...
    try
    {
      pph_vars.$pph_link_unlinked_phrases_to_matrix_arg0P$.bind( makeBoolean( NIL != pph_vars.pph_link_unlinked_phrases_to_matrix_arg0P() && NIL == Sequences.find_if( $sym8$GEN_TEMPLATE_QUERY_SENTENCE_ASSERTION_P, just,
  ...
  {
    return cycl_utilities.expression_transform( query_sentence, $sym9$NART_P, $sym10$NART_EL_FORMULA, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return cycl_utilities.expression_transform( query_term, $sym9$NART_P, $sym10$NART_EL_FORMULA, UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/pph-question.lisp", position = 3271L)
  public static SubLObject pph_default_question_preds()
  {
    return conses_high.copy_list( $pph_default_question_preds$.getGlobalValue() );
  }
  ...
  public static SubLObject pph_question_clause_memoized_internal(final SubLObject formula, final SubLObject nl_preds, SubLObject blanksP, SubLObject demerit_cutoff, SubLObject v_pph_sentence)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          pph_macros.$destroy_new_pph_phrasesP$.bind( makeBoolean( NIL != pph_macros.$destroy_new_pph_phrasesP$.getDynamicValue( thread ) || NIL != misc_utilities.uninitialized_p( pph_vars.$pph_sentence$.getDynamicValue(
              thread ) ) ), thread );
          pph_vars.$pph_current_arg0$.bind( ( NIL != pph_macros.pph_ok_arg0_for_linkingP( arg0 ) ) ? arg0 : $kw14$UNSPECIFIED, thread );
          ...
          try
          {
            ...
            try
            {
              ...
              if( NIL != pph_string.pph_string_p( string ) )
              {
                successful_fn = $sym16$GENERATE_QUESTION_FROM_QUERY_TEMPLATE;
              }
              ...
              else
              {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    {
                      format_nil.force_format( T, $str17$__Entering_PPH_POSSIBLY_BINDING_V, pph_vars.$pph_possibly_binding_variables_counter$.getDynamicValue( thread ), dictionary.dictionary_values(
                    ...
                    try
                    {
                      ...
                      try
                      {
                        ...
                        thread.resetMultipleValues();
                        if( NIL != el_utilities.el_formula_p( hypothetical ) )
                        {
                          ...
                          try
                          {
                            pph_vars.$pph_use_smart_variable_replacementP$.bind( ( NIL != pph_vars.$pph_handle_hypotheticalsP$.getDynamicValue( thread ) ) ? NIL
                                : pph_vars.$pph_use_smart_variable_replacementP$.getDynamicValue( thread ), thread );
                            thread.resetMultipleValues();
                            final SubLObject hyp_string_$51 = pph_question_declarative_string( hypothetical, $kw1$ANY, hypothetical_map, UNPROVIDED, UNPROVIDED );
                    ...
                    finally
                    {
                      ...
                      try
                      {
                        ...
                        if( NIL != pph_error.pph_trace_level_exceeds_minimumP( TWO_INTEGER ) )
                        {
                          format_nil.force_format( T, $str19$__Leaving_PPH_POSSIBLY_BINDING_VA, pph_vars.$pph_possibly_binding_variables_counter$.getDynamicValue( thread ), pph_variable_handling.pph_registered_vars(),
                              UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                        }
                        pph_macros.pph_handle_local_vars( local_vars );
                        if( NIL != pph_error.pph_trace_level_exceeds_minimumP( TWO_INTEGER ) )
                        {
                          format_nil.force_format( T, $str20$______and__pph_var_types__are_now, pph_variable_handling.pph_registered_vars(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED,
                              UNPROVIDED );
                        }
                        Values.restoreValuesFromVector( _values );
                      }
              ...
              {
                just = ConsesLow.cons( pph_phrase.pph_code_justification( successful_fn, UNPROVIDED ), just );
                if( NIL == pred )
                {
                  pred = $const21$tensed;
                }
                if( NIL == olist )
                {
                  olist = ConsesLow.list( pph_data_structures.new_pph_phrase_output_item( string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
                }
              }
  ...
  public static SubLObject pph_question_clause_memoized(final SubLObject formula, final SubLObject nl_preds, SubLObject blanksP, SubLObject demerit_cutoff, SubLObject v_pph_sentence)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym12$PPH_QUESTION_CLAUSE_MEMOIZED, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym12$PPH_QUESTION_CLAUSE_MEMOIZED, FIVE_INTEGER, NIL, EQUAL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym12$PPH_QUESTION_CLAUSE_MEMOIZED, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( pph_question_clause_memoized_internal( formula, nl_preds, blanksP, demerit_cutoff, v_pph_sentence ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( formula, nl_preds, blanksP, demerit_cutoff, v_pph_sentence ) );
  ...
  public static SubLObject pph_remove_hypothetical(final SubLObject formula, SubLObject arg_position_map)
  {
    ...
    {
      final SubLObject hypothetical_template = $kw23$ARG1;
      ...
      final SubLObject query_template = $kw24$ARG2;
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return makeBoolean( NIL != pph_vars.$pph_query_antecedents_are_hypothesizedP$.getDynamicValue( thread ) && NIL != el_utilities.el_implication_p( formula ) );
  }
  ...
  public static SubLObject pph_question_register_hypothetical_vars(final SubLObject hypothetical)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      pph_variable_handling.pph_register_var_quantifier( var, $kw25$EXISTENTIAL );
  ...
  public static SubLObject pph_add_hypothetical_paraphrase(SubLObject string, final SubLObject pred, SubLObject just, SubLObject olist, final SubLObject demerits, final SubLObject hyp_just, SubLObject hyp_olist)
  {
    if( NIL != hyp_olist )
    {
      final SubLObject implies_item = pph_data_structures.new_pph_phrase_output_item( $str26$if, $list27, $const28$implies, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      pph_phrase.pph_phrase_output_item_maybe_add_anchor_tags( implies_item, $const28$implies );
      hyp_olist = ConsesLow.cons( implies_item, hyp_olist );
  ...
  public static SubLObject question_paraphrase_availableP(final SubLObject formula, SubLObject language_mt, SubLObject domain_mt, SubLObject nl_preds)
  {
    ...
    try
    {
      ...
      if( NIL == ans )
      {
        ...
        SubLObject function;
        for( csome_list_var = ordered_gen_fun_list, function = NIL, function = csome_list_var.first(); NIL == ans && NIL != csome_list_var; ans = list_utilities.sublisp_boolean( Functions.funcall( function,
            rephrased_formula, nl_preds ) ), csome_list_var = csome_list_var.rest(), function = csome_list_var.first() )
        {
        }
      }
    }
  ...
  public static SubLObject remove_past_tense_formP(final SubLObject pred, SubLObject mt)
  {
    ...
    return memoization_state.caching_state_remove_function_results_with_args( $past_tense_formP_caching_state$.getGlobalValue(), ConsesLow.list( pred, mt ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/pph-question.lisp", position = 10163L)
  public static SubLObject past_tense_formP_internal(final SubLObject pred, final SubLObject mt)
  {
    return pph_utilities.pph_genl_predicateP( pred, $const31$pastTense_Generic, mt );
  }
  ...
  public static SubLObject past_tense_formP(final SubLObject pred, SubLObject mt)
  {
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( past_tense_formP_internal( pred, mt ) ) );
  ...
  public static SubLObject generate_question_from_genquestion(final SubLObject formula, SubLObject nl_preds, SubLObject arg_position_map)
  {
    ...
    if( NIL != el_utilities.el_formula_p( formula ) && NIL == prefer_past_tense_formP( nl_preds ) )
    {
  ...
  public static SubLObject pph_question_arg(final SubLObject formula)
  {
    ...
    final SubLObject args = cycl_utilities.formula_args( formula, $kw33$IGNORE );
    SubLObject rest;
    SubLObject arg;
  ...
  public static SubLObject get_genquestion_formula(final SubLObject relation, final SubLObject q_arg)
  {
    ...
    try
    {
      ...
      final SubLObject pred_var = $const34$genQuestion;
  ...
  {
    final SubLObject tuple = ConsesLow.list( bindings.variable_lookup( variables.get_variable( ZERO_INTEGER ), v_bindings ), bindings.variable_lookup( variables.get_variable( ONE_INTEGER ), v_bindings ) );
  ...
  {
    return Sequences.length( string_utilities.search_all( pph_vars.$pph_blank_string$.getGlobalValue(), string, UNPROVIDED, UNPROVIDED ) );
  }
                  ...
                  if( NIL != misc_utilities.initialized_p( pph_vars.$pph_sentence$.getDynamicValue( thread ) ) )
                  {
                    ...
                    while ( NIL == queues.queue_empty_p( queue ))
                    {
                      ...
                      while ( NIL != cdolist_list_var)
                      {
                        ...
                        {
                          final SubLObject new_format_string = Sequences.cconcatenate( $str38$_PPH_error_level_, new SubLObject[] { format_nil.format_nil_s_no_copy( ONE_INTEGER ), $str39$__, format_nil
                              .format_nil_a_no_copy( $str40$Done__S_alternatives_of__S )
                          } );
                        ...
                        if( NIL != misc_utilities.initialized_p( pph_vars.$pph_sentence$.getDynamicValue( thread ) ) )
                        {
                          ...
                          while ( NIL == queues.queue_empty_p( queue2 ))
                          {
                            ...
                            while ( NIL != cdolist_list_var2)
                            {
                              ...
                              done_count2 = Numbers.add( done_count2, ONE_INTEGER );
                              if( done_count2.numGE( pph_phrase.$pph_do_alternatives_max$.getDynamicValue( thread ) ) )
                              {
                                final SubLObject new_format_string2 = Sequences.cconcatenate( $str38$_PPH_error_level_, new SubLObject[] { format_nil.format_nil_s_no_copy( ONE_INTEGER ), $str39$__, format_nil
                                    .format_nil_a_no_copy( $str40$Done__S_alternatives_of__S )
                                } );
                                pph_error.pph_handle_error( new_format_string2, ConsesLow.list( done_count2, phrase2 ) );
                              }
  ...
  public static SubLObject clear_gen_template_query_sentence_index()
  {
    ...
    $gen_template_query_sentence_index$.setGlobalValue( $kw41$UNINITIALIZED );
  ...
  public static SubLObject initialize_gen_template_query_sentence_index()
  {
    ...
    try
    {
      release = Locks.seize_lock( $gen_template_query_sentence_index_lock$.getGlobalValue() );
      if( NIL != dictionary.dictionary_p( $gen_template_query_sentence_index$.getGlobalValue() ) )
      {
        dictionary.clear_dictionary( $gen_template_query_sentence_index$.getGlobalValue() );
      }
      ...
      {
        $gen_template_query_sentence_index$.setGlobalValue( dictionary.new_dictionary( Symbols.symbol_function( EQL ), UNPROVIDED ) );
      }
      ...
      try
      {
        ...
        final SubLObject pred_var = $const47$genTemplate_QuerySentence;
                ...
                try
                {
                  ...
                  while ( NIL == done_var_$76)
                  {
                    ...
                    if( NIL != valid_$78 )
                    {
                      ...
                      SubLObject cdolist_list_var = cycl_utilities.expression_gather( assertions_high.gaf_arg1( as ), Symbols.symbol_function( $sym48$INDEXED_TERM_P ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      ...
      final SubLObject threshold = Numbers.integerDivide( count, THREE_INTEGER );
      SubLObject common_keys = NIL;
      SubLObject iteration_state;
      for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( $gen_template_query_sentence_index$.getGlobalValue() ) ); NIL == dictionary_contents
          .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
      {
        ...
        {
          common_keys = ConsesLow.cons( v_term2, common_keys );
        }
      }
      ...
      while ( NIL != cdolist_list_var2)
      {
        ...
        {
          if( NIL == list_utilities.singletonP( cycl_utilities.expression_gather( assertions_high.gaf_arg1( as2 ), Symbols.symbol_function( $sym48$INDEXED_TERM_P ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) )
          {
    ...
    finally
    {
      if( NIL != release )
      {
        Locks.release_lock( $gen_template_query_sentence_index_lock$.getGlobalValue() );
      }
    }
    return count;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return makeBoolean( NIL != assertion_handles.valid_assertionP( assertion, UNPROVIDED ) && NIL != pph_utilities.pph_genl_mtP( pph_vars.$pph_language_mt$.getDynamicValue( thread ), assertions_high.assertion_mt(
        assertion ) ) );
  }
  ...
  {
    final SubLObject counts = dictionary.new_dictionary( Symbols.symbol_function( EQ ), TWENTY_INTEGER );
    SubLObject cdolist_list_var = cycl_utilities.expression_gather( query_sentence, $sym48$INDEXED_TERM_P, T, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    SubLObject v_term = NIL;
    v_term = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
    ...
    return Mapping.mapcar( Symbols.symbol_function( $sym50$CAR ), dictionary_utilities.sort_dictionary_by_values( counts, Symbols.symbol_function( $sym51$_ ) ) );
  }
  ...
  public static SubLObject gtqs_assertions_for_query_sentence(final SubLObject query_sentence, final SubLObject nl_preds)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        ans = ConsesLow.cons( gtqs_as, ans );
      }
      cdolist_list_var = cdolist_list_var.rest();
      gtqs_as = cdolist_list_var.first();
    }
    return Sort.stable_sort( pph_utilities.pph_sort_assertions( ans, UNPROVIDED, UNPROVIDED ), Symbols.symbol_function( $sym51$_ ), $sym52$GTQS_ASSERTION_CONSTANT_COUNT );
  }
  ...
  public static SubLObject gtqs_assertion_constant_count(final SubLObject gtqs_as)
  {
    ...
    return Sequences.length( cycl_utilities.expression_gather( query_sentence_template, $sym53$CONSTANT_P, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject gtqs_assertion_matches_query_sentenceP(final SubLObject gtqs_as, final SubLObject query_sentence, SubLObject nl_preds)
  {
    ...
    return Values.nth_value_step_2( Values.nth_value_step_1( ONE_INTEGER ), gtqs_assertion_bindings_for_query_sentence( gtqs_as, pph_standardize_query_sentence( query_sentence ), nl_preds ) );
  }
  ...
  public static SubLObject gtqs_assertion_bindings_for_query_sentence(final SubLObject gtqs_as, final SubLObject query_sentence, SubLObject nl_preds)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym54$GTQS_ASSERTION_BINDINGS_FOR_QUERY_SENTENCE, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym54$GTQS_ASSERTION_BINDINGS_FOR_QUERY_SENTENCE, THREE_INTEGER, NIL, EQUAL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym54$GTQS_ASSERTION_BINDINGS_FOR_QUERY_SENTENCE, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( gtqs_assertion_bindings_for_query_sentence_internal( gtqs_as, query_sentence, nl_preds ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( gtqs_as, query_sentence, nl_preds ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject hlify_gtqs_template_variables(final SubLObject query_sentence_template)
  {
    ...
    for( hl_var_num = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), el_var_or_keyword = list_var.first(), hl_var_num = Numbers.add( ONE_INTEGER, hl_var_num ) )
    {
      ...
      hl_var_to_el_var_or_keyword_bindings = ConsesLow.cons( bindings.make_variable_binding( hl_var, el_var_or_keyword ), hl_var_to_el_var_or_keyword_bindings );
    }
  ...
  public static SubLObject gtqs_bindings_from_unification_bindings(SubLObject unification_result, final SubLObject hl_var_to_el_var_or_keyword_bindings, final SubLObject gtqs_as, final SubLObject query_sentence)
  {
    ...
    final SubLObject arg_position_specifiers = cycl_utilities.expression_gather( phrase_naut, $sym56$PPH_ARG_POSITION_SPECIFIER_, NIL, Symbols.symbol_function( EQUAL ), Symbols.symbol_function( IDENTITY ), NIL );
    ...
    for( failP = NIL, rest = NIL, rest = query_sentence_template_terms_to_query_sentence_terms; NIL == failP && NIL != rest; rest = rest.rest() )
    {
      ...
      template_term2 = NIL;
      sentence_term2 = NIL;
      cdestructuring_bind.destructuring_bind_must_consp( current2, datum2, $list57 );
    ...
    return Values.values( query_sentence_template_terms_to_arg_positions, makeBoolean( NIL == failP ) );
  }
  ...
  {
    final SubLObject arg_positions = cycl_utilities.arg_positions_bfs( pph_standardize_query_term( sentence_term ), query_sentence, Symbols.symbol_function( EQUAL ) );
  ...
  public static SubLObject gtqs_specified_arg_matchesP(final SubLObject specified_arg, final SubLObject arg_position_specifier, final SubLObject query_sentence_template, final SubLObject map)
  {
    ...
    if( specified_arg.equal( list_utilities.alist_lookup( map, specified_template_term, Symbols.symbol_function( EQUAL ), UNPROVIDED ) ) )
    {
      return T;
    }
    if( NIL != pph_error.pph_trace_level_exceeds_minimumP( ONE_INTEGER ) && NIL == pph_error.suppress_pph_warningsP() )
  ...
  {
    return cycl_utilities.expression_gather( query_sentence_template, Symbols.symbol_function( $sym62$KEYWORDP ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return cycl_utilities.expression_transform( expression, $sym63$EL_VAR_, $sym64$EL_VAR_NAME, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return transform_list_utilities.transform( expression, $sym65$EL_VAR_NAME_, $sym66$MAKE_EL_VAR, UNPROVIDED );
  }
  ...
  {
    return makeBoolean( NIL != unification.unify_possible( cycl_utilities.formula_arg0( formula1 ), cycl_utilities.formula_arg0( formula2 ) ) && NIL != pph_unify_possible_args( cycl_utilities.formula_args( formula1,
        UNPROVIDED ), cycl_utilities.formula_args( formula2, UNPROVIDED ) ) );
  }
  ...
  public static SubLObject pph_unify_check_recursion_depth()
  {
    ...
    if( $pph_unify_recursion_depth$.getDynamicValue( thread ).numG( $pph_unify_recursion_limit$.getGlobalValue() ) )
    {
      final SubLObject new_format_string = Sequences.cconcatenate( $str38$_PPH_error_level_, new SubLObject[] { format_nil.format_nil_s_no_copy( ONE_INTEGER ), $str39$__, format_nil.format_nil_a_no_copy(
          $str70$Exceeded_PPH_unify_recursion_dept )
      } );
      pph_error.pph_handle_error( new_format_string, ConsesLow.list( $pph_unify_recursion_limit$.getGlobalValue() ) );
    }
    return NIL;
  }
  ...
  public static SubLObject pph_unify_gtqs(final SubLObject template, final SubLObject formula)
  {
    ...
    try
    {
      unification.$unify_cons_function$.bind( Symbols.symbol_function( $sym71$PPH_UNIFY_FORMULA_TEMPLATE ), thread );
      unification.$unify_possible_cons_function$.bind( Symbols.symbol_function( $sym67$PPH_UNIFY_POSSIBLE_FORMULA ), thread );
  ...
  public static SubLObject pph_unify_formula_template_memoized_internal(final SubLObject template, final SubLObject formula, final SubLObject v_bindings)
  {
    ...
    {
      final SubLObject new_format_string = Sequences.cconcatenate( $str38$_PPH_error_level_, new SubLObject[] { format_nil.format_nil_s_no_copy( ONE_INTEGER ), $str39$__, format_nil.format_nil_a_no_copy(
          $str73$Not_in_unify_multiple_mode_ )
      } );
    ...
    if( NIL != list_utilities.sublisp_boolean( functor_result ) )
    {
      ...
      try
      {
        $pph_unify_try_arg_permutationsP$.bind( makeBoolean( template_args.isList() && formula_args.isList() && ( NIL != pph_commutative_functor_p( template_functor ) || NIL != pph_commutative_functor_p(
            formula_functor ) ) ), thread );
        unification.$unify_possible_cons_function$.bind( Symbols.symbol_function( $sym67$PPH_UNIFY_POSSIBLE_FORMULA ), thread );
  ...
  public static SubLObject pph_unify_formula_template_memoized(final SubLObject template, final SubLObject formula, final SubLObject v_bindings)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym72$PPH_UNIFY_FORMULA_TEMPLATE_MEMOIZED, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym72$PPH_UNIFY_FORMULA_TEMPLATE_MEMOIZED, THREE_INTEGER, NIL, EQUAL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym72$PPH_UNIFY_FORMULA_TEMPLATE_MEMOIZED, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( pph_unify_formula_template_memoized_internal( template, formula, v_bindings ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( template, formula, v_bindings ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject pph_unify_args_memoized_internal(final SubLObject template_args, final SubLObject formula_args, final SubLObject assumed_bindings, final SubLObject try_permutationsP)
  {
    ...
    else if( NIL != try_permutationsP && NIL != list_utilities.lengthLE( template_args, $pph_arglist_permutations_max_arity$.getGlobalValue(), UNPROVIDED ) )
    {
    ...
    else
    {
      if( NIL != try_permutationsP )
      {
        if( NIL != pph_error.pph_trace_level_exceeds_minimumP( ONE_INTEGER ) && NIL == pph_error.suppress_pph_warningsP() )
        {
          Errors.warn( $str77$Skipping_permutations_for_templat, Sequences.length( template_args ), template_args, formula_args );
          streams_high.force_output( StreamsLow.$error_output$.getDynamicValue( thread ) );
        }
  ...
  public static SubLObject pph_unify_args_memoized(final SubLObject template_args, final SubLObject formula_args, final SubLObject assumed_bindings, final SubLObject try_permutationsP)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym76$PPH_UNIFY_ARGS_MEMOIZED, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym76$PPH_UNIFY_ARGS_MEMOIZED, FOUR_INTEGER, NIL, EQUAL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym76$PPH_UNIFY_ARGS_MEMOIZED, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( pph_unify_args_memoized_internal( template_args, formula_args, assumed_bindings, try_permutationsP ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( template_args, formula_args, assumed_bindings, try_permutationsP ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject pph_unify_ordered_args(final SubLObject template_args, final SubLObject formula_args, final SubLObject assumed_bindings)
  {
    ...
    {
      final SubLObject new_format_string = Sequences.cconcatenate( $str38$_PPH_error_level_, new SubLObject[] { format_nil.format_nil_s_no_copy( ONE_INTEGER ), $str39$__, format_nil.format_nil_a_no_copy(
          $str78$Lost_assumed_bindings________S__ )
      } );
      pph_error.pph_handle_error( new_format_string, ConsesLow.list( ( NIL != set.set_p( assumed_bindings ) ) ? set.set_element_list( assumed_bindings ) : assumed_bindings ) );
    }
  ...
  public static SubLObject pph_unify_args_permutations(final SubLObject template_args, final SubLObject formula_args, final SubLObject assumed_bindings)
  {
    ...
    try
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        if( NIL == possibleP )
        {
          impossible_count = Numbers.add( impossible_count, ONE_INTEGER );
        }
        else if( NIL != this_bindings )
        {
          if( NIL == v_bindings )
          {
          ...
          {
            v_bindings = set_utilities.new_singleton_set( v_bindings, Symbols.symbol_function( EQUAL ) );
            set.set_add( this_bindings, v_bindings );
          }
        }
        tried_count = Numbers.add( tried_count, ONE_INTEGER );
        cdolist_list_var = cdolist_list_var.rest();
        template_arg_permutation = cdolist_list_var.first();
      }
    }
  ...
  {
    final SubLObject argnum_list = list_utilities.num_list( Sequences.length( arglist ), UNPROVIDED );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        this_arglist_perm = ConsesLow.cons( ConsesLow.nth( argnum, arglist ), this_arglist_perm );
        cdolist_list_var_$82 = cdolist_list_var_$82.rest();
        argnum = cdolist_list_var_$82.first();
      }
      arglist_permutations = ConsesLow.cons( this_arglist_perm, arglist_permutations );
      cdolist_list_var = cdolist_list_var.rest();
      argnum_permutation = cdolist_list_var.first();
    }
  ...
  public static SubLObject replace_gtqs_template_terms(final SubLObject query_sentence, final SubLObject v_pph_phrase, final SubLObject query_sentence_template_terms_to_query_sentence_terms,
      final SubLObject arg_position_map)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject standardized_query_sentence = pph_standardize_query_sentence( query_sentence );
    SubLObject cdolist_list_var = query_sentence_template_terms_to_query_sentence_terms;
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        final SubLObject new_format_string = Sequences.cconcatenate( $str38$_PPH_error_level_, new SubLObject[] { format_nil.format_nil_s_no_copy( ONE_INTEGER ), $str39$__, format_nil.format_nil_a_no_copy(
            $str81$GTQS__Couldn_t_find__S_in____S__ )
        } );
        pph_error.pph_handle_error( new_format_string, ConsesLow.list( local_arg_position, query_sentence ) );
      }
      if( NIL != pph_error.pph_trace_level_exceeds_minimumP( ONE_INTEGER ) )
      {
        format_nil.force_format( T, $str82$__GTQS__Replacing__S_with__S__S__, template_term, sentence_term, pph_utilities.pph_arg_position_lookup( local_arg_position, arg_position_map ), UNPROVIDED, UNPROVIDED,
      ...
      if( !template_term.equal( sentence_term ) )
      {
        ...
        SubLObject replacedP = pph_phrase.pph_phrase_cycl_subst( sentence_term, template_term, v_pph_phrase, Symbols.symbol_function( EQUAL ), global_arg_position );
  ...
  public static SubLObject dummy_query_sentence_for_gtqs_assertion(final SubLObject gtqs_as)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      final SubLObject col = ( NIL != constraint_col ) ? constraint_col : $const84$Thing;
      final SubLObject instance = el_utilities.make_ternary_formula( $const85$InstanceNamedFn_Ternary, $str86$example, col, Guids.guid_to_string( Guids.new_guid() ) );
          ...
          try
          {
            ...
            try
            {
              ...
              try
              {
                ...
                try
                {
                  final SubLObject total = kb_indexing.num_predicate_extent_index( $const47$genTemplate_QuerySentence, UNPROVIDED );
                  ...
                  try
                  {
                    ...
                    try
                    {
                      utilities_macros.noting_percent_progress_preamble( $str88$Checking___genTemplate_QuerySente );
                      final SubLObject pred_var = $const47$genTemplate_QuerySentence;
                      if( NIL != kb_mapping_macros.do_predicate_extent_index_key_validator( pred_var ) )
                      {
                        final SubLObject str = NIL;
                              ...
                              try
                              {
                                ...
                                while ( NIL == done_var_$94)
                                {
                                  ...
                                  if( NIL != valid_$96 )
                                  {
                                    ...
                                    if( NIL != okP )
                                    {
                                      matched = Numbers.add( matched, ONE_INTEGER );
                                    }
                  ...
                  PrintLow.format( T, $str89$__Matched__S_of__S___genTemplate_, new SubLObject[] { matched, total, time
                  } );
                }
                finally
                {
  ...
  public static SubLObject verify_one_gtqs_assertion_with_query_sentence(final SubLObject gtqs_as, final SubLObject cutoff, final SubLObject query_sentence)
  {
      ...
      try
      {
        ...
        try
        {
          ...
          try
          {
            ...
            found_assertions = gtqs_assertions_for_query_sentence( query_sentence, $kw1$ANY );
          }
          finally
          {
    ...
    else if( NIL == subl_promotions.memberP( gtqs_as, found_assertions, UNPROVIDED, UNPROVIDED ) )
    {
  ...
  public static SubLObject generate_question_bf(SubLObject formula, SubLObject nl_preds, SubLObject arg_position_map, SubLObject type)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject query_vars = pph_utilities.pph_sort_variables( list_utilities.remove_if_not( $sym92$PPH_QUERY_VAR_P, pph_variable_handling.pph_formula_free_variables( formula, UNPROVIDED ), UNPROVIDED, UNPROVIDED,
    ...
    if( NIL == duplicate_varsP )
    {
      SubLObject csome_list_var;
      SubLObject var;
      for( csome_list_var = query_vars, var = NIL, var = csome_list_var.first(); NIL == duplicate_varsP && NIL != csome_list_var; duplicate_varsP = list_utilities.tree_countG( var, formula, ONE_INTEGER, UNPROVIDED,
          UNPROVIDED ), csome_list_var = csome_list_var.rest(), var = csome_list_var.first() )
      {
      }
    }
    if( NIL == subl_promotions.memberP( type, $list93, UNPROVIDED, UNPROVIDED ) )
    {
      type = ( NIL != pph_vars.$pph_blanks_for_varsP$.getDynamicValue( thread ) ) ? $kw94$BLANKS : $kw95$VARS;
    }
    if( NIL == query_vars && type == $kw95$VARS )
    {
      while ( NIL != el_utilities.el_negation_p( formula ))
      {
        ...
        arg_position_map = pph_utilities.pph_figure_new_arg_position_map( arg_position_map, $kw23$ARG1 );
    ...
    if( type == $kw94$BLANKS )
    {
      ...
      try
      {
        ...
        thread.resetMultipleValues();
        final SubLObject string_$103 = pph_main.generate_text( formula, nl_preds, pph_vars.$pph_language_mt$.getDynamicValue( thread ), pph_vars.$pph_domain_mt$.getDynamicValue( thread ), pph_vars.$paraphrase_mode$
    ...
    else if( NIL != question_rop_formulaP( formula ) )
    {
    ...
    else if( NIL == query_vars )
    {
      ...
      try
      {
        ...
        if( NIL != negationP )
        {
          pph_data_structures.pph_phrase_output_item_set_cycl( preamble_items.first(), $const97$not );
          pph_data_structures.pph_phrase_output_item_set_arg_position( preamble_items.first(), not_arg_position );
          pph_phrase.pph_phrase_output_item_maybe_add_anchor_tags( preamble_items.first(), $const97$not );
        }
        thread.resetMultipleValues();
        ...
        if( NIL != list_utilities.non_empty_list_p( olist ) )
        {
          ...
          while ( NIL != cdolist_list_var2)
          {
            olist = ConsesLow.cons( item, olist );
            cdolist_list_var2 = cdolist_list_var2.rest();
            item = cdolist_list_var2.first();
          }
          string = pph_phrase.pph_phrase_output_list_string( olist, T );
  ...
  public static SubLObject pph_brute_force_yes_no_preamble_strings(SubLObject negationP, SubLObject pastP)
  {
    ...
    final SubLObject aux = ( NIL != pastP ) ? $str98$was_ : $str99$is_;
    final SubLObject true_or_false_string = pph_brute_force_true_or_false_string( negationP );
    final SubLObject preamble = Sequences.cconcatenate( aux, Sequences.cconcatenate( $str100$it_, format_nil.format_nil_a_no_copy( true_or_false_string ) ) );
    return ConsesLow.list( preamble, $str101$that );
  }
  ...
  {
    return ( NIL != negationP ) ? pph_brute_force_false_string() : $str102$true;
  }
  ...
  {
    return ( NIL != pph_brute_force_capitalize_false_string_p() ) ? $str103$FALSE : $str104$false;
  }
  ...
  public static SubLObject pph_brute_force_wh_preamble_olist(final SubLObject unscoped_vars, final SubLObject pastP, final SubLObject formula, final SubLObject arg_position_map, final SubLObject lexify_varsP)
  {
    ...
    final SubLObject preamble_2 = Sequences.cconcatenate( ( NIL != pastP ) ? $str105$were : $str106$are, $str107$_there_such_that );
    final SubLObject preamble_2_olist = ConsesLow.list( new_pph_phrase_filler_item( preamble_2 ) );
  ...
  public static SubLObject pph_brute_force_wh_phrase_olist(final SubLObject query_vars, final SubLObject formula, final SubLObject arg_position_map, final SubLObject lexify_varsP)
  {
    ...
    if( NIL != lexify_varsP )
    {
      ...
      try
      {
        ...
        final SubLObject raw_olist = pph_methods_formulas.generate_juncts_output_list( query_vars, $list108, $kw109$AND, UNPROVIDED );
    ...
    else
    {
      ...
      try
      {
        ...
        final SubLObject preamble_1a = $str110$what_values_of;
        final SubLObject preamble_1b_olist = pph_methods_formulas.generate_juncts_output_list( query_vars, NIL, $kw109$AND, UNPROVIDED );
        olist = pph_brute_force_olist_set_arg_positions( preamble_1b_olist, formula, arg_position_map );
        olist = ConsesLow.cons( new_pph_phrase_filler_item( preamble_1a ), olist );
      }
      finally
      {
  ...
  public static SubLObject new_pph_phrase_filler_items(final SubLObject strings)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ans = ConsesLow.cons( pph_data_structures.new_pph_phrase_output_item( str, pph_utilities.pph_unknown_arg_position(), pph_phrase.pph_empty_cycl(), UNPROVIDED, UNPROVIDED, UNPROVIDED ), ans );
      cdolist_list_var = cdolist_list_var.rest();
      str = cdolist_list_var.first();
    }
  ...
  public static SubLObject pph_brute_force_wh_lexify_query_varsP(final SubLObject query_vars, final SubLObject query_formula)
  {
    ...
    return makeBoolean( NIL == Types.sublisp_true() && NIL == list_utilities.lengthG( query_vars, max, UNPROVIDED ) && NIL == pph_vars.pph_maximize_linksP() && NIL != pph_vars.$pph_use_smart_variable_replacementP$
        .getDynamicValue( thread ) && NIL == el_utilities.el_existential_p( query_formula ) && NIL == Sequences.find_if( $sym112$PPH_VAR_REGISTERED_AS_DEFAULT_, query_vars, UNPROVIDED, UNPROVIDED, UNPROVIDED )
        && NIL == Sequences.find_if( $sym113$PPH_EXCEPTIONAL_VAR_P, query_vars, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject pph_remove_redundant_query_var_typing_clauses(final SubLObject query_formula, final SubLObject query_vars, final SubLObject arg_position_map)
  {
    ...
    return ( $kw114$ERROR == template ) ? pph_utilities.pph_identity_template() : template;
  }
  ...
  public static SubLObject question_rop_formulaP(final SubLObject formula)
  {
        ...
        try
        {
          ...
          try
          {
            if( NIL == ans )
            {
              SubLObject csome_list_var;
              SubLObject word;
              for( csome_list_var = string_utilities.string_tokenize( string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), word = NIL, word = csome_list_var.first(); NIL == ans
                  && NIL != csome_list_var; ans = makeBoolean( NIL != lexicon_accessors.closed_lexical_class_string_case_insensitiveP( word, UNPROVIDED ) && ( NIL != lexicon_accessors.string_is_posP( word,
                      $const115$WHWord, UNPROVIDED, UNPROVIDED, UNPROVIDED ) || NIL != lexicon_accessors.string_is_posP( word, $const116$AuxVerb, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) ), csome_list_var = csome_list_var
                          .rest(), word = csome_list_var.first() )
              {
              }
            }
          }
    ...
    {
      return Sequences.find_if( $sym117$QUESTION_ROP_FORMULA_, cycl_utilities.formula_args( formula, UNPROVIDED ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
    return NIL;
  }
  ...
  {
    return el_utilities.el_formula_with_operator_p( obj, $const118$TheResultOfParsing );
  }
  ...
  public static SubLObject pph_phrase_maybe_npP(final SubLObject phrase)
  {
    ...
    if( NIL != agr_pred && ( NIL != pph_utilities.pph_genl_pos_predP( $const119$nounStrings, agr_pred, UNPROVIDED ) || NIL != pph_utilities.pph_genl_pos_predP( agr_pred, $const119$nounStrings, UNPROVIDED ) ) )
    {
      return T;
    }
    return NIL;
  ...
  public static SubLObject el_var_det_nbarP(final SubLObject phrase)
  {
    ...
    if( NIL != cycl_variables.el_varP( pph_phrase.pph_phrase_cycl( nbar_dtr, UNPROVIDED ) ) && NIL != pph_variable_handling.pph_query_var_p( pph_phrase.pph_phrase_cycl( nbar_dtr, UNPROVIDED ) ) && ( NIL != pph_phrase
        .pph_phrase_definite_articleP( det_dtr ) || NIL != pph_phrase.pph_phrase_indefinite_articleP( det_dtr ) ) && NIL != pph_utilities.pph_nbarP( pph_phrase.pph_phrase_category( nbar_dtr, UNPROVIDED ) ) )
    {
      return T;
    }
    if( NIL != cycl_variables.el_varP( pph_phrase.pph_phrase_cycl( det_dtr, UNPROVIDED ) ) && NIL != pph_variable_handling.pph_query_var_p( pph_phrase.pph_phrase_cycl( det_dtr, UNPROVIDED ) ) && NIL != pph_utilities
        .pph_genl_posP( pph_phrase.pph_phrase_category( det_dtr, UNPROVIDED ), $const120$Determiner, UNPROVIDED ) )
    {
      return T;
    }
    return NIL;
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject constraints = pph_variable_handling.pph_variable_isa_constraints( var, formula, pph_vars.$pph_domain_mt$.getDynamicValue( thread ), T, T, Symbols.symbol_function( $sym121$TRUE ) );
    return list_utilities.sublisp_boolean( Sequences.find( $const122$Integer, constraints, $sym123$PPH_SPEC_, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject formula_ok_for_subj_aux_inversionP(final SubLObject formula)
  {
    ...
    final SubLObject query_varsP = Sequences.find_if( $sym92$PPH_QUERY_VAR_P, vars, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  {
    return makeBoolean( NIL != kb_indexing_datastructures.indexed_term_p( op ) && NIL != pph_methods_formulas.quant_over_arg_tuples( op ) );
  }
  ...
  public static SubLObject generate_with_subj_aux_inversion(final SubLObject formula, SubLObject nl_preds, SubLObject arg_position_map)
  {
    ...
    final SubLObject phrase = ( NIL != pph_types.pph_phrase_nautP( formula ) ) ? pph_templates.pph_phrasify_phrase_naut( formula, arg_position_map )
        : pph_phrase.pph_phrase_copy( pph_phrase.new_pph_phrase_for_cycl( formula, arg_position_map, UNPROVIDED ), UNPROVIDED, UNPROVIDED );
    SubLObject string = NIL;
      ...
      if( NIL != misc_utilities.initialized_p( pph_vars.$pph_sentence$.getDynamicValue( thread ) ) )
      {
        ...
        while ( NIL == queues.queue_empty_p( queue ))
        {
          ...
          while ( NIL != cdolist_list_var)
          {
            ...
            {
              final SubLObject new_format_string = Sequences.cconcatenate( $str38$_PPH_error_level_, new SubLObject[] { format_nil.format_nil_s_no_copy( ONE_INTEGER ), $str39$__, format_nil.format_nil_a_no_copy(
                  $str40$Done__S_alternatives_of__S )
              } );
              pph_error.pph_handle_error( new_format_string, ConsesLow.list( done_count, phrase ) );
            }
            queues.enqueue( alternative, queue );
  ...
  public static SubLObject generate_phrase_with_subj_aux_inversion(final SubLObject phrase, final SubLObject formula, SubLObject nl_preds, final SubLObject arg_position_map, SubLObject reformulateP)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL != pph_error.pph_trace_level_exceeds_minimumP( TWO_INTEGER ) )
        {
          format_nil.force_format( T, $str17$__Entering_PPH_POSSIBLY_BINDING_V, pph_vars.$pph_possibly_binding_variables_counter$.getDynamicValue( thread ), dictionary.dictionary_values( pph_vars.$pph_var_types$
              ...
              try
              {
                ...
                if( NIL != reformulateP )
                {
                  ...
                  while ( NIL != cdolist_list_var)
                  {
                    ...
                    final SubLObject new_template2 = pph_methods_formulas.pph_reformulate_conjunction_with_thecollectionof( pph_phrase.pph_phrase_cycl( phrase, UNPROVIDED ), var, pph_utilities.pph_identity_template(),
                        pph_phrase.pph_phrase_cycl( phrase, UNPROVIDED ), var_path, NIL );
                    if( NIL == list_utilities.tree_find( new_template2, $kw114$ERROR, UNPROVIDED, UNPROVIDED ) && NIL == pph_utilities.pph_impossible_template_p( new_template2 ) && NIL == pph_utilities
                        .pph_identity_template_p( new_template2 ) )
                    {
                ...
                final SubLObject map = pph_phrase.pph_phrase_arg_position_map( phrase );
                final SubLObject query_vars = cycl_utilities.expression_gather( new_cycl, $sym92$PPH_QUERY_VAR_P, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                ...
                try
                {
                  ...
                  while ( NIL == doneP && NIL == pph_data_structures.pph_phrase_template_generator_done_p( generator ))
                  {
                    ...
                    if( NIL != pph_phrase.pph_phrase_p( phrase_template, UNPROVIDED ) )
                    {
                      ...
                      try
                      {
                        pph_vars.$pph_current_arg0$.bind( ( NIL != pph_macros.pph_ok_arg0_for_linkingP( cycl_utilities.formula_arg0( formula ) ) ) ? cycl_utilities.formula_arg0( formula ) : $kw14$UNSPECIFIED, thread );
        ...
        finally
        {
          ...
          try
          {
            ...
            if( NIL != pph_error.pph_trace_level_exceeds_minimumP( TWO_INTEGER ) )
            {
              format_nil.force_format( T, $str19$__Leaving_PPH_POSSIBLY_BINDING_VA, pph_vars.$pph_possibly_binding_variables_counter$.getDynamicValue( thread ), pph_variable_handling.pph_registered_vars(), UNPROVIDED,
    ...
    {
      PrintLow.format( T, $str129$in_generate_phrase_with_subj_aux_, pph_phrase.pph_phrase_string( phrase, UNPROVIDED ) );
  ...
  public static SubLObject find_head_clause(final SubLObject phrase_template)
  {
    ...
    for( head_clause = phrase_template; NIL != pph_phrase.pph_phrase_has_dtrsP( head_clause ) && NIL != pph_phrase.pph_phrase_head_dtr_num( head_clause ) && NIL != pph_phrase.pph_phrase_sP( pph_phrase
        .pph_phrase_head_dtr( head_clause ) ); head_clause = pph_phrase.pph_phrase_head_dtr( head_clause ) )
    {
    }
    return head_clause;
  }
  ...
  public static SubLObject make_question_template(final SubLObject template, final SubLObject query_vars, SubLObject matrix_agr, SubLObject template_cycl)
  {
    ...
    if( NIL != pph_utilities.pph_nl_pred_listP( matrix_agr ) )
    {
      ...
      if( NIL != pph_utilities.pph_genlP( pph_phrase.pph_phrase_category( dtr, UNPROVIDED ), $const132$Verb, UNPROVIDED ) )
      {
        pph_phrase.pph_phrase_set_agr_preds( dtr, pph_utilities.pph_filter_preds( matrix_agr, ( NIL != dtr_tense_preds ) ? dtr_tense_preds : $kw1$ANY, UNPROVIDED ), UNPROVIDED );
      }
    }
    thread.resetMultipleValues();
    ...
    SubLObject head_verb_path = ConsesLow.list( pph_phrase.pph_phrase_head_dtr_num( template ) );
    ...
    else if( NIL != pph_phrase.pph_aux_verb_phraseP( head_verb ) )
    {
      if( NIL != pph_error.pph_trace_level_exceeds_minimumP( TWO_INTEGER ) )
      {
    ...
    else
    {
      ...
      if( NIL != pph_utilities.pph_english_contextP( UNPROVIDED ) && ( NIL != pph_utilities.pph_genl_pos_predP( pph_phrase.pph_phrase_agr_pred( template ), lexicon_cache.perfect_aspect_pred(), UNPROVIDED )
          || NIL != pph_utilities.pph_genl_pos_predP( pph_phrase.pph_phrase_agr_pred( head_verb ), lexicon_cache.perfect_aspect_pred(), UNPROVIDED ) ) )
      {
        final SubLObject have_dtr_num = make_multi_word_perfect_verb( template );
        pph_phrase.pph_phrase_front_subphrase( ConsesLow.list( have_dtr_num ), pph_phrase.pph_phrase_nth_dtr( template, have_dtr_num ), template );
        structure_changedP = T;
      }
      else
      {
  ...
  public static SubLObject make_multi_word_perfect_verb(final SubLObject phrase)
  {
    ...
    try
    {
      ...
      pph_phrase.pph_phrase_set_wu( have_dtr, $const141$Have_TheWord );
      final SubLObject old_head_agr_pred = pph_phrase.pph_phrase_agr_pred( phrase );
      final SubLObject new_agr_pred = ( NIL != pph_utilities.pph_genl_pos_predP( old_head_agr_pred, $const142$pastPerfect_Generic, UNPROVIDED ) ) ? $const31$pastTense_Generic : $const143$presentTense_Generic;
      if( NIL != pph_error.pph_trace_level_exceeds_minimumP( ONE_INTEGER ) )
      {
      ...
      pph_phrase.pph_phrase_set_agr( head_dtr, pph_data_structures.new_pph_phrase_agr( pph_utilities.new_pph_agr_constraint( $kw145$POS_PRED, $const146$perfect ), UNPROVIDED ), UNPROVIDED );
  ...
  {
    if( $kw36$TRUE == pph_data_structures.pph_phrase_info_lookup( phrase, $kw147$TEMPORAL_LOCATION, $kw148$FALSE ) && NIL == pph_phrase.pph_phrase_cycl_find_if( phrase, $sym149$ROP_FORMULA_ ) && NIL != pph_phrase
        .pph_phrase_cycl_find_if( phrase, $sym63$EL_VAR_ ) )
    {
      return T;
    }
    return NIL;
  ...
  public static SubLObject find_question_subphrase_int(final SubLObject phrase, final SubLObject current_path)
  {
    ...
    return Values.values( $kw151$NOT_FOUND, NIL );
  }
  ...
  {
    return pph_utilities.pph_list_ofP( Symbols.symbol_function( $sym152$INTEGERP ), v_object );
  }
  ...
  public static SubLObject pph_use_who_for_var_in_formulaP(final SubLObject var, final SubLObject formula)
  {
    ...
    final SubLObject cols = ConsesLow.cons( pph_variable_handling.pph_var_type( var ), pph_variable_handling.pph_variable_isa_constraints( var, formula, pph_vars.$pph_domain_mt$.getDynamicValue( thread ), T, T,
        UNPROVIDED ) );
    SubLObject use_whoP = NIL;
    SubLObject include_non_personsP = NIL;
    SubLObject doneP = NIL;
    if( NIL != pph_utilities.pph_genlP( pph_variable_handling.pph_var_type( var ), $const153$Agent_Generic, UNPROVIDED ) )
    {
      ...
      try
      {
        ...
        if( NIL == doneP )
        {
          ...
          while ( NIL == doneP && NIL != csome_list_var)
          {
            if( NIL == pph_utilities.pph_genlP( $const154$Person, col, UNPROVIDED ) )
            {
              use_whoP = NIL;
              doneP = T;
            }
            else if( NIL != pph_utilities.pph_genlP( col, $const154$Person, UNPROVIDED ) )
            {
              use_whoP = T;
            }
            else
  ...
  public static SubLObject string_for_var_in_question_phrase(final SubLObject phrase, final SubLObject formula)
  {
    ...
    if( NIL != question_var_npP( phrase ) )
    {
      ...
      else
      {
        if( NIL != number_varP( var, formula ) && NIL != pph_phrase.pph_phrase_has_dtrsP( phrase ) )
        {
          ...
          pph_phrase.pph_phrase_set_string( number_dtr, $str157$how_many );
          return phrase;
        }
        if( NIL != pph_methods.pph_var_ok_for_lexifyingP( var, NIL ) && NIL == pph_variable_handling.pph_var_registered_as_defaultP( var ) )
        {
          ...
          final SubLObject agr_pred = ( NIL != phrase_pred && ( NIL != pph_utilities.pph_genl_pos_predP( phrase_pred, $const158$nonPlural_Generic, UNPROVIDED ) || NIL != pph_utilities.pph_genl_pos_predP( phrase_pred,
              $const159$nonSingular_Generic, UNPROVIDED ) ) ) ? phrase_pred : ( ( NIL != single_valueP ) ? $const158$nonPlural_Generic : $const159$nonSingular_Generic );
          pph_phrase.pph_phrase_copy( pph_methods.pph_lexify_var( var, $kw160$WHAT, $const161$NounPhrase, agr_pred, pph_phrase.pph_phrase_arg_position_map( phrase ), UNPROVIDED ), phrase, UNPROVIDED );
        }
        else
        {
          pph_phrase.pph_phrase_set_string( phrase, $str162$what );
          olist = pph_phrase.pph_phrase_output_list( phrase );
        }
      }
    ...
    else if( NIL != pph_use_when_for_phraseP( phrase ) )
    {
  ...
  {
    return makeBoolean( NIL != pph_use_whomP() && $kw163$ACCUSATIVE == pph_phrase.pph_phrase_case( phrase ) );
  }
  ...
  public static SubLObject pph_phrase_set_who_or_whom(final SubLObject phrase, SubLObject include_non_personsP)
  {
    ...
    SubLObject who_string = ( NIL != pph_use_whom_for_phraseP( phrase ) ) ? $str164$whom : $str165$who;
    if( NIL != include_non_personsP )
    {
      who_string = Sequences.cconcatenate( who_string, $str166$_or_what );
    }
  ...
  public static SubLObject pph_new_when_phrase_from_phrase(final SubLObject phrase)
  {
    ...
    pph_phrase.pph_phrase_set_string( new_phrase, $str167$when );
    return new_phrase;
  }
  ...
  public static SubLObject pph_single_entry_varP(final SubLObject var, final SubLObject formula)
  {
    ...
    final SubLObject single_entryP = makeBoolean( NIL != kb_accessors.arg_n_single_entry_formatP( pred, var_position, pph_vars.$pph_domain_mt$.getDynamicValue( thread ) ) || NIL != pph_disjoint_meta_isa_formulaP( var,
        formula ) );
  ...
  public static SubLObject pph_disjoint_meta_isa_formulaP(final SubLObject var, final SubLObject formula)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject ans = NIL;
    if( NIL != formula_pattern_match.formula_matches_pattern( formula, ConsesLow.list( $const168$isa, $kw169$ANYTHING, var ) ) )
    {
      ...
      if( NIL != cycl_utilities.reified_term_p( var_type ) && NIL == ans )
      {
        ...
        final SubLObject deck_type = $kw172$STACK;
        ...
        try
        {
          ...
          try
          {
            ...
            try
            {
              ...
              mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
              mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
              final SubLObject tv_var = $const173$True_JustificationTruth;
              ...
              try
              {
                ...
                sbhl_search_vars.$relevant_sbhl_tv_function$.bind( ( NIL != tv_var ) ? $sym174$RELEVANT_SBHL_TV_IS_GENERAL_TV : sbhl_search_vars.$relevant_sbhl_tv_function$.getDynamicValue( thread ), thread );
                if( NIL != tv_var && NIL != sbhl_paranoia.sbhl_object_type_checking_p() && NIL == sbhl_search_vars.sbhl_true_tv_p( tv_var ) )
                {
                  final SubLObject pcase_var = sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread );
                  if( pcase_var.eql( $kw114$ERROR ) )
                  {
                    sbhl_paranoia.sbhl_error( ONE_INTEGER, $str175$_A_is_not_a__A, tv_var, $sym176$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                  }
                  else if( pcase_var.eql( $kw177$CERROR ) )
                  {
                    sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str178$continue_anyway, $str175$_A_is_not_a__A, tv_var, $sym176$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                  }
                  else if( pcase_var.eql( $kw179$WARN ) )
                  {
                    Errors.warn( $str175$_A_is_not_a__A, tv_var, $sym176$SBHL_TRUE_TV_P );
                  }
                  else
                  {
                    Errors.warn( $str180$_A_is_not_a_valid__sbhl_type_erro, sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread ) );
                    Errors.cerror( $str178$continue_anyway, $str175$_A_is_not_a__A, tv_var, $sym176$SBHL_TRUE_TV_P );
                  }
                }
                ...
                try
                {
                  sbhl_search_vars.$sbhl_search_module$.bind( sbhl_module_vars.get_sbhl_module( $const181$genls ), thread );
                  sbhl_search_vars.$sbhl_search_module_type$.bind( sbhl_module_utilities.get_sbhl_module_type( sbhl_module_vars.get_sbhl_module( $const181$genls ) ), thread );
                  sbhl_search_vars.$sbhl_add_node_to_result_test$.bind( sbhl_module_utilities.get_sbhl_add_node_to_result_test( sbhl_module_vars.get_sbhl_module( $const181$genls ) ), thread );
                  sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                  sbhl_module_vars.$sbhl_module$.bind( sbhl_module_vars.get_sbhl_module( $const181$genls ), thread );
                  if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( var_type, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                  {
                    ...
                    try
                    {
                      ...
                      sbhl_link_vars.$sbhl_link_direction$.bind( sbhl_module_utilities.sbhl_search_direction_to_link_direction( sbhl_search_vars.get_sbhl_forward_search_direction(), sbhl_module_vars.get_sbhl_module(
                          $const181$genls ) ), thread );
                      sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                      sbhl_marking_utilities.sbhl_mark_node_marked( node_var, UNPROVIDED );
                      while ( NIL != node_var && NIL == ans)
                      {
                        final SubLObject genl = node_var;
                        ans = makeBoolean( NIL != pph_utilities.pph_isaP( genl, $const182$FacetingCollectionType, UNPROVIDED ) || NIL != pph_utilities.pph_isaP( genl, $const183$DisjointCollectionType, UNPROVIDED ) );
                        final SubLObject accessible_modules = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_vars.get_sbhl_module( $const181$genls ) );
                        SubLObject rest;
                                      ...
                                      .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                  {
                                    ...
                                    if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                                    {
                                      ...
                                      try
                                      {
                                        ...
                                        for( iteration_state_$133 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == ans && NIL == dictionary_contents
                  ...
                  {
                    sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str186$Node__a_does_not_pass_sbhl_type_t, var_type, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED,
                        UNPROVIDED, UNPROVIDED );
                  }
                }
                finally
  ...
  {
    if( pph_phrase.pph_phrase_dtr_count( phrase ).numG( ONE_INTEGER ) && pph_phrase.pph_phrase_head_dtr_num( phrase ).eql( ONE_INTEGER ) && NIL != pph_phrase.pph_phrase_head_verbP( pph_phrase.pph_phrase_nth_dtr( phrase,
        ONE_INTEGER ) ) )
    {
      return T;
    }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $modal_strings_caching_state$.getGlobalValue(), ConsesLow.list( EMPTY_SUBL_OBJECT_ARRAY ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject modal_strings_internal()
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      strings = kb_mapping_utilities.pred_values( $const188$Modal, $const189$partOfSpeech, TWO_INTEGER, THREE_INTEGER, UNPROVIDED );
    }
    finally
    {
      mt_relevance_macros.$relevant_mts$.rebind( _prev_bind_3, thread );
  ...
  public static SubLObject modal_strings()
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym187$MODAL_STRINGS, $sym190$_MODAL_STRINGS_CACHING_STATE_, NIL, EQL, ZERO_INTEGER, ZERO_INTEGER );
    }
    SubLObject results = memoization_state.caching_state_get_zero_arg_results( caching_state, UNPROVIDED );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( modal_strings_internal() ) );
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $modal_words_caching_state$.getGlobalValue(), ConsesLow.list( EMPTY_SUBL_OBJECT_ARRAY ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject modal_words_internal()
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      words = kb_mapping_utilities.pred_values( $const188$Modal, $const189$partOfSpeech, TWO_INTEGER, ONE_INTEGER, UNPROVIDED );
    }
    finally
    {
      mt_relevance_macros.$relevant_mts$.rebind( _prev_bind_3, thread );
  ...
  public static SubLObject modal_words()
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym191$MODAL_WORDS, $sym192$_MODAL_WORDS_CACHING_STATE_, NIL, EQL, ZERO_INTEGER, ZERO_INTEGER );
    }
    SubLObject results = memoization_state.caching_state_get_zero_arg_results( caching_state, UNPROVIDED );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( modal_words_internal() ) );
      memoization_state.caching_state_set_zero_arg_results( caching_state, results, UNPROVIDED );
    }
    return memoization_state.caching_results( results );
  }
  ...
  {
    SubLFiles.declareFunction( me, "generate_question", "GENERATE-QUESTION", 1, 4, false );
    SubLFiles.declareFunction( me, "pph_standardize_query_sentence", "PPH-STANDARDIZE-QUERY-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_standardize_query_term", "PPH-STANDARDIZE-QUERY-TERM", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_default_question_preds", "PPH-DEFAULT-QUESTION-PREDS", 0, 0, false );
    SubLFiles.declareFunction( me, "pph_question_clause", "PPH-QUESTION-CLAUSE", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_question_clause_memoized_internal", "PPH-QUESTION-CLAUSE-MEMOIZED-INTERNAL", 2, 3, false );
    SubLFiles.declareFunction( me, "pph_question_clause_memoized", "PPH-QUESTION-CLAUSE-MEMOIZED", 2, 3, false );
    SubLFiles.declareFunction( me, "pph_remove_hypothetical", "PPH-REMOVE-HYPOTHETICAL", 1, 1, false );
    SubLFiles.declareFunction( me, "pph_hypothesize_antecedent_varsP", "PPH-HYPOTHESIZE-ANTECEDENT-VARS?", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_question_register_hypothetical_vars", "PPH-QUESTION-REGISTER-HYPOTHETICAL-VARS", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_add_hypothetical_paraphrase", "PPH-ADD-HYPOTHETICAL-PARAPHRASE", 7, 0, false );
    SubLFiles.declareFunction( me, "generate_question_non_propositional", "GENERATE-QUESTION-NON-PROPOSITIONAL", 2, 0, false );
    SubLFiles.declareFunction( me, "question_paraphrase_availableP", "QUESTION-PARAPHRASE-AVAILABLE?", 1, 3, false );
    SubLFiles.declareFunction( me, "clear_past_tense_formP", "CLEAR-PAST-TENSE-FORM?", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_past_tense_formP", "REMOVE-PAST-TENSE-FORM?", 1, 1, false );
    SubLFiles.declareFunction( me, "past_tense_formP_internal", "PAST-TENSE-FORM?-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "past_tense_formP", "PAST-TENSE-FORM?", 1, 1, false );
    SubLFiles.declareFunction( me, "prefer_past_tense_formP", "PREFER-PAST-TENSE-FORM?", 1, 0, false );
    SubLFiles.declareFunction( me, "generate_question_from_genquestion", "GENERATE-QUESTION-FROM-GENQUESTION", 1, 2, false );
    SubLFiles.declareFunction( me, "pph_question_arg", "PPH-QUESTION-ARG", 1, 0, false );
    SubLFiles.declareFunction( me, "get_genquestion_formula", "GET-GENQUESTION-FORMULA", 2, 0, false );
    SubLFiles.declareFunction( me, "get_genq_bindings", "GET-GENQ-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_blank_count", "PPH-BLANK-COUNT", 1, 0, false );
    SubLFiles.declareFunction( me, "generate_question_from_query_template", "GENERATE-QUESTION-FROM-QUERY-TEMPLATE", 1, 2, false );
    SubLFiles.declareFunction( me, "pph_phrase_ok_for_gtqsP", "PPH-PHRASE-OK-FOR-GTQS?", 2, 0, false );
    SubLFiles.declareFunction( me, "clear_gen_template_query_sentence_index", "CLEAR-GEN-TEMPLATE-QUERY-SENTENCE-INDEX", 0, 0, false );
    SubLFiles.declareFunction( me, "add_gen_template_query_sentence", "ADD-GEN-TEMPLATE-QUERY-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "remove_gen_template_query_sentence", "REMOVE-GEN-TEMPLATE-QUERY-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "initialize_gen_template_query_sentence_index", "INITIALIZE-GEN-TEMPLATE-QUERY-SENTENCE-INDEX", 0, 0, false );
    SubLFiles.declareFunction( me, "gen_template_query_sentence_lookup", "GEN-TEMPLATE-QUERY-SENTENCE-LOOKUP", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_visible_lexical_assertionP", "PPH-VISIBLE-LEXICAL-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "gen_template_query_sentence_candidates", "GEN-TEMPLATE-QUERY-SENTENCE-CANDIDATES", 1, 0, false );
    SubLFiles.declareFunction( me, "gtqs_assertions_for_query_sentence", "GTQS-ASSERTIONS-FOR-QUERY-SENTENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "gtqs_assertion_constant_count", "GTQS-ASSERTION-CONSTANT-COUNT", 1, 0, false );
    SubLFiles.declareFunction( me, "gtqs_assertion_matches_query_sentenceP", "GTQS-ASSERTION-MATCHES-QUERY-SENTENCE?", 2, 1, false );
    SubLFiles.declareFunction( me, "gtqs_assertion_bindings_for_query_sentence_internal", "GTQS-ASSERTION-BINDINGS-FOR-QUERY-SENTENCE-INTERNAL", 2, 1, false );
    SubLFiles.declareFunction( me, "gtqs_assertion_bindings_for_query_sentence", "GTQS-ASSERTION-BINDINGS-FOR-QUERY-SENTENCE", 2, 1, false );
    SubLFiles.declareFunction( me, "hlify_gtqs_template_variables", "HLIFY-GTQS-TEMPLATE-VARIABLES", 1, 0, false );
    SubLFiles.declareFunction( me, "non_hypothesized_el_varP", "NON-HYPOTHESIZED-EL-VAR?", 1, 0, false );
    SubLFiles.declareFunction( me, "gtqs_bindings_from_unification_bindings", "GTQS-BINDINGS-FROM-UNIFICATION-BINDINGS", 4, 0, false );
    SubLFiles.declareFunction( me, "gtqs_one_arg_position", "GTQS-ONE-ARG-POSITION", 2, 0, false );
    SubLFiles.declareFunction( me, "gtqs_specified_arg_matchesP", "GTQS-SPECIFIED-ARG-MATCHES?", 4, 0, false );
    SubLFiles.declareFunction( me, "pph_query_sentence_template_keywords", "PPH-QUERY-SENTENCE-TEMPLATE-KEYWORDS", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_query_sentence_template_vars", "PPH-QUERY-SENTENCE-TEMPLATE-VARS", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_question_template_unify", "PPH-QUESTION-TEMPLATE-UNIFY", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_hide_el_vars", "PPH-HIDE-EL-VARS", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_unhide_el_vars", "PPH-UNHIDE-EL-VARS", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_possible_formula", "PPH-UNIFY-POSSIBLE-FORMULA", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_possible_args", "PPH-UNIFY-POSSIBLE-ARGS", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_check_recursion_depth", "PPH-UNIFY-CHECK-RECURSION-DEPTH", 0, 0, false );
    SubLFiles.declareFunction( me, "pph_commutative_functor_p", "PPH-COMMUTATIVE-FUNCTOR-P", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_gtqs", "PPH-UNIFY-GTQS", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_formula_template", "PPH-UNIFY-FORMULA-TEMPLATE", 2, 1, false );
    SubLFiles.declareFunction( me, "pph_unify_formula_template_memoized_internal", "PPH-UNIFY-FORMULA-TEMPLATE-MEMOIZED-INTERNAL", 3, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_formula_template_memoized", "PPH-UNIFY-FORMULA-TEMPLATE-MEMOIZED", 3, 0, false );
    SubLFiles.declareFunction( me, "unification_bindings_from_result", "UNIFICATION-BINDINGS-FROM-RESULT", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_args", "PPH-UNIFY-ARGS", 3, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_args_memoized_internal", "PPH-UNIFY-ARGS-MEMOIZED-INTERNAL", 4, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_args_memoized", "PPH-UNIFY-ARGS-MEMOIZED", 4, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_ordered_args", "PPH-UNIFY-ORDERED-ARGS", 3, 0, false );
    SubLFiles.declareFunction( me, "pph_unify_args_permutations", "PPH-UNIFY-ARGS-PERMUTATIONS", 3, 0, false );
    SubLFiles.declareFunction( me, "pph_arglist_permutations", "PPH-ARGLIST-PERMUTATIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_phrase_for_query_sentence_from_gtqs_as", "PPH-PHRASE-FOR-QUERY-SENTENCE-FROM-GTQS-AS", 3, 0, false );
    SubLFiles.declareFunction( me, "replace_gtqs_template_terms", "REPLACE-GTQS-TEMPLATE-TERMS", 4, 0, false );
    SubLFiles.declareFunction( me, "dummy_query_sentence_for_gtqs_assertion", "DUMMY-QUERY-SENTENCE-FOR-GTQS-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "verify_all_gtqs_assertions", "VERIFY-ALL-GTQS-ASSERTIONS", 0, 1, false );
    SubLFiles.declareFunction( me, "verify_one_gtqs_assertion", "VERIFY-ONE-GTQS-ASSERTION", 2, 0, false );
    SubLFiles.declareFunction( me, "verify_one_gtqs_assertion_with_query_sentence", "VERIFY-ONE-GTQS-ASSERTION-WITH-QUERY-SENTENCE", 3, 0, false );
    SubLFiles.declareFunction( me, "generate_question_bf", "GENERATE-QUESTION-BF", 1, 3, false );
    SubLFiles.declareFunction( me, "pph_brute_force_yes_no_preamble_strings", "PPH-BRUTE-FORCE-YES-NO-PREAMBLE-STRINGS", 0, 2, false );
    SubLFiles.declareFunction( me, "pph_brute_force_true_or_false_string", "PPH-BRUTE-FORCE-TRUE-OR-FALSE-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_brute_force_false_string", "PPH-BRUTE-FORCE-FALSE-STRING", 0, 0, false );
    SubLFiles.declareFunction( me, "pph_brute_force_capitalize_false_string_p", "PPH-BRUTE-FORCE-CAPITALIZE-FALSE-STRING-P", 0, 0, false );
    SubLFiles.declareFunction( me, "pph_brute_force_wh_preamble_olist", "PPH-BRUTE-FORCE-WH-PREAMBLE-OLIST", 5, 0, false );
    SubLFiles.declareFunction( me, "pph_brute_force_wh_phrase_olist", "PPH-BRUTE-FORCE-WH-PHRASE-OLIST", 4, 0, false );
    SubLFiles.declareFunction( me, "new_pph_phrase_filler_item", "NEW-PPH-PHRASE-FILLER-ITEM", 1, 0, false );
    SubLFiles.declareFunction( me, "new_pph_phrase_filler_items", "NEW-PPH-PHRASE-FILLER-ITEMS", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_brute_force_olist_set_arg_positions", "PPH-BRUTE-FORCE-OLIST-SET-ARG-POSITIONS", 3, 0, false );
    SubLFiles.declareFunction( me, "pph_brute_force_wh_lexify_query_varsP", "PPH-BRUTE-FORCE-WH-LEXIFY-QUERY-VARS?", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_question_declarative_string", "PPH-QUESTION-DECLARATIVE-STRING", 2, 3, false );
    SubLFiles.declareFunction( me, "pph_remove_redundant_query_var_typing_clauses", "PPH-REMOVE-REDUNDANT-QUERY-VAR-TYPING-CLAUSES", 3, 0, false );
    SubLFiles.declareFunction( me, "question_rop_formulaP", "QUESTION-ROP-FORMULA?", 1, 0, false );
    SubLFiles.declareFunction( me, "rop_formulaP", "ROP-FORMULA?", 1, 0, false );
    SubLFiles.declareFunction( me, "question_var_npP", "QUESTION-VAR-NP?", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_phrase_maybe_npP", "PPH-PHRASE-MAYBE-NP?", 1, 0, false );
    SubLFiles.declareFunction( me, "el_var_det_nbarP", "EL-VAR-DET-NBAR?", 1, 0, false );
    SubLFiles.declareFunction( me, "el_var_np_var", "EL-VAR-NP-VAR", 1, 0, false );
    SubLFiles.declareFunction( me, "number_varP", "NUMBER-VAR?", 2, 0, false );
    SubLFiles.declareFunction( me, "no_number_varsP", "NO-NUMBER-VARS?", 2, 0, false );
    SubLFiles.declareFunction( me, "formula_ok_for_subj_aux_inversionP", "FORMULA-OK-FOR-SUBJ-AUX-INVERSION?", 1, 0, false );
    SubLFiles.declareFunction( me, "rmp_formula_to_intermediate_cycl", "RMP-FORMULA-TO-INTERMEDIATE-CYCL", 1, 0, false );
    SubLFiles.declareFunction( me, "op_ok_for_i_cyclP", "OP-OK-FOR-I-CYCL?", 1, 0, false );
    SubLFiles.declareFunction( me, "remove_var_typing_clauses_from_question_phrase", "REMOVE-VAR-TYPING-CLAUSES-FROM-QUESTION-PHRASE", 1, 0, false );
    SubLFiles.declareFunction( me, "generate_with_subj_aux_inversion", "GENERATE-WITH-SUBJ-AUX-INVERSION", 1, 2, false );
    SubLFiles.declareFunction( me, "generate_phrase_with_subj_aux_inversion", "GENERATE-PHRASE-WITH-SUBJ-AUX-INVERSION", 4, 1, false );
    SubLFiles.declareFunction( me, "find_head_clause", "FIND-HEAD-CLAUSE", 1, 0, false );
    SubLFiles.declareFunction( me, "make_question_template", "MAKE-QUESTION-TEMPLATE", 2, 2, false );
    SubLFiles.declareFunction( me, "pph_phrase_add_do_supportXinvert", "PPH-PHRASE-ADD-DO-SUPPORT&INVERT", 1, 0, false );
    SubLFiles.declareFunction( me, "make_multi_word_perfect_verb", "MAKE-MULTI-WORD-PERFECT-VERB", 1, 0, false );
    SubLFiles.declareFunction( me, "question_phraseP", "QUESTION-PHRASE?", 3, 0, false );
    SubLFiles.declareFunction( me, "pph_temporal_location_var_phraseP", "PPH-TEMPORAL-LOCATION-VAR-PHRASE?", 1, 0, false );
    SubLFiles.declareFunction( me, "find_question_subphrase", "FIND-QUESTION-SUBPHRASE", 1, 0, false );
    SubLFiles.declareFunction( me, "find_question_subphrase_int", "FIND-QUESTION-SUBPHRASE-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_subphrase_path_p", "PPH-SUBPHRASE-PATH-P", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_use_who_for_var_in_formulaP", "PPH-USE-WHO-FOR-VAR-IN-FORMULA?", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_use_when_for_phraseP", "PPH-USE-WHEN-FOR-PHRASE?", 1, 0, false );
    SubLFiles.declareFunction( me, "string_for_var_in_question_phrase", "STRING-FOR-VAR-IN-QUESTION-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_use_whomP", "PPH-USE-WHOM?", 0, 0, false );
    SubLFiles.declareFunction( me, "pph_use_whom_for_phraseP", "PPH-USE-WHOM-FOR-PHRASE?", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_phrase_set_who_or_whom", "PPH-PHRASE-SET-WHO-OR-WHOM", 1, 1, false );
    SubLFiles.declareFunction( me, "pph_new_when_phrase_from_phrase", "PPH-NEW-WHEN-PHRASE-FROM-PHRASE", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_find_temporal_location_var_dtr", "PPH-FIND-TEMPORAL-LOCATION-VAR-DTR", 1, 0, false );
    SubLFiles.declareFunction( me, "pph_single_entry_varP", "PPH-SINGLE-ENTRY-VAR?", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_disjoint_meta_isa_formulaP", "PPH-DISJOINT-META-ISA-FORMULA?", 2, 0, false );
    SubLFiles.declareFunction( me, "pph_phrase_subject_head_verb_initialP", "PPH-PHRASE-SUBJECT-HEAD-VERB-INITIAL?", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_modal_strings", "CLEAR-MODAL-STRINGS", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_modal_strings", "REMOVE-MODAL-STRINGS", 0, 0, false );
    SubLFiles.declareFunction( me, "modal_strings_internal", "MODAL-STRINGS-INTERNAL", 0, 0, false );
    SubLFiles.declareFunction( me, "modal_strings", "MODAL-STRINGS", 0, 0, false );
    SubLFiles.declareFunction( me, "clear_modal_words", "CLEAR-MODAL-WORDS", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_modal_words", "REMOVE-MODAL-WORDS", 0, 0, false );
    SubLFiles.declareFunction( me, "modal_words_internal", "MODAL-WORDS-INTERNAL", 0, 0, false );
    SubLFiles.declareFunction( me, "modal_words", "MODAL-WORDS", 0, 0, false );
    return NIL;
  }

  public static SubLObject init_pph_question_file()
  {
    $pph_default_question_preds$ = SubLFiles.deflexical( "*PPH-DEFAULT-QUESTION-PREDS*", $list11 );
    $past_tense_formP_caching_state$ = SubLFiles.deflexical( "*PAST-TENSE-FORM?-CACHING-STATE*", NIL );
    $pph_use_gtqsP$ = SubLFiles.defparameter( "*PPH-USE-GTQS?*", T );
    $gen_template_query_sentence_index$ = SubLFiles.deflexical( "*GEN-TEMPLATE-QUERY-SENTENCE-INDEX*", $kw41$UNINITIALIZED );
    $gen_template_query_sentence_index_lock$ = SubLFiles.deflexical( "*GEN-TEMPLATE-QUERY-SENTENCE-INDEX-LOCK*", Locks.make_lock( $str42$genTemplate_QuerySentence_index ) );
    $pph_unify_try_arg_permutationsP$ = SubLFiles.defparameter( "*PPH-UNIFY-TRY-ARG-PERMUTATIONS?*", NIL );
    $pph_unify_recursion_limit$ = SubLFiles.deflexical( "*PPH-UNIFY-RECURSION-LIMIT*", $int69$40 );
    $pph_unify_recursion_depth$ = SubLFiles.defparameter( "*PPH-UNIFY-RECURSION-DEPTH*", ZERO_INTEGER );
    $pph_arglist_permutations_max_arity$ = SubLFiles.deflexical( "*PPH-ARGLIST-PERMUTATIONS-MAX-ARITY*", SEVEN_INTEGER );
    $modal_strings_caching_state$ = SubLFiles.deflexical( "*MODAL-STRINGS-CACHING-STATE*", NIL );
    $modal_words_caching_state$ = SubLFiles.deflexical( "*MODAL-WORDS-CACHING-STATE*", NIL );
    return NIL;
  }

  public static SubLObject setup_pph_question_file()
  {
    memoization_state.note_memoized_function( $sym12$PPH_QUESTION_CLAUSE_MEMOIZED );
    memoization_state.note_globally_cached_function( $sym30$PAST_TENSE_FORM_ );
    utilities_macros.register_kb_function( $sym43$ADD_GEN_TEMPLATE_QUERY_SENTENCE );
    utilities_macros.register_kb_function( $sym44$REMOVE_GEN_TEMPLATE_QUERY_SENTENCE );
    memoization_state.note_memoized_function( $sym54$GTQS_ASSERTION_BINDINGS_FOR_QUERY_SENTENCE );
    utilities_macros.note_funcall_helper_function( $sym67$PPH_UNIFY_POSSIBLE_FORMULA );
    utilities_macros.note_funcall_helper_function( $sym68$PPH_UNIFY_POSSIBLE_ARGS );
    utilities_macros.note_funcall_helper_function( $sym71$PPH_UNIFY_FORMULA_TEMPLATE );
    memoization_state.note_memoized_function( $sym72$PPH_UNIFY_FORMULA_TEMPLATE_MEMOIZED );
    memoization_state.note_memoized_function( $sym76$PPH_UNIFY_ARGS_MEMOIZED );
    memoization_state.note_globally_cached_function( $sym187$MODAL_STRINGS );
    memoization_state.note_globally_cached_function( $sym191$MODAL_WORDS );
    return NIL;
  }
  ...
  {
    me = new pph_question();
    $pph_default_question_preds$ = null;
    $past_tense_formP_caching_state$ = null;
    $pph_use_gtqsP$ = null;
    $gen_template_query_sentence_index$ = null;
    $gen_template_query_sentence_index_lock$ = null;
    $pph_unify_try_arg_permutationsP$ = null;
    $pph_unify_recursion_limit$ = null;
    $pph_unify_recursion_depth$ = null;
    $pph_arglist_permutations_max_arity$ = null;
    $modal_strings_caching_state$ = null;
    $modal_words_caching_state$ = null;
    $kw0$TEXT = makeKeyword( "TEXT" );
    $kw1$ANY = makeKeyword( "ANY" );
    $sym2$VALID_EXTERNAL_PPH_NL_PREDS_ = makeSymbol( "VALID-EXTERNAL-PPH-NL-PREDS?" );
    $kw3$DEFAULT = makeKeyword( "DEFAULT" );
    $kw4$INTERROGATIVE = makeKeyword( "INTERROGATIVE" );
    $kw5$NEW = makeKeyword( "NEW" );
    $sym6$CATCH_ERROR_MESSAGE_HANDLER = makeSymbol( "CATCH-ERROR-MESSAGE-HANDLER" );
    $str7$___Top_level_CycL___S = makeString( "~% Top-level CycL: ~S" );
    $sym8$GEN_TEMPLATE_QUERY_SENTENCE_ASSERTION_P = makeSymbol( "GEN-TEMPLATE-QUERY-SENTENCE-ASSERTION-P" );
    $sym9$NART_P = makeSymbol( "NART-P" );
    $sym10$NART_EL_FORMULA = makeSymbol( "NART-EL-FORMULA" );
    $list11 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "tensed" ) ) );
    $sym12$PPH_QUESTION_CLAUSE_MEMOIZED = makeSymbol( "PPH-QUESTION-CLAUSE-MEMOIZED" );
    $list13 = ConsesLow.list( makeSymbol( "GENERATE-QUESTION-FROM-GENQUESTION" ), makeSymbol( "GENERATE-WITH-SUBJ-AUX-INVERSION" ), makeSymbol( "GENERATE-QUESTION-BF" ) );
    $kw14$UNSPECIFIED = makeKeyword( "UNSPECIFIED" );
    $list15 = ConsesLow.list( makeSymbol( "GENERATE-QUESTION-BF" ) );
    $sym16$GENERATE_QUESTION_FROM_QUERY_TEMPLATE = makeSymbol( "GENERATE-QUESTION-FROM-QUERY-TEMPLATE" );
    $str17$__Entering_PPH_POSSIBLY_BINDING_V = makeString( "~&Entering PPH-POSSIBLY-BINDING-VARIABLES(~S), *pph-var-types* are~% ~S~%" );
    $str18$Failed_to_paraphrase__givens____S = makeString( "Failed to paraphrase 'givens': ~S" );
    $str19$__Leaving_PPH_POSSIBLY_BINDING_VA = makeString( "~&Leaving PPH-POSSIBLY-BINDING-VARIABLES(~S), vars in local *pph-var-types* were ~s " );
    $str20$______and__pph_var_types__are_now = makeString( "~&... and *pph-var-types* are now ~S~%" );
    $const21$tensed = constant_handles.reader_make_constant_shell( makeString( "tensed" ) );
    $sym22$_EXIT = makeSymbol( "%EXIT" );
    $kw23$ARG1 = makeKeyword( "ARG1" );
    $kw24$ARG2 = makeKeyword( "ARG2" );
    $kw25$EXISTENTIAL = makeKeyword( "EXISTENTIAL" );
    $str26$if = makeString( "if" );
    $list27 = ConsesLow.list( ZERO_INTEGER );
    $const28$implies = constant_handles.reader_make_constant_shell( makeString( "implies" ) );
    $list29 = ConsesLow.list( makeSymbol( "GENERATE-QUESTION-FROM-GENQUESTION" ), makeSymbol( "GENERATE-WITH-SUBJ-AUX-INVERSION" ) );
    $sym30$PAST_TENSE_FORM_ = makeSymbol( "PAST-TENSE-FORM?" );
    $const31$pastTense_Generic = constant_handles.reader_make_constant_shell( makeString( "pastTense-Generic" ) );
    $sym32$_PAST_TENSE_FORM__CACHING_STATE_ = makeSymbol( "*PAST-TENSE-FORM?-CACHING-STATE*" );
    $kw33$IGNORE = makeKeyword( "IGNORE" );
    $const34$genQuestion = constant_handles.reader_make_constant_shell( makeString( "genQuestion" ) );
    $kw35$GAF = makeKeyword( "GAF" );
    $kw36$TRUE = makeKeyword( "TRUE" );
    $str37$__Trying____S = makeString( "~&Trying~% ~S" );
    $str38$_PPH_error_level_ = makeString( "(PPH error level " );
    $str39$__ = makeString( ") " );
    $str40$Done__S_alternatives_of__S = makeString( "Done ~S alternatives of ~S" );
    $kw41$UNINITIALIZED = makeKeyword( "UNINITIALIZED" );
    $str42$genTemplate_QuerySentence_index = makeString( "genTemplate-QuerySentence index" );
    $sym43$ADD_GEN_TEMPLATE_QUERY_SENTENCE = makeSymbol( "ADD-GEN-TEMPLATE-QUERY-SENTENCE" );
    $sym44$REMOVE_GEN_TEMPLATE_QUERY_SENTENCE = makeSymbol( "REMOVE-GEN-TEMPLATE-QUERY-SENTENCE" );
    ...
    $const47$genTemplate_QuerySentence = constant_handles.reader_make_constant_shell( makeString( "genTemplate-QuerySentence" ) );
    $sym48$INDEXED_TERM_P = makeSymbol( "INDEXED-TERM-P" );
    $sym49$PPH_VISIBLE_LEXICAL_ASSERTION_ = makeSymbol( "PPH-VISIBLE-LEXICAL-ASSERTION?" );
    $sym50$CAR = makeSymbol( "CAR" );
    $sym51$_ = makeSymbol( ">" );
    $sym52$GTQS_ASSERTION_CONSTANT_COUNT = makeSymbol( "GTQS-ASSERTION-CONSTANT-COUNT" );
    $sym53$CONSTANT_P = makeSymbol( "CONSTANT-P" );
    $sym54$GTQS_ASSERTION_BINDINGS_FOR_QUERY_SENTENCE = makeSymbol( "GTQS-ASSERTION-BINDINGS-FOR-QUERY-SENTENCE" );
    $str55$unexpected_result_from__UNIFY__S_ = makeString( "unexpected result from (UNIFY ~S ~S):~% ~S~%" );
    $sym56$PPH_ARG_POSITION_SPECIFIER_ = makeSymbol( "PPH-ARG-POSITION-SPECIFIER?" );
    $list57 = ConsesLow.cons( makeSymbol( "TEMPLATE-TERM" ), makeSymbol( "SENTENCE-TERM" ) );
    $str58$Failed_to_match__S_to_var_in_sent = makeString( "Failed to match ~S to var in sentence. Got ~S~%" );
    $str59$Failed_to_match__S_to_var_in_temp = makeString( "Failed to match ~S to var in template Got ~S~%" );
    $str60$Couldn_t_get_arg_position_for__S_ = makeString( "Couldn't get arg position for ~S in ~S" );
    $str61$_S_doesn_t_match__S_of__S = makeString( "~S doesn't match ~S of ~S" );
    $sym62$KEYWORDP = makeSymbol( "KEYWORDP" );
    $sym63$EL_VAR_ = makeSymbol( "EL-VAR?" );
    $sym64$EL_VAR_NAME = makeSymbol( "EL-VAR-NAME" );
    $sym65$EL_VAR_NAME_ = makeSymbol( "EL-VAR-NAME?" );
    $sym66$MAKE_EL_VAR = makeSymbol( "MAKE-EL-VAR" );
    $sym67$PPH_UNIFY_POSSIBLE_FORMULA = makeSymbol( "PPH-UNIFY-POSSIBLE-FORMULA" );
    $sym68$PPH_UNIFY_POSSIBLE_ARGS = makeSymbol( "PPH-UNIFY-POSSIBLE-ARGS" );
    $int69$40 = makeInteger( 40 );
    $str70$Exceeded_PPH_unify_recursion_dept = makeString( "Exceeded PPH unify recursion depth of ~S.~%" );
    $sym71$PPH_UNIFY_FORMULA_TEMPLATE = makeSymbol( "PPH-UNIFY-FORMULA-TEMPLATE" );
    $sym72$PPH_UNIFY_FORMULA_TEMPLATE_MEMOIZED = makeSymbol( "PPH-UNIFY-FORMULA-TEMPLATE-MEMOIZED" );
    $str73$Not_in_unify_multiple_mode_ = makeString( "Not in unify-multiple mode." );
    $str74$Couldn_t_unify____S____S______giv = makeString( "Couldn't unify~% ~S~% ~S~% ...given ~S~%" );
    $str75$Found_multiple_bindings_for____S_ = makeString( "Found multiple bindings for~% ~S~% ~S ...given ~S~% ~S~%" );
    $sym76$PPH_UNIFY_ARGS_MEMOIZED = makeSymbol( "PPH-UNIFY-ARGS-MEMOIZED" );
    $str77$Skipping_permutations_for_templat = makeString( "Skipping permutations for template of length ~D ~% ~S~% ~S" );
    $str78$Lost_assumed_bindings________S__ = makeString( "Lost assumed bindings(?).~% ~S~%" );
    $str79$__GTQS_Bindings___S___Map___S = makeString( "~%GTQS Bindings: ~S~% Map: ~S" );
    $list80 = ConsesLow.cons( makeSymbol( "TEMPLATE-TERM" ), makeSymbol( "LOCAL-ARG-POSITION" ) );
    $str81$GTQS__Couldn_t_find__S_in____S__ = makeString( "GTQS: Couldn't find ~S in~% ~S~%" );
    $str82$__GTQS__Replacing__S_with__S__S__ = makeString( "~&GTQS: Replacing ~S with ~S ~S~%" );
    $str83$GTQS__Couldn_t_replace__S_for__S_ = makeString( "GTQS: Couldn't replace ~S for ~S in ~S" );
    $const84$Thing = constant_handles.reader_make_constant_shell( makeString( "Thing" ) );
    $const85$InstanceNamedFn_Ternary = constant_handles.reader_make_constant_shell( makeString( "InstanceNamedFn-Ternary" ) );
    $str86$example = makeString( "example" );
    $int87$30 = makeInteger( 30 );
    $str88$Checking___genTemplate_QuerySente = makeString( "Checking #$genTemplate-QuerySentence assertions..." );
    $str89$__Matched__S_of__S___genTemplate_ = makeString( "~&Matched ~S of ~S #$genTemplate-QuerySentence assertions.~% Time: ~S seconds.~%" );
    $str90$Timed_out_after__S_seconds_on____ = makeString( "Timed out after ~S seconds on~% ~S" );
    $str91$Didn_t_find_gtqs_in_matches_____S = makeString( "Didn't find gtqs in matches:~% ~S~%" );
    $sym92$PPH_QUERY_VAR_P = makeSymbol( "PPH-QUERY-VAR-P" );
    $list93 = ConsesLow.list( makeKeyword( "BLANKS" ), makeKeyword( "VARS" ) );
    $kw94$BLANKS = makeKeyword( "BLANKS" );
    $kw95$VARS = makeKeyword( "VARS" );
    $sym96$ALIST_P = makeSymbol( "ALIST-P" );
    $const97$not = constant_handles.reader_make_constant_shell( makeString( "not" ) );
    $str98$was_ = makeString( "was " );
    $str99$is_ = makeString( "is " );
    $str100$it_ = makeString( "it " );
    $str101$that = makeString( "that" );
    $str102$true = makeString( "true" );
    $str103$FALSE = makeString( "FALSE" );
    $str104$false = makeString( "false" );
    $str105$were = makeString( "were" );
    $str106$are = makeString( "are" );
    $str107$_there_such_that = makeString( " there such that" );
    $list108 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "plural-Generic" ) ) );
    $kw109$AND = makeKeyword( "AND" );
    $str110$what_values_of = makeString( "what values of" );
    $str111$__Setting_arg_position_of__S_to__ = makeString( "~&Setting arg-position of ~S to ~S from ~S.~%" );
    $sym112$PPH_VAR_REGISTERED_AS_DEFAULT_ = makeSymbol( "PPH-VAR-REGISTERED-AS-DEFAULT?" );
    $sym113$PPH_EXCEPTIONAL_VAR_P = makeSymbol( "PPH-EXCEPTIONAL-VAR-P" );
    $kw114$ERROR = makeKeyword( "ERROR" );
    $const115$WHWord = constant_handles.reader_make_constant_shell( makeString( "WHWord" ) );
    $const116$AuxVerb = constant_handles.reader_make_constant_shell( makeString( "AuxVerb" ) );
    $sym117$QUESTION_ROP_FORMULA_ = makeSymbol( "QUESTION-ROP-FORMULA?" );
    $const118$TheResultOfParsing = constant_handles.reader_make_constant_shell( makeString( "TheResultOfParsing" ) );
    $const119$nounStrings = constant_handles.reader_make_constant_shell( makeString( "nounStrings" ) );
    $const120$Determiner = constant_handles.reader_make_constant_shell( makeString( "Determiner" ) );
    $sym121$TRUE = makeSymbol( "TRUE" );
    $const122$Integer = constant_handles.reader_make_constant_shell( makeString( "Integer" ) );
    $sym123$PPH_SPEC_ = makeSymbol( "PPH-SPEC?" );
    $str124$___S_determined_to_be_a_number_va = makeString( "~&~S determined to be a number var in ~S~%" );
    $str125$No_number_vars_in__S__ = makeString( "No number vars in ~S~%" );
    $str126$__Trying_to_generate__S_using_sub = makeString( "~&Trying to generate ~S using subject-auxiliary inversion.~%" );
    $str127$__Made_question_template__S = makeString( "~&Made question template ~S" );
    $str128$_X_such_that = makeString( "?X such that" );
    $str129$in_generate_phrase_with_subj_aux_ = makeString( "in generate-phrase-with-subj-aux-inversion string is ~S; trying again~%" );
    $str130$__Not_subject_head_verb_initial__ = makeString( "~&Not subject-head-verb-initial:~% ~S" );
    $sym131$PPH_TENSE_PRED_ = makeSymbol( "PPH-TENSE-PRED?" );
    $const132$Verb = constant_handles.reader_make_constant_shell( makeString( "Verb" ) );
    $str133$__Couldn_t_find_question_subphras = makeString( "~&Couldn't find question subphrase:~% ~S" );
    $str134$__Subject_dtr_of__S_is_a_wh_phras = makeString( "~&Subject dtr of ~S is a wh-phrase; returning template as is.~%" );
    $str135$___S_has_no_head_verb__MAKE_QUEST = makeString( "~&~S has no head verb; MAKE-QUESTION-TEMPLATE returning NIL.~%" );
    $str136$__Head_dtr__S_is_a_copula__placin = makeString( "~&Head dtr ~S is a copula; placing it in front of the subject.~%" );
    $str137$__Head_dtr__S_is_an_auxiliary__pl = makeString( "~&Head dtr ~S is an auxiliary; placing it in front of the subject.~%" );
    $str138$___S_may_be_a_modal_verb__MAKE_QU = makeString( "~&~S may be a modal verb; MAKE-QUESTION-TEMPLATE returning NIL~%" );
    $str139$__Adding_do_support_to_template__ = makeString( "~&Adding do support to template ~S" );
    $str140$Fronting__S = makeString( "Fronting ~S" );
    $const141$Have_TheWord = constant_handles.reader_make_constant_shell( makeString( "Have-TheWord" ) );
    $const142$pastPerfect_Generic = constant_handles.reader_make_constant_shell( makeString( "pastPerfect-Generic" ) );
    $const143$presentTense_Generic = constant_handles.reader_make_constant_shell( makeString( "presentTense-Generic" ) );
    $str144$De_perfectiving_agr_from__S_to__S = makeString( "De-perfectiving agr from ~S to ~S" );
    $kw145$POS_PRED = makeKeyword( "POS-PRED" );
    $const146$perfect = constant_handles.reader_make_constant_shell( makeString( "perfect" ) );
    $kw147$TEMPORAL_LOCATION = makeKeyword( "TEMPORAL-LOCATION" );
    $kw148$FALSE = makeKeyword( "FALSE" );
    $sym149$ROP_FORMULA_ = makeSymbol( "ROP-FORMULA?" );
    $str150$Found_question_phrase___S = makeString( "Found question phrase: ~S" );
    $kw151$NOT_FOUND = makeKeyword( "NOT-FOUND" );
    $sym152$INTEGERP = makeSymbol( "INTEGERP" );
    $const153$Agent_Generic = constant_handles.reader_make_constant_shell( makeString( "Agent-Generic" ) );
    $const154$Person = constant_handles.reader_make_constant_shell( makeString( "Person" ) );
    $str155$in_STRING_FOR_VAR_IN_QUESTION_PHR = makeString( "in STRING-FOR-VAR-IN-QUESTION-PHRASE: var is ~S~%" );
    $str156$pph_var_type_for__S___S__ = makeString( "pph-var-type for ~S: ~S~%" );
    $str157$how_many = makeString( "how many" );
    $const158$nonPlural_Generic = constant_handles.reader_make_constant_shell( makeString( "nonPlural-Generic" ) );
    $const159$nonSingular_Generic = constant_handles.reader_make_constant_shell( makeString( "nonSingular-Generic" ) );
    $kw160$WHAT = makeKeyword( "WHAT" );
    $const161$NounPhrase = constant_handles.reader_make_constant_shell( makeString( "NounPhrase" ) );
    $str162$what = makeString( "what" );
    $kw163$ACCUSATIVE = makeKeyword( "ACCUSATIVE" );
    $str164$whom = makeString( "whom" );
    $str165$who = makeString( "who" );
    $str166$_or_what = makeString( " or what" );
    $str167$when = makeString( "when" );
    $const168$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $kw169$ANYTHING = makeKeyword( "ANYTHING" );
    $kw170$BREADTH = makeKeyword( "BREADTH" );
    $kw171$QUEUE = makeKeyword( "QUEUE" );
    $kw172$STACK = makeKeyword( "STACK" );
    $const173$True_JustificationTruth = constant_handles.reader_make_constant_shell( makeString( "True-JustificationTruth" ) );
    $sym174$RELEVANT_SBHL_TV_IS_GENERAL_TV = makeSymbol( "RELEVANT-SBHL-TV-IS-GENERAL-TV" );
    $str175$_A_is_not_a__A = makeString( "~A is not a ~A" );
    $sym176$SBHL_TRUE_TV_P = makeSymbol( "SBHL-TRUE-TV-P" );
    $kw177$CERROR = makeKeyword( "CERROR" );
    $str178$continue_anyway = makeString( "continue anyway" );
    $kw179$WARN = makeKeyword( "WARN" );
    $str180$_A_is_not_a_valid__sbhl_type_erro = makeString( "~A is not a valid *sbhl-type-error-action* value" );
    $const181$genls = constant_handles.reader_make_constant_shell( makeString( "genls" ) );
    $const182$FacetingCollectionType = constant_handles.reader_make_constant_shell( makeString( "FacetingCollectionType" ) );
    $const183$DisjointCollectionType = constant_handles.reader_make_constant_shell( makeString( "DisjointCollectionType" ) );
    $str184$_A_is_neither_SET_P_nor_LISTP_ = makeString( "~A is neither SET-P nor LISTP." );
    $str185$attempting_to_bind_direction_link = makeString( "attempting to bind direction link variable, to NIL. macro body not executed." );
    $str186$Node__a_does_not_pass_sbhl_type_t = makeString( "Node ~a does not pass sbhl-type-test ~a~%" );
    $sym187$MODAL_STRINGS = makeSymbol( "MODAL-STRINGS" );
    $const188$Modal = constant_handles.reader_make_constant_shell( makeString( "Modal" ) );
    $const189$partOfSpeech = constant_handles.reader_make_constant_shell( makeString( "partOfSpeech" ) );
    $sym190$_MODAL_STRINGS_CACHING_STATE_ = makeSymbol( "*MODAL-STRINGS-CACHING-STATE*" );
    $sym191$MODAL_WORDS = makeSymbol( "MODAL-WORDS" );
    $sym192$_MODAL_WORDS_CACHING_STATE_ = makeSymbol( "*MODAL-WORDS-CACHING-STATE*" );
  }
}
/*
 * 
