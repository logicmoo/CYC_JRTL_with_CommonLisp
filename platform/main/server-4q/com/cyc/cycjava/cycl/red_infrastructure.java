...
import com.cyc.cycjava.cycl.red_infrastructure;
...
import static com.cyc.cycjava.cycl.red_infrastructure.*;
...
public final class red_infrastructure extends SubLTranslatedFile {
    ...
    public static SubLObject red_symbol_p(final SubLObject v_object) {
        return v_object.getClass() == red_infrastructure.$red_symbol_native.class ? T : NIL;
    }

    public static SubLObject red_symbol_name(final SubLObject v_object) {
        assert NIL != red_symbol_p(v_object) : "red_infrastructure.red_symbol_p(v_object) " + "CommonSymbols.NIL != red_infrastructure.red_symbol_p(v_object) " + v_object;
    ...
    public static SubLObject make_red_symbol(SubLObject arglist) {
        ...
        final SubLObject v_new = new red_infrastructure.$red_symbol_native();
        SubLObject next;
    ...
    public static final class $red_symbol_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(red_infrastructure.$red_symbol_native.class, RED_SYMBOL, RED_SYMBOL_P, $list7, $list8, new String[]{ "$name", "$red_key", "$default_value", "$ltype", "$set_from_red", "$valuetype" }, $list9, $list10, PRINT_RED_SYMBOL);
        }
    }
