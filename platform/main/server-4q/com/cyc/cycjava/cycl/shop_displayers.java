...
import com.cyc.cycjava.cycl.shop_displayers;
...
import static com.cyc.cycjava.cycl.shop_displayers.*;
...
public final class shop_displayers extends SubLTranslatedFile {
    ...
    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_HTML_TASK_DISPLAYER_CLASS = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-HTML-TASK-DISPLAYER-CLASS");





    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_HTML_TASK_DISPLAYER_INSTANCE = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-HTML-TASK-DISPLAYER-INSTANCE");

    public static final SubLSymbol HTML_PLAN_DISPLAYER = makeSymbol("HTML-PLAN-DISPLAYER");

    public static final SubLList $list21 = list(makeSymbol("SHOP-PLAN-I"));

    public static final SubLList $list22 = list(new SubLObject[]{ list(makeSymbol("PLAN"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("TASK-DISPLAYER-HASH-TABLE"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("MBINDING"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("OPEN-VARIABLES"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DISPLAY-VARIABLE-SUBSTITUTION"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INITIALIZE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("HTML-FORM"), list(makeSymbol("STYLE-ARGS")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("HTML-HIERARCHICAL-FORM"), list(makeSymbol("STYLE-ARGS")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("HTML-PRIMITIVE-FORM"), list(makeSymbol("STYLE-ARGS")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("HTML-MBINDING-FORM"), list(makeSymbol("STYLE-ARGS")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("HTML-MULTIBINDING-VALUES"), list(makeSymbol("VAR"), makeSymbol("MBINDING"), makeSymbol("STYLE-ARGS")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PREPARE-TASK-FOR-DISPLAY"), list(makeSymbol("TASK")), makeKeyword("PROTECTED")) });

    public static final SubLSymbol DISPLAY_VARIABLE_SUBSTITUTION = makeSymbol("DISPLAY-VARIABLE-SUBSTITUTION");





    public static final SubLSymbol TASK_DISPLAYER_HASH_TABLE = makeSymbol("TASK-DISPLAYER-HASH-TABLE");



    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_HTML_PLAN_DISPLAYER_CLASS = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-HTML-PLAN-DISPLAYER-CLASS");

    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_HTML_PLAN_DISPLAYER_INSTANCE = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-HTML-PLAN-DISPLAYER-INSTANCE");

    public static final SubLSymbol CYC_DEVELOPMENT_PLAN_DISPLAYER_FACTORY = makeSymbol("CYC-DEVELOPMENT-PLAN-DISPLAYER-FACTORY");

    public static final SubLSymbol SHOP_PLAN_DISPLAYER_FACTORY = makeSymbol("SHOP-PLAN-DISPLAYER-FACTORY");

    public static final SubLSymbol $sym32$SUBLOOP_RESERVED_INITIALIZE_CYC_DEVELOPMENT_PLAN_DISPLAYER_FACTOR = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-CYC-DEVELOPMENT-PLAN-DISPLAYER-FACTORY-CLASS");

    public static final SubLSymbol $sym33$SUBLOOP_RESERVED_INITIALIZE_CYC_DEVELOPMENT_PLAN_DISPLAYER_FACTOR = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-CYC-DEVELOPMENT-PLAN-DISPLAYER-FACTORY-INSTANCE");

    public static final SubLSymbol CREATE_PLAN_DISPLAYER = makeSymbol("CREATE-PLAN-DISPLAYER");

    public static final SubLList $list35 = list(makeKeyword("PUBLIC"));

    public static final SubLList $list36 = list(makeSymbol("PLAN"));

    public static final SubLList $list37 = list(list(makeSymbol("CLET"), list(list(makeSymbol("PLAN-DISPLAYER"), list(makeSymbol("INLINE-METHOD"), list(makeSymbol("NEW"), makeSymbol("HTML-PLAN-DISPLAYER")), list(makeSymbol("QUOTE"), makeSymbol("HTML-PLAN-DISPLAYER"))))), list(makeSymbol("INLINE-METHOD"), list(makeSymbol("INIT-WITH-PLAN"), makeSymbol("HTML-PLAN-DISPLAYER")), makeSymbol("PLAN-DISPLAYER"), makeSymbol("PLAN"), makeSymbol("SELF")), list(makeSymbol("RET"), makeSymbol("PLAN-DISPLAYER"))));

    public static final SubLSymbol INIT_WITH_PLAN = makeSymbol("INIT-WITH-PLAN");

    public static final SubLSymbol $sym39$CYC_DEVELOPMENT_PLAN_DISPLAYER_FACTORY_CREATE_PLAN_DISPLAYER_METH = makeSymbol("CYC-DEVELOPMENT-PLAN-DISPLAYER-FACTORY-CREATE-PLAN-DISPLAYER-METHOD");

    public static final SubLSymbol CREATE_TASK_DISPLAYER = makeSymbol("CREATE-TASK-DISPLAYER");

    public static final SubLList $list41 = list(makeSymbol("TASK"));

    public static final SubLList $list42 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TASK-DISPLAYER"), list(makeSymbol("INLINE-METHOD"), list(makeSymbol("NEW"), makeSymbol("HTML-TASK-DISPLAYER")), list(makeSymbol("QUOTE"), makeSymbol("HTML-TASK-DISPLAYER"))))), list(makeSymbol("INLINE-METHOD"), list(makeSymbol("INIT-WITH-TASK"), makeSymbol("HTML-TASK-DISPLAYER")), makeSymbol("TASK-DISPLAYER"), makeSymbol("TASK")), list(makeSymbol("RET"), makeSymbol("TASK-DISPLAYER"))));

    public static final SubLSymbol $sym43$CYC_DEVELOPMENT_PLAN_DISPLAYER_FACTORY_CREATE_TASK_DISPLAYER_METH = makeSymbol("CYC-DEVELOPMENT-PLAN-DISPLAYER-FACTORY-CREATE-TASK-DISPLAYER-METHOD");



    public static final SubLList $list45 = list(makeKeyword("PROTECTED"));

    public static final SubLList $list46 = list(list(makeSymbol("INITIALIZE"), makeSymbol("SUPER")), list(makeSymbol("RET"), makeSymbol("SELF")));

    public static final SubLSymbol HTML_TASK_DISPLAYER_INITIALIZE_METHOD = makeSymbol("HTML-TASK-DISPLAYER-INITIALIZE-METHOD");

    public static final SubLSymbol INIT_WITH_TASK = makeSymbol("INIT-WITH-TASK");

    public static final SubLList $list49 = list(makeSymbol("NEW-TASK"));

    public static final SubLList $list50 = list(list(makeSymbol("CSETQ"), makeSymbol("TASK"), makeSymbol("NEW-TASK")), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol $sym51$OUTER_CATCH_FOR_HTML_TASK_DISPLAYER_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-HTML-TASK-DISPLAYER-METHOD");

    public static final SubLSymbol HTML_TASK_DISPLAYER_INIT_WITH_TASK_METHOD = makeSymbol("HTML-TASK-DISPLAYER-INIT-WITH-TASK-METHOD");

    public static final SubLSymbol FIND_INSTANCE_BY_ID_STRING = makeSymbol("FIND-INSTANCE-BY-ID-STRING");

    public static final SubLList $list54 = list(makeSymbol("ID-STRING"));

    public static final SubLList $list55 = list(list(makeSymbol("CLET"), list(list(makeSymbol("ID"), list(makeSymbol("READ-FROM-STRING-IGNORING-ERRORS"), makeSymbol("ID-STRING")))), list(makeSymbol("RET"), list(makeSymbol("FIND-INSTANCE"), makeSymbol("SELF"), makeSymbol("ID")))));

    public static final SubLSymbol HTML_TASK_DISPLAYER_FIND_INSTANCE_BY_ID_STRING_METHOD = makeSymbol("HTML-TASK-DISPLAYER-FIND-INSTANCE-BY-ID-STRING-METHOD");

    public static final SubLSymbol TASK_EXAMINER_LINK_IMAGE = makeSymbol("TASK-EXAMINER-LINK-IMAGE");

    public static final SubLList $list58 = list(makeString("@param TASK shop-task-p\n   @return keywordp ;; cb-icon to use for image"), list(makeSymbol("CLET"), list(list(makeSymbol("PLANNER-RULE"), list(makeSymbol("INLINE-METHOD"), list(makeSymbol("PLANNER-RULE"), makeSymbol("TASK")), makeSymbol("TASK")))), list(makeSymbol("PCOND"), list(list(makeSymbol("SHOP-METHOD-P"), makeSymbol("PLANNER-RULE")), list(makeSymbol("RET"), makeSymbol("*CB-PLAN-TASK-EXAMINER-METHOD-IMAGE*"))), list(list(makeSymbol("SHOP-PRECONDITION-P"), makeSymbol("PLANNER-RULE")), list(makeSymbol("RET"), makeSymbol("*CB-PLAN-TASK-EXAMINER-OPERATOR-IMAGE*"))), list(list(makeSymbol("SHOP-SUFFICIENCY-CONDITION-P"), makeSymbol("PLANNER-RULE")), list(makeSymbol("RET"), makeSymbol("*CB-PLAN-TASK-EXAMINER-SCOND-IMAGE*"))), list(T, list(makeSymbol("RET"), makeSymbol("*CB-PLAN-TASK-EXAMINER-LINK-IMAGE*"))))));

    public static final SubLSymbol $sym59$OUTER_CATCH_FOR_HTML_TASK_DISPLAYER_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-HTML-TASK-DISPLAYER-METHOD");



    public static final SubLSymbol HTML_TASK_DISPLAYER_TASK_EXAMINER_LINK_IMAGE_METHOD = makeSymbol("HTML-TASK-DISPLAYER-TASK-EXAMINER-LINK-IMAGE-METHOD");

    public static final SubLSymbol CB_TASK_EXAMINER_LINK = makeSymbol("CB-TASK-EXAMINER-LINK");

    public static final SubLList $list63 = list(list(makeSymbol("CLET"), list(list(makeSymbol("ID-STRING"), list(makeSymbol("WRITE-TO-STRING"), list(makeSymbol("GET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("INSTANCE-NUMBER"))))), list(makeSymbol("HREF"), list(makeSymbol("CCONCATENATE"), makeString("cg?plan-task-examiner&"), makeSymbol("ID-STRING"))), list(makeSymbol("IMAGE"), list(makeSymbol("TASK-EXAMINER-LINK-IMAGE"), makeSymbol("SELF")))), list(makeSymbol("HTML-FANCY-ANCHOR"), list(makeKeyword("HREF"), makeSymbol("HREF")), list(makeSymbol("CB-ICON"), makeSymbol("IMAGE"), makeKeyword("BORDER-OVERRIDE"), ZERO_INTEGER))), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol $sym64$OUTER_CATCH_FOR_HTML_TASK_DISPLAYER_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-HTML-TASK-DISPLAYER-METHOD");

    public static final SubLString $str65$cg_plan_task_examiner_ = makeString("cg?plan-task-examiner&");



    public static final SubLSymbol HTML_TASK_DISPLAYER_CB_TASK_EXAMINER_LINK_METHOD = makeSymbol("HTML-TASK-DISPLAYER-CB-TASK-EXAMINER-LINK-METHOD");

    public static final SubLSymbol HTML_FORM = makeSymbol("HTML-FORM");

    public static final SubLList $list69 = list(makeSymbol("STYLE-ARGS"));

    public static final SubLList $list70 = list(list(makeSymbol("PWHEN"), list(makeSymbol("MEMBER?"), makeKeyword("TASK-EXAMINER-LINKS"), makeSymbol("STYLE-ARGS")), list(makeSymbol("CB-TASK-EXAMINER-LINK"), makeSymbol("SELF"))), list(makeSymbol("CLET"), list(list(makeSymbol("DISPLAY-FORM"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("PLAN-DISPLAYER"), list(makeSymbol("QUOTE"), makeSymbol("PREPARE-TASK-FOR-DISPLAY")), list(makeSymbol("GET-SLOT"), makeSymbol("TASK"), list(makeSymbol("QUOTE"), makeSymbol("FORMULA")))))), list(makeSymbol("PIF"), list(makeSymbol("MEMBER?"), makeKeyword("CYCL"), makeSymbol("STYLE-ARGS")), list(makeSymbol("CB-FORM"), makeSymbol("DISPLAY-FORM")), list(makeSymbol("PROGN"), list(makeSymbol("CLET"), list(list(makeSymbol("*PPH-QUANTIFY-VARS?*"), NIL)), list(makeSymbol("HTML-TEXT-WITH-TARGET"), makeSymbol("DISPLAY-FORM"))))), list(makeSymbol("RET"), NIL)));

    public static final SubLSymbol $sym71$OUTER_CATCH_FOR_HTML_TASK_DISPLAYER_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-HTML-TASK-DISPLAYER-METHOD");

    private static final SubLSymbol $TASK_EXAMINER_LINKS = makeKeyword("TASK-EXAMINER-LINKS");

    public static final SubLSymbol PREPARE_TASK_FOR_DISPLAY = makeSymbol("PREPARE-TASK-FOR-DISPLAY");





    public static final SubLSymbol HTML_TASK_DISPLAYER_HTML_FORM_METHOD = makeSymbol("HTML-TASK-DISPLAYER-HTML-FORM-METHOD");

    public static final SubLList $list77 = list(list(makeSymbol("RET"), list(makeSymbol("GET-SLOT"), makeSymbol("TASK"), list(makeSymbol("QUOTE"), makeSymbol("FORMULA")))));

    public static final SubLSymbol $sym78$OUTER_CATCH_FOR_HTML_TASK_DISPLAYER_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-HTML-TASK-DISPLAYER-METHOD");

    public static final SubLSymbol HTML_TASK_DISPLAYER_FORMULA_METHOD = makeSymbol("HTML-TASK-DISPLAYER-FORMULA-METHOD");



    public static final SubLList $list81 = list(list(makeSymbol("RET"), list(makeSymbol("GET-SLOT"), makeSymbol("TASK"), list(makeSymbol("QUOTE"), makeSymbol("BINDINGS")))));

    public static final SubLSymbol $sym82$OUTER_CATCH_FOR_HTML_TASK_DISPLAYER_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-HTML-TASK-DISPLAYER-METHOD");

    public static final SubLSymbol HTML_TASK_DISPLAYER_BINDINGS_METHOD = makeSymbol("HTML-TASK-DISPLAYER-BINDINGS-METHOD");

    public static final SubLSymbol DISPLAY_BINDINGS = makeSymbol("DISPLAY-BINDINGS");

    public static final SubLList $list85 = list(makeKeyword("PRIVATE"));

    public static final SubLList $list86 = list(list(makeSymbol("IGNORE"), makeSymbol("STYLE-ARGS")), list(makeSymbol("CLET"), list(list(makeSymbol("VAR-MANAGER"), list(makeSymbol("GET-COMPOSED-SLOTS"), makeSymbol("SELF"), makeSymbol("VARIABLE-MANAGER"), makeSymbol("PLAN"), makeSymbol("PLAN-DISPLAYER"))), list(makeSymbol("MBIND"), list(makeSymbol("BINDINGS"), makeSymbol("SELF")))), list(makeSymbol("PWHEN"), makeSymbol("MBIND"), list(makeSymbol("HTML-FANCY-TABLE"), list(makeKeyword("BORDER"), ZERO_INTEGER), list(makeSymbol("DO-MBIND"), list(makeSymbol("CUR-VAR"), makeSymbol("CUR-VALUES"), makeSymbol("MBIND")), list(makeSymbol("CLET"), list(list(makeSymbol("EL-VAR"), list(makeSymbol("FIM"), makeSymbol("VAR-MANAGER"), list(makeSymbol("QUOTE"), makeSymbol("RECOVER-EL")), makeSymbol("CUR-VAR"))), list(makeSymbol("EL-VALUES"), list(makeSymbol("FIM"), makeSymbol("VAR-MANAGER"), list(makeSymbol("QUOTE"), makeSymbol("RECOVER-EL")), makeSymbol("CUR-VALUES")))), list(makeSymbol("HTML-TABLE-ROW"), list(makeSymbol("HTML-TABLE-DATA"), list(makeSymbol("HTML-PRINC"), makeSymbol("EL-VAR"))), list(makeSymbol("HTML-TABLE-DATA"), list(makeSymbol("PIF"), list(makeSymbol("SINGLETON?"), makeSymbol("EL-VALUES")), list(makeSymbol("CB-FORM"), list(makeSymbol("FIRST"), makeSymbol("EL-VALUES"))), list(makeSymbol("CB-FORM"), makeSymbol("EL-VALUES")))))))), list(makeSymbol("HTML-NEWLINE")))), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol $sym87$OUTER_CATCH_FOR_HTML_TASK_DISPLAYER_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-HTML-TASK-DISPLAYER-METHOD");
    ...
    public static final SubLList $list114 = list(makeString("@returns html-plan-displayer-p; initialized object"), list(makeSymbol("INITIALIZE"), makeSymbol("SUPER")), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("TASK-DISPLAYER-HASH-TABLE")), list(makeSymbol("MAKE-HASH-TABLE"), TEN_INTEGER)), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list117 = list(makeString("@param NEW-PLAN          shop-basic-plan-p\n   @param DISPLAYER-FACTORY shop-plan-displayer-factory-p\n   @return html-plan-displayer-p"), list(makeSymbol("CSETQ"), makeSymbol("PLAN"), makeSymbol("NEW-PLAN")), list(makeSymbol("CLET"), list(list(makeSymbol("VAR-MANAGER"), list(makeSymbol("GET-SLOT"), makeSymbol("NEW-PLAN"), list(makeSymbol("QUOTE"), makeSymbol("VARIABLE-MANAGER")))), list(makeSymbol("NEW-MBINDING"), list(makeSymbol("GET-SLOT"), makeSymbol("NEW-PLAN"), list(makeSymbol("QUOTE"), makeSymbol("BINDINGS")))), list(makeSymbol("OPEN-VARS"), list(makeSymbol("GET-SLOT"), makeSymbol("NEW-PLAN"), list(makeSymbol("QUOTE"), makeSymbol("OPEN-VARIABLES")))), makeSymbol("DISPLAY-SUB")), list(makeSymbol("CDOLIST"), list(makeSymbol("CUR-VAR"), makeSymbol("OPEN-VARS")), list(makeSymbol("CLET"), list(list(makeSymbol("EL-VAR"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("VAR-MANAGER"), list(makeSymbol("QUOTE"), makeSymbol("RECOVER-EL-VARIABLE")), makeSymbol("CUR-VAR")))), list(makeSymbol("CPUSH"), list(makeSymbol("CONS"), makeSymbol("CUR-VAR"), makeSymbol("EL-VAR")), makeSymbol("DISPLAY-SUB")))), list(makeSymbol("CSETQ"), makeSymbol("MBINDING"), makeSymbol("NEW-MBINDING")), list(makeSymbol("CSETQ"), makeSymbol("OPEN-VARIABLES"), makeSymbol("OPEN-VARS")), list(makeSymbol("CSETQ"), makeSymbol("DISPLAY-VARIABLE-SUBSTITUTION"), makeSymbol("DISPLAY-SUB")), list(makeSymbol("CDOLIST"), list(makeSymbol("STEP"), list(makeSymbol("GET-SLOT"), makeSymbol("NEW-PLAN"), list(makeSymbol("QUOTE"), makeSymbol("PRE-ORDERING")))), list(makeSymbol("CLET"), list(list(makeSymbol("TASK-DISPLAYER"), list(makeSymbol("FUNCALL-CLASS-METHOD"), makeSymbol("DISPLAYER-FACTORY"), list(makeSymbol("QUOTE"), makeSymbol("CREATE-TASK-DISPLAYER")), makeSymbol("STEP")))), list(makeSymbol("INLINE-METHOD"), list(makeSymbol("INIT-WITH-TASK"), makeSymbol("HTML-TASK-DISPLAYER")), makeSymbol("TASK-DISPLAYER"), makeSymbol("STEP")), list(makeSymbol("SET-SLOT"), makeSymbol("TASK-DISPLAYER"), list(makeSymbol("QUOTE"), makeSymbol("PLAN-DISPLAYER")), makeSymbol("SELF")), list(makeSymbol("CSETF"), list(makeSymbol("GETHASH"), makeSymbol("STEP"), makeSymbol("TASK-DISPLAYER-HASH-TABLE")), makeSymbol("TASK-DISPLAYER")))), list(makeSymbol("RET"), makeSymbol("SELF"))));
    ...
    private static final SubLList $list122 = list(makeString("@param TASK listp; a task formula in CycL."), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-TASK"), list(makeSymbol("SUBLIS"), list(makeSymbol("GET-SLOT"), makeSymbol("PLAN"), list(makeSymbol("QUOTE"), makeSymbol("SIMPLE-BINDING-LIST"))), makeSymbol("TASK"))), list(makeSymbol("VAR-MANAGER"), list(makeSymbol("GET-SLOT"), makeSymbol("PLAN"), list(makeSymbol("QUOTE"), makeSymbol("VARIABLE-MANAGER"))))), list(makeSymbol("RET"), list(makeSymbol("FIM"), makeSymbol("VAR-MANAGER"), list(makeSymbol("QUOTE"), makeSymbol("RECOVER-EL")), makeSymbol("NEW-TASK")))));
    ...
    public static final SubLList $list132 = list(makeString("Displays only the primitive tasks of the plan."), list(makeSymbol("CLET"), list(list(makeSymbol("STEP-DISPLAY-FORM"), NIL)), list(makeSymbol("HTML-NEWLINE"), TWO_INTEGER), list(makeSymbol("CDOLIST-NUMBERED"), list(makeSymbol("STEP"), makeSymbol("NUM"), list(makeSymbol("FIM"), makeSymbol("PLAN"), list(makeSymbol("QUOTE"), makeSymbol("PRIMITIVE-FORM")))), list(makeSymbol("HTML-STRONG"), list(makeSymbol("HTML-PRINC"), makeString("  Step ")), list(makeSymbol("HTML-PRIN1"), list(makeSymbol("1+"), makeSymbol("NUM"))), list(makeSymbol("HTML-PRINC"), makeString(".  "))), list(makeSymbol("CSETQ"), makeSymbol("STEP-DISPLAY-FORM"), list(makeSymbol("PREPARE-TASK-FOR-DISPLAY"), makeSymbol("SELF"), makeSymbol("STEP"))), list(makeSymbol("PIF"), list(makeSymbol("MEMBER?"), makeKeyword("CYCL"), makeSymbol("STYLE-ARGS")), list(makeSymbol("CB-FORM"), makeSymbol("STEP-DISPLAY-FORM")), list(makeSymbol("CLET"), list(list(makeSymbol("*PPH-QUANTIFY-VARS?*"), NIL)), list(makeSymbol("HTML-TEXT-WITH-TARGET"), makeSymbol("STEP-DISPLAY-FORM")))), list(makeSymbol("HTML-NEWLINE")))), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol $sym133$OUTER_CATCH_FOR_HTML_PLAN_DISPLAYER_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-HTML-PLAN-DISPLAYER-METHOD");
    ...
    public static SubLObject declare_shop_displayers_file() {
        declareFunction(me, "get_html_task_displayer_plan_displayer", "GET-HTML-TASK-DISPLAYER-PLAN-DISPLAYER", 1, 0, false);
        declareFunction(me, "set_html_task_displayer_plan_displayer", "SET-HTML-TASK-DISPLAYER-PLAN-DISPLAYER", 2, 0, false);
        declareFunction(me, "get_html_task_displayer_task", "GET-HTML-TASK-DISPLAYER-TASK", 1, 0, false);
        declareFunction(me, "set_html_task_displayer_task", "SET-HTML-TASK-DISPLAYER-TASK", 2, 0, false);
        declareFunction(me, "subloop_reserved_initialize_html_task_displayer_class", "SUBLOOP-RESERVED-INITIALIZE-HTML-TASK-DISPLAYER-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_html_task_displayer_instance", "SUBLOOP-RESERVED-INITIALIZE-HTML-TASK-DISPLAYER-INSTANCE", 1, 0, false);
        declareFunction(me, "html_task_displayer_p", "HTML-TASK-DISPLAYER-P", 1, 0, false);
        declareFunction(me, "get_html_plan_displayer_display_variable_substitution", "GET-HTML-PLAN-DISPLAYER-DISPLAY-VARIABLE-SUBSTITUTION", 1, 0, false);
        declareFunction(me, "set_html_plan_displayer_display_variable_substitution", "SET-HTML-PLAN-DISPLAYER-DISPLAY-VARIABLE-SUBSTITUTION", 2, 0, false);
        declareFunction(me, "get_html_plan_displayer_open_variables", "GET-HTML-PLAN-DISPLAYER-OPEN-VARIABLES", 1, 0, false);
        declareFunction(me, "set_html_plan_displayer_open_variables", "SET-HTML-PLAN-DISPLAYER-OPEN-VARIABLES", 2, 0, false);
        declareFunction(me, "get_html_plan_displayer_mbinding", "GET-HTML-PLAN-DISPLAYER-MBINDING", 1, 0, false);
        declareFunction(me, "set_html_plan_displayer_mbinding", "SET-HTML-PLAN-DISPLAYER-MBINDING", 2, 0, false);
        declareFunction(me, "get_html_plan_displayer_task_displayer_hash_table", "GET-HTML-PLAN-DISPLAYER-TASK-DISPLAYER-HASH-TABLE", 1, 0, false);
        declareFunction(me, "set_html_plan_displayer_task_displayer_hash_table", "SET-HTML-PLAN-DISPLAYER-TASK-DISPLAYER-HASH-TABLE", 2, 0, false);
        declareFunction(me, "get_html_plan_displayer_plan", "GET-HTML-PLAN-DISPLAYER-PLAN", 1, 0, false);
        declareFunction(me, "set_html_plan_displayer_plan", "SET-HTML-PLAN-DISPLAYER-PLAN", 2, 0, false);
        declareFunction(me, "subloop_reserved_initialize_html_plan_displayer_class", "SUBLOOP-RESERVED-INITIALIZE-HTML-PLAN-DISPLAYER-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_html_plan_displayer_instance", "SUBLOOP-RESERVED-INITIALIZE-HTML-PLAN-DISPLAYER-INSTANCE", 1, 0, false);
        declareFunction(me, "html_plan_displayer_p", "HTML-PLAN-DISPLAYER-P", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_cyc_development_plan_displayer_factory_class", "SUBLOOP-RESERVED-INITIALIZE-CYC-DEVELOPMENT-PLAN-DISPLAYER-FACTORY-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_cyc_development_plan_displayer_factory_instance", "SUBLOOP-RESERVED-INITIALIZE-CYC-DEVELOPMENT-PLAN-DISPLAYER-FACTORY-INSTANCE", 1, 0, false);
        declareFunction(me, "cyc_development_plan_displayer_factory_p", "CYC-DEVELOPMENT-PLAN-DISPLAYER-FACTORY-P", 1, 0, false);
        declareFunction(me, "cyc_development_plan_displayer_factory_create_plan_displayer_method", "CYC-DEVELOPMENT-PLAN-DISPLAYER-FACTORY-CREATE-PLAN-DISPLAYER-METHOD", 2, 0, false);
        declareFunction(me, "cyc_development_plan_displayer_factory_create_task_displayer_method", "CYC-DEVELOPMENT-PLAN-DISPLAYER-FACTORY-CREATE-TASK-DISPLAYER-METHOD", 2, 0, false);
        declareFunction(me, "html_task_displayer_initialize_method", "HTML-TASK-DISPLAYER-INITIALIZE-METHOD", 1, 0, false);
        declareFunction(me, "html_task_displayer_init_with_task_method", "HTML-TASK-DISPLAYER-INIT-WITH-TASK-METHOD", 2, 0, false);
        declareFunction(me, "html_task_displayer_find_instance_by_id_string_method", "HTML-TASK-DISPLAYER-FIND-INSTANCE-BY-ID-STRING-METHOD", 2, 0, false);
        declareFunction(me, "html_task_displayer_task_examiner_link_image_method", "HTML-TASK-DISPLAYER-TASK-EXAMINER-LINK-IMAGE-METHOD", 1, 0, false);
        declareFunction(me, "html_task_displayer_cb_task_examiner_link_method", "HTML-TASK-DISPLAYER-CB-TASK-EXAMINER-LINK-METHOD", 1, 0, false);
        declareFunction(me, "html_task_displayer_html_form_method", "HTML-TASK-DISPLAYER-HTML-FORM-METHOD", 2, 0, false);
        declareFunction(me, "html_task_displayer_formula_method", "HTML-TASK-DISPLAYER-FORMULA-METHOD", 1, 0, false);
        declareFunction(me, "html_task_displayer_bindings_method", "HTML-TASK-DISPLAYER-BINDINGS-METHOD", 1, 0, false);
        declareFunction(me, "html_task_displayer_display_bindings_method", "HTML-TASK-DISPLAYER-DISPLAY-BINDINGS-METHOD", 2, 0, false);
        declareFunction(me, "html_task_displayer_html_task_page_method", "HTML-TASK-DISPLAYER-HTML-TASK-PAGE-METHOD", 2, 0, false);
        declareFunction(me, "html_plan_displayer_initialize_method", "HTML-PLAN-DISPLAYER-INITIALIZE-METHOD", 1, 0, false);
        declareFunction(me, "html_plan_displayer_init_with_plan_method", "HTML-PLAN-DISPLAYER-INIT-WITH-PLAN-METHOD", 3, 0, false);
        declareFunction(me, "html_plan_displayer_prepare_task_for_display_method", "HTML-PLAN-DISPLAYER-PREPARE-TASK-FOR-DISPLAY-METHOD", 2, 0, false);
        declareFunction(me, "html_plan_displayer_html_hierarchical_form_method", "HTML-PLAN-DISPLAYER-HTML-HIERARCHICAL-FORM-METHOD", 2, 0, false);
        declareFunction(me, "html_plan_displayer_html_primitive_form_method", "HTML-PLAN-DISPLAYER-HTML-PRIMITIVE-FORM-METHOD", 2, 0, false);
        declareFunction(me, "html_plan_displayer_html_multibinding_values_method", "HTML-PLAN-DISPLAYER-HTML-MULTIBINDING-VALUES-METHOD", 3, 0, false);
        declareFunction(me, "html_plan_displayer_html_mbinding_form_method", "HTML-PLAN-DISPLAYER-HTML-MBINDING-FORM-METHOD", 2, 0, false);
        declareFunction(me, "html_plan_displayer_html_form_method", "HTML-PLAN-DISPLAYER-HTML-FORM-METHOD", 2, 0, false);
        return NIL;
    }
