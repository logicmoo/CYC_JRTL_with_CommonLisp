...
import com.cyc.cycjava.cycl.event_learning;
...
import static com.cyc.cycjava.cycl.event_learning.*;
...
public final class event_learning extends SubLTranslatedFile {
    ...
    public static SubLObject event_document_p(final SubLObject v_object) {
        return v_object.getClass() == event_learning.$event_document_native.class ? T : NIL;
    }

    public static SubLObject event_doc_cycl(final SubLObject v_object) {
        assert NIL != event_document_p(v_object) : "event_learning.event_document_p(v_object) " + "CommonSymbols.NIL != event_learning.event_document_p(v_object) " + v_object;
    ...
    public static SubLObject make_event_document(SubLObject arglist) {
        ...
        final SubLObject v_new = new event_learning.$event_document_native();
        SubLObject next;
    ...
    public static final class $event_document_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(event_learning.$event_document_native.class, EVENT_DOCUMENT, EVENT_DOCUMENT_P, $list5, $list6, new String[]{ "$cycl", "$url", "$string", "$html_string" }, $list7, $list8, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
