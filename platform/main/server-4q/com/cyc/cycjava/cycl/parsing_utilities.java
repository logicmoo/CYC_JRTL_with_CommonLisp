...
public final class parsing_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject parse_iterator_p(final SubLObject v_object) {
        return v_object.getClass() == parsing_utilities.$parse_iterator_native.class ? T : NIL;
    }

    public static SubLObject pi_sub_iterators(final SubLObject v_object) {
        assert NIL != parse_iterator_p(v_object) : "parsing_utilities.parse_iterator_p(v_object) " + "CommonSymbols.NIL != parsing_utilities.parse_iterator_p(v_object) " + v_object;
    ...
    public static SubLObject make_parse_iterator(SubLObject arglist) {
        ...
        final SubLObject v_new = new parsing_utilities.$parse_iterator_native();
        SubLObject next;
    ...
    public static SubLObject cyclify_iterator_p(final SubLObject v_object) {
        return v_object.getClass() == parsing_utilities.$cyclify_iterator_native.class ? T : NIL;
    }

    public static SubLObject cyclify_iterator_iter_obj(final SubLObject v_object) {
        assert NIL != cyclify_iterator_p(v_object) : "parsing_utilities.cyclify_iterator_p(v_object) " + "CommonSymbols.NIL != parsing_utilities.cyclify_iterator_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_cyclify_iterator(SubLObject arglist) {
        ...
        final SubLObject v_new = new parsing_utilities.$cyclify_iterator_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $parse_iterator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(parsing_utilities.$parse_iterator_native.class, PARSE_ITERATOR, PARSE_ITERATOR_P, $list266, $list267, new String[]{ "$sub_iterators", "$properties", "$current_iterator_index", "$string", "$previous_parses", "$next" }, $list268, $list269, PRINT_PARSE_ITERATOR);
        }
    }
    ...
    public static final class $cyclify_iterator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(parsing_utilities.$cyclify_iterator_native.class, CYCLIFY_ITERATOR, CYCLIFY_ITERATOR_P, $list308, $list309, new String[]{ "$iter_obj" }, $list310, $list311, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
