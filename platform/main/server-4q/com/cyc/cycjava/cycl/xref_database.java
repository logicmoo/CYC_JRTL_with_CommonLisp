...
import static com.cyc.cycjava.cycl.xref_database.*;
...
public final class xref_database extends SubLTranslatedFile {
    ...
    public static SubLObject xref_module_p(final SubLObject v_object) {
        return v_object.getClass() == xref_database.$xref_module_native.class ? T : NIL;
    }

    public static SubLObject xref_m_name(final SubLObject v_object) {
        assert NIL != xref_module_p(v_object) : "xref_database.xref_module_p(v_object) " + "CommonSymbols.NIL != xref_database.xref_module_p(v_object) " + v_object;
    ...
    public static SubLObject make_xref_module(SubLObject arglist) {
        ...
        final SubLObject v_new = new xref_database.$xref_module_native();
        SubLObject next;
    ...
    public static SubLObject xref_system_p(final SubLObject v_object) {
        return v_object.getClass() == xref_database.$xref_system_native.class ? T : NIL;
    }

    public static SubLObject xref_s_name(final SubLObject v_object) {
        assert NIL != xref_system_p(v_object) : "xref_database.xref_system_p(v_object) " + "CommonSymbols.NIL != xref_database.xref_system_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_xref_system(SubLObject arglist) {
        ...
        final SubLObject v_new = new xref_database.$xref_system_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
