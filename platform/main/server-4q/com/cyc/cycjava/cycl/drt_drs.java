...
import com.cyc.cycjava.cycl.drt_drs;
...
import static com.cyc.cycjava.cycl.drt_drs.*;
...
public final class drt_drs extends SubLTranslatedFile {
    ...
    public static final SubLSymbol AUDIENCE = makeSymbol("AUDIENCE");

    public static final SubLSymbol SPEAKER = makeSymbol("SPEAKER");



    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_DRS_CLASS = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-DRS-CLASS");





    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_DRS_INSTANCE = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-DRS-INSTANCE");

    public static final SubLSymbol ADD_RM = makeSymbol("ADD-RM");

    public static final SubLList $list25 = list(makeSymbol("NEW-RM"));

    public static final SubLList $list26 = list(list(makeSymbol("PUNLESS"), list(makeSymbol("MEMBER?"), makeSymbol("NEW-RM"), makeSymbol("RMS")), list(makeSymbol("CSETQ"), makeSymbol("RMS"), list(makeSymbol("CONS"), makeSymbol("NEW-RM"), makeSymbol("RMS")))), list(makeSymbol("RET"), makeSymbol("RMS")));

    public static final SubLSymbol $sym27$OUTER_CATCH_FOR_DRS_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-DRS-METHOD");

    public static final SubLSymbol DRS_ADD_RM_METHOD = makeSymbol("DRS-ADD-RM-METHOD");

    public static final SubLSymbol ADD_AVAILABLE_RM = makeSymbol("ADD-AVAILABLE-RM");

    public static final SubLList $list30 = list(list(makeSymbol("PUNLESS"), list(makeSymbol("MEMBER?"), makeSymbol("NEW-RM"), makeSymbol("AVAILABLE-RMS")), list(makeSymbol("CSETQ"), makeSymbol("AVAILABLE-RMS"), list(makeSymbol("CONS"), makeSymbol("NEW-RM"), makeSymbol("AVAILABLE-RMS")))), list(makeSymbol("RET"), makeSymbol("AVAILABLE-RMS")));

    public static final SubLSymbol $sym31$OUTER_CATCH_FOR_DRS_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-DRS-METHOD");

    public static final SubLSymbol DRS_ADD_AVAILABLE_RM_METHOD = makeSymbol("DRS-ADD-AVAILABLE-RM-METHOD");

    public static final SubLSymbol ADD_DEFINITE_RM = makeSymbol("ADD-DEFINITE-RM");

    public static final SubLList $list34 = list(list(makeSymbol("PUNLESS"), list(makeSymbol("MEMBER?"), makeSymbol("NEW-RM"), makeSymbol("DEFINITE-RMS")), list(makeSymbol("CSETQ"), makeSymbol("DEFINITE-RMS"), list(makeSymbol("CONS"), makeSymbol("NEW-RM"), makeSymbol("DEFINITE-RMS")))), list(makeSymbol("RET"), makeSymbol("DEFINITE-RMS")));

    public static final SubLSymbol $sym35$OUTER_CATCH_FOR_DRS_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-DRS-METHOD");

    public static final SubLSymbol DRS_ADD_DEFINITE_RM_METHOD = makeSymbol("DRS-ADD-DEFINITE-RM-METHOD");

    public static final SubLSymbol ADD_PRONOMIAL_RM = makeSymbol("ADD-PRONOMIAL-RM");

    public static final SubLList $list38 = list(list(makeSymbol("PUNLESS"), list(makeSymbol("MEMBER?"), makeSymbol("NEW-RM"), makeSymbol("PRONOMIAL-RMS")), list(makeSymbol("CSETQ"), makeSymbol("PRONOMIAL-RMS"), list(makeSymbol("CONS"), makeSymbol("NEW-RM"), makeSymbol("PRONOMIAL-RMS")))), list(makeSymbol("RET"), makeSymbol("PRONOMIAL-RMS")));

    public static final SubLSymbol $sym39$OUTER_CATCH_FOR_DRS_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-DRS-METHOD");

    public static final SubLSymbol DRS_ADD_PRONOMIAL_RM_METHOD = makeSymbol("DRS-ADD-PRONOMIAL-RM-METHOD");



    public static final SubLString $str42$_______________________INITIAL_RM = makeString("~%******************** INITIAL RMS ********************~%");

    public static final SubLString $str43$__ = makeString("~%");

    public static final SubLSymbol FIND_RM_BY_TARGET = makeSymbol("FIND-RM-BY-TARGET");

    public static final SubLList $list45 = list(makeKeyword("ROOT"));





    public static final SubLString $str48$_______________________INITIAL_DR = makeString("~%******************** INITIAL DRS ********************~%");

    public static final SubLList $list49 = list(reader_make_constant_shell(makeString("NLSemFn")), reader_make_constant_shell(makeString("NLNumberFn")), reader_make_constant_shell(makeString("NLTagFn")), reader_make_constant_shell(makeString("SomeFn")), reader_make_constant_shell(makeString("NLDefinitenessFn-3")), reader_make_constant_shell(makeString("NLQuantFn-3")));
    ...
    private static final SubLObject $$explains_PropProp = reader_make_constant_shell(makeString("explains-PropProp"));

    public static final SubLSymbol DRT_COMPLEX_FORMULA_ELEMENT = makeSymbol("DRT-COMPLEX-FORMULA-ELEMENT");



    public static final SubLList $list57 = list(makeKeyword("READ-ONLY"));

    public static final SubLList $list58 = list(makeSymbol("&OPTIONAL"), makeSymbol("CARRY-POSSIBLE-RM-COREFERENCES"));

    public static final SubLObject $list59 = _constant_59_initializer();

    public static final SubLString $str60$___drs_process_method__A_ = makeString("~%(drs-process-method ~A)");

    public static final SubLString $str61$drt_process_drs__more_than_one_co = makeString("drt-process-drs: more than one complex formula in drs ~A ~A~%");

    public static final SubLString $str62$1_a__quantifiers___ = makeString("1.a. quantifiers.~%");

    public static final SubLList $list63 = list(makeKeyword("VAR"));

    public static final SubLString $str64$drt_process_drs__A__no_RM_found_f = makeString("drt-process-drs ~A: no RM found for var ~A in complex-formula ~A~%");



    public static final SubLString $str66$_1________________modified_RM_ = makeString("-1--------------- modified RM:");

    public static final SubLString $str67$_1_____________ = makeString("-1-----------~%");

    public static final SubLString $str68$1_b__logical_connectives___ = makeString("1.b. logical connectives.~%");

    private static final SubLObject $$and = reader_make_constant_shell(makeString("and"));

    public static final SubLString $str70$1_c__quantproc__ = makeString("1.c. quantproc~%");

    public static final SubLString $str71$Attempting_reformulation_on_____A = makeString("Attempting reformulation on: ~%~A~%");





    public static final SubLString $str74$Attempting_reformulation_type__A_ = makeString("Attempting reformulation type ~A, mt=~A~%");

    public static final SubLString $str75$Using_reformulator_result_from__A = makeString("Using reformulator result from ~A: ~A~%");

    public static final SubLString $str76$failed_reformulation_on__A__new_c = makeString("failed reformulation on ~A: new-complex-formula is NULL.");

    public static final SubLString $str77$failed_reformulation_on__A__new_c = makeString("failed reformulation on ~A: new-complex-formula is IDENTICAL.");

    public static final SubLString $str78$DRT__A = makeString("DRT-~A");

    public static final SubLList $list79 = list(makeKeyword("ROOT"), makeKeyword("FORMULA"));



    public static final SubLString $str81$___2________________modified_RM_ = makeString("~%-2--------------- modified RM:");

    public static final SubLString $str82$_2_____________ = makeString("-2-----------~%");

    private static final SubLObject $$forAll = reader_make_constant_shell(makeString("forAll"));

    public static final SubLString $str84$___3________________modified_RM_ = makeString("~%-3--------------- modified RM:");

    public static final SubLString $str85$_3_____________ = makeString("-3-----------~%");

    public static final SubLString $str86$1_d__subcollection_processing__ = makeString("1.d. subcollection processing~%");

    public static final SubLString $str87$1_e__simple_formulas__ = makeString("1.e. simple formulas~%");





    public static final SubLSymbol RM_P = makeSymbol("RM-P");

    public static final SubLString $str91$_______________________FINAL_DRS_ = makeString("~%******************** FINAL DRS ********************~%");

    public static final SubLSymbol FIND_ALL_POSSIBLE_RM_COREFERENCES = makeSymbol("FIND-ALL-POSSIBLE-RM-COREFERENCES");

    public static final SubLSymbol DRS_PROCESS_METHOD = makeSymbol("DRS-PROCESS-METHOD");

    public static final SubLList $list94 = list(makeString("Returns a list of lists of the form (RM ((POSS-RM-1 PROB-1) (POSS-RM-2 PROB-2) ...)) indicating the probabiltiy of each possible RM coreference in this DRS."), list(makeSymbol("CLET"), list(makeSymbol("RESULT")), list(makeSymbol("PWHEN"), makeSymbol("SUB-DRSS"), list(makeSymbol("CDOLIST"), list(makeSymbol("SUB-DRS"), makeSymbol("SUB-DRSS")), list(makeSymbol("CSETQ"), makeSymbol("RESULT"), list(makeSymbol("APPEND"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SUB-DRS"), list(makeSymbol("QUOTE"), makeSymbol("FIND-ALL-POSSIBLE-RM-COREFERENCES"))))))), list(makeSymbol("PWHEN"), makeSymbol("PRONOMIAL-RMS"), list(makeSymbol("CDOLIST"), list(makeSymbol("PRONOMIAL-RM"), makeSymbol("PRONOMIAL-RMS")), list(makeSymbol("CLET"), list(list(makeSymbol("POSSIBLE-RM-COREFERENCES"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("FIND-POSSIBLE-RM-COREFERENCES")), makeSymbol("PRONOMIAL-RM")))), list(makeSymbol("PWHEN"), makeSymbol("POSSIBLE-RM-COREFERENCES"), list(makeSymbol("CPUSH"), list(makeSymbol("BQ-LIST"), makeSymbol("PRONOMIAL-RM"), makeSymbol("POSSIBLE-RM-COREFERENCES")), makeSymbol("RESULT")))))), list(makeSymbol("RET"), makeSymbol("RESULT"))));

    public static final SubLSymbol FIND_POSSIBLE_RM_COREFERENCES = makeSymbol("FIND-POSSIBLE-RM-COREFERENCES");

    public static final SubLSymbol DRS_FIND_ALL_POSSIBLE_RM_COREFERENCES_METHOD = makeSymbol("DRS-FIND-ALL-POSSIBLE-RM-COREFERENCES-METHOD");

    public static final SubLList $list97 = list(makeDouble(1.0));

    public static final SubLList $list98 = list(makeSymbol("RM"), makeSymbol("&OPTIONAL"), list(makeSymbol("DEPTH"), makeSymbol("*DRT-POSSIBLE-RM-COREFERENCES-MAX-DEPTH*")), list(makeSymbol("CUTOFF"), NIL));

    public static final SubLList $list99 = list(makeString("Returns a list of the form ((POSS-RM-1 PROB-1) (POSS-RM-2 PROB-2) ...) indicating the possible coreferences of the specified RM in this DRS.  If DEPTH is specified, we look to DEPTH-1 previous DRSs for possible intersentential coreferences."), list(makeSymbol("IGNORE"), makeSymbol("CUTOFF")), list(makeSymbol("CLET"), list(list(makeSymbol("POSSIBLE-RM-COREFERENCE-VALUE-PAIRS"), NIL)), list(makeSymbol("CLET"), list(list(makeSymbol("RM-FORMULA"), list(makeSymbol("GET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("FORMULA"))))), list(makeSymbol("PWHEN"), list(EQ, list(makeSymbol("FORMULA-ARG0"), makeSymbol("RM-FORMULA")), reader_make_constant_shell(makeString("PronounFn"))), list(makeSymbol("PCOND"), list(list(makeSymbol("CAND"), list(EQ, list(makeSymbol("FORMULA-ARG1"), makeSymbol("RM-FORMULA")), reader_make_constant_shell(makeString("FirstPerson-NLAttr"))), list(EQ, list(makeSymbol("FORMULA-ARG2"), makeSymbol("RM-FORMULA")), reader_make_constant_shell(makeString("Singular-NLAttr"))), list(EQ, list(makeSymbol("FORMULA-ARG3"), makeSymbol("RM-FORMULA")), reader_make_constant_shell(makeString("Ungendered-NLAttr"))), list(makeSymbol("FORT-P"), makeSymbol("SPEAKER"))), list(makeSymbol("CPUSH"), list(makeSymbol("BQ-CONS"), makeSymbol("SPEAKER"), list(makeSymbol("QUOTE"), list(makeDouble(1.0)))), makeSymbol("POSSIBLE-RM-COREFERENCE-VALUE-PAIRS"))), list(list(makeSymbol("CAND"), list(EQ, list(makeSymbol("FORMULA-ARG1"), makeSymbol("RM-FORMULA")), reader_make_constant_shell(makeString("SecondPerson-NLAttr"))), list(EQ, list(makeSymbol("FORMULA-ARG2"), makeSymbol("RM-FORMULA")), reader_make_constant_shell(makeString("Singular-NLAttr"))), list(EQ, list(makeSymbol("FORMULA-ARG3"), makeSymbol("RM-FORMULA")), reader_make_constant_shell(makeString("Ungendered-NLAttr")))), list(makeSymbol("CDOLIST"), list(makeSymbol("AUDIENCE-MEMBER"), makeSymbol("AUDIENCE")), list(makeSymbol("CPUSH"), list(makeSymbol("BQ-CONS"), makeSymbol("AUDIENCE-MEMBER"), list(makeSymbol("QUOTE"), list(makeDouble(1.0)))), makeSymbol("POSSIBLE-RM-COREFERENCE-VALUE-PAIRS"))))))), list(makeSymbol("CDOLIST"), list(makeSymbol("AVAILABLE-RM"), makeSymbol("AVAILABLE-RMS")), list(makeSymbol("CPUSH"), list(makeSymbol("BQ-LIST"), makeSymbol("AVAILABLE-RM"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("COREFERENCE-PROBABILITY")), makeSymbol("AVAILABLE-RM"))), makeSymbol("POSSIBLE-RM-COREFERENCE-VALUE-PAIRS"))), list(makeSymbol("CDOLIST"), list(makeSymbol("DEFINITE-RM"), makeSymbol("DEFINITE-RMS")), list(makeSymbol("CPUSH"), list(makeSymbol("BQ-LIST"), makeSymbol("DEFINITE-RM"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("COREFERENCE-PROBABILITY")), makeSymbol("DEFINITE-RM"))), makeSymbol("POSSIBLE-RM-COREFERENCE-VALUE-PAIRS"))), list(makeSymbol("CLET"), list(list(makeSymbol("BACK-DRS"), NIL)), list(makeSymbol("PCOND"), list(makeSymbol("SUPER-DRS"), list(makeSymbol("CSETQ"), makeSymbol("BACK-DRS"), makeSymbol("SUPER-DRS"))), list(makeSymbol("PREV-DRS"), list(makeSymbol("PWHEN"), list(makeSymbol(">"), makeSymbol("DEPTH"), ZERO_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("DEPTH"), list(makeSymbol("-"), makeSymbol("DEPTH"), ONE_INTEGER)), list(makeSymbol("CSETQ"), makeSymbol("BACK-DRS"), makeSymbol("PREV-DRS"))))), list(makeSymbol("PWHEN"), makeSymbol("BACK-DRS"), list(makeSymbol("CLET"), list(list(makeSymbol("MORE-POSSIBLE-RM-COREFERENCE-VALUE-PAIRS"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("BACK-DRS"), list(makeSymbol("QUOTE"), makeSymbol("FIND-POSSIBLE-RM-COREFERENCES")), makeSymbol("RM"), makeSymbol("DEPTH")))), list(makeSymbol("CDOLIST"), list(makeSymbol("MORE-POSSIBLE-RM-COREFERENCE-VALUE-PAIR"), makeSymbol("MORE-POSSIBLE-RM-COREFERENCE-VALUE-PAIRS")), list(makeSymbol("CLET"), list(list(makeSymbol("POSSIBLE-RM"), list(makeSymbol("FIRST"), makeSymbol("MORE-POSSIBLE-RM-COREFERENCE-VALUE-PAIR"))), list(makeSymbol("POSSIBLE-RM-VALUE"), list(makeSymbol("SECOND"), makeSymbol("MORE-POSSIBLE-RM-COREFERENCE-VALUE-PAIR"))), list(makeSymbol("DEPTH-BIAS"), list(makeSymbol("NTH"), makeSymbol("DEPTH"), makeSymbol("*DRT-POSSIBLE-RM-COREFERENCES-PREV-DRS-BIASES*")))), list(makeSymbol("PUNLESS"), makeSymbol("DEPTH-BIAS"), list(makeSymbol("CSETQ"), makeSymbol("DEPTH-BIAS"), makeDouble(0.0))), list(makeSymbol("CPUSH"), list(makeSymbol("BQ-LIST"), makeSymbol("POSSIBLE-RM"), list(makeSymbol("*"), makeSymbol("POSSIBLE-RM-VALUE"), makeSymbol("DEPTH-BIAS"))), makeSymbol("POSSIBLE-RM-COREFERENCE-VALUE-PAIRS"))))))), list(makeSymbol("RET"), makeSymbol("POSSIBLE-RM-COREFERENCE-VALUE-PAIRS"))));

    public static final SubLSymbol $sym100$OUTER_CATCH_FOR_DRS_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-DRS-METHOD");
    ...
    public static final SubLSymbol DRS_FIND_POSSIBLE_RM_COREFERENCES_METHOD = makeSymbol("DRS-FIND-POSSIBLE-RM-COREFERENCES-METHOD");

    public static final SubLList $list110 = list(makeKeyword("TERM"), makeKeyword("VAR"), makeKeyword("FORMULA"));
    ...
    private static final SubLObject $const113$SubcollectionOfWithRelationToType = reader_make_constant_shell(makeString("SubcollectionOfWithRelationToTypeFn"));
    ...
    private static final SubLObject $const115$SubcollectionOfWithRelationFromTy = reader_make_constant_shell(makeString("SubcollectionOfWithRelationFromTypeFn"));

    public static final SubLList $list116 = list(makeSymbol("TARGET"), makeSymbol("TARGET-TYPE"));

    public static final SubLList $list117 = list(makeString("Finds an RM by looking at the slots of the RMs in DRS.  There are 4 methods to look for RMs: by the :term or :var assigned to the RM after processing, by the initial formula the RM was created from, and the :root ('root-term') of the formula the RM was created from.  Any combination of these may be specified.  If both :formula and :root are specified, we allow matching to the RMs :mapped-formula such that contained RMs of which are replaced by those RMs :root's.  Also, there is a hack in here to ignore differences in subcollection functions (see drt-corresponding-type-subcol-fn-3 above)."), list(makeSymbol("CLET"), list(list(makeSymbol("RM-RESULTS"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("RM"), makeSymbol("RMS")), list(makeSymbol("PWHEN"), list(makeSymbol("MEMBER?"), makeKeyword("TERM"), makeSymbol("TARGET-TYPE")), list(makeSymbol("PWHEN"), list(makeSymbol("EQUALS-EL?"), makeSymbol("TARGET"), list(makeSymbol("DRT-FORMULA-CONSTRUCT-CYCL"), list(makeSymbol("GET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("TARGET-TERM"))))), list(makeSymbol("CPUSH"), makeSymbol("RM"), makeSymbol("RM-RESULTS")))), list(makeSymbol("PWHEN"), list(makeSymbol("MEMBER?"), makeKeyword("VAR"), makeSymbol("TARGET-TYPE")), list(makeSymbol("PWHEN"), list(EQUAL, makeSymbol("TARGET"), list(makeSymbol("DRT-FORMULA-CONSTRUCT-CYCL"), list(makeSymbol("GET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("TARGET-VAR"))))), list(makeSymbol("CPUSH"), makeSymbol("RM"), makeSymbol("RM-RESULTS")))), list(makeSymbol("PWHEN"), list(makeSymbol("MEMBER?"), makeKeyword("FORMULA"), makeSymbol("TARGET-TYPE")), list(makeSymbol("PWHEN"), list(EQUAL, makeSymbol("TARGET"), list(makeSymbol("DRT-FORMULA-CONSTRUCT-CYCL"), list(makeSymbol("GET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("FORMULA"))))), list(makeSymbol("CPUSH"), makeSymbol("RM"), makeSymbol("RM-RESULTS")))), list(makeSymbol("PWHEN"), list(makeSymbol("MEMBER?"), makeKeyword("ROOT"), makeSymbol("TARGET-TYPE")), list(makeSymbol("PWHEN"), list(makeSymbol("EQUALS-EL?"), makeSymbol("TARGET"), list(makeSymbol("DRT-FORMULA-CONSTRUCT-CYCL"), list(makeSymbol("GET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("ROOT-TERM"))))), list(makeSymbol("CPUSH"), makeSymbol("RM"), makeSymbol("RM-RESULTS")))), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("NULL"), makeSymbol("RM-RESULTS")), list(makeSymbol("MEMBER"), makeKeyword("FORMULA"), makeSymbol("TARGET-TYPE")), list(makeSymbol("MEMBER"), makeKeyword("ROOT"), makeSymbol("TARGET-TYPE"))), list(makeSymbol("CLET"), list(list(makeSymbol("RM-UNMAPPED-FORMULA"), list(makeSymbol("TREE-GATHER-TRANSFORMATIONS"), list(makeSymbol("FUNCTION"), makeSymbol("DRS-RM-ROOT-TERM-METHOD")), list(makeSymbol("COPY-TREE"), list(makeSymbol("GET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("MAPPED-FORMULA")))), list(makeSymbol("FUNCTION"), makeSymbol("RM-P"))))), list(makeSymbol("PWHEN"), list(makeSymbol("EQUALS-EL?"), list(makeSymbol("TREE-GATHER-TRANSFORMATIONS"), list(makeSymbol("FUNCTION"), makeSymbol("DRT-CORRESPONDING-TYPE-SUBCOL-FN-3")), makeSymbol("TARGET"), list(makeSymbol("FUNCTION"), makeSymbol("DRT-CORRESPONDING-TYPE-SUBCOL-FN-3"))), list(makeSymbol("TREE-GATHER-TRANSFORMATIONS"), list(makeSymbol("FUNCTION"), makeSymbol("DRT-CORRESPONDING-TYPE-SUBCOL-FN-3")), makeSymbol("RM-UNMAPPED-FORMULA"), list(makeSymbol("FUNCTION"), makeSymbol("DRT-CORRESPONDING-TYPE-SUBCOL-FN-3")))), list(makeSymbol("CPUSH"), makeSymbol("RM"), makeSymbol("RM-RESULTS")))))), list(makeSymbol("PUNLESS"), makeSymbol("RM-RESULTS"), list(makeSymbol("PWHEN"), makeSymbol("SUPER-DRS"), list(makeSymbol("CSETQ"), makeSymbol("RM-RESULTS"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SUPER-DRS"), list(makeSymbol("QUOTE"), makeSymbol("FIND-RM-BY-TARGET")), makeSymbol("TARGET"), makeSymbol("TARGET-TYPE"))))), list(makeSymbol("PWHEN"), list(makeSymbol(">"), list(makeSymbol("LENGTH"), makeSymbol("RM-RESULTS")), ONE_INTEGER), list(makeSymbol("CLET"), list(makeSymbol("NEW-RM-RESULTS")), list(makeSymbol("CDOLIST"), list(makeSymbol("RM-RESULT"), makeSymbol("RM-RESULTS")), list(makeSymbol("PUNLESS"), list(makeSymbol("TREE-FIND"), list(makeSymbol("GET-SLOT"), makeSymbol("RM-RESULT"), list(makeSymbol("QUOTE"), makeSymbol("FORMULA"))), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("FUNCTION"), EQUAL)), list(makeSymbol("CPUSH"), makeSymbol("RM-RESULT"), makeSymbol("NEW-RM-RESULTS")))), list(makeSymbol("PWHEN"), makeSymbol("NEW-RM-RESULTS"), list(makeSymbol("CSETQ"), makeSymbol("RM-RESULTS"), makeSymbol("NEW-RM-RESULTS")))), list(makeSymbol("PWHEN"), list(makeSymbol(">"), list(makeSymbol("LENGTH"), makeSymbol("RM-RESULTS")), ONE_INTEGER), list(makeSymbol("DRT-TRACE-PROGN"), FOUR_INTEGER, list(makeSymbol("DRT-WARN"), makeString("find-rm-by-target: ~A maps to multiple rms ~A~%"), makeSymbol("TARGET"), makeSymbol("RM-RESULTS"))))), list(makeSymbol("RET"), makeSymbol("RM-RESULTS"))));

    public static final SubLSymbol $sym118$OUTER_CATCH_FOR_DRS_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-DRS-METHOD");
    ...
    public static final SubLSymbol DRS_RM_ROOT_TERM_METHOD = makeSymbol("DRS-RM-ROOT-TERM-METHOD");

    public static final SubLSymbol MAPPED_FORMULA = makeSymbol("MAPPED-FORMULA");

    public static final SubLSymbol DRT_CORRESPONDING_TYPE_SUBCOL_FN_3 = makeSymbol("DRT-CORRESPONDING-TYPE-SUBCOL-FN-3");

    public static final SubLString $str127$find_rm_by_target___A_maps_to_mul = makeString("find-rm-by-target: ~A maps to multiple rms ~A~%");

    public static final SubLSymbol DRS_FIND_RM_BY_TARGET_METHOD = makeSymbol("DRS-FIND-RM-BY-TARGET-METHOD");
    ...
    public static final SubLList $list132 = list(makeString("Constructs the CycL output that is ready to be predicate/term strengthened, etc. (i.e. it may still contain underpecified vocab)."), list(makeSymbol("CLET"), list(list(makeSymbol("RESULT"), NIL), list(makeSymbol("SCOPES"), NIL)), list(makeSymbol("PWHEN"), makeSymbol("COMPLEX-CONDITIONS"), list(makeSymbol("CDOLIST"), list(makeSymbol("COMPLEX-CONDITION"), makeSymbol("COMPLEX-CONDITIONS")), list(makeSymbol("CLET"), list(list(makeSymbol("CF-CYCL"), list(makeSymbol("DRT-COMPLEX-CONDITION-CONSTRUCT-CYCL"), makeSymbol("COMPLEX-CONDITION"), makeSymbol("INTERACTION-MT")))), list(makeSymbol("CPUSH"), makeSymbol("CF-CYCL"), makeSymbol("RESULT"))))), list(makeSymbol("PWHEN"), makeSymbol("SIMPLE-CONDITIONS"), list(makeSymbol("CLET"), list(list(makeSymbol("RELEVANT-RMS"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("SIMPLE-CONDITION"), makeSymbol("SIMPLE-CONDITIONS")), list(makeSymbol("CDOLIST"), list(makeSymbol("POSS-RELEVANT-RM"), list(makeSymbol("REMOVE-IF-NOT"), list(makeSymbol("FUNCTION"), makeSymbol("RM-P")), makeSymbol("SIMPLE-CONDITION"))), list(makeSymbol("CPUSHNEW"), makeSymbol("POSS-RELEVANT-RM"), makeSymbol("RELEVANT-RMS"))), list(makeSymbol("CPUSH"), list(makeSymbol("DRT-SIMPLE-CONDITION-CONSTRUCT-CYCL"), makeSymbol("SIMPLE-CONDITION")), makeSymbol("RESULT"))), list(makeSymbol("CDOLIST"), list(makeSymbol("RELEVANT-RM"), makeSymbol("RELEVANT-RMS")), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("GET-SLOT"), makeSymbol("RELEVANT-RM"), list(makeSymbol("QUOTE"), makeSymbol("SCOPE"))), list(makeSymbol("CNOT"), list(EQ, reader_make_constant_shell(makeString("forAll")), list(makeSymbol("GET-SLOT"), makeSymbol("RELEVANT-RM"), list(makeSymbol("QUOTE"), makeSymbol("SCOPE")))))), list(makeSymbol("CPUSH"), list(makeSymbol("BQ-LIST"), list(makeSymbol("GET-SLOT"), makeSymbol("RELEVANT-RM"), list(makeSymbol("QUOTE"), makeSymbol("SCOPE"))), list(makeSymbol("GET-SLOT"), makeSymbol("RELEVANT-RM"), list(makeSymbol("QUOTE"), makeSymbol("TARGET-VAR")))), makeSymbol("SCOPES")))))), list(makeSymbol("PIF"), list(makeSymbol("CDR"), makeSymbol("RESULT")), list(makeSymbol("CSETQ"), makeSymbol("RESULT"), list(makeSymbol("BQ-CONS"), reader_make_constant_shell(makeString("and")), makeSymbol("RESULT"))), list(makeSymbol("CSETQ"), makeSymbol("RESULT"), list(makeSymbol("CAR"), makeSymbol("RESULT")))), list(makeSymbol("CDOLIST"), list(makeSymbol("SCOPE"), makeSymbol("SCOPES")), list(makeSymbol("CSETQ"), makeSymbol("RESULT"), list(makeSymbol("APPEND"), makeSymbol("SCOPE"), list(makeSymbol("LIST"), makeSymbol("RESULT"))))), list(makeSymbol("DRT-TRACE-PROGN"), TWO_INTEGER, list(makeSymbol("DRT-TRACE-OUT"), TWO_INTEGER, makeString("~%******************** FINAL CYCL FORMULA ********************~%")), list(makeSymbol("DRT-TRACE-OUT"), TWO_INTEGER, makeString("~A~%"), makeSymbol("RESULT"))), list(makeSymbol("RET"), makeSymbol("RESULT"))));

    public static final SubLSymbol $sym133$OUTER_CATCH_FOR_DRS_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-DRS-METHOD");

    public static final SubLString $str134$_______________________FINAL_CYCL = makeString("~%******************** FINAL CYCL FORMULA ********************~%");

    public static final SubLString $str135$_A__ = makeString("~A~%");

    public static final SubLSymbol DRS_CONSTRUCT_CYCL_METHOD = makeSymbol("DRS-CONSTRUCT-CYCL-METHOD");
    ...
    public static SubLObject declare_drt_drs_file() {
        declareFunction(me, "drt_drs_quant_call_type", "DRT-DRS-QUANT-CALL-TYPE", 1, 0, false);
        declareFunction(me, "drt_drs_quant_call_test", "DRT-DRS-QUANT-CALL-TEST", 1, 0, false);
        declareFunction(me, "drt_drs_quant_call_fn", "DRT-DRS-QUANT-CALL-FN", 1, 0, false);
        declareFunction(me, "drt_drs_quant_call_mt", "DRT-DRS-QUANT-CALL-MT", 1, 0, false);
        declareFunction(me, "get_drs_parsing_mt", "GET-DRS-PARSING-MT", 1, 0, false);
        declareFunction(me, "set_drs_parsing_mt", "SET-DRS-PARSING-MT", 2, 0, false);
        declareFunction(me, "get_drs_interaction_mt", "GET-DRS-INTERACTION-MT", 1, 0, false);
        declareFunction(me, "set_drs_interaction_mt", "SET-DRS-INTERACTION-MT", 2, 0, false);
        declareFunction(me, "get_drs_complex_conditions", "GET-DRS-COMPLEX-CONDITIONS", 1, 0, false);
        declareFunction(me, "set_drs_complex_conditions", "SET-DRS-COMPLEX-CONDITIONS", 2, 0, false);
        declareFunction(me, "get_drs_simple_conditions", "GET-DRS-SIMPLE-CONDITIONS", 1, 0, false);
        declareFunction(me, "set_drs_simple_conditions", "SET-DRS-SIMPLE-CONDITIONS", 2, 0, false);
        declareFunction(me, "get_drs_cycl_formulas", "GET-DRS-CYCL-FORMULAS", 1, 0, false);
        declareFunction(me, "set_drs_cycl_formulas", "SET-DRS-CYCL-FORMULAS", 2, 0, false);
        declareFunction(me, "get_drs_sub_drss", "GET-DRS-SUB-DRSS", 1, 0, false);
        declareFunction(me, "set_drs_sub_drss", "SET-DRS-SUB-DRSS", 2, 0, false);
        declareFunction(me, "get_drs_super_drs", "GET-DRS-SUPER-DRS", 1, 0, false);
        declareFunction(me, "set_drs_super_drs", "SET-DRS-SUPER-DRS", 2, 0, false);
        declareFunction(me, "get_drs_next_drs", "GET-DRS-NEXT-DRS", 1, 0, false);
        declareFunction(me, "set_drs_next_drs", "SET-DRS-NEXT-DRS", 2, 0, false);
        declareFunction(me, "get_drs_prev_drs", "GET-DRS-PREV-DRS", 1, 0, false);
        declareFunction(me, "set_drs_prev_drs", "SET-DRS-PREV-DRS", 2, 0, false);
        declareFunction(me, "get_drs_pronomial_rms", "GET-DRS-PRONOMIAL-RMS", 1, 0, false);
        declareFunction(me, "set_drs_pronomial_rms", "SET-DRS-PRONOMIAL-RMS", 2, 0, false);
        declareFunction(me, "get_drs_definite_rms", "GET-DRS-DEFINITE-RMS", 1, 0, false);
        declareFunction(me, "set_drs_definite_rms", "SET-DRS-DEFINITE-RMS", 2, 0, false);
        declareFunction(me, "get_drs_available_rms", "GET-DRS-AVAILABLE-RMS", 1, 0, false);
        declareFunction(me, "set_drs_available_rms", "SET-DRS-AVAILABLE-RMS", 2, 0, false);
        declareFunction(me, "get_drs_rms", "GET-DRS-RMS", 1, 0, false);
        declareFunction(me, "set_drs_rms", "SET-DRS-RMS", 2, 0, false);
        declareFunction(me, "get_drs_audience", "GET-DRS-AUDIENCE", 1, 0, false);
        declareFunction(me, "set_drs_audience", "SET-DRS-AUDIENCE", 2, 0, false);
        declareFunction(me, "get_drs_speaker", "GET-DRS-SPEAKER", 1, 0, false);
        declareFunction(me, "set_drs_speaker", "SET-DRS-SPEAKER", 2, 0, false);
        declareFunction(me, "subloop_reserved_initialize_drs_class", "SUBLOOP-RESERVED-INITIALIZE-DRS-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_drs_instance", "SUBLOOP-RESERVED-INITIALIZE-DRS-INSTANCE", 1, 0, false);
        declareFunction(me, "drs_p", "DRS-P", 1, 0, false);
        declareFunction(me, "drs_add_rm_method", "DRS-ADD-RM-METHOD", 2, 0, false);
        declareFunction(me, "drs_add_available_rm_method", "DRS-ADD-AVAILABLE-RM-METHOD", 2, 0, false);
        declareFunction(me, "drs_add_definite_rm_method", "DRS-ADD-DEFINITE-RM-METHOD", 2, 0, false);
        declareFunction(me, "drs_add_pronomial_rm_method", "DRS-ADD-PRONOMIAL-RM-METHOD", 2, 0, false);
        declareFunction(me, "create_drs_from_formula", "CREATE-DRS-FROM-FORMULA", 3, 2, false);
        declareFunction(me, "drt_quantproc_hint_fn_p", "DRT-QUANTPROC-HINT-FN-P", 1, 1, false);
        declareFunction(me, "drt_complex_formula_element", "DRT-COMPLEX-FORMULA-ELEMENT", 1, 0, false);
        declareFunction(me, "drt_complex_formulaP", "DRT-COMPLEX-FORMULA?", 1, 0, false);
        declareFunction(me, "drs_process_method", "DRS-PROCESS-METHOD", 1, 1, false);
        declareFunction(me, "drs_find_all_possible_rm_coreferences_method", "DRS-FIND-ALL-POSSIBLE-RM-COREFERENCES-METHOD", 1, 0, false);
        declareFunction(me, "possible_rm_coreference_source_rm", "POSSIBLE-RM-COREFERENCE-SOURCE-RM", 1, 0, false);
        declareFunction(me, "possible_rm_coreference_targets", "POSSIBLE-RM-COREFERENCE-TARGETS", 1, 0, false);
        declareFunction(me, "possible_rm_coreference_target_rm", "POSSIBLE-RM-COREFERENCE-TARGET-RM", 1, 0, false);
        declareFunction(me, "possible_rm_coreference_target_probability", "POSSIBLE-RM-COREFERENCE-TARGET-PROBABILITY", 1, 0, false);
        declareFunction(me, "drs_find_possible_rm_coreferences_method", "DRS-FIND-POSSIBLE-RM-COREFERENCES-METHOD", 2, 2, false);
        declareFunction(me, "drt_drs_map_add_rms_to_formula", "DRT-DRS-MAP-ADD-RMS-TO-FORMULA", 2, 0, false);
        declareFunction(me, "drs_rm_root_term_method", "DRS-RM-ROOT-TERM-METHOD", 1, 0, false);
        declareFunction(me, "drt_corresponding_type_subcol_fn_3", "DRT-CORRESPONDING-TYPE-SUBCOL-FN-3", 1, 0, false);
        declareFunction(me, "drs_find_rm_by_target_method", "DRS-FIND-RM-BY-TARGET-METHOD", 3, 0, false);
        declareFunction(me, "find_terms_for_var_in_formula", "FIND-TERMS-FOR-VAR-IN-FORMULA", 2, 0, false);
        declareFunction(me, "drs_construct_cycl_method", "DRS-CONSTRUCT-CYCL-METHOD", 1, 0, false);
        declareFunction(me, "drt_complex_condition_construct_cycl", "DRT-COMPLEX-CONDITION-CONSTRUCT-CYCL", 1, 1, false);
        declareFunction(me, "drt_simple_condition_construct_cycl", "DRT-SIMPLE-CONDITION-CONSTRUCT-CYCL", 1, 0, false);
        declareFunction(me, "drt_formula_construct_cycl", "DRT-FORMULA-CONSTRUCT-CYCL", 1, 0, false);
        return NIL;
    }
    ...
    private static SubLObject _constant_59_initializer() {
        return list(makeString("Processes a DRS until the cycl-formulas slot is empty and all the contents have been moved into the relevant RMs, the simple and complex conditions lists, or the this DRS itself."), list(makeSymbol("IGNORE"), makeSymbol("SUPER-DRS"), makeSymbol("AVAILABLE-RMS"), makeSymbol("DEFINITE-RMS"), makeSymbol("PRONOMIAL-RMS"), makeSymbol("SUB-DRSS")), list(makeSymbol("DRT-TRACE-PROGN"), FOUR_INTEGER, list(makeSymbol("FORMAT"), T, makeString("~%(drs-process-method ~A)"), makeSymbol("SELF")), list(makeSymbol("DESCRIBE-INSTANCE"), makeSymbol("SELF")), list(makeSymbol("FORMAT"), T, makeString("~%"))), list(makeSymbol("CLET"), list(list(makeSymbol("SIMPLE-FORMULAS"), NIL), list(makeSymbol("COMPLEX-FORMULAS"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("CYCL-FORMULA"), makeSymbol("CYCL-FORMULAS")), list(makeSymbol("PIF"), list(makeSymbol("DRT-COMPLEX-FORMULA?"), makeSymbol("CYCL-FORMULA")), list(makeSymbol("CPUSH"), makeSymbol("CYCL-FORMULA"), makeSymbol("COMPLEX-FORMULAS")), list(makeSymbol("CPUSH"), makeSymbol("CYCL-FORMULA"), makeSymbol("SIMPLE-FORMULAS")))), list(makeSymbol("PWHEN"), makeSymbol("COMPLEX-FORMULAS"), list(makeSymbol("PWHEN"), list(makeSymbol(">"), list(makeSymbol("LENGTH"), makeSymbol("COMPLEX-FORMULAS")), ONE_INTEGER), list(makeSymbol("DRT-WARN"), makeString("drt-process-drs: more than one complex formula in drs ~A ~A~%"), makeSymbol("SELF"), makeSymbol("COMPLEX-FORMULAS"))), list(makeSymbol("CLET"), list(list(makeSymbol("COMPLEX-FORMULA"), list(makeSymbol("CAR"), makeSymbol("COMPLEX-FORMULAS"))), list(makeSymbol("COMPLEX-FORMULA-ARG0"), list(makeSymbol("FORMULA-ARG0"), makeSymbol("COMPLEX-FORMULA")))), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("COMPLEX-FORMULAS"), list(makeSymbol("CDR"), makeSymbol("COMPLEX-FORMULAS"))), list(makeSymbol("CSETQ"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CYCL-FORMULAS")), list(makeSymbol("APPEND"), makeSymbol("COMPLEX-FORMULAS"), makeSymbol("SIMPLE-FORMULAS"))))), list(makeSymbol("PCOND"), list(list(makeSymbol("ISA?"), makeSymbol("COMPLEX-FORMULA-ARG0"), reader_make_constant_shell(makeString("Quantifier"))), list(makeSymbol("DRT-TRACE-PROGN"), THREE_INTEGER, list(makeSymbol("DRT-WARN"), makeString("1.a. quantifiers.~%"))), list(makeSymbol("CLET"), list(list(makeSymbol("TARGET-VAR"), list(makeSymbol("FORMULA-ARG1"), makeSymbol("COMPLEX-FORMULA"))), list(makeSymbol("RM"), list(makeSymbol("CAR"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("FIND-RM-BY-TARGET")), makeSymbol("TARGET-VAR"), list(makeSymbol("QUOTE"), list(makeKeyword("VAR"))))))), list(makeSymbol("PUNLESS"), makeSymbol("RM"), list(makeSymbol("DRT-WARN"), makeString("drt-process-drs ~A: no RM found for var ~A in complex-formula ~A~%"), makeSymbol("SELF"), makeSymbol("TARGET-VAR"), makeSymbol("COMPLEX-FORMULA"))), list(makeSymbol("PWHEN"), makeSymbol("RM"), list(makeSymbol("PUNLESS"), list(makeSymbol("GET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("SCOPE"))), list(makeSymbol("SET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("SCOPE")), makeSymbol("COMPLEX-FORMULA-ARG0"))), list(makeSymbol("DRT-TRACE-PROGN"), FOUR_INTEGER, list(makeSymbol("FORMAT"), T, makeString("-1--------------- modified RM:")), list(makeSymbol("DESCRIBE-INSTANCE"), makeSymbol("RM")), list(makeSymbol("FORMAT"), T, makeString("-1-----------~%")))), list(makeSymbol("PROGN"), list(makeSymbol("CPUSH"), list(makeSymbol("FORMULA-ARG2"), makeSymbol("COMPLEX-FORMULA")), makeSymbol("COMPLEX-FORMULAS")), list(makeSymbol("CSETQ"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CYCL-FORMULAS")), list(makeSymbol("APPEND"), makeSymbol("COMPLEX-FORMULAS"), makeSymbol("SIMPLE-FORMULAS"))))))), list(list(makeSymbol("COR"), list(makeSymbol("ISA?"), makeSymbol("COMPLEX-FORMULA-ARG0"), reader_make_constant_shell(makeString("LogicalConnective"))), list(EQ, makeSymbol("COMPLEX-FORMULA-ARG0"), reader_make_constant_shell(makeString("NLNegFn"))), list(EQ, makeSymbol("COMPLEX-FORMULA-ARG0"), reader_make_constant_shell(makeString("explains-PropProp")))), list(makeSymbol("DRT-TRACE-PROGN"), THREE_INTEGER, list(makeSymbol("DRT-WARN"), makeString("1.b. logical connectives.~%"))), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-COMPLEX-CONDITION"), list(makeSymbol("BQ-LIST"), makeSymbol("COMPLEX-FORMULA-ARG0"))), list(makeSymbol("SUBDRS-LIST"))), list(makeSymbol("PCASE"), makeSymbol("COMPLEX-FORMULA-ARG0"), list(reader_make_constant_shell(makeString("and")), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("COMPLEX-FORMULAS"), list(makeSymbol("APPEND"), list(makeSymbol("FORMULA-ARGS"), makeSymbol("COMPLEX-FORMULA")), makeSymbol("COMPLEX-FORMULAS"))), list(makeSymbol("CSETQ"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CYCL-FORMULAS")), list(makeSymbol("APPEND"), makeSymbol("COMPLEX-FORMULAS"), makeSymbol("SIMPLE-FORMULAS")))))), list(makeSymbol("OTHERWISE"), list(makeSymbol("CLET"), list(list(makeSymbol("LAST-NEW-DRS"), NIL), list(makeSymbol("FORMULA-ARGS"), list(makeSymbol("FORMULA-ARGS"), makeSymbol("COMPLEX-FORMULA")))), list(makeSymbol("CDOLIST"), list(makeSymbol("FORMULA-ARG"), makeSymbol("FORMULA-ARGS")), list(makeSymbol("PIF"), list(makeSymbol("CONSP"), makeSymbol("FORMULA-ARG")), list(new SubLObject[]{ makeSymbol("CLET"), list(list(makeSymbol("SUBDRS"), list(makeSymbol("FUNCALL-CLASS-METHOD"), list(makeSymbol("QUOTE"), makeSymbol("DRS")), list(makeSymbol("QUOTE"), makeSymbol("NEW"))))), list(makeSymbol("SET-SLOT"), makeSymbol("SUBDRS"), list(makeSymbol("QUOTE"), makeSymbol("INTERACTION-MT")), makeSymbol("INTERACTION-MT")), list(makeSymbol("SET-SLOT"), makeSymbol("SUBDRS"), list(makeSymbol("QUOTE"), makeSymbol("PARSING-MT")), makeSymbol("PARSING-MT")), list(makeSymbol("SET-SLOT"), makeSymbol("SUBDRS"), list(makeSymbol("QUOTE"), makeSymbol("CYCL-FORMULAS")), list(makeSymbol("BQ-LIST"), makeSymbol("FORMULA-ARG"))), list(makeSymbol("PIF"), makeSymbol("LAST-NEW-DRS"), list(makeSymbol("PROGN"), list(makeSymbol("SET-SLOT"), makeSymbol("SUBDRS"), list(makeSymbol("QUOTE"), makeSymbol("SUPER-DRS")), makeSymbol("LAST-NEW-DRS")), list(makeSymbol("SET-SLOT"), makeSymbol("LAST-NEW-DRS"), list(makeSymbol("QUOTE"), makeSymbol("SUB-DRSS")), list(makeSymbol("BQ-LIST"), makeSymbol("SUBDRS")))), list(makeSymbol("PROGN"), list(makeSymbol("SET-SLOT"), makeSymbol("SUBDRS"), list(makeSymbol("QUOTE"), makeSymbol("SUPER-DRS")), makeSymbol("SELF")), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("SUB-DRSS")), list(makeSymbol("BQ-LIST"), makeSymbol("SUBDRS"))))), list(makeSymbol("CSETQ"), makeSymbol("LAST-NEW-DRS"), makeSymbol("SUBDRS")), list(makeSymbol("CPUSH"), makeSymbol("SUBDRS"), makeSymbol("NEW-COMPLEX-CONDITION")), list(makeSymbol("CPUSH"), makeSymbol("SUBDRS"), makeSymbol("SUBDRS-LIST")) }), list(makeSymbol("CPUSH"), makeSymbol("FORMULA-ARG"), makeSymbol("NEW-COMPLEX-CONDITION"))))), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("NEW-COMPLEX-CONDITION"), list(makeSymbol("NREVERSE"), makeSymbol("NEW-COMPLEX-CONDITION"))), list(makeSymbol("CSETQ"), makeSymbol("COMPLEX-CONDITIONS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("COMPLEX-CONDITIONS")), list(makeSymbol("CONS"), makeSymbol("NEW-COMPLEX-CONDITION"), makeSymbol("COMPLEX-CONDITIONS"))))), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CYCL-FORMULAS")), list(makeSymbol("APPEND"), makeSymbol("COMPLEX-FORMULAS"), makeSymbol("SIMPLE-FORMULAS"))))), list(makeSymbol("CLET"), list(makeSymbol("POSSIBLE-RM-COREFERENCES")), list(makeSymbol("CDOLIST"), list(makeSymbol("SUBDRS"), makeSymbol("SUBDRS-LIST")), list(makeSymbol("CLET"), list(list(makeSymbol("SUB-POSSIBLE-RM-COREFERENCES"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SUBDRS"), list(makeSymbol("QUOTE"), makeSymbol("PROCESS"))))), list(makeSymbol("PCOND"), list(list(EQ, makeSymbol("SUB-POSSIBLE-RM-COREFERENCES"), T), list(makeSymbol("RET"), T)), list(T, list(makeSymbol("CSETQ"), makeSymbol("POSSIBLE-RM-COREFERENCES"), list(makeSymbol("APPEND"), makeSymbol("SUB-POSSIBLE-RM-COREFERENCES"), makeSymbol("POSSIBLE-RM-COREFERENCES"))))))), list(makeSymbol("CSETQ"), makeSymbol("CARRY-POSSIBLE-RM-COREFERENCES"), list(makeSymbol("APPEND"), makeSymbol("CARRY-POSSIBLE-RM-COREFERENCES"), makeSymbol("POSSIBLE-RM-COREFERENCES")))))))), list(T, list(makeSymbol("DRT-TRACE-PROGN"), THREE_INTEGER, list(makeSymbol("DRT-WARN"), makeString("1.c. quantproc~%")), list(makeSymbol("FORMAT"), T, makeString("Attempting reformulation on: ~%~A~%"), makeSymbol("COMPLEX-FORMULA"))), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-COMPLEX-FORMULA"), NIL)), list(makeSymbol("CLET"), list(makeSymbol("DONE?")), list(makeSymbol("CSOME"), list(makeSymbol("QUANT-CALL"), makeSymbol("*DRT-DRS-QUANT-CALLS*"), makeSymbol("DONE?")), list(makeSymbol("CLET"), list(list(makeSymbol("QUANT-CALL-TYPE"), list(makeSymbol("DRT-DRS-QUANT-CALL-TYPE"), makeSymbol("QUANT-CALL"))), list(makeSymbol("QUANT-CALL-TEST"), list(makeSymbol("DRT-DRS-QUANT-CALL-TEST"), makeSymbol("QUANT-CALL"))), list(makeSymbol("QUANT-CALL-FN"), list(makeSymbol("DRT-DRS-QUANT-CALL-FN"), makeSymbol("QUANT-CALL"))), list(makeSymbol("QUANT-CALL-MT"), list(makeSymbol("DRT-DRS-QUANT-CALL-MT"), makeSymbol("QUANT-CALL")))), list(makeSymbol("PCASE"), makeSymbol("QUANT-CALL-MT"), list(makeKeyword("PARSING-MT"), list(makeSymbol("CSETQ"), makeSymbol("QUANT-CALL-MT"), makeSymbol("PARSING-MT"))), list(makeKeyword("INTERACTION-MT"), list(makeSymbol("CSETQ"), makeSymbol("QUANT-CALL-MT"), makeSymbol("INTERACTION-MT"))), list(makeSymbol("OTHERWISE"), list(makeSymbol("CSETQ"), makeSymbol("QUANT-CALL-MT"), makeSymbol("INTERACTION-MT")))), list(makeSymbol("DRT-TRACE-PROGN"), THREE_INTEGER, list(makeSymbol("FORMAT"), T, makeString("Attempting reformulation type ~A, mt=~A~%"), makeSymbol("QUANT-CALL-TYPE"), makeSymbol("QUANT-CALL-MT"))), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("FUNCTION-SPEC-P"), makeSymbol("QUANT-CALL-TEST")), list(makeSymbol("FUNCALL"), makeSymbol("QUANT-CALL-TEST"), makeSymbol("COMPLEX-FORMULA"))), list(makeSymbol("PWHEN"), list(makeSymbol("FUNCTION-SPEC-P"), makeSymbol("QUANT-CALL-FN")), list(makeSymbol("CSETQ"), makeSymbol("NEW-COMPLEX-FORMULA"), list(makeSymbol("FUNCALL"), makeSymbol("QUANT-CALL-FN"), makeSymbol("COMPLEX-FORMULA"), makeSymbol("QUANT-CALL-MT"))))), list(makeSymbol("PUNLESS"), list(makeSymbol("COR"), list(makeSymbol("NULL"), makeSymbol("NEW-COMPLEX-FORMULA")), list(EQUAL, makeSymbol("NEW-COMPLEX-FORMULA"), makeSymbol("COMPLEX-FORMULA"))), list(makeSymbol("DRT-TRACE-PROGN"), THREE_INTEGER, list(makeSymbol("FORMAT"), T, makeString("Using reformulator result from ~A: ~A~%"), makeSymbol("QUANT-CALL-TYPE"), makeSymbol("NEW-COMPLEX-FORMULA"))), list(makeSymbol("CSETQ"), makeSymbol("DONE?"), T))))), list(makeSymbol("PCOND"), list(list(makeSymbol("NULL"), makeSymbol("NEW-COMPLEX-FORMULA")), list(makeSymbol("DRT-WARN"), makeString("failed reformulation on ~A: new-complex-formula is NULL."), makeSymbol("COMPLEX-FORMULA")), list(makeSymbol("RET"), T)), list(list(EQUAL, makeSymbol("NEW-COMPLEX-FORMULA"), makeSymbol("COMPLEX-FORMULA")), list(makeSymbol("DRT-WARN"), makeString("failed reformulation on ~A: new-complex-formula is IDENTICAL."), makeSymbol("COMPLEX-FORMULA")), list(makeSymbol("RET"), T)), list(T, list(makeSymbol("CLET"), list(list(makeSymbol("NEW-COMPLEX-FORMULA-ARG0"), list(makeSymbol("FORMULA-ARG0"), makeSymbol("NEW-COMPLEX-FORMULA")))), list(makeSymbol("PCOND"), list(list(makeSymbol("ISA?"), makeSymbol("NEW-COMPLEX-FORMULA-ARG0"), reader_make_constant_shell(makeString("Quantifier"))), list(makeSymbol("CLET"), list(list(makeSymbol("INTRODUCED-VAR"), list(makeSymbol("FORMULA-ARG1"), makeSymbol("NEW-COMPLEX-FORMULA"))), list(makeSymbol("UNIQUE-VAR"), list(makeSymbol("MAKE-EL-VAR"), list(makeSymbol("FORMAT"), NIL, makeString("DRT-~A"), list(makeSymbol("INTEGER-SEQUENCE-GENERATOR-NEXT"), makeSymbol("*DRT-INTRODUCED-VAR-NUM-ISG*")))))), list(makeSymbol("PWHEN"), list(makeSymbol("EL-VAR?"), makeSymbol("INTRODUCED-VAR")), list(makeSymbol("CSETQ"), makeSymbol("NEW-COMPLEX-FORMULA"), list(makeSymbol("TREE-SUBSTITUTE"), makeSymbol("NEW-COMPLEX-FORMULA"), makeSymbol("INTRODUCED-VAR"), makeSymbol("UNIQUE-VAR"))))), list(makeSymbol("PROGN"), list(makeSymbol("CPUSH"), makeSymbol("NEW-COMPLEX-FORMULA"), makeSymbol("COMPLEX-FORMULAS")), list(makeSymbol("CSETQ"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CYCL-FORMULAS")), list(makeSymbol("APPEND"), makeSymbol("COMPLEX-FORMULAS"), makeSymbol("SIMPLE-FORMULAS"))))), list(makeSymbol("CLET"), list(list(makeSymbol("INTRODUCED-VAR"), list(makeSymbol("FORMULA-ARG1"), makeSymbol("NEW-COMPLEX-FORMULA"))), list(makeSymbol("SUBFORMULA"), list(makeSymbol("FORMULA-ARG2"), makeSymbol("NEW-COMPLEX-FORMULA"))), list(makeSymbol("TARGET-TERMS"), list(makeSymbol("FIND-TERMS-FOR-VAR-IN-FORMULA"), makeSymbol("INTRODUCED-VAR"), makeSymbol("SUBFORMULA"))), list(makeSymbol("RM"), NIL)), list(makeSymbol("CLET"), list(makeSymbol("DONE?"), makeSymbol("DONE2?")), list(makeSymbol("CSOME"), list(makeSymbol("TARGET-TERM"), makeSymbol("TARGET-TERMS"), makeSymbol("DONE?")), list(makeSymbol("CLET"), list(list(makeSymbol("POSS-RMS"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("FIND-RM-BY-TARGET")), makeSymbol("TARGET-TERM"), list(makeSymbol("QUOTE"), list(makeKeyword("ROOT"), makeKeyword("FORMULA")))))), list(makeSymbol("CSOME"), list(makeSymbol("POSS-RM"), makeSymbol("POSS-RMS"), makeSymbol("DONE2?")), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("RM-P"), makeSymbol("POSS-RM")), list(makeSymbol("NULL"), list(makeSymbol("GET-SLOT"), makeSymbol("POSS-RM"), list(makeSymbol("QUOTE"), makeSymbol("TARGET-VAR"))))), list(makeSymbol("CSETQ"), makeSymbol("RM"), makeSymbol("POSS-RM")), list(makeSymbol("CSETQ"), makeSymbol("DONE?"), T), list(makeSymbol("CSETQ"), makeSymbol("DONE2?"), T)))))), list(makeSymbol("PWHEN"), list(makeSymbol("RM-P"), makeSymbol("RM")), list(makeSymbol("SET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("TARGET-VAR")), makeSymbol("INTRODUCED-VAR")), list(makeSymbol("SET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("SCOPE")), makeSymbol("NEW-COMPLEX-FORMULA-ARG0")), list(makeSymbol("DRT-TRACE-PROGN"), FOUR_INTEGER, list(makeSymbol("FORMAT"), T, makeString("~%-2--------------- modified RM:")), list(makeSymbol("DESCRIBE-INSTANCE"), makeSymbol("RM")), list(makeSymbol("FORMAT"), T, makeString("-2-----------~%")))))), list(list(makeSymbol("ISA?"), makeSymbol("NEW-COMPLEX-FORMULA-ARG0"), reader_make_constant_shell(makeString("LogicalConnective"))), list(makeSymbol("CLET"), list(list(makeSymbol("INTRODUCED-VAR"), list(makeSymbol("SECOND"), list(makeSymbol("SECOND"), makeSymbol("NEW-COMPLEX-FORMULA")))), list(makeSymbol("UNIQUE-VAR"), list(makeSymbol("MAKE-EL-VAR"), list(makeSymbol("FORMAT"), NIL, makeString("DRT-~A"), list(makeSymbol("INTEGER-SEQUENCE-GENERATOR-NEXT"), makeSymbol("*DRT-INTRODUCED-VAR-NUM-ISG*")))))), list(makeSymbol("PWHEN"), list(makeSymbol("EL-VAR?"), makeSymbol("INTRODUCED-VAR")), list(makeSymbol("CSETQ"), makeSymbol("NEW-COMPLEX-FORMULA"), list(makeSymbol("TREE-SUBSTITUTE"), makeSymbol("NEW-COMPLEX-FORMULA"), makeSymbol("INTRODUCED-VAR"), makeSymbol("UNIQUE-VAR"))))), list(makeSymbol("PROGN"), list(makeSymbol("CPUSH"), makeSymbol("NEW-COMPLEX-FORMULA"), makeSymbol("COMPLEX-FORMULAS")), list(makeSymbol("CSETQ"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CYCL-FORMULAS")), list(makeSymbol("APPEND"), makeSymbol("COMPLEX-FORMULAS"), makeSymbol("SIMPLE-FORMULAS"))))), list(makeSymbol("CLET"), list(list(makeSymbol("INTRODUCED-VAR"), list(makeSymbol("SECOND"), list(makeSymbol("SECOND"), makeSymbol("NEW-COMPLEX-FORMULA")))), list(makeSymbol("TARGET-TERM"), list(makeSymbol("THIRD"), list(makeSymbol("SECOND"), makeSymbol("NEW-COMPLEX-FORMULA")))), list(makeSymbol("POSS-RMS"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("FIND-RM-BY-TARGET")), makeSymbol("TARGET-TERM"), list(makeSymbol("QUOTE"), list(makeKeyword("ROOT"))))), makeSymbol("RM")), list(makeSymbol("CLET"), list(makeSymbol("DONE?")), list(makeSymbol("CSOME"), list(makeSymbol("POSS-RM"), makeSymbol("POSS-RMS"), makeSymbol("DONE?")), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("RM-P"), makeSymbol("POSS-RM")), list(makeSymbol("NULL"), list(makeSymbol("GET-SLOT"), makeSymbol("POSS-RM"), list(makeSymbol("QUOTE"), makeSymbol("TARGET-VAR"))))), list(makeSymbol("CSETQ"), makeSymbol("RM"), makeSymbol("POSS-RM")), list(makeSymbol("CSETQ"), makeSymbol("DONE?"), T)))), list(makeSymbol("SET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("TARGET-VAR")), makeSymbol("INTRODUCED-VAR")), list(makeSymbol("SET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("SCOPE")), reader_make_constant_shell(makeString("forAll"))), list(makeSymbol("DRT-TRACE-PROGN"), FOUR_INTEGER, list(makeSymbol("FORMAT"), T, makeString("~%-3--------------- modified RM:")), list(makeSymbol("DESCRIBE-INSTANCE"), makeSymbol("RM")), list(makeSymbol("FORMAT"), T, makeString("-3-----------~%"))))), list(T, list(makeSymbol("PROGN"), list(makeSymbol("CPUSH"), makeSymbol("NEW-COMPLEX-FORMULA"), makeSymbol("COMPLEX-FORMULAS")), list(makeSymbol("CSETQ"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CYCL-FORMULAS")), list(makeSymbol("APPEND"), makeSymbol("COMPLEX-FORMULAS"), makeSymbol("SIMPLE-FORMULAS"))))))))))))))), list(makeSymbol("PWHEN"), makeSymbol("SIMPLE-FORMULAS"), list(makeSymbol("DRT-TRACE-PROGN"), THREE_INTEGER, list(makeSymbol("DRT-WARN"), makeString("1.d. subcollection processing~%"))), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-SIMPLE-FORMULAS"), NIL), list(makeSymbol("NEW-COMPLEX-FORMULAS"), makeSymbol("COMPLEX-FORMULAS"))), list(makeSymbol("CDOLIST"), list(makeSymbol("SIMPLE-FORMULA"), makeSymbol("SIMPLE-FORMULAS")), list(makeSymbol("CLET"), list(list(makeSymbol("POSS-NEW-FORMULA"), list(makeSymbol("REFORMULATE-CYCL-SUBCOLLPROC"), makeSymbol("SIMPLE-FORMULA"), makeSymbol("INTERACTION-MT")))), list(makeSymbol("PIF"), list(makeSymbol("COR"), list(makeSymbol("NULL"), makeSymbol("POSS-NEW-FORMULA")), list(EQUAL, makeSymbol("POSS-NEW-FORMULA"), makeSymbol("SIMPLE-FORMULA"))), list(makeSymbol("CPUSH"), makeSymbol("SIMPLE-FORMULA"), makeSymbol("NEW-SIMPLE-FORMULAS")), list(makeSymbol("CPUSH"), makeSymbol("POSS-NEW-FORMULA"), makeSymbol("NEW-COMPLEX-FORMULAS"))))), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("SIMPLE-FORMULAS"), makeSymbol("NEW-SIMPLE-FORMULAS")), list(makeSymbol("CSETQ"), makeSymbol("COMPLEX-FORMULAS"), makeSymbol("NEW-COMPLEX-FORMULAS")), list(makeSymbol("CSETQ"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CYCL-FORMULAS")), list(makeSymbol("APPEND"), makeSymbol("COMPLEX-FORMULAS"), makeSymbol("SIMPLE-FORMULAS"))))))), list(makeSymbol("PWHEN"), makeSymbol("SIMPLE-FORMULAS"), list(makeSymbol("DRT-TRACE-PROGN"), THREE_INTEGER, list(makeSymbol("DRT-WARN"), makeString("1.e. simple formulas~%"))), list(makeSymbol("CDOLIST"), list(makeSymbol("SIMPLE-FORMULA"), makeSymbol("SIMPLE-FORMULAS")), list(makeSymbol("CLET"), list(list(makeSymbol("SIMPLE-CONDITION"), list(makeSymbol("DRT-DRS-MAP-ADD-RMS-TO-FORMULA"), makeSymbol("SELF"), makeSymbol("SIMPLE-FORMULA")))), list(makeSymbol("CDOLIST"), list(makeSymbol("RM"), list(makeSymbol("TREE-FIND-ALL-IF"), list(makeSymbol("FUNCTION"), makeSymbol("RM-P")), makeSymbol("SIMPLE-CONDITION"))), list(makeSymbol("PCASE"), list(makeSymbol("GET-SLOT"), makeSymbol("RM"), list(makeSymbol("QUOTE"), makeSymbol("TYPE"))), list(makeKeyword("DEFINITE"), list(makeSymbol("CSETQ"), makeSymbol("DEFINITE-RMS"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ADD-DEFINITE-RM")), makeSymbol("RM")))), list(makeKeyword("PRONOMIAL"), list(makeSymbol("CSETQ"), makeSymbol("PRONOMIAL-RMS"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ADD-PRONOMIAL-RM")), makeSymbol("RM")))), list(makeSymbol("OTHERWISE"), list(makeSymbol("CSETQ"), makeSymbol("AVAILABLE-RMS"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ADD-AVAILABLE-RM")), makeSymbol("RM")))))), list(makeSymbol("CSETQ"), makeSymbol("SIMPLE-CONDITIONS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("SIMPLE-CONDITIONS")), list(makeSymbol("CONS"), makeSymbol("SIMPLE-CONDITION"), makeSymbol("SIMPLE-CONDITIONS")))))), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("SIMPLE-FORMULAS"), NIL), list(makeSymbol("CSETQ"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CYCL-FORMULAS")), makeSymbol("COMPLEX-FORMULAS"))))), list(makeSymbol("DRT-TRACE-PROGN"), TWO_INTEGER, list(makeSymbol("PUNLESS"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("FORMAT"), T, makeString("~%******************** FINAL DRS ********************~%")), list(makeSymbol("DESCRIBE-INSTANCE"), makeSymbol("SELF")))), list(makeSymbol("PIF"), makeSymbol("CYCL-FORMULAS"), list(makeSymbol("RET"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("PROCESS")), makeSymbol("CARRY-POSSIBLE-RM-COREFERENCES"))), list(makeSymbol("RET"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("FIND-ALL-POSSIBLE-RM-COREFERENCES")))))));
    }
