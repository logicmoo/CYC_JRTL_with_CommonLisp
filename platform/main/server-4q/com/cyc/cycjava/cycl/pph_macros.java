...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class pph_macros extends SubLTranslatedFile {
    ...
    public static SubLObject pph_problem_store_pointer_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$pph_problem_store_pointer_native.class ? T : NIL;
    }

    public static SubLObject pph_problem_store_pointer_store(final SubLObject v_object) {
        assert NIL != pph_problem_store_pointer_p(v_object) : "pph_macros.pph_problem_store_pointer_p error :" + v_object;
    ...
    public static final class $pph_problem_store_pointer_native extends SubLStructNative {
        ...
        private $pph_problem_store_pointer_native() {
            this.$store = Lisp.NIL;
        }
        ...
        static {
            structDecl = makeStructDeclNative($pph_problem_store_pointer_native.class, PPH_PROBLEM_STORE_POINTER, PPH_PROBLEM_STORE_POINTER_P, $list71, $list72, new String[]{ "$store" }, $list73, $list74, PPRINT_PPH_PROBLEM_STORE_POINTER);
        }
    }
