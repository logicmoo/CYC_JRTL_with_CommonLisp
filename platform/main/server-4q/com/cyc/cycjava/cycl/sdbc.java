...
public final class sdbc extends SubLTranslatedFile {
    ...
    public static SubLObject sql_connection_p(final SubLObject v_object) {
        return v_object.getClass() == sdbc.$sql_connection_native.class ? T : NIL;
    }

    public static SubLObject sqlc_db(final SubLObject v_object) {
        assert NIL != sql_connection_p(v_object) : "sdbc.sql_connection_p(v_object) " + "CommonSymbols.NIL != sdbc.sql_connection_p(v_object) " + v_object;
    ...
    public static SubLObject make_sql_connection(SubLObject arglist) {
        ...
        final SubLObject v_new = new sdbc.$sql_connection_native();
        SubLObject next;
    ...
    public static SubLObject sql_ticket_p(final SubLObject v_object) {
        return v_object.getClass() == sdbc.$sql_ticket_native.class ? T : NIL;
    }

    public static SubLObject sql_ticket_semaphore(final SubLObject v_object) {
        assert NIL != sql_ticket_p(v_object) : "sdbc.sql_ticket_p(v_object) " + "CommonSymbols.NIL != sdbc.sql_ticket_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_ticket(SubLObject arglist) {
        ...
        final SubLObject v_new = new sdbc.$sql_ticket_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sdbc_error_p(final SubLObject v_object) {
        return v_object.getClass() == sdbc.$sdbc_error_native.class ? T : NIL;
    }

    public static SubLObject sdbc_error_type(final SubLObject v_object) {
        assert NIL != sdbc_error_p(v_object) : "sdbc.sdbc_error_p(v_object) " + "CommonSymbols.NIL != sdbc.sdbc_error_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sdbc_error(SubLObject arglist) {
        ...
        final SubLObject v_new = new sdbc.$sdbc_error_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_result_set_p(final SubLObject v_object) {
        return v_object.getClass() == sdbc.$sql_result_set_native.class ? T : NIL;
    }

    public static SubLObject sqlrs_rows(final SubLObject v_object) {
        assert NIL != sql_result_set_p(v_object) : "sdbc.sql_result_set_p(v_object) " + "CommonSymbols.NIL != sdbc.sql_result_set_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_result_set(SubLObject arglist) {
        ...
        final SubLObject v_new = new sdbc.$sql_result_set_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_statement_p(final SubLObject v_object) {
        return v_object.getClass() == sdbc.$sql_statement_native.class ? T : NIL;
    }

    public static SubLObject sqls_connection(final SubLObject v_object) {
        assert NIL != sql_statement_p(v_object) : "sdbc.sql_statement_p(v_object) " + "CommonSymbols.NIL != sdbc.sql_statement_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_statement(SubLObject arglist) {
        ...
        final SubLObject v_new = new sdbc.$sql_statement_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $sql_connection_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sdbc.$sql_connection_native.class, SQL_CONNECTION, SQL_CONNECTION_P, $list39, $list40, new String[]{ "$db", "$user", "$dbms_server", "$port", "$channel", "$statements", "$lock", "$subprotocol", "$proxy_server", "$error_handling", "$tickets", "$mailman" }, $list41, $list42, SQLC_PRINT);
        }
    }
    ...
    public static final class $sql_ticket_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sdbc.$sql_ticket_native.class, SQL_TICKET, SQL_TICKET_P, $list111, $list112, new String[]{ "$semaphore", "$result" }, $list113, $list114, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $sdbc_error_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sdbc.$sdbc_error_native.class, SDBC_ERROR, SDBC_ERROR_P, $list144, $list145, new String[]{ "$type", "$message", "$code" }, $list146, $list147, SDBC_ERROR_PRINT);
        }
    }
    ...
    public static final class $sql_result_set_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sdbc.$sql_result_set_native.class, SQL_RESULT_SET, SQL_RESULT_SET_P, $list176, $list177, new String[]{ "$rows", "$current", "$last", "$start", "$connection", "$block_size", "$id" }, $list178, $list179, SQLRS_PRINT);
        }
    }
    ...
    public static final class $sql_statement_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sdbc.$sql_statement_native.class, SQL_STATEMENT, SQL_STATEMENT_P, $list220, $list221, new String[]{ "$connection", "$id", "$sql", "$settings", "$batch", "$rs" }, $list222, $list223, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
