...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class pph_variable_handling extends SubLTranslatedFile {
    ...
    public static SubLObject pph_var_entry_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$pph_var_entry_native.class ? T : NIL;
    }

    public static SubLObject pph_var_entry_var(final SubLObject v_object) {
        assert NIL != pph_var_entry_p(v_object) : "pph_variable_handling.pph_var_entry_p error :" + v_object;
    ...
    public static final class $pph_var_entry_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($pph_var_entry_native.class, PPH_VAR_ENTRY, PPH_VAR_ENTRY_P, $list2, $list3, new String[]{ "$var", "$type", "$quantifier", "$single_useP", "$arg_position" }, $list4, $list5, PPRINT_PPH_VAR_ENTRY);
        }
    }
