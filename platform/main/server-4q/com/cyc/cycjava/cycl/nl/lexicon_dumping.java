...
import com.cyc.cycjava.cycl.nl.lexicon_dumping;
...
import static com.cyc.cycjava.cycl.nl.lexicon_dumping.*;
...
public final class lexicon_dumping extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLList $list0 = list(new SubLObject[]{ reader_make_constant_shell(makeString("abbreviationForLexicalWord")), reader_make_constant_shell(makeString("abbreviationString-PN")), reader_make_constant_shell(makeString("airportHasIATACode")), reader_make_constant_shell(makeString("atomicSymbol")), reader_make_constant_shell(makeString("chemicalFormulaString")), reader_make_constant_shell(makeString("countryCodeDigraph")), reader_make_constant_shell(makeString("countryCodeTrigraph")), reader_make_constant_shell(makeString("currencyCode")), reader_make_constant_shell(makeString("geopoliticalEntityCodeDigraph")), reader_make_constant_shell(makeString("internetCountryCode")), reader_make_constant_shell(makeString("urlStringOfCW")) });





    private static final SubLObject $$EnglishDocumentTaggingLexicalMt = reader_make_constant_shell(makeString("EnglishDocumentTaggingLexicalMt"));



    private static final SubLObject $const5$AllGeneralEnglishValidatedLexical = reader_make_constant_shell(makeString("AllGeneralEnglishValidatedLexicalMicrotheoryPSC"));

    public static final SubLList $list6 = list(reader_make_constant_shell(makeString("Adjective")), reader_make_constant_shell(makeString("Preposition")), reader_make_constant_shell(makeString("Adverb")));
    ...
    private static final SubLObject $$stopWordString = reader_make_constant_shell(makeString("stopWordString"));
    ...
    private static final SubLObject $const75$ContextuallyDependentLexicalMappi = reader_make_constant_shell(makeString("ContextuallyDependentLexicalMapping"));
    ...
    private static final SubLList $list80 = list(makeKeyword("EXTERNAL-ID"), makeKeyword("CYCL"), makeKeyword("PREFERRED-NL"));
    ...
    private static final SubLObject $$TextPrismParaphraseMt = reader_make_constant_shell(makeString("TextPrismParaphraseMt"));
    ...
    public static SubLObject declare_lexicon_dumping_file() {
        declareFunction(me, "get_dumping_lexicon", "GET-DUMPING-LEXICON", 0, 0, false);
        declareFunction(me, "get_dumping_semtrans_lexicon", "GET-DUMPING-SEMTRANS-LEXICON", 0, 0, false);
        declareFunction(me, "dump_opencyc_lexicon", "DUMP-OPENCYC-LEXICON", 0, 1, false);
        declareFunction(me, "dump_full_lexicon", "DUMP-FULL-LEXICON", 0, 1, false);
        declareFunction(me, "dump_and_link_lexicon", "DUMP-AND-LINK-LEXICON", 2, 0, false);
        declareFunction(me, "fort_should_be_in_lexiconP", "FORT-SHOULD-BE-IN-LEXICON?", 1, 0, false);
        declareFunction(me, "dump_xml_lexicon", "DUMP-XML-LEXICON", 0, 4, false);
        declareFunction(me, "add_entry_to_dictionary", "ADD-ENTRY-TO-DICTIONARY", 4, 0, false);
        declareFunction(me, "dump_string_to_concepts_dict", "DUMP-STRING-TO-CONCEPTS-DICT", 3, 2, false);
        declareFunction(me, "get_dumping_entry_cycl", "GET-DUMPING-ENTRY-CYCL", 2, 0, false);
        declareFunction(me, "dump_xml_string_to_concepts_dict", "DUMP-XML-STRING-TO-CONCEPTS-DICT", 3, 2, false);
        declareFunction(me, "dump_lexicon_string_row", "DUMP-LEXICON-STRING-ROW", 3, 1, false);
        declareFunction(me, "xml_dump_lexicon_string_row", "XML-DUMP-LEXICON-STRING-ROW", 3, 1, false);
        declareFunction(me, "contextually_dependent_entryP", "CONTEXTUALLY-DEPENDENT-ENTRY?", 1, 0, false);
        declareFunction(me, "vanishingly_rare_entryP", "VANISHINGLY-RARE-ENTRY?", 1, 0, false);
        declareFunction(me, "primary_entryP", "PRIMARY-ENTRY?", 1, 0, false);
        declareFunction(me, "xml_output_concept", "XML-OUTPUT-CONCEPT", 1, 1, false);
        declareFunction(me, "thing_describable_as_lex_p", "THING-DESCRIBABLE-AS-LEX-P", 1, 0, false);
        declareFunction(me, "dump_isa_genls", "DUMP-ISA-GENLS", 0, 2, false);
        declareFunction(me, "write_one_complete_fort_record_compactly", "WRITE-ONE-COMPLETE-FORT-RECORD-COMPACTLY", 1, 3, false);
        declareFunction(me, "write_one_fort_compactly", "WRITE-ONE-FORT-COMPACTLY", 2, 1, false);
        return NIL;
    }
