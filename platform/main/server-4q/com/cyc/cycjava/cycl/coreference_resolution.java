...
import com.cyc.cycjava.cycl.coreference_resolution;
...
import static com.cyc.cycjava.cycl.coreference_resolution.*;
...
public final class coreference_resolution extends SubLTranslatedFile {
    ...
    public static SubLObject coreference_resolution_discourse_struct_p(final SubLObject v_object) {
        return v_object.getClass() == coreference_resolution.$coreference_resolution_discourse_struct_native.class ? T : NIL;
    }

    public static SubLObject crd_implementation(final SubLObject v_object) {
        assert NIL != coreference_resolution_discourse_struct_p(v_object) : "coreference_resolution.coreference_resolution_discourse_struct_p(v_object) " + "CommonSymbols.NIL != coreference_resolution.coreference_resolution_discourse_struct_p(v_object) " + v_object;
    ...
    public static SubLObject make_coreference_resolution_discourse_struct(SubLObject arglist) {
        ...
        final SubLObject v_new = new coreference_resolution.$coreference_resolution_discourse_struct_native();
        SubLObject next;
    ...
    public static SubLObject reference_info_p(final SubLObject v_object) {
        return v_object.getClass() == coreference_resolution.$reference_info_native.class ? T : NIL;
    }

    public static SubLObject reference_info_index_number(final SubLObject v_object) {
        assert NIL != reference_info_p(v_object) : "coreference_resolution.reference_info_p(v_object) " + "CommonSymbols.NIL != coreference_resolution.reference_info_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_reference_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new coreference_resolution.$reference_info_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject referent_struct_p(final SubLObject v_object) {
        return v_object.getClass() == coreference_resolution.$referent_struct_native.class ? T : NIL;
    }

    public static SubLObject referent_struct_references(final SubLObject v_object) {
        assert NIL != referent_struct_p(v_object) : "coreference_resolution.referent_struct_p(v_object) " + "CommonSymbols.NIL != coreference_resolution.referent_struct_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_referent_struct(SubLObject arglist) {
        ...
        final SubLObject v_new = new coreference_resolution.$referent_struct_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $coreference_resolution_discourse_struct_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(coreference_resolution.$coreference_resolution_discourse_struct_native.class, COREFERENCE_RESOLUTION_DISCOURSE_STRUCT, COREFERENCE_RESOLUTION_DISCOURSE_STRUCT_P, $list2, $list3, new String[]{ "$implementation", "$parser", "$use_pspP", "$max_sufficient_recentness", "$max_possible_antecedents", "$max_sufficient_recentness_for_gendered_pronoun", "$max_possible_antecedents_for_gendered_pronoun", "$reference_note_hash", "$recent_references", "$sentences" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $referent_struct_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(coreference_resolution.$referent_struct_native.class, REFERENT_STRUCT, REFERENT_STRUCT_P, $list171, $list172, new String[]{ "$references", "$equals", "$types", "$facts", "$gender", "$number" }, $list173, $list174, PRINT_REFERENT_STRUCT);
        }
    }
