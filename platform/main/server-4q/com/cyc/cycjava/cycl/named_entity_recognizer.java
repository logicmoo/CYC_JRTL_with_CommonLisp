...
import static com.cyc.tool.subl.jrtl.translatedCode.sublisp.streams_high.read_line_with_timeout;
...
public final class named_entity_recognizer extends SubLTranslatedFile {
	...
	public static final SubLList $list2 = list(new SubLObject[] { list(makeSymbol("STRING"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("TYPE"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("SOURCE"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("CYC"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")),
			list(makeSymbol("CONFIDENCE"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-STRING"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-TYPE"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SOURCE"), NIL, makeKeyword("PUBLIC")),
			list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-CYC"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-CONFIDENCE"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT"), list(makeSymbol("STREAM"), makeSymbol("DEPTH")), makeKeyword("PROTECTED")) });
	...
	public static final SubLList $list16 = list(makeString("Prints this named entity to STREAM, ignoring DEPTH"), list(makeSymbol("IGNORE"), makeSymbol("DEPTH")), list(makeSymbol("WRITE-STRING"), makeString("#<NE: "), makeSymbol("STREAM")), list(makeSymbol("WRITE-STRING"), makeSymbol("STRING"), makeSymbol("STREAM")), list(makeSymbol("WRITE-STRING"), makeString("/"), makeSymbol("STREAM")),
			list(makeSymbol("PRINC"), makeSymbol("TYPE"), makeSymbol("STREAM")), list(makeSymbol("WRITE-STRING"), makeString(">"), makeSymbol("STREAM")), list(makeSymbol("RET"), makeSymbol("SELF")));
	...
	public static final SubLList $list44 = list(new SubLObject[] { list(makeSymbol("LEXICON"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("CONTEXT"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("OFFSETS"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("SUBTYPES"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")),
			list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-LEXICON"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-LEXICON"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-CONTEXT"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-OFFSETS"), NIL, makeKeyword("PUBLIC")),
			list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("TIGHTEN-TYPE"), NIL, makeKeyword("PUBLIC")) });
	...
	public static final SubLList $list64 = list(list(new SubLObject[] { makeSymbol("CLET"),
			list(new SubLObject[] { list(makeSymbol("PARSER"), list(makeSymbol("NEW-STANFORD-PARSER"))), list(makeSymbol("QUESTION-WORD"), list(makeSymbol("FIF"), list(EQL, makeSymbol("CYC"), reader_make_constant_shell(makeString("Person"))), makeString("Who"), makeString("What"))),
					list(makeSymbol("QUESTION-STRING"), list(makeSymbol("BUNGE"), list(makeSymbol("LIST"), makeSymbol("QUESTION-WORD"), makeString("is"), list(makeSymbol("CCONCATENATE"), makeSymbol("STRING"), makeString("?"))))), list(makeSymbol("QUESTION-PARSE"), list(makeSymbol("FIM"), makeSymbol("PARSER"), list(makeSymbol("QUOTE"), makeSymbol("PARSE")), makeSymbol("QUESTION-STRING"))),
					list(makeSymbol("QUESTION"), list(makeSymbol("NEW-CLASS-INSTANCE"), list(makeSymbol("QUOTE"), makeSymbol("DEFINITIONAL-QUESTION")))), list(makeSymbol("PASSAGE"), list(makeSymbol("NEW-SIMPLE-PASSAGE"), makeSymbol("CONTEXT"))), list(makeSymbol("LEXICON"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET-LEXICON")))), makeSymbol("ANSWERS"),
					makeSymbol("TIGHTER-TYPES"), makeSymbol("ANSWER-STRINGS"), list(makeSymbol("ENTITY-STRING"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET-STRING")))) }),
			list(makeSymbol("SET-QUESTION-STRING"), makeSymbol("QUESTION"), makeSymbol("QUESTION-STRING")), list(makeSymbol("PWHEN"), makeSymbol("QUESTION-PARSE"), list(makeSymbol("FIM"), makeSymbol("QUESTION-PARSE"), list(makeSymbol("QUOTE"), makeSymbol("LEXIFY")), makeSymbol("LEXICON"))), list(makeSymbol("SET-QUESTION-PARSE"), makeSymbol("QUESTION"), makeSymbol("QUESTION-PARSE")),
			list(makeSymbol("CSETQ"), makeSymbol("ANSWERS"), list(makeSymbol("FIM"), makeSymbol("QUESTION"), list(makeSymbol("QUOTE"), makeSymbol("EXTRACT")), makeSymbol("PASSAGE"))),
			list(makeSymbol("PWHEN"), list(makeSymbol("CNOT"), list(EQL, makeSymbol("CYC"), reader_make_constant_shell(makeString("Organization")))), list(makeSymbol("CPUSH"), list(makeSymbol("NEW-TEXT-ANSWER"), makeSymbol("QUESTION"), makeSymbol("ENTITY-STRING"), list(makeSymbol("NEW-SIMPLE-PASSAGE"), makeSymbol("ENTITY-STRING")), ONE_INTEGER), makeSymbol("ANSWERS"))),
			list(makeSymbol("WITH-POSSIBLY-NEW-MEMOIZATION-STATE"), list(makeSymbol("CDOLIST"), list(makeSymbol("ANSWER"), makeSymbol("ANSWERS")), list(makeSymbol("CLET"), list(list(makeSymbol("ANSWER-STRING"), list(makeSymbol("FIM"), makeSymbol("ANSWER"), list(makeSymbol("QUOTE"), makeSymbol("GET-CONTENT"))))), list(makeSymbol("PUNLESS"),
					list(makeSymbol("CAND"), list(makeSymbol("CNOT"), list(makeSymbol("SUBSTRING?"), makeSymbol("ANSWER-STRING"), makeSymbol("ENTITY-STRING"))),
							list(makeSymbol("COR"), list(makeSymbol("ENDS-WITH-START-OF"), makeSymbol("ENTITY-STRING"), makeSymbol("ANSWER-STRING"), list(makeSymbol("QUOTE"), EQUAL), list(makeSymbol("QUOTE"), list(makeString(" ")))), list(makeSymbol("ENDS-WITH-START-OF"), makeSymbol("ANSWER-STRING"), makeSymbol("ENTITY-STRING"), list(makeSymbol("QUOTE"), EQUAL), list(makeSymbol("QUOTE"), list(makeString(" ")))))),
					list(makeSymbol("CMULTIPLE-VALUE-BIND"), list(makeSymbol("NEW-TIGHTER-TYPES"), makeSymbol("ANSWER-STRING")), list(makeSymbol("TIGHTER-TYPES-FROM-ANSWER"), makeSymbol("ANSWER"), makeSymbol("LEXICON"), makeSymbol("ENTITY-STRING"), list(makeSymbol("FWHEN"), makeSymbol("RESPECT-NER-TYPE?"), makeSymbol("CYC")), makeSymbol("LEXICAL-LOOKUP-ONLY?")),
							list(makeSymbol("CPUSH"), makeSymbol("ANSWER-STRING"), makeSymbol("ANSWER-STRINGS")), list(makeSymbol("CSETQ"), makeSymbol("TIGHTER-TYPES"), list(makeSymbol("UNION"), makeSymbol("TIGHTER-TYPES"), makeSymbol("NEW-TIGHTER-TYPES")))))))),
			list(makeSymbol("CSETQ"), makeSymbol("SUBTYPES"), makeSymbol("TIGHTER-TYPES")), list(makeSymbol("RET"), list(makeSymbol("LIST"), makeSymbol("TIGHTER-TYPES"), makeSymbol("ANSWER-STRINGS"))) }));
	...
	public static final SubLList $list98 = list(
			list(makeSymbol("TYPE-MAP"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"),
					list(makeSymbol("QUOTE"), list(cons(makeSymbol("PERSON"), reader_make_constant_shell(makeString("Person"))), cons(makeSymbol("ORGANIZATION"), reader_make_constant_shell(makeString("Organization"))), cons(makeSymbol("LOCATION"), reader_make_constant_shell(makeString("Place"))), cons(makeSymbol("DATE"), reader_make_constant_shell(makeString("Date")))))),
			list(makeSymbol("KNOWN-CYC-TYPES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("Person")), reader_make_constant_shell(makeString("Organization")), reader_make_constant_shell(makeString("Place")), reader_make_constant_shell(makeString("Date"))))),
			list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("TO-CYC"), list(makeSymbol("TYPE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("RUN"), list(makeSymbol("STRING")), makeKeyword("PUBLIC")));
	...
	private static final SubLList $list111 = list(makeString("Returns the entities recognized by this Stanford named-entity recognizer"), list(makeSymbol("CHECK-TYPE"), makeSymbol("TEXT"), makeSymbol("STRINGP")),
			list(makeSymbol("CLET"), list(list(makeSymbol("STANFORD-TOKENS"), list(makeSymbol("STANFORD-NER"), makeSymbol("TEXT"))), list(makeSymbol("LATEST-STRING"), list(makeSymbol("FIRST"), makeSymbol("STANFORD-TOKENS"))), list(makeSymbol("LATEST-TYPE"), list(makeSymbol("INTERN"), list(makeSymbol("SECOND"), makeSymbol("STANFORD-TOKENS")))), list(makeSymbol("ENTITIES"), NIL)),
					list(makeSymbol("CDO"),
							list(list(makeSymbol("TOKENS"), list(makeSymbol("CDDR"), makeSymbol("STANFORD-TOKENS")), list(makeSymbol("CDDR"), makeSymbol("TOKENS"))), list(makeSymbol("STRING"), list(makeSymbol("FIRST"), makeSymbol("TOKENS")), list(makeSymbol("FIRST"), makeSymbol("TOKENS"))),
									list(makeSymbol("TYPE"), list(makeSymbol("INTERN"), list(makeSymbol("SECOND"), makeSymbol("TOKENS"))), list(makeSymbol("INTERN"), list(makeSymbol("SECOND"), makeSymbol("TOKENS"))))),
							list(list(makeSymbol("NULL"), makeSymbol("TOKENS"))),
							list(makeSymbol("PCOND"), list(list(makeSymbol("CAND"), list(EQL, makeSymbol("TYPE"), makeSymbol("LATEST-TYPE")), list(makeSymbol("CNOT"), list(EQL, list(makeSymbol("QUOTE"), makeSymbol("O")), makeSymbol("TYPE")))), list(makeSymbol("CSETQ"), makeSymbol("LATEST-STRING"), list(makeSymbol("BUILD-MWL"), makeSymbol("LATEST-STRING"), makeSymbol("STRING")))),
									list(T, list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), list(makeSymbol("NEW-CONTEXTUALIZED-NAMED-ENTITY"), makeSymbol("LATEST-STRING"), makeSymbol("LATEST-TYPE"), makeSymbol("SELF"), makeSymbol("TEXT"), NIL, NIL, list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("TO-CYC")), makeSymbol("LATEST-TYPE")))), makeSymbol("ENTITIES")),
											list(makeSymbol("CSETQ"), makeSymbol("LATEST-STRING"), makeSymbol("STRING"), makeSymbol("LATEST-TYPE"), makeSymbol("TYPE"))))),
					list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), list(makeSymbol("NEW-CONTEXTUALIZED-NAMED-ENTITY"), makeSymbol("LATEST-STRING"), makeSymbol("LATEST-TYPE"), makeSymbol("SELF"), makeSymbol("TEXT"), NIL, NIL, list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("TO-CYC")), makeSymbol("LATEST-TYPE")))), makeSymbol("ENTITIES")),
					list(makeSymbol("RET"), list(makeSymbol("NREVERSE"), makeSymbol("ENTITIES")))));
	...
	private static final SubLList $list117 = list(makeString("Merges clusters that the Stanford NER doesn\'t merge appropriately.  In particular, this merges \n   CITY, STATE cluster, since the NER returns <CITY/PLACE> <,/O> <STATE/PLACE> for things like\n   \'Austin, Texas\', and returns <CITY/PLACE> <,/O> <STATE/ORGANIZATION> for things like \'Austin, TX\'"), list(makeSymbol("IGNORE"), makeSymbol("LEXICON")),
			list(makeSymbol("CLET"), list(list(makeSymbol("NEW-CLUSTERS")), makeSymbol("PREV-NE"), makeSymbol("ANTE-PREV-NE")),
					list(makeSymbol("CDOLIST-NUMBERED"), list(makeSymbol("CLUSTER"), makeSymbol("CLUSTER-NUM"), makeSymbol("CLUSTERS")),
							list(makeSymbol("CLET"), list(list(makeSymbol("NE"), list(makeSymbol("FIRST"), makeSymbol("CLUSTER")))),
									list(makeSymbol("PCOND"),
											list(list(makeSymbol("CAND"), makeSymbol("PREV-NE"), makeSymbol("ANTE-PREV-NE"), list(EQUAL, list(makeSymbol("FIM"), makeSymbol("NE"), list(makeSymbol("QUOTE"), makeSymbol("GET-CYC"))), reader_make_constant_shell(makeString("Place"))), list(EQUAL, makeString(","), list(makeSymbol("FIM"), makeSymbol("PREV-NE"), list(makeSymbol("QUOTE"), makeSymbol("GET-STRING")))),
													list(EQUAL, list(makeSymbol("FIM"), makeSymbol("ANTE-PREV-NE"), list(makeSymbol("QUOTE"), makeSymbol("GET-CYC"))), reader_make_constant_shell(makeString("Place"))), list(makeSymbol("NE-HAS-STATE-DENOT?"), makeSymbol("LEXICON"), makeSymbol("NE")), list(makeSymbol("CNOT"), list(makeSymbol("NE-HAS-STATE-DENOT?"), makeSymbol("LEXICON"), makeSymbol("ANTE-PREV-NE")))),
													list(makeSymbol("CLET"),
															list(list(makeSymbol("NEW-STRING"), list(makeSymbol("FORMAT-NIL"), makeString("~A, ~A"), list(makeSymbol("FIM"), makeSymbol("ANTE-PREV-NE"), list(makeSymbol("QUOTE"), makeSymbol("GET-STRING"))), list(makeSymbol("FIM"), makeSymbol("NE"), list(makeSymbol("QUOTE"), makeSymbol("GET-STRING"))))),
																	list(makeSymbol("TYPE"), list(makeSymbol("QUOTE"), makeSymbol("LOCATION"))), list(makeSymbol("TEXT"), list(makeSymbol("GET-SLOT"), makeSymbol("NE"), list(makeSymbol("QUOTE"), makeSymbol("CONTEXT"))))),
															list(makeSymbol("CSETQ"), makeSymbol("PREV-NE"), list(makeSymbol("NEW-CONTEXTUALIZED-NAMED-ENTITY"), makeSymbol("NEW-STRING"), makeSymbol("TYPE"), makeSymbol("SELF"), makeSymbol("TEXT"), NIL, NIL, list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("TO-CYC")), makeSymbol("TYPE")))),
															list(makeSymbol("CSETQ"), makeSymbol("ANTE-PREV-NE"), list(makeSymbol("CAAR"), makeSymbol("NEW-CLUSTERS"))), list(makeSymbol("CPOP"), makeSymbol("NEW-CLUSTERS")))),
											list(T, list(makeSymbol("PWHEN"), makeSymbol("ANTE-PREV-NE"), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("ANTE-PREV-NE")), makeSymbol("NEW-CLUSTERS"))), list(makeSymbol("CSETQ"), makeSymbol("ANTE-PREV-NE"), makeSymbol("PREV-NE"), makeSymbol("PREV-NE"), makeSymbol("NE")))))),
					list(makeSymbol("PWHEN"), makeSymbol("ANTE-PREV-NE"), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("ANTE-PREV-NE")), makeSymbol("NEW-CLUSTERS"))), list(makeSymbol("PWHEN"), makeSymbol("PREV-NE"), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("PREV-NE")), makeSymbol("NEW-CLUSTERS"))),
					list(makeSymbol("RET"), list(makeSymbol("NREVERSE"), makeSymbol("NEW-CLUSTERS")))));
	...
	private static final SubLList $list137 = list(makeString("Returns the entities recognized by this resporator"), list(makeSymbol("CHECK-TYPE"), makeSymbol("TEXT"), makeSymbol("STRINGP")),
			list(makeSymbol("CLET"), list(list(makeSymbol("ENTITIES"), NIL)),
					list(makeSymbol("CDO"),
							list(list(makeSymbol("TOKENS"), list(makeSymbol("RESPORATOR"), makeSymbol("TEXT")), list(makeSymbol("NTHCDR"), makeSymbol("CARD"), makeSymbol("TOKENS"))),
									list(makeSymbol("ENTITY"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("NEXT-RESPORATOR-ENTITY")), makeSymbol("TOKENS")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("NEXT-RESPORATOR-ENTITY")), makeSymbol("TOKENS"))),
									list(makeSymbol("CARD"), list(makeSymbol("LENGTH"), makeSymbol("ENTITY")), list(makeSymbol("LENGTH"), makeSymbol("ENTITY")))),
							list(list(makeSymbol("NULL"), makeSymbol("ENTITY"))), list(makeSymbol("CPUSH"), makeSymbol("ENTITY"), makeSymbol("ENTITIES"))),
					list(makeSymbol("RET"), list(makeSymbol("NREVERSE"), makeSymbol("ENTITIES")))));
	...
	public static final SubLList $list142 = list(makeString("@param TOKENS listp;\n   @return listp; a disjunctively interpreted list of named-entity, all with the same\n   string and different types, resulting from a single occurrence in the input text"), list(makeSymbol("PUNLESS"), makeSymbol("TOKENS"), list(makeSymbol("RET"), NIL)),
			list(makeSymbol("CLET"),
					list(list(makeSymbol("FIRST"), list(makeSymbol("FIRST"), makeSymbol("TOKENS"))), list(makeSymbol("DISJUNCTION"), list(makeSymbol("LIST"), list(makeSymbol("NEW-NAMED-ENTITY"), list(makeSymbol("CDR"), makeSymbol("FIRST")), list(makeSymbol("CAR"), makeSymbol("FIRST")), makeSymbol("SELF"), NIL, list(makeSymbol("RESPORATOR-TO-CYCL"), list(makeSymbol("CAR"), makeSymbol("FIRST")))))),
							list(makeSymbol("TYPE"), list(makeSymbol("CAR"), makeSymbol("FIRST"))), list(makeSymbol("STRING"), list(makeSymbol("CDR"), makeSymbol("FIRST"))), list(makeSymbol("TYPES-SO-FAR"), list(makeSymbol("LIST"), makeSymbol("TYPE")))),
					list(makeSymbol("CDOLIST"), list(makeSymbol("TYPE.STRING"), list(makeSymbol("CDR"), makeSymbol("TOKENS"))),
							list(makeSymbol("PWHEN"), list(makeSymbol("COR"), list(makeSymbol("CNOT"), list(EQUAL, list(makeSymbol("CDR"), makeSymbol("TYPE.STRING")), makeSymbol("STRING"))), list(makeSymbol("MEMBER"), list(makeSymbol("CAR"), makeSymbol("TYPE.STRING")), makeSymbol("TYPES-SO-FAR"))), list(makeSymbol("RET"), makeSymbol("DISJUNCTION"))),
							list(makeSymbol("CPUSH"), list(makeSymbol("NEW-NAMED-ENTITY"), list(makeSymbol("CDR"), makeSymbol("TYPE.STRING")), list(makeSymbol("CAR"), makeSymbol("TYPE.STRING")), makeSymbol("SELF"), NIL, list(makeSymbol("RESPORATOR-TO-CYCL"), list(makeSymbol("CAR"), makeSymbol("TYPE.STRING")))), makeSymbol("DISJUNCTION")),
							list(makeSymbol("CPUSH"), list(makeSymbol("CAR"), makeSymbol("TYPE.STRING")), makeSymbol("TYPES-SO-FAR"))),
					list(makeSymbol("RET"), makeSymbol("DISJUNCTION"))));
	...
	private static final SubLList $list167 = list(new SubLObject[] {
			list(list(makeString("Canadian linguist George Lakoff lives in the woods"), makeString("George Lakoff"), reader_make_constant_shell(makeString("Person"))),
					list(makeKeyword("OR"), list(reader_make_constant_shell(makeString("CollectionIntersection2Fn")), list(makeKeyword("OR"), list(reader_make_constant_shell(makeString("CitizenFn")), reader_make_constant_shell(makeString("Canada"))), reader_make_constant_shell(makeString("CanadianPerson"))), reader_make_constant_shell(makeString("Linguist"))),
							list(reader_make_constant_shell(makeString("CollectionIntersection2Fn")), reader_make_constant_shell(makeString("Linguist")), list(makeKeyword("OR"), list(reader_make_constant_shell(makeString("CitizenFn")), reader_make_constant_shell(makeString("Canada"))), reader_make_constant_shell(makeString("CanadianPerson")))))),
			list(list(makeString("British chef Paul Cunningham opened a new restaurant last week"), makeString("Paul Cunningham"), reader_make_constant_shell(makeString("Person"))),
					list(makeKeyword("OR"), list(reader_make_constant_shell(makeString("CollectionIntersection2Fn")), reader_make_constant_shell(makeString("BritishPerson")), reader_make_constant_shell(makeString("Chef"))),
							list(reader_make_constant_shell(makeString("CollectionIntersection2Fn")), reader_make_constant_shell(makeString("Chef")), list(reader_make_constant_shell(makeString("CitizenFn")), reader_make_constant_shell(makeString("UnitedKingdomOfGreatBritainAndNorthernIreland")))),
							list(reader_make_constant_shell(makeString("CollectionIntersection2Fn")), list(reader_make_constant_shell(makeString("CitizenFn")), reader_make_constant_shell(makeString("UnitedKingdomOfGreatBritainAndNorthernIreland"))), reader_make_constant_shell(makeString("Chef"))))),
			list(list(makeString("Ranasinghe Premadasa - President of Sri Lanka - was assassinated."), makeString("Ranasinghe Premadasa"), reader_make_constant_shell(makeString("Person"))),
					list(reader_make_constant_shell(makeString("SubcollectionOfWithRelationFromFn")), list(makeKeyword("OR"), reader_make_constant_shell(makeString("Person")), reader_make_constant_shell(makeString("PresidentOfOrganization"))), reader_make_constant_shell(makeString("president")), reader_make_constant_shell(makeString("SriLanka")))),
			list(list(makeString("Ranasinghe Premadasa, President of Sri Lanka, was assassinated."), makeString("Ranasinghe Premadasa"), reader_make_constant_shell(makeString("Person"))),
					list(reader_make_constant_shell(makeString("SubcollectionOfWithRelationFromFn")), list(makeKeyword("OR"), reader_make_constant_shell(makeString("Person")), reader_make_constant_shell(makeString("PresidentOfOrganization"))), reader_make_constant_shell(makeString("president")), reader_make_constant_shell(makeString("SriLanka")))),
			list(list(makeString("Ranasinghe Premadasa (President of Sri Lanka) was assassinated."), makeString("Ranasinghe Premadasa"), reader_make_constant_shell(makeString("Person"))),
					list(reader_make_constant_shell(makeString("SubcollectionOfWithRelationFromFn")), list(makeKeyword("OR"), reader_make_constant_shell(makeString("Person")), reader_make_constant_shell(makeString("PresidentOfOrganization"))), reader_make_constant_shell(makeString("president")), reader_make_constant_shell(makeString("SriLanka")))),
			list(list(makeString("In 2004 he released Spooked, which was recorded with country/folk duo Gillian Welch and David Rawlings."), makeString("country/folk duo"), NIL),
					list(reader_make_constant_shell(makeString("SubcollectionOfWithRelationToFn")), reader_make_constant_shell(makeString("Duo-MusicalPerformanceGroup")), reader_make_constant_shell(makeString("institutionalFocus")), reader_make_constant_shell(makeString("FolkMusic")))),
			list(list(makeString("He is undergoing a medial septal myectomy."), makeString("medial septal myectomy"), NIL), reader_make_constant_shell(makeString("SeptalMyectomy"))),
			list(list(makeString("Salle Moulay Abdellah is an indoor sporting arena located in Rabat, Morocco. The capacity of the arena is 10,000 people."), makeString("Salle Moulay Abdellah"), NIL), reader_make_constant_shell(makeString("Stadium"))),
			list(list(makeString("The Hazaras even boasted a prime minister, Sultan Ali Keshtmand, in the mid-1980s."), makeString("Sultan Ali Keshtmand"), reader_make_constant_shell(makeString("Person"))), reader_make_constant_shell(makeString("PrimeMinister-HeadOfGovernment"))),
			list(list(makeString("Assadullah Sarwari replaced him with a Banner leader, Sultan Ali Keshtmand."), makeString("Sultan Ali Keshtmand"), reader_make_constant_shell(makeString("Person"))), reader_make_constant_shell(makeString("Leader"))) });
	...
	public static SubLObject stanford_ner_ping(SubLObject host, SubLObject port) {
		...
		try {
			...
			try {
				Errors.$error_handler$.bind(CATCH_ERROR_MESSAGE_HANDLER, thread);
				try {
					final SubLInteger timeoutMS = SubLObjectFactory.makeInteger(10000);
					stanford_ner_with_timout_out($str131$The_cat_sat_on_the_mat_, host, port, timeoutMS);
				} catch (final Throwable catch_var) {
					Errors.handleThrowable(catch_var, NIL);
				}
			} finally {
	...
	public static SubLObject stanford_ner(final SubLObject string, SubLObject host, SubLObject port) {
		return stanford_ner_with_timout_out(string, host, port, UNPROVIDED);
	}

	public static SubLObject stanford_ner_with_timout_out(final SubLObject string, SubLObject host, SubLObject port, SubLObject maxTime) {
		if (host == UNPROVIDED) {
			host = $stanford_ner_host$.getDynamicValue();
		}
		if (port == UNPROVIDED) {
		...
		try {
			...
			if (NIL != validate_tcp_connection(stream, host, port)) {
				...
				try {
					final SubLObject read_line = read_line_with_timeout(stream, UNPROVIDED, UNPROVIDED, UNPROVIDED, makeInteger(10000));
