...
public final class czer_graph extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol V_COLOUR = makeSymbol("V-COLOUR");

    public static final SubLSymbol V_COLOUR_P = makeSymbol("V-COLOUR-P");
    ...
    public static final SubLSymbol V_COLOUR_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("V-COLOUR-PRINT-FUNCTION-TRAMPOLINE");
    ...
    private static final SubLList $list34 = list(makeKeyword("HEAD"), makeKeyword("COLOUR"));
    ...
    public static SubLObject v_colour_p(final SubLObject v_object) {
        return v_object.getClass() == czer_graph.$v_colour_native.class ? T : NIL;
    }

    public static SubLObject v_colour_sorted_constant_list(final SubLObject v_object) {
        assert NIL != v_colour_p(v_object) : "czer_graph.v_colour_p(v_object) " + "CommonSymbols.NIL != czer_graph.v_colour_p(v_object) " + v_object;
    ...
    public static SubLObject make_v_colour(SubLObject arglist) {
        ...
        final SubLObject v_new = new czer_graph.$v_colour_native();
        SubLObject next;
    ...
    public static SubLObject arc_p(final SubLObject v_object) {
        return v_object.getClass() == czer_graph.$arc_native.class ? T : NIL;
    }

    public static SubLObject arc_head(final SubLObject v_object) {
        assert NIL != arc_p(v_object) : "czer_graph.arc_p(v_object) " + "CommonSymbols.NIL != czer_graph.arc_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_arc(SubLObject arglist) {
        ...
        final SubLObject v_new = new czer_graph.$arc_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject vertex_p(final SubLObject v_object) {
        return v_object.getClass() == czer_graph.$vertex_native.class ? T : NIL;
    }

    public static SubLObject vertex_id(final SubLObject v_object) {
        assert NIL != vertex_p(v_object) : "czer_graph.vertex_p(v_object) " + "CommonSymbols.NIL != czer_graph.vertex_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_vertex(SubLObject arglist) {
        ...
        final SubLObject v_new = new czer_graph.$vertex_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject graph_search_node_p(final SubLObject v_object) {
        return v_object.getClass() == czer_graph.$graph_search_node_native.class ? T : NIL;
    }

    public static SubLObject graph_search_node_vertex(final SubLObject v_object) {
        assert NIL != graph_search_node_p(v_object) : "czer_graph.graph_search_node_p(v_object) " + "CommonSymbols.NIL != czer_graph.graph_search_node_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_graph_search_node(SubLObject arglist) {
        ...
        final SubLObject v_new = new czer_graph.$graph_search_node_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject declare_czer_graph_file() {
        declareFunction(me, "v_colour_print_function_trampoline", "V-COLOUR-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "v_colour_p", "V-COLOUR-P", 1, 0, false);
        new czer_graph.$v_colour_p$UnaryFunction();
        declareFunction(me, "v_colour_sorted_constant_list", "V-COLOUR-SORTED-CONSTANT-LIST", 1, 0, false);
        declareFunction(me, "v_colour_sorted_nat_list", "V-COLOUR-SORTED-NAT-LIST", 1, 0, false);
        declareFunction(me, "v_colour_sorted_assertion_list", "V-COLOUR-SORTED-ASSERTION-LIST", 1, 0, false);
        declareFunction(me, "v_colour_list_structure", "V-COLOUR-LIST-STRUCTURE", 1, 0, false);
        declareFunction(me, "v_colour_sorted_var_positions", "V-COLOUR-SORTED-VAR-POSITIONS", 1, 0, false);
        declareFunction(me, "_csetf_v_colour_sorted_constant_list", "_CSETF-V-COLOUR-SORTED-CONSTANT-LIST", 2, 0, false);
        declareFunction(me, "_csetf_v_colour_sorted_nat_list", "_CSETF-V-COLOUR-SORTED-NAT-LIST", 2, 0, false);
        declareFunction(me, "_csetf_v_colour_sorted_assertion_list", "_CSETF-V-COLOUR-SORTED-ASSERTION-LIST", 2, 0, false);
        declareFunction(me, "_csetf_v_colour_list_structure", "_CSETF-V-COLOUR-LIST-STRUCTURE", 2, 0, false);
        declareFunction(me, "_csetf_v_colour_sorted_var_positions", "_CSETF-V-COLOUR-SORTED-VAR-POSITIONS", 2, 0, false);
        declareFunction(me, "make_v_colour", "MAKE-V-COLOUR", 0, 1, false);
        declareFunction(me, "visit_defstruct_v_colour", "VISIT-DEFSTRUCT-V-COLOUR", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_v_colour_method", "VISIT-DEFSTRUCT-OBJECT-V-COLOUR-METHOD", 2, 0, false);
        declareFunction(me, "v_colour_as_list", "V-COLOUR-AS-LIST", 1, 0, false);
        declareFunction(me, "v_colour_min", "V-COLOUR-MIN", 1, 0, false);
        declareFunction(me, "arc_print_function_trampoline", "ARC-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "arc_p", "ARC-P", 1, 0, false);
        new czer_graph.$arc_p$UnaryFunction();
        declareFunction(me, "arc_head", "ARC-HEAD", 1, 0, false);
        declareFunction(me, "arc_colour", "ARC-COLOUR", 1, 0, false);
        declareFunction(me, "_csetf_arc_head", "_CSETF-ARC-HEAD", 2, 0, false);
        declareFunction(me, "_csetf_arc_colour", "_CSETF-ARC-COLOUR", 2, 0, false);
        declareFunction(me, "make_arc", "MAKE-ARC", 0, 1, false);
        declareFunction(me, "visit_defstruct_arc", "VISIT-DEFSTRUCT-ARC", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_arc_method", "VISIT-DEFSTRUCT-OBJECT-ARC-METHOD", 2, 0, false);
        declareFunction(me, "print_arc", "PRINT-ARC", 3, 0, false);
        declareFunction(me, "new_arc", "NEW-ARC", 2, 0, false);
        declareFunction(me, "arc_as_sortable_list", "ARC-AS-SORTABLE-LIST", 1, 0, false);
        declareFunction(me, "arc_as_unifiable_list", "ARC-AS-UNIFIABLE-LIST", 1, 0, false);
        declareFunction(me, "colour_arc", "COLOUR-ARC", 3, 0, false);
        declareFunction(me, "vertex_print_function_trampoline", "VERTEX-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "vertex_p", "VERTEX-P", 1, 0, false);
        new czer_graph.$vertex_p$UnaryFunction();
        declareFunction(me, "vertex_id", "VERTEX-ID", 1, 0, false);
        declareFunction(me, "vertex_colour", "VERTEX-COLOUR", 1, 0, false);
        declareFunction(me, "vertex_arc_set", "VERTEX-ARC-SET", 1, 0, false);
        declareFunction(me, "_csetf_vertex_id", "_CSETF-VERTEX-ID", 2, 0, false);
        declareFunction(me, "_csetf_vertex_colour", "_CSETF-VERTEX-COLOUR", 2, 0, false);
        declareFunction(me, "_csetf_vertex_arc_set", "_CSETF-VERTEX-ARC-SET", 2, 0, false);
        declareFunction(me, "make_vertex", "MAKE-VERTEX", 0, 1, false);
        declareFunction(me, "visit_defstruct_vertex", "VISIT-DEFSTRUCT-VERTEX", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_vertex_method", "VISIT-DEFSTRUCT-OBJECT-VERTEX-METHOD", 2, 0, false);
        declareFunction(me, "print_vertex", "PRINT-VERTEX", 3, 0, false);
        declareFunction(me, "find_vertex_by_id", "FIND-VERTEX-BY-ID", 2, 0, false);
        declareFunction(me, "vertex_as_sortable_list", "VERTEX-AS-SORTABLE-LIST", 1, 0, false);
        declareFunction(me, "vertex_as_unifiable_list", "VERTEX-AS-UNIFIABLE-LIST", 1, 0, false);
        declareFunction(me, "vertex_first_half_as_sortable_list", "VERTEX-FIRST-HALF-AS-SORTABLE-LIST", 1, 0, false);
        declareFunction(me, "vertex_first_half_as_unifiable_list", "VERTEX-FIRST-HALF-AS-UNIFIABLE-LIST", 1, 0, false);
        declareFunction(me, "vertex_second_half_as_sortable_set", "VERTEX-SECOND-HALF-AS-SORTABLE-SET", 1, 0, false);
        declareFunction(me, "vertex_second_half_as_unifiable_set", "VERTEX-SECOND-HALF-AS-UNIFIABLE-SET", 1, 0, false);
        declareFunction(me, "vertex_add_arc", "VERTEX-ADD-ARC", 3, 0, false);
        declareFunction(me, "colour_vertex", "COLOUR-VERTEX", 2, 0, false);
        declareFunction(me, "new_vertex", "NEW-VERTEX", 3, 0, false);
        declareFunction(me, "graph_search_node_print_function_trampoline", "GRAPH-SEARCH-NODE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "graph_search_node_p", "GRAPH-SEARCH-NODE-P", 1, 0, false);
        new czer_graph.$graph_search_node_p$UnaryFunction();
        declareFunction(me, "graph_search_node_vertex", "GRAPH-SEARCH-NODE-VERTEX", 1, 0, false);
        declareFunction(me, "graph_search_node_search_history", "GRAPH-SEARCH-NODE-SEARCH-HISTORY", 1, 0, false);
        declareFunction(me, "_csetf_graph_search_node_vertex", "_CSETF-GRAPH-SEARCH-NODE-VERTEX", 2, 0, false);
        declareFunction(me, "_csetf_graph_search_node_search_history", "_CSETF-GRAPH-SEARCH-NODE-SEARCH-HISTORY", 2, 0, false);
        declareFunction(me, "make_graph_search_node", "MAKE-GRAPH-SEARCH-NODE", 0, 1, false);
        declareFunction(me, "visit_defstruct_graph_search_node", "VISIT-DEFSTRUCT-GRAPH-SEARCH-NODE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_graph_search_node_method", "VISIT-DEFSTRUCT-OBJECT-GRAPH-SEARCH-NODE-METHOD", 2, 0, false);
        declareFunction(me, "print_graph_search_node", "PRINT-GRAPH-SEARCH-NODE", 3, 0, false);
        declareFunction(me, "inert_variable", "INERT-VARIABLE", 1, 0, false);
        declareFunction(me, "graph_search_node_as_sortable_sets", "GRAPH-SEARCH-NODE-AS-SORTABLE-SETS", 1, 0, false);
        declareFunction(me, "graph_search_node_as_unifiable_sets", "GRAPH-SEARCH-NODE-AS-UNIFIABLE-SETS", 1, 0, false);
        declareFunction(me, "unify_graph_search_node", "UNIFY-GRAPH-SEARCH-NODE", 2, 0, false);
        declareFunction(me, "graph_search_nodes_isomorphicP", "GRAPH-SEARCH-NODES-ISOMORPHIC?", 2, 0, false);
        declareFunction(me, "graph_search_node_L", "GRAPH-SEARCH-NODE-<", 2, 0, false);
        declareFunction(me, "min_graph_search_node", "MIN-GRAPH-SEARCH-NODE", 1, 0, false);
        declareFunction(me, "vertex_search_state_as_unifiable_sets_of_sets", "VERTEX-SEARCH-STATE-AS-UNIFIABLE-SETS-OF-SETS", 1, 0, false);
        declareFunction(me, "vertex_search_state_as_sortable_sets_of_sets", "VERTEX-SEARCH-STATE-AS-SORTABLE-SETS-OF-SETS", 1, 0, false);
        declareFunction(me, "unify_vertex_search_state", "UNIFY-VERTEX-SEARCH-STATE", 2, 0, false);
        declareFunction(me, "vertex_search_states_isomorphicP", "VERTEX-SEARCH-STATES-ISOMORPHIC?", 2, 0, false);
        declareFunction(me, "vertex_search_state_L", "VERTEX-SEARCH-STATE-<", 2, 0, false);
        declareFunction(me, "min_vertex_search_state", "MIN-VERTEX-SEARCH-STATE", 2, 0, false);
        declareFunction(me, "source_vertex", "SOURCE-VERTEX", 1, 0, false);
        declareFunction(me, "init_graph_search_state", "INIT-GRAPH-SEARCH-STATE", 1, 0, false);
        declareFunction(me, "graph_search_state_covers_graphP", "GRAPH-SEARCH-STATE-COVERS-GRAPH?", 2, 0, false);
        declareFunction(me, "least_vertex", "LEAST-VERTEX", 1, 1, false);
        declareFunction(me, "least_vertex_recursive", "LEAST-VERTEX-RECURSIVE", 3, 0, false);
        declareFunction(me, "penultimate_resort_literals", "PENULTIMATE-RESORT-LITERALS", 1, 0, false);
        declareFunction(me, "guid_tree_L", "GUID-TREE-<", 2, 0, false);
        declareFunction(me, "safe_guidL", "SAFE-GUID<", 2, 0, false);
        declareFunction(me, "safe_guidE", "SAFE-GUID=", 2, 0, false);
        declareFunction(me, "last_resort_literal", "LAST-RESORT-LITERAL", 2, 0, false);
        declareFunction(me, "compute_sorted_shared_vars", "COMPUTE-SORTED-SHARED-VARS", 2, 0, false);
        return NIL;
    }
    ...
    public static final class $v_colour_native extends SubLStructNative {
        ...
        public $v_colour_native() {
            this.$sorted_constant_list = Lisp.NIL;
            this.$sorted_nat_list = Lisp.NIL;
            this.$sorted_assertion_list = Lisp.NIL;
            this.$list_structure = Lisp.NIL;
            this.$sorted_var_positions = Lisp.NIL;
        }
        ...
        static {
            structDecl = makeStructDeclNative(czer_graph.$v_colour_native.class, V_COLOUR, V_COLOUR_P, $list2, $list3, new String[]{ "$sorted_constant_list", "$sorted_nat_list", "$sorted_assertion_list", "$list_structure", "$sorted_var_positions" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $arc_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(czer_graph.$arc_native.class, ARC, ARC_P, $list33, $list34, new String[]{ "$head", "$colour" }, $list35, $list36, PRINT_ARC);
        }
    }
    ...
    public static final class $vertex_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(czer_graph.$vertex_native.class, VERTEX, VERTEX_P, $list52, $list53, new String[]{ "$id", "$colour", "$arc_set" }, $list54, $list55, PRINT_VERTEX);
        }
    }
    ...
    public static final class $graph_search_node_native extends SubLStructNative {
        ...
        public $graph_search_node_native() {
            this.$vertex = Lisp.NIL;
            this.$search_history = Lisp.NIL;
        }
        ...
        static {
            structDecl = makeStructDeclNative(czer_graph.$graph_search_node_native.class, GRAPH_SEARCH_NODE, GRAPH_SEARCH_NODE_P, $list78, $list79, new String[]{ "$vertex", "$search_history" }, $list80, $list81, PRINT_GRAPH_SEARCH_NODE);
        }
    }
