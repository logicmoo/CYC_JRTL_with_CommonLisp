...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class czer_graph extends SubLTranslatedFile {
    ...
    public static SubLObject v_colour_sorted_constant_list(final SubLObject v_object) {
        assert NIL != v_colour_p(v_object) : "czer_graph.v_colour_p error :" + v_object;
    ...
    public static SubLObject arc_head(final SubLObject v_object) {
        assert NIL != arc_p(v_object) : "czer_graph.arc_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject vertex_id(final SubLObject v_object) {
        assert NIL != vertex_p(v_object) : "czer_graph.vertex_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject graph_search_node_vertex(final SubLObject v_object) {
        assert NIL != graph_search_node_p(v_object) : "czer_graph.graph_search_node_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $v_colour_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($v_colour_native.class, V_COLOUR, V_COLOUR_P, $list2, $list3, new String[]{ "$sorted_constant_list", "$sorted_nat_list", "$sorted_assertion_list", "$list_structure", "$sorted_var_positions" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $arc_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($arc_native.class, ARC, ARC_P, $list33, $list34, new String[]{ "$head", "$colour" }, $list35, $list36, PRINT_ARC);
        }
    }
    ...
    public static final class $vertex_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($vertex_native.class, VERTEX, VERTEX_P, $list52, $list53, new String[]{ "$id", "$colour", "$arc_set" }, $list54, $list55, PRINT_VERTEX);
        }
    }
    ...
    public static final class $graph_search_node_native extends SubLStructNative {
        ...
        private $graph_search_node_native() {
        ...
        static {
            structDecl = makeStructDeclNative($graph_search_node_native.class, GRAPH_SEARCH_NODE, GRAPH_SEARCH_NODE_P, $list78, $list79, new String[]{ "$vertex", "$search_history" }, $list80, $list81, PRINT_GRAPH_SEARCH_NODE);
        }
    }
