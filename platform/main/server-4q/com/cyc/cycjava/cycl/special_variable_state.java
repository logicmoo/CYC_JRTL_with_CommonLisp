...
import static com.cyc.cycjava.cycl.special_variable_state.*;
...
public final class special_variable_state extends SubLTranslatedFile {
    ...
    public static SubLObject special_variable_state_p(final SubLObject v_object) {
        return v_object.getClass() == special_variable_state.$special_variable_state_native.class ? T : NIL;
    }

    public static SubLObject svs_variables(final SubLObject v_object) {
        assert NIL != special_variable_state_p(v_object) : "special_variable_state.special_variable_state_p(v_object) " + "CommonSymbols.NIL != special_variable_state.special_variable_state_p(v_object) " + v_object;
    ...
    public static SubLObject make_special_variable_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new special_variable_state.$special_variable_state_native();
        SubLObject next;
    ...
    public static final class $special_variable_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(special_variable_state.$special_variable_state_native.class, SPECIAL_VARIABLE_STATE, SPECIAL_VARIABLE_STATE_P, $list3, $list4, new String[]{ "$variables", "$values" }, $list5, $list6, PRINT_SPECIAL_VARIABLE_STATE);
        }
    }
