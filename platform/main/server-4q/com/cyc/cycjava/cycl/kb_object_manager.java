...
import static com.cyc.cycjava.cycl.id_index.new_id_index_dense_objects_iterator;
...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class kb_object_manager extends SubLTranslatedFile {
    ...
    public static SubLObject kb_object_manager_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$kb_object_manager_native.class ? T : NIL;
    }

    public static SubLObject kbom_name(final SubLObject v_object) {
        assert NIL != kb_object_manager_p(v_object) : "kb_object_manager.kb_object_manager_p error :" + v_object;
    ...
    public static final class $kb_object_manager_native extends SubLStructNative {
        ...
        private $kb_object_manager_native() {
            this.$name = Lisp.NIL;
