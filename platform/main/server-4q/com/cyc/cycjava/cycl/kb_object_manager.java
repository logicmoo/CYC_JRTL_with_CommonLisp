...
import static com.cyc.cycjava.cycl.kb_object_manager.*;
...
public final class kb_object_manager extends SubLTranslatedFile {
    ...
    public static final SubLSymbol KB_OBJECT_MANAGER_CONTENT_LOCK = makeSymbol("KB-OBJECT-MANAGER-CONTENT-LOCK");

    public static final SubLSymbol KB_OBJECT_MANAGER = makeSymbol("KB-OBJECT-MANAGER");

    public static final SubLSymbol KB_OBJECT_MANAGER_P = makeSymbol("KB-OBJECT-MANAGER-P");

    public static final SubLList $list5 = list(new SubLObject[]{ makeSymbol("NAME"), makeSymbol("CONTENT-LOCK"), makeSymbol("LRU-SIZE-PERCENTAGE"), makeSymbol("CONTENT-TABLE"), makeSymbol("USAGE-TABLE"), makeSymbol("LRU-INFORMATION"), makeSymbol("FILE-VECTOR"), makeSymbol("ID-THRESHOLD"), makeSymbol("LOAD-FUNC"), makeSymbol("METER-SWAP-TIME?"), makeSymbol("SWAP-TIME"), makeSymbol("LRU-SIZE-MAX"), makeSymbol("SUB-FILE-VECTOR"), makeSymbol("DUMMY3") });

    public static final SubLList $list6 = list(new SubLObject[]{ makeKeyword("NAME"), makeKeyword("CONTENT-LOCK"), makeKeyword("LRU-SIZE-PERCENTAGE"), makeKeyword("CONTENT-TABLE"), makeKeyword("USAGE-TABLE"), makeKeyword("LRU-INFORMATION"), makeKeyword("FILE-VECTOR"), makeKeyword("ID-THRESHOLD"), makeKeyword("LOAD-FUNC"), makeKeyword("METER-SWAP-TIME?"), makeKeyword("SWAP-TIME"), makeKeyword("LRU-SIZE-MAX"), makeKeyword("SUB-FILE-VECTOR"), makeKeyword("DUMMY3") });

    public static final SubLList $list7 = list(new SubLObject[]{ makeSymbol("KBOM-NAME"), makeSymbol("KBOM-CONTENT-LOCK"), makeSymbol("KBOM-LRU-SIZE-PERCENTAGE"), makeSymbol("KBOM-CONTENT-TABLE"), makeSymbol("KBOM-USAGE-TABLE"), makeSymbol("KBOM-LRU-INFORMATION"), makeSymbol("KBOM-FILE-VECTOR"), makeSymbol("KBOM-ID-THRESHOLD"), makeSymbol("KBOM-LOAD-FUNC"), makeSymbol("KBOM-METER-SWAP-TIME?"), makeSymbol("KBOM-SWAP-TIME"), makeSymbol("KBOM-LRU-SIZE-MAX"), makeSymbol("KBOM-SUB-FILE-VECTOR"), makeSymbol("KBOM-DUMMY3") });

    public static final SubLList $list8 = list(new SubLObject[]{ makeSymbol("_CSETF-KBOM-NAME"), makeSymbol("_CSETF-KBOM-CONTENT-LOCK"), makeSymbol("_CSETF-KBOM-LRU-SIZE-PERCENTAGE"), makeSymbol("_CSETF-KBOM-CONTENT-TABLE"), makeSymbol("_CSETF-KBOM-USAGE-TABLE"), makeSymbol("_CSETF-KBOM-LRU-INFORMATION"), makeSymbol("_CSETF-KBOM-FILE-VECTOR"), makeSymbol("_CSETF-KBOM-ID-THRESHOLD"), makeSymbol("_CSETF-KBOM-LOAD-FUNC"), makeSymbol("_CSETF-KBOM-METER-SWAP-TIME?"), makeSymbol("_CSETF-KBOM-SWAP-TIME"), makeSymbol("_CSETF-KBOM-LRU-SIZE-MAX"), makeSymbol("_CSETF-KBOM-SUB-FILE-VECTOR"), makeSymbol("_CSETF-KBOM-DUMMY3") });



    public static final SubLSymbol KB_OBJECT_MANAGER_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("KB-OBJECT-MANAGER-PRINT-FUNCTION-TRAMPOLINE");
    ...
    private static final SubLString $str73$We_expected_KB_object_ID__A_from_ = makeString("We expected KB object ID ~A from CFASL stream ~A but got object ~A of type ~A instead.~%Thus, the index and the data files for the file vector are misaligned.~%After index lookup, index was at filepos ~A.~%Corrupted KB units?");
    ...
    public static SubLObject kb_object_manager_p(final SubLObject v_object) {
        return v_object.getClass() == kb_object_manager.$kb_object_manager_native.class ? T : NIL;
    }

    public static SubLObject kbom_name(final SubLObject v_object) {
        assert NIL != kb_object_manager_p(v_object) : "kb_object_manager.kb_object_manager_p(v_object) " + "CommonSymbols.NIL != kb_object_manager.kb_object_manager_p(v_object) " + v_object;
    ...
    public static SubLObject make_kb_object_manager(SubLObject arglist) {
        ...
        final SubLObject v_new = new kb_object_manager.$kb_object_manager_native();
        SubLObject next;
    ...
    public static SubLObject new_kb_object_manager(final SubLObject name, final SubLObject size, final SubLObject lru_size_percentage, final SubLObject lru_size_max, final SubLObject load_func, final SubLObject exact_sizeP) {
        ...
        assert NIL != subl_promotions.positive_integer_p(lru_size_percentage) : "subl_promotions.positive_integer_p(lru_size_percentage) " + "CommonSymbols.NIL != subl_promotions.positive_integer_p(lru_size_percentage) " + lru_size_percentage;
        assert NIL != subl_promotions.positive_integer_p(lru_size_max) : "subl_promotions.positive_integer_p(lru_size_max) " + "CommonSymbols.NIL != subl_promotions.positive_integer_p(lru_size_max) " + lru_size_max;
        assert NIL != fboundp(load_func) : "Symbols.fboundp(load_func) " + "CommonSymbols.NIL != Symbols.fboundp(load_func) " + load_func;
    ...
    public static SubLObject kb_object_manager_change_stream_buffer_sizes(final SubLObject kbom, final SubLObject data_stream_buffer_size, final SubLObject index_stream_buffer_size) {
        assert NIL != subl_promotions.positive_integer_p(data_stream_buffer_size) : "subl_promotions.positive_integer_p(data_stream_buffer_size) " + "CommonSymbols.NIL != subl_promotions.positive_integer_p(data_stream_buffer_size) " + data_stream_buffer_size;
        assert NIL != subl_promotions.positive_integer_p(index_stream_buffer_size) : "subl_promotions.positive_integer_p(index_stream_buffer_size) " + "CommonSymbols.NIL != subl_promotions.positive_integer_p(index_stream_buffer_size) " + index_stream_buffer_size;
        assert NIL != kb_object_manager_p(kbom) : "kb_object_manager.kb_object_manager_p(kbom) " + "CommonSymbols.NIL != kb_object_manager.kb_object_manager_p(kbom) " + kbom;
    ...
    public static SubLObject optimize_kb_object_content_table(final SubLObject kbom, final SubLObject sparse_id_threshold) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != subl_promotions.non_negative_integer_p(sparse_id_threshold) : "subl_promotions.non_negative_integer_p(sparse_id_threshold) " + "CommonSymbols.NIL != subl_promotions.non_negative_integer_p(sparse_id_threshold) " + sparse_id_threshold;
    ...
    public static SubLObject with_kbom_fully_loaded(final SubLObject macroform, final SubLObject environment) {
        ...
        if (NIL == current) {
            ...
            return list(CLET, list(list(manager, kbom), list(maintaining_countsP, list($sym97$KB_OBJECT_USAGE_COUNTS_ENABLED_, manager)), list(memory_mappedP, list($sym98$KB_OBJECT_MANAGER_MEMORY_MAPPED_, manager))), list(CUNWIND_PROTECT, listS(PROGN, list(DONT_MAINTAIN_KB_OBJECT_USAGE_COUNTS, manager), list(KB_OBJECT_MANAGER_ENABLE_MEMORY_MAPPING, manager), append(body, NIL)), list(PROGN, list(PWHEN, maintaining_countsP, list(MAINTAIN_KB_OBJECT_USAGE_COUNTS, manager)), list(PWHEN, list(CNOT, memory_mappedP), listS(KB_OBJECT_MANAGER_CHANGE_STREAM_BUFFER_SIZES, manager, $list107)))));
        }
        cdestructuring_bind_error(datum, $list0);
        return NIL;
    }
    ...
    public static SubLObject declare_kb_object_manager_file() {
        declareMacro(me, "with_kb_object_manager_lock_held", "WITH-KB-OBJECT-MANAGER-LOCK-HELD");
        declareFunction(me, "kb_object_manager_print_function_trampoline", "KB-OBJECT-MANAGER-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "kb_object_manager_p", "KB-OBJECT-MANAGER-P", 1, 0, false);
        new kb_object_manager.$kb_object_manager_p$UnaryFunction();
        declareFunction(me, "kbom_name", "KBOM-NAME", 1, 0, false);
        declareFunction(me, "kbom_content_lock", "KBOM-CONTENT-LOCK", 1, 0, false);
        declareFunction(me, "kbom_lru_size_percentage", "KBOM-LRU-SIZE-PERCENTAGE", 1, 0, false);
        declareFunction(me, "kbom_content_table", "KBOM-CONTENT-TABLE", 1, 0, false);
        declareFunction(me, "kbom_usage_table", "KBOM-USAGE-TABLE", 1, 0, false);
        declareFunction(me, "kbom_lru_information", "KBOM-LRU-INFORMATION", 1, 0, false);
        declareFunction(me, "kbom_file_vector", "KBOM-FILE-VECTOR", 1, 0, false);
        declareFunction(me, "kbom_id_threshold", "KBOM-ID-THRESHOLD", 1, 0, false);
        declareFunction(me, "kbom_load_func", "KBOM-LOAD-FUNC", 1, 0, false);
        declareFunction(me, "kbom_meter_swap_timeP", "KBOM-METER-SWAP-TIME?", 1, 0, false);
        declareFunction(me, "kbom_swap_time", "KBOM-SWAP-TIME", 1, 0, false);
        declareFunction(me, "kbom_lru_size_max", "KBOM-LRU-SIZE-MAX", 1, 0, false);
        declareFunction(me, "kbom_sub_file_vector", "KBOM-SUB-FILE-VECTOR", 1, 0, false);
        declareFunction(me, "kbom_dummy3", "KBOM-DUMMY3", 1, 0, false);
        declareFunction(me, "_csetf_kbom_name", "_CSETF-KBOM-NAME", 2, 0, false);
        declareFunction(me, "_csetf_kbom_content_lock", "_CSETF-KBOM-CONTENT-LOCK", 2, 0, false);
        declareFunction(me, "_csetf_kbom_lru_size_percentage", "_CSETF-KBOM-LRU-SIZE-PERCENTAGE", 2, 0, false);
        declareFunction(me, "_csetf_kbom_content_table", "_CSETF-KBOM-CONTENT-TABLE", 2, 0, false);
        declareFunction(me, "_csetf_kbom_usage_table", "_CSETF-KBOM-USAGE-TABLE", 2, 0, false);
        declareFunction(me, "_csetf_kbom_lru_information", "_CSETF-KBOM-LRU-INFORMATION", 2, 0, false);
        declareFunction(me, "_csetf_kbom_file_vector", "_CSETF-KBOM-FILE-VECTOR", 2, 0, false);
        declareFunction(me, "_csetf_kbom_id_threshold", "_CSETF-KBOM-ID-THRESHOLD", 2, 0, false);
        declareFunction(me, "_csetf_kbom_load_func", "_CSETF-KBOM-LOAD-FUNC", 2, 0, false);
        declareFunction(me, "_csetf_kbom_meter_swap_timeP", "_CSETF-KBOM-METER-SWAP-TIME?", 2, 0, false);
        declareFunction(me, "_csetf_kbom_swap_time", "_CSETF-KBOM-SWAP-TIME", 2, 0, false);
        declareFunction(me, "_csetf_kbom_lru_size_max", "_CSETF-KBOM-LRU-SIZE-MAX", 2, 0, false);
        declareFunction(me, "_csetf_kbom_sub_file_vector", "_CSETF-KBOM-SUB-FILE-VECTOR", 2, 0, false);
        declareFunction(me, "_csetf_kbom_dummy3", "_CSETF-KBOM-DUMMY3", 2, 0, false);
        declareFunction(me, "make_kb_object_manager", "MAKE-KB-OBJECT-MANAGER", 0, 1, false);
        declareFunction(me, "visit_defstruct_kb_object_manager", "VISIT-DEFSTRUCT-KB-OBJECT-MANAGER", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_kb_object_manager_method", "VISIT-DEFSTRUCT-OBJECT-KB-OBJECT-MANAGER-METHOD", 2, 0, false);
        declareFunction(me, "new_kb_object_manager", "NEW-KB-OBJECT-MANAGER", 6, 0, false);
        declareFunction(me, "kb_object_manager_change_stream_buffer_sizes", "KB-OBJECT-MANAGER-CHANGE-STREAM-BUFFER-SIZES", 3, 0, false);
        declareFunction(me, "kb_object_manager_enable_memory_mapping", "KB-OBJECT-MANAGER-ENABLE-MEMORY-MAPPING", 1, 0, false);
        declareFunction(me, "kb_object_manager_memory_mappedP", "KB-OBJECT-MANAGER-MEMORY-MAPPED?", 1, 0, false);
        declareFunction(me, "setup_kb_object_content_table", "SETUP-KB-OBJECT-CONTENT-TABLE", 3, 0, false);
        declareFunction(me, "setup_kb_object_content_support", "SETUP-KB-OBJECT-CONTENT-SUPPORT", 1, 2, false);
        declareFunction(me, "compute_kbom_lru_size", "COMPUTE-KBOM-LRU-SIZE", 2, 0, false);
        declareFunction(me, "initialize_kb_object_hl_store_cache", "INITIALIZE-KB-OBJECT-HL-STORE-CACHE", 3, 2, false);
        declareFunction(me, "resize_kbom_lru_cache_from_percentage_and_max", "RESIZE-KBOM-LRU-CACHE-FROM-PERCENTAGE-AND-MAX", 3, 0, false);
        declareFunction(me, "resize_kbom_lru_cache", "RESIZE-KBOM-LRU-CACHE", 2, 0, false);
        declareFunction(me, "new_legacy_kb_object_manager", "NEW-LEGACY-KB-OBJECT-MANAGER", 7, 0, false);
        declareFunction(me, "optimize_kb_object_content_table", "OPTIMIZE-KB-OBJECT-CONTENT-TABLE", 2, 0, false);
        declareFunction(me, "clear_kb_object_content_table", "CLEAR-KB-OBJECT-CONTENT-TABLE", 1, 0, false);
        declareFunction(me, "kb_object_manager_name", "KB-OBJECT-MANAGER-NAME", 1, 0, false);
        declareFunction(me, "kb_object_manager_content_lock", "KB-OBJECT-MANAGER-CONTENT-LOCK", 1, 0, false);
        declareFunction(me, "kb_object_manager_lru_size_percentage", "KB-OBJECT-MANAGER-LRU-SIZE-PERCENTAGE", 1, 0, false);
        declareFunction(me, "kb_object_manager_lru_size_max", "KB-OBJECT-MANAGER-LRU-SIZE-MAX", 1, 0, false);
        declareFunction(me, "kb_object_manager_content_table", "KB-OBJECT-MANAGER-CONTENT-TABLE", 1, 0, false);
        declareFunction(me, "kb_object_manager_usage_table", "KB-OBJECT-MANAGER-USAGE-TABLE", 1, 0, false);
        declareFunction(me, "kb_object_manager_lru_information", "KB-OBJECT-MANAGER-LRU-INFORMATION", 1, 0, false);
        declareFunction(me, "kb_object_manager_file_vector", "KB-OBJECT-MANAGER-FILE-VECTOR", 1, 0, false);
        declareFunction(me, "kb_object_manager_id_threshold", "KB-OBJECT-MANAGER-ID-THRESHOLD", 1, 0, false);
        declareFunction(me, "kb_object_manager_load_func", "KB-OBJECT-MANAGER-LOAD-FUNC", 1, 0, false);
        declareFunction(me, "kb_object_manager_meter_swap_timeP", "KB-OBJECT-MANAGER-METER-SWAP-TIME?", 1, 0, false);
        declareFunction(me, "kb_object_manager_swap_time", "KB-OBJECT-MANAGER-SWAP-TIME", 1, 0, false);
        declareFunction(me, "kb_object_manager_sub_file_vector", "KB-OBJECT-MANAGER-SUB-FILE-VECTOR", 1, 0, false);
        declareFunction(me, "set_kb_object_manager_sub_file_vector", "SET-KB-OBJECT-MANAGER-SUB-FILE-VECTOR", 2, 0, false);
        declareFunction(me, "kb_object_usage_counts_enabledP", "KB-OBJECT-USAGE-COUNTS-ENABLED?", 1, 0, false);
        declareFunction(me, "cached_kb_object_count", "CACHED-KB-OBJECT-COUNT", 1, 0, false);
        declareFunction(me, "swappable_kb_object_count", "SWAPPABLE-KB-OBJECT-COUNT", 1, 0, false);
        declareFunction(me, "kb_object_id_cachedP", "KB-OBJECT-ID-CACHED?", 2, 0, false);
        declareFunction(me, "kb_object_id_cachableP", "KB-OBJECT-ID-CACHABLE?", 2, 0, false);
        declareFunction(me, "lookup_kb_object_content", "LOOKUP-KB-OBJECT-CONTENT", 2, 0, false);
        declareFunction(me, "kb_object_manager_unbuiltP", "KB-OBJECT-MANAGER-UNBUILT?", 1, 0, false);
        declareFunction(me, "maintain_kb_object_usage_counts", "MAINTAIN-KB-OBJECT-USAGE-COUNTS", 1, 0, false);
        declareFunction(me, "dont_maintain_kb_object_usage_counts", "DONT-MAINTAIN-KB-OBJECT-USAGE-COUNTS", 1, 0, false);
        declareFunction(me, "register_kb_object_content", "REGISTER-KB-OBJECT-CONTENT", 3, 0, false);
        declareFunction(me, "deregister_kb_object_content", "DEREGISTER-KB-OBJECT-CONTENT", 2, 0, false);
        declareFunction(me, "new_kb_object_content_file_vector", "NEW-KB-OBJECT-CONTENT-FILE-VECTOR", 2, 1, false);
        declareFunction(me, "kb_object_content_file_vector_cfasl_stream", "KB-OBJECT-CONTENT-FILE-VECTOR-CFASL-STREAM", 1, 0, false);
        declareFunction(me, "kb_object_content_file_vector_p", "KB-OBJECT-CONTENT-FILE-VECTOR-P", 1, 0, false);
        declareFunction(me, "kb_object_content_file_vector_lookup", "KB-OBJECT-CONTENT-FILE-VECTOR-LOOKUP", 2, 0, false);
        declareFunction(me, "wide_kb_object_managerP", "WIDE-KB-OBJECT-MANAGER?", 1, 0, false);
        declareFunction(me, "wide_kb_object_sub_managerP", "WIDE-KB-OBJECT-SUB-MANAGER?", 1, 0, false);
        declareFunction(me, "serialize_kbom_lru_information", "SERIALIZE-KBOM-LRU-INFORMATION", 2, 0, false);
        declareFunction(me, "precache_kbom_by_lru_information", "PRECACHE-KBOM-BY-LRU-INFORMATION", 2, 0, false);
        declareFunction(me, "kbom_lru_info_filename", "KBOM-LRU-INFO-FILENAME", 2, 0, false);
        declareFunction(me, "is_lru_cachable_kb_object_content_idP", "IS-LRU-CACHABLE-KB-OBJECT-CONTENT-ID?", 2, 0, false);
        declareFunction(me, "update_kb_object_usage", "UPDATE-KB-OBJECT-USAGE", 2, 0, false);
        declareFunction(me, "drop_kb_object_usage", "DROP-KB-OBJECT-USAGE", 2, 0, false);
        declareFunction(me, "mark_kb_object_content_as_muted", "MARK-KB-OBJECT-CONTENT-AS-MUTED", 2, 0, false);
        declareFunction(me, "meter_kb_object_content_swap_time", "METER-KB-OBJECT-CONTENT-SWAP-TIME", 1, 0, false);
        declareFunction(me, "dont_meter_kb_object_content_swap_time", "DONT-METER-KB-OBJECT-CONTENT-SWAP-TIME", 1, 0, false);
        declareFunction(me, "clear_kb_object_content_swap_time", "CLEAR-KB-OBJECT-CONTENT-SWAP-TIME", 1, 0, false);
        declareFunction(me, "get_file_backed_kb_object_id_threshold", "GET-FILE-BACKED-KB-OBJECT-ID-THRESHOLD", 1, 0, false);
        declareFunction(me, "swap_in_kb_object_content", "SWAP-IN-KB-OBJECT-CONTENT", 2, 0, false);
        declareFunction(me, "swap_in_kb_object_content_metered", "SWAP-IN-KB-OBJECT-CONTENT-METERED", 2, 0, false);
        declareFunction(me, "swap_in_kb_object_content_internal", "SWAP-IN-KB-OBJECT-CONTENT-INTERNAL", 2, 0, false);
        declareFunction(me, "swap_out_pristine_kb_object_content", "SWAP-OUT-PRISTINE-KB-OBJECT-CONTENT", 2, 0, false);
        declareFunction(me, "safely_swap_out_all_pristine_kb_objects", "SAFELY-SWAP-OUT-ALL-PRISTINE-KB-OBJECTS", 1, 0, false);
        declareFunction(me, "swap_out_all_pristine_kb_objects_int", "SWAP-OUT-ALL-PRISTINE-KB-OBJECTS-INT", 1, 0, false);
        declareFunction(me, "increment_kb_object_usage_count", "INCREMENT-KB-OBJECT-USAGE-COUNT", 2, 0, false);
        declareFunction(me, "new_muted_kb_object_iterator", "NEW-MUTED-KB-OBJECT-ITERATOR", 1, 0, false);
        declareFunction(me, "is_muted_kb_objectP", "IS-MUTED-KB-OBJECT?", 2, 0, false);
        declareFunction(me, "verify_kb_object_content_table_int", "VERIFY-KB-OBJECT-CONTENT-TABLE-INT", 2, 1, false);
        declareMacro(me, "with_kbom_fully_loaded", "WITH-KBOM-FULLY-LOADED");
        declareFunction(me, "segment_kb_object_manager_data", "SEGMENT-KB-OBJECT-MANAGER-DATA", 1, 2, false);
        declareFunction(me, "inspect_kb_object_manager_data", "INSPECT-KB-OBJECT-MANAGER-DATA", 2, 0, false);
        return NIL;
    }
    ...
    public static final class $kb_object_manager_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(kb_object_manager.$kb_object_manager_native.class, KB_OBJECT_MANAGER, KB_OBJECT_MANAGER_P, $list5, $list6, new String[]{ "$name", "$content_lock", "$lru_size_percentage", "$content_table", "$usage_table", "$lru_information", "$file_vector", "$id_threshold", "$load_func", "$meter_swap_timeP", "$swap_time", "$lru_size_max", "$sub_file_vector", "$dummy3" }, $list7, $list8, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
