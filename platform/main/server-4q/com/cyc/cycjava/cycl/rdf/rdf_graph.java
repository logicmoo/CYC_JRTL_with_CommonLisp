...
public final class rdf_graph extends SubLTranslatedFile {
    ...
    public static SubLObject rdf_graph_add_triple(final SubLObject v_graph, final SubLObject subject, final SubLObject predicate, final SubLObject v_object) {
        ...
        assert NIL != valid_rdf_object_p(v_object) : "rdf_graph.valid_rdf_object_p(v_object) " + "CommonSymbols.NIL != rdf_graph.valid_rdf_object_p(v_object) " + v_object;
    ...
    public static SubLObject rdf_graph_p(final SubLObject v_object) {
        return v_object.getClass() == rdf_graph.$rdf_graph_native.class ? T : NIL;
    }

    public static SubLObject rdf_graph_struct_triples(final SubLObject v_object) {
        assert NIL != rdf_graph_p(v_object) : "rdf_graph.rdf_graph_p(v_object) " + "CommonSymbols.NIL != rdf_graph.rdf_graph_p(v_object) " + v_object;
    ...
    public static SubLObject make_rdf_graph(SubLObject arglist) {
        ...
        final SubLObject v_new = new rdf_graph.$rdf_graph_native();
        SubLObject next;
    ...
    public static SubLObject rdf_graph_index_p(final SubLObject v_object) {
        return v_object.getClass() == rdf_graph.$rdf_graph_index_native.class ? T : NIL;
    }

    public static SubLObject rdf_graph_index_struct_subject_index(final SubLObject v_object) {
        assert NIL != rdf_graph_index_p(v_object) : "rdf_graph.rdf_graph_index_p(v_object) " + "CommonSymbols.NIL != rdf_graph.rdf_graph_index_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_rdf_graph_index(SubLObject arglist) {
        ...
        final SubLObject v_new = new rdf_graph.$rdf_graph_index_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $rdf_graph_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rdf_graph.$rdf_graph_native.class, RDF_GRAPH, RDF_GRAPH_P, $list72, $list73, new String[]{ "$triples", "$nodes", "$index", "$lock", "$node_count", "$prefix_map", "$file_location", "$topic", "$focal_nodes" }, $list74, $list75, PRINT_RDF_GRAPH);
        }
    }
    ...
    public static final class $rdf_graph_index_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rdf_graph.$rdf_graph_index_native.class, RDF_GRAPH_INDEX, RDF_GRAPH_INDEX_P, $list132, $list133, new String[]{ "$subject_index", "$predicate_index", "$object_index" }, $list134, $list135, PRINT_RDF_GRAPH_INDEX);
        }
    }
