...
public final class rdf_literal extends SubLTranslatedFile {
    ...
    public static SubLObject rdf_literal_p(final SubLObject v_object) {
        return v_object.getClass() == rdf_literal.$rdf_literal_native.class ? T : NIL;
    }

    public static SubLObject rdf_lit_utf8_lexical_form(final SubLObject v_object) {
        assert NIL != rdf_literal_p(v_object) : "rdf_literal.rdf_literal_p(v_object) " + "CommonSymbols.NIL != rdf_literal.rdf_literal_p(v_object) " + v_object;
    ...
    public static SubLObject make_rdf_literal(SubLObject arglist) {
        ...
        final SubLObject v_new = new rdf_literal.$rdf_literal_native();
        SubLObject next;
    ...
    public static final class $rdf_literal_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rdf_literal.$rdf_literal_native.class, RDF_LITERAL, RDF_LITERAL_P, $list2, $list3, new String[]{ "$utf8_lexical_form", "$language_tag", "$datatype" }, $list4, $list5, PRINT_RDF_LITERAL);
        }
    }
