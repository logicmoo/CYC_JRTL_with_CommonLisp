...
public final class rdf_uri extends SubLTranslatedFile {
    ...
    public static SubLObject rdf_uri_p(final SubLObject v_object) {
        return v_object.getClass() == rdf_uri.$rdf_uri_native.class ? T : NIL;
    }

    public static SubLObject rdf_uri_struct_base_uri(final SubLObject v_object) {
        assert NIL != rdf_uri_p(v_object) : "rdf_uri.rdf_uri_p(v_object) " + "CommonSymbols.NIL != rdf_uri.rdf_uri_p(v_object) " + v_object;
    ...
    public static SubLObject make_rdf_uri(SubLObject arglist) {
        ...
        final SubLObject v_new = new rdf_uri.$rdf_uri_native();
        SubLObject next;
    ...
    public static final class $rdf_uri_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rdf_uri.$rdf_uri_native.class, RDF_URI, RDF_URI_P, $list12, $list13, new String[]{ "$base_uri", "$connector", "$local_part" }, $list14, $list15, PRINT_RDF_URI);
        }
    }
