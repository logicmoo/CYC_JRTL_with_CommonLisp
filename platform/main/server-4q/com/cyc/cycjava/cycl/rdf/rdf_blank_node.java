...
import com.cyc.cycjava.cycl.rdf.rdf_blank_node.$rdf_blank_node_native;
...
public final class rdf_blank_node extends SubLTranslatedFile {
    ...
    public static SubLObject rdf_bnode_id(final SubLObject v_object) {
        assert NIL != rdf_blank_node_p(v_object) : "rdf_blank_node.rdf_blank_node_p error :" + v_object;
    ...
    public static final class $rdf_blank_node_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($rdf_blank_node_native.class, RDF_BLANK_NODE, RDF_BLANK_NODE_P, $list2, $list3, new String[]{ "$id" }, $list4, $list5, PRINT_RDF_BLANK_NODE);
        }
    }
