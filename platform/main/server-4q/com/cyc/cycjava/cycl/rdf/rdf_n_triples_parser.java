...
import com.cyc.cycjava.cycl.rdf.rdf_n_triples_parser;
...
import static com.cyc.cycjava.cycl.rdf.rdf_n_triples_parser.*;
...
public final class rdf_n_triples_parser extends SubLTranslatedFile {
    ...
    public static final SubLString $str5$Illegal_n_subject___S = makeString("Illegal n-subject: ~S");

    public static final SubLString $str6$Illegal_n_predicate___S = makeString("Illegal n-predicate: ~S");

    public static final SubLString $str7$Illegal_n_object___S = makeString("Illegal n-object: ~S");

    public static final SubLString $str8$_ = makeString(">");

    public static final SubLString $str9$_ = makeString("<");

    public static final SubLString $str10$No_close_quote_in__A = makeString("No close quote in ~A");

    public static final SubLString $str11$Invalid_n_literal___A = makeString("Invalid n-literal: ~A");

    private static final SubLInteger $int$34 = makeInteger(34);

    private static final SubLInteger $int$92 = makeInteger(92);

    public static final SubLString $str14$Invalid_n_triple_escape_char__S_a = makeString("Invalid n-triple escape char ~S at ~D");

    public static final SubLSymbol TEST_RDF_N_TRIPLES_PARSER = makeSymbol("TEST-RDF-N-TRIPLES-PARSER");
    ...
    public static final SubLString $str27$_nt = makeString(".nt");

    public static final SubLString $str28$Running_RDF_parsing_tests___ = makeString("Running RDF parsing tests...");



    public static final SubLString $str30$__Failed___S__ = makeString("~&Failed: ~S~%");

    public static final SubLString $str31$__Summary___D_Parsed___D_Failed__ = makeString("~&Summary: ~D Parsed. ~D Failed~%");
    ...
    public static SubLObject test_rdf_n_triples_parser() {
        ...
        assert NIL != Filesys.directory_p(rdf_parser.$rdfXxml_parser_test_directory$.getGlobalValue()) : "Filesys.directory_p(rdf_parser.$rdfXxml_parser_test_directory$.getGlobalValue()) " + "CommonSymbols.NIL != Filesys.directory_p(rdf_parser.$rdfXxml_parser_test_directory$.getGlobalValue()) " + rdf_parser.$rdfXxml_parser_test_directory$.getGlobalValue();
    ...
    public static SubLObject declare_rdf_n_triples_parser_file() {
        declareFunction(me, "rdf_graph_from_n_triples_file", "RDF-GRAPH-FROM-N-TRIPLES-FILE", 1, 0, false);
        declareFunction(me, "parse_n_triple_file_line", "PARSE-N-TRIPLE-FILE-LINE", 2, 0, false);
        declareFunction(me, "n_triple_comment_p", "N-TRIPLE-COMMENT-P", 1, 0, false);
        declareFunction(me, "parse_n_triple", "PARSE-N-TRIPLE", 2, 0, false);
        declareFunction(me, "tokenize_n_triple", "TOKENIZE-N-TRIPLE", 1, 0, false);
        declareFunction(me, "resolve_n_subject", "RESOLVE-N-SUBJECT", 2, 0, false);
        declareFunction(me, "resolve_n_predicate", "RESOLVE-N-PREDICATE", 1, 0, false);
        declareFunction(me, "resolve_n_object", "RESOLVE-N-OBJECT", 2, 0, false);
        declareFunction(me, "resolve_n_uriref", "RESOLVE-N-URIREF", 1, 0, false);
        declareFunction(me, "resolve_n_literal", "RESOLVE-N-LITERAL", 1, 0, false);
        declareFunction(me, "n_triple_string_to_utf8_string", "N-TRIPLE-STRING-TO-UTF8-STRING", 1, 0, false);
        declareFunction(me, "n_triple_string_to_unicode_vector", "N-TRIPLE-STRING-TO-UNICODE-VECTOR", 1, 0, false);
        declareFunction(me, "resolve_n_node_id", "RESOLVE-N-NODE-ID", 2, 0, false);
        declareFunction(me, "test_rdf_n_triples_parser", "TEST-RDF-N-TRIPLES-PARSER", 0, 0, false);
        return NIL;
    }
