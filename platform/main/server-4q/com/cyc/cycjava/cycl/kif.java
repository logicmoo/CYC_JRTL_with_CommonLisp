...
public final class kif extends SubLTranslatedFile {
    ...
    public static SubLObject kif_term_p(final SubLObject v_object) {
        return v_object.getClass() == kif.$kif_term_native.class ? T : NIL;
    }

    public static SubLObject kif_print_string(final SubLObject v_object) {
        assert NIL != kif_term_p(v_object) : "kif.kif_term_p(v_object) " + "CommonSymbols.NIL != kif.kif_term_p(v_object) " + v_object;
    ...
    public static SubLObject make_kif_term(SubLObject arglist) {
        ...
        final SubLObject v_new = new kif.$kif_term_native();
        SubLObject next;
    ...
    public static final class $kif_term_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(kif.$kif_term_native.class, KIF_TERM, KIF_TERM_P, $list64, $list65, new String[]{ "$print_string" }, $list66, $list67, PRINT_KIF_TERM);
        }
    }
