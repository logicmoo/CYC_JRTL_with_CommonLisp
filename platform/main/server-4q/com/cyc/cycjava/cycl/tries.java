...
import static com.cyc.cycjava.cycl.tries.*;
...
public final class tries extends SubLTranslatedFile {
    ...
    public static SubLObject trie_p(final SubLObject v_object) {
        return v_object.getClass() == tries.$trie_native.class ? T : NIL;
    }

    public static SubLObject trie_name(final SubLObject v_object) {
        assert NIL != trie_p(v_object) : "tries.trie_p(v_object) " + "CommonSymbols.NIL != tries.trie_p(v_object) " + v_object;
    ...
    public static SubLObject make_trie(SubLObject arglist) {
        ...
        final SubLObject v_new = new tries.$trie_native();
        SubLObject next;
    ...
    public static final class $trie_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(tries.$trie_native.class, TRIE, TRIE_P, $list3, $list4, new String[]{ "$name", "$top_node", "$unique", "$case_sensitive", "$entry_test_func", "$multi", "$multi_keys", "$multi_key_func" }, $list5, $list6, PRINT_TRIE);
        }
    }
