...
import static com.cyc.cycjava.cycl.rbp_rule_bank.*;
...
public final class rbp_rule_bank extends SubLTranslatedFile {
    ...
    // deflexical
    private static final SubLSymbol $rbp_rb_initializedP$ = makeSymbol("*RBP-RB-INITIALIZED?*");
    ...
    public static final SubLSymbol $sym2$_RBP_RB_INITIALIZED__ = makeSymbol("*RBP-RB-INITIALIZED?*");

    public static final SubLString $$$RBP_Rule_Bank_Lock = makeString("RBP Rule Bank Lock");



    public static final SubLList $list5 = list(makeSymbol("*RBP-RULE-BANK-LOCK*"));

    public static final SubLList $list6 = list(makeKeyword("PRED"), makeKeyword("POS"), makeKeyword("WU"));

    public static final SubLList $list7 = list(makeKeyword("GENL"), makeKeyword("TYPE-GENL"), makeKeyword("ISA"), makeKeyword("EQL"));

    public static final SubLList $list8 = list(makeKeyword("WU"), makeKeyword("GENL"), makeKeyword("TYPE-GENL"), makeKeyword("ISA"), makeKeyword("EQL"));

    public static final SubLList $list9 = list(makeKeyword("POS"), makeKeyword("PRED"));

    public static final SubLList $list10 = list(list(makeSymbol("TYPE"), makeSymbol("&KEY"), makeSymbol("DONE"), list(makeSymbol("MODE"), makeKeyword("ALL"))), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList $list11 = list(makeKeyword("DONE"), makeKeyword("MODE"));
    ...
    public static final SubLSymbol $sym16$SYNTACTIC_TYPES = makeUninternedSymbol("SYNTACTIC-TYPES");

    public static final SubLSymbol $sym17$SEMANTIC_TYPES = makeUninternedSymbol("SEMANTIC-TYPES");

    public static final SubLSymbol $sym18$OPEN_TYPES = makeUninternedSymbol("OPEN-TYPES");

    public static final SubLSymbol $sym19$CLOSED_TYPES = makeUninternedSymbol("CLOSED-TYPES");



    public static final SubLList $list21 = list(makeSymbol("*RBP-SYNTACTIC-CONSTRAINT-TYPES*"));

    public static final SubLList $list22 = list(makeSymbol("*RBP-SEMANTIC-CONSTRAINT-TYPES*"));

    public static final SubLList $list23 = list(makeSymbol("*RBP-OPEN-CLASS-CONSTRAINT-TYPES*"));

    public static final SubLList $list24 = list(makeSymbol("*RBP-CLOSED-CLASS-CONSTRAINT-TYPES*"));





    public static final SubLList $list27 = list(makeKeyword("ALL"));

    public static final SubLList $list28 = list(makeKeyword("SYNTACTIC"));



    public static final SubLList $list30 = list(makeKeyword("SEMANTIC"));

    public static final SubLList $list31 = list(makeKeyword("OPEN-CLASS"));

    public static final SubLList $list32 = list(makeKeyword("CLOSED-CLASS"));

    public static final SubLList $list33 = list(makeKeyword("HEAD"), makeKeyword("MODIFIER"));

    public static final SubLList $list34 = list(list(makeKeyword("TEST"), makeSymbol("RBP-SYNTACTIC-CONSTRAINT-TYPE-P")), makeKeyword("ANYTHING"), makeKeyword("ANYTHING"));

    public static final SubLList $list35 = list(makeKeyword("WU"), makeKeyword("ANYTHING"), makeKeyword("ANYTHING"));

    public static final SubLList $list36 = list(makeKeyword("OR"), list(list(makeKeyword("TEST"), makeSymbol("RBP-SEMANTIC-CONSTRAINT-TYPE-P")), makeKeyword("ANYTHING"), makeKeyword("ANYTHING")), list(reader_make_constant_shell(makeString("FormulaArgFn")), list(makeKeyword("TEST"), makeSymbol("POSITIVE-INTEGER-P")), list(makeKeyword("TEST"), makeSymbol("RBP-SEMANTIC-CONSTRAINT-P"))));

    public static final SubLSymbol RECURSIVE_BLOCK_PARSER_RULE = makeSymbol("RECURSIVE-BLOCK-PARSER-RULE");

    public static final SubLSymbol RECURSIVE_BLOCK_PARSER_RULE_P = makeSymbol("RECURSIVE-BLOCK-PARSER-RULE-P");

    public static final SubLList $list39 = list(makeSymbol("CYCL"), makeSymbol("FILTER-LAYERS"));

    public static final SubLList $list40 = list(makeKeyword("CYCL"), makeKeyword("FILTER-LAYERS"));

    public static final SubLList $list41 = list(makeSymbol("RBP-RULE-CYCL"), makeSymbol("RBP-RULE-FILTER-LAYERS"));

    public static final SubLList $list42 = list(makeSymbol("_CSETF-RBP-RULE-CYCL"), makeSymbol("_CSETF-RBP-RULE-FILTER-LAYERS"));

    public static final SubLSymbol PPRINT_RBP_RULE = makeSymbol("PPRINT-RBP-RULE");

    public static final SubLSymbol RECURSIVE_BLOCK_PARSER_RULE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("RECURSIVE-BLOCK-PARSER-RULE-PRINT-FUNCTION-TRAMPOLINE");
    ...
    public static final SubLList $list82 = list(makeKeyword("EXCLUDE"), makeKeyword("ANYTHING"));
    ...
    public static final SubLList $list86 = list(makeString("NCNotEqualsConstraintFn"), makeString("NCNotIsaConstraintFn"), makeString("NCNotGenlsConstraintFn"));

    private static final SubLList $list87 = list(cons(makeString("NCNotEqualsConstraintFn"), reader_make_constant_shell(makeString("NCEqualsConstraintFn"))), cons(makeString("NCNotIsaConstraintFn"), reader_make_constant_shell(makeString("NCIsaConstraintFn"))), cons(makeString("NCNotGenlsConstraintFn"), reader_make_constant_shell(makeString("NCGenlsConstraintFn"))));

    private static final SubLSymbol RBP_FORTS_TO_KEYWORDS = makeSymbol("RBP-FORTS-TO-KEYWORDS");



    public static final SubLList $list90 = list(cons(reader_make_constant_shell(makeString("NCPOSConstraintFn")), makeKeyword("POS")), cons(reader_make_constant_shell(makeString("NCPOSPredConstraintFn")), makeKeyword("PRED")), cons(reader_make_constant_shell(makeString("NCEqualsConstraintFn")), makeKeyword("EQL")), cons(reader_make_constant_shell(makeString("NCGenlsConstraintFn")), makeKeyword("GENL")), cons(reader_make_constant_shell(makeString("NCIsaConstraintFn")), makeKeyword("ISA")), cons(reader_make_constant_shell(makeString("TheNCHead")), makeKeyword("HEAD")), cons(reader_make_constant_shell(makeString("TheNCModifier")), makeKeyword("MODIFIER")));
    ...
    private static final SubLList $list95 = list(makeKeyword("ISA"), makeKeyword("GENL"));
    ...
    public static final SubLList $list109 = list(list(reader_make_constant_shell(makeString("genls")), makeSymbol("?SPEC"), makeSymbol("?TYPE")));
    ...
    private static final SubLList $list114 = list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("assertedSentence")), list(reader_make_constant_shell(makeString("isaConstraintForNCR")), makeSymbol("?RULE"), makeSymbol("?INDEXICAL"), makeSymbol("?COL"))), list(reader_make_constant_shell(makeString("genls")), makeSymbol("?COL"), reader_make_constant_shell(makeString("CharacterString"))));
    ...
    public static SubLObject recursive_block_parser_rule_p(final SubLObject v_object) {
        return v_object.getClass() == rbp_rule_bank.$recursive_block_parser_rule_native.class ? T : NIL;
    }

    public static SubLObject rbp_rule_cycl(final SubLObject v_object) {
        assert NIL != recursive_block_parser_rule_p(v_object) : "rbp_rule_bank.recursive_block_parser_rule_p(v_object) " + "CommonSymbols.NIL != rbp_rule_bank.recursive_block_parser_rule_p(v_object) " + v_object;
    ...
    public static SubLObject make_recursive_block_parser_rule(SubLObject arglist) {
        ...
        final SubLObject v_new = new rbp_rule_bank.$recursive_block_parser_rule_native();
        SubLObject next;
    ...
    public static SubLObject rbp_rule_constraints(final SubLObject rule_cycl) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != indexed_term_p(rule_cycl) : "kb_indexing_datastructures.indexed_term_p(rule_cycl) " + "CommonSymbols.NIL != kb_indexing_datastructures.indexed_term_p(rule_cycl) " + rule_cycl;
        if (NIL == rule_cycl) {
            return NIL;
        }
        SubLObject ans = NIL;
    ...
    public static SubLObject declare_rbp_rule_bank_file() {
        declareFunction(me, "rbp_new_rule_bank", "RBP-NEW-RULE-BANK", 0, 0, false);
        declareFunction(me, "note_rbp_rb_initialized", "NOTE-RBP-RB-INITIALIZED", 0, 0, false);
        declareMacro(me, "with_rbp_rule_bank_lock_held", "WITH-RBP-RULE-BANK-LOCK-HELD");
        declareMacro(me, "do_rbp_constraint_types", "DO-RBP-CONSTRAINT-TYPES");
        declareFunction(me, "rbp_syntactic_constraint_type_p", "RBP-SYNTACTIC-CONSTRAINT-TYPE-P", 1, 0, false);
        declareFunction(me, "rbp_semantic_constraint_type_p", "RBP-SEMANTIC-CONSTRAINT-TYPE-P", 1, 0, false);
        declareFunction(me, "rbp_syntactic_constraint_p", "RBP-SYNTACTIC-CONSTRAINT-P", 1, 0, false);
        declareFunction(me, "rbp_word_unit_constraint_p", "RBP-WORD-UNIT-CONSTRAINT-P", 1, 0, false);
        declareFunction(me, "rbp_semantic_constraint_p", "RBP-SEMANTIC-CONSTRAINT-P", 1, 0, false);
        declareFunction(me, "recursive_block_parser_rule_print_function_trampoline", "RECURSIVE-BLOCK-PARSER-RULE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "recursive_block_parser_rule_p", "RECURSIVE-BLOCK-PARSER-RULE-P", 1, 0, false);
        new rbp_rule_bank.$recursive_block_parser_rule_p$UnaryFunction();
        declareFunction(me, "rbp_rule_cycl", "RBP-RULE-CYCL", 1, 0, false);
        declareFunction(me, "rbp_rule_filter_layers", "RBP-RULE-FILTER-LAYERS", 1, 0, false);
        declareFunction(me, "_csetf_rbp_rule_cycl", "_CSETF-RBP-RULE-CYCL", 2, 0, false);
        declareFunction(me, "_csetf_rbp_rule_filter_layers", "_CSETF-RBP-RULE-FILTER-LAYERS", 2, 0, false);
        declareFunction(me, "make_recursive_block_parser_rule", "MAKE-RECURSIVE-BLOCK-PARSER-RULE", 0, 1, false);
        declareFunction(me, "visit_defstruct_recursive_block_parser_rule", "VISIT-DEFSTRUCT-RECURSIVE-BLOCK-PARSER-RULE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_recursive_block_parser_rule_method", "VISIT-DEFSTRUCT-OBJECT-RECURSIVE-BLOCK-PARSER-RULE-METHOD", 2, 0, false);
        declareFunction(me, "pprint_rbp_rule", "PPRINT-RBP-RULE", 1, 2, false);
        declareFunction(me, "new_rbp_rule", "NEW-RBP-RULE", 1, 0, false);
        declareFunction(me, "rbp_rule_note_cycl", "RBP-RULE-NOTE-CYCL", 2, 0, false);
        declareFunction(me, "rbp_find_or_create_rule_from_cycl", "RBP-FIND-OR-CREATE-RULE-FROM-CYCL", 1, 0, false);
        declareFunction(me, "rbp_find_rule_from_cycl", "RBP-FIND-RULE-FROM-CYCL", 1, 1, false);
        declareFunction(me, "rbp_find_rule_from_cycl_w_initialized_rb", "RBP-FIND-RULE-FROM-CYCL-W-INITIALIZED-RB", 1, 0, false);
        declareFunction(me, "rbp_find_cycl_from_rule", "RBP-FIND-CYCL-FROM-RULE", 1, 0, false);
        declareFunction(me, "rbp_rb_filters", "RBP-RB-FILTERS", 0, 0, false);
        declareFunction(me, "rbp_rb_add_filter", "RBP-RB-ADD-FILTER", 2, 0, false);
        declareFunction(me, "rbp_rb_rule_count", "RBP-RB-RULE-COUNT", 0, 0, false);
        declareFunction(me, "rbp_rb_all_rules", "RBP-RB-ALL-RULES", 0, 0, false);
        declareFunction(me, "clear_rbp_rb_all_rules_sorted", "CLEAR-RBP-RB-ALL-RULES-SORTED", 0, 0, false);
        declareFunction(me, "remove_rbp_rb_all_rules_sorted", "REMOVE-RBP-RB-ALL-RULES-SORTED", 0, 0, false);
        declareFunction(me, "rbp_rb_all_rules_sorted_internal", "RBP-RB-ALL-RULES-SORTED-INTERNAL", 0, 0, false);
        declareFunction(me, "rbp_rb_all_rules_sorted", "RBP-RB-ALL-RULES-SORTED", 0, 0, false);
        declareFunction(me, "sort_rbp_rules", "SORT-RBP-RULES", 1, 0, false);
        declareFunction(me, "rbp_rule_L", "RBP-RULE-<", 2, 0, false);
        new rbp_rule_bank.$rbp_rule_L$BinaryFunction();
        declareFunction(me, "rbp_rules_sortedP", "RBP-RULES-SORTED?", 1, 0, false);
        declareFunction(me, "rbp_rb_new_filter", "RBP-RB-NEW-FILTER", 1, 0, false);
        declareFunction(me, "rbp_rb_filter_layers_set", "RBP-RB-FILTER-LAYERS-SET", 1, 0, false);
        declareFunction(me, "rbp_rb_filter_exclusions_layer", "RBP-RB-FILTER-EXCLUSIONS-LAYER", 1, 0, false);
        declareFunction(me, "rbp_rb_filter_has_exclusions_p", "RBP-RB-FILTER-HAS-EXCLUSIONS-P", 1, 0, false);
        declareFunction(me, "rbp_rb_filter_layers_list", "RBP-RB-FILTER-LAYERS-LIST", 1, 0, false);
        declareFunction(me, "rbp_rb_filter_add_layer", "RBP-RB-FILTER-ADD-LAYER", 2, 0, false);
        declareFunction(me, "rbp_rb_filter_add_excluded_value", "RBP-RB-FILTER-ADD-EXCLUDED-VALUE", 3, 0, false);
        declareFunction(me, "rbp_rb_find_or_create_filter_for_key", "RBP-RB-FIND-OR-CREATE-FILTER-FOR-KEY", 1, 0, false);
        declareFunction(me, "rbp_rb_fn_for_filter_key", "RBP-RB-FN-FOR-FILTER-KEY", 1, 0, false);
        declareFunction(me, "rbp_rb_new_layer", "RBP-RB-NEW-LAYER", 0, 0, false);
        declareFunction(me, "rbp_rb_layer_dictionary", "RBP-RB-LAYER-DICTIONARY", 1, 0, false);
        declareFunction(me, "rbp_rb_layer_note_rule_to_check", "RBP-RB-LAYER-NOTE-RULE-TO-CHECK", 2, 0, false);
        declareFunction(me, "rbp_rb_layer_exempt_ruleP", "RBP-RB-LAYER-EXEMPT-RULE?", 2, 0, false);
        declareFunction(me, "rbp_rb_layer_search", "RBP-RB-LAYER-SEARCH", 2, 0, false);
        declareFunction(me, "rbp_rb_layer_search_indeterminate", "RBP-RB-LAYER-SEARCH-INDETERMINATE", 3, 0, false);
        declareFunction(me, "rbp_rb_layer_search_one", "RBP-RB-LAYER-SEARCH-ONE", 2, 0, false);
        declareFunction(me, "rbp_rb_layer_note_value", "RBP-RB-LAYER-NOTE-VALUE", 3, 0, false);
        declareFunction(me, "rbp_rb_layer_add_ok_value", "RBP-RB-LAYER-ADD-OK-VALUE", 3, 0, false);
        declareFunction(me, "rbp_rb_layer_add_excluded_value", "RBP-RB-LAYER-ADD-EXCLUDED-VALUE", 3, 0, false);
        declareFunction(me, "rbp_rb_check_initialization", "RBP-RB-CHECK-INITIALIZATION", 0, 0, false);
        declareFunction(me, "rbp_clear_rule_bank", "RBP-CLEAR-RULE-BANK", 0, 0, false);
        declareFunction(me, "rbp_clear_rule_bank_internal", "RBP-CLEAR-RULE-BANK-INTERNAL", 0, 0, false);
        declareFunction(me, "rbp_rb_initialize", "RBP-RB-INITIALIZE", 0, 0, false);
        declareFunction(me, "rbp_rb_update", "RBP-RB-UPDATE", 1, 0, false);
        declareFunction(me, "rbp_rb_update_all_filters", "RBP-RB-UPDATE-ALL-FILTERS", 1, 0, false);
        declareFunction(me, "rbp_rb_update_filter", "RBP-RB-UPDATE-FILTER", 2, 1, false);
        declareFunction(me, "rbp_rb_excluded_value_p", "RBP-RB-EXCLUDED-VALUE-P", 1, 0, false);
        declareFunction(me, "rbp_rb_make_excluded_value", "RBP-RB-MAKE-EXCLUDED-VALUE", 1, 0, false);
        declareFunction(me, "rbp_rb_excluded_value_term", "RBP-RB-EXCLUDED-VALUE-TERM", 1, 0, false);
        declareFunction(me, "rbp_rule_constraints", "RBP-RULE-CONSTRAINTS", 1, 0, false);
        declareFunction(me, "rbp_canonicalize_constraint", "RBP-CANONICALIZE-CONSTRAINT", 1, 0, false);
        declareFunction(me, "rbp_negative_constraint_fn_p", "RBP-NEGATIVE-CONSTRAINT-FN-P", 1, 0, false);
        declareFunction(me, "rbp_positive_correlate_of_negative_constraint_fn", "RBP-POSITIVE-CORRELATE-OF-NEGATIVE-CONSTRAINT-FN", 1, 0, false);
        declareFunction(me, "rbp_canonicalize_negative_constraint", "RBP-CANONICALIZE-NEGATIVE-CONSTRAINT", 1, 0, false);
        declareFunction(me, "rbp_forts_to_keywords", "RBP-FORTS-TO-KEYWORDS", 1, 0, false);
        declareFunction(me, "rbp_fort_to_keyword", "RBP-FORT-TO-KEYWORD", 1, 0, false);
        declareFunction(me, "rbp_term_keyword_map", "RBP-TERM-KEYWORD-MAP", 0, 0, false);
        declareFunction(me, "initialize_rbp_term_keyword_map", "INITIALIZE-RBP-TERM-KEYWORD-MAP", 0, 0, false);
        declareFunction(me, "rbp_keyword_for_term", "RBP-KEYWORD-FOR-TERM", 1, 0, false);
        declareFunction(me, "rbp_rb_filter_rules", "RBP-RB-FILTER-RULES", 4, 0, false);
        declareFunction(me, "rbp_rb_layer_exempt_rule_lambdaP", "RBP-RB-LAYER-EXEMPT-RULE-LAMBDA?", 1, 0, false);
        new rbp_rule_bank.$rbp_rb_layer_exempt_rule_lambdaP$UnaryFunction();
        declareFunction(me, "rbp_rb_exempt_rules", "RBP-RB-EXEMPT-RULES", 2, 0, false);
        declareFunction(me, "rbp_rb_exempt_rules_reporting_failures", "RBP-RB-EXEMPT-RULES-REPORTING-FAILURES", 6, 0, false);
        declareFunction(me, "rbp_report_failed_rule", "RBP-REPORT-FAILED-RULE", 3, 0, false);
        declareFunction(me, "rbp_rb_keys_from_base", "RBP-RB-KEYS-FROM-BASE", 2, 0, false);
        declareFunction(me, "rbp_rb_keys_from_base_int_internal", "RBP-RB-KEYS-FROM-BASE-INT-INTERNAL", 2, 0, false);
        declareFunction(me, "rbp_rb_keys_from_base_int", "RBP-RB-KEYS-FROM-BASE-INT", 2, 0, false);
        declareFunction(me, "rbp_rb_rule_term_table", "RBP-RB-RULE-TERM-TABLE", 1, 0, false);
        declareFunction(me, "rbp_rb_rule_term_table_lookup", "RBP-RB-RULE-TERM-TABLE-LOOKUP", 2, 0, false);
        declareFunction(me, "rbp_rb_all_genls", "RBP-RB-ALL-GENLS", 1, 0, false);
        declareFunction(me, "rbp_rb_all_type_genls", "RBP-RB-ALL-TYPE-GENLS", 1, 0, false);
        declareFunction(me, "rbp_rb_all_isa", "RBP-RB-ALL-ISA", 1, 0, false);
        declareFunction(me, "clear_noun_compound_constraint_string_specs", "CLEAR-NOUN-COMPOUND-CONSTRAINT-STRING-SPECS", 0, 0, false);
        declareFunction(me, "remove_noun_compound_constraint_string_specs", "REMOVE-NOUN-COMPOUND-CONSTRAINT-STRING-SPECS", 0, 0, false);
        declareFunction(me, "noun_compound_constraint_string_specs_internal", "NOUN-COMPOUND-CONSTRAINT-STRING-SPECS-INTERNAL", 0, 0, false);
        declareFunction(me, "noun_compound_constraint_string_specs", "NOUN-COMPOUND-CONSTRAINT-STRING-SPECS", 0, 0, false);
        return NIL;
    }
    ...
    public static SubLObject setup_rbp_rule_bank_file() {
        ...
        declare_defglobal($sym2$_RBP_RB_INITIALIZED__);
    ...
    public static final class $recursive_block_parser_rule_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rbp_rule_bank.$recursive_block_parser_rule_native.class, RECURSIVE_BLOCK_PARSER_RULE, RECURSIVE_BLOCK_PARSER_RULE_P, $list39, $list40, new String[]{ "$cycl", "$filter_layers" }, $list41, $list42, PPRINT_RBP_RULE);
        }
    }
