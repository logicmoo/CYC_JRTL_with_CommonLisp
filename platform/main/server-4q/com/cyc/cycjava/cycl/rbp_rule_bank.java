...
import static com.cyc.cycjava.cycl.rbp_rule_bank.*; 
 public final class rbp_rule_bank extends SubLTranslatedFile {
    ...
    public static SubLObject rbp_rule_cycl(final SubLObject v_object) {
        assert NIL != recursive_block_parser_rule_p(v_object) : "rbp_rule_bank.recursive_block_parser_rule_p error :" + v_object;
    ...
    public static final class $recursive_block_parser_rule_native extends SubLStructNative {
        ...
        private $recursive_block_parser_rule_native() {
            this.$cycl = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative($recursive_block_parser_rule_native.class, RECURSIVE_BLOCK_PARSER_RULE, RECURSIVE_BLOCK_PARSER_RULE_P, $list39, $list40, new String[]{ "$cycl", "$filter_layers" }, $list41, $list42, PPRINT_RBP_RULE);
        }
    }
