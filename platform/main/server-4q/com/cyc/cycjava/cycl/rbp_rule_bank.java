...
public final class rbp_rule_bank
    extends
      SubLTranslatedFile
{
  ...
  {
    return dictionary.new_dictionary( Symbols.symbol_function( EQUAL ), SIXTEEN_INTEGER );
  }
  ...
  public static SubLObject with_rbp_rule_bank_lock_held(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.listS( $sym4$WITH_LOCK_HELD, $list5, ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject do_rbp_constraint_types(final SubLObject macroform, final SubLObject environment)
  {
    ...
    final SubLObject mode_tail = cdestructuring_bind.property_list_member( $kw14$MODE, current );
    final SubLObject mode = ( NIL != mode_tail ) ? conses_high.cadr( mode_tail ) : $kw15$ALL;
    final SubLObject body;
    current = ( body = temp );
    ...
    return ConsesLow.list( $sym20$CLET, ConsesLow.list( reader.bq_cons( syntactic_types, $list21 ), reader.bq_cons( semantic_types, $list22 ), reader.bq_cons( open_types, $list23 ), reader.bq_cons( closed_types,
        $list24 ) ), ConsesLow.list( $sym25$PWHEN, ConsesLow.list( $sym26$COR, ConsesLow.listS( EQL, mode, $list27 ), ConsesLow.listS( EQL, mode, $list28 ) ), ConsesLow.listS( $sym29$CSOME, ConsesLow.list( type,
            syntactic_types, done ), ConsesLow.append( body, NIL ) ) ), ConsesLow.list( $sym25$PWHEN, ConsesLow.list( $sym26$COR, ConsesLow.listS( EQL, mode, $list27 ), ConsesLow.listS( EQL, mode, $list30 ) ), ConsesLow
                .listS( $sym29$CSOME, ConsesLow.list( type, semantic_types, done ), ConsesLow.append( body, NIL ) ) ), ConsesLow.list( $sym25$PWHEN, ConsesLow.listS( EQL, mode, $list31 ), ConsesLow.listS( $sym29$CSOME,
                    ConsesLow.list( type, open_types, done ), ConsesLow.append( body, NIL ) ) ), ConsesLow.list( $sym25$PWHEN, ConsesLow.listS( EQL, mode, $list32 ), ConsesLow.listS( $sym29$CSOME, ConsesLow.list( type,
                        closed_types, done ), ConsesLow.append( body, NIL ) ) ) );
  }
  ...
  {
    return ( v_object.getClass() == $recursive_block_parser_rule_native.class ) ? T : NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/rbp-rule-bank.lisp", position = 4492L)
  public static SubLObject rbp_rule_cycl(final SubLObject v_object)
  {
    assert NIL != recursive_block_parser_rule_p( v_object ) : v_object;
  ...
  public static SubLObject make_recursive_block_parser_rule(SubLObject arglist)
  {
    ...
    final SubLObject v_new = new $recursive_block_parser_rule_native();
    SubLObject next;
    ...
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      if( pcase_var.eql( $kw50$CYCL ) )
      {
        _csetf_rbp_rule_cycl( v_new, current_value );
      }
      else if( pcase_var.eql( $kw51$FILTER_LAYERS ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw53$BEGIN, $sym54$MAKE_RECURSIVE_BLOCK_PARSER_RULE, TWO_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw55$SLOT, $kw50$CYCL, rbp_rule_cycl( obj ) );
    Functions.funcall( visitor_fn, obj, $kw55$SLOT, $kw51$FILTER_LAYERS, rbp_rule_filter_layers( obj ) );
    Functions.funcall( visitor_fn, obj, $kw56$END, $sym54$MAKE_RECURSIVE_BLOCK_PARSER_RULE, TWO_INTEGER );
    return obj;
  }
  ...
  public static SubLObject pprint_rbp_rule(final SubLObject rbp_rule, SubLObject stream, SubLObject depth)
  {
    ...
    PrintLow.format( stream, $str58$__RBP_RULE__S_, rbp_rule_cycl( rbp_rule ) );
    return rbp_rule;
  }
  ...
  {
    final SubLObject rule = make_recursive_block_parser_rule( ConsesLow.list( $kw50$CYCL, cycl, $kw51$FILTER_LAYERS, set.new_set( Symbols.symbol_function( EQL ), UNPROVIDED ) ) );
  ...
  public static SubLObject rbp_rb_rule_count()
  {
    ...
    try
    {
      release = Locks.seize_lock( $rbp_rule_bank_lock$.getGlobalValue() );
    ...
    finally
    {
      if( NIL != release )
      {
        Locks.release_lock( $rbp_rule_bank_lock$.getGlobalValue() );
      }
    }
    return count;
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $rbp_rb_all_rules_sorted_caching_state$.getGlobalValue(), ConsesLow.list( EMPTY_SUBL_OBJECT_ARRAY ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject rbp_rb_all_rules_sorted()
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym59$RBP_RB_ALL_RULES_SORTED, $sym60$_RBP_RB_ALL_RULES_SORTED_CACHING_STATE_, NIL, EQL, ZERO_INTEGER, ZERO_INTEGER );
    }
    SubLObject results = memoization_state.caching_state_get_zero_arg_results( caching_state, UNPROVIDED );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( rbp_rb_all_rules_sorted_internal() ) );
  ...
  public static SubLObject rbp_rules_sortedP(final SubLObject rules)
  {
    ...
    if( NIL == problemP )
    {
      ...
      SubLObject rule;
      for( csome_list_var = rules, rule = NIL, rule = csome_list_var.first(); NIL == problemP && NIL != csome_list_var; problemP = makeBoolean( NIL != prev && NIL == rbp_rule_L( prev,
          rule ) ), csome_list_var = csome_list_var.rest(), rule = csome_list_var.first() )
      {
      }
    }
  ...
  {
    return ConsesLow.list( set_utilities.new_singleton_set( rbp_rb_new_layer(), Symbols.symbol_function( EQUAL ) ), $kw62$NO_EXCLUSIONS, rbp_rb_fn_for_filter_key( filter_key ) );
  }
  ...
  public static SubLObject rbp_rb_filter_add_excluded_value(final SubLObject filter, final SubLObject v_term, final SubLObject rbp_rule)
  {
    ...
    if( NIL == dictionary.dictionary_p( exclusions_layer ) )
    {
      ...
      ConsesLow.set_nth( ONE_INTEGER, filter, exclusions_layer );
    }
  ...
  public static SubLObject rbp_rb_fn_for_filter_key(final SubLObject filter_key)
  {
    ...
    if( pcase_var.eql( $kw63$PRED ) )
    {
      return $sym64$ALL_GENL_PREDS;
    }
    if( pcase_var.eql( $kw65$POS ) || pcase_var.eql( $kw66$GENL ) )
    {
      return $sym67$RBP_RB_ALL_GENLS;
    }
    if( pcase_var.eql( $kw68$TYPE_GENL ) )
    {
      return $sym69$RBP_RB_ALL_TYPE_GENLS;
    }
    if( pcase_var.eql( $kw70$ISA ) )
    {
      return $sym71$RBP_RB_ALL_ISA;
    }
    return $sym72$LIST;
  }
  ...
  {
    return dictionary.new_dictionary( Symbols.symbol_function( EQUALP ), $int73$256 );
  }
  ...
  public static SubLObject rbp_rb_layer_search(final SubLObject keys_to_check, final SubLObject layer)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      while ( NIL != cdolist_list_var_$2)
      {
        ...
        if( NIL == conses_high.member( item_var, hits, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
        {
          hits = ConsesLow.cons( item_var, hits );
        }
  ...
  public static SubLObject rbp_rb_layer_search_indeterminate(final SubLObject indeterminate_term, final SubLObject c_type, final SubLObject layer)
  {
        ...
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      ...
      thread.resetMultipleValues();
      SubLObject okP = NIL;
      final SubLObject key_defining_mts = rbp_wff.rbp_defining_mts( ConsesLow.list( indeterminate_term, key ) );
      if( NIL == okP )
      {
        ...
        while ( NIL == okP && NIL != csome_list_var)
        {
          ...
          else if( c_type.eql( $kw66$GENL ) && NIL == rbp_wff.rbp_wff_test_failsP( $sym76$NPP_GENL_, indeterminate_term, key, UNPROVIDED ) )
          {
            okP = T;
          }
  ...
  public static SubLObject rbp_rb_initialize()
  {
    ...
    try
    {
      ...
      try
      {
        ...
        final SubLObject rules = cdolist_list_var = isa.all_fort_instances( $const77$NounCompoundRule, UNPROVIDED, UNPROVIDED );
        SubLObject rule = NIL;
        rule = cdolist_list_var.first();
        while ( NIL != cdolist_list_var)
        {
  ...
  public static SubLObject rbp_rb_update_all_filters(final SubLObject rule_cycl)
  {
    ...
    if( $kw15$ALL.eql( $kw15$ALL ) || $kw15$ALL.eql( $kw78$SYNTACTIC ) )
    {
    ...
    if( $kw15$ALL.eql( $kw15$ALL ) || $kw15$ALL.eql( $kw79$SEMANTIC ) )
    {
    ...
    if( $kw15$ALL.eql( $kw80$OPEN_CLASS ) )
    {
    ...
    if( $kw15$ALL.eql( $kw81$CLOSED_CLASS ) )
    {
  ...
  public static SubLObject rbp_rb_update_filter(final SubLObject filter_key, final SubLObject rule_cycl, SubLObject table)
  {
    ...
    while ( NIL != this_layer || NIL != value)
    {
      if( NIL == value_$3 )
      {
        new_layers = ConsesLow.cons( this_layer_$4, new_layers );
      }
      else if( NIL != rbp_rb_excluded_value_p( value_$3 ) )
      {
      ...
      else
      {
        ...
        new_layers = ConsesLow.cons( rbp_rb_layer_add_ok_value( this_layer_$4, value_$3, rbp_rule ), new_layers );
      }
      value = value.rest();
      value_$3 = value.first();
  ...
  {
    return ConsesLow.list( $kw83$EXCLUDE, v_term );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != kb_indexing_datastructures.indexed_term_p( rule_cycl ) : rule_cycl;
    if( NIL == rule_cycl )
    {
      return NIL;
    }
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      SubLObject cdolist_list_var = kb_mapping_utilities.pred_values( rule_cycl, $const85$ncRuleConstraint, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      SubLObject raw_constraint = NIL;
      raw_constraint = cdolist_list_var.first();
      while ( NIL != cdolist_list_var)
      {
        ans = ConsesLow.cons( rbp_forts_to_keywords( rbp_canonicalize_constraint( raw_constraint ) ), ans );
        cdolist_list_var = cdolist_list_var.rest();
        raw_constraint = cdolist_list_var.first();
      }
    }
  ...
  {
    return makeBoolean( NIL != constant_handles.constant_p( v_object ) && NIL != conses_high.member( constants_high.constant_name( v_object ), $list86, Symbols.symbol_function( EQUAL ), UNPROVIDED ) );
  }
  ...
  {
    return list_utilities.alist_lookup( $list87, constants_high.constant_name( negative_fn ), Symbols.symbol_function( EQUAL ), UNPROVIDED );
  }
  ...
  public static SubLObject rbp_canonicalize_negative_constraint(final SubLObject naut)
  {
    ...
    return el_utilities.replace_formula_arg( ZERO_INTEGER, positive_fn, el_utilities.replace_formula_arg( TWO_INTEGER, excluded_value, naut ) );
  }
  ...
  {
    return formula.isAtom() ? rbp_fort_to_keyword( formula ) : Mapping.mapcar( $sym88$RBP_FORTS_TO_KEYWORDS, formula );
  }
  ...
  public static SubLObject initialize_rbp_term_keyword_map()
  {
    ...
    SubLObject cdolist_list_var = ConsesLow.list( ConsesLow.list( constants_high.find_constant( $str92$NCWordUnitConstraintFn ), $kw93$WU ), ConsesLow.list( constants_high.find_constant( $str94$NCTypeGenlsConstraintFn ),
        $kw68$TYPE_GENL ) );
    SubLObject pair = NIL;
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        if( NIL != constant_handles.valid_constantP( new_constraint_type, UNPROVIDED ) )
        {
  ...
  public static SubLObject rbp_rb_filter_rules(SubLObject candidate_matches, SubLObject surviving_traced_rules, final SubLObject filter_key, final SubLObject base)
  {
    ...
    final SubLObject indeterminateP = makeBoolean( NIL != subl_promotions.memberP( c_type, $list95, UNPROVIDED, UNPROVIDED ) && NIL != conses_high.member( $const96$IndeterminateTerm, keys_to_check, UNPROVIDED,
        UNPROVIDED ) );
    ...
    SubLObject exempt;
    for( basis_object = set_contents.do_set_contents_basis_object( set_contents_var ), state = NIL, state = set_contents.do_set_contents_initial_state( basis_object, set_contents_var ); NIL == no_matchP
        && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, layer ) )
      {
        ...
        exempt = ( ( NIL != report_failuresP ) ? rbp_rb_exempt_rules_reporting_failures( candidate_matches, surviving_traced_rules, filter_key, base, survivors, layer )
            : rbp_rb_exempt_rules( candidate_matches, layer ) );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        PrintLow.format( T, $str97$__Passed_all__S_constraints_for__, filter_key, rbp_rule_cycl( traced_rule ) );
      }
      else
      {
        new_survivors = Sequences.remove( traced_rule, new_survivors, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject rbp_rb_exempt_rules_reporting_failures(final SubLObject candidate_matches, final SubLObject surviving_traced_rules, final SubLObject filter_key, final SubLObject base,
      final SubLObject survivors, final SubLObject layer)
  {
    SubLObject exempt = NIL;
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != rbp_rb_layer_exempt_ruleP( layer, candidate_match ) )
      {
        ...
        exempt = ConsesLow.cons( candidate_match, exempt );
      }
      else if( NIL == subl_promotions.memberP( candidate_match, survivors, UNPROVIDED, UNPROVIDED ) )
      {
  ...
  public static SubLObject rbp_report_failed_rule(final SubLObject rbp_rule, final SubLObject filter_key, final SubLObject base)
  {
    ...
    PrintLow.format( T, $str99$__The__S_block_s__S_value__S__did, new SubLObject[] { conses_high.second( filter_key ), filter_key.first(), base, constraint_forts, rbp_rule
    } );
    return rbp_rule;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( base.eql( $kw100$ORIGINAL_STRING ) )
    {
      return NIL;
    }
  ...
  public static SubLObject rbp_rb_keys_from_base_int(final SubLObject filter_fn, final SubLObject base)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym103$RBP_RB_KEYS_FROM_BASE_INT, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym103$RBP_RB_KEYS_FROM_BASE_INT, TWO_INTEGER, NIL, EQUAL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym103$RBP_RB_KEYS_FROM_BASE_INT, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( rbp_rb_keys_from_base_int_internal( filter_fn, base ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( filter_fn, base ) );
  ...
  {
    final SubLObject table = Hashtables.make_hash_table( SIXTEEN_INTEGER, Symbols.symbol_function( EQUALP ), UNPROVIDED );
    SubLObject cdolist_list_var;
    ...
    while ( NIL != cdolist_list_var)
    {
      final SubLObject key = conses_high.butlast( clause, UNPROVIDED );
  ...
  {
    return Hashtables.gethash( filter_key, rule_term_table, UNPROVIDED );
  }
  ...
  public static SubLObject rbp_rb_all_type_genls(final SubLObject obj)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject ans = NIL;
    if( NIL != isa.isaP( obj, $const104$CollectionType, UNPROVIDED, UNPROVIDED ) )
    {
      ans = ask_utilities.query_variable( $sym105$_TYPE, ConsesLow.listS( $const106$and, ConsesLow.listS( $const107$typeGenls, obj, $list108 ), $list109 ), parsing_vars.$parsing_domain_mt$.getDynamicValue( thread ),
          UNPROVIDED );
    }
    return ans;
  }
  ...
  public static SubLObject rbp_rb_all_isa(final SubLObject obj)
  {
    ...
    if( NIL == isas )
    {
      ...
      {
        isas = genls.all_genls( $const110$PositiveInteger, UNPROVIDED, UNPROVIDED );
      }
      else if( obj.isString() )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          if( col.eql( $const111$ProperNameString ) )
          {
            if( NIL != Characters.upper_case_p( string_utilities.first_char( obj ) ) || NIL != list_utilities.empty_list_p( lexicon_cache.words_of_string( obj, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) )
            {
              isas = ConsesLow.cons( col, isas );
            }
          }
          else if( NIL != at_defns.quiet_has_typeP( obj, col, UNPROVIDED ) )
          {
            isas = ConsesLow.cons( col, isas );
          }
          cdolist_list_var = cdolist_list_var.rest();
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $noun_compound_constraint_string_specs_caching_state$.getGlobalValue(), ConsesLow.list( EMPTY_SUBL_OBJECT_ARRAY ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/rbp-rule-bank.lisp", position = 25231L)
  public static SubLObject noun_compound_constraint_string_specs_internal()
  {
    return ask_utilities.query_variable( $sym113$_COL, $list114, $const115$InferencePSC, UNPROVIDED );
  }
  ...
  public static SubLObject noun_compound_constraint_string_specs()
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym112$NOUN_COMPOUND_CONSTRAINT_STRING_SPECS, $sym116$_NOUN_COMPOUND_CONSTRAINT_STRING_SPECS_CACHING_STATE_, NIL, EQL, ZERO_INTEGER,
          ZERO_INTEGER );
    }
    SubLObject results = memoization_state.caching_state_get_zero_arg_results( caching_state, UNPROVIDED );
    if( results.eql( memoization_state.$memoized_item_not_found$.getGlobalValue() ) )
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( noun_compound_constraint_string_specs_internal() ) );
      memoization_state.caching_state_set_zero_arg_results( caching_state, results, UNPROVIDED );
    }
    return memoization_state.caching_results( results );
  }
  ...
  {
    SubLFiles.declareFunction( me, "rbp_new_rule_bank", "RBP-NEW-RULE-BANK", 0, 0, false );
    SubLFiles.declareFunction( me, "note_rbp_rb_initialized", "NOTE-RBP-RB-INITIALIZED", 0, 0, false );
    SubLFiles.declareMacro( me, "with_rbp_rule_bank_lock_held", "WITH-RBP-RULE-BANK-LOCK-HELD" );
    SubLFiles.declareMacro( me, "do_rbp_constraint_types", "DO-RBP-CONSTRAINT-TYPES" );
    SubLFiles.declareFunction( me, "rbp_syntactic_constraint_type_p", "RBP-SYNTACTIC-CONSTRAINT-TYPE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_semantic_constraint_type_p", "RBP-SEMANTIC-CONSTRAINT-TYPE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_syntactic_constraint_p", "RBP-SYNTACTIC-CONSTRAINT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_word_unit_constraint_p", "RBP-WORD-UNIT-CONSTRAINT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_semantic_constraint_p", "RBP-SEMANTIC-CONSTRAINT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "recursive_block_parser_rule_print_function_trampoline", "RECURSIVE-BLOCK-PARSER-RULE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "recursive_block_parser_rule_p", "RECURSIVE-BLOCK-PARSER-RULE-P", 1, 0, false );
    new $recursive_block_parser_rule_p$UnaryFunction();
    SubLFiles.declareFunction( me, "rbp_rule_cycl", "RBP-RULE-CYCL", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rule_filter_layers", "RBP-RULE-FILTER-LAYERS", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_rbp_rule_cycl", "_CSETF-RBP-RULE-CYCL", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_rbp_rule_filter_layers", "_CSETF-RBP-RULE-FILTER-LAYERS", 2, 0, false );
    SubLFiles.declareFunction( me, "make_recursive_block_parser_rule", "MAKE-RECURSIVE-BLOCK-PARSER-RULE", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_recursive_block_parser_rule", "VISIT-DEFSTRUCT-RECURSIVE-BLOCK-PARSER-RULE", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_recursive_block_parser_rule_method", "VISIT-DEFSTRUCT-OBJECT-RECURSIVE-BLOCK-PARSER-RULE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "pprint_rbp_rule", "PPRINT-RBP-RULE", 1, 2, false );
    SubLFiles.declareFunction( me, "new_rbp_rule", "NEW-RBP-RULE", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rule_note_cycl", "RBP-RULE-NOTE-CYCL", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_find_or_create_rule_from_cycl", "RBP-FIND-OR-CREATE-RULE-FROM-CYCL", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_find_rule_from_cycl", "RBP-FIND-RULE-FROM-CYCL", 1, 1, false );
    SubLFiles.declareFunction( me, "rbp_find_rule_from_cycl_w_initialized_rb", "RBP-FIND-RULE-FROM-CYCL-W-INITIALIZED-RB", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_find_cycl_from_rule", "RBP-FIND-CYCL-FROM-RULE", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_filters", "RBP-RB-FILTERS", 0, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_add_filter", "RBP-RB-ADD-FILTER", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_rule_count", "RBP-RB-RULE-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_all_rules", "RBP-RB-ALL-RULES", 0, 0, false );
    SubLFiles.declareFunction( me, "clear_rbp_rb_all_rules_sorted", "CLEAR-RBP-RB-ALL-RULES-SORTED", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_rbp_rb_all_rules_sorted", "REMOVE-RBP-RB-ALL-RULES-SORTED", 0, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_all_rules_sorted_internal", "RBP-RB-ALL-RULES-SORTED-INTERNAL", 0, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_all_rules_sorted", "RBP-RB-ALL-RULES-SORTED", 0, 0, false );
    SubLFiles.declareFunction( me, "sort_rbp_rules", "SORT-RBP-RULES", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rule_L", "RBP-RULE-<", 2, 0, false );
    new $rbp_rule_L$BinaryFunction();
    SubLFiles.declareFunction( me, "rbp_rules_sortedP", "RBP-RULES-SORTED?", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_new_filter", "RBP-RB-NEW-FILTER", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_filter_layers_set", "RBP-RB-FILTER-LAYERS-SET", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_filter_exclusions_layer", "RBP-RB-FILTER-EXCLUSIONS-LAYER", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_filter_has_exclusions_p", "RBP-RB-FILTER-HAS-EXCLUSIONS-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_filter_layers_list", "RBP-RB-FILTER-LAYERS-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_filter_add_layer", "RBP-RB-FILTER-ADD-LAYER", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_filter_add_excluded_value", "RBP-RB-FILTER-ADD-EXCLUDED-VALUE", 3, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_find_or_create_filter_for_key", "RBP-RB-FIND-OR-CREATE-FILTER-FOR-KEY", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_fn_for_filter_key", "RBP-RB-FN-FOR-FILTER-KEY", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_new_layer", "RBP-RB-NEW-LAYER", 0, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_layer_dictionary", "RBP-RB-LAYER-DICTIONARY", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_layer_note_rule_to_check", "RBP-RB-LAYER-NOTE-RULE-TO-CHECK", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_layer_exempt_ruleP", "RBP-RB-LAYER-EXEMPT-RULE?", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_layer_search", "RBP-RB-LAYER-SEARCH", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_layer_search_indeterminate", "RBP-RB-LAYER-SEARCH-INDETERMINATE", 3, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_layer_search_one", "RBP-RB-LAYER-SEARCH-ONE", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_layer_note_value", "RBP-RB-LAYER-NOTE-VALUE", 3, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_layer_add_ok_value", "RBP-RB-LAYER-ADD-OK-VALUE", 3, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_layer_add_excluded_value", "RBP-RB-LAYER-ADD-EXCLUDED-VALUE", 3, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_check_initialization", "RBP-RB-CHECK-INITIALIZATION", 0, 0, false );
    SubLFiles.declareFunction( me, "rbp_clear_rule_bank", "RBP-CLEAR-RULE-BANK", 0, 0, false );
    SubLFiles.declareFunction( me, "rbp_clear_rule_bank_internal", "RBP-CLEAR-RULE-BANK-INTERNAL", 0, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_initialize", "RBP-RB-INITIALIZE", 0, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_update", "RBP-RB-UPDATE", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_update_all_filters", "RBP-RB-UPDATE-ALL-FILTERS", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_update_filter", "RBP-RB-UPDATE-FILTER", 2, 1, false );
    SubLFiles.declareFunction( me, "rbp_rb_excluded_value_p", "RBP-RB-EXCLUDED-VALUE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_make_excluded_value", "RBP-RB-MAKE-EXCLUDED-VALUE", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_excluded_value_term", "RBP-RB-EXCLUDED-VALUE-TERM", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rule_constraints", "RBP-RULE-CONSTRAINTS", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_canonicalize_constraint", "RBP-CANONICALIZE-CONSTRAINT", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_negative_constraint_fn_p", "RBP-NEGATIVE-CONSTRAINT-FN-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_positive_correlate_of_negative_constraint_fn", "RBP-POSITIVE-CORRELATE-OF-NEGATIVE-CONSTRAINT-FN", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_canonicalize_negative_constraint", "RBP-CANONICALIZE-NEGATIVE-CONSTRAINT", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_forts_to_keywords", "RBP-FORTS-TO-KEYWORDS", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_fort_to_keyword", "RBP-FORT-TO-KEYWORD", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_term_keyword_map", "RBP-TERM-KEYWORD-MAP", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_rbp_term_keyword_map", "INITIALIZE-RBP-TERM-KEYWORD-MAP", 0, 0, false );
    SubLFiles.declareFunction( me, "rbp_keyword_for_term", "RBP-KEYWORD-FOR-TERM", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_filter_rules", "RBP-RB-FILTER-RULES", 4, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_layer_exempt_rule_lambdaP", "RBP-RB-LAYER-EXEMPT-RULE-LAMBDA?", 1, 0, false );
    new $rbp_rb_layer_exempt_rule_lambdaP$UnaryFunction();
    SubLFiles.declareFunction( me, "rbp_rb_exempt_rules", "RBP-RB-EXEMPT-RULES", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_exempt_rules_reporting_failures", "RBP-RB-EXEMPT-RULES-REPORTING-FAILURES", 6, 0, false );
    SubLFiles.declareFunction( me, "rbp_report_failed_rule", "RBP-REPORT-FAILED-RULE", 3, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_keys_from_base", "RBP-RB-KEYS-FROM-BASE", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_keys_from_base_int_internal", "RBP-RB-KEYS-FROM-BASE-INT-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_keys_from_base_int", "RBP-RB-KEYS-FROM-BASE-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_rule_term_table", "RBP-RB-RULE-TERM-TABLE", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_rule_term_table_lookup", "RBP-RB-RULE-TERM-TABLE-LOOKUP", 2, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_all_genls", "RBP-RB-ALL-GENLS", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_all_type_genls", "RBP-RB-ALL-TYPE-GENLS", 1, 0, false );
    SubLFiles.declareFunction( me, "rbp_rb_all_isa", "RBP-RB-ALL-ISA", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_noun_compound_constraint_string_specs", "CLEAR-NOUN-COMPOUND-CONSTRAINT-STRING-SPECS", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_noun_compound_constraint_string_specs", "REMOVE-NOUN-COMPOUND-CONSTRAINT-STRING-SPECS", 0, 0, false );
    SubLFiles.declareFunction( me, "noun_compound_constraint_string_specs_internal", "NOUN-COMPOUND-CONSTRAINT-STRING-SPECS-INTERNAL", 0, 0, false );
    SubLFiles.declareFunction( me, "noun_compound_constraint_string_specs", "NOUN-COMPOUND-CONSTRAINT-STRING-SPECS", 0, 0, false );
    return NIL;
  }

  public static SubLObject init_rbp_rule_bank_file()
  {
    $rbp_rule_bank$ = SubLFiles.deflexical( "*RBP-RULE-BANK*", maybeDefault( $sym0$_RBP_RULE_BANK_, $rbp_rule_bank$, () -> ( rbp_new_rule_bank() ) ) );
    $rbp_rule_index$ = SubLFiles.deflexical( "*RBP-RULE-INDEX*", maybeDefault( $sym1$_RBP_RULE_INDEX_, $rbp_rule_index$, () -> ( dictionary.new_dictionary( UNPROVIDED, UNPROVIDED ) ) ) );
    $rbp_rb_initializedP$ = SubLFiles.deflexical( "*RBP-RB-INITIALIZED?*", ( maybeDefault( $sym2$_RBP_RB_INITIALIZED__, $rbp_rb_initializedP$, NIL ) ) );
    $rbp_rule_bank_lock$ = SubLFiles.deflexical( "*RBP-RULE-BANK-LOCK*", Locks.make_lock( $str3$RBP_Rule_Bank_Lock ) );
    $rbp_syntactic_constraint_types$ = SubLFiles.defconstant( "*RBP-SYNTACTIC-CONSTRAINT-TYPES*", $list6 );
    $rbp_semantic_constraint_types$ = SubLFiles.defconstant( "*RBP-SEMANTIC-CONSTRAINT-TYPES*", $list7 );
    $rbp_open_class_constraint_types$ = SubLFiles.defconstant( "*RBP-OPEN-CLASS-CONSTRAINT-TYPES*", $list8 );
    $rbp_closed_class_constraint_types$ = SubLFiles.defconstant( "*RBP-CLOSED-CLASS-CONSTRAINT-TYPES*", $list9 );
    $rbp_constrained_types$ = SubLFiles.defparameter( "*RBP-CONSTRAINED-TYPES*", $list33 );
    $dtp_recursive_block_parser_rule$ = SubLFiles.defconstant( "*DTP-RECURSIVE-BLOCK-PARSER-RULE*", $sym37$RECURSIVE_BLOCK_PARSER_RULE );
    $rbp_rb_all_rules_sorted_caching_state$ = SubLFiles.deflexical( "*RBP-RB-ALL-RULES-SORTED-CACHING-STATE*", NIL );
    $rbp_term_keyword_map$ = SubLFiles.deflexical( "*RBP-TERM-KEYWORD-MAP*", $kw89$UNINITIALIZED );
    $rbp_lambda_layer$ = SubLFiles.defparameter( "*RBP-LAMBDA-LAYER*", NIL );
    $noun_compound_constraint_string_specs_caching_state$ = SubLFiles.deflexical( "*NOUN-COMPOUND-CONSTRAINT-STRING-SPECS-CACHING-STATE*", NIL );
    return NIL;
  }

  public static SubLObject setup_rbp_rule_bank_file()
  {
    subl_macro_promotions.declare_defglobal( $sym0$_RBP_RULE_BANK_ );
    subl_macro_promotions.declare_defglobal( $sym1$_RBP_RULE_INDEX_ );
    subl_macro_promotions.declare_defglobal( $sym2$_RBP_RB_INITIALIZED__ );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_recursive_block_parser_rule$.getGlobalValue(), Symbols.symbol_function(
        $sym44$RECURSIVE_BLOCK_PARSER_RULE_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list45 );
    Structures.def_csetf( $sym46$RBP_RULE_CYCL, $sym47$_CSETF_RBP_RULE_CYCL );
    Structures.def_csetf( $sym48$RBP_RULE_FILTER_LAYERS, $sym49$_CSETF_RBP_RULE_FILTER_LAYERS );
    Equality.identity( $sym37$RECURSIVE_BLOCK_PARSER_RULE );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_recursive_block_parser_rule$.getGlobalValue(), Symbols.symbol_function(
        $sym57$VISIT_DEFSTRUCT_OBJECT_RECURSIVE_BLOCK_PARSER_RULE_METHOD ) );
    memoization_state.note_globally_cached_function( $sym59$RBP_RB_ALL_RULES_SORTED );
    memoization_state.note_memoized_function( $sym103$RBP_RB_KEYS_FROM_BASE_INT );
    memoization_state.note_globally_cached_function( $sym112$NOUN_COMPOUND_CONSTRAINT_STRING_SPECS );
    return NIL;
  }
  ...
  static
  {
    me = new rbp_rule_bank();
    $rbp_rule_bank$ = null;
    $rbp_rule_index$ = null;
    $rbp_rb_initializedP$ = null;
    $rbp_rule_bank_lock$ = null;
    $rbp_syntactic_constraint_types$ = null;
    $rbp_semantic_constraint_types$ = null;
    $rbp_open_class_constraint_types$ = null;
    $rbp_closed_class_constraint_types$ = null;
    $rbp_constrained_types$ = null;
    $dtp_recursive_block_parser_rule$ = null;
    $rbp_rb_all_rules_sorted_caching_state$ = null;
    $rbp_term_keyword_map$ = null;
    $rbp_lambda_layer$ = null;
    $noun_compound_constraint_string_specs_caching_state$ = null;
    $sym0$_RBP_RULE_BANK_ = makeSymbol( "*RBP-RULE-BANK*" );
    $sym1$_RBP_RULE_INDEX_ = makeSymbol( "*RBP-RULE-INDEX*" );
    $sym2$_RBP_RB_INITIALIZED__ = makeSymbol( "*RBP-RB-INITIALIZED?*" );
    $str3$RBP_Rule_Bank_Lock = makeString( "RBP Rule Bank Lock" );
    $sym4$WITH_LOCK_HELD = makeSymbol( "WITH-LOCK-HELD" );
    $list5 = ConsesLow.list( makeSymbol( "*RBP-RULE-BANK-LOCK*" ) );
    $list6 = ConsesLow.list( makeKeyword( "PRED" ), makeKeyword( "POS" ), makeKeyword( "WU" ) );
    $list7 = ConsesLow.list( makeKeyword( "GENL" ), makeKeyword( "TYPE-GENL" ), makeKeyword( "ISA" ), makeKeyword( "EQL" ) );
    $list8 = ConsesLow.list( makeKeyword( "WU" ), makeKeyword( "GENL" ), makeKeyword( "TYPE-GENL" ), makeKeyword( "ISA" ), makeKeyword( "EQL" ) );
    $list9 = ConsesLow.list( makeKeyword( "POS" ), makeKeyword( "PRED" ) );
    $list10 = ConsesLow.list( ConsesLow.list( makeSymbol( "TYPE" ), makeSymbol( "&KEY" ), makeSymbol( "DONE" ), ConsesLow.list( makeSymbol( "MODE" ), makeKeyword( "ALL" ) ) ), makeSymbol( "&BODY" ), makeSymbol(
        "BODY" ) );
    $list11 = ConsesLow.list( makeKeyword( "DONE" ), makeKeyword( "MODE" ) );
    $kw12$ALLOW_OTHER_KEYS = makeKeyword( "ALLOW-OTHER-KEYS" );
    $kw13$DONE = makeKeyword( "DONE" );
    $kw14$MODE = makeKeyword( "MODE" );
    $kw15$ALL = makeKeyword( "ALL" );
    $sym16$SYNTACTIC_TYPES = makeUninternedSymbol( "SYNTACTIC-TYPES" );
    $sym17$SEMANTIC_TYPES = makeUninternedSymbol( "SEMANTIC-TYPES" );
    $sym18$OPEN_TYPES = makeUninternedSymbol( "OPEN-TYPES" );
    $sym19$CLOSED_TYPES = makeUninternedSymbol( "CLOSED-TYPES" );
    $sym20$CLET = makeSymbol( "CLET" );
    $list21 = ConsesLow.list( makeSymbol( "*RBP-SYNTACTIC-CONSTRAINT-TYPES*" ) );
    $list22 = ConsesLow.list( makeSymbol( "*RBP-SEMANTIC-CONSTRAINT-TYPES*" ) );
    $list23 = ConsesLow.list( makeSymbol( "*RBP-OPEN-CLASS-CONSTRAINT-TYPES*" ) );
    $list24 = ConsesLow.list( makeSymbol( "*RBP-CLOSED-CLASS-CONSTRAINT-TYPES*" ) );
    $sym25$PWHEN = makeSymbol( "PWHEN" );
    $sym26$COR = makeSymbol( "COR" );
    $list27 = ConsesLow.list( makeKeyword( "ALL" ) );
    $list28 = ConsesLow.list( makeKeyword( "SYNTACTIC" ) );
    $sym29$CSOME = makeSymbol( "CSOME" );
    $list30 = ConsesLow.list( makeKeyword( "SEMANTIC" ) );
    $list31 = ConsesLow.list( makeKeyword( "OPEN-CLASS" ) );
    $list32 = ConsesLow.list( makeKeyword( "CLOSED-CLASS" ) );
    $list33 = ConsesLow.list( makeKeyword( "HEAD" ), makeKeyword( "MODIFIER" ) );
    $list34 = ConsesLow.list( ConsesLow.list( makeKeyword( "TEST" ), makeSymbol( "RBP-SYNTACTIC-CONSTRAINT-TYPE-P" ) ), makeKeyword( "ANYTHING" ), makeKeyword( "ANYTHING" ) );
    $list35 = ConsesLow.list( makeKeyword( "WU" ), makeKeyword( "ANYTHING" ), makeKeyword( "ANYTHING" ) );
    $list36 = ConsesLow.list( makeKeyword( "OR" ), ConsesLow.list( ConsesLow.list( makeKeyword( "TEST" ), makeSymbol( "RBP-SEMANTIC-CONSTRAINT-TYPE-P" ) ), makeKeyword( "ANYTHING" ), makeKeyword( "ANYTHING" ) ),
        ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "FormulaArgFn" ) ), ConsesLow.list( makeKeyword( "TEST" ), makeSymbol( "POSITIVE-INTEGER-P" ) ), ConsesLow.list( makeKeyword( "TEST" ),
            makeSymbol( "RBP-SEMANTIC-CONSTRAINT-P" ) ) ) );
    $sym37$RECURSIVE_BLOCK_PARSER_RULE = makeSymbol( "RECURSIVE-BLOCK-PARSER-RULE" );
    $sym38$RECURSIVE_BLOCK_PARSER_RULE_P = makeSymbol( "RECURSIVE-BLOCK-PARSER-RULE-P" );
    $list39 = ConsesLow.list( makeSymbol( "CYCL" ), makeSymbol( "FILTER-LAYERS" ) );
    $list40 = ConsesLow.list( makeKeyword( "CYCL" ), makeKeyword( "FILTER-LAYERS" ) );
    $list41 = ConsesLow.list( makeSymbol( "RBP-RULE-CYCL" ), makeSymbol( "RBP-RULE-FILTER-LAYERS" ) );
    $list42 = ConsesLow.list( makeSymbol( "_CSETF-RBP-RULE-CYCL" ), makeSymbol( "_CSETF-RBP-RULE-FILTER-LAYERS" ) );
    $sym43$PPRINT_RBP_RULE = makeSymbol( "PPRINT-RBP-RULE" );
    $sym44$RECURSIVE_BLOCK_PARSER_RULE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "RECURSIVE-BLOCK-PARSER-RULE-PRINT-FUNCTION-TRAMPOLINE" );
    $list45 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "RECURSIVE-BLOCK-PARSER-RULE-P" ) );
    $sym46$RBP_RULE_CYCL = makeSymbol( "RBP-RULE-CYCL" );
    $sym47$_CSETF_RBP_RULE_CYCL = makeSymbol( "_CSETF-RBP-RULE-CYCL" );
    $sym48$RBP_RULE_FILTER_LAYERS = makeSymbol( "RBP-RULE-FILTER-LAYERS" );
    $sym49$_CSETF_RBP_RULE_FILTER_LAYERS = makeSymbol( "_CSETF-RBP-RULE-FILTER-LAYERS" );
    $kw50$CYCL = makeKeyword( "CYCL" );
    $kw51$FILTER_LAYERS = makeKeyword( "FILTER-LAYERS" );
    $str52$Invalid_slot__S_for_construction_ = makeString( "Invalid slot ~S for construction function" );
    $kw53$BEGIN = makeKeyword( "BEGIN" );
    $sym54$MAKE_RECURSIVE_BLOCK_PARSER_RULE = makeSymbol( "MAKE-RECURSIVE-BLOCK-PARSER-RULE" );
    $kw55$SLOT = makeKeyword( "SLOT" );
    $kw56$END = makeKeyword( "END" );
    $sym57$VISIT_DEFSTRUCT_OBJECT_RECURSIVE_BLOCK_PARSER_RULE_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-RECURSIVE-BLOCK-PARSER-RULE-METHOD" );
    $str58$__RBP_RULE__S_ = makeString( "#<RBP-RULE ~S>" );
    $sym59$RBP_RB_ALL_RULES_SORTED = makeSymbol( "RBP-RB-ALL-RULES-SORTED" );
    $sym60$_RBP_RB_ALL_RULES_SORTED_CACHING_STATE_ = makeSymbol( "*RBP-RB-ALL-RULES-SORTED-CACHING-STATE*" );
    $sym61$RBP_RULE__ = makeSymbol( "RBP-RULE-<" );
    $kw62$NO_EXCLUSIONS = makeKeyword( "NO-EXCLUSIONS" );
    $kw63$PRED = makeKeyword( "PRED" );
    $sym64$ALL_GENL_PREDS = makeSymbol( "ALL-GENL-PREDS" );
    $kw65$POS = makeKeyword( "POS" );
    $kw66$GENL = makeKeyword( "GENL" );
    $sym67$RBP_RB_ALL_GENLS = makeSymbol( "RBP-RB-ALL-GENLS" );
    $kw68$TYPE_GENL = makeKeyword( "TYPE-GENL" );
    $sym69$RBP_RB_ALL_TYPE_GENLS = makeSymbol( "RBP-RB-ALL-TYPE-GENLS" );
    $kw70$ISA = makeKeyword( "ISA" );
    $sym71$RBP_RB_ALL_ISA = makeSymbol( "RBP-RB-ALL-ISA" );
    $sym72$LIST = makeSymbol( "LIST" );
    $int73$256 = makeInteger( 256 );
    $kw74$NOTED = makeKeyword( "NOTED" );
    $sym75$RBP_WFF_ISA_ = makeSymbol( "RBP-WFF-ISA?" );
    $sym76$NPP_GENL_ = makeSymbol( "NPP-GENL?" );
    $const77$NounCompoundRule = constant_handles.reader_make_constant_shell( makeString( "NounCompoundRule" ) );
    $kw78$SYNTACTIC = makeKeyword( "SYNTACTIC" );
    $kw79$SEMANTIC = makeKeyword( "SEMANTIC" );
    $kw80$OPEN_CLASS = makeKeyword( "OPEN-CLASS" );
    $kw81$CLOSED_CLASS = makeKeyword( "CLOSED-CLASS" );
    $list82 = ConsesLow.list( makeKeyword( "EXCLUDE" ), makeKeyword( "ANYTHING" ) );
    $kw83$EXCLUDE = makeKeyword( "EXCLUDE" );
    $sym84$INDEXED_TERM_P = makeSymbol( "INDEXED-TERM-P" );
    $const85$ncRuleConstraint = constant_handles.reader_make_constant_shell( makeString( "ncRuleConstraint" ) );
    $list86 = ConsesLow.list( makeString( "NCNotEqualsConstraintFn" ), makeString( "NCNotIsaConstraintFn" ), makeString( "NCNotGenlsConstraintFn" ) );
    $list87 = ConsesLow.list( ConsesLow.cons( makeString( "NCNotEqualsConstraintFn" ), constant_handles.reader_make_constant_shell( makeString( "NCEqualsConstraintFn" ) ) ), ConsesLow.cons( makeString(
        "NCNotIsaConstraintFn" ), constant_handles.reader_make_constant_shell( makeString( "NCIsaConstraintFn" ) ) ), ConsesLow.cons( makeString( "NCNotGenlsConstraintFn" ), constant_handles.reader_make_constant_shell(
            makeString( "NCGenlsConstraintFn" ) ) ) );
    $sym88$RBP_FORTS_TO_KEYWORDS = makeSymbol( "RBP-FORTS-TO-KEYWORDS" );
    $kw89$UNINITIALIZED = makeKeyword( "UNINITIALIZED" );
    $list90 = ConsesLow.list( ConsesLow.cons( constant_handles.reader_make_constant_shell( makeString( "NCPOSConstraintFn" ) ), makeKeyword( "POS" ) ), ConsesLow.cons( constant_handles.reader_make_constant_shell(
        makeString( "NCPOSPredConstraintFn" ) ), makeKeyword( "PRED" ) ), ConsesLow.cons( constant_handles.reader_make_constant_shell( makeString( "NCEqualsConstraintFn" ) ), makeKeyword( "EQL" ) ), ConsesLow.cons(
            constant_handles.reader_make_constant_shell( makeString( "NCGenlsConstraintFn" ) ), makeKeyword( "GENL" ) ), ConsesLow.cons( constant_handles.reader_make_constant_shell( makeString( "NCIsaConstraintFn" ) ),
                makeKeyword( "ISA" ) ), ConsesLow.cons( constant_handles.reader_make_constant_shell( makeString( "TheNCHead" ) ), makeKeyword( "HEAD" ) ), ConsesLow.cons( constant_handles.reader_make_constant_shell(
                    makeString( "TheNCModifier" ) ), makeKeyword( "MODIFIER" ) ) );
    $list91 = ConsesLow.list( makeSymbol( "NEW-CONSTRAINT-TYPE" ), makeSymbol( "KEYWORD" ) );
    $str92$NCWordUnitConstraintFn = makeString( "NCWordUnitConstraintFn" );
    $kw93$WU = makeKeyword( "WU" );
    $str94$NCTypeGenlsConstraintFn = makeString( "NCTypeGenlsConstraintFn" );
    $list95 = ConsesLow.list( makeKeyword( "ISA" ), makeKeyword( "GENL" ) );
    $const96$IndeterminateTerm = constant_handles.reader_make_constant_shell( makeString( "IndeterminateTerm" ) );
    $str97$__Passed_all__S_constraints_for__ = makeString( "~&Passed all ~S constraints for~% ~S~%" );
    $sym98$RBP_RB_LAYER_EXEMPT_RULE_LAMBDA_ = makeSymbol( "RBP-RB-LAYER-EXEMPT-RULE-LAMBDA?" );
    $str99$__The__S_block_s__S_value__S__did = makeString( "~%The ~S block's ~S value ~S\n did not satisfy the constraints ~S\n on the rule ~S~%~%" );
    $kw100$ORIGINAL_STRING = makeKeyword( "ORIGINAL-STRING" );
    $sym101$RELEVANT_MT_IS_EVERYTHING = makeSymbol( "RELEVANT-MT-IS-EVERYTHING" );
    $const102$EverythingPSC = constant_handles.reader_make_constant_shell( makeString( "EverythingPSC" ) );
    $sym103$RBP_RB_KEYS_FROM_BASE_INT = makeSymbol( "RBP-RB-KEYS-FROM-BASE-INT" );
    $const104$CollectionType = constant_handles.reader_make_constant_shell( makeString( "CollectionType" ) );
    $sym105$_TYPE = makeSymbol( "?TYPE" );
    $const106$and = constant_handles.reader_make_constant_shell( makeString( "and" ) );
    $const107$typeGenls = constant_handles.reader_make_constant_shell( makeString( "typeGenls" ) );
    $list108 = ConsesLow.list( makeSymbol( "?SPEC" ) );
    $list109 = ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "genls" ) ), makeSymbol( "?SPEC" ), makeSymbol( "?TYPE" ) ) );
    $const110$PositiveInteger = constant_handles.reader_make_constant_shell( makeString( "PositiveInteger" ) );
    $const111$ProperNameString = constant_handles.reader_make_constant_shell( makeString( "ProperNameString" ) );
    $sym112$NOUN_COMPOUND_CONSTRAINT_STRING_SPECS = makeSymbol( "NOUN-COMPOUND-CONSTRAINT-STRING-SPECS" );
    $sym113$_COL = makeSymbol( "?COL" );
    $list114 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "and" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "assertedSentence" ) ), ConsesLow.list(
        constant_handles.reader_make_constant_shell( makeString( "isaConstraintForNCR" ) ), makeSymbol( "?RULE" ), makeSymbol( "?INDEXICAL" ), makeSymbol( "?COL" ) ) ), ConsesLow.list( constant_handles
            .reader_make_constant_shell( makeString( "genls" ) ), makeSymbol( "?COL" ), constant_handles.reader_make_constant_shell( makeString( "CharacterString" ) ) ) );
    $const115$InferencePSC = constant_handles.reader_make_constant_shell( makeString( "InferencePSC" ) );
    $sym116$_NOUN_COMPOUND_CONSTRAINT_STRING_SPECS_CACHING_STATE_ = makeSymbol( "*NOUN-COMPOUND-CONSTRAINT-STRING-SPECS-CACHING-STATE*" );
  }

  public static final class $recursive_block_parser_rule_native
      extends
        SubLStructNative
  {
    ...
    public $recursive_block_parser_rule_native()
    {
      ...
      this.$filter_layers = CommonSymbols.NIL;
    }

    @Override
    public SubLStructDecl getStructDecl()
    {
      return $recursive_block_parser_rule_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $recursive_block_parser_rule_native.class, $sym37$RECURSIVE_BLOCK_PARSER_RULE, $sym38$RECURSIVE_BLOCK_PARSER_RULE_P, $list39, $list40, new String[] { "$cycl",
        "$filter_layers"
      }, $list41, $list42, $sym43$PPRINT_RBP_RULE );
    }
  }

  public static final class $recursive_block_parser_rule_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $rbp_rule_L$BinaryFunction
      extends
        BinaryFunction
  {
  ...
  public static final class $rbp_rb_layer_exempt_rule_lambdaP$UnaryFunction
      extends
        UnaryFunction
  {
