...
import static com.cyc.cycjava.cycl.linkage.*;
...
public final class linkage extends SubLTranslatedFile {
    ...
    public static SubLObject link_p(final SubLObject v_object) {
        return v_object.getClass() == linkage.$link_native.class ? T : NIL;
    }

    public static SubLObject link_name(final SubLObject v_object) {
        assert NIL != link_p(v_object) : "linkage.link_p(v_object) " + "CommonSymbols.NIL != linkage.link_p(v_object) " + v_object;
    ...
    public static SubLObject make_link(SubLObject arglist) {
        ...
        final SubLObject v_new = new linkage.$link_native();
        SubLObject next;
    ...
    public static final class $link_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(linkage.$link_native.class, LINK, LINK_P, $list71, $list72, new String[]{ "$name", "$left_word", "$right_word" }, $list73, $list74, PRINT_LINKAGE_LINK);
        }
    }
