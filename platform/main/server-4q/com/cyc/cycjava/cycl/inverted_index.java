...
import com.cyc.cycjava.cycl.inverted_index;
...
import static com.cyc.cycjava.cycl.inverted_index.*;
...
public final class inverted_index extends SubLTranslatedFile {
    ...
    public static SubLObject indexed_items_p(final SubLObject v_object) {
        return v_object.getClass() == inverted_index.$indexed_items_native.class ? T : NIL;
    }

    public static SubLObject indexed_items_next_index(final SubLObject v_object) {
        assert NIL != indexed_items_p(v_object) : "inverted_index.indexed_items_p(v_object) " + "CommonSymbols.NIL != inverted_index.indexed_items_p(v_object) " + v_object;
    ...
    public static SubLObject make_indexed_items(SubLObject arglist) {
        ...
        final SubLObject v_new = new inverted_index.$indexed_items_native();
        SubLObject next;
    ...
    public static final class $indexed_items_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inverted_index.$indexed_items_native.class, INDEXED_ITEMS, INDEXED_ITEMS_P, $list35, $list36, new String[]{ "$next_index", "$item_suid_map", "$suid_item_map" }, $list37, $list38, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
