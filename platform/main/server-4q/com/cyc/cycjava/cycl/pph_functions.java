...
import static com.cyc.cycjava.cycl.pph_functions.*;
...
public final class pph_functions extends SubLTranslatedFile {
    ...
    public static SubLObject declare_pph_functions_file() {
        declareFunction(me, "initialize_pph_phrase_fns", "INITIALIZE-PPH-PHRASE-FNS", 0, 0, false);
        declareFunction(me, "pph_phrase_fns_initializedP", "PPH-PHRASE-FNS-INITIALIZED?", 0, 0, false);
        declareFunction(me, "pph_phrase_fnP", "PPH-PHRASE-FN?", 1, 1, false);
        declareFunction(me, "latitudeorlongitudeparaphrasefn", "LATITUDEORLONGITUDEPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "bestevaluatedifevaluatablephrasefn_constrained", "BESTEVALUATEDIFEVALUATABLEPHRASEFN-CONSTRAINED", 0, 0, false);
        declareFunction(me, "definitenounppfn", "DEFINITENOUNPPFN", 0, 0, false);
        declareFunction(me, "basictransitivesentencefn", "BASICTRANSITIVESENTENCEFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_countywithstateorprovinceabbreviation", "TERMPARAPHRASEFN-COUNTYWITHSTATEORPROVINCEABBREVIATION", 0, 0, false);
        declareFunction(me, "termparaphrasefn_citywithstateorprovincename", "TERMPARAPHRASEFN-CITYWITHSTATEORPROVINCENAME", 0, 0, false);
        declareFunction(me, "terseparaphrasefn", "TERSEPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "npisxp_nlsentencefn", "NPISXP-NLSENTENCEFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_constrained", "TERMPARAPHRASEFN-CONSTRAINED", 0, 0, false);
        declareFunction(me, "nldisjunctionfn", "NLDISJUNCTIONFN", 0, 0, false);
        declareFunction(me, "formulaargpositionparaphrasefn", "FORMULAARGPOSITIONPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "ndecimalplaceparaphrasefn", "NDECIMALPLACEPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_physicallocationtype", "TERMPARAPHRASEFN-PHYSICALLOCATIONTYPE", 0, 0, false);
        declareFunction(me, "bestdetnbarfn_definite", "BESTDETNBARFN-DEFINITE", 0, 0, false);
        declareFunction(me, "bestmathformulaoperandfn", "BESTMATHFORMULAOPERANDFN", 0, 0, false);
        declareFunction(me, "unlinkedsubparaphrasewithhtmlfn", "UNLINKEDSUBPARAPHRASEWITHHTMLFN", 0, 0, false);
        declareFunction(me, "bestlistparaphrasewithseparatorfn_constrained", "BESTLISTPARAPHRASEWITHSEPARATORFN-CONSTRAINED", 0, 0, false);
        declareFunction(me, "twodigityearparaphrasefn", "TWODIGITYEARPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_citywithstateorprovinceabbreviation", "TERMPARAPHRASEFN-CITYWITHSTATEORPROVINCEABBREVIATION", 0, 0, false);
        declareFunction(me, "bestsymbolphrasefn", "BESTSYMBOLPHRASEFN", 0, 0, false);
        declareFunction(me, "xactsasayinz_nlsentencefn", "XACTSASAYINZ-NLSENTENCEFN", 0, 0, false);
        declareFunction(me, "tensedphrasefn", "TENSEDPHRASEFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_np_quatype", "TERMPARAPHRASEFN-NP-QUATYPE", 0, 0, false);
        declareFunction(me, "gentemplaterecipeomitsargfn", "GENTEMPLATERECIPEOMITSARGFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_citywithcountryname", "TERMPARAPHRASEFN-CITYWITHCOUNTRYNAME", 0, 0, false);
        declareFunction(me, "termparaphrasefn_countywithstateorprovincename", "TERMPARAPHRASEFN-COUNTYWITHSTATEORPROVINCENAME", 0, 0, false);
        declareFunction(me, "typeclarifyingphrasefn", "TYPECLARIFYINGPHRASEFN", 0, 0, false);
        declareFunction(me, "xhasyasaz_nlsentencefn", "XHASYASAZ-NLSENTENCEFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_possessive", "TERMPARAPHRASEFN-POSSESSIVE", 0, 0, false);
        declareFunction(me, "bestchemicalformulafn", "BESTCHEMICALFORMULAFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_citywithcountryabbreviation", "TERMPARAPHRASEFN-CITYWITHCOUNTRYABBREVIATION", 0, 0, false);
        declareFunction(me, "indefinitenbarppfn", "INDEFINITENBARPPFN", 0, 0, false);
        declareFunction(me, "concatenatephrasesfn", "CONCATENATEPHRASESFN", 0, 0, false);
        declareFunction(me, "indefinitenounppfn", "INDEFINITENOUNPPFN", 0, 0, false);
        declareFunction(me, "nbarheadedbynounformfn", "NBARHEADEDBYNOUNFORMFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn", "TERMPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "definitenbarppfn", "DEFINITENBARPPFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_temporallocation_day", "TERMPARAPHRASEFN-TEMPORALLOCATION-DAY", 0, 0, false);
        declareFunction(me, "basictransitive_passivesentencefn", "BASICTRANSITIVE-PASSIVESENTENCEFN", 0, 0, false);
        declareFunction(me, "documentsentencefn", "DOCUMENTSENTENCEFN", 0, 0, false);
        declareFunction(me, "postmodifier_edformfn", "POSTMODIFIER_EDFORMFN", 0, 0, false);
        declareFunction(me, "bestheadverbforinitialsubjectfn", "BESTHEADVERBFORINITIALSUBJECTFN", 0, 0, false);
        declareFunction(me, "bestnlphraseofstringfn", "BESTNLPHRASEOFSTRINGFN", 0, 0, false);
        declareFunction(me, "paragraphsentencefn", "PARAGRAPHSENTENCEFN", 0, 0, false);
        declareFunction(me, "bestnumberedlistparaphrasefn_constrained", "BESTNUMBEREDLISTPARAPHRASEFN-CONSTRAINED", 0, 0, false);
        declareFunction(me, "bestnlwordformoflexemefn_constrained", "BESTNLWORDFORMOFLEXEMEFN-CONSTRAINED", 0, 0, false);
        declareFunction(me, "bestnlwordformoflexemefn", "BESTNLWORDFORMOFLEXEMEFN", 0, 0, false);
        declareFunction(me, "preciseparaphrasefn", "PRECISEPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_pp", "TERMPARAPHRASEFN-PP", 0, 0, false);
        declareFunction(me, "bestppfn", "BESTPPFN", 0, 0, false);
        declareFunction(me, "genvalueparaphrasefn", "GENVALUEPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "bestbindingsphrasefn", "BESTBINDINGSPHRASEFN", 0, 0, false);
        declareFunction(me, "phraseformfn", "PHRASEFORMFN", 0, 0, false);
        declareFunction(me, "stringmentionfn", "STRINGMENTIONFN", 0, 0, false);
        declareFunction(me, "bestcyclphrasefn", "BESTCYCLPHRASEFN", 0, 0, false);
        declareFunction(me, "bestdetnbarfn_indefinite", "BESTDETNBARFN-INDEFINITE", 0, 0, false);
        declareFunction(me, "bestdetnbarfn", "BESTDETNBARFN", 0, 0, false);
        declareFunction(me, "tensedphrasefn_defaultpast", "TENSEDPHRASEFN-DEFAULTPAST", 0, 0, false);
        declareFunction(me, "termparaphrasefn_pp_constrained", "TERMPARAPHRASEFN-PP-CONSTRAINED", 0, 0, false);
        declareFunction(me, "explicitifcollection_nlphrasefn", "EXPLICITIFCOLLECTION-NLPHRASEFN", 0, 0, false);
        declareFunction(me, "generategkeglosswrtmtfn", "GENERATEGKEGLOSSWRTMTFN", 0, 0, false);
        declareFunction(me, "pluralparaphrasefn", "PLURALPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "bestverbformforsubjectfn", "BESTVERBFORMFORSUBJECTFN", 0, 0, false);
        declareFunction(me, "concatenatephrasesfn_nospaces", "CONCATENATEPHRASESFN-NOSPACES", 0, 0, false);
        declareFunction(me, "nlsimplebinaryconjunctionfn", "NLSIMPLEBINARYCONJUNCTIONFN", 0, 0, false);
        declareFunction(me, "structuredparaphrasefn", "STRUCTUREDPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "pluralparaphrasefn_pp", "PLURALPARAPHRASEFN-PP", 0, 0, false);
        declareFunction(me, "headwordofphrasefn", "HEADWORDOFPHRASEFN", 0, 0, false);
        declareFunction(me, "bestlistparaphrasewithseparatorandcoefficientsfn_constrained", "BESTLISTPARAPHRASEWITHSEPARATORANDCOEFFICIENTSFN-CONSTRAINED", 0, 0, false);
        declareFunction(me, "nlconjunctionfn_but", "NLCONJUNCTIONFN-BUT", 0, 0, false);
        declareFunction(me, "termparaphrasefn_npandnp", "TERMPARAPHRASEFN-NPANDNP", 0, 0, false);
        declareFunction(me, "subparaphrasefn", "SUBPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "percentparaphrasefn", "PERCENTPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "bestpluraloflexemefn", "BESTPLURALOFLEXEMEFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_physicallocation", "TERMPARAPHRASEFN-PHYSICALLOCATION", 0, 0, false);
        declareFunction(me, "nthphrasefn", "NTHPHRASEFN", 0, 0, false);
        declareFunction(me, "nlconjunctionfn", "NLCONJUNCTIONFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_np", "TERMPARAPHRASEFN-NP", 0, 0, false);
        declareFunction(me, "quotedparaphrasefn", "QUOTEDPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "bestsetparaphrasewithseparatorandcoefficientsfn_constrained", "BESTSETPARAPHRASEWITHSEPARATORANDCOEFFICIENTSFN-CONSTRAINED", 0, 0, false);
        declareFunction(me, "oclockfn", "OCLOCKFN", 0, 0, false);
        declareFunction(me, "nbarwithpluralheadfn", "NBARWITHPLURALHEADFN", 0, 0, false);
        declareFunction(me, "conditionalphrasefn", "CONDITIONALPHRASEFN", 0, 0, false);
        declareFunction(me, "phrasecyclfn", "PHRASECYCLFN", 0, 0, false);
        declareFunction(me, "repeatforsubsequentargsfn", "REPEATFORSUBSEQUENTARGSFN", 0, 0, false);
        declareFunction(me, "bestcoefficientitemphrasefn_constrained", "BESTCOEFFICIENTITEMPHRASEFN-CONSTRAINED", 0, 0, false);
        declareFunction(me, "termparaphrasefn_prenominalmodifier", "TERMPARAPHRASEFN-PRENOMINALMODIFIER", 0, 0, false);
        declareFunction(me, "unlinkedsubparaphrasefn", "UNLINKEDSUBPARAPHRASEFN", 0, 0, false);
        declareFunction(me, "termparaphrasefn_temporallocation_date", "TERMPARAPHRASEFN-TEMPORALLOCATION-DATE", 0, 0, false);
        declareFunction(me, "termparaphrasefn_temporallocation", "TERMPARAPHRASEFN-TEMPORALLOCATION", 0, 0, false);
        declareFunction(me, "nphasxp_nlsentencefn", "NPHASXP-NLSENTENCEFN", 0, 0, false);
        declareFunction(me, "bestparentheticalphrasefn", "BESTPARENTHETICALPHRASEFN", 0, 0, false);
        declareFunction(me, "bestnlstringforsentencefn", "BESTNLSTRINGFORSENTENCEFN", 0, 0, false);
        return NIL;
    }
