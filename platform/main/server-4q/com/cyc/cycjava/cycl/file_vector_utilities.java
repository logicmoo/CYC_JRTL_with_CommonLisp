...
public final class file_vector_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject file_vector_reference_p(final SubLObject v_object) {
        return v_object.getClass() == file_vector_utilities.$file_vector_reference_native.class ? T : NIL;
    }

    public static SubLObject fvector_ref_index(final SubLObject v_object) {
        assert NIL != file_vector_reference_p(v_object) : "file_vector_utilities.file_vector_reference_p(v_object) " + "CommonSymbols.NIL != file_vector_utilities.file_vector_reference_p(v_object) " + v_object;
    ...
    public static SubLObject make_file_vector_reference(SubLObject arglist) {
        ...
        final SubLObject v_new = new file_vector_utilities.$file_vector_reference_native();
        SubLObject next;
    ...
    public static SubLObject backed_map_p(final SubLObject v_object) {
        return v_object.getClass() == file_vector_utilities.$backed_map_native.class ? T : NIL;
    }

    public static SubLObject backed_map_map(final SubLObject v_object) {
        assert NIL != backed_map_p(v_object) : "file_vector_utilities.backed_map_p(v_object) " + "CommonSymbols.NIL != file_vector_utilities.backed_map_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_backed_map(SubLObject arglist) {
        ...
        final SubLObject v_new = new file_vector_utilities.$backed_map_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $file_vector_reference_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(file_vector_utilities.$file_vector_reference_native.class, FILE_VECTOR_REFERENCE, FILE_VECTOR_REFERENCE_P, $list6, $list7, new String[]{ "$index", "$payload" }, $list8, $list9, PRINT_FVECTOR_REF);
        }
    }
    ...
    public static final class $backed_map_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(file_vector_utilities.$backed_map_native.class, BACKED_MAP, BACKED_MAP_P, $list86, $list87, new String[]{ "$map", "$fvector", "$common_symbols" }, $list88, $list89, PRINT_BACKED_MAP);
        }
    }
