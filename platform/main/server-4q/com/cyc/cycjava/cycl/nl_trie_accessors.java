...
import static com.cyc.cycjava.cycl.nl_trie_accessors.*;
...
public final class nl_trie_accessors extends SubLTranslatedFile {
    ...
    public static SubLObject nl_trie_index_item_p(final SubLObject v_object) {
        return v_object.getClass() == nl_trie_accessors.$nl_trie_index_item_native.class ? T : NIL;
    }

    public static SubLObject nl_trie_index_item_term(final SubLObject v_object) {
        assert NIL != nl_trie_index_item_p(v_object) : "nl_trie_accessors.nl_trie_index_item_p(v_object) " + "CommonSymbols.NIL != nl_trie_accessors.nl_trie_index_item_p(v_object) " + v_object;
    ...
    public static SubLObject make_nl_trie_index_item(SubLObject arglist) {
        ...
        final SubLObject v_new = new nl_trie_accessors.$nl_trie_index_item_native();
        SubLObject next;
    ...
    public static SubLObject init_nl_trie_accessors_file() {
        ...
        deflexical("*NL-TRIE-ROTATION-INDEX*", SubLTrampolineFile.maybeDefault($nl_trie_rotation_index$, $nl_trie_rotation_index$, NIL));
        ...
        deflexical("*NL-TRIE-STOPLIST-TRIE*", SubLTrampolineFile.maybeDefault($nl_trie_stoplist_trie$, $nl_trie_stoplist_trie$, NIL));
    ...
    public static final class $nl_trie_index_item_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(nl_trie_accessors.$nl_trie_index_item_native.class, NL_TRIE_INDEX_ITEM, NL_TRIE_INDEX_ITEM_P, $list126, $list127, new String[]{ "$term", "$phrase", "$mt" }, $list128, $list129, PRINT_NL_TRIE_INDEX_ITEM);
        }
    }
