...
public final class alexandria_iterators
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject new_alexandria_iterator(final SubLObject iterator_state_creation_func, final SubLObject args_list)
  {
    ...
    {
      return iteration.new_iterator( iterator_state, $sym0$ALEXANDRIA_KB_STORE_ITERATOR_DONE, $sym1$ALEXANDRIA_KB_STORE_ITERATOR_NEXT, $sym2$ALEXANDRIA_KB_STORE_ITERATOR_FINALIZE );
    }
  ...
  public static SubLObject new_alexandria_gafs_matching_formula_iterator(final SubLObject formula, SubLObject mt, SubLObject truth, SubLObject direction, SubLObject strength)
  {
    ...
    return new_alexandria_iterator( $sym3$CREATE_ALEXANDRIA_GAFS_MATCHING_FORMULA_ITERATOR_STATE, ConsesLow.list( formula, mt, truth, direction, strength ) );
  }
  ...
  public static SubLObject new_alexandria_gafs_matching_formula_relevant_mt_and_pred_iterator(final SubLObject formula, SubLObject truth, SubLObject direction, SubLObject strength)
  {
    ...
    return new_alexandria_iterator( $sym4$CREATE_ALEXANDRIA_GAFS_MATCHING_FORMULA_RELEVANT_MT_AND_PRED_ITER, ConsesLow.list( formula, truth, direction, strength ) );
  }
  ...
  {
    return new_alexandria_iterator( $sym5$CREATE_ALEXANDRIA_NATS_MATCHING_FORMULA_ITERATOR, ConsesLow.list( formula, type ) );
  }
  ...
  {
    return new_alexandria_iterator( $sym6$CREATE_ALEXANDRIA_REIFIABLE_FUNCTION_EXTENT_ITERATOR_STATE, ConsesLow.list( function ) );
  }
  ...
  {
    return new_alexandria_iterator( $sym7$CREATE_ALEXANDRIA_ALL_FORTS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym8$CREATE_ALEXANDRIA_ALL_GAFS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym9$CREATE_ALEXANDRIA_ALL_RULES_ITERATOR_STATE, NIL );
  }
  ...
  public static SubLObject new_alexandria_all_unbound_rules_iterator(SubLObject sense, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym10$CREATE_ALEXANDRIA_ALL_UNBOUND_RULES_ITERATOR_STATE, ConsesLow.list( sense, direction ) );
  }
  ...
  public static SubLObject new_alexandria_all_unbound_rules_relevant_mt_iterator(SubLObject sense, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym11$CREATE_ALEXANDRIA_ALL_UNBOUND_RULES_RELEVANT_MT_ITERATOR_STATE, ConsesLow.list( sense, direction ) );
  }
  ...
  {
    return new_alexandria_iterator( $sym12$CREATE_ALEXANDRIA_ALL_ASSERTIONS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym13$CREATE_ALEXANDRIA_ALL_BIG_INTEGERS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym14$CREATE_ALEXANDRIA_ALL_INTEGERS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym15$CREATE_ALEXANDRIA_ALL_BOOKKEEPING_GAFS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym16$CREATE_ALEXANDRIA_ALL_CONSTANTS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym17$CREATE_ALEXANDRIA_ALL_NARTS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym18$CREATE_ALEXANDRIA_ALL_DEDUCTIONS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym19$CREATE_ALEXANDRIA_ALL_FLOATS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym20$CREATE_ALEXANDRIA_ALL_FORMULAS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym21$CREATE_ALEXANDRIA_ALL_HL_SUPPORTS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym22$CREATE_ALEXANDRIA_ALL_KB_HL_SUPPORTS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym23$CREATE_ALEXANDRIA_ALL_ITEMS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym24$CREATE_ALEXANDRIA_ALL_STRINGS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym25$CREATE_ALEXANDRIA_ALL_NUMBERS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym26$CREATE_ALEXANDRIA_ALL_SUBL_EXPRESSIONS_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym27$CREATE_ALEXANDRIA_ALL_VARIABLES_ITERATOR_STATE, NIL );
  }
  ...
  {
    return new_alexandria_iterator( $sym28$CREATE_ALEXANDRIA_ALL_UNREPRESENTED_TERMS_ITERATOR_STATE, NIL );
  }
  ...
  public static SubLObject new_alexandria_term_assertions_relevant_mt_pred_iterator(final SubLObject v_term, SubLObject type, SubLObject truth, SubLObject direction, SubLObject nesting_level)
  {
    ...
    return new_alexandria_iterator( $sym29$CREATE_ALEXANDRIA_TERM_ASSERTIONS_ITERATOR_STATE, ConsesLow.list( v_term, type, truth, direction, nesting_level ) );
  }
  ...
  public static SubLObject new_alexandria_gaf_arg0_iterator(final SubLObject predicate, SubLObject truth, SubLObject direction, SubLObject mt)
  {
    ...
    return new_alexandria_iterator( $sym30$CREATE_ALEXANDRIA_GAF_ARG0_ITERATOR_STATE, ConsesLow.list( predicate, truth, direction, mt ) );
  }
  ...
  public static SubLObject new_alexandria_gaf_arg0_iterator_relevant_mt(final SubLObject predicate, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym31$CREATE_ALEXANDRIA_GAF_ARG0_RELEVANT_MT_ITERATOR_STATE, ConsesLow.list( predicate, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_gaf_arg_iterator(final SubLObject v_term, SubLObject index, SubLObject predicate, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym32$CREATE_ALEXANDRIA_GAF_ARG_ITERATOR_STATE, ConsesLow.list( v_term, index, predicate, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_gaf_arg_relevant_mt_and_pred_iterator(final SubLObject v_term, SubLObject index, SubLObject predicate, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym33$CREATE_ALEXANDRIA_GAF_ARG_RELEVANT_MT_AND_PRED_ITERATOR_STATE, ConsesLow.list( v_term, index, predicate, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_gaf_arg_relevant_mt_iterator(final SubLObject v_term, SubLObject index, SubLObject predicate, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym34$CREATE_ALEXANDRIA_GAF_ARG_RELEVANT_MT_ITERATOR_STATE, ConsesLow.list( v_term, index, predicate, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_gaf_arg_formula_iterator(final SubLObject v_term, SubLObject index, SubLObject predicate, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym35$CREATE_ALEXANDRIA_GAF_ARG_FORMULA_ITERATOR_STATE, ConsesLow.list( v_term, index, predicate, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_gaf_arg_formula_relevant_mt_and_pred_iterator(final SubLObject v_term, SubLObject index, SubLObject predicate, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym36$CREATE_ALEXANDRIA_GAF_ARG_FORMULA_RELEVANT_MT_AND_PRED_ITERATOR_S, ConsesLow.list( v_term, index, predicate, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_gaf_arg_formula_relevant_mt_iterator(final SubLObject v_term, SubLObject index, SubLObject predicate, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym37$CREATE_ALEXANDRIA_GAF_ARG_FORMULA_RELEVANT_MT_ITERATOR_STATE, ConsesLow.list( v_term, index, predicate, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_gaf_arg_values_iterator(final SubLObject v_term, final SubLObject gather_index, SubLObject index, SubLObject predicate, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym38$CREATE_ALEXANDRIA_GAF_ARG_VALUES_ITERATOR_STATE, ConsesLow.list( v_term, gather_index, index, predicate, truth, direction ) );
  }

  @SubLTranslatedFile.SubL(source = "cycl/alexandria-iterators.lisp", position = 26517L)
  public static SubLObject create_alexandria_gaf_arg_values_relevant_mt_and_pred_iterator_state(final SubLObject v_term, final SubLObject gather_index, SubLObject index, SubLObject predicate, SubLObject truth,
  ...
  public static SubLObject new_alexandria_gaf_arg_values_relevant_mt_and_pred_iterator(final SubLObject v_term, final SubLObject gather_index, SubLObject index, SubLObject predicate, SubLObject truth,
      SubLObject direction)
  {
    if( index == UNPROVIDED )
    {
    ...
    return new_alexandria_iterator( $sym39$CREATE_ALEXANDRIA_GAF_ARG_VALUES_RELEVANT_MT_AND_PRED_ITERATOR_ST, ConsesLow.list( v_term, gather_index, index, predicate, truth, direction ) );
  }

  @SubLTranslatedFile.SubL(source = "cycl/alexandria-iterators.lisp", position = 27307L)
  public static SubLObject create_alexandria_gaf_arg_values_relevant_mt_iterator_state(final SubLObject v_term, final SubLObject gather_index, SubLObject index, SubLObject predicate, SubLObject truth,
      SubLObject direction)
  {
    if( index == UNPROVIDED )
    {
  ...
  public static SubLObject new_alexandria_gaf_arg_values_relevant_mt_iterator(final SubLObject v_term, final SubLObject gather_index, SubLObject index, SubLObject predicate, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym40$CREATE_ALEXANDRIA_GAF_ARG_VALUES_RELEVANT_MT_ITERATOR_STATE, ConsesLow.list( v_term, gather_index, index, predicate, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_gaf_arg_arg_relevant_mt_and_pred_iterator(final SubLObject term1, final SubLObject term2, SubLObject index1, SubLObject index2, SubLObject predicate, SubLObject truth,
      SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym41$CREATE_ALEXANDRIA_GAF_ARG_ARG_RELEVANT_MT_AND_PRED_ITERATOR_STATE, ConsesLow.list( term1, term2, index1, index2, predicate, truth, direction ) );
  }

  @SubLTranslatedFile.SubL(source = "cycl/alexandria-iterators.lisp", position = 29301L)
  public static SubLObject create_alexandria_gaf_arg_arg_relevant_mt_and_pred_iterator_state(final SubLObject term1, final SubLObject term2, SubLObject index1, SubLObject index2, SubLObject predicate, SubLObject truth,
      SubLObject direction)
  {
    if( index1 == UNPROVIDED )
    {
  ...
  public static SubLObject count_alexandria_gaf_arg_arg_relevant_mt_and_pred(final SubLObject term1, final SubLObject term2, SubLObject index1, SubLObject index2, SubLObject predicate, SubLObject truth,
      SubLObject direction)
  {
    if( index1 == UNPROVIDED )
    {
  ...
  public static SubLObject new_alexandria_mt_contents_iterator_relevant_pred(final SubLObject mt, SubLObject type, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym42$CREATE_ALEXANDRIA_MT_CONTENTS_ITERATOR_STATE_RELEVANT_MT, ConsesLow.list( mt, type, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_mt_contents_iterator(final SubLObject mt, SubLObject type, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym43$CREATE_ALEXANDRIA_MT_CONTENTS_ITERATOR_STATE, ConsesLow.list( mt, type, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_other_index_iterator(final SubLObject v_term, SubLObject type, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym44$CREATE_ALEXANDRIA_OTHER_INDEX_ITERATOR_STATE, ConsesLow.list( v_term, type, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_other_index_relevant_mt_and_pred_iterator(final SubLObject v_term, SubLObject type, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym45$CREATE_ALEXANDRIA_OTHER_INDEX_RELEVANT_MT_AND_PRED_ITERATOR_STATE, ConsesLow.list( v_term, type, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_other_index_relevant_mt_iterator(final SubLObject v_term, SubLObject type, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym46$CREATE_ALEXANDRIA_OTHER_INDEX_RELEVANT_MT_ITERATOR_STATE, ConsesLow.list( v_term, type, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_rules_with_pred_iterator(final SubLObject pred, SubLObject sense, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym47$CREATE_ALEXANDRIA_RULES_WITH_PRED_RELEVANT_MT_ITERATOR_STATE, ConsesLow.list( pred, sense, direction ) );
  }
  ...
  public static SubLObject new_alexandria_rules_with_pred_and_arg2_iterator(final SubLObject pred, final SubLObject arg2, SubLObject sense, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym48$CREATE_ALEXANDRIA_RULES_WITH_PRED_AND_ARG2_ITERATOR_STATE, ConsesLow.list( pred, arg2, sense, direction ) );
  }
  ...
  public static SubLObject new_alexandria_rules_with_pred_and_arg2_relevant_mt_iterator(final SubLObject pred, final SubLObject arg2, SubLObject sense, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym49$CREATE_ALEXANDRIA_RULES_WITH_PRED_AND_ARG2_RELEVANT_MT_ITERATOR_S, ConsesLow.list( pred, arg2, sense, direction ) );
  }
  ...
  public static SubLObject new_alexandria_nested_formula_rules_iterator(final SubLObject outer_pred, final SubLObject inner_pred, SubLObject sense, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym50$CREATE_ALEXANDRIA_NESTED_FORMULA_RULES_ITERATOR_STATE, ConsesLow.list( outer_pred, inner_pred, sense, direction ) );
  }
  ...
  public static SubLObject new_alexandria_nested_formula_rules_relevant_mt_iterator(final SubLObject outer_pred, final SubLObject inner_pred, SubLObject sense, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym51$CREATE_ALEXANDRIA_NESTED_FORMULA_RULES_RELEVANT_MT_ITERATOR_STATE, ConsesLow.list( outer_pred, inner_pred, sense, direction ) );
  }
  ...
  public static SubLObject new_alexandria_function_extent_iterator(final SubLObject function, SubLObject truth, SubLObject direction)
  {
    ...
    return new_alexandria_iterator( $sym52$CREATE_ALEXANDRIA_FUNCTION_EXTENT_ITERATOR_STATE, ConsesLow.list( function, truth, direction ) );
  }
  ...
  public static SubLObject new_alexandria_nart_arg_index_iterator(final SubLObject v_term, SubLObject index, SubLObject function)
  {
    ...
    return new_alexandria_iterator( $sym53$CREATE_ALEXANDRIA_NART_ARG_INDEX_ITERATOR_STATE, ConsesLow.list( v_term, index, function ) );
  }
  ...
  {
    return new_alexandria_iterator( $sym53$CREATE_ALEXANDRIA_NART_ARG_INDEX_ITERATOR_STATE, ConsesLow.list( cnf ) );
  }
  ...
  public static SubLObject new_alexandria_assertion_asserted_by_iterator(final SubLObject user, SubLObject optimization)
  {
    ...
    return new_alexandria_iterator( $sym56$CREATE_ALEXANDRIA_ASSERTION_ASSERTED_BY_ITERATOR_STATE, ConsesLow.list( user, optimization ) );
  }
  ...
  public static SubLObject new_alexandria_assertion_asserted_why_iterator(final SubLObject reason, SubLObject optimization)
  {
    ...
    return new_alexandria_iterator( $sym57$CREATE_ALEXANDRIA_ASSERTION_ASSERTED_WHY_ITERATOR_STATE, ConsesLow.list( reason, optimization ) );
  }
  ...
  public static SubLObject new_alexandria_assertion_asserted_on_iterator(final SubLObject universal_date, SubLObject seconds)
  {
    ...
    return new_alexandria_iterator( $sym58$CREATE_ALEXANDRIA_ASSERTION_ASSERTED_ON_ITERATOR_STATE, ConsesLow.list( universal_date, seconds ) );
  }
  ...
  {
    SubLFiles.declareFunction( me, "new_alexandria_iterator", "NEW-ALEXANDRIA-ITERATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "alexandria_kb_store_iterator_done", "ALEXANDRIA-KB-STORE-ITERATOR-DONE", 1, 0, false );
    SubLFiles.declareFunction( me, "alexandria_kb_store_iterator_next", "ALEXANDRIA-KB-STORE-ITERATOR-NEXT", 1, 0, false );
    SubLFiles.declareFunction( me, "alexandria_kb_store_iterator_finalize", "ALEXANDRIA-KB-STORE-ITERATOR-FINALIZE", 1, 0, false );
    SubLFiles.declareFunction( me, "count_alexandria_gafs_matching_formula", "COUNT-ALEXANDRIA-GAFS-MATCHING-FORMULA", 1, 4, false );
    SubLFiles.declareFunction( me, "count_alexandria_gafs_matching_formula_relevant_mt_and_pred", "COUNT-ALEXANDRIA-GAFS-MATCHING-FORMULA-RELEVANT-MT-AND-PRED", 1, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_gafs_matching_formula_iterator_state", "CREATE-ALEXANDRIA-GAFS-MATCHING-FORMULA-ITERATOR-STATE", 1, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_gafs_matching_formula_iterator", "NEW-ALEXANDRIA-GAFS-MATCHING-FORMULA-ITERATOR", 1, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_gafs_matching_formula_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-GAFS-MATCHING-FORMULA-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 1, 3, false );
    SubLFiles.declareFunction( me, "new_alexandria_gafs_matching_formula_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-GAFS-MATCHING-FORMULA-RELEVANT-MT-AND-PRED-ITERATOR", 1, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_nats_matching_formula_iterator", "CREATE-ALEXANDRIA-NATS-MATCHING-FORMULA-ITERATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_nats_matching_formula_iterator", "NEW-ALEXANDRIA-NATS-MATCHING-FORMULA-ITERATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "count_alexandria_nats_matching_formula", "COUNT-ALEXANDRIA-NATS-MATCHING-FORMULA", 2, 0, false );
    SubLFiles.declareFunction( me, "count_alexandria_reifiable_function_extent", "COUNT-ALEXANDRIA-REIFIABLE-FUNCTION-EXTENT", 1, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_reifiable_function_extent_iterator_state", "CREATE-ALEXANDRIA-REIFIABLE-FUNCTION-EXTENT-ITERATOR-STATE", 1, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_reifiable_function_extent_iterator", "NEW-ALEXANDRIA-REIFIABLE-FUNCTION-EXTENT-ITERATOR", 1, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_forts_iterator_state", "CREATE-ALEXANDRIA-ALL-FORTS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_forts_iterator", "NEW-ALEXANDRIA-ALL-FORTS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_gafs_iterator_state", "CREATE-ALEXANDRIA-ALL-GAFS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_gafs_iterator", "NEW-ALEXANDRIA-ALL-GAFS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_rules_iterator_state", "CREATE-ALEXANDRIA-ALL-RULES-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_rules_iterator", "NEW-ALEXANDRIA-ALL-RULES-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_unbound_rules_iterator_state", "CREATE-ALEXANDRIA-ALL-UNBOUND-RULES-ITERATOR-STATE", 0, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_unbound_rules_iterator", "NEW-ALEXANDRIA-ALL-UNBOUND-RULES-ITERATOR", 0, 2, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_unbound_rules_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-ALL-UNBOUND-RULES-RELEVANT-MT-ITERATOR-STATE", 0, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_unbound_rules_relevant_mt_iterator", "NEW-ALEXANDRIA-ALL-UNBOUND-RULES-RELEVANT-MT-ITERATOR", 0, 2, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_assertions_iterator_state", "CREATE-ALEXANDRIA-ALL-ASSERTIONS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_assertions_iterator", "NEW-ALEXANDRIA-ALL-ASSERTIONS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_big_integers_iterator_state", "CREATE-ALEXANDRIA-ALL-BIG-INTEGERS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_big_integers_iterator", "NEW-ALEXANDRIA-ALL-BIG-INTEGERS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_integers_iterator_state", "CREATE-ALEXANDRIA-ALL-INTEGERS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_integers_iterator", "NEW-ALEXANDRIA-ALL-INTEGERS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_bookkeeping_gafs_iterator_state", "CREATE-ALEXANDRIA-ALL-BOOKKEEPING-GAFS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_bookkeeping_gafs_iterator", "NEW-ALEXANDRIA-ALL-BOOKKEEPING-GAFS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_constants_iterator_state", "CREATE-ALEXANDRIA-ALL-CONSTANTS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_constants_iterator", "NEW-ALEXANDRIA-ALL-CONSTANTS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_narts_iterator_state", "CREATE-ALEXANDRIA-ALL-NARTS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_narts_iterator", "NEW-ALEXANDRIA-ALL-NARTS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_deductions_iterator_state", "CREATE-ALEXANDRIA-ALL-DEDUCTIONS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_deductions_iterator", "NEW-ALEXANDRIA-ALL-DEDUCTIONS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_floats_iterator_state", "CREATE-ALEXANDRIA-ALL-FLOATS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_floats_iterator", "NEW-ALEXANDRIA-ALL-FLOATS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_formulas_iterator_state", "CREATE-ALEXANDRIA-ALL-FORMULAS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_formulas_iterator", "NEW-ALEXANDRIA-ALL-FORMULAS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_hl_supports_iterator_state", "CREATE-ALEXANDRIA-ALL-HL-SUPPORTS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_hl_supports_iterator", "NEW-ALEXANDRIA-ALL-HL-SUPPORTS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_kb_hl_supports_iterator_state", "CREATE-ALEXANDRIA-ALL-KB-HL-SUPPORTS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_kb_hl_supports_iterator", "NEW-ALEXANDRIA-ALL-KB-HL-SUPPORTS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_items_iterator_state", "CREATE-ALEXANDRIA-ALL-ITEMS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_items_iterator", "NEW-ALEXANDRIA-ALL-ITEMS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_strings_iterator_state", "CREATE-ALEXANDRIA-ALL-STRINGS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_strings_iterator", "NEW-ALEXANDRIA-ALL-STRINGS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_numbers_iterator_state", "CREATE-ALEXANDRIA-ALL-NUMBERS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_numbers_iterator", "NEW-ALEXANDRIA-ALL-NUMBERS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_subl_expressions_iterator_state", "CREATE-ALEXANDRIA-ALL-SUBL-EXPRESSIONS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_subl_expressions_iterator", "NEW-ALEXANDRIA-ALL-SUBL-EXPRESSIONS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_variables_iterator_state", "CREATE-ALEXANDRIA-ALL-VARIABLES-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_variables_iterator", "NEW-ALEXANDRIA-ALL-VARIABLES-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_all_unrepresented_terms_iterator_state", "CREATE-ALEXANDRIA-ALL-UNREPRESENTED-TERMS-ITERATOR-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_all_unrepresented_terms_iterator", "NEW-ALEXANDRIA-ALL-UNREPRESENTED-TERMS-ITERATOR", 0, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_term_assertions_relevant_mt_pred_iterator_state", "CREATE-ALEXANDRIA-TERM-ASSERTIONS-RELEVANT-MT-PRED-ITERATOR-STATE", 1, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_term_assertions_relevant_mt_pred_iterator", "NEW-ALEXANDRIA-TERM-ASSERTIONS-RELEVANT-MT-PRED-ITERATOR", 1, 4, false );
    SubLFiles.declareFunction( me, "count_alexandria_term_assertions_relevant_mt_pred", "COUNT-ALEXANDRIA-TERM-ASSERTIONS-RELEVANT-MT-PRED", 1, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_term_assertions_iterator_state", "CREATE-ALEXANDRIA-TERM-ASSERTIONS-ITERATOR-STATE", 1, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_term_assertions_iterator", "NEW-ALEXANDRIA-TERM-ASSERTIONS-ITERATOR", 1, 4, false );
    SubLFiles.declareFunction( me, "count_alexandria_term_assertions", "COUNT-ALEXANDRIA-TERM-ASSERTIONS", 1, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg0_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG0-ITERATOR-STATE", 1, 3, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg0_iterator", "NEW-ALEXANDRIA-GAF-ARG0-ITERATOR", 1, 3, false );
    SubLFiles.declareFunction( me, "count_alexandria_gaf_arg0", "COUNT-ALEXANDRIA-GAF-ARG0", 1, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg0_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG0-RELEVANT-MT-ITERATOR-STATE", 1, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg0_iterator_relevant_mt", "NEW-ALEXANDRIA-GAF-ARG0-ITERATOR-RELEVANT-MT", 1, 2, false );
    SubLFiles.declareFunction( me, "count_alexandria_gaf_arg0_relevant_mt", "COUNT-ALEXANDRIA-GAF-ARG0-RELEVANT-MT", 1, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-ITERATOR-STATE", 1, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg_iterator", "NEW-ALEXANDRIA-GAF-ARG-ITERATOR", 1, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 1, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-GAF-ARG-RELEVANT-MT-AND-PRED-ITERATOR", 1, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-RELEVANT-MT-ITERATOR-STATE", 1, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg_relevant_mt_iterator", "NEW-ALEXANDRIA-GAF-ARG-RELEVANT-MT-ITERATOR", 1, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg_formula_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-FORMULA-ITERATOR-STATE", 1, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg_formula_iterator", "NEW-ALEXANDRIA-GAF-ARG-FORMULA-ITERATOR", 1, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg_formula_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-FORMULA-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 1, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg_formula_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-GAF-ARG-FORMULA-RELEVANT-MT-AND-PRED-ITERATOR", 1, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg_formula_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-FORMULA-RELEVANT-MT-ITERATOR-STATE", 1, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg_formula_relevant_mt_iterator", "NEW-ALEXANDRIA-GAF-ARG-FORMULA-RELEVANT-MT-ITERATOR", 1, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg_values_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-VALUES-ITERATOR-STATE", 2, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg_values_iterator", "NEW-ALEXANDRIA-GAF-ARG-VALUES-ITERATOR", 2, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg_values_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-VALUES-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 2, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg_values_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-GAF-ARG-VALUES-RELEVANT-MT-AND-PRED-ITERATOR", 2, 4, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg_values_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-VALUES-RELEVANT-MT-ITERATOR-STATE", 2, 4, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg_values_relevant_mt_iterator", "NEW-ALEXANDRIA-GAF-ARG-VALUES-RELEVANT-MT-ITERATOR", 2, 4, false );
    SubLFiles.declareFunction( me, "count_alexandria_gaf_arg_relevant_mt_and_pred", "COUNT-ALEXANDRIA-GAF-ARG-RELEVANT-MT-AND-PRED", 1, 4, false );
    SubLFiles.declareFunction( me, "count_alexandria_gaf_arg", "COUNT-ALEXANDRIA-GAF-ARG", 1, 5, false );
    SubLFiles.declareFunction( me, "new_alexandria_gaf_arg_arg_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-GAF-ARG-ARG-RELEVANT-MT-AND-PRED-ITERATOR", 2, 5, false );
    SubLFiles.declareFunction( me, "create_alexandria_gaf_arg_arg_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-GAF-ARG-ARG-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 2, 5, false );
    SubLFiles.declareFunction( me, "count_alexandria_gaf_arg_arg_relevant_mt_and_pred", "COUNT-ALEXANDRIA-GAF-ARG-ARG-RELEVANT-MT-AND-PRED", 2, 5, false );
    SubLFiles.declareFunction( me, "create_alexandria_mt_contents_iterator_state_relevant_pred", "CREATE-ALEXANDRIA-MT-CONTENTS-ITERATOR-STATE-RELEVANT-PRED", 1, 3, false );
    SubLFiles.declareFunction( me, "new_alexandria_mt_contents_iterator_relevant_pred", "NEW-ALEXANDRIA-MT-CONTENTS-ITERATOR-RELEVANT-PRED", 1, 3, false );
    SubLFiles.declareFunction( me, "count_alexandria_mt_contents_relevant_pred", "COUNT-ALEXANDRIA-MT-CONTENTS-RELEVANT-PRED", 1, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_mt_contents_iterator_state", "CREATE-ALEXANDRIA-MT-CONTENTS-ITERATOR-STATE", 1, 3, false );
    SubLFiles.declareFunction( me, "new_alexandria_mt_contents_iterator", "NEW-ALEXANDRIA-MT-CONTENTS-ITERATOR", 1, 3, false );
    SubLFiles.declareFunction( me, "count_alexandria_mt_contents", "COUNT-ALEXANDRIA-MT-CONTENTS", 1, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_other_index_iterator_state", "CREATE-ALEXANDRIA-OTHER-INDEX-ITERATOR-STATE", 1, 3, false );
    SubLFiles.declareFunction( me, "new_alexandria_other_index_iterator", "NEW-ALEXANDRIA-OTHER-INDEX-ITERATOR", 1, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_other_index_relevant_mt_and_pred_iterator_state", "CREATE-ALEXANDRIA-OTHER-INDEX-RELEVANT-MT-AND-PRED-ITERATOR-STATE", 1, 3, false );
    SubLFiles.declareFunction( me, "new_alexandria_other_index_relevant_mt_and_pred_iterator", "NEW-ALEXANDRIA-OTHER-INDEX-RELEVANT-MT-AND-PRED-ITERATOR", 1, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_other_index_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-OTHER-INDEX-RELEVANT-MT-ITERATOR-STATE", 1, 3, false );
    SubLFiles.declareFunction( me, "new_alexandria_other_index_relevant_mt_iterator", "NEW-ALEXANDRIA-OTHER-INDEX-RELEVANT-MT-ITERATOR", 1, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_rules_with_pred_iterator_state", "CREATE-ALEXANDRIA-RULES-WITH-PRED-ITERATOR-STATE", 1, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_rules_with_pred_iterator", "NEW-ALEXANDRIA-RULES-WITH-PRED-ITERATOR", 1, 2, false );
    SubLFiles.declareFunction( me, "count_alexandria_rules_with_pred", "COUNT-ALEXANDRIA-RULES-WITH-PRED", 1, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_rules_with_pred_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-RULES-WITH-PRED-RELEVANT-MT-ITERATOR-STATE", 1, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_rules_with_pred_relevant_mt_iterator", "NEW-ALEXANDRIA-RULES-WITH-PRED-RELEVANT-MT-ITERATOR", 1, 2, false );
    SubLFiles.declareFunction( me, "count_alexandria_rules_with_pred_relevant_mt", "COUNT-ALEXANDRIA-RULES-WITH-PRED-RELEVANT-MT", 1, 2, false );
    SubLFiles.declareFunction( me, "create_alexandria_rules_with_pred_and_arg2_iterator_state", "CREATE-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-ITERATOR-STATE", 2, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_rules_with_pred_and_arg2_iterator", "NEW-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-ITERATOR", 2, 2, false );
    SubLFiles.declareFunction( me, "count_alexandria_rules_with_pred_and_arg2", "COUNT-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2", 2, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_rules_with_pred_and_arg2_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-RELEVANT-MT-ITERATOR-STATE", 2, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_rules_with_pred_and_arg2_relevant_mt_iterator", "NEW-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-RELEVANT-MT-ITERATOR", 2, 2, false );
    SubLFiles.declareFunction( me, "count_alexandria_rules_with_pred_and_arg2_relevant_mt", "COUNT-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-RELEVANT-MT", 2, 2, false );
    SubLFiles.declareFunction( me, "create_alexandria_nested_formula_rules_iterator_state", "CREATE-ALEXANDRIA-NESTED-FORMULA-RULES-ITERATOR-STATE", 2, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_nested_formula_rules_iterator", "NEW-ALEXANDRIA-NESTED-FORMULA-RULES-ITERATOR", 2, 2, false );
    SubLFiles.declareFunction( me, "count_alexandria_nested_formula_rules", "COUNT-ALEXANDRIA-NESTED-FORMULA-RULES", 2, 3, false );
    SubLFiles.declareFunction( me, "create_alexandria_nested_formula_rules_relevant_mt_iterator_state", "CREATE-ALEXANDRIA-NESTED-FORMULA-RULES-RELEVANT-MT-ITERATOR-STATE", 2, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_nested_formula_rules_relevant_mt_iterator", "NEW-ALEXANDRIA-NESTED-FORMULA-RULES-RELEVANT-MT-ITERATOR", 2, 2, false );
    SubLFiles.declareFunction( me, "count_alexandria_nested_formula_rules_relevant_mt", "COUNT-ALEXANDRIA-NESTED-FORMULA-RULES-RELEVANT-MT", 2, 2, false );
    SubLFiles.declareFunction( me, "create_alexandria_function_extent_iterator_state", "CREATE-ALEXANDRIA-FUNCTION-EXTENT-ITERATOR-STATE", 1, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_function_extent_iterator", "NEW-ALEXANDRIA-FUNCTION-EXTENT-ITERATOR", 1, 2, false );
    SubLFiles.declareFunction( me, "count_alexandria_nart_arg_index", "COUNT-ALEXANDRIA-NART-ARG-INDEX", 1, 2, false );
    SubLFiles.declareFunction( me, "create_alexandria_nart_arg_index_iterator_state", "CREATE-ALEXANDRIA-NART-ARG-INDEX-ITERATOR-STATE", 1, 2, false );
    SubLFiles.declareFunction( me, "new_alexandria_nart_arg_index_iterator", "NEW-ALEXANDRIA-NART-ARG-INDEX-ITERATOR", 1, 2, false );
    SubLFiles.declareFunction( me, "create_alexandria_rules_with_cnf_iterator_state", "CREATE-ALEXANDRIA-RULES-WITH-CNF-ITERATOR-STATE", 1, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_rules_with_cnf_iterator", "NEW-ALEXANDRIA-RULES-WITH-CNF-ITERATOR", 1, 0, false );
    SubLFiles.declareFunction( me, "does_constant_exist_with_name_or_guid", "DOES-CONSTANT-EXIST-WITH-NAME-OR-GUID", 2, 1, false );
    SubLFiles.declareFunction( me, "clear_alexandria_caches", "CLEAR-ALEXANDRIA-CACHES", 0, 0, false );
    SubLFiles.declareFunction( me, "term_assertion_usage_count_estimate", "TERM-ASSERTION-USAGE-COUNT-ESTIMATE", 1, 0, false );
    SubLFiles.declareFunction( me, "estimated_cost_for_indexing_on_term", "ESTIMATED-COST-FOR-INDEXING-ON-TERM", 1, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_assertion_asserted_by_iterator_state", "CREATE-ALEXANDRIA-ASSERTION-ASSERTED-BY-ITERATOR-STATE", 1, 1, false );
    SubLFiles.declareFunction( me, "new_alexandria_assertion_asserted_by_iterator", "NEW-ALEXANDRIA-ASSERTION-ASSERTED-BY-ITERATOR", 1, 1, false );
    SubLFiles.declareFunction( me, "count_alexandria_rules_assertion_asserted_by", "COUNT-ALEXANDRIA-RULES-ASSERTION-ASSERTED-BY", 1, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_assertion_asserted_why_iterator_state", "CREATE-ALEXANDRIA-ASSERTION-ASSERTED-WHY-ITERATOR-STATE", 1, 1, false );
    SubLFiles.declareFunction( me, "new_alexandria_assertion_asserted_why_iterator", "NEW-ALEXANDRIA-ASSERTION-ASSERTED-WHY-ITERATOR", 1, 1, false );
    SubLFiles.declareFunction( me, "count_alexandria_rules_assertion_asserted_why", "COUNT-ALEXANDRIA-RULES-ASSERTION-ASSERTED-WHY", 1, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_assertion_asserted_on_iterator_state", "CREATE-ALEXANDRIA-ASSERTION-ASSERTED-ON-ITERATOR-STATE", 1, 1, false );
    SubLFiles.declareFunction( me, "new_alexandria_assertion_asserted_on_iterator", "NEW-ALEXANDRIA-ASSERTION-ASSERTED-ON-ITERATOR", 1, 1, false );
    SubLFiles.declareFunction( me, "count_alexandria_rules_assertion_asserted_on", "COUNT-ALEXANDRIA-RULES-ASSERTION-ASSERTED-ON", 1, 1, false );
    SubLFiles.declareFunction( me, "all_genl_mts_alexandria", "ALL-GENL-MTS-ALEXANDRIA", 3, 0, false );
    SubLFiles.declareFunction( me, "all_spec_mts_alexandria", "ALL-SPEC-MTS-ALEXANDRIA", 3, 0, false );
    SubLFiles.declareFunction( me, "create_alexandria_defns_cache_iterator_state", "CREATE-ALEXANDRIA-DEFNS-CACHE-ITERATOR-STATE", 1, 0, false );
    SubLFiles.declareFunction( me, "new_alexandria_defns_cache_iterator", "NEW-ALEXANDRIA-DEFNS-CACHE-ITERATOR", 1, 0, false );
    return NIL;
  }
  ...
  static
  {
    me = new alexandria_iterators();
    $sym0$ALEXANDRIA_KB_STORE_ITERATOR_DONE = makeSymbol( "ALEXANDRIA-KB-STORE-ITERATOR-DONE" );
    $sym1$ALEXANDRIA_KB_STORE_ITERATOR_NEXT = makeSymbol( "ALEXANDRIA-KB-STORE-ITERATOR-NEXT" );
    $sym2$ALEXANDRIA_KB_STORE_ITERATOR_FINALIZE = makeSymbol( "ALEXANDRIA-KB-STORE-ITERATOR-FINALIZE" );
    $sym3$CREATE_ALEXANDRIA_GAFS_MATCHING_FORMULA_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAFS-MATCHING-FORMULA-ITERATOR-STATE" );
    $sym4$CREATE_ALEXANDRIA_GAFS_MATCHING_FORMULA_RELEVANT_MT_AND_PRED_ITER = makeSymbol( "CREATE-ALEXANDRIA-GAFS-MATCHING-FORMULA-RELEVANT-MT-AND-PRED-ITERATOR-STATE" );
    $sym5$CREATE_ALEXANDRIA_NATS_MATCHING_FORMULA_ITERATOR = makeSymbol( "CREATE-ALEXANDRIA-NATS-MATCHING-FORMULA-ITERATOR" );
    $sym6$CREATE_ALEXANDRIA_REIFIABLE_FUNCTION_EXTENT_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-REIFIABLE-FUNCTION-EXTENT-ITERATOR-STATE" );
    $sym7$CREATE_ALEXANDRIA_ALL_FORTS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-FORTS-ITERATOR-STATE" );
    $sym8$CREATE_ALEXANDRIA_ALL_GAFS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-GAFS-ITERATOR-STATE" );
    $sym9$CREATE_ALEXANDRIA_ALL_RULES_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-RULES-ITERATOR-STATE" );
    $sym10$CREATE_ALEXANDRIA_ALL_UNBOUND_RULES_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-UNBOUND-RULES-ITERATOR-STATE" );
    $sym11$CREATE_ALEXANDRIA_ALL_UNBOUND_RULES_RELEVANT_MT_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-UNBOUND-RULES-RELEVANT-MT-ITERATOR-STATE" );
    $sym12$CREATE_ALEXANDRIA_ALL_ASSERTIONS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-ASSERTIONS-ITERATOR-STATE" );
    $sym13$CREATE_ALEXANDRIA_ALL_BIG_INTEGERS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-BIG-INTEGERS-ITERATOR-STATE" );
    $sym14$CREATE_ALEXANDRIA_ALL_INTEGERS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-INTEGERS-ITERATOR-STATE" );
    $sym15$CREATE_ALEXANDRIA_ALL_BOOKKEEPING_GAFS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-BOOKKEEPING-GAFS-ITERATOR-STATE" );
    $sym16$CREATE_ALEXANDRIA_ALL_CONSTANTS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-CONSTANTS-ITERATOR-STATE" );
    $sym17$CREATE_ALEXANDRIA_ALL_NARTS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-NARTS-ITERATOR-STATE" );
    $sym18$CREATE_ALEXANDRIA_ALL_DEDUCTIONS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-DEDUCTIONS-ITERATOR-STATE" );
    $sym19$CREATE_ALEXANDRIA_ALL_FLOATS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-FLOATS-ITERATOR-STATE" );
    $sym20$CREATE_ALEXANDRIA_ALL_FORMULAS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-FORMULAS-ITERATOR-STATE" );
    $sym21$CREATE_ALEXANDRIA_ALL_HL_SUPPORTS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-HL-SUPPORTS-ITERATOR-STATE" );
    $sym22$CREATE_ALEXANDRIA_ALL_KB_HL_SUPPORTS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-KB-HL-SUPPORTS-ITERATOR-STATE" );
    $sym23$CREATE_ALEXANDRIA_ALL_ITEMS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-ITEMS-ITERATOR-STATE" );
    $sym24$CREATE_ALEXANDRIA_ALL_STRINGS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-STRINGS-ITERATOR-STATE" );
    $sym25$CREATE_ALEXANDRIA_ALL_NUMBERS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-NUMBERS-ITERATOR-STATE" );
    $sym26$CREATE_ALEXANDRIA_ALL_SUBL_EXPRESSIONS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-SUBL-EXPRESSIONS-ITERATOR-STATE" );
    $sym27$CREATE_ALEXANDRIA_ALL_VARIABLES_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-VARIABLES-ITERATOR-STATE" );
    $sym28$CREATE_ALEXANDRIA_ALL_UNREPRESENTED_TERMS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ALL-UNREPRESENTED-TERMS-ITERATOR-STATE" );
    $sym29$CREATE_ALEXANDRIA_TERM_ASSERTIONS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-TERM-ASSERTIONS-ITERATOR-STATE" );
    $sym30$CREATE_ALEXANDRIA_GAF_ARG0_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG0-ITERATOR-STATE" );
    $sym31$CREATE_ALEXANDRIA_GAF_ARG0_RELEVANT_MT_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG0-RELEVANT-MT-ITERATOR-STATE" );
    $sym32$CREATE_ALEXANDRIA_GAF_ARG_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG-ITERATOR-STATE" );
    $sym33$CREATE_ALEXANDRIA_GAF_ARG_RELEVANT_MT_AND_PRED_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG-RELEVANT-MT-AND-PRED-ITERATOR-STATE" );
    $sym34$CREATE_ALEXANDRIA_GAF_ARG_RELEVANT_MT_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG-RELEVANT-MT-ITERATOR-STATE" );
    $sym35$CREATE_ALEXANDRIA_GAF_ARG_FORMULA_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG-FORMULA-ITERATOR-STATE" );
    $sym36$CREATE_ALEXANDRIA_GAF_ARG_FORMULA_RELEVANT_MT_AND_PRED_ITERATOR_S = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG-FORMULA-RELEVANT-MT-AND-PRED-ITERATOR-STATE" );
    $sym37$CREATE_ALEXANDRIA_GAF_ARG_FORMULA_RELEVANT_MT_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG-FORMULA-RELEVANT-MT-ITERATOR-STATE" );
    $sym38$CREATE_ALEXANDRIA_GAF_ARG_VALUES_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG-VALUES-ITERATOR-STATE" );
    $sym39$CREATE_ALEXANDRIA_GAF_ARG_VALUES_RELEVANT_MT_AND_PRED_ITERATOR_ST = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG-VALUES-RELEVANT-MT-AND-PRED-ITERATOR-STATE" );
    $sym40$CREATE_ALEXANDRIA_GAF_ARG_VALUES_RELEVANT_MT_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG-VALUES-RELEVANT-MT-ITERATOR-STATE" );
    $sym41$CREATE_ALEXANDRIA_GAF_ARG_ARG_RELEVANT_MT_AND_PRED_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-GAF-ARG-ARG-RELEVANT-MT-AND-PRED-ITERATOR-STATE" );
    $sym42$CREATE_ALEXANDRIA_MT_CONTENTS_ITERATOR_STATE_RELEVANT_MT = makeSymbol( "CREATE-ALEXANDRIA-MT-CONTENTS-ITERATOR-STATE-RELEVANT-MT" );
    $sym43$CREATE_ALEXANDRIA_MT_CONTENTS_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-MT-CONTENTS-ITERATOR-STATE" );
    $sym44$CREATE_ALEXANDRIA_OTHER_INDEX_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-OTHER-INDEX-ITERATOR-STATE" );
    $sym45$CREATE_ALEXANDRIA_OTHER_INDEX_RELEVANT_MT_AND_PRED_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-OTHER-INDEX-RELEVANT-MT-AND-PRED-ITERATOR-STATE" );
    $sym46$CREATE_ALEXANDRIA_OTHER_INDEX_RELEVANT_MT_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-OTHER-INDEX-RELEVANT-MT-ITERATOR-STATE" );
    $sym47$CREATE_ALEXANDRIA_RULES_WITH_PRED_RELEVANT_MT_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-RULES-WITH-PRED-RELEVANT-MT-ITERATOR-STATE" );
    $sym48$CREATE_ALEXANDRIA_RULES_WITH_PRED_AND_ARG2_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-ITERATOR-STATE" );
    $sym49$CREATE_ALEXANDRIA_RULES_WITH_PRED_AND_ARG2_RELEVANT_MT_ITERATOR_S = makeSymbol( "CREATE-ALEXANDRIA-RULES-WITH-PRED-AND-ARG2-RELEVANT-MT-ITERATOR-STATE" );
    $sym50$CREATE_ALEXANDRIA_NESTED_FORMULA_RULES_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-NESTED-FORMULA-RULES-ITERATOR-STATE" );
    $sym51$CREATE_ALEXANDRIA_NESTED_FORMULA_RULES_RELEVANT_MT_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-NESTED-FORMULA-RULES-RELEVANT-MT-ITERATOR-STATE" );
    $sym52$CREATE_ALEXANDRIA_FUNCTION_EXTENT_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-FUNCTION-EXTENT-ITERATOR-STATE" );
    $sym53$CREATE_ALEXANDRIA_NART_ARG_INDEX_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-NART-ARG-INDEX-ITERATOR-STATE" );
    $kw54$UNKNOWN = makeKeyword( "UNKNOWN" );
    $kw55$LATENCY = makeKeyword( "LATENCY" );
    $sym56$CREATE_ALEXANDRIA_ASSERTION_ASSERTED_BY_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ASSERTION-ASSERTED-BY-ITERATOR-STATE" );
    $sym57$CREATE_ALEXANDRIA_ASSERTION_ASSERTED_WHY_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ASSERTION-ASSERTED-WHY-ITERATOR-STATE" );
    $sym58$CREATE_ALEXANDRIA_ASSERTION_ASSERTED_ON_ITERATOR_STATE = makeSymbol( "CREATE-ALEXANDRIA-ASSERTION-ASSERTED-ON-ITERATOR-STATE" );
  }
}
/*
 * 
