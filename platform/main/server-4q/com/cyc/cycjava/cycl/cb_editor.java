...
import static com.cyc.cycjava.cycl.cb_editor.*;
...
public final class cb_editor extends SubLTranslatedFile {
    ...
    private static final SubLObject $$ReservedConstant = reader_make_constant_shell(makeString("ReservedConstant"));

    private static final SubLList $list35 = list(reader_make_constant_shell(makeString("InstanceNamedFn-Ternary")), reader_make_constant_shell(makeString("ProperSubcollectionNamedFn-Ternary")), reader_make_constant_shell(makeString("CityNamedFn")), reader_make_constant_shell(makeString("PersonNamedFn")), reader_make_constant_shell(makeString("PlaceNamedFn")), reader_make_constant_shell(makeString("PredicateNamedFn")), reader_make_constant_shell(makeString("StreetNamedFn")), reader_make_constant_shell(makeString("OrganizationNamedFn")));
    ...
    public static SubLObject declare_cb_editor_file() {
        declareFunction(me, "cb_create_hook", "CB-CREATE-HOOK", 1, 0, false);
        declareFunction(me, "cb_hypothesize_hook", "CB-HYPOTHESIZE-HOOK", 2, 0, false);
        declareFunction(me, "cb_term_toolbar", "CB-TERM-TOOLBAR", 1, 0, false);
        declareFunction(me, "term_modification_permittedP", "TERM-MODIFICATION-PERMITTED?", 1, 0, false);
        declareFunction(me, "term_modification_forbiddenP", "TERM-MODIFICATION-FORBIDDEN?", 1, 0, false);
        declareFunction(me, "term_as_merge_source_permittedP", "TERM-AS-MERGE-SOURCE-PERMITTED?", 1, 0, false);
        declareFunction(me, "cb_create", "CB-CREATE", 0, 1, false);
        declareFunction(me, "cb_handle_create", "CB-HANDLE-CREATE", 1, 0, false);
        declareFunction(me, "cb_link_create", "CB-LINK-CREATE", 0, 1, false);
        declareFunction(me, "cb_create_similar_legacy", "CB-CREATE-SIMILAR-LEGACY", 1, 0, false);
        declareFunction(me, "cb_handle_create_similar_legacy", "CB-HANDLE-CREATE-SIMILAR-LEGACY", 1, 0, false);
        declareFunction(me, "cb_handle_create_similar", "CB-HANDLE-CREATE-SIMILAR", 1, 0, false);
        declareFunction(me, "cb_link_create_similar", "CB-LINK-CREATE-SIMILAR", 1, 1, false);
        declareFunction(me, "cb_create_similar_guest_warn", "CB-CREATE-SIMILAR-GUEST-WARN", 0, 0, false);
        declareFunction(me, "cb_similar_button_row", "CB-SIMILAR-BUTTON-ROW", 0, 1, false);
        declareFunction(me, "xml_fort_info", "XML-FORT-INFO", 1, 1, false);
        declareFunction(me, "fort_info_preds", "FORT-INFO-PREDS", 1, 1, false);
        declareFunction(me, "create_similar_valid_nat_nameP", "CREATE-SIMILAR-VALID-NAT-NAME?", 1, 0, false);
        declareFunction(me, "cb_create_similar", "CB-CREATE-SIMILAR", 1, 0, false);
        declareFunction(me, "cb_link_create_similar_legacy", "CB-LINK-CREATE-SIMILAR-LEGACY", 1, 1, false);
        declareFunction(me, "cb_link_create_instance", "CB-LINK-CREATE-INSTANCE", 1, 1, false);
        declareFunction(me, "cb_link_create_spec", "CB-LINK-CREATE-SPEC", 1, 1, false);
        declareFunction(me, "cb_link_create_spec_mt", "CB-LINK-CREATE-SPEC-MT", 1, 1, false);
        declareFunction(me, "cb_link_create_spec_pred", "CB-LINK-CREATE-SPEC-PRED", 1, 1, false);
        declareFunction(me, "cb_create_similar_checkbox", "CB-CREATE-SIMILAR-CHECKBOX", 1, 0, false);
        declareFunction(me, "cb_rename", "CB-RENAME", 1, 0, false);
        declareFunction(me, "cb_handle_rename", "CB-HANDLE-RENAME", 1, 0, false);
        declareFunction(me, "cb_link_rename", "CB-LINK-RENAME", 1, 2, false);
        declareFunction(me, "cb_merge", "CB-MERGE", 1, 0, false);
        declareFunction(me, "cb_handle_merge", "CB-HANDLE-MERGE", 1, 0, false);
        declareFunction(me, "cb_link_merge", "CB-LINK-MERGE", 1, 2, false);
        declareFunction(me, "cb_kill", "CB-KILL", 1, 0, false);
        declareFunction(me, "cb_link_kill", "CB-LINK-KILL", 1, 3, false);
        declareFunction(me, "cb_confirm_kill", "CB-CONFIRM-KILL", 1, 0, false);
        declareFunction(me, "cb_link_confirm_kill", "CB-LINK-CONFIRM-KILL", 1, 2, false);
        declareFunction(me, "cb_recreate", "CB-RECREATE", 1, 0, false);
        declareFunction(me, "cb_recreate_handler", "CB-RECREATE-HANDLER", 1, 0, false);
        declareFunction(me, "cb_link_recreate", "CB-LINK-RECREATE", 1, 2, false);
        declareFunction(me, "cb_all_assertions_tms", "CB-ALL-ASSERTIONS-TMS", 1, 0, false);
        declareFunction(me, "cb_all_assertions_tms_handler", "CB-ALL-ASSERTIONS-TMS-HANDLER", 1, 0, false);
        declareFunction(me, "cb_link_all_assertions_tms", "CB-LINK-ALL-ASSERTIONS-TMS", 1, 1, false);
        declareFunction(me, "cb_hypothesize_handler", "CB-HYPOTHESIZE-HANDLER", 0, 1, false);
        declareFunction(me, "cb_hypothesize_results", "CB-HYPOTHESIZE-RESULTS", 1, 0, false);
        declareFunction(me, "cb_link_hypothesize", "CB-LINK-HYPOTHESIZE", 0, 1, false);
        declareFunction(me, "xml_assertion_info", "XML-ASSERTION-INFO", 1, 0, false);
        declareFunction(me, "cb_form_smart", "CB-FORM-SMART", 1, 0, false);
        return NIL;
    }
