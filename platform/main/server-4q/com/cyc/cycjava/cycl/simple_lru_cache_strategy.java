...
import com.cyc.cycjava.cycl.simple_lru_cache_strategy;
...
import static com.cyc.cycjava.cycl.simple_lru_cache_strategy.*;
...
public final class simple_lru_cache_strategy extends SubLTranslatedFile {
    ...
    public static SubLObject simple_lru_cache_strategy_p(final SubLObject v_object) {
        return v_object.getClass() == simple_lru_cache_strategy.$simple_lru_cache_strategy_native.class ? T : NIL;
    }

    public static SubLObject slru_cachestrat_capacity(final SubLObject v_object) {
        assert NIL != simple_lru_cache_strategy_p(v_object) : "simple_lru_cache_strategy.simple_lru_cache_strategy_p(v_object) " + "CommonSymbols.NIL != simple_lru_cache_strategy.simple_lru_cache_strategy_p(v_object) " + v_object;
    ...
    public static SubLObject make_simple_lru_cache_strategy(SubLObject arglist) {
        ...
        final SubLObject v_new = new simple_lru_cache_strategy.$simple_lru_cache_strategy_native();
        SubLObject next;
    ...
    public static final class $simple_lru_cache_strategy_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(simple_lru_cache_strategy.$simple_lru_cache_strategy_native.class, SIMPLE_LRU_CACHE_STRATEGY, SIMPLE_LRU_CACHE_STRATEGY_P, $list2, $list3, new String[]{ "$capacity", "$index", "$payload", "$head", "$tail", "$freelist_head", "$metrics" }, $list4, $list5, PRINT_SIMPLE_LRU_CACHE_STRATEGY);
        }
    }
