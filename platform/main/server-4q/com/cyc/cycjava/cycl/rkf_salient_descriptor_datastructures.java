...
public final class rkf_salient_descriptor_datastructures extends SubLTranslatedFile {
    ...
    public static SubLObject rkf_salient_descriptor_prompter_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_salient_descriptor_datastructures.$rkf_salient_descriptor_prompter_native.class ? T : NIL;
    }

    public static SubLObject rkf_sd_prompter_seed_term(final SubLObject v_object) {
        assert NIL != rkf_salient_descriptor_prompter_p(v_object) : "rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompter_p(v_object) " + "CommonSymbols.NIL != rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompter_p(v_object) " + v_object;
    ...
    public static SubLObject make_rkf_salient_descriptor_prompter(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_salient_descriptor_datastructures.$rkf_salient_descriptor_prompter_native();
        SubLObject next;
    ...
    public static SubLObject rkf_salient_descriptor_prompt_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_salient_descriptor_datastructures.$rkf_salient_descriptor_prompt_native.class ? T : NIL;
    }

    public static SubLObject rkf_sd_prompt_id(final SubLObject v_object) {
        assert NIL != rkf_salient_descriptor_prompt_p(v_object) : "rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompt_p(v_object) " + "CommonSymbols.NIL != rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompt_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_rkf_salient_descriptor_prompt(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_salient_descriptor_datastructures.$rkf_salient_descriptor_prompt_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject rkf_sd_rule_info_score_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_salient_descriptor_datastructures.$rkf_sd_rule_info_score_native.class ? T : NIL;
    }

    public static SubLObject rkf_sd_rule_info_score_seed_term_in_pos_litsP(final SubLObject v_object) {
        assert NIL != rkf_sd_rule_info_score_p(v_object) : "rkf_salient_descriptor_datastructures.rkf_sd_rule_info_score_p(v_object) " + "CommonSymbols.NIL != rkf_salient_descriptor_datastructures.rkf_sd_rule_info_score_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_rkf_sd_rule_info_score(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_salient_descriptor_datastructures.$rkf_sd_rule_info_score_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject rkf_sd_example_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_salient_descriptor_datastructures.$rkf_sd_example_native.class ? T : NIL;
    }

    public static SubLObject rkf_sd_example_type(final SubLObject v_object) {
        assert NIL != rkf_sd_example_p(v_object) : "rkf_salient_descriptor_datastructures.rkf_sd_example_p(v_object) " + "CommonSymbols.NIL != rkf_salient_descriptor_datastructures.rkf_sd_example_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_rkf_sd_example(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_salient_descriptor_datastructures.$rkf_sd_example_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $rkf_salient_descriptor_prompter_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_salient_descriptor_datastructures.$rkf_salient_descriptor_prompter_native.class, RKF_SALIENT_DESCRIPTOR_PROMPTER, RKF_SALIENT_DESCRIPTOR_PROMPTER_P, $list2, $list3, new String[]{ "$seed_term", "$mt", "$used_prompts", "$unused_prompts", "$tactics", "$isg", "$plist" }, $list4, $list5, PRINT_RKF_SD_PROMPTER);
        }
    }
    ...
    public static final class $rkf_sd_rule_info_score_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_salient_descriptor_datastructures.$rkf_sd_rule_info_score_native.class, RKF_SD_RULE_INFO_SCORE, RKF_SD_RULE_INFO_SCORE_P, $list88, $list89, new String[]{ "$seed_term_in_pos_litsP", "$seed_term_in_neg_litsP", "$var_count", "$neg_lit_count", "$pos_lit_count", "$pos_lit_quality_score", "$mt_generality_score", "$plist" }, $list90, $list91, PRINT_RKF_SD_RULE_INFO_SCORE);
        }
    }
    ...
    public static final class $rkf_sd_example_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_salient_descriptor_datastructures.$rkf_sd_example_native.class, RKF_SD_EXAMPLE, RKF_SD_EXAMPLE_P, $list131, $list132, new String[]{ "$type", "$term", "$supports", "$focus_term_analog" }, $list133, $list134, PRINT_RKF_SD_EXAMPLE);
        }
    }
