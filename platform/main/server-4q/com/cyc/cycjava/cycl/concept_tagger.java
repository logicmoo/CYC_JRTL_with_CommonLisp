...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class concept_tagger extends SubLTranslatedFile {
    ...
    public static SubLObject tag_concepts_iterator_state_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$tag_concepts_iterator_state_native.class ? T : NIL;
    }

    public static SubLObject tag_concepts_iterator_state_sentences_to_do(final SubLObject v_object) {
        assert NIL != tag_concepts_iterator_state_p(v_object) : "concept_tagger.tag_concepts_iterator_state_p error :" + v_object;
    ...
    public static SubLObject concept_tagger_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$concept_tagger_native.class ? T : NIL;
    }

    public static SubLObject concept_tagger_name(final SubLObject v_object) {
        assert NIL != concept_tagger_p(v_object) : "concept_tagger.concept_tagger_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $tag_concepts_iterator_state_native extends SubLStructNative {
        ...
        private $tag_concepts_iterator_state_native() {
        ...
        static {
            structDecl = makeStructDeclNative($tag_concepts_iterator_state_native.class, TAG_CONCEPTS_ITERATOR_STATE, TAG_CONCEPTS_ITERATOR_STATE_P, $list184, $list185, new String[]{ "$sentences_to_do", "$document", "$lexicon", "$sense_tagger", "$filter", "$output_spec", "$prepared_sentence_output" }, $list186, $list187, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $concept_tagger_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($concept_tagger_native.class, CONCEPT_TAGGER, CONCEPT_TAGGER_P, $list234, $list235, new String[]{ "$name", "$tag_method", "$lexicon_method" }, $list236, $list237, PRINT_CONCEPT_TAGGER);
        }
    }
