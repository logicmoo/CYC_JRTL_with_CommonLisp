...
import com.cyc.cycjava.cycl.finite_state_cascade_parser;
...
import static com.cyc.cycjava.cycl.finite_state_cascade_parser.*;
...
public final class finite_state_cascade_parser extends SubLTranslatedFile {
    ...
    public static SubLObject finite_state_cascade_parser_p(final SubLObject v_object) {
        return v_object.getClass() == finite_state_cascade_parser.$finite_state_cascade_parser_native.class ? T : NIL;
    }

    public static SubLObject fscp_transducers(final SubLObject v_object) {
        assert NIL != finite_state_cascade_parser_p(v_object) : "finite_state_cascade_parser.finite_state_cascade_parser_p(v_object) " + "CommonSymbols.NIL != finite_state_cascade_parser.finite_state_cascade_parser_p(v_object) " + v_object;
    ...
    public static SubLObject make_finite_state_cascade_parser(SubLObject arglist) {
        ...
        final SubLObject v_new = new finite_state_cascade_parser.$finite_state_cascade_parser_native();
        SubLObject next;
    ...
    public static final class $finite_state_cascade_parser_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(finite_state_cascade_parser.$finite_state_cascade_parser_native.class, FINITE_STATE_CASCADE_PARSER, FINITE_STATE_CASCADE_PARSER_P, $list2, $list3, new String[]{ "$transducers", "$lexer" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
