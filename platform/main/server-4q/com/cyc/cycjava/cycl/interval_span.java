...
public final class interval_span extends SubLTranslatedFile {
    ...
    public static SubLObject interval_span_p(final SubLObject v_object) {
        return v_object.getClass() == interval_span.$interval_span_native.class ? T : NIL;
    }

    public static SubLObject int_span_start(final SubLObject v_object) {
        assert NIL != interval_span_p(v_object) : "interval_span.interval_span_p(v_object) " + "CommonSymbols.NIL != interval_span.interval_span_p(v_object) " + v_object;
    ...
    public static SubLObject make_interval_span(SubLObject arglist) {
        ...
        final SubLObject v_new = new interval_span.$interval_span_native();
        SubLObject next;
    ...
    public static final class $interval_span_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(interval_span.$interval_span_native.class, INTERVAL_SPAN, INTERVAL_SPAN_P, $list2, $list3, new String[]{ "$start", "$end" }, $list4, $list5, PRINT_INTERVAL_SPAN);
        }
    }
