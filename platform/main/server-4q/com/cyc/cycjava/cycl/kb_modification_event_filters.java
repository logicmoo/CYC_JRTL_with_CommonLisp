...
import com.cyc.cycjava.cycl.kb_modification_event_filters;
...
import static com.cyc.cycjava.cycl.kb_modification_event_filters.*;
...
public final class kb_modification_event_filters extends SubLTranslatedFile {
    ...
    public static SubLObject event_filter_description_p(final SubLObject v_object) {
        return v_object.getClass() == kb_modification_event_filters.$event_filter_description_native.class ? T : NIL;
    }

    public static SubLObject event_filter_description_id(final SubLObject v_object) {
        assert NIL != event_filter_description_p(v_object) : "kb_modification_event_filters.event_filter_description_p(v_object) " + "CommonSymbols.NIL != kb_modification_event_filters.event_filter_description_p(v_object) " + v_object;
    ...
    public static SubLObject make_event_filter_description(SubLObject arglist) {
        ...
        final SubLObject v_new = new kb_modification_event_filters.$event_filter_description_native();
        SubLObject next;
    ...
    public static SubLObject message_mailbox_listener_p(final SubLObject v_object) {
        return v_object.getClass() == kb_modification_event_filters.$message_mailbox_listener_native.class ? T : NIL;
    }

    public static SubLObject mmbox_listener_address(final SubLObject v_object) {
        assert NIL != message_mailbox_listener_p(v_object) : "kb_modification_event_filters.message_mailbox_listener_p(v_object) " + "CommonSymbols.NIL != kb_modification_event_filters.message_mailbox_listener_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_message_mailbox_listener(SubLObject arglist) {
        ...
        final SubLObject v_new = new kb_modification_event_filters.$message_mailbox_listener_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $event_filter_description_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(kb_modification_event_filters.$event_filter_description_native.class, EVENT_FILTER_DESCRIPTION, EVENT_FILTER_DESCRIPTION_P, $list67, $list68, new String[]{ "$id", "$pattern" }, $list69, $list70, PRINT_EVENT_FILTER_DESCRIPTION);
        }
    }
    ...
    public static final class $message_mailbox_listener_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(kb_modification_event_filters.$message_mailbox_listener_native.class, MESSAGE_MAILBOX_LISTENER, MESSAGE_MAILBOX_LISTENER_P, $list155, $list156, new String[]{ "$address" }, $list157, $list158, PRINT_MESSAGE_MAILBOX_LISTENER);
        }
    }
