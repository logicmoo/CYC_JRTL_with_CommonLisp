...
import static com.cyc.cycjava.cycl.assertion_handles.$dtp_assertion$;
import static com.cyc.cycjava.cycl.assertion_handles.assertion_id;
import static com.cyc.cycjava.cycl.assertion_handles.create_sample_invalid_assertion;
...
import static com.cyc.cycjava.cycl.cfasl.cfasl_output_string;
...
import static com.cyc.cycjava.cycl.clause_strucs.$dtp_clause_struc$;
import static com.cyc.cycjava.cycl.clause_strucs.clause_struc_cnf;
import static com.cyc.cycjava.cycl.clause_strucs.clause_struc_dump_id;
import static com.cyc.cycjava.cycl.clause_strucs.clause_struc_id;
import static com.cyc.cycjava.cycl.clause_strucs.create_sample_invalid_clause_struc;
import static com.cyc.cycjava.cycl.clause_strucs.find_clause_struc_by_dump_id;
import static com.cyc.cycjava.cycl.clause_strucs.find_clause_struc_by_id;
import static com.cyc.cycjava.cycl.clause_strucs.invalid_clause_struc;
import static com.cyc.cycjava.cycl.constant_handles.$dtp_constant$;
import static com.cyc.cycjava.cycl.constant_handles.create_sample_invalid_constant;
...
import static com.cyc.cycjava.cycl.deduction_handles.create_sample_invalid_deduction;
...
import static com.cyc.cycjava.cycl.nart_handles.$dtp_nart$;
import static com.cyc.cycjava.cycl.nart_handles.create_sample_invalid_nart;
import static com.cyc.cycjava.cycl.nart_handles.find_nart_by_id;
import static com.cyc.cycjava.cycl.nart_handles.nart_id;
...
/**
 * Copyright (c) 1995 - 2019 Cycorp, Inc.  All rights reserved.
 * module:      CFASL-KB-METHODS
 * source file: /cyc/top/cycl/cfasl-kb-methods.lisp
...
public final class cfasl_kb_methods extends SubLTranslatedFile implements V12 {
     ...
     */
    @LispMethod(comment = "Return T iff we are assuming complete CFASL constants (having guid and name) and complete\r\nvariables (having only a name).\nReturn T iff we are assuming complete CFASL constants (having guid and name) and complete\nvariables (having only a name).")
    public static final SubLObject within_complete_cfasl_objects_p_alt() {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    public static final SubLObject with_cfasl_externalized_constant_exceptions_alt(SubLObject macroform, SubLObject environment) {
        {
    ...
    public static final SubLObject cfasl_externalized_constant_exception_p_alt(SubLObject constant) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    public static final SubLObject cfasl_output_constant_alt(SubLObject constant, SubLObject stream) {
        if (NIL != com.cyc.cycjava.cycl.cfasl_kb_methods.within_complete_cfasl_objects_p()) {
            cfasl_raw_write_byte($cfasl_opcode_complete_constant$.getGlobalValue(), stream);
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_constant_recipe(constant, stream);
            cfasl_output_string(constants_high.constant_name(constant), stream);
        } else {
            cfasl_raw_write_byte($cfasl_opcode_constant$.getGlobalValue(), stream);
            if (NIL != within_cfasl_externalization_p()) {
                com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_constant_recipe(constant, stream);
            } else {
                com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_constant_handle(constant, stream);
            }
        }
        return constant;
    }
    ...
    public static final SubLObject cfasl_output_object_constant_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_constant(v_object, stream);
    }
    ...
    public static final SubLObject cfasl_invalid_constant_alt() {
    ...
    public static final SubLObject cfasl_input_constant_alt(SubLObject stream) {
        {
            SubLObject constant = NIL;
            if (NIL != within_cfasl_externalization_p()) {
                constant = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_constant_recipe(stream);
            } else {
                constant = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_constant_handle(stream);
            }
            if (NIL == constant) {
     ...
     */
    @LispMethod(comment = "Input the complete CFASL constant, assuming within-cfasl-externalization-p, and\r\nignoring the constant name.\nInput the complete CFASL constant, assuming within-cfasl-externalization-p, and\nignoring the constant name.")
    public static final SubLObject cfasl_input_complete_constant_alt(SubLObject stream) {
        {
            SubLObject constant = NIL;
            constant = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_constant_recipe(stream);
    ...
    public static final SubLObject cfasl_output_constant_recipe_alt(SubLObject constant, SubLObject stream) {
        if (NIL != com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_externalized_constant_exception_p(constant)) {
            return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_constant_handle(constant, stream);
        }
        {
    ...
    public static final SubLObject cfasl_input_constant_recipe_alt(SubLObject stream) {
        {
            ...
            if (NIL != constants_high.constant_external_id_p(id)) {
                ...
                if (NIL != constants_high.constant_internal_id_p(id)) {
                    return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_constant_handle_lookup(id);
                }
            }
        }
        return NIL;
    ...
    public static final SubLObject cfasl_output_constant_handle_alt(SubLObject constant, SubLObject stream) {
        cfasl_output(com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_constant_handle(constant), stream);
        return constant;
    }
    ...
    public static final SubLObject cfasl_input_constant_handle_alt(SubLObject stream) {
        {
            SubLObject handle = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
            return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_constant_handle_lookup(handle);
        }
    }
    ...
    public static final SubLObject cfasl_constant_handle_alt(SubLObject constant) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            ...
            {
                SubLObject method = api_control_vars.$cfasl_constant_handle_func$.getDynamicValue(thread);
                if (NIL == method) {
    ...
    public static final SubLObject cfasl_constant_handle_lookup_alt(SubLObject id) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    public static final SubLObject cfasl_output_nart_alt(SubLObject nart, SubLObject stream) {
        cfasl_raw_write_byte($cfasl_opcode_nart$.getGlobalValue(), stream);
        if (NIL != within_cfasl_externalization_p()) {
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_nart_recipe(nart, stream);
        } else {
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_nart_handle(nart, stream);
        }
        return nart;
    }
    ...
    public static final SubLObject cfasl_output_object_nart_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_nart(v_object, stream);
    }
    ...
    public static final SubLObject cfasl_invalid_nart_alt() {
    ...
    public static final SubLObject cfasl_input_nart_alt(SubLObject stream) {
        {
            SubLObject nart = NIL;
            if (NIL != within_cfasl_externalization_p()) {
                nart = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_nart_recipe(stream);
            } else {
                nart = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_nart_handle(stream);
            }
            if (NIL == nart) {
    ...
    public static final SubLObject cfasl_output_nart_recipe_alt(SubLObject nart, SubLObject stream) {
        {
            SubLObject hl_formula = narts_high.nart_hl_formula(nart);
    ...
    public static final SubLObject cfasl_input_nart_recipe_alt(SubLObject stream) {
        {
            SubLObject hl_formula = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
            if (NIL != hl_formula) {
                return narts_high.nart_lookup(hl_formula);
            }
        }
        return NIL;
    }
    ...
    public static final SubLObject cfasl_output_nart_handle_alt(SubLObject nart, SubLObject stream) {
        cfasl_output(com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_nart_handle(nart), stream);
        return nart;
    }
    ...
    public static final SubLObject cfasl_input_nart_handle_alt(SubLObject stream) {
        {
            SubLObject handle = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
            return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_nart_handle_lookup(handle);
        }
    }
    ...
    public static final SubLObject cfasl_nart_handle_alt(SubLObject nart) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            ...
            {
                SubLObject method = api_control_vars.$cfasl_nart_handle_func$.getDynamicValue(thread);
                if (NIL == method) {
                    return nart_id(nart);
                }
                {
    ...
    public static final SubLObject cfasl_nart_handle_lookup_alt(SubLObject id) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL == subl_promotions.non_negative_integer_p(id)) {
                return $sample_invalid_nart$.getGlobalValue();
    ...
    public static final SubLObject cfasl_output_assertion_alt(SubLObject assertion, SubLObject stream) {
        cfasl_raw_write_byte($cfasl_opcode_assertion$.getGlobalValue(), stream);
        if (NIL != within_cfasl_externalization_p()) {
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_assertion_recipe(assertion, stream);
        } else {
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_assertion_handle(assertion, stream);
        }
        return assertion;
    }
    ...
    public static final SubLObject cfasl_output_object_assertion_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_assertion(v_object, stream);
    }
    ...
    public static final SubLObject cfasl_invalid_assertion_alt() {
    ...
    public static final SubLObject cfasl_input_assertion_alt(SubLObject stream) {
        {
            SubLObject assertion = NIL;
            if (NIL != within_cfasl_externalization_p()) {
                assertion = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_assertion_recipe(stream);
            } else {
                assertion = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_assertion_handle(stream);
            }
            if (NIL == assertion) {
    ...
    public static final SubLObject cfasl_output_assertion_recipe_alt(SubLObject assertion, SubLObject stream) {
        {
    ...
    public static final SubLObject cfasl_input_assertion_recipe_alt(SubLObject stream) {
        {
    ...
    public static final SubLObject cfasl_output_assertion_handle_alt(SubLObject assertion, SubLObject stream) {
        cfasl_output(com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_assertion_handle(assertion), stream);
        return assertion;
    }
    ...
    public static final SubLObject cfasl_input_assertion_handle_alt(SubLObject stream) {
        {
            SubLObject handle = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
            return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_assertion_handle_lookup(handle);
        }
    }
    ...
    public static final SubLObject cfasl_assertion_handle_alt(SubLObject assertion) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            ...
            {
                SubLObject method = api_control_vars.$cfasl_assertion_handle_func$.getDynamicValue(thread);
                if (NIL == method) {
    ...
    public static final SubLObject cfasl_assertion_handle_lookup_alt(SubLObject id) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL == subl_promotions.non_negative_integer_p(id)) {
                return $sample_invalid_assertion$.getGlobalValue();
    ...
    public static final SubLObject cfasl_output_deduction_alt(SubLObject deduction, SubLObject stream) {
        cfasl_raw_write_byte($cfasl_opcode_deduction$.getGlobalValue(), stream);
        if (NIL != within_cfasl_externalization_p()) {
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_deduction_recipe(deduction, stream);
        } else {
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_deduction_handle(deduction, stream);
        }
        return deduction;
    }
    ...
    public static final SubLObject cfasl_output_object_deduction_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_deduction(v_object, stream);
    }
    ...
    public static final SubLObject cfasl_invalid_deduction_alt() {
    ...
    public static final SubLObject cfasl_input_deduction_alt(SubLObject stream) {
        {
            SubLObject deduction = NIL;
            if (NIL != within_cfasl_externalization_p()) {
                deduction = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_deduction_recipe(stream);
            } else {
                deduction = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_deduction_handle(stream);
            }
            if (NIL == deduction) {
    ...
    public static final SubLObject cfasl_output_deduction_recipe_alt(SubLObject deduction, SubLObject stream) {
        {
    ...
    public static final SubLObject cfasl_input_deduction_recipe_alt(SubLObject stream) {
        {
            ...
            SubLObject truth = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
            if (((NIL != assertion) && (NIL != supports)) && (NIL != truth)) {
                return deductions_high.find_deduction(assertion, supports, truth);
            }
        }
        return NIL;
    }
    ...
    public static final SubLObject cfasl_output_deduction_handle_alt(SubLObject deduction, SubLObject stream) {
        cfasl_output(com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_deduction_handle(deduction), stream);
        return deduction;
    }
    ...
    public static final SubLObject cfasl_input_deduction_handle_alt(SubLObject stream) {
        {
            SubLObject handle = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
            return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_deduction_handle_lookup(handle);
        }
    }
    ...
    public static final SubLObject cfasl_deduction_handle_alt(SubLObject deduction) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            ...
            {
                SubLObject method = api_control_vars.$cfasl_deduction_handle_func$.getDynamicValue(thread);
                if (NIL == method) {
                    return deduction_id(deduction);
                }
                {
                    SubLObject pcase_var = method;
    ...
    public static final SubLObject cfasl_deduction_handle_lookup_alt(SubLObject id) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL == subl_promotions.non_negative_integer_p(id)) {
                return $sample_invalid_deduction$.getGlobalValue();
    ...
    public static final SubLObject cfasl_output_kb_hl_support_alt(SubLObject kb_hl_support, SubLObject stream) {
        cfasl_raw_write_byte($cfasl_opcode_kb_hl_support$.getGlobalValue(), stream);
        if (NIL != within_cfasl_externalization_p()) {
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_kb_hl_support_recipe(kb_hl_support, stream);
        } else {
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_kb_hl_support_handle(kb_hl_support, stream);
        }
    ...
    public static final SubLObject cfasl_output_object_kb_hl_support_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_kb_hl_support(v_object, stream);
    }
    ...
    public static final SubLObject cfasl_invalid_kb_hl_support_alt() {
    ...
    public static final SubLObject cfasl_input_kb_hl_support_alt(SubLObject stream) {
        {
            SubLObject kb_hl_support = NIL;
            if (NIL != within_cfasl_externalization_p()) {
                kb_hl_support = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_kb_hl_support_recipe(stream);
            } else {
                kb_hl_support = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_kb_hl_support_handle(stream);
            }
    ...
    public static final SubLObject cfasl_output_kb_hl_support_recipe_alt(SubLObject kb_hl_support, SubLObject stream) {
        {
    ...
    public static final SubLObject cfasl_input_kb_hl_support_recipe_alt(SubLObject stream) {
        {
            SubLObject hl_support = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
            return NIL != arguments.hl_support_p(hl_support) ? ((SubLObject) (kb_hl_supports.find_kb_hl_support(hl_support))) : NIL;
        }
    }
    ...
    public static final SubLObject cfasl_output_kb_hl_support_handle_alt(SubLObject kb_hl_support, SubLObject stream) {
        cfasl_output(com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_kb_hl_support_handle(kb_hl_support), stream);
        return kb_hl_support;
    }
    ...
    public static final SubLObject cfasl_input_kb_hl_support_handle_alt(SubLObject stream) {
        {
            SubLObject handle = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
            return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_kb_hl_support_handle_lookup(handle);
        }
    }
    ...
    public static final SubLObject cfasl_kb_hl_support_handle_alt(SubLObject kb_hl_support) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL == kb_hl_supports.valid_kb_hl_supportP(kb_hl_support, UNPROVIDED)) {
                ...
                {
                    SubLObject method = (NIL != api_control_vars.$cfasl_kb_hl_support_handle_func$.getDynamicValue(thread)) ? ((SubLObject) (api_control_vars.$cfasl_kb_hl_support_handle_func$.getDynamicValue(thread))) : KB_HL_SUPPORT_ID;
                    SubLObject pcase_var = method;
                    if (pcase_var.eql(KB_HL_SUPPORT_ID)) {
                        return kb_hl_supports.kb_hl_support_id(kb_hl_support);
                    } else {
                        if (pcase_var.eql(KB_HL_SUPPORT_DUMP_ID)) {
                            return kb_hl_supports.kb_hl_support_dump_id(kb_hl_support);
                        } else {
    ...
    public static final SubLObject cfasl_kb_hl_support_handle_lookup_alt(SubLObject id) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject method = (NIL != api_control_vars.$cfasl_kb_hl_support_handle_lookup_func$.getDynamicValue(thread)) ? ((SubLObject) (api_control_vars.$cfasl_kb_hl_support_handle_lookup_func$.getDynamicValue(thread))) : FIND_KB_HL_SUPPORT_BY_ID;
                SubLObject pcase_var = method;
    ...
    public static final SubLObject cfasl_output_clause_struc_alt(SubLObject clause_struc, SubLObject stream) {
        cfasl_raw_write_byte($cfasl_opcode_clause_struc$.getGlobalValue(), stream);
        if (NIL != within_cfasl_externalization_p()) {
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_clause_struc_recipe(clause_struc, stream);
        } else {
            com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_clause_struc_handle(clause_struc, stream);
        }
        return clause_struc;
    }
    ...
    public static final SubLObject cfasl_output_object_clause_struc_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_clause_struc(v_object, stream);
    }
    ...
    static private final SubLList $list_alt0 = list(makeSymbol("CONSTANTS"), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLObject cfasl_invalid_clause_struc_alt() {
    ...
    public static final SubLObject cfasl_input_clause_struc_alt(SubLObject stream) {
        {
            SubLObject clause_struc = NIL;
            if (NIL != within_cfasl_externalization_p()) {
                clause_struc = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_clause_struc_recipe(stream);
            } else {
                clause_struc = com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_input_clause_struc_handle(stream);
            }
            if (NIL == clause_struc) {
    ...
    public static final SubLObject cfasl_output_clause_struc_recipe_alt(SubLObject clause_struc, SubLObject stream) {
        {
    ...
    public static final SubLObject cfasl_input_clause_struc_recipe_alt(SubLObject stream) {
        {
            SubLObject cnf = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
            if (NIL != cnf) {
                return kb_indexing.find_clause_struc(cnf);
            }
        }
        return NIL;
    }
    ...
    public static final SubLObject cfasl_output_clause_struc_handle_alt(SubLObject clause_struc, SubLObject stream) {
        cfasl_output(com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_clause_struc_handle(clause_struc), stream);
        return clause_struc;
    }
    ...
    public static final SubLObject cfasl_input_clause_struc_handle_alt(SubLObject stream) {
        {
            SubLObject handle = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
            return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_clause_struc_handle_lookup(handle);
        }
    }
    ...
    public static final SubLObject cfasl_clause_struc_handle_alt(SubLObject clause_struc) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL != invalid_clause_struc(clause_struc, UNPROVIDED)) {
                return MINUS_ONE_INTEGER;
            }
            {
                SubLObject method = api_control_vars.$cfasl_clause_struc_handle_func$.getDynamicValue(thread);
                if (NIL == method) {
                    return clause_struc_id(clause_struc);
                }
                {
                    SubLObject pcase_var = method;
                    if (pcase_var.eql(CLAUSE_STRUC_ID)) {
                        ...
                        if (pcase_var.eql(CLAUSE_STRUC_DUMP_ID)) {
                            return clause_struc_dump_id(clause_struc);
                        }
                    }
                }
    ...
    public static final SubLObject cfasl_clause_struc_handle_lookup_alt(SubLObject id) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            if (NIL == subl_promotions.non_negative_integer_p(id)) {
                return $sample_invalid_clause_struc$.getGlobalValue();
            }
            {
                ...
                if (NIL == method) {
                    return find_clause_struc_by_id(id);
                }
                {
                    SubLObject pcase_var = method;
                    if (pcase_var.eql(FIND_CLAUSE_STRUC_BY_ID)) {
                        ...
                        if (pcase_var.eql(FIND_CLAUSE_STRUC_BY_DUMP_ID)) {
                            return find_clause_struc_by_dump_id(id);
                        }
                    }
                }
                return funcall(method, id);
    ...
    public static final SubLObject cfasl_output_variable_alt(SubLObject variable, SubLObject stream) {
        if (NIL != com.cyc.cycjava.cycl.cfasl_kb_methods.within_complete_cfasl_objects_p()) {
    ...
    public static final SubLObject cfasl_output_object_variable_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_variable(v_object, stream);
    }
    ...
    public static final SubLObject cfasl_input_variable_alt(SubLObject stream) {
    ...
    public static final SubLObject cfasl_input_complete_variable_alt(SubLObject stream) {
        {
            SubLObject variable = variables.find_variable_by_id(cfasl_input(stream, UNPROVIDED, UNPROVIDED));
    ...
    public static final SubLObject cfasl_output_object_sbhl_directed_link_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_sbhl_directed_link(v_object, stream);
    }
    ...
    public static final SubLObject cfasl_output_sbhl_directed_link_alt(SubLObject d_link, SubLObject stream) {
    ...
    public static final SubLObject cfasl_input_sbhl_directed_link_alt(SubLObject stream) {
        {
    ...
    public static final SubLObject cfasl_output_object_sbhl_undirected_link_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_sbhl_undirected_link(v_object, stream);
    }
    ...
    static private final SubLList $list_alt78 = list(list(list(makeGuid("bd5880f4-9c29-11b1-9dad-c379636f7270")), vector(new SubLObject[]{ makeInteger(25), FIFTEEN_INTEGER, makeInteger(164), makeInteger(98), makeInteger(100), makeInteger(53), makeInteger(56), makeInteger(56), makeInteger(48), makeInteger(102), makeInteger(52), makeInteger(45), makeInteger(57), makeInteger(99), makeInteger(50), makeInteger(57), makeInteger(45), makeInteger(49), makeInteger(49), makeInteger(98), makeInteger(49), makeInteger(45), makeInteger(57), makeInteger(100), makeInteger(97), makeInteger(100), makeInteger(45), makeInteger(99), makeInteger(51), makeInteger(55), makeInteger(57), makeInteger(54), makeInteger(51), makeInteger(54), makeInteger(102), makeInteger(55), makeInteger(50), makeInteger(55), makeInteger(48) })), list(list(makeGuid("1bb5d971-e945-11dc-8241-00e08156aaa2")), vector(new SubLObject[]{ makeInteger(25), FIFTEEN_INTEGER, makeInteger(164), makeInteger(49), makeInteger(98), makeInteger(98), makeInteger(53), makeInteger(100), makeInteger(57), makeInteger(55), makeInteger(49), makeInteger(45), makeInteger(101), makeInteger(57), makeInteger(52), makeInteger(53), makeInteger(45), makeInteger(49), makeInteger(49), makeInteger(100), makeInteger(99), makeInteger(45), makeInteger(56), makeInteger(50), makeInteger(52), makeInteger(49), makeInteger(45), makeInteger(48), makeInteger(48), makeInteger(101), makeInteger(48), makeInteger(56), makeInteger(49), makeInteger(53), makeInteger(54), makeInteger(97), makeInteger(97), makeInteger(97), makeInteger(50) })), list(list(makeGuid("8654b22c-e947-11dc-86ef-00e08156aaa2")), vector(new SubLObject[]{ makeInteger(25), FIFTEEN_INTEGER, makeInteger(164), makeInteger(56), makeInteger(54), makeInteger(53), makeInteger(52), makeInteger(98), makeInteger(50), makeInteger(50), makeInteger(99), makeInteger(45), makeInteger(101), makeInteger(57), makeInteger(52), makeInteger(55), makeInteger(45), makeInteger(49), makeInteger(49), makeInteger(100), makeInteger(99), makeInteger(45), makeInteger(56), makeInteger(54), makeInteger(101), makeInteger(102), makeInteger(45), makeInteger(48), makeInteger(48), makeInteger(101), makeInteger(48), makeInteger(56), makeInteger(49), makeInteger(53), makeInteger(54), makeInteger(97), makeInteger(97), makeInteger(97), makeInteger(50) })), list(list(makeGuid("69ece82b-4224-40d6-8f55-268be97ba4e7")), vector(new SubLObject[]{ makeInteger(25), FIFTEEN_INTEGER, makeInteger(164), makeInteger(54), makeInteger(57), makeInteger(101), makeInteger(99), makeInteger(101), makeInteger(56), makeInteger(50), makeInteger(98), makeInteger(45), makeInteger(52), makeInteger(50), makeInteger(50), makeInteger(52), makeInteger(45), makeInteger(52), makeInteger(48), makeInteger(100), makeInteger(54), makeInteger(45), makeInteger(56), makeInteger(102), makeInteger(53), makeInteger(53), makeInteger(45), makeInteger(50), makeInteger(54), makeInteger(56), makeInteger(98), makeInteger(101), makeInteger(57), makeInteger(55), makeInteger(98), makeInteger(97), makeInteger(52), makeInteger(101), makeInteger(55) })));

    public static final SubLObject cfasl_output_sbhl_undirected_link_alt(SubLObject d_link, SubLObject stream) {
    ...
    public static final SubLObject cfasl_input_sbhl_undirected_link_alt(SubLObject stream) {
        {
            SubLObject d_link = NIL;
    ...
    public static final SubLObject cfasl_input_hl_start_alt(SubLObject stream) {
        {
            SubLObject interval = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
    ...
    public static final SubLObject cfasl_input_hl_end_alt(SubLObject stream) {
        {
            SubLObject interval = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
    ...
    public static final SubLObject cfasl_output_object_hl_start_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_hl_start(v_object, stream);
    }
    ...
    public static final SubLObject cfasl_output_object_hl_end_method_alt(SubLObject v_object, SubLObject stream) {
        return com.cyc.cycjava.cycl.cfasl_kb_methods.cfasl_output_hl_end(v_object, stream);
    }
    ...
    public static final SubLObject cfasl_output_hl_start_alt(SubLObject hl_start, SubLObject stream) {
    ...
    public static final SubLObject cfasl_output_hl_end_alt(SubLObject hl_end, SubLObject stream) {
    ...
    public static SubLObject declare_cfasl_kb_methods_file() {
        declareFunction("valid_cfasl_reloc_side_stream_p", "VALID-CFASL-RELOC-SIDE-STREAM-P", 0, 0, false);
        declareFunction("cfasl_output_reloc_address", "CFASL-OUTPUT-RELOC-ADDRESS", 1, 0, false);
        declareFunction("possibly_output_cfasl_reloc_position", "POSSIBLY-OUTPUT-CFASL-RELOC-POSITION", 1, 0, false);
        declareFunction("possibly_output_adjusted_cfasl_reloc_position", "POSSIBLY-OUTPUT-ADJUSTED-CFASL-RELOC-POSITION", 1, 1, false);
        declareFunction("cfasl_output_reloc_version_1p0a", "CFASL-OUTPUT-RELOC-VERSION-1P0A", 0, 0, false);
        declareFunction("cfasl_output_reloc_footer", "CFASL-OUTPUT-RELOC-FOOTER", 0, 0, false);
        declareMacro("with_cfasl_reloc_side_stream", "WITH-CFASL-RELOC-SIDE-STREAM");
        declareMacro("with_cfasl_reloc_side_file", "WITH-CFASL-RELOC-SIDE-FILE");
        declareFunction("show_cfasl_relocation_information", "SHOW-CFASL-RELOCATION-INFORMATION", 1, 1, false);
        declareMacro("with_cfasl_invalid_object_reporting", "WITH-CFASL-INVALID-OBJECT-REPORTING");
        declareFunction("report_cfasl_invalid_objectsP", "REPORT-CFASL-INVALID-OBJECTS?", 0, 0, false);
        declareFunction("within_complete_cfasl_objects_p", "WITHIN-COMPLETE-CFASL-OBJECTS-P", 0, 0, false);
        declareMacro("with_cfasl_externalized_constant_exceptions", "WITH-CFASL-EXTERNALIZED-CONSTANT-EXCEPTIONS");
        declareFunction("cfasl_externalized_constant_exception_p", "CFASL-EXTERNALIZED-CONSTANT-EXCEPTION-P", 1, 0, false);
        declareFunction("cfasl_output_constant", "CFASL-OUTPUT-CONSTANT", 2, 0, false);
        declareFunction("cfasl_output_object_constant_method", "CFASL-OUTPUT-OBJECT-CONSTANT-METHOD", 2, 0, false);
        declareFunction("cfasl_invalid_constant", "CFASL-INVALID-CONSTANT", 0, 0, false);
        declareFunction("cfasl_input_constant", "CFASL-INPUT-CONSTANT", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_constant$UnaryFunction();
        declareFunction("cfasl_input_complete_constant", "CFASL-INPUT-COMPLETE-CONSTANT", 1, 0, false);
        declareFunction("cfasl_output_constant_recipe", "CFASL-OUTPUT-CONSTANT-RECIPE", 2, 0, false);
        declareFunction("cfasl_input_constant_recipe", "CFASL-INPUT-CONSTANT-RECIPE", 1, 0, false);
        declareFunction("cfasl_output_constant_handle", "CFASL-OUTPUT-CONSTANT-HANDLE", 2, 0, false);
        declareFunction("cfasl_input_constant_handle", "CFASL-INPUT-CONSTANT-HANDLE", 1, 0, false);
        declareFunction("cfasl_constant_handle", "CFASL-CONSTANT-HANDLE", 1, 0, false);
        declareFunction("cfasl_constant_handle_lookup", "CFASL-CONSTANT-HANDLE-LOOKUP", 1, 0, false);
        declareFunction("cfasl_output_nart", "CFASL-OUTPUT-NART", 2, 0, false);
        declareFunction("cfasl_output_object_nart_method", "CFASL-OUTPUT-OBJECT-NART-METHOD", 2, 0, false);
        declareFunction("cfasl_invalid_nart", "CFASL-INVALID-NART", 0, 0, false);
        declareFunction("cfasl_input_nart", "CFASL-INPUT-NART", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_nart$UnaryFunction();
        declareFunction("cfasl_output_nart_recipe", "CFASL-OUTPUT-NART-RECIPE", 2, 0, false);
        declareFunction("cfasl_input_nart_recipe", "CFASL-INPUT-NART-RECIPE", 1, 0, false);
        declareFunction("cfasl_output_nart_handle", "CFASL-OUTPUT-NART-HANDLE", 2, 0, false);
        declareFunction("cfasl_input_nart_handle", "CFASL-INPUT-NART-HANDLE", 1, 0, false);
        declareFunction("cfasl_nart_handle", "CFASL-NART-HANDLE", 1, 0, false);
        declareFunction("cfasl_nart_handle_lookup", "CFASL-NART-HANDLE-LOOKUP", 1, 0, false);
        declareFunction("cfasl_output_assertion", "CFASL-OUTPUT-ASSERTION", 2, 0, false);
        declareFunction("cfasl_output_object_assertion_method", "CFASL-OUTPUT-OBJECT-ASSERTION-METHOD", 2, 0, false);
        declareFunction("cfasl_invalid_assertion", "CFASL-INVALID-ASSERTION", 0, 0, false);
        declareFunction("cfasl_input_assertion", "CFASL-INPUT-ASSERTION", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_assertion$UnaryFunction();
        declareFunction("cfasl_output_assertion_recipe", "CFASL-OUTPUT-ASSERTION-RECIPE", 2, 0, false);
        declareFunction("cfasl_input_assertion_recipe", "CFASL-INPUT-ASSERTION-RECIPE", 1, 0, false);
        declareFunction("cfasl_output_assertion_handle", "CFASL-OUTPUT-ASSERTION-HANDLE", 2, 0, false);
        declareFunction("cfasl_input_assertion_handle", "CFASL-INPUT-ASSERTION-HANDLE", 1, 0, false);
        declareFunction("cfasl_assertion_handle", "CFASL-ASSERTION-HANDLE", 1, 0, false);
        declareFunction("cfasl_assertion_handle_lookup", "CFASL-ASSERTION-HANDLE-LOOKUP", 1, 0, false);
        declareFunction("cfasl_output_deduction", "CFASL-OUTPUT-DEDUCTION", 2, 0, false);
        declareFunction("cfasl_output_object_deduction_method", "CFASL-OUTPUT-OBJECT-DEDUCTION-METHOD", 2, 0, false);
        declareFunction("cfasl_invalid_deduction", "CFASL-INVALID-DEDUCTION", 0, 0, false);
        declareFunction("cfasl_input_deduction", "CFASL-INPUT-DEDUCTION", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_deduction$UnaryFunction();
        declareFunction("cfasl_output_deduction_recipe", "CFASL-OUTPUT-DEDUCTION-RECIPE", 2, 0, false);
        declareFunction("cfasl_input_deduction_recipe", "CFASL-INPUT-DEDUCTION-RECIPE", 1, 0, false);
        declareFunction("cfasl_output_deduction_handle", "CFASL-OUTPUT-DEDUCTION-HANDLE", 2, 0, false);
        declareFunction("cfasl_input_deduction_handle", "CFASL-INPUT-DEDUCTION-HANDLE", 1, 0, false);
        declareFunction("cfasl_deduction_handle", "CFASL-DEDUCTION-HANDLE", 1, 0, false);
        declareFunction("cfasl_deduction_handle_lookup", "CFASL-DEDUCTION-HANDLE-LOOKUP", 1, 0, false);
        declareFunction("cfasl_output_kb_hl_support", "CFASL-OUTPUT-KB-HL-SUPPORT", 2, 0, false);
        declareFunction("cfasl_output_object_kb_hl_support_method", "CFASL-OUTPUT-OBJECT-KB-HL-SUPPORT-METHOD", 2, 0, false);
        declareFunction("cfasl_invalid_kb_hl_support", "CFASL-INVALID-KB-HL-SUPPORT", 0, 0, false);
        declareFunction("cfasl_input_kb_hl_support", "CFASL-INPUT-KB-HL-SUPPORT", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_kb_hl_support$UnaryFunction();
        declareFunction("cfasl_output_kb_hl_support_recipe", "CFASL-OUTPUT-KB-HL-SUPPORT-RECIPE", 2, 0, false);
        declareFunction("cfasl_input_kb_hl_support_recipe", "CFASL-INPUT-KB-HL-SUPPORT-RECIPE", 1, 0, false);
        declareFunction("cfasl_output_kb_hl_support_handle", "CFASL-OUTPUT-KB-HL-SUPPORT-HANDLE", 2, 0, false);
        declareFunction("cfasl_input_kb_hl_support_handle", "CFASL-INPUT-KB-HL-SUPPORT-HANDLE", 1, 0, false);
        declareFunction("cfasl_kb_hl_support_handle", "CFASL-KB-HL-SUPPORT-HANDLE", 1, 0, false);
        declareFunction("cfasl_kb_hl_support_handle_lookup", "CFASL-KB-HL-SUPPORT-HANDLE-LOOKUP", 1, 0, false);
        declareFunction("cfasl_output_clause_struc", "CFASL-OUTPUT-CLAUSE-STRUC", 2, 0, false);
        declareFunction("cfasl_output_object_clause_struc_method", "CFASL-OUTPUT-OBJECT-CLAUSE-STRUC-METHOD", 2, 0, false);
        declareFunction("cfasl_invalid_clause_struc", "CFASL-INVALID-CLAUSE-STRUC", 0, 0, false);
        declareFunction("cfasl_input_clause_struc", "CFASL-INPUT-CLAUSE-STRUC", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_clause_struc$UnaryFunction();
        declareFunction("cfasl_output_clause_struc_recipe", "CFASL-OUTPUT-CLAUSE-STRUC-RECIPE", 2, 0, false);
        declareFunction("cfasl_input_clause_struc_recipe", "CFASL-INPUT-CLAUSE-STRUC-RECIPE", 1, 0, false);
        declareFunction("cfasl_output_clause_struc_handle", "CFASL-OUTPUT-CLAUSE-STRUC-HANDLE", 2, 0, false);
        declareFunction("cfasl_input_clause_struc_handle", "CFASL-INPUT-CLAUSE-STRUC-HANDLE", 1, 0, false);
        declareFunction("cfasl_clause_struc_handle", "CFASL-CLAUSE-STRUC-HANDLE", 1, 0, false);
        declareFunction("cfasl_clause_struc_handle_lookup", "CFASL-CLAUSE-STRUC-HANDLE-LOOKUP", 1, 0, false);
        declareFunction("cfasl_output_variable", "CFASL-OUTPUT-VARIABLE", 2, 0, false);
        declareFunction("cfasl_output_object_variable_method", "CFASL-OUTPUT-OBJECT-VARIABLE-METHOD", 2, 0, false);
        declareFunction("cfasl_input_variable", "CFASL-INPUT-VARIABLE", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_variable$UnaryFunction();
        declareFunction("cfasl_input_complete_variable", "CFASL-INPUT-COMPLETE-VARIABLE", 1, 0, false);
        declareFunction("cfasl_output_object_sbhl_directed_link_method", "CFASL-OUTPUT-OBJECT-SBHL-DIRECTED-LINK-METHOD", 2, 0, false);
        declareFunction("cfasl_output_sbhl_directed_link", "CFASL-OUTPUT-SBHL-DIRECTED-LINK", 2, 0, false);
        declareFunction("cfasl_input_sbhl_directed_link", "CFASL-INPUT-SBHL-DIRECTED-LINK", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_sbhl_directed_link$UnaryFunction();
        declareFunction("cfasl_output_object_sbhl_undirected_link_method", "CFASL-OUTPUT-OBJECT-SBHL-UNDIRECTED-LINK-METHOD", 2, 0, false);
        declareFunction("cfasl_output_sbhl_undirected_link", "CFASL-OUTPUT-SBHL-UNDIRECTED-LINK", 2, 0, false);
        declareFunction("cfasl_input_sbhl_undirected_link", "CFASL-INPUT-SBHL-UNDIRECTED-LINK", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_sbhl_undirected_link$UnaryFunction();
        declareFunction("cfasl_input_hl_start", "CFASL-INPUT-HL-START", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_hl_start$UnaryFunction();
        declareFunction("cfasl_input_hl_end", "CFASL-INPUT-HL-END", 1, 0, false);
        new cfasl_kb_methods.$cfasl_input_hl_end$UnaryFunction();
        declareFunction("cfasl_output_object_hl_start_method", "CFASL-OUTPUT-OBJECT-HL-START-METHOD", 2, 0, false);
        declareFunction("cfasl_output_object_hl_end_method", "CFASL-OUTPUT-OBJECT-HL-END-METHOD", 2, 0, false);
        declareFunction("cfasl_output_hl_start", "CFASL-OUTPUT-HL-START", 2, 0, false);
        declareFunction("cfasl_output_hl_end", "CFASL-OUTPUT-HL-END", 2, 0, false);
        return NIL;
    }

    static private final SubLList $list_alt80 = list(list(list(vector(new SubLObject[]{ makeInteger(25), FIFTEEN_INTEGER, makeInteger(164), makeInteger(98), makeInteger(100), makeInteger(53), makeInteger(56), makeInteger(56), makeInteger(48), makeInteger(102), makeInteger(52), makeInteger(45), makeInteger(57), makeInteger(99), makeInteger(50), makeInteger(57), makeInteger(45), makeInteger(49), makeInteger(49), makeInteger(98), makeInteger(49), makeInteger(45), makeInteger(57), makeInteger(100), makeInteger(97), makeInteger(100), makeInteger(45), makeInteger(99), makeInteger(51), makeInteger(55), makeInteger(57), makeInteger(54), makeInteger(51), makeInteger(54), makeInteger(102), makeInteger(55), makeInteger(50), makeInteger(55), makeInteger(48) })), makeGuid("bd5880f4-9c29-11b1-9dad-c379636f7270")), list(list(vector(new SubLObject[]{ makeInteger(25), FIFTEEN_INTEGER, makeInteger(164), makeInteger(49), makeInteger(98), makeInteger(98), makeInteger(53), makeInteger(100), makeInteger(57), makeInteger(55), makeInteger(49), makeInteger(45), makeInteger(101), makeInteger(57), makeInteger(52), makeInteger(53), makeInteger(45), makeInteger(49), makeInteger(49), makeInteger(100), makeInteger(99), makeInteger(45), makeInteger(56), makeInteger(50), makeInteger(52), makeInteger(49), makeInteger(45), makeInteger(48), makeInteger(48), makeInteger(101), makeInteger(48), makeInteger(56), makeInteger(49), makeInteger(53), makeInteger(54), makeInteger(97), makeInteger(97), makeInteger(97), makeInteger(50) })), makeGuid("1bb5d971-e945-11dc-8241-00e08156aaa2")), list(list(vector(new SubLObject[]{ makeInteger(25), FIFTEEN_INTEGER, makeInteger(164), makeInteger(56), makeInteger(54), makeInteger(53), makeInteger(52), makeInteger(98), makeInteger(50), makeInteger(50), makeInteger(99), makeInteger(45), makeInteger(101), makeInteger(57), makeInteger(52), makeInteger(55), makeInteger(45), makeInteger(49), makeInteger(49), makeInteger(100), makeInteger(99), makeInteger(45), makeInteger(56), makeInteger(54), makeInteger(101), makeInteger(102), makeInteger(45), makeInteger(48), makeInteger(48), makeInteger(101), makeInteger(48), makeInteger(56), makeInteger(49), makeInteger(53), makeInteger(54), makeInteger(97), makeInteger(97), makeInteger(97), makeInteger(50) })), makeGuid("8654b22c-e947-11dc-86ef-00e08156aaa2")), list(list(vector(new SubLObject[]{ makeInteger(25), FIFTEEN_INTEGER, makeInteger(164), makeInteger(54), makeInteger(57), makeInteger(101), makeInteger(99), makeInteger(101), makeInteger(56), makeInteger(50), makeInteger(98), makeInteger(45), makeInteger(52), makeInteger(50), makeInteger(50), makeInteger(52), makeInteger(45), makeInteger(52), makeInteger(48), makeInteger(100), makeInteger(54), makeInteger(45), makeInteger(56), makeInteger(102), makeInteger(53), makeInteger(53), makeInteger(45), makeInteger(50), makeInteger(54), makeInteger(56), makeInteger(98), makeInteger(101), makeInteger(57), makeInteger(55), makeInteger(98), makeInteger(97), makeInteger(52), makeInteger(101), makeInteger(55) })), makeGuid("69ece82b-4224-40d6-8f55-268be97ba4e7")), list(list(vector(new SubLObject[]{ makeInteger(43), makeInteger(189), makeInteger(88), makeInteger(128), makeInteger(244), makeInteger(156), makeInteger(41), SEVENTEEN_INTEGER, makeInteger(177), makeInteger(157), makeInteger(173), makeInteger(195), makeInteger(121), makeInteger(99), makeInteger(111), makeInteger(114), makeInteger(112) })), makeGuid("bd5880f4-9c29-11b1-9dad-c379636f7270")), list(list(vector(new SubLObject[]{ makeInteger(43), makeInteger(27), makeInteger(181), makeInteger(217), makeInteger(113), makeInteger(233), makeInteger(69), SEVENTEEN_INTEGER, makeInteger(220), makeInteger(130), makeInteger(65), ZERO_INTEGER, makeInteger(224), makeInteger(129), makeInteger(86), makeInteger(170), makeInteger(162) })), makeGuid("1bb5d971-e945-11dc-8241-00e08156aaa2")), list(list(vector(new SubLObject[]{ makeInteger(43), makeInteger(134), makeInteger(84), makeInteger(178), makeInteger(44), makeInteger(233), makeInteger(71), SEVENTEEN_INTEGER, makeInteger(220), makeInteger(134), makeInteger(239), ZERO_INTEGER, makeInteger(224), makeInteger(129), makeInteger(86), makeInteger(170), makeInteger(162) })), makeGuid("8654b22c-e947-11dc-86ef-00e08156aaa2")), list(list(vector(new SubLObject[]{ makeInteger(43), makeInteger(105), makeInteger(236), makeInteger(232), makeInteger(43), makeInteger(66), makeInteger(36), makeInteger(64), makeInteger(214), makeInteger(143), makeInteger(85), makeInteger(38), makeInteger(139), makeInteger(233), makeInteger(123), makeInteger(164), makeInteger(231) })), makeGuid("69ece82b-4224-40d6-8f55-268be97ba4e7")));

    public static final SubLObject init_cfasl_kb_methods_file_alt() {
        ...
        deflexical("*SAMPLE-INVALID-CONSTANT*", NIL != boundp($sample_invalid_constant$) ? ((SubLObject) ($sample_invalid_constant$.getGlobalValue())) : create_sample_invalid_constant());
        defconstant("*CFASL-OPCODE-NART*", $int$31);
        deflexical("*SAMPLE-INVALID-NART*", NIL != boundp($sample_invalid_nart$) ? ((SubLObject) ($sample_invalid_nart$.getGlobalValue())) : create_sample_invalid_nart());
        defconstant("*CFASL-OPCODE-ASSERTION*", $int$33);
        deflexical("*SAMPLE-INVALID-ASSERTION*", NIL != boundp($sample_invalid_assertion$) ? ((SubLObject) ($sample_invalid_assertion$.getGlobalValue())) : create_sample_invalid_assertion());
        defconstant("*CFASL-OPCODE-DEDUCTION*", $int$36);
        deflexical("*SAMPLE-INVALID-DEDUCTION*", NIL != boundp($sample_invalid_deduction$) ? ((SubLObject) ($sample_invalid_deduction$.getGlobalValue())) : create_sample_invalid_deduction());
        defconstant("*CFASL-OPCODE-KB-HL-SUPPORT*", $int$37);
        deflexical("*SAMPLE-INVALID-KB-HL-SUPPORT*", NIL != boundp($sample_invalid_kb_hl_support$) ? ((SubLObject) ($sample_invalid_kb_hl_support$.getGlobalValue())) : kb_hl_supports.create_sample_invalid_kb_hl_support());
        defconstant("*CFASL-OPCODE-CLAUSE-STRUC*", $int$38);
        deflexical("*SAMPLE-INVALID-CLAUSE-STRUC*", NIL != boundp($sample_invalid_clause_struc$) ? ((SubLObject) ($sample_invalid_clause_struc$.getGlobalValue())) : create_sample_invalid_clause_struc());
    ...
    public static SubLObject init_cfasl_kb_methods_file_Previous() {
        defparameter("*CFASL-RELOC-SIDE-STREAM*", NIL);
        defparameter("*CFASL-RELOC-LAST-ADDRESS*", ZERO_INTEGER);
        deflexical("*CFASL-RELOC-EOF-MARKER*", MINUS_ONE_INTEGER);
        deflexical("*CFASL-RELOC-VERSION-1P0A*", $int$_101);
    ...
    public static final SubLObject setup_cfasl_kb_methods_file_alt() {
        ...
        register_method($cfasl_output_object_method_table$.getGlobalValue(), $dtp_nart$.getGlobalValue(), symbol_function(CFASL_OUTPUT_OBJECT_NART_METHOD));
        ...
        register_method($cfasl_output_object_method_table$.getGlobalValue(), $dtp_assertion$.getGlobalValue(), symbol_function(CFASL_OUTPUT_OBJECT_ASSERTION_METHOD));
        ...
        register_method($cfasl_output_object_method_table$.getGlobalValue(), $dtp_deduction$.getGlobalValue(), symbol_function(CFASL_OUTPUT_OBJECT_DEDUCTION_METHOD));
        ...
        register_method($cfasl_output_object_method_table$.getGlobalValue(), kb_hl_supports.$dtp_kb_hl_support$.getGlobalValue(), symbol_function(CFASL_OUTPUT_OBJECT_KB_HL_SUPPORT_METHOD));
        ...
        register_method($cfasl_output_object_method_table$.getGlobalValue(), $dtp_clause_struc$.getGlobalValue(), symbol_function(CFASL_OUTPUT_OBJECT_CLAUSE_STRUC_METHOD));
        ...
        define_test_case_table_int(CFASL_ENCODE, list(new SubLObject[]{ $TEST, symbol_function(EQUALP), $OWNER, $$$goolsbey, $CLASSES, NIL, $KB, $TINY, $WORKING_, T }), $list_alt78);
        define_test_case_table_int(CFASL_DECODE, list(new SubLObject[]{ $TEST, symbol_function(EQUALP), $OWNER, $$$goolsbey, $CLASSES, NIL, $KB, $TINY, $WORKING_, T }), $list_alt80);
        return NIL;
    }
    ...
    public static SubLObject setup_cfasl_kb_methods_file_Previous() {
        register_external_symbol(SHOW_CFASL_RELOCATION_INFORMATION);
        register_cfasl_input_function($cfasl_opcode_constant$.getGlobalValue(), CFASL_INPUT_CONSTANT);
        register_cfasl_input_function($cfasl_opcode_complete_constant$.getGlobalValue(), CFASL_INPUT_COMPLETE_CONSTANT);
        register_method($cfasl_output_object_method_table$.getGlobalValue(), $dtp_constant$.getGlobalValue(), symbol_function(CFASL_OUTPUT_OBJECT_CONSTANT_METHOD));
