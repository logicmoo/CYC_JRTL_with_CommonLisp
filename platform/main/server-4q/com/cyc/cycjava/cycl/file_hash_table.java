...
public final class file_hash_table extends SubLTranslatedFile {
	...
	private static final SubLList $list65 = list(new SubLObject[] { makeSymbol("HTFILE-HEADER-SIZE"), makeSymbol("HTFILE-HEADER-VERSION-MAJOR"), makeSymbol("HTFILE-HEADER-VERSION-MINOR"), makeSymbol("HTFILE-HEADER-OBJECT-SPACE-OFFSET"), makeSymbol("HTFILE-HEADER-KEY-SPACE-OFFSET"), makeSymbol("HTFILE-HEADER-CURRENT-HEAP-TOP"), makeSymbol("HTFILE-HEADER-ITEM-COUNT"), makeSymbol("HTFILE-HEADER-CAPACITY"),
			makeSymbol("HTFILE-HEADER-FREE-LIST-HEAD"), makeSymbol("HTFILE-HEADER-DELETION-COUNT"), makeSymbol("HTFILE-HEADER-HEADER-CRC"), makeSymbol("HTFILE-HEADER-EXTENSION-SPACE-SIZE"), makeSymbol("HTFILE-HEADER-EXTENSION-SPACE") });
	...
	private static final SubLList $list66 = list(new SubLObject[] { makeSymbol("_CSETF-HTFILE-HEADER-SIZE"), makeSymbol("_CSETF-HTFILE-HEADER-VERSION-MAJOR"), makeSymbol("_CSETF-HTFILE-HEADER-VERSION-MINOR"), makeSymbol("_CSETF-HTFILE-HEADER-OBJECT-SPACE-OFFSET"), makeSymbol("_CSETF-HTFILE-HEADER-KEY-SPACE-OFFSET"), makeSymbol("_CSETF-HTFILE-HEADER-CURRENT-HEAP-TOP"), makeSymbol("_CSETF-HTFILE-HEADER-ITEM-COUNT"),
			makeSymbol("_CSETF-HTFILE-HEADER-CAPACITY"), makeSymbol("_CSETF-HTFILE-HEADER-FREE-LIST-HEAD"), makeSymbol("_CSETF-HTFILE-HEADER-DELETION-COUNT"), makeSymbol("_CSETF-HTFILE-HEADER-HEADER-CRC"), makeSymbol("_CSETF-HTFILE-HEADER-EXTENSION-SPACE-SIZE"), makeSymbol("_CSETF-HTFILE-HEADER-EXTENSION-SPACE") });
	...
	private static final SubLList $list493 = list(new SubLObject[] { list(list(makeKeyword("SENTINEL"), makeKeyword("SENTINEL")), makeKeyword("EQ")), list(list(makeKeyword("EOF"), makeKeyword("EOF")), makeKeyword("EQ")), list(list(makeKeyword("SENTINEL"), makeKeyword("EOF")), makeKeyword("LT")), list(list(makeKeyword("EOF"), makeKeyword("SENTINEL")), makeKeyword("GT")),
			list(list(list(makeInteger(104), makeInteger(168), makeInteger(12850), makeString("137")), makeKeyword("SENTINEL")), makeKeyword("LT")), list(list(makeKeyword("SENTINEL"), list(makeInteger(104), makeInteger(168), makeInteger(12850), makeString("137"))), makeKeyword("GT")), list(list(list(makeInteger(104), makeInteger(168), makeInteger(12850), makeString("137")), makeKeyword("EOF")), makeKeyword("LT")),
			list(list(makeKeyword("EOF"), list(makeInteger(104), makeInteger(168), makeInteger(12850), makeString("137"))), makeKeyword("GT")), list(list(list(makeInteger(128), makeInteger(128), makeInteger(13062), makeString("97")), list(makeInteger(104), makeInteger(168), makeInteger(12850), makeString("137"))), makeKeyword("GT")),
			list(list(list(makeInteger(104), makeInteger(168), makeInteger(12850), makeString("137")), list(makeInteger(128), makeInteger(128), makeInteger(13062), makeString("97"))), makeKeyword("LT")), list(list(list(makeInteger(104), makeInteger(168), makeInteger(12850), makeString("137")), list(makeInteger(104), makeInteger(168), makeInteger(12850), makeString("137"))), makeKeyword("EQ")) });
	...
	private static final SubLList $list510 = list(
	...
	private static final SubLList $list517 = list(
			new SubLObject[] { list(list(makeInteger(31), THREE_INTEGER, makeKeyword("MODERATE")), makeKeyword("SUCCESS")), list(list(makeInteger(23), THREE_INTEGER, makeKeyword("MODERATE")), makeKeyword("SUCCESS")), list(list(FIFTEEN_INTEGER, THREE_INTEGER, makeKeyword("MODERATE")), makeKeyword("SUCCESS")), list(list(SEVEN_INTEGER, THREE_INTEGER, makeKeyword("MODERATE")), makeKeyword("SUCCESS")),
					list(list(makeInteger(31), THREE_INTEGER, makeKeyword("AGGRESSIVE")), makeKeyword("SUCCESS")), list(list(makeInteger(23), THREE_INTEGER, makeKeyword("AGGRESSIVE")), makeKeyword("SUCCESS")), list(list(FIFTEEN_INTEGER, THREE_INTEGER, makeKeyword("AGGRESSIVE")), makeKeyword("SUCCESS")), list(list(SEVEN_INTEGER, THREE_INTEGER, makeKeyword("AGGRESSIVE")), makeKeyword("SUCCESS")),
					list(list(makeInteger(31), THREE_INTEGER, makeKeyword("CONSERVATIVE")), makeKeyword("SUCCESS")), list(list(makeInteger(23), THREE_INTEGER, makeKeyword("CONSERVATIVE")), makeKeyword("SUCCESS")), list(list(FIFTEEN_INTEGER, THREE_INTEGER, makeKeyword("CONSERVATIVE")), makeKeyword("SUCCESS")), list(list(SEVEN_INTEGER, THREE_INTEGER, makeKeyword("CONSERVATIVE")), makeKeyword("SUCCESS")) });
	...
	private static final SubLList $list531 = list(list(list(makeInteger(100), makeSymbol("RANDOM-CONSTANT"), makeSymbol("CONSTANT-SUID"), makeSymbol("CONSTANT-NAME"), EQL, makeSymbol("STRING-EQUAL")), makeKeyword("SUCCESS")), list(list(makeInteger(100), makeSymbol("RANDOM-ASSERTION"), makeSymbol("ASSERTION-ID"), makeSymbol("COMPACT-HL-EXTERNAL-ID-STRING"), EQL, makeSymbol("STRING-EQUAL")), makeKeyword("SUCCESS")),
			list(list(makeInteger(100), makeSymbol("TEST-FFHTKB-GENERATE-CONSTANT-INFO"), makeSymbol("TEST-FFHTKB-GRAB-CONSTANT-KEY-INFO"), makeSymbol("TEST-FFHTKB-GRAB-CONSTANT-VALUE-INFO"), EQUALP, EQUALP, makeKeyword("IMAGE-INDEPENDENT-CFASL")), makeKeyword("SUCCESS")));
	...
	public static SubLObject file_hash_table_stream(final SubLObject v_object) {
		assert NIL != file_hash_table_p(v_object) : "file_hash_table.file_hash_table_p error :" + v_object;
	...
	public static SubLObject htfile_header_size(final SubLObject v_object) {
		assert NIL != htfile_header_p(v_object) : "file_hash_table.htfile_header_p error :" + v_object;
		return v_object.getField2();
	}
	...
	public static SubLObject htfile_object_entry_size(final SubLObject v_object) {
		assert NIL != htfile_object_entry_p(v_object) : "file_hash_table.htfile_object_entry_p error :" + v_object;
		return v_object.getField2();
	}
	...
	public static SubLObject htfile_key_entry_key_offset(final SubLObject v_object) {
		assert NIL != htfile_key_entry_p(v_object) : "file_hash_table.htfile_key_entry_p error :" + v_object;
		return v_object.getField2();
	}
	...
	public static SubLObject make_htfile_key_entry(SubLObject arglist) {
		...
		for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
			...
			} else if (pcase_var.eql($HASH_CODE)) {
	...
	public static SubLObject fht_se_encoding_input_fn(final SubLObject v_object) {
		assert NIL != fht_serialization_entry_p(v_object) : "file_hash_table.fht_serialization_entry_p error :" + v_object;
		return v_object.getField2();
	}
	...
	public static SubLObject open_file_hash_table(final SubLObject filename, SubLObject testfn, SubLObject serialization) {
		...
		final SubLObject openFHT = StreamsLow.open(filename, new SubLObject[] { $DIRECTION, $IO, $IF_EXISTS, $OVERWRITE, $IF_DOES_NOT_EXIST, $ERROR, $ELEMENT_TYPE, $BINARY });
		_csetf_file_hash_table_stream(fht, openFHT);
	...
	public static SubLObject recover_file_hash_table_heap(final SubLObject fht, SubLObject report_stream) {
		...
		while (file_position(fht_stream, UNPROVIDED).numL(heap_end) && records_read.numL(item_count)) {
			...
			} else if (NIL != output_stream_p(report_stream)) {
	...
	public static SubLObject htfile_file_block_entry_size(final SubLObject v_object) {
		assert NIL != htfile_file_block_entry_p(v_object) : "file_hash_table.htfile_file_block_entry_p error :" + v_object;
		return v_object.getField2();
	}
	...
	public static SubLObject with_different_keyspace(final SubLObject macroform, final SubLObject environment) {
		...
		if (NIL == current) {
			...
			return listS(CLET, list(list(header_local, list(FILE_HASH_TABLE_HEADER, fht)), list(keyspace_temp, list(HTFILE_HEADER_KEY_SPACE_OFFSET, header_local)), list(capacity_temp, list(HTFILE_HEADER_CAPACITY, header_local))), list(CSETF, list(HTFILE_HEADER_KEY_SPACE_OFFSET, header_local), diff_keyspace), list(CSETF, list(HTFILE_HEADER_CAPACITY, header_local), diff_capacity),
					append(body, list(list(CSETF, list(HTFILE_HEADER_KEY_SPACE_OFFSET, header_local), keyspace_temp), list(CSETF, list(HTFILE_HEADER_CAPACITY, header_local), capacity_temp))));
		}
	...
	public static SubLObject compute_new_htfile_heap_size(final SubLObject fht, SubLObject minimal_size) {
		...
		if (NIL == minimal_size) {
			...
			if ((Main.BOOTY_HACKZ || true)) {
				if (new_key_space.numLE(ZERO_INTEGER)) {
					new_key_space = ONE_INTEGER;
				}
			}
	...
	public static SubLObject fast_create_fht_fht(final SubLObject v_object) {
		assert NIL != fast_create_fht_p(v_object) : "file_hash_table.fast_create_fht_p error :" + v_object;
		return v_object.getField2();
	}
	...
	public static SubLObject fstfht_ksorter_tempstem(final SubLObject v_object) {
		assert NIL != fast_fht_keystream_sorter_p(v_object) : "file_hash_table.fast_fht_keystream_sorter_p error :" + v_object;
		return v_object.getField2();
	}
	...
	public static SubLObject make_fast_fht_keystream_sorter(SubLObject arglist) {
		...
		for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
			...
			} else if (pcase_var.eql($IN_FILES)) {
				_csetf_fstfht_ksorter_in_files(v_new, current_value);
			} else if (pcase_var.eql($OUT_FILES)) {
	...
	public static SubLObject fast_fht_manage_index_collisions(final SubLObject macroform, final SubLObject environment) {
		...
		if (NIL == current) {
			...
			return list(CLET, list(list(index_keeper, list(FAST_FHT_GET_COMPARABLE_INDEX_FROM_ENTRY, keeper_entry)), list(index_loser, list(FAST_FHT_GET_COMPARABLE_INDEX_FROM_ENTRY, loser_entry))), list(FAST_FHT_WRITE_ONE_KEYSTREAM_ENTRY, set_stream, keeper_entry), list(CINC, keeper_items), list(CSETQ, keeper_entry, list(FAST_FHT_READ_ONE_KEYSTREAM_ENTRY, keeper_stream, fht, keeper_entry)),
					list(FAST_FHT_DRAIN_INDEX_RUN, fht, index_keeper, keeper_entry, keeper_stream, loser_items, collision_stream), list(FAST_FHT_DRAIN_INDEX_RUN, fht, index_loser, loser_entry, loser_stream, loser_items, collision_stream));
		}
	...
	public static SubLObject init_file_hash_table_file() {
		...
		deflexical("*FHT-SERIALIZATION-TABLE*", SubLSystemTrampolineFile.maybeDefault($fht_serialization_table$, $fht_serialization_table$, () -> dictionary.new_dictionary(UNPROVIDED, UNPROVIDED)));
		defparameter("*FHT-LOOKUP-STREAM*", NIL);
		deflexical("*FHT-NOT-FOUND*", SubLSystemTrampolineFile.maybeDefault($fht_not_found$, $fht_not_found$, () -> make_symbol($$$FileHashTable_Not_Found)));
		deflexical("*NOT-IN-FHT*", SubLSystemTrampolineFile.maybeDefault($not_in_fht$, $not_in_fht$, () -> make_symbol($$$Not_In_FHT)));
		...
		deflexical("*FILE-HASH-TABLE-HEADERS*", SubLSystemTrampolineFile.maybeDefault($file_hash_table_headers$, $file_hash_table_headers$, () -> make_hash_table(TEN_INTEGER, symbol_function(EQUAL), UNPROVIDED)));
	...
	public static final class $file_hash_table_native extends SubLStructNative {
		...
		private $file_hash_table_native() {
	...
	public static final class $htfile_header_native extends SubLStructNative {
		...
		static {
			structDecl = makeStructDeclNative($htfile_header_native.class, HTFILE_HEADER, HTFILE_HEADER_P, $list63, $list64, new String[] { "$size", "$version_major", "$version_minor", "$object_space_offset", "$key_space_offset", "$current_heap_top", "$item_count", "$capacity", "$free_list_head", "$deletion_count", "$header_crc", "$extension_space_size", "$extension_space" }, $list65, $list66,
	...
	public static final class $htfile_object_entry_native extends SubLStructNative {
		...
		private $htfile_object_entry_native() {
			this.$size = Lisp.NIL;
			this.$type = Lisp.NIL;
		...
		static {
			structDecl = makeStructDeclNative($htfile_object_entry_native.class, HTFILE_OBJECT_ENTRY, HTFILE_OBJECT_ENTRY_P, $list123, $list124, new String[] { "$size", "$type", "$key_size", "$key", "$data_size", "$data" }, $list125, $list126, DEFAULT_STRUCT_PRINT_FUNCTION);
		}
	}
	...
	public static final class $htfile_key_entry_native extends SubLStructNative {
		...
		private $htfile_key_entry_native() {
		...
		static {
			structDecl = makeStructDeclNative($htfile_key_entry_native.class, HTFILE_KEY_ENTRY, HTFILE_KEY_ENTRY_P, $list150, $list151, new String[] { "$key_offset", "$hash_code" }, $list152, $list153, DEFAULT_STRUCT_PRINT_FUNCTION);
		}
	}
	...
	public static final class $fht_serialization_entry_native extends SubLStructNative {
		...
		private $fht_serialization_entry_native() {
			this.$encoding_input_fn = Lisp.NIL;
			this.$encoding_output_fn = Lisp.NIL;
			this.$encoding_size_fn = Lisp.NIL;
			this.$hash_fn = Lisp.NIL;
		...
		static {
			structDecl = makeStructDeclNative($fht_serialization_entry_native.class, FHT_SERIALIZATION_ENTRY, FHT_SERIALIZATION_ENTRY_P, $list174, $list175, new String[] { "$encoding_input_fn", "$encoding_output_fn", "$encoding_size_fn", "$hash_fn", "$encoding_key_input_fn", "$encoding_key_output_fn" }, $list176, $list177, PRINT_FHT_SERIALIZATION_ENTRY);
		}
	}
	...
	public static final class $htfile_file_block_entry_native extends SubLStructNative {
		...
		private $htfile_file_block_entry_native() {
			this.$size = Lisp.NIL;
			this.$next = Lisp.NIL;
		}
		...
		static {
			structDecl = makeStructDeclNative($htfile_file_block_entry_native.class, HTFILE_FILE_BLOCK_ENTRY, HTFILE_FILE_BLOCK_ENTRY_P, $list326, $list327, new String[] { "$size", "$next" }, $list328, $list329, PRINT_HTFILE_FILE_BLOCK_ENTRY);
		}
	}
	...
	public static final class $fast_create_fht_native extends SubLStructNative {
		...
		private $fast_create_fht_native() {
			this.$fht = Lisp.NIL;
		...
		static {
			structDecl = makeStructDeclNative($fast_create_fht_native.class, FAST_CREATE_FHT, FAST_CREATE_FHT_P, $list391, $list392, new String[] { "$fht", "$tempstem", "$tempfile", "$keystream" }, $list393, $list394, DEFAULT_STRUCT_PRINT_FUNCTION);
		}
	}
	...
	public static final class $fast_fht_keystream_sorter_native extends SubLStructNative {
		...
		private $fast_fht_keystream_sorter_native() {
			this.$tempstem = Lisp.NIL;
		...
		static {
			structDecl = makeStructDeclNative($fast_fht_keystream_sorter_native.class, FAST_FHT_KEYSTREAM_SORTER, FAST_FHT_KEYSTREAM_SORTER_P, $list430, $list431, new String[] { "$tempstem", "$in_files", "$out_files" }, $list432, $list433, DEFAULT_STRUCT_PRINT_FUNCTION);
		}
	}
