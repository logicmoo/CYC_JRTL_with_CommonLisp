...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class subl_extensions extends SubLTranslatedFile {
    ...
    public static SubLObject structure_info_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$structure_info_native.class ? T : NIL;
    }

    public static SubLObject structure_info_type_name(final SubLObject v_object) {
        assert NIL != structure_info_p(v_object) : "subl_extensions.structure_info_p error :" + v_object;
    ...
    public static final class $structure_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($structure_info_native.class, STRUCTURE_INFO, STRUCTURE_INFO_P, $list2, $list3, new String[]{ "$type_name", "$slot_list", "$accessor_associations", "$plist" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
