...
import static com.cyc.cycjava.cycl.modules.*;
...
public final class modules extends SubLTranslatedFile {
    ...
    public static SubLObject module_p(final SubLObject v_object) {
        return v_object.getClass() == modules.$module_native.class ? T : NIL;
    }

    public static SubLObject module_basis(final SubLObject v_object) {
        assert NIL != module_p(v_object) : "modules.module_p(v_object) " + "CommonSymbols.NIL != modules.module_p(v_object) " + v_object;
    ...
    public static SubLObject make_module(SubLObject arglist) {
        ...
        final SubLObject v_new = new modules.$module_native();
        SubLObject next;
    ...
    public static SubLObject system_p(final SubLObject v_object) {
        return v_object.getClass() == modules.$system_native.class ? T : NIL;
    }

    public static SubLObject system_basis(final SubLObject v_object) {
        assert NIL != system_p(v_object) : "modules.system_p(v_object) " + "CommonSymbols.NIL != modules.system_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_system(SubLObject arglist) {
        ...
        final SubLObject v_new = new modules.$system_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $module_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(modules.$module_native.class, MODULE, MODULE_P, $list7, $list8, new String[]{ "$basis", "$name", "$system", "$pathname", "$test_cases", "$test_suites", "$provisional_p" }, $list9, $list10, PRINT_MODULE);
        }
    }
    ...
    public static final class $system_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(modules.$system_native.class, SYSTEM, SYSTEM_P, $list73, $list74, new String[]{ "$basis", "$name", "$default_pathname", "$modules", "$provisional_p" }, $list75, $list76, PRINT_SYSTEM);
        }
    }
