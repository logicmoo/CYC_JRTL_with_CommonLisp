...
public final class shelfs extends SubLTranslatedFile {
    ...
    public static SubLObject shelf_info_p(final SubLObject v_object) {
        return v_object.getClass() == shelfs.$shelf_info_native.class ? T : NIL;
    }

    public static SubLObject shelf_info_key(final SubLObject v_object) {
        assert NIL != shelf_info_p(v_object) : "shelfs.shelf_info_p(v_object) " + "CommonSymbols.NIL != shelfs.shelf_info_p(v_object) " + v_object;
    ...
    public static SubLObject make_shelf_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new shelfs.$shelf_info_native();
        SubLObject next;
    ...
    public static SubLObject shelf_p(final SubLObject v_object) {
        return v_object.getClass() == shelfs.$shelf_native.class ? T : NIL;
    }

    public static SubLObject shelf_info(final SubLObject v_object) {
        assert NIL != shelf_p(v_object) : "shelfs.shelf_p(v_object) " + "CommonSymbols.NIL != shelfs.shelf_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_shelf(SubLObject arglist) {
        ...
        final SubLObject v_new = new shelfs.$shelf_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $shelf_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(shelfs.$shelf_info_native.class, SHELF_INFO, SHELF_INFO_P, $list3, $list4, new String[]{ "$key", "$test", "$compare", "$minor_limit", "$major_limit" }, $list5, $list6, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $shelf_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(shelfs.$shelf_native.class, SHELF, SHELF_P, $list34, $list35, new String[]{ "$info", "$payload", "$size" }, $list36, $list37, PRINT_SHELF);
        }
    }
