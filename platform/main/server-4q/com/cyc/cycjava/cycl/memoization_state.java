...
public final class memoization_state extends SubLTranslatedFile {
    ...
    public static SubLObject caching_state_p(final SubLObject v_object) {
        return v_object.getClass() == memoization_state.$caching_state_native.class ? T : NIL;
    }

    public static SubLObject caching_state_store(final SubLObject v_object) {
        assert NIL != caching_state_p(v_object) : "memoization_state.caching_state_p(v_object) " + "CommonSymbols.NIL != memoization_state.caching_state_p(v_object) " + v_object;
    ...
    public static SubLObject make_caching_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new memoization_state.$caching_state_native();
        SubLObject next;
    ...
    public static SubLObject memoization_state_p(final SubLObject v_object) {
        return v_object.getClass() == memoization_state.$memoization_state_native.class ? T : NIL;
    }

    public static SubLObject memoization_state_store(final SubLObject v_object) {
        assert NIL != memoization_state_p(v_object) : "memoization_state.memoization_state_p(v_object) " + "CommonSymbols.NIL != memoization_state.memoization_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_memoization_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new memoization_state.$memoization_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $caching_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(memoization_state.$caching_state_native.class, CACHING_STATE, CACHING_STATE_P, $list38, $list39, new String[]{ "$store", "$zero_arg_results", "$lock", "$capacity", "$func_symbol", "$test", "$args_length" }, $list40, $list41, PRINT_CACHING_STATE);
        }
    }
    ...
    public static final class $memoization_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(memoization_state.$memoization_state_native.class, MEMOIZATION_STATE, MEMOIZATION_STATE_P, $list84, $list85, new String[]{ "$store", "$current_process", "$lock", "$name", "$should_clone" }, $list86, $list87, PRINT_MEMOIZATION_STATE);
        }
    }
