...
public final class memoization_state extends SubLTranslatedFile {
	...
	public static final SubLSymbol CACHING_MODE_ENABLE = makeSymbol("CACHING-MODE-ENABLE");

	public static final SubLSymbol CACHING_MODE_DISABLE = makeSymbol("CACHING-MODE-DISABLE");
	...
	public static final SubLSymbol MEMOIZATION_STATE_LOCK = makeSymbol("MEMOIZATION-STATE-LOCK");
	...
	public static final SubLList $list38 = list(makeSymbol("STORE"), makeSymbol("ZERO-ARG-RESULTS"), makeSymbol("LOCK"), makeSymbol("CAPACITY"), makeSymbol("FUNC-SYMBOL"), makeSymbol("TEST"), makeSymbol("ARGS-LENGTH"));

	public static final SubLList $list39 = list(makeKeyword("STORE"), makeKeyword("ZERO-ARG-RESULTS"), makeKeyword("LOCK"), makeKeyword("CAPACITY"), makeKeyword("FUNC-SYMBOL"), makeKeyword("TEST"), makeKeyword("ARGS-LENGTH"));

	public static final SubLList $list40 = list(makeSymbol("CACHING-STATE-STORE"), makeSymbol("CACHING-STATE-ZERO-ARG-RESULTS"), makeSymbol("CACHING-STATE-LOCK"), makeSymbol("CACHING-STATE-CAPACITY"), makeSymbol("CACHING-STATE-FUNC-SYMBOL"), makeSymbol("CACHING-STATE-TEST"), makeSymbol("CACHING-STATE-ARGS-LENGTH"));
	...
	public static final SubLList $list78 = list(makeSymbol("CACHED-ARGS"), makeSymbol("RESULT"));

	public static final SubLList $list81 = list(makeSymbol("CACHED-ARGS"), makeSymbol("RESULTS"));
	...
	private static final SubLList $list85 = list(makeKeyword("STORE"), makeKeyword("CURRENT-PROCESS"), makeKeyword("LOCK"), makeKeyword("NAME"), makeKeyword("SHOULD-CLONE"));
	...
	private static final SubLList $list139 = list(makeKeyword("TEST"), makeKeyword("CAPACITY"), makeKeyword("FACCESS"), makeKeyword("MEMOIZATION-STATE-FUNCTION"), makeKeyword("MEMOIZATION-STATE-FUNCTION-ARG-POSITIONS"));
	...
	private static final SubLList $list143 = list(makeSymbol("QUOTE"), EQL);
	...
	public static final SubLList $list195 = list(makeSymbol("CNOT"), list(makeSymbol("REST"), makeSymbol("CACHED-ARGS")));

	private static final SubLList $list196 = list(list(makeSymbol("RET"), list(makeSymbol("CACHING-RESULTS"), makeSymbol("RESULTS2"))));
	...
	private static final SubLList $list210 = list(makeKeyword("TEST"), makeKeyword("CAPACITY"), makeKeyword("FACCESS"), makeKeyword("SIZE"), makeKeyword("CLEAR-WHEN"));
	...
	public static final SubLList $list230 = list(makeSymbol("PROGN"));
	...
	private static final SubLList $list247 = list(list(makeSymbol("RET"), NIL));
	...
	private static final SubLList $list259 = list(makeKeyword("TEST"));
	...
	public static SubLObject caching_state_p(final SubLObject v_object) {
		return v_object.getJavaClass() ==$caching_state_native.class ? T : NIL;
	}

	public static SubLObject caching_state_store(final SubLObject v_object) {
		assert NIL != caching_state_p(v_object) : "memoization_state.caching_state_p error :" + v_object;
	...
	public static SubLObject make_caching_state(SubLObject arglist) {
		...
		for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
			...
			} else if (pcase_var.eql($ZERO_ARG_RESULTS)) {
			...
			} else if (pcase_var.eql($FUNC_SYMBOL)) {
			...
			} else if (pcase_var.eql($ARGS_LENGTH)) {
	...
	public static SubLObject caching_state_multi_key_n_is_cached(final SubLObject caching_state, final SubLObject args_list) {
		...
		assert NIL != caching_state_p(caching_state) : "memoization_state.caching_state_p(caching_state) " + "CommonSymbols.NIL != memoization_state.caching_state_p(caching_state) " + caching_state;
		assert NIL != listp(args_list) : "Types.listp(args_list) " + "CommonSymbols.NIL != Types.listp(args_list) " + args_list;
	...
	public static SubLObject memoization_state_p(final SubLObject v_object) {
		return v_object.getJavaClass() ==$memoization_state_native.class ? T : NIL;
	}

	public static SubLObject memoization_state_store(final SubLObject v_object) {
		assert NIL != memoization_state_p(v_object) : "memoization_state.memoization_state_p error :" + v_object;
		return v_object.getField2();
	}
	...
	public static SubLObject make_memoization_state(SubLObject arglist) {
		...
		for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
			...
			} else if (pcase_var.eql($CURRENT_PROCESS)) {
			...
			} else if (pcase_var.eql($SHOULD_CLONE)) {
	...
	public static SubLObject memoization_state_get_caching_state_for_function(final SubLObject v_memoization_state, final SubLObject func_symbol) {
		...
		assert NIL != memoization_state_p(v_memoization_state) : "memoization_state.memoization_state_p(v_memoization_state) " + "CommonSymbols.NIL != memoization_state.memoization_state_p(v_memoization_state) " + v_memoization_state;
		assert NIL != symbolp(func_symbol) : "Types.symbolp(func_symbol) " + "CommonSymbols.NIL != Types.symbolp(func_symbol) " + func_symbol;
	...
	public static SubLObject clear_memoization(final SubLObject state, final SubLObject function_symbol) {
		assert NIL != memoization_state_p(state) : "memoization_state.memoization_state_p(state) " + "CommonSymbols.NIL != memoization_state.memoization_state_p(state) " + state;
	...
	public static SubLObject define_memoized_internal_0_or_1(final SubLObject name, final SubLObject args, final SubLObject test, final SubLObject capacity, final SubLObject faccess, final SubLObject memoization_state_function, final SubLObject memoization_state_function_arg_positions, final SubLObject body) {
		...
		final SubLObject formal_args = define_formal_args(args);
		return listS(
				PROGN, note_memoized_function_code(name), caching_internal_function_code(internal_function, args, body), append(
						NIL != faccess ? list(
								list(DECLAIM, list(FACCESS, faccess, name))) : NIL,
						list(listS(
								DEFINE, name, append(args, NIL), append(
										NIL != $caching_mode_should_monitor$.getGlobalValue() ? list(list(NOTE_CACHED_FUNCTION_CALLED, list(QUOTE, name))) : NIL, NIL != $allow_function_caching_to_be_disabled$
												.getGlobalValue() ? list(
														list(PWHEN, list(CACHING_DISABLED, list(QUOTE, name)), list(RET, bq_cons(internal_function, append(formal_args, NIL))))) : NIL,
										list(list(CLET, list(list(v_memoization_state, lookup_memoization_state_code(memoization_state_function, name, memoization_state_function_arg_positions, formal_args)), bq_cons(caching_state, $list157)), list(PUNLESS, v_memoization_state, list(RET, bq_cons(internal_function, append(formal_args, NIL)))),
												list(CSETQ, caching_state, list(MEMOIZATION_STATE_LOOKUP, v_memoization_state, list(QUOTE, name))),
												list(PUNLESS, caching_state, list(CSETQ, caching_state, list(CREATE_CACHING_STATE, list(MEMOIZATION_STATE_LOCK, v_memoization_state), list(QUOTE, name), length(formal_args), capacity, internal_test)), list(MEMOIZATION_STATE_PUT, v_memoization_state, list(QUOTE, name), caching_state)),
												list(CLET, list(list(results, caching_lookup_code(caching_state, formal_args, ZERO_INTEGER, NIL, NIL))), listS(PWHEN, listS(EQ, results, $list162), append(NIL != $caching_mode_should_monitor$.getGlobalValue() ? list(list(NOTE_CACHED_FUNCTION_CALLED_BUT_NOT_CACHED, list(QUOTE, name))) : NIL,
														list(list(CSETQ, results, list(MULTIPLE_VALUE_LIST, bq_cons(internal_function, append(formal_args, NIL)))), NIL == formal_args ? list(CACHING_STATE_SET_ZERO_ARG_RESULTS, caching_state, results) : listS(CACHING_STATE_PUT, caching_state, append(formal_args, list(results)))))), list(RET, list(CACHING_RESULTS, results))))))))));
	}
	...
	public static SubLObject define_memoized_internal_n(final SubLObject name, final SubLObject args, final SubLObject test, final SubLObject capacity, final SubLObject faccess, final SubLObject memoization_state_function, final SubLObject memoization_state_function_arg_positions, final SubLObject body) {
		...
		final SubLObject internal_test = macro_test_to_run_time_test(test);
		final SubLObject formal_args = define_formal_args(args);
		return listS(PROGN, note_memoized_function_code(name), caching_internal_function_code(internal_function, args, body), append(NIL != faccess ? list(list(DECLAIM, list(FACCESS, faccess, name))) : NIL,
				list(listS(DEFINE, name, append(args, NIL), append(NIL != $caching_mode_should_monitor$.getGlobalValue() ? list(list(NOTE_CACHED_FUNCTION_CALLED, list(QUOTE, name))) : NIL, NIL != $allow_function_caching_to_be_disabled$.getGlobalValue() ? list(list(PWHEN, list(CACHING_DISABLED, list(QUOTE, name)), list(RET, bq_cons(internal_function, append(formal_args, NIL))))) : NIL,
						list(list(CLET, list(list(v_memoization_state, lookup_memoization_state_code(memoization_state_function, name, memoization_state_function_arg_positions, formal_args)), bq_cons(caching_state, $list157)), list(PUNLESS, v_memoization_state, list(RET, bq_cons(internal_function, append(formal_args, NIL)))),
								list(CSETQ, caching_state, list(MEMOIZATION_STATE_LOOKUP, v_memoization_state, list(QUOTE, name))), list(PUNLESS, caching_state, list(CSETQ, caching_state, list(CREATE_CACHING_STATE, list(MEMOIZATION_STATE_LOCK, v_memoization_state), list(QUOTE, name), length(formal_args), capacity, internal_test)), list(MEMOIZATION_STATE_PUT, v_memoization_state, list(QUOTE, name), caching_state)),
								listS(CLET, list(list(sxhash, caching_sxhash_code(formal_args)), list(collisions, list(CACHING_STATE_LOOKUP, caching_state, sxhash))), list(PWHEN, list(CNOT, listS(EQ, collisions, $list162)), caching_lookup_code(caching_state, formal_args, sxhash, collisions, internal_test)),
										append(NIL != $caching_mode_should_monitor$.getGlobalValue() ? list(list(NOTE_CACHED_FUNCTION_CALLED_BUT_NOT_CACHED, list(QUOTE, name))) : NIL,
												list(list(CLET, list(list(results, list(MULTIPLE_VALUE_LIST, bq_cons(internal_function, append(formal_args, NIL))))), list(CACHING_STATE_ENTER_MULTI_KEY_N, caching_state, sxhash, collisions, results, bq_cons(LIST, append(formal_args, NIL))), list(RET, list(CACHING_RESULTS, results)))))))))))));
	}
	...
	public static SubLObject caching_lookup_code(final SubLObject caching_state, final SubLObject formal_args, final SubLObject sxhash, final SubLObject collisions, SubLObject test) {
		...
		if (SIX_INTEGER.eql(arg_list_length)) {
			return list(CDOLIST, list(COLLISION, collisions),
					list(CLET, $list190, list(PWHEN, listS(test, arg1, $list191), $list192, list(PWHEN, listS(test, arg2, $list191), $list192, list(PWHEN, listS(test, arg3, $list191), $list192, list(PWHEN, listS(test, arg4, $list191), $list192, list(PWHEN, listS(test, arg5, $list191), $list192, listS(PWHEN, list(CAND, CACHED_ARGS, $list195, listS(test, arg6, $list191)), $list196))))))));
		}
		if (SEVEN_INTEGER.eql(arg_list_length)) {
			return list(CDOLIST, list(COLLISION, collisions), list(CLET, $list190, list(PWHEN, listS(test, arg1, $list191), $list192,
					list(PWHEN, listS(test, arg2, $list191), $list192, list(PWHEN, listS(test, arg3, $list191), $list192, list(PWHEN, listS(test, arg4, $list191), $list192, list(PWHEN, listS(test, arg5, $list191), $list192, list(PWHEN, listS(test, arg6, $list191), $list192, listS(PWHEN, list(CAND, CACHED_ARGS, $list195, listS(test, arg7, $list191)), $list196)))))))));
		}
		if (EIGHT_INTEGER.eql(arg_list_length)) {
			return list(CDOLIST, list(COLLISION, collisions), list(CLET, $list190, list(PWHEN, listS(test, arg1, $list191), $list192, list(PWHEN, listS(test, arg2, $list191), $list192,
					list(PWHEN, listS(test, arg3, $list191), $list192, list(PWHEN, listS(test, arg4, $list191), $list192, list(PWHEN, listS(test, arg5, $list191), $list192, list(PWHEN, listS(test, arg6, $list191), $list192, list(PWHEN, listS(test, arg7, $list191), $list192, listS(PWHEN, list(CAND, CACHED_ARGS, $list195, listS(test, arg8, $list191)), $list196))))))))));
		}
		if (NINE_INTEGER.eql(arg_list_length)) {
			return list(CDOLIST, list(COLLISION, collisions), list(CLET, $list190, list(PWHEN, listS(test, arg1, $list191), $list192, list(PWHEN, listS(test, arg2, $list191), $list192, list(PWHEN, listS(test, arg3, $list191), $list192,
					list(PWHEN, listS(test, arg4, $list191), $list192, list(PWHEN, listS(test, arg5, $list191), $list192, list(PWHEN, listS(test, arg6, $list191), $list192, list(PWHEN, listS(test, arg7, $list191), $list192, list(PWHEN, listS(test, arg8, $list191), $list192, listS(PWHEN, list(CAND, CACHED_ARGS, $list195, listS(test, arg9, $list191)), $list196)))))))))));
		}
		if (TEN_INTEGER.eql(arg_list_length)) {
			return list(CDOLIST, list(COLLISION, collisions), list(CLET, $list190, list(PWHEN, listS(test, arg1, $list191), $list192, list(PWHEN, listS(test, arg2, $list191), $list192, list(PWHEN, listS(test, arg3, $list191), $list192, list(PWHEN, listS(test, arg4, $list191), $list192,
					list(PWHEN, listS(test, arg5, $list191), $list192, list(PWHEN, listS(test, arg6, $list191), $list192, list(PWHEN, listS(test, arg7, $list191), $list192, list(PWHEN, listS(test, arg8, $list191), $list192, list(PWHEN, listS(test, arg9, $list191), $list192, listS(PWHEN, list(CAND, CACHED_ARGS, $list195, listS(test, arg10, $list191)), $list196))))))))))));
		}
	...
	public static SubLObject define_cached_internal_0_or_1(final SubLObject name, final SubLObject args, SubLObject test, SubLObject size, final SubLObject capacity, final SubLObject faccess, final SubLObject clear_when, final SubLObject body) {
		...
		return listS(PROGN,
				new SubLObject[] {
						global_caching_variable_code(caching_state_var), global_caching_reset_code_new(name), global_caching_n_remove_code_new(name, args, caching_state_var), global_caching_note_function_code(name), caching_internal_function_code(internal_function, formal_args, body), append(
								NIL != faccess ? caching_faccess_code(faccess, name,
										args) : NIL,
								list(listS(
										DEFINE, name, append(args, NIL), append(
												NIL != $caching_mode_should_monitor$.getGlobalValue() ? list(list(NOTE_CACHED_FUNCTION_CALLED, list(QUOTE, name))) : NIL, NIL != $allow_function_caching_to_be_disabled$.getGlobalValue() ? list(
														list(PWHEN, list(CACHING_DISABLED, list(QUOTE, name)), list(RET, bq_cons(internal_function, append(formal_args, NIL))))) : NIL,
												list(list(CLET, list(list(caching_state, caching_state_var)), list(PUNLESS, caching_state, list(CSETQ, caching_state, list(CREATE_GLOBAL_CACHING_STATE_FOR_NAME, list(QUOTE, name), list(QUOTE, caching_state_var), capacity, internal_test, args_length, size)), global_caching_register_reset_code_new(name, clear_when)),
														list(CLET, list(list(results, caching_lookup_code(caching_state, formal_args, ZERO_INTEGER, NIL, NIL))), listS(PWHEN, listS(EQ, results, $list162), append(NIL != $caching_mode_should_monitor$.getGlobalValue() ? list(list(NOTE_CACHED_FUNCTION_CALLED_BUT_NOT_CACHED, list(QUOTE, name))) : NIL,
																list(list(CSETQ, results, list(MULTIPLE_VALUE_LIST, bq_cons(internal_function, append(formal_args, NIL)))), NIL == formal_args ? list(CACHING_STATE_SET_ZERO_ARG_RESULTS, caching_state, results) : listS(CACHING_STATE_PUT, caching_state, append(formal_args, list(results)))))), list(RET, list(CACHING_RESULTS, results))))))))) });
	}
	...
	public static SubLObject define_cached_internal_n(final SubLObject name, final SubLObject args, SubLObject test, SubLObject size, final SubLObject capacity, final SubLObject faccess, final SubLObject clear_when, final SubLObject body) {
		...
		final SubLObject internal_test = macro_test_to_run_time_test(test);
		return listS(PROGN,
				new SubLObject[] { global_caching_variable_code(caching_state_var), global_caching_reset_code_new(name), global_caching_n_remove_code_new(name, args, caching_state_var), global_caching_note_function_code(name), caching_internal_function_code(internal_function, formal_args, body),
						append(NIL != faccess ? caching_faccess_code(faccess, name, args) : NIL,
								list(listS(DEFINE, name, append(args, NIL),
										append(NIL != $caching_mode_should_monitor$.getGlobalValue() ? list(list(NOTE_CACHED_FUNCTION_CALLED, list(QUOTE, name))) : NIL, NIL != $allow_function_caching_to_be_disabled$.getGlobalValue() ? list(list(PWHEN, list(CACHING_DISABLED, list(QUOTE, name)), list(RET, bq_cons(internal_function, append(formal_args, NIL))))) : NIL,
												list(list(CLET, list(list(caching_state, caching_state_var)), list(PUNLESS, caching_state, list(CSETQ, caching_state, list(CREATE_GLOBAL_CACHING_STATE_FOR_NAME, list(QUOTE, name), list(QUOTE, caching_state_var), capacity, internal_test, args_length, size)), global_caching_register_reset_code_new(name, clear_when)),
														listS(CLET, list(list(sxhash, caching_sxhash_code(formal_args)), list(collisions, list(CACHING_STATE_LOOKUP, caching_state, sxhash))), list(PWHEN, list(CNOT, listS(EQ, collisions, $list162)), caching_lookup_code(caching_state, formal_args, sxhash, collisions, internal_test)),
																append(NIL != $caching_mode_should_monitor$.getGlobalValue() ? list(list(NOTE_CACHED_FUNCTION_CALLED_BUT_NOT_CACHED, list(QUOTE, name))) : NIL,
																		list(list(CLET, list(list(results, list(MULTIPLE_VALUE_LIST, bq_cons(internal_function, append(formal_args, NIL))))), list(CACHING_STATE_ENTER_MULTI_KEY_N, caching_state, sxhash, collisions, results, bq_cons(LIST, append(formal_args, NIL))), list(RET, list(CACHING_RESULTS, results)))))))))))) });
	...
	public static SubLObject register_hl_store_cache_clear_callback(final SubLObject callback) {
		assert NIL != function_spec_p(callback) : "Types.function_spec_p(callback) " + "CommonSymbols.NIL != Types.function_spec_p(callback) " + callback;
	...
	public static SubLObject declare_memoization_state_file() {
		declareFunction(me, "note_cached_function_called", "NOTE-CACHED-FUNCTION-CALLED", 1, 0, false);
		declareFunction(me, "note_cached_function_called_but_not_cached", "NOTE-CACHED-FUNCTION-CALLED-BUT-NOT-CACHED", 1, 0, false);
		declareFunction(me, "show_function_caching_results", "SHOW-FUNCTION-CACHING-RESULTS", 0, 0, false);
		declareFunction(me, "clear_function_caching_results", "CLEAR-FUNCTION-CACHING-RESULTS", 0, 0, false);
		declareMacro(me, "with_caching_mode", "WITH-CACHING-MODE");
		declareFunction(me, "caching_mode_enable", "CACHING-MODE-ENABLE", 0, 1, false);
		declareFunction(me, "caching_mode_disable", "CACHING-MODE-DISABLE", 0, 1, false);
		declareFunction(me, "caching_disabled", "CACHING-DISABLED", 1, 0, false);
		declareFunction(me, "sxhash_calc_n", "SXHASH-CALC-N", 1, 0, false);
		declareFunction(me, "sxhash_calc_10", "SXHASH-CALC-10", 10, 0, false);
		declareFunction(me, "sxhash_calc_9", "SXHASH-CALC-9", 9, 0, false);
		declareFunction(me, "sxhash_calc_8", "SXHASH-CALC-8", 8, 0, false);
		declareFunction(me, "sxhash_calc_7", "SXHASH-CALC-7", 7, 0, false);
		declareFunction(me, "sxhash_calc_6", "SXHASH-CALC-6", 6, 0, false);
		declareFunction(me, "sxhash_calc_5", "SXHASH-CALC-5", 5, 0, false);
		declareFunction(me, "sxhash_calc_4", "SXHASH-CALC-4", 4, 0, false);
		declareFunction(me, "sxhash_calc_3", "SXHASH-CALC-3", 3, 0, false);
		declareFunction(me, "sxhash_calc_2", "SXHASH-CALC-2", 2, 0, false);
		declareMacro(me, "possibly_with_memoization_state_writer_lock", "POSSIBLY-WITH-MEMOIZATION-STATE-WRITER-LOCK");
		declareMacro(me, "possibly_with_memoization_state_reader_lock", "POSSIBLY-WITH-MEMOIZATION-STATE-READER-LOCK");
		declareMacro(me, "possibly_with_caching_state_writer_lock", "POSSIBLY-WITH-CACHING-STATE-WRITER-LOCK");
		declareMacro(me, "possibly_with_caching_state_reader_lock", "POSSIBLY-WITH-CACHING-STATE-READER-LOCK");
		declareFunction(me, "caching_state_print_function_trampoline", "CACHING-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
		declareFunction(me, "caching_state_p", "CACHING-STATE-P", 1, 0, false);
		new memoization_state.$caching_state_p$UnaryFunction();
		declareFunction(me, "caching_state_store", "CACHING-STATE-STORE", 1, 0, false);
		declareFunction(me, "caching_state_zero_arg_results", "CACHING-STATE-ZERO-ARG-RESULTS", 1, 0, false);
		declareFunction(me, "caching_state_lock", "CACHING-STATE-LOCK", 1, 0, false);
		declareFunction(me, "caching_state_capacity", "CACHING-STATE-CAPACITY", 1, 0, false);
		declareFunction(me, "caching_state_func_symbol", "CACHING-STATE-FUNC-SYMBOL", 1, 0, false);
		declareFunction(me, "caching_state_test", "CACHING-STATE-TEST", 1, 0, false);
		declareFunction(me, "caching_state_args_length", "CACHING-STATE-ARGS-LENGTH", 1, 0, false);
		declareFunction(me, "_csetf_caching_state_store", "_CSETF-CACHING-STATE-STORE", 2, 0, false);
		declareFunction(me, "_csetf_caching_state_zero_arg_results", "_CSETF-CACHING-STATE-ZERO-ARG-RESULTS", 2, 0, false);
		declareFunction(me, "_csetf_caching_state_lock", "_CSETF-CACHING-STATE-LOCK", 2, 0, false);
		declareFunction(me, "_csetf_caching_state_capacity", "_CSETF-CACHING-STATE-CAPACITY", 2, 0, false);
		declareFunction(me, "_csetf_caching_state_func_symbol", "_CSETF-CACHING-STATE-FUNC-SYMBOL", 2, 0, false);
		declareFunction(me, "_csetf_caching_state_test", "_CSETF-CACHING-STATE-TEST", 2, 0, false);
		declareFunction(me, "_csetf_caching_state_args_length", "_CSETF-CACHING-STATE-ARGS-LENGTH", 2, 0, false);
		declareFunction(me, "make_caching_state", "MAKE-CACHING-STATE", 0, 1, false);
		declareFunction(me, "visit_defstruct_caching_state", "VISIT-DEFSTRUCT-CACHING-STATE", 2, 0, false);
		declareFunction(me, "visit_defstruct_object_caching_state_method", "VISIT-DEFSTRUCT-OBJECT-CACHING-STATE-METHOD", 2, 0, false);
		declareFunction(me, "create_caching_state", "CREATE-CACHING-STATE", 3, 3, false);
		declareFunction(me, "print_caching_state_internal", "PRINT-CACHING-STATE-INTERNAL", 3, 0, false);
		declareFunction(me, "print_caching_state", "PRINT-CACHING-STATE", 3, 0, false);
		declareFunction(me, "caching_state_get_zero_arg_results_internal", "CACHING-STATE-GET-ZERO-ARG-RESULTS-INTERNAL", 1, 0, false);
		declareFunction(me, "caching_state_get_zero_arg_results", "CACHING-STATE-GET-ZERO-ARG-RESULTS", 1, 1, false);
		declareFunction(me, "caching_state_set_zero_arg_results_internal", "CACHING-STATE-SET-ZERO-ARG-RESULTS-INTERNAL", 2, 0, false);
		declareFunction(me, "caching_state_set_zero_arg_results", "CACHING-STATE-SET-ZERO-ARG-RESULTS", 2, 1, false);
		declareFunction(me, "caching_state_lookup_internal", "CACHING-STATE-LOOKUP-INTERNAL", 2, 1, false);
		declareFunction(me, "caching_state_lookup", "CACHING-STATE-LOOKUP", 2, 1, false);
		declareFunction(me, "caching_state_put_internal", "CACHING-STATE-PUT-INTERNAL", 3, 0, false);
		declareFunction(me, "caching_state_put", "CACHING-STATE-PUT", 3, 1, false);
		declareFunction(me, "caching_state_clear_internal", "CACHING-STATE-CLEAR-INTERNAL", 1, 0, false);
		declareFunction(me, "caching_state_clear", "CACHING-STATE-CLEAR", 1, 0, false);
		declareFunction(me, "caching_state_get_capacity", "CACHING-STATE-GET-CAPACITY", 1, 0, false);
		declareFunction(me, "caching_state_get_func_symbol", "CACHING-STATE-GET-FUNC-SYMBOL", 1, 0, false);
		declareFunction(me, "caching_state_get_test", "CACHING-STATE-GET-TEST", 1, 0, false);
		declareFunction(me, "caching_state_keys_internal", "CACHING-STATE-KEYS-INTERNAL", 1, 0, false);
		declareFunction(me, "caching_state_keys", "CACHING-STATE-KEYS", 1, 1, false);
		declareFunction(me, "caching_state_size_internal", "CACHING-STATE-SIZE-INTERNAL", 1, 0, false);
		declareFunction(me, "caching_state_size", "CACHING-STATE-SIZE", 1, 1, false);
		declareFunction(me, "caching_state_size_robust", "CACHING-STATE-SIZE-ROBUST", 1, 1, false);
		declareFunction(me, "caching_state_remove_internal", "CACHING-STATE-REMOVE-INTERNAL", 2, 0, false);
		declareFunction(me, "caching_state_remove", "CACHING-STATE-REMOVE", 2, 1, false);
		declareFunction(me, "caching_state_remove_function_results_with_args_internal", "CACHING-STATE-REMOVE-FUNCTION-RESULTS-WITH-ARGS-INTERNAL", 2, 1, false);
		declareFunction(me, "caching_state_remove_function_results_with_args", "CACHING-STATE-REMOVE-FUNCTION-RESULTS-WITH-ARGS", 2, 2, false);
		declareFunction(me, "caching_state_clone_internal", "CACHING-STATE-CLONE-INTERNAL", 1, 0, false);
		declareFunction(me, "caching_state_store_as_dictionary", "CACHING-STATE-STORE-AS-DICTIONARY", 1, 0, false);
		declareFunction(me, "caching_state_clone", "CACHING-STATE-CLONE", 1, 1, false);
		declareFunction(me, "caching_state_multi_key_n_is_cached", "CACHING-STATE-MULTI-KEY-N-IS-CACHED", 2, 0, false);
		declareFunction(me, "caching_state_lookup_multi_key_n", "CACHING-STATE-LOOKUP-MULTI-KEY-N", 2, 2, false);
		declareFunction(me, "caching_state_lookup_multi_key_1", "CACHING-STATE-LOOKUP-MULTI-KEY-1", 2, 0, false);
		declareFunction(me, "caching_state_enter_multi_key_n", "CACHING-STATE-ENTER-MULTI-KEY-N", 5, 0, false);
		declareFunction(me, "memoization_state_print_function_trampoline", "MEMOIZATION-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
		declareFunction(me, "memoization_state_p", "MEMOIZATION-STATE-P", 1, 0, false);
		new memoization_state.$memoization_state_p$UnaryFunction();
		declareFunction(me, "memoization_state_store", "MEMOIZATION-STATE-STORE", 1, 0, false);
		declareFunction(me, "memoization_state_current_process", "MEMOIZATION-STATE-CURRENT-PROCESS", 1, 0, false);
		declareFunction(me, "memoization_state_lock", "MEMOIZATION-STATE-LOCK", 1, 0, false);
		declareFunction(me, "memoization_state_name", "MEMOIZATION-STATE-NAME", 1, 0, false);
		declareFunction(me, "memoization_state_should_clone", "MEMOIZATION-STATE-SHOULD-CLONE", 1, 0, false);
		declareFunction(me, "_csetf_memoization_state_store", "_CSETF-MEMOIZATION-STATE-STORE", 2, 0, false);
		declareFunction(me, "_csetf_memoization_state_current_process", "_CSETF-MEMOIZATION-STATE-CURRENT-PROCESS", 2, 0, false);
		declareFunction(me, "_csetf_memoization_state_lock", "_CSETF-MEMOIZATION-STATE-LOCK", 2, 0, false);
		declareFunction(me, "_csetf_memoization_state_name", "_CSETF-MEMOIZATION-STATE-NAME", 2, 0, false);
		declareFunction(me, "_csetf_memoization_state_should_clone", "_CSETF-MEMOIZATION-STATE-SHOULD-CLONE", 2, 0, false);
		declareFunction(me, "make_memoization_state", "MAKE-MEMOIZATION-STATE", 0, 1, false);
		declareFunction(me, "visit_defstruct_memoization_state", "VISIT-DEFSTRUCT-MEMOIZATION-STATE", 2, 0, false);
		declareFunction(me, "visit_defstruct_object_memoization_state_method", "VISIT-DEFSTRUCT-OBJECT-MEMOIZATION-STATE-METHOD", 2, 0, false);
		declareFunction(me, "create_memoization_state", "CREATE-MEMOIZATION-STATE", 0, 4, false);
		declareFunction(me, "new_memoization_state", "NEW-MEMOIZATION-STATE", 0, 4, false);
		declareFunction(me, "print_memoization_state_internal", "PRINT-MEMOIZATION-STATE-INTERNAL", 3, 0, false);
		declareFunction(me, "print_memoization_state", "PRINT-MEMOIZATION-STATE", 3, 0, false);
		declareFunction(me, "memoization_state_lookup_internal", "MEMOIZATION-STATE-LOOKUP-INTERNAL", 2, 1, false);
		declareFunction(me, "memoization_state_lookup", "MEMOIZATION-STATE-LOOKUP", 2, 1, false);
		declareFunction(me, "memoization_state_get_caching_state_for_function", "MEMOIZATION-STATE-GET-CACHING-STATE-FOR-FUNCTION", 2, 0, false);
		declareFunction(me, "memoization_state_put_internal", "MEMOIZATION-STATE-PUT-INTERNAL", 3, 0, false);
		declareFunction(me, "memoization_state_put", "MEMOIZATION-STATE-PUT", 3, 0, false);
		declareFunction(me, "memoization_state_remove_internal", "MEMOIZATION-STATE-REMOVE-INTERNAL", 2, 0, false);
		declareFunction(me, "memoization_state_remove", "MEMOIZATION-STATE-REMOVE", 2, 0, false);
		declareFunction(me, "memoization_state_clear_internal", "MEMOIZATION-STATE-CLEAR-INTERNAL", 1, 0, false);
		declareFunction(me, "memoization_state_clear", "MEMOIZATION-STATE-CLEAR", 1, 0, false);
		declareFunction(me, "memoization_state_get_test", "MEMOIZATION-STATE-GET-TEST", 1, 0, false);
		declareFunction(me, "memoization_state_get_lock", "MEMOIZATION-STATE-GET-LOCK", 1, 0, false);
		declareFunction(me, "memoization_state_get_name", "MEMOIZATION-STATE-GET-NAME", 1, 0, false);
		declareFunction(me, "memoization_state_get_should_clone", "MEMOIZATION-STATE-GET-SHOULD-CLONE", 1, 0, false);
		declareFunction(me, "memoization_state_get_current_process_internal", "MEMOIZATION-STATE-GET-CURRENT-PROCESS-INTERNAL", 1, 0, false);
		declareFunction(me, "memoization_state_get_current_process", "MEMOIZATION-STATE-GET-CURRENT-PROCESS", 1, 0, false);
		declareFunction(me, "memoization_state_keys_internal", "MEMOIZATION-STATE-KEYS-INTERNAL", 1, 0, false);
		declareFunction(me, "memoization_state_keys", "MEMOIZATION-STATE-KEYS", 1, 0, false);
		declareFunction(me, "memoization_state_set_current_process_internal", "MEMOIZATION-STATE-SET-CURRENT-PROCESS-INTERNAL", 2, 0, false);
		declareFunction(me, "memoization_state_set_current_process", "MEMOIZATION-STATE-SET-CURRENT-PROCESS", 2, 0, false);
		declareFunction(me, "memoization_state_clone", "MEMOIZATION-STATE-CLONE", 1, 0, false);
		declareFunction(me, "memoization_state_merge_cloned_state", "MEMOIZATION-STATE-MERGE-CLONED-STATE", 2, 0, false);
		declareFunction(me, "caching_state_results_has_argsP", "CACHING-STATE-RESULTS-HAS-ARGS?", 2, 0, false);
		declareFunction(me, "gather_memoization_state_statistics", "GATHER-MEMOIZATION-STATE-STATISTICS", 1, 0, false);
		declareFunction(me, "gather_memoization_state_statistics_unlocked", "GATHER-MEMOIZATION-STATE-STATISTICS-UNLOCKED", 1, 0, false);
		declareFunction(me, "gather_caching_state_store_statistics", "GATHER-CACHING-STATE-STORE-STATISTICS", 1, 0, false);
		declareFunction(me, "current_memoization_state", "CURRENT-MEMOIZATION-STATE", 0, 0, false);
		declareMacro(me, "with_memoization_state", "WITH-MEMOIZATION-STATE");
		declareFunction(me, "memoization_state_original_process", "MEMOIZATION-STATE-ORIGINAL-PROCESS", 1, 0, false);
		declareFunction(me, "memoization_state_possibly_clear_original_process", "MEMOIZATION-STATE-POSSIBLY-CLEAR-ORIGINAL-PROCESS", 2, 0, false);
		declareFunction(me, "possibly_clone_memoization_state", "POSSIBLY-CLONE-MEMOIZATION-STATE", 1, 0, false);
		declareFunction(me, "possibly_merge_back_memoization_state", "POSSIBLY-MERGE-BACK-MEMOIZATION-STATE", 3, 0, false);
		declareMacro(me, "with_new_memoization_state", "WITH-NEW-MEMOIZATION-STATE");
		declareMacro(me, "with_new_profiled_memoization_state", "WITH-NEW-PROFILED-MEMOIZATION-STATE");
		declareMacro(me, "with_possibly_new_memoization_state", "WITH-POSSIBLY-NEW-MEMOIZATION-STATE");
		declareFunction(me, "possibly_new_memoization_state", "POSSIBLY-NEW-MEMOIZATION-STATE", 0, 0, false);
		declareFunction(me, "clear_memoization", "CLEAR-MEMOIZATION", 2, 0, false);
		declareFunction(me, "clear_current_memoization", "CLEAR-CURRENT-MEMOIZATION", 1, 0, false);
		declareFunction(me, "clear_all_memoization", "CLEAR-ALL-MEMOIZATION", 1, 0, false);
		declareFunction(me, "clear_all_current_memoization", "CLEAR-ALL-CURRENT-MEMOIZATION", 0, 0, false);
		declareFunction(me, "memoization_state_remove_function_results_with_args", "MEMOIZATION-STATE-REMOVE-FUNCTION-RESULTS-WITH-ARGS", 3, 0, false);
		declareFunction(me, "current_memoization_state_remove_function_results_with_args", "CURRENT-MEMOIZATION-STATE-REMOVE-FUNCTION-RESULTS-WITH-ARGS", 2, 0, false);
		declareFunction(me, "note_memoized_function", "NOTE-MEMOIZED-FUNCTION", 1, 0, false);
		declareFunction(me, "memoized_functions", "MEMOIZED-FUNCTIONS", 0, 0, false);
		declareMacro(me, "define_memoized", "DEFINE-MEMOIZED");
		declareFunction(me, "macro_test_to_run_time_test", "MACRO-TEST-TO-RUN-TIME-TEST", 1, 0, false);
		declareFunction(me, "define_memoized_internal", "DEFINE-MEMOIZED-INTERNAL", 8, 0, false);
		declareFunction(me, "define_memoized_internal_0_or_1", "DEFINE-MEMOIZED-INTERNAL-0-OR-1", 8, 0, false);
		declareFunction(me, "define_memoized_internal_n", "DEFINE-MEMOIZED-INTERNAL-N", 8, 0, false);
		declareFunction(me, "caching_sxhash_code", "CACHING-SXHASH-CODE", 1, 0, false);
		declareFunction(me, "caching_lookup_code", "CACHING-LOOKUP-CODE", 5, 0, false);
		declareFunction(me, "lookup_memoization_state_code", "LOOKUP-MEMOIZATION-STATE-CODE", 4, 0, false);
		declareFunction(me, "note_memoized_function_code", "NOTE-MEMOIZED-FUNCTION-CODE", 1, 0, false);
		declareFunction(me, "note_globally_cached_function", "NOTE-GLOBALLY-CACHED-FUNCTION", 1, 0, false);
		declareFunction(me, "globally_cached_functions", "GLOBALLY-CACHED-FUNCTIONS", 0, 0, false);
		declareFunction(me, "global_cache_variables", "GLOBAL-CACHE-VARIABLES", 0, 0, false);
		declareFunction(me, "global_cache_variable_values", "GLOBAL-CACHE-VARIABLE-VALUES", 0, 0, false);
		declareFunction(me, "memoized_or_cached_functions", "MEMOIZED-OR-CACHED-FUNCTIONS", 0, 0, false);
		declareFunction(me, "clear_all_globally_cached_functions", "CLEAR-ALL-GLOBALLY-CACHED-FUNCTIONS", 0, 1, false);
		declareMacro(me, "define_cached_new", "DEFINE-CACHED-NEW");
		declareMacro(me, "define_cached", "DEFINE-CACHED");
		declareMacro(me, "define_cached_multiarg", "DEFINE-CACHED-MULTIARG");
		declareFunction(me, "cache_clear_trigger_p", "CACHE-CLEAR-TRIGGER-P", 1, 0, false);
		declareFunction(me, "atomic_cache_clear_trigger_p", "ATOMIC-CACHE-CLEAR-TRIGGER-P", 1, 0, false);
		declareFunction(me, "define_cached_internal", "DEFINE-CACHED-INTERNAL", 8, 0, false);
		declareFunction(me, "define_cached_internal_0_or_1", "DEFINE-CACHED-INTERNAL-0-OR-1", 8, 0, false);
		declareFunction(me, "define_cached_internal_n", "DEFINE-CACHED-INTERNAL-N", 8, 0, false);
		declareFunction(me, "load_caching_state_contents_from_hash_table", "LOAD-CACHING-STATE-CONTENTS-FROM-HASH-TABLE", 2, 0, false);
		declareFunction(me, "load_caching_state_contents_from_hash_table_internal", "LOAD-CACHING-STATE-CONTENTS-FROM-HASH-TABLE-INTERNAL", 2, 0, false);
		declareFunction(me, "get_caching_state_contents_as_hash_table", "GET-CACHING-STATE-CONTENTS-AS-HASH-TABLE", 1, 0, false);
		declareFunction(me, "get_caching_state_contents_as_hash_table_internal", "GET-CACHING-STATE-CONTENTS-AS-HASH-TABLE-INTERNAL", 1, 0, false);
		declareFunction(me, "get_caching_state_for_globally_cached_function", "GET-CACHING-STATE-FOR-GLOBALLY-CACHED-FUNCTION", 1, 4, false);
		declareFunction(me, "create_global_caching_state_for_name", "CREATE-GLOBAL-CACHING-STATE-FOR-NAME", 6, 0, false);
		declareFunction(me, "memoize_caching_state_for_function_new", "MEMOIZE-CACHING-STATE-FOR-FUNCTION-NEW", 2, 0, false);
		declareFunction(me, "global_caching_reset_from_function", "GLOBAL-CACHING-RESET-FROM-FUNCTION", 1, 0, false);
		declareFunction(me, "global_caching_lock", "GLOBAL-CACHING-LOCK", 1, 0, false);
		declareFunction(me, "global_caching_variable_new", "GLOBAL-CACHING-VARIABLE-NEW", 1, 0, false);
		declareFunction(me, "global_caching_variable_code", "GLOBAL-CACHING-VARIABLE-CODE", 1, 0, false);
		declareFunction(me, "global_caching_reset_function", "GLOBAL-CACHING-RESET-FUNCTION", 1, 0, false);
		declareFunction(me, "global_caching_register_reset_code_new", "GLOBAL-CACHING-REGISTER-RESET-CODE-NEW", 2, 0, false);
		declareFunction(me, "global_caching_register_reset_code_atomic", "GLOBAL-CACHING-REGISTER-RESET-CODE-ATOMIC", 2, 0, false);
		declareFunction(me, "global_caching_reset_code_new", "GLOBAL-CACHING-RESET-CODE-NEW", 1, 0, false);
		declareFunction(me, "global_caching_remove_function", "GLOBAL-CACHING-REMOVE-FUNCTION", 1, 0, false);
		declareFunction(me, "global_caching_n_remove_code_new", "GLOBAL-CACHING-N-REMOVE-CODE-NEW", 3, 0, false);
		declareFunction(me, "register_hl_store_cache_clear_callback", "REGISTER-HL-STORE-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "deregister_hl_store_cache_clear_callback", "DEREGISTER-HL-STORE-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "clear_hl_store_dependent_caches", "CLEAR-HL-STORE-DEPENDENT-CACHES", 0, 0, false);
		declareFunction(me, "register_mt_dependent_cache_clear_callback", "REGISTER-MT-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "deregister_mt_dependent_cache_clear_callback", "DEREGISTER-MT-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "clear_mt_dependent_cachesP", "CLEAR-MT-DEPENDENT-CACHES?", 0, 0, false);
		declareMacro(me, "without_clearing_mt_dependent_caches", "WITHOUT-CLEARING-MT-DEPENDENT-CACHES");
		declareFunction(me, "register_genl_preds_dependent_cache_clear_callback", "REGISTER-GENL-PREDS-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "deregister_genl_preds_dependent_cache_clear_callback", "DEREGISTER-GENL-PREDS-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "register_genls_dependent_cache_clear_callback", "REGISTER-GENLS-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "deregister_genls_dependent_cache_clear_callback", "DEREGISTER-GENLS-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "register_wff_constraint_dependent_cache_clear_callback", "REGISTER-WFF-CONSTRAINT-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "deregister_wff_constraint_dependent_cache_clear_callback", "DEREGISTER-WFF-CONSTRAINT-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "register_isa_dependent_cache_clear_callback", "REGISTER-ISA-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "deregister_isa_dependent_cache_clear_callback", "DEREGISTER-ISA-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "register_quoted_isa_dependent_cache_clear_callback", "REGISTER-QUOTED-ISA-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareFunction(me, "deregister_quoted_isa_dependent_cache_clear_callback", "DEREGISTER-QUOTED-ISA-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
		declareMacro(me, "memoized_already", "MEMOIZED-ALREADY");
		declareMacro(me, "cached_already", "CACHED-ALREADY");
		declareFunction(me, "define_formal_args", "DEFINE-FORMAL-ARGS", 1, 0, false);
		declareFunction(me, "caching_results", "CACHING-RESULTS", 1, 0, false);
		declareFunction(me, "global_caching_note_function_code", "GLOBAL-CACHING-NOTE-FUNCTION-CODE", 1, 0, false);
		declareFunction(me, "caching_internal_function", "CACHING-INTERNAL-FUNCTION", 1, 0, false);
		declareFunction(me, "caching_internal_function_code", "CACHING-INTERNAL-FUNCTION-CODE", 3, 0, false);
		declareFunction(me, "caching_faccess_code", "CACHING-FACCESS-CODE", 3, 0, false);
		return NIL;
	}
	...
	//	 * @return
	//	 */
	//	static SubLObject checkMemoLock(SubLObject local_state) {
	...
	//		                Errors.error(uia_trampolines.$str_alt19$Invalid_attempt_to_reuse_memoizat);
	//		            }
	//		        }
	//		    }
	//		}
	//		return original_memoization_process;
	//	}
	 ...
	 * @return
	 */
	final public static SubLObject aquireMemoStateLock(SubLObject local_state) {
		SubLObject original_memoization_process = NIL;
		if ((NIL != local_state) && (NIL == memoization_state_lock(local_state))) {
			original_memoization_process = memoization_state_get_current_process_internal(local_state);
			{
				...
				if (NIL == original_memoization_process) {
					...
					if (original_memoization_process != current_proc) {
						// @Dmiles this is because it is more likely a side task 
						// @TODO use thread groups
						if (!SubLMain.BOOTY_HACKZ) {
							Errors.error("Invalid attempt to reuse memoization state in multiple threads simultaneously.");
						} else {
							memoization_state_set_current_process_internal(local_state, current_proc);
						}
					}
	...
	public static final class $caching_state_native extends SubLStructNative {
		...
		private $caching_state_native() {
			this.$store = Lisp.NIL;
			this.$zero_arg_results = Lisp.NIL;
			this.$lock = Lisp.NIL;
			this.$capacity = Lisp.NIL;
			this.$func_symbol = Lisp.NIL;
			this.$test = Lisp.NIL;
			this.$args_length = Lisp.NIL;
		}
		...
		static {
			structDecl = makeStructDeclNative($caching_state_native.class, CACHING_STATE, CACHING_STATE_P, $list38, $list39, new String[] { "$store", "$zero_arg_results", "$lock", "$capacity", "$func_symbol", "$test", "$args_length" }, $list40, $list41, PRINT_CACHING_STATE);
		}
	}
	...
	public static final class $memoization_state_native extends SubLStructNative {
		...
		private $memoization_state_native() {
			this.$store = Lisp.NIL;
			this.$current_process = Lisp.NIL;
			this.$lock = Lisp.NIL;
			this.$name = Lisp.NIL;
			this.$should_clone = Lisp.NIL;
		}
		...
		static {
			structDecl = makeStructDeclNative($memoization_state_native.class, MEMOIZATION_STATE, MEMOIZATION_STATE_P, $list84, $list85, new String[] { "$store", "$current_process", "$lock", "$name", "$should_clone" }, $list86, $list87, PRINT_MEMOIZATION_STATE);
		}
	}
