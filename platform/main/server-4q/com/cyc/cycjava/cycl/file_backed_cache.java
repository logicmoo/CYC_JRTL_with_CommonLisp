...
import com.cyc.cycjava.cycl.file_backed_cache;
...
import static com.cyc.cycjava.cycl.file_backed_cache.*;
...
public final class file_backed_cache extends SubLTranslatedFile {
    ...
    public static SubLObject file_backed_cache_p(final SubLObject v_object) {
        return v_object.getClass() == file_backed_cache.$file_backed_cache_native.class ? T : NIL;
    }

    public static SubLObject fbc_file_hash_table_cache(final SubLObject v_object) {
        assert NIL != file_backed_cache_p(v_object) : "file_backed_cache.file_backed_cache_p(v_object) " + "CommonSymbols.NIL != file_backed_cache.file_backed_cache_p(v_object) " + v_object;
    ...
    public static SubLObject make_file_backed_cache(SubLObject arglist) {
        ...
        final SubLObject v_new = new file_backed_cache.$file_backed_cache_native();
        SubLObject next;
    ...
    public static final class $file_backed_cache_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(file_backed_cache.$file_backed_cache_native.class, FILE_BACKED_CACHE, FILE_BACKED_CACHE_P, $list7, $list8, new String[]{ "$file_hash_table_cache", "$local_cache", "$file_hash_table_path", "$should_preload_cache", "$is_fort_cache", "$fht_cache_percentage", "$test", "$mode", "$is_busy" }, $list9, $list10, PRINT_FBC);
        }
    }
