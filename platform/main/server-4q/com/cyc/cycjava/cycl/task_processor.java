...
public final class task_processor extends SubLTranslatedFile {
    ...
    public static SubLObject task_info_p(final SubLObject v_object) {
        return v_object.getClass() == task_processor.$task_info_native.class ? T : NIL;
    }

    public static SubLObject ti_type(final SubLObject v_object) {
        assert NIL != task_info_p(v_object) : "task_processor.task_info_p(v_object) " + "CommonSymbols.NIL != task_processor.task_info_p(v_object) " + v_object;
    ...
    public static SubLObject make_task_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new task_processor.$task_info_native();
        SubLObject next;
    ...
    public static SubLObject task_result_set_p(final SubLObject v_object) {
        return v_object.getClass() == task_processor.$task_result_set_native.class ? T : NIL;
    }

    public static SubLObject task_result_set_result(final SubLObject v_object) {
        assert NIL != task_result_set_p(v_object) : "task_processor.task_result_set_p(v_object) " + "CommonSymbols.NIL != task_processor.task_result_set_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_task_result_set(SubLObject arglist) {
        ...
        final SubLObject v_new = new task_processor.$task_result_set_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject task_processor_p(final SubLObject v_object) {
        return v_object.getClass() == task_processor.$task_processor_native.class ? T : NIL;
    }

    public static SubLObject tproc_name(final SubLObject v_object) {
        assert NIL != task_processor_p(v_object) : "task_processor.task_processor_p(v_object) " + "CommonSymbols.NIL != task_processor.task_processor_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_task_processor(SubLObject arglist) {
        ...
        final SubLObject v_new = new task_processor.$task_processor_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject task_process_pool_p(final SubLObject v_object) {
        return v_object.getClass() == task_processor.$task_process_pool_native.class ? T : NIL;
    }

    public static SubLObject tpool_lock(final SubLObject v_object) {
        assert NIL != task_process_pool_p(v_object) : "task_processor.task_process_pool_p(v_object) " + "CommonSymbols.NIL != task_processor.task_process_pool_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_task_process_pool(SubLObject arglist) {
        ...
        final SubLObject v_new = new task_processor.$task_process_pool_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $task_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(task_processor.$task_info_native.class, TASK_INFO, TASK_INFO_P, $list5, $list6, new String[]{ "$type", "$id", "$priority", "$requestor", "$giveback_info", "$bindings", "$request", "$response", "$error_message", "$task_processor_name" }, $list7, $list8, PRINT_TASK_INFO);
        }
    }
    ...
    public static final class $task_result_set_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(task_processor.$task_result_set_native.class, TASK_RESULT_SET, TASK_RESULT_SET_P, $list62, $list63, new String[]{ "$result", "$task_info", "$finished" }, $list64, $list65, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $task_processor_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(task_processor.$task_processor_native.class, TASK_PROCESSOR, TASK_PROCESSOR_P, $list83, $list84, new String[]{ "$name", "$process", "$busy_p", "$task_info" }, $list85, $list86, PRINT_TASK_PROCESSOR);
        }
    }
    ...
    public static final class $task_process_pool_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(task_processor.$task_process_pool_native.class, TASK_PROCESS_POOL, TASK_PROCESS_POOL_P, $list110, $list111, new String[]{ "$lock", "$request_queue", "$request_semaphore", "$processors", "$background_msgs", "$process_name_prefix", "$min_nbr_of_task_processors", "$max_nbr_of_task_processors" }, $list112, $list113, PRINT_TASK_PROCESS_POOL);
        }
    }
