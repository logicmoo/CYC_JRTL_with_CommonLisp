...
public final class number_utilities extends SubLTranslatedFile {
    ...
    public static final SubLList $list115 = list(new SubLObject[]{ list(CHAR_a, TEN_INTEGER), list(CHAR_A, TEN_INTEGER), list(CHAR_b, ELEVEN_INTEGER), list(CHAR_B, ELEVEN_INTEGER), list(CHAR_c, TWELVE_INTEGER), list(CHAR_C, TWELVE_INTEGER), list(CHAR_d, THIRTEEN_INTEGER), list(CHAR_D, THIRTEEN_INTEGER), list(CHAR_e, FOURTEEN_INTEGER), list(CHAR_E, FOURTEEN_INTEGER), list(CHAR_f, FIFTEEN_INTEGER), list(CHAR_F, FIFTEEN_INTEGER) });
