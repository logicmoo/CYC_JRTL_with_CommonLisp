...
public final class lexicon_accessors extends SubLTranslatedFile {
    ...
    public static SubLObject typed_denots_of_string(final SubLObject string, final SubLObject type, SubLObject abbrev_types, SubLObject denot_type, SubLObject misspellingsP, SubLObject skip_namestringsP, SubLObject lookup_mt, SubLObject semantic_mt, SubLObject parse_morphologically, SubLObject excluded_predicates) {
        ...
        SubLSystemTrampolineFile.enforceType(type, EL_FORT_P);
        SubLSystemTrampolineFile.enforceType(abbrev_types, LISTP);
        SubLSystemTrampolineFile.enforceType(denot_type, KEYWORDP);
        SubLSystemTrampolineFile.enforceType(misspellingsP, BOOLEANP);
        SubLSystemTrampolineFile.enforceType(skip_namestringsP, BOOLEANP);
        SubLSystemTrampolineFile.enforceType(lookup_mt, $sym176$HLMT_);
        SubLSystemTrampolineFile.enforceType(semantic_mt, $sym176$HLMT_);
        SubLSystemTrampolineFile.enforceType(parse_morphologically, PARSE_MORPHOLOGICALLY_OPTION_P);
        SubLSystemTrampolineFile.enforceType(excluded_predicates, SET_P);
        SubLObject result = NIL;
        final SubLObject current_state = memoization_state.current_memoization_state();
        final SubLObject _prev_bind_0 = lexicon_macros.$lexicon_memoization_state$.currentBinding(thread);
        try {
    ...
    public static SubLObject denotation_mapper(final SubLObject string, SubLObject excluded_preds, SubLObject mode, SubLObject parse_morphologically) {
        ...
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLSystemTrampolineFile.enforceType(string, STRINGP);
        SubLSystemTrampolineFile.enforceType(excluded_preds, LIST_OF_PREDICATES_P);
    ...
    public static SubLObject denots_of_string(final SubLObject string, SubLObject abbrev_types, SubLObject denot_type, SubLObject misspellingsP, SubLObject skip_namestringsP, SubLObject lookup_mt, SubLObject parse_morphologically, SubLObject parse_dates_and_numbersP, SubLObject lexicon) {
        ...
        final SubLThread thread = SubLProcess.currentSubLThread();
        SubLSystemTrampolineFile.enforceType(string, CYCL_STRING_P);
        SubLSystemTrampolineFile.enforceType(abbrev_types, LISTP);
        SubLSystemTrampolineFile.enforceType(denot_type, KEYWORDP);
        SubLSystemTrampolineFile.enforceType(misspellingsP, BOOLEANP);
        SubLSystemTrampolineFile.enforceType(skip_namestringsP, BOOLEANP);
        SubLSystemTrampolineFile.enforceType(lookup_mt, $sym212$VALID_DENOTS_OF_STRING_LOOKUP_MT_SPECIFICATION_);
        SubLSystemTrampolineFile.enforceType(parse_morphologically, PARSE_MORPHOLOGICALLY_OPTION_P);
        SubLObject denots = NIL;
        SubLObject predicate_lists = NIL;
        final SubLObject current_state = memoization_state.current_memoization_state();
    ...
    public static SubLObject init_lexicon_accessors_file() {
        ...
        deflexical("*DERIVED-PREDS*", SubLSystemTrampolineFile.maybeDefault($derived_preds$, $derived_preds$, () -> make_hash_table($int$256, UNPROVIDED, UNPROVIDED)));
        deflexical("*SPEECH-PART-PREDS*", SubLSystemTrampolineFile.maybeDefault($speech_part_preds$, $speech_part_preds$, () -> dictionary.new_dictionary(symbol_function(EQL), $int$256)));
        ...
        deflexical("*CLOSED-LEXICAL-CLASS-STRINGS*", SubLSystemTrampolineFile.maybeDefault($closed_lexical_class_strings$, $closed_lexical_class_strings$, () -> make_hash_table($int$512, symbol_function(EQUAL), UNPROVIDED)));
        deflexical("*CLOSED-LEXICAL-CLASS-STRINGS-CASE-INSENSITIVE*", SubLSystemTrampolineFile.maybeDefault($closed_lexical_class_strings_case_insensitive$, $closed_lexical_class_strings_case_insensitive$, () -> make_hash_table($int$512, symbol_function(EQUALP), UNPROVIDED)));
        ...
        deflexical("*VULGAR-WORDS*", SubLSystemTrampolineFile.maybeDefault($vulgar_words$, $vulgar_words$, () -> set.new_set(UNPROVIDED, UNPROVIDED)));
        ...
        deflexical("*SPEECH-PARTS*", SubLSystemTrampolineFile.maybeDefault($speech_parts$, $speech_parts$, () -> dictionary.new_dictionary(symbol_function(EQL), $int$256)));
