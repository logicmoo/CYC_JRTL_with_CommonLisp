...
import com.cyc.cycjava.cycl.pph_drs;
...
import static com.cyc.cycjava.cycl.pph_drs.*;
...
public final class pph_drs extends SubLTranslatedFile {
    ...
    public static SubLObject pph_rm_p(final SubLObject v_object) {
        return v_object.getClass() == pph_drs.$pph_rm_native.class ? T : NIL;
    }

    public static SubLObject pph_rm_cycl(final SubLObject v_object) {
        assert NIL != pph_rm_p(v_object) : "pph_drs.pph_rm_p(v_object) " + "CommonSymbols.NIL != pph_drs.pph_rm_p(v_object) " + v_object;
    ...
    public static SubLObject make_pph_rm(SubLObject arglist) {
        ...
        final SubLObject v_new = new pph_drs.$pph_rm_native();
        SubLObject next;
    ...
    public static SubLObject pph_drs_p(final SubLObject v_object) {
        return v_object.getClass() == pph_drs.$pph_drs_native.class ? T : NIL;
    }

    public static SubLObject pph_drs_rms(final SubLObject v_object) {
        assert NIL != pph_drs_p(v_object) : "pph_drs.pph_drs_p(v_object) " + "CommonSymbols.NIL != pph_drs.pph_drs_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_pph_drs(SubLObject arglist) {
        ...
        final SubLObject v_new = new pph_drs.$pph_drs_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $pph_rm_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(pph_drs.$pph_rm_native.class, PPH_RM, PPH_RM_P, $list15, $list16, new String[]{ "$cycl", "$agr", "$phrases" }, $list17, $list18, PPH_PPRINT_RM);
        }
    }
    ...
    public static final class $pph_drs_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(pph_drs.$pph_drs_native.class, PPH_DRS, PPH_DRS_P, $list42, $list43, new String[]{ "$rms", "$backward_looking_center", "$id" }, $list44, $list45, PPRINT_PPH_DRS);
        }
    }
