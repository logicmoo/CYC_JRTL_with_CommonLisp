...
public final class pph_data_structures extends SubLTranslatedFile {
    ...
    public static SubLObject generation_template_p(final SubLObject v_object) {
        return v_object.getClass() == pph_data_structures.$generation_template_native.class ? T : NIL;
    }

    public static SubLObject gen_template_phrase(final SubLObject v_object) {
        assert NIL != generation_template_p(v_object) : "pph_data_structures.generation_template_p(v_object) " + "CommonSymbols.NIL != pph_data_structures.generation_template_p(v_object) " + v_object;
    ...
    public static SubLObject make_generation_template(SubLObject arglist) {
        ...
        final SubLObject v_new = new pph_data_structures.$generation_template_native();
        SubLObject next;
    ...
    public static SubLObject pph_phrase_agr_p(final SubLObject v_object) {
        return v_object.getClass() == pph_data_structures.$pph_phrase_agr_native.class ? T : NIL;
    }

    public static SubLObject pph_phrase_agr_absolute_constraint(final SubLObject v_object) {
        assert NIL != pph_phrase_agr_p(v_object) : "pph_data_structures.pph_phrase_agr_p(v_object) " + "CommonSymbols.NIL != pph_data_structures.pph_phrase_agr_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_pph_phrase_agr(SubLObject arglist) {
        ...
        final SubLObject v_new = new pph_data_structures.$pph_phrase_agr_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject paraphrase_phrase_info_bundle_p(final SubLObject v_object) {
        return v_object.getClass() == pph_data_structures.$paraphrase_phrase_info_bundle_native.class ? T : NIL;
    }

    public static SubLObject pph_phrase_info_cycl(final SubLObject v_object) {
        assert NIL != paraphrase_phrase_info_bundle_p(v_object) : "pph_data_structures.paraphrase_phrase_info_bundle_p(v_object) " + "CommonSymbols.NIL != pph_data_structures.paraphrase_phrase_info_bundle_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_paraphrase_phrase_info_bundle(SubLObject arglist) {
        ...
        final SubLObject v_new = new pph_data_structures.$paraphrase_phrase_info_bundle_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject pph_phrase_output_item_p(final SubLObject v_object) {
        return v_object.getClass() == pph_data_structures.$pph_phrase_output_item_native.class ? T : NIL;
    }

    public static SubLObject pph_oi_string(final SubLObject v_object) {
        assert NIL != pph_phrase_output_item_p(v_object) : "pph_data_structures.pph_phrase_output_item_p(v_object) " + "CommonSymbols.NIL != pph_data_structures.pph_phrase_output_item_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_pph_phrase_output_item(SubLObject arglist) {
        ...
        final SubLObject v_new = new pph_data_structures.$pph_phrase_output_item_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject pph_phrase_template_generator_p(final SubLObject v_object) {
        return v_object.getClass() == pph_data_structures.$pph_phrase_template_generator_native.class ? T : NIL;
    }

    public static SubLObject pph_phrase_template_generator_formula(final SubLObject v_object) {
        assert NIL != pph_phrase_template_generator_p(v_object) : "pph_data_structures.pph_phrase_template_generator_p(v_object) " + "CommonSymbols.NIL != pph_data_structures.pph_phrase_template_generator_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_pph_phrase_template_generator(SubLObject arglist) {
        ...
        final SubLObject v_new = new pph_data_structures.$pph_phrase_template_generator_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject pph_phrase_output_list_iterator_p(final SubLObject v_object) {
        return v_object.getClass() == pph_data_structures.$pph_phrase_output_list_iterator_native.class ? T : NIL;
    }

    public static SubLObject pph_phrase_output_list_iterator_item_queue(final SubLObject v_object) {
        assert NIL != pph_phrase_output_list_iterator_p(v_object) : "pph_data_structures.pph_phrase_output_list_iterator_p(v_object) " + "CommonSymbols.NIL != pph_data_structures.pph_phrase_output_list_iterator_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_pph_phrase_output_list_iterator(SubLObject arglist) {
        ...
        final SubLObject v_new = new pph_data_structures.$pph_phrase_output_list_iterator_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $generation_template_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(pph_data_structures.$generation_template_native.class, GENERATION_TEMPLATE, GENERATION_TEMPLATE_P, $list11, $list12, new String[]{ "$phrase", "$constraint", "$assertion" }, $list13, $list14, PPRINT_GEN_TEMPLATE);
        }
    }
    ...
    public static final class $pph_phrase_agr_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(pph_data_structures.$pph_phrase_agr_native.class, PPH_PHRASE_AGR, PPH_PHRASE_AGR_P, $list47, $list48, new String[]{ "$absolute_constraint", "$relative_constraint" }, $list49, $list50, PPRINT_PPH_PHRASE_AGR);
        }
    }
    ...
    public static final class $paraphrase_phrase_info_bundle_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(pph_data_structures.$paraphrase_phrase_info_bundle_native.class, PARAPHRASE_PHRASE_INFO_BUNDLE, PARAPHRASE_PHRASE_INFO_BUNDLE_P, $list74, $list75, new String[]{ "$cycl", "$agr", "$justification", "$output_list", "$arg_position_map", "$other" }, $list76, $list77, PPRINT_PPH_PHRASE_INFO_BUNDLE);
        }
    }
    ...
    public static final class $pph_phrase_output_item_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(pph_data_structures.$pph_phrase_output_item_native.class, PPH_PHRASE_OUTPUT_ITEM, PPH_PHRASE_OUTPUT_ITEM_P, $list110, $list111, new String[]{ "$string", "$arg_position", "$cycl", "$html_open_tag", "$html_close_tag", "$agr" }, $list112, $list113, PPRINT_PPH_PHRASE_OUTPUT_ITEM);
        }
    }
    ...
    public static final class $pph_phrase_template_generator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(pph_data_structures.$pph_phrase_template_generator_native.class, PPH_PHRASE_TEMPLATE_GENERATOR, PPH_PHRASE_TEMPLATE_GENERATOR_P, $list189, $list190, new String[]{ "$formula", "$mt", "$focus_arg", "$specified_reln", "$nl_preds", "$doneP", "$search_limit", "$search_level", "$relns_to_use", "$gen_template_sets", "$gen_templates", "$arg_position_map" }, $list191, $list192, PPRINT_PPH_PHRASE_TEMPLATE_GENERATOR);
        }
    }
    ...
    public static final class $pph_phrase_output_list_iterator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(pph_data_structures.$pph_phrase_output_list_iterator_native.class, PPH_PHRASE_OUTPUT_LIST_ITERATOR, PPH_PHRASE_OUTPUT_LIST_ITERATOR_P, $list243, $list244, new String[]{ "$item_queue" }, $list245, $list246, PPRINT_PPH_PHRASE_OUTPUT_LIST_ITERATOR);
        }
    }
