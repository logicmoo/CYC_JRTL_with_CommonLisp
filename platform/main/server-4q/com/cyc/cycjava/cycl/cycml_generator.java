...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class cycml_generator extends SubLTranslatedFile {
    ...
    public static SubLObject cycml_kp_info_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$cycml_kp_info_native.class ? T : NIL;
    }

    public static SubLObject cycml_kp_info_knowledge_package_id(final SubLObject v_object) {
        assert NIL != cycml_kp_info_p(v_object) : "cycml_generator.cycml_kp_info_p error :" + v_object;
    ...
    public static SubLObject make_cycml_kp_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new $cycml_kp_info_native();
        SubLObject next;
    ...
    public static final class $cycml_kp_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($cycml_kp_info_native.class, CYCML_KP_INFO, CYCML_KP_INFO_P, $list29, $list30, new String[]{ "$knowledge_package_id", "$knowledge_package_dependencies", "$operations" }, $list31, $list32, PRINT_CYCML_KP_INFO);
        }
    }
