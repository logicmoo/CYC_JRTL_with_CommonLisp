...
import com.cyc.cycjava.cycl.gke_template_specification;
...
import static com.cyc.cycjava.cycl.gke_template_specification.*;
...
public final class gke_template_specification extends SubLTranslatedFile {
    ...
    public static SubLObject gke_template_specification_p(final SubLObject v_object) {
        return v_object.getClass() == gke_template_specification.$gke_template_specification_native.class ? T : NIL;
    }

    public static SubLObject gts_constant(final SubLObject v_object) {
        assert NIL != gke_template_specification_p(v_object) : "gke_template_specification.gke_template_specification_p(v_object) " + "CommonSymbols.NIL != gke_template_specification.gke_template_specification_p(v_object) " + v_object;
    ...
    public static SubLObject make_gke_template_specification(SubLObject arglist) {
        ...
        final SubLObject v_new = new gke_template_specification.$gke_template_specification_native();
        SubLObject next;
