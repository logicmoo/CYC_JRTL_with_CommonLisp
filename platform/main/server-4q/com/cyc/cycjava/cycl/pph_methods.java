...
public final class pph_methods extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol GENERATE_CONSTANT_DEFAULT = makeSymbol("GENERATE-CONSTANT-DEFAULT");

    public static final SubLSymbol GENERATE_ATOMIC_FORMULA = makeSymbol("GENERATE-ATOMIC-FORMULA");

    public static final SubLSymbol GENERATE_CYCL_LIST = makeSymbol("GENERATE-CYCL-LIST");

    public static final SubLSymbol GENERATE_CYCL_VARIABLE = makeSymbol("GENERATE-CYCL-VARIABLE");

    public static final SubLSymbol GENERATE_NART_AS_NAUT = makeSymbol("GENERATE-NART-AS-NAUT");
    ...
    private static final SubLList $list19 = list(reader_make_constant_shell(makeString("singular")), reader_make_constant_shell(makeString("massNumber")));
    ...
    private static final SubLList $list29 = list(makeKeyword("MODES"), list(reader_make_constant_shell(makeString("ReformulatorMode-Tersify"))));
    ...
    private static final SubLObject $$Instance_TheWord = reader_make_constant_shell(makeString("Instance-TheWord"));
    ...
    private static final SubLList $list55 = list(reader_make_constant_shell(makeString("PhraseFn")), reader_make_constant_shell(makeString("Determiner")));
    ...
    private static final SubLObject $$FacetingCollectionType = reader_make_constant_shell(makeString("FacetingCollectionType"));
    ...
    private static final SubLList $list88 = list(makeKeyword("CODE"), makeSymbol("UNIVERSAL-INTRODUCTION"), list(makeKeyword("BIND"), makeSymbol("VARS")));
    ...
    private static final SubLList $list101 = list(reader_make_constant_shell(makeString("implies")), reader_make_constant_shell(makeString("not")), reader_make_constant_shell(makeString("unknownSentence")));
    ...
    public static final SubLList $list133 = list(makeSymbol("ELEMENT-LIST"), makeSymbol("QUANTITY-LIST"));

    private static final SubLObject $$ElectronicCharge = reader_make_constant_shell(makeString("ElectronicCharge"));

    private static final SubLList $list135 = list(reader_make_constant_shell(makeString("ElementalSubstanceFn")), makeKeyword("FORT"));

    private static final SubLObject $$TheList = reader_make_constant_shell(makeString("TheList"));

    private static final SubLList $list137 = list(list(reader_make_constant_shell(makeString("TheList")), ONE_INTEGER));

    public static final SubLList $list138 = list(makeSymbol("?ELEMENTS"), makeSymbol("?QUANTITIES"));

    private static final SubLObject $$completeAtomicComposition_List = reader_make_constant_shell(makeString("completeAtomicComposition-List"));
    ...
    private static final SubLObject $$chargeOfObject = reader_make_constant_shell(makeString("chargeOfObject"));
    ...
    private static final SubLObject $$moleculesOfCompoundType = reader_make_constant_shell(makeString("moleculesOfCompoundType"));

    private static final SubLList $list146 = list(makeSymbol("?MOLECULE-TYPE"));

    private static final SubLObject $$ChemicalSubstanceFn = reader_make_constant_shell(makeString("ChemicalSubstanceFn"));
    ...
    private static final SubLList $list176 = list(reader_make_constant_shell(makeString("nonSingular-Generic")), reader_make_constant_shell(makeString("properNameStrings")));

    private static final SubLList $list177 = list(reader_make_constant_shell(makeString("plural-Generic")));

    public static final SubLList $list178 = list(reader_make_constant_shell(makeString("singular-Generic")));

    public static final SubLList $list179 = list(reader_make_constant_shell(makeString("massNumber-Generic")));
    ...
    private static final SubLObject $$abbreviationString = reader_make_constant_shell(makeString("abbreviationString"));
    ...
    private static final SubLObject $$ChemicalSubstanceType = reader_make_constant_shell(makeString("ChemicalSubstanceType"));
    ...
    private static final SubLObject $$Artifact_Generic = reader_make_constant_shell(makeString("Artifact-Generic"));

    private static final SubLList $list229 = list(new SubLObject[]{ reader_make_constant_shell(makeString("middleName")), reader_make_constant_shell(makeString("scientificName")), reader_make_constant_shell(makeString("nicknames")), reader_make_constant_shell(makeString("firstName")), reader_make_constant_shell(makeString("givenNames")), reader_make_constant_shell(makeString("familyName")), reader_make_constant_shell(makeString("formerName")), reader_make_constant_shell(makeString("placeName-LocalLongForm")), reader_make_constant_shell(makeString("placeName-LocalShortForm")), reader_make_constant_shell(makeString("countryName-LocalLongForm")), reader_make_constant_shell(makeString("countryName-LocalShortForm")), reader_make_constant_shell(makeString("epistleAddresseeText")), reader_make_constant_shell(makeString("abbreviationString-PN")), reader_make_constant_shell(makeString("internetCountryCode")), reader_make_constant_shell(makeString("countryCodeDigraph")), reader_make_constant_shell(makeString("geopoliticalEntityCodeDigraph")) });
    ...
    private static final SubLList $list233 = list(reader_make_constant_shell(makeString("prettyString-Canonical")), reader_make_constant_shell(makeString("prettyString")));
    ...
    private static final SubLObject $$MultiplicationSign_TheSymbol = reader_make_constant_shell(makeString("MultiplicationSign-TheSymbol"));
    ...
    private static final SubLObject $$imageURLPathname = reader_make_constant_shell(makeString("imageURLPathname"));
    ...
    private static final SubLList $list298 = list(makeKeyword("SELF"));
    ...
    public static final SubLList $list302 = list(makeSymbol("?DATE"));

    private static final SubLObject $$endingDate = reader_make_constant_shell(makeString("endingDate"));

    private static final SubLList $list304 = list(reader_make_constant_shell(makeString("TimeIntervalInclusiveFn")), list(makeKeyword("BIND"), makeSymbol("START-DATE")), list(makeKeyword("BIND"), makeSymbol("END-DATE")));
    ...
    private static final SubLList $list309 = list(reader_make_constant_shell(makeString("SomeTimeInIntervalFn")), list(reader_make_constant_shell(makeString("TimeIntervalBetweenFn")), list(makeKeyword("BIND"), makeSymbol("START-DATE")), list(makeKeyword("BIND"), makeSymbol("END-DATE"))), list(makeKeyword("BIND"), makeSymbol("GUID")));
    ...
    private static final SubLList $list314 = list(reader_make_constant_shell(makeString("SomeTimeInIntervalFn")), list(reader_make_constant_shell(makeString("IntervalEndedByFn")), list(makeKeyword("BIND"), makeSymbol("DATE"))), makeKeyword("ANYTHING"));
    ...
    private static final SubLObject $$TKBSourceSpindleHeadMt = reader_make_constant_shell(makeString("TKBSourceSpindleHeadMt"));
    ...
    public static final SubLList $list328 = list(makeSymbol("PPH-TEST-CASE-TABLES"));
    ...
    private static final SubLList $list332 = list(list(list(reader_make_constant_shell(makeString("CIAWorldFactbook1995Mt"))), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1994))), list(list(list(reader_make_constant_shell(makeString("MtSpace")), reader_make_constant_shell(makeString("BaseKB")), list(reader_make_constant_shell(makeString("MtTimeDimFn")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1994))))), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1994))));
    ...
    private static final SubLList $list336 = list(reader_make_constant_shell(makeString("SomeTimeInIntervalFn")), list(reader_make_constant_shell(makeString("IntervalEndedByFn")), list(makeKeyword("BIND"), makeSymbol("END-DATE"))), makeKeyword("ANYTHING"));
    ...
    private static final SubLList $list343 = list(reader_make_constant_shell(makeString("DaysDuration")), ONE_INTEGER);
    ...
    private static final SubLList $list346 = list(reader_make_constant_shell(makeString("YearsDuration")), ONE_INTEGER);
    ...
    public static final SubLList $list349 = list(list(list(list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1956)))), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1956)))), list(list(list(reader_make_constant_shell(makeString("SecondFn")), SIXTEEN_INTEGER, list(reader_make_constant_shell(makeString("MinuteFn")), makeInteger(42), list(reader_make_constant_shell(makeString("HourFn")), TWENTY_INTEGER, list(reader_make_constant_shell(makeString("DayFn")), ELEVEN_INTEGER, list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("August")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2004)))))))), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("August")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2004)))), list(list(list(reader_make_constant_shell(makeString("DecadeFn")), makeInteger(198))), list(reader_make_constant_shell(makeString("DecadeFn")), makeInteger(198))));

    private static final SubLObject $$genWithGloss = reader_make_constant_shell(makeString("genWithGloss"));
    ...
    private static final SubLList $list362 = list(reader_make_constant_shell(makeString("Collection")), reader_make_constant_shell(makeString("Relation")), reader_make_constant_shell(makeString("GAFGathering")), reader_make_constant_shell(makeString("StringBasedSearching")), reader_make_constant_shell(makeString("ObtainingAStringBasedSearchResult")), reader_make_constant_shell(makeString("LexicalItem")), reader_make_constant_shell(makeString("SKSSchema-LogicalOrPhysical")));
    ...
    public static final SubLList $list369 = list(reader_make_constant_shell(makeString("FirstPerson-NLAttr")), reader_make_constant_shell(makeString("Plural-NLAttr")), reader_make_constant_shell(makeString("Ungendered-NLAttr")));
    ...
    private static final SubLList $list375 = list(reader_make_constant_shell(makeString("Individual")));
    ...
    private static final SubLObject $$languageUsesGrammaticalGender = reader_make_constant_shell(makeString("languageUsesGrammaticalGender"));
    ...
    private static final SubLList $list395 = list(reader_make_constant_shell(makeString("EnglishLanguage")));

    private static final SubLObject $$LanguageDialect = reader_make_constant_shell(makeString("LanguageDialect"));

    private static final SubLObject $$dialects = reader_make_constant_shell(makeString("dialects"));
    ...
    private static final SubLObject $$defaultGrammaticalGender = reader_make_constant_shell(makeString("defaultGrammaticalGender"));
    ...
    private static final SubLObject $$ConceptualWorkSeries = reader_make_constant_shell(makeString("ConceptualWorkSeries"));

    private static final SubLObject $$licensedGrammaticalGender = reader_make_constant_shell(makeString("licensedGrammaticalGender"));
    ...
    public static SubLObject declare_pph_methods_file() {
        declareFunction(me, "funcall_pph_method", "FUNCALL-PPH-METHOD", 2, 0, false);
        declareFunction(me, "generate_skolem_term_with_name", "GENERATE-SKOLEM-TERM-WITH-NAME", 1, 0, false);
        declareFunction(me, "clear_generate_skolem_name", "CLEAR-GENERATE-SKOLEM-NAME", 0, 0, false);
        declareFunction(me, "remove_generate_skolem_name", "REMOVE-GENERATE-SKOLEM-NAME", 1, 0, false);
        declareFunction(me, "generate_skolem_name_internal", "GENERATE-SKOLEM-NAME-INTERNAL", 1, 0, false);
        declareFunction(me, "generate_skolem_name", "GENERATE-SKOLEM-NAME", 1, 0, false);
        declareFunction(me, "pph_capitalize_smart", "PPH-CAPITALIZE-SMART", 1, 0, false);
        declareFunction(me, "generate_skolem_term_existentially", "GENERATE-SKOLEM-TERM-EXISTENTIALLY", 1, 0, false);
        declareFunction(me, "generate_skolem_term_existentially_int", "GENERATE-SKOLEM-TERM-EXISTENTIALLY-INT", 1, 0, false);
        declareFunction(me, "pph_skolem_nat_find_type", "PPH-SKOLEM-NAT-FIND-TYPE", 1, 0, false);
        declareFunction(me, "pph_min_isa", "PPH-MIN-ISA", 1, 1, false);
        declareFunction(me, "arg_type_is_collection_p", "ARG-TYPE-IS-COLLECTION-P", 2, 0, false);
        declareFunction(me, "generate_hypothetical", "GENERATE-HYPOTHETICAL", 1, 0, false);
        declareFunction(me, "generate_cycl_variable", "GENERATE-CYCL-VARIABLE", 1, 0, false);
        declareFunction(me, "pph_phrase_set_var_arg_position", "PPH-PHRASE-SET-VAR-ARG-POSITION", 2, 1, false);
        declareFunction(me, "pph_phrase_set_var_type_arg_positions", "PPH-PHRASE-SET-VAR-TYPE-ARG-POSITIONS", 3, 0, false);
        declareFunction(me, "pph_phrase_set_var_type_arg_position", "PPH-PHRASE-SET-VAR-TYPE-ARG-POSITION", 3, 0, false);
        declareFunction(me, "pph_phrase_set_arg_position_for_cycl", "PPH-PHRASE-SET-ARG-POSITION-FOR-CYCL", 3, 0, false);
        declareFunction(me, "pph_var_ok_for_lexifyingP", "PPH-VAR-OK-FOR-LEXIFYING?", 1, 1, false);
        declareFunction(me, "pph_paraphrase_var_as_var", "PPH-PARAPHRASE-VAR-AS-VAR", 1, 2, false);
        declareFunction(me, "pph_instance_of_item", "PPH-INSTANCE-OF-ITEM", 1, 0, false);
        declareFunction(me, "pph_maybe_italicize_variable_phrase", "PPH-MAYBE-ITALICIZE-VARIABLE-PHRASE", 1, 0, false);
        declareFunction(me, "pph_italicize_variablesP", "PPH-ITALICIZE-VARIABLES?", 0, 0, false);
        declareFunction(me, "pph_var_phrase_prefix_items", "PPH-VAR-PHRASE-PREFIX-ITEMS", 1, 1, false);
        declareFunction(me, "var_functional_in_matrix_sentenceP", "VAR-FUNCTIONAL-IN-MATRIX-SENTENCE?", 1, 0, false);
        declareFunction(me, "pph_paraphrase_var_with_type", "PPH-PARAPHRASE-VAR-WITH-TYPE", 1, 0, false);
        declareFunction(me, "pph_lexify_var", "PPH-LEXIFY-VAR", 3, 3, false);
        declareFunction(me, "pph_use_other_for_varP", "PPH-USE-OTHER-FOR-VAR?", 1, 0, false);
        declareFunction(me, "pph_var_type_for_lexification", "PPH-VAR-TYPE-FOR-LEXIFICATION", 1, 1, false);
        declareFunction(me, "pph_var_type_for_lexification_internal", "PPH-VAR-TYPE-FOR-LEXIFICATION-INTERNAL", 3, 0, false);
        declareFunction(me, "pph_highly_faceted_typeP", "PPH-HIGHLY-FACETED-TYPE?", 1, 0, false);
        declareFunction(me, "pph_var_arg_position_map", "PPH-VAR-ARG-POSITION-MAP", 1, 0, false);
        declareFunction(me, "determiner_type_for_var_phrase", "DETERMINER-TYPE-FOR-VAR-PHRASE", 1, 0, false);
        declareFunction(me, "pph_var_phrase_var_bound_by_universal_introductionP", "PPH-VAR-PHRASE-VAR-BOUND-BY-UNIVERSAL-INTRODUCTION?", 1, 0, false);
        declareFunction(me, "pph_var_phrase_in_if_clauseP", "PPH-VAR-PHRASE-IN-IF-CLAUSE?", 1, 0, false);
        declareFunction(me, "pph_npi_licensor", "PPH-NPI-LICENSOR", 1, 0, false);
        declareFunction(me, "pph_npi_licensor_int", "PPH-NPI-LICENSOR-INT", 3, 0, false);
        declareFunction(me, "pph_downward_entailing_operator_p", "PPH-DOWNWARD-ENTAILING-OPERATOR-P", 1, 0, false);
        declareFunction(me, "pph_operator_downward_entailing_in_which_arg", "PPH-OPERATOR-DOWNWARD-ENTAILING-IN-WHICH-ARG", 1, 0, false);
        declareFunction(me, "pph_phrase_maybe_add_disambiguation", "PPH-PHRASE-MAYBE-ADD-DISAMBIGUATION", 3, 0, false);
        declareFunction(me, "pph_phrase_maybe_add_other", "PPH-PHRASE-MAYBE-ADD-OTHER", 2, 0, false);
        declareFunction(me, "different_instance_same_typeP", "DIFFERENT-INSTANCE-SAME-TYPE?", 1, 0, false);
        declareFunction(me, "pph_phrase_add_other", "PPH-PHRASE-ADD-OTHER", 1, 0, false);
        declareFunction(me, "pph_phrase_add_english_other", "PPH-PHRASE-ADD-ENGLISH-OTHER", 1, 0, false);
        declareFunction(me, "split_english_determiner_off", "SPLIT-ENGLISH-DETERMINER-OFF", 1, 0, false);
        declareFunction(me, "pph_add_english_other_to_olists", "PPH-ADD-ENGLISH-OTHER-TO-OLISTS", 2, 0, false);
        declareFunction(me, "pph_phrase_maybe_explicitify_var_phrase", "PPH-PHRASE-MAYBE-EXPLICITIFY-VAR-PHRASE", 3, 0, false);
        declareFunction(me, "pph_phrase_explicitify_var_phrase", "PPH-PHRASE-EXPLICITIFY-VAR-PHRASE", 3, 0, false);
        declareFunction(me, "generate_keyword", "GENERATE-KEYWORD", 1, 0, false);
        declareFunction(me, "generate_cycl_symbol", "GENERATE-CYCL-SYMBOL", 1, 0, false);
        declareFunction(me, "generate_non_cycl_symbol", "GENERATE-NON-CYCL-SYMBOL", 1, 0, false);
        declareFunction(me, "generate_constant_default", "GENERATE-CONSTANT-DEFAULT", 1, 0, false);
        declareFunction(me, "generate_lexical_word", "GENERATE-LEXICAL-WORD", 1, 0, false);
        declareFunction(me, "generate_chemical_substance_type", "GENERATE-CHEMICAL-SUBSTANCE-TYPE", 1, 0, false);
        declareFunction(me, "do_generate_chemical_substance_type", "DO-GENERATE-CHEMICAL-SUBSTANCE-TYPE", 1, 0, false);
        declareFunction(me, "generate_chemical_substance_type_from_formula_string", "GENERATE-CHEMICAL-SUBSTANCE-TYPE-FROM-FORMULA-STRING", 2, 0, false);
        declareFunction(me, "pph_chemical_formula_html_output_items", "PPH-CHEMICAL-FORMULA-HTML-OUTPUT-ITEMS", 1, 0, false);
        declareFunction(me, "do_generate_chemical_substance_type_semantic", "DO-GENERATE-CHEMICAL-SUBSTANCE-TYPE-SEMANTIC", 1, 0, false);
        declareFunction(me, "pph_chemical_composition", "PPH-CHEMICAL-COMPOSITION", 1, 0, false);
        declareFunction(me, "pph_electrical_charge_of_substance_type", "PPH-ELECTRICAL-CHARGE-OF-SUBSTANCE-TYPE", 1, 0, false);
        declareFunction(me, "pph_molecule_types", "PPH-MOLECULE-TYPES", 1, 0, false);
        declareFunction(me, "select_string_method_count", "SELECT-STRING-METHOD-COUNT", 1, 0, false);
        declareFunction(me, "select_string_method", "SELECT-STRING-METHOD", 1, 1, false);
        declareFunction(me, "equal_pph_nl_predsP", "EQUAL-PPH-NL-PREDS?", 2, 0, false);
        declareFunction(me, "omit_pph_select_string_method_p", "OMIT-PPH-SELECT-STRING-METHOD-P", 1, 0, false);
        declareFunction(me, "pph_update_phrase_with_method_result", "PPH-UPDATE-PHRASE-WITH-METHOD-RESULT", 9, 0, false);
        declareFunction(me, "pph_demerit_cutoff_for_quality", "PPH-DEMERIT-CUTOFF-FOR-QUALITY", 1, 0, false);
        declareFunction(me, "pph_try_method", "PPH-TRY-METHOD", 5, 0, false);
        declareFunction(me, "pph_process_method_result", "PPH-PROCESS-METHOD-RESULT", 6, 0, false);
        declareFunction(me, "pph_category_for_disambiguation", "PPH-CATEGORY-FOR-DISAMBIGUATION", 2, 0, false);
        declareFunction(me, "pph_filter_method_results", "PPH-FILTER-METHOD-RESULTS", 4, 0, false);
        declareFunction(me, "pph_revised_nl_preds_for_phrase", "PPH-REVISED-NL-PREDS-FOR-PHRASE", 1, 1, false);
        declareFunction(me, "pph_pred_ok_for_qualityP", "PPH-PRED-OK-FOR-QUALITY?", 4, 0, false);
        declareFunction(me, "pph_genl_lexicon_predicateP", "PPH-GENL-LEXICON-PREDICATE?", 2, 0, false);
        declareFunction(me, "select_string_for_term_internal", "SELECT-STRING-FOR-TERM-INTERNAL", 1, 4, false);
        declareFunction(me, "select_string_for_term", "SELECT-STRING-FOR-TERM", 1, 4, false);
        declareFunction(me, "clear_pph_name_string_preds", "CLEAR-PPH-NAME-STRING-PREDS", 0, 0, false);
        declareFunction(me, "remove_pph_name_string_preds", "REMOVE-PPH-NAME-STRING-PREDS", 0, 1, false);
        declareFunction(me, "pph_name_string_preds_internal", "PPH-NAME-STRING-PREDS-INTERNAL", 1, 0, false);
        declareFunction(me, "pph_name_string_preds", "PPH-NAME-STRING-PREDS", 0, 1, false);
        declareFunction(me, "clear_pph_term_string_preds", "CLEAR-PPH-TERM-STRING-PREDS", 0, 0, false);
        declareFunction(me, "remove_pph_term_string_preds", "REMOVE-PPH-TERM-STRING-PREDS", 0, 1, false);
        declareFunction(me, "pph_term_string_preds_internal", "PPH-TERM-STRING-PREDS-INTERNAL", 1, 0, false);
        declareFunction(me, "pph_term_string_preds", "PPH-TERM-STRING-PREDS", 0, 1, false);
        declareFunction(me, "name_string_method", "NAME-STRING-METHOD", 1, 1, false);
        declareFunction(me, "name_string_method_int", "NAME-STRING-METHOD-INT", 3, 1, false);
        declareFunction(me, "pph_name_string_preds_from_nl_pred_specification", "PPH-NAME-STRING-PREDS-FROM-NL-PRED-SPECIFICATION", 1, 0, false);
        declareFunction(me, "pph_name_ok_for_preds_and_cyclP", "PPH-NAME-OK-FOR-PREDS-AND-CYCL?", 4, 0, false);
        declareFunction(me, "pph_name_string_preds_from_nl_preds", "PPH-NAME-STRING-PREDS-FROM-NL-PREDS", 1, 0, false);
        declareFunction(me, "pph_standard_name_string_predP", "PPH-STANDARD-NAME-STRING-PRED?", 1, 0, false);
        declareFunction(me, "clear_pph_enhanced_domain_mt", "CLEAR-PPH-ENHANCED-DOMAIN-MT", 0, 0, false);
        declareFunction(me, "remove_pph_enhanced_domain_mt", "REMOVE-PPH-ENHANCED-DOMAIN-MT", 0, 2, false);
        declareFunction(me, "pph_enhanced_domain_mt_internal", "PPH-ENHANCED-DOMAIN-MT-INTERNAL", 2, 0, false);
        declareFunction(me, "pph_enhanced_domain_mt", "PPH-ENHANCED-DOMAIN-MT", 0, 2, false);
        declareFunction(me, "pph_broaden_language_mt", "PPH-BROADEN-LANGUAGE-MT", 0, 0, false);
        declareFunction(me, "pph_dispreferred_assertionP", "PPH-DISPREFERRED-ASSERTION?", 1, 0, false);
        declareFunction(me, "pph_do_name_string_method", "PPH-DO-NAME-STRING-METHOD", 2, 1, false);
        declareFunction(me, "name_string_gaf_strings_internal", "NAME-STRING-GAF-STRINGS-INTERNAL", 1, 0, false);
        declareFunction(me, "name_string_gaf_strings", "NAME-STRING-GAF-STRINGS", 1, 0, false);
        declareFunction(me, "pph_no_abbreviation_predsP", "PPH-NO-ABBREVIATION-PREDS?", 1, 0, false);
        declareFunction(me, "pph_non_abbreviation_name_predP", "PPH-NON-ABBREVIATION-NAME-PRED?", 1, 0, false);
        declareFunction(me, "clear_pph_methods_caches", "CLEAR-PPH-METHODS-CACHES", 0, 0, false);
        declareFunction(me, "pph_abbreviation_predP", "PPH-ABBREVIATION-PRED?", 1, 1, false);
        declareFunction(me, "clear_pph_abbreviation_preds", "CLEAR-PPH-ABBREVIATION-PREDS", 0, 0, false);
        declareFunction(me, "remove_pph_abbreviation_preds", "REMOVE-PPH-ABBREVIATION-PREDS", 0, 1, false);
        declareFunction(me, "pph_abbreviation_preds_internal", "PPH-ABBREVIATION-PREDS-INTERNAL", 1, 0, false);
        declareFunction(me, "pph_abbreviation_preds", "PPH-ABBREVIATION-PREDS", 0, 1, false);
        declareFunction(me, "any_name_string_method", "ANY-NAME-STRING-METHOD", 1, 1, false);
        declareFunction(me, "name_string_method_non_acronym", "NAME-STRING-METHOD-NON-ACRONYM", 1, 1, false);
        declareFunction(me, "smart_decapitalize", "SMART-DECAPITALIZE", 2, 0, false);
        declareFunction(me, "pph_starts_with_determinerP", "PPH-STARTS-WITH-DETERMINER?", 1, 0, false);
        declareFunction(me, "assume_det_is_part_of_nameP", "ASSUME-DET-IS-PART-OF-NAME?", 1, 0, false);
        declareFunction(me, "pph_sort_name_string_preds", "PPH-SORT-NAME-STRING-PREDS", 1, 0, false);
        declareFunction(me, "pph_prefer_name_string_predP", "PPH-PREFER-NAME-STRING-PRED?", 2, 0, false);
        declareFunction(me, "nl_generation_cache_method", "NL-GENERATION-CACHE-METHOD", 1, 1, false);
        new pph_methods.$nl_generation_cache_method$UnaryFunction();
        new pph_methods.$nl_generation_cache_method$BinaryFunction();
        declareFunction(me, "term_string_method", "TERM-STRING-METHOD", 1, 1, false);
        declareFunction(me, "chemical_formula_method", "CHEMICAL-FORMULA-METHOD", 1, 1, false);
        declareFunction(me, "scientific_name_method", "SCIENTIFIC-NAME-METHOD", 1, 1, false);
        declareFunction(me, "pretty_string_method", "PRETTY-STRING-METHOD", 1, 1, false);
        declareFunction(me, "genitive_paraphrase_method", "GENITIVE-PARAPHRASE-METHOD", 1, 1, false);
        declareFunction(me, "generate_nart_lexified_tight", "GENERATE-NART-LEXIFIED-TIGHT", 1, 0, false);
        declareFunction(me, "generate_nart_lexified_imprecise", "GENERATE-NART-LEXIFIED-IMPRECISE", 1, 0, false);
        declareFunction(me, "pph_nart_methods_to_omit_for_precision", "PPH-NART-METHODS-TO-OMIT-FOR-PRECISION", 1, 0, false);
        declareFunction(me, "generate_nart_lexified", "GENERATE-NART-LEXIFIED", 2, 0, false);
        declareFunction(me, "generate_nart_as_naut", "GENERATE-NART-AS-NAUT", 1, 0, false);
        declareFunction(me, "maybe_adjust_nart_paraphrase_demerits", "MAYBE-ADJUST-NART-PARAPHRASE-DEMERITS", 1, 0, false);
        declareFunction(me, "ok_gen_template_assertion_for_relnP_internal", "OK-GEN-TEMPLATE-ASSERTION-FOR-RELN?-INTERNAL", 2, 1, false);
        declareFunction(me, "ok_gen_template_assertion_for_relnP", "OK-GEN-TEMPLATE-ASSERTION-FOR-RELN?", 2, 1, false);
        declareFunction(me, "generate_universal_date", "GENERATE-UNIVERSAL-DATE", 1, 0, false);
        declareFunction(me, "generate_universal_date_numbers", "GENERATE-UNIVERSAL-DATE-NUMBERS", 1, 0, false);
        declareFunction(me, "generate_universal_second", "GENERATE-UNIVERSAL-SECOND", 1, 1, false);
        declareFunction(me, "generate_float", "GENERATE-FLOAT", 1, 0, false);
        declareFunction(me, "generate_float_items", "GENERATE-FLOAT-ITEMS", 3, 0, false);
        declareFunction(me, "pph_float_string", "PPH-FLOAT-STRING", 1, 1, false);
        declareFunction(me, "pph_standardize_float_string", "PPH-STANDARDIZE-FLOAT-STRING", 1, 1, false);
        declareFunction(me, "generate_integer_wXcommas", "GENERATE-INTEGER-W/COMMAS", 1, 0, false);
        declareFunction(me, "generate_integer_as_word", "GENERATE-INTEGER-AS-WORD", 1, 0, false);
        declareFunction(me, "generate_number_default", "GENERATE-NUMBER-DEFAULT", 1, 0, false);
        declareFunction(me, "pph_ordinal_phrase_p", "PPH-ORDINAL-PHRASE-P", 1, 0, false);
        declareFunction(me, "get_image_url_as_string", "GET-IMAGE-URL-AS-STRING", 1, 0, false);
        declareFunction(me, "generate_image_url", "GENERATE-IMAGE-URL", 1, 0, false);
        declareFunction(me, "generate_princ", "GENERATE-PRINC", 1, 0, false);
        declareFunction(me, "do_generate_princ", "DO-GENERATE-PRINC", 1, 0, false);
        declareFunction(me, "pph_default_mt_time_index", "PPH-DEFAULT-MT-TIME-INDEX", 0, 0, false);
        declareFunction(me, "generate_assertion", "GENERATE-ASSERTION", 1, 0, false);
        declareFunction(me, "pph_find_arg_starting_before", "PPH-FIND-ARG-STARTING-BEFORE", 3, 0, false);
        declareFunction(me, "pph_find_arg_ending_after", "PPH-FIND-ARG-ENDING-AFTER", 3, 0, false);
        declareFunction(me, "pph_time_interval_for_assertion", "PPH-TIME-INTERVAL-FOR-ASSERTION", 1, 0, false);
        declareFunction(me, "pph_ignore_temporal_qualification_for_assertionP", "PPH-IGNORE-TEMPORAL-QUALIFICATION-FOR-ASSERTION?", 2, 0, false);
        declareFunction(me, "pph_irrelevant_date_wrt_assertion_contentP", "PPH-IRRELEVANT-DATE-WRT-ASSERTION-CONTENT?", 2, 0, false);
        declareFunction(me, "pph_indexed_nautP", "PPH-INDEXED-NAUT?", 1, 0, false);
        declareFunction(me, "pph_support_creation_dates_internal", "PPH-SUPPORT-CREATION-DATES-INTERNAL", 1, 0, false);
        declareFunction(me, "pph_support_creation_dates", "PPH-SUPPORT-CREATION-DATES", 1, 0, false);
        declareFunction(me, "pph_support_creation_dates_recursive", "PPH-SUPPORT-CREATION-DATES-RECURSIVE", 2, 0, false);
        declareFunction(me, "pph_mt_time_index", "PPH-MT-TIME-INDEX", 1, 0, false);
        declareFunction(me, "pph_monad_mt_time_precision_suspect_p", "PPH-MONAD-MT-TIME-PRECISION-SUSPECT-P", 1, 0, false);
        declareFunction(me, "pph_adjust_mt_time_index_granularity", "PPH-ADJUST-MT-TIME-INDEX-GRANULARITY", 1, 0, false);
        declareFunction(me, "pph_adjust_mt_date_granularity_internal", "PPH-ADJUST-MT-DATE-GRANULARITY-INTERNAL", 2, 0, false);
        declareFunction(me, "pph_adjust_mt_date_granularity", "PPH-ADJUST-MT-DATE-GRANULARITY", 2, 0, false);
        declareFunction(me, "pph_assertion_has_glossP", "PPH-ASSERTION-HAS-GLOSS?", 1, 0, false);
        declareFunction(me, "pph_gloss_for_assertion", "PPH-GLOSS-FOR-ASSERTION", 2, 0, false);
        declareFunction(me, "pph_output_list_to_assertion_output_list", "PPH-OUTPUT-LIST-TO-ASSERTION-OUTPUT-LIST", 1, 0, false);
        declareFunction(me, "pph_output_list_from_assertion_output_list", "PPH-OUTPUT-LIST-FROM-ASSERTION-OUTPUT-LIST", 2, 0, false);
        declareFunction(me, "assertion_output_list_info_p", "ASSERTION-OUTPUT-LIST-INFO-P", 1, 0, false);
        declareFunction(me, "generate_string", "GENERATE-STRING", 1, 0, false);
        declareFunction(me, "generate_cycl_string_with_html", "GENERATE-CYCL-STRING-WITH-HTML", 1, 0, false);
        declareFunction(me, "generate_cycl_string_with_html_internal", "GENERATE-CYCL-STRING-WITH-HTML-INTERNAL", 1, 1, false);
        declareFunction(me, "generate_cycl_list", "GENERATE-CYCL-LIST", 1, 0, false);
        declareFunction(me, "generate_rop_expression", "GENERATE-ROP-EXPRESSION", 1, 0, false);
        declareFunction(me, "generate_genitive", "GENERATE-GENITIVE", 1, 0, false);
        declareFunction(me, "pph_genitive_cycl", "PPH-GENITIVE-CYCL", 1, 1, false);
        declareFunction(me, "pph_term_ok_for_genitive_paraphraseP", "PPH-TERM-OK-FOR-GENITIVE-PARAPHRASE?", 1, 0, false);
        declareFunction(me, "pph_dont_use_instances_for_genitive_paraphrase", "PPH-DONT-USE-INSTANCES-FOR-GENITIVE-PARAPHRASE", 0, 0, false);
        declareFunction(me, "clear_pph_possessive_preds", "CLEAR-PPH-POSSESSIVE-PREDS", 0, 0, false);
        declareFunction(me, "remove_pph_possessive_preds", "REMOVE-PPH-POSSESSIVE-PREDS", 0, 0, false);
        declareFunction(me, "pph_possessive_preds_internal", "PPH-POSSESSIVE-PREDS-INTERNAL", 0, 0, false);
        declareFunction(me, "pph_possessive_preds", "PPH-POSSESSIVE-PREDS", 0, 0, false);
        declareFunction(me, "pph_find_possessive_sentence_internal", "PPH-FIND-POSSESSIVE-SENTENCE-INTERNAL", 1, 1, false);
        declareFunction(me, "pph_find_possessive_sentence", "PPH-FIND-POSSESSIVE-SENTENCE", 1, 1, false);
        declareFunction(me, "pph_find_possessor", "PPH-FIND-POSSESSOR", 1, 0, false);
        declareFunction(me, "pph_find_possessive_support", "PPH-FIND-POSSESSIVE-SUPPORT", 3, 0, false);
        declareFunction(me, "pph_find_possessed_type", "PPH-FIND-POSSESSED-TYPE", 1, 0, false);
        declareFunction(me, "prefer_unlexified_formP", "PREFER-UNLEXIFIED-FORM?", 1, 0, false);
        declareFunction(me, "prefer_unlexified_form_method", "PREFER-UNLEXIFIED-FORM-METHOD", 1, 1, false);
        declareFunction(me, "use_as_is_method", "USE-AS-IS-METHOD", 1, 1, false);
        declareFunction(me, "coerce_name_method", "COERCE-NAME-METHOD", 1, 1, false);
        declareFunction(me, "licensed_definite_description_method", "LICENSED-DEFINITE-DESCRIPTION-METHOD", 1, 1, false);
        declareFunction(me, "licensed_definite_description_types_for_term", "LICENSED-DEFINITE-DESCRIPTION-TYPES-FOR-TERM", 2, 0, false);
        declareFunction(me, "coerced_definite_description_method", "COERCED-DEFINITE-DESCRIPTION-METHOD", 1, 1, false);
        declareFunction(me, "generate_definite_description_item", "GENERATE-DEFINITE-DESCRIPTION-ITEM", 3, 0, false);
        declareFunction(me, "unlexified_term_method", "UNLEXIFIED-TERM-METHOD", 1, 1, false);
        declareFunction(me, "pph_gender_p_internal", "PPH-GENDER-P-INTERNAL", 1, 1, false);
        declareFunction(me, "pph_gender_p", "PPH-GENDER-P", 1, 1, false);
        declareFunction(me, "pph_gender", "PPH-GENDER", 1, 0, false);
        declareFunction(me, "pph_number", "PPH-NUMBER", 1, 0, false);
        declareFunction(me, "pph_same_genderP", "PPH-SAME-GENDER?", 2, 0, false);
        declareFunction(me, "pph_same_numberP", "PPH-SAME-NUMBER?", 2, 0, false);
        declareFunction(me, "pph_same_gender_and_numberP", "PPH-SAME-GENDER-AND-NUMBER?", 2, 0, false);
        declareFunction(me, "pph_unify_gender", "PPH-UNIFY-GENDER", 2, 0, false);
        declareFunction(me, "pph_unify_number", "PPH-UNIFY-NUMBER", 2, 0, false);
        declareFunction(me, "pph_unify_person", "PPH-UNIFY-PERSON", 2, 0, false);
        declareFunction(me, "pph_gender_of_var", "PPH-GENDER-OF-VAR", 1, 0, false);
        declareFunction(me, "pph_gender_of_var_type", "PPH-GENDER-OF-VAR-TYPE", 2, 0, false);
        declareFunction(me, "pph_language_of_mt", "PPH-LANGUAGE-OF-MT", 1, 0, false);
        declareFunction(me, "pph_english_lexical_mtP", "PPH-ENGLISH-LEXICAL-MT?", 1, 0, false);
        declareFunction(me, "pph_non_english_lexical_mtP", "PPH-NON-ENGLISH-LEXICAL-MT?", 1, 0, false);
        declareFunction(me, "pph_default_grammatical_gender", "PPH-DEFAULT-GRAMMATICAL-GENDER", 0, 0, false);
        declareFunction(me, "pph_default_grammatical_gender_for_language_internal", "PPH-DEFAULT-GRAMMATICAL-GENDER-FOR-LANGUAGE-INTERNAL", 1, 1, false);
        declareFunction(me, "pph_default_grammatical_gender_for_language", "PPH-DEFAULT-GRAMMATICAL-GENDER-FOR-LANGUAGE", 1, 1, false);
        declareFunction(me, "pph_number_of_var", "PPH-NUMBER-OF-VAR", 1, 0, false);
        declareFunction(me, "pph_number_of_term", "PPH-NUMBER-OF-TERM", 1, 0, false);
        declareFunction(me, "pph_number_from_cycl", "PPH-NUMBER-FROM-CYCL", 1, 0, false);
        declareFunction(me, "pph_gender_of_term", "PPH-GENDER-OF-TERM", 1, 1, false);
        declareFunction(me, "adjust_gender_for_top_level_cycl", "ADJUST-GENDER-FOR-TOP-LEVEL-CYCL", 3, 0, false);
        declareFunction(me, "pph_person", "PPH-PERSON", 1, 0, false);
        declareFunction(me, "pph_default_person", "PPH-DEFAULT-PERSON", 0, 0, false);
        return NIL;
    }
