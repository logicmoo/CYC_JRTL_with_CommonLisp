...
import static com.cyc.cycjava.cycl.ranges.*;
...
public final class ranges extends SubLTranslatedFile {
    ...
    public static SubLObject range_p(final SubLObject v_object) {
        return v_object.getClass() == ranges.$range_native.class ? T : NIL;
    }

    public static SubLObject range_type_name(final SubLObject v_object) {
        assert NIL != range_p(v_object) : "ranges.range_p(v_object) " + "CommonSymbols.NIL != ranges.range_p(v_object) " + v_object;
    ...
    public static SubLObject make_range(SubLObject arglist) {
        ...
        final SubLObject v_new = new ranges.$range_native();
        SubLObject next;
    ...
    public static final class $range_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(ranges.$range_native.class, RANGE, RANGE_P, $list13, $list14, new String[]{ "$type_name", "$base_type_predicate", "$enumeration_type", "$low_bound", "$high_bound", "$low_bound_predicate", "$high_bound_predicate", "$low_bound_type", "$high_bound_type" }, $list15, $list16, PRINT_RANGE);
        }
    }
