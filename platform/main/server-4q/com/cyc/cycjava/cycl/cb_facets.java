...
import com.cyc.cycjava.cycl.cb_facets;
...
import static com.cyc.cycjava.cycl.cb_facets.*;
...
public final class cb_facets extends SubLTranslatedFile {
    ...
    public static SubLObject perspective_p(final SubLObject v_object) {
        return v_object.getClass() == cb_facets.$perspective_native.class ? T : NIL;
    }

    public static SubLObject perspective_name(final SubLObject v_object) {
        assert NIL != perspective_p(v_object) : "cb_facets.perspective_p(v_object) " + "CommonSymbols.NIL != cb_facets.perspective_p(v_object) " + v_object;
    ...
    public static SubLObject make_perspective(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_facets.$perspective_native();
        SubLObject next;
    ...
    public static SubLObject perspective_action_p(final SubLObject v_object) {
        return v_object.getClass() == cb_facets.$perspective_action_native.class ? T : NIL;
    }

    public static SubLObject perspective_action_name(final SubLObject v_object) {
        assert NIL != perspective_action_p(v_object) : "cb_facets.perspective_action_p(v_object) " + "CommonSymbols.NIL != cb_facets.perspective_action_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_perspective_action(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_facets.$perspective_action_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $perspective_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(cb_facets.$perspective_native.class, PERSPECTIVE, PERSPECTIVE_P, $list35, $list36, new String[]{ "$name", "$keyword", "$displayP_fn", "$display_fn", "$display_string" }, $list37, $list38, PRINT_PERSPECTIVE);
        }
    }
    ...
    public static final class $perspective_action_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(cb_facets.$perspective_action_native.class, PERSPECTIVE_ACTION, PERSPECTIVE_ACTION_P, $list128, $list129, new String[]{ "$name", "$keyword", "$order_num", "$perspective", "$displayP_fn", "$display_fn", "$handlerP_fn", "$handler_fn" }, $list130, $list131, PRINT_PERSPECTIVE_ACTION);
        }
    }
