...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class cb_partitions extends SubLTranslatedFile {
    ...
    public static SubLObject cb_partition_save_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$cb_partition_save_native.class ? T : NIL;
    }

    public static SubLObject cb_part_save_specified_directory(final SubLObject v_object) {
        assert NIL != cb_partition_save_p(v_object) : "cb_partitions.cb_partition_save_p error :" + v_object;
    ...
    public static final class $cb_partition_save_native extends SubLStructNative {
        ...
        private $cb_partition_save_native() {
        ...
        static {
            structDecl = makeStructDeclNative($cb_partition_save_native.class, CB_PARTITION_SAVE, CB_PARTITION_SAVE_P, $list5, $list6, new String[]{ "$specified_directory", "$personal_directory", "$public_directory", "$filename", "$predefined_methods", "$ontologies", "$quoted_ontologies", "$terms" }, $list7, $list8, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
