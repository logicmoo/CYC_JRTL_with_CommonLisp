...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class psp_rules extends SubLTranslatedFile {
    ...
    public static SubLObject phrase_structure_parser_rule_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$phrase_structure_parser_rule_native.class ? T : NIL;
    }

    public static SubLObject psp_rule_fort(final SubLObject v_object) {
        assert NIL != phrase_structure_parser_rule_p(v_object) : "psp_rules.phrase_structure_parser_rule_p error :" + v_object;
    ...
    public static SubLObject init_psp_rules_file() {
        ...
        deflexical("*PSP-TRACED-RULES*", SubLSystemTrampolineFile.maybeDefault($psp_traced_rules$, $psp_traced_rules$, NIL));
        deflexical("*PSP-SYNTACTIC-CONSTRAINT-TYPES*", SubLSystemTrampolineFile.maybeDefault($psp_syntactic_constraint_types$, $psp_syntactic_constraint_types$, NIL));
        deflexical("*PSP-SEMANTIC-CONSTRAINT-TYPES*", SubLSystemTrampolineFile.maybeDefault($psp_semantic_constraint_types$, $psp_semantic_constraint_types$, NIL));
    ...
    public static final class $phrase_structure_parser_rule_native extends SubLStructNative {
        ...
        private $phrase_structure_parser_rule_native() {
            this.$fort = Lisp.NIL;
            this.$arity = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative($phrase_structure_parser_rule_native.class, PHRASE_STRUCTURE_PARSER_RULE, PHRASE_STRUCTURE_PARSER_RULE_P, $list2, $list3, new String[]{ "$fort", "$arity", "$category", "$head", "$constraints", "$semx", "$weight" }, $list4, $list5, PPRINT_PSP_RULE);
        }
    }
