...
public final class wff_module_datastructures extends SubLTranslatedFile {
    ...
    public static SubLObject wff_module_p(final SubLObject v_object) {
        return v_object.getClass() == wff_module_datastructures.$wff_module_native.class ? T : NIL;
    }

    public static SubLObject wff_mod_name(final SubLObject v_object) {
        assert NIL != wff_module_p(v_object) : "wff_module_datastructures.wff_module_p(v_object) " + "CommonSymbols.NIL != wff_module_datastructures.wff_module_p(v_object) " + v_object;
    ...
    public static SubLObject make_wff_module(SubLObject arglist) {
        ...
        final SubLObject v_new = new wff_module_datastructures.$wff_module_native();
        SubLObject next;
    ...
    public static final class $wff_module_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(wff_module_datastructures.$wff_module_native.class, WFF_MODULE, WFF_MODULE_P, $list2, $list3, new String[]{ "$name", "$plist" }, $list4, $list5, PRINT_WFF_MODULE);
        }
    }
