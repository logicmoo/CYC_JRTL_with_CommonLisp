...
import static com.cyc.cycjava.cycl.bijection.*;
...
public final class bijection extends SubLTranslatedFile {
    ...
    public static SubLObject bijection_p(final SubLObject v_object) {
        return v_object.getClass() == bijection.$bijection_native.class ? T : NIL;
    }

    public static SubLObject bijection_size(final SubLObject v_object) {
        assert NIL != bijection_p(v_object) : "bijection.bijection_p(v_object) " + "CommonSymbols.NIL != bijection.bijection_p(v_object) " + v_object;
    ...
    public static SubLObject make_bijection(SubLObject arglist) {
        ...
        final SubLObject v_new = new bijection.$bijection_native();
        SubLObject next;
    ...
    public static final class $bijection_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(bijection.$bijection_native.class, BIJECTION, BIJECTION_P, $list4, $list5, new String[]{ "$size", "$database", "$inverse_database", "$test" }, $list6, $list7, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
