...
import static com.cyc.cycjava.cycl.unrepresented_terms.*;
...
public final class unrepresented_terms extends SubLTranslatedFile {
    ...
    public static final SubLList $list10 = list(makeSymbol("GET-UNREPRESENTED-TERM-FHT"));
    ...
    public static final SubLList $list21 = list(list(makeSymbol("ID"), makeSymbol("TERM"), makeSymbol("&KEY"), list(makeSymbol("PROGRESS-MESSAGE"), makeString("mapping Cyc unrepresented terms")), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));
    ...
    private static final SubLSymbol $sym62$_USE_FHT_APPROACH_TO_UNREPRESENTED_TERMS__ = makeSymbol("*USE-FHT-APPROACH-TO-UNREPRESENTED-TERMS?*");
    ...
    public static SubLObject declare_unrepresented_terms_file() {
        declareMacro(me, "do_old_unrepresented_terms", "DO-OLD-UNREPRESENTED-TERMS");
        declareMacro(me, "do_new_unrepresented_ids_and_terms", "DO-NEW-UNREPRESENTED-IDS-AND-TERMS");
        declareMacro(me, "do_unrepresented_ids_and_terms", "DO-UNREPRESENTED-IDS-AND-TERMS");
        declareMacro(me, "do_new_unrepresented_terms", "DO-NEW-UNREPRESENTED-TERMS");
        declareMacro(me, "do_kb_unrepresented_terms", "DO-KB-UNREPRESENTED-TERMS");
        declareMacro(me, "do_kb_strings", "DO-KB-STRINGS");
        declareMacro(me, "do_kb_numbers", "DO-KB-NUMBERS");
        declareFunction(me, "setup_unrepresented_term_suid_table", "SETUP-UNREPRESENTED-TERM-SUID-TABLE", 2, 0, false);
        declareFunction(me, "finalize_unrepresented_term_suid_table", "FINALIZE-UNREPRESENTED-TERM-SUID-TABLE", 0, 1, false);
        declareFunction(me, "clear_unrepresented_term_suid_table", "CLEAR-UNREPRESENTED-TERM-SUID-TABLE", 0, 0, false);
        declareFunction(me, "set_next_unrepresented_term_suid", "SET-NEXT-UNREPRESENTED-TERM-SUID", 0, 1, false);
        declareFunction(me, "lookup_unrepresented_term_by_suid_table", "LOOKUP-UNREPRESENTED-TERM-BY-SUID-TABLE", 1, 0, false);
        declareFunction(me, "lookup_unrepresented_term_suid_map", "LOOKUP-UNREPRESENTED-TERM-SUID-MAP", 1, 0, false);
        declareFunction(me, "register_unrepresented_term_suid_table", "REGISTER-UNREPRESENTED-TERM-SUID-TABLE", 2, 0, false);
        declareFunction(me, "deregister_unrepresented_term_suid_table", "DEREGISTER-UNREPRESENTED-TERM-SUID-TABLE", 1, 0, false);
        declareFunction(me, "use_unrepresented_term_fhtP", "USE-UNREPRESENTED-TERM-FHT?", 0, 0, false);
        declareFunction(me, "get_unrepresented_term_fht", "GET-UNREPRESENTED-TERM-FHT", 0, 0, false);
        declareFunction(me, "get_unrepresented_term_change_set", "GET-UNREPRESENTED-TERM-CHANGE-SET", 0, 0, false);
        declareFunction(me, "new_unrepresented_terms_iterator", "NEW-UNREPRESENTED-TERMS-ITERATOR", 0, 0, false);
        declareFunction(me, "construct_unrepresented_terms_fht_based_iterator", "CONSTRUCT-UNREPRESENTED-TERMS-FHT-BASED-ITERATOR", 0, 0, false);
        declareFunction(me, "do_unrepresented_terms_table", "DO-UNREPRESENTED-TERMS-TABLE", 0, 0, false);
        declareFunction(me, "map_unrepresented_terms", "MAP-UNREPRESENTED-TERMS", 1, 0, false);
        declareFunction(me, "new_new_unrepresented_terms_iterator", "NEW-NEW-UNREPRESENTED-TERMS-ITERATOR", 0, 0, false);
        declareFunction(me, "new_unrepresented_terms_table_entryP", "NEW-UNREPRESENTED-TERMS-TABLE-ENTRY?", 2, 0, false);
        declareFunction(me, "unrepresented_terms_table_tuple_to_unrepresented_term", "UNREPRESENTED-TERMS-TABLE-TUPLE-TO-UNREPRESENTED-TERM", 1, 0, false);
        declareFunction(me, "deleted_unrepresented_term_id_iterator", "DELETED-UNREPRESENTED-TERM-ID-ITERATOR", 0, 0, false);
        declareFunction(me, "has_new_unrepresented_termsP", "HAS-NEW-UNREPRESENTED-TERMS?", 0, 0, false);
        declareFunction(me, "kb_unrepresented_term_count", "KB-UNREPRESENTED-TERM-COUNT", 0, 0, false);
        declareFunction(me, "new_unrepresented_term_id_threshold", "NEW-UNREPRESENTED-TERM-ID-THRESHOLD", 0, 0, false);
        declareFunction(me, "set_new_unrepresented_term_id_threshold", "SET-NEW-UNREPRESENTED-TERM-ID-THRESHOLD", 1, 0, false);
        declareFunction(me, "old_unrepresented_term_count", "OLD-UNREPRESENTED-TERM-COUNT", 0, 0, false);
        declareFunction(me, "new_unrepresented_term_count", "NEW-UNREPRESENTED-TERM-COUNT", 0, 0, false);
        declareFunction(me, "compute_kb_unrepresented_term_count_fht", "COMPUTE-KB-UNREPRESENTED-TERM-COUNT-FHT", 0, 1, false);
        declareFunction(me, "get_kb_unrepresented_term_old_space_size", "GET-KB-UNREPRESENTED-TERM-OLD-SPACE-SIZE", 0, 0, false);
        declareFunction(me, "get_kb_unrepresented_term_raw_new_space_size", "GET-KB-UNREPRESENTED-TERM-RAW-NEW-SPACE-SIZE", 0, 0, false);
        declareFunction(me, "get_kb_unrepresented_term_max_suid", "GET-KB-UNREPRESENTED-TERM-MAX-SUID", 0, 0, false);
        declareFunction(me, "lookup_unrepresented_term_by_suid", "LOOKUP-UNREPRESENTED-TERM-BY-SUID", 1, 0, false);
        declareFunction(me, "lookup_unrepresented_term_suid", "LOOKUP-UNREPRESENTED-TERM-SUID", 1, 0, false);
        declareFunction(me, "find_unrepresented_term_by_suid", "FIND-UNREPRESENTED-TERM-BY-SUID", 1, 0, false);
        declareFunction(me, "unrepresented_term_suid", "UNREPRESENTED-TERM-SUID", 1, 0, false);
        declareFunction(me, "kb_unrepresented_term_p", "KB-UNREPRESENTED-TERM-P", 1, 0, false);
        declareFunction(me, "register_unrepresented_term_suid", "REGISTER-UNREPRESENTED-TERM-SUID", 2, 0, false);
        declareFunction(me, "register_unrepresented_term_suid_new", "REGISTER-UNREPRESENTED-TERM-SUID-NEW", 4, 0, false);
        declareFunction(me, "deregister_unrepresented_term_suid", "DEREGISTER-UNREPRESENTED-TERM-SUID", 1, 0, false);
        declareFunction(me, "make_unrepresented_term_suid", "MAKE-UNREPRESENTED-TERM-SUID", 0, 0, false);
        declareFunction(me, "next_unrepresented_term_suid", "NEXT-UNREPRESENTED-TERM-SUID", 0, 0, false);
        declareFunction(me, "find_or_create_unrepresented_term_suid", "FIND-OR-CREATE-UNREPRESENTED-TERM-SUID", 1, 0, false);
        declareFunction(me, "finalize_unrepresented_terms", "FINALIZE-UNREPRESENTED-TERMS", 0, 1, false);
        declareFunction(me, "unrepresented_term_index", "UNREPRESENTED-TERM-INDEX", 1, 0, false);
        declareFunction(me, "unrepresented_term_index_swapped_inP", "UNREPRESENTED-TERM-INDEX-SWAPPED-IN?", 1, 0, false);
        declareFunction(me, "setup_unrepresented_term_table", "SETUP-UNREPRESENTED-TERM-TABLE", 2, 0, false);
        declareFunction(me, "clear_unrepresented_term_table", "CLEAR-UNREPRESENTED-TERM-TABLE", 0, 0, false);
        declareFunction(me, "reset_unrepresented_term_index", "RESET-UNREPRESENTED-TERM-INDEX", 2, 1, false);
        declareFunction(me, "clear_unrepresented_term_index", "CLEAR-UNREPRESENTED-TERM-INDEX", 1, 0, false);
        declareFunction(me, "remove_unrepresented_term_index", "REMOVE-UNREPRESENTED-TERM-INDEX", 1, 0, false);
        declareFunction(me, "unrepresented_term_dump_id", "UNREPRESENTED-TERM-DUMP-ID", 1, 0, false);
        declareFunction(me, "find_unrepresented_term_by_dump_id", "FIND-UNREPRESENTED-TERM-BY-DUMP-ID", 1, 0, false);
        declareMacro(me, "with_unrepresented_term_dump_id_table", "WITH-UNREPRESENTED-TERM-DUMP-ID-TABLE");
        declareFunction(me, "create_unrepresented_term_dump_id_table", "CREATE-UNREPRESENTED-TERM-DUMP-ID-TABLE", 0, 0, false);
        declareFunction(me, "create_unrepresented_term_dump_id_table_fht", "CREATE-UNREPRESENTED-TERM-DUMP-ID-TABLE-FHT", 0, 0, false);
        declareFunction(me, "new_fht_term_item", "NEW-FHT-TERM-ITEM", 0, 0, false);
        declareFunction(me, "new_fht_suid_item", "NEW-FHT-SUID-ITEM", 0, 0, false);
        declareFunction(me, "fht_term_item_p", "FHT-TERM-ITEM-P", 1, 0, false);
        declareFunction(me, "fht_suid_item_p", "FHT-SUID-ITEM-P", 1, 0, false);
        declareFunction(me, "get_fht_term_item_term", "GET-FHT-TERM-ITEM-TERM", 1, 0, false);
        declareFunction(me, "get_fht_suid_item_suid", "GET-FHT-SUID-ITEM-SUID", 1, 0, false);
        declareFunction(me, "set_fht_term_item", "SET-FHT-TERM-ITEM", 2, 0, false);
        declareFunction(me, "set_fht_suid_item", "SET-FHT-SUID-ITEM", 2, 0, false);
        declareFunction(me, "deleted_unrepresented_term_itemP", "DELETED-UNREPRESENTED-TERM-ITEM?", 1, 0, false);
        declareFunction(me, "is_unrepresented_term_tombstoneP", "IS-UNREPRESENTED-TERM-TOMBSTONE?", 1, 0, false);
        declareFunction(me, "create_unrepresented_term_fht", "CREATE-UNREPRESENTED-TERM-FHT", 1, 0, false);
        declareFunction(me, "initialize_unrepresented_term_caches", "INITIALIZE-UNREPRESENTED-TERM-CACHES", 0, 0, false);
        declareFunction(me, "initialize_unrepresented_term_cache_fht", "INITIALIZE-UNREPRESENTED-TERM-CACHE-FHT", 1, 0, false);
        declareFunction(me, "reconnect_unrepresented_term_fht", "RECONNECT-UNREPRESENTED-TERM-FHT", 1, 0, false);
        declareFunction(me, "setup_unrepresented_term_fht_new_space", "SETUP-UNREPRESENTED-TERM-FHT-NEW-SPACE", 1, 0, false);
        declareFunction(me, "clear_unrepresented_term_fht", "CLEAR-UNREPRESENTED-TERM-FHT", 0, 0, false);
        declareFunction(me, "lookup_unrepresented_term_by_suid_fht", "LOOKUP-UNREPRESENTED-TERM-BY-SUID-FHT", 1, 0, false);
        declareFunction(me, "lookup_unrepresented_term_suid_fht", "LOOKUP-UNREPRESENTED-TERM-SUID-FHT", 1, 0, false);
        declareFunction(me, "get_unrepresented_term_min_new_suid", "GET-UNREPRESENTED-TERM-MIN-NEW-SUID", 0, 0, false);
        declareFunction(me, "is_unrepresented_term_suid_old_spaceP", "IS-UNREPRESENTED-TERM-SUID-OLD-SPACE?", 1, 0, false);
        declareFunction(me, "register_unrepresented_term_suid_fht", "REGISTER-UNREPRESENTED-TERM-SUID-FHT", 2, 0, false);
        declareFunction(me, "deregister_unrepresented_term_suid_fht", "DEREGISTER-UNREPRESENTED-TERM-SUID-FHT", 1, 0, false);
        declareFunction(me, "get_unrepresented_term_new_space_suid_keys", "GET-UNREPRESENTED-TERM-NEW-SPACE-SUID-KEYS", 0, 0, false);
        declareFunction(me, "get_unrepresented_term_new_space_ascending_suid_keys", "GET-UNREPRESENTED-TERM-NEW-SPACE-ASCENDING-SUID-KEYS", 0, 0, false);
        return NIL;
    }
    ...
    public static SubLObject setup_unrepresented_terms_file() {
        ...
        declare_defglobal($sym62$_USE_FHT_APPROACH_TO_UNREPRESENTED_TERMS__);
