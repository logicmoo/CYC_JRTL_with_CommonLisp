...
import com.cyc.cycjava.cycl.rkf_collaborator_scoop;
...
import static com.cyc.cycjava.cycl.rkf_collaborator_scoop.*;
...
public final class rkf_collaborator_scoop extends SubLTranslatedFile {
    ...
    public static SubLObject scoop_session_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_collaborator_scoop.$scoop_session_native.class ? T : NIL;
    }

    public static SubLObject scoop_session_machine(final SubLObject v_object) {
        assert NIL != scoop_session_p(v_object) : "rkf_collaborator_scoop.scoop_session_p(v_object) " + "CommonSymbols.NIL != rkf_collaborator_scoop.scoop_session_p(v_object) " + v_object;
    ...
    public static SubLObject make_scoop_session(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_collaborator_scoop.$scoop_session_native();
        SubLObject next;
    ...
    public static final class $scoop_session_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_collaborator_scoop.$scoop_session_native.class, SCOOP_SESSION, SCOOP_SESSION_P, $list150, $list151, new String[]{ "$machine", "$port", "$tcp_server", "$initialized_p" }, $list152, $list153, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
