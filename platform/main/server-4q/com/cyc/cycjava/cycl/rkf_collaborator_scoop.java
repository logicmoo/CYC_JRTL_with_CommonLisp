...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class rkf_collaborator_scoop extends SubLTranslatedFile {
    ...
    public static SubLObject init_rkf_collaborator_scoop_file() {
        ...
        deflexical("*SCOOP-DEFINITIONS*", SubLSystemTrampolineFile.maybeDefault($scoop_definitions$, $scoop_definitions$, NIL));
        deflexical("*SCOOP-MEMBERS*", SubLSystemTrampolineFile.maybeDefault($scoop_members$, $scoop_members$, NIL));
