...
public final class standard_tokenization extends SubLTranslatedFile {
    ...
    public static SubLObject dot_analysis_p(final SubLObject v_object) {
        return v_object.getClass() == standard_tokenization.$dot_analysis_native.class ? T : NIL;
    }

    public static SubLObject dot_analysis_found(final SubLObject v_object) {
        assert NIL != dot_analysis_p(v_object) : "standard_tokenization.dot_analysis_p(v_object) " + "CommonSymbols.NIL != standard_tokenization.dot_analysis_p(v_object) " + v_object;
    ...
    public static SubLObject make_dot_analysis(SubLObject arglist) {
        ...
        final SubLObject v_new = new standard_tokenization.$dot_analysis_native();
        SubLObject next;
    ...
    public static final class $dot_analysis_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(standard_tokenization.$dot_analysis_native.class, DOT_ANALYSIS, DOT_ANALYSIS_P, $list11, $list12, new String[]{ "$found", "$remains", "$accumulator", "$state" }, $list13, $list14, PPRINT_DOT_ANALYSIS);
        }
    }
