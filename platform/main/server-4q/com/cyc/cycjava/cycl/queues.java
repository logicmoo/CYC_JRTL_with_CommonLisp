...
public final class queues extends SubLTranslatedFile {
    ...
    public static SubLObject queue_p(final SubLObject v_object) {
        return v_object.getClass() == queues.$queue_native.class ? T : NIL;
    }

    public static SubLObject q_num(final SubLObject v_object) {
        assert NIL != queue_p(v_object) : "queues.queue_p(v_object) " + "CommonSymbols.NIL != queues.queue_p(v_object) " + v_object;
    ...
    public static SubLObject make_queue(SubLObject arglist) {
        ...
        final SubLObject v_new = new queues.$queue_native();
        SubLObject next;
    ...
    public static SubLObject priority_queue_p(final SubLObject v_object) {
        return v_object.getClass() == queues.$priority_queue_native.class ? T : NIL;
    }

    public static SubLObject p_queue_num(final SubLObject v_object) {
        assert NIL != priority_queue_p(v_object) : "queues.priority_queue_p(v_object) " + "CommonSymbols.NIL != queues.priority_queue_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_priority_queue(SubLObject arglist) {
        ...
        final SubLObject v_new = new queues.$priority_queue_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject lazy_priority_queue_p(final SubLObject v_object) {
        return v_object.getClass() == queues.$lazy_priority_queue_native.class ? T : NIL;
    }

    public static SubLObject lazy_p_queue_ordered_items(final SubLObject v_object) {
        assert NIL != lazy_priority_queue_p(v_object) : "queues.lazy_priority_queue_p(v_object) " + "CommonSymbols.NIL != queues.lazy_priority_queue_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_lazy_priority_queue(SubLObject arglist) {
        ...
        final SubLObject v_new = new queues.$lazy_priority_queue_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject locked_queue_p(final SubLObject v_object) {
        return v_object.getClass() == queues.$locked_queue_native.class ? T : NIL;
    }

    public static SubLObject locked_queue_lock(final SubLObject v_object) {
        assert NIL != locked_queue_p(v_object) : "queues.locked_queue_p(v_object) " + "CommonSymbols.NIL != queues.locked_queue_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_locked_queue(SubLObject arglist) {
        ...
        final SubLObject v_new = new queues.$locked_queue_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject locked_p_queue_p(final SubLObject v_object) {
        return v_object.getClass() == queues.$locked_p_queue_native.class ? T : NIL;
    }

    public static SubLObject lp_queue_lock(final SubLObject v_object) {
        assert NIL != locked_p_queue_p(v_object) : "queues.locked_p_queue_p(v_object) " + "CommonSymbols.NIL != queues.locked_p_queue_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_locked_p_queue(SubLObject arglist) {
        ...
        final SubLObject v_new = new queues.$locked_p_queue_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $queue_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(queues.$queue_native.class, QUEUE, QUEUE_P, $list2, $list3, new String[]{ "$num", "$elements", "$last" }, $list4, $list5, PRINT_QUEUE);
        }
    }
    ...
    public static final class $priority_queue_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(queues.$priority_queue_native.class, PRIORITY_QUEUE, PRIORITY_QUEUE_P, $list50, $list51, new String[]{ "$num", "$max_size", "$rank_func", "$comp_func", "$tree" }, $list52, $list53, PRINT_P_QUEUE);
        }
    }
    ...
    public static final class $lazy_priority_queue_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(queues.$lazy_priority_queue_native.class, LAZY_PRIORITY_QUEUE, LAZY_PRIORITY_QUEUE_P, $list86, $list87, new String[]{ "$ordered_items", "$new_items" }, $list88, $list89, PRINT_LAZY_P_QUEUE);
        }
    }
    ...
    public static final class $locked_queue_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(queues.$locked_queue_native.class, LOCKED_QUEUE, LOCKED_QUEUE_P, $list107, $list108, new String[]{ "$lock", "$queue" }, $list109, $list110, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $locked_p_queue_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(queues.$locked_p_queue_native.class, LOCKED_P_QUEUE, LOCKED_P_QUEUE_P, $list125, $list126, new String[]{ "$lock", "$priority_queue" }, $list127, $list128, PRINT_LP_QUEUE);
        }
    }
