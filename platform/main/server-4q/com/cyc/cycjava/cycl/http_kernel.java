...
public final class http_kernel extends SubLTranslatedFile implements V12 {
 ...
 public static final String myName = "com.cyc.cycjava.cycl.http_kernel";
    ...
    public static final SubLObject http_file_request_headers_alt(SubLObject filename) {
        {
            ...
            return listS(bq_cons($str_alt42$Last_Modified, last_modified_string), new SubLObject[]{ $list_alt43, bq_cons($str_alt44$Content_Length, content_length), $list_alt45, $list_alt46, bq_cons($str_alt26$Content_Type, content_type), append(NIL != expires ? ((SubLObject) (list(bq_cons($$$Expires, expires)))) : NIL, NIL) });
        }
    }
    ...
    public static final SubLObject http_file_request_expires_alt(SubLObject content_type) {
        {
            ...
            if (NIL != string_utilities.starts_with(content_type, $str_alt48$image_)) {
                ...
                if (((NIL != $allow_css_js_expires_headers$.getDynamicValue(thread)) && (NIL != string_utilities.starts_with(content_type, $str_alt49$text_))) && ((NIL != string_utilities.ends_with(content_type, $$$css, UNPROVIDED)) || (NIL != string_utilities.ends_with(content_type, $$$javascript, UNPROVIDED)))) {
        ...
        }
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                ...
                }
                {
                    ...
                    return cconcatenate($str_alt62$http___, new SubLObject[]{ format_nil.format_nil_a_no_copy(forwarding_machine), format_nil.format_nil_a_no_copy(NIL != port ? ((SubLObject) (cconcatenate($str_alt63$_, format_nil.format_nil_a_no_copy(forwarding_port)))) : $str_alt36$), $str_alt64$_ });
                }
            }
        }
    }
    ...
    static private final SubLList $list_alt52 = list(list(makeString("text/html"), list(makeString("html"), makeString("htm"), makeString("shtml"))), list(makeString("text/plain"), list(makeString("txt"), makeString("text"))), list(makeString("image/gif"), list(makeString("gif"))), list(makeString("image/jpeg"), list(makeString("jpeg"), makeString("jpg"), makeString("jpe"), makeString("jfif"), makeString("pjpeg"), makeString("pjp"))), list(makeString("image/png"), list(makeString("png"))), list(makeString("application/x-java-jnlp-file"), list(makeString("jnlp"))), list(makeString("text/css"), list(makeString("css"))), list(makeString("text/javascript"), list(makeString("js"))));
    ...
    static private final SubLList $list_alt78 = list(list(list(makeString("/cgi-bin/ws/xml-term-learner-create-new?termString0=hissentient&url=http%3A%2F%2Flocalhost%3A3742%2Fcgi-bin%2Fcg%3Fcb-content-frame%26c3096&title=GAF index for #$CityOfChristchurchNZ&argpos=(1)")), makeString("xml-term-learner-create-new&termString0=hissentient&url=http%3A%2F%2Flocalhost%3A3742%2Fcgi-bin%2Fcg%3Fcb-content-frame%26c3096&title=GAF index for #$CityOfChristchurchNZ&argpos=(1)")), list(list(makeString("/cgi-bin/ws/xml-term-learner-get-followups-for-term&max=1&questionsOnly=true&conceptId=Mx4rvVixTpwpEbGdrcN5Y29ycA")), makeString("xml-term-learner-get-followups-for-term&max=1&questionsOnly=true&conceptId=Mx4rvVixTpwpEbGdrcN5Y29ycA")), list(list(makeString("/cgi-bin/cg?cb-content-frame&c3096")), makeString("cb-content-frame&c3096")));
