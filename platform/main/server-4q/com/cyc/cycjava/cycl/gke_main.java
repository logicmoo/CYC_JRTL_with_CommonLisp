...
import com.cyc.cycjava.cycl.gke_main;
...
import static com.cyc.cycjava.cycl.gke_main.*;
...
public final class gke_main extends SubLTranslatedFile {
    ...
    public static SubLObject replacement_tree_p(final SubLObject v_object) {
        return v_object.getClass() == gke_main.$replacement_tree_native.class ? T : NIL;
    }

    public static SubLObject r_tree_root(final SubLObject v_object) {
        assert NIL != replacement_tree_p(v_object) : "gke_main.replacement_tree_p(v_object) " + "CommonSymbols.NIL != gke_main.replacement_tree_p(v_object) " + v_object;
    ...
    public static SubLObject make_replacement_tree(SubLObject arglist) {
        ...
        final SubLObject v_new = new gke_main.$replacement_tree_native();
        SubLObject next;
    ...
    public static final class $replacement_tree_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(gke_main.$replacement_tree_native.class, REPLACEMENT_TREE, REPLACEMENT_TREE_P, $list143, $list144, new String[]{ "$root", "$children" }, $list145, $list146, PRINT_REPLACEMENT_TREE);
        }
    }
