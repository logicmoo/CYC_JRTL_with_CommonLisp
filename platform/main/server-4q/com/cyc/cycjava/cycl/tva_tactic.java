...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class tva_tactic extends SubLTranslatedFile {
    ...
    public static SubLObject tva_tactic_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$tva_tactic_native.class ? T : NIL;
    }

    public static SubLObject tva_type(final SubLObject v_object) {
        assert NIL != tva_tactic_p(v_object) : "tva_tactic.tva_tactic_p error :" + v_object;
    ...
    public static final class $tva_tactic_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($tva_tactic_native.class, TVA_TACTIC, TVA_TACTIC_P, $list2, $list3, new String[]{ "$type", "$tva_pred", "$index_pred", "$transitive_pred", "$argnum", "$term", "$cost", "$precomputation", "$parent_pred", "$parent_pred_inverseP" }, $list4, $list5, PRINT_TVA_TACTIC);
        }
    }
