...
import com.cyc.cycjava.cycl.relation_lexifier;
...
import static com.cyc.cycjava.cycl.relation_lexifier.*;
...
public final class relation_lexifier extends SubLTranslatedFile {
    ...
    public static final SubLString $str4$_a = makeString("~a");

    public static final SubLString $str5$_ = makeString("`");



    public static final SubLSymbol $sym7$PPH_DETERMINER_ = makeSymbol("PPH-DETERMINER?");

    public static final SubLSymbol $sym8$SPEECH_PART_PRED_ = makeSymbol("SPEECH-PART-PRED?");

    public static final SubLSymbol $sym9$HANDLABLE_ARG_ORDER_SUBLIST_ELEMENT_ = makeSymbol("HANDLABLE-ARG-ORDER-SUBLIST-ELEMENT?");

    public static final SubLString $str10$Can_t_handle__S_in__S = makeString("Can't handle ~S in ~S");

    public static final SubLString $str11$_S_references_arg_S____which_is_g = makeString("~S references arg~S,~% which is greater than the min-arity of ~S");

    public static final SubLString $str12$Multiple_slots_for_arg_S_in____S = makeString("Multiple slots for arg~S in~% ~S");

    public static final SubLString $str13$Failed_to_exhaust_arg_order_list_ = makeString("Failed to exhaust arg-order list for ~S.~% Remainder: ~S~%");

    public static final SubLString $str14$Couldn_t_find_twiddle_for_ARG_S_i = makeString("Couldn't find twiddle for ARG~S in ~S");

    public static final SubLString $str15$_S_must_be_the_same_length_as__S = makeString("~S must be the same length as ~S");
    ...
    public static final SubLList $list19 = list(makeSymbol("START"), makeSymbol("END"));
    ...
    public static final SubLSymbol REL_PHRASE_START = makeSymbol("REL-PHRASE-START");





    private static final SubLObject $$headsPhraseOfType = reader_make_constant_shell(makeString("headsPhraseOfType"));

    public static final SubLList $list26 = list(makeKeyword("CAT"));
    ...
    public static final SubLList $list29 = list(reader_make_constant_shell(makeString("PhraseFn-Bar1")), reader_make_constant_shell(makeString("Noun")));
    ...
    public static final SubLString $str36$Can_t_determine_definiteness_of__ = makeString("Can't determine definiteness of ~S");

    public static final SubLSymbol CLOSE_QUOTE_STRING_P = makeSymbol("CLOSE-QUOTE-STRING-P");

    public static final SubLSymbol PPH_PHRASE_STRING = makeSymbol("PPH-PHRASE-STRING");
    ...
    public static final SubLString $str45$guess_more_info_not_doing_anythin = makeString("guess-more-info not doing anything with ~s~%");
    ...
    public static final SubLSymbol GENERALIZE_SPEECH_PART_PRED = makeSymbol("GENERALIZE-SPEECH-PART-PRED");
    ...
    public static final SubLString $str67$Node__a_does_not_pass_sbhl_type_t = makeString("Node ~a does not pass sbhl-type-test ~a~%");

    private static final SubLObject $$gerund = reader_make_constant_shell(makeString("gerund"));

    private static final SubLObject $$agentiveNounStrings = reader_make_constant_shell(makeString("agentiveNounStrings"));
    ...
    public static final SubLSymbol $sym71$SPEC_PRED_ = makeSymbol("SPEC-PRED?");



    public static final SubLSymbol $sym73$GENERIC_ARG_ = makeSymbol("GENERIC-ARG?");

    public static final SubLSymbol $sym74$_ = makeSymbol("<");

    public static final SubLSymbol GENERIC_ARG_NUM = makeSymbol("GENERIC-ARG-NUM");
    ...
    public static final SubLString $str82$unusable_phrase_sent_to_PPH_PHRAS = makeString("unusable phrase sent to PPH-PHRASE-TO-TEMPLATE-SYNTAX: ~%~S~%");
    ...
    public static final SubLString $str89$Sent_non_relation__S_to_DETERMINE = makeString("Sent non-relation ~S to DETERMINE-TEMPLATE-CATEGORY");
    ...
    public static SubLObject declare_relation_lexifier_file() {
        declareFunction(me, "gen_format_assertion_to_gen_template", "GEN-FORMAT-ASSERTION-TO-GEN-TEMPLATE", 1, 0, false);
        declareFunction(me, "handlable_arg_order_sublist_elementP", "HANDLABLE-ARG-ORDER-SUBLIST-ELEMENT?", 1, 0, false);
        declareFunction(me, "massage_lexification_tokenization", "MASSAGE-LEXIFICATION-TOKENIZATION", 1, 0, false);
        declareFunction(me, "lexify_relation", "LEXIFY-RELATION", 3, 3, false);
        declareFunction(me, "phrasal_cat_for_pos", "PHRASAL-CAT-FOR-POS", 1, 0, false);
        declareFunction(me, "lexifier_pph_phrase", "LEXIFIER-PPH-PHRASE", 3, 2, false);
        declareFunction(me, "lexifier_np", "LEXIFIER-NP", 4, 0, false);
        declareFunction(me, "lexifier_det_phrase", "LEXIFIER-DET-PHRASE", 1, 0, false);
        declareFunction(me, "lexifier_indefinite_determiner_p", "LEXIFIER-INDEFINITE-DETERMINER-P", 1, 0, false);
        declareFunction(me, "push_phrase", "PUSH-PHRASE", 4, 0, false);
        declareFunction(me, "open_quote_string_p", "OPEN-QUOTE-STRING-P", 1, 0, false);
        declareFunction(me, "open_quote_p", "OPEN-QUOTE-P", 1, 0, false);
        declareFunction(me, "close_quote_string_p", "CLOSE-QUOTE-STRING-P", 1, 0, false);
        declareFunction(me, "close_quote_p", "CLOSE-QUOTE-P", 1, 0, false);
        declareFunction(me, "rel_lex_guess_more_info", "REL-LEX-GUESS-MORE-INFO", 1, 0, false);
        declareFunction(me, "guess_more_info_for_dtr", "GUESS-MORE-INFO-FOR-DTR", 5, 0, false);
        declareFunction(me, "maybe_make_head_verb", "MAYBE-MAKE-HEAD-VERB", 3, 0, false);
        declareFunction(me, "make_np_dtr", "MAKE-NP-DTR", 1, 0, false);
        declareFunction(me, "remove_number_agreement", "REMOVE-NUMBER-AGREEMENT", 1, 0, false);
        declareFunction(me, "generalize_speech_part_preds", "GENERALIZE-SPEECH-PART-PREDS", 1, 0, false);
        declareFunction(me, "clear_generalize_speech_part_pred", "CLEAR-GENERALIZE-SPEECH-PART-PRED", 0, 0, false);
        declareFunction(me, "remove_generalize_speech_part_pred", "REMOVE-GENERALIZE-SPEECH-PART-PRED", 1, 0, false);
        declareFunction(me, "generalize_speech_part_pred_internal", "GENERALIZE-SPEECH-PART-PRED-INTERNAL", 1, 0, false);
        declareFunction(me, "generalize_speech_part_pred", "GENERALIZE-SPEECH-PART-PRED", 1, 0, false);
        declareFunction(me, "generalize_speech_part_pred_int", "GENERALIZE-SPEECH-PART-PRED-INT", 2, 0, false);
        declareFunction(me, "general_speech_part_predP", "GENERAL-SPEECH-PART-PRED?", 1, 0, false);
        declareFunction(me, "tensed_verb_lacking_agreement_infoP", "TENSED-VERB-LACKING-AGREEMENT-INFO?", 1, 0, false);
        declareFunction(me, "rel_lex_revert_generic_arg_phrases", "REL-LEX-REVERT-GENERIC-ARG-PHRASES", 1, 0, false);
        declareFunction(me, "rel_lex_merge_strings", "REL-LEX-MERGE-STRINGS", 1, 0, false);
        declareFunction(me, "add_bare_string_dtrs", "ADD-BARE-STRING-DTRS", 2, 0, false);
        declareFunction(me, "build_pph_np_from_np_parse", "BUILD-PPH-NP-FROM-NP-PARSE", 2, 0, false);
        declareFunction(me, "parse_template_from_pph_phrase", "PARSE-TEMPLATE-FROM-PPH-PHRASE", 2, 0, false);
        declareFunction(me, "template_sem_from_template_syntax", "TEMPLATE-SEM-FROM-TEMPLATE-SYNTAX", 2, 0, false);
        declareFunction(me, "pph_phrase_to_template_syntax", "PPH-PHRASE-TO-TEMPLATE-SYNTAX", 2, 0, false);
        declareFunction(me, "determine_template_pred", "DETERMINE-TEMPLATE-PRED", 2, 0, false);
        declareFunction(me, "determine_template_category", "DETERMINE-TEMPLATE-CATEGORY", 2, 0, false);
        declareFunction(me, "qsl_parse_template_from_pph_phrase", "QSL-PARSE-TEMPLATE-FROM-PPH-PHRASE", 4, 0, false);
        declareFunction(me, "compute_qsl_parse_template_semantics", "COMPUTE-QSL-PARSE-TEMPLATE-SEMANTICS", 3, 0, false);
        declareFunction(me, "qsl_determine_template_category", "QSL-DETERMINE-TEMPLATE-CATEGORY", 1, 0, false);
        declareFunction(me, "qsl_pph_phrase_to_template_syntax", "QSL-PPH-PHRASE-TO-TEMPLATE-SYNTAX", 2, 0, false);
        declareFunction(me, "qsl_pph_phrase_to_template_syntax_int", "QSL-PPH-PHRASE-TO-TEMPLATE-SYNTAX-INT", 2, 0, false);
        declareFunction(me, "qsl_trees_availableP", "QSL-TREES-AVAILABLE?", 0, 0, false);
        declareFunction(me, "print_words_from_rel_phrases", "PRINT-WORDS-FROM-REL-PHRASES", 1, 0, false);
        declareFunction(me, "attach_less_principled_information", "ATTACH-LESS-PRINCIPLED-INFORMATION", 1, 0, false);
        declareFunction(me, "new_rel_phrase", "NEW-REL-PHRASE", 4, 0, false);
        declareFunction(me, "rel_phrase_end", "REL-PHRASE-END", 1, 0, false);
        declareFunction(me, "rel_phrase_start", "REL-PHRASE-START", 1, 0, false);
        declareFunction(me, "rel_phrase_pph_phrase", "REL-PHRASE-PPH-PHRASE", 1, 0, false);
        declareFunction(me, "rel_phrase_original", "REL-PHRASE-ORIGINAL", 1, 0, false);
        declareFunction(me, "rel_phrase_words", "REL-PHRASE-WORDS", 1, 0, false);
        declareFunction(me, "get_rtp_useful_speech_parts", "GET-RTP-USEFUL-SPEECH-PARTS", 1, 0, false);
        declareFunction(me, "ensure_pos_template_mappings_initialized", "ENSURE-POS-TEMPLATE-MAPPINGS-INITIALIZED", 0, 0, false);
        declareFunction(me, "initialize_pos_template_mappings", "INITIALIZE-POS-TEMPLATE-MAPPINGS", 0, 0, false);
        return NIL;
    }
