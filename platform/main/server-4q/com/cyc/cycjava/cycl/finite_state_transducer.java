...
import com.cyc.cycjava.cycl.finite_state_transducer;
...
import static com.cyc.cycjava.cycl.finite_state_transducer.*;
...
public final class finite_state_transducer extends SubLTranslatedFile {
    ...
    public static SubLObject finite_state_transducer_p(final SubLObject v_object) {
        return v_object.getClass() == finite_state_transducer.$finite_state_transducer_native.class ? T : NIL;
    }

    public static SubLObject fst_initial_state(final SubLObject v_object) {
        assert NIL != finite_state_transducer_p(v_object) : "finite_state_transducer.finite_state_transducer_p(v_object) " + "CommonSymbols.NIL != finite_state_transducer.finite_state_transducer_p(v_object) " + v_object;
    ...
    public static SubLObject make_finite_state_transducer(SubLObject arglist) {
        ...
        final SubLObject v_new = new finite_state_transducer.$finite_state_transducer_native();
        SubLObject next;
    ...
    public static final class $finite_state_transducer_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(finite_state_transducer.$finite_state_transducer_native.class, FINITE_STATE_TRANSDUCER, FINITE_STATE_TRANSDUCER_P, $list2, $list3, new String[]{ "$initial_state", "$final_states", "$machine_table", "$token_builder", "$input", "$current_token_index", "$current_state", "$memory", "$indexed_output" }, $list4, $list5, PRINT_FST);
        }
    }
