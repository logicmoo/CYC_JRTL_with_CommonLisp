...
import com.cyc.cycjava.cycl.message_mailboxes;
...
import static com.cyc.cycjava.cycl.message_mailboxes.*;
...
public final class message_mailboxes extends SubLTranslatedFile {
    ...
    public static SubLObject message_mailbox_suite_p(final SubLObject v_object) {
        return v_object.getClass() == message_mailboxes.$message_mailbox_suite_native.class ? T : NIL;
    }

    public static SubLObject message_mailbox_suite_lock(final SubLObject v_object) {
        assert NIL != message_mailbox_suite_p(v_object) : "message_mailboxes.message_mailbox_suite_p(v_object) " + "CommonSymbols.NIL != message_mailboxes.message_mailbox_suite_p(v_object) " + v_object;
    ...
    public static SubLObject make_message_mailbox_suite(SubLObject arglist) {
        ...
        final SubLObject v_new = new message_mailboxes.$message_mailbox_suite_native();
        SubLObject next;
    ...
    public static final class $message_mailbox_suite_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(message_mailboxes.$message_mailbox_suite_native.class, MESSAGE_MAILBOX_SUITE, MESSAGE_MAILBOX_SUITE_P, $list2, $list3, new String[]{ "$lock", "$mailboxes" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
