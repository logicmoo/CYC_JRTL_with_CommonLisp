...
public final class psp_chart extends SubLTranslatedFile {
    ...
    public static SubLObject phrase_structure_parser_chart_p(final SubLObject v_object) {
        return v_object.getClass() == psp_chart.$phrase_structure_parser_chart_native.class ? T : NIL;
    }

    public static SubLObject psp_chart_id(final SubLObject v_object) {
        assert NIL != phrase_structure_parser_chart_p(v_object) : "psp_chart.phrase_structure_parser_chart_p(v_object) " + "CommonSymbols.NIL != psp_chart.phrase_structure_parser_chart_p(v_object) " + v_object;
    ...
    public static SubLObject make_phrase_structure_parser_chart(SubLObject arglist) {
        ...
        final SubLObject v_new = new psp_chart.$phrase_structure_parser_chart_native();
        SubLObject next;
    ...
    public static SubLObject phrase_structure_parser_phrasal_edge_p(final SubLObject v_object) {
        return v_object.getClass() == psp_chart.$phrase_structure_parser_phrasal_edge_native.class ? T : NIL;
    }

    public static SubLObject psp_phrasal_edge_weight(final SubLObject v_object) {
        assert NIL != phrase_structure_parser_phrasal_edge_p(v_object) : "psp_chart.phrase_structure_parser_phrasal_edge_p(v_object) " + "CommonSymbols.NIL != psp_chart.phrase_structure_parser_phrasal_edge_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_phrase_structure_parser_phrasal_edge(SubLObject arglist) {
        ...
        final SubLObject v_new = new psp_chart.$phrase_structure_parser_phrasal_edge_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject phrase_structure_parser_lexical_edge_p(final SubLObject v_object) {
        return v_object.getClass() == psp_chart.$phrase_structure_parser_lexical_edge_native.class ? T : NIL;
    }

    public static SubLObject psp_lexical_edge_weight(final SubLObject v_object) {
        assert NIL != phrase_structure_parser_lexical_edge_p(v_object) : "psp_chart.phrase_structure_parser_lexical_edge_p(v_object) " + "CommonSymbols.NIL != psp_chart.phrase_structure_parser_lexical_edge_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_phrase_structure_parser_lexical_edge(SubLObject arglist) {
        ...
        final SubLObject v_new = new psp_chart.$phrase_structure_parser_lexical_edge_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $phrase_structure_parser_phrasal_edge_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(psp_chart.$phrase_structure_parser_phrasal_edge_native.class, PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE, PHRASE_STRUCTURE_PARSER_PHRASAL_EDGE_P, $list63, $list64, new String[]{ "$weight", "$string", "$span", "$category", "$pos_pred", "$cycls", "$rule", "$new_dtr_constraints", "$head_dtr", "$non_head_dtrs", "$id", "$chart" }, $list65, $list66, PPRINT_PSP_PHRASAL_EDGE);
        }
    }
    ...
    public static final class $phrase_structure_parser_lexical_edge_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(psp_chart.$phrase_structure_parser_lexical_edge_native.class, PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE, PHRASE_STRUCTURE_PARSER_LEXICAL_EDGE_P, $list111, $list112, new String[]{ "$weight", "$string", "$span", "$category", "$pos_pred", "$cycls", "$wu", "$frame", "$id", "$chart" }, $list113, $list114, PPRINT_PSP_LEXICAL_EDGE);
        }
    }
