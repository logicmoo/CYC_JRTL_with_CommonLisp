...
public final class keyhash extends SubLTranslatedFile {
    ...
    public static SubLObject keyhash_p(final SubLObject v_object) {
        return v_object.getClass() == keyhash.$keyhash_native.class ? T : NIL;
    }

    public static SubLObject khash_nodes(final SubLObject v_object) {
        assert NIL != keyhash_p(v_object) : "keyhash.keyhash_p(v_object) " + "CommonSymbols.NIL != keyhash.keyhash_p(v_object) " + v_object;
    ...
    public static SubLObject make_keyhash(SubLObject arglist) {
        ...
        final SubLObject v_new = new keyhash.$keyhash_native();
        SubLObject next;
    ...
    public static final class $keyhash_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(keyhash.$keyhash_native.class, KEYHASH, KEYHASH_P, $list3, $list4, new String[]{ "$nodes", "$test", "$count", "$hash_stash" }, $list5, $list6, PRINT_KEY_HASH);
        }
    }
