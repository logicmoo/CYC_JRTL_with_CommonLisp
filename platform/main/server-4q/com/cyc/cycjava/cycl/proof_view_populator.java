...
import static com.cyc.cycjava.cycl.proof_view_populator.*;
...
public final class proof_view_populator extends SubLTranslatedFile {
    ...
    private static final SubLList $list150 = listS(list(makeKeyword("OR"), reader_make_constant_shell(makeString("situationConstituentWithTypeAndDesc")), reader_make_constant_shell(makeString("situationConstituentWithType")), reader_make_constant_shell(makeString("situationConstituentWithDesc"))), list(makeKeyword("BIND"), makeSymbol("HYPOTHESIS")), list(makeKeyword("BIND"), makeSymbol("TERM")), makeKeyword("ANYTHING"));
    ...
    public static SubLObject proof_view_populator_p(final SubLObject v_object) {
        return v_object.getClass() == proof_view_populator.$proof_view_populator_native.class ? T : NIL;
    }

    public static SubLObject pvp_proof_view(final SubLObject v_object) {
        assert NIL != proof_view_populator_p(v_object) : "proof_view_populator.proof_view_populator_p(v_object) " + "CommonSymbols.NIL != proof_view_populator.proof_view_populator_p(v_object) " + v_object;
    ...
    public static SubLObject make_proof_view_populator(SubLObject arglist) {
        ...
        final SubLObject v_new = new proof_view_populator.$proof_view_populator_native();
        SubLObject next;
        ...
        for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
            ...
            if (pcase_var.eql($PROOF_VIEW)) {
                ...
                if (pcase_var.eql($WORKER_SEMAPHORE)) {
                    _csetf_pvp_worker_semaphore(v_new, current_value);
                } else
                    if (pcase_var.eql($MASTER_SEMAPHORE)) {
    ...
    public static SubLObject proof_view_special_sections_to_include(final SubLObject v_proof_view) {
        ...
        if (NIL != misc_utilities.uninitialized_p(sections)) {
            ...
            SubLObject iteration_state;
            for (iteration_state = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents($proof_view_special_sections$.getGlobalValue())); NIL == dictionary_contents.do_dictionary_contents_doneP(iteration_state); iteration_state = dictionary_contents.do_dictionary_contents_next(iteration_state)) {
                thread.resetMultipleValues();
    ...
    public static SubLObject proof_view_maybe_add_justification_section(final SubLObject v_proof_view, final SubLObject mt, final SubLObject proof_index_string) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        if ((((NIL != proof_view.proof_view_get_include_justification_sectionP(v_proof_view)) || (NIL != proof_view_summary.proof_view_get_include_summary_sectionP(v_proof_view))) || (NIL != proof_view_linear.proof_view_get_include_linear_sectionP(v_proof_view))) || (NIL != set.non_empty_set_p(proof_view_special_sections_to_include(v_proof_view)))) {
    ...
    public static SubLObject construct_inference_proof_view_int(final SubLObject proof, final SubLObject inference_answer, final SubLObject mt, final SubLObject proof_index_string, final SubLObject v_proof_view, SubLObject parent_proof_view_entry, SubLObject pph_relevance_safe_list) {
        ...
        try {
            ...
            if (NIL != proof_view_residual.proof_view_proof_relocated_p(proof)) {
                ...
                if (NIL != proof_view_trivial_proofP(proof, mt)) {
                    ...
                    if (NIL != proof_conclusion_for_query_pragmaP(proof_conclusion, inference_answer)) {
                        ...
                        if (NIL != proof_view.proof_view_has_entry_for_objectP(v_proof_view, proof_conclusion, parent_proof_view_entry)) {
                            ...
                            if ((NIL != parent_proof_view_entry) && (NIL != proof_view_residual.proof_view_conjunctive_removal_proof_p(proof, mt))) {
                                ...
                                if (NIL != proof_view_situation_constituents_proof_p(proof)) {
                                    ...
                                    if (NIL != proof_view_entity_mentions_proofP(proof, mt)) {
                                        ...
                                        if (NIL != inference_worker.structural_proof_p(proof)) {
                                            ...
                                            if (NIL != proof_view_proof_already_handledP(v_proof_view, proof)) {
                                                suppressP = T;
                                                ...
                                                if (NIL != inference_worker_residual_transformation.residual_transformation_proof_p(proof)) {
                                                    ...
                                                    if (NIL != pph_proof.pph_irrelevant_formulaP(proof_conclusion, pph_relevance_safe_list, UNPROVIDED)) {
                                                        ...
                                                        if (NIL != pph_proof.pph_proof_wX_isomorphic_support_p(proof)) {
                                                            ...
                                                            if (NIL != proof_view.suppress_proof_view_literalP(proof_view.proof_view_fact_sentence(proof_conclusion))) {
                                                                suppressP = T;
    ...
    public static SubLObject construct_default_proof_view(final SubLObject proof, final SubLObject inference_answer, final SubLObject v_proof_view, final SubLObject parent_proof_view_entry, final SubLObject mt, final SubLObject proof_index_string, SubLObject traceP, SubLObject pph_relevance_safe_list) {
        ...
        final SubLObject subentry_parent_entry = (NIL != proof_view.proof_view_has_entry_for_objectP(v_proof_view, proof_conclusion, parent_proof_view_entry)) ? parent_proof_view_entry : proof_view_add_new_entry(v_proof_view, label, parent_proof_view_entry, object_type, proof_conclusion, list($FN, CONSTRUCT_DEFAULT_PROOF_VIEW, $PROOF, proof));
        if ((NIL != traceP) && (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread))) {
        ...
        try {
            ...
            while (NIL != cdolist_list_var) {
                ...
                if (NIL != literals_to_suppress) {
                    ...
                    final SubLObject rule_bindings = (NIL != inference_worker_transformation.transformation_proof_p(proof)) ? inference_worker_transformation.transformation_proof_rule_bindings(proof) : NIL != inference_worker_residual_transformation.residual_transformation_proof_p(proof) ? inference_worker_residual_transformation.residual_transformation_proof_rule_bindings(proof) : NIL;
    ...
    public static SubLObject proof_view_sort_entries_to_maximize_coherence(final SubLObject v_proof_view, final SubLObject mt, final SubLObject entries) {
        ...
        try {
            ...
            while (NIL != cdolist_list_var) {
                ...
                final SubLObject v_forts = (NIL != proof) ? cycl_utilities.expression_gather(NIL != inference_worker_residual_transformation.residual_transformation_proof_p(proof) ? proof_view_residual.pph_residual_transformation_proof_conclusion(proof, mt) : pph_proof.pph_proof_conclusion(proof, mt), FORT_P, T, UNPROVIDED, UNPROVIDED, UNPROVIDED) : NIL;
    ...
    public static SubLObject proof_view_add_fact_used(final SubLObject v_proof_view, final SubLObject facts_used_section_root, final SubLObject used_fact, final SubLObject inference_mt) {
        ...
        if (NIL != assertion_handles.assertion_p(used_fact)) {
            ...
            if (NIL != proof_view.proof_view_external_support_p(used_fact)) {
    ...
    public static SubLObject proof_view_add_support_tree(final SubLObject v_proof_view, final SubLObject support, final SubLObject parent_proof_view_entry, final SubLObject inference_mt, SubLObject current_depth, SubLObject seen_supports) {
        ...
        try {
            ...
            if (NIL != proof_view.proof_view_has_entry_for_objectP(v_proof_view, support, parent_proof_view_entry)) {
                ...
                if (NIL == proof_view.suppress_proof_supportP(support)) {
                    if ((NIL != assertion_handles.assertion_p(support)) && (NIL == assertions_high.deduced_assertionP(support))) {
                        ...
                        if ((NIL != assertion_handles.assertion_p(support)) && (NIL != circularP)) {
                            ...
                            if ((NIL != arguments.support_p(support)) && (NIL != circularP)) {
                                ...
                                if (NIL != arguments.support_p(support)) {
                                    ...
                                    if (((((NIL != formula_arityE(support_sentence, TWO_INTEGER, UNPROVIDED)) && (NIL != formula_arityE(parent_sentence, TWO_INTEGER, UNPROVIDED))) && cycl_utilities.formula_arg0(support_sentence).equal(cycl_utilities.formula_arg0(parent_sentence))) && cycl_utilities.formula_arg1(support_sentence, UNPROVIDED).equal(cycl_utilities.formula_arg2(parent_sentence, UNPROVIDED))) && cycl_utilities.formula_arg2(support_sentence, UNPROVIDED).equal(cycl_utilities.formula_arg1(parent_sentence, UNPROVIDED))) {
                                        if (NIL != proof_view.$proof_view_debugP$.getDynamicValue(thread)) {
                                    ...
                                    if (NIL != meta_supports) {
                                        ...
                                        if (NIL != proof_view.proof_view_external_support_p(support)) {
                                            ...
                                            if (NIL != abduction.abduction_support_p(support)) {
                                                ...
                                                if (NIL == proof_view.proof_view_get_suppress_assertion_bookkeepingP(v_proof_view)) {
    ...
    public static SubLObject proof_view_maybe_add_used_support(final SubLObject v_proof_view, final SubLObject support, final SubLObject current_depth, final SubLObject circularP) {
        if (NIL != proof_view_add_used_supportP(v_proof_view, support, current_depth, circularP)) {
            if ((NIL != groundP(arguments.support_sentence(support), UNPROVIDED)) && (NIL != atomic_sentenceP(arguments.support_sentence(support)))) {
                ...
                if ((NIL != proof_view.proof_view_get_include_rules_sectionP(v_proof_view)) && (NIL != assertions_high.rule_assertionP(support))) {
                    proof_view_add_used_support(v_proof_view, support);
                }
    ...
    public static SubLObject proof_view_add_used_supportP(final SubLObject v_proof_view, final SubLObject support, final SubLObject current_depth, final SubLObject circularP) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        return makeBoolean((((NIL != pph_vars.$pph_proof_show_facts_usedP$.getDynamicValue(thread)) || (NIL != proof_view.proof_view_get_include_rules_sectionP(v_proof_view))) && ((((NIL == proof_view_depth_exceeds_cutoffP(current_depth)) || ((NIL != proof_view.proof_view_get_include_rules_sectionP(v_proof_view)) && (NIL != assertions_high.rule_assertionP(support)))) || ((NIL != assertion_handles.assertion_p(support)) && (NIL != sources.assertion_sourcedP(support)))) || (NIL != abduction.abduction_support_p(support)))) && (((NIL != abduction.abduction_support_p(support)) || ((NIL != arguments.support_p(support)) && (NIL != member(arguments.support_module(support), $list193, UNPROVIDED, UNPROVIDED)))) || ((NIL != assertion_handles.assertion_p(support)) && (((NIL != assertions_high.asserted_assertionP(support)) || (NIL != circularP)) || (NIL != derived_assertion_proof_view_worthyP(support, v_proof_view, current_depth, circularP))))));
    }
    ...
    public static SubLObject proof_view_add_assert_info_entries(final SubLObject v_proof_view, final SubLObject assertion, final SubLObject assertion_entry, final SubLObject inference_mt) {
        ...
        if (NIL != v_sources) {
            ...
            if ((NIL != givenP) && (NIL == proof_view.proof_view_get_suppress_assertion_bookkeepingP(v_proof_view))) {
    ...
    public static SubLObject declare_proof_view_populator_file() {
        declareFunction(me, "proof_view_populator_print_function_trampoline", "PROOF-VIEW-POPULATOR-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "proof_view_populator_p", "PROOF-VIEW-POPULATOR-P", 1, 0, false);
        new proof_view_populator.$proof_view_populator_p$UnaryFunction();
        declareFunction(me, "pvp_proof_view", "PVP-PROOF-VIEW", 1, 0, false);
        declareFunction(me, "pvp_worker_semaphore", "PVP-WORKER-SEMAPHORE", 1, 0, false);
        declareFunction(me, "pvp_master_semaphore", "PVP-MASTER-SEMAPHORE", 1, 0, false);
        declareFunction(me, "pvp_process", "PVP-PROCESS", 1, 0, false);
        declareFunction(me, "_csetf_pvp_proof_view", "_CSETF-PVP-PROOF-VIEW", 2, 0, false);
        declareFunction(me, "_csetf_pvp_worker_semaphore", "_CSETF-PVP-WORKER-SEMAPHORE", 2, 0, false);
        declareFunction(me, "_csetf_pvp_master_semaphore", "_CSETF-PVP-MASTER-SEMAPHORE", 2, 0, false);
        declareFunction(me, "_csetf_pvp_process", "_CSETF-PVP-PROCESS", 2, 0, false);
        declareFunction(me, "make_proof_view_populator", "MAKE-PROOF-VIEW-POPULATOR", 0, 1, false);
        declareFunction(me, "visit_defstruct_proof_view_populator", "VISIT-DEFSTRUCT-PROOF-VIEW-POPULATOR", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_proof_view_populator_method", "VISIT-DEFSTRUCT-OBJECT-PROOF-VIEW-POPULATOR-METHOD", 2, 0, false);
        declareFunction(me, "print_proof_view_populator", "PRINT-PROOF-VIEW-POPULATOR", 3, 0, false);
        declareFunction(me, "new_proof_view_populator", "NEW-PROOF-VIEW-POPULATOR", 1, 0, false);
        declareFunction(me, "proof_view_populator_proof_view", "PROOF-VIEW-POPULATOR-PROOF-VIEW", 1, 0, false);
        declareFunction(me, "proof_view_populator_worker_semaphore", "PROOF-VIEW-POPULATOR-WORKER-SEMAPHORE", 1, 0, false);
        declareFunction(me, "proof_view_populator_master_semaphore", "PROOF-VIEW-POPULATOR-MASTER-SEMAPHORE", 1, 0, false);
        declareFunction(me, "proof_view_populator_process", "PROOF-VIEW-POPULATOR-PROCESS", 1, 0, false);
        declareFunction(me, "sxhash_proof_view_populator_method", "SXHASH-PROOF-VIEW-POPULATOR-METHOD", 1, 0, false);
        declareFunction(me, "sxhash_proof_view_populator", "SXHASH-PROOF-VIEW-POPULATOR", 1, 0, false);
        declareFunction(me, "proof_view_populator_doneP", "PROOF-VIEW-POPULATOR-DONE?", 1, 0, false);
        declareFunction(me, "proof_view_populator_do_one_step", "PROOF-VIEW-POPULATOR-DO-ONE-STEP", 1, 0, false);
        declareFunction(me, "proof_view_populator_note_done", "PROOF-VIEW-POPULATOR-NOTE-DONE", 1, 0, false);
        declareFunction(me, "proof_view_launch_stepwise_populator", "PROOF-VIEW-LAUNCH-STEPWISE-POPULATOR", 1, 2, false);
        declareFunction(me, "proof_view_populate", "PROOF-VIEW-POPULATE", 1, 3, false);
        declareFunction(me, "proof_view_note_no_justification", "PROOF-VIEW-NOTE-NO-JUSTIFICATION", 2, 0, false);
        declareFunction(me, "proof_view_set_populated_universal_time", "PROOF-VIEW-SET-POPULATED-UNIVERSAL-TIME", 1, 1, false);
        declareFunction(me, "proof_view_set_error_output", "PROOF-VIEW-SET-ERROR-OUTPUT", 2, 0, false);
        declareFunction(me, "proof_view_maybe_add_source_citations", "PROOF-VIEW-MAYBE-ADD-SOURCE-CITATIONS", 1, 0, false);
        declareFunction(me, "proof_view_maybe_flesh_out_rules_section", "PROOF-VIEW-MAYBE-FLESH-OUT-RULES-SECTION", 2, 0, false);
        declareMacro(me, "define_proof_view_special_section_populator", "DEFINE-PROOF-VIEW-SPECIAL-SECTION-POPULATOR");
        declareFunction(me, "proof_view_add_special_sections", "PROOF-VIEW-ADD-SPECIAL-SECTIONS", 1, 0, false);
        declareFunction(me, "proof_view_note_special_section_root", "PROOF-VIEW-NOTE-SPECIAL-SECTION-ROOT", 3, 0, false);
        declareFunction(me, "proof_view_get_special_section_roots", "PROOF-VIEW-GET-SPECIAL-SECTION-ROOTS", 1, 0, false);
        declareFunction(me, "proof_view_get_special_section_root", "PROOF-VIEW-GET-SPECIAL-SECTION-ROOT", 2, 0, false);
        declareFunction(me, "proof_view_special_sections_to_include", "PROOF-VIEW-SPECIAL-SECTIONS-TO-INCLUDE", 1, 0, false);
        declareFunction(me, "proof_view_set_include_special_sectionP", "PROOF-VIEW-SET-INCLUDE-SPECIAL-SECTION?", 3, 0, false);
        declareFunction(me, "proof_view_section_key_from_id", "PROOF-VIEW-SECTION-KEY-FROM-ID", 1, 0, false);
        declareFunction(me, "note_proof_view_special_section_populator", "NOTE-PROOF-VIEW-SPECIAL-SECTION-POPULATOR", 4, 0, false);
        declareFunction(me, "proof_view_maybe_add_justification_section", "PROOF-VIEW-MAYBE-ADD-JUSTIFICATION-SECTION", 3, 0, false);
        declareFunction(me, "note_constructing_proof_view_for_conclusion", "NOTE-CONSTRUCTING-PROOF-VIEW-FOR-CONCLUSION", 1, 0, false);
        declareMacro(me, "tracking_proof_view_literals_to_suppress", "TRACKING-PROOF-VIEW-LITERALS-TO-SUPPRESS");
        declareFunction(me, "construct_inference_proof_view_int", "CONSTRUCT-INFERENCE-PROOF-VIEW-INT", 5, 2, false);
        declareFunction(me, "construct_default_proof_view", "CONSTRUCT-DEFAULT-PROOF-VIEW", 6, 2, false);
        declareFunction(me, "proof_view_trivial_proofP", "PROOF-VIEW-TRIVIAL-PROOF?", 2, 0, false);
        declareFunction(me, "trivial_proof_conclusionP", "TRIVIAL-PROOF-CONCLUSION?", 2, 0, false);
        declareFunction(me, "proof_binds_some_variable_to_valueP", "PROOF-BINDS-SOME-VARIABLE-TO-VALUE?", 2, 1, false);
        declareFunction(me, "proof_conclusion_for_query_pragmaP", "PROOF-CONCLUSION-FOR-QUERY-PRAGMA?", 2, 0, false);
        declareFunction(me, "proof_view_proof_literals_to_suppress", "PROOF-VIEW-PROOF-LITERALS-TO-SUPPRESS", 2, 0, false);
        declareFunction(me, "proof_literals_to_suppress_internal", "PROOF-LITERALS-TO-SUPPRESS-INTERNAL", 1, 1, false);
        declareFunction(me, "proof_literals_to_suppress", "PROOF-LITERALS-TO-SUPPRESS", 1, 1, false);
        declareFunction(me, "proof_view_proof_already_handledP", "PROOF-VIEW-PROOF-ALREADY-HANDLED?", 2, 0, false);
        declareFunction(me, "proof_view_note_already_handled", "PROOF-VIEW-NOTE-ALREADY-HANDLED", 2, 0, false);
        declareFunction(me, "pph_relevance_safe_list_for_justification", "PPH-RELEVANCE-SAFE-LIST-FOR-JUSTIFICATION", 1, 0, false);
        declareFunction(me, "inference_answer_binding_targets", "INFERENCE-ANSWER-BINDING-TARGETS", 1, 0, false);
        declareFunction(me, "proof_view_add_inference_proof_used_rules_root", "PROOF-VIEW-ADD-INFERENCE-PROOF-USED-RULES-ROOT", 1, 0, false);
        declareFunction(me, "proof_view_add_query_and_answer_section", "PROOF-VIEW-ADD-QUERY-AND-ANSWER-SECTION", 2, 0, false);
        declareFunction(me, "construct_proof_view_answer_entry", "CONSTRUCT-PROOF-VIEW-ANSWER-ENTRY", 3, 0, false);
        declareFunction(me, "new_proof_view_entry", "NEW-PROOF-VIEW-ENTRY", 2, 0, false);
        declareFunction(me, "proof_view_add_new_entry", "PROOF-VIEW-ADD-NEW-ENTRY", 5, 1, false);
        declareFunction(me, "maybe_pause_proof_view_population", "MAYBE-PAUSE-PROOF-VIEW-POPULATION", 0, 1, false);
        declareFunction(me, "proof_view_entry_note_expand_initially", "PROOF-VIEW-ENTRY-NOTE-EXPAND-INITIALLY", 1, 0, false);
        declareFunction(me, "proof_view_add_section_root", "PROOF-VIEW-ADD-SECTION-ROOT", 2, 0, false);
        declareFunction(me, "proof_view_rem_property", "PROOF-VIEW-REM-PROPERTY", 2, 0, false);
        declareFunction(me, "proof_view_remove_entry", "PROOF-VIEW-REMOVE-ENTRY", 2, 0, false);
        declareFunction(me, "proof_view_add_rule_used", "PROOF-VIEW-ADD-RULE-USED", 4, 0, false);
        declareFunction(me, "proof_view_get_justification_root_entry", "PROOF-VIEW-GET-JUSTIFICATION-ROOT-ENTRY", 1, 0, false);
        declareFunction(me, "proof_view_get_linear_root_entry", "PROOF-VIEW-GET-LINEAR-ROOT-ENTRY", 1, 0, false);
        declareFunction(me, "proof_view_sort_entries_to_maximize_coherence", "PROOF-VIEW-SORT-ENTRIES-TO-MAXIMIZE-COHERENCE", 3, 0, false);
        declareFunction(me, "proof_view_entry_get_proof_suid", "PROOF-VIEW-ENTRY-GET-PROOF-SUID", 1, 0, false);
        declareFunction(me, "proof_view_entry_get_score", "PROOF-VIEW-ENTRY-GET-SCORE", 1, 0, false);
        declareFunction(me, "proof_view_add_fact_used", "PROOF-VIEW-ADD-FACT-USED", 4, 0, false);
        declareFunction(me, "proof_view_note_source", "PROOF-VIEW-NOTE-SOURCE", 3, 1, false);
        declareFunction(me, "proof_view_add_external_source_entry", "PROOF-VIEW-ADD-EXTERNAL-SOURCE-ENTRY", 3, 0, false);
        declareFunction(me, "proof_view_knowledge_source_for_hl_support", "PROOF-VIEW-KNOWLEDGE-SOURCE-FOR-HL-SUPPORT", 1, 0, false);
        declareFunction(me, "proof_view_knowledge_source_for_mt", "PROOF-VIEW-KNOWLEDGE-SOURCE-FOR-MT", 1, 0, false);
        declareFunction(me, "proof_view_maybe_add_document_display_entry", "PROOF-VIEW-MAYBE-ADD-DOCUMENT-DISPLAY-ENTRY", 4, 0, false);
        declareFunction(me, "proof_view_situation_constituents_proof_p", "PROOF-VIEW-SITUATION-CONSTITUENTS-PROOF-P", 1, 0, false);
        declareFunction(me, "proof_view_situation_constituents_proof_hypothesis_and_terms_internal", "PROOF-VIEW-SITUATION-CONSTITUENTS-PROOF-HYPOTHESIS-AND-TERMS-INTERNAL", 1, 0, false);
        declareFunction(me, "proof_view_situation_constituents_proof_hypothesis_and_terms", "PROOF-VIEW-SITUATION-CONSTITUENTS-PROOF-HYPOTHESIS-AND-TERMS", 1, 0, false);
        declareFunction(me, "proof_view_add_entries_for_situation_constituents_proof", "PROOF-VIEW-ADD-ENTRIES-FOR-SITUATION-CONSTITUENTS-PROOF", 4, 0, false);
        declareFunction(me, "proof_view_add_external_sentence_entries", "PROOF-VIEW-ADD-EXTERNAL-SENTENCE-ENTRIES", 5, 0, false);
        declareFunction(me, "proof_view_add_root_entry", "PROOF-VIEW-ADD-ROOT-ENTRY", 1, 0, false);
        declareFunction(me, "proof_view_get_sentences_for_hypothesis", "PROOF-VIEW-GET-SENTENCES-FOR-HYPOTHESIS", 2, 0, false);
        declareFunction(me, "proof_view_add_support_tree", "PROOF-VIEW-ADD-SUPPORT-TREE", 4, 2, false);
        declareFunction(me, "pph_check_meta_supports_for_circularity", "PPH-CHECK-META-SUPPORTS-FOR-CIRCULARITY", 2, 0, false);
        declareFunction(me, "proof_view_maybe_add_used_support", "PROOF-VIEW-MAYBE-ADD-USED-SUPPORT", 4, 0, false);
        declareFunction(me, "proof_view_add_used_supportP", "PROOF-VIEW-ADD-USED-SUPPORT?", 4, 0, false);
        declareFunction(me, "derived_assertion_proof_view_worthyP", "DERIVED-ASSERTION-PROOF-VIEW-WORTHY?", 4, 0, false);
        declareFunction(me, "proof_view_depth_exceeds_cutoffP", "PROOF-VIEW-DEPTH-EXCEEDS-CUTOFF?", 1, 0, false);
        declareFunction(me, "proof_view_entry_add_source", "PROOF-VIEW-ENTRY-ADD-SOURCE", 3, 0, false);
        declareFunction(me, "proof_view_entity_mentions_proofP", "PROOF-VIEW-ENTITY-MENTIONS-PROOF?", 2, 0, false);
        declareFunction(me, "entity_mentions_proof_possibleP_internal", "ENTITY-MENTIONS-PROOF-POSSIBLE?-INTERNAL", 0, 0, false);
        declareFunction(me, "entity_mentions_proof_possibleP", "ENTITY-MENTIONS-PROOF-POSSIBLE?", 0, 0, false);
        declareFunction(me, "proof_view_entity_mentions_proof_hypotheses_and_terms_internal", "PROOF-VIEW-ENTITY-MENTIONS-PROOF-HYPOTHESES-AND-TERMS-INTERNAL", 2, 0, false);
        declareFunction(me, "proof_view_entity_mentions_proof_hypotheses_and_terms", "PROOF-VIEW-ENTITY-MENTIONS-PROOF-HYPOTHESES-AND-TERMS", 2, 0, false);
        declareFunction(me, "proof_view_add_entity_mention_entries", "PROOF-VIEW-ADD-ENTITY-MENTION-ENTRIES", 4, 0, false);
        declareFunction(me, "proof_view_entry_note_abduced_support", "PROOF-VIEW-ENTRY-NOTE-ABDUCED-SUPPORT", 2, 0, false);
        declareFunction(me, "proof_view_get_hypotheses_for_sentence", "PROOF-VIEW-GET-HYPOTHESES-FOR-SENTENCE", 2, 0, false);
        declareFunction(me, "proof_view_get_entity_mentions_for_hypothesis", "PROOF-VIEW-GET-ENTITY-MENTIONS-FOR-HYPOTHESIS", 2, 0, false);
        declareFunction(me, "proof_view_get_publisher_for_document", "PROOF-VIEW-GET-PUBLISHER-FOR-DOCUMENT", 2, 0, false);
        declareFunction(me, "proof_view_get_date_for_document", "PROOF-VIEW-GET-DATE-FOR-DOCUMENT", 2, 0, false);
        declareFunction(me, "proof_view_get_author_for_document", "PROOF-VIEW-GET-AUTHOR-FOR-DOCUMENT", 2, 0, false);
        declareFunction(me, "proof_view_get_title_for_document", "PROOF-VIEW-GET-TITLE-FOR-DOCUMENT", 2, 0, false);
        declareFunction(me, "proof_view_entry_remove_label", "PROOF-VIEW-ENTRY-REMOVE-LABEL", 1, 0, false);
        declareFunction(me, "proof_view_entry_set_children", "PROOF-VIEW-ENTRY-SET-CHILDREN", 2, 0, false);
        declareFunction(me, "proof_view_entry_set_children_low", "PROOF-VIEW-ENTRY-SET-CHILDREN-LOW", 2, 0, false);
        declareFunction(me, "link_proof_view_causal_chains", "LINK-PROOF-VIEW-CAUSAL-CHAINS", 1, 0, false);
        declareFunction(me, "add_proof_view_entry_to_causal_chains", "ADD-PROOF-VIEW-ENTRY-TO-CAUSAL-CHAINS", 2, 0, false);
        declareFunction(me, "proof_view_entry_get_cause", "PROOF-VIEW-ENTRY-GET-CAUSE", 1, 0, false);
        declareFunction(me, "initialize_proof_view_entry_cause", "INITIALIZE-PROOF-VIEW-ENTRY-CAUSE", 1, 0, false);
        declareFunction(me, "cause_arg_num_of_pred_internal", "CAUSE-ARG-NUM-OF-PRED-INTERNAL", 1, 0, false);
        declareFunction(me, "cause_arg_num_of_pred", "CAUSE-ARG-NUM-OF-PRED", 1, 0, false);
        declareFunction(me, "proof_view_entry_get_effect", "PROOF-VIEW-ENTRY-GET-EFFECT", 1, 0, false);
        declareFunction(me, "initialize_proof_view_entry_effect", "INITIALIZE-PROOF-VIEW-ENTRY-EFFECT", 1, 0, false);
        declareFunction(me, "effect_arg_num_of_pred_internal", "EFFECT-ARG-NUM-OF-PRED-INTERNAL", 1, 0, false);
        declareFunction(me, "effect_arg_num_of_pred", "EFFECT-ARG-NUM-OF-PRED", 1, 0, false);
        declareFunction(me, "get_new_proof_view_entry_id", "GET-NEW-PROOF-VIEW-ENTRY-ID", 1, 0, false);
        declareFunction(me, "proof_view_add_used_support", "PROOF-VIEW-ADD-USED-SUPPORT", 2, 0, false);
        declareFunction(me, "proof_view_add_assert_info_entries", "PROOF-VIEW-ADD-ASSERT-INFO-ENTRIES", 4, 0, false);
        declareFunction(me, "suppress_proof_view_section_with_rootP", "SUPPRESS-PROOF-VIEW-SECTION-WITH-ROOT?", 1, 0, false);
        declareFunction(me, "proof_view_possibly_register_source", "PROOF-VIEW-POSSIBLY-REGISTER-SOURCE", 2, 1, false);
        declareFunction(me, "proof_view_set_source_isg", "PROOF-VIEW-SET-SOURCE-ISG", 2, 0, false);
        declareFunction(me, "proof_view_set_source_index", "PROOF-VIEW-SET-SOURCE-INDEX", 2, 0, false);
        declareFunction(me, "proof_view_add_circular_support_entry", "PROOF-VIEW-ADD-CIRCULAR-SUPPORT-ENTRY", 4, 0, false);
        declareFunction(me, "add_trivial_proof_view_entry", "ADD-TRIVIAL-PROOF-VIEW-ENTRY", 4, 0, false);
        return NIL;
    }
    ...
    public static final class $proof_view_populator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(proof_view_populator.$proof_view_populator_native.class, PROOF_VIEW_POPULATOR, PROOF_VIEW_POPULATOR_P, $list2, $list3, new String[]{ "$proof_view", "$worker_semaphore", "$master_semaphore", "$process" }, $list4, $list5, PRINT_PROOF_VIEW_POPULATOR);
        }
    }
