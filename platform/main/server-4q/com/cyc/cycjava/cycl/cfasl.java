...
import static com.cyc.tool.subl.jrtl.translatedCode.sublisp.streams_high.read_byte_sequence_into_string;
...
import static com.cyc.tool.subl.jrtl.translatedCode.sublisp.streams_high.unread_byte;
...
import static com.cyc.tool.subl.jrtl.translatedCode.sublisp.streams_high.write_string_to_byte_sequence;
...
public final class cfasl extends SubLTranslatedFile implements V10 {
    ...
    static private final SubLList $list2 = list(makeSymbol("INTERNAL-STREAM"), makeSymbol("COUNT"));

    static private final SubLList $list3 = list(makeKeyword("INTERNAL-STREAM"), makeKeyword("COUNT"));

    static private final SubLList $list4 = list(makeSymbol("CFASL-ENCODING-STREAM-INTERNAL-STREAM"), makeSymbol("CFASL-ENCODING-STREAM-COUNT"));

    static private final SubLList $list5 = list(makeSymbol("_CSETF-CFASL-ENCODING-STREAM-INTERNAL-STREAM"), makeSymbol("_CSETF-CFASL-ENCODING-STREAM-COUNT"));
    ...
    static private final SubLList $list31 = list(list(makeSymbol("STREAM"), makeSymbol("BYTE-VECTOR")), makeSymbol("&BODY"), makeSymbol("BODY"));
    ...
    static private final SubLList $list46 = list(makeSymbol("OPTIMIZE-FUNCALL"), makeSymbol("CFASL-DECODING-STREAM-P"));
    ...
    static private final SubLList $list78 = list(list(makeSymbol("*CFASL-STREAM-EXTENSIONS-ENABLED*"), T), list(makeSymbol("*CFASL-UNREAD-BYTE*"), NIL));
	...
	assert NIL != cfasl_encoding_stream_p(v_object) : "cfasl.cfasl_encoding_stream_p error :" + v_object;
	...
	assert NIL != cfasl_decoding_stream_p(v_object) : "cfasl.cfasl_decoding_stream_p error :" + v_object;
	return v_object.getField2();
    }
	...
	for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
	    ...
	    } else if (pcase_var.eql($POSITION)) {
	...
	assert NIL != cfasl_count_stream_p(v_object) : "cfasl.cfasl_count_stream_p error :" + v_object;
	return v_object.getField2();
    }
	...
	} else if (phase.eql($SLOT)) {
	    cfasl_output(param_a, stream);
	    cfasl_output(param_b, stream);
	} else if (phase.eql($END)) {
	}
	...
	} else if (value.numL($int$8388608)) {
	    if (NIL != positive) {
	...
	} else if (value.numL($int$2147483648)) {
	    if (NIL != positive) {
	...
	declareFunction("cfasl_encoding_stream_count", "CFASL-ENCODING-STREAM-COUNT", 1, 0, false);
	declareFunction("_csetf_cfasl_encoding_stream_internal_stream", "_CSETF-CFASL-ENCODING-STREAM-INTERNAL-STREAM", 2, 0, false);
	declareFunction("_csetf_cfasl_encoding_stream_count", "_CSETF-CFASL-ENCODING-STREAM-COUNT", 2, 0, false);
	declareFunction("make_cfasl_encoding_stream", "MAKE-CFASL-ENCODING-STREAM", 0, 1, false);
	declareFunction("visit_defstruct_cfasl_encoding_stream", "VISIT-DEFSTRUCT-CFASL-ENCODING-STREAM", 2, 0, false);
	declareFunction("visit_defstruct_object_cfasl_encoding_stream_method", "VISIT-DEFSTRUCT-OBJECT-CFASL-ENCODING-STREAM-METHOD", 2, 0, false);
	...
	declareFunction("cfasl_encoding_stream_hexchar_position", "CFASL-ENCODING-STREAM-HEXCHAR-POSITION", 1, 0, false);
	declareFunction("cfasl_encoding_stream_byte_position", "CFASL-ENCODING-STREAM-BYTE-POSITION", 1, 0, false);
	...
	declareFunction("cfasl_decoding_stream_position", "CFASL-DECODING-STREAM-POSITION", 1, 0, false);
	declareFunction("_csetf_cfasl_decoding_stream_internal_stream", "_CSETF-CFASL-DECODING-STREAM-INTERNAL-STREAM", 2, 0, false);
	declareFunction("_csetf_cfasl_decoding_stream_position", "_CSETF-CFASL-DECODING-STREAM-POSITION", 2, 0, false);
	declareFunction("make_cfasl_decoding_stream", "MAKE-CFASL-DECODING-STREAM", 0, 1, false);
	declareFunction("visit_defstruct_cfasl_decoding_stream", "VISIT-DEFSTRUCT-CFASL-DECODING-STREAM", 2, 0, false);
	declareFunction("visit_defstruct_object_cfasl_decoding_stream_method", "VISIT-DEFSTRUCT-OBJECT-CFASL-DECODING-STREAM-METHOD", 2, 0, false);
	...
	declareFunction("cfasl_decoding_stream_nybble_position", "CFASL-DECODING-STREAM-NYBBLE-POSITION", 1, 0, false);
	declareFunction("cfasl_decode", "CFASL-DECODE", 1, 0, false);
	declareFunction("cfasl_decoding_stream_byte_position", "CFASL-DECODING-STREAM-BYTE-POSITION", 1, 0, false);
	declareFunction("cfasl_decoding_stream_hexchar_position", "CFASL-DECODING-STREAM-HEXCHAR-POSITION", 1, 0, false);
	...
	declareFunction("visit_defstruct_cfasl_count_stream", "VISIT-DEFSTRUCT-CFASL-COUNT-STREAM", 2, 0, false);
	declareFunction("visit_defstruct_object_cfasl_count_stream_method", "VISIT-DEFSTRUCT-OBJECT-CFASL-COUNT-STREAM-METHOD", 2, 0, false);
	...
	declareFunction("cfasl_count_stream_increment", "CFASL-COUNT-STREAM-INCREMENT", 2, 0, false);
	...
	declareFunction("cfasl_test_externalized", "CFASL-TEST-EXTERNALIZED", 1, 0, false);
	...
	static {
	    structDecl = makeStructDeclNative($cfasl_encoding_stream_native.class, CFASL_ENCODING_STREAM, CFASL_ENCODING_STREAM_P, $list2, $list3, new String[] { "$internal_stream", "$count" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
	}
    }
	...
	private $cfasl_decoding_stream_native() {
	    this.$internal_stream = Lisp.NIL;
	...
	static {
	    structDecl = makeStructDeclNative($cfasl_decoding_stream_native.class, CFASL_DECODING_STREAM, CFASL_DECODING_STREAM_P, $list41, $list42, new String[] { "$internal_stream", "$position" }, $list43, $list44, DEFAULT_STRUCT_PRINT_FUNCTION);
	}
    }
	...
	private $cfasl_count_stream_native() {
	    this.$position = Lisp.NIL;
	}
	...
	static {
	    structDecl = makeStructDeclNative($cfasl_count_stream_native.class, CFASL_COUNT_STREAM, CFASL_COUNT_STREAM_P, $list64, $list65, new String[] { "$position" }, $list66, $list67, DEFAULT_STRUCT_PRINT_FUNCTION);
	}
    }
