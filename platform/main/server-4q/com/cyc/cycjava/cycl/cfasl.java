...
public final class cfasl extends SubLTranslatedFile {
	...
	private static final SubLList $list130 = ConsesLow.list(makeSymbol("INLINE"), makeSymbol("ASSEMBLE-2-FIXNUMS-TO-NON-NEGATIVE-INTEGER"), makeSymbol("ASSEMBLE-3-FIXNUMS-TO-NON-NEGATIVE-INTEGER"), makeSymbol("ASSEMBLE-4-FIXNUMS-TO-NON-NEGATIVE-INTEGER"));
	...
	public static SubLObject with_cfasl_output_to_hex_string(final SubLObject macroform, final SubLObject environment) {
		...
		return ConsesLow.list($sym23$CLET, ConsesLow.list(reader.bq_cons(stream, $list24)), ConsesLow.list($sym25$CUNWIND_PROTECT, reader.bq_cons($sym26$PROGN, ConsesLow.append(body, ConsesLow.list(ConsesLow.list($sym27$CSETQ, string, ConsesLow.list($sym28$CFASL_ENCODING_STRING_STREAM_ENCODING, stream))))), ConsesLow.list($sym29$CLOSE_CFASL_ENCODING_STREAM, stream)));
	}
	...
	public static SubLObject with_cfasl_output_to_byte_vector(final SubLObject macroform, final SubLObject environment) {
		...
		return ConsesLow.list($sym23$CLET, ConsesLow.list(reader.bq_cons(stream, $list24)), ConsesLow.list($sym25$CUNWIND_PROTECT, reader.bq_cons($sym26$PROGN, ConsesLow.append(body, ConsesLow.list(ConsesLow.list($sym27$CSETQ, byte_vector, ConsesLow.list($sym32$CFASL_ENCODING_STREAM_ENCODING, stream))))), ConsesLow.list($sym29$CLOSE_CFASL_ENCODING_STREAM, stream)));
	}
	...
	public static SubLObject cfasl_encode_externalized_terse(final SubLObject v_object) {
		...
		try {
			$terse_guid_serialization_enabledP$.bind(($terse_guid_serialization_enabled_for_cfasl_encode_externalizedP$.getDynamicValue(thread) == $kw38$UNINITIALIZED) ? T : $terse_guid_serialization_enabled_for_cfasl_encode_externalizedP$.getDynamicValue(thread), thread);
			final SubLObject stream = new_cfasl_encoding_stream();
			try {
				cfasl_output_externalized(v_object, stream);
				encoding = cfasl_encoding_stream_encoding(stream);
	...
	public static SubLObject with_cfasl_input_from_string(final SubLObject macroform, final SubLObject environment) {
		...
		current = (body = temp);
		assert NIL != Types.symbolp(stream) : stream;
		return ConsesLow.list($sym23$CLET, ConsesLow.list(ConsesLow.list(stream, ConsesLow.list($sym54$NEW_CFASL_DECODING_STREAM_FROM_STRING, string))), ConsesLow.list($sym25$CUNWIND_PROTECT, reader.bq_cons($sym26$PROGN, ConsesLow.append(body, NIL)), ConsesLow.list($sym55$CLOSE_CFASL_DECODING_STREAM, stream)));
	}
	...
	public static SubLObject with_cfasl_input_from_byte_vector(final SubLObject macroform, final SubLObject environment) {
		...
		current = (body = temp);
		assert NIL != Types.symbolp(stream) : stream;
		return ConsesLow.list($sym23$CLET, ConsesLow.list(ConsesLow.list(stream, ConsesLow.list($sym57$NEW_CFASL_DECODING_STREAM, byte_vector))), ConsesLow.list($sym25$CUNWIND_PROTECT, reader.bq_cons($sym26$PROGN, ConsesLow.append(body, NIL)), ConsesLow.list($sym55$CLOSE_CFASL_DECODING_STREAM, stream)));
	}
	...
	public static SubLObject with_cfasl_output_to_count_stream(final SubLObject macroform, final SubLObject environment) {
		...
		return ConsesLow.list($sym23$CLET, ConsesLow.list(reader.bq_cons(stream, $list75)), ConsesLow.list($sym25$CUNWIND_PROTECT, reader.bq_cons($sym26$PROGN, ConsesLow.append(body, ConsesLow.list(ConsesLow.list($sym27$CSETQ, count, ConsesLow.list($sym76$CFASL_COUNT_STREAM_SIZE, stream))))), ConsesLow.list($sym77$CLOSE_CFASL_COUNT_STREAM, stream)));
	}
	...
	public static SubLObject declare_cfasl_opcode(final SubLObject macroform, final SubLObject environment) {
		...
		return ConsesLow.list($sym26$PROGN, ConsesLow.list($sym91$DEFCONSTANT_PRIVATE, variable, cfasl_opcode), ConsesLow.list($sym92$REGISTER_CFASL_INPUT_FUNCTION, variable, ConsesLow.list($sym93$QUOTE, input_function)));
	}
	...
	public static SubLObject declare_cfasl_extension_opcode(final SubLObject macroform, final SubLObject environment) {
		...
		return ConsesLow.list($sym26$PROGN, ConsesLow.list($sym94$DECLARE_CFASL_OPCODE, variable, cfasl_opcode, input_func), ConsesLow.list($sym104$REGISTER_CFASL_EXTENSION, variable, ConsesLow.list($sym93$QUOTE, pred_func), ConsesLow.list($sym93$QUOTE, output_func), ConsesLow.list($sym93$QUOTE, input_func)));
	}
	...
	public static SubLObject cyc_package_symbol_p(final SubLObject v_object) {
		return makeBoolean(v_object.isSymbol() && !v_object.isKeyword() && (control_vars.$cyc_package$.getGlobalValue().eql(Symbols.symbol_package(v_object)) || v_object.eql(Packages.find_symbol(Symbols.symbol_name(v_object), control_vars.$cyc_package$.getGlobalValue()))));
	}
	...
	public static SubLObject cfasl_common_symbol_p(final SubLObject v_object) {
		final SubLThread thread = SubLProcess.currentSubLThread();
		return makeBoolean(NIL != $cfasl_common_symbols$.getDynamicValue(thread) && v_object.isSymbol() && NIL != Sequences.position(v_object, $cfasl_common_symbols$.getDynamicValue(thread), Symbols.symbol_function(EQ), UNPROVIDED, UNPROVIDED, UNPROVIDED));
	}
	...
	public static SubLObject cfasl_decode_common_symbol(final SubLObject integer) {
		final SubLThread thread = SubLProcess.currentSubLThread();
		return $cfasl_common_symbols$.getDynamicValue(thread).isVector() ? Vectors.aref($cfasl_common_symbols$.getDynamicValue(thread), integer) : ConsesLow.nth(integer, $cfasl_common_symbols$.getDynamicValue(thread));
	}
	...
	public static SubLObject declare_wide_cfasl_opcode(final SubLObject macroform, final SubLObject environment) {
		...
		return ConsesLow.list($sym26$PROGN, ConsesLow.list($sym91$DEFCONSTANT_PRIVATE, variable, wide_opcode), ConsesLow.list($sym184$REGISTER_WIDE_CFASL_OPCODE_INPUT_FUNCTION, variable, ConsesLow.list($sym93$QUOTE, input_function)));
	}
	...
	public static SubLObject declare_cfasl_guid_opcode(final SubLObject macroform, final SubLObject environment) {
		...
		assert NIL != Types.symbolp(input_function) : input_function;
		return ConsesLow.list($sym26$PROGN, ConsesLow.list($sym197$DEFLEXICAL_PRIVATE, variable, cfasl_guid_opcode), ConsesLow.list($sym198$REGISTER_CFASL_GUID_DENOTED_TYPE_INPUT_FUNCTION, variable, ConsesLow.list($sym93$QUOTE, input_function)));
	}
	...
	public static SubLObject declare_cfasl_guid_string_opcode(final SubLObject macroform, final SubLObject environment) {
		...
		assert NIL != Types.symbolp(input_function) : input_function;
		return ConsesLow.list($sym26$PROGN, ConsesLow.list($sym197$DEFLEXICAL_PRIVATE, variable, ConsesLow.list($sym201$STRING_TO_GUID, cfasl_guid_string_opcode)), ConsesLow.list($sym198$REGISTER_CFASL_GUID_DENOTED_TYPE_INPUT_FUNCTION, variable, ConsesLow.list($sym93$QUOTE, input_function)));
	}
	...
	public static SubLObject init_cfasl_file() {
		...
		$cfasl_input_method_table$ = SubLFiles.deflexical("*CFASL-INPUT-METHOD-TABLE*", maybeDefault($sym88$_CFASL_INPUT_METHOD_TABLE_, $cfasl_input_method_table$, () -> (Vectors.make_vector($cfasl_max_opcode$.getGlobalValue(), $sym85$CFASL_INPUT_ERROR))));
		...
		$cfasl_wide_opcode_input_method_table$ = SubLFiles.deflexical("*CFASL-WIDE-OPCODE-INPUT-METHOD-TABLE*", maybeDefault($sym180$_CFASL_WIDE_OPCODE_INPUT_METHOD_TABLE_, $cfasl_wide_opcode_input_method_table$, () -> (Hashtables.make_hash_table($int131$32, Symbols.symbol_function(EQL), UNPROVIDED))));
		...
		$cfasl_guid_denoted_type_input_method_table$ = SubLFiles.deflexical("*CFASL-GUID-DENOTED-TYPE-INPUT-METHOD-TABLE*", maybeDefault($sym193$_CFASL_GUID_DENOTED_TYPE_INPUT_METHOD_TABLE_, $cfasl_guid_denoted_type_input_method_table$, () -> (Hashtables.make_hash_table($int194$100, Symbols.symbol_function(EQUALP), UNPROVIDED))));
		return NIL;
	}
	...
	public static SubLObject setup_cfasl_file() {
		...
		Structures.register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_cfasl_encoding_stream$.getGlobalValue(), Symbols.symbol_function($sym20$VISIT_DEFSTRUCT_OBJECT_CFASL_ENCODING_STREAM_METHOD));
		...
		Structures.register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_cfasl_decoding_stream$.getGlobalValue(), Symbols.symbol_function($sym53$VISIT_DEFSTRUCT_OBJECT_CFASL_DECODING_STREAM_METHOD));
		...
		Structures.register_method(visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_cfasl_count_stream$.getGlobalValue(), Symbols.symbol_function($sym73$VISIT_DEFSTRUCT_OBJECT_CFASL_COUNT_STREAM_METHOD));
	...
	public static final class $cfasl_encoding_stream_native extends SubLStructNative {
		...
		static {
			structDecl = Structures.makeStructDeclNative($cfasl_encoding_stream_native.class, $sym0$CFASL_ENCODING_STREAM, $sym1$CFASL_ENCODING_STREAM_P, $list2, $list3, new String[] { "$internal_stream", "$count" }, $list4, $list5, $sym6$DEFAULT_STRUCT_PRINT_FUNCTION);
		}
	}
	...
	public static final class $cfasl_decoding_stream_native extends SubLStructNative {
		...
		static {
			structDecl = Structures.makeStructDeclNative($cfasl_decoding_stream_native.class, $sym39$CFASL_DECODING_STREAM, $sym40$CFASL_DECODING_STREAM_P, $list41, $list42, new String[] { "$internal_stream", "$position" }, $list43, $list44, $sym6$DEFAULT_STRUCT_PRINT_FUNCTION);
		}
	}
	...
	public static final class $cfasl_count_stream_native extends SubLStructNative {
		...
		static {
			structDecl = Structures.makeStructDeclNative($cfasl_count_stream_native.class, $sym62$CFASL_COUNT_STREAM, $sym63$CFASL_COUNT_STREAM_P, $list64, $list65, new String[] { "$position" }, $list66, $list67, $sym6$DEFAULT_STRUCT_PRINT_FUNCTION);
		}
	}
