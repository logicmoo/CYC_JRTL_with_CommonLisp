...
import static com.cyc.cycjava.cycl.plausibility_utilities.*;
...
public final class plausibility_utilities extends SubLTranslatedFile {
    ...
    private static final SubLList $list1 = list(new SubLObject[]{ makeKeyword("JUSTIFY?"), makeKeyword("RETURN-BOOLEAN?"), makeKeyword("PERCENT-CUTOFF"), makeKeyword("PERCENT-CLIPPING?"), makeKeyword("MAX-TIME"), makeKeyword("MAX-STEP"), makeKeyword("CLEAR-CACHES?"), makeKeyword("GATHER-STATS?"), makeKeyword("SUPPRESS-WFF-CHECKS?"), makeKeyword("WFF-CHECK-TYPE"), makeKeyword("SUPPRESS-WFT-CHECKS?"), makeKeyword("WFT-CHECK-TYPE"), makeKeyword("SUPPRESS-WF-CHECKS?"), makeKeyword("SUPPRESS-PLAUSIBLE-NART?"), makeKeyword("FORCE-GENLS-TRUTH-CHECK?") });
    ...
    private static final SubLList $list58 = list(makeKeyword("RELATION-DIRECTION"), makeKeyword("FROM"), makeKeyword("COL-ARG"), T);
    ...
    private static final SubLList $list62 = list(makeKeyword("RELATION-DIRECTION"), makeKeyword("FROM"), makeKeyword("COL-ARG"), T, makeKeyword("INVERSE-SUBSET"), T);
    ...
    private static final SubLList $list68 = list(makeKeyword("RELATION-DIRECTION"), makeKeyword("FROM"), makeKeyword("COL-ARG"), NIL);
    ...
    private static final SubLList $list72 = list(makeKeyword("RELATION-DIRECTION"), makeKeyword("FROM"), makeKeyword("COL-ARG"), NIL, makeKeyword("INVERSE-SUBSET"), T);
    ...
    public static SubLObject implausible_sentenceP(final SubLObject sentence, SubLObject mt, SubLObject v_properties, SubLObject depth) {
        ...
        if ((NIL != get_implausibility_property($kw21$GATHER_STATS_, v_properties, UNPROVIDED)) && $implausibility_stats_table$.getDynamicValue(thread).isHashtable()) {
            if ((NIL != timed_outP) || ((max_time.isNumber() && actual_time.isNumber()) && actual_time.numG(max_time))) {
                ...
                if (plausibility_factor.numL(percent_cutoff)) {
    ...
    public static SubLObject implausible_nautP_recursive(final SubLObject v_object, final SubLObject mt, final SubLObject justifyP, final SubLObject v_properties, final SubLObject depth) {
        ...
        if (NIL == plausibility_factor) {
            if (T == getf(functor_categories, $COL_ARG, UNPROVIDED)) {
                ...
                if ((NIL != functor_categories) && (NIL == getf(functor_categories, $COL_ARG, UNPROVIDED))) {
                    SubLObject current;
                    final SubLObject datum = current = cycl_utilities.naut_args(v_object, UNPROVIDED);
                    SubLObject col_arg = NIL;
                    SubLObject pred = NIL;
                    ...
                    if (NIL != kb_utilities.kbeq(functor, $$CollectionIntersection2Fn)) {
                        SubLObject current;
                        final SubLObject datum = current = cycl_utilities.naut_args(v_object, UNPROVIDED);
                        SubLObject col3 = NIL;
                        SubLObject col4 = NIL;
                        ...
                        if (NIL != kb_utilities.kbeq(functor, $$CollectionUnionFn)) {
    ...
    public static SubLObject categorize_subcollection_predicate_internal(final SubLObject pred) {
        return pred.eql($const55$SubcollectionOfWithRelationToType) ? $list56 : pred.eql($const57$SubcollectionOfWithRelationFromTy) ? $list58 : pred.eql($const59$SubcollectionOfWithoutRelationToT) ? $list60 : pred.eql($const61$SubcollectionOfWithoutRelationFro) ? $list62 : pred.eql($const63$SitTypeSpecWithTypeRestrictionOnR) ? $list64 : pred.eql($$SubcollectionOfWithRelationToFn) ? $list66 : pred.eql($$SubcollectionOfWithRelationFromFn) ? $list68 : pred.eql($const69$SubcollectionOfWithoutRelationToF) ? $list70 : pred.eql($const71$SubcollectionOfWithoutRelationFro) ? $list72 : pred.eql($$UsingAForFn) ? $list74 : NIL;
    }
    ...
    public static SubLObject implausible_thing_wrt_arg_isa_constraintP(final SubLObject pred, final SubLObject argnum, final SubLObject thing, final SubLObject mt, final SubLObject justifyP) {
        ...
        if ((NIL != closedP(pred, UNPROVIDED)) && (NIL != closedP(thing, UNPROVIDED))) {
            ...
            if ((NIL != thing_isa_constraints) && (NIL != (NIL != cycl_grammar.cycl_unrepresented_term_p(thing) ? makeBoolean(NIL == at_defns.quiet_has_any_typeP(thing, thing_isa_constraints, mt)) : disjoint_with.any_disjoint_with_anyP_memoized(isa.isa(thing, mt, UNPROVIDED), thing_isa_constraints, mt, UNPROVIDED, UNPROVIDED)))) {
                plausibility_factor = $plausibility_factor_arg_disjointness$.getDynamicValue(thread);
                if (NIL != justifyP) {
                    ...
                    while ((NIL == plausibility_factor) && (NIL != csome_list_var)) {
                        if (NIL == plausibility_factor) {
                            ...
                            while ((NIL == plausibility_factor) && (NIL != csome_list_var_$85)) {
                                final SubLObject tva_sentence = ((argnum.eql(ONE_INTEGER) && (arg_order == $PRED)) || (argnum.eql(TWO_INTEGER) && (arg_order == $INVERSE))) ? make_binary_formula($$typicallyMoreVoluminousThan, this_type, this_col) : (argnum.eql(ONE_INTEGER) && (arg_order == $INVERSE)) || (argnum.eql(TWO_INTEGER) && (arg_order == $PRED)) ? make_binary_formula($$typicallyMoreVoluminousThan, this_col, this_type) : NIL;
    ...
    public static SubLObject implied_argn_type_requirements_for_pred_internal(final SubLObject pred, final SubLObject argnum, final SubLObject col, final SubLObject mt, final SubLObject justifyP) {
        ...
        return argnum.eql(TWO_INTEGER) ? tva_unify_with_variable_lookup_and_values(list($$relationNotExistsExists, pred, col, var0), var0, mt, NIL, justifyP, UNPROVIDED, UNPROVIDED, UNPROVIDED) : argnum.eql(ONE_INTEGER) ? tva_unify_with_variable_lookup_and_values(list($$relationNotExistsExists, pred, var0, col), var0, mt, NIL, justifyP, UNPROVIDED, UNPROVIDED, UNPROVIDED) : NIL;
    }
    ...
    public static SubLObject implausible_admitted_argument_intP(final SubLObject v_term, final SubLObject argnum, final SubLObject relation, final SubLObject mt) {
        ...
        return makeBoolean((((NIL != kb_accessors.relationP(relation)) && ((!v_arity.isNumber()) || v_arity.numGE(argnum))) && (argnum.numG(ZERO_INTEGER) || (argnum.numE(ZERO_INTEGER) && (NIL != kb_utilities.kbeq(v_term, relation))))) && (NIL != arg_type.relation_arg_okP(relation, v_term, argnum, mt)));
    }
    ...
    public static SubLObject declare_plausibility_utilities_file() {
        declareFunction(me, "sentence_plausibility_factor", "SENTENCE-PLAUSIBILITY-FACTOR", 1, 2, false);
        declareFunction(me, "why_sentence_plausibility_factor", "WHY-SENTENCE-PLAUSIBILITY-FACTOR", 1, 2, false);
        declareFunction(me, "sentence_plausibility_score", "SENTENCE-PLAUSIBILITY-SCORE", 1, 2, false);
        declareFunction(me, "why_sentence_plausibility_score", "WHY-SENTENCE-PLAUSIBILITY-SCORE", 1, 2, false);
        declareFunction(me, "implausible_sentenceP", "IMPLAUSIBLE-SENTENCE?", 1, 3, false);
        declareFunction(me, "implausible_nautP", "IMPLAUSIBLE-NAUT?", 1, 3, false);
        declareFunction(me, "get_implausibility_property", "GET-IMPLAUSIBILITY-PROPERTY", 2, 1, false);
        declareFunction(me, "implausible_sentenceP_recursive", "IMPLAUSIBLE-SENTENCE?-RECURSIVE", 5, 0, false);
        declareFunction(me, "implausible_nautP_recursive", "IMPLAUSIBLE-NAUT?-RECURSIVE", 5, 0, false);
        declareFunction(me, "categorize_subcollection_predicate_internal", "CATEGORIZE-SUBCOLLECTION-PREDICATE-INTERNAL", 1, 0, false);
        declareFunction(me, "categorize_subcollection_predicate", "CATEGORIZE-SUBCOLLECTION-PREDICATE", 1, 0, false);
        declareFunction(me, "possibly_find_nart", "POSSIBLY-FIND-NART", 1, 0, false);
        declareFunction(me, "possible_naut_genls", "POSSIBLE-NAUT-GENLS", 1, 0, false);
        declareFunction(me, "implausible_sentence_wrt_variable_argumentsP", "IMPLAUSIBLE-SENTENCE-WRT-VARIABLE-ARGUMENTS?", 4, 0, false);
        declareFunction(me, "implausible_term_wrt_wft", "IMPLAUSIBLE-TERM-WRT-WFT", 5, 0, false);
        declareFunction(me, "implausible_sentence_wrt_wff", "IMPLAUSIBLE-SENTENCE-WRT-WFF", 5, 0, false);
        declareFunction(me, "implausible_genlsP", "IMPLAUSIBLE-GENLS?", 5, 0, false);
        declareFunction(me, "implausible_isaP", "IMPLAUSIBLE-ISA?", 5, 0, false);
        declareFunction(me, "implausible_typeP", "IMPLAUSIBLE-TYPE?", 3, 0, false);
        declareFunction(me, "implausible_col_wrt_arg_isa_constraintP", "IMPLAUSIBLE-COL-WRT-ARG-ISA-CONSTRAINT?", 5, 0, false);
        declareFunction(me, "implausible_col_wrt_arg_sometimes_isa_constraintP", "IMPLAUSIBLE-COL-WRT-ARG-SOMETIMES-ISA-CONSTRAINT?", 5, 0, false);
        declareFunction(me, "implausible_thing_wrt_arg_isa_constraintP", "IMPLAUSIBLE-THING-WRT-ARG-ISA-CONSTRAINT?", 5, 0, false);
        declareFunction(me, "implausible_thing_wrt_arg_sometimes_isa_constraintP", "IMPLAUSIBLE-THING-WRT-ARG-SOMETIMES-ISA-CONSTRAINT?", 5, 0, false);
        declareFunction(me, "implausible_col_wrt_implied_argn_type_requirements_for_predP", "IMPLAUSIBLE-COL-WRT-IMPLIED-ARGN-TYPE-REQUIREMENTS-FOR-PRED?", 6, 0, false);
        declareFunction(me, "implausible_thing_wrt_implied_argn_type_requirements_for_predP", "IMPLAUSIBLE-THING-WRT-IMPLIED-ARGN-TYPE-REQUIREMENTS-FOR-PRED?", 6, 0, false);
        declareFunction(me, "implausible_col_wrt_implied_argn_type_restrictions_for_predP", "IMPLAUSIBLE-COL-WRT-IMPLIED-ARGN-TYPE-RESTRICTIONS-FOR-PRED?", 6, 0, false);
        declareFunction(me, "implausible_thing_wrt_implied_argn_type_restrictions_for_predP", "IMPLAUSIBLE-THING-WRT-IMPLIED-ARGN-TYPE-RESTRICTIONS-FOR-PRED?", 6, 0, false);
        declareFunction(me, "implausible_col_wrt_genls_pred_disjointnessP", "IMPLAUSIBLE-COL-WRT-GENLS-PRED-DISJOINTNESS?", 6, 0, false);
        declareFunction(me, "implausible_col_wrt_isa_pred_disjointnessP", "IMPLAUSIBLE-COL-WRT-ISA-PRED-DISJOINTNESS?", 6, 0, false);
        declareFunction(me, "implausible_col_wrt_typical_volumeP", "IMPLAUSIBLE-COL-WRT-TYPICAL-VOLUME?", 6, 0, false);
        declareFunction(me, "implausible_intersection_of_two_colsP", "IMPLAUSIBLE-INTERSECTION-OF-TWO-COLS?", 4, 0, false);
        declareFunction(me, "implausible_union_of_colsP", "IMPLAUSIBLE-UNION-OF-COLS?", 3, 0, false);
        declareFunction(me, "esoteric_termP", "ESOTERIC-TERM?", 1, 0, false);
        declareFunction(me, "exoteric_termP", "EXOTERIC-TERM?", 1, 0, false);
        declareFunction(me, "clear_plausibility_caches", "CLEAR-PLAUSIBILITY-CACHES", 0, 0, false);
        declareFunction(me, "print_plausibility_cache_sizes", "PRINT-PLAUSIBILITY-CACHE-SIZES", 0, 0, false);
        declareFunction(me, "clear_tweak_implausibility_type_restrictions", "CLEAR-TWEAK-IMPLAUSIBILITY-TYPE-RESTRICTIONS", 0, 0, false);
        declareFunction(me, "remove_tweak_implausibility_type_restrictions", "REMOVE-TWEAK-IMPLAUSIBILITY-TYPE-RESTRICTIONS", 2, 0, false);
        declareFunction(me, "tweak_implausibility_type_restrictions_internal", "TWEAK-IMPLAUSIBILITY-TYPE-RESTRICTIONS-INTERNAL", 2, 0, false);
        declareFunction(me, "tweak_implausibility_type_restrictions", "TWEAK-IMPLAUSIBILITY-TYPE-RESTRICTIONS", 2, 0, false);
        declareFunction(me, "clear_implied_argn_type_requirements_for_pred", "CLEAR-IMPLIED-ARGN-TYPE-REQUIREMENTS-FOR-PRED", 0, 0, false);
        declareFunction(me, "remove_implied_argn_type_requirements_for_pred", "REMOVE-IMPLIED-ARGN-TYPE-REQUIREMENTS-FOR-PRED", 5, 0, false);
        declareFunction(me, "implied_argn_type_requirements_for_pred_internal", "IMPLIED-ARGN-TYPE-REQUIREMENTS-FOR-PRED-INTERNAL", 5, 0, false);
        declareFunction(me, "implied_argn_type_requirements_for_pred", "IMPLIED-ARGN-TYPE-REQUIREMENTS-FOR-PRED", 5, 0, false);
        declareFunction(me, "clear_implied_argn_type_restrictions_for_pred", "CLEAR-IMPLIED-ARGN-TYPE-RESTRICTIONS-FOR-PRED", 0, 0, false);
        declareFunction(me, "remove_implied_argn_type_restrictions_for_pred", "REMOVE-IMPLIED-ARGN-TYPE-RESTRICTIONS-FOR-PRED", 5, 0, false);
        declareFunction(me, "implied_argn_type_restrictions_for_pred_internal", "IMPLIED-ARGN-TYPE-RESTRICTIONS-FOR-PRED-INTERNAL", 5, 0, false);
        declareFunction(me, "implied_argn_type_restrictions_for_pred", "IMPLIED-ARGN-TYPE-RESTRICTIONS-FOR-PRED", 5, 0, false);
        declareFunction(me, "tva_unify_with_variable_lookup_and_values", "TVA-UNIFY-WITH-VARIABLE-LOOKUP-AND-VALUES", 2, 6, false);
        declareFunction(me, "clear_tva_check_cached", "CLEAR-TVA-CHECK-CACHED", 0, 0, false);
        declareFunction(me, "remove_tva_check_cached", "REMOVE-TVA-CHECK-CACHED", 2, 0, false);
        declareFunction(me, "tva_check_cached_internal", "TVA-CHECK-CACHED-INTERNAL", 2, 0, false);
        declareFunction(me, "tva_check_cached", "TVA-CHECK-CACHED", 2, 0, false);
        declareFunction(me, "clear_implausible_admitted_argumentP", "CLEAR-IMPLAUSIBLE-ADMITTED-ARGUMENT?", 0, 0, false);
        declareFunction(me, "remove_implausible_admitted_argumentP", "REMOVE-IMPLAUSIBLE-ADMITTED-ARGUMENT?", 3, 1, false);
        declareFunction(me, "implausible_admitted_argumentP_internal", "IMPLAUSIBLE-ADMITTED-ARGUMENT?-INTERNAL", 4, 0, false);
        declareFunction(me, "implausible_admitted_argumentP", "IMPLAUSIBLE-ADMITTED-ARGUMENT?", 3, 1, false);
        declareFunction(me, "implausible_admitted_argument_intP", "IMPLAUSIBLE-ADMITTED-ARGUMENT-INT?", 4, 0, false);
        declareFunction(me, "implausible_admitted_argument_to_formulaP", "IMPLAUSIBLE-ADMITTED-ARGUMENT-TO-FORMULA?", 4, 1, false);
        declareFunction(me, "hl_justify_asent_fast", "HL-JUSTIFY-ASENT-FAST", 2, 0, false);
        declareFunction(me, "hl_justify_asent", "HL-JUSTIFY-ASENT", 2, 0, false);
        return NIL;
    }
