...
public final class sbhl_module_vars extends SubLTranslatedFile {
    ...
    public static SubLObject sbhl_module_p(final SubLObject v_object) {
        return v_object.getClass() == sbhl_module_vars.$sbhl_module_native.class ? T : NIL;
    }

    public static SubLObject sbhl_mod_link_pred(final SubLObject v_object) {
        assert NIL != sbhl_module_p(v_object) : "sbhl_module_vars.sbhl_module_p(v_object) " + "CommonSymbols.NIL != sbhl_module_vars.sbhl_module_p(v_object) " + v_object;
    ...
    public static SubLObject make_sbhl_module(SubLObject arglist) {
        ...
        final SubLObject v_new = new sbhl_module_vars.$sbhl_module_native();
        SubLObject next;
    ...
    public static final class $sbhl_module_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sbhl_module_vars.$sbhl_module_native.class, SBHL_MODULE, SBHL_MODULE_P, $list2, $list3, new String[]{ "$link_pred", "$accessible_link_preds", "$graph", "$link_style", "$index_arg", "$module_type", "$type_test", "$path_terminating_mark_fn", "$marking_fn", "$unmarking_fn", "$var_bindings", "$misc_properties" }, $list4, $list5, PRINT_SBHL_MODULE);
        }
    }
