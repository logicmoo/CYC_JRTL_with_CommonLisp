...
import com.cyc.cycjava.cycl.sbhl.sbhl_link_iterators;
...
import static com.cyc.cycjava.cycl.sbhl.sbhl_link_iterators.*;
...
public final class sbhl_link_iterators extends SubLTranslatedFile {
    ...
    public static SubLObject sbhl_link_node_search_state_iterator_state_p(final SubLObject v_object) {
        return v_object.getClass() == sbhl_link_iterators.$sbhl_link_node_search_state_iterator_state_native.class ? T : NIL;
    }
    ...
    public static SubLObject sbhl_link_node_search_state_iterator_state_sbhl_link_node_search_state(final SubLObject v_object) {
        assert NIL != sbhl_link_node_search_state_iterator_state_p(v_object) : "sbhl_link_iterators.sbhl_link_node_search_state_iterator_state_p(v_object) " + "CommonSymbols.NIL != sbhl_link_iterators.sbhl_link_node_search_state_iterator_state_p(v_object) " + v_object;
    ...
    public static SubLObject make_sbhl_link_node_search_state_iterator_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new sbhl_link_iterators.$sbhl_link_node_search_state_iterator_state_native();
        SubLObject next;
    ...
    public static SubLObject sbhl_module_direction_link_search_state_iterator_state_p(final SubLObject v_object) {
        return v_object.getClass() == sbhl_link_iterators.$sbhl_module_direction_link_search_state_iterator_state_native.class ? T : NIL;
    }
    ...
    public static SubLObject sbhl_module_direction_link_search_state_iterator_state_mt_link_iterator(final SubLObject v_object) {
        assert NIL != sbhl_module_direction_link_search_state_iterator_state_p(v_object) : "sbhl_link_iterators.sbhl_module_direction_link_search_state_iterator_state_p(v_object) " + "CommonSymbols.NIL != sbhl_link_iterators.sbhl_module_direction_link_search_state_iterator_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sbhl_module_direction_link_search_state_iterator_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new sbhl_link_iterators.$sbhl_module_direction_link_search_state_iterator_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sbhl_module_tv_link_node_search_state_iterator_state_p(final SubLObject v_object) {
        return v_object.getClass() == sbhl_link_iterators.$sbhl_module_tv_link_node_search_state_iterator_state_native.class ? T : NIL;
    }

    public static SubLObject sbhl_module_tv_link_node_search_state_iterator_state_tv_link_iterator(final SubLObject v_object) {
        assert NIL != sbhl_module_tv_link_node_search_state_iterator_state_p(v_object) : "sbhl_link_iterators.sbhl_module_tv_link_node_search_state_iterator_state_p(v_object) " + "CommonSymbols.NIL != sbhl_link_iterators.sbhl_module_tv_link_node_search_state_iterator_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sbhl_module_tv_link_node_search_state_iterator_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new sbhl_link_iterators.$sbhl_module_tv_link_node_search_state_iterator_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sbhl_module_naut_link_node_search_state_iterator_state_p(final SubLObject v_object) {
        return v_object.getClass() == sbhl_link_iterators.$sbhl_module_naut_link_node_search_state_iterator_state_native.class ? T : NIL;
    }
    ...
    public static SubLObject sbhl_module_naut_link_node_search_state_iterator_state_generating_functions(final SubLObject v_object) {
        assert NIL != sbhl_module_naut_link_node_search_state_iterator_state_p(v_object) : "sbhl_link_iterators.sbhl_module_naut_link_node_search_state_iterator_state_p(v_object) " + "CommonSymbols.NIL != sbhl_link_iterators.sbhl_module_naut_link_node_search_state_iterator_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sbhl_module_naut_link_node_search_state_iterator_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new sbhl_link_iterators.$sbhl_module_naut_link_node_search_state_iterator_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $sbhl_module_tv_link_node_search_state_iterator_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sbhl_link_iterators.$sbhl_module_tv_link_node_search_state_iterator_state_native.class, SBHL_MODULE_TV_LINK_NODE_SEARCH_STATE_ITERATOR_STATE, SBHL_MODULE_TV_LINK_NODE_SEARCH_STATE_ITERATOR_STATE_P, $list68, $list69, new String[]{ "$tv_link_iterator", "$current_tv", "$current_remaining_nodes", "$module", "$parent_node", "$direction", "$mt", "$genl_inverse_modeP" }, $list70, $list71, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
