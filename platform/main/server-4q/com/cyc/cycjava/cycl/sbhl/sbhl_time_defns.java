...
public final class sbhl_time_defns
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject cyc_el_interval_ended_by_last_subinterval_of_type(final SubLObject interval, final SubLObject type)
  {
    ...
    if( NIL == result )
    {
      result = el_utilities.make_binary_formula( $const2$IntervalEndedByLastSubintervalOfT, interval, type );
    }
    return result;
  }
  ...
  public static SubLObject cyc_el_interval_started_by_first_subinterval_of_type(final SubLObject interval, final SubLObject type)
  {
    ...
    if( NIL == result )
    {
      result = el_utilities.make_binary_formula( $const5$IntervalStartedByFirstSubinterval, interval, type );
    }
    return result;
  }
  ...
  public static SubLObject cyc_el_nth_metrically_preceding_time_interval_of_type(final SubLObject n, final SubLObject interval, final SubLObject type)
  {
    ...
    if( NIL == result )
    {
      result = el_utilities.make_ternary_formula( $const8$NthMetricallyPrecedingTimeInterva, n, interval, type );
    }
    return result;
  }
  ...
  public static SubLObject cyc_el_nth_metrically_succeeding_time_interval_of_type(final SubLObject n, final SubLObject interval, final SubLObject type)
  {
    ...
    if( NIL == result )
    {
      result = el_utilities.make_ternary_formula( $const11$NthMetricallySucceedingTimeInterv, n, interval, type );
    }
    return result;
  }
  ...
  {
    SubLFiles.declareFunction( me, "cyc_temporal_intersection", "CYC-TEMPORAL-INTERSECTION", 1, 0, false );
    SubLFiles.declareFunction( me, "cyc_interval_ended_by_last_subinterval_of_type", "CYC-INTERVAL-ENDED-BY-LAST-SUBINTERVAL-OF-TYPE", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_el_interval_ended_by_last_subinterval_of_type", "CYC-EL-INTERVAL-ENDED-BY-LAST-SUBINTERVAL-OF-TYPE", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_interval_started_by_first_subinterval_of_type", "CYC-INTERVAL-STARTED-BY-FIRST-SUBINTERVAL-OF-TYPE", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_el_interval_started_by_first_subinterval_of_type", "CYC-EL-INTERVAL-STARTED-BY-FIRST-SUBINTERVAL-OF-TYPE", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_nth_metrically_preceding_time_interval_of_type", "CYC-NTH-METRICALLY-PRECEDING-TIME-INTERVAL-OF-TYPE", 3, 0, false );
    SubLFiles.declareFunction( me, "cyc_nth_metrically_preceding_time_interval_of_type_int", "CYC-NTH-METRICALLY-PRECEDING-TIME-INTERVAL-OF-TYPE-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "cyc_el_nth_metrically_preceding_time_interval_of_type", "CYC-EL-NTH-METRICALLY-PRECEDING-TIME-INTERVAL-OF-TYPE", 3, 0, false );
    SubLFiles.declareFunction( me, "cyc_nth_metrically_succeeding_time_interval_of_type", "CYC-NTH-METRICALLY-SUCCEEDING-TIME-INTERVAL-OF-TYPE", 3, 0, false );
    SubLFiles.declareFunction( me, "cyc_nth_metrically_succeeding_time_interval_of_type_int", "CYC-NTH-METRICALLY-SUCCEEDING-TIME-INTERVAL-OF-TYPE-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "cyc_el_nth_metrically_succeeding_time_interval_of_type", "CYC-EL-NTH-METRICALLY-SUCCEEDING-TIME-INTERVAL-OF-TYPE", 3, 0, false );
    return NIL;
  }
  ...
  {
    utilities_macros.register_kb_function( $sym0$CYC_TEMPORAL_INTERSECTION );
    utilities_macros.register_kb_function( $sym1$CYC_INTERVAL_ENDED_BY_LAST_SUBINTERVAL_OF_TYPE );
    utilities_macros.register_kb_function( $sym3$CYC_EL_INTERVAL_ENDED_BY_LAST_SUBINTERVAL_OF_TYPE );
    utilities_macros.register_kb_function( $sym4$CYC_INTERVAL_STARTED_BY_FIRST_SUBINTERVAL_OF_TYPE );
    utilities_macros.register_kb_function( $sym6$CYC_EL_INTERVAL_STARTED_BY_FIRST_SUBINTERVAL_OF_TYPE );
    utilities_macros.register_kb_function( $sym7$CYC_NTH_METRICALLY_PRECEDING_TIME_INTERVAL_OF_TYPE );
    utilities_macros.register_kb_function( $sym9$CYC_EL_NTH_METRICALLY_PRECEDING_TIME_INTERVAL_OF_TYPE );
    utilities_macros.register_kb_function( $sym10$CYC_NTH_METRICALLY_SUCCEEDING_TIME_INTERVAL_OF_TYPE );
    utilities_macros.register_kb_function( $sym12$CYC_EL_NTH_METRICALLY_SUCCEEDING_TIME_INTERVAL_OF_TYPE );
    return NIL;
  }
  ...
  static
  {
    me = new sbhl_time_defns();
    $sym0$CYC_TEMPORAL_INTERSECTION = makeSymbol( "CYC-TEMPORAL-INTERSECTION" );
    $sym1$CYC_INTERVAL_ENDED_BY_LAST_SUBINTERVAL_OF_TYPE = makeSymbol( "CYC-INTERVAL-ENDED-BY-LAST-SUBINTERVAL-OF-TYPE" );
    $const2$IntervalEndedByLastSubintervalOfT = constant_handles.reader_make_constant_shell( makeString( "IntervalEndedByLastSubintervalOfTypeFn" ) );
    $sym3$CYC_EL_INTERVAL_ENDED_BY_LAST_SUBINTERVAL_OF_TYPE = makeSymbol( "CYC-EL-INTERVAL-ENDED-BY-LAST-SUBINTERVAL-OF-TYPE" );
    $sym4$CYC_INTERVAL_STARTED_BY_FIRST_SUBINTERVAL_OF_TYPE = makeSymbol( "CYC-INTERVAL-STARTED-BY-FIRST-SUBINTERVAL-OF-TYPE" );
    $const5$IntervalStartedByFirstSubinterval = constant_handles.reader_make_constant_shell( makeString( "IntervalStartedByFirstSubintervalOfTypeFn" ) );
    $sym6$CYC_EL_INTERVAL_STARTED_BY_FIRST_SUBINTERVAL_OF_TYPE = makeSymbol( "CYC-EL-INTERVAL-STARTED-BY-FIRST-SUBINTERVAL-OF-TYPE" );
    $sym7$CYC_NTH_METRICALLY_PRECEDING_TIME_INTERVAL_OF_TYPE = makeSymbol( "CYC-NTH-METRICALLY-PRECEDING-TIME-INTERVAL-OF-TYPE" );
    $const8$NthMetricallyPrecedingTimeInterva = constant_handles.reader_make_constant_shell( makeString( "NthMetricallyPrecedingTimeIntervalOfTypeFn" ) );
    $sym9$CYC_EL_NTH_METRICALLY_PRECEDING_TIME_INTERVAL_OF_TYPE = makeSymbol( "CYC-EL-NTH-METRICALLY-PRECEDING-TIME-INTERVAL-OF-TYPE" );
    $sym10$CYC_NTH_METRICALLY_SUCCEEDING_TIME_INTERVAL_OF_TYPE = makeSymbol( "CYC-NTH-METRICALLY-SUCCEEDING-TIME-INTERVAL-OF-TYPE" );
    $const11$NthMetricallySucceedingTimeInterv = constant_handles.reader_make_constant_shell( makeString( "NthMetricallySucceedingTimeIntervalOfTypeFn" ) );
    $sym12$CYC_EL_NTH_METRICALLY_SUCCEEDING_TIME_INTERVAL_OF_TYPE = makeSymbol( "CYC-EL-NTH-METRICALLY-SUCCEEDING-TIME-INTERVAL-OF-TYPE" );
  }
}
/*
 * 
