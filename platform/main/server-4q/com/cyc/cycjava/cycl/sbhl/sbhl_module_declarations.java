...
import static com.cyc.cycjava.cycl.sbhl.sbhl_module_declarations.*;
...
public final class sbhl_module_declarations extends SubLTranslatedFile {
    ...
    public static final SubLList $list26 = list(makeSymbol("SBHL-RESULT-ISA"), makeSymbol("RESULT-ISA-ARGS"), makeSymbol("RESULT-INTER-ARG-ISA"), makeSymbol("RESULT-INTER-ARG-ISA-RELN"), makeSymbol("RESULT-ISA-VIA-ARG-ARG-ISA"), makeSymbol("RESULT-ISA-ARG-ISAS"), makeSymbol("RESULT-ISA-WHEN-ARG-ISA"), makeSymbol("RESULT-ISA-VIA-CLOSED-UNDER"));
    ...
    private static final SubLList $list47 = list(reader_make_constant_shell(makeString("genlPreds")), reader_make_constant_shell(makeString("genlInverse")));
    ...
    public static final SubLList $list52 = list(reader_make_constant_shell(makeString("genlInverse")), reader_make_constant_shell(makeString("genlPreds")));

    public static final SubLList $list53 = list(reader_make_constant_shell(makeString("negationPreds")), reader_make_constant_shell(makeString("negationInverse")));

    private static final SubLList $list54 = list(reader_make_constant_shell(makeString("negationInverse")), reader_make_constant_shell(makeString("negationPreds")));
    ...
    private static final SubLList $list64 = list(reader_make_constant_shell(makeString("successorStrict-HL-TimePrecedence")), reader_make_constant_shell(makeString("strict-HL-TimePrecedence")), reader_make_constant_shell(makeString("weak-HL-TimePrecedence")), reader_make_constant_shell(makeString("weakSuccessor-HL-TimePrecedence")));
    ...
    private static final SubLSymbol $sym74$_SBHL_MODULES_INITIALIZED__ = makeSymbol("*SBHL-MODULES-INITIALIZED?*");
    ...
    public static SubLObject declare_sbhl_module_declarations_file() {
        declareFunction(me, "initialize_genls_module", "INITIALIZE-GENLS-MODULE", 0, 0, false);
        declareFunction(me, "initialize_disjoint_with_module", "INITIALIZE-DISJOINT-WITH-MODULE", 0, 0, false);
        declareFunction(me, "initialize_isa_module", "INITIALIZE-ISA-MODULE", 0, 0, false);
        declareFunction(me, "initialize_quoted_isa_module", "INITIALIZE-QUOTED-ISA-MODULE", 0, 0, false);
        declareFunction(me, "initialize_genl_mt_module", "INITIALIZE-GENL-MT-MODULE", 0, 0, false);
        declareFunction(me, "initialize_negation_mt_module", "INITIALIZE-NEGATION-MT-MODULE", 0, 0, false);
        declareFunction(me, "initialize_genl_preds_module", "INITIALIZE-GENL-PREDS-MODULE", 0, 0, false);
        declareFunction(me, "initialize_genl_inverse_module", "INITIALIZE-GENL-INVERSE-MODULE", 0, 0, false);
        declareFunction(me, "initialize_negation_preds_module", "INITIALIZE-NEGATION-PREDS-MODULE", 0, 0, false);
        declareFunction(me, "initialize_negation_inverse_module", "INITIALIZE-NEGATION-INVERSE-MODULE", 0, 0, false);
        declareFunction(me, "initialize_incompatible_mt_module", "INITIALIZE-INCOMPATIBLE-MT-MODULE", 0, 0, false);
        declareFunction(me, "initialize_intensionally_incompatible_mt_module", "INITIALIZE-INTENSIONALLY-INCOMPATIBLE-MT-MODULE", 0, 0, false);
        declareFunction(me, "initialize_weak_precedence_module", "INITIALIZE-WEAK-PRECEDENCE-MODULE", 0, 0, false);
        declareFunction(me, "initialize_weak_successor_precedence_module", "INITIALIZE-WEAK-SUCCESSOR-PRECEDENCE-MODULE", 0, 0, false);
        declareFunction(me, "initialize_strict_precedence_module", "INITIALIZE-STRICT-PRECEDENCE-MODULE", 0, 0, false);
        declareFunction(me, "initialize_successor_strict_precedence_module", "INITIALIZE-SUCCESSOR-STRICT-PRECEDENCE-MODULE", 0, 0, false);
        declareFunction(me, "sbhl_modules_initializedP", "SBHL-MODULES-INITIALIZED?", 0, 0, false);
        declareFunction(me, "note_sbhl_modules_initialized", "NOTE-SBHL-MODULES-INITIALIZED", 0, 0, false);
        declareFunction(me, "initialize_sbhl_modules", "INITIALIZE-SBHL-MODULES", 0, 1, false);
        declareFunction(me, "convert_legacy_sbhl_modules_to_structs", "CONVERT-LEGACY-SBHL-MODULES-TO-STRUCTS", 0, 1, false);
        declareFunction(me, "verify_sbhl_modules", "VERIFY-SBHL-MODULES", 0, 1, false);
        return NIL;
    }
    ...
    public static SubLObject setup_sbhl_module_declarations_file() {
        declare_defglobal($sym74$_SBHL_MODULES_INITIALIZED__);
        return NIL;
    }
