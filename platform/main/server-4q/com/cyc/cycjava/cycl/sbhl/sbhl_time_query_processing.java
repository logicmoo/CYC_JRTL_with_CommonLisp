...
import static com.cyc.cycjava.cycl.sbhl.sbhl_time_query_processing.*;
...
public final class sbhl_time_query_processing extends SubLTranslatedFile {
    ...
    public static final SubLList $list3 = list(makeKeyword("WEAK-SUCCESSORS-SUCCESSOR"), makeKeyword("SUCCESSORS-SUCCESSOR-STRICT"));
    ...
    public static SubLObject declare_sbhl_time_query_processing_file() {
        declareFunction(me, "true_temporal_relation_literalP", "TRUE-TEMPORAL-RELATION-LITERAL?", 4, 1, false);
        declareFunction(me, "true_temporal_quasi_link_conjunctionP", "TRUE-TEMPORAL-QUASI-LINK-CONJUNCTION?", 1, 1, false);
        declareFunction(me, "false_temporal_quasi_link_conjunctionP", "FALSE-TEMPORAL-QUASI-LINK-CONJUNCTION?", 1, 1, false);
        declareFunction(me, "temporal_link_conjunction_negation", "TEMPORAL-LINK-CONJUNCTION-NEGATION", 1, 0, false);
        declareFunction(me, "temporal_link_negation", "TEMPORAL-LINK-NEGATION", 1, 0, false);
        declareFunction(me, "adjust_temporal_quasi_link_to_existing_nodes", "ADJUST-TEMPORAL-QUASI-LINK-TO-EXISTING-NODES", 1, 0, false);
        declareFunction(me, "adjust_quasi_link_before_half_to_existing_nodes", "ADJUST-QUASI-LINK-BEFORE-HALF-TO-EXISTING-NODES", 2, 0, false);
        declareFunction(me, "adjust_quasi_link_after_half_to_existing_nodes", "ADJUST-QUASI-LINK-AFTER-HALF-TO-EXISTING-NODES", 2, 0, false);
        declareFunction(me, "adjust_temporal_quasi_link_to_link_disjunction_terms_and_existing_nodes", "ADJUST-TEMPORAL-QUASI-LINK-TO-LINK-DISJUNCTION-TERMS-AND-EXISTING-NODES", 1, 0, false);
        declareFunction(me, "adjust_quasi_link_before_half_to_link_disjunction_terms_and_existing_nodes", "ADJUST-QUASI-LINK-BEFORE-HALF-TO-LINK-DISJUNCTION-TERMS-AND-EXISTING-NODES", 2, 0, false);
        declareFunction(me, "adjust_quasi_link_after_half_to_link_disjunction_terms_and_existing_nodes", "ADJUST-QUASI-LINK-AFTER-HALF-TO-LINK-DISJUNCTION-TERMS-AND-EXISTING-NODES", 2, 0, false);
        declareFunction(me, "closest_existing_date_point_before", "CLOSEST-EXISTING-DATE-POINT-BEFORE", 1, 0, false);
        declareFunction(me, "closest_existing_date_point_after", "CLOSEST-EXISTING-DATE-POINT-AFTER", 1, 0, false);
        declareFunction(me, "true_temporal_quasi_linkP", "TRUE-TEMPORAL-QUASI-LINK?", 3, 1, false);
        declareFunction(me, "date_date_quasi_link_p", "DATE-DATE-QUASI-LINK-P", 1, 0, false);
        declareFunction(me, "true_date_date_quasi_linkP", "TRUE-DATE-DATE-QUASI-LINK?", 3, 0, false);
        declareFunction(me, "true_temporal_linkP", "TRUE-TEMPORAL-LINK?", 3, 1, false);
        declareFunction(me, "add_temporal_link_disjunction_consequents", "ADD-TEMPORAL-LINK-DISJUNCTION-CONSEQUENTS", 1, 0, false);
        declareFunction(me, "remove_temporal_link_disjunction_consequents", "REMOVE-TEMPORAL-LINK-DISJUNCTION-CONSEQUENTS", 1, 0, false);
        declareFunction(me, "determine_temporal_link_disjunction_consequent", "DETERMINE-TEMPORAL-LINK-DISJUNCTION-CONSEQUENT", 2, 0, false);
        declareFunction(me, "all_weakly_before_quasi_link", "ALL-WEAKLY-BEFORE-QUASI-LINK", 1, 1, false);
        declareFunction(me, "all_weakly_after_quasi_link", "ALL-WEAKLY-AFTER-QUASI-LINK", 1, 1, false);
        declareFunction(me, "all_strictly_before_quasi_link", "ALL-STRICTLY-BEFORE-QUASI-LINK", 1, 1, false);
        declareFunction(me, "all_strictly_after_quasi_link", "ALL-STRICTLY-AFTER-QUASI-LINK", 1, 1, false);
        declareFunction(me, "all_coordinate_quasi_link", "ALL-COORDINATE-QUASI-LINK", 1, 1, false);
        declareFunction(me, "all_successors_quasi_link", "ALL-SUCCESSORS-QUASI-LINK", 1, 1, false);
        declareFunction(me, "all_predecessors_quasi_link", "ALL-PREDECESSORS-QUASI-LINK", 1, 1, false);
        declareFunction(me, "all_temporal_link_before", "ALL-TEMPORAL-LINK-BEFORE", 2, 1, false);
        declareFunction(me, "all_temporal_link_after", "ALL-TEMPORAL-LINK-AFTER", 2, 1, false);
        declareFunction(me, "all_weakly_between_quasi_links", "ALL-WEAKLY-BETWEEN-QUASI-LINKS", 2, 1, false);
        declareFunction(me, "all_strictly_between_quasi_links", "ALL-STRICTLY-BETWEEN-QUASI-LINKS", 2, 1, false);
        declareFunction(me, "all_temporal_link_between", "ALL-TEMPORAL-LINK-BETWEEN", 4, 1, false);
        declareFunction(me, "why_temporal_relationP", "WHY-TEMPORAL-RELATION?", 1, 1, false);
        declareFunction(me, "why_true_temporal_relation_literalP", "WHY-TRUE-TEMPORAL-RELATION-LITERAL?", 4, 1, false);
        declareFunction(me, "why_true_temporal_quasi_link_conjunctionP", "WHY-TRUE-TEMPORAL-QUASI-LINK-CONJUNCTION?", 1, 1, false);
        declareFunction(me, "why_false_temporal_quasi_link_conjunctionP", "WHY-FALSE-TEMPORAL-QUASI-LINK-CONJUNCTION?", 1, 1, false);
        declareFunction(me, "why_true_temporal_quasi_linkP", "WHY-TRUE-TEMPORAL-QUASI-LINK?", 3, 1, false);
        declareFunction(me, "why_true_temporal_linkP", "WHY-TRUE-TEMPORAL-LINK?", 3, 1, false);
        return NIL;
    }
