...
public final class sbhl_links extends SubLTranslatedFile {
    ...
    public static SubLObject sbhl_directed_link_predicate_links(final SubLObject v_object) {
        assert NIL != sbhl_directed_link_p(v_object) : "sbhl_links.sbhl_directed_link_p error :" + v_object;
    ...
    public static SubLObject sbhl_undirected_link_links(final SubLObject v_object) {
        assert NIL != sbhl_undirected_link_p(v_object) : "sbhl_links.sbhl_undirected_link_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $sbhl_directed_link_native extends SubLStructNative {
        ...
        private $sbhl_directed_link_native() {
        ...
        static {
            structDecl = makeStructDeclNative($sbhl_directed_link_native.class, SBHL_DIRECTED_LINK, SBHL_DIRECTED_LINK_P, $list3, $list4, new String[]{ "$predicate_links", "$inverse_links" }, $list5, $list6, PRINT_LINK);
        }
    }
    ...
    public static final class $sbhl_undirected_link_native extends SubLStructNative {
        ...
        private $sbhl_undirected_link_native() {
            this.$links = Lisp.NIL;
        }
        ...
        static {
            structDecl = makeStructDeclNative($sbhl_undirected_link_native.class, SBHL_UNDIRECTED_LINK, SBHL_UNDIRECTED_LINK_P, $list25, $list26, new String[]{ "$links" }, $list27, $list28, PRINT_LINK);
        }
    }
