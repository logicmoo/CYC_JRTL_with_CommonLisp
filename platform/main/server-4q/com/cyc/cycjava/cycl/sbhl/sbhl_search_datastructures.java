...
import static com.cyc.cycjava.cycl.sbhl.sbhl_search_datastructures.*;
...
public final class sbhl_search_datastructures extends SubLTranslatedFile {
    ...
    public static SubLObject sbhl_stack_p(final SubLObject v_object) {
        return v_object.getClass() == sbhl_search_datastructures.$sbhl_stack_native.class ? T : NIL;
    }

    public static SubLObject sbhl_stack_num(final SubLObject v_object) {
        assert NIL != sbhl_stack_p(v_object) : "sbhl_search_datastructures.sbhl_stack_p(v_object) " + "CommonSymbols.NIL != sbhl_search_datastructures.sbhl_stack_p(v_object) " + v_object;
    ...
    public static SubLObject make_sbhl_stack(SubLObject arglist) {
        ...
        final SubLObject v_new = new sbhl_search_datastructures.$sbhl_stack_native();
        SubLObject next;
    ...
    public static SubLObject sbhl_link_node_search_state_p(final SubLObject v_object) {
        return v_object.getClass() == sbhl_search_datastructures.$sbhl_link_node_search_state_native.class ? T : NIL;
    }

    public static SubLObject sbhl_link_node_search_state_node(final SubLObject v_object) {
        assert NIL != sbhl_link_node_search_state_p(v_object) : "sbhl_search_datastructures.sbhl_link_node_search_state_p(v_object) " + "CommonSymbols.NIL != sbhl_search_datastructures.sbhl_link_node_search_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sbhl_link_node_search_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new sbhl_search_datastructures.$sbhl_link_node_search_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $sbhl_stack_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sbhl_search_datastructures.$sbhl_stack_native.class, SBHL_STACK, SBHL_STACK_P, $list2, $list3, new String[]{ "$num", "$elements" }, $list4, $list5, PRINT_SBHL_STACK);
        }
    }
    ...
    public static final class $sbhl_link_node_search_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sbhl_search_datastructures.$sbhl_link_node_search_state_native.class, SBHL_LINK_NODE_SEARCH_STATE, SBHL_LINK_NODE_SEARCH_STATE_P, $list25, $list26, new String[]{ "$node", "$module", "$direction", "$mt", "$tv", "$parent_node", "$genl_inverse_modeP", "$link_generator" }, $list27, $list28, PRINT_SBHL_LINK_NODE_SEARCH_STATE);
        }
    }
