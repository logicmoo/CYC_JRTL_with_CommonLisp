...
import static com.cyc.cycjava.cycl.sbhl.sbhl_time_utilities.*;
...
public final class sbhl_time_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject hl_start_p(final SubLObject v_object) {
        return v_object.getClass() == sbhl_time_utilities.$hl_start_native.class ? T : NIL;
    }

    public static SubLObject hl_start_interval(final SubLObject v_object) {
        assert NIL != hl_start_p(v_object) : "sbhl_time_utilities.hl_start_p(v_object) " + "CommonSymbols.NIL != sbhl_time_utilities.hl_start_p(v_object) " + v_object;
    ...
    public static SubLObject make_hl_start(SubLObject arglist) {
        ...
        final SubLObject v_new = new sbhl_time_utilities.$hl_start_native();
        SubLObject next;
    ...
    public static SubLObject hl_end_p(final SubLObject v_object) {
        return v_object.getClass() == sbhl_time_utilities.$hl_end_native.class ? T : NIL;
    }

    public static SubLObject hl_end_interval(final SubLObject v_object) {
        assert NIL != hl_end_p(v_object) : "sbhl_time_utilities.hl_end_p(v_object) " + "CommonSymbols.NIL != sbhl_time_utilities.hl_end_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_hl_end(SubLObject arglist) {
        ...
        final SubLObject v_new = new sbhl_time_utilities.$hl_end_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $hl_start_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sbhl_time_utilities.$hl_start_native.class, HL_START, HL_START_P, $list11, $list12, new String[]{ "$interval" }, $list13, $list14, PRINT_HL_ENDPOINT);
        }
    }
    ...
    public static final class $hl_end_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sbhl_time_utilities.$hl_end_native.class, HL_END, HL_END_P, $list11, $list12, new String[]{ "$interval" }, $list30, $list31, PRINT_HL_ENDPOINT);
        }
    }
