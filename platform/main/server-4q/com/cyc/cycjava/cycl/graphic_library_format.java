...
public final class graphic_library_format extends SubLTranslatedFile {
    ...
    public static SubLObject glf_graph_p(final SubLObject v_object) {
        return v_object.getClass() == graphic_library_format.$glf_graph_native.class ? T : NIL;
    }

    public static SubLObject glfgrph_id(final SubLObject v_object) {
        assert NIL != glf_graph_p(v_object) : "graphic_library_format.glf_graph_p(v_object) " + "CommonSymbols.NIL != graphic_library_format.glf_graph_p(v_object) " + v_object;
    ...
    public static SubLObject make_glf_graph(SubLObject arglist) {
        ...
        final SubLObject v_new = new graphic_library_format.$glf_graph_native();
        SubLObject next;
    ...
    public static SubLObject glf_node_p(final SubLObject v_object) {
        return v_object.getClass() == graphic_library_format.$glf_node_native.class ? T : NIL;
    }

    public static SubLObject glfnode_id(final SubLObject v_object) {
        assert NIL != glf_node_p(v_object) : "graphic_library_format.glf_node_p(v_object) " + "CommonSymbols.NIL != graphic_library_format.glf_node_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_glf_node(SubLObject arglist) {
        ...
        final SubLObject v_new = new graphic_library_format.$glf_node_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject glf_arc_p(final SubLObject v_object) {
        return v_object.getClass() == graphic_library_format.$glf_arc_native.class ? T : NIL;
    }

    public static SubLObject glfarc_id(final SubLObject v_object) {
        assert NIL != glf_arc_p(v_object) : "graphic_library_format.glf_arc_p(v_object) " + "CommonSymbols.NIL != graphic_library_format.glf_arc_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_glf_arc(SubLObject arglist) {
        ...
        final SubLObject v_new = new graphic_library_format.$glf_arc_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject glf_rendering_p(final SubLObject v_object) {
        return v_object.getClass() == graphic_library_format.$glf_rendering_native.class ? T : NIL;
    }

    public static SubLObject glfrndr_label(final SubLObject v_object) {
        assert NIL != glf_rendering_p(v_object) : "graphic_library_format.glf_rendering_p(v_object) " + "CommonSymbols.NIL != graphic_library_format.glf_rendering_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_glf_rendering(SubLObject arglist) {
        ...
        final SubLObject v_new = new graphic_library_format.$glf_rendering_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $glf_graph_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(graphic_library_format.$glf_graph_native.class, GLF_GRAPH, GLF_GRAPH_P, $list2, $list3, new String[]{ "$id", "$types", "$ais", "$nodes", "$node_types", "$source_node", "$arcs", "$arc_types", "$incoming_connectors", "$outgoing_connectors", "$incoming_connector_types", "$outgoing_connector_types", "$rendering_info" }, $list4, $list5, GLFGRPH_PRINT);
        }
    }
    ...
    public static final class $glf_node_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(graphic_library_format.$glf_node_native.class, GLF_NODE, GLF_NODE_P, $list119, $list120, new String[]{ "$id", "$types", "$parent", "$semantics" }, $list121, $list122, GLFNODE_PRINT);
        }
    }
    ...
    public static final class $glf_arc_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(graphic_library_format.$glf_arc_native.class, GLF_ARC, GLF_ARC_P, $list146, $list147, new String[]{ "$id", "$types", "$parent", "$from", "$to", "$semantics" }, $list148, $list149, GLFARC_PRINT);
        }
    }
    ...
    public static final class $glf_rendering_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(graphic_library_format.$glf_rendering_native.class, GLF_RENDERING, GLF_RENDERING_P, $list182, $list183, new String[]{ "$label" }, $list184, $list185, GLFRNDR_PRINT);
        }
    }
