...
public final class cycl_utilities extends SubLTranslatedFile {
    ...
    public static final SubLSymbol HL_TERM_WITH_EL_COUNTERPART_P = makeSymbol("HL-TERM-WITH-EL-COUNTERPART-P");
    ...
    public static final SubLList $list92 = list(makeSymbol("INLINE"), makeSymbol("FORMULA-OPERATOR"));
    ...
    public static SubLObject expression_list_find(final SubLObject v_object, final SubLObject expression_list, SubLObject penetrate_hl_structuresP, SubLObject test, SubLObject key) {
        ...
        assert NIL != listp(expression_list) : "Types.listp(expression_list) " + "CommonSymbols.NIL != Types.listp(expression_list) " + expression_list;
        SubLObject cdolist_list_var = expression_list;
        SubLObject expression = NIL;
        expression = cdolist_list_var.first();
        while (NIL != cdolist_list_var) {
    ...
    public static SubLObject collection_intersection_intersectees(final SubLObject collection_intersection_nat) {
        assert NIL != collection_intersection_natP(collection_intersection_nat) : "cycl_utilities.collection_intersection_natP(collection_intersection_nat) " + "CommonSymbols.NIL != cycl_utilities.collection_intersection_natP(collection_intersection_nat) " + collection_intersection_nat;
    ...
    public static SubLObject collection_union_united_collections(final SubLObject collection_union_nat) {
        assert NIL != collection_union_natP(collection_union_nat) : "cycl_utilities.collection_union_natP(collection_union_nat) " + "CommonSymbols.NIL != cycl_utilities.collection_union_natP(collection_union_nat) " + collection_union_nat;
    ...
    public static SubLObject functional_in_some_argP(final SubLObject pred) {
        assert NIL != somewhere_cache.valid_somewhere_cache_itemP(pred) : "somewhere_cache.valid_somewhere_cache_itemP(pred) " + "CommonSymbols.NIL != somewhere_cache.valid_somewhere_cache_itemP(pred) " + pred;
    ...
    public static SubLObject functional_in_arg_positions_internal(final SubLObject pred, SubLObject assume_pred_has_functional_argsP) {
        ...
        assert NIL != indexed_term_p(pred) : "kb_indexing_datastructures.indexed_term_p(pred) " + "CommonSymbols.NIL != kb_indexing_datastructures.indexed_term_p(pred) " + pred;
    ...
    public static SubLObject el_formula_arg(final SubLObject el_formula, final SubLObject argnum, SubLObject seqvar_handling) {
        ...
        assert NIL != el_formula_p(el_formula) : "el_utilities.el_formula_p(el_formula) " + "CommonSymbols.NIL != el_utilities.el_formula_p(el_formula) " + el_formula;
    ...
    public static SubLObject cycl_formula_args(final SubLObject cycl_sentence) {
        assert NIL != cycl_grammar.cycl_sentence_p(cycl_sentence) : "cycl_grammar.cycl_sentence_p(cycl_sentence) " + "CommonSymbols.NIL != cycl_grammar.cycl_sentence_p(cycl_sentence) " + cycl_sentence;
    ...
    public static SubLObject naut_args(final SubLObject naut, SubLObject seqvar_handling) {
        ...
        assert NIL != possibly_naut_p(naut) : "el_utilities.possibly_naut_p(naut) " + "CommonSymbols.NIL != el_utilities.possibly_naut_p(naut) " + naut;
    ...
    public static SubLObject make_cycl_arg_position(final SubLObject arg_position) {
        assert NIL != arg_position_p(arg_position) : "cycl_utilities.arg_position_p(arg_position) " + "CommonSymbols.NIL != cycl_utilities.arg_position_p(arg_position) " + arg_position;
    ...
    public static SubLObject cycl_arg_position_to_arg_position(final SubLObject cycl_arg_position) {
        assert NIL != cycl_arg_position_p(cycl_arg_position) : "cycl_utilities.cycl_arg_position_p(cycl_arg_position) " + "CommonSymbols.NIL != cycl_utilities.cycl_arg_position_p(cycl_arg_position) " + cycl_arg_position;
    ...
    public static SubLObject formula_cycl_arg_position(final SubLObject formula, final SubLObject argpos, SubLObject v_default) {
        ...
        assert NIL != el_formula_p(formula) : "el_utilities.el_formula_p(formula) " + "CommonSymbols.NIL != el_utilities.el_formula_p(formula) " + formula;
        assert NIL != cycl_arg_position_p(argpos) : "cycl_utilities.cycl_arg_position_p(argpos) " + "CommonSymbols.NIL != cycl_utilities.cycl_arg_position_p(argpos) " + argpos;
    ...
    public static SubLObject substitute_terms_into_positions(final SubLObject terms, final SubLObject arg_positions, final SubLObject formula) {
        ...
        assert NIL != list_utilities.non_dotted_list_p(arg_positions) : "list_utilities.non_dotted_list_p(arg_positions) " + "CommonSymbols.NIL != list_utilities.non_dotted_list_p(arg_positions) " + arg_positions;
        SubLObject cdolist_list_var = arg_positions;
        SubLObject elem = NIL;
        elem = cdolist_list_var.first();
        while (NIL != cdolist_list_var) {
            assert NIL != cycl_arg_position_p(elem) : "cycl_utilities.cycl_arg_position_p(elem) " + "CommonSymbols.NIL != cycl_utilities.cycl_arg_position_p(elem) " + elem;
            cdolist_list_var = cdolist_list_var.rest();
            elem = cdolist_list_var.first();
        } 
        assert NIL != el_formula_p(formula) : "el_utilities.el_formula_p(formula) " + "CommonSymbols.NIL != el_utilities.el_formula_p(formula) " + formula;
    ...
    public static SubLObject declare_cycl_utilities_file() {
        declareMacro(me, "with_opaque_arg_function", "WITH-OPAQUE-ARG-FUNCTION");
        declareMacro(me, "with_opaque_seqvar_function", "WITH-OPAQUE-SEQVAR-FUNCTION");
        declareFunction(me, "maybe_some_opaque_argP", "MAYBE-SOME-OPAQUE-ARG?", 1, 0, false);
        declareFunction(me, "opaque_argP", "OPAQUE-ARG?", 2, 0, false);
        declareFunction(me, "opaque_argP_int", "OPAQUE-ARG?-INT", 3, 0, false);
        declareFunction(me, "opaque_seqvarP", "OPAQUE-SEQVAR?", 1, 0, false);
        declareFunction(me, "default_opaque_argP", "DEFAULT-OPAQUE-ARG?", 2, 0, false);
        declareFunction(me, "opaque_arg_wrt_free_varsP", "OPAQUE-ARG-WRT-FREE-VARS?", 2, 0, false);
        declareFunction(me, "opaque_arg_wrt_el_templateP", "OPAQUE-ARG-WRT-EL-TEMPLATE?", 2, 0, false);
        declareFunction(me, "opaque_arg_wrt_quotingP", "OPAQUE-ARG-WRT-QUOTING?", 2, 0, false);
        new cycl_utilities.$opaque_arg_wrt_quotingP$BinaryFunction();
        declareFunction(me, "opaque_arg_wrt_quoting_not_counting_logical_opsP", "OPAQUE-ARG-WRT-QUOTING-NOT-COUNTING-LOGICAL-OPS?", 2, 0, false);
        declareFunction(me, "opaque_arg_wrt_quoteP", "OPAQUE-ARG-WRT-QUOTE?", 2, 0, false);
        declareFunction(me, "opaque_arg_wrt_el_template_or_quoteP", "OPAQUE-ARG-WRT-EL-TEMPLATE-OR-QUOTE?", 2, 0, false);
        declareFunction(me, "opaque_arg_wrt_skolemP", "OPAQUE-ARG-WRT-SKOLEM?", 2, 0, false);
        declareFunction(me, "default_opaque_seqvarP", "DEFAULT-OPAQUE-SEQVAR?", 1, 0, false);
        declareFunction(me, "hl_term_with_el_counterpart_p", "HL-TERM-WITH-EL-COUNTERPART-P", 1, 0, false);
        new cycl_utilities.$hl_term_with_el_counterpart_p$UnaryFunction();
        declareFunction(me, "hl_term_to_el_term", "HL-TERM-TO-EL-TERM", 1, 0, false);
        new cycl_utilities.$hl_term_to_el_term$UnaryFunction();
        declareFunction(me, "careful_hl_term_to_el_term", "CAREFUL-HL-TERM-TO-EL-TERM", 1, 0, false);
        declareFunction(me, "hl_to_el", "HL-TO-EL", 1, 0, false);
        declareFunction(me, "hl_to_el_destructive", "HL-TO-EL-DESTRUCTIVE", 1, 0, false);
        declareFunction(me, "hl_to_el_preserve_el_vars", "HL-TO-EL-PRESERVE-EL-VARS", 1, 0, false);
        declareFunction(me, "binding_lists_hl_to_el", "BINDING-LISTS-HL-TO-EL", 1, 0, false);
        declareFunction(me, "transform_hl_to_el", "TRANSFORM-HL-TO-EL", 1, 0, false);
        declareFunction(me, "reified_term_p", "REIFIED-TERM-P", 1, 0, false);
        declareFunction(me, "atomic_reified_term_p", "ATOMIC-REIFIED-TERM-P", 1, 0, false);
        declareFunction(me, "reified_formula_p", "REIFIED-FORMULA-P", 1, 0, false);
        declareFunction(me, "rf_p", "RF-P", 1, 0, false);
        declareFunction(me, "rf_type", "RF-TYPE", 1, 0, false);
        declareFunction(me, "rf_raw_id", "RF-RAW-ID", 1, 0, false);
        declareFunction(me, "rf_id", "RF-ID", 1, 0, false);
        declareFunction(me, "find_rf_by_id", "FIND-RF-BY-ID", 1, 0, false);
        declareFunction(me, "find_rf", "FIND-RF", 1, 0, false);
        declareFunction(me, "robustly_find_rf", "ROBUSTLY-FIND-RF", 1, 0, false);
        declareFunction(me, "rf_formula", "RF-FORMULA", 1, 0, false);
        declareFunction(me, "rf_expand", "RF-EXPAND", 1, 0, false);
        declareFunction(me, "rf_narts", "RF-NARTS", 1, 1, false);
        declareFunction(me, "rf_assertions", "RF-ASSERTIONS", 1, 1, false);
        declareFunction(me, "wf_rf_syntaxP", "WF-RF-SYNTAX?", 1, 0, false);
        declareFunction(me, "valid_rfP", "VALID-RF?", 1, 0, false);
        declareFunction(me, "all_rfs", "ALL-RFS", 0, 0, false);
        declareFunction(me, "unreify_rfs", "UNREIFY-RFS", 1, 0, false);
        declareFunction(me, "rf_count", "RF-COUNT", 0, 0, false);
        declareFunction(me, "subrfs", "SUBRFS", 2, 0, false);
        declareFunction(me, "super_rfs", "SUPER-RFS", 1, 0, false);
        declareFunction(me, "inclusive_subrfs", "INCLUSIVE-SUBRFS", 1, 0, false);
        declareFunction(me, "expression_gather_int_2", "EXPRESSION-GATHER-INT-2", 5, 0, false);
        declareFunction(me, "expression_gather_int", "EXPRESSION-GATHER-INT", 6, 0, false);
        declareFunction(me, "expression_gather_with_duplicates", "EXPRESSION-GATHER-WITH-DUPLICATES", 2, 4, false);
        declareFunction(me, "expression_gather", "EXPRESSION-GATHER", 2, 4, false);
        declareFunction(me, "assertion_gather", "ASSERTION-GATHER", 2, 4, false);
        declareFunction(me, "expression_count", "EXPRESSION-COUNT", 2, 3, false);
        declareFunction(me, "expression_count_helper", "EXPRESSION-COUNT-HELPER", 1, 0, false);
        declareFunction(me, "expression_list_gather", "EXPRESSION-LIST-GATHER", 2, 4, false);
        declareFunction(me, "formula_gather", "FORMULA-GATHER", 2, 4, false);
        declareFunction(me, "expression_forts", "EXPRESSION-FORTS", 1, 3, false);
        declareFunction(me, "expression_list_forts", "EXPRESSION-LIST-FORTS", 1, 2, false);
        declareFunction(me, "formula_forts", "FORMULA-FORTS", 1, 3, false);
        declareFunction(me, "expression_constants", "EXPRESSION-CONSTANTS", 1, 1, false);
        declareFunction(me, "expression_list_constants", "EXPRESSION-LIST-CONSTANTS", 1, 1, false);
        declareFunction(me, "formula_constants", "FORMULA-CONSTANTS", 1, 1, false);
        declareFunction(me, "expression_narts", "EXPRESSION-NARTS", 1, 2, false);
        declareFunction(me, "expression_list_narts", "EXPRESSION-LIST-NARTS", 1, 2, false);
        declareFunction(me, "formula_narts", "FORMULA-NARTS", 1, 2, false);
        declareFunction(me, "expression_sub_assertions", "EXPRESSION-SUB-ASSERTIONS", 1, 2, false);
        declareFunction(me, "expression_list_sub_assertions", "EXPRESSION-LIST-SUB-ASSERTIONS", 1, 2, false);
        declareFunction(me, "formula_sub_assertions", "FORMULA-SUB-ASSERTIONS", 1, 2, false);
        declareFunction(me, "assertion_sub_assertions", "ASSERTION-SUB-ASSERTIONS", 1, 2, false);
        declareFunction(me, "nart_sub_assertions", "NART-SUB-ASSERTIONS", 1, 2, false);
        declareFunction(me, "subnarts", "SUBNARTS", 1, 2, false);
        declareFunction(me, "all_formula_terms", "ALL-FORMULA-TERMS", 1, 1, false);
        declareFunction(me, "all_literal_terms", "ALL-LITERAL-TERMS", 1, 1, false);
        declareFunction(me, "top_level_predicates", "TOP-LEVEL-PREDICATES", 1, 1, false);
        declareFunction(me, "top_level_predicates_int", "TOP-LEVEL-PREDICATES-INT", 1, 0, false);
        declareFunction(me, "containing_subexpressions", "CONTAINING-SUBEXPRESSIONS", 2, 0, false);
        declareFunction(me, "containing_subexpressions_lambda_fn", "CONTAINING-SUBEXPRESSIONS-LAMBDA-FN", 1, 0, false);
        declareFunction(me, "expression_contains_keywordp", "EXPRESSION-CONTAINS-KEYWORDP", 1, 1, false);
        declareFunction(me, "expression_find_if_int", "EXPRESSION-FIND-IF-INT", 4, 0, false);
        declareFunction(me, "expression_find_if", "EXPRESSION-FIND-IF", 2, 2, false);
        declareFunction(me, "formula_find_if", "FORMULA-FIND-IF", 2, 2, false);
        declareFunction(me, "assertion_find_if", "ASSERTION-FIND-IF", 2, 2, false);
        declareFunction(me, "nart_find_if", "NART-FIND-IF", 2, 2, false);
        declareFunction(me, "expression_find_int", "EXPRESSION-FIND-INT", 5, 0, false);
        declareFunction(me, "expression_find", "EXPRESSION-FIND", 2, 3, false);
        declareFunction(me, "formula_find", "FORMULA-FIND", 2, 3, false);
        declareFunction(me, "assertion_find", "ASSERTION-FIND", 2, 3, false);
        declareFunction(me, "nart_find", "NART-FIND", 2, 3, false);
        declareFunction(me, "expression_list_find", "EXPRESSION-LIST-FIND", 2, 3, false);
        declareFunction(me, "remove_if_not_in_expression", "REMOVE-IF-NOT-IN-EXPRESSION", 2, 3, false);
        declareFunction(me, "expression_find_any", "EXPRESSION-FIND-ANY", 2, 3, false);
        declareFunction(me, "expression_map_int", "EXPRESSION-MAP-INT", 4, 0, false);
        declareFunction(me, "expression_map", "EXPRESSION-MAP", 2, 2, false);
        declareFunction(me, "formula_map", "FORMULA-MAP", 2, 2, false);
        declareFunction(me, "assertion_map", "ASSERTION-MAP", 2, 2, false);
        declareFunction(me, "nart_map", "NART-MAP", 2, 2, false);
        declareFunction(me, "expression_ntransform_int", "EXPRESSION-NTRANSFORM-INT", 8, 0, false);
        declareFunction(me, "expression_transform", "EXPRESSION-TRANSFORM", 3, 2, false);
        declareFunction(me, "expression_ntransform", "EXPRESSION-NTRANSFORM", 3, 2, false);
        declareFunction(me, "formula_transform", "FORMULA-TRANSFORM", 3, 2, false);
        declareFunction(me, "formula_ntransform", "FORMULA-NTRANSFORM", 3, 2, false);
        declareFunction(me, "expression_transform_if", "EXPRESSION-TRANSFORM-IF", 3, 2, false);
        declareFunction(me, "expression_ntransform_if", "EXPRESSION-NTRANSFORM-IF", 3, 2, false);
        declareFunction(me, "formula_transform_if", "FORMULA-TRANSFORM-IF", 3, 2, false);
        declareFunction(me, "formula_ntransform_if", "FORMULA-NTRANSFORM-IF", 3, 2, false);
        declareFunction(me, "expression_transform_if_not", "EXPRESSION-TRANSFORM-IF-NOT", 3, 2, false);
        declareFunction(me, "expression_ntransform_if_not", "EXPRESSION-NTRANSFORM-IF-NOT", 3, 2, false);
        declareFunction(me, "formula_transform_if_not", "FORMULA-TRANSFORM-IF-NOT", 3, 2, false);
        declareFunction(me, "formula_ntransform_if_not", "FORMULA-NTRANSFORM-IF-NOT", 3, 2, false);
        declareFunction(me, "formula_and_mt_transform", "FORMULA-AND-MT-TRANSFORM", 4, 2, false);
        declareFunction(me, "formula_and_mt_ntransform", "FORMULA-AND-MT-NTRANSFORM", 4, 2, false);
        declareFunction(me, "sentence_and_mt_transform", "SENTENCE-AND-MT-TRANSFORM", 4, 2, false);
        declareFunction(me, "sentence_and_mt_ntransform", "SENTENCE-AND-MT-NTRANSFORM", 4, 2, false);
        declareFunction(me, "expression_nsubst_free_vars_int", "EXPRESSION-NSUBST-FREE-VARS-INT", 4, 0, false);
        declareFunction(me, "expression_nsubst_free_vars", "EXPRESSION-NSUBST-FREE-VARS", 3, 1, false);
        declareFunction(me, "expression_nsubst_int", "EXPRESSION-NSUBST-INT", 5, 0, false);
        declareFunction(me, "expression_subst", "EXPRESSION-SUBST", 3, 2, false);
        declareFunction(me, "expression_nsubst", "EXPRESSION-NSUBST", 3, 2, false);
        declareFunction(me, "formula_subst", "FORMULA-SUBST", 3, 2, false);
        declareFunction(me, "formula_nsubst", "FORMULA-NSUBST", 3, 2, false);
        declareFunction(me, "expression_nsublis_free_vars_int", "EXPRESSION-NSUBLIS-FREE-VARS-INT", 3, 0, false);
        declareFunction(me, "expression_nsublis_free_vars", "EXPRESSION-NSUBLIS-FREE-VARS", 2, 1, false);
        declareFunction(me, "expression_nsublis_int", "EXPRESSION-NSUBLIS-INT", 4, 0, false);
        declareFunction(me, "expression_sublis", "EXPRESSION-SUBLIS", 2, 2, false);
        declareFunction(me, "expression_nsublis", "EXPRESSION-NSUBLIS", 2, 2, false);
        declareFunction(me, "formula_sublis", "FORMULA-SUBLIS", 2, 2, false);
        declareFunction(me, "formula_nsublis", "FORMULA-NSUBLIS", 2, 2, false);
        declareFunction(me, "expression_nsublis_el_variables", "EXPRESSION-NSUBLIS-EL-VARIABLES", 2, 0, false);
        declareFunction(me, "expression_sublis_el_variables", "EXPRESSION-SUBLIS-EL-VARIABLES", 2, 0, false);
        declareFunction(me, "expression_nsublis_hl_variables", "EXPRESSION-NSUBLIS-HL-VARIABLES", 1, 0, false);
        declareFunction(me, "expression_sublis_hl_variables", "EXPRESSION-SUBLIS-HL-VARIABLES", 1, 0, false);
        declareFunction(me, "cnf_nsublis_el_variables", "CNF-NSUBLIS-EL-VARIABLES", 2, 0, false);
        declareFunction(me, "cnf_sublis_el_variables", "CNF-SUBLIS-EL-VARIABLES", 2, 0, false);
        declareFunction(me, "formula_arg_position_subst", "FORMULA-ARG-POSITION-SUBST", 3, 0, false);
        declareFunction(me, "formula_arg_position_nsubst", "FORMULA-ARG-POSITION-NSUBST", 3, 0, false);
        declareFunction(me, "permute_formula", "PERMUTE-FORMULA", 3, 0, false);
        declareFunction(me, "formula_permutations", "FORMULA-PERMUTATIONS", 2, 0, false);
        declareFunction(me, "formulas_permutations", "FORMULAS-PERMUTATIONS", 2, 0, false);
        declareFunction(me, "formula_arg_permutations", "FORMULA-ARG-PERMUTATIONS", 1, 0, false);
        declareFunction(me, "nat_commutative_permutations", "NAT-COMMUTATIVE-PERMUTATIONS", 1, 0, false);
        declareFunction(me, "clear_permute_list_cached", "CLEAR-PERMUTE-LIST-CACHED", 0, 0, false);
        declareFunction(me, "remove_permute_list_cached", "REMOVE-PERMUTE-LIST-CACHED", 1, 0, false);
        declareFunction(me, "permute_list_cached_internal", "PERMUTE-LIST-CACHED-INTERNAL", 1, 0, false);
        declareFunction(me, "permute_list_cached", "PERMUTE-LIST-CACHED", 1, 0, false);
        declareFunction(me, "formula_commutative_permutations", "FORMULA-COMMUTATIVE-PERMUTATIONS", 1, 1, false);
        declareFunction(me, "canonical_commutative_permutations", "CANONICAL-COMMUTATIVE-PERMUTATIONS", 1, 2, false);
        declareFunction(me, "variable_argnums", "VARIABLE-ARGNUMS", 1, 1, false);
        declareFunction(me, "args_canonical_commutative_permutations", "ARGS-CANONICAL-COMMUTATIVE-PERMUTATIONS", 2, 0, false);
        declareFunction(me, "formulas_canonical_permutations", "FORMULAS-CANONICAL-PERMUTATIONS", 1, 0, false);
        declareFunction(me, "canonical_permute_formula", "CANONICAL-PERMUTE-FORMULA", 3, 0, false);
        declareFunction(me, "nat_canonical_commutative_permutations", "NAT-CANONICAL-COMMUTATIVE-PERMUTATIONS", 2, 0, false);
        declareFunction(me, "split_list_set", "SPLIT-LIST-SET", 1, 0, false);
        declareFunction(me, "permutations_merge", "PERMUTATIONS-MERGE", 2, 0, false);
        declareFunction(me, "formula_operator_recursive", "FORMULA-OPERATOR-RECURSIVE", 1, 0, false);
        declareFunction(me, "rename_default_el_vars_int", "RENAME-DEFAULT-EL-VARS-INT", 2, 0, false);
        declareFunction(me, "rename_default_el_vars", "RENAME-DEFAULT-EL-VARS", 1, 0, false);
        declareFunction(me, "rename_default_el_vars_destructive", "RENAME-DEFAULT-EL-VARS-DESTRUCTIVE", 1, 0, false);
        declareFunction(me, "unrename_default_el_vars_int", "UNRENAME-DEFAULT-EL-VARS-INT", 2, 0, false);
        declareFunction(me, "unrename_default_el_vars", "UNRENAME-DEFAULT-EL-VARS", 1, 0, false);
        declareFunction(me, "unrename_default_el_vars_destructive", "UNRENAME-DEFAULT-EL-VARS-DESTRUCTIVE", 1, 0, false);
        declareFunction(me, "renamed_default_el_var_num", "RENAMED-DEFAULT-EL-VAR-NUM", 1, 0, false);
        declareFunction(me, "renamed_default_el_var_p", "RENAMED-DEFAULT-EL-VAR-P", 1, 0, false);
        new cycl_utilities.$renamed_default_el_var_p$UnaryFunction();
        declareFunction(me, "get_renamed_default_el_var", "GET-RENAMED-DEFAULT-EL-VAR", 1, 0, false);
        declareFunction(me, "non_indexed_fort_p", "NON-INDEXED-FORT-P", 1, 0, false);
        declareFunction(me, "fort_or_naut_p", "FORT-OR-NAUT-P", 1, 0, false);
        declareFunction(me, "fort_or_possibly_naut_p", "FORT-OR-POSSIBLY-NAUT-P", 1, 0, false);
        declareFunction(me, "naut_substitute", "NAUT-SUBSTITUTE", 1, 0, false);
        declareFunction(me, "collection_intersection_natP", "COLLECTION-INTERSECTION-NAT?", 1, 0, false);
        declareFunction(me, "collection_union_natP", "COLLECTION-UNION-NAT?", 1, 0, false);
        declareFunction(me, "collection_intersection", "COLLECTION-INTERSECTION", 1, 0, false);
        declareFunction(me, "collection_union", "COLLECTION-UNION", 1, 0, false);
        declareFunction(me, "collection_intersection_intersectees", "COLLECTION-INTERSECTION-INTERSECTEES", 1, 0, false);
        declareFunction(me, "collection_union_united_collections", "COLLECTION-UNION-UNITED-COLLECTIONS", 1, 0, false);
        declareFunction(me, "find_denotational_term", "FIND-DENOTATIONAL-TERM", 1, 0, false);
        declareFunction(me, "denotational_term_name", "DENOTATIONAL-TERM-NAME", 1, 0, false);
        declareFunction(me, "denotational_term_name_for_alpha_sort", "DENOTATIONAL-TERM-NAME-FOR-ALPHA-SORT", 1, 0, false);
        declareFunction(me, "sorted_constant_list", "SORTED-CONSTANT-LIST", 1, 0, false);
        declareFunction(me, "sorted_constant_external_id_list", "SORTED-CONSTANT-EXTERNAL-ID-LIST", 1, 0, false);
        declareFunction(me, "sorted_constant_internal_id_list", "SORTED-CONSTANT-INTERNAL-ID-LIST", 1, 0, false);
        declareFunction(me, "constant_list", "CONSTANT-LIST", 1, 1, false);
        declareFunction(me, "sorted_nat_list", "SORTED-NAT-LIST", 1, 0, false);
        declareFunction(me, "nat_list", "NAT-LIST", 1, 0, false);
        declareFunction(me, "sorted_assertion_list", "SORTED-ASSERTION-LIST", 1, 0, false);
        declareFunction(me, "assertion_list", "ASSERTION-LIST", 1, 0, false);
        declareFunction(me, "sorted_fort_id_list", "SORTED-FORT-ID-LIST", 1, 0, false);
        declareFunction(me, "functional_in_some_argP", "FUNCTIONAL-IN-SOME-ARG?", 1, 0, false);
        declareFunction(me, "functional_in_arg_positions_internal", "FUNCTIONAL-IN-ARG-POSITIONS-INTERNAL", 1, 1, false);
        declareFunction(me, "functional_in_arg_positions", "FUNCTIONAL-IN-ARG-POSITIONS", 1, 1, false);
        declareFunction(me, "strictly_functional_in_some_argP", "STRICTLY-FUNCTIONAL-IN-SOME-ARG?", 1, 0, false);
        declareFunction(me, "strictly_functional_in_arg_positions_internal", "STRICTLY-FUNCTIONAL-IN-ARG-POSITIONS-INTERNAL", 1, 1, false);
        declareFunction(me, "strictly_functional_in_arg_positions", "STRICTLY-FUNCTIONAL-IN-ARG-POSITIONS", 1, 1, false);
        declareFunction(me, "nart_cons", "NART-CONS", 1, 0, false);
        declareFunction(me, "lookup_all_narts", "LOOKUP-ALL-NARTS", 1, 0, false);
        declareFunction(me, "reify_all_existing_narts", "REIFY-ALL-EXISTING-NARTS", 1, 0, false);
        declareFunction(me, "opaque_arg_wrt_nat_reificationP", "OPAQUE-ARG-WRT-NAT-REIFICATION?", 2, 0, false);
        declareFunction(me, "reify_arg_when_closed_naut", "REIFY-ARG-WHEN-CLOSED-NAUT", 2, 0, false);
        declareFunction(me, "reify_when_closed_naut", "REIFY-WHEN-CLOSED-NAUT", 1, 0, false);
        declareFunction(me, "find_when_closed_naut", "FIND-WHEN-CLOSED-NAUT", 1, 0, false);
        declareFunction(me, "find_closed_naut", "FIND-CLOSED-NAUT", 1, 0, false);
        declareFunction(me, "find_when_ground_naut", "FIND-WHEN-GROUND-NAUT", 1, 0, false);
        declareFunction(me, "find_ground_naut", "FIND-GROUND-NAUT", 1, 0, false);
        declareFunction(me, "ground_hl_formulaP", "GROUND-HL-FORMULA?", 1, 0, false);
        declareFunction(me, "atomic_sentence_with_pred_p", "ATOMIC-SENTENCE-WITH-PRED-P", 2, 0, false);
        declareFunction(me, "atomic_sentence_with_any_of_preds_p", "ATOMIC-SENTENCE-WITH-ANY-OF-PREDS-P", 2, 0, false);
        declareFunction(me, "null_or_falseP", "NULL-OR-FALSE?", 1, 0, false);
        declareFunction(me, "possibly_cycl_formula_p", "POSSIBLY-CYCL-FORMULA-P", 1, 0, false);
        declareFunction(me, "negatedP", "NEGATED?", 1, 0, false);
        declareFunction(me, "negate", "NEGATE", 1, 0, false);
        declareFunction(me, "possibly_negate", "POSSIBLY-NEGATE", 2, 0, false);
        declareFunction(me, "formula_arg", "FORMULA-ARG", 2, 1, false);
        declareFunction(me, "el_formula_arg", "EL-FORMULA-ARG", 2, 1, false);
        declareFunction(me, "el_formula_has_argP", "EL-FORMULA-HAS-ARG?", 3, 0, false);
        declareFunction(me, "formula_arg0", "FORMULA-ARG0", 1, 0, false);
        declareFunction(me, "formula_operator", "FORMULA-OPERATOR", 1, 0, false);
        declareFunction(me, "el_formula_operator", "EL-FORMULA-OPERATOR", 1, 0, false);
        declareFunction(me, "el_formula_arg1", "EL-FORMULA-ARG1", 1, 1, false);
        declareFunction(me, "el_formula_arg2", "EL-FORMULA-ARG2", 1, 1, false);
        declareFunction(me, "el_formula_arg3", "EL-FORMULA-ARG3", 1, 1, false);
        declareFunction(me, "formula_arg1", "FORMULA-ARG1", 1, 1, false);
        declareFunction(me, "formula_arg2", "FORMULA-ARG2", 1, 1, false);
        declareFunction(me, "formula_arg3", "FORMULA-ARG3", 1, 1, false);
        declareFunction(me, "formula_arg4", "FORMULA-ARG4", 1, 1, false);
        declareFunction(me, "formula_arg5", "FORMULA-ARG5", 1, 1, false);
        declareFunction(me, "formula_arg6", "FORMULA-ARG6", 1, 1, false);
        declareFunction(me, "formula_args", "FORMULA-ARGS", 1, 1, false);
        declareFunction(me, "el_formula_args", "EL-FORMULA-ARGS", 1, 1, false);
        declareFunction(me, "cycl_formula_args", "CYCL-FORMULA-ARGS", 1, 0, false);
        declareFunction(me, "cycl_formula_arg0", "CYCL-FORMULA-ARG0", 1, 0, false);
        declareFunction(me, "cycl_formula_arg1", "CYCL-FORMULA-ARG1", 1, 0, false);
        declareFunction(me, "cycl_formula_arg2", "CYCL-FORMULA-ARG2", 1, 0, false);
        declareFunction(me, "cycl_formula_arg3", "CYCL-FORMULA-ARG3", 1, 0, false);
        declareFunction(me, "formula_terms", "FORMULA-TERMS", 1, 1, false);
        declareFunction(me, "el_formula_terms", "EL-FORMULA-TERMS", 1, 1, false);
        declareFunction(me, "formula_terms_int", "FORMULA-TERMS-INT", 2, 1, false);
        declareFunction(me, "formula_terms_int_two_pass", "FORMULA-TERMS-INT-TWO-PASS", 2, 0, false);
        declareFunction(me, "formula_terms_int_one_pass", "FORMULA-TERMS-INT-ONE-PASS", 2, 0, false);
        declareFunction(me, "formula_arg_positions", "FORMULA-ARG-POSITIONS", 2, 1, false);
        declareFunction(me, "el_formula_arg_positions", "EL-FORMULA-ARG-POSITIONS", 2, 1, false);
        declareFunction(me, "possibly_conjuncts", "POSSIBLY-CONJUNCTS", 1, 0, false);
        declareFunction(me, "nat_arity", "NAT-ARITY", 1, 1, false);
        declareFunction(me, "nat_args", "NAT-ARGS", 1, 1, false);
        declareFunction(me, "naut_args", "NAUT-ARGS", 1, 1, false);
        declareFunction(me, "nat_arg", "NAT-ARG", 2, 1, false);
        declareFunction(me, "naut_arg", "NAUT-ARG", 2, 1, false);
        declareFunction(me, "nat_function", "NAT-FUNCTION", 1, 0, false);
        declareFunction(me, "nat_functor", "NAT-FUNCTOR", 1, 0, false);
        declareFunction(me, "naut_functor", "NAUT-FUNCTOR", 1, 0, false);
        declareFunction(me, "nat_arg0", "NAT-ARG0", 1, 0, false);
        declareFunction(me, "nat_arg1", "NAT-ARG1", 1, 1, false);
        declareFunction(me, "naut_arg1", "NAUT-ARG1", 1, 1, false);
        declareFunction(me, "nat_arg2", "NAT-ARG2", 1, 1, false);
        declareFunction(me, "naut_arg2", "NAUT-ARG2", 1, 1, false);
        declareFunction(me, "nat_arg3", "NAT-ARG3", 1, 1, false);
        declareFunction(me, "naut_arg3", "NAUT-ARG3", 1, 1, false);
        declareFunction(me, "nat_arg4", "NAT-ARG4", 1, 1, false);
        declareFunction(me, "nat_arg5", "NAT-ARG5", 1, 1, false);
        declareFunction(me, "nat_with_functor_p", "NAT-WITH-FUNCTOR-P", 2, 0, false);
        declareFunction(me, "naut_with_functor_p", "NAUT-WITH-FUNCTOR-P", 2, 0, false);
        declareFunction(me, "naut_with_any_of_functors_p", "NAUT-WITH-ANY-OF-FUNCTORS-P", 2, 0, false);
        declareFunction(me, "cycl_nat_with_functor_p", "CYCL-NAT-WITH-FUNCTOR-P", 2, 0, false);
        declareFunction(me, "sentence_arg", "SENTENCE-ARG", 2, 1, false);
        declareFunction(me, "sentence_args", "SENTENCE-ARGS", 1, 1, false);
        declareFunction(me, "sentence_truth_function", "SENTENCE-TRUTH-FUNCTION", 1, 0, false);
        declareFunction(me, "sentence_arg0", "SENTENCE-ARG0", 1, 0, false);
        declareFunction(me, "sentence_arg1", "SENTENCE-ARG1", 1, 1, false);
        declareFunction(me, "sentence_arg2", "SENTENCE-ARG2", 1, 1, false);
        declareFunction(me, "sentence_arg3", "SENTENCE-ARG3", 1, 1, false);
        declareFunction(me, "sentence_arg4", "SENTENCE-ARG4", 1, 1, false);
        declareFunction(me, "sentence_arg5", "SENTENCE-ARG5", 1, 1, false);
        declareFunction(me, "atomic_sentence_arg", "ATOMIC-SENTENCE-ARG", 2, 1, false);
        declareFunction(me, "atomic_sentence_args", "ATOMIC-SENTENCE-ARGS", 1, 1, false);
        declareFunction(me, "atomic_sentence_predicate", "ATOMIC-SENTENCE-PREDICATE", 1, 0, false);
        new cycl_utilities.$atomic_sentence_predicate$UnaryFunction();
        declareFunction(me, "atomic_sentence_arg0", "ATOMIC-SENTENCE-ARG0", 1, 0, false);
        declareFunction(me, "atomic_sentence_arg1", "ATOMIC-SENTENCE-ARG1", 1, 1, false);
        declareFunction(me, "atomic_sentence_arg2", "ATOMIC-SENTENCE-ARG2", 1, 1, false);
        declareFunction(me, "atomic_sentence_arg3", "ATOMIC-SENTENCE-ARG3", 1, 1, false);
        declareFunction(me, "atomic_sentence_arg4", "ATOMIC-SENTENCE-ARG4", 1, 1, false);
        declareFunction(me, "atomic_sentence_arg5", "ATOMIC-SENTENCE-ARG5", 1, 1, false);
        declareFunction(me, "atomic_sentence_arg6", "ATOMIC-SENTENCE-ARG6", 1, 1, false);
        declareFunction(me, "arg_position_p", "ARG-POSITION-P", 1, 0, false);
        declareFunction(me, "formula_arg_position", "FORMULA-ARG-POSITION", 2, 1, false);
        declareFunction(me, "get_nested_nth_arg", "GET-NESTED-NTH-ARG", 2, 1, false);
        declareFunction(me, "arg_positions_dfs", "ARG-POSITIONS-DFS", 2, 1, false);
        declareFunction(me, "arg_positions_bfs", "ARG-POSITIONS-BFS", 2, 1, false);
        declareFunction(me, "arg_positions_if_dfs", "ARG-POSITIONS-IF-DFS", 2, 1, false);
        declareFunction(me, "arg_positions_if_bfs", "ARG-POSITIONS-IF-BFS", 2, 1, false);
        declareFunction(me, "smallest_enclosing_cycl_sentence", "SMALLEST-ENCLOSING-CYCL-SENTENCE", 2, 0, false);
        declareFunction(me, "cycl_arg_position_p", "CYCL-ARG-POSITION-P", 1, 0, false);
        declareFunction(me, "make_cycl_arg_position", "MAKE-CYCL-ARG-POSITION", 1, 0, false);
        declareFunction(me, "cycl_arg_position_to_arg_position", "CYCL-ARG-POSITION-TO-ARG-POSITION", 1, 0, false);
        declareFunction(me, "formula_cycl_arg_position", "FORMULA-CYCL-ARG-POSITION", 2, 1, false);
        declareFunction(me, "cycl_arg_position_nsubst", "CYCL-ARG-POSITION-NSUBST", 3, 0, false);
        declareFunction(me, "substitute_terms_into_positions", "SUBSTITUTE-TERMS-INTO-POSITIONS", 3, 0, false);
        return NIL;
    }
