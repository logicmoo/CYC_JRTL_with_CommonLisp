...
public final class rbp_chart_parser extends SubLTranslatedFile {
    ...
    public static SubLObject rbp_chart_p(final SubLObject v_object) {
        return v_object.getClass() == rbp_chart_parser.$rbp_chart_native.class ? T : NIL;
    }

    public static SubLObject rbp_chart_input_length(final SubLObject v_object) {
        assert NIL != rbp_chart_p(v_object) : "rbp_chart_parser.rbp_chart_p(v_object) " + "CommonSymbols.NIL != rbp_chart_parser.rbp_chart_p(v_object) " + v_object;
    ...
    public static SubLObject make_rbp_chart(SubLObject arglist) {
        ...
        final SubLObject v_new = new rbp_chart_parser.$rbp_chart_native();
        SubLObject next;
    ...
    public static final class $rbp_chart_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rbp_chart_parser.$rbp_chart_native.class, RBP_CHART, RBP_CHART_P, $list2, $list3, new String[]{ "$input_length", "$edges", "$done_spans", "$block_merge_fn", "$block_hash" }, $list4, $list5, RBP_CHART_SUMMARIZE);
        }
    }
