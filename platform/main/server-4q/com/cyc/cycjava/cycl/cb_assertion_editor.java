...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class cb_assertion_editor extends SubLTranslatedFile {
    ...
    public static SubLObject cb_assertion_spec_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$cb_assertion_spec_native.class ? T : NIL;
    }

    public static SubLObject assertion_spec_sentence(final SubLObject v_object) {
        assert NIL != cb_assertion_spec_p(v_object) : "cb_assertion_editor.cb_assertion_spec_p error :" + v_object;
    ...
    public static final class $cb_assertion_spec_native extends SubLStructNative {
        ...
        private $cb_assertion_spec_native() {
        ...
        static {
            structDecl = makeStructDeclNative($cb_assertion_spec_native.class, CB_ASSERTION_SPEC, CB_ASSERTION_SPEC_P, $list3, $list4, new String[]{ "$sentence", "$mt", "$strength", "$direction", "$unasserts", "$metas" }, $list5, $list6, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
