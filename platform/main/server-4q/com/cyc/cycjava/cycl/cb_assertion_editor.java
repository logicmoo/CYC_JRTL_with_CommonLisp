...
import static com.cyc.cycjava.cycl.cb_assertion_editor.*;
...
public final class cb_assertion_editor extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol CB_NOTE_NEW_FORWARD_INFERENCE_FOR_BROWSING = makeSymbol("CB-NOTE-NEW-FORWARD-INFERENCE-FOR-BROWSING");

    public static final SubLSymbol CB_ASSERTION_SPEC = makeSymbol("CB-ASSERTION-SPEC");

    public static final SubLSymbol CB_ASSERTION_SPEC_P = makeSymbol("CB-ASSERTION-SPEC-P");

    public static final SubLList $list3 = list(makeSymbol("SENTENCE"), makeSymbol("MT"), makeSymbol("STRENGTH"), makeSymbol("DIRECTION"), makeSymbol("UNASSERTS"), makeSymbol("METAS"));

    public static final SubLList $list4 = list(makeKeyword("SENTENCE"), makeKeyword("MT"), makeKeyword("STRENGTH"), makeKeyword("DIRECTION"), makeKeyword("UNASSERTS"), makeKeyword("METAS"));

    public static final SubLList $list5 = list(makeSymbol("ASSERTION-SPEC-SENTENCE"), makeSymbol("ASSERTION-SPEC-MT"), makeSymbol("ASSERTION-SPEC-STRENGTH"), makeSymbol("ASSERTION-SPEC-DIRECTION"), makeSymbol("ASSERTION-SPEC-UNASSERTS"), makeSymbol("ASSERTION-SPEC-METAS"));

    public static final SubLList $list6 = list(makeSymbol("_CSETF-ASSERTION-SPEC-SENTENCE"), makeSymbol("_CSETF-ASSERTION-SPEC-MT"), makeSymbol("_CSETF-ASSERTION-SPEC-STRENGTH"), makeSymbol("_CSETF-ASSERTION-SPEC-DIRECTION"), makeSymbol("_CSETF-ASSERTION-SPEC-UNASSERTS"), makeSymbol("_CSETF-ASSERTION-SPEC-METAS"));



    public static final SubLSymbol CB_ASSERTION_SPEC_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("CB-ASSERTION-SPEC-PRINT-FUNCTION-TRAMPOLINE");
    ...
    private static final SubLObject $const130$InferenceRelatedBookkeepingPredic = reader_make_constant_shell(makeString("InferenceRelatedBookkeepingPredicate"));
    ...
    private static final SubLList $list296 = list(list(makeKeyword("DEFAULT"), makeString("cb-handle-assert"), makeString("Assert Sentence"), makeString("Assert Sentence")), list(makeKeyword("SIMILAR"), makeString("cb-handle-assert"), makeString("Assert Similar Sentence"), makeString("Assert Sentence")), list(makeKeyword("EDIT"), makeString("cb-handle-edit"), makeString("Edit Assertion"), makeString("Perform Edit")), list(makeKeyword("EDIT-SENTENCE"), makeString("cb-handle-sentence-edit"), makeString("Edit Sentence"), makeString("Perform Edit")), list(makeKeyword("FIX-TYPO"), makeString("cb-handle-fix-typo"), makeString("Fix Assertion"), makeString("Perform Fix")), list(makeKeyword("META"), makeString("cb-handle-assert-meta"), makeString("Assert Meta Assertion"), makeString("Assert Sentence")));
    ...
    private static final SubLList $list340 = list(reader_make_constant_shell(makeString("UniversalVocabularyMt")));
    ...
    private static final SubLList $list355 = list(reader_make_constant_shell(makeString("TheAssertionSentence")), reader_make_constant_shell(makeString("exceptWhen")), reader_make_constant_shell(makeString("pragmaticRequirement")), reader_make_constant_shell(makeString("salientAssertions")));
    ...
    public static final SubLList $list368 = list(makeSymbol("FORMULA-ID"), makeSymbol("MT-ID"));
    ...
    public static SubLObject cb_assertion_spec_p(final SubLObject v_object) {
        return v_object.getClass() == cb_assertion_editor.$cb_assertion_spec_native.class ? T : NIL;
    }

    public static SubLObject assertion_spec_sentence(final SubLObject v_object) {
        assert NIL != cb_assertion_spec_p(v_object) : "cb_assertion_editor.cb_assertion_spec_p(v_object) " + "CommonSymbols.NIL != cb_assertion_editor.cb_assertion_spec_p(v_object) " + v_object;
    ...
    public static SubLObject make_cb_assertion_spec(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_assertion_editor.$cb_assertion_spec_native();
        SubLObject next;
    ...
    public static SubLObject ke_assert_assertion_spec(final SubLObject cb_assertion_spec) {
        assert NIL != cb_assertion_spec_p(cb_assertion_spec) : "cb_assertion_editor.cb_assertion_spec_p(cb_assertion_spec) " + "CommonSymbols.NIL != cb_assertion_editor.cb_assertion_spec_p(cb_assertion_spec) " + cb_assertion_spec;
    ...
    public static SubLObject cb_explain_why_not_wff(final SubLObject sentence, final SubLObject mt, SubLObject violations, SubLObject strength, SubLObject direction, SubLObject attempt_to_repair_and_assertP, SubLObject pending_assertions, SubLObject unasserts, SubLObject metas) {
        ...
        if (NIL != pending_assertions) {
            assert NIL != stacks.stack_p(pending_assertions) : "stacks.stack_p(pending_assertions) " + "CommonSymbols.NIL != stacks.stack_p(pending_assertions) " + pending_assertions;
        } else {
    ...
    public static SubLObject declare_cb_assertion_editor_file() {
        declareFunction(me, "cb_change_mt_hook", "CB-CHANGE-MT-HOOK", 2, 1, false);
        declareFunction(me, "cb_change_strength_hook", "CB-CHANGE-STRENGTH-HOOK", 2, 0, false);
        declareFunction(me, "cb_change_direction_hook", "CB-CHANGE-DIRECTION-HOOK", 2, 0, false);
        declareFunction(me, "cb_repropagate_hook", "CB-REPROPAGATE-HOOK", 1, 0, false);
        declareFunction(me, "cb_repropagate_browsably_hook", "CB-REPROPAGATE-BROWSABLY-HOOK", 1, 0, false);
        declareFunction(me, "cb_recanonicalize_hook", "CB-RECANONICALIZE-HOOK", 1, 1, false);
        declareFunction(me, "cb_rename_variables_hook", "CB-RENAME-VARIABLES-HOOK", 2, 0, false);
        declareFunction(me, "cb_edit_assertion_hook", "CB-EDIT-ASSERTION-HOOK", 5, 2, false);
        declareFunction(me, "cb_null_edit_assertion_hook", "CB-NULL-EDIT-ASSERTION-HOOK", 1, 0, false);
        declareFunction(me, "cb_edit_assertion_strings_hook", "CB-EDIT-ASSERTION-STRINGS-HOOK", 2, 1, false);
        declareFunction(me, "cb_assertion_spec_print_function_trampoline", "CB-ASSERTION-SPEC-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "cb_assertion_spec_p", "CB-ASSERTION-SPEC-P", 1, 0, false);
        new cb_assertion_editor.$cb_assertion_spec_p$UnaryFunction();
        declareFunction(me, "assertion_spec_sentence", "ASSERTION-SPEC-SENTENCE", 1, 0, false);
        declareFunction(me, "assertion_spec_mt", "ASSERTION-SPEC-MT", 1, 0, false);
        declareFunction(me, "assertion_spec_strength", "ASSERTION-SPEC-STRENGTH", 1, 0, false);
        declareFunction(me, "assertion_spec_direction", "ASSERTION-SPEC-DIRECTION", 1, 0, false);
        declareFunction(me, "assertion_spec_unasserts", "ASSERTION-SPEC-UNASSERTS", 1, 0, false);
        declareFunction(me, "assertion_spec_metas", "ASSERTION-SPEC-METAS", 1, 0, false);
        declareFunction(me, "_csetf_assertion_spec_sentence", "_CSETF-ASSERTION-SPEC-SENTENCE", 2, 0, false);
        declareFunction(me, "_csetf_assertion_spec_mt", "_CSETF-ASSERTION-SPEC-MT", 2, 0, false);
        declareFunction(me, "_csetf_assertion_spec_strength", "_CSETF-ASSERTION-SPEC-STRENGTH", 2, 0, false);
        declareFunction(me, "_csetf_assertion_spec_direction", "_CSETF-ASSERTION-SPEC-DIRECTION", 2, 0, false);
        declareFunction(me, "_csetf_assertion_spec_unasserts", "_CSETF-ASSERTION-SPEC-UNASSERTS", 2, 0, false);
        declareFunction(me, "_csetf_assertion_spec_metas", "_CSETF-ASSERTION-SPEC-METAS", 2, 0, false);
        declareFunction(me, "make_cb_assertion_spec", "MAKE-CB-ASSERTION-SPEC", 0, 1, false);
        declareFunction(me, "visit_defstruct_cb_assertion_spec", "VISIT-DEFSTRUCT-CB-ASSERTION-SPEC", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_cb_assertion_spec_method", "VISIT-DEFSTRUCT-OBJECT-CB-ASSERTION-SPEC-METHOD", 2, 0, false);
        declareFunction(me, "new_cb_assertion_spec", "NEW-CB-ASSERTION-SPEC", 2, 4, false);
        declareFunction(me, "ke_assert_assertion_spec", "KE-ASSERT-ASSERTION-SPEC", 1, 0, false);
        declareFunction(me, "cb_note_edit_change", "CB-NOTE-EDIT-CHANGE", 2, 2, false);
        declareFunction(me, "cb_attempt_to_repair_and_assert", "CB-ATTEMPT-TO-REPAIR-AND-ASSERT", 6, 0, false);
        declareFunction(me, "cb_explain_why_not_wff", "CB-EXPLAIN-WHY-NOT-WFF", 2, 7, false);
        declareFunction(me, "cb_wff_repair_advice", "CB-WFF-REPAIR-ADVICE", 6, 0, false);
        declareFunction(me, "cb_wff_repair_advise_assertion_creation", "CB-WFF-REPAIR-ADVISE-ASSERTION-CREATION", 6, 0, false);
        declareFunction(me, "cb_wff_repair_advise_assertion_creation_or_lift", "CB-WFF-REPAIR-ADVISE-ASSERTION-CREATION-OR-LIFT", 7, 0, false);
        declareFunction(me, "assertions_in_spec_mts_among", "ASSERTIONS-IN-SPEC-MTS-AMONG", 2, 0, false);
        declareFunction(me, "cb_wff_repair_advise_assertion_creation_or_lift_to_min_ceiling_mt", "CB-WFF-REPAIR-ADVISE-ASSERTION-CREATION-OR-LIFT-TO-MIN-CEILING-MT", 7, 0, false);
        declareFunction(me, "cb_wff_repair_advise_assertion_lift_from_spec_mt", "CB-WFF-REPAIR-ADVISE-ASSERTION-LIFT-FROM-SPEC-MT", 7, 0, false);
        declareFunction(me, "cb_link_repair_and_reattempt", "CB-LINK-REPAIR-AND-REATTEMPT", 2, 1, false);
        declareFunction(me, "cb_repair_and_reattempt", "CB-REPAIR-AND-REATTEMPT", 1, 0, false);
        declareFunction(me, "cb_assertion_toolbar", "CB-ASSERTION-TOOLBAR", 1, 0, false);
        declareFunction(me, "assertion_modification_permittedP", "ASSERTION-MODIFICATION-PERMITTED?", 1, 0, false);
        declareFunction(me, "cb_disabled_link", "CB-DISABLED-LINK", 1, 0, false);
        declareFunction(me, "cb_change_mt", "CB-CHANGE-MT", 1, 0, false);
        declareFunction(me, "cb_change_all_meta_assertions_mt_check", "CB-CHANGE-ALL-META-ASSERTIONS-MT-CHECK", 1, 0, false);
        declareFunction(me, "cb_handle_change_mt", "CB-HANDLE-CHANGE-MT", 1, 0, false);
        declareFunction(me, "cb_link_change_mt", "CB-LINK-CHANGE-MT", 1, 2, false);
        declareFunction(me, "cb_change_strength", "CB-CHANGE-STRENGTH", 1, 0, false);
        declareFunction(me, "cb_handle_change_strength", "CB-HANDLE-CHANGE-STRENGTH", 1, 0, false);
        declareFunction(me, "cb_link_change_strength", "CB-LINK-CHANGE-STRENGTH", 1, 2, false);
        declareFunction(me, "cb_change_direction", "CB-CHANGE-DIRECTION", 1, 0, false);
        declareFunction(me, "cb_handle_change_direction", "CB-HANDLE-CHANGE-DIRECTION", 1, 0, false);
        declareFunction(me, "cb_link_change_direction", "CB-LINK-CHANGE-DIRECTION", 1, 2, false);
        declareFunction(me, "cb_change_meta_assertion_mt", "CB-CHANGE-META-ASSERTION-MT", 1, 0, false);
        declareFunction(me, "cb_handle_change_meta_assertion_mt", "CB-HANDLE-CHANGE-META-ASSERTION-MT", 1, 0, false);
        declareFunction(me, "cb_link_change_meta_assertion_mt", "CB-LINK-CHANGE-META-ASSERTION-MT", 1, 2, false);
        declareFunction(me, "cb_rename_variables", "CB-RENAME-VARIABLES", 1, 0, false);
        declareFunction(me, "cb_handle_rename_variables", "CB-HANDLE-RENAME-VARIABLES", 1, 0, false);
        declareFunction(me, "cb_extract_variables_from_args", "CB-EXTRACT-VARIABLES-FROM-ARGS", 1, 0, false);
        declareFunction(me, "cb_show_invalid_variables_message", "CB-SHOW-INVALID-VARIABLES-MESSAGE", 1, 0, false);
        declareFunction(me, "cb_link_rename_variables", "CB-LINK-RENAME-VARIABLES", 1, 2, false);
        declareFunction(me, "cb_repropagate", "CB-REPROPAGATE", 1, 0, false);
        declareFunction(me, "cb_link_repropagate", "CB-LINK-REPROPAGATE", 1, 2, false);
        declareFunction(me, "cb_repropagate_browsably", "CB-REPROPAGATE-BROWSABLY", 1, 0, false);
        declareFunction(me, "cb_link_repropagate_browsably", "CB-LINK-REPROPAGATE-BROWSABLY", 1, 2, false);
        declareFunction(me, "cb_recanonicalize", "CB-RECANONICALIZE", 1, 0, false);
        declareFunction(me, "cb_link_recanonicalize", "CB-LINK-RECANONICALIZE", 1, 2, false);
        declareFunction(me, "cb_wff", "CB-WFF", 0, 1, false);
        declareFunction(me, "cb_link_wff", "CB-LINK-WFF", 0, 1, false);
        declareFunction(me, "cb_handle_wff", "CB-HANDLE-WFF", 1, 0, false);
        declareFunction(me, "cb_wff_check_formula", "CB-WFF-CHECK-FORMULA", 1, 1, false);
        declareFunction(me, "cb_wff_check_formula_ok", "CB-WFF-CHECK-FORMULA-OK", 2, 0, false);
        declareFunction(me, "cb_assert", "CB-ASSERT", 0, 1, false);
        declareFunction(me, "cb_handle_assert", "CB-HANDLE-ASSERT", 1, 0, false);
        declareFunction(me, "cb_extract_some_assert_arguments", "CB-EXTRACT-SOME-ASSERT-ARGUMENTS", 1, 0, false);
        declareFunction(me, "cb_link_assert", "CB-LINK-ASSERT", 0, 1, false);
        declareFunction(me, "cb_assert_internal", "CB-ASSERT-INTERNAL", 1, 3, false);
        declareFunction(me, "cb_assert_sentence_constant_suggestions", "CB-ASSERT-SENTENCE-CONSTANT-SUGGESTIONS", 1, 0, false);
        declareFunction(me, "cb_extract_values_for_assert", "CB-EXTRACT-VALUES-FOR-ASSERT", 4, 0, false);
        declareFunction(me, "cb_tabulate_checkable_meta_assertions", "CB-TABULATE-CHECKABLE-META-ASSERTIONS", 1, 4, false);
        declareFunction(me, "cb_show_meta_assertion_readably", "CB-SHOW-META-ASSERTION-READABLY", 2, 3, false);
        declareFunction(me, "cb_extract_mt_from_string", "CB-EXTRACT-MT-FROM-STRING", 1, 0, false);
        declareFunction(me, "cb_valid_microtheoryP", "CB-VALID-MICROTHEORY?", 1, 0, false);
        declareFunction(me, "cb_extract_formula_from_string", "CB-EXTRACT-FORMULA-FROM-STRING", 1, 1, false);
        declareFunction(me, "cb_wff_check_sentence_int", "CB-WFF-CHECK-SENTENCE-INT", 2, 2, false);
        declareFunction(me, "cb_assert_formula", "CB-ASSERT-FORMULA", 1, 0, false);
        declareFunction(me, "cb_link_assert_formula", "CB-LINK-ASSERT-FORMULA", 1, 2, false);
        declareFunction(me, "cb_similar", "CB-SIMILAR", 1, 0, false);
        declareFunction(me, "cb_link_assert_similar", "CB-LINK-ASSERT-SIMILAR", 1, 1, false);
        declareFunction(me, "cb_assert_meta", "CB-ASSERT-META", 1, 0, false);
        declareFunction(me, "cb_handle_assert_meta", "CB-HANDLE-ASSERT-META", 1, 0, false);
        declareFunction(me, "cb_link_assert_meta", "CB-LINK-ASSERT-META", 1, 1, false);
        declareFunction(me, "cb_suggest_pragmas", "CB-SUGGEST-PRAGMAS", 1, 0, false);
        declareFunction(me, "cb_link_suggest_pragmas", "CB-LINK-SUGGEST-PRAGMAS", 1, 3, false);
        declareFunction(me, "cb_suggest_pragmas_guts", "CB-SUGGEST-PRAGMAS-GUTS", 1, 0, false);
        declareFunction(me, "cb_link_assert_suggested_pragma", "CB-LINK-ASSERT-SUGGESTED-PRAGMA", 2, 1, false);
        declareFunction(me, "cb_assert_suggested_pragma", "CB-ASSERT-SUGGESTED-PRAGMA", 1, 0, false);
        declareMacro(me, "without_arg_format_and_relator_checking", "WITHOUT-ARG-FORMAT-AND-RELATOR-CHECKING");
        declareFunction(me, "cb_edit", "CB-EDIT", 1, 0, false);
        declareFunction(me, "cb_handle_edit", "CB-HANDLE-EDIT", 1, 0, false);
        declareFunction(me, "cb_extract_meta_assertions_from_args", "CB-EXTRACT-META-ASSERTIONS-FROM-ARGS", 2, 2, false);
        declareFunction(me, "cb_link_edit_assertion", "CB-LINK-EDIT-ASSERTION", 1, 3, false);
        declareFunction(me, "cb_handle_edit_assertion", "CB-HANDLE-EDIT-ASSERTION", 1, 0, false);
        declareFunction(me, "cb_handle_sentence_edit", "CB-HANDLE-SENTENCE-EDIT", 1, 0, false);
        declareFunction(me, "cb_handle_sentence_edit_int", "CB-HANDLE-SENTENCE-EDIT-INT", 6, 0, false);
        declareFunction(me, "cb_fix_typo_edit", "CB-FIX-TYPO-EDIT", 1, 0, false);
        declareFunction(me, "cb_link_fix_typo", "CB-LINK-FIX-TYPO", 1, 2, false);
        declareFunction(me, "cb_handle_fix_typo", "CB-HANDLE-FIX-TYPO", 1, 0, false);
        declareFunction(me, "cb_fix_typo_assertionP", "CB-FIX-TYPO-ASSERTION?", 1, 0, false);
        declareFunction(me, "cb_reassert", "CB-REASSERT", 1, 0, false);
        declareFunction(me, "cb_link_reassert", "CB-LINK-REASSERT", 1, 2, false);
        declareFunction(me, "cb_unassert", "CB-UNASSERT", 1, 0, false);
        declareFunction(me, "cb_link_unassert", "CB-LINK-UNASSERT", 1, 2, false);
        declareFunction(me, "cb_blast", "CB-BLAST", 1, 0, false);
        declareFunction(me, "cb_link_blast", "CB-LINK-BLAST", 1, 2, false);
        declareFunction(me, "cb_remove_deduction", "CB-REMOVE-DEDUCTION", 1, 0, false);
        declareFunction(me, "cb_link_remove_deduction", "CB-LINK-REMOVE-DEDUCTION", 1, 2, false);
        declareFunction(me, "cb_assertion_tms", "CB-ASSERTION-TMS", 1, 0, false);
        declareFunction(me, "cb_link_assert_tms", "CB-LINK-ASSERT-TMS", 1, 2, false);
        declareFunction(me, "cb_diagnose_assertion", "CB-DIAGNOSE-ASSERTION", 1, 0, false);
        declareFunction(me, "cb_diagnose_assertion_int", "CB-DIAGNOSE-ASSERTION-INT", 1, 0, false);
        declareFunction(me, "cb_link_diagnose_assertion", "CB-LINK-DIAGNOSE-ASSERTION", 1, 1, false);
        declareFunction(me, "cb_link_trigger_test", "CB-LINK-TRIGGER-TEST", 0, 3, false);
        declareFunction(me, "cb_trigger_test_id_strings", "CB-TRIGGER-TEST-ID-STRINGS", 2, 0, false);
        declareFunction(me, "cb_extract_trigger_test_args", "CB-EXTRACT-TRIGGER-TEST-ARGS", 1, 0, false);
        declareFunction(me, "cb_trigger_test", "CB-TRIGGER-TEST", 1, 0, false);
        declareFunction(me, "cb_trigger_test_support_and_rule", "CB-TRIGGER-TEST-SUPPORT-AND-RULE", 2, 0, false);
        declareFunction(me, "cb_trigger_test_support", "CB-TRIGGER-TEST-SUPPORT", 1, 0, false);
        declareFunction(me, "cb_trigger_test_rule", "CB-TRIGGER-TEST-RULE", 1, 0, false);
        declareFunction(me, "cb_trigger_test_unspecified", "CB-TRIGGER-TEST-UNSPECIFIED", 0, 0, false);
        declareFunction(me, "cb_proof_checker_rules", "CB-PROOF-CHECKER-RULES", 0, 0, false);
        declareFunction(me, "cb_add_to_proof_checker_rules", "CB-ADD-TO-PROOF-CHECKER-RULES", 1, 0, false);
        declareFunction(me, "cb_delete_from_proof_checker_rules", "CB-DELETE-FROM-PROOF-CHECKER-RULES", 1, 0, false);
        declareFunction(me, "cb_delete_all_proof_checker_rules", "CB-DELETE-ALL-PROOF-CHECKER-RULES", 0, 0, false);
        declareFunction(me, "cb_use_in_proof", "CB-USE-IN-PROOF", 1, 0, false);
        declareFunction(me, "cb_link_use_in_proof", "CB-LINK-USE-IN-PROOF", 1, 1, false);
        declareFunction(me, "cb_reinforce_rule", "CB-REINFORCE-RULE", 1, 0, false);
        declareFunction(me, "cb_link_reinforce_rule", "CB-LINK-REINFORCE-RULE", 1, 1, false);
        declareFunction(me, "reinforce_rule", "REINFORCE-RULE", 1, 1, false);
        declareFunction(me, "cb_strength_and_direction_section", "CB-STRENGTH-AND-DIRECTION-SECTION", 2, 1, false);
        declareFunction(me, "cb_extract_strength_and_direction_input", "CB-EXTRACT-STRENGTH-AND-DIRECTION-INPUT", 1, 1, false);
        declareFunction(me, "cb_link_assertion_graph", "CB-LINK-ASSERTION-GRAPH", 1, 1, false);
        declareFunction(me, "cb_assertion_graph", "CB-ASSERTION-GRAPH", 1, 0, false);
        declareFunction(me, "cb_assertion_graph_internal", "CB-ASSERTION-GRAPH-INTERNAL", 1, 0, false);
        declareFunction(me, "cb_assertion_graph_type_string", "CB-ASSERTION-GRAPH-TYPE-STRING", 1, 0, false);
        declareFunction(me, "cb_assertion_print_graph", "CB-ASSERTION-PRINT-GRAPH", 1, 0, false);
        declareFunction(me, "cb_assertion_check_graph", "CB-ASSERTION-CHECK-GRAPH", 1, 0, false);
        declareFunction(me, "cb_assertion_print_graph_of_rule", "CB-ASSERTION-PRINT-GRAPH-OF-RULE", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $cb_assertion_spec_native extends SubLStructNative {
        ...
        public $cb_assertion_spec_native() {
            ...
            this.$mt = Lisp.NIL;
            this.$strength = Lisp.NIL;
            this.$direction = Lisp.NIL;
            this.$unasserts = Lisp.NIL;
            this.$metas = Lisp.NIL;
        }
        ...
        static {
            structDecl = makeStructDeclNative(cb_assertion_editor.$cb_assertion_spec_native.class, CB_ASSERTION_SPEC, CB_ASSERTION_SPEC_P, $list3, $list4, new String[]{ "$sentence", "$mt", "$strength", "$direction", "$unasserts", "$metas" }, $list5, $list6, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
