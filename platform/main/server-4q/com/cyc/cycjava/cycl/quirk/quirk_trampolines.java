...
public final class quirk_trampolines
    extends
      SubLTranslatedFile
{
  ...
  {
    SubLFiles.declareFunction( me, "get_passages_for_entity", "GET-PASSAGES-FOR-ENTITY", 1, 0, false );
    SubLFiles.declareFunction( me, "return_document_as_string", "RETURN-DOCUMENT-AS-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "topics_related_to_entity", "TOPICS-RELATED-TO-ENTITY", 1, 0, false );
    SubLFiles.declareFunction( me, "answer_gui_question", "ANSWER-GUI-QUESTION", 1, 0, false );
    SubLFiles.declareFunction( me, "identify_all_geq_entities", "IDENTIFY-ALL-GEQ-ENTITIES", 1, 0, false );
    SubLFiles.declareFunction( me, "get_followups_for_entity", "GET-FOLLOWUPS-FOR-ENTITY", 1, 0, false );
    return NIL;
  }
  ...
  {
    access_macros.register_external_symbol( $sym0$GET_PASSAGES_FOR_ENTITY );
    access_macros.register_external_symbol( $sym1$RETURN_DOCUMENT_AS_STRING );
    access_macros.register_external_symbol( $sym2$TOPICS_RELATED_TO_ENTITY );
    access_macros.register_external_symbol( $sym3$ANSWER_GUI_QUESTION );
    access_macros.register_external_symbol( $sym4$IDENTIFY_ALL_GEQ_ENTITIES );
    access_macros.register_external_symbol( $sym5$GET_FOLLOWUPS_FOR_ENTITY );
    return NIL;
  }
  ...
  static
  {
    me = new quirk_trampolines();
    $sym0$GET_PASSAGES_FOR_ENTITY = makeSymbol( "GET-PASSAGES-FOR-ENTITY" );
    $sym1$RETURN_DOCUMENT_AS_STRING = makeSymbol( "RETURN-DOCUMENT-AS-STRING" );
    $sym2$TOPICS_RELATED_TO_ENTITY = makeSymbol( "TOPICS-RELATED-TO-ENTITY" );
    $sym3$ANSWER_GUI_QUESTION = makeSymbol( "ANSWER-GUI-QUESTION" );
    $sym4$IDENTIFY_ALL_GEQ_ENTITIES = makeSymbol( "IDENTIFY-ALL-GEQ-ENTITIES" );
    $sym5$GET_FOLLOWUPS_FOR_ENTITY = makeSymbol( "GET-FOLLOWUPS-FOR-ENTITY" );
  }
}
/*
 * 
