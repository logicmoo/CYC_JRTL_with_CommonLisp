...
import com.cyc.cycjava.cycl.quirk.quirk_java_gui;
...
import static com.cyc.cycjava.cycl.quirk.quirk_java_gui.*;
...
public final class quirk_java_gui extends SubLTranslatedFile {
    ...
    public static SubLObject gui_enabled_question_p(final SubLObject v_object) {
        return v_object.getClass() == quirk_java_gui.$gui_enabled_question_native.class ? T : NIL;
    }

    public static SubLObject geq_question_object(final SubLObject v_object) {
        assert NIL != gui_enabled_question_p(v_object) : "quirk_java_gui.gui_enabled_question_p(v_object) " + "CommonSymbols.NIL != quirk_java_gui.gui_enabled_question_p(v_object) " + v_object;
    ...
    public static SubLObject make_gui_enabled_question(SubLObject arglist) {
        ...
        final SubLObject v_new = new quirk_java_gui.$gui_enabled_question_native();
        SubLObject next;
    ...
    public static final class $gui_enabled_question_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(quirk_java_gui.$gui_enabled_question_native.class, GUI_ENABLED_QUESTION, GUI_ENABLED_QUESTION_P, $list3, $list4, new String[]{ "$question_object", "$answers", "$focus_entities", "$research_done" }, $list5, $list6, PPRINT_GEQ);
        }
    }
