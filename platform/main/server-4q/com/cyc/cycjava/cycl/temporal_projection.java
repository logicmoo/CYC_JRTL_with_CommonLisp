...
import static com.cyc.cycjava.cycl.temporal_projection.*;
...
public final class temporal_projection extends SubLTranslatedFile {
    ...
    public static SubLObject declare_temporal_projection_file() {
        declareFunction(me, "likelihood_of_truth_of_sentence", "LIKELIHOOD-OF-TRUTH-OF-SENTENCE", 1, 2, false);
        declareFunction(me, "find_likelihood_of_truth_of_isa_sentence", "FIND-LIKELIHOOD-OF-TRUTH-OF-ISA-SENTENCE", 3, 0, false);
        declareFunction(me, "find_likelihood_of_truth_of_isa_facts_by_using_decay_distributions", "FIND-LIKELIHOOD-OF-TRUTH-OF-ISA-FACTS-BY-USING-DECAY-DISTRIBUTIONS", 3, 0, false);
        declareFunction(me, "find_likelihood_of_isa_facts_by_using_backward_distributions", "FIND-LIKELIHOOD-OF-ISA-FACTS-BY-USING-BACKWARD-DISTRIBUTIONS", 3, 0, false);
        declareFunction(me, "find_likelihood_of_isa_facts_by_using_forward_distributions", "FIND-LIKELIHOOD-OF-ISA-FACTS-BY-USING-FORWARD-DISTRIBUTIONS", 3, 0, false);
        declareFunction(me, "find_likelihood_of_isa_facts_by_using_default_decay_distributions", "FIND-LIKELIHOOD-OF-ISA-FACTS-BY-USING-DEFAULT-DECAY-DISTRIBUTIONS", 3, 0, false);
        declareFunction(me, "find_likelihood_by_using_conditional_probability_of_entering_state_when_age_in_interval", "FIND-LIKELIHOOD-BY-USING-CONDITIONAL-PROBABILITY-OF-ENTERING-STATE-WHEN-AGE-IN-INTERVAL", 3, 0, false);
        declareFunction(me, "find_likelihood_by_using_conditional_probability_of_leaving_state_when_age_in_interval", "FIND-LIKELIHOOD-BY-USING-CONDITIONAL-PROBABILITY-OF-LEAVING-STATE-WHEN-AGE-IN-INTERVAL", 3, 0, false);
        declareFunction(me, "find_relevant_age_related_distribution_at_age", "FIND-RELEVANT-AGE-RELATED-DISTRIBUTION-AT-AGE", 3, 0, false);
        declareFunction(me, "find_relevant_age_related_distribution_at_age_2", "FIND-RELEVANT-AGE-RELATED-DISTRIBUTION-AT-AGE-2", 2, 0, false);
        declareFunction(me, "collect_time_intervals_for_negated_isa_sentence_by_conditional_probability_when_age", "COLLECT-TIME-INTERVALS-FOR-NEGATED-ISA-SENTENCE-BY-CONDITIONAL-PROBABILITY-WHEN-AGE", 3, 0, false);
        declareFunction(me, "collect_time_intervals_for_negated_isa_sentence_by_conditional_probability_when_age_single", "COLLECT-TIME-INTERVALS-FOR-NEGATED-ISA-SENTENCE-BY-CONDITIONAL-PROBABILITY-WHEN-AGE-SINGLE", 3, 0, false);
        declareFunction(me, "collect_time_intervals_for_non_negated_isa_sentence_by_conditional_probability_when_age", "COLLECT-TIME-INTERVALS-FOR-NON-NEGATED-ISA-SENTENCE-BY-CONDITIONAL-PROBABILITY-WHEN-AGE", 3, 0, false);
        declareFunction(me, "collect_time_intervals_for_non_negated_isa_sentence_by_conditional_probability_when_age_single", "COLLECT-TIME-INTERVALS-FOR-NON-NEGATED-ISA-SENTENCE-BY-CONDITIONAL-PROBABILITY-WHEN-AGE-SINGLE", 3, 0, false);
        declareFunction(me, "find_likelihood_for_absorbing_states", "FIND-LIKELIHOOD-FOR-ABSORBING-STATES", 3, 0, false);
        declareFunction(me, "collect_time_intervals_from_absorbing_states", "COLLECT-TIME-INTERVALS-FROM-ABSORBING-STATES", 5, 0, false);
        declareFunction(me, "collect_time_intervals_from_absorbing_states_single", "COLLECT-TIME-INTERVALS-FROM-ABSORBING-STATES-SINGLE", 5, 0, false);
        declareFunction(me, "find_likelihood_of_truth_of_non_isa_sentence", "FIND-LIKELIHOOD-OF-TRUTH-OF-NON-ISA-SENTENCE", 3, 0, false);
        declareFunction(me, "time_intervals_for_sentence", "TIME-INTERVALS-FOR-SENTENCE", 1, 4, false);
        declareFunction(me, "temporally_project", "TEMPORALLY-PROJECT", 2, 2, false);
        declareFunction(me, "find_time_intervals_from_state_persists_assertions", "FIND-TIME-INTERVALS-FROM-STATE-PERSISTS-ASSERTIONS", 1, 0, false);
        declareFunction(me, "find_time_intervals_from_starting_and_ending_points_of_sentence", "FIND-TIME-INTERVALS-FROM-STARTING-AND-ENDING-POINTS-OF-SENTENCE", 3, 0, false);
        declareFunction(me, "find_time_intervals_for_non_negated_sentence", "FIND-TIME-INTERVALS-FOR-NON-NEGATED-SENTENCE", 4, 0, false);
        declareFunction(me, "find_time_intervals_for_non_negated_sentence_single", "FIND-TIME-INTERVALS-FOR-NON-NEGATED-SENTENCE-SINGLE", 4, 0, false);
        declareFunction(me, "find_time_intervals_for_negated_sentence", "FIND-TIME-INTERVALS-FOR-NEGATED-SENTENCE", 4, 0, false);
        declareFunction(me, "find_time_intervals_for_negated_sentence_single", "FIND-TIME-INTERVALS-FOR-NEGATED-SENTENCE-SINGLE", 4, 0, false);
        declareFunction(me, "find_time_intervals_for_negated_isa_sentence", "FIND-TIME-INTERVALS-FOR-NEGATED-ISA-SENTENCE", 4, 0, false);
        declareFunction(me, "find_time_intervals_for_negated_isa_sentence_single", "FIND-TIME-INTERVALS-FOR-NEGATED-ISA-SENTENCE-SINGLE", 4, 0, false);
        declareFunction(me, "find_time_intervals_for_non_negated_non_isa_sentence", "FIND-TIME-INTERVALS-FOR-NON-NEGATED-NON-ISA-SENTENCE", 4, 0, false);
        declareFunction(me, "find_time_intervals_for_non_negated_non_isa_sentence_single", "FIND-TIME-INTERVALS-FOR-NON-NEGATED-NON-ISA-SENTENCE-SINGLE", 4, 0, false);
        declareFunction(me, "collect_intervals_from_decay_distributions_for_predicate", "COLLECT-INTERVALS-FROM-DECAY-DISTRIBUTIONS-FOR-PREDICATE", 3, 0, false);
        declareFunction(me, "collect_intervals_from_decay_distributions_for_predicate_single", "COLLECT-INTERVALS-FROM-DECAY-DISTRIBUTIONS-FOR-PREDICATE-SINGLE", 3, 0, false);
        declareFunction(me, "collect_intervals_from_specific_distributions_for_predicate", "COLLECT-INTERVALS-FROM-SPECIFIC-DISTRIBUTIONS-FOR-PREDICATE", 3, 0, false);
        declareFunction(me, "collect_intervals_from_specific_distributions_for_predicate_single", "COLLECT-INTERVALS-FROM-SPECIFIC-DISTRIBUTIONS-FOR-PREDICATE-SINGLE", 3, 0, false);
        declareFunction(me, "predicate_has_type_level_distributionsP", "PREDICATE-HAS-TYPE-LEVEL-DISTRIBUTIONS?", 1, 0, false);
        declareFunction(me, "find_time_intervals_for_negated_non_isa_sentence", "FIND-TIME-INTERVALS-FOR-NEGATED-NON-ISA-SENTENCE", 4, 0, false);
        declareFunction(me, "find_time_intervals_for_negated_non_isa_sentence_single", "FIND-TIME-INTERVALS-FOR-NEGATED-NON-ISA-SENTENCE-SINGLE", 4, 0, false);
        declareFunction(me, "find_time_intervals_for_non_negated_isa_sentence", "FIND-TIME-INTERVALS-FOR-NON-NEGATED-ISA-SENTENCE", 4, 0, false);
        declareFunction(me, "find_time_intervals_for_non_negated_isa_sentence_single", "FIND-TIME-INTERVALS-FOR-NON-NEGATED-ISA-SENTENCE-SINGLE", 4, 0, false);
        declareFunction(me, "collect_intervals_from_decay_distributions_for_collections", "COLLECT-INTERVALS-FROM-DECAY-DISTRIBUTIONS-FOR-COLLECTIONS", 3, 0, false);
        declareFunction(me, "collect_intervals_from_decay_distributions_for_collections_single", "COLLECT-INTERVALS-FROM-DECAY-DISTRIBUTIONS-FOR-COLLECTIONS-SINGLE", 3, 0, false);
        declareFunction(me, "collect_intervals_from_forward_and_backward_distributions_for_collections", "COLLECT-INTERVALS-FROM-FORWARD-AND-BACKWARD-DISTRIBUTIONS-FOR-COLLECTIONS", 3, 0, false);
        declareFunction(me, "collect_intervals_from_forward_and_backward_distributions_for_collections_single", "COLLECT-INTERVALS-FROM-FORWARD-AND-BACKWARD-DISTRIBUTIONS-FOR-COLLECTIONS-SINGLE", 3, 0, false);
        declareFunction(me, "use_backward_distribution_for_collections", "USE-BACKWARD-DISTRIBUTION-FOR-COLLECTIONS", 4, 0, false);
        declareFunction(me, "use_backward_distribution_for_collections_single", "USE-BACKWARD-DISTRIBUTION-FOR-COLLECTIONS-SINGLE", 4, 0, false);
        declareFunction(me, "use_forward_distribution_for_collections", "USE-FORWARD-DISTRIBUTION-FOR-COLLECTIONS", 4, 0, false);
        declareFunction(me, "use_forward_distribution_for_collections_single", "USE-FORWARD-DISTRIBUTION-FOR-COLLECTIONS-SINGLE", 4, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_probability_statements", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROBABILITY-STATEMENTS", 3, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_probability_statements_single", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROBABILITY-STATEMENTS-SINGLE", 3, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_probability_statements_with_decaying_persistence", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROBABILITY-STATEMENTS-WITH-DECAYING-PERSISTENCE", 4, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_probability_statements_with_decaying_persistence_single", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROBABILITY-STATEMENTS-WITH-DECAYING-PERSISTENCE-SINGLE", 4, 0, false);
        declareFunction(me, "collect_intervals_from_starting_and_ending_dates_for_arg", "COLLECT-INTERVALS-FROM-STARTING-AND-ENDING-DATES-FOR-ARG", 3, 0, false);
        declareFunction(me, "collect_intervals_for_non_isa_facts_from_starting_and_ending_dates", "COLLECT-INTERVALS-FOR-NON-ISA-FACTS-FROM-STARTING-AND-ENDING-DATES", 2, 0, false);
        declareFunction(me, "collect_intervals_for_non_isa_facts_from_starting_and_ending_dates_single", "COLLECT-INTERVALS-FOR-NON-ISA-FACTS-FROM-STARTING-AND-ENDING-DATES-SINGLE", 2, 0, false);
        declareFunction(me, "collect_intervals_from_starting_and_ending_dates", "COLLECT-INTERVALS-FROM-STARTING-AND-ENDING-DATES", 2, 0, false);
        declareFunction(me, "collect_intervals_from_starting_and_ending_dates_single", "COLLECT-INTERVALS-FROM-STARTING-AND-ENDING-DATES-SINGLE", 2, 0, false);
        declareFunction(me, "verify_starting_and_ending_times_of_isa_facts", "VERIFY-STARTING-AND-ENDING-TIMES-OF-ISA-FACTS", 2, 0, false);
        declareFunction(me, "collect_intervals_for_isa_facts_from_starting_and_ending_dates", "COLLECT-INTERVALS-FOR-ISA-FACTS-FROM-STARTING-AND-ENDING-DATES", 2, 0, false);
        declareFunction(me, "collect_intervals_for_isa_facts_from_starting_and_ending_dates_single", "COLLECT-INTERVALS-FOR-ISA-FACTS-FROM-STARTING-AND-ENDING-DATES-SINGLE", 2, 0, false);
        declareFunction(me, "verify_starting_and_ending_times_of_non_isa_facts", "VERIFY-STARTING-AND-ENDING-TIMES-OF-NON-ISA-FACTS", 2, 0, false);
        declareFunction(me, "verify_temporal_constraints_between_collections", "VERIFY-TEMPORAL-CONSTRAINTS-BETWEEN-COLLECTIONS", 2, 1, false);
        declareFunction(me, "collect_intervals_from_temporal_constraints_between_collections_for_negated_isa_sentence", "COLLECT-INTERVALS-FROM-TEMPORAL-CONSTRAINTS-BETWEEN-COLLECTIONS-FOR-NEGATED-ISA-SENTENCE", 2, 0, false);
        declareFunction(me, "collect_intervals_from_temporal_constraints_between_collections_for_negated_isa_sentence_single", "COLLECT-INTERVALS-FROM-TEMPORAL-CONSTRAINTS-BETWEEN-COLLECTIONS-FOR-NEGATED-ISA-SENTENCE-SINGLE", 2, 0, false);
        declareFunction(me, "not_all_points_are_later_thanP", "NOT-ALL-POINTS-ARE-LATER-THAN?", 2, 0, false);
        declareFunction(me, "get_assertion_time_pairs_for_fact", "GET-ASSERTION-TIME-PAIRS-FOR-FACT", 1, 0, false);
        declareFunction(me, "get_time_for_assertion_1", "GET-TIME-FOR-ASSERTION-1", 1, 0, false);
        declareFunction(me, "get_time_for_assertion_2", "GET-TIME-FOR-ASSERTION-2", 1, 0, false);
        declareFunction(me, "possibly_replace_indexicals", "POSSIBLY-REPLACE-INDEXICALS", 1, 0, false);
        declareFunction(me, "verify_temporal_relation_between_arguments", "VERIFY-TEMPORAL-RELATION-BETWEEN-ARGUMENTS", 1, 1, false);
        declareFunction(me, "collect_intervals_from_temporal_relation_between_arguments_assertions_for_negated_non_isa_sentence", "COLLECT-INTERVALS-FROM-TEMPORAL-RELATION-BETWEEN-ARGUMENTS-ASSERTIONS-FOR-NEGATED-NON-ISA-SENTENCE", 2, 0, false);
        declareFunction(me, "collect_intervals_from_temporal_relation_between_arguments_assertions_for_negated_non_isa_sentence_single", "COLLECT-INTERVALS-FROM-TEMPORAL-RELATION-BETWEEN-ARGUMENTS-ASSERTIONS-FOR-NEGATED-NON-ISA-SENTENCE-SINGLE", 2, 0, false);
        declareFunction(me, "verify_genls_and_disjoint_with_constraints", "VERIFY-GENLS-AND-DISJOINT-WITH-CONSTRAINTS", 3, 0, false);
        declareFunction(me, "collect_intervals_from_disjoint_assertions", "COLLECT-INTERVALS-FROM-DISJOINT-ASSERTIONS", 2, 0, false);
        declareFunction(me, "collect_intervals_from_disjoint_assertions_single", "COLLECT-INTERVALS-FROM-DISJOINT-ASSERTIONS-SINGLE", 2, 0, false);
        declareFunction(me, "collect_intervals_from_genls_assertions", "COLLECT-INTERVALS-FROM-GENLS-ASSERTIONS", 2, 0, false);
        declareFunction(me, "verify_starting_and_ending_times", "VERIFY-STARTING-AND-ENDING-TIMES", 2, 0, false);
        declareFunction(me, "check_starting_time_of_concept", "CHECK-STARTING-TIME-OF-CONCEPT", 2, 0, false);
        declareFunction(me, "check_ending_time_of_concept", "CHECK-ENDING-TIME-OF-CONCEPT", 2, 0, false);
        declareFunction(me, "earliest_possible_starting_date_of_concept", "EARLIEST-POSSIBLE-STARTING-DATE-OF-CONCEPT", 1, 0, false);
        declareFunction(me, "ending_date_of_concept", "ENDING-DATE-OF-CONCEPT", 1, 0, false);
        declareFunction(me, "get_assertions_for_fact_1", "GET-ASSERTIONS-FOR-FACT-1", 1, 0, false);
        declareFunction(me, "find_likelihood_of_truth_of_non_isa_sentence_by_using_decay_distributions", "FIND-LIKELIHOOD-OF-TRUTH-OF-NON-ISA-SENTENCE-BY-USING-DECAY-DISTRIBUTIONS", 3, 0, false);
        declareFunction(me, "use_type_level_distributions_for_computing_likelihood", "USE-TYPE-LEVEL-DISTRIBUTIONS-FOR-COMPUTING-LIKELIHOOD", 3, 0, false);
        declareFunction(me, "use_default_conditional_probability_for_sentence_in_interval", "USE-DEFAULT-CONDITIONAL-PROBABILITY-FOR-SENTENCE-IN-INTERVAL", 3, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_probability_for_sentence_in_interval", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROBABILITY-FOR-SENTENCE-IN-INTERVAL", 3, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_probability_for_sentence_in_interval_single", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROBABILITY-FOR-SENTENCE-IN-INTERVAL-SINGLE", 3, 0, false);
        declareFunction(me, "collect_intervals_from_forward_and_backward_distributions_for_predicates_single", "COLLECT-INTERVALS-FROM-FORWARD-AND-BACKWARD-DISTRIBUTIONS-FOR-PREDICATES-SINGLE", 3, 0, false);
        declareFunction(me, "collect_intervals_from_forward_distributions_for_predicates_single", "COLLECT-INTERVALS-FROM-FORWARD-DISTRIBUTIONS-FOR-PREDICATES-SINGLE", 4, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_prob_for_sentence", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROB-FOR-SENTENCE", 4, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_prob_for_sentence_single", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROB-FOR-SENTENCE-SINGLE", 4, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_prob_for_sentence_backward_from_time", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROB-FOR-SENTENCE-BACKWARD-FROM-TIME", 6, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_prob_for_sentence_forward_from_time", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROB-FOR-SENTENCE-FORWARD-FROM-TIME", 6, 0, false);
        declareFunction(me, "collect_intervals_from_default_conditional_prob_of_state_forward_from_time", "COLLECT-INTERVALS-FROM-DEFAULT-CONDITIONAL-PROB-OF-STATE-FORWARD-FROM-TIME", 6, 0, false);
        declareFunction(me, "collect_intervals_from_type_level_distributions_forward", "COLLECT-INTERVALS-FROM-TYPE-LEVEL-DISTRIBUTIONS-FORWARD", 6, 0, false);
        declareFunction(me, "get_intervals_from_decaying_type_level_distributions_forward_in_time", "GET-INTERVALS-FROM-DECAYING-TYPE-LEVEL-DISTRIBUTIONS-FORWARD-IN-TIME", 6, 0, false);
        declareFunction(me, "get_intervals_for_sentence_with_decaying_persistence_backwards_in_time", "GET-INTERVALS-FOR-SENTENCE-WITH-DECAYING-PERSISTENCE-BACKWARDS-IN-TIME", 6, 0, false);
        declareFunction(me, "get_intervals_for_sentence_with_decaying_persistence_forward_in_time", "GET-INTERVALS-FOR-SENTENCE-WITH-DECAYING-PERSISTENCE-FORWARD-IN-TIME", 6, 0, false);
        declareFunction(me, "get_intervals_for_state_with_decaying_persistence_forward_in_time", "GET-INTERVALS-FOR-STATE-WITH-DECAYING-PERSISTENCE-FORWARD-IN-TIME", 6, 0, false);
        declareFunction(me, "get_intervals_for_sentence_with_decaying_persistence", "GET-INTERVALS-FOR-SENTENCE-WITH-DECAYING-PERSISTENCE", 4, 0, false);
        declareFunction(me, "get_intervals_for_sentence_with_decaying_persistence_single", "GET-INTERVALS-FOR-SENTENCE-WITH-DECAYING-PERSISTENCE-SINGLE", 4, 0, false);
        declareFunction(me, "verify_result_entry", "VERIFY-RESULT-ENTRY", 4, 0, false);
        declareFunction(me, "verify_starting_and_ending_dates_for_result_entry", "VERIFY-STARTING-AND-ENDING-DATES-FOR-RESULT-ENTRY", 4, 0, false);
        declareFunction(me, "verify_starting_and_ending_dates_for_isa_result_entry", "VERIFY-STARTING-AND-ENDING-DATES-FOR-ISA-RESULT-ENTRY", 4, 0, false);
        declareFunction(me, "subtract_interval", "SUBTRACT-INTERVAL", 2, 0, false);
        declareFunction(me, "find_known_or_expected_lifespan_of_entity", "FIND-KNOWN-OR-EXPECTED-LIFESPAN-OF-ENTITY", 4, 0, false);
        declareFunction(me, "get_intervals_for_always_true_sentence", "GET-INTERVALS-FOR-ALWAYS-TRUE-SENTENCE", 4, 0, false);
        declareFunction(me, "get_intervals_for_always_true_sentence_single", "GET-INTERVALS-FOR-ALWAYS-TRUE-SENTENCE-SINGLE", 4, 0, false);
        declareFunction(me, "collect_intervals_from_initial_and_terminal_in_args_facts", "COLLECT-INTERVALS-FROM-INITIAL-AND-TERMINAL-IN-ARGS-FACTS", 3, 0, false);
        declareFunction(me, "collect_intervals_from_initial_and_terminal_in_args_facts_single", "COLLECT-INTERVALS-FROM-INITIAL-AND-TERMINAL-IN-ARGS-FACTS-SINGLE", 3, 0, false);
        declareFunction(me, "find_later_date", "FIND-LATER-DATE", 2, 0, false);
        declareFunction(me, "find_earlier_date", "FIND-EARLIER-DATE", 2, 0, false);
        declareFunction(me, "find_known_or_expected_starting_date", "FIND-KNOWN-OR-EXPECTED-STARTING-DATE", 1, 0, false);
        declareFunction(me, "find_known_or_expected_ending_date", "FIND-KNOWN-OR-EXPECTED-ENDING-DATE", 2, 1, false);
        declareFunction(me, "get_assertion_closest_to_given_time", "GET-ASSERTION-CLOSEST-TO-GIVEN-TIME", 2, 0, false);
        declareFunction(me, "get_closest_assertion_before_time", "GET-CLOSEST-ASSERTION-BEFORE-TIME", 2, 0, false);
        declareFunction(me, "get_closest_assertion_after_time", "GET-CLOSEST-ASSERTION-AFTER-TIME", 2, 0, false);
        declareFunction(me, "find_time_elapsed_between_time_points", "FIND-TIME-ELAPSED-BETWEEN-TIME-POINTS", 2, 0, false);
        declareFunction(me, "time_is_before_thanP", "TIME-IS-BEFORE-THAN?", 2, 0, false);
        declareFunction(me, "init_temporal_projection_global_variables", "INIT-TEMPORAL-PROJECTION-GLOBAL-VARIABLES", 0, 0, false);
        declareFunction(me, "update_temporal_projection_global_variables", "UPDATE-TEMPORAL-PROJECTION-GLOBAL-VARIABLES", 1, 0, false);
        declareFunction(me, "lookup_starting_date_for_entity", "LOOKUP-STARTING-DATE-FOR-ENTITY", 1, 0, false);
        declareFunction(me, "lookup_ending_date_for_entity", "LOOKUP-ENDING-DATE-FOR-ENTITY", 1, 0, false);
        declareFunction(me, "test_table_entry", "TEST-TABLE-ENTRY", 1, 0, false);
        return NIL;
    }
