...
import static com.cyc.cycjava.cycl.binary_tree.*;
...
public final class binary_tree extends SubLTranslatedFile {
    ...
    public static SubLObject btree_p(final SubLObject v_object) {
        return v_object.getClass() == binary_tree.$btree_native.class ? T : NIL;
    }

    public static SubLObject bt_tag(final SubLObject v_object) {
        assert NIL != btree_p(v_object) : "binary_tree.btree_p(v_object) " + "CommonSymbols.NIL != binary_tree.btree_p(v_object) " + v_object;
    ...
    public static SubLObject make_btree(SubLObject arglist) {
        ...
        final SubLObject v_new = new binary_tree.$btree_native();
        SubLObject next;
    ...
    public static SubLObject avl_tree_p(final SubLObject v_object) {
        return v_object.getClass() == binary_tree.$avl_tree_native.class ? T : NIL;
    }

    public static SubLObject avlt_root(final SubLObject v_object) {
        assert NIL != avl_tree_p(v_object) : "binary_tree.avl_tree_p(v_object) " + "CommonSymbols.NIL != binary_tree.avl_tree_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_avl_tree(SubLObject arglist) {
        ...
        final SubLObject v_new = new binary_tree.$avl_tree_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject avl_tree_node_p(final SubLObject v_object) {
        return v_object.getClass() == binary_tree.$avl_tree_node_native.class ? T : NIL;
    }

    public static SubLObject avltn_data(final SubLObject v_object) {
        assert NIL != avl_tree_node_p(v_object) : "binary_tree.avl_tree_node_p(v_object) " + "CommonSymbols.NIL != binary_tree.avl_tree_node_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_avl_tree_node(SubLObject arglist) {
        ...
        final SubLObject v_new = new binary_tree.$avl_tree_node_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $btree_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(binary_tree.$btree_native.class, BTREE, BTREE_P, $list2, $list3, new String[]{ "$tag", "$state", "$lower", "$higher" }, $list4, $list5, PRINT_BTREE);
        }
    }
    ...
    public static final class $avl_tree_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(binary_tree.$avl_tree_native.class, AVL_TREE, AVL_TREE_P, $list81, $list82, new String[]{ "$root", "$test", "$size" }, $list83, $list84, PRINT_AVL_TREE);
        }
    }
    ...
    public static final class $avl_tree_node_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(binary_tree.$avl_tree_node_native.class, AVL_TREE_NODE, AVL_TREE_NODE_P, $list119, $list120, new String[]{ "$data", "$balance", "$lower", "$higher" }, $list121, $list122, PRINT_AVL_TREE_NODE);
        }
    }
