...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class enumerations extends SubLTranslatedFile {
    ...
    public static SubLObject enumeration_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$enumeration_native.class ? T : NIL;
    }

    public static SubLObject enumeration_type_name(final SubLObject v_object) {
        assert NIL != enumeration_p(v_object) : "enumerations.enumeration_p error :" + v_object;
    ...
    public static final class $enumeration_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($enumeration_native.class, ENUMERATION, ENUMERATION_P, $list8, $list9, new String[]{ "$type_name", "$cardinality", "$values_vector" }, $list10, $list11, PRINT_ENUMERATION);
        }
    }
