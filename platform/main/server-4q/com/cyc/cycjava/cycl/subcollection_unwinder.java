...
import static com.cyc.cycjava.cycl.subcollection_unwinder.*;
...
public final class subcollection_unwinder extends SubLTranslatedFile {
    ...
    private static final SubLList $list20 = list(cons(makeKeyword("TERM"), makeKeyword("OBJ")));
    ...
    private static final SubLList $list28 = list(makeKeyword("AND"), makeKeyword("OR"), makeKeyword("NOT"), makeKeyword("BIND"));
    ...
    private static final SubLList $list38 = list(list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("relationInstanceExists")), list(makeKeyword("BIND"), makeSymbol("PRED")), list(makeKeyword("BIND"), makeSymbol("OBJ")), list(makeKeyword("BIND"), makeSymbol("TYPE"))), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), list(makeKeyword("VALUE"), makeKeyword("EXISTS")), list(makeKeyword("VALUE"), makeSymbol("TYPE"))), list(list(makeKeyword("VALUE"), makeSymbol("PRED")), list(makeKeyword("VALUE"), makeSymbol("OBJ")), list(makeKeyword("VALUE"), makeKeyword("EXISTS"))))), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("relationExistsInstance")), list(makeKeyword("BIND"), makeSymbol("PRED")), list(makeKeyword("BIND"), makeSymbol("TYPE")), list(makeKeyword("BIND"), makeSymbol("OBJ"))), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), list(makeKeyword("VALUE"), makeKeyword("EXISTS")), list(makeKeyword("VALUE"), makeSymbol("TYPE"))), list(list(makeKeyword("VALUE"), makeSymbol("PRED")), list(makeKeyword("VALUE"), makeKeyword("EXISTS")), list(makeKeyword("VALUE"), makeSymbol("OBJ"))))), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("thereExists")), list(makeKeyword("BIND"), makeSymbol("VAR")), list(makeKeyword("BIND"), makeSymbol("BODY"))), list(makeKeyword("CALL"), makeSymbol("SUBCOL-SUBSTITUTE-PATTERN-EXISTENTIAL"), list(makeKeyword("VALUE"), makeSymbol("VAR")), list(makeKeyword("VALUE"), makeKeyword("EXISTS")), list(makeKeyword("VALUE"), makeSymbol("BODY")))));
    ...
    public static SubLObject declare_subcollection_unwinder_file() {
        declareMacro(me, "with_existential_variable_tracking", "WITH-EXISTENTIAL-VARIABLE-TRACKING");
        declareFunction(me, "subcol_unwind_literal", "SUBCOL-UNWIND-LITERAL", 1, 0, false);
        declareFunction(me, "subcol_unwind_literals", "SUBCOL-UNWIND-LITERALS", 1, 0, false);
        declareFunction(me, "subcol_unwind_literals_int", "SUBCOL-UNWIND-LITERALS-INT", 1, 0, false);
        declareFunction(me, "subcol_unwind_literal_int", "SUBCOL-UNWIND-LITERAL-INT", 1, 0, false);
        declareFunction(me, "isa_naut_literalP", "ISA-NAUT-LITERAL?", 1, 0, false);
        declareFunction(me, "equals_naut_literalP", "EQUALS-NAUT-LITERAL?", 1, 0, false);
        declareFunction(me, "equal_symbols_naut_literalP", "EQUAL-SYMBOLS-NAUT-LITERAL?", 1, 0, false);
        declareFunction(me, "binary_pred_arg2_naut_literalP", "BINARY-PRED-ARG2-NAUT-LITERAL?", 2, 0, false);
        declareFunction(me, "subcollection_kappa_expansion", "SUBCOLLECTION-KAPPA-EXPANSION", 1, 0, false);
        declareFunction(me, "subcollection_the_set_of_expansion", "SUBCOLLECTION-THE-SET-OF-EXPANSION", 1, 0, false);
        declareFunction(me, "scg_subcol_expand_to_existential_sentence", "SCG-SUBCOL-EXPAND-TO-EXISTENTIAL-SENTENCE", 1, 0, false);
        declareFunction(me, "scg_subcol_expand_signature", "SCG-SUBCOL-EXPAND-SIGNATURE", 1, 0, false);
        declareFunction(me, "scg_subcl_expand_signature_int", "SCG-SUBCL-EXPAND-SIGNATURE-INT", 1, 0, false);
        declareFunction(me, "dmr_subcol_expand_signature", "DMR-SUBCOL-EXPAND-SIGNATURE", 1, 0, false);
        declareFunction(me, "scg_sentence_fully_unwoundP", "SCG-SENTENCE-FULLY-UNWOUND?", 1, 0, false);
        declareFunction(me, "is_subcollection_pattern_predicate_assertion", "IS-SUBCOLLECTION-PATTERN-PREDICATE-ASSERTION", 1, 0, false);
        declareFunction(me, "create_subcollection_unwind_template", "CREATE-SUBCOLLECTION-UNWIND-TEMPLATE", 1, 0, false);
        declareFunction(me, "get_subcollection_patterns_from_kb", "GET-SUBCOLLECTION-PATTERNS-FROM-KB", 0, 0, false);
        declareFunction(me, "subcol_unwind_template_lookup", "SUBCOL-UNWIND-TEMPLATE-LOOKUP", 1, 0, false);
        declareFunction(me, "possibly_initialize_isa_subcol_unwind_template_map", "POSSIBLY-INITIALIZE-ISA-SUBCOL-UNWIND-TEMPLATE-MAP", 0, 0, false);
        declareFunction(me, "rebuild_isa_subcol_unwind_template_map", "REBUILD-ISA-SUBCOL-UNWIND-TEMPLATE-MAP", 0, 0, false);
        declareFunction(me, "compute_isa_subcol_unwind_template", "COMPUTE-ISA-SUBCOL-UNWIND-TEMPLATE", 2, 0, false);
        declareFunction(me, "subcol_unwind_collection_intersection_set", "SUBCOL-UNWIND-COLLECTION-INTERSECTION-SET", 1, 0, false);
        declareFunction(me, "subcol_unwind_collection_intersection_set_recursive", "SUBCOL-UNWIND-COLLECTION-INTERSECTION-SET-RECURSIVE", 1, 0, false);
        declareFunction(me, "subcol_unwind_the_set", "SUBCOL-UNWIND-THE-SET", 3, 0, false);
        declareFunction(me, "subcol_substitute_pattern_existential", "SUBCOL-SUBSTITUTE-PATTERN-EXISTENTIAL", 3, 0, false);
        declareFunction(me, "existential_introduction_literalP", "EXISTENTIAL-INTRODUCTION-LITERAL?", 1, 0, false);
        declareFunction(me, "subcol_existential_unwind_template_lookup", "SUBCOL-EXISTENTIAL-UNWIND-TEMPLATE-LOOKUP", 1, 0, false);
        declareFunction(me, "subcol_unwind_allocate_existential_variable", "SUBCOL-UNWIND-ALLOCATE-EXISTENTIAL-VARIABLE", 0, 0, false);
        return NIL;
    }
    ...
    private static SubLObject _constant_24_initializer() {
        return list(new SubLObject[]{ list(list(reader_make_constant_shell(makeString("CollectionIntersectionFn")), list(makeKeyword("AND"), makeKeyword("SET"), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("ANYTHING")))), list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), list(makeKeyword("CALL"), makeSymbol("SUBCOL-UNWIND-COLLECTION-INTERSECTION-SET"), makeKeyword("SET"))))), list(list(reader_make_constant_shell(makeString("SitTypeSpecWithTypeRestrictionOnRolePlayerFn")), makeKeyword("COL"), makeKeyword("ROLE"), makeKeyword("TYPE")), list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), list(reader_make_constant_shell(makeString("SubcollectionOfWithRelationToTypeFn")), makeKeyword("COL"), makeKeyword("ROLE"), makeKeyword("TYPE"))))), list(list(reader_make_constant_shell(makeString("GenreFn")), makeKeyword("COL1"), makeKeyword("COL2")), list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), list(reader_make_constant_shell(makeString("CollectionIntersection2Fn")), makeKeyword("COL1"), makeKeyword("COL2"))))), list(list(reader_make_constant_shell(makeString("CollectionUnionFn")), makeKeyword("SET")), list(list(reader_make_constant_shell(makeString("thereExists")), makeKeyword("COL"), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("COL")), list(reader_make_constant_shell(makeString("elementOf")), makeKeyword("COL"), makeKeyword("SET")))))), list(list(reader_make_constant_shell(makeString("GroupFn")), makeKeyword("COL")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Group"))), list(reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("groupMembers")), makeKeyword("OBJ"), makeKeyword("COL")))), list(list(reader_make_constant_shell(makeString("TransportViaFn")), makeKeyword("COL")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("TransportationEvent"))), list(reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("transporter")), makeKeyword("OBJ"), makeKeyword("COL")))), list(list(reader_make_constant_shell(makeString("StockInFn")), makeKeyword("CORPORATION")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Stock"))), list(reader_make_constant_shell(makeString("stockIssuedBy")), makeKeyword("OBJ"), makeKeyword("CORPORATION")))), list(list(reader_make_constant_shell(makeString("WholeTypeForPartTypeFn")), makeKeyword("PART-TYPE"), makeKeyword("WHOLE-TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("WHOLE-TYPE")), list(reader_make_constant_shell(makeString("relationExistsInstance")), reader_make_constant_shell(makeString("properPhysicalParts")), makeKeyword("PART-TYPE"), makeKeyword("OBJ")))), list(list(reader_make_constant_shell(makeString("VideoClipOfSubjectFn")), makeKeyword("SUBJECT")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("VideoRecordedObject"))), list(reader_make_constant_shell(makeString("containsInformationAbout")), makeKeyword("OBJ"), makeKeyword("SUBJECT")))), list(list(reader_make_constant_shell(makeString("VideoClipTypeOfSubjectTypeFn")), makeKeyword("SUBJECT-TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("VideoRecordedObject"))), list(reader_make_constant_shell(makeString("containsInformationAbout")), makeKeyword("OBJ"), makeKeyword("SUBJECT-TYPE")))), list(list(reader_make_constant_shell(makeString("IssuingCredentialTypeFn")), makeKeyword("COL")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("GrantingPermission"))), list(reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("permissionsGranted")), makeKeyword("OBJ"), makeKeyword("COL")))), list(list(reader_make_constant_shell(makeString("RecreationalFn")), makeKeyword("ACTION-TYPE")), list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), list(reader_make_constant_shell(makeString("CollectionIntersection2Fn")), makeKeyword("ACTION-TYPE"), reader_make_constant_shell(makeString("RecreationalActivity")))))), list(list(reader_make_constant_shell(makeString("PlayerOfInstrumentFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("MusicalInstrumentPlayer"))), list(reader_make_constant_shell(makeString("skillCapableOf")), makeKeyword("OBJ"), list(reader_make_constant_shell(makeString("InstrumentPlayingFn")), makeKeyword("TYPE")), reader_make_constant_shell(makeString("performedBy"))))), list(list(reader_make_constant_shell(makeString("ModelFn")), makeKeyword("OBJ-TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Model-Artifact"))), list(reader_make_constant_shell(makeString("visuallyDepicts-Type")), makeKeyword("OBJ"), makeKeyword("OBJ-TYPE")))), list(list(reader_make_constant_shell(makeString("ProductionOfFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Production-Generic"))), list(reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("outputsCreated")), makeKeyword("OBJ"), makeKeyword("TYPE")))), list(list(reader_make_constant_shell(makeString("RoleWithResponsibilityForFn")), makeKeyword("TYPE"), makeKeyword("ACTIVITY")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("responsibleFor")), makeKeyword("OBJ"), makeKeyword("ACTIVITY")))), list(list(reader_make_constant_shell(makeString("CitizenFn")), makeKeyword("GEOPOLITICAL-ENTITY")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Person"))), list(reader_make_constant_shell(makeString("citizens")), makeKeyword("GEOPOLITICAL-ENTITY"), makeKeyword("OBJ")))), list(list(reader_make_constant_shell(makeString("ProfessionalFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("PersonWithOccupation"))), list(reader_make_constant_shell(makeString("occupation")), makeKeyword("OBJ"), makeKeyword("TYPE")))), list(list(reader_make_constant_shell(makeString("ResidentFn")), makeKeyword("REGION")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Individual"))), list(reader_make_constant_shell(makeString("residesInRegion")), makeKeyword("OBJ"), makeKeyword("REGION")))), list(list(reader_make_constant_shell(makeString("FrequentPerformerFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Person"))), list(reader_make_constant_shell(makeString("playsRoleInTypeWithFrequency")), makeKeyword("OBJ"), makeKeyword("TYPE"), reader_make_constant_shell(makeString("performedBy")), reader_make_constant_shell(makeString("Often"))))), list(list(reader_make_constant_shell(makeString("UsingAFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("UsingADevice"))), list(reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("deviceUsed")), makeKeyword("OBJ"), makeKeyword("TYPE")))), list(list(reader_make_constant_shell(makeString("BelieverFn")), makeKeyword("BELIEF-SYSTEM")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("IntelligentAgent"))), list(reader_make_constant_shell(makeString("hasBeliefSystems")), makeKeyword("OBJ"), makeKeyword("BELIEF-SYSTEM")))), list(list(reader_make_constant_shell(makeString("MaleFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("MaleAnimal"))), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("TYPE")))), list(list(reader_make_constant_shell(makeString("FemaleFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("FemaleAnimal"))), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("TYPE")))), list(list(reader_make_constant_shell(makeString("UsingAForFn")), makeKeyword("OBJ-TYPE"), makeKeyword("ACT-TYPE"), makeKeyword("ROLE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("ACT-TYPE")), list(reader_make_constant_shell(makeString("relationInstanceExists")), makeKeyword("ROLE"), makeKeyword("OBJ"), makeKeyword("OBJ-TYPE")))), list(list(reader_make_constant_shell(makeString("GlobalOrganizationFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("InternationalOrganization"))))), list(list(reader_make_constant_shell(makeString("ExperiencingEmotionFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("ExperiencingEmotion"))), list(reader_make_constant_shell(makeString("feelingTypeExperienced")), makeKeyword("OBJ"), makeKeyword("TYPE")))), list(list(reader_make_constant_shell(makeString("GroupOfMinSizeFn")), makeKeyword("N"), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Group"))), list(reader_make_constant_shell(makeString("groupCardinalityMin")), makeKeyword("OBJ"), makeKeyword("N")), list(reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("groupMembers")), makeKeyword("OBJ"), makeKeyword("TYPE")))), list(list(reader_make_constant_shell(makeString("CharacteristicSoundTypeFromActionTypeFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("AudibleSound"))), list(reader_make_constant_shell(makeString("relationExistsInstance")), reader_make_constant_shell(makeString("soundEmitted")), makeKeyword("TYPE"), makeKeyword("OBJ")))), list(list(reader_make_constant_shell(makeString("MilitaryFn")), makeKeyword("COUNTRY")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("GovernmentMilitaryOrganization"))), list(reader_make_constant_shell(makeString("officialArmedForces")), makeKeyword("OBJ"), makeKeyword("COUNTRY")))), list(list(reader_make_constant_shell(makeString("SubcollectionOfWithCapabilityFn")), makeKeyword("COL"), makeKeyword("SIT-TYPE"), makeKeyword("ROLE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("COL")), list(reader_make_constant_shell(makeString("behaviorCapable")), makeKeyword("OBJ"), makeKeyword("SIT-TYPE"), makeKeyword("ROLE")))), list(list(reader_make_constant_shell(makeString("GroupActivityFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), list(reader_make_constant_shell(makeString("CollectionIntersection2Fn")), makeKeyword("TYPE"), reader_make_constant_shell(makeString("SingleDoerAction")))), list(reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("doneBy")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Agent-PartiallyTangible"))))), list(list(reader_make_constant_shell(makeString("AcquiringFn")), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("AcquiringAnObject"))), list(reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("objectOfPossessionTransfer")), makeKeyword("OBJ"), makeKeyword("TYPE")))), list(list(reader_make_constant_shell(makeString("SubCollectionNamedFn")), makeKeyword("STRING"), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("TYPE")), list(reader_make_constant_shell(makeString("nameString")), makeKeyword("OBJ"), makeKeyword("STRING")))), list(list(reader_make_constant_shell(makeString("ProperSubcollectionNamedFn-Ternary")), makeKeyword("STRING"), makeKeyword("COL"), makeKeyword("GUID")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("COL")), list(reader_make_constant_shell(makeString("nameString")), makeKeyword("OBJ"), makeKeyword("STRING")))), list(list(reader_make_constant_shell(makeString("TechnologyForUseContextsOfTypeFn")), makeKeyword("SIT-TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Artifact-Generic"))), list(reader_make_constant_shell(makeString("intendedPrimaryFunction")), makeKeyword("OBJ"), makeKeyword("SIT-TYPE"), reader_make_constant_shell(makeString("deviceUsed"))))), list(list(reader_make_constant_shell(makeString("JuvenileFn")), makeKeyword("TYPE")), list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), list(reader_make_constant_shell(makeString("CollectionIntersection2Fn")), reader_make_constant_shell(makeString("JuvenileAnimal")), makeKeyword("TYPE"))))), list(list(reader_make_constant_shell(makeString("ProperSubSituationTypeFn")), makeKeyword("SIT-TYPE"), makeKeyword("SUB-SIT-TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Situation"))), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("SUB-SIT-TYPE")), list(reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("properSubSituations")), makeKeyword("OBJ"), makeKeyword("SIT-TYPE")))), list(list(reader_make_constant_shell(makeString("SensorTypeByTargetSituationTypeFn")), makeKeyword("SIT-TYPE")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), reader_make_constant_shell(makeString("Sensor-Device"))), list(reader_make_constant_shell(makeString("intendedPrimaryFunction")), makeKeyword("OBJ"), makeKeyword("SIT-TYPE"), reader_make_constant_shell(makeString("detector"))))), list(list(reader_make_constant_shell(makeString("TheFn")), makeKeyword("COL")), list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ"), makeKeyword("COL")))), list(list(reader_make_constant_shell(makeString("TheSet")), makeKeyword("BIND"), makeSymbol("ELEMENTS")), list(list(makeKeyword("CALL"), makeSymbol("SUBCOL-UNWIND-THE-SET"), list(makeKeyword("VALUE"), makeSymbol("ELEMENTS")), reader_make_constant_shell(makeString("isa")), makeKeyword("OBJ")))) });
    }
