...
import static com.cyc.cycjava.cycl.deductions_low.*;
...
public final class deductions_low extends SubLTranslatedFile {
    ...
    public static SubLObject deduction_content_p(final SubLObject v_object) {
        return v_object.getClass() == deductions_low.$deduction_content_native.class ? T : NIL;
    }

    public static SubLObject d_content_tv(final SubLObject v_object) {
        assert NIL != deduction_content_p(v_object) : "deductions_low.deduction_content_p(v_object) " + "CommonSymbols.NIL != deductions_low.deduction_content_p(v_object) " + v_object;
    ...
    public static SubLObject make_deduction_content(SubLObject arglist) {
        ...
        final SubLObject v_new = new deductions_low.$deduction_content_native();
        SubLObject next;
    ...
    public static final class $deduction_content_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(deductions_low.$deduction_content_native.class, DEDUCTION_CONTENT, DEDUCTION_CONTENT_P, $list3, $list4, new String[]{ "$tv", "$supported_object", "$supports", "$bindings", "$pragmatic_support_mts" }, $list5, $list6, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
