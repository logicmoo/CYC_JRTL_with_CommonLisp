...
import static com.cyc.cycjava.cycl.cycl_query_specification.*;
...
public final class cycl_query_specification extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol CYCL_QUERY_SPECIFICATION = makeSymbol("CYCL-QUERY-SPECIFICATION");

    public static final SubLSymbol CYCL_QUERY_SPECIFICATION_P = makeSymbol("CYCL-QUERY-SPECIFICATION-P");
    ...
    public static final SubLSymbol CYCL_QUERY_SPECIFICATION_PRINT = makeSymbol("CYCL-QUERY-SPECIFICATION-PRINT");

    public static final SubLSymbol CYCL_QUERY_SPECIFICATION_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("CYCL-QUERY-SPECIFICATION-PRINT-FUNCTION-TRAMPOLINE");
    ...
    private static final SubLObject $$InferenceFormulaParameter = reader_make_constant_shell(makeString("InferenceFormulaParameter"));
    ...
    private static final SubLObject $$InferenceMaxAnswersParameter = reader_make_constant_shell(makeString("InferenceMaxAnswersParameter"));

    private static final SubLObject $const81$InferenceMaxTransformationStepsPa = reader_make_constant_shell(makeString("InferenceMaxTransformationStepsParameter"));

    private static final SubLObject $$InferenceMaxTimeParameter = reader_make_constant_shell(makeString("InferenceMaxTimeParameter"));

    private static final SubLObject $$InferenceMaxProofDepthParameter = reader_make_constant_shell(makeString("InferenceMaxProofDepthParameter"));

    private static final SubLObject $const84$InferenceAllowUnboundPredicateTra = reader_make_constant_shell(makeString("InferenceAllowUnboundPredicateTransformationParameter"));

    private static final SubLObject $const85$InferenceProductivityLimitParamet = reader_make_constant_shell(makeString("InferenceProductivityLimitParameter"));

    private static final SubLObject $const86$InferenceEnableConsiderDisjunctiv = reader_make_constant_shell(makeString("InferenceEnableConsiderDisjunctiveTemporalRelationsParameter"));

    private static final SubLObject $const87$InferenceEnableSemanticPruningPar = reader_make_constant_shell(makeString("InferenceEnableSemanticPruningParameter"));

    private static final SubLObject $const88$InferenceCacheInferenceResultsPar = reader_make_constant_shell(makeString("InferenceCacheInferenceResultsParameter"));

    private static final SubLObject $const89$InferenceAllowHLPredicateTransfor = reader_make_constant_shell(makeString("InferenceAllowHLPredicateTransformationParameter"));

    private static final SubLObject $const90$InferenceNegationByFailureParamet = reader_make_constant_shell(makeString("InferenceNegationByFailureParameter"));
    ...
    private static final SubLObject $const95$softwareParameterValueInSpecifica = reader_make_constant_shell(makeString("softwareParameterValueInSpecification"));
    ...
    public static SubLObject cycl_query_specification_p(final SubLObject v_object) {
        return v_object.getClass() == cycl_query_specification.$cycl_query_specification_native.class ? T : NIL;
    }

    public static SubLObject cycl_query_spec_cycl_id(final SubLObject v_object) {
        assert NIL != cycl_query_specification_p(v_object) : "cycl_query_specification.cycl_query_specification_p(v_object) " + "CommonSymbols.NIL != cycl_query_specification.cycl_query_specification_p(v_object) " + v_object;
    ...
    public static SubLObject make_cycl_query_specification(SubLObject arglist) {
        ...
        final SubLObject v_new = new cycl_query_specification.$cycl_query_specification_native();
        SubLObject next;
    ...
    public static SubLObject cycl_query_specification_cycl_id(final SubLObject cycl_query) {
        assert NIL != cycl_query_specification_p(cycl_query) : "cycl_query_specification.cycl_query_specification_p(cycl_query) " + "CommonSymbols.NIL != cycl_query_specification.cycl_query_specification_p(cycl_query) " + cycl_query;
    ...
    public static SubLObject cycl_query_specification_ask_int(final SubLObject query_spec) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != cycl_query_specification_p(query_spec) : "cycl_query_specification.cycl_query_specification_p(query_spec) " + "CommonSymbols.NIL != cycl_query_specification.cycl_query_specification_p(query_spec) " + query_spec;
    ...
    public static SubLObject cycl_query_specification_set_mt(final SubLObject query, final SubLObject new_mt) {
        assert NIL != cycl_query_specification_p(query) : "cycl_query_specification.cycl_query_specification_p(query) " + "CommonSymbols.NIL != cycl_query_specification.cycl_query_specification_p(query) " + query;
        assert NIL != fort_types_interface.microtheory_p(new_mt) : "fort_types_interface.microtheory_p(new_mt) " + "CommonSymbols.NIL != fort_types_interface.microtheory_p(new_mt) " + new_mt;
    ...
    public static SubLObject cycl_query_specification_new_query_from_old(final SubLObject old_query, final SubLObject new_formula, final SubLObject new_mt) {
        assert NIL != cycl_query_specification_p(old_query) : "cycl_query_specification.cycl_query_specification_p(old_query) " + "CommonSymbols.NIL != cycl_query_specification.cycl_query_specification_p(old_query) " + old_query;
    ...
    public static SubLObject declare_cycl_query_specification_file() {
        declareFunction(me, "cycl_query_specification_print_function_trampoline", "CYCL-QUERY-SPECIFICATION-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "cycl_query_specification_p", "CYCL-QUERY-SPECIFICATION-P", 1, 0, false);
        new cycl_query_specification.$cycl_query_specification_p$UnaryFunction();
        declareFunction(me, "cycl_query_spec_cycl_id", "CYCL-QUERY-SPEC-CYCL-ID", 1, 0, false);
        declareFunction(me, "cycl_query_spec_formula", "CYCL-QUERY-SPEC-FORMULA", 1, 0, false);
        declareFunction(me, "cycl_query_spec_mt", "CYCL-QUERY-SPEC-MT", 1, 0, false);
        declareFunction(me, "cycl_query_spec_comment", "CYCL-QUERY-SPEC-COMMENT", 1, 0, false);
        declareFunction(me, "cycl_query_spec_max_number_of_results", "CYCL-QUERY-SPEC-MAX-NUMBER-OF-RESULTS", 1, 0, false);
        declareFunction(me, "cycl_query_spec_back_chaining", "CYCL-QUERY-SPEC-BACK-CHAINING", 1, 0, false);
        declareFunction(me, "cycl_query_spec_time_cutoff_secs", "CYCL-QUERY-SPEC-TIME-CUTOFF-SECS", 1, 0, false);
        declareFunction(me, "cycl_query_spec_max_depth", "CYCL-QUERY-SPEC-MAX-DEPTH", 1, 0, false);
        declareFunction(me, "cycl_query_spec_removal_cost_cutoff", "CYCL-QUERY-SPEC-REMOVAL-COST-CUTOFF", 1, 0, false);
        declareFunction(me, "cycl_query_spec_enable_negation_by_failure", "CYCL-QUERY-SPEC-ENABLE-NEGATION-BY-FAILURE", 1, 0, false);
        declareFunction(me, "cycl_query_spec_enable_hl_predicate_backchaining", "CYCL-QUERY-SPEC-ENABLE-HL-PREDICATE-BACKCHAINING", 1, 0, false);
        declareFunction(me, "cycl_query_spec_enable_cache_backwards_query_results", "CYCL-QUERY-SPEC-ENABLE-CACHE-BACKWARDS-QUERY-RESULTS", 1, 0, false);
        declareFunction(me, "cycl_query_spec_enable_unbound_predicate_backchaining", "CYCL-QUERY-SPEC-ENABLE-UNBOUND-PREDICATE-BACKCHAINING", 1, 0, false);
        declareFunction(me, "cycl_query_spec_enable_semantic_pruning", "CYCL-QUERY-SPEC-ENABLE-SEMANTIC-PRUNING", 1, 0, false);
        declareFunction(me, "cycl_query_spec_enable_consideration_of_disjunctive_temporal_relations", "CYCL-QUERY-SPEC-ENABLE-CONSIDERATION-OF-DISJUNCTIVE-TEMPORAL-RELATIONS", 1, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_cycl_id", "_CSETF-CYCL-QUERY-SPEC-CYCL-ID", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_formula", "_CSETF-CYCL-QUERY-SPEC-FORMULA", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_mt", "_CSETF-CYCL-QUERY-SPEC-MT", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_comment", "_CSETF-CYCL-QUERY-SPEC-COMMENT", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_max_number_of_results", "_CSETF-CYCL-QUERY-SPEC-MAX-NUMBER-OF-RESULTS", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_back_chaining", "_CSETF-CYCL-QUERY-SPEC-BACK-CHAINING", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_time_cutoff_secs", "_CSETF-CYCL-QUERY-SPEC-TIME-CUTOFF-SECS", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_max_depth", "_CSETF-CYCL-QUERY-SPEC-MAX-DEPTH", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_removal_cost_cutoff", "_CSETF-CYCL-QUERY-SPEC-REMOVAL-COST-CUTOFF", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_enable_negation_by_failure", "_CSETF-CYCL-QUERY-SPEC-ENABLE-NEGATION-BY-FAILURE", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_enable_hl_predicate_backchaining", "_CSETF-CYCL-QUERY-SPEC-ENABLE-HL-PREDICATE-BACKCHAINING", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_enable_cache_backwards_query_results", "_CSETF-CYCL-QUERY-SPEC-ENABLE-CACHE-BACKWARDS-QUERY-RESULTS", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_enable_unbound_predicate_backchaining", "_CSETF-CYCL-QUERY-SPEC-ENABLE-UNBOUND-PREDICATE-BACKCHAINING", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_enable_semantic_pruning", "_CSETF-CYCL-QUERY-SPEC-ENABLE-SEMANTIC-PRUNING", 2, 0, false);
        declareFunction(me, "_csetf_cycl_query_spec_enable_consideration_of_disjunctive_temporal_relations", "_CSETF-CYCL-QUERY-SPEC-ENABLE-CONSIDERATION-OF-DISJUNCTIVE-TEMPORAL-RELATIONS", 2, 0, false);
        declareFunction(me, "make_cycl_query_specification", "MAKE-CYCL-QUERY-SPECIFICATION", 0, 1, false);
        declareFunction(me, "visit_defstruct_cycl_query_specification", "VISIT-DEFSTRUCT-CYCL-QUERY-SPECIFICATION", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_cycl_query_specification_method", "VISIT-DEFSTRUCT-OBJECT-CYCL-QUERY-SPECIFICATION-METHOD", 2, 0, false);
        declareFunction(me, "cycl_query_specification_cycl_id", "CYCL-QUERY-SPECIFICATION-CYCL-ID", 1, 0, false);
        declareFunction(me, "cycl_query_specification_formula", "CYCL-QUERY-SPECIFICATION-FORMULA", 1, 0, false);
        declareFunction(me, "cycl_query_specification_mt", "CYCL-QUERY-SPECIFICATION-MT", 1, 0, false);
        declareFunction(me, "cycl_query_specification_comment", "CYCL-QUERY-SPECIFICATION-COMMENT", 1, 0, false);
        declareFunction(me, "cycl_query_specification_max_number_of_results", "CYCL-QUERY-SPECIFICATION-MAX-NUMBER-OF-RESULTS", 1, 0, false);
        declareFunction(me, "cycl_query_specification_back_chaining", "CYCL-QUERY-SPECIFICATION-BACK-CHAINING", 1, 0, false);
        declareFunction(me, "cycl_query_specification_time_cutoff_secs", "CYCL-QUERY-SPECIFICATION-TIME-CUTOFF-SECS", 1, 0, false);
        declareFunction(me, "cycl_query_specification_max_depth", "CYCL-QUERY-SPECIFICATION-MAX-DEPTH", 1, 0, false);
        declareFunction(me, "cycl_query_specification_conditional_sentenceP", "CYCL-QUERY-SPECIFICATION-CONDITIONAL-SENTENCE?", 1, 0, false);
        declareFunction(me, "cycl_query_specification_removal_cost_cutoff", "CYCL-QUERY-SPECIFICATION-REMOVAL-COST-CUTOFF", 1, 0, false);
        declareFunction(me, "cycl_query_specification_enable_negation_by_failure", "CYCL-QUERY-SPECIFICATION-ENABLE-NEGATION-BY-FAILURE", 1, 0, false);
        declareFunction(me, "cycl_query_specification_enable_hl_predicate_backchaining", "CYCL-QUERY-SPECIFICATION-ENABLE-HL-PREDICATE-BACKCHAINING", 1, 0, false);
        declareFunction(me, "cycl_query_specification_enable_cache_backwards_query_results", "CYCL-QUERY-SPECIFICATION-ENABLE-CACHE-BACKWARDS-QUERY-RESULTS", 1, 0, false);
        declareFunction(me, "cycl_query_specification_enable_unbound_predicate_backchaining", "CYCL-QUERY-SPECIFICATION-ENABLE-UNBOUND-PREDICATE-BACKCHAINING", 1, 0, false);
        declareFunction(me, "cycl_query_specification_enable_semantic_pruning", "CYCL-QUERY-SPECIFICATION-ENABLE-SEMANTIC-PRUNING", 1, 0, false);
        declareFunction(me, "cycl_query_specification_enable_consideration_of_disjunctive_temporal_relations", "CYCL-QUERY-SPECIFICATION-ENABLE-CONSIDERATION-OF-DISJUNCTIVE-TEMPORAL-RELATIONS", 1, 0, false);
        declareFunction(me, "cycl_query_specification_copy", "CYCL-QUERY-SPECIFICATION-COPY", 1, 0, false);
        declareFunction(me, "cycl_query_specification_print", "CYCL-QUERY-SPECIFICATION-PRINT", 3, 0, false);
        declareFunction(me, "cycl_query_specification_new", "CYCL-QUERY-SPECIFICATION-NEW", 0, 0, false);
        declareFunction(me, "cycl_query_specification_assign_param", "CYCL-QUERY-SPECIFICATION-ASSIGN-PARAM", 3, 0, false);
        declareFunction(me, "cycl_query_specification_get", "CYCL-QUERY-SPECIFICATION-GET", 1, 1, false);
        declareFunction(me, "cycl_query_specification_ask_int", "CYCL-QUERY-SPECIFICATION-ASK-INT", 1, 0, false);
        declareFunction(me, "cycl_query_specification_ask", "CYCL-QUERY-SPECIFICATION-ASK", 1, 0, false);
        declareFunction(me, "cycl_query_specification_set_mt", "CYCL-QUERY-SPECIFICATION-SET-MT", 2, 0, false);
        declareFunction(me, "cycl_query_specification_new_query_from_old", "CYCL-QUERY-SPECIFICATION-NEW-QUERY-FROM-OLD", 3, 0, false);
        declareFunction(me, "cycl_query_specification_rkf_ask", "CYCL-QUERY-SPECIFICATION-RKF-ASK", 1, 0, false);
        declareFunction(me, "new_continuable_inference_from_cycl_query_spec", "NEW-CONTINUABLE-INFERENCE-FROM-CYCL-QUERY-SPEC", 1, 0, false);
        declareFunction(me, "continue_cycl_query_spec_inference", "CONTINUE-CYCL-QUERY-SPEC-INFERENCE", 2, 0, false);
        declareFunction(me, "static_query_properties_from_cycl_query_spec", "STATIC-QUERY-PROPERTIES-FROM-CYCL-QUERY-SPEC", 1, 0, false);
        declareFunction(me, "dynamic_query_properties_from_cycl_query_spec", "DYNAMIC-QUERY-PROPERTIES-FROM-CYCL-QUERY-SPEC", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $cycl_query_specification_native extends SubLStructNative {
        ...
        public $cycl_query_specification_native() {
            ...
            this.$max_number_of_results = Lisp.NIL;
            this.$back_chaining = Lisp.NIL;
            this.$time_cutoff_secs = Lisp.NIL;
            this.$max_depth = Lisp.NIL;
            this.$removal_cost_cutoff = Lisp.NIL;
            this.$enable_negation_by_failure = Lisp.NIL;
            this.$enable_hl_predicate_backchaining = Lisp.NIL;
            this.$enable_cache_backwards_query_results = Lisp.NIL;
            this.$enable_unbound_predicate_backchaining = Lisp.NIL;
            this.$enable_semantic_pruning = Lisp.NIL;
            this.$enable_consideration_of_disjunctive_temporal_relations = Lisp.NIL;
        }
