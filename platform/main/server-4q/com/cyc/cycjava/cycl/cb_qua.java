...
import com.cyc.cycjava.cycl.cb_qua;
...
import static com.cyc.cycjava.cycl.cb_qua.*;
...
public final class cb_qua extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLString $str0$cb_query_augmentation = makeString("cb-query-augmentation");





    public static final SubLSymbol CB_LINK_QUERY_AUGMENTATION = makeSymbol("CB-LINK-QUERY-AUGMENTATION");
    ...
    public static final SubLSymbol CB_QUA_RAW_OUTPUT = makeSymbol("CB-QUA-RAW-OUTPUT");
    ...
    public static SubLObject declare_cb_qua_file() {
        declareFunction(me, "cb_link_query_augmentation", "CB-LINK-QUERY-AUGMENTATION", 0, 1, false);
        declareFunction(me, "cb_qua_raw_output", "CB-QUA-RAW-OUTPUT", 0, 1, false);
        declareFunction(me, "cb_qua_output", "CB-QUA-OUTPUT", 0, 1, false);
        declareFunction(me, "cb_query_augmentation", "CB-QUERY-AUGMENTATION", 0, 1, false);
        declareFunction(me, "cb_qua_input", "CB-QUA-INPUT", 0, 1, false);
        declareFunction(me, "print_addition_info", "PRINT-ADDITION-INFO", 1, 0, false);
        declareFunction(me, "handle_disambiguation_info", "HANDLE-DISAMBIGUATION-INFO", 2, 0, false);
        declareFunction(me, "print_query_guts", "PRINT-QUERY-GUTS", 0, 2, false);
        declareFunction(me, "print_disambiguation_info", "PRINT-DISAMBIGUATION-INFO", 1, 0, false);
        declareFunction(me, "cb_make_qua_query_term_object_id", "CB-MAKE-QUA-QUERY-TERM-OBJECT-ID", 2, 0, false);
        declareFunction(me, "cb_qua_show_term_in_nl", "CB-QUA-SHOW-TERM-IN-NL", 1, 0, false);
        return NIL;
    }
