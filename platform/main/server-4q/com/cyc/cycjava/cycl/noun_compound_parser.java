...
import static com.cyc.cycjava.cycl.noun_compound_parser.*;
...
public final class noun_compound_parser extends SubLTranslatedFile {
    ...
    public static SubLObject noun_compound_parse_p(final SubLObject v_object) {
        return v_object.getClass() == noun_compound_parser.$noun_compound_parse_native.class ? T : NIL;
    }

    public static SubLObject nc_parse_unique_id(final SubLObject v_object) {
        assert NIL != noun_compound_parse_p(v_object) : "noun_compound_parser.noun_compound_parse_p(v_object) " + "CommonSymbols.NIL != noun_compound_parser.noun_compound_parse_p(v_object) " + v_object;
    ...
    public static SubLObject make_noun_compound_parse(SubLObject arglist) {
        ...
        final SubLObject v_new = new noun_compound_parser.$noun_compound_parse_native();
        SubLObject next;
    ...
    public static SubLObject noun_compound_block_p(final SubLObject v_object) {
        return v_object.getClass() == noun_compound_parser.$noun_compound_block_native.class ? T : NIL;
    }

    public static SubLObject nc_block_unique_id(final SubLObject v_object) {
        assert NIL != noun_compound_block_p(v_object) : "noun_compound_parser.noun_compound_block_p(v_object) " + "CommonSymbols.NIL != noun_compound_parser.noun_compound_block_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_noun_compound_block(SubLObject arglist) {
        ...
        final SubLObject v_new = new noun_compound_parser.$noun_compound_block_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject date_parse_block_p(final SubLObject v_object) {
        return v_object.getClass() == noun_compound_parser.$date_parse_block_native.class ? T : NIL;
    }

    public static SubLObject date_parse_block_subcol_naut(final SubLObject v_object) {
        assert NIL != date_parse_block_p(v_object) : "noun_compound_parser.date_parse_block_p(v_object) " + "CommonSymbols.NIL != noun_compound_parser.date_parse_block_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_date_parse_block(SubLObject arglist) {
        ...
        final SubLObject v_new = new noun_compound_parser.$date_parse_block_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $noun_compound_parse_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(noun_compound_parser.$noun_compound_parse_native.class, NOUN_COMPOUND_PARSE, NOUN_COMPOUND_PARSE_P, $list6, $list7, new String[]{ "$unique_id", "$input_string", "$input_strings", "$chart" }, $list8, $list9, PPRINT_NC_PARSE);
        }
    }
    ...
    public static final class $noun_compound_block_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(noun_compound_parser.$noun_compound_block_native.class, NOUN_COMPOUND_BLOCK, NOUN_COMPOUND_BLOCK_P, $list41, $list42, new String[]{ "$unique_id", "$span_index", "$confidence", "$denot", "$filters", "$spanned_string", "$head", "$head_pos", "$head_string_pred", "$sub_tree", "$plist" }, $list43, $list44, PPRINT_NC_BLOCK);
        }
    }
    ...
    public static final class $date_parse_block_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(noun_compound_parser.$date_parse_block_native.class, DATE_PARSE_BLOCK, DATE_PARSE_BLOCK_P, $list286, $list287, new String[]{ "$subcol_naut", "$confidence" }, $list288, $list289, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
