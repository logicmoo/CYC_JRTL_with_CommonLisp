...
public final class ke_text extends SubLTranslatedFile {
    ...
    public static final SubLList $list9 = list(makeString("Aborting: Too many errors found"));
    ...
    public static final SubLList $list48 = list(makeString("Unknown directive"));



    public static final SubLList $list50 = list(makeString("Formula: No formula specified"));

    public static final SubLList $list51 = list(makeString("Formula: Formula specified must be a list"));
    ...
    public static final SubLList $list55 = list(makeString("Constant: Invalid constant name"));
    ...
    public static final SubLList $list60 = list(makeString("Kill: No constant specified"));

    public static final SubLList $list61 = list(makeString("Kill: Only one constant may be specified"));

    public static final SubLList $list62 = list(makeString("Kill: Can't kill a NART."));
    ...
    public static final SubLList $list68 = list(makeString("Rename: Can't rename NATs"));

    public static final SubLList $list69 = list(makeString("Rename: Old constant name must be a string"));
    ...
    public static final SubLList $list71 = list(makeString("Rename: New constant name must be a string"));

    public static final SubLList $list72 = list(makeString("Rename: New constant name must be a string inside double quotes."));

    public static final SubLList $list73 = list(makeString("Rename: New constant name is not a valid name for a constant."));
    ...
    public static final SubLList $list80 = list(makeString("Merge: No kill term given"));
    ...
    public static final SubLList $list84 = list(makeString("Merge: Can't merge onto killed term"));

    private static final SubLList $list85 = list(makeString("Merge: Keep term must be a FORT"));



    public static final SubLList $list87 = list(makeString("In Mt: No mt specified"));
    ...
    public static final SubLList $list95 = list(makeString("Strength: No strength specified"));
    ...
    private static final SubLList $list125 = list(list(makeSymbol("QUOTE"), reader_make_constant_shell(makeString("BookkeepingMt"))));
    ...
    public static SubLObject declare_ke_text_file() {
        declareMacro(me, "with_ke_text_failures_to_file", "WITH-KE-TEXT-FAILURES-TO-FILE");
        declareFunction(me, "ke_text_list_to_token_lists", "KE-TEXT-LIST-TO-TOKEN-LISTS", 1, 1, false);
        declareFunction(me, "ket_lookup_string", "KET-LOOKUP-STRING", 2, 0, false);
        declareFunction(me, "ket_directive_list_to_directive", "KET-DIRECTIVE-LIST-TO-DIRECTIVE", 1, 1, false);
        declareFunction(me, "ket_relevant_mt", "KET-RELEVANT-MT", 3, 0, false);
        declareFunction(me, "ket_relevant_strength", "KET-RELEVANT-STRENGTH", 2, 0, false);
        declareFunction(me, "ket_relevant_direction", "KET-RELEVANT-DIRECTION", 2, 0, false);
        declareFunction(me, "ket_unknown_to_known", "KET-UNKNOWN-TO-KNOWN", 1, 2, false);
        declareFunction(me, "ket_maybe_find_constant", "KET-MAYBE-FIND-CONSTANT", 1, 0, false);
        declareFunction(me, "ket_make_ke_operation", "KET-MAKE-KE-OPERATION", 2, 6, false);
        declareFunction(me, "ke_text_token_lists_to_ke_operations", "KE-TEXT-TOKEN-LISTS-TO-KE-OPERATIONS", 1, 2, false);
        declareFunction(me, "do_ke_operation", "DO-KE-OPERATION", 1, 1, false);
        declareFunction(me, "new_constant_wrapperp", "NEW-CONSTANT-WRAPPERP", 1, 0, false);
        declareFunction(me, "make_new_constant_wrapper", "MAKE-NEW-CONSTANT-WRAPPER", 1, 0, false);
        declareFunction(me, "resolve_new_constants", "RESOLVE-NEW-CONSTANTS", 1, 0, false);
        declareFunction(me, "ke_text_list_to_ke_operations", "KE-TEXT-LIST-TO-KE-OPERATIONS", 1, 3, false);
        declareFunction(me, "ke_text_file_to_ke_text_list", "KE-TEXT-FILE-TO-KE-TEXT-LIST", 1, 0, false);
        declareFunction(me, "ke_text_to_ke_text_list", "KE-TEXT-TO-KE-TEXT-LIST", 2, 0, false);
        declareFunction(me, "ke_text_to_ke_text_list_internal", "KE-TEXT-TO-KE-TEXT-LIST-INTERNAL", 2, 0, false);
        declareFunction(me, "ke_operations_new_killed_renamed_merged_constant_names", "KE-OPERATIONS-NEW-KILLED-RENAMED-MERGED-CONSTANT-NAMES", 1, 0, false);
        declareFunction(me, "ke_text_error_message", "KE-TEXT-ERROR-MESSAGE", 1, 0, false);
        declareFunction(me, "format_el_sentence_as_ke_text", "FORMAT-EL-SENTENCE-AS-KE-TEXT", 2, 0, false);
        declareFunction(me, "load_ke_text_file", "LOAD-KE-TEXT-FILE", 2, 3, false);
        declareFunction(me, "parse_ke_text_string", "PARSE-KE-TEXT-STRING", 1, 0, false);
        declareFunction(me, "load_ke_text_string", "LOAD-KE-TEXT-STRING", 1, 1, false);
        return NIL;
    }
