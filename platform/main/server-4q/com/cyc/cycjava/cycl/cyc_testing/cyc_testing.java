...
import static com.cyc.cycjava.cycl.cyc_testing.cyc_testing.*;
...
public final class cyc_testing extends SubLTranslatedFile {
    ...
    private static final SubLList $list8 = list(list(makeKeyword("IUT"), makeString("inference unit test")), list(makeKeyword("IT"), makeString("inference test")), list(makeKeyword("RMT"), makeString("removal module test")), list(makeKeyword("TMT"), makeString("transformation module test")),
	    list(makeKeyword("RMCT"), makeString("removal module cost test")), list(makeKeyword("ERT"), makeString("evaluatable relation test")), list(makeKeyword("TCT"), makeString("test case table")), list(makeKeyword("KCT"), makeString("KB content test")));
    ...
    private static final SubLList $list123 = list(new SubLObject[] { makeSymbol("PATH"), makeSymbol("&KEY"), list(makeSymbol("STREAM"), list(makeSymbol("QUOTE"), makeSymbol("*STANDARD-OUTPUT*"))), list(makeSymbol("VERBOSITY"), makeKeyword("TERSE")), list(makeSymbol("STOP-AT-FIRST-FAILURE?"), NIL),
	    list(makeSymbol("OUTPUT-FORMAT"), makeKeyword("STANDARD")), list(makeSymbol("RUN-TINY-KB-TESTS-IN-FULL-KB?"), list(makeSymbol("QUOTE"), makeSymbol("*RUN-TINY-KB-TESTS-IN-FULL-KB?*"))), list(makeSymbol("RUN-TEST-CASE-TABLES?"), T), list(makeSymbol("RETURN-TEST-RUNS?"), NIL),
    ...
    private static final SubLList $list124 = list(new SubLObject[] { makeKeyword("STREAM"), makeKeyword("VERBOSITY"), makeKeyword("STOP-AT-FIRST-FAILURE?"), makeKeyword("OUTPUT-FORMAT"), makeKeyword("RUN-TINY-KB-TESTS-IN-FULL-KB?"), makeKeyword("RUN-TEST-CASE-TABLES?"),
	    makeKeyword("RETURN-TEST-RUNS?"), makeKeyword("TYPE"), makeKeyword("RUN-NON-WORKING-TESTS"), makeKeyword("PROGRESS-FILE"), makeKeyword("RERUN-CRASHING-TESTS") });
    ...
    public static final SubLList $list140 = list(new SubLObject[] { makeSymbol("&KEY"), list(makeSymbol("STREAM"), list(makeSymbol("QUOTE"), makeSymbol("*STANDARD-OUTPUT*"))), list(makeSymbol("VERBOSITY"), makeKeyword("VERBOSE")), list(makeSymbol("STOP-AT-FIRST-FAILURE?"), NIL),
	    list(makeSymbol("OUTPUT-FORMAT"), makeKeyword("STANDARD")), list(makeSymbol("RETURN-TEST-RUNS?"), NIL), list(makeSymbol("TYPE"), makeKeyword("ALL")), list(makeSymbol("RUN-NON-WORKING-TESTS"), NIL), list(makeSymbol("PROGRESS-FILE"), NIL), list(makeSymbol("RERUN-CRASHING-TESTS"), NIL) });

    private static final SubLList $list141 = list(new SubLObject[] { makeKeyword("STREAM"), makeKeyword("VERBOSITY"), makeKeyword("STOP-AT-FIRST-FAILURE?"), makeKeyword("OUTPUT-FORMAT"), makeKeyword("RETURN-TEST-RUNS?"), makeKeyword("TYPE"), makeKeyword("RUN-NON-WORKING-TESTS"),
	    makeKeyword("PROGRESS-FILE"), makeKeyword("RERUN-CRASHING-TESTS") });
    ...
    private static final SubLList $list148 = list(new SubLObject[] { makeSymbol("NAMES"), makeSymbol("&KEY"), list(makeSymbol("STREAM"), list(makeSymbol("QUOTE"), makeSymbol("*STANDARD-OUTPUT*"))), list(makeSymbol("VERBOSITY"), makeKeyword("VERBOSE")),
	    list(makeSymbol("STOP-AT-FIRST-FAILURE?"), NIL), list(makeSymbol("OUTPUT-FORMAT"), makeKeyword("STANDARD")), list(makeSymbol("RETURN-TEST-RUNS?"), NIL), list(makeSymbol("TYPE"), makeKeyword("ALL")), list(makeSymbol("RUN-NON-WORKING-TESTS"), NIL) });
	...
	return v_object.getClass() == cyc_testing.$cyc_test_native.class ? T : NIL;
    }

    public static SubLObject ct_file(final SubLObject v_object) {
	assert NIL != cyc_test_p(v_object) : "cyc_testing.cyc_test_p(v_object) " + "CommonSymbols.NIL != cyc_testing.cyc_test_p(v_object) " + v_object;
	...
	final SubLObject v_new = new cyc_testing.$cyc_test_native();
	SubLObject next;
	...
	if (output_format.eql($WITH_OWNER)) {
	    return cconcatenate(format_nil.format_nil_s_no_copy(result),
		    new SubLObject[] { $$$_, format_nil.format_nil_s_no_copy(time), $$$_, format_nil.format_nil_s_no_copy(type), $$$_, format_nil.format_nil_s_no_copy(name), $$$_, format_nil.format_nil_s_no_copy(owner), format_nil.$format_nil_percent$.getGlobalValue() });
	}
	...
	return v_object.getClass() == cyc_testing.$cyc_test_file_native.class ? T : NIL;
    }

    public static SubLObject ctf_filename(final SubLObject v_object) {
	assert NIL != cyc_test_file_p(v_object) : "cyc_testing.cyc_test_file_p(v_object) " + "CommonSymbols.NIL != cyc_testing.cyc_test_file_p(v_object) " + v_object;
	return v_object.getField2();
    }
	...
	final SubLObject v_new = new cyc_testing.$cyc_test_file_native();
	SubLObject next;
	SubLObject current_arg;
	SubLObject current_value;
	SubLObject pcase_var;
    ...
    public static SubLObject run_all_cyc_tests_int(final SubLObject path, SubLObject stream, SubLObject verbosity, SubLObject stop_at_first_failureP, SubLObject output_format, SubLObject run_tiny_kb_tests_in_full_kbP, SubLObject run_test_case_tablesP, SubLObject return_test_runsP, SubLObject type,
	    SubLObject run_non_working_tests, SubLObject progress_file, SubLObject rerun_crashing_tests, SubLObject phase, SubLObject phases) {
    ...
    public static SubLObject run_all_loaded_cyc_tests(SubLObject stream, SubLObject verbosity, SubLObject stop_at_first_failureP, SubLObject output_format, SubLObject run_tiny_kb_tests_in_full_kbP, SubLObject run_test_case_tablesP, SubLObject return_test_runsP, SubLObject type,
	    SubLObject run_non_working_tests, SubLObject progress_file, SubLObject rerun_crashing_tests, SubLObject tests, SubLObject phase, SubLObject phases) {
	if (stream == UNPROVIDED) {
	    stream = StreamsLow.$standard_output$.getDynamicValue();
	}
	if (verbosity == UNPROVIDED) {
	...
	static {
	    structDecl = makeStructDeclNative(cyc_testing.$cyc_test_native.class, CYC_TEST, CYC_TEST_P, $list31, $list32, new String[] { "$file", "$guts" }, $list33, $list34, PRINT_CYC_TEST);
	}
    }
	...
	static {
	    structDecl = makeStructDeclNative(cyc_testing.$cyc_test_file_native.class, CYC_TEST_FILE, CYC_TEST_FILE_P, $list102, $list103, new String[] { "$filename", "$kb" }, $list104, $list105, PRINT_CYC_TEST_FILE);
	}
    }
