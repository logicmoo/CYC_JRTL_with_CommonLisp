...
import com.cyc.tool.subl.util.SubLTranslatedFile;
 public final class removal_module_tests extends SubLTranslatedFile {
    ...
    public static SubLObject removal_module_test_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$removal_module_test_native.class ? T : NIL;
    }

    public static SubLObject rmt_hl_module(final SubLObject v_object) {
        assert NIL != removal_module_test_p(v_object) : "removal_module_tests.removal_module_test_p error :" + v_object;
    ...
    public static SubLObject init_removal_module_tests_file() {
        ...
        deflexical("*REMOVAL-MODULE-TESTS*", SubLSystemTrampolineFile.maybeDefault($removal_module_tests$, $removal_module_tests$, () -> make_hash_table($int$100, UNPROVIDED, UNPROVIDED)));
        return NIL;
    }
    ...
    public static final class $removal_module_test_native extends SubLStructNative {
        ...
        private $removal_module_test_native() {
        ...
        static {
            structDecl = makeStructDeclNative($removal_module_test_native.class, REMOVAL_MODULE_TEST, REMOVAL_MODULE_TEST_P, $list2, $list3, new String[]{ "$hl_module", "$id", "$sentence", "$mt", "$properties", "$comment", "$kb", "$owner", "$bug_number", "$creation_date", "$creator", "$workingP" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
