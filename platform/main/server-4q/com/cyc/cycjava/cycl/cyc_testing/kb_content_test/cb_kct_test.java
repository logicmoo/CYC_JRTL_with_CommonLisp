...
import static com.cyc.cycjava.cycl.cyc_testing.kb_content_test.cb_kct_test.*;
...
public final class cb_kct_test extends SubLTranslatedFile {
    ...
    public static SubLObject kct_test_state_p(final SubLObject v_object) {
        return v_object.getClass() == cb_kct_test.$kct_test_state_native.class ? T : NIL;
    }

    public static SubLObject kct_test_state_test_spec(final SubLObject v_object) {
        assert NIL != kct_test_state_p(v_object) : "cb_kct_test.kct_test_state_p(v_object) " + "CommonSymbols.NIL != cb_kct_test.kct_test_state_p(v_object) " + v_object;
    ...
    public static SubLObject make_kct_test_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_kct_test.$kct_test_state_native();
        SubLObject next;
    ...
    public static SubLObject kct_answer_p(final SubLObject v_object) {
        return v_object.getClass() == cb_kct_test.$kct_answer_native.class ? T : NIL;
    }

    public static SubLObject kct_answer_binding_set(final SubLObject v_object) {
        assert NIL != kct_answer_p(v_object) : "cb_kct_test.kct_answer_p(v_object) " + "CommonSymbols.NIL != cb_kct_test.kct_answer_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_kct_answer(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_kct_test.$kct_answer_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $kct_answer_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(cb_kct_test.$kct_answer_native.class, KCT_ANSWER, KCT_ANSWER_P, $list222, $list223, new String[]{ "$binding_set", "$status", "$id" }, $list224, $list225, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
