...
public final class generic_testing extends SubLTranslatedFile {
    ...
    public static SubLObject generic_test_case_table_p(final SubLObject v_object) {
        return v_object.getClass() == generic_testing.$generic_test_case_table_native.class ? T : NIL;
    }

    public static SubLObject gtct_name(final SubLObject v_object) {
        assert NIL != generic_test_case_table_p(v_object) : "generic_testing.generic_test_case_table_p(v_object) " + "CommonSymbols.NIL != generic_testing.generic_test_case_table_p(v_object) " + v_object;
    ...
    public static SubLObject make_generic_test_case_table(SubLObject arglist) {
        ...
        final SubLObject v_new = new generic_testing.$generic_test_case_table_native();
        SubLObject next;
    ...
    public static final class $generic_test_case_table_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(generic_testing.$generic_test_case_table_native.class, GENERIC_TEST_CASE_TABLE, GENERIC_TEST_CASE_TABLE_P, $list9, $list10, new String[]{ "$name", "$tuples", "$test", "$owner", "$classes", "$kb", "$workingP" }, $list11, $list12, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
