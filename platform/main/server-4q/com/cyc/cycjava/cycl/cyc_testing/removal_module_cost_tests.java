...
public final class removal_module_cost_tests extends SubLTranslatedFile {
    ...
    public static SubLObject removal_module_cost_test_p(final SubLObject v_object) {
        return v_object.getClass() == removal_module_cost_tests.$removal_module_cost_test_native.class ? T : NIL;
    }

    public static SubLObject rmct_hl_module(final SubLObject v_object) {
        assert NIL != removal_module_cost_test_p(v_object) : "removal_module_cost_tests.removal_module_cost_test_p(v_object) " + "CommonSymbols.NIL != removal_module_cost_tests.removal_module_cost_test_p(v_object) " + v_object;
    ...
    public static SubLObject make_removal_module_cost_test(SubLObject arglist) {
        ...
        final SubLObject v_new = new removal_module_cost_tests.$removal_module_cost_test_native();
        SubLObject next;
    ...
    public static final class $removal_module_cost_test_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(removal_module_cost_tests.$removal_module_cost_test_native.class, REMOVAL_MODULE_COST_TEST, REMOVAL_MODULE_COST_TEST_P, $list2, $list3, new String[]{ "$hl_module", "$id", "$sentence", "$mt", "$comment", "$kb", "$owner", "$bug_number", "$creation_date", "$creator", "$workingP" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
