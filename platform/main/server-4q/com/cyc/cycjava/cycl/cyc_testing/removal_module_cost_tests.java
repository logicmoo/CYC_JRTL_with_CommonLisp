...
import com.cyc.tool.subl.util.SubLTranslatedFile;
 public final class removal_module_cost_tests extends SubLTranslatedFile {
    ...
    public static SubLObject removal_module_cost_test_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$removal_module_cost_test_native.class ? T : NIL;
    }
    ...
    public static SubLObject init_removal_module_cost_tests_file() {
        ...
        deflexical("*REMOVAL-MODULE-COST-TESTS*", SubLSystemTrampolineFile.maybeDefault($removal_module_cost_tests$, $removal_module_cost_tests$, () -> make_hash_table($int$100, UNPROVIDED, UNPROVIDED)));
        return NIL;
    }
