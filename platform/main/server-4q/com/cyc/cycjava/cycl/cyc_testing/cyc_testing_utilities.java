...
public final class cyc_testing_utilities extends SubLTranslatedFile {
	...
	private static final SubLList $list7 = list(makeSymbol("NAME"), makeSymbol("&KEY"), list(makeSymbol("VERBOSITY"), makeKeyword("TERSE")), makeSymbol("BROWSABLE?"), makeSymbol("BLOCK?"), list(makeSymbol("OUTPUT-FORMAT"), makeKeyword("STANDARD")), list(makeSymbol("STREAM"), list(makeSymbol("QUOTE"), makeSymbol("*STANDARD-OUTPUT*"))),
			list(makeSymbol("RUN-TINY-KB-TESTS-IN-FULL-KB?"), list(makeSymbol("QUOTE"), makeSymbol("*RUN-TINY-KB-TESTS-IN-FULL-KB?*"))));
	...
	private static final SubLList $list21 = list(new SubLObject[] { makeSymbol("NAME"), makeSymbol("MIN-NUMBER"), makeSymbol("MAX-NUMBER"), makeSymbol("&KEY"), list(makeSymbol("VERBOSITY"), makeKeyword("TERSE")), makeSymbol("BROWSABLE?"), makeSymbol("BLOCK?"), list(makeSymbol("OUTPUT-FORMAT"), makeKeyword("STANDARD")), list(makeSymbol("STREAM"), list(makeSymbol("QUOTE"), makeSymbol("*STANDARD-OUTPUT*"))),
			list(makeSymbol("RUN-TINY-KB-TESTS-IN-FULL-KB?"), list(makeSymbol("QUOTE"), makeSymbol("*RUN-TINY-KB-TESTS-IN-FULL-KB?*"))) });
	...
	private static final SubLList $list31 = list(new SubLObject[] { makeSymbol("NAME"), makeSymbol("&KEY"), list(makeSymbol("NTHREADS"), FOUR_INTEGER), list(makeSymbol("NTIMES"), TEN_INTEGER), list(makeSymbol("VERBOSITY"), makeKeyword("TERSE")), makeSymbol("BROWSABLE?"), makeSymbol("BLOCK?"), list(makeSymbol("OUTPUT-FORMAT"), makeKeyword("STANDARD")),
			list(makeSymbol("STREAM"), list(makeSymbol("QUOTE"), makeSymbol("*STANDARD-OUTPUT*"))), list(makeSymbol("RUN-TINY-KB-TESTS-IN-FULL-KB?"), list(makeSymbol("QUOTE"), makeSymbol("*RUN-TINY-KB-TESTS-IN-FULL-KB?*"))) });
	...
	private static final SubLList $list111 = list(new SubLObject[] { makeKeyword("CANONICALIZE-INFERENCE-ANSWER-JUSTIFICATIONS"), makeKeyword("NON-EXPLANATORY-SENTENCE-SUPPORTS"), makeKeyword("NON-EXPLANATORY-VARIABLE-MAP-SUPPORTS"), makeKeyword("TRUE-SENTENCE-OF-ATOMIC-SENTENCE-REDUCTION"), makeKeyword("IST-OF-ATOMIC-SENTENCE-REDUCTION"), makeKeyword("RELATION-ALL-INSTANCE-ITERATE-2"),
			makeKeyword("RELATION-INSTANCE-ALL-ITERATE-2"), makeKeyword("REJECT-PREVIOUSLY-PROVEN-PROOFS"), makeKeyword("INFERENCE-HARNESS-OVERHEAD"), makeKeyword("TACTICALLY-UNEXAMINED-NO-GOOD-IMPLIES-STRATEGICALLY-UNEXAMINED-NO-GOOD"), makeKeyword("KAPPA-REMOVAL-WORKS"), makeKeyword("DONT-REOPEN-ANSWER-LINK"), makeKeyword("REMOVAL-TRUE-SENTENCE-UNIVERSAL-DISJUNCTION-14A"),
			makeKeyword("CLOSED-ASENT-WITH-3-CHILDREN"), makeKeyword("SIMPLE-EXCEPT-WHEN"), makeKeyword("SIMPLE-EXCEPT-WHEN-RESIDUAL-TRANSFORMATION"), makeKeyword("PARTIAL-EXCEPT-WHEN"), makeKeyword("VARIABLE-MAP-EXCEPT-WHEN"), makeKeyword("EXCEPTION-TMS-BACKWARD-NO-OP"), makeKeyword("MULTIPLE-TRANSFORMATION-PROOFS-FOR-CLOSED-PROBLEM"), makeKeyword("BACKCHAIN-TO-REMOVAL-TRUE-SENTENCE-UNIVERSAL-DISJUNCTION-1"),
			makeKeyword("BACKCHAIN-TO-REMOVAL-TRUE-SENTENCE-UNIVERSAL-DISJUNCTION-2"), makeKeyword("BACKCHAIN-TO-REMOVAL-TRUE-SENTENCE-UNIVERSAL-DISJUNCTION-3"), makeKeyword("EXCEPT-MT-IN-MID-MT-BLOCKS-HIGH-MT-FROM-LOW-MT"), makeKeyword("EXCEPT-MT-IN-HIGH-MT-HOSES-BACKWARD-INFERENCE"), makeKeyword("TWO-STEP"), makeKeyword("TWO-STEP-ARG-1"), makeKeyword("RECONSIDER-DEDUCTION"), makeKeyword("THERE-EXISTS"),
			makeKeyword("EXCEPT-WHEN"), makeKeyword("STRENGTH-PROPAGATION"), makeKeyword("SEQUENCE-VARIABLES-INFERENCE"), makeKeyword("INFERENCE-ANSWER-TEMPLATE"), makeKeyword("EXCEPT-BLOCKS-BACKWARD"), makeKeyword("EXCEPT-BLOCKS-FORWARD"), makeKeyword("TRUE-SENTENCE-UNIVERSAL-DISJUNCTION-SCOPING"), makeKeyword("TMS-RECONSIDERATION-WITH-BACKCHAIN-FORBIDDEN"), makeKeyword("LAZILY-MANIFEST-NON-FOCALS"),
			makeKeyword("CONSIDER-NO-GOOD-AFTER-DETERMINING-TACTICS"), makeKeyword("IRRELEVANT-DOES-NOT-IMPLY-PENDING"), makeKeyword("PROBLEM-STORE-PRUNING-MAX-INSUFFICIENT"), makeKeyword("RESTRICTED-CLOSED-GOOD-PROBLEMS-STAY-UNEXAMINED"), makeKeyword("GENLS-BETWEEN"), makeKeyword("CONJUNCTIVE-INTEGER-BETWEEN-1"), makeKeyword("CONJUNCTIVE-INTEGER-BETWEEN-2"), makeKeyword("CONJUNCTIVE-INTEGER-BETWEEN-3"),
			makeKeyword("CONJUNCTIVE-INTEGER-BETWEEN-4"), makeKeyword("CONJUNCTIVE-INTEGER-BETWEEN-5"), makeKeyword("CONJUNCTIVE-INTEGER-BETWEEN-6"), makeKeyword("CONJUNCTIVE-INTEGER-BETWEEN-7"), makeKeyword("CONJUNCTIVE-INTEGER-BETWEEN-8"), makeKeyword("CONJUNCTIVE-FOLLOWUP-ADDITIONAL-JOIN-ORDERED"), makeKeyword("CONJUNCTIVE-FOLLOWUP-ADDITIONAL-JOIN-ORDERED-WITHOUT-INFERENCE"), makeKeyword("CIRCULAR-PROOFS"),
			makeKeyword("POSSIBLE-REUSED-PROBLEMS-GET-STRATEGICALLY-EVALUATED"), makeKeyword("RESIDUAL-TRANSFORMATION-PROBLEM-REUSE") });
	...
	public static SubLObject run_cyc_test_it_int(final SubLObject it, final SubLObject progress_blipP, final SubLObject verboseP, final SubLObject testing_direction) {
			...
			try {
				...
				try {
					...
					try {
						...
						} else if (testing_direction.eql($FORWARD)) {
		...
		} else if (testing_direction.eql($BACKWARD)) {
			test_run = inference_testing.run_test(it, progress_blipP, verboseP, $BACKWARD, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
		} else if (testing_direction.eql($FORWARD)) {
			test_run = inference_testing.run_test(it, progress_blipP, verboseP, $FORWARD, NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED);
		} else {
	...
	public static SubLObject run_all_loaded_cyc_tests_int(final SubLObject stream, final SubLObject verbosity, final SubLObject stop_at_first_failureP, final SubLObject output_format, final SubLObject run_tiny_kb_tests_in_full_kbP, final SubLObject run_test_case_tablesP, final SubLObject type, final SubLObject run_non_working_tests, final SubLObject progress_file, SubLObject rerun_crashing_tests, SubLObject tests,
			SubLObject phase, SubLObject phases) {
		if (tests == UNPROVIDED) {
					...
					try {
						...
						try {
							...
							for (test_num = ZERO_INTEGER; (NIL == doneP) && (NIL != list_var); list_var = list_var.rest(), ct = list_var.first(), test_num = add(ONE_INTEGER, test_num)) {
								...
								} else if (($TCT != cyc_testing.cyc_test_type(ct)) && (NIL != cyc_test_mentions_invalid_constantP(ct))) {
				...
				try {
					...
					try {
						...
						for (test_num2 = ZERO_INTEGER; (NIL == doneP) && (NIL != list_var2); list_var2 = list_var2.rest(), ct2 = list_var2.first(), test_num2 = add(ONE_INTEGER, test_num2)) {
							...
							} else if (($TCT != cyc_testing.cyc_test_type(ct2)) && (NIL != cyc_test_mentions_invalid_constantP(ct2))) {
	...
	public static SubLObject print_ignored_cyc_tests_message(final SubLObject stream, final SubLObject test_runs, SubLObject show_ownersP, SubLObject show_projectsP) {
		...
		if (NIL == ignored_test_runs) {
			...
			while (NIL != cdolist_list_var) {
				...
				} else if (pcase_var.eql($NON_REGRESSION_FAILURE)) {
	...
	public static SubLObject run_all_loaded_cyc_tests_print_header(final SubLObject stream, final SubLObject start_time, final SubLObject tests_specifiedP, SubLObject phase, SubLObject phases) {
		...
		final PrintWriter asPrintWriter = stream.toOutputTextStream().asPrintWriter();
		asPrintWriter.println(";;;");
		asPrintWriter.println(";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;");
		asPrintWriter.println(";; Test Count: " + cyc_testing.cyc_test_count());
		asPrintWriter.println(";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;");
		asPrintWriter.flush();
	 ...
	 * @param cyc_regression_test_runs
	 * @param comment
	 * @param overriding_to_address
	 * @return
	 */
	public static SubLObject email_cyc_test_runs_summaries(SubLObject cyc_regression_test_runs, SubLObject comment, SubLObject overriding_to_address) {
	 ...
	 * @return
	 */
	public static SubLObject email_cyc_test_runs_summaries_if_failures(SubLObject cyc_regression_test_runs, SubLObject comment, SubLObject overriding_to_address) {
		// TODO Auto-generated method stub
		if (true)
			Errors.unimplementedMethod(myName);
		return null;
