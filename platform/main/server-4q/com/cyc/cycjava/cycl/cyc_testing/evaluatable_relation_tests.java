...
import com.cyc.cycjava.cycl.cyc_testing.evaluatable_relation_tests;
...
import static com.cyc.cycjava.cycl.cyc_testing.evaluatable_relation_tests.*;
...
public final class evaluatable_relation_tests extends SubLTranslatedFile {
    ...
    public static SubLObject evaluatable_relation_test_p(final SubLObject v_object) {
        return v_object.getClass() == evaluatable_relation_tests.$evaluatable_relation_test_native.class ? T : NIL;
    }

    public static SubLObject ert_relation(final SubLObject v_object) {
        assert NIL != evaluatable_relation_test_p(v_object) : "evaluatable_relation_tests.evaluatable_relation_test_p(v_object) " + "CommonSymbols.NIL != evaluatable_relation_tests.evaluatable_relation_test_p(v_object) " + v_object;
    ...
    public static SubLObject make_evaluatable_relation_test(SubLObject arglist) {
        ...
        final SubLObject v_new = new evaluatable_relation_tests.$evaluatable_relation_test_native();
        SubLObject next;
    ...
    public static final class $evaluatable_relation_test_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(evaluatable_relation_tests.$evaluatable_relation_test_native.class, EVALUATABLE_RELATION_TEST, EVALUATABLE_RELATION_TEST_P, $list2, $list3, new String[]{ "$relation", "$id", "$sentence", "$kb", "$owner" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
