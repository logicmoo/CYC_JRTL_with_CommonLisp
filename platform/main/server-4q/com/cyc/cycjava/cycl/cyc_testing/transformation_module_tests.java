...
import com.cyc.cycjava.cycl.cyc_testing.transformation_module_tests;
...
import static com.cyc.cycjava.cycl.cyc_testing.transformation_module_tests.*;
...
public final class transformation_module_tests extends SubLTranslatedFile {
    ...
    public static SubLObject transformation_module_test_p(final SubLObject v_object) {
        return v_object.getClass() == transformation_module_tests.$transformation_module_test_native.class ? T : NIL;
    }

    public static SubLObject tmt_hl_module(final SubLObject v_object) {
        assert NIL != transformation_module_test_p(v_object) : "transformation_module_tests.transformation_module_test_p(v_object) " + "CommonSymbols.NIL != transformation_module_tests.transformation_module_test_p(v_object) " + v_object;
    ...
    public static SubLObject make_transformation_module_test(SubLObject arglist) {
        ...
        final SubLObject v_new = new transformation_module_tests.$transformation_module_test_native();
        SubLObject next;
