...
import static com.cyc.cycjava.cycl.rkf_text_processors.*;
...
public final class rkf_text_processors extends SubLTranslatedFile {
    ...
    public static SubLObject parse_result_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_text_processors.$parse_result_native.class ? T : NIL;
    }

    public static SubLObject parse_result_original(final SubLObject v_object) {
        assert NIL != parse_result_p(v_object) : "rkf_text_processors.parse_result_p(v_object) " + "CommonSymbols.NIL != rkf_text_processors.parse_result_p(v_object) " + v_object;
    ...
    public static SubLObject make_parse_result(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_text_processors.$parse_result_native();
        SubLObject next;
    ...
    public static SubLObject parse_module_definition_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_text_processors.$parse_module_definition_native.class ? T : NIL;
    }

    public static SubLObject pmd_name(final SubLObject v_object) {
        assert NIL != parse_module_definition_p(v_object) : "rkf_text_processors.parse_module_definition_p(v_object) " + "CommonSymbols.NIL != rkf_text_processors.parse_module_definition_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_parse_module_definition(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_text_processors.$parse_module_definition_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject parse_module_group_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_text_processors.$parse_module_group_native.class ? T : NIL;
    }

    public static SubLObject pmg_category(final SubLObject v_object) {
        assert NIL != parse_module_group_p(v_object) : "rkf_text_processors.parse_module_group_p(v_object) " + "CommonSymbols.NIL != rkf_text_processors.parse_module_group_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_parse_module_group(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_text_processors.$parse_module_group_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $parse_result_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_text_processors.$parse_result_native.class, PARSE_RESULT, PARSE_RESULT_P, $list9, $list10, new String[]{ "$original", "$constituents", "$eliminated", "$problems", "$solutions" }, $list11, $list12, PRINT_PARSE_RESULT);
        }
    }
    ...
    public static final class $parse_module_definition_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_text_processors.$parse_module_definition_native.class, PARSE_MODULE_DEFINITION, PARSE_MODULE_DEFINITION_P, $list72, $list73, new String[]{ "$name", "$category", "$quality", "$entry_point", "$cost", "$expected_expansions", "$supplants" }, $list74, $list75, PMD_PRINT);
        }
    }
    ...
    public static final class $parse_module_group_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_text_processors.$parse_module_group_native.class, PARSE_MODULE_GROUP, PARSE_MODULE_GROUP_P, $list109, $list110, new String[]{ "$category", "$tools" }, $list111, $list112, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
