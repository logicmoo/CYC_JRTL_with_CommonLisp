...
import com.cyc.cycjava.cycl.rkf_solution_finder;
...
import static com.cyc.cycjava.cycl.rkf_solution_finder.*;
...
public final class rkf_solution_finder extends SubLTranslatedFile {
    ...
    public static SubLObject sf_solution_set_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_solution_finder.$sf_solution_set_native.class ? T : NIL;
    }

    public static SubLObject sf_solution_set_id(final SubLObject v_object) {
        assert NIL != sf_solution_set_p(v_object) : "rkf_solution_finder.sf_solution_set_p(v_object) " + "CommonSymbols.NIL != rkf_solution_finder.sf_solution_set_p(v_object) " + v_object;
    ...
    public static SubLObject make_sf_solution_set(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_solution_finder.$sf_solution_set_native();
        SubLObject next;
    ...
    public static SubLObject sf_state_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_solution_finder.$sf_state_native.class ? T : NIL;
    }

    public static SubLObject sf_state_id(final SubLObject v_object) {
        assert NIL != sf_state_p(v_object) : "rkf_solution_finder.sf_state_p(v_object) " + "CommonSymbols.NIL != rkf_solution_finder.sf_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sf_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_solution_finder.$sf_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $sf_solution_set_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_solution_finder.$sf_solution_set_native.class, SF_SOLUTION_SET, SF_SOLUTION_SET_P, $list8, $list9, new String[]{ "$id", "$bindings", "$supports" }, $list10, $list11, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $sf_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_solution_finder.$sf_state_native.class, SF_STATE, SF_STATE_P, $list33, $list34, new String[]{ "$id", "$interaction", "$text", "$query", "$inference_params", "$inference", "$solution_queue", "$status", "$pros_cons", "$binding_index" }, $list35, $list36, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
