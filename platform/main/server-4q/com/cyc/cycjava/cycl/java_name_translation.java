...
import com.cyc.cycjava.cycl.java_name_translation;
...
import static com.cyc.cycjava.cycl.java_name_translation.*;
...
public final class java_name_translation extends SubLTranslatedFile {
    ...
    public static SubLObject declare_java_name_translation_file() {
        declareFunction(me, "java_backend_reserved_word_p", "JAVA-BACKEND-RESERVED-WORD-P", 1, 0, false);
        declareFunction(me, "java_backend_defined_function_p", "JAVA-BACKEND-DEFINED-FUNCTION-P", 1, 0, false);
        declareFunction(me, "java_backend_defined_function_name_exception_lookup", "JAVA-BACKEND-DEFINED-FUNCTION-NAME-EXCEPTION-LOOKUP", 1, 0, false);
        declareFunction(me, "java_backend_function_call_arity_transform", "JAVA-BACKEND-FUNCTION-CALL-ARITY-TRANSFORM", 1, 0, false);
        declareFunction(me, "java_backend_function_call_arity_lookup", "JAVA-BACKEND-FUNCTION-CALL-ARITY-LOOKUP", 2, 0, false);
        declareFunction(me, "java_backend_simplify_Xdtb_transform", "JAVA-BACKEND-SIMPLIFY-%DTB-TRANSFORM", 1, 0, false);
        declareFunction(me, "initialize_java_backend_function_boolean_hash", "INITIALIZE-JAVA-BACKEND-FUNCTION-BOOLEAN-HASH", 0, 0, false);
        declareFunction(me, "java_backend_boolean_method_lookup", "JAVA-BACKEND-BOOLEAN-METHOD-LOOKUP", 1, 0, false);
        declareFunction(me, "java_backend_function_to_method_transform", "JAVA-BACKEND-FUNCTION-TO-METHOD-TRANSFORM", 1, 0, false);
        declareFunction(me, "initialize_java_backend_function_to_method_hash", "INITIALIZE-JAVA-BACKEND-FUNCTION-TO-METHOD-HASH", 0, 0, false);
        declareFunction(me, "java_backend_function_to_method_lookup", "JAVA-BACKEND-FUNCTION-TO-METHOD-LOOKUP", 1, 0, false);
        declareFunction(me, "java_backend_predefined_function_p", "JAVA-BACKEND-PREDEFINED-FUNCTION-P", 1, 0, false);
        declareFunction(me, "java_backend_function_class_lookup", "JAVA-BACKEND-FUNCTION-CLASS-LOOKUP", 1, 0, false);
        declareFunction(me, "java_backend_function_name_lookup", "JAVA-BACKEND-FUNCTION-NAME-LOOKUP", 1, 0, false);
        declareFunction(me, "initialize_java_backend_function_tables", "INITIALIZE-JAVA-BACKEND-FUNCTION-TABLES", 0, 0, false);
        declareFunction(me, "java_backend_compute_defined_function_name", "JAVA-BACKEND-COMPUTE-DEFINED-FUNCTION-NAME", 1, 0, false);
        declareFunction(me, "java_backend_computed_function_name_internal", "JAVA-BACKEND-COMPUTED-FUNCTION-NAME-INTERNAL", 1, 0, false);
        declareFunction(me, "java_backend_computed_function_name", "JAVA-BACKEND-COMPUTED-FUNCTION-NAME", 1, 0, false);
        declareFunction(me, "java_backend_secure_method_id", "JAVA-BACKEND-SECURE-METHOD-ID", 1, 0, false);
        declareFunction(me, "java_backend_symbol_name_basis", "JAVA-BACKEND-SYMBOL-NAME-BASIS", 1, 0, false);
        declareFunction(me, "java_backend_convert_identifier_name", "JAVA-BACKEND-CONVERT-IDENTIFIER-NAME", 1, 0, false);
        declareFunction(me, "java_backend_function_class", "JAVA-BACKEND-FUNCTION-CLASS", 1, 0, false);
        declareFunction(me, "java_backend_function_name", "JAVA-BACKEND-FUNCTION-NAME", 1, 0, false);
        declareFunction(me, "java_backend_function_arglist_lookup", "JAVA-BACKEND-FUNCTION-ARGLIST-LOOKUP", 1, 0, false);
        declareFunction(me, "initialize_java_backend_function_arglist_table", "INITIALIZE-JAVA-BACKEND-FUNCTION-ARGLIST-TABLE", 0, 0, false);
        declareFunction(me, "java_backend_predefined_constant_name", "JAVA-BACKEND-PREDEFINED-CONSTANT-NAME", 1, 0, false);
        declareFunction(me, "java_backend_undefined_variable_binding_type_lookup", "JAVA-BACKEND-UNDEFINED-VARIABLE-BINDING-TYPE-LOOKUP", 1, 0, false);
        declareFunction(me, "java_backend_predefined_global_p", "JAVA-BACKEND-PREDEFINED-GLOBAL-P", 1, 0, false);
        declareFunction(me, "java_backend_global_class_lookup", "JAVA-BACKEND-GLOBAL-CLASS-LOOKUP", 1, 0, false);
        declareFunction(me, "java_backend_global_name_lookup", "JAVA-BACKEND-GLOBAL-NAME-LOOKUP", 1, 0, false);
        declareFunction(me, "initialize_java_backend_global_tables", "INITIALIZE-JAVA-BACKEND-GLOBAL-TABLES", 0, 0, false);
        declareFunction(me, "java_backend_global_class", "JAVA-BACKEND-GLOBAL-CLASS", 1, 0, false);
        declareFunction(me, "java_backend_global_name", "JAVA-BACKEND-GLOBAL-NAME", 1, 0, false);
        declareFunction(me, "java_backend_computed_global_name_internal", "JAVA-BACKEND-COMPUTED-GLOBAL-NAME-INTERNAL", 1, 0, false);
        declareFunction(me, "java_backend_computed_global_name", "JAVA-BACKEND-COMPUTED-GLOBAL-NAME", 1, 0, false);
        declareFunction(me, "java_backend_secure_global_id", "JAVA-BACKEND-SECURE-GLOBAL-ID", 1, 0, false);
        return NIL;
    }
