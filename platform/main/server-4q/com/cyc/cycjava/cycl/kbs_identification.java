...
public final class kbs_identification
    extends
      SubLTranslatedFile
{
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return makeBoolean( NIL != constant_handles.constant_p( constant ) && NIL != Hashtables.gethash( constant, $kbs_raw_constants_table$.getDynamicValue( thread ), UNPROVIDED ) );
  }
  ...
  public static SubLObject why_kbs_raw_constantP(final SubLObject constant)
  {
    ...
    if( NIL != kbs_raw_constant_p( constant ) )
    {
      ...
      final SubLObject inclusion_cols = cdolist_list_var = Hashtables.gethash( constant, $kbs_raw_constants_table$.getDynamicValue( thread ), UNPROVIDED );
      SubLObject inclusion_col = NIL;
      inclusion_col = cdolist_list_var.first();
      while ( NIL != cdolist_list_var)
      {
        result = ConsesLow.cons( arguments.make_hl_support( $kw0$ISA, el_utilities.make_binary_formula( $const1$quotedIsa, constant, inclusion_col ), $const2$InferencePSC, UNPROVIDED ), result );
  ...
  {
    return makeBoolean( NIL != constant_handles.constant_p( constant ) && NIL == kbs_raw_constant_p( constant ) );
  }
  ...
  public static SubLObject why_non_kbs_raw_constantP(final SubLObject constant)
  {
    ...
    {
      SubLObject cdolist_list_var;
      final SubLObject inclusion_exclusion_cols_list = cdolist_list_var = Hashtables.gethash( constant, $kbs_raw_constants_omission_table$.getDynamicValue( thread ), UNPROVIDED );
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        supports = ConsesLow.cons( $str3$Even_though_explicitly_included_v, supports );
        SubLObject cdolist_list_var_$1 = inclusion_cols;
        SubLObject inclusion_col = NIL;
        inclusion_col = cdolist_list_var_$1.first();
        while ( NIL != cdolist_list_var_$1)
        {
          supports = ConsesLow.cons( arguments.make_hl_support( $kw0$ISA, el_utilities.make_binary_formula( $const4$isa, constant, inclusion_col ), $const2$InferencePSC, UNPROVIDED ), supports );
          cdolist_list_var_$1 = cdolist_list_var_$1.rest();
          inclusion_col = cdolist_list_var_$1.first();
        }
        supports = ConsesLow.cons( $str5$The_constant_is_also_excluded_bec, supports );
        SubLObject cdolist_list_var_$2 = exclusion_cols;
        SubLObject exclusion_col = NIL;
        exclusion_col = cdolist_list_var_$2.first();
        while ( NIL != cdolist_list_var_$2)
        {
          supports = ConsesLow.cons( arguments.make_hl_support( $kw0$ISA, el_utilities.make_binary_formula( $const4$isa, constant, exclusion_col ), $const2$InferencePSC, UNPROVIDED ), supports );
    ...
    if( NIL == supports )
    {
      ...
      while ( NIL != cdolist_list_var2)
      {
        ...
        {
          supports = ConsesLow.cons( arguments.make_hl_support( $kw0$ISA, el_utilities.make_unary_formula( $const6$not, el_utilities.make_binary_formula( $const4$isa, constant, inclusion_col2 ) ), UNPROVIDED,
              UNPROVIDED ), supports );
  ...
  public static SubLObject kbs_raw_constant_omitted_p(final SubLObject v_term)
  {
    ...
    {
      return Hashtables.gethash( v_term, $kbs_raw_constants_omission_table$.getDynamicValue( thread ), UNPROVIDED );
    }
    return NIL;
  }
  ...
  {
    return list_utilities.tree_find_if( Symbols.symbol_function( $sym7$NON_KBS_RAW_CONSTANT_P ), formula, UNPROVIDED );
  }
  ...
  public static SubLObject reset_kbs_raw_constant_tables()
  {
    ...
    try
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        {
          omission_size = Numbers.add( omission_size, kb_indexing.num_predicate_extent_index( omission_predicate, UNPROVIDED ) );
        }
      ...
      $kbs_raw_constants_table$.setDynamicValue( Hashtables.make_hash_table( inclusion_size, Symbols.symbol_function( EQ ), UNPROVIDED ), thread );
      $kbs_definitional_constant_table$.setDynamicValue( Hashtables.make_hash_table( inclusion_size, Symbols.symbol_function( EQ ), UNPROVIDED ), thread );
      $kbs_raw_constants_omission_table$.setDynamicValue( Hashtables.make_hash_table( omission_size, Symbols.symbol_function( EQ ), UNPROVIDED ), thread );
  ...
  public static SubLObject compute_kbs_raw_constants()
  {
    ...
    try
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        final SubLObject inclusion_constants_hash = Hashtables.make_hash_table( $int10$1000, Symbols.symbol_function( EQ ), UNPROVIDED );
        final SubLObject omission_constants_hash = Hashtables.make_hash_table( $int10$1000, Symbols.symbol_function( EQ ), UNPROVIDED );
        ...
        if( NIL != list_utilities.non_empty_list_p( inclusion_collections ) )
        {
          ...
          while ( NIL != cdolist_list_var_$6)
          {
            ...
            try
            {
              sbhl_module_vars.$sbhl_module$.bind( sbhl_module_vars.get_sbhl_module( $const4$isa ), thread );
              sbhl_marking_vars.$sbhl_gather_space$.bind( sbhl_marking_vars.get_sbhl_marking_space(), thread );
              try
              {
                SubLObject node_var_$9 = node_var;
                final SubLObject deck_type = $kw13$STACK;
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      sbhl_search_vars.$relevant_sbhl_tv_function$.bind( ( NIL != tv_var ) ? $sym14$RELEVANT_SBHL_TV_IS_GENERAL_TV : sbhl_search_vars.$relevant_sbhl_tv_function$.getDynamicValue( thread ), thread );
                      if( NIL != tv_var && NIL != sbhl_paranoia.sbhl_object_type_checking_p() && NIL == sbhl_search_vars.sbhl_true_tv_p( tv_var ) )
                      {
                        final SubLObject pcase_var = sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread );
                        if( pcase_var.eql( $kw15$ERROR ) )
                        {
                          sbhl_paranoia.sbhl_error( ONE_INTEGER, $str16$_A_is_not_a__A, tv_var, $sym17$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                        }
                        else if( pcase_var.eql( $kw18$CERROR ) )
                        {
                          sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str19$continue_anyway, $str16$_A_is_not_a__A, tv_var, $sym17$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                        }
                        else if( pcase_var.eql( $kw20$WARN ) )
                        {
                          Errors.warn( $str16$_A_is_not_a__A, tv_var, $sym17$SBHL_TRUE_TV_P );
                        }
                        else
                        {
                          Errors.warn( $str21$_A_is_not_a_valid__sbhl_type_erro, sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread ) );
                          Errors.cerror( $str19$continue_anyway, $str16$_A_is_not_a__A, tv_var, $sym17$SBHL_TRUE_TV_P );
                        }
                      }
                      ...
                      try
                      {
                        sbhl_search_vars.$sbhl_search_module$.bind( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const4$isa ) ), thread );
                        ...
                        sbhl_search_vars.$sbhl_add_node_to_result_test$.bind( sbhl_module_utilities.get_sbhl_add_node_to_result_test( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars
                            .get_sbhl_module( $const4$isa ) ) ), thread );
                        sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                        sbhl_module_vars.$sbhl_module$.bind( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const4$isa ) ), thread );
                        if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( node_var, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                        {
                          ...
                          try
                          {
                            ...
                            sbhl_link_vars.$sbhl_link_direction$.bind( sbhl_module_utilities.sbhl_search_direction_to_link_direction( sbhl_search_vars.get_sbhl_backward_search_direction(), sbhl_module_utilities
                                .get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const4$isa ) ) ), thread );
                            sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                            ...
                            while ( NIL != node_var_$9)
                            {
                              ...
                              final SubLObject accessible_modules = cdolist_list_var_$7 = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_vars.get_sbhl_module( $const4$isa ) );
                              ...
                              while ( NIL != cdolist_list_var_$7)
                              {
                                ...
                                try
                                {
                                  ...
                                  if( NIL != sbhl_link_vars.sbhl_node_object_p( node ) )
                                  {
                                    ...
                                    if( NIL != d_link )
                                    {
                                      final SubLObject mt_links = sbhl_links.get_sbhl_mt_links( d_link, sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const4$isa ) ),
                                                  ...
                                                  try
                                                  {
                                                    ...
                                                    if( NIL != set.set_p( sol ) )
                                                    {
                                                          ...
                                                          set_contents_var ); NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
                                                      {
                                                        ...
                                                        if( NIL != set_contents.do_set_contents_element_validP( state, constant ) && NIL == sbhl_marking_utilities.sbhl_search_path_termination_p( constant,
                                                            sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) ) )
                                                        {
                                                          ...
                                                          if( NIL != forts.fort_p( constant ) && NIL != constant_handles.constant_p( constant ) )
                                                          {
                                                    ...
                                                    else if( sol.isList() )
                                                    {
                                                      ...
                                                      while ( NIL != csome_list_var)
                                                      {
                                                        if( NIL == sbhl_marking_utilities.sbhl_search_path_termination_p( constant2, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) ) )
                                                        {
                                                          ...
                                                          if( NIL != forts.fort_p( constant2 ) && NIL != constant_handles.constant_p( constant2 ) )
                                                          {
                                  ...
                                  else if( NIL != obsolete.cnat_p( node, UNPROVIDED ) )
                                  {
                                    ...
                                    final SubLObject new_list = cdolist_list_var_$8 = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities
                                        .get_sbhl_module_relevant_naut_link_generators( sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const4$isa ) ),
                                            sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                                        : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const4$isa ) ),
                                            sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) );
                                      ...
                                      try
                                      {
                                        ...
                                        if( NIL != set.set_p( sol2 ) )
                                        {
                                              ...
                                              set_contents_var2 ); NIL == set_contents.do_set_contents_doneP( basis_object2, state2 ); state2 = set_contents.do_set_contents_update_state( state2 ) )
                                          {
                                            ...
                                            if( NIL != set_contents.do_set_contents_element_validP( state2, constant3 ) && NIL == sbhl_marking_utilities.sbhl_search_path_termination_p( constant3,
                                                sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) ) )
                                            {
                                              sbhl_marking_utilities.sbhl_mark_node_marked( constant3, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) );
                                              if( NIL != forts.fort_p( constant3 ) && NIL != constant_handles.constant_p( constant3 ) )
                                              {
                                        ...
                                        else if( sol2.isList() )
                                        {
                                          ...
                                          while ( NIL != csome_list_var3)
                                          {
                                            if( NIL == sbhl_marking_utilities.sbhl_search_path_termination_p( constant4, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) ) )
                                            {
                                              ...
                                              if( NIL != forts.fort_p( constant4 ) && NIL != constant_handles.constant_p( constant4 ) )
                                              {
                              ...
                              final SubLObject accessible_modules2 = cdolist_list_var_$9 = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars
                                  .get_sbhl_module( $const4$isa ) ) );
                              ...
                              while ( NIL != cdolist_list_var_$9)
                              {
                                ...
                                try
                                {
                                  ...
                                  else if( NIL != obsolete.cnat_p( node2, UNPROVIDED ) )
                                  {
                                    ...
                                    final SubLObject new_list2 = cdolist_list_var_$10 = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities
                        ...
                        {
                          sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str25$Node__a_does_not_pass_sbhl_type_t, node_var, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED,
            ...
            {
              if( NIL != constant_handles.constant_p( constant5 ) )
              {
        ...
        else if( NIL != list_utilities.non_empty_list_p( inclusion_sets ) )
        {
          ...
          while ( NIL != cdolist_list_var_$12)
          {
                ...
                .do_set_contents_doneP( basis_object5, state5 ); state5 = set_contents.do_set_contents_update_state( state5 ) )
            {
              ...
              if( NIL != set_contents.do_set_contents_element_validP( state5, constant6 ) && NIL != constant_handles.constant_p( constant6 ) )
              {
        ...
        else if( NIL != list_utilities.non_empty_list_p( kbq_query_sets ) )
        {
            ...
            try
            {
              while ( Hashtables.iteratorHasNext( cdohash_iterator ))
              {
                ...
                else
                {
                  ...
                  SubLObject cdolist_list_var_$14 = list_utilities.find_all_if( $sym26$CONSTANT_P, narts_high.nart_el_formula( v_term ), UNPROVIDED );
        ...
        else
        {
          ...
          final SubLObject mess = $str27$mapping_Cyc_constants;
          ...
          try
          {
            ...
            try
            {
              ...
              if( NIL == id_index.id_index_objects_empty_p( idx_$45, $kw29$SKIP ) )
              {
                final SubLObject idx_$46 = idx_$45;
                if( NIL == id_index.id_index_dense_objects_empty_p( idx_$46, $kw29$SKIP ) )
                {
                  ...
                  for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
                  {
                    ...
                    if( NIL == id_index.id_index_tombstone_p( constant8 ) || NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) )
                    {
                      if( NIL != id_index.id_index_tombstone_p( constant8 ) )
                      {
                        constant8 = $kw29$SKIP;
                      }
                      hash_table_utilities.pushnew_hash( constant8, $const30$CycLConstant, inclusion_constants_hash, UNPROVIDED );
                ...
                if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$47 ) || NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) )
                {
                  ...
                  while ( id2.numL( end_id ))
                  {
                    ...
                    if( NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) || NIL == id_index.id_index_tombstone_p( constant9 ) )
                    {
                      hash_table_utilities.pushnew_hash( constant9, $const30$CycLConstant, inclusion_constants_hash, UNPROVIDED );
                      sofar = Numbers.add( sofar, ONE_INTEGER );
                      utilities_macros.note_percent_progress( sofar, total );
                    }
                      ...
                      if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( node_var, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                      {
                        ...
                        try
                        {
                          ...
                          while ( NIL != node_var_$10)
                          {
                            ...
                            final SubLObject accessible_modules = cdolist_list_var_$16 = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_vars.get_sbhl_module( $const4$isa ) );
                            SubLObject module_var = NIL;
                            ...
                            while ( NIL != cdolist_list_var_$16)
                            {
                              ...
                              try
                              {
                                          ...
                                          iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                      {
                                        ...
                                        if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                                        {
                                          ...
                                          try
                                          {
                                            ...
                                            for( iteration_state_$24 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == dictionary_contents
                                                .do_dictionary_contents_doneP( iteration_state_$24 ); iteration_state_$24 = dictionary_contents.do_dictionary_contents_next( iteration_state_$24 ) )
                                            {
                                              thread.resetMultipleValues();
                                ...
                                else if( NIL != obsolete.cnat_p( node, UNPROVIDED ) )
                                {
                                  ...
                                  final SubLObject new_list = cdolist_list_var_$17 = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities
                                      .get_sbhl_module_relevant_naut_link_generators( sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const4$isa ) ),
                                          sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                                      : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const4$isa ) ),
                                          sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) );
                            ...
                            final SubLObject accessible_modules2 = cdolist_list_var_$18 = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars
                                .get_sbhl_module( $const4$isa ) ) );
                            SubLObject module_var2 = NIL;
                            ...
                            while ( NIL != cdolist_list_var_$18)
                            {
                              ...
                              try
                              {
                                          ...
                                          iteration_state2 ); iteration_state2 = dictionary_contents.do_dictionary_contents_next( iteration_state2 ) )
                                      {
                                        ...
                                        if( NIL != mt_relevance_macros.relevant_mtP( mt3 ) )
                                        {
                                          ...
                                          try
                                          {
                                            ...
                                            for( iteration_state_$25 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links2 ) ); NIL == dictionary_contents
                                                .do_dictionary_contents_doneP( iteration_state_$25 ); iteration_state_$25 = dictionary_contents.do_dictionary_contents_next( iteration_state_$25 ) )
                                            {
                                              thread.resetMultipleValues();
                                ...
                                else if( NIL != obsolete.cnat_p( node2, UNPROVIDED ) )
                                {
                                  ...
                                  final SubLObject new_list2 = cdolist_list_var_$19 = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities
                                      .get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module(
                                          UNPROVIDED ) ) )
                                      : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ),
                                          sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) );
                  ...
                  try
                  {
                    ...
                    while ( NIL == done_var_$85)
                    {
                      ...
                      if( NIL != valid_$87 )
                      {
                        ...
                        if( NIL != constant_handles.constant_p( constant10 ) )
                        {
        ...
        {
          if( NIL != Hashtables.gethash( force_retained_term, omission_constants_hash, UNPROVIDED ) )
          {
            Errors.warn( $str32$Overriding_constant__A_omission__, force_retained_term, Hashtables.gethash( force_retained_term, omission_constants_hash, UNPROVIDED ) );
            Hashtables.remhash( force_retained_term, omission_constants_hash );
          }
          hash_table_utilities.pushnew_hash( force_retained_term, $const33$kbsProfileRetainTerm, inclusion_constants_hash, UNPROVIDED );
        ...
        {
          hash_table_utilities.pushnew_hash( force_excluded_term, $const34$kbsProfileRemoveFORT, omission_constants_hash, UNPROVIDED );
        ...
        try
        {
          while ( Hashtables.iteratorHasNext( cdohash_iterator2 ))
          {
            ...
            final SubLObject exclusion_reason = Hashtables.gethash( constant11, omission_constants_hash, UNPROVIDED );
            if( NIL != exclusion_reason )
            {
              if( NIL == Hashtables.gethash( constant11, $kbs_raw_constants_table$.getDynamicValue( thread ), UNPROVIDED ) && NIL == Hashtables.gethash( constant11, $kbs_raw_constants_omission_table$.getDynamicValue(
                  thread ), UNPROVIDED ) )
              {
                hash_table_utilities.pushnew_hash( constant11, ConsesLow.list( inclusion_reason, exclusion_reason ), $kbs_raw_constants_omission_table$.getDynamicValue( thread ), UNPROVIDED );
                Hashtables.remhash( constant11, $kbs_raw_constants_table$.getDynamicValue( thread ) );
              }
              omission_count = Numbers.add( omission_count, ONE_INTEGER );
            }
            else
            {
              if( NIL != definitional_predicate_set && NIL == Hashtables.gethash( constant11, $kbs_raw_constants_table$.getDynamicValue( thread ), UNPROVIDED ) )
              {
                Hashtables.sethash( constant11, $kbs_definitional_constant_table$.getDynamicValue( thread ), definitional_predicate_set );
              }
              ...
              inclusion_count = Numbers.add( inclusion_count, ONE_INTEGER );
            }
          }
        }
        finally
        ...
        PrintLow.format( T, $str35$___S_constants_included_via_the_c, inclusion_count, inclusion_collections );
        if( NIL != omission_collections || NIL != omission_predicate )
        {
          PrintLow.format( T, $str36$___S_constants_omitted_via_the__A, new SubLObject[] { omission_count, ( NIL != omission_collections ) ? $str37$collections_ : $str38$, ( NIL != omission_predicate )
              ? $str39$_predicate_
              : $str38$, ( NIL != omission_collections ) ? omission_collections : $str38$, ( NIL != omission_predicate ) ? omission_predicate : $str38$
          } );
        }
        cdolist_list_var = cdolist_list_var.rest();
        kbs_section = cdolist_list_var.first();
    ...
    PrintLow.format( T, $str40$___S_total_constants_included___, Hashtables.hash_table_count( $kbs_raw_constants_table$.getDynamicValue( thread ) ) );
    PrintLow.format( T, $str41$___S_total_constants_omitted___, Hashtables.hash_table_count( $kbs_raw_constants_omission_table$.getDynamicValue( thread ) ) );
    if( !$int10$1000.numL( Hashtables.hash_table_count( $kbs_raw_constants_omission_table$.getDynamicValue( thread ) ) ) )
    {
      PrintLow.format( T, $str42$__Omitted_constants__ );
      ...
      try
      {
        while ( Hashtables.iteratorHasNext( cdohash_iterator3 ))
        {
          ...
          PrintLow.format( T, $str43$_A_, constant12 );
        }
      }
      finally
      {
    ...
    try
    {
      while ( Hashtables.iteratorHasNext( cdohash_iterator3 ))
      {
        ...
        if( NIL == Hashtables.gethash( constant12, $kbs_raw_constants_omission_table$.getDynamicValue( thread ), UNPROVIDED ) )
        {
          $kbs_raw_constants$.setDynamicValue( ConsesLow.cons( constant12, $kbs_raw_constants$.getDynamicValue( thread ) ), thread );
        }
      }
    }
    finally
    ...
    PrintLow.format( T, $str45$____S_total_raw_KBS_constants_ide, Sequences.length( $kbs_raw_constants$.getDynamicValue( thread ) ) );
    return $kbs_raw_constants$.getDynamicValue( thread );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $kbs_kbq_query_set_terms_caching_state$.getGlobalValue(), ConsesLow.list( kbq_query_set ), UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return inference_utilities.gather_vocab_required_for_kbq_query_set( ConsesLow.list( $const47$TheSetOf, $sym48$_Q, ConsesLow.list( $const49$thereExists, $sym50$_T, ConsesLow.listS( $const51$and, ConsesLow.list(
        $const4$isa, $sym50$_T, kbq_query_set ), $list52 ) ) ), $int53$300, NIL, StreamsLow.$standard_output$.getDynamicValue( thread ) );
  }
  ...
  public static SubLObject kbs_kbq_query_set_terms(final SubLObject kbq_query_set)
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym46$KBS_KBQ_QUERY_SET_TERMS, $sym54$_KBS_KBQ_QUERY_SET_TERMS_CACHING_STATE_, FIFTEEN_INTEGER, EQL, ONE_INTEGER, ZERO_INTEGER );
    }
    ...
    {
      results = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( kbs_kbq_query_set_terms_internal( kbq_query_set ) ) );
  ...
  public static SubLObject compute_kbs_skolems()
  {
    ...
    try
    {
      ...
      try
      {
        if( NIL == $kbs_raw_constants$.getDynamicValue( thread ) || !$kbs_raw_constants_table$.getDynamicValue( thread ).isHashtable() || !$kbs_raw_constants_omission_table$.getDynamicValue( thread ).isHashtable()
            || !$kbs_definitional_constant_table$.getDynamicValue( thread ).isHashtable() )
        {
          Errors.cerror( $str55$Continue, $str56$compute_kbs_skolems_requirements_ );
        }
        ...
        try
        {
          mt_relevance_macros.$relevant_mt_function$.bind( $sym8$RELEVANT_MT_IS_EVERYTHING, thread );
          mt_relevance_macros.$mt$.bind( $const9$EverythingPSC, thread );
          all_skolems = isa.all_fort_instances( $const57$SkolemFunction, UNPROVIDED, UNPROVIDED );
        }
        finally
        {
          mt_relevance_macros.$mt$.rebind( _prev_bind_2, thread );
        ...
        try
        {
          utilities_macros.$progress_note$.bind( $str58$Computing_KBS_skolems, thread );
          utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
          ...
          try
          {
            ...
            while ( NIL != csome_list_var)
            {
              ...
              {
                kbs_skolems = ConsesLow.cons( skolem, kbs_skolems );
              }
        ...
        PrintLow.format( T, $str60$____S_total_KBS_skolems_identifie, Sequences.length( $kbs_skolems$.getDynamicValue( thread ) ) );
      }
      finally
      {
  ...
  public static SubLObject compute_kbs_skolem_p(final SubLObject skolem)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject result = NIL;
    if( NIL != constant_handles.constant_p( skolem ) )
    {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( NIL != list_utilities.tree_find_if( Symbols.symbol_function( $sym61$KBS_SKOLEM_ASSERTION_FAST_FAIL_CONSTANT_P ), assertions_high.assertion_cons( assertion ), UNPROVIDED ) )
    {
      return NIL;
    }
    thread.resetMultipleValues();
  ...
  {
    return makeBoolean( NIL != constant_handles.constant_p( v_object ) && NIL == kbs_raw_constant_p( v_object ) && NIL == fort_types_interface.skolem_function_p( v_object ) );
  }
  ...
  {
    return makeBoolean( NIL != constant_handles.constant_p( constant ) && NIL == kbs_constant_p( constant ) );
  }
  ...
  public static SubLObject initialize_kbs_constant_table()
  {
    ...
    $kbs_constant_table$.setDynamicValue( keyhash_utilities.keyhash_list_elements( kbs_constants, Symbols.symbol_function( EQ ), UNPROVIDED ), thread );
  ...
  public static SubLObject compute_kbs_constants()
  {
    ...
    $kbs_constants$.setDynamicValue( list_utilities.remove_duplicate_forts( Sequences.cconcatenate( tiny_constants, new SubLObject[] { kbs_raw_constants, kbs_skolems
    } ) ) );
  ...
  {
    return makeBoolean( NIL != kbs_nart_formula_p( narts_high.nart_el_formula( nart ) ) && NIL == list_utilities.member_equalP( nart, kbs_utilities.get_kbs_section_omission_terms( kbs_utilities.get_kbs_sections()
        .first() ) ) && NIL != ( ( NIL != Strings.stringE( $str62$akb, kbs_utilities.get_kbs_name(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) ? makeBoolean( ( NIL == kbs_utilities
            .quoted_isa_enhanced_in_any_mtP( nart, $const63$TKBTerm_Proprietary ) && NIL == isa.isa_in_any_mtP( nart, $const63$TKBTerm_Proprietary ) ) || NIL != kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart,
                $const64$ProprietaryTerm ) || NIL != isa.isa_in_any_mtP( nart, $const64$ProprietaryTerm ) )
            : ( ( NIL != Strings.stringE( $str65$cyfi, kbs_utilities.get_kbs_name(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) ? makeBoolean( NIL != kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart,
                $const66$Cy_FiProprietaryTerm ) || NIL != isa.isa_in_any_mtP( nart, $const66$Cy_FiProprietaryTerm ) || ( NIL == kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart, $const67$ResearchCycConstant )
                    && NIL == isa.isa_in_any_mtP( nart, $const67$ResearchCycConstant ) && NIL == kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart, $const68$ScaffoldingConstant ) && NIL == isa.isa_in_any_mtP( nart,
                        $const68$ScaffoldingConstant ) ) || NIL != kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart, $const64$ProprietaryTerm ) || NIL != isa.isa_in_any_mtP( nart, $const64$ProprietaryTerm )
                || NIL != kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart, $const69$TerroristAgent ) || NIL != isa.isa_in_any_mtP( nart, $const69$TerroristAgent ) || NIL != kbs_utilities
                    .quoted_isa_enhanced_in_any_mtP( nart, $const70$TerroristAct ) || NIL != isa.isa_in_any_mtP( nart, $const70$TerroristAct ) || NIL != kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart,
                        $const71$HostileSocialAction ) || NIL != isa.isa_in_any_mtP( nart, $const71$HostileSocialAction ) )
                : ( ( NIL != Strings.stringE( $str72$research, kbs_utilities.get_kbs_name(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) ? makeBoolean( NIL == kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart,
                    $const64$ProprietaryTerm ) && NIL == isa.isa_in_any_mtP( nart, $const64$ProprietaryTerm ) && NIL == kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart, $const69$TerroristAgent ) && NIL == isa
                        .isa_in_any_mtP( nart, $const69$TerroristAgent ) && NIL == kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart, $const70$TerroristAct ) && NIL == isa.isa_in_any_mtP( nart, $const70$TerroristAct )
                    && NIL == kbs_utilities.quoted_isa_enhanced_in_any_mtP( nart, $const71$HostileSocialAction ) && NIL == isa.isa_in_any_mtP( nart, $const71$HostileSocialAction ) ) : T ) ) ) );
  }
  ...
  {
    return makeBoolean( nart_formula.isCons() && NIL == list_utilities.tree_find_if( Symbols.symbol_function( $sym73$NON_KBS_CONSTANT_P ), nart_formula, UNPROVIDED ) );
  }
  ...
  public static SubLObject compute_kbs_narts()
  {
    ...
    final SubLObject mess = $str74$Computing_KBS_narts;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = ZERO_INTEGER;
    assert NIL != Types.stringp( mess ) : mess;
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL == id_index.id_index_objects_empty_p( idx_$96, $kw29$SKIP ) )
        {
          final SubLObject idx_$97 = idx_$96;
          if( NIL == id_index.id_index_dense_objects_empty_p( idx_$97, $kw29$SKIP ) )
          {
            ...
            for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
            {
              ...
              if( NIL == id_index.id_index_tombstone_p( nart ) || NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) )
              {
          ...
          if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$98 ) || NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) )
          {
            ...
            while ( id2.numL( end_id ))
            {
              ...
              if( NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) || NIL == id_index.id_index_tombstone_p( nart2 ) )
              {
                if( NIL != kbs_nart_p( nart2 ) )
                {
                  narts = ConsesLow.cons( nart2, narts );
                }
                sofar = Numbers.add( sofar, ONE_INTEGER );
                utilities_macros.note_percent_progress( sofar, total );
              }
    ...
    PrintLow.format( T, $str75$____S_total_KBS_NARTs_identified_, Sequences.length( $kbs_narts$.getDynamicValue( thread ) ) );
    return NIL;
  }
  ...
  public static SubLObject why_kbs_fortP(final SubLObject fort)
  {
    ...
    {
      supports = ConsesLow.cons( $str76$All_KB_subset_requirements_met_, supports );
    }
    final SubLObject splicing_gafs = kbs_add_redundant.kbs_additional_redundant_definitional_info( fort );
    if( NIL != splicing_gafs )
    {
      supports = ConsesLow.cons( $str38$, supports );
      supports = ConsesLow.cons( $str77$Also__the_following_GAFs_will_be_, supports );
      ...
      while ( NIL != cdolist_list_var2)
      {
        ...
        supports = ConsesLow.cons( arguments.make_hl_support( $kw78$OPAQUE, formula, mt, UNPROVIDED ), supports );
        cdolist_list_var2 = cdolist_list_var2.rest();
        splicing_gaf = cdolist_list_var2.first();
      }
    }
  ...
  public static SubLObject why_non_kbs_fortP(final SubLObject fort)
  {
    ...
    final SubLObject fort_non_forts = list_utilities.remove_duplicate_forts( list_utilities.tree_find_all_if( $sym79$NON_KBS_FORT_P, fort_el_formula, UNPROVIDED ) );
    SubLObject supports = NIL;
    supports = ConsesLow.cons( $str80$The_term_contains_terms_not_in_th, supports );
    SubLObject cdolist_list_var = fort_non_forts;
    SubLObject fort_non_fort = NIL;
    fort_non_fort = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      supports = ConsesLow.cons( fort_non_fort, supports );
      cdolist_list_var = cdolist_list_var.rest();
      fort_non_fort = cdolist_list_var.first();
    }
    return Sequences.nreverse( supports );
  ...
  public static SubLObject kbs_definitional_fort_p(final SubLObject fort)
  {
    ...
    {
      return list_utilities.tree_find_if( $sym81$KBS_DEFINITIONAL_FORT_P, narts_high.nart_el_formula( fort ), UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject initialize_kbs_fort_table()
  {
    ...
    $kbs_fort_table$.setDynamicValue( keyhash_utilities.keyhash_list_elements( kbs_forts, Symbols.symbol_function( EQ ), UNPROVIDED ), thread );
  ...
  public static SubLObject unmark_kbs_fort_and_dependents(final SubLObject fort)
  {
    ...
    if( NIL != kbs_fort_p( fort ) )
    {
      ...
      fort_count = Numbers.add( fort_count, ONE_INTEGER );
  ...
  public static SubLObject compute_kbs_forts()
  {
    ...
    $kbs_forts$.setDynamicValue( Sequences.cconcatenate( kbs_constants, kbs_narts ) );
  ...
  public static SubLObject kbs_definitional_constant_predicate_sets(final SubLObject constant)
  {
    ...
    {
      return Hashtables.gethash( constant, $kbs_definitional_constant_table$.getDynamicValue( thread ), UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject kbs_definitional_fort_predicate_sets(final SubLObject fort)
  {
    ...
    if( NIL != nart_handles.nart_p( fort ) )
    {
      return list_utilities.remove_duplicate_forts( Sequences.remove_if( Symbols.symbol_function( $sym82$NULL ), Mapping.mapcar( $sym83$KBS_DEFINITIONAL_FORT_PREDICATE_SETS, narts_high.nart_hl_formula( fort ) ),
  ...
  {
    return makeBoolean( NIL != constant_handles.constant_p( constant ) && NIL == kbs_definitional_constant_predicate_sets( constant ) );
  }
  ...
  public static SubLObject tree_gather_relevant_kbs_definitional_predicate_sets(final SubLObject tree)
  {
    ...
    {
      final SubLObject tree_forts = list_utilities.fast_delete_duplicates( list_utilities.tree_gather( tree, $sym84$FORT_P, UNPROVIDED, UNPROVIDED, UNPROVIDED ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED,
          UNPROVIDED );
      final SubLObject predicate_sets_list = Sequences.remove_if( Symbols.symbol_function( $sym82$NULL ), Mapping.mapcar( $sym83$KBS_DEFINITIONAL_FORT_PREDICATE_SETS, tree_forts ), UNPROVIDED, UNPROVIDED, UNPROVIDED,
          UNPROVIDED );
      final SubLObject relevant_predicate_sets = list_utilities.fast_delete_duplicates( list_utilities.tree_gather( predicate_sets_list, $sym84$FORT_P, UNPROVIDED, UNPROVIDED, UNPROVIDED ), UNPROVIDED, UNPROVIDED,
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != kbs_definitional_predicate_set_p( predicate_set1 ) : predicate_set1;
    assert NIL != kbs_definitional_predicate_set_p( predicate_set2 ) : predicate_set2;
    return Numbers.numG( Sequences.position( predicate_set1, $kbs_ordered_definitional_predicate_sets$.getDynamicValue( thread ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), Sequences.position( predicate_set2,
        $kbs_ordered_definitional_predicate_sets$.getDynamicValue( thread ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject kbs_predicate_definitional_predicate_sets(final SubLObject predicate)
  {
    ...
    {
      return Hashtables.gethash( predicate, $kbs_definitional_predicate_table$.getDynamicValue( thread ), UNPROVIDED );
    }
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return list_utilities.sublisp_boolean( Hashtables.gethash_without_values( v_object, $kbs_definitional_predicate_table$.getDynamicValue( thread ), NIL ) );
  }
  ...
  {
    $kbs_definitional_predicate_table$.setDynamicValue( Hashtables.make_hash_table( $int10$1000, Symbols.symbol_function( EQUAL ), UNPROVIDED ) );
    return NIL;
  }
  ...
  public static SubLObject initialize_kbs_definitional_predicate_table()
  {
    ...
    try
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        if( NIL != definitional_predicate_set )
        {
          ...
          if( NIL == conses_high.member( item_var, $kbs_ordered_definitional_predicate_sets$.getDynamicValue( thread ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
          {
            $kbs_ordered_definitional_predicate_sets$.setDynamicValue( ConsesLow.cons( item_var, $kbs_ordered_definitional_predicate_sets$.getDynamicValue( thread ) ), thread );
          }
          ...
          {
            final SubLObject old_value = Hashtables.gethash( definitional_predicate, $kbs_definitional_predicate_table$.getDynamicValue( thread ), UNPROVIDED );
            final SubLObject new_value = ConsesLow.cons( definitional_predicate_set, old_value );
            Hashtables.sethash( definitional_predicate, $kbs_definitional_predicate_table$.getDynamicValue( thread ), new_value );
    ...
    return Hashtables.hash_table_count( $kbs_definitional_predicate_table$.getDynamicValue( thread ) );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return Hashtables.gethash( rule, $kbs_definitional_rule_table$.getDynamicValue( thread ), UNPROVIDED );
  }
  ...
  {
    $kbs_definitional_rule_table$.setDynamicValue( Hashtables.make_hash_table( $int10$1000, Symbols.symbol_function( EQ ), UNPROVIDED ) );
    return NIL;
  }
  ...
  public static SubLObject initialize_kbs_definitional_rule_table()
  {
                  ...
                  try
                  {
                    ...
                    while ( NIL == done_var_$106)
                    {
                      ...
                      if( NIL != valid_$108 )
                      {
                        ...
                        final SubLObject old_value = Hashtables.gethash( rule_assertion, $kbs_definitional_rule_table$.getDynamicValue( thread ), UNPROVIDED );
                        final SubLObject new_value = ConsesLow.cons( definitional_predicate_set, old_value );
                        Hashtables.sethash( rule_assertion, $kbs_definitional_rule_table$.getDynamicValue( thread ), new_value );
                      }
    ...
    return Hashtables.hash_table_count( $kbs_definitional_rule_table$.getDynamicValue( thread ) );
  }
  ...
  public static SubLObject why_non_kbs_assertionP(final SubLObject assertion)
  {
    if( NIL != assertion_handles.assertion_p( assertion ) )
    {
      ...
      {
        supports = ConsesLow.cons( $str87$The_assertion_s_microtheory_is_no, supports );
      ...
      else if( NIL != subl_promotions.memberP( assertion, kbs_utilities.get_kbs_section_omission_assertions( kbs_utilities.get_kbs_sections().first() ), UNPROVIDED, UNPROVIDED ) )
      {
        supports = ConsesLow.cons( $str88$The_assertion_was_explicitly_omit, supports );
      }
      else
      {
        final SubLObject non_kbs_forts_in_cnf = list_utilities.remove_duplicate_forts( list_utilities.tree_find_all_if( Symbols.symbol_function( $sym79$NON_KBS_FORT_P ), cnf, UNPROVIDED ) );
        if( NIL != non_kbs_forts_in_cnf )
        {
          supports = ConsesLow.cons( $str89$The_assertion_s_formula_contains_, supports );
        ...
        else if( NIL != assertions_high.gaf_assertionP( assertion ) )
        {
          ...
          {
            supports = ConsesLow.cons( $str90$The_assertion_is_definitional_bec, supports );
            if( NIL != predicate_predicate_sets )
            {
              supports = ConsesLow.cons( $str91$__The_predicate_is_definitional_, supports );
              ...
              {
                supports = ConsesLow.cons( arguments.make_hl_support( $kw0$ISA, el_utilities.make_binary_formula( $const4$isa, predicate, predicate_predicate_set ), UNPROVIDED, UNPROVIDED ), supports );
            ...
            {
              supports = ConsesLow.cons( $str92$__The_predicate_is_not_definition, supports );
            }
            supports = ConsesLow.cons( $str93$__But_the_assertion_contains_defi, supports );
            ...
            while ( NIL != cdolist_list_var3)
            {
              supports = ConsesLow.cons( assertion_predicate_set, supports );
              cdolist_list_var3 = cdolist_list_var3.rest();
              assertion_predicate_set = cdolist_list_var3.first();
            }
          }
        ...
        else
        {
          ...
          supports = ConsesLow.cons( $str94$The_assertion_is_a_rule_containin, supports );
          ...
          {
            supports = ConsesLow.cons( assertion_predicate_set2, supports );
  ...
  public static SubLObject initialize_kbs_assertion_table(final SubLObject kbs_assertions)
  {
    ...
    $kbs_assertion_table$.setDynamicValue( keyhash_utilities.keyhash_list_elements( kbs_assertions, Symbols.symbol_function( EQ ), UNPROVIDED ), thread );
  ...
  public static SubLObject compute_kbs_assertions()
  {
    ...
    final SubLObject mess = $str95$Computing_KBS_assertions;
    final SubLObject total = id_index.id_index_count( idx );
    SubLObject sofar = ZERO_INTEGER;
    assert NIL != Types.stringp( mess ) : mess;
    final SubLObject _prev_bind_0 = utilities_macros.$last_percent_progress_index$.currentBinding( thread );
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL == id_index.id_index_objects_empty_p( idx_$111, $kw29$SKIP ) )
        {
          final SubLObject idx_$112 = idx_$111;
          if( NIL == id_index.id_index_dense_objects_empty_p( idx_$112, $kw29$SKIP ) )
          {
          ...
          if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$113 ) || NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) )
          {
  ...
  public static SubLObject compute_kbs_assertion_p(final SubLObject assertion)
  {
    ...
    try
    {
      ...
      if( NIL != assertion_handles.assertion_p( assertion ) )
      {
        ...
        if( NIL != assertions_high.gaf_assertionP( assertion ) && ( NIL != genl_predicates.any_genl_predP( assertions_high.gaf_predicate( assertion ), kbs_utilities.get_kbs_section_omission_predicate_extent(
            kbs_utilities.get_kbs_sections().first() ), UNPROVIDED, UNPROVIDED ) || NIL != genl_predicates.any_genl_inverseP( assertions_high.gaf_predicate( assertion ), kbs_utilities
                .get_kbs_section_omission_predicate_extent( kbs_utilities.get_kbs_sections().first() ), UNPROVIDED, UNPROVIDED ) ) && NIL == subl_promotions.memberP( assertion, kbs_utilities
                    .get_kbs_section_retained_assertions( kbs_utilities.get_kbs_sections().first() ), UNPROVIDED, UNPROVIDED ) )
        {
          v_answer = NIL;
        }
  ...
  public static SubLObject kbs_assertion_references_excluded_termsP(final SubLObject assertion)
  {
    final SubLObject mt = assertions_high.assertion_mt( assertion );
    final SubLObject cnf = assertions_high.assertion_cnf( assertion );
    return makeBoolean( NIL != non_kbs_fort_p( mt ) || NIL != list_utilities.tree_find_if( Symbols.symbol_function( $sym79$NON_KBS_FORT_P ), cnf, UNPROVIDED ) || NIL != ( ( NIL != forts.fort_p( mt ) ) ? non_kbs_fort_p(
        mt ) : list_utilities.tree_find_if( Symbols.symbol_function( $sym79$NON_KBS_FORT_P ), mt, UNPROVIDED ) ) || NIL != list_utilities.tree_find_if( Symbols.symbol_function( $sym96$COMPUTE_NON_KBS_ASSERTION_P ), cnf,
            UNPROVIDED ) );
  }
  ...
  public static SubLObject kbs_definitionally_restricted_assertionP(final SubLObject assertion)
  {
    ...
    final SubLObject mt = assertions_high.assertion_mt( assertion );
    final SubLObject cnf = assertions_high.assertion_cnf( assertion );
    if( NIL == list_utilities.tree_find_if( $sym81$KBS_DEFINITIONAL_FORT_P, cnf, UNPROVIDED ) )
    {
      return NIL;
    }
    final SubLObject assertion_predicate_sets = tree_gather_relevant_kbs_definitional_predicate_sets( cnf );
  ...
  public static SubLObject initialize_kbs_deduction_table(final SubLObject kbs_deductions)
  {
    ...
    $kbs_deduction_table$.setDynamicValue( keyhash_utilities.keyhash_list_elements( kbs_deductions, Symbols.symbol_function( EQ ), UNPROVIDED ), thread );
  ...
  public static SubLObject compute_kbs_deductions()
  {
    ...
    try
    {
      utilities_macros.$progress_note$.bind( $str97$Computing_KBS_deductions, thread );
      utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
      utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
      utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
      utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
      ...
      try
      {
        ...
        while ( NIL != csome_list_var)
        {
          ...
          while ( NIL != cdolist_list_var)
          {
            ...
            {
              deductions = ConsesLow.cons( argument, deductions );
            }
            cdolist_list_var = cdolist_list_var.rest();
            argument = cdolist_list_var.first();
          }
  ...
  public static SubLObject compute_kbs_support_p(final SubLObject support)
  {
    if( NIL != arguments.support_p( support ) )
    {
      ...
      if( NIL == non_kbs_fort_p( mt ) && NIL == kbs_raw_constant_omitted_p( mt ) )
      {
        ...
        if( NIL == list_utilities.tree_find_if( Symbols.symbol_function( $sym79$NON_KBS_FORT_P ), formula, UNPROVIDED ) && NIL == list_utilities.tree_find_if( Symbols.symbol_function( $sym98$KBS_RAW_CONSTANT_OMITTED_P ),
            formula, UNPROVIDED ) )
        {
          return T;
        }
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != forts.fort_p( preremoved_assertion_identifying_predicate ) )
      {
        ...
        try
        {
          ...
          if( NIL != kb_mapping_macros.do_predicate_extent_index_key_validator( pred_var ) )
          {
            final SubLObject str = Sequences.cconcatenate( $str100$Preremoving_, new SubLObject[] { format_nil.format_nil_s_no_copy( predicate ), $str101$_assertions
            } );
      ...
      else if( NIL != el_utilities.kappa_predicate_p( preremoved_assertion_identifying_predicate ) )
      {
        final SubLObject kappa = preremoved_assertion_identifying_predicate;
        if( NIL == Errors.$ignore_mustsP$.getDynamicValue( thread ) && !ONE_INTEGER.numE( el_utilities.kappa_predicate_arity( kappa ) ) )
        {
          Errors.error( $str102$Only_unary_KAPPA_predicates_suppo, kappa );
        }
        SubLObject assertions = NIL;
        final SubLObject str2 = Sequences.cconcatenate( $str103$Identifying_, new SubLObject[] { format_nil.format_nil_s_no_copy( kappa ), $str101$_assertions
        } );
        ...
        else
        {
          ...
          try
          {
            utilities_macros.$progress_note$.bind( ( NIL != Sequences.cconcatenate( $str100$Preremoving_, new SubLObject[] { format_nil.format_nil_a_no_copy( Sequences.length( assertions ) ),
              $str106$_assertions_indentified_by_Kappa_
            } ) ) ? Sequences.cconcatenate( $str100$Preremoving_, new SubLObject[] { format_nil.format_nil_a_no_copy( Sequences.length( assertions ) ), $str106$_assertions_indentified_by_Kappa_
            } ) : $str59$cdolist, thread );
            utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
            utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
            utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
            utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
  ...
  public static SubLObject kbs_get_kappa_specified_assertions(final SubLObject kappa)
  {
    ...
    final SubLObject v_bindings = ask_utilities.query_variable( variable, query, $const2$InferencePSC, $kbs_kappa_query_settings$.getDynamicValue( thread ) );
    return v_bindings;
  }
  ...
  public static SubLObject kbs_handle_preremoved_assertion(final SubLObject a, SubLObject pred)
  {
    ...
    {
      Errors.warn( $str109$Killing__A_assertion_for_KB_subse, ( NIL != forts.fort_p( pred ) ) ? pred : $str110$an, a );
  ...
  public static SubLObject perform_limitation_motivated_post_identify_cleanups()
  {
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL == id_index.id_index_objects_empty_p( idx_$124, $kw29$SKIP ) )
        {
          final SubLObject idx_$125 = idx_$124;
          if( NIL == id_index.id_index_dense_objects_empty_p( idx_$125, $kw29$SKIP ) )
          {
            ...
            for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
            {
              ...
              if( NIL == id_index.id_index_tombstone_p( n ) || NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) )
              {
                if( NIL != id_index.id_index_tombstone_p( n ) )
                {
                  n = $kw29$SKIP;
                }
                formula = narts_high.nart_hl_formula( n );
                if( NIL != list_utilities.tree_find_if( Symbols.symbol_function( $sym114$ASSERTION_P ), cycl_utilities.el_formula_args( formula, UNPROVIDED ), UNPROVIDED ) )
                {
                  unmark_kbs_fort( n );
                  bad_narts = Numbers.add( bad_narts, ONE_INTEGER );
          ...
          if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$126 ) || NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) )
          {
            ...
            while ( id2.numL( end_id ))
            {
              ...
              if( NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) || NIL == id_index.id_index_tombstone_p( n2 ) )
              {
                final SubLObject formula2 = narts_high.nart_hl_formula( n2 );
                if( NIL != list_utilities.tree_find_if( Symbols.symbol_function( $sym114$ASSERTION_P ), cycl_utilities.el_formula_args( formula2, UNPROVIDED ), UNPROVIDED ) )
                {
                  unmark_kbs_fort( n2 );
                  bad_narts = Numbers.add( bad_narts, ONE_INTEGER );
  ...
  public static SubLObject kbs_statistics(SubLObject stream)
  {
    ...
    PrintLow.format( stream, $str132$______KB__S_KBS_statistics__, control_vars.kb_loaded() );
    PrintLow.format( stream, $str133$__FORTs___________7___D__, fort_count );
    PrintLow.format( stream, $str134$___Constants______7___D__, constant_count );
    if( definitional_constant_count.isPositive() )
    {
      PrintLow.format( stream, $str135$_____def_only_____7___D__, definitional_constant_count );
    }
    PrintLow.format( stream, $str136$___NARTs__________7___D__, nart_count );
    PrintLow.format( stream, $str137$__Assertions______7___D__, assertion_count );
    PrintLow.format( stream, $str138$__Deductions______7___D__, deduction_count );
  ...
  public static SubLObject kbs_definitional_constant_count()
  {
    ...
    {
      return Hashtables.hash_table_count( $kbs_definitional_constant_table$.getDynamicValue( thread ) );
    }
    return ZERO_INTEGER;
  }
  ...
  public static SubLObject count_all_kbs_assertions_in_mt(final SubLObject mt, SubLObject type)
  {
    ...
    else if( pcase_var.eql( $kw142$BROAD_MT ) && NIL != kb_mapping_macros.do_broad_mt_index_key_validator( function_terms.naut_to_nart( mt ), type ) )
    {
      final SubLObject idx = assertion_handles.do_assertions_table();
      ...
      try
      {
        ...
        try
        {
          ...
          if( NIL == id_index.id_index_objects_empty_p( idx_$130, $kw29$SKIP ) )
          {
            final SubLObject idx_$131 = idx_$130;
            if( NIL == id_index.id_index_dense_objects_empty_p( idx_$131, $kw29$SKIP ) )
            {
            ...
            if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$132 ) || NIL == id_index.id_index_skip_tombstones_p( $kw29$SKIP ) )
            {
  ...
  {
    SubLFiles.declareFunction( me, "kbs_raw_constants", "KBS-RAW-CONSTANTS", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_raw_constant_p", "KBS-RAW-CONSTANT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "why_kbs_raw_constantP", "WHY-KBS-RAW-CONSTANT?", 1, 0, false );
    SubLFiles.declareFunction( me, "non_kbs_raw_constant_p", "NON-KBS-RAW-CONSTANT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "why_non_kbs_raw_constantP", "WHY-NON-KBS-RAW-CONSTANT?", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_raw_constant_omitted_p", "KBS-RAW-CONSTANT-OMITTED-P", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_raw_el_formula_p", "KBS-RAW-EL-FORMULA-P", 1, 0, false );
    SubLFiles.declareFunction( me, "non_kbs_raw_el_formula_p", "NON-KBS-RAW-EL-FORMULA-P", 1, 0, false );
    SubLFiles.declareFunction( me, "reset_kbs_raw_constant_tables", "RESET-KBS-RAW-CONSTANT-TABLES", 0, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_raw_constants", "COMPUTE-KBS-RAW-CONSTANTS", 0, 0, false );
    SubLFiles.declareFunction( me, "clear_kbs_kbq_query_set_terms", "CLEAR-KBS-KBQ-QUERY-SET-TERMS", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_kbs_kbq_query_set_terms", "REMOVE-KBS-KBQ-QUERY-SET-TERMS", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_kbq_query_set_terms_internal", "KBS-KBQ-QUERY-SET-TERMS-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_kbq_query_set_terms", "KBS-KBQ-QUERY-SET-TERMS", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_skolems", "KBS-SKOLEMS", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_skolem_p", "KBS-SKOLEM-P", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_skolems", "COMPUTE-KBS-SKOLEMS", 0, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_skolem_p", "COMPUTE-KBS-SKOLEM-P", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_skolem_assertion_p", "COMPUTE-KBS-SKOLEM-ASSERTION-P", 2, 0, false );
    SubLFiles.declareFunction( me, "kbs_skolem_assertion_fast_fail_constant_p", "KBS-SKOLEM-ASSERTION-FAST-FAIL-CONSTANT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_constants", "KBS-CONSTANTS", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_constant_p", "KBS-CONSTANT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "non_kbs_constant_p", "NON-KBS-CONSTANT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_kbs_constant_table", "INITIALIZE-KBS-CONSTANT-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_constants", "COMPUTE-KBS-CONSTANTS", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_narts", "KBS-NARTS", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_nart_p", "KBS-NART-P", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_nart_formula_p", "KBS-NART-FORMULA-P", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_narts", "COMPUTE-KBS-NARTS", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_forts", "KBS-FORTS", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_fort_p", "KBS-FORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "why_kbs_fortP", "WHY-KBS-FORT?", 1, 0, false );
    SubLFiles.declareFunction( me, "non_kbs_fort_p", "NON-KBS-FORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "why_non_kbs_fortP", "WHY-NON-KBS-FORT?", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_definitional_fort_p", "KBS-DEFINITIONAL-FORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "non_kbs_definitional_fort_p", "NON-KBS-DEFINITIONAL-FORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_kbs_fort_table", "INITIALIZE-KBS-FORT-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "unmark_kbs_fort", "UNMARK-KBS-FORT", 1, 0, false );
    SubLFiles.declareFunction( me, "unmark_kbs_fort_and_dependents", "UNMARK-KBS-FORT-AND-DEPENDENTS", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_forts", "COMPUTE-KBS-FORTS", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_definitional_constant_predicate_sets", "KBS-DEFINITIONAL-CONSTANT-PREDICATE-SETS", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_definitional_fort_predicate_sets", "KBS-DEFINITIONAL-FORT-PREDICATE-SETS", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_definitional_constant_p", "KBS-DEFINITIONAL-CONSTANT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "non_kbs_definitional_constant_p", "NON-KBS-DEFINITIONAL-CONSTANT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "tree_gather_relevant_kbs_definitional_predicate_sets", "TREE-GATHER-RELEVANT-KBS-DEFINITIONAL-PREDICATE-SETS", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_definitional_predicate_set_p", "KBS-DEFINITIONAL-PREDICATE-SET-P", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_definitional_predicate_setL", "KBS-DEFINITIONAL-PREDICATE-SET<", 2, 0, false );
    SubLFiles.declareFunction( me, "kbs_predicate_definitional_predicate_sets", "KBS-PREDICATE-DEFINITIONAL-PREDICATE-SETS", 1, 0, false );
    SubLFiles.declareFunction( me, "all_kbs_definitional_predicates", "ALL-KBS-DEFINITIONAL-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_definitional_predicate_p", "KBS-DEFINITIONAL-PREDICATE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_kbs_definitional_predicate_table", "CLEAR-KBS-DEFINITIONAL-PREDICATE-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_kbs_definitional_predicate_table", "INITIALIZE-KBS-DEFINITIONAL-PREDICATE-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_definitional_predicates", "COMPUTE-KBS-DEFINITIONAL-PREDICATES", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_rule_definitional_predicate_sets", "KBS-RULE-DEFINITIONAL-PREDICATE-SETS", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_kbs_definitional_rule_table", "CLEAR-KBS-DEFINITIONAL-RULE-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_kbs_definitional_rule_table", "INITIALIZE-KBS-DEFINITIONAL-RULE-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_definitional_rules", "COMPUTE-KBS-DEFINITIONAL-RULES", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_assertion_table", "KBS-ASSERTION-TABLE", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_assertion_p", "KBS-ASSERTION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "why_kbs_assertionP", "WHY-KBS-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "non_kbs_assertion_p", "NON-KBS-ASSERTION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "why_non_kbs_assertionP", "WHY-NON-KBS-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_kbs_assertion_table", "INITIALIZE-KBS-ASSERTION-TABLE", 1, 0, false );
    SubLFiles.declareFunction( me, "mark_kbs_assertion", "MARK-KBS-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "unmark_kbs_assertion", "UNMARK-KBS-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_assertions", "COMPUTE-KBS-ASSERTIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_assertion_p", "COMPUTE-KBS-ASSERTION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_non_kbs_assertion_p", "COMPUTE-NON-KBS-ASSERTION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_assertion_references_excluded_termsP", "KBS-ASSERTION-REFERENCES-EXCLUDED-TERMS?", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_definitionally_restricted_assertionP", "KBS-DEFINITIONALLY-RESTRICTED-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_deduction_p", "KBS-DEDUCTION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "non_kbs_deduction_p", "NON-KBS-DEDUCTION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_kbs_deduction_table", "INITIALIZE-KBS-DEDUCTION-TABLE", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_deductions", "COMPUTE-KBS-DEDUCTIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_deduction_p", "COMPUTE-KBS-DEDUCTION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_kbs_support_p", "COMPUTE-KBS-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_fort_state_validP", "KBS-FORT-STATE-VALID?", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_state_validP", "KBS-STATE-VALID?", 0, 0, false );
    SubLFiles.declareFunction( me, "prepare_kbs_kb_destructive", "PREPARE-KBS-KB-DESTRUCTIVE", 0, 1, false );
    SubLFiles.declareFunction( me, "kbs_get_kappa_specified_assertions", "KBS-GET-KAPPA-SPECIFIED-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "kbs_handle_preremoved_assertion", "KBS-HANDLE-PREREMOVED-ASSERTION", 1, 1, false );
    SubLFiles.declareFunction( me, "do_prerun_kbs_fns", "DO-PRERUN-KBS-FNS", 0, 0, false );
    SubLFiles.declareFunction( me, "identify_kbs_forts_and_assertions", "IDENTIFY-KBS-FORTS-AND-ASSERTIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "identify_kbs_forts", "IDENTIFY-KBS-FORTS", 0, 0, false );
    SubLFiles.declareFunction( me, "do_post_identify_kbs_forts_fns", "DO-POST-IDENTIFY-KBS-FORTS-FNS", 0, 0, false );
    SubLFiles.declareFunction( me, "perform_limitation_motivated_post_identify_cleanups", "PERFORM-LIMITATION-MOTIVATED-POST-IDENTIFY-CLEANUPS", 0, 0, false );
    SubLFiles.declareFunction( me, "identify_kbs_assertions", "IDENTIFY-KBS-ASSERTIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "do_post_identify_kbs_assertions_fns", "DO-POST-IDENTIFY-KBS-ASSERTIONS-FNS", 0, 0, false );
    SubLFiles.declareFunction( me, "identify_kbs_deductions", "IDENTIFY-KBS-DEDUCTIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "clear_kbs_state", "CLEAR-KBS-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "why_kbs_state_invalidP", "WHY-KBS-STATE-INVALID?", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_statistics", "KBS-STATISTICS", 0, 1, false );
    SubLFiles.declareFunction( me, "kbs_fort_count", "KBS-FORT-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_constant_count", "KBS-CONSTANT-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_nart_count", "KBS-NART-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_definitional_constant_count", "KBS-DEFINITIONAL-CONSTANT-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_assertion_count", "KBS-ASSERTION-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "kbs_deduction_count", "KBS-DEDUCTION-COUNT", 0, 0, false );
    SubLFiles.declareFunction( me, "count_all_kbs_assertions_in_mt", "COUNT-ALL-KBS-ASSERTIONS-IN-MT", 1, 1, false );
    return NIL;
  }

  public static SubLObject init_kbs_identification_file()
  {
    $kbs_raw_constants$ = SubLFiles.defvar( "*KBS-RAW-CONSTANTS*", NIL );
    $kbs_raw_constants_table$ = SubLFiles.defvar( "*KBS-RAW-CONSTANTS-TABLE*", NIL );
    $kbs_raw_constants_omission_table$ = SubLFiles.defvar( "*KBS-RAW-CONSTANTS-OMISSION-TABLE*", NIL );
    $kbs_definitional_constant_table$ = SubLFiles.defvar( "*KBS-DEFINITIONAL-CONSTANT-TABLE*", NIL );
    $kbs_kbq_query_set_terms_caching_state$ = SubLFiles.deflexical( "*KBS-KBQ-QUERY-SET-TERMS-CACHING-STATE*", NIL );
    $kbs_skolems$ = SubLFiles.defvar( "*KBS-SKOLEMS*", NIL );
    $kbs_constants$ = SubLFiles.defvar( "*KBS-CONSTANTS*", NIL );
    $kbs_constant_table$ = SubLFiles.defvar( "*KBS-CONSTANT-TABLE*", Hashtables.make_hash_table( $int10$1000, Symbols.symbol_function( EQ ), UNPROVIDED ) );
    $kbs_narts$ = SubLFiles.defvar( "*KBS-NARTS*", NIL );
    $kbs_forts$ = SubLFiles.defvar( "*KBS-FORTS*", NIL );
    $kbs_fort_table$ = SubLFiles.defvar( "*KBS-FORT-TABLE*", NIL );
    $kbs_ordered_definitional_predicate_sets$ = SubLFiles.defvar( "*KBS-ORDERED-DEFINITIONAL-PREDICATE-SETS*", NIL );
    $kbs_definitional_predicate_table$ = SubLFiles.defvar( "*KBS-DEFINITIONAL-PREDICATE-TABLE*", NIL );
    $kbs_definitional_rule_table$ = SubLFiles.defvar( "*KBS-DEFINITIONAL-RULE-TABLE*", NIL );
    $kbs_assertion_table$ = SubLFiles.defvar( "*KBS-ASSERTION-TABLE*", NIL );
    $kbs_deduction_table$ = SubLFiles.defvar( "*KBS-DEDUCTION-TABLE*", NIL );
    $kbs_fort_state_validP$ = SubLFiles.defvar( "*KBS-FORT-STATE-VALID?*", NIL );
    $kbs_state_validP$ = SubLFiles.defvar( "*KBS-STATE-VALID?*", NIL );
    $default_kbs_kappa_query_settings$ = SubLFiles.deflexical( "*DEFAULT-KBS-KAPPA-QUERY-SETTINGS*", $list99 );
    $kbs_kappa_query_settings$ = SubLFiles.defparameter( "*KBS-KAPPA-QUERY-SETTINGS*", $default_kbs_kappa_query_settings$.getGlobalValue() );
    return NIL;
  }

  public static SubLObject setup_kbs_identification_file()
  {
    memoization_state.note_globally_cached_function( $sym46$KBS_KBQ_QUERY_SET_TERMS );
    return NIL;
  }
  ...
  static
  {
    me = new kbs_identification();
    $kbs_raw_constants$ = null;
    $kbs_raw_constants_table$ = null;
    $kbs_raw_constants_omission_table$ = null;
    $kbs_definitional_constant_table$ = null;
    $kbs_kbq_query_set_terms_caching_state$ = null;
    $kbs_skolems$ = null;
    $kbs_constants$ = null;
    $kbs_constant_table$ = null;
    $kbs_narts$ = null;
    $kbs_forts$ = null;
    $kbs_fort_table$ = null;
    $kbs_ordered_definitional_predicate_sets$ = null;
    $kbs_definitional_predicate_table$ = null;
    $kbs_definitional_rule_table$ = null;
    $kbs_assertion_table$ = null;
    $kbs_deduction_table$ = null;
    $kbs_fort_state_validP$ = null;
    $kbs_state_validP$ = null;
    $default_kbs_kappa_query_settings$ = null;
    $kbs_kappa_query_settings$ = null;
    $kw0$ISA = makeKeyword( "ISA" );
    $const1$quotedIsa = constant_handles.reader_make_constant_shell( makeString( "quotedIsa" ) );
    $const2$InferencePSC = constant_handles.reader_make_constant_shell( makeString( "InferencePSC" ) );
    $str3$Even_though_explicitly_included_v = makeString( "Even though explicitly included via:" );
    $const4$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $str5$The_constant_is_also_excluded_bec = makeString( "The constant is also excluded because:" );
    $const6$not = constant_handles.reader_make_constant_shell( makeString( "not" ) );
    $sym7$NON_KBS_RAW_CONSTANT_P = makeSymbol( "NON-KBS-RAW-CONSTANT-P" );
    ...
    $kw11$BREADTH = makeKeyword( "BREADTH" );
    $kw12$QUEUE = makeKeyword( "QUEUE" );
    $kw13$STACK = makeKeyword( "STACK" );
    $sym14$RELEVANT_SBHL_TV_IS_GENERAL_TV = makeSymbol( "RELEVANT-SBHL-TV-IS-GENERAL-TV" );
    $kw15$ERROR = makeKeyword( "ERROR" );
    $str16$_A_is_not_a__A = makeString( "~A is not a ~A" );
    $sym17$SBHL_TRUE_TV_P = makeSymbol( "SBHL-TRUE-TV-P" );
    $kw18$CERROR = makeKeyword( "CERROR" );
    $str19$continue_anyway = makeString( "continue anyway" );
    $kw20$WARN = makeKeyword( "WARN" );
    $str21$_A_is_not_a_valid__sbhl_type_erro = makeString( "~A is not a valid *sbhl-type-error-action* value" );
    ...
    $list24 = ConsesLow.list( makeUninternedSymbol( "LINK-NODE" ), makeUninternedSymbol( "MT" ), makeUninternedSymbol( "TV" ) );
    $str25$Node__a_does_not_pass_sbhl_type_t = makeString( "Node ~a does not pass sbhl-type-test ~a~%" );
    $sym26$CONSTANT_P = makeSymbol( "CONSTANT-P" );
    $str27$mapping_Cyc_constants = makeString( "mapping Cyc constants" );
    $sym28$STRINGP = makeSymbol( "STRINGP" );
    $kw29$SKIP = makeKeyword( "SKIP" );
    $const30$CycLConstant = constant_handles.reader_make_constant_shell( makeString( "CycLConstant" ) );
    $kw31$GAF = makeKeyword( "GAF" );
    $str32$Overriding_constant__A_omission__ = makeString( "Overriding constant ~A omission (~S) due to #$kbsProfileRetainTerm" );
    $const33$kbsProfileRetainTerm = constant_handles.reader_make_constant_shell( makeString( "kbsProfileRetainTerm" ) );
    $const34$kbsProfileRemoveFORT = constant_handles.reader_make_constant_shell( makeString( "kbsProfileRemoveFORT" ) );
    $str35$___S_constants_included_via_the_c = makeString( "~&~S constants included via the collections : ~S~%" );
    $str36$___S_constants_omitted_via_the__A = makeString( "~&~S constants omitted via the ~A ~A: ~A ~A~%" );
    $str37$collections_ = makeString( "collections " );
    $str38$ = makeString( "" );
    $str39$_predicate_ = makeString( "/predicate " );
    $str40$___S_total_constants_included___ = makeString( "~&~S total constants included.~%" );
    $str41$___S_total_constants_omitted___ = makeString( "~&~S total constants omitted.~%" );
    $str42$__Omitted_constants__ = makeString( "~&Omitted constants: " );
    $str43$_A_ = makeString( "~A " );
    $str44$__ = makeString( "~%" );
    $str45$____S_total_raw_KBS_constants_ide = makeString( " ~&~S total raw KBS constants identified.~%" );
    $sym46$KBS_KBQ_QUERY_SET_TERMS = makeSymbol( "KBS-KBQ-QUERY-SET-TERMS" );
    $const47$TheSetOf = constant_handles.reader_make_constant_shell( makeString( "TheSetOf" ) );
    $sym48$_Q = makeSymbol( "?Q" );
    $const49$thereExists = constant_handles.reader_make_constant_shell( makeString( "thereExists" ) );
    $sym50$_T = makeSymbol( "?T" );
    $const51$and = constant_handles.reader_make_constant_shell( makeString( "and" ) );
    $list52 = ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "testQuery" ) ), makeSymbol( "?T" ), makeSymbol( "?Q" ) ) );
    $int53$300 = makeInteger( 300 );
    $sym54$_KBS_KBQ_QUERY_SET_TERMS_CACHING_STATE_ = makeSymbol( "*KBS-KBQ-QUERY-SET-TERMS-CACHING-STATE*" );
    $str55$Continue = makeString( "Continue" );
    $str56$compute_kbs_skolems_requirements_ = makeString( "compute-kbs-skolems requirements not met." );
    $const57$SkolemFunction = constant_handles.reader_make_constant_shell( makeString( "SkolemFunction" ) );
    $str58$Computing_KBS_skolems = makeString( "Computing KBS skolems" );
    $str59$cdolist = makeString( "cdolist" );
    $str60$____S_total_KBS_skolems_identifie = makeString( " ~&~S total KBS skolems identified." );
    $sym61$KBS_SKOLEM_ASSERTION_FAST_FAIL_CONSTANT_P = makeSymbol( "KBS-SKOLEM-ASSERTION-FAST-FAIL-CONSTANT-P" );
    $str62$akb = makeString( "akb" );
    $const63$TKBTerm_Proprietary = constant_handles.reader_make_constant_shell( makeString( "TKBTerm-Proprietary" ) );
    $const64$ProprietaryTerm = constant_handles.reader_make_constant_shell( makeString( "ProprietaryTerm" ) );
    $str65$cyfi = makeString( "cyfi" );
    $const66$Cy_FiProprietaryTerm = constant_handles.reader_make_constant_shell( makeString( "Cy-FiProprietaryTerm" ) );
    $const67$ResearchCycConstant = constant_handles.reader_make_constant_shell( makeString( "ResearchCycConstant" ) );
    $const68$ScaffoldingConstant = constant_handles.reader_make_constant_shell( makeString( "ScaffoldingConstant" ) );
    $const69$TerroristAgent = constant_handles.reader_make_constant_shell( makeString( "TerroristAgent" ) );
    $const70$TerroristAct = constant_handles.reader_make_constant_shell( makeString( "TerroristAct" ) );
    $const71$HostileSocialAction = constant_handles.reader_make_constant_shell( makeString( "HostileSocialAction" ) );
    $str72$research = makeString( "research" );
    $sym73$NON_KBS_CONSTANT_P = makeSymbol( "NON-KBS-CONSTANT-P" );
    $str74$Computing_KBS_narts = makeString( "Computing KBS narts" );
    $str75$____S_total_KBS_NARTs_identified_ = makeString( " ~&~S total KBS NARTs identified.~%" );
    $str76$All_KB_subset_requirements_met_ = makeString( "All KB subset requirements met." );
    $str77$Also__the_following_GAFs_will_be_ = makeString( "Also, the following GAFs will be spliced in:" );
    $kw78$OPAQUE = makeKeyword( "OPAQUE" );
    $sym79$NON_KBS_FORT_P = makeSymbol( "NON-KBS-FORT-P" );
    $str80$The_term_contains_terms_not_in_th = makeString( "The term contains terms not in the KB subset:" );
    $sym81$KBS_DEFINITIONAL_FORT_P = makeSymbol( "KBS-DEFINITIONAL-FORT-P" );
    $sym82$NULL = makeSymbol( "NULL" );
    $sym83$KBS_DEFINITIONAL_FORT_PREDICATE_SETS = makeSymbol( "KBS-DEFINITIONAL-FORT-PREDICATE-SETS" );
    $sym84$FORT_P = makeSymbol( "FORT-P" );
    $sym85$KBS_DEFINITIONAL_PREDICATE_SET_ = makeSymbol( "KBS-DEFINITIONAL-PREDICATE-SET<" );
    $sym86$KBS_DEFINITIONAL_PREDICATE_SET_P = makeSymbol( "KBS-DEFINITIONAL-PREDICATE-SET-P" );
    $str87$The_assertion_s_microtheory_is_no = makeString( "The assertion's microtheory is not in the KB subset:" );
    $str88$The_assertion_was_explicitly_omit = makeString( "The assertion was explicitly omitted via #$kbsProfileRemoveAssertion" );
    $str89$The_assertion_s_formula_contains_ = makeString( "The assertion's formula contains FORTs not in the KB subset:" );
    $str90$The_assertion_is_definitional_bec = makeString( "The assertion is definitional because:" );
    $str91$__The_predicate_is_definitional_ = makeString( "- The predicate is definitional:" );
    $str92$__The_predicate_is_not_definition = makeString( "- The predicate is not definitional." );
    $str93$__But_the_assertion_contains_defi = makeString( "- But the assertion contains definitional terms for the KBS sections with the predicate sets:" );
    $str94$The_assertion_is_a_rule_containin = makeString( "The assertion is a rule containing definitional FORTs:" );
    $str95$Computing_KBS_assertions = makeString( "Computing KBS assertions" );
    $sym96$COMPUTE_NON_KBS_ASSERTION_P = makeSymbol( "COMPUTE-NON-KBS-ASSERTION-P" );
    $str97$Computing_KBS_deductions = makeString( "Computing KBS deductions" );
    $sym98$KBS_RAW_CONSTANT_OMITTED_P = makeSymbol( "KBS-RAW-CONSTANT-OMITTED-P" );
    $list99 = ConsesLow.list( new SubLObject[] { makeKeyword( "CONTINUABLE?" ), NIL, makeKeyword( "MAX-NUMBER" ), NIL, makeKeyword( "COMPUTE-ANSWER-JUSTIFICATIONS?" ), NIL, makeKeyword( "INFERENCE-MODE" ), makeKeyword(
        "MINIMAL" ), makeKeyword( "RESULT-UNIQUENESS" ), makeKeyword( "BINDINGS" ), makeKeyword( "PRODUCTIVITY-LIMIT" ), makeKeyword( "POSITIVE-INFINITY" ), makeKeyword( "MAX-PROBLEM-COUNT" ), makeKeyword(
            "POSITIVE-INFINITY" ), makeKeyword( "ANSWER-LANGUAGE" ), makeKeyword( "HL" )
    } );
    $str100$Preremoving_ = makeString( "Preremoving " );
    $str101$_assertions = makeString( " assertions" );
    $str102$Only_unary_KAPPA_predicates_suppo = makeString( "Only unary KAPPA predicates supported, not ~A." );
    $str103$Identifying_ = makeString( "Identifying " );
    $str104$_PREREMOVED_ASSERTIONS_specificat = makeString( ":PREREMOVED-ASSERTIONS specification ~A picked out no assertions.~%" );
    $str105$Applying__PREREMOVED_ASSERTIONS_s = makeString( "Applying :PREREMOVED-ASSERTIONS specification ~A .....~%" );
    $str106$_assertions_indentified_by_Kappa_ = makeString( " assertions indentified by Kappa predicate" );
    $str107$Finished_applying__A___ = makeString( "Finished applying ~A.~%" );
    $str108$Invalid_pre_removal_specification = makeString( "Invalid pre-removal specification ~A." );
    $str109$Killing__A_assertion_for_KB_subse = makeString( "Killing ~A assertion for KB subset: ~A~%" );
    $str110$an = makeString( "an" );
    $str111$prerun__Calling__A__ = makeString( "prerun: Calling ~A~%" );
    $str112$post_kbs_forts__Calling__A___ = makeString( "post-kbs-forts: Calling ~A.~%" );
    $str113$POST_KBS_FORTS__Unmark_NARTs_that = makeString( "POST-KBS-FORTS: Unmark NARTs that have HL assertions as arguments" );
    $sym114$ASSERTION_P = makeSymbol( "ASSERTION-P" );
    $str115$__Unmarking_NART__A_with_formula_ = makeString( "~&Unmarking NART ~A with formula ~A ....~%" );
    $str116$__No_NARTs_had_to_be_unmarked___ = makeString( "~&No NARTs had to be unmarked.~%" );
    $str117$___A_NARTs_with_HL_assertions_as_ = makeString( "~&~A NARTs with HL assertions as arguments unmarked.~%" );
    $str118$post_kbs_assertions__Calling__A__ = makeString( "post-kbs-assertions: Calling ~A~%" );
    $str119$_kbs_raw_constants__is_null_ = makeString( "*kbs-raw-constants* is null." );
    $str120$_kbs_raw_constants_table__is_null = makeString( "*kbs-raw-constants-table* is null." );
    $str121$_kbs_raw_constants_omission_table = makeString( "*kbs-raw-constants-omission-table* is null." );
    $str122$_kbs_skolems__is_null_ = makeString( "*kbs-skolems* is null." );
    $str123$_kbs_constants__is_null_ = makeString( "*kbs-constants* is null." );
    $str124$_kbs_constant_table__is_null_ = makeString( "*kbs-constant-table* is null." );
    $str125$_kbs_narts__is_null_ = makeString( "*kbs-narts* is null." );
    $str126$_kbs_forts__is_null_ = makeString( "*kbs-forts* is null." );
    $str127$_kbs_fort_table__is_null_ = makeString( "*kbs-fort-table* is null." );
    $str128$_kbs_definitional_constant_table_ = makeString( "*kbs-definitional-constant-table* is null." );
    $str129$_kbs_definitional_predicate_table = makeString( "*kbs-definitional-predicate-table* is null." );
    $str130$_kbs_assertion_table__is_null_ = makeString( "*kbs-assertion-table* is null." );
    $str131$_kbs_deduction_table__is_null_ = makeString( "*kbs-deduction-table* is null." );
    $str132$______KB__S_KBS_statistics__ = makeString( "~&;;; KB ~S KBS statistics~%" );
    $str133$__FORTs___________7___D__ = makeString( "~&FORTs        : ~7,' D~%" );
    $str134$___Constants______7___D__ = makeString( "~& Constants   : ~7,' D~%" );
    $str135$_____def_only_____7___D__ = makeString( "~&  (def only) : ~7,' D~%" );
    $str136$___NARTs__________7___D__ = makeString( "~& NARTs       : ~7,' D~%" );
    $str137$__Assertions______7___D__ = makeString( "~&Assertions   : ~7,' D~%" );
    $str138$__Deductions______7___D__ = makeString( "~&Deductions   : ~7,' D~%" );
    $sym139$ISA_MT_ = makeSymbol( "ISA-MT?" );
    $str140$No_valid_KBS_available_ = makeString( "No valid KBS available!" );
    $kw141$MT = makeKeyword( "MT" );
    $kw142$BROAD_MT = makeKeyword( "BROAD-MT" );
    $str143$do_broad_mt_index = makeString( "do-broad-mt-index" );
  }
}
/*
 * 
