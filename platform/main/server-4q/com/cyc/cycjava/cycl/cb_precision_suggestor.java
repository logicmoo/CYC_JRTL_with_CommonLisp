...
import com.cyc.cycjava.cycl.cb_precision_suggestor;
...
import static com.cyc.cycjava.cycl.cb_precision_suggestor.*;
...
public final class cb_precision_suggestor extends SubLTranslatedFile {
    ...
    public static SubLObject cb_precision_suggestor_state_p(final SubLObject v_object) {
        return v_object.getClass() == cb_precision_suggestor.$cb_precision_suggestor_state_native.class ? T : NIL;
    }

    public static SubLObject cb_pss_original_formula(final SubLObject v_object) {
        assert NIL != cb_precision_suggestor_state_p(v_object) : "cb_precision_suggestor.cb_precision_suggestor_state_p(v_object) " + "CommonSymbols.NIL != cb_precision_suggestor.cb_precision_suggestor_state_p(v_object) " + v_object;
    ...
    public static SubLObject make_cb_precision_suggestor_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_precision_suggestor.$cb_precision_suggestor_state_native();
        SubLObject next;
    ...
    public static SubLObject cb_precision_suggestor_rkf_state_p(final SubLObject v_object) {
        return v_object.getClass() == cb_precision_suggestor.$cb_precision_suggestor_rkf_state_native.class ? T : NIL;
    }

    public static SubLObject cb_ps_rkf_s_next_arg_to_precisify(final SubLObject v_object) {
        assert NIL != cb_precision_suggestor_rkf_state_p(v_object) : "cb_precision_suggestor.cb_precision_suggestor_rkf_state_p(v_object) " + "CommonSymbols.NIL != cb_precision_suggestor.cb_precision_suggestor_rkf_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_cb_precision_suggestor_rkf_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_precision_suggestor.$cb_precision_suggestor_rkf_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $cb_precision_suggestor_rkf_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(cb_precision_suggestor.$cb_precision_suggestor_rkf_state_native.class, CB_PRECISION_SUGGESTOR_RKF_STATE, CB_PRECISION_SUGGESTOR_RKF_STATE_P, $list141, $list142, new String[]{ "$next_arg_to_precisify", "$next_direction_to_precisify" }, $list143, $list144, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
