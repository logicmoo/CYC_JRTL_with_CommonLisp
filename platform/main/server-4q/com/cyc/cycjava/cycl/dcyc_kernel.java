...
import static com.cyc.tool.subl.jrtl.nativeCode.subLisp.Threads.process_wait_with_timeout;
...
public final class dcyc_kernel extends SubLTranslatedFile implements V02 {
    ...
    public static final SubLObject ccc_p(SubLObject v_object) {
        return v_object.getClass() == dcyc_kernel.$ccc_native.class ? ((SubLObject) (T)) : NIL;
    }
    ...
    public static final SubLObject cco_p(SubLObject v_object) {
        return v_object.getClass() == dcyc_kernel.$cco_native.class ? ((SubLObject) (T)) : NIL;
    }
