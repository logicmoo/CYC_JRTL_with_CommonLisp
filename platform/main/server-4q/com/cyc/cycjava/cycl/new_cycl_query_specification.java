...
import static com.cyc.cycjava.cycl.new_cycl_query_specification.*;
...
public final class new_cycl_query_specification extends SubLTranslatedFile {
    ...
    public static SubLObject new_cycl_query_specification_p(final SubLObject v_object) {
        return v_object.getClass() == new_cycl_query_specification.$new_cycl_query_specification_native.class ? T : NIL;
    }

    public static SubLObject new_cycl_query_spec_cycl_id(final SubLObject v_object) {
        assert NIL != new_cycl_query_specification_p(v_object) : "new_cycl_query_specification.new_cycl_query_specification_p(v_object) " + "CommonSymbols.NIL != new_cycl_query_specification.new_cycl_query_specification_p(v_object) " + v_object;
    ...
    public static SubLObject make_new_cycl_query_specification(SubLObject arglist) {
        ...
        final SubLObject v_new = new new_cycl_query_specification.$new_cycl_query_specification_native();
        SubLObject next;
    ...
    public static final class $new_cycl_query_specification_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(new_cycl_query_specification.$new_cycl_query_specification_native.class, NEW_CYCL_QUERY_SPECIFICATION, NEW_CYCL_QUERY_SPECIFICATION_P, $list2, $list3, new String[]{ "$cycl_id", "$formula", "$mt", "$comment", "$properties", "$indexicals", "$edited" }, $list4, $list5, NEW_CYCL_QUERY_SPECIFICATION_PRINT);
        }
    }
