...
import com.cyc.cycjava.cycl.zookeeper;
...
import static com.cyc.cycjava.cycl.zookeeper.*;
...
public final class zookeeper extends SubLTranslatedFile {
    ...
    private static final SubLList $list10 = list(makeKeyword("PATH"), makeKeyword("URI"), makeKeyword("CHILD-URI-TEMPLATE"), makeKeyword("CHILDREN"));
    ...
    private static final SubLList $list75 = list(new SubLObject[]{ makeSymbol("PATH"), makeSymbol("URI"), makeSymbol("DATA"), makeSymbol("CZXID"), makeSymbol("MZXID"), makeSymbol("CTIME"), makeSymbol("MTIME"), makeSymbol("VERSION"), makeSymbol("CVERSION"), makeSymbol("AVERSION"), makeSymbol("EPHEMERAL-OWNER"), makeSymbol("DATA-LEN"), makeSymbol("NUM-CHILDREN"), makeSymbol("PZXID") });

    private static final SubLList $list76 = list(new SubLObject[]{ makeKeyword("PATH"), makeKeyword("URI"), makeKeyword("DATA"), makeKeyword("CZXID"), makeKeyword("MZXID"), makeKeyword("CTIME"), makeKeyword("MTIME"), makeKeyword("VERSION"), makeKeyword("CVERSION"), makeKeyword("AVERSION"), makeKeyword("EPHEMERAL-OWNER"), makeKeyword("DATA-LEN"), makeKeyword("NUM-CHILDREN"), makeKeyword("PZXID") });

    private static final SubLList $list77 = list(new SubLObject[]{ makeSymbol("ZKSTAT-PATH"), makeSymbol("ZKSTAT-URI"), makeSymbol("ZKSTAT-DATA"), makeSymbol("ZKSTAT-CZXID"), makeSymbol("ZKSTAT-MZXID"), makeSymbol("ZKSTAT-CTIME"), makeSymbol("ZKSTAT-MTIME"), makeSymbol("ZKSTAT-VERSION"), makeSymbol("ZKSTAT-CVERSION"), makeSymbol("ZKSTAT-AVERSION"), makeSymbol("ZKSTAT-EPHEMERAL-OWNER"), makeSymbol("ZKSTAT-DATA-LEN"), makeSymbol("ZKSTAT-NUM-CHILDREN"), makeSymbol("ZKSTAT-PZXID") });

    private static final SubLList $list78 = list(new SubLObject[]{ makeSymbol("_CSETF-ZKSTAT-PATH"), makeSymbol("_CSETF-ZKSTAT-URI"), makeSymbol("_CSETF-ZKSTAT-DATA"), makeSymbol("_CSETF-ZKSTAT-CZXID"), makeSymbol("_CSETF-ZKSTAT-MZXID"), makeSymbol("_CSETF-ZKSTAT-CTIME"), makeSymbol("_CSETF-ZKSTAT-MTIME"), makeSymbol("_CSETF-ZKSTAT-VERSION"), makeSymbol("_CSETF-ZKSTAT-CVERSION"), makeSymbol("_CSETF-ZKSTAT-AVERSION"), makeSymbol("_CSETF-ZKSTAT-EPHEMERAL-OWNER"), makeSymbol("_CSETF-ZKSTAT-DATA-LEN"), makeSymbol("_CSETF-ZKSTAT-NUM-CHILDREN"), makeSymbol("_CSETF-ZKSTAT-PZXID") });
    ...
    public static SubLObject zk_child_state_p(final SubLObject v_object) {
        return v_object.getClass() == zookeeper.$zk_child_state_native.class ? T : NIL;
    }

    public static SubLObject zkkids_path(final SubLObject v_object) {
        assert NIL != zk_child_state_p(v_object) : "zookeeper.zk_child_state_p(v_object) " + "CommonSymbols.NIL != zookeeper.zk_child_state_p(v_object) " + v_object;
    ...
    public static SubLObject make_zk_child_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new zookeeper.$zk_child_state_native();
        SubLObject next;
        ...
        for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
            ...
            if (pcase_var.eql($PATH)) {
                ...
                if (pcase_var.eql($URI)) {
                    ...
                    if (pcase_var.eql($CHILD_URI_TEMPLATE)) {
        ...
        if (NIL != web_utilities.matching_open_tagP($$$child, iteration.iteration_next(tokens), UNPROVIDED)) {
            ...
            while (NIL == iteration.iteration_done(tokens)) {
                ...
                if (NIL != web_utilities.matching_open_tagP($$$path, tag, UNPROVIDED)) {
                    ...
                    if (NIL != web_utilities.matching_open_tagP($$$uri, tag, UNPROVIDED)) {
                        _csetf_zkkids_uri(node, iteration.iteration_next(tokens));
                        zk_must_match_closing_tag(tokens, $$$uri);
                    } else
                        if (NIL != web_utilities.matching_open_tagP($str37$child_uri_template, tag, UNPROVIDED)) {
                            ...
                            if (NIL != web_utilities.matching_open_tagP($$$children, tag, UNPROVIDED)) {
                                children = NIL;
                            } else
                                if (NIL != web_utilities.matching_open_tagP($$$child, tag, UNPROVIDED)) {
                                    children = cons(iteration.iteration_next(tokens), children);
                                    zk_must_match_closing_tag(tokens, $$$child);
                                } else
                                    if (NIL != web_utilities.matching_close_tagP($$$children, tag, UNPROVIDED)) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (NIL != validate_tcp_connection(in_stream, server, real_port)) {
                                web_utilities.send_http_request(in_stream, list(new SubLObject[]{ $MACHINE, server, $PORT, $zookeeper_rest_port$.getDynamicValue(thread), $METHOD, $PUT, $URL, node_path, $QUERY, utf8_data, $kw52$KEEP_ALIVE_, NIL, $kw53$WIDE_NEWLINES_, NIL, $ACCEPT_TYPES, $list6, $CONTENT_TYPE, $str56$application_octet_stream, $SOAP_ACTION_URI, NIL }));
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            in_stream = subl_promotions.open_tcp_stream_with_timeout(server, real_port, $zookeeper_rest_timeout$.getDynamicValue(thread), $PRIVATE);
                            if (NIL != validate_tcp_connection(in_stream, server, real_port)) {
                                web_utilities.send_http_request(in_stream, list(new SubLObject[]{ $MACHINE, server, $PORT, $zookeeper_rest_port$.getDynamicValue(thread), $METHOD, $DELETE, $URL, node_path, $QUERY, $str69$, $kw52$KEEP_ALIVE_, NIL, $kw53$WIDE_NEWLINES_, NIL, $ACCEPT_TYPES, $list6, $CONTENT_TYPE, $str56$application_octet_stream, $SOAP_ACTION_URI, NIL }));
                                if (in_stream.isStream()) {
                                    thread.resetMultipleValues();
    ...
    public static SubLObject zk_node_state_p(final SubLObject v_object) {
        return v_object.getClass() == zookeeper.$zk_node_state_native.class ? T : NIL;
    }

    public static SubLObject zkstat_path(final SubLObject v_object) {
        assert NIL != zk_node_state_p(v_object) : "zookeeper.zk_node_state_p(v_object) " + "CommonSymbols.NIL != zookeeper.zk_node_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_zk_node_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new zookeeper.$zk_node_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
            ...
            while (NIL == iteration.iteration_done(tokens)) {
                ...
                if (NIL != web_utilities.matching_open_tagP($$$path, tag, UNPROVIDED)) {
                    ...
                    if (NIL != web_utilities.matching_open_tagP($$$uri, tag, UNPROVIDED)) {
                        ...
                        if (NIL != web_utilities.matching_open_tagP($$$dataUtf8, tag, UNPROVIDED)) {
                            _csetf_zkstat_data(node, iteration.iteration_next(tokens));
                            zk_must_match_closing_tag(tokens, $$$dataUtf8);
                        } else
                            if (NIL != web_utilities.matching_open_tagP($$$czxid, tag, UNPROVIDED)) {
                                ...
                                if (NIL != web_utilities.matching_open_tagP($$$mzxid, tag, UNPROVIDED)) {
                                    ...
                                    if (NIL != web_utilities.matching_open_tagP($$$pzxid, tag, UNPROVIDED)) {
                                        ...
                                        if (NIL != web_utilities.matching_open_tagP($$$ctime, tag, UNPROVIDED)) {
                                            ...
                                            if (NIL != web_utilities.matching_open_tagP($$$mtime, tag, UNPROVIDED)) {
                                                ...
                                                if (NIL != web_utilities.matching_open_tagP($$$version, tag, UNPROVIDED)) {
                                                    ...
                                                    if (NIL != web_utilities.matching_open_tagP($$$aversion, tag, UNPROVIDED)) {
                                                        ...
                                                        if (NIL != web_utilities.matching_open_tagP($$$cversion, tag, UNPROVIDED)) {
                                                            ...
                                                            if (NIL != web_utilities.matching_open_tagP($$$ephemeralOwner, tag, UNPROVIDED)) {
                                                                ...
                                                                if (NIL != web_utilities.matching_open_tagP($$$dataLength, tag, UNPROVIDED)) {
                                                                    ...
                                                                    if (NIL != web_utilities.matching_open_tagP($$$numChildren, tag, UNPROVIDED)) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            in_stream = subl_promotions.open_tcp_stream_with_timeout(server, real_port, $zookeeper_rest_timeout$.getDynamicValue(thread), $PRIVATE);
                            if (NIL != validate_tcp_connection(in_stream, server, real_port)) {
                                web_utilities.send_http_request(in_stream, list(new SubLObject[]{ $MACHINE, server, $PORT, $zookeeper_rest_port$.getDynamicValue(thread), $METHOD, $POST, $URL, full_path, $QUERY, initial_data, $kw52$KEEP_ALIVE_, NIL, $kw53$WIDE_NEWLINES_, NIL, $ACCEPT_TYPES, $list6, $CONTENT_TYPE, $str56$application_octet_stream, $SOAP_ACTION_URI, NIL }));
                                if (in_stream.isStream()) {
                                    thread.resetMultipleValues();
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            in_stream = subl_promotions.open_tcp_stream_with_timeout(server, real_port, $zookeeper_rest_timeout$.getDynamicValue(thread), $PRIVATE);
                            if (NIL != validate_tcp_connection(in_stream, server, real_port)) {
                                web_utilities.send_http_request(in_stream, list(new SubLObject[]{ $MACHINE, server, $PORT, $zookeeper_rest_port$.getDynamicValue(thread), $METHOD, $POST, $URL, session_uri, $QUERY, $str69$, $kw52$KEEP_ALIVE_, NIL, $kw53$WIDE_NEWLINES_, NIL, $ACCEPT_TYPES, $list6, $CONTENT_TYPE, $str56$application_octet_stream, $SOAP_ACTION_URI, NIL }));
                                if (in_stream.isStream()) {
                                    thread.resetMultipleValues();
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            in_stream = subl_promotions.open_tcp_stream_with_timeout(server, real_port, $zookeeper_rest_timeout$.getDynamicValue(thread), $PRIVATE);
                            if (NIL != validate_tcp_connection(in_stream, server, real_port)) {
                                web_utilities.send_http_request(in_stream, list(new SubLObject[]{ $MACHINE, server, $PORT, $zookeeper_rest_port$.getDynamicValue(thread), $METHOD, $DELETE, $URL, session_uri, $QUERY, $str69$, $kw52$KEEP_ALIVE_, NIL, $kw53$WIDE_NEWLINES_, NIL, $ACCEPT_TYPES, $list6, $CONTENT_TYPE, $str56$application_octet_stream, $SOAP_ACTION_URI, NIL }));
                                if (in_stream.isStream()) {
                                    thread.resetMultipleValues();
    ...
    public static SubLObject declare_zookeeper_file() {
        declareFunction(me, "zk_get_node_children", "ZK-GET-NODE-CHILDREN", 1, 0, false);
        declareFunction(me, "zk_child_state_print_function_trampoline", "ZK-CHILD-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "zk_child_state_p", "ZK-CHILD-STATE-P", 1, 0, false);
        new zookeeper.$zk_child_state_p$UnaryFunction();
        declareFunction(me, "zkkids_path", "ZKKIDS-PATH", 1, 0, false);
        declareFunction(me, "zkkids_uri", "ZKKIDS-URI", 1, 0, false);
        declareFunction(me, "zkkids_child_uri_template", "ZKKIDS-CHILD-URI-TEMPLATE", 1, 0, false);
        declareFunction(me, "zkkids_children", "ZKKIDS-CHILDREN", 1, 0, false);
        declareFunction(me, "_csetf_zkkids_path", "_CSETF-ZKKIDS-PATH", 2, 0, false);
        declareFunction(me, "_csetf_zkkids_uri", "_CSETF-ZKKIDS-URI", 2, 0, false);
        declareFunction(me, "_csetf_zkkids_child_uri_template", "_CSETF-ZKKIDS-CHILD-URI-TEMPLATE", 2, 0, false);
        declareFunction(me, "_csetf_zkkids_children", "_CSETF-ZKKIDS-CHILDREN", 2, 0, false);
        declareFunction(me, "make_zk_child_state", "MAKE-ZK-CHILD-STATE", 0, 1, false);
        declareFunction(me, "visit_defstruct_zk_child_state", "VISIT-DEFSTRUCT-ZK-CHILD-STATE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_zk_child_state_method", "VISIT-DEFSTRUCT-OBJECT-ZK-CHILD-STATE-METHOD", 2, 0, false);
        declareFunction(me, "parse_zk_children", "PARSE-ZK-CHILDREN", 1, 0, false);
        declareFunction(me, "zk_set_node_data", "ZK-SET-NODE-DATA", 2, 0, false);
        declareFunction(me, "zk_analyze_set_response", "ZK-ANALYZE-SET-RESPONSE", 1, 0, false);
        declareFunction(me, "zk_delete_node", "ZK-DELETE-NODE", 1, 0, false);
        declareFunction(me, "zk_analyze_delete_response", "ZK-ANALYZE-DELETE-RESPONSE", 1, 0, false);
        declareFunction(me, "zk_get_node_state", "ZK-GET-NODE-STATE", 1, 0, false);
        declareFunction(me, "zk_node_state_print_function_trampoline", "ZK-NODE-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "zk_node_state_p", "ZK-NODE-STATE-P", 1, 0, false);
        new zookeeper.$zk_node_state_p$UnaryFunction();
        declareFunction(me, "zkstat_path", "ZKSTAT-PATH", 1, 0, false);
        declareFunction(me, "zkstat_uri", "ZKSTAT-URI", 1, 0, false);
        declareFunction(me, "zkstat_data", "ZKSTAT-DATA", 1, 0, false);
        declareFunction(me, "zkstat_czxid", "ZKSTAT-CZXID", 1, 0, false);
        declareFunction(me, "zkstat_mzxid", "ZKSTAT-MZXID", 1, 0, false);
        declareFunction(me, "zkstat_ctime", "ZKSTAT-CTIME", 1, 0, false);
        declareFunction(me, "zkstat_mtime", "ZKSTAT-MTIME", 1, 0, false);
        declareFunction(me, "zkstat_version", "ZKSTAT-VERSION", 1, 0, false);
        declareFunction(me, "zkstat_cversion", "ZKSTAT-CVERSION", 1, 0, false);
        declareFunction(me, "zkstat_aversion", "ZKSTAT-AVERSION", 1, 0, false);
        declareFunction(me, "zkstat_ephemeral_owner", "ZKSTAT-EPHEMERAL-OWNER", 1, 0, false);
        declareFunction(me, "zkstat_data_len", "ZKSTAT-DATA-LEN", 1, 0, false);
        declareFunction(me, "zkstat_num_children", "ZKSTAT-NUM-CHILDREN", 1, 0, false);
        declareFunction(me, "zkstat_pzxid", "ZKSTAT-PZXID", 1, 0, false);
        declareFunction(me, "_csetf_zkstat_path", "_CSETF-ZKSTAT-PATH", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_uri", "_CSETF-ZKSTAT-URI", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_data", "_CSETF-ZKSTAT-DATA", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_czxid", "_CSETF-ZKSTAT-CZXID", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_mzxid", "_CSETF-ZKSTAT-MZXID", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_ctime", "_CSETF-ZKSTAT-CTIME", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_mtime", "_CSETF-ZKSTAT-MTIME", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_version", "_CSETF-ZKSTAT-VERSION", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_cversion", "_CSETF-ZKSTAT-CVERSION", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_aversion", "_CSETF-ZKSTAT-AVERSION", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_ephemeral_owner", "_CSETF-ZKSTAT-EPHEMERAL-OWNER", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_data_len", "_CSETF-ZKSTAT-DATA-LEN", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_num_children", "_CSETF-ZKSTAT-NUM-CHILDREN", 2, 0, false);
        declareFunction(me, "_csetf_zkstat_pzxid", "_CSETF-ZKSTAT-PZXID", 2, 0, false);
        declareFunction(me, "make_zk_node_state", "MAKE-ZK-NODE-STATE", 0, 1, false);
        declareFunction(me, "visit_defstruct_zk_node_state", "VISIT-DEFSTRUCT-ZK-NODE-STATE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_zk_node_state_method", "VISIT-DEFSTRUCT-OBJECT-ZK-NODE-STATE-METHOD", 2, 0, false);
        declareFunction(me, "parse_zk_state", "PARSE-ZK-STATE", 1, 0, false);
        declareFunction(me, "zk_must_match_closing_tag", "ZK-MUST-MATCH-CLOSING-TAG", 2, 0, false);
        declareFunction(me, "zk_create_permanent_node", "ZK-CREATE-PERMANENT-NODE", 2, 1, false);
        declareFunction(me, "zk_analyze_create_response", "ZK-ANALYZE-CREATE-RESPONSE", 1, 0, false);
        declareFunction(me, "zk_create_session", "ZK-CREATE-SESSION", 0, 1, false);
        declareFunction(me, "zk_analyze_create_session_response", "ZK-ANALYZE-CREATE-SESSION-RESPONSE", 1, 0, false);
        declareFunction(me, "zk_send_session_heartbeat", "ZK-SEND-SESSION-HEARTBEAT", 1, 0, false);
        declareFunction(me, "zk_analyze_session_heartbeat_response", "ZK-ANALYZE-SESSION-HEARTBEAT-RESPONSE", 1, 0, false);
        declareFunction(me, "zk_delete_session", "ZK-DELETE-SESSION", 1, 0, false);
        declareFunction(me, "zk_analyze_delete_session_response", "ZK-ANALYZE-DELETE-SESSION-RESPONSE", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $zk_child_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(zookeeper.$zk_child_state_native.class, ZK_CHILD_STATE, ZK_CHILD_STATE_P, $list9, $list10, new String[]{ "$path", "$uri", "$child_uri_template", "$children" }, $list11, $list12, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $zk_node_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(zookeeper.$zk_node_state_native.class, ZK_NODE_STATE, ZK_NODE_STATE_P, $list75, $list76, new String[]{ "$path", "$uri", "$data", "$czxid", "$mzxid", "$ctime", "$mtime", "$version", "$cversion", "$aversion", "$ephemeral_owner", "$data_len", "$num_children", "$pzxid" }, $list77, $list78, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
