      ...
      SubLTranslatedFile
{
  ...
  {
    return makeBoolean( NIL == el_utilities.el_formula_p( sentence ) && NIL != el_sentence_p( sentence ) );
  }
  ...
  {
    return makeBoolean( NIL == el_utilities.el_formula_p( sentence ) && NIL != cycl_grammar.cycl_sentence_p( sentence ) );
  }
  ...
  {
    SubLFiles.declareFunction( me, "why_not_el_sentence", "WHY-NOT-EL-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "el_sentence_p", "EL-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_non_formula_sentence_p", "EL-NON-FORMULA-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "non_el_formula_sentence_p", "NON-EL-FORMULA-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_sentence_sequence_p", "EL-SENTENCE-SEQUENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_unary_sentence_p", "EL-UNARY-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_binary_sentence_p", "EL-BINARY-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_ternary_sentence_p", "EL-TERNARY-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_quaternary_sentence_p", "EL-QUATERNARY-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_quintary_sentence_p", "EL-QUINTARY-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_variable_arity_sentence_p", "EL-VARIABLE-ARITY-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_regularly_quantified_sentence_p", "EL-REGULARLY-QUANTIFIED-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_bounded_existential_sentence_p", "EL-BOUNDED-EXISTENTIAL-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_quantified_sentence_p", "EL-QUANTIFIED-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_literal_p", "EL-LITERAL-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_atomic_sentence_p", "EL-ATOMIC-SENTENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_argument_sequence_p", "EL-ARGUMENT-SEQUENCE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_predicate_syntax_p", "EL-PREDICATE-SYNTAX-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_nat_p", "EL-NAT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_function_p", "EL-FUNCTION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_expression_p", "EL-EXPRESSION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_term_p", "EL-TERM-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_denotational_term_p", "EL-DENOTATIONAL-TERM-P", 1, 0, false );
    SubLFiles.declareFunction( me, "el_represented_term_p", "EL-REPRESENTED-TERM-P", 1, 0, false );
    return NIL;
  }
