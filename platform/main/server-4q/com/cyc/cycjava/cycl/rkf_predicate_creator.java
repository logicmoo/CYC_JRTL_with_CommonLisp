...
public final class rkf_predicate_creator extends SubLTranslatedFile {
    ...
    public static SubLObject pc_session_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_predicate_creator.$pc_session_native.class ? T : NIL;
    }

    public static SubLObject pc_session_interaction(final SubLObject v_object) {
        assert NIL != pc_session_p(v_object) : "rkf_predicate_creator.pc_session_p(v_object) " + "CommonSymbols.NIL != rkf_predicate_creator.pc_session_p(v_object) " + v_object;
    ...
    public static SubLObject make_pc_session(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_predicate_creator.$pc_session_native();
        SubLObject next;
    ...
    public static final class $pc_session_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_predicate_creator.$pc_session_native.class, PC_SESSION, PC_SESSION_P, $list9, $list10, new String[]{ "$interaction", "$mode", "$arity", "$full_examples", "$arg_examples", "$constraints_via_examples", "$generalized_constraints", "$template", "$predicate" }, $list11, $list12, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
