...
public final class learned_nouns extends SubLTranslatedFile implements V02 {
                    ...
                    current = current.rest();
                    {
                        ...
                        }
                        {
                            ...
                            current = temp;
                            {
                                ...
                                return list(CLET, list(list(count_threshold_var, count_threshold), list(confidence_threshold_var, confidence_threshold), list(statuses_var, statuses)), list(DO_DICTIONARY, list(string_var, noun_var, list(GET_LEARNED_NOUNS_DICTIONARY_OF_NOUNS, learned)), list(IGNORE, string_var), listS(PWHEN, list(CAND, list(SIMPLE_NOUN_P, noun_var), list($sym23$__, listS(FIM, noun_var, $list_alt25), count_threshold_var), list(COR, list(NULL, confidence_threshold_var), list($sym28$_, listS(FIM, noun_var, $list_alt29), confidence_threshold_var)), list(COR, listS(EQ, statuses_var, $list_alt30), listS($sym31$MEMBER_, listS(FIM, noun_var, $list_alt32), statuses_var, $list_alt33))), append(body, NIL))));
                            }
                        }
                    }
                }
    ...
    public static final SubLObject learned_nouns_reify_noun_as_method(SubLObject self, SubLObject noun_string, SubLObject collection_or_individual, SubLObject list_of_types, SubLObject gloss, SubLObject needs_oeP, SubLObject taxonomy_mt, SubLObject lexical_mt) {
        ...
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            SubLTrampolineFile.checkType(noun_string, STRINGP);
            {
            ...
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                ...
                while (NIL == dictionary_contents.do_dictionary_contents_doneP(iteration_state)) {
                    thread.resetMultipleValues();
                    {
                        ...
                        thread.resetMultipleValues();
                        if ((((NIL != noun_learner_noun_classes.simple_noun_p(simple_noun)) && methods.funcall_instance_method_with_0_args(simple_noun, GET_TOTAL_COUNT).numGE(count_threshold_var)) && ((NIL == confidence_threshold_var) || methods.funcall_instance_method_with_0_args(simple_noun, GET_CONFIDENCE_LEVEL).numG(confidence_threshold_var))) && ((statuses_var == $ALL) || (NIL != subl_promotions.memberP(methods.funcall_instance_method_with_0_args(simple_noun, GET_STATUS_IN_CYC), statuses_var, EQ, UNPROVIDED)))) {
                            {
    ...
    public static final SubLObject learned_nouns_noun_count_method(SubLObject self, SubLObject noun_string, SubLObject relation) {
        ...
        }
        {
            ...
            if (NIL != noun_learner_noun_classes.simple_noun_p(noun_object)) {
                ...
                if (NIL != noun_learner_noun_classes.complex_noun_p(noun_object)) {
                    if (NIL != relation) {
    ...
    public static final SubLObject learned_nouns_generate_ke_text_method(SubLObject self, SubLObject ke_file_path, SubLObject notes_file_path) {
        {
            ...
            {
                SubLObject dictionary_of_nouns = get_learned_nouns_dictionary_of_nouns(self);
                SubLTrampolineFile.checkType(ke_file_path, STRINGP);
                SubLTrampolineFile.checkType(notes_file_path, STRINGP);
                {
    ...
    public static final SubLObject learned_nouns_save_noun_list_method(SubLObject self, SubLObject unjavafied_noun_list, SubLObject filename, SubLObject max_ranking_length) {
        SubLTrampolineFile.checkType(unjavafied_noun_list, LISTP);
        SubLTrampolineFile.checkType(filename, STRINGP);
        SubLTrampolineFile.checkType(max_ranking_length, POSITIVE_INTEGER_P);
        {
    ...
    public static final SubLObject get_javafied_noun_refined_tag(SubLObject javafied_noun) {
        SubLTrampolineFile.checkType(javafied_noun, JAVAFIED_NOUN_P);
                                    ...
                                    if (NIL != list_utilities.empty_list_p(meanings)) {
                                        ...
                                        princ($str_alt317$__, stream_17);
                                        {
                                            ...
                                            if (NIL != kb_accessors.kb_individual_p(tag)) {
                                                ...
                                                if (NIL != fort_types_interface.collection_p(tag)) {
                                                    {
    ...
    public static final SubLObject learned_nouns_listify_known_nouns_with_meanings_for_mysentient_method(SubLObject self, SubLObject corpus, SubLObject corpus_mt, SubLObject graphing_mt) {
        {
            SubLObject dictionary_of_nouns = get_learned_nouns_dictionary_of_nouns(self);
            SubLTrampolineFile.checkType(corpus, CYCL_TERM_P);
            SubLTrampolineFile.checkType(graphing_mt, CYCL_TERM_P);
            {
                SubLObject nouns = dictionary.dictionary_values(dictionary_of_nouns);
                                                    ...
                                                    for (file = csome_list_var.first(); NIL != csome_list_var; csome_list_var = csome_list_var.rest() , file = csome_list_var.first()) {
                                                        ...
                                                        if (NIL != Filesys.directory_p(file)) {
                                                            ...
                                                            if (NIL != string_utilities.ends_with(file, subj_pairs_file_suffix, UNPROVIDED)) {
                                                                ...
                                                                if (NIL != string_utilities.ends_with(file, obj_pairs_file_suffix, UNPROVIDED)) {
                                                                    methods.funcall_instance_method_with_2_args(self, COMPILE_RAW_DATA_FOR_ARG_FROM_TEXT_FILE, $OBJ, file);
                                                                } else
                                                                    if (NIL != string_utilities.ends_with(file, complex_nouns_file_suffix, UNPROVIDED)) {
    ...
    public static final SubLObject learned_nouns_calculate_typicality_sum_by_collection_method(SubLObject self, SubLObject simple_noun) {
        {
            SubLObject noun_relevance_count_threshold = get_learned_nouns_noun_relevance_count_threshold(self);
            SubLTrampolineFile.checkType(simple_noun, SIMPLE_NOUN_P);
            {
    ...
    public static final SubLObject learned_nouns_why_not_tagged_as_int_method(SubLObject self, SubLObject simple_noun, SubLObject better_tag) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject typicality_sum_calculate_tag_methods = get_learned_nouns_typicality_sum_calculate_tag_methods(self);
                SubLObject calculate_tag_method = get_learned_nouns_calculate_tag_method(self);
                SubLTrampolineFile.checkType(better_tag, COLLECTION_P);
    ...
    public static final SubLObject singularize_complex_noun(SubLObject complex_noun_string, SubLObject head_string) {
        {
            ...
            if (NIL == result) {
                {
                    SubLObject head_string_pluralized = lexification_utilities.pluralize_word(head_string);
    ...
    static private final SubLList $list_alt115 = list(makeSymbol("NOUN-STRING"), makeSymbol("COLLECTION-OR-INDIVIDUAL"), makeSymbol("LIST-OF-TYPES"), makeSymbol("&OPTIONAL"), makeSymbol("GLOSS"), makeSymbol("NEEDS-OE?"), list(makeSymbol("TAXONOMY-MT"), constant_handles.reader_make_constant_shell(makeString("TheMotleyFoolUKCorpusMt"))), list(makeSymbol("LEXICAL-MT"), constant_handles.reader_make_constant_shell(makeString("GeneralEnglishMt"))));

    static private final SubLList $list_alt116 = list(makeString("@return list-of-list-p; a list (hopefully empty) of errors that occurred while attempting to make assertions,\n                           each of the form (ERROR-TYPE ERROR-STRING)"), list(makeSymbol("CHECK-TYPE"), makeSymbol("NOUN-STRING"), makeSymbol("STRINGP")), list(makeSymbol("CLET"), list(list(makeSymbol("TOOL"), constant_handles.reader_make_constant_shell(makeString("CycNounLearnerTool"))), list(makeSymbol("NEW-CONSTANT"), list(makeSymbol("CREATE-CONSTANT-USING-TOOL"), makeSymbol("NOUN-STRING"), makeSymbol("TOOL"), makeSymbol("TAXONOMY-MT"))), makeSymbol("ISA-OR-GENLS"), list(makeSymbol("ERROR-DATA"), NIL)), list(makeSymbol("PCASE"), makeSymbol("COLLECTION-OR-INDIVIDUAL"), list(makeKeyword("COLLECTION"), list(makeSymbol("CLET"), list(list(makeSymbol("SOPHISTICATED-ISAS"), list(makeSymbol("GET-SOPHISTICATED-ISAS-BASED-ON-GENLS"), makeSymbol("LIST-OF-TYPES"), makeSymbol("TAXONOMY-MT")))), list(makeSymbol("DO-LIST"), list(makeSymbol("ISA"), makeSymbol("SOPHISTICATED-ISAS")), list(makeSymbol("KE-ASSERT-USING-TOOL-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("isa")), makeSymbol("NEW-CONSTANT"), makeSymbol("ISA")), makeSymbol("TAXONOMY-MT"), makeSymbol("TOOL"), makeSymbol("ERROR-DATA")))), list(makeSymbol("CSETQ"), makeSymbol("ISA-OR-GENLS"), constant_handles.reader_make_constant_shell(makeString("genls")))), list(makeKeyword("INDIVIDUAL"), list(makeSymbol("CSETQ"), makeSymbol("ISA-OR-GENLS"), constant_handles.reader_make_constant_shell(makeString("isa")))), list(makeSymbol("OTHERWISE"), list(makeSymbol("ERROR"), makeString("~S is not :COLLECTION or :INDIVIDUAL"), makeSymbol("COLLECTION-OR-INDIVIDUAL")))), list(makeSymbol("CDOLIST"), list(makeSymbol("TYPE"), makeSymbol("LIST-OF-TYPES")), list(makeSymbol("KE-ASSERT-USING-TOOL-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), makeSymbol("ISA-OR-GENLS"), makeSymbol("NEW-CONSTANT"), makeSymbol("TYPE")), makeSymbol("TAXONOMY-MT"), makeSymbol("TOOL"), makeSymbol("ERROR-DATA"))), list(makeSymbol("KE-ASSERT-USING-TOOL-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("termStrings")), makeSymbol("NEW-CONSTANT"), makeSymbol("NOUN-STRING")), makeSymbol("LEXICAL-MT"), makeSymbol("TOOL"), makeSymbol("ERROR-DATA")), list(makeSymbol("PWHEN"), makeSymbol("GLOSS"), list(makeSymbol("KE-ASSERT-USING-TOOL-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("nounLearnerSenseGloss")), makeSymbol("NEW-CONSTANT"), makeSymbol("GLOSS")), makeSymbol("TAXONOMY-MT"), makeSymbol("TOOL"), makeSymbol("ERROR-DATA"))), list(makeSymbol("PWHEN"), makeSymbol("NEEDS-OE?"), list(makeSymbol("KE-ASSERT-USING-TOOL-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("isa")), makeSymbol("NEW-CONSTANT"), constant_handles.reader_make_constant_shell(makeString("PoorlyOntologized"))), makeSymbol("TAXONOMY-MT"), makeSymbol("TOOL"), makeSymbol("ERROR-DATA"))), list(RET, list(makeSymbol("NREVERSE"), makeSymbol("ERROR-DATA")))));
    ...
    static private final SubLList $list_alt135 = list(list(makeSymbol("CHECK-TYPE"), makeSymbol("NAME-STRING"), makeSymbol("STRINGP")), list(makeSymbol("CLET"), list(list(makeSymbol("TOOL"), constant_handles.reader_make_constant_shell(makeString("CycNounLearnerTool"))), list(makeSymbol("ERROR-DATA"), NIL), list(makeSymbol("QUERY-RESULT"), list(makeSymbol("ASK-VARIABLE"), list(QUOTE, makeSymbol("?NAME")), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("and")), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("isa")), list(QUOTE, makeSymbol("?NAME")), constant_handles.reader_make_constant_shell(makeString("Name"))), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("nameSpelling")), list(QUOTE, makeSymbol("?NAME")), makeSymbol("NAME-STRING"))), constant_handles.reader_make_constant_shell(makeString("InferencePSC")))), list(makeSymbol("NAME-CONSTANT"), list(makeSymbol("FIF"), makeSymbol("QUERY-RESULT"), list(makeSymbol("FIRST"), makeSymbol("QUERY-RESULT")), list(makeSymbol("CREATE-CONSTANT-USING-TOOL"), makeSymbol("NAME-STRING"), makeSymbol("TOOL"), makeSymbol("TAXONONY-MT"), makeString("-TheName"))))), list(makeSymbol("PUNLESS"), list(makeSymbol("ISA-IN-ANY-MT?"), makeSymbol("NAME-CONSTANT"), constant_handles.reader_make_constant_shell(makeString("HumanSurname"))), list(makeSymbol("KE-ASSERT-USING-TOOL-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("isa")), makeSymbol("NAME-CONSTANT"), constant_handles.reader_make_constant_shell(makeString("HumanSurname"))), makeSymbol("TAXONONY-MT"), makeSymbol("TOOL"), makeSymbol("ERROR-DATA"))), list(makeSymbol("PUNLESS"), makeSymbol("QUERY-RESULT"), list(makeSymbol("KE-ASSERT-USING-TOOL-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("nameSpelling")), makeSymbol("NAME-CONSTANT"), makeSymbol("NAME-STRING")), makeSymbol("LEXICAL-MT"), makeSymbol("TOOL"), makeSymbol("ERROR-DATA"))), list(RET, list(makeSymbol("NREVERSE"), makeSymbol("ERROR-DATA")))));
    ...
    static private final SubLList $list_alt146 = list(makeString("Record in the KB that NOUN-STRING was skipped in the #$CycNounLearnerTool by THE-CYCLIST just #$Now."), list(makeSymbol("CHECK-TYPE"), makeSymbol("NOUN-STRING"), makeSymbol("STRINGP")), list(makeSymbol("CLET"), list(list(makeSymbol("MT"), constant_handles.reader_make_constant_shell(makeString("CycNounLearnerToolUserActivityMt"))), makeSymbol("NEW-SKIPPING-EVENT"), list(makeSymbol("ERROR-DATA"), NIL)), list(makeSymbol("WITH-RKF-NAME-PREFIX"), list(makeString("")), list(makeSymbol("CSETQ"), makeSymbol("NEW-SKIPPING-EVENT"), list(makeSymbol("RKF-CREATE"), list(makeSymbol("CCONCATENATE"), makeString("skipping of "), makeSymbol("NOUN-STRING"))))), list(makeSymbol("KE-ASSERT-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("isa")), makeSymbol("NEW-SKIPPING-EVENT"), constant_handles.reader_make_constant_shell(makeString("SkippingAStringInNounLearnerTool"))), makeSymbol("MT"), makeSymbol("ERROR-DATA")), list(makeSymbol("KE-ASSERT-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("performedBy")), makeSymbol("NEW-SKIPPING-EVENT"), list(makeSymbol("THE-CYCLIST"))), makeSymbol("MT"), makeSymbol("ERROR-DATA")), list(makeSymbol("KE-ASSERT-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("stringSkipped")), makeSymbol("NEW-SKIPPING-EVENT"), makeSymbol("NOUN-STRING")), makeSymbol("MT"), makeSymbol("ERROR-DATA")), list(makeSymbol("KE-ASSERT-NOW-OR-PUSH-ERROR-ONTO"), list(makeSymbol("LIST"), constant_handles.reader_make_constant_shell(makeString("endingDate")), makeSymbol("NEW-SKIPPING-EVENT"), list(makeSymbol("INDEXICAL-NOW"))), makeSymbol("MT"), makeSymbol("ERROR-DATA")), list(RET, list(makeSymbol("NREVERSE"), makeSymbol("ERROR-DATA")))));
    ...
    static private final SubLList $list_alt156 = list(makeString("Return a list-representation of this object, where the elements of the list are lists of the following form:\n     (<noun-string> <cyc-constant> <:genls or :isa or :equals>)"), list(makeSymbol("CLET"), list(list(makeSymbol("RESULT"), NIL)), list(makeSymbol("DO-DICTIONARY"), list(makeSymbol("NOUN-STRING"), makeSymbol("NOUN-OBJECT"), makeSymbol("DICTIONARY-OF-NOUNS")), list(makeSymbol("CLET"), list(list(makeSymbol("TAG"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-TAG")))), list(makeSymbol("CONFIDENCE"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-CONFIDENCE-LEVEL")))), list(makeSymbol("STATUS"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-STATUS-IN-CYC"))))), list(makeSymbol("PUNLESS"), list(makeSymbol("KEYWORDP"), makeSymbol("TAG")), list(makeSymbol("PCASE"), makeSymbol("STATUS"), list(makeKeyword("KNOWN-AND-LEXIFIED"), list(makeSymbol("IGNORE"))), list(makeKeyword("KNOWN-BUT-UNLEXIFIED"), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("NOUN-STRING"), makeSymbol("TAG"), makeKeyword("EQUALS"), makeSymbol("CONFIDENCE")), makeSymbol("RESULT"))), list(makeKeyword("UNKNOWN"), list(makeSymbol("CLET"), list(list(makeSymbol("COLLECTION-OR-INDIVIDUAL?"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("COLLECTION-OR-INDIVIDUAL?")))), makeSymbol("GENLS-OR-ISA")), list(makeSymbol("PCASE"), makeSymbol("COLLECTION-OR-INDIVIDUAL?"), list(makeKeyword("COLLECTION"), list(makeSymbol("CSETQ"), makeSymbol("GENLS-OR-ISA"), makeKeyword("GENLS"))), list(makeKeyword("INDIVIDUAL"), list(makeSymbol("CSETQ"), makeSymbol("GENLS-OR-ISA"), makeKeyword("ISA"))), list(makeSymbol("OTHERWISE"), list(makeSymbol("ERROR"), makeString("Expecting :COLLECTION or :INDIVIDUAL, got ~S."), makeSymbol("COLLECTION-OR-INDIVIDUAL?")))), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("NOUN-STRING"), makeSymbol("TAG"), makeSymbol("GENLS-OR-ISA"), makeSymbol("CONFIDENCE")), makeSymbol("RESULT")))), list(makeSymbol("OTHERWISE"), list(makeSymbol("WARN"), makeString("The noun ~S has the status ~S."), makeSymbol("NOUN-STRING"), makeSymbol("STATUS"))))))), list(RET, makeSymbol("RESULT"))));
    ...
    static private final SubLList $list_alt171 = list(list(makeSymbol("DO-DICTIONARY"), list(makeSymbol("NOUN-STRING"), makeSymbol("NOUN-OBJECT"), makeSymbol("DICTIONARY-OF-NOUNS")), list(makeSymbol("CLET"), list(list(makeSymbol("TAG"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-TAG")))), list(makeSymbol("CONFIDENCE"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-CONFIDENCE-LEVEL")))), list(makeSymbol("STATUS"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-STATUS-IN-CYC"))))), list(makeSymbol("PUNLESS"), list(makeSymbol("KEYWORDP"), makeSymbol("TAG")), list(makeSymbol("PCASE"), makeSymbol("STATUS"), list(makeKeyword("KNOWN-AND-LEXIFIED"), list(makeSymbol("IGNORE"))), list(makeKeyword("KNOWN-BUT-UNLEXIFIED"), list(makeSymbol("FORMAT"), T, makeString("~&~S means ~S (confidence: ~S)~%"), makeSymbol("NOUN-STRING"), makeSymbol("TAG"), makeSymbol("CONFIDENCE")), list(makeSymbol("FORCE-OUTPUT"))), list(makeKeyword("UNKNOWN"), list(makeSymbol("CLET"), list(list(makeSymbol("COLLECTION-OR-INDIVIDUAL?"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("COLLECTION-OR-INDIVIDUAL?")))), makeSymbol("GENLS-OR-ISA")), list(makeSymbol("PCASE"), makeSymbol("COLLECTION-OR-INDIVIDUAL?"), list(makeKeyword("COLLECTION"), list(makeSymbol("CSETQ"), makeSymbol("GENLS-OR-ISA"), makeString("is a spec of"))), list(makeKeyword("INDIVIDUAL"), list(makeSymbol("CSETQ"), makeSymbol("GENLS-OR-ISA"), makeString("is an instance of"))), list(makeSymbol("OTHERWISE"), list(makeSymbol("ERROR"), makeString("Expecting :COLLECTION or :INDIVIDUAL, got ~S."), makeSymbol("COLLECTION-OR-INDIVIDUAL?")))), list(makeSymbol("FORMAT"), T, makeString("~&~S ~A ~S (confidence: ~S)~%"), makeSymbol("NOUN-STRING"), makeSymbol("GENLS-OR-ISA"), makeSymbol("TAG"), makeSymbol("CONFIDENCE"))), list(makeSymbol("FORCE-OUTPUT"))), list(makeSymbol("OTHERWISE"), list(makeSymbol("WARN"), makeString("The noun ~S has the status ~S."), makeSymbol("NOUN-STRING"), makeSymbol("STATUS"))))))), list(RET, NIL));
    ...
    static private final SubLList $list_alt179 = list(list(makeSymbol("CLET"), list(list(makeSymbol("LIST"), NIL)), list(makeSymbol("DO-LEARNED-SIMPLE-NOUNS"), list(makeSymbol("SIMPLE-NOUN"), makeKeyword("CONFIDENCE-THRESHOLD"), makeSymbol("CONFIDENCE-THRESHOLD"), makeKeyword("STATUSES"), list(QUOTE, list(makeKeyword("UNKNOWN")))), list(makeSymbol("CLET"), list(list(makeSymbol("TAG"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-TAG"))))), list(makeSymbol("PUNLESS"), list(makeSymbol("KEYWORDP"), makeSymbol("TAG")), list(makeSymbol("CPUSH"), makeSymbol("SIMPLE-NOUN"), makeSymbol("LIST"))))), list(makeSymbol("CSETQ"), makeSymbol("LIST"), list(makeSymbol("SORT"), makeSymbol("LIST"), list(makeSymbol("FUNCTION"), makeSymbol(">")), list(makeSymbol("FUNCTION"), makeSymbol("SIMPLE-NOUN-GET-CONFIDENCE-LEVEL-METHOD")))), list(makeSymbol("CDOLIST"), list(makeSymbol("SIMPLE-NOUN"), makeSymbol("LIST")), list(makeSymbol("FORMAT"), T, makeString("~%~S  ~S   (confidence: ~S)"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-STRING"))), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-TAG"))), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-CONFIDENCE-LEVEL")))))), list(RET, NIL));
    ...
    static private final SubLList $list_alt188 = list(list(makeSymbol("CLET"), list(list(makeSymbol("LIST"), NIL)), list(makeSymbol("DO-LEARNED-SIMPLE-NOUNS"), list(makeSymbol("SIMPLE-NOUN"), makeKeyword("CONFIDENCE-THRESHOLD"), makeSymbol("CONFIDENCE-THRESHOLD"), makeKeyword("STATUSES"), list(QUOTE, list(makeKeyword("UNKNOWN")))), list(makeSymbol("CLET"), list(list(makeSymbol("TOP-N-TAGS"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-TOP-N-TAGS")), makeSymbol("N")))), list(makeSymbol("PUNLESS"), list(makeSymbol("KEYWORDP"), makeSymbol("TOP-N-TAGS")), list(makeSymbol("CPUSH"), makeSymbol("SIMPLE-NOUN"), makeSymbol("LIST"))))), list(makeSymbol("CSETQ"), makeSymbol("LIST"), list(makeSymbol("SORT"), makeSymbol("LIST"), list(makeSymbol("FUNCTION"), makeSymbol(">")), list(makeSymbol("FUNCTION"), makeSymbol("SIMPLE-NOUN-GET-CONFIDENCE-LEVEL-METHOD")))), list(makeSymbol("CDOLIST"), list(makeSymbol("SIMPLE-NOUN"), makeSymbol("LIST")), list(makeSymbol("TERPRI")), list(makeSymbol("TERPRI")), list(makeSymbol("WRITE-STRING"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-STRING")))), list(makeSymbol("CDOLIST"), list(makeSymbol("TAG"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-TOP-N-TAGS")), makeSymbol("N"))), list(makeSymbol("PRINT"), makeSymbol("TAG"))), list(makeSymbol("FORMAT"), T, makeString("~%confidence: ~S"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-CONFIDENCE-LEVEL")))))), list(RET, NIL));
    ...
    static private final SubLList $list_alt197 = list(makeString("Get rid of irrelevant nouns in order to reclaim the memory they are using"), list(makeSymbol("CLET"), list(list(makeSymbol("IRRELEVANT-NOUN-STRINGS"), NIL)), list(makeSymbol("DO-DICTIONARY"), list(makeSymbol("NOUN-STRING"), makeSymbol("NOUN-OBJECT"), makeSymbol("DICTIONARY-OF-NOUNS")), list(makeSymbol("CLET"), list(list(makeSymbol("TOTAL-COUNT"), list(makeSymbol("FIF"), list(makeSymbol("SIMPLE-NOUN-P"), makeSymbol("NOUN-OBJECT")), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT"))), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN")))))), list(makeSymbol("PWHEN"), list(makeSymbol("<"), makeSymbol("TOTAL-COUNT"), makeSymbol("NOUN-RELEVANCE-COUNT-THRESHOLD")), list(makeSymbol("CPUSH"), makeSymbol("NOUN-STRING"), makeSymbol("IRRELEVANT-NOUN-STRINGS"))))), list(makeSymbol("CDOLIST"), list(makeSymbol("NOUN-STRING"), makeSymbol("IRRELEVANT-NOUN-STRINGS")), list(makeSymbol("DICTIONARY-REMOVE"), makeSymbol("DICTIONARY-OF-NOUNS"), makeSymbol("NOUN-STRING")))), list(RET, NIL));
    ...
    static private final SubLList $list_alt203 = list(makeString("@return integerp; the number of times NOUN occurred in the data in the RELATION position,\n                     or in total if RELATION is nil"), list(makeSymbol("CHECK-TYPE-IF-PRESENT"), makeSymbol("RELATION"), makeSymbol("NL-STATS-SUPPORTED-VERB-ARG-POSITION-P")), list(makeSymbol("CLET"), list(list(makeSymbol("NOUN-OBJECT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-NOUN")), makeSymbol("NOUN-STRING")))), list(makeSymbol("PCOND"), list(list(makeSymbol("SIMPLE-NOUN-P"), makeSymbol("NOUN-OBJECT")), list(RET, list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT")), makeSymbol("RELATION")))), list(list(makeSymbol("COMPLEX-NOUN-P"), makeSymbol("NOUN-OBJECT")), list(makeSymbol("PIF"), makeSymbol("RELATION"), list(makeSymbol("PROGN"), list(makeSymbol("WARN"), makeString("We don't keep track of occurrences of complex nouns by subject position, only in total.")), list(RET, NIL)), list(RET, list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT")))))), list(list(makeSymbol("NULL"), makeSymbol("NOUN-OBJECT")), list(RET, ZERO_INTEGER)))));
    ...
    static private final SubLList $list_alt210 = list(makeString("Returns the tag (i.e. most likely collection) of the noun NOUN-STRING."), list(makeSymbol("CLET"), list(list(makeSymbol("NOUN-OBJECT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-NOUN")), makeSymbol("NOUN-STRING")))), list(makeSymbol("PIF"), makeSymbol("NOUN-OBJECT"), list(RET, list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-TAG")))), list(RET, NIL))));
    ...
    static private final SubLList $list_alt213 = list(makeString("Returns a measure of our confidence in the tag of the noun NOUN-STRING."), list(makeSymbol("CLET"), list(list(makeSymbol("NOUN-OBJECT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-NOUN")), makeSymbol("NOUN-STRING")))), list(makeSymbol("PIF"), makeSymbol("NOUN-OBJECT"), list(RET, list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-CONFIDENCE-LEVEL")))), list(RET, NIL))));
    ...
    static private final SubLList $list_alt217 = list(list(makeSymbol("CLET"), list(list(makeSymbol("SIMPLE-NOUN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-NOUN")), makeSymbol("SIMPLE-NOUN-STRING")))), list(makeSymbol("PIF"), list(makeSymbol("SIMPLE-NOUN-P"), makeSymbol("SIMPLE-NOUN")), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("PRINT-COUNTS"))), list(makeSymbol("FORMAT"), T, makeString("~&Can't find the simple noun ~S~%"), makeSymbol("SIMPLE-NOUN-STRING")))), list(RET, NIL));
    ...
    static private final SubLList $list_alt222 = list(list(makeSymbol("CLET"), list(list(makeSymbol("SIMPLE-NOUN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-NOUN")), makeSymbol("SIMPLE-NOUN-STRING")))), list(makeSymbol("PIF"), list(makeSymbol("SIMPLE-NOUN-P"), makeSymbol("SIMPLE-NOUN")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("WHY-NOT-TAGGED-AS-INT")), makeSymbol("SIMPLE-NOUN"), makeSymbol("BETTER-TAG")), list(makeSymbol("FORMAT"), T, makeString("~&Can't find the simple noun ~S~%"), makeSymbol("SIMPLE-NOUN-STRING")))), list(RET, NIL));
    ...
    static private final SubLList $list_alt244 = list(list(makeSymbol("CLET"), list(list(makeSymbol("NOUN-OBJECT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-NOUN")), makeSymbol("NOUN-STRING")))), list(makeSymbol("PUNLESS"), makeSymbol("NOUN-OBJECT"), list(makeSymbol("CSETQ"), makeSymbol("NOUN-OBJECT"), list(makeSymbol("NEW-SIMPLE-NOUN"), makeSymbol("SELF"), makeSymbol("NOUN-STRING"))), list(makeSymbol("DICTIONARY-ENTER"), makeSymbol("DICTIONARY-OF-NOUNS"), makeSymbol("NOUN-STRING"), makeSymbol("NOUN-OBJECT"))), list(RET, makeSymbol("NOUN-OBJECT"))));
    ...
    static private final SubLList $list_alt248 = list(list(makeSymbol("CLET"), list(list(makeSymbol("COMPLEX-NOUN-OBJECT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-NOUN")), makeSymbol("COMPLEX-NOUN-STRING")))), list(makeSymbol("PUNLESS"), makeSymbol("COMPLEX-NOUN-OBJECT"), list(makeSymbol("CSETQ"), makeSymbol("COMPLEX-NOUN-OBJECT"), list(makeSymbol("NEW-COMPLEX-NOUN"), makeSymbol("SELF"), makeSymbol("COMPLEX-NOUN-STRING"), makeSymbol("HEAD-NOUN-OBJECT"))), list(makeSymbol("DICTIONARY-ENTER"), makeSymbol("DICTIONARY-OF-NOUNS"), makeSymbol("COMPLEX-NOUN-STRING"), makeSymbol("COMPLEX-NOUN-OBJECT")), list(makeSymbol("FIM"), makeSymbol("HEAD-NOUN-OBJECT"), list(QUOTE, makeSymbol("LINK-COMPLEX-NOUN")), makeSymbol("COMPLEX-NOUN-OBJECT"))), list(RET, makeSymbol("COMPLEX-NOUN-OBJECT"))));
    ...
    static private final SubLList $list_alt253 = list(list(makeSymbol("CHECK-TYPE"), makeSymbol("KE-FILE-PATH"), makeSymbol("STRINGP")), list(makeSymbol("CHECK-TYPE"), makeSymbol("NOTES-FILE-PATH"), makeSymbol("STRINGP")), list(makeSymbol("WITH-TEXT-FILE"), list(makeSymbol("KE-STREAM"), makeSymbol("KE-FILE-PATH"), makeKeyword("OUTPUT")), list(makeSymbol("WITH-TEXT-FILE"), list(makeSymbol("NOTES-STREAM"), makeSymbol("NOTES-FILE-PATH"), makeKeyword("OUTPUT")), list(makeSymbol("DO-DICTIONARY"), list(makeSymbol("NOUN-STRING"), makeSymbol("NOUN-OBJECT"), makeSymbol("DICTIONARY-OF-NOUNS")), list(makeSymbol("CLET"), list(list(makeSymbol("TAG"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-TAG")))), list(makeSymbol("STATUS"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("GET-STATUS-IN-CYC"))))), list(makeSymbol("PUNLESS"), list(makeSymbol("KEYWORDP"), makeSymbol("TAG")), list(makeSymbol("PCASE"), makeSymbol("STATUS"), list(makeKeyword("KNOWN-AND-LEXIFIED"), list(makeSymbol("IGNORE"))), list(makeKeyword("KNOWN-BUT-UNLEXIFIED"), list(makeSymbol("PIF"), list(makeSymbol("FORT-P"), makeSymbol("TAG")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("KE-TEXT-LEXIFICATION")), makeSymbol("NOUN-STRING"), makeSymbol("TAG"), makeSymbol("KE-STREAM")), list(makeSymbol("FORMAT"), makeSymbol("NOTES-STREAM"), makeString("~&~%Not lexifying ~S because ~S is not reified.~%"), makeSymbol("NOUN-STRING"), makeSymbol("TAG")))), list(makeKeyword("UNKNOWN"), list(makeSymbol("CLET"), list(list(makeSymbol("COLLECTION-OR-INDIVIDUAL?"), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("COLLECTION-OR-INDIVIDUAL?")))), list(makeSymbol("NEW-CONSTANT-NAME"), list(makeSymbol("GENERATE-CONSTANT-NAME-FOR-NOUN"), makeSymbol("NOUN-STRING")))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("KE-TEXT-REIFICATION")), makeSymbol("NEW-CONSTANT-NAME"), makeSymbol("TAG"), makeSymbol("COLLECTION-OR-INDIVIDUAL?"), makeSymbol("KE-STREAM")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("KE-TEXT-LEXIFICATION")), makeSymbol("NOUN-STRING"), makeSymbol("NEW-CONSTANT-NAME"), makeSymbol("KE-STREAM")))), list(makeSymbol("OTHERWISE"), list(makeSymbol("ERROR"), makeString("I don't understand the status ~S."), makeSymbol("STATUS"))))))))), list(RET, NIL));
    ...
    static private final SubLList $list_alt263 = list(list(makeSymbol("CLET"), list(list(makeSymbol("PREDICATE"), list(makeSymbol("FCOND"), list(list(EQ, makeSymbol("COLLECTION-OR-INDIVIDUAL?"), makeKeyword("COLLECTION")), makeString("genls")), list(list(EQ, makeSymbol("COLLECTION-OR-INDIVIDUAL?"), makeKeyword("INDIVIDUAL")), makeString("isa"))))), list(makeSymbol("CSETQ"), makeSymbol("TAG"), list(makeSymbol("NART-EXPAND"), makeSymbol("TAG"))), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("~&~%Constant: ~A.~%"), makeSymbol("CONSTANT-NAME")), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("~A: ~S.~%~%"), makeSymbol("PREDICATE"), makeSymbol("TAG")), list(RET, NIL)));
    ...
    static private final SubLList $list_alt275 = list(makeString("Partition nouns that are to be worked on in the java tool into groups of approximately MIN-LIST-LENGTH,\n   which is a reasonable number for a person to work on at a time.\n   For now, I\'m keeping :UNKNOWN simple nouns separate from :KNOWN-BUT-UNLEXIFIED simple nouns, because the tool is not\n   set up to handle :KNOWN-BUT-UNLEXIFIED nouns intelligently.  Complex nouns are stuck in after their heads if their\n   heads are included, the rest are shoved into a third group.\n   For now, I\'m ordering simple nouns by number of occurrences (ignoring confidence).\n   @return triple? of listp of listp of noun-p:\n           (1) a list of manageable lists of unknown simple nouns and associated complex nouns\n           (2) a list of manageable lists of known-but-unlexified simple nouns and associated complex nouns\n           (3) a list of manageable lists of complex nouns whose heads are known-and-lexified (and thus not included)"), list(makeSymbol("CLET"), list(list(makeSymbol("LIST-OF-RELEVANT-UNKNOWN-SIMPLE-NOUNS"), NIL), list(makeSymbol("LIST-OF-RELEVANT-KNOWN-BUT-UNLEXIFIED-SIMPLE-NOUNS"), NIL), list(makeSymbol("LIST-OF-RELEVANT-KNOWN-AND-LEXIFIED-SIMPLE-NOUNS"), NIL)), list(makeSymbol("DO-LEARNED-SIMPLE-NOUNS"), list(makeSymbol("SIMPLE-NOUN"), makeKeyword("COUNT-THRESHOLD"), makeSymbol("NOUN-RELEVANCE-COUNT-THRESHOLD")), list(makeSymbol("PCASE"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-STATUS-IN-CYC"))), list(makeKeyword("UNKNOWN"), list(makeSymbol("CPUSH"), makeSymbol("SIMPLE-NOUN"), makeSymbol("LIST-OF-RELEVANT-UNKNOWN-SIMPLE-NOUNS"))), list(makeKeyword("KNOWN-BUT-UNLEXIFIED"), list(makeSymbol("CPUSH"), makeSymbol("SIMPLE-NOUN"), makeSymbol("LIST-OF-RELEVANT-KNOWN-BUT-UNLEXIFIED-SIMPLE-NOUNS"))), list(makeKeyword("KNOWN-AND-LEXIFIED"), list(makeSymbol("CPUSH"), makeSymbol("SIMPLE-NOUN"), makeSymbol("LIST-OF-RELEVANT-KNOWN-AND-LEXIFIED-SIMPLE-NOUNS"))))), list(makeSymbol("SORT"), makeSymbol("LIST-OF-RELEVANT-UNKNOWN-SIMPLE-NOUNS"), list(makeSymbol("FUNCTION"), makeSymbol(">")), list(makeSymbol("FUNCTION"), makeSymbol("SIMPLE-NOUN-GET-TOTAL-COUNT-METHOD"))), list(makeSymbol("SORT"), makeSymbol("LIST-OF-RELEVANT-KNOWN-BUT-UNLEXIFIED-SIMPLE-NOUNS"), list(makeSymbol("FUNCTION"), makeSymbol(">")), list(makeSymbol("FUNCTION"), makeSymbol("SIMPLE-NOUN-GET-TOTAL-COUNT-METHOD"))), list(new SubLObject[]{ makeSymbol("CLET"), list(list(makeSymbol("LIST-OF-LISTS-OF-RELEVANT-UNKNOWN-NOUNS"), NIL), list(makeSymbol("LIST-OF-LISTS-OF-RELEVANT-KNOWN-BUT-UNLEXIFIED-NOUNS"), NIL), list(makeSymbol("LIST-OF-LISTS-OF-RELEVANT-ORPHAN-COMPLEX-NOUNS"), NIL), list(makeSymbol("CURRENT-SMALL-LIST"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("SIMPLE-NOUN"), makeSymbol("LIST-OF-RELEVANT-UNKNOWN-SIMPLE-NOUNS")), list(makeSymbol("CPUSH"), makeSymbol("SIMPLE-NOUN"), makeSymbol("CURRENT-SMALL-LIST")), list(makeSymbol("CLET"), list(list(makeSymbol("COMPLEX-NOUNS"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-COMPLEX-NOUNS-HEADED-BY-THIS-NOUN"))))), list(makeSymbol("CDOLIST"), list(makeSymbol("COMPLEX-NOUN"), makeSymbol("COMPLEX-NOUNS")), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol(">="), list(makeSymbol("FIM"), makeSymbol("COMPLEX-NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN"))), makeSymbol("NOUN-RELEVANCE-COUNT-THRESHOLD")), list(makeSymbol("CNOT"), list(EQ, makeKeyword("KNOWN-AND-LEXIFIED"), list(makeSymbol("FIM"), makeSymbol("COMPLEX-NOUN"), list(QUOTE, makeSymbol("GET-STATUS-IN-CYC")))))), list(makeSymbol("CPUSH"), makeSymbol("COMPLEX-NOUN"), makeSymbol("CURRENT-SMALL-LIST"))))), list(makeSymbol("PWHEN"), list(makeSymbol("LENGTH>="), makeSymbol("CURRENT-SMALL-LIST"), makeSymbol("MIN-LIST-LENGTH")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), list(makeSymbol("NREVERSE"), makeSymbol("CURRENT-SMALL-LIST"))), list(makeSymbol("CPUSH"), makeSymbol("CURRENT-SMALL-LIST"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-UNKNOWN-NOUNS")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), NIL))), list(makeSymbol("PUNLESS"), list(makeSymbol("EMPTY-LIST-P"), makeSymbol("CURRENT-SMALL-LIST")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), list(makeSymbol("NREVERSE"), makeSymbol("CURRENT-SMALL-LIST"))), list(makeSymbol("CPUSH"), makeSymbol("CURRENT-SMALL-LIST"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-UNKNOWN-NOUNS")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("SIMPLE-NOUN"), makeSymbol("LIST-OF-RELEVANT-KNOWN-BUT-UNLEXIFIED-SIMPLE-NOUNS")), list(makeSymbol("CPUSH"), makeSymbol("SIMPLE-NOUN"), makeSymbol("CURRENT-SMALL-LIST")), list(makeSymbol("CLET"), list(list(makeSymbol("COMPLEX-NOUNS"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-COMPLEX-NOUNS-HEADED-BY-THIS-NOUN"))))), list(makeSymbol("CDOLIST"), list(makeSymbol("COMPLEX-NOUN"), makeSymbol("COMPLEX-NOUNS")), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol(">="), list(makeSymbol("FIM"), makeSymbol("COMPLEX-NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN"))), makeSymbol("NOUN-RELEVANCE-COUNT-THRESHOLD")), list(makeSymbol("CNOT"), list(EQ, makeKeyword("KNOWN-AND-LEXIFIED"), list(makeSymbol("FIM"), makeSymbol("COMPLEX-NOUN"), list(QUOTE, makeSymbol("GET-STATUS-IN-CYC")))))), list(makeSymbol("CPUSH"), makeSymbol("COMPLEX-NOUN"), makeSymbol("CURRENT-SMALL-LIST"))))), list(makeSymbol("PWHEN"), list(makeSymbol("LENGTH>="), makeSymbol("CURRENT-SMALL-LIST"), makeSymbol("MIN-LIST-LENGTH")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), list(makeSymbol("NREVERSE"), makeSymbol("CURRENT-SMALL-LIST"))), list(makeSymbol("CPUSH"), makeSymbol("CURRENT-SMALL-LIST"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-KNOWN-BUT-UNLEXIFIED-NOUNS")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), NIL))), list(makeSymbol("PUNLESS"), list(makeSymbol("EMPTY-LIST-P"), makeSymbol("CURRENT-SMALL-LIST")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), list(makeSymbol("NREVERSE"), makeSymbol("CURRENT-SMALL-LIST"))), list(makeSymbol("CPUSH"), makeSymbol("CURRENT-SMALL-LIST"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-KNOWN-BUT-UNLEXIFIED-NOUNS")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("SIMPLE-NOUN"), makeSymbol("LIST-OF-RELEVANT-KNOWN-AND-LEXIFIED-SIMPLE-NOUNS")), list(makeSymbol("CLET"), list(list(makeSymbol("COMPLEX-NOUNS"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-COMPLEX-NOUNS-HEADED-BY-THIS-NOUN"))))), list(makeSymbol("CDOLIST"), list(makeSymbol("COMPLEX-NOUN"), makeSymbol("COMPLEX-NOUNS")), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol(">="), list(makeSymbol("FIM"), makeSymbol("COMPLEX-NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN"))), makeSymbol("NOUN-RELEVANCE-COUNT-THRESHOLD")), list(makeSymbol("CNOT"), list(EQ, makeKeyword("KNOWN-AND-LEXIFIED"), list(makeSymbol("FIM"), makeSymbol("COMPLEX-NOUN"), list(QUOTE, makeSymbol("GET-STATUS-IN-CYC")))))), list(makeSymbol("CPUSH"), makeSymbol("COMPLEX-NOUN"), makeSymbol("CURRENT-SMALL-LIST"))))), list(makeSymbol("PWHEN"), list(makeSymbol("LENGTH>="), makeSymbol("CURRENT-SMALL-LIST"), makeSymbol("MIN-LIST-LENGTH")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), list(makeSymbol("NREVERSE"), makeSymbol("CURRENT-SMALL-LIST"))), list(makeSymbol("CPUSH"), makeSymbol("CURRENT-SMALL-LIST"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-ORPHAN-COMPLEX-NOUNS")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), NIL))), list(makeSymbol("PUNLESS"), list(makeSymbol("EMPTY-LIST-P"), makeSymbol("CURRENT-SMALL-LIST")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-SMALL-LIST"), list(makeSymbol("NREVERSE"), makeSymbol("CURRENT-SMALL-LIST"))), list(makeSymbol("CPUSH"), makeSymbol("CURRENT-SMALL-LIST"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-ORPHAN-COMPLEX-NOUNS"))), list(RET, list(makeSymbol("LIST"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-UNKNOWN-NOUNS"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-KNOWN-BUT-UNLEXIFIED-NOUNS"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-ORPHAN-COMPLEX-NOUNS"))) })));
    ...
    static private final SubLList $list_alt282 = list(list(makeSymbol("CLET"), list(list(makeSymbol("UNJAVAFIED-RESULT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GROUP-NOUNS-INTO-LISTS-FOR-JAVA-TOOL")), makeSymbol("MIN-LIST-LENGTH"))), list(makeSymbol("JAVAFIED-RESULT"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("LIST-OF-LISTS-OF-NOUNS"), makeSymbol("UNJAVAFIED-RESULT")), list(makeSymbol("CLET"), list(list(makeSymbol("LIST-OF-LISTS-OF-JAVAFIED-NOUNS"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("LIST-OF-NOUNS"), makeSymbol("LIST-OF-LISTS-OF-NOUNS")), list(makeSymbol("CLET"), list(list(makeSymbol("LIST-OF-JAVAFIED-NOUNS"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("NOUN"), makeSymbol("LIST-OF-NOUNS")), list(makeSymbol("CPUSH"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("JAVAFY")), makeSymbol("MAX-RANKING-LENGTH")), makeSymbol("LIST-OF-JAVAFIED-NOUNS"))), list(makeSymbol("CSETQ"), makeSymbol("LIST-OF-JAVAFIED-NOUNS"), list(makeSymbol("NREVERSE"), makeSymbol("LIST-OF-JAVAFIED-NOUNS"))), list(makeSymbol("CPUSH"), makeSymbol("LIST-OF-JAVAFIED-NOUNS"), makeSymbol("LIST-OF-LISTS-OF-JAVAFIED-NOUNS")))), list(makeSymbol("CSETQ"), makeSymbol("LIST-OF-LISTS-OF-JAVAFIED-NOUNS"), list(makeSymbol("NREVERSE"), makeSymbol("LIST-OF-LISTS-OF-JAVAFIED-NOUNS"))), list(makeSymbol("CPUSH"), makeSymbol("LIST-OF-LISTS-OF-JAVAFIED-NOUNS"), makeSymbol("JAVAFIED-RESULT")))), list(RET, list(makeSymbol("NREVERSE"), makeSymbol("JAVAFIED-RESULT")))));
    ...
    static private final SubLList $list_alt288 = list(list(makeSymbol("CHECK-TYPE"), makeSymbol("DIRECTORY"), makeSymbol("DIRECTORY-P")), list(makeSymbol("CSETQ"), makeSymbol("DIRECTORY"), list(makeSymbol("NORMALIZE-DIRECTORY-NAME"), makeSymbol("DIRECTORY"))), list(makeSymbol("CLET"), list(list(makeSymbol("UNKNOWN-PREFIX"), makeString("unknown-javafied-noun-list-")), list(makeSymbol("KNOWN-BUT-UNLEXIFIED-PREFIX"), makeString("known-but-unlexified-javafied-noun-list-")), list(makeSymbol("ORPHAN-COMPLEX-PREFIX"), makeString("orphan-complex-javafied-noun-list-")), list(makeSymbol("SUFFIX"), makeString(".cfasl"))), list(makeSymbol("CDESTRUCTURING-BIND"), list(makeSymbol("LIST-OF-LISTS-OF-RELEVANT-UNKNOWN-NOUNS"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-KNOWN-BUT-UNLEXIFIED-NOUNS"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-ORPHAN-COMPLEX-NOUNS")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GROUP-NOUNS-INTO-LISTS-FOR-JAVA-TOOL")), makeSymbol("MIN-LIST-LENGTH")), list(makeSymbol("CDOLIST-NUMBERED"), list(makeSymbol("LIST-OF-UNKNOWN-NOUNS"), makeSymbol("INDEX"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-UNKNOWN-NOUNS")), list(makeSymbol("FCM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("SAVE-NOUN-LIST")), makeSymbol("LIST-OF-UNKNOWN-NOUNS"), list(makeSymbol("CCONCATENATE"), makeSymbol("DIRECTORY"), makeSymbol("UNKNOWN-PREFIX"), list(makeSymbol("TO-STRING"), makeSymbol("INDEX")), makeSymbol("SUFFIX")), makeSymbol("MAX-RANKING-LENGTH"))), list(makeSymbol("CDOLIST-NUMBERED"), list(makeSymbol("LIST-OF-KNOWN-BUT-UNLEXIFIED-NOUNS"), makeSymbol("INDEX"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-KNOWN-BUT-UNLEXIFIED-NOUNS")), list(makeSymbol("FCM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("SAVE-NOUN-LIST")), makeSymbol("LIST-OF-KNOWN-BUT-UNLEXIFIED-NOUNS"), list(makeSymbol("CCONCATENATE"), makeSymbol("DIRECTORY"), makeSymbol("KNOWN-BUT-UNLEXIFIED-PREFIX"), list(makeSymbol("TO-STRING"), makeSymbol("INDEX")), makeSymbol("SUFFIX")), makeSymbol("MAX-RANKING-LENGTH"))), list(makeSymbol("CDOLIST-NUMBERED"), list(makeSymbol("LIST-OF-ORPHAN-COMPLEX-NOUNS"), makeSymbol("INDEX"), makeSymbol("LIST-OF-LISTS-OF-RELEVANT-ORPHAN-COMPLEX-NOUNS")), list(makeSymbol("FCM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("SAVE-NOUN-LIST")), makeSymbol("LIST-OF-ORPHAN-COMPLEX-NOUNS"), list(makeSymbol("CCONCATENATE"), makeSymbol("DIRECTORY"), makeSymbol("ORPHAN-COMPLEX-PREFIX"), list(makeSymbol("TO-STRING"), makeSymbol("INDEX")), makeSymbol("SUFFIX")), makeSymbol("MAX-RANKING-LENGTH"))))), list(RET, NIL));
    ...
    static private final SubLList $list_alt298 = list(list(makeSymbol("CHECK-TYPE"), makeSymbol("UNJAVAFIED-NOUN-LIST"), makeSymbol("LISTP")), list(makeSymbol("CHECK-TYPE"), makeSymbol("FILENAME"), makeSymbol("STRINGP")), list(makeSymbol("CHECK-TYPE"), makeSymbol("MAX-RANKING-LENGTH"), makeSymbol("POSITIVE-INTEGER-P")), list(makeSymbol("CLET"), list(list(makeSymbol("JAVAFIED-NOUN-LIST"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("UNJAVAFIED-NOUN"), makeSymbol("UNJAVAFIED-NOUN-LIST")), list(makeSymbol("CPUSH"), list(makeSymbol("FIM"), makeSymbol("UNJAVAFIED-NOUN"), list(QUOTE, makeSymbol("JAVAFY")), makeSymbol("MAX-RANKING-LENGTH")), makeSymbol("JAVAFIED-NOUN-LIST"))), list(makeSymbol("CSETQ"), makeSymbol("JAVAFIED-NOUN-LIST"), list(makeSymbol("NREVERSE"), makeSymbol("JAVAFIED-NOUN-LIST"))), list(makeSymbol("FORMAT"), T, makeString("~%Saving ~A"), makeSymbol("FILENAME")), list(makeSymbol("FORCE-OUTPUT")), list(makeSymbol("CFASL-SAVE-EXTERNALIZED"), makeSymbol("JAVAFIED-NOUN-LIST"), makeSymbol("FILENAME"))), list(RET, NIL));
    ...
    static private final SubLList $list_alt305 = list(makeString("Call @xref CFASL-LOAD and weed out any invalid forts from the result."), list(makeSymbol("CLET"), list(list(makeSymbol("JAVAFIED-NOUNS"), list(makeSymbol("CFASL-LOAD"), makeSymbol("FILENAME"))), list(makeSymbol("RESULT"), NIL)), list(makeSymbol("PIF"), list(makeSymbol("LISTP"), makeSymbol("JAVAFIED-NOUNS")), list(makeSymbol("PROGN"), list(makeSymbol("CDOLIST"), list(makeSymbol("JAVAFIED-NOUN"), makeSymbol("JAVAFIED-NOUNS")), list(makeSymbol("CPUSH"), list(makeSymbol("FCM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("WEED-OUT-INVALID-FORTS")), makeSymbol("JAVAFIED-NOUN")), makeSymbol("RESULT"))), list(makeSymbol("CSETQ"), makeSymbol("RESULT"), list(makeSymbol("NREVERSE"), makeSymbol("RESULT")))), list(makeSymbol("CSETQ"), makeSymbol("RESULT"), makeSymbol("JAVAFIED-NOUNS"))), list(RET, makeSymbol("RESULT"))));
    ...
    static private final SubLList $list_alt311 = list(list(makeSymbol("PIF"), list(makeSymbol("JAVAFIED-NOUN-P"), makeSymbol("JAVAFIED-NOUN")), list(makeSymbol("PROGN"), list(makeSymbol("SET-JAVAFIED-NOUN-CONJECTURES"), makeSymbol("JAVAFIED-NOUN"), list(makeSymbol("WEED-OUT-INVALID-FORTS-FROM-CONJECTURES"), list(makeSymbol("GET-JAVAFIED-NOUN-CONJECTURES"), makeSymbol("JAVAFIED-NOUN")))), list(makeSymbol("PWHEN"), list(makeSymbol("INVALID-FORT?"), list(makeSymbol("GET-JAVAFIED-NOUN-REFINED-TAG"), makeSymbol("JAVAFIED-NOUN"))), list(makeSymbol("SET-JAVAFIED-NOUN-REFINED-TAG"), makeSymbol("JAVAFIED-NOUN"), list(makeSymbol("CAR"), list(makeSymbol("FIRST"), list(makeSymbol("GET-JAVAFIED-NOUN-CONJECTURES"), makeSymbol("JAVAFIED-NOUN"))))))), list(makeSymbol("WARN"), makeString("~S is not a javafied noun"), makeSymbol("JAVAFIED-NOUN"))), list(RET, makeSymbol("JAVAFIED-NOUN")));
    ...
    static private final SubLList $list_alt315 = list(list(makeSymbol("CLET"), list(list(makeSymbol("NOUNS"), list(makeSymbol("DICTIONARY-VALUES"), makeSymbol("DICTIONARY-OF-NOUNS")))), list(makeSymbol("CSETQ"), makeSymbol("NOUNS"), list(makeSymbol("SORT"), makeSymbol("NOUNS"), list(makeSymbol("FUNCTION"), makeSymbol(">")), list(makeSymbol("FUNCTION"), makeSymbol("NOUN-GET-TOTAL-COUNT-AS-WHOLE-NOUN-METHOD")))), list(makeSymbol("WITH-TEXT-FILE"), list(makeSymbol("STREAM"), makeSymbol("FILENAME"), makeKeyword("OUTPUT")), list(makeSymbol("DO-LIST"), list(makeSymbol("NOUN"), makeSymbol("NOUNS")), list(makeSymbol("CLET"), list(list(makeSymbol("COUNT"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN"))))), list(makeSymbol("PWHEN"), list(makeSymbol("POSITIVE-NUMBER-P"), makeSymbol("COUNT")), list(makeSymbol("PRINT"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-STRING"))), makeSymbol("STREAM")), list(makeSymbol("PRINC"), makeString("  "), makeSymbol("STREAM")), list(makeSymbol("PRINC"), makeSymbol("COUNT"), makeSymbol("STREAM"))))))), list(RET, makeSymbol("FILENAME")));
    ...
    static private final SubLList $list_alt320 = list(list(makeSymbol("CLET"), list(list(makeSymbol("NOUNS"), list(makeSymbol("DICTIONARY-VALUES"), makeSymbol("DICTIONARY-OF-NOUNS")))), list(makeSymbol("CSETQ"), makeSymbol("NOUNS"), list(makeSymbol("SORT"), makeSymbol("NOUNS"), list(makeSymbol("FUNCTION"), makeSymbol(">")), list(makeSymbol("FUNCTION"), makeSymbol("NOUN-GET-TOTAL-COUNT-AS-WHOLE-NOUN-METHOD")))), list(makeSymbol("WITH-TEXT-FILE"), list(makeSymbol("STREAM"), makeSymbol("FILENAME"), makeKeyword("OUTPUT")), list(makeSymbol("DO-LIST"), list(makeSymbol("NOUN"), makeSymbol("NOUNS")), list(makeSymbol("PWHEN"), list(makeSymbol("POSITIVE-NUMBER-P"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN")))), list(makeSymbol("CLET"), list(list(makeSymbol("MEANING"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-BEST-MEANING-IN-CYC"))))), list(makeSymbol("PWHEN"), makeSymbol("MEANING"), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("~S  ~S~%"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-STRING"))), makeSymbol("MEANING")))))))), list(RET, makeSymbol("FILENAME")));
    ...
    static private final SubLList $list_alt325 = list(list(makeSymbol("CLET"), list(list(makeSymbol("NOUNS"), list(makeSymbol("DICTIONARY-VALUES"), makeSymbol("DICTIONARY-OF-NOUNS")))), list(makeSymbol("CSETQ"), makeSymbol("NOUNS"), list(makeSymbol("SORT"), makeSymbol("NOUNS"), list(makeSymbol("FUNCTION"), makeSymbol(">")), list(makeSymbol("FUNCTION"), makeSymbol("NOUN-GET-TOTAL-COUNT-AS-WHOLE-NOUN-METHOD")))), list(makeSymbol("WITH-TEXT-FILE"), list(makeSymbol("STREAM"), makeSymbol("FILENAME"), makeKeyword("OUTPUT")), list(makeSymbol("DO-LIST"), list(makeSymbol("NOUN"), makeSymbol("NOUNS")), list(makeSymbol("PWHEN"), list(makeSymbol("POSITIVE-NUMBER-P"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN")))), list(makeSymbol("CLET"), list(list(makeSymbol("MEANINGS"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-MEANINGS-IN-CYC"))))), list(makeSymbol("PWHEN"), list(makeSymbol("EMPTY-LIST-P"), makeSymbol("MEANINGS")), list(makeSymbol("PRINT"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-STRING"))), makeSymbol("STREAM")), list(makeSymbol("PRINC"), makeString("  "), makeSymbol("STREAM")), list(makeSymbol("CLET"), list(list(makeSymbol("TAG"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-REFINED-TAG"))))), list(makeSymbol("PCOND"), list(list(makeSymbol("KB-INDIVIDUAL-P"), makeSymbol("TAG")), list(makeSymbol("PRIN1"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("equals")), makeKeyword("MEANING"), makeSymbol("TAG")), makeSymbol("STREAM"))), list(list(makeSymbol("COLLECTION-P"), makeSymbol("TAG")), list(makeSymbol("CLET"), list(list(makeSymbol("COLL-OR-IND?"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("COLLECTION-OR-INDIVIDUAL?"))))), list(makeSymbol("PIF"), list(EQ, makeSymbol("COLL-OR-IND?"), makeKeyword("INDIVIDUAL")), list(makeSymbol("PRIN1"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("isa")), makeKeyword("MEANING"), makeSymbol("TAG")), makeSymbol("STREAM")), list(makeSymbol("CLET"), list(list(makeSymbol("ISAS"), list(makeSymbol("GET-SOPHISTICATED-ISAS-BASED-ON-GENLS"), list(makeSymbol("LIST"), makeSymbol("TAG")), constant_handles.reader_make_constant_shell(makeString("CurrentWorldDataCollectorMt-NonHomocentric"))))), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("~S"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("genls")), makeKeyword("MEANING"), makeSymbol("TAG"))), list(makeSymbol("DO-LIST"), list(makeSymbol("ISA"), makeSymbol("ISAS")), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("  ~S"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("isa")), makeKeyword("MEANING"), makeSymbol("ISA")))))))), list(list(makeSymbol("KEYWORDP"), makeSymbol("TAG")), list(makeSymbol("PROGN"))))))))))), list(RET, makeSymbol("FILENAME")));
    ...
    static private final SubLList $list_alt335 = list(list(makeSymbol("CLET"), list(list(makeSymbol("NOUNS"), list(makeSymbol("DICTIONARY-VALUES"), makeSymbol("DICTIONARY-OF-NOUNS"))), list(makeSymbol("NOUN-COUNT-LIST"))), list(makeSymbol("CSETQ"), makeSymbol("NOUNS"), list(makeSymbol("SORT"), makeSymbol("NOUNS"), list(makeSymbol("FUNCTION"), makeSymbol("<")), list(makeSymbol("FUNCTION"), makeSymbol("NOUN-GET-TOTAL-COUNT-AS-WHOLE-NOUN-METHOD")))), list(makeSymbol("DO-LIST"), list(makeSymbol("NOUN"), makeSymbol("NOUNS")), list(makeSymbol("CLET"), list(list(makeSymbol("COUNT"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN"))))), list(makeSymbol("PWHEN"), list(makeSymbol("POSITIVE-NUMBER-P"), makeSymbol("COUNT")), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-STRING"))), makeSymbol("COUNT")), makeSymbol("NOUN-COUNT-LIST"))))), list(RET, makeSymbol("NOUN-COUNT-LIST"))));
    ...
    static private final SubLList $list_alt340 = list(list(makeSymbol("CHECK-TYPE"), makeSymbol("CORPUS"), makeSymbol("CYCL-TERM-P")), list(makeSymbol("IGNORE"), makeSymbol("CORPUS-MT")), list(makeSymbol("CHECK-TYPE"), makeSymbol("GRAPHING-MT"), makeSymbol("CYCL-TERM-P")), list(makeSymbol("CLET"), list(list(makeSymbol("NOUNS"), list(makeSymbol("DICTIONARY-VALUES"), makeSymbol("DICTIONARY-OF-NOUNS"))), list(makeSymbol("LISTIFIED-KNOWN-NOUNS"), NIL)), list(makeSymbol("CSETQ"), makeSymbol("NOUNS"), list(makeSymbol("SORT"), makeSymbol("NOUNS"), list(makeSymbol("FUNCTION"), makeSymbol("<")), list(makeSymbol("FUNCTION"), makeSymbol("NOUN-GET-TOTAL-COUNT-AS-WHOLE-NOUN-METHOD")))), list(makeSymbol("DO-LIST"), list(makeSymbol("NOUN"), makeSymbol("NOUNS")), list(makeSymbol("PWHEN"), list(makeSymbol("POSITIVE-NUMBER-P"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN")))), list(makeSymbol("CLET"), list(list(makeSymbol("NOUN-STRING"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-STRING")))), list(makeSymbol("MEANING"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-BEST-MEANING-IN-CYC"))))), list(makeSymbol("PWHEN"), makeSymbol("MEANING"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ASSERT-CORPUS-MENTION-FOR-MYSENTIENT")), makeSymbol("MEANING"), makeSymbol("CORPUS"), makeSymbol("GRAPHING-MT"), constant_handles.reader_make_constant_shell(makeString("TheMySentientTermMapperTool"))), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("NOUN-STRING"), makeSymbol("MEANING")), makeSymbol("LISTIFIED-KNOWN-NOUNS")))))), list(RET, makeSymbol("LISTIFIED-KNOWN-NOUNS"))));
    ...
    static private final SubLList $list_alt346 = list(list(makeSymbol("CHECK-TYPE"), makeSymbol("CORPUS"), makeSymbol("CYCL-TERM-P")), list(makeSymbol("IGNORE"), makeSymbol("CORPUS-MT")), list(makeSymbol("CHECK-TYPE"), makeSymbol("GRAPHING-MT"), makeSymbol("CYCL-TERM-P")), list(makeSymbol("CLET"), list(list(makeSymbol("NOUNS"), list(makeSymbol("DICTIONARY-VALUES"), makeSymbol("DICTIONARY-OF-NOUNS"))), list(makeSymbol("LISTIFIED-UNKNOWN-NOUNS"), NIL)), list(makeSymbol("CSETQ"), makeSymbol("NOUNS"), list(makeSymbol("SORT"), makeSymbol("NOUNS"), list(makeSymbol("FUNCTION"), makeSymbol("<")), list(makeSymbol("FUNCTION"), makeSymbol("NOUN-GET-TOTAL-COUNT-AS-WHOLE-NOUN-METHOD")))), list(makeSymbol("DO-LIST"), list(makeSymbol("NOUN"), makeSymbol("NOUNS")), list(makeSymbol("PWHEN"), list(makeSymbol("POSITIVE-NUMBER-P"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN")))), list(makeSymbol("CLET"), list(list(makeSymbol("MEANINGS"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-MEANINGS-IN-CYC"))))), list(makeSymbol("PWHEN"), list(makeSymbol("EMPTY-LIST-P"), makeSymbol("MEANINGS")), list(makeSymbol("CLET"), list(list(makeSymbol("CONJECTURES"), NIL), list(makeSymbol("TAG"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-REFINED-TAG"))))), list(makeSymbol("PCOND"), list(list(makeSymbol("KB-INDIVIDUAL-P"), makeSymbol("TAG")), list(makeSymbol("CPUSH"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("equals")), makeKeyword("MEANING"), makeSymbol("TAG")), makeSymbol("CONJECTURES"))), list(list(makeSymbol("COLLECTION-P"), makeSymbol("TAG")), list(makeSymbol("CLET"), list(list(makeSymbol("COLL-OR-IND?"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("COLLECTION-OR-INDIVIDUAL?"))))), list(makeSymbol("PIF"), list(EQ, makeSymbol("COLL-OR-IND?"), makeKeyword("INDIVIDUAL")), list(makeSymbol("CPUSH"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("isa")), makeKeyword("MEANING"), makeSymbol("TAG")), makeSymbol("CONJECTURES")), list(makeSymbol("CLET"), list(list(makeSymbol("ISAS"), list(makeSymbol("GET-SOPHISTICATED-ISAS-BASED-ON-GENLS"), list(makeSymbol("LIST"), makeSymbol("TAG")), constant_handles.reader_make_constant_shell(makeString("CurrentWorldDataCollectorMt-NonHomocentric"))))), list(makeSymbol("CPUSH"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("genls")), makeKeyword("MEANING"), makeSymbol("TAG")), makeSymbol("CONJECTURES")), list(makeSymbol("DO-LIST"), list(makeSymbol("ISA"), makeSymbol("ISAS")), list(makeSymbol("CPUSH"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("isa")), makeKeyword("MEANING"), makeSymbol("ISA")), makeSymbol("CONJECTURES"))))))), list(list(makeSymbol("KEYWORDP"), makeSymbol("TAG")), list(makeSymbol("PROGN")))), list(makeSymbol("CLET"), list(list(makeSymbol("NOUN-STRING"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-STRING"))))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("REIFY-UNKNOWN-NOUN-FROM-CORPUS-FOR-MYSENTIENT")), makeSymbol("NOUN-STRING"), makeSymbol("CORPUS"), makeSymbol("GRAPHING-MT"), makeSymbol("CONJECTURES")), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("NOUN-STRING"), makeSymbol("CONJECTURES")), makeSymbol("LISTIFIED-UNKNOWN-NOUNS")))))))), list(RET, makeSymbol("LISTIFIED-UNKNOWN-NOUNS"))));
    ...
    static private final SubLList $list_alt350 = list(list(makeSymbol("CLET"), list(list(makeSymbol("NOUNS"), list(makeSymbol("DICTIONARY-VALUES"), makeSymbol("DICTIONARY-OF-NOUNS"))), list(makeSymbol("LISTIFIED-KNOWN-NOUNS"), NIL), list(makeSymbol("LISTIFIED-UNKNOWN-NOUNS"), NIL)), list(makeSymbol("CSETQ"), makeSymbol("NOUNS"), list(makeSymbol("SORT"), makeSymbol("NOUNS"), list(makeSymbol("FUNCTION"), makeSymbol("<")), list(makeSymbol("FUNCTION"), makeSymbol("NOUN-GET-TOTAL-COUNT-AS-WHOLE-NOUN-METHOD")))), list(makeSymbol("DO-LIST"), list(makeSymbol("NOUN"), makeSymbol("NOUNS")), list(makeSymbol("PWHEN"), list(makeSymbol("POSITIVE-NUMBER-P"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT-AS-WHOLE-NOUN")))), list(makeSymbol("CLET"), list(list(makeSymbol("NOUN-STRING"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-STRING")))), list(makeSymbol("MEANING"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-BEST-MEANING-IN-CYC"))))), list(makeSymbol("PIF"), makeSymbol("MEANING"), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("NOUN-STRING"), makeSymbol("MEANING")), makeSymbol("LISTIFIED-KNOWN-NOUNS")), list(makeSymbol("CLET"), list(list(makeSymbol("CONJECTURES"), NIL), list(makeSymbol("TAG"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-REFINED-TAG"))))), list(makeSymbol("PCOND"), list(list(makeSymbol("KB-INDIVIDUAL-P"), makeSymbol("TAG")), list(makeSymbol("CPUSH"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("equals")), makeKeyword("MEANING"), makeSymbol("TAG")), makeSymbol("CONJECTURES"))), list(list(makeSymbol("COLLECTION-P"), makeSymbol("TAG")), list(makeSymbol("CLET"), list(list(makeSymbol("COLL-OR-IND?"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("COLLECTION-OR-INDIVIDUAL?"))))), list(makeSymbol("PIF"), list(EQ, makeSymbol("COLL-OR-IND?"), makeKeyword("INDIVIDUAL")), list(makeSymbol("CPUSH"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("isa")), makeKeyword("MEANING"), makeSymbol("TAG")), makeSymbol("CONJECTURES")), list(makeSymbol("CLET"), list(list(makeSymbol("ISAS"), list(makeSymbol("GET-SOPHISTICATED-ISAS-BASED-ON-GENLS"), list(makeSymbol("LIST"), makeSymbol("TAG")), constant_handles.reader_make_constant_shell(makeString("CurrentWorldDataCollectorMt-NonHomocentric"))))), list(makeSymbol("CPUSH"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("genls")), makeKeyword("MEANING"), makeSymbol("TAG")), makeSymbol("CONJECTURES")), list(makeSymbol("DO-LIST"), list(makeSymbol("ISA"), makeSymbol("ISAS")), list(makeSymbol("CPUSH"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("isa")), makeKeyword("MEANING"), makeSymbol("ISA")), makeSymbol("CONJECTURES"))))))), list(list(makeSymbol("KEYWORDP"), makeSymbol("TAG")), list(makeSymbol("PROGN")))), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("NOUN-STRING"), makeSymbol("CONJECTURES")), makeSymbol("LISTIFIED-UNKNOWN-NOUNS"))))))), list(RET, list(makeSymbol("LIST"), makeSymbol("LISTIFIED-KNOWN-NOUNS"), makeSymbol("LISTIFIED-UNKNOWN-NOUNS")))));
    ...
    static private final SubLList $list_alt353 = list(makeString("Assert that TERM was mentioned (i.e. some NL expression referring to TERM occurred) in CORPUS."), list(makeSymbol("ASSERT-TYPE"), makeSymbol("TERM"), makeSymbol("CYCL-TERM-P")), list(makeSymbol("WITH-THE-CYCLIST"), list(constant_handles.reader_make_constant_shell(makeString("TheMySentientSystem"))), list(makeSymbol("MYSE-ASSERT-NOW"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("documentMentions")), makeSymbol("CORPUS"), makeSymbol("TERM")), constant_handles.reader_make_constant_shell(makeString("PCWDataMt"))), list(makeSymbol("MYSE-ASSERT-NOW"), list(makeSymbol("MAKE-TERNARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("extractedFromCorpusUsingTool")), makeSymbol("TERM"), makeSymbol("CORPUS"), makeSymbol("TOOL")), constant_handles.reader_make_constant_shell(makeString("BookkeepingMt"))), list(makeSymbol("MYSE-ASSERT-NOW"), list(makeSymbol("MAKE-TERNARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("glfComponentSemanticsWRTGraph")), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("GLFNodeSemanticsWRTGraphFn")), makeSymbol("TERM"), constant_handles.reader_make_constant_shell(makeString("TheCycOntologyGraph"))), makeSymbol("TERM"), constant_handles.reader_make_constant_shell(makeString("TheCycOntologyGraph"))), constant_handles.reader_make_constant_shell(makeString("GLFMt"))), list(makeSymbol("MYSE-ASSERT-NOW"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("defaultCandidateFocalNodeInSystem")), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("GLFNodeSemanticsWRTGraphFn")), makeSymbol("TERM"), constant_handles.reader_make_constant_shell(makeString("TheCycOntologyGraph"))), list(makeSymbol("AIS-FOR"), constant_handles.reader_make_constant_shell(makeString("TheCycOntologyGraph")))), makeSymbol("GRAPHING-MT"))), list(RET, makeSymbol("TERM")));
    ...
    static private final SubLList $list_alt366 = list(list(makeSymbol("CLET"), list(makeSymbol("NEW-TERM")), list(makeSymbol("WITH-THE-CYCLIST"), list(constant_handles.reader_make_constant_shell(makeString("TheMySentientSystem"))), list(makeSymbol("CSETQ"), makeSymbol("NEW-TERM"), list(makeSymbol("MYSE-CREATE"), makeSymbol("NOUN-STRING"))), list(makeSymbol("DO-LIST"), list(makeSymbol("CONJECTURE"), makeSymbol("CONJECTURES")), list(makeSymbol("CLET"), list(list(makeSymbol("FORMULA"), list(makeSymbol("EXPRESSION-SUBST"), makeSymbol("NEW-TERM"), makeKeyword("MEANING"), makeSymbol("CONJECTURE"), list(makeSymbol("FUNCTION"), EQ)))), list(makeSymbol("MYSE-ASSERT-NOW"), makeSymbol("FORMULA"), constant_handles.reader_make_constant_shell(makeString("UniversalVocabularyMt"))))), list(makeSymbol("MYSE-ASSERT-NOW"), list(makeSymbol("MAKE-BINARY-FORMULA"), constant_handles.reader_make_constant_shell(makeString("termStrings")), makeSymbol("NEW-TERM"), makeSymbol("NOUN-STRING")), constant_handles.reader_make_constant_shell(makeString("GeneralEnglishMt")))), list(makeSymbol("FCM"), list(QUOTE, makeSymbol("LEARNED-NOUNS")), list(QUOTE, makeSymbol("ASSERT-CORPUS-MENTION-FOR-MYSENTIENT")), makeSymbol("NEW-TERM"), makeSymbol("CORPUS"), makeSymbol("GRAPHING-MT"), constant_handles.reader_make_constant_shell(makeString("TheMySentientDefinitionSuggestorTool"))), list(RET, makeSymbol("NEW-TERM"))));
    ...
    static private final SubLList $list_alt372 = list(list(makeSymbol("ASSERT-TYPE"), makeSymbol("SUBJ-PAIRS-FILE"), makeSymbol("STRINGP")), list(makeSymbol("ASSERT-TYPE"), makeSymbol("OBJ-PAIRS-FILE"), makeSymbol("STRINGP")), list(makeSymbol("ASSERT-TYPE"), makeSymbol("COMPLEX-NOUNS-FILE"), makeSymbol("STRINGP")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-RAW-DATA-FOR-ARG-FROM-TEXT-FILE")), $SUBJ, makeSymbol("SUBJ-PAIRS-FILE")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-RAW-DATA-FOR-ARG-FROM-TEXT-FILE")), makeKeyword("OBJ"), makeSymbol("OBJ-PAIRS-FILE")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-COMPLEX-NOUN-DATA-FROM-TEXT-FILE")), makeSymbol("COMPLEX-NOUNS-FILE")), list(RET, makeSymbol("SELF")));
    ...
    static private final SubLList $list_alt380 = list(list(makeSymbol("ASSERT-TYPE"), makeSymbol("INPUT-DIRECTORY"), makeSymbol("DIRECTORY-P")), list(makeSymbol("ASSERT-TYPE"), makeSymbol("SUBJ-PAIRS-FILE-SUFFIX"), makeSymbol("STRINGP")), list(makeSymbol("ASSERT-TYPE"), makeSymbol("OBJ-PAIRS-FILE-SUFFIX"), makeSymbol("STRINGP")), list(makeSymbol("ASSERT-TYPE"), makeSymbol("COMPLEX-NOUNS-FILE-SUFFIX"), makeSymbol("STRINGP")), list(makeSymbol("CLET"), list(list(makeSymbol("COMPLEX-NOUNS-FILES"), NIL)), list(makeSymbol("DO-DIRECTORY-TREE-FILES"), list(makeSymbol("FILE"), makeSymbol("INPUT-DIRECTORY")), list(makeSymbol("PCOND"), list(list(makeSymbol("ENDS-WITH"), makeSymbol("FILE"), makeSymbol("SUBJ-PAIRS-FILE-SUFFIX")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-RAW-DATA-FOR-ARG-FROM-TEXT-FILE")), $SUBJ, makeSymbol("FILE"))), list(list(makeSymbol("ENDS-WITH"), makeSymbol("FILE"), makeSymbol("OBJ-PAIRS-FILE-SUFFIX")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-RAW-DATA-FOR-ARG-FROM-TEXT-FILE")), makeKeyword("OBJ"), makeSymbol("FILE"))), list(list(makeSymbol("ENDS-WITH"), makeSymbol("FILE"), makeSymbol("COMPLEX-NOUNS-FILE-SUFFIX")), list(makeSymbol("CPUSH"), makeSymbol("FILE"), makeSymbol("COMPLEX-NOUNS-FILES"))), list(T, list(makeSymbol("FORMAT"), T, makeString("~&Ignoring file: ~S~%"), makeSymbol("FILE"))))), list(makeSymbol("CDOLIST"), list(makeSymbol("COMPLEX-NOUNS-FILE"), makeSymbol("COMPLEX-NOUNS-FILES")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-COMPLEX-NOUN-DATA-FROM-TEXT-FILE")), makeSymbol("COMPLEX-NOUNS-FILE")))), list(RET, makeSymbol("SELF")));
    ...
    static private final SubLList $list_alt387 = list(list(makeSymbol("IGNORE"), makeSymbol("NOUNS-WITHOUT-VERBS-LIST")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-RAW-DATA-FOR-ARG-FROM-VERBAL-MATCHES-LIST")), $SUBJ, makeSymbol("VERB-SUBJECTS-LIST")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-RAW-DATA-FOR-ARG-FROM-VERBAL-MATCHES-LIST")), makeKeyword("OBJ"), makeSymbol("VERB-OBJECTS-LIST")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-COMPLEX-NOUN-DATA-FROM-VERBAL-MATCHES-LISTS")), makeSymbol("VERB-SUBJECTS-LIST"), makeSymbol("VERB-OBJECTS-LIST")), list(RET, makeSymbol("SELF")));
    ...
    static private final SubLList $list_alt392 = list(list(makeSymbol("CLET"), list(list(makeSymbol("FIRST-LINE?"), T)), list(makeSymbol("DO-FILE-LINES"), list(makeSymbol("LINE"), makeSymbol("PAIRS-FILE"), makeKeyword("PROGRESS-MESSAGE"), list(makeSymbol("CCONCATENATE"), list(makeSymbol("UNCAPITALIZE-SMART"), list(makeSymbol("TO-STRING"), makeSymbol("RELATION"))), makeString("ect file: "), makeSymbol("PAIRS-FILE"))), list(makeSymbol("PIF"), makeSymbol("FIRST-LINE?"), list(makeSymbol("CSETQ"), makeSymbol("FIRST-LINE?"), NIL), list(makeSymbol("CDESTRUCTURING-BIND"), cons(makeSymbol("SENTENCE"), makeSymbol("ARG-VERB-PAIRS")), list(makeSymbol("BREAK-WORDS"), makeSymbol("LINE"), list(makeSymbol("FUNCTION"), makeSymbol("NON-TAB-CHAR-P"))), list(makeSymbol("IGNORE"), makeSymbol("SENTENCE")), list(makeSymbol("CDOLIST"), list(makeSymbol("PAIR"), makeSymbol("ARG-VERB-PAIRS")), list(makeSymbol("CDESTRUCTURING-BIND"), list(makeSymbol("NOUN-STRING-WITH-SUFFIX"), makeSymbol("VERB-WITH-SUFFIX")), list(makeSymbol("BREAK-WORDS"), makeSymbol("PAIR"), list(makeSymbol("FUNCTION"), makeSymbol("NON-SPACE-CHAR-P"))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-RAW-DATA-FOR-ARG-INT")), makeSymbol("RELATION"), makeSymbol("NOUN-STRING-WITH-SUFFIX"), makeSymbol("VERB-WITH-SUFFIX")))))))), list(RET, NIL));
    ...
    static private final SubLList $list_alt402 = list(list(makeSymbol("CDOLIST"), list(makeSymbol("ARG-VERB-PAIR"), makeSymbol("LIST")), list(makeSymbol("CDESTRUCTURING-BIND"), list(makeSymbol("NOUN-HEAD-WITH-SUFFIX"), makeSymbol("VERB-WITH-SUFFIX"), makeSymbol("WHOLE-NOUN"), makeSymbol("DETERMINER"), makeSymbol("CAVEAT")), makeSymbol("ARG-VERB-PAIR"), list(makeSymbol("IGNORE"), makeSymbol("WHOLE-NOUN"), makeSymbol("DETERMINER")), list(makeSymbol("PUNLESS"), list(makeSymbol("MEMBER?"), makeSymbol("CAVEAT"), list(QUOTE, list(makeKeyword("PROBLEM"), makeKeyword("PHRASELESS"), makeKeyword("QP-TREE")))), list(makeSymbol("CSETQ"), makeSymbol("NOUN-HEAD-WITH-SUFFIX"), list(makeSymbol("STRING-SUBSTITUTE"), makeString("-"), makeString(" "), makeSymbol("NOUN-HEAD-WITH-SUFFIX"))), list(makeSymbol("CSETQ"), makeSymbol("VERB-WITH-SUFFIX"), list(makeSymbol("STRING-SUBSTITUTE"), makeString("-"), makeString(" "), makeSymbol("VERB-WITH-SUFFIX"))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-RAW-DATA-FOR-ARG-INT")), makeSymbol("RELATION"), makeSymbol("NOUN-HEAD-WITH-SUFFIX"), makeSymbol("VERB-WITH-SUFFIX"))))), list(RET, NIL));
    ...
    static private final SubLList $list_alt409 = list(list(makeSymbol("CLET"), list(makeSymbol("ERROR")), list(makeSymbol("CATCH-ERROR-MESSAGE"), list(makeSymbol("ERROR")), list(makeSymbol("CMULTIPLE-VALUE-BIND"), list(makeSymbol("VERB"), makeSymbol("VERB-POS-SUFFIX")), list(makeSymbol("DETACH-POS-SUFFIX"), makeSymbol("VERB-WITH-SUFFIX")), list(makeSymbol("PIF"), list(makeSymbol("CNOT"), list(EQUAL, makeSymbol("VERB-POS-SUFFIX"), makeString("VB"))), list(makeSymbol("WARN"), makeString("The verb ~S does not have the expected suffix '_VB'.  Pair ignored."), makeSymbol("VERB-WITH-SUFFIX")), list(makeSymbol("CMULTIPLE-VALUE-BIND"), list(makeSymbol("NOUN-STRING"), makeSymbol("NOUN-POS-SUFFIX")), list(makeSymbol("DETACH-POS-SUFFIX"), makeSymbol("NOUN-STRING-WITH-SUFFIX")), list(makeSymbol("PIF"), list(makeSymbol("CNOT"), list(makeSymbol("COR"), list(EQUAL, makeSymbol("NOUN-POS-SUFFIX"), makeString("NN")), list(EQUAL, makeSymbol("NOUN-POS-SUFFIX"), makeString("NP")))), list(makeSymbol("PROGN")), list(makeSymbol("PROGN"), list(makeSymbol("PWHEN"), list(makeSymbol("STRING-EQUAL"), makeSymbol("VERB"), makeString("cum")), list(makeSymbol("CSETQ"), makeSymbol("VERB"), makeString("come"))), list(makeSymbol("PWHEN"), list(makeSymbol("COR"), list(makeSymbol("STRING-EQUAL"), makeSymbol("VERB"), makeString("'m")), list(makeSymbol("STRING-EQUAL"), makeSymbol("VERB"), makeString("'s"))), list(makeSymbol("CSETQ"), makeSymbol("VERB"), makeString("be"))), list(makeSymbol("PUNLESS"), list(makeSymbol("COR"), list(makeSymbol("NON-ALPHABETIC-STRING?"), makeSymbol("NOUN-STRING")), list(makeSymbol("CLOSED-LEXICAL-CLASS-STRING?"), makeSymbol("NOUN-STRING"))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("INCREMENT-RELEVANT-COUNTS-FOR-ARG-VERB-RELATION-TRIPLE")), list(makeSymbol("STRING-DOWNCASE"), makeSymbol("NOUN-STRING")), makeSymbol("VERB"), makeSymbol("RELATION"))))))))), list(makeSymbol("PWHEN"), makeSymbol("ERROR"), list(makeSymbol("WARN"), makeString("In COMPILE-RAW-DATA-FOR-ARG-INT: ~A"), makeSymbol("ERROR")))), list(RET, NIL));
    ...
    static private final SubLList $list_alt424 = list(makeString("Note that a noun headed by NOUN-STRING (i.e. either the simple noun NOUN-STRING itself or a complex noun headed by it) occurred\n   in the RELATION relation with the verb VERB."), list(makeSymbol("CLET"), list(list(makeSymbol("NOUN-OBJECT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-OR-CREATE-SIMPLE-NOUN")), makeSymbol("NOUN-STRING")))), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("RECORD-OCCURRENCE-WITH-VERB")), makeSymbol("VERB"), makeSymbol("RELATION"))), list(RET, NIL));
    ...
    static private final SubLList $list_alt429 = list(makeString("Note that a noun headed by HEAD-STRING (i.e. either the simple noun HEAD-STRING itself or a complex noun headed by it) occurred,\n   but not as the subject or direct object of any verb."), list(makeSymbol("CLET"), list(list(makeSymbol("NOUN-OBJECT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-OR-CREATE-SIMPLE-NOUN")), makeSymbol("HEAD-STRING")))), list(makeSymbol("FIM"), makeSymbol("NOUN-OBJECT"), list(QUOTE, makeSymbol("RECORD-OCCURRENCE-WITH-NO-VERB")))), list(RET, NIL));
    ...
    static private final SubLList $list_alt433 = list(list(makeSymbol("DO-FILE-LINES"), list(makeSymbol("LINE"), makeSymbol("COMPLEX-NOUNS-FILE"), makeKeyword("PROGRESS-MESSAGE"), list(makeSymbol("CCONCATENATE"), makeString("Nouns file: "), makeSymbol("COMPLEX-NOUNS-FILE"))), list(makeSymbol("PUNLESS"), list(makeSymbol("COR"), list(makeSymbol("EMPTY-STRING-P"), makeSymbol("LINE")), list(EQL, CHAR_semicolon, list(makeSymbol("FIRST-CHAR"), makeSymbol("LINE")))), list(makeSymbol("CLET"), list(makeSymbol("WHOLE-NOUN-STRING"), makeSymbol("HEAD-STRING-WITH-SUFFIX"), makeSymbol("DETERMINER"), makeSymbol("ERROR")), list(makeSymbol("CATCH-ERROR-MESSAGE"), list(makeSymbol("ERROR")), list(makeSymbol("CDESTRUCTURING-SETQ"), list(makeSymbol("WHOLE-NOUN-STRING"), makeSymbol("HEAD-STRING-WITH-SUFFIX"), makeSymbol("DETERMINER")), list(makeSymbol("BREAK-WORDS"), makeSymbol("LINE"), list(makeSymbol("FUNCTION"), makeSymbol("NON-TAB-CHAR-P")))), list(makeSymbol("PUNLESS"), makeSymbol("DETERMINER"), list(makeSymbol("ERROR"), makeString("The line ~S failed to match the pattern (WHOLE-NOUN-STRING HEAD-STRING-WITH-SUFFIX DETERMINER)."), makeSymbol("LINE")))), list(makeSymbol("PIF"), makeSymbol("ERROR"), list(makeSymbol("WARN"), makeSymbol("ERROR")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-COMPLEX-NOUN-DATA-INT")), makeSymbol("WHOLE-NOUN-STRING"), makeSymbol("HEAD-STRING-WITH-SUFFIX"), makeSymbol("DETERMINER")))))), list(RET, NIL));
    ...
    static private final SubLList $list_alt439 = list(list(makeSymbol("CDOLIST"), list(makeSymbol("MATCH"), list(makeSymbol("APPEND"), makeSymbol("VERB-SUBJECT-MATCHES-LIST"), makeSymbol("VERB-OBJECT-MATCHES-LIST"))), list(makeSymbol("CDESTRUCTURING-BIND"), list(makeSymbol("HEAD-STRING-WITH-SUFFIX"), makeSymbol("VERB"), makeSymbol("WHOLE-NOUN-STRING"), makeSymbol("DETERMINER"), makeSymbol("CAVEAT")), makeSymbol("MATCH"), list(makeSymbol("IGNORE"), makeSymbol("VERB")), list(makeSymbol("PUNLESS"), list(makeSymbol("MEMBER?"), makeSymbol("CAVEAT"), list(QUOTE, list(makeKeyword("PROBLEM"), makeKeyword("PHRASELESS"), makeKeyword("QP-TREE")))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("COMPILE-COMPLEX-NOUN-DATA-INT")), makeSymbol("WHOLE-NOUN-STRING"), makeSymbol("HEAD-STRING-WITH-SUFFIX"), makeSymbol("DETERMINER"))))), list(RET, NIL));
    ...
    static private final SubLList $list_alt443 = list(list(makeSymbol("CLET"), list(makeSymbol("ERROR")), list(makeSymbol("CATCH-ERROR-MESSAGE"), list(makeSymbol("ERROR")), list(makeSymbol("CMULTIPLE-VALUE-BIND"), list(makeSymbol("HEAD-STRING"), makeSymbol("HEAD-POS-SUFFIX")), list(makeSymbol("DETACH-POS-SUFFIX"), makeSymbol("HEAD-STRING-WITH-SUFFIX")), list(makeSymbol("PWHEN"), list(makeSymbol("COR"), list(EQUAL, makeSymbol("HEAD-POS-SUFFIX"), makeString("NN")), list(EQUAL, makeSymbol("HEAD-POS-SUFFIX"), makeString("NP"))), list(makeSymbol("PUNLESS"), list(makeSymbol("CLOSED-LEXICAL-CLASS-STRING?"), makeSymbol("HEAD-STRING")), list(makeSymbol("CLET"), list(list(makeSymbol("HEAD-NOUN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-NOUN")), makeSymbol("HEAD-STRING")))), list(makeSymbol("PIF"), list(makeSymbol("NULL"), makeSymbol("HEAD-NOUN")), list(makeSymbol("WARN"), makeString("Ignoring data for ~S because its head ~S is not represented."), makeSymbol("WHOLE-NOUN-STRING"), makeSymbol("HEAD-STRING")), list(makeSymbol("CLET"), list(makeSymbol("WHOLE-NOUN-NOUN")), list(makeSymbol("PIF"), list(makeSymbol("MULTI-WORD-STRING"), makeSymbol("WHOLE-NOUN-STRING")), list(makeSymbol("CLET"), list(list(makeSymbol("WHOLE-NOUN-STRING-NORMALIZED"), list(makeSymbol("SINGULARIZE-COMPLEX-NOUN"), makeSymbol("WHOLE-NOUN-STRING"), makeSymbol("HEAD-STRING")))), list(makeSymbol("CSETQ"), makeSymbol("WHOLE-NOUN-NOUN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FIND-OR-CREATE-COMPLEX-NOUN")), makeSymbol("WHOLE-NOUN-STRING-NORMALIZED"), makeSymbol("HEAD-NOUN")))), list(makeSymbol("CSETQ"), makeSymbol("WHOLE-NOUN-NOUN"), makeSymbol("HEAD-NOUN"))), list(makeSymbol("FIM"), makeSymbol("WHOLE-NOUN-NOUN"), list(QUOTE, makeSymbol("INCREMENT-TOTAL-COUNT-AS-WHOLE-NOUN"))), list(makeSymbol("PWHEN"), list(makeSymbol("PLURAL-FORM-OF?"), makeSymbol("WHOLE-NOUN-STRING"), makeSymbol("HEAD-STRING")), list(makeSymbol("FIM"), makeSymbol("WHOLE-NOUN-NOUN"), list(QUOTE, makeSymbol("INCREMENT-APPEARANCES-AS-PLURAL")))), list(makeSymbol("PWHEN"), list(makeSymbol("STRING-IS-POS?"), makeSymbol("DETERMINER"), constant_handles.reader_make_constant_shell(makeString("Determiner"))), list(makeSymbol("FIM"), makeSymbol("WHOLE-NOUN-NOUN"), list(QUOTE, makeSymbol("INCREMENT-APPEARANCES-WITH-DETERMINER")))), list(makeSymbol("PWHEN"), list(makeSymbol("CAPITALIZED-STRING-P"), makeSymbol("WHOLE-NOUN-STRING")), list(makeSymbol("FIM"), makeSymbol("WHOLE-NOUN-NOUN"), list(QUOTE, makeSymbol("INCREMENT-APPEARANCES-IN-ALL-CAPS"))), list(makeSymbol("PWHEN"), list(makeSymbol("STRING-EQUAL"), makeSymbol("DETERMINER"), makeString("the")), list(makeSymbol("FIM"), makeSymbol("WHOLE-NOUN-NOUN"), list(QUOTE, makeSymbol("INCREMENT-APPEARANCES-IN-ALL-CAPS-WITH-THE")))))))))))), list(makeSymbol("PWHEN"), makeSymbol("ERROR"), list(makeSymbol("WARN"), makeString("In COMPILE-COMPLEX-NOUN-DATA-INT: ~A"), makeSymbol("ERROR")))), list(RET, NIL));
    ...
    static private final SubLList $list_alt456 = list(list(makeSymbol("CLET"), list(list(makeSymbol("SCORES"), NIL)), list(makeSymbol("DO-LEARNED-SIMPLE-NOUNS"), list(makeSymbol("SIMPLE-NOUN"), makeKeyword("COUNT-THRESHOLD"), makeSymbol("COUNT-THRESHOLD")), list(makeSymbol("PWHEN"), list(makeSymbol("<"), list(makeSymbol("LENGTH"), makeSymbol("SCORES")), makeSymbol("SAMPLE-SIZE")), list(makeSymbol("CLET"), list(list(makeSymbol("DENOTS"), list(makeSymbol("DENOTS-OF-STRING"), list(makeSymbol("GET-NOUN-STRING"), makeSymbol("SIMPLE-NOUN"))))), list(makeSymbol("PWHEN"), list(makeSymbol("SINGLETON?"), makeSymbol("DENOTS")), list(makeSymbol("CLET"), list(list(makeSymbol("DENOT"), list(makeSymbol("FIRST"), makeSymbol("DENOTS")))), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("FORT-P"), makeSymbol("DENOT")), list(makeSymbol("CNOT"), list(makeSymbol("FORT-NOT-PROPERLY-IN-GENLS-HIERARCHY?"), makeSymbol("DENOT")))), list(makeSymbol("CLET"), list(makeSymbol("ALL-TYPES"), list(makeSymbol("TYPES"), NIL)), list(makeSymbol("WITH-ALL-MTS"), list(makeSymbol("PIF"), list(makeSymbol("COLLECTION-P"), makeSymbol("DENOT")), list(makeSymbol("CSETQ"), makeSymbol("ALL-TYPES"), list(makeSymbol("ALL-GENLS"), makeSymbol("DENOT"))), list(makeSymbol("CSETQ"), makeSymbol("ALL-TYPES"), list(makeSymbol("ALL-ISA"), makeSymbol("DENOT"))))), list(makeSymbol("CDOLIST"), list(makeSymbol("TYPE"), makeSymbol("ALL-TYPES")), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("COLLECTION-P"), makeSymbol("TYPE")), list(makeSymbol("<"), list(makeSymbol("GENERALITY-ESTIMATE"), makeSymbol("TYPE")), makeSymbol("GENERALITY-CUTOFF"))), list(makeSymbol("CPUSH"), makeSymbol("TYPE"), makeSymbol("TYPES")))), list(makeSymbol("PWHEN"), makeSymbol("TYPES"), list(makeSymbol("CLET"), list(makeSymbol("BEST-RANKING-AMONG-TYPES"), makeSymbol("BEST-RANKED-TYPE")), list(makeSymbol("CDOLIST"), list(makeSymbol("TYPE"), makeSymbol("TYPES")), list(makeSymbol("CLET"), list(list(makeSymbol("RANKING-OF-THIS-TYPE"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-RANKING-OF")), makeSymbol("TYPE")))), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("INTEGERP"), makeSymbol("RANKING-OF-THIS-TYPE")), list(makeSymbol("COR"), list(makeSymbol("NULL"), makeSymbol("BEST-RANKING-AMONG-TYPES")), list(makeSymbol("<"), makeSymbol("RANKING-OF-THIS-TYPE"), makeSymbol("BEST-RANKING-AMONG-TYPES")))), list(makeSymbol("CSETQ"), makeSymbol("BEST-RANKING-AMONG-TYPES"), makeSymbol("RANKING-OF-THIS-TYPE"), makeSymbol("BEST-RANKED-TYPE"), makeSymbol("TYPE"))))), list(makeSymbol("CPUSH"), makeSymbol("BEST-RANKING-AMONG-TYPES"), makeSymbol("SCORES")), list(makeSymbol("FORMAT"), T, makeString("~%Noun: ~S~%Highest ranked: ~S~%Rank: ~S~%"), list(makeSymbol("GET-NOUN-STRING"), makeSymbol("SIMPLE-NOUN")), makeSymbol("BEST-RANKED-TYPE"), makeSymbol("BEST-RANKING-AMONG-TYPES"))))))))))), list(makeSymbol("CLET"), list(list(makeSymbol("NUMBER-TOP-RANKED"), ZERO_INTEGER), list(makeSymbol("NUMBER-IN-TOP-5"), ZERO_INTEGER), list(makeSymbol("NUMBER-IN-TOP-10"), ZERO_INTEGER), list(makeSymbol("NUMBER-IN-TOP-25"), ZERO_INTEGER), list(makeSymbol("NUMBER-IN-TOP-50"), ZERO_INTEGER), list(makeSymbol("NUMBER-UNRANKED"), ZERO_INTEGER)), list(makeSymbol("CDOLIST"), list(makeSymbol("SCORE"), makeSymbol("SCORES")), list(makeSymbol("PIF"), makeSymbol("SCORE"), list(makeSymbol("PROGN"), list(makeSymbol("PWHEN"), list(makeSymbol("ZEROP"), makeSymbol("SCORE")), list(makeSymbol("CINC"), makeSymbol("NUMBER-TOP-RANKED"))), list(makeSymbol("PWHEN"), list(makeSymbol("<"), makeSymbol("SCORE"), FIVE_INTEGER), list(makeSymbol("CINC"), makeSymbol("NUMBER-IN-TOP-5"))), list(makeSymbol("PWHEN"), list(makeSymbol("<"), makeSymbol("SCORE"), TEN_INTEGER), list(makeSymbol("CINC"), makeSymbol("NUMBER-IN-TOP-10"))), list(makeSymbol("PWHEN"), list(makeSymbol("<"), makeSymbol("SCORE"), makeInteger(25)), list(makeSymbol("CINC"), makeSymbol("NUMBER-IN-TOP-25"))), list(makeSymbol("PWHEN"), list(makeSymbol("<"), makeSymbol("SCORE"), makeInteger(50)), list(makeSymbol("CINC"), makeSymbol("NUMBER-IN-TOP-50")))), list(makeSymbol("CINC"), makeSymbol("NUMBER-UNRANKED")))), list(new SubLObject[]{ makeSymbol("FORMAT"), T, makeString("~%Top ranked: ~S~%In top 5: ~S~%In top 10: ~S~%In top 25: ~S~%In top 50: ~S~%Unranked: ~S~%"), makeSymbol("NUMBER-TOP-RANKED"), makeSymbol("NUMBER-IN-TOP-5"), makeSymbol("NUMBER-IN-TOP-10"), makeSymbol("NUMBER-IN-TOP-25"), makeSymbol("NUMBER-IN-TOP-50"), makeSymbol("NUMBER-UNRANKED") }), list(makeSymbol("FORMAT"), T, makeString("~%Sample size: ~S~%"), list(makeSymbol("LENGTH"), makeSymbol("SCORES"))))), list(RET, NIL));
    ...
    static private final SubLList $list_alt469 = list(makeString("Create a file hash table that maps each noun string to its top 20 calculated types.\n   @return file-hash-table-p; maps string -> list of forts"), list(makeSymbol("CHECK-TYPE"), makeSymbol("FILENAME"), makeSymbol("STRINGP")), list(makeSymbol("CLET"), list(list(makeSymbol("FHT"), list(makeSymbol("FAST-CREATE-FILE-HASH-TABLE"), makeSymbol("FILENAME"), makeSymbol("TEMPSTEM"), list(makeSymbol("FUNCTION"), EQUAL), makeKeyword("IMAGE-INDEPENDENT-CFASL")))), list(makeSymbol("DO-LEARNED-NOUNS"), list(makeSymbol("NOUN")), list(makeSymbol("CLET"), list(list(makeSymbol("NOUN-STRING"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-STRING")))), list(makeSymbol("TOP-N-TAGS"), list(makeSymbol("FIM"), makeSymbol("NOUN"), list(QUOTE, makeSymbol("GET-TOP-N-TAGS")), TWENTY_INTEGER))), list(makeSymbol("FAST-PUT-FILE-HASH-TABLE"), makeSymbol("NOUN-STRING"), makeSymbol("FHT"), makeSymbol("TOP-N-TAGS")))), list(makeSymbol("FINALIZE-FAST-CREATE-FILE-HASH-TABLE"), makeSymbol("FHT")), list(RET, makeSymbol("FHT"))));
    ...
    static private final SubLList $list_alt475 = list(list(makeSymbol("CHECK-TYPE"), makeSymbol("SIMPLE-NOUN"), makeSymbol("SIMPLE-NOUN-P")), list(makeSymbol("CLET"), list(list(makeSymbol("COUNT-THRESHOLD"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET-NOUN-RELEVANCE-COUNT-THRESHOLD")))), list(makeSymbol("TOTAL-COUNT"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-TOTAL-COUNT"))))), list(makeSymbol("PIF"), list(makeSymbol("<"), makeSymbol("TOTAL-COUNT"), makeSymbol("COUNT-THRESHOLD")), list(RET, makeKeyword("DONT-CARE")), list(makeSymbol("CLET"), list(list(makeSymbol("COUNT-AS-SUBJECT-BY-VERB"), list(makeSymbol("GET-SIMPLE-NOUN-COUNT-AS-SUBJECT-BY-VERB"), makeSymbol("SIMPLE-NOUN"))), list(makeSymbol("COUNT-AS-OBJECT-BY-VERB"), list(makeSymbol("GET-SIMPLE-NOUN-COUNT-AS-OBJECT-BY-VERB"), makeSymbol("SIMPLE-NOUN"))), list(makeSymbol("TYPICALITY-METRIC"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET-TYPICALITY-METRIC")))), list(makeSymbol("WEIGHT-SUMMANDS-BY-SELECTIVENESS?"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("WEIGHT-SUMMANDS-BY-SELECTIVENESS?"))))), list(RET, list(makeSymbol("TYPICALITY-SUM-BY-COLLECTION-BASED-ON-NOUN-USAGES"), makeSymbol("COUNT-AS-SUBJECT-BY-VERB"), makeSymbol("COUNT-AS-OBJECT-BY-VERB"), makeSymbol("NOUN-RELEVANCE-COUNT-THRESHOLD"), makeSymbol("TYPICALITY-METRIC"), makeSymbol("WEIGHT-SUMMANDS-BY-SELECTIVENESS?")))))));
    ...
    static private final SubLList $list_alt504 = list(makeString("This is called by @xref CFASL-INPUT-INSTANCE.  Not meant to be called directly.\n   Use the public function @xref CFASL-INPUT or the like."), list(makeSymbol("CLET"), list(list(makeSymbol("LEARNED"), list(makeSymbol("CFASL-INPUT"), makeSymbol("SUPER"), makeSymbol("STREAM")))), list(makeSymbol("DO-LEARNED-NOUNS"), list(makeSymbol("NOUN"), makeKeyword("LEARNED"), makeSymbol("LEARNED")), list(makeSymbol("SET-NOUN-LEARNED"), makeSymbol("NOUN"), makeSymbol("LEARNED")), list(makeSymbol("PIF"), list(makeSymbol("SIMPLE-NOUN-P"), makeSymbol("NOUN")), list(makeSymbol("CLET"), list(list(makeSymbol("COMPLEX-NOUN-STRINGS"), list(makeSymbol("GET-SIMPLE-NOUN-COMPLEX-NOUNS"), makeSymbol("NOUN"))), list(makeSymbol("COMPLEX-NOUNS"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("STRING"), makeSymbol("COMPLEX-NOUN-STRINGS")), list(makeSymbol("CPUSH"), list(makeSymbol("FIM"), makeSymbol("LEARNED"), list(QUOTE, makeSymbol("FIND-NOUN")), makeSymbol("STRING")), makeSymbol("COMPLEX-NOUNS"))), list(makeSymbol("SET-SIMPLE-NOUN-COMPLEX-NOUNS"), makeSymbol("NOUN"), list(makeSymbol("NREVERSE"), makeSymbol("COMPLEX-NOUNS")))), list(makeSymbol("SET-COMPLEX-NOUN-HEAD"), makeSymbol("NOUN"), list(makeSymbol("FIM"), makeSymbol("LEARNED"), list(QUOTE, makeSymbol("FIND-NOUN")), list(makeSymbol("GET-COMPLEX-NOUN-HEAD"), makeSymbol("NOUN")))))), list(RET, makeSymbol("LEARNED"))));
    ...
    private static final SubLObject _constant_36_initializer() {
        return list(new SubLObject[]{ list(makeSymbol("DEFAULT-MAGIC-NUMBER"), makeKeyword("CLASS"), makeKeyword("VALUE"), makeDouble(0.51), makeKeyword("PUBLIC")), list(makeSymbol("DEFAULT-CALCULATE-TAG-METHOD"), makeKeyword("CLASS"), makeKeyword("VALUE"), makeKeyword("APMI-SUM-WEIGHTED-BY-SELECTIVENESS"), makeKeyword("PUBLIC")), list(makeSymbol("TYPICALITY-SUM-CALCULATE-TAG-METHODS"), makeKeyword("CLASS"), makeKeyword("VALUE"), list(makeSymbol("BQ-LIST"), list(makeSymbol("BQ-LIST*"), makeKeyword("SA-SUM"), list(makeSymbol("FUNCTION"), makeSymbol("SELECTIONAL-ASSOCIATION")), list(QUOTE, list(NIL))), list(makeSymbol("BQ-LIST*"), makeKeyword("APMI-SUM"), list(makeSymbol("FUNCTION"), makeSymbol("ADJUSTED-POINTWISE-MUTUAL-INFORMATION")), list(QUOTE, list(NIL))), list(makeSymbol("BQ-LIST*"), makeKeyword("APMI-SUM-WEIGHTED-BY-SELECTIVENESS"), list(makeSymbol("FUNCTION"), makeSymbol("ADJUSTED-POINTWISE-MUTUAL-INFORMATION")), list(QUOTE, list(T)))), makeKeyword("PROTECTED")), list(makeSymbol("CALCULATE-TAG-METHODS"), makeKeyword("CLASS"), makeKeyword("VALUE"), list(makeSymbol("APPEND"), list(makeSymbol("ALIST-KEYS"), list(makeSymbol("GET-SLOT"), list(QUOTE, makeSymbol("LEARNED-NOUNS")), list(QUOTE, makeSymbol("TYPICALITY-SUM-CALCULATE-TAG-METHODS")))), list(QUOTE, list(makeKeyword("BASIC"), makeKeyword("SPS")))), makeKeyword("PROTECTED")), list(makeSymbol("DICTIONARY-OF-NOUNS"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("CALCULATE-TAG-METHOD"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("NOUN-RELEVANCE-COUNT-THRESHOLD"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("TYPICALITY-SUM-CALCULATE-TAG-METHOD-P"), list(makeSymbol("OBJECT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("CALCULATE-TAG-METHOD-P"), list(makeSymbol("OBJECT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("ASSOCIATED-TYPICALITY-METRIC"), list(makeSymbol("TYPICALITY-SUM-CALCULATE-TAG-METHOD")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("ASSOCIATED-SUMMAND-WEIGHTING?"), list(makeSymbol("TYPICALITY-SUM-CALCULATE-TAG-METHOD")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("REIFY-NOUN-AS"), list(makeSymbol("NOUN-STRING"), makeSymbol("COLLECTION-OR-INDIVIDUAL"), makeSymbol("LIST-OF-TYPES"), makeSymbol("&OPTIONAL"), makeSymbol("GLOSS"), makeSymbol("MT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("LEXIFY-FORT-AS-NOUN"), list(makeSymbol("FORT"), makeSymbol("NOUN-STRING"), makeSymbol("&OPTIONAL"), makeSymbol("MT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("LISTIFY"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT-TAGS"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT-UNKNOWN-SIMPLE-NOUN-TAGS-ORDERED-BY-CONFIDENCE"), list(makeSymbol("&OPTIONAL"), makeSymbol("CONFIDENCE-THRESHOLD")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT-UNKNOWN-SIMPLE-NOUN-TOP-N-TAGS-ORDERED-BY-CONFIDENCE"), list(makeSymbol("&OPTIONAL"), makeSymbol("N"), makeSymbol("CONFIDENCE-THRESHOLD")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ANNIHILATE-TAGS"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PURGE-IRRELEVANT-NOUNS"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NOUN-COUNT"), list(makeSymbol("NOUN-STRING"), makeSymbol("&OPTIONAL"), makeSymbol("RELATION")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("TAG-FOR-NOUN"), list(makeSymbol("NOUN-STRING")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("TOP-N-TAGS-FOR-NOUN"), list(makeSymbol("NOUN-STRING")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CONFIDENCE-LEVEL"), list(makeSymbol("NOUN-STRING")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT-COUNTS"), list(makeSymbol("SIMPLE-NOUN-STRING")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("WHY-NOT-TAGGED-AS"), list(makeSymbol("SIMPLE-NOUN-STRING"), makeSymbol("COLLECTION")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("FIND-NOUN"), list(makeSymbol("NOUN-STRING")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-CALCULATE-TAG-METHOD"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-TYPICALITY-METRIC"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("WEIGHT-SUMMANDS-BY-SELECTIVENESS?"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-NOUN-RELEVANCE-COUNT-THRESHOLD"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SIZE"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-CALCULATE-TAG-METHOD-TO-DEFAULT"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GENERATE-KE-TEXT"), list(makeSymbol("KE-FILE-PATH"), makeSymbol("NOTES-FILE-PATH")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("KE-TEXT-REIFICATION"), list(makeSymbol("CONSTANT-NAME"), makeSymbol("TAG"), makeSymbol("COLLECTION-OR-INDIVIDUAL?"), makeSymbol("STREAM")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("KE-TEXT-LEXIFICATION"), list(makeSymbol("LEX-STRING"), makeSymbol("TERM"), makeSymbol("STREAM")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GROUP-NOUNS-INTO-LISTS-FOR-JAVA-TOOL"), list(makeSymbol("&OPTIONAL"), makeSymbol("MIN-LIST-LENGTH")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DUMP-NOUN-STRINGS-ORDERED-BY-PREVALENCE"), list(makeSymbol("FILENAME")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DUMP-KNOWN-NOUNS-WITH-MEANINGS"), list(makeSymbol("FILENAME")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DUMP-UNKNOWN-NOUNS-WITH-CONJECTURES"), list(makeSymbol("FILENAME")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPILE-RAW-DATA-FROM-TEXT-FILES"), list(makeSymbol("SUBJ-PAIRS-FILE"), makeSymbol("OBJ-PAIRS-FILE"), makeSymbol("COMPLEX-NOUNS-FILE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPILE-RAW-DATA-FROM-TEXT-FILES-DIRECTORY"), list(makeSymbol("INPUT-DIRECTORY"), makeSymbol("SUBJ-PAIRS-FILE-SUFFIX"), makeSymbol("OBJ-PAIRS-FILE-SUFFIX"), makeSymbol("COMPLEX-NOUNS-FILE-SUFFIX")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPILE-RAW-DATA-FOR-ARG-FROM-TEXT-FILE"), list(makeSymbol("RELATION"), makeSymbol("PAIRS-FILE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPILE-COMPLEX-NOUN-DATA-FROM-TEXT-FILE"), list(makeSymbol("COMPLEX-NOUNS-FILE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPILE-RAW-DATA-FROM-VERBAL-MATCHES-LISTS"), list(makeSymbol("PAIR-OF-LISTS")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPILE-RAW-DATA-FOR-ARG-FROM-VERBAL-MATCHES-LIST"), list(makeSymbol("RELATION"), makeSymbol("LIST")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPILE-COMPLEX-NOUN-DATA-FROM-VERBAL-MATCHES-LISTS"), list(makeSymbol("VERB-SUBJECT-MATCHES-LIST"), makeSymbol("VERB-OBJECT-MATCHES-LIST")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ACCURACY"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPILE-RAW-DATA-FOR-ARG-INT"), list(makeSymbol("RELATION"), makeSymbol("NOUN-STRING-WITH-SUFFIX"), makeSymbol("VERB-WITH-SUFFIX")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPILE-COMPLEX-NOUN-DATA-INT"), list(makeSymbol("WHOLE-NOUN-STRING"), makeSymbol("HEAD-STRING-WITH-SUFFIX"), makeSymbol("DETERMINER")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INCREMENT-RELEVANT-COUNTS-FOR-ARG-VERB-RELATION-TRIPLE"), list(makeSymbol("NOUN-STRING"), makeSymbol("VERB"), makeSymbol("RELATION")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NOTE-OCCURRENCE-OF-HEAD-NOUN-WITH-NO-VERB"), list(makeSymbol("HEAD-STRING")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INCREMENT-OCCURRENCES-OF-WHOLE-NOUN"), list(makeSymbol("WHOLE-NOUN-STRING")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CALCULATE-TYPICALITY-SUM-BY-COLLECTION"), list(makeSymbol("SIMPLE-NOUN")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("WHY-NOT-TAGGED-AS-INT"), list(makeSymbol("SIMPLE-NOUN"), makeSymbol("BETTER-TAG")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CFASL-OUTPUT"), list(makeSymbol("STREAM")), makeKeyword("PROTECTED")) });
    }

    private static final SubLObject _constant_481_initializer() {
        return list(list(makeSymbol("CHECK-TYPE"), makeSymbol("BETTER-TAG"), makeSymbol("COLLECTION-P")), list(makeSymbol("MUST"), list(makeSymbol("FCM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("TYPICALITY-SUM-CALCULATE-TAG-METHOD-P")), makeSymbol("CALCULATE-TAG-METHOD")), makeString("The method WHY-NOT-TAGGED-AS is only applicable when the calculate-tag-method is one of ~S."), list(makeSymbol("ALIST-KEYS"), makeSymbol("TYPICALITY-SUM-CALCULATE-TAG-METHODS"))), list(makeSymbol("CLET"), list(list(makeSymbol("CALCULATED-TAG"), list(makeSymbol("FIM"), makeSymbol("SIMPLE-NOUN"), list(QUOTE, makeSymbol("GET-CALCULATED-TAG"))))), list(makeSymbol("FORMAT"), T, makeString("~%The calculated tag for ~S is ~S.~%"), makeSymbol("SIMPLE-NOUN"), makeSymbol("CALCULATED-TAG")), list(makeSymbol("PUNLESS"), list(makeSymbol("COR"), list(makeSymbol("KEYWORDP"), makeSymbol("CALCULATED-TAG")), list(EQ, makeSymbol("BETTER-TAG"), makeSymbol("CALCULATED-TAG"))), list(makeSymbol("CLET"), list(list(makeSymbol("TYPICALITY-METRIC"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET-TYPICALITY-METRIC")))), list(makeSymbol("VERB-COUNTS-AS-SUBJ"), list(makeSymbol("GET-SIMPLE-NOUN-COUNT-AS-SUBJECT-BY-VERB"), makeSymbol("SIMPLE-NOUN"))), list(makeSymbol("VERB-COUNTS-AS-OBJ"), list(makeSymbol("GET-SIMPLE-NOUN-COUNT-AS-OBJECT-BY-VERB"), makeSymbol("SIMPLE-NOUN"))), list(makeSymbol("CALCULATED-TAG-TYPICALITY-SUM"), ZERO_INTEGER), list(makeSymbol("BETTER-TAG-TYPICALITY-SUM"), ZERO_INTEGER)), list(makeSymbol("DO-DICTIONARY"), list(makeSymbol("VERB"), makeSymbol("COUNT"), makeSymbol("VERB-COUNTS-AS-SUBJ")), list(makeSymbol("CLET"), list(list(makeSymbol("CALCULATED-TAG-SUMMAND"), list(makeSymbol("FUNCALL"), makeSymbol("TYPICALITY-METRIC"), makeSymbol("VERB"), makeSymbol("CALCULATED-TAG"), $SUBJ)), list(makeSymbol("BETTER-TAG-SUMMAND"), list(makeSymbol("FUNCALL"), makeSymbol("TYPICALITY-METRIC"), makeSymbol("VERB"), makeSymbol("BETTER-TAG"), $SUBJ)), list(makeSymbol("WEIGHT-SUMMANDS-BY-SELECTIVENESS?"), list(EQ, makeSymbol("CALCULATE-TAG-METHOD"), makeKeyword("APMI-SUM-WEIGHTED-BY-SELECTIVENESS")))), list(new SubLObject[]{ makeSymbol("PWHEN"), makeSymbol("CALCULATED-TAG-SUMMAND"), list(makeSymbol("FORMAT"), T, makeString("~%~%As subject:  ~S -> ~S~%"), makeSymbol("VERB"), makeSymbol("COUNT")), list(makeSymbol("FORMAT"), T, makeString("~%typicality-subj(~S,~S) = ~S"), makeSymbol("VERB"), makeSymbol("CALCULATED-TAG"), makeSymbol("CALCULATED-TAG-SUMMAND")), list(makeSymbol("FORMAT"), T, makeString("~%typicality-subj(~S,~S) = ~S~%"), makeSymbol("VERB"), makeSymbol("BETTER-TAG"), makeSymbol("BETTER-TAG-SUMMAND")), list(makeSymbol("PWHEN"), list(makeSymbol(">"), makeSymbol("COUNT"), ONE_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("CALCULATED-TAG-SUMMAND"), list(makeSymbol("*"), makeSymbol("CALCULATED-TAG-SUMMAND"), makeSymbol("COUNT")), makeSymbol("BETTER-TAG-SUMMAND"), list(makeSymbol("*"), makeSymbol("BETTER-TAG-SUMMAND"), makeSymbol("COUNT"))), list(makeSymbol("FORMAT"), T, makeString("~%Multiplied by count of ~S:~%"), makeSymbol("COUNT")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("CALCULATED-TAG"), makeSymbol("CALCULATED-TAG-SUMMAND")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("BETTER-TAG"), makeSymbol("BETTER-TAG-SUMMAND"))), list(makeSymbol("PWHEN"), makeSymbol("WEIGHT-SUMMANDS-BY-SELECTIVENESS?"), list(makeSymbol("CLET"), list(list(makeSymbol("SELECTIVENESS"), list(makeSymbol("SELECTIVENESS-WRT-SUBJECT"), makeSymbol("VERB")))), list(makeSymbol("CSETQ"), makeSymbol("CALCULATED-TAG-SUMMAND"), list(makeSymbol("*"), makeSymbol("CALCULATED-TAG-SUMMAND"), makeSymbol("SELECTIVENESS")), makeSymbol("BETTER-TAG-SUMMAND"), list(makeSymbol("*"), makeSymbol("BETTER-TAG-SUMMAND"), makeSymbol("SELECTIVENESS"))), list(makeSymbol("FORMAT"), T, makeString("~%Multiplied by selectiveness-wrt-subject(~S) = ~S~%"), makeSymbol("VERB"), makeSymbol("SELECTIVENESS")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("CALCULATED-TAG"), makeSymbol("CALCULATED-TAG-SUMMAND")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("BETTER-TAG"), makeSymbol("BETTER-TAG-SUMMAND")))), list(makeSymbol("CINC"), makeSymbol("CALCULATED-TAG-TYPICALITY-SUM"), makeSymbol("CALCULATED-TAG-SUMMAND")), list(makeSymbol("CINC"), makeSymbol("BETTER-TAG-TYPICALITY-SUM"), makeSymbol("BETTER-TAG-SUMMAND")), list(makeSymbol("FORMAT"), T, makeString("~%Total so far:~%")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("CALCULATED-TAG"), makeSymbol("CALCULATED-TAG-TYPICALITY-SUM")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("BETTER-TAG"), makeSymbol("BETTER-TAG-TYPICALITY-SUM")) }))), list(makeSymbol("FORMAT"), T, makeString("~%~%--------------------------------------------------------------------~%")), list(makeSymbol("DO-DICTIONARY"), list(makeSymbol("VERB"), makeSymbol("COUNT"), makeSymbol("VERB-COUNTS-AS-OBJ")), list(makeSymbol("CLET"), list(list(makeSymbol("CALCULATED-TAG-SUMMAND"), list(makeSymbol("FUNCALL"), makeSymbol("TYPICALITY-METRIC"), makeSymbol("VERB"), makeSymbol("CALCULATED-TAG"), makeKeyword("OBJ"))), list(makeSymbol("BETTER-TAG-SUMMAND"), list(makeSymbol("FUNCALL"), makeSymbol("TYPICALITY-METRIC"), makeSymbol("VERB"), makeSymbol("BETTER-TAG"), makeKeyword("OBJ"))), list(makeSymbol("WEIGHT-SUMMANDS-BY-SELECTIVENESS?"), list(EQ, makeSymbol("CALCULATE-TAG-METHOD"), makeKeyword("APMI-SUM-WEIGHTED-BY-SELECTIVENESS")))), list(new SubLObject[]{ makeSymbol("PWHEN"), makeSymbol("CALCULATED-TAG-SUMMAND"), list(makeSymbol("FORMAT"), T, makeString("~%~%As object:  ~S -> ~S~%"), makeSymbol("VERB"), makeSymbol("COUNT")), list(makeSymbol("FORMAT"), T, makeString("~%typicality-obj(~S,~S) = ~S"), makeSymbol("VERB"), makeSymbol("CALCULATED-TAG"), makeSymbol("CALCULATED-TAG-SUMMAND")), list(makeSymbol("FORMAT"), T, makeString("~%typicality-obj(~S,~S) = ~S~%"), makeSymbol("VERB"), makeSymbol("BETTER-TAG"), makeSymbol("BETTER-TAG-SUMMAND")), list(makeSymbol("PWHEN"), list(makeSymbol(">"), makeSymbol("COUNT"), ONE_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("CALCULATED-TAG-SUMMAND"), list(makeSymbol("*"), makeSymbol("CALCULATED-TAG-SUMMAND"), makeSymbol("COUNT")), makeSymbol("BETTER-TAG-SUMMAND"), list(makeSymbol("*"), makeSymbol("BETTER-TAG-SUMMAND"), makeSymbol("COUNT"))), list(makeSymbol("FORMAT"), T, makeString("~%Multiplied by count of ~S:~%"), makeSymbol("COUNT")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("CALCULATED-TAG"), makeSymbol("CALCULATED-TAG-SUMMAND")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("BETTER-TAG"), makeSymbol("BETTER-TAG-SUMMAND"))), list(makeSymbol("PWHEN"), makeSymbol("WEIGHT-SUMMANDS-BY-SELECTIVENESS?"), list(makeSymbol("CLET"), list(list(makeSymbol("SELECTIVENESS"), list(makeSymbol("SELECTIVENESS-WRT-OBJECT"), makeSymbol("VERB")))), list(makeSymbol("CSETQ"), makeSymbol("CALCULATED-TAG-SUMMAND"), list(makeSymbol("*"), makeSymbol("CALCULATED-TAG-SUMMAND"), makeSymbol("SELECTIVENESS")), makeSymbol("BETTER-TAG-SUMMAND"), list(makeSymbol("*"), makeSymbol("BETTER-TAG-SUMMAND"), makeSymbol("SELECTIVENESS"))), list(makeSymbol("FORMAT"), T, makeString("~%Multiplied by selectiveness-wrt-object(~S) = ~S~%"), makeSymbol("VERB"), makeSymbol("SELECTIVENESS")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("CALCULATED-TAG"), makeSymbol("CALCULATED-TAG-SUMMAND")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("BETTER-TAG"), makeSymbol("BETTER-TAG-SUMMAND")))), list(makeSymbol("CINC"), makeSymbol("CALCULATED-TAG-TYPICALITY-SUM"), makeSymbol("CALCULATED-TAG-SUMMAND")), list(makeSymbol("CINC"), makeSymbol("BETTER-TAG-TYPICALITY-SUM"), makeSymbol("BETTER-TAG-SUMMAND")), list(makeSymbol("FORMAT"), T, makeString("~%Total so far:~%")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("CALCULATED-TAG"), makeSymbol("CALCULATED-TAG-TYPICALITY-SUM")), list(makeSymbol("FORMAT"), T, makeString("~S:  ~S~%"), makeSymbol("BETTER-TAG"), makeSymbol("BETTER-TAG-TYPICALITY-SUM")) })))))), list(RET, NIL));
    }
