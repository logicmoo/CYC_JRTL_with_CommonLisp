...
public final class iteration extends SubLTranslatedFile {
    ...
    public static SubLObject iterator_p(final SubLObject v_object) {
        return v_object.getClass() == iteration.$iterator_native.class ? T : NIL;
    }

    public static SubLObject it_state(final SubLObject v_object) {
        assert NIL != iterator_p(v_object) : "iteration.iterator_p(v_object) " + "CommonSymbols.NIL != iteration.iterator_p(v_object) " + v_object;
    ...
    public static SubLObject make_iterator(SubLObject arglist) {
        ...
        final SubLObject v_new = new iteration.$iterator_native();
        SubLObject next;
    ...
    public static final class $iterator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(iteration.$iterator_native.class, ITERATOR, ITERATOR_P, $list2, $list3, new String[]{ "$state", "$done", "$next", "$finalize" }, $list4, $list5, PRINT_ITERATOR);
        }
    }
