...
import com.cyc.cycjava.cycl.rkf_test_suite_tool;
...
import static com.cyc.cycjava.cycl.rkf_test_suite_tool.*;
...
public final class rkf_test_suite_tool extends SubLTranslatedFile {
    ...
    public static SubLObject ts_query_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_test_suite_tool.$ts_query_native.class ? T : NIL;
    }

    public static SubLObject ts_query_id(final SubLObject v_object) {
        assert NIL != ts_query_p(v_object) : "rkf_test_suite_tool.ts_query_p(v_object) " + "CommonSymbols.NIL != rkf_test_suite_tool.ts_query_p(v_object) " + v_object;
    ...
    public static SubLObject make_ts_query(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_test_suite_tool.$ts_query_native();
        SubLObject next;
    ...
    public static SubLObject rkf_test_suite_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_test_suite_tool.$rkf_test_suite_native.class ? T : NIL;
    }

    public static SubLObject rkf_tsuite_isg(final SubLObject v_object) {
        assert NIL != rkf_test_suite_p(v_object) : "rkf_test_suite_tool.rkf_test_suite_p(v_object) " + "CommonSymbols.NIL != rkf_test_suite_tool.rkf_test_suite_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_rkf_test_suite(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_test_suite_tool.$rkf_test_suite_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $ts_query_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_test_suite_tool.$ts_query_native.class, TS_QUERY, TS_QUERY_P, $list3, $list4, new String[]{ "$id", "$label", "$formula", "$mt", "$number", "$time", "$backchain", "$depth", "$expected" }, $list5, $list6, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $rkf_test_suite_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_test_suite_tool.$rkf_test_suite_native.class, RKF_TEST_SUITE, RKF_TEST_SUITE_P, $list64, $list65, new String[]{ "$isg", "$label", "$filename", "$queries", "$siblings" }, $list66, $list67, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
