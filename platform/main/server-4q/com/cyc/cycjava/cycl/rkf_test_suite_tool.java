...
public final class rkf_test_suite_tool
    extends
      SubLTranslatedFile
{
  ...
  {
    assert NIL != rkf_test_suite_p( tsuite ) : tsuite;
  ...
  {
    return ( v_object.getClass() == $ts_query_native.class ) ? T : NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/rkf-test-suite-tool.lisp", position = 2616L)
  public static SubLObject ts_query_id(final SubLObject v_object)
  {
    assert NIL != ts_query_p( v_object ) : v_object;
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw38$BEGIN, $sym39$MAKE_TS_QUERY, NINE_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw28$ID, ts_query_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw29$LABEL, ts_query_label( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw30$FORMULA, ts_query_formula( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw31$MT, ts_query_mt( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw32$NUMBER, ts_query_number( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw33$TIME, ts_query_time( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw34$BACKCHAIN, ts_query_backchain( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw35$DEPTH, ts_query_depth( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw36$EXPECTED, ts_query_expected( obj ) );
    Functions.funcall( visitor_fn, obj, $kw41$END, $sym39$MAKE_TS_QUERY, NINE_INTEGER );
    return obj;
  }
  ...
  public static SubLObject new_ts_query(final SubLObject label, final SubLObject formula, final SubLObject microtheory, final SubLObject number, final SubLObject time, final SubLObject backchaining,
      final SubLObject depth, SubLObject expected)
  {
  ...
  public static SubLObject rkf_ts_parse_testcase_tokens(final SubLObject tokens)
  {
    ...
    while ( NIL != web_utilities.test_for_html_tagP( curr, $rkf_ts_test_case$.getGlobalValue() ))
    {
      ...
      curr = curr.rest();
      curr = conses_high.member( $rkf_ts_test_case$.getGlobalValue(), curr, Symbols.symbol_function( $sym58$SEARCH ), UNPROVIDED );
  ...
  public static SubLObject rkf_ts_interpret_parse(final SubLObject label, SubLObject formula, SubLObject microtheory, SubLObject number, SubLObject time, SubLObject backchaining, SubLObject depth)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          formula = reader.read_from_string( formula, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
        }
    ...
    microtheory = ( NIL != Strings.string_equal( microtheory, $rkf_ts_token_interaction_mt$.getGlobalValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) ? $kw61$INTERACTION_MT
        : reader.read_from_string( microtheory, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    number = ( NIL != Strings.string_equal( number, $rkf_ts_token_everything$.getGlobalValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) ? NIL
        : reader.parse_integer( number, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    time = ( NIL != Strings.string_equal( time, $rkf_ts_token_forever$.getGlobalValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) ? NIL
        : reader.parse_integer( time, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL != Strings.string_equal( backchaining, $rkf_ts_token_none$.getGlobalValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) )
    {
      backchaining = NIL;
    }
    else if( NIL != Strings.string_equal( backchaining, $rkf_ts_token_forever$.getGlobalValue(), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) )
    {
      backchaining = T;
    }
    else
    {
      backchaining = reader.parse_integer( backchaining, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
    if( NIL != Strings.string_equal( depth, $str62$NIL, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) )
    {
      depth = NIL;
    }
    else
    {
      depth = reader.parse_integer( depth, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
  ...
  public static SubLObject rkf_ts_write_one_query(final SubLObject s, final SubLObject query)
  {
    ...
    write_tagged_value( $rkf_ts_microtheory$.getGlobalValue(), ( ts_query_mt( query ) == $kw61$INTERACTION_MT ) ? $rkf_ts_token_interaction_mt$.getGlobalValue() : ts_query_mt( query ), s );
    ...
    write_tagged_value( $rkf_ts_backchaining$.getGlobalValue(), ( NIL == ts_query_backchain( query ) ) ? $rkf_ts_token_none$.getGlobalValue()
        : ( ( T == ts_query_backchain( query ) ) ? $rkf_ts_token_forever$.getGlobalValue() : ts_query_backchain( query ) ), s );
  ...
  {
    return ( v_object.getClass() == $rkf_test_suite_native.class ) ? T : NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/rkf-test-suite-tool.lisp", position = 9527L)
  public static SubLObject rkf_tsuite_isg(final SubLObject v_object)
  {
    assert NIL != rkf_test_suite_p( v_object ) : v_object;
    return v_object.getField2();
  }
  ...
  public static SubLObject make_rkf_test_suite(SubLObject arglist)
  {
    ...
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      else if( pcase_var.eql( $kw81$FILENAME ) )
      {
        _csetf_rkf_tsuite_filename( v_new, current_value );
      }
      else if( pcase_var.eql( $kw82$QUERIES ) )
      {
        _csetf_rkf_tsuite_queries( v_new, current_value );
      }
      else if( pcase_var.eql( $kw83$SIBLINGS ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw38$BEGIN, $sym84$MAKE_RKF_TEST_SUITE, FIVE_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw80$ISG, rkf_tsuite_isg( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw29$LABEL, rkf_tsuite_label( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw81$FILENAME, rkf_tsuite_filename( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw82$QUERIES, rkf_tsuite_queries( obj ) );
    Functions.funcall( visitor_fn, obj, $kw40$SLOT, $kw83$SIBLINGS, rkf_tsuite_siblings( obj ) );
    Functions.funcall( visitor_fn, obj, $kw41$END, $sym84$MAKE_RKF_TEST_SUITE, FIVE_INTEGER );
    return obj;
  }
  ...
  public static SubLObject new_rkf_tsuite(final SubLObject filename)
  {
    ...
    _csetf_rkf_tsuite_siblings( tsuite, dictionary.new_dictionary( Symbols.symbol_function( EQUALP ), UNPROVIDED ) );
    return tsuite;
  }
  ...
  public static SubLObject rkf_test_suite_queries_as_list(final SubLObject tsuite)
  {
    ...
    return Sort.sort( queries, $sym86$_, $sym10$TS_QUERY_ID );
  }
  ...
  public static SubLObject rkf_ts_fetch_test_suite_in_xml(final SubLObject filename)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        stream = compatibility.open_text( filename, $kw89$INPUT );
      }
      finally
      {
  ...
  public static SubLObject rkf_ts_parse_test_suite_tokens(final SubLObject tsuite, final SubLObject tokens)
  {
    ...
    SubLObject queries = NIL;
    SubLObject error_message = NIL;
    SubLObject curr = conses_high.member( $rkf_ts_definition$.getGlobalValue(), tokens, Symbols.symbol_function( $sym58$SEARCH ), UNPROVIDED ).rest();
  ...
  public static SubLObject rkf_ts_insert_query(final SubLObject tsuite, final SubLObject query)
  {
    ...
    {
      final SubLObject new_label = Sequences.cconcatenate( $test_suite_query_default_label$.getGlobalValue(), new SubLObject[] { $str92$__, string_utilities.str( id )
      } );
  ...
  public static SubLObject rkf_ts_initialize_all_siblings(final SubLObject tsuite)
  {
    ...
    for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( rkf_tsuite_queries( tsuite ) ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
  ...
  public static SubLObject rkf_ts_write_definition(final SubLObject s, final SubLObject tsuite)
  {
    ...
    streams_high.write_string( rkf_tsuite_label( tsuite ), s, UNPROVIDED, UNPROVIDED );
  ...
  {
    return streams_high.write_string( tag, s, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    streams_high.write_string( $str94$__, s, UNPROVIDED, UNPROVIDED );
    return streams_high.write_string( tag, s, ONE_INTEGER, UNPROVIDED );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject mt = ( ts_query_mt( query ) == $kw61$INTERACTION_MT ) ? current_mt : ts_query_mt( query );
    ...
    if( type == $kw95$TRUTH )
    {
      ...
      if( NIL == current )
      {
        answers = ConsesLow.list( $kw95$TRUTH, ConsesLow.list( ConsesLow.list( $kw97$PRO, pro ), ConsesLow.list( $kw98$CON, con ) ) );
      }
      else
      {
    ...
    {
      answers = ConsesLow.list( $kw99$QUERY, rkf_query_utilities.rkf_expand_justifications( results ) );
    }
    return answers;
  }
  ...
  public static SubLObject rkf_ts_classify_terms_for_iet_answer_page_new(final SubLObject test_suite, final SubLObject query, final SubLObject results, final SubLObject mt)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    thread.resetMultipleValues();
    final SubLObject v_question = rkf_ts_classify_terms_used_new( test_suite, query, ConsesLow.list( rkf_query_utilities.rkf_determine_query_type( cycl_query_specification.cycl_query_specification_formula( query ),
        cycl_query_specification.cycl_query_specification_mt( query ) ), results ), mt );
  ...
  public static SubLObject rkf_ts_classify_terms_used_new(final SubLObject test_suite, final SubLObject query, final SubLObject results, final SubLObject mt)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( results, results, $list100 );
    type = results.first();
    SubLObject current = results.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, results, $list100 );
    the_results = current.first();
    current = current.rest();
    if( NIL == current )
    {
      if( type == $kw99$QUERY || type == $kw101$ASK )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          cdestructuring_bind.destructuring_bind_must_consp( current_$10, datum_$9, $list102 );
          ...
          if( NIL == current_$10 )
          {
            ...
            {
              final SubLObject item_var = v_term;
              if( NIL == conses_high.member( item_var, support, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
              {
                support = ConsesLow.cons( item_var, support );
              }
          ...
          {
            cdestructuring_bind.cdestructuring_bind_error( datum_$9, $list102 );
          }
          cdolist_list_var = cdolist_list_var.rest();
          result = cdolist_list_var.first();
        }
      ...
      {
        final SubLObject pro_args = conses_high.assoc( $kw97$PRO, the_results, UNPROVIDED, UNPROVIDED );
        final SubLObject pro = conses_high.second( pro_args );
        final SubLObject con_args = conses_high.assoc( $kw98$CON, the_results, UNPROVIDED, UNPROVIDED );
        ...
        if( NIL != pro )
        {
          ...
          while ( NIL != cdolist_list_var2)
          {
            ...
            if( NIL == conses_high.member( item_var2, support, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
            {
              support = ConsesLow.cons( item_var2, support );
            }
    ...
    {
      cdestructuring_bind.cdestructuring_bind_error( results, $list100 );
    }
    ...
    if( NIL == current )
    {
      if( type == $kw99$QUERY || type == $kw101$ASK )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          SubLObject v_bindings = NIL;
          SubLObject supports = NIL;
          cdestructuring_bind.destructuring_bind_must_consp( current_$15, datum_$14, $list102 );
          ...
          {
            cdestructuring_bind.cdestructuring_bind_error( datum_$14, $list102 );
          }
          cdolist_list_var = cdolist_list_var.rest();
          result = cdolist_list_var.first();
        }
  ...
  {
    SubLObject assertions = NIL;
    SubLObject cdolist_list_var = list_utilities.tree_gather( supports, $sym103$ASSERTION_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject rkf_ts_expand_support_to_el_formulas(final SubLObject item)
  {
    ...
    if( item.isCons() )
    {
      return ConsesLow.cons( rkf_ts_expand_support_to_el_formulas( item.first() ), rkf_ts_expand_support_to_el_formulas( item.rest() ) );
    }
    return item;
  }
  ...
  {
    final SubLObject terms = list_utilities.tree_find_all_if( $sym104$FORT_P, formulas, UNPROVIDED );
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != nart_handles.nart_p( v_term ) )
      {
        ...
        {
          result_terms = ConsesLow.cons( nart_item, result_terms );
      ...
      {
        result_terms = ConsesLow.cons( v_term, result_terms );
      }
      cdolist_list_var = cdolist_list_var.rest();
      v_term = cdolist_list_var.first();
    }
    return Sequences.delete_duplicates( result_terms, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject rkf_ts_minimal_book_keeping_info_for_terms(final SubLObject terms)
  {
    ...
    SubLObject cdolist_list_var = Sort.sort( terms, $sym105$STRING_, $sym106$FORT_NAME );
    SubLObject v_term = NIL;
    v_term = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      final SubLObject info = rkf_ts_minimal_book_keeping_info_for_term( v_term );
      book_keeping_info = ConsesLow.cons( info, book_keeping_info );
      cdolist_list_var = cdolist_list_var.rest();
      v_term = cdolist_list_var.first();
    }
  ...
  public static SubLObject rkf_ts_minimal_book_keeping_info_for_term(final SubLObject v_term)
  {
    ...
    return ConsesLow.list( v_term, creator, time, second );
  }

  public static SubLObject declare_rkf_test_suite_tool_file()
  {
    SubLFiles.declareFunction( me, "new_test_suite_from_file", "NEW-TEST-SUITE-FROM-FILE", 1, 0, false );
    SubLFiles.declareFunction( me, "test_suite_save", "TEST-SUITE-SAVE", 1, 0, false );
    SubLFiles.declareFunction( me, "test_suite_write", "TEST-SUITE-WRITE", 2, 0, false );
    SubLFiles.declareFunction( me, "fetch_test_suite_query_list", "FETCH-TEST-SUITE-QUERY-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "test_suite_get_number_of_queries", "TEST-SUITE-GET-NUMBER-OF-QUERIES", 1, 0, false );
    SubLFiles.declareFunction( me, "test_suite_find_query_by_id", "TEST-SUITE-FIND-QUERY-BY-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "test_suite_find_query_by_id_string", "TEST-SUITE-FIND-QUERY-BY-ID-STRING", 2, 0, false );
    SubLFiles.declareFunction( me, "test_suite_query_siblings", "TEST-SUITE-QUERY-SIBLINGS", 2, 0, false );
    SubLFiles.declareFunction( me, "test_suite_add_query", "TEST-SUITE-ADD-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "test_suite_drop_query", "TEST-SUITE-DROP-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "test_suite_run_query", "TEST-SUITE-RUN-QUERY", 2, 1, false );
    SubLFiles.declareFunction( me, "ts_query_print_function_trampoline", "TS-QUERY-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "ts_query_p", "TS-QUERY-P", 1, 0, false );
    new $ts_query_p$UnaryFunction();
    SubLFiles.declareFunction( me, "ts_query_id", "TS-QUERY-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "ts_query_label", "TS-QUERY-LABEL", 1, 0, false );
    SubLFiles.declareFunction( me, "ts_query_formula", "TS-QUERY-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( me, "ts_query_mt", "TS-QUERY-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "ts_query_number", "TS-QUERY-NUMBER", 1, 0, false );
    SubLFiles.declareFunction( me, "ts_query_time", "TS-QUERY-TIME", 1, 0, false );
    SubLFiles.declareFunction( me, "ts_query_backchain", "TS-QUERY-BACKCHAIN", 1, 0, false );
    SubLFiles.declareFunction( me, "ts_query_depth", "TS-QUERY-DEPTH", 1, 0, false );
    SubLFiles.declareFunction( me, "ts_query_expected", "TS-QUERY-EXPECTED", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ts_query_id", "_CSETF-TS-QUERY-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ts_query_label", "_CSETF-TS-QUERY-LABEL", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ts_query_formula", "_CSETF-TS-QUERY-FORMULA", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ts_query_mt", "_CSETF-TS-QUERY-MT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ts_query_number", "_CSETF-TS-QUERY-NUMBER", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ts_query_time", "_CSETF-TS-QUERY-TIME", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ts_query_backchain", "_CSETF-TS-QUERY-BACKCHAIN", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ts_query_depth", "_CSETF-TS-QUERY-DEPTH", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_ts_query_expected", "_CSETF-TS-QUERY-EXPECTED", 2, 0, false );
    SubLFiles.declareFunction( me, "make_ts_query", "MAKE-TS-QUERY", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_ts_query", "VISIT-DEFSTRUCT-TS-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_ts_query_method", "VISIT-DEFSTRUCT-OBJECT-TS-QUERY-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "new_ts_query", "NEW-TS-QUERY", 7, 1, false );
    SubLFiles.declareFunction( me, "clone_ts_query", "CLONE-TS-QUERY", 1, 0, false );
    SubLFiles.declareFunction( me, "ts_query_label_update", "TS-QUERY-LABEL-UPDATE", 3, 0, false );
    SubLFiles.declareFunction( me, "ts_query_formula_update", "TS-QUERY-FORMULA-UPDATE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_parse_testcase_tokens", "RKF-TS-PARSE-TESTCASE-TOKENS", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_interpret_parse", "RKF-TS-INTERPRET-PARSE", 7, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_write_one_query", "RKF-TS-WRITE-ONE-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_test_suite_print_function_trampoline", "RKF-TEST-SUITE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_test_suite_p", "RKF-TEST-SUITE-P", 1, 0, false );
    new $rkf_test_suite_p$UnaryFunction();
    SubLFiles.declareFunction( me, "rkf_tsuite_isg", "RKF-TSUITE-ISG", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_tsuite_label", "RKF-TSUITE-LABEL", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_tsuite_filename", "RKF-TSUITE-FILENAME", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_tsuite_queries", "RKF-TSUITE-QUERIES", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_tsuite_siblings", "RKF-TSUITE-SIBLINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_rkf_tsuite_isg", "_CSETF-RKF-TSUITE-ISG", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_rkf_tsuite_label", "_CSETF-RKF-TSUITE-LABEL", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_rkf_tsuite_filename", "_CSETF-RKF-TSUITE-FILENAME", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_rkf_tsuite_queries", "_CSETF-RKF-TSUITE-QUERIES", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_rkf_tsuite_siblings", "_CSETF-RKF-TSUITE-SIBLINGS", 2, 0, false );
    SubLFiles.declareFunction( me, "make_rkf_test_suite", "MAKE-RKF-TEST-SUITE", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_rkf_test_suite", "VISIT-DEFSTRUCT-RKF-TEST-SUITE", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_rkf_test_suite_method", "VISIT-DEFSTRUCT-OBJECT-RKF-TEST-SUITE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "new_rkf_tsuite", "NEW-RKF-TSUITE", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_test_suite_queries_as_list", "RKF-TEST-SUITE-QUERIES-AS-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_obtain_test_suite", "RKF-TS-OBTAIN-TEST-SUITE", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_fetch_test_suite_in_xml", "RKF-TS-FETCH-TEST-SUITE-IN-XML", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_cleaned_string", "RKF-TS-CLEANED-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_parse_test_suite_tokens", "RKF-TS-PARSE-TEST-SUITE-TOKENS", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_insert_query", "RKF-TS-INSERT-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_finalize_test_suite", "RKF-TS-FINALIZE-TEST-SUITE", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_initialize_all_siblings", "RKF-TS-INITIALIZE-ALL-SIBLINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_update_query_siblings", "RKF-TS-UPDATE-QUERY-SIBLINGS", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_remove_query_from_siblings", "RKF-TS-REMOVE-QUERY-FROM-SIBLINGS", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_save_test_suite", "RKF-TS-SAVE-TEST-SUITE", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_write_test_suite", "RKF-TS-WRITE-TEST-SUITE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_write_queries", "RKF-TS-WRITE-QUERIES", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_write_prologue", "RKF-TS-WRITE-PROLOGUE", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_write_definition", "RKF-TS-WRITE-DEFINITION", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_write_epilogue", "RKF-TS-WRITE-EPILOGUE", 2, 0, false );
    SubLFiles.declareFunction( me, "write_tagged_value", "WRITE-TAGGED-VALUE", 3, 0, false );
    SubLFiles.declareFunction( me, "write_opening_tag", "WRITE-OPENING-TAG", 2, 0, false );
    SubLFiles.declareFunction( me, "write_closing_tag", "WRITE-CLOSING-TAG", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_run_query", "RKF-TS-RUN-QUERY", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_classify_terms_for_iet_answer_page_new", "RKF-TS-CLASSIFY-TERMS-FOR-IET-ANSWER-PAGE-NEW", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_classify_terms_for_iet_answer_page", "RKF-TS-CLASSIFY-TERMS-FOR-IET-ANSWER-PAGE", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_classify_terms_used_new", "RKF-TS-CLASSIFY-TERMS-USED-NEW", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_classify_terms_used", "RKF-TS-CLASSIFY-TERMS-USED", 4, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_gather_used_support_assertions", "RKF-TS-GATHER-USED-SUPPORT-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_gather_used_support_terms", "RKF-TS-GATHER-USED-SUPPORT-TERMS", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_expand_support_to_el_formulas", "RKF-TS-EXPAND-SUPPORT-TO-EL-FORMULAS", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_gather_used_terms", "RKF-TS-GATHER-USED-TERMS", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_minimal_book_keeping_info_for_terms", "RKF-TS-MINIMAL-BOOK-KEEPING-INFO-FOR-TERMS", 1, 0, false );
    SubLFiles.declareFunction( me, "rkf_ts_minimal_book_keeping_info_for_term", "RKF-TS-MINIMAL-BOOK-KEEPING-INFO-FOR-TERM", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_rkf_test_suite_tool_file()
  {
    $dtp_ts_query$ = SubLFiles.defconstant( "*DTP-TS-QUERY*", $sym1$TS_QUERY );
    $rkf_ts_test_case$ = SubLFiles.deflexical( "*RKF-TS-TEST-CASE*", $str43$_testcase_ );
    $rkf_ts_label$ = SubLFiles.deflexical( "*RKF-TS-LABEL*", $str44$_label_ );
    $rkf_ts_formula$ = SubLFiles.deflexical( "*RKF-TS-FORMULA*", $str45$_formula_ );
    $rkf_ts_microtheory$ = SubLFiles.deflexical( "*RKF-TS-MICROTHEORY*", $str46$_microtheory_ );
    $rkf_ts_settings$ = SubLFiles.deflexical( "*RKF-TS-SETTINGS*", $str47$_settings_ );
    $rkf_ts_number$ = SubLFiles.deflexical( "*RKF-TS-NUMBER*", $str48$_number_ );
    $rkf_ts_time$ = SubLFiles.deflexical( "*RKF-TS-TIME*", $str49$_time_ );
    $rkf_ts_backchaining$ = SubLFiles.deflexical( "*RKF-TS-BACKCHAINING*", $str50$_backchaining_ );
    $rkf_ts_depth$ = SubLFiles.deflexical( "*RKF-TS-DEPTH*", $str51$_depth_ );
    $rkf_ts_token_interaction_mt$ = SubLFiles.deflexical( "*RKF-TS-TOKEN-INTERACTION-MT*", $str52$_interaction_mt__ );
    $rkf_ts_token_everything$ = SubLFiles.deflexical( "*RKF-TS-TOKEN-EVERYTHING*", $str53$_everything__ );
    $rkf_ts_token_forever$ = SubLFiles.deflexical( "*RKF-TS-TOKEN-FOREVER*", $str54$_forever__ );
    $rkf_ts_token_none$ = SubLFiles.deflexical( "*RKF-TS-TOKEN-NONE*", $str55$_none__ );
    $dtp_rkf_test_suite$ = SubLFiles.defconstant( "*DTP-RKF-TEST-SUITE*", $sym63$RKF_TEST_SUITE );
    $rkf_ts_definition$ = SubLFiles.deflexical( "*RKF-TS-DEFINITION*", $str87$_definition_ );
    $rkf_ts_test_suite$ = SubLFiles.deflexical( "*RKF-TS-TEST-SUITE*", $str88$_testsuite_ );
    $test_suite_query_default_label$ = SubLFiles.deflexical( "*TEST-SUITE-QUERY-DEFAULT-LABEL*", $str91$unnamed_query );
    return NIL;
  }

  public static SubLObject setup_rkf_test_suite_tool_file()
  {
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_ts_query$.getGlobalValue(), Symbols.symbol_function( $sym8$TS_QUERY_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list9 );
    Structures.def_csetf( $sym10$TS_QUERY_ID, $sym11$_CSETF_TS_QUERY_ID );
    Structures.def_csetf( $sym12$TS_QUERY_LABEL, $sym13$_CSETF_TS_QUERY_LABEL );
    Structures.def_csetf( $sym14$TS_QUERY_FORMULA, $sym15$_CSETF_TS_QUERY_FORMULA );
    Structures.def_csetf( $sym16$TS_QUERY_MT, $sym17$_CSETF_TS_QUERY_MT );
    Structures.def_csetf( $sym18$TS_QUERY_NUMBER, $sym19$_CSETF_TS_QUERY_NUMBER );
    Structures.def_csetf( $sym20$TS_QUERY_TIME, $sym21$_CSETF_TS_QUERY_TIME );
    Structures.def_csetf( $sym22$TS_QUERY_BACKCHAIN, $sym23$_CSETF_TS_QUERY_BACKCHAIN );
    Structures.def_csetf( $sym24$TS_QUERY_DEPTH, $sym25$_CSETF_TS_QUERY_DEPTH );
    Structures.def_csetf( $sym26$TS_QUERY_EXPECTED, $sym27$_CSETF_TS_QUERY_EXPECTED );
    Equality.identity( $sym1$TS_QUERY );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_ts_query$.getGlobalValue(), Symbols.symbol_function( $sym42$VISIT_DEFSTRUCT_OBJECT_TS_QUERY_METHOD ) );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_rkf_test_suite$.getGlobalValue(), Symbols.symbol_function( $sym68$RKF_TEST_SUITE_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list69 );
    Structures.def_csetf( $sym70$RKF_TSUITE_ISG, $sym71$_CSETF_RKF_TSUITE_ISG );
    Structures.def_csetf( $sym72$RKF_TSUITE_LABEL, $sym73$_CSETF_RKF_TSUITE_LABEL );
    Structures.def_csetf( $sym74$RKF_TSUITE_FILENAME, $sym75$_CSETF_RKF_TSUITE_FILENAME );
    Structures.def_csetf( $sym76$RKF_TSUITE_QUERIES, $sym77$_CSETF_RKF_TSUITE_QUERIES );
    Structures.def_csetf( $sym78$RKF_TSUITE_SIBLINGS, $sym79$_CSETF_RKF_TSUITE_SIBLINGS );
    Equality.identity( $sym63$RKF_TEST_SUITE );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_rkf_test_suite$.getGlobalValue(), Symbols.symbol_function( $sym85$VISIT_DEFSTRUCT_OBJECT_RKF_TEST_SUITE_METHOD ) );
    return NIL;
  }
  ...
  static
  {
    me = new rkf_test_suite_tool();
    $dtp_ts_query$ = null;
    $rkf_ts_test_case$ = null;
    $rkf_ts_label$ = null;
    $rkf_ts_formula$ = null;
    $rkf_ts_microtheory$ = null;
    $rkf_ts_settings$ = null;
    $rkf_ts_number$ = null;
    $rkf_ts_time$ = null;
    $rkf_ts_backchaining$ = null;
    $rkf_ts_depth$ = null;
    $rkf_ts_token_interaction_mt$ = null;
    $rkf_ts_token_everything$ = null;
    $rkf_ts_token_forever$ = null;
    $rkf_ts_token_none$ = null;
    $dtp_rkf_test_suite$ = null;
    $rkf_ts_definition$ = null;
    $rkf_ts_test_suite$ = null;
    $test_suite_query_default_label$ = null;
    $sym0$RKF_TEST_SUITE_P = makeSymbol( "RKF-TEST-SUITE-P" );
    $sym1$TS_QUERY = makeSymbol( "TS-QUERY" );
    $sym2$TS_QUERY_P = makeSymbol( "TS-QUERY-P" );
    $list3 = ConsesLow.list( new SubLObject[] { makeSymbol( "ID" ), makeSymbol( "LABEL" ), makeSymbol( "FORMULA" ), makeSymbol( "MT" ), makeSymbol( "NUMBER" ), makeSymbol( "TIME" ), makeSymbol( "BACKCHAIN" ), makeSymbol(
        "DEPTH" ), makeSymbol( "EXPECTED" )
    } );
    $list4 = ConsesLow.list( new SubLObject[] { makeKeyword( "ID" ), makeKeyword( "LABEL" ), makeKeyword( "FORMULA" ), makeKeyword( "MT" ), makeKeyword( "NUMBER" ), makeKeyword( "TIME" ), makeKeyword( "BACKCHAIN" ),
      makeKeyword( "DEPTH" ), makeKeyword( "EXPECTED" )
    } );
    $list5 = ConsesLow.list( new SubLObject[] { makeSymbol( "TS-QUERY-ID" ), makeSymbol( "TS-QUERY-LABEL" ), makeSymbol( "TS-QUERY-FORMULA" ), makeSymbol( "TS-QUERY-MT" ), makeSymbol( "TS-QUERY-NUMBER" ), makeSymbol(
        "TS-QUERY-TIME" ), makeSymbol( "TS-QUERY-BACKCHAIN" ), makeSymbol( "TS-QUERY-DEPTH" ), makeSymbol( "TS-QUERY-EXPECTED" )
    } );
    $list6 = ConsesLow.list( new SubLObject[] { makeSymbol( "_CSETF-TS-QUERY-ID" ), makeSymbol( "_CSETF-TS-QUERY-LABEL" ), makeSymbol( "_CSETF-TS-QUERY-FORMULA" ), makeSymbol( "_CSETF-TS-QUERY-MT" ), makeSymbol(
        "_CSETF-TS-QUERY-NUMBER" ), makeSymbol( "_CSETF-TS-QUERY-TIME" ), makeSymbol( "_CSETF-TS-QUERY-BACKCHAIN" ), makeSymbol( "_CSETF-TS-QUERY-DEPTH" ), makeSymbol( "_CSETF-TS-QUERY-EXPECTED" )
    } );
    $sym7$DEFAULT_STRUCT_PRINT_FUNCTION = makeSymbol( "DEFAULT-STRUCT-PRINT-FUNCTION" );
    $sym8$TS_QUERY_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "TS-QUERY-PRINT-FUNCTION-TRAMPOLINE" );
    $list9 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "TS-QUERY-P" ) );
    $sym10$TS_QUERY_ID = makeSymbol( "TS-QUERY-ID" );
    $sym11$_CSETF_TS_QUERY_ID = makeSymbol( "_CSETF-TS-QUERY-ID" );
    $sym12$TS_QUERY_LABEL = makeSymbol( "TS-QUERY-LABEL" );
    $sym13$_CSETF_TS_QUERY_LABEL = makeSymbol( "_CSETF-TS-QUERY-LABEL" );
    $sym14$TS_QUERY_FORMULA = makeSymbol( "TS-QUERY-FORMULA" );
    $sym15$_CSETF_TS_QUERY_FORMULA = makeSymbol( "_CSETF-TS-QUERY-FORMULA" );
    $sym16$TS_QUERY_MT = makeSymbol( "TS-QUERY-MT" );
    $sym17$_CSETF_TS_QUERY_MT = makeSymbol( "_CSETF-TS-QUERY-MT" );
    $sym18$TS_QUERY_NUMBER = makeSymbol( "TS-QUERY-NUMBER" );
    $sym19$_CSETF_TS_QUERY_NUMBER = makeSymbol( "_CSETF-TS-QUERY-NUMBER" );
    $sym20$TS_QUERY_TIME = makeSymbol( "TS-QUERY-TIME" );
    $sym21$_CSETF_TS_QUERY_TIME = makeSymbol( "_CSETF-TS-QUERY-TIME" );
    $sym22$TS_QUERY_BACKCHAIN = makeSymbol( "TS-QUERY-BACKCHAIN" );
    $sym23$_CSETF_TS_QUERY_BACKCHAIN = makeSymbol( "_CSETF-TS-QUERY-BACKCHAIN" );
    $sym24$TS_QUERY_DEPTH = makeSymbol( "TS-QUERY-DEPTH" );
    $sym25$_CSETF_TS_QUERY_DEPTH = makeSymbol( "_CSETF-TS-QUERY-DEPTH" );
    $sym26$TS_QUERY_EXPECTED = makeSymbol( "TS-QUERY-EXPECTED" );
    $sym27$_CSETF_TS_QUERY_EXPECTED = makeSymbol( "_CSETF-TS-QUERY-EXPECTED" );
    $kw28$ID = makeKeyword( "ID" );
    $kw29$LABEL = makeKeyword( "LABEL" );
    $kw30$FORMULA = makeKeyword( "FORMULA" );
    $kw31$MT = makeKeyword( "MT" );
    $kw32$NUMBER = makeKeyword( "NUMBER" );
    $kw33$TIME = makeKeyword( "TIME" );
    $kw34$BACKCHAIN = makeKeyword( "BACKCHAIN" );
    $kw35$DEPTH = makeKeyword( "DEPTH" );
    $kw36$EXPECTED = makeKeyword( "EXPECTED" );
    $str37$Invalid_slot__S_for_construction_ = makeString( "Invalid slot ~S for construction function" );
    $kw38$BEGIN = makeKeyword( "BEGIN" );
    $sym39$MAKE_TS_QUERY = makeSymbol( "MAKE-TS-QUERY" );
    $kw40$SLOT = makeKeyword( "SLOT" );
    $kw41$END = makeKeyword( "END" );
    $sym42$VISIT_DEFSTRUCT_OBJECT_TS_QUERY_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-TS-QUERY-METHOD" );
    $str43$_testcase_ = makeString( "<testcase>" );
    $str44$_label_ = makeString( "<label>" );
    $str45$_formula_ = makeString( "<formula>" );
    $str46$_microtheory_ = makeString( "<microtheory>" );
    $str47$_settings_ = makeString( "<settings>" );
    $str48$_number_ = makeString( "<number>" );
    $str49$_time_ = makeString( "<time>" );
    $str50$_backchaining_ = makeString( "<backchaining>" );
    $str51$_depth_ = makeString( "<depth>" );
    $str52$_interaction_mt__ = makeString( "<interaction-mt/>" );
    $str53$_everything__ = makeString( "<everything/>" );
    $str54$_forever__ = makeString( "<forever/>" );
    $str55$_none__ = makeString( "<none/>" );
    $str56$Invalid_input_file_format__Expect = makeString( "Invalid input file format. Expected starting ~S and received ~S.~%" );
    $str57$Invalid_input_file_format__Expect = makeString( "Invalid input file format. Expected closing ~S and received ~S.~%" );
    $sym58$SEARCH = makeSymbol( "SEARCH" );
    $sym59$CATCH_ERROR_MESSAGE_HANDLER = makeSymbol( "CATCH-ERROR-MESSAGE-HANDLER" );
    $str60$Skipping_Query__A_due_to_error__A = makeString( "Skipping Query ~A due to error ~A.~%" );
    $kw61$INTERACTION_MT = makeKeyword( "INTERACTION-MT" );
    $str62$NIL = makeString( "NIL" );
    $sym63$RKF_TEST_SUITE = makeSymbol( "RKF-TEST-SUITE" );
    $list64 = ConsesLow.list( makeSymbol( "ISG" ), makeSymbol( "LABEL" ), makeSymbol( "FILENAME" ), makeSymbol( "QUERIES" ), makeSymbol( "SIBLINGS" ) );
    $list65 = ConsesLow.list( makeKeyword( "ISG" ), makeKeyword( "LABEL" ), makeKeyword( "FILENAME" ), makeKeyword( "QUERIES" ), makeKeyword( "SIBLINGS" ) );
    $list66 = ConsesLow.list( makeSymbol( "RKF-TSUITE-ISG" ), makeSymbol( "RKF-TSUITE-LABEL" ), makeSymbol( "RKF-TSUITE-FILENAME" ), makeSymbol( "RKF-TSUITE-QUERIES" ), makeSymbol( "RKF-TSUITE-SIBLINGS" ) );
    $list67 = ConsesLow.list( makeSymbol( "_CSETF-RKF-TSUITE-ISG" ), makeSymbol( "_CSETF-RKF-TSUITE-LABEL" ), makeSymbol( "_CSETF-RKF-TSUITE-FILENAME" ), makeSymbol( "_CSETF-RKF-TSUITE-QUERIES" ), makeSymbol(
        "_CSETF-RKF-TSUITE-SIBLINGS" ) );
    $sym68$RKF_TEST_SUITE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "RKF-TEST-SUITE-PRINT-FUNCTION-TRAMPOLINE" );
    $list69 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "RKF-TEST-SUITE-P" ) );
    $sym70$RKF_TSUITE_ISG = makeSymbol( "RKF-TSUITE-ISG" );
    $sym71$_CSETF_RKF_TSUITE_ISG = makeSymbol( "_CSETF-RKF-TSUITE-ISG" );
    $sym72$RKF_TSUITE_LABEL = makeSymbol( "RKF-TSUITE-LABEL" );
    $sym73$_CSETF_RKF_TSUITE_LABEL = makeSymbol( "_CSETF-RKF-TSUITE-LABEL" );
    $sym74$RKF_TSUITE_FILENAME = makeSymbol( "RKF-TSUITE-FILENAME" );
    $sym75$_CSETF_RKF_TSUITE_FILENAME = makeSymbol( "_CSETF-RKF-TSUITE-FILENAME" );
    $sym76$RKF_TSUITE_QUERIES = makeSymbol( "RKF-TSUITE-QUERIES" );
    $sym77$_CSETF_RKF_TSUITE_QUERIES = makeSymbol( "_CSETF-RKF-TSUITE-QUERIES" );
    $sym78$RKF_TSUITE_SIBLINGS = makeSymbol( "RKF-TSUITE-SIBLINGS" );
    $sym79$_CSETF_RKF_TSUITE_SIBLINGS = makeSymbol( "_CSETF-RKF-TSUITE-SIBLINGS" );
    $kw80$ISG = makeKeyword( "ISG" );
    $kw81$FILENAME = makeKeyword( "FILENAME" );
    $kw82$QUERIES = makeKeyword( "QUERIES" );
    $kw83$SIBLINGS = makeKeyword( "SIBLINGS" );
    $sym84$MAKE_RKF_TEST_SUITE = makeSymbol( "MAKE-RKF-TEST-SUITE" );
    $sym85$VISIT_DEFSTRUCT_OBJECT_RKF_TEST_SUITE_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-RKF-TEST-SUITE-METHOD" );
    $sym86$_ = makeSymbol( "<" );
    $str87$_definition_ = makeString( "<definition>" );
    $str88$_testsuite_ = makeString( "<testsuite>" );
    $kw89$INPUT = makeKeyword( "INPUT" );
    $str90$Unable_to_open__S = makeString( "Unable to open ~S" );
    $str91$unnamed_query = makeString( "unnamed query" );
    $str92$__ = makeString( " #" );
    $kw93$OUTPUT = makeKeyword( "OUTPUT" );
    $str94$__ = makeString( "</" );
    $kw95$TRUTH = makeKeyword( "TRUTH" );
    $list96 = ConsesLow.list( makeSymbol( "PRO" ), makeSymbol( "CON" ) );
    $kw97$PRO = makeKeyword( "PRO" );
    $kw98$CON = makeKeyword( "CON" );
    $kw99$QUERY = makeKeyword( "QUERY" );
    $list100 = ConsesLow.list( makeSymbol( "TYPE" ), makeSymbol( "THE-RESULTS" ) );
    $kw101$ASK = makeKeyword( "ASK" );
    $list102 = ConsesLow.list( makeSymbol( "BINDINGS" ), makeSymbol( "SUPPORTS" ) );
    $sym103$ASSERTION_P = makeSymbol( "ASSERTION-P" );
    $sym104$FORT_P = makeSymbol( "FORT-P" );
    $sym105$STRING_ = makeSymbol( "STRING<" );
    $sym106$FORT_NAME = makeSymbol( "FORT-NAME" );
  }

  public static final class $ts_query_native
      extends
        SubLStructNative
  {
    ...
    public $ts_query_native()
    {
      ...
      this.$time = CommonSymbols.NIL;
      this.$backchain = CommonSymbols.NIL;
      this.$depth = CommonSymbols.NIL;
      this.$expected = CommonSymbols.NIL;
    }

    @Override
    public SubLStructDecl getStructDecl()
    {
      return $ts_query_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $ts_query_native.class, $sym1$TS_QUERY, $sym2$TS_QUERY_P, $list3, $list4, new String[] { "$id", "$label", "$formula", "$mt", "$number", "$time", "$backchain", "$depth",
        "$expected"
      }, $list5, $list6, $sym7$DEFAULT_STRUCT_PRINT_FUNCTION );
    }
  }

  public static final class $ts_query_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $rkf_test_suite_native
      extends
        SubLStructNative
  {
    ...
    public $rkf_test_suite_native()
    {
      ...
      this.$siblings = CommonSymbols.NIL;
    }

    @Override
    public SubLStructDecl getStructDecl()
    {
      return $rkf_test_suite_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $rkf_test_suite_native.class, $sym63$RKF_TEST_SUITE, $sym0$RKF_TEST_SUITE_P, $list64, $list65, new String[] { "$isg", "$label", "$filename", "$queries", "$siblings"
      }, $list66, $list67, $sym7$DEFAULT_STRUCT_PRINT_FUNCTION );
    }
  }

  public static final class $rkf_test_suite_p$UnaryFunction
      extends
        UnaryFunction
  {
