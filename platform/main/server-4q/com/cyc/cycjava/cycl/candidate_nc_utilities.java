...
import static com.cyc.cycjava.cycl.candidate_nc_utilities.*;
...
public final class candidate_nc_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject candidate_nc_popcorn_timer_p(final SubLObject v_object) {
        return v_object.getClass() == candidate_nc_utilities.$candidate_nc_popcorn_timer_native.class ? T : NIL;
    }

    public static SubLObject cnc_popcorn_timer_window(final SubLObject v_object) {
        assert NIL != candidate_nc_popcorn_timer_p(v_object) : "candidate_nc_utilities.candidate_nc_popcorn_timer_p(v_object) " + "CommonSymbols.NIL != candidate_nc_utilities.candidate_nc_popcorn_timer_p(v_object) " + v_object;
    ...
    public static SubLObject make_candidate_nc_popcorn_timer(SubLObject arglist) {
        ...
        final SubLObject v_new = new candidate_nc_utilities.$candidate_nc_popcorn_timer_native();
        SubLObject next;
    ...
    public static SubLObject candidate_nc_iterator_state_p(final SubLObject v_object) {
        return v_object.getClass() == candidate_nc_utilities.$candidate_nc_iterator_state_native.class ? T : NIL;
    }

    public static SubLObject cnc_state_rule_fort(final SubLObject v_object) {
        assert NIL != candidate_nc_iterator_state_p(v_object) : "candidate_nc_utilities.candidate_nc_iterator_state_p(v_object) " + "CommonSymbols.NIL != candidate_nc_utilities.candidate_nc_iterator_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_candidate_nc_iterator_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new candidate_nc_utilities.$candidate_nc_iterator_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject candidate_nc_sub_iterator_state_p(final SubLObject v_object) {
        return v_object.getClass() == candidate_nc_utilities.$candidate_nc_sub_iterator_state_native.class ? T : NIL;
    }

    public static SubLObject cnc_substate_wu_constraints(final SubLObject v_object) {
        assert NIL != candidate_nc_sub_iterator_state_p(v_object) : "candidate_nc_utilities.candidate_nc_sub_iterator_state_p(v_object) " + "CommonSymbols.NIL != candidate_nc_utilities.candidate_nc_sub_iterator_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_candidate_nc_sub_iterator_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new candidate_nc_utilities.$candidate_nc_sub_iterator_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $candidate_nc_popcorn_timer_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(candidate_nc_utilities.$candidate_nc_popcorn_timer_native.class, CANDIDATE_NC_POPCORN_TIMER, CANDIDATE_NC_POPCORN_TIMER_P, $list59, $list60, new String[]{ "$window", "$minimum", "$index", "$recent_failure_count", "$history" }, $list61, $list62, PRINT_CNC_POPCORN_TIMER);
        }
    }
    ...
    public static final class $candidate_nc_iterator_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(candidate_nc_utilities.$candidate_nc_iterator_state_native.class, CANDIDATE_NC_ITERATOR_STATE, CANDIDATE_NC_ITERATOR_STATE_P, $list90, $list91, new String[]{ "$rule_fort", "$mod_iterator", "$head_iterator", "$mt", "$doneP" }, $list92, $list93, PRINT_CNC_STATE);
        }
    }
