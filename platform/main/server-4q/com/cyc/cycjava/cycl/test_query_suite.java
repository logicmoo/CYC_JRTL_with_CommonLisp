...
import static com.cyc.cycjava.cycl.test_query_suite.*; 
 public final class test_query_suite extends SubLTranslatedFile {
    ...
    public static SubLObject test_ste_cycl_id(final SubLObject v_object) {
        assert NIL != test_query_suite_p(v_object) : "test_query_suite.test_query_suite_p error :" + v_object;
    ...
    public static final class $test_query_suite_native extends SubLStructNative {
        ...
        private $test_query_suite_native() {
        ...
        static {
            structDecl = makeStructDeclNative($test_query_suite_native.class, TEST_QUERY_SUITE, TEST_QUERY_SUITE_P, $list2, $list3, new String[]{ "$cycl_id", "$comment", "$mt", "$queries" }, $list4, $list5, TEST_QUERY_SUITE_PRINT);
        }
    }
