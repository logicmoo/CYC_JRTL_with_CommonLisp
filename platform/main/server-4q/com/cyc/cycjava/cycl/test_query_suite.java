...
import com.cyc.cycjava.cycl.test_query_suite;
...
import static com.cyc.cycjava.cycl.test_query_suite.*;
...
public final class test_query_suite extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol TEST_QUERY_SUITE = makeSymbol("TEST-QUERY-SUITE");

    public static final SubLSymbol TEST_QUERY_SUITE_P = makeSymbol("TEST-QUERY-SUITE-P");
    ...
    public static final SubLSymbol TEST_QUERY_SUITE_PRINT = makeSymbol("TEST-QUERY-SUITE-PRINT");

    public static final SubLSymbol TEST_QUERY_SUITE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("TEST-QUERY-SUITE-PRINT-FUNCTION-TRAMPOLINE");
    ...
    public static SubLObject test_query_suite_p(final SubLObject v_object) {
        return v_object.getClass() == test_query_suite.$test_query_suite_native.class ? T : NIL;
    }

    public static SubLObject test_ste_cycl_id(final SubLObject v_object) {
        assert NIL != test_query_suite_p(v_object) : "test_query_suite.test_query_suite_p(v_object) " + "CommonSymbols.NIL != test_query_suite.test_query_suite_p(v_object) " + v_object;
    ...
    public static SubLObject make_test_query_suite(SubLObject arglist) {
        ...
        final SubLObject v_new = new test_query_suite.$test_query_suite_native();
        SubLObject next;
    ...
    public static SubLObject test_query_suite_cycl_id(final SubLObject test_suite) {
        assert NIL != test_query_suite_p(test_suite) : "test_query_suite.test_query_suite_p(test_suite) " + "CommonSymbols.NIL != test_query_suite.test_query_suite_p(test_suite) " + test_suite;
    ...
    public static SubLObject test_query_suite_get(final SubLObject constant_id, SubLObject mt) {
        ...
        assert NIL != cycl_grammar.cycl_denotational_term_p(constant_id) : "cycl_grammar.cycl_denotational_term_p(constant_id) " + "CommonSymbols.NIL != cycl_grammar.cycl_denotational_term_p(constant_id) " + constant_id;
    ...
    public static SubLObject declare_test_query_suite_file() {
        declareFunction(me, "test_query_suite_print_function_trampoline", "TEST-QUERY-SUITE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "test_query_suite_p", "TEST-QUERY-SUITE-P", 1, 0, false);
        new test_query_suite.$test_query_suite_p$UnaryFunction();
        declareFunction(me, "test_ste_cycl_id", "TEST-STE-CYCL-ID", 1, 0, false);
        declareFunction(me, "test_ste_comment", "TEST-STE-COMMENT", 1, 0, false);
        declareFunction(me, "test_ste_mt", "TEST-STE-MT", 1, 0, false);
        declareFunction(me, "test_ste_queries", "TEST-STE-QUERIES", 1, 0, false);
        declareFunction(me, "_csetf_test_ste_cycl_id", "_CSETF-TEST-STE-CYCL-ID", 2, 0, false);
        declareFunction(me, "_csetf_test_ste_comment", "_CSETF-TEST-STE-COMMENT", 2, 0, false);
        declareFunction(me, "_csetf_test_ste_mt", "_CSETF-TEST-STE-MT", 2, 0, false);
        declareFunction(me, "_csetf_test_ste_queries", "_CSETF-TEST-STE-QUERIES", 2, 0, false);
        declareFunction(me, "make_test_query_suite", "MAKE-TEST-QUERY-SUITE", 0, 1, false);
        declareFunction(me, "visit_defstruct_test_query_suite", "VISIT-DEFSTRUCT-TEST-QUERY-SUITE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_test_query_suite_method", "VISIT-DEFSTRUCT-OBJECT-TEST-QUERY-SUITE-METHOD", 2, 0, false);
        declareFunction(me, "test_query_suite_cycl_id", "TEST-QUERY-SUITE-CYCL-ID", 1, 0, false);
        declareFunction(me, "test_query_suite_comment", "TEST-QUERY-SUITE-COMMENT", 1, 0, false);
        declareFunction(me, "test_query_suite_mt", "TEST-QUERY-SUITE-MT", 1, 0, false);
        declareFunction(me, "test_query_suite_queries", "TEST-QUERY-SUITE-QUERIES", 1, 0, false);
        declareFunction(me, "test_query_suite_print", "TEST-QUERY-SUITE-PRINT", 3, 1, false);
        declareFunction(me, "test_query_suite_get", "TEST-QUERY-SUITE-GET", 1, 1, false);
        declareFunction(me, "test_query_suite_find_query_by_id", "TEST-QUERY-SUITE-FIND-QUERY-BY-ID", 2, 0, false);
        declareFunction(me, "test_query_suite_set_queries", "TEST-QUERY-SUITE-SET-QUERIES", 2, 0, false);
        declareFunction(me, "test_query_suite_find_query_siblings", "TEST-QUERY-SUITE-FIND-QUERY-SIBLINGS", 2, 0, false);
        declareFunction(me, "test_query_suite_new", "TEST-QUERY-SUITE-NEW", 2, 0, false);
        declareFunction(me, "cycl_query_specification_comment_comparator", "CYCL-QUERY-SPECIFICATION-COMMENT-COMPARATOR", 2, 0, false);
        declareFunction(me, "test_query_suite_sort_by_comment", "TEST-QUERY-SUITE-SORT-BY-COMMENT", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $test_query_suite_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(test_query_suite.$test_query_suite_native.class, TEST_QUERY_SUITE, TEST_QUERY_SUITE_P, $list2, $list3, new String[]{ "$cycl_id", "$comment", "$mt", "$queries" }, $list4, $list5, TEST_QUERY_SUITE_PRINT);
        }
    }
