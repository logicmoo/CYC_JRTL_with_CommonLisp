...
import com.cyc.cycjava.cycl.user_actions;
...
import static com.cyc.cycjava.cycl.user_actions.*;
...
public final class user_actions extends SubLTranslatedFile {
    ...
    public static final SubLSymbol ACTION_TYPE_P = makeSymbol("ACTION-TYPE-P");
    ...
    public static final SubLSymbol PRINT_ACTION_TYPE = makeSymbol("PRINT-ACTION-TYPE");

    public static final SubLSymbol ACTION_TYPE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("ACTION-TYPE-PRINT-FUNCTION-TRAMPOLINE");
    ...
    public static final SubLList $list38 = list(makeSymbol("ID-STRING"), makeSymbol("TYPE-KEY"), makeSymbol("CYCLIST"), makeSymbol("CREATION-TIME"), makeSymbol("DATA"));

    public static final SubLList $list39 = list(makeKeyword("ID-STRING"), makeKeyword("TYPE-KEY"), makeKeyword("CYCLIST"), makeKeyword("CREATION-TIME"), makeKeyword("DATA"));
    ...
    public static SubLObject action_type_p(final SubLObject v_object) {
        return v_object.getClass() == user_actions.$action_type_native.class ? T : NIL;
    }

    public static SubLObject action_type_key(final SubLObject v_object) {
        assert NIL != action_type_p(v_object) : "user_actions.action_type_p(v_object) " + "CommonSymbols.NIL != user_actions.action_type_p(v_object) " + v_object;
    ...
    public static SubLObject make_action_type(SubLObject arglist) {
        ...
        final SubLObject v_new = new user_actions.$action_type_native();
        SubLObject next;
    ...
    public static SubLObject user_action_p(final SubLObject v_object) {
        return v_object.getClass() == user_actions.$user_action_native.class ? T : NIL;
    }

    public static SubLObject user_action_id_string(final SubLObject v_object) {
        assert NIL != user_action_p(v_object) : "user_actions.user_action_p(v_object) " + "CommonSymbols.NIL != user_actions.user_action_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_user_action(SubLObject arglist) {
        ...
        final SubLObject v_new = new user_actions.$user_action_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject declare_user_actions_file() {
        declareFunction(me, "action_type_print_function_trampoline", "ACTION-TYPE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "action_type_p", "ACTION-TYPE-P", 1, 0, false);
        new user_actions.$action_type_p$UnaryFunction();
        declareFunction(me, "action_type_key", "ACTION-TYPE-KEY", 1, 0, false);
        declareFunction(me, "action_type_summary_fn", "ACTION-TYPE-SUMMARY-FN", 1, 0, false);
        declareFunction(me, "action_type_display_fn", "ACTION-TYPE-DISPLAY-FN", 1, 0, false);
        declareFunction(me, "action_type_handler_fn", "ACTION-TYPE-HANDLER-FN", 1, 0, false);
        declareFunction(me, "_csetf_action_type_key", "_CSETF-ACTION-TYPE-KEY", 2, 0, false);
        declareFunction(me, "_csetf_action_type_summary_fn", "_CSETF-ACTION-TYPE-SUMMARY-FN", 2, 0, false);
        declareFunction(me, "_csetf_action_type_display_fn", "_CSETF-ACTION-TYPE-DISPLAY-FN", 2, 0, false);
        declareFunction(me, "_csetf_action_type_handler_fn", "_CSETF-ACTION-TYPE-HANDLER-FN", 2, 0, false);
        declareFunction(me, "make_action_type", "MAKE-ACTION-TYPE", 0, 1, false);
        declareFunction(me, "visit_defstruct_action_type", "VISIT-DEFSTRUCT-ACTION-TYPE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_action_type_method", "VISIT-DEFSTRUCT-OBJECT-ACTION-TYPE-METHOD", 2, 0, false);
        declareFunction(me, "print_action_type", "PRINT-ACTION-TYPE", 3, 0, false);
        declareMacro(me, "defaction_type", "DEFACTION-TYPE");
        declareFunction(me, "action_type_by_key", "ACTION-TYPE-BY-KEY", 1, 0, false);
        declareFunction(me, "user_action_print_function_trampoline", "USER-ACTION-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "user_action_p", "USER-ACTION-P", 1, 0, false);
        new user_actions.$user_action_p$UnaryFunction();
        declareFunction(me, "user_action_id_string", "USER-ACTION-ID-STRING", 1, 0, false);
        declareFunction(me, "user_action_type_key", "USER-ACTION-TYPE-KEY", 1, 0, false);
        declareFunction(me, "user_action_cyclist", "USER-ACTION-CYCLIST", 1, 0, false);
        declareFunction(me, "user_action_creation_time", "USER-ACTION-CREATION-TIME", 1, 0, false);
        declareFunction(me, "user_action_data", "USER-ACTION-DATA", 1, 0, false);
        declareFunction(me, "_csetf_user_action_id_string", "_CSETF-USER-ACTION-ID-STRING", 2, 0, false);
        declareFunction(me, "_csetf_user_action_type_key", "_CSETF-USER-ACTION-TYPE-KEY", 2, 0, false);
        declareFunction(me, "_csetf_user_action_cyclist", "_CSETF-USER-ACTION-CYCLIST", 2, 0, false);
        declareFunction(me, "_csetf_user_action_creation_time", "_CSETF-USER-ACTION-CREATION-TIME", 2, 0, false);
        declareFunction(me, "_csetf_user_action_data", "_CSETF-USER-ACTION-DATA", 2, 0, false);
        declareFunction(me, "make_user_action", "MAKE-USER-ACTION", 0, 1, false);
        declareFunction(me, "visit_defstruct_user_action", "VISIT-DEFSTRUCT-USER-ACTION", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_user_action_method", "VISIT-DEFSTRUCT-OBJECT-USER-ACTION-METHOD", 2, 0, false);
        declareFunction(me, "print_user_action", "PRINT-USER-ACTION", 3, 0, false);
        declareFunction(me, "user_actions_emptyP", "USER-ACTIONS-EMPTY?", 0, 0, false);
        declareFunction(me, "user_actions_size", "USER-ACTIONS-SIZE", 0, 0, false);
        declareFunction(me, "new_user_action", "NEW-USER-ACTION", 1, 0, false);
        declareFunction(me, "delete_user_action", "DELETE-USER-ACTION", 1, 0, false);
        declareFunction(me, "user_action_by_id_string", "USER-ACTION-BY-ID-STRING", 1, 0, false);
        declareFunction(me, "user_action_type", "USER-ACTION-TYPE", 1, 0, false);
        declareFunction(me, "user_action_summary_fn", "USER-ACTION-SUMMARY-FN", 1, 0, false);
        declareFunction(me, "user_action_display_fn", "USER-ACTION-DISPLAY-FN", 1, 0, false);
        declareFunction(me, "user_action_handler_fn", "USER-ACTION-HANDLER-FN", 1, 0, false);
        declareFunction(me, "all_actions_for_cyclist", "ALL-ACTIONS-FOR-CYCLIST", 1, 0, false);
        declareFunction(me, "all_actions_for_cyclist_of_type", "ALL-ACTIONS-FOR-CYCLIST-OF-TYPE", 2, 0, false);
        return NIL;
    }
    ...
    public static final class $action_type_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(user_actions.$action_type_native.class, ACTION_TYPE, ACTION_TYPE_P, $list2, $list3, new String[]{ "$key", "$summary_fn", "$display_fn", "$handler_fn" }, $list4, $list5, PRINT_ACTION_TYPE);
        }
    }
    ...
    public static final class $user_action_native extends SubLStructNative {
        ...
        public $user_action_native() {
            this.$id_string = Lisp.NIL;
            this.$type_key = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative(user_actions.$user_action_native.class, USER_ACTION, USER_ACTION_P, $list38, $list39, new String[]{ "$id_string", "$type_key", "$cyclist", "$creation_time", "$data" }, $list40, $list41, PRINT_USER_ACTION);
        }
    }
