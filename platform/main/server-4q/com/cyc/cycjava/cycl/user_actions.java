...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class user_actions extends SubLTranslatedFile {
    ...
    public static SubLObject action_type_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$action_type_native.class ? T : NIL;
    }

    public static SubLObject action_type_key(final SubLObject v_object) {
        assert NIL != action_type_p(v_object) : "user_actions.action_type_p error :" + v_object;
    ...
    public static SubLObject user_action_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$user_action_native.class ? T : NIL;
    }

    public static SubLObject user_action_id_string(final SubLObject v_object) {
        assert NIL != user_action_p(v_object) : "user_actions.user_action_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $action_type_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($action_type_native.class, ACTION_TYPE, ACTION_TYPE_P, $list2, $list3, new String[]{ "$key", "$summary_fn", "$display_fn", "$handler_fn" }, $list4, $list5, PRINT_ACTION_TYPE);
        }
    }
    ...
    public static final class $user_action_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($user_action_native.class, USER_ACTION, USER_ACTION_P, $list38, $list39, new String[]{ "$id_string", "$type_key", "$cyclist", "$creation_time", "$data" }, $list40, $list41, PRINT_USER_ACTION);
        }
    }
