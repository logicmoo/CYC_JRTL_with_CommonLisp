...
import static com.cyc.cycjava.cycl.html_script_utilities.*;
...
public final class html_script_utilities extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLList $list0 = list(makeKeyword("JAVASCRIPT"));
    ...
    private static final SubLList $list74 = list(new SubLObject[]{ makeKeyword("HREF"), makeKeyword("NAME"), makeKeyword("TARGET"), makeKeyword("SCRIPT"), makeKeyword("STYLE"), makeKeyword("HOVEROVER-HTML"), makeKeyword("CAPTION"), makeKeyword("WIDTH"), makeKeyword("STICKY") });
    ...
    public static final SubLList $list89 = list(makeKeyword("ONMOUSEOUT"), makeString("nd();"));
	...
	public static final SubLSymbol $gke_applet_name$ = null;
    ...
    public static SubLObject html_simple_script_button(final SubLObject value, final SubLObject script, SubLObject arg_1, SubLObject arg_2) {
        ...
        assert NIL != stringp(script) : "Types.stringp(script) " + "CommonSymbols.NIL != Types.stringp(script) " + script;
    ...
    public static SubLObject html_insert_input_button(final SubLObject input_name, final SubLObject input_value, SubLObject button) {
        ...
        assert NIL != stringp(input_name) : "Types.stringp(input_name) " + "CommonSymbols.NIL != Types.stringp(input_name) " + input_name;
        assert NIL != stringp(input_value) : "Types.stringp(input_value) " + "CommonSymbols.NIL != Types.stringp(input_value) " + input_value;
    ...
    public static SubLObject html_clear_radio_input(final SubLObject name, final SubLObject clear_name, SubLObject value, SubLObject checkedP, SubLObject id) {
        ...
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != stringp(name) : "Types.stringp(name) " + "CommonSymbols.NIL != Types.stringp(name) " + name;
        assert NIL != stringp(clear_name) : "Types.stringp(clear_name) " + "CommonSymbols.NIL != Types.stringp(clear_name) " + clear_name;
        html_markup(html_macros.$html_input_head$.getGlobalValue());
        html_markup(html_macros.$html_input_type$.getGlobalValue());
        html_char(CHAR_quotation, UNPROVIDED);
    ...
    public static SubLObject html_focus_radio_input(final SubLObject name, final SubLObject focus_name, SubLObject value, SubLObject checkedP, SubLObject id) {
        ...
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != stringp(name) : "Types.stringp(name) " + "CommonSymbols.NIL != Types.stringp(name) " + name;
        assert NIL != stringp(focus_name) : "Types.stringp(focus_name) " + "CommonSymbols.NIL != Types.stringp(focus_name) " + focus_name;
        html_markup(html_macros.$html_input_head$.getGlobalValue());
        html_markup(html_macros.$html_input_type$.getGlobalValue());
        html_char(CHAR_quotation, UNPROVIDED);
        html_markup(html_macros.$html_input_radio$.getGlobalValue());
    ...
    public static SubLObject html_back_onload_script(SubLObject delay) {
        ...
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != integerp(delay) : "Types.integerp(delay) " + "CommonSymbols.NIL != Types.integerp(delay) " + delay;
    ...
    public static SubLObject declare_html_script_utilities_file() {
        declareFunction(me, "html_simple_script_button", "HTML-SIMPLE-SCRIPT-BUTTON", 2, 2, false);
        declareMacro(me, "html_fancy_script_button", "HTML-FANCY-SCRIPT-BUTTON");
        declareFunction(me, "html_simple_script_anchor", "HTML-SIMPLE-SCRIPT-ANCHOR", 2, 2, false);
        declareFunction(me, "cb_back", "CB-BACK", 0, 1, false);
        declareFunction(me, "html_dismiss_button", "HTML-DISMISS-BUTTON", 0, 1, false);
        declareFunction(me, "html_dismiss_link", "HTML-DISMISS-LINK", 0, 1, false);
        declareFunction(me, "html_back_button", "HTML-BACK-BUTTON", 0, 1, false);
        declareFunction(me, "html_refresh_button", "HTML-REFRESH-BUTTON", 0, 1, false);
        declareFunction(me, "html_refresh_link", "HTML-REFRESH-LINK", 0, 1, false);
        declareFunction(me, "html_refresh_frame_script", "HTML-REFRESH-FRAME-SCRIPT", 1, 0, false);
        declareFunction(me, "html_clear_input_button", "HTML-CLEAR-INPUT-BUTTON", 1, 2, false);
        declareFunction(me, "html_insert_input_button", "HTML-INSERT-INPUT-BUTTON", 2, 1, false);
        declareFunction(me, "html_completing_input_button", "HTML-COMPLETING-INPUT-BUTTON", 2, 1, false);
        declareFunction(me, "html_clear_radio_input", "HTML-CLEAR-RADIO-INPUT", 2, 3, false);
        declareFunction(me, "html_focus_radio_input", "HTML-FOCUS-RADIO-INPUT", 2, 3, false);
        declareFunction(me, "html_auto_select_radio_button_script", "HTML-AUTO-SELECT-RADIO-BUTTON-SCRIPT", 2, 0, false);
        declareFunction(me, "html_back_onload_script", "HTML-BACK-ONLOAD-SCRIPT", 0, 1, false);
        declareFunction(me, "html_multi_submit_input", "HTML-MULTI-SUBMIT-INPUT", 1, 6, false);
        declareFunction(me, "html_text_input_reset_multi_submit", "HTML-TEXT-INPUT-RESET-MULTI-SUBMIT", 1, 6, false);
        declareFunction(me, "html_set_multi_submit_form_info", "HTML-SET-MULTI-SUBMIT-FORM-INFO", 4, 0, false);
        declareFunction(me, "javascript_comment", "JAVASCRIPT-COMMENT", 0, 2, false);
        declareFunction(me, "javascript_comment_line", "JAVASCRIPT-COMMENT-LINE", 0, 2, false);
        declareFunction(me, "simple_javascript", "SIMPLE-JAVASCRIPT", 0, 2, false);
        declareFunction(me, "javascript_function", "JAVASCRIPT-FUNCTION", 2, 5, false);
        declareFunction(me, "cb_hoverover_page_init", "CB-HOVEROVER-PAGE-INIT", 0, 0, false);
        declareFunction(me, "cb_hoverover_clean_html", "CB-HOVEROVER-CLEAN-HTML", 1, 0, false);
        declareFunction(me, "cb_hoverover_recursion_disallowedP", "CB-HOVEROVER-RECURSION-DISALLOWED?", 0, 0, false);
        declareMacro(me, "with_cb_hoverover_recursion_protection", "WITH-CB-HOVEROVER-RECURSION-PROTECTION");
        declareMacro(me, "html_hoverover_anchor", "HTML-HOVEROVER-ANCHOR");
        declareFunction(me, "html_hoverover_anchor_onmouseover", "HTML-HOVEROVER-ANCHOR-ONMOUSEOVER", 4, 0, false);
        declareFunction(me, "instantiate_javascript_template", "INSTANTIATE-JAVASCRIPT-TEMPLATE", 2, 0, false);
        declareFunction(me, "edit_javascript_template", "EDIT-JAVASCRIPT-TEMPLATE", 3, 0, false);
        declareFunction(me, "javascript_note_event_remapping", "JAVASCRIPT-NOTE-EVENT-REMAPPING", 3, 0, false);
        declareFunction(me, "generate_javascript_event_remapping_assignments", "GENERATE-JAVASCRIPT-EVENT-REMAPPING-ASSIGNMENTS", 1, 0, false);
        declareMacro(me, "with_javascript_event_remapping", "WITH-JAVASCRIPT-EVENT-REMAPPING");
        declareFunction(me, "html_set_all_radio_buttons_script", "HTML-SET-ALL-RADIO-BUTTONS-SCRIPT", 0, 0, false);
        declareFunction(me, "html_anchor_set_radio_buttons_to_value", "HTML-ANCHOR-SET-RADIO-BUTTONS-TO-VALUE", 4, 0, false);
        declareFunction(me, "html_js_focus_window", "HTML-JS-FOCUS-WINDOW", 0, 0, false);
        declareFunction(me, "html_kill_window_button", "HTML-KILL-WINDOW-BUTTON", 0, 2, false);
        declareFunction(me, "html_popup_script", "HTML-POPUP-SCRIPT", 0, 0, false);
        declareFunction(me, "html_popup_onclick", "HTML-POPUP-ONCLICK", 0, 6, false);
        declareFunction(me, "html_popup_button_onclick", "HTML-POPUP-BUTTON-ONCLICK", 1, 6, false);
        declareFunction(me, "html_sentence_editor_enable_editors", "HTML-SENTENCE-EDITOR-ENABLE-EDITORS", 0, 0, false);
        declareFunction(me, "html_ke_text_editor_enable_editors", "HTML-KE-TEXT-EDITOR-ENABLE-EDITORS", 0, 0, false);
        return NIL;
    }
	 ...
	 * @param form_input_name
	 * @param globalValue
	 * @return
	 */
	public static SubLObject html_simple_applet_input_initialization(SubLObject form_input_name, SubLObject globalValue) {
