...
import com.cyc.cycjava.cycl.kb_compare;
...
import static com.cyc.cycjava.cycl.kb_compare.*;
...
public final class kb_compare extends SubLTranslatedFile {
    ...
    public static SubLObject kb_intersection_p(final SubLObject v_object) {
        return v_object.getClass() == kb_compare.$kb_intersection_native.class ? T : NIL;
    }

    public static SubLObject kb_intrsct_remote_image(final SubLObject v_object) {
        assert NIL != kb_intersection_p(v_object) : "kb_compare.kb_intersection_p(v_object) " + "CommonSymbols.NIL != kb_compare.kb_intersection_p(v_object) " + v_object;
    ...
    public static SubLObject make_kb_intersection(SubLObject arglist) {
        ...
        final SubLObject v_new = new kb_compare.$kb_intersection_native();
        SubLObject next;
    ...
    public static SubLObject kb_difference_p(final SubLObject v_object) {
        return v_object.getClass() == kb_compare.$kb_difference_native.class ? T : NIL;
    }

    public static SubLObject kb_diff_common_intersection(final SubLObject v_object) {
        assert NIL != kb_difference_p(v_object) : "kb_compare.kb_difference_p(v_object) " + "CommonSymbols.NIL != kb_compare.kb_difference_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_kb_difference(SubLObject arglist) {
        ...
        final SubLObject v_new = new kb_compare.$kb_difference_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $kb_intersection_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(kb_compare.$kb_intersection_native.class, KB_INTERSECTION, KB_INTERSECTION_P, $list20, $list21, new String[]{ "$remote_image", "$constant_index", "$nart_index", "$assertion_index", "$deduction_index" }, $list22, $list23, PRINT_KB_INTERSECTION);
        }
    }
    ...
    public static final class $kb_difference_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(kb_compare.$kb_difference_native.class, KB_DIFFERENCE, KB_DIFFERENCE_P, $list90, $list91, new String[]{ "$common_intersection", "$renamed_constants", "$constants", "$narts", "$assertions", "$deductions" }, $list92, $list93, PRINT_KB_DIFFERENCE);
        }
    }
