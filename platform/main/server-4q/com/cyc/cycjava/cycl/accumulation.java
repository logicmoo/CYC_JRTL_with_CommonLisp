...
public final class accumulation extends SubLTranslatedFile implements V12 {
	...
	public static final class $accumulator_native extends SubLStructNative {
		...
		private static final SubLStructDeclNative structDecl = makeStructDeclNative($accumulator_native.class, ACCUMULATOR, ACCUMULATOR_P, $list_alt2, $list_alt3, new String[] { "$state", "$reset_fn", "$add_fn", "$add_all_fn", "$size_fn", "$contents_fn", "$iterator_fn" }, $list_alt4, $list_alt5, PRINT_ACCUMULATOR);
	}
	...
	private static final SubLList $list117 = list(list(list(list(new SubLObject[] { list(ONE_INTEGER, makeString("Eins")), list(TWO_INTEGER, makeString("Zwei")), list(THREE_INTEGER, makeString("Drei")), list(FOUR_INTEGER, makeString("Vier")), list(FIVE_INTEGER, makeString("F&uuml;nf")), list(SIX_INTEGER, makeString("Sechs")), list(SEVEN_INTEGER, makeString("Sieben")), list(EIGHT_INTEGER, makeString("Acht")),
			list(NINE_INTEGER, makeString("Neun")), list(TEN_INTEGER, makeString("Zehn")) }), EQUAL), T));

	private static final SubLSymbol TEST_NULL_ACCUMULATOR = makeSymbol("TEST-NULL-ACCUMULATOR");

	static private final SubLList $list119 = list(list(list(list(new SubLObject[] { ONE_INTEGER, TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER, FIVE_INTEGER, SIX_INTEGER, SEVEN_INTEGER, EIGHT_INTEGER, NINE_INTEGER, TEN_INTEGER })), T), list(list(list(makeString("a"), CHAR_b, THREE_INTEGER, list(makeSymbol("FUNCTION"), makeSymbol("FOURTH")))), T));
	...
	*/
	...
	static private final SubLList $list_alt111 = list(list(list(list(new SubLObject[] { list(ONE_INTEGER, makeString("Eins")), list(TWO_INTEGER, makeString("Zwei")), list(THREE_INTEGER, makeString("Drei")), list(FOUR_INTEGER, makeString("Vier")), list(FIVE_INTEGER, makeString("F&uuml;nf")), list(SIX_INTEGER, makeString("Sechs")), list(SEVEN_INTEGER, makeString("Sieben")), list(EIGHT_INTEGER, makeString("Acht")),
			list(NINE_INTEGER, makeString("Neun")), list(TEN_INTEGER, makeString("Zehn")) }), EQUAL), T));

	static private final SubLString $$$pace = makeString("pace");

	static private final SubLList $list_alt114 = list(list(list(list(new SubLObject[] { ONE_INTEGER, TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER, FIVE_INTEGER, SIX_INTEGER, SEVEN_INTEGER, EIGHT_INTEGER, NINE_INTEGER, TEN_INTEGER })), T), list(list(list(makeString("a"), CHAR_b, THREE_INTEGER, list(makeSymbol("FUNCTION"), makeSymbol("FOURTH")))), T));

	static private final SubLList $list_alt116 = list(list(list(list(new SubLObject[] { ONE_INTEGER, TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER, FIVE_INTEGER, SIX_INTEGER, SEVEN_INTEGER, EIGHT_INTEGER, NINE_INTEGER, TEN_INTEGER })), T), list(list(list(ONE_INTEGER, ONE_INTEGER, ONE_INTEGER, makeInteger(-3))), T));
