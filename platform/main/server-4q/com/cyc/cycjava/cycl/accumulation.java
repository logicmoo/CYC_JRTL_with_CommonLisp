...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class accumulation extends SubLTranslatedFile {
    ...
    public static SubLObject accumulator_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$accumulator_native.class ? T : NIL;
    }

    public static SubLObject acc_state(final SubLObject v_object) {
        assert NIL != accumulator_p(v_object) : "accumulation.accumulator_p error :" + v_object;
    ...
    public static final class $accumulator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($accumulator_native.class, ACCUMULATOR, ACCUMULATOR_P, $list2, $list3, new String[]{ "$state", "$reset_fn", "$add_fn", "$add_all_fn", "$size_fn", "$contents_fn", "$iterator_fn" }, $list4, $list5, PRINT_ACCUMULATOR);
        }
    }
