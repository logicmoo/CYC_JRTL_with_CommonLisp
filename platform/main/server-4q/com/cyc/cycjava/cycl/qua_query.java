...
import com.cyc.cycjava.cycl.qua_query;
...
import static com.cyc.cycjava.cycl.qua_query.*;
...
public final class qua_query extends SubLTranslatedFile {
    ...
    public static SubLObject augmented_query_p(final SubLObject v_object) {
        return v_object.getClass() == qua_query.$augmented_query_native.class ? T : NIL;
    }

    public static SubLObject aq_original_phrase(final SubLObject v_object) {
        assert NIL != augmented_query_p(v_object) : "qua_query.augmented_query_p(v_object) " + "CommonSymbols.NIL != qua_query.augmented_query_p(v_object) " + v_object;
    ...
    public static SubLObject make_augmented_query(SubLObject arglist) {
        ...
        final SubLObject v_new = new qua_query.$augmented_query_native();
        SubLObject next;
    ...
    public static SubLObject aq_term_p(final SubLObject v_object) {
        return v_object.getClass() == qua_query.$aq_term_native.class ? T : NIL;
    }

    public static SubLObject aq_term_id(final SubLObject v_object) {
        assert NIL != aq_term_p(v_object) : "qua_query.aq_term_p(v_object) " + "CommonSymbols.NIL != qua_query.aq_term_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_aq_term(SubLObject arglist) {
        ...
        final SubLObject v_new = new qua_query.$aq_term_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $augmented_query_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(qua_query.$augmented_query_native.class, AUGMENTED_QUERY, AUGMENTED_QUERY_P, $list14, $list15, new String[]{ "$original_phrase", "$id", "$tokenizations", "$query_string", "$query_string_staleP", "$search_engine" }, $list16, $list17, PRINT_AUGMENTED_QUERY);
        }
    }
