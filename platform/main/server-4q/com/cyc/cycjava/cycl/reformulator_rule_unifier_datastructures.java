...
import com.cyc.cycjava.cycl.reformulator_rule_unifier_datastructures;
...
import static com.cyc.cycjava.cycl.reformulator_rule_unifier_datastructures.*;
...
public final class reformulator_rule_unifier_datastructures extends SubLTranslatedFile {
    ...
    public static SubLObject reformulator_template_p(final SubLObject v_object) {
        return v_object.getClass() == reformulator_rule_unifier_datastructures.$reformulator_template_native.class ? T : NIL;
    }

    public static SubLObject rt_expression(final SubLObject v_object) {
        assert NIL != reformulator_template_p(v_object) : "reformulator_rule_unifier_datastructures.reformulator_template_p(v_object) " + "CommonSymbols.NIL != reformulator_rule_unifier_datastructures.reformulator_template_p(v_object) " + v_object;
    ...
    public static SubLObject make_reformulator_template(SubLObject arglist) {
        ...
        final SubLObject v_new = new reformulator_rule_unifier_datastructures.$reformulator_template_native();
        SubLObject next;
    ...
    public static SubLObject reformulator_rule_p(final SubLObject v_object) {
        return v_object.getClass() == reformulator_rule_unifier_datastructures.$reformulator_rule_native.class ? T : NIL;
    }

    public static SubLObject refr_first_rt(final SubLObject v_object) {
        assert NIL != reformulator_rule_p(v_object) : "reformulator_rule_unifier_datastructures.reformulator_rule_p(v_object) " + "CommonSymbols.NIL != reformulator_rule_unifier_datastructures.reformulator_rule_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_reformulator_rule(SubLObject arglist) {
        ...
        final SubLObject v_new = new reformulator_rule_unifier_datastructures.$reformulator_rule_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $reformulator_template_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(reformulator_rule_unifier_datastructures.$reformulator_template_native.class, REFORMULATOR_TEMPLATE, REFORMULATOR_TEMPLATE_P, $list2, $list3, new String[]{ "$expression", "$shared_var_bindings", "$mt", "$forts" }, $list4, $list5, PRINT_REFORMULATOR_TEMPLATE);
        }
    }
    ...
    public static final class $reformulator_rule_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(reformulator_rule_unifier_datastructures.$reformulator_rule_native.class, REFORMULATOR_RULE, REFORMULATOR_RULE_P, $list29, $list30, new String[]{ "$first_rt", "$second_rt", "$mt", "$wff_degree", "$directions", "$assertion", "$rule_pred", "$preconditions", "$properties" }, $list31, $list32, PRINT_REFORMULATOR_RULE);
        }
    }
