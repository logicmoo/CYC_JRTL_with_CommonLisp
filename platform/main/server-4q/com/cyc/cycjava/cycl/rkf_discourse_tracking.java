...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class rkf_discourse_tracking extends SubLTranslatedFile {
    ...
    public static SubLObject rkf_discourse_context_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$rkf_discourse_context_native.class ? T : NIL;
    }

    public static SubLObject rkf_dc_explicit_mappings(final SubLObject v_object) {
        assert NIL != rkf_discourse_context_p(v_object) : "rkf_discourse_tracking.rkf_discourse_context_p error :" + v_object;
    ...
    public static SubLObject rkf_discourse_mapping_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$rkf_discourse_mapping_native.class ? T : NIL;
    }

    public static SubLObject rkf_dm_interpretation(final SubLObject v_object) {
        assert NIL != rkf_discourse_mapping_p(v_object) : "rkf_discourse_tracking.rkf_discourse_mapping_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $rkf_discourse_context_native extends SubLStructNative {
        ...
        private $rkf_discourse_context_native() {
        ...
        static {
            structDecl = makeStructDeclNative($rkf_discourse_context_native.class, RKF_DISCOURSE_CONTEXT, RKF_DISCOURSE_CONTEXT_P, $list4, $list5, new String[]{ "$explicit_mappings", "$discourse_mt", "$parent_context", "$phrase_index", "$indexical_index" }, $list6, $list7, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $rkf_discourse_mapping_native extends SubLStructNative {
        ...
        private $rkf_discourse_mapping_native() {
        ...
        static {
            structDecl = makeStructDeclNative($rkf_discourse_mapping_native.class, RKF_DISCOURSE_MAPPING, RKF_DISCOURSE_MAPPING_P, $list34, $list35, new String[]{ "$interpretation", "$indexicals", "$phrases" }, $list36, $list37, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
