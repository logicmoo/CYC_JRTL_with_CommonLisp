...
import com.cyc.cycjava.cycl.rkf_discourse_tracking;
...
import static com.cyc.cycjava.cycl.rkf_discourse_tracking.*;
...
public final class rkf_discourse_tracking extends SubLTranslatedFile {
    ...
    public static final SubLSymbol $sym1$RKF_DISC_DISCOURSE_ENTITY_ = makeSymbol("RKF-DISC-DISCOURSE-ENTITY?");

    public static final SubLSymbol RKF_DISCOURSE_CONTEXT = makeSymbol("RKF-DISCOURSE-CONTEXT");

    public static final SubLSymbol RKF_DISCOURSE_CONTEXT_P = makeSymbol("RKF-DISCOURSE-CONTEXT-P");

    public static final SubLList $list4 = list(makeSymbol("EXPLICIT-MAPPINGS"), makeSymbol("DISCOURSE-MT"), makeSymbol("PARENT-CONTEXT"), makeSymbol("PHRASE-INDEX"), makeSymbol("INDEXICAL-INDEX"));

    public static final SubLList $list5 = list(makeKeyword("EXPLICIT-MAPPINGS"), makeKeyword("DISCOURSE-MT"), makeKeyword("PARENT-CONTEXT"), makeKeyword("PHRASE-INDEX"), makeKeyword("INDEXICAL-INDEX"));

    public static final SubLList $list6 = list(makeSymbol("RKF-DC-EXPLICIT-MAPPINGS"), makeSymbol("RKF-DC-DISCOURSE-MT"), makeSymbol("RKF-DC-PARENT-CONTEXT"), makeSymbol("RKF-DC-PHRASE-INDEX"), makeSymbol("RKF-DC-INDEXICAL-INDEX"));

    public static final SubLList $list7 = list(makeSymbol("_CSETF-RKF-DC-EXPLICIT-MAPPINGS"), makeSymbol("_CSETF-RKF-DC-DISCOURSE-MT"), makeSymbol("_CSETF-RKF-DC-PARENT-CONTEXT"), makeSymbol("_CSETF-RKF-DC-PHRASE-INDEX"), makeSymbol("_CSETF-RKF-DC-INDEXICAL-INDEX"));



    public static final SubLSymbol RKF_DISCOURSE_CONTEXT_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("RKF-DISCOURSE-CONTEXT-PRINT-FUNCTION-TRAMPOLINE");
    ...
    private static final SubLObject $$CourseOfAction = reader_make_constant_shell(makeString("CourseOfAction"));

    private static final SubLSymbol $sym57$_X = makeSymbol("?X");

    private static final SubLObject $$coaDescribingSpecification = reader_make_constant_shell(makeString("coaDescribingSpecification"));

    private static final SubLList $list59 = list(reader_make_constant_shell(makeString("TheSalientInstance")), reader_make_constant_shell(makeString("CourseOfAction")));

    private static final SubLObject $$implies = reader_make_constant_shell(makeString("implies"));

    private static final SubLObject $$TheSalientInstance = reader_make_constant_shell(makeString("TheSalientInstance"));
    ...
    private static final SubLObject $$TheSalientFn = reader_make_constant_shell(makeString("TheSalientFn"));
    ...
    public static SubLObject rkf_discourse_context_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_discourse_tracking.$rkf_discourse_context_native.class ? T : NIL;
    }

    public static SubLObject rkf_dc_explicit_mappings(final SubLObject v_object) {
        assert NIL != rkf_discourse_context_p(v_object) : "rkf_discourse_tracking.rkf_discourse_context_p(v_object) " + "CommonSymbols.NIL != rkf_discourse_tracking.rkf_discourse_context_p(v_object) " + v_object;
    ...
    public static SubLObject make_rkf_discourse_context(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_discourse_tracking.$rkf_discourse_context_native();
        SubLObject next;
    ...
    public static SubLObject rkf_discourse_mapping_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_discourse_tracking.$rkf_discourse_mapping_native.class ? T : NIL;
    }

    public static SubLObject rkf_dm_interpretation(final SubLObject v_object) {
        assert NIL != rkf_discourse_mapping_p(v_object) : "rkf_discourse_tracking.rkf_discourse_mapping_p(v_object) " + "CommonSymbols.NIL != rkf_discourse_tracking.rkf_discourse_mapping_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_rkf_discourse_mapping(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_discourse_tracking.$rkf_discourse_mapping_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject declare_rkf_discourse_tracking_file() {
        declareFunction(me, "rkf_disc_resolve_sentence_entities", "RKF-DISC-RESOLVE-SENTENCE-ENTITIES", 2, 0, false);
        declareFunction(me, "rkf_disc_resolve_entity", "RKF-DISC-RESOLVE-ENTITY", 3, 0, false);
        declareFunction(me, "rkf_disc_find_discourse_entities", "RKF-DISC-FIND-DISCOURSE-ENTITIES", 1, 0, false);
        declareFunction(me, "rkf_discourse_context_print_function_trampoline", "RKF-DISCOURSE-CONTEXT-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "rkf_discourse_context_p", "RKF-DISCOURSE-CONTEXT-P", 1, 0, false);
        new rkf_discourse_tracking.$rkf_discourse_context_p$UnaryFunction();
        declareFunction(me, "rkf_dc_explicit_mappings", "RKF-DC-EXPLICIT-MAPPINGS", 1, 0, false);
        declareFunction(me, "rkf_dc_discourse_mt", "RKF-DC-DISCOURSE-MT", 1, 0, false);
        declareFunction(me, "rkf_dc_parent_context", "RKF-DC-PARENT-CONTEXT", 1, 0, false);
        declareFunction(me, "rkf_dc_phrase_index", "RKF-DC-PHRASE-INDEX", 1, 0, false);
        declareFunction(me, "rkf_dc_indexical_index", "RKF-DC-INDEXICAL-INDEX", 1, 0, false);
        declareFunction(me, "_csetf_rkf_dc_explicit_mappings", "_CSETF-RKF-DC-EXPLICIT-MAPPINGS", 2, 0, false);
        declareFunction(me, "_csetf_rkf_dc_discourse_mt", "_CSETF-RKF-DC-DISCOURSE-MT", 2, 0, false);
        declareFunction(me, "_csetf_rkf_dc_parent_context", "_CSETF-RKF-DC-PARENT-CONTEXT", 2, 0, false);
        declareFunction(me, "_csetf_rkf_dc_phrase_index", "_CSETF-RKF-DC-PHRASE-INDEX", 2, 0, false);
        declareFunction(me, "_csetf_rkf_dc_indexical_index", "_CSETF-RKF-DC-INDEXICAL-INDEX", 2, 0, false);
        declareFunction(me, "make_rkf_discourse_context", "MAKE-RKF-DISCOURSE-CONTEXT", 0, 1, false);
        declareFunction(me, "visit_defstruct_rkf_discourse_context", "VISIT-DEFSTRUCT-RKF-DISCOURSE-CONTEXT", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_rkf_discourse_context_method", "VISIT-DEFSTRUCT-OBJECT-RKF-DISCOURSE-CONTEXT-METHOD", 2, 0, false);
        declareFunction(me, "new_rkf_discourse_context", "NEW-RKF-DISCOURSE-CONTEXT", 1, 0, false);
        declareFunction(me, "rkf_dc_link_parent_child_discourse", "RKF-DC-LINK-PARENT-CHILD-DISCOURSE", 2, 0, false);
        declareFunction(me, "rkf_dc_unlink_parent_child_discourse", "RKF-DC-UNLINK-PARENT-CHILD-DISCOURSE", 2, 0, false);
        declareFunction(me, "rkf_discourse_mapping_print_function_trampoline", "RKF-DISCOURSE-MAPPING-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "rkf_discourse_mapping_p", "RKF-DISCOURSE-MAPPING-P", 1, 0, false);
        new rkf_discourse_tracking.$rkf_discourse_mapping_p$UnaryFunction();
        declareFunction(me, "rkf_dm_interpretation", "RKF-DM-INTERPRETATION", 1, 0, false);
        declareFunction(me, "rkf_dm_indexicals", "RKF-DM-INDEXICALS", 1, 0, false);
        declareFunction(me, "rkf_dm_phrases", "RKF-DM-PHRASES", 1, 0, false);
        declareFunction(me, "_csetf_rkf_dm_interpretation", "_CSETF-RKF-DM-INTERPRETATION", 2, 0, false);
        declareFunction(me, "_csetf_rkf_dm_indexicals", "_CSETF-RKF-DM-INDEXICALS", 2, 0, false);
        declareFunction(me, "_csetf_rkf_dm_phrases", "_CSETF-RKF-DM-PHRASES", 2, 0, false);
        declareFunction(me, "make_rkf_discourse_mapping", "MAKE-RKF-DISCOURSE-MAPPING", 0, 1, false);
        declareFunction(me, "visit_defstruct_rkf_discourse_mapping", "VISIT-DEFSTRUCT-RKF-DISCOURSE-MAPPING", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_rkf_discourse_mapping_method", "VISIT-DEFSTRUCT-OBJECT-RKF-DISCOURSE-MAPPING-METHOD", 2, 0, false);
        declareFunction(me, "new_rkf_discourse_mapping", "NEW-RKF-DISCOURSE-MAPPING", 3, 0, false);
        declareFunction(me, "create_rkf_discourse_indexicals_mapping", "CREATE-RKF-DISCOURSE-INDEXICALS-MAPPING", 2, 0, false);
        declareFunction(me, "create_rkf_discourse_phrases_mapping", "CREATE-RKF-DISCOURSE-PHRASES-MAPPING", 2, 0, false);
        declareMacro(me, "create_rkf_discourse_mapping", "CREATE-RKF-DISCOURSE-MAPPING");
        declareFunction(me, "rkf_dc_add_mapping", "RKF-DC-ADD-MAPPING", 2, 0, false);
        declareFunction(me, "rkf_dc_remove_mapping", "RKF-DC-REMOVE-MAPPING", 2, 0, false);
        declareFunction(me, "rkf_disc_resolve_phrase_local", "RKF-DISC-RESOLVE-PHRASE-LOCAL", 2, 0, false);
        declareFunction(me, "rkf_disc_interp_for_phrase", "RKF-DISC-INTERP-FOR-PHRASE", 2, 0, false);
        declareFunction(me, "rkf_disc_phrase_from_phrase_entity", "RKF-DISC-PHRASE-FROM-PHRASE-ENTITY", 1, 0, false);
        declareFunction(me, "rkf_disc_resolve_indexical_local", "RKF-DISC-RESOLVE-INDEXICAL-LOCAL", 2, 0, false);
        declareFunction(me, "rkf_disc_resolve_coa", "RKF-DISC-RESOLVE-COA", 2, 0, false);
        declareFunction(me, "rkf_disc_resolve_indexical_wXlocal_mappings", "RKF-DISC-RESOLVE-INDEXICAL-W/LOCAL-MAPPINGS", 2, 0, false);
        declareFunction(me, "rkf_disc_consequent_from_indexical", "RKF-DISC-CONSEQUENT-FROM-INDEXICAL", 2, 0, false);
        declareFunction(me, "rkf_disc_easily_testable_formula", "RKF-DISC-EASILY-TESTABLE-FORMULA", 2, 0, false);
        declareFunction(me, "rkf_disc_resolve_phrase", "RKF-DISC-RESOLVE-PHRASE", 2, 0, false);
        declareFunction(me, "rkf_disc_resolve_indexical", "RKF-DISC-RESOLVE-INDEXICAL", 2, 0, false);
        declareFunction(me, "rkf_disc_potentially_resolvable_entityP", "RKF-DISC-POTENTIALLY-RESOLVABLE-ENTITY?", 2, 0, false);
        declareFunction(me, "rkf_disc_salient_individual_of_type_formulaP", "RKF-DISC-SALIENT-INDIVIDUAL-OF-TYPE-FORMULA?", 2, 0, false);
        declareFunction(me, "rkf_disc_salient_individual_formulaP", "RKF-DISC-SALIENT-INDIVIDUAL-FORMULA?", 1, 0, false);
        declareFunction(me, "rkf_disc_somefn_formulaP", "RKF-DISC-SOMEFN-FORMULA?", 1, 0, false);
        declareFunction(me, "rkf_disc_salient_instance_formulaP", "RKF-DISC-SALIENT-INSTANCE-FORMULA?", 1, 0, false);
        declareFunction(me, "rkf_disc_discourse_entityP", "RKF-DISC-DISCOURSE-ENTITY?", 1, 0, false);
        declareFunction(me, "rkf_disc_implied_indexicals_formulaP", "RKF-DISC-IMPLIED-INDEXICALS-FORMULA?", 1, 0, false);
        declareFunction(me, "rkf_make_discourse_formula_from_constraints", "RKF-MAKE-DISCOURSE-FORMULA-FROM-CONSTRAINTS", 2, 0, false);
        declareFunction(me, "rkf_discourse_bundle_ar_concept", "RKF-DISCOURSE-BUNDLE-AR-CONCEPT", 1, 0, false);
        declareFunction(me, "rkf_discourse_bundle_original", "RKF-DISCOURSE-BUNDLE-ORIGINAL", 1, 0, false);
        declareFunction(me, "rkf_discourse_bundle_options", "RKF-DISCOURSE-BUNDLE-OPTIONS", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $rkf_discourse_context_native extends SubLStructNative {
        ...
        public $rkf_discourse_context_native() {
            this.$explicit_mappings = Lisp.NIL;
            this.$discourse_mt = Lisp.NIL;
            this.$parent_context = Lisp.NIL;
            this.$phrase_index = Lisp.NIL;
            this.$indexical_index = Lisp.NIL;
        }
        ...
        static {
            structDecl = makeStructDeclNative(rkf_discourse_tracking.$rkf_discourse_context_native.class, RKF_DISCOURSE_CONTEXT, RKF_DISCOURSE_CONTEXT_P, $list4, $list5, new String[]{ "$explicit_mappings", "$discourse_mt", "$parent_context", "$phrase_index", "$indexical_index" }, $list6, $list7, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $rkf_discourse_mapping_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_discourse_tracking.$rkf_discourse_mapping_native.class, RKF_DISCOURSE_MAPPING, RKF_DISCOURSE_MAPPING_P, $list34, $list35, new String[]{ "$interpretation", "$indexicals", "$phrases" }, $list36, $list37, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
