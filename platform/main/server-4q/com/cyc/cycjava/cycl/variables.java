...
public final class variables extends SubLTranslatedFile {
    ...
    public static SubLObject variable_p(final SubLObject v_object) {
        return v_object.getClass() == variables.$variable_native.class ? T : NIL;
    }

    public static SubLObject var_id(final SubLObject v_object) {
        assert NIL != variable_p(v_object) : "variables.variable_p(v_object) " + "CommonSymbols.NIL != variables.variable_p(v_object) " + v_object;
    ...
    public static SubLObject make_variable(SubLObject arglist) {
        ...
        final SubLObject v_new = new variables.$variable_native();
        SubLObject next;
    ...
    public static final class $variable_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(variables.$variable_native.class, VARIABLE, VARIABLE_P, $list3, $list4, new String[]{ "$id" }, $list5, $list6, PRINT_VARIABLE);
        }
    }
