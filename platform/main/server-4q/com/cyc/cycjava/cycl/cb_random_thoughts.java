...
import com.cyc.cycjava.cycl.cb_random_thoughts;
...
import static com.cyc.cycjava.cycl.cb_random_thoughts.*;
...
public final class cb_random_thoughts extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLString $str0$_Random_Thought_ = makeString("[Random Thought]");



    public static final SubLString $str2$cb_random_thoughts = makeString("cb-random-thoughts");



    public static final SubLSymbol CB_LINK_RANDOM_THOUGHT = makeSymbol("CB-LINK-RANDOM-THOUGHT");

    public static final SubLSymbol CB_RANDOM_THOUGHTS = makeSymbol("CB-RANDOM-THOUGHTS");
    ...
    public static final SubLList $list9 = list(makeKeyword("NOW"), NIL);
    ...
    private static final SubLList $list43 = list(reader_make_constant_shell(makeString("Baxter")), reader_make_constant_shell(makeString("DaveS")), reader_make_constant_shell(makeString("Witbrock")));
    ...
    public static final SubLList $list47 = list(makeKeyword("REQUIRE-TOPICAL?"), NIL, makeKeyword("NOW"), NIL);
    ...
    private static final SubLList $list54 = list(cons(reader_make_constant_shell(makeString("TrueCycLSentence")), makeString("True")), cons(reader_make_constant_shell(makeString("FalseCycLSentence")), makeString("False")), cons(reader_make_constant_shell(makeString("BadlyParaphrasedCycLSentence")), makeString("Bad Paraphrase")), cons(reader_make_constant_shell(makeString("UninterestingCycLSentence")), makeString("Uninteresting")), cons(reader_make_constant_shell(makeString("ProblematicCycLSentence")), makeString("Other")));
    ...
    private static final SubLObject $$CycRandomThoughtEvaluationTool = reader_make_constant_shell(makeString("CycRandomThoughtEvaluationTool"));

    private static final SubLObject $$EvaluationOfByOnFn = reader_make_constant_shell(makeString("EvaluationOfByOnFn"));

    private static final SubLObject $$evaluationInput = reader_make_constant_shell(makeString("evaluationInput"));

    private static final SubLObject $$evaluationOfAs = reader_make_constant_shell(makeString("evaluationOfAs"));

    private static final SubLObject $const73$EvaluatedSentencesFromRandomThoug = reader_make_constant_shell(makeString("EvaluatedSentencesFromRandomThoughtServerMt"));
    ...
    public static SubLObject declare_cb_random_thoughts_file() {
        declareFunction(me, "cb_link_random_thought", "CB-LINK-RANDOM-THOUGHT", 0, 1, false);
        declareFunction(me, "cb_random_thoughts", "CB-RANDOM-THOUGHTS", 0, 1, false);
        declareFunction(me, "cb_random_thought_for_cyclist", "CB-RANDOM-THOUGHT-FOR-CYCLIST", 1, 2, false);
        declareFunction(me, "cb_show_random_thought", "CB-SHOW-RANDOM-THOUGHT", 2, 2, false);
        declareFunction(me, "cb_random_thought_connection_type", "CB-RANDOM-THOUGHT-CONNECTION-TYPE", 3, 0, false);
        declareFunction(me, "cb_handle_random_thoughts", "CB-HANDLE-RANDOM-THOUGHTS", 1, 0, false);
        declareFunction(me, "show_random_thought_for_user_and_topic_p", "SHOW-RANDOM-THOUGHT-FOR-USER-AND-TOPIC-P", 2, 0, false);
        declareFunction(me, "cb_random_thought_frame", "CB-RANDOM-THOUGHT-FRAME", 1, 0, false);
        declareFunction(me, "cb_random_thought_retrieve_and_display", "CB-RANDOM-THOUGHT-RETRIEVE-AND-DISPLAY", 2, 0, false);
        declareFunction(me, "cb_random_thought_frame_internal", "CB-RANDOM-THOUGHT-FRAME-INTERNAL", 4, 1, false);
        declareFunction(me, "cb_random_thoughts_button_bar", "CB-RANDOM-THOUGHTS-BUTTON-BAR", 0, 0, false);
        declareFunction(me, "cb_random_thoughts_evaluation", "CB-RANDOM-THOUGHTS-EVALUATION", 3, 0, false);
        declareFunction(me, "cb_link_random_thought_frame", "CB-LINK-RANDOM-THOUGHT-FRAME", 2, 1, false);
        declareFunction(me, "cb_handle_random_thought_frame", "CB-HANDLE-RANDOM-THOUGHT-FRAME", 1, 0, false);
        declareFunction(me, "cb_maybe_show_random_thought", "CB-MAYBE-SHOW-RANDOM-THOUGHT", 1, 0, false);
        return NIL;
    }
