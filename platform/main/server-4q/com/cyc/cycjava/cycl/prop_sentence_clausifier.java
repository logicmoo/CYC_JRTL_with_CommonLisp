...
public final class prop_sentence_clausifier
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject prop_sentence_conjoin_p(final SubLObject sentence)
  {
    ...
    return Equality.equal( $prop_sentence_and$.getDynamicValue( thread ), sentence.first() );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return Equality.equal( $prop_sentence_or$.getDynamicValue( thread ), sentence.first() );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return Equality.equal( $prop_sentence_not$.getDynamicValue( thread ), sentence.first() );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return ConsesLow.cons( $prop_sentence_and$.getDynamicValue( thread ), sentences );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return ConsesLow.cons( $prop_sentence_or$.getDynamicValue( thread ), sentences );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return ConsesLow.list( $prop_sentence_not$.getDynamicValue( thread ), prop_sentence );
  }
  ...
  {
    return Mapping.mapcar( $sym5$PROP_SENTENCE_NEGATE, sentence_list );
  }
  ...
  {
    return Sequences.find( operator, args, Symbols.symbol_function( EQL ), Symbols.symbol_function( $sym6$PROP_SENTENCE_ARG_OPERATOR ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject prop_sentence_canon_negations_in(final SubLObject prop_sentence)
  {
    ...
    {
      return prop_sentence_conjoin( Mapping.mapcar( $sym10$PROP_SENTENCE_CANON_NEGATIONS_IN, prop_sentence_args( prop_sentence ) ) );
    }
    if( NIL != prop_sentence_disjoin_p( prop_sentence ) )
    {
      return prop_sentence_disjoin( Mapping.mapcar( $sym10$PROP_SENTENCE_CANON_NEGATIONS_IN, prop_sentence_args( prop_sentence ) ) );
    }
    return Errors.error( $str9$Can_t_handle__S, prop_sentence );
  }
  ...
  public static SubLObject prop_sentence_canon_disjunctions_in(final SubLObject prop_sentence)
  {
    ...
    if( NIL != prop_sentence_conjoin_p( prop_sentence ) )
    {
      return prop_sentence_conjoin( Mapping.mapcar( $sym11$PROP_SENTENCE_CANON_DISJUNCTIONS_IN, prop_sentence_args( prop_sentence ) ) );
    }
    if( NIL == prop_sentence_disjoin_p( prop_sentence ) )
    {
      return Errors.error( $str9$Can_t_handle__S, prop_sentence );
    ...
    final SubLObject other_disjuncts = Sequences.delete( nested_conjunction, args, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL != other_disjuncts )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        new_conjuncts = ConsesLow.cons( prop_sentence_disjoin( new_disjuncts ), new_conjuncts );
        cdolist_list_var = cdolist_list_var.rest();
        conjunct = cdolist_list_var.first();
      }
      return prop_sentence_conjoin( Mapping.mapcar( $sym11$PROP_SENTENCE_CANON_DISJUNCTIONS_IN, new_conjuncts ) );
    }
  ...
  public static SubLObject prop_sentence_canon_conjunctions_in(final SubLObject prop_sentence)
  {
    ...
    if( NIL != prop_sentence_disjoin_p( prop_sentence ) )
    {
      return prop_sentence_disjoin( Mapping.mapcar( $sym12$PROP_SENTENCE_CANON_CONJUNCTIONS_IN, prop_sentence_args( prop_sentence ) ) );
    }
    if( NIL == prop_sentence_conjoin_p( prop_sentence ) )
    {
      return Errors.error( $str9$Can_t_handle__S, prop_sentence );
    ...
    final SubLObject other_conjuncts = Sequences.delete( nested_disjunction, args, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL != other_conjuncts )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        new_disjuncts = ConsesLow.cons( prop_sentence_conjoin( new_conjuncts ), new_disjuncts );
        cdolist_list_var = cdolist_list_var.rest();
        disjunct = cdolist_list_var.first();
      }
      return prop_sentence_disjoin( Mapping.mapcar( $sym12$PROP_SENTENCE_CANON_CONJUNCTIONS_IN, new_disjuncts ) );
    }
  ...
  public static SubLObject prop_sentence_simplify_and(final SubLObject prop_sentence)
  {
    ...
    SubLObject args = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( prop_sentence, prop_sentence, $list13 );
    operator = prop_sentence.first();
    final SubLObject current = args = prop_sentence.rest();
    args = Mapping.mapcar( $sym14$PROP_SENTENCE_SIMPLIFY, args );
    ...
    while ( NIL != cdolist_list_var)
    {
      if( arg.isCons() )
      {
        ...
        cdestructuring_bind.destructuring_bind_must_consp( current_$4, datum_$3, $list15 );
        ...
        if( $prop_sentence_and$.getDynamicValue( thread ).eql( inner_operator ) )
        {
          ...
          {
            lifted_args = ConsesLow.cons( inner_arg, lifted_args );
        ...
        {
          lifted_args = ConsesLow.cons( arg, lifted_args );
        }
      }
      else
      {
    ...
    args = Sequences.delete_duplicates( args, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
    args = Sequences.delete( $prop_sentence_true$.getDynamicValue( thread ), args, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL == args )
    {
    ...
    if( NIL != list_utilities.singletonP( args ) )
    {
      ...
      arg = NIL;
      cdestructuring_bind.destructuring_bind_must_consp( current_$5, datum_$4, $list7 );
      ...
      cdestructuring_bind.cdestructuring_bind_error( datum_$4, $list7 );
      return NIL;
    }
    else
    {
      if( NIL != subl_promotions.memberP( $prop_sentence_false$.getDynamicValue( thread ), args, Symbols.symbol_function( EQUAL ), UNPROVIDED ) )
      {
  ...
  public static SubLObject prop_sentence_simplify_or(final SubLObject prop_sentence)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( arg.isCons() )
      {
        ...
        SubLObject inner_operator = NIL;
        SubLObject inner_args = NIL;
        cdestructuring_bind.destructuring_bind_must_consp( current_$9, datum_$8, $list15 );
    ...
    args = Sequences.nreverse( lifted_args );
    args = Sequences.delete_duplicates( args, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
    args = Sequences.delete( $prop_sentence_false$.getDynamicValue( thread ), args, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL == args )
    {
      return $prop_sentence_false$.getDynamicValue( thread );
    }
    ...
    if( NIL != subl_promotions.memberP( $prop_sentence_true$.getDynamicValue( thread ), args, Symbols.symbol_function( EQUAL ), UNPROVIDED ) )
    {
      return $prop_sentence_true$.getDynamicValue( thread );
    }
    if( NIL != prop_literal_duals_foundP( args ) )
  ...
  public static SubLObject prop_sentence_simplify_not(final SubLObject prop_sentence)
  {
    ...
    SubLObject operator = NIL;
    SubLObject arg = NIL;
    cdestructuring_bind.destructuring_bind_must_consp( prop_sentence, prop_sentence, $list16 );
    operator = prop_sentence.first();
    SubLObject current = prop_sentence.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, prop_sentence, $list16 );
    arg = current.first();
    current = current.rest();
    if( NIL != current )
    {
      cdestructuring_bind.cdestructuring_bind_error( prop_sentence, $list16 );
      return NIL;
    }
  ...
  public static SubLObject prop_literal_duals_foundP(final SubLObject args)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( args, args, $list17 );
  ...
  {
    SubLFiles.declareFunction( me, "prop_sentence_conjoin_p", "PROP-SENTENCE-CONJOIN-P", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_disjoin_p", "PROP-SENTENCE-DISJOIN-P", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_negation_p", "PROP-SENTENCE-NEGATION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_conjoin", "PROP-SENTENCE-CONJOIN", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_disjoin", "PROP-SENTENCE-DISJOIN", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_negate", "PROP-SENTENCE-NEGATE", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_negate_args", "PROP-SENTENCE-NEGATE-ARGS", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_args", "PROP-SENTENCE-ARGS", 1, 0, false );
    SubLFiles.declareFunction( me, "find_arg_with_operator", "FIND-ARG-WITH-OPERATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_arg_operator", "PROP-SENTENCE-ARG-OPERATOR", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_to_cnf", "PROP-SENTENCE-TO-CNF", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_to_dnf", "PROP-SENTENCE-TO-DNF", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_canon_negations_in", "PROP-SENTENCE-CANON-NEGATIONS-IN", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_canon_disjunctions_in", "PROP-SENTENCE-CANON-DISJUNCTIONS-IN", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_canon_conjunctions_in", "PROP-SENTENCE-CANON-CONJUNCTIONS-IN", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_simplify", "PROP-SENTENCE-SIMPLIFY", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_simplify_and", "PROP-SENTENCE-SIMPLIFY-AND", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_simplify_or", "PROP-SENTENCE-SIMPLIFY-OR", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_sentence_simplify_not", "PROP-SENTENCE-SIMPLIFY-NOT", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_literal_duals_foundP", "PROP-LITERAL-DUALS-FOUND?", 1, 0, false );
    SubLFiles.declareFunction( me, "prop_literal_dual_p", "PROP-LITERAL-DUAL-P", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_prop_sentence_clausifier_file()
  {
    $prop_sentence_and$ = SubLFiles.defparameter( "*PROP-SENTENCE-AND*", $const0$and );
    $prop_sentence_or$ = SubLFiles.defparameter( "*PROP-SENTENCE-OR*", $const1$or );
    $prop_sentence_not$ = SubLFiles.defparameter( "*PROP-SENTENCE-NOT*", $const2$not );
    $prop_sentence_true$ = SubLFiles.defparameter( "*PROP-SENTENCE-TRUE*", $const3$True );
    $prop_sentence_false$ = SubLFiles.defparameter( "*PROP-SENTENCE-FALSE*", $const4$False );
    return NIL;
  }
  ...
  static
  {
    me = new prop_sentence_clausifier();
    $prop_sentence_and$ = null;
    $prop_sentence_or$ = null;
    $prop_sentence_not$ = null;
    $prop_sentence_true$ = null;
    $prop_sentence_false$ = null;
    $const0$and = constant_handles.reader_make_constant_shell( makeString( "and" ) );
    ...
    $const4$False = constant_handles.reader_make_constant_shell( makeString( "False" ) );
    $sym5$PROP_SENTENCE_NEGATE = makeSymbol( "PROP-SENTENCE-NEGATE" );
    $sym6$PROP_SENTENCE_ARG_OPERATOR = makeSymbol( "PROP-SENTENCE-ARG-OPERATOR" );
    $list7 = ConsesLow.list( makeSymbol( "ARG" ) );
    $list8 = ConsesLow.list( makeSymbol( "INNER-ARG" ) );
    $str9$Can_t_handle__S = makeString( "Can't handle ~S" );
    $sym10$PROP_SENTENCE_CANON_NEGATIONS_IN = makeSymbol( "PROP-SENTENCE-CANON-NEGATIONS-IN" );
    $sym11$PROP_SENTENCE_CANON_DISJUNCTIONS_IN = makeSymbol( "PROP-SENTENCE-CANON-DISJUNCTIONS-IN" );
    $sym12$PROP_SENTENCE_CANON_CONJUNCTIONS_IN = makeSymbol( "PROP-SENTENCE-CANON-CONJUNCTIONS-IN" );
    $list13 = ConsesLow.cons( makeSymbol( "OPERATOR" ), makeSymbol( "ARGS" ) );
    $sym14$PROP_SENTENCE_SIMPLIFY = makeSymbol( "PROP-SENTENCE-SIMPLIFY" );
    $list15 = ConsesLow.cons( makeSymbol( "INNER-OPERATOR" ), makeSymbol( "INNER-ARGS" ) );
    $list16 = ConsesLow.list( makeSymbol( "OPERATOR" ), makeSymbol( "ARG" ) );
    $list17 = ConsesLow.cons( makeSymbol( "FIRST-ARG" ), makeSymbol( "REST-ARGS" ) );
  }
}
/*
 * 
