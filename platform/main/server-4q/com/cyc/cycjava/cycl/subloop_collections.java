...
import static com.cyc.cycjava.cycl.subloop_collections.*;
...
public final class subloop_collections extends SubLTranslatedFile {
    ...
    public static SubLObject double_link_cell_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_collections.$double_link_cell_native.class ? T : NIL;
    }

    public static SubLObject dlc_owner(final SubLObject v_object) {
        assert NIL != double_link_cell_p(v_object) : "subloop_collections.double_link_cell_p(v_object) " + "CommonSymbols.NIL != subloop_collections.double_link_cell_p(v_object) " + v_object;
    ...
    public static SubLObject make_double_link_cell(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_collections.$double_link_cell_native();
        SubLObject next;
    ...
    public static final class $double_link_cell_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_collections.$double_link_cell_native.class, DOUBLE_LINK_CELL, DOUBLE_LINK_CELL_P, $list251, $list252, new String[]{ "$owner", "$contents", "$previous", "$next" }, $list253, $list254, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
