...
import com.cyc.cycjava.cycl.math_expression_utilities;
...
import static com.cyc.cycjava.cycl.math_expression_utilities.*;
...
public final class math_expression_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject declare_math_expression_utilities_file() {
        declareFunction(me, "math_expression_infix_operator_precedence_rank", "MATH-EXPRESSION-INFIX-OPERATOR-PRECEDENCE-RANK", 1, 0, false);
        declareFunction(me, "math_expression_addition_op_p", "MATH-EXPRESSION-ADDITION-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_subtraction_op_p", "MATH-EXPRESSION-SUBTRACTION-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_addition_or_subtraction_op_p", "MATH-EXPRESSION-ADDITION-OR-SUBTRACTION-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_multiplication_op_p", "MATH-EXPRESSION-MULTIPLICATION-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_division_op_p", "MATH-EXPRESSION-DIVISION-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_multiplication_or_divide_op_p", "MATH-EXPRESSION-MULTIPLICATION-OR-DIVIDE-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_exponentiation_op_p", "MATH-EXPRESSION-EXPONENTIATION-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_nth_root_op_p", "MATH-EXPRESSION-NTH-ROOT-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_infix_op_p", "MATH-EXPRESSION-INFIX-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_unary_prefix_op_p", "MATH-EXPRESSION-UNARY-PREFIX-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_unary_surround_op_p", "MATH-EXPRESSION-UNARY-SURROUND-OP-P", 1, 0, false);
        declareFunction(me, "math_expression_with_some_operator_p", "MATH-EXPRESSION-WITH-SOME-OPERATOR-P", 1, 0, false);
        declareFunction(me, "clear_all_math_expression_denoting_functions", "CLEAR-ALL-MATH-EXPRESSION-DENOTING-FUNCTIONS", 0, 0, false);
        declareFunction(me, "remove_all_math_expression_denoting_functions", "REMOVE-ALL-MATH-EXPRESSION-DENOTING-FUNCTIONS", 0, 0, false);
        declareFunction(me, "all_math_expression_denoting_functions_internal", "ALL-MATH-EXPRESSION-DENOTING-FUNCTIONS-INTERNAL", 0, 0, false);
        declareFunction(me, "all_math_expression_denoting_functions", "ALL-MATH-EXPRESSION-DENOTING-FUNCTIONS", 0, 0, false);
        declareFunction(me, "math_expression_p", "MATH-EXPRESSION-P", 1, 0, false);
        declareFunction(me, "infix_math_expression_p", "INFIX-MATH-EXPRESSION-P", 1, 0, false);
        declareFunction(me, "prefix_math_expression_p", "PREFIX-MATH-EXPRESSION-P", 1, 0, false);
        declareFunction(me, "math_expression_quant_fn_p", "MATH-EXPRESSION-QUANT-FN-P", 1, 0, false);
        declareFunction(me, "time_expression_fn_p", "TIME-EXPRESSION-FN-P", 1, 0, false);
        declareFunction(me, "math_expression_minus_quant_fn_p", "MATH-EXPRESSION-MINUS-QUANT-FN-P", 1, 0, false);
        declareFunction(me, "math_expression_quant_fn_or_minus_quant_fn_p", "MATH-EXPRESSION-QUANT-FN-OR-MINUS-QUANT-FN-P", 1, 0, false);
        declareFunction(me, "math_expression_quant_value", "MATH-EXPRESSION-QUANT-VALUE", 1, 0, false);
        declareFunction(me, "math_expression_zero_quant_value", "MATH-EXPRESSION-ZERO-QUANT-VALUE", 1, 0, false);
        declareFunction(me, "math_expression_var_p", "MATH-EXPRESSION-VAR-P", 1, 0, false);
        declareFunction(me, "math_expression_enclosure_fn_p", "MATH-EXPRESSION-ENCLOSURE-FN-P", 1, 0, false);
        declareFunction(me, "math_statement_function_p", "MATH-STATEMENT-FUNCTION-P", 1, 0, false);
        declareFunction(me, "math_statement_expressionP", "MATH-STATEMENT-EXPRESSION?", 1, 0, false);
        declareFunction(me, "math_addition_expressionP", "MATH-ADDITION-EXPRESSION?", 1, 0, false);
        declareFunction(me, "math_subtraction_expressionP", "MATH-SUBTRACTION-EXPRESSION?", 1, 0, false);
        declareFunction(me, "math_addition_or_subtraction_expressionP", "MATH-ADDITION-OR-SUBTRACTION-EXPRESSION?", 1, 0, false);
        declareFunction(me, "math_multiplication_expressionP", "MATH-MULTIPLICATION-EXPRESSION?", 1, 0, false);
        declareFunction(me, "math_division_expressionP", "MATH-DIVISION-EXPRESSION?", 1, 0, false);
        declareFunction(me, "math_multiplication_or_division_expressionP", "MATH-MULTIPLICATION-OR-DIVISION-EXPRESSION?", 1, 0, false);
        declareFunction(me, "math_exponentiation_expressionP", "MATH-EXPONENTIATION-EXPRESSION?", 1, 0, false);
        declareFunction(me, "math_nth_root_expressionP", "MATH-NTH-ROOT-EXPRESSION?", 1, 0, false);
        declareFunction(me, "math_enclosed_math_expressionP", "MATH-ENCLOSED-MATH-EXPRESSION?", 1, 0, false);
        declareFunction(me, "math_expression_unenclose", "MATH-EXPRESSION-UNENCLOSE", 1, 0, false);
        declareFunction(me, "math_expression_with_all_of_operator_test", "MATH-EXPRESSION-WITH-ALL-OF-OPERATOR-TEST", 2, 0, false);
        declareFunction(me, "math_expression_with_any_of_operator_test", "MATH-EXPRESSION-WITH-ANY-OF-OPERATOR-TEST", 2, 0, false);
        declareFunction(me, "removal_submathexpressions_direct_expand", "REMOVAL-SUBMATHEXPRESSIONS-DIRECT-EXPAND", 1, 1, false);
        declareFunction(me, "sub_math_expressions_direct", "SUB-MATH-EXPRESSIONS-DIRECT", 1, 0, false);
        declareFunction(me, "test_removal_submathexpressions_direct_expand", "TEST-REMOVAL-SUBMATHEXPRESSIONS-DIRECT-EXPAND", 1, 2, false);
        declareFunction(me, "removal_submathexpressions_expand", "REMOVAL-SUBMATHEXPRESSIONS-EXPAND", 1, 1, false);
        declareFunction(me, "sub_math_expressions", "SUB-MATH-EXPRESSIONS", 1, 0, false);
        declareFunction(me, "test_removal_submathexpressions_expand", "TEST-REMOVAL-SUBMATHEXPRESSIONS-EXPAND", 1, 2, false);
        declareFunction(me, "removal_mathquantvalue_expand", "REMOVAL-MATHQUANTVALUE-EXPAND", 1, 1, false);
        declareFunction(me, "math_quant_value", "MATH-QUANT-VALUE", 1, 0, false);
        declareFunction(me, "test_removal_mathquantvalue_expand", "TEST-REMOVAL-MATHQUANTVALUE-EXPAND", 1, 2, false);
        declareFunction(me, "removal_additionarglist_expand", "REMOVAL-ADDITIONARGLIST-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_addition_arglist", "MATH-EXPRESSION-ADDITION-ARGLIST", 1, 0, false);
        declareFunction(me, "test_removal_additionarglist_expand", "TEST-REMOVAL-ADDITIONARGLIST-EXPAND", 1, 2, false);
        declareFunction(me, "removal_genericadditionarglist_expand", "REMOVAL-GENERICADDITIONARGLIST-EXPAND", 1, 1, false);
        declareFunction(me, "generic_math_expression_addition_arglist", "GENERIC-MATH-EXPRESSION-ADDITION-ARGLIST", 1, 0, false);
        declareFunction(me, "test_removal_genericadditionarglist_expand", "TEST-REMOVAL-GENERICADDITIONARGLIST-EXPAND", 1, 2, false);
        declareFunction(me, "removal_multiplicationarglist_expand", "REMOVAL-MULTIPLICATIONARGLIST-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_multiplication_arglist", "MATH-EXPRESSION-MULTIPLICATION-ARGLIST", 1, 0, false);
        declareFunction(me, "test_removal_multiplicationarglist_expand", "TEST-REMOVAL-MULTIPLICATIONARGLIST-EXPAND", 1, 2, false);
        declareFunction(me, "removal_genericmultiplicationarglist_expand", "REMOVAL-GENERICMULTIPLICATIONARGLIST-EXPAND", 1, 1, false);
        declareFunction(me, "generic_math_expression_multiplication_arglist", "GENERIC-MATH-EXPRESSION-MULTIPLICATION-ARGLIST", 1, 0, false);
        declareFunction(me, "test_removal_genericmultiplicationarglist_expand", "TEST-REMOVAL-GENERICMULTIPLICATIONARGLIST-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionnegated_expand", "REMOVAL-EXPRESSIONNEGATED-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_expressionnegated_expand", "TEST-REMOVAL-EXPRESSIONNEGATED-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionminuend_expand", "REMOVAL-EXPRESSIONMINUEND-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_minuend", "MATH-EXPRESSION-MINUEND", 1, 0, false);
        declareFunction(me, "test_removal_expressionminuend_expand", "TEST-REMOVAL-EXPRESSIONMINUEND-EXPAND", 1, 2, false);
        declareFunction(me, "removal_genericexpressionminuend_expand", "REMOVAL-GENERICEXPRESSIONMINUEND-EXPAND", 1, 1, false);
        declareFunction(me, "generic_math_expression_minuend", "GENERIC-MATH-EXPRESSION-MINUEND", 1, 0, false);
        declareFunction(me, "test_removal_genericexpressionminuend_expand", "TEST-REMOVAL-GENERICEXPRESSIONMINUEND-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionsubtrahend_expand", "REMOVAL-EXPRESSIONSUBTRAHEND-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_subtrahend", "MATH-EXPRESSION-SUBTRAHEND", 1, 0, false);
        declareFunction(me, "test_removal_expressionsubtrahend_expand", "TEST-REMOVAL-EXPRESSIONSUBTRAHEND-EXPAND", 1, 2, false);
        declareFunction(me, "removal_genericexpressionsubtrahend_expand", "REMOVAL-GENERICEXPRESSIONSUBTRAHEND-EXPAND", 1, 1, false);
        declareFunction(me, "generic_math_expression_subtrahend", "GENERIC-MATH-EXPRESSION-SUBTRAHEND", 1, 0, false);
        declareFunction(me, "test_removal_genericexpressionsubtrahend_expand", "TEST-REMOVAL-GENERICEXPRESSIONSUBTRAHEND-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressiondivisor_expand", "REMOVAL-EXPRESSIONDIVISOR-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_divisor", "MATH-EXPRESSION-DIVISOR", 1, 0, false);
        declareFunction(me, "test_removal_expressiondivisor_expand", "TEST-REMOVAL-EXPRESSIONDIVISOR-EXPAND", 1, 2, false);
        declareFunction(me, "removal_genericexpressiondivisor_expand", "REMOVAL-GENERICEXPRESSIONDIVISOR-EXPAND", 1, 1, false);
        declareFunction(me, "generic_math_expression_divisor", "GENERIC-MATH-EXPRESSION-DIVISOR", 1, 0, false);
        declareFunction(me, "test_removal_genericexpressiondivisor_expand", "TEST-REMOVAL-GENERICEXPRESSIONDIVISOR-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressiondividend_expand", "REMOVAL-EXPRESSIONDIVIDEND-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_dividend", "MATH-EXPRESSION-DIVIDEND", 1, 0, false);
        declareFunction(me, "test_removal_expressiondividend_expand", "TEST-REMOVAL-EXPRESSIONDIVIDEND-EXPAND", 1, 2, false);
        declareFunction(me, "removal_genericexpressiondividend_expand", "REMOVAL-GENERICEXPRESSIONDIVIDEND-EXPAND", 1, 1, false);
        declareFunction(me, "generic_math_expression_dividend", "GENERIC-MATH-EXPRESSION-DIVIDEND", 1, 0, false);
        declareFunction(me, "test_removal_genericexpressiondividend_expand", "TEST-REMOVAL-GENERICEXPRESSIONDIVIDEND-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionexponent_expand", "REMOVAL-EXPRESSIONEXPONENT-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_expressionexponent_expand", "TEST-REMOVAL-EXPRESSIONEXPONENT-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionbase_expand", "REMOVAL-EXPRESSIONBASE-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_expressionbase_expand", "TEST-REMOVAL-EXPRESSIONBASE-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionradicand_expand", "REMOVAL-EXPRESSIONRADICAND-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_expressionradicand_expand", "TEST-REMOVAL-EXPRESSIONRADICAND-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionindex_expand", "REMOVAL-EXPRESSIONINDEX-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_expressionindex_expand", "TEST-REMOVAL-EXPRESSIONINDEX-EXPAND", 1, 2, false);
        declareFunction(me, "removal_absolutevalueofexpression_expand", "REMOVAL-ABSOLUTEVALUEOFEXPRESSION-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_absolutevalueofexpression_expand", "TEST-REMOVAL-ABSOLUTEVALUEOFEXPRESSION-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionenclosed_expand", "REMOVAL-EXPRESSIONENCLOSED-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_enclosed_expression", "MATH-EXPRESSION-ENCLOSED-EXPRESSION", 1, 0, false);
        declareFunction(me, "test_removal_expressionenclosed_expand", "TEST-REMOVAL-EXPRESSIONENCLOSED-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionaddends_expand", "REMOVAL-EXPRESSIONADDENDS-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_addends", "MATH-EXPRESSION-ADDENDS", 1, 0, false);
        declareFunction(me, "test_removal_expressionaddends_expand", "TEST-REMOVAL-EXPRESSIONADDENDS-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionfactors_expand", "REMOVAL-EXPRESSIONFACTORS-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_factors", "MATH-EXPRESSION-FACTORS", 1, 0, false);
        declareFunction(me, "test_removal_expressionfactors_expand", "TEST-REMOVAL-EXPRESSIONFACTORS-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionaddendlist_expand", "REMOVAL-EXPRESSIONADDENDLIST-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_expressionaddendlist_expand", "TEST-REMOVAL-EXPRESSIONADDENDLIST-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionfactorlist_expand", "REMOVAL-EXPRESSIONFACTORLIST-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_expressionfactorlist_expand", "TEST-REMOVAL-EXPRESSIONFACTORLIST-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionisevaluatable_expand", "REMOVAL-EXPRESSIONISEVALUATABLE-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_is_evaluatableP", "MATH-EXPRESSION-IS-EVALUATABLE?", 1, 0, false);
        declareFunction(me, "math_expression_evaluate", "MATH-EXPRESSION-EVALUATE", 1, 0, false);
        declareFunction(me, "math_expression_evaluate_int", "MATH-EXPRESSION-EVALUATE-INT", 1, 0, false);
        declareFunction(me, "math_expression_failed_evaluation_reasons_merge", "MATH-EXPRESSION-FAILED-EVALUATION-REASONS-MERGE", 2, 0, false);
        declareFunction(me, "math_expression_operand_quantity_type", "MATH-EXPRESSION-OPERAND-QUANTITY-TYPE", 1, 0, false);
        declareFunction(me, "math_quant_value_type", "MATH-QUANT-VALUE-TYPE", 1, 0, false);
        declareFunction(me, "test_removal_expressionisevaluatable_expand", "TEST-REMOVAL-EXPRESSIONISEVALUATABLE-EXPAND", 1, 2, false);
        declareFunction(me, "removal_mathexpressionoperatorlist_expand", "REMOVAL-MATHEXPRESSIONOPERATORLIST-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_mathexpressionoperatorlist_expand", "TEST-REMOVAL-MATHEXPRESSIONOPERATORLIST-EXPAND", 1, 2, false);
        declareFunction(me, "removal_mathexpressionoperatorcount_expand", "REMOVAL-MATHEXPRESSIONOPERATORCOUNT-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_mathexpressionoperatorcount_expand", "TEST-REMOVAL-MATHEXPRESSIONOPERATORCOUNT-EXPAND", 1, 2, false);
        declareFunction(me, "math_expression_elems_and_ops", "MATH-EXPRESSION-ELEMS-AND-OPS", 1, 0, false);
        declareFunction(me, "make_math_expression", "MAKE-MATH-EXPRESSION", 2, 0, false);
        declareFunction(me, "math_expression_elems_and_ops_for_additions_and_subtractions", "MATH-EXPRESSION-ELEMS-AND-OPS-FOR-ADDITIONS-AND-SUBTRACTIONS", 1, 0, false);
        declareFunction(me, "math_expression_elems_and_ops_for_addition", "MATH-EXPRESSION-ELEMS-AND-OPS-FOR-ADDITION", 1, 0, false);
        declareFunction(me, "math_expression_elems_and_ops_for_multiplication_and_division", "MATH-EXPRESSION-ELEMS-AND-OPS-FOR-MULTIPLICATION-AND-DIVISION", 1, 0, false);
        declareFunction(me, "math_expression_elems_and_ops_for_multiplication", "MATH-EXPRESSION-ELEMS-AND-OPS-FOR-MULTIPLICATION", 1, 0, false);
        declareFunction(me, "removal_mathexpressionoperator_expand", "REMOVAL-MATHEXPRESSIONOPERATOR-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_operator", "MATH-EXPRESSION-OPERATOR", 1, 0, false);
        declareFunction(me, "test_removal_mathexpressionoperator_expand", "TEST-REMOVAL-MATHEXPRESSIONOPERATOR-EXPAND", 1, 2, false);
        declareFunction(me, "removal_leftsideofmathematicalstatement_expand", "REMOVAL-LEFTSIDEOFMATHEMATICALSTATEMENT-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_leftsideofmathematicalstatement_expand", "TEST-REMOVAL-LEFTSIDEOFMATHEMATICALSTATEMENT-EXPAND", 1, 2, false);
        declareFunction(me, "removal_rightsideofmathematicalstatement_expand", "REMOVAL-RIGHTSIDEOFMATHEMATICALSTATEMENT-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_rightsideofmathematicalstatement_expand", "TEST-REMOVAL-RIGHTSIDEOFMATHEMATICALSTATEMENT-EXPAND", 1, 2, false);
        declareFunction(me, "removal_likemathterms_expand", "REMOVAL-LIKEMATHTERMS-EXPAND", 1, 1, false);
        declareFunction(me, "like_fractionsP", "LIKE-FRACTIONS?", 2, 0, false);
        declareFunction(me, "like_math_termsP", "LIKE-MATH-TERMS?", 2, 1, false);
        declareFunction(me, "normalize_term_for_like_math_terms", "NORMALIZE-TERM-FOR-LIKE-MATH-TERMS", 1, 0, false);
        declareFunction(me, "why_like_math_termsP", "WHY-LIKE-MATH-TERMS?", 2, 1, false);
        declareFunction(me, "like_math_terms_listsP", "LIKE-MATH-TERMS-LISTS?", 2, 1, false);
        declareFunction(me, "why_like_math_terms_listsP", "WHY-LIKE-MATH-TERMS-LISTS?", 2, 1, false);
        declareFunction(me, "simplify_math_expression_multiplication_term_for_like_terms", "SIMPLIFY-MATH-EXPRESSION-MULTIPLICATION-TERM-FOR-LIKE-TERMS", 1, 0, false);
        declareFunction(me, "test_removal_likemathterms_expand", "TEST-REMOVAL-LIKEMATHTERMS-EXPAND", 1, 2, false);
        declareFunction(me, "removal_unlikemathterms_expand", "REMOVAL-UNLIKEMATHTERMS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_simplifiablemathexpression_expand", "REMOVAL-SIMPLIFIABLEMATHEXPRESSION-EXPAND", 1, 1, false);
        declareFunction(me, "removal_unsimplifiablemathexpression_expand", "REMOVAL-UNSIMPLIFIABLEMATHEXPRESSION-EXPAND", 1, 1, false);
        declareFunction(me, "unsimplifiable_math_expressionP", "UNSIMPLIFIABLE-MATH-EXPRESSION?", 1, 0, false);
        declareFunction(me, "like_math_terms_for_simplificationP", "LIKE-MATH-TERMS-FOR-SIMPLIFICATION?", 2, 0, false);
        declareFunction(me, "test_removal_unsimplifiablemathexpression_expand", "TEST-REMOVAL-UNSIMPLIFIABLEMATHEXPRESSION-EXPAND", 1, 2, false);
        declareFunction(me, "test_removal_simplifiablemathexpression_expand", "TEST-REMOVAL-SIMPLIFIABLEMATHEXPRESSION-EXPAND", 1, 2, false);
        declareFunction(me, "math_equals_statementP", "MATH-EQUALS-STATEMENT?", 1, 0, false);
        declareFunction(me, "math_equation_univariate_linearP", "MATH-EQUATION-UNIVARIATE-LINEAR?", 1, 0, false);
        declareFunction(me, "math_expression_univariate_linearP", "MATH-EXPRESSION-UNIVARIATE-LINEAR?", 1, 0, false);
        declareFunction(me, "removal_comparablemathterms_expand", "REMOVAL-COMPARABLEMATHTERMS-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_comparablemathterms_expand", "TEST-REMOVAL-COMPARABLEMATHTERMS-EXPAND", 1, 2, false);
        declareFunction(me, "removal_likemathtermsonoppositesides_expand", "REMOVAL-LIKEMATHTERMSONOPPOSITESIDES-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_likemathtermsonoppositesides_expand", "TEST-REMOVAL-LIKEMATHTERMSONOPPOSITESIDES-EXPAND", 1, 2, false);
        declareFunction(me, "apply_operation_to_math_statement", "APPLY-OPERATION-TO-MATH-STATEMENT", 3, 0, false);
        declareFunction(me, "apply_operation_to_math_expression", "APPLY-OPERATION-TO-MATH-EXPRESSION", 3, 0, false);
        declareFunction(me, "test_apply_operation_to_math_statement", "TEST-APPLY-OPERATION-TO-MATH-STATEMENT", 1, 0, false);
        declareFunction(me, "removal_besttermtoremovevia_expand", "REMOVAL-BESTTERMTOREMOVEVIA-EXPAND", 1, 1, false);
        declareFunction(me, "math_statement_best_term_to_remove", "MATH-STATEMENT-BEST-TERM-TO-REMOVE", 1, 0, false);
        declareFunction(me, "math_statement_best_term_to_remove_int", "MATH-STATEMENT-BEST-TERM-TO-REMOVE-INT", 1, 0, false);
        declareFunction(me, "math_expression_best_term_to_remove", "MATH-EXPRESSION-BEST-TERM-TO-REMOVE", 1, 0, false);
        declareFunction(me, "possibly_denegate_math_expression", "POSSIBLY-DENEGATE-MATH-EXPRESSION", 1, 1, false);
        declareFunction(me, "possibly_negate_math_quant_fn", "POSSIBLY-NEGATE-MATH-QUANT-FN", 1, 0, false);
        declareFunction(me, "test_removal_besttermtoremovevia_expand", "TEST-REMOVAL-BESTTERMTOREMOVEVIA-EXPAND", 1, 2, false);
        declareFunction(me, "removal_possibletermstoremovevia_expand", "REMOVAL-POSSIBLETERMSTOREMOVEVIA-EXPAND", 1, 1, false);
        declareFunction(me, "math_statement_terms_to_remove", "MATH-STATEMENT-TERMS-TO-REMOVE", 1, 0, false);
        declareFunction(me, "math_expression_terms_to_remove", "MATH-EXPRESSION-TERMS-TO-REMOVE", 1, 1, false);
        declareFunction(me, "test_removal_possibletermstoremovevia_expand", "TEST-REMOVAL-POSSIBLETERMSTOREMOVEVIA-EXPAND", 1, 2, false);
        declareFunction(me, "removal_mathtermcoefficient_expand", "REMOVAL-MATHTERMCOEFFICIENT-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_mathtermcoefficient_expand", "TEST-REMOVAL-MATHTERMCOEFFICIENT-EXPAND", 1, 2, false);
        declareFunction(me, "removal_mathtermvariablewithdegree_expand", "REMOVAL-MATHTERMVARIABLEWITHDEGREE-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_variables_and_degrees", "MATH-EXPRESSION-VARIABLES-AND-DEGREES", 1, 0, false);
        declareFunction(me, "test_removal_mathtermvariablewithdegree_expand", "TEST-REMOVAL-MATHTERMVARIABLEWITHDEGREE-EXPAND", 1, 2, false);
        declareFunction(me, "removal_mathtermdegree_expand", "REMOVAL-MATHTERMDEGREE-EXPAND", 1, 1, false);
        declareFunction(me, "math_expression_degree", "MATH-EXPRESSION-DEGREE", 1, 0, false);
        declareFunction(me, "test_removal_mathtermdegree_expand", "TEST-REMOVAL-MATHTERMDEGREE-EXPAND", 1, 2, false);
        declareFunction(me, "removal_commonprimefactorlist_expand", "REMOVAL-COMMONPRIMEFACTORLIST-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_commonprimefactorlist_expand", "TEST-REMOVAL-COMMONPRIMEFACTORLIST-EXPAND", 1, 2, false);
        declareFunction(me, "removal_simplifiablefraction_expand", "REMOVAL-SIMPLIFIABLEFRACTION-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_simplifiablefraction_expand", "TEST-REMOVAL-SIMPLIFIABLEFRACTION-EXPAND", 1, 2, false);
        declareFunction(me, "removal_mathexpressionoperandlist_expand", "REMOVAL-MATHEXPRESSIONOPERANDLIST-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_mathexpressionoperandlist_expand", "TEST-REMOVAL-MATHEXPRESSIONOPERANDLIST-EXPAND", 1, 2, false);
        declareFunction(me, "like_fractions_or_non_fractional_math_termsP", "LIKE-FRACTIONS-OR-NON-FRACTIONAL-MATH-TERMS?", 2, 0, false);
        declareFunction(me, "removal_associateliketerms_expand", "REMOVAL-ASSOCIATELIKETERMS-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_associateliketerms_expand", "TEST-REMOVAL-ASSOCIATELIKETERMS-EXPAND", 1, 2, false);
        declareFunction(me, "math_term_type_fractionP", "MATH-TERM-TYPE-FRACTION?", 1, 0, false);
        declareFunction(me, "math_term_type_L", "MATH-TERM-TYPE-<", 2, 0, false);
        declareFunction(me, "math_term_type_internal", "MATH-TERM-TYPE-INTERNAL", 1, 0, false);
        declareFunction(me, "math_term_type", "MATH-TERM-TYPE", 1, 0, false);
        declareFunction(me, "math_term_L_compare_values", "MATH-TERM-<-COMPARE-VALUES", 2, 0, false);
        declareFunction(me, "math_term_L", "MATH-TERM-<", 2, 1, false);
        declareFunction(me, "group_and_sort_like_math_terms", "GROUP-AND-SORT-LIKE-MATH-TERMS", 1, 0, false);
        declareFunction(me, "group_like_math_terms", "GROUP-LIKE-MATH-TERMS", 1, 0, false);
        declareFunction(me, "removal_expressionreorderedtogroupliketerms_expand", "REMOVAL-EXPRESSIONREORDEREDTOGROUPLIKETERMS-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_expressionreorderedtogroupliketerms_expand", "TEST-REMOVAL-EXPRESSIONREORDEREDTOGROUPLIKETERMS-EXPAND", 1, 2, false);
        declareFunction(me, "removal_expressionhasnonadjacentliketermsasoperands_expand", "REMOVAL-EXPRESSIONHASNONADJACENTLIKETERMSASOPERANDS-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_expressionhasnonadjacentliketermsasoperands_expand", "TEST-REMOVAL-EXPRESSIONHASNONADJACENTLIKETERMSASOPERANDS-EXPAND", 1, 2, false);
        declareFunction(me, "strong_math_term_L", "STRONG-MATH-TERM-<", 2, 0, false);
        declareFunction(me, "sort_math_terms", "SORT-MATH-TERMS", 1, 0, false);
        declareFunction(me, "removal_expressionreorderedinascendingorder_expand", "REMOVAL-EXPRESSIONREORDEREDINASCENDINGORDER-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_expressionreorderedinascendingorder_expand", "TEST-REMOVAL-EXPRESSIONREORDEREDINASCENDINGORDER-EXPAND", 1, 2, false);
        declareFunction(me, "removal_bestsubexpressiontoevaluate_expand", "REMOVAL-BESTSUBEXPRESSIONTOEVALUATE-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_bestsubexpressiontoevaluate_expand", "TEST-REMOVAL-BESTSUBEXPRESSIONTOEVALUATE-EXPAND", 1, 2, false);
        declareFunction(me, "math_expression_to_prefix_format", "MATH-EXPRESSION-TO-PREFIX-FORMAT", 1, 0, false);
        declareFunction(me, "infix_math_expression_to_prefix_format", "INFIX-MATH-EXPRESSION-TO-PREFIX-FORMAT", 1, 0, false);
        declareFunction(me, "infix_math_expression_main_operator", "INFIX-MATH-EXPRESSION-MAIN-OPERATOR", 1, 0, false);
        declareFunction(me, "really_big_number_for_fractionP", "REALLY-BIG-NUMBER-FOR-FRACTION?", 1, 0, false);
        declareFunction(me, "fraction_to_el", "FRACTION-TO-EL", 1, 0, false);
        declareFunction(me, "fraction_from_el", "FRACTION-FROM-EL", 1, 0, false);
        declareFunction(me, "removal_mathexpressionnthoperand_expand", "REMOVAL-MATHEXPRESSIONNTHOPERAND-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_mathexpressionnthoperand_expand", "TEST-REMOVAL-MATHEXPRESSIONNTHOPERAND-EXPAND", 1, 2, false);
        declareFunction(me, "removal_orderedlistofdirectsubexpressionswithoperandcount_expand", "REMOVAL-ORDEREDLISTOFDIRECTSUBEXPRESSIONSWITHOPERANDCOUNT-EXPAND", 1, 1, false);
        declareFunction(me, "sub_math_expressions_direct_ordered_by_appearance", "SUB-MATH-EXPRESSIONS-DIRECT-ORDERED-BY-APPEARANCE", 2, 0, false);
        declareFunction(me, "test_removal_orderedlistofdirectsubexpressionswithoperandcount_expand", "TEST-REMOVAL-ORDEREDLISTOFDIRECTSUBEXPRESSIONSWITHOPERANDCOUNT-EXPAND", 1, 2, false);
        declareFunction(me, "math_expression_flatten", "MATH-EXPRESSION-FLATTEN", 1, 0, false);
        declareFunction(me, "math_expression_flatten_int", "MATH-EXPRESSION-FLATTEN-INT", 1, 1, false);
        return NIL;
    }
