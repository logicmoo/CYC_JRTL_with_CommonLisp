...
public final class integer_sequence_generator extends SubLTranslatedFile {
    ...
    public static SubLObject integer_sequence_generator_p(final SubLObject v_object) {
        return v_object.getClass() == integer_sequence_generator.$integer_sequence_generator_native.class ? T : NIL;
    }

    public static SubLObject isg_lock(final SubLObject v_object) {
        assert NIL != integer_sequence_generator_p(v_object) : "integer_sequence_generator.integer_sequence_generator_p(v_object) " + "CommonSymbols.NIL != integer_sequence_generator.integer_sequence_generator_p(v_object) " + v_object;
    ...
    public static SubLObject make_integer_sequence_generator(SubLObject arglist) {
        ...
        final SubLObject v_new = new integer_sequence_generator.$integer_sequence_generator_native();
        SubLObject next;
    ...
    public static final class $integer_sequence_generator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(integer_sequence_generator.$integer_sequence_generator_native.class, INTEGER_SEQUENCE_GENERATOR, INTEGER_SEQUENCE_GENERATOR_P, $list2, $list3, new String[]{ "$lock", "$current", "$start", "$limit", "$delta" }, $list4, $list5, PRINT_INTEGER_SEQUENCE_GENERATOR);
        }
    }
