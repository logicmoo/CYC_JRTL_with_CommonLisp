...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class cae_query_search extends SubLTranslatedFile {
    ...
    public static SubLObject justified_interpretation_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$justified_interpretation_native.class ? T : NIL;
    }

    public static SubLObject ji_cycl(final SubLObject v_object) {
        assert NIL != justified_interpretation_p(v_object) : "cae_query_search.justified_interpretation_p error :" + v_object;
    ...
    public static SubLObject make_justified_interpretation(SubLObject arglist) {
        ...
        final SubLObject v_new = new $justified_interpretation_native();
        SubLObject next;
    ...
    public static SubLObject term_record_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$term_record_native.class ? T : NIL;
    }

    public static SubLObject term_record_term(final SubLObject v_object) {
        assert NIL != term_record_p(v_object) : "cae_query_search.term_record_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_term_record(SubLObject arglist) {
        ...
        final SubLObject v_new = new $term_record_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject token_record_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$token_record_native.class ? T : NIL;
    }

    public static SubLObject tr_string(final SubLObject v_object) {
        assert NIL != token_record_p(v_object) : "cae_query_search.token_record_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_token_record(SubLObject arglist) {
        ...
        final SubLObject v_new = new $token_record_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $justified_interpretation_native extends SubLStructNative {
        ...
        private $justified_interpretation_native() {
            this.$cycl = Lisp.NIL;
            this.$words = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative($justified_interpretation_native.class, JUSTIFIED_INTERPRETATION, JUSTIFIED_INTERPRETATION_P, $list436, $list437, new String[]{ "$cycl", "$words", "$arg_records" }, $list438, $list439, JI_PRINT);
        }
    }
    ...
    public static final class $term_record_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($term_record_native.class, TERM_RECORD, TERM_RECORD_P, $list470, $list471, new String[]{ "$term", "$word", "$literal" }, $list472, $list473, TERM_RECORD_PRINT);
        }
    }
    ...
    public static final class $token_record_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($token_record_native.class, TOKEN_RECORD, TOKEN_RECORD_P, $list579, $list580, new String[]{ "$string", "$denotations", "$offset", "$end" }, $list581, $list582, PRINT_TOKEN_RECORD);
        }
    }
