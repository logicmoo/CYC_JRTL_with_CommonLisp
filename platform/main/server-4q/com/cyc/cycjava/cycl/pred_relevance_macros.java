...
public final class pred_relevance_macros extends SubLTranslatedFile {
    ...
    public static SubLObject pred_info_object_p(final SubLObject v_object) {
        return v_object.getClass() == pred_relevance_macros.$pred_info_object_native.class ? T : NIL;
    }

    public static SubLObject pred_info_pred(final SubLObject v_object) {
        assert NIL != pred_info_object_p(v_object) : "pred_relevance_macros.pred_info_object_p(v_object) " + "CommonSymbols.NIL != pred_relevance_macros.pred_info_object_p(v_object) " + v_object;
    ...
    public static SubLObject make_pred_info_object(SubLObject arglist) {
        ...
        final SubLObject v_new = new pred_relevance_macros.$pred_info_object_native();
        SubLObject next;
    ...
    public static final class $pred_info_object_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(pred_relevance_macros.$pred_info_object_native.class, PRED_INFO_OBJECT, PRED_INFO_OBJECT_P, $list54, $list55, new String[]{ "$pred", "$relevance_function" }, $list56, $list57, PRINT_PRED_INFO_OBJECT);
        }
    }
