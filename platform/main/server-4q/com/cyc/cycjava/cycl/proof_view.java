...
import static com.cyc.cycjava.cycl.proof_view.*;
...
public final class proof_view extends SubLTranslatedFile {
    ...
    public static SubLObject proof_view_p(final SubLObject v_object) {
        return v_object.getClass() == proof_view.$proof_view_native.class ? T : NIL;
    }

    public static SubLObject proof_view_int_id(final SubLObject v_object) {
        assert NIL != proof_view_p(v_object) : "proof_view.proof_view_p(v_object) " + "CommonSymbols.NIL != proof_view.proof_view_p(v_object) " + v_object;
    ...
    public static SubLObject make_proof_view(SubLObject arglist) {
        ...
        final SubLObject v_new = new proof_view.$proof_view_native();
        SubLObject next;
    ...
    public static SubLObject proof_view_entry_p(final SubLObject v_object) {
        return v_object.getClass() == proof_view.$proof_view_entry_native.class ? T : NIL;
    }

    public static SubLObject proof_view_entry_int_id(final SubLObject v_object) {
        assert NIL != proof_view_entry_p(v_object) : "proof_view.proof_view_entry_p(v_object) " + "CommonSymbols.NIL != proof_view.proof_view_entry_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_proof_view_entry(SubLObject arglist) {
        ...
        final SubLObject v_new = new proof_view.$proof_view_entry_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $proof_view_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(proof_view.$proof_view_native.class, PROOF_VIEW, PROOF_VIEW_P, $list17, $list18, new String[]{ "$id", "$proof", "$answer", "$id_index", "$properties" }, $list19, $list20, PROOF_VIEW_INT_PRINT);
        }
    }
    ...
    public static final class $proof_view_entry_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(proof_view.$proof_view_entry_native.class, PROOF_VIEW_ENTRY, PROOF_VIEW_ENTRY_P, $list167, $list168, new String[]{ "$id", "$parent_id", "$label", "$object_type", "$object", "$proof_view", "$properties" }, $list169, $list170, PROOF_VIEW_ENTRY_INT_PRINT);
        }
    }
