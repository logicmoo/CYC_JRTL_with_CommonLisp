...
import static com.cyc.cycjava.cycl.encapsulation.*;
...
public final class encapsulation extends SubLTranslatedFile {
    ...
    public static final SubLSymbol ENCAPSULATE_CONS_METHOD = makeSymbol("ENCAPSULATE-CONS-METHOD");

    public static final SubLSymbol ENCAPSULATE_CONSTANT_METHOD = makeSymbol("ENCAPSULATE-CONSTANT-METHOD");

    public static final SubLSymbol ENCAPSULATE_NART_METHOD = makeSymbol("ENCAPSULATE-NART-METHOD");
    ...
    public static final SubLList $list11 = list(makeSymbol("HP"), makeSymbol("NAME-SPEC"), makeSymbol("EXTERNAL-ID"));
    ...
    public static SubLObject declare_encapsulation_file() {
        declareFunction(me, "encapsulate", "ENCAPSULATE", 1, 0, false);
        declareFunction(me, "encapsulate_cons_method", "ENCAPSULATE-CONS-METHOD", 1, 0, false);
        declareFunction(me, "encapsulate_constant_method", "ENCAPSULATE-CONSTANT-METHOD", 1, 0, false);
        declareFunction(me, "encapsulate_nart_method", "ENCAPSULATE-NART-METHOD", 1, 0, false);
        declareFunction(me, "encapsulate_constant", "ENCAPSULATE-CONSTANT", 1, 0, false);
        declareFunction(me, "encapsulate_nart", "ENCAPSULATE-NART", 1, 0, false);
        declareFunction(me, "encapsulate_constant_internal", "ENCAPSULATE-CONSTANT-INTERNAL", 1, 0, false);
        declareFunction(me, "encapsulate_nart_internal", "ENCAPSULATE-NART-INTERNAL", 1, 0, false);
        declareFunction(me, "unencapsulate", "UNENCAPSULATE", 1, 0, false);
        declareFunction(me, "unencapsulate_partial", "UNENCAPSULATE-PARTIAL", 1, 0, false);
        declareFunction(me, "unencapsulate_internal", "UNENCAPSULATE-INTERNAL", 2, 0, false);
        declareFunction(me, "unencapsulate_token_equal_p", "UNENCAPSULATE-TOKEN-EQUAL-P", 2, 0, false);
        declareFunction(me, "unencapsulate_cons", "UNENCAPSULATE-CONS", 2, 0, false);
        declareFunction(me, "unencapsulate_constant_marker", "UNENCAPSULATE-CONSTANT-MARKER", 2, 0, false);
        declareFunction(me, "unencapsulate_constant_marker_int", "UNENCAPSULATE-CONSTANT-MARKER-INT", 2, 0, false);
        declareFunction(me, "unencapsulate_find_constant", "UNENCAPSULATE-FIND-CONSTANT", 1, 0, false);
        declareFunction(me, "unencapsulate_nart_marker", "UNENCAPSULATE-NART-MARKER", 2, 0, false);
        declareFunction(me, "handle_unencapsulate_constant_problem", "HANDLE-UNENCAPSULATE-CONSTANT-PROBLEM", 2, 0, false);
        declareFunction(me, "handle_unencapsulate_unnamed_constant_problem", "HANDLE-UNENCAPSULATE-UNNAMED-CONSTANT-PROBLEM", 2, 0, false);
        declareFunction(me, "handle_unencapsulate_nart_problem", "HANDLE-UNENCAPSULATE-NART-PROBLEM", 2, 0, false);
        declareFunction(me, "handle_unencapsulation_error", "HANDLE-UNENCAPSULATION-ERROR", 1, 0, false);
        return NIL;
    }
