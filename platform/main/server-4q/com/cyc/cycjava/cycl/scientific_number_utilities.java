...
public final class scientific_number_utilities
    extends
      SubLTranslatedFile
{
  ...
  {
    assert NIL != scientific_numbers.scientific_number_p( sci_num ) : sci_num;
  ...
  public static SubLObject scientific_number_negate(final SubLObject sci_num)
  {
    ...
    final SubLObject significand = scientific_numbers.scientific_number_significand( sci_num );
    final SubLObject exponent = scientific_numbers.scientific_number_exponent( sci_num );
    return scientific_numbers.new_scientific_number( Numbers.multiply( MINUS_ONE_INTEGER, significand ), exponent );
  }
  ...
  public static SubLObject scientific_number_integer_part(final SubLObject sci_num)
  {
    ...
    final SubLObject division_exponent = Numbers.subtract( sig_length, exponent, ONE_INTEGER );
    ...
    {
      return Numbers.multiply( significand, Numbers.expt( TEN_INTEGER, Numbers.minus( division_exponent ) ) );
    }
    return Numbers.integerDivide( significand, Numbers.expt( TEN_INTEGER, division_exponent ) );
  }
  ...
  {
    assert NIL != scientific_numbers.scientific_number_p( sci_num ) : sci_num;
    assert NIL != subl_promotions.positive_integer_p( digits ) : digits;
    final SubLObject significand = scientific_numbers.scientific_number_significand( sci_num );
    ...
    {
      new_significand = Numbers.integerDivide( new_significand, Numbers.expt( TEN_INTEGER, division_exponent ) );
    }
  ...
  {
    assert NIL != scientific_numbers.scientific_number_p( sci_num0 ) : sci_num0;
    assert NIL != scientific_numbers.scientific_number_p( sci_num1 ) : sci_num1;
  ...
  {
    return Numbers.max( ONE_INTEGER, ( NIL != scientific_numbers.scientific_number_p( ex_num ) ) ? Numbers.min( scientific_numbers.scientific_number_significant_digit_count( sci_num ), scientific_numbers
        .scientific_number_significant_digit_count( ex_num ) )
        : ( ex_num.isInteger() ? scientific_numbers.scientific_number_significant_digit_count( sci_num )
            : ( ex_num.isNumber() ? Numbers.min( scientific_numbers.scientific_number_significant_digit_count( sci_num ), scientific_numbers.scientific_number_significant_digit_count( scientific_numbers
                .scientific_number_from_subl_real( ex_num, UNPROVIDED ) ) ) : scientific_numbers.scientific_number_significant_digit_count( sci_num ) ) ) );
  }
  ...
  public static SubLObject scientific_numberE(final SubLObject sci_num0, final SubLObject sci_num1, SubLObject digits)
  {
    ...
    if( ( ZERO_INTEGER.numE( significand0 ) || digits.numGE( number_utilities.decimal_integer_length( significand0 ) ) ) && ( ZERO_INTEGER.numE( significand2 ) || digits.numGE( number_utilities.decimal_integer_length(
        significand2 ) ) ) )
    {
      return Numbers.numE( significand0, significand2 );
    }
  ...
  public static SubLObject scientific_numberG(final SubLObject sci_num0, final SubLObject sci_num1, SubLObject digits)
  {
    ...
    final SubLObject significand2 = scientific_numbers.scientific_number_significand( new_sci_num2 );
    final SubLObject exponent2 = scientific_numbers.scientific_number_exponent( new_sci_num2 );
    if( ( !ZERO_INTEGER.numE( significand0 ) && !digits.numLE( number_utilities.decimal_integer_length( significand0 ) ) ) || ( !ZERO_INTEGER.numE( significand2 ) && !digits.numLE( number_utilities
        .decimal_integer_length( significand2 ) ) ) )
    {
      return NIL;
    }
  ...
  public static SubLObject scientific_number_times(final SubLObject sci_num0, final SubLObject sci_num1)
  {
    ...
    final SubLObject new_exponent = Numbers.subtract( new_sig_length, new SubLObject[] { Numbers.subtract( sig_length0, exponent0, ONE_INTEGER ), Numbers.subtract( sig_length2, exponent2, ONE_INTEGER ), ONE_INTEGER
    } );
  ...
  public static SubLObject scientific_number_inverse(final SubLObject sci_num)
  {
    ...
    return scientific_numbers.scientific_number_from_subl_real( Numbers.divide( ONE_INTEGER, real_num ), sig_digits );
  }
  ...
  public static SubLObject scientific_number_plus_different_exponents(final SubLObject sci_num_large, final SubLObject exponent_large, final SubLObject sci_num_small, final SubLObject exponent_small)
  {
    ...
    final SubLObject guarded_significand_large = Numbers.multiply( TEN_INTEGER, significand_large );
    ...
    final SubLObject new_sig_digits = Numbers.min( Numbers.subtract( sig_digits_large, ONE_INTEGER ), Numbers.add( sig_digits_small, exponent_diff ) );
    final SubLObject sum_length = number_utilities.decimal_integer_length( sum );
    ...
    final SubLObject initial_result = almost_final_sig_digits.numG( ZERO_INTEGER ) ? scientific_numbers.new_scientific_number( sum, new_exponent )
        : scientific_numbers.new_scientific_number( number_utilities.significant_digits( Numbers.integerDivide( sum, TEN_INTEGER ), ONE_INTEGER ), Numbers.add( new_exponent, ONE_INTEGER ) );
  ...
  public static SubLObject scientific_number_log(final SubLObject sci_num, SubLObject base)
  {
    ...
    assert NIL != extended_numbers.extended_number_p( base ) : base;
    assert NIL != scientific_numbers.scientific_number_p( sci_num ) : sci_num;
  ...
  public static SubLObject scientific_number_log10(final SubLObject sci_num)
  {
    ...
    final SubLObject sig_digits = scientific_numbers.cyc_scientific_number_significant_digit_count( sci_num );
    final SubLObject new_significand = Numbers.log( Numbers.divide( significand, Numbers.expt( TEN_INTEGER, Numbers.subtract( sig_digits, ONE_INTEGER ) ) ), TEN_INTEGER );
  ...
  public static SubLObject scientific_number_sqrt(final SubLObject sci_num)
  {
    ...
    final SubLObject new_exponent = Numbers.floor( Numbers.divide( old_exponent, TWO_INTEGER ), UNPROVIDED );
    final SubLObject old_significand = scientific_numbers.scientific_number_significand( sci_num );
    final SubLObject old_significand_float = old_significand.isZero() ? ZERO_INTEGER
        : Numbers.divide( old_significand, Numbers.expt( TEN_INTEGER, Numbers.truncate( Numbers.log( Numbers.abs( old_significand ), TEN_INTEGER ), UNPROVIDED ) ) );
    final SubLObject new_significand_square = ( NIL != Numbers.oddp( old_exponent ) ) ? Numbers.multiply( TEN_INTEGER, old_significand_float ) : old_significand_float;
    final SubLObject new_significand_float = new_significand_square.isZero() ? ZERO_INTEGER : number_utilities.significant_digits( Numbers.sqrt( new_significand_square ), sig_digits );
    final SubLObject new_significand = reader.read_from_string( Sequences.remove( Characters.CHAR_period, print_high.princ_to_string( new_significand_float ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ),
  ...
  public static SubLObject scientific_number_expt10(final SubLObject sci_num)
  {
    ...
    final SubLObject exponent = scientific_numbers.scientific_number_exponent( sci_num );
    final SubLObject real_sci_num = scientific_numbers.cyc_scientific_number_to_subl_real( sci_num );
    final SubLObject new_num = Numbers.expt( TEN_INTEGER, real_sci_num );
    final SubLObject new_sig_digits = Numbers.max( Numbers.subtract( sig_digits, exponent, ONE_INTEGER ), ONE_INTEGER );
  ...
  {
    SubLFiles.declareFunction( me, "scientific_number_abs", "SCIENTIFIC-NUMBER-ABS", 1, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_negate", "SCIENTIFIC-NUMBER-NEGATE", 1, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_integer_part", "SCIENTIFIC-NUMBER-INTEGER-PART", 1, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_significant_digits", "SCIENTIFIC-NUMBER-SIGNIFICANT-DIGITS", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_eql", "SCIENTIFIC-NUMBER-EQL", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_comparison_significant_digits", "SCIENTIFIC-NUMBER-COMPARISON-SIGNIFICANT-DIGITS", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_numberE", "SCIENTIFIC-NUMBER=", 2, 1, false );
    SubLFiles.declareFunction( me, "scientific_number_integerE", "SCIENTIFIC-NUMBER-INTEGER=", 2, 1, false );
    SubLFiles.declareFunction( me, "integer_scientific_numberE", "INTEGER-SCIENTIFIC-NUMBER=", 2, 1, false );
    SubLFiles.declareFunction( me, "scientific_numberG", "SCIENTIFIC-NUMBER>", 2, 1, false );
    SubLFiles.declareFunction( me, "scientific_number_integerG", "SCIENTIFIC-NUMBER-INTEGER>", 2, 1, false );
    SubLFiles.declareFunction( me, "integer_scientific_numberG", "INTEGER-SCIENTIFIC-NUMBER>", 2, 1, false );
    SubLFiles.declareFunction( me, "scientific_numberGE", "SCIENTIFIC-NUMBER>=", 2, 1, false );
    SubLFiles.declareFunction( me, "scientific_number_integerGE", "SCIENTIFIC-NUMBER-INTEGER>=", 2, 1, false );
    SubLFiles.declareFunction( me, "integer_scientific_numberGE", "INTEGER-SCIENTIFIC-NUMBER>=", 2, 1, false );
    SubLFiles.declareFunction( me, "scientific_numberL", "SCIENTIFIC-NUMBER<", 2, 1, false );
    SubLFiles.declareFunction( me, "scientific_number_integerL", "SCIENTIFIC-NUMBER-INTEGER<", 2, 1, false );
    SubLFiles.declareFunction( me, "integer_scientific_numberL", "INTEGER-SCIENTIFIC-NUMBER<", 2, 1, false );
    SubLFiles.declareFunction( me, "scientific_numberLE", "SCIENTIFIC-NUMBER<=", 2, 1, false );
    SubLFiles.declareFunction( me, "scientific_number_integerLE", "SCIENTIFIC-NUMBER-INTEGER<=", 2, 1, false );
    SubLFiles.declareFunction( me, "integer_scientific_numberLE", "INTEGER-SCIENTIFIC-NUMBER<=", 2, 1, false );
    SubLFiles.declareFunction( me, "scientific_number_times", "SCIENTIFIC-NUMBER-TIMES", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_integer_times", "SCIENTIFIC-NUMBER-INTEGER-TIMES", 2, 0, false );
    SubLFiles.declareFunction( me, "integer_scientific_number_times", "INTEGER-SCIENTIFIC-NUMBER-TIMES", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_inverse", "SCIENTIFIC-NUMBER-INVERSE", 1, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_quotient", "SCIENTIFIC-NUMBER-QUOTIENT", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_integer_quotient", "SCIENTIFIC-NUMBER-INTEGER-QUOTIENT", 2, 0, false );
    SubLFiles.declareFunction( me, "integer_scientific_number_quotient", "INTEGER-SCIENTIFIC-NUMBER-QUOTIENT", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_plus", "SCIENTIFIC-NUMBER-PLUS", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_plus_same_exponent", "SCIENTIFIC-NUMBER-PLUS-SAME-EXPONENT", 3, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_plus_different_exponents", "SCIENTIFIC-NUMBER-PLUS-DIFFERENT-EXPONENTS", 4, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_minus", "SCIENTIFIC-NUMBER-MINUS", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_log", "SCIENTIFIC-NUMBER-LOG", 1, 1, false );
    SubLFiles.declareFunction( me, "scientific_number_log10", "SCIENTIFIC-NUMBER-LOG10", 1, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_antilog", "SCIENTIFIC-NUMBER-ANTILOG", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_antilog10", "SCIENTIFIC-NUMBER-ANTILOG10", 1, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_sqrt", "SCIENTIFIC-NUMBER-SQRT", 1, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_expt10", "SCIENTIFIC-NUMBER-EXPT10", 1, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_expt", "SCIENTIFIC-NUMBER-EXPT", 2, 0, false );
    SubLFiles.declareFunction( me, "scientific_number_exp", "SCIENTIFIC-NUMBER-EXP", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_scientific_number_utilities_file()
  {
    $scientific_number_e$ = SubLFiles.defconstant( "*SCIENTIFIC-NUMBER-E*", $list3 );
    return NIL;
  }
  ...
  static
  {
    me = new scientific_number_utilities();
    $scientific_number_e$ = null;
    $sym0$SCIENTIFIC_NUMBER_P = makeSymbol( "SCIENTIFIC-NUMBER-P" );
    $sym1$POSITIVE_INTEGER_P = makeSymbol( "POSITIVE-INTEGER-P" );
    $sym2$INTEGERP = makeSymbol( "INTEGERP" );
    $list3 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ScientificNumberFn" ) ), makeInteger( "2718281828459045" ), ZERO_INTEGER );
    $sym4$EXTENDED_NUMBER_P = makeSymbol( "EXTENDED-NUMBER-P" );
  }
}
/*
 * 
