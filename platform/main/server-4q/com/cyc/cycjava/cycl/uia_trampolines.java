...
public final class uia_trampolines extends SubLTranslatedFile implements V02 {
                ...
                for (permutation = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , permutation = cdolist_list_var.first()) {
                    {
                        ...
                        for (index = permutation, index_1 = index.first(), candidate_terms = candidate_terms_list, candidate_terms_2 = candidate_terms.first(), arg_position = arg_positions, arg_position_3 = arg_position.first(); !(((NIL == arg_position) && (NIL == candidate_terms)) && (NIL == index)); index = index.rest() , index_1 = index.first() , candidate_terms = candidate_terms.rest() , candidate_terms_2 = candidate_terms.first() , arg_position = arg_position.rest() , arg_position_3 = arg_position.first()) {
                            {
    ...
    public static final SubLObject uia_paraphrase_constraint_for_term_memoized_internal(SubLObject v_term, SubLObject mt) {
        {
            ...
            if (NIL != uia_term_with_paraphrase_constraint_p(v_term)) {
                ...
                if (NIL != constant_handles.constant_p(check_pred)) {
                    {
            ...
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                SubLObject result = NIL;
                {
                    ...
                    try {
                        ...
                        result = pph_methods_lexicon.all_phrases_for_term(v_term, list(pred), abbrev_type, $HTML, UNPROVIDED, UNPROVIDED, UNPROVIDED);
                    } finally {
        ...
        }
        {
            ...
            }
            {
                ...
                if (NIL == terms) {
                    ...
                    if (NIL != bindings.unification_success_token_p(terms)) {
    ...
    public static final SubLObject uia_meta_supports(SubLObject support) {
        if (NIL != assertion_handles.assertion_p(support)) {
            ...
            if (NIL != not_isa_supportP(support)) {
                    ...
                    for (raw_support = csome_list_var.first(); !((NIL != abortP) || (NIL == csome_list_var)); csome_list_var = csome_list_var.rest() , raw_support = csome_list_var.first()) {
                        if ((NIL == new_supports) && (!(((NIL != assertion_handles.assertion_p(raw_support)) && (NIL != isa_supportP(raw_support))) && assertions_high.gaf_arg1(raw_support).equal(focus_term)))) {
                            ...
                            if (NIL == new_supports) {
                                ...
                                if (((NIL != genls_supportP(raw_support)) && (NIL != assertion_handles.assertion_p(raw_support))) && assertions_high.gaf_arg1(raw_support).equal(curr_genl)) {
                                    curr_genl = assertions_high.gaf_arg2(raw_support);
                                } else {
                                    abortP = T;
                                }
                                    ...
                                    for (meta_support = csome_list_var.first(); !((NIL != failP) || (NIL == csome_list_var)); csome_list_var = csome_list_var.rest() , meta_support = csome_list_var.first()) {
                                        {
                                            ...
                                            if (((NIL == genl1_sentence) && (NIL != el_utilities.el_formula_with_operator_p(meta_support_sentence, $$genls))) && cycl_utilities.formula_arg1(meta_support_sentence, UNPROVIDED).equal(genl1)) {
                                                ...
                                                if (((NIL == disjoint_with_sentence) && (!col1.equal(genl1))) && (NIL != el_utilities.el_formula_with_operator_p(meta_support_sentence, $$disjointWith))) {
                                                    genl1_sentence = el_utilities.make_binary_formula($$genls, col1, genl1);
                                                    disjoint_with_sentence = meta_support_sentence;
                                                } else
                                                    if (((((NIL == genl2_sentence) && (NIL != genl2)) && (NIL != el_utilities.el_formula_with_operator_p(meta_support_sentence, $$genls))) && cycl_utilities.formula_arg1(meta_support_sentence, UNPROVIDED).equal(col2)) && cycl_utilities.formula_arg2(meta_support_sentence, UNPROVIDED).equal(mid_genl2)) {
                                                        genl2_sentence = el_utilities.make_binary_formula($$genls, col2, genl2);
                                                    } else
                                                        if ((NIL == genl2) && (NIL != el_utilities.el_formula_with_operator_p(meta_support_sentence, $$genls))) {
                                                            ...
                                                            if ((NIL != el_utilities.el_formula_with_operator_p(meta_support_sentence, $$genls)) && cycl_utilities.formula_arg2(meta_support_sentence, UNPROVIDED).equal(mid_genl2)) {
                                                                mid_genl2 = cycl_utilities.formula_arg1(meta_support_sentence, UNPROVIDED);
                                                            } else {
                                                                failP = T;
                                                            }
        ...
        }
        {
            ...
            for (to_term = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , to_term = cdolist_list_var.first()) {
                if (NIL != uia_irrelevant_term_memoizedP(to_term, domain_mt)) {
                    ...
                    if (NIL != uia_irrelevant_precision_suggestion_term_memoizedP(to_term, domain_mt)) {
                        if (NIL != keep_irrelevantP) {
                            irrelevant = cons(to_term, irrelevant);
                        }
                    } else {
    ...
    public static final SubLObject uia_collectionP(SubLObject interaction, SubLObject v_term) {
        if (NIL != forts.fort_p(v_term)) {
            ...
            if ((NIL != el_utilities.possibly_fo_naut_p(v_term)) && (NIL != isa.isaP(v_term.first(), $$ReifiableFunction, UNPROVIDED, UNPROVIDED))) {
    ...
    static private final SubLList $list_alt35 = list(new SubLObject[]{ makeSymbol("UIA-TERM-PHRASE-MEMOIZED"), makeSymbol("UIA-TERM-PHRASE-PRECISE-MEMOIZED"), makeSymbol("UIA-SENTENCE-PHRASE-MEMOIZED"), makeSymbol("UIA-SENTENCE-PHRASE-PRECISE-MEMOIZED"), makeSymbol("UIA-PHRASE-OUTPUT-LIST-MEMOIZED"), makeSymbol("UIA-HTML-SENTENCE-PHRASE-MEMOIZED"), makeSymbol("UIA-HTML-SENTENCE-PHRASE-PRECISE-MEMOIZED"), makeSymbol("UIA-QUERY-PHRASE-MEMOIZED"), makeSymbol("UIA-HTML-QUERY-PHRASE-MEMOIZED"), makeSymbol("UIA-TERMS-DISTINGUISHING-PHRASES-MEMOIZED"), makeSymbol("UIA-ALL-PHRASES-FOR-TERM-MEMOIZED") });
