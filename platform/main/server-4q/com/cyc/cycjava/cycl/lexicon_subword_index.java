...
import static com.cyc.cycjava.cycl.lexicon_subword_index.*;
...
public final class lexicon_subword_index extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLString $str0$nl_trie_subword_fht_lock = makeString("nl-trie-subword-fht-lock");
    ...
    private static final SubLObject $$indexSubWordsForArg = reader_make_constant_shell(makeString("indexSubWordsForArg"));
    ...
    private static final SubLList $list59 = list(list(list(makeString("The emu is a noble beast.")), NIL), list(list(list(reader_make_constant_shell(makeString("UnicodeStringFn")), makeString("foo &u41D;&u435;&u440;&u43E;&u43D; bar bam"))), NIL));
    ...
    public static SubLObject reset_nl_trie_subword_index_for_string(final SubLObject v_cycl_string, final SubLObject removedP) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != cycl_string.cycl_string_p(v_cycl_string) : "cycl_string.cycl_string_p(v_cycl_string) " + "CommonSymbols.NIL != cycl_string.cycl_string_p(v_cycl_string) " + v_cycl_string;
        final SubLObject string = cycl_string.cycl_string_to_utf8_string(v_cycl_string);
        final SubLObject _prev_bind_0 = $cfasl_common_symbols$.currentBinding(thread);
        try {
            $cfasl_common_symbols$.bind(NIL, thread);
    ...
    public static SubLObject declare_lexicon_subword_index_file() {
        declareFunction(me, "nl_trie_subword_index_search", "NL-TRIE-SUBWORD-INDEX-SEARCH", 1, 1, false);
        declareFunction(me, "get_nl_trie_subword_cache", "GET-NL-TRIE-SUBWORD-CACHE", 0, 0, false);
        declareFunction(me, "nl_trie_subword_index_existsP", "NL-TRIE-SUBWORD-INDEX-EXISTS?", 0, 0, false);
        declareFunction(me, "maybe_initialize_nl_trie_subword_cache", "MAYBE-INITIALIZE-NL-TRIE-SUBWORD-CACHE", 0, 0, false);
        declareFunction(me, "nl_trie_subword_index_search_set", "NL-TRIE-SUBWORD-INDEX-SEARCH-SET", 1, 1, false);
        declareFunction(me, "nl_trie_subword_index_search_set_low", "NL-TRIE-SUBWORD-INDEX-SEARCH-SET-LOW", 1, 1, false);
        declareFunction(me, "subword_index_raw_search_set_internal", "SUBWORD-INDEX-RAW-SEARCH-SET-INTERNAL", 1, 0, false);
        declareFunction(me, "subword_index_raw_search_set", "SUBWORD-INDEX-RAW-SEARCH-SET", 1, 0, false);
        declareFunction(me, "denots_of_nl_trie_subword_index_search", "DENOTS-OF-NL-TRIE-SUBWORD-INDEX-SEARCH", 1, 2, false);
        declareFunction(me, "subwords_internal", "SUBWORDS-INTERNAL", 1, 0, false);
        declareFunction(me, "subwords", "SUBWORDS", 1, 0, false);
        declareFunction(me, "lexicon_subword_index_stop_wordP", "LEXICON-SUBWORD-INDEX-STOP-WORD?", 1, 0, false);
        declareFunction(me, "pivot_location_break_chars", "PIVOT-LOCATION-BREAK-CHARS", 0, 0, false);
        declareFunction(me, "subword_index_break_char_p", "SUBWORD-INDEX-BREAK-CHAR-P", 1, 0, false);
        declareFunction(me, "add_non_trie_predicate_to_sub_word_index", "ADD-NON-TRIE-PREDICATE-TO-SUB-WORD-INDEX", 2, 0, false);
        declareFunction(me, "remove_non_trie_predicate_from_sub_word_index", "REMOVE-NON-TRIE-PREDICATE-FROM-SUB-WORD-INDEX", 2, 0, false);
        declareFunction(me, "reset_nl_trie_subword_index_for_string", "RESET-NL-TRIE-SUBWORD-INDEX-FOR-STRING", 2, 0, false);
        declareFunction(me, "non_trie_subword_preds_internal", "NON-TRIE-SUBWORD-PREDS-INTERNAL", 0, 0, false);
        declareFunction(me, "non_trie_subword_preds", "NON-TRIE-SUBWORD-PREDS", 0, 0, false);
        declareFunction(me, "non_trie_subword_pred_args", "NON-TRIE-SUBWORD-PRED-ARGS", 1, 0, false);
        declareFunction(me, "string_asserted_on_non_trie_subword_pred_arg_comboP", "STRING-ASSERTED-ON-NON-TRIE-SUBWORD-PRED-ARG-COMBO?", 1, 0, false);
        declareFunction(me, "string_in_trieP_internal", "STRING-IN-TRIE?-INTERNAL", 1, 1, false);
        declareFunction(me, "string_in_trieP", "STRING-IN-TRIE?", 1, 1, false);
        declareFunction(me, "initialize_nl_trie_subword_caches", "INITIALIZE-NL-TRIE-SUBWORD-CACHES", 0, 0, false);
        declareFunction(me, "reset_nl_trie_subword_caches", "RESET-NL-TRIE-SUBWORD-CACHES", 0, 0, false);
        declareFunction(me, "build_nl_trie_subword_index", "BUILD-NL-TRIE-SUBWORD-INDEX", 0, 0, false);
        declareFunction(me, "index_sub_words", "INDEX-SUB-WORDS", 1, 0, false);
        declareFunction(me, "index_sub_words_for_pred_and_arg", "INDEX-SUB-WORDS-FOR-PRED-AND-ARG", 2, 0, false);
        declareFunction(me, "nl_trie_entries_strings", "NL-TRIE-ENTRIES-STRINGS", 1, 0, false);
        declareFunction(me, "dump_nl_trie_subword_index", "DUMP-NL-TRIE-SUBWORD-INDEX", 1, 0, false);
        declareFunction(me, "dump_nl_trie_subword_index_int", "DUMP-NL-TRIE-SUBWORD-INDEX-INT", 0, 3, false);
        declareFunction(me, "get_default_nl_trie_subword_cache_file_path", "GET-DEFAULT-NL-TRIE-SUBWORD-CACHE-FILE-PATH", 0, 1, false);
        declareFunction(me, "test_subword_index", "TEST-SUBWORD-INDEX", 1, 0, false);
        return NIL;
    }
