...
import static com.cyc.cycjava.cycl.inference.browser.cb_kb_query_state.*;
...
public final class cb_kb_query_state extends SubLTranslatedFile {
    ...
    public static SubLObject kb_query_state_p(final SubLObject v_object) {
        return v_object.getClass() == cb_kb_query_state.$kb_query_state_native.class ? T : NIL;
    }

    public static SubLObject kb_query_state_query_spec(final SubLObject v_object) {
        assert NIL != kb_query_state_p(v_object) : "cb_kb_query_state.kb_query_state_p(v_object) " + "CommonSymbols.NIL != cb_kb_query_state.kb_query_state_p(v_object) " + v_object;
    ...
    public static SubLObject make_kb_query_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_kb_query_state.$kb_query_state_native();
        SubLObject next;
                                                    ...
                                                    if (pcase_var.eql($TEMPLATE_GLOSSES)) {
                                                        ...
                                                        if (pcase_var.eql($QUERY_PROPERTIES)) {
                                                            ...
                                                            if (pcase_var.eql($NON_EXPLANATORY_SENTENCE)) {
                                                                ...
                                                                if (pcase_var.eql($MULTIPLE_CHOICE_OPTION_SPECS)) {
    ...
    public static SubLObject declare_cb_kb_query_state_file() {
        declareFunction(me, "kb_query_state_print_function_trampoline", "KB-QUERY-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "kb_query_state_p", "KB-QUERY-STATE-P", 1, 0, false);
        new cb_kb_query_state.$kb_query_state_p$UnaryFunction();
        declareFunction(me, "kb_query_state_query_spec", "KB-QUERY-STATE-QUERY-SPEC", 1, 0, false);
        declareFunction(me, "kb_query_state_name", "KB-QUERY-STATE-NAME", 1, 0, false);
        declareFunction(me, "kb_query_state_comments", "KB-QUERY-STATE-COMMENTS", 1, 0, false);
        declareFunction(me, "kb_query_state_test_state", "KB-QUERY-STATE-TEST-STATE", 1, 0, false);
        declareFunction(me, "kb_query_state_save_mt", "KB-QUERY-STATE-SAVE-MT", 1, 0, false);
        declareFunction(me, "kb_query_state_inference", "KB-QUERY-STATE-INFERENCE", 1, 0, false);
        declareFunction(me, "kb_query_state_sentences", "KB-QUERY-STATE-SENTENCES", 1, 0, false);
        declareFunction(me, "kb_query_state_query_mts", "KB-QUERY-STATE-QUERY-MTS", 1, 0, false);
        declareFunction(me, "kb_query_state_template", "KB-QUERY-STATE-TEMPLATE", 1, 0, false);
        declareFunction(me, "kb_query_state_template_folder_mt_pairs", "KB-QUERY-STATE-TEMPLATE-FOLDER-MT-PAIRS", 1, 0, false);
        declareFunction(me, "kb_query_state_template_glosses", "KB-QUERY-STATE-TEMPLATE-GLOSSES", 1, 0, false);
        declareFunction(me, "kb_query_state_query_properties", "KB-QUERY-STATE-QUERY-PROPERTIES", 1, 0, false);
        declareFunction(me, "kb_query_state_non_explanatory_sentence", "KB-QUERY-STATE-NON-EXPLANATORY-SENTENCE", 1, 0, false);
        declareFunction(me, "kb_query_state_multiple_choice_option_specs", "KB-QUERY-STATE-MULTIPLE-CHOICE-OPTION-SPECS", 1, 0, false);
        declareFunction(me, "_csetf_kb_query_state_query_spec", "_CSETF-KB-QUERY-STATE-QUERY-SPEC", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_name", "_CSETF-KB-QUERY-STATE-NAME", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_comments", "_CSETF-KB-QUERY-STATE-COMMENTS", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_test_state", "_CSETF-KB-QUERY-STATE-TEST-STATE", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_save_mt", "_CSETF-KB-QUERY-STATE-SAVE-MT", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_inference", "_CSETF-KB-QUERY-STATE-INFERENCE", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_sentences", "_CSETF-KB-QUERY-STATE-SENTENCES", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_query_mts", "_CSETF-KB-QUERY-STATE-QUERY-MTS", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_template", "_CSETF-KB-QUERY-STATE-TEMPLATE", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_template_folder_mt_pairs", "_CSETF-KB-QUERY-STATE-TEMPLATE-FOLDER-MT-PAIRS", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_template_glosses", "_CSETF-KB-QUERY-STATE-TEMPLATE-GLOSSES", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_query_properties", "_CSETF-KB-QUERY-STATE-QUERY-PROPERTIES", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_non_explanatory_sentence", "_CSETF-KB-QUERY-STATE-NON-EXPLANATORY-SENTENCE", 2, 0, false);
        declareFunction(me, "_csetf_kb_query_state_multiple_choice_option_specs", "_CSETF-KB-QUERY-STATE-MULTIPLE-CHOICE-OPTION-SPECS", 2, 0, false);
        declareFunction(me, "make_kb_query_state", "MAKE-KB-QUERY-STATE", 0, 1, false);
        declareFunction(me, "visit_defstruct_kb_query_state", "VISIT-DEFSTRUCT-KB-QUERY-STATE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_kb_query_state_method", "VISIT-DEFSTRUCT-OBJECT-KB-QUERY-STATE-METHOD", 2, 0, false);
        declareFunction(me, "cb_kbq_new_query_state_from_query_spec", "CB-KBQ-NEW-QUERY-STATE-FROM-QUERY-SPEC", 1, 1, false);
        declareFunction(me, "cb_kbq_new_query_state_from_inference", "CB-KBQ-NEW-QUERY-STATE-FROM-INFERENCE", 1, 1, false);
        declareFunction(me, "kb_query_state_best_sentence", "KB-QUERY-STATE-BEST-SENTENCE", 1, 0, false);
        declareFunction(me, "kb_query_state_other_sentences", "KB-QUERY-STATE-OTHER-SENTENCES", 1, 0, false);
        declareFunction(me, "kb_query_state_best_mt", "KB-QUERY-STATE-BEST-MT", 1, 0, false);
        declareFunction(me, "kb_query_state_other_mts", "KB-QUERY-STATE-OTHER-MTS", 1, 0, false);
        declareFunction(me, "cb_clear_kb_query_being_saved", "CB-CLEAR-KB-QUERY-BEING-SAVED", 0, 0, false);
        declareFunction(me, "cb_kb_query_being_saved", "CB-KB-QUERY-BEING-SAVED", 0, 0, false);
        declareFunction(me, "cb_set_kb_query_being_saved", "CB-SET-KB-QUERY-BEING-SAVED", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $kb_query_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(cb_kb_query_state.$kb_query_state_native.class, KB_QUERY_STATE, KB_QUERY_STATE_P, $list2, $list3, new String[]{ "$query_spec", "$name", "$comments", "$test_state", "$save_mt", "$inference", "$sentences", "$query_mts", "$template", "$template_folder_mt_pairs", "$template_glosses", "$query_properties", "$non_explanatory_sentence", "$multiple_choice_option_specs" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
