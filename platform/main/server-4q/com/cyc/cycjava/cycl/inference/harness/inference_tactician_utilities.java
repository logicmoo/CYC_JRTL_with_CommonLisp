...
import static com.cyc.cycjava.cycl.inference.harness.inference_tactician_utilities.*;
...
public final class inference_tactician_utilities extends SubLTranslatedFile {
    ...
    public static final SubLString $$$problem_is_closed = makeString("problem is closed");
    ...
    public static final SubLList $list22 = list(list(makeKeyword("DISPREFERRED"), TWO_INTEGER, ZERO_INTEGER), list(makeKeyword("GROSSLY-DISPREFERRED"), TWENTY_INTEGER, ZERO_INTEGER), list(makeKeyword("JOIN-ORDERED"), FIVE_INTEGER, ZERO_INTEGER));
    ...
    public static SubLObject declare_inference_tactician_utilities_file() {
        declareFunction(me, "memoized_problem_global_preference_level", "MEMOIZED-PROBLEM-GLOBAL-PREFERENCE-LEVEL", 3, 0, false);
        declareFunction(me, "memoized_problem_global_preference_level_int_internal", "MEMOIZED-PROBLEM-GLOBAL-PREFERENCE-LEVEL-INT-INTERNAL", 3, 0, false);
        declareFunction(me, "memoized_problem_global_preference_level_int", "MEMOIZED-PROBLEM-GLOBAL-PREFERENCE-LEVEL-INT", 3, 0, false);
        declareFunction(me, "problem_global_preference_level", "PROBLEM-GLOBAL-PREFERENCE-LEVEL", 3, 0, false);
        declareFunction(me, "problem_global_preference_level_wrt_modules", "PROBLEM-GLOBAL-PREFERENCE-LEVEL-WRT-MODULES", 3, 0, false);
        declareFunction(me, "single_negative_literal_problem_p", "SINGLE-NEGATIVE-LITERAL-PROBLEM-P", 1, 0, false);
        declareFunction(me, "multi_literal_problem_global_preference_level", "MULTI-LITERAL-PROBLEM-GLOBAL-PREFERENCE-LEVEL", 2, 0, false);
        declareFunction(me, "multi_literal_problem_tactics_to_activate", "MULTI-LITERAL-PROBLEM-TACTICS-TO-ACTIVATE", 2, 0, false);
        declareFunction(me, "problem_has_some_complete_non_thrown_away_removal_tacticP", "PROBLEM-HAS-SOME-COMPLETE-NON-THROWN-AWAY-REMOVAL-TACTIC?", 2, 0, false);
        declareFunction(me, "problem_has_no_allowed_or_executed_tactics_wrt_removalP", "PROBLEM-HAS-NO-ALLOWED-OR-EXECUTED-TACTICS-WRT-REMOVAL?", 2, 0, false);
        declareFunction(me, "removal_unhappiness", "REMOVAL-UNHAPPINESS", 4, 0, false);
        declareFunction(me, "scale_unhappiness", "SCALE-UNHAPPINESS", 2, 0, false);
        declareFunction(me, "module_scaling_factor", "MODULE-SCALING-FACTOR", 1, 0, false);
        declareFunction(me, "preference_scaling_factor", "PREFERENCE-SCALING-FACTOR", 1, 0, false);
        declareFunction(me, "literal_count_scaling_factor", "LITERAL-COUNT-SCALING-FACTOR", 1, 0, false);
        declareFunction(me, "strategy_deems_conjunctive_tactic_spec_betterP", "STRATEGY-DEEMS-CONJUNCTIVE-TACTIC-SPEC-BETTER?", 8, 0, false);
        declareFunction(me, "magic_wand_tacticP", "MAGIC-WAND-TACTIC?", 2, 0, false);
        declareFunction(me, "under_magic_wand_max_preference_levelP", "UNDER-MAGIC-WAND-MAX-PREFERENCE-LEVEL?", 1, 0, false);
        declareFunction(me, "tactic_strictly_less_preferred_than_some_siblingP", "TACTIC-STRICTLY-LESS-PREFERRED-THAN-SOME-SIBLING?", 2, 0, false);
        declareFunction(me, "abductive_magic_wand_tacticP", "ABDUCTIVE-MAGIC-WAND-TACTIC?", 2, 0, false);
        declareFunction(me, "abductive_strategy_chooses_only_abductive_tacticP", "ABDUCTIVE-STRATEGY-CHOOSES-ONLY-ABDUCTIVE-TACTIC?", 2, 0, false);
        declareFunction(me, "inference_all_set_asides", "INFERENCE-ALL-SET-ASIDES", 1, 0, false);
        declareFunction(me, "inference_all_set_aside_problems", "INFERENCE-ALL-SET-ASIDE-PROBLEMS", 1, 0, false);
        declareFunction(me, "inference_all_set_aside_strategems", "INFERENCE-ALL-SET-ASIDE-STRATEGEMS", 1, 0, false);
        return NIL;
    }
