      ...
      SubLTranslatedFile
{
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw22$BEGIN, $sym23$MAKE_TRANSFORMATION_LINK_DATA, FOUR_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw24$SLOT, $kw17$HL_MODULE, trans_link_data_hl_module( obj ) );
    Functions.funcall( visitor_fn, obj, $kw24$SLOT, $kw18$BINDINGS, trans_link_data_bindings( obj ) );
    Functions.funcall( visitor_fn, obj, $kw24$SLOT, $kw19$SUPPORTS, trans_link_data_supports( obj ) );
    Functions.funcall( visitor_fn, obj, $kw24$SLOT, $kw20$NON_EXPLANATORY_SUBQUERY, trans_link_data_non_explanatory_subquery( obj ) );
    Functions.funcall( visitor_fn, obj, $kw25$END, $sym23$MAKE_TRANSFORMATION_LINK_DATA, FOUR_INTEGER );
    return obj;
  }
  ...
  public static SubLObject new_transformation_link(final SubLObject supported_problem, final SubLObject supporting_mapped_problem, final SubLObject hl_module, final SubLObject transformation_bindings,
      final SubLObject rule_assertion, final SubLObject more_supports, final SubLObject non_explanatory_subquery)
  {
    ...
    final SubLObject supports = ConsesLow.cons( rule_assertion, more_supports );
  ...
  {
    final SubLObject transformation_link = inference_datastructures_problem_link.new_problem_link( $kw29$TRANSFORMATION, problem );
  ...
  public static SubLObject destroy_transformation_link(final SubLObject transformation_link)
  {
    ...
    _csetf_trans_link_data_hl_module( data, $kw30$FREE );
    _csetf_trans_link_data_bindings( data, $kw30$FREE );
    _csetf_trans_link_data_supports( data, $kw30$FREE );
    _csetf_trans_link_data_non_explanatory_subquery( data, $kw30$FREE );
    return transformation_link;
  }
  ...
  public static SubLObject transformation_link_tactic(final SubLObject transformation_link)
  {
    ...
    {
      if( NIL != inference_datastructures_problem.do_problem_tactics_type_match( candidate_tactic, $kw29$TRANSFORMATION ) && hl_module.eql( inference_datastructures_tactic.tactic_hl_module( candidate_tactic ) ) && rule
          .eql( transformation_tactic_rule( candidate_tactic ) ) )
      {
  ...
  public static SubLObject transformed_problem_using_rule(final SubLObject supported_problem, final SubLObject rule)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, transformation_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( transformation_link, $kw29$TRANSFORMATION ) )
      {
  ...
  public static SubLObject transformation_link_motivated_residual_transformation_links(final SubLObject transformation_link)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, jo_link_var ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( jo_link_var, $kw38$JOIN_ORDERED ) )
      {
        ...
        for( basis_object_$3 = set_contents.do_set_contents_basis_object( set_contents_var_$2 ), state_$4 = NIL, state_$4 = set_contents.do_set_contents_initial_state( basis_object_$3,
            set_contents_var_$2 ); NIL == set_contents.do_set_contents_doneP( basis_object_$3, state_$4 ); state_$4 = set_contents.do_set_contents_update_state( state_$4 ) )
        {
          rt_link = set_contents.do_set_contents_next( basis_object_$3, state_$4 );
          if( NIL != set_contents.do_set_contents_element_validP( state_$4, rt_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( rt_link, $kw39$RESIDUAL_TRANSFORMATION )
              && NIL != inference_worker_residual_transformation.residual_transformation_link_motivated_by_join_ordered_linkP( rt_link, jo_link_var_$1 ) && NIL != inference_worker_residual_transformation
                  .residual_transformation_link_motivated_by_transformation_linkP( rt_link, transformation_link ) )
          {
            rt_links = ConsesLow.cons( rt_link, rt_links );
          }
        }
      }
    }
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, jo_link_var ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( jo_link_var, $kw38$JOIN_ORDERED ) )
      {
            ...
            set_contents_var_$6 ); NIL == set_contents.do_set_contents_doneP( basis_object_$7, state_$8 ); state_$8 = set_contents.do_set_contents_update_state( state_$8 ) )
        {
          ...
          if( NIL != set_contents.do_set_contents_element_validP( state_$8, rt_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( rt_link, $kw39$RESIDUAL_TRANSFORMATION )
              && NIL != inference_worker_residual_transformation.residual_transformation_link_motivated_by_join_ordered_linkP( rt_link, jo_link_var_$5 ) && NIL != inference_worker_residual_transformation
                  .residual_transformation_link_motivated_by_transformation_linkP( rt_link, transformation_link ) )
          {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, jo_link_var ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( jo_link_var, $kw38$JOIN_ORDERED ) )
      {
            ...
            set_contents_var_$10 ); NIL == set_contents.do_set_contents_doneP( basis_object_$11, state_$12 ); state_$12 = set_contents.do_set_contents_update_state( state_$12 ) )
        {
          ...
          if( NIL != set_contents.do_set_contents_element_validP( state_$12, rt_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( rt_link, $kw39$RESIDUAL_TRANSFORMATION )
              && NIL != inference_worker_residual_transformation.residual_transformation_link_motivated_by_join_ordered_linkP( rt_link, jo_link_var_$9 ) && NIL != inference_worker_residual_transformation
                  .residual_transformation_link_motivated_by_transformation_linkP( rt_link, transformation_link ) && NIL != inference_datastructures_problem_link.problem_link_goodP( rt_link ) )
          {
            total = Numbers.add( total, ONE_INTEGER );
          }
        }
  ...
  public static SubLObject with_problem_store_transformation_assumptions(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.listS( $sym42$CLET, ConsesLow.list( ConsesLow.list( store_var, store ), $list43, $list44, $list45, ConsesLow.list( $sym46$_NEGATION_BY_FAILURE_, ConsesLow.list(
        $sym47$PROBLEM_STORE_NEGATION_BY_FAILURE_, store_var ) ) ), ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject new_meta_transformation_tactic(final SubLObject problem, final SubLObject asent, final SubLObject sense)
  {
    ...
    inference_datastructures_tactic.set_tactic_completeness( tactic, $kw50$GROSSLY_INCOMPLETE );
    ...
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw51$SKIP ) )
    {
      final SubLObject idx_$13 = idx;
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$13, $kw51$SKIP ) )
      {
        ...
        for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
        {
          ...
          if( NIL == id_index.id_index_tombstone_p( inference ) || NIL == id_index.id_index_skip_tombstones_p( $kw51$SKIP ) )
          {
  ...
  {
    return makeBoolean( NIL != inference_datastructures_problem_link.problem_link_p( v_object ) && $kw29$TRANSFORMATION == inference_datastructures_problem_link.problem_link_type( v_object ) );
  }
  ...
  {
    return makeBoolean( NIL != inference_datastructures_tactic.tactic_p( tactic ) && $kw29$TRANSFORMATION == inference_datastructures_tactic.tactic_type( tactic ) );
  }
    ...
    try
    {
      ...
      else
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          {
            rules2 = ConsesLow.cons( rule2, rules2 );
          }
          cdolist_list_var = cdolist_list_var.rest();
          rule2 = cdolist_list_var.first();
        }
  ...
  {
    return determine_literal_transformation_tactic_specs_int( asent, sense, disabled_modules, $kw60$TACTIC_SPECS );
  }
  ...
  public static SubLObject determine_literal_transformation_tactic_specs_int(final SubLObject asent, final SubLObject sense, final SubLObject disabled_modules, final SubLObject return_type)
  {
    ...
    for( exclusive_foundP = NIL, rest = NIL, rest = inference_modules.transformation_modules(); NIL == exclusive_foundP && NIL != rest; rest = rest.rest() )
    {
      ...
      if( NIL != inference_modules.hl_module_activeP( hl_module, disabled_modules ) && ( NIL == supplanted_modules || NIL == conses_high.member( hl_module, supplanted_modules, UNPROVIDED, UNPROVIDED ) )
          && NIL != inference_modules.hl_module_sense_relevant_p( hl_module, sense ) && NIL != inference_modules.hl_module_predicate_relevant_p( hl_module, predicate ) && NIL != inference_modules
              .hl_module_required_pattern_matched_p( hl_module, asent ) && NIL != inference_modules.hl_module_required_mt_relevantP( hl_module ) && NIL != inference_modules.hl_module_direction_relevantP( hl_module ) )
      {
        ...
        if( NIL == exclusive_func || ( exclusive_func.isFunctionSpec() && NIL != Functions.funcall( exclusive_func, asent ) ) )
        {
          ...
          if( NIL == required_func || ( required_func.isFunctionSpec() && NIL != Functions.funcall( required_func, asent ) ) )
          {
            ...
            if( NIL != cost )
            {
              ...
              if( return_type.eql( $kw60$TACTIC_SPECS ) )
              {
                tactic_spec = ConsesLow.list( hl_module, productivity );
                tactic_specs = ConsesLow.cons( tactic_spec, tactic_specs );
              }
              else if( return_type.eql( $kw61$TOTAL_PRODUCTIVITY ) )
              {
    ...
    if( return_type.eql( $kw61$TOTAL_PRODUCTIVITY ) )
    {
  ...
  public static SubLObject maybe_new_transformation_link(final SubLObject supported_problem, final SubLObject supporting_mapped_problem, final SubLObject tactic, final SubLObject transformation_bindings,
      final SubLObject rule_assertion, final SubLObject more_supports, final SubLObject non_explanatory_subquery)
  {
  ...
  public static SubLObject recompute_thrown_away_due_to_new_transformation_link(final SubLObject problem)
  {
    ...
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw51$SKIP ) )
    {
      ...
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$18, $kw51$SKIP ) )
      {
  ...
  public static SubLObject new_transformation_tactic(final SubLObject problem, final SubLObject hl_module, final SubLObject productivity, final SubLObject rule)
  {
    ...
    final SubLObject completeness = $kw50$GROSSLY_INCOMPLETE;
    inference_datastructures_tactic.set_tactic_productivity( tactic, productivity, UNPROVIDED );
    ...
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw51$SKIP ) )
    {
      ...
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$20, $kw51$SKIP ) )
      {
  ...
  public static SubLObject with_transformation_tactic_execution_assumptions(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      ...
      return ConsesLow.list( $sym42$CLET, ConsesLow.list( ConsesLow.list( tactic_var, tactic ) ), ConsesLow.list( $sym66$WITH_INFERENCE_MT_RELEVANCE, mt, ConsesLow.list( $sym42$CLET, ConsesLow.list( ConsesLow.list(
          $sym67$_INFERENCE_EXPAND_HL_MODULE_, ConsesLow.list( $sym68$TACTIC_HL_MODULE, tactic_var ) ), ConsesLow.list( $sym69$_INFERENCE_EXPAND_SENSE_, sense ) ), ConsesLow.listS(
              $sym70$WITH_PROBLEM_STORE_TRANSFORMATION_ASSUMPTIONS, ConsesLow.list( $sym71$TACTIC_STORE, tactic_var ), ConsesLow.append( body, NIL ) ) ) ) );
    }
  ...
  public static SubLObject maybe_make_meta_transformation_progress_iterator(final SubLObject tactic, final SubLObject asent, final SubLObject sense)
  {
    ...
    if( NIL == Errors.$ignore_mustsP$.getDynamicValue( thread ) && name != $kw49$DETERMINE_NEW_TRANSFORMATION_TACTICS )
    {
  ...
  {
    return inference_datastructures_tactic.new_tactic_progress_iterator( $kw73$TRANSFORMATION_RULE_SELECT, tactic, tactic_specs );
  }
  ...
  public static SubLObject handle_transformation_add_node_for_expand_results(final SubLObject rule_assertion, final SubLObject rule_pivot_asent, final SubLObject rule_pivot_sense, SubLObject unification_bindings,
      SubLObject unification_dependent_dnf, final SubLObject more_supports)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
  ...
  public static SubLObject transformation_additional_dont_care_constraints(final SubLObject rule_pivot_asent, final SubLObject unification_dependent_dnf, final SubLObject rule_assertion,
      final SubLObject unification_bindings)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        dont_care_constraints = ConsesLow.cons( source_var_pos_lit, dont_care_constraints );
      }
      cdolist_list_var = cdolist_list_var.rest();
      source_var_pos_lit = cdolist_list_var.first();
    }
  ...
  public static SubLObject complete_execution_of_transformation_tactic(final SubLObject tactic, final SubLObject transformation_bindings, final SubLObject rule_assertion, final SubLObject more_supports,
      final SubLObject unrestricted_transformation_dependent_dnf, final SubLObject unrestricted_transformation_explanatory_dnf)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    if( NIL == clauses.empty_clauseP( restricted_transformation_dependent_dnf ) )
    {
      ...
      final SubLObject abduction_allowedP = inference_datastructures_problem_store.problem_store_abduction_allowedP( inference_datastructures_problem.problem_store( inference_datastructures_tactic.tactic_problem(
          tactic ) ) );
      if( NIL == potentially_wf_transformation_dependent_query( dependent_query, abduction_allowedP ) )
      {
        return NIL;
      }
      final SubLObject dependent_query_free_hl_vars = variables.sort_hl_variable_list_memoized( conses_high.intersection( cycl_utilities.expression_gather( dependent_query, $sym76$HL_VAR_, UNPROVIDED, UNPROVIDED,
          UNPROVIDED, UNPROVIDED ), cycl_utilities.expression_gather( bindings.apply_bindings( transformation_bindings, inference_datastructures_problem.problem_free_hl_vars( inference_datastructures_tactic
              .tactic_problem( tactic ) ) ), $sym76$HL_VAR_, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), UNPROVIDED, UNPROVIDED ) );
    ...
    final SubLObject non_explanatory_subquery = compute_transformation_non_explanatory_subquery( unrestricted_transformation_dependent_dnf, unrestricted_transformation_explanatory_dnf,
        restricted_transformation_dependent_dnf, transformation_bindings, supporting_mapped_problem );
  ...
  public static SubLObject compute_transformation_non_explanatory_subquery(final SubLObject unrestricted_transformation_dependent_dnf, final SubLObject unrestricted_transformation_explanatory_dnf,
      final SubLObject restricted_transformation_dependent_dnf, final SubLObject transformation_bindings, final SubLObject supporting_mapped_problem)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
  ...
  public static SubLObject potentially_wf_transformation_dependent_query(final SubLObject dependent_query, final SubLObject abduction_allowedP)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        final SubLObject sense = $kw77$NEG;
      ...
      {
        final SubLObject sense = $kw78$POS;
        if( NIL == potentially_wf_restricted_transformation_dependent_asent( contextualized_asent, sense, abduction_allowedP ) )
        {
          return NIL;
        }
  ...
  public static SubLObject potentially_wf_restricted_transformation_dependent_asent(final SubLObject contextualized_asent, final SubLObject sense, final SubLObject abduction_allowedP)
  {
    ...
    if( NIL == current )
    {
      return makeBoolean( NIL != syntactically_valid_asent( asent ) && ( NIL != abduction_allowedP || NIL == cycl_utilities.atomic_sentence_with_pred_p( asent, $const80$termOfUnit )
          || NIL != syntactically_valid_contextualized_term_of_unit_asent( asent, sense ) ) );
    }
  ...
  {
    return makeBoolean( $kw78$POS == sense && NIL != backward.syntactically_valid_term_of_unit_asent( asent ) );
  }
  ...
  public static SubLObject unification_bindings_to_transformation_bindings(final SubLObject unification_bindings)
  {
    ...
    if( NIL != bindings_to_closed )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        transformation_bindings = ConsesLow.cons( bindings.make_variable_binding( bindings.variable_binding_variable( binding ), new_value ), transformation_bindings );
        cdolist_list_var = cdolist_list_var.rest();
        binding = cdolist_list_var.first();
      }
  ...
  public static SubLObject unify_transformation_and_subproof_bindings(final SubLObject transformation_bindings, final SubLObject subproof_bindings)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        final_bindings = ConsesLow.cons( binding, final_bindings );
      }
      else
      {
        working_bindings = ConsesLow.cons( binding, working_bindings );
      }
      cdolist_list_var = cdolist_list_var.rest();
      binding = cdolist_list_var.first();
    }
  ...
  public static SubLObject extended_supported_problem_bindings_to_supported_problem_bindings(final SubLObject extended_supported_problem_bindings)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        supported_problem_bindings = ConsesLow.cons( binding, supported_problem_bindings );
      }
      cdolist_list_var = cdolist_list_var.rest();
      binding = cdolist_list_var.first();
    }
  ...
  public static SubLObject extended_supported_problem_bindings_to_rule_bindings(final SubLObject extended_supported_problem_bindings)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        rule_bindings = ConsesLow.cons( binding, rule_bindings );
      }
      cdolist_list_var = cdolist_list_var.rest();
      binding = cdolist_list_var.first();
    }
  ...
  {
    final SubLObject pragmatics_mt = $const86$InferencePSC.equal( propagation_mt ) ? assertions_high.assertion_mt( rule ) : propagation_mt;
      ...
      if( NIL != kb_mapping_macros.do_pragma_rule_index_key_validator( rule_assertion, NIL ) )
      {
        ...
        while ( NIL == done_var)
        {
          ...
          if( NIL != valid )
          {
            ...
            try
            {
              final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, $kw88$RULE, NIL, NIL );
              ...
              while ( NIL == done_var_$32)
              {
                ...
                if( NIL != valid_$34 )
                {
                  ...
                  if( NIL != list_utilities.singletonP( neg_lits ) )
                  {
                    ...
                    if( NIL != el_utilities.el_formula_with_operator_p( lit, $const89$forwardNonTriggerLiteral ) )
                    {
                      final SubLObject item_var = el_utilities.literal_arg1( lit, UNPROVIDED );
            ...
            try
            {
              ...
              while ( NIL == done_var_$36)
              {
                ...
                if( NIL != valid_$38 )
                {
                  ...
                  {
                    final SubLObject lit = neg_lits.first();
                    if( NIL != el_utilities.el_formula_with_operator_p( lit, $const90$forwardTriggerLiteral ) )
                    {
                      final SubLObject item_var = el_utilities.literal_arg1( lit, UNPROVIDED );
                      if( NIL == conses_high.member( item_var, result, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
                      {
  ...
  public static SubLObject merge_pragmatic_requirement(final SubLObject rule_assertion, final SubLObject pragma_assertion, final SubLObject merge_dnf)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        pos_lits = ConsesLow.cons( item_var, pos_lits );
      }
      cdolist_list_var = cdolist_list_var.rest();
      pragmatic_lit = cdolist_list_var.first();
    }
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL == el_utilities.el_meets_pragmatic_requirement_p( pragmatic_lit ) )
      {
        ...
        {
          neg_lits = ConsesLow.cons( item_var, neg_lits );
        }
      }
      cdolist_list_var = cdolist_list_var.rest();
      pragmatic_lit = cdolist_list_var.first();
  ...
  public static SubLObject compute_pragmatic_literal_for_merge(final SubLObject literal, final SubLObject merge_dnf, final SubLObject rule_dnf)
  {
    ...
    try
    {
      ...
      final SubLObject conflicting_hl_var = cycl_utilities.expression_find_if( $sym91$HL_VARIABLE_NOT_MENTIONED_IN_RULE_DNF_BUT_MENTIONED_IN_MERGE_DNF, literal, NIL, UNPROVIDED );
  ...
  public static SubLObject inference_backchain_forbidden_unless_arg_chosen_argnums_memoized(final SubLObject predicate, final SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym94$INFERENCE_BACKCHAIN_FORBIDDEN_UNLESS_ARG_CHOSEN_ARGNUMS_MEMOIZED, TWO_INTEGER, NIL,
          EQUAL, UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( inference_backchain_forbidden_unless_arg_chosen_argnums_memoized_internal( predicate, mt ) ) );
  ...
  public static SubLObject inference_backchain_forbidden_unless_arg_chosen_asent_variables_int(final SubLObject asent, final SubLObject mt, final SubLObject justifyP)
  {
    ...
    if( NIL == variables.fully_bound_p( asent ) )
    {
      ...
      if( NIL != argnums )
      {
        ...
        SubLObject cdolist_list_var;
        final SubLObject args = cdolist_list_var = cycl_utilities.formula_args( asent, $kw95$IGNORE );
        SubLObject arg = NIL;
        ...
        while ( NIL != cdolist_list_var)
        {
          ...
          if( NIL != subl_promotions.memberP( argnum, argnums, Symbols.symbol_function( EQL ), UNPROVIDED ) && NIL == variables.fully_bound_p( arg ) )
          {
            ...
            while ( NIL != cdolist_list_var_$40)
            {
              ...
              {
                v_variables = ConsesLow.cons( item_var, v_variables );
              }
  ...
  public static SubLObject genl_rules(final SubLObject rule, SubLObject mt)
  {
    ...
    return gt_methods.gt_superiors( $const98$genlRules, rule, mt );
  }
  ...
  public static SubLObject max_rules(final SubLObject rules, SubLObject mt)
  {
    ...
    if( NIL == constant_handles.valid_constantP( $const98$genlRules, UNPROVIDED ) )
    {
      return rules;
    }
    ...
    if( NIL == any_relevant_genl_rules_assertionsP )
    {
      ...
      {
        if( NIL != somewhere_cache.some_pred_assertion_somewhereP( $const98$genlRules, rule, ONE_INTEGER, UNPROVIDED ) )
        {
    ...
    return gt_methods.gt_max_nodes( $const98$genlRules, rules, mt, UNPROVIDED );
  }

  public static SubLObject declare_inference_worker_transformation_file()
  {
    SubLFiles.declareFunction( me, "transformation_link_data_print_function_trampoline", "TRANSFORMATION-LINK-DATA-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_data_p", "TRANSFORMATION-LINK-DATA-P", 1, 0, false );
    new $transformation_link_data_p$UnaryFunction();
    SubLFiles.declareFunction( me, "trans_link_data_hl_module", "TRANS-LINK-DATA-HL-MODULE", 1, 0, false );
    SubLFiles.declareFunction( me, "trans_link_data_bindings", "TRANS-LINK-DATA-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "trans_link_data_supports", "TRANS-LINK-DATA-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "trans_link_data_non_explanatory_subquery", "TRANS-LINK-DATA-NON-EXPLANATORY-SUBQUERY", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_trans_link_data_hl_module", "_CSETF-TRANS-LINK-DATA-HL-MODULE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_trans_link_data_bindings", "_CSETF-TRANS-LINK-DATA-BINDINGS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_trans_link_data_supports", "_CSETF-TRANS-LINK-DATA-SUPPORTS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_trans_link_data_non_explanatory_subquery", "_CSETF-TRANS-LINK-DATA-NON-EXPLANATORY-SUBQUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "make_transformation_link_data", "MAKE-TRANSFORMATION-LINK-DATA", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_transformation_link_data", "VISIT-DEFSTRUCT-TRANSFORMATION-LINK-DATA", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_transformation_link_data_method", "VISIT-DEFSTRUCT-OBJECT-TRANSFORMATION-LINK-DATA-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "new_transformation_link", "NEW-TRANSFORMATION-LINK", 7, 0, false );
    SubLFiles.declareFunction( me, "new_transformation_link_int", "NEW-TRANSFORMATION-LINK-INT", 5, 0, false );
    SubLFiles.declareFunction( me, "new_transformation_link_data", "NEW-TRANSFORMATION-LINK-DATA", 1, 0, false );
    SubLFiles.declareFunction( me, "destroy_transformation_link", "DESTROY-TRANSFORMATION-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_hl_module", "TRANSFORMATION-LINK-HL-MODULE", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_bindings", "TRANSFORMATION-LINK-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_supports", "TRANSFORMATION-LINK-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_rule_assertion", "TRANSFORMATION-LINK-RULE-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_more_supports", "TRANSFORMATION-LINK-MORE-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_non_explanatory_subquery", "TRANSFORMATION-LINK-NON-EXPLANATORY-SUBQUERY", 1, 0, false );
    SubLFiles.declareFunction( me, "set_transformation_link_hl_module", "SET-TRANSFORMATION-LINK-HL-MODULE", 2, 0, false );
    SubLFiles.declareFunction( me, "set_transformation_link_bindings", "SET-TRANSFORMATION-LINK-BINDINGS", 2, 0, false );
    SubLFiles.declareFunction( me, "set_transformation_link_supports", "SET-TRANSFORMATION-LINK-SUPPORTS", 2, 0, false );
    SubLFiles.declareFunction( me, "set_transformation_link_non_explanatory_subquery", "SET-TRANSFORMATION-LINK-NON-EXPLANATORY-SUBQUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_tactic", "TRANSFORMATION-LINK-TACTIC", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_pragmatic_requirements", "TRANSFORMATION-LINK-PRAGMATIC-REQUIREMENTS", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_supporting_mapped_problem", "TRANSFORMATION-LINK-SUPPORTING-MAPPED-PROBLEM", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_supporting_problem", "TRANSFORMATION-LINK-SUPPORTING-PROBLEM", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_supporting_variable_map", "TRANSFORMATION-LINK-SUPPORTING-VARIABLE-MAP", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_transformation_mt", "TRANSFORMATION-LINK-TRANSFORMATION-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_supporting_problem_wholly_explanatoryP", "TRANSFORMATION-LINK-SUPPORTING-PROBLEM-WHOLLY-EXPLANATORY?", 1, 0, false );
    SubLFiles.declareFunction( me, "transformed_problem_using_rule", "TRANSFORMED-PROBLEM-USING-RULE", 2, 0, false );
    SubLFiles.declareFunction( me, "transformed_problem_using_rule_and_hl_module", "TRANSFORMED-PROBLEM-USING-RULE-AND-HL-MODULE", 3, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_rule_bindings_to_closed", "TRANSFORMATION-LINK-RULE-BINDINGS-TO-CLOSED", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_rule_bindings_to_closed", "TRANSFORMATION-RULE-BINDINGS-TO-CLOSED", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_el_bindings", "TRANSFORMATION-LINK-EL-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "canonicalize_bindings_wrt_el_vars", "CANONICALIZE-BINDINGS-WRT-EL-VARS", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_motivated_residual_transformation_links", "TRANSFORMATION-LINK-MOTIVATED-RESIDUAL-TRANSFORMATION-LINKS", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_motivated_residual_transformation_link_count", "TRANSFORMATION-LINK-MOTIVATED-RESIDUAL-TRANSFORMATION-LINK-COUNT", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_good_motivated_residual_transformation_link_count", "TRANSFORMATION-LINK-GOOD-MOTIVATED-RESIDUAL-TRANSFORMATION-LINK-COUNT", 1, 0, false );
    SubLFiles.declareMacro( me, "with_problem_store_transformation_assumptions", "WITH-PROBLEM-STORE-TRANSFORMATION-ASSUMPTIONS" );
    SubLFiles.declareFunction( me, "meta_transformation_tactic_p", "META-TRANSFORMATION-TACTIC-P", 1, 0, false );
    SubLFiles.declareFunction( me, "add_tactic_to_determine_new_literal_transformation_tactics", "ADD-TACTIC-TO-DETERMINE-NEW-LITERAL-TRANSFORMATION-TACTICS", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_backchain_forbidden_asentP", "INFERENCE-BACKCHAIN-FORBIDDEN-ASENT?", 2, 0, false );
    SubLFiles.declareFunction( me, "new_meta_transformation_tactic", "NEW-META-TRANSFORMATION-TACTIC", 3, 0, false );
    SubLFiles.declareFunction( me, "compute_strategic_properties_of_meta_transformation_tactic", "COMPUTE-STRATEGIC-PROPERTIES-OF-META-TRANSFORMATION-TACTIC", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_p", "TRANSFORMATION-LINK-P", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_tactic_p", "TRANSFORMATION-TACTIC-P", 1, 0, false );
    new $transformation_tactic_p$UnaryFunction();
    SubLFiles.declareFunction( me, "transformation_tactic_rule", "TRANSFORMATION-TACTIC-RULE", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_rule_tactic_p", "TRANSFORMATION-RULE-TACTIC-P", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_generator_tactic_p", "TRANSFORMATION-GENERATOR-TACTIC-P", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_generator_tactic_lookahead_rule", "TRANSFORMATION-GENERATOR-TACTIC-LOOKAHEAD-RULE", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_tactic_lookahead_rule", "TRANSFORMATION-TACTIC-LOOKAHEAD-RULE", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_proof_p", "TRANSFORMATION-PROOF-P", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_proof_rule_assertion", "TRANSFORMATION-PROOF-RULE-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_proof_additional_supports", "TRANSFORMATION-PROOF-ADDITIONAL-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_proof_subproof", "TRANSFORMATION-PROOF-SUBPROOF", 1, 0, false );
    SubLFiles.declareFunction( me, "generalized_transformation_link_p", "GENERALIZED-TRANSFORMATION-LINK-P", 1, 0, false );
    SubLFiles.declareFunction( me, "generalized_transformation_link_rule_assertion", "GENERALIZED-TRANSFORMATION-LINK-RULE-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "generalized_transformation_link_unaffected_by_exceptionsP", "GENERALIZED-TRANSFORMATION-LINK-UNAFFECTED-BY-EXCEPTIONS?", 1, 0, false );
    SubLFiles.declareFunction( me, "generalized_transformation_proof_p", "GENERALIZED-TRANSFORMATION-PROOF-P", 1, 0, false );
    SubLFiles.declareFunction( me, "generalized_transformation_proof_rule_assertion", "GENERALIZED-TRANSFORMATION-PROOF-RULE-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "generalized_transformation_proof_rule_bindings", "GENERALIZED-TRANSFORMATION-PROOF-RULE-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "generalized_transformation_proof_transformation_link", "GENERALIZED-TRANSFORMATION-PROOF-TRANSFORMATION-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "determine_new_literal_transformation_tactics", "DETERMINE-NEW-LITERAL-TRANSFORMATION-TACTICS", 3, 0, false );
    SubLFiles.declareFunction( me, "determine_new_literal_transformation_tactics_int", "DETERMINE-NEW-LITERAL-TRANSFORMATION-TACTICS-INT", 3, 1, false );
    SubLFiles.declareFunction( me, "determine_rules_for_literal_transformation_tactics", "DETERMINE-RULES-FOR-LITERAL-TRANSFORMATION-TACTICS", 3, 0, false );
    SubLFiles.declareFunction( me, "problem_inference_and_non_continuable_problem_store_private", "PROBLEM-INFERENCE-AND-NON-CONTINUABLE-PROBLEM-STORE-PRIVATE", 1, 0, false );
    SubLFiles.declareFunction( me, "single_literal_problem_candidate_transformation_tactic_specs", "SINGLE-LITERAL-PROBLEM-CANDIDATE-TRANSFORMATION-TACTIC-SPECS", 1, 0, false );
    SubLFiles.declareFunction( me, "determine_literal_transformation_tactic_specs", "DETERMINE-LITERAL-TRANSFORMATION-TACTIC-SPECS", 3, 0, false );
    SubLFiles.declareFunction( me, "determine_literal_transformation_tactic_specs_int", "DETERMINE-LITERAL-TRANSFORMATION-TACTIC-SPECS-INT", 4, 0, false );
    SubLFiles.declareFunction( me, "literal_level_transformation_tactic_p", "LITERAL-LEVEL-TRANSFORMATION-TACTIC-P", 1, 0, false );
    SubLFiles.declareFunction( me, "maybe_new_transformation_link", "MAYBE-NEW-TRANSFORMATION-LINK", 7, 0, false );
    SubLFiles.declareFunction( me, "recompute_thrown_away_due_to_new_transformation_link", "RECOMPUTE-THROWN-AWAY-DUE-TO-NEW-TRANSFORMATION-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "new_transformation_tactic", "NEW-TRANSFORMATION-TACTIC", 4, 0, false );
    SubLFiles.declareFunction( me, "compute_strategic_properties_of_transformation_tactic", "COMPUTE-STRATEGIC-PROPERTIES-OF-TRANSFORMATION-TACTIC", 2, 0, false );
    SubLFiles.declareMacro( me, "with_transformation_tactic_execution_assumptions", "WITH-TRANSFORMATION-TACTIC-EXECUTION-ASSUMPTIONS" );
    SubLFiles.declareFunction( me, "execute_literal_level_transformation_tactic", "EXECUTE-LITERAL-LEVEL-TRANSFORMATION-TACTIC", 4, 0, false );
    SubLFiles.declareFunction( me, "maybe_make_transformation_tactic_progress_iterator", "MAYBE-MAKE-TRANSFORMATION-TACTIC-PROGRESS-ITERATOR", 3, 0, false );
    SubLFiles.declareFunction( me, "maybe_make_meta_transformation_progress_iterator", "MAYBE-MAKE-META-TRANSFORMATION-PROGRESS-ITERATOR", 3, 0, false );
    SubLFiles.declareFunction( me, "maybe_make_transformation_rule_select_progress_iterator", "MAYBE-MAKE-TRANSFORMATION-RULE-SELECT-PROGRESS-ITERATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "new_transformation_rule_select_progress_iterator", "NEW-TRANSFORMATION-RULE-SELECT-PROGRESS-ITERATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "handle_one_transformation_tactic_rule_select_result", "HANDLE-ONE-TRANSFORMATION-TACTIC-RULE-SELECT-RESULT", 2, 0, false );
    SubLFiles.declareFunction( me, "maybe_make_transformation_expand_progress_iterator", "MAYBE-MAKE-TRANSFORMATION-EXPAND-PROGRESS-ITERATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "handle_transformation_add_node_for_expand_results", "HANDLE-TRANSFORMATION-ADD-NODE-FOR-EXPAND-RESULTS", 6, 0, false );
    SubLFiles.declareFunction( me, "rule_assertion_worth_adding_type_constraintsP", "RULE-ASSERTION-WORTH-ADDING-TYPE-CONSTRAINTS?", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_additional_dont_care_constraints", "TRANSFORMATION-ADDITIONAL-DONT-CARE-CONSTRAINTS", 4, 0, false );
    SubLFiles.declareFunction( me, "nmerge_dnf", "NMERGE-DNF", 2, 0, false );
    SubLFiles.declareFunction( me, "merge_dnf", "MERGE-DNF", 2, 0, false );
    SubLFiles.declareFunction( me, "complete_execution_of_transformation_tactic", "COMPLETE-EXECUTION-OF-TRANSFORMATION-TACTIC", 6, 0, false );
    SubLFiles.declareFunction( me, "compute_transformation_non_explanatory_subquery", "COMPUTE-TRANSFORMATION-NON-EXPLANATORY-SUBQUERY", 5, 0, false );
    SubLFiles.declareFunction( me, "potentially_wf_transformation_dependent_query", "POTENTIALLY-WF-TRANSFORMATION-DEPENDENT-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "potentially_wf_restricted_transformation_dependent_asent", "POTENTIALLY-WF-RESTRICTED-TRANSFORMATION-DEPENDENT-ASENT", 3, 0, false );
    SubLFiles.declareFunction( me, "syntactically_valid_asent", "SYNTACTICALLY-VALID-ASENT", 1, 0, false );
    SubLFiles.declareFunction( me, "syntactically_valid_contextualized_term_of_unit_asent", "SYNTACTICALLY-VALID-CONTEXTUALIZED-TERM-OF-UNIT-ASENT", 2, 0, false );
    SubLFiles.declareFunction( me, "new_transformation_proof", "NEW-TRANSFORMATION-PROOF", 3, 0, false );
    SubLFiles.declareFunction( me, "compute_canonical_transformation_proof_bindings", "COMPUTE-CANONICAL-TRANSFORMATION-PROOF-BINDINGS", 3, 0, false );
    SubLFiles.declareFunction( me, "unification_dependent_dnf_to_transformation_dependent_dnf", "UNIFICATION-DEPENDENT-DNF-TO-TRANSFORMATION-DEPENDENT-DNF", 1, 0, false );
    SubLFiles.declareFunction( me, "unification_bindings_to_transformation_bindings", "UNIFICATION-BINDINGS-TO-TRANSFORMATION-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "swap_variable_spaces_of_unification_bindings", "SWAP-VARIABLE-SPACES-OF-UNIFICATION-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_proof_rule_bindings", "TRANSFORMATION-PROOF-RULE-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_transformation_link_rule_bindings", "COMPUTE-TRANSFORMATION-LINK-RULE-BINDINGS", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_proof_rule_el_bindings", "TRANSFORMATION-PROOF-RULE-EL-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_proof_el_bindings", "TRANSFORMATION-PROOF-EL-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "unify_transformation_and_subproof_bindings", "UNIFY-TRANSFORMATION-AND-SUBPROOF-BINDINGS", 2, 0, false );
    SubLFiles.declareFunction( me, "extended_supported_problem_bindings_to_supported_problem_bindings", "EXTENDED-SUPPORTED-PROBLEM-BINDINGS-TO-SUPPORTED-PROBLEM-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "supported_problem_variable_p", "SUPPORTED-PROBLEM-VARIABLE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "extended_supported_problem_bindings_to_rule_bindings", "EXTENDED-SUPPORTED-PROBLEM-BINDINGS-TO-RULE-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "rule_assertion_variable_p", "RULE-ASSERTION-VARIABLE-P", 1, 0, false );
    SubLFiles.declareFunction( me, "rule_assertion_variable_map", "RULE-ASSERTION-VARIABLE-MAP", 1, 0, false );
    SubLFiles.declareFunction( me, "rule_assertion_base_variable_map", "RULE-ASSERTION-BASE-VARIABLE-MAP", 1, 0, false );
    SubLFiles.declareFunction( me, "rule_assertion_has_some_pragmatic_requirementP", "RULE-ASSERTION-HAS-SOME-PRAGMATIC-REQUIREMENT?", 1, 1, false );
    SubLFiles.declareFunction( me, "backward_rule_pragmatic_dnf", "BACKWARD-RULE-PRAGMATIC-DNF", 1, 1, false );
    SubLFiles.declareFunction( me, "forward_rule_pragmatic_dnf", "FORWARD-RULE-PRAGMATIC-DNF", 2, 0, false );
    SubLFiles.declareFunction( me, "rule_assertion_pragmatic_requirements_dnf", "RULE-ASSERTION-PRAGMATIC-REQUIREMENTS-DNF", 1, 1, false );
    SubLFiles.declareFunction( me, "forward_rule_non_trigger_literals", "FORWARD-RULE-NON-TRIGGER-LITERALS", 2, 0, false );
    SubLFiles.declareFunction( me, "forward_rule_trigger_literals", "FORWARD-RULE-TRIGGER-LITERALS", 2, 0, false );
    SubLFiles.declareFunction( me, "merge_pragmatic_requirement", "MERGE-PRAGMATIC-REQUIREMENT", 3, 0, false );
    SubLFiles.declareFunction( me, "compute_pragmatic_literal_for_merge", "COMPUTE-PRAGMATIC-LITERAL-FOR-MERGE", 3, 0, false );
    SubLFiles.declareFunction( me, "hl_variable_not_mentioned_in_rule_dnf_but_mentioned_in_merge_dnf", "HL-VARIABLE-NOT-MENTIONED-IN-RULE-DNF-BUT-MENTIONED-IN-MERGE-DNF", 1, 0, false );
    new $hl_variable_not_mentioned_in_rule_dnf_but_mentioned_in_merge_dnf$UnaryFunction();
    SubLFiles.declareFunction( me, "bubble_up_proof_to_transformation_link", "BUBBLE-UP-PROOF-TO-TRANSFORMATION-LINK", 3, 0, false );
    SubLFiles.declareFunction( me, "transformation_proof_abnormalP_internal", "TRANSFORMATION-PROOF-ABNORMAL?-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_proof_abnormalP", "TRANSFORMATION-PROOF-ABNORMAL?", 1, 0, false );
    SubLFiles.declareFunction( me, "transformation_proof_abnormal_intP", "TRANSFORMATION-PROOF-ABNORMAL-INT?", 1, 0, false );
    SubLFiles.declareFunction( me, "proof_depends_on_excepted_assertionP", "PROOF-DEPENDS-ON-EXCEPTED-ASSERTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "supports_contain_excepted_assertionP", "SUPPORTS-CONTAIN-EXCEPTED-ASSERTION?", 1, 1, false );
    SubLFiles.declareFunction( me, "supports_contain_excepted_assertion_in_mtP", "SUPPORTS-CONTAIN-EXCEPTED-ASSERTION-IN-MT?", 2, 1, false );
    SubLFiles.declareFunction( me, "inference_backchain_forbidden_unless_arg_chosen_argnums", "INFERENCE-BACKCHAIN-FORBIDDEN-UNLESS-ARG-CHOSEN-ARGNUMS", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_backchain_forbidden_unless_arg_chosen_argnums_memoized_internal", "INFERENCE-BACKCHAIN-FORBIDDEN-UNLESS-ARG-CHOSEN-ARGNUMS-MEMOIZED-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_backchain_forbidden_unless_arg_chosen_argnums_memoized", "INFERENCE-BACKCHAIN-FORBIDDEN-UNLESS-ARG-CHOSEN-ARGNUMS-MEMOIZED", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_backchain_forbidden_unless_arg_chosen_asentP", "INFERENCE-BACKCHAIN-FORBIDDEN-UNLESS-ARG-CHOSEN-ASENT?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_backchain_forbidden_unless_arg_chosen_asent_variables", "INFERENCE-BACKCHAIN-FORBIDDEN-UNLESS-ARG-CHOSEN-ASENT-VARIABLES", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_backchain_forbidden_unless_arg_chosen_asent_variables_int", "INFERENCE-BACKCHAIN-FORBIDDEN-UNLESS-ARG-CHOSEN-ASENT-VARIABLES-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "genl_rules_enabledP", "GENL-RULES-ENABLED?", 0, 0, false );
    SubLFiles.declareFunction( me, "genl_rules", "GENL-RULES", 1, 1, false );
    SubLFiles.declareFunction( me, "max_rules", "MAX-RULES", 1, 1, false );
    return NIL;
  }

  public static SubLObject init_inference_worker_transformation_file()
  {
    $dtp_transformation_link_data$ = SubLFiles.defconstant( "*DTP-TRANSFORMATION-LINK-DATA*", $sym0$TRANSFORMATION_LINK_DATA );
    $determine_new_transformation_tactics_module$ = SubLFiles.deflexical( "*DETERMINE-NEW-TRANSFORMATION-TACTICS-MODULE*", maybeDefault( $sym48$_DETERMINE_NEW_TRANSFORMATION_TACTICS_MODULE_,
        $determine_new_transformation_tactics_module$, () -> ( inference_modules.inference_meta_transformation_module( $kw49$DETERMINE_NEW_TRANSFORMATION_TACTICS, UNPROVIDED ) ) ) );
    $transformation_tactic_iteration_threshold$ = SubLFiles.defparameter( "*TRANSFORMATION-TACTIC-ITERATION-THRESHOLD*", TWO_INTEGER );
    $stitch_up_bindings_loopP$ = SubLFiles.defparameter( "*STITCH-UP-BINDINGS-LOOP?*", T );
    ...
    $merge_dnf_lambda_var$ = SubLFiles.defparameter( "*MERGE-DNF-LAMBDA-VAR*", NIL );
    $rule_dnf_lambda_var$ = SubLFiles.defparameter( "*RULE-DNF-LAMBDA-VAR*", NIL );
    $genl_rules_enabledP$ = SubLFiles.defvar( "*GENL-RULES-ENABLED?*", T );
    return NIL;
  }

  public static SubLObject setup_inference_worker_transformation_file()
  {
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_transformation_link_data$.getGlobalValue(), Symbols.symbol_function(
    ...
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_transformation_link_data$.getGlobalValue(), Symbols.symbol_function(
        $sym26$VISIT_DEFSTRUCT_OBJECT_TRANSFORMATION_LINK_DATA_METHOD ) );
  ...
  static
  {
    ...
    $list2 = ConsesLow.list( makeSymbol( "HL-MODULE" ), makeSymbol( "BINDINGS" ), makeSymbol( "SUPPORTS" ), makeSymbol( "NON-EXPLANATORY-SUBQUERY" ) );
    $list3 = ConsesLow.list( makeKeyword( "HL-MODULE" ), makeKeyword( "BINDINGS" ), makeKeyword( "SUPPORTS" ), makeKeyword( "NON-EXPLANATORY-SUBQUERY" ) );
    $list4 = ConsesLow.list( makeSymbol( "TRANS-LINK-DATA-HL-MODULE" ), makeSymbol( "TRANS-LINK-DATA-BINDINGS" ), makeSymbol( "TRANS-LINK-DATA-SUPPORTS" ), makeSymbol( "TRANS-LINK-DATA-NON-EXPLANATORY-SUBQUERY" ) );
    $list5 = ConsesLow.list( makeSymbol( "_CSETF-TRANS-LINK-DATA-HL-MODULE" ), makeSymbol( "_CSETF-TRANS-LINK-DATA-BINDINGS" ), makeSymbol( "_CSETF-TRANS-LINK-DATA-SUPPORTS" ), makeSymbol(
        "_CSETF-TRANS-LINK-DATA-NON-EXPLANATORY-SUBQUERY" ) );
    ...
    $list8 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "TRANSFORMATION-LINK-DATA-P" ) );
    ...
    $kw17$HL_MODULE = makeKeyword( "HL-MODULE" );
    $kw18$BINDINGS = makeKeyword( "BINDINGS" );
    $kw19$SUPPORTS = makeKeyword( "SUPPORTS" );
    $kw20$NON_EXPLANATORY_SUBQUERY = makeKeyword( "NON-EXPLANATORY-SUBQUERY" );
    ...
    $kw29$TRANSFORMATION = makeKeyword( "TRANSFORMATION" );
    $kw30$FREE = makeKeyword( "FREE" );
    ...
    $list37 = ConsesLow.cons( makeSymbol( "VARIABLE" ), makeSymbol( "VALUE" ) );
    $kw38$JOIN_ORDERED = makeKeyword( "JOIN-ORDERED" );
    $kw39$RESIDUAL_TRANSFORMATION = makeKeyword( "RESIDUAL-TRANSFORMATION" );
    $list40 = ConsesLow.list( makeSymbol( "STORE" ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym41$STORE_VAR = makeUninternedSymbol( "STORE-VAR" );
    $sym42$CLET = makeSymbol( "CLET" );
    $list43 = ConsesLow.list( makeSymbol( "*HL-FAILURE-BACKCHAINING*" ), T );
    $list44 = ConsesLow.list( makeSymbol( "*UNBOUND-RULE-BACKCHAIN-ENABLED*" ), T );
    $list45 = ConsesLow.list( makeSymbol( "*EVALUATABLE-BACKCHAIN-ENABLED*" ), T );
    ...
    $kw49$DETERMINE_NEW_TRANSFORMATION_TACTICS = makeKeyword( "DETERMINE-NEW-TRANSFORMATION-TACTICS" );
    $kw50$GROSSLY_INCOMPLETE = makeKeyword( "GROSSLY-INCOMPLETE" );
    $kw51$SKIP = makeKeyword( "SKIP" );
    ...
    $list56 = ConsesLow.list( makeSymbol( "HL-MODULE" ), makeSymbol( "PRODUCTIVITY" ) );
    ...
    $kw60$TACTIC_SPECS = makeKeyword( "TACTIC-SPECS" );
    $kw61$TOTAL_PRODUCTIVITY = makeKeyword( "TOTAL-PRODUCTIVITY" );
    ...
    $list64 = ConsesLow.list( ConsesLow.list( makeSymbol( "TACTIC" ), makeSymbol( "MT" ), makeSymbol( "SENSE" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    ...
    $kw73$TRANSFORMATION_RULE_SELECT = makeKeyword( "TRANSFORMATION-RULE-SELECT" );
    ...
    $kw77$NEG = makeKeyword( "NEG" );
    $kw78$POS = makeKeyword( "POS" );
    $list79 = ConsesLow.list( makeSymbol( "MT" ), makeSymbol( "ASENT" ) );
    $const80$termOfUnit = constant_handles.reader_make_constant_shell( makeString( "termOfUnit" ) );
    ...
    $const86$InferencePSC = constant_handles.reader_make_constant_shell( makeString( "InferencePSC" ) );
    $sym87$ASSERTION_P = makeSymbol( "ASSERTION-P" );
    $kw88$RULE = makeKeyword( "RULE" );
    $const89$forwardNonTriggerLiteral = constant_handles.reader_make_constant_shell( makeString( "forwardNonTriggerLiteral" ) );
    $const90$forwardTriggerLiteral = constant_handles.reader_make_constant_shell( makeString( "forwardTriggerLiteral" ) );
    ...
    $const98$genlRules = constant_handles.reader_make_constant_shell( makeString( "genlRules" ) );
  }

  public static final class $transformation_link_data_native
      extends
        SubLStructNative
  {
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $transformation_link_data_native.class, $sym0$TRANSFORMATION_LINK_DATA, $sym1$TRANSFORMATION_LINK_DATA_P, $list2, $list3, new String[] { "$hl_module", "$bindings",
        "$supports", "$non_explanatory_subquery"
      }, $list4, $list5, $sym6$DEFAULT_STRUCT_PRINT_FUNCTION );
    }
  }

  public static final class $transformation_link_data_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $transformation_tactic_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $hl_variable_not_mentioned_in_rule_dnf_but_mentioned_in_merge_dnf$UnaryFunction
      extends
        UnaryFunction
  {
