...
import com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_subset_of;
...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_subset_of.*;
...
public final class removal_modules_subset_of extends SubLTranslatedFile {
    ...
    private static final SubLList $list6 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("FULLY-BOUND")), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("FULLY-BOUND"))), makeKeyword("COST-EXPRESSION"), makeSymbol("*REMOVAL-SUBSETOF-THESET-THESET-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-THESET-THESET-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$subsetOf (#$TheSet . <fully-bound>)(#$TheSet . <fully-bound>))"), makeKeyword("EXAMPLE"), makeString("(#$subsetOf (#$TheSet 1 2)(#$TheSet 1 2 3))") });

    private static final SubLSymbol $REMOVAL_SUBSETOF_THESET_THESET_NEG = makeKeyword("REMOVAL-SUBSETOF-THESET-THESET-NEG");

    private static final SubLList $list8 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("FULLY-BOUND")), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("FULLY-BOUND"))), makeKeyword("COST-EXPRESSION"), makeSymbol("*REMOVAL-SUBSETOF-THESET-THESET-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-THESET-THESET-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not (#$subsetOf (#$TheSet . <fully-bound>)(#$TheSet . <fully-bound>)))"), makeKeyword("EXAMPLE"), makeString("(#$not (#$subsetOf (#$TheSet 1 2 3)(#$TheSet 1 2)))") });

    private static final SubLSymbol $REMOVAL_SUBSETOF_THESET_THESETOF_POS = makeKeyword("REMOVAL-SUBSETOF-THESET-THESETOF-POS");

    private static final SubLList $list10 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("FULLY-BOUND")), cons(reader_make_constant_shell(makeString("TheSetOf")), makeKeyword("FULLY-BOUND"))), makeKeyword("COST-EXPRESSION"), makeSymbol("*REMOVAL-SUBSETOF-THESET-THESETOF-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-THESET-THESETOF-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$subsetOf\n  (#$TheSet . <fully-bound>)\n  (#$TheSetOf <variable> <fully-bound>))"), makeKeyword("EXAMPLE"), makeString("(#$subsetOf\n  (#$TheSet #$France #$Austria)\n  (#$TheSetOf ?COUNTRY\n    (#$bordersOn #$Germany ?COUNTRY)))") });

    private static final SubLSymbol $REMOVAL_SUBSETOF_THESET_THESETOF_NEG = makeKeyword("REMOVAL-SUBSETOF-THESET-THESETOF-NEG");

    private static final SubLList $list12 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("FULLY-BOUND")), cons(reader_make_constant_shell(makeString("TheSetOf")), makeKeyword("FULLY-BOUND"))), makeKeyword("COST-EXPRESSION"), makeSymbol("*REMOVAL-SUBSETOF-THESET-THESETOF-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-THESET-THESETOF-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not \n (#$subsetOf\n  (#$TheSet . <fully-bound>)\n  (#$TheSetOf <variable> <fully-bound>)))"), makeKeyword("EXAMPLE"), makeString("(#$not\n (#$subsetOf\n  (#$TheSet #$France #$Canada)\n  (#$TheSetOf ?COUNTRY\n    (#$bordersOn #$Germany ?COUNTRY))))") });
    ...
    private static final SubLList $list16 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), cons(reader_make_constant_shell(makeString("TheSetOf")), makeKeyword("FULLY-BOUND")), makeKeyword("FORT")), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-SUBSETOF-THESETOF-HYPOTHESIZE-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-THESETOF-FORT-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$subsetOf (#$TheSetOf <variable> <fully-bound>) <fort>)"), makeKeyword("EXAMPLE"), makeString("(#$subsetOf \n  (#$TheSetOf ?DOG \n    (#$and \n      (#$isa ?DOG #$Dog)\n      (#$colorOfObject ?DOG #$RedColor)))\n  #$Mammal)") });

    private static final SubLSymbol $REMOVAL_SUBSETOF_THESETOF_FORT_NEG = makeKeyword("REMOVAL-SUBSETOF-THESETOF-FORT-NEG");

    private static final SubLList $list18 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), cons(reader_make_constant_shell(makeString("TheSetOf")), makeKeyword("FULLY-BOUND")), makeKeyword("FORT")), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-SUBSETOF-THESETOF-HYPOTHESIZE-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-THESETOF-FORT-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not\n  (#$subsetOf (#$TheSetOf <variable> <fully-bound>) <fort>))"), makeKeyword("EXAMPLE"), makeString("(#$not\n  (#$subsetOf \n    (#$TheSetOf ?MAMMAL \n      (#$and \n        (#$isa ?MAMMAL #$Mammal)\n        (#$colorOfObject ?MAMMAL #$RedColor)))\n    #$Dog))") });
    ...
    private static final SubLList $list20 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), list(makeKeyword("NAT"), cons(reader_make_constant_shell(makeString("TheCollectionOf")), makeKeyword("FULLY-BOUND"))), makeKeyword("FORT")), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-GENLS-THECOLLECTIONOF-HYPOTHESIZE-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-GENLS-THECOLLECTIONOF-FORT-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$genls (#$TheCollectionOf <variable> <fully-bound>) <fort>)"), makeKeyword("EXAMPLE"), makeString("(#$genls \n  (#$TheCollectionOf ?DOG \n    (#$and \n      (#$isa ?DOG #$Dog)\n      (#$colorOfObject ?DOG #$RedColor)))\n  #$Mammal)") });
    ...
    private static final SubLList $list22 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), list(makeKeyword("NAT"), cons(reader_make_constant_shell(makeString("TheCollectionOf")), makeKeyword("FULLY-BOUND"))), makeKeyword("FORT")), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-GENLS-THECOLLECTIONOF-HYPOTHESIZE-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-GENLS-THECOLLECTIONOF-FORT-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not\n  (#$genls (#$TheCollectionOf <variable> <fully-bound>) <fort>))"), makeKeyword("EXAMPLE"), makeString("(#$not\n  (#$genls \n    (#$TheCollectionOf ?MAMMAL \n      (#$and \n        (#$isa ?MAMMAL #$Mammal)\n        (#$colorOfObject ?MAMMAL #$RedColor)))\n    #$Dog))") });
    ...
    private static final SubLList $list24 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), cons(reader_make_constant_shell(makeString("TheSetOf")), makeKeyword("FULLY-BOUND")), cons(reader_make_constant_shell(makeString("TheSetOf")), makeKeyword("FULLY-BOUND"))), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-SUBSETOF-THESETOF-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-THESETOF-THESETOF-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$subsetOf \n  (#$TheSetOf <variable> <fully-bound>) \n  (#$TheSetOf <variable> <fully-bound>))"), makeKeyword("EXAMPLE"), makeString("(#$subsetOf \n  (#$TheSetOf ?DOG \n    (#$and \n      (#$isa ?DOG #$Dog)\n      (#$colorOfObject ?DOG #$RedColor)))\n  (#$TheSetOf ?MAMMAL\n    (#$and \n      (#$isa ?MAMMAL #$Mammal)\n      (#$colorOfObject ?MAMMAL #$RedColor))))") });
    ...
    private static final SubLList $list26 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), cons(reader_make_constant_shell(makeString("TheSetOf")), makeKeyword("FULLY-BOUND")), cons(reader_make_constant_shell(makeString("TheSetOf")), makeKeyword("FULLY-BOUND"))), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-SUBSETOF-THESETOF-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-THESETOF-THESETOF-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not \n  (#$subsetOf \n    (#$TheSetOf <variable> <fully-bound>) \n    (#$TheSetOf <variable> <fully-bound>)))"), makeKeyword("EXAMPLE"), makeString("(#$not\n  (#$subsetOf \n    (#$TheSetOf ?MAMMAL\n      (#$and \n        (#$isa ?MAMMAL #$Mammal)\n        (#$colorOfObject ?MAMMAL #$RedColor)))\n    (#$TheSetOf ?DOG \n      (#$and \n        (#$isa ?DOG #$Dog)\n        (#$colorOfObject ?DOG #$RedColor)))))") });
    ...
    private static final SubLList $list28 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), list(makeKeyword("NAT"), cons(reader_make_constant_shell(makeString("TheCollectionOf")), makeKeyword("FULLY-BOUND"))), list(makeKeyword("NAT"), cons(reader_make_constant_shell(makeString("TheCollectionOf")), makeKeyword("FULLY-BOUND")))), makeKeyword("EXCLUSIVE"), makeSymbol("TRUE"), makeKeyword("SUPPLANTS"), list(makeKeyword("REMOVAL-GENLS-THECOLLECTIONOF-FORT-POS")), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-GENLS-THECOLLECTIONOF-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-GENLS-THECOLLECTIONOF-THECOLLECTIONOF-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$genls \n  (#$TheCollectionOf <variable> <fully-bound>) \n  (#$TheCollectionOf <variable> <fully-bound>))"), makeKeyword("EXAMPLE"), makeString("(#$genls \n  (#$TheCollectionOf ?DOG \n    (#$and \n      (#$isa ?DOG #$Dog)\n      (#$colorOfObject ?DOG #$RedColor)))\n  (#$TheCollectionOf ?MAMMAL\n    (#$and \n      (#$isa ?MAMMAL #$Mammal)\n      (#$colorOfObject ?MAMMAL #$RedColor))))") });
    ...
    private static final SubLList $list30 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), list(makeKeyword("NAT"), cons(reader_make_constant_shell(makeString("TheCollectionOf")), makeKeyword("FULLY-BOUND"))), list(makeKeyword("NAT"), cons(reader_make_constant_shell(makeString("TheCollectionOf")), makeKeyword("FULLY-BOUND")))), makeKeyword("EXCLUSIVE"), makeSymbol("TRUE"), makeKeyword("SUPPLANTS"), list(makeKeyword("REMOVAL-GENLS-THECOLLECTIONOF-FORT-NEG")), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-GENLS-THECOLLECTIONOF-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-GENLS-THECOLLECTIONOF-THECOLLECTIONOF-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not \n  (#$genls \n    (#$TheCollectionOf <variable> <fully-bound>) \n    (#$TheCollectionOf <variable> <fully-bound>)))"), makeKeyword("EXAMPLE"), makeString("(#$not\n  (#$genls \n    (#$TheCollectionOf ?MAMMAL\n      (#$and \n        (#$isa ?MAMMAL #$Mammal)\n        (#$colorOfObject ?MAMMAL #$RedColor)))\n    (#$TheCollectionOf ?DOG \n      (#$and \n        (#$isa ?DOG #$Dog)\n        (#$colorOfObject ?DOG #$RedColor)))))") });
    ...
    public static final SubLList $list34 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), list(makeKeyword("OR"), makeKeyword("VARIABLE"), list(makeKeyword("AND"), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("NOT-FULLY-BOUND")), list(makeKeyword("TEST"), makeSymbol("ALL-EXTENSIONAL-SET-ELEMENTS-UNBOUND?")))), list(makeKeyword("AND"), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("FULLY-BOUND")), list(makeKeyword("TEST"), makeSymbol("SMALL-EXTENSIONAL-SET-WRT-POWERSET?")))), makeKeyword("COST"), makeSymbol("REMOVAL-SUBSETOF-VARIABLE-THESET-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-VARIABLE-THESET-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$subsetOf (<variable> or (#$TheSet . <all-unbound>) (#$TheSet . <fully-bound>))"), makeKeyword("EXAMPLE"), makeString("(#$subsetOf ?SUBSET (#$TheSet 1 2 3))") });
    ...
    private static final SubLList $list39 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), list(makeKeyword("AND"), list(makeKeyword("NOT"), makeKeyword("VARIABLE")), list(makeKeyword("AND"), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("NOT-FULLY-BOUND")), list(makeKeyword("NOT"), list(makeKeyword("TEST"), makeSymbol("ALL-EXTENSIONAL-SET-ELEMENTS-UNBOUND?"))))), list(makeKeyword("AND"), cons(reader_make_constant_shell(makeString("TheSet")), makeKeyword("FULLY-BOUND")), list(makeKeyword("TEST"), makeSymbol("SMALL-EXTENSIONAL-SET-WRT-POWERSET?")))), makeKeyword("COST"), makeSymbol("REMOVAL-SUBSETOF-VARIABLE-THESET-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-NOT-FULLY-BOUND-THESET-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$subsetOf (#$TheSet . <not-fully-bound>) (#$TheSet . <fully-bound>))"), makeKeyword("EXAMPLE"), makeString("(#$subsetOf (#$TheSet 1 ?X 3) (#$TheSet 1 2 3 4))") });

    private static final SubLList $list40 = list(reader_make_constant_shell(makeString("subsetOf")), reader_make_constant_shell(makeString("TheEmptySet")), makeSymbol("?SET"));
    ...
    private static final SubLList $list43 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("subsetOf")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("subsetOf")), reader_make_constant_shell(makeString("TheEmptySet")), list(makeKeyword("AND"), makeKeyword("FULLY-BOUND"), list(makeKeyword("TEST"), makeSymbol("SET-OR-COLLECTION?")))), makeKeyword("COST-EXPRESSION"), ONE_INTEGER, makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUBSETOF-THEEMPTYSET-SET-OR-COLLECTION-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$subsetOf #$TheEmptySet <fully-bound>)\n    where <fully-bound> arg2 is also a #$Set-Mathematical or a #$Collection"), makeKeyword("EXAMPLE"), makeString(" (#$subsetOf #$TheEmptySet #$TheEmptySet)\n\n  (#$subsetOf \n  #$TheEmptySet\n  (#$TheSet #$isa #$Thing #$Collection))\n\n  (#$subsetOf \n  #$TheEmptySet\n  (#$TheSetOf ?DOG \n    (#$and \n      (#$isa ?DOG #$Dog)\n      (#$colorOfObject ?DOG #$RedColor))))\n") });
    ...
    public static SubLObject declare_removal_modules_subset_of_file() {
        declareFunction(me, "make_subsetof_hl_support", "MAKE-SUBSETOF-HL-SUPPORT", 1, 2, false);
        declareFunction(me, "removal_subsetof_theset_theset_pos_expand", "REMOVAL-SUBSETOF-THESET-THESET-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_subsetof_theset_theset_neg_expand", "REMOVAL-SUBSETOF-THESET-THESET-NEG-EXPAND", 1, 1, false);
        declareFunction(me, "removal_subsetof_theset_thesetof_pos_expand", "REMOVAL-SUBSETOF-THESET-THESETOF-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_subsetof_theset_thesetof_neg_expand", "REMOVAL-SUBSETOF-THESET-THESETOF-NEG-EXPAND", 1, 1, false);
        declareFunction(me, "removal_subsetof_thesetof_fort_pos_expand", "REMOVAL-SUBSETOF-THESETOF-FORT-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_subsetof_thesetof_fort_neg_expand", "REMOVAL-SUBSETOF-THESETOF-FORT-NEG-EXPAND", 1, 1, false);
        declareFunction(me, "removal_subsetof_thesetof_fort_expand", "REMOVAL-SUBSETOF-THESETOF-FORT-EXPAND", 2, 0, false);
        declareFunction(me, "inference_hypothesize_element", "INFERENCE-HYPOTHESIZE-ELEMENT", 1, 1, false);
        declareFunction(me, "removal_genls_thecollectionof_fort_pos_expand", "REMOVAL-GENLS-THECOLLECTIONOF-FORT-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_genls_thecollectionof_fort_neg_expand", "REMOVAL-GENLS-THECOLLECTIONOF-FORT-NEG-EXPAND", 1, 1, false);
        declareFunction(me, "removal_subsetof_thesetof_thesetof_pos_expand", "REMOVAL-SUBSETOF-THESETOF-THESETOF-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_subsetof_thesetof_thesetof_neg_expand", "REMOVAL-SUBSETOF-THESETOF-THESETOF-NEG-EXPAND", 1, 1, false);
        declareFunction(me, "removal_subsetof_thesetof_thesetof_expand", "REMOVAL-SUBSETOF-THESETOF-THESETOF-EXPAND", 2, 0, false);
        declareFunction(me, "removal_genls_thecollectionof_thecollectionof_pos_expand", "REMOVAL-GENLS-THECOLLECTIONOF-THECOLLECTIONOF-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_genls_thecollectionof_thecollectionof_neg_expand", "REMOVAL-GENLS-THECOLLECTIONOF-THECOLLECTIONOF-NEG-EXPAND", 1, 1, false);
        declareFunction(me, "removal_subsetof_variable_theset_cost", "REMOVAL-SUBSETOF-VARIABLE-THESET-COST", 1, 0, false);
        declareFunction(me, "removal_subsetof_variable_theset_expand", "REMOVAL-SUBSETOF-VARIABLE-THESET-EXPAND", 2, 0, false);
        declareFunction(me, "small_extensional_set_wrt_powersetP", "SMALL-EXTENSIONAL-SET-WRT-POWERSET?", 1, 0, false);
        declareFunction(me, "all_extensional_set_elements_unboundP", "ALL-EXTENSIONAL-SET-ELEMENTS-UNBOUND?", 1, 0, false);
        declareFunction(me, "removal_subsetof_not_fully_bound_theset_expand", "REMOVAL-SUBSETOF-NOT-FULLY-BOUND-THESET-EXPAND", 2, 0, false);
        declareFunction(me, "make_empty_set_support", "MAKE-EMPTY-SET-SUPPORT", 0, 0, false);
        declareFunction(me, "removal_subsetof_theemptyset_set_or_collection_expand", "REMOVAL-SUBSETOF-THEEMPTYSET-SET-OR-COLLECTION-EXPAND", 1, 1, false);
        return NIL;
    }
