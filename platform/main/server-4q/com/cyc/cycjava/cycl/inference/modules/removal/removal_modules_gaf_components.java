...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_gaf_components.*;
...
public final class removal_modules_gaf_components extends SubLTranslatedFile {
    ...
    private static final SubLList $list14 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("gafPredicate")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("gafPredicate")), list(makeKeyword("AND"), makeKeyword("FULLY-BOUND"), list(makeKeyword("BIND"), makeSymbol("FORMULA"))), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("COST"), makeSymbol("REMOVAL-GAF-PREDICATE-BOUND-UNBOUND-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("gafPredicate")), list(makeKeyword("BIND"), makeSymbol("FORMULA")), makeKeyword("ANYTHING")), list(list(makeKeyword("VALUE"), makeSymbol("FORMULA")))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("TUPLE"), list(makeSymbol("FORMULA")), list(makeKeyword("CALL"), makeSymbol("NON-NULL-ANSWER-TO-SINGLETON"), list(makeKeyword("CALL"), makeSymbol("FORMULA-ARG0"), list(makeKeyword("VALUE"), makeSymbol("FORMULA"))))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(reader_make_constant_shell(makeString("gafPredicate")), list(makeKeyword("VALUE"), makeSymbol("FORMULA")), makeKeyword("INPUT")), makeKeyword("SUPPORT-MODULE"), makeKeyword("GAF"), makeKeyword("SUPPORT-STRENGTH"), makeKeyword("MONOTONIC"), makeKeyword("DOCUMENTATION"), makeString("(#$gafPredicate <sentence> <not-fully-bound>)"), makeKeyword("EXAMPLE"), makeString("(#$gafPredicate (#$arity #$isa 2) ?WHAT)\n   Estimate: 2; Actual: 1\n   @todo: We could improve count-all-gafs to be mt relevant?") });
    ...
    private static final SubLList $list25 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("gafArgument")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("gafArgument")), makeKeyword("FULLY-BOUND"), makeKeyword("INTEGER"), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("COST"), makeSymbol("REMOVAL-GAF-ARGUMENT-BOUND-BOUND-UNBOUND-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("gafArgument")), list(makeKeyword("BIND"), makeSymbol("FORMULA")), list(makeKeyword("BIND"), makeSymbol("ARG-POS")), makeKeyword("ANYTHING")), list(list(makeKeyword("VALUE"), makeSymbol("FORMULA")), list(makeKeyword("VALUE"), makeSymbol("ARG-POS")))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("TUPLE"), list(makeSymbol("FORMULA"), makeSymbol("ARG-POS")), list(makeKeyword("CALL"), makeSymbol("NON-NULL-ANSWER-TO-SINGLETON"), list(makeKeyword("CALL"), makeSymbol("EL-FORMULA-ARG"), list(makeKeyword("VALUE"), makeSymbol("FORMULA")), list(makeKeyword("VALUE"), makeSymbol("ARG-POS"))))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(reader_make_constant_shell(makeString("gafArgument")), list(makeKeyword("VALUE"), makeSymbol("FORMULA")), list(makeKeyword("VALUE"), makeSymbol("ARG-POS")), makeKeyword("INPUT")), makeKeyword("SUPPORT-MODULE"), makeKeyword("GAF"), makeKeyword("SUPPORT-STRENGTH"), makeKeyword("MONOTONIC"), makeKeyword("DOCUMENTATION"), makeString("(#$gafArgument <sentence> <integer> <not-fully-bound>)"), makeKeyword("EXAMPLE"), makeString("(#$gafArgument (#$isa #$Muffet #$Poodle) 2 ?WHAT) - CyclistsMt KB 1174\n    Estimate: 1; Actual: 1 \n    (#$gafArgument (#$isa #$Muffet #$Poodle) 3 ?WHAT) - CyclistMt KB 1174\n    Estimate: 0; Actual: 0\n    (#$gafArgument (#$isa #$Muffet #$Dog) 2 ?WHAT) : False") });
    ...
    private static final SubLList $list27 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("gafArgument")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("gafArgument")), makeKeyword("FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("ANYTHING")), makeKeyword("COST"), makeSymbol("REMOVAL-GAF-ARGUMENT-BOUND-UNBOUND-UNBOUND-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("gafArgument")), list(makeKeyword("BIND"), makeSymbol("FORMULA")), makeKeyword("ANYTHING"), makeKeyword("ANYTHING")), list(list(makeKeyword("VALUE"), makeSymbol("FORMULA")))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("CALL"), makeSymbol("TERM-ARG-POS-FOR-FORMULA"), list(makeKeyword("VALUE"), makeSymbol("FORMULA"))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(makeKeyword("TUPLE"), list(makeSymbol("ARGNUM"), makeSymbol("TERM")), list(reader_make_constant_shell(makeString("gafArgument")), list(makeKeyword("VALUE"), makeSymbol("FORMULA")), list(makeKeyword("VALUE"), makeSymbol("ARGNUM")), list(makeKeyword("VALUE"), makeSymbol("TERM")))), makeKeyword("SUPPORT-MODULE"), makeKeyword("GAF"), makeKeyword("SUPPORT-STRENGTH"), makeKeyword("MONOTONIC"), makeKeyword("DOCUMENTATION"), makeString("(#$gafArgument <sentence> <not-fully-bound> <not-fully-bound>)"), makeKeyword("EXAMPLE"), makeString("(#$gafArgument (#$isa #$Muffet #$Poodle) ?X ?WHAT) - InferencePSC KB 1174\n    Estimate: 3; Actual 3; \n    (#$gafArgument (#$isa #$Muffet #$Poodle) ?X ?WHAT) - UniversalVocabularyMt KB 1174\n    Estimate: 0; Actual 0;\n    Vijay: Why is the estimate zero? Where is count-all-gafs considering relevant mt? \n\n    (#$gafArgument (#$isa #$Muffet #$Dog) ?X ?WHAT) : False   \n    Use CyclistsMt so check if some code path is looking in just-mt\n    (#$gafArgument (#$isa #$Muffet #$Poodle) ?X #$Poodle) - CyclistsMt KB 1174\n    Estimate: 1; Actual: 1;\n\n    (#$gafArgument (#$isa #$Muffet #$Poodle) ?X #$Dog) - term-occurs-as.. CyclistsMt KB 1174\n    Estimate: 0; Actual: 0;  \n    (#$gafArgument (#$isa #$Muffet #$Poodle) ?X #$genls) - formula-has-operator?\n    Estimate: 0; Actual: 0;\n\n    (#$gafArgument (#$isa #$Muffet #$Dog) ?X #$Dog) : False\n   ") });
    ...
    private static final SubLList $list33 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("gafArgument")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("gafArgument")), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("FULLY-BOUND")), makeKeyword("COST"), makeSymbol("REMOVAL-GAF-ARGUMENT-UNBOUND-UNBOUND-BOUND-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("gafArgument")), makeKeyword("ANYTHING"), makeKeyword("ANYTHING"), list(makeKeyword("BIND"), makeSymbol("TERM"))), list(list(makeKeyword("VALUE"), makeSymbol("TERM")))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("CALL"), makeSymbol("GET-GAF-ARGNUM-TUPLE-WITH-TERM"), list(makeKeyword("VALUE"), makeSymbol("TERM"))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(makeKeyword("TUPLE"), list(makeSymbol("GAF"), makeSymbol("ARGNUM")), list(reader_make_constant_shell(makeString("gafArgument")), list(makeKeyword("VALUE"), makeSymbol("GAF")), list(makeKeyword("VALUE"), makeSymbol("ARGNUM")), list(makeKeyword("VALUE"), makeSymbol("TERM")))), makeKeyword("SUPPORT-MODULE"), makeKeyword("GAF"), makeKeyword("SUPPORT-STRENGTH"), makeKeyword("MONOTONIC"), makeKeyword("DOCUMENTATION"), makeString("(#$gafArgument <not-fully-bound> <integer> <fully-bound>)"), makeKeyword("EXAMPLE"), makeString("(#$gafArgument ?GAF ?X #$Dog) in BiologyVocabularyMt KB: 1174\n   Estimate: 272; Actual: 263") });
    ...
    public static SubLObject declare_removal_modules_gaf_components_file() {
        declareFunction(me, "make_gaf_predicate_code_rule_support", "MAKE-GAF-PREDICATE-CODE-RULE-SUPPORT", 0, 0, false);
        declareFunction(me, "removal_gaf_predicate_bound_unbound_cost", "REMOVAL-GAF-PREDICATE-BOUND-UNBOUND-COST", 1, 0, false);
        declareFunction(me, "removal_gaf_predicate_unbound_bound_cost", "REMOVAL-GAF-PREDICATE-UNBOUND-BOUND-COST", 1, 0, false);
        declareFunction(me, "make_gaf_argument_code_rule_support", "MAKE-GAF-ARGUMENT-CODE-RULE-SUPPORT", 0, 0, false);
        declareFunction(me, "removal_gaf_argument_bound_bound_unbound_cost", "REMOVAL-GAF-ARGUMENT-BOUND-BOUND-UNBOUND-COST", 1, 0, false);
        declareFunction(me, "removal_gaf_argument_bound_unbound_unbound_cost", "REMOVAL-GAF-ARGUMENT-BOUND-UNBOUND-UNBOUND-COST", 1, 0, false);
        declareFunction(me, "term_arg_pos_for_formula", "TERM-ARG-POS-FOR-FORMULA", 1, 0, false);
        declareFunction(me, "removal_gaf_argument_unbound_unbound_bound_cost", "REMOVAL-GAF-ARGUMENT-UNBOUND-UNBOUND-BOUND-COST", 1, 0, false);
        declareFunction(me, "get_gafs_with_term_argnum", "GET-GAFS-WITH-TERM-ARGNUM", 2, 0, false);
        declareFunction(me, "get_gaf_argnum_tuple_with_term", "GET-GAF-ARGNUM-TUPLE-WITH-TERM", 1, 0, false);
        return NIL;
    }
