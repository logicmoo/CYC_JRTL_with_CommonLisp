...
public final class inference_worker_union
    extends
      SubLTranslatedFile
{
  ...
  {
    return makeBoolean( NIL != inference_datastructures_problem_link.problem_link_p( v_object ) && $kw0$UNION == inference_datastructures_problem_link.problem_link_type( v_object ) );
  }
  ...
  public static SubLObject maybe_new_union_link(final SubLObject supported_problem, final SubLObject supporting_mapped_problem)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, candidate_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( candidate_link, $kw0$UNION ) )
      {
  ...
  {
    final SubLObject link = inference_datastructures_problem_link.new_problem_link( $kw0$UNION, supported_problem );
    ...
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw2$SKIP ) )
    {
      ...
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$1, $kw2$SKIP ) )
      {
        ...
        for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
        {
          ...
          if( NIL == id_index.id_index_tombstone_p( inference ) || NIL == id_index.id_index_skip_tombstones_p( $kw2$SKIP ) )
          {
  ...
  public static SubLObject union_tactic_link_int(final SubLObject union_tactic)
  {
    ...
    if( NIL != disjunct_mapped_problem )
    {
          ...
          .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        if( NIL != set_contents.do_set_contents_element_validP( state, union_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( union_link, $kw0$UNION ) && disjunction_problem.eql(
  ...
  public static SubLObject find_disjunct_problem_from_contextualized_clause(final SubLObject disjunction_problem, final SubLObject disjunct_clause, final SubLObject must_be_cleanP)
  {
    ...
    final SubLObject canonical_query = inference_czer.canonicalize_problem_query( ConsesLow.list( disjunct_clause ) );
    ...
    {
      union_link = set_contents.do_set_contents_next( basis_object, state );
      if( NIL != set_contents.do_set_contents_element_validP( state, union_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( union_link, $kw0$UNION ) )
      {
  ...
  public static SubLObject find_or_create_union_link_supporting_mapped_problem(final SubLObject supported_problem, final SubLObject disjunct_index)
  {
    ...
    final SubLObject disjunct_free_hl_vars = ( NIL != inference_datastructures_problem_store.problem_store_allows_problem_hl_free_vars_optimizationP( store ) ) ? variables.sort_hl_variable_list_memoized( conses_high
        .intersection( disjunct_vars, inference_datastructures_problem.problem_free_hl_vars( supported_problem ), UNPROVIDED, UNPROVIDED ) ) : NIL;
  ...
  public static SubLObject compute_strategic_properties_of_union_tactic(final SubLObject tactic, final SubLObject disjunct_index, final SubLObject strategy)
  {
    ...
    {
      thread.resetMultipleValues();
      final SubLObject preference_level = compute_union_tactic_preference_level( problem, disjunct_index, $kw5$TACTICAL );
  ...
  public static SubLObject possibly_clean_union_tactic(final SubLObject tactic)
  {
    ...
    if( NIL == clean_disjunct_mapped_problem && NIL == inference_datastructures_tactic.tactic_discardedP( tactic ) && NIL != inference_datastructures_problem_store.$problem_store_modification_permittedP$.getDynamicValue(
        thread ) )
    {
      final SubLObject disjunction_problem = inference_datastructures_tactic.tactic_problem( tactic );
  ...
  {
    final SubLObject subproofs = ConsesLow.list( subproof );
  ...
  {
    return makeBoolean( NIL != inference_datastructures_problem_link.problem_link_p( v_object ) && $kw8$DISJUNCTIVE_ASSUMPTION == inference_datastructures_problem_link.problem_link_type( v_object ) );
  }
  ...
  {
    SubLFiles.declareFunction( me, "union_link_p", "UNION-LINK-P", 1, 0, false );
    SubLFiles.declareFunction( me, "maybe_new_union_link", "MAYBE-NEW-UNION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "new_union_link", "NEW-UNION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "destroy_union_link", "DESTROY-UNION-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "union_link_supporting_problem", "UNION-LINK-SUPPORTING-PROBLEM", 1, 0, false );
    SubLFiles.declareFunction( me, "union_link_tactic", "UNION-LINK-TACTIC", 1, 0, false );
    SubLFiles.declareFunction( me, "union_link_tactic_int", "UNION-LINK-TACTIC-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "union_tactic_p", "UNION-TACTIC-P", 1, 0, false );
    SubLFiles.declareFunction( me, "new_union_tactic", "NEW-UNION-TACTIC", 2, 0, false );
    SubLFiles.declareFunction( me, "union_tactic_disjunct_index", "UNION-TACTIC-DISJUNCT-INDEX", 1, 0, false );
    SubLFiles.declareFunction( me, "union_tactic_link", "UNION-TACTIC-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "union_tactic_link_int", "UNION-TACTIC-LINK-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "find_union_tactic_disjunct_mapped_problem", "FIND-UNION-TACTIC-DISJUNCT-MAPPED-PROBLEM", 2, 0, false );
    SubLFiles.declareFunction( me, "find_union_link_supporting_mapped_problem", "FIND-UNION-LINK-SUPPORTING-MAPPED-PROBLEM", 3, 0, false );
    SubLFiles.declareFunction( me, "find_disjunct_problem_from_contextualized_clause", "FIND-DISJUNCT-PROBLEM-FROM-CONTEXTUALIZED-CLAUSE", 3, 0, false );
    SubLFiles.declareFunction( me, "find_or_create_union_tactic_disjunct_mapped_problem", "FIND-OR-CREATE-UNION-TACTIC-DISJUNCT-MAPPED-PROBLEM", 1, 0, false );
    SubLFiles.declareFunction( me, "find_or_create_union_link_supporting_mapped_problem", "FIND-OR-CREATE-UNION-LINK-SUPPORTING-MAPPED-PROBLEM", 2, 0, false );
    SubLFiles.declareFunction( me, "determine_new_union_tactics", "DETERMINE-NEW-UNION-TACTICS", 2, 0, false );
    SubLFiles.declareFunction( me, "compute_strategic_properties_of_union_tactic", "COMPUTE-STRATEGIC-PROPERTIES-OF-UNION-TACTIC", 3, 0, false );
    SubLFiles.declareFunction( me, "compute_union_tactic_productivity", "COMPUTE-UNION-TACTIC-PRODUCTIVITY", 3, 0, false );
    SubLFiles.declareFunction( me, "compute_union_tactic_preference_level", "COMPUTE-UNION-TACTIC-PREFERENCE-LEVEL", 3, 0, false );
    SubLFiles.declareFunction( me, "union_tactic_lookahead_problem", "UNION-TACTIC-LOOKAHEAD-PROBLEM", 1, 0, false );
    SubLFiles.declareFunction( me, "execute_union_tactic", "EXECUTE-UNION-TACTIC", 1, 0, false );
    SubLFiles.declareFunction( me, "possibly_clean_union_tactic", "POSSIBLY-CLEAN-UNION-TACTIC", 1, 0, false );
    SubLFiles.declareFunction( me, "new_union_proof", "NEW-UNION-PROOF", 3, 0, false );
    SubLFiles.declareFunction( me, "bubble_up_proof_to_union_link", "BUBBLE-UP-PROOF-TO-UNION-LINK", 3, 0, false );
    SubLFiles.declareFunction( me, "disjunctive_assumption_link_p", "DISJUNCTIVE-ASSUMPTION-LINK-P", 1, 0, false );
    SubLFiles.declareFunction( me, "disjunctive_assumption_tactic_p", "DISJUNCTIVE-ASSUMPTION-TACTIC-P", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_inference_worker_union_file()
  {
    $union_module$ = SubLFiles.defparameter( "*UNION-MODULE*", inference_modules.inference_structural_module( $kw0$UNION, UNPROVIDED ) );
    $union_tactic_preference_level$ = SubLFiles.deflexical( "*UNION-TACTIC-PREFERENCE-LEVEL*", $kw6$PREFERRED );
    $union_tactic_preference_level_justification$ = SubLFiles.deflexical( "*UNION-TACTIC-PREFERENCE-LEVEL-JUSTIFICATION*", $kw6$PREFERRED );
    $disjunction_assumption_module$ = SubLFiles.defparameter( "*DISJUNCTION-ASSUMPTION-MODULE*", inference_modules.inference_structural_module( $kw8$DISJUNCTIVE_ASSUMPTION, UNPROVIDED ) );
    return NIL;
  }
  ...
  static
  {
    ...
    $kw5$TACTICAL = makeKeyword( "TACTICAL" );
    $kw6$PREFERRED = makeKeyword( "PREFERRED" );
    $sym7$UNION_TACTIC_P = makeSymbol( "UNION-TACTIC-P" );
    $kw8$DISJUNCTIVE_ASSUMPTION = makeKeyword( "DISJUNCTIVE-ASSUMPTION" );
  }
}
/*
 * 
