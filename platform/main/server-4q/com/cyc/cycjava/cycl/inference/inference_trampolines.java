...
public final class inference_trampolines extends SubLTranslatedFile {
    ...
    public static final SubLSymbol INFERENCE_PARTIALLY_COMMUTATIVE_PREDICATE_P = makeSymbol("INFERENCE-PARTIALLY-COMMUTATIVE-PREDICATE-P");
    ...
    public static final SubLSymbol INFERENCE_ALL_PROPER_SPEC_PREDICATES_WITH_AXIOM_INDEX_INT = makeSymbol("INFERENCE-ALL-PROPER-SPEC-PREDICATES-WITH-AXIOM-INDEX-INT");
    ...
    private static final SubLList $list62 = list(reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("genls")));
    ...
    private static final SubLObject $$highlyRelevantPredAssertion = reader_make_constant_shell(makeString("highlyRelevantPredAssertion"));

    private static final SubLObject $$highlyRelevantTerm = reader_make_constant_shell(makeString("highlyRelevantTerm"));

    private static final SubLObject $$irrelevantMt = reader_make_constant_shell(makeString("irrelevantMt"));

    private static final SubLObject $$irrelevantAssertion = reader_make_constant_shell(makeString("irrelevantAssertion"));

    private static final SubLObject $$irrelevantPredAssertion = reader_make_constant_shell(makeString("irrelevantPredAssertion"));

    private static final SubLObject $$irrelevantTerm = reader_make_constant_shell(makeString("irrelevantTerm"));

    private static final SubLObject $$assertionUtility = reader_make_constant_shell(makeString("assertionUtility"));
    ...
    public static SubLObject declare_inference_trampolines_file() {
        declareFunction(me, "inference_atomic_term_p", "INFERENCE-ATOMIC-TERM-P", 1, 0, false);
        declareFunction(me, "inference_collectionP", "INFERENCE-COLLECTION?", 1, 1, false);
        declareFunction(me, "inference_predicate_p", "INFERENCE-PREDICATE-P", 1, 0, false);
        new inference_trampolines.$inference_predicate_p$UnaryFunction();
        declareFunction(me, "inference_commutative_relationP", "INFERENCE-COMMUTATIVE-RELATION?", 1, 0, false);
        declareFunction(me, "inference_symmetric_predicateP", "INFERENCE-SYMMETRIC-PREDICATE?", 1, 0, false);
        new inference_trampolines.$inference_symmetric_predicateP$UnaryFunction();
        declareFunction(me, "inference_commutative_predicate_p", "INFERENCE-COMMUTATIVE-PREDICATE-P", 1, 0, false);
        new inference_trampolines.$inference_commutative_predicate_p$UnaryFunction();
        declareFunction(me, "inference_partially_commutative_predicate_p_internal", "INFERENCE-PARTIALLY-COMMUTATIVE-PREDICATE-P-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_partially_commutative_predicate_p", "INFERENCE-PARTIALLY-COMMUTATIVE-PREDICATE-P", 1, 0, false);
        new inference_trampolines.$inference_partially_commutative_predicate_p$UnaryFunction();
        declareFunction(me, "inference_at_least_partially_commutative_predicate_p", "INFERENCE-AT-LEAST-PARTIALLY-COMMUTATIVE-PREDICATE-P", 1, 0, false);
        declareFunction(me, "inference_asymmetric_predicateP", "INFERENCE-ASYMMETRIC-PREDICATE?", 1, 0, false);
        declareFunction(me, "inference_transitive_predicateP", "INFERENCE-TRANSITIVE-PREDICATE?", 1, 0, false);
        new inference_trampolines.$inference_transitive_predicateP$UnaryFunction();
        declareFunction(me, "inference_evaluatable_predicateP", "INFERENCE-EVALUATABLE-PREDICATE?", 1, 0, false);
        new inference_trampolines.$inference_evaluatable_predicateP$UnaryFunction();
        declareFunction(me, "inference_reflexive_predicateP", "INFERENCE-REFLEXIVE-PREDICATE?", 1, 0, false);
        new inference_trampolines.$inference_reflexive_predicateP$UnaryFunction();
        declareFunction(me, "inference_irreflexive_predicateP", "INFERENCE-IRREFLEXIVE-PREDICATE?", 1, 0, false);
        declareFunction(me, "inference_indeterminate_termP", "INFERENCE-INDETERMINATE-TERM?", 1, 0, false);
        declareFunction(me, "clear_indeterminate_term_p", "CLEAR-INDETERMINATE-TERM-P", 0, 0, false);
        new inference_trampolines.$clear_indeterminate_term_p$ZeroArityFunction();
        declareFunction(me, "remove_indeterminate_term_p", "REMOVE-INDETERMINATE-TERM-P", 1, 0, false);
        declareFunction(me, "indeterminate_term_p_internal", "INDETERMINATE-TERM-P-INTERNAL", 1, 0, false);
        declareFunction(me, "indeterminate_term_p", "INDETERMINATE-TERM-P", 1, 0, false);
        declareFunction(me, "memoized_inference_indeterminate_termP_internal", "MEMOIZED-INFERENCE-INDETERMINATE-TERM?-INTERNAL", 1, 0, false);
        declareFunction(me, "memoized_inference_indeterminate_termP", "MEMOIZED-INFERENCE-INDETERMINATE-TERM?", 1, 0, false);
        declareFunction(me, "inference_some_genl_pred_or_inverseP", "INFERENCE-SOME-GENL-PRED-OR-INVERSE?", 1, 0, false);
        new inference_trampolines.$inference_some_genl_pred_or_inverseP$UnaryFunction();
        declareFunction(me, "inference_some_spec_pred_or_inverseP", "INFERENCE-SOME-SPEC-PRED-OR-INVERSE?", 1, 0, false);
        new inference_trampolines.$inference_some_spec_pred_or_inverseP$UnaryFunction();
        declareFunction(me, "inference_some_negation_pred_or_inverseP", "INFERENCE-SOME-NEGATION-PRED-OR-INVERSE?", 1, 0, false);
        declareFunction(me, "inference_all_genl_predicates_internal", "INFERENCE-ALL-GENL-PREDICATES-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_all_genl_predicates", "INFERENCE-ALL-GENL-PREDICATES", 1, 0, false);
        declareFunction(me, "inference_all_spec_predicates", "INFERENCE-ALL-SPEC-PREDICATES", 1, 0, false);
        declareFunction(me, "inference_all_spec_predicates_int_internal", "INFERENCE-ALL-SPEC-PREDICATES-INT-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_all_spec_predicates_int", "INFERENCE-ALL-SPEC-PREDICATES-INT", 1, 0, false);
        declareFunction(me, "inference_all_genl_inverses_internal", "INFERENCE-ALL-GENL-INVERSES-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_all_genl_inverses", "INFERENCE-ALL-GENL-INVERSES", 1, 0, false);
        declareFunction(me, "inference_all_spec_inverses", "INFERENCE-ALL-SPEC-INVERSES", 1, 0, false);
        declareFunction(me, "inference_all_spec_inverses_int_internal", "INFERENCE-ALL-SPEC-INVERSES-INT-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_all_spec_inverses_int", "INFERENCE-ALL-SPEC-INVERSES-INT", 1, 0, false);
        declareFunction(me, "inference_all_proper_genl_predicates_with_axiom_index_internal", "INFERENCE-ALL-PROPER-GENL-PREDICATES-WITH-AXIOM-INDEX-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_all_proper_genl_predicates_with_axiom_index", "INFERENCE-ALL-PROPER-GENL-PREDICATES-WITH-AXIOM-INDEX", 2, 0, false);
        declareFunction(me, "inference_all_proper_spec_predicates_with_axiom_index", "INFERENCE-ALL-PROPER-SPEC-PREDICATES-WITH-AXIOM-INDEX", 2, 0, false);
        declareFunction(me, "inference_all_proper_spec_predicates_with_axiom_index_int_internal", "INFERENCE-ALL-PROPER-SPEC-PREDICATES-WITH-AXIOM-INDEX-INT-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_all_proper_spec_predicates_with_axiom_index_int", "INFERENCE-ALL-PROPER-SPEC-PREDICATES-WITH-AXIOM-INDEX-INT", 2, 0, false);
        declareFunction(me, "inference_all_proper_genl_inverses_with_axiom_index_internal", "INFERENCE-ALL-PROPER-GENL-INVERSES-WITH-AXIOM-INDEX-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_all_proper_genl_inverses_with_axiom_index", "INFERENCE-ALL-PROPER-GENL-INVERSES-WITH-AXIOM-INDEX", 2, 0, false);
        declareFunction(me, "inference_all_proper_spec_inverses_with_axiom_index", "INFERENCE-ALL-PROPER-SPEC-INVERSES-WITH-AXIOM-INDEX", 2, 0, false);
        declareFunction(me, "inference_all_proper_spec_inverses_with_axiom_index_int_internal", "INFERENCE-ALL-PROPER-SPEC-INVERSES-WITH-AXIOM-INDEX-INT-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_all_proper_spec_inverses_with_axiom_index_int", "INFERENCE-ALL-PROPER-SPEC-INVERSES-WITH-AXIOM-INDEX-INT", 2, 0, false);
        declareFunction(me, "inference_all_negation_predicates_with_axiom_index_internal", "INFERENCE-ALL-NEGATION-PREDICATES-WITH-AXIOM-INDEX-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_all_negation_predicates_with_axiom_index", "INFERENCE-ALL-NEGATION-PREDICATES-WITH-AXIOM-INDEX", 2, 0, false);
        declareFunction(me, "inference_some_max_floor_mts", "INFERENCE-SOME-MAX-FLOOR-MTS", 1, 0, false);
        declareFunction(me, "clear_some_max_floor_mtsP_cached", "CLEAR-SOME-MAX-FLOOR-MTS?-CACHED", 0, 0, false);
        declareFunction(me, "remove_some_max_floor_mtsP_cached", "REMOVE-SOME-MAX-FLOOR-MTS?-CACHED", 1, 0, false);
        declareFunction(me, "some_max_floor_mtsP_cached_internal", "SOME-MAX-FLOOR-MTS?-CACHED-INTERNAL", 1, 0, false);
        declareFunction(me, "some_max_floor_mtsP_cached", "SOME-MAX-FLOOR-MTS?-CACHED", 1, 0, false);
        declareFunction(me, "inference_max_floor_mts_with_cycles_pruned", "INFERENCE-MAX-FLOOR-MTS-WITH-CYCLES-PRUNED", 1, 1, false);
        declareFunction(me, "clear_inference_max_floor_mts_with_cycles_pruned_cached", "CLEAR-INFERENCE-MAX-FLOOR-MTS-WITH-CYCLES-PRUNED-CACHED", 0, 0, false);
        declareFunction(me, "remove_inference_max_floor_mts_with_cycles_pruned_cached", "REMOVE-INFERENCE-MAX-FLOOR-MTS-WITH-CYCLES-PRUNED-CACHED", 1, 0, false);
        declareFunction(me, "inference_max_floor_mts_with_cycles_pruned_cached_internal", "INFERENCE-MAX-FLOOR-MTS-WITH-CYCLES-PRUNED-CACHED-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_max_floor_mts_with_cycles_pruned_cached", "INFERENCE-MAX-FLOOR-MTS-WITH-CYCLES-PRUNED-CACHED", 1, 0, false);
        declareFunction(me, "inference_max_floor_mts_of_nat_internal", "INFERENCE-MAX-FLOOR-MTS-OF-NAT-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_max_floor_mts_of_nat", "INFERENCE-MAX-FLOOR-MTS-OF-NAT", 1, 0, false);
        declareFunction(me, "some_max_floor_mtsP", "SOME-MAX-FLOOR-MTS?", 1, 0, false);
        declareFunction(me, "inference_applicable_sdctP_internal", "INFERENCE-APPLICABLE-SDCT?-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_applicable_sdctP", "INFERENCE-APPLICABLE-SDCT?", 1, 0, false);
        declareFunction(me, "expression_has_inference_excepted_assertionP_iteration_helper", "EXPRESSION-HAS-INFERENCE-EXCEPTED-ASSERTION?-ITERATION-HELPER", 1, 0, false);
        declareFunction(me, "expression_has_inference_excepted_assertionP", "EXPRESSION-HAS-INFERENCE-EXCEPTED-ASSERTION?", 1, 0, false);
        declareFunction(me, "inference_excepted_assertionP", "INFERENCE-EXCEPTED-ASSERTION?", 1, 1, false);
        declareFunction(me, "memoized_inference_excepted_assertionP_internal", "MEMOIZED-INFERENCE-EXCEPTED-ASSERTION?-INTERNAL", 3, 0, false);
        declareFunction(me, "memoized_inference_excepted_assertionP", "MEMOIZED-INFERENCE-EXCEPTED-ASSERTION?", 3, 0, false);
        declareFunction(me, "inference_excepted_assertionP_shallow", "INFERENCE-EXCEPTED-ASSERTION?-SHALLOW", 1, 1, false);
        declareFunction(me, "memoized_inference_excepted_assertionP_shallow_internal", "MEMOIZED-INFERENCE-EXCEPTED-ASSERTION?-SHALLOW-INTERNAL", 3, 0, false);
        declareFunction(me, "memoized_inference_excepted_assertionP_shallow", "MEMOIZED-INFERENCE-EXCEPTED-ASSERTION?-SHALLOW", 3, 0, false);
        ...
        declareFunction(me, "inference_gaf_lookup_index_internal", "INFERENCE-GAF-LOOKUP-INDEX-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_gaf_lookup_index", "INFERENCE-GAF-LOOKUP-INDEX", 2, 0, false);
        declareFunction(me, "inference_num_gaf_lookup_index_internal", "INFERENCE-NUM-GAF-LOOKUP-INDEX-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_num_gaf_lookup_index", "INFERENCE-NUM-GAF-LOOKUP-INDEX", 2, 0, false);
        declareFunction(me, "inference_relevant_num_gaf_lookup_index_internal", "INFERENCE-RELEVANT-NUM-GAF-LOOKUP-INDEX-INTERNAL", 3, 0, false);
        declareFunction(me, "inference_relevant_num_gaf_lookup_index", "INFERENCE-RELEVANT-NUM-GAF-LOOKUP-INDEX", 3, 0, false);
        declareFunction(me, "inference_argnums_from_gafs_mentioning_term_internal", "INFERENCE-ARGNUMS-FROM-GAFS-MENTIONING-TERM-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_argnums_from_gafs_mentioning_term", "INFERENCE-ARGNUMS-FROM-GAFS-MENTIONING-TERM", 1, 0, false);
        declareFunction(me, "inference_preds_from_gafs_mentioning_term_at_index_internal", "INFERENCE-PREDS-FROM-GAFS-MENTIONING-TERM-AT-INDEX-INTERNAL", 1, 1, false);
        declareFunction(me, "inference_preds_from_gafs_mentioning_term_at_index", "INFERENCE-PREDS-FROM-GAFS-MENTIONING-TERM-AT-INDEX", 1, 1, false);
        declareFunction(me, "inference_key_gaf_arg_index_internal", "INFERENCE-KEY-GAF-ARG-INDEX-INTERNAL", 1, 2, false);
        declareFunction(me, "inference_key_gaf_arg_index", "INFERENCE-KEY-GAF-ARG-INDEX", 1, 2, false);
        declareFunction(me, "compute_problem_backchain_requiredP", "COMPUTE-PROBLEM-BACKCHAIN-REQUIRED?", 1, 0, false);
        declareFunction(me, "inference_some_backchain_required_asent_in_clauseP", "INFERENCE-SOME-BACKCHAIN-REQUIRED-ASENT-IN-CLAUSE?", 1, 0, false);
        declareFunction(me, "inference_backchain_required_contextualized_asentP", "INFERENCE-BACKCHAIN-REQUIRED-CONTEXTUALIZED-ASENT?", 1, 0, false);
        declareFunction(me, "inference_backchain_required_asentP", "INFERENCE-BACKCHAIN-REQUIRED-ASENT?", 2, 0, false);
        declareFunction(me, "inference_predicate_backchain_requiredP_internal", "INFERENCE-PREDICATE-BACKCHAIN-REQUIRED?-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_predicate_backchain_requiredP", "INFERENCE-PREDICATE-BACKCHAIN-REQUIRED?", 2, 0, false);
        declareFunction(me, "inference_backchain_forbiddenP_internal", "INFERENCE-BACKCHAIN-FORBIDDEN?-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_backchain_forbiddenP", "INFERENCE-BACKCHAIN-FORBIDDEN?", 2, 0, false);
        declareFunction(me, "inference_collection_isa_backchain_encouragedP_internal", "INFERENCE-COLLECTION-ISA-BACKCHAIN-ENCOURAGED?-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_collection_isa_backchain_encouragedP", "INFERENCE-COLLECTION-ISA-BACKCHAIN-ENCOURAGED?", 2, 0, false);
        declareFunction(me, "inference_collection_genls_backchain_encouragedP_internal", "INFERENCE-COLLECTION-GENLS-BACKCHAIN-ENCOURAGED?-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_collection_genls_backchain_encouragedP", "INFERENCE-COLLECTION-GENLS-BACKCHAIN-ENCOURAGED?", 2, 0, false);
        declareFunction(me, "inference_collection_backchain_encouragedP_internal", "INFERENCE-COLLECTION-BACKCHAIN-ENCOURAGED?-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_collection_backchain_encouragedP", "INFERENCE-COLLECTION-BACKCHAIN-ENCOURAGED?", 2, 0, false);
        declareFunction(me, "inference_collection_backchain_requiredP_internal", "INFERENCE-COLLECTION-BACKCHAIN-REQUIRED?-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_collection_backchain_requiredP", "INFERENCE-COLLECTION-BACKCHAIN-REQUIRED?", 2, 0, false);
        declareFunction(me, "inference_collection_isa_backchain_requiredP_internal", "INFERENCE-COLLECTION-ISA-BACKCHAIN-REQUIRED?-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_collection_isa_backchain_requiredP", "INFERENCE-COLLECTION-ISA-BACKCHAIN-REQUIRED?", 2, 0, false);
        declareFunction(me, "inference_collection_genls_backchain_requiredP_internal", "INFERENCE-COLLECTION-GENLS-BACKCHAIN-REQUIRED?-INTERNAL", 2, 0, false);
        declareFunction(me, "inference_collection_genls_backchain_requiredP", "INFERENCE-COLLECTION-GENLS-BACKCHAIN-REQUIRED?", 2, 0, false);
        declareFunction(me, "backchain_control_mt", "BACKCHAIN-CONTROL-MT", 1, 0, false);
        declareFunction(me, "inference_relevant_mtP", "INFERENCE-RELEVANT-MT?", 1, 1, false);
        declareFunction(me, "inference_relevant_assertionP", "INFERENCE-RELEVANT-ASSERTION?", 1, 1, false);
        declareFunction(me, "inference_relevant_predicate_assertionP", "INFERENCE-RELEVANT-PREDICATE-ASSERTION?", 2, 1, false);
        declareFunction(me, "inference_relevant_termP", "INFERENCE-RELEVANT-TERM?", 1, 1, false);
        declareFunction(me, "inference_irrelevant_mtP", "INFERENCE-IRRELEVANT-MT?", 1, 1, false);
        declareFunction(me, "inference_irrelevant_assertionP", "INFERENCE-IRRELEVANT-ASSERTION?", 1, 1, false);
        declareFunction(me, "inference_irrelevant_predicate_assertionP", "INFERENCE-IRRELEVANT-PREDICATE-ASSERTION?", 2, 1, false);
        declareFunction(me, "inference_irrelevant_termP", "INFERENCE-IRRELEVANT-TERM?", 1, 1, false);
        declareFunction(me, "inference_rule_has_utilityP", "INFERENCE-RULE-HAS-UTILITY?", 1, 1, false);
        declareFunction(me, "inference_rule_utility", "INFERENCE-RULE-UTILITY", 1, 1, false);
        declareFunction(me, "inference_known_sentence_removal_query_internal", "INFERENCE-KNOWN-SENTENCE-REMOVAL-QUERY-INTERNAL", 2, 1, false);
        declareFunction(me, "inference_known_sentence_removal_query", "INFERENCE-KNOWN-SENTENCE-REMOVAL-QUERY", 2, 1, false);
        declareFunction(me, "inference_known_sentence_recursive_query", "INFERENCE-KNOWN-SENTENCE-RECURSIVE-QUERY", 2, 1, false);
        declareFunction(me, "inference_true_sentence_recursion_cycleP", "INFERENCE-TRUE-SENTENCE-RECURSION-CYCLE?", 1, 0, false);
        declareFunction(me, "inference_true_sentence_recursive_query_internal", "INFERENCE-TRUE-SENTENCE-RECURSIVE-QUERY-INTERNAL", 2, 2, false);
        declareFunction(me, "inference_true_sentence_recursive_query", "INFERENCE-TRUE-SENTENCE-RECURSIVE-QUERY", 2, 2, false);
        declareFunction(me, "inference_mts_where_gaf_sentence_true_internal", "INFERENCE-MTS-WHERE-GAF-SENTENCE-TRUE-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_mts_where_gaf_sentence_true", "INFERENCE-MTS-WHERE-GAF-SENTENCE-TRUE", 1, 0, false);
        declareFunction(me, "inference_mts_where_gaf_sentence_true_justified_memoized_internal", "INFERENCE-MTS-WHERE-GAF-SENTENCE-TRUE-JUSTIFIED-MEMOIZED-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_mts_where_gaf_sentence_true_justified_memoized", "INFERENCE-MTS-WHERE-GAF-SENTENCE-TRUE-JUSTIFIED-MEMOIZED", 1, 0, false);
        declareFunction(me, "inference_mts_where_gaf_sentence_true_justified", "INFERENCE-MTS-WHERE-GAF-SENTENCE-TRUE-JUSTIFIED", 1, 0, false);
        declareFunction(me, "determine_sentence_recursive_query_properties", "DETERMINE-SENTENCE-RECURSIVE-QUERY-PROPERTIES", 2, 0, false);
        declareFunction(me, "determine_sentence_recursive_query_properties_recursive", "DETERMINE-SENTENCE-RECURSIVE-QUERY-PROPERTIES-RECURSIVE", 2, 0, false);
        declareFunction(me, "inference_rule_type_constraints_internal", "INFERENCE-RULE-TYPE-CONSTRAINTS-INTERNAL", 1, 0, false);
        declareFunction(me, "inference_rule_type_constraints", "INFERENCE-RULE-TYPE-CONSTRAINTS", 1, 0, false);
        return NIL;
    }
	 ...
	 * @param tactic_problem
	 * @return
	 */
	public static SubLBoolean problem_backchain_requiredP(SubLObject tactic_problem) {
