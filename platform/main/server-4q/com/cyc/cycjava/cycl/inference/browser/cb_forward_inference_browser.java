...
public class cb_forward_inference_browser extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.browser.cb_forward_inference_browser";
    ...
    public static SubLObject declare_cb_forward_inference_browser_file() {
        declareFunction(myName, "cb_forward_inference_clump_lookup_by_id", "CB-FORWARD-INFERENCE-CLUMP-LOOKUP-BY-ID", 1, 0, false);
        declareFunction(myName, "forward_inference_clump_print_function_trampoline", "FORWARD-INFERENCE-CLUMP-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(myName, "forward_inference_clump_p", "FORWARD-INFERENCE-CLUMP-P", 1, 0, false);
        new $forward_inference_clump_p$UnaryFunction();
        declareFunction(myName, "fwd_inf_clump_id", "FWD-INF-CLUMP-ID", 1, 0, false);
        declareFunction(myName, "fwd_inf_clump_timestamp", "FWD-INF-CLUMP-TIMESTAMP", 1, 0, false);
        declareFunction(myName, "fwd_inf_clump_triggering_assertion", "FWD-INF-CLUMP-TRIGGERING-ASSERTION", 1, 0, false);
        declareFunction(myName, "fwd_inf_clump_inference_infos", "FWD-INF-CLUMP-INFERENCE-INFOS", 1, 0, false);
        declareFunction(myName, "_csetf_fwd_inf_clump_id", "_CSETF-FWD-INF-CLUMP-ID", 2, 0, false);
        declareFunction(myName, "_csetf_fwd_inf_clump_timestamp", "_CSETF-FWD-INF-CLUMP-TIMESTAMP", 2, 0, false);
        declareFunction(myName, "_csetf_fwd_inf_clump_triggering_assertion", "_CSETF-FWD-INF-CLUMP-TRIGGERING-ASSERTION", 2, 0, false);
        declareFunction(myName, "_csetf_fwd_inf_clump_inference_infos", "_CSETF-FWD-INF-CLUMP-INFERENCE-INFOS", 2, 0, false);
        declareFunction(myName, "make_forward_inference_clump", "MAKE-FORWARD-INFERENCE-CLUMP", 0, 1, false);
        declareFunction(myName, "visit_defstruct_forward_inference_clump", "VISIT-DEFSTRUCT-FORWARD-INFERENCE-CLUMP", 2, 0, false);
        declareFunction(myName, "visit_defstruct_object_forward_inference_clump_method", "VISIT-DEFSTRUCT-OBJECT-FORWARD-INFERENCE-CLUMP-METHOD", 2, 0, false);
        declareFunction(myName, "valid_forward_inference_clump_p", "VALID-FORWARD-INFERENCE-CLUMP-P", 1, 0, false);
        declareFunction(myName, "new_forward_inference_clump", "NEW-FORWARD-INFERENCE-CLUMP", 1, 0, false);
        declareMacro(me, "do_forward_inference_clump_inference_infos", "DO-FORWARD-INFERENCE-CLUMP-INFERENCE-INFOS");
        declareFunction(myName, "destroy_forward_inference_clump", "DESTROY-FORWARD-INFERENCE-CLUMP", 1, 0, false);
        declareFunction(myName, "forward_inference_clump_id", "FORWARD-INFERENCE-CLUMP-ID", 1, 0, false);
        declareFunction(myName, "forward_inference_clump_timestamp", "FORWARD-INFERENCE-CLUMP-TIMESTAMP", 1, 0, false);
        declareFunction(myName, "forward_inference_clump_triggering_assertion", "FORWARD-INFERENCE-CLUMP-TRIGGERING-ASSERTION", 1, 0, false);
        declareFunction(myName, "forward_inference_clump_inference_infos", "FORWARD-INFERENCE-CLUMP-INFERENCE-INFOS", 1, 0, false);
        declareFunction(myName, "add_forward_inference_info_to_clump", "ADD-FORWARD-INFERENCE-INFO-TO-CLUMP", 2, 0, false);
        declareFunction(myName, "forward_inference_clump_total_answer_count", "FORWARD-INFERENCE-CLUMP-TOTAL-ANSWER-COUNT", 1, 0, false);
        declareFunction(myName, "forward_inference_info_print_function_trampoline", "FORWARD-INFERENCE-INFO-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(myName, "forward_inference_info_p", "FORWARD-INFERENCE-INFO-P", 1, 0, false);
        new $forward_inference_info_p$UnaryFunction();
        declareFunction(myName, "fwd_inf_info_inference", "FWD-INF-INFO-INFERENCE", 1, 0, false);
        declareFunction(myName, "fwd_inf_info_rule", "FWD-INF-INFO-RULE", 1, 0, false);
        declareFunction(myName, "fwd_inf_info_more_info", "FWD-INF-INFO-MORE-INFO", 1, 0, false);
        declareFunction(myName, "_csetf_fwd_inf_info_inference", "_CSETF-FWD-INF-INFO-INFERENCE", 2, 0, false);
        declareFunction(myName, "_csetf_fwd_inf_info_rule", "_CSETF-FWD-INF-INFO-RULE", 2, 0, false);
        declareFunction(myName, "_csetf_fwd_inf_info_more_info", "_CSETF-FWD-INF-INFO-MORE-INFO", 2, 0, false);
        declareFunction(myName, "make_forward_inference_info", "MAKE-FORWARD-INFERENCE-INFO", 0, 1, false);
        declareFunction(myName, "visit_defstruct_forward_inference_info", "VISIT-DEFSTRUCT-FORWARD-INFERENCE-INFO", 2, 0, false);
        declareFunction(myName, "visit_defstruct_object_forward_inference_info_method", "VISIT-DEFSTRUCT-OBJECT-FORWARD-INFERENCE-INFO-METHOD", 2, 0, false);
        declareFunction(myName, "valid_forward_inference_info_p", "VALID-FORWARD-INFERENCE-INFO-P", 1, 0, false);
        declareFunction(myName, "new_forward_inference_info", "NEW-FORWARD-INFERENCE-INFO", 2, 1, false);
        declareFunction(myName, "destroy_inference_info", "DESTROY-INFERENCE-INFO", 1, 0, false);
        declareFunction(myName, "forward_inference_info_inference", "FORWARD-INFERENCE-INFO-INFERENCE", 1, 0, false);
        declareFunction(myName, "forward_inference_info_rule", "FORWARD-INFERENCE-INFO-RULE", 1, 0, false);
        declareFunction(myName, "forward_inference_info_more_info", "FORWARD-INFERENCE-INFO-MORE-INFO", 1, 0, false);
        declareFunction(myName, "inference_info_G", "INFERENCE-INFO->", 2, 0, false);
        declareFunction(myName, "inference_info_L", "INFERENCE-INFO-<", 2, 0, false);
        declareFunction(myName, "cb_current_forward_inference_clump", "CB-CURRENT-FORWARD-INFERENCE-CLUMP", 0, 0, false);
        declareMacro(me, "do_current_forward_inference_infos", "DO-CURRENT-FORWARD-INFERENCE-INFOS");
        declareFunction(myName, "cb_forward_inference_browser", "CB-FORWARD-INFERENCE-BROWSER", 0, 1, false);
        declareFunction(myName, "cb_link_forward_inference_browser", "CB-LINK-FORWARD-INFERENCE-BROWSER", 0, 1, false);
        declareFunction(myName, "cb_forward_inference_browser_int", "CB-FORWARD-INFERENCE-BROWSER-INT", 1, 1, false);
        declareFunction(myName, "cb_fib_trigger_support_link_name", "CB-FIB-TRIGGER-SUPPORT-LINK-NAME", 2, 0, false);
        declareFunction(myName, "cb_fib_next_trigger_support_link_name", "CB-FIB-NEXT-TRIGGER-SUPPORT-LINK-NAME", 2, 0, false);
        declareFunction(myName, "cb_forward_inference_browser_show_infos", "CB-FORWARD-INFERENCE-BROWSER-SHOW-INFOS", 2, 0, false);
        declareFunction(myName, "cb_note_new_forward_inference_for_browsing", "CB-NOTE-NEW-FORWARD-INFERENCE-FOR-BROWSING", 2, 1, false);
        declareFunction(myName, "prepare_to_browse_new_forward_inference", "PREPARE-TO-BROWSE-NEW-FORWARD-INFERENCE", 1, 0, false);
        declareFunction(myName, "cleanup_from_browsing_new_forward_inference", "CLEANUP-FROM-BROWSING-NEW-FORWARD-INFERENCE", 0, 0, false);
        return NIL;
    }
