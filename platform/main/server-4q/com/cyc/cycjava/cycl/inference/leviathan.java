      ...
      SubLTranslatedFile
{
  ...
  private static final SubLFloat $float$0_8;
  ...
  private static final SubLInteger $int$1000000;
  ...
  public static SubLObject determine_leviathan_training_and_blind_sets_int(final SubLObject unsorted_col, final SubLObject training_col, final SubLObject blind_col)
  {
    ...
    final SubLObject split = Numbers.round( Numbers.multiply( length, $float$0_8 ), UNPROVIDED );
  ...
  public static SubLObject init_leviathan_file()
  {
    ...
    $leviathan_crtl_internal_time_units_per_second$ = SubLFiles.deflexical( "*LEVIATHAN-CRTL-INTERNAL-TIME-UNITS-PER-SECOND*", $int$1000000 );
  ...
  static
  {
    ...
    $const27$KBContentLeviathanQuery = makeConstSym(( "KBContentLeviathanQuery" ) );
    $const28$HALOLeviathanQuery = makeConstSym(( "HALOLeviathanQuery" ) );
    $const29$AutogeneratedLeviathanQuery = makeConstSym(( "AutogeneratedLeviathanQuery" ) );
    ...
    $const57$isa = makeConstSym(( "isa" ) );
    $list58 = ConsesLow.list( makeConstSym(( "AutogeneratedLeviathanQuery-Uncrippled" ) ) );
    $const59$UniversalVocabularyMt = makeConstSym(( "UniversalVocabularyMt" ) );
    $list60 = ConsesLow.list( makeConstSym(( "AutogeneratedLeviathanQuery-Crippled" ) ) );
    $const61$TestVocabularyMt = makeConstSym(( "TestVocabularyMt" ) );
    $const62$softwareParameterValueInSpecifica = makeConstSym(( "softwareParameterValueInSpecification" ) );
    $const63$InferenceMaxTransformationStepsPa = makeConstSym(( "InferenceMaxTransformationStepsParameter" ) );
    $list64 = ConsesLow.list( makeConstSym(( "canonicalizerDirectiveForArg" ) ), makeConstSym((
        "softwareParameterValueInSpecification" ) ), TWO_INTEGER, makeConstSym(( "LeaveSomeTermsAtEL" ) ) );
    $const65$UniversalVocabularyImplementation = makeConstSym(( "UniversalVocabularyImplementationMt" ) );
    $const66$InferenceAllowedRulesParameter = makeConstSym(( "InferenceAllowedRulesParameter" ) );
    ...
    $list74 = ConsesLow.list( makeConstSym(( "AutogeneratedHaystackQuery" ) ) );
    $const75$AutogeneratedLeviathanQuery_Uncri = makeConstSym(( "AutogeneratedLeviathanQuery-Uncrippled" ) );
    $str76$deep_queries_with_1_backchain = makeString( "deep-queries-with-1-backchain" );
    $list77 = ConsesLow.list( makeConstSym(( "KBContentLeviathanQuery" ) ) );
    $const78$KBContentLeviathanQuery_Training = makeConstSym(( "KBContentLeviathanQuery-Training" ) );
    $const79$KBContentLeviathanQuery_Blind = makeConstSym(( "KBContentLeviathanQuery-Blind" ) );
    $const80$HALOLeviathanQuery_Training = makeConstSym(( "HALOLeviathanQuery-Training" ) );
    $const81$HALOLeviathanQuery_Blind = makeConstSym(( "HALOLeviathanQuery-Blind" ) );
    $const82$AutogeneratedLeviathanQuery_Uncri = makeConstSym(( "AutogeneratedLeviathanQuery-Uncrippled-Training" ) );
    $const83$AutogeneratedLeviathanQuery_Uncri = makeConstSym(( "AutogeneratedLeviathanQuery-Uncrippled-Blind" ) );
    $const84$AutogeneratedLeviathanQuery_Cripp = makeConstSym(( "AutogeneratedLeviathanQuery-Crippled" ) );
    $const85$AutogeneratedLeviathanQuery_Cripp = makeConstSym(( "AutogeneratedLeviathanQuery-Crippled-Training" ) );
    $const86$AutogeneratedLeviathanQuery_Cripp = makeConstSym(( "AutogeneratedLeviathanQuery-Crippled-Blind" ) );
    $float$0_8 = makeDouble( 0.8 );
    ...
    $const95$TheList = makeConstSym(( "TheList" ) );
    $const96$LeviathanQuery_Training = makeConstSym(( "LeviathanQuery-Training" ) );
    ...
    $const120$skolem = makeConstSym(( "skolem" ) );
    ...
    $const141$AutogeneratedLeviathanQuery_Train = makeConstSym(( "AutogeneratedLeviathanQuery-Training" ) );
    $const142$CycLQuerySpecification = makeConstSym(( "CycLQuerySpecification" ) );
    $kw143$CONDITIONAL_SENTENCE_ = makeKeyword( "CONDITIONAL-SENTENCE?" );
    $const144$BaseKB = makeConstSym(( "BaseKB" ) );
    $const145$InferenceConditionalSentenceParam = makeConstSym(( "InferenceConditionalSentenceParameter" ) );
    $const146$True = makeConstSym(( "True" ) );
    ...
    $list161 = ConsesLow.list( makeConstSym(( "HALOLeviathanQuery" ) ) );
    ...
    $int$1000000 = makeInteger( 1000000 );
    ...
    $list240 = ConsesLow.list( makeConstSym(( "doppelgangers" ) ), makeConstSym(( "termOfUnit" ) ), makeConstSym(( "genTemplate" ) ), makeConstSym(( "genTemplate-Constrained" ) ), makeConstSym((
            "genTemplate-QuerySentence" ) ), makeConstSym(( "detailedIsaParaphrase" ) ) );
    ...
    $const245$doppelgangers = makeConstSym(( "doppelgangers" ) );
    $const246$BookkeepingMt = makeConstSym(( "BookkeepingMt" ) );
    ...
    $list252 = ConsesLow.list( makeConstSym(( "isa" ) ), makeConstSym(( "doppelgangers" ) ), makeConstSym(( "BinaryPredicate" ) ) );
    $list253 = ConsesLow.list( makeConstSym(( "isa" ) ), makeConstSym(( "doppelgangers" ) ), makeConstSym(( "FunctionalPredicate" ) ) );
    $list254 = ConsesLow.list( makeConstSym(( "comment" ) ), makeConstSym(( "doppelgangers" ) ), makeString(
        "(#$doppelgangers ORIGINAL-TERM DOPPELGANGER) means that DOPPELGANGER was cloned from ORIGINAL-TERM." ) );
    $list255 = ConsesLow.list( makeConstSym(( "arg1QuotedIsa" ) ), makeConstSym(( "doppelgangers" ) ), makeConstSym(( "CycLClosedDenotationalTerm" ) ) );
    $list256 = ConsesLow.list( makeConstSym(( "arg2QuotedIsa" ) ), makeConstSym(( "doppelgangers" ) ), makeConstSym(( "CycLClosedDenotationalTerm" ) ) );
    $list257 = ConsesLow.list( makeConstSym(( "functionalInArgs" ) ), makeConstSym(( "doppelgangers" ) ), ONE_INTEGER );
  }
}
/*
 *
