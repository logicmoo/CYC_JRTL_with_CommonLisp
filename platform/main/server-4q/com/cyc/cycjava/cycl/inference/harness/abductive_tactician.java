...
import com.cyc.cycjava.cycl.inference.harness.abductive_tactician;
...
import static com.cyc.cycjava.cycl.inference.harness.abductive_tactician.*;
...
public final class abductive_tactician extends SubLTranslatedFile {
    ...
    public static SubLObject declare_abductive_tactician_file() {
        declareFunction(me, "abductive_strategy_p", "ABDUCTIVE-STRATEGY-P", 1, 0, false);
        return NIL;
    }
