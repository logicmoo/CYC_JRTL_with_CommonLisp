...
import com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relevant_similar_queries;
...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_relevant_similar_queries.*;
...
public final class removal_modules_relevant_similar_queries extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLList $list0 = list(reader_make_constant_shell(makeString("NoAmountFn")), reader_make_constant_shell(makeString("Relevance")));

    private static final SubLFloat $float$0_25 = makeDouble(0.25);

    public static final SubLList $list2 = list(reader_make_constant_shell(makeString("LowAmountFn")), reader_make_constant_shell(makeString("Relevance")));

    private static final SubLFloat $float$0_5 = makeDouble(0.5);

    public static final SubLList $list4 = list(reader_make_constant_shell(makeString("MediumAmountFn")), reader_make_constant_shell(makeString("Relevance")));

    private static final SubLFloat $float$0_75 = makeDouble(0.75);

    public static final SubLList $list6 = list(reader_make_constant_shell(makeString("HighAmountFn")), reader_make_constant_shell(makeString("Relevance")));

    public static final SubLList $list7 = list(reader_make_constant_shell(makeString("VeryHighAmountFn")), reader_make_constant_shell(makeString("Relevance")));

    private static final SubLObject $const8$querySpecificationForFormulaTempl = reader_make_constant_shell(makeString("querySpecificationForFormulaTemplate"));



    private static final SubLObject $$pertinentQuerySentenceWithTerms = reader_make_constant_shell(makeString("pertinentQuerySentenceWithTerms"));
    ...
    private static final SubLList $list13 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("pertinentQuerySentenceWithTerms")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("pertinentQuerySentenceWithTerms")), makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*PERTINENT-QUERY-SENTENCE-WITH-TERMS-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("pertinentQuerySentenceWithTerms")), list(makeKeyword("BIND"), makeSymbol("INPUT-SENTENCE")), list(makeKeyword("BIND"), makeSymbol("TERM-SET")), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND")), list(list(makeKeyword("VALUE"), makeSymbol("INPUT-SENTENCE")), list(makeKeyword("VALUE"), makeSymbol("TERM-SET")))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("CALL"), makeSymbol("PERTINENT-QUERY-SENTENCES-WITH-TERMS"), list(makeKeyword("VALUE"), makeSymbol("INPUT-SENTENCE")), list(makeKeyword("VALUE"), makeSymbol("TERM-SET"))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(makeKeyword("TUPLE"), list(makeSymbol("NEW-SENTENCE"), makeSymbol("SUBST-COUNT")), list(reader_make_constant_shell(makeString("pertinentQuerySentenceWithTerms")), list(makeKeyword("VALUE"), makeSymbol("INPUT-SENTENCE")), list(makeKeyword("VALUE"), makeSymbol("TERM-SET")), list(makeKeyword("VALUE"), makeSymbol("NEW-SENTENCE")), list(makeKeyword("VALUE"), makeSymbol("SUBST-COUNT")))), makeKeyword("DOCUMENTATION"), makeString("(#$formulaForStringPertinentToDegreeFromFolderOfType <string> <not-fully-bound> <not-fully-bound> <fully-bound>)"), makeKeyword("EXAMPLE"), makeString("(#$formulaForStringPertinentToDegreeFromFolderOfType \"al Qaeda\" ?QUERY ?RELEVANCE #$FolderWithIntelligenceQueriesForSuggestion)") });
    ...
    private static final SubLObject $const16$termInSentenceOfQuerySpecificatio = reader_make_constant_shell(makeString("termInSentenceOfQuerySpecificationOfType"));
    ...
    private static final SubLList $list18 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("termInSentenceOfQuerySpecificationOfType")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("termInSentenceOfQuerySpecificationOfType")), makeKeyword("FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("FULLY-BOUND")), makeKeyword("COST"), makeSymbol("TERM-IN-SENTENCE-OF-QUERY-SPECIFICATION-OF-TYPE-POS-UNIFY-ARG2-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("termInSentenceOfQuerySpecificationOfType")), list(makeKeyword("BIND"), makeSymbol("TERM")), makeKeyword("NOT-FULLY-BOUND"), list(makeKeyword("BIND"), makeSymbol("FOLDER-TYPE"))), list(list(makeKeyword("VALUE"), makeSymbol("TERM")), list(makeKeyword("VALUE"), makeSymbol("FOLDER-TYPE")))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("CALL"), makeSymbol("TERM-IN-SENTENCE-OF-QUERY-SPECIFICATION-OF-TYPE-POS-UNIFY-ARG2-ITERATOR"), list(makeKeyword("VALUE"), makeSymbol("TERM")), list(makeKeyword("VALUE"), makeSymbol("FOLDER-TYPE"))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(reader_make_constant_shell(makeString("termInSentenceOfQuerySpecificationOfType")), list(makeKeyword("VALUE"), makeSymbol("TERM")), makeKeyword("INPUT"), list(makeKeyword("VALUE"), makeSymbol("FOLDER-TYPE"))), makeKeyword("DOCUMENTATION"), makeString("(#$termInSentenceOfQuerySpecificationOfType <fully-bound> <not-fully-bound> <fully-bound>)"), makeKeyword("EXAMPLE"), makeString("(#$termInSentenceOfQuerySpecificationOfType #$AlQaida ?CYCL-Q-SPEC #$FolderWithIntelligenceQueriesForSuggestion)") });

    private static final SubLObject $$folderContainsResource = reader_make_constant_shell(makeString("folderContainsResource"));

    private static final SubLObject $const20$sentenceParameterValueInSpecifica = reader_make_constant_shell(makeString("sentenceParameterValueInSpecification"));

    private static final SubLList $list21 = list(makeSymbol("ARG-POS"), makeSymbol("SUBSTITUTIONS"));

    public static final SubLList $list22 = list(makeSymbol("FORMULA"), makeSymbol("FORMULA-WEIGHT"), makeSymbol("SUBSTITUTION-COUNT"));

    public static final SubLList $list23 = list(makeSymbol("TERM"), makeSymbol("SUBST-WEIGHT"));
    ...
    public static SubLObject declare_removal_modules_relevant_similar_queries_file() {
        declareFunction(me, "relevance_for_query", "RELEVANCE-FOR-QUERY", 1, 0, false);
        declareFunction(me, "formula_for_query", "FORMULA-FOR-QUERY", 1, 0, false);
        declareFunction(me, "pertinent_query_sentences_with_terms", "PERTINENT-QUERY-SENTENCES-WITH-TERMS", 2, 0, false);
        declareFunction(me, "term_in_sentence_of_query_specification_of_type_pos_unify_arg2_cost", "TERM-IN-SENTENCE-OF-QUERY-SPECIFICATION-OF-TYPE-POS-UNIFY-ARG2-COST", 1, 0, false);
        declareFunction(me, "term_in_sentence_of_query_specification_of_type_pos_unify_arg2_iterator", "TERM-IN-SENTENCE-OF-QUERY-SPECIFICATION-OF-TYPE-POS-UNIFY-ARG2-ITERATOR", 2, 0, false);
        declareFunction(me, "term_in_sentence_of_query_specification_of_type_pos_unify_arg2", "TERM-IN-SENTENCE-OF-QUERY-SPECIFICATION-OF-TYPE-POS-UNIFY-ARG2", 2, 0, false);
        declareFunction(me, "substitute_sentence_terms_into_query", "SUBSTITUTE-SENTENCE-TERMS-INTO-QUERY", 2, 0, false);
        declareFunction(me, "substitute_query", "SUBSTITUTE-QUERY", 3, 0, false);
        declareFunction(me, "substitute_query_terms_into_cycl", "SUBSTITUTE-QUERY-TERMS-INTO-CYCL", 2, 1, false);
        declareFunction(me, "query_subst_string_denots", "QUERY-SUBST-STRING-DENOTS", 1, 0, false);
        declareFunction(me, "query_subst_find_substitutable_terms", "QUERY-SUBST-FIND-SUBSTITUTABLE-TERMS", 1, 0, false);
        declareFunction(me, "substitution_gather_term", "SUBSTITUTION-GATHER-TERM", 1, 0, false);
        declareFunction(me, "substitution_weight", "SUBSTITUTION-WEIGHT", 3, 1, false);
        declareFunction(me, "filter_unsubstitutable_terms_for_argpos", "FILTER-UNSUBSTITUTABLE-TERMS-FOR-ARGPOS", 4, 1, false);
        declareFunction(me, "meets_heuristic_substitution_constraints", "MEETS-HEURISTIC-SUBSTITUTION-CONSTRAINTS", 5, 0, false);
        declareFunction(me, "term_already_in_literalP", "TERM-ALREADY-IN-LITERAL?", 3, 0, false);
        declareFunction(me, "terms_of_same_orderP", "TERMS-OF-SAME-ORDER?", 2, 0, false);
        declareFunction(me, "my_term_order", "MY-TERM-ORDER", 1, 0, false);
        return NIL;
    }
