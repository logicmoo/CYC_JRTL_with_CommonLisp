...
public final class inference_ipc_queue_processor extends SubLTranslatedFile {
    ...
    public static SubLObject inf_ipcq_processor_inference(final SubLObject v_object) {
        assert NIL != inference_ipc_queue_processor_p(v_object) : "inference_ipc_queue_processor.inference_ipc_queue_processor_p error :" + v_object;
    ...
    public static final class $inference_ipc_queue_processor_native extends SubLStructNative {
        ...
        private $inference_ipc_queue_processor_native() {
        ...
        static {
            structDecl = makeStructDeclNative($inference_ipc_queue_processor_native.class, INFERENCE_IPC_QUEUE_PROCESSOR, INFERENCE_IPC_QUEUE_PROCESSOR_P, $list8, $list9, new String[]{ "$inference", "$ipc_queue", "$inference_answer_process_function", "$nl_generation_properties", "$minimum_time_before_sending_new_answers", "$incremental_resultsP", "$next_answer_index", "$results", "$doneP", "$last_answer_post_time", "$message_queue", "$inference_process", "$inference_death_counter" }, $list10, $list11, PRINT_INFERENCE_IPC_QUEUE_PROCESSOR);
        }
    }
