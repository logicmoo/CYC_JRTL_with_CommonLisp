...
import static com.cyc.cycjava.cycl.inference.harness.inference_worker_rewrite.*;
...
public final class inference_worker_rewrite extends SubLTranslatedFile {
    ...
    public static SubLObject rewrite_link_data_p(final SubLObject v_object) {
        return v_object.getClass() == inference_worker_rewrite.$rewrite_link_data_native.class ? T : NIL;
    }

    public static SubLObject rw_link_data_hl_module(final SubLObject v_object) {
        assert NIL != rewrite_link_data_p(v_object) : "inference_worker_rewrite.rewrite_link_data_p(v_object) " + "CommonSymbols.NIL != inference_worker_rewrite.rewrite_link_data_p(v_object) " + v_object;
    ...
    public static SubLObject make_rewrite_link_data(SubLObject arglist) {
        ...
        final SubLObject v_new = new inference_worker_rewrite.$rewrite_link_data_native();
        SubLObject next;
    ...
    public static final class $rewrite_link_data_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_worker_rewrite.$rewrite_link_data_native.class, REWRITE_LINK_DATA, REWRITE_LINK_DATA_P, $list2, $list3, new String[]{ "$hl_module", "$bindings", "$supports" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
