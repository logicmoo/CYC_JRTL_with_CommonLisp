      ...
      SubLTranslatedFile
{
  ...
  public static SubLObject inference_complete_extent_asserted_for_value_in_arg_gafs(final SubLObject predicate, final SubLObject value, final SubLObject argnum, final SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym1$INFERENCE_COMPLETE_EXTENT_ASSERTED_FOR_VALUE_IN_ARG_GAFS, FOUR_INTEGER, $int2$8192,
          EQL, UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( inference_complete_extent_asserted_for_value_in_arg_gafs_internal( predicate, value, argnum, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( predicate, value, argnum, mt ) );
  ...
  public static SubLObject inference_complete_extent_enumerable_gafs(final SubLObject predicate, final SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym3$INFERENCE_COMPLETE_EXTENT_ENUMERABLE_GAFS, TWO_INTEGER, $int2$8192, EQL, UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( inference_complete_extent_enumerable_gafs_internal( predicate, mt ) ) );
  ...
  public static SubLObject inference_complete_extent_decidable_gafs_internal(final SubLObject predicate, SubLObject mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      gafs = ConsesLow.cons( stronger_gaf, gafs );
      cdolist_list_var = cdolist_list_var.rest();
      stronger_gaf = cdolist_list_var.first();
    }
    final SubLObject mt_var = mt_relevance_macros.with_inference_mt_relevance_validate( mt );
  ...
  public static SubLObject inference_complete_extent_decidable_gafs(final SubLObject predicate, final SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym4$INFERENCE_COMPLETE_EXTENT_DECIDABLE_GAFS, TWO_INTEGER, $int2$8192, EQL, UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( inference_complete_extent_decidable_gafs_internal( predicate, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( predicate, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject inference_complete_extent_enumerable_for_arg_gafs(final SubLObject predicate, final SubLObject argnum, final SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym5$INFERENCE_COMPLETE_EXTENT_ENUMERABLE_FOR_ARG_GAFS, THREE_INTEGER, $int2$8192, EQL,
          UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( inference_complete_extent_enumerable_for_arg_gafs_internal( predicate, argnum, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( predicate, argnum, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject inference_complete_extent_enumerable_for_value_in_arg_gafs(final SubLObject predicate, final SubLObject value, final SubLObject argnum, final SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym6$INFERENCE_COMPLETE_EXTENT_ENUMERABLE_FOR_VALUE_IN_ARG_GAFS, FOUR_INTEGER, $int2$8192,
          EQL, UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( inference_complete_extent_enumerable_for_value_in_arg_gafs_internal( predicate, value, argnum, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( predicate, value, argnum, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject inference_complete_extent_decidable_for_value_in_arg_gafs(final SubLObject predicate, final SubLObject value, final SubLObject argnum, final SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym7$INFERENCE_COMPLETE_EXTENT_DECIDABLE_FOR_VALUE_IN_ARG_GAFS, FOUR_INTEGER, $int2$8192,
          EQL, UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( inference_complete_extent_decidable_for_value_in_arg_gafs_internal( predicate, value, argnum, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( predicate, value, argnum, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject inference_completely_decidable_collection_gafs(final SubLObject collection, final SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym8$INFERENCE_COMPLETELY_DECIDABLE_COLLECTION_GAFS, TWO_INTEGER, $int2$8192, EQL,
          UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( inference_completely_decidable_collection_gafs_internal( collection, mt ) ) );
  ...
  public static SubLObject inference_completely_asserted_asent_gafs(final SubLObject asent, SubLObject mt)
  {
    ...
    if( NIL != forts.fort_p( predicate ) )
    {
      ...
      if( NIL != equals.unique_names_assumption_applicable_to_all_argsP( asent ) )
      {
        ...
        if( NIL != var )
        {
          result_gafs = ConsesLow.cons( var, result_gafs );
        }
      }
      final SubLObject terms = cycl_utilities.formula_terms( asent, $kw9$IGNORE );
        ...
        if( NIL != variables.fully_bound_p( value ) )
        {
          ...
          if( NIL != gafs && NIL != equals.unique_names_assumption_applicable_to_all_args_exceptP( asent, argnum ) )
          {
            ...
            while ( NIL != cdolist_list_var)
            {
              ...
              {
                result_gafs = ConsesLow.cons( item_var, result_gafs );
              }
              cdolist_list_var = cdolist_list_var.rest();
              gaf2 = cdolist_list_var.first();
            }
  ...
  public static SubLObject inference_completely_enumerable_asent_gafs(final SubLObject asent, SubLObject mt)
  {
    ...
    if( NIL != forts.fort_p( predicate ) )
    {
      ...
      if( NIL != gafs && NIL != equals.unique_names_assumption_applicable_to_all_argsP( asent ) )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          result_gafs = ConsesLow.cons( gaf, result_gafs );
          cdolist_list_var = cdolist_list_var.rest();
          gaf = cdolist_list_var.first();
        }
      }
      if( $const10$isa.eql( predicate ) )
      {
        ...
        if( NIL != forts.fort_p( collection ) )
        {
          ...
          {
            result_gafs = ConsesLow.cons( gaf2, result_gafs );
          }
        }
      }
      ...
      terms = cycl_utilities.formula_terms( asent, $kw9$IGNORE );
      list_var = NIL;
      value = NIL;
      argnum = NIL;
      list_var = terms;
        ...
        if( NIL != forts.fort_p( collection ) )
        {
          ...
          if( NIL != gafs2 && NIL != equals.unique_names_assumption_applicable_to_termP( cycl_utilities.atomic_sentence_arg1( asent, UNPROVIDED ) ) )
          {
            ...
            while ( NIL != cdolist_list_var2)
            {
              ...
              {
                result_gafs = ConsesLow.cons( item_var2, result_gafs );
              }
              cdolist_list_var2 = cdolist_list_var2.rest();
              gaf3 = cdolist_list_var2.first();
            }
        ...
        if( NIL != variables.fully_bound_p( value ) )
        {
          ...
          if( NIL != gafs3 && NIL != equals.unique_names_assumption_applicable_to_all_args_exceptP( asent, argnum ) )
          {
            ...
            while ( NIL != cdolist_list_var3)
            {
              ...
              {
                result_gafs = ConsesLow.cons( item_var3, result_gafs );
              }
  ...
  public static SubLObject inference_complete_extent_enumerable_via_backchain_gafs(final SubLObject predicate, final SubLObject mt)
  {
    ...
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym11$INFERENCE_COMPLETE_EXTENT_ENUMERABLE_VIA_BACKCHAIN_GAFS, TWO_INTEGER, $int2$8192, EQL,
          UNPROVIDED );
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( inference_complete_extent_enumerable_via_backchain_gafs_internal( predicate, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( predicate, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  {
    SubLFiles.declareFunction( me, "inference_minimize_extentP_internal", "INFERENCE-MINIMIZE-EXTENT?-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "inference_minimize_extentP", "INFERENCE-MINIMIZE-EXTENT?", 1, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_assertedP", "INFERENCE-COMPLETE-EXTENT-ASSERTED?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_asserted_gaf", "INFERENCE-COMPLETE-EXTENT-ASSERTED-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_asserted_for_value_in_argP", "INFERENCE-COMPLETE-EXTENT-ASSERTED-FOR-VALUE-IN-ARG?", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_asserted_for_value_in_arg_gaf", "INFERENCE-COMPLETE-EXTENT-ASSERTED-FOR-VALUE-IN-ARG-GAF", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_asserted_for_value_in_arg_gafs_internal", "INFERENCE-COMPLETE-EXTENT-ASSERTED-FOR-VALUE-IN-ARG-GAFS-INTERNAL", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_asserted_for_value_in_arg_gafs", "INFERENCE-COMPLETE-EXTENT-ASSERTED-FOR-VALUE-IN-ARG-GAFS", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerableP", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_gaf", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_gafs_internal", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-GAFS-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_gafs", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-GAFS", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_decidableP", "INFERENCE-COMPLETE-EXTENT-DECIDABLE?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_decidable_gaf", "INFERENCE-COMPLETE-EXTENT-DECIDABLE-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_decidable_gafs_internal", "INFERENCE-COMPLETE-EXTENT-DECIDABLE-GAFS-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_decidable_gafs", "INFERENCE-COMPLETE-EXTENT-DECIDABLE-GAFS", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_for_argP", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-FOR-ARG?", 3, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_for_arg_gaf", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-FOR-ARG-GAF", 3, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_for_arg_gafs_internal", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-FOR-ARG-GAFS-INTERNAL", 3, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_for_arg_gafs", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-FOR-ARG-GAFS", 3, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_for_value_in_argP", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-FOR-VALUE-IN-ARG?", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_for_value_in_arg_gaf", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-FOR-VALUE-IN-ARG-GAF", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_for_value_in_arg_gafs_internal", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-FOR-VALUE-IN-ARG-GAFS-INTERNAL", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_for_value_in_arg_gafs", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-FOR-VALUE-IN-ARG-GAFS", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_decidable_for_value_in_argP", "INFERENCE-COMPLETE-EXTENT-DECIDABLE-FOR-VALUE-IN-ARG?", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_decidable_for_value_in_arg_gaf", "INFERENCE-COMPLETE-EXTENT-DECIDABLE-FOR-VALUE-IN-ARG-GAF", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_decidable_for_value_in_arg_gafs_internal", "INFERENCE-COMPLETE-EXTENT-DECIDABLE-FOR-VALUE-IN-ARG-GAFS-INTERNAL", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_decidable_for_value_in_arg_gafs", "INFERENCE-COMPLETE-EXTENT-DECIDABLE-FOR-VALUE-IN-ARG-GAFS", 4, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_enumerable_collectionP", "INFERENCE-COMPLETELY-ENUMERABLE-COLLECTION?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_enumerable_collection_gaf", "INFERENCE-COMPLETELY-ENUMERABLE-COLLECTION-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_decidable_collectionP", "INFERENCE-COMPLETELY-DECIDABLE-COLLECTION?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_decidable_collection_gaf", "INFERENCE-COMPLETELY-DECIDABLE-COLLECTION-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_decidable_collection_gafs_internal", "INFERENCE-COMPLETELY-DECIDABLE-COLLECTION-GAFS-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_decidable_collection_gafs", "INFERENCE-COMPLETELY-DECIDABLE-COLLECTION-GAFS", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_asentP", "INFERENCE-COMPLETE-ASENT?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_asserted_asentP", "INFERENCE-COMPLETELY-ASSERTED-ASENT?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_asserted_asent_gaf", "INFERENCE-COMPLETELY-ASSERTED-ASENT-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_asserted_asent_gafs", "INFERENCE-COMPLETELY-ASSERTED-ASENT-GAFS", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_enumerable_asentP", "INFERENCE-COMPLETELY-ENUMERABLE-ASENT?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_enumerable_asent_gaf", "INFERENCE-COMPLETELY-ENUMERABLE-ASENT-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_enumerable_asent_gafs", "INFERENCE-COMPLETELY-ENUMERABLE-ASENT-GAFS", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_decidable_asentP", "INFERENCE-COMPLETELY-DECIDABLE-ASENT?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_decidable_asent_gaf", "INFERENCE-COMPLETELY-DECIDABLE-ASENT-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_decidable_asent_gafs", "INFERENCE-COMPLETELY-DECIDABLE-ASENT-GAFS", 2, 0, false );
    SubLFiles.declareFunction( me, "completeness_constraint_mt", "COMPLETENESS-CONSTRAINT-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_via_backchainP", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-VIA-BACKCHAIN?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_via_backchain_gaf", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-VIA-BACKCHAIN-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_via_backchain_gafs_internal", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-VIA-BACKCHAIN-GAFS-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_complete_extent_enumerable_via_backchain_gafs", "INFERENCE-COMPLETE-EXTENT-ENUMERABLE-VIA-BACKCHAIN-GAFS", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_collection_completely_enumerable_via_backchainP", "INFERENCE-COLLECTION-COMPLETELY-ENUMERABLE-VIA-BACKCHAIN?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_collection_completely_enumerable_via_backchain_gaf", "INFERENCE-COLLECTION-COMPLETELY-ENUMERABLE-VIA-BACKCHAIN-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_enumerable_via_backchain_asentP", "INFERENCE-COMPLETELY-ENUMERABLE-VIA-BACKCHAIN-ASENT?", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_enumerable_via_backchain_asent_gaf", "INFERENCE-COMPLETELY-ENUMERABLE-VIA-BACKCHAIN-ASENT-GAF", 2, 0, false );
    SubLFiles.declareFunction( me, "inference_completely_enumerable_via_backchain_asent_gafs", "INFERENCE-COMPLETELY-ENUMERABLE-VIA-BACKCHAIN-ASENT-GAFS", 2, 0, false );
    return NIL;
  }
