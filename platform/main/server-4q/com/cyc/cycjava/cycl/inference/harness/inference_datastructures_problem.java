...
public final class inference_datastructures_problem extends SubLTranslatedFile {
    ...
    public static final SubLString $$$Ignore_the_crazy_problems = makeString("Ignore the crazy problems");
    ...
    public static final SubLSymbol $ARGUMENT_LINK_BINDINGS_INDEX = makeKeyword("ARGUMENT-LINK-BINDINGS-INDEX");
    ...
    public static final SubLSymbol $GENERALIZED_REMOVAL_OR_REWRITE = makeKeyword("GENERALIZED-REMOVAL-OR-REWRITE");
    ...
    public static final SubLList $list3 = list(new SubLObject[] { makeSymbol("SUID"), makeSymbol("STORE"), makeSymbol("QUERY"), makeSymbol("FREE-HL-VARS"), makeSymbol("STATUS"), makeSymbol("DEPENDENT-LINKS"), makeSymbol("ARGUMENT-LINKS"), makeSymbol("TACTICS"), makeSymbol("PROOF-BINDINGS-INDEX"),
	    makeSymbol("ARGUMENT-LINK-BINDINGS-INDEX"), makeSymbol("BACKCHAIN-REQUIRED"), makeSymbol("MEMOIZATION-STATE") });

    public static final SubLList $list4 = list(new SubLObject[] { makeKeyword("SUID"), makeKeyword("STORE"), makeKeyword("QUERY"), makeKeyword("FREE-HL-VARS"), makeKeyword("STATUS"), makeKeyword("DEPENDENT-LINKS"), makeKeyword("ARGUMENT-LINKS"), makeKeyword("TACTICS"),
    ...
    public static final SubLList $list5 = list(new SubLObject[] { makeSymbol("PROB-SUID"), makeSymbol("PROB-STORE"), makeSymbol("PROB-QUERY"), makeSymbol("PROB-FREE-HL-VARS"), makeSymbol("PROB-STATUS"), makeSymbol("PROB-DEPENDENT-LINKS"), makeSymbol("PROB-ARGUMENT-LINKS"),
    ...
    public static final SubLList $list6 = list(new SubLObject[] { makeSymbol("_CSETF-PROB-SUID"), makeSymbol("_CSETF-PROB-STORE"), makeSymbol("_CSETF-PROB-QUERY"), makeSymbol("_CSETF-PROB-FREE-HL-VARS"), makeSymbol("_CSETF-PROB-STATUS"), makeSymbol("_CSETF-PROB-DEPENDENT-LINKS"),
    ...
    //  public static final SubLSymbol $PROOF_BINDINGS_INDEX = makeKeyword("PROOF-BINDINGS-INDEX");
    ...
    public static final SubLList alt_list100 = list(list(makeSymbol("LINK-VAR"), makeSymbol("MAPPED-PROBLEM-VAR"), makeSymbol("PROBLEM"), makeSymbol("&KEY"), makeSymbol("TYPE"), makeSymbol("OPEN?"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list101 = list(makeKeyword("TYPE"), makeKeyword("OPEN?"), makeKeyword("DONE"));

    public static final SubLList alt_list107 = list(list(makeSymbol("SUPPORTED-PROBLEM-VAR"), makeSymbol("PROBLEM"), makeSymbol("&KEY"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list110 = list(list(makeSymbol("SUPPORTED-INFERENCE-VAR"), makeSymbol("PROBLEM")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list113 = list(list(makeSymbol("SUPPORTING-PROBLEM-VAR"), makeSymbol("VARIABLE-MAP-VAR"), makeSymbol("PROBLEM")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list116 = list(list(makeSymbol("PROOF-VAR"), makeSymbol("PROBLEM"), makeSymbol("&KEY"), makeSymbol("PROOF-STATUS"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list117 = list(makeKeyword("PROOF-STATUS"), makeKeyword("DONE"));

    public static final SubLList alt_list127 = list(list(makeSymbol("INFERENCE-VAR"), makeSymbol("PROBLEM")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list131 = list(list(makeSymbol("INFERENCE-VAR"), makeSymbol("PROBLEM"), makeSymbol("&KEY"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list137 = list(list(makeSymbol("STRATEGY-VAR"), makeSymbol("PROBLEM")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list142 = list(list(makeSymbol("STRATEGY-VAR"), makeSymbol("PROBLEM"), makeSymbol("&KEY"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list146 = list(list(makeSymbol("STRATEGIC-CONTEXT-VAR"), makeSymbol("PROBLEM"), makeSymbol("&KEY"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list148 = list(makeKeyword("TACTICAL"));

    public static final SubLList alt_list153 = list(makeSymbol("MT"), makeSymbol("ASENT"));

    public static final SubLList alt_list158 = list(makeSymbol("DNF-CLAUSE"));

    public static final SubLList alt_list3 = list(
    ...
    public static final SubLList alt_list4 = list(
	    new SubLObject[] { makeKeyword("SUID"), makeKeyword("STORE"), makeKeyword("QUERY"), makeKeyword("STATUS"), makeKeyword("DEPENDENT-LINKS"), makeKeyword("ARGUMENT-LINKS"), makeKeyword("TACTICS"), makeKeyword("PROOF-BINDINGS-INDEX"), makeKeyword("ARGUMENT-LINK-BINDINGS-INDEX") });

    public static final SubLList alt_list47 = list(list(makeSymbol("ASENT-VAR"), makeSymbol("MT-VAR"), makeSymbol("SENSE-VAR"), makeSymbol("PROBLEM"), makeSymbol("&KEY"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list48 = list(makeKeyword("DONE"));

    public static final SubLList alt_list5 = list(new SubLObject[] { makeSymbol("PROB-SUID"), makeSymbol("PROB-STORE"), makeSymbol("PROB-QUERY"), makeSymbol("PROB-STATUS"), makeSymbol("PROB-DEPENDENT-LINKS"), makeSymbol("PROB-ARGUMENT-LINKS"), makeSymbol("PROB-TACTICS"),
	    makeSymbol("PROB-PROOF-BINDINGS-INDEX"), makeSymbol("PROB-ARGUMENT-LINK-BINDINGS-INDEX") });

    public static final SubLList alt_list53 = list(
    ...
    public static final SubLList alt_list54 = list(makeKeyword("DONE"), makeKeyword("STATUS"), makeKeyword("COMPLETENESS"), makeKeyword("PREFERENCE-LEVEL"), makeKeyword("HL-MODULE"), makeKeyword("TYPE"), makeKeyword("PRODUCTIVITY"));

    public static final SubLList alt_list6 = list(new SubLObject[] { makeSymbol("_CSETF-PROB-SUID"), makeSymbol("_CSETF-PROB-STORE"), makeSymbol("_CSETF-PROB-QUERY"), makeSymbol("_CSETF-PROB-STATUS"), makeSymbol("_CSETF-PROB-DEPENDENT-LINKS"), makeSymbol("_CSETF-PROB-ARGUMENT-LINKS"),
    ...
    public static final SubLList alt_list75 = list(new SubLObject[] { makeKeyword("NON-TRANSFORMATION"), makeKeyword("GENERALIZED-REMOVAL"), makeKeyword("GENERALIZED-REMOVAL-OR-REWRITE"), makeKeyword("CONNECTED-CONJUNCTION"), makeKeyword("CONJUNCTIVE"), makeKeyword("DISJUNCTIVE"),
	    makeKeyword("LOGICAL"), makeKeyword("LOGICAL-CONJUNCTIVE"), makeKeyword("STRUCTURAL-CONJUNCTIVE"), makeKeyword("META-STRUCTURAL"), makeKeyword("CONTENT"), makeKeyword("UNION"), makeKeyword("SPLIT"), makeKeyword("JOIN-ORDERED"), makeKeyword("JOIN") });

    public static final SubLList alt_list94 = list(list(makeSymbol("LINK-VAR"), makeSymbol("PROBLEM"), makeSymbol("&KEY"), makeSymbol("TYPE"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLList alt_list95 = list(makeKeyword("TYPE"), makeKeyword("DONE"));

    public static final SubLString alt_str157$The_problem__S_did_not_have_a_sin = makeString("The problem ~S did not have a single-clause query.");

    public static final SubLString alt_str159$Found_more_than_one__a_argument_l = makeString("Found more than one ~a argument link on ~a");

    public static final SubLString alt_str160$Expected__a_to_have_a__a_argument = makeString("Expected ~a to have a ~a argument link");

    public static final SubLString alt_str164$_a_had_more_than_one_dependent_li = makeString("~a had more than one dependent link");

    public static final SubLString alt_str165$_a_had_no_dependent_links = makeString("~a had no dependent links");

    public static final SubLString alt_str188$Tried_to_add__s_to__s__which_woul = makeString("Tried to add ~s to ~s, which would result in more than ~s tactics on ~s");

    public static final SubLString alt_str36$Invalid_slot__S_for_construction_ = makeString("Invalid slot ~S for construction function");

    public static final SubLString alt_str38$_Invalid_PROBLEM__s_ = makeString("<Invalid PROBLEM ~s>");

    public static final SubLString alt_str39$__a_PROBLEM__a__a__s_ = makeString("<~a PROBLEM ~a.~a:~s>");

    public static final SubLString alt_str44$Crazy_amount_of_problems___a__in_ = makeString("Crazy amount of problems (~a) in store ~a");

    //    public static final SubLSymbol BINDINGS_P = makeSymbol("BINDINGS-P");
    //
    //    public static final SubLSymbol COMPLETENESS_P = makeSymbol("COMPLETENESS-P");
    //
    //    public static final SubLSymbol CONTEXTUALIZED_DNF_CLAUSES_P = makeSymbol("CONTEXTUALIZED-DNF-CLAUSES-P");
    //
    //    public static final SubLSymbol DO_DICTIONARY_CONTENTS = makeSymbol("DO-DICTIONARY-CONTENTS");
    //
    //    public static final SubLSymbol DO_INFERENCE_STRATEGIES = makeSymbol("DO-INFERENCE-STRATEGIES");
    //
    //    public static final SubLSymbol DO_PROBLEM_ACTIVE_STRATEGIES = makeSymbol("DO-PROBLEM-ACTIVE-STRATEGIES");
    //
    ...
    //
    //    public static final SubLSymbol DO_PROBLEM_PROOFS = makeSymbol("DO-PROBLEM-PROOFS");
    //
    //    public static final SubLSymbol DO_PROBLEM_QUERY_LITERALS = makeSymbol("DO-PROBLEM-QUERY-LITERALS");
    //
    //    public static final SubLSymbol DO_PROBLEM_RELEVANT_INFERENCES = makeSymbol("DO-PROBLEM-RELEVANT-INFERENCES");
    //
    //    public static final SubLSymbol DO_PROBLEM_RELEVANT_STRATEGIES = makeSymbol("DO-PROBLEM-RELEVANT-STRATEGIES");
    //
    //    public static final SubLSymbol DO_PROBLEM_STORE_INFERENCES = makeSymbol("DO-PROBLEM-STORE-INFERENCES");
    //
    //    public static final SubLSymbol DO_PROBLEM_STORE_STRATEGIES = makeSymbol("DO-PROBLEM-STORE-STRATEGIES");
    //
    //    public static final SubLSymbol DO_PROBLEM_TACTICS = makeSymbol("DO-PROBLEM-TACTICS");
    //
    //    public static final SubLSymbol DO_PROBLEM_TACTICS_COMPLETENESS_MATCH = makeSymbol("DO-PROBLEM-TACTICS-COMPLETENESS-MATCH");
    //
    //    public static final SubLSymbol DO_PROBLEM_TACTICS_HL_MODULE_MATCH = makeSymbol("DO-PROBLEM-TACTICS-HL-MODULE-MATCH");
    //
    //    public static final SubLSymbol DO_PROBLEM_TACTICS_PREFERENCE_LEVEL_MATCH = makeSymbol("DO-PROBLEM-TACTICS-PREFERENCE-LEVEL-MATCH");
    //
    //    public static final SubLSymbol DO_PROBLEM_TACTICS_PRODUCTIVITY_MATCH = makeSymbol("DO-PROBLEM-TACTICS-PRODUCTIVITY-MATCH");
    //
    //    public static final SubLSymbol DO_PROBLEM_TACTICS_STATUS_MATCH = makeSymbol("DO-PROBLEM-TACTICS-STATUS-MATCH");
    //
    //    public static final SubLSymbol DO_PROBLEM_TACTICS_TYPE_MATCH = makeSymbol("DO-PROBLEM-TACTICS-TYPE-MATCH");
    //
    //    public static final SubLSymbol GENERALIZED_TACTIC_TYPE_P = makeSymbol("GENERALIZED-TACTIC-TYPE-P");
    //
    ...
    //    public static final String myName = "com.cyc.cycjava.cycl.inference.harness.inference_datastructures_problem";
    //
    //    public static final SubLSymbol PREFERENCE_LEVEL_P = makeSymbol("PREFERENCE-LEVEL-P");
    //
    public static final SubLSymbol PRINT_PROBLEM = makeSymbol("PRINT-PROBLEM");
    //
    //    public static final SubLSymbol PRINT_PROBLEM = makeSymbol("PRINT-PROBLEM");
    //
    //    public static final SubLSymbol PROB_ARGUMENT_LINK_BINDINGS_INDEX = makeSymbol("PROB-ARGUMENT-LINK-BINDINGS-INDEX");
    //
    //    public static final SubLSymbol PROB_ARGUMENT_LINKS = makeSymbol("PROB-ARGUMENT-LINKS");
    //
    //    public static final SubLSymbol PROB_DEPENDENT_LINKS = makeSymbol("PROB-DEPENDENT-LINKS");
    //
    //    public static final SubLSymbol PROB_PROOF_BINDINGS_INDEX = makeSymbol("PROB-PROOF-BINDINGS-INDEX");
    //
    //    public static final SubLSymbol PROB_QUERY = makeSymbol("PROB-QUERY");
    //
    //    public static final SubLSymbol PROB_STATUS = makeSymbol("PROB-STATUS");
    //
    //    public static final SubLSymbol PROB_STORE = makeSymbol("PROB-STORE");
    //
    //    public static final SubLSymbol PROB_SUID = makeSymbol("PROB-SUID");
    //
    //    public static final SubLSymbol PROB_TACTICS = makeSymbol("PROB-TACTICS");
    //
    //    public static final SubLSymbol PROBLEM_ARGUMENT_LINKS = makeSymbol("PROBLEM-ARGUMENT-LINKS");
    //
    //    public static final SubLSymbol PROBLEM_DEPENDENT_LINKS = makeSymbol("PROBLEM-DEPENDENT-LINKS");
    //
    //    public static final SubLSymbol PROBLEM_LINK_SUPPORTED_INFERENCE = makeSymbol("PROBLEM-LINK-SUPPORTED-INFERENCE");
    //
    //    public static final SubLSymbol PROBLEM_LINK_SUPPORTED_PROBLEM = makeSymbol("PROBLEM-LINK-SUPPORTED-PROBLEM");
    //
    //    public static final SubLSymbol PROBLEM_LINK_TYPE_P = makeSymbol("PROBLEM-LINK-TYPE-P");
    //
    public static final SubLSymbol PROBLEM_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("PROBLEM-PRINT-FUNCTION-TRAMPOLINE");
    //
    //    public static final SubLSymbol PROBLEM_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("PROBLEM-PRINT-FUNCTION-TRAMPOLINE");
    //
    //    public static final SubLSymbol PROBLEM_PROOF_BINDINGS_INDEX = makeSymbol("PROBLEM-PROOF-BINDINGS-INDEX");
    //
    //    public static final SubLSymbol PROBLEM_QUERY = makeSymbol("PROBLEM-QUERY");
    //
    //    public static final SubLSymbol PROBLEM_QUERY_DEPTH_SIGNATURE_P = makeSymbol("PROBLEM-QUERY-DEPTH-SIGNATURE-P");
    //
    //    public static final SubLSymbol PROBLEM_STATUS_P = makeSymbol("PROBLEM-STATUS-P");
    //
    //    public static final SubLSymbol PROBLEM_STORE = makeSymbol("PROBLEM-STORE");
    //
    //    public static final SubLSymbol PROBLEM_TACTICS = makeSymbol("PROBLEM-TACTICS");
    //
    //    public static final SubLSymbol PRODUCTIVITY_P = makeSymbol("PRODUCTIVITY-P");
    //
    //    public static final SubLSymbol STRATEGIC_CONTEXT_P = makeSymbol("STRATEGIC-CONTEXT-P");
    //
    //    public static final SubLSymbol STRATEGY_INFERENCE = makeSymbol("STRATEGY-INFERENCE");
    //
    //    public static final SubLSymbol SXHASH_PROBLEM_METHOD = makeSymbol("SXHASH-PROBLEM-METHOD");
    //
    //    public static final SubLSymbol TACTIC_STATUS_P = makeSymbol("TACTIC-STATUS-P");
    //
	...
	assert NIL != problem_p(v_object) : "inference_datastructures_problem.problem_p error :" + v_object;
    ...
    public static final SubLObject all_problem_argument_problems_alt(SubLObject problem) {
	{
	    SubLObject problem_set = set_contents.new_set_contents(problem_argument_link_count(problem), symbol_function(EQ));
	    problem_set = all_problem_argument_problems_recursive(problem, problem_set);
	    return Sort.sort(set_contents.set_contents_element_list(problem_set), $sym162$_, PROBLEM_SUID);
	}
    }
	...
	return list_utilities.any_in_list($sym177$PROBLEM_HAS_AN_IN_PROGRESS_TACTIC_, problems, UNPROVIDED);
    }
	...
	if (false) {
	    ...
	    declareFunction(me,"new_problem", "NEW-PROBLEM", 2, 0, false);
	...
	if (NIL != valid_problem_p(problem)) {
		...
		com.cyc.cycjava.cycl.inference.harness.inference_datastructures_problem_store.problem_store_note_problem_unprocessed(problem_store(problem), problem);
	    }
    ...
    public static final SubLObject do_problem_active_inferences_alt(SubLObject macroform, SubLObject environment) {
	{
	    ...
	    destructuring_bind_must_consp(current, datum, alt_list127);
	    {
		...
		current = current.first();
		{
			...
			current = temp;
			{
			    ...
			    SubLObject strategy = $sym128$STRATEGY;
			    return list(DO_PROBLEM_ACTIVE_STRATEGIES, list(strategy, problem), listS(CLET, list(list(inference_var, list(STRATEGY_INFERENCE, strategy))), append(body, NIL)));
			}
		    } else {
			cdestructuring_bind_error(datum, alt_list127);
		    }
		}
	    }
	}
    ...
    public static final SubLObject do_problem_active_strategies_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list137);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			{
			    SubLObject body = current;
			    SubLObject store = $sym138$STORE;
			    SubLObject prob = $sym139$PROB;
			    return list(CLET, list(list(prob, problem), list(store, list(PROBLEM_STORE, prob))), list(DO_PROBLEM_STORE_STRATEGIES, list(strategy_var, store), listS(PWHEN, list($sym141$PROBLEM_ACTIVE_IN_STRATEGY_, prob, strategy_var), append(body, NIL))));
			}
		    } else {
			cdestructuring_bind_error(datum, alt_list137);
		    }
		}
	    }
	}
	...
	return list(CLET, list(list(problem_var, problem)), list(DO_PROBLEM_DEPENDENT_LINKS, list(link_var, problem, $TYPE, type, $DONE, done),
		list(DO_PROBLEM_LINK_SUPPORTING_MAPPED_PROBLEMS, list(mapped_problem_var, link_var, $OPEN_, openP, $DONE, done), listS(PWHEN, list(EQ, problem_var, list(MAPPED_PROBLEM_PROBLEM, mapped_problem_var)), append(body, NIL)))));
    }
    ...
    public static final SubLObject do_problem_dependent_link_interpretations_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list100);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			for (; NIL != rest;) {
			    destructuring_bind_must_consp(rest, datum, alt_list100);
			    current_4 = rest.first();
			    rest = rest.rest();
			    destructuring_bind_must_consp(rest, datum, alt_list100);
			    if (NIL == member(current_4, alt_list101, UNPROVIDED, UNPROVIDED)) {
				bad = T;
			    }
			...
			if ((NIL != bad) && (NIL == allow_other_keys_p)) {
			    cdestructuring_bind_error(datum, alt_list100);
			}
			{
			    ...
			    {
				SubLObject body = current;
				SubLObject problem_var = $sym103$PROBLEM_VAR;
				return list(CLET, list(list(problem_var, problem)), list(DO_PROBLEM_DEPENDENT_LINKS, list(link_var, problem, $TYPE, type, $DONE, done),
					list(DO_PROBLEM_LINK_SUPPORTING_MAPPED_PROBLEMS, list(mapped_problem_var, link_var, $OPEN_, openP, $DONE, done), listS(PWHEN, list(EQ, problem_var, list(MAPPED_PROBLEM_PROBLEM, mapped_problem_var)), append(body, NIL)))));
			    }
			}
    ...
    public static final SubLObject do_problem_dependent_links_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list94);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			for (; NIL != rest;) {
			    destructuring_bind_must_consp(rest, datum, alt_list94);
			    current_3 = rest.first();
			    rest = rest.rest();
			    destructuring_bind_must_consp(rest, datum, alt_list94);
			    if (NIL == member(current_3, alt_list95, UNPROVIDED, UNPROVIDED)) {
				bad = T;
			    }
			...
			if ((NIL != bad) && (NIL == allow_other_keys_p)) {
			    cdestructuring_bind_error(datum, alt_list94);
			}
			{
			    SubLObject type_tail = property_list_member($TYPE, current);
			    SubLObject type = (NIL != type_tail) ? ((SubLObject) (cadr(type_tail))) : NIL;
				...
				if (NIL == type) {
				    ...
				    return list(DO_PROBLEM_DEPENDENT_LINKS, list(link_var, problem, $DONE, done), listS(PWHEN, list($sym99$PROBLEM_LINK_HAS_TYPE_, link_var, type), append(body, NIL)));
				}
			    }
			}
		    }
    ...
    public static final SubLObject do_problem_literals_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list47);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			for (; NIL != rest;) {
			    destructuring_bind_must_consp(rest, datum, alt_list47);
			    current_1 = rest.first();
			    rest = rest.rest();
			    destructuring_bind_must_consp(rest, datum, alt_list47);
			    if (NIL == member(current_1, alt_list48, UNPROVIDED, UNPROVIDED)) {
				bad = T;
			    }
			...
			if ((NIL != bad) && (NIL == allow_other_keys_p)) {
			    cdestructuring_bind_error(datum, alt_list47);
			}
			{
			    SubLObject done_tail = property_list_member($DONE, current);
			    SubLObject done = (NIL != done_tail) ? ((SubLObject) (cadr(done_tail))) : NIL;
    ...
    public static final SubLObject do_problem_proofs_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list116);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			for (; NIL != rest;) {
			    destructuring_bind_must_consp(rest, datum, alt_list116);
			    current_6 = rest.first();
			    rest = rest.rest();
			    destructuring_bind_must_consp(rest, datum, alt_list116);
			    if (NIL == member(current_6, alt_list117, UNPROVIDED, UNPROVIDED)) {
				bad = T;
			    }
			...
			if ((NIL != bad) && (NIL == allow_other_keys_p)) {
			    cdestructuring_bind_error(datum, alt_list116);
			}
			{
			    ...
			    {
				SubLObject body = current;
				SubLObject proof_list = $sym119$PROOF_LIST;
				SubLObject v_bindings = $sym120$BINDINGS;
				if (NIL == proof_status) {
				    return list(DO_DICTIONARY_CONTENTS, list(v_bindings, proof_list, list(PROBLEM_PROOF_BINDINGS_INDEX, problem), $DONE, done), list(IGNORE, v_bindings), listS(DO_LIST, list(proof_var, proof_list, $DONE, done), append(body, NIL)));
				} else {
				    {
					SubLObject status_var = $sym124$STATUS_VAR;
					return list(CLET, list(list(status_var, proof_status)), list(DO_PROBLEM_PROOFS, list(proof_var, problem, $DONE, done), listS(PWHEN, list($sym126$PROOF_HAS_STATUS_, proof_var, status_var), append(body, NIL))));
				    }
				}
			    }
			}
    ...
    public static final SubLObject do_problem_relevant_inferences_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list131);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			for (; NIL != rest;) {
			    destructuring_bind_must_consp(rest, datum, alt_list131);
			    current_7 = rest.first();
			    rest = rest.rest();
			    destructuring_bind_must_consp(rest, datum, alt_list131);
			    if (NIL == member(current_7, alt_list48, UNPROVIDED, UNPROVIDED)) {
				bad = T;
			    }
			...
			if ((NIL != bad) && (NIL == allow_other_keys_p)) {
			    cdestructuring_bind_error(datum, alt_list131);
			}
			{
			    SubLObject done_tail = property_list_member($DONE, current);
			    SubLObject done = (NIL != done_tail) ? ((SubLObject) (cadr(done_tail))) : NIL;
			    ...
			    {
				SubLObject body = current;
				SubLObject store = $sym132$STORE;
				SubLObject prob = $sym133$PROB;
				return list(CLET, list(list(prob, problem), list(store, list(PROBLEM_STORE, prob))), list(DO_PROBLEM_STORE_INFERENCES, list(inference_var, store, $DONE, done), listS(PWHEN, list($sym136$PROBLEM_RELEVANT_TO_INFERENCE_, prob, inference_var), append(body, NIL))));
			    }
			}
		    }
		}
    ...
    public static final SubLObject do_problem_relevant_strategic_contexts_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list146);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			for (; NIL != rest;) {
			    destructuring_bind_must_consp(rest, datum, alt_list146);
			    current_9 = rest.first();
			    rest = rest.rest();
			    destructuring_bind_must_consp(rest, datum, alt_list146);
			    if (NIL == member(current_9, alt_list48, UNPROVIDED, UNPROVIDED)) {
				bad = T;
			    }
			...
			if ((NIL != bad) && (NIL == allow_other_keys_p)) {
			    cdestructuring_bind_error(datum, alt_list146);
			}
			{
			    SubLObject done_tail = property_list_member($DONE, current);
			    SubLObject done = (NIL != done_tail) ? ((SubLObject) (cadr(done_tail))) : NIL;
			    ...
			    {
				SubLObject body = current;
				return list(PROGN, listS(CLET, list(bq_cons(strategic_context_var, alt_list148)), append(body, NIL)), listS(DO_PROBLEM_RELEVANT_STRATEGIES, list(strategic_context_var, problem, $DONE, done), append(body, NIL)));
			    }
			}
		    }
		}
    ...
    public static final SubLObject do_problem_relevant_strategies_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list142);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			for (; NIL != rest;) {
			    destructuring_bind_must_consp(rest, datum, alt_list142);
			    current_8 = rest.first();
			    rest = rest.rest();
			    destructuring_bind_must_consp(rest, datum, alt_list142);
			    if (NIL == member(current_8, alt_list48, UNPROVIDED, UNPROVIDED)) {
				bad = T;
			    }
			...
			if ((NIL != bad) && (NIL == allow_other_keys_p)) {
			    cdestructuring_bind_error(datum, alt_list142);
			}
			{
			    SubLObject done_tail = property_list_member($DONE, current);
			    SubLObject done = (NIL != done_tail) ? ((SubLObject) (cadr(done_tail))) : NIL;
			    ...
			    {
				SubLObject body = current;
				SubLObject inference = $sym143$INFERENCE;
				return list(DO_PROBLEM_RELEVANT_INFERENCES, list(inference, problem, $DONE, done), listS(DO_INFERENCE_STRATEGIES, list(strategy_var, inference), append(body, NIL)));
			    }
			}
		    }
    ...
    public static final SubLObject do_problem_supported_inferences_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list110);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			{
			    SubLObject body = current;
			    SubLObject link = $sym111$LINK;
			    return list(DO_PROBLEM_DEPENDENT_LINKS, list(link, problem), list(CLET, list(list(supported_inference_var, list(PROBLEM_LINK_SUPPORTED_INFERENCE, link))), listS(PWHEN, supported_inference_var, append(body, NIL))));
			}
		    } else {
			cdestructuring_bind_error(datum, alt_list110);
		    }
		}
	    }
	}
    ...
    public static final SubLObject do_problem_supported_problems_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list107);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			for (; NIL != rest;) {
			    destructuring_bind_must_consp(rest, datum, alt_list107);
			    current_5 = rest.first();
			    rest = rest.rest();
			    destructuring_bind_must_consp(rest, datum, alt_list107);
			    if (NIL == member(current_5, alt_list48, UNPROVIDED, UNPROVIDED)) {
				bad = T;
			    }
			...
			if ((NIL != bad) && (NIL == allow_other_keys_p)) {
			    cdestructuring_bind_error(datum, alt_list107);
			}
			{
			    SubLObject done_tail = property_list_member($DONE, current);
			    SubLObject done = (NIL != done_tail) ? ((SubLObject) (cadr(done_tail))) : NIL;
    ...
    public static final SubLObject do_problem_supporting_problems_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list113);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			{
			    SubLObject body = current;
			    SubLObject link = $sym114$LINK;
			    return list(DO_PROBLEM_ARGUMENT_LINKS, list(link, problem), listS(DO_PROBLEM_LINK_SUPPORTING_PROBLEMS, list(supporting_problem_var, variable_map_var, link), append(body, NIL)));
			}
		    } else {
			cdestructuring_bind_error(datum, alt_list113);
		    }
		}
	    }
	}
    ...
    public static final SubLObject do_problem_tactics_alt(SubLObject macroform, SubLObject environment) {
	{
	    SubLObject datum = macroform.rest();
	    SubLObject current = datum;
	    destructuring_bind_must_consp(current, datum, alt_list53);
	    {
		SubLObject temp = current.rest();
		current = current.first();
		{
			...
			for (; NIL != rest;) {
			    destructuring_bind_must_consp(rest, datum, alt_list53);
			    current_2 = rest.first();
			    rest = rest.rest();
			    destructuring_bind_must_consp(rest, datum, alt_list53);
			    if (NIL == member(current_2, alt_list54, UNPROVIDED, UNPROVIDED)) {
				bad = T;
			    }
			...
			if ((NIL != bad) && (NIL == allow_other_keys_p)) {
			    cdestructuring_bind_error(datum, alt_list53);
			}
			{
			    SubLObject done_tail = property_list_member($DONE, current);
			    SubLObject done = (NIL != done_tail) ? ((SubLObject) (cadr(done_tail))) : NIL;
				...
				if (NIL == filter_forms) {
				    ...
				    return list(DO_PROBLEM_TACTICS, list(tactic_var, problem, $DONE, done), listS(PWHEN, NIL != list_utilities.singletonP(filter_forms) ? ((SubLObject) (filter_forms.first())) : bq_cons(CAND, append(filter_forms, NIL)), append(body, NIL)));
				}
			    }
			}
		    }
	...
	assert NIL != inference_datastructures_enumerated_types.completeness_p(completeness_spec) : "inference_datastructures_enumerated_types.completeness_p(completeness_spec) " + "CommonSymbols.NIL != inference_datastructures_enumerated_types.completeness_p(completeness_spec) "
		+ completeness_spec;
	...
	assert NIL != inference_datastructures_enumerated_types.productivity_p(productivity_spec) : "inference_datastructures_enumerated_types.productivity_p(productivity_spec) " + "CommonSymbols.NIL != inference_datastructures_enumerated_types.productivity_p(productivity_spec) "
		+ productivity_spec;
	...
	defconstant("*DTP-PROBLEM*", PROBLEM);
	deflexical("*EMPTY-CLAUSES*", NIL != boundp($empty_clauses$) ? ((SubLObject) ($empty_clauses$.getGlobalValue())) : list(clauses.empty_clause()));
	deflexical("*GENERALIZED-TACTIC-TYPES*", alt_list75);
	defvar("*TRANSFORMATION-DEPTH-COMPUTATION*", $COUNTERINTUITIVE);
	defparameter("*PROBLEM-MIN-TRANSFORMATION-DEPTH-FROM-SIGNATURE-ENABLED?*", T);
	deflexical("*MAX-PROBLEM-TACTICS*", $int$10000);
	return NIL;
	...
	{
	    final SubLThread thread = SubLProcess.currentSubLThread();
	    return makeBoolean((NIL != single_literal_problem_p(v_object)) && (($$ist == single_literal_problem_predicate(v_object)) || ((NIL != utilities_macros.within_normal_forward_inferenceP()) && (mt_relevance_macros.$mt$.getDynamicValue(thread) != $$InferencePSC))));
	}
    }
	...
	}
	{
	    ...
	    for (next = arglist; NIL != next; next = cddr(next)) {
		{
			...
			Errors.error(alt_str36$Invalid_slot__S_for_construction_, current_arg);
		    }
    ...
    public static final SubLObject new_problem(SubLObject store, SubLObject query) {
	{
		...
		_csetf_prob_argument_link_bindings_index(problem, dictionary_contents.new_dictionary_contents(ZERO_INTEGER, symbol_function(EQUAL)));
		inference_datastructures_problem_store.add_problem_store_problem(store, problem);
		com.cyc.cycjava.cycl.inference.harness.inference_worker.note_problem_created(problem);
		return problem;
	    }
	}
    }
	...
	return com.cyc.cycjava.cycl.inference.harness.inference_datastructures_problem_store.problem_store_note_problem_potentially_processed(problem_store(problem), problem);
    }
	...
	if (NIL != problem_invalid_p(v_object)) {
	    ...
	    format(stream, $str54$__a_PROBLEM__a__a__s_a_, new SubLObject[] { problem_status(v_object), inference_datastructures_problem_store.problem_store_suid(problem_store(v_object)), problem_suid(v_object), problem_query(v_object),
		    NIL != problem_free_hl_vars(v_object) ? cconcatenate($str55$_free_, format_nil.format_nil_a_no_copy(Mapping.mapcar(VARIABLE_ID, problem_free_hl_vars(v_object)))) : $str57$ });
	}
	return NIL;
    }
	...
	if (NIL != problem_invalid_p(v_object)) {
	    format(stream, alt_str38$_Invalid_PROBLEM__s_, prob_suid(v_object));
	} else {
	    format(stream, alt_str39$__a_PROBLEM__a__a__s_, new SubLObject[] { problem_status(v_object), inference_datastructures_problem_store.problem_store_suid(problem_store(v_object)), problem_suid(v_object), problem_query(v_object) });
	}
	return NIL;
    }
	...
	if (NIL != problem_indestructibleP(problem)) {
	    return $INDESTRUCTIBLE;
	} else if (NIL != problem_destructibleP(problem)) {
	    return $DESTRUCTIBLE;
	} else {
	    return $UNKNOWN;
	}
    ...
    public static final SubLObject problem_has_an_in_progress_tacticP_alt(SubLObject problem) {
	{
	    ...
	    SubLObject rest = NIL;
	    for (rest = problem_tactics(problem); !((NIL != has_oneP) || (NIL == rest)); rest = rest.rest()) {
		{
    ...
    public static final SubLObject problem_has_split_tacticsP_alt(SubLObject problem) {
	{
	    ...
	    SubLObject rest = NIL;
	    for (rest = problem_tactics(problem); !((NIL != foundP) || (NIL == rest)); rest = rest.rest()) {
		{
		    SubLObject tactic = rest.first();
	...
	final SubLObject store = problem_store(problem);
	final SubLObject potentially_processed_problems = com.cyc.cycjava.cycl.inference.harness.inference_datastructures_problem_store.problem_store_potentially_processed_problems(store);
	...
	}
	{
	    ...
	    for (contextualized_clause = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest(), contextualized_clause = cdolist_list_var.first()) {
		{
		    ...
		    for (contextualized_asent = cdolist_list_var_10.first(); NIL != cdolist_list_var_10; cdolist_list_var_10 = cdolist_list_var_10.rest(), contextualized_asent = cdolist_list_var_10.first()) {
			{
			    ...
			    SubLObject mt = NIL;
			    SubLObject asent = NIL;
			    destructuring_bind_must_consp(current, datum, alt_list153);
			    mt = current.first();
			    current = current.rest();
			    destructuring_bind_must_consp(current, datum, alt_list153);
			    asent = current.first();
				...
				cdestructuring_bind_error(datum, alt_list153);
			    }
			}
			index_var = add(index_var, ONE_INTEGER);
		    }
    ...
    public static final SubLObject problem_query_sole_clause_alt(SubLObject query) {
	{
	    ...
	    SubLObject current = datum;
	    SubLObject dnf_clause = NIL;
	    destructuring_bind_must_consp(current, datum, alt_list158);
	    dnf_clause = current.first();
	    current = current.rest();
	    if (NIL == current) {
		return dnf_clause;
	    } else {
		cdestructuring_bind_error(datum, alt_list158);
	    }
	}
	return NIL;
    }
    ...
    public static final SubLObject problem_sole_argument_link_of_type_alt(SubLObject problem, SubLObject type) {
	{
		...
		for (state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); NIL == set_contents.do_set_contents_doneP(basis_object, state); state = set_contents.do_set_contents_update_state(state)) {
			...
			if (NIL != set_contents.do_set_contents_element_validP(state, link)) {
			    if (NIL != inference_datastructures_problem_link.problem_link_has_typeP(link, type)) {
				if (NIL != first_link) {
				    Errors.error(alt_str159$Found_more_than_one__a_argument_l, type, problem);
				} else {
				    first_link = link;
				}
			    }
		...
		if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread)) {
		    if (NIL == first_link) {
			Errors.error(alt_str160$Expected__a_to_have_a__a_argument, problem, type);
		    }
		}
		return first_link;
	    }
    ...
    public static final SubLObject problem_sole_clause_alt(SubLObject problem) {
	{
		...
		if (NIL == Errors.$ignore_mustsP$.getDynamicValue(thread)) {
			...
			Errors.error(alt_str157$The_problem__S_did_not_have_a_sin, problem);
		    }
		}
		return problem_query_sole_clause(query);
	    }
    ...
    public static final SubLObject problem_sole_dependent_link_alt(SubLObject problem) {
	{
	    ...
	    for (state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); NIL == set_contents.do_set_contents_doneP(basis_object, state); state = set_contents.do_set_contents_update_state(state)) {
		{
		    ...
		    if (NIL != set_contents.do_set_contents_element_validP(state, dependent_link)) {
			if (NIL != result) {
			    return Errors.error(alt_str164$_a_had_more_than_one_dependent_li, problem);
			} else {
			    result = dependent_link;
			}
		    }
		...
		return Errors.error(alt_str165$_a_had_no_dependent_links, problem);
	    }
	}
    }
    ...
    //
    //    public static final SubLObject problem_store_all_modules_alt(SubLObject store) {
    //	SubLTrampolineFile.checkType(store, PROBLEM_STORE_P);
    //	{
    ...
    //		    SubLObject problem = NIL;
    //		    while (NIL != id) {
    //			problem = id_index.do_id_index_state_object(idx, $SKIP, id, state_var);
    //			if (NIL != id_index.do_id_index_id_and_object_validP(id, problem, $SKIP)) {
    //			    {
    //				SubLObject cdolist_list_var = problem_tactics(problem);
    //				SubLObject tactic = NIL;
    //				for (tactic = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest(), tactic = cdolist_list_var.first()) {
    ...
    //		}
    //	    }
    //	    return Sort.sort(dictionary_utilities.dictionary_to_alist(module_counts), symbol_function($sym194$_), symbol_function(CDR));
    //	}
    //    }
	...
	SubLTrampolineFile.checkType(problem, PROBLEM_P);
	{
	    ...
	    SubLObject tactic = NIL;
	    for (tactic = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest(), tactic = cdolist_list_var.first()) {
		if (NIL != do_problem_tactics_type_match(tactic, $REMOVAL)) {
	...
	identity(PROBLEM);
	register_method(Sxhash.$sxhash_method_table$.getGlobalValue(), $dtp_problem$.getGlobalValue(), symbol_function(SXHASH_PROBLEM_METHOD));
	subl_macro_promotions.declare_defglobal($empty_clauses$);
	access_macros.register_macro_helper(PROBLEM_TACTICS, DO_PROBLEM_TACTICS);
	access_macros.register_macro_helper(DO_PROBLEM_TACTICS_STATUS_MATCH, DO_PROBLEM_TACTICS);
	access_macros.register_macro_helper(DO_PROBLEM_TACTICS_COMPLETENESS_MATCH, DO_PROBLEM_TACTICS);
	access_macros.register_macro_helper(DO_PROBLEM_TACTICS_PREFERENCE_LEVEL_MATCH, DO_PROBLEM_TACTICS);
	access_macros.register_macro_helper(DO_PROBLEM_TACTICS_PRODUCTIVITY_MATCH, DO_PROBLEM_TACTICS);
	access_macros.register_macro_helper(DO_PROBLEM_TACTICS_HL_MODULE_MATCH, DO_PROBLEM_TACTICS);
	access_macros.register_macro_helper(DO_PROBLEM_TACTICS_TYPE_MATCH, DO_PROBLEM_TACTICS);
	access_macros.register_macro_helper(PROBLEM_ARGUMENT_LINKS, DO_PROBLEM_ARGUMENT_LINKS);
	access_macros.register_macro_helper(PROBLEM_DEPENDENT_LINKS, DO_PROBLEM_DEPENDENT_LINKS);
	access_macros.register_macro_helper(PROBLEM_PROOF_BINDINGS_INDEX, DO_PROBLEM_PROOFS);
	access_macros.register_macro_helper($sym126$PROOF_HAS_STATUS_, DO_PROBLEM_PROOFS);
	return NIL;
    }
	...
	if (NIL != single_literal_problem_p(v_object)) {
	    return eq(predicate, single_literal_problem_predicate(v_object));
	}
	return NIL;
    }
	...
	if (NIL == type_spec) {
		...
		if (pcase_var.eql($NON_TRANSFORMATION)) {
		    ...
		    return inference_worker_removal.generalized_removal_tactic_p(tactic);
		} else if (pcase_var.eql($GENERALIZED_REMOVAL_OR_REWRITE)) {
		    return makeBoolean((NIL != inference_worker_removal.generalized_removal_tactic_p(tactic)) || (NIL != inference_worker_rewrite.rewrite_tactic_p(tactic)));
    ...
    // // Definitions
    public static final class $problem_native_ORIG extends SubLStructNative {
	private static final SubLStructDeclNative structDecl = makeStructDeclNative(inference_datastructures_problem.$problem_native.class, PROBLEM, PROBLEM_P, alt_list3, alt_list4,
		new String[] { "$suid", "$store", "$query", "$status", "$dependent_links", "$argument_links", "$tactics", "$proof_bindings_index", "$argument_link_bindings_index" }, alt_list5, alt_list6, PRINT_PROBLEM);

	public SubLObject $argument_link_bindings_index = Lisp.NIL;

	public SubLObject $argument_links = Lisp.NIL;

	public SubLObject $dependent_links = Lisp.NIL;

	public SubLObject $proof_bindings_index = Lisp.NIL;
	...
	public SubLObject getField10_alt() {
	    return $argument_link_bindings_index;
	}

	public SubLObject getField2_alt() {
	    return $suid;
	}

	public SubLObject getField3_alt() {
	    return $store;
	}

	public SubLObject getField4_alt() {
	    return $query;
	}

	public SubLObject getField5_alt() {
	    return $status;
	}

	public SubLObject getField6_alt() {
	    return $dependent_links;
	}

	public SubLObject getField7_alt() {
	    return $argument_links;
	}

	public SubLObject getField8_alt() {
	    return $tactics;
	}

	public SubLObject getField9_alt() {
	    return $proof_bindings_index;
	}

	public SubLStructDecl getStructDecl() {
	    return inference_datastructures_problem.$problem_native.structDecl;
	}

	public SubLObject setField10_alt(SubLObject value) {
	    return $argument_link_bindings_index = value;
	}

	public SubLObject setField2_alt(SubLObject value) {
	    return $suid = value;
	}

	public SubLObject setField3_alt(SubLObject value) {
	    return $store = value;
	}

	public SubLObject setField4_alt(SubLObject value) {
	    return $query = value;
	}

	public SubLObject setField5_alt(SubLObject value) {
	    return $status = value;
	}

	public SubLObject setField6_alt(SubLObject value) {
	    return $dependent_links = value;
	}

	public SubLObject setField7_alt(SubLObject value) {
	    return $argument_links = value;
	}

	public SubLObject setField8_alt(SubLObject value) {
	    return $tactics = value;
	}

	public SubLObject setField9_alt(SubLObject value) {
	    return $proof_bindings_index = value;
	}
    }
	...
	static {
	    structDecl = makeStructDeclNative($problem_native.class, PROBLEM, PROBLEM_P, $list3, $list4,
		    new String[] { "$suid", "$store", "$query", "$free_hl_vars", "$status", "$dependent_links", "$argument_links", "$tactics", "$proof_bindings_index", "$argument_link_bindings_index", "$backchain_required", "$memoization_state" }, $list5, $list6, PRINT_PROBLEM);
	}
    }
