...
public final class inference_worker_residual_transformation
    extends
      SubLTranslatedFile
{
  ...
  {
    return makeBoolean( NIL != inference_datastructures_problem_link.problem_link_p( v_object ) && $kw0$RESIDUAL_TRANSFORMATION == inference_datastructures_problem_link.problem_link_type( v_object ) );
  }
  ...
  {
    return inference_datastructures_problem_link.find_problem_link_of_type_between( $kw0$RESIDUAL_TRANSFORMATION, supported_problem, supporting_mapped_problem );
  }

  @SubLTranslatedFile.SubL(source = "cycl/inference/harness/inference-worker-residual-transformation.lisp", position = 1496L)
  public static SubLObject new_residual_transformation_link(final SubLObject supporting_mapped_problem, final SubLObject join_ordered_link, final SubLObject transformation_link,
      final SubLObject conjunctive_problem_dont_care_variable_map, final SubLObject residual_conjunction_literal_map)
  {
    ...
    final SubLObject rt_link = inference_datastructures_problem_link.new_problem_link( $kw0$RESIDUAL_TRANSFORMATION, motivating_conjunction_problem );
  ...
  public static SubLObject destroy_join_ordered_link_wrt_residual_transformation_links(final SubLObject jo_link)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, rt_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( rt_link, $kw0$RESIDUAL_TRANSFORMATION )
          && NIL != residual_transformation_link_motivated_by_join_ordered_linkP( rt_link, jo_link ) )
      {
  ...
  public static SubLObject destroy_transformation_link_wrt_residual_transformation_links(final SubLObject t_link)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, jo_link_var ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( jo_link_var, $kw4$JOIN_ORDERED ) )
      {
            ...
            set_contents_var_$2 ); NIL == set_contents.do_set_contents_doneP( basis_object_$3, state_$4 ); state_$4 = set_contents.do_set_contents_update_state( state_$4 ) )
        {
          ...
          if( NIL != set_contents.do_set_contents_element_validP( state_$4, rt_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( rt_link, $kw0$RESIDUAL_TRANSFORMATION )
              && NIL != residual_transformation_link_motivated_by_join_ordered_linkP( rt_link, jo_link_var_$1 ) && NIL != residual_transformation_link_motivated_by_transformation_linkP( rt_link, t_link ) )
          {
            inference_datastructures_problem_link.destroy_problem_link( rt_link );
          }
        }
  ...
  public static SubLObject set_residual_transformation_link_data(final SubLObject rt_link, final SubLObject join_ordered_link, final SubLObject transformation_link,
      final SubLObject conjunctive_problem_dont_care_variable_map, final SubLObject residual_conjunction_literal_map)
  {
    inference_datastructures_problem_link.set_problem_link_data( rt_link, ConsesLow.list( join_ordered_link, transformation_link, conjunctive_problem_dont_care_variable_map, residual_conjunction_literal_map ) );
    return rt_link;
  }
  ...
  public static SubLObject possibly_add_residual_transformation_links_via_join_ordered_link(final SubLObject join_ordered_link)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, transformation_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( transformation_link, $kw6$TRANSFORMATION )
  ...
  public static SubLObject possibly_add_residual_transformation_links_via_transformation_link(final SubLObject transformation_link)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, join_ordered_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( join_ordered_link, $kw4$JOIN_ORDERED ) )
      {
  ...
  public static SubLObject compute_residual_transformation_link_query(final SubLObject join_ordered_link, final SubLObject transformation_link)
  {
    ...
    final SubLObject focal_variable_map = inference_datastructures_problem_link.mapped_problem_variable_map( focal_mapped_problem );
    final SubLObject focal_free_hl_vars = rt_apply_bindings_backwards( focal_variable_map, conses_high.intersection( bindings.bindings_values( focal_variable_map ), supported_problem_free_hl_vars, UNPROVIDED,
        UNPROVIDED ) );
    ...
    final SubLObject residual_free_hl_vars = conses_high.intersection( cycl_utilities.expression_gather( residual_query, $sym7$HL_VAR_, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ), bindings.apply_bindings(
        transformation_variable_map, focal_free_hl_vars ), UNPROVIDED, UNPROVIDED );
    ...
    final SubLObject residual_conjunction_free_hl_vars_wrt_conjunction = conses_high.union( non_focal_free_hl_vars_wrt_conjunction, residual_free_hl_vars_wrt_conjunction, UNPROVIDED, UNPROVIDED );
    ...
    final SubLObject residual_conjunction_free_hl_vars_raw = list_utilities.fast_remove_duplicates( bindings.apply_bindings_backwards( transformation_variable_map,
        residual_conjunction_free_hl_vars_wrt_focal_restricted ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    ...
    final SubLObject residual_conjunction_free_hl_vars = variables.sort_hl_variable_list( conses_high.intersection( residual_conjunction_free_hl_vars_raw, residual_conjunction_query_vars, UNPROVIDED, UNPROVIDED ) );
  ...
  public static SubLObject compute_residual_conjunction_literal_map(final SubLObject join_ordered_link, final SubLObject transformation_link, final SubLObject conjunctive_problem_dont_care_variable_map,
      final SubLObject residual_conjunction_mapped_problem)
  {
    final SubLObject focal_mapped_problem = inference_worker_join_ordered.join_ordered_link_focal_mapped_problem( join_ordered_link );
    final SubLObject residual_mapped_problem = inference_worker_transformation.transformation_link_supporting_mapped_problem( transformation_link );
    final SubLObject focal_variable_map = inference_datastructures_problem_link.mapped_problem_variable_map( focal_mapped_problem );
    ...
    final SubLObject residual_conjunction_literal_map = compute_residual_conjunction_literal_map_internal( conjunction_query_wrt_conjunction_extended, non_focal_query_wrt_conjunction_extended,
        non_focal_query_wrt_actual_residual_conjunction, actual_residual_conjunction_query );
  ...
  public static SubLObject compute_residual_conjunction_literal_map_internal(final SubLObject conjunction_query_wrt_conjunction_extended, final SubLObject non_focal_query_wrt_conjunction_extended,
      final SubLObject non_focal_query_wrt_actual_residual_conjunction, final SubLObject actual_residual_conjunction_query)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      final SubLObject conj_index = Sequences.position( conj_pos_lit, nf_conj_pos_lits, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
      SubLObject res_conj_index = $kw6$TRANSFORMATION;
      if( NIL != conj_index )
      {
      ...
      pos_lit_map = ConsesLow.cons( res_conj_index, pos_lit_map );
      cdolist_list_var = cdolist_list_var.rest();
      conj_pos_lit = cdolist_list_var.first();
    }
    pos_lit_map = Sequences.nreverse( pos_lit_map );
    final SubLObject literal_map = ConsesLow.list( NIL, pos_lit_map );
    return literal_map;
  }
  ...
  public static SubLObject new_residual_transformation_proof(final SubLObject rt_link, final SubLObject subproof, final SubLObject variable_map)
  {
    ...
    return inference_worker.propose_new_proof_with_bindings( rt_link, canonical_proof_bindings, ConsesLow.list( subproof ) );
  }
  ...
  {
    SubLFiles.declareFunction( me, "residual_transformation_link_p", "RESIDUAL-TRANSFORMATION-LINK-P", 1, 0, false );
    SubLFiles.declareFunction( me, "find_residual_transformation_link", "FIND-RESIDUAL-TRANSFORMATION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "new_residual_transformation_link", "NEW-RESIDUAL-TRANSFORMATION-LINK", 5, 0, false );
    SubLFiles.declareFunction( me, "destroy_residual_transformation_link", "DESTROY-RESIDUAL-TRANSFORMATION-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "destroy_join_ordered_link_wrt_residual_transformation_links", "DESTROY-JOIN-ORDERED-LINK-WRT-RESIDUAL-TRANSFORMATION-LINKS", 1, 0, false );
    SubLFiles.declareFunction( me, "destroy_transformation_link_wrt_residual_transformation_links", "DESTROY-TRANSFORMATION-LINK-WRT-RESIDUAL-TRANSFORMATION-LINKS", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_supporting_mapped_problem", "RESIDUAL-TRANSFORMATION-LINK-SUPPORTING-MAPPED-PROBLEM", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_supporting_problem", "RESIDUAL-TRANSFORMATION-LINK-SUPPORTING-PROBLEM", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_supporting_variable_map", "RESIDUAL-TRANSFORMATION-LINK-SUPPORTING-VARIABLE-MAP", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_motivating_join_ordered_link", "RESIDUAL-TRANSFORMATION-LINK-MOTIVATING-JOIN-ORDERED-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_motivating_transformation_link", "RESIDUAL-TRANSFORMATION-LINK-MOTIVATING-TRANSFORMATION-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_conjunctive_problem_dont_care_variable_map", "RESIDUAL-TRANSFORMATION-LINK-CONJUNCTIVE-PROBLEM-DONT-CARE-VARIABLE-MAP", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_residual_conjunction_literal_map", "RESIDUAL-TRANSFORMATION-LINK-RESIDUAL-CONJUNCTION-LITERAL-MAP", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_motivated_by_link_pairP", "RESIDUAL-TRANSFORMATION-LINK-MOTIVATED-BY-LINK-PAIR?", 3, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_motivated_by_join_ordered_linkP", "RESIDUAL-TRANSFORMATION-LINK-MOTIVATED-BY-JOIN-ORDERED-LINK?", 2, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_motivated_by_transformation_linkP", "RESIDUAL-TRANSFORMATION-LINK-MOTIVATED-BY-TRANSFORMATION-LINK?", 2, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_residual_problem", "RESIDUAL-TRANSFORMATION-LINK-RESIDUAL-PROBLEM", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_rule_assertion", "RESIDUAL-TRANSFORMATION-LINK-RULE-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_bindings", "RESIDUAL-TRANSFORMATION-LINK-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_el_bindings", "RESIDUAL-TRANSFORMATION-LINK-EL-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "set_residual_transformation_link_data", "SET-RESIDUAL-TRANSFORMATION-LINK-DATA", 5, 0, false );
    SubLFiles.declareFunction( me, "maybe_possibly_add_residual_transformation_links_via_join_ordered_link", "MAYBE-POSSIBLY-ADD-RESIDUAL-TRANSFORMATION-LINKS-VIA-JOIN-ORDERED-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "maybe_possibly_add_residual_transformation_links_via_transformation_link", "MAYBE-POSSIBLY-ADD-RESIDUAL-TRANSFORMATION-LINKS-VIA-TRANSFORMATION-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "possibly_add_residual_transformation_links_via_join_ordered_link", "POSSIBLY-ADD-RESIDUAL-TRANSFORMATION-LINKS-VIA-JOIN-ORDERED-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "possibly_add_residual_transformation_links_via_transformation_link", "POSSIBLY-ADD-RESIDUAL-TRANSFORMATION-LINKS-VIA-TRANSFORMATION-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "possibly_add_residual_transformation_link", "POSSIBLY-ADD-RESIDUAL-TRANSFORMATION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "compute_residual_transformation_link_query", "COMPUTE-RESIDUAL-TRANSFORMATION-LINK-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "compute_residual_conjunction_literal_map", "COMPUTE-RESIDUAL-CONJUNCTION-LITERAL-MAP", 4, 0, false );
    SubLFiles.declareFunction( me, "compute_residual_conjunction_literal_map_internal", "COMPUTE-RESIDUAL-CONJUNCTION-LITERAL-MAP-INTERNAL", 4, 0, false );
    SubLFiles.declareFunction( me, "new_residual_transformation_proof", "NEW-RESIDUAL-TRANSFORMATION-PROOF", 3, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_proof_rule_bindings", "RESIDUAL-TRANSFORMATION-PROOF-RULE-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_proof_motivating_transformation_link", "RESIDUAL-TRANSFORMATION-PROOF-MOTIVATING-TRANSFORMATION-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_link_residual_conjunction_to_motivating_conjunction_variable_map", "RESIDUAL-TRANSFORMATION-LINK-RESIDUAL-CONJUNCTION-TO-MOTIVATING-CONJUNCTION-VARIABLE-MAP",
        1, 0, false );
    SubLFiles.declareFunction( me, "conjoin_problem_queries", "CONJOIN-PROBLEM-QUERIES", 2, 0, false );
    SubLFiles.declareFunction( me, "rt_apply_bindings", "RT-APPLY-BINDINGS", 2, 0, false );
    SubLFiles.declareFunction( me, "rt_apply_bindings_backwards", "RT-APPLY-BINDINGS-BACKWARDS", 2, 0, false );
    SubLFiles.declareFunction( me, "compute_conjunctive_problem_dont_care_variable_map", "COMPUTE-CONJUNCTIVE-PROBLEM-DONT-CARE-VARIABLE-MAP", 3, 0, false );
    SubLFiles.declareFunction( me, "transformation_link_first_unused_extended_var_number", "TRANSFORMATION-LINK-FIRST-UNUSED-EXTENDED-VAR-NUMBER", 1, 0, false );
    SubLFiles.declareFunction( me, "filter_transformation_link_bindings", "FILTER-TRANSFORMATION-LINK-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_proof_p", "RESIDUAL-TRANSFORMATION-PROOF-P", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_proof_rule_assertion", "RESIDUAL-TRANSFORMATION-PROOF-RULE-ASSERTION", 1, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_proof_subproof", "RESIDUAL-TRANSFORMATION-PROOF-SUBPROOF", 1, 0, false );
    SubLFiles.declareFunction( me, "bubble_up_proof_to_residual_transformation_link", "BUBBLE-UP-PROOF-TO-RESIDUAL-TRANSFORMATION-LINK", 3, 0, false );
    SubLFiles.declareFunction( me, "residual_transformation_proof_abnormalP", "RESIDUAL-TRANSFORMATION-PROOF-ABNORMAL?", 1, 0, false );
    SubLFiles.declareFunction( me, "problem_is_a_residual_conjunctionP", "PROBLEM-IS-A-RESIDUAL-CONJUNCTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "problem_store_problematic_residual_transformation_links", "PROBLEM-STORE-PROBLEMATIC-RESIDUAL-TRANSFORMATION-LINKS", 1, 0, false );
    SubLFiles.declareFunction( me, "problem_store_problematic_residual_transformation_link_count", "PROBLEM-STORE-PROBLEMATIC-RESIDUAL-TRANSFORMATION-LINK-COUNT", 1, 0, false );
    return NIL;
  }
  ...
  static
  {
    ...
    $kw0$RESIDUAL_TRANSFORMATION = makeKeyword( "RESIDUAL-TRANSFORMATION" );
    ...
    $kw4$JOIN_ORDERED = makeKeyword( "JOIN-ORDERED" );
    $sym5$RESIDUAL_TRANSFORMATION_LINK_P = makeSymbol( "RESIDUAL-TRANSFORMATION-LINK-P" );
    $kw6$TRANSFORMATION = makeKeyword( "TRANSFORMATION" );
    ...
    $list13 = ConsesLow.list( makeSymbol( "NULL" ) );
    ...
    $list15 = ConsesLow.list( makeSymbol( "ZERO" ) );
  }
}
/*
 * 
