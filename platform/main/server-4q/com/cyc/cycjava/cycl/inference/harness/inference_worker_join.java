...
import static com.cyc.cycjava.cycl.inference.harness.inference_worker_join.*;
...
public final class inference_worker_join extends SubLTranslatedFile {
    ...
    public static SubLObject join_link_data_p(final SubLObject v_object) {
        return v_object.getClass() == inference_worker_join.$join_link_data_native.class ? T : NIL;
    }

    public static SubLObject j_link_data_join_vars(final SubLObject v_object) {
        assert NIL != join_link_data_p(v_object) : "inference_worker_join.join_link_data_p(v_object) " + "CommonSymbols.NIL != inference_worker_join.join_link_data_p(v_object) " + v_object;
    ...
    public static SubLObject make_join_link_data(SubLObject arglist) {
        ...
        final SubLObject v_new = new inference_worker_join.$join_link_data_native();
        SubLObject next;
    ...
    public static final class $join_link_data_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_worker_join.$join_link_data_native.class, JOIN_LINK_DATA, JOIN_LINK_DATA_P, $list2, $list3, new String[]{ "$join_vars", "$first_proof_index", "$second_proof_index" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
