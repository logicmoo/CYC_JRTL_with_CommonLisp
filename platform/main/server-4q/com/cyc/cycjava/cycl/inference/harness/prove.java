...
public class prove extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.harness.prove";
    ...
    public static SubLObject declare_prove_file() {
        declareFunction(myName, "prove_justified", "PROVE-JUSTIFIED", 1, 5, false);
        declareFunction(myName, "fi_hypothesize", "FI-HYPOTHESIZE", 2, 2, false);
        declareFunction(myName, "fi_hypothesize_int", "FI-HYPOTHESIZE-INT", 2, 2, false);
        declareFunction(myName, "hypothesize_terms", "HYPOTHESIZE-TERMS", 2, 2, false);
        declareFunction(myName, "hypothesize_terms_for_antecedent", "HYPOTHESIZE-TERMS-FOR-ANTECEDENT", 6, 0, false);
        declareFunction(myName, "hypothesize_terms_for_consequent", "HYPOTHESIZE-TERMS-FOR-CONSEQUENT", 4, 0, false);
        declareFunction(myName, "hypothesize_terms_int", "HYPOTHESIZE-TERMS-INT", 8, 0, false);
        declareFunction(myName, "hypothesize_terms_int_2", "HYPOTHESIZE-TERMS-INT-2", 8, 0, false);
        declareFunction(myName, "hypothesize_terms_for_variables", "HYPOTHESIZE-TERMS-FOR-VARIABLES", 10, 0, false);
        declareFunction(myName, "assert_within_hypothetical", "ASSERT-WITHIN-HYPOTHETICAL", 3, 1, false);
        declareFunction(myName, "assert_hypothetical_term_isa_constraints", "ASSERT-HYPOTHETICAL-TERM-ISA-CONSTRAINTS", 4, 0, false);
        declareFunction(myName, "assert_hypothetical_term_quoted_isa_constraints", "ASSERT-HYPOTHETICAL-TERM-QUOTED-ISA-CONSTRAINTS", 4, 0, false);
        declareFunction(myName, "assert_hypothetical_term_genl_constraints", "ASSERT-HYPOTHETICAL-TERM-GENL-CONSTRAINTS", 4, 0, false);
        declareFunction(myName, "assert_hypothetical_term_content_gafs", "ASSERT-HYPOTHETICAL-TERM-CONTENT-GAFS", 3, 0, false);
        declareFunction(myName, "assert_hypothetical_term_rules", "ASSERT-HYPOTHETICAL-TERM-RULES", 4, 0, false);
        declareFunction(myName, "create_hypothesized_constant", "CREATE-HYPOTHESIZED-CONSTANT", 3, 0, false);
        declareFunction(myName, "assert_that_term_is_hypothetical", "ASSERT-THAT-TERM-IS-HYPOTHETICAL", 2, 0, false);
        declareFunction(myName, "hypothesize_dnf_equality_constraints", "HYPOTHESIZE-DNF-EQUALITY-CONSTRAINTS", 2, 0, false);
        declareFunction(myName, "hypothesize_dnf_isa_constraints", "HYPOTHESIZE-DNF-ISA-CONSTRAINTS", 2, 0, false);
        declareFunction(myName, "hypothesize_dnf_quoted_isa_constraints", "HYPOTHESIZE-DNF-QUOTED-ISA-CONSTRAINTS", 2, 0, false);
        declareFunction(myName, "hypothesize_dnf_genl_constraints", "HYPOTHESIZE-DNF-GENL-CONSTRAINTS", 2, 0, false);
        declareFunction(myName, "antecedent_dnf_variables_isa_constraints", "ANTECEDENT-DNF-VARIABLES-ISA-CONSTRAINTS", 2, 0, false);
        declareFunction(myName, "antecedent_dnf_variables_quoted_isa_constraints", "ANTECEDENT-DNF-VARIABLES-QUOTED-ISA-CONSTRAINTS", 2, 0, false);
        declareFunction(myName, "antecedent_dnf_variables_genl_constraints", "ANTECEDENT-DNF-VARIABLES-GENL-CONSTRAINTS", 2, 0, false);
        declareFunction(myName, "suggest_string_from_fort_el_formula", "SUGGEST-STRING-FROM-FORT-EL-FORMULA", 1, 0, false);
        declareFunction(myName, "fi_prove", "FI-PROVE", 2, 4, false);
        declareFunction(myName, "fi_prove_int", "FI-PROVE-INT", 2, 4, false);
        declareFunction(myName, "fi_prove_int_new_cyc_query_trampoline", "FI-PROVE-INT-NEW-CYC-QUERY-TRAMPOLINE", 2, 4, false);
        declareFunction(myName, "prove_from", "PROVE-FROM", 3, 4, false);
        declareFunction(myName, "prove_from_forward_time", "PROVE-FROM-FORWARD-TIME", 1, 0, false);
        declareFunction(myName, "prove_from_backward_time", "PROVE-FROM-BACKWARD-TIME", 1, 0, false);
        declareFunction(myName, "new_prepare_for_proof", "NEW-PREPARE-FOR-PROOF", 3, 0, false);
        declareFunction(myName, "prepare_for_proof", "PREPARE-FOR-PROOF", 4, 0, false);
        declareFunction(myName, "prepare_assumption_mt", "PREPARE-ASSUMPTION-MT", 1, 0, false);
        declareFunction(myName, "prepare_query_mt", "PREPARE-QUERY-MT", 2, 0, false);
        declareFunction(myName, "prepare_hypothesis_mt", "PREPARE-HYPOTHESIS-MT", 2, 1, false);
        declareFunction(myName, "find_or_create_hypothesis_mt", "FIND-OR-CREATE-HYPOTHESIS-MT", 2, 1, false);
        declareFunction(myName, "find_hypothesis_mt", "FIND-HYPOTHESIS-MT", 2, 0, false);
        declareFunction(myName, "valid_hypothesis_mt_infoP", "VALID-HYPOTHESIS-MT-INFO?", 2, 0, false);
        declareFunction(myName, "create_hypothesis_mt", "CREATE-HYPOTHESIS-MT", 2, 1, false);
        declareFunction(myName, "create_hypothesis_mt_int", "CREATE-HYPOTHESIS-MT-INT", 2, 1, false);
        declareFunction(myName, "note_hypothesis_mt_term_bindings", "NOTE-HYPOTHESIS-MT-TERM-BINDINGS", 2, 0, false);
        declareFunction(myName, "kill_cached_hypothesis_mt", "KILL-CACHED-HYPOTHESIS-MT", 1, 0, false);
        declareFunction(myName, "prepare_proof_mt", "PREPARE-PROOF-MT", 3, 0, false);
        declareFunction(myName, "find_or_create_proof_mt", "FIND-OR-CREATE-PROOF-MT", 3, 0, false);
        declareFunction(myName, "find_proof_mt", "FIND-PROOF-MT", 2, 0, false);
        declareFunction(myName, "create_proof_mt", "CREATE-PROOF-MT", 3, 0, false);
        declareFunction(myName, "create_proof_mt_int", "CREATE-PROOF-MT-INT", 3, 0, false);
        declareFunction(myName, "forward_propagate_proof_hypothesis_mt", "FORWARD-PROPAGATE-PROOF-HYPOTHESIS-MT", 2, 0, false);
        declareFunction(myName, "hypothesize_spec_mt", "HYPOTHESIZE-SPEC-MT", 1, 1, false);
        declareFunction(myName, "hypothetical_constant", "HYPOTHETICAL-CONSTANT", 1, 0, false);
        declareFunction(myName, "construct_non_wff_conflict_supports", "CONSTRUCT-NON-WFF-CONFLICT-SUPPORTS", 2, 1, false);
        declareFunction(myName, "flatten_explain_hl_why_not_wff", "FLATTEN-EXPLAIN-HL-WHY-NOT-WFF", 1, 0, false);
        declareFunction(myName, "flatten_explain_hl_why_not_wff_recursive", "FLATTEN-EXPLAIN-HL-WHY-NOT-WFF-RECURSIVE", 2, 0, false);
        declareFunction(myName, "convert_to_hl_support", "CONVERT-TO-HL-SUPPORT", 1, 0, false);
        declareFunction(myName, "convert_ist_formula_to_hl_support", "CONVERT-IST-FORMULA-TO-HL-SUPPORT", 2, 0, false);
        declareFunction(myName, "note_non_wff_conflict", "NOTE-NON-WFF-CONFLICT", 2, 1, false);
        return NIL;
    }
