...
public final class inference_datastructures_forward_propagate extends SubLTranslatedFile {
    ...
    public static SubLObject fpmt_old_queue(final SubLObject v_object) {
        assert NIL != forward_propagate_p(v_object) : "inference_datastructures_forward_propagate.forward_propagate_p error :" + v_object;
    ...
    public static final class $forward_propagate_native extends SubLStructNative {
        ...
        private $forward_propagate_native() {
        ...
        static {
            structDecl = makeStructDeclNative($forward_propagate_native.class, FORWARD_PROPAGATE, FORWARD_PROPAGATE_P, $list2, $list3, new String[]{ "$old_queue", "$new_queue" }, $list4, $list5, PRINT_FORWARD_PROPAGATE);
        }
    }
