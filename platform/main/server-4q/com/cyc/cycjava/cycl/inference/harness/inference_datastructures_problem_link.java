...
import static com.cyc.cycjava.cycl.inference.harness.inference_datastructures_problem_link.*;
...
public final class inference_datastructures_problem_link extends SubLTranslatedFile {
    ...
    public static final SubLList $list5 = list(makeSymbol("PROB-LINK-SUID"), makeSymbol("PROB-LINK-TYPE"), makeSymbol("PROB-LINK-SUPPORTED-OBJECT"), makeSymbol("PROB-LINK-SUPPORTING-MAPPED-PROBLEMS"), makeSymbol("PROB-LINK-OPEN-FLAGS"), makeSymbol("PROB-LINK-DATA"), makeSymbol("PROB-LINK-PROOFS"), makeSymbol("PROB-LINK-MEMOIZATION-STATE"));
    ...
    public static SubLObject prob_link_suid(final SubLObject v_object) {
        assert NIL != problem_link_p(v_object) : "inference_datastructures_problem_link.problem_link_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_link.problem_link_p(v_object) " + v_object;
        ...
        for (basis_object = set_contents.do_set_contents_basis_object(set_contents_var), state = NIL, state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); (NIL == existing_link) && (NIL == set_contents.do_set_contents_doneP(basis_object, state)); state = set_contents.do_set_contents_update_state(state)) {
            ...
            if ((NIL != set_contents.do_set_contents_element_validP(state, dependent_link)) && (NIL != problem_link_has_typeP(dependent_link, type))) {
                ...
                for (rest = NIL, rest = problem_link_supporting_mapped_problems(link_var); (NIL == existing_link) && (NIL != rest); rest = rest.rest()) {
                    ...
                    if ((((NIL != inference_macros.do_problem_link_open_matchP(NIL, link_var, candidate_supporting_mapped_problem)) && problem_var.eql(mapped_problem_problem(candidate_supporting_mapped_problem))) && supported_problem.eql(problem_link_supported_problem(dependent_link))) && (NIL != mapped_problem_equal(supporting_mapped_problem, candidate_supporting_mapped_problem))) {
    ...
    public static SubLObject mapped_prob_problem(final SubLObject v_object) {
        assert NIL != mapped_problem_p(v_object) : "inference_datastructures_problem_link.mapped_problem_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_link.mapped_problem_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $problem_link_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_datastructures_problem_link.$problem_link_native.class, PROBLEM_LINK, PROBLEM_LINK_P, $list3, $list4, new String[]{ "$suid", "$type", "$supported_object", "$supporting_mapped_problems", "$open_flags", "$data", "$proofs", "$memoization_state" }, $list5, $list6, PRINT_PROBLEM_LINK);
        }
    }
    ...
    public static final class $mapped_problem_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_datastructures_problem_link.$mapped_problem_native.class, MAPPED_PROBLEM, MAPPED_PROBLEM_P, $list83, $list84, new String[]{ "$problem", "$variable_map" }, $list85, $list86, PRINT_MAPPED_PROBLEM);
        }
    }
