...
public final class ask_utilities extends SubLTranslatedFile {
    ...
    public static final SubLSymbol INFERENCE_RETURN_TEMPLATE = makeSymbol("INFERENCE-RETURN-TEMPLATE");
    ...
    public static final SubLSymbol QUERY_JUSTIFIED = makeSymbol("QUERY-JUSTIFIED");
    ...
    public static final SubLSymbol ASK_JUSTIFIED = makeSymbol("ASK-JUSTIFIED");
    ...
    public static final SubLSymbol ASK_TEMPLATE = makeSymbol("ASK-TEMPLATE");
    ...
    public static final SubLSymbol QUERY_VARIABLE = makeSymbol("QUERY-VARIABLE");
    ...
    public static final SubLSymbol ASK_VARIABLE = makeSymbol("ASK-VARIABLE");
    ...
    public static final SubLSymbol QUERY_TEMPLATE_EVAL = makeSymbol("QUERY-TEMPLATE-EVAL");
    ...
    public static final SubLSymbol ASK_TEMPLATE_EVAL = makeSymbol("ASK-TEMPLATE-EVAL");
    ...
    private static final SubLObject $const90$predNotAllowedInGeneralizedQueryF = reader_make_constant_shell(makeString("predNotAllowedInGeneralizedQueryForTheSetOf"));
    ...
    public static SubLObject declare_ask_utilities_file() {
        declareFunction(me, "query_properties_from_legacy_ask_parameters", "QUERY-PROPERTIES-FROM-LEGACY-ASK-PARAMETERS", 0, 4, false);
        declareFunction(me, "productivity_limit_from_removal_cost_cutoff", "PRODUCTIVITY-LIMIT-FROM-REMOVAL-COST-CUTOFF", 1, 0, false);
        declareFunction(me, "query_static_properties_from_legacy_ask_parameters", "QUERY-STATIC-PROPERTIES-FROM-LEGACY-ASK-PARAMETERS", 0, 0, false);
        declareFunction(me, "query_dynamic_properties_from_legacy_ask_parameters", "QUERY-DYNAMIC-PROPERTIES-FROM-LEGACY-ASK-PARAMETERS", 0, 5, false);
        declareFunction(me, "query_justified", "QUERY-JUSTIFIED", 1, 2, false);
        declareFunction(me, "ask_justified", "ASK-JUSTIFIED", 1, 5, false);
        declareFunction(me, "query_template", "QUERY-TEMPLATE", 2, 2, false);
        declareFunction(me, "ask_template", "ASK-TEMPLATE", 2, 5, false);
        declareFunction(me, "query_variable", "QUERY-VARIABLE", 2, 2, false);
        declareFunction(me, "ask_variable", "ASK-VARIABLE", 2, 5, false);
        declareFunction(me, "query_template_eval", "QUERY-TEMPLATE-EVAL", 2, 2, false);
        declareFunction(me, "ask_template_eval", "ASK-TEMPLATE-EVAL", 2, 5, false);
        declareFunction(me, "query_boolean", "QUERY-BOOLEAN", 1, 2, false);
        declareFunction(me, "recursive_ask_query_properties_from_legacy_ask_parameters", "RECURSIVE-ASK-QUERY-PROPERTIES-FROM-LEGACY-ASK-PARAMETERS", 0, 4, false);
        declareFunction(me, "within_recursive_queryP", "WITHIN-RECURSIVE-QUERY?", 0, 0, false);
        declareFunction(me, "recursive_query", "RECURSIVE-QUERY", 1, 2, false);
        declareFunction(me, "query_property_inherited_by_recursive_queryP", "QUERY-PROPERTY-INHERITED-BY-RECURSIVE-QUERY?", 1, 0, false);
        declareFunction(me, "filter_query_properties_for_recursive_query", "FILTER-QUERY-PROPERTIES-FOR-RECURSIVE-QUERY", 1, 0, false);
        declareFunction(me, "recursive_query_problem_store_to_reuse", "RECURSIVE-QUERY-PROBLEM-STORE-TO-REUSE", 1, 0, false);
        declareFunction(me, "kappa_tuples", "KAPPA-TUPLES", 3, 1, false);
        declareFunction(me, "kappa_tuples_justified", "KAPPA-TUPLES-JUSTIFIED", 3, 1, false);
        declareFunction(me, "inference_recursive_ask", "INFERENCE-RECURSIVE-ASK", 1, 5, false);
        declareFunction(me, "inference_recursive_query", "INFERENCE-RECURSIVE-QUERY", 1, 2, false);
        declareFunction(me, "inference_recursive_query_unique_bindings", "INFERENCE-RECURSIVE-QUERY-UNIQUE-BINDINGS", 1, 2, false);
        declareFunction(me, "inference_recursive_ask_unique_bindings", "INFERENCE-RECURSIVE-ASK-UNIQUE-BINDINGS", 1, 5, false);
        declareFunction(me, "inference_recursive_query_convert_to_hl_bindings", "INFERENCE-RECURSIVE-QUERY-CONVERT-TO-HL-BINDINGS", 2, 0, false);
        declareFunction(me, "inference_literal_truth", "INFERENCE-LITERAL-TRUTH", 2, 0, false);
        declareFunction(me, "inference_literal_ask", "INFERENCE-LITERAL-ASK", 2, 0, false);
        declareFunction(me, "the_set_of_elements", "THE-SET-OF-ELEMENTS", 1, 2, false);
        declareFunction(me, "the_set_of_problem_solvable_via_generalized_queryP", "THE-SET-OF-PROBLEM-SOLVABLE-VIA-GENERALIZED-QUERY?", 0, 3, false);
        declareFunction(me, "pred_not_allowed_in_generalized_query_for_the_set_ofP", "PRED-NOT-ALLOWED-IN-GENERALIZED-QUERY-FOR-THE-SET-OF?", 1, 0, false);
        declareFunction(me, "the_set_of_elements_via_generalized_query", "THE-SET-OF-ELEMENTS-VIA-GENERALIZED-QUERY", 0, 2, false);
        declareFunction(me, "compute_the_set_of_elements_generalized_query", "COMPUTE-THE-SET-OF-ELEMENTS-GENERALIZED-QUERY", 0, 1, false);
        declareFunction(me, "find_unrestricted_problem_of_the_set_of_expression_problem", "FIND-UNRESTRICTED-PROBLEM-OF-THE-SET-OF-EXPRESSION-PROBLEM", 1, 0, false);
        declareFunction(me, "find_jo_link_and_focal_problem_of_supported_problem", "FIND-JO-LINK-AND-FOCAL-PROBLEM-OF-SUPPORTED-PROBLEM", 1, 0, false);
        declareFunction(me, "the_set_of_elements_generalized_query_memoized_internal", "THE-SET-OF-ELEMENTS-GENERALIZED-QUERY-MEMOIZED-INTERNAL", 2, 0, false);
        declareFunction(me, "the_set_of_elements_generalized_query_memoized", "THE-SET-OF-ELEMENTS-GENERALIZED-QUERY-MEMOIZED", 2, 0, false);
        declareFunction(me, "determine_the_set_of_elements_generalized_query_properties", "DETERMINE-THE-SET-OF-ELEMENTS-GENERALIZED-QUERY-PROPERTIES", 2, 0, false);
        declareFunction(me, "cyc_query_with_minimal_required_transformation", "CYC-QUERY-WITH-MINIMAL-REQUIRED-TRANSFORMATION", 1, 2, false);
        return NIL;
    }
