...
public class inference_strategist extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.harness.inference_strategist";
    ...
    public static SubLObject declare_inference_strategist_file() {
        ...
        declareFunction(myName, "inference_strategist_max_proof_depth_from_properties", "INFERENCE-STRATEGIST-MAX-PROOF-DEPTH-FROM-PROPERTIES", 2, 0, false);
        ...
        declareFunction(myName, "inference_interrupt_external", "INFERENCE-INTERRUPT-EXTERNAL", 1, 1, false);
        ...
        declareFunction(myName, "strategist_wants_recursive_queries_in_currently_active_problem_storeP", "STRATEGIST-WANTS-RECURSIVE-QUERIES-IN-CURRENTLY-ACTIVE-PROBLEM-STORE?", 0, 0, false);
        ...
        declareFunction(myName, "inference_all_explanatory_and_non_explanatory_proof_supports", "INFERENCE-ALL-EXPLANATORY-AND-NON-EXPLANATORY-PROOF-SUPPORTS", 2, 0, false);
