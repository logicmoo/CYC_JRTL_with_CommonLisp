...
import com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_ke_useless_precision_value;
...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_ke_useless_precision_value.*;
...
public final class removal_modules_ke_useless_precision_value extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLList $list0 = list(reader_make_constant_shell(makeString("implies")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), makeSymbol("?TERM"), makeSymbol("?TYPE")), list(reader_make_constant_shell(makeString("intervalSize")), makeSymbol("?INTERVAL"), makeSymbol("?INTERVAL-SIZE")), list(reader_make_constant_shell(makeString("greaterThan")), makeSymbol("?INTERVAL-SIZE"), makeSymbol("?SIZE")), list(reader_make_constant_shell(makeString("keRelevantPrecisionValueForSlotOnType")), makeSymbol("?SLOT"), makeSymbol("?TYPE"), makeSymbol("?SIZE"))), list(reader_make_constant_shell(makeString("keUselessPrecisionValueForSlotOnTerm")), makeSymbol("?SLOT"), makeSymbol("?TERM"), makeSymbol("?INTERVAL")));



    private static final SubLObject $$UniversalVocabularyMt = reader_make_constant_shell(makeString("UniversalVocabularyMt"));

    public static final SubLList $list3 = list(list(list(makeSymbol("?TERM"), makeSymbol("?INTERVAL")), list(makeSymbol("?SLOT"), makeSymbol("?TYPE"), makeSymbol("?SIZE"), makeSymbol("?INTERVAL-SIZE")), list(makeSymbol("?TYPE"), makeSymbol("?SIZE"), makeSymbol("?INTERVAL-SIZE"))), list(NIL, list(list(reader_make_constant_shell(makeString("isa")), makeSymbol("?TERM"), makeSymbol("?TYPE")), list(reader_make_constant_shell(makeString("intervalSize")), makeSymbol("?INTERVAL"), makeSymbol("?INTERVAL-SIZE")), list(reader_make_constant_shell(makeString("greaterThan")), makeSymbol("?INTERVAL-SIZE"), makeSymbol("?SIZE")), list(reader_make_constant_shell(makeString("keRelevantPrecisionValueForSlotOnType")), makeSymbol("?SLOT"), makeSymbol("?TYPE"), makeSymbol("?SIZE")))));
    ...
    public static final SubLList $list11 = list(reader_make_constant_shell(makeString("keUselessPrecisionValueForSlotOnTerm")), makeKeyword("ANYTHING"), list(makeKeyword("BIND"), makeSymbol("TERM")), list(makeKeyword("BIND"), makeSymbol("INTERVAL")));





    private static final SubLObject $const14$keUselessPrecisionValueForSlotOnT = reader_make_constant_shell(makeString("keUselessPrecisionValueForSlotOnTerm"));
    ...
    public static final SubLList $list17 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("keUselessPrecisionValueForSlotOnTerm")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("keUselessPrecisionValueForSlotOnTerm")), makeKeyword("ANYTHING"), makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), ONE_INTEGER, makeKeyword("COMPLETENESS"), makeKeyword("INCOMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-USELESS-PRECISION-FROM-RELEVANT-PRECISION-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$keUselessPrecisionValueForSlotOnTerm <whatever> <fully-bound> <fully-bound>)\n    using relevant precision information from the KB."), makeKeyword("EXAMPLE"), makeString("(#$keUselessPrecisionValueForSlotOnTerm #$age #$Muffet (#$YearsDuration 1 19))") });
    ...
    public static SubLObject declare_removal_modules_ke_useless_precision_value_file() {
        declareFunction(me, "make_useless_precision_from_relevant_precision_rule_support", "MAKE-USELESS-PRECISION-FROM-RELEVANT-PRECISION-RULE-SUPPORT", 0, 0, false);
        declareFunction(me, "useless_precision_from_relevant_precision_rule_antecedent_dnf", "USELESS-PRECISION-FROM-RELEVANT-PRECISION-RULE-ANTECEDENT-DNF", 2, 0, false);
        declareFunction(me, "removal_useless_precision_from_relevant_precision_antecedent_answers", "REMOVAL-USELESS-PRECISION-FROM-RELEVANT-PRECISION-ANTECEDENT-ANSWERS", 2, 1, false);
        declareFunction(me, "removal_useless_precision_from_relevant_precision_pos_expand", "REMOVAL-USELESS-PRECISION-FROM-RELEVANT-PRECISION-POS-EXPAND", 1, 1, false);
        return NIL;
    }
