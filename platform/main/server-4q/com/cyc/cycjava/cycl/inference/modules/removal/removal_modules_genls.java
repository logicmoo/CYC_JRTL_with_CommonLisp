...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_genls.*;
...
public final class removal_modules_genls extends SubLTranslatedFile {
    ...
    public static final SubLList $list5 = list(makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("FORT")), makeKeyword("PREFERENCE-LEVEL"), makeKeyword("DISPREFERRED"));

    private static final SubLSymbol $ALL_SPECS_OF_NON_FORT_POS = makeKeyword("ALL-SPECS-OF-NON-FORT-POS");

    public static final SubLList $list7 = list(makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), makeKeyword("NOT-FULLY-BOUND"), list(makeKeyword("AND"), makeKeyword("FULLY-BOUND"), list(makeKeyword("NOT"), makeKeyword("FORT")))), makeKeyword("PREFERENCE-LEVEL"), makeKeyword("GROSSLY-DISPREFERRED"));

    private static final SubLSymbol $ALL_GENLS_POS = makeKeyword("ALL-GENLS-POS");

    public static final SubLList $list9 = list(makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), makeKeyword("FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("PREFERENCE-LEVEL"), makeKeyword("DISPREFERRED"));
    ...
    private static final SubLList $list13 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), makeKeyword("FORT"), makeKeyword("FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-SUPERSET-COST*"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-SUPERSET-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$genls <fort> <fully-bound>)"), makeKeyword("EXAMPLE"), makeString("(#$genls #$Dog #$Animal)") });

    private static final SubLSymbol $REMOVAL_NAT_GENLS = makeKeyword("REMOVAL-NAT-GENLS");

    private static final SubLList $list15 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), cons(makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND")), makeKeyword("FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-SUPERSET-COST*"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-NAT-GENLS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$genls (<fully-bound> . <fully-bound>) <fully-bound>)\n    via #$resultGenl and #$resultGenlArg"), makeKeyword("EXAMPLE"), makeString("(#$genls (#$JuvenileFn #$Cougar) #$Animal)") });

    private static final SubLSymbol $REMOVAL_ALL_GENLS = makeKeyword("REMOVAL-ALL-GENLS");

    private static final SubLList $list17 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), makeKeyword("FORT"), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("COST"), makeSymbol("REMOVAL-ALL-GENLS-COST"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-ALL-GENLS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$genls <fort> <not fully-bound>)"), makeKeyword("EXAMPLE"), makeString("(#$genls #$Dog ?WHAT)") });

    private static final SubLSymbol $REMOVAL_NAT_ALL_GENLS = makeKeyword("REMOVAL-NAT-ALL-GENLS");

    private static final SubLList $list19 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), cons(makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND")), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-NAT-ALL-GENLS-COST*"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-NAT-ALL-GENLS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$genls (<fully-bound> . <fully-bound>) <not fully-bound>)\n    via #$resultGenl and #$resultGenlArg"), makeKeyword("EXAMPLE"), makeString("(#$genls (#$JuvenileFn #$Cougar) ?WHAT)") });
    ...
    private static final SubLList $list22 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("FORT")), makeKeyword("COST"), makeSymbol("REMOVAL-ALL-SPECS-COST"), makeKeyword("COMPLETENESS"), makeKeyword("GROSSLY-INCOMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("genls")), makeKeyword("ANYTHING"), list(makeKeyword("BIND"), makeSymbol("COLLECTION"))), list(makeKeyword("VALUE"), makeSymbol("COLLECTION"))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("CALL"), makeSymbol("REMOVAL-ALL-SPECS-ITERATOR"), makeKeyword("INPUT")), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(reader_make_constant_shell(makeString("genls")), makeKeyword("INPUT"), list(makeKeyword("VALUE"), makeSymbol("COLLECTION"))), makeKeyword("SUPPORT-MODULE"), makeKeyword("GENLS"), makeKeyword("SUPPORT-STRENGTH"), makeKeyword("DEFAULT"), makeKeyword("DOCUMENTATION"), makeString("(#$genls <not fully-bound> <fort>)"), makeKeyword("EXAMPLE"), makeString("(#$genls ?WHAT #$Animal)") });



    private static final SubLSymbol $REMOVAL_NOT_SUPERSET = makeKeyword("REMOVAL-NOT-SUPERSET");

    private static final SubLList $list25 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), list(makeKeyword("OR"), makeKeyword("FORT"), cons(makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND"))), makeKeyword("FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), list(makeSymbol("FIF"), makeSymbol("*NEGATION-BY-FAILURE*"), makeSymbol("*DEFAULT-SUPERSET-COST*"), makeSymbol("*DEFAULT-NOT-SUPERSET-COST*")), makeKeyword("EXPAND"), makeSymbol("REMOVAL-NOT-SUPERSET-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not (#$genls <fort> <fully-bound>))\n    (#$not (#$genls (<fully-bound> . <fully-bound>) <fully-bound>))"), makeKeyword("EXAMPLE"), makeString("(#$not (#$genls #$Collection #$Individual))\n    (#$not (#$genls (#$JuvenileFn #$Cougar) #$Individual))") });

    private static final SubLSymbol $REMOVAL_GENLS_BETWEEN = makeKeyword("REMOVAL-GENLS-BETWEEN");

    private static final SubLList $list27 = list(new SubLObject[]{ makeKeyword("EVERY-PREDICATES"), list(reader_make_constant_shell(makeString("genls"))), makeKeyword("APPLICABILITY"), makeSymbol("REMOVAL-GENLS-BETWEEN-APPLICABILITY"), makeKeyword("COST"), makeSymbol("REMOVAL-GENLS-BETWEEN-COST"), makeKeyword("COMPLETENESS-PATTERN"), list(makeKeyword("CALL"), makeSymbol("REMOVAL-GENLS-BETWEEN-COMPLETENESS")), makeKeyword("EXPAND"), makeSymbol("REMOVAL-GENLS-BETWEEN-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$and (#$genls <fort1> <varN>)\n           (#$genls <varN> <fort2>))"), makeKeyword("EXAMPLE"), makeString("(#$and (#$genls #$Dog ?COL)\n           (#$genls ?COL #$Animal))") });
    ...
    public static final SubLList $list34 = list(makeSymbol("CONTEXTUALIZED-ASENT0"), makeSymbol("CONTEXTUALIZED-ASENT1"));

    public static final SubLList $list35 = list(makeSymbol("MT0"), makeSymbol("ASENT0"));

    public static final SubLList $list36 = list(makeSymbol("MT1"), makeSymbol("ASENT1"));
    ...
    private static final SubLList $list39 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), list(makeKeyword("NAT"), cons(reader_make_constant_shell(makeString("CollectionSubsetFn")), makeKeyword("FULLY-BOUND"))), list(makeKeyword("NAT"), cons(reader_make_constant_shell(makeString("CollectionSubsetFn")), makeKeyword("FULLY-BOUND")))), makeKeyword("COST-EXPRESSION"), makeSymbol("*EXPENSIVE-HL-MODULE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("GROSSLY-INCOMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-GENLS-COLLECTION-SUBSET-CHECK-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$genls (#$CollectionSubsetFn . <fully-bound>) (#$CollectionSubsetFn . <fully-bound>))") });
    ...
    private static final SubLList $list41 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genls")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genls")), list(makeKeyword("NAT"), cons(reader_make_constant_shell(makeString("CollectionSubsetFn")), makeKeyword("FULLY-BOUND"))), list(makeKeyword("NAT"), cons(reader_make_constant_shell(makeString("CollectionSubsetFn")), makeKeyword("FULLY-BOUND")))), makeKeyword("COST-EXPRESSION"), makeSymbol("*EXPENSIVE-HL-MODULE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("GROSSLY-INCOMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-GENLS-COLLECTION-SUBSET-CHECK-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not (#$genls (#$CollectionSubsetFn . <fully-bound>) (#$CollectionSubsetFn . <fully-bound>)))") });
    ...
    private static final SubLObject $$genlsDown = reader_make_constant_shell(makeString("genlsDown"));

    private static final SubLSymbol $REMOVAL_GENLS_DOWN_ARG2_BOUND = makeKeyword("REMOVAL-GENLS-DOWN-ARG2-BOUND");

    private static final SubLList $list48 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genlsDown")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genlsDown")), makeKeyword("ANYTHING"), makeKeyword("FULLY-BOUND")), makeKeyword("COST"), makeSymbol("REMOVAL-GENLS-DOWN-ARG2-BOUND-COST"), makeKeyword("COMPLETENESS-PATTERN"), list(makeKeyword("CALL"), makeSymbol("REMOVAL-GENLS-DOWN-ARG2-BOUND-COMPLETENESS"), makeKeyword("INPUT")), makeKeyword("EXPAND"), makeSymbol("REMOVAL-GENLS-DOWN-ARG2-BOUND-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$genlsDown <fully-bound> <fully-bound>)\n(#$genlsDown <not-fully-bound> <fully-bound>)"), makeKeyword("EXAMPLE"), makeString("(#$genlsDown #$Dog #$Animal)\n(#$genlsDown ?WHAT #$Dog)") });

    public static final SubLSymbol REMOVAL_GENLS_DOWN_ARG2_BOUND_COST = makeSymbol("REMOVAL-GENLS-DOWN-ARG2-BOUND-COST");

    public static final SubLSymbol REMOVAL_GENLS_DOWN_ARG2_BOUND_COMPLETENESS = makeSymbol("REMOVAL-GENLS-DOWN-ARG2-BOUND-COMPLETENESS");



    public static final SubLSymbol REMOVAL_GENLS_DOWN_ARG2_BOUND_EXPAND = makeSymbol("REMOVAL-GENLS-DOWN-ARG2-BOUND-EXPAND");
    ...
    public static final SubLList $list55 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("genlsDown")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("genlsDown")), makeKeyword("FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), ONE_INTEGER, makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("genlsDown")), list(makeKeyword("BIND"), makeSymbol("TERM")), makeKeyword("ANYTHING")), list(makeKeyword("VALUE"), makeSymbol("TERM"))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(list(reader_make_constant_shell(makeString("genlsDown")), makeKeyword("INPUT"), makeKeyword("INPUT"))), makeKeyword("SUPPORT-MODULE"), makeKeyword("REFLEXIVE"), makeKeyword("DOCUMENTATION"), makeString("(#$genlsDown <fully-bound> <not-fully-bound>)"), makeKeyword("EXAMPLE"), makeString("(#$genlsDown #$Dog ?WHAT)") });
    ...
    public static SubLObject removal_genls_between_cost(final SubLObject contextualized_dnf_clause) {
        ...
        assert NIL != forts.fort_p(spec) : "forts.fort_p(spec) " + "CommonSymbols.NIL != forts.fort_p(spec) " + spec;
        assert NIL != forts.fort_p(genl) : "forts.fort_p(genl) " + "CommonSymbols.NIL != forts.fort_p(genl) " + genl;
    ...
    public static SubLObject declare_removal_modules_genls_file() {
        declareFunction(me, "inference_genlP", "INFERENCE-GENL?", 2, 2, false);
        declareFunction(me, "inference_not_genlP", "INFERENCE-NOT-GENL?", 2, 2, false);
        declareFunction(me, "inference_all_genls", "INFERENCE-ALL-GENLS", 1, 2, false);
        declareFunction(me, "inference_all_specs", "INFERENCE-ALL-SPECS", 1, 2, false);
        declareFunction(me, "inference_genls_between", "INFERENCE-GENLS-BETWEEN", 2, 1, false);
        declareFunction(me, "removal_superset_expand", "REMOVAL-SUPERSET-EXPAND", 1, 1, false);
        ...
        declareFunction(me, "removal_nat_genls_expand", "REMOVAL-NAT-GENLS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_all_genls_cost", "REMOVAL-ALL-GENLS-COST", 1, 1, false);
        declareFunction(me, "removal_all_genls_expand", "REMOVAL-ALL-GENLS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_nat_all_genls_expand", "REMOVAL-NAT-ALL-GENLS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_all_specs_cost", "REMOVAL-ALL-SPECS-COST", 1, 1, false);
        declareFunction(me, "removal_all_specs_iterator", "REMOVAL-ALL-SPECS-ITERATOR", 1, 0, false);
        declareFunction(me, "removal_not_superset_expand", "REMOVAL-NOT-SUPERSET-EXPAND", 1, 1, false);
        declareFunction(me, "removal_genls_between_applicability", "REMOVAL-GENLS-BETWEEN-APPLICABILITY", 1, 0, false);
        new removal_modules_genls.$removal_genls_between_applicability$UnaryFunction();
        declareFunction(me, "removal_genls_between_cost", "REMOVAL-GENLS-BETWEEN-COST", 1, 0, false);
        declareFunction(me, "removal_genls_between_completeness", "REMOVAL-GENLS-BETWEEN-COMPLETENESS", 0, 0, false);
        declareFunction(me, "removal_genls_between_expand", "REMOVAL-GENLS-BETWEEN-EXPAND", 1, 0, false);
        declareFunction(me, "removal_sbhl_between_applicability", "REMOVAL-SBHL-BETWEEN-APPLICABILITY", 2, 0, false);
        declareFunction(me, "find_pos_pred_indices_for_pred_between", "FIND-POS-PRED-INDICES-FOR-PRED-BETWEEN", 2, 0, false);
        declareFunction(me, "removal_genls_between_categorize_asents", "REMOVAL-GENLS-BETWEEN-CATEGORIZE-ASENTS", 2, 0, false);
        declareFunction(me, "removal_genls_collection_subset_check_pos_expand", "REMOVAL-GENLS-COLLECTION-SUBSET-CHECK-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_genls_collection_subset_check_neg_expand", "REMOVAL-GENLS-COLLECTION-SUBSET-CHECK-NEG-EXPAND", 1, 1, false);
        declareFunction(me, "removal_genls_collection_subset_construct_query", "REMOVAL-GENLS-COLLECTION-SUBSET-CONSTRUCT-QUERY", 1, 0, false);
        declareFunction(me, "removal_genls_down_arg2_bound_cost", "REMOVAL-GENLS-DOWN-ARG2-BOUND-COST", 1, 1, false);
        declareFunction(me, "removal_genls_down_arg2_bound_completeness", "REMOVAL-GENLS-DOWN-ARG2-BOUND-COMPLETENESS", 1, 0, false);
        declareFunction(me, "removal_genls_down_arg2_bound_expand", "REMOVAL-GENLS-DOWN-ARG2-BOUND-EXPAND", 1, 1, false);
        declareFunction(me, "destructure_genls_down_asent", "DESTRUCTURE-GENLS-DOWN-ASENT", 1, 0, false);
        return NIL;
    }
