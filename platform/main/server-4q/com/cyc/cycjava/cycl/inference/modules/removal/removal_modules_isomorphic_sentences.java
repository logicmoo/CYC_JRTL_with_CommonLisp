...
import com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_isomorphic_sentences;
...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_isomorphic_sentences.*;
...
public final class removal_modules_isomorphic_sentences extends SubLTranslatedFile {
    ...
    private static final SubLObject $$isomorphicSentences = reader_make_constant_shell(makeString("isomorphicSentences"));
    ...
    private static final SubLList $list3 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("isomorphicSentences")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("isomorphicSentences")), cons(reader_make_constant_shell(makeString("TheList")), makeKeyword("FULLY-BOUND")), cons(reader_make_constant_shell(makeString("TheList")), makeKeyword("FULLY-BOUND"))), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("COST-EXPRESSION"), makeSymbol("*CHEAP-HL-MODULE-CHECK-COST*"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("isomorphicSentences")), list(makeKeyword("BIND"), makeSymbol("TERM-EL-LIST")), list(makeKeyword("BIND"), makeSymbol("SENTENCE-EL-LIST"))), list(list(makeKeyword("VALUE"), makeSymbol("TERM-EL-LIST")), list(makeKeyword("VALUE"), makeSymbol("SENTENCE-EL-LIST")))), makeKeyword("OUTPUT-CHECK-PATTERN"), list(makeKeyword("TUPLE"), list(makeSymbol("TERM-EL-LIST"), makeSymbol("SENTENCE-EL-LIST")), list(makeKeyword("CALL"), makeSymbol("ISOMORPHIC-SENTENCES?"), list(makeKeyword("VALUE"), makeSymbol("TERM-EL-LIST")), list(makeKeyword("VALUE"), makeSymbol("SENTENCE-EL-LIST")))), makeKeyword("SUPPORT"), makeSymbol("MAKE-ISOMORPHIC-SENTENCES-SUPPORT"), makeKeyword("DOCUMENTATION"), makeString("(#$isomorphicSentences (#$TheList . <fullybound>) (#$TheList . <fullybound>)  "), makeKeyword("EXAMPLE"), makeString("(#$isomorphicSentences \n       (#$TheList #$Muffet #$Snoopy #$Molly) \n       (#$TheList (#$isa #$Muffet #$Dog) (#$isa #$Snoopy #$Dog) (#$isa #$Molly #$Dog)))") });

    private static final SubLSymbol $sym4$_FOO = makeSymbol("?FOO");



    private static final SubLList $list6 = list(reader_make_constant_shell(makeString("implies")), list(new SubLObject[]{ reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isomorphicSentences")), makeSymbol("?TERM-LIST"), makeSymbol("?FORMULA-LIST")), list(reader_make_constant_shell(makeString("integerBetween")), ONE_INTEGER, makeSymbol("?NUM-1"), makeSymbol("?TERM-COUNT")), list(reader_make_constant_shell(makeString("integerBetween")), ONE_INTEGER, makeSymbol("?NUM-2"), makeSymbol("?TERM-COUNT")), list(reader_make_constant_shell(makeString("evaluate")), makeSymbol("?TERM-COUNT"), list(reader_make_constant_shell(makeString("LengthOfListFn")), makeSymbol("?TERM-LIST"))), list(reader_make_constant_shell(makeString("evaluate")), makeSymbol("?TERM-1"), list(reader_make_constant_shell(makeString("NthInListFn")), makeSymbol("?TERM-LIST"), makeSymbol("?NUM-1"))), list(reader_make_constant_shell(makeString("evaluate")), makeSymbol("?TERM-2"), list(reader_make_constant_shell(makeString("NthInListFn")), makeSymbol("?TERM-LIST"), makeSymbol("?NUM-2"))), list(reader_make_constant_shell(makeString("evaluate")), makeSymbol("?FORMULA-1"), list(reader_make_constant_shell(makeString("NthInListFn")), makeSymbol("?FORMULA-LIST"), makeSymbol("?NUM-1"))), list(reader_make_constant_shell(makeString("evaluate")), makeSymbol("?FORMULA-2"), list(reader_make_constant_shell(makeString("NthInListFn")), makeSymbol("?FORMULA-LIST"), makeSymbol("?NUM-2"))) }), list(reader_make_constant_shell(makeString("formulaSubstitutionFor")), makeSymbol("?TERM-1"), makeSymbol("?TERM-2"), makeSymbol("?FORMULA-1"), makeSymbol("?FORMULA-2")));
    ...
    public static SubLObject declare_removal_modules_isomorphic_sentences_file() {
        declareFunction(me, "isomorphic_sentencesP", "ISOMORPHIC-SENTENCES?", 2, 0, false);
        declareFunction(me, "make_isomorphic_sentences_support", "MAKE-ISOMORPHIC-SENTENCES-SUPPORT", 1, 1, false);
        declareFunction(me, "make_isomorphic_sentences_rule_support", "MAKE-ISOMORPHIC-SENTENCES-RULE-SUPPORT", 0, 0, false);
        declareFunction(me, "removal_isomorphic_sentences_term_unify_expand", "REMOVAL-ISOMORPHIC-SENTENCES-TERM-UNIFY-EXPAND", 1, 1, false);
        declareFunction(me, "removal_determine_sentence_isomorphisms", "REMOVAL-DETERMINE-SENTENCE-ISOMORPHISMS", 1, 0, false);
        declareFunction(me, "removal_determine_different_terms_and_verify", "REMOVAL-DETERMINE-DIFFERENT-TERMS-AND-VERIFY", 4, 0, false);
        declareFunction(me, "removal_equal_length_list_difference", "REMOVAL-EQUAL-LENGTH-LIST-DIFFERENCE", 2, 1, false);
        declareFunction(me, "removal_isomorphic_sentences_prune_required", "REMOVAL-ISOMORPHIC-SENTENCES-PRUNE-REQUIRED", 1, 1, false);
        declareFunction(me, "removal_isomorphic_sentences_prune_required_int", "REMOVAL-ISOMORPHIC-SENTENCES-PRUNE-REQUIRED-INT", 3, 0, false);
        return NIL;
    }
