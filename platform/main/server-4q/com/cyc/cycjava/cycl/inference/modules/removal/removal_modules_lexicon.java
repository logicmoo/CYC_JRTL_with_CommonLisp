...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_lexicon.*;
...
public final class removal_modules_lexicon extends SubLTranslatedFile {
    ...
    public static SubLObject removal_word_strings_iterator_state_p(final SubLObject v_object) {
        return v_object.getClass() == removal_modules_lexicon.$removal_word_strings_iterator_state_native.class ? T : NIL;
    }

    public static SubLObject removal_wsi_state_speech_part_predicate(final SubLObject v_object) {
        assert NIL != removal_word_strings_iterator_state_p(v_object) : "removal_modules_lexicon.removal_word_strings_iterator_state_p(v_object) " + "CommonSymbols.NIL != removal_modules_lexicon.removal_word_strings_iterator_state_p(v_object) " + v_object;
    ...
    public static SubLObject make_removal_word_strings_iterator_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new removal_modules_lexicon.$removal_word_strings_iterator_state_native();
        SubLObject next;
    ...
    public static final class $removal_word_strings_iterator_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(removal_modules_lexicon.$removal_word_strings_iterator_state_native.class, REMOVAL_WORD_STRINGS_ITERATOR_STATE, REMOVAL_WORD_STRINGS_ITERATOR_STATE_P, $list33, $list34, new String[]{ "$speech_part_predicate", "$arg1", "$arg2", "$trie_iterator", "$entry_iterator" }, $list35, $list36, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
