...
public final class inference_datastructures_inference extends SubLTranslatedFile {
    ...
    public static SubLObject infrnc_suid(final SubLObject v_object) {
        assert NIL != inference_p(v_object) : "inference_datastructures_inference.inference_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_inference.inference_p(v_object) " + v_object;
    ...
    public static SubLObject inf_answer_suid(final SubLObject v_object) {
        assert NIL != inference_answer_p(v_object) : "inference_datastructures_inference.inference_answer_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_inference.inference_answer_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject inf_ans_just_answer(final SubLObject v_object) {
        assert NIL != inference_answer_justification_p(v_object) : "inference_datastructures_inference.inference_answer_justification_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_inference.inference_answer_justification_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $inference_answer_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_datastructures_inference.$inference_answer_native.class, INFERENCE_ANSWER, INFERENCE_ANSWER_P, $list442, $list443, new String[]{ "$suid", "$inference", "$bindings", "$justifications", "$elapsed_creation_time", "$step_count" }, $list444, $list445, PRINT_INFERENCE_ANSWER);
        }
    }
    ...
    public static final class $inference_answer_justification_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_datastructures_inference.$inference_answer_justification_native.class, INFERENCE_ANSWER_JUSTIFICATION, INFERENCE_ANSWER_JUSTIFICATION_P, $list482, $list483, new String[]{ "$answer", "$supports", "$pragma_supports", "$proofs" }, $list484, $list485, PRINT_INFERENCE_ANSWER_JUSTIFICATION);
        }
    }
