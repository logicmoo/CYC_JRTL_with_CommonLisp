...
import static com.cyc.cycjava.cycl.inference.harness.removal_tactician_datastructures.*;
...
public final class removal_tactician_datastructures extends SubLTranslatedFile {
    ...
    public static SubLObject removal_strategy_data_p(final SubLObject v_object) {
        return v_object.getClass() == removal_tactician_datastructures.$removal_strategy_data_native.class ? T : NIL;
    }

    public static SubLObject rem_strat_data_link_heads_motivated(final SubLObject v_object) {
        assert NIL != removal_strategy_data_p(v_object) : "removal_tactician_datastructures.removal_strategy_data_p(v_object) " + "CommonSymbols.NIL != removal_tactician_datastructures.removal_strategy_data_p(v_object) " + v_object;
    ...
    public static SubLObject make_removal_strategy_data(SubLObject arglist) {
        ...
        final SubLObject v_new = new removal_tactician_datastructures.$removal_strategy_data_native();
        SubLObject next;
    ...
    public static final class $removal_strategy_data_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(removal_tactician_datastructures.$removal_strategy_data_native.class, REMOVAL_STRATEGY_DATA, REMOVAL_STRATEGY_DATA_P, $list2, $list3, new String[]{ "$link_heads_motivated", "$problems_pending", "$removal_strategem_index", "$problem_total_strategems_active", "$problem_strategems_set_aside", "$problem_strategems_thrown_away" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
