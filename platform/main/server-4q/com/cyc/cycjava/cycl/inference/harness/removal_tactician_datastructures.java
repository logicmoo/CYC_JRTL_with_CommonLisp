...
public class removal_tactician_datastructures extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.harness.removal_tactician_datastructures";
    ...
    public static SubLObject declare_removal_tactician_datastructures_file() {
        ...
        declareFunction(myName, "removal_strategy_data_p", "REMOVAL-STRATEGY-DATA-P", 1, 0, false);
        ...
        declareFunction(myName, "visit_defstruct_removal_strategy_data", "VISIT-DEFSTRUCT-REMOVAL-STRATEGY-DATA", 2, 0, false);
        declareFunction(myName, "visit_defstruct_object_removal_strategy_data_method", "VISIT-DEFSTRUCT-OBJECT-REMOVAL-STRATEGY-DATA-METHOD", 2, 0, false);
        ...
        declareFunction(myName, "removal_strategy_force_done", "REMOVAL-STRATEGY-FORCE-DONE", 1, 0, false);
