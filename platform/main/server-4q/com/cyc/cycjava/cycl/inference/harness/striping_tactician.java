...
import static com.cyc.cycjava.cycl.inference.harness.striping_tactician.*;
...
public final class striping_tactician extends SubLTranslatedFile {
    ...
    private static final SubLList $list1 = list(new SubLObject[]{ makeKeyword("NAME"), makeString("Striping Tactician"), makeKeyword("COMMENT"), makeString("A balancing tactician type which delegates to a new-root tactician,\n a transformation tactician, and multiple removal tacticians."), makeKeyword("CONSTRUCTOR"), makeSymbol("STRIPING-TACTICIAN-INITIALIZE"), makeKeyword("DONE?"), makeSymbol("STRIPING-TACTICIAN-DONE?"), makeKeyword("DO-ONE-STEP"), makeSymbol("STRIPING-TACTICIAN-DO-ONE-STEP"), makeKeyword("INITIAL-RELEVANT-STRATEGIES"), makeSymbol("STRIPING-TACTICIAN-INITIAL-RELEVANT-STRATEGIES"), makeKeyword("INITIALIZE-PROPERTIES"), makeSymbol("STRIPING-TACTICIAN-INITIALIZE-PROPERTIES"), makeKeyword("UPDATE-PROPERTIES"), makeSymbol("STRIPING-TACTICIAN-UPDATE-PROPERTIES"), makeKeyword("INFERENCE-DYNAMIC-PROPERTIES-UPDATED"), makeSymbol("STRIPING-TACTICIAN-NOTE-INFERENCE-DYNAMIC-PROPERTIES-UPDATED"), makeKeyword("CONTINUATION-POSSIBLE?"), makeSymbol("STRIPING-TACTICIAN-CONTINUATION-POSSIBLE?"), makeKeyword("THROW-AWAY-UNINTERESTING-SET-ASIDES"), makeSymbol("STRIPING-TACTICIAN-THROW-AWAY-UNINTERESTING-SET-ASIDES"), makeKeyword("EARLY-REMOVAL-PRODUCTIVITY-LIMIT"), makeSymbol("STRIPING-TACTICIAN-EARLY-REMOVAL-PRODUCTIVITY-LIMIT"), makeKeyword("POSSIBLY-ACTIVATE-PROBLEM"), makeSymbol("STRIPING-TACTICIAN-POSSIBLY-ACTIVATE-PROBLEM"), makeKeyword("THROW-AWAY-PROBLEM"), makeSymbol("STRIPING-TACTICIAN-CHOOSES-TO-THROW-AWAY-PROBLEM?"), makeKeyword("SET-ASIDE-PROBLEM"), makeSymbol("STRIPING-TACTICIAN-CHOOSES-TO-SET-ASIDE-PROBLEM?"), makeKeyword("THROW-AWAY-TACTIC"), makeSymbol("STRIPING-TACTICIAN-CHOOSES-TO-THROW-AWAY-TACTIC?"), makeKeyword("SET-ASIDE-TACTIC"), makeSymbol("STRIPING-TACTICIAN-CHOOSES-TO-SET-ASIDE-TACTIC?"), makeKeyword("NEW-ARGUMENT-LINK"), makeSymbol("STRIPING-TACTICIAN-NOTE-ARGUMENT-LINK"), makeKeyword("NEW-TACTIC"), makeSymbol("IGNORE"), makeKeyword("SPLIT-TACTICS-POSSIBLE"), makeSymbol("IGNORE"), makeKeyword("PROBLEM-COULD-BE-PENDING"), makeSymbol("IGNORE"), makeKeyword("LINK-HEAD-MOTIVATED?"), makeSymbol("FALSE"), makeKeyword("PROBLEM-NOTHING-TO-DO?"), makeSymbol("FALSE"), makeKeyword("SUBSTRATEGY-STRATEGEM-MOTIVATED"), makeSymbol("STRIPING-TACTICIAN-SUBSTRATEGY-STRATEGEM-MOTIVATED"), makeKeyword("SUBSTRATEGY-TOTALLY-THROW-AWAY-TACTIC"), makeSymbol("STRIPING-TACTICIAN-CHOOSES-TO-TOTALLY-THROW-AWAY-TACTIC?"), makeKeyword("SUBSTRATEGY-ALLOW-SPLIT-TACTIC-SET-ASIDE-WRT-REMOVAL"), makeSymbol("STRIPING-TACTICIAN-ALLOWS-SPLIT-TACTIC-TO-BE-SET-ASIDE-WRT-REMOVAL?"), makeKeyword("SUBSTRATEGY-PROBLEM-STATUS-CHANGE"), makeSymbol("STRIPING-TACTICIAN-SUBSTRATEGY-PROBLEM-STATUS-CHANGE") });
    ...
    private static final SubLList $list4 = list(makeSymbol("NEW-ROOT-SUBSTRATEGY"), makeSymbol("TRANSFORMATION-SUBSTRATEGY"), makeSymbol("REMOVAL-SUBSTRATEGIES"), makeSymbol("NEW-ROOT-R-MAP"), makeSymbol("NEW-ROOT-PROOFINESS-MAP"), makeSymbol("NEW-ROOT-DELAY-MAP"), makeSymbol("NEW-ROOT-METRICS-MAP"));

    private static final SubLList $list5 = list(makeKeyword("NEW-ROOT-SUBSTRATEGY"), makeKeyword("TRANSFORMATION-SUBSTRATEGY"), makeKeyword("REMOVAL-SUBSTRATEGIES"), makeKeyword("NEW-ROOT-R-MAP"), makeKeyword("NEW-ROOT-PROOFINESS-MAP"), makeKeyword("NEW-ROOT-DELAY-MAP"), makeKeyword("NEW-ROOT-METRICS-MAP"));

    private static final SubLList $list6 = list(makeSymbol("STR-TAC-DATA-NEW-ROOT-SUBSTRATEGY"), makeSymbol("STR-TAC-DATA-TRANSFORMATION-SUBSTRATEGY"), makeSymbol("STR-TAC-DATA-REMOVAL-SUBSTRATEGIES"), makeSymbol("STR-TAC-DATA-NEW-ROOT-R-MAP"), makeSymbol("STR-TAC-DATA-NEW-ROOT-PROOFINESS-MAP"), makeSymbol("STR-TAC-DATA-NEW-ROOT-DELAY-MAP"), makeSymbol("STR-TAC-DATA-NEW-ROOT-METRICS-MAP"));

    private static final SubLList $list7 = list(makeSymbol("_CSETF-STR-TAC-DATA-NEW-ROOT-SUBSTRATEGY"), makeSymbol("_CSETF-STR-TAC-DATA-TRANSFORMATION-SUBSTRATEGY"), makeSymbol("_CSETF-STR-TAC-DATA-REMOVAL-SUBSTRATEGIES"), makeSymbol("_CSETF-STR-TAC-DATA-NEW-ROOT-R-MAP"), makeSymbol("_CSETF-STR-TAC-DATA-NEW-ROOT-PROOFINESS-MAP"), makeSymbol("_CSETF-STR-TAC-DATA-NEW-ROOT-DELAY-MAP"), makeSymbol("_CSETF-STR-TAC-DATA-NEW-ROOT-METRICS-MAP"));
    ...
    private static final SubLList $list40 = list(makeKeyword("DONE"));
    ...
    private static final SubLList $list64 = list(makeSymbol("START-INFERENCE-STEP-COUNT"), makeSymbol("INDEX"), makeSymbol("START-TIME"), makeSymbol("TIME-TO-FIRST-ANSWER"), makeSymbol("STEPS-TO-FIRST-ANSWER"), makeSymbol("TIME-TO-LAST-ANSWER"), makeSymbol("STEPS-TO-LAST-ANSWER"), makeSymbol("ANSWER-COUNT"));

    private static final SubLList $list65 = list(makeKeyword("START-INFERENCE-STEP-COUNT"), makeKeyword("INDEX"), makeKeyword("START-TIME"), makeKeyword("TIME-TO-FIRST-ANSWER"), makeKeyword("STEPS-TO-FIRST-ANSWER"), makeKeyword("TIME-TO-LAST-ANSWER"), makeKeyword("STEPS-TO-LAST-ANSWER"), makeKeyword("ANSWER-COUNT"));

    private static final SubLList $list66 = list(makeSymbol("NR-METRICS-START-INFERENCE-STEP-COUNT"), makeSymbol("NR-METRICS-INDEX"), makeSymbol("NR-METRICS-START-TIME"), makeSymbol("NR-METRICS-TIME-TO-FIRST-ANSWER"), makeSymbol("NR-METRICS-STEPS-TO-FIRST-ANSWER"), makeSymbol("NR-METRICS-TIME-TO-LAST-ANSWER"), makeSymbol("NR-METRICS-STEPS-TO-LAST-ANSWER"), makeSymbol("NR-METRICS-ANSWER-COUNT"));

    private static final SubLList $list67 = list(makeSymbol("_CSETF-NR-METRICS-START-INFERENCE-STEP-COUNT"), makeSymbol("_CSETF-NR-METRICS-INDEX"), makeSymbol("_CSETF-NR-METRICS-START-TIME"), makeSymbol("_CSETF-NR-METRICS-TIME-TO-FIRST-ANSWER"), makeSymbol("_CSETF-NR-METRICS-STEPS-TO-FIRST-ANSWER"), makeSymbol("_CSETF-NR-METRICS-TIME-TO-LAST-ANSWER"), makeSymbol("_CSETF-NR-METRICS-STEPS-TO-LAST-ANSWER"), makeSymbol("_CSETF-NR-METRICS-ANSWER-COUNT"));
    ...
    public static SubLObject striping_tactician_data_p(final SubLObject v_object) {
        return v_object.getClass() == striping_tactician.$striping_tactician_data_native.class ? T : NIL;
    }

    public static SubLObject str_tac_data_new_root_substrategy(final SubLObject v_object) {
        assert NIL != striping_tactician_data_p(v_object) : "striping_tactician.striping_tactician_data_p(v_object) " + "CommonSymbols.NIL != striping_tactician.striping_tactician_data_p(v_object) " + v_object;
    ...
    public static SubLObject make_striping_tactician_data(SubLObject arglist) {
        ...
        final SubLObject v_new = new striping_tactician.$striping_tactician_data_native();
        SubLObject next;
    ...
    public static SubLObject new_root_metrics_p(final SubLObject v_object) {
        return v_object.getClass() == striping_tactician.$new_root_metrics_native.class ? T : NIL;
    }

    public static SubLObject nr_metrics_start_inference_step_count(final SubLObject v_object) {
        assert NIL != new_root_metrics_p(v_object) : "striping_tactician.new_root_metrics_p(v_object) " + "CommonSymbols.NIL != striping_tactician.new_root_metrics_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_new_root_metrics(SubLObject arglist) {
        ...
        final SubLObject v_new = new striping_tactician.$new_root_metrics_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
                ...
                if (pcase_var.eql($INDEX)) {
                    ...
                    if (pcase_var.eql($START_TIME)) {
                        ...
                        if (pcase_var.eql($TIME_TO_FIRST_ANSWER)) {
                            ...
                            if (pcase_var.eql($STEPS_TO_FIRST_ANSWER)) {
                                ...
                                if (pcase_var.eql($TIME_TO_LAST_ANSWER)) {
                                    ...
                                    if (pcase_var.eql($STEPS_TO_LAST_ANSWER)) {
    ...
    public static SubLObject construct_new_root_metrics_plist(final SubLObject start_inference_step_count, final SubLObject start_time, final SubLObject time_to_first_answer, final SubLObject steps_to_first_answer, final SubLObject time_to_last_answer, final SubLObject steps_to_last_answer, final SubLObject answer_count, final SubLObject step_count, final SubLObject exhaustedP) {
        return list(new SubLObject[]{ $NEW_ROOT_START_INFERENCE_STEP_COUNT, start_inference_step_count, $NEW_ROOT_START_TIME, start_time, $NEW_ROOT_TIME_TO_FIRST_ANSWER, time_to_first_answer, $NEW_ROOT_STEPS_TO_FIRST_ANSWER, steps_to_first_answer, $NEW_ROOT_TIME_TO_LAST_ANSWER, time_to_last_answer, $NEW_ROOT_STEPS_TO_LAST_ANSWER, steps_to_last_answer, $NEW_ROOT_ANSWER_COUNT, answer_count, $NEW_ROOT_STEP_COUNT, step_count, $kw104$NEW_ROOT_EXHAUSTED_, exhaustedP });
    }
    ...
    public static SubLObject striping_tactician_do_one_step_int(final SubLObject strategy) {
        ...
        if (NIL != striping_tactician_should_reconsider_set_asidesP(strategy)) {
            ...
            if (NIL != inference_datastructures_strategy.strategy_should_propagate_answer_linkP(strategy)) {
                ...
                if ((NIL != $striping_tactician_one_stripe_modeP$.getDynamicValue(thread)) && (NIL != striping_tactician_has_some_removal_to_doP(strategy))) {
                    ...
                    if (NIL != subl_promotions.positive_integer_p(proofiness)) {
                        ...
                        if (NIL != striping_tactician_chooses_to_do_removalP(strategy)) {
                            thread.resetMultipleValues();
                            ...
                            if (NIL != striping_tactician_chooses_to_focus_on_a_new_rootP(strategy)) {
                                final SubLObject n_strategy = striping_tactician_new_root_substrategy(strategy);
                                ...
                                if (NIL == striping_tactician_problem_motivated_wrt_any_rP(strategy, inference_datastructures_strategy.strategy_root_problem(strategy))) {
                                    ...
                                    if (NIL != new_root_needs_removal_motivationP(new_root, strategy)) {
                                        re_addP = T;
                                        ...
                                        if ((NIL == striping_tactician_problem_motivated_wrt_tP(strategy, new_root)) && (NIL == inference_tactician.strategy_throws_away_all_transformationP(t_strategy))) {
                                            re_addP = T;
                                ...
                                if (NIL == inference_tactician.strategy_doneP(striping_tactician_transformation_substrategy(strategy))) {
                                    ...
                                    if (NIL == striping_tactician_doneP(strategy)) {
    ...
    public static SubLObject striping_tactician_possibly_activate_problem(final SubLObject strategy, final SubLObject problem) {
        if (NIL == inference_tactician.strategy_throws_away_all_transformationP(strategy)) {
            if (NIL != striping_tactician_problem_is_the_rest_of_an_early_removalP(strategy, problem)) {
                ...
                if (NIL != striping_tactician_problem_is_the_result_of_a_simplificationP(strategy, problem)) {
                    striping_tactician_possibly_make_new_root(strategy, problem);
                }
        ...
        for (basis_object = set_contents.do_set_contents_basis_object(set_contents_var), state = NIL, state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); NIL == set_contents.do_set_contents_doneP(basis_object, state); state = set_contents.do_set_contents_update_state(state)) {
            ...
            if ((NIL != set_contents.do_set_contents_element_validP(state, restriction_link)) && (NIL != inference_datastructures_problem_link.problem_link_has_typeP(restriction_link, $RESTRICTION))) {
                ...
                for (basis_object_$8 = set_contents.do_set_contents_basis_object(set_contents_var_$7), state_$9 = NIL, state_$9 = set_contents.do_set_contents_initial_state(basis_object_$8, set_contents_var_$7); NIL == set_contents.do_set_contents_doneP(basis_object_$8, state_$9); state_$9 = set_contents.do_set_contents_update_state(state_$9)) {
                    ...
                    if (((((NIL != set_contents.do_set_contents_element_validP(state_$9, join_ordered_link)) && (NIL != inference_datastructures_problem_link.problem_link_has_typeP(join_ordered_link, $JOIN_ORDERED))) && (NIL != inference_worker_join_ordered.join_ordered_link_restricted_non_focal_linkP(join_ordered_link, restriction_link))) && non_focal_problem.eql(inference_worker_join_ordered.join_ordered_link_non_focal_problem(join_ordered_link))) && (NIL != striping_tactician_chooses_to_propagate_new_root_motivation_to_restricted_non_focal_problemP(strategy, problem, join_ordered_link))) {
                        return T;
                    }
                }
            }
    ...
    public static SubLObject striping_tactician_early_removal_linkP(final SubLObject strategy, final SubLObject link) {
        ...
        while (NIL != cdolist_list_var) {
            if ((((((NIL != inference_worker_join_ordered.join_ordered_link_p(link)) && (NIL != inference_datastructures_problem_link.problem_link_openP(link))) && (NIL != balancing_tactician.substrategy_connected_conjunction_link_motivatedP(r_strategy, link))) && (NIL != striping_tactician_problem_motivated_wrt_nP(strategy, inference_datastructures_problem_link.problem_link_supported_problem(link)))) && ($COMPLETE == inference_worker.problem_generalized_removal_completeness(inference_worker_join_ordered.join_ordered_tactic_lookahead_problem(inference_worker_join_ordered.join_ordered_link_tactic(link)), r_strategy))) && (NIL != inference_tactician.join_ordered_link_early_removal_cheapP(link, strategy))) {
                return T;
            }
            cdolist_list_var = cdolist_list_var.rest();
            r_strategy = cdolist_list_var.first();
    ...
    public static SubLObject striping_tactician_problem_is_the_result_of_a_simplificationP(final SubLObject strategy, final SubLObject problem) {
        if (NIL != inference_worker_restriction.problem_is_a_simplificationP(problem)) {
            ...
            for (basis_object = set_contents.do_set_contents_basis_object(set_contents_var), state = NIL, state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); NIL == set_contents.do_set_contents_doneP(basis_object, state); state = set_contents.do_set_contents_update_state(state)) {
                ...
                if (((NIL != set_contents.do_set_contents_element_validP(state, simplification_link)) && (NIL != inference_datastructures_problem_link.problem_link_has_typeP(simplification_link, $SIMPLIFICATION))) && (NIL != striping_tactician_problem_motivated_wrt_nP(strategy, inference_datastructures_problem_link.problem_link_supported_problem(simplification_link)))) {
                    return T;
                }
            }
        }
            ...
            for (basis_object = set_contents.do_set_contents_basis_object(set_contents_var), state = NIL, state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); NIL == set_contents.do_set_contents_doneP(basis_object, state); state = set_contents.do_set_contents_update_state(state)) {
                ...
                if (((NIL != set_contents.do_set_contents_element_validP(state, link)) && (NIL != inference_datastructures_problem_link.problem_link_has_typeP(link, $JOIN_ORDERED))) && (NIL != striping_tactician_early_removal_linkP(strategy, link))) {
                    ...
                    for (basis_object_$11 = set_contents.do_set_contents_basis_object(set_contents_var_$10), state_$12 = NIL, state_$12 = set_contents.do_set_contents_initial_state(basis_object_$11, set_contents_var_$10); NIL == set_contents.do_set_contents_doneP(basis_object_$11, state_$12); state_$12 = set_contents.do_set_contents_update_state(state_$12)) {
                        ...
                        if (((NIL != set_contents.do_set_contents_element_validP(state_$12, restriction_link)) && (NIL != inference_datastructures_problem_link.problem_link_has_typeP(restriction_link, $RESTRICTION))) && (NIL != inference_worker_join_ordered.non_focal_restriction_link_with_corresponding_focal_proofP(restriction_link, link_var))) {
        ...
        if ((NIL == $striping_tactician_self_looping_rule_fix_enabledP$.getDynamicValue(thread)) || (NIL == assertion_utilities.self_expanding_ruleP(inference_worker_transformation.transformation_link_rule_assertion(t_link)))) {
            ...
            for (basis_object = set_contents.do_set_contents_basis_object(set_contents_var), state = NIL, state = set_contents.do_set_contents_initial_state(basis_object, set_contents_var); NIL == set_contents.do_set_contents_doneP(basis_object, state); state = set_contents.do_set_contents_update_state(state)) {
                ...
                if ((NIL != set_contents.do_set_contents_element_validP(state, jo_link_var)) && (NIL != inference_datastructures_problem_link.problem_link_has_typeP(jo_link_var, $JOIN_ORDERED))) {
                    ...
                    for (basis_object_$15 = set_contents.do_set_contents_basis_object(set_contents_var_$14), state_$16 = NIL, state_$16 = set_contents.do_set_contents_initial_state(basis_object_$15, set_contents_var_$14); NIL == set_contents.do_set_contents_doneP(basis_object_$15, state_$16); state_$16 = set_contents.do_set_contents_update_state(state_$16)) {
                        rt_link = set_contents.do_set_contents_next(basis_object_$15, state_$16);
                        if ((((NIL != set_contents.do_set_contents_element_validP(state_$16, rt_link)) && (NIL != inference_datastructures_problem_link.problem_link_has_typeP(rt_link, $RESIDUAL_TRANSFORMATION))) && (NIL != inference_worker_residual_transformation.residual_transformation_link_motivated_by_join_ordered_linkP(rt_link, jo_link_var_$13))) && (NIL != inference_worker_residual_transformation.residual_transformation_link_motivated_by_transformation_linkP(rt_link, t_link))) {
    ...
    public static SubLObject declare_striping_tactician_file() {
        declareFunction(me, "striping_tactician_data_print_function_trampoline", "STRIPING-TACTICIAN-DATA-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "striping_tactician_data_p", "STRIPING-TACTICIAN-DATA-P", 1, 0, false);
        new striping_tactician.$striping_tactician_data_p$UnaryFunction();
        declareFunction(me, "str_tac_data_new_root_substrategy", "STR-TAC-DATA-NEW-ROOT-SUBSTRATEGY", 1, 0, false);
        declareFunction(me, "str_tac_data_transformation_substrategy", "STR-TAC-DATA-TRANSFORMATION-SUBSTRATEGY", 1, 0, false);
        declareFunction(me, "str_tac_data_removal_substrategies", "STR-TAC-DATA-REMOVAL-SUBSTRATEGIES", 1, 0, false);
        declareFunction(me, "str_tac_data_new_root_r_map", "STR-TAC-DATA-NEW-ROOT-R-MAP", 1, 0, false);
        declareFunction(me, "str_tac_data_new_root_proofiness_map", "STR-TAC-DATA-NEW-ROOT-PROOFINESS-MAP", 1, 0, false);
        declareFunction(me, "str_tac_data_new_root_delay_map", "STR-TAC-DATA-NEW-ROOT-DELAY-MAP", 1, 0, false);
        declareFunction(me, "str_tac_data_new_root_metrics_map", "STR-TAC-DATA-NEW-ROOT-METRICS-MAP", 1, 0, false);
        declareFunction(me, "_csetf_str_tac_data_new_root_substrategy", "_CSETF-STR-TAC-DATA-NEW-ROOT-SUBSTRATEGY", 2, 0, false);
        declareFunction(me, "_csetf_str_tac_data_transformation_substrategy", "_CSETF-STR-TAC-DATA-TRANSFORMATION-SUBSTRATEGY", 2, 0, false);
        declareFunction(me, "_csetf_str_tac_data_removal_substrategies", "_CSETF-STR-TAC-DATA-REMOVAL-SUBSTRATEGIES", 2, 0, false);
        declareFunction(me, "_csetf_str_tac_data_new_root_r_map", "_CSETF-STR-TAC-DATA-NEW-ROOT-R-MAP", 2, 0, false);
        declareFunction(me, "_csetf_str_tac_data_new_root_proofiness_map", "_CSETF-STR-TAC-DATA-NEW-ROOT-PROOFINESS-MAP", 2, 0, false);
        declareFunction(me, "_csetf_str_tac_data_new_root_delay_map", "_CSETF-STR-TAC-DATA-NEW-ROOT-DELAY-MAP", 2, 0, false);
        declareFunction(me, "_csetf_str_tac_data_new_root_metrics_map", "_CSETF-STR-TAC-DATA-NEW-ROOT-METRICS-MAP", 2, 0, false);
        declareFunction(me, "make_striping_tactician_data", "MAKE-STRIPING-TACTICIAN-DATA", 0, 1, false);
        declareFunction(me, "visit_defstruct_striping_tactician_data", "VISIT-DEFSTRUCT-STRIPING-TACTICIAN-DATA", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_striping_tactician_data_method", "VISIT-DEFSTRUCT-OBJECT-STRIPING-TACTICIAN-DATA-METHOD", 2, 0, false);
        declareFunction(me, "striping_tactician_p", "STRIPING-TACTICIAN-P", 1, 0, false);
        declareMacro(me, "do_striping_tactician_substrategies", "DO-STRIPING-TACTICIAN-SUBSTRATEGIES");
        declareMacro(me, "do_striping_tactician_spineful_substrategies", "DO-STRIPING-TACTICIAN-SPINEFUL-SUBSTRATEGIES");
        declareMacro(me, "do_striping_tactician_removal_substrategies", "DO-STRIPING-TACTICIAN-REMOVAL-SUBSTRATEGIES");
        declareMacro(me, "do_striping_tactician_active_removal_substrategies", "DO-STRIPING-TACTICIAN-ACTIVE-REMOVAL-SUBSTRATEGIES");
        declareMacro(me, "do_striping_tactician_inactive_removal_substrategies", "DO-STRIPING-TACTICIAN-INACTIVE-REMOVAL-SUBSTRATEGIES");
        declareFunction(me, "new_striping_tactician_data", "NEW-STRIPING-TACTICIAN-DATA", 2, 0, false);
        declareFunction(me, "striping_tactician_initialize", "STRIPING-TACTICIAN-INITIALIZE", 1, 0, false);
        declareFunction(me, "new_striping_tactician_data_from_inference", "NEW-STRIPING-TACTICIAN-DATA-FROM-INFERENCE", 1, 0, false);
        declareFunction(me, "striping_tactician_new_root_substrategy", "STRIPING-TACTICIAN-NEW-ROOT-SUBSTRATEGY", 1, 0, false);
        declareFunction(me, "striping_tactician_transformation_substrategy", "STRIPING-TACTICIAN-TRANSFORMATION-SUBSTRATEGY", 1, 0, false);
        declareFunction(me, "striping_tactician_removal_substrategies", "STRIPING-TACTICIAN-REMOVAL-SUBSTRATEGIES", 1, 0, false);
        declareFunction(me, "striping_tactician_new_root_r_map", "STRIPING-TACTICIAN-NEW-ROOT-R-MAP", 1, 0, false);
        declareFunction(me, "striping_tactician_new_root_proofiness_map", "STRIPING-TACTICIAN-NEW-ROOT-PROOFINESS-MAP", 1, 0, false);
        declareFunction(me, "striping_tactician_new_root_delay_map", "STRIPING-TACTICIAN-NEW-ROOT-DELAY-MAP", 1, 0, false);
        declareFunction(me, "striping_tactician_new_root_metrics_map", "STRIPING-TACTICIAN-NEW-ROOT-METRICS-MAP", 1, 0, false);
        declareFunction(me, "striping_tactician_new_removal_substrategy", "STRIPING-TACTICIAN-NEW-REMOVAL-SUBSTRATEGY", 2, 0, false);
        declareFunction(me, "striping_tactician_new_throwaway_removal_substrategy", "STRIPING-TACTICIAN-NEW-THROWAWAY-REMOVAL-SUBSTRATEGY", 1, 0, false);
        declareFunction(me, "set_striping_tactician_new_root_metrics", "SET-STRIPING-TACTICIAN-NEW-ROOT-METRICS", 3, 0, false);
        declareFunction(me, "set_new_root_proofiness", "SET-NEW-ROOT-PROOFINESS", 2, 0, false);
        declareFunction(me, "decrement_new_root_proofiness", "DECREMENT-NEW-ROOT-PROOFINESS", 1, 0, false);
        declareFunction(me, "set_new_root_delay", "SET-NEW-ROOT-DELAY", 2, 0, false);
        declareFunction(me, "decrement_new_root_delay", "DECREMENT-NEW-ROOT-DELAY", 2, 0, false);
        declareFunction(me, "striping_tactician_all_substrategies", "STRIPING-TACTICIAN-ALL-SUBSTRATEGIES", 1, 0, false);
        declareFunction(me, "striping_tactician_removal_substrategy_count", "STRIPING-TACTICIAN-REMOVAL-SUBSTRATEGY-COUNT", 1, 0, false);
        declareFunction(me, "striping_tactician_problem_motivated_wrt_nP", "STRIPING-TACTICIAN-PROBLEM-MOTIVATED-WRT-N?", 2, 0, false);
        declareFunction(me, "striping_tactician_problem_motivated_wrt_any_rP", "STRIPING-TACTICIAN-PROBLEM-MOTIVATED-WRT-ANY-R?", 2, 0, false);
        declareFunction(me, "striping_tactician_problem_motivated_wrt_tP", "STRIPING-TACTICIAN-PROBLEM-MOTIVATED-WRT-T?", 2, 0, false);
        declareFunction(me, "striping_tactician_link_head_motivated_wrt_any_rP", "STRIPING-TACTICIAN-LINK-HEAD-MOTIVATED-WRT-ANY-R?", 2, 0, false);
        declareFunction(me, "striping_tactician_substrategy_p", "STRIPING-TACTICIAN-SUBSTRATEGY-P", 1, 0, false);
        declareFunction(me, "striping_tactician_proper_substrategy_p", "STRIPING-TACTICIAN-PROPER-SUBSTRATEGY-P", 1, 0, false);
        declareFunction(me, "striping_tactician_spineless_substrategy_p", "STRIPING-TACTICIAN-SPINELESS-SUBSTRATEGY-P", 1, 0, false);
        declareFunction(me, "striping_tactician_new_root_removal_strategy", "STRIPING-TACTICIAN-NEW-ROOT-REMOVAL-STRATEGY", 2, 0, false);
        declareFunction(me, "striping_tactician_removal_strategy_new_root", "STRIPING-TACTICIAN-REMOVAL-STRATEGY-NEW-ROOT", 2, 0, false);
        declareFunction(me, "new_root_proofiness", "NEW-ROOT-PROOFINESS", 1, 0, false);
        declareFunction(me, "new_root_delay", "NEW-ROOT-DELAY", 1, 0, false);
        declareFunction(me, "new_root_metrics", "NEW-ROOT-METRICS", 1, 0, false);
        declareFunction(me, "new_root_metrics_print_function_trampoline", "NEW-ROOT-METRICS-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "new_root_metrics_p", "NEW-ROOT-METRICS-P", 1, 0, false);
        new striping_tactician.$new_root_metrics_p$UnaryFunction();
        declareFunction(me, "nr_metrics_start_inference_step_count", "NR-METRICS-START-INFERENCE-STEP-COUNT", 1, 0, false);
        declareFunction(me, "nr_metrics_index", "NR-METRICS-INDEX", 1, 0, false);
        declareFunction(me, "nr_metrics_start_time", "NR-METRICS-START-TIME", 1, 0, false);
        declareFunction(me, "nr_metrics_time_to_first_answer", "NR-METRICS-TIME-TO-FIRST-ANSWER", 1, 0, false);
        declareFunction(me, "nr_metrics_steps_to_first_answer", "NR-METRICS-STEPS-TO-FIRST-ANSWER", 1, 0, false);
        declareFunction(me, "nr_metrics_time_to_last_answer", "NR-METRICS-TIME-TO-LAST-ANSWER", 1, 0, false);
        declareFunction(me, "nr_metrics_steps_to_last_answer", "NR-METRICS-STEPS-TO-LAST-ANSWER", 1, 0, false);
        declareFunction(me, "nr_metrics_answer_count", "NR-METRICS-ANSWER-COUNT", 1, 0, false);
        declareFunction(me, "_csetf_nr_metrics_start_inference_step_count", "_CSETF-NR-METRICS-START-INFERENCE-STEP-COUNT", 2, 0, false);
        declareFunction(me, "_csetf_nr_metrics_index", "_CSETF-NR-METRICS-INDEX", 2, 0, false);
        declareFunction(me, "_csetf_nr_metrics_start_time", "_CSETF-NR-METRICS-START-TIME", 2, 0, false);
        declareFunction(me, "_csetf_nr_metrics_time_to_first_answer", "_CSETF-NR-METRICS-TIME-TO-FIRST-ANSWER", 2, 0, false);
        declareFunction(me, "_csetf_nr_metrics_steps_to_first_answer", "_CSETF-NR-METRICS-STEPS-TO-FIRST-ANSWER", 2, 0, false);
        declareFunction(me, "_csetf_nr_metrics_time_to_last_answer", "_CSETF-NR-METRICS-TIME-TO-LAST-ANSWER", 2, 0, false);
        declareFunction(me, "_csetf_nr_metrics_steps_to_last_answer", "_CSETF-NR-METRICS-STEPS-TO-LAST-ANSWER", 2, 0, false);
        declareFunction(me, "_csetf_nr_metrics_answer_count", "_CSETF-NR-METRICS-ANSWER-COUNT", 2, 0, false);
        declareFunction(me, "make_new_root_metrics", "MAKE-NEW-ROOT-METRICS", 0, 1, false);
        declareFunction(me, "visit_defstruct_new_root_metrics", "VISIT-DEFSTRUCT-NEW-ROOT-METRICS", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_new_root_metrics_method", "VISIT-DEFSTRUCT-OBJECT-NEW-ROOT-METRICS-METHOD", 2, 0, false);
        declareFunction(me, "striping_tactician_initialize_new_root_metrics_from_inference", "STRIPING-TACTICIAN-INITIALIZE-NEW-ROOT-METRICS-FROM-INFERENCE", 3, 0, false);
        declareFunction(me, "new_root_start_inference_step_count", "NEW-ROOT-START-INFERENCE-STEP-COUNT", 1, 0, false);
        declareFunction(me, "new_root_index", "NEW-ROOT-INDEX", 1, 0, false);
        declareFunction(me, "new_root_start_time", "NEW-ROOT-START-TIME", 1, 0, false);
        declareFunction(me, "new_root_time_to_first_answer", "NEW-ROOT-TIME-TO-FIRST-ANSWER", 1, 0, false);
        declareFunction(me, "new_root_steps_to_first_answer", "NEW-ROOT-STEPS-TO-FIRST-ANSWER", 1, 0, false);
        declareFunction(me, "new_root_time_to_last_answer", "NEW-ROOT-TIME-TO-LAST-ANSWER", 1, 0, false);
        declareFunction(me, "new_root_steps_to_last_answer", "NEW-ROOT-STEPS-TO-LAST-ANSWER", 1, 0, false);
        declareFunction(me, "new_root_answer_count", "NEW-ROOT-ANSWER-COUNT", 1, 0, false);
        declareFunction(me, "set_new_root_time_to_first_answer", "SET-NEW-ROOT-TIME-TO-FIRST-ANSWER", 2, 0, false);
        declareFunction(me, "set_new_root_steps_to_first_answer", "SET-NEW-ROOT-STEPS-TO-FIRST-ANSWER", 2, 0, false);
        declareFunction(me, "set_new_root_time_to_last_answer", "SET-NEW-ROOT-TIME-TO-LAST-ANSWER", 2, 0, false);
        declareFunction(me, "set_new_root_steps_to_last_answer", "SET-NEW-ROOT-STEPS-TO-LAST-ANSWER", 2, 0, false);
        declareFunction(me, "set_new_root_answer_count", "SET-NEW-ROOT-ANSWER-COUNT", 2, 0, false);
        declareFunction(me, "new_root_metrics_plist", "NEW-ROOT-METRICS-PLIST", 1, 0, false);
        declareFunction(me, "construct_new_root_metrics_plist", "CONSTRUCT-NEW-ROOT-METRICS-PLIST", 9, 0, false);
        declareFunction(me, "striping_tactician_new_root_metrics", "STRIPING-TACTICIAN-NEW-ROOT-METRICS", 1, 0, false);
        declareFunction(me, "striping_tactician_remember_new_root_metrics", "STRIPING-TACTICIAN-REMEMBER-NEW-ROOT-METRICS", 1, 0, false);
        declareFunction(me, "new_root_answerableP", "NEW-ROOT-ANSWERABLE?", 1, 0, false);
        declareFunction(me, "new_root_unanswerableP", "NEW-ROOT-UNANSWERABLE?", 1, 0, false);
        declareFunction(me, "increment_new_root_answer_count", "INCREMENT-NEW-ROOT-ANSWER-COUNT", 2, 0, false);
        declareFunction(me, "striping_tactician_update_new_root_metrics", "STRIPING-TACTICIAN-UPDATE-NEW-ROOT-METRICS", 2, 0, false);
        declareFunction(me, "striping_tactician_doneP", "STRIPING-TACTICIAN-DONE?", 1, 0, false);
        declareFunction(me, "striping_tactician_do_one_step", "STRIPING-TACTICIAN-DO-ONE-STEP", 1, 0, false);
        declareFunction(me, "striping_tactician_do_one_step_int", "STRIPING-TACTICIAN-DO-ONE-STEP-INT", 1, 0, false);
        declareFunction(me, "new_root_needs_removal_motivationP", "NEW-ROOT-NEEDS-REMOVAL-MOTIVATION?", 2, 0, false);
        declareFunction(me, "striping_tactician_should_reconsider_set_asidesP", "STRIPING-TACTICIAN-SHOULD-RECONSIDER-SET-ASIDES?", 1, 0, false);
        declareFunction(me, "striping_tactician_reconsider_set_asides", "STRIPING-TACTICIAN-RECONSIDER-SET-ASIDES", 1, 0, false);
        declareFunction(me, "striping_tactician_new_root_with_highest_proofiness", "STRIPING-TACTICIAN-NEW-ROOT-WITH-HIGHEST-PROOFINESS", 1, 0, false);
        declareFunction(me, "striping_tactician_chooses_to_do_removalP", "STRIPING-TACTICIAN-CHOOSES-TO-DO-REMOVAL?", 1, 0, false);
        declareFunction(me, "striping_tactician_chooses_to_focus_on_a_new_rootP", "STRIPING-TACTICIAN-CHOOSES-TO-FOCUS-ON-A-NEW-ROOT?", 1, 0, false);
        declareFunction(me, "new_root_freshP", "NEW-ROOT-FRESH?", 1, 0, false);
        declareFunction(me, "striping_tactician_unanswerable_new_root_with_lowest_delay", "STRIPING-TACTICIAN-UNANSWERABLE-NEW-ROOT-WITH-LOWEST-DELAY", 1, 0, false);
        declareFunction(me, "striping_tactician_favor_answerable_new_roots", "STRIPING-TACTICIAN-FAVOR-ANSWERABLE-NEW-ROOTS", 1, 0, false);
        declareFunction(me, "striping_tactician_reset_delay", "STRIPING-TACTICIAN-RESET-DELAY", 1, 0, false);
        declareFunction(me, "striping_tactician_compute_new_root_delay", "STRIPING-TACTICIAN-COMPUTE-NEW-ROOT-DELAY", 1, 0, false);
        declareFunction(me, "striping_tactician_compute_new_root_delay_based_on_step_count", "STRIPING-TACTICIAN-COMPUTE-NEW-ROOT-DELAY-BASED-ON-STEP-COUNT", 1, 0, false);
        declareFunction(me, "striping_tactician_compute_new_root_delay_based_on_index", "STRIPING-TACTICIAN-COMPUTE-NEW-ROOT-DELAY-BASED-ON-INDEX", 1, 0, false);
        declareFunction(me, "striping_tactician_decrement_all_unanswerable_new_root_delays_except", "STRIPING-TACTICIAN-DECREMENT-ALL-UNANSWERABLE-NEW-ROOT-DELAYS-EXCEPT", 3, 0, false);
        declareFunction(me, "striping_tactician_new_root_do_one_step", "STRIPING-TACTICIAN-NEW-ROOT-DO-ONE-STEP", 1, 0, false);
        declareFunction(me, "striping_tactician_active_removal_strategies", "STRIPING-TACTICIAN-ACTIVE-REMOVAL-STRATEGIES", 1, 0, false);
        declareFunction(me, "striping_tactician_has_some_removal_to_doP", "STRIPING-TACTICIAN-HAS-SOME-REMOVAL-TO-DO?", 1, 0, false);
        declareFunction(me, "striping_tactician_first_active_removal_substrategy", "STRIPING-TACTICIAN-FIRST-ACTIVE-REMOVAL-SUBSTRATEGY", 1, 0, false);
        declareFunction(me, "striping_tactician_continuation_possibleP", "STRIPING-TACTICIAN-CONTINUATION-POSSIBLE?", 1, 0, false);
        declareFunction(me, "striping_tactician_chooses_to_throw_away_problemP", "STRIPING-TACTICIAN-CHOOSES-TO-THROW-AWAY-PROBLEM?", 2, 0, false);
        declareFunction(me, "striping_tactician_chooses_to_set_aside_problemP", "STRIPING-TACTICIAN-CHOOSES-TO-SET-ASIDE-PROBLEM?", 2, 0, false);
        declareFunction(me, "striping_tactician_chooses_to_throw_away_tacticP", "STRIPING-TACTICIAN-CHOOSES-TO-THROW-AWAY-TACTIC?", 4, 0, false);
        declareFunction(me, "striping_tactician_chooses_to_set_aside_tacticP", "STRIPING-TACTICIAN-CHOOSES-TO-SET-ASIDE-TACTIC?", 4, 0, false);
        declareFunction(me, "striping_tactician_throw_away_uninteresting_set_asides", "STRIPING-TACTICIAN-THROW-AWAY-UNINTERESTING-SET-ASIDES", 1, 0, false);
        declareFunction(me, "striping_tactician_note_inference_dynamic_properties_updated", "STRIPING-TACTICIAN-NOTE-INFERENCE-DYNAMIC-PROPERTIES-UPDATED", 1, 0, false);
        declareFunction(me, "striping_tactician_initialize_properties", "STRIPING-TACTICIAN-INITIALIZE-PROPERTIES", 2, 0, false);
        declareFunction(me, "striping_tactician_update_properties", "STRIPING-TACTICIAN-UPDATE-PROPERTIES", 2, 0, false);
        declareFunction(me, "striping_tactician_initial_relevant_strategies", "STRIPING-TACTICIAN-INITIAL-RELEVANT-STRATEGIES", 1, 0, false);
        declareFunction(me, "striping_tactician_possibly_activate_problem", "STRIPING-TACTICIAN-POSSIBLY-ACTIVATE-PROBLEM", 2, 0, false);
        declareFunction(me, "striping_tactician_problem_is_the_rest_of_an_early_removalP", "STRIPING-TACTICIAN-PROBLEM-IS-THE-REST-OF-AN-EARLY-REMOVAL?", 2, 0, false);
        declareFunction(me, "striping_tactician_chooses_to_propagate_new_root_motivation_to_restricted_non_focal_problemP", "STRIPING-TACTICIAN-CHOOSES-TO-PROPAGATE-NEW-ROOT-MOTIVATION-TO-RESTRICTED-NON-FOCAL-PROBLEM?", 3, 0, false);
        declareFunction(me, "striping_tactician_treats_restricted_non_focal_as_new_rootP", "STRIPING-TACTICIAN-TREATS-RESTRICTED-NON-FOCAL-AS-NEW-ROOT?", 2, 0, false);
        declareFunction(me, "striping_tactician_early_removal_linkP", "STRIPING-TACTICIAN-EARLY-REMOVAL-LINK?", 2, 0, false);
        declareFunction(me, "striping_tactician_problem_is_the_result_of_a_simplificationP", "STRIPING-TACTICIAN-PROBLEM-IS-THE-RESULT-OF-A-SIMPLIFICATION?", 2, 0, false);
        declareFunction(me, "striping_tactician_note_argument_link", "STRIPING-TACTICIAN-NOTE-ARGUMENT-LINK", 2, 0, false);
        declareFunction(me, "striping_tactician_early_removal_productivity_limit", "STRIPING-TACTICIAN-EARLY-REMOVAL-PRODUCTIVITY-LIMIT", 1, 0, false);
        declareFunction(me, "striping_tactician_substrategy_strategem_motivated", "STRIPING-TACTICIAN-SUBSTRATEGY-STRATEGEM-MOTIVATED", 3, 0, false);
        declareFunction(me, "striping_tactician_substrategy_problem_motivated", "STRIPING-TACTICIAN-SUBSTRATEGY-PROBLEM-MOTIVATED", 3, 0, false);
        declareFunction(me, "striping_tactician_substrategy_link_motivated", "STRIPING-TACTICIAN-SUBSTRATEGY-LINK-MOTIVATED", 3, 0, false);
        declareFunction(me, "striping_tactician_chooses_to_make_d_a_new_rootP", "STRIPING-TACTICIAN-CHOOSES-TO-MAKE-D-A-NEW-ROOT?", 2, 0, false);
        declareFunction(me, "striping_tactician_residual_conjunction_new_root_candidates", "STRIPING-TACTICIAN-RESIDUAL-CONJUNCTION-NEW-ROOT-CANDIDATES", 2, 0, false);
        declareFunction(me, "striping_tactician_transformation_new_root_candidates", "STRIPING-TACTICIAN-TRANSFORMATION-NEW-ROOT-CANDIDATES", 2, 0, false);
        declareFunction(me, "striping_tactician_possibly_make_new_root", "STRIPING-TACTICIAN-POSSIBLY-MAKE-NEW-ROOT", 2, 0, false);
        declareFunction(me, "striping_tactician_substrategy_tactic_motivated", "STRIPING-TACTICIAN-SUBSTRATEGY-TACTIC-MOTIVATED", 3, 0, false);
        declareFunction(me, "striping_tactician_substrategy_connected_conjunction_tactic_motivated", "STRIPING-TACTICIAN-SUBSTRATEGY-CONNECTED-CONJUNCTION-TACTIC-MOTIVATED", 3, 0, false);
        declareFunction(me, "striping_tactician_possibly_motivate_new_root_via_residual_transformation_link", "STRIPING-TACTICIAN-POSSIBLY-MOTIVATE-NEW-ROOT-VIA-RESIDUAL-TRANSFORMATION-LINK", 2, 0, false);
        declareFunction(me, "striping_tactician_substrategy_split_tactic_motivated", "STRIPING-TACTICIAN-SUBSTRATEGY-SPLIT-TACTIC-MOTIVATED", 3, 0, false);
        declareFunction(me, "striping_tactician_possibly_propagate_new_root_motivation_down_split_link", "STRIPING-TACTICIAN-POSSIBLY-PROPAGATE-NEW-ROOT-MOTIVATION-DOWN-SPLIT-LINK", 2, 0, false);
        declareFunction(me, "striping_tactician_substrategy_union_tactic_motivated", "STRIPING-TACTICIAN-SUBSTRATEGY-UNION-TACTIC-MOTIVATED", 3, 0, false);
        declareFunction(me, "striping_tactician_possibly_propagate_new_root_motivation_down_union_link", "STRIPING-TACTICIAN-POSSIBLY-PROPAGATE-NEW-ROOT-MOTIVATION-DOWN-UNION-LINK", 2, 0, false);
        declareFunction(me, "striping_tactician_allows_split_tactic_to_be_set_aside_wrt_removalP", "STRIPING-TACTICIAN-ALLOWS-SPLIT-TACTIC-TO-BE-SET-ASIDE-WRT-REMOVAL?", 3, 0, false);
        declareFunction(me, "striping_tactician_chooses_to_totally_throw_away_tacticP", "STRIPING-TACTICIAN-CHOOSES-TO-TOTALLY-THROW-AWAY-TACTIC?", 5, 0, false);
        declareFunction(me, "striping_tactician_substrategy_problem_status_change", "STRIPING-TACTICIAN-SUBSTRATEGY-PROBLEM-STATUS-CHANGE", 5, 0, false);
        declareFunction(me, "striping_tactician_recompute_problem_status", "STRIPING-TACTICIAN-RECOMPUTE-PROBLEM-STATUS", 2, 0, false);
        declareFunction(me, "striping_tactician_recompute_uninterestingness_for_sibling_split_tactics", "STRIPING-TACTICIAN-RECOMPUTE-UNINTERESTINGNESS-FOR-SIBLING-SPLIT-TACTICS", 2, 0, false);
        declareFunction(me, "striping_tactician_possibly_propagate_strategic_status_to_tactical_status", "STRIPING-TACTICIAN-POSSIBLY-PROPAGATE-STRATEGIC-STATUS-TO-TACTICAL-STATUS", 3, 0, false);
        declareFunction(me, "striping_tactician_make_problem_no_good", "STRIPING-TACTICIAN-MAKE-PROBLEM-NO-GOOD", 2, 0, false);
        declareFunction(me, "striping_tactician_make_problem_pending", "STRIPING-TACTICIAN-MAKE-PROBLEM-PENDING", 2, 0, false);
        declareFunction(me, "striping_tactician_arbitrary_relevant_removal_substrategy", "STRIPING-TACTICIAN-ARBITRARY-RELEVANT-REMOVAL-SUBSTRATEGY", 2, 0, false);
        declareFunction(me, "sibling_removal_strategy", "SIBLING-REMOVAL-STRATEGY", 2, 0, false);
        declareFunction(me, "sibling_transformation_strategy", "SIBLING-TRANSFORMATION-STRATEGY", 1, 0, false);
        declareFunction(me, "cb_show_striping_tactician_stripes", "CB-SHOW-STRIPING-TACTICIAN-STRIPES", 1, 0, false);
        declareFunction(me, "cb_show_striping_tactician_one_stripe", "CB-SHOW-STRIPING-TACTICIAN-ONE-STRIPE", 2, 0, false);
        declareFunction(me, "all_new_root_metrics_from_kbq_experiment", "ALL-NEW-ROOT-METRICS-FROM-KBQ-EXPERIMENT", 1, 0, false);
        declareFunction(me, "answerable_new_root_metrics", "ANSWERABLE-NEW-ROOT-METRICS", 1, 0, false);
        declareFunction(me, "answerable_new_root_metrics_count", "ANSWERABLE-NEW-ROOT-METRICS-COUNT", 1, 0, false);
        declareFunction(me, "unanswerable_new_root_metrics", "UNANSWERABLE-NEW-ROOT-METRICS", 1, 0, false);
        declareFunction(me, "answerable_new_root_metricP", "ANSWERABLE-NEW-ROOT-METRIC?", 1, 0, false);
        declareFunction(me, "new_root_metric_step_count", "NEW-ROOT-METRIC-STEP-COUNT", 1, 0, false);
        declareFunction(me, "new_root_metric_exhaustedP", "NEW-ROOT-METRIC-EXHAUSTED?", 1, 0, false);
        declareFunction(me, "new_root_metric_start_inference_step_count", "NEW-ROOT-METRIC-START-INFERENCE-STEP-COUNT", 1, 0, false);
        declareFunction(me, "new_root_metric_steps_to_first_answer", "NEW-ROOT-METRIC-STEPS-TO-FIRST-ANSWER", 1, 0, false);
        declareFunction(me, "answerable_new_root_steps_to_first_answer", "ANSWERABLE-NEW-ROOT-STEPS-TO-FIRST-ANSWER", 1, 0, false);
        declareFunction(me, "unanswerable_new_root_step_counts", "UNANSWERABLE-NEW-ROOT-STEP-COUNTS", 1, 0, false);
        declareFunction(me, "compute_new_root_answerability_expectation", "COMPUTE-NEW-ROOT-ANSWERABILITY-EXPECTATION", 1, 0, false);
        declareFunction(me, "exhausted_new_root_answerability_probabilities_by_order", "EXHAUSTED-NEW-ROOT-ANSWERABILITY-PROBABILITIES-BY-ORDER", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $striping_tactician_data_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(striping_tactician.$striping_tactician_data_native.class, STRIPING_TACTICIAN_DATA, STRIPING_TACTICIAN_DATA_P, $list4, $list5, new String[]{ "$new_root_substrategy", "$transformation_substrategy", "$removal_substrategies", "$new_root_r_map", "$new_root_proofiness_map", "$new_root_delay_map", "$new_root_metrics_map" }, $list6, $list7, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $new_root_metrics_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(striping_tactician.$new_root_metrics_native.class, NEW_ROOT_METRICS, NEW_ROOT_METRICS_P, $list64, $list65, new String[]{ "$start_inference_step_count", "$index", "$start_time", "$time_to_first_answer", "$steps_to_first_answer", "$time_to_last_answer", "$steps_to_last_answer", "$answer_count" }, $list66, $list67, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
