...
public class removal_modules_lookup extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_lookup";
    ...
    public static SubLObject declare_removal_modules_lookup_file() {
        declareFunction(myName, "removal_lookup_pos_cost", "REMOVAL-LOOKUP-POS-COST", 1, 1, false);
        new $removal_lookup_pos_cost$UnaryFunction();
        new $removal_lookup_pos_cost$BinaryFunction();
        declareFunction(myName, "removal_completely_asserted_asentP", "REMOVAL-COMPLETELY-ASSERTED-ASENT?", 1, 0, false);
        new $removal_completely_asserted_asentP$UnaryFunction();
        declareFunction(myName, "removal_lookup_pos_iterator", "REMOVAL-LOOKUP-POS-ITERATOR", 1, 0, false);
        ...
        declareFunction(myName, "asent_has_indexed_term_arg_p", "ASENT-HAS-INDEXED-TERM-ARG-P", 1, 1, false);
