...
import static com.cyc.cycjava.cycl.inference.harness.inference_worker_join_ordered.*;
...
public final class inference_worker_join_ordered extends SubLTranslatedFile {
    ...
    public static SubLObject join_ordered_link_data_p(final SubLObject v_object) {
        return v_object.getClass() == inference_worker_join_ordered.$join_ordered_link_data_native.class ? T : NIL;
    }

    public static SubLObject jo_link_data_focal_proof_index(final SubLObject v_object) {
        assert NIL != join_ordered_link_data_p(v_object) : "inference_worker_join_ordered.join_ordered_link_data_p(v_object) " + "CommonSymbols.NIL != inference_worker_join_ordered.join_ordered_link_data_p(v_object) " + v_object;
    ...
    public static SubLObject make_join_ordered_link_data(SubLObject arglist) {
        ...
        final SubLObject v_new = new inference_worker_join_ordered.$join_ordered_link_data_native();
        SubLObject next;
    ...
    public static final class $join_ordered_link_data_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_worker_join_ordered.$join_ordered_link_data_native.class, JOIN_ORDERED_LINK_DATA, JOIN_ORDERED_LINK_DATA_P, $list2, $list3, new String[]{ "$focal_proof_index", "$non_focal_proof_index", "$restricted_non_focal_link_index" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
