...
import com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_mean_stdev;
...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_mean_stdev.*;
...
public final class removal_modules_mean_stdev extends SubLTranslatedFile {
    ...
    private static final SubLList $list3 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("averageOfListElementsWithStandardDeviation")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("averageOfListElementsWithStandardDeviation")), makeKeyword("FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), ONE_INTEGER, makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("averageOfListElementsWithStandardDeviation")), list(makeKeyword("BIND"), makeSymbol("INPUT-EL-LIST")), makeKeyword("ANYTHING"), makeKeyword("ANYTHING")), makeKeyword("SUCCESS")), makeKeyword("INPUT-ENCODE-PATTERN"), list(makeKeyword("TEMPLATE"), makeKeyword("ANYTHING"), list(makeKeyword("CALL"), makeSymbol("EL-LIST-ITEMS"), list(makeKeyword("VALUE"), makeSymbol("INPUT-EL-LIST")))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(list(makeKeyword("CALL"), makeSymbol("REMOVAL-STANDARD-DEVIATION-TUPLE"), makeKeyword("INPUT"))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(makeKeyword("TUPLE"), list(makeSymbol("STDEV"), makeSymbol("AVERAGE")), list(reader_make_constant_shell(makeString("averageOfListElementsWithStandardDeviation")), list(makeKeyword("VALUE"), makeSymbol("INPUT-EL-LIST")), list(makeKeyword("VALUE"), makeSymbol("AVERAGE")), list(makeKeyword("VALUE"), makeSymbol("STDEV")))), makeKeyword("SUPPORT-MODULE"), makeKeyword("OPAQUE"), makeKeyword("SUPPORT-STRENGTH"), makeKeyword("MONOTONIC"), makeKeyword("SUPPORT-MT"), reader_make_constant_shell(makeString("BaseKB")), makeKeyword("DOCUMENTATION"), makeString("(#$averageOfListElementsWithStandardDeviation :fully-bound :not-fully-bound :not-fully-bound)"), makeKeyword("EXAMPLE"), makeString("(#$averageOfListElementsWithStandardDeviation (#$TheList 1 2 3 4 5) ?MEAN ?STDEV)\nwill bind ?MEAN to 3, and ?STDEV to 1.4142135623730951.") });
    ...
    public static SubLObject declare_removal_modules_mean_stdev_file() {
        declareFunction(me, "removal_standard_deviation_tuple", "REMOVAL-STANDARD-DEVIATION-TUPLE", 1, 0, false);
        return NIL;
    }
