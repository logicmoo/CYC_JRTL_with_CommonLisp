...
public final class removal_modules_parse_trees
    extends
      SubLTranslatedFile
{
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $predicates_with_parse_tree_support_in_some_mt_caching_state$.getGlobalValue(), ConsesLow.list( EMPTY_SUBL_OBJECT_ARRAY ), UNPROVIDED,
        UNPROVIDED );
  }
  ...
  public static SubLObject predicates_with_parse_tree_support_in_some_mt_internal()
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$mt$.bind( $const3$InferencePSC, thread );
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        final SubLObject deck_type = $kw7$QUEUE;
          ...
          try
          {
            ...
            try
            {
              ...
              if( NIL != tv_var && NIL != sbhl_paranoia.sbhl_object_type_checking_p() && NIL == sbhl_search_vars.sbhl_true_tv_p( tv_var ) )
              {
                ...
                else if( pcase_var.eql( $kw14$WARN ) )
                {
              ...
              try
              {
                sbhl_search_vars.$sbhl_search_module$.bind( sbhl_module_vars.get_sbhl_module( $const16$genlPreds ), thread );
                sbhl_search_vars.$sbhl_search_module_type$.bind( sbhl_module_utilities.get_sbhl_module_type( sbhl_module_vars.get_sbhl_module( $const16$genlPreds ) ), thread );
                sbhl_search_vars.$sbhl_add_node_to_result_test$.bind( sbhl_module_utilities.get_sbhl_add_node_to_result_test( sbhl_module_vars.get_sbhl_module( $const16$genlPreds ) ), thread );
                sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                sbhl_module_vars.$sbhl_module$.bind( sbhl_module_vars.get_sbhl_module( $const16$genlPreds ), thread );
                  ...
                  try
                  {
                    ...
                    for( node_and_predicate_mode = ConsesLow.list( pred, sbhl_search_vars.genl_inverse_mode_p() ); NIL != node_and_predicate_mode; node_and_predicate_mode = deck.deck_pop( recur_deck ) )
                    {
                      ...
                      try
                      {
                        ...
                        final SubLObject accessible_modules = cdolist_list_var_$11 = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_vars.get_sbhl_module( $const16$genlPreds ) );
                        ...
                        while ( NIL != cdolist_list_var_$11)
                        {
                          ...
                          try
                          {
                            ...
                            else if( NIL != obsolete.cnat_p( node, UNPROVIDED ) )
                            {
                              ...
                              final SubLObject new_list = cdolist_list_var_$12 = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities
                ...
                {
                  sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str19$Node__a_does_not_pass_sbhl_type_t, pred, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED, UNPROVIDED,
                      UNPROVIDED );
                }
              }
              finally
  ...
  public static SubLObject predicates_with_parse_tree_support_in_some_mt()
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym1$PREDICATES_WITH_PARSE_TREE_SUPPORT_IN_SOME_MT, $sym20$_PREDICATES_WITH_PARSE_TREE_SUPPORT_IN_SOME_MT_CACHING_STATE_, NIL, EQL,
  ...
  {
    return removal_parse_tree_relation_int( asent, $kw22$NODES );
  }
  ...
  {
    return removal_parse_tree_relation_int( asent, $kw23$SUPPORTS );
  }
    ...
    if( NIL == current )
    {
      ...
      if( NIL != parsing_utilities.phrasal_nodeP( root_node ) )
      {
        ...
        try
        {
          ...
          try
          {
            final SubLObject tv_var = $const25$True_JustificationTruth;
              ...
              try
              {
                ...
                if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( original_pred, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                {
                  ...
                  try
                  {
                    ...
                    sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                    sbhl_marking_utilities.sbhl_mark_node_marked( node_var, UNPROVIDED );
                    for( node_and_predicate_mode = ConsesLow.list( original_pred, sbhl_search_vars.genl_inverse_mode_p() ); NIL != node_and_predicate_mode; node_and_predicate_mode = deck.deck_pop( recur_deck ) )
                    {
                      ...
                      try
                      {
                        ...
                        if( NIL == inverseP && NIL != predicate_with_parse_tree_direct_support_p( pred ) )
                        {
                          ...
                          final SubLObject method = conses_high.getf( plist, $kw26$METHOD, UNPROVIDED );
                          final SubLObject type_check = conses_high.getf( plist, $kw27$TYPE_CHECK, UNPROVIDED );
                          final SubLObject result = ( NIL != Functions.funcall( type_check, v_parse_tree ) ) ? apply_parse_tree_removal_method( v_parse_tree, method ) : NIL;
                          SubLObject cdolist_list_var;
                          final SubLObject results = cdolist_list_var = result.isList() ? result : ConsesLow.list( result );
                          ...
                          while ( NIL != cdolist_list_var)
                          {
                            ...
                            {
                              if( return_type.eql( $kw22$NODES ) )
                              {
                                ans = ConsesLow.cons( answer_node, ans );
                              }
                              else if( return_type.eql( $kw23$SUPPORTS ) )
                              {
                                if( !pred.eql( original_pred ) )
                                {
                                  ans = ConsesLow.cons( removal_module_utilities.make_genl_preds_support( pred, original_pred ), ans );
                                }
                                final SubLObject support_formula = el_utilities.make_binary_formula( pred, node, answer_node );
                                ans = ConsesLow.cons( arguments.make_hl_support( $kw28$PARSE_TREE, support_formula, UNPROVIDED, UNPROVIDED ), ans );
                              }
                            }
                            cdolist_list_var = cdolist_list_var.rest();
                            one_result = cdolist_list_var.first();
                        ...
                        final SubLObject accessible_modules = cdolist_list_var2 = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_vars.get_sbhl_module( $const16$genlPreds ) );
                        SubLObject module_var = NIL;
                        ...
                        while ( NIL != cdolist_list_var2)
                        {
                          ...
                          try
                          {
                            ...
                            else if( NIL != obsolete.cnat_p( node_$30, UNPROVIDED ) )
                            {
                              ...
                              final SubLObject new_list = cdolist_list_var_$34 = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities
                                  .get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module(
                                      UNPROVIDED ) ) )
                                  : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue( thread ), sbhl_module_vars
                                      .get_sbhl_module( UNPROVIDED ) ) );
                ...
                {
                  sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str19$Node__a_does_not_pass_sbhl_type_t, original_pred, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED,
  ...
  {
    SubLFiles.declareFunction( me, "clear_predicates_with_parse_tree_support_in_some_mt", "CLEAR-PREDICATES-WITH-PARSE-TREE-SUPPORT-IN-SOME-MT", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_predicates_with_parse_tree_support_in_some_mt", "REMOVE-PREDICATES-WITH-PARSE-TREE-SUPPORT-IN-SOME-MT", 0, 0, false );
    SubLFiles.declareFunction( me, "predicates_with_parse_tree_support_in_some_mt_internal", "PREDICATES-WITH-PARSE-TREE-SUPPORT-IN-SOME-MT-INTERNAL", 0, 0, false );
    SubLFiles.declareFunction( me, "predicates_with_parse_tree_support_in_some_mt", "PREDICATES-WITH-PARSE-TREE-SUPPORT-IN-SOME-MT", 0, 0, false );
    SubLFiles.declareFunction( me, "predicate_with_parse_tree_support_p", "PREDICATE-WITH-PARSE-TREE-SUPPORT-P", 1, 0, false );
    new $predicate_with_parse_tree_support_p$UnaryFunction();
    SubLFiles.declareFunction( me, "predicate_with_parse_tree_direct_support_p", "PREDICATE-WITH-PARSE-TREE-DIRECT-SUPPORT-P", 1, 0, false );
    SubLFiles.declareFunction( me, "removal_parse_tree_relation_answer_list", "REMOVAL-PARSE-TREE-RELATION-ANSWER-LIST", 1, 0, false );
    SubLFiles.declareFunction( me, "parse_tree_relation_supports", "PARSE-TREE-RELATION-SUPPORTS", 1, 0, false );
    SubLFiles.declareFunction( me, "removal_parse_tree_relation_int", "REMOVAL-PARSE-TREE-RELATION-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "apply_parse_tree_removal_method", "APPLY-PARSE-TREE-REMOVAL-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "syntactic_node_for_parse_tree", "SYNTACTIC-NODE-FOR-PARSE-TREE", 2, 0, false );
    SubLFiles.declareFunction( me, "parse_tree_for_syntactic_node", "PARSE-TREE-FOR-SYNTACTIC-NODE", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_removal_modules_parse_trees_file()
  {
    $predicates_to_parse_tree_methods$ = SubLFiles.deflexical( "*PREDICATES-TO-PARSE-TREE-METHODS*", $list0 );
  ...
  public static SubLObject setup_removal_modules_parse_trees_file()
  {
    ...
    inference_modules.inference_removal_module( $kw29$REMOVAL_PARSE_TREE_RELATION_POS, $list30 );
    preference_modules.inference_preference_module( $kw31$PARSE_TREE_REQUIRE_ARG1_FULLY_BOUND, $list32 );
    return NIL;
  }
  ...
  static
  {
    ...
    $list0 = ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "syntacticVerbalPhraseNodeSubjectNode" ) ), makeKeyword( "METHOD" ), makeSymbol( "GET-SUBJECT" ), makeKeyword(
        "TYPE-CHECK" ), makeSymbol( "VERBAL-PHRASE-TREE-P" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "syntacticVerbalPhraseNodeObjectNodes" ) ), makeKeyword( "METHOD" ), makeSymbol(
            "GET-OBJECTS" ), makeKeyword( "TYPE-CHECK" ), makeSymbol( "VERBAL-PHRASE-TREE-P" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "syntacticNodeSyntacticHead" ) ), makeKeyword(
                "METHOD" ), makeSymbol( "GET-HEAD" ), makeKeyword( "TYPE-CHECK" ), makeSymbol( "PHRASE-TREE-P" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString(
                    "syntacticVerbalPhraseNodeIndirectObjectNode" ) ), makeKeyword( "METHOD" ), makeSymbol( "GET-INDIRECT-OBJECT" ), makeKeyword( "TYPE-CHECK" ), makeSymbol( "VERBAL-PHRASE-TREE-P" ) ), ConsesLow.list(
                        constant_handles.reader_make_constant_shell( makeString( "syntacticVerbalPhraseNodeDirectObjectNode" ) ), makeKeyword( "METHOD" ), makeSymbol( "GET-DIRECT-OBJECT" ), makeKeyword( "TYPE-CHECK" ),
    ...
    $list4 = ConsesLow.cons( makeSymbol( "PRED" ), makeUninternedSymbol( "VALUE" ) );
    $kw5$DEPTH = makeKeyword( "DEPTH" );
    $kw6$STACK = makeKeyword( "STACK" );
    $kw7$QUEUE = makeKeyword( "QUEUE" );
    $sym8$RELEVANT_SBHL_TV_IS_GENERAL_TV = makeSymbol( "RELEVANT-SBHL-TV-IS-GENERAL-TV" );
    $kw9$ERROR = makeKeyword( "ERROR" );
    ...
    $kw22$NODES = makeKeyword( "NODES" );
    $kw23$SUPPORTS = makeKeyword( "SUPPORTS" );
    $list24 = ConsesLow.list( makeSymbol( "ORIGINAL-PRED" ), makeSymbol( "NODE" ), makeSymbol( "ARG2" ) );
    $const25$True_JustificationTruth = constant_handles.reader_make_constant_shell( makeString( "True-JustificationTruth" ) );
    $kw26$METHOD = makeKeyword( "METHOD" );
    $kw27$TYPE_CHECK = makeKeyword( "TYPE-CHECK" );
    $kw28$PARSE_TREE = makeKeyword( "PARSE-TREE" );
    $kw29$REMOVAL_PARSE_TREE_RELATION_POS = makeKeyword( "REMOVAL-PARSE-TREE-RELATION-POS" );
    $list30 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "REQUIRED-PATTERN" ), ConsesLow.list( ConsesLow.list( makeKeyword( "TEST" ), makeSymbol(
        "PREDICATE-WITH-PARSE-TREE-SUPPORT-P" ) ), makeKeyword( "FULLY-BOUND" ), makeKeyword( "ANYTHING" ) ), makeKeyword( "COST-EXPRESSION" ), makeSymbol( "*CHEAP-HL-MODULE-CHECK-COST*" ), makeKeyword( "COMPLETENESS" ),
      makeKeyword( "INCOMPLETE" ), makeKeyword( "INPUT-EXTRACT-PATTERN" ), ConsesLow.list( makeKeyword( "TEMPLATE" ), ConsesLow.list( ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "PRED" ) ), ConsesLow.list(
          makeKeyword( "BIND" ), makeSymbol( "NODE" ) ), ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "ARG2" ) ) ), ConsesLow.list( ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "PRED" ) ), ConsesLow.list(
              makeKeyword( "VALUE" ), makeSymbol( "NODE" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ARG2" ) ) ) ), makeKeyword( "OUTPUT-GENERATE-PATTERN" ), ConsesLow.list( makeKeyword( "CALL" ),
                  makeSymbol( "REMOVAL-PARSE-TREE-RELATION-ANSWER-LIST" ), makeKeyword( "INPUT" ) ), makeKeyword( "OUTPUT-CONSTRUCT-PATTERN" ), ConsesLow.list( ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol(
                      "PRED" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "NODE" ) ), makeKeyword( "INPUT" ) ), makeKeyword( "SUPPORT-MODULE" ), makeKeyword( "PARSE-TREE" ), makeKeyword( "DOCUMENTATION" ),
      makeString( "((:test predicate-with-parse-tree-support-p) :fully-bound :anything)" )
    } );
    $kw31$PARSE_TREE_REQUIRE_ARG1_FULLY_BOUND = makeKeyword( "PARSE-TREE-REQUIRE-ARG1-FULLY-BOUND" );
    $list32 = ConsesLow.list( makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "REQUIRED-PATTERN" ), ConsesLow.list( makeKeyword( "AND" ), ConsesLow.list( makeKeyword( "FORT" ), makeKeyword(
        "NOT-FULLY-BOUND" ), makeKeyword( "ANYTHING" ) ), ConsesLow.cons( ConsesLow.list( makeKeyword( "TEST" ), makeSymbol( "PREDICATE-WITH-PARSE-TREE-SUPPORT-P" ) ), makeKeyword( "ANYTHING" ) ) ), makeKeyword(
            "PREFERENCE" ), makeSymbol( "MUST-BIND-ARG1" ) );
  }

  public static final class $predicate_with_parse_tree_support_p$UnaryFunction
      extends
        UnaryFunction
  {
