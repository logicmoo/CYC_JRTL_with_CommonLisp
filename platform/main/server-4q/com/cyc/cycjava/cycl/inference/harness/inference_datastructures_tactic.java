...
import static com.cyc.cycjava.cycl.inference.harness.inference_datastructures_tactic.*;
...
public final class inference_datastructures_tactic extends SubLTranslatedFile {
    ...
    public static SubLObject tactic_p(final SubLObject v_object) {
        return v_object.getClass() == inference_datastructures_tactic.$tactic_native.class ? T : NIL;
    }

    public static SubLObject tact_suid(final SubLObject v_object) {
        assert NIL != tactic_p(v_object) : "inference_datastructures_tactic.tactic_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_tactic.tactic_p(v_object) " + v_object;
    ...
    public static SubLObject make_tactic(SubLObject arglist) {
        ...
        final SubLObject v_new = new inference_datastructures_tactic.$tactic_native();
        SubLObject next;
    ...
    public static final class $tactic_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_datastructures_tactic.$tactic_native.class, TACTIC, TACTIC_P, $list3, $list4, new String[]{ "$suid", "$problem", "$type", "$hl_module", "$completeness", "$preference_level_justification", "$productivity", "$original_productivity", "$status", "$progress_iterator", "$data", "$properties" }, $list5, $list6, PRINT_TACTIC);
        }
    }
