...
public final class inference_metrics extends SubLTranslatedFile {
    ...
    public static SubLObject inference_metric_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$inference_metric_native.class ? T : NIL;
    }
    ...
    public static SubLObject init_inference_metrics_file() {
        ...
        deflexical("*INFERENCE-METRICS-STORE*", SubLSystemTrampolineFile.maybeDefault($inference_metrics_store$, $inference_metrics_store$, () -> dictionary.new_dictionary(symbol_function(EQ), UNPROVIDED)));
        deflexical("*INFERENCE-METRIC-PROPERTIES*", $list39);
        deflexical("*PROBLEM-STORE-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($problem_store_historical_count$, $problem_store_historical_count$, ZERO_INTEGER));
        deflexical("*FORWARD-PROBLEM-STORE-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($forward_problem_store_historical_count$, $forward_problem_store_historical_count$, ZERO_INTEGER));
        deflexical("*MAXIMUM-PROBLEM-STORE-HISTORICAL-PROBLEM-COUNT*", SubLSystemTrampolineFile.maybeDefault($maximum_problem_store_historical_problem_count$, $maximum_problem_store_historical_problem_count$, ZERO_INTEGER));
        deflexical("*MAXIMUM-FORWARD-PROBLEM-STORE-HISTORICAL-PROBLEM-COUNT*", SubLSystemTrampolineFile.maybeDefault($maximum_forward_problem_store_historical_problem_count$, $maximum_forward_problem_store_historical_problem_count$, ZERO_INTEGER));
        defvar("*EXPENSIVE-FORWARD-PROBLEM-STORE-THRESHOLD*", $int$1000);
        deflexical("*PROBLEM-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($problem_historical_count$, $problem_historical_count$, ZERO_INTEGER));
        deflexical("*GOOD-PROBLEM-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($good_problem_historical_count$, $good_problem_historical_count$, ZERO_INTEGER));
        deflexical("*NO-GOOD-PROBLEM-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($no_good_problem_historical_count$, $no_good_problem_historical_count$, ZERO_INTEGER));
        deflexical("*FORWARD-PROBLEM-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($forward_problem_historical_count$, $forward_problem_historical_count$, ZERO_INTEGER));
        deflexical("*SINGLE-LITERAL-PROBLEM-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($single_literal_problem_historical_count$, $single_literal_problem_historical_count$, ZERO_INTEGER));
        deflexical("*PROBLEM-LINK-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($problem_link_historical_count$, $problem_link_historical_count$, ZERO_INTEGER));
        deflexical("*STRUCTURAL-LINK-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($structural_link_historical_count$, $structural_link_historical_count$, ZERO_INTEGER));
        deflexical("*CONTENT-LINK-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($content_link_historical_count$, $content_link_historical_count$, ZERO_INTEGER));
        deflexical("*REMOVAL-LINK-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($removal_link_historical_count$, $removal_link_historical_count$, ZERO_INTEGER));
        deflexical("*TRANSFORMATION-LINK-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($transformation_link_historical_count$, $transformation_link_historical_count$, ZERO_INTEGER));
        deflexical("*DEPENDENT-LINK-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($dependent_link_historical_count$, $dependent_link_historical_count$, ZERO_INTEGER));
        deflexical("*SINGLE-LITERAL-PROBLEM-DEPENDENT-LINK-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($single_literal_problem_dependent_link_historical_count$, $single_literal_problem_dependent_link_historical_count$, ZERO_INTEGER));
        deflexical("*TACTIC-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($tactic_historical_count$, $tactic_historical_count$, ZERO_INTEGER));
        deflexical("*EXECUTED-TACTIC-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($executed_tactic_historical_count$, $executed_tactic_historical_count$, ZERO_INTEGER));
        deflexical("*DISCARDED-TACTIC-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($discarded_tactic_historical_count$, $discarded_tactic_historical_count$, ZERO_INTEGER));
        deflexical("*UNIFICATION-ATTEMPT-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($unification_attempt_historical_count$, $unification_attempt_historical_count$, ZERO_INTEGER));
        deflexical("*UNIFICATION-SUCCESS-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($unification_success_historical_count$, $unification_success_historical_count$, ZERO_INTEGER));
        deflexical("*SBHL-CACHE-ATTEMPT-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($sbhl_cache_attempt_historical_count$, $sbhl_cache_attempt_historical_count$, ZERO_INTEGER));
        deflexical("*SBHL-CACHE-SUCCESS-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($sbhl_cache_success_historical_count$, $sbhl_cache_success_historical_count$, ZERO_INTEGER));
        deflexical("*SBHL-GRAPH-ATTEMPT-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($sbhl_graph_attempt_historical_count$, $sbhl_graph_attempt_historical_count$, ZERO_INTEGER));
        deflexical("*SBHL-GRAPH-SUCCESS-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($sbhl_graph_success_historical_count$, $sbhl_graph_success_historical_count$, ZERO_INTEGER));
        deflexical("*SBHL-LINK-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($sbhl_link_historical_count$, $sbhl_link_historical_count$, ZERO_INTEGER));
        deflexical("*PROOF-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($proof_historical_count$, $proof_historical_count$, ZERO_INTEGER));
        deflexical("*INFERENCE-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($inference_historical_count$, $inference_historical_count$, ZERO_INTEGER));
        deflexical("*SUCCESSFUL-INFERENCE-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($successful_inference_historical_count$, $successful_inference_historical_count$, ZERO_INTEGER));
        deflexical("*FORWARD-INFERENCE-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($forward_inference_historical_count$, $forward_inference_historical_count$, ZERO_INTEGER));
        deflexical("*SUCCESSFUL-FORWARD-INFERENCE-HISTORICAL-COUNT*", SubLSystemTrampolineFile.maybeDefault($successful_forward_inference_historical_count$, $successful_forward_inference_historical_count$, ZERO_INTEGER));
        ...
        deflexical("*FORWARD-INFERENCE-METRICS-TIME-INDEX*", SubLSystemTrampolineFile.maybeDefault($forward_inference_metrics_time_index$, $forward_inference_metrics_time_index$, () -> dictionary.new_dictionary(symbol_function(EQ), UNPROVIDED)));
        deflexical("*FORWARD-INFERENCE-METRICS-COUNT-INDEX*", SubLSystemTrampolineFile.maybeDefault($forward_inference_metrics_count_index$, $forward_inference_metrics_count_index$, () -> dictionary.new_dictionary(symbol_function(EQ), UNPROVIDED)));
        deflexical("*FORWARD-INFERENCE-METRICS-INFERENCE-INDEX*", SubLSystemTrampolineFile.maybeDefault($forward_inference_metrics_inference_index$, $forward_inference_metrics_inference_index$, () -> dictionary.new_dictionary(symbol_function(EQ), UNPROVIDED)));
        deflexical("*FORWARD-INFERENCE-METRICS-GAF-INDEX*", SubLSystemTrampolineFile.maybeDefault($forward_inference_metrics_gaf_index$, $forward_inference_metrics_gaf_index$, () -> dictionary.new_dictionary(symbol_function(EQ), UNPROVIDED)));
        deflexical("*FORWARD-INFERENCE-METRICS-SUCCESSFUL-RULE-INDEX*", SubLSystemTrampolineFile.maybeDefault($forward_inference_metrics_successful_rule_index$, $forward_inference_metrics_successful_rule_index$, () -> dictionary.new_dictionary(symbol_function(EQ), UNPROVIDED)));
