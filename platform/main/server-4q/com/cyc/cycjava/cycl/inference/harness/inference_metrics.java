...
import static com.cyc.cycjava.cycl.inference.harness.inference_metrics.*;
...
public final class inference_metrics extends SubLTranslatedFile {
    ...
    public static SubLObject inference_metric_p(final SubLObject v_object) {
        return v_object.getClass() == inference_metrics.$inference_metric_native.class ? T : NIL;
    }

    public static SubLObject inf_metric_name(final SubLObject v_object) {
        assert NIL != inference_metric_p(v_object) : "inference_metrics.inference_metric_p(v_object) " + "CommonSymbols.NIL != inference_metrics.inference_metric_p(v_object) " + v_object;
    ...
    public static SubLObject make_inference_metric(SubLObject arglist) {
        ...
        final SubLObject v_new = new inference_metrics.$inference_metric_native();
        SubLObject next;
    ...
    public static final class $inference_metric_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_metrics.$inference_metric_native.class, INFERENCE_METRIC, INFERENCE_METRIC_P, $list3, $list4, new String[]{ "$name", "$evaluation_func", "$evaluation_arg1", "$cross_productP" }, $list5, $list6, PRINT_INFERENCE_METRIC);
        }
    }
