...
public class removal_modules_natfunction extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_natfunction";
    ...
    public static SubLObject declare_removal_modules_natfunction_file() {
        ...
        declareFunction(myName, "inference_nart_id_check", "INFERENCE-NART-ID-CHECK", 2, 0, false);
        declareFunction(myName, "make_nart_id_support", "MAKE-NART-ID-SUPPORT", 2, 1, false);
        declareFunction(myName, "removal_nart_id_check_pos_cost", "REMOVAL-NART-ID-CHECK-POS-COST", 1, 1, false);
        declareFunction(myName, "removal_nart_id_check_neg_cost", "REMOVAL-NART-ID-CHECK-NEG-COST", 1, 1, false);
        declareFunction(myName, "removal_nart_id_check", "REMOVAL-NART-ID-CHECK", 1, 0, false);
        declareFunction(myName, "removal_nart_id_lookup_cost", "REMOVAL-NART-ID-LOOKUP-COST", 1, 1, false);
        return NIL;
    }
