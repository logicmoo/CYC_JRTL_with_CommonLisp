...
public class cb_inference_debugger extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.browser.cb_inference_debugger";
    ...
    public static SubLObject declare_cb_inference_debugger_file() {
        ...
        declareFunction(myName, "cb_link_debug_inference", "CB-LINK-DEBUG-INFERENCE", 1, 2, false);
        declareFunction(myName, "cb_debug_inference_handler", "CB-DEBUG-INFERENCE-HANDLER", 1, 0, false);
        declareFunction(myName, "cb_link_debug_problem", "CB-LINK-DEBUG-PROBLEM", 2, 2, false);
        declareFunction(myName, "cb_debug_problem_handler", "CB-DEBUG-PROBLEM-HANDLER", 1, 0, false);
        declareFunction(myName, "cb_link_debug_problem_link", "CB-LINK-DEBUG-PROBLEM-LINK", 2, 2, false);
        declareFunction(myName, "cb_debug_problem_link_handler", "CB-DEBUG-PROBLEM-LINK-HANDLER", 1, 0, false);
        declareFunction(myName, "cb_debug_handler_link", "CB-DEBUG-HANDLER-LINK", 6, 0, false);
        declareFunction(myName, "cb_debug_link", "CB-DEBUG-LINK", 4, 0, false);
        declareFunction(myName, "cb_lookup_options_by_glob_string", "CB-LOOKUP-OPTIONS-BY-GLOB-STRING", 1, 0, false);
        declareFunction(myName, "cb_debug_option_p", "CB-DEBUG-OPTION-P", 1, 0, false);
        declareFunction(myName, "cb_debug_option_default", "CB-DEBUG-OPTION-DEFAULT", 1, 0, false);
        declareFunction(myName, "cb_debug_option_value", "CB-DEBUG-OPTION-VALUE", 2, 0, false);
        declareFunction(myName, "cb_show_inference_debugger_option_tweaking_links", "CB-SHOW-INFERENCE-DEBUGGER-OPTION-TWEAKING-LINKS", 3, 0, false);
        declareFunction(myName, "cb_show_ancestor_depth_tweaking_links", "CB-SHOW-ANCESTOR-DEPTH-TWEAKING-LINKS", 3, 0, false);
        declareFunction(myName, "cb_show_option_tweaking_links", "CB-SHOW-OPTION-TWEAKING-LINKS", 6, 0, false);
        declareFunction(myName, "cb_show_option_tweaking_link", "CB-SHOW-OPTION-TWEAKING-LINK", 6, 0, false);
        declareFunction(myName, "cb_debug_inference", "CB-DEBUG-INFERENCE", 2, 0, false);
        declareFunction(myName, "cb_debug_problem", "CB-DEBUG-PROBLEM", 3, 0, false);
        declareFunction(myName, "cb_debug_problem_link", "CB-DEBUG-PROBLEM-LINK", 3, 0, false);
        declareFunction(myName, "cb_debug_ancestors", "CB-DEBUG-ANCESTORS", 5, 0, false);
        declareFunction(myName, "cb_debug_compute_ancestor_layers", "CB-DEBUG-COMPUTE-ANCESTOR-LAYERS", 2, 0, false);
        declareFunction(myName, "cb_debug_add_children_and_links_to_set", "CB-DEBUG-ADD-CHILDREN-AND-LINKS-TO-SET", 2, 0, false);
        declareFunction(myName, "cb_debug_problem_int", "CB-DEBUG-PROBLEM-INT", 5, 0, false);
        declareFunction(myName, "cb_debug_problem_parametrized", "CB-DEBUG-PROBLEM-PARAMETRIZED", 8, 0, false);
        declareFunction(myName, "cb_show_problem_link_for_debuggingP", "CB-SHOW-PROBLEM-LINK-FOR-DEBUGGING?", 3, 0, false);
        declareFunction(myName, "cb_debug_problem_link_int", "CB-DEBUG-PROBLEM-LINK-INT", 5, 0, false);
        declareFunction(myName, "cb_debug_join_ordered_link_guts", "CB-DEBUG-JOIN-ORDERED-LINK-GUTS", 5, 0, false);
        declareFunction(myName, "cb_debug_add_node_to_tree", "CB-DEBUG-ADD-NODE-TO-TREE", 2, 0, false);
        declareFunction(myName, "cb_debug_sort_argument_links", "CB-DEBUG-SORT-ARGUMENT-LINKS", 1, 0, false);
        declareFunction(myName, "cb_debug_argument_link_L", "CB-DEBUG-ARGUMENT-LINK-<", 2, 0, false);
        declareFunction(myName, "problem_link_suid_L", "PROBLEM-LINK-SUID-<", 2, 0, false);
        declareFunction(myName, "good_problem_link_p", "GOOD-PROBLEM-LINK-P", 1, 0, false);
        declareFunction(myName, "cb_debug_sort_supporting_problems", "CB-DEBUG-SORT-SUPPORTING-PROBLEMS", 1, 0, false);
        declareFunction(myName, "cb_debug_supporting_problem_L", "CB-DEBUG-SUPPORTING-PROBLEM-<", 2, 0, false);
        declareFunction(myName, "problem_suid_L", "PROBLEM-SUID-<", 2, 0, false);
        declareFunction(myName, "cb_debug_display_tree", "CB-DEBUG-DISPLAY-TREE", 3, 0, false);
        declareFunction(myName, "cb_debug_display_tree_children", "CB-DEBUG-DISPLAY-TREE-CHILDREN", 5, 0, false);
        declareFunction(myName, "cb_debug_display_tree_children_int", "CB-DEBUG-DISPLAY-TREE-CHILDREN-INT", 4, 0, false);
        declareFunction(myName, "cb_debug_display_tree_int", "CB-DEBUG-DISPLAY-TREE-INT", 3, 0, false);
        declareFunction(myName, "cb_debug_next_object_id_string", "CB-DEBUG-NEXT-OBJECT-ID-STRING", 0, 0, false);
        declareFunction(myName, "cb_debug_indent_the_right_amount", "CB-DEBUG-INDENT-THE-RIGHT-AMOUNT", 1, 0, false);
        declareFunction(myName, "cb_debug_inference_form", "CB-DEBUG-INFERENCE-FORM", 2, 0, false);
        return NIL;
    }
