...
import static com.cyc.cycjava.cycl.inference.harness.inference_worker_restriction.*;
...
public final class inference_worker_restriction extends SubLTranslatedFile {
    ...
    public static SubLObject restriction_link_data_p(final SubLObject v_object) {
        return v_object.getClass() == inference_worker_restriction.$restriction_link_data_native.class ? T : NIL;
    }

    public static SubLObject restr_link_data_bindings(final SubLObject v_object) {
        assert NIL != restriction_link_data_p(v_object) : "inference_worker_restriction.restriction_link_data_p(v_object) " + "CommonSymbols.NIL != inference_worker_restriction.restriction_link_data_p(v_object) " + v_object;
    ...
    public static SubLObject make_restriction_link_data(SubLObject arglist) {
        ...
        final SubLObject v_new = new inference_worker_restriction.$restriction_link_data_native();
        SubLObject next;
    ...
    public static SubLObject restriction_listening_link_data_p(final SubLObject v_object) {
        return v_object.getClass() == inference_worker_restriction.$restriction_listening_link_data_native.class ? T : NIL;
    }

    public static SubLObject restr_listen_link_data_bindings(final SubLObject v_object) {
        assert NIL != restriction_listening_link_data_p(v_object) : "inference_worker_restriction.restriction_listening_link_data_p(v_object) " + "CommonSymbols.NIL != inference_worker_restriction.restriction_listening_link_data_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_restriction_listening_link_data(SubLObject arglist) {
        ...
        final SubLObject v_new = new inference_worker_restriction.$restriction_listening_link_data_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $restriction_link_data_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_worker_restriction.$restriction_link_data_native.class, RESTRICTION_LINK_DATA, RESTRICTION_LINK_DATA_P, $list2, $list3, new String[]{ "$bindings", "$hl_module" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $restriction_listening_link_data_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_worker_restriction.$restriction_listening_link_data_native.class, RESTRICTION_LISTENING_LINK_DATA, RESTRICTION_LISTENING_LINK_DATA_P, $list23, $list24, new String[]{ "$bindings", "$hl_module", "$listeners" }, $list25, $list26, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
