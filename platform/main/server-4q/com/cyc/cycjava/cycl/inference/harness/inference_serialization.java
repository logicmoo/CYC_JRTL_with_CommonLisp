...
import static com.cyc.cycjava.cycl.inference.harness.inference_serialization.*;
...
public final class inference_serialization extends SubLTranslatedFile {
    ...
    public static final SubLString $str6$Time_to_implement_XML_problem_sto = makeString("Time to implement XML problem-store output serialization.");

    public static final SubLString $str7$Unexpected_protocol__S = makeString("Unexpected protocol ~S");



    public static final SubLString $str9$Time_to_implement_XML_problem_sto = makeString("Time to implement XML problem-store input serialization.");

    public static final SubLString $str10$1_0 = makeString("1.0");



    public static final SubLString $str12$Unsupported_serialization_version = makeString("Unsupported serialization version ~A");



    public static final SubLList $list14 = list(list(makeSymbol("*CFASL-LOAD-PS-PROBLEM-TABLE*"), makeKeyword("UNINITIALIZED")), list(makeSymbol("*CFASL-LOAD-PS-LINK-TABLE*"), makeKeyword("UNINITIALIZED")), list(makeSymbol("*CFASL-LOAD-PS-PROOF-TABLE*"), makeKeyword("UNINITIALIZED")));



    public static final SubLSymbol CFASL_LOAD_PS_PREPARE_FOR_EXPECTED_PROBLEM_COUNT = makeSymbol("CFASL-LOAD-PS-PREPARE-FOR-EXPECTED-PROBLEM-COUNT");

    public static final SubLSymbol WITH_CLEAN_CFASL_LOAD_PS_IDS = makeSymbol("WITH-CLEAN-CFASL-LOAD-PS-IDS");

    public static final SubLSymbol CFASL_LOAD_PS_PREPARE_FOR_EXPECTED_LINK_COUNT = makeSymbol("CFASL-LOAD-PS-PREPARE-FOR-EXPECTED-LINK-COUNT");

    public static final SubLSymbol CFASL_LOAD_PS_PREPARE_FOR_EXPECTED_PROOF_COUNT = makeSymbol("CFASL-LOAD-PS-PREPARE-FOR-EXPECTED-PROOF-COUNT");

    public static final SubLSymbol CFASL_LOAD_PS_NOTE_PROBLEM_ID = makeSymbol("CFASL-LOAD-PS-NOTE-PROBLEM-ID");

    public static final SubLSymbol CFASL_LOAD_PS_LOOKUP_PROBLEM = makeSymbol("CFASL-LOAD-PS-LOOKUP-PROBLEM");

    public static final SubLSymbol CFASL_LOAD_PS_NOTE_LINK_ID = makeSymbol("CFASL-LOAD-PS-NOTE-LINK-ID");

    public static final SubLSymbol CFASL_LOAD_PS_LOOKUP_LINK = makeSymbol("CFASL-LOAD-PS-LOOKUP-LINK");

    public static final SubLSymbol CFASL_LOAD_PS_NOTE_PROOF_ID = makeSymbol("CFASL-LOAD-PS-NOTE-PROOF-ID");

    public static final SubLSymbol CFASL_LOAD_PS_LOOKUP_PROOF = makeSymbol("CFASL-LOAD-PS-LOOKUP-PROOF");

    public static final SubLList $list26 = list(makeSymbol("CONSTANT-TABLE"), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLSymbol $cfasl_load_ps_constant_table$ = makeSymbol("*CFASL-LOAD-PS-CONSTANT-TABLE*");

    public static final SubLList $list28 = list(list(makeSymbol("*CFASL-CONSTANT-HANDLE-LOOKUP-FUNC*"), list(makeSymbol("QUOTE"), makeSymbol("CFASL-LOAD-PS-LOOKUP-CONSTANT"))), list(makeSymbol("*CFASL-INPUT-GUID-STRING-RESOURCE*"), list(makeSymbol("GUID-TO-STRING"), list(makeSymbol("NEW-GUID")))));

    public static final SubLSymbol CFASL_LOAD_PS_LOOKUP_CONSTANT = makeSymbol("CFASL-LOAD-PS-LOOKUP-CONSTANT");

    public static final SubLSymbol WITH_CFASL_LOAD_PS_CONSTANT_TABLE = makeSymbol("WITH-CFASL-LOAD-PS-CONSTANT-TABLE");

    public static final SubLString $str31$Unable_to_lookup_a_constant_from_ = makeString("Unable to lookup a constant from ~S");
    ...
    public static final SubLString $str36$Unexpected_section__S = makeString("Unexpected section ~S");
    ...
    public static final SubLSymbol POSSIBLY_NOTE_PROBLEM_STORE_COMMON_CONSTANT = makeSymbol("POSSIBLY-NOTE-PROBLEM-STORE-COMMON-CONSTANT");



    public static final SubLSymbol CONSTANT_INTERNAL_ID = makeSymbol("CONSTANT-INTERNAL-ID");





    public static final SubLSymbol PROBLEM_STORE_PROPERTIES_P = makeSymbol("PROBLEM-STORE-PROPERTIES-P");
    ...
    public static final SubLString $str56$Unexpected_link_type__S = makeString("Unexpected link type ~S");

    public static final SubLSymbol SPLIT_LINK_P = makeSymbol("SPLIT-LINK-P");

    public static final SubLSymbol JOIN_LINK_P = makeSymbol("JOIN-LINK-P");

    public static final SubLSymbol UNION_LINK_P = makeSymbol("UNION-LINK-P");
    ...
    public static SubLObject make_hash_table_from_set(final SubLObject v_set, SubLObject value_method, SubLObject key_method, SubLObject test) {
        ...
        assert NIL != function_spec_p(value_method) : "Types.function_spec_p(value_method) " + "CommonSymbols.NIL != Types.function_spec_p(value_method) " + value_method;
        assert NIL != function_spec_p(key_method) : "Types.function_spec_p(key_method) " + "CommonSymbols.NIL != Types.function_spec_p(key_method) " + key_method;
    ...
    public static SubLObject cfasl_load_problem_store_properties(final SubLObject stream) {
        ...
        assert NIL != inference_datastructures_enumerated_types.problem_store_properties_p(v_properties) : "inference_datastructures_enumerated_types.problem_store_properties_p(v_properties) " + "CommonSymbols.NIL != inference_datastructures_enumerated_types.problem_store_properties_p(v_properties) " + v_properties;
        return v_properties;
    }
    ...
    public static SubLObject cfasl_save_split_link(final SubLObject split_link, final SubLObject stream) {
        assert NIL != inference_worker_split.split_link_p(split_link) : "inference_worker_split.split_link_p(split_link) " + "CommonSymbols.NIL != inference_worker_split.split_link_p(split_link) " + split_link;
    ...
    public static SubLObject cfasl_save_union_link(final SubLObject union_link, final SubLObject stream) {
        assert NIL != inference_worker_union.union_link_p(union_link) : "inference_worker_union.union_link_p(union_link) " + "CommonSymbols.NIL != inference_worker_union.union_link_p(union_link) " + union_link;
    ...
    public static SubLObject cfasl_save_mapped_problem_reference_int(final SubLObject mapped_problem, final SubLObject stream, final SubLObject requiredP) {
        ...
        assert NIL != inference_datastructures_problem_link.mapped_problem_p(mapped_problem) : "inference_datastructures_problem_link.mapped_problem_p(mapped_problem) " + "CommonSymbols.NIL != inference_datastructures_problem_link.mapped_problem_p(mapped_problem) " + mapped_problem;
    ...
    public static SubLObject declare_inference_serialization_file() {
        declareFunction(me, "save_problem_store", "SAVE-PROBLEM-STORE", 2, 1, false);
        declareFunction(me, "load_problem_store", "LOAD-PROBLEM-STORE", 1, 2, false);
        declareFunction(me, "cfasl_save_problem_store", "CFASL-SAVE-PROBLEM-STORE", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_store", "CFASL-LOAD-PROBLEM-STORE", 1, 0, false);
        declareMacro(me, "with_clean_cfasl_load_ps_ids", "WITH-CLEAN-CFASL-LOAD-PS-IDS");
        declareFunction(me, "cfasl_load_ps_prepare_for_expected_problem_count", "CFASL-LOAD-PS-PREPARE-FOR-EXPECTED-PROBLEM-COUNT", 1, 0, false);
        declareFunction(me, "cfasl_load_ps_prepare_for_expected_link_count", "CFASL-LOAD-PS-PREPARE-FOR-EXPECTED-LINK-COUNT", 1, 0, false);
        declareFunction(me, "cfasl_load_ps_prepare_for_expected_proof_count", "CFASL-LOAD-PS-PREPARE-FOR-EXPECTED-PROOF-COUNT", 1, 0, false);
        declareFunction(me, "cfasl_load_ps_note_problem_id", "CFASL-LOAD-PS-NOTE-PROBLEM-ID", 2, 0, false);
        declareFunction(me, "cfasl_load_ps_lookup_problem", "CFASL-LOAD-PS-LOOKUP-PROBLEM", 1, 0, false);
        declareFunction(me, "cfasl_load_ps_note_link_id", "CFASL-LOAD-PS-NOTE-LINK-ID", 2, 0, false);
        declareFunction(me, "cfasl_load_ps_lookup_link", "CFASL-LOAD-PS-LOOKUP-LINK", 1, 0, false);
        declareFunction(me, "cfasl_load_ps_note_proof_id", "CFASL-LOAD-PS-NOTE-PROOF-ID", 2, 0, false);
        declareFunction(me, "cfasl_load_ps_lookup_proof", "CFASL-LOAD-PS-LOOKUP-PROOF", 1, 0, false);
        declareMacro(me, "with_cfasl_load_ps_constant_table", "WITH-CFASL-LOAD-PS-CONSTANT-TABLE");
        declareFunction(me, "cfasl_load_ps_lookup_constant", "CFASL-LOAD-PS-LOOKUP-CONSTANT", 1, 0, false);
        declareFunction(me, "cfasl_save_problem_store_1_0", "CFASL-SAVE-PROBLEM-STORE-1-0", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_store_1_0", "CFASL-LOAD-PROBLEM-STORE-1-0", 1, 0, false);
        declareFunction(me, "compute_problem_store_common_symbols", "COMPUTE-PROBLEM-STORE-COMMON-SYMBOLS", 1, 0, false);
        declareFunction(me, "possibly_note_problem_store_common_constant", "POSSIBLY-NOTE-PROBLEM-STORE-COMMON-CONSTANT", 1, 0, false);
        declareFunction(me, "compute_problem_store_common_constants", "COMPUTE-PROBLEM-STORE-COMMON-CONSTANTS", 1, 0, false);
        declareFunction(me, "make_constant_internal_id_map", "MAKE-CONSTANT-INTERNAL-ID-MAP", 1, 0, false);
        declareFunction(me, "make_hash_table_from_set", "MAKE-HASH-TABLE-FROM-SET", 1, 3, false);
        declareFunction(me, "cfasl_save_problem_store_properties", "CFASL-SAVE-PROBLEM-STORE-PROPERTIES", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_store_properties", "CFASL-LOAD-PROBLEM-STORE-PROPERTIES", 1, 0, false);
        declareFunction(me, "cfasl_save_problem_store_problems", "CFASL-SAVE-PROBLEM-STORE-PROBLEMS", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_store_problems", "CFASL-LOAD-PROBLEM-STORE-PROBLEMS", 2, 0, false);
        declareFunction(me, "cfasl_save_problem_store_problem", "CFASL-SAVE-PROBLEM-STORE-PROBLEM", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_store_problem", "CFASL-LOAD-PROBLEM-STORE-PROBLEM", 2, 0, false);
        declareFunction(me, "cfasl_save_problem_store_proofs", "CFASL-SAVE-PROBLEM-STORE-PROOFS", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_store_proofs", "CFASL-LOAD-PROBLEM-STORE-PROOFS", 2, 0, false);
        declareFunction(me, "cfasl_save_problem_store_proof", "CFASL-SAVE-PROBLEM-STORE-PROOF", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_store_proof", "CFASL-LOAD-PROBLEM-STORE-PROOF", 2, 0, false);
        declareFunction(me, "cfasl_load_proof_subproofs", "CFASL-LOAD-PROOF-SUBPROOFS", 2, 0, false);
        declareFunction(me, "cfasl_save_problem_store_problem_links", "CFASL-SAVE-PROBLEM-STORE-PROBLEM-LINKS", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_store_problem_links", "CFASL-LOAD-PROBLEM-STORE-PROBLEM-LINKS", 2, 0, false);
        declareFunction(me, "cfasl_save_problem_store_problem_link", "CFASL-SAVE-PROBLEM-STORE-PROBLEM-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_store_problem_link", "CFASL-LOAD-PROBLEM-STORE-PROBLEM-LINK", 2, 0, false);
        declareFunction(me, "cfasl_save_removal_link", "CFASL-SAVE-REMOVAL-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_removal_link", "CFASL-LOAD-REMOVAL-LINK", 2, 0, false);
        declareFunction(me, "cfasl_save_rewrite_link", "CFASL-SAVE-REWRITE-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_rewrite_link", "CFASL-LOAD-REWRITE-LINK", 2, 0, false);
        declareFunction(me, "cfasl_save_transformation_link", "CFASL-SAVE-TRANSFORMATION-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_transformation_link", "CFASL-LOAD-TRANSFORMATION-LINK", 2, 0, false);
        declareFunction(me, "cfasl_save_residual_transformation_link", "CFASL-SAVE-RESIDUAL-TRANSFORMATION-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_residual_transformation_link", "CFASL-LOAD-RESIDUAL-TRANSFORMATION-LINK", 2, 0, false);
        declareFunction(me, "cfasl_save_restriction_link", "CFASL-SAVE-RESTRICTION-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_restriction_link", "CFASL-LOAD-RESTRICTION-LINK", 2, 0, false);
        declareFunction(me, "cfasl_save_split_link", "CFASL-SAVE-SPLIT-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_split_link", "CFASL-LOAD-SPLIT-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_split_link_conjuncts", "CFASL-LOAD-SPLIT-LINK-CONJUNCTS", 2, 0, false);
        declareFunction(me, "cfasl_save_join_ordered_link", "CFASL-SAVE-JOIN-ORDERED-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_join_ordered_link", "CFASL-LOAD-JOIN-ORDERED-LINK", 2, 0, false);
        declareFunction(me, "cfasl_save_join_link", "CFASL-SAVE-JOIN-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_join_link", "CFASL-LOAD-JOIN-LINK", 2, 0, false);
        declareFunction(me, "cfasl_save_union_link", "CFASL-SAVE-UNION-LINK", 2, 0, false);
        declareFunction(me, "cfasl_load_union_link", "CFASL-LOAD-UNION-LINK", 2, 0, false);
        declareFunction(me, "cfasl_save_problem_reference", "CFASL-SAVE-PROBLEM-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_reference", "CFASL-LOAD-PROBLEM-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_save_mapped_problem_reference", "CFASL-SAVE-MAPPED-PROBLEM-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_load_mapped_problem_reference", "CFASL-LOAD-MAPPED-PROBLEM-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_save_optional_mapped_problem_reference", "CFASL-SAVE-OPTIONAL-MAPPED-PROBLEM-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_load_optional_mapped_problem_reference", "CFASL-LOAD-OPTIONAL-MAPPED-PROBLEM-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_save_mapped_problem_reference_int", "CFASL-SAVE-MAPPED-PROBLEM-REFERENCE-INT", 3, 0, false);
        declareFunction(me, "cfasl_load_mapped_problem_reference_int", "CFASL-LOAD-MAPPED-PROBLEM-REFERENCE-INT", 3, 0, false);
        declareFunction(me, "cfasl_save_problem_link_reference", "CFASL-SAVE-PROBLEM-LINK-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_load_problem_link_reference", "CFASL-LOAD-PROBLEM-LINK-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_save_proof_reference", "CFASL-SAVE-PROOF-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_load_proof_reference", "CFASL-LOAD-PROOF-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_save_hl_module_reference", "CFASL-SAVE-HL-MODULE-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_load_hl_module_reference", "CFASL-LOAD-HL-MODULE-REFERENCE", 1, 0, false);
        declareFunction(me, "cfasl_save_optional_hl_module_reference", "CFASL-SAVE-OPTIONAL-HL-MODULE-REFERENCE", 2, 0, false);
        declareFunction(me, "cfasl_load_optional_hl_module_reference", "CFASL-LOAD-OPTIONAL-HL-MODULE-REFERENCE", 1, 0, false);
        declareFunction(me, "cfasl_save_hl_module_reference_int", "CFASL-SAVE-HL-MODULE-REFERENCE-INT", 3, 0, false);
        declareFunction(me, "cfasl_load_hl_module_reference_int", "CFASL-LOAD-HL-MODULE-REFERENCE-INT", 2, 0, false);
        declareFunction(me, "cfasl_unsupported_type_error", "CFASL-UNSUPPORTED-TYPE-ERROR", 1, 0, false);
        declareFunction(me, "cfasl_output_object_problem_store_method", "CFASL-OUTPUT-OBJECT-PROBLEM-STORE-METHOD", 2, 0, false);
        declareFunction(me, "cfasl_output_object_problem_method", "CFASL-OUTPUT-OBJECT-PROBLEM-METHOD", 2, 0, false);
        declareFunction(me, "cfasl_output_object_tactic_method", "CFASL-OUTPUT-OBJECT-TACTIC-METHOD", 2, 0, false);
        declareFunction(me, "cfasl_output_object_problem_link_method", "CFASL-OUTPUT-OBJECT-PROBLEM-LINK-METHOD", 2, 0, false);
        declareFunction(me, "cfasl_output_object_proof_method", "CFASL-OUTPUT-OBJECT-PROOF-METHOD", 2, 0, false);
        declareFunction(me, "cfasl_output_object_strategy_method", "CFASL-OUTPUT-OBJECT-STRATEGY-METHOD", 2, 0, false);
        declareFunction(me, "cfasl_output_object_inference_method", "CFASL-OUTPUT-OBJECT-INFERENCE-METHOD", 2, 0, false);
        declareFunction(me, "cfasl_output_object_inference_answer_method", "CFASL-OUTPUT-OBJECT-INFERENCE-ANSWER-METHOD", 2, 0, false);
        declareFunction(me, "cfasl_output_object_inference_answer_justification_method", "CFASL-OUTPUT-OBJECT-INFERENCE-ANSWER-JUSTIFICATION-METHOD", 2, 0, false);
        return NIL;
    }
