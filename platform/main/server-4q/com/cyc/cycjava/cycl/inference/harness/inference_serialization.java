...
public final class inference_serialization
    extends
      SubLTranslatedFile
{
    ...
    if( pcase_var.eql( $kw0$CFASL ) )
    {
      ...
      try
      {
        ...
        try
        {
          ...
          stream = compatibility.open_binary( filename, $kw3$OUTPUT );
        }
        finally
        {
  ...
  public static SubLObject load_problem_store(final SubLObject filename, SubLObject protocol, SubLObject validateP)
  {
    ...
    if( pcase_var.eql( $kw0$CFASL ) )
    {
      ...
      try
      {
        ...
        {
          stream_macros.$stream_requires_locking$.bind( NIL, thread );
          stream = compatibility.open_binary( filename, $kw8$INPUT );
        }
        finally
        {
          stream_macros.$stream_requires_locking$.rebind( _prev_bind_0, thread );
  ...
  {
    assert NIL != Types.streamp( stream ) : stream;
    final SubLObject version = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    if( version.equal( $str10$1_0 ) )
    {
  ...
  public static SubLObject with_clean_cfasl_load_ps_ids(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.listS( $sym13$CLET, $list14, ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject with_cfasl_load_ps_constant_table(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.listS( $sym13$CLET, reader.bq_cons( ConsesLow.list( $sym27$_CFASL_LOAD_PS_CONSTANT_TABLE_, constant_table ), $list28 ), ConsesLow.append( body, NIL ) );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject constant = Hashtables.gethash_without_values( id, $cfasl_load_ps_constant_table$.getDynamicValue( thread ), UNPROVIDED );
    if( NIL == Errors.$ignore_mustsP$.getDynamicValue( thread ) && NIL == constant_handles.constant_p( constant ) )
    {
  ...
  public static SubLObject cfasl_save_problem_store_1_0(final SubLObject store, final SubLObject stream)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        cfasl.cfasl_output( $kw32$PROBLEM, stream );
        cfasl_save_problem_store_problems( store, stream );
        cfasl.cfasl_output( $kw33$PROBLEM_LINK, stream );
        cfasl_save_problem_store_problem_links( store, stream );
        cfasl.cfasl_output( $kw34$PROOF, stream );
        cfasl_save_problem_store_proofs( store, stream );
        cfasl.cfasl_output( $kw35$DONE, stream );
      }
      finally
      {
  ...
  public static SubLObject cfasl_load_problem_store_1_0(final SubLObject stream)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        $cfasl_load_ps_problem_table$.bind( $kw15$UNINITIALIZED, thread );
        $cfasl_load_ps_link_table$.bind( $kw15$UNINITIALIZED, thread );
        $cfasl_load_ps_proof_table$.bind( $kw15$UNINITIALIZED, thread );
        ...
        for( SubLObject section = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED ); $kw35$DONE != section; section = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED ) )
        {
          final SubLObject pcase_var = section;
          if( pcase_var.eql( $kw32$PROBLEM ) )
          {
            cfasl_load_problem_store_problems( store, stream );
          }
          else if( pcase_var.eql( $kw33$PROBLEM_LINK ) )
          {
            cfasl_load_problem_store_problem_links( store, stream );
          }
          else if( pcase_var.eql( $kw34$PROOF ) )
          {
  ...
  {
    assert NIL != inference_datastructures_problem_store.problem_store_p( store ) : store;
    final SubLObject common_symbols = set.new_set( Symbols.symbol_function( EQ ), UNPROVIDED );
    final SubLObject idx = inference_datastructures_problem_store.problem_store_link_id_index( store );
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw37$SKIP ) )
    {
      final SubLObject idx_$6 = idx;
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$6, $kw37$SKIP ) )
      {
        ...
        for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
        {
          ...
          if( NIL == id_index.id_index_tombstone_p( link ) || NIL == id_index.id_index_skip_tombstones_p( $kw37$SKIP ) )
          {
  ...
  public static SubLObject compute_problem_store_common_constants(final SubLObject store)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    assert NIL != inference_datastructures_problem_store.problem_store_p( store ) : store;
    final SubLObject common_constants = set.new_set( Symbols.symbol_function( EQ ), $int41$100 );
    ...
    try
    {
      ...
      if( NIL == id_index.id_index_objects_empty_p( idx, $kw37$SKIP ) )
      {
        ...
        if( NIL == id_index.id_index_dense_objects_empty_p( idx_$8, $kw37$SKIP ) )
        {
          ...
          for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
          {
            ...
            if( NIL == id_index.id_index_tombstone_p( problem ) || NIL == id_index.id_index_skip_tombstones_p( $kw37$SKIP ) )
            {
  ...
  public static SubLObject make_hash_table_from_set(final SubLObject v_set, SubLObject value_method, SubLObject key_method, SubLObject test)
  {
    ...
    final SubLObject table = Hashtables.make_hash_table( set.set_size( v_set ), test, UNPROVIDED );
  ...
  {
    final SubLObject v_properties = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject cfasl_save_problem_store_problems(final SubLObject store, final SubLObject stream)
  {
    ...
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw37$SKIP ) )
    {
      ...
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$10, $kw37$SKIP ) )
      {
      ...
      if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$11 ) || NIL == id_index.id_index_skip_tombstones_p( $kw37$SKIP ) )
      {
        ...
        final SubLObject v_default = ( NIL != id_index.id_index_skip_tombstones_p( $kw37$SKIP ) ) ? NIL : $kw37$SKIP;
        while ( id2.numL( end_id ))
        {
          final SubLObject problem2 = Hashtables.gethash_without_values( id2, sparse, v_default );
          if( NIL == id_index.id_index_skip_tombstones_p( $kw37$SKIP ) || NIL == id_index.id_index_tombstone_p( problem2 ) )
          {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject suid = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    final SubLObject query = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    SubLObject free_hl_vars = NIL;
    if( NIL != $inference_serialization_supports_problem_free_hl_var_optimizationP$.getDynamicValue( thread ) )
    {
      final SubLObject possible_free_hl_vars_opcode = cfasl.cfasl_opcode_peek( stream, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject cfasl_save_problem_store_proofs(final SubLObject store, final SubLObject stream)
  {
    ...
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw37$SKIP ) )
    {
      ...
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$12, $kw37$SKIP ) )
      {
        ...
        for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
        {
          ...
          if( NIL == id_index.id_index_tombstone_p( proof ) || NIL == id_index.id_index_skip_tombstones_p( $kw37$SKIP ) )
          {
      ...
      if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$13 ) || NIL == id_index.id_index_skip_tombstones_p( $kw37$SKIP ) )
      {
        ...
        while ( id2.numL( end_id ))
        {
          ...
          if( NIL == id_index.id_index_skip_tombstones_p( $kw37$SKIP ) || NIL == id_index.id_index_tombstone_p( proof2 ) )
          {
  ...
  public static SubLObject cfasl_load_problem_store_proofs(final SubLObject store, final SubLObject stream)
  {
    ...
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw37$SKIP ) )
    {
      ...
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$14, $kw37$SKIP ) )
      {
  ...
  {
    final SubLObject suid = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    final SubLObject v_bindings = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject cfasl_save_problem_store_problem_links(final SubLObject store, final SubLObject stream)
  {
    ...
    if( NIL == id_index.id_index_objects_empty_p( idx, $kw37$SKIP ) )
    {
      ...
      if( NIL == id_index.id_index_dense_objects_empty_p( idx_$16, $kw37$SKIP ) )
      {
      ...
      if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$17 ) || NIL == id_index.id_index_skip_tombstones_p( $kw37$SKIP ) )
      {
        ...
        while ( id2.numL( end_id ))
        {
          ...
          if( ( NIL == id_index.id_index_skip_tombstones_p( $kw37$SKIP ) || NIL == id_index.id_index_tombstone_p( link2 ) ) && NIL == inference_worker_answer.answer_link_p( link2 ) )
          {
  ...
  public static SubLObject cfasl_save_problem_store_problem_link(final SubLObject link, final SubLObject stream)
  {
    ...
    if( pcase_var.eql( $kw47$REMOVAL ) )
    {
      cfasl_save_removal_link( link, stream );
    }
    else if( pcase_var.eql( $kw48$REWRITE ) )
    {
      cfasl_save_rewrite_link( link, stream );
    }
    else if( pcase_var.eql( $kw49$TRANSFORMATION ) )
    {
      cfasl_save_transformation_link( link, stream );
    }
    else if( pcase_var.eql( $kw50$RESIDUAL_TRANSFORMATION ) )
    {
      cfasl_save_residual_transformation_link( link, stream );
    }
    else if( pcase_var.eql( $kw51$RESTRICTION ) )
    {
      cfasl_save_restriction_link( link, stream );
    }
    else if( pcase_var.eql( $kw52$SPLIT ) )
    {
      cfasl_save_split_link( link, stream );
    }
    else if( pcase_var.eql( $kw53$JOIN_ORDERED ) )
    {
      cfasl_save_join_ordered_link( link, stream );
    }
    else if( pcase_var.eql( $kw54$JOIN ) )
    {
      cfasl_save_join_link( link, stream );
    }
    else if( pcase_var.eql( $kw55$UNION ) )
    {
  ...
  public static SubLObject cfasl_load_removal_link(final SubLObject store, final SubLObject stream)
  {
    ...
    final SubLObject removal_bindings = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject cfasl_load_transformation_link(final SubLObject store, final SubLObject stream)
  {
    ...
    final SubLObject supporting_mapped_problem = cfasl_load_mapped_problem_reference( store, stream );
    final SubLObject hl_module = cfasl_load_hl_module_reference( stream );
    final SubLObject transformation_bindings = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    final SubLObject rule_assertion = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    final SubLObject more_supports = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    final SubLObject non_explanatory_subquery = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    final SubLObject transformation_link = inference_worker_transformation.new_transformation_link( supported_problem, supporting_mapped_problem, hl_module, transformation_bindings, rule_assertion, more_supports,
  ...
  public static SubLObject cfasl_load_residual_transformation_link(final SubLObject store, final SubLObject stream)
  {
    ...
    final SubLObject supporting_mapped_problem = cfasl_load_mapped_problem_reference( store, stream );
    final SubLObject conjunctive_problem_dont_care_variable_map = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    final SubLObject residual_conjunction_literal_map = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    final SubLObject residual_transformation_link = inference_worker_residual_transformation.new_residual_transformation_link( supporting_mapped_problem, join_ordered_link, transformation_link,
        conjunctive_problem_dont_care_variable_map, residual_conjunction_literal_map );
  ...
  public static SubLObject cfasl_load_restriction_link(final SubLObject store, final SubLObject stream)
  {
    final SubLObject supported_problem = cfasl_load_problem_reference( store, stream );
    final SubLObject supporting_mapped_problem = cfasl_load_mapped_problem_reference( store, stream );
    final SubLObject restriction_bindings = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
    final SubLObject listening_linkP = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
  ...
  {
    final SubLObject supporting_problem_count = cfasl.cfasl_input( stream, UNPROVIDED, UNPROVIDED );
  ...
  {
    SubLFiles.declareFunction( me, "save_problem_store", "SAVE-PROBLEM-STORE", 2, 1, false );
    SubLFiles.declareFunction( me, "load_problem_store", "LOAD-PROBLEM-STORE", 1, 2, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_store", "CFASL-SAVE-PROBLEM-STORE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_store", "CFASL-LOAD-PROBLEM-STORE", 1, 0, false );
    SubLFiles.declareMacro( me, "with_clean_cfasl_load_ps_ids", "WITH-CLEAN-CFASL-LOAD-PS-IDS" );
    SubLFiles.declareFunction( me, "cfasl_load_ps_prepare_for_expected_problem_count", "CFASL-LOAD-PS-PREPARE-FOR-EXPECTED-PROBLEM-COUNT", 1, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_ps_prepare_for_expected_link_count", "CFASL-LOAD-PS-PREPARE-FOR-EXPECTED-LINK-COUNT", 1, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_ps_prepare_for_expected_proof_count", "CFASL-LOAD-PS-PREPARE-FOR-EXPECTED-PROOF-COUNT", 1, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_ps_note_problem_id", "CFASL-LOAD-PS-NOTE-PROBLEM-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_ps_lookup_problem", "CFASL-LOAD-PS-LOOKUP-PROBLEM", 1, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_ps_note_link_id", "CFASL-LOAD-PS-NOTE-LINK-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_ps_lookup_link", "CFASL-LOAD-PS-LOOKUP-LINK", 1, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_ps_note_proof_id", "CFASL-LOAD-PS-NOTE-PROOF-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_ps_lookup_proof", "CFASL-LOAD-PS-LOOKUP-PROOF", 1, 0, false );
    SubLFiles.declareMacro( me, "with_cfasl_load_ps_constant_table", "WITH-CFASL-LOAD-PS-CONSTANT-TABLE" );
    SubLFiles.declareFunction( me, "cfasl_load_ps_lookup_constant", "CFASL-LOAD-PS-LOOKUP-CONSTANT", 1, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_store_1_0", "CFASL-SAVE-PROBLEM-STORE-1-0", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_store_1_0", "CFASL-LOAD-PROBLEM-STORE-1-0", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_problem_store_common_symbols", "COMPUTE-PROBLEM-STORE-COMMON-SYMBOLS", 1, 0, false );
    SubLFiles.declareFunction( me, "possibly_note_problem_store_common_constant", "POSSIBLY-NOTE-PROBLEM-STORE-COMMON-CONSTANT", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_problem_store_common_constants", "COMPUTE-PROBLEM-STORE-COMMON-CONSTANTS", 1, 0, false );
    SubLFiles.declareFunction( me, "make_constant_internal_id_map", "MAKE-CONSTANT-INTERNAL-ID-MAP", 1, 0, false );
    SubLFiles.declareFunction( me, "make_hash_table_from_set", "MAKE-HASH-TABLE-FROM-SET", 1, 3, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_store_properties", "CFASL-SAVE-PROBLEM-STORE-PROPERTIES", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_store_properties", "CFASL-LOAD-PROBLEM-STORE-PROPERTIES", 1, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_store_problems", "CFASL-SAVE-PROBLEM-STORE-PROBLEMS", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_store_problems", "CFASL-LOAD-PROBLEM-STORE-PROBLEMS", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_store_problem", "CFASL-SAVE-PROBLEM-STORE-PROBLEM", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_store_problem", "CFASL-LOAD-PROBLEM-STORE-PROBLEM", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_store_proofs", "CFASL-SAVE-PROBLEM-STORE-PROOFS", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_store_proofs", "CFASL-LOAD-PROBLEM-STORE-PROOFS", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_store_proof", "CFASL-SAVE-PROBLEM-STORE-PROOF", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_store_proof", "CFASL-LOAD-PROBLEM-STORE-PROOF", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_proof_subproofs", "CFASL-LOAD-PROOF-SUBPROOFS", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_store_problem_links", "CFASL-SAVE-PROBLEM-STORE-PROBLEM-LINKS", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_store_problem_links", "CFASL-LOAD-PROBLEM-STORE-PROBLEM-LINKS", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_store_problem_link", "CFASL-SAVE-PROBLEM-STORE-PROBLEM-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_store_problem_link", "CFASL-LOAD-PROBLEM-STORE-PROBLEM-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_removal_link", "CFASL-SAVE-REMOVAL-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_removal_link", "CFASL-LOAD-REMOVAL-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_rewrite_link", "CFASL-SAVE-REWRITE-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_rewrite_link", "CFASL-LOAD-REWRITE-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_transformation_link", "CFASL-SAVE-TRANSFORMATION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_transformation_link", "CFASL-LOAD-TRANSFORMATION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_residual_transformation_link", "CFASL-SAVE-RESIDUAL-TRANSFORMATION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_residual_transformation_link", "CFASL-LOAD-RESIDUAL-TRANSFORMATION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_restriction_link", "CFASL-SAVE-RESTRICTION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_restriction_link", "CFASL-LOAD-RESTRICTION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_split_link", "CFASL-SAVE-SPLIT-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_split_link", "CFASL-LOAD-SPLIT-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_split_link_conjuncts", "CFASL-LOAD-SPLIT-LINK-CONJUNCTS", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_join_ordered_link", "CFASL-SAVE-JOIN-ORDERED-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_join_ordered_link", "CFASL-LOAD-JOIN-ORDERED-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_join_link", "CFASL-SAVE-JOIN-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_join_link", "CFASL-LOAD-JOIN-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_union_link", "CFASL-SAVE-UNION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_union_link", "CFASL-LOAD-UNION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_reference", "CFASL-SAVE-PROBLEM-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_reference", "CFASL-LOAD-PROBLEM-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_mapped_problem_reference", "CFASL-SAVE-MAPPED-PROBLEM-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_mapped_problem_reference", "CFASL-LOAD-MAPPED-PROBLEM-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_optional_mapped_problem_reference", "CFASL-SAVE-OPTIONAL-MAPPED-PROBLEM-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_optional_mapped_problem_reference", "CFASL-LOAD-OPTIONAL-MAPPED-PROBLEM-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_mapped_problem_reference_int", "CFASL-SAVE-MAPPED-PROBLEM-REFERENCE-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_mapped_problem_reference_int", "CFASL-LOAD-MAPPED-PROBLEM-REFERENCE-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_problem_link_reference", "CFASL-SAVE-PROBLEM-LINK-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_problem_link_reference", "CFASL-LOAD-PROBLEM-LINK-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_proof_reference", "CFASL-SAVE-PROOF-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_proof_reference", "CFASL-LOAD-PROOF-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_hl_module_reference", "CFASL-SAVE-HL-MODULE-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_hl_module_reference", "CFASL-LOAD-HL-MODULE-REFERENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_optional_hl_module_reference", "CFASL-SAVE-OPTIONAL-HL-MODULE-REFERENCE", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_optional_hl_module_reference", "CFASL-LOAD-OPTIONAL-HL-MODULE-REFERENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "cfasl_save_hl_module_reference_int", "CFASL-SAVE-HL-MODULE-REFERENCE-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "cfasl_load_hl_module_reference_int", "CFASL-LOAD-HL-MODULE-REFERENCE-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_unsupported_type_error", "CFASL-UNSUPPORTED-TYPE-ERROR", 1, 0, false );
    SubLFiles.declareFunction( me, "cfasl_output_object_problem_store_method", "CFASL-OUTPUT-OBJECT-PROBLEM-STORE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_output_object_problem_method", "CFASL-OUTPUT-OBJECT-PROBLEM-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_output_object_tactic_method", "CFASL-OUTPUT-OBJECT-TACTIC-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_output_object_problem_link_method", "CFASL-OUTPUT-OBJECT-PROBLEM-LINK-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_output_object_proof_method", "CFASL-OUTPUT-OBJECT-PROOF-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_output_object_strategy_method", "CFASL-OUTPUT-OBJECT-STRATEGY-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_output_object_inference_method", "CFASL-OUTPUT-OBJECT-INFERENCE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_output_object_inference_answer_method", "CFASL-OUTPUT-OBJECT-INFERENCE-ANSWER-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "cfasl_output_object_inference_answer_justification_method", "CFASL-OUTPUT-OBJECT-INFERENCE-ANSWER-JUSTIFICATION-METHOD", 2, 0, false );
    return NIL;
  }
  ...
  public static SubLObject init_inference_serialization_file()
  {
    ...
    $current_cfasl_save_problem_store_version$ = SubLFiles.deflexical( "*CURRENT-CFASL-SAVE-PROBLEM-STORE-VERSION*", $str10$1_0 );
    $cfasl_load_ps_problem_table$ = SubLFiles.defparameter( "*CFASL-LOAD-PS-PROBLEM-TABLE*", $kw15$UNINITIALIZED );
    $cfasl_load_ps_link_table$ = SubLFiles.defparameter( "*CFASL-LOAD-PS-LINK-TABLE*", $kw15$UNINITIALIZED );
    $cfasl_load_ps_proof_table$ = SubLFiles.defparameter( "*CFASL-LOAD-PS-PROOF-TABLE*", $kw15$UNINITIALIZED );
    $cfasl_load_ps_constant_table$ = SubLFiles.defparameter( "*CFASL-LOAD-PS-CONSTANT-TABLE*", $kw15$UNINITIALIZED );
    $problem_store_common_constants$ = SubLFiles.defparameter( "*PROBLEM-STORE-COMMON-CONSTANTS*", NIL );
    return NIL;
  }
  ...
  public static SubLObject setup_inference_serialization_file()
  {
    ...
    Structures.register_method( cfasl.$cfasl_output_object_method_table$.getGlobalValue(), inference_datastructures_problem_store.$dtp_problem_store$.getGlobalValue(), Symbols.symbol_function(
        $sym65$CFASL_OUTPUT_OBJECT_PROBLEM_STORE_METHOD ) );
    Structures.register_method( cfasl.$cfasl_output_object_method_table$.getGlobalValue(), inference_datastructures_problem.$dtp_problem$.getGlobalValue(), Symbols.symbol_function(
        $sym66$CFASL_OUTPUT_OBJECT_PROBLEM_METHOD ) );
    Structures.register_method( cfasl.$cfasl_output_object_method_table$.getGlobalValue(), inference_datastructures_tactic.$dtp_tactic$.getGlobalValue(), Symbols.symbol_function(
        $sym67$CFASL_OUTPUT_OBJECT_TACTIC_METHOD ) );
    Structures.register_method( cfasl.$cfasl_output_object_method_table$.getGlobalValue(), inference_datastructures_problem_link.$dtp_problem_link$.getGlobalValue(), Symbols.symbol_function(
        $sym68$CFASL_OUTPUT_OBJECT_PROBLEM_LINK_METHOD ) );
    Structures.register_method( cfasl.$cfasl_output_object_method_table$.getGlobalValue(), inference_datastructures_proof.$dtp_proof$.getGlobalValue(), Symbols.symbol_function(
        $sym69$CFASL_OUTPUT_OBJECT_PROOF_METHOD ) );
    Structures.register_method( cfasl.$cfasl_output_object_method_table$.getGlobalValue(), inference_datastructures_strategy.$dtp_strategy$.getGlobalValue(), Symbols.symbol_function(
        $sym70$CFASL_OUTPUT_OBJECT_STRATEGY_METHOD ) );
    Structures.register_method( cfasl.$cfasl_output_object_method_table$.getGlobalValue(), inference_datastructures_inference.$dtp_inference$.getGlobalValue(), Symbols.symbol_function(
        $sym71$CFASL_OUTPUT_OBJECT_INFERENCE_METHOD ) );
    Structures.register_method( cfasl.$cfasl_output_object_method_table$.getGlobalValue(), inference_datastructures_inference.$dtp_inference_answer$.getGlobalValue(), Symbols.symbol_function(
        $sym72$CFASL_OUTPUT_OBJECT_INFERENCE_ANSWER_METHOD ) );
    Structures.register_method( cfasl.$cfasl_output_object_method_table$.getGlobalValue(), inference_datastructures_inference.$dtp_inference_answer_justification$.getGlobalValue(), Symbols.symbol_function(
        $sym73$CFASL_OUTPUT_OBJECT_INFERENCE_ANSWER_JUSTIFICATION_METHOD ) );
    return NIL;
  }
  ...
  static
  {
    ...
    $list14 = ConsesLow.list( ConsesLow.list( makeSymbol( "*CFASL-LOAD-PS-PROBLEM-TABLE*" ), makeKeyword( "UNINITIALIZED" ) ), ConsesLow.list( makeSymbol( "*CFASL-LOAD-PS-LINK-TABLE*" ), makeKeyword( "UNINITIALIZED" ) ),
        ConsesLow.list( makeSymbol( "*CFASL-LOAD-PS-PROOF-TABLE*" ), makeKeyword( "UNINITIALIZED" ) ) );
    ...
    $list26 = ConsesLow.list( makeSymbol( "CONSTANT-TABLE" ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $sym27$_CFASL_LOAD_PS_CONSTANT_TABLE_ = makeSymbol( "*CFASL-LOAD-PS-CONSTANT-TABLE*" );
    $list28 = ConsesLow.list( ConsesLow.list( makeSymbol( "*CFASL-CONSTANT-HANDLE-LOOKUP-FUNC*" ), ConsesLow.list( makeSymbol( "QUOTE" ), makeSymbol( "CFASL-LOAD-PS-LOOKUP-CONSTANT" ) ) ), ConsesLow.list( makeSymbol(
        "*CFASL-INPUT-GUID-STRING-RESOURCE*" ), ConsesLow.list( makeSymbol( "GUID-TO-STRING" ), ConsesLow.list( makeSymbol( "NEW-GUID" ) ) ) ) );
    ...
    $kw32$PROBLEM = makeKeyword( "PROBLEM" );
    $kw33$PROBLEM_LINK = makeKeyword( "PROBLEM-LINK" );
    $kw34$PROOF = makeKeyword( "PROOF" );
    $kw35$DONE = makeKeyword( "DONE" );
    $str36$Unexpected_section__S = makeString( "Unexpected section ~S" );
    $kw37$SKIP = makeKeyword( "SKIP" );
    ...
    $kw47$REMOVAL = makeKeyword( "REMOVAL" );
    $kw48$REWRITE = makeKeyword( "REWRITE" );
    $kw49$TRANSFORMATION = makeKeyword( "TRANSFORMATION" );
    $kw50$RESIDUAL_TRANSFORMATION = makeKeyword( "RESIDUAL-TRANSFORMATION" );
    $kw51$RESTRICTION = makeKeyword( "RESTRICTION" );
    $kw52$SPLIT = makeKeyword( "SPLIT" );
    $kw53$JOIN_ORDERED = makeKeyword( "JOIN-ORDERED" );
    $kw54$JOIN = makeKeyword( "JOIN" );
    $kw55$UNION = makeKeyword( "UNION" );
