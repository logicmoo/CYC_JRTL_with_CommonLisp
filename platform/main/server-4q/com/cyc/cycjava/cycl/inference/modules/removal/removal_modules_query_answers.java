...
import com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_query_answers;
...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_query_answers.*;
...
public final class removal_modules_query_answers extends SubLTranslatedFile {
    ...
    private static final SubLObject $$queryAnswers = reader_make_constant_shell(makeString("queryAnswers"));
    ...
    private static final SubLList $list4 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("queryAnswers")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("queryAnswers")), list(makeKeyword("AND"), makeKeyword("FULLY-BOUND"), list(makeKeyword("TEST"), makeSymbol("REMOVAL-CYCL-QUERY-SPECIFICATION-P")), list(makeKeyword("TEST"), makeSymbol("REMOVAL-ALLOWED-QUERY-ANSWERS-SENTENCE?"))), makeKeyword("ANYTHING")), makeKeyword("COST"), makeSymbol("REMOVAL-QUERY-ANSWERS-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("queryAnswers")), list(makeKeyword("BIND"), makeSymbol("QUERY-SPEC")), makeKeyword("ANYTHING")), list(list(makeKeyword("VALUE"), makeSymbol("QUERY-SPEC")))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("TUPLE"), list(makeSymbol("QUERY-SPEC")), list(makeKeyword("CALL"), makeSymbol("REMOVAL-QUERY-ANSWERS-ITERATE"), list(makeKeyword("VALUE"), makeSymbol("QUERY-SPEC")))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(reader_make_constant_shell(makeString("queryAnswers")), list(makeKeyword("VALUE"), makeSymbol("QUERY-SPEC")), makeKeyword("INPUT")), makeKeyword("DOCUMENTATION"), makeString("(#$queryAnswers <fully-bound> <anything>)\n    by recursively querying sentence and succeeding if the query returns the answer"), makeKeyword("EXAMPLE"), makeString("(#$queryAnswers (#$QueryFn (#$Quote (#$ist InferencePSC (#$isa ?X #$Dog)))) ?ANS)") });
    ...
    private static final SubLObject $$CycInferenceAnswerJustificationFn = reader_make_constant_shell(makeString("CycInferenceAnswerJustificationFn"));

    private static final SubLList $list13 = list(makeSymbol("MODULE"), makeSymbol("SENTENCE"), makeSymbol("MT"), makeSymbol("TV"));

    private static final SubLObject $$CycHLSupportFn = reader_make_constant_shell(makeString("CycHLSupportFn"));

    private static final SubLObject $$CycInferenceAnswerFn = reader_make_constant_shell(makeString("CycInferenceAnswerFn"));

    private static final SubLObject $const16$inferenceAnswerBindingsAndJustifi = reader_make_constant_shell(makeString("inferenceAnswerBindingsAndJustifications"));
    ...
    private static final SubLList $list18 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("inferenceAnswerBindingsAndJustifications")), makeKeyword("REQUIRED-PATTERN"), listS(reader_make_constant_shell(makeString("inferenceAnswerBindingsAndJustifications")), cons(reader_make_constant_shell(makeString("CycInferenceAnswerFn")), makeKeyword("FULLY-BOUND")), makeKeyword("ANYTHING")), makeKeyword("COST-EXPRESSION"), ONE_INTEGER, makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("inferenceAnswerBindingsAndJustifications")), list(makeKeyword("BIND"), makeSymbol("ANSWER-FN")), makeKeyword("ANYTHING"), makeKeyword("ANYTHING")), list(makeKeyword("VALUE"), makeSymbol("ANSWER-FN"))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("CycInferenceAnswerFn")), list(makeKeyword("BIND"), makeSymbol("BINDING-SET")), list(makeKeyword("BIND"), makeSymbol("JUSTIFICATION-SET"))), list(list(makeKeyword("VALUE"), makeSymbol("BINDING-SET")), list(makeKeyword("VALUE"), makeSymbol("JUSTIFICATION-SET")))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(makeKeyword("TEMPLATE"), list(list(makeKeyword("BIND"), makeSymbol("BINDING-SET")), list(makeKeyword("BIND"), makeSymbol("JUSTIFICATION-SET"))), list(reader_make_constant_shell(makeString("inferenceAnswerBindingsAndJustifications")), list(makeKeyword("VALUE"), makeSymbol("ANSWER-FN")), list(makeKeyword("VALUE"), makeSymbol("BINDING-SET")), list(makeKeyword("VALUE"), makeSymbol("JUSTIFICATION-SET")))), makeKeyword("DOCUMENTATION"), makeString("(#$inferenceAnswerBindingsAndJustifications <fully-bound> <anything> <anything>)"), makeKeyword("EXAMPLE"), makeString("(#$inferenceAnswerBindingsAndJustifications \n      (#$CycInferenceAnswerFn (#$TheSet (#$ELInferenceBindingFn ?DOG #$Muffet)) TheEmptySet) \n      ?BIND ?JUST)") });

    private static final SubLObject $$queryBindings = reader_make_constant_shell(makeString("queryBindings"));

    private static final SubLSymbol $REMOVAL_QUERY_BINDINGS = makeKeyword("REMOVAL-QUERY-BINDINGS");

    private static final SubLList $list21 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("queryBindings")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("queryBindings")), list(makeKeyword("AND"), makeKeyword("FULLY-BOUND"), list(makeKeyword("TEST"), makeSymbol("REMOVAL-CYCL-QUERY-SPECIFICATION-P")), list(makeKeyword("TEST"), makeSymbol("REMOVAL-ALLOWED-QUERY-BINDINGS-SENTENCE?"))), makeKeyword("ANYTHING")), makeKeyword("COST"), makeSymbol("REMOVAL-QUERY-BINDINGS-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("queryBindings")), list(makeKeyword("BIND"), makeSymbol("QUERY-SPEC")), makeKeyword("ANYTHING")), list(list(makeKeyword("VALUE"), makeSymbol("QUERY-SPEC")))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("TUPLE"), list(makeSymbol("QUERY-SPEC")), list(makeKeyword("CALL"), makeSymbol("REMOVAL-QUERY-BINDINGS-ITERATE"), list(makeKeyword("VALUE"), makeSymbol("QUERY-SPEC")))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(reader_make_constant_shell(makeString("queryBindings")), list(makeKeyword("VALUE"), makeSymbol("QUERY-SPEC")), makeKeyword("INPUT")), makeKeyword("DOCUMENTATION"), makeString("(#$queryBindings <fully-bound> <anything>)\n    by recursively querying sentence and succeeding if the query returns the answer"), makeKeyword("EXAMPLE"), makeString("(#$queryBindings (#$QueryFn (#$Quote (#$ist InferencePSC (#$isa ?X #$Dog)))) ?BINDINGS)") });

    private static final SubLObject $$queryVariable = reader_make_constant_shell(makeString("queryVariable"));

    private static final SubLSymbol $REMOVAL_QUERY_VARIABLE = makeKeyword("REMOVAL-QUERY-VARIABLE");

    private static final SubLList $list24 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("queryVariable")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("queryVariable")), list(makeKeyword("AND"), makeKeyword("FULLY-BOUND"), list(makeKeyword("TEST"), makeSymbol("REMOVAL-CYCL-QUERY-SPECIFICATION-P")), list(makeKeyword("TEST"), makeSymbol("REMOVAL-ALLOWED-QUERY-VARIABLE-SENTENCE?"))), makeKeyword("ANYTHING")), makeKeyword("COST"), makeSymbol("REMOVAL-QUERY-VARIABLE-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("INPUT-EXTRACT-PATTERN"), list(makeKeyword("TEMPLATE"), list(reader_make_constant_shell(makeString("queryVariable")), list(makeKeyword("BIND"), makeSymbol("QUERY-SPEC")), makeKeyword("ANYTHING")), list(list(makeKeyword("VALUE"), makeSymbol("QUERY-SPEC")))), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("TUPLE"), list(makeSymbol("QUERY-SPEC")), list(makeKeyword("CALL"), makeSymbol("REMOVAL-QUERY-VARIABLE-ITERATE"), list(makeKeyword("VALUE"), makeSymbol("QUERY-SPEC")))), makeKeyword("OUTPUT-CONSTRUCT-PATTERN"), list(reader_make_constant_shell(makeString("queryVariable")), list(makeKeyword("VALUE"), makeSymbol("QUERY-SPEC")), makeKeyword("INPUT")), makeKeyword("DOCUMENTATION"), makeString("(#$queryVariable <fully-bound> <anything>)\n    by recursively querying sentence and succeeding if the query returns the answer"), makeKeyword("EXAMPLE"), makeString("(#$queryVariable (#$QueryFn (#$Quote (#$ist InferencePSC (#$isa ?X #$Dog)))) ?SET)") });

    private static final SubLObject $$justification_Partial = reader_make_constant_shell(makeString("justification-Partial"));

    private static final SubLSymbol $REMOVAL_JUSTIFICATION_PARTIAL = makeKeyword("REMOVAL-JUSTIFICATION-PARTIAL");

    private static final SubLList $list27 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("justification-Partial")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("justification-Partial")), makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*EXPENSIVE-HL-MODULE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-JUSTIFICATION-PARTIAL-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$justification-Partial <fully-bound> <fully-bound>)\n    by recursively querying ASKABLE-SENTENCE and succeeding if the answer justifications contain the JUSTIFICATION-SENTENCE"), makeKeyword("EXAMPLE"), makeString("(#$justification-Partial (#$genls #$Dog #$Animal) (#$genls #$Dog #$CanisGenus))") });
    ...
    private static final SubLObject $$firstInListSatisfying = reader_make_constant_shell(makeString("firstInListSatisfying"));



    private static final SubLList $list40 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("firstInListSatisfying")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("firstInListSatisfying")), makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND"), makeKeyword("ANYTHING")), makeKeyword("COST-EXPRESSION"), makeSymbol("*EXPENSIVE-HL-MODULE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("INCOMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-FIRSTINLISTSATISFYING-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$firstInListSatisfying <fully-bound-p> <fully-bound-p> <anything>)"), makeKeyword("EXAMPLE"), makeString("(#$firstInListSatisfying\n  (#$TheList 1 2 3 4 5 6)\n  (#$Kappa (?INPUT)\n    (#$greaterThan ?INPUT 4))\n  ?WHAT)") });
    ...
    private static final SubLList $list51 = list(list(list(list(reader_make_constant_shell(makeString("firstInListSatisfying")), list(reader_make_constant_shell(makeString("TheList")), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER), list(reader_make_constant_shell(makeString("Kappa")), list(makeSymbol("?INPUT")), list(reader_make_constant_shell(makeString("greaterThan")), makeSymbol("?INPUT"), FOUR_INTEGER)), makeSymbol("?WHAT"))), NIL), list(list(list(reader_make_constant_shell(makeString("firstInListSatisfying")), list(reader_make_constant_shell(makeString("TheList")), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER), list(reader_make_constant_shell(makeString("Kappa")), list(makeSymbol("?INPUT")), list(reader_make_constant_shell(makeString("greaterThan")), makeSymbol("?INPUT"), FOUR_INTEGER)), FOUR_INTEGER)), NIL), list(list(list(reader_make_constant_shell(makeString("firstInListSatisfying")), list(reader_make_constant_shell(makeString("TheList")), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER, FIVE_INTEGER, SIX_INTEGER), list(reader_make_constant_shell(makeString("Kappa")), list(makeSymbol("?INPUT")), list(reader_make_constant_shell(makeString("greaterThan")), makeSymbol("?INPUT"), FOUR_INTEGER)), makeSymbol("?WHAT"))), list(FIVE_INTEGER)), list(list(list(reader_make_constant_shell(makeString("firstInListSatisfying")), list(reader_make_constant_shell(makeString("TheList")), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER, FIVE_INTEGER, SIX_INTEGER), list(reader_make_constant_shell(makeString("Kappa")), list(makeSymbol("?INPUT")), list(reader_make_constant_shell(makeString("greaterThan")), makeSymbol("?INPUT"), FOUR_INTEGER)), FIVE_INTEGER)), T), list(list(list(reader_make_constant_shell(makeString("firstInListSatisfying")), list(reader_make_constant_shell(makeString("TheList")), list(reader_make_constant_shell(makeString("MathExpressionFn")), list(reader_make_constant_shell(makeString("MathVarFn")), makeString("X")), reader_make_constant_shell(makeString("InfixPlusFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), FIVE_INTEGER)), list(reader_make_constant_shell(makeString("MathExpressionFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), FIVE_INTEGER), reader_make_constant_shell(makeString("InfixTimesFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), SEVEN_INTEGER)), list(reader_make_constant_shell(makeString("MathExpressionFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), SEVEN_INTEGER), reader_make_constant_shell(makeString("InfixMinusFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), THREE_INTEGER))), list(reader_make_constant_shell(makeString("Kappa")), list(makeSymbol("?FOO")), list(reader_make_constant_shell(makeString("thereExists")), makeSymbol("?VAR"), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("mathExpressionNthOperand")), makeSymbol("?FOO"), ONE_INTEGER, makeSymbol("?VAR")), list(reader_make_constant_shell(makeString("isa")), makeSymbol("?VAR"), reader_make_constant_shell(makeString("MathematicalVariable")))))), list(reader_make_constant_shell(makeString("MathExpressionFn")), list(reader_make_constant_shell(makeString("MathVarFn")), makeString("X")), reader_make_constant_shell(makeString("InfixPlusFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), FIVE_INTEGER)))), T), list(list(list(reader_make_constant_shell(makeString("firstInListSatisfying")), list(reader_make_constant_shell(makeString("TheList")), list(reader_make_constant_shell(makeString("MathExpressionFn")), list(reader_make_constant_shell(makeString("MathVarFn")), makeString("X")), reader_make_constant_shell(makeString("InfixPlusFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), FIVE_INTEGER)), list(reader_make_constant_shell(makeString("MathExpressionFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), FIVE_INTEGER), reader_make_constant_shell(makeString("InfixTimesFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), SEVEN_INTEGER)), list(reader_make_constant_shell(makeString("MathExpressionFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), SEVEN_INTEGER), reader_make_constant_shell(makeString("InfixMinusFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), THREE_INTEGER))), list(reader_make_constant_shell(makeString("Kappa")), list(makeSymbol("?FOO")), list(reader_make_constant_shell(makeString("thereExists")), makeSymbol("?VAR"), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("mathExpressionNthOperand")), makeSymbol("?FOO"), ONE_INTEGER, makeSymbol("?VAR")), list(reader_make_constant_shell(makeString("isa")), makeSymbol("?VAR"), reader_make_constant_shell(makeString("MathematicalVariable")))))), makeSymbol("?WHAT"))), list(list(reader_make_constant_shell(makeString("MathExpressionFn")), list(reader_make_constant_shell(makeString("MathVarFn")), makeString("X")), reader_make_constant_shell(makeString("InfixPlusFn")), list(reader_make_constant_shell(makeString("MathQuantFn")), FIVE_INTEGER)))), list(list(list(reader_make_constant_shell(makeString("firstInListSatisfying")), list(reader_make_constant_shell(makeString("TheList")), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER), list(reader_make_constant_shell(makeString("Kappa")), list(makeSymbol("?INPUT")), list(reader_make_constant_shell(makeString("greaterThan")), makeSymbol("?INPUT"), ZERO_INTEGER)), FOUR_INTEGER)), NIL));
    ...
    public static SubLObject declare_removal_modules_query_answers_file() {
        declareFunction(me, "removal_cycl_query_specification_p", "REMOVAL-CYCL-QUERY-SPECIFICATION-P", 1, 0, false);
        declareFunction(me, "removal_allowed_query_answers_sentenceP", "REMOVAL-ALLOWED-QUERY-ANSWERS-SENTENCE?", 1, 0, false);
        declareFunction(me, "removal_query_answers_cost", "REMOVAL-QUERY-ANSWERS-COST", 1, 0, false);
        declareFunction(me, "removal_query_answers_iterate", "REMOVAL-QUERY-ANSWERS-ITERATE", 1, 0, false);
        declareFunction(me, "removal_create_inference_answer_fns", "REMOVAL-CREATE-INFERENCE-ANSWER-FNS", 2, 0, false);
        declareFunction(me, "removal_create_inference_answer_fn_from_answers", "REMOVAL-CREATE-INFERENCE-ANSWER-FN-FROM-ANSWERS", 1, 0, false);
        declareFunction(me, "removal_create_inference_answer_fn_from_bindings", "REMOVAL-CREATE-INFERENCE-ANSWER-FN-FROM-BINDINGS", 1, 0, false);
        declareFunction(me, "removal_create_inference_answer_fn_from_supports", "REMOVAL-CREATE-INFERENCE-ANSWER-FN-FROM-SUPPORTS", 1, 0, false);
        declareFunction(me, "removal_create_inference_answer_fn_from_bindings_and_supports", "REMOVAL-CREATE-INFERENCE-ANSWER-FN-FROM-BINDINGS-AND-SUPPORTS", 1, 0, false);
        declareFunction(me, "removal_create_inference_answer_fn_from_bindings_and_hypothetical_bindings", "REMOVAL-CREATE-INFERENCE-ANSWER-FN-FROM-BINDINGS-AND-HYPOTHETICAL-BINDINGS", 1, 0, false);
        declareFunction(me, "removal_justification_fns", "REMOVAL-JUSTIFICATION-FNS", 1, 0, false);
        declareFunction(me, "removal_justification_fns_from_supports", "REMOVAL-JUSTIFICATION-FNS-FROM-SUPPORTS", 1, 0, false);
        declareFunction(me, "removal_create_justification_fn", "REMOVAL-CREATE-JUSTIFICATION-FN", 1, 0, false);
        declareFunction(me, "removal_support_datastructures", "REMOVAL-SUPPORT-DATASTRUCTURES", 1, 0, false);
        declareFunction(me, "removal_create_cycl_hl_support_fn", "REMOVAL-CREATE-CYCL-HL-SUPPORT-FN", 1, 0, false);
        declareFunction(me, "removal_create_inference_answer_fn", "REMOVAL-CREATE-INFERENCE-ANSWER-FN", 2, 0, false);
        declareFunction(me, "query_answers_kbq_run_query", "QUERY-ANSWERS-KBQ-RUN-QUERY", 1, 0, false);
        declareFunction(me, "removal_allowed_query_bindings_sentenceP", "REMOVAL-ALLOWED-QUERY-BINDINGS-SENTENCE?", 1, 0, false);
        declareFunction(me, "removal_query_bindings_cost", "REMOVAL-QUERY-BINDINGS-COST", 1, 0, false);
        declareFunction(me, "removal_query_bindings_iterate", "REMOVAL-QUERY-BINDINGS-ITERATE", 1, 0, false);
        declareFunction(me, "removal_create_el_bindings_sets", "REMOVAL-CREATE-EL-BINDINGS-SETS", 2, 0, false);
        declareFunction(me, "removal_allowed_query_variable_sentenceP", "REMOVAL-ALLOWED-QUERY-VARIABLE-SENTENCE?", 1, 0, false);
        declareFunction(me, "removal_query_variable_cost", "REMOVAL-QUERY-VARIABLE-COST", 1, 0, false);
        declareFunction(me, "removal_query_variable_iterate", "REMOVAL-QUERY-VARIABLE-ITERATE", 1, 0, false);
        declareFunction(me, "removal_create_set_of_variable_bindings", "REMOVAL-CREATE-SET-OF-VARIABLE-BINDINGS", 2, 0, false);
        declareFunction(me, "removal_query_variable_binding", "REMOVAL-QUERY-VARIABLE-BINDING", 1, 0, false);
        declareFunction(me, "removal_justification_partial_expand", "REMOVAL-JUSTIFICATION-PARTIAL-EXPAND", 1, 1, false);
        declareFunction(me, "entails_elP", "ENTAILS-EL?", 2, 0, false);
        declareFunction(me, "inference_justification_partial_recursive_inference", "INFERENCE-JUSTIFICATION-PARTIAL-RECURSIVE-INFERENCE", 3, 0, false);
        declareFunction(me, "inference_justification_partial_recursive_inference_one_more_justification", "INFERENCE-JUSTIFICATION-PARTIAL-RECURSIVE-INFERENCE-ONE-MORE-JUSTIFICATION", 2, 0, false);
        declareFunction(me, "inference_justification_partial_recursive_query_properties_initial", "INFERENCE-JUSTIFICATION-PARTIAL-RECURSIVE-QUERY-PROPERTIES-INITIAL", 1, 1, false);
        declareFunction(me, "inference_justification_partial_recursive_query_properties_continued", "INFERENCE-JUSTIFICATION-PARTIAL-RECURSIVE-QUERY-PROPERTIES-CONTINUED", 1, 1, false);
        declareFunction(me, "removal_firstinlistsatisfying_expand", "REMOVAL-FIRSTINLISTSATISFYING-EXPAND", 1, 1, false);
        declareFunction(me, "test_removal_firstinlistsatisfying_expand", "TEST-REMOVAL-FIRSTINLISTSATISFYING-EXPAND", 1, 2, false);
        return NIL;
    }
