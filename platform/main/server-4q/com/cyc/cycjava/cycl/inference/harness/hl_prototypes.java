...
import static com.cyc.cycjava.cycl.inference.harness.hl_prototypes.*;
...
public final class hl_prototypes extends SubLTranslatedFile {
    ...
    private static final SubLList $list7 = list(reader_make_constant_shell(makeString("HLPrototypicalTerm")));
    ...
    private static final SubLList $list29 = list(reader_make_constant_shell(makeString("Individual")));
    ...
    private static final SubLList $list33 = list(reader_make_constant_shell(makeString("Person")));
    ...
    public static SubLObject declare_hl_prototypes_file() {
        declareFunction(me, "hl_prototypes_enabledP", "HL-PROTOTYPES-ENABLED?", 0, 0, false);
        declareFunction(me, "hl_prototype_allowed_forward_rules", "HL-PROTOTYPE-ALLOWED-FORWARD-RULES", 1, 0, false);
        declareFunction(me, "hl_prototype_forbidden_forward_rules", "HL-PROTOTYPE-FORBIDDEN-FORWARD-RULES", 1, 0, false);
        declareFunction(me, "hl_prototypical_instance_after_adding", "HL-PROTOTYPICAL-INSTANCE-AFTER-ADDING", 2, 0, false);
        declareFunction(me, "hl_prototypical_instance_after_removing", "HL-PROTOTYPICAL-INSTANCE-AFTER-REMOVING", 2, 0, false);
        declareFunction(me, "clear_the_hl_prototype_ke_irrelevant_rule", "CLEAR-THE-HL-PROTOTYPE-KE-IRRELEVANT-RULE", 0, 0, false);
        declareFunction(me, "remove_the_hl_prototype_ke_irrelevant_rule", "REMOVE-THE-HL-PROTOTYPE-KE-IRRELEVANT-RULE", 0, 0, false);
        declareFunction(me, "the_hl_prototype_ke_irrelevant_rule_internal", "THE-HL-PROTOTYPE-KE-IRRELEVANT-RULE-INTERNAL", 0, 0, false);
        declareFunction(me, "the_hl_prototype_ke_irrelevant_rule", "THE-HL-PROTOTYPE-KE-IRRELEVANT-RULE", 0, 0, false);
        declareFunction(me, "relevant_hl_prototype_rules", "RELEVANT-HL-PROTOTYPE-RULES", 1, 0, false);
        declareFunction(me, "clear_hl_prototype_caches", "CLEAR-HL-PROTOTYPE-CACHES", 0, 0, false);
        declareFunction(me, "possibly_hl_prototype_assertionP", "POSSIBLY-HL-PROTOTYPE-ASSERTION?", 1, 0, false);
        declareFunction(me, "find_or_create_hl_prototypical_instance", "FIND-OR-CREATE-HL-PROTOTYPICAL-INSTANCE", 1, 1, false);
        declareFunction(me, "hl_prototypical_instance", "HL-PROTOTYPICAL-INSTANCE", 1, 0, false);
        declareFunction(me, "create_hl_prototypical_instance", "CREATE-HL-PROTOTYPICAL-INSTANCE", 1, 1, false);
        declareFunction(me, "hl_prototypical_instance_name", "HL-PROTOTYPICAL-INSTANCE-NAME", 1, 0, false);
        declareFunction(me, "hl_prototype_collections", "HL-PROTOTYPE-COLLECTIONS", 0, 0, false);
        declareFunction(me, "hl_prototypical_collection", "HL-PROTOTYPICAL-COLLECTION", 1, 0, false);
        declareFunction(me, "hl_prototypical_instanceP", "HL-PROTOTYPICAL-INSTANCE?", 1, 0, false);
        declareFunction(me, "show_hl_prototype_statistics", "SHOW-HL-PROTOTYPE-STATISTICS", 0, 0, false);
        declareFunction(me, "clear_hl_prototype_statistics", "CLEAR-HL-PROTOTYPE-STATISTICS", 0, 0, false);
        declareFunction(me, "create_hl_prototypical_instances_for_common_collections", "CREATE-HL-PROTOTYPICAL-INSTANCES-FOR-COMMON-COLLECTIONS", 1, 1, false);
        declareFunction(me, "n_most_useful_hl_prototype_collections", "N-MOST-USEFUL-HL-PROTOTYPE-COLLECTIONS", 1, 1, false);
        declareFunction(me, "most_useful_hl_prototypical_instances_dict", "MOST-USEFUL-HL-PROTOTYPICAL-INSTANCES-DICT", 0, 0, false);
        declareFunction(me, "likely_first_asserted_isa_col", "LIKELY-FIRST-ASSERTED-ISA-COL", 1, 0, false);
        declareFunction(me, "likely_first_asserted_isa_gaf", "LIKELY-FIRST-ASSERTED-ISA-GAF", 1, 0, false);
        declareFunction(me, "hl_prototype_benchmark_1", "HL-PROTOTYPE-BENCHMARK-1", 0, 1, false);
        declareFunction(me, "hl_prototype_benchmark_2", "HL-PROTOTYPE-BENCHMARK-2", 0, 1, false);
        declareFunction(me, "hl_prototype_benchmark_3", "HL-PROTOTYPE-BENCHMARK-3", 0, 1, false);
        return NIL;
    }
