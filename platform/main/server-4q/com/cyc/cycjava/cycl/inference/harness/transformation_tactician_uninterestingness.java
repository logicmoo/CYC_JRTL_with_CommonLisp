...
public class transformation_tactician_uninterestingness extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.harness.transformation_tactician_uninterestingness";
    ...
    public static SubLObject declare_transformation_tactician_uninterestingness_file() {
        declareFunction(myName, "transformation_strategy_set_aside_non_continuable_implies_throw_away_tacticP", "TRANSFORMATION-STRATEGY-SET-ASIDE-NON-CONTINUABLE-IMPLIES-THROW-AWAY-TACTIC?", 1, 0, false);
        declareFunction(myName, "transformation_strategy_set_aside_non_continuable_implies_throw_away_problemP", "TRANSFORMATION-STRATEGY-SET-ASIDE-NON-CONTINUABLE-IMPLIES-THROW-AWAY-PROBLEM?", 1, 0, false);
        declareFunction(myName, "transformation_strategy_why_problem_already_thrown_awayP", "TRANSFORMATION-STRATEGY-WHY-PROBLEM-ALREADY-THROWN-AWAY?", 2, 0, false);
        declareFunction(myName, "rederive_why_transformation_strategy_chooses_to_throw_away_problemP", "REDERIVE-WHY-TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-PROBLEM?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_problemP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-PROBLEM?", 2, 1, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_problem_uncacheableP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-PROBLEM-UNCACHEABLE?", 3, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_problem_cacheableP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-PROBLEM-CACHEABLE?", 3, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_strategemP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-STRATEGEM?", 2, 1, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_tacticP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-TACTIC?", 2, 2, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_tactic_uncacheableP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-TACTIC-UNCACHEABLE?", 4, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_tactic_cacheableP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-TACTIC-CACHEABLE?", 4, 0, false);
        ...
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_linkP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-LINK?", 2, 1, false);
        declareFunction(myName, "transformation_strategy_chooses_to_set_aside_problemP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-SET-ASIDE-PROBLEM?", 2, 2, false);
        declareFunction(myName, "transformation_strategy_chooses_to_set_aside_problem_uncacheableP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-SET-ASIDE-PROBLEM-UNCACHEABLE?", 4, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_set_aside_problem_cacheableP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-SET-ASIDE-PROBLEM-CACHEABLE?", 4, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_set_aside_strategemP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-SET-ASIDE-STRATEGEM?", 2, 2, false);
        declareFunction(myName, "transformation_strategy_chooses_to_set_aside_tacticP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-SET-ASIDE-TACTIC?", 2, 3, false);
        declareFunction(myName, "transformation_strategy_chooses_to_set_aside_tactic_uncacheableP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-SET-ASIDE-TACTIC-UNCACHEABLE?", 5, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_set_aside_tactic_cacheableP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-SET-ASIDE-TACTIC-CACHEABLE?", 5, 0, false);
        declareFunction(myName, "transformation_strategy_transformation_tactic_generated_enoughP", "TRANSFORMATION-STRATEGY-TRANSFORMATION-TACTIC-GENERATED-ENOUGH?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_set_aside_linkP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-SET-ASIDE-LINK?", 2, 2, false);
        declareFunction(myName, "transformation_strategy_chooses_to_ignore_problemP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-IGNORE-PROBLEM?", 2, 0, false);
        declareFunction(myName, "why_transformation_strategy_chooses_to_ignore_problem", "WHY-TRANSFORMATION-STRATEGY-CHOOSES-TO-IGNORE-PROBLEM", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_ignore_strategemP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-IGNORE-STRATEGEM?", 2, 0, false);
        declareFunction(myName, "why_transformation_strategy_chooses_to_ignore_strategem", "WHY-TRANSFORMATION-STRATEGY-CHOOSES-TO-IGNORE-STRATEGEM", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_ignore_tacticP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-IGNORE-TACTIC?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_ignore_linkP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-IGNORE-LINK?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_all_tacticsP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-ALL-TACTICS?", 2, 1, false);
        declareFunction(myName, "transformation_strategy_chooses_to_set_aside_all_tacticsP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-SET-ASIDE-ALL-TACTICS?", 2, 1, false);
        declareFunction(myName, "transformation_strategy_chooses_to_totally_set_aside_tacticP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-TOTALLY-SET-ASIDE-TACTIC?", 2, 2, false);
        declareFunction(myName, "transformation_strategy_chooses_to_totally_throw_away_tacticP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-TOTALLY-THROW-AWAY-TACTIC?", 2, 2, false);
        declareFunction(myName, "transformation_strategy_chooses_to_totally_ignore_tacticP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-TOTALLY-IGNORE-TACTIC?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_tactic_hl_moduleP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-TACTIC-HL-MODULE?", 2, 0, false);
        ...
        declareFunction(myName, "transformation_strategy_preferred_backchain_required_join_ordered_tactic", "TRANSFORMATION-STRATEGY-PREFERRED-BACKCHAIN-REQUIRED-JOIN-ORDERED-TACTIC", 2, 0, false);
        declareFunction(myName, "transformation_strategy_total_transformation_productivity", "TRANSFORMATION-STRATEGY-TOTAL-TRANSFORMATION-PRODUCTIVITY", 2, 0, false);
        declareFunction(myName, "transformation_strategy_problem_thrown_awayP", "TRANSFORMATION-STRATEGY-PROBLEM-THROWN-AWAY?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_tactic_thrown_awayP", "TRANSFORMATION-STRATEGY-TACTIC-THROWN-AWAY?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_tactic_set_asideP", "TRANSFORMATION-STRATEGY-TACTIC-SET-ASIDE?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_tactic_lookahead_problemP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-TACTIC-LOOKAHEAD-PROBLEM?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_throw_away_lookahead_problemP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-THROW-AWAY-LOOKAHEAD-PROBLEM?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_not_to_activate_any_strategems_on_problemP", "TRANSFORMATION-STRATEGY-CHOOSES-NOT-TO-ACTIVATE-ANY-STRATEGEMS-ON-PROBLEM?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_set_aside_tactic_lookahead_problemP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-SET-ASIDE-TACTIC-LOOKAHEAD-PROBLEM?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_throw_away_uninteresting_set_asides", "TRANSFORMATION-STRATEGY-THROW-AWAY-UNINTERESTING-SET-ASIDES", 1, 0, false);
        declareFunction(myName, "transformation_strategy_throw_away_uninteresting_set_asides_int", "TRANSFORMATION-STRATEGY-THROW-AWAY-UNINTERESTING-SET-ASIDES-INT", 1, 0, false);
        declareFunction(myName, "transformation_strategy_chooses_to_leave_problem_set_asideP", "TRANSFORMATION-STRATEGY-CHOOSES-TO-LEAVE-PROBLEM-SET-ASIDE?", 2, 0, false);
        declareFunction(myName, "transformation_strategy_reconsider_set_asides", "TRANSFORMATION-STRATEGY-RECONSIDER-SET-ASIDES", 1, 0, false);
        declareFunction(myName, "transformation_strategy_set_aside_problems_to_reconsider", "TRANSFORMATION-STRATEGY-SET-ASIDE-PROBLEMS-TO-RECONSIDER", 1, 0, false);
        declareFunction(myName, "transformation_strategy_reconsider_one_set_aside", "TRANSFORMATION-STRATEGY-RECONSIDER-ONE-SET-ASIDE", 2, 0, false);
        return NIL;
    }
