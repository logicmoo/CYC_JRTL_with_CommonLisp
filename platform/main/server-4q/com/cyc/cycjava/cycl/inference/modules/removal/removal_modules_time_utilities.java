...
import com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_time_utilities;
...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_time_utilities.*;
...
public final class removal_modules_time_utilities extends SubLTranslatedFile {
    ...
    public static final SubLList $list1 = list(new SubLObject[]{ makeKeyword("EVERY-PREDICATES"), list(reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("temporallySubsumes"))), makeKeyword("APPLICABILITY"), makeSymbol("REMOVAL-SUB-TIME-INTERVAL-OF-TYPE-APPLICABILITY"), makeKeyword("COST"), makeSymbol("REMOVAL-SUB-TIME-INTERVAL-OF-TYPE-COST"), makeKeyword("COMPLETENESS"), makeKeyword("INCOMPLETE"), makeKeyword("EXPAND-ITERATIVE-PATTERN"), list(makeKeyword("CALL"), makeSymbol("REMOVAL-SUB-TIME-INTERVAL-OF-TYPE-OUTPUT-GENERATE"), makeKeyword("INPUT")), makeKeyword("DOCUMENTATION"), makeString("(#$and (#$isa <varN> <time-type>)\n           (#$temporallySubsumes <time-interval> <varN>))"), makeKeyword("EXAMPLE"), makeString("(#$and (#$isa ?MONTH #$CalendarWeek)\n           (#$temporallySubsumes (#$MonthFn #$May (#$YearFn 2005)) ?MONTH))") });

    public static final SubLList $list2 = list(makeSymbol("MT"), makeSymbol("ASENT"));

    private static final SubLObject $$isa = reader_make_constant_shell(makeString("isa"));

    public static final SubLList $list4 = list(makeSymbol("VAR"), makeSymbol("TYPE"));

    private static final SubLObject $$TimeParameter = reader_make_constant_shell(makeString("TimeParameter"));

    public static final SubLList $list6 = list(makeSymbol("MT1"), makeSymbol("ASENT1"));

    private static final SubLObject $$temporallySubsumes = reader_make_constant_shell(makeString("temporallySubsumes"));

    public static final SubLList $list8 = list(makeSymbol("INTERVAL1"), makeSymbol("VAR1"));

    public static final SubLSymbol $sym9$_ = makeSymbol("<");

    public static final SubLList $list10 = list(makeSymbol("ISA-MT"), makeSymbol("ISA-ASENT"));

    public static final SubLList $list11 = list(makeSymbol("TEMP-MT"), makeSymbol("TEMP-ASENT"));



    public static final SubLSymbol SUB_TIME_INTERVAL_OF_TYPE_ITERATOR_DONE = makeSymbol("SUB-TIME-INTERVAL-OF-TYPE-ITERATOR-DONE");

    public static final SubLSymbol SUB_TIME_INTERVAL_OF_TYPE_ITERATOR_NEXT = makeSymbol("SUB-TIME-INTERVAL-OF-TYPE-ITERATOR-NEXT");

    public static final SubLSymbol SUB_TIME_INTERVAL_OF_TYPE_ITERATOR_FINALIZE = makeSymbol("SUB-TIME-INTERVAL-OF-TYPE-ITERATOR-FINALIZE");

    public static final SubLList $list16 = list(makeSymbol("MT0"), makeSymbol("ASENT0"));
    ...
    public static final SubLList $list21 = list(makeSymbol("INDEX"), makeSymbol("DIRECTION"), makeSymbol("TYPE"), makeSymbol("INTERVAL"), makeSymbol("VAR"), makeSymbol("JUST-TEMPLATE"));

    private static final SubLObject $$startingDay = reader_make_constant_shell(makeString("startingDay"));

    private static final SubLSymbol $REMOVAL_STARTING_DAY_CHECK_POS = makeKeyword("REMOVAL-STARTING-DAY-CHECK-POS");

    private static final SubLList $list24 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("startingDay")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("startingDay")), list(makeKeyword("TEST"), makeSymbol("DATE-INTERVAL-P")), makeKeyword("FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*CHEAP-HL-MODULE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-STARTING-DAY-CHECK-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$startingDay <time-interval> <day>)"), makeKeyword("EXAMPLE"), makeString("(#$startingDay (#$YearFn 2002) (#$DayFn 1 (#$MonthFn #$January (#$YearFn 2002))))") });

    private static final SubLSymbol $REMOVAL_STARTING_DAY_CHECK_NEG = makeKeyword("REMOVAL-STARTING-DAY-CHECK-NEG");

    private static final SubLList $list26 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("startingDay")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("startingDay")), list(makeKeyword("TEST"), makeSymbol("DATE-INTERVAL-P")), makeKeyword("FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*CHEAP-HL-MODULE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-STARTING-DAY-CHECK-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not (#$startingDay <time-interval> <day>))"), makeKeyword("EXAMPLE"), makeString("(#$not (#$startingDay (#$YearFn 2002) (#$DayFn 1 (#$MonthFn #$January (#$YearFn 2002)))))") });

    private static final SubLSymbol $REMOVAL_STARTING_DAY_POS = makeKeyword("REMOVAL-STARTING-DAY-POS");

    private static final SubLList $list28 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("startingDay")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("startingDay")), list(makeKeyword("TEST"), makeSymbol("DATE-INTERVAL-P")), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*CHEAP-HL-MODULE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-STARTING-DAY-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$startingDay <time-interval> ?DAY)"), makeKeyword("EXAMPLE"), makeString("(#$startingDay (#$YearFn 2002) ?DAY) -> (#$DayFn 1 (#$MonthFn #$January (#$YearFn 2002)))") });
    ...
    private static final SubLObject $$endingDay = reader_make_constant_shell(makeString("endingDay"));

    private static final SubLSymbol $REMOVAL_ENDING_DAY_CHECK_POS = makeKeyword("REMOVAL-ENDING-DAY-CHECK-POS");

    private static final SubLList $list36 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("endingDay")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("endingDay")), list(makeKeyword("TEST"), makeSymbol("DATE-INTERVAL-P")), makeKeyword("FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*CHEAP-HL-MODULE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-ENDING-DAY-CHECK-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$endingDay <time-interval> <day>)"), makeKeyword("EXAMPLE"), makeString("(#$endingDay (#$YearFn 2002) (#$DayFn 31 (#$MonthFn #$December (#$YearFn 2002))))") });

    private static final SubLSymbol $REMOVAL_ENDING_DAY_CHECK_NEG = makeKeyword("REMOVAL-ENDING-DAY-CHECK-NEG");

    private static final SubLList $list38 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("endingDay")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("endingDay")), list(makeKeyword("TEST"), makeSymbol("DATE-INTERVAL-P")), makeKeyword("FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*CHEAP-HL-MODULE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-ENDING-DAY-CHECK-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not (#$endingDay <time-interval> <day>))"), makeKeyword("EXAMPLE"), makeString("(#$not (#$endingDay (#$YearFn 2002) (#$DayFn 1 (#$MonthFn #$January (#$YearFn 2002))))") });

    private static final SubLSymbol $REMOVAL_ENDING_DAY_POS = makeKeyword("REMOVAL-ENDING-DAY-POS");

    private static final SubLList $list40 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("endingDay")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("endingDay")), list(makeKeyword("TEST"), makeSymbol("DATE-INTERVAL-P")), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("COST-EXPRESSION"), makeSymbol("*CHEAP-HL-MODULE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-ENDING-DAY-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$endingDay <time-interval> ?DAY)"), makeKeyword("EXAMPLE"), makeString("(#$endingDay (#$YearFn 2002) ?DAY) -> (#$DayFn 31 (#$MonthFn #$December (#$YearFn 2002)))") });

    private static final SubLObject $$maximalContiguousSpanningInterval = reader_make_constant_shell(makeString("maximalContiguousSpanningInterval"));



    private static final SubLList $list43 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("maximalContiguousSpanningInterval")), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell(makeString("maximalContiguousSpanningInterval")), makeKeyword("FULLY-BOUND"), makeKeyword("ANYTHING")), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-MATH-MODULE-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("INCOMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-MAXIMALCONTIGUOUSSPANNINGINTERVAL-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$maximalContiguousSpanningInterval <fully-bound-p> <anything>)"), makeKeyword("EXAMPLE"), makeString("(maximalContiguousSpanningInterval (TheSet (DateFromStringFn \"2002\") (DateFromStringFn \"2003\")) (#$TimeIntervalInclusiveFn (DateFromStringFn \"2002\") (DateFromStringFn \"2003\")))") });
    ...
    public static SubLObject declare_removal_modules_time_utilities_file() {
        declareFunction(me, "removal_sub_time_interval_of_type_applicability", "REMOVAL-SUB-TIME-INTERVAL-OF-TYPE-APPLICABILITY", 1, 0, false);
        declareFunction(me, "removal_sub_time_interval_of_type_cost", "REMOVAL-SUB-TIME-INTERVAL-OF-TYPE-COST", 1, 0, false);
        declareFunction(me, "removal_sub_time_interval_of_type_output_generate", "REMOVAL-SUB-TIME-INTERVAL-OF-TYPE-OUTPUT-GENERATE", 1, 0, false);
        declareFunction(me, "removal_sub_time_interval_of_type_literals", "REMOVAL-SUB-TIME-INTERVAL-OF-TYPE-LITERALS", 1, 0, false);
        declareFunction(me, "new_sub_time_interval_of_type_iterator", "NEW-SUB-TIME-INTERVAL-OF-TYPE-ITERATOR", 4, 0, false);
        declareFunction(me, "sub_time_interval_of_type_iterator_state", "SUB-TIME-INTERVAL-OF-TYPE-ITERATOR-STATE", 4, 0, false);
        declareFunction(me, "sub_time_interval_of_type_iterator_done", "SUB-TIME-INTERVAL-OF-TYPE-ITERATOR-DONE", 1, 0, false);
        declareFunction(me, "sub_time_interval_of_type_iterator_next", "SUB-TIME-INTERVAL-OF-TYPE-ITERATOR-NEXT", 1, 0, false);
        declareFunction(me, "sub_time_interval_of_type_iterator_finalize", "SUB-TIME-INTERVAL-OF-TYPE-ITERATOR-FINALIZE", 1, 0, false);
        declareFunction(me, "removal_starting_day_pos_expand", "REMOVAL-STARTING-DAY-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_starting_day_check_pos_expand", "REMOVAL-STARTING-DAY-CHECK-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_starting_day_check_neg_expand", "REMOVAL-STARTING-DAY-CHECK-NEG-EXPAND", 1, 1, false);
        declareFunction(me, "removal_ending_day_pos_expand", "REMOVAL-ENDING-DAY-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_ending_day_check_pos_expand", "REMOVAL-ENDING-DAY-CHECK-POS-EXPAND", 1, 1, false);
        declareFunction(me, "removal_ending_day_check_neg_expand", "REMOVAL-ENDING-DAY-CHECK-NEG-EXPAND", 1, 1, false);
        declareFunction(me, "removal_maximalcontiguousspanninginterval_expand", "REMOVAL-MAXIMALCONTIGUOUSSPANNINGINTERVAL-EXPAND", 1, 1, false);
        declareFunction(me, "first_cycl_interval_initial_second_possibly_indeterminate_late", "FIRST-CYCL-INTERVAL-INITIAL-SECOND-POSSIBLY-INDETERMINATE-LATE", 1, 0, false);
        declareFunction(me, "maximal_intervals_subsuming_intervals", "MAXIMAL-INTERVALS-SUBSUMING-INTERVALS", 1, 2, false);
        return NIL;
    }
