...
public class inference_analysis extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.harness.inference_analysis";
    ...
    public static SubLObject declare_inference_analysis_file() {
        ...
        declareFunction(myName, "clear_transformation_rule_statistics_received_filename_load_history", "CLEAR-TRANSFORMATION-RULE-STATISTICS-RECEIVED-FILENAME-LOAD-HISTORY", 0, 0, false);
        declareFunction(myName, "add_to_transformation_rule_statistics_filename_load_history", "ADD-TO-TRANSFORMATION-RULE-STATISTICS-FILENAME-LOAD-HISTORY", 2, 0, false);
        ...
        declareFunction(myName, "transformation_rule_statistics_received_filename_load_history", "TRANSFORMATION-RULE-STATISTICS-RECEIVED-FILENAME-LOAD-HISTORY", 0, 0, false);
        ...
        declareFunction(myName, "transformation_rules_with_statistics_condition_passesP", "TRANSFORMATION-RULES-WITH-STATISTICS-CONDITION-PASSES?", 3, 0, false);
        ...
        declareFunction(myName, "transformation_rules_with_statistics", "TRANSFORMATION-RULES-WITH-STATISTICS", 0, 3, false);
        declareFunction(myName, "transformation_rules_with_recent_statistics", "TRANSFORMATION-RULES-WITH-RECENT-STATISTICS", 0, 0, false);
        declareFunction(myName, "transformation_rules_with_received_statistics", "TRANSFORMATION-RULES-WITH-RECEIVED-STATISTICS", 0, 0, false);
        ...
        declareFunction(myName, "transformation_rules_with_received_statistics_count", "TRANSFORMATION-RULES-WITH-RECEIVED-STATISTICS-COUNT", 0, 0, false);
        declareFunction(myName, "any_recent_experienceP", "ANY-RECENT-EXPERIENCE?", 0, 0, false);
        declareFunction(myName, "any_received_experienceP", "ANY-RECEIVED-EXPERIENCE?", 0, 0, false);
        ...
        declareFunction(myName, "total_transformation_rule_received_considered_count", "TOTAL-TRANSFORMATION-RULE-RECEIVED-CONSIDERED-COUNT", 0, 0, false);
        ...
        declareFunction(myName, "transformation_rule_received_considered_count", "TRANSFORMATION-RULE-RECEIVED-CONSIDERED-COUNT", 1, 0, false);
        declareFunction(myName, "transformation_rule_has_recent_statisticsP", "TRANSFORMATION-RULE-HAS-RECENT-STATISTICS?", 1, 0, false);
        declareFunction(myName, "transformation_rule_has_received_statisticsP", "TRANSFORMATION-RULE-HAS-RECEIVED-STATISTICS?", 1, 0, false);
        ...
        declareFunction(myName, "total_transformation_rule_received_success_count", "TOTAL-TRANSFORMATION-RULE-RECEIVED-SUCCESS-COUNT", 0, 0, false);
        ...
        declareFunction(myName, "transformation_rule_received_success_count", "TRANSFORMATION-RULE-RECEIVED-SUCCESS-COUNT", 1, 0, false);
        declareFunction(myName, "transformation_rule_success_probability", "TRANSFORMATION-RULE-SUCCESS-PROBABILITY", 1, 1, false);
        declareFunction(myName, "increment_transformation_rule_considered_count", "INCREMENT-TRANSFORMATION-RULE-CONSIDERED-COUNT", 2, 2, false);
        declareFunction(myName, "increment_transformation_rule_success_count", "INCREMENT-TRANSFORMATION-RULE-SUCCESS-COUNT", 2, 2, false);
        ...
        declareFunction(myName, "clear_all_received_transformation_rule_statistics", "CLEAR-ALL-RECEIVED-TRANSFORMATION-RULE-STATISTICS", 0, 0, false);
        declareFunction(myName, "clear_transformation_rule_recent_counts", "CLEAR-TRANSFORMATION-RULE-RECENT-COUNTS", 1, 0, false);
        declareFunction(myName, "clear_transformation_rule_received_counts", "CLEAR-TRANSFORMATION-RULE-RECEIVED-COUNTS", 1, 0, false);
        declareFunction(myName, "clean_transformation_rule_statistics", "CLEAN-TRANSFORMATION-RULE-STATISTICS", 0, 0, false);
        declareFunction(myName, "rule_utility_p", "RULE-UTILITY-P", 1, 0, false);
        declareFunction(myName, "transformation_rule_has_insufficient_historical_utilityP", "TRANSFORMATION-RULE-HAS-INSUFFICIENT-HISTORICAL-UTILITY?", 2, 0, false);
        ...
        declareFunction(myName, "transformation_rules_considered_with_success", "TRANSFORMATION-RULES-CONSIDERED-WITH-SUCCESS", 0, 2, false);
        ...
        declareFunction(myName, "load_transformation_rule_statistics", "LOAD-TRANSFORMATION-RULE-STATISTICS", 1, 2, false);
        declareFunction(myName, "load_transformation_rule_statistics_except_for_rules", "LOAD-TRANSFORMATION-RULE-STATISTICS-EXCEPT-FOR-RULES", 2, 2, false);
        declareFunction(myName, "load_transformation_rule_statistics_int", "LOAD-TRANSFORMATION-RULE-STATISTICS-INT", 4, 0, false);
        declareFunction(myName, "load_transformation_rule_statistics_bookkeeping", "LOAD-TRANSFORMATION-RULE-STATISTICS-BOOKKEEPING", 3, 0, false);
        declareFunction(myName, "save_recent_transformation_rule_statistics", "SAVE-RECENT-TRANSFORMATION-RULE-STATISTICS", 1, 0, false);
        declareFunction(myName, "save_received_experience", "SAVE-RECEIVED-EXPERIENCE", 1, 0, false);
        declareFunction(myName, "save_transformation_rule_statistics_for_rule", "SAVE-TRANSFORMATION-RULE-STATISTICS-FOR-RULE", 5, 0, false);
        declareFunction(myName, "transformation_rule_something_considered_count", "TRANSFORMATION-RULE-SOMETHING-CONSIDERED-COUNT", 3, 0, false);
        declareFunction(myName, "transformation_rule_something_success_count", "TRANSFORMATION-RULE-SOMETHING-SUCCESS-COUNT", 3, 0, false);
        declareFunction(myName, "load_transformation_rule_statistics_for_rule", "LOAD-TRANSFORMATION-RULE-STATISTICS-FOR-RULE", 3, 0, false);
        ...
        declareFunction(myName, "receive_experience", "RECEIVE-EXPERIENCE", 0, 0, false);
        declareFunction(myName, "load_received_experience", "LOAD-RECEIVED-EXPERIENCE", 1, 0, false);
        declareFunction(myName, "load_all_experience_transcripts_from_directory", "LOAD-ALL-EXPERIENCE-TRANSCRIPTS-FROM-DIRECTORY", 1, 1, false);
        ...
        declareFunction(myName, "load_experience_transcript", "LOAD-EXPERIENCE-TRANSCRIPT", 1, 1, false);
        ...
        declareFunction(myName, "possibly_extend_transformation_rule_utility_table", "POSSIBLY-EXTEND-TRANSFORMATION-RULE-UTILITY-TABLE", 0, 0, false);
        declareFunction(myName, "rule_utility_table_uses_new_formatP", "RULE-UTILITY-TABLE-USES-NEW-FORMAT?", 0, 0, false);
        ...
        declareFunction(myName, "cb_show_transformation_rule_historical_connectivity_graph", "CB-SHOW-TRANSFORMATION-RULE-HISTORICAL-CONNECTIVITY-GRAPH", 0, 0, false);
        ...
        declareFunction(myName, "asked_query_common_symbols_simple", "ASKED-QUERY-COMMON-SYMBOLS-SIMPLE", 0, 0, false);
        ...
        declareFunction(myName, "mts_of_inference_answer", "MTS-OF-INFERENCE-ANSWER", 1, 0, false);
        declareFunction(myName, "mts_of_inference_answer_justification", "MTS-OF-INFERENCE-ANSWER-JUSTIFICATION", 1, 0, false);
        declareFunction(myName, "max_floor_mts_of_inference", "MAX-FLOOR-MTS-OF-INFERENCE", 1, 1, false);
        declareFunction(myName, "max_floor_mts_of_inference_answer", "MAX-FLOOR-MTS-OF-INFERENCE-ANSWER", 1, 1, false);
        declareFunction(myName, "conjoin_mt_tuples", "CONJOIN-MT-TUPLES", 1, 0, false);
        declareFunction(myName, "disjoin_mt_tuples", "DISJOIN-MT-TUPLES", 1, 0, false);
        declareFunction(myName, "max_floor_mts_of_inference_answer_justification", "MAX-FLOOR-MTS-OF-INFERENCE-ANSWER-JUSTIFICATION", 1, 0, false);
        declareFunction(myName, "max_floor_mts_of_supports", "MAX-FLOOR-MTS-OF-SUPPORTS", 1, 0, false);
        return NIL;
    }
