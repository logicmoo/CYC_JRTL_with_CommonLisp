...
public final class inference_analysis extends SubLTranslatedFile implements V12 {
 ...
 public static final String myName = "com.cyc.cycjava.cycl.inference.harness.inference_analysis";
    ...
    public static final SubLObject transformation_rule_has_insufficient_historical_utilityP(SubLObject rule) {
        {
            ...
            return makeBoolean(com.cyc.cycjava.cycl.inference.harness.inference_analysis.transformation_rule_success_count(rule).numL($transformation_rule_historical_success_pruning_threshold$.getDynamicValue(thread)) || com.cyc.cycjava.cycl.inference.harness.inference_analysis.transformation_rule_historical_utility(rule).numL($transformation_rule_historical_utility_pruning_threshold$.getDynamicValue(thread)));
        }
    }
    ...
    public static final SubLObject transformation_rule_historical_utility_alt(SubLObject rule) {
        SubLTrampolineFile.checkType(rule, $sym40$RULE_ASSERTION_);
        return com.cyc.cycjava.cycl.inference.harness.inference_analysis.rule_historical_utility_from_observations(com.cyc.cycjava.cycl.inference.harness.inference_analysis.transformation_rule_success_count(rule), com.cyc.cycjava.cycl.inference.harness.inference_analysis.transformation_rule_considered_count(rule));
    }
    ...
    public static final SubLObject cinc_module_expand_count_alt(SubLObject name) {
        {
            ...
            return com.cyc.cycjava.cycl.inference.harness.inference_analysis.cinc_hl_module_expand_count(hl_module);
        }
    }
    ...
    public static final SubLObject init_inference_analysis_file_alt() {
        ...
        deflexical("*TRANSFORMATION-RULE-HISTORICAL-CONNECTIVITY-GRAPH-LOCK*", NIL != boundp($transformation_rule_historical_connectivity_graph_lock$) ? ((SubLObject) ($transformation_rule_historical_connectivity_graph_lock$.getGlobalValue())) : make_lock($str_alt68$Rule_Historical_Connectivity_Grap));
