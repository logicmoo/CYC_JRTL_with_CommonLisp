...
import com.cyc.cycjava.cycl.inference.modules.preference_modules.$preference_module_native;
...
public final class preference_modules extends SubLTranslatedFile {
    ...
    public static SubLObject pref_mod_name(final SubLObject v_object) {
        assert NIL != preference_module_p(v_object) : "preference_modules.preference_module_p error :" + v_object;
    ...
    public static final class $preference_module_native extends SubLStructNative {
        ...
        private $preference_module_native() {
            this.$name = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative($preference_module_native.class, PREFERENCE_MODULE, PREFERENCE_MODULE_P, $list86, $list87, new String[]{ "$name", "$predicate", "$sense", "$required_pattern", "$preference_level", "$preference_func", "$required_mt", "$any_predicates" }, $list88, $list89, PRINT_PREFERENCE_MODULE);
        }
    }
