      ...
      SubLTranslatedFile
{
  ...
  public static SubLObject make_balancing_tactician_data(SubLObject arglist)
  {
    ...
    for( next = NIL, next = arglist; NIL != next; next = conses_high.cddr( next ) )
    {
      ...
      if( pcase_var.eql( $kw17$NEW_ROOT_SUBSTRATEGY ) )
      {
        _csetf_bal_tac_data_new_root_substrategy( v_new, current_value );
      }
      else if( pcase_var.eql( $kw18$TRANSFORMATION_SUBSTRATEGY ) )
      {
        _csetf_bal_tac_data_transformation_substrategy( v_new, current_value );
      }
      else if( pcase_var.eql( $kw19$REMOVAL_SUBSTRATEGIES ) )
      {
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw21$BEGIN, $sym22$MAKE_BALANCING_TACTICIAN_DATA, THREE_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw23$SLOT, $kw17$NEW_ROOT_SUBSTRATEGY, bal_tac_data_new_root_substrategy( obj ) );
    Functions.funcall( visitor_fn, obj, $kw23$SLOT, $kw18$TRANSFORMATION_SUBSTRATEGY, bal_tac_data_transformation_substrategy( obj ) );
    Functions.funcall( visitor_fn, obj, $kw23$SLOT, $kw19$REMOVAL_SUBSTRATEGIES, bal_tac_data_removal_substrategies( obj ) );
    Functions.funcall( visitor_fn, obj, $kw24$END, $sym22$MAKE_BALANCING_TACTICIAN_DATA, THREE_INTEGER );
    return obj;
  }
  ...
  public static SubLObject do_balancing_tactician_substrategies(final SubLObject macroform, final SubLObject environment)
  {
    ...
    while ( NIL != rest)
    {
      ...
      if( current_$1 == $kw29$ALLOW_OTHER_KEYS )
      {
    ...
    final SubLObject done_tail = cdestructuring_bind.property_list_member( $kw30$DONE, current );
    final SubLObject done = ( NIL != done_tail ) ? conses_high.cadr( done_tail ) : NIL;
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.listS( $sym31$CSOME, ConsesLow.list( substrategy_var, ConsesLow.list( $sym32$BALANCING_TACTICIAN_ALL_SUBSTRATEGIES, strategy ), done ), ConsesLow.append( body, NIL ) );
  }
  ...
  public static SubLObject do_balancing_tactician_spineful_substrategies(final SubLObject macroform, final SubLObject environment)
  {
    ...
    while ( NIL != rest)
    {
      ...
      if( current_$2 == $kw29$ALLOW_OTHER_KEYS )
      {
        allow_other_keys_p = rest.first();
      }
      rest = rest.rest();
    ...
    final SubLObject body;
    current = ( body = temp );
    return ConsesLow.list( $sym33$DO_BALANCING_TACTICIAN_SUBSTRATEGIES, ConsesLow.list( substrategy_var, strategy, $kw30$DONE, done ), ConsesLow.listS( $sym34$PUNLESS, ConsesLow.list(
        $sym35$BALANCING_TACTICIAN_SPINELESS_SUBSTRATEGY_P, substrategy_var ), ConsesLow.append( body, NIL ) ) );
  }
  ...
  {
    final SubLObject new_root_substrategy = inference_datastructures_strategy.new_strategy( $kw37$NEW_ROOT, inference );
    final SubLObject transformation_substrategy = inference_datastructures_strategy.new_strategy( $kw38$TRANSFORMATION, inference );
    final SubLObject sole_removal_substrategy = inference_datastructures_strategy.new_strategy( $kw39$REMOVAL, inference );
    return new_balancing_tactician_data( new_root_substrategy, transformation_substrategy, ConsesLow.list( sole_removal_substrategy ) );
  }
  ...
  {
    return ConsesLow.listS( balancing_tactician_new_root_substrategy( strategy ), balancing_tactician_transformation_substrategy( strategy ), balancing_tactician_removal_substrategies( strategy ) );
  }
  ...
  {
    return makeBoolean( NIL != inference_datastructures_strategy.strategy_p( v_object ) && NIL == balancing_tactician_p( v_object ) && NIL != balancing_tactician_p( inference_tactician.controlling_strategy(
        v_object ) ) );
  }
  ...
  {
    SubLObject result;
    for( result = $kw42$UNINTERESTING; $kw42$UNINTERESTING == result; result = balancing_tactician_do_one_step_int( strategy ) )
    {
    }
    return Equality.eq( $kw30$DONE, result );
  }
  ...
  public static SubLObject balancing_tactician_do_one_step_int(final SubLObject strategy)
  {
    ...
    if( NIL != balancing_tactician_should_reconsider_set_asidesP( strategy ) )
    {
      ...
      action = $kw44$RECONSIDER_SET_ASIDES;
      result = $kw42$UNINTERESTING;
    }
    else if( NIL != inference_datastructures_strategy.strategy_should_propagate_answer_linkP( strategy ) )
    {
      ...
      action = $kw45$PROPAGATE_ANSWER_LINK;
      result = $kw46$INTERESTING;
    }
    ...
    else if( NIL == inference_tactician.strategy_doneP( balancing_tactician_new_root_substrategy( strategy ) ) )
    {
      ...
      {
        re_addP = T;
        action = ConsesLow.list( $kw47$MOTIVATION, r_strategy, new_root );
      ...
      {
        re_addP = T;
        action = ConsesLow.list( $kw47$MOTIVATION, t_strategy, new_root );
  ...
  {
    return ( NIL != substrategy_return_value ) ? $kw42$UNINTERESTING : $kw46$INTERESTING;
  }
  ...
  public static SubLObject balancing_tactician_chooses_to_throw_away_tacticP(final SubLObject strategy, final SubLObject tactic, final SubLObject problem_already_consideredP,
      final SubLObject siblings_already_consideredP)
  {
    ...
    if( NIL == dont_throw_awayP )
    {
      ...
      while ( NIL == dont_throw_awayP && NIL != csome_list_var)
      {
        if( NIL == balancing_tactician_spineless_substrategy_p( sub_strategy ) )
        {
          dont_throw_awayP = makeBoolean( NIL == inference_tactician_strategic_uninterestingness.strategy_chooses_to_throw_away_tacticP( sub_strategy, tactic, problem_already_consideredP,
  ...
  public static SubLObject balancing_tactician_problem_is_the_rest_of_an_early_removalP(final SubLObject strategy, final SubLObject problem)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, restriction_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( restriction_link, $kw60$RESTRICTION ) )
      {
        ...
        for( basis_object_$4 = set_contents.do_set_contents_basis_object( set_contents_var_$3 ), state_$5 = NIL, state_$5 = set_contents.do_set_contents_initial_state( basis_object_$4,
            set_contents_var_$3 ); NIL == set_contents.do_set_contents_doneP( basis_object_$4, state_$5 ); state_$5 = set_contents.do_set_contents_update_state( state_$5 ) )
        {
          join_ordered_link = set_contents.do_set_contents_next( basis_object_$4, state_$5 );
          if( NIL != set_contents.do_set_contents_element_validP( state_$5, join_ordered_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( join_ordered_link, $kw61$JOIN_ORDERED )
              && NIL != inference_worker_join_ordered.join_ordered_link_restricted_non_focal_linkP( join_ordered_link, restriction_link ) && non_focal_problem.eql( inference_worker_join_ordered
                  .join_ordered_link_non_focal_problem( join_ordered_link ) ) && NIL != balancing_tactician_chooses_to_propagate_new_root_motivation_to_restricted_non_focal_problemP( strategy, problem,
                      join_ordered_link ) )
          {
            return T;
          }
  ...
  public static SubLObject balancing_tactician_early_removal_linkP(final SubLObject strategy, final SubLObject link)
  {
    ...
    final SubLObject r_strategy = balancing_tactician_sole_removal_substrategy( strategy );
    return makeBoolean( NIL != inference_worker_join_ordered.join_ordered_link_p( link ) && NIL != inference_datastructures_problem_link.problem_link_openP( link )
        && NIL != substrategy_connected_conjunction_link_motivatedP( r_strategy, link ) && NIL != balancing_tactician_problem_motivated_wrt_nP( strategy, inference_datastructures_problem_link
            .problem_link_supported_problem( link ) ) && $kw63$COMPLETE == inference_worker.problem_generalized_removal_completeness( inference_worker_join_ordered.join_ordered_tactic_lookahead_problem(
                inference_worker_join_ordered.join_ordered_link_tactic( link ) ), r_strategy ) && NIL != inference_tactician.join_ordered_link_early_removal_cheapP( link, strategy ) );
  }
  ...
  public static SubLObject balancing_tactician_problem_is_the_result_of_a_simplificationP(final SubLObject strategy, final SubLObject problem)
  {
    if( NIL != inference_worker_restriction.problem_is_a_simplificationP( problem ) )
    {
          ...
          .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        if( NIL != set_contents.do_set_contents_element_validP( state, simplification_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( simplification_link, $kw64$SIMPLIFICATION )
  ...
  public static SubLObject balancing_tactician_substrategy_problem_motivated(final SubLObject strategy, final SubLObject substrategy, final SubLObject problem)
  {
    ...
    if( NIL != new_root_tactician.new_root_strategy_p( substrategy ) )
    {
          ...
          .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        if( NIL != set_contents.do_set_contents_element_validP( state, split_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( split_link, $kw68$SPLIT ) )
        {
          ...
          .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        if( NIL != set_contents.do_set_contents_element_validP( state, union_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( union_link, $kw69$UNION ) )
        {
          ...
          .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        if( NIL != set_contents.do_set_contents_element_validP( state, link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( link, $kw61$JOIN_ORDERED )
            && NIL != balancing_tactician_early_removal_linkP( strategy, link ) )
        {
          link_var = link;
              ...
              set_contents_var_$6 ); NIL == set_contents.do_set_contents_doneP( basis_object_$7, state_$8 ); state_$8 = set_contents.do_set_contents_update_state( state_$8 ) )
          {
            ...
            if( NIL != set_contents.do_set_contents_element_validP( state_$8, restriction_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( restriction_link, $kw60$RESTRICTION )
  ...
  public static SubLObject balancing_tactician_residual_conjunction_new_root_candidates(final SubLObject strategy, final SubLObject t_link)
  {
    ...
    if( NIL == $balancing_tactician_self_looping_rule_fix_enabledP$.getDynamicValue( thread ) || NIL == assertion_utilities.self_expanding_ruleP( inference_worker_transformation.transformation_link_rule_assertion(
        t_link ) ) )
    {
          ...
          .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        ...
        if( NIL != set_contents.do_set_contents_element_validP( state, jo_link_var ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( jo_link_var, $kw61$JOIN_ORDERED ) )
        {
              ...
              set_contents_var_$10 ); NIL == set_contents.do_set_contents_doneP( basis_object_$11, state_$12 ); state_$12 = set_contents.do_set_contents_update_state( state_$12 ) )
          {
            ...
            if( NIL != set_contents.do_set_contents_element_validP( state_$12, rt_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( rt_link, $kw71$RESIDUAL_TRANSFORMATION )
    ...
    if( NIL != $balancing_tactician_new_roots_triggered_by_t_on_jo_linkP$.getDynamicValue( thread ) )
    {
      ...
      if( NIL != inference_worker_join_ordered.join_ordered_link_p( link ) )
      {
            ...
            .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
        {
          ...
          if( NIL != set_contents.do_set_contents_element_validP( state, rt_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( rt_link, $kw71$RESIDUAL_TRANSFORMATION )
    ...
    if( NIL != balancing_tactician_problem_motivated_wrt_nP( strategy, inference_datastructures_problem_link.problem_link_supported_problem( split_link ) ) )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        if( NIL != inference_macros.do_problem_link_open_matchP( NIL, split_link, supporting_mapped_problem ) )
        {
          ...
          if( NIL != balancing_tactician_problem_motivated_wrt_tP( strategy, supporting_problem ) && NIL != inference_tactician.substrategy_motivate_strategem( balancing_tactician_new_root_substrategy( strategy ),
              supporting_problem ) )
          {
            count = Numbers.add( count, ONE_INTEGER );
          }
  ...
  public static SubLObject balancing_tactician_chooses_to_totally_throw_away_tacticP(final SubLObject strategy, final SubLObject substrategy, final SubLObject tactic, final SubLObject problem_already_consideredP,
      final SubLObject siblings_already_consideredP)
  {
  ...
  public static SubLObject balancing_tactician_substrategy_problem_status_change(final SubLObject strategy, final SubLObject substrategy, final SubLObject problem, final SubLObject old_status,
      final SubLObject new_status)
  {
        ...
        && NIL == inference_datastructures_enumerated_types.no_good_problem_status_p( old_status ) && NIL != inference_datastructures_enumerated_types.no_good_problem_status_p( new_status ) )
    {
      ...
      return $kw77$COMPLETE_REMOVAL_TACTIC_NO_GOOD;
    }
    return NIL;
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    SubLObject weakest_strategic_status = $kw79$FINISHED;
    SubLObject most_sensible_provability_status = $kw80$NO_GOOD;
    SubLObject csome_list_var = balancing_tactician_all_substrategies( strategy );
    SubLObject substrategy = NIL;
    substrategy = csome_list_var.first();
    while ( NIL != csome_list_var)
    {
      if( NIL == balancing_tactician_spineless_substrategy_p( substrategy ) )
      {
        ...
        if( !pcase_var.eql( $kw80$NO_GOOD ) )
        {
          if( pcase_var.eql( $kw81$GOOD ) )
          {
            most_sensible_provability_status = $kw82$NEUTRAL;
          }
          else if( pcase_var.eql( $kw82$NEUTRAL ) )
          {
            most_sensible_provability_status = $kw82$NEUTRAL;
          }
        }
    ...
    if( $kw83$POSSIBLE == weakest_strategic_status && $kw80$NO_GOOD == most_sensible_provability_status )
    {
      weakest_strategic_status = $kw84$PENDING;
    }
    ...
    if( NIL != $balancing_tactician_is_tactically_hardcoreP$.getDynamicValue( thread ) && NIL != inference_tactician.strategy_controls_problem_storeP( strategy ) && NIL == inference_datastructures_strategy
        .strategy_continuableP( strategy ) && NIL != inference_tactician.strategy_set_aside_non_continuable_implies_throw_awayP( strategy ) )
    {
  ...
  public static SubLObject balancing_tactician_possibly_propagate_strategic_status_to_tactical_status(final SubLObject problem, final SubLObject most_sensible_provability_status,
      final SubLObject weakest_strategic_status)
  {
    if( $kw80$NO_GOOD == most_sensible_provability_status )
    {
      inference_worker.make_problem_no_good( problem, NIL, $kw85$TACTICAL );
    }
    if( $kw84$PENDING == weakest_strategic_status )
    {
      inference_worker.discard_all_possible_tactics( problem );
      inference_worker.possibly_note_problem_pending( problem, $kw85$TACTICAL );
    }
    if( $kw79$FINISHED == weakest_strategic_status )
    {
      inference_worker.possibly_note_problem_finished( problem, $kw85$TACTICAL );
    }
    return problem;
  }
  ...
  public static SubLObject balancing_tactician_make_problem_pending(final SubLObject strategy, final SubLObject problem)
  {
    ...
    {
      link = set_contents.do_set_contents_next( basis_object, state );
      if( NIL != set_contents.do_set_contents_element_validP( state, link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( link, $kw86$CONNECTED_CONJUNCTION ) )
      {
  ...
  {
    SubLFiles.declareFunction( me, "balancing_tactician_data_print_function_trampoline", "BALANCING-TACTICIAN-DATA-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_data_p", "BALANCING-TACTICIAN-DATA-P", 1, 0, false );
    new $balancing_tactician_data_p$UnaryFunction();
    SubLFiles.declareFunction( me, "bal_tac_data_new_root_substrategy", "BAL-TAC-DATA-NEW-ROOT-SUBSTRATEGY", 1, 0, false );
    SubLFiles.declareFunction( me, "bal_tac_data_transformation_substrategy", "BAL-TAC-DATA-TRANSFORMATION-SUBSTRATEGY", 1, 0, false );
    SubLFiles.declareFunction( me, "bal_tac_data_removal_substrategies", "BAL-TAC-DATA-REMOVAL-SUBSTRATEGIES", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_bal_tac_data_new_root_substrategy", "_CSETF-BAL-TAC-DATA-NEW-ROOT-SUBSTRATEGY", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_bal_tac_data_transformation_substrategy", "_CSETF-BAL-TAC-DATA-TRANSFORMATION-SUBSTRATEGY", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_bal_tac_data_removal_substrategies", "_CSETF-BAL-TAC-DATA-REMOVAL-SUBSTRATEGIES", 2, 0, false );
    SubLFiles.declareFunction( me, "make_balancing_tactician_data", "MAKE-BALANCING-TACTICIAN-DATA", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_balancing_tactician_data", "VISIT-DEFSTRUCT-BALANCING-TACTICIAN-DATA", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_balancing_tactician_data_method", "VISIT-DEFSTRUCT-OBJECT-BALANCING-TACTICIAN-DATA-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_p", "BALANCING-TACTICIAN-P", 1, 0, false );
    SubLFiles.declareMacro( me, "do_balancing_tactician_substrategies", "DO-BALANCING-TACTICIAN-SUBSTRATEGIES" );
    SubLFiles.declareMacro( me, "do_balancing_tactician_spineful_substrategies", "DO-BALANCING-TACTICIAN-SPINEFUL-SUBSTRATEGIES" );
    SubLFiles.declareFunction( me, "new_balancing_tactician_data", "NEW-BALANCING-TACTICIAN-DATA", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_initialize", "BALANCING-TACTICIAN-INITIALIZE", 1, 0, false );
    SubLFiles.declareFunction( me, "new_balancing_tactician_data_from_inference", "NEW-BALANCING-TACTICIAN-DATA-FROM-INFERENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_new_root_substrategy", "BALANCING-TACTICIAN-NEW-ROOT-SUBSTRATEGY", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_transformation_substrategy", "BALANCING-TACTICIAN-TRANSFORMATION-SUBSTRATEGY", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_removal_substrategies", "BALANCING-TACTICIAN-REMOVAL-SUBSTRATEGIES", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_sole_removal_substrategy", "BALANCING-TACTICIAN-SOLE-REMOVAL-SUBSTRATEGY", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_all_substrategies", "BALANCING-TACTICIAN-ALL-SUBSTRATEGIES", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_problem_motivated_wrt_nP", "BALANCING-TACTICIAN-PROBLEM-MOTIVATED-WRT-N?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_problem_motivated_wrt_rP", "BALANCING-TACTICIAN-PROBLEM-MOTIVATED-WRT-R?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_problem_motivated_wrt_tP", "BALANCING-TACTICIAN-PROBLEM-MOTIVATED-WRT-T?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_link_head_motivated_wrt_rP", "BALANCING-TACTICIAN-LINK-HEAD-MOTIVATED-WRT-R?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_substrategy_p", "BALANCING-TACTICIAN-SUBSTRATEGY-P", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_proper_substrategy_p", "BALANCING-TACTICIAN-PROPER-SUBSTRATEGY-P", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_spineless_substrategy_p", "BALANCING-TACTICIAN-SPINELESS-SUBSTRATEGY-P", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_doneP", "BALANCING-TACTICIAN-DONE?", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_do_one_step", "BALANCING-TACTICIAN-DO-ONE-STEP", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_do_one_step_int", "BALANCING-TACTICIAN-DO-ONE-STEP-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_should_reconsider_set_asidesP", "BALANCING-TACTICIAN-SHOULD-RECONSIDER-SET-ASIDES?", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_reconsider_set_asides", "BALANCING-TACTICIAN-RECONSIDER-SET-ASIDES", 1, 0, false );
    SubLFiles.declareFunction( me, "substrategy_do_one_step_interestingness", "SUBSTRATEGY-DO-ONE-STEP-INTERESTINGNESS", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_continuation_possibleP", "BALANCING-TACTICIAN-CONTINUATION-POSSIBLE?", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_chooses_to_throw_away_problemP", "BALANCING-TACTICIAN-CHOOSES-TO-THROW-AWAY-PROBLEM?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_chooses_to_set_aside_problemP", "BALANCING-TACTICIAN-CHOOSES-TO-SET-ASIDE-PROBLEM?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_chooses_to_throw_away_tacticP", "BALANCING-TACTICIAN-CHOOSES-TO-THROW-AWAY-TACTIC?", 4, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_chooses_to_set_aside_tacticP", "BALANCING-TACTICIAN-CHOOSES-TO-SET-ASIDE-TACTIC?", 4, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_throw_away_uninteresting_set_asides", "BALANCING-TACTICIAN-THROW-AWAY-UNINTERESTING-SET-ASIDES", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_note_inference_dynamic_properties_updated", "BALANCING-TACTICIAN-NOTE-INFERENCE-DYNAMIC-PROPERTIES-UPDATED", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_initialize_properties", "BALANCING-TACTICIAN-INITIALIZE-PROPERTIES", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_update_properties", "BALANCING-TACTICIAN-UPDATE-PROPERTIES", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_initial_relevant_strategies", "BALANCING-TACTICIAN-INITIAL-RELEVANT-STRATEGIES", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_possibly_activate_problem", "BALANCING-TACTICIAN-POSSIBLY-ACTIVATE-PROBLEM", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_problem_is_the_rest_of_an_early_removalP", "BALANCING-TACTICIAN-PROBLEM-IS-THE-REST-OF-AN-EARLY-REMOVAL?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_chooses_to_propagate_new_root_motivation_to_restricted_non_focal_problemP",
        "BALANCING-TACTICIAN-CHOOSES-TO-PROPAGATE-NEW-ROOT-MOTIVATION-TO-RESTRICTED-NON-FOCAL-PROBLEM?", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_treats_restricted_non_focal_as_new_rootP", "BALANCING-TACTICIAN-TREATS-RESTRICTED-NON-FOCAL-AS-NEW-ROOT?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_early_removal_linkP", "BALANCING-TACTICIAN-EARLY-REMOVAL-LINK?", 2, 0, false );
    SubLFiles.declareFunction( me, "substrategy_connected_conjunction_link_motivatedP", "SUBSTRATEGY-CONNECTED-CONJUNCTION-LINK-MOTIVATED?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_problem_is_the_result_of_a_simplificationP", "BALANCING-TACTICIAN-PROBLEM-IS-THE-RESULT-OF-A-SIMPLIFICATION?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_note_argument_link", "BALANCING-TACTICIAN-NOTE-ARGUMENT-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_early_removal_productivity_limit", "BALANCING-TACTICIAN-EARLY-REMOVAL-PRODUCTIVITY-LIMIT", 1, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_substrategy_strategem_motivated", "BALANCING-TACTICIAN-SUBSTRATEGY-STRATEGEM-MOTIVATED", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_substrategy_problem_motivated", "BALANCING-TACTICIAN-SUBSTRATEGY-PROBLEM-MOTIVATED", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_substrategy_link_motivated", "BALANCING-TACTICIAN-SUBSTRATEGY-LINK-MOTIVATED", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_chooses_to_make_d_a_new_rootP", "BALANCING-TACTICIAN-CHOOSES-TO-MAKE-D-A-NEW-ROOT?", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_residual_conjunction_new_root_candidates", "BALANCING-TACTICIAN-RESIDUAL-CONJUNCTION-NEW-ROOT-CANDIDATES", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_transformation_new_root_candidates", "BALANCING-TACTICIAN-TRANSFORMATION-NEW-ROOT-CANDIDATES", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_possibly_make_new_root", "BALANCING-TACTICIAN-POSSIBLY-MAKE-NEW-ROOT", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_substrategy_tactic_motivated", "BALANCING-TACTICIAN-SUBSTRATEGY-TACTIC-MOTIVATED", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_substrategy_connected_conjunction_tactic_motivated", "BALANCING-TACTICIAN-SUBSTRATEGY-CONNECTED-CONJUNCTION-TACTIC-MOTIVATED", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_possibly_motivate_new_root_via_residual_transformation_link", "BALANCING-TACTICIAN-POSSIBLY-MOTIVATE-NEW-ROOT-VIA-RESIDUAL-TRANSFORMATION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_substrategy_split_tactic_motivated", "BALANCING-TACTICIAN-SUBSTRATEGY-SPLIT-TACTIC-MOTIVATED", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_possibly_propagate_new_root_motivation_down_split_link", "BALANCING-TACTICIAN-POSSIBLY-PROPAGATE-NEW-ROOT-MOTIVATION-DOWN-SPLIT-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_substrategy_union_tactic_motivated", "BALANCING-TACTICIAN-SUBSTRATEGY-UNION-TACTIC-MOTIVATED", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_possibly_propagate_new_root_motivation_down_union_link", "BALANCING-TACTICIAN-POSSIBLY-PROPAGATE-NEW-ROOT-MOTIVATION-DOWN-UNION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_allows_split_tactic_to_be_set_aside_wrt_removalP", "BALANCING-TACTICIAN-ALLOWS-SPLIT-TACTIC-TO-BE-SET-ASIDE-WRT-REMOVAL?", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_chooses_to_totally_throw_away_tacticP", "BALANCING-TACTICIAN-CHOOSES-TO-TOTALLY-THROW-AWAY-TACTIC?", 5, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_substrategy_problem_status_change", "BALANCING-TACTICIAN-SUBSTRATEGY-PROBLEM-STATUS-CHANGE", 5, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_recompute_problem_status", "BALANCING-TACTICIAN-RECOMPUTE-PROBLEM-STATUS", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_possibly_propagate_strategic_status_to_tactical_status", "BALANCING-TACTICIAN-POSSIBLY-PROPAGATE-STRATEGIC-STATUS-TO-TACTICAL-STATUS", 3, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_make_problem_no_good", "BALANCING-TACTICIAN-MAKE-PROBLEM-NO-GOOD", 2, 0, false );
    SubLFiles.declareFunction( me, "balancing_tactician_make_problem_pending", "BALANCING-TACTICIAN-MAKE-PROBLEM-PENDING", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_balancing_tactician_file()
  {
    $dtp_balancing_tactician_data$ = SubLFiles.defconstant( "*DTP-BALANCING-TACTICIAN-DATA*", $sym2$BALANCING_TACTICIAN_DATA );
    $balancing_tactician_early_removal_productivity_limit$ = SubLFiles.defvar( "*BALANCING-TACTICIAN-EARLY-REMOVAL-PRODUCTIVITY-LIMIT*", inference_datastructures_enumerated_types.productivity_for_number_of_children(
  ...
  public static SubLObject setup_balancing_tactician_file()
  {
    ...
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_balancing_tactician_data$.getGlobalValue(), Symbols.symbol_function(
    ...
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_balancing_tactician_data$.getGlobalValue(), Symbols.symbol_function(
        $sym25$VISIT_DEFSTRUCT_OBJECT_BALANCING_TACTICIAN_DATA_METHOD ) );
  ...
  static
  {
    ...
    $kw0$BALANCING = makeKeyword( "BALANCING" );
    $list1 = ConsesLow.list( new SubLObject[] { makeKeyword( "NAME" ), makeString( "Balancing Tactician" ), makeKeyword( "COMMENT" ), makeString(
        "A balancing tactician type which delegates to a new-root tactician,\n a transformation tactician, and a single removal tactician." ), makeKeyword( "CONSTRUCTOR" ), makeSymbol( "BALANCING-TACTICIAN-INITIALIZE" ),
      makeKeyword( "DONE?" ), makeSymbol( "BALANCING-TACTICIAN-DONE?" ), makeKeyword( "DO-ONE-STEP" ), makeSymbol( "BALANCING-TACTICIAN-DO-ONE-STEP" ), makeKeyword( "INITIAL-RELEVANT-STRATEGIES" ), makeSymbol(
          "BALANCING-TACTICIAN-INITIAL-RELEVANT-STRATEGIES" ), makeKeyword( "INITIALIZE-PROPERTIES" ), makeSymbol( "BALANCING-TACTICIAN-INITIALIZE-PROPERTIES" ), makeKeyword( "UPDATE-PROPERTIES" ), makeSymbol(
              "BALANCING-TACTICIAN-UPDATE-PROPERTIES" ), makeKeyword( "INFERENCE-DYNAMIC-PROPERTIES-UPDATED" ), makeSymbol( "BALANCING-TACTICIAN-NOTE-INFERENCE-DYNAMIC-PROPERTIES-UPDATED" ), makeKeyword(
                  "CONTINUATION-POSSIBLE?" ), makeSymbol( "BALANCING-TACTICIAN-CONTINUATION-POSSIBLE?" ), makeKeyword( "THROW-AWAY-UNINTERESTING-SET-ASIDES" ), makeSymbol(
                      "BALANCING-TACTICIAN-THROW-AWAY-UNINTERESTING-SET-ASIDES" ), makeKeyword( "EARLY-REMOVAL-PRODUCTIVITY-LIMIT" ), makeSymbol( "BALANCING-TACTICIAN-EARLY-REMOVAL-PRODUCTIVITY-LIMIT" ), makeKeyword(
                          "POSSIBLY-ACTIVATE-PROBLEM" ), makeSymbol( "BALANCING-TACTICIAN-POSSIBLY-ACTIVATE-PROBLEM" ), makeKeyword( "THROW-AWAY-PROBLEM" ), makeSymbol(
                              "BALANCING-TACTICIAN-CHOOSES-TO-THROW-AWAY-PROBLEM?" ), makeKeyword( "SET-ASIDE-PROBLEM" ), makeSymbol( "BALANCING-TACTICIAN-CHOOSES-TO-SET-ASIDE-PROBLEM?" ), makeKeyword(
                                  "THROW-AWAY-TACTIC" ), makeSymbol( "BALANCING-TACTICIAN-CHOOSES-TO-THROW-AWAY-TACTIC?" ), makeKeyword( "SET-ASIDE-TACTIC" ), makeSymbol(
                                      "BALANCING-TACTICIAN-CHOOSES-TO-SET-ASIDE-TACTIC?" ), makeKeyword( "NEW-ARGUMENT-LINK" ), makeSymbol( "BALANCING-TACTICIAN-NOTE-ARGUMENT-LINK" ), makeKeyword( "NEW-TACTIC" ),
      makeSymbol( "IGNORE" ), makeKeyword( "SPLIT-TACTICS-POSSIBLE" ), makeSymbol( "IGNORE" ), makeKeyword( "PROBLEM-COULD-BE-PENDING" ), makeSymbol( "IGNORE" ), makeKeyword( "LINK-HEAD-MOTIVATED?" ), makeSymbol(
          "FALSE" ), makeKeyword( "PROBLEM-NOTHING-TO-DO?" ), makeSymbol( "FALSE" ), makeKeyword( "SUBSTRATEGY-STRATEGEM-MOTIVATED" ), makeSymbol( "BALANCING-TACTICIAN-SUBSTRATEGY-STRATEGEM-MOTIVATED" ), makeKeyword(
              "SUBSTRATEGY-TOTALLY-THROW-AWAY-TACTIC" ), makeSymbol( "BALANCING-TACTICIAN-CHOOSES-TO-TOTALLY-THROW-AWAY-TACTIC?" ), makeKeyword( "SUBSTRATEGY-ALLOW-SPLIT-TACTIC-SET-ASIDE-WRT-REMOVAL" ), makeSymbol(
                  "BALANCING-TACTICIAN-ALLOWS-SPLIT-TACTIC-TO-BE-SET-ASIDE-WRT-REMOVAL?" ), makeKeyword( "SUBSTRATEGY-PROBLEM-STATUS-CHANGE" ), makeSymbol( "BALANCING-TACTICIAN-SUBSTRATEGY-PROBLEM-STATUS-CHANGE" )
    } );
    ...
    $list4 = ConsesLow.list( makeSymbol( "NEW-ROOT-SUBSTRATEGY" ), makeSymbol( "TRANSFORMATION-SUBSTRATEGY" ), makeSymbol( "REMOVAL-SUBSTRATEGIES" ) );
    $list5 = ConsesLow.list( makeKeyword( "NEW-ROOT-SUBSTRATEGY" ), makeKeyword( "TRANSFORMATION-SUBSTRATEGY" ), makeKeyword( "REMOVAL-SUBSTRATEGIES" ) );
    $list6 = ConsesLow.list( makeSymbol( "BAL-TAC-DATA-NEW-ROOT-SUBSTRATEGY" ), makeSymbol( "BAL-TAC-DATA-TRANSFORMATION-SUBSTRATEGY" ), makeSymbol( "BAL-TAC-DATA-REMOVAL-SUBSTRATEGIES" ) );
    $list7 = ConsesLow.list( makeSymbol( "_CSETF-BAL-TAC-DATA-NEW-ROOT-SUBSTRATEGY" ), makeSymbol( "_CSETF-BAL-TAC-DATA-TRANSFORMATION-SUBSTRATEGY" ), makeSymbol( "_CSETF-BAL-TAC-DATA-REMOVAL-SUBSTRATEGIES" ) );
    ...
    $list10 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "BALANCING-TACTICIAN-DATA-P" ) );
    ...
    $kw17$NEW_ROOT_SUBSTRATEGY = makeKeyword( "NEW-ROOT-SUBSTRATEGY" );
    $kw18$TRANSFORMATION_SUBSTRATEGY = makeKeyword( "TRANSFORMATION-SUBSTRATEGY" );
    $kw19$REMOVAL_SUBSTRATEGIES = makeKeyword( "REMOVAL-SUBSTRATEGIES" );
    $str20$Invalid_slot__S_for_construction_ = makeString( "Invalid slot ~S for construction function" );
    $kw21$BEGIN = makeKeyword( "BEGIN" );
    $sym22$MAKE_BALANCING_TACTICIAN_DATA = makeSymbol( "MAKE-BALANCING-TACTICIAN-DATA" );
    $kw23$SLOT = makeKeyword( "SLOT" );
    $kw24$END = makeKeyword( "END" );
    ...
    $list26 = ConsesLow.list( makeKeyword( "BALANCING" ), makeKeyword( "STRIPING" ), makeKeyword( "ABDUCTIVE" ) );
    $list27 = ConsesLow.list( ConsesLow.list( makeSymbol( "SUBSTRATEGY-VAR" ), makeSymbol( "STRATEGY" ), makeSymbol( "&KEY" ), makeSymbol( "DONE" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    $list28 = ConsesLow.list( makeKeyword( "DONE" ) );
    $kw29$ALLOW_OTHER_KEYS = makeKeyword( "ALLOW-OTHER-KEYS" );
    $kw30$DONE = makeKeyword( "DONE" );
    ...
    $kw37$NEW_ROOT = makeKeyword( "NEW-ROOT" );
    $kw38$TRANSFORMATION = makeKeyword( "TRANSFORMATION" );
    $kw39$REMOVAL = makeKeyword( "REMOVAL" );
    ...
    $kw42$UNINTERESTING = makeKeyword( "UNINTERESTING" );
    $sym43$BALANCING_TACTICIAN_DO_ONE_STEP = makeSymbol( "BALANCING-TACTICIAN-DO-ONE-STEP" );
    $kw44$RECONSIDER_SET_ASIDES = makeKeyword( "RECONSIDER-SET-ASIDES" );
    $kw45$PROPAGATE_ANSWER_LINK = makeKeyword( "PROPAGATE-ANSWER-LINK" );
    $kw46$INTERESTING = makeKeyword( "INTERESTING" );
    $kw47$MOTIVATION = makeKeyword( "MOTIVATION" );
    ...
    $kw60$RESTRICTION = makeKeyword( "RESTRICTION" );
    $kw61$JOIN_ORDERED = makeKeyword( "JOIN-ORDERED" );
    $sym62$PROBLEM_LINK_P = makeSymbol( "PROBLEM-LINK-P" );
    $kw63$COMPLETE = makeKeyword( "COMPLETE" );
    $kw64$SIMPLIFICATION = makeKeyword( "SIMPLIFICATION" );
    ...
    $kw68$SPLIT = makeKeyword( "SPLIT" );
    $kw69$UNION = makeKeyword( "UNION" );
    $sym70$TRANSFORMATION_STRATEGY_P = makeSymbol( "TRANSFORMATION-STRATEGY-P" );
    $kw71$RESIDUAL_TRANSFORMATION = makeKeyword( "RESIDUAL-TRANSFORMATION" );
    ...
    $kw77$COMPLETE_REMOVAL_TACTIC_NO_GOOD = makeKeyword( "COMPLETE-REMOVAL-TACTIC-NO-GOOD" );
    ...
    $kw79$FINISHED = makeKeyword( "FINISHED" );
    $kw80$NO_GOOD = makeKeyword( "NO-GOOD" );
    $kw81$GOOD = makeKeyword( "GOOD" );
    $kw82$NEUTRAL = makeKeyword( "NEUTRAL" );
    $kw83$POSSIBLE = makeKeyword( "POSSIBLE" );
    $kw84$PENDING = makeKeyword( "PENDING" );
    $kw85$TACTICAL = makeKeyword( "TACTICAL" );
    $kw86$CONNECTED_CONJUNCTION = makeKeyword( "CONNECTED-CONJUNCTION" );
  }

  public static final class $balancing_tactician_data_native
      extends
        SubLStructNative
  {
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $balancing_tactician_data_native.class, $sym2$BALANCING_TACTICIAN_DATA, $sym3$BALANCING_TACTICIAN_DATA_P, $list4, $list5, new String[] { "$new_root_substrategy",
        "$transformation_substrategy", "$removal_substrategies"
      }, $list6, $list7, $sym8$DEFAULT_STRUCT_PRINT_FUNCTION );
    }
  }

  public static final class $balancing_tactician_data_p$UnaryFunction
      extends
        UnaryFunction
  {
