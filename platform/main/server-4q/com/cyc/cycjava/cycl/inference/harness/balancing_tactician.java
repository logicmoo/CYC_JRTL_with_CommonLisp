...
import static com.cyc.cycjava.cycl.inference.harness.balancing_tactician.*;
...
public final class balancing_tactician extends SubLTranslatedFile {
    ...
    public static SubLObject balancing_tactician_data_p(final SubLObject v_object) {
        return v_object.getClass() == balancing_tactician.$balancing_tactician_data_native.class ? T : NIL;
    }

    public static SubLObject bal_tac_data_new_root_substrategy(final SubLObject v_object) {
        assert NIL != balancing_tactician_data_p(v_object) : "balancing_tactician.balancing_tactician_data_p(v_object) " + "CommonSymbols.NIL != balancing_tactician.balancing_tactician_data_p(v_object) " + v_object;
    ...
    public static SubLObject make_balancing_tactician_data(SubLObject arglist) {
        ...
        final SubLObject v_new = new balancing_tactician.$balancing_tactician_data_native();
        SubLObject next;
    ...
    public static final class $balancing_tactician_data_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(balancing_tactician.$balancing_tactician_data_native.class, BALANCING_TACTICIAN_DATA, BALANCING_TACTICIAN_DATA_P, $list4, $list5, new String[]{ "$new_root_substrategy", "$transformation_substrategy", "$removal_substrategies" }, $list6, $list7, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
