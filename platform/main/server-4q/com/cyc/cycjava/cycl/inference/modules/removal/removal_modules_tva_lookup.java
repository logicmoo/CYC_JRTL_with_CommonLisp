...
public class removal_modules_tva_lookup extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_tva_lookup";
    ...
    public static SubLObject declare_removal_modules_tva_lookup_file() {
        ...
        declareFunction(myName, "possible_tva_check_solved_by_other_hl_module", "POSSIBLE-TVA-CHECK-SOLVED-BY-OTHER-HL-MODULE", 1, 2, false);
        declareFunction(myName, "tva_determine_lookup_success", "TVA-DETERMINE-LOOKUP-SUCCESS", 1, 1, false);
        declareFunction(myName, "tva_determine_genl_preds_success", "TVA-DETERMINE-GENL-PREDS-SUCCESS", 1, 1, false);
        declareFunction(myName, "tva_determine_genl_preds_lookup_int", "TVA-DETERMINE-GENL-PREDS-LOOKUP-INT", 1, 0, false);
        declareFunction(myName, "tva_determine_genl_inverse_success", "TVA-DETERMINE-GENL-INVERSE-SUCCESS", 1, 1, false);
        declareFunction(myName, "tva_determine_genl_inverse_lookup_int", "TVA-DETERMINE-GENL-INVERSE-LOOKUP-INT", 1, 0, false);
        declareFunction(myName, "atomic_sentence_valid_wrt_irreflexivityP", "ATOMIC-SENTENCE-VALID-WRT-IRREFLEXIVITY?", 1, 0, false);
        declareFunction(myName, "arguments_valid_wrt_irreflexivityP", "ARGUMENTS-VALID-WRT-IRREFLEXIVITY?", 3, 0, false);
        declareFunction(myName, "tva_check", "TVA-CHECK", 1, 2, false);
        declareFunction(myName, "tva_justify", "TVA-JUSTIFY", 1, 1, false);
        declareFunction(myName, "tva_answer_justification_betterP", "TVA-ANSWER-JUSTIFICATION-BETTER?", 2, 0, false);
        declareFunction(myName, "tva_max_floor_mts_of_just", "TVA-MAX-FLOOR-MTS-OF-JUST", 1, 0, false);
        declareFunction(myName, "new_tva_support_mts_for_support", "NEW-TVA-SUPPORT-MTS-FOR-SUPPORT", 1, 0, false);
        declareFunction(myName, "legacy_tva_support_mts_for_support", "LEGACY-TVA-SUPPORT-MTS-FOR-SUPPORT", 1, 0, false);
        declareFunction(myName, "inference_tva_check", "INFERENCE-TVA-CHECK", 1, 2, false);
        ...
        declareFunction(myName, "make_tva_support", "MAKE-TVA-SUPPORT", 1, 2, false);
        ...
        declareFunction(myName, "tva_unify_usefulP_internal", "TVA-UNIFY-USEFUL?-INTERNAL", 1, 0, false);
        ...
        declareFunction(myName, "removal_tva_unify_cost", "REMOVAL-TVA-UNIFY-COST", 1, 1, false);
        ...
        declareFunction(myName, "removal_tva_unify_closure_required", "REMOVAL-TVA-UNIFY-CLOSURE-REQUIRED", 1, 1, false);
        ...
        declareFunction(myName, "removal_tva_unify_closure_conjunction_applicability", "REMOVAL-TVA-UNIFY-CLOSURE-CONJUNCTION-APPLICABILITY", 1, 0, false);
