...
public final class removal_modules_ist
    extends
      SubLTranslatedFile
{
  ...
  {
    return ConsesLow.list( make_ist_support( mt, sentence ) );
  }
  ...
  {
    final SubLObject ist_sentence = el_utilities.make_binary_formula( $const0$ist, mt, sentence );
    return arguments.make_hl_support( $kw6$QUERY, ist_sentence, mt_vars.$ist_mt$.getGlobalValue(), UNPROVIDED );
  }
  ...
  public static SubLObject removal_ist_pos_gaf_cost(final SubLObject asent, SubLObject sense)
  {
    ...
    try
    {
      ...
      cost = inference_utilities.literal_removal_cost( gaf_sentence, $kw10$POS, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
  ...
  public static SubLObject removal_ist_pos_gaf_completeness(final SubLObject asent, SubLObject sense)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      completeness = inference_utilities.literal_removal_completeness( gaf_sentence, $kw10$POS, UNPROVIDED );
    }
    finally
    {
      mt_relevance_macros.$relevant_mts$.rebind( _prev_bind_3, thread );
  ...
  {
    return inference_trampolines.inference_known_sentence_removal_query( gaf_sentence, mt, $kw15$TRUE );
  }
  ...
  public static SubLObject removal_ist_neg_gaf_cost(final SubLObject asent, SubLObject sense)
  {
    ...
    try
    {
      ...
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.update_inference_mt_relevance_function( mt_var ), thread );
      mt_relevance_macros.$relevant_mts$.bind( mt_relevance_macros.update_inference_mt_relevance_mt_list( mt_var ), thread );
      cost = inference_utilities.literal_removal_cost( gaf_sentence, $kw16$NEG, UNPROVIDED, UNPROVIDED );
    }
    finally
    {
      mt_relevance_macros.$relevant_mts$.rebind( _prev_bind_3, thread );
  ...
  {
    return inference_trampolines.inference_known_sentence_removal_query( gaf_sentence, mt, $kw19$FALSE );
  }
  ...
  public static SubLObject removal_ist_unbound_mt_gaf_lookup_pos_cost(final SubLObject asent, SubLObject sense)
  {
    ...
    try
    {
      ...
      final SubLObject binding_cost = inference_utilities.literal_removal_cost( ist_formula, $kw10$POS, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject removal_ist_unbound_mt_gaf_lookup_pos_expand(final SubLObject asent, SubLObject sense)
  {
    ...
    final SubLObject ist_formula = cycl_utilities.atomic_sentence_arg2( asent, UNPROVIDED );
    SubLObject cdolist_list_var;
    final SubLObject bindings_list = cdolist_list_var = removal_ist_pos_gaf_query( $const25$InferencePSC, ist_formula );
    SubLObject formula_bindings = NIL;
    formula_bindings = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      final SubLObject new_formula = conses_high.sublis( formula_bindings, ist_formula, Symbols.symbol_function( EQL ), UNPROVIDED );
      ...
      while ( NIL != cdolist_list_var_$2)
      {
        ...
        if( NIL == current )
        {
          ...
          while ( NIL != cdolist_list_var_$3)
          {
            ...
            {
              final SubLObject v_bindings = list_utilities.fast_remove_duplicates( ConsesLow.append( mt_bindings, formula_bindings ), Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  {
    return ConsesLow.list( make_ist_asserted_support( assertion ) );
  }
  ...
  public static SubLObject make_ist_asserted_support(final SubLObject assertion)
  {
    ...
    final SubLObject ist_asserted_sentence = el_utilities.make_binary_formula( $const28$ist_Asserted, mt, sentence );
    return arguments.make_hl_support( $kw6$QUERY, ist_asserted_sentence, mt_vars.$ist_mt$.getGlobalValue(), UNPROVIDED );
  }
  ...
  public static SubLObject removal_ist_asserted_gaf_iterator(final SubLObject mt, final SubLObject formula)
  {
    ...
    try
    {
      ...
      while ( NIL != cdolist_list_var)
      {
              ...
              if( NIL != kb_mapping_macros.do_gaf_arg_index_key_validator( v_term, argnum, pred_var ) )
              {
                ...
                while ( NIL == done_var)
                {
                  ...
                  if( NIL != valid )
                  {
                    ...
                    try
                    {
                      final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, $kw31$GAF, enumeration_types.sense_truth( sub_sense ), NIL );
        ...
        else if( pcase_var.eql( $kw32$PREDICATE_EXTENT ) )
        {
            ...
            try
            {
              ...
              while ( NIL == done_var2)
              {
                ...
                if( NIL != valid2 )
                {
                  ...
                  try
                  {
                    final_index_iterator2 = kb_mapping_macros.new_final_index_iterator( final_index_spec2, $kw31$GAF, enumeration_types.sense_truth( sub_sense ), NIL );
        ...
        else if( pcase_var.eql( $kw33$OVERLAP ) )
        {
          ...
          while ( NIL != cdolist_list_var_$26)
          {
            if( ( NIL == enumeration_types.sense_truth( sub_sense ) || NIL != assertions_high.assertion_has_truth( assertion3, enumeration_types.sense_truth( sub_sense ) ) ) && NIL != backward_utilities
                .direction_is_relevant( assertion3 ) && enumeration_types.truth_sense( assertions_high.assertion_truth( assertion3 ) ).eql( sub_sense ) )
            {
              thread.resetMultipleValues();
  ...
  {
    return makeBoolean( !v_object.eql( $const35$not ) && NIL != forts.fort_p( v_object ) );
  }
  ...
  public static SubLObject removal_ist_asserted_unbound_lookup_pos_required(final SubLObject asent, SubLObject sense)
  {
    ...
    final SubLObject formula = el_utilities.literal_atomic_sentence( cycl_utilities.atomic_sentence_arg2( asent, UNPROVIDED ) );
  ...
  public static SubLObject removal_ist_asserted_mt_contents_iterator(final SubLObject mt, final SubLObject formula)
  {
    ...
    if( pcase_var.eql( $kw41$MT ) )
    {
      if( NIL != kb_mapping_macros.do_mt_index_key_validator( mt, $kw31$GAF ) )
      {
    ...
    else if( pcase_var.eql( $kw42$BROAD_MT ) && NIL != kb_mapping_macros.do_broad_mt_index_key_validator( mt, $kw31$GAF ) )
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if( NIL == id_index.id_index_objects_empty_p( idx_$27, $kw45$SKIP ) )
          {
            final SubLObject idx_$28 = idx_$27;
            if( NIL == id_index.id_index_dense_objects_empty_p( idx_$28, $kw45$SKIP ) )
            {
              ...
              for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
              {
                ...
                if( NIL == id_index.id_index_tombstone_p( a_handle ) || NIL == id_index.id_index_skip_tombstones_p( $kw45$SKIP ) )
                {
                  ...
                  if( NIL != kb_mapping_macros.do_broad_mt_index_match_p( assertion2, mt, $kw31$GAF, NIL ) && NIL != backward_utilities.direction_is_relevant( assertion2 ) )
                  {
            ...
            if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$29 ) || NIL == id_index.id_index_skip_tombstones_p( $kw45$SKIP ) )
            {
              ...
              while ( a_id2.numL( end_id ))
              {
                ...
                if( NIL == id_index.id_index_skip_tombstones_p( $kw45$SKIP ) || NIL == id_index.id_index_tombstone_p( a_handle2 ) )
                {
                  ...
                  if( NIL != kb_mapping_macros.do_broad_mt_index_match_p( assertion3, mt, $kw31$GAF, NIL ) && NIL != backward_utilities.direction_is_relevant( assertion3 ) )
                  {
  ...
  public static SubLObject removal_ist_asserted_gaf_lookup_neg_expand(final SubLObject asent, SubLObject sense)
  {
    ...
    if( NIL == found )
    {
      backward.removal_add_node( arguments.make_hl_support( $kw48$MINIMIZE, cycl_utilities.negate( asent ), UNPROVIDED, UNPROVIDED ), UNPROVIDED, UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject removal_ist_asserted_unbound_mt_gaf_lookup_pos_required(final SubLObject asent, SubLObject sense)
  {
    ...
    final SubLObject ist_formula = el_utilities.literal_atomic_sentence( cycl_utilities.atomic_sentence_arg2( asent, UNPROVIDED ) );
          ...
          else if( pcase_var.eql( $kw33$OVERLAP ) )
          {
            ...
            while ( NIL != cdolist_list_var_$54)
            {
              if( NIL == enumeration_types.sense_truth( sub_sense ) || NIL != assertions_high.assertion_has_truth( assertion4, enumeration_types.sense_truth( sub_sense ) ) )
              {
                ...
                if( NIL != v_bindings4 )
                {
                  result = ConsesLow.cons( ConsesLow.list( v_bindings4, assertion4 ), result );
                }
              }
  ...
  public static SubLObject removal_ist_asserted_unify(final SubLObject assertion, final SubLObject inference_literal, final SubLObject mt)
  {
    ...
    if( NIL != backward_utilities.direction_is_relevant( assertion ) )
    {
      ...
      SubLObject gaf_asent = el_utilities.make_binary_formula( $const28$ist_Asserted, gaf_mt, gaf_formula );
      SubLObject inf_asent = el_utilities.make_binary_formula( $const28$ist_Asserted, mt, inference_literal );
      thread.resetMultipleValues();
  ...
  public static SubLObject possibly_simplify_ist_sentences_for_unify(SubLObject inference_asent, SubLObject gaf_asent)
  {
    if( NIL != el_utilities.ist_sentence_p( inference_asent, T ) && NIL != el_utilities.ist_sentence_p( gaf_asent, T ) )
    {
      ...
      if( NIL != variables.fully_bound_p( gaf_asent_mt ) && NIL != variables.fully_bound_p( inference_asent_mt ) && NIL != genl_predicates.genl_predP( gaf_asent_predicate, inference_asent_predicate, UNPROVIDED,
          UNPROVIDED ) && ( NIL != kb_utilities.kbeq( gaf_asent_mt, inference_asent_mt ) || ( NIL == kb_utilities.kbeq( inference_asent_predicate, $const28$ist_Asserted ) && NIL != mt_relevance_macros.mt_relevant_to_mtP(
              gaf_asent_mt, inference_asent_mt ) ) ) )
      {
  ...
  {
    SubLFiles.declareFunction( me, "make_ist_supports", "MAKE-IST-SUPPORTS", 2, 0, false );
    SubLFiles.declareFunction( me, "make_ist_justification", "MAKE-IST-JUSTIFICATION", 2, 0, false );
    SubLFiles.declareFunction( me, "make_ist_support", "MAKE-IST-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_formula_check_expand", "REMOVAL-IST-FORMULA-CHECK-EXPAND", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_check_query", "REMOVAL-IST-CHECK-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_pos_gaf_required", "REMOVAL-IST-POS-GAF-REQUIRED", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_pos_gaf_cost", "REMOVAL-IST-POS-GAF-COST", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_pos_gaf_expand", "REMOVAL-IST-POS-GAF-EXPAND", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_pos_gaf_completeness", "REMOVAL-IST-POS-GAF-COMPLETENESS", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_pos_gaf_query", "REMOVAL-IST-POS-GAF-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_neg_gaf_cost", "REMOVAL-IST-NEG-GAF-COST", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_neg_gaf_expand", "REMOVAL-IST-NEG-GAF-EXPAND", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_neg_gaf_query", "REMOVAL-IST-NEG-GAF-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_pos_gaf_mt_lookup_expand", "REMOVAL-IST-POS-GAF-MT-LOOKUP-EXPAND", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_unbound_mt_gaf_lookup_pos_cost", "REMOVAL-IST-UNBOUND-MT-GAF-LOOKUP-POS-COST", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_unbound_mt_gaf_lookup_pos_expand", "REMOVAL-IST-UNBOUND-MT-GAF-LOOKUP-POS-EXPAND", 1, 1, false );
    SubLFiles.declareFunction( me, "make_ist_asserted_justification", "MAKE-IST-ASSERTED-JUSTIFICATION", 1, 0, false );
    SubLFiles.declareFunction( me, "make_ist_asserted_support", "MAKE-IST-ASSERTED-SUPPORT", 1, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_gaf_lookup_pos_cost", "REMOVAL-IST-ASSERTED-GAF-LOOKUP-POS-COST", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_gaf_iterator", "REMOVAL-IST-ASSERTED-GAF-ITERATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_pred_fort", "REMOVAL-IST-ASSERTED-PRED-FORT", 1, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_gaf_lookup_cost", "REMOVAL-IST-ASSERTED-GAF-LOOKUP-COST", 1, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unbound_lookup_pos_required", "REMOVAL-IST-ASSERTED-UNBOUND-LOOKUP-POS-REQUIRED", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unbound_lookup_pos_cost", "REMOVAL-IST-ASSERTED-UNBOUND-LOOKUP-POS-COST", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unbound_lookup_iterator", "REMOVAL-IST-ASSERTED-UNBOUND-LOOKUP-ITERATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_mt_contents_required", "REMOVAL-IST-ASSERTED-MT-CONTENTS-REQUIRED", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_mt_contents_cost", "REMOVAL-IST-ASSERTED-MT-CONTENTS-COST", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_mt_contents_iterator", "REMOVAL-IST-ASSERTED-MT-CONTENTS-ITERATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_gaf_lookup_neg_cost", "REMOVAL-IST-ASSERTED-GAF-LOOKUP-NEG-COST", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_gaf_lookup_neg_expand", "REMOVAL-IST-ASSERTED-GAF-LOOKUP-NEG-EXPAND", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_gaf_lookup_neg_expand_internal", "REMOVAL-IST-ASSERTED-GAF-LOOKUP-NEG-EXPAND-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unbound_mt_gaf_lookup_pos_required", "REMOVAL-IST-ASSERTED-UNBOUND-MT-GAF-LOOKUP-POS-REQUIRED", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unbound_mt_gaf_lookup_pos_cost", "REMOVAL-IST-ASSERTED-UNBOUND-MT-GAF-LOOKUP-POS-COST", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unbound_mt_gaf_lookup_iterator", "REMOVAL-IST-ASSERTED-UNBOUND-MT-GAF-LOOKUP-ITERATOR", 1, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unbound_mt_gaf_lookup_cost", "REMOVAL-IST-ASSERTED-UNBOUND-MT-GAF-LOOKUP-COST", 1, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unify", "REMOVAL-IST-ASSERTED-UNIFY", 3, 0, false );
    SubLFiles.declareFunction( me, "possibly_simplify_ist_sentences_for_unify", "POSSIBLY-SIMPLIFY-IST-SENTENCES-FOR-UNIFY", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unbound_mt_unbound_pred_lookup_pos_required", "REMOVAL-IST-ASSERTED-UNBOUND-MT-UNBOUND-PRED-LOOKUP-POS-REQUIRED", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unbound_mt_unbound_pred_lookup_pos_cost", "REMOVAL-IST-ASSERTED-UNBOUND-MT-UNBOUND-PRED-LOOKUP-POS-COST", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_ist_asserted_unbound_mt_unbound_pred_lookup_pos_iterator", "REMOVAL-IST-ASSERTED-UNBOUND-MT-UNBOUND-PRED-LOOKUP-POS-ITERATOR", 1, 0, false );
    return NIL;
  }

  public static SubLObject init_removal_modules_ist_file()
  {
    $default_ist_formula_check_cost$ = SubLFiles.defparameter( "*DEFAULT-IST-FORMULA-CHECK-COST*", $float7$1_5 );
    $estimated_mts_per_formula$ = SubLFiles.defparameter( "*ESTIMATED-MTS-PER-FORMULA*", TWO_INTEGER );
    $default_ist_pos_gaf_mt_lookup_cost$ = SubLFiles.defparameter( "*DEFAULT-IST-POS-GAF-MT-LOOKUP-COST*", $estimated_mts_per_formula$.getDynamicValue() );
    return NIL;
  }

  public static SubLObject setup_removal_modules_ist_file()
  {
    inference_modules.register_solely_specific_removal_module_predicate( $const0$ist );
    preference_modules.inference_preference_module( $kw1$IST_MT_PROP_POS, $list2 );
    preference_modules.inference_preference_module( $kw3$IST_IN_WHAT_MTS_POS, $list4 );
    inference_modules.inference_removal_module( $kw8$REMOVAL_IST_FORMULA_CHECK, $list9 );
    inference_modules.inference_removal_module( $kw11$REMOVAL_IST_POS_GAF, $list12 );
    inference_modules.inference_removal_module( $kw13$REMOVAL_IST_PRED_UNBOUND_POS_GAF, $list14 );
    inference_modules.inference_removal_module( $kw17$REMOVAL_IST_NEG_GAF, $list18 );
    inference_modules.inference_removal_module( $kw21$REMOVAL_IST_POS_GAF_MT_LOOKUP, $list22 );
    inference_modules.inference_removal_module( $kw26$REMOVAL_IST_UNBOUND_MT_GAF_LOOKUP_POS, $list27 );
    inference_modules.register_solely_specific_removal_module_predicate( $const28$ist_Asserted );
    inference_modules.inference_removal_module( $kw36$REMOVAL_IST_ASSERTED_GAF_LOOKUP_POS, $list37 );
    inference_modules.inference_removal_module( $kw39$REMOVAL_IST_ASSERTED_UNBOUND_LOOKUP_POS, $list40 );
    inference_modules.inference_removal_module( $kw46$REMOVAL_IST_ASSERTED_MT_CONTENTS, $list47 );
    inference_modules.inference_removal_module( $kw49$REMOVAL_IST_ASSERTED_GAF_LOOKUP_NEG, $list50 );
    inference_modules.inference_removal_module( $kw51$REMOVAL_IST_ASSERTED_UNBOUND_MT_GAF_LOOKUP_POS, $list52 );
    inference_modules.inference_removal_module( $kw53$REMOVAL_IST_ASSERTED_UNBOUND_MT_UNBOUND_PRED_LOOKUP_POS, $list54 );
    return NIL;
  }
  ...
  static
  {
    ...
    $const0$ist = constant_handles.reader_make_constant_shell( makeString( "ist" ) );
    $kw1$IST_MT_PROP_POS = makeKeyword( "IST-MT-PROP-POS" );
    $list2 = ConsesLow.list( makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword( "REQUIRED-PATTERN" ), ConsesLow
        .list( constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword( "NOT-FULLY-BOUND" ), makeKeyword( "VARIABLE" ) ), makeKeyword( "PREFERENCE-LEVEL" ), makeKeyword( "DISALLOWED" ) );
    $kw3$IST_IN_WHAT_MTS_POS = makeKeyword( "IST-IN-WHAT-MTS-POS" );
    $list4 = ConsesLow.list( makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword( "REQUIRED-PATTERN" ), ConsesLow
        .list( constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword( "NOT-FULLY-BOUND" ), ConsesLow.list( makeKeyword( "NOT" ), makeKeyword( "VARIABLE" ) ) ), makeKeyword( "PREFERENCE-LEVEL" ),
        makeKeyword( "GROSSLY-DISPREFERRED" ) );
    $list5 = ConsesLow.list( makeSymbol( "SUPPORT" ), makeSymbol( "&REST" ), makeSymbol( "MORE-SUPPORTS" ) );
    $kw6$QUERY = makeKeyword( "QUERY" );
    $float7$1_5 = makeDouble( 1.5 );
    $kw8$REMOVAL_IST_FORMULA_CHECK = makeKeyword( "REMOVAL-IST-FORMULA-CHECK" );
    $list9 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword( "CLOSED-HLMT" ), ConsesLow.list( makeKeyword( "AND" ), ConsesLow.cons( makeKeyword(
            "FULLY-BOUND" ), makeKeyword( "FULLY-BOUND" ) ), ConsesLow.list( makeKeyword( "NOT" ), ConsesLow.cons( ConsesLow.list( makeKeyword( "TEST" ), makeSymbol( "INFERENCE-PREDICATE-P" ) ), makeKeyword(
                "ANYTHING" ) ) ), ConsesLow.list( makeKeyword( "NOT" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "not" ) ), ConsesLow.cons( ConsesLow.list( makeKeyword( "TEST" ),
                    makeSymbol( "INFERENCE-PREDICATE-P" ) ), makeKeyword( "ANYTHING" ) ) ) ) ) ), makeKeyword( "COST-EXPRESSION" ), makeSymbol( "*DEFAULT-IST-FORMULA-CHECK-COST*" ), makeKeyword( "EXPAND" ), makeSymbol(
                        "REMOVAL-IST-FORMULA-CHECK-EXPAND" ), makeKeyword( "DOCUMENTATION" ), makeString(
                            "(#$ist <mt> (<non-predicate> . <fully-bound>))\n    by recursively querying sentence in <mt>\n    and succeeding if the query succeeds" ), makeKeyword( "EXAMPLE" ), makeString(
                                "(#$ist #$BaseKB\n     (#$thereExists ?SPEC\n      (#$genls ?SPEC #$BinaryRelation)))" )
    } );
    $kw10$POS = makeKeyword( "POS" );
    $kw11$REMOVAL_IST_POS_GAF = makeKeyword( "REMOVAL-IST-POS-GAF" );
    $list12 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword( "CLOSED-HLMT" ), ConsesLow.cons( ConsesLow.list( makeKeyword( "TEST" ), makeSymbol(
            "INFERENCE-PREDICATE-P" ) ), makeKeyword( "ANYTHING" ) ) ), makeKeyword( "REQUIRED" ), makeSymbol( "REMOVAL-IST-POS-GAF-REQUIRED" ), makeKeyword( "COST" ), makeSymbol( "REMOVAL-IST-POS-GAF-COST" ),
      makeKeyword( "EXPAND" ), makeSymbol( "REMOVAL-IST-POS-GAF-EXPAND" ), makeKeyword( "COMPLETENESS-PATTERN" ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol( "REMOVAL-IST-POS-GAF-COMPLETENESS" ), makeKeyword(
          "INPUT" ) ), makeKeyword( "DOCUMENTATION" ), makeString( "(#$ist <mt> (<predicate> . <whatever>))\n    by recursively querying sentence (<predicate> . <whatever>)\n    in <mt>" ), makeKeyword( "EXAMPLE" ),
      makeString( "(#$ist #$BaseKB\n     (#$genls ?SPEC #$BinaryRelation))" )
    } );
    $kw13$REMOVAL_IST_PRED_UNBOUND_POS_GAF = makeKeyword( "REMOVAL-IST-PRED-UNBOUND-POS-GAF" );
    $list14 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword( "CLOSED-HLMT" ), ConsesLow.cons( makeKeyword( "NOT-FULLY-BOUND" ), makeKeyword(
            "ANYTHING" ) ) ), makeKeyword( "REQUIRED" ), makeSymbol( "REMOVAL-IST-POS-GAF-REQUIRED" ), makeKeyword( "COST" ), makeSymbol( "REMOVAL-IST-POS-GAF-COST" ), makeKeyword( "EXPAND" ), makeSymbol(
                "REMOVAL-IST-POS-GAF-EXPAND" ), makeKeyword( "COMPLETENESS-PATTERN" ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol( "REMOVAL-IST-POS-GAF-COMPLETENESS" ), makeKeyword( "INPUT" ) ), makeKeyword(
                    "DOCUMENTATION" ), makeString( "(#$ist <mt> (<variable> . <whatever>))\n    by recursively querying sentence (<variable> . <whatever>)\n    in <mt>" ), makeKeyword( "EXAMPLE" ), makeString(
                        "(#$ist #$BaseKB\n     (?PRED ?SPEC #$BinaryRelation))" )
    } );
    $kw15$TRUE = makeKeyword( "TRUE" );
    $kw16$NEG = makeKeyword( "NEG" );
    $kw17$REMOVAL_IST_NEG_GAF = makeKeyword( "REMOVAL-IST-NEG-GAF" );
    $list18 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword( "CLOSED-HLMT" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString(
            "not" ) ), ConsesLow.cons( ConsesLow.list( makeKeyword( "TEST" ), makeSymbol( "INFERENCE-PREDICATE-P" ) ), makeKeyword( "FULLY-BOUND" ) ) ) ), makeKeyword( "COST" ), makeSymbol( "REMOVAL-IST-NEG-GAF-COST" ),
      makeKeyword( "EXPAND" ), makeSymbol( "REMOVAL-IST-NEG-GAF-EXPAND" ), makeKeyword( "DOCUMENTATION" ), makeString(
          "(#$ist <mt> (#$not (<predicate> . <fully-bound>)))\n    by recursively querying sentence (#$not (<predicate> . <fully-bound>))\n    in <mt>" ), makeKeyword( "EXAMPLE" ), makeString(
              "(#$ist #$BaseKB\n     (#$not (#$genls #$Microtheory #$BinaryPredicate)))" )
    } );
    $kw19$FALSE = makeKeyword( "FALSE" );
    $list20 = ConsesLow.list( makeSymbol( "MTS" ), makeSymbol( "JUSTIFICATION" ) );
    $kw21$REMOVAL_IST_POS_GAF_MT_LOOKUP = makeKeyword( "REMOVAL-IST-POS-GAF-MT-LOOKUP" );
    $list22 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword( "NOT-FULLY-BOUND" ), ConsesLow.cons( ConsesLow.list( makeKeyword( "TEST" ), makeSymbol(
            "INFERENCE-PREDICATE-P" ) ), makeKeyword( "FULLY-BOUND" ) ) ), makeKeyword( "COST-EXPRESSION" ), makeSymbol( "*DEFAULT-IST-POS-GAF-MT-LOOKUP-COST*" ), makeKeyword( "COMPLETENESS" ), makeKeyword(
                "GROSSLY-INCOMPLETE" ), makeKeyword( "EXPAND" ), makeSymbol( "REMOVAL-IST-POS-GAF-MT-LOOKUP-EXPAND" ), makeKeyword( "DOCUMENTATION" ), makeString(
                    "(#$ist <not fully-bound> (<predicate> . <fully-bound>)))\n    by recursively querying formula in #$InferencePSC\n    and computing appropriate mts from the justification." ), makeKeyword(
                        "EXAMPLE" ), makeString( "(#$ist ?MT (#$genls #$BinaryPredicate #$Relation))" )
    } );
    ...
    $const25$InferencePSC = constant_handles.reader_make_constant_shell( makeString( "InferencePSC" ) );
    $kw26$REMOVAL_IST_UNBOUND_MT_GAF_LOOKUP_POS = makeKeyword( "REMOVAL-IST-UNBOUND-MT-GAF-LOOKUP-POS" );
    $list27 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist" ) ), makeKeyword( "NOT-FULLY-BOUND" ), ConsesLow.cons( ConsesLow.list( makeKeyword( "TEST" ), makeSymbol(
            "INFERENCE-PREDICATE-P" ) ), makeKeyword( "NOT-FULLY-BOUND" ) ) ), makeKeyword( "COST" ), makeSymbol( "REMOVAL-IST-UNBOUND-MT-GAF-LOOKUP-POS-COST" ), makeKeyword( "COMPLETENESS" ), makeKeyword(
                "GROSSLY-INCOMPLETE" ), makeKeyword( "EXPAND" ), makeSymbol( "REMOVAL-IST-UNBOUND-MT-GAF-LOOKUP-POS-EXPAND" ), makeKeyword( "DOCUMENTATION" ), makeString( "(#$ist <not-fully-bound> <not-fully-bound>)" ),
      makeKeyword( "EXAMPLE" ), makeString( "(#$ist ?MT (#$acquaintedWith #$ThomasPynchon ?WHO))" )
    } );
    $const28$ist_Asserted = constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) );
    $sym29$RELEVANT_MT_IS_EQ = makeSymbol( "RELEVANT-MT-IS-EQ" );
    $kw30$GAF_ARG = makeKeyword( "GAF-ARG" );
    $kw31$GAF = makeKeyword( "GAF" );
    $kw32$PREDICATE_EXTENT = makeKeyword( "PREDICATE-EXTENT" );
    $kw33$OVERLAP = makeKeyword( "OVERLAP" );
    $sym34$HL_VAR_ = makeSymbol( "HL-VAR?" );
    $const35$not = constant_handles.reader_make_constant_shell( makeString( "not" ) );
    $kw36$REMOVAL_IST_ASSERTED_GAF_LOOKUP_POS = makeKeyword( "REMOVAL-IST-ASSERTED-GAF-LOOKUP-POS" );
    $list37 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword( "CLOSED-HLMT" ), ConsesLow.list( makeKeyword( "OR" ), ConsesLow.cons( ConsesLow
            .list( makeKeyword( "TEST" ), makeSymbol( "REMOVAL-IST-ASSERTED-PRED-FORT" ) ), makeKeyword( "ANYTHING" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "not" ) ), ConsesLow.cons(
                makeKeyword( "FORT" ), makeKeyword( "ANYTHING" ) ) ) ) ), makeKeyword( "COST" ), makeSymbol( "REMOVAL-IST-ASSERTED-GAF-LOOKUP-POS-COST" ), makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ),
      makeKeyword( "INPUT-EXTRACT-PATTERN" ), ConsesLow.list( makeKeyword( "TEMPLATE" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), ConsesLow.list( makeKeyword( "BIND" ),
          makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "FORMULA" ) ) ), ConsesLow.list( ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword( "VALUE" ),
              makeSymbol( "FORMULA" ) ) ) ), makeKeyword( "OUTPUT-GENERATE-PATTERN" ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol( "REMOVAL-IST-ASSERTED-GAF-ITERATOR" ), ConsesLow.list( makeKeyword( "VALUE" ),
                  makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "FORMULA" ) ) ), makeKeyword( "OUTPUT-DECODE-PATTERN" ), ConsesLow.list( makeKeyword( "TEMPLATE" ), ConsesLow.list( ConsesLow
                      .list( makeKeyword( "BIND" ), makeSymbol( "BINDINGS" ) ), ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "ASSERTION" ) ) ), ConsesLow.list( ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol(
                          "BINDINGS" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASSERTION" ) ) ) ), makeKeyword( "OUTPUT-CONSTRUCT-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell(
                              makeString( "ist-Asserted" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol( "SUBST-BINDINGS" ), ConsesLow.list(
                                  makeKeyword( "VALUE" ), makeSymbol( "BINDINGS" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "FORMULA" ) ) ) ), makeKeyword( "SUPPORT-PATTERN" ), ConsesLow.list( makeKeyword(
                                      "CALL" ), makeSymbol( "MAKE-IST-ASSERTED-JUSTIFICATION" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASSERTION" ) ) ), makeKeyword( "DOCUMENTATION" ), makeString(
                                          "(#$ist-Asserted <mt> (<predicate> . <whatever>))\nusing only the KB GAF indexing and explicit assertions in ARG1 MT involving <predicate>" ), makeKeyword( "EXAMPLE" ),
      makeString( "(#$ist-Asserted #$LogicalTruthMt (#$genls #$Predicate ?WHAT))" )
    } );
    $sym38$FORT_P = makeSymbol( "FORT-P" );
    $kw39$REMOVAL_IST_ASSERTED_UNBOUND_LOOKUP_POS = makeKeyword( "REMOVAL-IST-ASSERTED-UNBOUND-LOOKUP-POS" );
    $list40 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword( "CLOSED-HLMT" ), ConsesLow.list( makeKeyword( "OR" ), ConsesLow.cons( ConsesLow
            .list( makeKeyword( "NOT" ), makeKeyword( "FORT" ) ), makeKeyword( "ANYTHING" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "not" ) ), ConsesLow.cons( ConsesLow.list(
                makeKeyword( "NOT" ), makeKeyword( "FORT" ) ), makeKeyword( "ANYTHING" ) ) ) ) ), makeKeyword( "REQUIRED" ), makeSymbol( "REMOVAL-IST-ASSERTED-UNBOUND-LOOKUP-POS-REQUIRED" ), makeKeyword( "COST" ),
      makeSymbol( "REMOVAL-IST-ASSERTED-UNBOUND-LOOKUP-POS-COST" ), makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ), makeKeyword( "INPUT-EXTRACT-PATTERN" ), ConsesLow.list( makeKeyword( "TEMPLATE" ), ConsesLow
          .list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword( "BIND" ), makeSymbol(
              "FORMULA" ) ) ), ConsesLow.list( ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "FORMULA" ) ) ) ), makeKeyword(
                  "OUTPUT-GENERATE-PATTERN" ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol( "REMOVAL-IST-ASSERTED-UNBOUND-LOOKUP-ITERATOR" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "MT" ) ), ConsesLow
                      .list( makeKeyword( "VALUE" ), makeSymbol( "FORMULA" ) ) ), makeKeyword( "OUTPUT-DECODE-PATTERN" ), ConsesLow.list( makeKeyword( "TEMPLATE" ), ConsesLow.list( ConsesLow.list( makeKeyword( "BIND" ),
                          makeSymbol( "BINDINGS" ) ), ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "ASSERTION" ) ) ), ConsesLow.list( ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "BINDINGS" ) ), ConsesLow
                              .list( makeKeyword( "VALUE" ), makeSymbol( "ASSERTION" ) ) ) ), makeKeyword( "OUTPUT-CONSTRUCT-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString(
                                  "ist-Asserted" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol( "SUBST-BINDINGS" ), ConsesLow.list( makeKeyword(
                                      "VALUE" ), makeSymbol( "BINDINGS" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "FORMULA" ) ) ) ), makeKeyword( "SUPPORT-PATTERN" ), ConsesLow.list( makeKeyword( "CALL" ),
                                          makeSymbol( "MAKE-IST-ASSERTED-JUSTIFICATION" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASSERTION" ) ) ), makeKeyword( "DOCUMENTATION" ), makeString(
                                              "(#$ist-Asserted <mt> (<not fully-bound> ... <fort> ...))\nwhere <mt> is a chlmt-p\nusing only the KB GAF indexing and explicit assertions involving <fort>" ), makeKeyword(
                                                  "EXAMPLE" ), makeString( "(#$ist-Asserted #$LogicalTruthMt (?PRED #$Predicate ?WHAT))" )
    } );
    $kw41$MT = makeKeyword( "MT" );
    $kw42$BROAD_MT = makeKeyword( "BROAD-MT" );
    $str43$do_broad_mt_index = makeString( "do-broad-mt-index" );
    $sym44$STRINGP = makeSymbol( "STRINGP" );
    $kw45$SKIP = makeKeyword( "SKIP" );
    $kw46$REMOVAL_IST_ASSERTED_MT_CONTENTS = makeKeyword( "REMOVAL-IST-ASSERTED-MT-CONTENTS" );
    $list47 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword( "CLOSED-HLMT" ), makeKeyword( "NOT-FULLY-BOUND" ) ), makeKeyword( "REQUIRED" ),
      makeSymbol( "REMOVAL-IST-ASSERTED-MT-CONTENTS-REQUIRED" ), makeKeyword( "COST" ), makeSymbol( "REMOVAL-IST-ASSERTED-MT-CONTENTS-COST" ), makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ), makeKeyword(
          "INPUT-EXTRACT-PATTERN" ), ConsesLow.list( makeKeyword( "TEMPLATE" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), ConsesLow.list( makeKeyword( "BIND" ),
              makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "FORMULA" ) ) ), ConsesLow.list( ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword(
                  "VALUE" ), makeSymbol( "FORMULA" ) ) ) ), makeKeyword( "OUTPUT-GENERATE-PATTERN" ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol( "REMOVAL-IST-ASSERTED-MT-CONTENTS-ITERATOR" ), ConsesLow.list(
                      makeKeyword( "VALUE" ), makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "FORMULA" ) ) ), makeKeyword( "OUTPUT-DECODE-PATTERN" ), ConsesLow.list( makeKeyword( "TEMPLATE" ),
                          ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "ASSERTION" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASSERTION" ) ) ), makeKeyword( "OUTPUT-CONSTRUCT-PATTERN" ), ConsesLow
                              .list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "MT" ) ), ConsesLow.list( makeKeyword( "CALL" ),
                                  makeSymbol( "GAF-EL-FORMULA" ), makeKeyword( "INPUT" ) ) ), makeKeyword( "SUPPORT-PATTERN" ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol( "MAKE-IST-ASSERTED-JUSTIFICATION" ),
                                      ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASSERTION" ) ) ), makeKeyword( "DOCUMENTATION" ), makeString(
                                          "(#$ist-Asserted <fort> <variable>)\nusing only the KB MT indexing and explicit GAF assertions in ARG1 MT" ), makeKeyword( "EXAMPLE" ), makeString(
                                              "(#$ist-Asserted #$ChristmasMythologyMt ?FORMULA)" )
    } );
    $kw48$MINIMIZE = makeKeyword( "MINIMIZE" );
    $kw49$REMOVAL_IST_ASSERTED_GAF_LOOKUP_NEG = makeKeyword( "REMOVAL-IST-ASSERTED-GAF-LOOKUP-NEG" );
    $list50 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "NEG" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword( "FORT" ), ConsesLow.list( makeKeyword( "OR" ), ConsesLow.cons( ConsesLow.list(
            makeKeyword( "TEST" ), makeSymbol( "REMOVAL-IST-ASSERTED-PRED-FORT" ) ), makeKeyword( "FULLY-BOUND" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "not" ) ), ConsesLow.cons(
                makeKeyword( "FORT" ), makeKeyword( "FULLY-BOUND" ) ) ) ) ), makeKeyword( "COST" ), makeSymbol( "REMOVAL-IST-ASSERTED-GAF-LOOKUP-NEG-COST" ), makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ),
      makeKeyword( "EXPAND" ), makeSymbol( "REMOVAL-IST-ASSERTED-GAF-LOOKUP-NEG-EXPAND" ), makeKeyword( "DOCUMENTATION" ), makeString(
          "(#$not (#$ist-Asserted <fort> (<predicate> . <fully-bound>)))\nusing only the KB GAF indexing and explicit assertions in ARG1 MT involving <predicate>" ), makeKeyword( "EXAMPLE" ), makeString(
              "(#$not (#$ist-Asserted #$LogicalTruthMt (#$genls #$Predicate #$Thing)))" )
    } );
    $kw51$REMOVAL_IST_ASSERTED_UNBOUND_MT_GAF_LOOKUP_POS = makeKeyword( "REMOVAL-IST-ASSERTED-UNBOUND-MT-GAF-LOOKUP-POS" );
    $list52 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword( "NOT-FULLY-BOUND" ), ConsesLow.list( makeKeyword( "OR" ), ConsesLow.cons( ConsesLow
            .list( makeKeyword( "TEST" ), makeSymbol( "REMOVAL-IST-ASSERTED-PRED-FORT" ) ), makeKeyword( "ANYTHING" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "not" ) ), ConsesLow.cons(
                makeKeyword( "FORT" ), makeKeyword( "ANYTHING" ) ) ) ) ), makeKeyword( "REQUIRED" ), makeSymbol( "REMOVAL-IST-ASSERTED-UNBOUND-MT-GAF-LOOKUP-POS-REQUIRED" ), makeKeyword( "COST" ), makeSymbol(
                    "REMOVAL-IST-ASSERTED-UNBOUND-MT-GAF-LOOKUP-POS-COST" ), makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ), makeKeyword( "INPUT-EXTRACT-PATTERN" ), ConsesLow.list( makeKeyword( "TEMPLATE" ),
                        ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "ASENT" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASENT" ) ) ), makeKeyword( "OUTPUT-GENERATE-PATTERN" ), ConsesLow.list(
                            makeKeyword( "CALL" ), makeSymbol( "REMOVAL-IST-ASSERTED-UNBOUND-MT-GAF-LOOKUP-ITERATOR" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASENT" ) ) ), makeKeyword(
                                "OUTPUT-DECODE-PATTERN" ), ConsesLow.list( makeKeyword( "TEMPLATE" ), ConsesLow.list( ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "BINDINGS" ) ), ConsesLow.list( makeKeyword(
                                    "BIND" ), makeSymbol( "ASSERTION" ) ) ), ConsesLow.list( ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "BINDINGS" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol(
                                        "ASSERTION" ) ) ) ), makeKeyword( "OUTPUT-CONSTRUCT-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), ConsesLow.list(
                                            makeKeyword( "CALL" ), makeSymbol( "ASSERTION-MT" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASSERTION" ) ) ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol(
                                                "SUBST-BINDINGS" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "BINDINGS" ) ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol( "ATOMIC-SENTENCE-ARG2" ),
                                                    ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASENT" ) ) ) ) ), makeKeyword( "SUPPORT-PATTERN" ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol(
                                                        "MAKE-IST-ASSERTED-JUSTIFICATION" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASSERTION" ) ) ), makeKeyword( "DOCUMENTATION" ), makeString(
                                                            "(#$ist-Asserted <not fully-bound> (<predicate> . <anything>))\nusing only the KB GAF indexing and explicit assertions in ARG1 MT involving <predicate>" ),
      makeKeyword( "EXAMPLE" ), makeString( "(#$ist-Asserted ?MT (#$genls #$Dog #$CanineAnimal))\n    (#$ist-Asserted ?MT (#$genls #$Dog ?WHAT))" )
    } );
    $kw53$REMOVAL_IST_ASSERTED_UNBOUND_MT_UNBOUND_PRED_LOOKUP_POS = makeKeyword( "REMOVAL-IST-ASSERTED-UNBOUND-MT-UNBOUND-PRED-LOOKUP-POS" );
    $list54 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword(
        "REQUIRED-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), makeKeyword( "NOT-FULLY-BOUND" ), ConsesLow.list( makeKeyword( "OR" ), ConsesLow.cons(
            makeKeyword( "NOT-FULLY-BOUND" ), makeKeyword( "ANYTHING" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "not" ) ), ConsesLow.cons( makeKeyword( "NOT-FULLY-BOUND" ),
                makeKeyword( "ANYTHING" ) ) ) ) ), makeKeyword( "REQUIRED" ), makeSymbol( "REMOVAL-IST-ASSERTED-UNBOUND-MT-UNBOUND-PRED-LOOKUP-POS-REQUIRED" ), makeKeyword( "COST" ), makeSymbol(
                    "REMOVAL-IST-ASSERTED-UNBOUND-MT-UNBOUND-PRED-LOOKUP-POS-COST" ), makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ), makeKeyword( "INPUT-EXTRACT-PATTERN" ), ConsesLow.list( makeKeyword(
                        "TEMPLATE" ), ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "ASENT" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASENT" ) ) ), makeKeyword( "OUTPUT-GENERATE-PATTERN" ), ConsesLow
                            .list( makeKeyword( "CALL" ), makeSymbol( "REMOVAL-IST-ASSERTED-UNBOUND-MT-UNBOUND-PRED-LOOKUP-POS-ITERATOR" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASENT" ) ) ), makeKeyword(
                                "OUTPUT-DECODE-PATTERN" ), ConsesLow.list( makeKeyword( "TEMPLATE" ), ConsesLow.list( ConsesLow.list( makeKeyword( "BIND" ), makeSymbol( "BINDINGS" ) ), ConsesLow.list( makeKeyword(
                                    "BIND" ), makeSymbol( "ASSERTION" ) ) ), ConsesLow.list( ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "BINDINGS" ) ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol(
                                        "ASSERTION" ) ) ) ), makeKeyword( "OUTPUT-CONSTRUCT-PATTERN" ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "ist-Asserted" ) ), ConsesLow.list(
                                            makeKeyword( "CALL" ), makeSymbol( "ASSERTION-MT" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASSERTION" ) ) ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol(
                                                "SUBST-BINDINGS" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "BINDINGS" ) ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol( "ATOMIC-SENTENCE-ARG2" ),
                                                    ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASENT" ) ) ) ) ), makeKeyword( "SUPPORT-PATTERN" ), ConsesLow.list( makeKeyword( "CALL" ), makeSymbol(
                                                        "MAKE-IST-ASSERTED-JUSTIFICATION" ), ConsesLow.list( makeKeyword( "VALUE" ), makeSymbol( "ASSERTION" ) ) ), makeKeyword( "DOCUMENTATION" ), makeString(
                                                            "(#$ist-Asserted <not fully-bound> (<not fully-bound> ... <fort> ...))\nusing only the KB GAF indexing and explicit assertions in ARG1 MT with <fort> in its arg position." ),
      makeKeyword( "EXAMPLE" ), makeString( "(#$ist-Asserted ?MT (?PRED #$Madonna ?WHAT))" )
    } );
  }
}
/*
