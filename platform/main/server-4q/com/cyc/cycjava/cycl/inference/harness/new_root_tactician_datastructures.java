...
public final class new_root_tactician_datastructures extends SubLTranslatedFile {
    ...
    public static SubLObject nr_strat_data_new_root_index(final SubLObject v_object) {
        assert NIL != new_root_strategy_data_p(v_object) : "new_root_tactician_datastructures.new_root_strategy_data_p error :" + v_object;
    ...
    public static final class $new_root_strategy_data_native extends SubLStructNative {
        ...
        private $new_root_strategy_data_native() {
        ...
        static {
            structDecl = makeStructDeclNative($new_root_strategy_data_native.class, NEW_ROOT_STRATEGY_DATA, NEW_ROOT_STRATEGY_DATA_P, $list2, $list3, new String[]{ "$new_root_index" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
