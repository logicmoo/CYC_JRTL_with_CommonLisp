...
public final class lilliput_caches
    extends
      SubLTranslatedFile
{
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $lilliput_all_instances_caching_state$.getGlobalValue(), ConsesLow.list( collection ), UNPROVIDED, UNPROVIDED );
  }

  @SubLTranslatedFile.SubL(source = "cycl/inference/lilliput-caches.lisp", position = 958L)
  public static SubLObject lilliput_all_instances_internal(final SubLObject collection)
  {
    if( NIL != el_utilities.el_formula_with_operator_p( collection, $const1$SpecsFn ) )
    {
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $lilliput_all_instances_if_tkb_fort_caching_state$.getGlobalValue(), ConsesLow.list( collection ), UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $all_valid_lilliput_queries_caching_state$.getGlobalValue(), ConsesLow.list( EMPTY_SUBL_OBJECT_ARRAY ), UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject all_valid_lilliput_queries_internal()
  {
    ...
    try
    {
      ...
      try
      {
        sbhl_module_vars.$sbhl_module$.bind( sbhl_module_vars.get_sbhl_module( $const8$isa ), thread );
        sbhl_marking_vars.$sbhl_gather_space$.bind( sbhl_marking_vars.get_sbhl_marking_space(), thread );
        try
        {
          SubLObject node_var_$3 = node_var;
          final SubLObject deck_type = $kw11$STACK;
          ...
          try
          {
            ...
            try
            {
              ...
              try
              {
                ...
                try
                {
                  sbhl_search_vars.$sbhl_search_module$.bind( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const8$isa ) ), thread );
                  sbhl_search_vars.$sbhl_search_module_type$.bind( sbhl_module_utilities.get_sbhl_module_type( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const8$isa ) ) ),
                      thread );
                  ...
                  sbhl_module_vars.$sbhl_module$.bind( sbhl_module_utilities.get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const8$isa ) ), thread );
                  if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( node_var, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                  {
                    ...
                    try
                    {
                      ...
                      sbhl_link_vars.$sbhl_link_direction$.bind( sbhl_module_utilities.sbhl_search_direction_to_link_direction( sbhl_search_vars.get_sbhl_backward_search_direction(), sbhl_module_utilities
                          .get_sbhl_transfers_through_module( sbhl_module_vars.get_sbhl_module( $const8$isa ) ) ), thread );
                      sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                      ...
                      while ( NIL != node_var_$3)
                      {
                        ...
                        final SubLObject accessible_modules = cdolist_list_var = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_vars.get_sbhl_module( $const8$isa ) );
                        ...
                        while ( NIL != cdolist_list_var)
                        {
                          ...
                          try
                          {
                            ...
                            if( NIL != sbhl_link_vars.sbhl_node_object_p( node ) )
                            {
                              ...
                              if( NIL != d_link )
                              {
                                final SubLObject mt_links = sbhl_links.get_sbhl_mt_links( d_link, sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const8$isa ) ),
                            ...
                            else if( NIL != obsolete.cnat_p( node, UNPROVIDED ) )
                            {
                              ...
                              final SubLObject new_list = cdolist_list_var_$21 = ( ( NIL != sbhl_link_vars.sbhl_randomize_lists_p() ) ? list_utilities.randomize_list( sbhl_module_utilities
                                  .get_sbhl_module_relevant_naut_link_generators( sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const8$isa ) ), sbhl_search_vars.$sbhl_tv$
                                      .getDynamicValue( thread ), sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                                  : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators( sbhl_module_utilities.get_sbhl_module_backward_direction( sbhl_module_vars.get_sbhl_module( $const8$isa ) ),
                                  ...
                                  if( NIL != set.set_p( sol2 ) )
                                  {
                                        ...
                                        set_contents_var2 ); NIL == set_contents.do_set_contents_doneP( basis_object2, state2 ); state2 = set_contents.do_set_contents_update_state( state2 ) )
                                    {
                                          ...
                                          sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) ) )
                                      {
                                        ...
                                        {
                                          queries = ConsesLow.cons( query3, queries );
                                        }
                                      }
                                    }
                                  }
                                  else if( sol2.isList() )
                                  {
                                    ...
                                    while ( NIL != csome_list_var3)
                                    {
                                      if( NIL == sbhl_marking_utilities.sbhl_search_path_termination_p( query4, sbhl_marking_vars.$sbhl_gather_space$.getDynamicValue( thread ) ) )
                                      {
                                        ...
                                        {
                                          queries = ConsesLow.cons( query4, queries );
                                        }
                                      }
                  ...
                  {
                    sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str23$Node__a_does_not_pass_sbhl_type_t, node_var, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED,
  ...
  {
    SubLFiles.declareFunction( me, "clear_lilliput_all_instances", "CLEAR-LILLIPUT-ALL-INSTANCES", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_lilliput_all_instances", "REMOVE-LILLIPUT-ALL-INSTANCES", 1, 0, false );
    SubLFiles.declareFunction( me, "lilliput_all_instances_internal", "LILLIPUT-ALL-INSTANCES-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "lilliput_all_instances", "LILLIPUT-ALL-INSTANCES", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_lilliput_all_instances_if_tkb_fort", "CLEAR-LILLIPUT-ALL-INSTANCES-IF-TKB-FORT", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_lilliput_all_instances_if_tkb_fort", "REMOVE-LILLIPUT-ALL-INSTANCES-IF-TKB-FORT", 1, 0, false );
    SubLFiles.declareFunction( me, "lilliput_all_instances_if_tkb_fort_internal", "LILLIPUT-ALL-INSTANCES-IF-TKB-FORT-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "lilliput_all_instances_if_tkb_fort", "LILLIPUT-ALL-INSTANCES-IF-TKB-FORT", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_all_valid_lilliput_queries", "CLEAR-ALL-VALID-LILLIPUT-QUERIES", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_all_valid_lilliput_queries", "REMOVE-ALL-VALID-LILLIPUT-QUERIES", 0, 0, false );
    SubLFiles.declareFunction( me, "all_valid_lilliput_queries_internal", "ALL-VALID-LILLIPUT-QUERIES-INTERNAL", 0, 0, false );
    SubLFiles.declareFunction( me, "all_valid_lilliput_queries", "ALL-VALID-LILLIPUT-QUERIES", 0, 0, false );
    SubLFiles.declareFunction( me, "clear_lilliput_caches", "CLEAR-LILLIPUT-CACHES", 0, 0, false );
    return NIL;
  }

  public static SubLObject init_lilliput_caches_file()
  {
    $lilliput_all_instances_caching_state$ = SubLFiles.deflexical( "*LILLIPUT-ALL-INSTANCES-CACHING-STATE*", NIL );
    ...
    $all_valid_lilliput_queries_caching_state$ = SubLFiles.deflexical( "*ALL-VALID-LILLIPUT-QUERIES-CACHING-STATE*", NIL );
    return NIL;
  }
  ...
  static
  {
    ...
    $const1$SpecsFn = constant_handles.reader_make_constant_shell( makeString( "SpecsFn" ) );
    ...
    $kw9$BREADTH = makeKeyword( "BREADTH" );
    $kw10$QUEUE = makeKeyword( "QUEUE" );
    ...
    $list22 = ConsesLow.list( makeUninternedSymbol( "LINK-NODE" ), makeUninternedSymbol( "MT" ), makeUninternedSymbol( "TV" ) );
