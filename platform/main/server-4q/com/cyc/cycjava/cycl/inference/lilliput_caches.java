...
public final class lilliput_caches extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol LILLIPUT_ALL_INSTANCES = makeSymbol("LILLIPUT-ALL-INSTANCES");
    ...
    public static final SubLList $list22 = list(makeUninternedSymbol("LINK-NODE"), makeUninternedSymbol("MT"), makeUninternedSymbol("TV"));

    public static final SubLString $str23$Node__a_does_not_pass_sbhl_type_t = makeString("Node ~a does not pass sbhl-type-test ~a~%");
    ...
    public static SubLObject declare_lilliput_caches_file() {
        declareFunction(me, "clear_lilliput_all_instances", "CLEAR-LILLIPUT-ALL-INSTANCES", 0, 0, false);
        declareFunction(me, "remove_lilliput_all_instances", "REMOVE-LILLIPUT-ALL-INSTANCES", 1, 0, false);
        declareFunction(me, "lilliput_all_instances_internal", "LILLIPUT-ALL-INSTANCES-INTERNAL", 1, 0, false);
        declareFunction(me, "lilliput_all_instances", "LILLIPUT-ALL-INSTANCES", 1, 0, false);
        declareFunction(me, "clear_lilliput_all_instances_if_tkb_fort", "CLEAR-LILLIPUT-ALL-INSTANCES-IF-TKB-FORT", 0, 0, false);
        declareFunction(me, "remove_lilliput_all_instances_if_tkb_fort", "REMOVE-LILLIPUT-ALL-INSTANCES-IF-TKB-FORT", 1, 0, false);
        declareFunction(me, "lilliput_all_instances_if_tkb_fort_internal", "LILLIPUT-ALL-INSTANCES-IF-TKB-FORT-INTERNAL", 1, 0, false);
        declareFunction(me, "lilliput_all_instances_if_tkb_fort", "LILLIPUT-ALL-INSTANCES-IF-TKB-FORT", 1, 0, false);
        declareFunction(me, "clear_all_valid_lilliput_queries", "CLEAR-ALL-VALID-LILLIPUT-QUERIES", 0, 0, false);
        declareFunction(me, "remove_all_valid_lilliput_queries", "REMOVE-ALL-VALID-LILLIPUT-QUERIES", 0, 0, false);
        declareFunction(me, "all_valid_lilliput_queries_internal", "ALL-VALID-LILLIPUT-QUERIES-INTERNAL", 0, 0, false);
        declareFunction(me, "all_valid_lilliput_queries", "ALL-VALID-LILLIPUT-QUERIES", 0, 0, false);
        declareFunction(me, "clear_lilliput_caches", "CLEAR-LILLIPUT-CACHES", 0, 0, false);
        return NIL;
    }
