...
public final class inference_datastructures_problem_store extends SubLTranslatedFile {
    ...
    public static SubLObject problem_store_p(final SubLObject v_object) {
        return v_object.getClass() == inference_datastructures_problem_store.$problem_store_native.class ? T : NIL;
    }

    public static SubLObject prob_store_guid(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
    ...
    public static SubLObject prob_store_min_depth_index(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$min_depth_index;
    }

    public static SubLObject prob_store_equality_reasoning_method(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$equality_reasoning_method;
    }

    public static SubLObject prob_store_equality_reasoning_domain(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$equality_reasoning_domain;
    }

    public static SubLObject prob_store_intermediate_step_validation_level(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$intermediate_step_validation_level;
    }

    public static SubLObject prob_store_max_problem_count(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$max_problem_count;
    }

    public static SubLObject prob_store_crazy_max_problem_count(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$crazy_max_problem_count;
    }

    public static SubLObject prob_store_removal_allowedP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$removal_allowedP;
    }

    public static SubLObject prob_store_transformation_allowedP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$transformation_allowedP;
    }

    public static SubLObject prob_store_add_restriction_layer_of_indirectionP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$add_restriction_layer_of_indirectionP;
    }

    public static SubLObject prob_store_negation_by_failureP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$negation_by_failureP;
    }

    public static SubLObject prob_store_completeness_minimization_allowedP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$completeness_minimization_allowedP;
    }

    public static SubLObject prob_store_direction(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$direction;
    }

    public static SubLObject prob_store_evaluate_subl_allowedP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$evaluate_subl_allowedP;
    }

    public static SubLObject prob_store_rewrite_allowedP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$rewrite_allowedP;
    }

    public static SubLObject prob_store_abduction_allowedP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$abduction_allowedP;
    }

    public static SubLObject prob_store_new_terms_allowedP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$new_terms_allowedP;
    }

    public static SubLObject prob_store_compute_answer_justificationsP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$compute_answer_justificationsP;
    }

    public static SubLObject prob_store_memoization_state(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$memoization_state;
    }

    public static SubLObject prob_store_sbhl_resource_space(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$sbhl_resource_space;
    }

    public static SubLObject prob_store_preparedP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$preparedP;
    }

    public static SubLObject prob_store_destruction_imminentP(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$destruction_imminentP;
    }

    public static SubLObject prob_store_meta_problem_store(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$meta_problem_store;
    }

    public static SubLObject prob_store_static_properties(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$static_properties;
    }

    public static SubLObject prob_store_janitor(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$janitor;
    }

    public static SubLObject prob_store_historical_root_problems(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$historical_root_problems;
    }

    public static SubLObject prob_store_historical_tactic_count(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$historical_tactic_count;
    }

    public static SubLObject prob_store_complex_problem_query_czer_index(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$complex_problem_query_czer_index;
    }

    public static SubLObject prob_store_complex_problem_query_signatures(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$complex_problem_query_signatures;
    }

    public static SubLObject prob_store_proof_keeping_index(final SubLObject v_object) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$proof_keeping_index;
    }
    ...
    public static SubLObject _csetf_prob_store_min_depth_index(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$min_depth_index = value;
    }

    public static SubLObject _csetf_prob_store_equality_reasoning_method(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$equality_reasoning_method = value;
    }

    public static SubLObject _csetf_prob_store_equality_reasoning_domain(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$equality_reasoning_domain = value;
    }
    ...
    public static SubLObject _csetf_prob_store_intermediate_step_validation_level(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$intermediate_step_validation_level = value;
    }

    public static SubLObject _csetf_prob_store_max_problem_count(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$max_problem_count = value;
    }

    public static SubLObject _csetf_prob_store_crazy_max_problem_count(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$crazy_max_problem_count = value;
    }

    public static SubLObject _csetf_prob_store_removal_allowedP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$removal_allowedP = value;
    }

    public static SubLObject _csetf_prob_store_transformation_allowedP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$transformation_allowedP = value;
    }
    ...
    public static SubLObject _csetf_prob_store_add_restriction_layer_of_indirectionP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$add_restriction_layer_of_indirectionP = value;
    }

    public static SubLObject _csetf_prob_store_negation_by_failureP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$negation_by_failureP = value;
    }
    ...
    public static SubLObject _csetf_prob_store_completeness_minimization_allowedP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$completeness_minimization_allowedP = value;
    }

    public static SubLObject _csetf_prob_store_direction(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$direction = value;
    }

    public static SubLObject _csetf_prob_store_evaluate_subl_allowedP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$evaluate_subl_allowedP = value;
    }

    public static SubLObject _csetf_prob_store_rewrite_allowedP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$rewrite_allowedP = value;
    }

    public static SubLObject _csetf_prob_store_abduction_allowedP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$abduction_allowedP = value;
    }

    public static SubLObject _csetf_prob_store_new_terms_allowedP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$new_terms_allowedP = value;
    }
    ...
    public static SubLObject _csetf_prob_store_compute_answer_justificationsP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$compute_answer_justificationsP = value;
    }

    public static SubLObject _csetf_prob_store_memoization_state(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$memoization_state = value;
    }

    public static SubLObject _csetf_prob_store_sbhl_resource_space(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$sbhl_resource_space = value;
    }

    public static SubLObject _csetf_prob_store_preparedP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$preparedP = value;
    }

    public static SubLObject _csetf_prob_store_destruction_imminentP(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$destruction_imminentP = value;
    }

    public static SubLObject _csetf_prob_store_meta_problem_store(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$meta_problem_store = value;
    }

    public static SubLObject _csetf_prob_store_static_properties(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$static_properties = value;
    }

    public static SubLObject _csetf_prob_store_janitor(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$janitor = value;
    }

    public static SubLObject _csetf_prob_store_historical_root_problems(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$historical_root_problems = value;
    }

    public static SubLObject _csetf_prob_store_historical_tactic_count(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$historical_tactic_count = value;
    }
    ...
    public static SubLObject _csetf_prob_store_complex_problem_query_czer_index(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$complex_problem_query_czer_index = value;
    }
    ...
    public static SubLObject _csetf_prob_store_complex_problem_query_signatures(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$complex_problem_query_signatures = value;
    }

    public static SubLObject _csetf_prob_store_proof_keeping_index(final SubLObject v_object, final SubLObject value) {
        assert NIL != problem_store_p(v_object) : "inference_datastructures_problem_store.problem_store_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_p(v_object) " + v_object;
        return ((inference_datastructures_problem_store.$problem_store_native) (v_object)).$proof_keeping_index = value;
    }
    ...
    public static SubLObject make_problem_store(SubLObject arglist) {
        ...
        final SubLObject v_new = new inference_datastructures_problem_store.$problem_store_native();
        SubLObject next;
    ...
    public static SubLObject problem_store_janitor_p(final SubLObject v_object) {
        return v_object.getClass() == inference_datastructures_problem_store.$problem_store_janitor_native.class ? T : NIL;
    }

    public static SubLObject prob_store_janitor_store(final SubLObject v_object) {
        assert NIL != problem_store_janitor_p(v_object) : "inference_datastructures_problem_store.problem_store_janitor_p(v_object) " + "CommonSymbols.NIL != inference_datastructures_problem_store.problem_store_janitor_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_problem_store_janitor(SubLObject arglist) {
        ...
        final SubLObject v_new = new inference_datastructures_problem_store.$problem_store_janitor_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $problem_store_janitor_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_datastructures_problem_store.$problem_store_janitor_native.class, PROBLEM_STORE_JANITOR, PROBLEM_STORE_JANITOR_P, $list327, $list328, new String[]{ "$store", "$indestructible_problems", "$staleP" }, $list329, $list330, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
