...
public final class inference_modules extends SubLTranslatedFile {
    ...
    public static SubLObject hl_module_p(final SubLObject v_object) {
        return v_object.getClass() == inference_modules.$hl_module_native.class ? T : NIL;
    }

    public static SubLObject hl_mod_name(final SubLObject v_object) {
        assert NIL != hl_module_p(v_object) : "inference_modules.hl_module_p(v_object) " + "CommonSymbols.NIL != inference_modules.hl_module_p(v_object) " + v_object;
    ...
    public static SubLObject make_hl_module(SubLObject arglist) {
        ...
        final SubLObject v_new = new inference_modules.$hl_module_native();
        SubLObject next;
    ...
    public static final class $hl_module_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(inference_modules.$hl_module_native.class, HL_MODULE, HL_MODULE_P, $list23, $list24, new String[]{ "$name", "$plist", "$sense", "$predicate", "$any_predicates", "$arity", "$direction", "$required_pattern", "$required_mt", "$exclusive_func", "$required_func", "$completeness" }, $list25, $list26, PRINT_HL_MODULE);
        }
    }
