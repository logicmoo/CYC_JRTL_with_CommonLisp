...
public class inference_modules extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.harness.inference_modules";
    ...
    public static SubLObject declare_inference_modules_file() {
        ...
        declareFunction(myName, "allowed_modules_spec_p", "ALLOWED-MODULES-SPEC-P", 1, 0, false);
        ...
        declareFunction(myName, "hl_module_p", "HL-MODULE-P", 1, 0, false);
        ...
        declareFunction(myName, "visit_defstruct_hl_module", "VISIT-DEFSTRUCT-HL-MODULE", 2, 0, false);
        declareFunction(myName, "visit_defstruct_object_hl_module_method", "VISIT-DEFSTRUCT-OBJECT-HL-MODULE-METHOD", 2, 0, false);
        declareFunction(myName, "print_hl_module", "PRINT-HL-MODULE", 3, 0, false);
        declareFunction(myName, "sxhash_hl_module_method", "SXHASH-HL-MODULE-METHOD", 1, 0, false);
        ...
        declareFunction(myName, "clear_cfasl_create_invalid_hl_module", "CLEAR-CFASL-CREATE-INVALID-HL-MODULE", 0, 0, false);
        declareFunction(myName, "remove_cfasl_create_invalid_hl_module", "REMOVE-CFASL-CREATE-INVALID-HL-MODULE", 1, 0, false);
        declareFunction(myName, "cfasl_create_invalid_hl_module_internal", "CFASL-CREATE-INVALID-HL-MODULE-INTERNAL", 1, 0, false);
        declareFunction(myName, "cfasl_create_invalid_hl_module", "CFASL-CREATE-INVALID-HL-MODULE", 1, 0, false);
        ...
        declareFunction(myName, "hl_module_sense", "HL-MODULE-SENSE", 1, 0, false);
        ...
        declareFunction(myName, "hl_module_required_func_p", "HL-MODULE-REQUIRED-FUNC-P", 2, 0, false);
        ...
        declareFunction(myName, "hl_module_implementation_methods", "HL-MODULE-IMPLEMENTATION-METHODS", 1, 0, false);
        ...
        declareFunction(myName, "inference_removal_moduleL_for_classification", "INFERENCE-REMOVAL-MODULE<-FOR-CLASSIFICATION", 2, 0, false);
        declareFunction(myName, "removal_module_specific_use_genericP_internal", "REMOVAL-MODULE-SPECIFIC-USE-GENERIC?-INTERNAL", 1, 0, false);
        declareFunction(myName, "removal_module_specific_use_genericP", "REMOVAL-MODULE-SPECIFIC-USE-GENERIC?", 1, 0, false);
        declareFunction(myName, "inference_removal_pruning_module", "INFERENCE-REMOVAL-PRUNING-MODULE", 2, 0, false);
        declareFunction(myName, "removal_pruning_moduleP", "REMOVAL-PRUNING-MODULE?", 1, 0, false);
