...
public final class removal_modules_kb_sentence extends SubLTranslatedFile implements V12 {
 ...
 public static final String myName = "com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_kb_sentence";
    ...
    static private final SubLList $list1 = list(makeKeyword("OR"), list(makeKeyword("MODULE-SUBTYPE"), makeKeyword("KB")), list(makeKeyword("AND"), list(makeKeyword("NOT"), list(makeKeyword("MODULE-TYPE"), makeKeyword("REMOVAL"))), list(makeKeyword("NOT"), list(makeKeyword("MODULE-TYPE"), makeKeyword("REMOVAL-CONJUNCTIVE")))));
    ...
    static private final SubLList $list8 = list(makeSymbol("BINDINGS"), makeSymbol("SUPPORTS"));

    private static final SubLSymbol $REMOVAL_KB_SENTENCE_LOOKUP_POS = makeKeyword("REMOVAL-KB-SENTENCE-LOOKUP-POS");

    static private final SubLList $list10 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell("kbSentence"), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell("kbSentence"), list(makeKeyword("OR"), cons(makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND")), cons(list($TEST, makeSymbol("INFERENCE-PREDICATE-P")), makeKeyword("ANYTHING")), cons(reader_make_constant_shell("and"), makeKeyword("ANYTHING")))), $COST, makeSymbol("REMOVAL-KB-SENTENCE-LOOKUP-POS-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-KB-SENTENCE-LOOKUP-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$kbSentence (<non-predicate> . <fully-bound>)) or \n    (#$kbSentence (<predicate> . <anything>)) or\n    (#$kbSentence (#$and . <anything>))\n    by recursively asking sentence w/o any sksi support\n    and succeeding if the ask succeeds"), makeKeyword("EXAMPLE"), makeString("(#$kbSentence\n     (#$thereExists ?SPEC\n      (#$genls ?SPEC #$BinaryRelation)))") });

    private static final SubLSymbol $REMOVAL_KB_SENTENCE_CHECK_NEG = makeKeyword("REMOVAL-KB-SENTENCE-CHECK-NEG");

    static private final SubLList $list13 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell("kbSentence"), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell("kbSentence"), list(makeKeyword("OR"), cons(list($TEST, makeSymbol("INFERENCE-PREDICATE-P")), makeKeyword("FULLY-BOUND")), list(reader_make_constant_shell("not"), cons(list($TEST, makeSymbol("INFERENCE-PREDICATE-P")), makeKeyword("FULLY-BOUND"))))), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-KB-SENTENCE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-KB-SENTENCE-CHECK-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not (#$kbSentence (<predicate> . <fully-bound>))) or\n    (#$not (#$kbSentence (#$not (<predicate> . <fully-bound>))))\n    by recursively asking sentence (<predicate> . <fully-bound>) or \n                                   (#$not (<predicate> . <fully-bound>))\n    without any sksi support\n    and succeeding if the ask succeeds"), makeKeyword("EXAMPLE"), makeString("(#$not (#$kbSentence\n     (#$not (#$genls #$Microtheory #$BinaryPredicate))))") });

    public static final SubLObject removal_kb_sentence_lookup_pos_cost_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            SubLObject subsentence = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
            return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_kb_sentence.removal_kb_sentence_lookup_pos_cost_int(subsentence);
        }
    }
    ...
    public static final SubLObject removal_kb_sentence_lookup_pos_cost_int_alt(SubLObject sentence) {
        if (NIL != variables.fully_bound_p(sentence)) {
            ...
            if (NIL != atomic_sentenceP(sentence)) {
                ...
                if (NIL != el_conjunction_p(sentence)) {
                    return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_kb_sentence.removal_kb_sentence_lookup_pos_conjunction_cost(sentence);
                }
            }
        }
        return NIL;
    ...
    public static final SubLObject removal_kb_sentence_lookup_pos_conjunction_cost_alt(SubLObject conjunction) {
        {
            ...
            for (conjunct = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , conjunct = cdolist_list_var.first()) {
                {
                    SubLObject conjunct_cost = com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_kb_sentence.removal_kb_sentence_lookup_pos_cost_int(conjunct);
                    if (NIL != conjunct_cost) {
                        costs = cons(conjunct_cost, costs);
                    }
                }
            }
            return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_kb_sentence.removal_kb_sentence_guess_cost_from_literal_costs(costs);
        }
    }
    ...
    public static final SubLObject removal_kb_sentence_guess_cost_from_literal_costs_alt(SubLObject costs) {
        if (NIL != costs) {
            {
                SubLObject min_cost = apply(MIN, costs);
                return min_cost.isZero() ? ((SubLObject) (min_cost)) : max(com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_kb_sentence.removal_kb_sentence_adjust_cost_guess(min_cost), $float$0_01);
            }
        }
        return NIL;
    }
    ...
    public static final SubLObject removal_kb_sentence_adjust_cost_guess_alt(SubLObject cost) {
    ...
    public static final SubLObject removal_kb_sentence_lookup_pos_expand_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            ...
            return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_kb_sentence.removal_kb_sentence_lookup_pos_expand_subsentence(subsentence, mt, sense);
        }
    }
    ...
    public static final SubLObject removal_kb_sentence_lookup_pos_expand_subsentence_alt(SubLObject subsentence, SubLObject mt, SubLObject sense) {
        {
            SubLObject result = ask_utilities.inference_recursive_query(subsentence, mt, list($RETURN, $BINDINGS_AND_SUPPORTS, $ALLOWED_MODULES, $kb_sentence_allowed_modules_spec$.getGlobalValue()));
    ...
    public static final SubLObject removal_kb_sentence_neg_gaf_cost_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        return $default_kb_sentence_check_cost$.getGlobalValue();
    ...
    public static final SubLObject removal_kb_sentence_check_neg_expand_alt(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        {
            SubLObject subsentence = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
            SubLObject mt = inference_worker.mt_of_currently_executing_tactic();
            return com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_kb_sentence.removal_kb_sentence_check_neg_expand_subsentence(subsentence, mt, sense);
        }
    }
    ...
    public static final SubLObject removal_kb_sentence_check_neg_expand_subsentence_alt(SubLObject subsentence, SubLObject mt, SubLObject sense) {
        {
    ...
    static private final SubLList $list_alt1 = list(makeKeyword("OR"), list(makeKeyword("MODULE-SUBTYPE"), makeKeyword("KB")), list(makeKeyword("AND"), list(makeKeyword("NOT"), list(makeKeyword("MODULE-TYPE"), makeKeyword("REMOVAL"))), list(makeKeyword("NOT"), list(makeKeyword("MODULE-TYPE"), makeKeyword("REMOVAL-CONJUNCTIVE")))));
    ...
    static private final SubLList $list_alt8 = list(makeSymbol("BINDINGS"), makeSymbol("SUPPORTS"));

    static private final SubLList $list_alt10 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell("kbSentence"), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell("kbSentence"), list(makeKeyword("OR"), cons(makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND")), cons(list($TEST, makeSymbol("INFERENCE-PREDICATE-P")), makeKeyword("ANYTHING")), cons(reader_make_constant_shell("and"), makeKeyword("ANYTHING")))), $COST, makeSymbol("REMOVAL-KB-SENTENCE-LOOKUP-POS-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-KB-SENTENCE-LOOKUP-POS-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$kbSentence (<non-predicate> . <fully-bound>)) or \n    (#$kbSentence (<predicate> . <anything>)) or\n    (#$kbSentence (#$and . <anything>))\n    by recursively asking sentence w/o any sksi support\n    and succeeding if the ask succeeds"), makeKeyword("EXAMPLE"), makeString("(#$kbSentence\n     (#$thereExists ?SPEC\n      (#$genls ?SPEC #$BinaryRelation)))") });
    ...
    static private final SubLList $list_alt13 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell("kbSentence"), makeKeyword("REQUIRED-PATTERN"), list(reader_make_constant_shell("kbSentence"), list(makeKeyword("OR"), cons(list($TEST, makeSymbol("INFERENCE-PREDICATE-P")), makeKeyword("FULLY-BOUND")), list(reader_make_constant_shell("not"), cons(list($TEST, makeSymbol("INFERENCE-PREDICATE-P")), makeKeyword("FULLY-BOUND"))))), makeKeyword("COST-EXPRESSION"), makeSymbol("*DEFAULT-KB-SENTENCE-CHECK-COST*"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-KB-SENTENCE-CHECK-NEG-EXPAND"), makeKeyword("DOCUMENTATION"), makeString("(#$not (#$kbSentence (<predicate> . <fully-bound>))) or\n    (#$not (#$kbSentence (#$not (<predicate> . <fully-bound>))))\n    by recursively asking sentence (<predicate> . <fully-bound>) or \n                                   (#$not (<predicate> . <fully-bound>))\n    without any sksi support\n    and succeeding if the ask succeeds"), makeKeyword("EXAMPLE"), makeString("(#$not (#$kbSentence\n     (#$not (#$genls #$Microtheory #$BinaryPredicate))))") });
