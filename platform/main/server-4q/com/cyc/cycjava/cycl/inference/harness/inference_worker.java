...
public class inference_worker extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.harness.inference_worker";
    ...
    public static SubLObject declare_inference_worker_file() {
        declareFunction(myName, "currently_considered_tactic", "CURRENTLY-CONSIDERED-TACTIC", 0, 0, false);
        ...
        declareFunction(myName, "currently_executing_tactics", "CURRENTLY-EXECUTING-TACTICS", 0, 0, false);
        ...
        declareFunction(myName, "generalized_logical_conjunctive_tactic_p", "GENERALIZED-LOGICAL-CONJUNCTIVE-TACTIC-P", 1, 0, false);
        declareFunction(myName, "connected_conjunction_tactic_literals_score", "CONNECTED-CONJUNCTION-TACTIC-LITERALS-SCORE", 1, 0, false);
        ...
        declareFunction(myName, "possibly_discard_all_other_possible_structural_conjunctive_tactics", "POSSIBLY-DISCARD-ALL-OTHER-POSSIBLE-STRUCTURAL-CONJUNCTIVE-TACTICS", 1, 0, false);
        ...
        declareFunction(myName, "reject_proof_due_to_abnormality", "REJECT-PROOF-DUE-TO-ABNORMALITY", 2, 0, false);
        ...
        declareFunction(myName, "strategic_context_may_modify_its_problem_storeP", "STRATEGIC-CONTEXT-MAY-MODIFY-ITS-PROBLEM-STORE?", 1, 0, false);
        ...
        declareFunction(myName, "change_and_propagate_problem_status_int", "CHANGE-AND-PROPAGATE-PROBLEM-STATUS-INT", 5, 0, false);
        declareFunction(myName, "set_problem_raw_status_if_strategic", "SET-PROBLEM-RAW-STATUS-IF-STRATEGIC", 5, 0, false);
        ...
        declareFunction(myName, "problem_link_openableP", "PROBLEM-LINK-OPENABLE?", 2, 0, false);
        ...
        declareFunction(myName, "note_tactic_doomed", "NOTE-TACTIC-DOOMED", 2, 0, false);
        ...
        declareFunction(myName, "problem_doomedP", "PROBLEM-DOOMED?", 2, 0, false);
        declareFunction(myName, "compute_shared_vars_that_are_actually_bindable", "COMPUTE-SHARED-VARS-THAT-ARE-ACTUALLY-BINDABLE", 4, 0, false);
        declareFunction(myName, "shared_var_actually_bindableP", "SHARED-VAR-ACTUALLY-BINDABLE?", 4, 0, false);
        declareFunction(myName, "join_ordered_tactic_has_a_chance_at_binding_varP", "JOIN-ORDERED-TACTIC-HAS-A-CHANCE-AT-BINDING-VAR?", 3, 0, false);
        ...
        declareFunction(myName, "some_no_good_preferred_join_ordered_argument_linkP", "SOME-NO-GOOD-PREFERRED-JOIN-ORDERED-ARGUMENT-LINK?", 4, 0, false);
        ...
        declareFunction(myName, "unsatisfiable_problem_ignoring_transformation_tacticsP", "UNSATISFIABLE-PROBLEM-IGNORING-TRANSFORMATION-TACTICS?", 2, 0, false);
        ...
        declareFunction(myName, "find_problem", "FIND-PROBLEM", 3, 0, false);
        declareFunction(myName, "find_or_create_problem", "FIND-OR-CREATE-PROBLEM", 3, 1, false);
        declareFunction(myName, "find_problem_int", "FIND-PROBLEM-INT", 4, 0, false);
        declareFunction(myName, "find_or_create_problem_from_contextualized_asent_sense", "FIND-OR-CREATE-PROBLEM-FROM-CONTEXTUALIZED-ASENT-SENSE", 4, 0, false);
        declareFunction(myName, "find_or_create_problem_from_contextualized_clause", "FIND-OR-CREATE-PROBLEM-FROM-CONTEXTUALIZED-CLAUSE", 3, 0, false);
        declareFunction(myName, "find_or_create_problem_from_subclause_spec", "FIND-OR-CREATE-PROBLEM-FROM-SUBCLAUSE-SPEC", 4, 0, false);
        declareFunction(myName, "find_or_create_problem_without_subclause_spec", "FIND-OR-CREATE-PROBLEM-WITHOUT-SUBCLAUSE-SPEC", 4, 0, false);
        ...
        declareFunction(myName, "find_or_create_root_problem", "FIND-OR-CREATE-ROOT-PROBLEM", 3, 0, false);
        declareFunction(myName, "prune_problem_store", "PRUNE-PROBLEM-STORE", 1, 1, false);
        declareFunction(myName, "destroy_discarded_tactics", "DESTROY-DISCARDED-TACTICS", 1, 0, false);
        declareFunction(myName, "tactic_thrown_away_and_privateP", "TACTIC-THROWN-AWAY-AND-PRIVATE?", 2, 0, false);
        ...
        declareFunction(myName, "variant_problemP", "VARIANT-PROBLEM?", 1, 0, false);
        ...
        declareFunction(myName, "compute_indestructible_problems_due_to_potentially_useful_transformation_link", "COMPUTE-INDESTRUCTIBLE-PROBLEMS-DUE-TO-POTENTIALLY-USEFUL-TRANSFORMATION-LINK", 1, 0, false);
        ...
        declareFunction(myName, "all_dependent_proofs_have_siblingsP", "ALL-DEPENDENT-PROOFS-HAVE-SIBLINGS?", 1, 0, false);
        declareFunction(myName, "all_dependent_proofs_have_siblings_int", "ALL-DEPENDENT-PROOFS-HAVE-SIBLINGS-INT", 1, 0, false);
        ...
        declareFunction(myName, "join_ordered_link_restricted_focal_countGE", "JOIN-ORDERED-LINK-RESTRICTED-FOCAL-COUNT>=", 2, 0, false);
        ...
        declareFunction(myName, "problem_cleanP", "PROBLEM-CLEAN?", 1, 0, false);
        declareFunction(myName, "problem_has_any_new_root_motivationP", "PROBLEM-HAS-ANY-NEW-ROOT-MOTIVATION?", 1, 0, false);
        declareFunction(myName, "problem_has_any_transformation_motivationP", "PROBLEM-HAS-ANY-TRANSFORMATION-MOTIVATION?", 1, 0, false);
        declareFunction(myName, "problem_has_any_removal_motivationP", "PROBLEM-HAS-ANY-REMOVAL-MOTIVATION?", 1, 0, false);
        ...
        declareFunction(myName, "cartesian_split_linkP", "CARTESIAN-SPLIT-LINK?", 1, 0, false);
