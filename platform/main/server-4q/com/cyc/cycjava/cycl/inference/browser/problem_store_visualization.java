...
import static com.cyc.cycjava.cycl.inference.browser.problem_store_visualization.*;
...
public final class problem_store_visualization extends SubLTranslatedFile {
    ...
    public static SubLObject problem_layout_p(final SubLObject v_object) {
        return v_object.getClass() == problem_store_visualization.$problem_layout_native.class ? T : NIL;
    }

    public static SubLObject prob_layout_problem_store(final SubLObject v_object) {
        assert NIL != problem_layout_p(v_object) : "problem_store_visualization.problem_layout_p(v_object) " + "CommonSymbols.NIL != problem_store_visualization.problem_layout_p(v_object) " + v_object;
    ...
    public static SubLObject make_problem_layout(SubLObject arglist) {
        ...
        final SubLObject v_new = new problem_store_visualization.$problem_layout_native();
        SubLObject next;
    ...
    public static final class $problem_layout_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(problem_store_visualization.$problem_layout_native.class, PROBLEM_LAYOUT, PROBLEM_LAYOUT_P, $list2, $list3, new String[]{ "$problem_store", "$min_x", "$max_x", "$min_y", "$max_y", "$grid", "$next_problem_id", "$problem_x_table", "$problem_y_table" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
