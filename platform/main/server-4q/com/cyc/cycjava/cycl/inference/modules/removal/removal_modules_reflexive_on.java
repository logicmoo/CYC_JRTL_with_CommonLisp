...
public final class removal_modules_reflexive_on extends SubLTranslatedFile {
    ...
    public static final SubLSymbol REFLEXIVE_ON_COMPLETNESS = makeSymbol("REFLEXIVE-ON-COMPLETNESS");
    ...
    public static SubLObject declare_removal_modules_reflexive_on_file() {
        declareFunction(me, "reflexive_on_predicateP", "REFLEXIVE-ON-PREDICATE?", 1, 0, false);
        new removal_modules_reflexive_on.$reflexive_on_predicateP$UnaryFunction();
        declareFunction(me, "reflexive_on_cols", "REFLEXIVE-ON-COLS", 1, 0, false);
        declareFunction(me, "removal_reflexive_on_expand", "REMOVAL-REFLEXIVE-ON-EXPAND", 1, 1, false);
        declareFunction(me, "reflexive_on_completness", "REFLEXIVE-ON-COMPLETNESS", 1, 0, false);
        declareFunction(me, "supports_for_reflexive_on", "SUPPORTS-FOR-REFLEXIVE-ON", 2, 0, false);
        declareFunction(me, "reflexive_on_isa_support", "REFLEXIVE-ON-ISA-SUPPORT", 3, 0, false);
        return NIL;
    }
