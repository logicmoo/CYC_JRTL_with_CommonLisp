...
public final class transformation_tactician_motivation
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject transformation_strategy_with_strategically_active_strategem(final SubLObject macroform, final SubLObject environment)
  {
    ...
    if( NIL == current )
    {
      ...
      return ConsesLow.listS( $sym3$CLET, ConsesLow.list( ConsesLow.list( strategem_var, strategem ), ConsesLow.list( problem, ConsesLow.list( $sym4$STRATEGEM_PROBLEM, strategem_var ) ) ), ConsesLow.list(
          $sym5$TRANSFORMATION_STRATEGY_DEACTIVATE_STRATEGEM, strategy, strategem_var ), ConsesLow.append( body, ConsesLow.list( ConsesLow.list( $sym6$TRANSFORMATION_STRATEGY_POSSIBLY_DEACTIVATE_PROBLEM, strategy,
              problem ) ) ) );
    }
  ...
  public static SubLObject transformation_strategy_propagate_motivation_to_link_head(final SubLObject strategy, final SubLObject link_head)
  {
    ...
    inference_datastructures_strategy.controlling_strategy_callback( strategy, $kw9$SUBSTRATEGY_STRATEGEM_MOTIVATED, link_head, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    return NIL;
  }
  ...
  public static SubLObject transformation_strategy_possibly_activate_problem(final SubLObject strategy, final SubLObject problem)
  {
    ...
    if( NIL != inference_worker_restriction.problem_is_a_simplificationP( problem ) && NIL != inference_worker_restriction.$simplification_tactics_execute_early_and_pass_down_transformation_motivationP$.getDynamicValue(
        thread ) )
    {
    ...
    final SubLObject activateP = makeBoolean( NIL != transformation_tactician_datastructures.transformation_strategy_problem_motivatedP( strategy, problem )
  ...
  public static SubLObject transformation_strategy_problem_is_the_rest_of_a_join_orderedP(final SubLObject problem, final SubLObject strategy)
  {
        ...
        && NIL == set_contents.do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, restriction_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( restriction_link, $kw11$RESTRICTION ) )
      {
        ...
        for( basis_object_$3 = set_contents.do_set_contents_basis_object( set_contents_var_$2 ), state_$4 = NIL, state_$4 = set_contents.do_set_contents_initial_state( basis_object_$3,
            set_contents_var_$2 ); NIL == part_of_join_orderedP && NIL == set_contents.do_set_contents_doneP( basis_object_$3, state_$4 ); state_$4 = set_contents.do_set_contents_update_state( state_$4 ) )
        {
          join_ordered_link = set_contents.do_set_contents_next( basis_object_$3, state_$4 );
          if( NIL != set_contents.do_set_contents_element_validP( state_$4, join_ordered_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( join_ordered_link, $kw12$JOIN_ORDERED )
  ...
  {
    return makeBoolean( NIL != inference_tactician_strategic_uninterestingness.strategy_deems_problem_tactically_uninterestingP( strategy, problem ) || NIL != inference_tactician_strategic_uninterestingness
        .problem_has_executed_a_complete_removal_tacticP( problem, strategy ) );
  }
  ...
  {
    return makeBoolean( NIL != transformation_tactician_datastructures.transformation_strategy_problem_activeP( strategy, problem ) || NIL != transformation_tactician_datastructures
        .transformation_strategy_problem_pendingP( strategy, problem ) );
  }
  ...
  public static SubLObject transformation_strategy_activate_transformation_argument_links(final SubLObject strategy, final SubLObject problem)
  {
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      ...
      if( NIL != set_contents.do_set_contents_element_validP( state, transformation_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( transformation_link, $kw14$TRANSFORMATION ) )
      {
        ...
        if( NIL != supporting_transformed_problem && NIL == inference_datastructures_problem.problem_relevant_to_inferenceP( supporting_transformed_problem, inference_datastructures_strategy.strategy_inference(
            strategy ) ) )
        {
  ...
  {
    if( NIL != inference_datastructures_problem_link.problem_link_with_supporting_problem_p( transformation_link ) && NIL == transformation_tactician_datastructures.transformation_strategy_link_head_motivatedP( strategy,
        transformation_link ) )
    {
  ...
  public static SubLObject transformation_strategy_note_new_tactic(final SubLObject strategy, final SubLObject tactic)
  {
    ...
    if( NIL == inference_worker_split.split_tactic_p( tactic ) || NIL == inference_worker_split.meta_split_tactics_enabledP() )
    {
      ...
      {
        if( ( NIL != inference_tactician.strategy_set_aside_non_continuable_implies_throw_awayP( strategy ) || NIL != inference_datastructures_inference.inference_continuableP( inference_datastructures_strategy
            .strategy_inference( strategy ) ) ) && NIL != inference_tactician_strategic_uninterestingness.simple_strategy_chooses_to_set_aside_tacticP( strategy, tactic ) )
        {
  ...
  public static SubLObject transformation_strategy_note_split_tactics_strategically_possible(final SubLObject strategy, final SubLObject split_tactics)
  {
    ...
    {
      final SubLObject sorted_split_tactics = inference_tactician.strategy_sort( strategy, conses_high.copy_list( split_tactics ), $sym16$LOGICAL_TACTIC_BETTER_WRT_REMOVAL_ );
  ...
  public static SubLObject transformation_strategy_note_new_tactic_possible(final SubLObject strategy, final SubLObject tactic)
  {
    ...
    if( ( NIL != inference_worker_split.meta_split_tactics_enabledP() && NIL != inference_worker_split.split_tactic_p( tactic ) ) || ( NIL != inference_worker_transformation.transformation_tactic_p( tactic )
  ...
  public static SubLObject transformation_strategy_categorize_strategems(final SubLObject strategy, final SubLObject problem)
  {
    ...
    if( NIL == transformation_tactician_uninterestingness.transformation_strategy_chooses_to_throw_away_problemP( strategy, problem, UNPROVIDED ) )
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        if( NIL != inference_datastructures_problem.do_problem_tactics_type_match( transformation_tactic, $kw14$TRANSFORMATION ) && NIL != inference_datastructures_problem.do_problem_tactics_status_match(
            transformation_tactic, $kw18$POSSIBLE ) && NIL == transformation_tactician_uninterestingness.transformation_strategy_chooses_to_throw_away_tacticP( strategy, transformation_tactic, T, UNPROVIDED ) )
        {
          ...
          {
            strategems_to_set_aside = ConsesLow.cons( transformation_tactic, strategems_to_set_aside );
          }
          else
          {
            strategems_to_activate = ConsesLow.cons( transformation_tactic, strategems_to_activate );
          }
        }
        cdolist_list_var = cdolist_list_var.rest();
        transformation_tactic = cdolist_list_var.first();
          ...
          .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
      {
        transformation_link = set_contents.do_set_contents_next( basis_object, state );
        if( NIL != set_contents.do_set_contents_element_validP( state, transformation_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( transformation_link, $kw14$TRANSFORMATION )
            && NIL != inference_datastructures_problem_link.problem_link_with_supporting_problem_p( transformation_link ) && NIL == transformation_tactician_datastructures.transformation_strategy_link_head_motivatedP(
                strategy, transformation_link ) )
        {
          ...
          if( NIL == transformation_tactician_uninterestingness.transformation_strategy_chooses_to_throw_away_tacticP( strategy, transformation_tactic2, T, UNPROVIDED ) )
          {
            ...
            {
              strategems_to_set_aside = ConsesLow.cons( transformation_tactic2, strategems_to_set_aside );
            }
            else
            {
              strategems_to_activate = ConsesLow.cons( transformation_tactic2, strategems_to_activate );
            }
          }
        }
      }
      if( NIL == inference_datastructures_problem.single_literal_problem_p( problem ) )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          if( NIL != inference_datastructures_problem.do_problem_tactics_type_match( logical_tactic, $kw19$LOGICAL ) && NIL == transformation_tactician_datastructures.transformation_strategy_link_head_motivatedP(
              strategy, logical_tactic ) && NIL == transformation_tactician_uninterestingness.transformation_strategy_chooses_to_throw_away_tacticP( strategy, logical_tactic, T, UNPROVIDED ) )
          {
            ...
            {
              strategems_to_set_aside = ConsesLow.cons( logical_tactic, strategems_to_set_aside );
            }
            else
            {
              strategems_to_activate = ConsesLow.cons( logical_tactic, strategems_to_activate );
            }
          }
          cdolist_list_var = cdolist_list_var.rest();
          logical_tactic = cdolist_list_var.first();
    ...
    {
      if( NIL != inference_datastructures_problem.do_problem_tactics_type_match( transformation_tactic, $kw14$TRANSFORMATION ) && NIL != inference_datastructures_problem.do_problem_tactics_status_match(
          transformation_tactic, $kw18$POSSIBLE ) && NIL == list_utilities.member_eqP( transformation_tactic, strategems_to_activate ) && NIL == list_utilities.member_eqP( transformation_tactic,
              strategems_to_set_aside ) )
      {
        strategems_to_throw_away = ConsesLow.cons( transformation_tactic, strategems_to_throw_away );
      }
      cdolist_list_var = cdolist_list_var.rest();
      transformation_tactic = cdolist_list_var.first();
    }
        ...
        .do_set_contents_doneP( basis_object, state ); state = set_contents.do_set_contents_update_state( state ) )
    {
      transformation_link = set_contents.do_set_contents_next( basis_object, state );
      if( NIL != set_contents.do_set_contents_element_validP( state, transformation_link ) && NIL != inference_datastructures_problem_link.problem_link_has_typeP( transformation_link, $kw14$TRANSFORMATION )
          && NIL == list_utilities.member_eqP( transformation_link, strategems_to_activate ) && NIL == list_utilities.member_eqP( transformation_link, strategems_to_set_aside ) )
      {
        strategems_to_throw_away = ConsesLow.cons( transformation_link, strategems_to_throw_away );
      }
    }
    cdolist_list_var = inference_datastructures_problem.problem_tactics( problem );
    SubLObject logical_tactic = NIL;
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != inference_datastructures_problem.do_problem_tactics_type_match( logical_tactic, $kw19$LOGICAL ) && NIL == list_utilities.member_eqP( logical_tactic, strategems_to_activate ) && NIL == list_utilities
          .member_eqP( logical_tactic, strategems_to_set_aside ) )
      {
        strategems_to_throw_away = ConsesLow.cons( logical_tactic, strategems_to_throw_away );
      }
      cdolist_list_var = cdolist_list_var.rest();
      logical_tactic = cdolist_list_var.first();
    }
  ...
  {
    SubLFiles.declareMacro( me, "transformation_strategy_with_strategically_active_strategem", "TRANSFORMATION-STRATEGY-WITH-STRATEGICALLY-ACTIVE-STRATEGEM" );
    SubLFiles.declareFunction( me, "transformation_strategy_possibly_propagate_motivation_to_link_head", "TRANSFORMATION-STRATEGY-POSSIBLY-PROPAGATE-MOTIVATION-TO-LINK-HEAD", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_propagate_motivation_to_link_head", "TRANSFORMATION-STRATEGY-PROPAGATE-MOTIVATION-TO-LINK-HEAD", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_link_motivates_problemP", "TRANSFORMATION-STRATEGY-LINK-MOTIVATES-PROBLEM?", 2, 1, false );
    SubLFiles.declareFunction( me, "transformation_strategy_link_motivates_lookahead_problemP", "TRANSFORMATION-STRATEGY-LINK-MOTIVATES-LOOKAHEAD-PROBLEM?", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_possibly_propagate_motivation_to_problem", "TRANSFORMATION-STRATEGY-POSSIBLY-PROPAGATE-MOTIVATION-TO-PROBLEM", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_propagate_motivation_to_problem", "TRANSFORMATION-STRATEGY-PROPAGATE-MOTIVATION-TO-PROBLEM", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_possibly_activate_problem", "TRANSFORMATION-STRATEGY-POSSIBLY-ACTIVATE-PROBLEM", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_problem_is_the_rest_of_a_join_orderedP", "TRANSFORMATION-STRATEGY-PROBLEM-IS-THE-REST-OF-A-JOIN-ORDERED?", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_possibly_propagate_proof_spec_to_restricted_non_focals", "TRANSFORMATION-STRATEGY-POSSIBLY-PROPAGATE-PROOF-SPEC-TO-RESTRICTED-NON-FOCALS", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_chooses_not_to_examine_problemP", "TRANSFORMATION-STRATEGY-CHOOSES-NOT-TO-EXAMINE-PROBLEM?", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_chooses_not_to_activate_problemP", "TRANSFORMATION-STRATEGY-CHOOSES-NOT-TO-ACTIVATE-PROBLEM?", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_activate_problem", "TRANSFORMATION-STRATEGY-ACTIVATE-PROBLEM", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_possibly_activate_strategems", "TRANSFORMATION-STRATEGY-POSSIBLY-ACTIVATE-STRATEGEMS", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_activate_transformation_argument_links", "TRANSFORMATION-STRATEGY-ACTIVATE-TRANSFORMATION-ARGUMENT-LINKS", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_note_argument_link_added", "TRANSFORMATION-STRATEGY-NOTE-ARGUMENT-LINK-ADDED", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_possibly_activate_transformation_link", "TRANSFORMATION-STRATEGY-POSSIBLY-ACTIVATE-TRANSFORMATION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_activate_transformation_link", "TRANSFORMATION-STRATEGY-ACTIVATE-TRANSFORMATION-LINK", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_note_new_tactic", "TRANSFORMATION-STRATEGY-NOTE-NEW-TACTIC", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_note_split_tactics_strategically_possible", "TRANSFORMATION-STRATEGY-NOTE-SPLIT-TACTICS-STRATEGICALLY-POSSIBLE", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_note_new_tactic_possible", "TRANSFORMATION-STRATEGY-NOTE-NEW-TACTIC-POSSIBLE", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_categorize_strategems", "TRANSFORMATION-STRATEGY-CATEGORIZE-STRATEGEMS", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_reactivate_executable_strategem", "TRANSFORMATION-STRATEGY-REACTIVATE-EXECUTABLE-STRATEGEM", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_strategically_deactivate_strategem", "TRANSFORMATION-STRATEGY-STRATEGICALLY-DEACTIVATE-STRATEGEM", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_deactivate_strategem", "TRANSFORMATION-STRATEGY-DEACTIVATE-STRATEGEM", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_possibly_deactivate_problem", "TRANSFORMATION-STRATEGY-POSSIBLY-DEACTIVATE-PROBLEM", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_consider_that_problem_could_be_strategically_totally_pending", "TRANSFORMATION-STRATEGY-CONSIDER-THAT-PROBLEM-COULD-BE-STRATEGICALLY-TOTALLY-PENDING", 2, 0,
        false );
    SubLFiles.declareFunction( me, "transformation_strategy_consider_that_problem_could_be_strategically_pending", "TRANSFORMATION-STRATEGY-CONSIDER-THAT-PROBLEM-COULD-BE-STRATEGICALLY-PENDING", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_make_problem_pending", "TRANSFORMATION-STRATEGY-MAKE-PROBLEM-PENDING", 2, 0, false );
    SubLFiles.declareFunction( me, "transformation_strategy_problem_nothing_to_doP", "TRANSFORMATION-STRATEGY-PROBLEM-NOTHING-TO-DO?", 2, 0, false );
    return NIL;
  }
  ...
  static
  {
    ...
    $list0 = ConsesLow.list( ConsesLow.list( makeSymbol( "STRATEGY" ), makeSymbol( "STRATEGEM" ) ), makeSymbol( "&BODY" ), makeSymbol( "BODY" ) );
    ...
    $kw9$SUBSTRATEGY_STRATEGEM_MOTIVATED = makeKeyword( "SUBSTRATEGY-STRATEGEM-MOTIVATED" );
    $str10$_s_tried_to_propagate_T_to__s_but = makeString( "~s tried to propagate T to ~s but it throws away all transformation" );
    $kw11$RESTRICTION = makeKeyword( "RESTRICTION" );
    $kw12$JOIN_ORDERED = makeKeyword( "JOIN-ORDERED" );
    $sym13$PROBLEM_P = makeSymbol( "PROBLEM-P" );
    $kw14$TRANSFORMATION = makeKeyword( "TRANSFORMATION" );
    ...
    $kw18$POSSIBLE = makeKeyword( "POSSIBLE" );
    $kw19$LOGICAL = makeKeyword( "LOGICAL" );
