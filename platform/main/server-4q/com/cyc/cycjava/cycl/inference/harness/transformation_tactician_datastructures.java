...
public class transformation_tactician_datastructures extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.harness.transformation_tactician_datastructures";
    ...
    public static SubLObject declare_transformation_tactician_datastructures_file() {
        ...
        declareFunction(myName, "transformation_strategy_data_p", "TRANSFORMATION-STRATEGY-DATA-P", 1, 0, false);
        ...
        declareFunction(myName, "visit_defstruct_transformation_strategy_data", "VISIT-DEFSTRUCT-TRANSFORMATION-STRATEGY-DATA", 2, 0, false);
        declareFunction(myName, "visit_defstruct_object_transformation_strategy_data_method", "VISIT-DEFSTRUCT-OBJECT-TRANSFORMATION-STRATEGY-DATA-METHOD", 2, 0, false);
