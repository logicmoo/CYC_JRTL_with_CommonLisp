...
public final class transformation_tactician_datastructures extends SubLTranslatedFile {
    ...
    public static SubLObject transformation_strategy_data_p(final SubLObject v_object) {
        return v_object.getClass() == transformation_tactician_datastructures.$transformation_strategy_data_native.class ? T : NIL;
    }

    public static SubLObject trans_strat_data_link_heads_motivated(final SubLObject v_object) {
        assert NIL != transformation_strategy_data_p(v_object) : "transformation_tactician_datastructures.transformation_strategy_data_p(v_object) " + "CommonSymbols.NIL != transformation_tactician_datastructures.transformation_strategy_data_p(v_object) " + v_object;
    ...
    public static SubLObject make_transformation_strategy_data(SubLObject arglist) {
        ...
        final SubLObject v_new = new transformation_tactician_datastructures.$transformation_strategy_data_native();
        SubLObject next;
