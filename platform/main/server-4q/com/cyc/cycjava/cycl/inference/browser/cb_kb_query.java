...
public final class cb_kb_query extends SubLTranslatedFile implements V12 {
	...
	public static final class $kb_query_state_native extends SubLStructNative {
		...
		private static final SubLStructDeclNative structDecl = makeStructDeclNative(com.cyc.cycjava.cycl.inference.browser.cb_kb_query.$kb_query_state_native.class, KB_QUERY_STATE, KB_QUERY_STATE_P, $list_alt11, $list_alt12,
				new String[] { "$query_spec", "$name", "$comments", "$test_state", "$save_mt", "$inference", "$sentences", "$query_mts", "$template", "$template_folder_mt_pairs", "$template_glosses", "$query_properties", "$non_explanatory_sentence" }, $list_alt13, $list_alt14, DEFAULT_STRUCT_PRINT_FUNCTION);
	}
				...
				if (NIL == current) {
					if ((NIL != string_utilities.starts_with(label, $str142$mc_option_)) && (NIL == string_utilities.empty_string_p(value))) {
						...
						if (NIL == current_$7) {
							...
							} else if ($$$binding.equal(item_type)) {
								multiple_choice_queryP = T;
	...
	public static final SubLObject cb_kb_overwrite_query_alt(SubLObject query_state) {
		...
		}
		{
			...
			kb_query.kbq_ensure_query_spec_definition(query_spec, sentence, query_mt, inference_parameters.explicify_query_tool_query_property_defaults(query_properties, sentence), defining_mt, non_explanatory_sentence, UNPROVIDED_SYM);
	...
	static private final SubLList $list_alt11 = list(
			new SubLObject[] { makeSymbol("QUERY-SPEC"), makeSymbol("NAME"), makeSymbol("COMMENTS"), makeSymbol("TEST-STATE"), makeSymbol("SAVE-MT"), makeSymbol("INFERENCE"), makeSymbol("SENTENCES"), makeSymbol("QUERY-MTS"), makeSymbol("TEMPLATE"), makeSymbol("TEMPLATE-FOLDER-MT-PAIRS"), makeSymbol("TEMPLATE-GLOSSES"), makeSymbol("QUERY-PROPERTIES"), makeSymbol("NON-EXPLANATORY-SENTENCE") });

	static private final SubLList $list_alt12 = list(
			new SubLObject[] { makeKeyword("QUERY-SPEC"), $NAME, makeKeyword("COMMENTS"), makeKeyword("TEST-STATE"), makeKeyword("SAVE-MT"), makeKeyword("INFERENCE"), makeKeyword("SENTENCES"), makeKeyword("QUERY-MTS"), makeKeyword("TEMPLATE"), makeKeyword("TEMPLATE-FOLDER-MT-PAIRS"), makeKeyword("TEMPLATE-GLOSSES"), makeKeyword("QUERY-PROPERTIES"), makeKeyword("NON-EXPLANATORY-SENTENCE") });

	static private final SubLList $list_alt13 = list(new SubLObject[] { makeSymbol("KB-QUERY-STATE-QUERY-SPEC"), makeSymbol("KB-QUERY-STATE-NAME"), makeSymbol("KB-QUERY-STATE-COMMENTS"), makeSymbol("KB-QUERY-STATE-TEST-STATE"), makeSymbol("KB-QUERY-STATE-SAVE-MT"), makeSymbol("KB-QUERY-STATE-INFERENCE"), makeSymbol("KB-QUERY-STATE-SENTENCES"), makeSymbol("KB-QUERY-STATE-QUERY-MTS"),
			makeSymbol("KB-QUERY-STATE-TEMPLATE"), makeSymbol("KB-QUERY-STATE-TEMPLATE-FOLDER-MT-PAIRS"), makeSymbol("KB-QUERY-STATE-TEMPLATE-GLOSSES"), makeSymbol("KB-QUERY-STATE-QUERY-PROPERTIES"), makeSymbol("KB-QUERY-STATE-NON-EXPLANATORY-SENTENCE") });

	static private final SubLList $list_alt14 = list(new SubLObject[] { makeSymbol("_CSETF-KB-QUERY-STATE-QUERY-SPEC"), makeSymbol("_CSETF-KB-QUERY-STATE-NAME"), makeSymbol("_CSETF-KB-QUERY-STATE-COMMENTS"), makeSymbol("_CSETF-KB-QUERY-STATE-TEST-STATE"), makeSymbol("_CSETF-KB-QUERY-STATE-SAVE-MT"), makeSymbol("_CSETF-KB-QUERY-STATE-INFERENCE"), makeSymbol("_CSETF-KB-QUERY-STATE-SENTENCES"),
			makeSymbol("_CSETF-KB-QUERY-STATE-QUERY-MTS"), makeSymbol("_CSETF-KB-QUERY-STATE-TEMPLATE"), makeSymbol("_CSETF-KB-QUERY-STATE-TEMPLATE-FOLDER-MT-PAIRS"), makeSymbol("_CSETF-KB-QUERY-STATE-TEMPLATE-GLOSSES"), makeSymbol("_CSETF-KB-QUERY-STATE-QUERY-PROPERTIES"), makeSymbol("_CSETF-KB-QUERY-STATE-NON-EXPLANATORY-SENTENCE") });
