...
import static com.cyc.cycjava.cycl.el_utilities.possibly_unquote_closed_formula;
...
public final class after_adding_modules extends SubLTranslatedFile {
    ...
    public static SubLObject init_after_adding_modules_file() {
        ...
        deflexical("*TRUE-RULE-DEFINING-MT*", SubLSystemTrampolineFile.maybeDefault($true_rule_defining_mt$, $true_rule_defining_mt$, $$CoreCycLMt));
