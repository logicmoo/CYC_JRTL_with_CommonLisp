...
public class after_adding_modules extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.modules.after_adding_modules";
    ...
    public static SubLObject declare_after_adding_modules_file() {
        ...
        declareFunction(myName, "clear_isa_dependent_caches", "CLEAR-ISA-DEPENDENT-CACHES", 2, 0, false);
        ...
        declareFunction(myName, "propagate_to_arity", "PROPAGATE-TO-ARITY", 2, 0, false);
        declareFunction(myName, "add_arity", "ADD-ARITY", 2, 0, false);
        declareFunction(myName, "remove_arity", "REMOVE-ARITY", 2, 0, false);
        declareFunction(myName, "propagate_to_arity_min", "PROPAGATE-TO-ARITY-MIN", 2, 0, false);
        ...
        declareFunction(myName, "propagate_to_arity_max", "PROPAGATE-TO-ARITY-MAX", 2, 0, false);
        ...
        declareFunction(myName, "clear_unit_multiplication_factor_caches", "CLEAR-UNIT-MULTIPLICATION-FACTOR-CACHES", 2, 0, false);
        ...
        declareFunction(myName, "cyc_except_mt_added", "CYC-EXCEPT-MT-ADDED", 2, 0, false);
        declareFunction(myName, "cyc_except_mt_removed", "CYC-EXCEPT-MT-REMOVED", 2, 0, false);
        ...
        declareFunction(myName, "hl_gaf_p", "HL-GAF-P", 1, 0, false);
        declareFunction(myName, "except_of_hl_gaf_p", "EXCEPT-OF-HL-GAF-P", 1, 0, false);
        declareFunction(myName, "add_hl_gaf_denial", "ADD-HL-GAF-DENIAL", 2, 0, false);
        declareFunction(myName, "rem_hl_gaf_denial", "REM-HL-GAF-DENIAL", 2, 0, false);
        ...
        declareFunction(myName, "mark_constant_as_instantiated", "MARK-CONSTANT-AS-INSTANTIATED", 2, 0, false);
        declareFunction(myName, "cyc_create_new_instantiated_permanent", "CYC-CREATE-NEW-INSTANTIATED-PERMANENT", 2, 0, false);
        declareFunction(myName, "instantiated_constant_p", "INSTANTIATED-CONSTANT-P", 1, 0, false);
        declareFunction(myName, "possible_instantiated_constant_with_no_assertionsP", "POSSIBLE-INSTANTIATED-CONSTANT-WITH-NO-ASSERTIONS?", 1, 0, false);
        declareFunction(myName, "instantiated_constant_with_one_assertionP", "INSTANTIATED-CONSTANT-WITH-ONE-ASSERTION?", 1, 0, false);
        declareFunction(myName, "possible_instantiated_constant_to_reuseP", "POSSIBLE-INSTANTIATED-CONSTANT-TO-REUSE?", 1, 0, false);
        declareFunction(myName, "do_create_from_description", "DO-CREATE-FROM-DESCRIPTION", 2, 0, false);
        declareFunction(myName, "expression_instantiated_constant_count", "EXPRESSION-INSTANTIATED-CONSTANT-COUNT", 1, 0, false);
        declareFunction(myName, "expression_has_instantiated_constantP", "EXPRESSION-HAS-INSTANTIATED-CONSTANT?", 1, 0, false);
        declareFunction(myName, "do_create_from_description_multiple", "DO-CREATE-FROM-DESCRIPTION-MULTIPLE", 2, 0, false);
        declareFunction(myName, "make_do_create_from_description_query", "MAKE-DO-CREATE-FROM-DESCRIPTION-QUERY", 2, 0, false);
        declareFunction(myName, "constant_instantiated_from_subcollection_expression_p", "CONSTANT-INSTANTIATED-FROM-SUBCOLLECTION-EXPRESSION-P", 1, 0, false);
        declareFunction(myName, "instantiate_from_subcollection_expression", "INSTANTIATE-FROM-SUBCOLLECTION-EXPRESSION", 2, 0, false);
        declareFunction(myName, "show_constants_with_no_assertions", "SHOW-CONSTANTS-WITH-NO-ASSERTIONS", 0, 0, false);
        declareFunction(myName, "kill_constants_with_no_assertions_by_prefix", "KILL-CONSTANTS-WITH-NO-ASSERTIONS-BY-PREFIX", 1, 0, false);
        declareFunction(myName, "show_unused_instantiated_constants", "SHOW-UNUSED-INSTANTIATED-CONSTANTS", 0, 0, false);
        declareFunction(myName, "forget_unused_instantiated_constants", "FORGET-UNUSED-INSTANTIATED-CONSTANTS", 0, 0, false);
        declareFunction(myName, "kill_unused_instantiated_constants", "KILL-UNUSED-INSTANTIATED-CONSTANTS", 0, 0, false);
        declareFunction(myName, "assert_missing_quoted_isa_instantiated_constant_assertions", "ASSERT-MISSING-QUOTED-ISA-INSTANTIATED-CONSTANT-ASSERTIONS", 0, 0, false);
        declareFunction(myName, "retain_mt_contents", "RETAIN-MT-CONTENTS", 2, 0, false);
        return NIL;
    }
