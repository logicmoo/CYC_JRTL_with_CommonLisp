...
import static com.cyc.cycjava.cycl.inference.kbq_query_run.*;
...
public final class kbq_query_run extends SubLTranslatedFile {
    ...
    private static final SubLList $list150 = list(cons(reader_make_constant_shell(makeString("TestMetric-TotalTime")), makeKeyword("TOTAL-TIME")), cons(reader_make_constant_shell(makeString("TestMetric-TimeToFirstAnswer")), makeKeyword("TIME-TO-FIRST-ANSWER")), cons(reader_make_constant_shell(makeString("TestMetric-TimeToLastAnswer")), makeKeyword("TIME-TO-LAST-ANSWER")), cons(reader_make_constant_shell(makeString("TestMetric-AnswerCount")), makeKeyword("ANSWER-COUNT")), cons(reader_make_constant_shell(makeString("TestMetric-AnswerCountAt30Seconds")), makeKeyword("ANSWER-COUNT-AT-30-SECONDS")), cons(reader_make_constant_shell(makeString("TestMetric-AnswerCountAt60Seconds")), makeKeyword("ANSWER-COUNT-AT-60-SECONDS")), cons(reader_make_constant_shell(makeString("TestMetric-ProblemStoreProofCount")), makeKeyword("PROOF-COUNT")), cons(reader_make_constant_shell(makeString("TestMetric-ProblemStoreProblemCount")), makeKeyword("PROBLEM-COUNT")));
    ...
    private static final SubLList $list183 = list(reader_make_constant_shell(makeString("evaluate")), makeKeyword("SET"), list(reader_make_constant_shell(makeString("SetExtentFn")), list(reader_make_constant_shell(makeString("TheSetOf")), makeSymbol("?QUERY"), list(reader_make_constant_shell(makeString("thereExists")), makeSymbol("?TEST"), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("knownSentence")), list(reader_make_constant_shell(makeString("isa")), makeSymbol("?TEST"), makeKeyword("TEST-COLLECTION"))), list(reader_make_constant_shell(makeString("assertedSentence")), list(reader_make_constant_shell(makeString("testQuerySpecification")), makeSymbol("?TEST"), makeSymbol("?QUERY"))))))));
    ...
    private static final SubLList $list590 = list(new SubLObject[]{ reader_make_constant_shell(makeString("TheSet")), list(reader_make_constant_shell(makeString("QueryFn"))), list(reader_make_constant_shell(makeString("QueryFn")), list(reader_make_constant_shell(makeString("Quote")), list(reader_make_constant_shell(makeString("ist")), reader_make_constant_shell(makeString("BaseKB")), list(reader_make_constant_shell(makeString("isa")))))), list(reader_make_constant_shell(makeString("QueryFn")), list(reader_make_constant_shell(makeString("Quote")), list(reader_make_constant_shell(makeString("ist")), reader_make_constant_shell(makeString("BaseKB")), list(reader_make_constant_shell(makeString("and")))))), list(reader_make_constant_shell(makeString("QueryFn")), list(reader_make_constant_shell(makeString("Quote")), list(reader_make_constant_shell(makeString("or"))))), list(reader_make_constant_shell(makeString("QueryFn")), list(reader_make_constant_shell(makeString("Quote")), list(reader_make_constant_shell(makeString("ist")), reader_make_constant_shell(makeString("BaseKB")), list(reader_make_constant_shell(makeString("isa")), makeInteger(212), reader_make_constant_shell(makeString("Dog")))))), list(reader_make_constant_shell(makeString("QueryFn")), list(reader_make_constant_shell(makeString("Quote")), list(reader_make_constant_shell(makeString("trueSubL")), list(reader_make_constant_shell(makeString("SubLQuoteFn")), list(makeSymbol("WITH-INFERENCE-ERROR-HANDLING"), list(makeSymbol("ERROR"), makeString("zyxwvut"))))))), list(reader_make_constant_shell(makeString("QueryFn")), list(reader_make_constant_shell(makeString("Quote")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("integerBetween")), ONE_INTEGER, makeSymbol("?N"), TWO_INTEGER), list(reader_make_constant_shell(makeString("performSubL")), list(reader_make_constant_shell(makeString("ExpandSubLFn")), list(makeSymbol("?N")), list(makeSymbol("PWHEN"), list(makeSymbol("="), makeSymbol("?N"), TWO_INTEGER), list(makeSymbol("WITH-INFERENCE-ERROR-HANDLING"), list(makeSymbol("ERROR"), makeString("zyxwvut"))))))))), list(reader_make_constant_shell(makeString("QueryFn")), list(reader_make_constant_shell(makeString("Quote")), list(reader_make_constant_shell(makeString("performSubL")), list(reader_make_constant_shell(makeString("SubLQuoteFn")), list(makeSymbol("SLEEP"), FOUR_INTEGER))))), list(reader_make_constant_shell(makeString("QueryFn")), list(reader_make_constant_shell(makeString("Quote")), list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("integerBetween")), ONE_INTEGER, makeSymbol("?N"), TWO_INTEGER), list(reader_make_constant_shell(makeString("performSubL")), list(reader_make_constant_shell(makeString("ExpandSubLFn")), list(makeSymbol("?N")), list(makeSymbol("SLEEP"), TWO_INTEGER)))))) });
    ...
    public static SubLObject kbq_run_query(final SubLObject query_spec, SubLObject query_metrics, SubLObject outlier_timeout, SubLObject overriding_query_properties, SubLObject include_resultP, SubLObject substitutions) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (NIL != never_runP) {
                        query_metrics_plist = nconc(new SubLObject[]{ NIL != subl_promotions.memberP($TOTAL_TIME, query_metrics, UNPROVIDED, UNPROVIDED) ? list($TOTAL_TIME, total_time) : NIL, NIL != subl_promotions.memberP($COMPLETE_TOTAL_TIME, query_metrics, UNPROVIDED, UNPROVIDED) ? list($COMPLETE_TOTAL_TIME, total_time) : NIL, NIL != subl_promotions.memberP($ANSWER_COUNT, query_metrics, UNPROVIDED, UNPROVIDED) ? $TAUTOLOGY == halt_reason ? list($ANSWER_COUNT, ONE_INTEGER) : list($ANSWER_COUNT, ZERO_INTEGER) : NIL, $TAUTOLOGY == halt_reason ? nconc(NIL != subl_promotions.memberP($TIME_TO_FIRST_ANSWER, query_metrics, UNPROVIDED, UNPROVIDED) ? list($TIME_TO_FIRST_ANSWER, total_time) : NIL, NIL != subl_promotions.memberP($TIME_TO_LAST_ANSWER, query_metrics, UNPROVIDED, UNPROVIDED) ? list($TIME_TO_LAST_ANSWER, total_time) : NIL) : NIL });
                    }
        ...
        final SubLObject query_run = listS($QUERY, query_spec, append(NIL != overriding_query_properties ? list($OVERRIDING_QUERY_PROPERTIES, overriding_query_properties) : NIL, NIL != include_resultP ? list($RESULT, result) : NIL, listS($HALT_REASON, halt_reason, append(query_metrics_plist, NIL))));
    ...
    public static SubLObject any_kct_followup_test_formula_gafsP(final SubLObject test_spec) {
        return makeBoolean((NIL != forts.fort_p(test_spec)) && (((NIL != kb_mapping_utilities.some_pred_value_in_any_mt(test_spec, $$testFollowupTestFormula_All, UNPROVIDED, UNPROVIDED)) || (NIL != kb_mapping_utilities.some_pred_value_in_any_mt(test_spec, $$testFollowupTestFormula_Some, UNPROVIDED, UNPROVIDED))) || (NIL != kb_mapping_utilities.some_pred_value_in_any_mt(test_spec, $$testFollowupTestFormula_None, UNPROVIDED, UNPROVIDED))));
    }
    ...
    public static SubLObject kb_test_metrics_to_query_metrics(final SubLObject kb_test_metrics) {
        ...
        while (NIL != cdolist_list_var) {
            ...
            if (NIL != query_metric) {
                ...
                if (!kb_test_metric.eql($$TestMetric_HaltReason)) {
    ...
    public static SubLObject kct_compute_test_status(final SubLObject test_spec, final SubLObject query_results, final SubLObject hypothetical_bindings) {
        ...
        if (NIL != kb_query.multiple_choice_testP(test_spec)) {
            ...
            if (((NIL == kct_test_query_results_satisfy_binding_sets_cardinality(query_results, kct_utils.kct_binding_sets_cardinality(test_spec, UNPROVIDED))) || (NIL == kct_test_query_results_satisfy_binding_sets_min_cardinality(query_results, kct_utils.kct_binding_sets_min_cardinality(test_spec, UNPROVIDED)))) || (NIL == kct_test_query_results_satisfy_binding_sets_max_cardinality(query_results, kct_utils.kct_binding_sets_max_cardinality(test_spec, UNPROVIDED)))) {
                return $FAILURE;
            }
            if ((NIL == kct_utils.kct_bindings_unimportantP(test_spec, UNPROVIDED)) && (((NIL == kct_test_query_results_satisfy_exact_set_of_binding_sets(el_query_results, kct_utils.kct_exact_set_of_binding_sets(test_spec, UNPROVIDED), hypothetical_bindings)) || (NIL == kct_test_query_results_satisfy_wanted_binding_sets(el_query_results, kct_utils.kct_wanted_binding_sets(test_spec, UNPROVIDED), hypothetical_bindings))) || (NIL == kct_test_query_results_satisfy_unwanted_binding_sets(el_query_results, kct_utils.kct_unwanted_binding_sets(test_spec, UNPROVIDED), hypothetical_bindings)))) {
                return $FAILURE;
            }
            if (NIL != any_kct_followup_test_formula_gafsP(test_spec)) {
                ...
                if (((NIL == kct_followup_test_formula_all_holdsP(test_spec, store, el_query, mt, v_properties, hypothetical_bindings, query_results)) || (NIL == kct_followup_test_formula_some_holdsP(test_spec, store, el_query, mt, v_properties, hypothetical_bindings))) || (NIL == kct_followup_test_formula_none_holdsP(test_spec, store, el_query, mt, v_properties, hypothetical_bindings))) {
                    return $FAILURE;
                }
            }
        }
    ...
    public static SubLObject print_kct_experiment_analysis_to_file(final SubLObject analysis_filename, final SubLObject test_set_run, final SubLObject metrics, final SubLObject test_spec_set) {
        ...
        final SubLObject regression_tests_uninterestingP = makeBoolean((NIL != list_utilities.every_in_list($sym243$KB_CONTENT_REGRESSION_TEST_, kct_test_set_run_test_runs(test_set_run), KCT_TEST_RUN_TEST)) || (NIL == list_utilities.any_in_list($sym243$KB_CONTENT_REGRESSION_TEST_, kct_test_set_run_test_runs(test_set_run), KCT_TEST_RUN_TEST)));
    ...
    public static SubLObject print_experiment_csv_to_file(final SubLObject analysis_filename, final SubLObject test_or_query_set_run) {
        ...
        try {
            ...
            while (NIL != cdolist_list_var) {
                ...
                format(csv, $str257$_A__A__A__A__A__A__A___, new SubLObject[]{ list_utilities.plist_lookup(atest, $TEST, UNPROVIDED), list_utilities.plist_lookup(atest, $STATUS, UNPROVIDED), list_utilities.plist_lookup(atest, $STATUS, UNPROVIDED).equalp($SUCCESS) ? list_utilities.plist_lookup(qrun, $HALT_REASON, UNPROVIDED) : $str161$, list_utilities.plist_lookup(atest, $STATUS, UNPROVIDED).equalp($SUCCESS) && (!list_utilities.plist_lookup(qrun, $HALT_REASON, UNPROVIDED).isList()) ? list_utilities.plist_lookup(qrun, $HALT_REASON, UNPROVIDED) : $str161$, list_utilities.plist_lookup(qrun, $ANSWER_COUNT, UNPROVIDED), list_utilities.plist_lookup(qrun, $TIME_TO_FIRST_ANSWER, UNPROVIDED), list_utilities.plist_lookup(qrun, $TIME_TO_LAST_ANSWER, UNPROVIDED), list_utilities.plist_lookup(qrun, $TOTAL_TIME, UNPROVIDED) });
                cdolist_list_var = cdolist_list_var.rest();
                atest = cdolist_list_var.first();
            } 
        } finally {
    ...
    public static SubLObject kbq_runstate_p(final SubLObject v_object) {
        return v_object.getClass() == kbq_query_run.$kbq_runstate_native.class ? T : NIL;
    }

    public static SubLObject kbqr_id(final SubLObject v_object) {
        assert NIL != kbq_runstate_p(v_object) : "kbq_query_run.kbq_runstate_p(v_object) " + "CommonSymbols.NIL != kbq_query_run.kbq_runstate_p(v_object) " + v_object;
    ...
    public static SubLObject make_kbq_runstate(SubLObject arglist) {
        ...
        final SubLObject v_new = new kbq_query_run.$kbq_runstate_native();
        SubLObject next;
    ...
    public static SubLObject kct_runstate_p(final SubLObject v_object) {
        return v_object.getClass() == kbq_query_run.$kct_runstate_native.class ? T : NIL;
    }

    public static SubLObject kctr_id(final SubLObject v_object) {
        assert NIL != kct_runstate_p(v_object) : "kbq_query_run.kct_runstate_p(v_object) " + "CommonSymbols.NIL != kbq_query_run.kct_runstate_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_kct_runstate(SubLObject arglist) {
        ...
        final SubLObject v_new = new kbq_query_run.$kct_runstate_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject kct_set_runstate_p(final SubLObject v_object) {
        return v_object.getClass() == kbq_query_run.$kct_set_runstate_native.class ? T : NIL;
    }

    public static SubLObject kctsr_id(final SubLObject v_object) {
        assert NIL != kct_set_runstate_p(v_object) : "kbq_query_run.kct_set_runstate_p(v_object) " + "CommonSymbols.NIL != kbq_query_run.kct_set_runstate_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_kct_set_runstate(SubLObject arglist) {
        ...
        final SubLObject v_new = new kbq_query_run.$kct_set_runstate_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject do_query_set_run(final SubLObject macroform, final SubLObject environment) {
        ...
        return list(PROGN, listS(CHECK_TYPE, filename, $list383), list(WITH_PRIVATE_BINARY_FILE, listS(stream, filename, $list385), list(WITH_CFASL_COMMON_SYMBOLS_SIMPLE, $list387, list(WITH_NEW_CFASL_INPUT_GUID_STRING_RESOURCE, list(CLET, list(list(query_set_run, list(KBQ_LOAD_QUERY_SET_RUN_INT, stream))), listS(CSOME, list(query_run, list(KBQ_QUERY_SET_RUN_QUERY_RUNS, query_set_run), done), append(body, NIL)), list(CLET, list(list(done_var, done)), list(WHILE, list(CNOT, done_var), list(CLET, list(list(query_run, list(KBQ_LOAD_QUERY_RUN_INT, stream))), list(PWHEN, listS(EQ, query_run, $list395), listS(CSETQ, done_var, $list396)), listS(PUNLESS, done_var, list(CSETQ, query_run, list(KBQ_NCLEAN_QUERY_RUN, query_run)), append(body, list(list(CSETQ, done_var, done))))))))))));
    }
    ...
    public static SubLObject kbq_summarize_compare_query_set_run_answers(final SubLObject query_set_run_1, final SubLObject query_set_run_2) {
        ...
        return nconc(new SubLObject[]{ NIL != answerable_2 ? list($ANSWERABLE_2, Sort.sort(answerable_2, symbol_function($sym434$_), symbol_function(SECOND))) : NIL, NIL != more_answers_2 ? list($MORE_ANSWERS_2, Sort.sort(more_answers_2, symbol_function($sym434$_), symbol_function(SECOND))) : NIL, NIL != different_answers ? list($DIFFERENT_ANSWERS, Sort.sort(different_answers, symbol_function($sym434$_), symbol_function(SECOND))) : NIL, NIL != more_answers_3 ? list($MORE_ANSWERS_1, Sort.sort(more_answers_3, symbol_function($sym434$_), symbol_function(SECOND))) : NIL, NIL != answerable_3 ? list($ANSWERABLE_1, Sort.sort(answerable_3, symbol_function($sym434$_), symbol_function(SECOND))) : NIL });
    }
    ...
    public static SubLObject kbq_compare_analysis(final SubLObject analysis_1, final SubLObject analysis_2) {
        ...
        for (remainder = NIL, remainder = analysis_2; NIL != remainder; remainder = cddr(remainder)) {
            ...
            if ($UNDEFINED != metric_value_3) {
                ...
                metric_comparison_values = list(NIL != metric_value_3 ? significant_digits_if_float(metric_value_3, FOUR_INTEGER) : NIL, NIL != metric_value_2 ? significant_digits_if_float(metric_value_2, FOUR_INTEGER) : NIL, NIL != difference ? significant_digits_if_float(difference, FOUR_INTEGER) : NIL, percentage);
        ...
        if (NIL != analysis) {
            ...
            for (remainder = NIL, remainder = analysis; NIL != remainder; remainder = cddr(remainder)) {
                ...
                if (NIL != subl_promotions.memberP(statistic_type, $list459, UNPROVIDED, UNPROVIDED)) {
                    ratio = ($NEITHER == statistic_type) ? NIL : $INCREASE == statistic_type ? (NIL == baseline_value) || baseline_value.isZero() ? $UNDEFINED : number_utilities.significant_digits(divide(experiment_value, baseline_value), FOUR_INTEGER) : (NIL == experiment_value) || experiment_value.isZero() ? $UNDEFINED : number_utilities.significant_digits(divide(baseline_value, experiment_value), FOUR_INTEGER);
    ...
    public static SubLObject kbq_analyze_query_runs(final SubLObject query_runs, final SubLObject metrics) {
        ...
        while (NIL != cdolist_list_var) {
            ...
            if (pcase_var.eql($ANSWER_COUNT)) {
                ...
                final SubLObject partial_analysis2 = list(new SubLObject[]{ $TOTAL_ANSWERABLE, total_answerable, $TOTAL_UNANSWERABLE, total_unanswerable, $TOTAL_ERROR, total_error, $TOTAL_LUMPY, total_lumpy, $SUM_ANSWER_COUNT, sum_answer_count, $MEAN_ANSWER_COUNT, mean_answer_count, $MEDIAN_ANSWER_COUNT, median_answer_count });
                        ...
                        if (pcase_var.eql($COMPLETE_TOTAL_TIME)) {
                            ...
                            if (pcase_var.eql($TIME_TO_FIRST_ANSWER)) {
                                ...
                                if (pcase_var.eql($COMPLETE_TIME_TO_FIRST_ANSWER)) {
                                    ...
                                    final SubLObject median_time_to_first_answer = (NIL != all_time_to_first_answers) ? number_utilities.median(all_time_to_first_answers, UNPROVIDED, UNPROVIDED) : NIL;
                                    final SubLObject stdev_time_to_first_answer = (NIL != all_time_to_first_answers) ? number_utilities.standard_deviation(all_time_to_first_answers) : NIL;
                                    final SubLObject partial_analysis3 = list($SUM_COMPLETE_TIME_TO_FIRST_ANSWER, sum_time_to_first_answer, $MEAN_COMPLETE_TIME_TO_FIRST_ANSWER, mean_time_to_first_answer, $MEDIAN_COMPLETE_TIME_TO_FIRST_ANSWER, median_time_to_first_answer, $STDEV_COMPLETE_TIME_TO_FIRST_ANSWER, stdev_time_to_first_answer);
                                    analysis = list_utilities.merge_plist(analysis, partial_analysis3);
                                } else
    ...
    public static SubLObject kbq_lumpy_query_runP(final SubLObject query_run) {
        final SubLObject halt_reason = kbq_query_run_halt_reason(query_run);
        if ((NIL != inference_datastructures_enumerated_types.inference_error_suspend_status_p(halt_reason)) && (NIL != string_utilities.substringP($$$Unable_to_compute_any_metrics, inference_datastructures_enumerated_types.inference_error_suspend_status_message(halt_reason), UNPROVIDED, UNPROVIDED, UNPROVIDED))) {
            return T;
        }
        return NIL;
    }
    ...
    public static SubLObject kbq_benchmark_run(final SubLObject filename, final SubLObject title, final SubLObject test_col, SubLObject overriding_query_properties, SubLObject skip, SubLObject count) {
        ...
        return run_kbq_experiment_internal(list(new SubLObject[]{ $QUERY_SPEC_SET, bq_cons($$TheSet, append(Mapping.mapcar(KCT_QUERY_SPECIFICATION, isa.all_instances_in_all_mts(test_col)), NIL)), $FILENAME, filename, $ANALYSIS_FILENAME, NIL, $KEEPALIVE_FILENAME, NIL, $COMMENT, comment, $OVERRIDING_QUERY_PROPERTIES, overriding_query_properties, $METRICS, $list535, $OUTLIER_TIMEOUT, $kbq_benchmark_outlier_timeout$.getDynamicValue(thread), $INCREMENTAL, T, $INCLUDE_RESULTS, T, $RANDOMIZE, NIL, $SKIP, skip, $COUNT, count, $IF_FILE_EXISTS, $AUGMENT_OR_RERUN_ERRORS }));
    }
    ...
    public static SubLObject kbq_benchmark_report(final SubLObject filename, SubLObject stream) {
        ...
        while (NIL != cdolist_list_var) {
            ...
            format(stream, $str540$_5D__5_1F__7_1F_4D__7_1F__7_1F__7, new SubLObject[]{ num, ttfs, ttfa, sksi_call_count, sksi_query_total_time, NIL != number_utilities.positive_number_p(sksi_query_total_time) ? subtract(total_time, sksi_query_total_time) : total_time, total_time, NIL != number_utilities.positive_number_p(sksi_query_total_time) ? number_utilities.percent(sksi_query_total_time, total_time, THREE_INTEGER) : ZERO_INTEGER, test, halt_reason == $EXHAUST_TOTAL ? $str161$ : format(NIL, $str542$___A_, halt_reason) });
            cdolist_list_var = cdolist_list_var.rest();
            kbq_run = cdolist_list_var.first();
        } 
        format(stream, $str537$_________________________________);
        format(stream, $str543$_5D__5_1F__7_1F_4D__7_1F__7_1F__7, new SubLObject[]{ total_num, total_ttfs, total_ttfa, total_sksi_call_count, total_sksi, NIL != number_utilities.positive_number_p(total_sksi) ? subtract(total_total_time, total_sksi) : total_total_time, total_total_time, NIL != number_utilities.positive_number_p(total_sksi) ? number_utilities.percent(total_sksi, total_total_time, THREE_INTEGER) : ZERO_INTEGER });
        return NIL;
    }
    ...
    public static SubLObject kbq_benchmark_report_for_test(final SubLObject filename, final SubLObject test_fort, SubLObject stream) {
        ...
        final SubLObject one_line_comment = string_utilities.string_first_n($int$60, Strings.string_trim(cons(CHAR_asterisk, string_utilities.whitespace_chars()), string_utilities.string_tokenize(comment, list(string_utilities.$new_line_string$.getGlobalValue()), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED).first()));
        SubLObject cdolist_list_var = kbq_query_set_run_query_runs(query_set_run);
        SubLObject kbq_run = NIL;
        kbq_run = cdolist_list_var.first();
        while (NIL != cdolist_list_var) {
            ...
            if (test_fort.equal(test)) {
                format(stream, $str546$_15A___5D__5_1F__7_1F_4D__7_1F__7, new SubLObject[]{ short_filename, num, ttfs, ttfa, sksi_call_count, sksi_query_total_time, NIL != number_utilities.positive_number_p(sksi_query_total_time) ? subtract(total_time, sksi_query_total_time) : total_time, total_time, NIL != number_utilities.positive_number_p(sksi_query_total_time) ? number_utilities.percent(sksi_query_total_time, total_time, THREE_INTEGER) : ZERO_INTEGER, one_line_comment });
                force_output(T);
            }
            cdolist_list_var = cdolist_list_var.rest();
            kbq_run = cdolist_list_var.first();
                                                                    ...
                                                                    for (iteration_state = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents(mt_links)); NIL == dictionary_contents.do_dictionary_contents_doneP(iteration_state); iteration_state = dictionary_contents.do_dictionary_contents_next(iteration_state)) {
                                                                        ...
                                                                        if (NIL != mt_relevance_macros.relevant_mtP(mt)) {
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                for (iteration_state_$110 = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents(tv_links)); NIL == dictionary_contents.do_dictionary_contents_doneP(iteration_state_$110); iteration_state_$110 = dictionary_contents.do_dictionary_contents_next(iteration_state_$110)) {
                                                                                    thread.resetMultipleValues();
                                                                    ...
                                                                    for (iteration_state2 = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents(mt_links2)); NIL == dictionary_contents.do_dictionary_contents_doneP(iteration_state2); iteration_state2 = dictionary_contents.do_dictionary_contents_next(iteration_state2)) {
                                                                        ...
                                                                        if (NIL != mt_relevance_macros.relevant_mtP(mt3)) {
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                for (iteration_state_$111 = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents(tv_links2)); NIL == dictionary_contents.do_dictionary_contents_doneP(iteration_state_$111); iteration_state_$111 = dictionary_contents.do_dictionary_contents_next(iteration_state_$111)) {
                                                                                    thread.resetMultipleValues();
    ...
    public static final class $kbq_runstate_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(kbq_query_run.$kbq_runstate_native.class, KBQ_RUNSTATE, KBQ_RUNSTATE_P, $list271, $list272, new String[]{ "$id", "$lock", "$query_spec", "$inference", "$result", "$test_runstate", "$run_status" }, $list273, $list274, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $kct_runstate_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(kbq_query_run.$kct_runstate_native.class, KCT_RUNSTATE, KCT_RUNSTATE_P, $list310, $list311, new String[]{ "$id", "$lock", "$test_spec", "$result", "$query_runstate", "$test_set_runstate", "$run_status", "$start", "$end" }, $list312, $list313, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $kct_set_runstate_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(kbq_query_run.$kct_set_runstate_native.class, KCT_SET_RUNSTATE, KCT_SET_RUNSTATE_P, $list344, $list345, new String[]{ "$id", "$lock", "$test_set", "$result", "$test_runstates", "$run_status", "$start", "$end" }, $list346, $list347, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
