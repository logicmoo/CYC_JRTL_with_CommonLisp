...
public class kbq_query_run extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.kbq_query_run";
    ...
    public static SubLObject declare_kbq_query_run_file() {
        ...
        declareFunction(myName, "kbq_cfasl_common_symbols_simple", "KBQ-CFASL-COMMON-SYMBOLS-SIMPLE", 0, 0, false);
        ...
        declareFunction(myName, "kbq_query_run_hypothesization_time", "KBQ-QUERY-RUN-HYPOTHESIZATION-TIME", 1, 0, false);
        ...
        declareFunction(myName, "kct_test_run_answer_count", "KCT-TEST-RUN-ANSWER-COUNT", 1, 0, false);
        ...
        declareFunction(myName, "kbq_run_query", "KBQ-RUN-QUERY", 1, 5, false);
        declareFunction(myName, "abort_kbq_run_query", "ABORT-KBQ-RUN-QUERY", 0, 0, false);
        declareFunction(myName, "kbq_run_query_and_maybe_destroy", "KBQ-RUN-QUERY-AND-MAYBE-DESTROY", 4, 1, false);
        declareFunction(myName, "kbq_run_query_problem_store", "KBQ-RUN-QUERY-PROBLEM-STORE", 1, 1, false);
        declareFunction(myName, "kbq_run_query_int", "KBQ-RUN-QUERY-INT", 3, 1, false);
        declareFunction(myName, "ensure_sksi_modules_needed", "ENSURE-SKSI-MODULES-NEEDED", 1, 0, false);
        declareFunction(myName, "ensure_only_sksi_modules_needed", "ENSURE-ONLY-SKSI-MODULES-NEEDED", 1, 0, false);
        declareFunction(myName, "sksi_modules_needed", "SKSI-MODULES-NEEDED", 1, 0, false);
        declareFunction(myName, "query_sksi_modules_needed", "QUERY-SKSI-MODULES-NEEDED", 1, 0, false);
        ...
        declareFunction(myName, "kct_compute_test_status", "KCT-COMPUTE-TEST-STATUS", 3, 0, false);
        ...
        declareFunction(myName, "kct_test_query_results_satisfy_exact_set_of_binding_sets", "KCT-TEST-QUERY-RESULTS-SATISFY-EXACT-SET-OF-BINDING-SETS", 3, 0, false);
        declareFunction(myName, "kct_test_query_results_satisfy_wanted_binding_sets", "KCT-TEST-QUERY-RESULTS-SATISFY-WANTED-BINDING-SETS", 3, 0, false);
        declareFunction(myName, "kct_test_query_results_satisfy_unwanted_binding_sets", "KCT-TEST-QUERY-RESULTS-SATISFY-UNWANTED-BINDING-SETS", 3, 0, false);
        ...
        declareFunction(myName, "kct_test_query_results_satisfy_best_multiple_choice_option", "KCT-TEST-QUERY-RESULTS-SATISFY-BEST-MULTIPLE-CHOICE-OPTION", 2, 0, false);
        declareFunction(myName, "why_kct_failure", "WHY-KCT-FAILURE", 3, 0, false);
        declareFunction(myName, "why_kct_multiple_choice_option_failure", "WHY-KCT-MULTIPLE-CHOICE-OPTION-FAILURE", 2, 0, false);
        declareFunction(myName, "why_kct_binding_cardinality_failure", "WHY-KCT-BINDING-CARDINALITY-FAILURE", 2, 0, false);
        declareFunction(myName, "why_kct_binding_match_failure", "WHY-KCT-BINDING-MATCH-FAILURE", 3, 0, false);
        ...
        declareFunction(myName, "sort_queries_by_sksi_modules_needed", "SORT-QUERIES-BY-SKSI-MODULES-NEEDED", 1, 0, false);
        declareFunction(myName, "sort_tests_by_sksi_modules_needed", "SORT-TESTS-BY-SKSI-MODULES-NEEDED", 1, 0, false);
        declareFunction(myName, "sort_terms_by_sksi_modules_needed", "SORT-TERMS-BY-SKSI-MODULES-NEEDED", 2, 0, false);
        declareFunction(myName, "sksi_modules_needed_sorted_memoized_internal", "SKSI-MODULES-NEEDED-SORTED-MEMOIZED-INTERNAL", 1, 0, false);
        declareFunction(myName, "sksi_modules_needed_sorted_memoized", "SKSI-MODULES-NEEDED-SORTED-MEMOIZED", 1, 0, false);
        declareFunction(myName, "query_sksi_modules_needed_sorted_memoized_internal", "QUERY-SKSI-MODULES-NEEDED-SORTED-MEMOIZED-INTERNAL", 1, 0, false);
        declareFunction(myName, "query_sksi_modules_needed_sorted_memoized", "QUERY-SKSI-MODULES-NEEDED-SORTED-MEMOIZED", 1, 0, false);
        ...
        declareFunction(myName, "run_kbq_query_spec_set_and_process_inferences", "RUN-KBQ-QUERY-SPEC-SET-AND-PROCESS-INFERENCES", 2, 1, false);
        declareFunction(myName, "run_kbq_and_process_inferences", "RUN-KBQ-AND-PROCESS-INFERENCES", 3, 0, false);
        declareFunction(myName, "run_kbq_and_generate_inferences", "RUN-KBQ-AND-GENERATE-INFERENCES", 3, 0, false);
        declareFunction(myName, "process_all_kbq_inferences", "PROCESS-ALL-KBQ-INFERENCES", 4, 0, false);
        ...
        declareFunction(myName, "last_query_set_run", "LAST-QUERY-SET-RUN", 0, 0, false);
        ...
        declareFunction(myName, "print_kct_experiment_analysis_to_file", "PRINT-KCT-EXPERIMENT-ANALYSIS-TO-FILE", 4, 0, false);
        declareFunction(myName, "print_experiment_csv_to_file", "PRINT-EXPERIMENT-CSV-TO-FILE", 2, 0, false);
        ...
        declareFunction(myName, "kbq_runstate_p", "KBQ-RUNSTATE-P", 1, 0, false);
        ...
        declareFunction(myName, "visit_defstruct_kbq_runstate", "VISIT-DEFSTRUCT-KBQ-RUNSTATE", 2, 0, false);
        declareFunction(myName, "visit_defstruct_object_kbq_runstate_method", "VISIT-DEFSTRUCT-OBJECT-KBQ-RUNSTATE-METHOD", 2, 0, false);
        ...
        declareFunction(myName, "kct_runstate_p", "KCT-RUNSTATE-P", 1, 0, false);
        ...
        declareFunction(myName, "visit_defstruct_kct_runstate", "VISIT-DEFSTRUCT-KCT-RUNSTATE", 2, 0, false);
        declareFunction(myName, "visit_defstruct_object_kct_runstate_method", "VISIT-DEFSTRUCT-OBJECT-KCT-RUNSTATE-METHOD", 2, 0, false);
        ...
        declareFunction(myName, "kct_set_runstate_p", "KCT-SET-RUNSTATE-P", 1, 0, false);
        ...
        declareFunction(myName, "visit_defstruct_kct_set_runstate", "VISIT-DEFSTRUCT-KCT-SET-RUNSTATE", 2, 0, false);
        declareFunction(myName, "visit_defstruct_object_kct_set_runstate_method", "VISIT-DEFSTRUCT-OBJECT-KCT-SET-RUNSTATE-METHOD", 2, 0, false);
        ...
        declareFunction(myName, "kct_answerable_test_set_run", "KCT-ANSWERABLE-TEST-SET-RUN", 1, 0, false);
        ...
        declareFunction(myName, "kct_unanswerable_test_set_run", "KCT-UNANSWERABLE-TEST-SET-RUN", 1, 0, false);
        declareFunction(myName, "kct_failing_test_set_run", "KCT-FAILING-TEST-SET-RUN", 1, 0, false);
        declareFunction(myName, "kct_erroring_test_set_run", "KCT-ERRORING-TEST-SET-RUN", 1, 0, false);
        declareFunction(myName, "kct_common_sense_test_set_run", "KCT-COMMON-SENSE-TEST-SET-RUN", 1, 0, false);
        declareFunction(myName, "kct_regression_test_set_run", "KCT-REGRESSION-TEST-SET-RUN", 1, 0, false);
        declareFunction(myName, "kct_subcollection_test_set_run", "KCT-SUBCOLLECTION-TEST-SET-RUN", 2, 0, false);
        declareFunction(myName, "kct_failing_tests", "KCT-FAILING-TESTS", 1, 0, false);
        declareFunction(myName, "kct_succeeding_tests", "KCT-SUCCEEDING-TESTS", 1, 0, false);
        declareFunction(myName, "kct_answerable_tests", "KCT-ANSWERABLE-TESTS", 1, 0, false);
        declareFunction(myName, "kct_unanswerable_tests", "KCT-UNANSWERABLE-TESTS", 1, 0, false);
        declareFunction(myName, "kct_newly_failing_tests", "KCT-NEWLY-FAILING-TESTS", 2, 0, false);
        ...
        declareFunction(myName, "clear_cached_all_instances_among", "CLEAR-CACHED-ALL-INSTANCES-AMONG", 0, 0, false);
        ...
        declareFunction(myName, "trim_analysis_if_zero", "TRIM-ANALYSIS-IF-ZERO", 1, 0, false);
        ...
        declareFunction(myName, "kct_run_support_set", "KCT-RUN-SUPPORT-SET", 1, 0, false);
        declareFunction(myName, "kct_run_supports_report", "KCT-RUN-SUPPORTS-REPORT", 1, 1, false);
        declareFunction(myName, "unknown_sentence_support_p", "UNKNOWN-SENTENCE-SUPPORT-P", 1, 0, false);
        declareFunction(myName, "kcts_using_only_these_sksi_sources", "KCTS-USING-ONLY-THESE-SKSI-SOURCES", 1, 0, false);
        declareFunction(myName, "kcts_for_sksi_source", "KCTS-FOR-SKSI-SOURCE", 1, 0, false);
        declareFunction(myName, "succeeding_kcts_for_sksi_source", "SUCCEEDING-KCTS-FOR-SKSI-SOURCE", 2, 0, false);
        declareFunction(myName, "failing_kcts_for_sksi_source", "FAILING-KCTS-FOR-SKSI-SOURCE", 2, 0, false);
        declareFunction(myName, "answerable_kcts_for_sksi_source", "ANSWERABLE-KCTS-FOR-SKSI-SOURCE", 2, 0, false);
        declareFunction(myName, "unanswerable_kcts_for_sksi_source", "UNANSWERABLE-KCTS-FOR-SKSI-SOURCE", 2, 0, false);
        declareFunction(myName, "erroring_kcts_for_sksi_source", "ERRORING-KCTS-FOR-SKSI-SOURCE", 2, 0, false);
        declareFunction(myName, "show_errors_for_sksi_source", "SHOW-ERRORS-FOR-SKSI-SOURCE", 2, 0, false);
        declareFunction(myName, "analyze_sksi_test_set_run", "ANALYZE-SKSI-TEST-SET-RUN", 2, 0, false);
        return NIL;
    }
