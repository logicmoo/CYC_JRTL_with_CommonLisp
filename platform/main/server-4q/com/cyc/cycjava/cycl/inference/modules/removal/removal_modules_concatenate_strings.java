...
import com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_concatenate_strings;
...
import static com.cyc.cycjava.cycl.inference.modules.removal.removal_modules_concatenate_strings.*;
...
public final class removal_modules_concatenate_strings extends SubLTranslatedFile {
    ...
    private static final SubLObject $$concatenateStrings = reader_make_constant_shell(makeString("concatenateStrings"));
    ...
    public static final SubLList $list4 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("concatenateStrings")), makeKeyword("REQUIRED-PATTERN"), listS(reader_make_constant_shell(makeString("concatenateStrings")), makeKeyword("ANYTHING"), makeKeyword("FULLY-BOUND")), makeKeyword("REQUIRED"), makeSymbol("REMOVAL-CONCATENATE-STRINGS-BOUND-ARGS-SUPPORTED-P"), makeKeyword("COST-EXPRESSION"), ONE_INTEGER, makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-CONCATENATE-STRINGS-CONCATENATE-ARG1-POS"), makeKeyword("SUPPORT-MT"), reader_make_constant_shell(makeString("BaseKB")), makeKeyword("DOCUMENTATION"), makeString("(#$concatenateStrings :not-fully-bound . :fully-bound)"), makeKeyword("EXAMPLE"), makeString("(#$concatenateStrings ?X \"foo\" \"bar\")\nwill bind ?X to \"foobar\"") });
    ...
    private static final SubLList $list10 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("NEG"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("concatenateStrings")), makeKeyword("REQUIRED-PATTERN"), listS(reader_make_constant_shell(makeString("concatenateStrings")), makeKeyword("FULLY-BOUND"), makeKeyword("FULLY-BOUND")), makeKeyword("REQUIRED"), makeSymbol("REMOVAL-CONCATENATE-STRINGS-BOUND-ARGS-SUPPORTED-P"), makeKeyword("COST-EXPRESSION"), ONE_INTEGER, makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-CONCATENATE-STRINGS-CONCATENATE-NEG"), makeKeyword("SUPPORT-MT"), reader_make_constant_shell(makeString("BaseKB")), makeKeyword("DOCUMENTATION"), makeString("(#$not (#$concatenateStrings :fully-bound . :fully-bound))"), makeKeyword("EXAMPLE"), makeString("(#$not (#$concatenateStrings \"something unrelated\" \"foo\" \"bar\"))\nwill be provable\n    (#$not (#$concatenateStrings \"foobar\" \"foo\" \"bar\"))\nwill fail to be provable") });
    ...
    private static final SubLList $list13 = list(new SubLObject[]{ makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("PREDICATE"), reader_make_constant_shell(makeString("concatenateStrings")), makeKeyword("REQUIRED-PATTERN"), listS(reader_make_constant_shell(makeString("concatenateStrings")), makeKeyword("FULLY-BOUND"), makeKeyword("NOT-FULLY-BOUND")), makeKeyword("COST"), makeSymbol("REMOVAL-CONCATENATE-STRINGS-PERMUTE-COST"), makeKeyword("COMPLETENESS"), makeKeyword("COMPLETE"), makeKeyword("OUTPUT-GENERATE-PATTERN"), list(makeKeyword("CALL"), makeSymbol("REMOVAL-CONCATENATE-STRINGS-PERMUTE-POS-OUTPUT-GENERATE"), makeKeyword("INPUT")), makeKeyword("SUPPORT-MODULE"), makeKeyword("OPAQUE"), makeKeyword("SUPPORT-MT"), reader_make_constant_shell(makeString("BaseKB")), makeKeyword("DOCUMENTATION"), makeString("(#$concatenateStrings :fully-bound . :not-fully-bound)"), makeKeyword("EXAMPLE"), makeString("(#$concatenateStrings \"foobar\" ?X \"o\" ?Z)\nwill bind ?X ?Z to both \"fo\" \"bar\"\nand \"f\" \"obar\".") });
    ...
    public static SubLObject declare_removal_modules_concatenate_strings_file() {
        declareFunction(me, "removal_concatenate_strings_bound_args_supported_p", "REMOVAL-CONCATENATE-STRINGS-BOUND-ARGS-SUPPORTED-P", 1, 1, false);
        declareFunction(me, "removal_concatenate_strings_arg_supported_p", "REMOVAL-CONCATENATE-STRINGS-ARG-SUPPORTED-P", 1, 0, false);
        declareFunction(me, "removal_concatenate_strings_concatenate_arg1_pos", "REMOVAL-CONCATENATE-STRINGS-CONCATENATE-ARG1-POS", 1, 1, false);
        declareFunction(me, "removal_concatenate_strings_concatenate_neg", "REMOVAL-CONCATENATE-STRINGS-CONCATENATE-NEG", 1, 1, false);
        declareFunction(me, "removal_concatenate_strings_permute_cost", "REMOVAL-CONCATENATE-STRINGS-PERMUTE-COST", 1, 1, false);
        declareFunction(me, "removal_concatenate_strings_permute_pos_output_generate", "REMOVAL-CONCATENATE-STRINGS-PERMUTE-POS-OUTPUT-GENERATE", 1, 1, false);
        declareFunction(me, "new_concatenate_strings_permute_pos_iterator", "NEW-CONCATENATE-STRINGS-PERMUTE-POS-ITERATOR", 6, 0, false);
        declareFunction(me, "concatenate_strings_permute_pos_iterator_state", "CONCATENATE-STRINGS-PERMUTE-POS-ITERATOR-STATE", 6, 0, false);
        declareFunction(me, "concatenate_strings_permute_pos_iterator_done", "CONCATENATE-STRINGS-PERMUTE-POS-ITERATOR-DONE", 1, 0, false);
        declareFunction(me, "concatenate_strings_permute_pos_iterator_next", "CONCATENATE-STRINGS-PERMUTE-POS-ITERATOR-NEXT", 1, 0, false);
        declareFunction(me, "concatenate_strings_permute_pos_iterator_finalize", "CONCATENATE-STRINGS-PERMUTE-POS-ITERATOR-FINALIZE", 1, 0, false);
        declareFunction(me, "preprocess_stringy_args", "PREPROCESS-STRINGY-ARGS", 1, 0, false);
        declareFunction(me, "generate_concatenate_strings_permutation_iterator", "GENERATE-CONCATENATE-STRINGS-PERMUTATION-ITERATOR", 2, 0, false);
        declareFunction(me, "permutation_ordered_consistentlyP", "PERMUTATION-ORDERED-CONSISTENTLY?", 2, 0, false);
        declareFunction(me, "concatenate_strings_permute_pos_iterator_next_int", "CONCATENATE-STRINGS-PERMUTE-POS-ITERATOR-NEXT-INT", 4, 0, false);
        declareFunction(me, "removal_concatenate_strings_partial_bindings", "REMOVAL-CONCATENATE-STRINGS-PARTIAL-BINDINGS", 5, 0, false);
        declareFunction(me, "insert_empty_strings_between_adjacent_variables", "INSERT-EMPTY-STRINGS-BETWEEN-ADJACENT-VARIABLES", 1, 0, false);
        return NIL;
    }
