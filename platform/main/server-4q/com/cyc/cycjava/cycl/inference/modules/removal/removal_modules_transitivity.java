      ...
      SubLTranslatedFile
{
  ...
  private static final SubLInteger $int$256;
  ...
  public static SubLObject init_removal_modules_transitivity_file()
  {
    ...
    $nearest_restricted_transitive_neighbor_max_query_count$ = SubLFiles.defparameter( "*NEAREST-RESTRICTED-TRANSITIVE-NEIGHBOR-MAX-QUERY-COUNT*", $int$256 );
    return NIL;
  }
  ...
  static
  {
    ...
    $const2$isa = makeConstSym(( "isa" ) );
    $const3$TransitiveBinaryPredicate = makeConstSym(( "TransitiveBinaryPredicate" ) );
    ...
    $const9$genlPreds = makeConstSym(( "genlPreds" ) );
    ...
    $const21$genls = makeConstSym(( "genls" ) );
    ...
    $const32$PredicateUnionFn_Reifiable = makeConstSym(( "PredicateUnionFn-Reifiable" ) );
    $const33$PredicateUnionFn = makeConstSym(( "PredicateUnionFn" ) );
    ...
    $const36$nearestRestrictedTransitiveNeighb = makeConstSym(( "nearestRestrictedTransitiveNeighbor" ) );
    ...
    $list39 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), makeConstSym((
        "nearestRestrictedTransitiveNeighbor" ) ), makeKeyword( "REQUIRED-PATTERN" ), ConsesLow.list( makeConstSym(( "nearestRestrictedTransitiveNeighbor" ) ), makeKeyword(
    ...
    $const40$nearestRestrictedTransitiveNeighb = makeConstSym(( "nearestRestrictedTransitiveNeighbor-Inverse" ) );
    ...
    $list42 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), makeConstSym((
        "nearestRestrictedTransitiveNeighbor-Inverse" ) ), makeKeyword( "REQUIRED-PATTERN" ), ConsesLow.list( makeConstSym(( "nearestRestrictedTransitiveNeighbor-Inverse" ) ),
    ...
    $const43$nearestRestrictedTransitiveNeighb = makeConstSym(( "nearestRestrictedTransitiveNeighbor-Proper" ) );
    ...
    $list45 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), makeConstSym((
        "nearestRestrictedTransitiveNeighbor-Proper" ) ), makeKeyword( "REQUIRED-PATTERN" ), ConsesLow.list( makeConstSym(( "nearestRestrictedTransitiveNeighbor-Proper" ) ),
            makeKeyword( "FULLY-BOUND" ), makeKeyword( "FULLY-BOUND" ), makeKeyword( "FULLY-BOUND" ), makeKeyword( "ANYTHING" ) ), makeKeyword( "COST-EXPRESSION" ), makeSymbol( "*EXPENSIVE-HL-MODULE-CHECK-COST*" ),
      makeKeyword( "COMPLETENESS" ), makeKeyword( "COMPLETE" ), makeKeyword( "EXPAND" ), makeSymbol( "REMOVAL-NEAREST-RESTRICTED-TRANSITIVE-NEIGHBOR-EXPAND" ), makeKeyword( "DOCUMENTATION" ), makeString(
    ...
    $const46$nearestRestrictedTransitiveNeighb = makeConstSym(( "nearestRestrictedTransitiveNeighbor-InverseProper" ) );
    ...
    $list48 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "PREDICATE" ), makeConstSym((
        "nearestRestrictedTransitiveNeighbor-InverseProper" ) ), makeKeyword( "REQUIRED-PATTERN" ), ConsesLow.list( makeConstSym((
