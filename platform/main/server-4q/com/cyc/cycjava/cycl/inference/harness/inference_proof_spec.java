...
public class inference_proof_spec extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.harness.inference_proof_spec";
    ...
    public static SubLObject declare_inference_proof_spec_file() {
        declareFunction(myName, "proof_spec_p", "PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "structural_proof_spec_p", "STRUCTURAL-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "union_proof_spec_p", "UNION-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "join_proof_spec_p", "JOIN-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "split_proof_spec_p", "SPLIT-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "restriction_proof_spec_p", "RESTRICTION-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "join_ordered_proof_spec_p", "JOIN-ORDERED-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "content_proof_spec_p", "CONTENT-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "removal_proof_spec_p", "REMOVAL-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "conjunctive_removal_proof_spec_p", "CONJUNCTIVE-REMOVAL-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "transformation_proof_spec_p", "TRANSFORMATION-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "residual_transformation_proof_spec_p", "RESIDUAL-TRANSFORMATION-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "rewrite_proof_spec_p", "REWRITE-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "removal_module_spec_p", "REMOVAL-MODULE-SPEC-P", 1, 0, false);
        declareFunction(myName, "conjunctive_removal_module_spec_p", "CONJUNCTIVE-REMOVAL-MODULE-SPEC-P", 1, 0, false);
        declareFunction(myName, "transformation_module_spec_p", "TRANSFORMATION-MODULE-SPEC-P", 1, 0, false);
        declareFunction(myName, "literal_spec_p", "LITERAL-SPEC-P", 1, 0, false);
        declareFunction(myName, "single_literal_proof_spec_p", "SINGLE-LITERAL-PROOF-SPEC-P", 1, 0, false);
        declareFunction(myName, "removal_module_name_p", "REMOVAL-MODULE-NAME-P", 1, 0, false);
        declareFunction(myName, "conjunctive_removal_module_name_p", "CONJUNCTIVE-REMOVAL-MODULE-NAME-P", 1, 0, false);
        declareFunction(myName, "transformation_module_name_p", "TRANSFORMATION-MODULE-NAME-P", 1, 0, false);
        declareFunction(myName, "proof_spec_or_nothing_p", "PROOF-SPEC-OR-NOTHING-P", 1, 0, false);
        declareFunction(myName, "transformation_proof_rule_p", "TRANSFORMATION-PROOF-RULE-P", 1, 0, false);
        declareFunction(myName, "transformational_proof_spec_p", "TRANSFORMATIONAL-PROOF-SPEC-P", 2, 0, false);
        declareFunction(myName, "branching_proof_spec_p", "BRANCHING-PROOF-SPEC-P", 2, 0, false);
        declareFunction(myName, "inference_module_spec_p", "INFERENCE-MODULE-SPEC-P", 3, 0, false);
        declareFunction(myName, "negated_module_spec_p", "NEGATED-MODULE-SPEC-P", 2, 0, false);
        declareFunction(myName, "conjunctive_module_spec_p", "CONJUNCTIVE-MODULE-SPEC-P", 2, 0, false);
        declareFunction(myName, "disjunctive_module_spec_p", "DISJUNCTIVE-MODULE-SPEC-P", 2, 0, false);
        declareFunction(myName, "single_literal_proof_spec_hl_sentence", "SINGLE-LITERAL-PROOF-SPEC-HL-SENTENCE", 1, 0, false);
        declareFunction(myName, "restriction_proof_spec_restricted_proof_spec", "RESTRICTION-PROOF-SPEC-RESTRICTED-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "join_ordered_proof_spec_non_focal_proof_spec", "JOIN-ORDERED-PROOF-SPEC-NON-FOCAL-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "split_proof_spec_sub_proof_specs", "SPLIT-PROOF-SPEC-SUB-PROOF-SPECS", 1, 0, false);
        declareFunction(myName, "join_ordered_proof_spec_focal_proof_spec", "JOIN-ORDERED-PROOF-SPEC-FOCAL-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "union_proof_spec_disjunct_proof_spec", "UNION-PROOF-SPEC-DISJUNCT-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "join_ordered_focal_proof_spec_pattern", "JOIN-ORDERED-FOCAL-PROOF-SPEC-PATTERN", 1, 0, false);
        declareFunction(myName, "transformation_proof_spec_rule", "TRANSFORMATION-PROOF-SPEC-RULE", 1, 0, false);
        declareFunction(myName, "transformation_proof_spec_supporting_proof_spec", "TRANSFORMATION-PROOF-SPEC-SUPPORTING-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "residual_transformation_proof_spec_rule", "RESIDUAL-TRANSFORMATION-PROOF-SPEC-RULE", 1, 0, false);
        declareFunction(myName, "residual_transformation_proof_spec_supporting_proof_spec", "RESIDUAL-TRANSFORMATION-PROOF-SPEC-SUPPORTING-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "proof_spec_literal_spec", "PROOF-SPEC-LITERAL-SPEC", 1, 0, false);
        declareFunction(myName, "join_ordered_proof_spec_from_residual_transformation_proof_spec", "JOIN-ORDERED-PROOF-SPEC-FROM-RESIDUAL-TRANSFORMATION-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "filter_proof_specs_of_type", "FILTER-PROOF-SPECS-OF-TYPE", 2, 0, false);
        declareFunction(myName, "compute_proof_spec", "COMPUTE-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "compute_proof_spec_recursive", "COMPUTE-PROOF-SPEC-RECURSIVE", 1, 0, false);
        declareFunction(myName, "compute_removal_proof_spec", "COMPUTE-REMOVAL-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "compute_transformation_proof_spec", "COMPUTE-TRANSFORMATION-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "compute_rewrite_proof_spec", "COMPUTE-REWRITE-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "compute_residual_transformation_proof_spec", "COMPUTE-RESIDUAL-TRANSFORMATION-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "conjunctive_removal_restriction_proof_p", "CONJUNCTIVE-REMOVAL-RESTRICTION-PROOF-P", 1, 0, false);
        declareFunction(myName, "compute_conjunctive_removal_restriction_proof_spec", "COMPUTE-CONJUNCTIVE-REMOVAL-RESTRICTION-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "extract_single_literal_proof_info_for_proof_spec", "EXTRACT-SINGLE-LITERAL-PROOF-INFO-FOR-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "compute_structural_proof_spec", "COMPUTE-STRUCTURAL-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "inference_proof_spec", "INFERENCE-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "inference_first_answer_proof_spec", "INFERENCE-FIRST-ANSWER-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "inference_all_answer_proof_specs", "INFERENCE-ALL-ANSWER-PROOF-SPECS", 1, 0, false);
        declareFunction(myName, "failed_inference_proof_spec", "FAILED-INFERENCE-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "root_problem_has_top_level_disjunctP", "ROOT-PROBLEM-HAS-TOP-LEVEL-DISJUNCT?", 1, 0, false);
        declareMacro(me, "with_failed_proof_spec_for_object", "WITH-FAILED-PROOF-SPEC-FOR-OBJECT");
        declareFunction(myName, "failed_inference_union_problem_proof_spec", "FAILED-INFERENCE-UNION-PROBLEM-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_problem_proof_spec", "FAILED-INFERENCE-PROBLEM-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_link_proof_spec", "FAILED-INFERENCE-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "problem_link_tactic_executedP", "PROBLEM-LINK-TACTIC-EXECUTED?", 1, 0, false);
        declareFunction(myName, "possibly_tactic_executedP", "POSSIBLY-TACTIC-EXECUTED?", 1, 0, false);
        declareFunction(myName, "failed_inference_removal_link_proof_spec", "FAILED-INFERENCE-REMOVAL-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_rewrite_link_proof_spec", "FAILED-INFERENCE-REWRITE-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_transformation_link_proof_spec", "FAILED-INFERENCE-TRANSFORMATION-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_answer_link_proof_spec", "FAILED-INFERENCE-ANSWER-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_restriction_link_proof_spec", "FAILED-INFERENCE-RESTRICTION-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_split_link_proof_spec", "FAILED-INFERENCE-SPLIT-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_join_link_proof_spec", "FAILED-INFERENCE-JOIN-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_join_ordered_link_proof_spec", "FAILED-INFERENCE-JOIN-ORDERED-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_union_link_proof_spec", "FAILED-INFERENCE-UNION-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_residual_transformation_link_proof_spec", "FAILED-INFERENCE-RESIDUAL-TRANSFORMATION-LINK-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_tactic_proof_spec", "FAILED-INFERENCE-TACTIC-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_removal_tactic_proof_spec", "FAILED-INFERENCE-REMOVAL-TACTIC-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_split_tactic_proof_spec", "FAILED-INFERENCE-SPLIT-TACTIC-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_join_ordered_tactic_proof_spec", "FAILED-INFERENCE-JOIN-ORDERED-TACTIC-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_join_tactic_proof_spec", "FAILED-INFERENCE-JOIN-TACTIC-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_transformation_tactic_proof_spec", "FAILED-INFERENCE-TRANSFORMATION-TACTIC-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_rewrite_tactic_proof_spec", "FAILED-INFERENCE-REWRITE-TACTIC-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "failed_inference_restriction_tactic_proof_spec", "FAILED-INFERENCE-RESTRICTION-TACTIC-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "hl_asent_from_problem_query", "HL-ASENT-FROM-PROBLEM-QUERY", 1, 0, false);
        declareFunction(myName, "merge_proof_specs", "MERGE-PROOF-SPECS", 1, 0, false);
        declareFunction(myName, "merge_2_proof_specs", "MERGE-2-PROOF-SPECS", 2, 0, false);
        declareFunction(myName, "merge_into_or_pattern", "MERGE-INTO-OR-PATTERN", 2, 0, false);
        declareFunction(myName, "proof_specs_mergeable_wrt_typeP", "PROOF-SPECS-MERGEABLE-WRT-TYPE?", 2, 0, false);
        declareFunction(myName, "proof_spec_type", "PROOF-SPEC-TYPE", 1, 0, false);
        declareFunction(myName, "merge_removal_proof_specs", "MERGE-REMOVAL-PROOF-SPECS", 2, 0, false);
        declareFunction(myName, "merge_transformation_proof_specs", "MERGE-TRANSFORMATION-PROOF-SPECS", 2, 0, false);
        declareFunction(myName, "merge_residual_transformation_proof_specs", "MERGE-RESIDUAL-TRANSFORMATION-PROOF-SPECS", 2, 0, false);
        declareFunction(myName, "merge_generalized_transformation_proof_specs", "MERGE-GENERALIZED-TRANSFORMATION-PROOF-SPECS", 3, 0, false);
        declareFunction(myName, "merge_single_literal_formula_patterns", "MERGE-SINGLE-LITERAL-FORMULA-PATTERNS", 2, 0, false);
        declareFunction(myName, "destructure_single_literal_formula_pattern", "DESTRUCTURE-SINGLE-LITERAL-FORMULA-PATTERN", 1, 0, false);
        declareFunction(myName, "merge_content_spec_module_patterns", "MERGE-CONTENT-SPEC-MODULE-PATTERNS", 2, 0, false);
        declareFunction(myName, "make_or_pattern", "MAKE-OR-PATTERN", 2, 0, false);
        declareFunction(myName, "or_pattern_p", "OR-PATTERN-P", 1, 0, false);
        declareFunction(myName, "merge_proof_spec_terms", "MERGE-PROOF-SPEC-TERMS", 2, 0, false);
        declareFunction(myName, "merge_proof_spec_term", "MERGE-PROOF-SPEC-TERM", 2, 0, false);
        declareFunction(myName, "genericize_proof_spec", "GENERICIZE-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "genericize_content_proof_spec", "GENERICIZE-CONTENT-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "genericize_removal_proof_spec", "GENERICIZE-REMOVAL-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "genericize_transformation_proof_spec", "GENERICIZE-TRANSFORMATION-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "genericize_residual_transformation_proof_spec", "GENERICIZE-RESIDUAL-TRANSFORMATION-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "genericize_generalized_transformation_proof_spec", "GENERICIZE-GENERALIZED-TRANSFORMATION-PROOF-SPEC", 2, 0, false);
        declareFunction(myName, "genericize_single_literal_formula_pattern", "GENERICIZE-SINGLE-LITERAL-FORMULA-PATTERN", 1, 0, false);
        declareFunction(myName, "genericize_proof_spec_terms", "GENERICIZE-PROOF-SPEC-TERMS", 1, 0, false);
        declareFunction(myName, "genericize_proof_spec_term", "GENERICIZE-PROOF-SPEC-TERM", 1, 0, false);
        declareFunction(myName, "genericize_problem_query", "GENERICIZE-PROBLEM-QUERY", 1, 0, false);
        declareFunction(myName, "genericize_contextualized_clause", "GENERICIZE-CONTEXTUALIZED-CLAUSE", 1, 0, false);
        declareFunction(myName, "genericize_contextualized_asent", "GENERICIZE-CONTEXTUALIZED-ASENT", 1, 0, false);
        declareFunction(myName, "genericize_formula", "GENERICIZE-FORMULA", 1, 0, false);
        declareFunction(myName, "genericize_formula_args", "GENERICIZE-FORMULA-ARGS", 1, 0, false);
        declareFunction(myName, "genericize_term_wrt_pattern_match", "GENERICIZE-TERM-WRT-PATTERN-MATCH", 1, 0, false);
        declareFunction(myName, "proof_spec_possibly_admits_problemP", "PROOF-SPEC-POSSIBLY-ADMITS-PROBLEM?", 2, 0, false);
        declareFunction(myName, "query_parameters_from_proof_spec", "QUERY-PARAMETERS-FROM-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "query_allowance_parameters_from_proof_spec", "QUERY-ALLOWANCE-PARAMETERS-FROM-PROOF-SPEC", 1, 0, false);
        declareFunction(myName, "query_allowance_parameters_from_proof_spec_recursive", "QUERY-ALLOWANCE-PARAMETERS-FROM-PROOF-SPEC-RECURSIVE", 3, 0, false);
        declareFunction(myName, "module_parameters_from_module_pattern", "MODULE-PARAMETERS-FROM-MODULE-PATTERN", 2, 0, false);
        declareFunction(myName, "use_kbq_proof_spec_tableP", "USE-KBQ-PROOF-SPEC-TABLE?", 0, 0, false);
        declareFunction(myName, "initialize_kbq_proof_spec_table", "INITIALIZE-KBQ-PROOF-SPEC-TABLE", 1, 0, false);
        declareFunction(myName, "overriding_experimental_proof_spec_properties", "OVERRIDING-EXPERIMENTAL-PROOF-SPEC-PROPERTIES", 1, 0, false);
        declareFunction(myName, "initialize_kbq_proof_spec_table_from_query_set", "INITIALIZE-KBQ-PROOF-SPEC-TABLE-FROM-QUERY-SET", 1, 1, false);
        declareFunction(myName, "proof_spec_for_kbq", "PROOF-SPEC-FOR-KBQ", 1, 0, false);
        declareFunction(myName, "inference_results_for_kbq", "INFERENCE-RESULTS-FOR-KBQ", 1, 0, false);
        declareFunction(myName, "analyze_asked_queries_for_proof_spec_overlap", "ANALYZE-ASKED-QUERIES-FOR-PROOF-SPEC-OVERLAP", 1, 0, false);
        declareFunction(myName, "run_proof_spec_experiment", "RUN-PROOF-SPEC-EXPERIMENT", 2, 1, false);
        declareFunction(myName, "run_and_save_one_proof_spec_experiment", "RUN-AND-SAVE-ONE-PROOF-SPEC-EXPERIMENT", 2, 1, false);
        declareFunction(myName, "load_proof_spec_experiment", "LOAD-PROOF-SPEC-EXPERIMENT", 1, 0, false);
        declareFunction(myName, "proof_spec_data_metric_positions", "PROOF-SPEC-DATA-METRIC-POSITIONS", 1, 0, false);
        declareFunction(myName, "proof_spec_data_lookup", "PROOF-SPEC-DATA-LOOKUP", 2, 0, false);
        declareFunction(myName, "analyze_proof_spec_experiment_answerability", "ANALYZE-PROOF-SPEC-EXPERIMENT-ANSWERABILITY", 1, 0, false);
        declareFunction(myName, "graph_proof_spec_experiment_metric", "GRAPH-PROOF-SPEC-EXPERIMENT-METRIC", 2, 2, false);
        declareFunction(myName, "experiment_run_proof_spec_for_kbq", "EXPERIMENT-RUN-PROOF-SPEC-FOR-KBQ", 1, 1, false);
        declareFunction(myName, "test_proof_spec_for_kbq", "TEST-PROOF-SPEC-FOR-KBQ", 1, 1, false);
        declareFunction(myName, "test_proof_spec_for_query", "TEST-PROOF-SPEC-FOR-QUERY", 2, 1, false);
        declareFunction(myName, "test_proof_spec_for_query_int", "TEST-PROOF-SPEC-FOR-QUERY-INT", 4, 0, false);
        declareFunction(myName, "retest_proof_spec_for_kbq", "RETEST-PROOF-SPEC-FOR-KBQ", 2, 0, false);
        declareFunction(myName, "retest_proof_spec_for_query", "RETEST-PROOF-SPEC-FOR-QUERY", 4, 0, false);
        declareFunction(myName, "test_inference_proof_spec", "TEST-INFERENCE-PROOF-SPEC", 0, 1, false);
        declareFunction(myName, "test_query_first_proof_spec", "TEST-QUERY-FIRST-PROOF-SPEC", 1, 0, false);
        return NIL;
    }
