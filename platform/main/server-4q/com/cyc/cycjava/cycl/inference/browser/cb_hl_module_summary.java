...
public class cb_hl_module_summary extends SubLTranslatedFile {
    ...
    public static String myName = "com.cyc.cycjava.cycl.inference.browser.cb_hl_module_summary";
    ...
    public static SubLObject declare_cb_hl_module_summary_file() {
        declareFunction(myName, "cb_hl_module_summary", "CB-HL-MODULE-SUMMARY", 0, 1, false);
        declareFunction(myName, "cb_link_hl_module_index", "CB-LINK-HL-MODULE-INDEX", 0, 2, false);
        declareFunction(myName, "cb_transformation_modules", "CB-TRANSFORMATION-MODULES", 0, 1, false);
        declareFunction(myName, "cb_link_transformation_modules", "CB-LINK-TRANSFORMATION-MODULES", 0, 1, false);
        declareFunction(myName, "cb_all_transformation_modules", "CB-ALL-TRANSFORMATION-MODULES", 0, 0, false);
        declareFunction(myName, "cb_generic_removal_modules", "CB-GENERIC-REMOVAL-MODULES", 0, 1, false);
        declareFunction(myName, "cb_link_generic_removal_modules", "CB-LINK-GENERIC-REMOVAL-MODULES", 0, 1, false);
        declareFunction(myName, "cb_all_generic_removal_modules", "CB-ALL-GENERIC-REMOVAL-MODULES", 0, 0, false);
        declareFunction(myName, "cb_generic_preference_modules", "CB-GENERIC-PREFERENCE-MODULES", 0, 1, false);
        declareFunction(myName, "cb_link_generic_preference_modules", "CB-LINK-GENERIC-PREFERENCE-MODULES", 0, 1, false);
        declareFunction(myName, "cb_all_generic_preference_modules", "CB-ALL-GENERIC-PREFERENCE-MODULES", 0, 0, false);
        declareFunction(myName, "cb_conjunctive_removal_modules", "CB-CONJUNCTIVE-REMOVAL-MODULES", 0, 1, false);
        declareFunction(myName, "cb_link_conjunctive_removal_modules", "CB-LINK-CONJUNCTIVE-REMOVAL-MODULES", 0, 1, false);
        declareFunction(myName, "cb_all_conjunctive_removal_modules", "CB-ALL-CONJUNCTIVE-REMOVAL-MODULES", 0, 0, false);
        declareFunction(myName, "cb_predicate_specific_removal_modules", "CB-PREDICATE-SPECIFIC-REMOVAL-MODULES", 1, 0, false);
        declareFunction(myName, "cb_link_predicate_specific_removal_modules", "CB-LINK-PREDICATE-SPECIFIC-REMOVAL-MODULES", 1, 1, false);
        declareFunction(myName, "cb_predicate_specific_removal_modules_guts", "CB-PREDICATE-SPECIFIC-REMOVAL-MODULES-GUTS", 1, 0, false);
        declareFunction(myName, "cb_display_specific_use_generic", "CB-DISPLAY-SPECIFIC-USE-GENERIC", 2, 0, false);
        declareFunction(myName, "cb_specific_removal_module_predicates", "CB-SPECIFIC-REMOVAL-MODULE-PREDICATES", 0, 0, false);
        declareFunction(myName, "cb_specific_removal_modules", "CB-SPECIFIC-REMOVAL-MODULES", 1, 0, false);
        declareFunction(myName, "cb_specific_use_generic", "CB-SPECIFIC-USE-GENERIC", 1, 0, false);
        declareFunction(myName, "cb_total_specific_removal_module_count", "CB-TOTAL-SPECIFIC-REMOVAL-MODULE-COUNT", 0, 0, false);
        declareFunction(myName, "cb_specific_removal_module_count", "CB-SPECIFIC-REMOVAL-MODULE-COUNT", 1, 0, false);
        declareFunction(myName, "cb_predicate_specific_preference_modules", "CB-PREDICATE-SPECIFIC-PREFERENCE-MODULES", 1, 0, false);
        declareFunction(myName, "cb_link_predicate_specific_preference_modules", "CB-LINK-PREDICATE-SPECIFIC-PREFERENCE-MODULES", 1, 1, false);
        declareFunction(myName, "cb_predicate_specific_preference_modules_guts", "CB-PREDICATE-SPECIFIC-PREFERENCE-MODULES-GUTS", 1, 0, false);
        declareFunction(myName, "cb_all_specific_preference_module_predicates", "CB-ALL-SPECIFIC-PREFERENCE-MODULE-PREDICATES", 0, 0, false);
        declareFunction(myName, "cb_rewrite_modules", "CB-REWRITE-MODULES", 0, 1, false);
        declareFunction(myName, "cb_link_rewrite_modules", "CB-LINK-REWRITE-MODULES", 0, 1, false);
        declareFunction(myName, "cb_all_rewrite_modules", "CB-ALL-REWRITE-MODULES", 0, 0, false);
        declareFunction(myName, "cb_forward_modules", "CB-FORWARD-MODULES", 0, 1, false);
        declareFunction(myName, "cb_link_forward_modules", "CB-LINK-FORWARD-MODULES", 0, 1, false);
        declareFunction(myName, "cb_all_forward_modules", "CB-ALL-FORWARD-MODULES", 0, 0, false);
        declareFunction(myName, "cb_hl_storage_modules", "CB-HL-STORAGE-MODULES", 0, 1, false);
        declareFunction(myName, "cb_link_hl_storage_modules", "CB-LINK-HL-STORAGE-MODULES", 0, 1, false);
        declareFunction(myName, "cb_generic_hl_storage_modules", "CB-GENERIC-HL-STORAGE-MODULES", 0, 1, false);
        declareFunction(myName, "cb_link_generic_hl_storage_modules", "CB-LINK-GENERIC-HL-STORAGE-MODULES", 0, 1, false);
        declareFunction(myName, "cb_all_generic_hl_storage_modules", "CB-ALL-GENERIC-HL-STORAGE-MODULES", 0, 0, false);
        declareFunction(myName, "cb_predicate_specific_hl_storage_modules", "CB-PREDICATE-SPECIFIC-HL-STORAGE-MODULES", 1, 0, false);
        declareFunction(myName, "cb_link_predicate_specific_hl_storage_modules", "CB-LINK-PREDICATE-SPECIFIC-HL-STORAGE-MODULES", 1, 1, false);
        declareFunction(myName, "cb_predicate_specific_hl_storage_modules_guts", "CB-PREDICATE-SPECIFIC-HL-STORAGE-MODULES-GUTS", 1, 0, false);
        declareFunction(myName, "cb_specific_hl_storage_module_predicates", "CB-SPECIFIC-HL-STORAGE-MODULE-PREDICATES", 0, 0, false);
        declareFunction(myName, "cb_specific_hl_storage_modules", "CB-SPECIFIC-HL-STORAGE-MODULES", 1, 0, false);
        declareFunction(myName, "cb_total_specific_hl_storage_module_count", "CB-TOTAL-SPECIFIC-HL-STORAGE-MODULE-COUNT", 0, 0, false);
        declareFunction(myName, "cb_specific_hl_storage_module_count", "CB-SPECIFIC-HL-STORAGE-MODULE-COUNT", 1, 0, false);
        declareFunction(myName, "cb_display_hl_module_info", "CB-DISPLAY-HL-MODULE-INFO", 1, 0, false);
        declareFunction(myName, "cb_hl_module", "CB-HL-MODULE", 1, 0, false);
        declareFunction(myName, "cb_link_hl_module", "CB-LINK-HL-MODULE", 1, 1, false);
        declareFunction(myName, "cb_form_hl_module_method", "CB-FORM-HL-MODULE-METHOD", 1, 2, false);
        declareFunction(myName, "cb_hl_module_id", "CB-HL-MODULE-ID", 1, 0, false);
        declareFunction(myName, "cb_guess_hl_module", "CB-GUESS-HL-MODULE", 1, 0, false);
        declareFunction(myName, "cb_hl_module_guts", "CB-HL-MODULE-GUTS", 1, 0, false);
        declareFunction(myName, "cb_evaluatable_predicates", "CB-EVALUATABLE-PREDICATES", 0, 1, false);
        declareFunction(myName, "cb_link_evaluatable_predicates", "CB-LINK-EVALUATABLE-PREDICATES", 0, 1, false);
        declareFunction(myName, "cb_display_evaluatable_predicate", "CB-DISPLAY-EVALUATABLE-PREDICATE", 1, 0, false);
        declareFunction(myName, "cb_gather_evaluatable_predicates", "CB-GATHER-EVALUATABLE-PREDICATES", 0, 0, false);
        declareFunction(myName, "cb_evaluatable_predicate_count", "CB-EVALUATABLE-PREDICATE-COUNT", 0, 0, false);
        declareFunction(myName, "cb_evaluatable_functions", "CB-EVALUATABLE-FUNCTIONS", 0, 1, false);
        declareFunction(myName, "cb_link_evaluatable_functions", "CB-LINK-EVALUATABLE-FUNCTIONS", 0, 1, false);
        declareFunction(myName, "cb_display_evaluatable_function", "CB-DISPLAY-EVALUATABLE-FUNCTION", 1, 0, false);
        declareFunction(myName, "cb_function_result_type", "CB-FUNCTION-RESULT-TYPE", 1, 0, false);
        declareFunction(myName, "cb_gather_evaluatable_functions", "CB-GATHER-EVALUATABLE-FUNCTIONS", 0, 0, false);
        declareFunction(myName, "cb_evaluatable_function_count", "CB-EVALUATABLE-FUNCTION-COUNT", 0, 0, false);
        declareFunction(myName, "cb_relation_arg_signature", "CB-RELATION-ARG-SIGNATURE", 1, 0, false);
        declareFunction(myName, "cb_display_evaluation_defn_example", "CB-DISPLAY-EVALUATION-DEFN-EXAMPLE", 1, 0, false);
        declareFunction(myName, "evaluation_defn_example", "EVALUATION-DEFN-EXAMPLE", 1, 0, false);
        return NIL;
    }
