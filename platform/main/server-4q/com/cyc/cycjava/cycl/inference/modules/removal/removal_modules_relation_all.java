...
public final class removal_modules_relation_all
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject removal_some_relation_all_for_collection(final SubLObject collection, SubLObject mt)
  {
    ...
    {
      return kb_mapping_utilities.some_pred_value_in_relevant_mts( collection, $const0$relationAll, mt, TWO_INTEGER, UNPROVIDED );
    }
    return NIL;
  }
  ...
  {
    return kb_indexing.relevant_num_gaf_arg_index( predicate, ONE_INTEGER, $const0$relationAll );
  }
  ...
  {
    return arguments.make_hl_support( $kw4$CODE, $relation_all_rule$.getGlobalValue(), $relation_all_defining_mt$.getGlobalValue(), $kw5$TRUE_MON );
  }
  ...
  public static SubLObject removal_relation_all_check_expand(final SubLObject asent, SubLObject sense)
  {
    ...
    {
      final SubLObject pred_var = $const0$relationAll;
    ...
    else
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        {
          final SubLObject pred_var2 = $const0$relationAll;
          if( NIL != kb_mapping_macros.do_gaf_arg_index_key_validator( collection, TWO_INTEGER, pred_var2 ) )
          {
            ...
            while ( NIL == done_var2)
            {
              ...
              if( NIL != valid2 )
              {
                ...
                try
                {
                  final_index_iterator2 = kb_mapping_macros.new_final_index_iterator( final_index_spec2, $kw7$GAF, $kw8$TRUE, NIL );
  ...
  public static SubLObject removal_relation_all_check_expand_guts(final SubLObject asent, final SubLObject assertion)
  {
    if( NIL != backward_utilities.direction_is_relevant( assertion ) )
    {
      ...
      final SubLObject isa_support = arguments.make_hl_support( $kw11$ISA, ConsesLow.list( $const12$isa, v_object, collection ), UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject unary_pred_holds(final SubLObject predicate, final SubLObject v_term, SubLObject mt)
  {
    ...
    return kb_mapping_utilities.some_pred_value_in_relevant_mts( v_term, predicate, mt, ONE_INTEGER, $kw8$TRUE );
  }
  ...
  public static SubLObject unary_pred_holds_via_relation_all(final SubLObject predicate, final SubLObject v_term, SubLObject mt)
  {
    ...
    if( NIL == ans )
    {
      final SubLObject deck_type = ( $kw14$BREADTH == $kw15$DEPTH ) ? $kw16$STACK : $kw17$QUEUE;
        ...
        try
        {
          ...
          try
          {
            ...
            try
            {
              ...
              try
              {
                sbhl_search_vars.$sbhl_search_module$.bind( sbhl_module_vars.get_sbhl_module( $const12$isa ), thread );
                sbhl_search_vars.$sbhl_search_module_type$.bind( sbhl_module_utilities.get_sbhl_module_type( sbhl_module_vars.get_sbhl_module( $const12$isa ) ), thread );
                sbhl_search_vars.$sbhl_add_node_to_result_test$.bind( sbhl_module_utilities.get_sbhl_add_node_to_result_test( sbhl_module_vars.get_sbhl_module( $const12$isa ) ), thread );
                sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                sbhl_module_vars.$sbhl_module$.bind( sbhl_module_vars.get_sbhl_module( $const12$isa ), thread );
                if( NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test( v_term, sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ) )
                {
                  ...
                  try
                  {
                    ...
                    sbhl_search_vars.$genl_inverse_mode_p$.bind( NIL, thread );
                    final SubLObject accessible_modules = sbhl_macros.get_sbhl_accessible_modules( sbhl_module_vars.get_sbhl_module( $const12$isa ) );
                    SubLObject rest;
                                  ...
                                  iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                              {
                                ...
                                if( NIL != mt_relevance_macros.relevant_mtP( mt_$18 ) )
                                {
                                  ...
                                  try
                                  {
                                    ...
                                    for( iteration_state_$20 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == ans && NIL == dictionary_contents
                    ...
                    try
                    {
                      ...
                      while ( NIL != node_var && NIL == ans)
                      {
                        ...
                        ans = kb_mapping_utilities.pred_u_v_holds( $const0$relationAll, predicate, col, ONE_INTEGER, TWO_INTEGER, $kw8$TRUE );
                                      ...
                                      .do_dictionary_contents_doneP( iteration_state2 ); iteration_state2 = dictionary_contents.do_dictionary_contents_next( iteration_state2 ) )
                                  {
                                    ...
                                    if( NIL != mt_relevance_macros.relevant_mtP( mt_$19 ) )
                                    {
                                      ...
                                      try
                                      {
                                        ...
                                        for( iteration_state_$21 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links2 ) ); NIL == ans && NIL == dictionary_contents
                ...
                {
                  sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str28$Node__a_does_not_pass_sbhl_type_t, v_term, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED,
  ...
  {
    SubLFiles.declareFunction( me, "removal_some_relation_all_for_predicate", "REMOVAL-SOME-RELATION-ALL-FOR-PREDICATE", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_some_relation_all_for_collection", "REMOVAL-SOME-RELATION-ALL-FOR-COLLECTION", 1, 1, false );
    SubLFiles.declareFunction( me, "relation_all_predicate_cost_estimate", "RELATION-ALL-PREDICATE-COST-ESTIMATE", 1, 0, false );
    SubLFiles.declareFunction( me, "relation_all_collection_cost_estimate", "RELATION-ALL-COLLECTION-COST-ESTIMATE", 0, 0, false );
    SubLFiles.declareFunction( me, "removal_relation_all_required", "REMOVAL-RELATION-ALL-REQUIRED", 1, 0, false );
    SubLFiles.declareFunction( me, "make_relation_all_support", "MAKE-RELATION-ALL-SUPPORT", 0, 0, false );
    SubLFiles.declareFunction( me, "removal_relation_all_check_required", "REMOVAL-RELATION-ALL-CHECK-REQUIRED", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_relation_all_check_expand", "REMOVAL-RELATION-ALL-CHECK-EXPAND", 1, 1, false );
    SubLFiles.declareFunction( me, "removal_relation_all_check_via_collection_expand", "REMOVAL-RELATION-ALL-CHECK-VIA-COLLECTION-EXPAND", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_relation_all_check_via_predicate_expand", "REMOVAL-RELATION-ALL-CHECK-VIA-PREDICATE-EXPAND", 2, 0, false );
    SubLFiles.declareFunction( me, "removal_relation_all_check_expand_guts", "REMOVAL-RELATION-ALL-CHECK-EXPAND-GUTS", 2, 0, false );
    SubLFiles.declareFunction( me, "unary_pred_holds", "UNARY-PRED-HOLDS", 2, 1, false );
    SubLFiles.declareFunction( me, "unary_pred_holds_via_relation_all", "UNARY-PRED-HOLDS-VIA-RELATION-ALL", 2, 1, false );
    return NIL;
  }
  ...
  public static SubLObject init_removal_modules_relation_all_file()
  {
    ...
    $relation_all_rule$ = SubLFiles.deflexical( "*RELATION-ALL-RULE*", $list1 );
    $relation_all_defining_mt$ = SubLFiles.deflexical( "*RELATION-ALL-DEFINING-MT*", maybeDefault( $sym2$_RELATION_ALL_DEFINING_MT_, $relation_all_defining_mt$, $const3$BaseKB ) );
    $removal_relation_all_check_cost$ = SubLFiles.defparameter( "*REMOVAL-RELATION-ALL-CHECK-COST*", $float6$1_5 );
    return NIL;
  }
  ...
  static
  {
    ...
    $const0$relationAll = constant_handles.reader_make_constant_shell( makeString( "relationAll" ) );
    $list1 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "implies" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "and" ) ), ConsesLow.list( constant_handles
        .reader_make_constant_shell( makeString( "relationAll" ) ), makeSymbol( "?PRED" ), makeSymbol( "?COL" ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "isa" ) ), makeSymbol( "?OBJ" ),
            makeSymbol( "?COL" ) ) ), ConsesLow.list( makeSymbol( "?PRED" ), makeSymbol( "?OBJ" ) ) );
    ...
    $float6$1_5 = makeDouble( 1.5 );
    $kw7$GAF = makeKeyword( "GAF" );
    $kw8$TRUE = makeKeyword( "TRUE" );
    $kw9$REMOVAL_RELATION_ALL_CHECK = makeKeyword( "REMOVAL-RELATION-ALL-CHECK" );
    $list10 = ConsesLow.list( new SubLObject[] { makeKeyword( "SENSE" ), makeKeyword( "POS" ), makeKeyword( "ARITY" ), ONE_INTEGER, makeKeyword( "REQUIRED-PATTERN" ), ConsesLow.list( makeKeyword( "FORT" ), makeKeyword(
        "FORT" ) ), makeKeyword( "REQUIRED" ), makeSymbol( "REMOVAL-RELATION-ALL-CHECK-REQUIRED" ), makeKeyword( "COST-EXPRESSION" ), makeSymbol( "*REMOVAL-RELATION-ALL-CHECK-COST*" ), makeKeyword( "EXPAND" ),
      makeSymbol( "REMOVAL-RELATION-ALL-CHECK-EXPAND" ), makeKeyword( "DOCUMENTATION" ), makeString(
          "(<predicate> <object>) where <object> is a FORT\nfrom (#$relationAll <predicate> <collection>) \nand (#$isa <object> <collection>)" ), makeKeyword( "EXAMPLE" ), makeString(
              "(#$temporallyContinuous #$AbrahamLincoln)\nfrom (#$relationAll #$temporallyContinuous #$Entity)\nand (#$isa #$AbrahamLincoln #$Entity)" )
    } );
    $kw11$ISA = makeKeyword( "ISA" );
    $const12$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $sym13$FORT_P = makeSymbol( "FORT-P" );
    $kw14$BREADTH = makeKeyword( "BREADTH" );
