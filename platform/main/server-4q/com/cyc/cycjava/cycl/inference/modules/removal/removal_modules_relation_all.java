...
public class removal_modules_relation_all extends SubLTranslatedFile {
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 1800L)
    private static SubLSymbol $relation_all_rule$;
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 1900L)
    public static SubLSymbol $relation_all_defining_mt$;
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 2500L)
    private static SubLSymbol $removal_relation_all_check_cost$;
    private static SubLObject $$relationAll;
    private static SubLList $list1;
    private static SubLSymbol $sym2$_RELATION_ALL_DEFINING_MT_;
    ...
    private static SubLSymbol $REMOVAL_RELATION_ALL_CHECK;
    private static SubLList $list10;
    private static SubLSymbol $ISA;
    private static SubLObject $$isa;
    private static SubLSymbol $sym13$FORT_P;
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 600L)
    public static SubLObject removal_some_relation_all_for_predicate(SubLObject predicate, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 1000L)
    public static SubLObject removal_some_relation_all_for_collection(SubLObject collection, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 1200L)
    public static SubLObject relation_all_predicate_cost_estimate(SubLObject predicate) {
        return kb_indexing.relevant_num_gaf_arg_index(predicate, ONE_INTEGER, $$relationAll);
    }

    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 1400L)
    public static SubLObject relation_all_collection_cost_estimate() {
        SubLThread thread = SubLProcess.currentSubLThread();
        return Numbers.integerDivide(control_vars.$average_all_isa_count$.getDynamicValue(thread), $estimated_per_collection_relation_all_fraction$.getDynamicValue(thread));
    }

    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 1600L)
    public static SubLObject removal_relation_all_required(SubLObject asent) {
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 2000L)
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 2100L)
    public static SubLObject removal_relation_all_check_required(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 2600L)
    public static SubLObject removal_relation_all_check_expand(SubLObject asent, SubLObject sense) {
        if (sense == UNPROVIDED) {
            sense = NIL;
        }
        SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
        SubLObject v_object = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
        SubLObject predicate_cost_estimate = relation_all_predicate_cost_estimate(predicate);
        SubLObject collection_cost_estimate = relation_all_collection_cost_estimate();
        if (predicate_cost_estimate.numLE(collection_cost_estimate)) {
            SubLObject pred_var = $$relationAll;
            ...
            while (NIL != cdolist_list_var) {
                if (NIL != removal_some_relation_all_for_collection(collection, NIL)) {
                    SubLObject pred_var2 = $$relationAll;
                            ...
                            if (NIL != valid2) {
                                ...
                                try {
                                    ...
                                    while (NIL == done_var_$2) {
                                        SubLObject assertion2 = iteration.iteration_next_without_values_macro_helper(final_index_iterator2, token_var_$3);
                                        SubLObject valid_$4 = makeBoolean(!token_var_$3.eql(assertion2));
                                        if (NIL != valid_$4) {
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 4200L)
    public static SubLObject removal_relation_all_check_via_collection_expand(SubLObject asent, SubLObject assertion) {
        SubLObject predicate = cycl_utilities.atomic_sentence_predicate(asent);
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 4500L)
    public static SubLObject removal_relation_all_check_via_predicate_expand(SubLObject asent, SubLObject assertion) {
        SubLObject v_object = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 4900L)
    public static SubLObject removal_relation_all_check_expand_guts(SubLObject asent, SubLObject assertion) {
        if (NIL != backward_utilities.direction_is_relevant(assertion)) {
            SubLObject v_object = cycl_utilities.atomic_sentence_arg1(asent, UNPROVIDED);
            SubLObject collection = assertions_high.gaf_arg2(assertion);
            SubLObject rule_support = make_relation_all_support();
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 5400L)
    public static SubLObject unary_pred_holds(SubLObject predicate, SubLObject v_term, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
    ...
    @SubL(source = "cycl/inference/modules/removal/removal-modules-relation-all.lisp", position = 5600L)
    public static SubLObject unary_pred_holds_via_relation_all(SubLObject predicate, SubLObject v_term, SubLObject mt) {
        if (mt == UNPROVIDED) {
            mt = NIL;
        }
        SubLThread thread = SubLProcess.currentSubLThread();
        ...
        SubLObject ans = NIL;
        if (NIL == ans) {
            SubLObject deck_type = ($BREADTH == $DEPTH) ? $STACK : $QUEUE;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        SubLObject _prev_bind_0_$8 = sbhl_search_vars.$sbhl_tv$.currentBinding(thread);
                        SubLObject _prev_bind_1_$9 = sbhl_search_vars.$relevant_sbhl_tv_function$.currentBinding(thread);
                        try {
                            ...
                            SubLObject _prev_bind_0_$9 = sbhl_search_vars.$sbhl_search_module$.currentBinding(thread);
                            SubLObject _prev_bind_1_$10 = sbhl_search_vars.$sbhl_search_module_type$.currentBinding(thread);
                            SubLObject _prev_bind_2_$12 = sbhl_search_vars.$sbhl_add_node_to_result_test$.currentBinding(thread);
                            ...
                            try {
                                ...
                                if (NIL != sbhl_paranoia.suspend_sbhl_type_checkingP() || NIL != sbhl_module_utilities.apply_sbhl_module_type_test(v_term, sbhl_module_vars.get_sbhl_module(UNPROVIDED))) {
                                    SubLObject _prev_bind_0_$10 = sbhl_search_vars.$sbhl_search_direction$.currentBinding(thread);
                                    SubLObject _prev_bind_1_$11 = sbhl_link_vars.$sbhl_link_direction$.currentBinding(thread);
                                    SubLObject _prev_bind_2_$13 = sbhl_search_vars.$genl_inverse_mode_p$.currentBinding(thread);
                                    try {
                                                            ...
                                                            for (iteration_state = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents(mt_links)); NIL == ans
                                                                ...
                                                                if (NIL != mt_relevance_macros.relevant_mtP(mt_$18)) {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        for (iteration_state_$20 = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents(tv_links)); NIL == ans
                                                                                && NIL == dictionary_contents.do_dictionary_contents_doneP(iteration_state_$20); iteration_state_$20 = dictionary_contents.do_dictionary_contents_next(iteration_state_$20)) {
                                                                            thread.resetMultipleValues();
                                        ...
                                        SubLObject _prev_bind_0_$15 = sbhl_module_vars.$sbhl_module$.currentBinding(thread);
                                        SubLObject _prev_bind_1_$13 = sbhl_search_vars.$genl_inverse_mode_p$.currentBinding(thread);
                                        SubLObject _prev_bind_2_$14 = sbhl_link_vars.$sbhl_link_direction$.currentBinding(thread);
                                        try {
                                            ...
                                            while (NIL != node_var && NIL == ans) {
                                                ...
                                                SubLObject accessible_modules2 = sbhl_macros.get_sbhl_accessible_modules(sbhl_module_vars.get_sbhl_module(UNPROVIDED));
                                                SubLObject rest2;
                                                                    ...
                                                                    for (iteration_state2 = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents(mt_links2)); NIL == ans
                                                                        ...
                                                                        if (NIL != mt_relevance_macros.relevant_mtP(mt_$19)) {
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                for (iteration_state_$21 = dictionary_contents.do_dictionary_contents_state(dictionary.dictionary_contents(tv_links2)); NIL == ans
                                                                                        && NIL == dictionary_contents.do_dictionary_contents_doneP(iteration_state_$21); iteration_state_$21 = dictionary_contents.do_dictionary_contents_next(iteration_state_$21)) {
                                                                                    thread.resetMultipleValues();
    ...
    public static SubLObject init_removal_modules_relation_all_file() {
        $estimated_per_collection_relation_all_fraction$ = SubLFiles.defparameter("*ESTIMATED-PER-COLLECTION-RELATION-ALL-FRACTION*", TEN_INTEGER);
        $relation_all_rule$ = deflexical("*RELATION-ALL-RULE*", $list1);
        $relation_all_defining_mt$ = deflexical("*RELATION-ALL-DEFINING-MT*", maybeDefault($sym2$_RELATION_ALL_DEFINING_MT_, $relation_all_defining_mt$, $$BaseKB));
        $removal_relation_all_check_cost$ = defparameter("*REMOVAL-RELATION-ALL-CHECK-COST*", $float$1_5);
        return NIL;
    }
    ...
    public static SubLObject setup_removal_modules_relation_all_file() {
        ...
        mt_vars.note_mt_var($sym2$_RELATION_ALL_DEFINING_MT_, $$relationAll);
    ...
    static {
        me = new removal_modules_relation_all();
        $estimated_per_collection_relation_all_fraction$ = null;
        $relation_all_rule$ = null;
        $relation_all_defining_mt$ = null;
        $removal_relation_all_check_cost$ = null;
        $$relationAll = makeConstSym(("relationAll"));
        $list1 = list(makeConstSym(("implies")), list(makeConstSym(("and")), list(makeConstSym(("relationAll")), makeSymbol("?PRED"), makeSymbol("?COL")), list(makeConstSym(("isa")), makeSymbol("?OBJ"), makeSymbol("?COL"))), list(makeSymbol("?PRED"), makeSymbol("?OBJ")));
        $sym2$_RELATION_ALL_DEFINING_MT_ = makeSymbol("*RELATION-ALL-DEFINING-MT*");
        ...
        $REMOVAL_RELATION_ALL_CHECK = makeKeyword("REMOVAL-RELATION-ALL-CHECK");
        $list10 = list(new SubLObject[] { makeKeyword("SENSE"), makeKeyword("POS"), makeKeyword("ARITY"), ONE_INTEGER, makeKeyword("REQUIRED-PATTERN"), list(makeKeyword("FORT"), makeKeyword("FORT")), makeKeyword("REQUIRED"), makeSymbol("REMOVAL-RELATION-ALL-CHECK-REQUIRED"),
                makeKeyword("COST-EXPRESSION"), makeSymbol("*REMOVAL-RELATION-ALL-CHECK-COST*"), makeKeyword("EXPAND"), makeSymbol("REMOVAL-RELATION-ALL-CHECK-EXPAND"), makeKeyword("DOCUMENTATION"),
                makeString("(<predicate> <object>) where <object> is a FORT\nfrom (#$relationAll <predicate> <collection>) \nand (#$isa <object> <collection>)"), makeKeyword("EXAMPLE"),
                makeString("(#$temporallyContinuous #$AbrahamLincoln)\nfrom (#$relationAll #$temporallyContinuous #$Entity)\nand (#$isa #$AbrahamLincoln #$Entity)") });
        $ISA = makeKeyword("ISA");
