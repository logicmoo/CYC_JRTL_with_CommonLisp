...
public final class psp_main extends SubLTranslatedFile {
    ...
    public static SubLObject psp_answer_accumulator_p(final SubLObject v_object) {
        return v_object.getClass() == psp_main.$psp_answer_accumulator_native.class ? T : NIL;
    }

    public static SubLObject psp_answer_accumulator_best(final SubLObject v_object) {
        assert NIL != psp_answer_accumulator_p(v_object) : "psp_main.psp_answer_accumulator_p(v_object) " + "CommonSymbols.NIL != psp_main.psp_answer_accumulator_p(v_object) " + v_object;
    ...
    public static SubLObject make_psp_answer_accumulator(SubLObject arglist) {
        ...
        final SubLObject v_new = new psp_main.$psp_answer_accumulator_native();
        SubLObject next;
    ...
    public static final class $psp_answer_accumulator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(psp_main.$psp_answer_accumulator_native.class, PSP_ANSWER_ACCUMULATOR, PSP_ANSWER_ACCUMULATOR_P, $list37, $list38, new String[]{ "$best", "$rest", "$plist" }, $list39, $list40, PPRINT_PSP_ANSWER_ACCUMULATOR);
        }
    }
