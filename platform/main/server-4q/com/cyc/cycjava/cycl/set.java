...
public final class set extends SubLTranslatedFile {
    ...
    public static SubLObject set_p(final SubLObject v_object) {
        return v_object.getClass() == set.$set_native.class ? T : NIL;
    }

    public static SubLObject set_struct_contents(final SubLObject v_object) {
        assert NIL != set_p(v_object) : "set.set_p(v_object) " + "CommonSymbols.NIL != set.set_p(v_object) " + v_object;
    ...
    public static SubLObject make_set(SubLObject arglist) {
        ...
        final SubLObject v_new = new set.$set_native();
        SubLObject next;
    ...
    public static final class $set_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(set.$set_native.class, SET, SET_P, $list3, $list4, new String[]{ "$contents", "$test" }, $list5, $list6, PRINT_SET);
        }
    }
