																															...
																															html_utilities.html_char(CHAR_greater, UNPROVIDED);
																															{
																																...
																																try {
																																	html_macros.$html_safe_print$.bind(T, thread);
																																	{
																																		...
																																		} else if (pcase_var.eql($NOT_HIGH_LIGHTED)) {
	...
	public static final SubLObject cb_uiat_sentence_clarifier_render_request(SubLObject request) {
		{
			...
			plist = current;
			{
				...
				} else if (pcase_var.eql($SHOW_RULE)) {
					{
				...
				} else if (pcase_var.eql($SHOW_QUESTION)) {
					{
				...
				try {
					...
					html_utilities.html_char(CHAR_greater, UNPROVIDED);
					{
						...
						try {
							...
							} else if (NIL == el_utilities.cyc_const_logical_operator_p(cycl_utilities.formula_operator(cycl_sentence))) {
								html_utilities.html_markup(html_macros.$html_table_data_head$.getGlobalValue());
								html_utilities.html_char(CHAR_greater, UNPROVIDED);
								{
												...
												html_utilities.html_char(CHAR_greater, UNPROVIDED);
												{
													...
													try {
														...
														html_utilities.html_char(CHAR_greater, UNPROVIDED);
														{
															...
															try {
																html_macros.$html_safe_print$.bind(T, thread);
																html_utilities.html_radio_input($$$filter, $$$none, sublisp_null(filter_term), UNPROVIDED_SYM);
															} finally {
													...
													html_utilities.html_char(CHAR_greater, UNPROVIDED);
													{
														...
														try {
															...
															html_utilities.html_char(CHAR_greater, UNPROVIDED);
															{
																...
																try {
																	html_macros.$html_safe_print$.bind(T, thread);
																	html_utilities.html_radio_input($$$filter, $$$term, T, UNPROVIDED_SYM);
																} finally {
												...
												html_utilities.html_char(CHAR_greater, UNPROVIDED);
												{
													...
													try {
														...
														html_utilities.html_char(CHAR_greater, UNPROVIDED);
														{
															...
															try {
																html_macros.$html_safe_print$.bind(T, thread);
																html_utilities.html_radio_input($$$filter, $$$specify, NIL, UNPROVIDED_SYM);
															} finally {
	...
	public static final SubLObject cb_uiat_handle_domain_examples_show(SubLObject args) {
		{
			...
			} else if ($$$specify.equal(filter_string)) {
			...
			{
				SubLObject reply = user_interaction_agenda.make_ui_reply_with_interaction(interaction, $ANSWER,
						nconc(new SubLObject[] { NIL != sample_sentence ? ((SubLObject) (list($SAMPLE_SENTENCE, sample_sentence))) : NIL, NIL != filter_term ? ((SubLObject) (list($FILTER_TERM, filter_term))) : NIL, NIL != filter_phrase ? ((SubLObject) (list($FILTER_PHRASE, filter_phrase))) : NIL, list($SORT_METHOD, sort_method) }));
				return cb_user_interaction_agenda.cb_uia_handle_reply(v_agenda, reply);
			}
		}
	}
