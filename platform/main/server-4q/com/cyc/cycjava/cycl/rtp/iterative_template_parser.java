...
import static com.cyc.cycjava.cycl.rtp.iterative_template_parser.*;
...
public final class iterative_template_parser extends SubLTranslatedFile {
    ...
    public static SubLObject itp_node_p(final SubLObject v_object) {
        return v_object.getClass() == iterative_template_parser.$itp_node_native.class ? T : NIL;
    }

    public static SubLObject itp_node_id(final SubLObject v_object) {
        assert NIL != itp_node_p(v_object) : "iterative_template_parser.itp_node_p(v_object) " + "CommonSymbols.NIL != iterative_template_parser.itp_node_p(v_object) " + v_object;
    ...
    public static SubLObject make_itp_node(SubLObject arglist) {
        ...
        final SubLObject v_new = new iterative_template_parser.$itp_node_native();
        SubLObject next;
    ...
    public static SubLObject itp_state_p(final SubLObject v_object) {
        return v_object.getClass() == iterative_template_parser.$itp_state_native.class ? T : NIL;
    }

    public static SubLObject itp_state_sequence(final SubLObject v_object) {
        assert NIL != itp_state_p(v_object) : "iterative_template_parser.itp_state_p(v_object) " + "CommonSymbols.NIL != iterative_template_parser.itp_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_itp_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new iterative_template_parser.$itp_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $itp_node_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(iterative_template_parser.$itp_node_native.class, ITP_NODE, ITP_NODE_P, $list125, $list126, new String[]{ "$id", "$parent", "$component", "$span", "$new_parse", "$assertion", "$children", "$permutations", "$syntactic_node", "$syntactic_choices" }, $list127, $list128, PRINT_ITP_NODE);
        }
    }
    ...
    public static final class $itp_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(iterative_template_parser.$itp_state_native.class, ITP_STATE, ITP_STATE_P, $list192, $list193, new String[]{ "$sequence", "$complete_parses_only", "$work_set", "$solution_set", "$sentence", "$category", "$cache", "$psp_charts", "$working_mt" }, $list194, $list195, PRINT_ITP_STATE);
        }
    }
