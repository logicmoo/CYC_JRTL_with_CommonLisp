...
import static com.cyc.cycjava.cycl.rtp.rtp_datastructures.*;
...
public final class rtp_datastructures extends SubLTranslatedFile {
    ...
    public static SubLObject template_rule_p(final SubLObject v_object) {
        return v_object.getClass() == rtp_datastructures.$template_rule_native.class ? T : NIL;
    }

    public static SubLObject template_rule_category(final SubLObject v_object) {
        assert NIL != template_rule_p(v_object) : "rtp_datastructures.template_rule_p(v_object) " + "CommonSymbols.NIL != rtp_datastructures.template_rule_p(v_object) " + v_object;
    ...
    public static SubLObject make_template_rule(SubLObject arglist) {
        ...
        final SubLObject v_new = new rtp_datastructures.$template_rule_native();
        SubLObject next;
    ...
    public static SubLObject template_span_item_p(final SubLObject v_object) {
        return v_object.getClass() == rtp_datastructures.$template_span_item_native.class ? T : NIL;
    }

    public static SubLObject template_span_item_template_item(final SubLObject v_object) {
        assert NIL != template_span_item_p(v_object) : "rtp_datastructures.template_span_item_p(v_object) " + "CommonSymbols.NIL != rtp_datastructures.template_span_item_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_template_span_item(SubLObject arglist) {
        ...
        final SubLObject v_new = new rtp_datastructures.$template_span_item_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject categorized_template_rule_set_p(final SubLObject v_object) {
        return v_object.getClass() == rtp_datastructures.$categorized_template_rule_set_native.class ? T : NIL;
    }

    public static SubLObject categorized_template_rule_set_mentions(final SubLObject v_object) {
        assert NIL != categorized_template_rule_set_p(v_object) : "rtp_datastructures.categorized_template_rule_set_p(v_object) " + "CommonSymbols.NIL != rtp_datastructures.categorized_template_rule_set_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_categorized_template_rule_set(SubLObject arglist) {
        ...
        final SubLObject v_new = new rtp_datastructures.$categorized_template_rule_set_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject rtp_chart_entry_p(final SubLObject v_object) {
        return v_object.getClass() == rtp_datastructures.$rtp_chart_entry_native.class ? T : NIL;
    }

    public static SubLObject rtp_chart_entry_start(final SubLObject v_object) {
        assert NIL != rtp_chart_entry_p(v_object) : "rtp_datastructures.rtp_chart_entry_p(v_object) " + "CommonSymbols.NIL != rtp_datastructures.rtp_chart_entry_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_rtp_chart_entry(SubLObject arglist) {
        ...
        final SubLObject v_new = new rtp_datastructures.$rtp_chart_entry_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject subconstit_p(final SubLObject v_object) {
        return v_object.getClass() == rtp_datastructures.$subconstit_native.class ? T : NIL;
    }

    public static SubLObject subconstit_cat(final SubLObject v_object) {
        assert NIL != subconstit_p(v_object) : "rtp_datastructures.subconstit_p(v_object) " + "CommonSymbols.NIL != rtp_datastructures.subconstit_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_subconstit(SubLObject arglist) {
        ...
        final SubLObject v_new = new rtp_datastructures.$subconstit_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $template_rule_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rtp_datastructures.$template_rule_native.class, TEMPLATE_RULE, TEMPLATE_RULE_P, $list14, $list15, new String[]{ "$category", "$template", "$transformation", "$sem_test", "$assertion", "$terminals", "$meaning", "$constraints", "$id" }, $list16, $list17, PRINT_TEMPLATE_RULE);
        }
    }
    ...
    public static final class $template_span_item_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rtp_datastructures.$template_span_item_native.class, TEMPLATE_SPAN_ITEM, TEMPLATE_SPAN_ITEM_P, $list68, $list69, new String[]{ "$template_item", "$start", "$end" }, $list70, $list71, PRINT_TEMPLATE_SPAN_ITEM);
        }
    }
    ...
    public static final class $categorized_template_rule_set_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rtp_datastructures.$categorized_template_rule_set_native.class, CATEGORIZED_TEMPLATE_RULE_SET, CATEGORIZED_TEMPLATE_RULE_SET_P, $list124, $list125, new String[]{ "$mentions", "$generic", "$key_terminal" }, $list126, $list127, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $rtp_chart_entry_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rtp_datastructures.$rtp_chart_entry_native.class, RTP_CHART_ENTRY, RTP_CHART_ENTRY_P, $list192, $list193, new String[]{ "$start", "$end", "$rule", "$template_index", "$words", "$bindings", "$subconstits", "$sem" }, $list194, $list195, RTP_ENTRY_PRINT);
        }
    }
    ...
    public static final class $subconstit_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rtp_datastructures.$subconstit_native.class, SUBCONSTIT, SUBCONSTIT_P, $list227, $list228, new String[]{ "$cat", "$string", "$binding_var", "$start", "$end", "$sem_test" }, $list229, $list230, PRINT_SUBCONSTIT);
        }
    }
