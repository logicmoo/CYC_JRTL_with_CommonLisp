...
public final class rtp_constituent_weeders extends SubLTranslatedFile {
    ...
    public static SubLObject itp_semantics_cycl(final SubLObject v_object) {
        assert NIL != itp_semantics_p(v_object) : "rtp_constituent_weeders.itp_semantics_p error :" + v_object;
    ...
    public static final class $itp_semantics_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($itp_semantics_native.class, ITP_SEMANTICS, ITP_SEMANTICS_P, $list18, $list19, new String[]{ "$cycl", "$category", "$force", "$supports", "$confidence" }, $list20, $list21, PRINT_ITP_SEMANTICS);
        }
    }
