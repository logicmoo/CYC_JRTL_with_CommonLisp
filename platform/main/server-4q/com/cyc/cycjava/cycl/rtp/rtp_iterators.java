...
import static com.cyc.cycjava.cycl.rtp.rtp_iterators.*;
...
public final class rtp_iterators extends SubLTranslatedFile {
    ...
    public static SubLObject itp_result_iterator_p(final SubLObject v_object) {
        return v_object.getClass() == rtp_iterators.$itp_result_iterator_native.class ? T : NIL;
    }

    public static SubLObject itp_result_iterator_style(final SubLObject v_object) {
        assert NIL != itp_result_iterator_p(v_object) : "rtp_iterators.itp_result_iterator_p(v_object) " + "CommonSymbols.NIL != rtp_iterators.itp_result_iterator_p(v_object) " + v_object;
    ...
    public static SubLObject make_itp_result_iterator(SubLObject arglist) {
        ...
        final SubLObject v_new = new rtp_iterators.$itp_result_iterator_native();
        SubLObject next;
    ...
    public static SubLObject itp_section_iterator_p(final SubLObject v_object) {
        return v_object.getClass() == rtp_iterators.$itp_section_iterator_native.class ? T : NIL;
    }

    public static SubLObject itp_section_iterator_parent(final SubLObject v_object) {
        assert NIL != itp_section_iterator_p(v_object) : "rtp_iterators.itp_section_iterator_p(v_object) " + "CommonSymbols.NIL != rtp_iterators.itp_section_iterator_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_itp_section_iterator(SubLObject arglist) {
        ...
        final SubLObject v_new = new rtp_iterators.$itp_section_iterator_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject itp_child_iterator_p(final SubLObject v_object) {
        return v_object.getClass() == rtp_iterators.$itp_child_iterator_native.class ? T : NIL;
    }

    public static SubLObject itp_child_iterator_parent(final SubLObject v_object) {
        assert NIL != itp_child_iterator_p(v_object) : "rtp_iterators.itp_child_iterator_p(v_object) " + "CommonSymbols.NIL != rtp_iterators.itp_child_iterator_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_itp_child_iterator(SubLObject arglist) {
        ...
        final SubLObject v_new = new rtp_iterators.$itp_child_iterator_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject rtp_iterator_p(final SubLObject v_object) {
        return v_object.getClass() == rtp_iterators.$rtp_iterator_native.class ? T : NIL;
    }

    public static SubLObject rtp_iterator_string(final SubLObject v_object) {
        assert NIL != rtp_iterator_p(v_object) : "rtp_iterators.rtp_iterator_p(v_object) " + "CommonSymbols.NIL != rtp_iterators.rtp_iterator_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_rtp_iterator(SubLObject arglist) {
        ...
        final SubLObject v_new = new rtp_iterators.$rtp_iterator_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $itp_result_iterator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rtp_iterators.$itp_result_iterator_native.class, ITP_RESULT_ITERATOR, ITP_RESULT_ITERATOR_P, $list2, $list3, new String[]{ "$style", "$parses", "$span", "$section_iterator" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $itp_section_iterator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rtp_iterators.$itp_section_iterator_native.class, ITP_SECTION_ITERATOR, ITP_SECTION_ITERATOR_P, $list29, $list30, new String[]{ "$parent", "$span", "$section", "$current" }, $list31, $list32, ITP_PRINT_SECTION_ITERATOR);
        }
    }
    ...
    public static final class $itp_child_iterator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rtp_iterators.$itp_child_iterator_native.class, ITP_CHILD_ITERATOR, ITP_CHILD_ITERATOR_P, $list52, $list53, new String[]{ "$parent", "$rop_formula", "$section" }, $list54, $list55, ITP_PRINT_CHILD_ITERATOR);
        }
    }
    ...
    public static final class $rtp_iterator_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rtp_iterators.$rtp_iterator_native.class, RTP_ITERATOR, RTP_ITERATOR_P, $list77, $list78, new String[]{ "$string", "$parsing_mt", "$semantic_mt", "$strengthenP", "$multiple_quantificationsP", "$wff_checkP", "$force", "$raw_parses", "$result_queue", "$initialized", "$template_category", "$memoization_state", "$sbhl_resource" }, $list79, $list80, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
