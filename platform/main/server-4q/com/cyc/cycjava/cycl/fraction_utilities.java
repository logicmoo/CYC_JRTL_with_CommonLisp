...
public final class fraction_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject fraction_p(final SubLObject v_object) {
        return v_object.getClass() == fraction_utilities.$fraction_native.class ? T : NIL;
    }

    public static SubLObject fract_numerator(final SubLObject v_object) {
        assert NIL != fraction_p(v_object) : "fraction_utilities.fraction_p(v_object) " + "CommonSymbols.NIL != fraction_utilities.fraction_p(v_object) " + v_object;
    ...
    public static SubLObject make_fraction(SubLObject arglist) {
        ...
        final SubLObject v_new = new fraction_utilities.$fraction_native();
        SubLObject next;
    ...
    public static SubLObject fractionify(final SubLObject v_object) {
        assert NIL != number_or_fraction_p(v_object) : "fraction_utilities.number_or_fraction_p(v_object) " + "CommonSymbols.NIL != fraction_utilities.number_or_fraction_p(v_object) " + v_object;
    ...
    public static final class $fraction_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(fraction_utilities.$fraction_native.class, FRACTION, FRACTION_P, $list2, $list3, new String[]{ "$numerator", "$denominator" }, $list4, $list5, PRINT_FRACTION);
        }
    }
