...
public final class recanonicalizer extends SubLTranslatedFile implements V02 {
    ...
    public static final SubLObject recan_rf_p(SubLObject v_object) {
        return v_object.getClass() == recanonicalizer.$recan_rf_native.class ? ((SubLObject) (T)) : NIL;
    }
                                                    ...
                                                    if (pcase_var.eql($ABNORMAL)) {
                                                        ...
                                                        if (pcase_var.eql($POLY)) {
                                                            ...
                                                            if (pcase_var.eql($INVALID)) {
                                                                ...
                                                                if (pcase_var.eql($RECAN_INVALID)) {
                                                                    ...
                                                                    if (pcase_var.eql($ILL_FORMED)) {
                                                                        ...
                                                                        if (pcase_var.eql($ILL_FORMED_SYNTAX)) {
            ...
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                ...
                if (NIL == el_utilities.el_formula_p(new_formula)) {
                    ...
                    if (old_formula.equal(new_formula)) {
                        ...
                        if (NIL != czer_main.terms_reorder_equalP(old_formula, new_formula)) {
    ...
    public static final SubLObject recan_analyze_assertion_int(SubLObject old_cnf, SubLObject new_cnf, SubLObject old_var_names, SubLObject new_var_names, SubLObject abnormalP) {
        if (old_var_names.equal(new_var_names) && old_cnf.equal(new_cnf)) {
            ...
            if (NIL != abnormalP) {
                ...
                if (NIL != czer_utilities.ordered_cnf_unifyP(old_cnf, new_cnf)) {
                    return $VAR_RENAME;
                } else
                    if (NIL != czer_utilities.cnfs_reorder_equalP(old_cnf, new_cnf, UNPROVIDED)) {
                        return $REORDER;
                    } else {
                        return NIL;
                    }
    ...
    public static final SubLObject really_recanonicalize_recan_rf(SubLObject recan_rf) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                ...
                if (NIL != recan_error_analysis_p(analysis)) {
                    ...
                    if (NIL != recan_special_analysis_p(analysis)) {
                        return handle_rf_recan_special(rf, analysis);
                    } else
                        if (NIL != unrecanonicalizable_analysis_p(analysis)) {
                                        ...
                                        for (assertion_spec = cdolist_list_var_11.first(); NIL != cdolist_list_var_11; cdolist_list_var_11 = cdolist_list_var_11.rest() , assertion_spec = cdolist_list_var_11.first()) {
                                            {
                                                ...
                                                if (NIL == current) {
                                                    ...
                                                    {
                                                        SubLObject cdolist_list_var_12 = fi.$fi_last_assertions_asserted$.getDynamicValue(thread);
                                ...
                                if (NIL != why_not_wff) {
                                    ...
                                    if (NIL != czer_utilities.ordered_cnf_unifyP(old_cnf, new_cnf)) {
                                        ...
                                        if (NIL != czer_utilities.cnfs_reorder_equalP(old_cnf, new_cnf, UNPROVIDED)) {
                                            ...
                                            if (NIL != czer_utilities.cnfs_reorder_equalP(old_cnf, clauses.make_cnf(set_difference(clauses.neg_lits(new_cnf), el_utilities.tou_lits(clauses.neg_lits(new_cnf)), symbol_function(EQUAL), UNPROVIDED), clauses.pos_lits(new_cnf)), UNPROVIDED)) {
                                                if (NIL != printP) {
