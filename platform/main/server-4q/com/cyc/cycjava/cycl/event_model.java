...
import static com.cyc.cycjava.cycl.event_model.*;
...
public final class event_model extends SubLTranslatedFile {
    ...
    public static SubLObject event_class_p(final SubLObject v_object) {
        return v_object.getClass() == event_model.$event_class_native.class ? T : NIL;
    }

    public static SubLObject event_class_parent(final SubLObject v_object) {
        assert NIL != event_class_p(v_object) : "event_model.event_class_p(v_object) " + "CommonSymbols.NIL != event_model.event_class_p(v_object) " + v_object;
    ...
    public static SubLObject make_event_class(SubLObject arglist) {
        ...
        final SubLObject v_new = new event_model.$event_class_native();
        SubLObject next;
    ...
    public static SubLObject event_hierarchy_p(final SubLObject v_object) {
        return v_object.getClass() == event_model.$event_hierarchy_native.class ? T : NIL;
    }

    public static SubLObject event_hierarchy_lock(final SubLObject v_object) {
        assert NIL != event_hierarchy_p(v_object) : "event_model.event_hierarchy_p(v_object) " + "CommonSymbols.NIL != event_model.event_hierarchy_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_event_hierarchy(SubLObject arglist) {
        ...
        final SubLObject v_new = new event_model.$event_hierarchy_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject event_p(final SubLObject v_object) {
        return v_object.getClass() == event_model.$event_native.class ? T : NIL;
    }

    public static SubLObject event_class(final SubLObject v_object) {
        assert NIL != event_p(v_object) : "event_model.event_p(v_object) " + "CommonSymbols.NIL != event_model.event_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_event(SubLObject arglist) {
        ...
        final SubLObject v_new = new event_model.$event_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $event_class_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(event_model.$event_class_native.class, EVENT_CLASS, EVENT_CLASS_P, $list2, $list3, new String[]{ "$parent", "$self", "$pattern", "$properties" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $event_hierarchy_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(event_model.$event_hierarchy_native.class, EVENT_HIERARCHY, EVENT_HIERARCHY_P, $list35, $list36, new String[]{ "$lock", "$graph", "$properties" }, $list37, $list38, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $event_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(event_model.$event_native.class, EVENT, EVENT_P, $list118, $list119, new String[]{ "$class", "$timestamp", "$source", "$message" }, $list120, $list121, PRINT_EVENT);
        }
    }
