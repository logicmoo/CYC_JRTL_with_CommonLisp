...
import com.cyc.cycjava.cycl.eval_in_api_registrations;
...
import static com.cyc.cycjava.cycl.eval_in_api_registrations.*;
...
public final class eval_in_api_registrations extends SubLTranslatedFile {
    ...
    public static final SubLSymbol BQ_NCONC = makeSymbol("BQ-NCONC");

    public static final SubLSymbol BQ_VECTOR_APPEND = makeSymbol("BQ-VECTOR-APPEND");



    public static final SubLSymbol API_BQ_LIST = makeSymbol("API-BQ-LIST");



    public static final SubLSymbol WITH_PRECISE_PARAPHRASE_ON = makeSymbol("WITH-PRECISE-PARAPHRASE-ON");

    public static final SubLSymbol WITH_PARAPHRASE_PRECISION = makeSymbol("WITH-PARAPHRASE-PRECISION");

    public static final SubLSymbol WITH_BOOKKEEPING_INFO = makeSymbol("WITH-BOOKKEEPING-INFO");

    public static final SubLSymbol WITH_MT_FUNCTION = makeSymbol("WITH-MT-FUNCTION");

    public static final SubLSymbol WITH_GENL_MTS = makeSymbol("WITH-GENL-MTS");





    public static final SubLSymbol DO_PREDICATE_RULE_INDEX = makeSymbol("DO-PREDICATE-RULE-INDEX");

    public static final SubLSymbol DO_RULE_INDEX = makeSymbol("DO-RULE-INDEX");

    public static final SubLSymbol WITHOUT_WFF_SEMANTICS = makeSymbol("WITHOUT-WFF-SEMANTICS");

    public static final SubLSymbol CDOLIST_DONE = makeSymbol("CDOLIST-DONE");



    public static final SubLSymbol PROGRESS_CDOTIMES = makeSymbol("PROGRESS-CDOTIMES");





    public static final SubLSymbol OLD_DO_ID_INDEX = makeSymbol("OLD-DO-ID-INDEX");
    ...
    public static SubLObject declare_eval_in_api_registrations_file() {
        declareMacro(me, "api_bq_list", "API-BQ-LIST");
        return NIL;
    }
