...
import com.cyc.cycjava.cycl.secure_translation;
...
import static com.cyc.cycjava.cycl.secure_translation.*;
...
public final class secure_translation extends SubLTranslatedFile {
    ...
    public static SubLObject secure_id_database_p(final SubLObject v_object) {
        return v_object.getClass() == secure_translation.$secure_id_database_native.class ? T : NIL;
    }

    public static SubLObject sid_db_security_level(final SubLObject v_object) {
        assert NIL != secure_id_database_p(v_object) : "secure_translation.secure_id_database_p(v_object) " + "CommonSymbols.NIL != secure_translation.secure_id_database_p(v_object) " + v_object;
    ...
    public static SubLObject make_secure_id_database(SubLObject arglist) {
        ...
        final SubLObject v_new = new secure_translation.$secure_id_database_native();
        SubLObject next;
