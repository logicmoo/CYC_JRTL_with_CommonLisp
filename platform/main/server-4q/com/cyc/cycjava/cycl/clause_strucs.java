...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class clause_strucs extends SubLTranslatedFile {
    ...
    public static SubLObject clause_struc_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$clause_struc_native.class ? T : NIL;
    }

    public static SubLObject cls_id(final SubLObject v_object) {
        assert NIL != clause_struc_p(v_object) : "clause_strucs.clause_struc_p error :" + v_object;
    ...
    public static final class $clause_struc_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($clause_struc_native.class, CLAUSE_STRUC, CLAUSE_STRUC_P, $list3, $list4, new String[]{ "$id", "$cnf", "$assertions" }, $list5, $list6, PRINT_CLAUSE_STRUC);
        }
    }
