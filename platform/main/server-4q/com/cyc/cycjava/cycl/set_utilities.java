...
public final class set_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject sldwnd_window(final SubLObject v_object) {
        assert NIL != sliding_window_p(v_object) : "set_utilities.sliding_window_p(v_object) " + "CommonSymbols.NIL != set_utilities.sliding_window_p(v_object) " + v_object;
    ...
    public static final class $sliding_window_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(set_utilities.$sliding_window_native.class, SLIDING_WINDOW, SLIDING_WINDOW_P, $list23, $list24, new String[]{ "$window", "$set_a", "$set_b", "$window_a", "$window_b" }, $list25, $list26, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
