...
import static com.cyc.cycjava.cycl.cfasl.cfasl_raw_read_byte;
...
import static com.cyc.cycjava.cycl.html_utilities.html_reserved_character_code_p;
...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class unicode_strings extends SubLTranslatedFile {
    ...
    public static SubLObject unicode_char_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$unicode_char_native.class ? T : NIL;
    }

    public static SubLObject unicode_char_uchar(final SubLObject v_object) {
        assert NIL != unicode_char_p(v_object) : "unicode_strings.unicode_char_p error :" + v_object;
    ...
    public static SubLObject unicode_string_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$unicode_string_native.class ? T : NIL;
    }

    public static SubLObject unicode_string_vect(final SubLObject v_object) {
        assert NIL != unicode_string_p(v_object) : "unicode_strings.unicode_string_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $unicode_char_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($unicode_char_native.class, UNICODE_CHAR, UNICODE_CHAR_P, $list3, $list4, new String[]{ "$uchar" }, $list5, $list6, PRINT_UNICODE_CHAR);
        }
    }
    ...
    public static final class $unicode_string_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($unicode_string_native.class, UNICODE_STRING, UNICODE_STRING_P, $list24, $list25, new String[]{ "$vect" }, $list26, $list27, PRINT_UNICODE_STRING);
        }
    }
