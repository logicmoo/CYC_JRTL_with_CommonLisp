...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class pos_tagger extends SubLTranslatedFile {
    ...
    public static SubLObject tagger_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$tagger_native.class ? T : NIL;
    }

    public static SubLObject tagger_hmm(final SubLObject v_object) {
        assert NIL != tagger_p(v_object) : "pos_tagger.tagger_p error :" + v_object;
    ...
    public static SubLObject hmm_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$hmm_native.class ? T : NIL;
    }

    public static SubLObject hmm_initial_state(final SubLObject v_object) {
        assert NIL != hmm_p(v_object) : "pos_tagger.hmm_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject state_set_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$state_set_native.class ? T : NIL;
    }

    public static SubLObject state_set_store(final SubLObject v_object) {
        assert NIL != state_set_p(v_object) : "pos_tagger.state_set_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject transition_set_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$transition_set_native.class ? T : NIL;
    }

    public static SubLObject transition_set_known_probabilities(final SubLObject v_object) {
        assert NIL != transition_set_p(v_object) : "pos_tagger.transition_set_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject emission_probability_estimator_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$emission_probability_estimator_native.class ? T : NIL;
    }

    public static SubLObject epe_open_states(final SubLObject v_object) {
        assert NIL != emission_probability_estimator_p(v_object) : "pos_tagger.emission_probability_estimator_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $tagger_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($tagger_native.class, TAGGER, TAGGER_P, $list48, $list49, new String[]{ "$hmm", "$state_interpretation" }, $list50, $list51, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $hmm_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($hmm_native.class, HMM, HMM_P, $list80, $list81, new String[]{ "$initial_state", "$states", "$transitions" }, $list82, $list83, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $state_set_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($state_set_native.class, STATE_SET, STATE_SET_P, $list100, $list101, new String[]{ "$store", "$estimator", "$cache" }, $list102, $list103, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $transition_set_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($transition_set_native.class, TRANSITION_SET, TRANSITION_SET_P, $list121, $list122, new String[]{ "$known_probabilities", "$estimated_probabilities" }, $list123, $list124, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $emission_probability_estimator_native extends SubLStructNative {
        ...
        private $emission_probability_estimator_native() {
        ...
        static {
            structDecl = makeStructDeclNative($emission_probability_estimator_native.class, EMISSION_PROBABILITY_ESTIMATOR, EMISSION_PROBABILITY_ESTIMATOR_P, $list139, $list140, new String[]{ "$open_states", "$suffixes", "$unknown_word", "$suffix", "$hyphen", "$number", "$capitalization" }, $list141, $list142, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
