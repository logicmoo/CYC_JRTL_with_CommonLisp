...
import com.cyc.cycjava.cycl.learning_reader.$l2r_document_reader_native;
import com.cyc.cycjava.cycl.learning_reader.$l2r_paragraph_reader_native;
...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class learning_reader extends SubLTranslatedFile {
    ...
    public static SubLObject l2r_paragraph_reader_paragraph(final SubLObject v_object) {
        assert NIL != l2r_paragraph_reader_p(v_object) : "learning_reader.l2r_paragraph_reader_p error :" + v_object;
    ...
    public static SubLObject l2r_document_reader_document(final SubLObject v_object) {
        assert NIL != l2r_document_reader_p(v_object) : "learning_reader.l2r_document_reader_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $l2r_paragraph_reader_native extends SubLStructNative {
        ...
        private $l2r_paragraph_reader_native() {
        ...
        static {
            structDecl = makeStructDeclNative($l2r_paragraph_reader_native.class, L2R_PARAGRAPH_READER, L2R_PARAGRAPH_READER_P, $list34, $list35, new String[]{ "$paragraph", "$document", "$paragraph_source_html", "$sentence_vector", "$sentence_pegs", "$sentence_non_html_texts", "$sentence_number", "$linkage", "$linkage_fort", "$initial_assertion_count", "$total_time", "$total_cpu_time", "$sentence_time", "$sentence_cpu_time", "$state" }, $list36, $list37, PRINT_L2R_PARAGRAPH_READER);
        }
    }
    ...
    public static final class $l2r_document_reader_native extends SubLStructNative {
        ...
        private $l2r_document_reader_native() {
            this.$document = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative($l2r_document_reader_native.class, L2R_DOCUMENT_READER, L2R_DOCUMENT_READER_P, $list218, $list219, new String[]{ "$document", "$remaining_paragraphs", "$read_paragraphs", "$paragraph_reader", "$reading_event" }, $list220, $list221, PRINT_L2R_DOCUMENT_READER);
        }
    }
