...
import static com.cyc.cycjava.cycl.html_utilities.html_basic_image;
...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class cb_adornments extends SubLTranslatedFile {
    ...
    public static SubLObject adornment_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$adornment_native.class ? T : NIL;
    }

    public static SubLObject adornment_name(final SubLObject v_object) {
        assert NIL != adornment_p(v_object) : "cb_adornments.adornment_p error :" + v_object;
    ...
    public static final class $adornment_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($adornment_native.class, ADORNMENT, ADORNMENT_P, $list5, $list6, new String[]{ "$name", "$type", "$active_p", "$image", "$image_disabled", "$image_alt", "$dynamic_tagfn", "$color", "$letter", "$effective_fn", "$handler", "$tool", "$comment", "$dynamic_comment", "$title" }, $list7, $list8, PRINT_ADORNMENT);
        }
    }
