...
import com.cyc.cycjava.cycl.cb_adornments;
...
import static com.cyc.cycjava.cycl.cb_adornments.*;
...
public final class cb_adornments extends SubLTranslatedFile {
    ...
    public static final SubLList $list1 = list(new SubLObject[]{ makeSymbol("ALPHABETICAL-SEARCH"), makeSymbol("VFACETS"), makeSymbol("WORDNET-SYNSET"), makeSymbol("HIERARCHY-DEFAULT"), makeSymbol("HIERARCHY-LINK"), makeSymbol("LITERAL-QUERY-INDEX-DISPLAY"), makeSymbol("LITERAL-QUERY-NORMAL"), makeSymbol("LITERAL-QUERY-INDEX"), makeSymbol("CONSTANT-REVIEW"), makeSymbol("ASSERTION-REVIEW"), makeSymbol("META-AXIOMS"), makeSymbol("DEDUCED-ASSERTION"), makeSymbol("ASSERTED-ASSERTION") });
    ...
    private static final SubLList $list5 = list(new SubLObject[]{ makeSymbol("NAME"), makeSymbol("TYPE"), makeSymbol("ACTIVE-P"), makeSymbol("IMAGE"), makeSymbol("IMAGE-DISABLED"), makeSymbol("IMAGE-ALT"), makeSymbol("DYNAMIC-TAGFN"), makeSymbol("COLOR"), makeSymbol("LETTER"), makeSymbol("EFFECTIVE-FN"), makeSymbol("HANDLER"), makeSymbol("TOOL"), makeSymbol("COMMENT"), makeSymbol("DYNAMIC-COMMENT"), makeSymbol("TITLE") });

    private static final SubLList $list6 = list(new SubLObject[]{ makeKeyword("NAME"), makeKeyword("TYPE"), makeKeyword("ACTIVE-P"), makeKeyword("IMAGE"), makeKeyword("IMAGE-DISABLED"), makeKeyword("IMAGE-ALT"), makeKeyword("DYNAMIC-TAGFN"), makeKeyword("COLOR"), makeKeyword("LETTER"), makeKeyword("EFFECTIVE-FN"), makeKeyword("HANDLER"), makeKeyword("TOOL"), makeKeyword("COMMENT"), makeKeyword("DYNAMIC-COMMENT"), makeKeyword("TITLE") });

    private static final SubLList $list7 = list(new SubLObject[]{ makeSymbol("ADORNMENT-NAME"), makeSymbol("ADORNMENT-TYPE"), makeSymbol("ADORNMENT-ACTIVE-P"), makeSymbol("ADORNMENT-IMAGE"), makeSymbol("ADORNMENT-IMAGE-DISABLED"), makeSymbol("ADORNMENT-IMAGE-ALT"), makeSymbol("ADORNMENT-DYNAMIC-TAGFN"), makeSymbol("ADORNMENT-COLOR"), makeSymbol("ADORNMENT-LETTER"), makeSymbol("ADORNMENT-EFFECTIVE-FN"), makeSymbol("ADORNMENT-HANDLER"), makeSymbol("ADORNMENT-TOOL"), makeSymbol("ADORNMENT-COMMENT"), makeSymbol("ADORNMENT-DYNAMIC-COMMENT"), makeSymbol("ADORNMENT-TITLE") });

    public static final SubLList $list8 = list(new SubLObject[]{ makeSymbol("_CSETF-ADORNMENT-NAME"), makeSymbol("_CSETF-ADORNMENT-TYPE"), makeSymbol("_CSETF-ADORNMENT-ACTIVE-P"), makeSymbol("_CSETF-ADORNMENT-IMAGE"), makeSymbol("_CSETF-ADORNMENT-IMAGE-DISABLED"), makeSymbol("_CSETF-ADORNMENT-IMAGE-ALT"), makeSymbol("_CSETF-ADORNMENT-DYNAMIC-TAGFN"), makeSymbol("_CSETF-ADORNMENT-COLOR"), makeSymbol("_CSETF-ADORNMENT-LETTER"), makeSymbol("_CSETF-ADORNMENT-EFFECTIVE-FN"), makeSymbol("_CSETF-ADORNMENT-HANDLER"), makeSymbol("_CSETF-ADORNMENT-TOOL"), makeSymbol("_CSETF-ADORNMENT-COMMENT"), makeSymbol("_CSETF-ADORNMENT-DYNAMIC-COMMENT"), makeSymbol("_CSETF-ADORNMENT-TITLE") });
    ...
    public static final SubLList $list11 = list(makeSymbol("OPTIMIZE-FUNCALL"), makeSymbol("ADORNMENT-P"));
    ...
    private static final SubLList $list94 = list(new SubLObject[]{ makeKeyword("TYPE"), makeKeyword("INDEX-TERM"), makeKeyword("ACTIVE-P"), T, makeKeyword("IMAGE"), makeKeyword("INDEX-BROWSER"), makeKeyword("IMAGE-DISABLED"), makeKeyword("INDEX-BROWSER-DISABLED"), makeKeyword("IMAGE-ALT"), makeString("[Indices]"), makeKeyword("EFFECTIVE-FN"), makeSymbol("CYC-TERM"), makeKeyword("HANDLER"), makeString("cb-cf"), makeKeyword("TITLE"), makeString("Index Browser"), makeKeyword("COMMENT"), makeString("Links you to the index view for a term.") });

    private static final SubLSymbol INDEX_BROWSER = makeSymbol("INDEX-BROWSER");

    private static final SubLList $list96 = list(new SubLObject[]{ makeKeyword("TYPE"), makeKeyword("ASSERTION"), makeKeyword("ACTIVE-P"), T, makeKeyword("COLOR"), makeKeyword("YELLOW"), makeKeyword("LETTER"), makeString("M"), makeKeyword("EFFECTIVE-FN"), makeSymbol("ASSERTION-HAS-META-ASSERTIONS?"), makeKeyword("COMMENT"), makeString("Indicates that some meta-assertion has been made, that is, an assertion where one of the arguments is this assertion.") });
    ...
    private static final SubLList $list100 = list(new SubLObject[]{ makeKeyword("TYPE"), makeKeyword("ASSERTION"), makeKeyword("ACTIVE-P"), NIL, makeKeyword("IMAGE"), makeKeyword("CY-MENU"), makeKeyword("IMAGE-ALT"), makeString("[KE Assertion Review]"), makeKeyword("EFFECTIVE-FN"), makeSymbol("ASSERTION-NEEDS-REVIEW-P"), makeKeyword("HANDLER"), makeString("cb-taf"), makeKeyword("TOOL"), makeKeyword("KE-REVIEW"), makeKeyword("COMMENT"), makeString("Links to a special page for reviewing this assertion (support of #$MyReviewer).") });
    ...
    private static final SubLList $list109 = list(new SubLObject[]{ makeKeyword("TYPE"), makeKeyword("GAF-ARG-PREDICATE"), makeKeyword("ACTIVE-P"), T, makeKeyword("IMAGE"), makeKeyword("RED-DIAMOND"), makeKeyword("IMAGE-ALT"), makeString("[Hier]"), makeKeyword("EFFECTIVE-FN"), makeSymbol("HIERARCHY-LINK-EFFECTIVE-FN"), makeKeyword("HANDLER"), makeString("cb-hier"), makeKeyword("TOOL"), makeKeyword("HIERARCHY-BROWSER"), makeKeyword("TITLE"), makeString("Hierarchy Browser"), makeKeyword("COMMENT"), makeString("Lets you browse the isa hierarchy.") });
    ...
    private static final SubLList $list115 = list(new SubLObject[]{ makeKeyword("TYPE"), makeKeyword("INDEX-CONSTANT"), makeKeyword("ACTIVE-P"), T, makeKeyword("IMAGE"), makeKeyword("HIERARCHY-BROWSER"), makeKeyword("IMAGE-DISABLED"), makeKeyword("HIERARCHY-BROWSER-DISABLED"), makeKeyword("IMAGE-ALT"), makeString("[Hier]"), makeKeyword("EFFECTIVE-FN"), makeSymbol("HB-DEFAULT-METHOD-AVAILABLE?"), makeKeyword("HANDLER"), makeString("cb-hier-default"), makeKeyword("TOOL"), makeKeyword("HIERARCHY-BROWSER"), makeKeyword("TITLE"), makeString("Hierarchy Browser"), makeKeyword("COMMENT"), makeString("Lets you browse the isa hierarchy.") });
    ...
    private static final SubLList $list134 = list(new SubLObject[]{ makeKeyword("TYPE"), makeKeyword("GAF-ARG-PREDICATE-CONTENT"), makeKeyword("ACTIVE-P"), T, makeKeyword("IMAGE"), makeSymbol("LITERAL-QUERY-MARKER-ELSE-GREEN"), makeKeyword("IMAGE-ALT"), makeString("[LitQ]"), makeKeyword("EFFECTIVE-FN"), makeSymbol("LITERAL-QUERY-INDEX-EFFECTIVE-FN"), makeKeyword("HANDLER"), makeString("cb-lq"), makeKeyword("TOOL"), makeKeyword("ASK"), makeKeyword("COMMENT"), makeString("There are likely to be some additional derivable relations; this establishes them.") });

    private static final SubLSymbol LITERAL_QUERY_INDEX = makeSymbol("LITERAL-QUERY-INDEX");



    private static final SubLList $list137 = list(new SubLObject[]{ makeKeyword("TYPE"), makeKeyword("GAF-ARG-PREDICATEX"), makeKeyword("ACTIVE-P"), T, makeKeyword("IMAGE"), makeSymbol("LITERAL-QUERY-MARKER-ELSE-YELLOW"), makeKeyword("IMAGE-ALT"), makeString("[LitQ]"), makeKeyword("EFFECTIVE-FN"), makeSymbol("LITERAL-QUERY-NORMAL-EFFECTIVE-FN"), makeKeyword("HANDLER"), makeString("cb-lq"), makeKeyword("TOOL"), makeKeyword("ASK"), makeKeyword("COMMENT"), makeString("If Green, there are likely to be some additional derivable relations; if yellow, it is possible there are additional relations. This establishes them.") });

    private static final SubLSymbol LITERAL_QUERY_NORMAL = makeSymbol("LITERAL-QUERY-NORMAL");



    private static final SubLList $list140 = list(new SubLObject[]{ makeKeyword("TYPE"), makeKeyword("GAF-ARG-PREDICATEX"), makeKeyword("ACTIVE-P"), T, makeKeyword("IMAGE"), makeSymbol("LITERAL-QUERY-MARKER-ELSE-PURPLE"), makeKeyword("IMAGE-ALT"), makeString("[LitQ]"), makeKeyword("EFFECTIVE-FN"), makeSymbol("LITERAL-QUERY-INDEX-DISPLAY-EFFECTIVE-FN"), makeKeyword("HANDLER"), makeString("cb-lq"), makeKeyword("TOOL"), makeKeyword("ASK"), makeKeyword("COMMENT"), makeString("If Green, there are likely to be some additional derivable relations; if yellow, it is possible there are additional relations. If purple, additional relations are unlikely to be found (but you won't know until you try). This establishes them.") });
    ...
    private static final SubLList $list147 = list(new SubLObject[]{ makeKeyword("TYPE"), makeKeyword("ASSERTION"), makeKeyword("ACTIVE-P"), NIL, makeKeyword("IMAGE"), makeKeyword("BL-SDI"), makeKeyword("DYNAMIC-TAGFN"), makeSymbol("CB-GET-ASSERTED-ARGUMENT"), makeKeyword("IMAGE-ALT"), makeSymbol("CB-GET-ASSERTED-ARGUMENT"), makeKeyword("EFFECTIVE-FN"), makeSymbol("ASSERTED-ASSERTION?"), makeKeyword("COMMENT"), makeString("effective when the assertion has some asserted argument."), makeKeyword("DYNAMIC-COMMENT"), makeString("The asserted argument") });
    ...
    private static final SubLList $list151 = list(new SubLObject[]{ makeKeyword("TYPE"), makeKeyword("ASSERTION"), makeKeyword("ACTIVE-P"), NIL, makeKeyword("IMAGE"), makeKeyword("GR-SDI"), makeKeyword("DYNAMIC-TAGFN"), makeSymbol("CB-ASSERTION-DEDUCTIONS"), makeKeyword("IMAGE-ALT"), makeSymbol("CB-ASSERTION-DEDUCTIONS"), makeKeyword("EFFECTIVE-FN"), makeSymbol("DEDUCED-ASSERTION?"), makeKeyword("COMMENT"), makeString("effective when the assertion has some deduced argument."), makeKeyword("DYNAMIC-COMMENT"), makeString("List of deduced formulas") });
    ...
    public static SubLObject adornment_p(final SubLObject v_object) {
        return v_object.getClass() == cb_adornments.$adornment_native.class ? T : NIL;
    }

    public static SubLObject adornment_name(final SubLObject v_object) {
        assert NIL != adornment_p(v_object) : "cb_adornments.adornment_p(v_object) " + "CommonSymbols.NIL != cb_adornments.adornment_p(v_object) " + v_object;
    ...
    public static SubLObject make_adornment(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_adornments.$adornment_native();
        SubLObject next;
                                                    ...
                                                    try {
                                                        ...
                                                        try {
                                                            ...
                                                            if (NIL != adornment_dynamic_tagfn(entry)) {
                                                                html_checkbox_input(cconcatenate(format_nil.format_nil_a_no_copy(name), $str189$_dynamic), cconcatenate(format_nil.format_nil_a_no_copy(name), $str189$_dynamic), makeBoolean((NIL != adornment_image_alt(entry)) && (!adornment_image_alt(entry).isString())), UNPROVIDED, UNPROVIDED, UNPROVIDED);
                                                                html_indent(UNPROVIDED);
    ...
    public static SubLObject declare_cb_adornments_file() {
        declareFunction(me, "bookkeeping_assertion_p", "BOOKKEEPING-ASSERTION-P", 1, 0, false);
        declareFunction(me, "documentation_assertion_p", "DOCUMENTATION-ASSERTION-P", 1, 0, false);
        declareFunction(me, "print_adornment", "PRINT-ADORNMENT", 3, 0, false);
        declareFunction(me, "adornment_print_function_trampoline", "ADORNMENT-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "adornment_p", "ADORNMENT-P", 1, 0, false);
        new cb_adornments.$adornment_p$UnaryFunction();
        declareFunction(me, "adornment_name", "ADORNMENT-NAME", 1, 0, false);
        declareFunction(me, "adornment_type", "ADORNMENT-TYPE", 1, 0, false);
        declareFunction(me, "adornment_active_p", "ADORNMENT-ACTIVE-P", 1, 0, false);
        declareFunction(me, "adornment_image", "ADORNMENT-IMAGE", 1, 0, false);
        declareFunction(me, "adornment_image_disabled", "ADORNMENT-IMAGE-DISABLED", 1, 0, false);
        declareFunction(me, "adornment_image_alt", "ADORNMENT-IMAGE-ALT", 1, 0, false);
        declareFunction(me, "adornment_dynamic_tagfn", "ADORNMENT-DYNAMIC-TAGFN", 1, 0, false);
        declareFunction(me, "adornment_color", "ADORNMENT-COLOR", 1, 0, false);
        declareFunction(me, "adornment_letter", "ADORNMENT-LETTER", 1, 0, false);
        declareFunction(me, "adornment_effective_fn", "ADORNMENT-EFFECTIVE-FN", 1, 0, false);
        declareFunction(me, "adornment_handler", "ADORNMENT-HANDLER", 1, 0, false);
        declareFunction(me, "adornment_tool", "ADORNMENT-TOOL", 1, 0, false);
        declareFunction(me, "adornment_comment", "ADORNMENT-COMMENT", 1, 0, false);
        declareFunction(me, "adornment_dynamic_comment", "ADORNMENT-DYNAMIC-COMMENT", 1, 0, false);
        declareFunction(me, "adornment_title", "ADORNMENT-TITLE", 1, 0, false);
        declareFunction(me, "_csetf_adornment_name", "_CSETF-ADORNMENT-NAME", 2, 0, false);
        declareFunction(me, "_csetf_adornment_type", "_CSETF-ADORNMENT-TYPE", 2, 0, false);
        declareFunction(me, "_csetf_adornment_active_p", "_CSETF-ADORNMENT-ACTIVE-P", 2, 0, false);
        declareFunction(me, "_csetf_adornment_image", "_CSETF-ADORNMENT-IMAGE", 2, 0, false);
        declareFunction(me, "_csetf_adornment_image_disabled", "_CSETF-ADORNMENT-IMAGE-DISABLED", 2, 0, false);
        declareFunction(me, "_csetf_adornment_image_alt", "_CSETF-ADORNMENT-IMAGE-ALT", 2, 0, false);
        declareFunction(me, "_csetf_adornment_dynamic_tagfn", "_CSETF-ADORNMENT-DYNAMIC-TAGFN", 2, 0, false);
        declareFunction(me, "_csetf_adornment_color", "_CSETF-ADORNMENT-COLOR", 2, 0, false);
        declareFunction(me, "_csetf_adornment_letter", "_CSETF-ADORNMENT-LETTER", 2, 0, false);
        declareFunction(me, "_csetf_adornment_effective_fn", "_CSETF-ADORNMENT-EFFECTIVE-FN", 2, 0, false);
        declareFunction(me, "_csetf_adornment_handler", "_CSETF-ADORNMENT-HANDLER", 2, 0, false);
        declareFunction(me, "_csetf_adornment_tool", "_CSETF-ADORNMENT-TOOL", 2, 0, false);
        declareFunction(me, "_csetf_adornment_comment", "_CSETF-ADORNMENT-COMMENT", 2, 0, false);
        declareFunction(me, "_csetf_adornment_dynamic_comment", "_CSETF-ADORNMENT-DYNAMIC-COMMENT", 2, 0, false);
        declareFunction(me, "_csetf_adornment_title", "_CSETF-ADORNMENT-TITLE", 2, 0, false);
        declareFunction(me, "make_adornment", "MAKE-ADORNMENT", 0, 1, false);
        declareFunction(me, "visit_defstruct_adornment", "VISIT-DEFSTRUCT-ADORNMENT", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_adornment_method", "VISIT-DEFSTRUCT-OBJECT-ADORNMENT-METHOD", 2, 0, false);
        declareFunction(me, "active_adornment_struct_p", "ACTIVE-ADORNMENT-STRUCT-P", 1, 1, false);
        declareFunction(me, "active_adornment_p", "ACTIVE-ADORNMENT-P", 1, 0, false);
        declareFunction(me, "enable_adornment", "ENABLE-ADORNMENT", 1, 1, false);
        declareMacro(me, "defadornment", "DEFADORNMENT");
        declareFunction(me, "find_adornment", "FIND-ADORNMENT", 1, 0, false);
        declareFunction(me, "active_adornments", "ACTIVE-ADORNMENTS", 1, 0, false);
        declareFunction(me, "id_for_type", "ID-FOR-TYPE", 2, 0, false);
        declareFunction(me, "calc_adornment_image_alt", "CALC-ADORNMENT-IMAGE-ALT", 2, 2, false);
        declareFunction(me, "display_linked_adornment", "DISPLAY-LINKED-ADORNMENT", 6, 0, false);
        declareFunction(me, "display_adornment_disabled", "DISPLAY-ADORNMENT-DISABLED", 1, 5, false);
        declareFunction(me, "display_adornment", "DISPLAY-ADORNMENT", 1, 5, false);
        declareFunction(me, "display_active_adornments", "DISPLAY-ACTIVE-ADORNMENTS", 0, 1, false);
        declareFunction(me, "resolved_adornment_image", "RESOLVED-ADORNMENT-IMAGE", 1, 4, false);
        declareFunction(me, "adorn_thingo_p", "ADORN-THINGO-P", 2, 2, false);
        declareFunction(me, "activate_adornment", "ACTIVATE-ADORNMENT", 1, 0, false);
        declareFunction(me, "handle_adornments", "HANDLE-ADORNMENTS", 3, 3, false);
        declareFunction(me, "handle_specific_adornment", "HANDLE-SPECIFIC-ADORNMENT", 4, 3, false);
        declareFunction(me, "cb_include_hierarchy_linkP", "CB-INCLUDE-HIERARCHY-LINK?", 2, 0, false);
        declareFunction(me, "hierarchy_link_effective_fn", "HIERARCHY-LINK-EFFECTIVE-FN", 3, 0, false);
        declareFunction(me, "cb_show_alphabetic_searchP", "CB-SHOW-ALPHABETIC-SEARCH?", 1, 0, false);
        declareFunction(me, "literal_query_index_effective_fn", "LITERAL-QUERY-INDEX-EFFECTIVE-FN", 3, 1, false);
        declareFunction(me, "literal_query_normal_effective_fn", "LITERAL-QUERY-NORMAL-EFFECTIVE-FN", 3, 0, false);
        declareFunction(me, "literal_query_marker_else_green", "LITERAL-QUERY-MARKER-ELSE-GREEN", 1, 0, false);
        declareFunction(me, "literal_query_marker_else_yellow", "LITERAL-QUERY-MARKER-ELSE-YELLOW", 1, 0, false);
        declareFunction(me, "literal_query_marker_else_purple", "LITERAL-QUERY-MARKER-ELSE-PURPLE", 1, 0, false);
        declareFunction(me, "literal_query_index_display_effective_fn", "LITERAL-QUERY-INDEX-DISPLAY-EFFECTIVE-FN", 3, 0, false);
        declareFunction(me, "cb_get_asserted_argument", "CB-GET-ASSERTED-ARGUMENT", 1, 0, false);
        declareFunction(me, "convert_deduction_to_formula", "CONVERT-DEDUCTION-TO-FORMULA", 1, 0, false);
        declareFunction(me, "cb_assertion_deductions", "CB-ASSERTION-DEDUCTIONS", 1, 0, false);
        declareFunction(me, "adornmentL", "ADORNMENT<", 2, 0, false);
        declareFunction(me, "cb_view_adorn", "CB-VIEW-ADORN", 0, 1, false);
        declareFunction(me, "cb_adornment_handler", "CB-ADORNMENT-HANDLER", 1, 0, false);
        declareFunction(me, "cb_link_view_adorn", "CB-LINK-VIEW-ADORN", 1, 1, false);
        declareFunction(me, "cb_c_index_adornments", "CB-C-INDEX-ADORNMENTS", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $adornment_native extends SubLStructNative {
        ...
        public $adornment_native() {
            ...
            this.$image = Lisp.NIL;
            this.$image_disabled = Lisp.NIL;
            this.$image_alt = Lisp.NIL;
            this.$dynamic_tagfn = Lisp.NIL;
            this.$color = Lisp.NIL;
            this.$letter = Lisp.NIL;
            this.$effective_fn = Lisp.NIL;
            this.$handler = Lisp.NIL;
            this.$tool = Lisp.NIL;
            this.$comment = Lisp.NIL;
            this.$dynamic_comment = Lisp.NIL;
            this.$title = Lisp.NIL;
        }
        ...
        static {
            structDecl = makeStructDeclNative(cb_adornments.$adornment_native.class, ADORNMENT, ADORNMENT_P, $list5, $list6, new String[]{ "$name", "$type", "$active_p", "$image", "$image_disabled", "$image_alt", "$dynamic_tagfn", "$color", "$letter", "$effective_fn", "$handler", "$tool", "$comment", "$dynamic_comment", "$title" }, $list7, $list8, PRINT_ADORNMENT);
        }
    }
