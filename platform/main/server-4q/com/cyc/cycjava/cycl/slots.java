...
public final class slots extends SubLTranslatedFile {
    ...
    public static SubLObject slot_p(final SubLObject v_object) {
        return v_object.getClass() == slots.$slot_native.class ? T : NIL;
    }

    public static SubLObject slot_name(final SubLObject v_object) {
        assert NIL != slot_p(v_object) : "slots.slot_p(v_object) " + "CommonSymbols.NIL != slots.slot_p(v_object) " + v_object;
    ...
    public static SubLObject make_slot(SubLObject arglist) {
        ...
        final SubLObject v_new = new slots.$slot_native();
        SubLObject next;
    ...
    public static final class $slot_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(slots.$slot_native.class, SLOT, SLOT_P, $list2, $list3, new String[]{ "$name", "$index", "$protection", "$class_name", "$essential", "$init_value" }, $list4, $list5, PRINT_SLOT);
        }
    }
