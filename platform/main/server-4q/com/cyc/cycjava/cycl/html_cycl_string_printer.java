...
import com.cyc.cycjava.cycl.html_cycl_string_printer;
...
import static com.cyc.cycjava.cycl.html_cycl_string_printer.*;
...
public final class html_cycl_string_printer extends SubLTranslatedFile {
    ...
    private static final SubLList $list2 = list(new SubLObject[]{ makeSymbol("STRING"), makeSymbol("LENGTH"), makeSymbol("LAST-IDX"), makeSymbol("INSIDE-CYCL-TAG?"), makeSymbol("HASH-IDX"), makeSymbol("COLON-IDX"), makeSymbol("LT-IDX"), makeSymbol("VARIABLE-IDX"), makeSymbol("URL-IDX"), makeSymbol("URL-END-IDX"), makeSymbol("LINK-FUNCTION"), makeSymbol("REQUIRE-EXACT?") });

    private static final SubLList $list3 = list(new SubLObject[]{ makeKeyword("STRING"), makeKeyword("LENGTH"), makeKeyword("LAST-IDX"), makeKeyword("INSIDE-CYCL-TAG?"), makeKeyword("HASH-IDX"), makeKeyword("COLON-IDX"), makeKeyword("LT-IDX"), makeKeyword("VARIABLE-IDX"), makeKeyword("URL-IDX"), makeKeyword("URL-END-IDX"), makeKeyword("LINK-FUNCTION"), makeKeyword("REQUIRE-EXACT?") });

    private static final SubLList $list4 = list(new SubLObject[]{ makeSymbol("HCS-STRING"), makeSymbol("HCS-LENGTH"), makeSymbol("HCS-LAST-IDX"), makeSymbol("HCS-INSIDE-CYCL-TAG?"), makeSymbol("HCS-HASH-IDX"), makeSymbol("HCS-COLON-IDX"), makeSymbol("HCS-LT-IDX"), makeSymbol("HCS-VARIABLE-IDX"), makeSymbol("HCS-URL-IDX"), makeSymbol("HCS-URL-END-IDX"), makeSymbol("HCS-LINK-FUNCTION"), makeSymbol("HCS-REQUIRE-EXACT?") });

    private static final SubLList $list5 = list(new SubLObject[]{ makeSymbol("_CSETF-HCS-STRING"), makeSymbol("_CSETF-HCS-LENGTH"), makeSymbol("_CSETF-HCS-LAST-IDX"), makeSymbol("_CSETF-HCS-INSIDE-CYCL-TAG?"), makeSymbol("_CSETF-HCS-HASH-IDX"), makeSymbol("_CSETF-HCS-COLON-IDX"), makeSymbol("_CSETF-HCS-LT-IDX"), makeSymbol("_CSETF-HCS-VARIABLE-IDX"), makeSymbol("_CSETF-HCS-URL-IDX"), makeSymbol("_CSETF-HCS-URL-END-IDX"), makeSymbol("_CSETF-HCS-LINK-FUNCTION"), makeSymbol("_CSETF-HCS-REQUIRE-EXACT?") });
    ...
    public static SubLObject html_cycl_string_printer_p(final SubLObject v_object) {
        return v_object.getClass() == html_cycl_string_printer.$html_cycl_string_printer_native.class ? T : NIL;
    }

    public static SubLObject hcs_string(final SubLObject v_object) {
        assert NIL != html_cycl_string_printer_p(v_object) : "html_cycl_string_printer.html_cycl_string_printer_p(v_object) " + "CommonSymbols.NIL != html_cycl_string_printer.html_cycl_string_printer_p(v_object) " + v_object;
    ...
    public static SubLObject make_html_cycl_string_printer(SubLObject arglist) {
        ...
        final SubLObject v_new = new html_cycl_string_printer.$html_cycl_string_printer_native();
        SubLObject next;
    ...
    public static SubLObject html_cycl_string_printer_print_next(final SubLObject printer) {
        ...
        if (hcs_colon_idx(printer).eql(next_char_idx)) {
            ...
            if (hcs_hash_idx(printer).eql(next_char_idx)) {
                hcs_handle_hash(printer);
            } else
                if (hcs_variable_idx(printer).eql(next_char_idx)) {
                    hcs_handle_variable(printer);
                } else
                    if (hcs_lt_idx(printer).eql(next_char_idx)) {
    ...
    public static SubLObject html_cycl_string_variable_index(final SubLObject string, final SubLObject start_char) {
        ...
        for (end_var = end_var_$1 = length(string), n = NIL, n = start_char; !n.numGE(end_var_$1); n = number_utilities.f_1X(n)) {
            ...
            if (NIL != inside_tagP) {
                ...
                if (this_char.eql(CHAR_less)) {
                    inside_tagP = T;
                } else {
                    if ((NIL != string_utilities.whitespacep(prev_char)) && (NIL != find(this_char, $str56$__, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED))) {
                        return n;
                    }
                    if ((((NIL != string_utilities.whitespacep(prev_char)) && (NIL != list_utilities.lengthG(string, number_utilities.f_1X(n), UNPROVIDED))) && (NIL != cycl_variables.el_variable_charP(this_char))) && (NIL != cycl_variables.el_variable_charP(Strings.sublisp_char(string, number_utilities.f_1X(n))))) {
                        return n;
                    }
                    prev_char = this_char;
                }
    ...
    public static SubLObject declare_html_cycl_string_printer_file() {
        declareFunction(me, "html_cycl_string_printer_print_function_trampoline", "HTML-CYCL-STRING-PRINTER-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "html_cycl_string_printer_p", "HTML-CYCL-STRING-PRINTER-P", 1, 0, false);
        new html_cycl_string_printer.$html_cycl_string_printer_p$UnaryFunction();
        declareFunction(me, "hcs_string", "HCS-STRING", 1, 0, false);
        declareFunction(me, "hcs_length", "HCS-LENGTH", 1, 0, false);
        declareFunction(me, "hcs_last_idx", "HCS-LAST-IDX", 1, 0, false);
        declareFunction(me, "hcs_inside_cycl_tagP", "HCS-INSIDE-CYCL-TAG?", 1, 0, false);
        declareFunction(me, "hcs_hash_idx", "HCS-HASH-IDX", 1, 0, false);
        declareFunction(me, "hcs_colon_idx", "HCS-COLON-IDX", 1, 0, false);
        declareFunction(me, "hcs_lt_idx", "HCS-LT-IDX", 1, 0, false);
        declareFunction(me, "hcs_variable_idx", "HCS-VARIABLE-IDX", 1, 0, false);
        declareFunction(me, "hcs_url_idx", "HCS-URL-IDX", 1, 0, false);
        declareFunction(me, "hcs_url_end_idx", "HCS-URL-END-IDX", 1, 0, false);
        declareFunction(me, "hcs_link_function", "HCS-LINK-FUNCTION", 1, 0, false);
        declareFunction(me, "hcs_require_exactP", "HCS-REQUIRE-EXACT?", 1, 0, false);
        declareFunction(me, "_csetf_hcs_string", "_CSETF-HCS-STRING", 2, 0, false);
        declareFunction(me, "_csetf_hcs_length", "_CSETF-HCS-LENGTH", 2, 0, false);
        declareFunction(me, "_csetf_hcs_last_idx", "_CSETF-HCS-LAST-IDX", 2, 0, false);
        declareFunction(me, "_csetf_hcs_inside_cycl_tagP", "_CSETF-HCS-INSIDE-CYCL-TAG?", 2, 0, false);
        declareFunction(me, "_csetf_hcs_hash_idx", "_CSETF-HCS-HASH-IDX", 2, 0, false);
        declareFunction(me, "_csetf_hcs_colon_idx", "_CSETF-HCS-COLON-IDX", 2, 0, false);
        declareFunction(me, "_csetf_hcs_lt_idx", "_CSETF-HCS-LT-IDX", 2, 0, false);
        declareFunction(me, "_csetf_hcs_variable_idx", "_CSETF-HCS-VARIABLE-IDX", 2, 0, false);
        declareFunction(me, "_csetf_hcs_url_idx", "_CSETF-HCS-URL-IDX", 2, 0, false);
        declareFunction(me, "_csetf_hcs_url_end_idx", "_CSETF-HCS-URL-END-IDX", 2, 0, false);
        declareFunction(me, "_csetf_hcs_link_function", "_CSETF-HCS-LINK-FUNCTION", 2, 0, false);
        declareFunction(me, "_csetf_hcs_require_exactP", "_CSETF-HCS-REQUIRE-EXACT?", 2, 0, false);
        declareFunction(me, "make_html_cycl_string_printer", "MAKE-HTML-CYCL-STRING-PRINTER", 0, 1, false);
        declareFunction(me, "visit_defstruct_html_cycl_string_printer", "VISIT-DEFSTRUCT-HTML-CYCL-STRING-PRINTER", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_html_cycl_string_printer_method", "VISIT-DEFSTRUCT-OBJECT-HTML-CYCL-STRING-PRINTER-METHOD", 2, 0, false);
        declareFunction(me, "print_html_cycl_string_printer", "PRINT-HTML-CYCL-STRING-PRINTER", 3, 0, false);
        declareFunction(me, "new_html_cycl_string_printer", "NEW-HTML-CYCL-STRING-PRINTER", 1, 2, false);
        declareFunction(me, "html_cycl_string_printer_done_p", "HTML-CYCL-STRING-PRINTER-DONE-P", 1, 0, false);
        declareFunction(me, "html_cycl_string_printer_print_next", "HTML-CYCL-STRING-PRINTER-PRINT-NEXT", 1, 0, false);
        declareFunction(me, "html_cycl_string_variable_index", "HTML-CYCL-STRING-VARIABLE-INDEX", 2, 0, false);
        declareFunction(me, "print_url_with_tag", "PRINT-URL-WITH-TAG", 1, 0, false);
        declareFunction(me, "print_embedded_constant", "PRINT-EMBEDDED-CONSTANT", 3, 2, false);
        declareFunction(me, "hcs_find", "HCS-FIND", 3, 0, false);
        declareFunction(me, "hcs_set_colon_idx", "HCS-SET-COLON-IDX", 1, 0, false);
        declareFunction(me, "hcs_set_hash_idx", "HCS-SET-HASH-IDX", 1, 0, false);
        declareFunction(me, "hcs_print", "HCS-PRINT", 3, 0, false);
        declareFunction(me, "hcs_handle_colon", "HCS-HANDLE-COLON", 1, 0, false);
        declareFunction(me, "hcs_handle_hash", "HCS-HANDLE-HASH", 1, 0, false);
        declareFunction(me, "hcs_handle_variable", "HCS-HANDLE-VARIABLE", 1, 0, false);
        declareFunction(me, "hcs_handle_lt", "HCS-HANDLE-LT", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $html_cycl_string_printer_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(html_cycl_string_printer.$html_cycl_string_printer_native.class, HTML_CYCL_STRING_PRINTER, HTML_CYCL_STRING_PRINTER_P, $list2, $list3, new String[]{ "$string", "$length", "$last_idx", "$inside_cycl_tagP", "$hash_idx", "$colon_idx", "$lt_idx", "$variable_idx", "$url_idx", "$url_end_idx", "$link_function", "$require_exactP" }, $list4, $list5, PRINT_HTML_CYCL_STRING_PRINTER);
        }
    }
