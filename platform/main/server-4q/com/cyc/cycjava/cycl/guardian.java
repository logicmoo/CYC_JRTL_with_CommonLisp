...
import com.cyc.cycjava.cycl.guardian;
...
import static com.cyc.cycjava.cycl.guardian.*;
...
public final class guardian extends SubLTranslatedFile {
    ...
    public static SubLObject guardian_request_p(final SubLObject v_object) {
        return v_object.getClass() == guardian.$guardian_request_native.class ? T : NIL;
    }

    public static SubLObject guardian_request_id(final SubLObject v_object) {
        assert NIL != guardian_request_p(v_object) : "guardian.guardian_request_p(v_object) " + "CommonSymbols.NIL != guardian.guardian_request_p(v_object) " + v_object;
    ...
    public static SubLObject make_guardian_request(SubLObject arglist) {
        ...
        final SubLObject v_new = new guardian.$guardian_request_native();
        SubLObject next;
    ...
    public static final class $guardian_request_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(guardian.$guardian_request_native.class, GUARDIAN_REQUEST, GUARDIAN_REQUEST_P, $list5, $list6, new String[]{ "$id", "$checker_fn", "$parameter", "$notification_fn", "$interrupt_p", "$process" }, $list7, $list8, PRINT_GUARDIAN_REQUEST);
        }
    }
