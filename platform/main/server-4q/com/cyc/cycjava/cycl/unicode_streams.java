...
import com.cyc.cycjava.cycl.unicode_streams;
...
import static com.cyc.cycjava.cycl.unicode_streams.*;
...
public final class unicode_streams extends SubLTranslatedFile {
    ...
    public static SubLObject utf8_stream_p(final SubLObject v_object) {
        return v_object.getClass() == unicode_streams.$utf8_stream_native.class ? T : NIL;
    }

    public static SubLObject utf8_stream_stream(final SubLObject v_object) {
        assert NIL != utf8_stream_p(v_object) : "unicode_streams.utf8_stream_p(v_object) " + "CommonSymbols.NIL != unicode_streams.utf8_stream_p(v_object) " + v_object;
    ...
    public static SubLObject make_utf8_stream(SubLObject arglist) {
        ...
        final SubLObject v_new = new unicode_streams.$utf8_stream_native();
        SubLObject next;
    ...
    public static final class $utf8_stream_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(unicode_streams.$utf8_stream_native.class, UTF8_STREAM, UTF8_STREAM_P, $list2, $list3, new String[]{ "$stream", "$cache" }, $list4, $list5, PRINT_UTF8_STREAM);
        }
    }
