...
import static com.cyc.cycjava.cycl.event_broker.*;
...
public final class event_broker extends SubLTranslatedFile {
    ...
    public static SubLObject funcall_info_p(final SubLObject v_object) {
        return v_object.getClass() == event_broker.$funcall_info_native.class ? T : NIL;
    }

    public static SubLObject funcall_info_function(final SubLObject v_object) {
        assert NIL != funcall_info_p(v_object) : "event_broker.funcall_info_p(v_object) " + "CommonSymbols.NIL != event_broker.funcall_info_p(v_object) " + v_object;
    ...
    public static SubLObject make_funcall_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new event_broker.$funcall_info_native();
        SubLObject next;
    ...
    public static SubLObject socket_info_p(final SubLObject v_object) {
        return v_object.getClass() == event_broker.$socket_info_native.class ? T : NIL;
    }

    public static SubLObject socket_info_host(final SubLObject v_object) {
        assert NIL != socket_info_p(v_object) : "event_broker.socket_info_p(v_object) " + "CommonSymbols.NIL != event_broker.socket_info_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_socket_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new event_broker.$socket_info_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject event_listener_p(final SubLObject v_object) {
        return v_object.getClass() == event_broker.$event_listener_native.class ? T : NIL;
    }

    public static SubLObject event_listener_event(final SubLObject v_object) {
        assert NIL != event_listener_p(v_object) : "event_broker.event_listener_p(v_object) " + "CommonSymbols.NIL != event_broker.event_listener_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_event_listener(SubLObject arglist) {
        ...
        final SubLObject v_new = new event_broker.$event_listener_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject event_broker_p(final SubLObject v_object) {
        return v_object.getClass() == event_broker.$event_broker_native.class ? T : NIL;
    }

    public static SubLObject event_broker_hierarchy(final SubLObject v_object) {
        assert NIL != event_broker_p(v_object) : "event_broker.event_broker_p(v_object) " + "CommonSymbols.NIL != event_broker.event_broker_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_event_broker(SubLObject arglist) {
        ...
        final SubLObject v_new = new event_broker.$event_broker_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject protocol_description_p(final SubLObject v_object) {
        return v_object.getClass() == event_broker.$protocol_description_native.class ? T : NIL;
    }

    public static SubLObject protocol_description_protocol(final SubLObject v_object) {
        assert NIL != protocol_description_p(v_object) : "event_broker.protocol_description_p(v_object) " + "CommonSymbols.NIL != event_broker.protocol_description_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_protocol_description(SubLObject arglist) {
        ...
        final SubLObject v_new = new event_broker.$protocol_description_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $funcall_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(event_broker.$funcall_info_native.class, FUNCALL_INFO, FUNCALL_INFO_P, $list2, $list3, new String[]{ "$function" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $socket_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(event_broker.$socket_info_native.class, SOCKET_INFO, SOCKET_INFO_P, $list21, $list22, new String[]{ "$host", "$port", "$protocol" }, $list23, $list24, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $event_listener_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(event_broker.$event_listener_native.class, EVENT_LISTENER, EVENT_LISTENER_P, $list41, $list42, new String[]{ "$event", "$invocation_mode", "$invocation_info", "$my_params", "$source_filter" }, $list43, $list44, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $event_broker_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(event_broker.$event_broker_native.class, EVENT_BROKER, EVENT_BROKER_P, $list74, $list75, new String[]{ "$hierarchy", "$listeners", "$lock", "$postings", "$protocols" }, $list76, $list77, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $protocol_description_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(event_broker.$protocol_description_native.class, PROTOCOL_DESCRIPTION, PROTOCOL_DESCRIPTION_P, $list110, $list111, new String[]{ "$protocol", "$event_serialize", "$my_params_serialize" }, $list112, $list113, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
