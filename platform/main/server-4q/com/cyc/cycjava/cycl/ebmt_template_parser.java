...
public final class ebmt_template_parser extends SubLTranslatedFile {
    ...
    public static SubLObject ebmt_template_p(final SubLObject v_object) {
        return v_object.getClass() == ebmt_template_parser.$ebmt_template_native.class ? T : NIL;
    }

    public static SubLObject ebmt_template_nl_cycl_pair(final SubLObject v_object) {
        assert NIL != ebmt_template_p(v_object) : "ebmt_template_parser.ebmt_template_p(v_object) " + "CommonSymbols.NIL != ebmt_template_parser.ebmt_template_p(v_object) " + v_object;
    ...
    public static SubLObject make_ebmt_template(SubLObject arglist) {
        ...
        final SubLObject v_new = new ebmt_template_parser.$ebmt_template_native();
        SubLObject next;
    ...
    public static SubLObject ebmt_template_parsing_info_p(final SubLObject v_object) {
        return v_object.getClass() == ebmt_template_parser.$ebmt_template_parsing_info_native.class ? T : NIL;
    }

    public static SubLObject ebmt_template_parsing_info_kw_lw_pairs(final SubLObject v_object) {
        assert NIL != ebmt_template_parsing_info_p(v_object) : "ebmt_template_parser.ebmt_template_parsing_info_p(v_object) " + "CommonSymbols.NIL != ebmt_template_parser.ebmt_template_parsing_info_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_ebmt_template_parsing_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new ebmt_template_parser.$ebmt_template_parsing_info_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $ebmt_template_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(ebmt_template_parser.$ebmt_template_native.class, EBMT_TEMPLATE, EBMT_TEMPLATE_P, $list16, $list17, new String[]{ "$nl_cycl_pair", "$type", "$links", "$cycl", "$indexing_result", "$weight" }, $list18, $list19, PRINT_EBMT_TEMPLATE);
        }
    }
    ...
    public static final class $ebmt_template_parsing_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(ebmt_template_parser.$ebmt_template_parsing_info_native.class, EBMT_TEMPLATE_PARSING_INFO, EBMT_TEMPLATE_PARSING_INFO_P, $list98, $list99, new String[]{ "$kw_lw_pairs", "$lw_links_pairs", "$lw", "$processed", "$cycl" }, $list100, $list101, PRINT_EBMT_TEMPLATE_PARSING_INFO);
        }
    }
