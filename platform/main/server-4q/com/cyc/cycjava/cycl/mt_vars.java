...
public final class mt_vars extends SubLTranslatedFile {
    ...
    public static SubLObject init_mt_vars_file() {
        ...
        deflexical("*MT-ROOT*", SubLSystemTrampolineFile.maybeDefault($mt_root$, $mt_root$, $$BaseKB));
        deflexical("*THEORY-MT-ROOT*", SubLSystemTrampolineFile.maybeDefault($theory_mt_root$, $theory_mt_root$, $$BaseKB));
        deflexical("*ASSERTIBLE-MT-ROOT*", SubLSystemTrampolineFile.maybeDefault($assertible_mt_root$, $assertible_mt_root$, $$BaseKB));
        deflexical("*ASSERTIBLE-THEORY-MT-ROOT*", SubLSystemTrampolineFile.maybeDefault($assertible_theory_mt_root$, $assertible_theory_mt_root$, $$BaseKB));
        deflexical("*CORE-MT-FLOOR*", SubLSystemTrampolineFile.maybeDefault($core_mt_floor$, $core_mt_floor$, $$BaseKB));
        deflexical("*MT-MT*", SubLSystemTrampolineFile.maybeDefault($mt_mt$, $mt_mt$, $$UniversalVocabularyMt));
        deflexical("*DEFINING-MT-MT*", SubLSystemTrampolineFile.maybeDefault($defining_mt_mt$, $defining_mt_mt$, $$BaseKB));
        deflexical("*DECONTEXTUALIZED-PREDICATE-MT*", SubLSystemTrampolineFile.maybeDefault($decontextualized_predicate_mt$, $decontextualized_predicate_mt$, $$BaseKB));
        deflexical("*DECONTEXTUALIZED-COLLECTION-MT*", SubLSystemTrampolineFile.maybeDefault($decontextualized_collection_mt$, $decontextualized_collection_mt$, $$BaseKB));
        deflexical("*EPHEMERAL-TERM-MT*", SubLSystemTrampolineFile.maybeDefault($ephemeral_term_mt$, $ephemeral_term_mt$, $$BaseKB));
        deflexical("*IST-MT*", SubLSystemTrampolineFile.maybeDefault($ist_mt$, $ist_mt$, $$BaseKB));
        deflexical("*INFERENCE-RELATED-BOOKKEEPING-PREDICATE-MT*", SubLSystemTrampolineFile.maybeDefault($inference_related_bookkeeping_predicate_mt$, $inference_related_bookkeeping_predicate_mt$, $$BaseKB));
        deflexical("*ANECT-MT*", SubLSystemTrampolineFile.maybeDefault($anect_mt$, $anect_mt$, $$UniversalVocabularyMt));
        deflexical("*BROAD-MT-MT*", SubLSystemTrampolineFile.maybeDefault($broad_mt_mt$, $broad_mt_mt$, $$BaseKB));
        deflexical("*PSC-MT*", SubLSystemTrampolineFile.maybeDefault($psc_mt$, $psc_mt$, $$BaseKB));
        deflexical("*TOU-MT*", SubLSystemTrampolineFile.maybeDefault($tou_mt$, $tou_mt$, $$BaseKB));
        deflexical("*SKOLEM-MT*", SubLSystemTrampolineFile.maybeDefault($skolem_mt$, $skolem_mt$, $$BaseKB));
        deflexical("*THING-DEFINING-MT*", SubLSystemTrampolineFile.maybeDefault($thing_defining_mt$, $thing_defining_mt$, $$BaseKB));
        deflexical("*RELATION-DEFINING-MT*", SubLSystemTrampolineFile.maybeDefault($relation_defining_mt$, $relation_defining_mt$, $$BaseKB));
        deflexical("*EQUALS-DEFINING-MT*", SubLSystemTrampolineFile.maybeDefault($equals_defining_mt$, $equals_defining_mt$, $$BaseKB));
        deflexical("*ELEMENT-OF-DEFINING-MT*", SubLSystemTrampolineFile.maybeDefault($element_of_defining_mt$, $element_of_defining_mt$, $$BaseKB));
        deflexical("*SUBSET-OF-DEFINING-MT*", SubLSystemTrampolineFile.maybeDefault($subset_of_defining_mt$, $subset_of_defining_mt$, $$BaseKB));
        deflexical("*ARITY-MT*", SubLSystemTrampolineFile.maybeDefault($arity_mt$, $arity_mt$, $$UniversalVocabularyMt));
        deflexical("*SUBLID-MT*", SubLSystemTrampolineFile.maybeDefault($sublid_mt$, $sublid_mt$, $$CycAPIMt));
        deflexical("*NOT-ASSERTIBLE-MT-CONVENTION-MT*", SubLSystemTrampolineFile.maybeDefault($not_assertible_mt_convention_mt$, $not_assertible_mt_convention_mt$, $$UniversalVocabularyMt));
        deflexical("*DEFAULT-ASK-MT*", SubLSystemTrampolineFile.maybeDefault($default_ask_mt$, $default_ask_mt$, $$BaseKB));
        deflexical("*DEFAULT-ASSERT-MT*", SubLSystemTrampolineFile.maybeDefault($default_assert_mt$, $default_assert_mt$, $$BaseKB));
        deflexical("*DEFAULT-CLONE-MT*", SubLSystemTrampolineFile.maybeDefault($default_clone_mt$, $default_clone_mt$, $$BaseKB));
        deflexical("*DEFAULT-SUPPORT-MT*", SubLSystemTrampolineFile.maybeDefault($default_support_mt$, $default_support_mt$, $$BaseKB));
        deflexical("*DEFAULT-COMMENT-MT*", SubLSystemTrampolineFile.maybeDefault($default_comment_mt$, $default_comment_mt$, $$BaseKB));
        deflexical("*DEFAULT-CONVENTION-MT*", SubLSystemTrampolineFile.maybeDefault($default_convention_mt$, $default_convention_mt$, $$UniversalVocabularyMt));
