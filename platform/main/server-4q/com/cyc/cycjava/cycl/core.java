...
import com.cyc.cycjava.cycl.core;
...
import static com.cyc.cycjava.cycl.core.*;
...
public final class core extends SubLTranslatedFile {
    ...
    private static final SubLList $list1 = list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("BaseKB")), reader_make_constant_shell(makeString("BookkeepingMt")));
    ...
    public static final SubLSymbol CACHED_NON_CORE_CONSTANT_P = makeSymbol("CACHED-NON-CORE-CONSTANT-P");
    ...
    public static final SubLSymbol CACHED_NON_CORE_FORT_P = makeSymbol("CACHED-NON-CORE-FORT-P");

    public static final SubLSymbol NON_CORE_ASSERTION_P = makeSymbol("NON-CORE-ASSERTION-P");

    public static final SubLString $$$determining_core_rules = makeString("determining core rules");
    ...
    public static final SubLString $$$Computing_definitional_info = makeString("Computing definitional info");

    public static final SubLList $list22 = list(new SubLObject[]{ list(reader_make_constant_shell(makeString("isa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("quotedIsa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("genls")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), T), list(reader_make_constant_shell(makeString("arg1Isa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg1Genl")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg2Isa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg2Genl")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg3Isa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg3Genl")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg4Isa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg4Genl")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg5Isa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg5Genl")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("argsIsa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg1QuotedIsa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg2QuotedIsa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg3QuotedIsa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg4QuotedIsa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("arg5QuotedIsa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("argsQuotedIsa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("resultIsa")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("resultGenl")), makeSymbol("ALL-GENLS"), makeSymbol("GENL?"), NIL), list(reader_make_constant_shell(makeString("genlPreds")), makeSymbol("ALL-GENL-PREDS"), makeSymbol("GENL-PRED?"), T), list(reader_make_constant_shell(makeString("genlInverse")), makeSymbol("ALL-GENL-PREDS"), makeSymbol("GENL-PRED?"), NIL), list(reader_make_constant_shell(makeString("genlMt")), makeSymbol("ALL-GENL-MTS"), makeSymbol("GENL-MT?"), T), list(reader_make_constant_shell(makeString("arity")), NIL, NIL, NIL), list(reader_make_constant_shell(makeString("arityMin")), NIL, NIL, NIL), list(reader_make_constant_shell(makeString("arityMax")), NIL, NIL, NIL), list(reader_make_constant_shell(makeString("defnIff")), NIL, NIL, NIL), list(reader_make_constant_shell(makeString("defnNecessary")), NIL, NIL, NIL), list(reader_make_constant_shell(makeString("defnSufficient")), NIL, NIL, NIL), list(reader_make_constant_shell(makeString("quotedDefnIff")), NIL, NIL, NIL), list(reader_make_constant_shell(makeString("quotedDefnNecessary")), NIL, NIL, NIL), list(reader_make_constant_shell(makeString("quotedDefnSufficient")), NIL, NIL, NIL) });

    public static final SubLSymbol CORE_DEFINITIONAL_INFO = makeSymbol("CORE-DEFINITIONAL-INFO");

    public static final SubLList $list24 = list(makeSymbol("PRED"), makeSymbol("ALL-FUNC"), makeSymbol("TEST-FUNC"), makeSymbol("REFLEXIVE"));
    ...
    public static final SubLSymbol CACHED_CORE_FORT_P = makeSymbol("CACHED-CORE-FORT-P");
    ...
    public static final SubLList $list98 = cons(makeSymbol("PRED"), makeSymbol("TRUTHS"));
    ...
    public static final SubLList $list114 = list(makeSymbol("PRED"), makeSymbol("ARG1"), makeSymbol("ARG2"));
    ...
    private static final SubLList $list123 = list(reader_make_constant_shell(makeString("decontextualizedPredicate")), reader_make_constant_shell(makeString("predicateConventionMt")), reader_make_constant_shell(makeString("decontextualizedCollection")), reader_make_constant_shell(makeString("collectionConventionMt")));
    ...
    public static SubLObject write_core_hlmt(final SubLObject v_hlmt, final SubLObject stream, SubLObject depth) {
        ...
        assert NIL != hlmt.hlmt_p(v_hlmt) : "hlmt.hlmt_p(v_hlmt) " + "CommonSymbols.NIL != hlmt.hlmt_p(v_hlmt) " + v_hlmt;
    ...
    public static SubLObject declare_core_file() {
        declareFunction(me, "core_raw_constant_p", "CORE-RAW-CONSTANT-P", 1, 0, false);
        declareFunction(me, "non_core_raw_constant_p", "NON-CORE-RAW-CONSTANT-P", 1, 0, false);
        declareFunction(me, "core_raw_el_formula_p", "CORE-RAW-EL-FORMULA-P", 1, 0, false);
        declareFunction(me, "non_core_raw_el_formula_p", "NON-CORE-RAW-EL-FORMULA-P", 1, 0, false);
        declareFunction(me, "compute_core_raw_constants", "COMPUTE-CORE-RAW-CONSTANTS", 0, 0, false);
        declareFunction(me, "all_core_raw_constants", "ALL-CORE-RAW-CONSTANTS", 0, 0, false);
        declareFunction(me, "compute_core_skolems", "COMPUTE-CORE-SKOLEMS", 0, 0, false);
        declareFunction(me, "all_core_skolems", "ALL-CORE-SKOLEMS", 0, 0, false);
        declareFunction(me, "compute_core_constants", "COMPUTE-CORE-CONSTANTS", 0, 0, false);
        declareFunction(me, "all_core_constants", "ALL-CORE-CONSTANTS", 0, 0, false);
        declareFunction(me, "initialize_core_constant_table", "INITIALIZE-CORE-CONSTANT-TABLE", 0, 0, false);
        declareFunction(me, "cached_core_constant_p", "CACHED-CORE-CONSTANT-P", 1, 0, false);
        declareFunction(me, "cached_non_core_constant_p", "CACHED-NON-CORE-CONSTANT-P", 1, 0, false);
        declareFunction(me, "compute_core_narts", "COMPUTE-CORE-NARTS", 0, 0, false);
        declareFunction(me, "core_nart_p", "CORE-NART-P", 1, 0, false);
        declareFunction(me, "core_nart_formula_p", "CORE-NART-FORMULA-P", 1, 0, false);
        declareFunction(me, "all_core_narts", "ALL-CORE-NARTS", 0, 0, false);
        declareFunction(me, "compute_core_forts", "COMPUTE-CORE-FORTS", 0, 0, false);
        declareFunction(me, "all_core_forts", "ALL-CORE-FORTS", 0, 0, false);
        declareFunction(me, "initialize_core_fort_table", "INITIALIZE-CORE-FORT-TABLE", 0, 0, false);
        declareFunction(me, "cached_core_fort_p", "CACHED-CORE-FORT-P", 1, 0, false);
        declareFunction(me, "cached_non_core_fort_p", "CACHED-NON-CORE-FORT-P", 1, 0, false);
        declareFunction(me, "core_sentence_p", "CORE-SENTENCE-P", 1, 0, false);
        declareFunction(me, "core_assertion_p", "CORE-ASSERTION-P", 1, 0, false);
        declareFunction(me, "non_core_assertion_p", "NON-CORE-ASSERTION-P", 1, 0, false);
        declareFunction(me, "compute_core_rules", "COMPUTE-CORE-RULES", 0, 0, false);
        declareFunction(me, "all_core_rules", "ALL-CORE-RULES", 0, 0, false);
        declareFunction(me, "identify_core_kb", "IDENTIFY-CORE-KB", 0, 0, false);
        declareFunction(me, "clear_core_state", "CLEAR-CORE-STATE", 0, 0, false);
        declareFunction(me, "compute_core_kb", "COMPUTE-CORE-KB", 0, 1, false);
        declareFunction(me, "compute_core_definitional_info", "COMPUTE-CORE-DEFINITIONAL-INFO", 0, 0, false);
        declareFunction(me, "clear_core_definitional_info", "CLEAR-CORE-DEFINITIONAL-INFO", 0, 0, false);
        declareFunction(me, "remove_core_definitional_info", "REMOVE-CORE-DEFINITIONAL-INFO", 1, 0, false);
        declareFunction(me, "core_definitional_info_internal", "CORE-DEFINITIONAL-INFO-INTERNAL", 1, 0, false);
        declareFunction(me, "core_definitional_info", "CORE-DEFINITIONAL-INFO", 1, 0, false);
        declareFunction(me, "minimal_implied_core_values", "MINIMAL-IMPLIED-CORE-VALUES", 5, 0, false);
        declareFunction(me, "core_cycle_set", "CORE-CYCLE-SET", 3, 0, false);
        declareFunction(me, "clear_core_mt_definitional_info", "CLEAR-CORE-MT-DEFINITIONAL-INFO", 0, 0, false);
        declareFunction(me, "remove_core_mt_definitional_info", "REMOVE-CORE-MT-DEFINITIONAL-INFO", 1, 0, false);
        declareFunction(me, "core_mt_definitional_info_internal", "CORE-MT-DEFINITIONAL-INFO-INTERNAL", 1, 0, false);
        declareFunction(me, "core_mt_definitional_info", "CORE-MT-DEFINITIONAL-INFO", 1, 0, false);
        declareFunction(me, "minimal_core_mt_implied_core_values", "MINIMAL-CORE-MT-IMPLIED-CORE-VALUES", 5, 0, false);
        declareFunction(me, "load_core_kb", "LOAD-CORE-KB", 1, 0, false);
        declareFunction(me, "write_core_kb", "WRITE-CORE-KB", 1, 0, false);
        declareFunction(me, "write_core_definition", "WRITE-CORE-DEFINITION", 1, 1, false);
        declareFunction(me, "low_create_nart", "LOW-CREATE-NART", 1, 0, false);
        declareFunction(me, "low_assert_gaf", "LOW-ASSERT-GAF", 2, 2, false);
        declareFunction(me, "ensure_bootstrapping_kb", "ENSURE-BOOTSTRAPPING-KB", 0, 0, false);
        declareFunction(me, "low_assert_literal", "LOW-ASSERT-LITERAL", 2, 2, false);
        declareFunction(me, "low_assert_cnf", "LOW-ASSERT-CNF", 2, 2, false);
        declareFunction(me, "low_assert_cnf_internal", "LOW-ASSERT-CNF-INTERNAL", 4, 1, false);
        declareFunction(me, "core_kb_initialization", "CORE-KB-INITIALIZATION", 1, 0, false);
        declareFunction(me, "core_kb_start_bootstrapping", "CORE-KB-START-BOOTSTRAPPING", 0, 0, false);
        declareFunction(me, "core_kb_start_definitions", "CORE-KB-START-DEFINITIONS", 0, 0, false);
        declareFunction(me, "core_kb_finish_definitions", "CORE-KB-FINISH-DEFINITIONS", 0, 0, false);
        declareFunction(me, "core_kb_finish_bootstrapping", "CORE-KB-FINISH-BOOTSTRAPPING", 0, 0, false);
        declareFunction(me, "core_kb_finalization", "CORE-KB-FINALIZATION", 0, 0, false);
        declareFunction(me, "write_core_constant_creation", "WRITE-CORE-CONSTANT-CREATION", 2, 0, false);
        declareFunction(me, "write_core_nart_creation", "WRITE-CORE-NART-CREATION", 2, 0, false);
        declareFunction(me, "write_core_nart_creation_internal", "WRITE-CORE-NART-CREATION-INTERNAL", 3, 0, false);
        declareFunction(me, "write_core_mt_definitional_info_to_stream", "WRITE-CORE-MT-DEFINITIONAL-INFO-TO-STREAM", 1, 1, false);
        declareFunction(me, "write_core_definitional_info_to_stream", "WRITE-CORE-DEFINITIONAL-INFO-TO-STREAM", 1, 1, false);
        declareFunction(me, "write_core_low_assert", "WRITE-CORE-LOW-ASSERT", 3, 2, false);
        declareFunction(me, "write_core_formula", "WRITE-CORE-FORMULA", 2, 0, false);
        declareFunction(me, "write_core_constant", "WRITE-CORE-CONSTANT", 2, 1, false);
        declareFunction(me, "write_core_nart", "WRITE-CORE-NART", 2, 1, false);
        declareFunction(me, "write_core_fort", "WRITE-CORE-FORT", 2, 1, false);
        declareFunction(me, "write_core_assertion", "WRITE-CORE-ASSERTION", 2, 1, false);
        declareFunction(me, "write_core_hlmt", "WRITE-CORE-HLMT", 2, 1, false);
        declareFunction(me, "write_core_gaf_assert", "WRITE-CORE-GAF-ASSERT", 2, 0, false);
        declareFunction(me, "write_core_bookkeeping_assert", "WRITE-CORE-BOOKKEEPING-ASSERT", 2, 0, false);
        declareFunction(me, "write_core_late_assert", "WRITE-CORE-LATE-ASSERT", 2, 0, false);
        declareFunction(me, "write_core_rule_assert_backward_if_forward", "WRITE-CORE-RULE-ASSERT-BACKWARD-IF-FORWARD", 2, 0, false);
        declareFunction(me, "write_core_rule_reassert_as_forward_if_forward", "WRITE-CORE-RULE-REASSERT-AS-FORWARD-IF-FORWARD", 2, 0, false);
        declareFunction(me, "write_core_rule_meta_assertion_gafs", "WRITE-CORE-RULE-META-ASSERTION-GAFS", 2, 0, false);
        declareFunction(me, "write_core_early_extent_to_stream", "WRITE-CORE-EARLY-EXTENT-TO-STREAM", 1, 1, false);
        declareFunction(me, "write_core_after_adding_info_to_stream", "WRITE-CORE-AFTER-ADDING-INFO-TO-STREAM", 1, 1, false);
        declareFunction(me, "write_core_decontextualization_info_to_stream", "WRITE-CORE-DECONTEXTUALIZATION-INFO-TO-STREAM", 1, 1, false);
        declareFunction(me, "write_core_early_extent_to_stream_int", "WRITE-CORE-EARLY-EXTENT-TO-STREAM-INT", 3, 0, false);
        declareFunction(me, "write_core_additional_gaf_info_to_stream", "WRITE-CORE-ADDITIONAL-GAF-INFO-TO-STREAM", 1, 1, false);
        declareFunction(me, "core_kb_delay_assertionP", "CORE-KB-DELAY-ASSERTION?", 1, 0, false);
        declareFunction(me, "not_assertible_assertion_p", "NOT-ASSERTIBLE-ASSERTION-P", 1, 0, false);
        declareFunction(me, "clear_late_assertions", "CLEAR-LATE-ASSERTIONS", 0, 0, false);
        declareFunction(me, "core_kb_note_assertion_delayed", "CORE-KB-NOTE-ASSERTION-DELAYED", 1, 0, false);
        declareFunction(me, "write_late_assertions_to_stream", "WRITE-LATE-ASSERTIONS-TO-STREAM", 0, 1, false);
        declareFunction(me, "core_additional_gaf_predicate", "CORE-ADDITIONAL-GAF-PREDICATE", 1, 0, false);
        declareFunction(me, "core_rule_formula", "CORE-RULE-FORMULA", 1, 0, false);
        declareFunction(me, "constant_core_kb_link_sentences", "CONSTANT-CORE-KB-LINK-SENTENCES", 1, 0, false);
        return NIL;
    }
