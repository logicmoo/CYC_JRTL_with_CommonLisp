...
public final class stacks extends SubLTranslatedFile {
    ...
    public static SubLObject stack_p(final SubLObject v_object) {
        return v_object.getClass() == stacks.$stack_native.class ? T : NIL;
    }

    public static SubLObject stack_struc_num(final SubLObject v_object) {
        assert NIL != stack_p(v_object) : "stacks.stack_p(v_object) " + "CommonSymbols.NIL != stacks.stack_p(v_object) " + v_object;
    ...
    public static SubLObject make_stack(SubLObject arglist) {
        ...
        final SubLObject v_new = new stacks.$stack_native();
        SubLObject next;
    ...
    public static SubLObject locked_stack_p(final SubLObject v_object) {
        return v_object.getClass() == stacks.$locked_stack_native.class ? T : NIL;
    }

    public static SubLObject locked_stack_struc_lock(final SubLObject v_object) {
        assert NIL != locked_stack_p(v_object) : "stacks.locked_stack_p(v_object) " + "CommonSymbols.NIL != stacks.locked_stack_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_locked_stack(SubLObject arglist) {
        ...
        final SubLObject v_new = new stacks.$locked_stack_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $stack_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(stacks.$stack_native.class, STACK, STACK_P, $list2, $list3, new String[]{ "$num", "$elements" }, $list4, $list5, PRINT_STACK);
        }
    }
    ...
    public static final class $locked_stack_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(stacks.$locked_stack_native.class, LOCKED_STACK, LOCKED_STACK_P, $list34, $list35, new String[]{ "$lock", "$stack" }, $list36, $list37, PRINT_LOCKED_STACK);
        }
    }
