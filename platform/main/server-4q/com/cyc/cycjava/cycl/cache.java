...
import static com.cyc.cycjava.cycl.cache.*;
...
public final class cache extends SubLTranslatedFile {
    ...
    public static SubLObject cache_p(final SubLObject v_object) {
        return v_object.getClass() == cache.$cache_native.class ? T : NIL;
    }

    public static SubLObject cache_capacity(final SubLObject v_object) {
        assert NIL != cache_p(v_object) : "cache.cache_p(v_object) " + "CommonSymbols.NIL != cache.cache_p(v_object) " + v_object;
    ...
    public static SubLObject make_cache(SubLObject arglist) {
        ...
        final SubLObject v_new = new cache.$cache_native();
        SubLObject next;
    ...
    public static SubLObject cache_entry_p(final SubLObject v_object) {
        return v_object.getClass() == cache.$cache_entry_native.class ? T : NIL;
    }

    public static SubLObject cache_entry_newer(final SubLObject v_object) {
        assert NIL != cache_entry_p(v_object) : "cache.cache_entry_p(v_object) " + "CommonSymbols.NIL != cache.cache_entry_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_cache_entry(SubLObject arglist) {
        ...
        final SubLObject v_new = new cache.$cache_entry_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $cache_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(cache.$cache_native.class, CACHE, CACHE_P, $list2, $list3, new String[]{ "$capacity", "$map", "$head_entry" }, $list4, $list5, CACHE_PRINT);
        }
    }
    ...
    public static final class $cache_entry_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(cache.$cache_entry_native.class, CACHE_ENTRY, CACHE_ENTRY_P, $list26, $list27, new String[]{ "$newer", "$key", "$value", "$older" }, $list28, $list29, CACHE_ENTRY_PRINT);
        }
    }
