...
public final class owl_utilities extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLString $str0$http___www_w3_org_2002_07_owl_ = makeString("http://www.w3.org/2002/07/owl#");
    ...
    private static final SubLSymbol $sym6$_OWL_VERBOSE__ = makeSymbol("*OWL-VERBOSE?*");
    ...
    public static final SubLList $list10 = list(makeString("~%"));
    ...
    public static final SubLSymbol OWL_EXPANDED_NAME = makeSymbol("OWL-EXPANDED-NAME");
    ...
    private static final SubLObject $$termActedOnDuringOWLImport = reader_make_constant_shell(makeString("termActedOnDuringOWLImport"));
    ...
    public static SubLObject owl_note(final SubLObject macroform, final SubLObject environment) {
        ...
        final SubLObject args;
        current = args = current.rest();
        return listS(PWHEN, $sym6$_OWL_VERBOSE__, listS(FORMAT, T, listS(CCONCATENATE, $str9$__, format_str, $list10), append(args, NIL)), $list11);
    }
    ...
    public static SubLObject declare_owl_utilities_file() {
        declareFunction(me, "clear_owl_caches", "CLEAR-OWL-CACHES", 0, 0, false);
        declareFunction(me, "owl_namespace", "OWL-NAMESPACE", 0, 0, false);
        declareFunction(me, "owl11_namespace", "OWL11-NAMESPACE", 0, 0, false);
        declareFunction(me, "owl_namespace_uriP", "OWL-NAMESPACE-URI?", 1, 0, false);
        declareFunction(me, "owl_warnP", "OWL-WARN?", 0, 0, false);
        declareMacro(me, "owl_warn", "OWL-WARN");
        declareMacro(me, "owl_note", "OWL-NOTE");
        declareFunction(me, "clear_owl_name", "CLEAR-OWL-NAME", 0, 0, false);
        declareFunction(me, "remove_owl_name", "REMOVE-OWL-NAME", 1, 0, false);
        declareFunction(me, "owl_name_internal", "OWL-NAME-INTERNAL", 1, 0, false);
        declareFunction(me, "owl_name", "OWL-NAME", 1, 0, false);
        declareFunction(me, "clear_owl_expanded_name", "CLEAR-OWL-EXPANDED-NAME", 0, 0, false);
        declareFunction(me, "remove_owl_expanded_name", "REMOVE-OWL-EXPANDED-NAME", 1, 0, false);
        declareFunction(me, "owl_expanded_name_internal", "OWL-EXPANDED-NAME-INTERNAL", 1, 0, false);
        declareFunction(me, "owl_expanded_name", "OWL-EXPANDED-NAME", 1, 0, false);
        declareFunction(me, "clear_owl11_name", "CLEAR-OWL11-NAME", 0, 0, false);
        declareFunction(me, "remove_owl11_name", "REMOVE-OWL11-NAME", 1, 0, false);
        declareFunction(me, "owl11_name_internal", "OWL11-NAME-INTERNAL", 1, 0, false);
        declareFunction(me, "owl11_name", "OWL11-NAME", 1, 0, false);
        declareFunction(me, "clear_owl11_expanded_name", "CLEAR-OWL11-EXPANDED-NAME", 0, 0, false);
        declareFunction(me, "remove_owl11_expanded_name", "REMOVE-OWL11-EXPANDED-NAME", 1, 0, false);
        declareFunction(me, "owl11_expanded_name_internal", "OWL11-EXPANDED-NAME-INTERNAL", 1, 0, false);
        declareFunction(me, "owl11_expanded_name", "OWL11-EXPANDED-NAME", 1, 0, false);
        declareFunction(me, "owl_create_wff", "OWL-CREATE-WFF", 5, 1, false);
        declareFunction(me, "owl_create_new_constant_wff", "OWL-CREATE-NEW-CONSTANT-WFF", 5, 0, false);
        declareFunction(me, "owl_create_new_constant_wff_non_rkf", "OWL-CREATE-NEW-CONSTANT-WFF-NON-RKF", 5, 0, false);
        declareFunction(me, "owl_assert_wff_internal", "OWL-ASSERT-WFF-INTERNAL", 2, 3, false);
        declareFunction(me, "owl_assert_wff", "OWL-ASSERT-WFF", 2, 3, false);
        declareFunction(me, "implementation_uriP", "IMPLEMENTATION-URI?", 1, 0, false);
        declareFunction(me, "rdf_graph_xmlns_plist", "RDF-GRAPH-XMLNS-PLIST", 1, 0, false);
        declareFunction(me, "rdf_abbrev_prefix_and_name_for_uri", "RDF-ABBREV-PREFIX-AND-NAME-FOR-URI", 2, 0, false);
        declareFunction(me, "rdf_graph_node_abbreviation_string", "RDF-GRAPH-NODE-ABBREVIATION-STRING", 2, 0, false);
        declareFunction(me, "owl_importer_use_rkfP", "OWL-IMPORTER-USE-RKF?", 0, 0, false);
        declareFunction(me, "owl_assert_low_wff", "OWL-ASSERT-LOW-WFF", 2, 0, false);
        declareFunction(me, "note_sentence_asserted", "NOTE-SENTENCE-ASSERTED", 3, 0, false);
        declareFunction(me, "note_term_acted_on_during_import_internal", "NOTE-TERM-ACTED-ON-DURING-IMPORT-INTERNAL", 2, 1, false);
        declareFunction(me, "note_term_acted_on_during_import", "NOTE-TERM-ACTED-ON-DURING-IMPORT", 2, 1, false);
        declareFunction(me, "rdf_graph_root_classes", "RDF-GRAPH-ROOT-CLASSES", 1, 0, false);
        declareFunction(me, "rdf_graph_root_concepts", "RDF-GRAPH-ROOT-CONCEPTS", 1, 0, false);
        declareFunction(me, "rdf_graph_object_properties_without_ranges", "RDF-GRAPH-OBJECT-PROPERTIES-WITHOUT-RANGES", 1, 0, false);
        declareFunction(me, "count_outgoing_sameas_links", "COUNT-OUTGOING-SAMEAS-LINKS", 1, 0, false);
        declareFunction(me, "count_all_sameas_links", "COUNT-ALL-SAMEAS-LINKS", 1, 0, false);
        declareFunction(me, "classify_sameas_links_by_namespace", "CLASSIFY-SAMEAS-LINKS-BY-NAMESPACE", 1, 0, false);
        declareFunction(me, "classify_sameas_links_by_domain", "CLASSIFY-SAMEAS-LINKS-BY-DOMAIN", 1, 0, false);
        declareFunction(me, "find_weird_sameas_links", "FIND-WEIRD-SAMEAS-LINKS", 1, 0, false);
        declareFunction(me, "owl_intersection_of_node_p", "OWL-INTERSECTION-OF-NODE-P", 2, 0, false);
        declareFunction(me, "owl_union_of_node_p", "OWL-UNION-OF-NODE-P", 2, 0, false);
        declareFunction(me, "owl_complement_of_node_p", "OWL-COMPLEMENT-OF-NODE-P", 2, 0, false);
        declareFunction(me, "owl_restriction_node_p", "OWL-RESTRICTION-NODE-P", 2, 0, false);
        declareFunction(me, "owl_one_of_node_p", "OWL-ONE-OF-NODE-P", 2, 0, false);
        declareFunction(me, "owl_debug_show_options", "OWL-DEBUG-SHOW-OPTIONS", 1, 0, false);
        declareFunction(me, "owl_debug_show_graph", "OWL-DEBUG-SHOW-GRAPH", 1, 0, false);
        declareFunction(me, "owl_debug_show_graph_info", "OWL-DEBUG-SHOW-GRAPH-INFO", 1, 0, false);
        declareFunction(me, "owl_debug_show_triples", "OWL-DEBUG-SHOW-TRIPLES", 1, 0, false);
        declareFunction(me, "owl_import_file_round_trip_test", "OWL-IMPORT-FILE-ROUND-TRIP-TEST", 1, 5, false);
        declareFunction(me, "owl_import_file_round_trip_test_owl_dl", "OWL-IMPORT-FILE-ROUND-TRIP-TEST-OWL-DL", 1, 5, false);
        declareFunction(me, "owl_import_file_quiescence_test", "OWL-IMPORT-FILE-QUIESCENCE-TEST", 1, 5, false);
        declareFunction(me, "owl_import_file_quiescence_test_owl_dl", "OWL-IMPORT-FILE-QUIESCENCE-TEST-OWL-DL", 1, 5, false);
        return NIL;
    }
