...
import com.cyc.cycjava.cycl.owl.owl_importer2.$owl_importer2_native;
...
public final class owl_importer2 extends SubLTranslatedFile {
    ...
    public static SubLObject owl_imp2_id(final SubLObject v_object) {
        assert NIL != owl_importer2_p(v_object) : "owl_importer2.owl_importer2_p error :" + v_object;
    ...
    public static final class $owl_importer2_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($owl_importer2_native.class, OWL_IMPORTER2, OWL_IMPORTER2_P, $list92, $list93, new String[]{ "$id", "$uri", "$file", "$graph", "$cyclist", "$import", "$ontologies", "$terms", "$sentences", "$stats", "$options", "$thread" }, $list94, $list95, PRINT_OWL_IMPORTER2);
        }
    }
