...
public final class cb_owl_to_cycl extends SubLTranslatedFile {
    ...
    public static final SubLString $str1$cb_owl_to_cycl_html = makeString("cb-owl-to-cycl.html");

    public static final SubLString $$$OWL_Importer = makeString("OWL Importer");

    public static final SubLString $$$Import_an_OWL_ontology = makeString("Import an OWL ontology");
    ...
    private static final SubLObject $const46$owl_Ontology = reader_make_constant_shell(makeString("owl:Ontology"));
    ...
    public static SubLObject declare_cb_owl_to_cycl_file() {
        declareFunction(me, "cb_owl_import_old", "CB-OWL-IMPORT-OLD", 0, 1, false);
        declareFunction(me, "handle_owl_to_cycl_input", "HANDLE-OWL-TO-CYCL-INPUT", 1, 0, false);
        declareFunction(me, "cb_start_owl_import", "CB-START-OWL-IMPORT", 1, 0, false);
        declareFunction(me, "cb_show_owl_importer", "CB-SHOW-OWL-IMPORTER", 1, 0, false);
        declareFunction(me, "cb_show_owl_importer_internal", "CB-SHOW-OWL-IMPORTER-INTERNAL", 2, 0, false);
        declareFunction(me, "owl_importer_time_so_far", "OWL-IMPORTER-TIME-SO-FAR", 1, 0, false);
        declareFunction(me, "cb_link_show_owl_importer", "CB-LINK-SHOW-OWL-IMPORTER", 1, 2, false);
        return NIL;
    }
