...
import static com.cyc.cycjava.cycl.owl.owl_to_cycl.*;
...
public final class owl_to_cycl extends SubLTranslatedFile {
    ...
    public static SubLObject owl_pred_info_p(final SubLObject v_object) {
        return v_object.getClass() == owl_to_cycl.$owl_pred_info_native.class ? T : NIL;
    }

    public static SubLObject opi_cyc_name(final SubLObject v_object) {
        assert NIL != owl_pred_info_p(v_object) : "owl_to_cycl.owl_pred_info_p(v_object) " + "CommonSymbols.NIL != owl_to_cycl.owl_pred_info_p(v_object) " + v_object;
    ...
    public static SubLObject make_owl_pred_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new owl_to_cycl.$owl_pred_info_native();
        SubLObject next;
    ...
    public static SubLObject owl_import_parameters_p(final SubLObject v_object) {
        return v_object.getClass() == owl_to_cycl.$owl_import_parameters_native.class ? T : NIL;
    }

    public static SubLObject oip_ontology(final SubLObject v_object) {
        assert NIL != owl_import_parameters_p(v_object) : "owl_to_cycl.owl_import_parameters_p(v_object) " + "CommonSymbols.NIL != owl_to_cycl.owl_import_parameters_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_owl_import_parameters(SubLObject arglist) {
        ...
        final SubLObject v_new = new owl_to_cycl.$owl_import_parameters_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject owl_term_info_p(final SubLObject v_object) {
        return v_object.getClass() == owl_to_cycl.$owl_term_info_native.class ? T : NIL;
    }

    public static SubLObject oti_cyc_name(final SubLObject v_object) {
        assert NIL != owl_term_info_p(v_object) : "owl_to_cycl.owl_term_info_p(v_object) " + "CommonSymbols.NIL != owl_to_cycl.owl_term_info_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_owl_term_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new owl_to_cycl.$owl_term_info_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject owl_importer_p(final SubLObject v_object) {
        return v_object.getClass() == owl_to_cycl.$owl_importer_native.class ? T : NIL;
    }

    public static SubLObject owl_imp_id(final SubLObject v_object) {
        assert NIL != owl_importer_p(v_object) : "owl_to_cycl.owl_importer_p(v_object) " + "CommonSymbols.NIL != owl_to_cycl.owl_importer_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_owl_importer(SubLObject arglist) {
        ...
        final SubLObject v_new = new owl_to_cycl.$owl_importer_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $owl_pred_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(owl_to_cycl.$owl_pred_info_native.class, OWL_PRED_INFO, OWL_PRED_INFO_P, $list125, $list126, new String[]{ "$cyc_name", "$comment", "$domains", "$range", "$plist" }, $list127, $list128, PRINT_OWL_PRED_INFO);
        }
    }
    ...
    public static final class $owl_term_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(owl_to_cycl.$owl_term_info_native.class, OWL_TERM_INFO, OWL_TERM_INFO_P, $list533, $list534, new String[]{ "$cyc_name", "$comment", "$superclasses", "$disjoint_classes", "$plist" }, $list535, $list536, PRINT_OWL_TERM_INFO);
        }
    }
    ...
    public static final class $owl_importer_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(owl_to_cycl.$owl_importer_native.class, OWL_IMPORTER, OWL_IMPORTER_P, $list642, $list643, new String[]{ "$id", "$progress", "$error_info", "$import_parameters", "$thread" }, $list644, $list645, PRINT_OWL_IMPORTER);
        }
    }
