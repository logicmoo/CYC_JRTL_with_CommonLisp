...
public final class dictionary_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject synchronized_dictionary_p(final SubLObject v_object) {
        return v_object.getClass() == dictionary_utilities.$synchronized_dictionary_native.class ? T : NIL;
    }

    public static SubLObject synchronized_dictionary_dictionary(final SubLObject v_object) {
        assert NIL != synchronized_dictionary_p(v_object) : "dictionary_utilities.synchronized_dictionary_p(v_object) " + "CommonSymbols.NIL != dictionary_utilities.synchronized_dictionary_p(v_object) " + v_object;
    ...
    public static SubLObject make_synchronized_dictionary(SubLObject arglist) {
        ...
        final SubLObject v_new = new dictionary_utilities.$synchronized_dictionary_native();
        SubLObject next;
    ...
    public static final class $synchronized_dictionary_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(dictionary_utilities.$synchronized_dictionary_native.class, SYNCHRONIZED_DICTIONARY, SYNCHRONIZED_DICTIONARY_P, $list64, $list65, new String[]{ "$dictionary", "$lock" }, $list66, $list67, PRINT_SYNCHRONIZED_DICTIONARY);
        }
    }
