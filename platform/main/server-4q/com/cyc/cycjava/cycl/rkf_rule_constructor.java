...
import com.cyc.cycjava.cycl.rkf_rule_constructor;
...
import static com.cyc.cycjava.cycl.rkf_rule_constructor.*;
...
public final class rkf_rule_constructor extends SubLTranslatedFile {
    ...
    public static SubLObject rc_lhs_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_rule_constructor.$rc_lhs_native.class ? T : NIL;
    }

    public static SubLObject rc_lhs_id(final SubLObject v_object) {
        assert NIL != rc_lhs_p(v_object) : "rkf_rule_constructor.rc_lhs_p(v_object) " + "CommonSymbols.NIL != rkf_rule_constructor.rc_lhs_p(v_object) " + v_object;
    ...
    public static SubLObject make_rc_lhs(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_rule_constructor.$rc_lhs_native();
        SubLObject next;
    ...
    public static SubLObject rc_rhs_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_rule_constructor.$rc_rhs_native.class ? T : NIL;
    }

    public static SubLObject rc_rhs_id(final SubLObject v_object) {
        assert NIL != rc_rhs_p(v_object) : "rkf_rule_constructor.rc_rhs_p(v_object) " + "CommonSymbols.NIL != rkf_rule_constructor.rc_rhs_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_rc_rhs(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_rule_constructor.$rc_rhs_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject rc_state_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_rule_constructor.$rc_state_native.class ? T : NIL;
    }

    public static SubLObject rc_state_id(final SubLObject v_object) {
        assert NIL != rc_state_p(v_object) : "rkf_rule_constructor.rc_state_p(v_object) " + "CommonSymbols.NIL != rkf_rule_constructor.rc_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_rc_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_rule_constructor.$rc_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $rc_lhs_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_rule_constructor.$rc_lhs_native.class, RC_LHS, RC_LHS_P, $list7, $list8, new String[]{ "$id", "$nl_sentence", "$constraints", "$terms", "$cycl" }, $list9, $list10, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $rc_rhs_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_rule_constructor.$rc_rhs_native.class, RC_RHS, RC_RHS_P, $list40, $list41, new String[]{ "$id", "$nl_sentence", "$constraints", "$existential_term", "$cycl" }, $list42, $list43, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $rc_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_rule_constructor.$rc_state_native.class, RC_STATE, RC_STATE_P, $list63, $list64, new String[]{ "$id", "$text", "$interaction", "$if_scenario", "$then_scenario", "$lhs", "$rhs", "$parsing_mt", "$generation_mt", "$domain_mt", "$domain_interaction_mt", "$var_map", "$exceptions" }, $list65, $list66, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
