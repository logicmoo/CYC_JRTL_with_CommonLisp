...
public final class at_utilities
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject arg_n_predicate(final SubLObject n)
  {
    ...
    {
      return $const0$arg1Isa;
    }
    if( n.eql( TWO_INTEGER ) )
    {
      return $const1$arg2Isa;
    }
    if( n.eql( THREE_INTEGER ) )
    {
      return $const2$arg3Isa;
    }
    if( n.eql( FOUR_INTEGER ) )
    {
      return $const3$arg4Isa;
    }
    if( n.eql( FIVE_INTEGER ) )
    {
      return $const4$arg5Isa;
    }
    return NIL;
  }
  ...
  {
    return conses_high.rassoc( generic_arg, $generic_arg_store$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED ).first();
  }
  ...
  {
    return list_utilities.sublisp_boolean( conses_high.rassoc( v_object, $generic_arg_store$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED ) );
  }
  ...
  public static SubLObject get_generic_arg(final SubLObject number)
  {
    ...
    final SubLObject v_new = Symbols.make_keyword( Sequences.cconcatenate( $str7$ARG, PrintLow.format( NIL, $str8$_S, number ) ) );
  ...
  public static SubLObject generic_arg_num(final SubLObject v_object)
  {
    ...
    final SubLObject argnum = string_utilities.substring( Symbols.symbol_name( v_object ), THREE_INTEGER, UNPROVIDED );
    final SubLObject num = reader.read_from_string( argnum, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  public static SubLObject generic_argP(final SubLObject v_object)
  {
    ...
    if( NIL != list_utilities.lengthLE( Symbols.symbol_name( v_object ), THREE_INTEGER, UNPROVIDED ) )
    {
      return NIL;
    }
    ...
    final SubLObject generic_argP = makeBoolean( $str7$ARG.equalp( arg ) && NIL != string_utilities.digit_stringP( argnum_string ) );
    if( NIL != generic_argP )
    {
      store_generic_arg( v_object, reader.read_from_string( argnum_string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    return generic_argP;
  }
  ...
  public static SubLObject inter_arg_isa_pred(final SubLObject ind_arg, final SubLObject dep_arg)
  {
    if( ind_arg.eql( ONE_INTEGER ) )
    {
      ...
      {
        return $const9$interArgIsa1_2;
      }
      if( dep_arg.eql( THREE_INTEGER ) )
      {
        return $const10$interArgIsa1_3;
      }
      if( dep_arg.eql( FOUR_INTEGER ) )
      {
        return $const11$interArgIsa1_4;
      }
      if( dep_arg.eql( FIVE_INTEGER ) )
      {
        return $const12$interArgIsa1_5;
      }
      el_utilities.el_error( THREE_INTEGER, $str13$invalid_arg_isa_pred_index___s__s, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( TWO_INTEGER ) )
    {
      if( dep_arg.eql( ONE_INTEGER ) )
      {
        return $const14$interArgIsa2_1;
      }
      if( dep_arg.eql( THREE_INTEGER ) )
      {
        return $const15$interArgIsa2_3;
      }
      if( dep_arg.eql( FOUR_INTEGER ) )
      {
        return $const16$interArgIsa2_4;
      }
      if( dep_arg.eql( FIVE_INTEGER ) )
      {
        return $const17$interArgIsa2_5;
      }
      el_utilities.el_error( THREE_INTEGER, $str13$invalid_arg_isa_pred_index___s__s, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( THREE_INTEGER ) )
    {
      if( dep_arg.eql( ONE_INTEGER ) )
      {
        return $const18$interArgIsa3_1;
      }
      if( dep_arg.eql( TWO_INTEGER ) )
      {
        return $const19$interArgIsa3_2;
      }
      if( dep_arg.eql( FOUR_INTEGER ) )
      {
        return $const20$interArgIsa3_4;
      }
      if( dep_arg.eql( FIVE_INTEGER ) )
      {
        return $const21$interArgIsa3_5;
      }
      el_utilities.el_error( THREE_INTEGER, $str13$invalid_arg_isa_pred_index___s__s, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( FOUR_INTEGER ) )
    {
      if( dep_arg.eql( ONE_INTEGER ) )
      {
        return $const22$interArgIsa4_1;
      }
      if( dep_arg.eql( TWO_INTEGER ) )
      {
        return $const23$interArgIsa4_2;
      }
      if( dep_arg.eql( THREE_INTEGER ) )
      {
        return $const24$interArgIsa4_3;
      }
      if( dep_arg.eql( FIVE_INTEGER ) )
      {
        return $const25$interArgIsa4_5;
      }
      el_utilities.el_error( THREE_INTEGER, $str13$invalid_arg_isa_pred_index___s__s, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( FIVE_INTEGER ) )
    {
      if( dep_arg.eql( ONE_INTEGER ) )
      {
        return $const26$interArgIsa5_1;
      }
      if( dep_arg.eql( TWO_INTEGER ) )
      {
        return $const27$interArgIsa5_2;
      }
      if( dep_arg.eql( THREE_INTEGER ) )
      {
        return $const28$interArgIsa5_3;
      }
      if( dep_arg.eql( FOUR_INTEGER ) )
      {
        return $const29$interArgIsa5_4;
      }
      el_utilities.el_error( THREE_INTEGER, $str13$invalid_arg_isa_pred_index___s__s, ind_arg, dep_arg, UNPROVIDED );
    }
    else
  ...
  public static SubLObject inter_arg_not_isa_pred(final SubLObject ind_arg, final SubLObject dep_arg)
  {
    if( ind_arg.eql( ONE_INTEGER ) )
    {
      if( dep_arg.eql( TWO_INTEGER ) )
      {
        return $const31$interArgNotIsa1_2;
      }
      if( dep_arg.eql( THREE_INTEGER ) )
      {
        return $const32$interArgNotIsa1_3;
      }
      if( dep_arg.eql( FOUR_INTEGER ) )
      {
        return $const33$interArgNotIsa1_4;
      }
      if( dep_arg.eql( FIVE_INTEGER ) )
      {
        return $const34$interArgNotIsa1_5;
      }
      el_utilities.el_error( THREE_INTEGER, $str35$invalid_arg_not_isa_pred_index___, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( TWO_INTEGER ) )
    {
      if( dep_arg.eql( THREE_INTEGER ) )
      {
        return $const36$interArgNotIsa2_3;
      }
      if( dep_arg.eql( FOUR_INTEGER ) )
      {
        return $const37$interArgNotIsa2_4;
      }
      if( dep_arg.eql( FIVE_INTEGER ) )
      {
        return $const38$interArgNotIsa2_5;
      }
      el_utilities.el_error( THREE_INTEGER, $str35$invalid_arg_not_isa_pred_index___, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( THREE_INTEGER ) )
    {
      if( dep_arg.eql( FOUR_INTEGER ) )
      {
        return $const39$interArgNotIsa3_4;
      }
      if( dep_arg.eql( FIVE_INTEGER ) )
      {
        return $const40$interArgNotIsa3_5;
      }
      el_utilities.el_error( THREE_INTEGER, $str35$invalid_arg_not_isa_pred_index___, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( FOUR_INTEGER ) )
    {
      if( dep_arg.eql( FIVE_INTEGER ) )
      {
        return $const41$interArgNotIsa4_5;
      }
      el_utilities.el_error( THREE_INTEGER, $str35$invalid_arg_not_isa_pred_index___, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( FIVE_INTEGER ) )
  ...
  public static SubLObject inter_arg_genl_pred(final SubLObject ind_arg, final SubLObject dep_arg)
  {
    if( ind_arg.eql( ONE_INTEGER ) )
    {
      if( dep_arg.eql( TWO_INTEGER ) )
      {
        return $const42$interArgGenl1_2;
      }
      el_utilities.el_error( THREE_INTEGER, $str43$invalid_arg_genl_pred_index___s__, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( TWO_INTEGER ) )
    {
      if( dep_arg.eql( ONE_INTEGER ) )
      {
        return $const44$interArgGenl2_1;
      }
      if( dep_arg.eql( FOUR_INTEGER ) )
      {
        return $const45$interArgGenl2_4;
      }
      el_utilities.el_error( THREE_INTEGER, $str43$invalid_arg_genl_pred_index___s__, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( THREE_INTEGER ) )
  ...
  public static SubLObject inter_arg_not_genl_pred(final SubLObject ind_arg, final SubLObject dep_arg)
  {
    if( ind_arg.eql( ONE_INTEGER ) )
    {
      if( dep_arg.eql( TWO_INTEGER ) )
      {
        return $const46$interArgNotGenl1_2;
      }
      el_utilities.el_error( THREE_INTEGER, $str47$invalid_arg_not_genl_pred_index__, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( TWO_INTEGER ) )
    {
      el_utilities.el_error( THREE_INTEGER, $str47$invalid_arg_not_genl_pred_index__, ind_arg, dep_arg, UNPROVIDED );
  ...
  public static SubLObject inter_arg_isa_genl_pred(final SubLObject ind_arg, final SubLObject dep_arg)
  {
    if( ind_arg.eql( ONE_INTEGER ) )
    {
      if( dep_arg.eql( TWO_INTEGER ) )
      {
        return $const48$interArgIsaGenl1_2;
      }
      el_utilities.el_error( THREE_INTEGER, $str49$invalid_arg_isa_genl_pred_index__, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( TWO_INTEGER ) )
    {
      if( dep_arg.eql( ONE_INTEGER ) )
      {
        return $const50$interArgIsaGenl2_1;
      }
      if( dep_arg.eql( THREE_INTEGER ) )
      {
        return $const51$interArgIsaGenl2_3;
      }
      el_utilities.el_error( THREE_INTEGER, $str49$invalid_arg_isa_genl_pred_index__, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( THREE_INTEGER ) )
    {
      if( dep_arg.eql( TWO_INTEGER ) )
      {
        return $const52$interArgIsaGenl3_2;
      }
      el_utilities.el_error( THREE_INTEGER, $str49$invalid_arg_isa_genl_pred_index__, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( FOUR_INTEGER ) )
  ...
  public static SubLObject inter_arg_genl_isa_pred(final SubLObject ind_arg, final SubLObject dep_arg)
  {
    if( ind_arg.eql( ONE_INTEGER ) )
    {
      el_utilities.el_error( THREE_INTEGER, $str53$invalid_arg_genl_isa_pred_index__, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( TWO_INTEGER ) )
    {
      if( dep_arg.eql( ONE_INTEGER ) )
      {
        return $const54$interArgGenlIsa2_1;
      }
      el_utilities.el_error( THREE_INTEGER, $str53$invalid_arg_genl_isa_pred_index__, ind_arg, dep_arg, UNPROVIDED );
    }
    else if( ind_arg.eql( THREE_INTEGER ) )
  ...
  {
    return subl_promotions.memberP( symbol, czer_vars.$implication_operators$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED );
  }
  ...
  {
    return isa.isaP( v_object, $const55$TruthFunction, mt_vars.$anect_mt$.getGlobalValue(), UNPROVIDED );
  }
  ...
  public static SubLObject arg_isa_binary_predP(final SubLObject v_object, SubLObject mt)
  {
    ...
    return makeBoolean( NIL != subl_promotions.memberP( v_object, czer_vars.$arg_isa_binary_preds$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED ) || NIL != isa.isaP( v_object,
        $const56$ArgIsaBinaryPredicate, mt, UNPROVIDED ) );
  }
  ...
  public static SubLObject arg_isa_ternary_predP(final SubLObject v_object, SubLObject mt)
  {
    ...
    return makeBoolean( NIL != subl_promotions.memberP( v_object, czer_vars.$arg_isa_ternary_preds$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED ) || NIL != isa.isaP( v_object,
        $const57$ArgIsaTernaryPredicate, mt, UNPROVIDED ) );
  }
  ...
  public static SubLObject arg_isa_predicateP(final SubLObject v_object, SubLObject mt)
  {
    ...
    return makeBoolean( NIL != subl_promotions.memberP( v_object, czer_vars.$arg_isa_binary_preds$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED ) || NIL != subl_promotions.memberP( v_object,
        czer_vars.$arg_isa_ternary_preds$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED ) || NIL != isa.isaP( v_object, $const58$ArgIsaPredicate, mt, UNPROVIDED ) );
  }
  ...
  public static SubLObject arg_genl_binary_predP(final SubLObject v_object, SubLObject mt)
  {
    ...
    return makeBoolean( NIL != subl_promotions.memberP( v_object, czer_vars.$arg_genl_binary_preds$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED ) || NIL != isa.isaP( v_object,
        $const59$ArgGenlBinaryPredicate, mt, UNPROVIDED ) );
  }
  ...
  public static SubLObject arg_genl_ternary_predP(final SubLObject v_object, SubLObject mt)
  {
    ...
    return makeBoolean( NIL != subl_promotions.memberP( v_object, czer_vars.$arg_genl_ternary_preds$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED ) || NIL != isa.isaP( v_object,
        $const60$ArgGenlTernaryPredicate, mt, UNPROVIDED ) );
  }
  ...
  public static SubLObject arg_genl_predicateP(final SubLObject v_object, SubLObject mt)
  {
    ...
    return makeBoolean( NIL != subl_promotions.memberP( v_object, czer_vars.$arg_genl_binary_preds$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED ) || NIL != subl_promotions.memberP( v_object,
        czer_vars.$arg_genl_ternary_preds$.getGlobalValue(), Symbols.symbol_function( $sym6$KBEQ ), UNPROVIDED ) || NIL != isa.isaP( v_object, $const61$ArgGenlPredicate, mt, UNPROVIDED ) );
  }
  ...
  public static SubLObject formula_denoting_functionP(final SubLObject v_object, SubLObject mt)
  {
    ...
    if( NIL != el_utilities.relation_expressionP( v_object ) )
    {
  ...
  public static SubLObject formula_functorP(final SubLObject functor, SubLObject mt)
  {
    ...
    if( NIL != forts.fort_p( functor ) )
    {
      ...
      if( NIL == formula_functorP )
      {
        ...
        for( csome_list_var = kb_accessors.result_isa( functor, mt ), result_isa = NIL, result_isa = csome_list_var.first(); NIL == formula_functorP && NIL != csome_list_var; formula_functorP = el_utilities
            .formula_denoting_collectionP( result_isa ), csome_list_var = csome_list_var.rest(), result_isa = csome_list_var.first() )
        {
        }
      }
  ...
  public static SubLObject sentence_functorP(final SubLObject functor, SubLObject mt)
  {
    ...
    if( NIL != forts.fort_p( functor ) )
    {
      ...
      if( NIL == sentence_functorP )
      {
        SubLObject csome_list_var;
        SubLObject result_isa;
        for( csome_list_var = kb_accessors.result_isa( functor, mt ), result_isa = NIL, result_isa = csome_list_var.first(); NIL == sentence_functorP && NIL != csome_list_var; sentence_functorP = el_utilities
            .sentence_denoting_collectionP( result_isa ), csome_list_var = csome_list_var.rest(), result_isa = csome_list_var.first() )
        {
        }
      }
  ...
  public static SubLObject argn_type_levelP(final SubLObject relation, final SubLObject argnum, SubLObject mt)
  {
    ...
    if( NIL == foundP )
    {
      SubLObject csome_list_var;
      SubLObject type;
      for( csome_list_var = types, type = NIL, type = csome_list_var.first(); NIL == foundP && NIL != csome_list_var; foundP = genls.genlP( type, $const63$Collection, mt, UNPROVIDED ), csome_list_var = csome_list_var
    ...
    if( NIL != v_forts )
    {
      ...
      else
      {
        ...
        try
        {
          ...
          final SubLObject genl_somethingP = ( NIL != forts.fort_p( reln ) ) ? makeBoolean( NIL != genl_predicates.genl_predicates( reln, UNPROVIDED, UNPROVIDED ) || NIL != genl_predicates.genl_inverses( reln,
          ...
          try
          {
            ...
            try
            {
              ...
              at_vars.$at_arg_type$.bind( $kw64$STRONG_FORT, thread );
              if( NIL != isa_okP )
              {
                        ...
                        try
                        {
                          ...
                          try
                          {
                            ...
                            try
                            {
                              ...
                              if( NIL != arg_type.arg_test_okP( reln, fort, argnum, $kw65$ISA ) && ( NIL == at_vars.$at_check_inter_arg_isaP$.getDynamicValue( thread ) || NIL == ind_arg_fort || NIL == ind_argnum
                                  || NIL == arg_type.mal_inter_argP( reln, ind_arg_fort, ind_argnum, fort, argnum, $kw65$ISA ) ) )
                              {
                                isa_candidates = ConsesLow.cons( fort, isa_candidates );
                              }
                            }
                            finally
                            {
                    ...
                    try
                    {
                      ...
                      try
                      {
                        ...
                        try
                        {
                          ...
                          if( NIL != collectionP )
                          {
                            sbhl_marking_methods.sbhl_record_all_forward_true_nodes( sbhl_module_vars.get_sbhl_module( $const66$genls ), fort, UNPROVIDED, UNPROVIDED );
                            sbhl_marking_methods.sbhl_record_node( $const67$Thing, UNPROVIDED );
                          }
                          final SubLObject genl_somethingP_$49 = ( NIL != forts.fort_p( reln ) ) ? makeBoolean( NIL != genl_predicates.genl_predicates( reln, UNPROVIDED, UNPROVIDED ) || NIL != genl_predicates
                              .genl_inverses( reln, UNPROVIDED, UNPROVIDED ) ) : NIL;
                          ...
                          try
                          {
                            ...
                            if( NIL != arg_type.arg_test_okP( reln, fort, argnum, $kw68$GENLS ) )
                            {
  ...
  public static SubLObject term_requires_types_in_relations(final SubLObject v_term, final SubLObject relation_expressions, SubLObject mt, SubLObject minimizeP)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL != minimizeP )
      {
        result_isas = genls.min_cols( ConsesLow.nconc( result_isas, isas ), mt, UNPROVIDED );
        result_genls = genls.min_cols( ConsesLow.nconc( result_genls, v_genls ), mt, UNPROVIDED );
      }
      else
      {
        result_isas = conses_high.nunion( result_isas, isas, UNPROVIDED, UNPROVIDED );
        result_genls = conses_high.nunion( result_genls, v_genls, UNPROVIDED, UNPROVIDED );
      }
      cdolist_list_var = cdolist_list_var.rest();
      relation_expression = cdolist_list_var.first();
    }
  ...
  public static SubLObject term_requires_isa_in_clause(final SubLObject v_term, final SubLObject clause, SubLObject mt)
  {
    ...
    try
    {
      ...
      while ( NIL != cdolist_list_var)
      {
        result = conses_high.nunion( term_requires_isa_in_relation( v_term, literal, mt ), result, UNPROVIDED, UNPROVIDED );
        cdolist_list_var = cdolist_list_var.rest();
        literal = cdolist_list_var.first();
      }
  ...
  public static SubLObject term_requires_isa_in_relation(final SubLObject v_term, final SubLObject relation_expression, SubLObject mt)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        result = Hashtables.gethash( v_term, at_vars.$at_isa_constraints$.getDynamicValue( thread ), UNPROVIDED );
        ...
        try
        {
          ...
          if( NIL != forts.fort_p( at_vars.$at_reln$.getDynamicValue( thread ) ) )
          {
            ...
            try
            {
              ...
              {
                at_vars.$at_argnum$.setDynamicValue( Numbers.add( at_vars.$at_argnum$.getDynamicValue( thread ), ONE_INTEGER ), thread );
                if( NIL != ( ( NIL != subformulasP ) ? cycl_utilities.expression_find( v_term, at_vars.$at_arg$.getDynamicValue( thread ), NIL, Symbols.symbol_function( EQUAL ), UNPROVIDED )
                    : Equality.equal( v_term, at_vars.$at_arg$.getDynamicValue( thread ) ) ) )
                {
  ...
  public static SubLObject term_requires_genl_in_relation(final SubLObject v_term, final SubLObject relation_expression, SubLObject mt)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        result = Hashtables.gethash( v_term, at_vars.$at_genl_constraints$.getDynamicValue( thread ), UNPROVIDED );
        Hashtables.clrhash( at_vars.$at_isa_constraints$.getDynamicValue( thread ) );
        Hashtables.clrhash( at_vars.$at_genl_constraints$.getDynamicValue( thread ) );
      }
      finally
  ...
  public static SubLObject get_sub_expression_for_term_position(final SubLObject term_position, final SubLObject expression)
  {
    ...
    assert NIL != collection_defns.cycl_formulaP( expression ) : expression;
    if( ONE_INTEGER.equal( Sequences.length( term_position ) ) )
    {
      return expression;
    }
    return list_utilities.get_nested_nth( expression, list_utilities.remove_last( conses_high.copy_list( term_position ) ), UNPROVIDED );
  }
  ...
  public static SubLObject term_position_requires_types_in_relation(final SubLObject term_position, final SubLObject expression, SubLObject mt)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          at_vars.$at_argnum$.bind( conses_high.last( term_position, UNPROVIDED ).first(), thread );
          at_vars.$at_reln$.bind( cycl_utilities.formula_arg0( relation_expression ), thread );
          at_vars.$at_formula$.bind( relation_expression, thread );
        ...
        isa_result = Hashtables.gethash( v_term, at_vars.$at_isa_constraints$.getDynamicValue( thread ), UNPROVIDED );
        genls_result = Hashtables.gethash( v_term, at_vars.$at_genl_constraints$.getDynamicValue( thread ), UNPROVIDED );
        Hashtables.clrhash( at_vars.$at_isa_constraints$.getDynamicValue( thread ) );
        Hashtables.clrhash( at_vars.$at_genl_constraints$.getDynamicValue( thread ) );
      }
      finally
    ...
    return Values.values( genls.min_cols( isa_result, mt, UNPROVIDED ), genls.min_cols( genls_result, mt, UNPROVIDED ) );
  }
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          SubLObject cdolist_list_var = el_utilities.literal_args( at_vars.$at_formula$.getDynamicValue( thread ), UNPROVIDED );
          SubLObject v_term = NIL;
          ...
          n = ZERO_INTEGER;
          cdolist_list_var = el_utilities.literal_args( at_vars.$at_formula$.getDynamicValue( thread ), UNPROVIDED );
          v_term = NIL;
          v_term = cdolist_list_var.first();
          while ( NIL != cdolist_list_var)
          {
            ...
            {
              result = ConsesLow.cons( ConsesLow.list( n, genls.min_cols( list_utilities.remove_duplicate_forts( Hashtables.gethash( v_term, at_vars.$at_isa_constraints$.getDynamicValue( thread ), UNPROVIDED ) ), mt,
                  UNPROVIDED ) ), result );
            }
            cdolist_list_var = cdolist_list_var.rest();
            v_term = cdolist_list_var.first();
  ...
  public static SubLObject make_el_query_literal(final SubLObject pred)
  {
    ...
    SubLObject literal = ConsesLow.list( pred );
    if( NIL != el_utilities.valid_arity_p( v_arity ) )
    {
      SubLObject i;
      for( i = NIL, i = ZERO_INTEGER; i.numL( v_arity ); i = Numbers.add( i, ONE_INTEGER ) )
      {
        literal = ConsesLow.cons( czer_utilities.get_nth_canonical_variable( i, $kw71$EL_VAR ), literal );
      }
    }
    ...
    if( NIL != forts.fort_p( relation ) )
    {
      ...
      try
      {
        ...
        if( NIL != fort_types_interface.predicateP( relation ) )
        {
          ...
          try
          {
            mt_relevance_macros.$relevant_mt_function$.bind( $sym72$RELEVANT_MT_IS_SPEC_MT, thread );
            mt_relevance_macros.$mt$.bind( mt, thread );
            genl_predicates.map_spec_preds( relation, $sym73$GATHER_VIA_MAP_PRED_INDEX, UNPROVIDED );
          }
          finally
          {
            mt_relevance_macros.$mt$.rebind( _prev_bind_2, thread );
        ...
        else
        {
          ...
          try
          {
            mt_relevance_macros.$relevant_mt_function$.bind( $sym72$RELEVANT_MT_IS_SPEC_MT, thread );
            mt_relevance_macros.$mt$.bind( mt, thread );
            kb_mapping.map_predicate_extent_index( $sym74$GATHER_ASSERTIONS, relation, $kw75$TRUE, UNPROVIDED );
          }
          finally
          {
            mt_relevance_macros.$mt$.rebind( _prev_bind_2, thread );
  ...
  public static SubLObject gather_via_map_pred_index(final SubLObject predicate)
  {
    ...
    {
      kb_mapping.map_predicate_extent_index( $sym74$GATHER_ASSERTIONS, predicate, $kw75$TRUE, UNPROVIDED );
    }
    return NIL;
  }
  ...
  public static SubLObject some_inter_arg_isa_assertion_somewhere_cache_maybe_remove_int(final SubLObject reln)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      while ( NIL != cdolist_list_var_$93)
      {
        ...
        {
          count = Numbers.add( count, kb_indexing.num_gaf_arg_index( reln, ONE_INTEGER, inter_arg_isa_pred, UNPROVIDED ) );
        }
  ...
  public static SubLObject initialize_some_inter_arg_isa_assertion_somewhere_cache()
  {
    ...
    try
    {
      ...
      try
      {
        utilities_macros.$progress_note$.bind( $str79$Initializing___interArgIsa_cache, thread );
                    ...
                    try
                    {
                      ...
                      while ( NIL == done_var)
                      {
                        ...
                        if( NIL != valid )
                        {
                          ...
                          try
                          {
                            final_index_iterator = kb_mapping_macros.new_final_index_iterator( final_index_spec, $kw81$GAF, $kw75$TRUE, NIL );
  ...
  public static SubLObject some_inter_arg_isa_constraint_somewhereP(final SubLObject reln)
  {
    ...
    if( NIL != fort_types_interface.predicateP( reln ) )
    {
      if( NIL == found_oneP )
      {
        final SubLObject module = sbhl_module_vars.get_sbhl_module( $const82$genlPreds );
        final SubLObject deck_type = ( $kw83$DEPTH == $kw83$DEPTH ) ? $kw84$STACK : $kw85$QUEUE;
        ...
        try
        {
          ...
          try
          {
            ...
            try
            {
              ...
              sbhl_search_vars.$relevant_sbhl_tv_function$.bind( ( NIL != tv_var ) ? $sym86$RELEVANT_SBHL_TV_IS_GENERAL_TV : sbhl_search_vars.$relevant_sbhl_tv_function$.getDynamicValue( thread ), thread );
              if( NIL != tv_var && NIL != sbhl_paranoia.sbhl_object_type_checking_p() && NIL == sbhl_search_vars.sbhl_true_tv_p( tv_var ) )
              {
                final SubLObject pcase_var = sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread );
                if( pcase_var.eql( $kw87$ERROR ) )
                {
                  sbhl_paranoia.sbhl_error( ONE_INTEGER, $str88$_A_is_not_a__A, tv_var, $sym89$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                }
                else if( pcase_var.eql( $kw90$CERROR ) )
                {
                  sbhl_paranoia.sbhl_cerror( ONE_INTEGER, $str91$continue_anyway, $str88$_A_is_not_a__A, tv_var, $sym89$SBHL_TRUE_TV_P, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                }
                else if( pcase_var.eql( $kw92$WARN ) )
                {
                  Errors.warn( $str88$_A_is_not_a__A, tv_var, $sym89$SBHL_TRUE_TV_P );
                }
                else
                {
                  Errors.warn( $str93$_A_is_not_a_valid__sbhl_type_erro, sbhl_paranoia.$sbhl_type_error_action$.getDynamicValue( thread ) );
                  Errors.cerror( $str91$continue_anyway, $str88$_A_is_not_a__A, tv_var, $sym89$SBHL_TRUE_TV_P );
                }
              }
              ...
              try
              {
                                      ...
                                      .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                  {
                                    ...
                                    if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                                    {
                                      ...
                                      try
                                      {
                                        ...
                                        for( iteration_state_$120 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == found_oneP && NIL == dictionary_contents
                                            .do_dictionary_contents_doneP( iteration_state_$120 ); iteration_state_$120 = dictionary_contents.do_dictionary_contents_next( iteration_state_$120 ) )
                                        {
                                          thread.resetMultipleValues();
                ...
                {
                  sbhl_paranoia.sbhl_warn( TWO_INTEGER, $str96$Node__a_does_not_pass_sbhl_type_t, reln, sbhl_module_utilities.get_sbhl_type_test( sbhl_module_vars.get_sbhl_module( UNPROVIDED ) ), UNPROVIDED, UNPROVIDED,
                      UNPROVIDED );
                }
              }
              finally
  ...
  public static SubLObject some_inter_arg_format_assertion_somewhere_cache_maybe_remove_int(final SubLObject reln)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      while ( NIL != cdolist_list_var_$125)
      {
        ...
        {
          count = Numbers.add( count, kb_indexing.num_gaf_arg_index( reln, ONE_INTEGER, inter_arg_format_pred, UNPROVIDED ) );
        }
  ...
  public static SubLObject initialize_some_inter_arg_format_assertion_somewhere_cache()
  {
    ...
    try
    {
      ...
      try
      {
        utilities_macros.$progress_note$.bind( $str98$Initializing___interArgFormat_cac, thread );
        utilities_macros.$progress_start_time$.bind( Time.get_universal_time(), thread );
        utilities_macros.$progress_total$.bind( Sequences.length( list_var ), thread );
        utilities_macros.$progress_sofar$.bind( ZERO_INTEGER, thread );
        utilities_macros.$last_percent_progress_index$.bind( ZERO_INTEGER, thread );
                                ...
                                if( NIL != mt_links )
                                {
                                      ...
                                      .do_dictionary_contents_doneP( iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
                                  {
                                    ...
                                    if( NIL != mt_relevance_macros.relevant_mtP( mt ) )
                                    {
                                      ...
                                      {
                                        sbhl_link_vars.$sbhl_link_mt$.bind( mt, thread );
                                        for( iteration_state_$152 = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( tv_links ) ); NIL == found_oneP && NIL == dictionary_contents
                                            .do_dictionary_contents_doneP( iteration_state_$152 ); iteration_state_$152 = dictionary_contents.do_dictionary_contents_next( iteration_state_$152 ) )
                                        {
                                          thread.resetMultipleValues();
  ...
  {
    return reln_constrained_to_be_collectionP( relation, arg_isa_pred, $const99$GenericArgTemplate );
  }
  ...
  {
    return reln_constrained_to_be_collectionP( relation, arg_isa_pred, $const100$KeywordVariableTemplate );
  }
  ...
  {
    if( NIL != subl_promotions.memberP( pred, czer_vars.$arg_isa_binary_preds$.getGlobalValue(), UNPROVIDED, UNPROVIDED ) || NIL != subl_promotions.memberP( pred, czer_vars.$arg_not_isa_binary_preds$.getGlobalValue(),
        UNPROVIDED, UNPROVIDED ) || NIL != subl_promotions.memberP( pred, czer_vars.$arg_quoted_isa_binary_preds$.getGlobalValue(), UNPROVIDED, UNPROVIDED ) || NIL != subl_promotions.memberP( pred,
            czer_vars.$arg_genl_binary_preds$.getGlobalValue(), UNPROVIDED, UNPROVIDED ) || NIL != subl_promotions.memberP( pred, czer_vars.$arg_format_binary_preds$.getGlobalValue(), UNPROVIDED, UNPROVIDED ) )
    {
      return TWO_INTEGER;
    }
    if( NIL != subl_promotions.memberP( pred, czer_vars.$arg_isa_ternary_preds$.getGlobalValue(), UNPROVIDED, UNPROVIDED ) || NIL != subl_promotions.memberP( pred, czer_vars.$arg_not_isa_ternary_preds$.getGlobalValue(),
        UNPROVIDED, UNPROVIDED ) || NIL != subl_promotions.memberP( pred, czer_vars.$arg_quoted_isa_ternary_preds$.getGlobalValue(), UNPROVIDED, UNPROVIDED ) || NIL != subl_promotions.memberP( pred,
            czer_vars.$arg_genl_ternary_preds$.getGlobalValue(), UNPROVIDED, UNPROVIDED ) || NIL != subl_promotions.memberP( pred, czer_vars.$arg_format_ternary_preds$.getGlobalValue(), UNPROVIDED, UNPROVIDED ) )
    {
      return THREE_INTEGER;
    }
    if( NIL != fort_types_interface.isa_arg_type_binary_predicateP( pred, mt_vars.$anect_mt$.getGlobalValue() ) || NIL != fort_types_interface.isa_arg_quoted_isa_binary_predicateP( pred, mt_vars.$anect_mt$
        .getGlobalValue() ) || NIL != fort_types_interface.isa_arg_format_binary_predicateP( pred, mt_vars.$anect_mt$.getGlobalValue() ) )
    {
      return TWO_INTEGER;
    }
    if( NIL != fort_types_interface.isa_arg_type_ternary_predicateP( pred, mt_vars.$anect_mt$.getGlobalValue() ) || NIL != fort_types_interface.isa_arg_quoted_isa_ternary_predicateP( pred, mt_vars.$anect_mt$
        .getGlobalValue() ) || NIL != fort_types_interface.isa_arg_format_ternary_predicateP( pred, mt_vars.$anect_mt$.getGlobalValue() ) )
    {
      return THREE_INTEGER;
    }
  ...
  public static SubLObject at_mapping_finished()
  {
    ...
    {
      Dynamic.sublisp_throw( $kw104$AT_MAPPING_DONE, NIL );
    }
    return NIL;
  }
  ...
  public static SubLObject at_handle_mal_constraint(final SubLObject constraint)
  {
    ...
    if( NIL == at_vars.$within_at_suggestionP$.getDynamicValue( thread ) )
    {
      final SubLObject at_trace_fn = ( NIL != at_vars.$at_break_on_failureP$.getDynamicValue( thread ) ) ? Symbols.symbol_function( $sym105$AT_ERROR ) : Symbols.symbol_function( $sym106$AT_NOTE );
      ...
      {
        Functions.funcall( at_trace_fn, at_trace_level, $str107$__at_test_fails___s_fails__s_cons, at_vars.$at_reln$.getDynamicValue( thread ), at_vars.$at_pred$.getDynamicValue( thread ), constraint );
      }
      else
      {
        Functions.funcall( at_trace_fn, new SubLObject[] { at_trace_level, $str108$__at_test_fails___s_fails__s_cons, at_vars.$at_arg$.getDynamicValue( thread ), at_vars.$at_pred$.getDynamicValue( thread ), constraint,
          at_vars.$at_argnum$.getDynamicValue( thread ), at_vars.$at_reln$.getDynamicValue( thread )
        } );
      }
  ...
  public static SubLObject at_mal_arg_msg(final SubLObject constraint)
  {
    ...
    if( pcase_var.eql( $kw109$IRREFLEXIVE_PREDICATE ) )
    {
      return predicate_isa_violation_data( constraint, mt_relevance_macros.$mt$.getDynamicValue( thread ) );
    }
    if( pcase_var.eql( $kw110$ASYMMETRIC_PREDICATE ) )
    {
      return predicate_isa_violation_data( constraint, mt_relevance_macros.$mt$.getDynamicValue( thread ) );
    }
    if( pcase_var.eql( $kw111$ANTI_SYMMETRIC_PREDICATE ) )
    {
      return predicate_isa_violation_data( constraint, mt_relevance_macros.$mt$.getDynamicValue( thread ) );
    }
    if( pcase_var.eql( $kw112$ANTI_TRANSITIVE_PREDICATE ) )
    {
      return predicate_isa_violation_data( constraint, mt_relevance_macros.$mt$.getDynamicValue( thread ) );
    }
    if( pcase_var.eql( $kw113$NEGATION_PREDS ) )
    {
      return meta_predicate_violation_data( constraint, mt_relevance_macros.$mt$.getDynamicValue( thread ) );
    }
    if( pcase_var.eql( $kw114$NEGATION_INVERSES ) )
    {
      return meta_predicate_violation_data( constraint, mt_relevance_macros.$mt$.getDynamicValue( thread ) );
    }
  ...
  public static SubLObject predicate_isa_violation_data(final SubLObject col, SubLObject mt)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    return ConsesLow.list( $kw116$PREDICATE_ISA_VIOLATION, at_vars.$at_reln$.getDynamicValue( thread ), col, mt, at_vars.$at_predicate_violations$.getDynamicValue( thread ) );
  }
  ...
  public static SubLObject meta_predicate_violation_data(final SubLObject meta_pred_value, SubLObject mt)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    return ConsesLow.list( $kw117$META_PREDICATE_VIOLATION, at_vars.$at_reln$.getDynamicValue( thread ), at_vars.$at_pred$.getDynamicValue( thread ), meta_pred_value, mt, at_vars.$at_predicate_violations$
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return Sequences.nreverse( Sequences.cconcatenate( wff_vars.$arity_violations$.getDynamicValue( thread ), new SubLObject[] { at_vars.$at_violations$.getDynamicValue( thread ), czer_vars.$semantic_violations$
        .getDynamicValue( thread )
    } ) );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    return makeBoolean( NIL != at_vars.$noting_at_violationsP$.getDynamicValue( thread ) && ( NIL == at_vars.$at_violations$.getDynamicValue( thread ) || NIL != at_vars.$accumulating_at_violationsP$.getDynamicValue(
        thread ) ) );
  }
  ...
  public static SubLObject note_at_violation(final SubLObject note)
  {
    ...
    if( NIL != note_at_violationP() )
    {
      ...
      if( NIL == recursive_violationP( note ) && NIL == conses_high.member( note, at_vars.$at_violations$.getDynamicValue( thread ), Symbols.symbol_function( EQUAL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        at_vars.$at_violations$.setDynamicValue( ConsesLow.cons( note, at_vars.$at_violations$.getDynamicValue( thread ) ), thread );
      }
    }
  ...
  public static SubLObject recursive_violationP(final SubLObject note)
  {
    ...
    if( pcase_var.eql( $kw118$MAL_ARG_WRT_COL_DEFN ) )
    {
      return Equality.eql( conses_high.fifth( note ), $const119$CycLSentence_Assertible );
    }
    if( pcase_var.eql( $kw120$MAL_ARG_WRT_NEC_DEFN ) )
    {
      return Equality.eql( conses_high.third( note ), $const119$CycLSentence_Assertible );
    }
    return NIL;
  }
  ...
  public static SubLObject suggest_formula_fix_for_at_violation(final SubLObject formula, final SubLObject mt)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        {
          wff.note_wff_suggestion( ConsesLow.list( $kw121$CHANGE_MT, formula, mt, accommodating_mts ) );
        }
  ...
  {
    return list_utilities.remove_if_not( Symbols.symbol_function( $sym122$ASSERTION_ARG_VIOLATION_ ), violations, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return list_utilities.remove_if_not( Symbols.symbol_function( $sym123$SEF_VIOLATION_ ), violations, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return list_utilities.remove_if_not( Symbols.symbol_function( $sym124$PREDICATE_VIOLATION_ ), violations, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject assertion_arg_violationP(final SubLObject violation)
  {
    ...
    if( pcase_var.eql( $kw125$MAL_ARG_WRT_IFF_DEFN ) )
    {
      SubLObject current;
      ...
      return makeBoolean( NIL != kb_utilities.kbeq( defn, $sym127$CYC_ASSERTION ) || NIL != assertion_collectionP( col, mt ) );
    }
    return NIL;
  }
  ...
  public static SubLObject assertion_collectionP(final SubLObject thing, SubLObject mt)
  {
    ...
    if( thing.eql( $const128$CycLAssertion ) )
    {
      return T;
    }
    SubLObject v_boolean = NIL;
    v_boolean = genls.genlP( thing, $const128$CycLAssertion, mt, UNPROVIDED );
    return v_boolean;
  }
  ...
  {
    final SubLObject pcase_var = violation_type( violation );
    if( pcase_var.eql( $kw129$MAL_ARG_WRT_ARG_FORMAT ) )
    {
      return T;
    }
    if( pcase_var.eql( $kw130$MAL_ARG_WRT_INTER_ARG_FORMAT ) )
    {
      return T;
    }
    return NIL;
  ...
  {
    final SubLObject pcase_var = violation_type( violation );
    if( pcase_var.eql( $kw116$PREDICATE_ISA_VIOLATION ) )
    {
      return T;
    }
    return NIL;
  ...
  public static SubLObject assertion_arg_violation_fix(final SubLObject violation)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      candidate_mts = ConsesLow.cons( assertions_high.assertion_mt( assertion ), candidate_mts );
      cdolist_list_var = cdolist_list_var.rest();
      assertion = cdolist_list_var.first();
    }
    ...
    while ( NIL != cdolist_list_var)
    {
      wff.note_wff_suggestion( ConsesLow.list( $kw131$REPLACE_TERM, arg, el_utilities.make_binary_formula( $const132$ist, candidate_mt, formula ) ) );
      cdolist_list_var = cdolist_list_var.rest();
      candidate_mt = cdolist_list_var.first();
    }
    return wff.wff_suggestions();
  ...
  public static SubLObject strip_mt_literals(final SubLObject formula, SubLObject mt)
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( mt_relevance_macros.possibly_in_mt_determine_function( mt_var ), thread );
      mt_relevance_macros.$mt$.bind( mt_relevance_macros.possibly_in_mt_determine_mt( mt_var ), thread );
      if( NIL != el_utilities.mt_designating_literalP( formula ) && NIL != fort_types_interface.mtP( el_utilities.designated_mt( formula ) ) )
      {
  ...
  public static SubLObject sef_violation_fix(final SubLObject violation)
  {
      ...
      if( NIL == current )
      {
        if( NIL != forts.fort_p( arg ) )
        {
          ...
          while ( NIL != cdolist_list_var)
          {
            ...
            wff.note_wff_suggestion( ConsesLow.list( $kw134$ASSERT, ConsesLow.list( $const135$equals, arg, rival ), mt ) );
            cdolist_list_var = cdolist_list_var.rest();
            assertion = cdolist_list_var.first();
          }
        }
    ...
    else if( pcase_var.eql( $kw130$MAL_ARG_WRT_INTER_ARG_FORMAT ) )
    {
      SubLObject current;
      final SubLObject datum = current = violation.rest();
      SubLObject arg = NIL;
      ...
      cdestructuring_bind.destructuring_bind_must_listp( current, datum, $list136 );
      current = current.rest();
      if( NIL == current )
      {
        if( NIL != forts.fort_p( arg ) )
        {
          ...
          while ( NIL != cdolist_list_var2)
          {
            ...
            wff.note_wff_suggestion( ConsesLow.list( $kw134$ASSERT, ConsesLow.list( $const135$equals, arg, rival2 ), mt2 ) );
  ...
  public static SubLObject predicate_violation_fix(final SubLObject violation)
  {
    ...
    if( pcase_var.eql( $kw116$PREDICATE_ISA_VIOLATION ) )
    {
      ...
      if( NIL == current )
      {
        ...
        while ( NIL != cdolist_list_var)
        {
          wff.note_wff_suggestion( ConsesLow.list( $kw138$UNASSERT, fi.assertion_fi_ist_formula( assertion, UNPROVIDED ) ) );
          cdolist_list_var = cdolist_list_var.rest();
          assertion = cdolist_list_var.first();
        }
      }
  ...
  public static SubLObject mts_accommodating_formula_wrt_types(final SubLObject formula)
  {
    ...
    SubLObject candidate_mts = NIL;
    SubLObject cdolist_list_var = list_utilities.tree_gather( formula, Symbols.symbol_function( $sym140$CONSTANT_P ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
    SubLObject arg = NIL;
    ...
    candidate_mts = Sort.sort( list_utilities.remove_duplicate_forts( candidate_mts ), $sym141$_, $sym142$SPEC_CARDINALITY );
    ...
    try
    {
      ...
      wff_vars.$provide_wff_suggestionsP$.bind( NIL, thread );
      if( $mts_cutoff_for_mts_accommodating_formula_wrt_types$.getDynamicValue( thread ).isInteger() && NIL != list_utilities.lengthG( candidate_mts, $mts_cutoff_for_mts_accommodating_formula_wrt_types$.getDynamicValue(
          thread ), UNPROVIDED ) )
      {
      ...
      while ( NIL != cdolist_list_var2)
      {
        if( NIL == genl_mts.any_genl_mtP( mt, valid_mts, UNPROVIDED, UNPROVIDED ) && NIL != el_utilities.el_formulaP( formula ) && NIL != wff.el_wffP( formula, mt, UNPROVIDED ) )
        {
          valid_mts = ConsesLow.cons( mt, valid_mts );
        }
        cdolist_list_var2 = cdolist_list_var2.rest();
        mt = cdolist_list_var2.first();
      }
  ...
  public static SubLObject nat_wf_in_some_mt(final SubLObject cnat, SubLObject mts, SubLObject validate_expansionP)
  {
    ...
    if( NIL == el_utilities.el_formula_p( cnat ) )
    {
      return NIL;
    }
    if( NIL != validate_expansionP )
    {
      final SubLObject nat_expansion = wff.wff_el_expansion( cnat, $const78$EverythingPSC );
  ...
  public static SubLObject nat_wf_default_mts(final SubLObject cnat, SubLObject independentP, SubLObject unindexedP)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL == kb_indexing_datastructures.unindexed_syntax_constant_p( fort ) || NIL != unindexedP )
      {
        final SubLObject isa_mts = czer_main.fort_sort_by_type_and_id( isa.isa_mts( fort ) );
        if( NIL != isa_mts )
        {
          final SubLObject item_var = isa_mts;
          if( NIL == conses_high.member( item_var, mt_sets, Symbols.symbol_function( EQUAL ), Symbols.symbol_function( IDENTITY ) ) )
          {
            mt_sets = ConsesLow.cons( item_var, mt_sets );
          }
        }
      }
      cdolist_list_var = cdolist_list_var.rest();
    ...
    while ( NIL != cdolist_list_var)
    {
      mts = ConsesLow.nconc( mts, genl_mts.max_floor_mts( list_utilities.remove_duplicate_forts( mt_set ), UNPROVIDED, UNPROVIDED ) );
      cdolist_list_var = cdolist_list_var.rest();
      mt_set = cdolist_list_var.first();
    }
  ...
  {
    return memoization_state.caching_state_remove_function_results_with_args( $cached_max_floor_mts_of_nat_caching_state$.getGlobalValue(), ConsesLow.list( nat, mt, validate_expansionP, number ), UNPROVIDED,
        UNPROVIDED );
  }
  ...
  public static SubLObject cached_max_floor_mts_of_nat(final SubLObject nat, final SubLObject mt, final SubLObject validate_expansionP, final SubLObject number)
  {
    ...
    {
      caching_state = memoization_state.create_global_caching_state_for_name( $sym143$CACHED_MAX_FLOOR_MTS_OF_NAT, $sym144$_CACHED_MAX_FLOOR_MTS_OF_NAT_CACHING_STATE_, NIL, EQL, FOUR_INTEGER, $int145$64 );
    }
    ...
    final SubLObject results3 = Values.arg2( Values.resetMultipleValues(), Values.multiple_value_list( cached_max_floor_mts_of_nat_internal( nat, mt, validate_expansionP, number ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( nat, mt, validate_expansionP, number ) );
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( NIL != el_utilities.el_formula_p( naut ) )
    {
      if( NIL != validate_expansionP )
      {
        final SubLObject expansion_mt = ( NIL != mt ) ? mt : $const78$EverythingPSC;
      ...
      else
      {
        ...
        if( NIL != isa.result_isa_colP( cycl_utilities.nat_arg0( naut ), $const146$Microtheory, mt ) && NIL == at_mt_mt_relevantP( mt ) )
        {
  ...
  public static SubLObject max_floor_mts_of_naut_int(final SubLObject naut, final SubLObject mt, final SubLObject number)
  {
    ...
    SubLObject args_mts = ConsesLow.list( fn_mts );
    ...
    final SubLObject args = cdolist_list_var = cycl_utilities.formula_args( naut, $kw147$IGNORE );
    SubLObject arg = NIL;
    arg = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      argnum = Numbers.add( argnum, ONE_INTEGER );
      if( fn.eql( $const148$Kappa ) && argnum.eql( ONE_INTEGER ) )
      {
    ...
    SubLObject cdolist_list_var2 = list_utilities.cross_products( list_utilities.fast_delete_duplicates( args_mts, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    SubLObject mt_set = NIL;
    mt_set = cdolist_list_var2.first();
    while ( NIL != cdolist_list_var2)
    {
      candidate_mts = ConsesLow.append( candidate_mts, genl_mts.max_floor_mts( mt_set, UNPROVIDED, UNPROVIDED ) );
      cdolist_list_var2 = cdolist_list_var2.rest();
      mt_set = cdolist_list_var2.first();
    }
  ...
  public static SubLObject admitted_arg_candidate_mt_sets(SubLObject arg, final SubLObject argnum, final SubLObject reln, SubLObject mt)
  {
    ...
    if( NIL != nart_handles.nart_p( arg ) || NIL != term.nautP( arg, UNPROVIDED ) )
    {
      ...
      arg_mts = ConsesLow.cons( nat_wf_mts, arg_mts );
    }
    else if( NIL != term.sentenceP( arg, UNPROVIDED ) )
    {
      ...
      arg_mts = ConsesLow.cons( elf_mts, arg_mts );
    }
    ...
    while ( NIL != cdolist_list_var)
    {
      if( col.eql( $const67$Thing ) )
      {
        arg_mts = ConsesLow.cons( ConsesLow.list( mt_vars.$thing_defining_mt$.getGlobalValue() ), arg_mts );
      }
      else
      {
        ...
        if( NIL != mts )
        {
          arg_mts = ConsesLow.cons( mts, arg_mts );
        }
        else if( NIL == $max_floor_mts_of_nat_exceptions$.getDynamicValue( thread ) && NIL == at_vars.$at_admit_consistent_nartsP$.getDynamicValue( thread ) )
        {
          return NIL;
        }
      }
    ...
    {
      return ConsesLow.list( ConsesLow.list( $const149$UniversalVocabularyMt ) );
    }
    return arg_mts;
  }
  ...
  public static SubLObject result_of_max_floor_mts_of_nat(final SubLObject nat, final SubLObject candidate_mts, SubLObject number)
  {
    ...
    try
    {
      mt_relevance_macros.$relevant_mt_function$.bind( $sym150$RELEVANT_MT_IS_GENL_MT, thread );
  ...
  public static SubLObject max_floor_mts_of_admitted_arg(final SubLObject arg, final SubLObject argnum, final SubLObject reln, SubLObject mt)
  {
    ...
    if( NIL != reln_mts )
    {
      ...
      if( NIL != arg_mt_sets )
      {
        final SubLObject mt_sets = ConsesLow.cons( reln_mts, arg_mt_sets );
        SubLObject candidate_mts = NIL;
        SubLObject cdolist_list_var = list_utilities.cross_products( Sequences.delete_duplicates( mt_sets, EQUAL, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
        SubLObject mt_set = NIL;
        mt_set = cdolist_list_var.first();
        while ( NIL != cdolist_list_var)
        {
        ...
        if( NIL != nart_handles.nart_p( arg ) || NIL != el_utilities.possibly_naut_p( arg ) )
        {
  ...
  public static SubLObject max_floor_mts_of_nat_benchmark(final SubLObject n)
  {
    ...
    return number_utilities.float_n( Numbers.divide( time, n ), TWO_INTEGER );
  }
  ...
  public static SubLObject max_floor_mts_of_admitted_arg_benchmark(SubLObject n)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        result = ConsesLow.cons( ConsesLow.list( assertion, admitted_argument_gaf, mts ), result );
      }
      cdolist_list_var = cdolist_list_var.rest();
      support_datum = cdolist_list_var.first();
    }
    ...
    while ( NIL != cdolist_list_var)
    {
      PrintLow.format( T, $str151$___S_____S_____s__, new SubLObject[] { data.first(), conses_high.second( data ), conses_high.third( data )
      } );
      cdolist_list_var = cdolist_list_var.rest();
      data = cdolist_list_var.first();
    }
    print_high.print( Sequences.length( support_data ), UNPROVIDED );
    return number_utilities.float_n( Numbers.divide( time, count ), TWO_INTEGER );
  }
  ...
  public static SubLObject get_admitted_by_supports()
  {
    ...
    final SubLObject mess = $str152$mapping_Cyc_arguments;
    ...
    try
    {
      ...
      try
      {
        ...
        if( NIL == id_index.id_index_objects_empty_p( idx_$159, $kw154$SKIP ) )
        {
          final SubLObject idx_$160 = idx_$159;
          if( NIL == id_index.id_index_dense_objects_empty_p( idx_$160, $kw154$SKIP ) )
          {
            ...
            for( length = Sequences.length( vector_var ), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL( length ); v_iteration = Numbers.add( v_iteration, ONE_INTEGER ) )
            {
              ...
              if( NIL == id_index.id_index_tombstone_p( a_handle ) || NIL == id_index.id_index_skip_tombstones_p( $kw154$SKIP ) )
              {
                  ...
                  if( NIL != deduction_handles.deduction_p( argument ) )
                  {
                    ...
                    while ( NIL != cdolist_list_var_$161)
                    {
                      if( NIL == assertion_handles.assertion_p( support ) && NIL != arguments.hl_support_p( support ) )
                      {
                        ...
                        if( $const155$admittedArgument.eql( cycl_utilities.sentence_arg0( sentence ) ) )
                        {
                          admitted_by_supports = ConsesLow.cons( ConsesLow.list( assertion, mt, sentence ), admitted_by_supports );
                        }
                      }
          ...
          if( NIL == id_index.id_index_sparse_objects_empty_p( idx_$161 ) || NIL == id_index.id_index_skip_tombstones_p( $kw154$SKIP ) )
          {
            ...
            final SubLObject v_default = ( NIL != id_index.id_index_skip_tombstones_p( $kw154$SKIP ) ) ? NIL : $kw154$SKIP;
            while ( a_id2.numL( end_id ))
            {
              final SubLObject a_handle2 = Hashtables.gethash_without_values( a_id2, sparse, v_default );
              if( NIL == id_index.id_index_skip_tombstones_p( $kw154$SKIP ) || NIL == id_index.id_index_tombstone_p( a_handle2 ) )
              {
                  ...
                  if( NIL != deduction_handles.deduction_p( argument2 ) )
                  {
                    ...
                    while ( NIL != cdolist_list_var_$162)
                    {
                      if( NIL == assertion_handles.assertion_p( support2 ) && NIL != arguments.hl_support_p( support2 ) )
                      {
                        ...
                        if( $const155$admittedArgument.eql( cycl_utilities.sentence_arg0( sentence2 ) ) )
                        {
                          admitted_by_supports = ConsesLow.cons( ConsesLow.list( assertion2, mt2, sentence2 ), admitted_by_supports );
                        }
                      }
    ...
    return Sequences.delete_duplicates( admitted_by_supports, Symbols.symbol_function( EQUAL ), UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    return isa.max_floor_mts_of_isa_paths( fn, $const156$Function_Denotational, UNPROVIDED );
  }
  ...
  {
    return isa.max_floor_mts_of_isa_paths( reln, $const157$Relation, UNPROVIDED );
  }
  ...
  public static SubLObject candidate_mts_wrt(final SubLObject candidates, final SubLObject mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      result = ConsesLow.append( result, genl_mts.max_floor_mts( ConsesLow.list( mt, candidate ), UNPROVIDED, UNPROVIDED ) );
      cdolist_list_var = cdolist_list_var.rest();
      candidate = cdolist_list_var.first();
    }
  ...
  public static SubLObject at_error(final SubLObject level, final SubLObject format_str, SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4, SubLObject arg5)
  {
    ...
    if( at_vars.$at_trace_level$.getDynamicValue( thread ).numGE( level ) )
    {
      Errors.cerror( $str91$continue_anyway, format_str, new SubLObject[] { arg1, arg2, arg3, arg4, arg5
      } );
    }
  ...
  public static SubLObject at_warn(final SubLObject level, final SubLObject format_str, SubLObject arg1, SubLObject arg2, SubLObject arg3, SubLObject arg4, SubLObject arg5)
  {
    ...
    if( at_vars.$at_trace_level$.getDynamicValue( thread ).numGE( level ) )
    {
      Functions.apply( $sym158$WARN, format_str, new SubLObject[] { arg1, arg2, arg3, arg4, arg5
      } );
      return NIL;
    }
    return NIL;
  ...
  public static SubLObject relation_arg_constraint_sentences(final SubLObject relation, final SubLObject argnum, SubLObject mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      constraints = ConsesLow.cons( el_utilities.make_ternary_formula( $const160$argIsa, relation, argnum, col ), constraints );
      cdolist_list_var = cdolist_list_var.rest();
      col = cdolist_list_var.first();
    }
    ...
    while ( NIL != cdolist_list_var)
    {
      constraints = ConsesLow.cons( el_utilities.make_ternary_formula( $const161$argGenl, relation, argnum, col ), constraints );
      cdolist_list_var = cdolist_list_var.rest();
      col = cdolist_list_var.first();
    }
  ...
  public static SubLObject variable_arity_relation_arg_constraint_sentences(final SubLObject relation, SubLObject mt)
  {
    ...
    assert NIL != fort_types_interface.variable_arity_relation_p( relation ) : relation;
    SubLObject constraints = NIL;
    SubLObject cdolist_list_var;
    ...
    while ( NIL != cdolist_list_var)
    {
      constraints = ConsesLow.cons( ConsesLow.list( $const163$argsIsa, relation, col ), constraints );
      cdolist_list_var = cdolist_list_var.rest();
      col = cdolist_list_var.first();
    }
    ...
    while ( NIL != cdolist_list_var)
    {
      constraints = ConsesLow.cons( ConsesLow.list( $const164$argsGenl, relation, col ), constraints );
      cdolist_list_var = cdolist_list_var.rest();
      col = cdolist_list_var.first();
    }
    return Sequences.nreverse( constraints );
  ...
  public static SubLObject all_relation_arg_constraint_sentences(final SubLObject relation, SubLObject mt)
  {
    ...
    assert NIL != fort_types_interface.relation_p( relation ) : relation;
    SubLObject constraints = NIL;
  ...
  public static SubLObject relation_term_arg_constraints(final SubLObject relation, final SubLObject v_term, final SubLObject argnum, SubLObject mt)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      constraints = ConsesLow.cons( el_utilities.make_binary_formula( $const168$isa, v_term, col ), constraints );
      cdolist_list_var = cdolist_list_var.rest();
      col = cdolist_list_var.first();
    }
    cols = ( cdolist_list_var = kb_accessors.argn_genl( relation, argnum, mt ) );
    ...
    while ( NIL != cdolist_list_var)
    {
      constraints = ConsesLow.cons( el_utilities.make_binary_formula( $const66$genls, v_term, col ), constraints );
      cdolist_list_var = cdolist_list_var.rest();
      col = cdolist_list_var.first();
    }
    return Sequences.nreverse( constraints );
  ...
  public static SubLObject formula_arg_constraints_cycl(final SubLObject formula, SubLObject mt)
  {
    ...
    if( NIL == forts.fort_p( relation ) )
    {
      return ConsesLow.list( ConsesLow.listS( $const168$isa, relation, $list169 ) );
    }
    SubLObject argnum = ZERO_INTEGER;
    SubLObject cdolist_list_var;
  ...
  public static SubLObject constraint_sentence_isa_constraints(final SubLObject constraint_sentence, final SubLObject mt)
  {
    ...
    final SubLObject conjunction = ( NIL != el_utilities.el_conjunction_p( constraint_sentence ) ) ? constraint_sentence : simplifier.conjoin( ConsesLow.list( constraint_sentence ), UNPROVIDED );
    SubLObject cdolist_list_var;
    final SubLObject args = cdolist_list_var = cycl_utilities.formula_args( conjunction, $kw147$IGNORE );
    SubLObject conjunct = NIL;
    conjunct = cdolist_list_var.first();
    while ( NIL != cdolist_list_var)
    {
      if( NIL != el_utilities.el_formula_with_operator_p( conjunct, $const168$isa ) )
      {
        ...
        assert NIL != cycl_variables.cyc_varP( var ) : var;
  ...
  public static SubLObject possible_followup_variable_binding_sets(final SubLObject formula, final SubLObject followup_formula, SubLObject mt)
  {
    ...
    final SubLObject sentence_variables = el_utilities.sentence_free_variables( formula, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    final SubLObject followup_variables = el_utilities.sentence_free_variables( followup_formula, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    final SubLObject possible_bindings = dictionary.new_dictionary( EQL, Sequences.length( sentence_variables ) );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      while ( NIL != cdolist_list_var_$165)
      {
        ...
        if( NIL == disjoint_with.any_disjoint_with_anyP( cur_isa_constraints, cur_followup_isa_constraints, mt, UNPROVIDED, UNPROVIDED ) && NIL == disjoint_with.any_disjoint_with_anyP( cur_genls_constraints,
            cur_followup_genls_constraints, mt, UNPROVIDED, UNPROVIDED ) )
        {
          ...
          dictionary_utilities.dictionary_push( possible_bindings, var, ConsesLow.list( followup_var, var_score ) );
        }
    ...
    while ( NIL != cdolist_list_var)
    {
      result = ConsesLow.cons( ConsesLow.list( similarity_for_variable_binding_set( binding_set, formula, followup_formula, mt ), binding_set ), result );
      cdolist_list_var = cdolist_list_var.rest();
      binding_set = cdolist_list_var.first();
    }
    return Sort.sort( result, Symbols.symbol_function( $sym171$VARIABLE_BINDING_SET_ITEM_COMPARATOR ), UNPROVIDED );
  }
  ...
  {
    return Functions.funcall( Symbols.symbol_function( $sym141$_ ), item_a.first(), item_b.first() );
  }
  ...
  public static SubLObject calc_possible_followup_binding_sets(SubLObject bindings_dict, SubLObject bindings_list, SubLObject working_bindings)
  {
    ...
    SubLObject iteration_state;
    for( iteration_state = dictionary_contents.do_dictionary_contents_state( dictionary.dictionary_contents( bindings_dict ) ); NIL == dictionary_contents.do_dictionary_contents_doneP(
        iteration_state ); iteration_state = dictionary_contents.do_dictionary_contents_next( iteration_state ) )
    {
      thread.resetMultipleValues();
      ...
      while ( NIL != cdolist_list_var)
      {
        cur_binding = ConsesLow.cons( var, cur_binding );
        working_bindings = ConsesLow.cons( cur_binding, working_bindings );
        ...
        bindings_list = ConsesLow.cons( working_bindings, bindings_list );
  ...
  public static SubLObject count_followup_bindings(final SubLObject variable_binding_set)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      bindings_list = ConsesLow.cons( conses_high.second( binding ), bindings_list );
      cdolist_list_var = cdolist_list_var.rest();
      binding = cdolist_list_var.first();
    }
    return Sequences.length( Sequences.remove_duplicates( bindings_list, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
  }
  ...
  public static SubLObject similarity_for_variable_binding_set(final SubLObject variable_binding_set, final SubLObject formula, final SubLObject followup_formula, SubLObject mt)
  {
    ...
    final SubLObject formula_var_count = Sequences.length( el_utilities.literal_variables( formula, UNPROVIDED, UNPROVIDED ) );
    final SubLObject followup_var_count = Sequences.length( el_utilities.literal_variables( followup_formula, UNPROVIDED, UNPROVIDED ) );
    ...
    {
      formula_variable_usage_score = $int172$100;
    }
    else
    {
      formula_variable_usage_score = Numbers.multiply( $int172$100, Numbers.divide( bindings_count_for_formula, formula_var_count ) );
    }
    if( followup_var_count.eql( ZERO_INTEGER ) )
    {
      followup_variable_usage_score = $int172$100;
    }
    else
    {
      followup_variable_usage_score = Numbers.multiply( $int172$100, Numbers.divide( bindings_count_for_followup, formula_var_count ) );
    }
    SubLObject cdolist_list_var = variable_binding_set;
    SubLObject binding = NIL;
    binding = cdolist_list_var.first();
    ...
    return Numbers.divide( Numbers.add( variable_bindings_score, Numbers.divide( Numbers.add( formula_variable_usage_score, followup_variable_usage_score ), TWO_INTEGER ) ), TWO_INTEGER );
  }
  ...
  public static SubLObject constraint_similarity(final SubLObject constraints1, final SubLObject constraints2, SubLObject mt)
  {
    ...
    final SubLObject max_generality = Numbers.log( cardinality_estimates.generality_estimate( $const67$Thing ), UNPROVIDED );
    final SubLObject min_gen_constraints1 = Numbers.max( ONE_INTEGER, cardinality_estimates.generality_estimate( constraints1.first() ) );
    final SubLObject min_gen_constraints2 = Numbers.max( ONE_INTEGER, cardinality_estimates.generality_estimate( constraints2.first() ) );
    if( min_gen_constraints1.numL( min_gen_constraints2 ) )
    {
      return ONE_INTEGER;
    }
    final SubLObject constraint_diff = Numbers.abs( Numbers.subtract( Numbers.log( min_gen_constraints1, UNPROVIDED ), Numbers.log( min_gen_constraints2, UNPROVIDED ) ) );
    SubLObject score = Numbers.subtract( $int172$100, Numbers.multiply( Numbers.divide( constraint_diff, max_generality ), $int172$100 ) );
    if( constraint_diff.numL( $float173$0_01 ) )
    {
      score = $int172$100;
    }
    return score;
  ...
  public static SubLObject isas_and_genls_similarity(final SubLObject isas1, final SubLObject isas2, final SubLObject genls1, final SubLObject genls2, final SubLObject mt)
  {
    ...
    return Numbers.divide( Numbers.add( isa_score, genls_score ), TWO_INTEGER );
  }
  ...
  public static SubLObject more_specific_p(final SubLObject specific, final SubLObject general, SubLObject mt)
  {
    ...
    if( NIL != genls.genl_in_any_mtP( general, $const174$Number_General ) && specific.isNumber() )
    {
      return T;
    }
    return NIL;
  ...
  {
    SubLFiles.declareFunction( me, "arg_n_predicate", "ARG-N-PREDICATE", 1, 0, false );
    SubLFiles.declareFunction( me, "arg_type_mt", "ARG-TYPE-MT", 4, 0, false );
    SubLFiles.declareFunction( me, "find_generic_arg_by_id", "FIND-GENERIC-ARG-BY-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "find_generic_arg_id", "FIND-GENERIC-ARG-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "store_generic_arg", "STORE-GENERIC-ARG", 2, 0, false );
    SubLFiles.declareFunction( me, "stored_generic_arg_p", "STORED-GENERIC-ARG-P", 1, 0, false );
    SubLFiles.declareFunction( me, "get_generic_arg", "GET-GENERIC-ARG", 1, 0, false );
    SubLFiles.declareFunction( me, "generic_arg_num", "GENERIC-ARG-NUM", 1, 0, false );
    SubLFiles.declareFunction( me, "generic_argP", "GENERIC-ARG?", 1, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_isa_pred", "INTER-ARG-ISA-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_isa_inverse", "INTER-ARG-ISA-INVERSE", 2, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_not_isa_pred", "INTER-ARG-NOT-ISA-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_not_isa_inverse", "INTER-ARG-NOT-ISA-INVERSE", 2, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_genl_pred", "INTER-ARG-GENL-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_not_genl_pred", "INTER-ARG-NOT-GENL-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_isa_genl_pred", "INTER-ARG-ISA-GENL-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_genl_isa_pred", "INTER-ARG-GENL-ISA-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_genl_inverse", "INTER-ARG-GENL-INVERSE", 2, 0, false );
    SubLFiles.declareFunction( me, "implication_opP", "IMPLICATION-OP?", 1, 0, false );
    SubLFiles.declareFunction( me, "logical_opP", "LOGICAL-OP?", 1, 0, false );
    SubLFiles.declareFunction( me, "truth_functionP", "TRUTH-FUNCTION?", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_all_arg_type_predicate_caches", "INITIALIZE-ALL-ARG-TYPE-PREDICATE-CACHES", 0, 0, false );
    SubLFiles.declareFunction( me, "clear_all_arg_type_predicate_caches", "CLEAR-ALL-ARG-TYPE-PREDICATE-CACHES", 0, 0, false );
    SubLFiles.declareFunction( me, "arg_isa_binary_predP", "ARG-ISA-BINARY-PRED?", 1, 1, false );
    SubLFiles.declareFunction( me, "arg_isa_ternary_predP", "ARG-ISA-TERNARY-PRED?", 1, 1, false );
    SubLFiles.declareFunction( me, "arg_isa_predicateP", "ARG-ISA-PREDICATE?", 1, 1, false );
    SubLFiles.declareFunction( me, "arg_genl_binary_predP", "ARG-GENL-BINARY-PRED?", 1, 1, false );
    SubLFiles.declareFunction( me, "arg_genl_ternary_predP", "ARG-GENL-TERNARY-PRED?", 1, 1, false );
    SubLFiles.declareFunction( me, "arg_genl_predicateP", "ARG-GENL-PREDICATE?", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_denoting_functionP", "FORMULA-DENOTING-FUNCTION?", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_functorP", "FORMULA-FUNCTOR?", 1, 1, false );
    SubLFiles.declareFunction( me, "sentence_denoting_functionP", "SENTENCE-DENOTING-FUNCTION?", 1, 1, false );
    SubLFiles.declareFunction( me, "sentence_functorP", "SENTENCE-FUNCTOR?", 1, 1, false );
    SubLFiles.declareFunction( me, "argn_type_levelP", "ARGN-TYPE-LEVEL?", 2, 1, false );
    SubLFiles.declareFunction( me, "min_genl_preds_admitting_fort_as_arg", "MIN-GENL-PREDS-ADMITTING-FORT-AS-ARG", 3, 1, false );
    SubLFiles.declareFunction( me, "forts_admitted_as_arg", "FORTS-ADMITTED-AS-ARG", 3, 3, false );
    SubLFiles.declareFunction( me, "min_implicit_types", "MIN-IMPLICIT-TYPES", 1, 1, false );
    SubLFiles.declareFunction( me, "term_requires_isa_in_relations", "TERM-REQUIRES-ISA-IN-RELATIONS", 2, 2, false );
    SubLFiles.declareFunction( me, "term_requires_genl_in_relations", "TERM-REQUIRES-GENL-IN-RELATIONS", 2, 2, false );
    SubLFiles.declareFunction( me, "term_requires_types_in_relations", "TERM-REQUIRES-TYPES-IN-RELATIONS", 2, 2, false );
    SubLFiles.declareFunction( me, "term_requires_isa_in_clause", "TERM-REQUIRES-ISA-IN-CLAUSE", 2, 1, false );
    SubLFiles.declareFunction( me, "term_requires_isa_in_relation", "TERM-REQUIRES-ISA-IN-RELATION", 2, 1, false );
    SubLFiles.declareFunction( me, "term_requires_isa_in_formula", "TERM-REQUIRES-ISA-IN-FORMULA", 2, 2, false );
    SubLFiles.declareFunction( me, "term_requires_genl_in_relation", "TERM-REQUIRES-GENL-IN-RELATION", 2, 1, false );
    SubLFiles.declareFunction( me, "get_sub_expression_for_term_position", "GET-SUB-EXPRESSION-FOR-TERM-POSITION", 2, 0, false );
    SubLFiles.declareFunction( me, "term_position_requires_types_in_relation", "TERM-POSITION-REQUIRES-TYPES-IN-RELATION", 2, 1, false );
    SubLFiles.declareFunction( me, "term_requires_types_in_relation", "TERM-REQUIRES-TYPES-IN-RELATION", 2, 1, false );
    SubLFiles.declareFunction( me, "arg_requires_isa_in_relation", "ARG-REQUIRES-ISA-IN-RELATION", 2, 1, false );
    SubLFiles.declareFunction( me, "pred_arg_isa_requires_other_arg_isa", "PRED-ARG-ISA-REQUIRES-OTHER-ARG-ISA", 3, 1, false );
    SubLFiles.declareFunction( me, "make_el_query_literal", "MAKE-EL-QUERY-LITERAL", 1, 0, false );
    SubLFiles.declareFunction( me, "arg_isa_applicable_gafs", "ARG-ISA-APPLICABLE-GAFS", 1, 0, false );
    SubLFiles.declareFunction( me, "gather_via_map_pred_index", "GATHER-VIA-MAP-PRED-INDEX", 1, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_isa_cache_initializedP", "INTER-ARG-ISA-CACHE-INITIALIZED?", 0, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_isa_assertion_somewhere_cache_add_int", "SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE-CACHE-ADD-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_isa_assertion_somewhere_cache_remove_int", "SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE-CACHE-REMOVE-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_isa_assertion_somewhere_cache_maybe_remove_int", "SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE-CACHE-MAYBE-REMOVE-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_isa_assertion_somewhere_cache_add", "SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE-CACHE-ADD", 1, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_isa_assertion_somewhere_cache_maybe_remove", "SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE-CACHE-MAYBE-REMOVE", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_some_inter_arg_isa_assertion_somewhere_cache", "CLEAR-SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_some_inter_arg_isa_assertion_somewhere_cache", "INITIALIZE-SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_isa_assertion_somewhereP", "SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE?", 1, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_isa_constraint_somewhereP", "SOME-INTER-ARG-ISA-CONSTRAINT-SOMEWHERE?", 1, 0, false );
    SubLFiles.declareFunction( me, "inter_arg_format_cache_initializedP", "INTER-ARG-FORMAT-CACHE-INITIALIZED?", 0, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_format_assertion_somewhere_cache_add_int", "SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE-CACHE-ADD-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_format_assertion_somewhere_cache_remove_int", "SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE-CACHE-REMOVE-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_format_assertion_somewhere_cache_maybe_remove_int", "SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE-CACHE-MAYBE-REMOVE-INT", 1, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_format_assertion_somewhere_cache_add", "SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE-CACHE-ADD", 1, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_format_assertion_somewhere_cache_maybe_remove", "SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE-CACHE-MAYBE-REMOVE", 1, 0, false );
    SubLFiles.declareFunction( me, "clear_some_inter_arg_format_assertion_somewhere_cache", "CLEAR-SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "initialize_some_inter_arg_format_assertion_somewhere_cache", "INITIALIZE-SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE-CACHE", 0, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_format_assertion_somewhereP", "SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE?", 1, 0, false );
    SubLFiles.declareFunction( me, "some_inter_arg_format_constraint_somewhereP", "SOME-INTER-ARG-FORMAT-CONSTRAINT-SOMEWHERE?", 1, 0, false );
    SubLFiles.declareFunction( me, "reln_permits_generic_arg_variablesP", "RELN-PERMITS-GENERIC-ARG-VARIABLES?", 2, 0, false );
    SubLFiles.declareFunction( me, "reln_permits_keyword_variablesP", "RELN-PERMITS-KEYWORD-VARIABLES?", 2, 0, false );
    SubLFiles.declareFunction( me, "reln_constrained_to_be_collectionP", "RELN-CONSTRAINED-TO-BE-COLLECTION?", 3, 0, false );
    SubLFiles.declareFunction( me, "constraint_pred_constraint_argnum", "CONSTRAINT-PRED-CONSTRAINT-ARGNUM", 1, 0, false );
    SubLFiles.declareFunction( me, "gaf_arg_type_constraint", "GAF-ARG-TYPE-CONSTRAINT", 1, 0, false );
    SubLFiles.declareFunction( me, "gather_at_data", "GATHER-AT-DATA", 2, 2, false );
    SubLFiles.declareFunction( me, "gather_at_data_assertion", "GATHER-AT-DATA-ASSERTION", 1, 2, false );
    SubLFiles.declareFunction( me, "gather_at_constraint", "GATHER-AT-CONSTRAINT", 1, 2, false );
    SubLFiles.declareFunction( me, "gather_at_assertion", "GATHER-AT-ASSERTION", 1, 2, false );
    SubLFiles.declareFunction( me, "at_finishedP", "AT-FINISHED?", 0, 1, false );
    SubLFiles.declareFunction( me, "at_finished", "AT-FINISHED", 0, 1, false );
    SubLFiles.declareFunction( me, "at_mapping_finished", "AT-MAPPING-FINISHED", 0, 0, false );
    SubLFiles.declareFunction( me, "at_handle_mal_constraint", "AT-HANDLE-MAL-CONSTRAINT", 1, 0, false );
    SubLFiles.declareFunction( me, "at_mal_arg_msg", "AT-MAL-ARG-MSG", 1, 0, false );
    SubLFiles.declareFunction( me, "predicate_isa_violation_data", "PREDICATE-ISA-VIOLATION-DATA", 1, 1, false );
    SubLFiles.declareFunction( me, "meta_predicate_violation_data", "META-PREDICATE-VIOLATION-DATA", 1, 1, false );
    SubLFiles.declareFunction( me, "semantic_violations", "SEMANTIC-VIOLATIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "note_at_violationP", "NOTE-AT-VIOLATION?", 0, 0, false );
    SubLFiles.declareFunction( me, "note_at_violation", "NOTE-AT-VIOLATION", 1, 0, false );
    SubLFiles.declareFunction( me, "recursive_violationP", "RECURSIVE-VIOLATION?", 1, 0, false );
    SubLFiles.declareFunction( me, "reset_at_violations", "RESET-AT-VIOLATIONS", 0, 1, false );
    SubLFiles.declareFunction( me, "reset_arity_violations", "RESET-ARITY-VIOLATIONS", 0, 1, false );
    SubLFiles.declareFunction( me, "reset_semantic_violations", "RESET-SEMANTIC-VIOLATIONS", 0, 1, false );
    SubLFiles.declareFunction( me, "reset_at_state", "RESET-AT-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "suggest_formula_fix_for_at_violation", "SUGGEST-FORMULA-FIX-FOR-AT-VIOLATION", 2, 0, false );
    SubLFiles.declareFunction( me, "assertion_arg_violations_among", "ASSERTION-ARG-VIOLATIONS-AMONG", 1, 0, false );
    SubLFiles.declareFunction( me, "sef_violations_among", "SEF-VIOLATIONS-AMONG", 1, 0, false );
    SubLFiles.declareFunction( me, "predicate_violations_among", "PREDICATE-VIOLATIONS-AMONG", 1, 0, false );
    SubLFiles.declareFunction( me, "assertion_arg_violationP", "ASSERTION-ARG-VIOLATION?", 1, 0, false );
    SubLFiles.declareFunction( me, "assertion_collectionP", "ASSERTION-COLLECTION?", 1, 1, false );
    SubLFiles.declareFunction( me, "sef_violationP", "SEF-VIOLATION?", 1, 0, false );
    SubLFiles.declareFunction( me, "predicate_violationP", "PREDICATE-VIOLATION?", 1, 0, false );
    SubLFiles.declareFunction( me, "assertion_arg_violation_fix", "ASSERTION-ARG-VIOLATION-FIX", 1, 0, false );
    SubLFiles.declareFunction( me, "strip_mt_literals", "STRIP-MT-LITERALS", 1, 1, false );
    SubLFiles.declareFunction( me, "sef_violation_fix", "SEF-VIOLATION-FIX", 1, 0, false );
    SubLFiles.declareFunction( me, "predicate_violation_fix", "PREDICATE-VIOLATION-FIX", 1, 0, false );
    SubLFiles.declareFunction( me, "violation_type", "VIOLATION-TYPE", 1, 0, false );
    SubLFiles.declareFunction( me, "mts_accommodating_formula_wrt_types", "MTS-ACCOMMODATING-FORMULA-WRT-TYPES", 1, 0, false );
    SubLFiles.declareFunction( me, "nat_wf_in_some_mtP", "NAT-WF-IN-SOME-MT?", 1, 2, false );
    SubLFiles.declareFunction( me, "nat_wf_in_some_mt", "NAT-WF-IN-SOME-MT", 1, 2, false );
    SubLFiles.declareFunction( me, "nat_wf_default_mts", "NAT-WF-DEFAULT-MTS", 1, 2, false );
    SubLFiles.declareFunction( me, "formula_forts_isa_mts", "FORMULA-FORTS-ISA-MTS", 1, 1, false );
    SubLFiles.declareFunction( me, "at_mt_mt_relevantP", "AT-MT-MT-RELEVANT?", 1, 0, false );
    SubLFiles.declareFunction( me, "mts_accommodating_nat", "MTS-ACCOMMODATING-NAT", 1, 2, false );
    SubLFiles.declareFunction( me, "nat_wf_in_mts", "NAT-WF-IN-MTS", 1, 3, false );
    SubLFiles.declareFunction( me, "clear_cached_max_floor_mts_of_nat", "CLEAR-CACHED-MAX-FLOOR-MTS-OF-NAT", 0, 0, false );
    SubLFiles.declareFunction( me, "remove_cached_max_floor_mts_of_nat", "REMOVE-CACHED-MAX-FLOOR-MTS-OF-NAT", 4, 0, false );
    SubLFiles.declareFunction( me, "cached_max_floor_mts_of_nat_internal", "CACHED-MAX-FLOOR-MTS-OF-NAT-INTERNAL", 4, 0, false );
    SubLFiles.declareFunction( me, "cached_max_floor_mts_of_nat", "CACHED-MAX-FLOOR-MTS-OF-NAT", 4, 0, false );
    SubLFiles.declareFunction( me, "fast_max_floor_mts_of_nat", "FAST-MAX-FLOOR-MTS-OF-NAT", 1, 1, false );
    SubLFiles.declareFunction( me, "max_floor_mts_of_nat", "MAX-FLOOR-MTS-OF-NAT", 1, 3, false );
    SubLFiles.declareFunction( me, "max_floor_mts_of_naut", "MAX-FLOOR-MTS-OF-NAUT", 4, 0, false );
    SubLFiles.declareFunction( me, "max_floor_mts_of_naut_int", "MAX-FLOOR-MTS-OF-NAUT-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "admitted_arg_candidate_mt_sets", "ADMITTED-ARG-CANDIDATE-MT-SETS", 3, 1, false );
    SubLFiles.declareFunction( me, "result_of_max_floor_mts_of_nat", "RESULT-OF-MAX-FLOOR-MTS-OF-NAT", 2, 1, false );
    SubLFiles.declareFunction( me, "max_floor_mts_of_admitted_arg", "MAX-FLOOR-MTS-OF-ADMITTED-ARG", 3, 1, false );
    SubLFiles.declareFunction( me, "max_floor_mts_of_nat_benchmark", "MAX-FLOOR-MTS-OF-NAT-BENCHMARK", 1, 0, false );
    SubLFiles.declareFunction( me, "get_random_nart_set", "GET-RANDOM-NART-SET", 1, 0, false );
    SubLFiles.declareFunction( me, "max_floor_mts_of_admitted_arg_benchmark", "MAX-FLOOR-MTS-OF-ADMITTED-ARG-BENCHMARK", 0, 1, false );
    SubLFiles.declareFunction( me, "get_admitted_by_supports", "GET-ADMITTED-BY-SUPPORTS", 0, 0, false );
    SubLFiles.declareFunction( me, "nat_formula_arg_wff_mts", "NAT-FORMULA-ARG-WFF-MTS", 1, 0, false );
    SubLFiles.declareFunction( me, "nat_function_wff_mts", "NAT-FUNCTION-WFF-MTS", 1, 0, false );
    SubLFiles.declareFunction( me, "relation_wff_mts", "RELATION-WFF-MTS", 1, 0, false );
    SubLFiles.declareFunction( me, "candidate_mts_wrt", "CANDIDATE-MTS-WRT", 2, 0, false );
    SubLFiles.declareFunction( me, "nat_arg_wff_wrt_arg_isa_mts", "NAT-ARG-WFF-WRT-ARG-ISA-MTS", 2, 0, false );
    SubLFiles.declareFunction( me, "nat_arg_wff_wrt_arg_genls_mts", "NAT-ARG-WFF-WRT-ARG-GENLS-MTS", 2, 0, false );
    SubLFiles.declareFunction( me, "filter_excepted_nat_wff_mts", "FILTER-EXCEPTED-NAT-WFF-MTS", 1, 0, false );
    SubLFiles.declareFunction( me, "at_note", "AT-NOTE", 2, 5, false );
    SubLFiles.declareFunction( me, "at_error", "AT-ERROR", 2, 5, false );
    SubLFiles.declareFunction( me, "at_cerror", "AT-CERROR", 3, 5, false );
    SubLFiles.declareFunction( me, "at_warn", "AT-WARN", 2, 5, false );
    SubLFiles.declareFunction( me, "min_anects", "MIN-ANECTS", 1, 1, false );
    SubLFiles.declareFunction( me, "union_min_anects", "UNION-MIN-ANECTS", 1, 1, false );
    SubLFiles.declareFunction( me, "relation_arg_constraint_sentences", "RELATION-ARG-CONSTRAINT-SENTENCES", 2, 1, false );
    SubLFiles.declareFunction( me, "variable_arity_relation_arg_constraint_sentences", "VARIABLE-ARITY-RELATION-ARG-CONSTRAINT-SENTENCES", 1, 1, false );
    SubLFiles.declareFunction( me, "all_relation_arg_constraint_sentences", "ALL-RELATION-ARG-CONSTRAINT-SENTENCES", 1, 1, false );
    SubLFiles.declareFunction( me, "all_relation_constraint_sentences", "ALL-RELATION-CONSTRAINT-SENTENCES", 1, 1, false );
    SubLFiles.declareFunction( me, "relation_term_arg_constraints", "RELATION-TERM-ARG-CONSTRAINTS", 3, 1, false );
    SubLFiles.declareFunction( me, "formula_arg_constraints_cycl", "FORMULA-ARG-CONSTRAINTS-CYCL", 1, 1, false );
    SubLFiles.declareFunction( me, "formula_variable_isa_constraint_alist", "FORMULA-VARIABLE-ISA-CONSTRAINT-ALIST", 2, 0, false );
    SubLFiles.declareFunction( me, "constraint_sentence_isa_constraints", "CONSTRAINT-SENTENCE-ISA-CONSTRAINTS", 2, 0, false );
    SubLFiles.declareFunction( me, "possible_followup_variable_binding_sets", "POSSIBLE-FOLLOWUP-VARIABLE-BINDING-SETS", 2, 1, false );
    SubLFiles.declareFunction( me, "variable_binding_set_item_comparator", "VARIABLE-BINDING-SET-ITEM-COMPARATOR", 2, 0, false );
    SubLFiles.declareFunction( me, "calc_possible_followup_binding_sets", "CALC-POSSIBLE-FOLLOWUP-BINDING-SETS", 3, 0, false );
    SubLFiles.declareFunction( me, "count_followup_bindings", "COUNT-FOLLOWUP-BINDINGS", 1, 0, false );
    SubLFiles.declareFunction( me, "similarity_for_variable_binding_set", "SIMILARITY-FOR-VARIABLE-BINDING-SET", 3, 1, false );
    SubLFiles.declareFunction( me, "constraint_similarity", "CONSTRAINT-SIMILARITY", 2, 1, false );
    SubLFiles.declareFunction( me, "isa_constraint_similarity", "ISA-CONSTRAINT-SIMILARITY", 2, 1, false );
    SubLFiles.declareFunction( me, "genls_constraint_similarity", "GENLS-CONSTRAINT-SIMILARITY", 2, 1, false );
    SubLFiles.declareFunction( me, "isas_and_genls_similarity", "ISAS-AND-GENLS-SIMILARITY", 5, 0, false );
    SubLFiles.declareFunction( me, "more_specific_p", "MORE-SPECIFIC-P", 2, 1, false );
    return NIL;
  }

  public static SubLObject init_at_utilities_file()
  {
    $generic_arg_store$ = SubLFiles.deflexical( "*GENERIC-ARG-STORE*", ( maybeDefault( $sym5$_GENERIC_ARG_STORE_, $generic_arg_store$, NIL ) ) );
    $some_inter_arg_isa_assertion_somewhere_cache$ = SubLFiles.deflexical( "*SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE-CACHE*", ( maybeDefault( $sym76$_SOME_INTER_ARG_ISA_ASSERTION_SOMEWHERE_CACHE_,
        $some_inter_arg_isa_assertion_somewhere_cache$, NIL ) ) );
    $some_inter_arg_format_assertion_somewhere_cache$ = SubLFiles.deflexical( "*SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE-CACHE*", ( maybeDefault( $sym97$_SOME_INTER_ARG_FORMAT_ASSERTION_SOMEWHERE_CACHE_,
        $some_inter_arg_format_assertion_somewhere_cache$, NIL ) ) );
    $mts_cutoff_for_mts_accommodating_formula_wrt_types$ = SubLFiles.defparameter( "*MTS-CUTOFF-FOR-MTS-ACCOMMODATING-FORMULA-WRT-TYPES*", $int139$40 );
    $max_floor_mts_of_nat_exceptions$ = SubLFiles.defparameter( "*MAX-FLOOR-MTS-OF-NAT-EXCEPTIONS*", NIL );
    $cached_max_floor_mts_of_nat_caching_state$ = SubLFiles.deflexical( "*CACHED-MAX-FLOOR-MTS-OF-NAT-CACHING-STATE*", NIL );
    $max_floor_mts_of_nat_recursionP$ = SubLFiles.defparameter( "*MAX-FLOOR-MTS-OF-NAT-RECURSION?*", NIL );
    return NIL;
  }
  ...
  public static SubLObject setup_at_utilities_file()
  {
    ...
    subl_macro_promotions.declare_defglobal( $sym76$_SOME_INTER_ARG_ISA_ASSERTION_SOMEWHERE_CACHE_ );
    subl_macro_promotions.declare_defglobal( $sym97$_SOME_INTER_ARG_FORMAT_ASSERTION_SOMEWHERE_CACHE_ );
    memoization_state.note_globally_cached_function( $sym143$CACHED_MAX_FLOOR_MTS_OF_NAT );
    generic_testing.define_test_case_table_int( $sym175$ALL_RELATION_CONSTRAINT_SENTENCES, ConsesLow.list( new SubLObject[] { $kw176$TEST, NIL, $kw177$OWNER, NIL, $kw178$CLASSES, NIL, $kw179$KB, $kw180$FULL,
      $kw181$WORKING_, T
    } ), $list182 );
    generic_testing.define_test_case_table_int( $sym183$ALL_RELATION_ARG_CONSTRAINT_SENTENCES, ConsesLow.list( new SubLObject[] { $kw176$TEST, NIL, $kw177$OWNER, NIL, $kw178$CLASSES, NIL, $kw179$KB, $kw184$TINY,
      $kw181$WORKING_, T
    } ), $list185 );
    generic_testing.define_test_case_table_int( $sym186$FORMULA_ARG_CONSTRAINTS_CYCL, ConsesLow.list( new SubLObject[] { $kw176$TEST, NIL, $kw177$OWNER, NIL, $kw178$CLASSES, NIL, $kw179$KB, $kw184$TINY, $kw181$WORKING_,
      T
    } ), $list187 );
  ...
  {
    me = new at_utilities();
    $generic_arg_store$ = null;
    $some_inter_arg_isa_assertion_somewhere_cache$ = null;
    $some_inter_arg_format_assertion_somewhere_cache$ = null;
    $mts_cutoff_for_mts_accommodating_formula_wrt_types$ = null;
    $max_floor_mts_of_nat_exceptions$ = null;
    $cached_max_floor_mts_of_nat_caching_state$ = null;
    $max_floor_mts_of_nat_recursionP$ = null;
    $const0$arg1Isa = constant_handles.reader_make_constant_shell( makeString( "arg1Isa" ) );
    $const1$arg2Isa = constant_handles.reader_make_constant_shell( makeString( "arg2Isa" ) );
    $const2$arg3Isa = constant_handles.reader_make_constant_shell( makeString( "arg3Isa" ) );
    $const3$arg4Isa = constant_handles.reader_make_constant_shell( makeString( "arg4Isa" ) );
    $const4$arg5Isa = constant_handles.reader_make_constant_shell( makeString( "arg5Isa" ) );
    $sym5$_GENERIC_ARG_STORE_ = makeSymbol( "*GENERIC-ARG-STORE*" );
    $sym6$KBEQ = makeSymbol( "KBEQ" );
    $str7$ARG = makeString( "ARG" );
    $str8$_S = makeString( "~S" );
    $const9$interArgIsa1_2 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa1-2" ) );
    $const10$interArgIsa1_3 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa1-3" ) );
    $const11$interArgIsa1_4 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa1-4" ) );
    $const12$interArgIsa1_5 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa1-5" ) );
    $str13$invalid_arg_isa_pred_index___s__s = makeString( "invalid arg-isa-pred index: ~s-~s" );
    $const14$interArgIsa2_1 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa2-1" ) );
    $const15$interArgIsa2_3 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa2-3" ) );
    $const16$interArgIsa2_4 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa2-4" ) );
    $const17$interArgIsa2_5 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa2-5" ) );
    $const18$interArgIsa3_1 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa3-1" ) );
    $const19$interArgIsa3_2 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa3-2" ) );
    $const20$interArgIsa3_4 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa3-4" ) );
    $const21$interArgIsa3_5 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa3-5" ) );
    $const22$interArgIsa4_1 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa4-1" ) );
    $const23$interArgIsa4_2 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa4-2" ) );
    $const24$interArgIsa4_3 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa4-3" ) );
    $const25$interArgIsa4_5 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa4-5" ) );
    $const26$interArgIsa5_1 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa5-1" ) );
    $const27$interArgIsa5_2 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa5-2" ) );
    $const28$interArgIsa5_3 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa5-3" ) );
    $const29$interArgIsa5_4 = constant_handles.reader_make_constant_shell( makeString( "interArgIsa5-4" ) );
    $list30 = ConsesLow.list( ONE_INTEGER, TWO_INTEGER );
    $const31$interArgNotIsa1_2 = constant_handles.reader_make_constant_shell( makeString( "interArgNotIsa1-2" ) );
    $const32$interArgNotIsa1_3 = constant_handles.reader_make_constant_shell( makeString( "interArgNotIsa1-3" ) );
    $const33$interArgNotIsa1_4 = constant_handles.reader_make_constant_shell( makeString( "interArgNotIsa1-4" ) );
    $const34$interArgNotIsa1_5 = constant_handles.reader_make_constant_shell( makeString( "interArgNotIsa1-5" ) );
    $str35$invalid_arg_not_isa_pred_index___ = makeString( "invalid arg-not-isa-pred index: ~s-~s" );
    $const36$interArgNotIsa2_3 = constant_handles.reader_make_constant_shell( makeString( "interArgNotIsa2-3" ) );
    $const37$interArgNotIsa2_4 = constant_handles.reader_make_constant_shell( makeString( "interArgNotIsa2-4" ) );
    $const38$interArgNotIsa2_5 = constant_handles.reader_make_constant_shell( makeString( "interArgNotIsa2-5" ) );
    $const39$interArgNotIsa3_4 = constant_handles.reader_make_constant_shell( makeString( "interArgNotIsa3-4" ) );
    $const40$interArgNotIsa3_5 = constant_handles.reader_make_constant_shell( makeString( "interArgNotIsa3-5" ) );
    $const41$interArgNotIsa4_5 = constant_handles.reader_make_constant_shell( makeString( "interArgNotIsa4-5" ) );
    $const42$interArgGenl1_2 = constant_handles.reader_make_constant_shell( makeString( "interArgGenl1-2" ) );
    $str43$invalid_arg_genl_pred_index___s__ = makeString( "invalid arg-genl-pred index: ~s-~s" );
    $const44$interArgGenl2_1 = constant_handles.reader_make_constant_shell( makeString( "interArgGenl2-1" ) );
    $const45$interArgGenl2_4 = constant_handles.reader_make_constant_shell( makeString( "interArgGenl2-4" ) );
    $const46$interArgNotGenl1_2 = constant_handles.reader_make_constant_shell( makeString( "interArgNotGenl1-2" ) );
    $str47$invalid_arg_not_genl_pred_index__ = makeString( "invalid arg-not-genl-pred index: ~s-~s" );
    $const48$interArgIsaGenl1_2 = constant_handles.reader_make_constant_shell( makeString( "interArgIsaGenl1-2" ) );
    $str49$invalid_arg_isa_genl_pred_index__ = makeString( "invalid arg-isa-genl-pred index: ~s-~s" );
    $const50$interArgIsaGenl2_1 = constant_handles.reader_make_constant_shell( makeString( "interArgIsaGenl2-1" ) );
    $const51$interArgIsaGenl2_3 = constant_handles.reader_make_constant_shell( makeString( "interArgIsaGenl2-3" ) );
    $const52$interArgIsaGenl3_2 = constant_handles.reader_make_constant_shell( makeString( "interArgIsaGenl3-2" ) );
    $str53$invalid_arg_genl_isa_pred_index__ = makeString( "invalid arg-genl-isa-pred index: ~s-~s" );
    $const54$interArgGenlIsa2_1 = constant_handles.reader_make_constant_shell( makeString( "interArgGenlIsa2-1" ) );
    $const55$TruthFunction = constant_handles.reader_make_constant_shell( makeString( "TruthFunction" ) );
    $const56$ArgIsaBinaryPredicate = constant_handles.reader_make_constant_shell( makeString( "ArgIsaBinaryPredicate" ) );
    $const57$ArgIsaTernaryPredicate = constant_handles.reader_make_constant_shell( makeString( "ArgIsaTernaryPredicate" ) );
    $const58$ArgIsaPredicate = constant_handles.reader_make_constant_shell( makeString( "ArgIsaPredicate" ) );
    $const59$ArgGenlBinaryPredicate = constant_handles.reader_make_constant_shell( makeString( "ArgGenlBinaryPredicate" ) );
    $const60$ArgGenlTernaryPredicate = constant_handles.reader_make_constant_shell( makeString( "ArgGenlTernaryPredicate" ) );
    $const61$ArgGenlPredicate = constant_handles.reader_make_constant_shell( makeString( "ArgGenlPredicate" ) );
    $sym62$INTEGERP = makeSymbol( "INTEGERP" );
    $const63$Collection = constant_handles.reader_make_constant_shell( makeString( "Collection" ) );
    $kw64$STRONG_FORT = makeKeyword( "STRONG-FORT" );
    $kw65$ISA = makeKeyword( "ISA" );
    $const66$genls = constant_handles.reader_make_constant_shell( makeString( "genls" ) );
    $const67$Thing = constant_handles.reader_make_constant_shell( makeString( "Thing" ) );
    $kw68$GENLS = makeKeyword( "GENLS" );
    $sym69$TREE_POSITION_P = makeSymbol( "TREE-POSITION-P" );
    $sym70$CYCL_FORMULA_ = makeSymbol( "CYCL-FORMULA?" );
    $kw71$EL_VAR = makeKeyword( "EL-VAR" );
    $sym72$RELEVANT_MT_IS_SPEC_MT = makeSymbol( "RELEVANT-MT-IS-SPEC-MT" );
    $sym73$GATHER_VIA_MAP_PRED_INDEX = makeSymbol( "GATHER-VIA-MAP-PRED-INDEX" );
    $sym74$GATHER_ASSERTIONS = makeSymbol( "GATHER-ASSERTIONS" );
    $kw75$TRUE = makeKeyword( "TRUE" );
    $sym76$_SOME_INTER_ARG_ISA_ASSERTION_SOMEWHERE_CACHE_ = makeSymbol( "*SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE-CACHE*" );
    ...
    $str79$Initializing___interArgIsa_cache = makeString( "Initializing #$interArgIsa cache" );
    $str80$cdolist = makeString( "cdolist" );
    $kw81$GAF = makeKeyword( "GAF" );
    $const82$genlPreds = constant_handles.reader_make_constant_shell( makeString( "genlPreds" ) );
    $kw83$DEPTH = makeKeyword( "DEPTH" );
    $kw84$STACK = makeKeyword( "STACK" );
    $kw85$QUEUE = makeKeyword( "QUEUE" );
    $sym86$RELEVANT_SBHL_TV_IS_GENERAL_TV = makeSymbol( "RELEVANT-SBHL-TV-IS-GENERAL-TV" );
    $kw87$ERROR = makeKeyword( "ERROR" );
    $str88$_A_is_not_a__A = makeString( "~A is not a ~A" );
    $sym89$SBHL_TRUE_TV_P = makeSymbol( "SBHL-TRUE-TV-P" );
    $kw90$CERROR = makeKeyword( "CERROR" );
    $str91$continue_anyway = makeString( "continue anyway" );
    $kw92$WARN = makeKeyword( "WARN" );
    $str93$_A_is_not_a_valid__sbhl_type_erro = makeString( "~A is not a valid *sbhl-type-error-action* value" );
    $str94$_A_is_neither_SET_P_nor_LISTP_ = makeString( "~A is neither SET-P nor LISTP." );
    $str95$attempting_to_bind_direction_link = makeString( "attempting to bind direction link variable, to NIL. macro body not executed." );
    $str96$Node__a_does_not_pass_sbhl_type_t = makeString( "Node ~a does not pass sbhl-type-test ~a~%" );
    $sym97$_SOME_INTER_ARG_FORMAT_ASSERTION_SOMEWHERE_CACHE_ = makeSymbol( "*SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE-CACHE*" );
    $str98$Initializing___interArgFormat_cac = makeString( "Initializing #$interArgFormat cache" );
    $const99$GenericArgTemplate = constant_handles.reader_make_constant_shell( makeString( "GenericArgTemplate" ) );
    $const100$KeywordVariableTemplate = constant_handles.reader_make_constant_shell( makeString( "KeywordVariableTemplate" ) );
    $str101$got_an_arg_type_predicate___s__th = makeString( "got an arg-type predicate (~s) that's neither binary nor ternary in ~s" );
    $kw102$FORMAT = makeKeyword( "FORMAT" );
    $kw103$DIFFERENT = makeKeyword( "DIFFERENT" );
    $kw104$AT_MAPPING_DONE = makeKeyword( "AT-MAPPING-DONE" );
    $sym105$AT_ERROR = makeSymbol( "AT-ERROR" );
    $sym106$AT_NOTE = makeSymbol( "AT-NOTE" );
    $str107$__at_test_fails___s_fails__s_cons = makeString( "~%at test fails: ~s fails ~s constraint ~s" );
    $str108$__at_test_fails___s_fails__s_cons = makeString( "~%at test fails: ~s fails ~s constraint ~s for arg ~s of reln ~s" );
    $kw109$IRREFLEXIVE_PREDICATE = makeKeyword( "IRREFLEXIVE-PREDICATE" );
    $kw110$ASYMMETRIC_PREDICATE = makeKeyword( "ASYMMETRIC-PREDICATE" );
    $kw111$ANTI_SYMMETRIC_PREDICATE = makeKeyword( "ANTI-SYMMETRIC-PREDICATE" );
    $kw112$ANTI_TRANSITIVE_PREDICATE = makeKeyword( "ANTI-TRANSITIVE-PREDICATE" );
    $kw113$NEGATION_PREDS = makeKeyword( "NEGATION-PREDS" );
    $kw114$NEGATION_INVERSES = makeKeyword( "NEGATION-INVERSES" );
    $str115$illegal_value_of__at_mode____s = makeString( "illegal value of *at-mode*: ~s" );
    $kw116$PREDICATE_ISA_VIOLATION = makeKeyword( "PREDICATE-ISA-VIOLATION" );
    $kw117$META_PREDICATE_VIOLATION = makeKeyword( "META-PREDICATE-VIOLATION" );
    $kw118$MAL_ARG_WRT_COL_DEFN = makeKeyword( "MAL-ARG-WRT-COL-DEFN" );
    $const119$CycLSentence_Assertible = constant_handles.reader_make_constant_shell( makeString( "CycLSentence-Assertible" ) );
    $kw120$MAL_ARG_WRT_NEC_DEFN = makeKeyword( "MAL-ARG-WRT-NEC-DEFN" );
    $kw121$CHANGE_MT = makeKeyword( "CHANGE-MT" );
    $sym122$ASSERTION_ARG_VIOLATION_ = makeSymbol( "ASSERTION-ARG-VIOLATION?" );
    $sym123$SEF_VIOLATION_ = makeSymbol( "SEF-VIOLATION?" );
    $sym124$PREDICATE_VIOLATION_ = makeSymbol( "PREDICATE-VIOLATION?" );
    $kw125$MAL_ARG_WRT_IFF_DEFN = makeKeyword( "MAL-ARG-WRT-IFF-DEFN" );
    $list126 = ConsesLow.listS( makeSymbol( "ARG" ), new SubLObject[] { makeSymbol( "RELN" ), makeSymbol( "ARGNUM" ), makeSymbol( "COL" ), makeSymbol( "DEFN" ), makeSymbol( "MT" ), makeSymbol( "DATA" )
    } );
    $sym127$CYC_ASSERTION = makeSymbol( "CYC-ASSERTION" );
    $const128$CycLAssertion = constant_handles.reader_make_constant_shell( makeString( "CycLAssertion" ) );
    $kw129$MAL_ARG_WRT_ARG_FORMAT = makeKeyword( "MAL-ARG-WRT-ARG-FORMAT" );
    $kw130$MAL_ARG_WRT_INTER_ARG_FORMAT = makeKeyword( "MAL-ARG-WRT-INTER-ARG-FORMAT" );
    $kw131$REPLACE_TERM = makeKeyword( "REPLACE-TERM" );
    $const132$ist = constant_handles.reader_make_constant_shell( makeString( "ist" ) );
    $list133 = ConsesLow.list( makeSymbol( "ARG" ), makeSymbol( "REL" ), makeSymbol( "POS" ), makeSymbol( "FORMAT" ), makeSymbol( "MT" ), makeSymbol( "VIOLATIONS" ), makeSymbol( "&OPTIONAL" ), makeSymbol( "VIA" ) );
    $kw134$ASSERT = makeKeyword( "ASSERT" );
    $const135$equals = constant_handles.reader_make_constant_shell( makeString( "equals" ) );
    $list136 = ConsesLow.list( new SubLObject[] { makeSymbol( "ARG" ), makeSymbol( "REL" ), makeSymbol( "POS" ), makeSymbol( "FORMAT" ), makeSymbol( "IND-ARG-ISA" ), makeSymbol( "IND-POS" ), makeSymbol( "IND-ARG" ),
      makeSymbol( "MT" ), makeSymbol( "VIOLATIONS" ), makeSymbol( "&OPTIONAL" ), makeSymbol( "VIA" )
    } );
    $list137 = ConsesLow.list( makeSymbol( "PREDICATE" ), makeSymbol( "ISA" ), makeSymbol( "MT" ), makeSymbol( "&OPTIONAL" ), makeSymbol( "VIOLATIONS" ) );
    $kw138$UNASSERT = makeKeyword( "UNASSERT" );
    $int139$40 = makeInteger( 40 );
    $sym140$CONSTANT_P = makeSymbol( "CONSTANT-P" );
    $sym141$_ = makeSymbol( ">" );
    $sym142$SPEC_CARDINALITY = makeSymbol( "SPEC-CARDINALITY" );
    $sym143$CACHED_MAX_FLOOR_MTS_OF_NAT = makeSymbol( "CACHED-MAX-FLOOR-MTS-OF-NAT" );
    $sym144$_CACHED_MAX_FLOOR_MTS_OF_NAT_CACHING_STATE_ = makeSymbol( "*CACHED-MAX-FLOOR-MTS-OF-NAT-CACHING-STATE*" );
    $int145$64 = makeInteger( 64 );
    $const146$Microtheory = constant_handles.reader_make_constant_shell( makeString( "Microtheory" ) );
    $kw147$IGNORE = makeKeyword( "IGNORE" );
    $const148$Kappa = constant_handles.reader_make_constant_shell( makeString( "Kappa" ) );
    $const149$UniversalVocabularyMt = constant_handles.reader_make_constant_shell( makeString( "UniversalVocabularyMt" ) );
    $sym150$RELEVANT_MT_IS_GENL_MT = makeSymbol( "RELEVANT-MT-IS-GENL-MT" );
    $str151$___S_____S_____s__ = makeString( "~&~S~%  ~S~%  ~s~%" );
    $str152$mapping_Cyc_arguments = makeString( "mapping Cyc arguments" );
    $sym153$STRINGP = makeSymbol( "STRINGP" );
    $kw154$SKIP = makeKeyword( "SKIP" );
    $const155$admittedArgument = constant_handles.reader_make_constant_shell( makeString( "admittedArgument" ) );
    $const156$Function_Denotational = constant_handles.reader_make_constant_shell( makeString( "Function-Denotational" ) );
    $const157$Relation = constant_handles.reader_make_constant_shell( makeString( "Relation" ) );
    $sym158$WARN = makeSymbol( "WARN" );
    $const159$AtemporalNecessarilyEssentialColl = constant_handles.reader_make_constant_shell( makeString( "AtemporalNecessarilyEssentialCollectionType" ) );
    $const160$argIsa = constant_handles.reader_make_constant_shell( makeString( "argIsa" ) );
    $const161$argGenl = constant_handles.reader_make_constant_shell( makeString( "argGenl" ) );
    $sym162$VARIABLE_ARITY_RELATION_P = makeSymbol( "VARIABLE-ARITY-RELATION-P" );
    $const163$argsIsa = constant_handles.reader_make_constant_shell( makeString( "argsIsa" ) );
    $const164$argsGenl = constant_handles.reader_make_constant_shell( makeString( "argsGenl" ) );
    $sym165$RELATION_P = makeSymbol( "RELATION-P" );
    $sym166$FORT_P = makeSymbol( "FORT-P" );
    $sym167$POSITIVE_INTEGER_P = makeSymbol( "POSITIVE-INTEGER-P" );
    $const168$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $list169 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "Relation" ) ) );
    $sym170$CYC_VAR_ = makeSymbol( "CYC-VAR?" );
    $sym171$VARIABLE_BINDING_SET_ITEM_COMPARATOR = makeSymbol( "VARIABLE-BINDING-SET-ITEM-COMPARATOR" );
    $int172$100 = makeInteger( 100 );
    $float173$0_01 = makeDouble( 0.01 );
    $const174$Number_General = constant_handles.reader_make_constant_shell( makeString( "Number-General" ) );
    $sym175$ALL_RELATION_CONSTRAINT_SENTENCES = makeSymbol( "ALL-RELATION-CONSTRAINT-SENTENCES" );
    $kw176$TEST = makeKeyword( "TEST" );
    $kw177$OWNER = makeKeyword( "OWNER" );
    $kw178$CLASSES = makeKeyword( "CLASSES" );
    $kw179$KB = makeKeyword( "KB" );
    $kw180$FULL = makeKeyword( "FULL" );
    $kw181$WORKING_ = makeKeyword( "WORKING?" );
    $list182 = ConsesLow.list( ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "isa" ) ) ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell(
        makeString( "arity" ) ), constant_handles.reader_make_constant_shell( makeString( "isa" ) ), TWO_INTEGER ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "argIsa" ) ), constant_handles
            .reader_make_constant_shell( makeString( "isa" ) ), ONE_INTEGER, constant_handles.reader_make_constant_shell( makeString( "Thing" ) ) ), ConsesLow.list( constant_handles.reader_make_constant_shell(
                makeString( "argIsa" ) ), constant_handles.reader_make_constant_shell( makeString( "isa" ) ), TWO_INTEGER, constant_handles.reader_make_constant_shell( makeString( "Collection" ) ) ), ConsesLow.list(
                    constant_handles.reader_make_constant_shell( makeString( "argGenl" ) ), constant_handles.reader_make_constant_shell( makeString( "isa" ) ), TWO_INTEGER, constant_handles.reader_make_constant_shell(
                        makeString( "Thing" ) ) ) ) ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "PlusFn" ) ) ), ConsesLow.list( ConsesLow.list( constant_handles
                            .reader_make_constant_shell( makeString( "arityMin" ) ), constant_handles.reader_make_constant_shell( makeString( "PlusFn" ) ), ONE_INTEGER ), ConsesLow.list( constant_handles
                                .reader_make_constant_shell( makeString( "argsIsa" ) ), constant_handles.reader_make_constant_shell( makeString( "PlusFn" ) ), constant_handles.reader_make_constant_shell( makeString(
                                    "ScalarInterval" ) ) ) ) ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "GramsPerLiter" ) ) ), ConsesLow.list( ConsesLow.list(
                                        constant_handles.reader_make_constant_shell( makeString( "arityMin" ) ), constant_handles.reader_make_constant_shell( makeString( "GramsPerLiter" ) ), ONE_INTEGER ), ConsesLow
                                            .list( constant_handles.reader_make_constant_shell( makeString( "arityMax" ) ), constant_handles.reader_make_constant_shell( makeString( "GramsPerLiter" ) ), TWO_INTEGER ),
                                        ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "argIsa" ) ), constant_handles.reader_make_constant_shell( makeString( "GramsPerLiter" ) ), ONE_INTEGER,
                                            constant_handles.reader_make_constant_shell( makeString( "NumericInterval" ) ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "argIsa" ) ),
                                                constant_handles.reader_make_constant_shell( makeString( "GramsPerLiter" ) ), TWO_INTEGER, constant_handles.reader_make_constant_shell( makeString(
                                                    "NumericInterval" ) ) ) ) ) );
    $sym183$ALL_RELATION_ARG_CONSTRAINT_SENTENCES = makeSymbol( "ALL-RELATION-ARG-CONSTRAINT-SENTENCES" );
    $kw184$TINY = makeKeyword( "TINY" );
    $list185 = ConsesLow.list( ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "isa" ) ) ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell(
        makeString( "argIsa" ) ), constant_handles.reader_make_constant_shell( makeString( "isa" ) ), ONE_INTEGER, constant_handles.reader_make_constant_shell( makeString( "Thing" ) ) ), ConsesLow.list( constant_handles
            .reader_make_constant_shell( makeString( "argIsa" ) ), constant_handles.reader_make_constant_shell( makeString( "isa" ) ), TWO_INTEGER, constant_handles.reader_make_constant_shell( makeString(
                "Collection" ) ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "argGenl" ) ), constant_handles.reader_make_constant_shell( makeString( "isa" ) ), TWO_INTEGER,
                    constant_handles.reader_make_constant_shell( makeString( "Thing" ) ) ) ) ) );
    $sym186$FORMULA_ARG_CONSTRAINTS_CYCL = makeSymbol( "FORMULA-ARG-CONSTRAINTS-CYCL" );
    $list187 = ConsesLow.list( ConsesLow.list( ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "isa" ) ), constant_handles.reader_make_constant_shell( makeString( "Thing" ) ),
        makeSymbol( "?X" ) ) ), ConsesLow.list( ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "isa" ) ), constant_handles.reader_make_constant_shell( makeString( "Thing" ) ), constant_handles
            .reader_make_constant_shell( makeString( "Thing" ) ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "isa" ) ), makeSymbol( "?X" ), constant_handles.reader_make_constant_shell(
                makeString( "Collection" ) ) ), ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "genls" ) ), makeSymbol( "?X" ), constant_handles.reader_make_constant_shell( makeString(
                    "Thing" ) ) ) ) ) );
    $str188$Arg_Type_Utilities_Test_Suite = makeString( "Arg-Type Utilities Test Suite" );
    $list189 = ConsesLow.list( makeSymbol( "GENERIC-ARG-TEST-CASE" ) );
  }
}
/*
 * 
