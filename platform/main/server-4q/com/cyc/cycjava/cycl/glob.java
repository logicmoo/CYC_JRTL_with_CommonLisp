...
import static com.cyc.cycjava.cycl.glob.*;
...
public final class glob extends SubLTranslatedFile {
    ...
    public static SubLObject glob_p(final SubLObject v_object) {
        return v_object.getClass() == glob.$glob_native.class ? T : NIL;
    }

    public static SubLObject glob_struc_test(final SubLObject v_object) {
        assert NIL != glob_p(v_object) : "glob.glob_p(v_object) " + "CommonSymbols.NIL != glob.glob_p(v_object) " + v_object;
    ...
    public static SubLObject make_glob(SubLObject arglist) {
        ...
        final SubLObject v_new = new glob.$glob_native();
        SubLObject next;
    ...
    public static final class $glob_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(glob.$glob_native.class, GLOB, GLOB_P, $list2, $list3, new String[]{ "$test", "$max_size", "$id_state", "$lock", "$index", "$back_index", "$owner" }, $list4, $list5, PRINT_GLOB);
        }
    }
