...
import com.cyc.cycjava.cycl.fact_sheet_logs;
...
import static com.cyc.cycjava.cycl.fact_sheet_logs.*;
...
public final class fact_sheet_logs extends SubLTranslatedFile {
    ...
    private static final SubLList $list95 = list(new SubLObject[]{ makeKeyword("VERBOSITY"), makeKeyword("TERM"), makeKeyword("STATUS"), makeKeyword("START-DATE"), makeKeyword("START-TIME"), makeKeyword("END-DATE"), makeKeyword("END-TIME"), makeKeyword("QUERY-TIMEOUTS"), makeKeyword("QUERY-TIMEOUT-INFO"), makeKeyword("MISC-SENTENCE-COUNT"), makeKeyword("MISC-SENTENCE-TIME"), makeKeyword("FILTERED-REDUNDANT-FACT-COUNT"), makeKeyword("CATEGORY-COUNT"), makeKeyword("INFO-GATHERING-TIME"), makeKeyword("PPH-PARAGRAPH-COUNT"), makeKeyword("PPH-SENTENCE-COUNT"), makeKeyword("PPH-FAILURE-COUNT"), makeKeyword("PPH-TIME"), makeKeyword("TOTAL-TIME") });
    ...
    public static SubLObject declare_fact_sheet_logs_file() {
        declareFunction(me, "fact_sheet_log_stream", "FACT-SHEET-LOG-STREAM", 0, 0, false);
        declareMacro(me, "with_quiet_fact_sheet_logging", "WITH-QUIET-FACT-SHEET-LOGGING");
        declareMacro(me, "log_fact_sheet_message", "LOG-FACT-SHEET-MESSAGE");
        declareFunction(me, "print_fact_sheet_log_header", "PRINT-FACT-SHEET-LOG-HEADER", 2, 0, false);
        declareMacro(me, "log_fact_sheet_warning", "LOG-FACT-SHEET-WARNING");
        declareMacro(me, "log_fact_sheet_note", "LOG-FACT-SHEET-NOTE");
        declareMacro(me, "with_fact_sheet_log_file", "WITH-FACT-SHEET-LOG-FILE");
        declareMacro(me, "with_fact_sheet_logging", "WITH-FACT-SHEET-LOGGING");
        declareFunction(me, "note_fact_sheet_log_file_closed", "NOTE-FACT-SHEET-LOG-FILE-CLOSED", 0, 1, false);
        declareFunction(me, "fact_sheet_log_file_closed_p", "FACT-SHEET-LOG-FILE-CLOSED-P", 1, 0, false);
        declareFunction(me, "hourly_fact_sheet_stats", "HOURLY-FACT-SHEET-STATS", 0, 0, false);
        declareMacro(me, "with_fact_sheet_logging_and_hourly_reporting", "WITH-FACT-SHEET-LOGGING-AND-HOURLY-REPORTING");
        declareFunction(me, "fact_sheet_hourly_reporting_onP", "FACT-SHEET-HOURLY-REPORTING-ON?", 0, 0, false);
        declareFunction(me, "reset_hourly_report_time", "RESET-HOURLY-REPORT-TIME", 0, 1, false);
        declareFunction(me, "clear_hourly_fact_sheet_stats", "CLEAR-HOURLY-FACT-SHEET-STATS", 0, 0, false);
        declareFunction(me, "add_fact_sheet_info_to_hourly_stats", "ADD-FACT-SHEET-INFO-TO-HOURLY-STATS", 1, 0, false);
        declareFunction(me, "get_hourly_fact_sheet_update_count", "GET-HOURLY-FACT-SHEET-UPDATE-COUNT", 0, 0, false);
        declareFunction(me, "clear_hourly_fact_sheet_update_count", "CLEAR-HOURLY-FACT-SHEET-UPDATE-COUNT", 0, 0, false);
        declareFunction(me, "note_fact_sheet_query_timeout_in_hourly_stats", "NOTE-FACT-SHEET-QUERY-TIMEOUT-IN-HOURLY-STATS", 0, 0, false);
        declareFunction(me, "get_hourly_fact_sheet_query_timeout_count", "GET-HOURLY-FACT-SHEET-QUERY-TIMEOUT-COUNT", 0, 0, false);
        declareFunction(me, "clear_hourly_fact_sheet_query_timeout_count", "CLEAR-HOURLY-FACT-SHEET-QUERY-TIMEOUT-COUNT", 0, 0, false);
        declareFunction(me, "maybe_log_fact_sheet_hourly_report", "MAYBE-LOG-FACT-SHEET-HOURLY-REPORT", 0, 0, false);
        declareFunction(me, "log_fact_sheet_hourly_report", "LOG-FACT-SHEET-HOURLY-REPORT", 0, 0, false);
        declareFunction(me, "fact_sheet_log_directory_generated_count", "FACT-SHEET-LOG-DIRECTORY-GENERATED-COUNT", 1, 0, false);
        declareFunction(me, "fact_sheet_log_file_generated_count", "FACT-SHEET-LOG-FILE-GENERATED-COUNT", 1, 1, false);
        declareFunction(me, "fact_sheet_log_directory_average_total_time", "FACT-SHEET-LOG-DIRECTORY-AVERAGE-TOTAL-TIME", 1, 0, false);
        declareFunction(me, "fact_sheet_log_file_count_and_total_time", "FACT-SHEET-LOG-FILE-COUNT-AND-TOTAL-TIME", 1, 1, false);
        declareFunction(me, "plot_fact_sheet_log_directory_generated_count_by_date", "PLOT-FACT-SHEET-LOG-DIRECTORY-GENERATED-COUNT-BY-DATE", 1, 2, false);
        declareFunction(me, "fact_sheet_log_directory_generated_count_by_date", "FACT-SHEET-LOG-DIRECTORY-GENERATED-COUNT-BY-DATE", 1, 1, false);
        declareFunction(me, "fact_sheet_log_file_generated_count_by_date", "FACT-SHEET-LOG-FILE-GENERATED-COUNT-BY-DATE", 1, 2, false);
        declareFunction(me, "fact_sheet_log_directory_average_total_time_by_date", "FACT-SHEET-LOG-DIRECTORY-AVERAGE-TOTAL-TIME-BY-DATE", 1, 1, false);
        declareFunction(me, "fact_sheet_log_file_average_total_time_by_date", "FACT-SHEET-LOG-FILE-AVERAGE-TOTAL-TIME-BY-DATE", 1, 2, false);
        declareFunction(me, "fact_sheet_log_directory_average_category_count_by_date", "FACT-SHEET-LOG-DIRECTORY-AVERAGE-CATEGORY-COUNT-BY-DATE", 1, 1, false);
        declareFunction(me, "fact_sheet_log_file_average_category_count_by_date", "FACT-SHEET-LOG-FILE-AVERAGE-CATEGORY-COUNT-BY-DATE", 1, 2, false);
        declareFunction(me, "fact_sheet_log_directory_average_sentence_count_by_date", "FACT-SHEET-LOG-DIRECTORY-AVERAGE-SENTENCE-COUNT-BY-DATE", 1, 1, false);
        declareFunction(me, "fact_sheet_log_file_average_sentence_count_by_date", "FACT-SHEET-LOG-FILE-AVERAGE-SENTENCE-COUNT-BY-DATE", 1, 2, false);
        declareFunction(me, "fact_sheet_log_directory_average_uncategorized_sentence_count_by_date", "FACT-SHEET-LOG-DIRECTORY-AVERAGE-UNCATEGORIZED-SENTENCE-COUNT-BY-DATE", 1, 1, false);
        declareFunction(me, "fact_sheet_log_file_average_uncategorized_sentence_count_by_date", "FACT-SHEET-LOG-FILE-AVERAGE-UNCATEGORIZED-SENTENCE-COUNT-BY-DATE", 1, 2, false);
        declareFunction(me, "plot_fact_sheet_log_directory_query_failure_rate_by_date", "PLOT-FACT-SHEET-LOG-DIRECTORY-QUERY-FAILURE-RATE-BY-DATE", 1, 3, false);
        declareFunction(me, "fact_sheet_log_directory_query_failure_rate_by_date", "FACT-SHEET-LOG-DIRECTORY-QUERY-FAILURE-RATE-BY-DATE", 1, 1, false);
        declareFunction(me, "fact_sheet_log_file_query_failure_rate_by_date", "FACT-SHEET-LOG-FILE-QUERY-FAILURE-RATE-BY-DATE", 1, 2, false);
        declareFunction(me, "fact_sheet_log_directory_generated_count_for_date", "FACT-SHEET-LOG-DIRECTORY-GENERATED-COUNT-FOR-DATE", 1, 1, false);
        declareFunction(me, "fact_sheet_log_file_generated_count_for_date", "FACT-SHEET-LOG-FILE-GENERATED-COUNT-FOR-DATE", 1, 2, false);
        declareFunction(me, "fact_sheet_log_file_generated_count_old", "FACT-SHEET-LOG-FILE-GENERATED-COUNT-OLD", 1, 0, false);
        declareFunction(me, "fact_sheet_log_file_generated_count_for_date_old", "FACT-SHEET-LOG-FILE-GENERATED-COUNT-FOR-DATE-OLD", 1, 1, false);
        declareFunction(me, "get_fact_sheet_log_file_data", "GET-FACT-SHEET-LOG-FILE-DATA", 1, 0, false);
        declareFunction(me, "get_fact_sheet_log_directory_data", "GET-FACT-SHEET-LOG-DIRECTORY-DATA", 1, 1, false);
        declareFunction(me, "clear_get_fact_sheet_log_directory_data_cached", "CLEAR-GET-FACT-SHEET-LOG-DIRECTORY-DATA-CACHED", 0, 0, false);
        declareFunction(me, "remove_get_fact_sheet_log_directory_data_cached", "REMOVE-GET-FACT-SHEET-LOG-DIRECTORY-DATA-CACHED", 2, 0, false);
        declareFunction(me, "get_fact_sheet_log_directory_data_cached_internal", "GET-FACT-SHEET-LOG-DIRECTORY-DATA-CACHED-INTERNAL", 2, 0, false);
        declareFunction(me, "get_fact_sheet_log_directory_data_cached", "GET-FACT-SHEET-LOG-DIRECTORY-DATA-CACHED", 2, 0, false);
        declareFunction(me, "find_or_create_fact_sheet_log_directory_data_file", "FIND-OR-CREATE-FACT-SHEET-LOG-DIRECTORY-DATA-FILE", 1, 1, false);
        declareFunction(me, "ensure_fact_sheet_log_directories_are_up_to_date", "ENSURE-FACT-SHEET-LOG-DIRECTORIES-ARE-UP-TO-DATE", 0, 0, false);
        declareFunction(me, "parse_and_save_fact_sheet_log_directory_data", "PARSE-AND-SAVE-FACT-SHEET-LOG-DIRECTORY-DATA", 1, 0, false);
        declareFunction(me, "parse_and_save_fact_sheet_log_file_data", "PARSE-AND-SAVE-FACT-SHEET-LOG-FILE-DATA", 1, 2, false);
        declareFunction(me, "fact_sheet_log_file_parsed_data_filename", "FACT-SHEET-LOG-FILE-PARSED-DATA-FILENAME", 1, 0, false);
        declareFunction(me, "fact_sheet_log_directory_parsed_data_filename", "FACT-SHEET-LOG-DIRECTORY-PARSED-DATA-FILENAME", 1, 0, false);
        declareFunction(me, "fact_sheet_log_file_parse_data", "FACT-SHEET-LOG-FILE-PARSE-DATA", 1, 0, false);
        declareFunction(me, "fact_sheet_log_line_starts_withP", "FACT-SHEET-LOG-LINE-STARTS-WITH?", 3, 0, false);
        declareFunction(me, "fact_sheet_log_file_parse_start_line_data", "FACT-SHEET-LOG-FILE-PARSE-START-LINE-DATA", 1, 0, false);
        declareFunction(me, "fact_sheet_log_file_parse_stale_start_line_data", "FACT-SHEET-LOG-FILE-PARSE-STALE-START-LINE-DATA", 2, 0, false);
        declareFunction(me, "fact_sheet_log_file_parse_dequeue_line_data", "FACT-SHEET-LOG-FILE-PARSE-DEQUEUE-LINE-DATA", 2, 0, false);
        declareFunction(me, "fact_sheet_log_file_parse_new_query_timeout_line_data", "FACT-SHEET-LOG-FILE-PARSE-NEW-QUERY-TIMEOUT-LINE-DATA", 1, 0, false);
        declareFunction(me, "update_current_datum_for_misc_sentence_stats", "UPDATE-CURRENT-DATUM-FOR-MISC-SENTENCE-STATS", 3, 0, false);
        declareFunction(me, "update_current_datum_for_pph_stats", "UPDATE-CURRENT-DATUM-FOR-PPH-STATS", 3, 0, false);
        declareFunction(me, "update_current_datum_for_pph_failure_stats", "UPDATE-CURRENT-DATUM-FOR-PPH-FAILURE-STATS", 3, 0, false);
        declareFunction(me, "update_current_datum_for_info_gather_stats", "UPDATE-CURRENT-DATUM-FOR-INFO-GATHER-STATS", 3, 0, false);
        declareFunction(me, "finalize_current_datum", "FINALIZE-CURRENT-DATUM", 3, 0, false);
        declareFunction(me, "compute_total_time_from_start_and_end", "COMPUTE-TOTAL-TIME-FROM-START-AND-END", 1, 0, false);
        declareFunction(me, "term_from_fact_sheet_log_finish_line", "TERM-FROM-FACT-SHEET-LOG-FINISH-LINE", 2, 0, false);
        declareFunction(me, "add_total_time_to_datum", "ADD-TOTAL-TIME-TO-DATUM", 1, 1, false);
        declareFunction(me, "add_end_date_and_time_to_datum", "ADD-END-DATE-AND-TIME-TO-DATUM", 2, 0, false);
        declareFunction(me, "fact_sheet_term_from_string", "FACT-SHEET-TERM-FROM-STRING", 1, 3, false);
        declareFunction(me, "nart_end_from_string", "NART-END-FROM-STRING", 2, 0, false);
        declareFunction(me, "open_new_unique_fact_sheet_log_file", "OPEN-NEW-UNIQUE-FACT-SHEET-LOG-FILE", 0, 0, false);
        declareFunction(me, "fact_sheet_log_directory_path_for_kb", "FACT-SHEET-LOG-DIRECTORY-PATH-FOR-KB", 0, 1, false);
        declareFunction(me, "uniquify_fact_sheet_log_filename", "UNIQUIFY-FACT-SHEET-LOG-FILENAME", 3, 0, false);
        declareFunction(me, "physical_directory_from_path", "PHYSICAL-DIRECTORY-FROM-PATH", 1, 0, false);
        return NIL;
    }
