...
public final class document extends SubLTranslatedFile {
    ...
    public static SubLObject sign_p(final SubLObject v_object) {
        return v_object.getClass() == document.$sign_native.class ? T : NIL;
    }

    public static SubLObject sign_string(final SubLObject v_object) {
        assert NIL != sign_p(v_object) : "document.sign_p(v_object) " + "CommonSymbols.NIL != document.sign_p(v_object) " + v_object;
    ...
    public static SubLObject make_sign(SubLObject arglist) {
        ...
        final SubLObject v_new = new document.$sign_native();
        SubLObject next;
    ...
    public static SubLObject html_string_wordify_state_p(final SubLObject v_object) {
        return v_object.getClass() == document.$html_string_wordify_state_native.class ? T : NIL;
    }

    public static SubLObject hsw_state_state(final SubLObject v_object) {
        assert NIL != html_string_wordify_state_p(v_object) : "document.html_string_wordify_state_p(v_object) " + "CommonSymbols.NIL != document.html_string_wordify_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_html_string_wordify_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new document.$html_string_wordify_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject paragraph_p(final SubLObject v_object) {
        return v_object.getClass() == document.$paragraph_native.class ? T : NIL;
    }

    public static SubLObject paragraph_sentences(final SubLObject v_object) {
        assert NIL != paragraph_p(v_object) : "document.paragraph_p(v_object) " + "CommonSymbols.NIL != document.paragraph_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_paragraph(SubLObject arglist) {
        ...
        final SubLObject v_new = new document.$paragraph_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject document_p(final SubLObject v_object) {
        return v_object.getClass() == document.$document_native.class ? T : NIL;
    }

    public static SubLObject document_paragraphs(final SubLObject v_object) {
        assert NIL != document_p(v_object) : "document.document_p(v_object) " + "CommonSymbols.NIL != document.document_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_document(SubLObject arglist) {
        ...
        final SubLObject v_new = new document.$document_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $sign_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(document.$sign_native.class, SIGN, SIGN_P, $list3, $list4, new String[]{ "$string", "$type", "$info", "$category", "$constituents", "$offset", "$mother" }, $list5, $list6, SIGN_PRINT);
        }
    }
    ...
    public static final class $html_string_wordify_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(document.$html_string_wordify_state_native.class, HTML_STRING_WORDIFY_STATE, HTML_STRING_WORDIFY_STATE_P, $list80, $list81, new String[]{ "$state", "$tag_pieces", "$string_pieces", "$punctuation_pieces", "$leading_tags", "$following_tags", "$current_offset" }, $list82, $list83, PRINT_HSW_STATE);
        }
    }
    ...
    public static final class $paragraph_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(document.$paragraph_native.class, PARAGRAPH, PARAGRAPH_P, $list159, $list160, new String[]{ "$sentences", "$mother" }, $list161, $list162, PARAGRAPH_PRINT);
        }
    }
    ...
    public static final class $document_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(document.$document_native.class, DOCUMENT, DOCUMENT_P, $list185, $list186, new String[]{ "$paragraphs" }, $list187, $list188, DOCUMENT_PRINT);
        }
    }
