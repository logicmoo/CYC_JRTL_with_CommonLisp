...
public final class deck extends SubLTranslatedFile {
    ...
    public static SubLObject deck_p(final SubLObject v_object) {
        return v_object.getClass() == deck.$deck_native.class ? T : NIL;
    }

    public static SubLObject deck_type(final SubLObject v_object) {
        assert NIL != deck_p(v_object) : "deck.deck_p(v_object) " + "CommonSymbols.NIL != deck.deck_p(v_object) " + v_object;
    ...
    public static SubLObject make_deck(SubLObject arglist) {
        ...
        final SubLObject v_new = new deck.$deck_native();
        SubLObject next;
    ...
    public static final class $deck_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(deck.$deck_native.class, DECK, DECK_P, $list2, $list3, new String[]{ "$type", "$data" }, $list4, $list5, PRINT_DECK);
        }
    }
