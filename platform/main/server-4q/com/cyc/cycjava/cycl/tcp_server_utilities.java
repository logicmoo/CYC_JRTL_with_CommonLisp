...
import static com.cyc.cycjava.cycl.tcp_server_utilities.*;
...
public final class tcp_server_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject tcp_server_p(final SubLObject v_object) {
        return v_object.getClass() == tcp_server_utilities.$tcp_server_native.class ? T : NIL;
    }

    public static SubLObject tcps_type(final SubLObject v_object) {
        assert NIL != tcp_server_p(v_object) : "tcp_server_utilities.tcp_server_p(v_object) " + "CommonSymbols.NIL != tcp_server_utilities.tcp_server_p(v_object) " + v_object;
    ...
    public static SubLObject make_tcp_server(SubLObject arglist) {
        ...
        final SubLObject v_new = new tcp_server_utilities.$tcp_server_native();
        SubLObject next;
    ...
    public static final class $tcp_server_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(tcp_server_utilities.$tcp_server_native.class, TCP_SERVER, TCP_SERVER_P, $list26, $list27, new String[]{ "$type", "$port", "$process" }, $list28, $list29, PRINT_TCP_SERVER);
        }
    }
