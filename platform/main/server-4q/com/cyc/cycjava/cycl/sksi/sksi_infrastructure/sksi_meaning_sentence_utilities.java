...
public final class sksi_meaning_sentence_utilities extends SubLTranslatedFile {
    ...
    private static final SubLObject $const1$conditionalMeaningSentenceOfSchem = reader_make_constant_shell(makeString("conditionalMeaningSentenceOfSchema"));

    public static final SubLList $list2 = list(list(makeSymbol("LOGICAL-SCHEMA"), makeSymbol("MEANING-SENTENCE")), makeSymbol("MEANING-SENTENCE-GAF"), makeSymbol("&BODY"), makeSymbol("BODY"));



    public static final SubLSymbol GAF_ARGS = makeSymbol("GAF-ARGS");

    public static final SubLList $list5 = list(list(makeSymbol("ANTECEDENT-LOGICAL-SCHEMATA"), makeSymbol("ANTECEDENT-MEANING-SENTENCE"), makeSymbol("CONSEQUENT-LOGICAL-SCHEMATA"), makeSymbol("CONSEQUENT-MEANING-SENTENCE")), makeSymbol("CONDITIONAL-MEANING-SENTENCE-GAF"), makeSymbol("&BODY"), makeSymbol("BODY"));



    public static final SubLSymbol $sym7$GET_ANTECEDENT_LOGICAL_SCHEMATA_FROM_CONDITIONAL_MEANING_SENTENCE = makeSymbol("GET-ANTECEDENT-LOGICAL-SCHEMATA-FROM-CONDITIONAL-MEANING-SENTENCE-GAF");

    public static final SubLSymbol GET_ANTECEDENT_MEANING_SENTENCE_FROM_GAF = makeSymbol("GET-ANTECEDENT-MEANING-SENTENCE-FROM-GAF");

    public static final SubLSymbol $sym9$GET_CONSEQUENT_LOGICAL_SCHEMATA_FROM_CONDITIONAL_MEANING_SENTENCE = makeSymbol("GET-CONSEQUENT-LOGICAL-SCHEMATA-FROM-CONDITIONAL-MEANING-SENTENCE-GAF");

    public static final SubLSymbol GET_CONSEQUENT_MEANING_SENTENCE_FROM_GAF = makeSymbol("GET-CONSEQUENT-MEANING-SENTENCE-FROM-GAF");

    public static final SubLList $list11 = list(list(makeSymbol("ANTECEDENT-LOGICAL-SCHEMATA"), makeSymbol("ANTECEDENT-MEANING-SENTENCE"), makeSymbol("CONSEQUENT-LOGICAL-SCHEMATA"), makeSymbol("CONSEQUENT-MEANING-SENTENCE")), makeSymbol("CONDITIONAL-MEANING-SENTENCE"), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLSymbol GET_ANTECEDENT_LOGICAL_SCHEMATA_FROM_CONDITIONAL_MEANING_SENTENCE = makeSymbol("GET-ANTECEDENT-LOGICAL-SCHEMATA-FROM-CONDITIONAL-MEANING-SENTENCE");

    public static final SubLSymbol GET_ANTECEDENT_MEANING_SENTENCE_FROM_CONDITIONAL_MEANING_SENTENCE = makeSymbol("GET-ANTECEDENT-MEANING-SENTENCE-FROM-CONDITIONAL-MEANING-SENTENCE");

    public static final SubLSymbol GET_CONSEQUENT_LOGICAL_SCHEMATA_FROM_CONDITIONAL_MEANING_SENTENCE = makeSymbol("GET-CONSEQUENT-LOGICAL-SCHEMATA-FROM-CONDITIONAL-MEANING-SENTENCE");

    public static final SubLSymbol GET_CONSEQUENT_MEANING_SENTENCE_FROM_CONDITIONAL_MEANING_SENTENCE = makeSymbol("GET-CONSEQUENT-MEANING-SENTENCE-FROM-CONDITIONAL-MEANING-SENTENCE");

    public static final SubLSymbol GET_RELEVANT_MEANING_SENTENCE_FROM_GAF = makeSymbol("GET-RELEVANT-MEANING-SENTENCE-FROM-GAF");
    ...
    public static SubLObject declare_sksi_meaning_sentence_utilities_file() {
        declareFunction(me, "meaning_sentence_gaf_p", "MEANING-SENTENCE-GAF-P", 1, 0, false);
        declareFunction(me, "ordinary_meaning_sentence_gaf_p", "ORDINARY-MEANING-SENTENCE-GAF-P", 1, 0, false);
        declareFunction(me, "conditional_meaning_sentence_gaf_p", "CONDITIONAL-MEANING-SENTENCE-GAF-P", 1, 0, false);
        declareFunction(me, "gaf_assertion_is_conditional_meaning_sentence_gafP", "GAF-ASSERTION-IS-CONDITIONAL-MEANING-SENTENCE-GAF?", 1, 0, false);
        declareFunction(me, "get_logical_schema_from_meaning_sentence_gaf", "GET-LOGICAL-SCHEMA-FROM-MEANING-SENTENCE-GAF", 1, 0, false);
        declareFunction(me, "get_logical_schemata_from_meaning_sentence_gaf", "GET-LOGICAL-SCHEMATA-FROM-MEANING-SENTENCE-GAF", 1, 0, false);
        declareFunction(me, "get_meaning_sentence_from_gaf", "GET-MEANING-SENTENCE-FROM-GAF", 1, 1, false);
        declareFunction(me, "get_meaning_sentence_pred_from_gaf", "GET-MEANING-SENTENCE-PRED-FROM-GAF", 1, 1, false);
        declareMacro(me, "destructure_meaning_sentence_gaf", "DESTRUCTURE-MEANING-SENTENCE-GAF");
        declareFunction(me, "get_antecedent_logical_schemata_from_conditional_meaning_sentence_gaf", "GET-ANTECEDENT-LOGICAL-SCHEMATA-FROM-CONDITIONAL-MEANING-SENTENCE-GAF", 1, 0, false);
        declareFunction(me, "get_antecedent_meaning_sentence_from_gaf", "GET-ANTECEDENT-MEANING-SENTENCE-FROM-GAF", 1, 0, false);
        declareFunction(me, "get_consequent_logical_schemata_from_conditional_meaning_sentence_gaf", "GET-CONSEQUENT-LOGICAL-SCHEMATA-FROM-CONDITIONAL-MEANING-SENTENCE-GAF", 1, 0, false);
        declareFunction(me, "get_consequent_meaning_sentence_from_gaf", "GET-CONSEQUENT-MEANING-SENTENCE-FROM-GAF", 1, 1, false);
        declareFunction(me, "get_consequent_meaning_sentence_from_gaf_unwrapping_ists", "GET-CONSEQUENT-MEANING-SENTENCE-FROM-GAF-UNWRAPPING-ISTS", 1, 0, false);
        declareMacro(me, "destructure_conditional_meaning_sentence_gaf", "DESTRUCTURE-CONDITIONAL-MEANING-SENTENCE-GAF");
        declareMacro(me, "destructure_conditional_meaning_sentence", "DESTRUCTURE-CONDITIONAL-MEANING-SENTENCE");
        declareFunction(me, "get_antecedent_logical_schemata_from_conditional_meaning_sentence", "GET-ANTECEDENT-LOGICAL-SCHEMATA-FROM-CONDITIONAL-MEANING-SENTENCE", 1, 0, false);
        declareFunction(me, "get_antecedent_meaning_sentence_from_conditional_meaning_sentence", "GET-ANTECEDENT-MEANING-SENTENCE-FROM-CONDITIONAL-MEANING-SENTENCE", 1, 0, false);
        declareFunction(me, "get_consequent_logical_schemata_from_conditional_meaning_sentence", "GET-CONSEQUENT-LOGICAL-SCHEMATA-FROM-CONDITIONAL-MEANING-SENTENCE", 1, 0, false);
        declareFunction(me, "get_consequent_meaning_sentence_from_conditional_meaning_sentence", "GET-CONSEQUENT-MEANING-SENTENCE-FROM-CONDITIONAL-MEANING-SENTENCE", 1, 0, false);
        declareFunction(me, "get_relevant_meaning_sentence_from_gaf_internal", "GET-RELEVANT-MEANING-SENTENCE-FROM-GAF-INTERNAL", 1, 1, false);
        declareFunction(me, "get_relevant_meaning_sentence_from_gaf", "GET-RELEVANT-MEANING-SENTENCE-FROM-GAF", 1, 1, false);
        declareFunction(me, "get_relevant_logical_schemata_and_meaning_sentence_from_gaf", "GET-RELEVANT-LOGICAL-SCHEMATA-AND-MEANING-SENTENCE-FROM-GAF", 1, 1, false);
        declareFunction(me, "supported_conditional_meaning_sentence_gaf_p", "SUPPORTED-CONDITIONAL-MEANING-SENTENCE-GAF-P", 1, 1, false);
        declareFunction(me, "supported_conditional_meaning_sentence_gaf_int_internal", "SUPPORTED-CONDITIONAL-MEANING-SENTENCE-GAF-INT-INTERNAL", 3, 0, false);
        declareFunction(me, "supported_conditional_meaning_sentence_gaf_int", "SUPPORTED-CONDITIONAL-MEANING-SENTENCE-GAF-INT", 3, 0, false);
        declareFunction(me, "appropriate_logical_schemata_setsP", "APPROPRIATE-LOGICAL-SCHEMATA-SETS?", 3, 0, false);
        declareMacro(me, "with_appropriate_meaning_sentence_tmp_args", "WITH-APPROPRIATE-MEANING-SENTENCE-TMP-ARGS");
        declareFunction(me, "logical_schemata_relevant_meaning_sentences", "LOGICAL-SCHEMATA-RELEVANT-MEANING-SENTENCES", 2, 0, false);
        declareFunction(me, "logical_schema_meaning_sentences_relevant_to_appropriateness_check", "LOGICAL-SCHEMA-MEANING-SENTENCES-RELEVANT-TO-APPROPRIATENESS-CHECK", 2, 1, false);
        declareFunction(me, "logical_schema_conditional_meaning_sentence_gafs_relevant_to_appropriateness_check", "LOGICAL-SCHEMA-CONDITIONAL-MEANING-SENTENCE-GAFS-RELEVANT-TO-APPROPRIATENESS-CHECK", 2, 1, false);
        declareFunction(me, "appropriate_consequent_meaning_sentenceP", "APPROPRIATE-CONSEQUENT-MEANING-SENTENCE?", 5, 0, false);
        declareFunction(me, "appropriate_consequent_literalP", "APPROPRIATE-CONSEQUENT-LITERAL?", 2, 0, false);
        declareFunction(me, "appropriate_antecedent_meaning_sentenceP", "APPROPRIATE-ANTECEDENT-MEANING-SENTENCE?", 5, 0, false);
        declareFunction(me, "appropriate_antecedent_literalP", "APPROPRIATE-ANTECEDENT-LITERAL?", 1, 0, false);
        declareFunction(me, "appropriate_antecedent_comparison_literalP", "APPROPRIATE-ANTECEDENT-COMPARISON-LITERAL?", 4, 0, false);
        declareFunction(me, "antecedent_logical_field_joinable_with_consequent_logical_fieldsP", "ANTECEDENT-LOGICAL-FIELD-JOINABLE-WITH-CONSEQUENT-LOGICAL-FIELDS?", 3, 0, false);
        declareFunction(me, "appropriate_antecedent_other_literalP", "APPROPRIATE-ANTECEDENT-OTHER-LITERAL?", 5, 0, false);
        declareFunction(me, "logical_schema_meaning_sentence_gafs", "LOGICAL-SCHEMA-MEANING-SENTENCE-GAFS", 1, 1, false);
        declareFunction(me, "logical_schema_meaning_sentence_gafs_memoized_internal", "LOGICAL-SCHEMA-MEANING-SENTENCE-GAFS-MEMOIZED-INTERNAL", 2, 0, false);
        declareFunction(me, "logical_schema_meaning_sentence_gafs_memoized", "LOGICAL-SCHEMA-MEANING-SENTENCE-GAFS-MEMOIZED", 2, 0, false);
        declareFunction(me, "logical_schema_meaning_sentence_gafs_int", "LOGICAL-SCHEMA-MEANING-SENTENCE-GAFS-INT", 1, 0, false);
        declareFunction(me, "logical_schema_consequent_conditional_meaning_sentence_gafs", "LOGICAL-SCHEMA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS", 1, 3, false);
        declareFunction(me, "logical_schema_consequent_conditional_meaning_sentence_gafs_memoized_internal", "LOGICAL-SCHEMA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS-MEMOIZED-INTERNAL", 2, 2, false);
        declareFunction(me, "logical_schema_consequent_conditional_meaning_sentence_gafs_memoized", "LOGICAL-SCHEMA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS-MEMOIZED", 2, 2, false);
        declareFunction(me, "logical_schema_consequent_conditional_meaning_sentence_gafs_int", "LOGICAL-SCHEMA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS-INT", 1, 2, false);
        declareFunction(me, "logical_schema_unindexed_consequent_conditional_meaning_sentence_gafs", "LOGICAL-SCHEMA-UNINDEXED-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS", 1, 0, false);
        declareFunction(me, "meaning_sentence_pred_relevantP_internal", "MEANING-SENTENCE-PRED-RELEVANT?-INTERNAL", 3, 1, false);
        declareFunction(me, "meaning_sentence_pred_relevantP", "MEANING-SENTENCE-PRED-RELEVANT?", 3, 1, false);
        declareFunction(me, "relevant_logical_schema_meaning_sentence_gafs", "RELEVANT-LOGICAL-SCHEMA-MEANING-SENTENCE-GAFS", 3, 2, false);
        declareFunction(me, "relevant_logical_schema_meaning_sentence_gafs_memoized_internal", "RELEVANT-LOGICAL-SCHEMA-MEANING-SENTENCE-GAFS-MEMOIZED-INTERNAL", 5, 0, false);
        declareFunction(me, "relevant_logical_schema_meaning_sentence_gafs_memoized", "RELEVANT-LOGICAL-SCHEMA-MEANING-SENTENCE-GAFS-MEMOIZED", 5, 0, false);
        declareFunction(me, "relevant_logical_schema_meaning_sentence_gafs_int", "RELEVANT-LOGICAL-SCHEMA-MEANING-SENTENCE-GAFS-INT", 4, 0, false);
        declareFunction(me, "relevant_logical_schema_consequent_conditional_meaning_sentence_gafs", "RELEVANT-LOGICAL-SCHEMA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS", 3, 4, false);
        declareFunction(me, "relevant_logical_schema_consequent_conditional_meaning_sentence_gafs_memoized_internal", "RELEVANT-LOGICAL-SCHEMA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS-MEMOIZED-INTERNAL", 4, 3, false);
        declareFunction(me, "relevant_logical_schema_consequent_conditional_meaning_sentence_gafs_memoized", "RELEVANT-LOGICAL-SCHEMA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS-MEMOIZED", 4, 3, false);
        declareFunction(me, "logical_schema_conditional_meaning_sentence_gafs_internal", "LOGICAL-SCHEMA-CONDITIONAL-MEANING-SENTENCE-GAFS-INTERNAL", 1, 1, false);
        declareFunction(me, "logical_schema_conditional_meaning_sentence_gafs", "LOGICAL-SCHEMA-CONDITIONAL-MEANING-SENTENCE-GAFS", 1, 1, false);
        declareFunction(me, "relevant_logical_schema_consequent_conditional_meaning_sentence_gafs_int", "RELEVANT-LOGICAL-SCHEMA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS-INT", 3, 3, false);
        declareFunction(me, "asserted_logical_schema_meaning_sentences", "ASSERTED-LOGICAL-SCHEMA-MEANING-SENTENCES", 1, 1, false);
        declareFunction(me, "logical_schema_meaning_sentences", "LOGICAL-SCHEMA-MEANING-SENTENCES", 1, 3, false);
        declareFunction(me, "logical_schema_consequent_meaning_sentences", "LOGICAL-SCHEMA-CONSEQUENT-MEANING-SENTENCES", 1, 5, false);
        declareFunction(me, "logical_schemata_meaning_sentence_gafs", "LOGICAL-SCHEMATA-MEANING-SENTENCE-GAFS", 1, 1, false);
        declareFunction(me, "logical_schemata_consequent_conditional_meaning_sentence_gafs", "LOGICAL-SCHEMATA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS", 1, 2, false);
        declareFunction(me, "relevant_logical_schemata_meaning_sentence_gafs", "RELEVANT-LOGICAL-SCHEMATA-MEANING-SENTENCE-GAFS", 3, 2, false);
        declareFunction(me, "relevant_logical_schemata_consequent_conditional_meaning_sentence_gafs", "RELEVANT-LOGICAL-SCHEMATA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS", 3, 2, false);
        declareFunction(me, "relevant_logical_schema_meaning_sentences_internal", "RELEVANT-LOGICAL-SCHEMA-MEANING-SENTENCES-INTERNAL", 2, 2, false);
        declareFunction(me, "relevant_logical_schema_meaning_sentences", "RELEVANT-LOGICAL-SCHEMA-MEANING-SENTENCES", 2, 2, false);
        declareFunction(me, "relevant_logical_schema_conditional_meaning_sentences_internal", "RELEVANT-LOGICAL-SCHEMA-CONDITIONAL-MEANING-SENTENCES-INTERNAL", 2, 2, false);
        declareFunction(me, "relevant_logical_schema_conditional_meaning_sentences", "RELEVANT-LOGICAL-SCHEMA-CONDITIONAL-MEANING-SENTENCES", 2, 2, false);
        declareFunction(me, "logical_schema_meaning_sentence_gafs_for_pred", "LOGICAL-SCHEMA-MEANING-SENTENCE-GAFS-FOR-PRED", 2, 1, false);
        declareFunction(me, "logical_schema_consequent_conditional_meaning_sentence_gafs_for_pred", "LOGICAL-SCHEMA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS-FOR-PRED", 2, 1, false);
        declareFunction(me, "logical_schema_meaning_sentences_for_pred", "LOGICAL-SCHEMA-MEANING-SENTENCES-FOR-PRED", 2, 2, false);
        declareFunction(me, "logical_schema_consequent_meaning_sentences_for_pred", "LOGICAL-SCHEMA-CONSEQUENT-MEANING-SENTENCES-FOR-PRED", 2, 2, false);
        declareFunction(me, "logical_schemata_meaning_sentence_gafs_for_pred", "LOGICAL-SCHEMATA-MEANING-SENTENCE-GAFS-FOR-PRED", 2, 1, false);
        declareFunction(me, "logical_schemata_consequent_conditional_meaning_sentence_gafs_for_pred", "LOGICAL-SCHEMATA-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAFS-FOR-PRED", 2, 1, false);
        declareFunction(me, "logical_schema_meaning_sentence_preds", "LOGICAL-SCHEMA-MEANING-SENTENCE-PREDS", 1, 2, false);
        declareFunction(me, "logical_schema_meaning_sentence_predP", "LOGICAL-SCHEMA-MEANING-SENTENCE-PRED?", 2, 2, false);
        declareFunction(me, "logical_schema_consequent_meaning_sentence_preds", "LOGICAL-SCHEMA-CONSEQUENT-MEANING-SENTENCE-PREDS", 1, 2, false);
        declareFunction(me, "logical_schema_consequent_meaning_sentence_predP", "LOGICAL-SCHEMA-CONSEQUENT-MEANING-SENTENCE-PRED?", 2, 2, false);
        declareFunction(me, "logical_schema_all_relevant_preds", "LOGICAL-SCHEMA-ALL-RELEVANT-PREDS", 1, 1, false);
        declareFunction(me, "logical_schema_all_relevant_preds_memoized_internal", "LOGICAL-SCHEMA-ALL-RELEVANT-PREDS-MEMOIZED-INTERNAL", 3, 0, false);
        declareFunction(me, "logical_schema_all_relevant_preds_memoized", "LOGICAL-SCHEMA-ALL-RELEVANT-PREDS-MEMOIZED", 3, 0, false);
        declareFunction(me, "sksi_code_mapping_predicates_for_logical_field_indexical_internal", "SKSI-CODE-MAPPING-PREDICATES-FOR-LOGICAL-FIELD-INDEXICAL-INTERNAL", 1, 1, false);
        declareFunction(me, "sksi_code_mapping_predicates_for_logical_field_indexical", "SKSI-CODE-MAPPING-PREDICATES-FOR-LOGICAL-FIELD-INDEXICAL", 1, 1, false);
        declareFunction(me, "meaning_sentences_type_check", "MEANING-SENTENCES-TYPE-CHECK", 2, 4, false);
        declareFunction(me, "meaning_sentence_type_check", "MEANING-SENTENCE-TYPE-CHECK", 2, 6, false);
        declareFunction(me, "meaning_sentence_type_check_memoized_internal", "MEANING-SENTENCE-TYPE-CHECK-MEMOIZED-INTERNAL", 6, 0, false);
        declareFunction(me, "meaning_sentence_type_check_memoized", "MEANING-SENTENCE-TYPE-CHECK-MEMOIZED", 6, 0, false);
        declareFunction(me, "meaning_sentence_type_check_int", "MEANING-SENTENCE-TYPE-CHECK-INT", 5, 3, false);
        declareFunction(me, "meaning_sentence_arg_type_check", "MEANING-SENTENCE-ARG-TYPE-CHECK", 2, 4, false);
        declareFunction(me, "meaning_sentence_arg_type_check_memoized_internal", "MEANING-SENTENCE-ARG-TYPE-CHECK-MEMOIZED-INTERNAL", 5, 0, false);
        declareFunction(me, "meaning_sentence_arg_type_check_memoized", "MEANING-SENTENCE-ARG-TYPE-CHECK-MEMOIZED", 5, 0, false);
        declareFunction(me, "meaning_sentence_arg_type_check_int", "MEANING-SENTENCE-ARG-TYPE-CHECK-INT", 5, 1, false);
        declareFunction(me, "meaning_sentence_gaf_type_check", "MEANING-SENTENCE-GAF-TYPE-CHECK", 2, 4, false);
        declareFunction(me, "meaning_sentence_gafs_type_check", "MEANING-SENTENCE-GAFS-TYPE-CHECK", 2, 4, false);
        declareFunction(me, "generate_robust_pattern_for_meaning_sentence", "GENERATE-ROBUST-PATTERN-FOR-MEANING-SENTENCE", 1, 2, false);
        declareFunction(me, "generate_robust_pattern_for_meaning_sentence_args", "GENERATE-ROBUST-PATTERN-FOR-MEANING-SENTENCE-ARGS", 1, 2, false);
        declareFunction(me, "generate_weak_pattern_for_meaning_sentence", "GENERATE-WEAK-PATTERN-FOR-MEANING-SENTENCE", 1, 2, false);
        declareFunction(me, "generate_strict_pattern_for_meaning_sentence", "GENERATE-STRICT-PATTERN-FOR-MEANING-SENTENCE", 1, 2, false);
        declareFunction(me, "generate_strict_pattern_for_meaning_sentence_args", "GENERATE-STRICT-PATTERN-FOR-MEANING-SENTENCE-ARGS", 1, 2, false);
        declareFunction(me, "generate_strict_pattern_for_meaning_sentence_arg", "GENERATE-STRICT-PATTERN-FOR-MEANING-SENTENCE-ARG", 1, 2, false);
        declareFunction(me, "generate_pedantic_pattern_for_meaning_sentence", "GENERATE-PEDANTIC-PATTERN-FOR-MEANING-SENTENCE", 1, 2, false);
        declareFunction(me, "generate_pattern_for_meaning_sentence_memoized_internal", "GENERATE-PATTERN-FOR-MEANING-SENTENCE-MEMOIZED-INTERNAL", 5, 1, false);
        declareFunction(me, "generate_pattern_for_meaning_sentence_memoized", "GENERATE-PATTERN-FOR-MEANING-SENTENCE-MEMOIZED", 5, 1, false);
        declareFunction(me, "generate_pattern_for_meaning_sentence", "GENERATE-PATTERN-FOR-MEANING-SENTENCE", 4, 1, false);
        declareFunction(me, "transitive_args_for_meaning_sentence_predicate", "TRANSITIVE-ARGS-FOR-MEANING-SENTENCE-PREDICATE", 1, 0, false);
        declareFunction(me, "generate_pattern_for_meaning_sentence_args", "GENERATE-PATTERN-FOR-MEANING-SENTENCE-ARGS", 4, 2, false);
        declareFunction(me, "generate_pattern_for_meaning_sentence_arg", "GENERATE-PATTERN-FOR-MEANING-SENTENCE-ARG", 4, 2, false);
        declareFunction(me, "generate_pattern_for_meaning_sentence_arg_memoized_internal", "GENERATE-PATTERN-FOR-MEANING-SENTENCE-ARG-MEMOIZED-INTERNAL", 4, 1, false);
        declareFunction(me, "generate_pattern_for_meaning_sentence_arg_memoized", "GENERATE-PATTERN-FOR-MEANING-SENTENCE-ARG-MEMOIZED", 4, 1, false);
        declareFunction(me, "generate_pattern_for_meaning_sentence_arg_int", "GENERATE-PATTERN-FOR-MEANING-SENTENCE-ARG-INT", 3, 2, false);
        declareFunction(me, "generate_pattern_for_logical_field_indexical", "GENERATE-PATTERN-FOR-LOGICAL-FIELD-INDEXICAL", 2, 1, false);
        declareFunction(me, "generate_pattern_for_el_variable", "GENERATE-PATTERN-FOR-EL-VARIABLE", 2, 0, false);
        declareFunction(me, "generate_pattern_for_collection", "GENERATE-PATTERN-FOR-COLLECTION", 2, 1, false);
        declareFunction(me, "generate_pattern_for_predicate", "GENERATE-PATTERN-FOR-PREDICATE", 2, 0, false);
        declareFunction(me, "generate_pattern_for_nat", "GENERATE-PATTERN-FOR-NAT", 2, 0, false);
        declareFunction(me, "ist_meaning_sentence_gaf_p", "IST-MEANING-SENTENCE-GAF-P", 1, 0, false);
        declareFunction(me, "unwrap_meaning_sentence_if_ist", "UNWRAP-MEANING-SENTENCE-IF-IST", 1, 0, false);
        declareFunction(me, "sksi_reconstruct_meaning_sentence", "SKSI-RECONSTRUCT-MEANING-SENTENCE", 1, 0, false);
        declareFunction(me, "possibly_nart_el_formula_wXo_logical_field_indexicals_p", "POSSIBLY-NART-EL-FORMULA-W/O-LOGICAL-FIELD-INDEXICALS-P", 1, 0, false);
        declareFunction(me, "sksi_valid_meaning_sentence_pred_p_internal", "SKSI-VALID-MEANING-SENTENCE-PRED-P-INTERNAL", 2, 0, false);
        declareFunction(me, "sksi_valid_meaning_sentence_pred_p", "SKSI-VALID-MEANING-SENTENCE-PRED-P", 2, 0, false);
        declareFunction(me, "sksi_valid_meaning_sentence_pred_for_storage_p_internal", "SKSI-VALID-MEANING-SENTENCE-PRED-FOR-STORAGE-P-INTERNAL", 2, 0, false);
        declareFunction(me, "sksi_valid_meaning_sentence_pred_for_storage_p", "SKSI-VALID-MEANING-SENTENCE-PRED-FOR-STORAGE-P", 2, 0, false);
        declareFunction(me, "meaning_sentence_logical_field_indexicals", "MEANING-SENTENCE-LOGICAL-FIELD-INDEXICALS", 1, 0, false);
        declareFunction(me, "logical_schema_logical_field_indexicals_used_in_meaning_sentences", "LOGICAL-SCHEMA-LOGICAL-FIELD-INDEXICALS-USED-IN-MEANING-SENTENCES", 1, 0, false);
        declareFunction(me, "meaning_sentence_logical_fields", "MEANING-SENTENCE-LOGICAL-FIELDS", 1, 0, false);
        declareFunction(me, "meaning_sentence_logical_field_indexical_p_internal", "MEANING-SENTENCE-LOGICAL-FIELD-INDEXICAL-P-INTERNAL", 2, 0, false);
        declareFunction(me, "meaning_sentence_logical_field_indexical_p", "MEANING-SENTENCE-LOGICAL-FIELD-INDEXICAL-P", 2, 0, false);
        declareFunction(me, "meaning_sentence_with_logical_field_indexical_predicateP", "MEANING-SENTENCE-WITH-LOGICAL-FIELD-INDEXICAL-PREDICATE?", 1, 0, false);
        declareFunction(me, "possibly_constrain_consequent_meaning_sentence", "POSSIBLY-CONSTRAIN-CONSEQUENT-MEANING-SENTENCE", 2, 0, false);
        declareFunction(me, "antecedent_meaning_sentence_constraining_lfi_as_non_lfi", "ANTECEDENT-MEANING-SENTENCE-CONSTRAINING-LFI-AS-NON-LFI", 2, 0, false);
        declareFunction(me, "atomic_sentence_constraining_lfi_as_non_lfi", "ATOMIC-SENTENCE-CONSTRAINING-LFI-AS-NON-LFI", 2, 0, false);
        return NIL;
    }
