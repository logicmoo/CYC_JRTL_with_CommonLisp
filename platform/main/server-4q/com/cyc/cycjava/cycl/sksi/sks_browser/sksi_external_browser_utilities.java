...
/**
 * Copyright (c) 1995 - 2019 Cycorp, Inc.  All rights reserved.
 * module:      SKSI-EXTERNAL-BROWSER-UTILITIES
 * source file: /cyc/top/cycl/sksi/sks-browser/sksi-external-browser-utilities.lisp
...
public final class sksi_external_browser_utilities extends SubLTranslatedFile implements V12 {
 ...
 public static final String myName = "com.cyc.cycjava.cycl.sksi.sks_browser.sksi_external_browser_utilities";
    ...
    private static final SubLSymbol SKSI_CREATE_QUERY_FORM_FROM_REQUIRED_PATTERN = makeSymbol("SKSI-CREATE-QUERY-FORM-FROM-REQUIRED-PATTERN");
    ...
    public static final SubLObject count_not_too_expensive_for_browser_supportP_alt(SubLObject count) {
    ...
    public static final SubLObject sksi_create_query_form_from_required_pattern_internal_alt(SubLObject required_pattern) {
        {
            SubLObject query_form = required_pattern;
            SubLObject not_fully_bound_positions = cycl_utilities.arg_positions_bfs($NOT_FULLY_BOUND, query_form, UNPROVIDED);
            SubLObject list_var = NIL;
            SubLObject position = NIL;
            SubLObject hl_variable_count = NIL;
            for (list_var = not_fully_bound_positions, position = list_var.first(), hl_variable_count = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest() , position = list_var.first() , hl_variable_count = add(ONE_INTEGER, hl_variable_count)) {
                query_form = list_utilities.replace_nested_nth(query_form, position.isList() ? ((SubLObject) (position)) : list(position), variables.get_variable(hl_variable_count));
            }
            return query_form;
        }
    }
    ...
    public static final SubLObject sksi_create_query_form_from_required_pattern_alt(SubLObject required_pattern) {
        {
            final SubLThread thread = SubLProcess.currentSubLThread();
            {
                ...
                if (NIL == v_memoization_state) {
                    return com.cyc.cycjava.cycl.sksi.sks_browser.sksi_external_browser_utilities.sksi_create_query_form_from_required_pattern_internal(required_pattern);
                }
                ...
                {
                    SubLObject results = memoization_state.caching_state_lookup(caching_state, required_pattern, $kw2$_MEMOIZED_ITEM_NOT_FOUND_);
                    if (results == $kw2$_MEMOIZED_ITEM_NOT_FOUND_) {
                        results = arg2(thread.resetMultipleValues(), multiple_value_list(com.cyc.cycjava.cycl.sksi.sks_browser.sksi_external_browser_utilities.sksi_create_query_form_from_required_pattern_internal(required_pattern)));
    ...
    public static final SubLObject sksi_compute_count_for_external_browser_cache_entry_merge_alt(SubLObject current_count, SubLObject new_count) {
    ...
    public static final SubLObject sksi_compute_count_for_external_browser_cache_entry_demerge_alt(SubLObject current_count, SubLObject removed_count) {
    ...
    public static final SubLObject sksi_display_external_facts_alt(SubLObject query_form_module_list_pairs, SubLObject mt) {
        {
            SubLObject cdolist_list_var = query_form_module_list_pairs;
            SubLObject query_form_module_list_pair = NIL;
            for (query_form_module_list_pair = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , query_form_module_list_pair = cdolist_list_var.first()) {
                {
                    SubLObject datum = query_form_module_list_pair;
                    ...
                    current = current.rest();
                    if (NIL == current) {
                        com.cyc.cycjava.cycl.sksi.sks_browser.sksi_external_browser_utilities.sksi_display_external_facts_int(query_form, mt, v_modules);
                    } else {
    ...
    public static final SubLObject sksi_display_external_term_facts_alt(SubLObject external_term, SubLObject arg_pos, SubLObject query_form_module_list_pairs, SubLObject mt) {
        {
            SubLObject cdolist_list_var = query_form_module_list_pairs;
            SubLObject query_form_module_list_pair = NIL;
            for (query_form_module_list_pair = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var.rest() , query_form_module_list_pair = cdolist_list_var.first()) {
                {
                    ...
                    if (NIL == current) {
                        {
                            SubLObject actual_query_form = replace_formula_arg(arg_pos, external_term, query_form);
                            com.cyc.cycjava.cycl.sksi.sks_browser.sksi_external_browser_utilities.sksi_display_external_facts_int(actual_query_form, mt, v_modules);
                        }
                    } else {
                        cdestructuring_bind_error(datum, $list_alt3);
                    }
    ...
    public static final SubLObject sksi_display_external_facts_int_alt(SubLObject query_form, SubLObject mt, SubLObject v_modules) {
        {
            SubLObject sentence_list = NIL;
            SubLObject error_msg = NIL;
            SubLObject allowed_modules_spec = sksi_infrastructure_utilities.hl_modules_list_to_allowed_modules_spec(v_modules);
            try {
                {
            ...
            if (error_msg.isString()) {
                return Errors.warn($str_alt7$The_following_error_was_encounter, query_form, mt, error_msg);
            }
            {
    ...
    public static final SubLObject sksi_term_L_wX_constants_by_name_on_alt(SubLObject term1, SubLObject term2) {
    ...
    /**
     * Clear all SKSI supported browsing caches.
     */
    @LispMethod(comment = "Clear all SKSI supported browsing caches.")
    public static final SubLObject clear_sksi_supported_browsing_caches_alt() {
    ...
    public static final SubLObject sksi_supported_browsing_registeredP_alt() {
    ...
    public static final SubLObject sksi_sort_preds_for_display_alt(SubLObject preds) {
        preds = list_utilities.delete_if_not($sym8$VALID_FORT_, preds, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
    ...
    public static final SubLObject sksi_sort_mts_for_display_alt(SubLObject mts) {
        return cb_sort_mts_for_display(mts);
    }
    ...
    public static final SubLObject sksi_sort_mt_count_pairs_alt(SubLObject mt_count_pairs) {
        {
            SubLObject mts = com.cyc.cycjava.cycl.sksi.sks_browser.sksi_external_browser_utilities.sksi_sort_mts_for_display(Mapping.mapcar(FIRST, mt_count_pairs));
    ...
    public static final SubLObject sksi_sort_pred_count_pairs_alt(SubLObject pred_count_pairs) {
        {
            SubLObject preds = com.cyc.cycjava.cycl.sksi.sks_browser.sksi_external_browser_utilities.sksi_sort_preds_for_display(Mapping.mapcar(FIRST, pred_count_pairs));
    ...
    static private final SubLList $list_alt3 = list(makeSymbol("QUERY-FORM"), makeSymbol("MODULES"));

    static private final SubLString $str_alt7$The_following_error_was_encounter = makeString("The following error was encountered during the ask of ~A in the microtheory ~A:~%~s~%");
    ...
    static private final SubLSymbol $sym8$VALID_FORT_ = makeSymbol("VALID-FORT?");
    ...
    public static SubLObject declare_sksi_external_browser_utilities_file() {
        declareFunction("count_not_too_expensive_for_browser_supportP", "COUNT-NOT-TOO-EXPENSIVE-FOR-BROWSER-SUPPORT?", 1, 0, false);
        declareFunction("sksi_create_query_form_from_required_pattern_internal", "SKSI-CREATE-QUERY-FORM-FROM-REQUIRED-PATTERN-INTERNAL", 1, 0, false);
        declareFunction("sksi_create_query_form_from_required_pattern", "SKSI-CREATE-QUERY-FORM-FROM-REQUIRED-PATTERN", 1, 0, false);
        declareFunction("sksi_compute_count_for_external_browser_cache_entry_merge", "SKSI-COMPUTE-COUNT-FOR-EXTERNAL-BROWSER-CACHE-ENTRY-MERGE", 2, 0, false);
        declareFunction("sksi_compute_count_for_external_browser_cache_entry_demerge", "SKSI-COMPUTE-COUNT-FOR-EXTERNAL-BROWSER-CACHE-ENTRY-DEMERGE", 2, 0, false);
        declareFunction("sksi_display_external_facts", "SKSI-DISPLAY-EXTERNAL-FACTS", 2, 0, false);
        declareFunction("sksi_display_external_term_facts", "SKSI-DISPLAY-EXTERNAL-TERM-FACTS", 4, 0, false);
        declareFunction("sksi_display_external_facts_int", "SKSI-DISPLAY-EXTERNAL-FACTS-INT", 3, 0, false);
        declareFunction("sksi_term_L_wX_constants_by_name_on", "SKSI-TERM-<-W/-CONSTANTS-BY-NAME-ON", 2, 0, false);
        declareFunction("clear_sksi_supported_browsing_caches", "CLEAR-SKSI-SUPPORTED-BROWSING-CACHES", 0, 0, false);
        declareFunction("sksi_supported_browsing_registeredP", "SKSI-SUPPORTED-BROWSING-REGISTERED?", 0, 0, false);
        declareFunction("sksi_sort_preds_for_display", "SKSI-SORT-PREDS-FOR-DISPLAY", 1, 0, false);
        declareFunction("sksi_sort_mts_for_display", "SKSI-SORT-MTS-FOR-DISPLAY", 1, 0, false);
        declareFunction("sksi_sort_mt_count_pairs", "SKSI-SORT-MT-COUNT-PAIRS", 1, 0, false);
        declareFunction("sksi_sort_pred_count_pairs", "SKSI-SORT-PRED-COUNT-PAIRS", 1, 0, false);
        declareFunction("cb_all_sksi_conjunctive_removals", "CB-ALL-SKSI-CONJUNCTIVE-REMOVALS", 0, 1, false);
        declareFunction("cb_link_all_sksi_conjunctive_removals", "CB-LINK-ALL-SKSI-CONJUNCTIVE-REMOVALS", 0, 1, false);
        declareFunction("links_to_all_sksi_conjunctive_removals", "LINKS-TO-ALL-SKSI-CONJUNCTIVE-REMOVALS", 0, 0, false);
        return NIL;
    }
