...
public final class sksi_testing_utilities
    extends
      SubLTranslatedFile
{
  ...
  {
    sunit_external.define_test_category( $str0$SKSI_Category, UNPROVIDED );
    sunit_external.define_test_suite( $str1$SKSI, $list2, UNPROVIDED, UNPROVIDED );
    return NIL;
  }
  ...
  static
  {
    me = new sksi_testing_utilities();
    $str0$SKSI_Category = makeString( "SKSI Category" );
    $str1$SKSI = makeString( "SKSI" );
    $list2 = ConsesLow.list( makeString( "SKSI Category" ) );
  }
}
/*
 * 
