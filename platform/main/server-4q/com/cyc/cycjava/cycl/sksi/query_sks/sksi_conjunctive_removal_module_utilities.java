...
import com.cyc.cycjava.cycl.sksi.query_sks.sksi_conjunctive_removal_module_utilities;
...
import static com.cyc.cycjava.cycl.sksi.query_sks.sksi_conjunctive_removal_module_utilities.*;
...
public final class sksi_conjunctive_removal_module_utilities extends SubLTranslatedFile {
    ...
    private static final SubLObject $const2$disallowMeaningSentencesForUnboun = reader_make_constant_shell(makeString("disallowMeaningSentencesForUnboundPredicates"));
    ...
    private static final SubLObject $const37$CCF_SDB_SDBMySQLExportStore_Cyc_K = reader_make_constant_shell(makeString("CCF-SDB-SDBMySQLExportStore-Cyc-KS"));

    private static final SubLInteger $int$88888888 = makeInteger(88888888);

    public static final SubLList $list39 = list(makeSymbol("MT1"), makeSymbol("B-ASENT"));
    ...
    public static final SubLSymbol $sym43$SKSI_EVALUATABLE_PREDICATE_ = makeSymbol("SKSI-EVALUATABLE-PREDICATE?");
    ...
    public static final SubLList $list64 = list(makeSymbol("SELECT-KEYWORD"), makeSymbol("FIELDS"), makeSymbol("FROM"), makeSymbol("&OPTIONAL"), makeSymbol("WHERE"), makeSymbol("LIMIT"), makeSymbol("OFFSET"));
    ...
    public static final SubLList $list77 = list(makeSymbol("CSQL-EQUALS"), makeSymbol("KEEP-FIELD"), makeSymbol("KILL-FIELD"));
    ...
    public static final SubLList $list82 = list(makeSymbol("TABLE-KEYWORD"), makeSymbol("TABLE-NAME"), makeSymbol("ALIAS"), makeSymbol("NAMESPACE"));

    public static final SubLList $list83 = list(makeSymbol("FIELD-KEYWORD"), makeSymbol("FIELD-NAME"), makeSymbol("TABLE-NAME"), makeSymbol("NAMESPACE"));
    ...
    public static final SubLList $list93 = list(makeSymbol("EVAL-LFI"), makeSymbol("EVAL-EXPRESSION"), makeSymbol("EVAL-CONDITIONS"));

    public static final SubLList $list94 = list(makeSymbol("PFI"), makeSymbol("ENCODING"));

    public static final SubLList $list95 = list(makeSymbol("PHYSICAL-FIELD-INDEXICAL"), makeSymbol("ENCODING"));
    ...
    private static final SubLObject $const119$fieldEncodingOverrideForCompariso = reader_make_constant_shell(makeString("fieldEncodingOverrideForComparisonOperatorArg"));
    ...
    public static SubLObject declare_sksi_conjunctive_removal_module_utilities_file() {
        declareFunction(me, "sksi_disallow_meaning_sentences_for_unbound_predicatesP", "SKSI-DISALLOW-MEANING-SENTENCES-FOR-UNBOUND-PREDICATES?", 1, 0, false);
        declareFunction(me, "sksi_disallow_meaning_sentences_for_unbound_predicates_for_just_this_sourceP", "SKSI-DISALLOW-MEANING-SENTENCES-FOR-UNBOUND-PREDICATES-FOR-JUST-THIS-SOURCE?", 1, 0, false);
        declareFunction(me, "get_all_meaning_sentence_gafs_for_contextualized_dnf_clause", "GET-ALL-MEANING-SENTENCE-GAFS-FOR-CONTEXTUALIZED-DNF-CLAUSE", 3, 3, false);
        declareFunction(me, "get_all_meaning_sentence_gafs_for_asent", "GET-ALL-MEANING-SENTENCE-GAFS-FOR-ASENT", 3, 4, false);
        declareFunction(me, "get_meaning_sentence_gafs_for_asent", "GET-MEANING-SENTENCE-GAFS-FOR-ASENT", 2, 4, false);
        declareFunction(me, "get_meaning_sentence_gafs_for_asent_memoized_internal", "GET-MEANING-SENTENCE-GAFS-FOR-ASENT-MEMOIZED-INTERNAL", 6, 0, false);
        declareFunction(me, "get_meaning_sentence_gafs_for_asent_memoized", "GET-MEANING-SENTENCE-GAFS-FOR-ASENT-MEMOIZED", 6, 0, false);
        declareFunction(me, "get_meaning_sentence_gafs_for_asent_int", "GET-MEANING-SENTENCE-GAFS-FOR-ASENT-INT", 6, 0, false);
        declareFunction(me, "get_conditional_meaning_sentence_gafs_for_asent", "GET-CONDITIONAL-MEANING-SENTENCE-GAFS-FOR-ASENT", 3, 4, false);
        declareFunction(me, "get_conditional_meaning_sentence_gafs_for_asent_memoized_internal", "GET-CONDITIONAL-MEANING-SENTENCE-GAFS-FOR-ASENT-MEMOIZED-INTERNAL", 7, 0, false);
        declareFunction(me, "get_conditional_meaning_sentence_gafs_for_asent_memoized", "GET-CONDITIONAL-MEANING-SENTENCE-GAFS-FOR-ASENT-MEMOIZED", 7, 0, false);
        declareFunction(me, "get_conditional_meaning_sentence_gafs_for_asent_int", "GET-CONDITIONAL-MEANING-SENTENCE-GAFS-FOR-ASENT-INT", 7, 0, false);
        declareFunction(me, "filter_meaning_sentence_gafs_for_asent", "FILTER-MEANING-SENTENCE-GAFS-FOR-ASENT", 2, 4, false);
        declareFunction(me, "filter_conditional_meaning_sentence_gafs_for_asent", "FILTER-CONDITIONAL-MEANING-SENTENCE-GAFS-FOR-ASENT", 3, 4, false);
        declareFunction(me, "filter_meaning_sentence_for_asent", "FILTER-MEANING-SENTENCE-FOR-ASENT", 6, 0, false);
        declareFunction(me, "get_meaning_sentence_gaf_iterators_for_contextualized_dnf_clause", "GET-MEANING-SENTENCE-GAF-ITERATORS-FOR-CONTEXTUALIZED-DNF-CLAUSE", 2, 3, false);
        declareFunction(me, "get_meaning_sentence_gaf_iterator_for_asent", "GET-MEANING-SENTENCE-GAF-ITERATOR-FOR-ASENT", 3, 4, false);
        declareFunction(me, "meaning_sentence_gaf_iterator_done", "MEANING-SENTENCE-GAF-ITERATOR-DONE", 1, 0, false);
        declareFunction(me, "meaning_sentence_gaf_iterator_next", "MEANING-SENTENCE-GAF-ITERATOR-NEXT", 1, 0, false);
        declareFunction(me, "find_first_applicable_meaning_sentence_gaf_for_asent", "FIND-FIRST-APPLICABLE-MEANING-SENTENCE-GAF-FOR-ASENT", 2, 4, false);
        declareFunction(me, "find_first_applicable_meaning_sentence_gaf_for_asent_memoized_internal", "FIND-FIRST-APPLICABLE-MEANING-SENTENCE-GAF-FOR-ASENT-MEMOIZED-INTERNAL", 5, 0, false);
        declareFunction(me, "find_first_applicable_meaning_sentence_gaf_for_asent_memoized", "FIND-FIRST-APPLICABLE-MEANING-SENTENCE-GAF-FOR-ASENT-MEMOIZED", 5, 0, false);
        declareFunction(me, "find_first_applicable_meaning_sentence_gaf_for_asent_int", "FIND-FIRST-APPLICABLE-MEANING-SENTENCE-GAF-FOR-ASENT-INT", 6, 0, false);
        declareFunction(me, "genl_pred_meaning_sentenceP", "GENL-PRED-MEANING-SENTENCE?", 2, 2, false);
        declareFunction(me, "genl_inverse_meaning_sentenceP", "GENL-INVERSE-MEANING-SENTENCE?", 2, 2, false);
        declareFunction(me, "genl_pred_meaning_sentence_gafP", "GENL-PRED-MEANING-SENTENCE-GAF?", 2, 1, false);
        declareFunction(me, "genl_pred_consequent_conditional_meaning_sentence_gafP", "GENL-PRED-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAF?", 2, 1, false);
        declareFunction(me, "genl_inverse_meaning_sentence_gafP", "GENL-INVERSE-MEANING-SENTENCE-GAF?", 2, 1, false);
        declareFunction(me, "genl_inverse_consequent_conditional_meaning_sentence_gafP", "GENL-INVERSE-CONSEQUENT-CONDITIONAL-MEANING-SENTENCE-GAF?", 2, 1, false);
        declareFunction(me, "sksi_relevant_spec_preds_from_meaning_sentence", "SKSI-RELEVANT-SPEC-PREDS-FROM-MEANING-SENTENCE", 2, 3, false);
        declareFunction(me, "sksi_relevant_spec_preds_from_meaning_sentence_pred_internal", "SKSI-RELEVANT-SPEC-PREDS-FROM-MEANING-SENTENCE-PRED-INTERNAL", 2, 3, false);
        declareFunction(me, "sksi_relevant_spec_preds_from_meaning_sentence_pred", "SKSI-RELEVANT-SPEC-PREDS-FROM-MEANING-SENTENCE-PRED", 2, 3, false);
        declareFunction(me, "sksi_relevant_spec_inverses_from_meaning_sentence", "SKSI-RELEVANT-SPEC-INVERSES-FROM-MEANING-SENTENCE", 2, 3, false);
        declareFunction(me, "sksi_relevant_spec_inverses_from_meaning_sentence_pred_internal", "SKSI-RELEVANT-SPEC-INVERSES-FROM-MEANING-SENTENCE-PRED-INTERNAL", 2, 3, false);
        declareFunction(me, "sksi_relevant_spec_inverses_from_meaning_sentence_pred", "SKSI-RELEVANT-SPEC-INVERSES-FROM-MEANING-SENTENCE-PRED", 2, 3, false);
        declareFunction(me, "sksi_joinability_assertedP", "SKSI-JOINABILITY-ASSERTED?", 0, 0, false);
        declareFunction(me, "sksi_crm_joinable_asentsP", "SKSI-CRM-JOINABLE-ASENTS?", 3, 0, false);
        declareFunction(me, "sksi_crm_unjoinable_asents_int", "SKSI-CRM-UNJOINABLE-ASENTS-INT", 5, 0, false);
        declareFunction(me, "sksi_crm_literal_coherent_with_other_literalsP", "SKSI-CRM-LITERAL-COHERENT-WITH-OTHER-LITERALS?", 5, 0, false);
        declareFunction(me, "sksi_crm_literals_incoherent_together", "SKSI-CRM-LITERALS-INCOHERENT-TOGETHER", 5, 0, false);
        declareFunction(me, "logical_field_indexicals_joinableP_internal", "LOGICAL-FIELD-INDEXICALS-JOINABLE?-INTERNAL", 2, 1, false);
        declareFunction(me, "logical_field_indexicals_joinableP", "LOGICAL-FIELD-INDEXICALS-JOINABLE?", 2, 1, false);
        declareFunction(me, "logical_field_indexicals_joinable_asserted", "LOGICAL-FIELD-INDEXICALS-JOINABLE-ASSERTED", 2, 0, false);
        declareFunction(me, "logical_field_indexicals_joinable_deduced", "LOGICAL-FIELD-INDEXICALS-JOINABLE-DEDUCED", 3, 0, false);
        declareFunction(me, "sksi_generate_csql_where_lists_for_fixed_physical_indexicals", "SKSI-GENERATE-CSQL-WHERE-LISTS-FOR-FIXED-PHYSICAL-INDEXICALS", 5, 0, false);
        declareFunction(me, "sksi_sort_asents_and_meaning_sentence_gafs", "SKSI-SORT-ASENTS-AND-MEANING-SENTENCE-GAFS", 2, 1, false);
        declareFunction(me, "sksi_sort_asents", "SKSI-SORT-ASENTS", 1, 0, false);
        declareFunction(me, "sksi_sort_asents_rest", "SKSI-SORT-ASENTS-REST", 3, 0, false);
        declareFunction(me, "sksi_sort_compute_best_initial_asent", "SKSI-SORT-COMPUTE-BEST-INITIAL-ASENT", 1, 0, false);
        declareFunction(me, "sksi_determine_newly_constrained_vars", "SKSI-DETERMINE-NEWLY-CONSTRAINED-VARS", 2, 0, false);
        declareFunction(me, "sksi_sort_asents_bound_var_p", "SKSI-SORT-ASENTS-BOUND-VAR-P", 1, 0, false);
        new sksi_conjunctive_removal_module_utilities.$sksi_sort_asents_bound_var_p$UnaryFunction();
        declareFunction(me, "sksi_sort_asents_unbound_var_p", "SKSI-SORT-ASENTS-UNBOUND-VAR-P", 1, 0, false);
        new sksi_conjunctive_removal_module_utilities.$sksi_sort_asents_unbound_var_p$UnaryFunction();
        declareFunction(me, "sksi_sort_asents_use_cost_path_lookahead_methodP", "SKSI-SORT-ASENTS-USE-COST-PATH-LOOKAHEAD-METHOD?", 1, 0, false);
        declareFunction(me, "sksi_sort_select_best_asent", "SKSI-SORT-SELECT-BEST-ASENT", 2, 0, false);
        declareFunction(me, "sksi_sort_select_best_asent_and_cost_values", "SKSI-SORT-SELECT-BEST-ASENT-AND-COST-VALUES", 2, 0, false);
        declareFunction(me, "sksi_sort_select_best_asent_with_cost_path_lookahead", "SKSI-SORT-SELECT-BEST-ASENT-WITH-COST-PATH-LOOKAHEAD", 2, 0, false);
        declareFunction(me, "sksi_sort_asent_estimated_cost_path_transform_asent_elem", "SKSI-SORT-ASENT-ESTIMATED-COST-PATH-TRANSFORM-ASENT-ELEM", 1, 0, false);
        declareFunction(me, "asent_and_cost_path_L", "ASENT-AND-COST-PATH-<", 2, 0, false);
        declareFunction(me, "cost_path_L", "COST-PATH-<", 2, 0, false);
        declareFunction(me, "cost_path_computed_cost", "COST-PATH-COMPUTED-COST", 1, 0, false);
        declareFunction(me, "cost_path_L_wrt_first_differing_cost", "COST-PATH-<-WRT-FIRST-DIFFERING-COST", 2, 0, false);
        declareFunction(me, "sksi_sort_asent_estimated_cost_path_internal", "SKSI-SORT-ASENT-ESTIMATED-COST-PATH-INTERNAL", 3, 0, false);
        declareFunction(me, "sksi_sort_asent_estimated_cost_path", "SKSI-SORT-ASENT-ESTIMATED-COST-PATH", 3, 0, false);
        declareFunction(me, "sksi_asent_better_p", "SKSI-ASENT-BETTER-P", 2, 0, false);
        declareFunction(me, "sksi_asent_better_wrt_primary_characterics", "SKSI-ASENT-BETTER-WRT-PRIMARY-CHARACTERICS", 2, 0, false);
        new sksi_conjunctive_removal_module_utilities.$sksi_asent_better_wrt_primary_characterics$BinaryFunction();
        declareFunction(me, "sksi_asent_better_wrt_secondary_characterics", "SKSI-ASENT-BETTER-WRT-SECONDARY-CHARACTERICS", 2, 0, false);
        declareFunction(me, "sksi_asent_better_wrt_unbound_vars", "SKSI-ASENT-BETTER-WRT-UNBOUND-VARS", 2, 0, false);
        declareFunction(me, "sksi_asent_unbound_var_count", "SKSI-ASENT-UNBOUND-VAR-COUNT", 1, 0, false);
        declareFunction(me, "sksi_asent_better_wrt_other_fanout_args", "SKSI-ASENT-BETTER-WRT-OTHER-FANOUT-ARGS", 2, 0, false);
        declareFunction(me, "sksi_asent_other_fanout_arg_count", "SKSI-ASENT-OTHER-FANOUT-ARG-COUNT", 1, 0, false);
        declareFunction(me, "sksi_asent_fanout_arg_term_internal", "SKSI-ASENT-FANOUT-ARG-TERM-INTERNAL", 1, 0, false);
        declareFunction(me, "sksi_asent_fanout_arg_term", "SKSI-ASENT-FANOUT-ARG-TERM", 1, 0, false);
        declareFunction(me, "sksi_asent_better_wrt_total_var_bindings", "SKSI-ASENT-BETTER-WRT-TOTAL-VAR-BINDINGS", 2, 0, false);
        declareFunction(me, "sksi_asent_total_var_binding_count", "SKSI-ASENT-TOTAL-VAR-BINDING-COUNT", 1, 0, false);
        declareFunction(me, "sksi_asent_better_wrt_evaluatable_pred", "SKSI-ASENT-BETTER-WRT-EVALUATABLE-PRED", 2, 0, false);
        declareFunction(me, "sksi_evaluatable_predicateP_internal", "SKSI-EVALUATABLE-PREDICATE?-INTERNAL", 1, 0, false);
        declareFunction(me, "sksi_evaluatable_predicateP", "SKSI-EVALUATABLE-PREDICATE?", 1, 0, false);
        declareFunction(me, "sksi_asent_better_wrt_own_fanout_args", "SKSI-ASENT-BETTER-WRT-OWN-FANOUT-ARGS", 2, 0, false);
        declareFunction(me, "sksi_asent_fanout_arg_count", "SKSI-ASENT-FANOUT-ARG-COUNT", 1, 0, false);
        declareFunction(me, "sksi_asent_better_wrt_bound_vars", "SKSI-ASENT-BETTER-WRT-BOUND-VARS", 2, 0, false);
        declareFunction(me, "sksi_asent_bound_var_count", "SKSI-ASENT-BOUND-VAR-COUNT", 1, 0, false);
        declareFunction(me, "sksi_asent_better_wrt_arbitrary", "SKSI-ASENT-BETTER-WRT-ARBITRARY", 2, 0, false);
        declareFunction(me, "sksi_crm_generate_csql_for_query", "SKSI-CRM-GENERATE-CSQL-FOR-QUERY", 6, 0, false);
        declareFunction(me, "possibly_simplify_csql_wrt_field_equivalences", "POSSIBLY-SIMPLIFY-CSQL-WRT-FIELD-EQUIVALENCES", 3, 0, false);
        declareFunction(me, "csql_identify_equivalent_field_constraint", "CSQL-IDENTIFY-EQUIVALENT-FIELD-CONSTRAINT", 1, 0, false);
        declareFunction(me, "must_eq", "MUST-EQ", 2, 0, false);
        declareFunction(me, "must_kbeq", "MUST-KBEQ", 2, 0, false);
        declareFunction(me, "simplify_csql_wrt_equivalent_field_constraint", "SIMPLIFY-CSQL-WRT-EQUIVALENT-FIELD-CONSTRAINT", 2, 0, false);
        declareFunction(me, "simplify_var_decoding_map_wrt_equivalent_field_constraint", "SIMPLIFY-VAR-DECODING-MAP-WRT-EQUIVALENT-FIELD-CONSTRAINT", 3, 0, false);
        declareFunction(me, "simplify_var_lit_pfis_wrt_equivalent_field_constraint", "SIMPLIFY-VAR-LIT-PFIS-WRT-EQUIVALENT-FIELD-CONSTRAINT", 2, 0, false);
        declareFunction(me, "remove_namespaces_made_redundant_by_aliases", "REMOVE-NAMESPACES-MADE-REDUNDANT-BY-ALIASES", 2, 0, false);
        declareFunction(me, "gather_csql_aliases", "GATHER-CSQL-ALIASES", 1, 0, false);
        declareFunction(me, "csql_aliased_expression_with_namespaceP", "CSQL-ALIASED-EXPRESSION-WITH-NAMESPACE?", 1, 0, false);
        declareFunction(me, "csql_expression_remove_namespace", "CSQL-EXPRESSION-REMOVE-NAMESPACE", 1, 0, false);
        declareFunction(me, "csql_kill_table_alias_field_p", "CSQL-KILL-TABLE-ALIAS-FIELD-P", 1, 0, false);
        declareFunction(me, "csql_transform_table_alias_field", "CSQL-TRANSFORM-TABLE-ALIAS-FIELD", 1, 0, false);
        declareFunction(me, "csql_field_subst_wrt_table_alias", "CSQL-FIELD-SUBST-WRT-TABLE-ALIAS", 5, 0, false);
        declareFunction(me, "csql_result_set_index_to_renumber_p", "CSQL-RESULT-SET-INDEX-TO-RENUMBER-P", 1, 0, false);
        declareFunction(me, "csql_renumber_result_set_index", "CSQL-RENUMBER-RESULT-SET-INDEX", 1, 0, false);
        declareFunction(me, "csql_decoding_subst_wrt_rs_index", "CSQL-DECODING-SUBST-WRT-RS-INDEX", 3, 0, false);
        declareFunction(me, "make_sparql_csql_query_and_decoding_map", "MAKE-SPARQL-CSQL-QUERY-AND-DECODING-MAP", 5, 1, false);
        declareFunction(me, "sksi_sparql_csql_compute_decoding_map", "SKSI-SPARQL-CSQL-COMPUTE-DECODING-MAP", 4, 0, false);
        declareFunction(me, "sksi_sparql_compute_result_set_index_map", "SKSI-SPARQL-COMPUTE-RESULT-SET-INDEX-MAP", 3, 0, false);
        declareFunction(me, "sksi_crm_generate_csql_for_asent", "SKSI-CRM-GENERATE-CSQL-FOR-ASENT", 9, 0, false);
        declareFunction(me, "sksi_crm_generate_csql_for_arg", "SKSI-CRM-GENERATE-CSQL-FOR-ARG", 12, 0, false);
        declareFunction(me, "double_dictionary_pushnew", "DOUBLE-DICTIONARY-PUSHNEW", 4, 2, false);
        declareFunction(me, "double_dictionary_enter", "DOUBLE-DICTIONARY-ENTER", 4, 1, false);
        declareFunction(me, "sksi_crm_generate_csql_for_variable_arg", "SKSI-CRM-GENERATE-CSQL-FOR-VARIABLE-ARG", 11, 0, false);
        declareFunction(me, "sksi_crm_generate_csql_for_other_arg", "SKSI-CRM-GENERATE-CSQL-FOR-OTHER-ARG", 8, 0, false);
        declareFunction(me, "get_decoding_field_expressions_for_logical_field_indexical", "GET-DECODING-FIELD-EXPRESSIONS-FOR-LOGICAL-FIELD-INDEXICAL", 5, 0, false);
        declareFunction(me, "get_decoding_field_expressions_for_logical_field", "GET-DECODING-FIELD-EXPRESSIONS-FOR-LOGICAL-FIELD", 5, 0, false);
        declareFunction(me, "get_encoding_field_expressions_for_logical_field_indexical", "GET-ENCODING-FIELD-EXPRESSIONS-FOR-LOGICAL-FIELD-INDEXICAL", 4, 0, false);
        declareFunction(me, "get_encoding_field_expressions_for_logical_field", "GET-ENCODING-FIELD-EXPRESSIONS-FOR-LOGICAL-FIELD", 4, 0, false);
        declareFunction(me, "get_field_expressions_for_physical_field", "GET-FIELD-EXPRESSIONS-FOR-PHYSICAL-FIELD", 2, 1, false);
        declareFunction(me, "get_decodings_for_logical_field_indexical_internal", "GET-DECODINGS-FOR-LOGICAL-FIELD-INDEXICAL-INTERNAL", 3, 0, false);
        declareFunction(me, "get_decodings_for_logical_field_indexical", "GET-DECODINGS-FOR-LOGICAL-FIELD-INDEXICAL", 3, 0, false);
        declareFunction(me, "get_pfi_encoding_pairs_for_logical_field_indexical_internal", "GET-PFI-ENCODING-PAIRS-FOR-LOGICAL-FIELD-INDEXICAL-INTERNAL", 2, 0, false);
        declareFunction(me, "get_pfi_encoding_pairs_for_logical_field_indexical", "GET-PFI-ENCODING-PAIRS-FOR-LOGICAL-FIELD-INDEXICAL", 2, 0, false);
        declareFunction(me, "get_primary_keys_for_logical_field_indexical_internal", "GET-PRIMARY-KEYS-FOR-LOGICAL-FIELD-INDEXICAL-INTERNAL", 3, 1, false);
        declareFunction(me, "get_primary_keys_for_logical_field_indexical", "GET-PRIMARY-KEYS-FOR-LOGICAL-FIELD-INDEXICAL", 3, 1, false);
        declareFunction(me, "get_primary_keys_from_decodings_internal", "GET-PRIMARY-KEYS-FROM-DECODINGS-INTERNAL", 2, 0, false);
        declareFunction(me, "get_primary_keys_from_decodings", "GET-PRIMARY-KEYS-FROM-DECODINGS", 2, 0, false);
        declareFunction(me, "primary_key_for_some_physical_schemaP", "PRIMARY-KEY-FOR-SOME-PHYSICAL-SCHEMA?", 2, 0, false);
        declareFunction(me, "sksi_crm_required_fields_have_values_in_where_clauseP", "SKSI-CRM-REQUIRED-FIELDS-HAVE-VALUES-IN-WHERE-CLAUSE?", 3, 0, false);
        declareFunction(me, "sksi_crm_relevant_table_present_in_where_clauseP", "SKSI-CRM-RELEVANT-TABLE-PRESENT-IN-WHERE-CLAUSE?", 2, 0, false);
        declareFunction(me, "where_expression_contains_value_for_field_expressionP", "WHERE-EXPRESSION-CONTAINS-VALUE-FOR-FIELD-EXPRESSION?", 2, 0, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_conditional_meaning_sentence_gaf", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-CONDITIONAL-MEANING-SENTENCE-GAF", 4, 0, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_sksi_unknown_sentence_asents", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-SKSI-UNKNOWN-SENTENCE-ASENTS", 13, 0, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_sksi_unknown_sentence_asent", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-SKSI-UNKNOWN-SENTENCE-ASENT", 12, 0, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_sksi_unknown_sentence_asent_recursive", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-SKSI-UNKNOWN-SENTENCE-ASENT-RECURSIVE", 13, 0, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_sksi_conjunctive_unknown_sentence", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-SKSI-CONJUNCTIVE-UNKNOWN-SENTENCE", 13, 0, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_sksi_atomic_unknown_sentence", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-SKSI-ATOMIC-UNKNOWN-SENTENCE", 12, 0, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_comparisons", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-COMPARISONS", 9, 0, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_comparison_asent", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-COMPARISON-ASENT", 9, 0, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_comparison_asent_single_var", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-COMPARISON-ASENT-SINGLE-VAR", 9, 1, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_comparison_asent_double_vars", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-COMPARISON-ASENT-DOUBLE-VARS", 6, 0, false);
        declareFunction(me, "sksi_crm_apply_csql_operator_to_pfi_list_pair", "SKSI-CRM-APPLY-CSQL-OPERATOR-TO-PFI-LIST-PAIR", 6, 0, false);
        declareFunction(me, "sksi_crm_csql_operator_argnum_encodings_override_internal", "SKSI-CRM-CSQL-OPERATOR-ARGNUM-ENCODINGS-OVERRIDE-INTERNAL", 3, 0, false);
        declareFunction(me, "sksi_crm_csql_operator_argnum_encodings_override", "SKSI-CRM-CSQL-OPERATOR-ARGNUM-ENCODINGS-OVERRIDE", 3, 0, false);
        declareFunction(me, "sksi_crm_apply_csql_operator_to_pfi_list_value_pair", "SKSI-CRM-APPLY-CSQL-OPERATOR-TO-PFI-LIST-VALUE-PAIR", 9, 1, false);
        declareFunction(me, "sksi_crm_get_where_clauses_from_decodings", "SKSI-CRM-GET-WHERE-CLAUSES-FROM-DECODINGS", 4, 0, false);
        declareFunction(me, "remake_where_clause", "REMAKE-WHERE-CLAUSE", 2, 1, false);
        declareFunction(me, "remake_where_clause_single", "REMAKE-WHERE-CLAUSE-SINGLE", 3, 0, false);
        declareFunction(me, "remake_where_clause_multiple", "REMAKE-WHERE-CLAUSE-MULTIPLE", 2, 0, false);
        declareFunction(me, "get_lit_pfi_list_pairs", "GET-LIT-PFI-LIST-PAIRS", 1, 0, false);
        declareFunction(me, "apply_csql_operator_to_lit_pfi_list_pair", "APPLY-CSQL-OPERATOR-TO-LIT-PFI-LIST-PAIR", 4, 0, false);
        declareFunction(me, "sksi_crm_get_select_expressions_from_evaluations", "SKSI-CRM-GET-SELECT-EXPRESSIONS-FROM-EVALUATIONS", 9, 0, false);
        declareFunction(me, "variable_predicate_litP", "VARIABLE-PREDICATE-LIT?", 1, 0, false);
        declareFunction(me, "binary_litP", "BINARY-LIT?", 1, 0, false);
        declareFunction(me, "invert_lit", "INVERT-LIT", 1, 0, false);
        return NIL;
    }
