...
import static com.cyc.cycjava.cycl.sksi.sks_indexing.sksi_sks_gaf_arg_indexing.*;
...
public final class sksi_sks_gaf_arg_indexing extends SubLTranslatedFile {
    ...
    public static SubLObject sksi_supported_gaf_argument_cache_entry_p(final SubLObject v_object) {
        return v_object.getClass() == sksi_sks_gaf_arg_indexing.$sksi_supported_gaf_argument_cache_entry_native.class ? T : NIL;
    }

    public static SubLObject sksi_gaf_arg_entry_argument_position(final SubLObject v_object) {
        assert NIL != sksi_supported_gaf_argument_cache_entry_p(v_object) : "sksi_sks_gaf_arg_indexing.sksi_supported_gaf_argument_cache_entry_p(v_object) " + "CommonSymbols.NIL != sksi_sks_gaf_arg_indexing.sksi_supported_gaf_argument_cache_entry_p(v_object) " + v_object;
    ...
    public static SubLObject make_sksi_supported_gaf_argument_cache_entry(SubLObject arglist) {
        ...
        final SubLObject v_new = new sksi_sks_gaf_arg_indexing.$sksi_supported_gaf_argument_cache_entry_native();
        SubLObject next;
    ...
    public static final class $sksi_supported_gaf_argument_cache_entry_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sksi_sks_gaf_arg_indexing.$sksi_supported_gaf_argument_cache_entry_native.class, SKSI_SUPPORTED_GAF_ARGUMENT_CACHE_ENTRY, SKSI_SUPPORTED_GAF_ARGUMENT_CACHE_ENTRY_P, $list2, $list3, new String[]{ "$argument_position", "$query_form", "$predicate", "$mt", "$count", "$modules" }, $list4, $list5, PRINT_SKSI_SUPPORTED_GAF_ARGUMENT_CACHE_ENTRY);
        }
    }
