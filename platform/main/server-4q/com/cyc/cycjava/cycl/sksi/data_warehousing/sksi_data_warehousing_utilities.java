...
import com.cyc.cycjava.cycl.sksi.data_warehousing.sksi_data_warehousing_utilities;
...
import static com.cyc.cycjava.cycl.sksi.data_warehousing.sksi_data_warehousing_utilities.*;
...
public final class sksi_data_warehousing_utilities extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol SKSI_ENCODE_MEMOIZED = makeSymbol("SKSI-ENCODE-MEMOIZED");
    ...
    public static SubLObject declare_sksi_data_warehousing_utilities_file() {
        declareFunction(me, "sksi_encode_memoized_internal", "SKSI-ENCODE-MEMOIZED-INTERNAL", 3, 1, false);
        declareFunction(me, "sksi_encode_memoized", "SKSI-ENCODE-MEMOIZED", 3, 1, false);
        declareFunction(me, "construct_lfi_value_cache", "CONSTRUCT-LFI-VALUE-CACHE", 1, 0, false);
        declareFunction(me, "decoded_sentence_satisfies_conditionP", "DECODED-SENTENCE-SATISFIES-CONDITION?", 4, 0, false);
        declareFunction(me, "closed_decoded_sentence_satisfies_conditionP_internal", "CLOSED-DECODED-SENTENCE-SATISFIES-CONDITION?-INTERNAL", 2, 1, false);
        declareFunction(me, "closed_decoded_sentence_satisfies_conditionP", "CLOSED-DECODED-SENTENCE-SATISFIES-CONDITION?", 2, 1, false);
        declareFunction(me, "decoded_sentence_satisfies_condition_intP", "DECODED-SENTENCE-SATISFIES-CONDITION-INT?", 4, 0, false);
        declareFunction(me, "check_csql_conditions_with_sk_source", "CHECK-CSQL-CONDITIONS-WITH-SK-SOURCE", 3, 0, false);
        declareFunction(me, "get_from_and_where_expression_for_antecedent_of_conditional_meaning_sentence", "GET-FROM-AND-WHERE-EXPRESSION-FOR-ANTECEDENT-OF-CONDITIONAL-MEANING-SENTENCE", 8, 0, false);
        declareFunction(me, "decoded_sentence_satisfies_condition_recursiveP", "DECODED-SENTENCE-SATISFIES-CONDITION-RECURSIVE?", 3, 0, false);
        declareFunction(me, "atomic_sentence_satisfies_conditionP", "ATOMIC-SENTENCE-SATISFIES-CONDITION?", 3, 0, false);
        declareFunction(me, "open_decoded_sentence_satisfies_conditionP", "OPEN-DECODED-SENTENCE-SATISFIES-CONDITION?", 4, 0, false);
        declareFunction(me, "make_sentence_template", "MAKE-SENTENCE-TEMPLATE", 1, 0, false);
        declareFunction(me, "sksi_template_appropriate_for_schemasP", "SKSI-TEMPLATE-APPROPRIATE-FOR-SCHEMAS?", 3, 1, false);
        declareFunction(me, "sksi_template_appropriate_for_schemas_intP", "SKSI-TEMPLATE-APPROPRIATE-FOR-SCHEMAS-INT?", 6, 0, false);
        return NIL;
    }
