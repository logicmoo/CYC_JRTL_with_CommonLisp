...
public final class semantic_etl_bus extends SubLTranslatedFile {
    ...
    public static SubLObject semantics_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$semantics_native.class ? T : NIL;
    }

    public static SubLObject semant_access_path(final SubLObject v_object) {
        assert NIL != semantics_p(v_object) : "semantic_etl_bus.semantics_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.semantics_p(v_object) " + v_object;
    ...
    public static SubLObject make_semantics(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$semantics_native();
        SubLObject next;
    ...
    public static SubLObject table_semantics_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$table_semantics_native.class ? T : NIL;
    }

    public static SubLObject t_semant_table_id(final SubLObject v_object) {
        assert NIL != table_semantics_p(v_object) : "semantic_etl_bus.table_semantics_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.table_semantics_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_table_semantics(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$table_semantics_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject foreign_key_constraint_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$foreign_key_constraint_native.class ? T : NIL;
    }

    public static SubLObject fk_constraint_constraint_name(final SubLObject v_object) {
        assert NIL != foreign_key_constraint_p(v_object) : "semantic_etl_bus.foreign_key_constraint_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.foreign_key_constraint_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_foreign_key_constraint(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$foreign_key_constraint_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject primary_key_constraint_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$primary_key_constraint_native.class ? T : NIL;
    }

    public static SubLObject pk_constraint_constraint_name(final SubLObject v_object) {
        assert NIL != primary_key_constraint_p(v_object) : "semantic_etl_bus.primary_key_constraint_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.primary_key_constraint_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_primary_key_constraint(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$primary_key_constraint_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject column_semantics_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$column_semantics_native.class ? T : NIL;
    }

    public static SubLObject c_semant_column_name(final SubLObject v_object) {
        assert NIL != column_semantics_p(v_object) : "semantic_etl_bus.column_semantics_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.column_semantics_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_column_semantics(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$column_semantics_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject value_semantics_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$value_semantics_native.class ? T : NIL;
    }

    public static SubLObject v_semant_value(final SubLObject v_object) {
        assert NIL != value_semantics_p(v_object) : "semantic_etl_bus.value_semantics_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.value_semantics_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_value_semantics(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$value_semantics_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject database_output_spec_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$database_output_spec_native.class ? T : NIL;
    }

    public static SubLObject db_output_spec_id(final SubLObject v_object) {
        assert NIL != database_output_spec_p(v_object) : "semantic_etl_bus.database_output_spec_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.database_output_spec_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_database_output_spec(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$database_output_spec_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject table_merger_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$table_merger_native.class ? T : NIL;
    }

    public static SubLObject table_merger_id(final SubLObject v_object) {
        assert NIL != table_merger_p(v_object) : "semantic_etl_bus.table_merger_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.table_merger_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_table_merger(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$table_merger_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject column_merger_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$column_merger_native.class ? T : NIL;
    }

    public static SubLObject column_merger_output_spec(final SubLObject v_object) {
        assert NIL != column_merger_p(v_object) : "semantic_etl_bus.column_merger_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.column_merger_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_column_merger(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$column_merger_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_conjunction_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_conjunction_native.class ? T : NIL;
    }

    public static SubLObject sql_conjunction_conjuncts(final SubLObject v_object) {
        assert NIL != sql_conjunction_p(v_object) : "semantic_etl_bus.sql_conjunction_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_conjunction_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_conjunction(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_conjunction_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_disjunction_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_disjunction_native.class ? T : NIL;
    }

    public static SubLObject sql_disjunction_disjuncts(final SubLObject v_object) {
        assert NIL != sql_disjunction_p(v_object) : "semantic_etl_bus.sql_disjunction_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_disjunction_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_disjunction(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_disjunction_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_copy_table_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_copy_table_native.class ? T : NIL;
    }

    public static SubLObject sql_copy_table_table(final SubLObject v_object) {
        assert NIL != sql_copy_table_p(v_object) : "semantic_etl_bus.sql_copy_table_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_copy_table_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_copy_table(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_copy_table_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_insert_into_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_insert_into_native.class ? T : NIL;
    }

    public static SubLObject sql_insert_into_table(final SubLObject v_object) {
        assert NIL != sql_insert_into_p(v_object) : "semantic_etl_bus.sql_insert_into_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_insert_into_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_insert_into(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_insert_into_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_select_from_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_select_from_native.class ? T : NIL;
    }

    public static SubLObject sql_select_from_columns(final SubLObject v_object) {
        assert NIL != sql_select_from_p(v_object) : "semantic_etl_bus.sql_select_from_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_select_from_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_select_from(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_select_from_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_except_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_except_native.class ? T : NIL;
    }

    public static SubLObject sql_except_table1(final SubLObject v_object) {
        assert NIL != sql_except_p(v_object) : "semantic_etl_bus.sql_except_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_except_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_except(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_except_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_alias_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_alias_native.class ? T : NIL;
    }

    public static SubLObject sql_alias_table(final SubLObject v_object) {
        assert NIL != sql_alias_p(v_object) : "semantic_etl_bus.sql_alias_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_alias_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_alias(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_alias_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_column_equal_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_column_equal_native.class ? T : NIL;
    }

    public static SubLObject sql_column_equal_table1(final SubLObject v_object) {
        assert NIL != sql_column_equal_p(v_object) : "semantic_etl_bus.sql_column_equal_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_column_equal_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_column_equal(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_column_equal_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_is_null_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_is_null_native.class ? T : NIL;
    }

    public static SubLObject sql_is_null_table(final SubLObject v_object) {
        assert NIL != sql_is_null_p(v_object) : "semantic_etl_bus.sql_is_null_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_is_null_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_is_null(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_is_null_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_not_in_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_not_in_native.class ? T : NIL;
    }

    public static SubLObject sql_not_in_column_table(final SubLObject v_object) {
        assert NIL != sql_not_in_p(v_object) : "semantic_etl_bus.sql_not_in_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_not_in_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_not_in(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_not_in_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_inner_join_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_inner_join_native.class ? T : NIL;
    }

    public static SubLObject sql_inner_join_table1(final SubLObject v_object) {
        assert NIL != sql_inner_join_p(v_object) : "semantic_etl_bus.sql_inner_join_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_inner_join_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_inner_join(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_inner_join_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_left_join_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_left_join_native.class ? T : NIL;
    }

    public static SubLObject sql_left_join_left_table(final SubLObject v_object) {
        assert NIL != sql_left_join_p(v_object) : "semantic_etl_bus.sql_left_join_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_left_join_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_left_join(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_left_join_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_union_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_union_native.class ? T : NIL;
    }

    public static SubLObject sql_union_select1(final SubLObject v_object) {
        assert NIL != sql_union_p(v_object) : "semantic_etl_bus.sql_union_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_union_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_union(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_union_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_alter_table_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_alter_table_native.class ? T : NIL;
    }

    public static SubLObject sql_alter_table_table(final SubLObject v_object) {
        assert NIL != sql_alter_table_p(v_object) : "semantic_etl_bus.sql_alter_table_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_alter_table_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_alter_table(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_alter_table_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_add_column_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_add_column_native.class ? T : NIL;
    }

    public static SubLObject sql_add_column_column(final SubLObject v_object) {
        assert NIL != sql_add_column_p(v_object) : "semantic_etl_bus.sql_add_column_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_add_column_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_add_column(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_add_column_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_drop_column_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_drop_column_native.class ? T : NIL;
    }

    public static SubLObject sql_drop_column_column(final SubLObject v_object) {
        assert NIL != sql_drop_column_p(v_object) : "semantic_etl_bus.sql_drop_column_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_drop_column_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_drop_column(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_drop_column_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_rename_column_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_rename_column_native.class ? T : NIL;
    }

    public static SubLObject sql_rename_column_old_column(final SubLObject v_object) {
        assert NIL != sql_rename_column_p(v_object) : "semantic_etl_bus.sql_rename_column_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_rename_column_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_rename_column(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_rename_column_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_add_constraint_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_add_constraint_native.class ? T : NIL;
    }

    public static SubLObject sql_add_constraint_constraint(final SubLObject v_object) {
        assert NIL != sql_add_constraint_p(v_object) : "semantic_etl_bus.sql_add_constraint_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_add_constraint_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_add_constraint(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_add_constraint_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_drop_constraint_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_drop_constraint_native.class ? T : NIL;
    }

    public static SubLObject sql_drop_constraint_constraint(final SubLObject v_object) {
        assert NIL != sql_drop_constraint_p(v_object) : "semantic_etl_bus.sql_drop_constraint_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_drop_constraint_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_drop_constraint(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_drop_constraint_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_fk_column_constraint_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_fk_column_constraint_native.class ? T : NIL;
    }

    public static SubLObject sql_fk_column_constraint_name(final SubLObject v_object) {
        assert NIL != sql_fk_column_constraint_p(v_object) : "semantic_etl_bus.sql_fk_column_constraint_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_fk_column_constraint_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_fk_column_constraint(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_fk_column_constraint_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_fk_table_constraint_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_fk_table_constraint_native.class ? T : NIL;
    }

    public static SubLObject sql_fk_table_constraint_column(final SubLObject v_object) {
        assert NIL != sql_fk_table_constraint_p(v_object) : "semantic_etl_bus.sql_fk_table_constraint_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_fk_table_constraint_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_fk_table_constraint(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_fk_table_constraint_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_update_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_update_native.class ? T : NIL;
    }

    public static SubLObject sql_update_table(final SubLObject v_object) {
        assert NIL != sql_update_p(v_object) : "semantic_etl_bus.sql_update_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_update_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_update(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_update_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sql_drop_table_p(final SubLObject v_object) {
        return v_object.getClass() == semantic_etl_bus.$sql_drop_table_native.class ? T : NIL;
    }

    public static SubLObject sql_drop_table_table(final SubLObject v_object) {
        assert NIL != sql_drop_table_p(v_object) : "semantic_etl_bus.sql_drop_table_p(v_object) " + "CommonSymbols.NIL != semantic_etl_bus.sql_drop_table_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sql_drop_table(SubLObject arglist) {
        ...
        final SubLObject v_new = new semantic_etl_bus.$sql_drop_table_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $semantics_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$semantics_native.class, SEMANTICS, SEMANTICS_P, $list22, $list23, new String[]{ "$access_path", "$table_semantics_list", "$table_aliases", "$dict", "$dropped_items", "$output_spec" }, $list24, $list25, PRINT_SEMANTICS);
        }
    }
    ...
    public static final class $foreign_key_constraint_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$foreign_key_constraint_native.class, FOREIGN_KEY_CONSTRAINT, FOREIGN_KEY_CONSTRAINT_P, $list120, $list121, new String[]{ "$constraint_name", "$constrained_column", "$constraining_table", "$constraining_column" }, $list122, $list123, PRINT_FOREIGN_KEY_CONSTRAINT);
        }
    }
    ...
    public static final class $primary_key_constraint_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$primary_key_constraint_native.class, PRIMARY_KEY_CONSTRAINT, PRIMARY_KEY_CONSTRAINT_P, $list147, $list148, new String[]{ "$constraint_name", "$constraint_type", "$constrained_column" }, $list149, $list150, PRINT_PRIMARY_KEY_CONSTRAINT);
        }
    }
    ...
    public static final class $column_semantics_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$column_semantics_native.class, COLUMN_SEMANTICS, COLUMN_SEMANTICS_P, $list168, $list169, new String[]{ "$column_name", "$column_parses", "$table_semantics", "$value_semantics_list", "$column_type", "$column_size" }, $list170, $list171, PRINT_COLUMN_SEMANTICS);
        }
    }
    ...
    public static final class $value_semantics_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$value_semantics_native.class, VALUE_SEMANTICS, VALUE_SEMANTICS_P, $list207, $list208, new String[]{ "$value", "$value_parses" }, $list209, $list210, PRINT_VALUE_SEMANTICS);
        }
    }
    ...
    public static final class $database_output_spec_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$database_output_spec_native.class, DATABASE_OUTPUT_SPEC, DATABASE_OUTPUT_SPEC_P, $list227, $list228, new String[]{ "$id", "$semantics1", "$semantics2", "$recipe", "$semantics", "$semantic_recipe" }, $list229, $list230, PRINT_DATABASE_OUTPUT_SPEC);
        }
    }
    ...
    public static final class $table_merger_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$table_merger_native.class, TABLE_MERGER, TABLE_MERGER_P, $list268, $list269, new String[]{ "$id", "$output_spec", "$sources", "$target", "$column_correspondence_list", "$added", "$dropped", "$sql_start_index", "$sql_end_index" }, $list270, $list271, PRINT_TABLE_MERGER);
        }
    }
    ...
    public static final class $column_merger_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$column_merger_native.class, COLUMN_MERGER, COLUMN_MERGER_P, $list324, $list325, new String[]{ "$output_spec", "$sources", "$target", "$column_correspondence_list", "$added", "$dropped", "$sql_start_index", "$sql_end_index" }, $list326, $list327, PRINT_COLUMN_MERGER);
        }
    }
    ...
    public static final class $sql_conjunction_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_conjunction_native.class, SQL_CONJUNCTION, SQL_CONJUNCTION_P, $list371, $list372, new String[]{ "$conjuncts" }, $list373, $list374, PRINT_SQL_CONJUNCTION);
        }
    }
    ...
    public static final class $sql_disjunction_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_disjunction_native.class, SQL_DISJUNCTION, SQL_DISJUNCTION_P, $list387, $list388, new String[]{ "$disjuncts" }, $list389, $list390, PRINT_SQL_DISJUNCTION);
        }
    }
    ...
    public static final class $sql_copy_table_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_copy_table_native.class, SQL_COPY_TABLE, SQL_COPY_TABLE_P, $list402, $list403, new String[]{ "$table", "$from", "$to" }, $list404, $list405, PRINT_SQL_COPY_TABLE);
        }
    }
    ...
    public static final class $sql_insert_into_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_insert_into_native.class, SQL_INSERT_INTO, SQL_INSERT_INTO_P, $list423, $list424, new String[]{ "$table", "$columns", "$data" }, $list425, $list426, PRINT_SQL_INSERT_INTO);
        }
    }
    ...
    public static final class $sql_select_from_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_select_from_native.class, SQL_SELECT_FROM, SQL_SELECT_FROM_P, $list445, $list446, new String[]{ "$columns", "$tables", "$conditions" }, $list447, $list448, PRINT_SQL_SELECT_FROM);
        }
    }
    ...
    public static final class $sql_except_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_except_native.class, SQL_EXCEPT, SQL_EXCEPT_P, $list467, $list468, new String[]{ "$table1", "$table2" }, $list469, $list470, PRINT_SQL_EXCEPT);
        }
    }
    ...
    public static final class $sql_alias_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_alias_native.class, SQL_ALIAS, SQL_ALIAS_P, $list485, $list486, new String[]{ "$table", "$alias" }, $list487, $list488, PRINT_SQL_ALIAS);
        }
    }
    ...
    public static final class $sql_column_equal_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_column_equal_native.class, SQL_COLUMN_EQUAL, SQL_COLUMN_EQUAL_P, $list502, $list503, new String[]{ "$table1", "$column1", "$table2", "$column2" }, $list504, $list505, PRINT_SQL_COLUMN_EQUAL);
        }
    }
    ...
    public static final class $sql_is_null_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_is_null_native.class, SQL_IS_NULL, SQL_IS_NULL_P, $list524, $list525, new String[]{ "$table", "$column" }, $list526, $list527, PRINT_SQL_IS_NULL);
        }
    }
    ...
    public static final class $sql_not_in_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_not_in_native.class, SQL_NOT_IN, SQL_NOT_IN_P, $list541, $list542, new String[]{ "$column_table", "$column", "$table" }, $list543, $list544, PRINT_SQL_NOT_IN);
        }
    }
    ...
    public static final class $sql_inner_join_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_inner_join_native.class, SQL_INNER_JOIN, SQL_INNER_JOIN_P, $list560, $list561, new String[]{ "$table1", "$table2", "$on" }, $list562, $list563, PRINT_SQL_INNER_JOIN);
        }
    }
    ...
    public static final class $sql_left_join_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_left_join_native.class, SQL_LEFT_JOIN, SQL_LEFT_JOIN_P, $list579, $list580, new String[]{ "$left_table", "$right_table", "$on" }, $list581, $list582, PRINT_SQL_LEFT_JOIN);
        }
    }
    ...
    public static final class $sql_union_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_union_native.class, SQL_UNION, SQL_UNION_P, $list599, $list600, new String[]{ "$select1", "$select2" }, $list601, $list602, PRINT_SQL_UNION);
        }
    }
    ...
    public static final class $sql_alter_table_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_alter_table_native.class, SQL_ALTER_TABLE, SQL_ALTER_TABLE_P, $list617, $list618, new String[]{ "$table", "$action" }, $list619, $list620, PRINT_SQL_ALTER_TABLE);
        }
    }
    ...
    public static final class $sql_add_column_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_add_column_native.class, SQL_ADD_COLUMN, SQL_ADD_COLUMN_P, $list635, $list636, new String[]{ "$column", "$type", "$size", "$constraints" }, $list637, $list638, PRINT_SQL_ADD_COLUMN);
        }
    }
    ...
    public static final class $sql_drop_column_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_drop_column_native.class, SQL_DROP_COLUMN, SQL_DROP_COLUMN_P, $list661, $list662, new String[]{ "$column" }, $list663, $list664, PRINT_SQL_DROP_COLUMN);
        }
    }
    ...
    public static final class $sql_rename_column_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_rename_column_native.class, SQL_RENAME_COLUMN, SQL_RENAME_COLUMN_P, $list675, $list676, new String[]{ "$old_column", "$new_column" }, $list677, $list678, PRINT_SQL_RENAME_COLUMN);
        }
    }
    ...
    public static final class $sql_add_constraint_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_add_constraint_native.class, SQL_ADD_CONSTRAINT, SQL_ADD_CONSTRAINT_P, $list693, $list694, new String[]{ "$constraint" }, $list695, $list696, PRINT_SQL_ADD_CONSTRAINT);
        }
    }
    ...
    public static final class $sql_drop_constraint_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_drop_constraint_native.class, SQL_DROP_CONSTRAINT, SQL_DROP_CONSTRAINT_P, $list693, $list694, new String[]{ "$constraint" }, $list709, $list710, PRINT_SQL_DROP_CONSTRAINT);
        }
    }
    ...
    public static final class $sql_fk_column_constraint_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_fk_column_constraint_native.class, SQL_FK_COLUMN_CONSTRAINT, SQL_FK_COLUMN_CONSTRAINT_P, $list721, $list722, new String[]{ "$name", "$table", "$column" }, $list723, $list724, PRINT_SQL_FK_COLUMN_CONSTRAINT);
        }
    }
    ...
    public static final class $sql_fk_table_constraint_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_fk_table_constraint_native.class, SQL_FK_TABLE_CONSTRAINT, SQL_FK_TABLE_CONSTRAINT_P, $list740, $list741, new String[]{ "$column", "$constraint" }, $list742, $list743, PRINT_SQL_FK_TABLE_CONSTRAINT);
        }
    }
    ...
    public static final class $sql_update_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_update_native.class, SQL_UPDATE, SQL_UPDATE_P, $list756, $list757, new String[]{ "$table", "$settings", "$conditions" }, $list758, $list759, PRINT_SQL_UPDATE);
        }
    }
    ...
    public static final class $sql_drop_table_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(semantic_etl_bus.$sql_drop_table_native.class, SQL_DROP_TABLE, SQL_DROP_TABLE_P, $list776, $list777, new String[]{ "$table" }, $list778, $list779, PRINT_SQL_DROP_TABLE);
        }
    }
