...
public final class sksi_sks_indexing_utilities
    extends
      SubLTranslatedFile
{
  ...
  {
    SubLFiles.declareFunction( me, "sksi_query_forms_unifyP", "SKSI-QUERY-FORMS-UNIFY?", 2, 0, false );
    SubLFiles.declareFunction( me, "binding_binds_same_type_termsP", "BINDING-BINDS-SAME-TYPE-TERMS?", 1, 0, false );
    return NIL;
  }
  ...
  static
  {
    me = new sksi_sks_indexing_utilities();
  }
}
/*
 * 
