...
public final class sksi_batch_store
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject sksi_store_ist_logical_sentences_in_sk_source(final SubLObject list_of_ist_logical_sentences, final SubLObject sk_source, final SubLObject logical_schema, final SubLObject physical_schema,
      SubLObject meta_mt, SubLObject access_path)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if( $const0$Database_Physical.eql( source_type ) )
          {
            sksi_store_or_delete_ist_logical_sentences_in_db( list_of_ist_logical_sentences, sk_source, access_path, logical_schema, physical_schema, meta_mt, $kw1$INSERT );
          }
          else
          {
  ...
  public static SubLObject sksi_delete_ist_logical_sentences_from_sk_source(final SubLObject list_of_ist_logical_sentences, final SubLObject sk_source, final SubLObject logical_schema, final SubLObject physical_schema,
      SubLObject meta_mt, SubLObject access_path)
  {
    if( meta_mt == UNPROVIDED )
    {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if( $const0$Database_Physical.eql( source_type ) )
          {
            sksi_store_or_delete_ist_logical_sentences_in_db( list_of_ist_logical_sentences, sk_source, access_path, logical_schema, physical_schema, meta_mt, $kw2$DELETE );
          }
          else
          {
            SubLObject cdolist_list_var = list_of_ist_logical_sentences;
  ...
  public static SubLObject sksi_store_logical_sentences_in_sk_source(final SubLObject list_of_logical_sentences, final SubLObject sk_source, final SubLObject logical_schema, final SubLObject physical_schema,
      SubLObject meta_mt, SubLObject access_path)
  {
    if( meta_mt == UNPROVIDED )
    {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if( $const0$Database_Physical.eql( source_type ) )
          {
            sksi_store_or_delete_logical_sentences_in_db( list_of_logical_sentences, sk_source, access_path, logical_schema, physical_schema, meta_mt, $kw1$INSERT, UNPROVIDED, UNPROVIDED );
          }
          else
          {
  ...
  public static SubLObject sksi_delete_logical_sentences_from_sk_source(final SubLObject list_of_logical_sentences, final SubLObject sk_source, final SubLObject logical_schema, final SubLObject physical_schema,
      SubLObject meta_mt, SubLObject access_path)
  {
    if( meta_mt == UNPROVIDED )
    {
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if( $const0$Database_Physical.eql( source_type ) )
          {
            sksi_store_or_delete_logical_sentences_in_db( list_of_logical_sentences, sk_source, access_path, logical_schema, physical_schema, meta_mt, $kw2$DELETE, UNPROVIDED, UNPROVIDED );
          }
          else
          {
            SubLObject cdolist_list_var = list_of_logical_sentences;
  ...
  public static SubLObject sksi_store_mt_contents_in_sk_source(final SubLObject mt, final SubLObject sk_source, final SubLObject logical_schema, final SubLObject physical_schema, SubLObject meta_mt)
  {
    ...
    try
    {
      ...
      try
      {
        final SubLObject logical_sentences = Mapping.mapcar( $sym3$ASSERTION_FORMULA, kb_mapping.gather_mt_index( mt ) );
  ...
  public static SubLObject sksi_store_or_delete_ist_logical_sentences_in_db(final SubLObject list_of_logical_sentences, final SubLObject sk_source, final SubLObject access_path, final SubLObject logical_schema,
      final SubLObject physical_schema, final SubLObject meta_mt, final SubLObject operator)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    ...
    if( NIL != sksi_access_path.access_path_p( access_path ) )
    {
      ...
      try
      {
        connection = sdbc.new_sql_connection( db, user, password, ConsesLow.list( new SubLObject[] { $kw4$DBMS_SERVER, server, $kw5$PORT, conn_port, $kw6$SUBPROTOCOL, subprotocol, $kw7$PROXY_SERVER, conn_server,
          $kw8$TIMEOUT, conn_timeout
        } ) );
        ...
        if( NIL != sdbc.sql_open_statement_p( statement ) )
        {
          ...
          {
            sdbc.sqlc_set_error_handling( connection_$11, $kw9$THROW );
            try
            {
  ...
  public static SubLObject sksi_store_or_delete_logical_sentences_in_db(final SubLObject list_of_logical_sentences, final SubLObject sk_source, final SubLObject access_path, final SubLObject logical_schema,
              ...
              while ( NIL != cdolist_list_var)
              {
                ...
                if( NIL == current )
                {
                  ...
                  if( NIL == sksi_csql_utilities.invalid_csql_expressionP( csql ) )
                  {
                    final SubLObject sql = sksi_csql_interpretation.csql_to_sql( csql, sql_flavor, UNPROVIDED );
                    some_successP = T;
                    all_sql_statements = ConsesLow.cons( sql, all_sql_statements );
                    all_auto_key_fields = conses_high.union( all_auto_key_fields, auto_key_fields, UNPROVIDED, UNPROVIDED );
                  }
                }
                else
                {
  ...
  {
    SubLFiles.declareFunction( me, "sksi_store_ist_logical_sentences_in_sk_source", "SKSI-STORE-IST-LOGICAL-SENTENCES-IN-SK-SOURCE", 4, 2, false );
    SubLFiles.declareFunction( me, "sksi_delete_ist_logical_sentences_from_sk_source", "SKSI-DELETE-IST-LOGICAL-SENTENCES-FROM-SK-SOURCE", 4, 2, false );
    SubLFiles.declareFunction( me, "sksi_store_logical_sentences_in_sk_source", "SKSI-STORE-LOGICAL-SENTENCES-IN-SK-SOURCE", 4, 2, false );
    SubLFiles.declareFunction( me, "sksi_delete_logical_sentences_from_sk_source", "SKSI-DELETE-LOGICAL-SENTENCES-FROM-SK-SOURCE", 4, 2, false );
    SubLFiles.declareFunction( me, "sksi_store_mt_contents_in_sk_source", "SKSI-STORE-MT-CONTENTS-IN-SK-SOURCE", 4, 1, false );
    SubLFiles.declareFunction( me, "sksi_delete_mt_contents_from_sk_source", "SKSI-DELETE-MT-CONTENTS-FROM-SK-SOURCE", 4, 1, false );
    SubLFiles.declareFunction( me, "sksi_store_or_delete_ist_logical_sentences_in_db", "SKSI-STORE-OR-DELETE-IST-LOGICAL-SENTENCES-IN-DB", 7, 0, false );
    SubLFiles.declareFunction( me, "sksi_store_or_delete_logical_sentences_in_db", "SKSI-STORE-OR-DELETE-LOGICAL-SENTENCES-IN-DB", 7, 2, false );
    return NIL;
  }
  ...
  static
  {
    ...
    $kw4$DBMS_SERVER = makeKeyword( "DBMS-SERVER" );
    $kw5$PORT = makeKeyword( "PORT" );
    $kw6$SUBPROTOCOL = makeKeyword( "SUBPROTOCOL" );
    $kw7$PROXY_SERVER = makeKeyword( "PROXY-SERVER" );
    $kw8$TIMEOUT = makeKeyword( "TIMEOUT" );
    $kw9$THROW = makeKeyword( "THROW" );
    $sym10$CATCH_ERROR_MESSAGE_HANDLER = makeSymbol( "CATCH-ERROR-MESSAGE-HANDLER" );
    $list11 = ConsesLow.list( makeSymbol( "RAW-TUPLE" ), makeSymbol( "&OPTIONAL" ), makeSymbol( "CSQL-CONDITIONS" ) );
