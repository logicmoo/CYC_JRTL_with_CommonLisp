...
import static com.cyc.cycjava.cycl.sksi.sksi_infrastructure.sksi_infrastructure_utilities.*;
...
public final class sksi_infrastructure_utilities extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLList $list0 = list(new SubLObject[]{ reader_make_constant_shell(makeString("ContentMtFn")), reader_make_constant_shell(makeString("ContentMtHeadFn")), reader_make_constant_shell(makeString("ContentMtSpindleFn")), reader_make_constant_shell(makeString("MappingMtFn")), reader_make_constant_shell(makeString("PhysicalFieldFn")), reader_make_constant_shell(makeString("ThePhysicalFieldValueFn")), reader_make_constant_shell(makeString("PFIAliasFn")), reader_make_constant_shell(makeString("PFAliasFn")), reader_make_constant_shell(makeString("LogicalFieldFn")), reader_make_constant_shell(makeString("TheLogicalFieldValueFn")), reader_make_constant_shell(makeString("LFIAliasFn")), reader_make_constant_shell(makeString("SchemaObjectFn")), reader_make_constant_shell(makeString("SchemaObjectIDFn")), reader_make_constant_shell(makeString("SourceSchemaObjectFn")), reader_make_constant_shell(makeString("SourceSchemaObjectIDFn")), reader_make_constant_shell(makeString("SchemaIndexFn")), reader_make_constant_shell(makeString("TheNextSequenceValueFn")), reader_make_constant_shell(makeString("IntegerSequenceGeneratorFn")), reader_make_constant_shell(makeString("TheCurrentSequenceValueFn")), reader_make_constant_shell(makeString("mappingMt")), reader_make_constant_shell(makeString("sksSourceDescriptionMt")), reader_make_constant_shell(makeString("sksPhysicalSchemaDescriptionMt")), reader_make_constant_shell(makeString("sksLogicalSchemaDescriptionMt")), reader_make_constant_shell(makeString("sksSchemaTranslationMt")), reader_make_constant_shell(makeString("contentMt")), reader_make_constant_shell(makeString("contentMtSpindle")), reader_make_constant_shell(makeString("contentMtHead")), reader_make_constant_shell(makeString("subKS")), reader_make_constant_shell(makeString("subKS-Direct")), reader_make_constant_shell(makeString("schemaSourceMap")), reader_make_constant_shell(makeString("physicalSchemaSourceMap")), reader_make_constant_shell(makeString("logicalSchemaSourceMap")), reader_make_constant_shell(makeString("sksIsa")), reader_make_constant_shell(makeString("structuredKnowledgeSourceName")), reader_make_constant_shell(makeString("serverOfSKS")), reader_make_constant_shell(makeString("portNumberForSKS")), reader_make_constant_shell(makeString("sksProxyHost")), reader_make_constant_shell(makeString("sksProxyPort")), reader_make_constant_shell(makeString("userNameForSKS")), reader_make_constant_shell(makeString("passwordForSKS")), reader_make_constant_shell(makeString("sqlProgramForSKS")), reader_make_constant_shell(makeString("subProtocolForSKS")), reader_make_constant_shell(makeString("filenameForSKS")), reader_make_constant_shell(makeString("serializationTypeForSKS")), reader_make_constant_shell(makeString("keyTestFunctionForSKS")), reader_make_constant_shell(makeString("valueTestFunctionForSKS")), reader_make_constant_shell(makeString("physicalFields")), reader_make_constant_shell(makeString("physicalFieldIndexicals")), reader_make_constant_shell(makeString("enumerableSchema")), reader_make_constant_shell(makeString("schemaFieldNameList")), reader_make_constant_shell(makeString("schemaFieldList")), reader_make_constant_shell(makeString("exampleTuple")), reader_make_constant_shell(makeString("indexicalForPhysicalField")), reader_make_constant_shell(makeString("requiredFields")), reader_make_constant_shell(makeString("indexedFields")), reader_make_constant_shell(makeString("primaryKey")), reader_make_constant_shell(makeString("schemaKeys")), reader_make_constant_shell(makeString("secondaryKeys")), reader_make_constant_shell(makeString("foreignKeyMap")), reader_make_constant_shell(makeString("foreignKeyMap-Restrict")), reader_make_constant_shell(makeString("foreignKeyMap-Cascade")), reader_make_constant_shell(makeString("foreignKeyMap-SetNull")), reader_make_constant_shell(makeString("foreignKeyMap-SetDefault")), reader_make_constant_shell(makeString("nonNullFields")), reader_make_constant_shell(makeString("uniqueFieldList")), reader_make_constant_shell(makeString("schemaConstraints")), reader_make_constant_shell(makeString("defaultFieldValue")), reader_make_constant_shell(makeString("nonNullFieldList")), reader_make_constant_shell(makeString("resultSetCardinality")), reader_make_constant_shell(makeString("resultSetCardinalityWithConstraints")), reader_make_constant_shell(makeString("logicalResultSetCardinality")), reader_make_constant_shell(makeString("logicalResultSetCardinalityWRTValue")), reader_make_constant_shell(makeString("physicalFieldConversionFunction")), reader_make_constant_shell(makeString("schemaFieldsIndex")), reader_make_constant_shell(makeString("indexType")), reader_make_constant_shell(makeString("indexName")), reader_make_constant_shell(makeString("physicalFieldXPath")), reader_make_constant_shell(makeString("physicalFieldXPathString")), reader_make_constant_shell(makeString("fieldValue")), reader_make_constant_shell(makeString("fieldValueComparison")), reader_make_constant_shell(makeString("fieldValueComparison-Inverse")), reader_make_constant_shell(makeString("fieldIndexicalsEqual")), reader_make_constant_shell(makeString("fieldIndexicalsComparison")), reader_make_constant_shell(makeString("integerSequenceGeneratorName")), reader_make_constant_shell(makeString("integerSequenceGeneratorIncrementsField")), reader_make_constant_shell(makeString("logicalFields")), reader_make_constant_shell(makeString("meaningSentenceOfSchema")), reader_make_constant_shell(makeString("conditionalMeaningSentenceOfSchema")), reader_make_constant_shell(makeString("objectField")), reader_make_constant_shell(makeString("fieldIsa")), reader_make_constant_shell(makeString("fieldGenls")), reader_make_constant_shell(makeString("schemaIsa")), reader_make_constant_shell(makeString("schemaGenls")), reader_make_constant_shell(makeString("logicalSchemaKeys")), reader_make_constant_shell(makeString("indexicalForLogicalField")), reader_make_constant_shell(makeString("logicalFieldIndexicals")), reader_make_constant_shell(makeString("logicalSchemaFieldTypeList")), reader_make_constant_shell(makeString("schemaExampleSentence")), reader_make_constant_shell(makeString("schemaCompleteExtentKnown")), reader_make_constant_shell(makeString("completeObjectSchema")), reader_make_constant_shell(makeString("contentSentenceOfSchema")), reader_make_constant_shell(makeString("codeMapping")), reader_make_constant_shell(makeString("schemaFields")), reader_make_constant_shell(makeString("indexicalForField")), reader_make_constant_shell(makeString("schemaFieldIndexicals")), reader_make_constant_shell(makeString("schemaObjectID")), reader_make_constant_shell(makeString("fieldName-SKS")), reader_make_constant_shell(makeString("fieldTranslation")), reader_make_constant_shell(makeString("logicalFieldTranslation")), reader_make_constant_shell(makeString("physicalFieldTranslation")), reader_make_constant_shell(makeString("logicalFieldDecoding")), reader_make_constant_shell(makeString("logicalFieldEncoding")), reader_make_constant_shell(makeString("physicalFieldDecoding")), reader_make_constant_shell(makeString("physicalFieldEncoding")), reader_make_constant_shell(makeString("fieldDecoding")), reader_make_constant_shell(makeString("fieldEncoding")), reader_make_constant_shell(makeString("logicalPhysicalSchemaMap")), reader_make_constant_shell(makeString("calendarMonthIndex")), reader_make_constant_shell(makeString("logicalPhysicalFieldMap-DecodeClosed")), reader_make_constant_shell(makeString("logicalPhysicalFieldMap-EncodeClosed")), reader_make_constant_shell(makeString("fieldEncodingOverrideForComparisonOperatorArg")), reader_make_constant_shell(makeString("logicalPhysicalFieldMap")), reader_make_constant_shell(makeString("httpdRequestSubLParsingProgramForSKS")), reader_make_constant_shell(makeString("httpdRequestURLForSKS")), reader_make_constant_shell(makeString("httpdRequestMethodForSKS")), reader_make_constant_shell(makeString("httpdRequestSubLBooleanParsingProgramForSKS")), reader_make_constant_shell(makeString("httpdRequestUnboundOnlySubLParsingProgramForSKS")), reader_make_constant_shell(makeString("httpdRequestQueryTemplateForSKS")), reader_make_constant_shell(makeString("rowInSourceClaims")), reader_make_constant_shell(makeString("sourceClaims")), reader_make_constant_shell(makeString("meaningSentencePredicateForSource")), reader_make_constant_shell(makeString("meaningSentencePredicateForSchema")), reader_make_constant_shell(makeString("sksRepresentationComplete")), reader_make_constant_shell(makeString("rowCount-SKS")), reader_make_constant_shell(makeString("sourceAssumptions")), reader_make_constant_shell(makeString("sksModifiable")), reader_make_constant_shell(makeString("objectFieldTypeForSource")), reader_make_constant_shell(makeString("logicalFieldTypeForSource")), reader_make_constant_shell(makeString("sourceSchemaObjectID")), reader_make_constant_shell(makeString("schemaRepresentationComplete")), reader_make_constant_shell(makeString("sksModuleTypeDirection")), reader_make_constant_shell(makeString("SKSIPhysicalSchemaConstraintPredicate")), reader_make_constant_shell(makeString("PhysicalFieldIndexical")), reader_make_constant_shell(makeString("SKSIPhysicalSchemaDescriptionMicrotheory")), reader_make_constant_shell(makeString("PhysicalField")), reader_make_constant_shell(makeString("IndexDataStructure")), reader_make_constant_shell(makeString("IndexDataStructureType")), reader_make_constant_shell(makeString("IntegerSequenceGenerator")), reader_make_constant_shell(makeString("LogicalSchema")), reader_make_constant_shell(makeString("LogicalFieldIndexical")), reader_make_constant_shell(makeString("SKSILogicalSchemaDescriptionMicrotheory")), reader_make_constant_shell(makeString("LogicalField")), reader_make_constant_shell(makeString("ObjectDefiningSchema")), reader_make_constant_shell(makeString("ReifiedMapping")), reader_make_constant_shell(makeString("Schema-LogicalOrPhysical")), reader_make_constant_shell(makeString("SchemaType-LogicalOrPhysical")), reader_make_constant_shell(makeString("FieldIndexical-LogicalOrPhysical")), reader_make_constant_shell(makeString("SKSISchemaDescriptionMicrotheory")), reader_make_constant_shell(makeString("Field-LogicalOrPhysical")), reader_make_constant_shell(makeString("FieldType-LogicalOrPhysical")), reader_make_constant_shell(makeString("SKSISchemaTranslationMicrotheory")), reader_make_constant_shell(makeString("HTTP-RequestMethod")), reader_make_constant_shell(makeString("StructuredKnowledgeSource")), reader_make_constant_shell(makeString("StructuredKnowledgeSource-Atomic")), reader_make_constant_shell(makeString("StructuredKnowledgeSource-Complex")), reader_make_constant_shell(makeString("SKSIContentMicrotheorySpindle")), reader_make_constant_shell(makeString("SKSISupportedStructuredKnowledgeSourceType")), reader_make_constant_shell(makeString("SKSISourceDescriptionMicrotheory")), reader_make_constant_shell(makeString("SKSIMappingMicrotheory")), reader_make_constant_shell(makeString("SKSISupportedDatabaseServerProgram")), reader_make_constant_shell(makeString("SKSMereologyType")), reader_make_constant_shell(makeString("StructuredKnowledgeSource-TopLevel")), reader_make_constant_shell(makeString("SKSIContentMicrotheory")), reader_make_constant_shell(makeString("SKSIExternalTermDenotingFunction")), reader_make_constant_shell(makeString("SKSIHLModule")), reader_make_constant_shell(makeString("SKSIHLModuleType")), reader_make_constant_shell(makeString("SKSIRemovalModule")), reader_make_constant_shell(makeString("SKSISingleLiteralRemovalModule")), reader_make_constant_shell(makeString("SKSIMultiLiteralRemovalModule")), reader_make_constant_shell(makeString("SKSIStorageModule")), reader_make_constant_shell(makeString("SKSISupportedComparisonPredicate")), reader_make_constant_shell(makeString("SKSISupportedOperator")), reader_make_constant_shell(makeString("SKSISupportedFunction")) });
    ...
    public static final SubLSymbol SKSI_RECONSTRUCT_EXPRESSION_MEMOIZED = makeSymbol("SKSI-RECONSTRUCT-EXPRESSION-MEMOIZED");





    public static final SubLSymbol ALL_RELEVANT_SKSI_CONTENT_MTS_INT = makeSymbol("ALL-RELEVANT-SKSI-CONTENT-MTS-INT");

    public static final SubLSymbol $sym11$RELEVANT_MT_ = makeSymbol("RELEVANT-MT?");
    ...
    private static final SubLObject $$ReifiedMappingForPredFn = reader_make_constant_shell(makeString("ReifiedMappingForPredFn"));
    ...
    private static final SubLList $list38 = list(reader_make_constant_shell(makeString("resultQuotedIsa")), makeSymbol("?FN"), reader_make_constant_shell(makeString("LogicalFieldIndexical")));
    ...
    private static final SubLObject $const49$CommonObjectRequestBrokerArchitec = reader_make_constant_shell(makeString("CommonObjectRequestBrokerArchitecture"));
    ...
    public static final SubLList $list91 = list(makeUninternedSymbol("LINK-NODE"), makeUninternedSymbol("MT"), makeUninternedSymbol("TV"));
    ...
    public static final SubLList $list103 = list(makeSymbol("SKS2"), makeSymbol("ODS2"), makeSymbol("SUB-EXPRESSION2"));

    private static final SubLObject $$joinable = reader_make_constant_shell(makeString("joinable"));



    private static final SubLObject $$subKS = reader_make_constant_shell(makeString("subKS"));
    ...
    public static SubLObject declare_sksi_infrastructure_utilities_file() {
        declareFunction(me, "initialize_sksi_kb_feature", "INITIALIZE-SKSI-KB-FEATURE", 0, 0, false);
        declareFunction(me, "initialize_sksi_data_structures", "INITIALIZE-SKSI-DATA-STRUCTURES", 0, 0, false);
        declareFunction(me, "initialize_non_thelogicalfieldvaluefn_lfi_fort_cache", "INITIALIZE-NON-THELOGICALFIELDVALUEFN-LFI-FORT-CACHE", 0, 0, false);
        declareFunction(me, "possibly_add_lfi_to_non_thelogicalfieldvaluefn_lfi_fort_cache", "POSSIBLY-ADD-LFI-TO-NON-THELOGICALFIELDVALUEFN-LFI-FORT-CACHE", 2, 0, false);
        declareFunction(me, "possibly_remove_lfi_from_non_thelogicalfieldvaluefn_lfi_fort_cache", "POSSIBLY-REMOVE-LFI-FROM-NON-THELOGICALFIELDVALUEFN-LFI-FORT-CACHE", 2, 0, false);
        declareFunction(me, "non_thelogicalfieldvaluefn_lfi_fort_p", "NON-THELOGICALFIELDVALUEFN-LFI-FORT-P", 1, 0, false);
        declareFunction(me, "sksi_reconstruct_expression", "SKSI-RECONSTRUCT-EXPRESSION", 2, 1, false);
        declareFunction(me, "sksi_reconstruct_expression_memoized_internal", "SKSI-RECONSTRUCT-EXPRESSION-MEMOIZED-INTERNAL", 2, 0, false);
        declareFunction(me, "sksi_reconstruct_expression_memoized", "SKSI-RECONSTRUCT-EXPRESSION-MEMOIZED", 2, 0, false);
        declareFunction(me, "sksi_reconstruct_expression_int", "SKSI-RECONSTRUCT-EXPRESSION-INT", 2, 0, false);
        declareFunction(me, "all_relevant_sksi_content_mts", "ALL-RELEVANT-SKSI-CONTENT-MTS", 0, 0, false);
        declareFunction(me, "all_relevant_sksi_content_mts_int_internal", "ALL-RELEVANT-SKSI-CONTENT-MTS-INT-INTERNAL", 1, 0, false);
        declareFunction(me, "all_relevant_sksi_content_mts_int", "ALL-RELEVANT-SKSI-CONTENT-MTS-INT", 1, 0, false);
        declareFunction(me, "any_sksi_content_mt_with_registered_module_relevantP", "ANY-SKSI-CONTENT-MT-WITH-REGISTERED-MODULE-RELEVANT?", 0, 0, false);
        declareFunction(me, "any_sksi_content_mt_with_registered_module_relevantP_int_internal", "ANY-SKSI-CONTENT-MT-WITH-REGISTERED-MODULE-RELEVANT?-INT-INTERNAL", 1, 0, false);
        declareFunction(me, "any_sksi_content_mt_with_registered_module_relevantP_int", "ANY-SKSI-CONTENT-MT-WITH-REGISTERED-MODULE-RELEVANT?-INT", 1, 0, false);
        declareFunction(me, "any_sksi_content_mt_relevantP", "ANY-SKSI-CONTENT-MT-RELEVANT?", 0, 0, false);
        declareFunction(me, "any_sksi_content_mt_relevantP_int_internal", "ANY-SKSI-CONTENT-MT-RELEVANT?-INT-INTERNAL", 1, 0, false);
        declareFunction(me, "any_sksi_content_mt_relevantP_int", "ANY-SKSI-CONTENT-MT-RELEVANT?-INT", 1, 0, false);
        declareFunction(me, "relevant_top_level_sksi_content_mts", "RELEVANT-TOP-LEVEL-SKSI-CONTENT-MTS", 0, 0, false);
        declareFunction(me, "sk_source_atomicP", "SK-SOURCE-ATOMIC?", 1, 0, false);
        declareFunction(me, "sk_source_complexP", "SK-SOURCE-COMPLEX?", 1, 0, false);
        declareFunction(me, "gather_all_complete_knowledge_sources", "GATHER-ALL-COMPLETE-KNOWLEDGE-SOURCES", 0, 0, false);
        declareFunction(me, "gather_all_top_level_complete_knowledge_sources", "GATHER-ALL-TOP-LEVEL-COMPLETE-KNOWLEDGE-SOURCES", 0, 0, false);
        declareFunction(me, "gather_all_top_level_complete_registered_knowledge_sources", "GATHER-ALL-TOP-LEVEL-COMPLETE-REGISTERED-KNOWLEDGE-SOURCES", 0, 0, false);
        declareFunction(me, "gather_all_top_level_registered_knowledge_sources", "GATHER-ALL-TOP-LEVEL-REGISTERED-KNOWLEDGE-SOURCES", 0, 0, false);
        declareFunction(me, "sort_knowledge_sources", "SORT-KNOWLEDGE-SOURCES", 1, 0, false);
        declareFunction(me, "gather_sksi_knowledge_sources_and_descriptions", "GATHER-SKSI-KNOWLEDGE-SOURCES-AND-DESCRIPTIONS", 0, 0, false);
        declareFunction(me, "get_sks_description_string", "GET-SKS-DESCRIPTION-STRING", 1, 0, false);
        declareFunction(me, "top_level_knowledge_source_p", "TOP-LEVEL-KNOWLEDGE-SOURCE-P", 1, 0, false);
        declareFunction(me, "top_level_knowledge_source_in_any_mt_p", "TOP-LEVEL-KNOWLEDGE-SOURCE-IN-ANY-MT-P", 1, 0, false);
        declareFunction(me, "all_relevant_sk_sources", "ALL-RELEVANT-SK-SOURCES", 0, 0, false);
        declareFunction(me, "all_relevant_dbs", "ALL-RELEVANT-DBS", 0, 0, false);
        declareFunction(me, "relevant_registered_top_level_sksi_dbs", "RELEVANT-REGISTERED-TOP-LEVEL-SKSI-DBS", 0, 0, false);
        declareFunction(me, "relevant_maximum_sksi_dbs", "RELEVANT-MAXIMUM-SKSI-DBS", 0, 0, false);
        declareFunction(me, "external_term_denoting_function_expression_p", "EXTERNAL-TERM-DENOTING-FUNCTION-EXPRESSION-P", 1, 0, false);
        declareFunction(me, "sksi_external_term_p", "SKSI-EXTERNAL-TERM-P", 1, 0, false);
        declareFunction(me, "sksi_term_p", "SKSI-TERM-P", 1, 0, false);
        declareFunction(me, "sksi_supported_predicate_type_p", "SKSI-SUPPORTED-PREDICATE-TYPE-P", 1, 1, false);
        declareFunction(me, "physical_fields_for_indexicals_in_expression", "PHYSICAL-FIELDS-FOR-INDEXICALS-IN-EXPRESSION", 1, 0, false);
        declareFunction(me, "indexicals_for_physical_fields_in_expression", "INDEXICALS-FOR-PHYSICAL-FIELDS-IN-EXPRESSION", 1, 0, false);
        declareFunction(me, "extract_physical_fields_via_indexicals", "EXTRACT-PHYSICAL-FIELDS-VIA-INDEXICALS", 2, 0, false);
        declareFunction(me, "sort_physical_fields_by_field_name_list", "SORT-PHYSICAL-FIELDS-BY-FIELD-NAME-LIST", 2, 0, false);
        declareFunction(me, "sksi_determine_relevant_physical_field_indexicals", "SKSI-DETERMINE-RELEVANT-PHYSICAL-FIELD-INDEXICALS", 3, 0, false);
        declareFunction(me, "sksi_determine_relevant_physical_field_indexicals_for_logical_field_indexical", "SKSI-DETERMINE-RELEVANT-PHYSICAL-FIELD-INDEXICALS-FOR-LOGICAL-FIELD-INDEXICAL", 3, 0, false);
        declareFunction(me, "sksi_determine_relevant_logical_field_indexicals_for_physical_field_indexical_internal", "SKSI-DETERMINE-RELEVANT-LOGICAL-FIELD-INDEXICALS-FOR-PHYSICAL-FIELD-INDEXICAL-INTERNAL", 3, 0, false);
        declareFunction(me, "sksi_determine_relevant_logical_field_indexicals_for_physical_field_indexical", "SKSI-DETERMINE-RELEVANT-LOGICAL-FIELD-INDEXICALS-FOR-PHYSICAL-FIELD-INDEXICAL", 3, 0, false);
        declareFunction(me, "physical_field_indexical_el_formula_p", "PHYSICAL-FIELD-INDEXICAL-EL-FORMULA-P", 1, 0, false);
        declareFunction(me, "reified_mapping_el_formula_p", "REIFIED-MAPPING-EL-FORMULA-P", 1, 0, false);
        declareFunction(me, "physical_field_indexical_or_reified_mapping_el_formula_p", "PHYSICAL-FIELD-INDEXICAL-OR-REIFIED-MAPPING-EL-FORMULA-P", 1, 0, false);
        declareFunction(me, "physical_field_logical_field_indexical_mappings_given_logical_physical_schemata_internal", "PHYSICAL-FIELD-LOGICAL-FIELD-INDEXICAL-MAPPINGS-GIVEN-LOGICAL-PHYSICAL-SCHEMATA-INTERNAL", 2, 0, false);
        declareFunction(me, "physical_field_logical_field_indexical_mappings_given_logical_physical_schemata", "PHYSICAL-FIELD-LOGICAL-FIELD-INDEXICAL-MAPPINGS-GIVEN-LOGICAL-PHYSICAL-SCHEMATA", 2, 0, false);
        declareFunction(me, "determine_relevant_physical_fields_for_field_decoding", "DETERMINE-RELEVANT-PHYSICAL-FIELDS-FOR-FIELD-DECODING", 2, 0, false);
        declareFunction(me, "determine_relevant_physical_field_indexicals_for_field_decoding", "DETERMINE-RELEVANT-PHYSICAL-FIELD-INDEXICALS-FOR-FIELD-DECODING", 2, 0, false);
        declareFunction(me, "sksi_determine_fixed_physical_field_indexicals_internal", "SKSI-DETERMINE-FIXED-PHYSICAL-FIELD-INDEXICALS-INTERNAL", 2, 0, false);
        declareFunction(me, "sksi_determine_fixed_physical_field_indexicals", "SKSI-DETERMINE-FIXED-PHYSICAL-FIELD-INDEXICALS", 2, 0, false);
        declareFunction(me, "sksi_fixed_physical_field_indexicalP_internal", "SKSI-FIXED-PHYSICAL-FIELD-INDEXICAL?-INTERNAL", 2, 0, false);
        declareFunction(me, "sksi_fixed_physical_field_indexicalP", "SKSI-FIXED-PHYSICAL-FIELD-INDEXICAL?", 2, 0, false);
        declareFunction(me, "logical_field_indexical_denoting_functions_internal", "LOGICAL-FIELD-INDEXICAL-DENOTING-FUNCTIONS-INTERNAL", 0, 0, false);
        declareFunction(me, "logical_field_indexical_denoting_functions", "LOGICAL-FIELD-INDEXICAL-DENOTING-FUNCTIONS", 0, 0, false);
        declareFunction(me, "logical_field_indexical_el_formula_p", "LOGICAL-FIELD-INDEXICAL-EL-FORMULA-P", 1, 0, false);
        new sksi_infrastructure_utilities.$logical_field_indexical_el_formula_p$UnaryFunction();
        declareFunction(me, "logical_field_indexical_or_reified_mapping_el_formula_p", "LOGICAL-FIELD-INDEXICAL-OR-REIFIED-MAPPING-EL-FORMULA-P", 1, 0, false);
        declareFunction(me, "logical_physical_field_mappings_given_logical_physical_schemata_internal", "LOGICAL-PHYSICAL-FIELD-MAPPINGS-GIVEN-LOGICAL-PHYSICAL-SCHEMATA-INTERNAL", 2, 0, false);
        declareFunction(me, "logical_physical_field_mappings_given_logical_physical_schemata", "LOGICAL-PHYSICAL-FIELD-MAPPINGS-GIVEN-LOGICAL-PHYSICAL-SCHEMATA", 2, 0, false);
        declareFunction(me, "physical_field_mappings_for_logical_fields", "PHYSICAL-FIELD-MAPPINGS-FOR-LOGICAL-FIELDS", 3, 1, false);
        declareFunction(me, "physical_field_mappings_for_logical_fields_given_logical_physical_schemata", "PHYSICAL-FIELD-MAPPINGS-FOR-LOGICAL-FIELDS-GIVEN-LOGICAL-PHYSICAL-SCHEMATA", 3, 0, false);
        declareFunction(me, "expression_logical_fields", "EXPRESSION-LOGICAL-FIELDS", 1, 0, false);
        declareFunction(me, "expression_logical_field_indexicals", "EXPRESSION-LOGICAL-FIELD-INDEXICALS", 1, 2, false);
        declareFunction(me, "expression_logical_field_indexicals_memoized_internal", "EXPRESSION-LOGICAL-FIELD-INDEXICALS-MEMOIZED-INTERNAL", 2, 0, false);
        declareFunction(me, "expression_logical_field_indexicals_memoized", "EXPRESSION-LOGICAL-FIELD-INDEXICALS-MEMOIZED", 2, 0, false);
        declareFunction(me, "expression_logical_field_indexicals_int", "EXPRESSION-LOGICAL-FIELD-INDEXICALS-INT", 2, 0, false);
        declareFunction(me, "expression_logical_field_indexicals_ordered", "EXPRESSION-LOGICAL-FIELD-INDEXICALS-ORDERED", 1, 1, false);
        declareFunction(me, "expression_logical_fields_for_indexicals", "EXPRESSION-LOGICAL-FIELDS-FOR-INDEXICALS", 1, 0, false);
        declareFunction(me, "sksi_get_code_mapping_relations_for_logical_field_predicate_internal", "SKSI-GET-CODE-MAPPING-RELATIONS-FOR-LOGICAL-FIELD-PREDICATE-INTERNAL", 3, 1, false);
        declareFunction(me, "sksi_get_code_mapping_relations_for_logical_field_predicate", "SKSI-GET-CODE-MAPPING-RELATIONS-FOR-LOGICAL-FIELD-PREDICATE", 3, 1, false);
        declareFunction(me, "sk_source_accessibleP", "SK-SOURCE-ACCESSIBLE?", 1, 1, false);
        declareFunction(me, "db_sk_source_accessibleP", "DB-SK-SOURCE-ACCESSIBLE?", 1, 0, false);
        declareFunction(me, "web_page_sk_source_accessibleP", "WEB-PAGE-SK-SOURCE-ACCESSIBLE?", 1, 0, false);
        declareFunction(me, "fht_sk_source_accessibleP", "FHT-SK-SOURCE-ACCESSIBLE?", 1, 0, false);
        declareFunction(me, "corba_sk_source_accessibleP", "CORBA-SK-SOURCE-ACCESSIBLE?", 1, 0, false);
        declareFunction(me, "sk_source_registeredP", "SK-SOURCE-REGISTERED?", 1, 1, false);
        declareFunction(me, "sk_source_registeredP_int", "SK-SOURCE-REGISTERED?-INT", 1, 0, false);
        declareFunction(me, "sk_source_queryableP", "SK-SOURCE-QUERYABLE?", 1, 1, false);
        declareFunction(me, "set_external_sources_activated_in_image", "SET-EXTERNAL-SOURCES-ACTIVATED-IN-IMAGE", 1, 0, false);
        declareFunction(me, "external_sources_activated_in_image", "EXTERNAL-SOURCES-ACTIVATED-IN-IMAGE", 0, 0, false);
        declareFunction(me, "list_of_external_sources_activated_in_image", "LIST-OF-EXTERNAL-SOURCES-ACTIVATED-IN-IMAGE", 0, 0, false);
        declareFunction(me, "some_external_source_activated_in_imageP", "SOME-EXTERNAL-SOURCE-ACTIVATED-IN-IMAGE?", 0, 0, false);
        declareFunction(me, "number_of_external_sources_activated_in_image", "NUMBER-OF-EXTERNAL-SOURCES-ACTIVATED-IN-IMAGE", 0, 0, false);
        declareFunction(me, "external_source_activated_in_imageP", "EXTERNAL-SOURCE-ACTIVATED-IN-IMAGE?", 1, 0, false);
        declareFunction(me, "clear_external_sources_activated_in_image", "CLEAR-EXTERNAL-SOURCES-ACTIVATED-IN-IMAGE", 0, 0, false);
        declareFunction(me, "add_to_external_sources_activated_in_image", "ADD-TO-EXTERNAL-SOURCES-ACTIVATED-IN-IMAGE", 1, 1, false);
        declareFunction(me, "remove_from_external_sources_activated_in_image", "REMOVE-FROM-EXTERNAL-SOURCES-ACTIVATED-IN-IMAGE", 1, 1, false);
        declareFunction(me, "disjoint_schemasP", "DISJOINT-SCHEMAS?", 2, 1, false);
        declareFunction(me, "disjoint_schemas_memoize", "DISJOINT-SCHEMAS-MEMOIZE", 2, 0, false);
        declareFunction(me, "disjoint_schemas_memoized_int_internal", "DISJOINT-SCHEMAS-MEMOIZED-INT-INTERNAL", 3, 0, false);
        declareFunction(me, "disjoint_schemas_memoized_int", "DISJOINT-SCHEMAS-MEMOIZED-INT", 3, 0, false);
        declareFunction(me, "disjoint_schemas_regular", "DISJOINT-SCHEMAS-REGULAR", 2, 0, false);
        declareFunction(me, "all_disjoint_schemas", "ALL-DISJOINT-SCHEMAS", 1, 1, false);
        declareFunction(me, "all_disjoint_schemas_int_internal", "ALL-DISJOINT-SCHEMAS-INT-INTERNAL", 2, 0, false);
        declareFunction(me, "all_disjoint_schemas_int", "ALL-DISJOINT-SCHEMAS-INT", 2, 0, false);
        declareFunction(me, "all_joinable_object_defining_schemas", "ALL-JOINABLE-OBJECT-DEFINING-SCHEMAS", 1, 1, false);
        declareFunction(me, "all_joinable_object_defining_schemas_int_internal", "ALL-JOINABLE-OBJECT-DEFINING-SCHEMAS-INT-INTERNAL", 2, 0, false);
        declareFunction(me, "all_joinable_object_defining_schemas_int", "ALL-JOINABLE-OBJECT-DEFINING-SCHEMAS-INT", 2, 0, false);
        declareFunction(me, "sksi_determine_relevant_object_defining_schemas", "SKSI-DETERMINE-RELEVANT-OBJECT-DEFINING-SCHEMAS", 3, 0, false);
        declareFunction(me, "sksi_determine_relevant_object_defining_schemas_memoized_internal", "SKSI-DETERMINE-RELEVANT-OBJECT-DEFINING-SCHEMAS-MEMOIZED-INTERNAL", 4, 0, false);
        declareFunction(me, "sksi_determine_relevant_object_defining_schemas_memoized", "SKSI-DETERMINE-RELEVANT-OBJECT-DEFINING-SCHEMAS-MEMOIZED", 4, 0, false);
        declareFunction(me, "schema_object_naut_p", "SCHEMA-OBJECT-NAUT-P", 1, 0, false);
        declareFunction(me, "schema_object_id_naut_p", "SCHEMA-OBJECT-ID-NAUT-P", 1, 0, false);
        declareFunction(me, "source_schema_object_fn_expression_possibly_definedP", "SOURCE-SCHEMA-OBJECT-FN-EXPRESSION-POSSIBLY-DEFINED?", 1, 0, false);
        declareFunction(me, "source_schema_object_fn_expression_possibly_defined", "SOURCE-SCHEMA-OBJECT-FN-EXPRESSION-POSSIBLY-DEFINED", 1, 0, false);
        declareFunction(me, "source_schema_object_fn_expression_undefinedP", "SOURCE-SCHEMA-OBJECT-FN-EXPRESSION-UNDEFINED?", 1, 0, false);
        declareFunction(me, "source_schema_object_fn_expression_undefined", "SOURCE-SCHEMA-OBJECT-FN-EXPRESSION-UNDEFINED", 1, 0, false);
        declareFunction(me, "source_schema_object_fn_expression_undefined_int", "SOURCE-SCHEMA-OBJECT-FN-EXPRESSION-UNDEFINED-INT", 1, 0, false);
        declareFunction(me, "source_schema_object_fn_expressions_equalP", "SOURCE-SCHEMA-OBJECT-FN-EXPRESSIONS-EQUAL?", 2, 0, false);
        declareFunction(me, "source_schema_object_fn_expressions_equal", "SOURCE-SCHEMA-OBJECT-FN-EXPRESSIONS-EQUAL", 2, 1, false);
        declareFunction(me, "source_schema_object_fn_expressions_equal_sub_ks", "SOURCE-SCHEMA-OBJECT-FN-EXPRESSIONS-EQUAL-SUB-KS", 6, 0, false);
        declareFunction(me, "source_schema_object_fn_expressions_equal_common_super_ks", "SOURCE-SCHEMA-OBJECT-FN-EXPRESSIONS-EQUAL-COMMON-SUPER-KS", 6, 0, false);
        declareFunction(me, "source_schema_object_fn_equal_sk_sources", "SOURCE-SCHEMA-OBJECT-FN-EQUAL-SK-SOURCES", 1, 0, false);
        declareFunction(me, "source_schema_object_fn_equal_expressions", "SOURCE-SCHEMA-OBJECT-FN-EQUAL-EXPRESSIONS", 1, 0, false);
        declareFunction(me, "source_schema_object_fn_canonical_sks", "SOURCE-SCHEMA-OBJECT-FN-CANONICAL-SKS", 1, 0, false);
        declareFunction(me, "source_schema_object_fn_canonical_expression", "SOURCE-SCHEMA-OBJECT-FN-CANONICAL-EXPRESSION", 1, 0, false);
        declareFunction(me, "sks_relevant_to_ods", "SKS-RELEVANT-TO-ODS", 2, 0, false);
        declareFunction(me, "sks_relevant_to_some_logical_fieldP", "SKS-RELEVANT-TO-SOME-LOGICAL-FIELD?", 2, 0, false);
        declareFunction(me, "sks_relevant_to_some_logical_field", "SKS-RELEVANT-TO-SOME-LOGICAL-FIELD", 2, 0, false);
        declareFunction(me, "sks_relevant_to_some_logical_field_int", "SKS-RELEVANT-TO-SOME-LOGICAL-FIELD-INT", 2, 0, false);
        declareFunction(me, "sks_directly_relevant_to_some_logical_field", "SKS-DIRECTLY-RELEVANT-TO-SOME-LOGICAL-FIELD", 2, 0, false);
        declareFunction(me, "some_logical_schema_relevant_to_some_logical_field", "SOME-LOGICAL-SCHEMA-RELEVANT-TO-SOME-LOGICAL-FIELD", 2, 0, false);
        declareFunction(me, "sksi_supported_function_expression_p", "SKSI-SUPPORTED-FUNCTION-EXPRESSION-P", 1, 0, false);
        declareFunction(me, "sks_to_allowed_modules_list", "SKS-TO-ALLOWED-MODULES-LIST", 1, 0, false);
        declareFunction(me, "make_sksi_support", "MAKE-SKSI-SUPPORT", 2, 0, false);
        declareFunction(me, "sksi_support_p", "SKSI-SUPPORT-P", 1, 0, false);
        declareFunction(me, "hl_modules_list_to_allowed_modules_spec", "HL-MODULES-LIST-TO-ALLOWED-MODULES-SPEC", 1, 0, false);
        declareFunction(me, "sksi_possibly_nart_el_formula_p", "SKSI-POSSIBLY-NART-EL-FORMULA-P", 1, 0, false);
        declareFunction(me, "sksi_true_cycl_expression_p", "SKSI-TRUE-CYCL-EXPRESSION-P", 1, 0, false);
        declareFunction(me, "code_mapping_expressionP", "CODE-MAPPING-EXPRESSION?", 1, 0, false);
        declareFunction(me, "code_mapping_expression_schema", "CODE-MAPPING-EXPRESSION-SCHEMA", 1, 0, false);
        declareFunction(me, "find_assertion_cycl_memoized_internal", "FIND-ASSERTION-CYCL-MEMOIZED-INTERNAL", 1, 2, false);
        declareFunction(me, "find_assertion_cycl_memoized", "FIND-ASSERTION-CYCL-MEMOIZED", 1, 2, false);
        declareFunction(me, "genl_predicate_memoizedP_internal", "GENL-PREDICATE-MEMOIZED?-INTERNAL", 2, 3, false);
        declareFunction(me, "genl_predicate_memoizedP", "GENL-PREDICATE-MEMOIZED?", 2, 3, false);
        declareFunction(me, "genl_inverse_memoizedP_internal", "GENL-INVERSE-MEMOIZED?-INTERNAL", 2, 3, false);
        declareFunction(me, "genl_inverse_memoizedP", "GENL-INVERSE-MEMOIZED?", 2, 3, false);
        declareFunction(me, "all_fort_instances_memoized_internal", "ALL-FORT-INSTANCES-MEMOIZED-INTERNAL", 1, 3, false);
        declareFunction(me, "all_fort_instances_memoized", "ALL-FORT-INSTANCES-MEMOIZED", 1, 3, false);
        declareFunction(me, "mt_relevant_to_mt_memoizedP_internal", "MT-RELEVANT-TO-MT-MEMOIZED?-INTERNAL", 2, 1, false);
        declareFunction(me, "mt_relevant_to_mt_memoizedP", "MT-RELEVANT-TO-MT-MEMOIZED?", 2, 1, false);
        declareFunction(me, "formula_commutative_permutations_memoized_internal", "FORMULA-COMMUTATIVE-PERMUTATIONS-MEMOIZED-INTERNAL", 2, 1, false);
        declareFunction(me, "formula_commutative_permutations_memoized", "FORMULA-COMMUTATIVE-PERMUTATIONS-MEMOIZED", 2, 1, false);
        declareFunction(me, "removal_ask_template_memoized_internal", "REMOVAL-ASK-TEMPLATE-MEMOIZED-INTERNAL", 2, 3, false);
        declareFunction(me, "removal_ask_template_memoized", "REMOVAL-ASK-TEMPLATE-MEMOIZED", 2, 3, false);
        declareFunction(me, "removal_ask_memoized_internal", "REMOVAL-ASK-MEMOIZED-INTERNAL", 1, 3, false);
        declareFunction(me, "removal_ask_memoized", "REMOVAL-ASK-MEMOIZED", 1, 3, false);
        declareFunction(me, "removal_ask_hl_variable_memoized_internal", "REMOVAL-ASK-HL-VARIABLE-MEMOIZED-INTERNAL", 2, 3, false);
        declareFunction(me, "removal_ask_hl_variable_memoized", "REMOVAL-ASK-HL-VARIABLE-MEMOIZED", 2, 3, false);
        declareFunction(me, "isa_unit_of_measureP_internal", "ISA-UNIT-OF-MEASURE?-INTERNAL", 1, 0, false);
        declareFunction(me, "isa_unit_of_measureP", "ISA-UNIT-OF-MEASURE?", 1, 0, false);
        return NIL;
    }
