...
import static com.cyc.cycjava.cycl.sksi.query_sks.sksi_query_datastructures.*;
...
public final class sksi_query_datastructures extends SubLTranslatedFile {
    ...
    public static SubLObject sks_profile_p(final SubLObject v_object) {
        return v_object.getClass() == sksi_query_datastructures.$sks_profile_native.class ? T : NIL;
    }

    public static SubLObject sks_profile_sks(final SubLObject v_object) {
        assert NIL != sks_profile_p(v_object) : "sksi_query_datastructures.sks_profile_p(v_object) " + "CommonSymbols.NIL != sksi_query_datastructures.sks_profile_p(v_object) " + v_object;
    ...
    public static SubLObject make_sks_profile(SubLObject arglist) {
        ...
        final SubLObject v_new = new sksi_query_datastructures.$sks_profile_native();
        SubLObject next;
    ...
    public static SubLObject table_aliasing_context_p(final SubLObject v_object) {
        return v_object.getClass() == sksi_query_datastructures.$table_aliasing_context_native.class ? T : NIL;
    }

    public static SubLObject tac_lits(final SubLObject v_object) {
        assert NIL != table_aliasing_context_p(v_object) : "sksi_query_datastructures.table_aliasing_context_p(v_object) " + "CommonSymbols.NIL != sksi_query_datastructures.table_aliasing_context_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_table_aliasing_context(SubLObject arglist) {
        ...
        final SubLObject v_new = new sksi_query_datastructures.$table_aliasing_context_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $sks_profile_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sksi_query_datastructures.$sks_profile_native.class, SKS_PROFILE, SKS_PROFILE_P, $list2, $list3, new String[]{ "$sks", "$type", "$content_mt", "$mapping_mt", "$logical_schemata", "$physical_schemata", "$required_fields" }, $list4, $list5, SKS_PROFILE_PRINT);
        }
    }
    ...
    public static final class $table_aliasing_context_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sksi_query_datastructures.$table_aliasing_context_native.class, TABLE_ALIASING_CONTEXT, TABLE_ALIASING_CONTEXT_P, $list49, $list50, new String[]{ "$lits", "$aliases", "$primary_keys", "$primary_key_lits", "$fixedP", "$namespaces" }, $list51, $list52, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
