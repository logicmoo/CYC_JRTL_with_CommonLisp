...
import com.cyc.cycjava.cycl.sksi.sksi_infrastructure.sksi_sks_interaction.$sksi_resourcing_cache_native;
...
public final class sksi_sks_interaction extends SubLTranslatedFile {
    ...
    public static SubLObject sksi_resourcing_cache_connections(final SubLObject v_object) {
        assert NIL != sksi_resourcing_cache_p(v_object) : "sksi_sks_interaction.sksi_resourcing_cache_p error :" + v_object;
    ...
    public static final class $sksi_resourcing_cache_native extends SubLStructNative {
        ...
        private $sksi_resourcing_cache_native() {
        ...
        static {
            structDecl = makeStructDeclNative($sksi_resourcing_cache_native.class, SKSI_RESOURCING_CACHE, SKSI_RESOURCING_CACHE_P, $list216, $list217, new String[]{ "$connections", "$statements", "$used_statements", "$access_times", "$lock", "$max_pool_size", "$max_idle" }, $list218, $list219, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
