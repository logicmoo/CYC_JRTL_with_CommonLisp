...
import com.cyc.cycjava.cycl.sksi.sksi_widgets.nws_widgets;
...
import static com.cyc.cycjava.cycl.sksi.sksi_widgets.nws_widgets.*;
...
public final class nws_widgets extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLString $str0$Choose_Location_from_the_Followin = makeString("Choose Location from the Following List");

    public static final SubLList $list1 = list(list(NIL, NIL, NIL, NIL));

    public static final SubLString $str2$Your_National_Weather_Service_for = makeString("Your National Weather Service forecast");

    public static final SubLString $str3$__tr_ = makeString("</tr>");

    public static final SubLString $str4$_td = makeString("<td");

    public static final SubLString $$$Last_Update = makeString("Last Update");

    public static final SubLString $str6$_td_class_ = makeString("<td class=");

    public static final SubLList $list7 = list(list(new SubLObject[]{ NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL }), makeSymbol("RESULTS"));

    public static final SubLList $list8 = list(new SubLObject[]{ NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL });

    public static final SubLString $str9$Please_select_one_of_the_followin = makeString("Please select one of the following choices");

    public static final SubLString $str10$data_forecasts = makeString("data/forecasts");

    public static final SubLString $str11$http_ = makeString("http:");
    ...
    public static final SubLList $list28 = list(makeString("and"), makeString("a"), makeString("with"));
    ...
    public static SubLObject declare_nws_widgets_file() {
        declareFunction(me, "nws_parse_temp_weather_request", "NWS-PARSE-TEMP-WEATHER-REQUEST", 1, 0, false);
        declareFunction(me, "possible_disambiguation", "POSSIBLE-DISAMBIGUATION", 1, 0, false);
        declareFunction(me, "filter_city", "FILTER-CITY", 1, 0, false);
        declareFunction(me, "filter_weather", "FILTER-WEATHER", 1, 0, false);
        declareFunction(me, "filter_tempf", "FILTER-TEMPF", 1, 0, false);
        declareFunction(me, "filter_tempc", "FILTER-TEMPC", 1, 0, false);
        return NIL;
    }
