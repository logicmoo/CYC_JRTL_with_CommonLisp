...
import com.cyc.cycjava.cycl.sksi.sks_browser.sksi_external_predicate_extent_browser;
...
import static com.cyc.cycjava.cycl.sksi.sks_browser.sksi_external_predicate_extent_browser.*;
...
public final class sksi_external_predicate_extent_browser extends SubLTranslatedFile {
    ...
    public static SubLObject declare_sksi_external_predicate_extent_browser_file() {
        declareMacro(me, "with_sksi_pph_memoization", "WITH-SKSI-PPH-MEMOIZATION");
        declareFunction(me, "cb_link_sksi_external_predicate_extent", "CB-LINK-SKSI-EXTERNAL-PREDICATE-EXTENT", 1, 0, false);
        declareFunction(me, "sksi_external_predicate_extent", "SKSI-EXTERNAL-PREDICATE-EXTENT", 1, 0, false);
        declareFunction(me, "sksi_external_predicate_extent_internal", "SKSI-EXTERNAL-PREDICATE-EXTENT-INTERNAL", 2, 2, false);
        declareFunction(me, "sksi_external_predicate_extent_rec", "SKSI-EXTERNAL-PREDICATE-EXTENT-REC", 1, 2, false);
        declareFunction(me, "sksi_external_predicate_extent_rec_mt", "SKSI-EXTERNAL-PREDICATE-EXTENT-REC-MT", 2, 1, false);
        return NIL;
    }
