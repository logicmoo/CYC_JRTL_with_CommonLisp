...
public final class sksi_sks_mapping_utilities
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject gather_sksi_gaf_lookup_index(final SubLObject asent, final SubLObject sense)
  {
    ...
    final SubLObject ask_sent = ( sense == $kw0$POS ) ? asent : el_utilities.make_negation( asent );
    final SubLObject allowed_modules_spec = determine_allowed_modules_spec_for_sks_mapping( UNPROVIDED );
    final SubLObject ask_result = ask_utilities.inference_recursive_query( ask_sent, mt, ConsesLow.list( $kw1$RETURN, $kw2$BINDINGS_AND_SUPPORTS, $kw3$ALLOWED_MODULES, allowed_modules_spec ) );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        result = ConsesLow.cons( supports.first(), result );
      }
      else
      {
  ...
  public static SubLObject gather_sksi_predicate_extent_index_int(final SubLObject predicate, final SubLObject truth)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        ...
        final SubLObject ask_results = cdolist_list_var_$1 = sksi_infrastructure_utilities.removal_ask_template_memoized( query_form, query_form, mt, truth, ConsesLow.list( $kw3$ALLOWED_MODULES, allowed_modules_spec ) );
        SubLObject formula = NIL;
        formula = cdolist_list_var_$1.first();
        while ( NIL != cdolist_list_var_$1)
        {
          answer_list = ConsesLow.cons( ConsesLow.list( formula, mt ), answer_list );
  ...
  public static SubLObject gather_sksi_gaf_arg_index_values_int_internal(final SubLObject index_arg, final SubLObject index_argnum, final SubLObject gather_argnum, final SubLObject predicate, final SubLObject truth,
      SubLObject inference)
  {
    ...
    {
      final SubLObject arg_list = ConsesLow.make_list( pred_arity, index_arg );
      SubLObject answer_list = NIL;
      SubLObject query_form = NIL;
      ...
      arg = list_var.first();
      for( index_1 = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), arg = list_var.first(), index_1 = Numbers.add( ONE_INTEGER, index_1 ) )
      {
      ...
      query_form = el_utilities.make_el_formula( predicate, arg_list, UNPROVIDED );
      ...
      final SubLObject ask_results = cdolist_list_var = list_utilities.fast_delete_duplicates( backward.removal_ask( query_form, mt_relevance_macros.$mt$.getDynamicValue( thread ), truth, ConsesLow.list(
          $kw3$ALLOWED_MODULES, allowed_modules_spec ) ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      ...
      while ( NIL != cdolist_list_var)
      {
        ...
        {
          answer_list = ConsesLow.cons( ConsesLow.list( gather_arg_binding, arguments.support_mt( just ) ), answer_list );
  ...
  @SubLTranslatedFile.SubL(source = "cycl/sksi/sks-indexing/sksi-sks-mapping-utilities.lisp", position = 3673L)
  public static SubLObject gather_sksi_gaf_arg_index_values_int(final SubLObject index_arg, final SubLObject index_argnum, final SubLObject gather_argnum, final SubLObject predicate, final SubLObject truth,
      SubLObject inference)
  {
    if( inference == UNPROVIDED )
    {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym6$GATHER_SKSI_GAF_ARG_INDEX_VALUES_INT, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym6$GATHER_SKSI_GAF_ARG_INDEX_VALUES_INT, SIX_INTEGER, NIL, EQUAL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym6$GATHER_SKSI_GAF_ARG_INDEX_VALUES_INT, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( gather_sksi_gaf_arg_index_values_int_internal( index_arg, index_argnum, gather_argnum, predicate, truth,
        inference ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( index_arg, index_argnum, gather_argnum, predicate, truth, inference ) );
  ...
  public static SubLObject gather_sksi_gaf_arg_index_int_internal(final SubLObject index_arg, final SubLObject index_argnum, final SubLObject predicate, final SubLObject truth, SubLObject inference)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        answer_list = ConsesLow.cons( ConsesLow.list( bindings.subst_bindings( v_bindings, query_form ), arguments.support_mt( just ) ), answer_list );
  ...
  public static SubLObject gather_sksi_gaf_arg_index_int(final SubLObject index_arg, final SubLObject index_argnum, final SubLObject predicate, final SubLObject truth, SubLObject inference)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym7$GATHER_SKSI_GAF_ARG_INDEX_INT, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym7$GATHER_SKSI_GAF_ARG_INDEX_INT, FIVE_INTEGER, NIL, EQUAL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym7$GATHER_SKSI_GAF_ARG_INDEX_INT, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( gather_sksi_gaf_arg_index_int_internal( index_arg, index_argnum, predicate, truth, inference ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( index_arg, index_argnum, predicate, truth, inference ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  {
    final SubLObject query_form_mt_module_list_tuples = sksi_sks_gaf_arg_indexing.gather_relevant_query_form_mt_module_list_tuples_from_sksi_supported_gaf_argument_cache_for_term_argument_position( index_arg,
        index_argnum );
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        ...
        if( NIL != allowed_modules_spec )
        {
          ...
          final SubLObject ask_results = cdolist_list_var_$4 = sksi_infrastructure_utilities.removal_ask_hl_variable_memoized( gather_var, query_form, mt, truth, ConsesLow.list( $kw3$ALLOWED_MODULES,
              allowed_modules_spec ) );
          SubLObject binding = NIL;
          binding = cdolist_list_var_$4.first();
          while ( NIL != cdolist_list_var_$4)
          {
            answer_list = ConsesLow.cons( ConsesLow.list( binding, mt, cycl_utilities.formula_operator( query_form ) ), answer_list );
  ...
  public static SubLObject gather_bindings_for_index_arg_value_from_meaning_sentence_query_form_mt_module_list_tuples(final SubLObject meaning_sentence_query_form_mt_module_list_tuples, final SubLObject index_arg,
      final SubLObject index_argnum, final SubLObject gather_argnum, final SubLObject truth)
  {
    final SubLObject allowed_modules_spec = determine_allowed_modules_spec_for_sks_mapping( UNPROVIDED );
    SubLObject answer_list = NIL;
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        ...
        final SubLObject mod_query_form = cycl_utilities.expression_subst( index_arg, index_var, query_form, Symbols.symbol_function( EQUAL ), UNPROVIDED );
        if( NIL != meaning_sentence_type_check_query_form( mod_query_form, meaning_sentence, mt ) )
        {
          final SubLObject gather_var = cycl_utilities.formula_arg( query_form, gather_argnum, UNPROVIDED );
          SubLObject cdolist_list_var_$5;
          final SubLObject ask_results = cdolist_list_var_$5 = sksi_infrastructure_utilities.removal_ask_hl_variable_memoized( gather_var, mod_query_form, mt, truth, ConsesLow.list( $kw3$ALLOWED_MODULES,
              allowed_modules_spec ) );
          SubLObject binding = NIL;
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        ...
        if( NIL != allowed_modules_spec )
        {
          ...
          final SubLObject ask_results = cdolist_list_var_$6 = sksi_infrastructure_utilities.removal_ask_template_memoized( query_form, query_form, mt, truth, ConsesLow.list( $kw3$ALLOWED_MODULES,
              allowed_modules_spec ) );
          SubLObject formula = NIL;
  ...
  public static SubLObject gather_instantiated_formulas_from_meaning_sentence_query_form_mt_module_list_tuples(final SubLObject meaning_sentence_query_form_mt_module_list_tuples, final SubLObject index_arg,
      final SubLObject index_argnum, final SubLObject truth)
  {
    final SubLObject allowed_modules_spec = determine_allowed_modules_spec_for_sks_mapping( UNPROVIDED );
    SubLObject answer_list = NIL;
    SubLObject cdolist_list_var = meaning_sentence_query_form_mt_module_list_tuples;
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        final SubLObject index_var = cycl_utilities.formula_arg( query_form, index_argnum, UNPROVIDED );
        final SubLObject mod_query_form = cycl_utilities.expression_subst( index_arg, index_var, query_form, Symbols.symbol_function( EQ ), UNPROVIDED );
        if( NIL != meaning_sentence_type_check_query_form( mod_query_form, meaning_sentence, mt ) )
        {
          SubLObject cdolist_list_var_$7;
          final SubLObject ask_results = cdolist_list_var_$7 = sksi_infrastructure_utilities.removal_ask_template_memoized( mod_query_form, mod_query_form, mt, truth, ConsesLow.list( $kw3$ALLOWED_MODULES,
              allowed_modules_spec ) );
          SubLObject formula = NIL;
  ...
  public static SubLObject meaning_sentence_type_check_query_form(final SubLObject query_form, final SubLObject meaning_sentence, final SubLObject mt)
  {
    ...
    while ( NIL != m_term || NIL != q_term)
    {
      ...
      {
        new_query_form = ConsesLow.cons( m_term_$9, new_query_form );
      }
      else
      {
        new_query_form = ConsesLow.cons( q_term_$8, new_query_form );
      }
      termnum = Numbers.add( termnum, ONE_INTEGER );
      q_term = q_term.rest();
      q_term_$8 = q_term.first();
      m_term = m_term.rest();
      m_term_$9 = m_term.first();
    ...
    return sksi_meaning_sentence_utilities.meaning_sentence_type_check( new_query_form, meaning_sentence, NIL, mt, sksi_kb_accessors.content_mt_to_mapping_mt( mt ), $kw9$RAW, T, T );
  }
  ...
  public static SubLObject determine_allowed_modules_spec_for_sks_mapping(SubLObject current_inference)
  {
    ...
    if( inference_allowed_modules_spec == $kw11$ALL )
    {
      return $list10;
    }
  ...
  public static SubLObject compute_sksi_modules_allowed_in_current_inference(final SubLObject v_modules)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      {
        allowed_modules = ConsesLow.cons( module, allowed_modules );
      }
      cdolist_list_var = cdolist_list_var.rest();
      module = cdolist_list_var.first();
    }
  ...
  {
    if( allowed_modules_spec == $kw11$ALL )
    {
      return NIL;
    }
    ...
    if( NIL != subl_promotions.memberP( $list12, allowed_modules_spec, Symbols.symbol_function( EQUAL ), UNPROVIDED ) )
    {
      return T;
    }
    return NIL;
  ...
  public static SubLObject sksi_sks_mapping_allowedP_internal(SubLObject mt)
  {
    ...
    try
    {
      ...
      result = makeBoolean( NIL != sksi_query_utilities.some_sksi_removal_module_registeredP() && NIL != sksi_infrastructure_utilities.some_external_source_activated_in_imageP()
          && NIL != sksi_modules_allowed_in_current_inferenceP() && NIL != sksi_infrastructure_utilities.any_sksi_content_mt_with_registered_module_relevantP() );
    }
    finally
    {
  ...
  public static SubLObject sksi_sks_mapping_allowedP(SubLObject mt)
  {
    ...
    {
      results = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( sksi_sks_mapping_allowedP_internal( mt ) ) );
  ...
  {
    SubLFiles.declareFunction( me, "gather_sksi_gaf_lookup_index", "GATHER-SKSI-GAF-LOOKUP-INDEX", 2, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_predicate_extent_index", "GATHER-SKSI-PREDICATE-EXTENT-INDEX", 2, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_predicate_extent_index_int", "GATHER-SKSI-PREDICATE-EXTENT-INDEX-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_values", "GATHER-SKSI-GAF-ARG-INDEX-VALUES", 5, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_values_int_internal", "GATHER-SKSI-GAF-ARG-INDEX-VALUES-INT-INTERNAL", 5, 1, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_values_int", "GATHER-SKSI-GAF-ARG-INDEX-VALUES-INT", 5, 1, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index", "GATHER-SKSI-GAF-ARG-INDEX", 4, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_int_internal", "GATHER-SKSI-GAF-ARG-INDEX-INT-INTERNAL", 4, 1, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_int", "GATHER-SKSI-GAF-ARG-INDEX-INT", 4, 1, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_values_relevant_pred", "GATHER-SKSI-GAF-ARG-INDEX-VALUES-RELEVANT-PRED", 4, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_values_relevant_pred_by_term", "GATHER-SKSI-GAF-ARG-INDEX-VALUES-RELEVANT-PRED-BY-TERM", 4, 0, false );
    SubLFiles.declareFunction( me, "gather_bindings_from_query_form_mt_module_list_tuples", "GATHER-BINDINGS-FROM-QUERY-FORM-MT-MODULE-LIST-TUPLES", 3, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_values_relevant_pred_int", "GATHER-SKSI-GAF-ARG-INDEX-VALUES-RELEVANT-PRED-INT", 4, 0, false );
    SubLFiles.declareFunction( me, "gather_bindings_for_index_arg_value_from_meaning_sentence_query_form_mt_module_list_tuples",
        "GATHER-BINDINGS-FOR-INDEX-ARG-VALUE-FROM-MEANING-SENTENCE-QUERY-FORM-MT-MODULE-LIST-TUPLES", 5, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_relevant_pred", "GATHER-SKSI-GAF-ARG-INDEX-RELEVANT-PRED", 3, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_relevant_pred_by_term", "GATHER-SKSI-GAF-ARG-INDEX-RELEVANT-PRED-BY-TERM", 3, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_relevant_pred_by_term_int", "GATHER-SKSI-GAF-ARG-INDEX-RELEVANT-PRED-BY-TERM-INT", 2, 0, false );
    SubLFiles.declareFunction( me, "gather_sksi_gaf_arg_index_relevant_pred_int", "GATHER-SKSI-GAF-ARG-INDEX-RELEVANT-PRED-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "gather_instantiated_formulas_from_meaning_sentence_query_form_mt_module_list_tuples", "GATHER-INSTANTIATED-FORMULAS-FROM-MEANING-SENTENCE-QUERY-FORM-MT-MODULE-LIST-TUPLES", 4, 0,
        false );
    SubLFiles.declareFunction( me, "meaning_sentence_type_check_query_form", "MEANING-SENTENCE-TYPE-CHECK-QUERY-FORM", 3, 0, false );
    SubLFiles.declareFunction( me, "make_sksi_link_support", "MAKE-SKSI-LINK-SUPPORT", 2, 0, false );
    SubLFiles.declareFunction( me, "determine_allowed_modules_spec_for_sks_mapping", "DETERMINE-ALLOWED-MODULES-SPEC-FOR-SKS-MAPPING", 0, 1, false );
    SubLFiles.declareFunction( me, "compute_sksi_modules_allowed_in_current_inference", "COMPUTE-SKSI-MODULES-ALLOWED-IN-CURRENT-INFERENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "sksi_modules_allowed_in_current_inferenceP", "SKSI-MODULES-ALLOWED-IN-CURRENT-INFERENCE?", 0, 0, false );
    SubLFiles.declareFunction( me, "sksi_modules_not_allowed_in_inferenceP", "SKSI-MODULES-NOT-ALLOWED-IN-INFERENCE?", 1, 0, false );
    SubLFiles.declareFunction( me, "sksi_modules_not_allowed_by_allowed_modules_specP", "SKSI-MODULES-NOT-ALLOWED-BY-ALLOWED-MODULES-SPEC?", 1, 0, false );
    SubLFiles.declareFunction( me, "sksi_sks_mapping_allowedP_internal", "SKSI-SKS-MAPPING-ALLOWED?-INTERNAL", 0, 1, false );
    SubLFiles.declareFunction( me, "sksi_sks_mapping_allowedP", "SKSI-SKS-MAPPING-ALLOWED?", 0, 1, false );
    return NIL;
  }
  ...
  {
    memoization_state.note_memoized_function( $sym6$GATHER_SKSI_GAF_ARG_INDEX_VALUES_INT );
    memoization_state.note_memoized_function( $sym7$GATHER_SKSI_GAF_ARG_INDEX_INT );
  ...
  static
  {
    me = new sksi_sks_mapping_utilities();
    $kw0$POS = makeKeyword( "POS" );
    $kw1$RETURN = makeKeyword( "RETURN" );
    $kw2$BINDINGS_AND_SUPPORTS = makeKeyword( "BINDINGS-AND-SUPPORTS" );
    $kw3$ALLOWED_MODULES = makeKeyword( "ALLOWED-MODULES" );
    $list4 = ConsesLow.list( makeSymbol( "BINDINGS" ), makeSymbol( "SUPPORTS" ) );
    $list5 = ConsesLow.list( makeSymbol( "QUERY-FORM" ), makeSymbol( "MT" ), makeSymbol( "MODULES" ) );
    $sym6$GATHER_SKSI_GAF_ARG_INDEX_VALUES_INT = makeSymbol( "GATHER-SKSI-GAF-ARG-INDEX-VALUES-INT" );
    $sym7$GATHER_SKSI_GAF_ARG_INDEX_INT = makeSymbol( "GATHER-SKSI-GAF-ARG-INDEX-INT" );
    $list8 = ConsesLow.list( makeSymbol( "MEANING-SENTENCE" ), makeSymbol( "QUERY-FORM" ), makeSymbol( "MT" ), makeSymbol( "MODULES" ) );
    $kw9$RAW = makeKeyword( "RAW" );
    $list10 = ConsesLow.list( makeKeyword( "MODULE-SUBTYPE" ), makeKeyword( "SKSI" ) );
    $kw11$ALL = makeKeyword( "ALL" );
    $list12 = ConsesLow.list( makeKeyword( "NOT" ), ConsesLow.list( makeKeyword( "MODULE-SUBTYPE" ), makeKeyword( "SKSI" ) ) );
    $sym13$SKSI_SKS_MAPPING_ALLOWED_ = makeSymbol( "SKSI-SKS-MAPPING-ALLOWED?" );
  }
}
/*
 * 
