...
import com.cyc.cycjava.cycl.sksi.sksi_widgets.washington_post_restaurants_widgets;
...
import static com.cyc.cycjava.cycl.sksi.sksi_widgets.washington_post_restaurants_widgets.*;
...
public final class washington_post_restaurants_widgets extends SubLTranslatedFile {
    ...
    public static final SubLString $str2$www_washingtonpost_com = makeString("www.washingtonpost.com");

    public static final SubLString $str3$_ac2_wp_dyn = makeString("/ac2/wp-dyn");

    public static final SubLString $str4$node_entertainment_2Fsearch_type_ = makeString("node=entertainment%2Fsearch&type=restaurants&query=&sort=recommended-desc&cw1=~A&cw4=~A&neighborhood=~A");
    ...
    public static SubLObject washpost_rest_get_all_restaurants_for_criteria(SubLObject cuisine, SubLObject price, SubLObject neighborhood) {
        ...
        assert NIL != stringp(cuisine) : "Types.stringp(cuisine) " + "CommonSymbols.NIL != Types.stringp(cuisine) " + cuisine;
        assert NIL != stringp(price) : "Types.stringp(price) " + "CommonSymbols.NIL != Types.stringp(price) " + price;
        assert NIL != stringp(neighborhood) : "Types.stringp(neighborhood) " + "CommonSymbols.NIL != Types.stringp(neighborhood) " + neighborhood;
    ...
    public static SubLObject declare_washington_post_restaurants_widgets_file() {
        declareFunction(me, "washpost_rest_get_all_restaurants_for_cuisine", "WASHPOST-REST-GET-ALL-RESTAURANTS-FOR-CUISINE", 1, 0, false);
        declareFunction(me, "washpost_rest_get_all_restaurants_for_price", "WASHPOST-REST-GET-ALL-RESTAURANTS-FOR-PRICE", 1, 0, false);
        declareFunction(me, "washpost_rest_get_all_restaurants_for_neighborhood", "WASHPOST-REST-GET-ALL-RESTAURANTS-FOR-NEIGHBORHOOD", 1, 0, false);
        declareFunction(me, "washpost_rest_get_all_restaurants_for_criteria", "WASHPOST-REST-GET-ALL-RESTAURANTS-FOR-CRITERIA", 0, 3, false);
        declareFunction(me, "washpost_rest_perform_query_request", "WASHPOST-REST-PERFORM-QUERY-REQUEST", 1, 0, false);
        declareFunction(me, "washpost_rest_instantiate_query", "WASHPOST-REST-INSTANTIATE-QUERY", 3, 0, false);
        declareFunction(me, "washpost_rest_update_cookie_stash", "WASHPOST-REST-UPDATE-COOKIE-STASH", 1, 0, false);
        declareFunction(me, "washpost_rest_parse_all_restaurants_request", "WASHPOST-REST-PARSE-ALL-RESTAURANTS-REQUEST", 1, 0, false);
        declareFunction(me, "washpost_rest_parse_selection_choices", "WASHPOST-REST-PARSE-SELECTION-CHOICES", 1, 0, false);
        declareFunction(me, "washpost_rest_advance_to_cuisine_selector", "WASHPOST-REST-ADVANCE-TO-CUISINE-SELECTOR", 1, 0, false);
        declareFunction(me, "washpost_rest_advance_to_price_selector", "WASHPOST-REST-ADVANCE-TO-PRICE-SELECTOR", 1, 0, false);
        declareFunction(me, "washpost_rest_advance_to_neighborhood_selector", "WASHPOST-REST-ADVANCE-TO-NEIGHBORHOOD-SELECTOR", 1, 0, false);
        declareFunction(me, "washpost_rest_advance_past_choices", "WASHPOST-REST-ADVANCE-PAST-CHOICES", 1, 0, false);
        declareFunction(me, "washpost_rest_advance_to_next_restaurant_url", "WASHPOST-REST-ADVANCE-TO-NEXT-RESTAURANT-URL", 1, 0, false);
        declareFunction(me, "washpost_rest_advance_from_url_to_restaurant_name", "WASHPOST-REST-ADVANCE-FROM-URL-TO-RESTAURANT-NAME", 1, 0, false);
        declareFunction(me, "washpost_rest_advance_from_restaurant_name_to_address", "WASHPOST-REST-ADVANCE-FROM-RESTAURANT-NAME-TO-ADDRESS", 1, 0, false);
        declareFunction(me, "washpost_rest_advance_from_restaurant_address_to_phone_number", "WASHPOST-REST-ADVANCE-FROM-RESTAURANT-ADDRESS-TO-PHONE-NUMBER", 1, 0, false);
        declareFunction(me, "washpost_rest_advance_to_restaurant_map_url", "WASHPOST-REST-ADVANCE-TO-RESTAURANT-MAP-URL", 1, 0, false);
        declareFunction(me, "washpost_rest_advance_to_restaurant_cuisines", "WASHPOST-REST-ADVANCE-TO-RESTAURANT-CUISINES", 1, 0, false);
        declareFunction(me, "washpost_rest_harvest_one_restaurant", "WASHPOST-REST-HARVEST-ONE-RESTAURANT", 1, 0, false);
        declareFunction(me, "print_washington_post_restaurant_information", "PRINT-WASHINGTON-POST-RESTAURANT-INFORMATION", 1, 1, false);
        declareFunction(me, "washpost_rest_convert_cuisine_encoding_to_cuisines", "WASHPOST-REST-CONVERT-CUISINE-ENCODING-TO-CUISINES", 1, 0, false);
        declareFunction(me, "washpost_rest_harvest_cuisine_choices", "WASHPOST-REST-HARVEST-CUISINE-CHOICES", 1, 0, false);
        declareFunction(me, "washpost_rest_harvest_price_choices", "WASHPOST-REST-HARVEST-PRICE-CHOICES", 1, 0, false);
        declareFunction(me, "washpost_rest_harvest_neighborhood_choices", "WASHPOST-REST-HARVEST-NEIGHBORHOOD-CHOICES", 1, 0, false);
        declareFunction(me, "washpost_rest_harvest_all_choices", "WASHPOST-REST-HARVEST-ALL-CHOICES", 1, 0, false);
        declareFunction(me, "extract_option_value_from_html_encoding", "EXTRACT-OPTION-VALUE-FROM-HTML-ENCODING", 1, 0, false);
        return NIL;
    }
