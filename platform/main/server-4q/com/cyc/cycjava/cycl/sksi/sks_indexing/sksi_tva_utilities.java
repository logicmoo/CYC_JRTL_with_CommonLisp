...
import static com.cyc.cycjava.cycl.sksi.sks_indexing.sksi_tva_utilities.*;
...
public final class sksi_tva_utilities extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol SKSI_PRED_AND_RELEVANCE_P = makeSymbol("SKSI-PRED-AND-RELEVANCE-P");
    ...
    public static SubLObject declare_sksi_tva_utilities_file() {
        declareFunction(me, "sksi_pred_and_relevance_p_internal", "SKSI-PRED-AND-RELEVANCE-P-INTERNAL", 1, 0, false);
        declareFunction(me, "sksi_pred_and_relevance_p", "SKSI-PRED-AND-RELEVANCE-P", 1, 0, false);
        declareFunction(me, "sksi_gaf_arg_impossible_p", "SKSI-GAF-ARG-IMPOSSIBLE-P", 3, 0, false);
        declareFunction(me, "sksi_gaf_arg_possible_p", "SKSI-GAF-ARG-POSSIBLE-P", 3, 0, false);
        declareFunction(me, "sksi_transitivity_possibleP", "SKSI-TRANSITIVITY-POSSIBLE?", 0, 0, false);
        declareFunction(me, "sksi_gt_relevant_predP", "SKSI-GT-RELEVANT-PRED?", 1, 0, false);
        declareFunction(me, "sksi_record_all_backward_true_nodes", "SKSI-RECORD-ALL-BACKWARD-TRUE-NODES", 2, 2, false);
        declareFunction(me, "sksi_record_all_forward_true_nodes", "SKSI-RECORD-ALL-FORWARD-TRUE-NODES", 2, 2, false);
        declareFunction(me, "sksi_inverse_cardinality_internal", "SKSI-INVERSE-CARDINALITY-INTERNAL", 2, 1, false);
        declareFunction(me, "sksi_inverse_cardinality", "SKSI-INVERSE-CARDINALITY", 2, 1, false);
        declareFunction(me, "sksi_predicate_cardinality_internal", "SKSI-PREDICATE-CARDINALITY-INTERNAL", 2, 1, false);
        declareFunction(me, "sksi_predicate_cardinality", "SKSI-PREDICATE-CARDINALITY", 2, 1, false);
        return NIL;
    }
