...
import com.cyc.cycjava.cycl.sksi.sksi_widgets.sxsw_widgets;
...
import static com.cyc.cycjava.cycl.sksi.sksi_widgets.sxsw_widgets.*;
...
public final class sxsw_widgets extends SubLTranslatedFile {
    ...
    public static SubLObject declare_sxsw_widgets_file() {
        declareFunction(me, "sxsw_all_bands_request", "SXSW-ALL-BANDS-REQUEST", 0, 0, false);
        declareFunction(me, "sxsw_parse_bands_by_date_request", "SXSW-PARSE-BANDS-BY-DATE-REQUEST", 1, 0, false);
        declareFunction(me, "sxsw_parse_bands_with_section_dates", "SXSW-PARSE-BANDS-WITH-SECTION-DATES", 1, 0, false);
        declareFunction(me, "sxsw_parse_bands_without_date_in_table", "SXSW-PARSE-BANDS-WITHOUT-DATE-IN-TABLE", 2, 0, false);
        declareFunction(me, "sxsw_parse_bands_with_date_in_table", "SXSW-PARSE-BANDS-WITH-DATE-IN-TABLE", 1, 0, false);
        declareFunction(me, "sxsw_extract_location_code_from_venue_url", "SXSW-EXTRACT-LOCATION-CODE-FROM-VENUE-URL", 1, 0, false);
        declareFunction(me, "sxsw_extract_date_from_datesection_header", "SXSW-EXTRACT-DATE-FROM-DATESECTION-HEADER", 1, 0, false);
        declareFunction(me, "sxsw_extract_date_from_datefield", "SXSW-EXTRACT-DATE-FROM-DATEFIELD", 1, 0, false);
        declareFunction(me, "sxsw_extract_time_from_timefield", "SXSW-EXTRACT-TIME-FROM-TIMEFIELD", 1, 0, false);
        declareFunction(me, "sxsw_convert_home_to_cityXregion", "SXSW-CONVERT-HOME-TO-CITY&REGION", 1, 0, false);
        declareFunction(me, "sxsw_strip_greyspace", "SXSW-STRIP-GREYSPACE", 1, 0, false);
        declareFunction(me, "advance_xml_tokens_past", "ADVANCE-XML-TOKENS-PAST", 2, 1, false);
        return NIL;
    }
