...
import static com.cyc.cycjava.cycl.sksi.corba.corba_utilities.*;
...
public final class corba_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject corba_connection_p(final SubLObject v_object) {
        return v_object.getClass() == corba_utilities.$corba_connection_native.class ? T : NIL;
    }

    public static SubLObject corba_connection_int_stream(final SubLObject v_object) {
        assert NIL != corba_connection_p(v_object) : "corba_utilities.corba_connection_p(v_object) " + "CommonSymbols.NIL != corba_utilities.corba_connection_p(v_object) " + v_object;
    ...
    public static SubLObject make_corba_connection(SubLObject arglist) {
        ...
        final SubLObject v_new = new corba_utilities.$corba_connection_native();
        SubLObject next;
    ...
    public static final class $corba_connection_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(corba_utilities.$corba_connection_native.class, CORBA_CONNECTION, CORBA_CONNECTION_P, $list9, $list10, new String[]{ "$stream", "$properties", "$initial_object_id", "$history", "$error_handling" }, $list11, $list12, CORBA_CONNECTION_INT_PRINT);
        }
    }
