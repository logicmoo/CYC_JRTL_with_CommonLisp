...
import static com.cyc.cycjava.cycl.sksi.sksi_database_fusion.*;
...
public final class sksi_database_fusion extends SubLTranslatedFile {
    ...
    public static SubLObject db_info_p(final SubLObject v_object) {
        return v_object.getClass() == sksi_database_fusion.$db_info_native.class ? T : NIL;
    }

    public static SubLObject dbnfo_constant_base_name(final SubLObject v_object) {
        assert NIL != db_info_p(v_object) : "sksi_database_fusion.db_info_p(v_object) " + "CommonSymbols.NIL != sksi_database_fusion.db_info_p(v_object) " + v_object;
    ...
    public static SubLObject make_db_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new sksi_database_fusion.$db_info_native();
        SubLObject next;
    ...
    public static SubLObject table_info_p(final SubLObject v_object) {
        return v_object.getClass() == sksi_database_fusion.$table_info_native.class ? T : NIL;
    }

    public static SubLObject tblnfo_id(final SubLObject v_object) {
        assert NIL != table_info_p(v_object) : "sksi_database_fusion.table_info_p(v_object) " + "CommonSymbols.NIL != sksi_database_fusion.table_info_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_table_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new sksi_database_fusion.$table_info_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $db_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sksi_database_fusion.$db_info_native.class, DB_INFO, DB_INFO_P, $list3, $list4, new String[]{ "$constant_base_name", "$db_name", "$table_infos", "$table_info_index", "$server", "$port", "$proxy_host", "$proxy_port", "$user", "$pass", "$subprotocol", "$sql_flavor", "$quoted_isas", "$input_mt", "$content_genl_mts" }, $list5, $list6, PRINT_DB_INFO);
        }
    }
    ...
    public static final class $table_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sksi_database_fusion.$table_info_native.class, TABLE_INFO, TABLE_INFO_P, $list84, $list85, new String[]{ "$id", "$constant_base_name", "$table_name", "$isas", "$lf_types", "$field_mappings", "$meaning_sentences", "$enumerableP", "$field_names", "$field_types", "$primary_key", "$indexes", "$field_encodings", "$field_decodings", "$foreign_key_maps", "$non_null_field_list", "$unique_field_tuples" }, $list86, $list87, PRINT_TABLE_INFO);
        }
    }
