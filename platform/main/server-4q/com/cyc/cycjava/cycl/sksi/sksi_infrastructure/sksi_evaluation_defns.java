...
import com.cyc.cycjava.cycl.sksi.sksi_infrastructure.sksi_evaluation_defns;
...
import static com.cyc.cycjava.cycl.sksi.sksi_infrastructure.sksi_evaluation_defns.*;
...
public final class sksi_evaluation_defns extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLString $$$the_ = makeString("the ");

    public static final SubLSymbol PRE_REMOVE_DEFINITE_ARTICLE_FROM_STRING = makeSymbol("PRE-REMOVE-DEFINITE-ARTICLE-FROM-STRING");

    public static final SubLSymbol CYC_SKSI_SOURCE_REGISTERED = makeSymbol("CYC-SKSI-SOURCE-REGISTERED");

    public static final SubLSymbol CYC_SKSI_SOURCE_ACTIVATED = makeSymbol("CYC-SKSI-SOURCE-ACTIVATED");

    public static final SubLSymbol CYC_SKSI_SOURCE_ACCESSIBLE = makeSymbol("CYC-SKSI-SOURCE-ACCESSIBLE");

    public static final SubLSymbol CYC_SKSI_SOURCE_QUERYABLE = makeSymbol("CYC-SKSI-SOURCE-QUERYABLE");

    public static final SubLSymbol CYC_PARSE_PLACE_NAME = makeSymbol("CYC-PARSE-PLACE-NAME");

    public static final SubLSymbol SKSI_PARSE_PLACE_NAME = makeSymbol("SKSI-PARSE-PLACE-NAME");
    ...
    private static final SubLObject $$SKSIDateDecodeFn = reader_make_constant_shell(makeString("SKSIDateDecodeFn"));
    ...
    public static SubLObject declare_sksi_evaluation_defns_file() {
        declareFunction(me, "pre_remove_definite_article_from_string", "PRE-REMOVE-DEFINITE-ARTICLE-FROM-STRING", 1, 0, false);
        declareFunction(me, "cyc_sksi_source_registered", "CYC-SKSI-SOURCE-REGISTERED", 1, 0, false);
        declareFunction(me, "cyc_sksi_source_activated", "CYC-SKSI-SOURCE-ACTIVATED", 1, 0, false);
        declareFunction(me, "cyc_sksi_source_accessible", "CYC-SKSI-SOURCE-ACCESSIBLE", 1, 0, false);
        declareFunction(me, "cyc_sksi_source_queryable", "CYC-SKSI-SOURCE-QUERYABLE", 1, 0, false);
        declareFunction(me, "cyc_parse_place_name", "CYC-PARSE-PLACE-NAME", 4, 0, false);
        declareFunction(me, "sksi_parse_place_name_internal", "SKSI-PARSE-PLACE-NAME-INTERNAL", 4, 0, false);
        declareFunction(me, "sksi_parse_place_name", "SKSI-PARSE-PLACE-NAME", 4, 0, false);
        declareFunction(me, "cyc_schema_object_id_fn", "CYC-SCHEMA-OBJECT-ID-FN", 2, 0, false);
        declareFunction(me, "cyc_source_schema_object_id_fn", "CYC-SOURCE-SCHEMA-OBJECT-ID-FN", 3, 0, false);
        declareFunction(me, "cyc_schema_object_fn", "CYC-SCHEMA-OBJECT-FN", 2, 0, false);
        declareFunction(me, "cyc_source_schema_object_fn", "CYC-SOURCE-SCHEMA-OBJECT-FN", 3, 0, false);
        declareFunction(me, "sksi_date_decode", "SKSI-DATE-DECODE", 2, 0, false);
        return NIL;
    }
