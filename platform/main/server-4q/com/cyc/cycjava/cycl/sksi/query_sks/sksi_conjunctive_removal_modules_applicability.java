...
import com.cyc.cycjava.cycl.sksi.query_sks.sksi_conjunctive_removal_modules_applicability;
...
import static com.cyc.cycjava.cycl.sksi.query_sks.sksi_conjunctive_removal_modules_applicability.*;
...
public final class sksi_conjunctive_removal_modules_applicability extends SubLTranslatedFile {
    ...
    public static final SubLList $list9 = list(list(makeSymbol("RESULT-VAR")), makeSymbol("&BODY"), makeSymbol("BODY"));



    public static final SubLList $list11 = list(list(makeSymbol("*SKSI-CRM-GATHERED-POS-SUBCLAUSE-SPECS*"), NIL), list(makeSymbol("*SKSI-CRM-REJECTED-POS-SUBCLAUSE-SPECS*"), list(makeSymbol("NEW-DICTIONARY"), list(makeSymbol("FUNCTION"), EQUAL))));



    private static final SubLList $list13 = list(list(makeSymbol("FIF"), makeSymbol("*SKSI-CRM-IGNORE-SUBSUMED-SUBCLAUSE-SPECS?*"), list(makeSymbol("DELETE-SUBSUMED-ITEMS"), makeSymbol("*SKSI-CRM-GATHERED-POS-SUBCLAUSE-SPECS*"), list(makeSymbol("QUOTE"), makeSymbol("SUPERSETP"))), makeSymbol("*SKSI-CRM-GATHERED-POS-SUBCLAUSE-SPECS*")));
    ...
    public static SubLObject declare_sksi_conjunctive_removal_modules_applicability_file() {
        declareFunction(me, "removal_sksi_conjunction_pos_lits_applicability", "REMOVAL-SKSI-CONJUNCTION-POS-LITS-APPLICABILITY", 2, 0, false);
        declareFunction(me, "removal_sksi_conjunction_pos_lits_applicability_int", "REMOVAL-SKSI-CONJUNCTION-POS-LITS-APPLICABILITY-INT", 2, 0, false);
        declareFunction(me, "sksi_crm_profile_relevantP", "SKSI-CRM-PROFILE-RELEVANT?", 2, 0, false);
        declareFunction(me, "sksi_crm_sks_relevantP", "SKSI-CRM-SKS-RELEVANT?", 2, 0, false);
        declareFunction(me, "sksi_crm_genl_ks", "SKSI-CRM-GENL-KS", 1, 0, false);
        declareFunction(me, "sksi_crm_get_subclause_candidates", "SKSI-CRM-GET-SUBCLAUSE-CANDIDATES", 2, 0, false);
        declareFunction(me, "sks_supports_evaluation_asentsP", "SKS-SUPPORTS-EVALUATION-ASENTS?", 1, 0, false);
        declareFunction(me, "sksi_supported_evaluate_asentP", "SKSI-SUPPORTED-EVALUATE-ASENT?", 1, 0, false);
        declareFunction(me, "sksi_crm_fully_forbidden_comparison_operators_internal", "SKSI-CRM-FULLY-FORBIDDEN-COMPARISON-OPERATORS-INTERNAL", 1, 0, false);
        declareFunction(me, "sksi_crm_fully_forbidden_comparison_operators", "SKSI-CRM-FULLY-FORBIDDEN-COMPARISON-OPERATORS", 1, 0, false);
        declareMacro(me, "with_sksi_crm_pos_subclause_spec_gathering", "WITH-SKSI-CRM-POS-SUBCLAUSE-SPEC-GATHERING");
        declareFunction(me, "sksi_crm_add_pos_subclause_spec", "SKSI-CRM-ADD-POS-SUBCLAUSE-SPEC", 1, 0, false);
        declareFunction(me, "sksi_crm_reject_pos_subclause_spec", "SKSI-CRM-REJECT-POS-SUBCLAUSE-SPEC", 1, 0, false);
        declareFunction(me, "sksi_crm_pos_subclause_spec_irrelevantP", "SKSI-CRM-POS-SUBCLAUSE-SPEC-IRRELEVANT?", 1, 0, false);
        declareFunction(me, "sksi_crm_gather_literals", "SKSI-CRM-GATHER-LITERALS", 7, 0, false);
        declareFunction(me, "sksi_crm_gather_literals_iterative", "SKSI-CRM-GATHER-LITERALS-ITERATIVE", 8, 0, false);
        declareFunction(me, "pos_subclause_spec_G", "POS-SUBCLAUSE-SPEC->", 2, 0, false);
        new sksi_conjunctive_removal_modules_applicability.$pos_subclause_spec_G$BinaryFunction();
        declareFunction(me, "sksi_crm_gather_literals_recursive", "SKSI-CRM-GATHER-LITERALS-RECURSIVE", 8, 0, false);
        declareFunction(me, "sksi_crm_gather_literals_recursive_continue_recursion", "SKSI-CRM-GATHER-LITERALS-RECURSIVE-CONTINUE-RECURSION", 8, 0, false);
        declareFunction(me, "sksi_crm_valid_queryP", "SKSI-CRM-VALID-QUERY?", 8, 0, false);
        declareFunction(me, "sksi_crm_valid_query_int", "SKSI-CRM-VALID-QUERY-INT", 6, 0, false);
        declareFunction(me, "sksi_crm_applicability_iterate_over_meaning_sentence_gafs", "SKSI-CRM-APPLICABILITY-ITERATE-OVER-MEANING-SENTENCE-GAFS", 9, 0, false);
        declareFunction(me, "sksi_crm_applicability_process_meaning_sentence_gafs", "SKSI-CRM-APPLICABILITY-PROCESS-MEANING-SENTENCE-GAFS", 6, 0, false);
        declareFunction(me, "sksi_crm_applicability_iterate_over_asents", "SKSI-CRM-APPLICABILITY-ITERATE-OVER-ASENTS", 9, 0, false);
        declareFunction(me, "sksi_crm_asents_generate_csqlP", "SKSI-CRM-ASENTS-GENERATE-CSQL?", 6, 0, false);
        declareFunction(me, "sksi_crm_asents_generate_sqlP", "SKSI-CRM-ASENTS-GENERATE-SQL?", 6, 0, false);
        declareFunction(me, "sksi_crm_form_islands", "SKSI-CRM-FORM-ISLANDS", 2, 1, false);
        declareFunction(me, "sksi_crm_literal_coherentP", "SKSI-CRM-LITERAL-COHERENT?", 5, 0, false);
        declareFunction(me, "sksi_crm_literal_coherent", "SKSI-CRM-LITERAL-COHERENT", 5, 0, false);
        declareFunction(me, "sksi_crm_literal_coherent_int", "SKSI-CRM-LITERAL-COHERENT-INT", 3, 0, false);
        declareFunction(me, "sksi_crm_literals_coherent_together", "SKSI-CRM-LITERALS-COHERENT-TOGETHER", 5, 0, false);
        declareFunction(me, "sksi_crm_literals_coherent_together_int", "SKSI-CRM-LITERALS-COHERENT-TOGETHER-INT", 7, 0, false);
        declareFunction(me, "sksi_crm_enumerability_check_asents", "SKSI-CRM-ENUMERABILITY-CHECK-ASENTS", 5, 0, false);
        declareFunction(me, "sksi_crm_unbound_unknown_sentence_asentsP", "SKSI-CRM-UNBOUND-UNKNOWN-SENTENCE-ASENTS?", 5, 0, false);
        declareFunction(me, "sksi_crm_enumerability_check", "SKSI-CRM-ENUMERABILITY-CHECK", 1, 0, false);
        declareFunction(me, "sksi_crm_multi_table_check", "SKSI-CRM-MULTI-TABLE-CHECK", 2, 0, false);
        declareFunction(me, "sksi_crm_fully_unbound_asentsP", "SKSI-CRM-FULLY-UNBOUND-ASENTS?", 5, 0, false);
        declareFunction(me, "sksi_crm_any_fully_bound_argP", "SKSI-CRM-ANY-FULLY-BOUND-ARG?", 1, 0, false);
        declareFunction(me, "sksi_crm_fully_unbound_for_meaning_sentenceP", "SKSI-CRM-FULLY-UNBOUND-FOR-MEANING-SENTENCE?", 2, 0, false);
        declareFunction(me, "sksi_crm_fully_unbound_for_meaning_sentence_int", "SKSI-CRM-FULLY-UNBOUND-FOR-MEANING-SENTENCE-INT", 2, 0, false);
        declareFunction(me, "collect_physical_schemata_from_meaning_sentence_gafs", "COLLECT-PHYSICAL-SCHEMATA-FROM-MEANING-SENTENCE-GAFS", 1, 0, false);
        declareFunction(me, "collect_physical_schemata_from_meaning_sentence", "COLLECT-PHYSICAL-SCHEMATA-FROM-MEANING-SENTENCE", 1, 0, false);
        declareFunction(me, "collect_physical_schemata_from_logical_field_indexical_internal", "COLLECT-PHYSICAL-SCHEMATA-FROM-LOGICAL-FIELD-INDEXICAL-INTERNAL", 1, 0, false);
        declareFunction(me, "collect_physical_schemata_from_logical_field_indexical", "COLLECT-PHYSICAL-SCHEMATA-FROM-LOGICAL-FIELD-INDEXICAL", 1, 0, false);
        declareFunction(me, "clause_literal_variables", "CLAUSE-LITERAL-VARIABLES", 3, 0, false);
        declareFunction(me, "contextualized_literal_variables", "CONTEXTUALIZED-LITERAL-VARIABLES", 1, 0, false);
        declareFunction(me, "contextualized_literal_hl_variables", "CONTEXTUALIZED-LITERAL-HL-VARIABLES", 1, 0, false);
        return NIL;
    }
