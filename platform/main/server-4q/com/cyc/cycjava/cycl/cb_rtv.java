...
import com.cyc.cycjava.cycl.cb_rtv;
...
import static com.cyc.cycjava.cycl.cb_rtv.*;
...
public final class cb_rtv extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLString $$$RTV = makeString("RTV");



    public static final SubLString $str2$cb_rtv = makeString("cb-rtv");



    public static final SubLSymbol CB_LINK_RTV_QUERY = makeSymbol("CB-LINK-RTV-QUERY");

    public static final SubLString $$$relatedToVia_Query_Tool = makeString("relatedToVia Query Tool");
    ...
    private static final SubLObject $const10$CurrentWorldDataCollectorMt_NonHo = reader_make_constant_shell(makeString("CurrentWorldDataCollectorMt-NonHomocentric"));

    public static final SubLSymbol $cb_rtv_predicates$ = makeSymbol("*CB-RTV-PREDICATES*");

    private static final SubLList $list12 = list(new SubLObject[]{ reader_make_constant_shell(makeString("actors")), reader_make_constant_shell(makeString("affiliatedWith")), reader_make_constant_shell(makeString("acquaintedWith")), reader_make_constant_shell(makeString("allies")), reader_make_constant_shell(makeString("citizens")), reader_make_constant_shell(makeString("containsInformation")), reader_make_constant_shell(makeString("deliberateActors")), reader_make_constant_shell(makeString("deviceUsed")), reader_make_constant_shell(makeString("directingAgent")), reader_make_constant_shell(makeString("doesBusinessWith")), reader_make_constant_shell(makeString("employees")), reader_make_constant_shell(makeString("eventOccursAt")), reader_make_constant_shell(makeString("hasLeaders")), reader_make_constant_shell(makeString("hasOwnershipIn")), reader_make_constant_shell(makeString("in-ContCompletely")), reader_make_constant_shell(makeString("inRegion")), reader_make_constant_shell(makeString("likesAsFriend")), reader_make_constant_shell(makeString("performedBy")), reader_make_constant_shell(makeString("possesses")), reader_make_constant_shell(makeString("residenceOfOrganization")), reader_make_constant_shell(makeString("subEvents")) });
    ...
    private static final SubLObject $$RTVDemoCollection = reader_make_constant_shell(makeString("RTVDemoCollection"));

    private static final SubLList $list18 = list(reader_make_constant_shell(makeString("Thing")), reader_make_constant_shell(makeString("Person")), reader_make_constant_shell(makeString("Place")));
    ...
    private static final SubLList $list44 = list(makeKeyword("ISA"), makeKeyword("GENL"));
    ...
    private static final SubLList $list127 = list(makeSymbol("HTML-TABLE-DATA"), list(makeSymbol("HTML-GLYPH"), makeKeyword("NBSP")));
    ...
    private static final SubLList $list170 = list(reader_make_constant_shell(makeString("isa")), makeSymbol("?ANY"), reader_make_constant_shell(makeString("Thing")));
                ...
                try {
                    ...
                    try {
                        ...
                        if (NIL != running_query_nowP) {
                            ...
                            assert NIL != booleanp(genl_preds_reasoning_enabledP) : "Types.booleanp(genl_preds_reasoning_enabledP) " + "CommonSymbols.NIL != Types.booleanp(genl_preds_reasoning_enabledP) " + genl_preds_reasoning_enabledP;
    ...
    public static SubLObject declare_cb_rtv_file() {
        declareFunction(me, "cb_link_rtv_query", "CB-LINK-RTV-QUERY", 0, 1, false);
        declareFunction(me, "cb_rtv_fort_generation_fn", "CB-RTV-FORT-GENERATION-FN", 0, 0, false);
        declareFunction(me, "cb_rtv_fort_parse_fn", "CB-RTV-FORT-PARSE-FN", 0, 0, false);
        declareFunction(me, "maybe_initialize_cb_rtv_predicates", "MAYBE-INITIALIZE-CB-RTV-PREDICATES", 0, 0, false);
        declareFunction(me, "initialize_cb_rtv_predicates", "INITIALIZE-CB-RTV-PREDICATES", 0, 0, false);
        declareFunction(me, "maybe_initialize_cb_rtv_collections", "MAYBE-INITIALIZE-CB-RTV-COLLECTIONS", 0, 0, false);
        declareFunction(me, "initialize_cb_rtv_collections", "INITIALIZE-CB-RTV-COLLECTIONS", 0, 0, false);
        declareFunction(me, "cb_rtv", "CB-RTV", 1, 0, false);
        declareFunction(me, "cb_rtv_submit_buttons", "CB-RTV-SUBMIT-BUTTONS", 2, 0, false);
        declareFunction(me, "cb_rtv_query_readyP", "CB-RTV-QUERY-READY?", 1, 0, false);
        declareFunction(me, "cb_rtv_show_query_results", "CB-RTV-SHOW-QUERY-RESULTS", 2, 1, false);
        declareFunction(me, "cb_rtv_justify_term", "CB-RTV-JUSTIFY-TERM", 1, 0, false);
        declareFunction(me, "cb_rtv_justify_term_open_window", "CB-RTV-JUSTIFY-TERM-OPEN-WINDOW", 1, 0, false);
        declareFunction(me, "cb_link_rtv_justify_term", "CB-LINK-RTV-JUSTIFY-TERM", 2, 0, false);
        declareFunction(me, "cb_rtv_justify_open_window_link", "CB-RTV-JUSTIFY-OPEN-WINDOW-LINK", 2, 1, false);
        declareFunction(me, "rtv_hl_justify", "RTV-HL-JUSTIFY", 1, 0, false);
        declareMacro(me, "cb_rtv_indented_table_data", "CB-RTV-INDENTED-TABLE-DATA");
        declareFunction(me, "cb_rtv_meta_supports_to_show", "CB-RTV-META-SUPPORTS-TO-SHOW", 1, 0, false);
        declareFunction(me, "cb_rtv_maybe_show_meta_supports", "CB-RTV-MAYBE-SHOW-META-SUPPORTS", 2, 0, false);
        declareFunction(me, "cb_rtv_show_support", "CB-RTV-SHOW-SUPPORT", 1, 1, false);
        declareFunction(me, "cb_rtv_show_support_readably", "CB-RTV-SHOW-SUPPORT-READABLY", 1, 1, false);
        declareFunction(me, "cb_rtv_maybe_show_additional_supports", "CB-RTV-MAYBE-SHOW-ADDITIONAL-SUPPORTS", 2, 0, false);
        declareFunction(me, "cb_rtv_show_argument", "CB-RTV-SHOW-ARGUMENT", 2, 0, false);
        declareFunction(me, "cb_rtv_show_arguments", "CB-RTV-SHOW-ARGUMENTS", 1, 2, false);
        declareFunction(me, "rtv_supportP", "RTV-SUPPORT?", 1, 0, false);
        declareFunction(me, "cb_link_rtv_graph_event", "CB-LINK-RTV-GRAPH-EVENT", 2, 1, false);
        declareFunction(me, "cb_rtv_graph_event", "CB-RTV-GRAPH-EVENT", 1, 0, false);
        declareFunction(me, "cb_rtv_graph_event_process", "CB-RTV-GRAPH-EVENT-PROCESS", 1, 0, false);
        declareFunction(me, "bbf_rtv_all_edges_between", "BBF-RTV-ALL-EDGES-BETWEEN", 1, 0, false);
        declareFunction(me, "bbf_rtv_all_edges_from_node", "BBF-RTV-ALL-EDGES-FROM-NODE", 1, 0, false);
        declareFunction(me, "bbf_rtv_all_edges_from_node_satisfying", "BBF-RTV-ALL-EDGES-FROM-NODE-SATISFYING", 1, 0, false);
        declareFunction(me, "bbf_rtv", "BBF-RTV", 1, 0, false);
        declareFunction(me, "cb_link_rtv_predicate_graph_event", "CB-LINK-RTV-PREDICATE-GRAPH-EVENT", 2, 0, false);
        declareFunction(me, "cb_rtv_predicate_graph_event", "CB-RTV-PREDICATE-GRAPH-EVENT", 1, 0, false);
        declareFunction(me, "cb_rtv_predicate_graph_event_process", "CB-RTV-PREDICATE-GRAPH-EVENT-PROCESS", 1, 0, false);
        declareFunction(me, "bbf_all_edges_subsumed_by_preds", "BBF-ALL-EDGES-SUBSUMED-BY-PREDS", 1, 0, false);
        return NIL;
    }
