...
import static com.cyc.cycjava.cycl.ontology_layers.*;
...
public final class ontology_layers extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLList $list0 = list(makeKeyword("UPPER"), makeKeyword("MIDDLE"), makeKeyword("LOWER"));
    ...
    public static final SubLString $str13$Computing_collection_generalizati = makeString("Computing collection generalization counts");
    ...
    public static final SubLList $list19 = cons(makeSymbol("FORT"), makeSymbol("COUNT"));

    public static final SubLList $list20 = list(makeSymbol("UPPER-COLLECTIONS"), makeSymbol("MIDDLE-COLLECTIONS"), makeSymbol("LOWER-COLLECTIONS"));

    public static final SubLString $str21$Computing_relation_ontology_layer = makeString("Computing relation ontology layers");
    ...
    public static SubLObject declare_ontology_layers_file() {
        declareFunction(me, "ontology_layer_p", "ONTOLOGY-LAYER-P", 1, 0, false);
        declareFunction(me, "lower_ontology_layer", "LOWER-ONTOLOGY-LAYER", 2, 0, false);
        declareFunction(me, "fort_ontology_layer", "FORT-ONTOLOGY-LAYER", 1, 0, false);
        declareFunction(me, "assertion_ontology_layer", "ASSERTION-ONTOLOGY-LAYER", 1, 0, false);
        declareFunction(me, "assertion_ontology_layer_recursive", "ASSERTION-ONTOLOGY-LAYER-RECURSIVE", 2, 0, false);
        declareFunction(me, "compute_collection_generalization_counts", "COMPUTE-COLLECTION-GENERALIZATION-COUNTS", 0, 1, false);
        declareFunction(me, "compute_collection_ontology_layer_sets", "COMPUTE-COLLECTION-ONTOLOGY-LAYER-SETS", 1, 2, false);
        declareFunction(me, "compute_relation_ontology_layer_sets", "COMPUTE-RELATION-ONTOLOGY-LAYER-SETS", 1, 0, false);
        declareFunction(me, "relation_constraining_collections", "RELATION-CONSTRAINING-COLLECTIONS", 1, 1, false);
        declareFunction(me, "all_core_union_constants", "ALL-CORE-UNION-CONSTANTS", 0, 0, false);
        declareFunction(me, "initialize_ontology_layers", "INITIALIZE-ONTOLOGY-LAYERS", 0, 3, false);
        declareFunction(me, "possibly_initialize_ontology_layers", "POSSIBLY-INITIALIZE-ONTOLOGY-LAYERS", 0, 0, false);
        declareFunction(me, "ontology_layers_initializedP", "ONTOLOGY-LAYERS-INITIALIZED?", 0, 0, false);
        declareFunction(me, "save_ontology_layers", "SAVE-ONTOLOGY-LAYERS", 1, 3, false);
        declareFunction(me, "load_ontology_layers", "LOAD-ONTOLOGY-LAYERS", 1, 0, false);
        declareFunction(me, "initialize_ontology_layers_internal", "INITIALIZE-ONTOLOGY-LAYERS-INTERNAL", 3, 0, false);
        declareFunction(me, "compute_assertion_ontology_layer_statistics", "COMPUTE-ASSERTION-ONTOLOGY-LAYER-STATISTICS", 0, 0, false);
        declareFunction(me, "all_upper_ontology_layer_collections", "ALL-UPPER-ONTOLOGY-LAYER-COLLECTIONS", 0, 0, false);
        return NIL;
    }
