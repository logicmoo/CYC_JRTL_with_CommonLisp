...
public final class reformulator_module_harness extends SubLTranslatedFile {
    ...
    public static SubLObject rl_module_p(final SubLObject v_object) {
        return v_object.getClass() == reformulator_module_harness.$rl_module_native.class ? T : NIL;
    }

    public static SubLObject rlm_name(final SubLObject v_object) {
        assert NIL != rl_module_p(v_object) : "reformulator_module_harness.rl_module_p(v_object) " + "CommonSymbols.NIL != reformulator_module_harness.rl_module_p(v_object) " + v_object;
    ...
    public static SubLObject make_rl_module(SubLObject arglist) {
        ...
        final SubLObject v_new = new reformulator_module_harness.$rl_module_native();
        SubLObject next;
    ...
    public static final class $rl_module_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(reformulator_module_harness.$rl_module_native.class, RL_MODULE, RL_MODULE_P, $list2, $list3, new String[]{ "$name", "$required", "$cost", "$reformulate", "$documentation", "$example_source", "$example_target", "$plist" }, $list4, $list5, PRINT_RL_MODULE);
        }
    }
