...
import static com.cyc.cycjava.cycl.file_translation.*;
...
public final class file_translation extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol TRANS_SUBL_FILE = makeSymbol("TRANS-SUBL-FILE");
    ...
    public static final SubLSymbol PRINT_TRANS_SUBL_FILE = makeSymbol("PRINT-TRANS-SUBL-FILE");

    public static final SubLSymbol TRANS_SUBL_FILE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("TRANS-SUBL-FILE-PRINT-FUNCTION-TRAMPOLINE");
    ...
    public static SubLObject trans_subl_file_p(final SubLObject v_object) {
        return v_object.getClass() == file_translation.$trans_subl_file_native.class ? T : NIL;
    }

    public static SubLObject tsf_module_name(final SubLObject v_object) {
        assert NIL != trans_subl_file_p(v_object) : "file_translation.trans_subl_file_p(v_object) " + "CommonSymbols.NIL != file_translation.trans_subl_file_p(v_object) " + v_object;
    ...
    public static SubLObject make_trans_subl_file(SubLObject arglist) {
        ...
        final SubLObject v_new = new file_translation.$trans_subl_file_native();
        SubLObject next;
    ...
    public static SubLObject tsf_possibly_note_defined_global_binding_type(final SubLObject global, final SubLObject binding_type) {
        assert NIL != symbolp(global) : "Types.symbolp(global) " + "CommonSymbols.NIL != Types.symbolp(global) " + global;
        assert NIL != keywordp(binding_type) : "Types.keywordp(binding_type) " + "CommonSymbols.NIL != Types.keywordp(binding_type) " + binding_type;
        final SubLObject ts_file = current_ts_file();
        if (NIL != ts_file) {
    ...
    public static SubLObject tsf_possibly_note_defined_method_visibility(final SubLObject method, final SubLObject visibility) {
        ...
        assert NIL != symbolp(visibility) : "Types.symbolp(visibility) " + "CommonSymbols.NIL != Types.symbolp(visibility) " + visibility;
        final SubLObject ts_file = current_ts_file();
        if (NIL != ts_file) {
            ...
            try {
                ...
                try {
                    ...
                    for (form = read(stream_$1, NIL, $EOF, UNPROVIDED); form != $EOF; form = read(stream_$1, NIL, $EOF, UNPROVIDED)) {
                        ...
                        assert NIL != subl_promotions.non_negative_integer_p(position_var) : "subl_promotions.non_negative_integer_p(position_var) " + "CommonSymbols.NIL != subl_promotions.non_negative_integer_p(position_var) " + position_var;
    ...
    public static SubLObject declare_file_translation_file() {
        declareFunction(me, "current_ts_file", "CURRENT-TS-FILE", 0, 0, false);
        declareFunction(me, "trans_subl_file_print_function_trampoline", "TRANS-SUBL-FILE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "trans_subl_file_p", "TRANS-SUBL-FILE-P", 1, 0, false);
        new file_translation.$trans_subl_file_p$UnaryFunction();
        declareFunction(me, "tsf_module_name", "TSF-MODULE-NAME", 1, 0, false);
        declareFunction(me, "tsf_filename", "TSF-FILENAME", 1, 0, false);
        declareFunction(me, "tsf_internal_constants", "TSF-INTERNAL-CONSTANTS", 1, 0, false);
        declareFunction(me, "tsf_referenced_globals", "TSF-REFERENCED-GLOBALS", 1, 0, false);
        declareFunction(me, "tsf_referenced_functions", "TSF-REFERENCED-FUNCTIONS", 1, 0, false);
        declareFunction(me, "tsf_definitions", "TSF-DEFINITIONS", 1, 0, false);
        declareFunction(me, "tsf_top_level_forms", "TSF-TOP-LEVEL-FORMS", 1, 0, false);
        declareFunction(me, "tsf_defined_globals", "TSF-DEFINED-GLOBALS", 1, 0, false);
        declareFunction(me, "tsf_defined_functions", "TSF-DEFINED-FUNCTIONS", 1, 0, false);
        declareFunction(me, "tsf_defined_macros", "TSF-DEFINED-MACROS", 1, 0, false);
        declareFunction(me, "tsf_arglist_table", "TSF-ARGLIST-TABLE", 1, 0, false);
        declareFunction(me, "tsf_binding_type_table", "TSF-BINDING-TYPE-TABLE", 1, 0, false);
        declareFunction(me, "tsf_method_visibility_table", "TSF-METHOD-VISIBILITY-TABLE", 1, 0, false);
        declareFunction(me, "tsf_global_visibility_table", "TSF-GLOBAL-VISIBILITY-TABLE", 1, 0, false);
        declareFunction(me, "tsf_rwbc_methods", "TSF-RWBC-METHODS", 1, 0, false);
        declareFunction(me, "_csetf_tsf_module_name", "_CSETF-TSF-MODULE-NAME", 2, 0, false);
        declareFunction(me, "_csetf_tsf_filename", "_CSETF-TSF-FILENAME", 2, 0, false);
        declareFunction(me, "_csetf_tsf_internal_constants", "_CSETF-TSF-INTERNAL-CONSTANTS", 2, 0, false);
        declareFunction(me, "_csetf_tsf_referenced_globals", "_CSETF-TSF-REFERENCED-GLOBALS", 2, 0, false);
        declareFunction(me, "_csetf_tsf_referenced_functions", "_CSETF-TSF-REFERENCED-FUNCTIONS", 2, 0, false);
        declareFunction(me, "_csetf_tsf_definitions", "_CSETF-TSF-DEFINITIONS", 2, 0, false);
        declareFunction(me, "_csetf_tsf_top_level_forms", "_CSETF-TSF-TOP-LEVEL-FORMS", 2, 0, false);
        declareFunction(me, "_csetf_tsf_defined_globals", "_CSETF-TSF-DEFINED-GLOBALS", 2, 0, false);
        declareFunction(me, "_csetf_tsf_defined_functions", "_CSETF-TSF-DEFINED-FUNCTIONS", 2, 0, false);
        declareFunction(me, "_csetf_tsf_defined_macros", "_CSETF-TSF-DEFINED-MACROS", 2, 0, false);
        declareFunction(me, "_csetf_tsf_arglist_table", "_CSETF-TSF-ARGLIST-TABLE", 2, 0, false);
        declareFunction(me, "_csetf_tsf_binding_type_table", "_CSETF-TSF-BINDING-TYPE-TABLE", 2, 0, false);
        declareFunction(me, "_csetf_tsf_method_visibility_table", "_CSETF-TSF-METHOD-VISIBILITY-TABLE", 2, 0, false);
        declareFunction(me, "_csetf_tsf_global_visibility_table", "_CSETF-TSF-GLOBAL-VISIBILITY-TABLE", 2, 0, false);
        declareFunction(me, "_csetf_tsf_rwbc_methods", "_CSETF-TSF-RWBC-METHODS", 2, 0, false);
        declareFunction(me, "make_trans_subl_file", "MAKE-TRANS-SUBL-FILE", 0, 1, false);
        declareFunction(me, "visit_defstruct_trans_subl_file", "VISIT-DEFSTRUCT-TRANS-SUBL-FILE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_trans_subl_file_method", "VISIT-DEFSTRUCT-OBJECT-TRANS-SUBL-FILE-METHOD", 2, 0, false);
        declareFunction(me, "print_trans_subl_file", "PRINT-TRANS-SUBL-FILE", 3, 0, false);
        declareFunction(me, "sxhash_trans_subl_file_method", "SXHASH-TRANS-SUBL-FILE-METHOD", 1, 0, false);
        declareFunction(me, "new_ts_file", "NEW-TS-FILE", 2, 0, false);
        declareFunction(me, "destroy_trans_subl_file", "DESTROY-TRANS-SUBL-FILE", 1, 0, false);
        declareFunction(me, "ts_file_module_name", "TS-FILE-MODULE-NAME", 1, 0, false);
        declareFunction(me, "ts_file_filename", "TS-FILE-FILENAME", 1, 0, false);
        declareFunction(me, "ts_file_definitions", "TS-FILE-DEFINITIONS", 1, 0, false);
        declareFunction(me, "ts_file_internal_constant_count", "TS-FILE-INTERNAL-CONSTANT-COUNT", 1, 0, false);
        declareFunction(me, "ts_file_next_internal_constant_id", "TS-FILE-NEXT-INTERNAL-CONSTANT-ID", 1, 0, false);
        declareFunction(me, "ts_file_internal_constants_info", "TS-FILE-INTERNAL-CONSTANTS-INFO", 1, 0, false);
        declareFunction(me, "ts_file_all_referenced_globals", "TS-FILE-ALL-REFERENCED-GLOBALS", 1, 0, false);
        declareFunction(me, "ts_file_all_defined_globals", "TS-FILE-ALL-DEFINED-GLOBALS", 1, 0, false);
        declareFunction(me, "ts_file_all_referenced_functions", "TS-FILE-ALL-REFERENCED-FUNCTIONS", 1, 0, false);
        declareFunction(me, "ts_file_all_defined_functions", "TS-FILE-ALL-DEFINED-FUNCTIONS", 1, 0, false);
        declareFunction(me, "ts_file_all_defined_private_functions", "TS-FILE-ALL-DEFINED-PRIVATE-FUNCTIONS", 1, 0, false);
        declareFunction(me, "ts_file_function_arglist", "TS-FILE-FUNCTION-ARGLIST", 2, 0, false);
        declareFunction(me, "current_ts_file_defined_function_arglist", "CURRENT-TS-FILE-DEFINED-FUNCTION-ARGLIST", 1, 0, false);
        declareFunction(me, "ts_file_defined_global_binding_type", "TS-FILE-DEFINED-GLOBAL-BINDING-TYPE", 2, 0, false);
        declareFunction(me, "ts_file_global_binding_type", "TS-FILE-GLOBAL-BINDING-TYPE", 2, 0, false);
        declareFunction(me, "current_ts_file_global_binding_type", "CURRENT-TS-FILE-GLOBAL-BINDING-TYPE", 1, 0, false);
        declareFunction(me, "ts_file_defined_method_visibility", "TS-FILE-DEFINED-METHOD-VISIBILITY", 2, 0, false);
        declareFunction(me, "ts_file_defined_private_method_p", "TS-FILE-DEFINED-PRIVATE-METHOD-P", 2, 0, false);
        declareFunction(me, "current_ts_file_defined_private_method_p", "CURRENT-TS-FILE-DEFINED-PRIVATE-METHOD-P", 1, 0, false);
        declareFunction(me, "ts_file_defined_global_visibility", "TS-FILE-DEFINED-GLOBAL-VISIBILITY", 2, 0, false);
        declareFunction(me, "ts_file_defined_private_global_p", "TS-FILE-DEFINED-PRIVATE-GLOBAL-P", 2, 0, false);
        declareFunction(me, "current_ts_file_defined_private_global_p", "CURRENT-TS-FILE-DEFINED-PRIVATE-GLOBAL-P", 1, 0, false);
        declareFunction(me, "ts_file_private_global_definition_p", "TS-FILE-PRIVATE-GLOBAL-DEFINITION-P", 2, 0, false);
        declareFunction(me, "ts_file_private_global_definitions", "TS-FILE-PRIVATE-GLOBAL-DEFINITIONS", 1, 0, false);
        declareFunction(me, "ts_file_method_returns_within_binding_constructP", "TS-FILE-METHOD-RETURNS-WITHIN-BINDING-CONSTRUCT?", 2, 0, false);
        declareFunction(me, "ts_file_internal_constant_id_lookup", "TS-FILE-INTERNAL-CONSTANT-ID-LOOKUP", 2, 0, false);
        declareFunction(me, "ts_file_note_function_definition", "TS-FILE-NOTE-FUNCTION-DEFINITION", 3, 0, false);
        declareFunction(me, "ts_file_note_macro_definition", "TS-FILE-NOTE-MACRO-DEFINITION", 3, 0, false);
        declareFunction(me, "ts_file_note_global_definition", "TS-FILE-NOTE-GLOBAL-DEFINITION", 3, 0, false);
        declareFunction(me, "ts_file_note_class_definition", "TS-FILE-NOTE-CLASS-DEFINITION", 3, 0, false);
        declareFunction(me, "ts_file_note_top_level_form", "TS-FILE-NOTE-TOP-LEVEL-FORM", 2, 0, false);
        declareMacro(me, "with_translator_output_file", "WITH-TRANSLATOR-OUTPUT-FILE");
        declareFunction(me, "possibly_delete_file", "POSSIBLY-DELETE-FILE", 1, 0, false);
        declareFunction(me, "show_trans_subl_file", "SHOW-TRANS-SUBL-FILE", 1, 1, false);
        declareFunction(me, "print_subl_expression", "PRINT-SUBL-EXPRESSION", 1, 2, false);
        declareFunction(me, "function_signature_info", "FUNCTION-SIGNATURE-INFO", 1, 0, false);
        declareFunction(me, "function_arglist_signature_info", "FUNCTION-ARGLIST-SIGNATURE-INFO", 1, 0, false);
        declareFunction(me, "tsf_possibly_convert_internal_constant", "TSF-POSSIBLY-CONVERT-INTERNAL-CONSTANT", 1, 0, false);
        declareFunction(me, "tsf_possibly_note_referenced_global", "TSF-POSSIBLY-NOTE-REFERENCED-GLOBAL", 1, 0, false);
        declareFunction(me, "tsf_possibly_note_referenced_function", "TSF-POSSIBLY-NOTE-REFERENCED-FUNCTION", 1, 0, false);
        declareFunction(me, "tsf_possibly_note_defined_function_arglist", "TSF-POSSIBLY-NOTE-DEFINED-FUNCTION-ARGLIST", 2, 0, false);
        declareFunction(me, "tsf_possibly_note_defined_global_binding_type", "TSF-POSSIBLY-NOTE-DEFINED-GLOBAL-BINDING-TYPE", 2, 0, false);
        declareFunction(me, "tsf_possibly_note_defined_method_visibility", "TSF-POSSIBLY-NOTE-DEFINED-METHOD-VISIBILITY", 2, 0, false);
        declareFunction(me, "tsf_possibly_note_defined_global_visibility", "TSF-POSSIBLY-NOTE-DEFINED-GLOBAL-VISIBILITY", 2, 0, false);
        declareFunction(me, "tsf_possibly_note_method_returns_within_binding_construct", "TSF-POSSIBLY-NOTE-METHOD-RETURNS-WITHIN-BINDING-CONSTRUCT", 1, 0, false);
        declareFunction(me, "translate_file", "TRANSLATE-FILE", 2, 0, false);
        declareFunction(me, "ts_file_translate_form", "TS-FILE-TRANSLATE-FORM", 2, 0, false);
        declareFunction(me, "handle_file_form", "HANDLE-FILE-FORM", 2, 0, false);
        declareFunction(me, "finalize_ts_file", "FINALIZE-TS-FILE", 1, 0, false);
        declareFunction(me, "ts_file_compute_initialization_methods", "TS-FILE-COMPUTE-INITIALIZATION-METHODS", 1, 0, false);
        declareFunction(me, "ts_file_declare_method", "TS-FILE-DECLARE-METHOD", 1, 0, false);
        declareFunction(me, "ts_file_init_method", "TS-FILE-INIT-METHOD", 1, 0, false);
        declareFunction(me, "ts_file_setup_method", "TS-FILE-SETUP-METHOD", 1, 0, false);
        declareFunction(me, "current_ts_file_initializerP", "CURRENT-TS-FILE-INITIALIZER?", 1, 0, false);
        declareFunction(me, "translate_constant_initialization_form", "TRANSLATE-CONSTANT-INITIALIZATION-FORM", 1, 0, false);
        declareFunction(me, "translator_symbol_for_function", "TRANSLATOR-SYMBOL-FOR-FUNCTION", 1, 0, false);
        declareFunction(me, "predefined_constant_p", "PREDEFINED-CONSTANT-P", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $trans_subl_file_native extends SubLStructNative {
        ...
        public $trans_subl_file_native() {
            ...
            this.$internal_constants = Lisp.NIL;
            this.$referenced_globals = Lisp.NIL;
            this.$referenced_functions = Lisp.NIL;
            this.$definitions = Lisp.NIL;
            this.$top_level_forms = Lisp.NIL;
            this.$defined_globals = Lisp.NIL;
            this.$defined_functions = Lisp.NIL;
            this.$defined_macros = Lisp.NIL;
            this.$arglist_table = Lisp.NIL;
            this.$binding_type_table = Lisp.NIL;
            this.$method_visibility_table = Lisp.NIL;
            this.$global_visibility_table = Lisp.NIL;
            this.$rwbc_methods = Lisp.NIL;
        }
