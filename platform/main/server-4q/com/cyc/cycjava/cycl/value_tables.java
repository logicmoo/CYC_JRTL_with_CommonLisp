...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class value_tables extends SubLTranslatedFile {
    ...
    public static SubLObject value_table_column_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$value_table_column_native.class ? T : NIL;
    }

    public static SubLObject value_table_column_query(final SubLObject v_object) {
        assert NIL != value_table_column_p(v_object) : "value_tables.value_table_column_p error :" + v_object;
    ...
    public static SubLObject value_table_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$value_table_native.class ? T : NIL;
    }

    public static SubLObject value_table_id(final SubLObject v_object) {
        assert NIL != value_table_p(v_object) : "value_tables.value_table_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject variable_mapping_table_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$variable_mapping_table_native.class ? T : NIL;
    }

    public static SubLObject variable_mapping_table_id(final SubLObject v_object) {
        assert NIL != variable_mapping_table_p(v_object) : "value_tables.variable_mapping_table_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $value_table_column_native extends SubLStructNative {
        ...
        private $value_table_column_native() {
            this.$query = Lisp.NIL;
            this.$label = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative($value_table_column_native.class, VALUE_TABLE_COLUMN, VALUE_TABLE_COLUMN_P, $list2, $list3, new String[]{ "$query", "$label", "$values" }, $list4, $list5, PRINT_VALUE_TABLE_COLUMN);
        }
    }
    ...
    public static final class $value_table_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($value_table_native.class, VALUE_TABLE, VALUE_TABLE_P, $list39, $list40, new String[]{ "$id", "$label", "$input_columns", "$output_column", "$assignments" }, $list41, $list42, PRINT_VALUE_TABLE);
        }
    }
    ...
    public static final class $variable_mapping_table_native extends SubLStructNative {
        ...
        private $variable_mapping_table_native() {
            this.$id = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative($variable_mapping_table_native.class, VARIABLE_MAPPING_TABLE, VARIABLE_MAPPING_TABLE_P, $list95, $list96, new String[]{ "$id", "$source_query", "$target_query", "$source_variables", "$target_variables", "$incompatibles", "$assignments" }, $list97, $list98, PRINT_VARMAP_TABLE);
        }
    }
