...
import static com.cyc.cycjava.cycl.api_widgets.*;
...
public final class api_widgets extends SubLTranslatedFile {
    ...
    private static final SubLList $list436 = list(reader_make_constant_shell(makeString("elementOf")), makeSymbol("?Y"), list(new SubLObject[]{ reader_make_constant_shell(makeString("TheSet")), reader_make_constant_shell(makeString("performedBy")), reader_make_constant_shell(makeString("hasMembers")), reader_make_constant_shell(makeString("affiliatedWith")), reader_make_constant_shell(makeString("relatives")), reader_make_constant_shell(makeString("teacherOf")), reader_make_constant_shell(makeString("religiousTeacherOf")), reader_make_constant_shell(makeString("actors")), reader_make_constant_shell(makeString("linked")), reader_make_constant_shell(makeString("stagesEvent")), reader_make_constant_shell(makeString("hasLeaders")) }));
    ...
    private static final SubLList $list497 = list(list(list(list(reader_make_constant_shell(makeString("TKBTemplate-Individual")), reader_make_constant_shell(makeString("TKB-GKE-TestMt")), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt"))), list(list(reader_make_constant_shell(makeString("temporallySubsumes")), list(reader_make_constant_shell(makeString("SomeTimeInIntervalFn")), list(reader_make_constant_shell(makeString("DecadeFn")), makeInteger(199)), makeString("e235fd00-10a4-41d9-8612-85cd130d8ba6")), makeSymbol("?DATE0")), list(reader_make_constant_shell(makeString("ist-Intermediate")), list(reader_make_constant_shell(makeString("MtSpace")), list(reader_make_constant_shell(makeString("The")), reader_make_constant_shell(makeString("Microtheory"))), list(reader_make_constant_shell(makeString("MtTimeWithGranularityDimFn")), makeSymbol("?DATE0"), reader_make_constant_shell(makeString("TimePoint")))), list(reader_make_constant_shell(makeString("objectFoundInLocation")), makeSymbol("?X"), reader_make_constant_shell(makeString("ContinentOfEurope"))))), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))), list(reader_make_constant_shell(makeString("Terrorist-Fawwaz"))), makeInteger(14564)), T));
    ...
    private static final SubLList $list501 = list(new SubLObject[]{ list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("HumanNameString"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), makeString("bin Laden")), T), list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("ProperNameString"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), makeString("bin Laden")), T), list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("Person"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("Lenat"))), T), list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("TimeInterval"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2002))), T), list(list(list(reader_make_constant_shell(makeString("quotedIsa")), makeKeyword("X"), reader_make_constant_shell(makeString("CycLIndexedTerm"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("isa"))), T), list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("NonNegativeScalarInterval"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), list(reader_make_constant_shell(makeString("Meter")), TWO_INTEGER)), T), list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("Date"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1997))), T), list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("HumanNameString"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("Thing"))), NIL), list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("ProperNameString"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), FOUR_INTEGER), NIL), list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("Person"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("PlanetEarth"))), NIL), list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("Date"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), makeInteger(1997)), NIL), list(list(list(reader_make_constant_shell(makeString("isa")), makeKeyword("X"), reader_make_constant_shell(makeString("NonNegativeScalarInterval"))), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), makeInteger(-2)), NIL) });



    private static final SubLSymbol TEST_CONSTRAINED_CYCL_FILTER = makeSymbol("TEST-CONSTRAINED-CYCL-FILTER");

    private static final SubLList $list504 = list(new SubLObject[]{ list(list(list(NIL, NIL, reader_make_constant_shell(makeString("Penguin")), reader_make_constant_shell(makeString("CyclistsMt")), makeSymbol("FILTER-CONSTRAINED-CYCLS")), list(reader_make_constant_shell(makeString("Aramil")))), NIL), list(list(list(NIL, NIL, reader_make_constant_shell(makeString("Penguin")), reader_make_constant_shell(makeString("CyclistsMt")), makeSymbol("FILTER-CONSTRAINED-CYCLS")), list(reader_make_constant_shell(makeString("Pizza")))), NIL), list(list(list(NIL, NIL, reader_make_constant_shell(makeString("PersonTypeByOccupation")), reader_make_constant_shell(makeString("CyclistsMt")), makeSymbol("FILTER-CONSTRAINED-CYCLS")), list(reader_make_constant_shell(makeString("PostageStamp")))), NIL), list(list(list(NIL, NIL, list(reader_make_constant_shell(makeString("SpecsFn")), reader_make_constant_shell(makeString("Person"))), reader_make_constant_shell(makeString("CyclistsMt")), makeSymbol("FILTER-CONSTRAINED-CYCLS")), list(reader_make_constant_shell(makeString("HumanCyclist")))), list(reader_make_constant_shell(makeString("HumanCyclist")))), list(list(list(NIL, NIL, list(reader_make_constant_shell(makeString("SpecsFn")), reader_make_constant_shell(makeString("Person"))), reader_make_constant_shell(makeString("CyclistsMt")), makeSymbol("FILTER-CONSTRAINED-CYCLS")), list(reader_make_constant_shell(makeString("HumanCyclist")), reader_make_constant_shell(makeString("Pizza")))), list(reader_make_constant_shell(makeString("HumanCyclist")))), list(list(list(list(reader_make_constant_shell(makeString("genlMt")), makeSymbol("?X"), reader_make_constant_shell(makeString("BaseKB"))), list(ONE_INTEGER), reader_make_constant_shell(makeString("PersonTypeByOccupation")), reader_make_constant_shell(makeString("CyclistsMt")), makeSymbol("FILTER-CONSTRAINED-CYCLS")), list(reader_make_constant_shell(makeString("Plumber")))), NIL), list(list(list(list(reader_make_constant_shell(makeString("genlMt")), makeSymbol("?X"), reader_make_constant_shell(makeString("BaseKB"))), list(ONE_INTEGER), NIL, reader_make_constant_shell(makeString("CyclistsMt")), makeSymbol("FILTER-CONSTRAINED-CYCLS")), list(makeInteger(2000))), NIL), list(list(list(list(reader_make_constant_shell(makeString("genlMt")), makeSymbol("?X"), reader_make_constant_shell(makeString("BaseKB"))), list(ONE_INTEGER), NIL, reader_make_constant_shell(makeString("CyclistsMt")), makeSymbol("FILTER-CONSTRAINED-CYCLS")), list(reader_make_constant_shell(makeString("Plumber")))), NIL), list(list(list(list(reader_make_constant_shell(makeString("genlMt")), makeSymbol("?X"), reader_make_constant_shell(makeString("BaseKB"))), list(ONE_INTEGER), NIL, reader_make_constant_shell(makeString("CyclistsMt")), makeSymbol("FILTER-CONSTRAINED-CYCLS")), list(reader_make_constant_shell(makeString("CyclistsMt")))), list(reader_make_constant_shell(makeString("CyclistsMt")))) });
    ...
    private static final SubLList $list512 = list(list(list(list(new SubLObject[]{ makeString("around 10:01 eastern time"), reader_make_constant_shell(makeString("TimeInterval")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("TerrorismParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T, NIL, T, makeKeyword("NONE"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("nonPlural-Generic")))), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))), TEN_INTEGER })), ONE_INTEGER), list(list(list(new SubLObject[]{ makeString("mutual support"), list(makeSymbol("CANONICALIZE-TERM"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("SpecsFn")), reader_make_constant_shell(makeString("InterAgentSupportQuantity"))))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("TerrorismParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T, NIL, T, makeKeyword("NONE"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("nonPlural-Generic")))), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))), TEN_INTEGER })), ONE_INTEGER));
    ...
    private static final SubLList $list517 = list(list(list(reader_make_constant_shell(makeString("Collection")), reader_make_constant_shell(makeString("EverythingPSC")), T, makeInteger(100), ZERO_INTEGER, T), list(makeInteger(100), makeInteger(100))), list(list(reader_make_constant_shell(makeString("Zebra")), reader_make_constant_shell(makeString("EverythingPSC")), T, makeInteger(100), ZERO_INTEGER, T), list(FIVE_INTEGER, TWENTY_INTEGER)), list(list(reader_make_constant_shell(makeString("PlainsZebra")), reader_make_constant_shell(makeString("EverythingPSC")), T, makeInteger(100), ZERO_INTEGER, T), list(ZERO_INTEGER, ZERO_INTEGER)));

    private static final SubLList $list518 = list(list(list(reader_make_constant_shell(makeString("Collection")), reader_make_constant_shell(makeString("EverythingPSC")), NIL, makeInteger(100), ZERO_INTEGER, T), list(ONE_INTEGER, TWENTY_INTEGER)), list(list(reader_make_constant_shell(makeString("Zebra")), reader_make_constant_shell(makeString("EverythingPSC")), NIL, makeInteger(250), ZERO_INTEGER, T), list(makeInteger(50), makeInteger(150))), list(list(reader_make_constant_shell(makeString("PlainsZebra")), reader_make_constant_shell(makeString("EverythingPSC")), T, makeInteger(100), ZERO_INTEGER, T), list(ONE_INTEGER, ONE_INTEGER)));

    private static final SubLList $list519 = list(list(list(reader_make_constant_shell(makeString("Collection")), reader_make_constant_shell(makeString("EverythingPSC")), NIL, makeInteger(100), ZERO_INTEGER, T), list(makeInteger(100), makeInteger(100))), list(list(reader_make_constant_shell(makeString("Dog")), reader_make_constant_shell(makeString("EverythingPSC")), T, makeInteger(100), ZERO_INTEGER, T), list(FOUR_INTEGER, makeInteger(50))));
    ...
    public static SubLObject foo_p(final SubLObject v_object) {
        return v_object.getClass() == api_widgets.$foo_native.class ? T : NIL;
    }

    public static SubLObject foo_bar(final SubLObject v_object) {
        assert NIL != foo_p(v_object) : "api_widgets.foo_p(v_object) " + "CommonSymbols.NIL != api_widgets.foo_p(v_object) " + v_object;
    ...
    public static SubLObject make_foo(SubLObject arglist) {
        ...
        final SubLObject v_new = new api_widgets.$foo_native();
        SubLObject next;
                ...
                try {
                    ...
                    try {
                        ...
                        if (NIL != string_specP(constraining_collection)) {
                            ...
                            if ((NIL == string_utilities.string_contains_constant_reader_prefix_p(str)) || (NIL == result)) {
                                                                                ...
                                                                                try {
                                                                                    ...
                                                                                    if (NIL != sbhl_link_vars.sbhl_node_object_p(node)) {
                                                                                        ...
                                                                                        if (NIL != obsolete.cnat_p(node, UNPROVIDED)) {
                                                                                            ...
                                                                                            final SubLObject new_list = cdolist_list_var_$100 = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? list_utilities.randomize_list(sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators(sbhl_module_utilities.get_sbhl_module_backward_direction(sbhl_module_vars.get_sbhl_module($$isa)), sbhl_search_vars.$sbhl_tv$.getDynamicValue(thread), sbhl_module_vars.get_sbhl_module(UNPROVIDED))) : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators(sbhl_module_utilities.get_sbhl_module_backward_direction(sbhl_module_vars.get_sbhl_module($$isa)), sbhl_search_vars.$sbhl_tv$.getDynamicValue(thread), sbhl_module_vars.get_sbhl_module(UNPROVIDED));
                                                                                        ...
                                                                                        try {
                                                                                            ...
                                                                                            if (NIL != sbhl_link_vars.sbhl_node_object_p(node)) {
                                                                                                ...
                                                                                                if (NIL != obsolete.cnat_p(node, UNPROVIDED)) {
                                                                                                    ...
                                                                                                    final SubLObject new_list = cdolist_list_var_$148 = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? list_utilities.randomize_list(sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators(sbhl_module_utilities.get_sbhl_module_backward_direction(sbhl_module_vars.get_sbhl_module($$isa)), sbhl_search_vars.$sbhl_tv$.getDynamicValue(thread), sbhl_module_vars.get_sbhl_module(UNPROVIDED))) : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators(sbhl_module_utilities.get_sbhl_module_backward_direction(sbhl_module_vars.get_sbhl_module($$isa)), sbhl_search_vars.$sbhl_tv$.getDynamicValue(thread), sbhl_module_vars.get_sbhl_module(UNPROVIDED));
                                                                                                    SubLObject generating_fn = NIL;
                                                                                        ...
                                                                                        try {
                                                                                            ...
                                                                                            if (NIL != sbhl_link_vars.sbhl_node_object_p(node2)) {
                                                                                                ...
                                                                                                if (NIL != obsolete.cnat_p(node2, UNPROVIDED)) {
                                                                                                    ...
                                                                                                    final SubLObject new_list2 = cdolist_list_var_$149 = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? list_utilities.randomize_list(sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators(sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue(thread), sbhl_module_vars.get_sbhl_module(UNPROVIDED))) : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators(sbhl_link_vars.get_sbhl_link_direction(), sbhl_search_vars.$sbhl_tv$.getDynamicValue(thread), sbhl_module_vars.get_sbhl_module(UNPROVIDED));
                                                                                                    SubLObject generating_fn2 = NIL;
        ...
        for (rest = NIL, rest = Sort.sort(nl_trie_completion.nl_trie_completions(prefix, UNPROVIDED), symbol_function(STRING_LESSP), UNPROVIDED); (NIL == max_limitP) && (NIL != rest); rest = rest.rest()) {
            ...
            for (doneP = NIL, rest_$174 = NIL, rest_$174 = nl_trie.nl_trie_search(string, UNPROVIDED, UNPROVIDED); (NIL == doneP) && (NIL != rest_$174); rest_$174 = rest_$174.rest()) {
                ...
                if (NIL != list_utilities.non_empty_list_p(pref_denots)) {
                    ...
                    if (NIL != list_utilities.non_empty_list_p(nl_trie.nl_trie_entry_denots(nl_trie_entry))) {
                        entry_to_push = nl_trie_entry;
                    }
    ...
    public static SubLObject process_feedback(final SubLObject mt, final SubLObject severity, final SubLObject comment, final SubLObject reason, final SubLObject logblock, final SubLObject component, final SubLObject query, final SubLObject query_formula, final SubLObject query_string, final SubLObject binding_list) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        if (((((((((((NIL == fort_types_interface.mtP(mt)) || (NIL == fi.ke_purpose())) || (NIL == cycl_grammar.cycl_constant_p(severity))) || (!comment.isString())) || (!reason.isString())) || (NIL == cycl_grammar.cycl_constant_p(component))) || (!logblock.isString())) || (NIL == collection_defns.cycl_formulaP(query_formula))) || (NIL == collection_defns.cycl_formulaP(query))) || (!query_string.isString())) || (!binding_list.isList())) {
            return NIL;
        }
                                                            ...
                                                            try {
                                                                ...
                                                                if (NIL != sbhl_link_vars.sbhl_node_object_p(node)) {
                                                                    ...
                                                                    if (NIL != obsolete.cnat_p(node, UNPROVIDED)) {
                                                                        ...
                                                                        final SubLObject new_list = cdolist_list_var_$248 = (NIL != sbhl_link_vars.sbhl_randomize_lists_p()) ? list_utilities.randomize_list(sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators(sbhl_module_utilities.get_sbhl_module_backward_direction(sbhl_module_vars.get_sbhl_module($$isa)), sbhl_search_vars.$sbhl_tv$.getDynamicValue(thread), sbhl_module_vars.get_sbhl_module(UNPROVIDED))) : sbhl_module_utilities.get_sbhl_module_relevant_naut_link_generators(sbhl_module_utilities.get_sbhl_module_backward_direction(sbhl_module_vars.get_sbhl_module($$isa)), sbhl_search_vars.$sbhl_tv$.getDynamicValue(thread), sbhl_module_vars.get_sbhl_module(UNPROVIDED));
                                                                        SubLObject generating_fn = NIL;
    ...
    private static SubLObject _constant_508_initializer() {
        return list(new SubLObject[]{ list(list(list(makeString("Ordizia, Spain"), reader_make_constant_shell(makeString("GeographicalRegion")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), list(reader_make_constant_shell(makeString("CityNamedFn")), makeString("Ordizia"), reader_make_constant_shell(makeString("Spain"))), makeInteger(13870)), T), list(list(list(new SubLObject[]{ makeString("Hezbollah"), reader_make_constant_shell(makeString("TerroristGroup")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T, NIL, T, makeKeyword("NONE"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("nonPlural-Generic")))), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), reader_make_constant_shell(makeString("LebaneseHizballah")), makeKeyword("NOT-A-BUG")), T), list(list(list(makeString("#$BananaTree"), reader_make_constant_shell(makeString("Thing")), reader_make_constant_shell(makeString("InferencePSC"))), reader_make_constant_shell(makeString("BananaTree")), makeKeyword("NOT-A-BUG")), T), list(list(list(makeString("Israeli army"), reader_make_constant_shell(makeString("Agent-PartiallyTangible")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), list(reader_make_constant_shell(makeString("ArmyFn")), reader_make_constant_shell(makeString("Israel"))), makeInteger(13667)), T), list(list(list(new SubLObject[]{ makeString("tomatoes"), list(makeSymbol("CANONICALIZE-TERM"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("SpecsFn")), reader_make_constant_shell(makeString("HighExplosive"))))), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt"))), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("TerrorismParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt"))), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt"))), T, NIL, T, makeKeyword("NONE"), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("nonPlural-Generic"))), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), list(reader_make_constant_shell(makeString("ProperSubcollectionNamedFn-Ternary")), makeString("tomatoes"), reader_make_constant_shell(makeString("HighExplosive")), makeString("53c4c132-f1e1-11da-88f0-0002b3a85b0b")), makeInteger(19137)), T), list(list(list(new SubLObject[]{ makeString("3"), reader_make_constant_shell(makeString("Thing")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("TerrorismParaphraseMt")), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt"))), T, T, T, makeKeyword("NONE"), makeKeyword("DEFAULT"), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("thereExists")), list(makeSymbol("QUOTE"), makeSymbol("?NUM")), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("and")), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("greaterThan")), list(makeSymbol("QUOTE"), makeSymbol("?NUM")), ZERO_INTEGER), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("relationInstanceExists")), reader_make_constant_shell(makeString("intendedAttackTargets")), list(makeSymbol("QUOTE"), makeSymbol("?ATTACK")), reader_make_constant_shell(makeString("RestaurantSpace"))), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("dateOfEvent")), list(makeSymbol("QUOTE"), makeSymbol("?ATTACK")), list(makeSymbol("CANONICALIZE-TERM"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("DecadeFn")), makeInteger(199))))), list(makeSymbol("LIST"), reader_make_constant_shell(makeString("relationInstanceExistsCount")), reader_make_constant_shell(makeString("animalWoundedIn")), list(makeSymbol("QUOTE"), makeSymbol("?ATTACK")), reader_make_constant_shell(makeString("Person")), list(makeSymbol("QUOTE"), makeSymbol("?NUM"))))), list(makeSymbol("LIST"), TWO_INTEGER, ONE_INTEGER, TWO_INTEGER), list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), THREE_INTEGER, makeInteger(17698)), T), list(list(list(makeString("Austin, TX"), reader_make_constant_shell(makeString("Place")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), reader_make_constant_shell(makeString("CityOfAustinTX")), makeInteger(11675)), T), list(list(list(makeString("the mid 1980s"), reader_make_constant_shell(makeString("TemporalThing")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("EnglishMt")), T), list(reader_make_constant_shell(makeString("MiddlePartFn")), list(reader_make_constant_shell(makeString("DecadeFn")), makeInteger(198))), makeInteger(11969)), T), list(list(list(makeString("and"), reader_make_constant_shell(makeString("Thing")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("EnglishMt")), T), reader_make_constant_shell(makeString("and")), makeInteger(17645)), T), list(list(list(makeString("#$and"), reader_make_constant_shell(makeString("Thing")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("EnglishMt")), T), reader_make_constant_shell(makeString("and")), makeInteger(17645)), T), list(list(list(makeString("late October 1980"), reader_make_constant_shell(makeString("TemporalThing")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("EnglishMt")), T), list(reader_make_constant_shell(makeString("LatePartFn")), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("October")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1980)))), makeInteger(11969)), T), list(list(list(makeString("2001"), reader_make_constant_shell(makeString("TemporalThing")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("EnglishMt")), T), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2001)), makeInteger(11972)), T), list(list(list(makeString("between 1973 and 1988"), reader_make_constant_shell(makeString("TemporalThing")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), list(reader_make_constant_shell(makeString("TimeIntervalInclusiveFn")), list(reader_make_constant_shell(makeString("SomeTimeInIntervalFn")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1973)), makeKeyword("GUID-STRING")), list(reader_make_constant_shell(makeString("SomeTimeInIntervalFn")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1988)), makeKeyword("GUID-STRING"))), makeInteger(12047)), T), list(list(list(makeString("$2"), reader_make_constant_shell(makeString("MonetaryValue")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), list(reader_make_constant_shell(makeString("Dollar-UnitedStates")), TWO_INTEGER), makeInteger(15954)), T), list(list(list(makeString("between 7 and 10"), reader_make_constant_shell(makeString("NonNegativeIntegerRange")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), list(reader_make_constant_shell(makeString("IntervalRangeFn")), SEVEN_INTEGER, TEN_INTEGER), makeInteger(12348)), T), list(list(list(makeString("Western Europe"), reader_make_constant_shell(makeString("GeographicalRegion")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), reader_make_constant_shell(makeString("WesternEurope")), makeInteger(12367)), T), list(list(list(makeString("Western Congo-Kinshasa"), reader_make_constant_shell(makeString("GeographicalRegion")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), list(reader_make_constant_shell(makeString("WesternRegionFn")), reader_make_constant_shell(makeString("DemocraticRepublicOfTheCongo"))), makeInteger(14356)), T), list(list(list(makeString("Israel"), reader_make_constant_shell(makeString("IndependentCountry")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), reader_make_constant_shell(makeString("Israel")), makeInteger(12377)), T), list(list(list(new SubLObject[]{ makeString("from early 1997 to the end of January 2004"), reader_make_constant_shell(makeString("TimeInterval")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T, NIL, T, makeKeyword("NONE"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("nonPlural-Generic")))), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("TRUE"))) }), list(reader_make_constant_shell(makeString("TimeIntervalInclusiveFn")), list(reader_make_constant_shell(makeString("SomeTimeInIntervalFn")), list(reader_make_constant_shell(makeString("EarlyPartFn")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1997))), makeString("506fa613-a8de-11d8-8d30-0002b3a84f94")), list(reader_make_constant_shell(makeString("SomeTimeInIntervalFn")), list(reader_make_constant_shell(makeString("EndingIntervalFn")), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("January")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2004)))), makeString("506fa614-a8de-11d8-8d30-0002b3a84f94"))), makeInteger(12404)), T), list(list(list(makeString("separatist organization"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("SpecsFn")), reader_make_constant_shell(makeString("PoliticalOrganization")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), reader_make_constant_shell(makeString("SeparatistOrganization")), makeInteger(12425)), T), list(list(list(makeString("CA"), reader_make_constant_shell(makeString("Place")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), reader_make_constant_shell(makeString("California-State")), makeInteger(12438)), T), list(list(list(makeString("arson"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("SpecsFn")), reader_make_constant_shell(makeString("ActionOnObject")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), reader_make_constant_shell(makeString("Arson")), makeInteger(12479)), T), list(list(list(makeString("10 kilos"), reader_make_constant_shell(makeString("MassOrSpatialQuantity")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), list(reader_make_constant_shell(makeString("Kilogram")), TEN_INTEGER), makeInteger(12488)), T), list(list(list(makeString("10 pounds"), reader_make_constant_shell(makeString("MassOrSpatialQuantity")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T), list(reader_make_constant_shell(makeString("Pound-UnitOfMass")), TEN_INTEGER), makeInteger(12503)), T), list(list(list(new SubLObject[]{ makeString("approx 1000"), reader_make_constant_shell(makeString("NonNegativeIntegerRange")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T, NIL, T, makeKeyword("NONE"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("nonPlural-Generic")))), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), list(reader_make_constant_shell(makeString("ApproximatelyFn")), makeInteger(1000)), makeInteger(12588)), T), list(list(list(new SubLObject[]{ makeString("Greater than 9"), reader_make_constant_shell(makeString("NonNegativeIntegerRange")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T, NIL, T, makeKeyword("NONE"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("nonPlural-Generic")))), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), list(reader_make_constant_shell(makeString("IntervalOfTypeMinFn")), reader_make_constant_shell(makeString("NonNegativeInteger")), TEN_INTEGER), makeInteger(12713)), T), list(list(list(new SubLObject[]{ makeString("over 9"), reader_make_constant_shell(makeString("NonNegativeIntegerRange")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T, NIL, T, makeKeyword("NONE"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("nonPlural-Generic")))), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), list(reader_make_constant_shell(makeString("IntervalOfTypeMinFn")), reader_make_constant_shell(makeString("NonNegativeInteger")), TEN_INTEGER), makeInteger(12713)), T), list(list(list(new SubLObject[]{ makeString("fewer than 9"), reader_make_constant_shell(makeString("NonNegativeIntegerRange")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T, NIL, T, makeKeyword("NONE"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("nonPlural-Generic")))), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), list(reader_make_constant_shell(makeString("IntervalOfTypeMaxFn")), reader_make_constant_shell(makeString("NonNegativeInteger")), EIGHT_INTEGER), makeInteger(12713)), T), list(list(list(new SubLObject[]{ makeString("under 9"), reader_make_constant_shell(makeString("NonNegativeIntegerRange")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")))), T, NIL, T, makeKeyword("NONE"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("nonPlural-Generic")))), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), list(reader_make_constant_shell(makeString("IntervalOfTypeMaxFn")), reader_make_constant_shell(makeString("NonNegativeInteger")), EIGHT_INTEGER), makeInteger(12713)), T), list(list(list(new SubLObject[]{ makeString("sudan's government"), reader_make_constant_shell(makeString("Thing")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("TerrorismParaphraseMt")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")))), T, NIL, T, makeKeyword("NONE"), makeKeyword("DEFAULT"), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), list(reader_make_constant_shell(makeString("GovernmentFn")), reader_make_constant_shell(makeString("Sudan"))), makeInteger(21749)), T), list(list(list(new SubLObject[]{ makeString("government of Sudan"), reader_make_constant_shell(makeString("Thing")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("TerrorismParaphraseMt")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")))), T, NIL, T, makeKeyword("NONE"), makeKeyword("DEFAULT"), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), list(reader_make_constant_shell(makeString("GovernmentFn")), reader_make_constant_shell(makeString("Sudan"))), makeInteger(21749)), T), list(list(list(new SubLObject[]{ makeString("the government of Sudan"), reader_make_constant_shell(makeString("Thing")), reader_make_constant_shell(makeString("TKBSourceSpindleCollectorMt")), reader_make_constant_shell(makeString("TerrorismParaphraseMt")), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("MtUnionFn")), reader_make_constant_shell(makeString("EnglishMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")))), T, NIL, T, makeKeyword("NONE"), makeKeyword("DEFAULT"), NIL, NIL, list(makeSymbol("QUOTE"), list(makeKeyword("CASE-INSENSITIVE"), makeKeyword("TRUE"), makeKeyword("REGULAR-EXPRESSIONS"), makeKeyword("FALSE"))) }), list(reader_make_constant_shell(makeString("GovernmentFn")), reader_make_constant_shell(makeString("Sudan"))), makeInteger(21749)), T) });
    }
    ...
    public static final class $foo_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(api_widgets.$foo_native.class, FOO, FOO_P, $list2, $list3, new String[]{ "$bar" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
