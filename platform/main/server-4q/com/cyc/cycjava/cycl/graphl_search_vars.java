...
import static com.cyc.cycjava.cycl.graphl_search_vars.*;
...
public final class graphl_search_vars extends SubLTranslatedFile {
    ...
    public static SubLObject graphl_search_p(final SubLObject v_object) {
        return v_object.getClass() == graphl_search_vars.$graphl_search_native.class ? T : NIL;
    }

    public static SubLObject graphl_search_type(final SubLObject v_object) {
        assert NIL != graphl_search_p(v_object) : "graphl_search_vars.graphl_search_p(v_object) " + "CommonSymbols.NIL != graphl_search_vars.graphl_search_p(v_object) " + v_object;
    ...
    public static SubLObject make_graphl_search(SubLObject arglist) {
        ...
        final SubLObject v_new = new graphl_search_vars.$graphl_search_native();
        SubLObject next;
    ...
    public static final class $graphl_search_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(graphl_search_vars.$graphl_search_native.class, GRAPHL_SEARCH, GRAPHL_SEARCH_P, $list2, $list3, new String[]{ "$type", "$order", "$cutoff", "$marking", "$marking_space", "$goal_space", "$goal", "$goal_fn", "$goal_found_p", "$satisfy_fn", "$map_fn", "$justifyP", "$add_to_resultP", "$unwind_fn_toggle", "$result", "$graph" }, $list4, $list5, PRINT_GRAPHL_SEARCH);
        }
    }
