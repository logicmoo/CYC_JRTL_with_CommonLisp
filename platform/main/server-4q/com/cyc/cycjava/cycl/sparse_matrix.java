...
import com.cyc.cycjava.cycl.sparse_matrix;
...
import static com.cyc.cycjava.cycl.sparse_matrix.*;
...
public final class sparse_matrix extends SubLTranslatedFile {
    ...
    public static SubLObject sparse_matrix_p(final SubLObject v_object) {
        return v_object.getClass() == sparse_matrix.$sparse_matrix_native.class ? T : NIL;
    }

    public static SubLObject smatrix_rows(final SubLObject v_object) {
        assert NIL != sparse_matrix_p(v_object) : "sparse_matrix.sparse_matrix_p(v_object) " + "CommonSymbols.NIL != sparse_matrix.sparse_matrix_p(v_object) " + v_object;
    ...
    public static SubLObject make_sparse_matrix(SubLObject arglist) {
        ...
        final SubLObject v_new = new sparse_matrix.$sparse_matrix_native();
        SubLObject next;
    ...
    public static final class $sparse_matrix_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sparse_matrix.$sparse_matrix_native.class, SPARSE_MATRIX, SPARSE_MATRIX_P, $list2, $list3, new String[]{ "$rows", "$columns" }, $list4, $list5, SMATRIX_PRINT);
        }
    }
