...
import com.cyc.cycjava.cycl.multibindings;
...
import static com.cyc.cycjava.cycl.multibindings.*;
...
public final class multibindings extends SubLTranslatedFile {
    ...
    public static SubLObject print_multibinding(final SubLObject v_object, final SubLObject stream, final SubLObject depth) {
        assert NIL != multibinding_p(v_object) : "multibindings.multibinding_p(v_object) " + "CommonSymbols.NIL != multibindings.multibinding_p(v_object) " + v_object;
    ...
    public static SubLObject mbinding_p(final SubLObject v_object) {
        return v_object.getClass() == multibindings.$mbinding_native.class ? T : NIL;
    }

    public static SubLObject mb_multi_var_term_map(final SubLObject v_object) {
        assert NIL != mbinding_p(v_object) : "multibindings.mbinding_p(v_object) " + "CommonSymbols.NIL != multibindings.mbinding_p(v_object) " + v_object;
    ...
    public static SubLObject make_mbinding(SubLObject arglist) {
        ...
        final SubLObject v_new = new multibindings.$mbinding_native();
        SubLObject next;
    ...
    public static final class $mbinding_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(multibindings.$mbinding_native.class, MBINDING, MBINDING_P, $list15, $list16, new String[]{ "$multi_var_term_map", "$simple_var_term_map", "$degenerateP" }, $list17, $list18, PRINT_MB);
        }
    }
