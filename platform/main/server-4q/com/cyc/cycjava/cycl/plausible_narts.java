...
import static com.cyc.cycjava.cycl.plausible_narts.*;
...
public final class plausible_narts extends SubLTranslatedFile {
    ...
    public static SubLObject declare_plausible_narts_file() {
        declareFunction(me, "default_plausubility_justification", "DEFAULT-PLAUSUBILITY-JUSTIFICATION", 2, 0, false);
        declareFunction(me, "plausibility_of_sentence", "PLAUSIBILITY-OF-SENTENCE", 1, 2, false);
        declareFunction(me, "handle_arbitrary_expression", "HANDLE-ARBITRARY-EXPRESSION", 1, 2, false);
        declareFunction(me, "find_plausibility_of_collection", "FIND-PLAUSIBILITY-OF-COLLECTION", 1, 2, false);
        declareFunction(me, "handle_nested_nart", "HANDLE-NESTED-NART", 1, 2, false);
        declareFunction(me, "find_plausibility_of_sentences", "FIND-PLAUSIBILITY-OF-SENTENCES", 1, 2, false);
        declareFunction(me, "combine_plausibility_scores", "COMBINE-PLAUSIBILITY-SCORES", 1, 0, false);
        declareFunction(me, "assess_plausibility_of_sentence", "ASSESS-PLAUSIBILITY-OF-SENTENCE", 4, 0, false);
        declareFunction(me, "assess_plausibility_of_isa_sentence", "ASSESS-PLAUSIBILITY-OF-ISA-SENTENCE", 4, 0, false);
        declareFunction(me, "assess_plausibility_of_binary_predicate", "ASSESS-PLAUSIBILITY-OF-BINARY-PREDICATE", 4, 0, false);
        declareFunction(me, "handle_plausibility_of_binary_predicate_types_ins", "HANDLE-PLAUSIBILITY-OF-BINARY-PREDICATE-TYPES-INS", 5, 0, false);
        declareFunction(me, "handle_plausibility_of_binary_predicate_ins_types", "HANDLE-PLAUSIBILITY-OF-BINARY-PREDICATE-INS-TYPES", 5, 0, false);
        declareFunction(me, "handle_plausibility_of_binary_predicate_types_types", "HANDLE-PLAUSIBILITY-OF-BINARY-PREDICATE-TYPES-TYPES", 5, 0, false);
        declareFunction(me, "assess_plausibility_of_relation_instance_exists", "ASSESS-PLAUSIBILITY-OF-RELATION-INSTANCE-EXISTS", 4, 0, false);
        declareFunction(me, "assess_plausibility_of_collections", "ASSESS-PLAUSIBILITY-OF-COLLECTIONS", 5, 0, false);
        declareFunction(me, "gather_collections_for_variable", "GATHER-COLLECTIONS-FOR-VARIABLE", 2, 0, false);
        declareFunction(me, "handle_simple_nart", "HANDLE-SIMPLE-NART", 3, 0, false);
        declareFunction(me, "get_plausibility_of_binary_predicate_type_type", "GET-PLAUSIBILITY-OF-BINARY-PREDICATE-TYPE-TYPE", 5, 0, false);
        declareFunction(me, "get_plausibility_of_binary_predicate_type_ins", "GET-PLAUSIBILITY-OF-BINARY-PREDICATE-TYPE-INS", 5, 0, false);
        declareFunction(me, "handle_composite_activity_fn", "HANDLE-COMPOSITE-ACTIVITY-FN", 3, 0, false);
        declareFunction(me, "handle_collection_intersection_2_fn", "HANDLE-COLLECTION-INTERSECTION-2-FN", 3, 0, false);
        declareFunction(me, "handle_plausibility_of_isa_sentence", "HANDLE-PLAUSIBILITY-OF-ISA-SENTENCE", 4, 0, false);
        declareFunction(me, "map_likelihood_to_numbers", "MAP-LIKELIHOOD-TO-NUMBERS", 1, 0, false);
        declareFunction(me, "combined_evidence", "COMBINED-EVIDENCE", 1, 0, false);
        declareFunction(me, "find_min_likelihood", "FIND-MIN-LIKELIHOOD", 1, 0, false);
        declareFunction(me, "clear_do_tva_query_type_type", "CLEAR-DO-TVA-QUERY-TYPE-TYPE", 0, 0, false);
        declareFunction(me, "remove_do_tva_query_type_type", "REMOVE-DO-TVA-QUERY-TYPE-TYPE", 5, 0, false);
        declareFunction(me, "do_tva_query_type_type_internal", "DO-TVA-QUERY-TYPE-TYPE-INTERNAL", 5, 0, false);
        declareFunction(me, "do_tva_query_type_type", "DO-TVA-QUERY-TYPE-TYPE", 5, 0, false);
        declareFunction(me, "clear_do_tva_query_type_disjoint_with", "CLEAR-DO-TVA-QUERY-TYPE-DISJOINT-WITH", 0, 0, false);
        declareFunction(me, "remove_do_tva_query_type_disjoint_with", "REMOVE-DO-TVA-QUERY-TYPE-DISJOINT-WITH", 5, 0, false);
        declareFunction(me, "do_tva_query_type_disjoint_with_internal", "DO-TVA-QUERY-TYPE-DISJOINT-WITH-INTERNAL", 5, 0, false);
        declareFunction(me, "do_tva_query_type_disjoint_with", "DO-TVA-QUERY-TYPE-DISJOINT-WITH", 5, 0, false);
        declareFunction(me, "do_tva_query_ins_not_in_col", "DO-TVA-QUERY-INS-NOT-IN-COL", 5, 0, false);
        declareFunction(me, "do_tva_query_type_ins", "DO-TVA-QUERY-TYPE-INS", 5, 0, false);
        declareFunction(me, "do_tva_query_ins_type", "DO-TVA-QUERY-INS-TYPE", 5, 0, false);
        declareFunction(me, "simple_nartP", "SIMPLE-NART?", 1, 0, false);
        declareFunction(me, "possibly_get_atomic_collection", "POSSIBLY-GET-ATOMIC-COLLECTION", 1, 0, false);
        declareFunction(me, "answers_for", "ANSWERS-FOR", 1, 0, false);
        declareFunction(me, "find_distance_between_term_sets", "FIND-DISTANCE-BETWEEN-TERM-SETS", 3, 1, false);
        declareFunction(me, "find_distance_between_detected_and_predicted_features", "FIND-DISTANCE-BETWEEN-DETECTED-AND-PREDICTED-FEATURES", 3, 1, false);
        declareFunction(me, "find_distance_between_parse_features_and_features", "FIND-DISTANCE-BETWEEN-PARSE-FEATURES-AND-FEATURES", 4, 0, false);
        declareFunction(me, "find_apriori_score_for_collection", "FIND-APRIORI-SCORE-FOR-COLLECTION", 1, 0, false);
        declareFunction(me, "find_apriori_score_for_predicate", "FIND-APRIORI-SCORE-FOR-PREDICATE", 1, 0, false);
        declareFunction(me, "coefficient_of_generalization", "COEFFICIENT-OF-GENERALIZATION", 2, 0, false);
        declareFunction(me, "coefficient_of_generalization_pred", "COEFFICIENT-OF-GENERALIZATION-PRED", 2, 0, false);
        declareFunction(me, "coefficient_of_specialization", "COEFFICIENT-OF-SPECIALIZATION", 2, 0, false);
        declareFunction(me, "find_lowest_common_ancestor", "FIND-LOWEST-COMMON-ANCESTOR", 3, 1, false);
        declareFunction(me, "find_lowest_common_ancestor_of_predicates", "FIND-LOWEST-COMMON-ANCESTOR-OF-PREDICATES", 3, 1, false);
        declareFunction(me, "find_associations_between_objects", "FIND-ASSOCIATIONS-BETWEEN-OBJECTS", 2, 0, false);
        declareFunction(me, "find_distance_between_collections", "FIND-DISTANCE-BETWEEN-COLLECTIONS", 3, 1, false);
        declareFunction(me, "find_distance_between_collections_hierarchy", "FIND-DISTANCE-BETWEEN-COLLECTIONS-HIERARCHY", 3, 1, false);
        declareFunction(me, "find_reinforcement_of_node", "FIND-REINFORCEMENT-OF-NODE", 4, 0, false);
        declareFunction(me, "find_common_genls", "FIND-COMMON-GENLS", 2, 0, false);
        declareFunction(me, "find_common_genlpreds", "FIND-COMMON-GENLPREDS", 2, 0, false);
        declareFunction(me, "check_genl_associations", "CHECK-GENL-ASSOCIATIONS", 2, 0, false);
        declareFunction(me, "check_genlpred_associations", "CHECK-GENLPRED-ASSOCIATIONS", 2, 0, false);
        declareFunction(me, "check_isa_associations", "CHECK-ISA-ASSOCIATIONS", 2, 0, false);
        declareFunction(me, "get_elements_of_set", "GET-ELEMENTS-OF-SET", 1, 0, false);
        declareFunction(me, "find_distance_between_collections_sym", "FIND-DISTANCE-BETWEEN-COLLECTIONS-SYM", 3, 0, false);
        declareFunction(me, "find_distance_between_predicates_sym", "FIND-DISTANCE-BETWEEN-PREDICATES-SYM", 3, 0, false);
        declareFunction(me, "find_distance_between_individuals_sym", "FIND-DISTANCE-BETWEEN-INDIVIDUALS-SYM", 3, 0, false);
        declareFunction(me, "find_distance_between_assertions", "FIND-DISTANCE-BETWEEN-ASSERTIONS", 3, 0, false);
        declareFunction(me, "find_distance_between_terms_sym", "FIND-DISTANCE-BETWEEN-TERMS-SYM", 3, 0, false);
        declareFunction(me, "distance_between_two_strings", "DISTANCE-BETWEEN-TWO-STRINGS", 2, 0, false);
        declareFunction(me, "best_concept_match_for_string", "BEST-CONCEPT-MATCH-FOR-STRING", 1, 1, false);
        declareFunction(me, "find_definite_descriptions_match", "FIND-DEFINITE-DESCRIPTIONS-MATCH", 1, 0, false);
        declareFunction(me, "find_all_aura_concepts", "FIND-ALL-AURA-CONCEPTS", 0, 0, false);
        declareFunction(me, "find_namestring_match", "FIND-NAMESTRING-MATCH", 1, 0, false);
        declareFunction(me, "replace_too_common_strings", "REPLACE-TOO-COMMON-STRINGS", 1, 0, false);
        return NIL;
    }
