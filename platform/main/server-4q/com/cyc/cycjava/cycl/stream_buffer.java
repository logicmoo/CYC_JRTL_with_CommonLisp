...
import static com.cyc.cycjava.cycl.stream_buffer.*;
...
public final class stream_buffer extends SubLTranslatedFile {
    ...
    public static final SubLSymbol STRING_BUFFER = makeSymbol("STRING-BUFFER");

    public static final SubLSymbol STRING_BUFFER_P = makeSymbol("STRING-BUFFER-P");
    ...
    public static final SubLSymbol PRINT_STRING_BUFFER = makeSymbol("PRINT-STRING-BUFFER");

    public static final SubLSymbol STRING_BUFFER_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("STRING-BUFFER-PRINT-FUNCTION-TRAMPOLINE");
    ...
    public static final SubLList $list26 = list(list(makeSymbol("BUFFER-STRING-VAR"), makeSymbol("BUFFER-END-VAR")), makeSymbol("STRING-BUFFER"), makeSymbol("&BODY"), makeSymbol("BODY"));
    ...
    private static final SubLList $list57 = list(makeKeyword("BLOCK-SIZE"), makeKeyword("PROGRESS-MESSAGE"), makeKeyword("DONE"));
    ...
    private static final SubLList $list78 = list(makeKeyword("BLOCK-SIZE"), makeKeyword("DONE"));
    ...
    public static SubLObject string_buffer_p(final SubLObject v_object) {
        return v_object.getClass() == stream_buffer.$string_buffer_native.class ? T : NIL;
    }

    public static SubLObject strbuf_string(final SubLObject v_object) {
        assert NIL != string_buffer_p(v_object) : "stream_buffer.string_buffer_p(v_object) " + "CommonSymbols.NIL != stream_buffer.string_buffer_p(v_object) " + v_object;
    ...
    public static SubLObject make_string_buffer(SubLObject arglist) {
        ...
        final SubLObject v_new = new stream_buffer.$string_buffer_native();
        SubLObject next;
    ...
    public static SubLObject new_string_buffer(SubLObject initial_capacity) {
        ...
        assert NIL != subl_promotions.non_negative_integer_p(initial_capacity) : "subl_promotions.non_negative_integer_p(initial_capacity) " + "CommonSymbols.NIL != subl_promotions.non_negative_integer_p(initial_capacity) " + initial_capacity;
    ...
    public static SubLObject destroy_string_buffer(final SubLObject string_buffer) {
        assert NIL != string_buffer_p(string_buffer) : "stream_buffer.string_buffer_p(string_buffer) " + "CommonSymbols.NIL != stream_buffer.string_buffer_p(string_buffer) " + string_buffer;
    ...
    public static SubLObject stream_buffer_p(final SubLObject v_object) {
        return v_object.getClass() == stream_buffer.$stream_buffer_native.class ? T : NIL;
    }

    public static SubLObject strm_buf_stream(final SubLObject v_object) {
        assert NIL != stream_buffer_p(v_object) : "stream_buffer.stream_buffer_p(v_object) " + "CommonSymbols.NIL != stream_buffer.stream_buffer_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_stream_buffer(SubLObject arglist) {
        ...
        final SubLObject v_new = new stream_buffer.$stream_buffer_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject destroy_stream_buffer(final SubLObject v_stream_buffer) {
        assert NIL != stream_buffer_p(v_stream_buffer) : "stream_buffer.stream_buffer_p(v_stream_buffer) " + "CommonSymbols.NIL != stream_buffer.stream_buffer_p(v_stream_buffer) " + v_stream_buffer;
    ...
    public static SubLObject declare_stream_buffer_file() {
        declareFunction(me, "stream_buffer_read_sequence", "STREAM-BUFFER-READ-SEQUENCE", 2, 2, false);
        declareFunction(me, "string_buffer_replace", "STRING-BUFFER-REPLACE", 2, 4, false);
        declareFunction(me, "read_text_into_vector", "READ-TEXT-INTO-VECTOR", 2, 2, false);
        declareFunction(me, "replace_string_from_vector", "REPLACE-STRING-FROM-VECTOR", 2, 4, false);
        declareFunction(me, "string_buffer_print_function_trampoline", "STRING-BUFFER-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "string_buffer_p", "STRING-BUFFER-P", 1, 0, false);
        new stream_buffer.$string_buffer_p$UnaryFunction();
        declareFunction(me, "strbuf_string", "STRBUF-STRING", 1, 0, false);
        declareFunction(me, "strbuf_position", "STRBUF-POSITION", 1, 0, false);
        declareFunction(me, "_csetf_strbuf_string", "_CSETF-STRBUF-STRING", 2, 0, false);
        declareFunction(me, "_csetf_strbuf_position", "_CSETF-STRBUF-POSITION", 2, 0, false);
        declareFunction(me, "make_string_buffer", "MAKE-STRING-BUFFER", 0, 1, false);
        declareFunction(me, "visit_defstruct_string_buffer", "VISIT-DEFSTRUCT-STRING-BUFFER", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_string_buffer_method", "VISIT-DEFSTRUCT-OBJECT-STRING-BUFFER-METHOD", 2, 0, false);
        declareFunction(me, "print_string_buffer", "PRINT-STRING-BUFFER", 3, 0, false);
        declareFunction(me, "new_string_buffer", "NEW-STRING-BUFFER", 0, 1, false);
        declareFunction(me, "destroy_string_buffer", "DESTROY-STRING-BUFFER", 1, 0, false);
        declareFunction(me, "string_buffer_string", "STRING-BUFFER-STRING", 1, 0, false);
        declareFunction(me, "string_buffer_position", "STRING-BUFFER-POSITION", 1, 0, false);
        declareMacro(me, "with_string_buffer", "WITH-STRING-BUFFER");
        declareFunction(me, "string_buffer_capacity", "STRING-BUFFER-CAPACITY", 1, 0, false);
        declareFunction(me, "string_buffer_write", "STRING-BUFFER-WRITE", 1, 1, false);
        declareFunction(me, "string_buffer_read", "STRING-BUFFER-READ", 1, 3, false);
        declareFunction(me, "string_buffer_reset", "STRING-BUFFER-RESET", 1, 0, false);
        declareFunction(me, "string_buffer_add", "STRING-BUFFER-ADD", 2, 0, false);
        declareFunction(me, "string_buffer_add_sequence", "STRING-BUFFER-ADD-SEQUENCE", 2, 2, false);
        declareFunction(me, "stream_buffer_print_function_trampoline", "STREAM-BUFFER-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "stream_buffer_p", "STREAM-BUFFER-P", 1, 0, false);
        new stream_buffer.$stream_buffer_p$UnaryFunction();
        declareFunction(me, "strm_buf_stream", "STRM-BUF-STREAM", 1, 0, false);
        declareFunction(me, "strm_buf_buffer", "STRM-BUF-BUFFER", 1, 0, false);
        declareFunction(me, "strm_buf_end", "STRM-BUF-END", 1, 0, false);
        declareFunction(me, "strm_buf_position", "STRM-BUF-POSITION", 1, 0, false);
        declareFunction(me, "_csetf_strm_buf_stream", "_CSETF-STRM-BUF-STREAM", 2, 0, false);
        declareFunction(me, "_csetf_strm_buf_buffer", "_CSETF-STRM-BUF-BUFFER", 2, 0, false);
        declareFunction(me, "_csetf_strm_buf_end", "_CSETF-STRM-BUF-END", 2, 0, false);
        declareFunction(me, "_csetf_strm_buf_position", "_CSETF-STRM-BUF-POSITION", 2, 0, false);
        declareFunction(me, "make_stream_buffer", "MAKE-STREAM-BUFFER", 0, 1, false);
        declareFunction(me, "visit_defstruct_stream_buffer", "VISIT-DEFSTRUCT-STREAM-BUFFER", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_stream_buffer_method", "VISIT-DEFSTRUCT-OBJECT-STREAM-BUFFER-METHOD", 2, 0, false);
        declareFunction(me, "print_stream_buffer", "PRINT-STREAM-BUFFER", 3, 0, false);
        declareFunction(me, "new_stream_buffer", "NEW-STREAM-BUFFER", 1, 1, false);
        declareFunction(me, "destroy_stream_buffer", "DESTROY-STREAM-BUFFER", 1, 0, false);
        declareFunction(me, "stream_buffer_stream", "STREAM-BUFFER-STREAM", 1, 0, false);
        declareFunction(me, "stream_buffer_block_size", "STREAM-BUFFER-BLOCK-SIZE", 1, 0, false);
        declareFunction(me, "stream_buffer_reset", "STREAM-BUFFER-RESET", 1, 0, false);
        declareFunction(me, "stream_buffer_load", "STREAM-BUFFER-LOAD", 1, 0, false);
        declareFunction(me, "read_line_into_string_buffer", "READ-LINE-INTO-STRING-BUFFER", 1, 3, false);
        declareFunction(me, "stream_buffer_read_line_into_string_buffer", "STREAM-BUFFER-READ-LINE-INTO-STRING-BUFFER", 1, 3, false);
        declareFunction(me, "read_line_into_string_buffer_int", "READ-LINE-INTO-STRING-BUFFER-INT", 2, 0, false);
        declareFunction(me, "stream_buffer_read_line_into_string_buffer_int", "STREAM-BUFFER-READ-LINE-INTO-STRING-BUFFER-INT", 2, 0, false);
        declareMacro(me, "do_file_lines_buffered", "DO-FILE-LINES-BUFFERED");
        declareMacro(me, "do_stream_lines_buffered", "DO-STREAM-LINES-BUFFERED");
        declareFunction(me, "do_stream_lines_buffered_initialize", "DO-STREAM-LINES-BUFFERED-INITIALIZE", 1, 1, false);
        declareFunction(me, "do_stream_lines_buffered_next", "DO-STREAM-LINES-BUFFERED-NEXT", 2, 0, false);
        declareFunction(me, "do_stream_lines_buffered_finalize", "DO-STREAM-LINES-BUFFERED-FINALIZE", 2, 0, false);
        declareFunction(me, "new_stream_line_iterator", "NEW-STREAM-LINE-ITERATOR", 1, 1, false);
        declareFunction(me, "make_stream_line_iterator_state", "MAKE-STREAM-LINE-ITERATOR-STATE", 2, 0, false);
        declareFunction(me, "stream_line_iterator_doneP", "STREAM-LINE-ITERATOR-DONE?", 1, 0, false);
        declareFunction(me, "stream_line_iterator_next", "STREAM-LINE-ITERATOR-NEXT", 1, 0, false);
        declareFunction(me, "stream_line_iterator_finalize", "STREAM-LINE-ITERATOR-FINALIZE", 1, 0, false);
        declareFunction(me, "buffered_file_grep", "BUFFERED-FILE-GREP", 2, 1, false);
        return NIL;
    }
    ...
    public static final class $string_buffer_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(stream_buffer.$string_buffer_native.class, STRING_BUFFER, STRING_BUFFER_P, $list3, $list4, new String[]{ "$string", "$position" }, $list5, $list6, PRINT_STRING_BUFFER);
        }
    }
    ...
    public static final class $stream_buffer_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(stream_buffer.$stream_buffer_native.class, STREAM_BUFFER, STREAM_BUFFER_P, $list32, $list33, new String[]{ "$stream", "$buffer", "$end", "$position" }, $list34, $list35, PRINT_STREAM_BUFFER);
        }
    }
