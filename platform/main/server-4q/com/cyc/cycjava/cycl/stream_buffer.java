...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class stream_buffer extends SubLTranslatedFile {
    ...
    public static SubLObject string_buffer_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$string_buffer_native.class ? T : NIL;
    }

    public static SubLObject strbuf_string(final SubLObject v_object) {
        assert NIL != string_buffer_p(v_object) : "stream_buffer.string_buffer_p error :" + v_object;
    ...
    public static SubLObject stream_buffer_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$stream_buffer_native.class ? T : NIL;
    }

    public static SubLObject strm_buf_stream(final SubLObject v_object) {
        assert NIL != stream_buffer_p(v_object) : "stream_buffer.stream_buffer_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $string_buffer_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($string_buffer_native.class, STRING_BUFFER, STRING_BUFFER_P, $list3, $list4, new String[]{ "$string", "$position" }, $list5, $list6, PRINT_STRING_BUFFER);
        }
    }
    ...
    public static final class $stream_buffer_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($stream_buffer_native.class, STREAM_BUFFER, STREAM_BUFFER_P, $list32, $list33, new String[]{ "$stream", "$buffer", "$end", "$position" }, $list34, $list35, PRINT_STREAM_BUFFER);
        }
    }
