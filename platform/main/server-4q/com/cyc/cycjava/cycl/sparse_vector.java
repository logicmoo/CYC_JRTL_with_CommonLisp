...
public final class sparse_vector extends SubLTranslatedFile {
    ...
    public static SubLObject sparse_vector_p(final SubLObject v_object) {
        return v_object.getClass() == sparse_vector.$sparse_vector_native.class ? T : NIL;
    }

    public static SubLObject svector_magnitude(final SubLObject v_object) {
        assert NIL != sparse_vector_p(v_object) : "sparse_vector.sparse_vector_p(v_object) " + "CommonSymbols.NIL != sparse_vector.sparse_vector_p(v_object) " + v_object;
    ...
    public static SubLObject make_sparse_vector(SubLObject arglist) {
        ...
        final SubLObject v_new = new sparse_vector.$sparse_vector_native();
        SubLObject next;
    ...
    public static final class $sparse_vector_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(sparse_vector.$sparse_vector_native.class, SPARSE_VECTOR, SPARSE_VECTOR_P, $list2, $list3, new String[]{ "$magnitude", "$dimensions" }, $list4, $list5, SVECTOR_PRINT);
        }
    }
