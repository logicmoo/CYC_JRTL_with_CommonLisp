...
import static com.cyc.cycjava.cycl.memoization_state.register_isa_dependent_cache_clear_callback;
...
public final class html_complete extends SubLTranslatedFile implements V12 {
    ...
    private static final SubLList $list131 = list(new SubLObject[]{ makeKeyword("COMPLETE-ON-CONSTANTS?"), makeKeyword("PREFER-HISTORY-TERMS?"), makeKeyword("LEXICON"), makeKeyword("CASE-SENSITIVE?"), makeKeyword("RETURN-ATTRS"), makeKeyword("TIMEOUT"), makeKeyword("LIMIT"), makeKeyword("MT"), makeKeyword("ISA-FILTER"), makeKeyword("GENLS-FILTER"), makeKeyword("ISA-RESTRICTIONS"), makeKeyword("GENLS-RESTRICTIONS") });
    ...
    private static final SubLList $list195 = list(list(list(list(list(makeString("filter"), makeString("Thing")), list(makeString("constrainingSentence"), makeString("(argIsa COPY_OF_cblSendMessageNamed  2  :term-to-replace)")), list(makeString("caseSensitive"), makeString("nil")), list(makeString("prefix"), makeString("genlI")))), ZERO_INTEGER), list(list(list(list(makeString("filter"), makeString("Thing")), list(makeString("constrainingSentence"), makeString("(genlPreds COPY_OF_cblSendMessageNamed :term-to-replace)")), list(makeString("caseSensitive"), makeString("T")), list(makeString("prefix"), makeString("ProgRa")))), ZERO_INTEGER));
    ...
    public static SubLObject get_constraint_filters_from_html_args(final SubLObject args) {
        ...
        if (NIL != constraining_sentence) {
            ...
            if (NIL == forts.fort_p(isa_filter)) {
