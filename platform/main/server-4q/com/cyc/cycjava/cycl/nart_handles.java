...
public final class nart_handles extends SubLTranslatedFile {
    ...
    public static SubLObject nart_p(final SubLObject v_object) {
        return v_object.getClass() == nart_handles.$nart_native.class ? T : NIL;
    }

    public static SubLObject n_id(final SubLObject v_object) {
        assert NIL != nart_p(v_object) : "nart_handles.nart_p(v_object) " + "CommonSymbols.NIL != nart_handles.nart_p(v_object) " + v_object;
    ...
    public static SubLObject make_nart(SubLObject arglist) {
        ...
        final SubLObject v_new = new nart_handles.$nart_native();
        SubLObject next;
    ...
    public static final class $nart_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(nart_handles.$nart_native.class, NART, NART_P, $list38, $list39, new String[]{ "$id" }, $list40, $list41, PRINT_NART);
        }
    }
