...
import com.cyc.cycjava.cycl.rkf_scenario_manipulator;
...
public final class rkf_scenario_manipulator extends SubLTranslatedFile {
    ...
    public static SubLObject sm_scenario_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_scenario_manipulator.$sm_scenario_native.class ? T : NIL;
    }

    public static SubLObject sm_scenario_id(final SubLObject v_object) {
        assert NIL != sm_scenario_p(v_object) : "rkf_scenario_manipulator.sm_scenario_p(v_object) " + "CommonSymbols.NIL != rkf_scenario_manipulator.sm_scenario_p(v_object) " + v_object;
    ...
    public static SubLObject make_sm_scenario(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_scenario_manipulator.$sm_scenario_native();
        SubLObject next;
    ...
    public static SubLObject sm_template_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_scenario_manipulator.$sm_template_native.class ? T : NIL;
    }

    public static SubLObject sm_template_id(final SubLObject v_object) {
        assert NIL != sm_template_p(v_object) : "rkf_scenario_manipulator.sm_template_p(v_object) " + "CommonSymbols.NIL != rkf_scenario_manipulator.sm_template_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sm_template(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_scenario_manipulator.$sm_template_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sm_indexical_record_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_scenario_manipulator.$sm_indexical_record_native.class ? T : NIL;
    }

    public static SubLObject sm_indexical_record_id(final SubLObject v_object) {
        assert NIL != sm_indexical_record_p(v_object) : "rkf_scenario_manipulator.sm_indexical_record_p(v_object) " + "CommonSymbols.NIL != rkf_scenario_manipulator.sm_indexical_record_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sm_indexical_record(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_scenario_manipulator.$sm_indexical_record_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sm_constraint_record_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_scenario_manipulator.$sm_constraint_record_native.class ? T : NIL;
    }

    public static SubLObject sm_constraint_record_id(final SubLObject v_object) {
        assert NIL != sm_constraint_record_p(v_object) : "rkf_scenario_manipulator.sm_constraint_record_p(v_object) " + "CommonSymbols.NIL != rkf_scenario_manipulator.sm_constraint_record_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sm_constraint_record(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_scenario_manipulator.$sm_constraint_record_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sm_merge_info_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_scenario_manipulator.$sm_merge_info_native.class ? T : NIL;
    }

    public static SubLObject sm_merge_info_id(final SubLObject v_object) {
        assert NIL != sm_merge_info_p(v_object) : "rkf_scenario_manipulator.sm_merge_info_p(v_object) " + "CommonSymbols.NIL != rkf_scenario_manipulator.sm_merge_info_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sm_merge_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_scenario_manipulator.$sm_merge_info_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject sm_gen_point_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_scenario_manipulator.$sm_gen_point_native.class ? T : NIL;
    }

    public static SubLObject sm_gen_point_id(final SubLObject v_object) {
        assert NIL != sm_gen_point_p(v_object) : "rkf_scenario_manipulator.sm_gen_point_p(v_object) " + "CommonSymbols.NIL != rkf_scenario_manipulator.sm_gen_point_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_sm_gen_point(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_scenario_manipulator.$sm_gen_point_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $sm_scenario_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_scenario_manipulator.$sm_scenario_native.class, SM_SCENARIO, SM_SCENARIO_P, $list7, $list8, new String[]{ "$id", "$sessions", "$phrase", "$candidate_terms", "$candidate_constraints", "$fort", "$terms", "$constraints", "$templates", "$state" }, $list9, $list10, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $sm_template_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_scenario_manipulator.$sm_template_native.class, SM_TEMPLATE, SM_TEMPLATE_P, $list64, $list65, new String[]{ "$id", "$scenario", "$phrase", "$expression", "$param_subs", "$parameters", "$constraints", "$state" }, $list66, $list67, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $sm_indexical_record_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_scenario_manipulator.$sm_indexical_record_native.class, SM_INDEXICAL_RECORD, SM_INDEXICAL_RECORD_P, $list97, $list98, new String[]{ "$id", "$indexical", "$phrases", "$var", "$explicit_isas", "$explicit_genls", "$isas", "$genls", "$state" }, $list99, $list100, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $sm_constraint_record_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_scenario_manipulator.$sm_constraint_record_native.class, SM_CONSTRAINT_RECORD, SM_CONSTRAINT_RECORD_P, $list135, $list136, new String[]{ "$id", "$sentence", "$nl_sentence" }, $list137, $list138, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $sm_merge_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_scenario_manipulator.$sm_merge_info_native.class, SM_MERGE_INFO, SM_MERGE_INFO_P, $list154, $list155, new String[]{ "$id", "$from_scenario", "$to_scenario", "$align_to", "$align_from", "$indexical_equivalences" }, $list156, $list157, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $sm_gen_point_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_scenario_manipulator.$sm_gen_point_native.class, SM_GEN_POINT, SM_GEN_POINT_P, $list181, $list182, new String[]{ "$id", "$non_indexical", "$isas", "$genls", "$positions", "$indexical_record", "$keyword" }, $list183, $list184, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
