...
public final class cb_viewpoint extends SubLTranslatedFile {
    ...
    public static SubLObject viewpoint_p(final SubLObject v_object) {
        return v_object.getClass() == cb_viewpoint.$viewpoint_native.class ? T : NIL;
    }

    public static SubLObject viewpoint_name(final SubLObject v_object) {
        assert NIL != viewpoint_p(v_object) : "cb_viewpoint.viewpoint_p(v_object) " + "CommonSymbols.NIL != cb_viewpoint.viewpoint_p(v_object) " + v_object;
    ...
    public static SubLObject make_viewpoint(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_viewpoint.$viewpoint_native();
        SubLObject next;
    ...
    public static final class $viewpoint_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(cb_viewpoint.$viewpoint_native.class, VIEWPOINT, VIEWPOINT_P, $list3, $list4, new String[]{ "$name", "$summary_name", "$linkable_name", "$linkname_prefix", "$filter_getter", "$filter_setter", "$type", "$active_p", "$effective_fn", "$value_prompt_fn", "$value_update_fn", "$initial_filter_value", "$effective_fn_slotname" }, $list5, $list6, PRINT_VIEWPOINT);
        }
    }
