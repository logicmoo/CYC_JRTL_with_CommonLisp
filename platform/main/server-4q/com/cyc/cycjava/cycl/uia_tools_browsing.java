...
public final class uia_tools_browsing extends SubLTranslatedFile implements V02 {
				...
				SubLObject phrases = NIL;
				{
					...
					try {
						...
						lexicon_vars.$lexicon_lookup_mt$.bind(pph_vars.$pph_language_mt$.getDynamicValue(thread), thread);
						{
							...
							phrases = remove(main_phrase, pph_methods_lexicon.all_phrases_for_term(v_term, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED_SYM), symbol_function(EQUAL), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
						}
					} finally {
	...
	public static final SubLObject uia_act_new_sentence_clarifier(SubLObject v_agenda, SubLObject mode, SubLObject cycl_sentence, SubLObject force) {
		...
		}
		{
			...
			} else if (pcase_var.eql($QUESTION) || pcase_var.eql($INTERROGATIVE)) {
				...
				if (NIL == current) {
					{
						...
						} else if ((NIL != el_utilities.cafP(cycl_sentence)) || (NIL != assertions_high.gaf_assertionP(cycl_sentence))) {
							{
	...
	public static final SubLObject uiat_domain_examples_child_completed(SubLObject parent, SubLObject child) {
		{
			...
			} else if (pcase_var.eql($THINKING)) {
			}
	...
	public static final SubLObject uiat_domain_examples_sentence_sections(SubLObject v_agenda, SubLObject sample_sentence, SubLObject filter_term, SubLObject sort_method) {
		{
			...
			}
			{
				...
				} else if (pcase_var.eql($SPECIFICITY)) {
					if ($UNDETERMINED != filter_term) {
	...
	public static final SubLObject uiat_knowledge_scrapbook_child_completed(SubLObject parent, SubLObject child) {
		{
			...
			} else if (pcase_var.eql($FILE_BROWSER)) {
				{
	...
	public static final SubLObject scrap_book_p(SubLObject v_object) {
		return v_object.getJavaClass() ==uia_tools_browsing.$scrap_book_native.class ? ((SubLObject) (T)) : NIL;
	}
			...
			for (next = arglist; NIL != next; next = cddr(next)) {
				{
					...
					} else if (pcase_var.eql($ASSERTIONS)) {
	...
	public static final SubLObject rem_from_scrap_book(SubLObject scrapbook, SubLObject entity) {
		...
		} else if (NIL != assertion_handles.assertion_p(entity)) {
			rem_assertion_from_scrap_book(scrapbook, entity);
		} else if (NIL != term.nautP(entity, UNPROVIDED)) {
			rem_term_from_scrap_book(scrapbook, entity);
		} else if (NIL != collection_defns.cycl_sentenceP(entity)) {
	...
	public static final SubLObject uia_ontology_browser_handle_reply(SubLObject reply) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				...
				temp_plist = current;
				{
					...
					} else if (pcase_var.eql($INTERPRET)) {
						{
					...
					} else if (pcase_var.eql($OTHER)) {
						{
							...
							}
							{
								...
								if (pcase_var_41.eql($ASSERTED_SENTENCES)) {
									...
									uia_act_new_ontology_browser(v_agenda, $REQUIRED, v_term, UNPROVIDED);
								} else if (pcase_var_41.eql($ADD_SCRAP)) {
									{
										SubLObject _prev_bind_0 = uia_macros.$focused_uia_interaction$.currentBinding(thread);
										try {
											uia_macros.$focused_uia_interaction$.bind(T, thread);
									...
									uia_act_new_ontology_browser(v_agenda, $REQUIRED, v_term, UNPROVIDED);
								} else if (pcase_var_41.eql($INTERVIEW)) {
									{
										SubLObject _prev_bind_0 = uia_macros.$focused_uia_interaction$.currentBinding(thread);
										try {
											uia_macros.$focused_uia_interaction$.bind(T, thread);
									...
									uia_act_new_ontology_browser(v_agenda, $REQUIRED, v_term, UNPROVIDED);
								} else if (pcase_var_41.eql($LEXIFY)) {
									{
										SubLObject _prev_bind_0 = uia_macros.$focused_uia_interaction$.currentBinding(thread);
										try {
											uia_macros.$focused_uia_interaction$.bind(T, thread);
									...
									uia_act_new_ontology_browser(v_agenda, $REQUIRED, v_term, UNPROVIDED);
								} else if (pcase_var_41.eql($CONCEPT_RELATOR)) {
									{
										SubLObject _prev_bind_0 = uia_macros.$focused_uia_interaction$.currentBinding(thread);
										try {
											uia_macros.$focused_uia_interaction$.bind(T, thread);
									...
									uia_act_new_ontology_browser(v_agenda, $REQUIRED, v_term, UNPROVIDED);
								} else if (pcase_var_41.eql($COMMON_QUERIES)) {
									{
										SubLObject _prev_bind_0 = uia_macros.$focused_uia_interaction$.currentBinding(thread);
										try {
											uia_macros.$focused_uia_interaction$.bind(T, thread);
									...
									uia_act_new_ontology_browser(v_agenda, $REQUIRED, v_term, UNPROVIDED);
								} else if (pcase_var_41.eql($CREATE_SIMILAR)) {
									{
								...
								} else if (pcase_var_41.eql($CREATE_INSTANCE)) {
									{
								...
								} else if (pcase_var_41.eql($CREATE_SPEC)) {
									{
								...
								} else if (pcase_var_41.eql($KILL_TERM)) {
									{
										SubLObject _prev_bind_0 = uia_macros.$focused_uia_interaction$.currentBinding(thread);
										try {
											uia_macros.$focused_uia_interaction$.bind(T, thread);
									...
									uia_act_new_ontology_browser(v_agenda, $REQUIRED, UNPROVIDED, UNPROVIDED);
								} else if (pcase_var_41.eql($COMPARE)) {
									{
										SubLObject _prev_bind_0 = uia_macros.$focused_uia_interaction$.currentBinding(thread);
										try {
											uia_macros.$focused_uia_interaction$.bind(T, thread);
									...
									uia_act_new_ontology_browser(v_agenda, $REQUIRED, v_term, UNPROVIDED);
								} else if (pcase_var_41.eql($ANALOGY)) {
									{
										SubLObject _prev_bind_0 = uia_macros.$focused_uia_interaction$.currentBinding(thread);
										try {
											uia_macros.$focused_uia_interaction$.bind(T, thread);
									...
									uia_act_new_ontology_browser(v_agenda, $REQUIRED, v_term, UNPROVIDED);
								} else if (pcase_var_41.eql($RELATION_SUGGESTOR)) {
									{
										SubLObject _prev_bind_0 = uia_macros.$focused_uia_interaction$.currentBinding(thread);
										try {
											uia_macros.$focused_uia_interaction$.bind(T, thread);
	...
	public static final SubLObject uia_ontology_browser_irrelevant_connectionP(SubLObject v_agenda, SubLObject predicate) {
		if (NIL != subl_promotions.memberP(predicate, list($$isa, $$genls, $$repatriateToMt, $$definingMt), UNPROVIDED, UNPROVIDED)) {
			return T;
		} else if (NIL != uia_trampolines.uia_irrelevant_termP(v_agenda, predicate, UNPROVIDED)) {
			return T;
		} else {
			return NIL;
		}
	...
	public static final SubLObject uiat_search_type_description(SubLObject search_type) {
		{
			...
			} else if (pcase_var.eql($SUFFIX)) {
				return $$$at_the_end;
			} else if (pcase_var.eql($INFIX)) {
				return $$$somewhere;
			}
	...
	static private final SubLList $list_alt63 = list(new SubLObject[] { $NAME, makeString("Domain Examples"), makeKeyword("HINT-METHOD"), makeSymbol("UIAT-DOMAIN-EXAMPLES-HINT"), makeKeyword("CHILD-COMPLETED-METHOD"), makeSymbol("UIAT-DOMAIN-EXAMPLES-CHILD-COMPLETED"), makeKeyword("CHILD-REJECTED-METHOD"), makeSymbol("UIAT-DOMAIN-EXAMPLES-CHILD-REJECTED"), makeKeyword("GENERATE-REQUEST-METHOD"),
			makeSymbol("UIAT-DOMAIN-EXAMPLES-GENERATE-REQUEST"), makeKeyword("HANDLE-REPLY-METHOD"), makeSymbol("UIAT-DOMAIN-EXAMPLES-HANDLE-REPLY"), $CYCL, constant_handles.reader_make_constant_shell(makeString("CycDomainExamplesTool")), makeKeyword("FEATURES"), list(makeKeyword("CONCEPT-BROWSING"), makeKeyword("SENTENCE-BROWSING")) });
	...
	static private final SubLList $list_alt93 = list(list(makeKeyword("TOPICAL-UTILITY"), makeString("by topical utility")), list(makeKeyword("GENERAL-UTILITY"), makeString("by general utility")), list(makeKeyword("CLOSENESS"), makeString("by closeness to this sentence")), list(makeKeyword("SPECIFICITY"), makeString("by specificity")), list(makeKeyword("MT-RELEVANCE"), makeString("by topical relevance")),
			list(makeKeyword("SIMILARITY"), makeString("by similarity")), list(makeKeyword("ALPHABETICALLY"), makeString("alphabetically")), list(makeKeyword("RANDOMLY"), makeString("in random order")));
	...
	static private final SubLList $list_alt211 = list(new SubLObject[] { constant_handles.reader_make_constant_shell(makeString("Person")), constant_handles.reader_make_constant_shell(makeString("Dog")), constant_handles.reader_make_constant_shell(makeString("Plant")), constant_handles.reader_make_constant_shell(makeString("Pizza")), constant_handles.reader_make_constant_shell(makeString("Country")),
			constant_handles.reader_make_constant_shell(makeString("River")), constant_handles.reader_make_constant_shell(makeString("Business")), constant_handles.reader_make_constant_shell(makeString("FurniturePiece")), constant_handles.reader_make_constant_shell(makeString("Automobile")), constant_handles.reader_make_constant_shell(makeString("Tool")),
			constant_handles.reader_make_constant_shell(makeString("AnimalWalkingProcess")), constant_handles.reader_make_constant_shell(makeString("RedColor")), constant_handles.reader_make_constant_shell(makeString("FeelingAttribute")), constant_handles.reader_make_constant_shell(makeString("Book-CW")), constant_handles.reader_make_constant_shell(makeString("Mile")),
			constant_handles.reader_make_constant_shell(makeString("Dollar-UnitedStates")), constant_handles.reader_make_constant_shell(makeString("Number-General")), constant_handles.reader_make_constant_shell(makeString("Predicate")), constant_handles.reader_make_constant_shell(makeString("Microtheory")), constant_handles.reader_make_constant_shell(makeString("Function-Denotational")),
			constant_handles.reader_make_constant_shell(makeString("LexicalWord")) });
	...
	static private final SubLList $list_alt224 = list(new SubLObject[] { $NAME, makeString("Concept Recognizer"), makeKeyword("HINT-METHOD"), makeSymbol("UIAT-CONCEPT-RECOGNIZER-HINT"), makeKeyword("GENERATE-REQUEST-METHOD"), makeSymbol("UIAT-CONCEPT-RECOGNIZER-GENERATE-REQUEST"), makeKeyword("CHILD-COMPLETED-METHOD"), makeSymbol("UIAT-CONCEPT-RECOGNIZER-CHILD-COMPLETED"), $CYCL,
			constant_handles.reader_make_constant_shell(makeString("CycConceptRecognizer")) });
	...
	static private final SubLList $list_alt266 = list(new SubLObject[] { $NAME, makeString("Relationship Suggestor"), makeKeyword("HINT-METHOD"), makeSymbol("UIAT-RELATIONSHIP-SUGGESTOR-HINT"), makeKeyword("GENERATE-REQUEST-METHOD"), makeSymbol("UIAT-RELATIONSHIP-SUGGESTOR-GENERATE-REQUEST"), makeKeyword("CHILD-COMPLETED-METHOD"), makeSymbol("UIAT-RELATIONSHIP-SUGGESTOR-CHILD-COMPLETED"),
			makeKeyword("HANDLE-REPLY-METHOD"), makeSymbol("UIAT-RELATIONSHIP-SUGGESTOR-HANDLE-REPLY"), $CYCL, constant_handles.reader_make_constant_shell(makeString("CycRelationshipSuggestor")) });
