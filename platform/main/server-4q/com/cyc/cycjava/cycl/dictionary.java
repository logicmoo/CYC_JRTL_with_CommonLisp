...
public final class dictionary extends SubLTranslatedFile {
    ...
    public static SubLObject dictionary_p(final SubLObject v_object) {
        return v_object.getClass() == dictionary.$dictionary_native.class ? T : NIL;
    }

    public static SubLObject dictionary_database(final SubLObject v_object) {
        assert NIL != dictionary_p(v_object) : "dictionary.dictionary_p(v_object) " + "CommonSymbols.NIL != dictionary.dictionary_p(v_object) " + v_object;
    ...
    public static SubLObject make_dictionary(SubLObject arglist) {
        ...
        final SubLObject v_new = new dictionary.$dictionary_native();
        SubLObject next;
    ...
    public static final class $dictionary_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(dictionary.$dictionary_native.class, DICTIONARY, DICTIONARY_P, $list3, $list4, new String[]{ "$database", "$test" }, $list5, $list6, PRINT_DICTIONARY);
        }
    }
