...
public final class dictionary extends SubLTranslatedFile {
	...
	public static SubLObject dictionary_like(final SubLObject v_object) {
		final boolean isDict = v_object.getClass() == $dictionary_native.class || v_object.isHashtable() || NIL != v_object.toLispObject().typep(DICTIONARY.toLispObject());
		return isDict ? T : NIL;
	}

	public static SubLObject dictionary_p(final SubLObject v_object) {
		final boolean isDict = v_object.getClass() == $dictionary_native.class || NIL != v_object.toLispObject().typep(DICTIONARY.toLispObject());
		return isDict ? T : NIL;
	}
