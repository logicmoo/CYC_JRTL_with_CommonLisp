...
import static com.cyc.cycjava.cycl.leader.parse_tree_gui.*;
...
public final class parse_tree_gui extends SubLTranslatedFile {
    ...
    public static SubLObject gui_enabled_document_p(final SubLObject v_object) {
        return v_object.getClass() == parse_tree_gui.$gui_enabled_document_native.class ? T : NIL;
    }

    public static SubLObject ged_sentences(final SubLObject v_object) {
        assert NIL != gui_enabled_document_p(v_object) : "parse_tree_gui.gui_enabled_document_p(v_object) " + "CommonSymbols.NIL != parse_tree_gui.gui_enabled_document_p(v_object) " + v_object;
    ...
    public static SubLObject make_gui_enabled_document(SubLObject arglist) {
        ...
        final SubLObject v_new = new parse_tree_gui.$gui_enabled_document_native();
        SubLObject next;
    ...
    public static SubLObject gui_enabled_sentence_p(final SubLObject v_object) {
        return v_object.getClass() == parse_tree_gui.$gui_enabled_sentence_native.class ? T : NIL;
    }

    public static SubLObject ges_surface_string(final SubLObject v_object) {
        assert NIL != gui_enabled_sentence_p(v_object) : "parse_tree_gui.gui_enabled_sentence_p(v_object) " + "CommonSymbols.NIL != parse_tree_gui.gui_enabled_sentence_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_gui_enabled_sentence(SubLObject arglist) {
        ...
        final SubLObject v_new = new parse_tree_gui.$gui_enabled_sentence_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $gui_enabled_document_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(parse_tree_gui.$gui_enabled_document_native.class, GUI_ENABLED_DOCUMENT, GUI_ENABLED_DOCUMENT_P, $list3, $list4, new String[]{ "$sentences", "$parser", "$lexicon" }, $list5, $list6, PPRINT_GED);
        }
    }
    ...
    public static final class $gui_enabled_sentence_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(parse_tree_gui.$gui_enabled_sentence_native.class, GUI_ENABLED_SENTENCE, GUI_ENABLED_SENTENCE_P, $list31, $list32, new String[]{ "$surface_string", "$gui_tokens", "$full_parse_tree", "$current_parse_tree", "$token_mapping", "$parent_document" }, $list33, $list34, PPRINT_GES);
        }
    }
