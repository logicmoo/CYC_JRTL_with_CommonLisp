...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class nl_parsing_api extends SubLTranslatedFile {
    ...
    public static SubLObject tag_relations_iterator_state_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$tag_relations_iterator_state_native.class ? T : NIL;
    }

    public static SubLObject tag_relations_iterator_state_sentence_iterator(final SubLObject v_object) {
        assert NIL != tag_relations_iterator_state_p(v_object) : "nl_parsing_api.tag_relations_iterator_state_p error :" + v_object;
    ...
    public static SubLObject sentence_cyclifier_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$sentence_cyclifier_native.class ? T : NIL;
    }

    public static SubLObject sentence_cyclifier_name(final SubLObject v_object) {
        assert NIL != sentence_cyclifier_p(v_object) : "nl_parsing_api.sentence_cyclifier_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $tag_relations_iterator_state_native extends SubLStructNative {
        ...
        private $tag_relations_iterator_state_native() {
    ...
    public static final class $sentence_cyclifier_native extends SubLStructNative {
        ...
        private $sentence_cyclifier_native() {
            this.$name = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative($sentence_cyclifier_native.class, SENTENCE_CYCLIFIER, SENTENCE_CYCLIFIER_P, $list55, $list56, new String[]{ "$name", "$cyclify_method", "$lexicon_method" }, $list57, $list58, PRINT_SENTENCE_CYCLIFIER);
        }
    }
