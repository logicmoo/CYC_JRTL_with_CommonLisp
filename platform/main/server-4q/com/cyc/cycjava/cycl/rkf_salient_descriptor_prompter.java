...
import com.cyc.cycjava.cycl.rkf_salient_descriptor_prompter;
...
import static com.cyc.cycjava.cycl.rkf_salient_descriptor_prompter.*;
...
public final class rkf_salient_descriptor_prompter extends SubLTranslatedFile {
    ...
    public static final SubLList $list3 = list(list(makeSymbol("PROMPTER"), makeSymbol("WHOSTATE")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLSymbol $sym4$LOCK = makeUninternedSymbol("LOCK");



    public static final SubLSymbol RKF_SALIENT_DESCRIPTOR_PROMPTER_LOOKUP = makeSymbol("RKF-SALIENT-DESCRIPTOR-PROMPTER-LOOKUP");

    public static final SubLList $list7 = list(makeKeyword("LOCK"));





    public static final SubLList $list10 = list(list(makeSymbol("PROMPTER")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLSymbol $sym11$STATE = makeUninternedSymbol("STATE");

    public static final SubLList $list12 = list(makeKeyword("MEMOIZATION-STATE"), list(makeSymbol("CURRENT-MEMOIZATION-STATE")));



    public static final SubLSymbol $rkf_sd_problem_store$ = makeSymbol("*RKF-SD-PROBLEM-STORE*");

    public static final SubLSymbol RKF_SD_PROMPTER_FIND_OR_SET_PROBLEM_STORE = makeSymbol("RKF-SD-PROMPTER-FIND-OR-SET-PROBLEM-STORE");

    public static final SubLSymbol REUSING_RKF_SD_PROBLEM_STORE = makeSymbol("REUSING-RKF-SD-PROBLEM-STORE");

    public static final SubLSymbol WITH_RKF_SD_PROMPTER_PROBLEM_STORE = makeSymbol("WITH-RKF-SD-PROMPTER-PROBLEM-STORE");
    ...
    private static final SubLList $list48 = list(list(makeKeyword("FORT"), makeSymbol("RKF-SD-PROMPTER-SUGGESTION"), makeSymbol("RKF-SD-PROMPTER-ANALOGIZE"), makeSymbol("RKF-SD-PROMPTER-RULES-FOR-TERM"), makeSymbol("RKF-SD-PROMPTER-INDUCED")), list(makeKeyword("EXAMPLE-INSTANCE"), makeSymbol("RKF-SD-PROMPTER-SUGGESTION"), makeSymbol("RKF-SD-PROMPTER-EXAMPLE-INSTANCE-NONINDUCED"), makeSymbol("RKF-SD-PROMPTER-EXAMPLE-INSTANCE-INDUCED-STRONG"), makeSymbol("RKF-SD-PROMPTER-EXAMPLE-INSTANCE-INDUCED-WEAK")), list(makeKeyword("GAF")), list(makeKeyword("MT"), makeSymbol("RKF-SD-PROMPTER-INTERACTION-CONTEXT-REQUIRED"), makeSymbol("RKF-SD-PROMPTER-INTERACTION-CONTEXT-STRONG")), list(makeKeyword("RULE"), makeSymbol("RKF-SD-PROMPTER-FIND-RULE-PROMPTS")));

    public static final SubLList $list49 = list(list(makeSymbol("TABLE")), makeSymbol("&BODY"), makeSymbol("BODY"));
    ...
    private static final SubLObject $const63$focalTermPositionForFormulaTempla = reader_make_constant_shell(makeString("focalTermPositionForFormulaTemplate"));
    ...
    public static final SubLList $list68 = list(makeSymbol("GLOSS"), makeSymbol("COLLECTION"), makeSymbol("EXPLANATION"));

    private static final SubLObject $$SpecsFn = reader_make_constant_shell(makeString("SpecsFn"));

    private static final SubLObject $const70$templateReplacementsInvisibleForP = reader_make_constant_shell(makeString("templateReplacementsInvisibleForPosition"));
    ...
    private static final SubLList $list93 = list(reader_make_constant_shell(makeString("FormulaTemplate")));
    ...
    private static final SubLObject $const101$focalTermTypeForInducedTemplateTy = reader_make_constant_shell(makeString("focalTermTypeForInducedTemplateType"));
    ...
    public static final SubLString $str119$attempting_to_bind_direction_link = makeString("attempting to bind direction link variable, to NIL. macro body not executed.");

    public static final SubLString $str120$Node__a_does_not_pass_sbhl_type_t = makeString("Node ~a does not pass sbhl-type-test ~a~%");

    public static final SubLList $list121 = list(reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("formulaTemplateHasType")));

    public static final SubLString $str122$Hey_ho___S_has_got_to_go___ = makeString("Hey ho. ~S has got to go.~%");

    public static final SubLSymbol $sym123$ISA_COLLECTION_ = makeSymbol("ISA-COLLECTION?");

    public static final SubLList $list124 = list(list(makeKeyword("EXAMPLE-INSTANCE"), makeSymbol("RKF-SD-PROMPTER-EXAMPLE-INSTANCE-INDUCED-STRONG"), makeSymbol("RKF-SD-PROMPTER-EXAMPLE-INSTANCE-INDUCED-WEAK")));





    public static final SubLList $list127 = list(list(makeSymbol("SEED-TERM-TYPE"), makeSymbol("TACTIC")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLSymbol $sym128$TACTICS_FOR_SEED_TERM_TYPE = makeUninternedSymbol("TACTICS-FOR-SEED-TERM-TYPE");

    public static final SubLSymbol $sym129$TACTICS_TABLE_COPY = makeUninternedSymbol("TACTICS-TABLE-COPY");



    public static final SubLSymbol RKF_SD_PROMPTER_TACTICS_FOR_SEED_TERM_TYPE = makeSymbol("RKF-SD-PROMPTER-TACTICS-FOR-SEED-TERM-TYPE");

    public static final SubLList $list132 = list(list(makeSymbol("FUNCTION"), EQ));

    public static final SubLList $list133 = list(list(makeSymbol("COPY-TREE"), makeSymbol("*RKF-SD-SEED-TERM-TACTICS-TABLE*")));

    public static final SubLSymbol ALIST_ENTER = makeSymbol("ALIST-ENTER");

    public static final SubLList $list135 = list(list(makeSymbol("SEED-TERM-TYPE"), makeSymbol("TACTICS")), makeSymbol("&BODY"), makeSymbol("BODY"));

    public static final SubLSymbol $sym136$TACTICS_FOR_SEED_TERM_TYPE = makeUninternedSymbol("TACTICS-FOR-SEED-TERM-TYPE");

    public static final SubLSymbol $sym137$TACTICS_TABLE_COPY = makeUninternedSymbol("TACTICS-TABLE-COPY");

    public static final SubLList $list138 = list(makeSymbol("NON-DOTTED-LIST-P"));

    public static final SubLSymbol ORDERED_SET_DIFFERENCE = makeSymbol("ORDERED-SET-DIFFERENCE");

    private static final SubLObject $$keSuggestion = reader_make_constant_shell(makeString("keSuggestion"));
    ...
    public static final SubLList $list144 = list(makeSymbol("FORMULAS"), makeSymbol("JUSTIFICATIONS"));

    private static final SubLSymbol $KE_DRIVEN_PROMPTS = makeKeyword("KE-DRIVEN-PROMPTS");

    public static final SubLSymbol RKF_NEIGHBOR_SUGGESTIONS = makeSymbol("RKF-NEIGHBOR-SUGGESTIONS");
    ...
    public static final SubLList $list149 = cons(makeSymbol("INFERENCE"), makeSymbol("FORMULA-VAR"));

    public static final SubLString $str150$Timed_out_after__S_seconds_gettin = makeString("Timed out after ~S seconds getting ~S for ~S.~%");

    private static final SubLSymbol $PROBABLY_APPROXIMATELY_DONE = makeKeyword("PROBABLY-APPROXIMATELY-DONE");

    public static final SubLString $str152$P_A_D__getting__S_for__S___ = makeString("P.A.D. getting ~S for ~S.~%");



    public static final SubLString $str154$_S_is_not_continuable____Exit_con = makeString("~S is not continuable.~% Exit condition: ~S~%");

    public static final SubLSymbol $sym155$_SEED_TERM = makeSymbol("?SEED-TERM");

    public static final SubLString $str156$Suppressing_SD_prompt_for__S_____ = makeString("Suppressing SD prompt for ~S:~% ~S~% Couldn't find the minimum ~S similar terms about which that is known.~%");

    public static final SubLSymbol RKF_SD_SUPPRESS_FORMULA_THRESHOLD_FOR_PROPERTY = makeSymbol("RKF-SD-SUPPRESS-FORMULA-THRESHOLD-FOR-PROPERTY");



    private static final SubLList $list159 = list(NIL);

    public static final SubLList $list160 = cons(makeSymbol("INFERENCE"), makeSymbol("VAR"));
    ...
    private static final SubLObject $$similarTo = reader_make_constant_shell(makeString("similarTo"));
    ...
    public static final SubLList $list198 = list(reader_make_constant_shell(makeString("SubLString")), reader_make_constant_shell(makeString("CycLAssertion")));
    ...
    private static final SubLObject $$CoaDiagramObject = reader_make_constant_shell(makeString("CoaDiagramObject"));
    ...
    public static SubLObject rkf_salient_descriptor_prompter_prune_unused_prompts(final SubLObject prompter) {
        assert NIL != rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompter_p(prompter) : "rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompter_p(prompter) " + "CommonSymbols.NIL != rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompter_p(prompter) " + prompter;
    ...
    public static SubLObject rkf_salient_descriptor_prompter_replace_prompt(final SubLObject prompter, final SubLObject prompt) {
        assert NIL != rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompter_p(prompter) : "rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompter_p(prompter) " + "CommonSymbols.NIL != rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompter_p(prompter) " + prompter;
        assert NIL != rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompt_p(prompt) : "rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompt_p(prompt) " + "CommonSymbols.NIL != rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompt_p(prompt) " + prompt;
    ...
    public static SubLObject formula_template_fort_for_rkf_salient_descriptor_prompt(final SubLObject prompt, final SubLObject topic_id) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompt_p(prompt) : "rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompt_p(prompt) " + "CommonSymbols.NIL != rkf_salient_descriptor_datastructures.rkf_salient_descriptor_prompt_p(prompt) " + prompt;
        assert NIL != forts.fort_p(topic_id) : "forts.fort_p(topic_id) " + "CommonSymbols.NIL != forts.fort_p(topic_id) " + topic_id;
    ...
    public static SubLObject rkf_induced_salient_descriptor_prompts_for_focal_term_type(final SubLObject focal_term_type, final SubLObject elmt) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != fort_types_interface.isa_collectionP(focal_term_type, UNPROVIDED) : "fort_types_interface.isa_collectionP(focal_term_type, CommonSymbols.UNPROVIDED) " + "CommonSymbols.NIL != fort_types_interface.isa_collectionP(focal_term_type, CommonSymbols.UNPROVIDED) " + focal_term_type;
        SubLObject prompts = NIL;
        final SubLObject table = $list124;
        assert NIL != list_utilities.alist_p(table) : "list_utilities.alist_p(table) " + "CommonSymbols.NIL != list_utilities.alist_p(table) " + table;
    ...
    public static SubLObject declare_rkf_salient_descriptor_prompter_file() {
        declareFunction(me, "rkf_salient_descriptor_prompter_prune_unused_prompts", "RKF-SALIENT-DESCRIPTOR-PROMPTER-PRUNE-UNUSED-PROMPTS", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_prompt_count", "RKF-SALIENT-DESCRIPTOR-PROMPTER-PROMPT-COUNT", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_note_generator_thread", "RKF-SALIENT-DESCRIPTOR-PROMPTER-NOTE-GENERATOR-THREAD", 2, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_clear_generator_thread", "RKF-SALIENT-DESCRIPTOR-PROMPTER-CLEAR-GENERATOR-THREAD", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_candidate_p", "RKF-SALIENT-DESCRIPTOR-CANDIDATE-P", 1, 0, false);
        declareMacro(me, "with_rkf_sd_prompter_lock_held", "WITH-RKF-SD-PROMPTER-LOCK-HELD");
        declareMacro(me, "with_rkf_sd_prompter_memoization_state", "WITH-RKF-SD-PROMPTER-MEMOIZATION-STATE");
        declareMacro(me, "with_rkf_sd_prompter_problem_store", "WITH-RKF-SD-PROMPTER-PROBLEM-STORE");
        declareFunction(me, "rkf_sd_examples_for_prompt", "RKF-SD-EXAMPLES-FOR-PROMPT", 3, 0, false);
        declareFunction(me, "rkf_sd_prompter_find_or_set_problem_store", "RKF-SD-PROMPTER-FIND-OR-SET-PROBLEM-STORE", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_reset_problem_store", "RKF-SALIENT-DESCRIPTOR-PROMPTER-RESET-PROBLEM-STORE", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_next", "RKF-SALIENT-DESCRIPTOR-PROMPTER-NEXT", 1, 1, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_finalize", "RKF-SALIENT-DESCRIPTOR-PROMPTER-FINALIZE", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_mark_prompt_used", "RKF-SD-PROMPTER-MARK-PROMPT-USED", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_remove_unused_prompt", "RKF-SD-PROMPTER-REMOVE-UNUSED-PROMPT", 2, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_has_generator_thread_p", "RKF-SALIENT-DESCRIPTOR-PROMPTER-HAS-GENERATOR-THREAD-P", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_unblock_generator_thread", "RKF-SALIENT-DESCRIPTOR-PROMPTER-UNBLOCK-GENERATOR-THREAD", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_generate_prompt", "RKF-SALIENT-DESCRIPTOR-PROMPTER-GENERATE-PROMPT", 1, 1, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_remove_prompt", "RKF-SALIENT-DESCRIPTOR-PROMPTER-REMOVE-PROMPT", 2, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_replace_prompt", "RKF-SALIENT-DESCRIPTOR-PROMPTER-REPLACE-PROMPT", 2, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_mt", "RKF-SALIENT-DESCRIPTOR-PROMPTER-MT", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_seed_term", "RKF-SALIENT-DESCRIPTOR-PROMPTER-SEED-TERM", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_pop_prompt_tactic", "RKF-SALIENT-DESCRIPTOR-PROMPTER-POP-PROMPT-TACTIC", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_prune_tactic_prompts", "RKF-SD-PROMPTER-PRUNE-TACTIC-PROMPTS", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_prune_bad_prompts", "RKF-SD-PROMPTER-PRUNE-BAD-PROMPTS", 1, 0, false);
        declareFunction(me, "rkf_sd_bad_promptP", "RKF-SD-BAD-PROMPT?", 1, 0, false);
        declareFunction(me, "rkf_sd_ok_support_p", "RKF-SD-OK-SUPPORT-P", 2, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_last_tactic", "RKF-SALIENT-DESCRIPTOR-PROMPTER-LAST-TACTIC", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_current_tactic", "RKF-SALIENT-DESCRIPTOR-PROMPTER-CURRENT-TACTIC", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_next_tactic", "RKF-SALIENT-DESCRIPTOR-PROMPTER-NEXT-TACTIC", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_current_tactic_string", "RKF-SALIENT-DESCRIPTOR-PROMPTER-CURRENT-TACTIC-STRING", 2, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_next_tactic_string", "RKF-SALIENT-DESCRIPTOR-PROMPTER-NEXT-TACTIC-STRING", 2, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompt_tactic_string", "RKF-SALIENT-DESCRIPTOR-PROMPT-TACTIC-STRING", 2, 0, false);
        declareFunction(me, "rkf_sd_string_for_tactic", "RKF-SD-STRING-FOR-TACTIC", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_best_prompt", "RKF-SD-PROMPTER-BEST-PROMPT", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_update_best_prompt", "RKF-SD-PROMPTER-UPDATE-BEST-PROMPT", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_sorted_unused_prompts", "RKF-SALIENT-DESCRIPTOR-PROMPTER-SORTED-UNUSED-PROMPTS", 1, 0, false);
        declareFunction(me, "rkf_sd_better_promptP", "RKF-SD-BETTER-PROMPT?", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_knownP", "RKF-SD-PROMPTER-KNOWN?", 4, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompter_find_prompt_by_id", "RKF-SALIENT-DESCRIPTOR-PROMPTER-FIND-PROMPT-BY-ID", 2, 0, false);
        declareFunction(me, "rkf_sd_prompt_maybe_compute_subprompts", "RKF-SD-PROMPT-MAYBE-COMPUTE-SUBPROMPTS", 1, 0, false);
        declareFunction(me, "rkf_sd_prompt_compute_subprompts", "RKF-SD-PROMPT-COMPUTE-SUBPROMPTS", 1, 0, false);
        declareFunction(me, "rkf_sd_prompt_missing_examplesP", "RKF-SD-PROMPT-MISSING-EXAMPLES?", 1, 0, false);
        declareFunction(me, "rkf_salient_descriptor_followup_prompt_via_prompter", "RKF-SALIENT-DESCRIPTOR-FOLLOWUP-PROMPT-VIA-PROMPTER", 3, 0, false);
        declareFunction(me, "rkf_salient_descriptor_followup_prompt", "RKF-SALIENT-DESCRIPTOR-FOLLOWUP-PROMPT", 3, 0, false);
        declareFunction(me, "positive_gaf_cnfs_p", "POSITIVE-GAF-CNFS-P", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_add_prompt", "RKF-SD-PROMPTER-ADD-PROMPT", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_add_to_unused_prompts", "RKF-SD-PROMPTER-ADD-TO-UNUSED-PROMPTS", 2, 0, false);
        declareFunction(me, "rkf_sd_prompt_E", "RKF-SD-PROMPT-=", 2, 0, false);
        declareFunction(me, "rkf_sd_prompt_formula_E", "RKF-SD-PROMPT-FORMULA-=", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_find_prompt_by_id_string", "RKF-SD-PROMPTER-FIND-PROMPT-BY-ID-STRING", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_find_prompt_by_id", "RKF-SD-PROMPTER-FIND-PROMPT-BY-ID", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_prefer_promptP", "RKF-SD-PROMPTER-PREFER-PROMPT?", 4, 0, false);
        declareFunction(me, "rkf_sd_prompt_localityG", "RKF-SD-PROMPT-LOCALITY>", 3, 0, false);
        declareFunction(me, "rkf_sd_prompt_local_supports", "RKF-SD-PROMPT-LOCAL-SUPPORTS", 2, 0, false);
        declareFunction(me, "rkf_sd_more_recent_supportsP", "RKF-SD-MORE-RECENT-SUPPORTS?", 2, 0, false);
        declareFunction(me, "rkf_sd_prompt_generalityL", "RKF-SD-PROMPT-GENERALITY<", 2, 0, false);
        declareFunction(me, "rkf_sd_sentence_generalityL", "RKF-SD-SENTENCE-GENERALITY<", 2, 0, false);
        declareFunction(me, "rkf_sd_sentence_generality", "RKF-SD-SENTENCE-GENERALITY", 1, 0, false);
        declareFunction(me, "rkf_sd_terms_generality", "RKF-SD-TERMS-GENERALITY", 1, 0, false);
        declareFunction(me, "rkf_sd_term_generality", "RKF-SD-TERM-GENERALITY", 1, 0, false);
        declareFunction(me, "rkf_sd_prompt_fewer_lits_p", "RKF-SD-PROMPT-FEWER-LITS-P", 2, 0, false);
        declareFunction(me, "rkf_sd_prompt_min_lit_count", "RKF-SD-PROMPT-MIN-LIT-COUNT", 1, 0, false);
        declareFunction(me, "rkf_sd_cnf_lit_count", "RKF-SD-CNF-LIT-COUNT", 1, 0, false);
        declareMacro(me, "with_rkf_salient_descriptor_seed_term_tactics_table", "WITH-RKF-SALIENT-DESCRIPTOR-SEED-TERM-TACTICS-TABLE");
        declareFunction(me, "rkf_sd_prompter_tactics_for_seed_term_type", "RKF-SD-PROMPTER-TACTICS-FOR-SEED-TERM-TYPE", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_compute_seed_term_type", "RKF-SD-PROMPTER-COMPUTE-SEED-TERM-TYPE", 1, 0, false);
        declareFunction(me, "formula_template_fort_for_rkf_salient_descriptor_prompt", "FORMULA-TEMPLATE-FORT-FOR-RKF-SALIENT-DESCRIPTOR-PROMPT", 2, 0, false);
        declareFunction(me, "find_or_create_formula_template_fort", "FIND-OR-CREATE-FORMULA-TEMPLATE-FORT", 6, 0, false);
        declareFunction(me, "formula_template_definitional_properties", "FORMULA-TEMPLATE-DEFINITIONAL-PROPERTIES", 7, 0, false);
        declareFunction(me, "rkf_sd_fet_data_assert_mt", "RKF-SD-FET-DATA-ASSERT-MT", 2, 0, false);
        declareFunction(me, "rkf_sd_fet_find_match", "RKF-SD-FET-FIND-MATCH", 1, 1, false);
        declareFunction(me, "rkf_sd_fet_assert", "RKF-SD-FET-ASSERT", 1, 0, false);
        declareFunction(me, "rkf_sd_new_formula_template_fort", "RKF-SD-NEW-FORMULA-TEMPLATE-FORT", 1, 0, false);
        declareFunction(me, "rkf_sd_candidate_replacement_info", "RKF-SD-CANDIDATE-REPLACEMENT-INFO", 2, 0, false);
        declareFunction(me, "rkf_sd_prompt_get_var_arg_positions", "RKF-SD-PROMPT-GET-VAR-ARG-POSITIONS", 2, 0, false);
        declareFunction(me, "rkf_sd_prompt_get_precedent_example_sentences", "RKF-SD-PROMPT-GET-PRECEDENT-EXAMPLE-SENTENCES", 2, 0, false);
        declareFunction(me, "rkf_sd_single_entry_promptP", "RKF-SD-SINGLE-ENTRY-PROMPT?", 2, 0, false);
        declareFunction(me, "rkf_sd_hide_specs_fn_replacements", "RKF-SD-HIDE-SPECS-FN-REPLACEMENTS", 1, 0, false);
        declareFunction(me, "prune_rkf_sd_formula_template_topic", "PRUNE-RKF-SD-FORMULA-TEMPLATE-TOPIC", 1, 0, false);
        declareFunction(me, "focal_term_type_has_template_with_bin_predP", "FOCAL-TERM-TYPE-HAS-TEMPLATE-WITH-BIN-PRED?", 2, 0, false);
        declareFunction(me, "rkf_induced_salient_descriptor_prompts_for_focal_term_type", "RKF-INDUCED-SALIENT-DESCRIPTOR-PROMPTS-FOR-FOCAL-TERM-TYPE", 2, 0, false);
        declareFunction(me, "rkf_salient_descriptor_prompts_for_focal_term_type", "RKF-SALIENT-DESCRIPTOR-PROMPTS-FOR-FOCAL-TERM-TYPE", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_apply_tactics", "RKF-SD-PROMPTER-APPLY-TACTICS", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_exhausted_p", "RKF-SD-PROMPTER-EXHAUSTED-P", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_tactics_exhausted_p", "RKF-SD-PROMPTER-TACTICS-EXHAUSTED-P", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_tactics_next", "RKF-SD-PROMPTER-TACTICS-NEXT", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_apply_tactic", "RKF-SD-PROMPTER-APPLY-TACTIC", 2, 0, false);
        declareMacro(me, "with_sd_tactic_disabled_for_seed_term_type", "WITH-SD-TACTIC-DISABLED-FOR-SEED-TERM-TYPE");
        declareMacro(me, "with_sd_tactics_disabled_for_seed_term_type", "WITH-SD-TACTICS-DISABLED-FOR-SEED-TERM-TYPE");
        declareFunction(me, "rkf_sd_prompter_suggestion", "RKF-SD-PROMPTER-SUGGESTION", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_required", "RKF-SD-PROMPTER-REQUIRED", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_interaction_context_required", "RKF-SD-PROMPTER-INTERACTION-CONTEXT-REQUIRED", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_interaction_context_strong", "RKF-SD-PROMPTER-INTERACTION-CONTEXT-STRONG", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_add_ke_driven_prompts", "RKF-SD-PROMPTER-ADD-KE-DRIVEN-PROMPTS", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_ke_driven_prompt_fodder", "RKF-SD-PROMPTER-KE-DRIVEN-PROMPT-FODDER", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_update_ke_driven_prompts", "RKF-SD-PROMPTER-UPDATE-KE-DRIVEN-PROMPTS", 3, 0, false);
        declareFunction(me, "rkf_sd_prompter_compute_ke_driven_prompt_fodder", "RKF-SD-PROMPTER-COMPUTE-KE-DRIVEN-PROMPT-FODDER", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_iterative_prompt_method_p", "RKF-SD-PROMPTER-ITERATIVE-PROMPT-METHOD-P", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_get_ke_driven_prompt_formulas", "RKF-SD-PROMPTER-GET-KE-DRIVEN-PROMPT-FORMULAS", 2, 0, false);
        declareFunction(me, "rkf_sd_suppress_formula_for_seed_termP", "RKF-SD-SUPPRESS-FORMULA-FOR-SEED-TERM?", 4, 0, false);
        declareFunction(me, "rkf_sd_suppress_formula_threshold", "RKF-SD-SUPPRESS-FORMULA-THRESHOLD", 3, 0, false);
        declareFunction(me, "rkf_sd_suppress_formula_threshold_for_property_internal", "RKF-SD-SUPPRESS-FORMULA-THRESHOLD-FOR-PROPERTY-INTERNAL", 2, 3, false);
        declareFunction(me, "rkf_sd_suppress_formula_threshold_for_property", "RKF-SD-SUPPRESS-FORMULA-THRESHOLD-FOR-PROPERTY", 2, 3, false);
        declareFunction(me, "rkf_sd_suppress_formula_test_query", "RKF-SD-SUPPRESS-FORMULA-TEST-QUERY", 3, 0, false);
        declareFunction(me, "rkf_sd_prompter_ke_driven_inference_and_var", "RKF-SD-PROMPTER-KE-DRIVEN-INFERENCE-AND-VAR", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_analogize", "RKF-SD-PROMPTER-ANALOGIZE", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_get_analogous_terms", "RKF-SD-PROMPTER-GET-ANALOGOUS-TERMS", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_clear_analogous_terms", "RKF-SD-PROMPTER-CLEAR-ANALOGOUS-TERMS", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_add_analogy_prompt", "RKF-SD-PROMPTER-ADD-ANALOGY-PROMPT", 3, 0, false);
        declareFunction(me, "rkf_sd_prompt_add_analogy_examples", "RKF-SD-PROMPT-ADD-ANALOGY-EXAMPLES", 4, 0, false);
        declareFunction(me, "rkf_sd_prompter_loosen_analogy_formula", "RKF-SD-PROMPTER-LOOSEN-ANALOGY-FORMULA", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_uneditable_analogy_argP", "RKF-SD-PROMPTER-UNEDITABLE-ANALOGY-ARG?", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_analogy_var", "RKF-SD-PROMPTER-ANALOGY-VAR", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_get_analogy_suggestions", "RKF-SD-PROMPTER-GET-ANALOGY-SUGGESTIONS", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_clear_analogy_suggestions", "RKF-SD-PROMPTER-CLEAR-ANALOGY-SUGGESTIONS", 1, 0, false);
        declareFunction(me, "rkf_sd_analogy_justifications", "RKF-SD-ANALOGY-JUSTIFICATIONS", 4, 0, false);
        declareFunction(me, "rkf_sd_prompter_rules_for_term", "RKF-SD-PROMPTER-RULES-FOR-TERM", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_rule_table_pop", "RKF-SD-PROMPTER-RULE-TABLE-POP", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_rule_table", "RKF-SD-PROMPTER-RULE-TABLE", 2, 0, false);
        declareFunction(me, "rkf_sd_sort_rule_tuples", "RKF-SD-SORT-RULE-TUPLES", 1, 0, false);
        declareFunction(me, "rkf_sd_remove_low_scoring_tuples", "RKF-SD-REMOVE-LOW-SCORING-TUPLES", 1, 0, false);
        declareFunction(me, "rkf_sd_low_scoring_tuple_p", "RKF-SD-LOW-SCORING-TUPLE-P", 1, 0, false);
        declareFunction(me, "rkf_sd_score_rule_tuples", "RKF-SD-SCORE-RULE-TUPLES", 1, 0, false);
        declareFunction(me, "rkf_sd_get_other_rules", "RKF-SD-GET-OTHER-RULES", 4, 0, false);
        declareFunction(me, "rkf_sd_get_isa_rules", "RKF-SD-GET-ISA-RULES", 5, 0, false);
        declareFunction(me, "rkf_sd_get_genls_rules", "RKF-SD-GET-GENLS-RULES", 5, 0, false);
        declareFunction(me, "rkf_sd_rule_tuple_E", "RKF-SD-RULE-TUPLE-=", 2, 0, false);
        declareFunction(me, "rkf_sd_score_rule_tuple", "RKF-SD-SCORE-RULE-TUPLE", 1, 0, false);
        declareFunction(me, "rkf_sd_prefer_rule_tupleP", "RKF-SD-PREFER-RULE-TUPLE?", 2, 0, false);
        declareFunction(me, "rkf_sd_rule_info_score_G", "RKF-SD-RULE-INFO-SCORE->", 2, 0, false);
        declareFunction(me, "rkf_sd_rule_score_do_test", "RKF-SD-RULE-SCORE-DO-TEST", 3, 0, false);
        declareFunction(me, "rkf_sd_rst_seed_term_in_pos_lits", "RKF-SD-RST-SEED-TERM-IN-POS-LITS", 2, 0, false);
        declareFunction(me, "rkf_sd_rst_seed_term_in_neg_lits", "RKF-SD-RST-SEED-TERM-IN-NEG-LITS", 2, 0, false);
        declareFunction(me, "rkf_sd_rst_var_count", "RKF-SD-RST-VAR-COUNT", 2, 0, false);
        declareFunction(me, "rkf_sd_rst_neg_lit_count", "RKF-SD-RST-NEG-LIT-COUNT", 2, 0, false);
        declareFunction(me, "rkf_sd_rst_pos_lit_count", "RKF-SD-RST-POS-LIT-COUNT", 2, 0, false);
        declareFunction(me, "rkf_sd_rst_mt_generality", "RKF-SD-RST-MT-GENERALITY", 2, 0, false);
        declareFunction(me, "rkf_sd_rst_pos_lit_quality", "RKF-SD-RST-POS-LIT-QUALITY", 2, 0, false);
        declareFunction(me, "rkf_sd_tuple_mt_generality", "RKF-SD-TUPLE-MT-GENERALITY", 1, 0, false);
        declareFunction(me, "rkf_sd_cnf_rule_count", "RKF-SD-CNF-RULE-COUNT", 1, 0, false);
        declareFunction(me, "rkf_sd_el_cnf_from_rule_tuple", "RKF-SD-EL-CNF-FROM-RULE-TUPLE", 1, 0, false);
        declareFunction(me, "rkf_sd_gaf_okP", "RKF-SD-GAF-OK?", 1, 0, false);
        declareFunction(me, "rkf_sd_gaf_generality_okP", "RKF-SD-GAF-GENERALITY-OK?", 1, 0, false);
        declareFunction(me, "rkf_sd_term_too_generalP", "RKF-SD-TERM-TOO-GENERAL?", 1, 0, false);
        declareFunction(me, "rkf_sd_gaf_rule_bindings", "RKF-SD-GAF-RULE-BINDINGS", 3, 1, false);
        declareFunction(me, "rkf_sd_gaf_lit_rule_bindings", "RKF-SD-GAF-LIT-RULE-BINDINGS", 3, 1, false);
        declareFunction(me, "rkf_sd_subprompts_matches_cnfP", "RKF-SD-SUBPROMPTS-MATCHES-CNF?", 2, 0, false);
        declareFunction(me, "rkf_sd_assert_sentence_matches_cnfP", "RKF-SD-ASSERT-SENTENCE-MATCHES-CNF?", 2, 0, false);
        declareFunction(me, "rkf_sd_assert_sentence_matches_neg_litP", "RKF-SD-ASSERT-SENTENCE-MATCHES-NEG-LIT?", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_strong", "RKF-SD-PROMPTER-STRONG", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_induced", "RKF-SD-PROMPTER-INDUCED", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_weak", "RKF-SD-PROMPTER-WEAK", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_compute_subpromptss", "RKF-SD-PROMPTER-COMPUTE-SUBPROMPTSS", 1, 0, false);
        declareFunction(me, "rkf_sd_prompt_bad_subpromptsP", "RKF-SD-PROMPT-BAD-SUBPROMPTS?", 2, 0, false);
        declareFunction(me, "rkf_sd_not_assertible_subpromptsP_internal", "RKF-SD-NOT-ASSERTIBLE-SUBPROMPTS?-INTERNAL", 1, 0, false);
        declareFunction(me, "rkf_sd_not_assertible_subpromptsP", "RKF-SD-NOT-ASSERTIBLE-SUBPROMPTS?", 1, 0, false);
        declareFunction(me, "rkf_sd_unparseable_subpromptsP_internal", "RKF-SD-UNPARSEABLE-SUBPROMPTS?-INTERNAL", 1, 0, false);
        declareFunction(me, "rkf_sd_unparseable_subpromptsP", "RKF-SD-UNPARSEABLE-SUBPROMPTS?", 1, 0, false);
        declareFunction(me, "rkf_sd_unparseable_prompt_litP_internal", "RKF-SD-UNPARSEABLE-PROMPT-LIT?-INTERNAL", 2, 0, false);
        declareFunction(me, "rkf_sd_unparseable_prompt_litP", "RKF-SD-UNPARSEABLE-PROMPT-LIT?", 2, 0, false);
        declareFunction(me, "rkf_unparseable_arg_typeP", "RKF-UNPARSEABLE-ARG-TYPE?", 1, 0, false);
        declareFunction(me, "rkf_no_instances_arg_typeP", "RKF-NO-INSTANCES-ARG-TYPE?", 1, 0, false);
        declareFunction(me, "rkf_direct_instances_arg_typeP", "RKF-DIRECT-INSTANCES-ARG-TYPE?", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_find_rule_prompts", "RKF-SD-PROMPTER-FIND-RULE-PROMPTS", 1, 0, false);
        declareFunction(me, "rkf_sd_prompt_justification_from_sentence", "RKF-SD-PROMPT-JUSTIFICATION-FROM-SENTENCE", 2, 0, false);
        declareFunction(me, "rkf_sd_prompt_from_cnf", "RKF-SD-PROMPT-FROM-CNF", 2, 0, false);
        declareFunction(me, "rkf_sd_prompt_formula_for_cnf", "RKF-SD-PROMPT-FORMULA-FOR-CNF", 2, 0, false);
        declareFunction(me, "rkf_sd_prompt_formula_for_lit", "RKF-SD-PROMPT-FORMULA-FOR-LIT", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_example_instance_induced_strong", "RKF-SD-PROMPTER-EXAMPLE-INSTANCE-INDUCED-STRONG", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_example_instance_induced_weak", "RKF-SD-PROMPTER-EXAMPLE-INSTANCE-INDUCED-WEAK", 1, 0, false);
        declareFunction(me, "rkf_sd_prompter_example_instance_induced", "RKF-SD-PROMPTER-EXAMPLE-INSTANCE-INDUCED", 2, 0, false);
        declareFunction(me, "rkf_sd_prompter_example_instance_noninduced", "RKF-SD-PROMPTER-EXAMPLE-INSTANCE-NONINDUCED", 1, 0, false);
        declareFunction(me, "rkf_sd_binary_pred_ok_for_promptsP", "RKF-SD-BINARY-PRED-OK-FOR-PROMPTS?", 1, 0, false);
        declareFunction(me, "rkf_binary_pred_arg2_unparseableP", "RKF-BINARY-PRED-ARG2-UNPARSEABLE?", 1, 0, false);
        declareFunction(me, "rkf_sd_prompt_example_instance_prompt", "RKF-SD-PROMPT-EXAMPLE-INSTANCE-PROMPT", 3, 0, false);
        declareFunction(me, "rkf_sd_prompt_example_instance_sentence", "RKF-SD-PROMPT-EXAMPLE-INSTANCE-SENTENCE", 3, 0, false);
        return NIL;
    }
