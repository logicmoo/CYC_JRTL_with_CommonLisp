...
import com.cyc.cycjava.cycl.cb_proof_view;
...
import static com.cyc.cycjava.cycl.cb_proof_view.*;
...
public final class cb_proof_view extends SubLTranslatedFile {
    ...
    public static SubLObject declare_cb_proof_view_file() {
        declareFunction(me, "cb_link_assertion_proof_view", "CB-LINK-ASSERTION-PROOF-VIEW", 1, 1, false);
        declareFunction(me, "cb_link_proof_view_bug", "CB-LINK-PROOF-VIEW-BUG", 1, 0, false);
        declareFunction(me, "cb_proof_view_bug_report", "CB-PROOF-VIEW-BUG-REPORT", 1, 0, false);
        declareFunction(me, "cb_process_proof_view_bug_report", "CB-PROCESS-PROOF-VIEW-BUG-REPORT", 1, 0, false);
        declareFunction(me, "cb_assertion_proof_view", "CB-ASSERTION-PROOF-VIEW", 1, 0, false);
        declareFunction(me, "cb_proof_view_assertion_answer", "CB-PROOF-VIEW-ASSERTION-ANSWER", 1, 0, false);
        declareFunction(me, "cb_proof_view_sentence_answer", "CB-PROOF-VIEW-SENTENCE-ANSWER", 2, 1, false);
        declareFunction(me, "clear_cb_proof_view_sentence_answer_cached", "CLEAR-CB-PROOF-VIEW-SENTENCE-ANSWER-CACHED", 0, 0, false);
        declareFunction(me, "remove_cb_proof_view_sentence_answer_cached", "REMOVE-CB-PROOF-VIEW-SENTENCE-ANSWER-CACHED", 2, 1, false);
        declareFunction(me, "cb_proof_view_sentence_answer_cached_internal", "CB-PROOF-VIEW-SENTENCE-ANSWER-CACHED-INTERNAL", 3, 0, false);
        declareFunction(me, "cb_proof_view_sentence_answer_cached", "CB-PROOF-VIEW-SENTENCE-ANSWER-CACHED", 2, 1, false);
        declareFunction(me, "cb_sentence_proof_view", "CB-SENTENCE-PROOF-VIEW", 1, 0, false);
        declareFunction(me, "dwim_cb_sentence_proof_view_mt", "DWIM-CB-SENTENCE-PROOF-VIEW-MT", 2, 0, false);
        declareFunction(me, "cb_link_simple_proof_view", "CB-LINK-SIMPLE-PROOF-VIEW", 2, 2, false);
        declareFunction(me, "find_or_create_cb_proof_view_memoization_state", "FIND-OR-CREATE-CB-PROOF-VIEW-MEMOIZATION-STATE", 1, 0, false);
        declareFunction(me, "cb_proof_view_initialize_memoization_state", "CB-PROOF-VIEW-INITIALIZE-MEMOIZATION-STATE", 2, 0, false);
        declareFunction(me, "cb_simple_proof_view", "CB-SIMPLE-PROOF-VIEW", 1, 0, false);
        declareFunction(me, "cb_launch_proof_view", "CB-LAUNCH-PROOF-VIEW", 3, 0, false);
        declareFunction(me, "extract_cb_proof_view_proof_and_answer", "EXTRACT-CB-PROOF-VIEW-PROOF-AND-ANSWER", 1, 0, false);
        declareFunction(me, "cb_proof_view_select_inference", "CB-PROOF-VIEW-SELECT-INFERENCE", 1, 0, false);
        declareFunction(me, "cb_proof_view_select_inference_answer", "CB-PROOF-VIEW-SELECT-INFERENCE-ANSWER", 1, 0, false);
        declareFunction(me, "cb_proof_view_select_inference_answer_proof", "CB-PROOF-VIEW-SELECT-INFERENCE-ANSWER-PROOF", 1, 0, false);
        declareFunction(me, "cb_link_show_proof_view", "CB-LINK-SHOW-PROOF-VIEW", 1, 2, false);
        declareFunction(me, "cb_show_proof_view", "CB-SHOW-PROOF-VIEW", 1, 0, false);
        declareFunction(me, "lookup_cb_proof_view", "LOOKUP-CB-PROOF-VIEW", 2, 0, false);
        declareFunction(me, "note_cb_proof_view", "NOTE-CB-PROOF-VIEW", 3, 0, false);
        declareFunction(me, "forget_cb_proof_view", "FORGET-CB-PROOF-VIEW", 2, 0, false);
        declareFunction(me, "kill_all_cb_proof_view_threads", "KILL-ALL-CB-PROOF-VIEW-THREADS", 0, 0, false);
        declareFunction(me, "launch_cb_proof_view_preparer", "LAUNCH-CB-PROOF-VIEW-PREPARER", 1, 0, false);
        declareFunction(me, "increment_cb_proof_view_entries_paraphrased", "INCREMENT-CB-PROOF-VIEW-ENTRIES-PARAPHRASED", 1, 0, false);
        declareFunction(me, "get_cb_proof_view_entries_paraphrased", "GET-CB-PROOF-VIEW-ENTRIES-PARAPHRASED", 1, 0, false);
        declareFunction(me, "prepare_cb_proof_view", "PREPARE-CB-PROOF-VIEW", 1, 0, false);
        declareFunction(me, "cb_proof_view_get_proof_view", "CB-PROOF-VIEW-GET-PROOF-VIEW", 2, 1, false);
        declareFunction(me, "cb_proof_view_compute_percent_ready", "CB-PROOF-VIEW-COMPUTE-PERCENT-READY", 2, 0, false);
        declareFunction(me, "cb_proof_view_compute_percent_ready_int", "CB-PROOF-VIEW-COMPUTE-PERCENT-READY-INT", 1, 0, false);
        declareFunction(me, "cb_simple_proof_view_guts", "CB-SIMPLE-PROOF-VIEW-GUTS", 2, 1, false);
        declareFunction(me, "note_cb_proof_view_time_estimate", "NOTE-CB-PROOF-VIEW-TIME-ESTIMATE", 3, 1, false);
        declareFunction(me, "log_cb_proof_view_time_estimate_results", "LOG-CB-PROOF-VIEW-TIME-ESTIMATE-RESULTS", 1, 1, false);
        declareFunction(me, "log_cb_proof_view_time_estimate_result", "LOG-CB-PROOF-VIEW-TIME-ESTIMATE-RESULT", 4, 0, false);
        declareFunction(me, "cb_proof_view_estimate_seconds_to_go", "CB-PROOF-VIEW-ESTIMATE-SECONDS-TO-GO", 2, 0, false);
        declareFunction(me, "clear_cb_proof_view_historical_fudge_factors", "CLEAR-CB-PROOF-VIEW-HISTORICAL-FUDGE-FACTORS", 0, 0, false);
        declareFunction(me, "remove_cb_proof_view_historical_fudge_factors", "REMOVE-CB-PROOF-VIEW-HISTORICAL-FUDGE-FACTORS", 0, 0, false);
        declareFunction(me, "cb_proof_view_historical_fudge_factors_internal", "CB-PROOF-VIEW-HISTORICAL-FUDGE-FACTORS-INTERNAL", 0, 0, false);
        declareFunction(me, "cb_proof_view_historical_fudge_factors", "CB-PROOF-VIEW-HISTORICAL-FUDGE-FACTORS", 0, 0, false);
        declareFunction(me, "adjust_cb_proof_view_estimate_wrt_historical_data", "ADJUST-CB-PROOF-VIEW-ESTIMATE-WRT-HISTORICAL-DATA", 2, 0, false);
        declareFunction(me, "cb_proof_view_progress_pacifier", "CB-PROOF-VIEW-PROGRESS-PACIFIER", 2, 0, false);
        declareFunction(me, "cb_show_proof_view_int", "CB-SHOW-PROOF-VIEW-INT", 1, 1, false);
        declareFunction(me, "cb_proof_view_destroyer", "CB-PROOF-VIEW-DESTROYER", 0, 0, false);
        declareFunction(me, "set_cb_proof_view_destruction_grace_period", "SET-CB-PROOF-VIEW-DESTRUCTION-GRACE-PERIOD", 1, 0, false);
        declareFunction(me, "destroy_cb_proof_view", "DESTROY-CB-PROOF-VIEW", 1, 0, false);
        declareFunction(me, "dreamcatcher_justify", "DREAMCATCHER-JUSTIFY", 1, 0, false);
        declareFunction(me, "set_dreamcatcher_proof_view_params", "SET-DREAMCATCHER-PROOF-VIEW-PARAMS", 1, 0, false);
        declareFunction(me, "proof_view_entry_generate_html_dreamcatcher", "PROOF-VIEW-ENTRY-GENERATE-HTML-DREAMCATCHER", 1, 0, false);
        return NIL;
    }
