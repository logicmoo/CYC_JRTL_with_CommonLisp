...
public final class abstract_lexicon extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLList $list0 = list(new SubLObject[]{ list(makeKeyword("."), reader_make_constant_shell(makeString("Punctuation-SP")), NIL), list(makeKeyword("WP"), reader_make_constant_shell(makeString("WHPronoun")), reader_make_constant_shell(makeString("pronounStrings"))), list(makeKeyword("``"), reader_make_constant_shell(makeString("Punctuation-SP")), NIL), list(makeKeyword("POS"), reader_make_constant_shell(makeString("PossessiveMarker")), reader_make_constant_shell(makeString("possessiveMarkerStrings"))), list(makeKeyword("RB"), reader_make_constant_shell(makeString("Adverb")), reader_make_constant_shell(makeString("regularAdverb"))), list(makeKeyword("JJ"), reader_make_constant_shell(makeString("Adjective")), reader_make_constant_shell(makeString("regularDegree"))), list(makeKeyword("''"), reader_make_constant_shell(makeString("Punctuation-SP")), NIL), list(makeKeyword("MD"), reader_make_constant_shell(makeString("Modal")), reader_make_constant_shell(makeString("verbStrings"))), list(makeKeyword("AUX"), reader_make_constant_shell(makeString("AuxVerb")), reader_make_constant_shell(makeString("verbStrings"))), list(makeKeyword("VB"), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("infinitive"))), list(makeKeyword("DT"), reader_make_constant_shell(makeString("Determiner")), reader_make_constant_shell(makeString("determinerStrings"))), list(makeKeyword("VBD"), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("pastTense-Generic"))), list(makeKeyword("NN"), reader_make_constant_shell(makeString("Noun")), reader_make_constant_shell(makeString("nonPlural-Generic"))), list(makeKeyword("NNS"), reader_make_constant_shell(makeString("Noun")), reader_make_constant_shell(makeString("plural-Generic"))), list(makeKeyword("VBG"), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("presentParticiple"))), list(makeKeyword("RP"), reader_make_constant_shell(makeString("VerbParticle")), NIL), list(makeKeyword("TO"), reader_make_constant_shell(makeString("InfinitiveComp")), NIL), list(makeKeyword("TO"), reader_make_constant_shell(makeString("Preposition")), reader_make_constant_shell(makeString("prepositionStrings"))), list(makeKeyword("CC"), reader_make_constant_shell(makeString("CoordinatingConjunction")), NIL), list(makeKeyword("JJR"), reader_make_constant_shell(makeString("Adjective")), reader_make_constant_shell(makeString("comparativeDegree"))), list(makeKeyword("RBR"), reader_make_constant_shell(makeString("Adverb")), reader_make_constant_shell(makeString("comparativeAdverb"))), list(makeKeyword("VBN"), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("perfect"))), list(makeKeyword("VBN"), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("passiveParticiple"))), list(makeKeyword("CD"), reader_make_constant_shell(makeString("Number-SP")), NIL), list(makeKeyword("JJS"), reader_make_constant_shell(makeString("Adjective")), reader_make_constant_shell(makeString("superlativeDegree"))), list(makeKeyword("RBS"), reader_make_constant_shell(makeString("Adverb")), reader_make_constant_shell(makeString("superlativeAdverb"))), list(makeKeyword("PDT"), reader_make_constant_shell(makeString("Predeterminer")), NIL), list(makeKeyword("VBP"), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("nonThirdSg-Present"))), list(makeKeyword("WRB"), reader_make_constant_shell(makeString("WHAdverb")), reader_make_constant_shell(makeString("regularAdverb"))), list(makeKeyword("WP$"), reader_make_constant_shell(makeString("WHPossessive")), NIL), list(makeKeyword("NNP"), reader_make_constant_shell(makeString("ProperNoun")), reader_make_constant_shell(makeString("nonPlural-Generic"))), list(makeKeyword("NNP"), reader_make_constant_shell(makeString("ProperNoun")), reader_make_constant_shell(makeString("nameSpelling"))), list(makeKeyword("NNPS"), reader_make_constant_shell(makeString("ProperNoun")), reader_make_constant_shell(makeString("plural-Generic"))), list(makeKeyword("WDT"), reader_make_constant_shell(makeString("WHDeterminer")), reader_make_constant_shell(makeString("determinerStrings"))), list(makeKeyword("PRP"), reader_make_constant_shell(makeString("Pronoun")), reader_make_constant_shell(makeString("pronounStrings"))), list(makeKeyword("VBZ"), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("thirdPersonSg-Present"))), list(makeKeyword("PRP$"), reader_make_constant_shell(makeString("PossessivePronoun")), NIL), list(makeKeyword("IN"), reader_make_constant_shell(makeString("Preposition")), reader_make_constant_shell(makeString("prepositionStrings"))), list(makeKeyword("IN"), reader_make_constant_shell(makeString("Complementizer")), NIL), list(makeKeyword("IN"), reader_make_constant_shell(makeString("SubordinatingConjunction")), NIL), list(makeKeyword("EX"), reader_make_constant_shell(makeString("There-Existential")), NIL), list(makeKeyword("UH"), reader_make_constant_shell(makeString("Interjection-SpeechPart")), NIL), list(makeKeyword(":"), reader_make_constant_shell(makeString("Punctuation-SP")), NIL), list(makeKeyword("$"), reader_make_constant_shell(makeString("Punctuation-SP")), NIL), list(makeKeyword(","), reader_make_constant_shell(makeString("Punctuation-SP")), NIL), list(makeKeyword(")"), reader_make_constant_shell(makeString("Punctuation-SP")), NIL), list(makeKeyword("("), reader_make_constant_shell(makeString("Punctuation-SP")), NIL) });

    public static final SubLSymbol $sym1$GENL_IN_ANY_MT_ = makeSymbol("GENL-IN-ANY-MT?");
    ...
    public static final SubLList $list8 = list(new SubLObject[]{ list(list(makeString("A_nx0V")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("IntransitiveVerbFrame")), reader_make_constant_shell(makeString("tensed"))), list(list(makeString("A_nx0V")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("MiddleVoiceFrame")), reader_make_constant_shell(makeString("tensed"))), list(list(makeString("A_nx0Vnx1")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("TransitiveNPFrame")), reader_make_constant_shell(makeString("tensed"))), list(list(makeString("A_nx0Vnx1nx2"), makeString("A_nx0Vnx2nx1")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("DitransitiveNP-NPFrame")), reader_make_constant_shell(makeString("tensed"))), list(list(makeString("A_nx0Vpnx1"), makeString("A_nx0Vpx1")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("TransitivePPFrameType")), reader_make_constant_shell(makeString("tensed"))), list(list(makeString("A_nx0Vnx1pnx2"), makeString("A_nx0Vnx1px2")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("DitransitivePPFrameType")), reader_make_constant_shell(makeString("tensed"))), list(list(makeString("A_nx0V")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("UnderstoodReciprocalObjectFrame")), reader_make_constant_shell(makeString("tensed"))), list(list(makeString("A_Gnx0V")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("IntransitiveVerbFrame")), reader_make_constant_shell(makeString("presentParticiple"))), list(list(makeString("A_Gnx0Vnx1")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("TransitiveNPFrame")), reader_make_constant_shell(makeString("presentParticiple"))), list(list(makeString("A_Gnx0Vnx1nx2")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("DitransitiveNP-NPFrame")), reader_make_constant_shell(makeString("presentParticiple"))), list(list(makeString("A_Gnx0Vpnx1"), makeString("A_Gnx0Vpx1")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("TransitivePPFrameType")), reader_make_constant_shell(makeString("presentParticiple"))), list(list(makeString("A_Gnx0Vnx1pnx2"), makeString("A_Gnx0Vnx1px2"), makeString("B_Nn")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("DitransitivePPFrameType")), reader_make_constant_shell(makeString("presentParticiple"))), list(list(makeString("B_Vvx")), reader_make_constant_shell(makeString("AuxVerb"))), list(list(makeString("A_NXN"), makeString("B_Nn")), reader_make_constant_shell(makeString("Noun")), reader_make_constant_shell(makeString("RegularNounFrame")), reader_make_constant_shell(makeString("nounStrings"))), list(list(makeString("A_NXN")), reader_make_constant_shell(makeString("Noun")), reader_make_constant_shell(makeString("GenitiveFrame")), reader_make_constant_shell(makeString("nounStrings"))), list(list(makeString("B_nxPnx")), reader_make_constant_shell(makeString("Preposition")), reader_make_constant_shell(makeString("Post-NounPhraseModifyingFrame")), reader_make_constant_shell(makeString("prepositionStrings"))), list(list(makeString("B_vxPnx")), reader_make_constant_shell(makeString("Preposition")), reader_make_constant_shell(makeString("VerbPhraseModifyingFrame")), reader_make_constant_shell(makeString("prepositionStrings"))), list(list(makeString("B_Dnx")), reader_make_constant_shell(makeString("Determiner"))), list(list(makeString("B_An")), reader_make_constant_shell(makeString("Adjective")), reader_make_constant_shell(makeString("RegularAdjFrame")), reader_make_constant_shell(makeString("adjStrings"))), list(list(makeString("B_vxARB"), makeString("B_ARBvx"), makeString("B_ARBs")), reader_make_constant_shell(makeString("Adverb")), reader_make_constant_shell(makeString("VerbPhraseModifyingFrame")), reader_make_constant_shell(makeString("adverbStrings"))) });

    private static final SubLObject $$GeneralEnglishMt = reader_make_constant_shell(makeString("GeneralEnglishMt"));

    public static final SubLSymbol TEXTRACT_LEMMA = makeSymbol("TEXTRACT-LEMMA");

    public static final SubLSymbol TEXTRACT_LEMMA_P = makeSymbol("TEXTRACT-LEMMA-P");

    public static final SubLList $list12 = list(makeSymbol("PARAGRAPH"), makeSymbol("SENTENCE"), makeSymbol("WORD"), makeSymbol("STRING"), makeSymbol("CANON"), makeSymbol("TYPE"));

    public static final SubLList $list13 = list(makeKeyword("PARAGRAPH"), makeKeyword("SENTENCE"), makeKeyword("WORD"), makeKeyword("STRING"), makeKeyword("CANON"), makeKeyword("TYPE"));

    public static final SubLList $list14 = list(makeSymbol("TEXTRACT-LEMMA-PARAGRAPH"), makeSymbol("TEXTRACT-LEMMA-SENTENCE"), makeSymbol("TEXTRACT-LEMMA-WORD"), makeSymbol("TEXTRACT-LEMMA-STRING"), makeSymbol("TEXTRACT-LEMMA-CANON"), makeSymbol("TEXTRACT-LEMMA-TYPE"));

    public static final SubLList $list15 = list(makeSymbol("_CSETF-TEXTRACT-LEMMA-PARAGRAPH"), makeSymbol("_CSETF-TEXTRACT-LEMMA-SENTENCE"), makeSymbol("_CSETF-TEXTRACT-LEMMA-WORD"), makeSymbol("_CSETF-TEXTRACT-LEMMA-STRING"), makeSymbol("_CSETF-TEXTRACT-LEMMA-CANON"), makeSymbol("_CSETF-TEXTRACT-LEMMA-TYPE"));

    public static final SubLSymbol TEXTRACT_LEMMA_PRINT = makeSymbol("TEXTRACT-LEMMA-PRINT");

    public static final SubLSymbol TEXTRACT_LEMMA_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("TEXTRACT-LEMMA-PRINT-FUNCTION-TRAMPOLINE");
    ...
    public static final SubLList $list46 = list(CHAR_lbracket, CHAR_rbracket);
    ...
    public static final SubLList $list52 = list(new SubLObject[]{ list(makeSymbol("STORED-PROPERTIES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(makeSymbol("QUOTE"), list(new SubLObject[]{ makeKeyword("STRING"), makeKeyword("WORD-UNIT"), makeKeyword("INFLECTIONS"), makeKeyword("PREDICATE"), makeKeyword("DENOTS"), makeKeyword("DENOT"), makeKeyword("PRAGMATICS"), makeKeyword("MT"), makeKeyword("SEMTRANS"), makeKeyword("FRAME"), makeKeyword("TRIE-ENTRY") }))), list(makeSymbol("COMPUTED-PROPERTIES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(makeSymbol("QUOTE"), list(cons(makeKeyword("PENN-TAGS"), makeSymbol("COMPUTE-PENN-TAGS")), cons(makeKeyword("BACKOFF-PENN-TAGS"), makeSymbol("COMPUTE-BACKOFF-PENN-TAGS")), cons(makeKeyword("TERM"), makeSymbol("COMPUTE-TERM")), cons(makeKeyword("GENDER"), makeSymbol("COMPUTE-GENDER")), cons(makeKeyword("SUPER-TAGS"), makeSymbol("COMPUTE-SUPER-TAGS")), cons(makeKeyword("CYC-POS"), makeSymbol("COMPUTE-CYC-POS")), cons(makeKeyword("CYC-CATEGORY"), makeSymbol("COMPUTE-CYC-CATEGORY")), cons(makeKeyword("IS-NER-ENTRY?"), makeSymbol("COMPUTE-IS-NER-ENTRY"))))), list(makeSymbol("SUPPORTED-PROPERTIES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(makeSymbol("APPEND"), list(makeSymbol("GET-SLOT"), list(makeSymbol("QUOTE"), makeSymbol("LEX-ENTRY")), list(makeSymbol("QUOTE"), makeSymbol("STORED-PROPERTIES"))), list(makeSymbol("MAPCAR"), list(makeSymbol("QUOTE"), makeSymbol("CAR")), list(makeSymbol("GET-SLOT"), list(makeSymbol("QUOTE"), makeSymbol("LEX-ENTRY")), list(makeSymbol("QUOTE"), makeSymbol("COMPUTED-PROPERTIES")))))), list(makeSymbol("PROPERTIES"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INITIALIZE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT"), list(makeSymbol("STREAM"), makeSymbol("DEPTH")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COPY"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET"), list(makeSymbol("PROPERTY")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET"), list(makeSymbol("PROPERTY"), makeSymbol("VALUE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NOMINAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("VERBAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADJECTIVAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADVERBIAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPUTE-PENN-TAGS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPUTE-BACKOFF-PENN-TAGS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPUTE-SUPER-TAGS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NOUN?"), NIL, makeKeyword("PUBLIC")) });
    ...
    private static final SubLList $list59 = list(cons(makeKeyword("PENN-TAGS"), makeSymbol("COMPUTE-PENN-TAGS")), cons(makeKeyword("BACKOFF-PENN-TAGS"), makeSymbol("COMPUTE-BACKOFF-PENN-TAGS")), cons(makeKeyword("TERM"), makeSymbol("COMPUTE-TERM")), cons(makeKeyword("GENDER"), makeSymbol("COMPUTE-GENDER")), cons(makeKeyword("SUPER-TAGS"), makeSymbol("COMPUTE-SUPER-TAGS")), cons(makeKeyword("CYC-POS"), makeSymbol("COMPUTE-CYC-POS")), cons(makeKeyword("CYC-CATEGORY"), makeSymbol("COMPUTE-CYC-CATEGORY")), cons(makeKeyword("IS-NER-ENTRY?"), makeSymbol("COMPUTE-IS-NER-ENTRY")));
    ...
    public static final SubLList $list66 = list(makeKeyword("PROTECTED"));

    public static final SubLList $list67 = list(makeString("@return lex-entry-p; a new empty lex-entry"), list(makeSymbol("INITIALIZE"), makeSymbol("SUPER")), list(makeSymbol("CSETQ"), makeSymbol("PROPERTIES"), NIL), list(makeSymbol("RET"), makeSymbol("SELF")));

    public static final SubLSymbol $sym68$OUTER_CATCH_FOR_LEX_ENTRY_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-LEX-ENTRY-METHOD");
    ...
    private static final SubLList $list73 = list(makeString("@return object; the property value associated with PROPERTY"), list(makeSymbol("MUST"), list(makeSymbol("MEMBER"), makeSymbol("PROPERTY"), list(makeSymbol("GET-SLOT"), list(makeSymbol("QUOTE"), makeSymbol("LEX-ENTRY")), list(makeSymbol("QUOTE"), makeSymbol("SUPPORTED-PROPERTIES")))), makeString("Unsupported lexical property ~a"), makeSymbol("PROPERTY")), list(makeSymbol("CLET"), list(list(makeSymbol("VALUE"), list(makeSymbol("CDR"), list(makeSymbol("ASSOC"), makeSymbol("PROPERTY"), makeSymbol("PROPERTIES"))))), list(makeSymbol("PUNLESS"), makeSymbol("VALUE"), list(makeSymbol("CLET"), list(list(makeSymbol("PROPERTY-METHOD"), list(makeSymbol("CDR"), list(makeSymbol("ASSOC"), makeSymbol("PROPERTY"), list(makeSymbol("GET-SLOT"), list(makeSymbol("QUOTE"), makeSymbol("LEX-ENTRY")), list(makeSymbol("QUOTE"), makeSymbol("COMPUTED-PROPERTIES"))))))), list(makeSymbol("PWHEN"), makeSymbol("PROPERTY-METHOD"), list(makeSymbol("CSETQ"), makeSymbol("VALUE"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), makeSymbol("PROPERTY-METHOD"))), list(makeSymbol("PWHEN"), makeSymbol("VALUE"), list(makeSymbol("CPUSH"), list(makeSymbol("CONS"), makeSymbol("PROPERTY"), makeSymbol("VALUE")), makeSymbol("PROPERTIES")))))), list(makeSymbol("RET"), makeSymbol("VALUE"))));
    ...
    public static final SubLList $list81 = list(makeSymbol("PROPERTY"), makeSymbol("VALUE"));

    private static final SubLList $list82 = list(makeString("Sets this lex-entry's PROPERTY to VALUE"), list(makeSymbol("MUST"), list(makeSymbol("MEMBER"), makeSymbol("PROPERTY"), list(makeSymbol("GET-SLOT"), list(makeSymbol("QUOTE"), makeSymbol("LEX-ENTRY")), list(makeSymbol("QUOTE"), makeSymbol("SUPPORTED-PROPERTIES")))), makeString("Unsupported lexical property ~a"), makeSymbol("PROPERTY")), list(makeSymbol("CSETQ"), makeSymbol("PROPERTIES"), list(makeSymbol("REMOVE"), makeSymbol("PROPERTY"), makeSymbol("PROPERTIES"), list(makeSymbol("QUOTE"), EQ), list(makeSymbol("QUOTE"), makeSymbol("FIRST")))), list(makeSymbol("CPUSH"), list(makeSymbol("CONS"), makeSymbol("PROPERTY"), makeSymbol("VALUE")), makeSymbol("PROPERTIES")), list(makeSymbol("RET"), makeSymbol("VALUE")));
    ...
    public static final SubLList $list87 = list(makeString("make a deep-copy of self"), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-ENTRY"), list(makeSymbol("NEW-CLASS-INSTANCE"), list(makeSymbol("QUOTE"), makeSymbol("LEX-ENTRY")))), list(makeSymbol("NEW-PROPERTIES"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("KEY.VAL"), makeSymbol("PROPERTIES")), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-KEY"), list(makeSymbol("CAR"), makeSymbol("KEY.VAL"))), list(makeSymbol("VAL"), list(makeSymbol("CDR"), makeSymbol("KEY.VAL"))), list(makeSymbol("NEW-VAL"), list(makeSymbol("FIF"), list(makeSymbol("LISTP"), makeSymbol("VAL")), list(makeSymbol("COPY-LIST"), makeSymbol("VAL")), makeSymbol("VAL")))), list(makeSymbol("CPUSH"), list(makeSymbol("CONS"), makeSymbol("NEW-KEY"), makeSymbol("NEW-VAL")), makeSymbol("NEW-PROPERTIES")))), list(makeSymbol("SET-SLOT"), makeSymbol("NEW-ENTRY"), list(makeSymbol("QUOTE"), makeSymbol("PROPERTIES")), makeSymbol("NEW-PROPERTIES")), list(makeSymbol("RET"), makeSymbol("NEW-ENTRY"))));
    ...
    public static final SubLList $list93 = list(makeString("@return booleanp; Does this LEX-ENTRY represent a noun?\n                     i.e. Is its :CYC-POS property value a spec of #$Noun?"), list(makeSymbol("CLET"), list(list(makeSymbol("POS"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("CYC-POS")))), list(makeSymbol("PIF"), list(EQ, makeSymbol("MT"), makeKeyword("ANY")), list(makeSymbol("RET"), list(makeSymbol("GENL-IN-ANY-MT?"), makeSymbol("POS"), reader_make_constant_shell(makeString("Noun")))), list(makeSymbol("RET"), list(makeSymbol("GENL?"), makeSymbol("POS"), reader_make_constant_shell(makeString("Noun")), makeSymbol("MT"))))));
    ...
    public static final SubLList $list99 = list(makeSymbol("STREAM"), makeSymbol("DEPTH"));

    public static final SubLList $list100 = list(makeString("Prints this lex-entry to STREAM, ignoring DEPTH"), list(makeSymbol("IGNORE"), makeSymbol("DEPTH")), list(makeSymbol("WRITE-STRING"), makeString("#<LEX-ENTRY "), makeSymbol("STREAM")), list(makeSymbol("TERPRI"), makeSymbol("STREAM")), list(makeSymbol("CDOLIST"), list(makeSymbol("PROPERTY"), makeSymbol("PROPERTIES")), list(makeSymbol("PRIN1"), list(makeSymbol("CAR"), makeSymbol("PROPERTY")), makeSymbol("STREAM")), list(makeSymbol("WRITE-STRING"), makeString(" -> "), makeSymbol("STREAM")), list(makeSymbol("PRIN1"), list(makeSymbol("CDR"), makeSymbol("PROPERTY")), makeSymbol("STREAM")), list(makeSymbol("TERPRI"), makeSymbol("STREAM"))), list(makeSymbol("WRITE-STRING"), makeString(">"), makeSymbol("STREAM")), list(makeSymbol("TERPRI"), makeSymbol("STREAM")), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list105 = list(makeKeyword("NN"), makeKeyword("NNS"), makeKeyword("NNP"), makeKeyword("NNPS"), makeKeyword("WP"), makeKeyword("PP"), makeKeyword("PRP"), makeKeyword("FW"));
    ...
    public static final SubLList $list108 = list(makeKeyword("RB"), makeKeyword("RBR"), makeKeyword("RBS"), makeKeyword("WRB"));

    private static final SubLSymbol NOMINAL_P = makeSymbol("NOMINAL-P");

    private static final SubLList $list110 = list(list(makeSymbol("RET"), list(makeSymbol("INTERSECTION"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("PENN-TAGS")), makeSymbol("*NOMINAL-TAGS*"))));
    ...
    public static final SubLList $list114 = list(list(makeSymbol("RET"), list(makeSymbol("INTERSECTION"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("PENN-TAGS")), makeSymbol("*VERBAL-TAGS*"))));
    ...
    public static final SubLList $list117 = list(list(makeSymbol("RET"), list(makeSymbol("INTERSECTION"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("PENN-TAGS")), makeSymbol("*ADJECTIVAL-TAGS*"))));
    ...
    private static final SubLList $list120 = list(list(makeSymbol("RET"), list(makeSymbol("INTERSECTION"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("PENN-TAGS")), makeSymbol("*ADVERBIAL-TAGS*"))));
    ...
    private static final SubLList $list123 = list(makeString("@return constantp; a single constant derived from this lex entry\'s\n    semantics"), list(makeSymbol("PUNLESS"), list(makeSymbol("COR"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("NOMINAL-P"))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("VERBAL-P")))), list(makeSymbol("ERROR"), makeString("Invalid lexical property :term called on ~a"), makeSymbol("SELF"))), list(makeSymbol("CLET"), list(list(makeSymbol("TERM"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("DENOT")))), list(makeSymbol("PUNLESS"), makeSymbol("TERM"), list(makeSymbol("CLET"), list(list(makeSymbol("SEMTRANS"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("SEMTRANS")))), list(makeSymbol("PWHEN"), makeSymbol("SEMTRANS"), list(makeSymbol("CLET"), list(list(makeSymbol("OPERATOR"), list(makeSymbol("FORMULA-OPERATOR"), makeSymbol("SEMTRANS")))), list(makeSymbol("PCOND"), list(list(makeSymbol("COR"), list(EQL, makeSymbol("OPERATOR"), reader_make_constant_shell(makeString("equals"))), list(EQL, makeSymbol("OPERATOR"), reader_make_constant_shell(makeString("isa"))), list(EQL, makeSymbol("OPERATOR"), reader_make_constant_shell(makeString("genls")))), list(makeSymbol("CSETQ"), makeSymbol("TERM"), list(makeSymbol("FORMULA-ARG2"), makeSymbol("SEMTRANS")))), list(list(makeSymbol("COR"), list(makeSymbol("LOGICAL-CONNECTIVE-P"), list(makeSymbol("FORMULA-OPERATOR"), makeSymbol("SEMTRANS"))), list(makeSymbol("QUANTIFIER-P"), list(makeSymbol("FORMULA-OPERATOR"), makeSymbol("SEMTRANS")))), list(makeSymbol("CLET"), list(list(makeSymbol("CENTRAL-KEYWORD"), list(makeSymbol("FCOND"), list(list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("NOMINAL-P"))), makeKeyword("NOUN")), list(list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("VERBAL-P"))), makeKeyword("ACTION"))))), list(makeSymbol("CSETQ"), makeSymbol("TERM"), list(makeSymbol("MAIN-COLLECTION"), makeSymbol("SEMTRANS"), makeSymbol("CENTRAL-KEYWORD"))))), list(T, list(makeSymbol("CSETQ"), makeSymbol("TERM"), list(makeSymbol("FORMULA-OPERATOR"), makeSymbol("SEMTRANS"))))))))), list(makeSymbol("RET"), makeSymbol("TERM"))));
    ...
    public static final SubLList $list132 = list(makeString("@return listp;  a list of genders of this lex entry with possible gender values \n   :FEMININE, :MASCULINE and :NEUTER"), list(makeSymbol("PUNLESS"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("NOMINAL-P"))), list(makeSymbol("ERROR"), makeString("Invalid lexical property :gender called on ~a"), makeSymbol("SELF"))), list(makeSymbol("CLET"), list(makeSymbol("GENDERS"), list(makeSymbol("TERM"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("TERM")))), list(makeSymbol("PIF"), list(makeSymbol("MORE-SPECIFIC-P"), makeSymbol("TERM"), reader_make_constant_shell(makeString("MaleAnimal")), reader_make_constant_shell(makeString("EverythingPSC"))), list(makeSymbol("CSETQ"), makeSymbol("GENDERS"), list(makeSymbol("QUOTE"), list(makeKeyword("MASCULINE")))), list(makeSymbol("PIF"), list(makeSymbol("MORE-SPECIFIC-P"), makeSymbol("TERM"), reader_make_constant_shell(makeString("FemaleAnimal")), reader_make_constant_shell(makeString("EverythingPSC"))), list(makeSymbol("CSETQ"), makeSymbol("GENDERS"), list(makeSymbol("QUOTE"), list(makeKeyword("FEMININE")))), list(makeSymbol("PIF"), list(makeSymbol("MORE-SPECIFIC-P"), makeSymbol("TERM"), reader_make_constant_shell(makeString("Person")), reader_make_constant_shell(makeString("EverythingPSC"))), list(makeSymbol("CSETQ"), makeSymbol("GENDERS"), list(makeSymbol("QUOTE"), list(makeKeyword("MASCULINE"), makeKeyword("FEMININE")))), list(makeSymbol("PWHEN"), list(makeSymbol("MORE-SPECIFIC-P"), makeSymbol("TERM"), reader_make_constant_shell(makeString("SentientAnimal")), reader_make_constant_shell(makeString("EverythingPSC"))), list(makeSymbol("CSETQ"), makeSymbol("GENDERS"), list(makeSymbol("QUOTE"), list(makeKeyword("MASCULINE"), makeKeyword("FEMININE"), makeKeyword("NEUTER")))))))), list(makeSymbol("PUNLESS"), makeSymbol("GENDERS"), list(makeSymbol("CSETQ"), makeSymbol("GENDERS"), list(makeSymbol("QUOTE"), list(makeKeyword("NEUTER"))))), list(makeSymbol("RET"), makeSymbol("GENDERS"))));
    ...
    private static final SubLObject $$MaleAnimal = reader_make_constant_shell(makeString("MaleAnimal"));

    public static final SubLList $list136 = list(makeKeyword("MASCULINE"));

    private static final SubLObject $$FemaleAnimal = reader_make_constant_shell(makeString("FemaleAnimal"));
    ...
    public static final SubLList $list140 = list(makeKeyword("MASCULINE"), makeKeyword("FEMININE"));

    private static final SubLObject $$SentientAnimal = reader_make_constant_shell(makeString("SentientAnimal"));
    ...
    private static final SubLList $list146 = list(makeString("@return listp; the Penn part-of-speech tags of this lex-entry"), list(makeSymbol("CLET"), list(list(makeSymbol("POS"), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("CYC-POS"))), list(makeSymbol("INFLECTIONS"), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("INFLECTIONS"))), list(makeSymbol("STRING"), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("STRING"))), list(makeSymbol("PENN-TAGS"), NIL)), list(makeSymbol("PCOND"), list(list(makeSymbol("CAND"), list(EQL, makeSymbol("POS"), reader_make_constant_shell(makeString("Preposition"))), list(EQUALP, makeSymbol("STRING"), makeString("to"))), list(makeSymbol("CPUSH"), makeKeyword("TO"), makeSymbol("PENN-TAGS"))), list(T, list(makeSymbol("CDOLIST"), list(makeSymbol("INFLECTION"), makeSymbol("INFLECTIONS")), list(makeSymbol("CLET"), list(list(makeSymbol("PENN-TAG"), list(makeSymbol("MAP-FROM-CYC-TO-PENN-POS"), makeSymbol("POS"), makeSymbol("INFLECTION")))), list(makeSymbol("PWHEN"), makeSymbol("PENN-TAG"), list(makeSymbol("CPUSH"), makeSymbol("PENN-TAG"), makeSymbol("PENN-TAGS"))))))), list(makeSymbol("RET"), list(makeSymbol("REMOVE-DUPLICATES"), makeSymbol("PENN-TAGS"), list(makeSymbol("QUOTE"), EQ)))));
    ...
    public static final SubLList $list155 = list(list(makeKeyword("NN"), makeKeyword("VBG")), list(makeKeyword("JJ"), makeKeyword("VBN"), makeKeyword("VBD")), list(makeKeyword("NNP"), makeKeyword("NNPS"), makeKeyword("NN"), makeKeyword("NNS"), makeKeyword("$"), makeKeyword("CD")));

    private static final SubLSymbol COMPUTE_SUPER_TAGS = makeSymbol("COMPUTE-SUPER-TAGS");

    private static final SubLList $list157 = list(makeString("@return stringp; the super tag of this lex-entry"), list(makeSymbol("CLET"), list(list(makeSymbol("SUPERTAGS"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("INFL"), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("INFLECTIONS"))), list(makeSymbol("CDOLIST"), list(makeSymbol("SUPERTAG"), list(makeSymbol("GETHASH"), list(makeSymbol("LIST"), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("CYC-POS")), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("FRAME")), makeSymbol("INFL")), makeSymbol("*CYC-TO-SUPERTAG-MAP*"))), list(makeSymbol("CPUSHNEW"), makeSymbol("SUPERTAG"), makeSymbol("SUPERTAGS"), list(makeSymbol("QUOTE"), EQUAL)))), list(makeSymbol("RET"), makeSymbol("SUPERTAGS"))));
    ...
    public static final SubLList $list161 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-ENTRY"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("TRIE-ENTRY")))), list(makeSymbol("PCOND"), list(makeSymbol("TRIE-ENTRY"), list(makeSymbol("RET"), list(makeSymbol("NL-TRIE-ENTRY-POS"), makeSymbol("TRIE-ENTRY")))), list(list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("INFLECTIONS")), list(makeSymbol("CDOLIST"), list(makeSymbol("PRED"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("INFLECTIONS"))), list(makeSymbol("CLET"), list(list(makeSymbol("POS"), list(makeSymbol("POS-OF-PRED"), makeSymbol("PRED")))), list(makeSymbol("PWHEN"), makeSymbol("POS"), list(makeSymbol("RET"), makeSymbol("POS"))))))), list(makeSymbol("RET"), NIL)));
    ...
    private static final SubLList $list164 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-ENTRY"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("TRIE-ENTRY")))), list(makeSymbol("RET"), list(makeSymbol("CNOT"), makeSymbol("TRIE-ENTRY")))));
    ...
    private static final SubLList $list167 = list(makeString("What is the syntactic category of this lexical entry.  Unlike cyc-pos, this does not assume that each \n   entry is a part-of-speech.  In some cases, the category may be a XP, not just an X0"), list(makeSymbol("CLET"), list(list(makeSymbol("PRED"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("PREDICATE")))), list(makeSymbol("PWHEN"), list(makeSymbol("NAME-STRING-PRED?"), makeSymbol("PRED")), list(makeSymbol("RET"), reader_make_constant_shell(makeString("NounPhrase")))), list(makeSymbol("RET"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("CYC-POS")))));
    ...
    private static final SubLList $list172 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-ENTRY"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("TRIE-ENTRY")))), list(makeSymbol("PWHEN"), makeSymbol("TRIE-ENTRY"), list(makeSymbol("RET"), list(makeSymbol("NL-TRIE-ENTRY-POS-PREDS"), makeSymbol("TRIE-ENTRY")))), list(makeSymbol("RET"), NIL)));
    ...
    private static final SubLList $list201 = list(new SubLObject[]{ makeString("@return lexicon-p; a newly created lexicon"), list(makeSymbol("INITIALIZE"), makeSymbol("SUPER")), list(makeSymbol("CSETQ"), makeSymbol("TRIE"), list(makeSymbol("GET-NL-TRIE"))), list(makeSymbol("CSETQ"), makeSymbol("CACHE"), list(makeSymbol("NEW-CACHE"), makeInteger(2000), list(makeSymbol("QUOTE"), EQUAL))), list(makeSymbol("CSETQ"), makeSymbol("CASE-SENSITIVITY"), makeKeyword("ON")), list(makeSymbol("ENSURE-CYC-TO-PENN-MAP")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("INITIALIZE-EXCLUDED-PREDS"))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("INITIALIZE-ALLOWED-MTS"))), list(makeSymbol("CSETQ"), makeSymbol("LEARNED"), NIL), list(makeSymbol("RET"), makeSymbol("SELF")) });
    ...
    private static final SubLList $list209 = list(makeString("Finalizes this lexicon"), list(makeSymbol("CSETQ"), makeSymbol("CACHE"), NIL), list(makeSymbol("ISOLATE"), makeSymbol("SUPER")), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    public static final SubLList $list213 = list(list(makeSymbol("CSETQ"), makeSymbol("IGNORE-CACHE?"), T), list(makeSymbol("RET"), makeSymbol("SELF")));

    public static final SubLSymbol $sym214$OUTER_CATCH_FOR_ABSTRACT_LEXICON_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-ABSTRACT-LEXICON-METHOD");

    private static final SubLSymbol ABSTRACT_LEXICON_IGNORE_CACHE_METHOD = makeSymbol("ABSTRACT-LEXICON-IGNORE-CACHE-METHOD");

    private static final SubLList $list216 = list(list(makeSymbol("RET"), list(makeSymbol("GET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("IGNORE-CACHE?")))));
    ...
    private static final SubLList $list219 = list(list(makeSymbol("CSETQ"), makeSymbol("ALLOW-STEMMING"), T), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list223 = list(list(makeSymbol("CSETQ"), makeSymbol("ALLOW-STEMMING"), NIL), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list227 = list(list(makeSymbol("CSETQ"), makeSymbol("ALLOW-FABRICATION?"), T), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list231 = list(list(makeSymbol("CSETQ"), makeSymbol("ALLOW-FABRICATION?"), NIL), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list235 = list(list(makeSymbol("RET"), list(makeSymbol("CNOT"), makeSymbol("ALLOW-FABRICATION?"))));
    ...
    public static final SubLList $list239 = list(list(makeSymbol("RET"), makeSymbol("ALLOW-FABRICATION?")));
    ...
    private static final SubLList $list245 = list(makeString("Returns t if LEX-ENTRY is a contextually valid nl-trie-entry, nil otherwise\n   Lexicons derived from abstract-lexicon will typically override this method"), list(makeSymbol("PWHEN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("STOP-WORD-P")), list(makeSymbol("NL-TRIE-ENTRY-STRING"), makeSymbol("NL-TRIE-ENTRY"))), list(makeSymbol("RET"), NIL)), list(makeSymbol("RET"), list(makeSymbol("COR"), list(makeSymbol("CAND"), list(makeSymbol("LEX-ENTRY-P"), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ALLOWED-POS?")), list(makeSymbol("FIM"), makeSymbol("NL-TRIE-ENTRY"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("CYC-POS")))), list(makeSymbol("CAND"), list(makeSymbol("NL-TRIE-WORD-P"), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("MEMBER"), reader_make_constant_shell(makeString("nameSpelling")), list(makeSymbol("NL-TRIE-WORD-POS-PREDS"), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("QUOTE"), EQL)), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("NL-TRIE-ENTRY-HAS-ALLOWED-PREDICATE?")), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ALLOWED-MT?")), list(makeSymbol("NL-TRIE-ENTRY-SEMANTIC-MT"), makeSymbol("NL-TRIE-ENTRY")))), list(makeSymbol("CAND"), list(makeSymbol("VALID-DENOTS?"), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("NL-TRIE-ENTRY-HAS-ALLOWED-PREDICATE?")), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("NL-TRIE-ENTRY-HAS-ALLOWED-POS?")), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ALLOWED-MT?")), list(makeSymbol("NL-TRIE-ENTRY-SEMANTIC-MT"), makeSymbol("NL-TRIE-ENTRY")))))));
    ...
    private static final SubLList $list255 = list(makeString("Used for setting case-sensitivity of this lexicon.  Acceptable values include :off, :on, :preferred"), list(makeSymbol("CSETQ"), makeSymbol("CASE-SENSITIVITY"), makeSymbol("KEYWORD")), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list259 = list(makeString("Used for getting case-sensitivity of this lexicon.  Acceptable values include :off, :on, :preferred"), list(makeSymbol("RET"), makeSymbol("CASE-SENSITIVITY")));
    ...
    public static final SubLList $list262 = list(makeSymbol("&OPTIONAL"), list(makeSymbol("PREDS-TO-EXCLUDE"), makeKeyword("DEFAULT")));

    public static final SubLList $list263 = list(makeString("exclude assertions using the predicates in PREDS-TO-EXCLUDE from use by this lexicon.\n   If PREDS-TO-EXCLUDE is :default, \n   all preds in the class variable DEFAULT-EXCLUDE-PREDS will be excluded"), list(makeSymbol("PIF"), list(EQ, makeSymbol("PREDS-TO-EXCLUDE"), makeKeyword("DEFAULT")), list(makeSymbol("CSETQ"), makeSymbol("EXCLUDED-PREDS"), makeSymbol("DEFAULT-EXCLUDE-PREDICATES")), list(makeSymbol("CSETQ"), makeSymbol("EXCLUDED-PREDS"), makeSymbol("PREDS-TO-EXCLUDE"))), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list269 = list(makeString("allow POS-PRED to be used by this lexicon for lexical lookup"), list(makeSymbol("CSETQ"), makeSymbol("EXCLUDED-PREDS"), list(makeSymbol("REMOVE"), makeSymbol("POS-PRED"), makeSymbol("EXCLUDED-PREDS"))), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list273 = list(makeString("do not allow POS-PRED to be used by this lexicon for lexical lookup"), list(makeSymbol("CPUSHNEW"), makeSymbol("POS-PRED"), makeSymbol("EXCLUDED-PREDS")), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list277 = list(makeString("is POS-PRED a predicate that can not be used in from this lexicon?"), list(makeSymbol("RET"), list(makeSymbol("MEMBER"), makeSymbol("POS-PRED"), makeSymbol("EXCLUDED-PREDS"))));
    ...
    private static final SubLList $list281 = list(makeString("is POS-PRED a predicate that can not be used in from this lexicon?"), list(makeSymbol("RET"), list(makeSymbol("CNOT"), list(makeSymbol("MEMBER?"), makeSymbol("POS-PRED"), makeSymbol("EXCLUDED-PREDS")))));
    ...
    private static final SubLList $list289 = list(makeString("allow POS to be used by this lexicon for lexical lookup"), list(makeSymbol("CSETQ"), makeSymbol("EXCLUDED-POS-LIST"), list(makeSymbol("REMOVE"), makeSymbol("POS"), makeSymbol("EXCLUDED-POS-LIST"))), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list293 = list(makeString("do not allow POS to be used by this lexicon for lexical lookup"), list(makeSymbol("CPUSHNEW"), makeSymbol("POS"), makeSymbol("EXCLUDED-POS-LIST")), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    public static final SubLList $list297 = list(makeString("is POS a part of speech that can not be used in from this lexicon?"), list(makeSymbol("RET"), list(makeSymbol("GENL-POS-MEMBER?"), makeSymbol("POS"), makeSymbol("EXCLUDED-POS-LIST"))));

    public static final SubLSymbol $sym298$OUTER_CATCH_FOR_ABSTRACT_LEXICON_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-ABSTRACT-LEXICON-METHOD");
    ...
    private static final SubLList $list300 = list(makeString("is POS a part of speech that can not be used in from this lexicon?"), list(makeSymbol("RET"), list(makeSymbol("CNOT"), list(makeSymbol("GENL-POS-MEMBER?"), makeSymbol("POS"), makeSymbol("EXCLUDED-POS-LIST")))));
    ...
    private static final SubLList $list308 = list(makeString("add LEARNER (a method-name) as a learner to lexicon"), list(makeSymbol("CPUSHNEW"), makeSymbol("LEARNER"), makeSymbol("ACTIVE-LEARNERS")), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list312 = list(makeString("remove LEARNER (a method-name) as a learner for this lexicon"), list(makeSymbol("CSETQ"), makeSymbol("ACTIVE-LEARNERS"), list(makeSymbol("REMOVE"), makeSymbol("LEARNER"), makeSymbol("ACTIVE-LEARNERS"))), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list316 = list(list(makeSymbol("RET"), makeSymbol("ACTIVE-LEARNERS")));
    ...
    public static final SubLList $list320 = list(makeSymbol("LEARNERS"));

    private static final SubLList $list321 = list(makeString("set learners for lexicon to be all and only those learners specified in LEARNERS"), list(makeSymbol("CSETQ"), makeSymbol("ACTIVE-LEARNERS"), makeSymbol("LEARNERS")), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    public static final SubLList $list325 = list(makeSymbol("&OPTIONAL"), list(makeSymbol("KB-SPEC"), makeKeyword("DEFAULT")));

    private static final SubLList $list326 = list(makeString("allow all mts visible from BASE-MT to be used by this lexicon.  If the value is :default, the value of the class variable DEFAULT-BASE-MT will be\n   used, and all mts in the class variable DEFAULT-EXCLUDED-MTS will be removed"), list(makeSymbol("CSETQ"), makeSymbol("ALLOWED-MTS"), list(makeSymbol("NEW-SET"), list(makeSymbol("FUNCTION"), EQUAL))), list(makeSymbol("CSETQ"), makeSymbol("EXCLUDED-MTS"), list(makeSymbol("CONSTRUCT-SET-FROM-LIST"), makeSymbol("DEFAULT-EXCLUDE-MTS"), list(makeSymbol("FUNCTION"), EQUAL))), list(makeSymbol("PUNLESS"), list(EQ, makeKeyword("DEFAULT"), makeSymbol("KB-SPEC")), list(makeSymbol("CLET"), list(list(makeSymbol("BASE-MTS"), list(makeSymbol("QUERY-VARIABLE"), list(makeSymbol("QUOTE"), makeSymbol("?MT")), list(makeSymbol("BQ-LIST*"), reader_make_constant_shell(makeString("defaultBaseLexicalMt")), makeSymbol("KB-SPEC"), list(makeSymbol("QUOTE"), list(makeSymbol("?MT")))), reader_make_constant_shell(makeString("InferencePSC")), list(makeSymbol("QUOTE"), list(makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL"))))), list(makeSymbol("SPEC-ALLOWED-MTS"), list(makeSymbol("QUERY-VARIABLE"), list(makeSymbol("QUOTE"), makeSymbol("?MT")), list(makeSymbol("BQ-LIST*"), reader_make_constant_shell(makeString("allowedLexicalMt")), makeSymbol("KB-SPEC"), list(makeSymbol("QUOTE"), list(makeSymbol("?MT")))), reader_make_constant_shell(makeString("InferencePSC")), list(makeSymbol("QUOTE"), list(makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL"))))), list(makeSymbol("SPEC-DISALLOWED-MTS"), list(makeSymbol("QUERY-VARIABLE"), list(makeSymbol("QUOTE"), makeSymbol("?MT")), list(makeSymbol("BQ-LIST*"), reader_make_constant_shell(makeString("disallowedLexicalMt")), makeSymbol("KB-SPEC"), list(makeSymbol("QUOTE"), list(makeSymbol("?MT")))), reader_make_constant_shell(makeString("InferencePSC")), list(makeSymbol("QUOTE"), list(makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL")))))), list(makeSymbol("PCOND"), list(list(makeSymbol("SINGLETON?"), makeSymbol("BASE-MTS")), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("BASE-MT")), list(makeSymbol("COPY-EXPRESSION"), list(makeSymbol("ONLY-ONE"), makeSymbol("BASE-MTS"))))), list(list(makeSymbol("EMPTY-LIST-P"), makeSymbol("BASE-MTS")), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("BASE-MT")), list(makeSymbol("COPY-EXPRESSION"), list(makeSymbol("GET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("DEFAULT-BASE-MT"))))), list(makeSymbol("IGNORE"), makeSymbol("BASE-MTS"))), list(T, list(makeSymbol("CSETQ"), makeSymbol("BASE-MT"), list(makeSymbol("COPY-EXPRESSION"), list(makeSymbol("CANONICALIZE-HLMT"), list(makeSymbol("MAKE-EL-FORMULA"), reader_make_constant_shell(makeString("MtUnionFn")), makeSymbol("BASE-MTS"))))))), list(makeSymbol("CDOLIST"), list(makeSymbol("MT"), makeSymbol("SPEC-ALLOWED-MTS")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ALLOW-MT")), makeSymbol("MT"))), list(makeSymbol("CDOLIST"), list(makeSymbol("MT"), makeSymbol("SPEC-DISALLOWED-MTS")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("FORBID-MT")), makeSymbol("MT"))))), list(makeSymbol("RET"), makeSymbol("SELF")));

    private static final SubLSymbol $sym327$_MT = makeSymbol("?MT");

    private static final SubLObject $$defaultBaseLexicalMt = reader_make_constant_shell(makeString("defaultBaseLexicalMt"));
    ...
    private static final SubLObject $$allowedLexicalMt = reader_make_constant_shell(makeString("allowedLexicalMt"));

    private static final SubLObject $$disallowedLexicalMt = reader_make_constant_shell(makeString("disallowedLexicalMt"));
    ...
    private static final SubLList $list340 = list(makeString("base-mt represents the standard mt-reasoning-based Mt for this lexicon. Using allow-mt and forbid-mt allow\n   for minor tweaks to the base-mt, but in general, this is the Mt for this lexicon\n   @note that this method will override any excluded-mts if they are visible from the newly-set base-mt"), list(makeSymbol("CSETQ"), makeSymbol("BASE-MT"), list(makeSymbol("COPY-EXPRESSION"), makeSymbol("MT"))), list(makeSymbol("DO-SET"), list(makeSymbol("EXCLUDED-MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("PWHEN"), list(makeSymbol("GENL-LEXICON-MT?"), makeSymbol("MT"), makeSymbol("EXCLUDED-MT")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ALLOW-MT")), makeSymbol("EXCLUDED-MT")))), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    private static final SubLList $list344 = list(list(makeSymbol("PWHEN"), list(makeSymbol("INITIALIZED-P"), makeSymbol("BASE-MT")), list(makeSymbol("RET"), makeSymbol("BASE-MT"))), list(makeSymbol("CSETQ"), makeSymbol("BASE-MT"), makeSymbol("DEFAULT-BASE-MT")), list(makeSymbol("RET"), makeSymbol("DEFAULT-BASE-MT")));
    ...
    private static final SubLList $list347 = list(makeString("@param MT possibly-hlmt-p; the mt to be allowed for retrieval of lex entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("MT"), makeSymbol("POSSIBLY-HLMT-P")), list(makeSymbol("SET-ADD"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("CSETQ"), makeSymbol("ROOT-MT"), makeKeyword("UNINITIALIZED")), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    public static final SubLList $list352 = list(makeString("@param MT possibly-hlmt-p; the mt and all its genlMTs to be allowed for \n     retrieval of lex entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("MT"), makeSymbol("POSSIBLY-HLMT-P")), list(makeSymbol("SET-ADD"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("CDOLIST"), list(makeSymbol("GENL-MT"), list(makeSymbol("QUERY-VARIABLE"), list(makeSymbol("QUOTE"), makeSymbol("?GENLMT")), list(makeSymbol("BQ-LIST*"), reader_make_constant_shell(makeString("genlMt")), makeSymbol("MT"), list(makeSymbol("QUOTE"), list(makeSymbol("?GENLMT")))))), list(makeSymbol("SET-ADD"), makeSymbol("GENL-MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("GENL-MT"), makeSymbol("EXCLUDED-MTS"))), list(makeSymbol("CSETQ"), makeSymbol("ROOT-MT"), makeKeyword("UNINITIALIZED")), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    public static final SubLList $list356 = list(makeSymbol("?GENLMT"));

    private static final SubLSymbol ABSTRACT_LEXICON_ALLOW_GENL_MTS_METHOD = makeSymbol("ABSTRACT-LEXICON-ALLOW-GENL-MTS-METHOD");

    private static final SubLList $list358 = list(makeString("@param MT possibly-hlmt-p; the mt to be forbidden for retrieval of lex entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("MT"), makeSymbol("POSSIBLY-HLMT-P")), list(makeSymbol("SET-ADD"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("CSETQ"), makeSymbol("ROOT-MT"), makeKeyword("UNINITIALIZED")), list(makeSymbol("RET"), makeSymbol("SELF")));

    private static final SubLSymbol ABSTRACT_LEXICON_FORBID_MT_METHOD = makeSymbol("ABSTRACT-LEXICON-FORBID-MT-METHOD");

    public static final SubLList $list360 = list(makeString("@param MT possibly-hlmt-p; are assertions in MT allowed in this lexicon?"), list(makeSymbol("PUNLESS"), makeSymbol("MT"), list(makeSymbol("RET"), NIL)), list(makeSymbol("PCOND"), list(list(makeSymbol("SET-MEMBER?"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("RET"), T)), list(list(makeSymbol("SET-MEMBER?"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("RET"), NIL)), list(list(makeSymbol("CNOT"), list(makeSymbol("HLMT-P"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET-BASE-MT"))))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("FORBID-MT")), makeSymbol("MT")), list(makeSymbol("RET"), NIL)), list(list(makeSymbol("GENL-LEXICON-MT?"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET-BASE-MT"))), makeSymbol("MT")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ALLOW-MT")), makeSymbol("MT")), list(makeSymbol("RET"), T)), list(T, list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("FORBID-MT")), makeSymbol("MT")), list(makeSymbol("RET"), NIL))));
    ...
    private static final SubLList $list363 = list(makeString("return the one Mt that is the composition of all the allowed/disallowed mts, an MtUnionFn of all the Mts"), list(makeSymbol("PUNLESS"), list(makeSymbol("INITIALIZED-P"), makeSymbol("ROOT-MT")), list(makeSymbol("CLET"), list(list(makeSymbol("THIS-ALLOWED-MTS"), list(makeSymbol("GET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ALLOWED-MTS")))), list(makeSymbol("THIS-BASE-MT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET-BASE-MT")))), list(makeSymbol("MTS"), list(makeSymbol("FIF"), list(makeSymbol("POSSIBLY-HLMT-P"), makeSymbol("THIS-BASE-MT")), list(makeSymbol("CONS"), makeSymbol("THIS-BASE-MT"), list(makeSymbol("SET-ELEMENT-LIST"), makeSymbol("THIS-ALLOWED-MTS"))), list(makeSymbol("SET-ELEMENT-LIST"), makeSymbol("ALLOWED-MTS")))), list(makeSymbol("MIN-MTS"), list(makeSymbol("MIN-MTS"), makeSymbol("MTS")))), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("ROOT-MT")), list(makeSymbol("CANONICALIZE-HLMT"), list(makeSymbol("MAKE-EL-FORMULA"), reader_make_constant_shell(makeString("MtUnionFn")), makeSymbol("MIN-MTS")))))), list(makeSymbol("RET"), makeSymbol("ROOT-MT")));
    ...
    private static final SubLList $list367 = list(list(makeSymbol("CLET"), list(list(makeSymbol("STOP-WORD-SET"), makeSymbol("STOP-WORDS"))), list(makeSymbol("PUNLESS"), list(makeSymbol("SET-P"), makeSymbol("STOP-WORD-SET")), list(makeSymbol("CSETQ"), makeSymbol("STOP-WORD-SET"), list(makeSymbol("NEW-SET"), list(makeSymbol("QUOTE"), EQUAL)))), list(makeSymbol("SET-ADD"), makeSymbol("STRING"), makeSymbol("STOP-WORD-SET")), list(makeSymbol("CSETQ"), makeSymbol("STOP-WORDS"), makeSymbol("STOP-WORD-SET")), list(makeSymbol("RET"), makeSymbol("STOP-WORDS"))));
    ...
    private static final SubLList $list370 = list(list(makeSymbol("RET"), list(makeSymbol("CAND"), makeSymbol("STOP-WORDS"), list(makeSymbol("BOOLEAN"), list(makeSymbol("SET-MEMBER?"), makeSymbol("STRING"), makeSymbol("STOP-WORDS"))))));
    ...
    private static final SubLList $list374 = list(list(makeSymbol("PUNLESS"), list(makeSymbol("SET-P"), makeSymbol("STOP-WORDS")), list(makeSymbol("CSETQ"), makeSymbol("STOP-WORDS"), list(makeSymbol("NEW-SET"), list(makeSymbol("QUOTE"), EQUAL)))), list(makeSymbol("RET"), makeSymbol("STOP-WORDS")));
    ...
    public static final SubLList $list377 = list(makeSymbol("&OPTIONAL"), makeSymbol("TARGET"));

    private static final SubLList $list378 = list(makeString("@return ABSTRACT-LEXICON-P; a copy of this lexicon.\n@note -- list values are copied with copy-list.\n@note -- cache and trie are set to their defaults."), list(makeSymbol("CHECK-TYPE-IF-PRESENT"), makeSymbol("TARGET"), makeSymbol("ABSTRACT-LEXICON-P")), list(makeSymbol("PUNLESS"), makeSymbol("TARGET"), list(makeSymbol("CSETQ"), makeSymbol("TARGET"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CLONE")))), list(makeSymbol("WARN"), makeString("Cloned instance: ~S"), makeSymbol("TARGET"))), list(makeSymbol("CDOLIST"), list(makeSymbol("SLOT"), list(makeSymbol("QUOTE"), list(makeSymbol("ALLOWED-MTS"), makeSymbol("EXCLUDED-MTS"), makeSymbol("EXCLUDED-PREDS"), makeSymbol("EXCLUDED-POS-LIST"), makeSymbol("IGNORE-CACHE?"), makeSymbol("CASE-SENSITIVITY"), makeSymbol("ACTIVE-LEARNERS")))), list(makeSymbol("CLET"), list(list(makeSymbol("VALUE"), list(makeSymbol("GET-SLOT"), makeSymbol("SELF"), makeSymbol("SLOT")))), list(makeSymbol("PCOND"), list(list(makeSymbol("LISTP"), makeSymbol("VALUE")), list(makeSymbol("SET-SLOT"), makeSymbol("TARGET"), makeSymbol("SLOT"), list(makeSymbol("COPY-LIST"), makeSymbol("VALUE")))), list(T, list(makeSymbol("SET-SLOT"), makeSymbol("TARGET"), makeSymbol("SLOT"), makeSymbol("VALUE")))))), list(makeSymbol("RET"), makeSymbol("TARGET")));
    ...
    private static final SubLList $list385 = list(makeString("@param STRING stringp;\n   @return listp; the list of  lex-entry-p associated with STRING in this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("CYCL-STRING-P")), list(makeSymbol("PWHEN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("STOP-WORD-P")), makeSymbol("STRING")), list(makeSymbol("RET"), NIL)), list(makeSymbol("PUNLESS"), makeSymbol("IGNORE-CACHE?"), list(makeSymbol("CMULTIPLE-VALUE-BIND"), list(makeSymbol("LEX-ENTRIES"), makeSymbol("EXISTS?")), list(makeSymbol("CACHE-GET"), makeSymbol("CACHE"), makeSymbol("STRING")), list(makeSymbol("PWHEN"), makeSymbol("EXISTS?"), list(makeSymbol("RET"), makeSymbol("LEX-ENTRIES"))))), list(makeSymbol("CLET"), list(list(makeSymbol("LEX-ENTRIES"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CREATE-LEX-ENTRIES")), makeSymbol("STRING"), NIL)), list(makeSymbol("NL-TRIE-ENTRIES"), list(makeSymbol("NL-TRIE-SEARCH"), makeSymbol("STRING"), makeSymbol("TRIE"), makeSymbol("CASE-SENSITIVITY")))), list(makeSymbol("CSETQ"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("ADD-LEX-ENTRIES-FOR-TRIE-ENTRIES"), makeSymbol("NL-TRIE-ENTRIES"), makeSymbol("STRING"), makeSymbol("SELF"), makeSymbol("LEX-ENTRIES"))), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("NULL"), makeSymbol("LEX-ENTRIES")), list(EQ, makeSymbol("CASE-SENSITIVITY"), makeKeyword("PREFERRED"))), list(makeSymbol("CLET"), list(list(makeSymbol("NL-TRIE-ENTRIES"), list(makeSymbol("NL-TRIE-SEARCH"), makeSymbol("STRING"), makeSymbol("TRIE"), makeKeyword("OFF")))), list(makeSymbol("CSETQ"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("ADD-LEX-ENTRIES-FOR-TRIE-ENTRIES"), makeSymbol("NL-TRIE-ENTRIES"), makeSymbol("STRING"), makeSymbol("SELF"), makeSymbol("LEX-ENTRIES"))))), list(makeSymbol("PUNLESS"), makeSymbol("IGNORE-CACHE?"), list(makeSymbol("CACHE-SET"), makeSymbol("CACHE"), makeSymbol("STRING"), makeSymbol("LEX-ENTRIES"))), list(makeSymbol("RET"), makeSymbol("LEX-ENTRIES"))));
    ...
    private static final SubLList $list394 = list(makeString("Deletes all entries for STRING from this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("CYCL-STRING-P")), list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-ENTRIES"), list(makeSymbol("NL-TRIE-SEARCH"), makeSymbol("STRING"), makeSymbol("TRIE"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("GET-CASE-SENSITIVITY")))))), list(makeSymbol("CDOLIST"), list(makeSymbol("TRIE-ENTRY"), makeSymbol("TRIE-ENTRIES")), list(makeSymbol("PWHEN"), list(makeSymbol("LEX-ENTRY-P"), makeSymbol("TRIE-ENTRY")), list(makeSymbol("CDOLIST"), list(makeSymbol("TRIE-KEY"), list(makeSymbol("NL-TRIE-ENTRY-KEYS"), makeSymbol("TRIE-ENTRY"))), list(makeSymbol("NL-TRIE-DELETE-ENTRY"), makeSymbol("TRIE"), makeSymbol("TRIE-KEY"), makeSymbol("TRIE-ENTRY")))))), list(makeSymbol("CACHE-REMOVE"), makeSymbol("CACHE"), makeSymbol("STRING")), list(makeSymbol("RET"), makeSymbol("SELF")));
    ...
    public static final SubLList $list398 = list(makeSymbol("LEX-ENTRY"), makeSymbol("STRING"));

    public static final SubLList $list399 = list(makeString("Deletes the entry associating STRING with LEX-ENTRY from this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("STRINGP")), list(makeSymbol("CHECK-TYPE"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRY-P")), list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-KEY"), list(makeSymbol("NL-TRIE-STRING-TOKENIZE"), makeSymbol("STRING")))), list(makeSymbol("NL-TRIE-DELETE-ENTRY"), makeSymbol("TRIE"), makeSymbol("TRIE-KEY"), makeSymbol("LEX-ENTRY"))), list(makeSymbol("CLET"), list(list(makeSymbol("CACHE-ENTRIES"), list(makeSymbol("REMOVE"), makeSymbol("LEX-ENTRY"), list(makeSymbol("CACHE-GET"), makeSymbol("CACHE"), makeSymbol("STRING")), list(makeSymbol("QUOTE"), EQUAL)))), list(makeSymbol("CACHE-SET"), makeSymbol("CACHE"), makeSymbol("STRING"), makeSymbol("CACHE-ENTRIES"))), list(makeSymbol("RET"), makeSymbol("SELF")));

    public static final SubLSymbol $sym400$OUTER_CATCH_FOR_ABSTRACT_LEXICON_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-ABSTRACT-LEXICON-METHOD");
    ...
    private static final SubLList $list406 = list(makeString("Adds LEX-ENTRY to this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRY-P")), list(makeSymbol("CLET"), list(list(makeSymbol("STRING"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("LEX-ENTRY"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("STRING"))), makeSymbol("RESULT")), list(makeSymbol("PUNLESS"), list(makeSymbol("CHAR-POSITION"), makeSymbol("*STRIE-NULL-KEY*"), makeSymbol("STRING")), list(makeSymbol("CPUSH"), makeSymbol("LEX-ENTRY"), makeSymbol("LEARNED")), list(makeSymbol("CSETQ"), makeSymbol("RESULT"), list(makeSymbol("NL-TRIE-INSERT-ENTRY"), makeSymbol("TRIE"), list(makeSymbol("NL-TRIE-STRING-TOKENIZE"), makeSymbol("STRING")), list(makeSymbol("LEX-ENTRY2NL-TRIE-ENTRY"), makeSymbol("LEX-ENTRY")))), list(makeSymbol("CACHE-REMOVE"), makeSymbol("CACHE"), makeSymbol("STRING")), list(makeSymbol("RET"), makeSymbol("RESULT"))), list(makeSymbol("RET"), NIL)));
    ...
    private static final SubLList $list410 = list(makeString("Check to see if this lex entry was learned by this lexicon"), list(makeSymbol("RET"), list(makeSymbol("MEMBER?"), makeSymbol("LEX-ENTRY"), makeSymbol("LEARNED"))));
    ...
    private static final SubLList $list414 = list(makeString("Delete all entries previously learned from this lexicon"), list(makeSymbol("CLET"), list(list(makeSymbol("DELETED"), makeSymbol("LEARNED"))), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX"), makeSymbol("LEARNED")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("DELETE")), list(makeSymbol("FIM"), makeSymbol("LEX"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("STRING")))), list(makeSymbol("CSETQ"), makeSymbol("LEARNED"), NIL), list(makeSymbol("RET"), makeSymbol("DELETED"))));
    ...
    private static final SubLList $list419 = list(makeString("@param STRINGS; listp\n   @return listp; a list of conses whose car is a list of strings which are\n   in this lexicon and a prefix of STRINGS, and whose cdr is a lex entry\n   with that string"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRINGS"), makeSymbol("LISTP")), list(makeSymbol("RET"), list(makeSymbol("VALID-PREFIXES"), list(makeSymbol("NL-TRIE-PREFIXES"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY")), makeSymbol("SELF"))));
    ...
    private static final SubLList $list424 = list(makeString("@param STRING stringp\n   @return listp; a list of conses whose car is a list of strings which are\n   in this lexicon and a prefix of STRINGS, and whose cdr is a lex entry\n   with that string"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("STRINGP")), list(makeSymbol("CLET"), list(list(makeSymbol("PREFIX-KEYS"), list(makeSymbol("NL-TRIE-PREFIX-KEYS-FROM-STRING"), makeSymbol("TRIE"), makeSymbol("STRING"), makeSymbol("CASE-SENSITIVITY"))), list(makeSymbol("NL-TRIE-ENTRY"), list(makeSymbol("SECOND"), list(makeSymbol("FIRST"), makeSymbol("PREFIX-KEYS")))), list(makeSymbol("PREFIX-STRING"), list(makeSymbol("NL-TRIE-ENTRY-STRING"), makeSymbol("NL-TRIE-ENTRY")))), list(makeSymbol("RET"), list(makeSymbol("LIST"), list(makeSymbol("VALID-PREFIXES"), makeSymbol("PREFIX-KEYS"), makeSymbol("SELF")), makeSymbol("PREFIX-STRING")))));
    ...
    private static final SubLList $list430 = list(makeString("@param STRINGS; listp\n   @return listp; a list of strings which are both in this lexicon and a prefix of STRINGS"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRINGS"), makeSymbol("LISTP")), list(makeSymbol("RET"), list(makeSymbol("VALID-PREFIX-KEYS"), list(makeSymbol("NL-TRIE-PREFIXES"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY")), makeSymbol("SELF"), makeSymbol("CASE-SENSITIVITY"))));
    ...
    private static final SubLList $list434 = list(makeString("@param STRING stringp\n   @return listp; a list of strings which are both in this lexicon and a prefix of STRINGS"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("STRINGP")), list(makeSymbol("CLET"), list(list(makeSymbol("MY-PREFIX-KEYS"), list(makeSymbol("NL-TRIE-PREFIX-KEYS-FROM-STRING"), makeSymbol("TRIE"), makeSymbol("STRING"), makeSymbol("CASE-SENSITIVITY"))), list(makeSymbol("NL-TRIE-ENTRY"), list(makeSymbol("SECOND"), list(makeSymbol("FIRST"), makeSymbol("MY-PREFIX-KEYS")))), list(makeSymbol("PREFIX-STRING"), list(makeSymbol("NL-TRIE-ENTRY-STRING"), makeSymbol("NL-TRIE-ENTRY")))), list(makeSymbol("RET"), list(makeSymbol("LIST"), list(makeSymbol("VALID-PREFIX-KEYS"), makeSymbol("MY-PREFIX-KEYS"), makeSymbol("SELF"), makeSymbol("CASE-SENSITIVITY")), makeSymbol("PREFIX-STRING")))));
    ...
    private static final SubLList $list439 = list(makeString("@param TEXT stringp; the text from which to learn lexical entries\n   @param LEARNERS listp; a list of learning methods. Each such method\n   is expected to take a natural language string as input and return a \n   list of lex-entries\n   @return non-negative-integerp; the number of entries learned\n   @note it is the responsibility of each learner to add any entries to the lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("TEXT"), makeSymbol("STRINGP")), list(makeSymbol("PUNLESS"), makeSymbol("LEARNERS"), list(makeSymbol("CSETQ"), makeSymbol("LEARNERS"), makeSymbol("ACTIVE-LEARNERS"))), list(makeSymbol("CLET"), list(makeSymbol("LEARNED-HERE")), list(makeSymbol("CDOLIST"), list(makeSymbol("LEARNER"), makeSymbol("LEARNERS")), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX"), list(makeSymbol("FIM"), makeSymbol("SELF"), makeSymbol("LEARNER"), makeSymbol("TEXT"))), list(makeSymbol("CPUSH"), makeSymbol("LEX"), makeSymbol("LEARNED-HERE")))), list(makeSymbol("RET"), makeSymbol("LEARNED-HERE"))));
    ...
    private static final SubLList $list444 = list(list(makeSymbol("IGNORE"), makeSymbol("TEXT")), list(makeSymbol("RET"), NIL));
    ...
    public static final SubLList $list456 = list(makeString("@param TEXT stringp; the text from which to learn lexical entries\n   @return listp; a list of lexical entries learned from TEXT\n   This is a stub just to make sure that all subclasses will be have a base\n   implementation of this method, although we don\'t wish to give it a real\n   implementation as a method of this class."), list(makeSymbol("IGNORE"), makeSymbol("TEXT")), list(makeSymbol("RET"), NIL));
    ...
    private static final SubLList $list461 = list(reader_make_constant_shell(makeString("PhraseFn-Bar1")), reader_make_constant_shell(makeString("Noun")));

    private static final SubLSymbol EXTRACT_PARSE_POS_PRED = makeSymbol("EXTRACT-PARSE-POS-PRED");

    private static final SubLList $list463 = list(reader_make_constant_shell(makeString("NLNumberFn")), reader_make_constant_shell(makeString("Plural-NLAttr")), makeKeyword("ANYTHING"));

    private static final SubLObject $$plural_Generic = reader_make_constant_shell(makeString("plural-Generic"));

    private static final SubLList $list465 = list(reader_make_constant_shell(makeString("NLNumberFn")), reader_make_constant_shell(makeString("Singular-NLAttr")), makeKeyword("ANYTHING"));

    private static final SubLObject $$singular_Generic = reader_make_constant_shell(makeString("singular-Generic"));

    public static final SubLList $list467 = list(reader_make_constant_shell(makeString("NLNumberFn")), reader_make_constant_shell(makeString("Mass-NLAttr")), makeKeyword("ANYTHING"));
    ...
    public static final SubLList $list473 = list(makeSymbol("DOC"));

    private static final SubLList $list474 = list(makeString("@param DOC document-p; \n   @return document-p; a new version of DOC with adjacent words collapsed into\n   single words and nl-trie-entries associated with the words in DOC"), list(makeSymbol("CHECK-TYPE"), makeSymbol("DOC"), makeSymbol("DOCUMENT-P")), list(makeSymbol("CLET"), list(list(makeSymbol("LEXIFIED"), list(makeSymbol("MAKE-DOCUMENT"))), list(makeSymbol("PARAGRAPHS"), NIL)), list(makeSymbol("DOCUMENT-DO-PARAGRAPHS"), list(makeSymbol("PARAGRAPH"), makeSymbol("DOC")), list(makeSymbol("CPUSH"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("LEXIFY-PARAGRAPH")), makeSymbol("PARAGRAPH")), makeSymbol("PARAGRAPHS"))), list(makeSymbol("CSETF"), list(makeSymbol("DOCUMENT-PARAGRAPHS"), makeSymbol("LEXIFIED")), list(makeSymbol("APPLY"), list(makeSymbol("FUNCTION"), makeSymbol("VECTOR")), list(makeSymbol("NREVERSE"), makeSymbol("PARAGRAPHS")))), list(makeSymbol("RET"), makeSymbol("LEXIFIED"))));
    ...
    private static final SubLList $list480 = list(makeString("@param DOC document-p; \n   @return document-p; a new version of DOC with all possible lexical matches included.  \n   The document will contain exhaustive-word-p\'s, each of which will contain zero or more \n   word-p\'s with attached nl-trie-entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("DOC"), makeSymbol("DOCUMENT-P")), list(makeSymbol("CLET"), list(list(makeSymbol("LEXIFIED"), list(makeSymbol("MAKE-DOCUMENT"))), list(makeSymbol("PARAGRAPHS"), NIL)), list(makeSymbol("DOCUMENT-DO-PARAGRAPHS"), list(makeSymbol("PARAGRAPH"), makeSymbol("DOC")), list(makeSymbol("CPUSH"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("LEXIFY-PARAGRAPH-EXHAUSTIVELY")), makeSymbol("PARAGRAPH")), makeSymbol("PARAGRAPHS"))), list(makeSymbol("CSETF"), list(makeSymbol("DOCUMENT-PARAGRAPHS"), makeSymbol("LEXIFIED")), list(makeSymbol("APPLY"), list(makeSymbol("FUNCTION"), makeSymbol("VECTOR")), list(makeSymbol("NREVERSE"), makeSymbol("PARAGRAPHS")))), list(makeSymbol("RET"), makeSymbol("LEXIFIED"))));
    ...
    private static final SubLList $list484 = list(makeString("@param PAR paragraph-p;\n   @return paraphraph-p; a new version of PAR with adjacent words collapsed into\n   single words and nl-trie-entries associated with the words in PAR"), list(makeSymbol("CHECK-TYPE"), makeSymbol("PAR"), makeSymbol("PARAGRAPH-P")), list(makeSymbol("CLET"), list(list(makeSymbol("LEXIFIED"), list(makeSymbol("MAKE-PARAGRAPH"))), list(makeSymbol("SENTENCES"), NIL)), list(makeSymbol("PARAGRAPH-DO-SENTENCES"), list(makeSymbol("SENTENCE"), makeSymbol("PAR")), list(makeSymbol("CPUSH"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("LEXIFY-SENTENCE")), makeSymbol("SENTENCE")), makeSymbol("SENTENCES"))), list(makeSymbol("CSETF"), list(makeSymbol("PARAGRAPH-SENTENCES"), makeSymbol("LEXIFIED")), list(makeSymbol("APPLY"), list(makeSymbol("FUNCTION"), makeSymbol("VECTOR")), list(makeSymbol("NREVERSE"), makeSymbol("SENTENCES")))), list(makeSymbol("RET"), makeSymbol("LEXIFIED"))));
    ...
    private static final SubLList $list488 = list(makeString("@param PAR paragraph-p;\n   @return paraphraph-p; a new version of PAR with all possible lexical matches included.  \n   The document will contain exhaustive-word-p\'s, each of which will contain zero or more \n   word-p\'s with attached nl-trie-entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("PAR"), makeSymbol("PARAGRAPH-P")), list(makeSymbol("CLET"), list(list(makeSymbol("LEXIFIED"), list(makeSymbol("MAKE-PARAGRAPH"))), list(makeSymbol("SENTENCES"), NIL)), list(makeSymbol("PARAGRAPH-DO-SENTENCES"), list(makeSymbol("SENTENCE"), makeSymbol("PAR")), list(makeSymbol("CPUSH"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("LEXIFY-SENTENCE-EXHAUSTIVELY")), makeSymbol("SENTENCE")), makeSymbol("SENTENCES"))), list(makeSymbol("CSETF"), list(makeSymbol("PARAGRAPH-SENTENCES"), makeSymbol("LEXIFIED")), list(makeSymbol("APPLY"), list(makeSymbol("FUNCTION"), makeSymbol("VECTOR")), list(makeSymbol("NREVERSE"), makeSymbol("SENTENCES")))), list(makeSymbol("RET"), makeSymbol("LEXIFIED"))));
    ...
    public static final SubLList $list491 = list(makeSymbol("SENTENCE"));

    private static final SubLList $list492 = list(makeString("@param sentence sentence-p;\n   @return sentence-p; a new version of SENTENCE with adjacent words collapsed into\n   single words and nl-trie-entries associated with the words in SENTENCE"), list(makeSymbol("CHECK-TYPE"), makeSymbol("SENTENCE"), makeSymbol("SENTENCE-P")), list(makeSymbol("PWHEN"), list(makeSymbol("ZEROP"), list(makeSymbol("SENTENCE-LENGTH"), makeSymbol("SENTENCE"))), list(makeSymbol("RET"), makeSymbol("SENTENCE"))), list(new SubLObject[]{ makeSymbol("CLET"), list(list(makeSymbol("LEXIFIED"), list(makeSymbol("NEW-SENTENCE"))), list(makeSymbol("WORD-VEC"), list(makeSymbol("SENTENCE-YIELD"), makeSymbol("SENTENCE"))), list(makeSymbol("FIRST-WORD"), list(makeSymbol("WORD-STRING"), list(makeSymbol("AREF"), makeSymbol("WORD-VEC"), ZERO_INTEGER))), list(makeSymbol("RECORD-LENGTH"), ZERO_INTEGER), list(makeSymbol("LEXIFIED-TOKENS"), NIL), makeSymbol("WORDS"), list(makeSymbol("TOKENIZING-STREAM"), list(makeSymbol("MAKE-PRIVATE-STRING-OUTPUT-STREAM")))), list(makeSymbol("TAGGER-NORMALIZE-INITIAL-CAPITALIZATION"), list(makeSymbol("GET-TAGGER")), makeSymbol("WORD-VEC")), list(makeSymbol("CSETQ"), makeSymbol("WORDS"), list(makeSymbol("VECTOR-ELEMENTS"), makeSymbol("WORD-VEC"))), list(makeSymbol("CLET"), list(list(makeSymbol("*LEXICON-LOOKUP-MT*"), reader_make_constant_shell(makeString("InferencePSC")))), list(makeSymbol("CDO"), list(list(makeSymbol("INDEX"), ZERO_INTEGER, list(makeSymbol("+"), makeSymbol("INDEX"), makeSymbol("RECORD-LENGTH"))), list(makeSymbol("TOKENS"), makeSymbol("WORDS"), list(makeSymbol("NTHCDR"), makeSymbol("RECORD-LENGTH"), makeSymbol("TOKENS")))), list(list(makeSymbol("NULL"), makeSymbol("TOKENS"))), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-TOKEN-ADDED?"), NIL)), list(makeSymbol("CSOME"), list(makeSymbol("STRINGS"), list(makeSymbol("NL-TRIE-STRING-TOKENIZE-MULTIPLE"), list(makeSymbol("CONSTRUCT-STRING-FROM-WORDS"), makeSymbol("TOKENS"), NIL, makeSymbol("TOKENIZING-STREAM"))), makeSymbol("NEW-TOKEN-ADDED?")), list(makeSymbol("CLET"), list(list(makeSymbol("PREFIXES"), list(makeSymbol("NL-TRIE-PREFIXES-MEMOIZED"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY"))), list(makeSymbol("NEW-TOKEN"), NIL), list(makeSymbol("LOCAL-CASE-SENSITIVITY"), makeSymbol("CASE-SENSITIVITY")), list(makeSymbol("ITERATION-COUNT"), ZERO_INTEGER)), list(makeSymbol("UNTIL"), list(makeSymbol("COR"), list(makeSymbol("LEXIFIED-WORD-P"), makeSymbol("NEW-TOKEN")), list(makeSymbol("EMPTY-LIST-P"), makeSymbol("PREFIXES"))), list(makeSymbol("CINC"), makeSymbol("ITERATION-COUNT")), list(makeSymbol("PWHEN"), list(makeSymbol(">"), makeSymbol("ITERATION-COUNT"), TWENTY_INTEGER), list(makeSymbol("BREAK"), makeString("20 iterations hit inside abstract-lexicon:lexify-sentence.  We seem to be stuck.  Please report this problem through standard bug-reporting channels. '~S'"), makeSymbol("SENTENCE"))), list(makeSymbol("POP-BIND"), list(makeSymbol("RECORD"), makeSymbol("PREFIXES")), list(makeSymbol("CMULTIPLE-VALUE-SETQ"), list(makeSymbol("NEW-TOKEN"), makeSymbol("RECORD-LENGTH")), list(makeSymbol("GET-LEX-ENTRIES-FOR-PREFIX"), makeSymbol("SELF"), makeSymbol("TOKENS"), makeSymbol("STRINGS"), makeSymbol("RECORD"), makeSymbol("LEXIFIED")))), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("EMPTY-LIST-P"), makeSymbol("PREFIXES")), list(makeSymbol("NULL"), list(makeSymbol("WORD-INFO"), makeSymbol("NEW-TOKEN"))), list(EQ, makeSymbol("LOCAL-CASE-SENSITIVITY"), makeKeyword("PREFERRED"))), list(makeSymbol("CSETQ"), makeSymbol("LOCAL-CASE-SENSITIVITY"), makeKeyword("OFF")), list(makeSymbol("CSETQ"), makeSymbol("PREFIXES"), list(makeSymbol("NL-TRIE-PREFIXES-MEMOIZED"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("LOCAL-CASE-SENSITIVITY"))))), list(makeSymbol("PUNLESS"), list(makeSymbol("WORD-P"), makeSymbol("NEW-TOKEN")), list(makeSymbol("CMULTIPLE-VALUE-SETQ"), list(makeSymbol("NEW-TOKEN"), makeSymbol("RECORD-LENGTH")), list(makeSymbol("GET-LEX-ENTRIES-FOR-PREFIX"), makeSymbol("SELF"), makeSymbol("TOKENS"), makeSymbol("STRINGS"), NIL, makeSymbol("LEXIFIED")))), list(makeSymbol("PUNLESS"), list(makeSymbol("="), makeSymbol("RECORD-LENGTH"), ZERO_INTEGER), list(makeSymbol("CPUSH"), makeSymbol("NEW-TOKEN"), makeSymbol("LEXIFIED-TOKENS")), list(makeSymbol("CSETQ"), makeSymbol("NEW-TOKEN-ADDED?"), T))))))), list(makeSymbol("CSETF"), list(makeSymbol("SIGN-CONSTITUENTS"), makeSymbol("LEXIFIED")), list(makeSymbol("APPLY"), list(makeSymbol("FUNCTION"), makeSymbol("VECTOR")), list(makeSymbol("NREVERSE"), makeSymbol("LEXIFIED-TOKENS")))), list(makeSymbol("PUNLESS"), list(EQUAL, list(makeSymbol("WORD-STRING"), list(makeSymbol("SENTENCE-GET"), makeSymbol("LEXIFIED"), ZERO_INTEGER)), makeSymbol("FIRST-WORD")), list(makeSymbol("WORD-UPDATE"), list(makeSymbol("SENTENCE-GET"), makeSymbol("LEXIFIED"), ZERO_INTEGER), list(makeSymbol("LIST"), makeKeyword("STRING"), list(makeSymbol("REPLACE"), list(makeSymbol("WORD-STRING"), list(makeSymbol("SENTENCE-GET"), makeSymbol("LEXIFIED"), ZERO_INTEGER)), makeSymbol("FIRST-WORD"))))), list(makeSymbol("CSETF"), list(makeSymbol("SIGN-STRING"), makeSymbol("LEXIFIED")), list(makeSymbol("SENTENCE-STRING"), makeSymbol("SENTENCE"))), list(makeSymbol("PWHEN"), list(makeSymbol("SENTENCE-MOTHER"), makeSymbol("SENTENCE")), list(makeSymbol("PARAGRAPH-SET"), list(makeSymbol("SENTENCE-MOTHER"), makeSymbol("SENTENCE")), list(makeSymbol("SENTENCE-INDEX"), makeSymbol("SENTENCE")), makeSymbol("LEXIFIED"))), list(makeSymbol("RET"), makeSymbol("LEXIFIED")) }));
    ...
    private static final SubLList $list497 = list(makeString("@param sentence sentence-p;\n   @return sentence-p; a new version of SENTENCE with all possible lexical matches included.  \n   The document will contain exhaustive-word-p\'s, each of which will contain zero or more \n   word-p\'s with attached nl-trie-entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("SENTENCE"), makeSymbol("SENTENCE-P")), list(makeSymbol("PWHEN"), list(makeSymbol("ZEROP"), list(makeSymbol("SENTENCE-LENGTH"), makeSymbol("SENTENCE"))), list(makeSymbol("RET"), makeSymbol("SENTENCE"))), list(new SubLObject[]{ makeSymbol("CLET"), list(list(makeSymbol("LEXIFIED"), list(makeSymbol("NEW-SENTENCE"))), list(makeSymbol("WORD-VEC"), list(makeSymbol("SENTENCE-YIELD"), makeSymbol("SENTENCE"))), list(makeSymbol("FIRST-WORD"), list(makeSymbol("WORD-STRING"), list(makeSymbol("AREF"), makeSymbol("WORD-VEC"), ZERO_INTEGER))), list(makeSymbol("EXHAUSTIVE-WORDS"), NIL), makeSymbol("WORDS")), list(makeSymbol("TAGGER-NORMALIZE-INITIAL-CAPITALIZATION"), list(makeSymbol("GET-TAGGER")), makeSymbol("WORD-VEC")), list(makeSymbol("CSETQ"), makeSymbol("WORDS"), list(makeSymbol("VECTOR-ELEMENTS"), makeSymbol("WORD-VEC"))), list(makeSymbol("CLET"), list(list(makeSymbol("*LEXICON-LOOKUP-MT*"), reader_make_constant_shell(makeString("InferencePSC")))), list(makeSymbol("CDO"), list(list(makeSymbol("INDEX"), ZERO_INTEGER, list(makeSymbol("+"), makeSymbol("INDEX"), ONE_INTEGER)), list(makeSymbol("TOKENS"), makeSymbol("WORDS"), list(makeSymbol("CDR"), makeSymbol("TOKENS"))), list(makeSymbol("STRINGS"), list(makeSymbol("MAPCAR"), list(makeSymbol("FUNCTION"), makeSymbol("WORD-STRING")), makeSymbol("TOKENS")), list(makeSymbol("CDR"), makeSymbol("STRINGS")))), list(list(makeSymbol("NULL"), makeSymbol("TOKENS"))), list(makeSymbol("CLET"), list(list(makeSymbol("PREFIXES"), list(makeSymbol("NL-TRIE-PREFIXES-MEMOIZED"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY"))), list(makeSymbol("PARENT-WORD"), list(makeSymbol("NEW-EXHAUSTIVE-WORD-FROM-WORD"), list(makeSymbol("FIRST"), makeSymbol("TOKENS")))), list(makeSymbol("PREFIX-WORDS"), list(makeSymbol("GET-ALL-PREFIX-WORDS"), makeSymbol("SELF"), makeSymbol("PREFIXES"), makeSymbol("TOKENS"), makeSymbol("STRINGS"), makeSymbol("LEXIFIED"), makeSymbol("PARENT-WORD")))), list(makeSymbol("CSETF"), list(makeSymbol("SIGN-CONSTITUENTS"), makeSymbol("PARENT-WORD")), list(makeSymbol("APPLY"), list(makeSymbol("FUNCTION"), makeSymbol("VECTOR")), makeSymbol("PREFIX-WORDS"))), list(makeSymbol("CPUSH"), makeSymbol("PARENT-WORD"), makeSymbol("EXHAUSTIVE-WORDS"))))), list(makeSymbol("CSETF"), list(makeSymbol("SIGN-CONSTITUENTS"), makeSymbol("LEXIFIED")), list(makeSymbol("APPLY"), list(makeSymbol("FUNCTION"), makeSymbol("VECTOR")), list(makeSymbol("NREVERSE"), makeSymbol("EXHAUSTIVE-WORDS")))), list(makeSymbol("CDOLIST"), list(makeSymbol("FIRST-WORD-OBJ"), list(makeSymbol("CONS"), list(makeSymbol("SENTENCE-GET"), makeSymbol("LEXIFIED"), ZERO_INTEGER), list(makeSymbol("VECTOR-ELEMENTS"), list(makeSymbol("WORD-CONSTITUENTS"), list(makeSymbol("SENTENCE-GET"), makeSymbol("LEXIFIED"), ZERO_INTEGER))))), list(makeSymbol("WORD-UPDATE"), makeSymbol("FIRST-WORD-OBJ"), list(makeSymbol("LIST"), makeKeyword("STRING"), list(makeSymbol("REPLACE"), list(makeSymbol("WORD-STRING"), makeSymbol("FIRST-WORD-OBJ")), makeSymbol("FIRST-WORD"))))), list(makeSymbol("CSETF"), list(makeSymbol("SIGN-STRING"), makeSymbol("LEXIFIED")), list(makeSymbol("SENTENCE-STRING"), makeSymbol("SENTENCE"))), list(makeSymbol("PWHEN"), list(makeSymbol("SENTENCE-MOTHER"), makeSymbol("SENTENCE")), list(makeSymbol("PARAGRAPH-SET"), list(makeSymbol("SENTENCE-MOTHER"), makeSymbol("SENTENCE")), list(makeSymbol("SENTENCE-INDEX"), makeSymbol("SENTENCE")), makeSymbol("LEXIFIED"))), list(makeSymbol("RET"), makeSymbol("LEXIFIED")) }));
    ...
    public static final SubLList $list507 = list(makeKeyword("VB"), makeKeyword("VBN"), makeKeyword("VBZ"), makeKeyword("VBD"));
    ...
    private static final SubLList $list513 = list(makeKeyword("NNP"), makeKeyword("NNPS"), makeKeyword("NN"), makeKeyword("NNS"));

    private static final SubLSymbol LEXIFY_WORDS = makeSymbol("LEXIFY-WORDS");

    public static final SubLList $list515 = list(makeSymbol("WORDS"));

    private static final SubLList $list516 = list(makeString("@param WORDS listp;\n   @return listp; a list of <string, category, lex-entries> triples for WORDS, where\n   STRING may be several of WORDS collapsed into a single entry"), list(makeSymbol("CHECK-TYPE"), makeSymbol("WORDS"), makeSymbol("LISTP")), list(makeSymbol("CLET"), list(list(makeSymbol("RECORD-LENGTH"), ZERO_INTEGER), list(makeSymbol("LEXIFIED-TOKENS"), NIL), makeSymbol("CATEGORY"), makeSymbol("STRING")), list(makeSymbol("CDO"), list(list(makeSymbol("INDEX"), ZERO_INTEGER, list(makeSymbol("+"), makeSymbol("INDEX"), makeSymbol("RECORD-LENGTH"))), list(makeSymbol("TOKENS"), makeSymbol("WORDS"), list(makeSymbol("NTHCDR"), makeSymbol("RECORD-LENGTH"), makeSymbol("TOKENS"))), list(makeSymbol("STRINGS"), list(makeSymbol("MAPCAR"), list(makeSymbol("FUNCTION"), makeSymbol("GET-PARSE-TREE-STRING")), makeSymbol("TOKENS")), list(makeSymbol("NTHCDR"), makeSymbol("RECORD-LENGTH"), makeSymbol("STRINGS"))), list(makeSymbol("RECORDS"), list(makeSymbol("NL-TRIE-PREFIXES"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY")), list(makeSymbol("NL-TRIE-PREFIXES"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY")))), list(list(makeSymbol("NULL"), makeSymbol("TOKENS"))), list(makeSymbol("CSETQ"), makeSymbol("RECORDS"), list(makeSymbol("ADD-TO-END"), list(makeSymbol("NEW-NL-TRIE-RECORD"), list(makeSymbol("LIST"), list(makeSymbol("FIM"), list(makeSymbol("FIRST"), makeSymbol("TOKENS")), list(makeSymbol("QUOTE"), makeSymbol("GET-STRING")))), NIL), makeSymbol("RECORDS"))), list(makeSymbol("CLET"), list(makeSymbol("NEW-TOKEN-ADDED-FOR-PREFIXE")), list(makeSymbol("CSOME"), list(makeSymbol("RECORD"), makeSymbol("RECORDS"), makeSymbol("NEW-TOKEN-ADDED-FOR-PREFIXE")), list(makeSymbol("CSETQ"), makeSymbol("RECORD-LENGTH"), list(makeSymbol("LENGTH"), list(makeSymbol("NL-TRIE-RECORD-KEY"), makeSymbol("RECORD")))), list(makeSymbol("CSETQ"), makeSymbol("STRING"), list(makeSymbol("BUILD-MULTI-WORD-LEXEME"), list(makeSymbol("FIRST-N"), makeSymbol("RECORD-LENGTH"), makeSymbol("STRINGS")))), list(makeSymbol("CSETQ"), makeSymbol("CATEGORY"), list(makeSymbol("GUESS-CATEGORY"), makeSymbol("SELF"), makeSymbol("STRING"), makeSymbol("TOKENS"))), list(makeSymbol("CLET"), list(list(makeSymbol("LEX-ENTRIES"), NIL), makeSymbol("LEX-ENTRIES0"), makeSymbol("EXISTS?")), list(makeSymbol("PUNLESS"), makeSymbol("IGNORE-CACHE?"), list(makeSymbol("CMULTIPLE-VALUE-SETQ"), list(makeSymbol("LEX-ENTRIES0"), makeSymbol("EXISTS?")), list(makeSymbol("CACHE-GET"), makeSymbol("CACHE"), makeSymbol("STRING")))), list(makeSymbol("PUNLESS"), makeSymbol("EXISTS?"), list(makeSymbol("CDOLIST"), list(makeSymbol("NL-TRIE-ENTRY"), list(makeSymbol("NL-TRIE-RECORD-ENTRIES"), makeSymbol("RECORD"))), list(makeSymbol("PWHEN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("VALID-NL-TRIE-ENTRY?")), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX-ENTRY"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("CREATE-LEX-ENTRIES")), makeSymbol("STRING"), makeSymbol("NL-TRIE-ENTRY"))), list(makeSymbol("CPUSH"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRIES0"))))), list(makeSymbol("PUNLESS"), makeSymbol("IGNORE-CACHE?"), list(makeSymbol("CACHE-SET"), makeSymbol("CACHE"), makeSymbol("STRING"), makeSymbol("LEX-ENTRIES0")))), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRIES0")), list(makeSymbol("PWHEN"), list(makeSymbol("MEMBER?"), makeSymbol("CATEGORY"), list(makeSymbol("FIM"), makeSymbol("LEX-ENTRY"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("PENN-TAGS"))), list(makeSymbol("CPUSHNEW"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("QUOTE"), makeSymbol("LEX-ENTRY-EQUAL-P"))))), list(makeSymbol("PUNLESS"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRIES0")), list(makeSymbol("PWHEN"), list(makeSymbol("MEMBER?"), makeSymbol("CATEGORY"), list(makeSymbol("FIM"), makeSymbol("LEX-ENTRY"), list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("BACKOFF-PENN-TAGS"))), list(makeSymbol("CPUSHNEW"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("QUOTE"), makeSymbol("LEX-ENTRY-EQUAL-P")))))), list(makeSymbol("PWHEN"), list(makeSymbol("COR"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("NULL"), list(makeSymbol("NL-TRIE-RECORD-ENTRIES"), makeSymbol("RECORD")))), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("NEW-TOKEN-ADDED-FOR-PREFIXE"), T), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("STRING"), makeSymbol("CATEGORY"), makeSymbol("LEX-ENTRIES")), makeSymbol("LEXIFIED-TOKENS")))))))), list(makeSymbol("RET"), list(makeSymbol("NREVERSE"), makeSymbol("LEXIFIED-TOKENS")))));
    ...
    private static final SubLList $list522 = list(makeString("@param STRING stringp; an English string\n   @return listp; a list of English string tokens from STRING\n   @note Not the most efficient way since words and lexical entries are painfully constructed\n   and then discarded...this should duplicate only the tokenization part of the \'lexify method"), list(makeSymbol("CLET"), list(list(makeSymbol("WORDS"), list(makeSymbol("LEXIFY-SENTENCE"), makeSymbol("SELF"), list(makeSymbol("NEW-SENTENCE"), makeSymbol("STRING"), list(makeSymbol("QUOTE"), makeSymbol("FST-STRING-WORDIFY"))))), list(makeSymbol("STRINGS"), NIL)), list(makeSymbol("SENTENCE-DO-WORDS"), list(makeSymbol("WORD"), makeSymbol("WORDS")), list(makeSymbol("CPUSH"), list(makeSymbol("WORD-STRING"), makeSymbol("WORD")), makeSymbol("STRINGS"))), list(makeSymbol("RET"), list(makeSymbol("NREVERSE"), makeSymbol("STRINGS")))));
    ...
    private static final SubLList $list533 = list(list(makeSymbol("QUOTE"), makeSymbol("GET")), makeKeyword("STRING"));



    private static final SubLList $list535 = list(makeString("@return iterator-p; an iterator for this lexicon"), list(makeSymbol("RET"), list(makeSymbol("NEW-LEXICON-ITERATOR"), makeSymbol("SELF"))));
    ...
    public static final SubLList $list539 = list(makeSymbol("KB-SPEC"));
    ...
    public static final SubLList $list541 = list(list(makeSymbol("KB-SPEC"), makeSymbol("FORT-P")));

    public static final SubLList $list542 = list(makeSymbol("ABSTRACT-LEXICON-P"));

    private static final SubLSymbol $sym543$_CLASS_NAME = makeSymbol("?CLASS-NAME");

    private static final SubLObject $$objectClassName = reader_make_constant_shell(makeString("objectClassName"));
    ...
    private static final SubLObject $$disallowedLexicalPredicate = reader_make_constant_shell(makeString("disallowedLexicalPredicate"));
    ...
    public static final SubLList $list558 = list(makeKeyword("TRIE-ITERATOR"), makeKeyword("NEXT-ENTRIES"), makeKeyword("LEXICON"));
    ...
    public static final SubLList $list576 = list(list(makeSymbol("TERM"), makeSymbol("FORMULA")), makeSymbol("&BODY"), makeSymbol("BODY"));
    ...
    private static final SubLList $list596 = list(new SubLObject[]{ list(list(makeString("0.4")), list(list(makeString("0.4"), makeDouble(0.4)))), list(list(makeString("-0.4")), list(list(makeString("-0.4"), makeDouble(-0.4)))), list(list(makeString("-.4")), list(list(makeString("-.4"), makeDouble(-0.4)))), list(list(makeString("0.4%")), list(list(makeString("0.4%"), list(reader_make_constant_shell(makeString("Percent")), makeDouble(0.4))))), list(list(makeString("4%")), list(list(makeString("4%"), list(reader_make_constant_shell(makeString("Percent")), FOUR_INTEGER)))), list(list(makeString(".4%")), list(list(makeString(".4%"), list(reader_make_constant_shell(makeString("Percent")), makeDouble(0.4))))), list(list(makeString("-0.4%")), list(list(makeString("-0.4%"), list(reader_make_constant_shell(makeString("Percent")), makeDouble(-0.4))))), list(list(makeString("-.4%")), list(list(makeString("-.4%"), list(reader_make_constant_shell(makeString("Percent")), makeDouble(-0.4))))), list(list(makeString("-4%")), list(list(makeString("-4%"), list(reader_make_constant_shell(makeString("Percent")), makeInteger(-4))))) });

    private static final SubLSymbol TEXT_NUMBERS = makeSymbol("TEXT-NUMBERS");

    private static final SubLList $list598 = list(list(list(makeString("3.4   billion dogs and 2 cats")), list(makeString("3.4   billion"), makeString("2"))), list(list(makeString("3.4   billion 2")), list(makeString("3.4   billion"), makeString("2"))), list(list(makeString("3.1415926 is pi")), list(makeString("3.1415926"))), list(list(makeString("November 12 1832")), list(makeString("12"), makeString("1832"))), list(list(makeString("3.1415926, 2.3456789 and 1.3254 are numbers")), list(makeString("3.1415926"), makeString("2.3456789"), makeString("1.3254"))), list(list(makeString("3.1415926, -2.3456789 and 1.3254 are numbers")), list(makeString("3.1415926"), makeString("-2.3456789"), makeString("1.3254"))));
    ...
    private static final SubLList $list604 = list(list(list(makeString("3.4   billion dogs and 2 cats")), list(list(makeString("2"), TWO_INTEGER), list(makeString("3.4   billion"), makeDouble(3.4E9)))), list(list(makeString("3.1415926 is pi")), list(list(makeString("3.1415926"), makeDouble(3.1415926)))), list(list(makeString("3.1415926, 2.3456789 and 1.3254 are numbers")), list(list(makeString("1.3254"), makeDouble(1.3254)), list(makeString("2.3456789"), makeDouble(2.3456789)), list(makeString("3.1415926"), makeDouble(3.1415926)))), list(list(makeString("3.1415926, -2.3456789 and 1.3254 are numbers")), list(list(makeString("1.3254"), makeDouble(1.3254)), list(makeString("-2.3456789"), makeDouble(-2.3456789)), list(makeString("3.1415926"), makeDouble(3.1415926)))));

    private static final SubLSymbol TOKENIZING_TEST_COVERING = makeSymbol("TOKENIZING-TEST-COVERING");

    private static final SubLList $list606 = list(list(list(makeString("glyceraldehdyde 3-phosphate (G3P) sleep"), list(reader_make_constant_shell(makeString("Glyceraldehyde3Phosphate")))), NIL), list(list(makeString("glyceraldehdyde 3-phosphate (G3P)"), list(reader_make_constant_shell(makeString("Glyceraldehyde3Phosphate")))), T));
    ...
    public static SubLObject textract_lemma_p(final SubLObject v_object) {
        return v_object.getClass() == abstract_lexicon.$textract_lemma_native.class ? T : NIL;
    }

    public static SubLObject textract_lemma_paragraph(final SubLObject v_object) {
        assert NIL != textract_lemma_p(v_object) : "abstract_lexicon.textract_lemma_p(v_object) " + "CommonSymbols.NIL != abstract_lexicon.textract_lemma_p(v_object) " + v_object;
    ...
    public static SubLObject make_textract_lemma(SubLObject arglist) {
        ...
        final SubLObject v_new = new abstract_lexicon.$textract_lemma_native();
        SubLObject next;
    ...
    public static SubLObject new_textract_lemma(final SubLObject line) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != stringp(line) : "Types.stringp(line) " + "CommonSymbols.NIL != Types.stringp(line) " + line;
    ...
    public static SubLObject lex_entry_equal_p(final SubLObject lex1, final SubLObject lex2) {
        ...
        for (equalP = T, properties2 = get_lex_entry_properties(lex2), keyXvalue1 = NIL, properties3 = NIL, keyXvalue1 = get_lex_entry_properties(lex1).first(), properties3 = get_lex_entry_properties(lex1).rest(); (NIL != keyXvalue1) && (NIL != equalP); equalP = makeBoolean((NIL != equalP) && (NIL != member(keyXvalue1, properties2, EQUAL, UNPROVIDED))) , keyXvalue1 = properties3.first() , properties3 = properties3.rest()) {
        }
        return equalP;
    }
    ...
    public static SubLObject abstract_lexicon_delete_entry_from_string_method(final SubLObject self, final SubLObject lex_entry, final SubLObject string) {
        ...
        try {
            ...
            try {
                ...
                assert NIL != lex_entry_p(lex_entry) : "abstract_lexicon.lex_entry_p(lex_entry) " + "CommonSymbols.NIL != abstract_lexicon.lex_entry_p(lex_entry) " + lex_entry;
    ...
    public static SubLObject abstract_lexicon_prefixes_method(final SubLObject self, final SubLObject strings) {
        ...
        try {
            ...
            try {
                assert NIL != listp(strings) : "Types.listp(strings) " + "CommonSymbols.NIL != Types.listp(strings) " + strings;
    ...
    public static SubLObject abstract_lexicon_lexify_paragraph_method(final SubLObject self, final SubLObject par) {
        assert NIL != document.paragraph_p(par) : "document.paragraph_p(par) " + "CommonSymbols.NIL != document.paragraph_p(par) " + par;
        ...
        if (NIL == existsP) {
            ...
            while (NIL != cdolist_list_var) {
                if (NIL != methods.funcall_instance_method_with_1_args(lexicon, $sym242$VALID_NL_TRIE_ENTRY_, nl_trie_entry)) {
                    ...
                    if (NIL != methods.funcall_instance_method_with_1_args(lexicon, $sym409$LEARNED_, nl_trie_entry)) {
    ...
    public static SubLObject guess_category(final SubLObject lexicon, final SubLObject string, final SubLObject tokens) {
        assert NIL != abstract_lexicon_p(lexicon) : "abstract_lexicon.abstract_lexicon_p(lexicon) " + "CommonSymbols.NIL != abstract_lexicon.abstract_lexicon_p(lexicon) " + lexicon;
        assert NIL != stringp(string) : "Types.stringp(string) " + "CommonSymbols.NIL != Types.stringp(string) " + string;
        assert NIL != listp(tokens) : "Types.listp(tokens) " + "CommonSymbols.NIL != Types.listp(tokens) " + tokens;
        final SubLObject first_word = tokens.first();
        final SubLObject last_word = last(tokens, UNPROVIDED).first();
    ...
    public static SubLObject abstract_lexicon_iterator_state_p(final SubLObject v_object) {
        return v_object.getClass() == abstract_lexicon.$abstract_lexicon_iterator_state_native.class ? T : NIL;
    }

    public static SubLObject abstract_lexicon_iterator_state_trie_iterator(final SubLObject v_object) {
        assert NIL != abstract_lexicon_iterator_state_p(v_object) : "abstract_lexicon.abstract_lexicon_iterator_state_p(v_object) " + "CommonSymbols.NIL != abstract_lexicon.abstract_lexicon_iterator_state_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_abstract_lexicon_iterator_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new abstract_lexicon.$abstract_lexicon_iterator_state_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject declare_abstract_lexicon_file() {
        declareFunction(me, "get_cyc_to_penn_map", "GET-CYC-TO-PENN-MAP", 0, 0, false);
        declareFunction(me, "ensure_cyc_to_penn_map", "ENSURE-CYC-TO-PENN-MAP", 0, 0, false);
        declareFunction(me, "reinitialize_cyc_to_penn_map", "REINITIALIZE-CYC-TO-PENN-MAP", 0, 0, false);
        declareFunction(me, "get_cyc_to_penn_list", "GET-CYC-TO-PENN-LIST", 0, 0, false);
        declareFunction(me, "ensure_cyc_to_penn_list", "ENSURE-CYC-TO-PENN-LIST", 0, 0, false);
        declareFunction(me, "rebuild_cyc_to_penn_map", "REBUILD-CYC-TO-PENN-MAP", 0, 0, false);
        declareFunction(me, "build_cyc_to_penn_map", "BUILD-CYC-TO-PENN-MAP", 0, 0, false);
        declareFunction(me, "build_cyc_to_supertag_map", "BUILD-CYC-TO-SUPERTAG-MAP", 0, 0, false);
        declareFunction(me, "textract_lemma_print_function_trampoline", "TEXTRACT-LEMMA-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "textract_lemma_p", "TEXTRACT-LEMMA-P", 1, 0, false);
        new abstract_lexicon.$textract_lemma_p$UnaryFunction();
        declareFunction(me, "textract_lemma_paragraph", "TEXTRACT-LEMMA-PARAGRAPH", 1, 0, false);
        declareFunction(me, "textract_lemma_sentence", "TEXTRACT-LEMMA-SENTENCE", 1, 0, false);
        declareFunction(me, "textract_lemma_word", "TEXTRACT-LEMMA-WORD", 1, 0, false);
        declareFunction(me, "textract_lemma_string", "TEXTRACT-LEMMA-STRING", 1, 0, false);
        declareFunction(me, "textract_lemma_canon", "TEXTRACT-LEMMA-CANON", 1, 0, false);
        declareFunction(me, "textract_lemma_type", "TEXTRACT-LEMMA-TYPE", 1, 0, false);
        declareFunction(me, "_csetf_textract_lemma_paragraph", "_CSETF-TEXTRACT-LEMMA-PARAGRAPH", 2, 0, false);
        declareFunction(me, "_csetf_textract_lemma_sentence", "_CSETF-TEXTRACT-LEMMA-SENTENCE", 2, 0, false);
        declareFunction(me, "_csetf_textract_lemma_word", "_CSETF-TEXTRACT-LEMMA-WORD", 2, 0, false);
        declareFunction(me, "_csetf_textract_lemma_string", "_CSETF-TEXTRACT-LEMMA-STRING", 2, 0, false);
        declareFunction(me, "_csetf_textract_lemma_canon", "_CSETF-TEXTRACT-LEMMA-CANON", 2, 0, false);
        declareFunction(me, "_csetf_textract_lemma_type", "_CSETF-TEXTRACT-LEMMA-TYPE", 2, 0, false);
        declareFunction(me, "make_textract_lemma", "MAKE-TEXTRACT-LEMMA", 0, 1, false);
        declareFunction(me, "visit_defstruct_textract_lemma", "VISIT-DEFSTRUCT-TEXTRACT-LEMMA", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_textract_lemma_method", "VISIT-DEFSTRUCT-OBJECT-TEXTRACT-LEMMA-METHOD", 2, 0, false);
        declareFunction(me, "new_textract_lemma", "NEW-TEXTRACT-LEMMA", 1, 0, false);
        declareFunction(me, "textract_lemma_print", "TEXTRACT-LEMMA-PRINT", 3, 0, false);
        declareFunction(me, "get_lex_entry_properties", "GET-LEX-ENTRY-PROPERTIES", 1, 0, false);
        declareFunction(me, "set_lex_entry_properties", "SET-LEX-ENTRY-PROPERTIES", 2, 0, false);
        declareFunction(me, "get_lex_entry_supported_properties", "GET-LEX-ENTRY-SUPPORTED-PROPERTIES", 1, 0, false);
        declareFunction(me, "set_lex_entry_supported_properties", "SET-LEX-ENTRY-SUPPORTED-PROPERTIES", 2, 0, false);
        declareFunction(me, "get_lex_entry_computed_properties", "GET-LEX-ENTRY-COMPUTED-PROPERTIES", 1, 0, false);
        declareFunction(me, "set_lex_entry_computed_properties", "SET-LEX-ENTRY-COMPUTED-PROPERTIES", 2, 0, false);
        declareFunction(me, "get_lex_entry_stored_properties", "GET-LEX-ENTRY-STORED-PROPERTIES", 1, 0, false);
        declareFunction(me, "set_lex_entry_stored_properties", "SET-LEX-ENTRY-STORED-PROPERTIES", 2, 0, false);
        declareFunction(me, "subloop_reserved_initialize_lex_entry_class", "SUBLOOP-RESERVED-INITIALIZE-LEX-ENTRY-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_lex_entry_instance", "SUBLOOP-RESERVED-INITIALIZE-LEX-ENTRY-INSTANCE", 1, 0, false);
        declareFunction(me, "lex_entry_p", "LEX-ENTRY-P", 1, 0, false);
        declareFunction(me, "lex_entry_initialize_method", "LEX-ENTRY-INITIALIZE-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_get_method", "LEX-ENTRY-GET-METHOD", 2, 0, false);
        declareFunction(me, "lex_entry_denot", "LEX-ENTRY-DENOT", 1, 0, false);
        declareFunction(me, "lex_entry_semtrans", "LEX-ENTRY-SEMTRANS", 1, 0, false);
        declareFunction(me, "lex_entry_trie_entry", "LEX-ENTRY-TRIE-ENTRY", 1, 0, false);
        declareFunction(me, "lex_entry_set_method", "LEX-ENTRY-SET-METHOD", 3, 0, false);
        declareFunction(me, "lex_entry_copy_method", "LEX-ENTRY-COPY-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_nounP_method", "LEX-ENTRY-NOUN?-METHOD", 1, 1, false);
        declareFunction(me, "lex_entry_print_method", "LEX-ENTRY-PRINT-METHOD", 3, 0, false);
        declareFunction(me, "lex_entry_nominal_p_method", "LEX-ENTRY-NOMINAL-P-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_verbal_p_method", "LEX-ENTRY-VERBAL-P-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_adjectival_p_method", "LEX-ENTRY-ADJECTIVAL-P-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_adverbial_p_method", "LEX-ENTRY-ADVERBIAL-P-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_compute_term_method", "LEX-ENTRY-COMPUTE-TERM-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_compute_gender_method", "LEX-ENTRY-COMPUTE-GENDER-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_compute_penn_tags_method", "LEX-ENTRY-COMPUTE-PENN-TAGS-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_compute_backoff_penn_tags_method", "LEX-ENTRY-COMPUTE-BACKOFF-PENN-TAGS-METHOD", 1, 0, false);
        declareFunction(me, "tag_backoffs", "TAG-BACKOFFS", 1, 0, false);
        declareFunction(me, "lex_entry_compute_super_tags_method", "LEX-ENTRY-COMPUTE-SUPER-TAGS-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_compute_cyc_pos_method", "LEX-ENTRY-COMPUTE-CYC-POS-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_compute_is_ner_entry_method", "LEX-ENTRY-COMPUTE-IS-NER-ENTRY-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_compute_cyc_category_method", "LEX-ENTRY-COMPUTE-CYC-CATEGORY-METHOD", 1, 0, false);
        declareFunction(me, "lex_entry_compute_inflections_method", "LEX-ENTRY-COMPUTE-INFLECTIONS-METHOD", 1, 0, false);
        declareFunction(me, "get_abstract_lexicon_stop_words", "GET-ABSTRACT-LEXICON-STOP-WORDS", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_stop_words", "SET-ABSTRACT-LEXICON-STOP-WORDS", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_allow_stemming", "GET-ABSTRACT-LEXICON-ALLOW-STEMMING", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_allow_stemming", "SET-ABSTRACT-LEXICON-ALLOW-STEMMING", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_active_learners", "GET-ABSTRACT-LEXICON-ACTIVE-LEARNERS", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_active_learners", "SET-ABSTRACT-LEXICON-ACTIVE-LEARNERS", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_learned", "GET-ABSTRACT-LEXICON-LEARNED", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_learned", "SET-ABSTRACT-LEXICON-LEARNED", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_allow_fabricationP", "GET-ABSTRACT-LEXICON-ALLOW-FABRICATION?", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_allow_fabricationP", "SET-ABSTRACT-LEXICON-ALLOW-FABRICATION?", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_case_sensitivity", "GET-ABSTRACT-LEXICON-CASE-SENSITIVITY", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_case_sensitivity", "SET-ABSTRACT-LEXICON-CASE-SENSITIVITY", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_ignore_cacheP", "GET-ABSTRACT-LEXICON-IGNORE-CACHE?", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_ignore_cacheP", "SET-ABSTRACT-LEXICON-IGNORE-CACHE?", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_cache", "GET-ABSTRACT-LEXICON-CACHE", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_cache", "SET-ABSTRACT-LEXICON-CACHE", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_trie", "GET-ABSTRACT-LEXICON-TRIE", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_trie", "SET-ABSTRACT-LEXICON-TRIE", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_excluded_pos_list", "GET-ABSTRACT-LEXICON-EXCLUDED-POS-LIST", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_excluded_pos_list", "SET-ABSTRACT-LEXICON-EXCLUDED-POS-LIST", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_excluded_preds", "GET-ABSTRACT-LEXICON-EXCLUDED-PREDS", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_excluded_preds", "SET-ABSTRACT-LEXICON-EXCLUDED-PREDS", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_root_mt", "GET-ABSTRACT-LEXICON-ROOT-MT", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_root_mt", "SET-ABSTRACT-LEXICON-ROOT-MT", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_base_mt", "GET-ABSTRACT-LEXICON-BASE-MT", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_base_mt", "SET-ABSTRACT-LEXICON-BASE-MT", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_excluded_mts", "GET-ABSTRACT-LEXICON-EXCLUDED-MTS", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_excluded_mts", "SET-ABSTRACT-LEXICON-EXCLUDED-MTS", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_allowed_mts", "GET-ABSTRACT-LEXICON-ALLOWED-MTS", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_allowed_mts", "SET-ABSTRACT-LEXICON-ALLOWED-MTS", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_default_kb_spec", "GET-ABSTRACT-LEXICON-DEFAULT-KB-SPEC", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_default_kb_spec", "SET-ABSTRACT-LEXICON-DEFAULT-KB-SPEC", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_default_base_mt", "GET-ABSTRACT-LEXICON-DEFAULT-BASE-MT", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_default_base_mt", "SET-ABSTRACT-LEXICON-DEFAULT-BASE-MT", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_default_exclude_predicates", "GET-ABSTRACT-LEXICON-DEFAULT-EXCLUDE-PREDICATES", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_default_exclude_predicates", "SET-ABSTRACT-LEXICON-DEFAULT-EXCLUDE-PREDICATES", 2, 0, false);
        declareFunction(me, "get_abstract_lexicon_default_exclude_mts", "GET-ABSTRACT-LEXICON-DEFAULT-EXCLUDE-MTS", 1, 0, false);
        declareFunction(me, "set_abstract_lexicon_default_exclude_mts", "SET-ABSTRACT-LEXICON-DEFAULT-EXCLUDE-MTS", 2, 0, false);
        declareFunction(me, "subloop_reserved_initialize_abstract_lexicon_class", "SUBLOOP-RESERVED-INITIALIZE-ABSTRACT-LEXICON-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_abstract_lexicon_instance", "SUBLOOP-RESERVED-INITIALIZE-ABSTRACT-LEXICON-INSTANCE", 1, 0, false);
        declareFunction(me, "abstract_lexicon_p", "ABSTRACT-LEXICON-P", 1, 0, false);
        declareFunction(me, "abstract_lexicon_initialize_method", "ABSTRACT-LEXICON-INITIALIZE-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_isolate_method", "ABSTRACT-LEXICON-ISOLATE-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_ignore_cache_method", "ABSTRACT-LEXICON-IGNORE-CACHE-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_ignore_cacheP_method", "ABSTRACT-LEXICON-IGNORE-CACHE?-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_allow_stemming_method", "ABSTRACT-LEXICON-ALLOW-STEMMING-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_forbid_stemming_method", "ABSTRACT-LEXICON-FORBID-STEMMING-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_allow_fabrication_method", "ABSTRACT-LEXICON-ALLOW-FABRICATION-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_forbid_fabrication_method", "ABSTRACT-LEXICON-FORBID-FABRICATION-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_fabrication_forbiddenP_method", "ABSTRACT-LEXICON-FABRICATION-FORBIDDEN?-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_fabrication_allowedP_method", "ABSTRACT-LEXICON-FABRICATION-ALLOWED?-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_valid_nl_trie_entryP_method", "ABSTRACT-LEXICON-VALID-NL-TRIE-ENTRY?-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_set_case_sensitivity_method", "ABSTRACT-LEXICON-SET-CASE-SENSITIVITY-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_get_case_sensitivity_method", "ABSTRACT-LEXICON-GET-CASE-SENSITIVITY-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_initialize_excluded_preds_method", "ABSTRACT-LEXICON-INITIALIZE-EXCLUDED-PREDS-METHOD", 1, 1, false);
        declareFunction(me, "abstract_lexicon_allow_predicate_method", "ABSTRACT-LEXICON-ALLOW-PREDICATE-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_exclude_predicate_method", "ABSTRACT-LEXICON-EXCLUDE-PREDICATE-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_excluded_predicateP_method", "ABSTRACT-LEXICON-EXCLUDED-PREDICATE?-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_allowed_predicateP_method", "ABSTRACT-LEXICON-ALLOWED-PREDICATE?-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_nl_trie_entry_has_allowed_predicateP_method", "ABSTRACT-LEXICON-NL-TRIE-ENTRY-HAS-ALLOWED-PREDICATE?-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_allow_pos_method", "ABSTRACT-LEXICON-ALLOW-POS-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_exclude_pos_method", "ABSTRACT-LEXICON-EXCLUDE-POS-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_excluded_posP_method", "ABSTRACT-LEXICON-EXCLUDED-POS?-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_allowed_posP_method", "ABSTRACT-LEXICON-ALLOWED-POS?-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_nl_trie_entry_has_allowed_posP_method", "ABSTRACT-LEXICON-NL-TRIE-ENTRY-HAS-ALLOWED-POS?-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_add_learner_method", "ABSTRACT-LEXICON-ADD-LEARNER-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_remove_learner_method", "ABSTRACT-LEXICON-REMOVE-LEARNER-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_get_learners_method", "ABSTRACT-LEXICON-GET-LEARNERS-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_set_learners_method", "ABSTRACT-LEXICON-SET-LEARNERS-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_initialize_allowed_mts_method", "ABSTRACT-LEXICON-INITIALIZE-ALLOWED-MTS-METHOD", 1, 1, false);
        declareFunction(me, "abstract_lexicon_set_base_mt_method", "ABSTRACT-LEXICON-SET-BASE-MT-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_get_base_mt_method", "ABSTRACT-LEXICON-GET-BASE-MT-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_allow_mt_method", "ABSTRACT-LEXICON-ALLOW-MT-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_allow_genl_mts_method", "ABSTRACT-LEXICON-ALLOW-GENL-MTS-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_forbid_mt_method", "ABSTRACT-LEXICON-FORBID-MT-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_allowed_mtP_method", "ABSTRACT-LEXICON-ALLOWED-MT?-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_root_mt_method", "ABSTRACT-LEXICON-ROOT-MT-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_add_stop_word_method", "ABSTRACT-LEXICON-ADD-STOP-WORD-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_stop_word_p_method", "ABSTRACT-LEXICON-STOP-WORD-P-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_get_stop_words_method", "ABSTRACT-LEXICON-GET-STOP-WORDS-METHOD", 1, 0, false);
        declareFunction(me, "abstract_lexicon_copy_method", "ABSTRACT-LEXICON-COPY-METHOD", 1, 1, false);
        declareFunction(me, "abstract_lexicon_get_method", "ABSTRACT-LEXICON-GET-METHOD", 2, 0, false);
        declareFunction(me, "add_lex_entries_for_trie_entries", "ADD-LEX-ENTRIES-FOR-TRIE-ENTRIES", 4, 0, false);
        declareFunction(me, "lex_entry_equal_p", "LEX-ENTRY-EQUAL-P", 2, 0, false);
        declareFunction(me, "abstract_lexicon_delete_method", "ABSTRACT-LEXICON-DELETE-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_delete_entry_from_string_method", "ABSTRACT-LEXICON-DELETE-ENTRY-FROM-STRING-METHOD", 3, 0, false);
        declareFunction(me, "delete_nl_trie_lex_entries_for_string", "DELETE-NL-TRIE-LEX-ENTRIES-FOR-STRING", 1, 0, false);
        declareFunction(me, "abstract_lexicon_add_method", "ABSTRACT-LEXICON-ADD-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_learnedP_method", "ABSTRACT-LEXICON-LEARNED?-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_forget_method", "ABSTRACT-LEXICON-FORGET-METHOD", 1, 0, false);
        declareFunction(me, "valid_prefixes", "VALID-PREFIXES", 2, 0, false);
        declareFunction(me, "abstract_lexicon_prefixes_method", "ABSTRACT-LEXICON-PREFIXES-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_prefixes_from_string_method", "ABSTRACT-LEXICON-PREFIXES-FROM-STRING-METHOD", 2, 0, false);
        declareFunction(me, "valid_prefix_keys", "VALID-PREFIX-KEYS", 3, 0, false);
        declareFunction(me, "lexicon_equality_from_case_sensitivity", "LEXICON-EQUALITY-FROM-CASE-SENSITIVITY", 1, 0, false);
        declareFunction(me, "abstract_lexicon_prefix_keys_method", "ABSTRACT-LEXICON-PREFIX-KEYS-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_prefix_keys_from_string_method", "ABSTRACT-LEXICON-PREFIX-KEYS-FROM-STRING-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_learn_method", "ABSTRACT-LEXICON-LEARN-METHOD", 2, 1, false);
        declareFunction(me, "abstract_lexicon_number_learn_method", "ABSTRACT-LEXICON-NUMBER-LEARN-METHOD", 2, 0, false);
        declareFunction(me, "number_meanings", "NUMBER-MEANINGS", 1, 0, false);
        declareFunction(me, "text_numbers", "TEXT-NUMBERS", 1, 0, false);
        declareFunction(me, "scalar_interval_meanings", "SCALAR-INTERVAL-MEANINGS", 1, 0, false);
        declareFunction(me, "text_scalar_intervals", "TEXT-SCALAR-INTERVALS", 1, 0, false);
        declareFunction(me, "scalar_prefix", "SCALAR-PREFIX", 2, 0, false);
        declareFunction(me, "prefix_strings_from_words", "PREFIX-STRINGS-FROM-WORDS", 1, 0, false);
        declareFunction(me, "combine_words_into_string", "COMBINE-WORDS-INTO-STRING", 1, 0, false);
        declareFunction(me, "spaces", "SPACES", 1, 0, false);
        declareFunction(me, "clear_scalar_functionP", "CLEAR-SCALAR-FUNCTION?", 0, 0, false);
        declareFunction(me, "remove_scalar_functionP", "REMOVE-SCALAR-FUNCTION?", 1, 1, false);
        declareFunction(me, "scalar_functionP_internal", "SCALAR-FUNCTION?-INTERNAL", 2, 0, false);
        declareFunction(me, "scalar_functionP", "SCALAR-FUNCTION?", 1, 1, false);
        declareFunction(me, "abstract_lexicon_noun_compound_learn_method", "ABSTRACT-LEXICON-NOUN-COMPOUND-LEARN-METHOD", 2, 0, false);
        declareFunction(me, "tree_nps", "TREE-NPS", 1, 1, false);
        declareFunction(me, "np_treeP", "NP-TREE?", 1, 1, false);
        declareFunction(me, "compounds_from_tree", "COMPOUNDS-FROM-TREE", 1, 0, false);
        declareFunction(me, "text_noun_compounds", "TEXT-NOUN-COMPOUNDS", 1, 0, false);
        declareFunction(me, "noun_compound_meanings", "NOUN-COMPOUND-MEANINGS", 1, 0, false);
        declareFunction(me, "noun_compound_meanings_of_string", "NOUN-COMPOUND-MEANINGS-OF-STRING", 1, 0, false);
        declareFunction(me, "extract_parse_pos_pred", "EXTRACT-PARSE-POS-PRED", 1, 0, false);
        declareFunction(me, "pos_pred_from_nc_parse", "POS-PRED-FROM-NC-PARSE", 1, 0, false);
        declareFunction(me, "abstract_lexicon_cooccurrence_statistics_learn_method", "ABSTRACT-LEXICON-COOCCURRENCE-STATISTICS-LEARN-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_lexify_document_method", "ABSTRACT-LEXICON-LEXIFY-DOCUMENT-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_lexify_document_exhaustively_method", "ABSTRACT-LEXICON-LEXIFY-DOCUMENT-EXHAUSTIVELY-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_lexify_paragraph_method", "ABSTRACT-LEXICON-LEXIFY-PARAGRAPH-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_lexify_paragraph_exhaustively_method", "ABSTRACT-LEXICON-LEXIFY-PARAGRAPH-EXHAUSTIVELY-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_lexify_sentence_method", "ABSTRACT-LEXICON-LEXIFY-SENTENCE-METHOD", 2, 0, false);
        declareFunction(me, "abstract_lexicon_lexify_sentence_exhaustively_method", "ABSTRACT-LEXICON-LEXIFY-SENTENCE-EXHAUSTIVELY-METHOD", 2, 0, false);
        declareFunction(me, "get_all_prefix_words", "GET-ALL-PREFIX-WORDS", 6, 0, false);
        declareFunction(me, "lexified_word_p", "LEXIFIED-WORD-P", 1, 0, false);
        declareFunction(me, "possibly_merge_tokens", "POSSIBLY-MERGE-TOKENS", 1, 0, false);
        declareFunction(me, "get_lex_entries_for_prefix", "GET-LEX-ENTRIES-FOR-PREFIX", 5, 1, false);
        declareFunction(me, "reconstruct_string_from_tokens", "RECONSTRUCT-STRING-FROM-TOKENS", 2, 0, false);
        declareFunction(me, "token_list_equalp", "TOKEN-LIST-EQUALP", 2, 1, false);
        declareFunction(me, "unstemmed_tokens_from_tokens", "UNSTEMMED-TOKENS-FROM-TOKENS", 3, 0, false);
        declareFunction(me, "order_penn_tags", "ORDER-PENN-TAGS", 2, 0, false);
        declareFunction(me, "some_head_initial_lex_entry_has_tag", "SOME-HEAD-INITIAL-LEX-ENTRY-HAS-TAG", 2, 0, false);
        declareFunction(me, "entries_tags", "ENTRIES-TAGS", 1, 0, false);
        declareFunction(me, "entries_backoff_tags", "ENTRIES-BACKOFF-TAGS", 1, 0, false);
        declareFunction(me, "tags_matching_backoff_tags", "TAGS-MATCHING-BACKOFF-TAGS", 2, 0, false);
        declareFunction(me, "guess_category", "GUESS-CATEGORY", 3, 0, false);
        declareFunction(me, "abstract_lexicon_lexify_words_method", "ABSTRACT-LEXICON-LEXIFY-WORDS-METHOD", 2, 0, false);
        declareFunction(me, "build_multi_word_lexeme", "BUILD-MULTI-WORD-LEXEME", 1, 0, false);
        declareFunction(me, "abstract_lexicon_tokenize_method", "ABSTRACT-LEXICON-TOKENIZE-METHOD", 2, 0, false);
        declareMacro(me, "do_lexicon", "DO-LEXICON");
        declareFunction(me, "abstract_lexicon_iterator_method", "ABSTRACT-LEXICON-ITERATOR-METHOD", 1, 0, false);
        declareFunction(me, "new_lexicon_from_kb_spec", "NEW-LEXICON-FROM-KB-SPEC", 1, 0, false);
        declareFunction(me, "lexicon_spec_class_name", "LEXICON-SPEC-CLASS-NAME", 1, 0, false);
        declareFunction(me, "clear_preds_for_lexicon_exclusion", "CLEAR-PREDS-FOR-LEXICON-EXCLUSION", 0, 0, false);
        new abstract_lexicon.$clear_preds_for_lexicon_exclusion$ZeroArityFunction();
        declareFunction(me, "remove_preds_for_lexicon_exclusion", "REMOVE-PREDS-FOR-LEXICON-EXCLUSION", 1, 0, false);
        declareFunction(me, "preds_for_lexicon_exclusion_internal", "PREDS-FOR-LEXICON-EXCLUSION-INTERNAL", 1, 0, false);
        declareFunction(me, "preds_for_lexicon_exclusion", "PREDS-FOR-LEXICON-EXCLUSION", 1, 0, false);
        declareFunction(me, "new_lexicon_iterator", "NEW-LEXICON-ITERATOR", 1, 0, false);
        declareFunction(me, "abstract_lexicon_iterator_state_print_function_trampoline", "ABSTRACT-LEXICON-ITERATOR-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "abstract_lexicon_iterator_state_p", "ABSTRACT-LEXICON-ITERATOR-STATE-P", 1, 0, false);
        new abstract_lexicon.$abstract_lexicon_iterator_state_p$UnaryFunction();
        declareFunction(me, "abstract_lexicon_iterator_state_trie_iterator", "ABSTRACT-LEXICON-ITERATOR-STATE-TRIE-ITERATOR", 1, 0, false);
        declareFunction(me, "abstract_lexicon_iterator_state_next_entries", "ABSTRACT-LEXICON-ITERATOR-STATE-NEXT-ENTRIES", 1, 0, false);
        declareFunction(me, "abstract_lexicon_iterator_state_lexicon", "ABSTRACT-LEXICON-ITERATOR-STATE-LEXICON", 1, 0, false);
        declareFunction(me, "_csetf_abstract_lexicon_iterator_state_trie_iterator", "_CSETF-ABSTRACT-LEXICON-ITERATOR-STATE-TRIE-ITERATOR", 2, 0, false);
        declareFunction(me, "_csetf_abstract_lexicon_iterator_state_next_entries", "_CSETF-ABSTRACT-LEXICON-ITERATOR-STATE-NEXT-ENTRIES", 2, 0, false);
        declareFunction(me, "_csetf_abstract_lexicon_iterator_state_lexicon", "_CSETF-ABSTRACT-LEXICON-ITERATOR-STATE-LEXICON", 2, 0, false);
        declareFunction(me, "make_abstract_lexicon_iterator_state", "MAKE-ABSTRACT-LEXICON-ITERATOR-STATE", 0, 1, false);
        declareFunction(me, "visit_defstruct_abstract_lexicon_iterator_state", "VISIT-DEFSTRUCT-ABSTRACT-LEXICON-ITERATOR-STATE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_abstract_lexicon_iterator_state_method", "VISIT-DEFSTRUCT-OBJECT-ABSTRACT-LEXICON-ITERATOR-STATE-METHOD", 2, 0, false);
        declareFunction(me, "new_abstract_lexicon_iterator_state", "NEW-ABSTRACT-LEXICON-ITERATOR-STATE", 1, 0, false);
        declareFunction(me, "abstract_lexicon_iterator_state_done_p", "ABSTRACT-LEXICON-ITERATOR-STATE-DONE-P", 1, 0, false);
        declareFunction(me, "abstract_lexicon_iterator_state_next", "ABSTRACT-LEXICON-ITERATOR-STATE-NEXT", 1, 0, false);
        declareFunction(me, "valid_denotsP", "VALID-DENOTS?", 1, 0, false);
        declareFunction(me, "lex_entry2nl_trie_entry", "LEX-ENTRY2NL-TRIE-ENTRY", 1, 0, false);
        declareFunction(me, "map_from_cyc_to_penn_pos", "MAP-FROM-CYC-TO-PENN-POS", 2, 0, false);
        declareMacro(me, "with_el_formula_terms", "WITH-EL-FORMULA-TERMS");
        declareFunction(me, "number_meanings_equalP", "NUMBER-MEANINGS-EQUAL?", 2, 0, false);
        declareFunction(me, "number_meanings_results_equalP", "NUMBER-MEANINGS-RESULTS-EQUAL?", 2, 0, false);
        declareFunction(me, "tokenizing_test_covering", "TOKENIZING-TEST-COVERING", 2, 0, false);
        return NIL;
    }
    ...
    private static SubLObject _constant_175_initializer() {
        return list(new SubLObject[]{ list(makeSymbol("DEFAULT-EXCLUDE-MTS"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(makeSymbol("QUOTE"), list(new SubLObject[]{ reader_make_constant_shell(makeString("WebSearchDataMt")), reader_make_constant_shell(makeString("CyclistsMt")), reader_make_constant_shell(makeString("RelationParaphraseMt")), reader_make_constant_shell(makeString("WordNetMappingMt")), reader_make_constant_shell(makeString("PornographyJargonMt")), reader_make_constant_shell(makeString("CommonEnglishMisspellingsMt")), reader_make_constant_shell(makeString("ComputereseLexicalMt")), reader_make_constant_shell(makeString("CyclishMt")), reader_make_constant_shell(makeString("TemporaryLexicalAssertionsMt")), reader_make_constant_shell(makeString("EnglishWordSenseAssertions-HoldingMt")), reader_make_constant_shell(makeString("TemporaryLexicalAssertions-WordNetImportMt")), reader_make_constant_shell(makeString("RedundantLexicalMt")), reader_make_constant_shell(makeString("PDATemplateTestMt")), reader_make_constant_shell(makeString("EnglishParaphraseMt")), reader_make_constant_shell(makeString("SupplementalDeterminerSemTransLexicalMt")) }))), list(makeSymbol("DEFAULT-EXCLUDE-PREDICATES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(makeSymbol("SET-ELEMENT-LIST"), makeSymbol("*SEMANTIC-PREDICATES-EXCLUDED-FROM-LEXICAL-LOOKUP*"))), list(makeSymbol("DEFAULT-BASE-MT"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), reader_make_constant_shell(makeString("AllGeneralEnglishValidatedLexicalMicrotheoryPSC"))), list(makeSymbol("DEFAULT-KB-SPEC"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), reader_make_constant_shell(makeString("AbstractLexiconSpecification"))), list(makeSymbol("ALLOWED-MTS"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), makeKeyword("UNINITIALIZED")), list(makeSymbol("EXCLUDED-MTS"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), makeKeyword("UNINITIALIZED")), list(makeSymbol("BASE-MT"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), makeKeyword("UNINITIALIZED")), list(makeSymbol("ROOT-MT"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), makeKeyword("UNINITIALIZED")), list(makeSymbol("EXCLUDED-PREDS"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), makeKeyword("UNINITIALIZED")), list(makeSymbol("EXCLUDED-POS-LIST"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), NIL), list(makeSymbol("TRIE"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("CACHE"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("IGNORE-CACHE?"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("CASE-SENSITIVITY"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("ALLOW-FABRICATION?"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), T), list(makeSymbol("LEARNED"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("ACTIVE-LEARNERS"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("ALLOW-STEMMING"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), T), list(makeSymbol("STOP-WORDS"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), NIL), list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("RESPORATOR-CYC-POS"), list(makeSymbol("TYPE.STRING")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-CLASS-METHOD"), makeSymbol("RESPORATOR-TO-INFLECTIONS"), list(makeSymbol("TYPE.STRING")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("RESPORATOR-TO-CYCL"), list(makeSymbol("TYPE.STRING")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("VALID-NL-TRIE-ENTRY?"), list(makeSymbol("NL-TRIE-ENTRY")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COPY"), list(makeSymbol("&OPTIONAL"), makeSymbol("TARGET")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET"), list(makeSymbol("STRING")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DELETE"), list(makeSymbol("STRING")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADD"), list(makeSymbol("LEX-ENTRY")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("FORGET"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PREFIXES"), list(makeSymbol("STRINGS")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PREFIXES-FROM-STRING"), list(makeSymbol("STRING")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("LEXIFY-DOCUMENT"), list(makeSymbol("DOCUMENT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("LEXIFY-PARAGRAPH"), list(makeSymbol("PARAGRAPH")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("LEXIFY-SENTENCE"), list(makeSymbol("SENTENCE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("TOKENIZE"), list(makeSymbol("STRING")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("LEXIFY-WORDS"), list(makeSymbol("WORDS")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ITERATOR"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INITIALIZE-ALLOWED-MTS"), list(makeSymbol("KB-SPEC")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-BASE-MT"), list(makeSymbol("MT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-BASE-MT"), list(makeSymbol("MT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOW-MT"), list(makeSymbol("MT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOW-GENL-MTS"), list(makeSymbol("MT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("FORBID-MT"), list(makeSymbol("MT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INITIALIZE-EXCLUDED-PREDS"), list(makeSymbol("PRED-LIST")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOW-PREDICATE"), list(makeSymbol("PRED")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("EXCLUDE-PREDICATE"), list(makeSymbol("PRED")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOW-POS"), list(makeSymbol("POS")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("EXCLUDE-POS"), list(makeSymbol("POS")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADD-LEARNER"), list(makeSymbol("LEARNER")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("REMOVE-LEARNER"), list(makeSymbol("LEARNER")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-LEARNERS"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("IGNORE-CACHE"), list(makeSymbol("BOOLEAN")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("IGNORE-CACHE?"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOW-STEMMING"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-CASE-SENSITIVITY"), list(makeSymbol("SENSITIVITY")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-CASE-SENSITIVITY"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("FORBID-STEMMING"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOW-FABRICATION"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("FORBID-FABRICATION"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("FABRICATION-FORBIDDEN?"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("FABRICATION-ALLOWED?"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CREATE-LEX-ENTRIES"), list(makeSymbol("STRING"), makeSymbol("NL-TRIE-ENTRY")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NOUN-COMPOUND-LEARN"), list(makeSymbol("TEXT")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COOCCURRENCE-STATISTICS-LEARN"), list(makeSymbol("TEXT")), makeKeyword("PROTECTED")) });
    }
    ...
    public static final class $textract_lemma_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(abstract_lexicon.$textract_lemma_native.class, TEXTRACT_LEMMA, TEXTRACT_LEMMA_P, $list12, $list13, new String[]{ "$paragraph", "$sentence", "$word", "$string", "$canon", "$type" }, $list14, $list15, TEXTRACT_LEMMA_PRINT);
        }
    }
    ...
    public static final class $abstract_lexicon_iterator_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(abstract_lexicon.$abstract_lexicon_iterator_state_native.class, ABSTRACT_LEXICON_ITERATOR_STATE, ABSTRACT_LEXICON_ITERATOR_STATE_P, $list557, $list558, new String[]{ "$trie_iterator", "$next_entries", "$lexicon" }, $list559, $list560, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
