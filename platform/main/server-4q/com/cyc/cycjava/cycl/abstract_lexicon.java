...
public final class abstract_lexicon extends SubLTranslatedFile implements V12 {
 ...
 public static final String myName = "com.cyc.cycjava.cycl.abstract_lexicon";
    ...
    static private final SubLList $list0 = list(new SubLObject[]{ list(makeKeyword("."), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword("WP"), reader_make_constant_shell("WHPronoun"), reader_make_constant_shell("pronounStrings")), list(makeKeyword("``"), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword("POS"), reader_make_constant_shell("PossessiveMarker"), reader_make_constant_shell("possessiveMarkerStrings")), list(makeKeyword("RB"), reader_make_constant_shell("Adverb"), reader_make_constant_shell("regularAdverb")), list(makeKeyword("JJ"), reader_make_constant_shell("Adjective"), reader_make_constant_shell("regularDegree")), list(makeKeyword("''"), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword("MD"), reader_make_constant_shell("Modal"), reader_make_constant_shell("verbStrings")), list(makeKeyword("AUX"), reader_make_constant_shell("AuxVerb"), reader_make_constant_shell("verbStrings")), list(makeKeyword("VB"), reader_make_constant_shell("Verb"), reader_make_constant_shell("infinitive")), list(makeKeyword("DT"), reader_make_constant_shell("Determiner"), reader_make_constant_shell("determinerStrings")), list(makeKeyword("VBD"), reader_make_constant_shell("Verb"), reader_make_constant_shell("pastTense-Generic")), list(makeKeyword("NN"), reader_make_constant_shell("Noun"), reader_make_constant_shell("nonPlural-Generic")), list(makeKeyword("NNS"), reader_make_constant_shell("Noun"), reader_make_constant_shell("plural-Generic")), list(makeKeyword("VBG"), reader_make_constant_shell("Verb"), reader_make_constant_shell("presentParticiple")), list(makeKeyword("RP"), reader_make_constant_shell("VerbParticle"), NIL), list(makeKeyword("TO"), reader_make_constant_shell("InfinitiveComp"), NIL), list(makeKeyword("TO"), reader_make_constant_shell("Preposition"), reader_make_constant_shell("prepositionStrings")), list(makeKeyword("CC"), reader_make_constant_shell("CoordinatingConjunction"), NIL), list(makeKeyword("JJR"), reader_make_constant_shell("Adjective"), reader_make_constant_shell("comparativeDegree")), list(makeKeyword("RBR"), reader_make_constant_shell("Adverb"), reader_make_constant_shell("comparativeAdverb")), list(makeKeyword("VBN"), reader_make_constant_shell("Verb"), reader_make_constant_shell("perfect")), list(makeKeyword("VBN"), reader_make_constant_shell("Verb"), reader_make_constant_shell("passiveParticiple")), list(makeKeyword("CD"), reader_make_constant_shell("Number-SP"), NIL), list(makeKeyword("JJS"), reader_make_constant_shell("Adjective"), reader_make_constant_shell("superlativeDegree")), list(makeKeyword("RBS"), reader_make_constant_shell("Adverb"), reader_make_constant_shell("superlativeAdverb")), list(makeKeyword("PDT"), reader_make_constant_shell("Predeterminer"), NIL), list(makeKeyword("VBP"), reader_make_constant_shell("Verb"), reader_make_constant_shell("nonThirdSg-Present")), list(makeKeyword("WRB"), reader_make_constant_shell("WHAdverb"), reader_make_constant_shell("regularAdverb")), list(makeKeyword("WP$"), reader_make_constant_shell("WHPossessive"), NIL), list(makeKeyword("NNP"), reader_make_constant_shell("ProperNoun"), reader_make_constant_shell("nonPlural-Generic")), list(makeKeyword("NNP"), reader_make_constant_shell("ProperNoun"), reader_make_constant_shell("nameSpelling")), list($NNPS, reader_make_constant_shell("ProperNoun"), reader_make_constant_shell("plural-Generic")), list(makeKeyword("WDT"), reader_make_constant_shell("WHDeterminer"), reader_make_constant_shell("determinerStrings")), list(makeKeyword("PRP"), reader_make_constant_shell("Pronoun"), reader_make_constant_shell("pronounStrings")), list(makeKeyword("VBZ"), reader_make_constant_shell("Verb"), reader_make_constant_shell("thirdPersonSg-Present")), list(makeKeyword("PRP$"), reader_make_constant_shell("PossessivePronoun"), NIL), list(makeKeyword("IN"), reader_make_constant_shell("Preposition"), reader_make_constant_shell("prepositionStrings")), list(makeKeyword("IN"), reader_make_constant_shell("Complementizer"), NIL), list(makeKeyword("IN"), reader_make_constant_shell("SubordinatingConjunction"), NIL), list(makeKeyword("EX"), reader_make_constant_shell("There-Existential"), NIL), list(makeKeyword("UH"), reader_make_constant_shell("Interjection-SpeechPart"), NIL), list(makeKeyword(":"), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword("$"), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword(","), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword(")"), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword("("), reader_make_constant_shell("Punctuation-SP"), NIL) });
    ...
    static private final SubLList $list8 = list(new SubLObject[]{ list(list(makeString("A_nx0V")), reader_make_constant_shell("Verb"), reader_make_constant_shell("IntransitiveVerbFrame"), reader_make_constant_shell("tensed")), list(list(makeString("A_nx0V")), reader_make_constant_shell("Verb"), reader_make_constant_shell("MiddleVoiceFrame"), reader_make_constant_shell("tensed")), list(list(makeString("A_nx0Vnx1")), reader_make_constant_shell("Verb"), reader_make_constant_shell("TransitiveNPFrame"), reader_make_constant_shell("tensed")), list(list(makeString("A_nx0Vnx1nx2"), makeString("A_nx0Vnx2nx1")), reader_make_constant_shell("Verb"), reader_make_constant_shell("DitransitiveNP-NPFrame"), reader_make_constant_shell("tensed")), list(list(makeString("A_nx0Vpnx1"), makeString("A_nx0Vpx1")), reader_make_constant_shell("Verb"), reader_make_constant_shell("TransitivePPFrameType"), reader_make_constant_shell("tensed")), list(list(makeString("A_nx0Vnx1pnx2"), makeString("A_nx0Vnx1px2")), reader_make_constant_shell("Verb"), reader_make_constant_shell("DitransitivePPFrameType"), reader_make_constant_shell("tensed")), list(list(makeString("A_nx0V")), reader_make_constant_shell("Verb"), reader_make_constant_shell("UnderstoodReciprocalObjectFrame"), reader_make_constant_shell("tensed")), list(list(makeString("A_Gnx0V")), reader_make_constant_shell("Verb"), reader_make_constant_shell("IntransitiveVerbFrame"), reader_make_constant_shell("presentParticiple")), list(list(makeString("A_Gnx0Vnx1")), reader_make_constant_shell("Verb"), reader_make_constant_shell("TransitiveNPFrame"), reader_make_constant_shell("presentParticiple")), list(list(makeString("A_Gnx0Vnx1nx2")), reader_make_constant_shell("Verb"), reader_make_constant_shell("DitransitiveNP-NPFrame"), reader_make_constant_shell("presentParticiple")), list(list(makeString("A_Gnx0Vpnx1"), makeString("A_Gnx0Vpx1")), reader_make_constant_shell("Verb"), reader_make_constant_shell("TransitivePPFrameType"), reader_make_constant_shell("presentParticiple")), list(list(makeString("A_Gnx0Vnx1pnx2"), makeString("A_Gnx0Vnx1px2"), makeString("B_Nn")), reader_make_constant_shell("Verb"), reader_make_constant_shell("DitransitivePPFrameType"), reader_make_constant_shell("presentParticiple")), list(list(makeString("B_Vvx")), reader_make_constant_shell("AuxVerb")), list(list(makeString("A_NXN"), makeString("B_Nn")), reader_make_constant_shell("Noun"), reader_make_constant_shell("RegularNounFrame"), reader_make_constant_shell("nounStrings")), list(list(makeString("A_NXN")), reader_make_constant_shell("Noun"), reader_make_constant_shell("GenitiveFrame"), reader_make_constant_shell("nounStrings")), list(list(makeString("B_nxPnx")), reader_make_constant_shell("Preposition"), reader_make_constant_shell("Post-NounPhraseModifyingFrame"), reader_make_constant_shell("prepositionStrings")), list(list(makeString("B_vxPnx")), reader_make_constant_shell("Preposition"), reader_make_constant_shell("VerbPhraseModifyingFrame"), reader_make_constant_shell("prepositionStrings")), list(list(makeString("B_Dnx")), reader_make_constant_shell("Determiner")), list(list(makeString("B_An")), reader_make_constant_shell("Adjective"), reader_make_constant_shell("RegularAdjFrame"), reader_make_constant_shell("adjStrings")), list(list(makeString("B_vxARB"), makeString("B_ARBvx"), makeString("B_ARBs")), reader_make_constant_shell("Adverb"), reader_make_constant_shell("VerbPhraseModifyingFrame"), reader_make_constant_shell("adverbStrings")) });
    ...
    static private final SubLList $list52 = list(new SubLObject[]{ list(makeSymbol("STORED-PROPERTIES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(QUOTE, list(new SubLObject[]{ makeKeyword("STRING"), makeKeyword("WORD-UNIT"), makeKeyword("INFLECTIONS"), makeKeyword("PREDICATE"), makeKeyword("DENOTS"), makeKeyword("DENOT"), makeKeyword("PRAGMATICS"), makeKeyword("MT"), makeKeyword("SEMTRANS"), makeKeyword("FRAME"), makeKeyword("TRIE-ENTRY") }))), list(makeSymbol("COMPUTED-PROPERTIES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(QUOTE, list(cons(makeKeyword("PENN-TAGS"), makeSymbol("COMPUTE-PENN-TAGS")), cons(makeKeyword("BACKOFF-PENN-TAGS"), makeSymbol("COMPUTE-BACKOFF-PENN-TAGS")), cons($TERM, makeSymbol("COMPUTE-TERM")), cons(makeKeyword("GENDER"), makeSymbol("COMPUTE-GENDER")), cons(makeKeyword("SUPER-TAGS"), makeSymbol("COMPUTE-SUPER-TAGS")), cons(makeKeyword("CYC-POS"), makeSymbol("COMPUTE-CYC-POS")), cons(makeKeyword("CYC-CATEGORY"), makeSymbol("COMPUTE-CYC-CATEGORY")), cons(makeKeyword("IS-NER-ENTRY?"), makeSymbol("COMPUTE-IS-NER-ENTRY"))))), list(makeSymbol("SUPPORTED-PROPERTIES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(makeSymbol("APPEND"), list(makeSymbol("GET-SLOT"), list(QUOTE, makeSymbol("LEX-ENTRY")), list(QUOTE, makeSymbol("STORED-PROPERTIES"))), list(makeSymbol("MAPCAR"), list(QUOTE, makeSymbol("CAR")), list(makeSymbol("GET-SLOT"), list(QUOTE, makeSymbol("LEX-ENTRY")), list(QUOTE, makeSymbol("COMPUTED-PROPERTIES")))))), list(makeSymbol("PROPERTIES"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INITIALIZE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT"), list(makeSymbol("STREAM"), makeSymbol("DEPTH")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COPY"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET"), list(makeSymbol("PROPERTY")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET"), list(makeSymbol("PROPERTY"), makeSymbol("VALUE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NOMINAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("VERBAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADJECTIVAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADVERBIAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPUTE-PENN-TAGS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPUTE-BACKOFF-PENN-TAGS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPUTE-SUPER-TAGS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NOUN?"), NIL, makeKeyword("PUBLIC")) });
    ...
    private static final SubLList $list73 = list(makeString("@return object; the property value associated with PROPERTY"), list(makeSymbol("MUST"), list(makeSymbol("MEMBER"), makeSymbol("PROPERTY"), list(makeSymbol("GET-SLOT"), list(QUOTE, makeSymbol("LEX-ENTRY")), list(QUOTE, makeSymbol("SUPPORTED-PROPERTIES")))), makeString("Unsupported lexical property ~a"), makeSymbol("PROPERTY")), list(makeSymbol("CLET"), list(list(makeSymbol("VALUE"), list(makeSymbol("CDR"), list(makeSymbol("ASSOC"), makeSymbol("PROPERTY"), makeSymbol("PROPERTIES"))))), list(makeSymbol("PUNLESS"), makeSymbol("VALUE"), list(makeSymbol("CLET"), list(list(makeSymbol("PROPERTY-METHOD"), list(makeSymbol("CDR"), list(makeSymbol("ASSOC"), makeSymbol("PROPERTY"), list(makeSymbol("GET-SLOT"), list(QUOTE, makeSymbol("LEX-ENTRY")), list(QUOTE, makeSymbol("COMPUTED-PROPERTIES"))))))), list(makeSymbol("PWHEN"), makeSymbol("PROPERTY-METHOD"), list(makeSymbol("CSETQ"), makeSymbol("VALUE"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SELF"), makeSymbol("PROPERTY-METHOD"))), list(makeSymbol("PWHEN"), makeSymbol("VALUE"), list(makeSymbol("CPUSH"), list(makeSymbol("CONS"), makeSymbol("PROPERTY"), makeSymbol("VALUE")), makeSymbol("PROPERTIES")))))), list(RET, makeSymbol("VALUE"))));
    ...
    static private final SubLList $list87 = list(makeString("make a deep-copy of self"), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-ENTRY"), list(makeSymbol("NEW-CLASS-INSTANCE"), list(QUOTE, makeSymbol("LEX-ENTRY")))), list(makeSymbol("NEW-PROPERTIES"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("KEY.VAL"), makeSymbol("PROPERTIES")), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-KEY"), list(makeSymbol("CAR"), makeSymbol("KEY.VAL"))), list(makeSymbol("VAL"), list(makeSymbol("CDR"), makeSymbol("KEY.VAL"))), list(makeSymbol("NEW-VAL"), list(makeSymbol("FIF"), list(makeSymbol("LISTP"), makeSymbol("VAL")), list(makeSymbol("COPY-LIST"), makeSymbol("VAL")), makeSymbol("VAL")))), list(makeSymbol("CPUSH"), list(makeSymbol("CONS"), makeSymbol("NEW-KEY"), makeSymbol("NEW-VAL")), makeSymbol("NEW-PROPERTIES")))), list(makeSymbol("SET-SLOT"), makeSymbol("NEW-ENTRY"), list(QUOTE, makeSymbol("PROPERTIES")), makeSymbol("NEW-PROPERTIES")), list(RET, makeSymbol("NEW-ENTRY"))));
    ...
    static private final SubLList $list93 = list(makeString("@return booleanp; Does this LEX-ENTRY represent a noun?\n                     i.e. Is its :CYC-POS property value a spec of #$Noun?"), list(makeSymbol("CLET"), list(list(makeSymbol("POS"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("CYC-POS")))), list(makeSymbol("PIF"), list(EQ, makeSymbol("MT"), makeKeyword("ANY")), list(RET, list(makeSymbol("GENL-IN-ANY-MT?"), makeSymbol("POS"), reader_make_constant_shell("Noun"))), list(RET, list(makeSymbol("GENL?"), makeSymbol("POS"), reader_make_constant_shell("Noun"), makeSymbol("MT"))))));
    ...
    private static final SubLList $list123 = list(makeString("@return constantp; a single constant derived from this lex entry\'s\n    semantics"), list(makeSymbol("PUNLESS"), list(makeSymbol("COR"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("NOMINAL-P"))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("VERBAL-P")))), list(makeSymbol("ERROR"), makeString("Invalid lexical property :term called on ~a"), makeSymbol("SELF"))), list(makeSymbol("CLET"), list(list(makeSymbol("TERM"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("DENOT")))), list(makeSymbol("PUNLESS"), makeSymbol("TERM"), list(makeSymbol("CLET"), list(list(makeSymbol("SEMTRANS"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("SEMTRANS")))), list(makeSymbol("PWHEN"), makeSymbol("SEMTRANS"), list(makeSymbol("CLET"), list(list(makeSymbol("OPERATOR"), list(makeSymbol("FORMULA-OPERATOR"), makeSymbol("SEMTRANS")))), list(makeSymbol("PCOND"), list(list(makeSymbol("COR"), list(EQL, makeSymbol("OPERATOR"), reader_make_constant_shell("equals")), list(EQL, makeSymbol("OPERATOR"), reader_make_constant_shell("isa")), list(EQL, makeSymbol("OPERATOR"), reader_make_constant_shell("genls"))), list(makeSymbol("CSETQ"), makeSymbol("TERM"), list(makeSymbol("FORMULA-ARG2"), makeSymbol("SEMTRANS")))), list(list(makeSymbol("COR"), list(makeSymbol("LOGICAL-CONNECTIVE-P"), list(makeSymbol("FORMULA-OPERATOR"), makeSymbol("SEMTRANS"))), list(makeSymbol("QUANTIFIER-P"), list(makeSymbol("FORMULA-OPERATOR"), makeSymbol("SEMTRANS")))), list(makeSymbol("CLET"), list(list(makeSymbol("CENTRAL-KEYWORD"), list(makeSymbol("FCOND"), list(list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("NOMINAL-P"))), $NOUN), list(list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("VERBAL-P"))), makeKeyword("ACTION"))))), list(makeSymbol("CSETQ"), makeSymbol("TERM"), list(makeSymbol("MAIN-COLLECTION"), makeSymbol("SEMTRANS"), makeSymbol("CENTRAL-KEYWORD"))))), list(T, list(makeSymbol("CSETQ"), makeSymbol("TERM"), list(makeSymbol("FORMULA-OPERATOR"), makeSymbol("SEMTRANS"))))))))), list(RET, makeSymbol("TERM"))));
    ...
    static private final SubLList $list132 = list(makeString("@return listp;  a list of genders of this lex entry with possible gender values \n   :FEMININE, :MASCULINE and :NEUTER"), list(makeSymbol("PUNLESS"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("NOMINAL-P"))), list(makeSymbol("ERROR"), makeString("Invalid lexical property :gender called on ~a"), makeSymbol("SELF"))), list(makeSymbol("CLET"), list(makeSymbol("GENDERS"), list(makeSymbol("TERM"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), $TERM))), list(makeSymbol("PIF"), list(makeSymbol("MORE-SPECIFIC-P"), makeSymbol("TERM"), reader_make_constant_shell("MaleAnimal"), reader_make_constant_shell("EverythingPSC")), list(makeSymbol("CSETQ"), makeSymbol("GENDERS"), list(QUOTE, list(makeKeyword("MASCULINE")))), list(makeSymbol("PIF"), list(makeSymbol("MORE-SPECIFIC-P"), makeSymbol("TERM"), reader_make_constant_shell("FemaleAnimal"), reader_make_constant_shell("EverythingPSC")), list(makeSymbol("CSETQ"), makeSymbol("GENDERS"), list(QUOTE, list(makeKeyword("FEMININE")))), list(makeSymbol("PIF"), list(makeSymbol("MORE-SPECIFIC-P"), makeSymbol("TERM"), reader_make_constant_shell("Person"), reader_make_constant_shell("EverythingPSC")), list(makeSymbol("CSETQ"), makeSymbol("GENDERS"), list(QUOTE, list(makeKeyword("MASCULINE"), makeKeyword("FEMININE")))), list(makeSymbol("PWHEN"), list(makeSymbol("MORE-SPECIFIC-P"), makeSymbol("TERM"), reader_make_constant_shell("SentientAnimal"), reader_make_constant_shell("EverythingPSC")), list(makeSymbol("CSETQ"), makeSymbol("GENDERS"), list(QUOTE, list(makeKeyword("MASCULINE"), makeKeyword("FEMININE"), makeKeyword("NEUTER")))))))), list(makeSymbol("PUNLESS"), makeSymbol("GENDERS"), list(makeSymbol("CSETQ"), makeSymbol("GENDERS"), list(QUOTE, list(makeKeyword("NEUTER"))))), list(RET, makeSymbol("GENDERS"))));
    ...
    static private final SubLList $list161 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-ENTRY"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("TRIE-ENTRY")))), list(makeSymbol("PCOND"), list(makeSymbol("TRIE-ENTRY"), list(RET, list(makeSymbol("NL-TRIE-ENTRY-POS"), makeSymbol("TRIE-ENTRY")))), list(list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("INFLECTIONS")), list(makeSymbol("CDOLIST"), list(makeSymbol("PRED"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("INFLECTIONS"))), list(makeSymbol("CLET"), list(list(makeSymbol("POS"), list(makeSymbol("POS-OF-PRED"), makeSymbol("PRED")))), list(makeSymbol("PWHEN"), makeSymbol("POS"), list(RET, makeSymbol("POS"))))))), list(RET, NIL)));
    ...
    private static final SubLList $list167 = list(makeString("What is the syntactic category of this lexical entry.  Unlike cyc-pos, this does not assume that each \n   entry is a part-of-speech.  In some cases, the category may be a XP, not just an X0"), list(makeSymbol("CLET"), list(list(makeSymbol("PRED"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("PREDICATE")))), list(makeSymbol("PWHEN"), list(makeSymbol("NAME-STRING-PRED?"), makeSymbol("PRED")), list(RET, reader_make_constant_shell("NounPhrase"))), list(RET, list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("CYC-POS")))));
    ...
    private static final SubLList $list201 = list(new SubLObject[]{ makeString("@return lexicon-p; a newly created lexicon"), list(makeSymbol("INITIALIZE"), makeSymbol("SUPER")), list(makeSymbol("CSETQ"), makeSymbol("TRIE"), list(makeSymbol("GET-NL-TRIE"))), list(makeSymbol("CSETQ"), makeSymbol("CACHE"), list(makeSymbol("NEW-CACHE"), makeInteger(2000), list(QUOTE, EQUAL))), list(makeSymbol("CSETQ"), makeSymbol("CASE-SENSITIVITY"), makeKeyword("ON")), list(makeSymbol("ENSURE-CYC-TO-PENN-MAP")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("INITIALIZE-EXCLUDED-PREDS"))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("INITIALIZE-ALLOWED-MTS"))), list(makeSymbol("CSETQ"), makeSymbol("LEARNED"), NIL), list(RET, makeSymbol("SELF")) });
    ...
    private static final SubLList $list245 = list(makeString("Returns t if LEX-ENTRY is a contextually valid nl-trie-entry, nil otherwise\n   Lexicons derived from abstract-lexicon will typically override this method"), list(makeSymbol("PWHEN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("STOP-WORD-P")), list(makeSymbol("NL-TRIE-ENTRY-STRING"), makeSymbol("NL-TRIE-ENTRY"))), list(RET, NIL)), list(RET, list(makeSymbol("COR"), list(makeSymbol("CAND"), list(makeSymbol("LEX-ENTRY-P"), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ALLOWED-POS?")), list(makeSymbol("FIM"), makeSymbol("NL-TRIE-ENTRY"), list(QUOTE, makeSymbol("GET")), makeKeyword("CYC-POS")))), list(makeSymbol("CAND"), list(makeSymbol("NL-TRIE-WORD-P"), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("MEMBER"), reader_make_constant_shell("nameSpelling"), list(makeSymbol("NL-TRIE-WORD-POS-PREDS"), makeSymbol("NL-TRIE-ENTRY")), list(QUOTE, EQL)), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("NL-TRIE-ENTRY-HAS-ALLOWED-PREDICATE?")), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ALLOWED-MT?")), list(makeSymbol("NL-TRIE-ENTRY-SEMANTIC-MT"), makeSymbol("NL-TRIE-ENTRY")))), list(makeSymbol("CAND"), list(makeSymbol("VALID-DENOTS?"), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("NL-TRIE-ENTRY-HAS-ALLOWED-PREDICATE?")), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("NL-TRIE-ENTRY-HAS-ALLOWED-POS?")), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ALLOWED-MT?")), list(makeSymbol("NL-TRIE-ENTRY-SEMANTIC-MT"), makeSymbol("NL-TRIE-ENTRY")))))));
    ...
    private static final SubLList $list326 = list(makeString("allow all mts visible from BASE-MT to be used by this lexicon.  If the value is :default, the value of the class variable DEFAULT-BASE-MT will be\n   used, and all mts in the class variable DEFAULT-EXCLUDED-MTS will be removed"), list(makeSymbol("CSETQ"), makeSymbol("ALLOWED-MTS"), list(makeSymbol("NEW-SET"), list(makeSymbol("FUNCTION"), EQUAL))), list(makeSymbol("CSETQ"), makeSymbol("EXCLUDED-MTS"), list(makeSymbol("CONSTRUCT-SET-FROM-LIST"), makeSymbol("DEFAULT-EXCLUDE-MTS"), list(makeSymbol("FUNCTION"), EQUAL))), list(makeSymbol("PUNLESS"), list(EQ, makeKeyword("DEFAULT"), makeSymbol("KB-SPEC")), list(makeSymbol("CLET"), list(list(makeSymbol("BASE-MTS"), list(makeSymbol("QUERY-VARIABLE"), list(QUOTE, makeSymbol("?MT")), list(makeSymbol("BQ-LIST*"), reader_make_constant_shell("defaultBaseLexicalMt"), makeSymbol("KB-SPEC"), list(QUOTE, list(makeSymbol("?MT")))), reader_make_constant_shell("InferencePSC"), list(QUOTE, list(makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL"))))), list(makeSymbol("SPEC-ALLOWED-MTS"), list(makeSymbol("QUERY-VARIABLE"), list(QUOTE, makeSymbol("?MT")), list(makeSymbol("BQ-LIST*"), reader_make_constant_shell("allowedLexicalMt"), makeSymbol("KB-SPEC"), list(QUOTE, list(makeSymbol("?MT")))), reader_make_constant_shell("InferencePSC"), list(QUOTE, list(makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL"))))), list(makeSymbol("SPEC-DISALLOWED-MTS"), list(makeSymbol("QUERY-VARIABLE"), list(QUOTE, makeSymbol("?MT")), list(makeSymbol("BQ-LIST*"), reader_make_constant_shell("disallowedLexicalMt"), makeSymbol("KB-SPEC"), list(QUOTE, list(makeSymbol("?MT")))), reader_make_constant_shell("InferencePSC"), list(QUOTE, list(makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL")))))), list(makeSymbol("PCOND"), list(list(makeSymbol("SINGLETON?"), makeSymbol("BASE-MTS")), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(QUOTE, makeSymbol("BASE-MT")), list(makeSymbol("COPY-EXPRESSION"), list(makeSymbol("ONLY-ONE"), makeSymbol("BASE-MTS"))))), list(list(makeSymbol("EMPTY-LIST-P"), makeSymbol("BASE-MTS")), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(QUOTE, makeSymbol("BASE-MT")), list(makeSymbol("COPY-EXPRESSION"), list(makeSymbol("GET-SLOT"), makeSymbol("SELF"), list(QUOTE, makeSymbol("DEFAULT-BASE-MT"))))), list(makeSymbol("IGNORE"), makeSymbol("BASE-MTS"))), list(T, list(makeSymbol("CSETQ"), makeSymbol("BASE-MT"), list(makeSymbol("COPY-EXPRESSION"), list(makeSymbol("CANONICALIZE-HLMT"), list(makeSymbol("MAKE-EL-FORMULA"), reader_make_constant_shell("MtUnionFn"), makeSymbol("BASE-MTS"))))))), list(makeSymbol("CDOLIST"), list(makeSymbol("MT"), makeSymbol("SPEC-ALLOWED-MTS")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ALLOW-MT")), makeSymbol("MT"))), list(makeSymbol("CDOLIST"), list(makeSymbol("MT"), makeSymbol("SPEC-DISALLOWED-MTS")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FORBID-MT")), makeSymbol("MT"))))), list(RET, makeSymbol("SELF")));
    ...
    private static final SubLList $list340 = list(makeString("base-mt represents the standard mt-reasoning-based Mt for this lexicon. Using allow-mt and forbid-mt allow\n   for minor tweaks to the base-mt, but in general, this is the Mt for this lexicon\n   @note that this method will override any excluded-mts if they are visible from the newly-set base-mt"), list(makeSymbol("CSETQ"), makeSymbol("BASE-MT"), list(makeSymbol("COPY-EXPRESSION"), makeSymbol("MT"))), list(makeSymbol("DO-SET"), list(makeSymbol("EXCLUDED-MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("PWHEN"), list(makeSymbol("GENL-LEXICON-MT?"), makeSymbol("MT"), makeSymbol("EXCLUDED-MT")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ALLOW-MT")), makeSymbol("EXCLUDED-MT")))), list(RET, makeSymbol("SELF")));
    ...
    private static final SubLList $list347 = list(makeString("@param MT possibly-hlmt-p; the mt to be allowed for retrieval of lex entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("MT"), makeSymbol("POSSIBLY-HLMT-P")), list(makeSymbol("SET-ADD"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("CSETQ"), makeSymbol("ROOT-MT"), makeKeyword("UNINITIALIZED")), list(RET, makeSymbol("SELF")));
    ...
    static private final SubLList $list352 = list(makeString("@param MT possibly-hlmt-p; the mt and all its genlMTs to be allowed for \n     retrieval of lex entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("MT"), makeSymbol("POSSIBLY-HLMT-P")), list(makeSymbol("SET-ADD"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("CDOLIST"), list(makeSymbol("GENL-MT"), list(makeSymbol("QUERY-VARIABLE"), list(QUOTE, makeSymbol("?GENLMT")), list(makeSymbol("BQ-LIST*"), reader_make_constant_shell("genlMt"), makeSymbol("MT"), list(QUOTE, list(makeSymbol("?GENLMT")))))), list(makeSymbol("SET-ADD"), makeSymbol("GENL-MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("GENL-MT"), makeSymbol("EXCLUDED-MTS"))), list(makeSymbol("CSETQ"), makeSymbol("ROOT-MT"), makeKeyword("UNINITIALIZED")), list(RET, makeSymbol("SELF")));
    ...
    private static final SubLList $list358 = list(makeString("@param MT possibly-hlmt-p; the mt to be forbidden for retrieval of lex entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("MT"), makeSymbol("POSSIBLY-HLMT-P")), list(makeSymbol("SET-ADD"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("CSETQ"), makeSymbol("ROOT-MT"), makeKeyword("UNINITIALIZED")), list(RET, makeSymbol("SELF")));

    private static final SubLSymbol ABSTRACT_LEXICON_FORBID_MT_METHOD = makeSymbol("ABSTRACT-LEXICON-FORBID-MT-METHOD");

    static private final SubLList $list360 = list(makeString("@param MT possibly-hlmt-p; are assertions in MT allowed in this lexicon?"), list(makeSymbol("PUNLESS"), makeSymbol("MT"), list(RET, NIL)), list(makeSymbol("PCOND"), list(list(makeSymbol("SET-MEMBER?"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(RET, T)), list(list(makeSymbol("SET-MEMBER?"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(RET, NIL)), list(list(makeSymbol("CNOT"), list(makeSymbol("HLMT-P"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET-BASE-MT"))))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FORBID-MT")), makeSymbol("MT")), list(RET, NIL)), list(list(makeSymbol("GENL-LEXICON-MT?"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET-BASE-MT"))), makeSymbol("MT")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ALLOW-MT")), makeSymbol("MT")), list(RET, T)), list(T, list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FORBID-MT")), makeSymbol("MT")), list(RET, NIL))));
    ...
    private static final SubLList $list363 = list(makeString("return the one Mt that is the composition of all the allowed/disallowed mts, an MtUnionFn of all the Mts"), list(makeSymbol("PUNLESS"), list(makeSymbol("INITIALIZED-P"), makeSymbol("ROOT-MT")), list(makeSymbol("CLET"), list(list(makeSymbol("THIS-ALLOWED-MTS"), list(makeSymbol("GET-SLOT"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ALLOWED-MTS")))), list(makeSymbol("THIS-BASE-MT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET-BASE-MT")))), list(makeSymbol("MTS"), list(makeSymbol("FIF"), list(makeSymbol("POSSIBLY-HLMT-P"), makeSymbol("THIS-BASE-MT")), list(makeSymbol("CONS"), makeSymbol("THIS-BASE-MT"), list(makeSymbol("SET-ELEMENT-LIST"), makeSymbol("THIS-ALLOWED-MTS"))), list(makeSymbol("SET-ELEMENT-LIST"), makeSymbol("ALLOWED-MTS")))), list(makeSymbol("MIN-MTS"), list(makeSymbol("MIN-MTS"), makeSymbol("MTS")))), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ROOT-MT")), list(makeSymbol("CANONICALIZE-HLMT"), list(makeSymbol("MAKE-EL-FORMULA"), reader_make_constant_shell("MtUnionFn"), makeSymbol("MIN-MTS")))))), list(RET, makeSymbol("ROOT-MT")));
    ...
    private static final SubLList $list367 = list(list(makeSymbol("CLET"), list(list(makeSymbol("STOP-WORD-SET"), makeSymbol("STOP-WORDS"))), list(makeSymbol("PUNLESS"), list(makeSymbol("SET-P"), makeSymbol("STOP-WORD-SET")), list(makeSymbol("CSETQ"), makeSymbol("STOP-WORD-SET"), list(makeSymbol("NEW-SET"), list(QUOTE, EQUAL)))), list(makeSymbol("SET-ADD"), makeSymbol("STRING"), makeSymbol("STOP-WORD-SET")), list(makeSymbol("CSETQ"), makeSymbol("STOP-WORDS"), makeSymbol("STOP-WORD-SET")), list(RET, makeSymbol("STOP-WORDS"))));
    ...
    private static final SubLList $list378 = list(makeString("@return ABSTRACT-LEXICON-P; a copy of this lexicon.\n@note -- list values are copied with copy-list.\n@note -- cache and trie are set to their defaults."), list(makeSymbol("CHECK-TYPE-IF-PRESENT"), makeSymbol("TARGET"), makeSymbol("ABSTRACT-LEXICON-P")), list(makeSymbol("PUNLESS"), makeSymbol("TARGET"), list(makeSymbol("CSETQ"), makeSymbol("TARGET"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("CLONE")))), list(makeSymbol("WARN"), makeString("Cloned instance: ~S"), makeSymbol("TARGET"))), list(makeSymbol("CDOLIST"), list(makeSymbol("SLOT"), list(QUOTE, list(makeSymbol("ALLOWED-MTS"), makeSymbol("EXCLUDED-MTS"), makeSymbol("EXCLUDED-PREDS"), makeSymbol("EXCLUDED-POS-LIST"), makeSymbol("IGNORE-CACHE?"), makeSymbol("CASE-SENSITIVITY"), makeSymbol("ACTIVE-LEARNERS")))), list(makeSymbol("CLET"), list(list(makeSymbol("VALUE"), list(makeSymbol("GET-SLOT"), makeSymbol("SELF"), makeSymbol("SLOT")))), list(makeSymbol("PCOND"), list(list(makeSymbol("LISTP"), makeSymbol("VALUE")), list(makeSymbol("SET-SLOT"), makeSymbol("TARGET"), makeSymbol("SLOT"), list(makeSymbol("COPY-LIST"), makeSymbol("VALUE")))), list(T, list(makeSymbol("SET-SLOT"), makeSymbol("TARGET"), makeSymbol("SLOT"), makeSymbol("VALUE")))))), list(RET, makeSymbol("TARGET")));
    ...
    private static final SubLList $list385 = list(makeString("@param STRING stringp;\n   @return listp; the list of  lex-entry-p associated with STRING in this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("CYCL-STRING-P")), list(makeSymbol("PWHEN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("STOP-WORD-P")), makeSymbol("STRING")), list(RET, NIL)), list(makeSymbol("PUNLESS"), makeSymbol("IGNORE-CACHE?"), list(makeSymbol("CMULTIPLE-VALUE-BIND"), list(makeSymbol("LEX-ENTRIES"), makeSymbol("EXISTS?")), list(makeSymbol("CACHE-GET"), makeSymbol("CACHE"), makeSymbol("STRING")), list(makeSymbol("PWHEN"), makeSymbol("EXISTS?"), list(RET, makeSymbol("LEX-ENTRIES"))))), list(makeSymbol("CLET"), list(list(makeSymbol("LEX-ENTRIES"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("CREATE-LEX-ENTRIES")), makeSymbol("STRING"), NIL)), list(makeSymbol("NL-TRIE-ENTRIES"), list(makeSymbol("NL-TRIE-SEARCH"), makeSymbol("STRING"), makeSymbol("TRIE"), makeSymbol("CASE-SENSITIVITY")))), list(makeSymbol("CSETQ"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("ADD-LEX-ENTRIES-FOR-TRIE-ENTRIES"), makeSymbol("NL-TRIE-ENTRIES"), makeSymbol("STRING"), makeSymbol("SELF"), makeSymbol("LEX-ENTRIES"))), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("NULL"), makeSymbol("LEX-ENTRIES")), list(EQ, makeSymbol("CASE-SENSITIVITY"), makeKeyword("PREFERRED"))), list(makeSymbol("CLET"), list(list(makeSymbol("NL-TRIE-ENTRIES"), list(makeSymbol("NL-TRIE-SEARCH"), makeSymbol("STRING"), makeSymbol("TRIE"), makeKeyword("OFF")))), list(makeSymbol("CSETQ"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("ADD-LEX-ENTRIES-FOR-TRIE-ENTRIES"), makeSymbol("NL-TRIE-ENTRIES"), makeSymbol("STRING"), makeSymbol("SELF"), makeSymbol("LEX-ENTRIES"))))), list(makeSymbol("PUNLESS"), makeSymbol("IGNORE-CACHE?"), list(makeSymbol("CACHE-SET"), makeSymbol("CACHE"), makeSymbol("STRING"), makeSymbol("LEX-ENTRIES"))), list(RET, makeSymbol("LEX-ENTRIES"))));
    ...
    private static final SubLList $list394 = list(makeString("Deletes all entries for STRING from this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("CYCL-STRING-P")), list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-ENTRIES"), list(makeSymbol("NL-TRIE-SEARCH"), makeSymbol("STRING"), makeSymbol("TRIE"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET-CASE-SENSITIVITY")))))), list(makeSymbol("CDOLIST"), list(makeSymbol("TRIE-ENTRY"), makeSymbol("TRIE-ENTRIES")), list(makeSymbol("PWHEN"), list(makeSymbol("LEX-ENTRY-P"), makeSymbol("TRIE-ENTRY")), list(makeSymbol("CDOLIST"), list(makeSymbol("TRIE-KEY"), list(makeSymbol("NL-TRIE-ENTRY-KEYS"), makeSymbol("TRIE-ENTRY"))), list(makeSymbol("NL-TRIE-DELETE-ENTRY"), makeSymbol("TRIE"), makeSymbol("TRIE-KEY"), makeSymbol("TRIE-ENTRY")))))), list(makeSymbol("CACHE-REMOVE"), makeSymbol("CACHE"), makeSymbol("STRING")), list(RET, makeSymbol("SELF")));
    ...
    static private final SubLList $list399 = list(makeString("Deletes the entry associating STRING with LEX-ENTRY from this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("STRINGP")), list(makeSymbol("CHECK-TYPE"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRY-P")), list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-KEY"), list(makeSymbol("NL-TRIE-STRING-TOKENIZE"), makeSymbol("STRING")))), list(makeSymbol("NL-TRIE-DELETE-ENTRY"), makeSymbol("TRIE"), makeSymbol("TRIE-KEY"), makeSymbol("LEX-ENTRY"))), list(makeSymbol("CLET"), list(list(makeSymbol("CACHE-ENTRIES"), list(makeSymbol("REMOVE"), makeSymbol("LEX-ENTRY"), list(makeSymbol("CACHE-GET"), makeSymbol("CACHE"), makeSymbol("STRING")), list(QUOTE, EQUAL)))), list(makeSymbol("CACHE-SET"), makeSymbol("CACHE"), makeSymbol("STRING"), makeSymbol("CACHE-ENTRIES"))), list(RET, makeSymbol("SELF")));
    ...
    private static final SubLList $list414 = list(makeString("Delete all entries previously learned from this lexicon"), list(makeSymbol("CLET"), list(list(makeSymbol("DELETED"), makeSymbol("LEARNED"))), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX"), makeSymbol("LEARNED")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("DELETE")), list(makeSymbol("FIM"), makeSymbol("LEX"), list(QUOTE, makeSymbol("GET")), makeKeyword("STRING")))), list(makeSymbol("CSETQ"), makeSymbol("LEARNED"), NIL), list(RET, makeSymbol("DELETED"))));
    ...
    private static final SubLList $list419 = list(makeString("@param STRINGS; listp\n   @return listp; a list of conses whose car is a list of strings which are\n   in this lexicon and a prefix of STRINGS, and whose cdr is a lex entry\n   with that string"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRINGS"), makeSymbol("LISTP")), list(RET, list(makeSymbol("VALID-PREFIXES"), list(makeSymbol("NL-TRIE-PREFIXES"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY")), makeSymbol("SELF"))));
    ...
    private static final SubLList $list424 = list(makeString("@param STRING stringp\n   @return listp; a list of conses whose car is a list of strings which are\n   in this lexicon and a prefix of STRINGS, and whose cdr is a lex entry\n   with that string"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("STRINGP")), list(makeSymbol("CLET"), list(list(makeSymbol("PREFIX-KEYS"), list(makeSymbol("NL-TRIE-PREFIX-KEYS-FROM-STRING"), makeSymbol("TRIE"), makeSymbol("STRING"), makeSymbol("CASE-SENSITIVITY"))), list(makeSymbol("NL-TRIE-ENTRY"), list(makeSymbol("SECOND"), list(makeSymbol("FIRST"), makeSymbol("PREFIX-KEYS")))), list(makeSymbol("PREFIX-STRING"), list(makeSymbol("NL-TRIE-ENTRY-STRING"), makeSymbol("NL-TRIE-ENTRY")))), list(RET, list(makeSymbol("LIST"), list(makeSymbol("VALID-PREFIXES"), makeSymbol("PREFIX-KEYS"), makeSymbol("SELF")), makeSymbol("PREFIX-STRING")))));
    ...
    private static final SubLList $list430 = list(makeString("@param STRINGS; listp\n   @return listp; a list of strings which are both in this lexicon and a prefix of STRINGS"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRINGS"), makeSymbol("LISTP")), list(RET, list(makeSymbol("VALID-PREFIX-KEYS"), list(makeSymbol("NL-TRIE-PREFIXES"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY")), makeSymbol("SELF"), makeSymbol("CASE-SENSITIVITY"))));
    ...
    private static final SubLList $list434 = list(makeString("@param STRING stringp\n   @return listp; a list of strings which are both in this lexicon and a prefix of STRINGS"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("STRINGP")), list(makeSymbol("CLET"), list(list(makeSymbol("MY-PREFIX-KEYS"), list(makeSymbol("NL-TRIE-PREFIX-KEYS-FROM-STRING"), makeSymbol("TRIE"), makeSymbol("STRING"), makeSymbol("CASE-SENSITIVITY"))), list(makeSymbol("NL-TRIE-ENTRY"), list(makeSymbol("SECOND"), list(makeSymbol("FIRST"), makeSymbol("MY-PREFIX-KEYS")))), list(makeSymbol("PREFIX-STRING"), list(makeSymbol("NL-TRIE-ENTRY-STRING"), makeSymbol("NL-TRIE-ENTRY")))), list(RET, list(makeSymbol("LIST"), list(makeSymbol("VALID-PREFIX-KEYS"), makeSymbol("MY-PREFIX-KEYS"), makeSymbol("SELF"), makeSymbol("CASE-SENSITIVITY")), makeSymbol("PREFIX-STRING")))));
    ...
    private static final SubLList $list439 = list(makeString("@param TEXT stringp; the text from which to learn lexical entries\n   @param LEARNERS listp; a list of learning methods. Each such method\n   is expected to take a natural language string as input and return a \n   list of lex-entries\n   @return non-negative-integerp; the number of entries learned\n   @note it is the responsibility of each learner to add any entries to the lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("TEXT"), makeSymbol("STRINGP")), list(makeSymbol("PUNLESS"), makeSymbol("LEARNERS"), list(makeSymbol("CSETQ"), makeSymbol("LEARNERS"), makeSymbol("ACTIVE-LEARNERS"))), list(makeSymbol("CLET"), list(makeSymbol("LEARNED-HERE")), list(makeSymbol("CDOLIST"), list(makeSymbol("LEARNER"), makeSymbol("LEARNERS")), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX"), list(makeSymbol("FIM"), makeSymbol("SELF"), makeSymbol("LEARNER"), makeSymbol("TEXT"))), list(makeSymbol("CPUSH"), makeSymbol("LEX"), makeSymbol("LEARNED-HERE")))), list(RET, makeSymbol("LEARNED-HERE"))));
    ...
    private static final SubLList $list516 = list(makeString("@param WORDS listp;\n   @return listp; a list of <string, category, lex-entries> triples for WORDS, where\n   STRING may be several of WORDS collapsed into a single entry"), list(makeSymbol("CHECK-TYPE"), makeSymbol("WORDS"), makeSymbol("LISTP")), list(makeSymbol("CLET"), list(list(makeSymbol("RECORD-LENGTH"), ZERO_INTEGER), list(makeSymbol("LEXIFIED-TOKENS"), NIL), makeSymbol("CATEGORY"), makeSymbol("STRING")), list(makeSymbol("CDO"), list(list(makeSymbol("INDEX"), ZERO_INTEGER, list(makeSymbol("+"), makeSymbol("INDEX"), makeSymbol("RECORD-LENGTH"))), list(makeSymbol("TOKENS"), makeSymbol("WORDS"), list(makeSymbol("NTHCDR"), makeSymbol("RECORD-LENGTH"), makeSymbol("TOKENS"))), list(makeSymbol("STRINGS"), list(makeSymbol("MAPCAR"), list(makeSymbol("FUNCTION"), makeSymbol("GET-PARSE-TREE-STRING")), makeSymbol("TOKENS")), list(makeSymbol("NTHCDR"), makeSymbol("RECORD-LENGTH"), makeSymbol("STRINGS"))), list(makeSymbol("RECORDS"), list(makeSymbol("NL-TRIE-PREFIXES"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY")), list(makeSymbol("NL-TRIE-PREFIXES"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY")))), list(list(makeSymbol("NULL"), makeSymbol("TOKENS"))), list(makeSymbol("CSETQ"), makeSymbol("RECORDS"), list(makeSymbol("ADD-TO-END"), list(makeSymbol("NEW-NL-TRIE-RECORD"), list(makeSymbol("LIST"), list(makeSymbol("FIM"), list(makeSymbol("FIRST"), makeSymbol("TOKENS")), list(QUOTE, makeSymbol("GET-STRING")))), NIL), makeSymbol("RECORDS"))), list(makeSymbol("CLET"), list(makeSymbol("NEW-TOKEN-ADDED-FOR-PREFIXE")), list(makeSymbol("CSOME"), list(makeSymbol("RECORD"), makeSymbol("RECORDS"), makeSymbol("NEW-TOKEN-ADDED-FOR-PREFIXE")), list(makeSymbol("CSETQ"), makeSymbol("RECORD-LENGTH"), list(makeSymbol("LENGTH"), list(makeSymbol("NL-TRIE-RECORD-KEY"), makeSymbol("RECORD")))), list(makeSymbol("CSETQ"), makeSymbol("STRING"), list(makeSymbol("BUILD-MULTI-WORD-LEXEME"), list(makeSymbol("FIRST-N"), makeSymbol("RECORD-LENGTH"), makeSymbol("STRINGS")))), list(makeSymbol("CSETQ"), makeSymbol("CATEGORY"), list(makeSymbol("GUESS-CATEGORY"), makeSymbol("SELF"), makeSymbol("STRING"), makeSymbol("TOKENS"))), list(makeSymbol("CLET"), list(list(makeSymbol("LEX-ENTRIES"), NIL), makeSymbol("LEX-ENTRIES0"), makeSymbol("EXISTS?")), list(makeSymbol("PUNLESS"), makeSymbol("IGNORE-CACHE?"), list(makeSymbol("CMULTIPLE-VALUE-SETQ"), list(makeSymbol("LEX-ENTRIES0"), makeSymbol("EXISTS?")), list(makeSymbol("CACHE-GET"), makeSymbol("CACHE"), makeSymbol("STRING")))), list(makeSymbol("PUNLESS"), makeSymbol("EXISTS?"), list(makeSymbol("CDOLIST"), list(makeSymbol("NL-TRIE-ENTRY"), list(makeSymbol("NL-TRIE-RECORD-ENTRIES"), makeSymbol("RECORD"))), list(makeSymbol("PWHEN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("VALID-NL-TRIE-ENTRY?")), makeSymbol("NL-TRIE-ENTRY")), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX-ENTRY"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("CREATE-LEX-ENTRIES")), makeSymbol("STRING"), makeSymbol("NL-TRIE-ENTRY"))), list(makeSymbol("CPUSH"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRIES0"))))), list(makeSymbol("PUNLESS"), makeSymbol("IGNORE-CACHE?"), list(makeSymbol("CACHE-SET"), makeSymbol("CACHE"), makeSymbol("STRING"), makeSymbol("LEX-ENTRIES0")))), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRIES0")), list(makeSymbol("PWHEN"), list(makeSymbol("MEMBER?"), makeSymbol("CATEGORY"), list(makeSymbol("FIM"), makeSymbol("LEX-ENTRY"), list(QUOTE, makeSymbol("GET")), makeKeyword("PENN-TAGS"))), list(makeSymbol("CPUSHNEW"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRIES"), list(QUOTE, makeSymbol("LEX-ENTRY-EQUAL-P"))))), list(makeSymbol("PUNLESS"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRIES0")), list(makeSymbol("PWHEN"), list(makeSymbol("MEMBER?"), makeSymbol("CATEGORY"), list(makeSymbol("FIM"), makeSymbol("LEX-ENTRY"), list(QUOTE, makeSymbol("GET")), makeKeyword("BACKOFF-PENN-TAGS"))), list(makeSymbol("CPUSHNEW"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRIES"), list(QUOTE, makeSymbol("LEX-ENTRY-EQUAL-P")))))), list(makeSymbol("PWHEN"), list(makeSymbol("COR"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("NULL"), list(makeSymbol("NL-TRIE-RECORD-ENTRIES"), makeSymbol("RECORD")))), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("NEW-TOKEN-ADDED-FOR-PREFIXE"), T), list(makeSymbol("CPUSH"), list(makeSymbol("LIST"), makeSymbol("STRING"), makeSymbol("CATEGORY"), makeSymbol("LEX-ENTRIES")), makeSymbol("LEXIFIED-TOKENS")))))))), list(RET, list(makeSymbol("NREVERSE"), makeSymbol("LEXIFIED-TOKENS")))));
    ...
    private static final SubLList $list522 = list(makeString("@param STRING stringp; an English string\n   @return listp; a list of English string tokens from STRING\n   @note Not the most efficient way since words and lexical entries are painfully constructed\n   and then discarded...this should duplicate only the tokenization part of the \'lexify method"), list(makeSymbol("CLET"), list(list(makeSymbol("WORDS"), list(makeSymbol("LEXIFY-SENTENCE"), makeSymbol("SELF"), list(makeSymbol("NEW-SENTENCE"), makeSymbol("STRING"), list(QUOTE, makeSymbol("FST-STRING-WORDIFY"))))), list(makeSymbol("STRINGS"), NIL)), list(makeSymbol("SENTENCE-DO-WORDS"), list(makeSymbol("WORD"), makeSymbol("WORDS")), list(makeSymbol("CPUSH"), list(makeSymbol("WORD-STRING"), makeSymbol("WORD")), makeSymbol("STRINGS"))), list(RET, list(makeSymbol("NREVERSE"), makeSymbol("STRINGS")))));
    ...
    private static final SubLList $list596 = list(new SubLObject[]{ list(list(makeString("0.4")), list(list(makeString("0.4"), makeDouble(0.4)))), list(list(makeString("-0.4")), list(list(makeString("-0.4"), makeDouble(-0.4)))), list(list(makeString("-.4")), list(list(makeString("-.4"), makeDouble(-0.4)))), list(list(makeString("0.4%")), list(list(makeString("0.4%"), list(reader_make_constant_shell("Percent"), makeDouble(0.4))))), list(list(makeString("4%")), list(list(makeString("4%"), list(reader_make_constant_shell("Percent"), FOUR_INTEGER)))), list(list(makeString(".4%")), list(list(makeString(".4%"), list(reader_make_constant_shell("Percent"), makeDouble(0.4))))), list(list(makeString("-0.4%")), list(list(makeString("-0.4%"), list(reader_make_constant_shell("Percent"), makeDouble(-0.4))))), list(list(makeString("-.4%")), list(list(makeString("-.4%"), list(reader_make_constant_shell("Percent"), makeDouble(-0.4))))), list(list(makeString("-4%")), list(list(makeString("-4%"), list(reader_make_constant_shell("Percent"), makeInteger(-4))))) });
    ...
    public static final SubLObject abstract_lexicon_valid_nl_trie_entryP_method_alt(SubLObject self, SubLObject nl_trie_entry) {
        ...
        return makeBoolean((((NIL != lex_entry_p(nl_trie_entry)) && (NIL != methods.funcall_instance_method_with_1_args(self, $sym241$ALLOWED_POS_, methods.funcall_instance_method_with_1_args(nl_trie_entry, GET, $CYC_POS)))) || ((((NIL != nl_trie.nl_trie_word_p(nl_trie_entry, UNPROVIDED)) && (NIL != member($$nameSpelling, nl_trie.nl_trie_word_pos_preds(nl_trie_entry), EQL, UNPROVIDED))) && (NIL != methods.funcall_instance_method_with_1_args(self, $sym243$NL_TRIE_ENTRY_HAS_ALLOWED_PREDICATE_, nl_trie_entry))) && (NIL != methods.funcall_instance_method_with_1_args(self, $sym244$ALLOWED_MT_, nl_trie.nl_trie_entry_semantic_mt(nl_trie_entry))))) || ((((NIL != valid_denotsP(nl_trie_entry)) && (NIL != methods.funcall_instance_method_with_1_args(self, $sym243$NL_TRIE_ENTRY_HAS_ALLOWED_PREDICATE_, nl_trie_entry))) && (NIL != methods.funcall_instance_method_with_1_args(self, $sym245$NL_TRIE_ENTRY_HAS_ALLOWED_POS_, nl_trie_entry))) && (NIL != methods.funcall_instance_method_with_1_args(self, $sym244$ALLOWED_MT_, nl_trie.nl_trie_entry_semantic_mt(nl_trie_entry)))));
    }
    ...
    // Internal Constants
    @LispMethod(comment = "Internal Constants")
    static private final SubLList $list_alt0 = list(new SubLObject[]{ list(makeKeyword("."), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword("WP"), reader_make_constant_shell("WHPronoun"), reader_make_constant_shell("pronounStrings")), list(makeKeyword("``"), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword("POS"), reader_make_constant_shell("PossessiveMarker"), reader_make_constant_shell("possessiveMarkerStrings")), list(makeKeyword("RB"), reader_make_constant_shell("Adverb"), reader_make_constant_shell("regularAdverb")), list(makeKeyword("JJ"), reader_make_constant_shell("Adjective"), reader_make_constant_shell("regularDegree")), list(makeKeyword("''"), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword("MD"), reader_make_constant_shell("Modal"), reader_make_constant_shell("verbStrings")), list(makeKeyword("AUX"), reader_make_constant_shell("AuxVerb"), reader_make_constant_shell("verbStrings")), list(makeKeyword("VB"), reader_make_constant_shell("Verb"), reader_make_constant_shell("infinitive")), list(makeKeyword("DT"), reader_make_constant_shell("Determiner"), reader_make_constant_shell("determinerStrings")), list(makeKeyword("VBD"), reader_make_constant_shell("Verb"), reader_make_constant_shell("pastTense-Generic")), list(makeKeyword("NN"), reader_make_constant_shell("Noun"), reader_make_constant_shell("nonPlural-Generic")), list(makeKeyword("NNS"), reader_make_constant_shell("Noun"), reader_make_constant_shell("plural-Generic")), list(makeKeyword("VBG"), reader_make_constant_shell("Verb"), reader_make_constant_shell("presentParticiple")), list(makeKeyword("RP"), reader_make_constant_shell("VerbParticle"), NIL), list(makeKeyword("TO"), reader_make_constant_shell("InfinitiveComp"), NIL), list(makeKeyword("TO"), reader_make_constant_shell("Preposition"), reader_make_constant_shell("prepositionStrings")), list(makeKeyword("CC"), reader_make_constant_shell("CoordinatingConjunction"), NIL), list(makeKeyword("JJR"), reader_make_constant_shell("Adjective"), reader_make_constant_shell("comparativeDegree")), list(makeKeyword("RBR"), reader_make_constant_shell("Adverb"), reader_make_constant_shell("comparativeAdverb")), list(makeKeyword("VBN"), reader_make_constant_shell("Verb"), reader_make_constant_shell("perfect")), list(makeKeyword("VBN"), reader_make_constant_shell("Verb"), reader_make_constant_shell("passiveParticiple")), list(makeKeyword("CD"), reader_make_constant_shell("Number-SP"), NIL), list(makeKeyword("JJS"), reader_make_constant_shell("Adjective"), reader_make_constant_shell("superlativeDegree")), list(makeKeyword("RBS"), reader_make_constant_shell("Adverb"), reader_make_constant_shell("superlativeAdverb")), list(makeKeyword("PDT"), reader_make_constant_shell("Predeterminer"), NIL), list(makeKeyword("VBP"), reader_make_constant_shell("Verb"), reader_make_constant_shell("nonThirdSg-Present")), list(makeKeyword("WRB"), reader_make_constant_shell("WHAdverb"), reader_make_constant_shell("regularAdverb")), list(makeKeyword("WP$"), reader_make_constant_shell("WHPossessive"), NIL), list(makeKeyword("NNP"), reader_make_constant_shell("ProperNoun"), reader_make_constant_shell("nonPlural-Generic")), list(makeKeyword("NNP"), reader_make_constant_shell("ProperNoun"), reader_make_constant_shell("nameSpelling")), list($NNPS, reader_make_constant_shell("ProperNoun"), reader_make_constant_shell("plural-Generic")), list(makeKeyword("WDT"), reader_make_constant_shell("WHDeterminer"), reader_make_constant_shell("determinerStrings")), list(makeKeyword("PRP"), reader_make_constant_shell("Pronoun"), reader_make_constant_shell("pronounStrings")), list(makeKeyword("VBZ"), reader_make_constant_shell("Verb"), reader_make_constant_shell("thirdPersonSg-Present")), list(makeKeyword("PRP$"), reader_make_constant_shell("PossessivePronoun"), NIL), list(makeKeyword("IN"), reader_make_constant_shell("Preposition"), reader_make_constant_shell("prepositionStrings")), list(makeKeyword("IN"), reader_make_constant_shell("Complementizer"), NIL), list(makeKeyword("IN"), reader_make_constant_shell("SubordinatingConjunction"), NIL), list(makeKeyword("EX"), reader_make_constant_shell("There-Existential"), NIL), list(makeKeyword("UH"), reader_make_constant_shell("Interjection-SpeechPart"), NIL), list(makeKeyword(":"), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword("$"), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword(","), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword(")"), reader_make_constant_shell("Punctuation-SP"), NIL), list(makeKeyword("("), reader_make_constant_shell("Punctuation-SP"), NIL) });
    ...
    static private final SubLList $list_alt46 = list(new SubLObject[]{ list(makeSymbol("STORED-PROPERTIES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(QUOTE, list(new SubLObject[]{ makeKeyword("STRING"), makeKeyword("WORD-UNIT"), makeKeyword("INFLECTIONS"), makeKeyword("PREDICATE"), makeKeyword("DENOTS"), makeKeyword("DENOT"), makeKeyword("PRAGMATICS"), makeKeyword("MT"), makeKeyword("SEMTRANS"), makeKeyword("FRAME"), makeKeyword("TRIE-ENTRY") }))), list(makeSymbol("COMPUTED-PROPERTIES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(QUOTE, list(cons(makeKeyword("PENN-TAGS"), makeSymbol("COMPUTE-PENN-TAGS")), cons(makeKeyword("BACKOFF-PENN-TAGS"), makeSymbol("COMPUTE-BACKOFF-PENN-TAGS")), cons($TERM, makeSymbol("COMPUTE-TERM")), cons(makeKeyword("GENDER"), makeSymbol("COMPUTE-GENDER")), cons(makeKeyword("SUPER-TAGS"), makeSymbol("COMPUTE-SUPER-TAGS")), cons(makeKeyword("CYC-POS"), makeSymbol("COMPUTE-CYC-POS")), cons(makeKeyword("CYC-CATEGORY"), makeSymbol("COMPUTE-CYC-CATEGORY")), cons(makeKeyword("IS-NER-ENTRY?"), makeSymbol("COMPUTE-IS-NER-ENTRY"))))), list(makeSymbol("SUPPORTED-PROPERTIES"), makeKeyword("CLASS"), makeKeyword("PROTECTED"), makeKeyword("VALUE"), list(makeSymbol("APPEND"), list(makeSymbol("GET-SLOT"), list(QUOTE, makeSymbol("LEX-ENTRY")), list(QUOTE, makeSymbol("STORED-PROPERTIES"))), list(makeSymbol("MAPCAR"), list(QUOTE, makeSymbol("CAR")), list(makeSymbol("GET-SLOT"), list(QUOTE, makeSymbol("LEX-ENTRY")), list(QUOTE, makeSymbol("COMPUTED-PROPERTIES")))))), list(makeSymbol("PROPERTIES"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INITIALIZE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT"), list(makeSymbol("STREAM"), makeSymbol("DEPTH")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COPY"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET"), list(makeSymbol("PROPERTY")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET"), list(makeSymbol("PROPERTY"), makeSymbol("VALUE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NOMINAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("VERBAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADJECTIVAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADVERBIAL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPUTE-PENN-TAGS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPUTE-BACKOFF-PENN-TAGS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("COMPUTE-SUPER-TAGS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NOUN?"), NIL, makeKeyword("PUBLIC")) });
    ...
    static private final SubLList $list_alt81 = list(makeString("make a deep-copy of self"), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-ENTRY"), list(makeSymbol("NEW-CLASS-INSTANCE"), list(QUOTE, makeSymbol("LEX-ENTRY")))), list(makeSymbol("NEW-PROPERTIES"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("KEY.VAL"), makeSymbol("PROPERTIES")), list(makeSymbol("CLET"), list(list(makeSymbol("NEW-KEY"), list(makeSymbol("CAR"), makeSymbol("KEY.VAL"))), list(makeSymbol("VAL"), list(makeSymbol("CDR"), makeSymbol("KEY.VAL"))), list(makeSymbol("NEW-VAL"), list(makeSymbol("FIF"), list(makeSymbol("LISTP"), makeSymbol("VAL")), list(makeSymbol("COPY-LIST"), makeSymbol("VAL")), makeSymbol("VAL")))), list(makeSymbol("CPUSH"), list(makeSymbol("CONS"), makeSymbol("NEW-KEY"), makeSymbol("NEW-VAL")), makeSymbol("NEW-PROPERTIES")))), list(makeSymbol("SET-SLOT"), makeSymbol("NEW-ENTRY"), list(QUOTE, makeSymbol("PROPERTIES")), makeSymbol("NEW-PROPERTIES")), list(RET, makeSymbol("NEW-ENTRY"))));
    ...
    static private final SubLList $list_alt94 = list(makeString("Prints this lex-entry to STREAM, ignoring DEPTH"), list(makeSymbol("IGNORE"), makeSymbol("DEPTH")), list(makeSymbol("WRITE-STRING"), makeString("#<LEX-ENTRY "), makeSymbol("STREAM")), list(makeSymbol("TERPRI"), makeSymbol("STREAM")), list(makeSymbol("CDOLIST"), list(makeSymbol("PROPERTY"), makeSymbol("PROPERTIES")), list(makeSymbol("PRIN1"), list(makeSymbol("CAR"), makeSymbol("PROPERTY")), makeSymbol("STREAM")), list(makeSymbol("WRITE-STRING"), makeString(" -> "), makeSymbol("STREAM")), list(makeSymbol("PRIN1"), list(makeSymbol("CDR"), makeSymbol("PROPERTY")), makeSymbol("STREAM")), list(makeSymbol("TERPRI"), makeSymbol("STREAM"))), list(makeSymbol("WRITE-STRING"), makeString(">"), makeSymbol("STREAM")), list(makeSymbol("TERPRI"), makeSymbol("STREAM")), list(RET, makeSymbol("SELF")));
    ...
    static private final SubLList $list_alt140 = list(makeString("@return listp; the Penn part-of-speech tags of this lex-entry"), list(makeSymbol("CLET"), list(list(makeSymbol("POS"), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("CYC-POS"))), list(makeSymbol("INFLECTIONS"), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("INFLECTIONS"))), list(makeSymbol("STRING"), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("STRING"))), list(makeSymbol("PENN-TAGS"), NIL)), list(makeSymbol("PCOND"), list(list(makeSymbol("CAND"), list(EQ, makeSymbol("POS"), reader_make_constant_shell("Preposition")), list(EQUALP, makeSymbol("STRING"), makeString("to"))), list(makeSymbol("CPUSH"), makeKeyword("TO"), makeSymbol("PENN-TAGS"))), list(T, list(makeSymbol("CDOLIST"), list(makeSymbol("INFLECTION"), makeSymbol("INFLECTIONS")), list(makeSymbol("CLET"), list(list(makeSymbol("PENN-TAG"), list(makeSymbol("MAP-FROM-CYC-TO-PENN-POS"), makeSymbol("POS"), makeSymbol("INFLECTION")))), list(makeSymbol("PWHEN"), makeSymbol("PENN-TAG"), list(makeSymbol("CPUSH"), makeSymbol("PENN-TAG"), makeSymbol("PENN-TAGS"))))))), list(RET, list(makeSymbol("REMOVE-DUPLICATES"), makeSymbol("PENN-TAGS"), list(QUOTE, EQ)))));
    ...
    static private final SubLList $list_alt151 = list(makeString("@return stringp; the super tag of this lex-entry"), list(makeSymbol("CLET"), list(list(makeSymbol("SUPERTAGS"), NIL)), list(makeSymbol("CDOLIST"), list(makeSymbol("INFL"), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("INFLECTIONS"))), list(makeSymbol("CDOLIST"), list(makeSymbol("SUPERTAG"), list(makeSymbol("GETHASH"), list(makeSymbol("LIST"), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("CYC-POS")), list(makeSymbol("GET"), makeSymbol("SELF"), makeKeyword("FRAME")), makeSymbol("INFL")), makeSymbol("*CYC-TO-SUPERTAG-MAP*"))), list(makeSymbol("CPUSHNEW"), makeSymbol("SUPERTAG"), makeSymbol("SUPERTAGS"), list(QUOTE, EQUAL)))), list(RET, makeSymbol("SUPERTAGS"))));

    static private final SubLList $list_alt155 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-ENTRY"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("TRIE-ENTRY")))), list(makeSymbol("PCOND"), list(makeSymbol("TRIE-ENTRY"), list(RET, list(makeSymbol("NL-TRIE-ENTRY-POS"), makeSymbol("TRIE-ENTRY")))), list(list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("INFLECTIONS")), list(makeSymbol("CDOLIST"), list(makeSymbol("PRED"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET")), makeKeyword("INFLECTIONS"))), list(makeSymbol("CLET"), list(list(makeSymbol("POS"), list(makeSymbol("POS-OF-PRED"), makeSymbol("PRED")))), list(makeSymbol("PWHEN"), makeSymbol("POS"), list(RET, makeSymbol("POS"))))))), list(RET, NIL)));
    ...
    static private final SubLList $list_alt341 = list(makeString("@param MT possibly-hlmt-p; the mt to be allowed for retrieval of lex entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("MT"), makeSymbol("POSSIBLY-HLMT-P")), list(makeSymbol("SET-ADD"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("CSETQ"), makeSymbol("ROOT-MT"), makeKeyword("UNINITIALIZED")), list(RET, makeSymbol("SELF")));
    ...
    static private final SubLList $list_alt346 = list(makeString("@param MT possibly-hlmt-p; the mt and all its genlMTs to be allowed for \n     retrieval of lex entries"), list(makeSymbol("CHECK-TYPE"), makeSymbol("MT"), makeSymbol("POSSIBLY-HLMT-P")), list(makeSymbol("SET-ADD"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(makeSymbol("CDOLIST"), list(makeSymbol("GENL-MT"), list(makeSymbol("QUERY-VARIABLE"), list(QUOTE, makeSymbol("?GENLMT")), list(makeSymbol("BQ-LIST*"), reader_make_constant_shell("genlMt"), makeSymbol("MT"), list(QUOTE, list(makeSymbol("?GENLMT")))))), list(makeSymbol("SET-ADD"), makeSymbol("GENL-MT"), makeSymbol("ALLOWED-MTS")), list(makeSymbol("SET-REMOVE"), makeSymbol("GENL-MT"), makeSymbol("EXCLUDED-MTS"))), list(makeSymbol("CSETQ"), makeSymbol("ROOT-MT"), makeKeyword("UNINITIALIZED")), list(RET, makeSymbol("SELF")));
    ...
    static private final SubLList $list_alt354 = list(makeString("@param MT possibly-hlmt-p; are assertions in MT allowed in this lexicon?"), list(makeSymbol("PUNLESS"), makeSymbol("MT"), list(RET, NIL)), list(makeSymbol("PCOND"), list(list(makeSymbol("SET-MEMBER?"), makeSymbol("MT"), makeSymbol("ALLOWED-MTS")), list(RET, T)), list(list(makeSymbol("SET-MEMBER?"), makeSymbol("MT"), makeSymbol("EXCLUDED-MTS")), list(RET, NIL)), list(list(makeSymbol("CNOT"), list(makeSymbol("HLMT-P"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET-BASE-MT"))))), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FORBID-MT")), makeSymbol("MT")), list(RET, NIL)), list(list(makeSymbol("GENL-LEXICON-MT?"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET-BASE-MT"))), makeSymbol("MT")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ALLOW-MT")), makeSymbol("MT")), list(RET, T)), list(T, list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("FORBID-MT")), makeSymbol("MT")), list(RET, NIL))));
    ...
    static private final SubLList $list_alt357 = list(makeString("return the one Mt that is the composition of all the allowed/disallowed mts, an MtUnionFn of all the Mts"), list(makeSymbol("PUNLESS"), list(makeSymbol("INITIALIZED-P"), makeSymbol("ROOT-MT")), list(makeSymbol("CLET"), list(list(makeSymbol("THIS-ALLOWED-MTS"), list(makeSymbol("GET-SLOT"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ALLOWED-MTS")))), list(makeSymbol("THIS-BASE-MT"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("GET-BASE-MT")))), list(makeSymbol("MTS"), list(makeSymbol("FIF"), list(makeSymbol("POSSIBLY-HLMT-P"), makeSymbol("THIS-BASE-MT")), list(makeSymbol("CONS"), makeSymbol("THIS-BASE-MT"), list(makeSymbol("SET-ELEMENT-LIST"), makeSymbol("THIS-ALLOWED-MTS"))), list(makeSymbol("SET-ELEMENT-LIST"), makeSymbol("ALLOWED-MTS")))), list(makeSymbol("MIN-MTS"), list(makeSymbol("MIN-MTS"), makeSymbol("MTS")))), list(makeSymbol("SET-SLOT"), makeSymbol("SELF"), list(QUOTE, makeSymbol("ROOT-MT")), list(makeSymbol("CANONICALIZE-HLMT"), list(makeSymbol("MAKE-EL-FORMULA"), reader_make_constant_shell("MtUnionFn"), makeSymbol("MIN-MTS")))))), list(RET, makeSymbol("ROOT-MT")));

    static private final SubLList $list_alt360 = list(makeSymbol("STRING"));

    static private final SubLList $list_alt361 = list(list(makeSymbol("CLET"), list(list(makeSymbol("STOP-WORD-SET"), makeSymbol("STOP-WORDS"))), list(makeSymbol("PUNLESS"), list(makeSymbol("SET-P"), makeSymbol("STOP-WORD-SET")), list(makeSymbol("CSETQ"), makeSymbol("STOP-WORD-SET"), list(makeSymbol("NEW-SET"), list(QUOTE, EQUAL)))), list(makeSymbol("SET-ADD"), makeSymbol("STRING"), makeSymbol("STOP-WORD-SET")), list(makeSymbol("CSETQ"), makeSymbol("STOP-WORDS"), makeSymbol("STOP-WORD-SET")), list(RET, makeSymbol("STOP-WORDS"))));
    ...
    static private final SubLList $list_alt379 = list(makeString("@param STRING stringp;\n   @return listp; the list of  lex-entry-p associated with STRING in this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("STRINGP")), list(makeSymbol("PWHEN"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("STOP-WORD-P")), makeSymbol("STRING")), list(RET, NIL)), list(makeSymbol("PUNLESS"), makeSymbol("IGNORE-CACHE?"), list(makeSymbol("CMULTIPLE-VALUE-BIND"), list(makeSymbol("LEX-ENTRIES"), makeSymbol("EXISTS?")), list(makeSymbol("CACHE-GET"), makeSymbol("CACHE"), makeSymbol("STRING")), list(makeSymbol("PWHEN"), makeSymbol("EXISTS?"), list(RET, makeSymbol("LEX-ENTRIES"))))), list(makeSymbol("CLET"), list(list(makeSymbol("LEX-ENTRIES"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("CREATE-LEX-ENTRIES")), makeSymbol("STRING"), NIL)), list(makeSymbol("NL-TRIE-ENTRIES"), list(makeSymbol("NL-TRIE-SEARCH"), makeSymbol("STRING"), makeSymbol("TRIE"), makeSymbol("CASE-SENSITIVITY")))), list(makeSymbol("CSETQ"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("ADD-LEX-ENTRIES-FOR-TRIE-ENTRIES"), makeSymbol("NL-TRIE-ENTRIES"), makeSymbol("STRING"), makeSymbol("SELF"), makeSymbol("LEX-ENTRIES"))), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("NULL"), makeSymbol("LEX-ENTRIES")), list(EQ, makeSymbol("CASE-SENSITIVITY"), makeKeyword("PREFERRED"))), list(makeSymbol("CLET"), list(list(makeSymbol("NL-TRIE-ENTRIES"), list(makeSymbol("NL-TRIE-SEARCH"), makeSymbol("STRING"), makeSymbol("TRIE"), makeKeyword("OFF")))), list(makeSymbol("CSETQ"), makeSymbol("LEX-ENTRIES"), list(makeSymbol("ADD-LEX-ENTRIES-FOR-TRIE-ENTRIES"), makeSymbol("NL-TRIE-ENTRIES"), makeSymbol("STRING"), makeSymbol("SELF"), makeSymbol("LEX-ENTRIES"))))), list(makeSymbol("PUNLESS"), makeSymbol("IGNORE-CACHE?"), list(makeSymbol("CACHE-SET"), makeSymbol("CACHE"), makeSymbol("STRING"), makeSymbol("LEX-ENTRIES"))), list(RET, makeSymbol("LEX-ENTRIES"))));
    ...
    static private final SubLList $list_alt387 = list(makeString("Deletes all entries for STRING from this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("STRINGP")), list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-KEY"), list(makeSymbol("NL-TRIE-STRING-TOKENIZE"), makeSymbol("STRING"))), list(makeSymbol("TRIE-ENTRIES"), list(makeSymbol("STRIE-LOOKUP"), makeSymbol("TRIE"), makeSymbol("TRIE-KEY")))), list(makeSymbol("CDOLIST"), list(makeSymbol("TRIE-ENTRY"), makeSymbol("TRIE-ENTRIES")), list(makeSymbol("PWHEN"), list(makeSymbol("LEX-ENTRY-P"), makeSymbol("TRIE-ENTRY")), list(makeSymbol("STRIE-UNASSOCIATE"), makeSymbol("TRIE"), makeSymbol("TRIE-KEY"), makeSymbol("TRIE-ENTRY"))))), list(makeSymbol("CACHE-REMOVE"), makeSymbol("CACHE"), makeSymbol("STRING")), list(RET, makeSymbol("SELF")));
    ...
    static private final SubLList $list_alt392 = list(makeString("Deletes the entry associating STRING with LEX-ENTRY from this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("STRING"), makeSymbol("STRINGP")), list(makeSymbol("CHECK-TYPE"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRY-P")), list(makeSymbol("CLET"), list(list(makeSymbol("TRIE-KEY"), list(makeSymbol("NL-TRIE-STRING-TOKENIZE"), makeSymbol("STRING")))), list(makeSymbol("STRIE-UNASSOCIATE"), makeSymbol("TRIE"), makeSymbol("TRIE-KEY"), makeSymbol("LEX-ENTRY"))), list(makeSymbol("CLET"), list(list(makeSymbol("CACHE-ENTRIES"), list(makeSymbol("REMOVE"), makeSymbol("LEX-ENTRY"), list(makeSymbol("CACHE-GET"), makeSymbol("CACHE"), makeSymbol("STRING")), list(QUOTE, EQUAL)))), list(makeSymbol("CACHE-SET"), makeSymbol("CACHE"), makeSymbol("STRING"), makeSymbol("CACHE-ENTRIES"))), list(RET, makeSymbol("SELF")));
    ...
    static private final SubLList $list_alt399 = list(makeString("Adds LEX-ENTRY to this lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("LEX-ENTRY"), makeSymbol("LEX-ENTRY-P")), list(makeSymbol("CLET"), list(list(makeSymbol("STRING"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("LEX-ENTRY"), list(QUOTE, makeSymbol("GET")), makeKeyword("STRING"))), makeSymbol("RESULT")), list(makeSymbol("PUNLESS"), list(makeSymbol("CHAR-POSITION"), makeSymbol("*STRIE-NULL-KEY*"), makeSymbol("STRING")), list(makeSymbol("CPUSH"), makeSymbol("LEX-ENTRY"), makeSymbol("LEARNED")), list(makeSymbol("CSETQ"), makeSymbol("RESULT"), list(makeSymbol("NL-TRIE-INSERT-ENTRY"), makeSymbol("TRIE"), list(makeSymbol("NL-TRIE-STRING-TOKENIZE"), makeSymbol("STRING")), list(makeSymbol("LEX-ENTRY2NL-TRIE-ENTRY"), makeSymbol("LEX-ENTRY")))), list(makeSymbol("CACHE-REMOVE"), makeSymbol("CACHE"), makeSymbol("STRING")), list(RET, makeSymbol("RESULT"))), list(RET, NIL)));
    ...
    static private final SubLList $list_alt407 = list(makeString("Delete all entries previously learned from this lexicon"), list(makeSymbol("CLET"), list(list(makeSymbol("DELETED"), makeSymbol("LEARNED"))), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX"), makeSymbol("LEARNED")), list(makeSymbol("FIM"), makeSymbol("SELF"), list(QUOTE, makeSymbol("DELETE")), list(makeSymbol("FIM"), makeSymbol("LEX"), list(QUOTE, makeSymbol("GET")), makeKeyword("STRING")))), list(makeSymbol("CSETQ"), makeSymbol("LEARNED"), NIL), list(RET, makeSymbol("DELETED"))));
    ...
    static private final SubLList $list_alt432 = list(makeString("@param TEXT stringp; the text from which to learn lexical entries\n   @param LEARNERS listp; a list of learning methods. Each such method\n   is expected to take a natural language string as input and return a \n   list of lex-entries\n   @return non-negative-integerp; the number of entries learned\n   @note it is the responsibility of each learner to add any entries to the lexicon"), list(makeSymbol("CHECK-TYPE"), makeSymbol("TEXT"), makeSymbol("STRINGP")), list(makeSymbol("PUNLESS"), makeSymbol("LEARNERS"), list(makeSymbol("CSETQ"), makeSymbol("LEARNERS"), makeSymbol("ACTIVE-LEARNERS"))), list(makeSymbol("CLET"), list(makeSymbol("LEARNED-HERE")), list(makeSymbol("CDOLIST"), list(makeSymbol("LEARNER"), makeSymbol("LEARNERS")), list(makeSymbol("CDOLIST"), list(makeSymbol("LEX"), list(makeSymbol("FIM"), makeSymbol("SELF"), makeSymbol("LEARNER"), makeSymbol("TEXT"))), list(makeSymbol("CPUSH"), makeSymbol("LEX"), makeSymbol("LEARNED-HERE")))), list(RET, makeSymbol("LEARNED-HERE"))));
    ...
    static private final SubLList $list_alt478 = list(makeString("@param sentence sentence-p;\n   @return sentence-p; a new version of SENTENCE with adjacent words collapsed into\n   single words and nl-trie-entries associated with the words in SENTENCE"), list(makeSymbol("CHECK-TYPE"), makeSymbol("SENTENCE"), makeSymbol("SENTENCE-P")), list(makeSymbol("PWHEN"), list(makeSymbol("ZEROP"), list(makeSymbol("SENTENCE-LENGTH"), makeSymbol("SENTENCE"))), list(RET, makeSymbol("SENTENCE"))), list(new SubLObject[]{ makeSymbol("CLET"), list(list(makeSymbol("LEXIFIED"), list(makeSymbol("NEW-SENTENCE"))), list(makeSymbol("WORD-VEC"), list(makeSymbol("SENTENCE-YIELD"), makeSymbol("SENTENCE"))), list(makeSymbol("FIRST-WORD"), list(makeSymbol("WORD-STRING"), list(makeSymbol("AREF"), makeSymbol("WORD-VEC"), ZERO_INTEGER))), list(makeSymbol("RECORD-LENGTH"), ZERO_INTEGER), list(makeSymbol("LEXIFIED-TOKENS"), NIL), makeSymbol("WORDS")), list(makeSymbol("TAGGER-NORMALIZE-INITIAL-CAPITALIZATION"), list(makeSymbol("GET-TAGGER")), makeSymbol("WORD-VEC")), list(makeSymbol("CSETQ"), makeSymbol("WORDS"), list(makeSymbol("VECTOR-ELEMENTS"), makeSymbol("WORD-VEC"))), list(makeSymbol("CLET"), list(list(makeSymbol("*LEXICON-LOOKUP-MT*"), reader_make_constant_shell("InferencePSC"))), list(makeSymbol("CDO"), list(list(makeSymbol("INDEX"), ZERO_INTEGER, list(makeSymbol("+"), makeSymbol("INDEX"), makeSymbol("RECORD-LENGTH"))), list(makeSymbol("TOKENS"), makeSymbol("WORDS"), list(makeSymbol("NTHCDR"), makeSymbol("RECORD-LENGTH"), makeSymbol("TOKENS"))), list(makeSymbol("STRINGS"), list(makeSymbol("MAPCAR"), list(makeSymbol("FUNCTION"), makeSymbol("WORD-STRING")), makeSymbol("TOKENS")), list(makeSymbol("NTHCDR"), makeSymbol("RECORD-LENGTH"), makeSymbol("STRINGS")))), list(list(makeSymbol("NULL"), makeSymbol("TOKENS"))), list(makeSymbol("CLET"), list(list(makeSymbol("PREFIXES"), list(makeSymbol("NL-TRIE-PREFIXES-MEMOIZED"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("CASE-SENSITIVITY"))), list(makeSymbol("NEW-TOKEN"), NIL), list(makeSymbol("LOCAL-CASE-SENSITIVITY"), makeSymbol("CASE-SENSITIVITY"))), list(makeSymbol("UNTIL"), list(makeSymbol("COR"), list(makeSymbol("LEXIFIED-WORD-P"), makeSymbol("NEW-TOKEN")), list(makeSymbol("EMPTY-LIST-P"), makeSymbol("PREFIXES"))), list(makeSymbol("POP-BIND"), list(makeSymbol("RECORD"), makeSymbol("PREFIXES")), list(makeSymbol("CMULTIPLE-VALUE-SETQ"), list(makeSymbol("NEW-TOKEN"), makeSymbol("RECORD-LENGTH")), list(makeSymbol("GET-LEX-ENTRIES-FOR-PREFIX"), makeSymbol("SELF"), makeSymbol("TOKENS"), makeSymbol("STRINGS"), makeSymbol("RECORD"), makeSymbol("LEXIFIED")))), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol("EMPTY-LIST-P"), makeSymbol("PREFIXES")), list(makeSymbol("NULL"), list(makeSymbol("WORD-INFO"), makeSymbol("NEW-TOKEN"))), list(EQ, makeSymbol("LOCAL-CASE-SENSITIVITY"), makeKeyword("PREFERRED"))), list(makeSymbol("CSETQ"), makeSymbol("LOCAL-CASE-SENSITIVITY"), makeKeyword("OFF")), list(makeSymbol("CSETQ"), makeSymbol("PREFIXES"), list(makeSymbol("NL-TRIE-PREFIXES-MEMOIZED"), makeSymbol("TRIE"), makeSymbol("STRINGS"), makeSymbol("LOCAL-CASE-SENSITIVITY"))))), list(makeSymbol("PUNLESS"), list(makeSymbol("WORD-P"), makeSymbol("NEW-TOKEN")), list(makeSymbol("CMULTIPLE-VALUE-SETQ"), list(makeSymbol("NEW-TOKEN"), makeSymbol("RECORD-LENGTH")), list(makeSymbol("GET-LEX-ENTRIES-FOR-PREFIX"), makeSymbol("SELF"), makeSymbol("TOKENS"), makeSymbol("STRINGS"), NIL, makeSymbol("LEXIFIED")))), list(makeSymbol("CPUSH"), makeSymbol("NEW-TOKEN"), makeSymbol("LEXIFIED-TOKENS"))))), list(makeSymbol("CSETF"), list(makeSymbol("SIGN-CONSTITUENTS"), makeSymbol("LEXIFIED")), list(makeSymbol("APPLY"), list(makeSymbol("FUNCTION"), makeSymbol("VECTOR")), list(makeSymbol("NREVERSE"), makeSymbol("LEXIFIED-TOKENS")))), list(makeSymbol("WORD-UPDATE"), list(makeSymbol("SENTENCE-GET"), makeSymbol("LEXIFIED"), ZERO_INTEGER), list(makeSymbol("LIST"), makeKeyword("STRING"), list(makeSymbol("REPLACE"), list(makeSymbol("WORD-STRING"), list(makeSymbol("SENTENCE-GET"), makeSymbol("LEXIFIED"), ZERO_INTEGER)), makeSymbol("FIRST-WORD")))), list(makeSymbol("CSETF"), list(makeSymbol("SIGN-STRING"), makeSymbol("LEXIFIED")), list(makeSymbol("SENTENCE-STRING"), makeSymbol("SENTENCE"))), list(makeSymbol("PWHEN"), list(makeSymbol("SENTENCE-MOTHER"), makeSymbol("SENTENCE")), list(makeSymbol("PARAGRAPH-SET"), list(makeSymbol("SENTENCE-MOTHER"), makeSymbol("SENTENCE")), list(makeSymbol("SENTENCE-INDEX"), makeSymbol("SENTENCE")), makeSymbol("LEXIFIED"))), list(RET, makeSymbol("LEXIFIED")) }));
    ...
    static private final SubLList $list_alt578 = list(list(list(makeString("3.4   billion dogs and 2 cats")), list(list(makeString("2"), TWO_INTEGER), list(makeString("3.4   billion"), makeDouble(3.4E9)))), list(list(makeString("3.1415926 is pi")), list(list(makeString("3.1415926"), makeDouble(3.1415926)))), list(list(makeString("3.1415926, 2.3456789 and 1.3254 are numbers")), list(list(makeString("1.3254"), makeDouble(1.3254)), list(makeString("2.3456789"), makeDouble(2.3456789)), list(makeString("3.1415926"), makeDouble(3.1415926)))), list(list(makeString("3.1415926, -2.3456789 and 1.3254 are numbers")), list(list(makeString("1.3254"), makeDouble(1.3254)), list(makeString("-2.3456789"), makeDouble(-2.3456789)), list(makeString("3.1415926"), makeDouble(3.1415926)))));
