...
public final class abstract_lexicon extends SubLTranslatedFile implements V12 {
	...
	public static final SubLObject textract_lemma_p_alt(SubLObject v_object) {
		return v_object.getJavaClass() ==com.cyc.cycjava.cycl.abstract_lexicon.$textract_lemma_native.class ? ((SubLObject) (T)) : NIL;
	}

	public static SubLObject textract_lemma_p(final SubLObject v_object) {
		return v_object.getJavaClass() ==com.cyc.cycjava.cycl.abstract_lexicon.$textract_lemma_native.class ? T : NIL;
	}
	...
	public static final SubLObject abstract_lexicon_iterator_state_p_alt(SubLObject v_object) {
		return v_object.getJavaClass() ==com.cyc.cycjava.cycl.abstract_lexicon.$abstract_lexicon_iterator_state_native.class ? ((SubLObject) (T)) : NIL;
	}

	public static SubLObject abstract_lexicon_iterator_state_p(final SubLObject v_object) {
		return v_object.getJavaClass() ==com.cyc.cycjava.cycl.abstract_lexicon.$abstract_lexicon_iterator_state_native.class ? T : NIL;
	}
