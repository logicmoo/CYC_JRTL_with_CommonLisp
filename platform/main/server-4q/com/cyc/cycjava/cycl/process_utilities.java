...
public class process_utilities extends SubLTranslatedFile implements V12 {
	...
	public static final SubLObject make_thinking_task(SubLObject arglist) {
		if (arglist == UNPROVIDED) {
			arglist = NIL;
		}
	...
	public static SubLObject make_ordered_ipc_queue(SubLObject arglist) {
		...
		for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
			...
			} else if (pcase_var.eql(process_utilities.$EARLY_CONSUMER_SEMAPHORE)) {
	...
	static private final SubLList $list_alt179 = list(list(makeSymbol("THINKING"), makeKeyword("INSTANCE"), makeKeyword("PRIVATE")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SETUP"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CLEANUP"), NIL, makeKeyword("PROTECTED")),
			list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("THINKING-EXISTS-TESTS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("THINKING-BAD-ARGS-TESTS"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("THINKING-COMPLEX-TEST-1"), NIL, makeKeyword("PROTECTED")),
			list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("THINKING-COMPLEX-TEST-2"), NIL, makeKeyword("PROTECTED")));
