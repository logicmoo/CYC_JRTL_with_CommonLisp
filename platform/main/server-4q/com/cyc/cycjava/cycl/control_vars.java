...
public final class control_vars extends SubLTranslatedFile implements V12 {
 ...
 public static final String myName = "com.cyc.cycjava.cycl.control_vars";
		...
		if (NIL != unprovided_argumentP($mapping_fn_arg2$.getDynamicValue(thread))) {
			...
			if (NIL != unprovided_argumentP($mapping_fn_arg4$.getDynamicValue(thread))) {
				...
				if (NIL != unprovided_argumentP($mapping_fn_arg6$.getDynamicValue(thread))) {
				    return funcall($mapping_fn$.getDynamicValue(thread), $mapping_fn_arg1$.getDynamicValue(thread), $mapping_fn_arg2$.getDynamicValue(thread), $mapping_fn_arg3$.getDynamicValue(thread), $mapping_fn_arg4$.getDynamicValue(thread),
					    $mapping_fn_arg5$.getDynamicValue(thread));
				} else {
				    if (NIL != unprovided_argumentP($mapping_fn_arg7$.getDynamicValue(thread))) {
					return funcall($mapping_fn$.getDynamicValue(thread), $mapping_fn_arg1$.getDynamicValue(thread), $mapping_fn_arg2$.getDynamicValue(thread), $mapping_fn_arg3$.getDynamicValue(thread), $mapping_fn_arg4$.getDynamicValue(thread),
						$mapping_fn_arg5$.getDynamicValue(thread), $mapping_fn_arg6$.getDynamicValue(thread));
				    } else {
					if (NIL != unprovided_argumentP($mapping_fn_arg8$.getDynamicValue(thread))) {
					    return funcall($mapping_fn$.getDynamicValue(thread), new SubLObject[] { $mapping_fn_arg1$.getDynamicValue(thread), $mapping_fn_arg2$.getDynamicValue(thread), $mapping_fn_arg3$.getDynamicValue(thread), $mapping_fn_arg4$.getDynamicValue(thread),
						    $mapping_fn_arg5$.getDynamicValue(thread), $mapping_fn_arg6$.getDynamicValue(thread), $mapping_fn_arg7$.getDynamicValue(thread) });
					} else {
					    return funcall($mapping_fn$.getDynamicValue(thread), new SubLObject[] { $mapping_fn_arg1$.getDynamicValue(thread), $mapping_fn_arg2$.getDynamicValue(thread), $mapping_fn_arg3$.getDynamicValue(thread), $mapping_fn_arg4$.getDynamicValue(thread),
						    $mapping_fn_arg5$.getDynamicValue(thread), $mapping_fn_arg6$.getDynamicValue(thread), $mapping_fn_arg7$.getDynamicValue(thread), $mapping_fn_arg8$.getDynamicValue(thread) });
					}
				    }
				}
			    }
	...
	if (NIL != unprovided_argumentP($mapping_fn_arg7$.getDynamicValue(thread))) {
	    return funcall($mapping_fn$.getDynamicValue(thread), $mapping_fn_arg1$.getDynamicValue(thread), $mapping_fn_arg2$.getDynamicValue(thread), $mapping_fn_arg3$.getDynamicValue(thread), $mapping_fn_arg4$.getDynamicValue(thread), $mapping_fn_arg5$.getDynamicValue(thread),
		    $mapping_fn_arg6$.getDynamicValue(thread));
	}
	if (NIL != unprovided_argumentP($mapping_fn_arg8$.getDynamicValue(thread))) {
	    return funcall($mapping_fn$.getDynamicValue(thread), new SubLObject[] { $mapping_fn_arg1$.getDynamicValue(thread), $mapping_fn_arg2$.getDynamicValue(thread), $mapping_fn_arg3$.getDynamicValue(thread), $mapping_fn_arg4$.getDynamicValue(thread), $mapping_fn_arg5$.getDynamicValue(thread),
		    $mapping_fn_arg6$.getDynamicValue(thread), $mapping_fn_arg7$.getDynamicValue(thread) });
	}
	return funcall($mapping_fn$.getDynamicValue(thread), new SubLObject[] { $mapping_fn_arg1$.getDynamicValue(thread), $mapping_fn_arg2$.getDynamicValue(thread), $mapping_fn_arg3$.getDynamicValue(thread), $mapping_fn_arg4$.getDynamicValue(thread), $mapping_fn_arg5$.getDynamicValue(thread),
		$mapping_fn_arg6$.getDynamicValue(thread), $mapping_fn_arg7$.getDynamicValue(thread), $mapping_fn_arg8$.getDynamicValue(thread) });
    }
