...
public final class pattern_match extends SubLTranslatedFile implements V12 {
	...
	public static final SubLSymbol $pattern_matches_tree_atomic_methods$ = makeSymbol(
			"*PATTERN-MATCHES-TREE-ATOMIC-METHODS*");
	...
	static private final SubLList $list2 = list(list(makeSymbol("VARIABLES"), makeSymbol("TREE"), makeSymbol("PATTERN"),
			makeSymbol("&KEY"), makeSymbol("MATCH-METHOD")), makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	static private final SubLList $list28 = list(makeSymbol("TEST"), makeSymbol("&OPTIONAL"), makeSymbol("ARG2"),
			makeSymbol("ARG3"));

	static private final SubLList $list29 = list(makeSymbol("TEST"), makeSymbol("&OPTIONAL"), makeSymbol("ARG2"),
			makeSymbol("ARG3"), makeSymbol("ARG4"));
	...
	static private final SubLList $list43 = list(makeSymbol("OPERATOR"), makeSymbol("VARIABLES"),
			makeSymbol("SUBPATTERN"));

	static private final SubLList $list44 = list(makeSymbol("OPERATOR"), makeSymbol("MATCH-PATTERN"),
			makeSymbol("SUBPATTERN"));

	static private final SubLList $list45 = cons(makeSymbol("VARIABLE"), makeSymbol("VALUE"));

	static private final SubLList $list46 = list(makeSymbol("OPERATOR"), makeSymbol("METHOD"), makeSymbol("&REST"),
			makeSymbol("METHOD-ARGS"));

	private static final SubLList $list47 = list(makeSymbol("&OPTIONAL"), makeSymbol("ARG1"), makeSymbol("ARG2"),
			makeSymbol("ARG3"), makeSymbol("ARG4"));

	static private final SubLList $list48 = list(
			list(makeSymbol("VARIABLES"), makeSymbol("FORMULA"), makeSymbol("PATTERN")), makeSymbol("&BODY"),
			makeSymbol("BODY"));
	...
	private static final SubLList $list57 = list(
			list(list(
					list(makeKeyword("AND"), cons(makeKeyword("DIFFERENT"), makeKeyword("ANYTHING")),
							list($BIND, makeSymbol("ASENT"))),
					list(makeKeyword("DIFFERENT"), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER)), T,
					list(list(makeSymbol("ASENT"), makeKeyword("DIFFERENT"), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER))),
			list(list(
					list(makeKeyword("AND"),
							list(makeKeyword("DIFFERENT"), makeKeyword("ANYTHING"), makeKeyword("ANYTHING"),
									list($BIND, makeSymbol("ARG"))),
							list($BIND, makeSymbol("ASENT"))),
					list(makeKeyword("DIFFERENT"), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER)), T,
					list(cons(makeSymbol("ARG"), THREE_INTEGER),
							list(makeSymbol("ASENT"), makeKeyword("DIFFERENT"), ONE_INTEGER, TWO_INTEGER,
									THREE_INTEGER))),
			list(list(
					list(makeKeyword("AND"), list(makeKeyword("DIFFERENT"), $BIND, makeSymbol("ARGS")),
							list($BIND, makeSymbol("ASENT"))),
					list(makeKeyword("DIFFERENT"), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER)), T,
					list(list(makeSymbol("ARGS"), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER),
							list(makeSymbol("ASENT"), makeKeyword("DIFFERENT"), ONE_INTEGER, TWO_INTEGER,
									THREE_INTEGER))),
			list(list(
					list(makeKeyword("AND"),
							list(makeKeyword("DIFFERENT"), list($BIND, makeSymbol("ARG1")),
									list($BIND, makeSymbol("ARG2")), $BIND, makeSymbol("ARGS")),
							list($BIND, makeSymbol("ASENT"))),
					list(makeKeyword("DIFFERENT"), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER, FOUR_INTEGER,
							FIVE_INTEGER)),
					T,
					list(cons(makeSymbol("ARG1"), ONE_INTEGER), cons(makeSymbol("ARG2"), TWO_INTEGER),
							list(makeSymbol("ARGS"), THREE_INTEGER, FOUR_INTEGER, FIVE_INTEGER),
							list(makeSymbol("ASENT"), makeKeyword("DIFFERENT"), ONE_INTEGER, TWO_INTEGER, THREE_INTEGER,
									FOUR_INTEGER, FIVE_INTEGER))));
							...
							try {
								{
									...
									try {
										...
										if (NIL != pattern_matches_tree_internal(pattern, tree)) {
											success = T;
											v_bindings = nreverse(
													$pattern_matches_tree_bindings$.getDynamicValue(thread));
										}
									} finally {
	...
	/**
	 * Return T iff PATTERN matches TREE. :BIND expressions are not allowed in
	 * PATTERN.
	 */
				...
				current = current.first();
				{
					...
					current = current.rest();
					{
						...
						}
						{
							...
							SubLObject match_method = (NIL != match_method_tail)
									? ((SubLObject) (cadr(match_method_tail)))
									: NIL;
							current = temp;
							{
								...
								}
								{
									...
									SubLObject variable_specs = pattern_bindings_variable_specs(v_variables,
											v_bindings);
									return listS(CMULTIPLE_VALUE_BIND, list(success, v_bindings),
											list(match_method, tree, pattern),
											append(NIL != variable_specs
													? ((SubLObject) (list(list(PWHEN, success,
															listS(CLET, variable_specs, append(body, NIL))))))
													: list(list(IGNORE, v_bindings),
															listS(PWHEN, success, append(body, NIL))),
													NIL));
								}
							}
						}
	...
	public static SubLObject with_tree_pattern_bindings(final SubLObject macroform, final SubLObject environment) {
		...
		return listS(CMULTIPLE_VALUE_BIND, list(success, v_bindings), list(match_method, tree, pattern),
				append(NIL != variable_specs
						? list(list(PWHEN, success, listS(CLET, variable_specs, append(body, NIL))))
						: list(list(IGNORE, v_bindings), listS(PWHEN, success, append(body, NIL))), NIL));
	}

	public static final SubLObject pattern_bindings_variable_specs_alt(SubLObject v_variables,
			SubLObject bindings_var) {
		{
			...
			for (variable = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var
				...
				{
					SubLObject variable_spec = list(variable,
							list(ALIST_LOOKUP_WITHOUT_VALUES, bindings_var, list(QUOTE, variable)));
	...
	public static SubLObject pattern_bindings_variable_specs(final SubLObject v_variables,
			final SubLObject bindings_var) {
		SubLObject variable_specs = NIL;
		SubLObject cdolist_list_var = v_variables;
		SubLObject variable = NIL;
		variable = cdolist_list_var.first();
		while (NIL != cdolist_list_var) {
			final SubLObject variable_spec = list(variable,
					list(ALIST_LOOKUP_WITHOUT_VALUES, bindings_var, list(QUOTE, variable)));
			variable_specs = cons(variable_spec, variable_specs);
	...
	public static SubLObject pattern_matches_tree_internal(final SubLObject pattern, final SubLObject tree) {
		SubLObject success = pattern_matches_tree_recursive(pattern, tree);
		if (success != NIL)
			return success;
		success = pattern_matches_tree_recursive_alt(pattern, tree);
		return success;
	}
	...
	public static SubLObject pattern_matches_tree_atomic_method_funcall(final SubLObject method,
			final SubLObject tree) {
		return funcall(method, tree);
	}

	public static final SubLObject pattern_matches_tree_method_funcall_alt(SubLObject method, SubLObject pattern,
			SubLObject tree) {
		return funcall(method, pattern, tree);
	}

	public static SubLObject pattern_matches_tree_method_funcall(final SubLObject method, final SubLObject pattern,
			final SubLObject tree) {
		return funcall(method, pattern, tree);
	}
	...
	public static final SubLObject pattern_matches_tree_recursive_alt(SubLObject pattern, SubLObject tree) {
		...
		if (pattern.isAtom()) {
				...
				if (pcase_var.eql($ANYTHING)) {
					...
					if (pcase_var.eql($NOTHING)) {
					...
					} else {
						{
							...
							for (method_info = cdolist_list_var
									.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var
											.rest(), method_info = cdolist_list_var.first()) {
								{
		...
		} else {
			{
				...
				SubLObject current = datum;
				final SubLObject pattern_operator;
									...
									if (pcase_var.eql($NOT)) {
										{
											...
											if (NIL == current_4) {
												return makeBoolean(
														NIL == pattern_matches_tree_recursive(sub_pattern, tree));
											} else {
										...
										if (pcase_var.eql($TEST)) {
											{
												SubLObject extra_arg_count = subtract(length(pattern_args),
														ONE_INTEGER);
												if (ZERO_INTEGER == extra_arg_count) {
													{
														...
														if (NIL == current_6) {
															return list_utilities.sublisp_boolean(
																	pattern_matches_tree_test_funcall(test, tree));
														} else {
													...
													if (ONE_INTEGER == extra_arg_count) {
														{
															...
															SubLObject test = NIL;
															destructuring_bind_must_consp(current_8, datum_7,
																	$list_alt27);
															test = current_8.first();
															current_8 = current_8.rest();
															{
																SubLObject arg2 = (current_8.isCons())
																		? ((SubLObject) (current_8.first()))
																		: NIL;
																destructuring_bind_must_listp(current_8, datum_7,
																		$list_alt27);
																current_8 = current_8.rest();
																if (NIL == current_8) {
																	return list_utilities.sublisp_boolean(
																			pattern_matches_tree_test_funcall_2(test,
																					tree, arg2));
																} else {
														...
														if (TWO_INTEGER == extra_arg_count) {
															{
																...
																SubLObject test = NIL;
																destructuring_bind_must_consp(current_10, datum_9,
																		$list_alt28);
																test = current_10.first();
																current_10 = current_10.rest();
																{
																	SubLObject arg2 = (current_10.isCons())
																			? ((SubLObject) (current_10.first()))
																			: NIL;
																	destructuring_bind_must_listp(current_10, datum_9,
																			$list_alt28);
																	current_10 = current_10.rest();
																	{
																		SubLObject arg3 = (current_10.isCons())
																				? ((SubLObject) (current_10.first()))
																				: NIL;
																		destructuring_bind_must_listp(current_10,
																				datum_9, $list_alt28);
																		current_10 = current_10.rest();
																		if (NIL == current_10) {
																			return list_utilities.sublisp_boolean(
																					pattern_matches_tree_test_funcall_3(
																							test, tree, arg2, arg3));
																		} else {
																			cdestructuring_bind_error(datum_9,
																					$list_alt28);
																		}
																	}
																}
															...
															if (THREE_INTEGER == extra_arg_count) {
																{
																	...
																	SubLObject test = NIL;
																	destructuring_bind_must_consp(current_12, datum_11,
																			$list_alt29);
																	test = current_12.first();
																	current_12 = current_12.rest();
																	{
																		SubLObject arg2 = (current_12.isCons())
																				? ((SubLObject) (current_12.first()))
																				: NIL;
																		destructuring_bind_must_listp(current_12,
																				datum_11, $list_alt29);
																		current_12 = current_12.rest();
																		{
																			SubLObject arg3 = (current_12.isCons())
																					? ((SubLObject) (current_12
																							.first()))
																					: NIL;
																			destructuring_bind_must_listp(current_12,
																					datum_11, $list_alt29);
																			current_12 = current_12.rest();
																			{
																				SubLObject arg4 = (current_12.isCons())
																						? ((SubLObject) (current_12
																								.first()))
																						: NIL;
																				...
																				if (NIL == current_12) {
																					return list_utilities
																							.sublisp_boolean(
																									pattern_matches_tree_test_funcall_4(
																											test, tree,
																											arg2, arg3,
																											arg4));
																				} else {
																					cdestructuring_bind_error(datum_11,
																							$list_alt29);
																				}
																			}
																		}
												...
												if (pcase_var.eql($QUOTE)) {
													{
														...
														destructuring_bind_must_consp(current_16, datum_15,
																$list_alt32);
													...
													{
														SubLObject cdolist_list_var = $pattern_matches_tree_methods$
																.getDynamicValue(thread);
														SubLObject method_info = NIL;
														for (method_info = cdolist_list_var
																.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var
																		.rest(), method_info = cdolist_list_var
																				.first()) {
															{
																...
																SubLObject method_operator = NIL;
																SubLObject method = NIL;
																destructuring_bind_must_consp(current_18, datum_17,
																		$list_alt17);
																...
																if (NIL == current_18) {
																	if (method_operator == pattern_operator) {
																		return pattern_matches_tree_method_funcall(
																				method, pattern, tree);
																	}
																} else {
		...
		if (pattern.isAtom()) {
			...
			if (pcase_var.eql($NOT)) {
				...
				if (ZERO_INTEGER.eql(extra_arg_count)) {
					...
					if (NIL == current_$7) {
						return list_utilities
								.sublisp_boolean(pattern_matches_tree_test_funcall_3(test, tree, arg2, arg3));
					}
					...
					if (NIL == current_$8) {
						return list_utilities
								.sublisp_boolean(pattern_matches_tree_test_funcall_4(test, tree, arg2, arg3, arg4));
					}
					cdestructuring_bind_error(datum_$7, $list29);
				}

			} else if (pcase_var.eql($TREE_FIND)) {
			...
			} else if (pcase_var.eql($TREE_FIND_IF)) {
	...
	public static final SubLObject pattern_matches_tree_bind_alt(SubLObject pattern, SubLObject tree) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				...
				$pattern_matches_tree_bindings$.setDynamicValue(list_utilities.alist_enter_without_values(
						$pattern_matches_tree_bindings$.getDynamicValue(thread), variable, tree, symbol_function(EQL)),
						thread);
				return T;
			}
		}
	...
	public static SubLObject pattern_matches_tree_bind(final SubLObject pattern, final SubLObject tree) {
		...
		$pattern_matches_tree_bindings$.setDynamicValue(list_utilities.alist_enter_without_values(
				$pattern_matches_tree_bindings$.getDynamicValue(thread), variable, tree, symbol_function(EQL)), thread);
		return T;
	}
	...
	public static final SubLObject pattern_matches_tree_value_alt(SubLObject pattern, SubLObject tree) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				...
				{
					SubLObject value = list_utilities.alist_lookup(
							$pattern_matches_tree_bindings$.getDynamicValue(thread), variable, symbol_function(EQL),
							UNPROVIDED);
	...
	public static SubLObject pattern_matches_tree_value(final SubLObject pattern, final SubLObject tree) {
		...
		final SubLObject variable = second(pattern);
		thread.resetMultipleValues();
		final SubLObject value = list_utilities.alist_lookup($pattern_matches_tree_bindings$.getDynamicValue(thread),
				variable, symbol_function(EQL), UNPROVIDED);
	...
	public static final SubLObject pattern_matches_tree_and_alt(SubLObject pattern, SubLObject tree) {
		{
			...
			SubLObject sub_pattern = NIL;
			for (sub_pattern = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var
					.rest(), sub_pattern = cdolist_list_var.first()) {
	...
	public static final SubLObject pattern_matches_tree_test_funcall_2_alt(SubLObject test, SubLObject tree,
			SubLObject arg2) {
		if (NIL != eval_in_api.possibly_cyc_api_function_spec_p(test)) {
	...
	public static SubLObject pattern_matches_tree_test_funcall_2(final SubLObject test, final SubLObject tree,
			final SubLObject arg2) {
		if (NIL != eval_in_api.possibly_cyc_api_function_spec_p(test)) {
			return eval_in_api.possibly_cyc_api_funcall_2(test, tree, arg2);
		}
		return NIL;
	...
	public static final SubLObject pattern_matches_tree_test_funcall_3_alt(SubLObject test, SubLObject tree,
	...
	public static SubLObject pattern_matches_tree_test_funcall_3(final SubLObject test, final SubLObject tree,
			final SubLObject arg2, final SubLObject arg3) {
		if (NIL != eval_in_api.possibly_cyc_api_function_spec_p(test)) {
			return eval_in_api.possibly_cyc_api_funcall_3(test, tree, arg2, arg3);
		}
		return NIL;
	...
	public static final SubLObject pattern_matches_tree_test_funcall_4_alt(SubLObject test, SubLObject tree,
	...
	public static SubLObject pattern_matches_tree_test_funcall_4(final SubLObject test, final SubLObject tree,
			final SubLObject arg2, final SubLObject arg3, final SubLObject arg4) {
		if (NIL != eval_in_api.possibly_cyc_api_function_spec_p(test)) {
			return eval_in_api.possibly_cyc_api_funcall_4(test, tree, arg2, arg3, arg4);
		}
		return NIL;
				...
				pattern_args = current;
				{
					...
					}
					{
						...
						for (rest_pattern_args = pattern_args, rest_tree_args = tree_args; !(rest_pattern_args.isAtom()
								|| rest_tree_args.isAtom()); rest_pattern_args = rest_pattern_args
	...
	public static SubLObject pattern_matches_tree_cons(final SubLObject pattern, final SubLObject tree) {
		...
		for (rest_pattern_args = NIL, rest_tree_args = NIL, rest_pattern_args = pattern_args, rest_tree_args = tree_args; (!rest_pattern_args
				.isAtom())
				&& (!rest_tree_args.isAtom()); rest_pattern_args = rest_pattern_args
						.rest(), rest_tree_args = rest_tree_args.rest()) {
	...
	public static SubLObject possibly_match_pattern_p(final SubLObject v_object) {
		return makeBoolean(v_object.isList() && (NIL != cycl_utilities.expression_find_if(symbol_function(KEYWORDP),
				v_object, UNPROVIDED, UNPROVIDED)));
	}

	/**
	 * Use PATTERN to transform TREE, assuming BINDINGS. Return transformation
	 * result and updated BINDINGS.
	 */
	...
	public static final SubLObject pattern_transform_tree_alt(SubLObject pattern, SubLObject tree,
	 ...
	 */
	@LispMethod(comment = "Use PATTERN to transform TREE, assuming BINDINGS.\r\nReturn transformation result and updated BINDINGS.\nUse PATTERN to transform TREE, assuming BINDINGS.\nReturn transformation result and updated BINDINGS.")
	public static SubLObject pattern_transform_tree(final SubLObject pattern, final SubLObject tree,
			SubLObject v_bindings) {
		if (v_bindings == UNPROVIDED) {
			v_bindings = NIL;
		}
	...
	/**
	 * Transform TREE using PATTERN, assuming BINDINGS. Return transformation result
	...
	public static final SubLObject tree_pattern_transform_alt(SubLObject tree, SubLObject pattern,
			SubLObject v_bindings) {
		if (v_bindings == UNPROVIDED) {
			v_bindings = NIL;
		}
	...
	@LispMethod(comment = "Transform TREE using PATTERN, assuming BINDINGS.\r\nReturn transformation result and updated BINDINGS.\nTransform TREE using PATTERN, assuming BINDINGS.\nReturn transformation result and updated BINDINGS.")
	public static SubLObject tree_pattern_transform(final SubLObject tree, final SubLObject pattern,
			SubLObject v_bindings) {
		if (v_bindings == UNPROVIDED) {
			v_bindings = NIL;
		}
						...
						if (pcase_var.eql($VALUE)) {
							{
								...
								if (NIL == current_22) {
									return list_utilities.alist_lookup_without_values(
											$pattern_transform_tree_bindings$.getDynamicValue(thread), variable,
											symbol_function(EQL), NIL);
								} else {
	...
	public static SubLObject pattern_transform_tree_recursive(final SubLObject pattern, final SubLObject tree) {
		...
		if (!pattern.isAtom()) {
			...
			if (pcase_var.eql($VALUE)) {
				...
				if (NIL == current_$24) {
					return list_utilities.alist_lookup_without_values(
							$pattern_transform_tree_bindings$.getDynamicValue(thread), variable, symbol_function(EQL),
							NIL);
				}
	...
	public static final SubLObject pattern_transform_tuple_alt(SubLObject pattern, SubLObject tree) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				...
				current = current.rest();
				if (NIL == current) {
					if (!((tree.isList() && v_variables.isList())
							&& (NIL != list_utilities.lengthE(tree, length(v_variables), UNPROVIDED)))) {
						return NIL;
					}
					{
						SubLObject variable = NIL;
						...
						for (variable = v_variables, variable_25 = variable
								.first(), subtree = tree, subtree_26 = subtree.first(); !((NIL == subtree)
										&& (NIL == variable)); variable = variable.rest(), variable_25 = variable
												.first(), subtree = subtree.rest(), subtree_26 = subtree.first()) {
							$pattern_transform_tree_bindings$.setDynamicValue(list_utilities.alist_enter_without_values(
									$pattern_transform_tree_bindings$.getDynamicValue(thread), variable_25, subtree_26,
									symbol_function(EQL)), thread);
						}
					}
	...
	public static SubLObject pattern_transform_tuple(final SubLObject pattern, final SubLObject tree) {
		...
		while ((NIL != subtree) || (NIL != variable)) {
			$pattern_transform_tree_bindings$.setDynamicValue(
					list_utilities.alist_enter_without_values($pattern_transform_tree_bindings$.getDynamicValue(thread),
							variable_$27, subtree_$28, symbol_function(EQL)),
					thread);
	...
	public static final SubLObject pattern_transform_template_alt(SubLObject pattern, SubLObject tree) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				...
				if (NIL == current) {
					thread.resetMultipleValues();
					{
						SubLObject success = (NIL != $pattern_transform_match_method$.getDynamicValue(thread))
								? ((SubLObject) (funcall($pattern_transform_match_method$.getDynamicValue(thread),
										match_pattern, tree)))
						...
						}
						{
							...
							for (binding = cdolist_list_var
											...
											.rest(), binding = cdolist_list_var.first()) {
								{
									...
									value = current_28;
									$pattern_transform_tree_bindings$
											.setDynamicValue(list_utilities.alist_enter_without_values(
													$pattern_transform_tree_bindings$.getDynamicValue(thread), variable,
													value, symbol_function(EQL)), thread);
								}
							}
						}
						return pattern_transform_tree_recursive(subpattern, NIL);
	...
	public static SubLObject pattern_transform_template(final SubLObject pattern, final SubLObject tree) {
		...
		thread.resetMultipleValues();
		final SubLObject success = (NIL != $pattern_transform_match_method$.getDynamicValue(thread))
				? funcall($pattern_transform_match_method$.getDynamicValue(thread), match_pattern, tree)
				: pattern_matches_tree(match_pattern, tree);
		...
		while (NIL != cdolist_list_var) {
			...
			$pattern_transform_tree_bindings$.setDynamicValue(
					list_utilities.alist_enter_without_values($pattern_transform_tree_bindings$.getDynamicValue(thread),
							variable, value, symbol_function(EQL)),
					thread);
			cdolist_list_var = cdolist_list_var.rest();
			binding = cdolist_list_var.first();
		}
	...
	public static SubLObject pattern_transform_cons(final SubLObject pattern, final SubLObject tree) {
		...
		for (rest_answer = NIL, rest_answer = v_answer; !rest_answer.rest().isAtom(); rest_answer = rest_answer
				.rest()) {
			rplaca(rest_answer, pattern_transform_tree_recursive(rest_answer.first(), tree));
		}
		rplaca(rest_answer, pattern_transform_tree_recursive(rest_answer.first(), tree));
			...
			destructuring_bind_must_consp(current, datum, $list_alt46);
			{
				...
				current = current.first();
				{
					...
					if (NIL == current) {
						...
						{
							SubLObject body = current;
							return listS(WITH_TREE_PATTERN_BINDINGS, listS(v_variables, formula, pattern, $list_alt48),
									append(body, NIL));
						}
					} else {
	...
	public static SubLObject declare_pattern_match_file() {
		...
		declareFunction("pattern_matches_tree_atomic_method_funcall", "PATTERN-MATCHES-TREE-ATOMIC-METHOD-FUNCALL", 2,
				0, false);
	...
	public static SubLObject setup_pattern_match_file() {
		define_test_case_table_int(PATTERN_MATCHES_TREE, list(new SubLObject[] { $TEST, symbol_function(EQUAL), $OWNER,
				NIL, $CLASSES, NIL, $KB, $TINY, $WORKING_, T }), $list57);
		return NIL;
	}
	...
	static private final SubLList $list_alt2 = list(list(makeSymbol("VARIABLES"), makeSymbol("TREE"),
			makeSymbol("PATTERN"), makeSymbol("&KEY"), makeSymbol("MATCH-METHOD")), makeSymbol("&BODY"),
			makeSymbol("BODY"));
	...
	static private final SubLList $list_alt28 = list(makeSymbol("TEST"), makeSymbol("&OPTIONAL"), makeSymbol("ARG2"),
			makeSymbol("ARG3"));

	static private final SubLList $list_alt29 = list(makeSymbol("TEST"), makeSymbol("&OPTIONAL"), makeSymbol("ARG2"),
			makeSymbol("ARG3"), makeSymbol("ARG4"));
	...
	static private final SubLList $list_alt41 = list(makeSymbol("OPERATOR"), makeSymbol("VARIABLES"),
			makeSymbol("SUBPATTERN"));

	static private final SubLList $list_alt42 = list(makeSymbol("OPERATOR"), makeSymbol("MATCH-PATTERN"),
			makeSymbol("SUBPATTERN"));

	static private final SubLList $list_alt43 = cons(makeSymbol("VARIABLE"), makeSymbol("VALUE"));

	static private final SubLList $list_alt44 = list(makeSymbol("OPERATOR"), makeSymbol("METHOD"), makeSymbol("&REST"),
			makeSymbol("METHOD-ARGS"));

	static private final SubLList $list_alt45 = list(makeSymbol("&OPTIONAL"), makeSymbol("ARG1"), makeSymbol("ARG2"),
			makeSymbol("ARG3"), makeSymbol("ARG4"));

	static private final SubLList $list_alt46 = list(
			list(makeSymbol("VARIABLES"), makeSymbol("FORMULA"), makeSymbol("PATTERN")), makeSymbol("&BODY"),
			makeSymbol("BODY"));

	static private final SubLList $list_alt48 = list(makeKeyword("MATCH-METHOD"),
			makeSymbol("FORMULA-MATCHES-PATTERN"));
}
