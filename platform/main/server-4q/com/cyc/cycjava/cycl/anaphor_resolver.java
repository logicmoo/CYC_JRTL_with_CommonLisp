...
import com.cyc.cycjava.cycl.anaphor_resolver;
...
import static com.cyc.cycjava.cycl.anaphor_resolver.*;
...
public final class anaphor_resolver extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol ANAPHOR_RESOLVER = makeSymbol("ANAPHOR-RESOLVER");



    public static final SubLList $list2 = list(makeSymbol("COREFERENCE-RESOLVER"));

    public static final SubLList $list3 = list(list(makeSymbol("NEW-DISCOURSE-EACH-RUN?"), makeKeyword("INSTANCE"), makeKeyword("VALUE"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("COREF-DISCOURSE"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NEW-DISCOURSE"), NIL, makeKeyword("PUBLIC")));





    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_ANAPHOR_RESOLVER_CLASS = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-ANAPHOR-RESOLVER-CLASS");





    public static final SubLSymbol $sym9$NEW_DISCOURSE_EACH_RUN_ = makeSymbol("NEW-DISCOURSE-EACH-RUN?");

    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_ANAPHOR_RESOLVER_INSTANCE = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-ANAPHOR-RESOLVER-INSTANCE");



    public static final SubLList $list12 = list(makeKeyword("PUBLIC"));

    public static final SubLList $list13 = list(makeSymbol("PARSE-TREES"));

    public static final SubLList $list14 = list(list(makeSymbol("PWHEN"), list(makeSymbol("COR"), makeSymbol("NEW-DISCOURSE-EACH-RUN?"), list(makeSymbol("NULL"), makeSymbol("COREF-DISCOURSE"))), list(makeSymbol("CSETQ"), makeSymbol("COREF-DISCOURSE"), list(makeSymbol("NEW-COREF-DISCOURSE")))), list(makeSymbol("RESOLVE-COREFERENCES-IN-LIST-OF-PARSE-TREES"), makeSymbol("PARSE-TREES"), makeSymbol("COREF-DISCOURSE")), list(makeSymbol("CLET"), list(list(makeSymbol("COREF-LISTS"), list(makeSymbol("COREF-DISCOURSE-COREFERRING-EXPRESSIONS"), makeSymbol("COREF-DISCOURSE"))), list(makeSymbol("COREF-WORD-LISTS"), NIL)), list(makeSymbol("DO-LIST"), list(makeSymbol("COREF-LIST"), makeSymbol("COREF-LISTS")), list(makeSymbol("CLET"), list(list(makeSymbol("COREF-WORD-LIST"), NIL)), list(makeSymbol("DO-LIST"), list(makeSymbol("PARSE-TREE"), makeSymbol("COREF-LIST")), list(makeSymbol("CLET"), list(list(makeSymbol("WORD-TREE"), list(makeSymbol("FIF"), list(makeSymbol("PHRASE-TREE-P"), makeSymbol("PARSE-TREE")), list(makeSymbol("FIM"), makeSymbol("PARSE-TREE"), list(makeSymbol("QUOTE"), makeSymbol("GET-HEAD"))), makeSymbol("PARSE-TREE")))), list(makeSymbol("CPUSH"), makeSymbol("WORD-TREE"), makeSymbol("COREF-WORD-LIST")))), list(makeSymbol("CPUSH"), list(makeSymbol("NREVERSE"), makeSymbol("COREF-WORD-LIST")), makeSymbol("COREF-WORD-LISTS")))), list(makeSymbol("RET"), list(makeSymbol("NREVERSE"), makeSymbol("COREF-WORD-LISTS")))));

    public static final SubLSymbol $sym15$OUTER_CATCH_FOR_ANAPHOR_RESOLVER_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-ANAPHOR-RESOLVER-METHOD");



    public static final SubLSymbol ANAPHOR_RESOLVER_RUN_METHOD = makeSymbol("ANAPHOR-RESOLVER-RUN-METHOD");

    public static final SubLSymbol NEW_DISCOURSE = makeSymbol("NEW-DISCOURSE");

    public static final SubLList $list19 = list(makeString("Clear out any previous discourse that this instance has been run on."), list(makeSymbol("CSETQ"), makeSymbol("COREF-DISCOURSE"), list(makeSymbol("NEW-COREF-DISCOURSE"))), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol $sym20$OUTER_CATCH_FOR_ANAPHOR_RESOLVER_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-ANAPHOR-RESOLVER-METHOD");

    public static final SubLSymbol ANAPHOR_RESOLVER_NEW_DISCOURSE_METHOD = makeSymbol("ANAPHOR-RESOLVER-NEW-DISCOURSE-METHOD");
    ...
    public static SubLObject declare_anaphor_resolver_file() {
        declareFunction(me, "get_anaphor_resolver_coref_discourse", "GET-ANAPHOR-RESOLVER-COREF-DISCOURSE", 1, 0, false);
        declareFunction(me, "set_anaphor_resolver_coref_discourse", "SET-ANAPHOR-RESOLVER-COREF-DISCOURSE", 2, 0, false);
        declareFunction(me, "get_anaphor_resolver_new_discourse_each_runP", "GET-ANAPHOR-RESOLVER-NEW-DISCOURSE-EACH-RUN?", 1, 0, false);
        declareFunction(me, "set_anaphor_resolver_new_discourse_each_runP", "SET-ANAPHOR-RESOLVER-NEW-DISCOURSE-EACH-RUN?", 2, 0, false);
        declareFunction(me, "subloop_reserved_initialize_anaphor_resolver_class", "SUBLOOP-RESERVED-INITIALIZE-ANAPHOR-RESOLVER-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_anaphor_resolver_instance", "SUBLOOP-RESERVED-INITIALIZE-ANAPHOR-RESOLVER-INSTANCE", 1, 0, false);
        declareFunction(me, "anaphor_resolver_p", "ANAPHOR-RESOLVER-P", 1, 0, false);
        declareFunction(me, "anaphor_resolver_run_method", "ANAPHOR-RESOLVER-RUN-METHOD", 2, 0, false);
        declareFunction(me, "anaphor_resolver_new_discourse_method", "ANAPHOR-RESOLVER-NEW-DISCOURSE-METHOD", 1, 0, false);
        return NIL;
    }
