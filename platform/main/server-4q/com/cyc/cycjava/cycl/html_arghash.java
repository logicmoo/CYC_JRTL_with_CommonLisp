...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class html_arghash extends SubLTranslatedFile {
    ...
    public static SubLObject arghash_type_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$arghash_type_native.class ? T : NIL;
    }

    public static SubLObject arghash_type_name(final SubLObject v_object) {
        assert NIL != arghash_type_p(v_object) : "html_arghash.arghash_type_p error :" + v_object;
    ...
    public static final class $arghash_type_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($arghash_type_native.class, ARGHASH_TYPE, ARGHASH_TYPE_P, $list3, $list4, new String[]{ "$name", "$keyword", "$character", "$string_validator", "$string_to_object_fn", "$object_detector", "$object_to_string_fn", "$priority" }, $list5, $list6, PRINT_ARGHASH_TYPE);
        }
    }
