...
import static com.cyc.cycjava.cycl.html_arghash.*;
...
public final class html_arghash extends SubLTranslatedFile {
    ...
    private static final SubLList $list4 = list(makeKeyword("NAME"), makeKeyword("KEYWORD"), makeKeyword("CHARACTER"), makeKeyword("STRING-VALIDATOR"), makeKeyword("STRING-TO-OBJECT-FN"), makeKeyword("OBJECT-DETECTOR"), makeKeyword("OBJECT-TO-STRING-FN"), makeKeyword("PRIORITY"));
    ...
    public static final SubLList $list6 = list(makeSymbol("_CSETF-ARGHASH-TYPE-NAME"), makeSymbol("_CSETF-ARGHASH-TYPE-KEYWORD"), makeSymbol("_CSETF-ARGHASH-TYPE-CHARACTER"), makeSymbol("_CSETF-ARGHASH-TYPE-STRING-VALIDATOR"), makeSymbol("_CSETF-ARGHASH-TYPE-STRING-TO-OBJECT-FN"), makeSymbol("_CSETF-ARGHASH-TYPE-OBJECT-DETECTOR"), makeSymbol("_CSETF-ARGHASH-TYPE-OBJECT-TO-STRING-FN"), makeSymbol("_CSETF-ARGHASH-TYPE-PRIORITY"));
    ...
    public static final SubLList $list9 = list(makeSymbol("OPTIMIZE-FUNCALL"), makeSymbol("ARGHASH-TYPE-P"));
    ...
    public static final SubLList $list52 = list(makeSymbol("*ARGHASH-TYPES*"), list(makeSymbol("FUNCTION"), EQUAL), list(makeSymbol("QUOTE"), makeSymbol("ARGHASH-TYPE-NAME")));

    private static final SubLSymbol $sym53$_ = makeSymbol("<");

    private static final SubLList $list54 = list(new SubLObject[]{ makeKeyword("NAME"), makeString("keyword"), makeKeyword("KEYWORD"), makeKeyword("KEYWORD"), makeKeyword("CHARACTER"), CHAR_colon, makeKeyword("STRING-VALIDATOR"), makeSymbol("STRINGP"), makeKeyword("STRING-TO-OBJECT-FN"), makeSymbol("ARGHASH-STRING-TO-KEYWORD"), makeKeyword("OBJECT-DETECTOR"), makeSymbol("KEYWORDP"), makeKeyword("OBJECT-TO-STRING-FN"), makeSymbol("ARGHASH-KEYWORD-TO-STRING"), makeKeyword("PRIORITY"), ONE_INTEGER });
    ...
    public static final SubLList $list58 = list(new SubLObject[]{ makeKeyword("NAME"), makeString("fort"), makeKeyword("KEYWORD"), makeKeyword("FORT"), makeKeyword("CHARACTER"), CHAR_dollar, makeKeyword("STRING-VALIDATOR"), makeSymbol("STRINGP"), makeKeyword("STRING-TO-OBJECT-FN"), makeSymbol("ARGHASH-STRING-TO-FORT"), makeKeyword("OBJECT-DETECTOR"), makeSymbol("FORT-P"), makeKeyword("OBJECT-TO-STRING-FN"), makeSymbol("ARGHASH-FORT-TO-STRING"), makeKeyword("PRIORITY"), TWO_INTEGER });



    public static final SubLList $list60 = list(new SubLObject[]{ makeKeyword("NAME"), makeString("assertion"), makeKeyword("KEYWORD"), makeKeyword("ASSERTION"), makeKeyword("CHARACTER"), CHAR_a, makeKeyword("STRING-VALIDATOR"), makeSymbol("NUMBER-STRING-P"), makeKeyword("STRING-TO-OBJECT-FN"), makeSymbol("ARGHASH-STRING-TO-ASSERTION"), makeKeyword("OBJECT-DETECTOR"), makeSymbol("ASSERTION-P"), makeKeyword("OBJECT-TO-STRING-FN"), makeSymbol("ARGHASH-ASSERTION-TO-STRING"), makeKeyword("PRIORITY"), TWO_INTEGER });



    public static final SubLList $list62 = list(new SubLObject[]{ makeKeyword("NAME"), makeString("integer"), makeKeyword("KEYWORD"), makeKeyword("INTEGER"), makeKeyword("CHARACTER"), CHAR_period, makeKeyword("STRING-VALIDATOR"), makeSymbol("NUMBER-STRING-P"), makeKeyword("STRING-TO-OBJECT-FN"), makeSymbol("ARGHASH-STRING-TO-INTEGER"), makeKeyword("OBJECT-DETECTOR"), makeSymbol("INTEGERP"), makeKeyword("OBJECT-TO-STRING-FN"), makeSymbol("ARGHASH-INTEGER-TO-STRING"), makeKeyword("PRIORITY"), THREE_INTEGER });



    private static final SubLList $list64 = list(new SubLObject[]{ makeKeyword("NAME"), makeString("boolean"), makeKeyword("KEYWORD"), makeKeyword("BOOLEAN"), makeKeyword("CHARACTER"), CHAR_question, makeKeyword("STRING-VALIDATOR"), NIL, makeKeyword("STRING-TO-OBJECT-FN"), makeSymbol("ARGHASH-BOOLEAN-STRING-TO-BOOLEAN"), makeKeyword("OBJECT-DETECTOR"), makeSymbol("ARGHASH-BOOLEAN-DETECTOR"), makeKeyword("OBJECT-TO-STRING-FN"), makeSymbol("ARGHASH-BOOLEAN-TO-BOOLEAN-STRING"), makeKeyword("PRIORITY"), FOUR_INTEGER });
    ...
    private static final SubLList $list69 = list(new SubLObject[]{ makeKeyword("NAME"), makeString("list"), makeKeyword("KEYWORD"), makeKeyword("LIST"), makeKeyword("CHARACTER"), CHAR_lparen, makeKeyword("STRING-VALIDATOR"), NIL, makeKeyword("STRING-TO-OBJECT-FN"), makeSymbol("ARGHASH-STRING-TO-LIST"), makeKeyword("OBJECT-DETECTOR"), makeSymbol("CONSP"), makeKeyword("OBJECT-TO-STRING-FN"), makeSymbol("ARGHASH-LIST-TO-STRING"), makeKeyword("PRIORITY"), FIVE_INTEGER });
    ...
    public static final SubLList $list80 = list(new SubLObject[]{ makeKeyword("NAME"), makeString("el-formula"), makeKeyword("KEYWORD"), makeKeyword("EL-FORMULA"), makeKeyword("CHARACTER"), CHAR_lbrace, makeKeyword("STRING-VALIDATOR"), NIL, makeKeyword("STRING-TO-OBJECT-FN"), makeSymbol("ARGHASH-STRING-TO-EL-FORMULA"), makeKeyword("OBJECT-DETECTOR"), NIL, makeKeyword("OBJECT-TO-STRING-FN"), makeSymbol("ARGHASH-EL-FORMULA-TO-STRING"), makeKeyword("PRIORITY"), makeInteger(888) });



    private static final SubLList $list82 = list(new SubLObject[]{ makeKeyword("NAME"), makeString("default"), makeKeyword("KEYWORD"), makeKeyword("DEFAULT"), makeKeyword("CHARACTER"), CHAR_underbar, makeKeyword("STRING-VALIDATOR"), makeSymbol("TRUE"), makeKeyword("STRING-TO-OBJECT-FN"), IDENTITY, makeKeyword("OBJECT-DETECTOR"), makeSymbol("TRUE"), makeKeyword("OBJECT-TO-STRING-FN"), makeSymbol("ARGHASH-DEFAULT-TO-STRING"), makeKeyword("PRIORITY"), makeInteger(999) });
    ...
    private static final SubLList $list92 = list(makeKeyword("NAME"), makeKeyword("TARGET"), makeKeyword("SCRIPT"), makeKeyword("STYLE"));
    ...
    private static final SubLList $list106 = list(makeKeyword("MULTIPLE"), makeKeyword("SIZE"), makeKeyword("SCRIPT"), makeKeyword("ONCHANGE"));
    ...
    public static SubLObject arghash_type_p(final SubLObject v_object) {
        return v_object.getClass() == html_arghash.$arghash_type_native.class ? T : NIL;
    }

    public static SubLObject arghash_type_name(final SubLObject v_object) {
        assert NIL != arghash_type_p(v_object) : "html_arghash.arghash_type_p(v_object) " + "CommonSymbols.NIL != html_arghash.arghash_type_p(v_object) " + v_object;
    ...
    public static SubLObject make_arghash_type(SubLObject arglist) {
        ...
        final SubLObject v_new = new html_arghash.$arghash_type_native();
        SubLObject next;
    ...
    public static SubLObject declare_html_arghash_file() {
        declareFunction(me, "print_arghash_type", "PRINT-ARGHASH-TYPE", 3, 0, false);
        declareFunction(me, "arghash_type_print_function_trampoline", "ARGHASH-TYPE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "arghash_type_p", "ARGHASH-TYPE-P", 1, 0, false);
        new html_arghash.$arghash_type_p$UnaryFunction();
        declareFunction(me, "arghash_type_name", "ARGHASH-TYPE-NAME", 1, 0, false);
        declareFunction(me, "arghash_type_keyword", "ARGHASH-TYPE-KEYWORD", 1, 0, false);
        declareFunction(me, "arghash_type_character", "ARGHASH-TYPE-CHARACTER", 1, 0, false);
        declareFunction(me, "arghash_type_string_validator", "ARGHASH-TYPE-STRING-VALIDATOR", 1, 0, false);
        declareFunction(me, "arghash_type_string_to_object_fn", "ARGHASH-TYPE-STRING-TO-OBJECT-FN", 1, 0, false);
        declareFunction(me, "arghash_type_object_detector", "ARGHASH-TYPE-OBJECT-DETECTOR", 1, 0, false);
        declareFunction(me, "arghash_type_object_to_string_fn", "ARGHASH-TYPE-OBJECT-TO-STRING-FN", 1, 0, false);
        declareFunction(me, "arghash_type_priority", "ARGHASH-TYPE-PRIORITY", 1, 0, false);
        declareFunction(me, "_csetf_arghash_type_name", "_CSETF-ARGHASH-TYPE-NAME", 2, 0, false);
        declareFunction(me, "_csetf_arghash_type_keyword", "_CSETF-ARGHASH-TYPE-KEYWORD", 2, 0, false);
        declareFunction(me, "_csetf_arghash_type_character", "_CSETF-ARGHASH-TYPE-CHARACTER", 2, 0, false);
        declareFunction(me, "_csetf_arghash_type_string_validator", "_CSETF-ARGHASH-TYPE-STRING-VALIDATOR", 2, 0, false);
        declareFunction(me, "_csetf_arghash_type_string_to_object_fn", "_CSETF-ARGHASH-TYPE-STRING-TO-OBJECT-FN", 2, 0, false);
        declareFunction(me, "_csetf_arghash_type_object_detector", "_CSETF-ARGHASH-TYPE-OBJECT-DETECTOR", 2, 0, false);
        declareFunction(me, "_csetf_arghash_type_object_to_string_fn", "_CSETF-ARGHASH-TYPE-OBJECT-TO-STRING-FN", 2, 0, false);
        declareFunction(me, "_csetf_arghash_type_priority", "_CSETF-ARGHASH-TYPE-PRIORITY", 2, 0, false);
        declareFunction(me, "make_arghash_type", "MAKE-ARGHASH-TYPE", 0, 1, false);
        declareFunction(me, "visit_defstruct_arghash_type", "VISIT-DEFSTRUCT-ARGHASH-TYPE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_arghash_type_method", "VISIT-DEFSTRUCT-OBJECT-ARGHASH-TYPE-METHOD", 2, 0, false);
        declareMacro(me, "defarghash_type", "DEFARGHASH-TYPE");
        declareFunction(me, "arghash_keyword_to_arghash_type", "ARGHASH-KEYWORD-TO-ARGHASH-TYPE", 1, 0, false);
        declareFunction(me, "arghash_character_to_arghash_type", "ARGHASH-CHARACTER-TO-ARGHASH-TYPE", 1, 0, false);
        declareFunction(me, "arghash_keywordP", "ARGHASH-KEYWORD?", 1, 0, false);
        declareFunction(me, "arghash_types", "ARGHASH-TYPES", 0, 0, false);
        declareFunction(me, "arghash_string_to_keyword", "ARGHASH-STRING-TO-KEYWORD", 1, 0, false);
        declareFunction(me, "arghash_keyword_to_string", "ARGHASH-KEYWORD-TO-STRING", 1, 0, false);
        declareFunction(me, "arghash_fort_to_string", "ARGHASH-FORT-TO-STRING", 1, 0, false);
        declareFunction(me, "arghash_string_to_fort", "ARGHASH-STRING-TO-FORT", 1, 0, false);
        declareFunction(me, "arghash_assertion_to_string", "ARGHASH-ASSERTION-TO-STRING", 1, 0, false);
        declareFunction(me, "arghash_string_to_assertion", "ARGHASH-STRING-TO-ASSERTION", 1, 0, false);
        declareFunction(me, "arghash_string_to_integer", "ARGHASH-STRING-TO-INTEGER", 1, 0, false);
        declareFunction(me, "arghash_integer_to_string", "ARGHASH-INTEGER-TO-STRING", 1, 0, false);
        declareFunction(me, "arghash_boolean_string_to_boolean", "ARGHASH-BOOLEAN-STRING-TO-BOOLEAN", 1, 0, false);
        declareFunction(me, "arghash_boolean_detector", "ARGHASH-BOOLEAN-DETECTOR", 1, 0, false);
        declareFunction(me, "arghash_boolean_to_boolean_string", "ARGHASH-BOOLEAN-TO-BOOLEAN-STRING", 1, 0, false);
        declareFunction(me, "arghash_prefixed_string_to_object", "ARGHASH-PREFIXED-STRING-TO-OBJECT", 1, 0, false);
        declareFunction(me, "arghash_string_to_list", "ARGHASH-STRING-TO-LIST", 1, 0, false);
        declareFunction(me, "arghash_list_to_string", "ARGHASH-LIST-TO-STRING", 1, 0, false);
        declareFunction(me, "arghash_string_to_el_formula", "ARGHASH-STRING-TO-EL-FORMULA", 1, 0, false);
        declareFunction(me, "arghash_el_formula_to_string", "ARGHASH-EL-FORMULA-TO-STRING", 1, 0, false);
        declareFunction(me, "arghash_default_to_string", "ARGHASH-DEFAULT-TO-STRING", 1, 0, false);
        declareFunction(me, "arghash_handle_string", "ARGHASH-HANDLE-STRING", 2, 0, false);
        declareFunction(me, "arghash_parse_key_and_value", "ARGHASH-PARSE-KEY-AND-VALUE", 1, 1, false);
        declareFunction(me, "arghash_get_handler_char_and_string", "ARGHASH-GET-HANDLER-CHAR-AND-STRING", 1, 1, false);
        declareFunction(me, "arghash_get_string", "ARGHASH-GET-STRING", 1, 1, false);
        declareFunction(me, "arghash_make_key_and_value_strings", "ARGHASH-MAKE-KEY-AND-VALUE-STRINGS", 2, 1, false);
        declareFunction(me, "arghash_make_key_string", "ARGHASH-MAKE-KEY-STRING", 1, 1, false);
        declareFunction(me, "exists_arghash_valueP", "EXISTS-ARGHASH-VALUE?", 2, 0, false);
        declareFunction(me, "get_arghash_value", "GET-ARGHASH-VALUE", 2, 0, false);
        declareFunction(me, "get_arghash_value_list", "GET-ARGHASH-VALUE-LIST", 2, 0, false);
        declareFunction(me, "set_arghash_value", "SET-ARGHASH-VALUE", 3, 0, false);
        declareFunction(me, "set_arghash_value_list", "SET-ARGHASH-VALUE-LIST", 3, 0, false);
        declareFunction(me, "push_arghash_value", "PUSH-ARGHASH-VALUE", 3, 0, false);
        declareFunction(me, "pushnew_arghash_value", "PUSHNEW-ARGHASH-VALUE", 3, 0, false);
        declareFunction(me, "rem_arghash_value", "REM-ARGHASH-VALUE", 2, 0, false);
        declareFunction(me, "rem_arghash_values", "REM-ARGHASH-VALUES", 2, 0, false);
        declareFunction(me, "rem_arghash_values_inverse", "REM-ARGHASH-VALUES-INVERSE", 2, 0, false);
        declareFunction(me, "new_arghash", "NEW-ARGHASH", 0, 1, false);
        declareFunction(me, "arghash_p", "ARGHASH-P", 1, 0, false);
        declareFunction(me, "copy_arghash", "COPY-ARGHASH", 1, 0, false);
        declareFunction(me, "get_arghash_keys", "GET-ARGHASH-KEYS", 1, 0, false);
        declareFunction(me, "arglist_to_arghash", "ARGLIST-TO-ARGHASH", 1, 0, false);
        declareFunction(me, "argassoc_to_arghash", "ARGASSOC-TO-ARGHASH", 1, 0, false);
        declareFunction(me, "html_arghash_href", "HTML-ARGHASH-HREF", 2, 0, false);
        declareMacro(me, "html_arghash_fancy_anchor", "HTML-ARGHASH-FANCY-ANCHOR");
        declareFunction(me, "html_arghash_checkbox_input", "HTML-ARGHASH-CHECKBOX-INPUT", 3, 2, false);
        declareFunction(me, "html_arghash_radio_input", "HTML-ARGHASH-RADIO-INPUT", 3, 0, false);
        declareFunction(me, "html_arghash_focus_radio_input", "HTML-ARGHASH-FOCUS-RADIO-INPUT", 5, 1, false);
        declareFunction(me, "html_arghash_clear_radio_input", "HTML-ARGHASH-CLEAR-RADIO-INPUT", 5, 1, false);
        declareFunction(me, "html_arghash_hidden_input", "HTML-ARGHASH-HIDDEN-INPUT", 2, 2, false);
        declareFunction(me, "html_arghash_hidden_input_force", "HTML-ARGHASH-HIDDEN-INPUT-FORCE", 3, 2, false);
        declareMacro(me, "html_arghash_fancy_select", "HTML-ARGHASH-FANCY-SELECT");
        declareMacro(me, "html_arghash_fancy_option", "HTML-ARGHASH-FANCY-OPTION");
        declareMacro(me, "html_arghash_fancy_select_with_options", "HTML-ARGHASH-FANCY-SELECT-WITH-OPTIONS");
        declareFunction(me, "html_arghash_submit_input", "HTML-ARGHASH-SUBMIT-INPUT", 3, 1, false);
        declareFunction(me, "html_arghash_clear_input_button", "HTML-ARGHASH-CLEAR-INPUT-BUTTON", 3, 1, false);
        declareFunction(me, "html_arghash_complete_button", "HTML-ARGHASH-COMPLETE-BUTTON", 3, 3, false);
        declareFunction(me, "html_arghash_text_input", "HTML-ARGHASH-TEXT-INPUT", 2, 3, false);
        declareFunction(me, "html_arghash_textarea_input", "HTML-ARGHASH-TEXTAREA-INPUT", 2, 5, false);
        declareFunction(me, "html_arghash_fort_input", "HTML-ARGHASH-FORT-INPUT", 2, 4, false);
        declareFunction(me, "html_arghash_sentence_input", "HTML-ARGHASH-SENTENCE-INPUT", 2, 6, false);
        declareFunction(me, "html_arghash_nl_fort_input", "HTML-ARGHASH-NL-FORT-INPUT", 2, 5, false);
        declareFunction(me, "html_arghash_nl_fort_input_invisible", "HTML-ARGHASH-NL-FORT-INPUT-INVISIBLE", 2, 0, false);
        declareFunction(me, "html_arghash_nl_fort_input_activeP", "HTML-ARGHASH-NL-FORT-INPUT-ACTIVE?", 2, 0, false);
        declareFunction(me, "html_arghash_nl_fort_input_doneP", "HTML-ARGHASH-NL-FORT-INPUT-DONE?", 2, 0, false);
        declareFunction(me, "html_arghash_nl_fort_input_clear", "HTML-ARGHASH-NL-FORT-INPUT-CLEAR", 2, 0, false);
        declareFunction(me, "html_arghash_nl_fort_input_force_default_if_unset", "HTML-ARGHASH-NL-FORT-INPUT-FORCE-DEFAULT-IF-UNSET", 3, 2, false);
        declareFunction(me, "html_arghash_nl_fort_list_input_set_forts", "HTML-ARGHASH-NL-FORT-LIST-INPUT-SET-FORTS", 4, 1, false);
        declareFunction(me, "html_arghash_nl_fort_input_set_fort", "HTML-ARGHASH-NL-FORT-INPUT-SET-FORT", 3, 1, false);
        declareFunction(me, "html_arghash_nl_fort_input_validate", "HTML-ARGHASH-NL-FORT-INPUT-VALIDATE", 2, 5, false);
        declareFunction(me, "html_arghash_nl_fort_list_input", "HTML-ARGHASH-NL-FORT-LIST-INPUT", 3, 6, false);
        declareFunction(me, "html_arghash_nl_fort_list_input_validate", "HTML-ARGHASH-NL-FORT-LIST-INPUT-VALIDATE", 3, 5, false);
        declareFunction(me, "arghash_fort_key_list", "ARGHASH-FORT-KEY-LIST", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $arghash_type_native extends SubLStructNative {
        ...
        public $arghash_type_native() {
            ...
            this.$character = Lisp.NIL;
            this.$string_validator = Lisp.NIL;
            this.$string_to_object_fn = Lisp.NIL;
            this.$object_detector = Lisp.NIL;
            this.$object_to_string_fn = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative(html_arghash.$arghash_type_native.class, ARGHASH_TYPE, ARGHASH_TYPE_P, $list3, $list4, new String[]{ "$name", "$keyword", "$character", "$string_validator", "$string_to_object_fn", "$object_detector", "$object_to_string_fn", "$priority" }, $list5, $list6, PRINT_ARGHASH_TYPE);
        }
    }
