...
import static com.cyc.cycjava.cycl.system_translation.*;
...
public final class system_translation extends SubLTranslatedFile {
    ...
    public static SubLObject system_translation_p(final SubLObject v_object) {
        return v_object.getClass() == system_translation.$system_translation_native.class ? T : NIL;
    }

    public static SubLObject sys_tr_system(final SubLObject v_object) {
        assert NIL != system_translation_p(v_object) : "system_translation.system_translation_p(v_object) " + "CommonSymbols.NIL != system_translation.system_translation_p(v_object) " + v_object;
    ...
    public static SubLObject make_system_translation(SubLObject arglist) {
        ...
        final SubLObject v_new = new system_translation.$system_translation_native();
        SubLObject next;
