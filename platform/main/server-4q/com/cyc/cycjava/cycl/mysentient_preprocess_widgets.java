                                                                                                                            ...
                                                                                                                            try {
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    try {
                                                                                                                                        ...
                                                                                                                                        try {
                                                                                                                                            thread.resetMultipleValues();
                                                                                                                                            {
                                                                                                                                                SubLObject best = psp_main.ps_get_cycls_for_phrase(np_string_25, cat, pred, NIL, psp_lexicon.get_default_psp_lexicon(mt, UNPROVIDED, UNPROVIDED), UNPROVIDED, UNPROVIDED);
                                                                                                                                                SubLObject rest = thread.secondMultipleValue();
                                                                                                                                                thread.resetMultipleValues();
                                                                                                                                                {
    ...
    public static final SubLObject sentence_of_type_semantics(SubLObject string, SubLObject sentence_type, SubLObject mt, SubLObject spelling_corrections, SubLObject np_strings) {
        ...
        }
        {
            ...
            if (NIL != list_utilities.lengthG(string, $sentence_of_type_semantics_length_cutoff$.getGlobalValue(), UNPROVIDED)) {
                mysentient_utilities.myselog_warn(cconcatenate($str_alt62$String_is_too_long_for_SENTENCE_O, new SubLObject[]{ format_nil.format_nil_s_no_copy($sentence_of_type_semantics_length_cutoff$.getGlobalValue()), $str_alt63$__, format_nil.$format_nil_percent$.getGlobalValue(), $str_alt64$_, format_nil.format_nil_s_no_copy(string) }));
