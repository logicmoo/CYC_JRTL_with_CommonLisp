...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class neural_net extends SubLTranslatedFile {
    ...
    public static SubLObject neural_net_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$neural_net_native.class ? T : NIL;
    }

    public static SubLObject nn_input_nodes(final SubLObject v_object) {
        assert NIL != neural_net_p(v_object) : "neural_net.neural_net_p error :" + v_object;
    ...
    public static SubLObject nn_input_node_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$nn_input_node_native.class ? T : NIL;
    }

    public static SubLObject nnin_value(final SubLObject v_object) {
        assert NIL != nn_input_node_p(v_object) : "neural_net.nn_input_node_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $neural_net_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($neural_net_native.class, NEURAL_NET, NEURAL_NET_P, $list2, $list3, new String[]{ "$input_nodes" }, $list4, $list5, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $nn_input_node_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($nn_input_node_native.class, NN_INPUT_NODE, NN_INPUT_NODE_P, $list23, $list24, new String[]{ "$value", "$weights" }, $list25, $list26, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
