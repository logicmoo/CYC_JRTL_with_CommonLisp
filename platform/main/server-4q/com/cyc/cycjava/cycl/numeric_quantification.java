...
public final class numeric_quantification
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject numeric_quantification_group_items(final SubLObject item_group, final SubLObject function)
  {
    ...
    try
    {
      ...
      if( NIL != el_utilities.el_list_p( item_group ) )
      {
        items = el_utilities.el_list_items( item_group );
      }
      else
      {
        items = quantities.evaluate_set_elements( item_group, $kw1$HL );
      }
    }
    finally
    {
  ...
  public static SubLObject numeric_quantification_item_value_tuples(final SubLObject item_group, final SubLObject function)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL != valid )
      {
        tuples = ConsesLow.cons( ConsesLow.list( item, value ), tuples );
      }
      else if( NIL == $partial_numeric_quantification$.getGlobalValue() )
      {
  ...
  {
    if( function.eql( $const2$IdentityFn ) )
    {
  ...
  public static SubLObject compute_possible_numeric_quantification_value_formula_memoized_internal(final SubLObject the_set_of_variable, final SubLObject output_argnum, final SubLObject predicate)
  {
    ...
    if( NIL != el_utilities.kappa_predicate_p( predicate ) && TWO_INTEGER.numE( el_utilities.kappa_predicate_arity( predicate ) ) )
    {
      ...
      value_formula = conses_high.subst( the_set_of_variable, kappa_input_variable, value_formula, UNPROVIDED, UNPROVIDED );
      value_formula = conses_high.subst( numeric_quant_value_variable, kappa_output_variable, value_formula, UNPROVIDED, UNPROVIDED );
      return value_formula;
    }
    if( NIL != forts.fort_p( predicate ) && NIL != arity.binaryP( predicate ) )
    {
      final SubLObject value_formula2 = el_utilities.make_binary_formula( predicate, $kw5$ARG1, $kw6$ARG2 );
  ...
  public static SubLObject compute_possible_numeric_quantification_value_formula_memoized(final SubLObject the_set_of_variable, final SubLObject output_argnum, final SubLObject predicate)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym3$COMPUTE_POSSIBLE_NUMERIC_QUANTIFICATION_VALUE_FORMULA_MEMOIZED, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym3$COMPUTE_POSSIBLE_NUMERIC_QUANTIFICATION_VALUE_FORMULA_MEMOIZED, THREE_INTEGER, NIL,
          EQUAL, UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym3$COMPUTE_POSSIBLE_NUMERIC_QUANTIFICATION_VALUE_FORMULA_MEMOIZED, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( compute_possible_numeric_quantification_value_formula_memoized_internal( the_set_of_variable, output_argnum,
        predicate ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( the_set_of_variable, output_argnum, predicate ) );
  ...
  public static SubLObject compute_the_set_of_element_to_numeric_quant_value_map_internal(final SubLObject problem, final SubLObject mt)
  {
    ...
    final SubLObject result_map = dictionary.new_dictionary( Symbols.symbol_function( EQUAL ), ZERO_INTEGER );
  ...
  public static SubLObject compute_the_set_of_element_to_numeric_quant_value_map(final SubLObject problem, final SubLObject mt)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym7$COMPUTE_THE_SET_OF_ELEMENT_TO_NUMERIC_QUANT_VALUE_MAP, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym7$COMPUTE_THE_SET_OF_ELEMENT_TO_NUMERIC_QUANT_VALUE_MAP, TWO_INTEGER, $int8$100, EQUAL,
          UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym7$COMPUTE_THE_SET_OF_ELEMENT_TO_NUMERIC_QUANT_VALUE_MAP, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( compute_the_set_of_element_to_numeric_quant_value_map_internal( problem, mt ) ) );
    memoization_state.caching_state_enter_multi_key_n( caching_state, sxhash, collisions, results3, ConsesLow.list( problem, mt ) );
    return memoization_state.caching_results( results3 );
  }
  ...
  public static SubLObject cyc_median(final SubLObject v_set, final SubLObject function)
  {
    ...
    final SubLObject middle_index = Numbers.integerDivide( total, TWO_INTEGER );
    SubLObject v_answer = NIL;
    values = Sort.sort( values, $sym14$CYC_LESS_THAN, UNPROVIDED );
    if( total.isZero() )
    {
      relation_evaluation.throw_unevaluatable();
    }
    else if( NIL != Numbers.oddp( total ) )
    {
  ...
  public static SubLObject possibly_optimize_tuples_wrt_compare_pred(SubLObject tuples, final SubLObject compare_pred)
  {
    ...
    {
      tuples = list_utilities.nmapcar( $sym19$NSIMPLIFY_NUMERIC_QUANTIFICATION_TUPLE_QUANTITY_VALUE, tuples );
    }
    return tuples;
  }
  ...
  public static SubLObject tuple_values_all_are_simply_uniform_quantitiesP(final SubLObject tuples)
  {
    if( NIL != tuples )
    {
      ...
      cdestructuring_bind.destructuring_bind_must_consp( tuples, tuples, $list20 );
      ...
      if( NIL != el_utilities.el_unary_formula_p( first_value ) && cycl_utilities.formula_arg1( first_value, UNPROVIDED ).isNumber() )
      {
        ...
        if( NIL != collection_defns.unit_of_measureP( unit, UNPROVIDED ) )
        {
          ...
          if( NIL == witness )
          {
            ...
            while ( NIL == witness && NIL != csome_list_var)
            {
              ...
              if( NIL == el_utilities.el_unary_formula_p( other_value ) || !unit.equal( cycl_utilities.formula_operator( other_value ) ) || !cycl_utilities.formula_arg1( other_value, UNPROVIDED ).isNumber() )
              {
                witness = other_value;
              }
  ...
  public static SubLObject nsimplify_numeric_quantification_tuple_quantity_value(final SubLObject tuple)
  {
    ...
    ConsesLow.set_nth( ONE_INTEGER, tuple, number );
    return tuple;
  }
  ...
  public static SubLObject cyc_sort_item_group(final SubLObject item_group, final SubLObject compare_pred, final SubLObject function, final SubLObject stableP)
  {
    ...
    final SubLObject sorted_items = Mapping.mapcar( Symbols.symbol_function( $sym23$FIRST ), sorted_tuples );
    return el_utilities.make_el_list( sorted_items, UNPROVIDED );
  }
  ...
  public static SubLObject cyc_sort_item_group_tuples(SubLObject tuples, final SubLObject compare_pred, final SubLObject stableP)
  {
    ...
    try
    {
      ...
      {
        tuples = kb_utilities.sort_terms( tuples, NIL, NIL, T, NIL, Symbols.symbol_function( $sym23$FIRST ), UNPROVIDED );
      }
      tuples = Sort.stable_sort( tuples, $sym26$CYC_SORT__, Symbols.symbol_function( $sym27$SECOND ) );
    }
    finally
    {
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( compare_pred.eql( $const28$greaterThan ) )
    {
      return arithmetic.cyc_greater_than( term1, term2 );
    }
    if( compare_pred.eql( $const29$lessThan ) )
    {
  ...
  public static SubLObject numeric_quantification_compare_recursive_query(final SubLObject sentence, SubLObject mt, SubLObject query_properties)
  {
    ...
    caching_state = memoization_state.memoization_state_lookup( v_memoization_state, $sym31$NUMERIC_QUANTIFICATION_COMPARE_RECURSIVE_QUERY, UNPROVIDED );
    if( NIL == caching_state )
    {
      caching_state = memoization_state.create_caching_state( memoization_state.memoization_state_lock( v_memoization_state ), $sym31$NUMERIC_QUANTIFICATION_COMPARE_RECURSIVE_QUERY, THREE_INTEGER, $int32$8096, EQUAL,
          UNPROVIDED );
      memoization_state.memoization_state_put( v_memoization_state, $sym31$NUMERIC_QUANTIFICATION_COMPARE_RECURSIVE_QUERY, caching_state );
    }
    ...
    final SubLObject results3 = Values.arg2( thread.resetMultipleValues(), Values.multiple_value_list( numeric_quantification_compare_recursive_query_internal( sentence, mt, query_properties ) ) );
  ...
  {
    return cyc_sort( v_set, compare_pred, $const2$IdentityFn );
  }

  public static SubLObject declare_numeric_quantification_file()
  {
    SubLFiles.declareFunction( me, "numeric_evaluate_all_unary", "NUMERIC-EVALUATE-ALL-UNARY", 2, 0, false );
    SubLFiles.declareFunction( me, "numeric_quantification_group_items", "NUMERIC-QUANTIFICATION-GROUP-ITEMS", 2, 0, false );
    SubLFiles.declareFunction( me, "numeric_quantification_item_value_tuples", "NUMERIC-QUANTIFICATION-ITEM-VALUE-TUPLES", 2, 0, false );
    SubLFiles.declareFunction( me, "numeric_quantification_item_values", "NUMERIC-QUANTIFICATION-ITEM-VALUES", 2, 0, false );
    SubLFiles.declareFunction( me, "numeric_quantification_apply_function", "NUMERIC-QUANTIFICATION-APPLY-FUNCTION", 2, 0, false );
    SubLFiles.declareFunction( me, "numeric_quantification_item_value_via_generalized_query", "NUMERIC-QUANTIFICATION-ITEM-VALUE-VIA-GENERALIZED-QUERY", 2, 0, false );
    SubLFiles.declareFunction( me, "compute_possible_numeric_quantification_value_formula", "COMPUTE-POSSIBLE-NUMERIC-QUANTIFICATION-VALUE-FORMULA", 1, 0, false );
    SubLFiles.declareFunction( me, "compute_possible_numeric_quantification_value_formula_memoized_internal", "COMPUTE-POSSIBLE-NUMERIC-QUANTIFICATION-VALUE-FORMULA-MEMOIZED-INTERNAL", 3, 0, false );
    SubLFiles.declareFunction( me, "compute_possible_numeric_quantification_value_formula_memoized", "COMPUTE-POSSIBLE-NUMERIC-QUANTIFICATION-VALUE-FORMULA-MEMOIZED", 3, 0, false );
    SubLFiles.declareFunction( me, "the_set_of_element_value_via_generalized_query", "THE-SET-OF-ELEMENT-VALUE-VIA-GENERALIZED-QUERY", 1, 2, false );
    SubLFiles.declareFunction( me, "compute_the_set_of_element_to_numeric_quant_value_map_internal", "COMPUTE-THE-SET-OF-ELEMENT-TO-NUMERIC-QUANT-VALUE-MAP-INTERNAL", 2, 0, false );
    SubLFiles.declareFunction( me, "compute_the_set_of_element_to_numeric_quant_value_map", "COMPUTE-THE-SET-OF-ELEMENT-TO-NUMERIC-QUANT-VALUE-MAP", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_plus_all", "CYC-PLUS-ALL", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_plus_all_internal", "CYC-PLUS-ALL-INTERNAL", 1, 0, false );
    SubLFiles.declareFunction( me, "cyc_times_all", "CYC-TIMES-ALL", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_maximum", "CYC-MAXIMUM", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_minimum", "CYC-MINIMUM", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_average", "CYC-AVERAGE", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_median", "CYC-MEDIAN", 2, 0, false );
    SubLFiles.declareFunction( me, "cyc_extreme_member", "CYC-EXTREME-MEMBER", 3, 0, false );
    SubLFiles.declareFunction( me, "possibly_optimize_tuples_wrt_compare_pred", "POSSIBLY-OPTIMIZE-TUPLES-WRT-COMPARE-PRED", 2, 0, false );
    SubLFiles.declareFunction( me, "tuple_values_all_are_simply_uniform_quantitiesP", "TUPLE-VALUES-ALL-ARE-SIMPLY-UNIFORM-QUANTITIES?", 1, 0, false );
    SubLFiles.declareFunction( me, "nsimplify_numeric_quantification_tuple_quantity_value", "NSIMPLIFY-NUMERIC-QUANTIFICATION-TUPLE-QUANTITY-VALUE", 1, 0, false );
    SubLFiles.declareFunction( me, "cyc_sort", "CYC-SORT", 3, 0, false );
    SubLFiles.declareFunction( me, "cyc_stable_sort", "CYC-STABLE-SORT", 3, 0, false );
    SubLFiles.declareFunction( me, "cyc_sort_item_group", "CYC-SORT-ITEM-GROUP", 4, 0, false );
    SubLFiles.declareFunction( me, "cyc_sort_fn", "CYC-SORT-FN", 3, 0, false );
    SubLFiles.declareFunction( me, "cyc_sort_item_group_tuples", "CYC-SORT-ITEM-GROUP-TUPLES", 3, 0, false );
    SubLFiles.declareFunction( me, "cyc_sort_L", "CYC-SORT-<", 2, 0, false );
    SubLFiles.declareFunction( me, "numeric_quantification_compare", "NUMERIC-QUANTIFICATION-COMPARE", 3, 0, false );
    SubLFiles.declareFunction( me, "numeric_quantification_compare_recursive_query_internal", "NUMERIC-QUANTIFICATION-COMPARE-RECURSIVE-QUERY-INTERNAL", 1, 2, false );
    SubLFiles.declareFunction( me, "numeric_quantification_compare_recursive_query", "NUMERIC-QUANTIFICATION-COMPARE-RECURSIVE-QUERY", 1, 2, false );
    SubLFiles.declareFunction( me, "cyc_sort_set_via_bin_pred_fn", "CYC-SORT-SET-VIA-BIN-PRED-FN", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_numeric_quantification_file()
  {
    $partial_numeric_quantification$ = SubLFiles.deflexical( "*PARTIAL-NUMERIC-QUANTIFICATION*", T );
    $numeric_quantification_function$ = SubLFiles.defparameter( "*NUMERIC-QUANTIFICATION-FUNCTION*", NIL );
    $cyc_sort_compare_pred$ = SubLFiles.defparameter( "*CYC-SORT-COMPARE-PRED*", NIL );
    return NIL;
  }

  public static SubLObject setup_numeric_quantification_file()
  {
    memoization_state.note_memoized_function( $sym3$COMPUTE_POSSIBLE_NUMERIC_QUANTIFICATION_VALUE_FORMULA_MEMOIZED );
    memoization_state.note_memoized_function( $sym7$COMPUTE_THE_SET_OF_ELEMENT_TO_NUMERIC_QUANT_VALUE_MAP );
    utilities_macros.register_kb_function( $sym9$CYC_PLUS_ALL );
    utilities_macros.register_kb_function( $sym10$CYC_TIMES_ALL );
    utilities_macros.register_kb_function( $sym11$CYC_MAXIMUM );
    utilities_macros.register_kb_function( $sym12$CYC_MINIMUM );
    utilities_macros.register_kb_function( $sym13$CYC_AVERAGE );
    utilities_macros.register_kb_function( $sym15$CYC_MEDIAN );
    utilities_macros.register_kb_function( $sym17$CYC_EXTREME_MEMBER );
    utilities_macros.note_funcall_helper_function( $sym19$NSIMPLIFY_NUMERIC_QUANTIFICATION_TUPLE_QUANTITY_VALUE );
    utilities_macros.register_kb_function( $sym21$CYC_SORT );
    utilities_macros.register_kb_function( $sym22$CYC_STABLE_SORT );
    access_macros.define_obsolete_register( $sym24$CYC_SORT_FN, $list25 );
    utilities_macros.note_funcall_helper_function( $sym26$CYC_SORT__ );
    memoization_state.note_memoized_function( $sym31$NUMERIC_QUANTIFICATION_COMPARE_RECURSIVE_QUERY );
    utilities_macros.register_kb_function( $sym33$CYC_SORT_SET_VIA_BIN_PRED_FN );
    return NIL;
  }
  ...
  static
  {
    me = new numeric_quantification();
    $partial_numeric_quantification$ = null;
    $numeric_quantification_function$ = null;
    $cyc_sort_compare_pred$ = null;
    ...
    $const2$IdentityFn = constant_handles.reader_make_constant_shell( makeString( "IdentityFn" ) );
    $sym3$COMPUTE_POSSIBLE_NUMERIC_QUANTIFICATION_VALUE_FORMULA_MEMOIZED = makeSymbol( "COMPUTE-POSSIBLE-NUMERIC-QUANTIFICATION-VALUE-FORMULA-MEMOIZED" );
    $sym4$_NQVAL = makeSymbol( "?NQVAL" );
    $kw5$ARG1 = makeKeyword( "ARG1" );
    $kw6$ARG2 = makeKeyword( "ARG2" );
    $sym7$COMPUTE_THE_SET_OF_ELEMENT_TO_NUMERIC_QUANT_VALUE_MAP = makeSymbol( "COMPUTE-THE-SET-OF-ELEMENT-TO-NUMERIC-QUANT-VALUE-MAP" );
    $int8$100 = makeInteger( 100 );
    $sym9$CYC_PLUS_ALL = makeSymbol( "CYC-PLUS-ALL" );
    $sym10$CYC_TIMES_ALL = makeSymbol( "CYC-TIMES-ALL" );
    $sym11$CYC_MAXIMUM = makeSymbol( "CYC-MAXIMUM" );
    $sym12$CYC_MINIMUM = makeSymbol( "CYC-MINIMUM" );
    $sym13$CYC_AVERAGE = makeSymbol( "CYC-AVERAGE" );
    $sym14$CYC_LESS_THAN = makeSymbol( "CYC-LESS-THAN" );
    $sym15$CYC_MEDIAN = makeSymbol( "CYC-MEDIAN" );
    $list16 = ConsesLow.list( makeSymbol( "CANDIDATE-ITEM" ), makeSymbol( "CANDIDATE-VALUE" ) );
    $sym17$CYC_EXTREME_MEMBER = makeSymbol( "CYC-EXTREME-MEMBER" );
    $list18 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "greaterThan" ) ), constant_handles.reader_make_constant_shell( makeString( "lessThan" ) ) );
    $sym19$NSIMPLIFY_NUMERIC_QUANTIFICATION_TUPLE_QUANTITY_VALUE = makeSymbol( "NSIMPLIFY-NUMERIC-QUANTIFICATION-TUPLE-QUANTITY-VALUE" );
    $list20 = ConsesLow.cons( makeSymbol( "FIRST-TUPLE" ), makeSymbol( "REST-TUPLES" ) );
    $sym21$CYC_SORT = makeSymbol( "CYC-SORT" );
    $sym22$CYC_STABLE_SORT = makeSymbol( "CYC-STABLE-SORT" );
    $sym23$FIRST = makeSymbol( "FIRST" );
    $sym24$CYC_SORT_FN = makeSymbol( "CYC-SORT-FN" );
    $list25 = ConsesLow.list( makeSymbol( "CYC-SORT" ) );
    $sym26$CYC_SORT__ = makeSymbol( "CYC-SORT-<" );
    $sym27$SECOND = makeSymbol( "SECOND" );
    $const28$greaterThan = constant_handles.reader_make_constant_shell( makeString( "greaterThan" ) );
    $const29$lessThan = constant_handles.reader_make_constant_shell( makeString( "lessThan" ) );
    $sym30$_EXIT = makeSymbol( "%EXIT" );
    $sym31$NUMERIC_QUANTIFICATION_COMPARE_RECURSIVE_QUERY = makeSymbol( "NUMERIC-QUANTIFICATION-COMPARE-RECURSIVE-QUERY" );
    $int32$8096 = makeInteger( 8096 );
    $sym33$CYC_SORT_SET_VIA_BIN_PRED_FN = makeSymbol( "CYC-SORT-SET-VIA-BIN-PRED-FN" );
  }
}
