...
public final class rewrite_of_propagation extends SubLTranslatedFile {
    ...
    public static final SubLSymbol REWRITE_OF_AFTER_ADDING = makeSymbol("REWRITE-OF-AFTER-ADDING");



    private static final SubLObject $$EverythingPSC = reader_make_constant_shell(makeString("EverythingPSC"));

    public static final SubLSymbol PROPAGATE_REWRITE_OF_ASSERTION = makeSymbol("PROPAGATE-REWRITE-OF-ASSERTION");

    public static final SubLSymbol FORT_WITH_SOME_SOURCE_REWRITE_OF_ASSERTIONS = makeSymbol("FORT-WITH-SOME-SOURCE-REWRITE-OF-ASSERTIONS");
    ...
    public static SubLObject propagate_assertion_via_rewrite_of(final SubLObject assertion, SubLObject source, final SubLObject target, final SubLObject rewrite_of_assertion) {
        ...
        assert NIL != assertion_handles.assertion_p(rewrite_of_assertion) : "assertion_handles.assertion_p(rewrite_of_assertion) " + "CommonSymbols.NIL != assertion_handles.assertion_p(rewrite_of_assertion) " + rewrite_of_assertion;
    ...
    public static SubLObject declare_rewrite_of_propagation_file() {
        declareFunction(me, "rewrite_of_after_adding", "REWRITE-OF-AFTER-ADDING", 2, 0, false);
        declareFunction(me, "rewrite_of_after_adding_internal", "REWRITE-OF-AFTER-ADDING-INTERNAL", 3, 0, false);
        declareFunction(me, "propagate_rewrite_of_assertion", "PROPAGATE-REWRITE-OF-ASSERTION", 1, 0, false);
        declareFunction(me, "perform_rewrite_of_propagation", "PERFORM-REWRITE-OF-PROPAGATION", 1, 0, false);
        declareFunction(me, "perform_rewrite_of_propagation_internal", "PERFORM-REWRITE-OF-PROPAGATION-INTERNAL", 2, 0, false);
        declareFunction(me, "fort_with_some_source_rewrite_of_assertions", "FORT-WITH-SOME-SOURCE-REWRITE-OF-ASSERTIONS", 1, 0, false);
        new rewrite_of_propagation.$fort_with_some_source_rewrite_of_assertions$UnaryFunction();
        declareFunction(me, "propagate_assertion_via_rewrite_of", "PROPAGATE-ASSERTION-VIA-REWRITE-OF", 4, 0, false);
        declareFunction(me, "should_propagate_rewrite_of_cnf", "SHOULD-PROPAGATE-REWRITE-OF-CNF", 3, 0, false);
        declareFunction(me, "note_should_propagate_rewrite_of_cnf", "NOTE-SHOULD-PROPAGATE-REWRITE-OF-CNF", 0, 0, false);
        declareFunction(me, "propagate_rewrite_of_cnf", "PROPAGATE-REWRITE-OF-CNF", 3, 0, false);
        declareFunction(me, "propagate_rewrite_of_cnf_internal", "PROPAGATE-REWRITE-OF-CNF-INTERNAL", 4, 0, false);
        declareFunction(me, "propagate_rewrite_of_atomic_sentence", "PROPAGATE-REWRITE-OF-ATOMIC-SENTENCE", 4, 0, false);
        declareFunction(me, "determine_propagate_rewrite_of_mt", "DETERMINE-PROPAGATE-REWRITE-OF-MT", 2, 0, false);
        return NIL;
    }
