...
import static com.cyc.cycjava.cycl.evaluation_defns.*;
...
public final class evaluation_defns extends SubLTranslatedFile {
    ...
    public static final SubLSymbol CYC_TRUE_SUBL = makeSymbol("CYC-TRUE-SUBL");



    public static final SubLSymbol CYC_DIFFERENT = makeSymbol("CYC-DIFFERENT");

    public static final SubLSymbol CYC_DIFFERENT_SYMBOLS = makeSymbol("CYC-DIFFERENT-SYMBOLS");
    ...
    public static final SubLList $list80 = list(new SubLObject[]{ makeSymbol("&KEY"), makeSymbol("ID"), makeSymbol("CLASS"), makeSymbol("ISMAP"), makeSymbol("HEIGHT"), makeSymbol("WIDTH"), makeSymbol("ALT"), makeSymbol("ALIGN"), makeSymbol("BORDER") });

    public static final SubLList $list81 = list(makeKeyword("ID"), makeKeyword("CLASS"), makeKeyword("ISMAP"), makeKeyword("HEIGHT"), makeKeyword("WIDTH"), makeKeyword("ALT"), makeKeyword("ALIGN"), makeKeyword("BORDER"));
    ...
    private static final SubLList $list124 = list(reader_make_constant_shell(makeString("SubLQuoteFn")), makeKeyword("ANYTHING"));

    private static final SubLList $list125 = list(reader_make_constant_shell(makeString("Percent")), makeKeyword("ANYTHING"));
    ...
    private static final SubLObject $$SymmetricAnatomicalPartType = reader_make_constant_shell(makeString("SymmetricAnatomicalPartType"));

    private static final SubLObject $$LeftObjectOfPairFn = reader_make_constant_shell(makeString("LeftObjectOfPairFn"));
    ...
    private static final SubLObject $$RightObjectOfPairFn = reader_make_constant_shell(makeString("RightObjectOfPairFn"));
    ...
    private static final SubLObject $$creationTemplateMt = reader_make_constant_shell(makeString("creationTemplateMt"));



    private static final SubLObject $const188$creationTemplateConstantNameForma = reader_make_constant_shell(makeString("creationTemplateConstantNameFormat"));

    private static final SubLObject $$creationTemplateSentenceTemplate = reader_make_constant_shell(makeString("creationTemplateSentenceTemplate"));
    ...
    private static final SubLObject $$IndividualDenotingFunction = reader_make_constant_shell(makeString("IndividualDenotingFunction"));
    ...
    private static final SubLSymbol $sym204$_USE_NEW_NL_GENERATION_API_FOR_GENERATE_PHRASE_FN__ = makeSymbol("*USE-NEW-NL-GENERATION-API-FOR-GENERATE-PHRASE-FN?*");
    ...
    private static final SubLSymbol $sym222$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__ = makeSymbol("*APPEND-STACK-TRACES-TO-ERROR-MESSAGES?*");
    ...
    private static final SubLObject $$CanadianProvince = reader_make_constant_shell(makeString("CanadianProvince"));
    ...
    public static final SubLList $list266 = list(makeKeyword("ALLOWED-MODULES"), list(makeKeyword("NOT"), list(makeKeyword("MODULE-SUBTYPE"), makeKeyword("SKSI"))));
    ...
    private static final SubLObject $$orderingRelation = reader_make_constant_shell(makeString("orderingRelation"));
    ...
    private static final SubLObject $$AssertionGeneratingRKFTool = reader_make_constant_shell(makeString("AssertionGeneratingRKFTool"));
    ...
    private static final SubLObject $$LinkParser = reader_make_constant_shell(makeString("LinkParser"));
    ...
    private static final SubLObject $const316$WordNet2_0_KS = reader_make_constant_shell(makeString("WordNet2_0-KS"));
    ...
    private static final SubLObject $$KAObjectInteractionFn = reader_make_constant_shell(makeString("KAObjectInteractionFn"));
    ...
    private static final SubLObject $$laterOrSameInteractionHistoryMt = reader_make_constant_shell(makeString("laterOrSameInteractionHistoryMt"));

    private static final SubLObject $$laterInteractionHistoryMt = reader_make_constant_shell(makeString("laterInteractionHistoryMt"));

    private static final SubLObject $$laterInteractionHistoryMt_Direct = reader_make_constant_shell(makeString("laterInteractionHistoryMt-Direct"));

    private static final SubLObject $const343$laterInteractionHistoryMtForSimul = reader_make_constant_shell(makeString("laterInteractionHistoryMtForSimulatedAgent-Direct"));
    ...
    private static final SubLObject $const345$executionOfPlannedEventBeginsInCo = reader_make_constant_shell(makeString("executionOfPlannedEventBeginsInContext"));

    private static final SubLObject $$performedByInBELLAUI = reader_make_constant_shell(makeString("performedByInBELLAUI"));

    private static final SubLObject $$executionOfPlannedEvent = reader_make_constant_shell(makeString("executionOfPlannedEvent"));

    private static final SubLObject $$finishedEvent = reader_make_constant_shell(makeString("finishedEvent"));

    private static final SubLObject $$mistakenEvent = reader_make_constant_shell(makeString("mistakenEvent"));
    ...
    private static final SubLObject $const353$agentShouldAttemptToFindModelForE = reader_make_constant_shell(makeString("agentShouldAttemptToFindModelForEventInInteractionContext"));
    ...
    private static final SubLObject $$interactionContextAbandonedAtDate = reader_make_constant_shell(makeString("interactionContextAbandonedAtDate"));



    private static final SubLObject $$eventModeledByPlannedByAtDate = reader_make_constant_shell(makeString("eventModeledByPlannedByAtDate"));

    private static final SubLObject $$startedInMt = reader_make_constant_shell(makeString("startedInMt"));

    private static final SubLObject $$finishedInMt = reader_make_constant_shell(makeString("finishedInMt"));

    private static final SubLObject $$mistakenInMt = reader_make_constant_shell(makeString("mistakenInMt"));

    private static final SubLObject $$agentAgenda = reader_make_constant_shell(makeString("agentAgenda"));
    ...
    private static final SubLObject $$agendaHasTaskWithPriority = reader_make_constant_shell(makeString("agendaHasTaskWithPriority"));
    ...
    private static final SubLObject $const372$agentToDoMtAndHistoryCoincideAtDa = reader_make_constant_shell(makeString("agentToDoMtAndHistoryCoincideAtDate"));
    ...
    public static SubLObject paraphrase_of_formula_from_template_defn(final SubLObject formula, final SubLObject assertion) {
        ...
        try {
            ...
            try {
                Errors.$error_handler$.bind(CATCH_ERROR_MESSAGE_HANDLER, thread);
                try {
                    final SubLObject was_appendingP = eval($sym222$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__);
                    eval($list223);
                    try {
                        ...
                        try {
                            ...
                            eval(list(CSETQ, $sym222$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__, was_appendingP));
    ...
    public static SubLObject types_most_often_asserted_using_tool(final SubLObject tool, SubLObject result_length, SubLObject exclude_list, SubLObject exclude_if_not_list) {
        ...
        assert NIL != assertion_generating_tool_p(tool) : "evaluation_defns.assertion_generating_tool_p(tool) " + "CommonSymbols.NIL != evaluation_defns.assertion_generating_tool_p(tool) " + tool;
        assert NIL != subl_promotions.non_negative_integer_p(result_length) : "subl_promotions.non_negative_integer_p(result_length) " + "CommonSymbols.NIL != subl_promotions.non_negative_integer_p(result_length) " + result_length;
        assert NIL != list_utilities.non_dotted_list_p(exclude_list) : "list_utilities.non_dotted_list_p(exclude_list) " + "CommonSymbols.NIL != list_utilities.non_dotted_list_p(exclude_list) " + exclude_list;
        assert NIL != list_utilities.non_dotted_list_p(exclude_if_not_list) : "list_utilities.non_dotted_list_p(exclude_if_not_list) " + "CommonSymbols.NIL != list_utilities.non_dotted_list_p(exclude_if_not_list) " + exclude_if_not_list;
    ...
    public static SubLObject declare_evaluation_defns_file() {
        declareFunction(me, "evaluatable_predicate_count", "EVALUATABLE-PREDICATE-COUNT", 0, 0, false);
        declareFunction(me, "cyc_true_subl", "CYC-TRUE-SUBL", 1, 0, false);
        declareFunction(me, "cyc_different", "CYC-DIFFERENT", 1, 0, false);
        new evaluation_defns.$cyc_different$UnaryFunction();
        declareFunction(me, "cyc_different_symbols", "CYC-DIFFERENT-SYMBOLS", 1, 0, false);
        declareFunction(me, "cyc_string_precedes", "CYC-STRING-PRECEDES", 2, 0, false);
        declareFunction(me, "cyc_string_precedes_case_insensitive", "CYC-STRING-PRECEDES-CASE-INSENSITIVE", 2, 0, false);
        declareFunction(me, "cyc_string_precedes_internal", "CYC-STRING-PRECEDES-INTERNAL", 3, 0, false);
        declareFunction(me, "cyc_substring_predicate", "CYC-SUBSTRING-PREDICATE", 2, 0, false);
        declareFunction(me, "cyc_substring_case_insensitive_predicate", "CYC-SUBSTRING-CASE-INSENSITIVE-PREDICATE", 2, 0, false);
        declareFunction(me, "cyc_substring_predicate_internal", "CYC-SUBSTRING-PREDICATE-INTERNAL", 3, 0, false);
        declareFunction(me, "cyc_prefix_substring", "CYC-PREFIX-SUBSTRING", 2, 0, false);
        declareFunction(me, "cyc_suffix_substring", "CYC-SUFFIX-SUBSTRING", 2, 0, false);
        declareFunction(me, "cyc_subword_predicate", "CYC-SUBWORD-PREDICATE", 2, 0, false);
        declareFunction(me, "cyc_find_constant", "CYC-FIND-CONSTANT", 1, 0, false);
        declareFunction(me, "evaluatable_function_count", "EVALUATABLE-FUNCTION-COUNT", 0, 0, false);
        declareFunction(me, "cyc_evaluate_subl", "CYC-EVALUATE-SUBL", 1, 0, false);
        declareFunction(me, "cyc_string_upcase", "CYC-STRING-UPCASE", 1, 0, false);
        declareFunction(me, "string_upcase_defn", "STRING-UPCASE-DEFN", 1, 0, false);
        declareFunction(me, "cyc_string_downcase", "CYC-STRING-DOWNCASE", 1, 0, false);
        declareFunction(me, "cyc_substring", "CYC-SUBSTRING", 3, 0, false);
        declareFunction(me, "cyc_string_concat", "CYC-STRING-CONCAT", 1, 0, false);
        declareFunction(me, "cyc_strings_to_phrase", "CYC-STRINGS-TO-PHRASE", 1, 0, false);
        declareFunction(me, "cyc_pre_remove", "CYC-PRE-REMOVE", 2, 0, false);
        declareFunction(me, "cyc_replace_substring", "CYC-REPLACE-SUBSTRING", 3, 0, false);
        declareFunction(me, "unicode_naut_or_ascii_string_p", "UNICODE-NAUT-OR-ASCII-STRING-P", 1, 0, false);
        declareFunction(me, "cyc_unique_ws", "CYC-UNIQUE-WS", 3, 0, false);
        declareFunction(me, "generate_names_for_term", "GENERATE-NAMES-FOR-TERM", 1, 0, false);
        declareFunction(me, "cyc_remove_substring", "CYC-REMOVE-SUBSTRING", 2, 0, false);
        declareFunction(me, "cyc_post_remove", "CYC-POST-REMOVE", 2, 0, false);
        declareFunction(me, "cyc_trim_whitespace", "CYC-TRIM-WHITESPACE", 1, 0, false);
        declareFunction(me, "cyc_string_search", "CYC-STRING-SEARCH", 2, 0, false);
        declareFunction(me, "cyc_length", "CYC-LENGTH", 1, 0, false);
        declareFunction(me, "cyc_string_to_integer", "CYC-STRING-TO-INTEGER", 1, 0, false);
        declareFunction(me, "cyc_integral_number_to_integer", "CYC-INTEGRAL-NUMBER-TO-INTEGER", 1, 0, false);
        declareFunction(me, "cyc_integer_to_string", "CYC-INTEGER-TO-STRING", 1, 0, false);
        declareFunction(me, "cyc_stringify_fn", "CYC-STRINGIFY-FN", 1, 0, false);
        declareFunction(me, "cyc_syntactic_disquotation", "CYC-SYNTACTIC-DISQUOTATION", 1, 0, false);
        declareFunction(me, "identify_pattern", "IDENTIFY-PATTERN", 1, 0, false);
        declareFunction(me, "cyc_string_to_real_number", "CYC-STRING-TO-REAL-NUMBER", 1, 0, false);
        declareFunction(me, "cyc_real_number_to_string", "CYC-REAL-NUMBER-TO-STRING", 1, 0, false);
        declareFunction(me, "max_supported_formula_arity", "MAX-SUPPORTED-FORMULA-ARITY", 0, 0, false);
        declareFunction(me, "cyc_string_tokenize", "CYC-STRING-TOKENIZE", 2, 0, false);
        declareFunction(me, "cyc_string_to_nth_code_point", "CYC-STRING-TO-NTH-CODE-POINT", 2, 0, false);
        declareFunction(me, "cyc_http_url_encode", "CYC-HTTP-URL-ENCODE", 1, 0, false);
        declareFunction(me, "cyc_xml_value_string", "CYC-XML-VALUE-STRING", 3, 0, false);
        declareFunction(me, "cyc_http_url_decode", "CYC-HTTP-URL-DECODE", 1, 0, false);
        declareFunction(me, "cyc_acronym_from_string", "CYC-ACRONYM-FROM-STRING", 1, 0, false);
        declareFunction(me, "cyc_html_image", "CYC-HTML-IMAGE", 2, 0, false);
        declareFunction(me, "html_image_plist", "HTML-IMAGE-PLIST", 1, 0, false);
        declareFunction(me, "cyc_html_table_data", "CYC-HTML-TABLE-DATA", 2, 0, false);
        declareFunction(me, "cyc_html_table_data_variable_arity", "CYC-HTML-TABLE-DATA-VARIABLE-ARITY", 1, 0, false);
        declareFunction(me, "html_table_data_plist", "HTML-TABLE-DATA-PLIST", 1, 0, false);
        declareFunction(me, "cyc_html_table_row", "CYC-HTML-TABLE-ROW", 2, 0, false);
        declareFunction(me, "cyc_html_table_row_variable_arity", "CYC-HTML-TABLE-ROW-VARIABLE-ARITY", 1, 0, false);
        declareFunction(me, "html_table_row_plist", "HTML-TABLE-ROW-PLIST", 1, 0, false);
        declareFunction(me, "cyc_html_table", "CYC-HTML-TABLE", 2, 0, false);
        declareFunction(me, "cyc_html_table_variable_arity", "CYC-HTML-TABLE-VARIABLE-ARITY", 1, 0, false);
        declareFunction(me, "html_table_plist", "HTML-TABLE-PLIST", 1, 0, false);
        declareFunction(me, "cyc_html_division", "CYC-HTML-DIVISION", 2, 0, false);
        declareFunction(me, "cyc_html_division_variable_arity", "CYC-HTML-DIVISION-VARIABLE-ARITY", 1, 0, false);
        declareFunction(me, "output_html_division_content", "OUTPUT-HTML-DIVISION-CONTENT", 1, 0, false);
        declareFunction(me, "html_division_plist", "HTML-DIVISION-PLIST", 1, 0, false);
        declareFunction(me, "decode_html_option", "DECODE-HTML-OPTION", 1, 0, false);
        declareFunction(me, "parse_html_attribute", "PARSE-HTML-ATTRIBUTE", 1, 0, false);
        declareFunction(me, "parse_html_attribute_value", "PARSE-HTML-ATTRIBUTE-VALUE", 1, 0, false);
        declareFunction(me, "cyc_contextual_url", "CYC-CONTEXTUAL-URL", 2, 0, false);
        declareFunction(me, "url_string", "URL-STRING", 1, 0, false);
        declareFunction(me, "cyc_term_from_sparql_uri", "CYC-TERM-FROM-SPARQL-URI", 1, 0, false);
        declareFunction(me, "open_cyc_uri_for_term", "OPEN-CYC-URI-FOR-TERM", 1, 0, false);
        declareFunction(me, "canonical_uri_for_term", "CANONICAL-URI-FOR-TERM", 1, 0, false);
        declareFunction(me, "resource_with_uri_fn_nat_p", "RESOURCE-WITH-URI-FN-NAT-P", 1, 0, false);
        declareFunction(me, "cyc_remove_html_tags", "CYC-REMOVE-HTML-TAGS", 1, 0, false);
        declareFunction(me, "cyc_capitalize_smart", "CYC-CAPITALIZE-SMART", 1, 0, false);
        declareFunction(me, "cyc_recapitalize_smart", "CYC-RECAPITALIZE-SMART", 1, 0, false);
        declareFunction(me, "cyc_relation_arg", "CYC-RELATION-ARG", 2, 0, false);
        declareFunction(me, "cyc_relation_args_list", "CYC-RELATION-ARGS-LIST", 1, 0, false);
        declareFunction(me, "cyc_relation_arg_set", "CYC-RELATION-ARG-SET", 1, 0, false);
        declareFunction(me, "cyc_quoted_relation_expression_arity", "CYC-QUOTED-RELATION-EXPRESSION-ARITY", 1, 0, false);
        declareFunction(me, "cyc_relation_expression_arity", "CYC-RELATION-EXPRESSION-ARITY", 1, 0, false);
        declareFunction(me, "cyc_identity", "CYC-IDENTITY", 1, 0, false);
        declareFunction(me, "cyc_relation_tuples", "CYC-RELATION-TUPLES", 1, 0, false);
        declareFunction(me, "cyc_relation_tuples_internal", "CYC-RELATION-TUPLES-INTERNAL", 1, 1, false);
        declareFunction(me, "convert_relation_to_kappa", "CONVERT-RELATION-TO-KAPPA", 1, 0, false);
        declareFunction(me, "cyc_substitute_formula", "CYC-SUBSTITUTE-FORMULA", 3, 0, false);
        declareFunction(me, "cyc_bilateral_form_of_sentence_left", "CYC-BILATERAL-FORM-OF-SENTENCE-LEFT", 1, 0, false);
        declareFunction(me, "symmetric_part_typeP", "SYMMETRIC-PART-TYPE?", 1, 0, false);
        declareFunction(me, "left_form_of_symmetric_part_type", "LEFT-FORM-OF-SYMMETRIC-PART-TYPE", 1, 0, false);
        declareFunction(me, "cyc_bilateral_form_of_sentence_right", "CYC-BILATERAL-FORM-OF-SENTENCE-RIGHT", 1, 0, false);
        declareFunction(me, "symmetry_neutralized_el_sentence_p", "SYMMETRY-NEUTRALIZED-EL-SENTENCE-P", 1, 0, false);
        declareFunction(me, "right_form_of_symmetric_part_type", "RIGHT-FORM-OF-SYMMETRIC-PART-TYPE", 1, 0, false);
        declareFunction(me, "neutralize_symmetric_formula", "NEUTRALIZE-SYMMETRIC-FORMULA", 1, 0, false);
        declareFunction(me, "side_fn_naut_p", "SIDE-FN-NAUT-P", 1, 0, false);
        declareFunction(me, "cyc_substitute_formula_arg", "CYC-SUBSTITUTE-FORMULA-ARG", 3, 0, false);
        declareFunction(me, "cyc_substitute_formula_arg_position", "CYC-SUBSTITUTE-FORMULA-ARG-POSITION", 3, 0, false);
        declareFunction(me, "cyc_make_formula", "CYC-MAKE-FORMULA", 2, 0, false);
        declareFunction(me, "cyc_substitute_quoted_formula", "CYC-SUBSTITUTE-QUOTED-FORMULA", 3, 0, false);
        declareFunction(me, "cyc_substitute_quoted_formula_arg", "CYC-SUBSTITUTE-QUOTED-FORMULA-ARG", 3, 0, false);
        declareFunction(me, "cyc_substitute_quoted_formula_arg_position", "CYC-SUBSTITUTE-QUOTED-FORMULA-ARG-POSITION", 3, 0, false);
        declareFunction(me, "cyc_make_quoted_formula", "CYC-MAKE-QUOTED-FORMULA", 2, 0, false);
        declareFunction(me, "cycl_to_el_fn", "CYCL-TO-EL-FN", 1, 0, false);
        declareFunction(me, "cyc_substitute_nlte", "CYC-SUBSTITUTE-NLTE", 3, 0, false);
        declareFunction(me, "sem_trans_template_defn", "SEM-TRANS-TEMPLATE-DEFN", 3, 0, false);
        declareFunction(me, "cyc_word_strings", "CYC-WORD-STRINGS", 2, 0, false);
        declareFunction(me, "word_strings_fn", "WORD-STRINGS-FN", 0, 0, false);
        declareFunction(me, "word_sequence_fn", "WORD-SEQUENCE-FN", 0, 0, false);
        declareFunction(me, "cyc_strings_of_word_sequence", "CYC-STRINGS-OF-WORD-SEQUENCE", 1, 0, false);
        declareFunction(me, "cyc_instantiate", "CYC-INSTANTIATE", 3, 0, false);
        declareFunction(me, "cyc_find_or_instantiate", "CYC-FIND-OR-INSTANTIATE", 3, 0, false);
        declareFunction(me, "cyc_instantiate_set_formula", "CYC-INSTANTIATE-SET-FORMULA", 1, 0, false);
        declareFunction(me, "cyc_instantiate_formula", "CYC-INSTANTIATE-FORMULA", 3, 0, false);
        declareFunction(me, "cyc_find_via_pred_value_or_create_via_template", "CYC-FIND-VIA-PRED-VALUE-OR-CREATE-VIA-TEMPLATE", 3, 0, false);
        declareFunction(me, "clear_cached_find_via_pred_value_wrt_template", "CLEAR-CACHED-FIND-VIA-PRED-VALUE-WRT-TEMPLATE", 0, 0, false);
        declareFunction(me, "remove_cached_find_via_pred_value_wrt_template", "REMOVE-CACHED-FIND-VIA-PRED-VALUE-WRT-TEMPLATE", 3, 1, false);
        declareFunction(me, "cached_find_via_pred_value_wrt_template_internal", "CACHED-FIND-VIA-PRED-VALUE-WRT-TEMPLATE-INTERNAL", 4, 0, false);
        declareFunction(me, "cached_find_via_pred_value_wrt_template", "CACHED-FIND-VIA-PRED-VALUE-WRT-TEMPLATE", 3, 1, false);
        declareFunction(me, "find_via_pred_value_wrt_template", "FIND-VIA-PRED-VALUE-WRT-TEMPLATE", 3, 1, false);
        declareFunction(me, "create_and_assert_via_value_wrt_template", "CREATE-AND-ASSERT-VIA-VALUE-WRT-TEMPLATE", 2, 1, false);
        declareFunction(me, "create_constant_from_value_wrt_template", "CREATE-CONSTANT-FROM-VALUE-WRT-TEMPLATE", 2, 1, false);
        declareFunction(me, "compute_constant_assert_sentence_wrt_template", "COMPUTE-CONSTANT-ASSERT-SENTENCE-WRT-TEMPLATE", 3, 1, false);
        declareFunction(me, "cyc_action_type_nlte", "CYC-ACTION-TYPE-NLTE", 1, 0, false);
        declareFunction(me, "action_type_nlte", "ACTION-TYPE-NLTE", 1, 0, false);
        declareFunction(me, "action_type_nltes", "ACTION-TYPE-NLTES", 1, 0, false);
        declareFunction(me, "cyc_individual_denoting_unary_function_for", "CYC-INDIVIDUAL-DENOTING-UNARY-FUNCTION-FOR", 1, 0, false);
        declareFunction(me, "cyc_collection_denoting_unary_function_for", "CYC-COLLECTION-DENOTING-UNARY-FUNCTION-FOR", 1, 0, false);
        declareFunction(me, "unary_functions_for", "UNARY-FUNCTIONS-FOR", 2, 0, false);
        declareFunction(me, "unary_functionP", "UNARY-FUNCTION?", 1, 0, false);
        declareFunction(me, "individual_denoting_fnP", "INDIVIDUAL-DENOTING-FN?", 1, 0, false);
        declareFunction(me, "cyc_el_variable_fn", "CYC-EL-VARIABLE-FN", 1, 0, false);
        declareFunction(me, "cyc_add_english_suffix", "CYC-ADD-ENGLISH-SUFFIX", 2, 0, false);
        declareFunction(me, "generate_phrase_defn", "GENERATE-PHRASE-DEFN", 1, 0, false);
        declareFunction(me, "generate_phrase_memoized_internal", "GENERATE-PHRASE-MEMOIZED-INTERNAL", 2, 0, false);
        declareFunction(me, "generate_phrase_memoized", "GENERATE-PHRASE-MEMOIZED", 2, 0, false);
        declareFunction(me, "assertions_relevant_to_string_defn", "ASSERTIONS-RELEVANT-TO-STRING-DEFN", 1, 0, false);
        declareFunction(me, "assertions_for_prompt_string_memoized_internal", "ASSERTIONS-FOR-PROMPT-STRING-MEMOIZED-INTERNAL", 3, 0, false);
        declareFunction(me, "assertions_for_prompt_string_memoized", "ASSERTIONS-FOR-PROMPT-STRING-MEMOIZED", 3, 0, false);
        declareFunction(me, "best_string_of_nl_phrase_defn", "BEST-STRING-OF-NL-PHRASE-DEFN", 1, 0, false);
        declareFunction(me, "best_string_of_nl_phrase_addressing_defn", "BEST-STRING-OF-NL-PHRASE-ADDRESSING-DEFN", 2, 0, false);
        declareFunction(me, "best_string_of_nl_phrase_with_force_defn", "BEST-STRING-OF-NL-PHRASE-WITH-FORCE-DEFN", 2, 0, false);
        declareFunction(me, "generate_gke_gloss_wrt_mt", "GENERATE-GKE-GLOSS-WRT-MT", 2, 0, false);
        declareFunction(me, "basic_datum_paraphrase_defn", "BASIC-DATUM-PARAPHRASE-DEFN", 2, 0, false);
        declareFunction(me, "basic_datum_phrase_naut", "BASIC-DATUM-PHRASE-NAUT", 1, 0, false);
        declareFunction(me, "paraphrase_of_formula_from_template_defn", "PARAPHRASE-OF-FORMULA-FROM-TEMPLATE-DEFN", 2, 0, false);
        declareFunction(me, "state_or_province_for_city_defn", "STATE-OR-PROVINCE-FOR-CITY-DEFN", 1, 0, false);
        declareFunction(me, "cyc_html_url_encode", "CYC-HTML-URL-ENCODE", 1, 0, false);
        declareFunction(me, "cyc_url_source", "CYC-URL-SOURCE", 1, 0, false);
        declareFunction(me, "cyc_get_from_http_source", "CYC-GET-FROM-HTTP-SOURCE", 1, 0, false);
        declareFunction(me, "encode_list_for_simple_http_server", "ENCODE-LIST-FOR-SIMPLE-HTTP-SERVER", 1, 0, false);
        declareFunction(me, "cyc_term_uri_fn", "CYC-TERM-URI-FN", 1, 0, false);
        declareFunction(me, "city_named_fn_defn", "CITY-NAMED-FN-DEFN", 2, 0, false);
        declareFunction(me, "city_in_regionP", "CITY-IN-REGION?", 2, 0, false);
        declareFunction(me, "text_topic_structure", "TEXT-TOPIC-STRUCTURE", 1, 0, false);
        declareFunction(me, "el_list_to_subl_list", "EL-LIST-TO-SUBL-LIST", 1, 0, false);
        declareFunction(me, "cyc_ordering_result", "CYC-ORDERING-RESULT", 1, 0, false);
        declareFunction(me, "ordering_L", "ORDERING-<", 2, 0, false);
        declareFunction(me, "cyc_ordering_result_internal", "CYC-ORDERING-RESULT-INTERNAL", 2, 0, false);
        declareFunction(me, "cyc_time_of_day_of_date", "CYC-TIME-OF-DAY-OF-DATE", 1, 0, false);
        declareFunction(me, "cyc_seconds_since_1970_to_date", "CYC-SECONDS-SINCE-1970-TO-DATE", 1, 0, false);
        declareFunction(me, "cyc_date_to_seconds_since_1970", "CYC-DATE-TO-SECONDS-SINCE-1970", 1, 0, false);
        declareFunction(me, "cyc_types_most_often_asserted_using_tool", "CYC-TYPES-MOST-OFTEN-ASSERTED-USING-TOOL", 2, 0, false);
        declareFunction(me, "types_most_often_asserted_using_tool", "TYPES-MOST-OFTEN-ASSERTED-USING-TOOL", 1, 3, false);
        declareFunction(me, "assertion_generating_tool_p", "ASSERTION-GENERATING-TOOL-P", 1, 0, false);
        declareFunction(me, "cyc_html_for_text_containing_strings", "CYC-HTML-FOR-TEXT-CONTAINING-STRINGS", 2, 0, false);
        declareFunction(me, "cyc_html_for_text_containing_strings_count_bold_tags", "CYC-HTML-FOR-TEXT-CONTAINING-STRINGS-COUNT-BOLD-TAGS", 1, 0, false);
        declareFunction(me, "cyc_format", "CYC-FORMAT", 2, 0, false);
        declareFunction(me, "cyc_next_integer_in_sequence", "CYC-NEXT-INTEGER-IN-SEQUENCE", 1, 0, false);
        declareFunction(me, "cyc_next_integer_in_sequence_starting_at", "CYC-NEXT-INTEGER-IN-SEQUENCE-STARTING-AT", 2, 0, false);
        declareFunction(me, "cyc_cyclify", "CYC-CYCLIFY", 2, 0, false);
        declareFunction(me, "cyc_concatenate_strings", "CYC-CONCATENATE-STRINGS", 1, 0, false);
        declareFunction(me, "cyc_concatenate_list_of_strings", "CYC-CONCATENATE-LIST-OF-STRINGS", 1, 0, false);
        declareFunction(me, "cyc_term_similarity_metric", "CYC-TERM-SIMILARITY-METRIC", 2, 0, false);
        declareFunction(me, "check_wn_sks_registered", "CHECK-WN-SKS-REGISTERED", 0, 0, false);
        declareFunction(me, "cyc_wn_all_candidate_cycls_for_word_unitXpos", "CYC-WN-ALL-CANDIDATE-CYCLS-FOR-WORD-UNIT&POS", 2, 0, false);
        declareFunction(me, "cyc_wn_all_hypernyms_for_word_unitXpos", "CYC-WN-ALL-HYPERNYMS-FOR-WORD-UNIT&POS", 2, 0, false);
        declareFunction(me, "cyc_wn_all_synonyms_for_word_unitXpos", "CYC-WN-ALL-SYNONYMS-FOR-WORD-UNIT&POS", 2, 0, false);
        declareFunction(me, "cyc_wn_ranked_candidate_cycls_for_word_unitXpos", "CYC-WN-RANKED-CANDIDATE-CYCLS-FOR-WORD-UNIT&POS", 2, 0, false);
        declareFunction(me, "cyc_wn_ranked_hypernyms_for_word_unitXpos", "CYC-WN-RANKED-HYPERNYMS-FOR-WORD-UNIT&POS", 2, 0, false);
        declareFunction(me, "cyc_wn_ranked_synonyms_for_word_unitXpos", "CYC-WN-RANKED-SYNONYMS-FOR-WORD-UNIT&POS", 2, 0, false);
        declareFunction(me, "cyc_kb_orthogonal", "CYC-KB-ORTHOGONAL", 2, 0, false);
        declareFunction(me, "cyc_content_of_file", "CYC-CONTENT-OF-FILE", 1, 0, false);
        declareFunction(me, "cyc_transform_relation_tuples", "CYC-TRANSFORM-RELATION-TUPLES", 1, 0, false);
        declareFunction(me, "unlist", "UNLIST", 1, 0, false);
        declareFunction(me, "cyc_provable_via_defns", "CYC-PROVABLE-VIA-DEFNS", 1, 0, false);
        declareFunction(me, "provable_via_defns_proper", "PROVABLE-VIA-DEFNS-PROPER", 3, 0, false);
        declareFunction(me, "current_inference_answer_justification_proof_view", "CURRENT-INFERENCE-ANSWER-JUSTIFICATION-PROOF-VIEW", 0, 0, false);
        declareFunction(me, "cyc_find_object_by_compact_hl_external_id_string", "CYC-FIND-OBJECT-BY-COMPACT-HL-EXTERNAL-ID-STRING", 1, 0, false);
        declareFunction(me, "cyc_compact_hl_external_id_string", "CYC-COMPACT-HL-EXTERNAL-ID-STRING", 1, 0, false);
        declareFunction(me, "cyc_decode_ka_interaction", "CYC-DECODE-KA-INTERACTION", 1, 0, false);
        declareFunction(me, "cyc_most_recently_started_events_by_agent_relative_to_interaction_mt_fn", "CYC-MOST-RECENTLY-STARTED-EVENTS-BY-AGENT-RELATIVE-TO-INTERACTION-MT-FN", 2, 0, false);
        declareFunction(me, "most_recently_started_events_by_agent_relative_to_interaction_mt", "MOST-RECENTLY-STARTED-EVENTS-BY-AGENT-RELATIVE-TO-INTERACTION-MT", 2, 0, false);
        declareFunction(me, "executed_events_for_agent_in_interaction_mt", "EXECUTED-EVENTS-FOR-AGENT-IN-INTERACTION-MT", 2, 0, false);
        declareFunction(me, "executed_unfinished_events_for_agent_in_interaction_mt", "EXECUTED-UNFINISHED-EVENTS-FOR-AGENT-IN-INTERACTION-MT", 2, 1, false);
        declareFunction(me, "cyc_most_recently_started_unfinish_events_by_agent_relative_to_interaction_mt_fn", "CYC-MOST-RECENTLY-STARTED-UNFINISH-EVENTS-BY-AGENT-RELATIVE-TO-INTERACTION-MT-FN", 2, 0, false);
        declareFunction(me, "most_recently_started_unfinished_events_by_agent_relative_to_interaction_mt", "MOST-RECENTLY-STARTED-UNFINISHED-EVENTS-BY-AGENT-RELATIVE-TO-INTERACTION-MT", 2, 0, false);
        declareFunction(me, "cyc_event_to_plan_for_by_agent_in_interaction_context_fn", "CYC-EVENT-TO-PLAN-FOR-BY-AGENT-IN-INTERACTION-CONTEXT-FN", 2, 0, false);
        declareFunction(me, "event_to_plan_for_by_agent_in_interaction_context", "EVENT-TO-PLAN-FOR-BY-AGENT-IN-INTERACTION-CONTEXT", 2, 0, false);
        declareFunction(me, "cyc_plan_agent_should_execute_in_interaction_context_fn", "CYC-PLAN-AGENT-SHOULD-EXECUTE-IN-INTERACTION-CONTEXT-FN", 2, 0, false);
        declareFunction(me, "earlier_mt_or_abandonedP", "EARLIER-MT-OR-ABANDONED?", 2, 0, false);
        declareFunction(me, "plan_agent_should_execute_in_interaction_context", "PLAN-AGENT-SHOULD-EXECUTE-IN-INTERACTION-CONTEXT", 2, 0, false);
        declareFunction(me, "cyc_agent_cannot_progress_in_interaction_context_fn", "CYC-AGENT-CANNOT-PROGRESS-IN-INTERACTION-CONTEXT-FN", 2, 0, false);
        declareFunction(me, "agent_cannot_progress_in_interaction_context", "AGENT-CANNOT-PROGRESS-IN-INTERACTION-CONTEXT", 2, 0, false);
        declareFunction(me, "cyc_highest_priority_item_on_agenda_for_agent_in_interaction_context_fn", "CYC-HIGHEST-PRIORITY-ITEM-ON-AGENDA-FOR-AGENT-IN-INTERACTION-CONTEXT-FN", 2, 0, false);
        declareFunction(me, "highest_priority_item_on_agenda_for_agent_in_interaction_context", "HIGHEST-PRIORITY-ITEM-ON-AGENDA-FOR-AGENT-IN-INTERACTION-CONTEXT", 2, 0, false);
        declareFunction(me, "cyc_highest_priority_item_on_agenda_in_to_do_mt_fn", "CYC-HIGHEST-PRIORITY-ITEM-ON-AGENDA-IN-TO-DO-MT-FN", 2, 0, false);
        declareFunction(me, "highest_priority_item_on_agenda_in_to_do_mt", "HIGHEST-PRIORITY-ITEM-ON-AGENDA-IN-TO-DO-MT", 2, 0, false);
        declareFunction(me, "cyc_likelihood_of_truth_of_sentence", "CYC-LIKELIHOOD-OF-TRUTH-OF-SENTENCE", 2, 0, false);
        declareFunction(me, "cyc_time_intervals_for_sentence", "CYC-TIME-INTERVALS-FOR-SENTENCE", 2, 0, false);
        declareFunction(me, "cyc_evaluate_math_expression", "CYC-EVALUATE-MATH-EXPRESSION", 1, 0, false);
        declareFunction(me, "cyc_flatten_math_expression", "CYC-FLATTEN-MATH-EXPRESSION", 1, 0, false);
        declareFunction(me, "cyc_apply_operation_to_math_statement", "CYC-APPLY-OPERATION-TO-MATH-STATEMENT", 3, 0, false);
        declareFunction(me, "cyc_serialize_mathml", "CYC-SERIALIZE-MATHML", 1, 0, false);
        declareFunction(me, "cyc_cartesian_product", "CYC-CARTESIAN-PRODUCT", 1, 0, false);
        declareFunction(me, "cyc_filter_list", "CYC-FILTER-LIST", 2, 0, false);
        return NIL;
    }
    ...
    public static SubLObject setup_evaluation_defns_file() {
        ...
        declare_defglobal($sym204$_USE_NEW_NL_GENERATION_API_FOR_GENERATE_PHRASE_FN__);
