...
import static com.cyc.cycjava.cycl.ghl_search_vars.*;
...
public final class ghl_search_vars extends SubLTranslatedFile {
    ...
    public static SubLObject ghl_search_p(final SubLObject v_object) {
        return v_object.getClass() == ghl_search_vars.$ghl_search_native.class ? T : NIL;
    }

    public static SubLObject ghl_search_graphl_search(final SubLObject v_object) {
        assert NIL != ghl_search_p(v_object) : "ghl_search_vars.ghl_search_p(v_object) " + "CommonSymbols.NIL != ghl_search_vars.ghl_search_p(v_object) " + v_object;
    ...
    public static SubLObject make_ghl_search(SubLObject arglist) {
        ...
        final SubLObject v_new = new ghl_search_vars.$ghl_search_native();
        SubLObject next;
    ...
    public static final class $ghl_search_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(ghl_search_vars.$ghl_search_native.class, GHL_SEARCH, GHL_SEARCH_P, $list3, $list4, new String[]{ "$graphl_search", "$predicates", "$directions", "$tv" }, $list5, $list6, PRINT_GHL_SEARCH);
        }
    }
