...
import static com.cyc.cycjava.cycl.wordnet_import.wordnet_import.*;
...
public final class wordnet_import extends SubLTranslatedFile {
    ...
    public static SubLObject wni_role_info_p(final SubLObject v_object) {
        return v_object.getClass() == wordnet_import.$wni_role_info_native.class ? T : NIL;
    }

    public static SubLObject wni_role(final SubLObject v_object) {
        assert NIL != wni_role_info_p(v_object) : "wordnet_import.wni_role_info_p(v_object) " + "CommonSymbols.NIL != wordnet_import.wni_role_info_p(v_object) " + v_object;
    ...
    public static SubLObject make_wni_role_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new wordnet_import.$wni_role_info_native();
        SubLObject next;
    ...
    public static final class $wni_role_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(wordnet_import.$wni_role_info_native.class, WNI_ROLE_INFO, WNI_ROLE_INFO_P, $list395, $list396, new String[]{ "$role", "$filler", "$defining_col", "$defining_pred", "$subsumption_status" }, $list397, $list398, WNI_PRINT_ROLE_INFO);
        }
    }
