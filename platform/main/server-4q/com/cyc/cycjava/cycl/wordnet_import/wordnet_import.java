...
public final class wordnet_import extends SubLTranslatedFile {
	...
	// Internal Constants
	public static final SubLList $list0 = list(new SubLObject[] { reader_make_constant_shell(makeString("Noun")), reader_make_constant_shell(makeString("Verb")), reader_make_constant_shell(makeString("Adjective")), reader_make_constant_shell(makeString("wnSynsetMemberWord")), reader_make_constant_shell(makeString("WordNetEnglishWordFn")), reader_make_constant_shell(makeString("WordNetWorkflowCollectorMt")),
			reader_make_constant_shell(makeString("WordNet2_0-KS")), reader_make_constant_shell(makeString("WordNetSynsetImportStatus-DeterminedIndividual")), reader_make_constant_shell(makeString("Adverb")), reader_make_constant_shell(makeString("WordNetSynsetFn")), reader_make_constant_shell(makeString("WordNetWorkflowDataStatusMt")), reader_make_constant_shell(makeString("Situation")),
	...
	private static final SubLList $list9 = list(new SubLObject[] { makeKeyword("MAX-NUMBER"), NIL, makeKeyword("MAX-TIME"), NIL, makeKeyword("MAX-TRANSFORMATION-DEPTH"), ZERO_INTEGER, makeKeyword("PROBABLY-APPROXIMATELY-DONE"), makeDouble(1.0), makeKeyword("BLOCK?"), NIL, makeKeyword("MAX-PROOF-DEPTH"), NIL, makeKeyword("CACHE-INFERENCE-RESULTS?"), NIL, makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL"),
			makeKeyword("CONTINUABLE?"), NIL, makeKeyword("PRODUCTIVITY-LIMIT"), makeKeyword("POSITIVE-INFINITY") });
	...
	private static final SubLList $list65 = list(cons(reader_make_constant_shell(makeString("WNVerbFrame-8")), TWO_INTEGER), cons(reader_make_constant_shell(makeString("WNVerbFrame-2")), FIVE_INTEGER), cons(reader_make_constant_shell(makeString("WNVerbFrame-1")), FOUR_INTEGER), cons(reader_make_constant_shell(makeString("WNVerbFrame-9")), THREE_INTEGER),
			cons(reader_make_constant_shell(makeString("WNVerbFrame-11")), ONE_INTEGER), cons(reader_make_constant_shell(makeString("WNVerbFrame-22")), FIVE_INTEGER), cons(reader_make_constant_shell(makeString("WNVerbFrame-4")), FOUR_INTEGER));
	...
	private static final SubLList $list72 = list(new SubLObject[] { makeKeyword("MAX-NUMBER"), NIL, makeKeyword("MAX-TIME"), NIL, makeKeyword("MAX-TRANSFORMATION-DEPTH"), ZERO_INTEGER, makeKeyword("PROBABLY-APPROXIMATELY-DONE"), makeDouble(1.0), makeKeyword("BLOCK?"), NIL, makeKeyword("RETURN"), list(makeKeyword("TEMPLATE"), makeSymbol("?VERB-FRAME")), makeKeyword("MAX-PROOF-DEPTH"), NIL,
			makeKeyword("CACHE-INFERENCE-RESULTS?"), NIL, makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL"), makeKeyword("CONTINUABLE?"), NIL, makeKeyword("PRODUCTIVITY-LIMIT"), makeKeyword("POSITIVE-INFINITY") });
	...
	private static final SubLList $list105 = list(new SubLObject[] { makeKeyword("MAX-NUMBER"), ONE_INTEGER, makeKeyword("MAX-TIME"), NIL, makeKeyword("MAX-TRANSFORMATION-DEPTH"), ZERO_INTEGER, makeKeyword("PROBABLY-APPROXIMATELY-DONE"), makeDouble(1.0), makeKeyword("BLOCK?"), NIL, makeKeyword("MAX-PROOF-DEPTH"), NIL, makeKeyword("CACHE-INFERENCE-RESULTS?"), NIL, makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL"),
			makeKeyword("RETURN"), list(makeKeyword("TEMPLATE"), makeSymbol("?GLOSS")), makeKeyword("ALLOW-INDETERMINATE-RESULTS?"), NIL, makeKeyword("CONTINUABLE?"), NIL, makeKeyword("PRODUCTIVITY-LIMIT"), makeKeyword("POSITIVE-INFINITY") });
	...
	private static final SubLList $list111 = list(new SubLObject[] { makeKeyword("MAX-NUMBER"), ONE_INTEGER, makeKeyword("MAX-TIME"), NIL, makeKeyword("MAX-TRANSFORMATION-DEPTH"), ZERO_INTEGER, makeKeyword("PROBABLY-APPROXIMATELY-DONE"), makeDouble(1.0), makeKeyword("BLOCK?"), NIL, makeKeyword("MAX-PROOF-DEPTH"), NIL, makeKeyword("CACHE-INFERENCE-RESULTS?"), NIL, makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL"),
			makeKeyword("CONTINUABLE?"), NIL, makeKeyword("ALLOW-INDETERMINATE-RESULTS?"), NIL, makeKeyword("RETURN"), list(makeKeyword("TEMPLATE"), makeSymbol("?POS")), makeKeyword("PRODUCTIVITY-LIMIT"), makeKeyword("POSITIVE-INFINITY") });
	...
	private static final SubLList $list129 = list(new SubLObject[] { makeKeyword("MAX-NUMBER"), ONE_INTEGER, makeKeyword("MAX-TIME"), NIL, makeKeyword("MAX-TRANSFORMATION-DEPTH"), ZERO_INTEGER, makeKeyword("PROBABLY-APPROXIMATELY-DONE"), makeDouble(0.95), makeKeyword("BLOCK?"), NIL, makeKeyword("MAX-PROOF-DEPTH"), NIL, makeKeyword("RETURN"), list(makeKeyword("TEMPLATE"), makeSymbol("?TERM")),
			makeKeyword("CACHE-INFERENCE-RESULTS?"), NIL, makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL"), makeKeyword("CONTINUABLE?"), NIL, makeKeyword("PRODUCTIVITY-LIMIT"), makeInteger(2000000) });
	...
	private static final SubLList $list173 = list(new SubLObject[] { makeKeyword("MAX-NUMBER"), NIL, makeKeyword("MAX-TIME"), NIL, makeKeyword("MAX-TRANSFORMATION-DEPTH"), ZERO_INTEGER, makeKeyword("PROBABLY-APPROXIMATELY-DONE"), makeDouble(0.95), makeKeyword("BLOCK?"), NIL, makeKeyword("MAX-PROOF-DEPTH"), NIL, makeKeyword("CACHE-INFERENCE-RESULTS?"), NIL, makeKeyword("ANSWER-LANGUAGE"), makeKeyword("HL"),
			makeKeyword("CONTINUABLE?"), NIL, makeKeyword("PRODUCTIVITY-LIMIT"), makeInteger(2000000) });
	...
	private static final SubLString $str205$__and____________________Synset_c = makeString(
	...
	private static final SubLList $list225 = list(
			list(reader_make_constant_shell(makeString("unknownSentence")), list(reader_make_constant_shell(makeString("thereExists")), makeSymbol("?CYCLIST"), list(reader_make_constant_shell(makeString("thereExists")), makeSymbol("?DATE"), list(reader_make_constant_shell(makeString("wnWorkflowSynsetLock")), makeSymbol("?REIFIED-SYNSET"), makeSymbol("?CYCLIST"), makeSymbol("?DATE"))))));
	...
	public static final SubLList $list443 = list(list(reader_make_constant_shell(makeString("genls")), makeSymbol("?DEFINING-COLL"), reader_make_constant_shell(makeString("Situation"))), list(reader_make_constant_shell(makeString("assertedSentence")), list(reader_make_constant_shell(makeString("relationAllExists")), makeSymbol("?ROLE"), makeSymbol("?DEFINING-COLL"), makeSymbol("?COLL"))),
			list(reader_make_constant_shell(makeString("equals")), makeSymbol("?FILLER"), makeSymbol("?COLL")), list(reader_make_constant_shell(makeString("equals")), makeSymbol("?DEFINING-PRED"), reader_make_constant_shell(makeString("relationAllExists"))),
			list(reader_make_constant_shell(makeString("unknownSentence")), list(reader_make_constant_shell(makeString("quotedIsa")), makeSymbol("?ROLE"), reader_make_constant_shell(makeString("FormulaTemplateConstant-FactEntryTool")))));

	private static final SubLSymbol $sym444$_THING = makeSymbol("?THING");

	public static final SubLList $list445 = list(list(reader_make_constant_shell(makeString("genls")), makeSymbol("?DEFINING-COLL"), reader_make_constant_shell(makeString("Situation"))), list(reader_make_constant_shell(makeString("assertedSentence")), list(reader_make_constant_shell(makeString("relationAllInstance")), makeSymbol("?ROLE"), makeSymbol("?DEFINING-COLL"), makeSymbol("?THING"))),
			list(reader_make_constant_shell(makeString("equals")), makeSymbol("?FILLER"), makeSymbol("?THING")), list(reader_make_constant_shell(makeString("equals")), makeSymbol("?DEFINING-PRED"), reader_make_constant_shell(makeString("relationAllInstance"))),
			list(reader_make_constant_shell(makeString("unknownSentence")), list(reader_make_constant_shell(makeString("quotedIsa")), makeSymbol("?ROLE"), reader_make_constant_shell(makeString("FormulaTemplateConstant-FactEntryTool")))));
	...
	private static final SubLList $list452 = list(list(reader_make_constant_shell(makeString("unknownSentence")), list(reader_make_constant_shell(makeString("genls")), makeSymbol("?DEFINING-COLL"), reader_make_constant_shell(makeString("Situation")))),
			list(reader_make_constant_shell(makeString("assertedSentence")), list(reader_make_constant_shell(makeString("relationAllExists")), makeSymbol("?ROLE"), makeSymbol("?DEFINING-COLL"), makeSymbol("?COLL"))), list(reader_make_constant_shell(makeString("equals")), makeSymbol("?FILLER"), makeSymbol("?COLL")),
			list(reader_make_constant_shell(makeString("equals")), makeSymbol("?DEFINING-PRED"), reader_make_constant_shell(makeString("relationAllExists"))), list(reader_make_constant_shell(makeString("unknownSentence")), list(reader_make_constant_shell(makeString("quotedIsa")), makeSymbol("?ROLE"), reader_make_constant_shell(makeString("FormulaTemplateConstant-FactEntryTool")))));

	private static final SubLList $list453 = list(list(reader_make_constant_shell(makeString("unknownSentence")), list(reader_make_constant_shell(makeString("genls")), makeSymbol("?DEFINING-COLL"), reader_make_constant_shell(makeString("Situation")))),
			list(reader_make_constant_shell(makeString("assertedSentence")), list(reader_make_constant_shell(makeString("relationAllInstance")), makeSymbol("?ROLE"), makeSymbol("?DEFINING-COLL"), makeSymbol("?THING"))), list(reader_make_constant_shell(makeString("equals")), makeSymbol("?FILLER"), makeSymbol("?THING")),
			list(reader_make_constant_shell(makeString("equals")), makeSymbol("?DEFINING-PRED"), reader_make_constant_shell(makeString("relationAllInstance"))), list(reader_make_constant_shell(makeString("unknownSentence")), list(reader_make_constant_shell(makeString("quotedIsa")), makeSymbol("?ROLE"), reader_make_constant_shell(makeString("FormulaTemplateConstant-FactEntryTool")))));
	...
	public static SubLObject wni_most_general_synset_verb_frame(final SubLObject synset) {
		...
		if (((NIL != most_general_verb_frame) && (!SubLSystemTrampolineFile.assertionsDisabledInClass)) && (NIL == forts.fort_p(most_general_verb_frame))) {
	...
	public static SubLObject wni_synset_verb_frames_helper_internal(final SubLObject synset) {
		...
		while (NIL != cdolist_list_var) {
			...
			} else if (NIL != possibly_naut_p(binding)) {
	...
	public static SubLObject wni_synset_gloss_helper_internal(final SubLObject synset) {
		...
		gloss = results.first();
		if (((NIL != gloss) && (!SubLSystemTrampolineFile.assertionsDisabledInClass)) && (NIL == stringp(gloss))) {
	...
	public static SubLObject wni_synset_pos_helper_internal(final SubLObject synset) {
		...
		final SubLObject results = wni_trace_new_cyc_query(sentence, $$WordNetWorkflowCollectorMt, query_properties);
		pos = results.first();
		if (((NIL != pos) && (!SubLSystemTrampolineFile.assertionsDisabledInClass)) && (NIL == forts.fort_p(pos))) {
	...
	public static SubLObject wni_urban_area_geographical_entity(final SubLObject synset) {
		...
		while (NIL == doneP) {
			...
			if (NIL != Strings.stringE(gloss_word, $$$ancient, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
				ancientP = T;
			} else if ((NIL != ancientP) && (NIL != Strings.stringE(gloss_word, $$$Greek, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED))) {
				ancientP = NIL;
			} else {
				ancientP = NIL;
				if (NIL != upper_case_p(string_utilities.first_char(gloss_word))) {
					...
					if ((((((((((((((NIL != string_utilities.starts_with(place_name, $$$Atlantic)) || (NIL != string_utilities.starts_with(place_name, $$$Pacific))) || (NIL != string_utilities.starts_with(place_name, $$$Crown_Colony))) || (NIL != string_utilities.starts_with(place_name, $$$Caribbean))) || (NIL != string_utilities.starts_with(place_name, $$$State)))
							|| (NIL != string_utilities.starts_with(place_name, $$$Lake_Erie))) || (NIL != string_utilities.starts_with(place_name, $$$Asia_Minor))) || (NIL != string_utilities.starts_with(place_name, $$$Elbo_River))) || (NIL != string_utilities.starts_with(place_name, $$$Asian))) || (NIL != string_utilities.starts_with(place_name, $$$Yourba)))
							|| (NIL != string_utilities.starts_with(place_name, $$$Japanese))) || (NIL != string_utilities.starts_with(place_name, $$$Nile))) || (NIL != string_utilities.starts_with(place_name, $$$River_Thames))) || (NIL != string_utilities.starts_with(place_name, $$$River_Aire))) {
	...
	public static SubLObject wni_speech_part_offset_to_synset(final SubLObject pos_offset) {
		...
		if (((NIL != synset) && (!SubLSystemTrampolineFile.assertionsDisabledInClass)) && (NIL == narts_high.naut_p(synset))) {
	...
	public static SubLObject wni_problem_store() {
		...
		if (NIL != inference_datastructures_problem_store.problem_store_p($wni_problem_store$.getDynamicValue(thread))) {
			...
			} else if (inference_datastructures_problem_store.problem_store_problem_count($wni_problem_store$.getDynamicValue(thread)).numG(multiply($float$0_9, inference_datastructures_problem_store.problem_store_max_problem_count($wni_problem_store$.getDynamicValue(thread))))) {
	...
	public static SubLObject wni_term_has_verb_semtrans_helperP_internal(final SubLObject v_term) {
		assert NIL != forts.fort_p(v_term) : "forts.fort_p(v_term) " + "CommonSymbols.NIL != forts.fort_p(v_term) " + v_term;
		final SubLObject sentence = list($$thereExists, $sym229$_WORD_UNIT,
				list($$thereExists, $sym230$_SENSE_NBR, listS($$and, list($$denotation, $sym229$_WORD_UNIT, $$Verb, $sym230$_SENSE_NBR, v_term), list($$unknownSentence, list($$thereExists, $sym234$_FRAME, list($$thereExists, $sym235$_TRANS, listS($$verbSemTrans_Canonical, $sym229$_WORD_UNIT, $sym230$_SENSE_NBR, $sym234$_FRAME, v_term, $list237)))), $list238)));
		final SubLObject query_properties = $list9;
			...
			if (NIL != possible_matches) {
				...
				while (NIL != cdolist_list_var_$11) {
					...
					if ((NIL != forts.fort_p(possible_match2)) && fort_types_interface.collectionP(possible_match2).eql(synset_collectionP)) {
						...
						} else if ((NIL != Strings.stringE(generated_phrase, synset_word, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) && (NIL == disjoint_with.any_disjoint_with_anyP(hypernym_terms, mapped_broader_terms, UNPROVIDED, UNPROVIDED, UNPROVIDED))) {
							if (NIL != $wni_verbose_exact_synset_term_matches$.getDynamicValue(thread)) {
	...
	public static SubLObject wni_assert_heuristic_lexicon_for_collection_common(final SubLObject synset, final SubLObject synset_words, final SubLObject v_term, final SubLObject workflow_alist, SubLObject nowP) {
		...
		while (NIL != cdolist_list_var2) {
			if (NIL != list_utilities.alist_lookup(workflow_alist, cconcatenate(synset_word, $str312$_included), EQUAL, UNPROVIDED)) {
				...
				} else if (NIL != string_utilities.contains_charP(synset_word, CHAR_space)) {
	...
	public static SubLObject wni_politeness(final SubLObject synset_word, final SubLObject workflow_alist) {
		...
		} else if (NIL != Strings.stringE(politeness_value, $$$rude, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			politeness = $$RudeSpeech;
		} else if (NIL != Strings.stringE(politeness_value, $$$vulgar, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			politeness = $$VulgarSpeech;
		}

		if (((NIL != politeness) && (!SubLSystemTrampolineFile.assertionsDisabledInClass)) && (NIL == forts.fort_p(politeness))) {
	...
	public static SubLObject wni_formality(final SubLObject synset_word, final SubLObject workflow_alist) {
		...
		} else if (NIL != Strings.stringE(formality_value, $$$slang, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			formality = $$SlangSpeech;
		} else if (NIL != Strings.stringE(formality_value, $$$formal, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			formality = $$FormalSpeech;
		} else if (NIL != Strings.stringE(formality_value, $$$informal, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			formality = $$InformalSpeech;
		} else if (NIL != Strings.stringE(formality_value, $$$baby_talk, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			formality = $$BabyTalk;
		} else if (NIL != Strings.stringE(formality_value, $$$technical_jargon, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			formality = $$Jargon;
		}

		if (((NIL != formality) && (!SubLSystemTrampolineFile.assertionsDisabledInClass)) && (NIL == forts.fort_p(formality))) {
	...
	public static SubLObject wni_rhetorical_device(final SubLObject synset_word, final SubLObject workflow_alist) {
		...
		} else if (NIL != Strings.stringE(rhetorical_device_value, $$$simile, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			rhetorical_device = $$Simile_FigureOfSpeech;
		} else if (NIL != Strings.stringE(rhetorical_device_value, $$$euphemism, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			rhetorical_device = $$EuphemisticSpeech;
		}

		if (((NIL != rhetorical_device) && (!SubLSystemTrampolineFile.assertionsDisabledInClass)) && (NIL == forts.fort_p(rhetorical_device))) {
	...
	public static SubLObject make_wni_role_info(SubLObject arglist) {
		...
		for (next = NIL, next = arglist; NIL != next; next = cddr(next)) {
			...
			} else if (pcase_var.eql($FILLER)) {
				_csetf_wni_filler(v_new, current_value);
			} else if (pcase_var.eql($DEFINING_COL)) {
				_csetf_wni_defining_col(v_new, current_value);
			} else if (pcase_var.eql($DEFINING_PRED)) {
				_csetf_wni_defining_pred(v_new, current_value);
			} else if (pcase_var.eql($SUBSUMPTION_STATUS)) {
	...
	public static SubLObject wni_gather_traits(final SubLObject event_col) {
		...
		SubLObject v_bindings = NIL;
		SubLObject fillers = NIL;
		sentence = list($$and, listS($$genls, event_col, $list430), $list451, $list432, $list433,
				list($$or, list($$and, listS($$interArgIsa1_2, $sym436$_ROLE, event_col, $list437), list($$unknownSentence, list($$thereExists, $sym438$_FILLER_2, listS($$and, listS($$interArgIsa1_2, $sym436$_ROLE, event_col, $list439), $list440)))), listS($$and, list($$unknownSentence, list($$thereExists, $sym438$_FILLER_2, listS($$interArgIsa1_2, $sym436$_ROLE, event_col, $list439))), $list441)));
		thread.resetMultipleValues();
		SubLObject values = ask_utilities.query_template(template, sentence, $$EverythingPSC, query_properties);
		SubLObject results = thread.secondMultipleValue();
