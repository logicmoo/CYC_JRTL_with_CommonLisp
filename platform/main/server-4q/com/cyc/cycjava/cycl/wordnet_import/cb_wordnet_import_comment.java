...
import com.cyc.cycjava.cycl.wordnet_import.cb_wordnet_import_comment;
...
import static com.cyc.cycjava.cycl.wordnet_import.cb_wordnet_import_comment.*;
...
public final class cb_wordnet_import_comment extends SubLTranslatedFile {
    ...
    public static final SubLString $str1$WordNet_Import___Comment = makeString("WordNet Import - Comment");
    ...
    public static final SubLSymbol WNI_CONCEPT_COMMENT = makeSymbol("WNI-CONCEPT-COMMENT");
    ...
    public static SubLObject declare_cb_wordnet_import_comment_file() {
        declareFunction(me, "wni_concept_comment", "WNI-CONCEPT-COMMENT", 1, 0, false);
        declareFunction(me, "wni_concept_comment_input", "WNI-CONCEPT-COMMENT-INPUT", 1, 0, false);
        declareFunction(me, "wni_concept_comment_existing_term", "WNI-CONCEPT-COMMENT-EXISTING-TERM", 1, 0, false);
        declareFunction(me, "wni_concept_comment_existing_term_input", "WNI-CONCEPT-COMMENT-EXISTING-TERM-INPUT", 1, 0, false);
        declareFunction(me, "wni_concept_comment_internal", "WNI-CONCEPT-COMMENT-INTERNAL", 4, 0, false);
        declareFunction(me, "wni_concept_comment_existing_term_internal", "WNI-CONCEPT-COMMENT-EXISTING-TERM-INTERNAL", 4, 0, false);
        declareFunction(me, "wni_suggest_comment", "WNI-SUGGEST-COMMENT", 3, 0, false);
        declareFunction(me, "wni_suggest_noun_comment", "WNI-SUGGEST-NOUN-COMMENT", 2, 0, false);
        declareFunction(me, "wni_gloss_with_determiner", "WNI-GLOSS-WITH-DETERMINER", 1, 0, false);
        declareFunction(me, "wni_suggest_adjective_comment", "WNI-SUGGEST-ADJECTIVE-COMMENT", 2, 0, false);
        declareFunction(me, "wni_suggest_verb_comment", "WNI-SUGGEST-VERB-COMMENT", 3, 0, false);
        declareFunction(me, "wni_common_comment_substitutions", "WNI-COMMON-COMMENT-SUBSTITUTIONS", 1, 0, false);
        declareFunction(me, "wni_verb_comment_substitutions", "WNI-VERB-COMMENT-SUBSTITUTIONS", 1, 0, false);
        declareFunction(me, "wni_suggest_verb_frame", "WNI-SUGGEST-VERB-FRAME", 4, 0, false);
        declareFunction(me, "wni_pluralize", "WNI-PLURALIZE", 1, 2, false);
        declareFunction(me, "wni_suggest_adverb_comment", "WNI-SUGGEST-ADVERB-COMMENT", 2, 0, false);
        return NIL;
    }
