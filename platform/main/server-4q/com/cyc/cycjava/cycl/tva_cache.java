...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class tva_cache extends SubLTranslatedFile {
    ...
    public static SubLObject tva_cache_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$tva_cache_native.class ? T : NIL;
    }
    ...
    public static SubLObject init_tva_cache_file() {
        ...
        deflexical("*SWAPPABLE-TVA-CACHE-LOCK*", SubLSystemTrampolineFile.maybeDefault($swappable_tva_cache_lock$, $swappable_tva_cache_lock$, NIL));
        deflexical("*TVA-CACHE-REGISTRY*", SubLSystemTrampolineFile.maybeDefault($tva_cache_registry$, $tva_cache_registry$, () -> dictionary.new_dictionary(symbol_function(EQL), UNPROVIDED)));
        defparameter("*TVA-CACHE-USE-MEMOIZED-SPEC-PRED-LISTS?*", NIL);
        deflexical("*TVA-CACHE-SPEC-PRED-STATS*", SubLSystemTrampolineFile.maybeDefault($tva_cache_spec_pred_stats$, $tva_cache_spec_pred_stats$, () -> dictionary.new_dictionary(symbol_function(EQUAL), UNPROVIDED)));
