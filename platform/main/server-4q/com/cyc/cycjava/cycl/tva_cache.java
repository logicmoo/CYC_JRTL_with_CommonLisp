...
public final class tva_cache extends SubLTranslatedFile {
    ...
    public static SubLObject tva_cache_p(final SubLObject v_object) {
        return v_object.getClass() == tva_cache.$tva_cache_native.class ? T : NIL;
    }

    public static SubLObject tva_cache_pred(final SubLObject v_object) {
        assert NIL != tva_cache_p(v_object) : "tva_cache.tva_cache_p(v_object) " + "CommonSymbols.NIL != tva_cache.tva_cache_p(v_object) " + v_object;
    ...
    public static SubLObject make_tva_cache(SubLObject arglist) {
        ...
        final SubLObject v_new = new tva_cache.$tva_cache_native();
        SubLObject next;
    ...
    public static final class $tva_cache_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(tva_cache.$tva_cache_native.class, TVA_CACHE, TVA_CACHE_P, $list23, $list24, new String[]{ "$pred", "$index_argnum", "$tva_pred_gafs", "$tvai_pred_gafs", "$map" }, $list25, $list26, PPRINT_TVA_CACHE);
        }
    }
