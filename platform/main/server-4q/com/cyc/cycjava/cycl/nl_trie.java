...
import static com.cyc.cycjava.cycl.nl_trie.*;
...
public final class nl_trie extends SubLTranslatedFile {
    ...
    public static SubLObject nl_trie_word_struc_p(final SubLObject v_object) {
        return v_object.getClass() == nl_trie.$nl_trie_word_struc_native.class ? T : NIL;
    }

    public static SubLObject nl_trie_word_struc_syntactic_supports(final SubLObject v_object) {
        assert NIL != nl_trie_word_struc_p(v_object) : "nl_trie.nl_trie_word_struc_p(v_object) " + "CommonSymbols.NIL != nl_trie.nl_trie_word_struc_p(v_object) " + v_object;
    ...
    public static SubLObject make_nl_trie_word_struc(SubLObject arglist) {
        ...
        final SubLObject v_new = new nl_trie.$nl_trie_word_struc_native();
        SubLObject next;
    ...
    public static final class $nl_trie_word_struc_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(nl_trie.$nl_trie_word_struc_native.class, NL_TRIE_WORD_STRUC, NL_TRIE_WORD_STRUC_P, $list109, $list110, new String[]{ "$syntactic_supports", "$semantic_supports" }, $list111, $list112, PPRINT_NL_TRIE_WORD_STRUC);
        }
    }
