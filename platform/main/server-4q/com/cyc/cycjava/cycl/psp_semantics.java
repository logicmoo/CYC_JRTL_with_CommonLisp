...
import com.cyc.cycjava.cycl.psp_semantics;
...
import static com.cyc.cycjava.cycl.psp_semantics.*;
...
public final class psp_semantics extends SubLTranslatedFile {
    ...
    public static SubLObject phrase_structure_parser_weighted_cycl_p(final SubLObject v_object) {
        return v_object.getClass() == psp_semantics.$phrase_structure_parser_weighted_cycl_native.class ? T : NIL;
    }

    public static SubLObject psp_weighted_cycl_cycl(final SubLObject v_object) {
        assert NIL != phrase_structure_parser_weighted_cycl_p(v_object) : "psp_semantics.phrase_structure_parser_weighted_cycl_p(v_object) " + "CommonSymbols.NIL != psp_semantics.phrase_structure_parser_weighted_cycl_p(v_object) " + v_object;
    ...
    public static SubLObject make_phrase_structure_parser_weighted_cycl(SubLObject arglist) {
        ...
        final SubLObject v_new = new psp_semantics.$phrase_structure_parser_weighted_cycl_native();
        SubLObject next;
    ...
    public static final class $phrase_structure_parser_weighted_cycl_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(psp_semantics.$phrase_structure_parser_weighted_cycl_native.class, PHRASE_STRUCTURE_PARSER_WEIGHTED_CYCL, PHRASE_STRUCTURE_PARSER_WEIGHTED_CYCL_P, $list2, $list3, new String[]{ "$cycl", "$weight" }, $list4, $list5, PPRINT_PSP_WEIGHTED_CYCL);
        }
    }
