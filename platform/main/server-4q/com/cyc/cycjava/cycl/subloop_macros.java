...
import com.cyc.cycjava.cycl.subloop_macros;
...
import static com.cyc.cycjava.cycl.subloop_macros.*;
...
public final class subloop_macros extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLList $list0 = list(makeSymbol("DEF-FORM"), makeSymbol("FUNCTION-NAME"), list(makeSymbol("METHOD-NAME"), makeSymbol("CLASS-NAME")), makeSymbol("LAMBDA-LIST"), makeSymbol("&REST"), makeSymbol("CLASSES"));

    public static final SubLString $str1$_S_P = makeString("~S-P");
    ...
    public static final SubLString $str5$_S____S_is_not_an_instance_of__S_ = makeString("~S: ~~S is not an instance of ~S.");
    ...
    public static final SubLList $list9 = list(makeSymbol("FUNCTION-NAME"), list(makeSymbol("METHOD-NAME"), makeSymbol("CLASS-NAME")), makeSymbol("LAMBDA-LIST"), makeSymbol("&REST"), makeSymbol("CLASSES"));

    public static final SubLSymbol DEF_OPTIMIZED_INSTANCE_METHOD_FUNCTION = makeSymbol("DEF-OPTIMIZED-INSTANCE-METHOD-FUNCTION");
    ...
    public static SubLObject declare_subloop_macros_file() {
        declareMacro(me, "def_optimized_instance_method_function", "DEF-OPTIMIZED-INSTANCE-METHOD-FUNCTION");
        declareMacro(me, "def_optimized_instance_method_function_public", "DEF-OPTIMIZED-INSTANCE-METHOD-FUNCTION-PUBLIC");
        declareMacro(me, "def_optimized_instance_method_function_protected", "DEF-OPTIMIZED-INSTANCE-METHOD-FUNCTION-PROTECTED");
        declareMacro(me, "def_optimized_instance_method_function_private", "DEF-OPTIMIZED-INSTANCE-METHOD-FUNCTION-PRIVATE");
        return NIL;
    }
