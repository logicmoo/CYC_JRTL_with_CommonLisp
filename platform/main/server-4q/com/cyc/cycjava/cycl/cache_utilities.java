...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class cache_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject cachemtr_hit_count(final SubLObject v_object) {
        assert NIL != cache_metrics_p(v_object) : "cache_utilities.cache_metrics_p error :" + v_object;
    ...
    public static SubLObject mcache_cache(final SubLObject v_object) {
        assert NIL != metered_cache_p(v_object) : "cache_utilities.metered_cache_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject rec_cachstrat_facade_cache_strategy(final SubLObject v_object) {
        assert NIL != recording_cache_strategy_facade_p(v_object) : "cache_utilities.recording_cache_strategy_facade_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $cache_metrics_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($cache_metrics_native.class, CACHE_METRICS, CACHE_METRICS_P, $list8, $list9, new String[]{ "$hit_count", "$miss_count" }, $list10, $list11, PRINT_CACHE_METRICS);
        }
    }
    ...
    public static final class $metered_cache_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($metered_cache_native.class, METERED_CACHE, METERED_CACHE_P, $list35, $list36, new String[]{ "$cache", "$metrics" }, $list37, $list38, PRINT_METERED_CACHE);
        }
    }
    ...
    public static final class $recording_cache_strategy_facade_native extends SubLStructNative {
        ...
        private $recording_cache_strategy_facade_native() {
        ...
        static {
            structDecl = makeStructDeclNative($recording_cache_strategy_facade_native.class, RECORDING_CACHE_STRATEGY_FACADE, RECORDING_CACHE_STRATEGY_FACADE_P, $list75, $list76, new String[]{ "$cache_strategy", "$records", "$timestamper" }, $list77, $list78, PRINT_RECORDING_CACHE_STRATEGY_FACADE);
        }
    }
