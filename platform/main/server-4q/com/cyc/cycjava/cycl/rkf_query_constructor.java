...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class rkf_query_constructor extends SubLTranslatedFile {
    ...
    public static SubLObject qc_query_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$qc_query_native.class ? T : NIL;
    }

    public static SubLObject qc_query_id(final SubLObject v_object) {
        assert NIL != qc_query_p(v_object) : "rkf_query_constructor.qc_query_p error :" + v_object;
    ...
    public static SubLObject qc_state_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$qc_state_native.class ? T : NIL;
    }

    public static SubLObject qc_state_id(final SubLObject v_object) {
        assert NIL != qc_state_p(v_object) : "rkf_query_constructor.qc_state_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static final class $qc_query_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($qc_query_native.class, QC_QUERY, QC_QUERY_P, $list7, $list8, new String[]{ "$id", "$cycl", "$terms", "$return_terms", "$constraints", "$var_map", "$scenario", "$assumed_terms", "$assumed_constraints" }, $list9, $list10, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $qc_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($qc_state_native.class, QC_STATE, QC_STATE_P, $list54, $list55, new String[]{ "$id", "$text", "$candidates", "$query", "$interaction", "$parsing_mt", "$generation_mt", "$domain_mt", "$domain_interaction_mt" }, $list56, $list57, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
