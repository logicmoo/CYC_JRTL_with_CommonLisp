...
public final class psp_parse_tree_generator extends SubLTranslatedFile {
    ...
    public static SubLObject psp_edge_equivalence_set_p(final SubLObject v_object) {
        return v_object.getClass() == psp_parse_tree_generator.$psp_edge_equivalence_set_native.class ? T : NIL;
    }

    public static SubLObject psp_equivalence_set_choice_dtr_num(final SubLObject v_object) {
        assert NIL != psp_edge_equivalence_set_p(v_object) : "psp_parse_tree_generator.psp_edge_equivalence_set_p(v_object) " + "CommonSymbols.NIL != psp_parse_tree_generator.psp_edge_equivalence_set_p(v_object) " + v_object;
    ...
    public static SubLObject make_psp_edge_equivalence_set(SubLObject arglist) {
        ...
        final SubLObject v_new = new psp_parse_tree_generator.$psp_edge_equivalence_set_native();
        SubLObject next;
    ...
    public static final class $psp_edge_equivalence_set_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(psp_parse_tree_generator.$psp_edge_equivalence_set_native.class, PSP_EDGE_EQUIVALENCE_SET, PSP_EDGE_EQUIVALENCE_SET_P, $list7, $list8, new String[]{ "$choice_dtr_num", "$edges" }, $list9, $list10, PPRINT_PSP_EQUIVALENCE_SET);
        }
    }
