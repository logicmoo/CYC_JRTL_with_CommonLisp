...
public final class ke_interaction_folder extends SubLTranslatedFile {
    ...
    public static SubLObject ke_interaction_folder_p(final SubLObject v_object) {
        return v_object.getClass() == ke_interaction_folder.$ke_interaction_folder_native.class ? T : NIL;
    }

    public static SubLObject ke_interaction_folder_id(final SubLObject v_object) {
        assert NIL != ke_interaction_folder_p(v_object) : "ke_interaction_folder.ke_interaction_folder_p(v_object) " + "CommonSymbols.NIL != ke_interaction_folder.ke_interaction_folder_p(v_object) " + v_object;
    ...
    public static SubLObject make_ke_interaction_folder(SubLObject arglist) {
        ...
        final SubLObject v_new = new ke_interaction_folder.$ke_interaction_folder_native();
        SubLObject next;
    ...
    public static final class $ke_interaction_folder_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(ke_interaction_folder.$ke_interaction_folder_native.class, KE_INTERACTION_FOLDER, KE_INTERACTION_FOLDER_P, $list51, $list52, new String[]{ "$id", "$mt", "$gloss", "$parent", "$children" }, $list53, $list54, PRINT_KE_INTERACTION_FOLDER);
        }
    }
