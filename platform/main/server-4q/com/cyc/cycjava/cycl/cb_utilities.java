...
public final class cb_utilities extends SubLTranslatedFile {
	...
	private static final SubLList $list57 = list(
			list(new SubLObject[] { reader_make_constant_shell(makeString("Collection")), reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("quotedIsa")), reader_make_constant_shell(makeString("genls")), reader_make_constant_shell(makeString("disjointWith")), reader_make_constant_shell(makeString("defnIff")), reader_make_constant_shell(makeString("quotedDefnIff")),
					reader_make_constant_shell(makeString("defnSufficient")), reader_make_constant_shell(makeString("quotedDefnSufficient")), reader_make_constant_shell(makeString("defnNecessary")), reader_make_constant_shell(makeString("quotedDefnNecessary")), reader_make_constant_shell(makeString("comment")), reader_make_constant_shell(makeString("cyclistNotes")),
					reader_make_constant_shell(makeString("sharedNotes")), reader_make_constant_shell(makeString("userDocComment")) }),
			list(new SubLObject[] { reader_make_constant_shell(makeString("Predicate")), reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("quotedIsa")), reader_make_constant_shell(makeString("genlPreds")), reader_make_constant_shell(makeString("genlInverse")), reader_make_constant_shell(makeString("negationPreds")), reader_make_constant_shell(makeString("negationInverse")),
					reader_make_constant_shell(makeString("arity")), reader_make_constant_shell(makeString("arityMin")), reader_make_constant_shell(makeString("argsIsa")), reader_make_constant_shell(makeString("argAndRestIsa")), reader_make_constant_shell(makeString("argsQuotedIsa")), reader_make_constant_shell(makeString("argAndRestQuotedIsa")), reader_make_constant_shell(makeString("argsGenl")),
					reader_make_constant_shell(makeString("argAndRestGenl")), reader_make_constant_shell(makeString("argIsa")), reader_make_constant_shell(makeString("argGenl")), reader_make_constant_shell(makeString("argQuotedIsa")), reader_make_constant_shell(makeString("arg1Isa")), reader_make_constant_shell(makeString("arg1QuotedIsa")), reader_make_constant_shell(makeString("arg1Genl")),
					reader_make_constant_shell(makeString("arg2Isa")), reader_make_constant_shell(makeString("arg2QuotedIsa")), reader_make_constant_shell(makeString("arg2Genl")), reader_make_constant_shell(makeString("arg3Isa")), reader_make_constant_shell(makeString("arg3QuotedIsa")), reader_make_constant_shell(makeString("arg3Genl")), reader_make_constant_shell(makeString("arg4Isa")),
					reader_make_constant_shell(makeString("arg4QuotedIsa")), reader_make_constant_shell(makeString("arg4Genl")), reader_make_constant_shell(makeString("arg5Isa")), reader_make_constant_shell(makeString("arg5QuotedIsa")), reader_make_constant_shell(makeString("arg5Genl")), reader_make_constant_shell(makeString("arg6Isa")), reader_make_constant_shell(makeString("arg6QuotedIsa")),
					reader_make_constant_shell(makeString("arg6Genl")), reader_make_constant_shell(makeString("arg7Isa")), reader_make_constant_shell(makeString("arg7QuotedIsa")), reader_make_constant_shell(makeString("arg7Genl")), reader_make_constant_shell(makeString("arg8Isa")), reader_make_constant_shell(makeString("arg8QuotedIsa")), reader_make_constant_shell(makeString("arg8Genl")),
					reader_make_constant_shell(makeString("arg9Isa")), reader_make_constant_shell(makeString("arg9QuotedIsa")), reader_make_constant_shell(makeString("arg9Genl")), reader_make_constant_shell(makeString("arg10Isa")), reader_make_constant_shell(makeString("arg10QuotedIsa")), reader_make_constant_shell(makeString("arg10Genl")), reader_make_constant_shell(makeString("arg11Isa")),
					reader_make_constant_shell(makeString("arg11QuotedIsa")), reader_make_constant_shell(makeString("arg11Genl")), reader_make_constant_shell(makeString("arg12Isa")), reader_make_constant_shell(makeString("arg12QuotedIsa")), reader_make_constant_shell(makeString("arg12Genl")), reader_make_constant_shell(makeString("fanOutArg")), reader_make_constant_shell(makeString("evaluationDefn")),
					reader_make_constant_shell(makeString("afterAdding")), reader_make_constant_shell(makeString("afterRemoving")), reader_make_constant_shell(makeString("comment")), reader_make_constant_shell(makeString("cyclistNotes")), reader_make_constant_shell(makeString("sharedNotes")), reader_make_constant_shell(makeString("userDocComment")) }),
			list(NIL, reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("quotedIsa")), reader_make_constant_shell(makeString("comment")), reader_make_constant_shell(makeString("cyclistNotes")), reader_make_constant_shell(makeString("sharedNotes")), reader_make_constant_shell(makeString("userDocComment"))),
			list(reader_make_constant_shell(makeString("Microtheory")), reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("quotedIsa")), reader_make_constant_shell(makeString("genlMt")), reader_make_constant_shell(makeString("comment")), reader_make_constant_shell(makeString("cyclistNotes")), reader_make_constant_shell(makeString("sharedNotes")),
					reader_make_constant_shell(makeString("userDocComment"))),
			list(new SubLObject[] { reader_make_constant_shell(makeString("Function-Denotational")), reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("quotedIsa")), reader_make_constant_shell(makeString("genlFuncs")), reader_make_constant_shell(makeString("genlFunctions")), reader_make_constant_shell(makeString("resultIsa")), reader_make_constant_shell(makeString("resultIsaArg")),
					reader_make_constant_shell(makeString("resultIsaArgIsa")), reader_make_constant_shell(makeString("resultGenl")), reader_make_constant_shell(makeString("resultGenlArg")), reader_make_constant_shell(makeString("arity")), reader_make_constant_shell(makeString("arityMin")), reader_make_constant_shell(makeString("argsIsa")), reader_make_constant_shell(makeString("argAndRestIsa")),
					reader_make_constant_shell(makeString("argsQuotedIsa")), reader_make_constant_shell(makeString("argAndRestQuotedIsa")), reader_make_constant_shell(makeString("argsGenl")), reader_make_constant_shell(makeString("argAndRestGenl")), reader_make_constant_shell(makeString("argIsa")), reader_make_constant_shell(makeString("argGenl")), reader_make_constant_shell(makeString("argQuotedIsa")),
					reader_make_constant_shell(makeString("arg1Isa")), reader_make_constant_shell(makeString("arg1QuotedIsa")), reader_make_constant_shell(makeString("arg1Genl")), reader_make_constant_shell(makeString("arg2Isa")), reader_make_constant_shell(makeString("arg2QuotedIsa")), reader_make_constant_shell(makeString("arg2Genl")), reader_make_constant_shell(makeString("arg3Isa")),
					reader_make_constant_shell(makeString("arg3QuotedIsa")), reader_make_constant_shell(makeString("arg3Genl")), reader_make_constant_shell(makeString("arg4Isa")), reader_make_constant_shell(makeString("arg4QuotedIsa")), reader_make_constant_shell(makeString("arg4Genl")), reader_make_constant_shell(makeString("arg5Isa")), reader_make_constant_shell(makeString("arg5QuotedIsa")),
	...
	private static final SubLList $list434 = list(new SubLObject[] { list(list(makeString("isa")), reader_make_constant_shell(makeString("isa"))), list(list(reader_make_constant_shell(makeString("isa"))), reader_make_constant_shell(makeString("isa"))), list(list(makeString("bd588104-9c29-11b1-9dad-c379636f7270")), reader_make_constant_shell(makeString("isa"))),
			list(list(makeString("Mx4rvViBBJwpEbGdrcN5Y29ycA")), reader_make_constant_shell(makeString("isa"))), list(list(makeString("331E2BBD5881049C2911B19DADC379636F7270")), reader_make_constant_shell(makeString("isa"))), list(list(NIL), NIL), list(list(list(makeString("isa"))), reader_make_constant_shell(makeString("isa"))), list(list(list(NIL)), NIL),
			list(list(list(makeString("bd588104-9c29-11b1-9dad-c379636f7270"))), reader_make_constant_shell(makeString("isa"))), list(list(list(makeString("Mx4rvViBBJwpEbGdrcN5Y29ycA"))), reader_make_constant_shell(makeString("isa"))), list(list(list(makeString("331E2BBD5881049C2911B19DADC379636F7270"))), reader_make_constant_shell(makeString("isa"))) });

	private static final SubLSymbol CB_GUESS_DATE = makeSymbol("CB-GUESS-DATE");

	private static final SubLList $list437 = list(new SubLObject[] { list(list(makeString("2064")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064))),
			list(list(makeString("from October 1977 to February 2064")),
					list(reader_make_constant_shell(makeString("TimeIntervalInclusiveFn")), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("October")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1977))),
							list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064))))),
			list(list(makeString("from 1977 to February 2064")), list(reader_make_constant_shell(makeString("TimeIntervalInclusiveFn")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1977)), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064))))),
			list(list(makeString("from 1977 to 2064")), list(reader_make_constant_shell(makeString("TimeIntervalInclusiveFn")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(1977)), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064)))),
			list(list(makeString("February 2064")), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064)))),
			list(list(makeString("February, 2064")), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064)))),
			list(list(makeString("February 29, 2064")), list(reader_make_constant_shell(makeString("DayFn")), makeInteger(29), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064))))),
			list(list(makeString("February 29th, 2064")), list(reader_make_constant_shell(makeString("DayFn")), makeInteger(29), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064))))), list(list(makeString("February 29xx, 2064")), NIL), list(list(makeString("February 29foo, 2064")), NIL),
			list(list(makeString("2/29/2064")), list(reader_make_constant_shell(makeString("DayFn")), makeInteger(29), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064))))),
			list(list(makeString("2-29-2064")), list(reader_make_constant_shell(makeString("DayFn")), makeInteger(29), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064))))),
			list(list(makeString("2:12 2-29-2064")),
					list(reader_make_constant_shell(makeString("MinuteFn")), TWELVE_INTEGER, list(reader_make_constant_shell(makeString("HourFn")), TWO_INTEGER, list(reader_make_constant_shell(makeString("DayFn")), makeInteger(29), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064))))))),
			list(list(makeString("2-29-2064 2:12")),
					list(reader_make_constant_shell(makeString("MinuteFn")), TWELVE_INTEGER, list(reader_make_constant_shell(makeString("HourFn")), TWO_INTEGER, list(reader_make_constant_shell(makeString("DayFn")), makeInteger(29), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064))))))),
			list(list(makeString("2-29-2064, 2:12")), list(reader_make_constant_shell(makeString("MinuteFn")), TWELVE_INTEGER,
					list(reader_make_constant_shell(makeString("HourFn")), TWO_INTEGER, list(reader_make_constant_shell(makeString("DayFn")), makeInteger(29), list(reader_make_constant_shell(makeString("MonthFn")), reader_make_constant_shell(makeString("February")), list(reader_make_constant_shell(makeString("YearFn")), makeInteger(2064))))))) });
	...
	public static SubLObject cb_form_cons_method_p(final SubLObject v_object) {
		return v_object.getJavaClass() == $cb_form_cons_method_native.class ? T : NIL;
	}

	public static SubLObject cb_form_cons_method_name(final SubLObject v_object) {
		assert NIL != cb_form_cons_method_p(v_object) : "cb_utilities.cb_form_cons_method_p error :" + v_object;
	...
	public static final class $cb_form_cons_method_native extends SubLStructNative {
		...
		private $cb_form_cons_method_native() {
			this.$name = Lisp.NIL;
		...
		static {
			structDecl = makeStructDeclNative($cb_form_cons_method_native.class, CB_FORM_CONS_METHOD, CB_FORM_CONS_METHOD_P, $list260, $list261, new String[] { "$name", "$keyword", "$applicability_test_fn", "$html_output_fn" }, $list262, $list263, PRINT_CB_FORM_CONS_METHODS);
		}
	}
