...
import static com.cyc.cycjava.cycl.cb_assertion_browser.*;
...
public final class cb_assertion_browser extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLString $$$Find_Assertion = makeString("Find Assertion");

    public static final SubLString $str1$cb_handle_find_assertion = makeString("cb-handle-find-assertion");

    public static final SubLSymbol CB_FIND_ASSERTION = makeSymbol("CB-FIND-ASSERTION");
    ...
    public static SubLObject cb_assertion_show_formula_variants(final SubLObject assertion) {
        ...
        if ((NIL != $cb_a_show_english$.getDynamicValue(thread)) || ($NL == $cb_major_presentation_language$.getDynamicValue(thread))) {
            _prev_bind_0 = $cb_major_presentation_language$.currentBinding(thread);
    ...
    public static SubLObject cb_link_clause_struc(final SubLObject clause_struc, SubLObject linktext) {
        ...
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != clause_strucs.clause_struc_p(clause_struc) : "clause_strucs.clause_struc_p(clause_struc) " + "CommonSymbols.NIL != clause_strucs.clause_struc_p(clause_struc) " + clause_struc;
    ...
    public static SubLObject declare_cb_assertion_browser_file() {
        declareFunction(me, "cb_find_assertion", "CB-FIND-ASSERTION", 0, 1, false);
        declareFunction(me, "cb_find_assertion_internal", "CB-FIND-ASSERTION-INTERNAL", 2, 2, false);
        declareFunction(me, "cb_link_find_assertion", "CB-LINK-FIND-ASSERTION", 0, 1, false);
        declareFunction(me, "cb_handle_find_assertion", "CB-HANDLE-FIND-ASSERTION", 1, 0, false);
        declareFunction(me, "cb_extract_find_assertion_args", "CB-EXTRACT-FIND-ASSERTION-ARGS", 1, 0, false);
        declareFunction(me, "cb_find_similar_assertion", "CB-FIND-SIMILAR-ASSERTION", 1, 0, false);
        declareFunction(me, "cb_link_find_similar_assertion", "CB-LINK-FIND-SIMILAR-ASSERTION", 1, 1, false);
        declareFunction(me, "cb_assertion", "CB-ASSERTION", 1, 0, false);
        declareFunction(me, "cb_af", "CB-AF", 1, 0, false);
        declareFunction(me, "cb_assertion_internal", "CB-ASSERTION-INTERNAL", 1, 0, false);
        declareFunction(me, "cb_assertion_info", "CB-ASSERTION-INFO", 1, 0, false);
        declareFunction(me, "cb_show_rule_info", "CB-SHOW-RULE-INFO", 1, 0, false);
        declareFunction(me, "cb_assertion_diagnostics", "CB-ASSERTION-DIAGNOSTICS", 1, 0, false);
        declareFunction(me, "cb_canonicalizer_problemP", "CB-CANONICALIZER-PROBLEM?", 1, 0, false);
        declareFunction(me, "cb_canonicalizer_problems", "CB-CANONICALIZER-PROBLEMS", 1, 0, false);
        declareFunction(me, "cb_assertion_exception_info", "CB-ASSERTION-EXCEPTION-INFO", 1, 0, false);
        declareFunction(me, "cb_assertion_doomed_info", "CB-ASSERTION-DOOMED-INFO", 1, 0, false);
        declareFunction(me, "cb_rule_assertion_analysis_info", "CB-RULE-ASSERTION-ANALYSIS-INFO", 1, 0, false);
        declareFunction(me, "cb_assertion_access_diagnostics", "CB-ASSERTION-ACCESS-DIAGNOSTICS", 1, 0, false);
        declareFunction(me, "cb_assertion_show_formula_variants", "CB-ASSERTION-SHOW-FORMULA-VARIANTS", 1, 0, false);
        declareFunction(me, "rule_variable_arg_constraints_formula", "RULE-VARIABLE-ARG-CONSTRAINTS-FORMULA", 1, 0, false);
        declareFunction(me, "constraint_formula_from_constraints_dict", "CONSTRAINT-FORMULA-FROM-CONSTRAINTS-DICT", 1, 1, false);
        declareFunction(me, "cb_assertion_variable_info", "CB-ASSERTION-VARIABLE-INFO", 1, 0, false);
        declareFunction(me, "assertion_variable_info_cols", "ASSERTION-VARIABLE-INFO-COLS", 2, 0, false);
        declareFunction(me, "cb_show_formula_madlibs", "CB-SHOW-FORMULA-MADLIBS", 1, 0, false);
        declareFunction(me, "cb_show_exception_rule_index", "CB-SHOW-EXCEPTION-RULE-INDEX", 1, 0, false);
        declareFunction(me, "cb_show_exception_rule_rec", "CB-SHOW-EXCEPTION-RULE-REC", 1, 0, false);
        declareFunction(me, "cb_show_exception_rule_rec_mt", "CB-SHOW-EXCEPTION-RULE-REC-MT", 2, 0, false);
        declareFunction(me, "cb_show_pragma_rule_index", "CB-SHOW-PRAGMA-RULE-INDEX", 1, 0, false);
        declareFunction(me, "cb_show_pragma_rule_rec", "CB-SHOW-PRAGMA-RULE-REC", 1, 0, false);
        declareFunction(me, "cb_show_pragma_rule_rec_mt", "CB-SHOW-PRAGMA-RULE-REC-MT", 2, 0, false);
        declareFunction(me, "cb_assertion_with_show_english", "CB-ASSERTION-WITH-SHOW-ENGLISH", 1, 0, false);
        declareFunction(me, "cb_link_show_english", "CB-LINK-SHOW-ENGLISH", 1, 1, false);
        declareFunction(me, "cb_assertion_with_show_el_formula", "CB-ASSERTION-WITH-SHOW-EL-FORMULA", 1, 0, false);
        declareFunction(me, "cb_link_show_el_formula", "CB-LINK-SHOW-EL-FORMULA", 1, 1, false);
        declareFunction(me, "cb_arguments", "CB-ARGUMENTS", 1, 0, false);
        declareFunction(me, "cb_link_arguments", "CB-LINK-ARGUMENTS", 1, 1, false);
        declareFunction(me, "cb_dependents", "CB-DEPENDENTS", 1, 0, false);
        declareFunction(me, "cb_link_dependents", "CB-LINK-DEPENDENTS", 1, 1, false);
        declareFunction(me, "cb_assertion_dependencies", "CB-ASSERTION-DEPENDENCIES", 1, 0, false);
        declareFunction(me, "cb_link_assertion_dependencies", "CB-LINK-ASSERTION-DEPENDENCIES", 1, 1, false);
        declareFunction(me, "cb_assertion_dependencies_internal", "CB-ASSERTION-DEPENDENCIES-INTERNAL", 1, 0, false);
        declareFunction(me, "cb_assertion_dependencies_section", "CB-ASSERTION-DEPENDENCIES-SECTION", 1, 0, false);
        declareFunction(me, "cb_deduction", "CB-DEDUCTION", 1, 0, false);
        declareFunction(me, "cb_deduction_id_url", "CB-DEDUCTION-ID-URL", 1, 0, false);
        declareFunction(me, "cb_link_deduction", "CB-LINK-DEDUCTION", 1, 1, false);
        declareFunction(me, "cb_link_deduction_struct", "CB-LINK-DEDUCTION-STRUCT", 1, 1, false);
        declareFunction(me, "cb_form_deduction_method", "CB-FORM-DEDUCTION-METHOD", 1, 2, false);
        declareFunction(me, "cb_deduction_internal", "CB-DEDUCTION-INTERNAL", 1, 0, false);
        declareFunction(me, "cb_deduction_toolbar", "CB-DEDUCTION-TOOLBAR", 1, 0, false);
        declareFunction(me, "cb_goto_previous_deduction_control", "CB-GOTO-PREVIOUS-DEDUCTION-CONTROL", 1, 0, false);
        declareFunction(me, "cb_goto_next_deduction_control", "CB-GOTO-NEXT-DEDUCTION-CONTROL", 1, 0, false);
        declareFunction(me, "cb_deduction_info", "CB-DEDUCTION-INFO", 1, 0, false);
        declareFunction(me, "cb_deduction_supports", "CB-DEDUCTION-SUPPORTS", 1, 0, false);
        declareFunction(me, "cb_justify", "CB-JUSTIFY", 1, 0, false);
        declareFunction(me, "cb_link_justify", "CB-LINK-JUSTIFY", 1, 1, false);
        declareFunction(me, "cb_justify_internal", "CB-JUSTIFY-INTERNAL", 1, 1, false);
        declareFunction(me, "cb_justify_deduction", "CB-JUSTIFY-DEDUCTION", 1, 1, false);
        declareFunction(me, "cb_justify_support", "CB-JUSTIFY-SUPPORT", 1, 1, false);
        declareFunction(me, "cb_asserted_argument", "CB-ASSERTED-ARGUMENT", 1, 0, false);
        declareFunction(me, "cb_show_support", "CB-SHOW-SUPPORT", 1, 1, false);
        declareFunction(me, "cb_show_justification_readably", "CB-SHOW-JUSTIFICATION-READABLY", 1, 1, false);
        declareFunction(me, "cb_hl_support", "CB-HL-SUPPORT", 1, 0, false);
        declareFunction(me, "cb_link_hl_support", "CB-LINK-HL-SUPPORT", 1, 2, false);
        declareFunction(me, "cb_hl_support_internal", "CB-HL-SUPPORT-INTERNAL", 2, 0, false);
        declareFunction(me, "cb_hl_support_toolbar", "CB-HL-SUPPORT-TOOLBAR", 2, 0, false);
        declareFunction(me, "cb_hl_support_info", "CB-HL-SUPPORT-INFO", 1, 0, false);
        declareFunction(me, "cb_hl_support_show_formula_variants", "CB-HL-SUPPORT-SHOW-FORMULA-VARIANTS", 1, 0, false);
        declareFunction(me, "cb_hl_support_justify", "CB-HL-SUPPORT-JUSTIFY", 1, 0, false);
        declareFunction(me, "cb_hl_support_justify_int", "CB-HL-SUPPORT-JUSTIFY-INT", 2, 0, false);
        declareFunction(me, "cb_hl_support_more_info", "CB-HL-SUPPORT-MORE-INFO", 1, 0, false);
        declareFunction(me, "cb_hl_support_argument", "CB-HL-SUPPORT-ARGUMENT", 1, 0, false);
        declareFunction(me, "cb_hl_support_dependents", "CB-HL-SUPPORT-DEPENDENTS", 1, 0, false);
        declareFunction(me, "cb_hl_support_identifier", "CB-HL-SUPPORT-IDENTIFIER", 1, 0, false);
        declareFunction(me, "cb_guess_hl_support", "CB-GUESS-HL-SUPPORT", 1, 0, false);
        declareFunction(me, "cb_link_hl_support_validate", "CB-LINK-HL-SUPPORT-VALIDATE", 2, 1, false);
        declareFunction(me, "cb_hl_validate", "CB-HL-VALIDATE", 1, 0, false);
        declareFunction(me, "cb_link_hl_support_similar_query", "CB-LINK-HL-SUPPORT-SIMILAR-QUERY", 1, 1, false);
        declareFunction(me, "cb_hl_support_similar_query", "CB-HL-SUPPORT-SIMILAR-QUERY", 1, 0, false);
        declareFunction(me, "cb_clause_struc", "CB-CLAUSE-STRUC", 1, 0, false);
        declareFunction(me, "cb_link_clause_struc", "CB-LINK-CLAUSE-STRUC", 1, 1, false);
        declareFunction(me, "cb_form_clause_struc_method", "CB-FORM-CLAUSE-STRUC-METHOD", 1, 2, false);
        declareFunction(me, "cb_clause_struc_internal", "CB-CLAUSE-STRUC-INTERNAL", 1, 0, false);
        declareFunction(me, "cb_cnf", "CB-CNF", 2, 0, false);
        declareFunction(me, "cb_guess_clause_struc", "CB-GUESS-CLAUSE-STRUC", 1, 0, false);
        declareFunction(me, "cb_process_suggested_english", "CB-PROCESS-SUGGESTED-ENGLISH", 1, 0, false);
        return NIL;
    }
