...
public final class parser extends SubLTranslatedFile {
	...
	public static final SubLList $list3 = list(list(makeSymbol("ERROR-HANDLING"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("TIMEOUT"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT"), list(makeSymbol("STREAM"), makeSymbol("DEPTH")), makeKeyword("PUBLIC")),
			list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PARSE"), list(makeSymbol("TEXT"), makeSymbol("&OPTIONAL"), makeSymbol("LEXICON"), makeSymbol("CONTEXT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("HANDLE-ERROR"), list(makeSymbol("ERROR")), makeKeyword("PRIVATE")));
	...
	private static final SubLString $str40$charniakparser_cyc_com = makeString("localhost"); //charniakparser.cyc.com
	...
	public static final SubLList $list52 = list(makeString("@param TEXT stringp; one or more English sentences, one per line\n   @return listp; the list of most likely parses for TEXT, one for each \n     sentence/line"),
			list(makeSymbol("CLET"), list(makeSymbol("PARSES"), makeSymbol("ERROR"), makeSymbol("TIMEOUT?"), makeSymbol("TREES")),
					list(makeSymbol("CATCH-ERROR-MESSAGE"), list(makeSymbol("ERROR")),
							list(makeSymbol("WITH-TIMEOUT"), list(makeSymbol("TIMEOUT"), makeSymbol("TIMEOUT?")), list(makeSymbol("CSETQ"), makeSymbol("PARSES"), list(makeSymbol("CHARNIAK-PARSE"), makeSymbol("TEXT"))), list(makeSymbol("PWHEN"), makeSymbol("TIMEOUT?"), list(makeSymbol("ERROR"), makeString("Charniak Parser timed out after ~a seconds"), makeSymbol("TIMEOUT")))),
							list(makeSymbol("PWHEN"), makeSymbol("ERROR"), list(makeSymbol("HANDLE-ERROR"), makeSymbol("SELF"), makeSymbol("ERROR")))),
	...
	private static final SubLList $list59 = list(makeString("@param TEXT stringp; a single English sentence\n   @return parse-tree-p; the most likely parse of TEXT"), list(makeSymbol("CHECK-TYPE"), makeSymbol("TEXT"), makeSymbol("STRINGP")), list(makeSymbol("CHECK-TYPE-IF-PRESENT"), makeSymbol("CONTEXT"), makeSymbol("PARSE-TREE-CONTEXT-P")),
			list(makeSymbol("CLET"), list(list(makeSymbol("PARSE"), list(makeSymbol("FIRST"), list(makeSymbol("FIM"), makeSymbol("SELF"), list(makeSymbol("QUOTE"), makeSymbol("PARSE-MULTIPLE")), list(makeSymbol("SUBSTITUTE"), CHAR_space, CHAR_newline, makeSymbol("TEXT")), makeSymbol("LEXICON"), makeSymbol("CONTEXT"))))),
					list(makeSymbol("PWHEN"), makeSymbol("PARSE"), list(makeSymbol("SET-PARSE-TREE-MOTHER"), makeSymbol("PARSE"), NIL)), list(makeSymbol("RET"), makeSymbol("PARSE"))));
	...
	private static final SubLString $str77$stanfordparser_cyc_com = makeString("localhost"); // stanfordparser.logicmoo.org
	...
	private static final SubLList $list85 = list(makeString("@param TEXT stringp; a single English sentence\n   @return parse-tree-p; the most likely parse of TEXT"),
			list(makeSymbol("CLET"), list(makeSymbol("PARSE"), makeSymbol("ERROR"), makeSymbol("TIMEOUT?")),
					list(makeSymbol("CATCH-ERROR-MESSAGE"), list(makeSymbol("ERROR")),
							list(makeSymbol("WITH-TIMEOUT"), list(makeSymbol("TIMEOUT"), makeSymbol("TIMEOUT?")), list(makeSymbol("CSETQ"), makeSymbol("PARSE"), list(makeSymbol("STANFORD-PARSE"), makeSymbol("TEXT"))), list(makeSymbol("PWHEN"), makeSymbol("TIMEOUT?"), list(makeSymbol("ERROR"), makeString("Stanford Parser timed out after ~a seconds "), makeSymbol("TIMEOUT")))),
							list(makeSymbol("PWHEN"), makeSymbol("ERROR"), list(makeSymbol("HANDLE-ERROR"), makeSymbol("SELF"), makeSymbol("ERROR")))),
					list(makeSymbol("RET"), list(makeSymbol("FWHEN"), makeSymbol("PARSE"), list(makeSymbol("NEW-PARSE-TREE"), list(makeSymbol("STRIP-SHELL"), makeSymbol("PARSE")), makeSymbol("LEXICON"), makeSymbol("CONTEXT"))))));
	...
	private static final SubLList $list122 = list(makeString("@param TEXT stringp; a single English sentence\n   @return linkage-p; the most likely linkage for TEXT"),
			list(makeSymbol("CLET"), list(makeSymbol("LINKAGE"), makeSymbol("ERROR"), makeSymbol("TIMEOUT?")),
					list(makeSymbol("CATCH-ERROR-MESSAGE"), list(makeSymbol("ERROR")),
							list(makeSymbol("WITH-TIMEOUT"), list(makeSymbol("TIMEOUT"), makeSymbol("TIMEOUT?")), list(makeSymbol("CSETQ"), makeSymbol("LINKAGE"), list(makeSymbol("NEW-LINKAGE"), makeSymbol("TEXT"), list(makeSymbol("LIST"), makeKeyword("CONTEXT"), makeSymbol("CONTEXT"), makeKeyword("OPTIONS"), makeSymbol("OPTIONS"), makeKeyword("LEXICON"), makeSymbol("LEXICON")))),
									list(makeSymbol("PWHEN"), makeSymbol("TIMEOUT?"), list(makeSymbol("ERROR"), makeString("Link Parser timed out after ~a seconds"), makeSymbol("TIMEOUT")))),
							list(makeSymbol("PWHEN"), makeSymbol("ERROR"), list(makeSymbol("HANDLE-ERROR"), makeSymbol("SELF"), makeSymbol("ERROR")))),
	...
	public static SubLObject ensure_link_server_running() {
		...
		if (NIL == linkage.link_ping(host, port, UNPROVIDED)) {
			...
			} else if ((NIL == $link_server_allow_local_start$.getGlobalValue()) || (NIL != listening_socketP($$$localhost, linkage.$link_port$.getDynamicValue(thread)))) {
				host = NIL;
				port = NIL;
			} else {
				host = $$$localhost;
