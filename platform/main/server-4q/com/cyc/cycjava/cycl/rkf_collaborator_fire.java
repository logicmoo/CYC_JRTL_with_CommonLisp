...
import com.cyc.cycjava.cycl.rkf_collaborator_fire;
...
import static com.cyc.cycjava.cycl.rkf_collaborator_fire.*;
...
public final class rkf_collaborator_fire extends SubLTranslatedFile {
    ...
    public static SubLObject kqml_object_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_collaborator_fire.$kqml_object_native.class ? T : NIL;
    }

    public static SubLObject kqml_object_performative(final SubLObject v_object) {
        assert NIL != kqml_object_p(v_object) : "rkf_collaborator_fire.kqml_object_p(v_object) " + "CommonSymbols.NIL != rkf_collaborator_fire.kqml_object_p(v_object) " + v_object;
    ...
    public static SubLObject make_kqml_object(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_collaborator_fire.$kqml_object_native();
        SubLObject next;
    ...
    public static SubLObject fire_session_p(final SubLObject v_object) {
        return v_object.getClass() == rkf_collaborator_fire.$fire_session_native.class ? T : NIL;
    }

    public static SubLObject fire_session_machine(final SubLObject v_object) {
        assert NIL != fire_session_p(v_object) : "rkf_collaborator_fire.fire_session_p(v_object) " + "CommonSymbols.NIL != rkf_collaborator_fire.fire_session_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_fire_session(SubLObject arglist) {
        ...
        final SubLObject v_new = new rkf_collaborator_fire.$fire_session_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $kqml_object_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_collaborator_fire.$kqml_object_native.class, KQML_OBJECT, KQML_OBJECT_P, $list22, $list23, new String[]{ "$performative", "$sender", "$receiver", "$from", "$to", "$in_reply_to", "$reply_with", "$language", "$ontology", "$content" }, $list24, $list25, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $fire_session_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(rkf_collaborator_fire.$fire_session_native.class, FIRE_SESSION, FIRE_SESSION_P, $list138, $list139, new String[]{ "$machine", "$port", "$kb_path", "$kb_name", "$predstyle" }, $list140, $list141, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
