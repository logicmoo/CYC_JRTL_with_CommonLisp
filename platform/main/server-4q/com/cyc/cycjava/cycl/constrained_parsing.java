...
public final class constrained_parsing extends SubLTranslatedFile {
    ...
    public static SubLObject parsing_faithfulness_filter_p(final SubLObject v_object) {
        return v_object.getClass() == constrained_parsing.$parsing_faithfulness_filter_native.class ? T : NIL;
    }

    public static SubLObject parsing_faithfulness_filter_type(final SubLObject v_object) {
        assert NIL != parsing_faithfulness_filter_p(v_object) : "constrained_parsing.parsing_faithfulness_filter_p(v_object) " + "CommonSymbols.NIL != constrained_parsing.parsing_faithfulness_filter_p(v_object) " + v_object;
    ...
    public static SubLObject make_parsing_faithfulness_filter(SubLObject arglist) {
        ...
        final SubLObject v_new = new constrained_parsing.$parsing_faithfulness_filter_native();
        SubLObject next;
    ...
    public static SubLObject parsing_arbitrary_filter_p(final SubLObject v_object) {
        return v_object.getClass() == constrained_parsing.$parsing_arbitrary_filter_native.class ? T : NIL;
    }

    public static SubLObject parsing_arbitrary_filter_type(final SubLObject v_object) {
        assert NIL != parsing_arbitrary_filter_p(v_object) : "constrained_parsing.parsing_arbitrary_filter_p(v_object) " + "CommonSymbols.NIL != constrained_parsing.parsing_arbitrary_filter_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_parsing_arbitrary_filter(SubLObject arglist) {
        ...
        final SubLObject v_new = new constrained_parsing.$parsing_arbitrary_filter_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $parsing_faithfulness_filter_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(constrained_parsing.$parsing_faithfulness_filter_native.class, PARSING_FAITHFULNESS_FILTER, PARSING_FAITHFULNESS_FILTER_P, $list31, $list32, new String[]{ "$type", "$mt" }, $list33, $list34, PPRINT_FAITHFULNESS_FILTER);
        }
    }
    ...
    public static final class $parsing_arbitrary_filter_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(constrained_parsing.$parsing_arbitrary_filter_native.class, PARSING_ARBITRARY_FILTER, PARSING_ARBITRARY_FILTER_P, $list58, $list59, new String[]{ "$type", "$details", "$mt" }, $list60, $list61, PPRINT_ARBITRARY_FILTER);
        }
    }
