...
import static com.cyc.cycjava.cycl.mail_message.*;
...
public final class mail_message extends SubLTranslatedFile {
    ...
    public static SubLObject message_p(final SubLObject v_object) {
        return v_object.getClass() == mail_message.$message_native.class ? T : NIL;
    }

    public static SubLObject msg_from(final SubLObject v_object) {
        assert NIL != message_p(v_object) : "mail_message.message_p(v_object) " + "CommonSymbols.NIL != mail_message.message_p(v_object) " + v_object;
    ...
    public static SubLObject make_message(SubLObject arglist) {
        ...
        final SubLObject v_new = new mail_message.$message_native();
        SubLObject next;
    ...
    public static SubLObject message_part_p(final SubLObject v_object) {
        return v_object.getClass() == mail_message.$message_part_native.class ? T : NIL;
    }

    public static SubLObject msg_part_content_type(final SubLObject v_object) {
        assert NIL != message_part_p(v_object) : "mail_message.message_part_p(v_object) " + "CommonSymbols.NIL != mail_message.message_part_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_message_part(SubLObject arglist) {
        ...
        final SubLObject v_new = new mail_message.$message_part_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $message_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(mail_message.$message_native.class, MESSAGE, MESSAGE_P, $list2, $list3, new String[]{ "$from", "$to", "$cc", "$bcc", "$subject", "$additional_headers", "$host", "$port", "$parts" }, $list4, $list5, PRINT_MESSAGE);
        }
    }
    ...
    public static final class $message_part_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(mail_message.$message_part_native.class, MESSAGE_PART, MESSAGE_PART_P, $list53, $list54, new String[]{ "$content_type", "$content_type_parameters", "$disposition", "$content_disposition_parameters", "$encoding", "$data", "$data_type" }, $list55, $list56, PRINT_MESSAGE_PART);
        }
    }
