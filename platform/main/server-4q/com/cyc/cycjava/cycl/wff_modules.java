...
import com.cyc.cycjava.cycl.wff_modules;
...
import static com.cyc.cycjava.cycl.wff_modules.*;
...
public final class wff_modules extends SubLTranslatedFile {
    ...
    public static final SubLList $list1 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-INVALID-VARIABLES"), makeKeyword("COMMENT"), makeString("The sentence has at least one variable which is not a valid variable name."));

    private static final SubLList $list2 = list(makeSymbol("VARIABLES"), makeSymbol("SENTENCE"));



    public static final SubLString $str4$Sentence__s_contains_invalid_vari = makeString("Sentence ~s contains invalid variable~P: ~a ~% which do~[~;es~:;~] not satisfy the regular expression ~a~%");



    public static final SubLString $str6$__ = makeString(", ");

    public static final SubLString $str7$__and_ = makeString(", and ");
    ...
    public static final SubLList $list11 = list(reader_make_constant_shell(makeString("CycLVariable")));





    public static final SubLList $list14 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-INVALID-SENTENCE"), makeKeyword("COMMENT"), makeString("Not a well-formed sentence."));
    ...
    public static final SubLList $list25 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-NOT-AN-ASCII-STRING"), makeKeyword("COMMENT"), makeString("The sentence references a non-ASCII string."));
    ...
    public static final SubLList $list32 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-MAL-FORT"), makeKeyword("COMMENT"), makeString("The sentence references an invalid (undefined) Fort."));
    ...
    public static final SubLList $list36 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-MAL-ARITY"), makeKeyword("COMMENT"), makeString("The arity of a predicate is a Non-Negative Integer."));
    ...
    private static final SubLList $list40 = list(reader_make_constant_shell(makeString("NonNegativeInteger")));



    public static final SubLList $list42 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-ARITY-MISMATCH"), makeKeyword("COMMENT"), makeString("The number of arguments applied to the relation in the sentence was different than the number of arguments it expected"));
    ...
    public static final SubLList $list46 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-VIOLATED-ARITY"), makeKeyword("COMMENT"), makeString("The sentence contains use of a predicate which does not conform to the arity of the relation."));
    ...
    private static final SubLObject $$FormulaArityFn = reader_make_constant_shell(makeString("FormulaArityFn"));
    ...
    public static final SubLList $list79 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-SEQUENCE-NON-VAR"), makeKeyword("COMMENT"), makeString("The formula contains an ill-formed sequence variable syntax"));
    ...
    public static final SubLList $list84 = list(makeSymbol("VIOLATING-NON-VARIABLES"), makeSymbol("SENTENCE"), makeSymbol("EXPAND-SUBL-FN"));
    ...
    public static final SubLList $list117 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-MAL-ARG-WRT-QUOTED-SUF-DEFNS"), makeKeyword("COMMENT"), makeString("The formula contains a term which violates #$quotedDefnSufficient of some Collection."));
    ...
    public static final SubLList $list120 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-MAL-ARG-WRT-NEC-DEFN"), makeKeyword("COMMENT"), makeString("The sentence contains a term which violates #$defnNecessary of some Collection."));

    public static final SubLList $list121 = listS(makeSymbol("ARG"), new SubLObject[]{ makeSymbol("RELN"), makeSymbol("PSN"), makeSymbol("COL"), makeSymbol("DEFN-COL"), makeSymbol("DEFN"), makeSymbol("MT"), makeSymbol("DATA") });
    ...
    private static final SubLObject $$ParaphraseFn = reader_make_constant_shell(makeString("ParaphraseFn"));

    private static final SubLObject $$CycLPhraseFn = reader_make_constant_shell(makeString("CycLPhraseFn"));

    private static final SubLObject $$SpecsFn = reader_make_constant_shell(makeString("SpecsFn"));

    public static final SubLList $list158 = list(reader_make_constant_shell(makeString("SpecsFn")), NIL);

    private static final SubLList $list159 = list(reader_make_constant_shell(makeString("SymbolPhraseFn")), reader_make_constant_shell(makeString("Comma-TheSymbol")));

    private static final SubLList $list160 = list(reader_make_constant_shell(makeString("PhraseFromStringFn")), makeString("but is"));

    private static final SubLObject $$ConcatenatePhrasesFn = reader_make_constant_shell(makeString("ConcatenatePhrasesFn"));

    public static final SubLList $list162 = list(reader_make_constant_shell(makeString("PhraseFromStringFn")), makeString("must be"));



    private static final SubLObject $$Np_DetNbarFn_Indefinite = reader_make_constant_shell(makeString("Np-DetNbarFn-Indefinite"));

    public static final SubLList $list165 = list(reader_make_constant_shell(makeString("PhraseFromStringFn")), makeString("a specialization of"));
    ...
    public static final SubLList $list179 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-MAL-ARG-WRT-ARG-QUOTED-ISA"), makeKeyword("COMMENT"), makeString("The sentence contains a term which violates argQuotedIsa constraint."));
    ...
    public static final SubLList $list185 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-MAL-ARG-WRT-ARG-NOT-ISA"), makeKeyword("COMMENT"), makeString("The sentence contains a term which is an instance of a collection specified to be an argNotIsa."));
    ...
    public static final SubLList $list195 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-MAL-ARG-WRT-INTER-ARG-ISA"), makeKeyword("COMMENT"), makeString("The sentence contains a term which is violates interArgIsa constraints."));
    ...
    private static final SubLObject $$interArgIsaGenl = reader_make_constant_shell(makeString("interArgIsaGenl"));
    ...
    private static final SubLObject $$genl = reader_make_constant_shell(makeString("genl"));

    private static final SubLSymbol $MAL_ARG_WRT_ARG_FORMAT = makeKeyword("MAL-ARG-WRT-ARG-FORMAT");

    public static final SubLList $list232 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-MAL-ARG-WRT-ARG-FORMAT"), makeKeyword("COMMENT"), makeString("The sentence contains a term which violates argFormat constraint."));

    public static final SubLList $list233 = list(makeSymbol("ARG"), makeSymbol("RELN"), makeSymbol("POS"), makeSymbol("FORMAT"), makeSymbol("MT"), makeSymbol("VIOLATIONS"), makeSymbol("&OPTIONAL"), makeSymbol("VIA"));
    ...
    public static final SubLList $list252 = list(makeSymbol("RELN"), makeSymbol("ARG1"), makeSymbol("PSN1"), makeSymbol("ARG2"), makeSymbol("PSN2"), makeSymbol("MT"), makeSymbol("&OPTIONAL"), makeSymbol("VIA"));
    ...
    public static final SubLList $list264 = list(makeSymbol("?ARGNUM"), makeSymbol("?COL"));
    ...
    public static final SubLList $list267 = list(makeSymbol("ASENT"), makeSymbol("MT"));
    ...
    public static final SubLList $list286 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-DISJOINTED-ARG-ISA"), makeKeyword("COMMENT"), makeString("The sentence contains a term which is said to be #$isa of disjoint collections."));
    ...
    public static final SubLList $list338 = list(makeSymbol("PRED"), makeSymbol("COL"), makeSymbol("MT"), makeSymbol("&OPTIONAL"), makeSymbol("VIOLATIONS"));
    ...
    public static final SubLList $list341 = list(makeKeyword("EXPLAIN-FUNC"), makeSymbol("EXPLAIN-META-PREDICATE-VIOLATION"), makeKeyword("COMMENT"), makeString(""));
    ...
    public static SubLObject declare_wff_modules_file() {
        declareFunction(me, "explain_invalid_variables", "EXPLAIN-INVALID-VARIABLES", 1, 1, false);
        declareFunction(me, "explain_invalid_sentence", "EXPLAIN-INVALID-SENTENCE", 1, 1, false);
        declareFunction(me, "explain_not_an_ascii_string", "EXPLAIN-NOT-AN-ASCII-STRING", 1, 1, false);
        declareFunction(me, "explain_mal_forts", "EXPLAIN-MAL-FORTS", 1, 1, false);
        declareFunction(me, "explain_mal_fort", "EXPLAIN-MAL-FORT", 1, 1, false);
        declareFunction(me, "explain_mal_arity", "EXPLAIN-MAL-ARITY", 1, 1, false);
        declareFunction(me, "explain_arity_mismatch", "EXPLAIN-ARITY-MISMATCH", 1, 1, false);
        declareFunction(me, "explain_violated_arity", "EXPLAIN-VIOLATED-ARITY", 1, 1, false);
        declareFunction(me, "explain_missing_arity", "EXPLAIN-MISSING-ARITY", 1, 1, false);
        declareFunction(me, "explain_malformed_args", "EXPLAIN-MALFORMED-ARGS", 1, 1, false);
        declareFunction(me, "explain_not_a_denotational_term", "EXPLAIN-NOT-A-DENOTATIONAL-TERM", 1, 1, false);
        declareFunction(me, "explain_not_a_truth_function", "EXPLAIN-NOT-A-TRUTH-FUNCTION", 1, 1, false);
        declareFunction(me, "explain_not_an_el_formula", "EXPLAIN-NOT-AN-EL-FORMULA", 1, 1, false);
        declareFunction(me, "explain_not_an_el_variable", "EXPLAIN-NOT-AN-EL-VARIABLE", 1, 1, false);
        declareFunction(me, "explain_not_a_list_of_variables", "EXPLAIN-NOT-A-LIST-OF-VARIABLES", 1, 1, false);
        declareFunction(me, "explain_sequence_non_var", "EXPLAIN-SEQUENCE-NON-VAR", 1, 1, false);
        declareFunction(me, "explain_expand_subl_fn_irrelevant_term_in_arg1", "EXPLAIN-EXPAND-SUBL-FN-IRRELEVANT-TERM-IN-ARG1", 1, 1, false);
        declareFunction(me, "explain_invalid_mt", "EXPLAIN-INVALID-MT", 1, 1, false);
        declareFunction(me, "explain_mal_function_nesting", "EXPLAIN-MAL-FUNCTION-NESTING", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_defns_int", "EXPLAIN-MAL-ARG-WRT-DEFNS-INT", 3, 0, false);
        declareFunction(me, "explain_mal_arg_wrt_iff_defns", "EXPLAIN-MAL-ARG-WRT-IFF-DEFNS", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_quoted_iff_defns", "EXPLAIN-MAL-ARG-WRT-QUOTED-IFF-DEFNS", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_suf_defns", "EXPLAIN-MAL-ARG-WRT-SUF-DEFNS", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_quoted_suf_defns", "EXPLAIN-MAL-ARG-WRT-QUOTED-SUF-DEFNS", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_nec_defn_int", "EXPLAIN-MAL-ARG-WRT-NEC-DEFN-INT", 3, 0, false);
        declareFunction(me, "explain_mal_arg_wrt_nec_defn", "EXPLAIN-MAL-ARG-WRT-NEC-DEFN", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_quoted_nec_defn", "EXPLAIN-MAL-ARG-WRT-QUOTED-NEC-DEFN", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_col_defn_int", "EXPLAIN-MAL-ARG-WRT-COL-DEFN-INT", 4, 0, false);
        declareFunction(me, "explain_mal_arg_wrt_col_defn", "EXPLAIN-MAL-ARG-WRT-COL-DEFN", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_col_quoted_defn", "EXPLAIN-MAL-ARG-WRT-COL-QUOTED-DEFN", 1, 1, false);
        declareFunction(me, "explanation_constraint_string", "EXPLANATION-CONSTRAINT-STRING", 1, 0, false);
        declareFunction(me, "explanation_disjoint_string", "EXPLANATION-DISJOINT-STRING", 1, 0, false);
        declareFunction(me, "explanation_pred_from_type", "EXPLANATION-PRED-FROM-TYPE", 1, 0, false);
        declareFunction(me, "hl_explanation_via_genl_pred", "HL-EXPLANATION-VIA-GENL-PRED", 6, 0, false);
        declareFunction(me, "hl_explanation_via_genl_inverse", "HL-EXPLANATION-VIA-GENL-INVERSE", 6, 0, false);
        declareFunction(me, "hl_explanation_for_pred", "HL-EXPLANATION-FOR-PRED", 5, 0, false);
        declareFunction(me, "hl_explanation_from_why_not", "HL-EXPLANATION-FROM-WHY-NOT", 2, 1, false);
        declareFunction(me, "nl_explanation_from_why_not", "NL-EXPLANATION-FROM-WHY-NOT", 3, 0, false);
        declareFunction(me, "nl_explanation_from_why_not_with_disjoint", "NL-EXPLANATION-FROM-WHY-NOT-WITH-DISJOINT", 2, 1, false);
        declareFunction(me, "nl_explanation_of_why_not_terse", "NL-EXPLANATION-OF-WHY-NOT-TERSE", 3, 0, false);
        declareFunction(me, "get_type_phrase", "GET-TYPE-PHRASE", 2, 0, false);
        declareFunction(me, "explain_mal_arg_wrt_arg_isa_int", "EXPLAIN-MAL-ARG-WRT-ARG-ISA-INT", 3, 0, false);
        declareFunction(me, "explain_mal_arg_wrt_arg_isa", "EXPLAIN-MAL-ARG-WRT-ARG-ISA", 1, 1, false);
        declareFunction(me, "new_explain_mal_arg_wrt_arg_isa", "NEW-EXPLAIN-MAL-ARG-WRT-ARG-ISA", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_arg_quoted_isa", "EXPLAIN-MAL-ARG-WRT-ARG-QUOTED-ISA", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_arg_genl", "EXPLAIN-MAL-ARG-WRT-ARG-GENL", 1, 1, false);
        declareFunction(me, "new_explain_mal_arg_wrt_arg_genl", "NEW-EXPLAIN-MAL-ARG-WRT-ARG-GENL", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_arg_not_isa", "EXPLAIN-MAL-ARG-WRT-ARG-NOT-ISA", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_arg_not_isa_disjoint_int", "EXPLAIN-MAL-ARG-WRT-ARG-NOT-ISA-DISJOINT-INT", 4, 0, false);
        declareFunction(me, "explain_mal_arg_wrt_arg_not_isa_disjoint", "EXPLAIN-MAL-ARG-WRT-ARG-NOT-ISA-DISJOINT", 1, 1, false);
        declareFunction(me, "new_explain_mal_arg_wrt_arg_not_isa_disjoint", "NEW-EXPLAIN-MAL-ARG-WRT-ARG-NOT-ISA-DISJOINT", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_arg_not_quoted_isa_disjoint", "EXPLAIN-MAL-ARG-WRT-ARG-NOT-QUOTED-ISA-DISJOINT", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_arg_not_genls_disjoint", "EXPLAIN-MAL-ARG-WRT-ARG-NOT-GENLS-DISJOINT", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_isa", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-ISA", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_not_isa", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-NOT-ISA", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_genl", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-GENL", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_defn", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-DEFN", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_not_defn", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-NOT-DEFN", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_not_isa_disjoint", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-NOT-ISA-DISJOINT", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_not_genl_disjoint", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-NOT-GENL-DISJOINT", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_isa_genl", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-ISA-GENL", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_genl_isa", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-GENL-ISA", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_arg_format", "EXPLAIN-MAL-ARG-WRT-ARG-FORMAT", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_format", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-FORMAT", 1, 1, false);
        declareFunction(me, "explain_mal_arg_wrt_inter_arg_different", "EXPLAIN-MAL-ARG-WRT-INTER-ARG-DIFFERENT", 1, 1, false);
        declareFunction(me, "explain_mal_reln_wrt_arg_isa_required", "EXPLAIN-MAL-RELN-WRT-ARG-ISA-REQUIRED", 1, 1, false);
        declareFunction(me, "explain_conflict_asserting_true_sbhl", "EXPLAIN-CONFLICT-ASSERTING-TRUE-SBHL", 1, 1, false);
        declareFunction(me, "why_sbhl_false", "WHY-SBHL-FALSE", 3, 1, false);
        declareFunction(me, "sbhl_nl_inverse", "SBHL-NL-INVERSE", 1, 0, false);
        declareFunction(me, "explain_conflict_asserting_false_sbhl", "EXPLAIN-CONFLICT-ASSERTING-FALSE-SBHL", 1, 1, false);
        declareFunction(me, "why_sbhl_true", "WHY-SBHL-TRUE", 3, 1, false);
        declareFunction(me, "explain_disjointed_arg_isa", "EXPLAIN-DISJOINTED-ARG-ISA", 1, 1, false);
        declareFunction(me, "nl_explanation_of_verbose_data", "NL-EXPLANATION-OF-VERBOSE-DATA", 1, 0, false);
        declareFunction(me, "explain_disjointed_arg_quoted_isa", "EXPLAIN-DISJOINTED-ARG-QUOTED-ISA", 1, 1, false);
        declareFunction(me, "explain_disjointed_arg_genl", "EXPLAIN-DISJOINTED-ARG-GENL", 1, 1, false);
        declareFunction(me, "explain_isolated_terms", "EXPLAIN-ISOLATED-TERMS", 1, 1, false);
        declareFunction(me, "explain_irrelevant_literals", "EXPLAIN-IRRELEVANT-LITERALS", 1, 1, false);
        declareFunction(me, "explain_restricted_skolem_assertion", "EXPLAIN-RESTRICTED-SKOLEM-ASSERTION", 1, 1, false);
        declareFunction(me, "explain_restricted_predicate_assertion", "EXPLAIN-RESTRICTED-PREDICATE-ASSERTION", 1, 1, false);
        declareFunction(me, "explain_restricted_collection_assertion", "EXPLAIN-RESTRICTED-COLLECTION-ASSERTION", 1, 1, false);
        declareFunction(me, "explain_evaluatable_literal_false", "EXPLAIN-EVALUATABLE-LITERAL-FALSE", 1, 1, false);
        declareFunction(me, "explain_except_for_wXo_singleton_var", "EXPLAIN-EXCEPT-FOR-W/O-SINGLETON-VAR", 1, 1, false);
        declareFunction(me, "explain_invalid_mt_for_tou", "EXPLAIN-INVALID-MT-FOR-TOU", 1, 1, false);
        declareFunction(me, "explain_non_defn_pred_in_vocab_mt", "EXPLAIN-NON-DEFN-PRED-IN-VOCAB-MT", 1, 1, false);
        declareFunction(me, "explain_predicate_isa_violation", "EXPLAIN-PREDICATE-ISA-VIOLATION", 1, 1, false);
        declareFunction(me, "explain_meta_predicate_violation", "EXPLAIN-META-PREDICATE-VIOLATION", 1, 1, false);
        declareFunction(me, "explain_mal_precanonicalizations", "EXPLAIN-MAL-PRECANONICALIZATIONS", 1, 1, false);
        declareFunction(me, "explain_invalid_expansion", "EXPLAIN-INVALID-EXPANSION", 1, 1, false);
        declareFunction(me, "explain_recursion_limit_exceeded", "EXPLAIN-RECURSION-LIMIT-EXCEEDED", 1, 1, false);
        declareFunction(me, "explain_el_unevaluatable_expression", "EXPLAIN-EL-UNEVALUATABLE-EXPRESSION", 1, 1, false);
        declareFunction(me, "explain_quantified_sequence_variable", "EXPLAIN-QUANTIFIED-SEQUENCE-VARIABLE", 1, 1, false);
        declareFunction(me, "explain_too_many_sequence_vars_in_skolem_scope", "EXPLAIN-TOO-MANY-SEQUENCE-VARS-IN-SKOLEM-SCOPE", 1, 1, false);
        declareFunction(me, "explain_ambiguous_var_type_in_skolem_scope", "EXPLAIN-AMBIGUOUS-VAR-TYPE-IN-SKOLEM-SCOPE", 1, 1, false);
        declareFunction(me, "explain_inhibited_sequence_variable", "EXPLAIN-INHIBITED-SEQUENCE-VARIABLE", 1, 1, false);
        declareFunction(me, "explain_too_many_commutative_in_args_and_rest", "EXPLAIN-TOO-MANY-COMMUTATIVE-IN-ARGS-AND-REST", 1, 1, false);
        declareFunction(me, "explain_cyclic_commutative_in_args", "EXPLAIN-CYCLIC-COMMUTATIVE-IN-ARGS", 1, 1, false);
        declareFunction(me, "explain_defining_mt_violation", "EXPLAIN-DEFINING-MT-VIOLATION", 1, 1, false);
        declareFunction(me, "explain_disjunct_in_pragmatic_requirement", "EXPLAIN-DISJUNCT-IN-PRAGMATIC-REQUIREMENT", 1, 1, false);
        declareFunction(me, "explain_bad_exponential_disjunction", "EXPLAIN-BAD-EXPONENTIAL-DISJUNCTION", 1, 1, false);
        declareFunction(me, "explain_bad_exponential_conjunction", "EXPLAIN-BAD-EXPONENTIAL-CONJUNCTION", 1, 1, false);
        declareFunction(me, "explain_restricted_mt_assertion", "EXPLAIN-RESTRICTED-MT-ASSERTION", 1, 1, false);
        declareFunction(me, "explain_simplification_to_tautology_due_to_pos_and_neg_literal", "EXPLAIN-SIMPLIFICATION-TO-TAUTOLOGY-DUE-TO-POS-AND-NEG-LITERAL", 1, 1, false);
        declareFunction(me, "explain_reifiable_but_not_forward_reifiable", "EXPLAIN-REIFIABLE-BUT-NOT-FORWARD-REIFIABLE", 1, 1, false);
        return NIL;
    }
