...
public final class cb_inferred_index
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject cb_inferred_index_frame(final SubLObject args)
  {
    ...
    if( NIL == index_hook )
    {
      return cb_utilities.cb_error( $str6$Unable_to_determine_a_term_from__, index_id, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
  ...
  public static SubLObject cb_link_inferred_index(final SubLObject v_term, SubLObject linktext, SubLObject target)
  {
    ...
    PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str11$cb_inferred_index_frame__A, index_id );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
  ...
  public static SubLObject cb_link_legacy_index(final SubLObject v_term, SubLObject linktext, SubLObject target)
  {
    ...
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str16$cb_legacy_index_frame__A, index_id );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    if( NIL != frame_name_var )
    {
      html_utilities.html_markup( html_macros.$html_anchor_target$.getGlobalValue() );
  ...
  public static SubLObject cb_show_inferred_gaf_arg_index_utilities_section(final SubLObject v_term)
  {
    ...
    html_utilities.html_princ_strong( $str23$Browsing___ );
    cb_utilities.cb_link( $kw24$DOCUMENTATION, v_term, $str25$documentation, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    html_utilities.html_princ( $str26$___ );
    cb_utilities.cb_link( $kw27$DEFINITIONAL, v_term, $str28$definitional, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    html_utilities.html_princ( $str26$___ );
    cb_utilities.cb_link( $kw29$LEXICAL, v_term, NIL, $str30$lexical, UNPROVIDED, UNPROVIDED );
    if( NIL != cb_parameters.$cb_editing_enabled$.getDynamicValue( thread ) )
    {
      html_utilities.html_newline( UNPROVIDED );
      html_utilities.html_princ_strong( $str31$Editing___ );
      if( NIL != sksi_smt.$allow_smt_editing_links$.getDynamicValue( thread ) && NIL != sksi_kb_accessors.sk_source_in_any_mt_p( v_term ) && NIL != sksi_infrastructure_utilities.top_level_knowledge_source_in_any_mt_p(
          v_term ) )
      {
        cb_utilities.cb_link( $kw32$EDIT_IN_SMT, v_term, $str33$edit_in_SMT, UNPROVIDED, UNPROVIDED, UNPROVIDED );
        html_utilities.html_princ( $str26$___ );
      }
      cb_utilities.cb_link( $kw34$CREATE_SIMILAR, v_term, $str35$copy, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      if( NIL != constant_handles.constant_p( v_term ) )
      {
        html_utilities.html_princ( $str26$___ );
        cb_utilities.cb_link( $kw36$RENAME, v_term, $str37$rename, not_modifiableP, UNPROVIDED, UNPROVIDED );
      }
      ...
      if( NIL != unlexifiedP )
      {
        ...
        cb_utilities.cb_link( $kw38$LEXIFY_TERM, v_term, $str39$lexify, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      ...
      {
        html_utilities.html_princ( $str26$___ );
        cb_utilities.cb_link( $kw40$MERGE, v_term, $str41$merge, not_modifiableP, UNPROVIDED, UNPROVIDED );
      }
      html_utilities.html_princ( $str26$___ );
      cb_utilities.cb_link( ( NIL != cb_parameters.$cb_confirm_kills$.getDynamicValue( thread ) ) ? $kw42$CONFIRM_KILL : $kw43$KILL, v_term, $str44$kill, not_modifiableP, UNPROVIDED, UNPROVIDED );
      if( NIL != fort_types_interface.collectionP( v_term ) )
      {
        html_utilities.html_princ( $str26$___ );
        html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
        cb_utilities.cb_link( $kw45$CREATE_INSTANCE, v_term, $str46$create_instance, UNPROVIDED, UNPROVIDED, UNPROVIDED );
        html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
        html_utilities.html_princ( $str26$___ );
        html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
        cb_utilities.cb_link( $kw47$CREATE_SPEC, v_term, $str48$create_spec, UNPROVIDED, UNPROVIDED, UNPROVIDED );
        html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
      }
    }
    html_utilities.html_newline( UNPROVIDED );
    html_utilities.html_princ_strong( $str49$Advanced___ );
    if( NIL != forts.fort_p( v_term ) )
    {
      cb_utilities.cb_link( $kw50$CHRONOLOGICAL_ORDER, v_term, $str51$history, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      html_utilities.html_princ( $str26$___ );
    }
    if( NIL != nart_handles.nart_p( v_term ) )
    {
      cb_utilities.cb_link( $kw52$DESCRIBE_NART, v_term, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      html_utilities.html_princ( $str26$___ );
    }
    else if( NIL != constant_handles.constant_p( v_term ) )
    {
      cb_utilities.cb_link( $kw53$DESCRIBE_CONSTANT, v_term, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      html_utilities.html_princ( $str26$___ );
    }
    if( NIL != kct_utils.kct_test_spec_p( v_term, UNPROVIDED ) )
    {
      ...
      if( NIL != ttt_linkP )
      {
        cb_utilities.cb_link( $kw54$TTT_TEST, v_term, $str55$take_test, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
      else
      {
        cb_utilities.cb_link( $kw56$KCT_TEST, v_term, $str57$run_test, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
      html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
    }
    if( NIL != kb_query.kbq_query_spec_p( v_term ) || NIL != kct_utils.kct_test_spec_p( v_term, UNPROVIDED ) )
    {
      ...
      if( NIL != forts.fort_p( query ) )
      {
        html_utilities.html_princ( $str26$___ );
        html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
        cb_utilities.cb_link( $kw58$KBQ_ASK, query, $str59$ask_query, UNPROVIDED, UNPROVIDED, UNPROVIDED );
        html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
        if( NIL != cb_kb_query.kbq_query_practice_rules( query ) )
        {
          html_utilities.html_princ( $str26$___ );
          html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
          cb_utilities.cb_link( $kw60$KBQ_ASK_IN_PROOF_CHECKER, query, $str61$proof_check_query, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
        }
      }
      html_utilities.html_princ( $str26$___ );
      ...
      if( NIL != kct_utils.kct_test_spec_p( v_term, UNPROVIDED ) )
      {
        cb_utilities.cb_link( $kw62$KCT_EDIT, v_term, $str63$edit_test, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
      else
      {
        cb_utilities.cb_link( $kw64$KBQ_EDIT, query, $str65$edit_query, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
      html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
    }
    if( NIL != cb_parameters.$show_kb_monitor_links$.getDynamicValue( thread ) )
    {
      html_utilities.html_princ( $str26$___ );
      html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
      cb_utilities.cb_link( $kw66$KB_MONITOR_INDEX_HOOK, v_term, $str67$monitor, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
    }
    if( NIL != kct_utils.kct_test_collection_p( v_term, UNPROVIDED ) )
    {
      ...
      html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
      cb_utilities.cb_link( $kw68$KCT_TEST_SET, v_term, $str69$run_test_set, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
    }
    html_utilities.html_princ( $str26$___ );
    cb_browser.cb_c_index_views( v_term, $str70$more_filters );
    if( NIL == cb_tools.cb_fastP() )
    {
      dhtml_macros.js_delayed_load_int( ConsesLow.list( new SubLObject[] { $kw71$HANDLER, $sym72$CB_C_PERTINENT_QUERY_LINKS, $kw73$ARGS, ConsesLow.list( reader.bq_cons( $str74$term, v_term ) ), $kw75$MESSAGE,
        $str76$Checking_for_Pertinent_Queries___, $kw77$TAG, $str78$div, $kw79$DELAY, $int80$50
      } ) );
    }
    return NIL;
  }
  ...
  public static SubLObject cb_possibly_show_term_as_seen_from_mt_header(final SubLObject mt, SubLObject newline_mode)
  {
    ...
    {
      newline_mode = $kw81$BEFORE;
    }
    if( NIL == kb_utilities.kbeq( mt, $const82$EverythingPSC ) )
    {
      SubLObject pcase_var = newline_mode;
      if( pcase_var.eql( $kw81$BEFORE ) || pcase_var.eql( $kw83$BOTH ) )
      {
        html_utilities.html_newline( UNPROVIDED );
      }
      cb_show_term_as_seen_from_mt_header( mt );
      pcase_var = newline_mode;
      if( pcase_var.eql( $kw84$AFTER ) || pcase_var.eql( $kw83$BOTH ) )
      {
        html_utilities.html_newline( UNPROVIDED );
      }
      return mt;
  ...
  public static SubLObject cb_show_term_as_seen_from_mt_header(final SubLObject mt)
  {
    ...
    html_utilities.html_princ( $str85$as_seen_from );
  ...
  public static SubLObject cb_show_inferred_gaf_arg_index_header(final SubLObject v_term, final SubLObject filters, final SubLObject order_by)
  {
    ...
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    html_utilities.html_markup( $str86$100_ );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
    final SubLObject _prev_bind_0 = html_macros.$html_safe_print$.currentBinding( thread );
    try
    {
      ...
      try
      {
        ...
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_markup( html_utilities.html_align( $kw87$LEFT ) );
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_markup( html_macros.$html_table_data_valign$.getGlobalValue() );
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_markup( html_utilities.html_align( $kw88$TOP ) );
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
        ...
        {
          html_macros.$html_safe_print$.bind( T, thread );
          final SubLObject size = cb_utilities.cb_term_font_size( v_term, UNPROVIDED, UNPROVIDED );
          html_utilities.html_markup( html_macros.$html_strong_head$.getGlobalValue() );
          ...
          html_utilities.html_markup( html_macros.$html_strong_tail$.getGlobalValue() );
          final SubLObject browsing_mt = inferred_indexing.inferred_index_filters_extract_microtheory( filters );
          cb_possibly_show_term_as_seen_from_mt_header( browsing_mt, $kw81$BEFORE );
        }
        finally
        {
        ...
        html_utilities.html_markup( html_macros.$html_table_data_align$.getGlobalValue() );
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_markup( html_utilities.html_align( $kw89$RIGHT ) );
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_markup( html_macros.$html_table_data_valign$.getGlobalValue() );
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_markup( html_utilities.html_align( $kw88$TOP ) );
        ...
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_markup( $str90$40_ );
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
        ...
        try
        {
          ...
          html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
          html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
          html_utilities.html_princ( $str91$order_by__ );
          html_utilities.html_indent( UNPROVIDED );
          if( order_by == $kw92$PREDICATE )
          {
            html_utilities.html_markup( html_macros.$html_strong_head$.getGlobalValue() );
            html_utilities.html_princ( $str93$predicate );
            html_utilities.html_markup( html_macros.$html_strong_tail$.getGlobalValue() );
          }
          else
          {
            cb_utilities.cb_link( $kw94$INFERRED_INDEX_ORDER_BY, v_term, $kw92$PREDICATE, $str93$predicate, UNPROVIDED, UNPROVIDED );
          }
          html_utilities.html_indent( UNPROVIDED );
          if( order_by == $kw0$ONTOLOGY )
          {
            html_utilities.html_markup( html_macros.$html_strong_head$.getGlobalValue() );
            html_utilities.html_princ( $str95$ontology );
            html_utilities.html_markup( html_macros.$html_strong_tail$.getGlobalValue() );
          }
          else
          {
            cb_utilities.cb_link( $kw94$INFERRED_INDEX_ORDER_BY, v_term, $kw0$ONTOLOGY, $str95$ontology, UNPROVIDED, UNPROVIDED );
          }
          html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
          html_utilities.html_newline( UNPROVIDED );
          html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
          html_utilities.html_princ( $str96$filters__ );
          html_utilities.html_indent( UNPROVIDED );
          cb_utilities.cb_link( $kw97$INFERRED_INDEX_PREDICATE_FILTERS, v_term, $str93$predicate, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          html_utilities.html_indent( UNPROVIDED );
          cb_utilities.cb_link( $kw98$INFERRED_INDEX_ONTOLOGY_FILTERS, v_term, $str95$ontology, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          html_utilities.html_indent( UNPROVIDED );
          cb_utilities.cb_link( $kw99$INFERRED_INDEX_MICROTHEORY_FILTERS, v_term, $str100$mt, UNPROVIDED, UNPROVIDED, UNPROVIDED );
          html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
          html_utilities.html_newline( UNPROVIDED );
          html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
          html_utilities.html_princ( $str101$index_view__ );
          html_utilities.html_indent( UNPROVIDED );
          html_utilities.html_markup( html_macros.$html_strong_head$.getGlobalValue() );
          cb_utilities.cb_link( $kw12$INFERRED_INDEX, v_term, $str102$inferred, $kw9$SELF, UNPROVIDED, UNPROVIDED );
          html_utilities.html_markup( html_macros.$html_strong_tail$.getGlobalValue() );
          html_utilities.html_indent( UNPROVIDED );
          cb_utilities.cb_link( $kw17$LEGACY_INDEX, v_term, $str103$legacy, $kw9$SELF, UNPROVIDED, UNPROVIDED );
          html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
          html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
        }
        finally
  ...
  public static SubLObject cb_show_inferred_gaf_arg_index(final SubLObject v_term, SubLObject filters, SubLObject order_by)
  {
    ...
    if( pcase_var.eql( $kw0$ONTOLOGY ) )
    {
      return cb_show_inferred_gaf_arg_index_by_ontology( v_term, tuple_groups );
    }
    if( pcase_var.eql( $kw92$PREDICATE ) )
    {
      return cb_show_inferred_gaf_arg_index_by_predicate( v_term, tuple_groups );
    }
    return cb_utilities.cb_error( $str104$Unexpected_order_by____S, order_by, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  public static SubLObject cb_show_inferred_gaf_arg_index_by_ontology(final SubLObject v_term, final SubLObject tuple_groups)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
      html_utilities.html_princ( $str106$via_ );
      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
      cb_utilities.cb_link( $kw107$INFERRED_GAF_ARG_ASSERTIONS, v_term, group_qua, group_qua, UNPROVIDED, UNPROVIDED );
      final SubLObject count = inferred_indexing.num_inferred_gaf_arg_index_tuples( tuples, UNPROVIDED );
      html_utilities.html_indent( TWO_INTEGER );
      cb_show_inferred_index_count( count, $int108$100 );
      html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
      html_utilities.html_newline( UNPROVIDED );
      dhtml_macros.dhtml_set_switched_visibility( dhtml_object_id, group_qua.eql( v_term ) ? $kw109$VISIBLE : $cb_inferred_index_visibility$.getDynamicValue( thread ), $kw110$TEXT );
      ...
      try
      {
        ...
        while ( NIL != cdolist_list_var_$10)
        {
          ...
          if( NIL == current )
          {
            ...
            cb_utilities.cb_link( $kw107$INFERRED_GAF_ARG_ASSERTIONS, v_term, pred, qua, argnum, pred );
            if( !argnum.numE( ONE_INTEGER ) )
            {
              PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str112$_arg_S, argnum );
            }
            final SubLObject count2 = inferred_indexing.num_inferred_gaf_arg_index_tuple( tuple, UNPROVIDED );
            html_utilities.html_indent( TWO_INTEGER );
            cb_show_inferred_index_count( count2, $int108$100 );
            ...
            {
              html_utilities.html_indent( UNPROVIDED );
              cb_utilities.cb_link( $kw113$LITERAL_QUERY, v_term, argnum, pred, $const82$EverythingPSC, UNPROVIDED );
            }
            if( NIL != hierarchy_browserP )
            {
              html_utilities.html_indent( UNPROVIDED );
              cb_utilities.cb_link( $kw114$HIER_BROW, v_term, argnum, pred, $const82$EverythingPSC, UNPROVIDED );
            }
            html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
            html_utilities.html_newline( UNPROVIDED );
          }
  ...
  public static SubLObject cb_show_inferred_gaf_arg_index_by_predicate(final SubLObject v_term, final SubLObject tuple_groups)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      final SubLObject size = size_val = cb_utilities.cb_term_font_size( group_pred, UNPROVIDED, UNPROVIDED );
      html_utilities.html_markup( html_macros.$html_font_head$.getGlobalValue() );
      if( NIL != size_val )
      {
        html_utilities.html_markup( html_macros.$html_font_size$.getGlobalValue() );
      ...
      {
        html_macros.$html_safe_print$.bind( T, thread );
        cb_utilities.cb_link( $kw107$INFERRED_GAF_ARG_ASSERTIONS, v_term, group_pred, NIL, group_argnum, group_pred );
      }
      finally
      {
        html_macros.$html_safe_print$.rebind( _prev_bind_0, thread );
      ...
      {
        PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str112$_arg_S, group_argnum );
      }
      final SubLObject count = inferred_indexing.num_inferred_gaf_arg_index_tuples( tuples, UNPROVIDED );
      html_utilities.html_indent( TWO_INTEGER );
      cb_show_inferred_index_count( count, $int108$100 );
      ...
      {
        html_utilities.html_indent( UNPROVIDED );
        cb_utilities.cb_link( $kw113$LITERAL_QUERY, v_term, group_argnum, group_pred, $const82$EverythingPSC, UNPROVIDED );
      }
      final SubLObject hierarchy_browserP = cb_show_inferred_index_hierarchy_browser_linkP( v_term, group_argnum, group_pred );
      if( NIL != hierarchy_browserP )
      {
        html_utilities.html_indent( UNPROVIDED );
        cb_utilities.cb_link( $kw114$HIER_BROW, v_term, group_argnum, group_pred, $const82$EverythingPSC, UNPROVIDED );
      }
      html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
      html_utilities.html_newline( UNPROVIDED );
      if( NIL == list_utilities.singletonP( tuples ) || !v_term.equal( first_qua ) )
      {
        dhtml_macros.dhtml_set_switched_visibility( dhtml_object_id, $cb_inferred_index_visibility$.getDynamicValue( thread ), $kw110$TEXT );
        html_utilities.html_markup( html_macros.$html_div_head$.getGlobalValue() );
        if( NIL != dhtml_object_id )
        {
          html_utilities.html_markup( html_macros.$html_attribute_id$.getGlobalValue() );
        ...
        try
        {
          ...
          while ( NIL != cdolist_list_var_$11)
          {
            ...
            if( NIL == current )
            {
              ...
              html_utilities.html_princ( $str106$via_ );
              html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
              cb_utilities.cb_link( $kw107$INFERRED_GAF_ARG_ASSERTIONS, v_term, qua, qua, argnum, pred );
              final SubLObject count2 = inferred_indexing.num_inferred_gaf_arg_index_tuple( tuple, UNPROVIDED );
              html_utilities.html_indent( TWO_INTEGER );
              cb_show_inferred_index_count( count2, $int108$100 );
              html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
  ...
  {
    html_utilities.html_markup( html_macros.$html_no_break_head$.getGlobalValue() );
    cb_utilities.cb_link( $kw107$INFERRED_GAF_ARG_ASSERTIONS, v_term, $str115$All_Assertions, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    final SubLObject count = inferred_indexing.num_inferred_gaf_arg_index_tuple_groups( tuple_groups, UNPROVIDED );
    html_utilities.html_indent( TWO_INTEGER );
    cb_show_inferred_index_count( count, $int116$1000 );
    html_utilities.html_indent( FOUR_INTEGER );
    cb_utilities.cb_link( $kw117$INFERRED_INDEX_TOGGLE_VISIBILITY, v_term, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    html_utilities.html_markup( html_macros.$html_no_break_tail$.getGlobalValue() );
    return NIL;
  }
  ...
  public static SubLObject cb_show_inferred_index_count(final SubLObject count, SubLObject warning_limit)
  {
    ...
    if( !ONE_INTEGER.numE( count ) )
    {
      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
      html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
      PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str118$__A_, count );
      html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
      if( NIL != warning_limit && count.numG( warning_limit ) )
      {
        ...
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_markup( $str119$color__red__background_color_yell );
        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
        html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
        final SubLObject _prev_bind_0 = html_macros.$html_safe_print$.currentBinding( thread );
        try
        {
          html_macros.$html_safe_print$.bind( T, thread );
          html_utilities.html_princ( $str120$_ );
        }
        finally
        {
          html_macros.$html_safe_print$.rebind( _prev_bind_0, thread );
  ...
  public static SubLObject cb_make_inferred_gaf_arg_index_tuples_object_id(final SubLObject v_term, SubLObject argnum)
  {
    ...
    return Sequences.cconcatenate( $str121$igai_, new SubLObject[] { format_nil.format_nil_a_no_copy( id ), format_nil.format_nil_a_no_copy( ( NIL != argnum ) ? argnum : $str105$ )
    } );
  }
  ...
  public static SubLObject cb_link_literal_query(final SubLObject v_term, final SubLObject argnum, final SubLObject pred, SubLObject mt)
  {
    ...
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject frame_name_var = cb_utilities.cb_frame_name( $kw122$CONTENT );
    html_utilities.html_markup( html_macros.$html_anchor_head$.getGlobalValue() );
    html_utilities.html_markup( html_macros.$html_anchor_href$.getGlobalValue() );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    if( NIL != mt )
    {
      PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str123$cb_lq__A__A__A__A, new SubLObject[] { cb_utilities.cb_fort_identifier( v_term ), argnum, cb_utilities.cb_fort_identifier( pred ),
        cb_utilities.cb_fort_identifier( mt )
      } );
    }
    else
    {
      PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str124$cb_lq__A__A__A, new SubLObject[] { cb_utilities.cb_fort_identifier( v_term ), argnum, cb_utilities.cb_fort_identifier( pred )
      } );
    }
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    if( NIL != frame_name_var )
    ...
    {
      html_macros.$html_safe_print$.bind( T, thread );
      final SubLObject image_src = cyc_file_dependencies.cb_icon_file_path( $kw125$PLUS_GREEN );
      final SubLObject align = $kw88$TOP;
      final SubLObject alt = cyc_file_dependencies.cb_get_icon_alt_string( $kw125$PLUS_GREEN );
  ...
  {
    return makeBoolean( NIL != hl_supports.hl_predicate_p( pred ) || NIL != inference_trampolines.inference_symmetric_predicateP( pred ) || NIL != inference_trampolines.inference_transitive_predicateP( pred )
        || NIL != inference_trampolines.inference_reflexive_predicateP( pred ) );
  }
  ...
  public static SubLObject cb_link_hier_brow(final SubLObject v_term, final SubLObject argnum, final SubLObject pred, SubLObject mt)
  {
    ...
    if( NIL != mt )
    {
      PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str127$cb_hier__A__A__A__A, new SubLObject[] { cb_utilities.cb_fort_identifier( v_term ), argnum, cb_utilities.cb_fort_identifier( pred ),
        cb_utilities.cb_fort_identifier( mt )
      } );
    }
    else
    {
      PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str128$cb_hier__A__A__A, new SubLObject[] { cb_utilities.cb_fort_identifier( v_term ), argnum, cb_utilities.cb_fort_identifier( pred )
      } );
    }
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    if( NIL != frame_name_var )
    ...
    {
      html_macros.$html_safe_print$.bind( T, thread );
      final SubLObject image_src = cyc_file_dependencies.cb_icon_file_path( $kw129$RED_DIAMOND );
      final SubLObject align = $kw88$TOP;
      final SubLObject alt = cyc_file_dependencies.cb_get_icon_alt_string( $kw129$RED_DIAMOND );
      final SubLObject border = ZERO_INTEGER;
      html_utilities.html_markup( html_macros.$html_image_head$.getGlobalValue() );
      html_utilities.html_markup( html_macros.$html_image_src$.getGlobalValue() );
      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
  ...
  public static SubLObject cb_inferred_index_order_by(final SubLObject args)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( args, args, $list132 );
    index_id = args.first();
    SubLObject current = args.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, args, $list132 );
    order_by_string = current.first();
    current = current.rest();
    if( NIL != current )
    {
      cdestructuring_bind.cdestructuring_bind_error( args, $list132 );
      return NIL;
    }
    final SubLObject index_hook = cb_utilities.cb_guess_index( index_id );
    if( NIL == index_hook )
  ...
  public static SubLObject cb_link_inferred_index_order_by(final SubLObject v_term, final SubLObject order_by, final SubLObject linktext)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject index_id = cb_utilities.cb_index_identifier( v_term );
    final SubLObject frame_name_var = cb_utilities.cb_frame_name( $kw9$SELF );
    html_utilities.html_markup( html_macros.$html_anchor_head$.getGlobalValue() );
    html_utilities.html_markup( html_macros.$html_anchor_href$.getGlobalValue() );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str134$cb_inferred_index_order_by__A__A, index_id, order_by );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    if( NIL != frame_name_var )
    {
      html_utilities.html_markup( html_macros.$html_anchor_target$.getGlobalValue() );
  ...
  public static SubLObject cb_inferred_index_visibility(final SubLObject args)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( args, args, $list136 );
    index_id = args.first();
    SubLObject current = args.rest();
    cdestructuring_bind.destructuring_bind_must_consp( current, args, $list136 );
    visibility_string = current.first();
    current = current.rest();
    if( NIL != current )
    {
      cdestructuring_bind.cdestructuring_bind_error( args, $list136 );
      return NIL;
    }
    final SubLObject index_hook = cb_utilities.cb_guess_index( index_id );
    final SubLObject visibility = reader.read_from_string_ignoring_errors( visibility_string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    if( NIL == index_hook )
    {
      return cb_utilities.cb_error( $str6$Unable_to_determine_a_term_from__, index_id, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
  ...
  public static SubLObject cb_link_inferred_index_toggle_visibility(final SubLObject v_term)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject index_id = cb_utilities.cb_index_identifier( v_term );
    final SubLObject toggled_visibility = ( $cb_inferred_index_visibility$.getDynamicValue( thread ) == $kw109$VISIBLE ) ? $kw3$INVISIBLE : $kw109$VISIBLE;
    final SubLObject linktext = ( $cb_inferred_index_visibility$.getDynamicValue( thread ) == $kw109$VISIBLE ) ? $str138$close_all : $str139$open_all;
    final SubLObject icon = ( $cb_inferred_index_visibility$.getDynamicValue( thread ) == $kw109$VISIBLE ) ? $kw140$DOWN_TRIANGLE_V : $kw141$RIGHT_TRIANGLE_V;
    final SubLObject frame_name_var = cb_utilities.cb_frame_name( $kw9$SELF );
    html_utilities.html_markup( html_macros.$html_anchor_head$.getGlobalValue() );
    html_utilities.html_markup( html_macros.$html_anchor_href$.getGlobalValue() );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str142$cb_inferred_index_visibility__A__, index_id, toggled_visibility );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    if( NIL != frame_name_var )
    {
      html_utilities.html_markup( html_macros.$html_anchor_target$.getGlobalValue() );
  ...
  public static SubLObject cb_inferred_index_predicate_filters(final SubLObject args)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( args, args, $list145 );
    id_string = args.first();
    final SubLObject current = args.rest();
    if( NIL != current )
    {
      cdestructuring_bind.cdestructuring_bind_error( args, $list145 );
      return NIL;
    }
    final SubLObject v_term = cb_utilities.cb_guess_term( id_string, UNPROVIDED );
    if( NIL == kb_indexing_datastructures.indexed_term_p( v_term ) )
    {
      return cb_utilities.cb_error( $str146$_S_did_not_specify_a_term, id_string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
  ...
  public static SubLObject cb_link_inferred_index_predicate_filters(SubLObject v_term, SubLObject linktext)
  {
    ...
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str149$cb_inferred_index_predicate_filte, id );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    if( NIL != frame_name_var )
    {
      html_utilities.html_markup( html_macros.$html_anchor_target$.getGlobalValue() );
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject title = $str151$Inferred_Index_Predicate_Filters;
    html_utilities.html_markup( $str19$__DOCTYPE_html_PUBLIC_____W3C__DT );
    if( NIL != html_macros.$html_force_ie_standards_mode$.getDynamicValue( thread ) )
    {
      html_utilities.html_source_readability_terpri( UNPROVIDED );
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
          html_utilities.html_markup( $str152$post );
          html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
          if( NIL != frame_name_var )
          {
          ...
          try
          {
            ...
            html_utilities.html_hidden_input( $str153$cb_handle_inferred_index_predicat, T, UNPROVIDED );
            ...
            html_utilities.html_newline( UNPROVIDED );
            html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
            html_utilities.html_princ( $str154$relevant_to_ );
            html_utilities.html_indent( UNPROVIDED );
            html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
            html_utilities.html_markup( html_macros.$html_strong_head$.getGlobalValue() );
            ...
            html_utilities.html_submit_input( $str155$Update_Filters, $str156$update, UNPROVIDED );
            html_utilities.html_indent( TWO_INTEGER );
            html_utilities.html_reset_input( $str157$Reset_Values );
            html_utilities.html_indent( FOUR_INTEGER );
            html_utilities.html_submit_input( $str158$Remove_All_Filters, $str159$clear, UNPROVIDED );
            html_utilities.html_newline( TWO_INTEGER );
            final SubLObject current;
            final SubLObject datum = current = $cb_inferred_index_filters$.getDynamicValue( thread );
            final SubLObject allow_predicates_tail = cdestructuring_bind.property_list_member( $kw160$ALLOW_PREDICATES, current );
            final SubLObject allow_predicates = ( NIL != allow_predicates_tail ) ? conses_high.cadr( allow_predicates_tail ) : NIL;
            final SubLObject allow_predicate_types_tail = cdestructuring_bind.property_list_member( $kw161$ALLOW_PREDICATE_TYPES, current );
            final SubLObject allow_predicate_types = ( NIL != allow_predicate_types_tail ) ? conses_high.cadr( allow_predicate_types_tail ) : NIL;
            final SubLObject forbid_predicates_tail = cdestructuring_bind.property_list_member( $kw162$FORBID_PREDICATES, current );
            final SubLObject forbid_predicates = ( NIL != forbid_predicates_tail ) ? conses_high.cadr( forbid_predicates_tail ) : NIL;
            final SubLObject forbid_predicate_types_tail = cdestructuring_bind.property_list_member( $kw163$FORBID_PREDICATE_TYPES, current );
            ...
            thread.resetMultipleValues();
            term_allow_predicates = conses_high.union( allow_predicates, term_allow_predicates, Symbols.symbol_function( EQ ), UNPROVIDED );
            term_forbid_predicates = conses_high.union( forbid_predicates, term_forbid_predicates, Symbols.symbol_function( EQ ), UNPROVIDED );
            html_utilities.html_hidden_input( $str74$term, cb_utilities.cb_term_identifier( v_term ), UNPROVIDED );
            html_utilities.html_markup( html_macros.$html_table_head$.getGlobalValue() );
            html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
            ...
            try
            {
              ...
              try
              {
                ...
                try
                {
                  ...
                  {
                    html_macros.$html_safe_print$.bind( T, thread );
                    html_utilities.html_princ( $str164$Allowed_Types );
                  }
                  finally
                  {
                  ...
                  if( NIL != allow_predicate_types )
                  {
                    ...
                    html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                    html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                    html_utilities.html_princ( $str165$check_to_remove );
                    html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                    html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                    ...
                    while ( NIL != cdolist_list_var)
                    {
                      ...
                      html_utilities.html_indent( UNPROVIDED );
                      cb_utilities.cb_show_term( type, UNPROVIDED, UNPROVIDED );
                      cdolist_list_var = cdolist_list_var.rest();
                      type = cdolist_list_var.first();
                    }
                  }
                  html_utilities.html_newline( UNPROVIDED );
                  html_utilities.html_princ( $str166$add_ );
                  html_utilities.html_text_input( $str167$type_allow, $str105$, $int168$30 );
                  html_utilities.html_indent( ONE_INTEGER );
                  html_complete.html_complete_button( $str167$type_allow, $str169$Complete, $const170$Collection, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                  html_utilities.html_newline( TWO_INTEGER );
                }
                finally
                {
                ...
                try
                {
                  ...
                  {
                    html_macros.$html_safe_print$.bind( T, thread );
                    html_utilities.html_princ( $str171$Forbidden_Types );
                  }
                  finally
                  {
                  ...
                  html_utilities.html_newline( UNPROVIDED );
                  html_utilities.html_princ( $str166$add_ );
                  html_utilities.html_text_input( $str172$type_forbid, $str105$, $int168$30 );
                  html_utilities.html_indent( ONE_INTEGER );
                  html_complete.html_complete_button( $str172$type_forbid, $str169$Complete, $const170$Collection, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                  html_utilities.html_newline( TWO_INTEGER );
                }
                finally
                {
              ...
              try
              {
                ...
                try
                {
                  ...
                  {
                    html_macros.$html_safe_print$.bind( T, thread );
                    html_utilities.html_princ( $str173$Allowed_Predicates );
                  }
                  finally
                  {
                  ...
                  {
                    html_utilities.html_newline( UNPROVIDED );
                    final SubLObject color_val = $kw174$RED;
                    html_utilities.html_markup( html_macros.$html_font_head$.getGlobalValue() );
                    if( NIL != color_val )
                    {
                    ...
                    {
                      html_macros.$html_safe_print$.bind( T, thread );
                      html_utilities.html_princ( $str175$None_ );
                    }
                    finally
                    {
                  ...
                  if( NIL != term_allow_predicates )
                  {
                    ...
                    html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                    html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                    html_utilities.html_princ( $str176$check_to_forbid );
                    html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                    html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                ...
                try
                {
                  ...
                  {
                    html_macros.$html_safe_print$.bind( T, thread );
                    html_utilities.html_princ( $str177$Forbidden_Predicates );
                  }
                  finally
                  {
                  ...
                  if( NIL != term_forbid_predicates )
                  {
                    ...
                    html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                    html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                    html_utilities.html_princ( $str178$check_to_allow );
                    html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                    html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
  ...
  {
    return html_utilities.html_checkbox_input( Sequences.cconcatenate( $str179$remove_type_allow_, format_nil.format_nil_a_no_copy( cb_utilities.cb_term_identifier( type ) ) ), $str180$T, NIL, UNPROVIDED, UNPROVIDED,
        UNPROVIDED );
  }
  ...
  {
    return html_utilities.html_checkbox_input( Sequences.cconcatenate( $str181$remove_type_forbid_, format_nil.format_nil_a_no_copy( cb_utilities.cb_term_identifier( type ) ) ), $str180$T, NIL, UNPROVIDED, UNPROVIDED,
        UNPROVIDED );
  }
  ...
  {
    return html_utilities.html_checkbox_input( Sequences.cconcatenate( $str182$forbid_, format_nil.format_nil_a_no_copy( cb_utilities.cb_term_identifier( predicate ) ) ), $str180$T, NIL, UNPROVIDED, UNPROVIDED,
        UNPROVIDED );
  }
  ...
  {
    return html_utilities.html_checkbox_input( Sequences.cconcatenate( $str183$allow_, format_nil.format_nil_a_no_copy( cb_utilities.cb_term_identifier( predicate ) ) ), $str180$T, NIL, UNPROVIDED, UNPROVIDED,
        UNPROVIDED );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject term_string = html_utilities.html_extract_input( $str74$term, args );
    final SubLObject v_term = cb_utilities.cb_guess_term( term_string, UNPROVIDED );
    if( NIL != html_utilities.html_extract_input( $str159$clear, args ) )
    {
  ...
  public static SubLObject cb_extract_inferred_index_predicate_filters(final SubLObject args)
  {
    ...
    final SubLObject type_allow_string = html_utilities.html_extract_input( $str167$type_allow, args );
    if( NIL == string_utilities.empty_string_p( type_allow_string ) )
    {
      final SubLObject v_term = cb_utilities.cb_guess_term( type_allow_string, UNPROVIDED );
      if( NIL != v_term )
      {
        new_type_allow = v_term;
      }
    }
    final SubLObject type_forbid_string = html_utilities.html_extract_input( $str172$type_forbid, args );
    if( NIL == string_utilities.empty_string_p( type_forbid_string ) )
    {
      final SubLObject v_term2 = cb_utilities.cb_guess_term( type_forbid_string, UNPROVIDED );
      if( NIL != v_term2 )
      {
      ...
      if( arg.isCons() )
      {
        ...
        if( NIL == current )
        {
          if( NIL != string_utilities.starts_with( name, $str182$forbid_ ) )
          {
            ...
            final SubLObject v_term3 = var = cb_utilities.cb_guess_term( id_string, UNPROVIDED );
            if( NIL != var )
            {
              new_predicates_to_forbid = ConsesLow.cons( var, new_predicates_to_forbid );
            }
          }
          else if( NIL != string_utilities.starts_with( name, $str183$allow_ ) )
          {
            ...
            if( NIL != var )
            {
              new_predicates_to_allow = ConsesLow.cons( var, new_predicates_to_allow );
            }
          }
          else if( NIL != string_utilities.starts_with( name, $str181$remove_type_forbid_ ) )
          {
            ...
            if( NIL != var )
            {
              type_forbids_to_remove = ConsesLow.cons( var, type_forbids_to_remove );
            }
          }
          else if( NIL != string_utilities.starts_with( name, $str179$remove_type_allow_ ) )
          {
            ...
            if( NIL != var )
            {
              type_allows_to_remove = ConsesLow.cons( var, type_allows_to_remove );
            }
          }
        }
        else
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    $cb_inferred_index_filters$.setDynamicValue( Symbols.remprop( $kw161$ALLOW_PREDICATE_TYPES, $cb_inferred_index_filters$.getDynamicValue( thread ) ), thread );
    $cb_inferred_index_filters$.setDynamicValue( Symbols.remprop( $kw163$FORBID_PREDICATE_TYPES, $cb_inferred_index_filters$.getDynamicValue( thread ) ), thread );
    $cb_inferred_index_filters$.setDynamicValue( Symbols.remprop( $kw160$ALLOW_PREDICATES, $cb_inferred_index_filters$.getDynamicValue( thread ) ), thread );
    $cb_inferred_index_filters$.setDynamicValue( Symbols.remprop( $kw162$FORBID_PREDICATES, $cb_inferred_index_filters$.getDynamicValue( thread ) ), thread );
    return NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/cb-inferred-index.lisp", position = 28264L)
  public static SubLObject cb_update_inferred_index_predicate_filters(final SubLObject new_type_allow, final SubLObject type_allows_to_remove, final SubLObject new_type_forbid, final SubLObject type_forbids_to_remove,
      final SubLObject new_predicates_to_allow, final SubLObject new_predicates_to_forbid)
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( NIL != new_type_allow || NIL != type_allows_to_remove )
    {
      SubLObject types = conses_high.getf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw161$ALLOW_PREDICATE_TYPES, NIL );
      if( NIL != new_type_allow && NIL == conses_high.member( new_type_allow, types, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        types = ConsesLow.cons( new_type_allow, types );
      }
      ...
      while ( NIL != cdolist_list_var)
      {
        types = list_utilities.delete_first( type, types, Symbols.symbol_function( EQ ) );
        cdolist_list_var = cdolist_list_var.rest();
        type = cdolist_list_var.first();
      }
      $cb_inferred_index_filters$.setDynamicValue( conses_high.putf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw161$ALLOW_PREDICATE_TYPES, types ), thread );
    }
    if( NIL != new_type_forbid || NIL != type_forbids_to_remove )
    {
      SubLObject types = conses_high.getf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw163$FORBID_PREDICATE_TYPES, NIL );
      if( NIL != new_type_forbid && NIL == conses_high.member( new_type_forbid, types, Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        types = ConsesLow.cons( new_type_forbid, types );
      }
      ...
      $cb_inferred_index_filters$.setDynamicValue( conses_high.putf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw163$FORBID_PREDICATE_TYPES, types ), thread );
    }
    if( NIL != new_predicates_to_allow || NIL != new_predicates_to_forbid )
    {
      SubLObject allow = conses_high.getf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw160$ALLOW_PREDICATES, NIL );
      SubLObject forbid = conses_high.getf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw162$FORBID_PREDICATES, NIL );
      SubLObject cdolist_list_var = new_predicates_to_allow;
      SubLObject pred = NIL;
      pred = cdolist_list_var.first();
      while ( NIL != cdolist_list_var)
      {
        forbid = list_utilities.delete_first( pred, forbid, Symbols.symbol_function( EQ ) );
        final SubLObject item_var = pred;
        if( NIL == conses_high.member( item_var, allow, Symbols.symbol_function( EQ ), Symbols.symbol_function( IDENTITY ) ) )
        {
          allow = ConsesLow.cons( item_var, allow );
        }
        cdolist_list_var = cdolist_list_var.rest();
        pred = cdolist_list_var.first();
      }
      ...
      while ( NIL != cdolist_list_var)
      {
        allow = list_utilities.delete_first( pred, allow, Symbols.symbol_function( EQ ) );
        final SubLObject item_var = pred;
        if( NIL == conses_high.member( item_var, forbid, Symbols.symbol_function( EQ ), Symbols.symbol_function( IDENTITY ) ) )
        {
          forbid = ConsesLow.cons( item_var, forbid );
        }
        cdolist_list_var = cdolist_list_var.rest();
        pred = cdolist_list_var.first();
      }
      $cb_inferred_index_filters$.setDynamicValue( conses_high.putf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw160$ALLOW_PREDICATES, allow ), thread );
      $cb_inferred_index_filters$.setDynamicValue( conses_high.putf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw162$FORBID_PREDICATES, forbid ), thread );
    }
    return NIL;
  }
  ...
  public static SubLObject cb_link_inferred_index_ontology_filters(SubLObject v_term, SubLObject linktext)
  {
    ...
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    cb_parameters.cyc_cgi_url_int();
    PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str188$cb_inferred_index_ontology_filter, id );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    if( NIL != frame_name_var )
    {
      html_utilities.html_markup( html_macros.$html_anchor_target$.getGlobalValue() );
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject title = $str190$Inferred_Index_Ontology_Filters;
    html_utilities.html_markup( $str19$__DOCTYPE_html_PUBLIC_____W3C__DT );
    if( NIL != html_macros.$html_force_ie_standards_mode$.getDynamicValue( thread ) )
    {
      html_utilities.html_source_readability_terpri( UNPROVIDED );
      ...
      try
      {
        ...
        try
        {
          ...
          try
          {
            ...
            html_macros.$within_html_form$.bind( T, thread );
            html_macros.$html_form_field_uniquifier_code$.bind( html_macros.next_html_form_field_uniquifier_code(), thread );
            html_utilities.html_hidden_input( $str191$cb_handle_inferred_index_ontology, T, UNPROVIDED );
            final SubLObject size_val = FIVE_INTEGER;
            html_utilities.html_markup( html_macros.$html_font_head$.getGlobalValue() );
            if( NIL != size_val )
            {
            ...
            final SubLObject current;
            final SubLObject datum = current = $cb_inferred_index_filters$.getDynamicValue( thread );
            final SubLObject ontology_horizon_tail = cdestructuring_bind.property_list_member( $kw192$ONTOLOGY_HORIZON, current );
            ...
            {
              html_macros.$html_safe_print$.bind( T, thread );
              html_utilities.html_princ( $str193$Generality_Horizon );
            }
            finally
            {
            ...
            html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
            html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
            html_utilities.html_princ( $str194$select_a_qualitative_boundary );
            html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
            html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
            ...
            html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
            html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
            html_utilities.html_princ( $str196$or_a_generalization );
            html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
            html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
  ...
  {
    final SubLObject checkedP = makeBoolean( ( NIL == ontology_horizon && qua == $kw197$ALL ) || qua.eql( ontology_horizon ) );
    final SubLObject value = ( NIL != forts.fort_p( qua ) ) ? cb_utilities.cb_fort_identifier( qua ) : print_high.prin1_to_string( qua );
    return html_utilities.html_radio_input( $str198$ontology_horizon, value, checkedP, UNPROVIDED );
  }
  ...
  public static SubLObject cb_show_ontology_horizon_term(final SubLObject qua)
  {
    ...
    if( qua.eql( $kw9$SELF ) )
    {
      html_utilities.html_princ( $str200$Just_on_the_term );
    }
    else if( qua.eql( $kw201$LOWER ) )
    {
      html_utilities.html_princ( $str202$Also_from_the_lower_ontology );
    }
    else if( qua.eql( $kw203$MIDDLE ) )
    {
      html_utilities.html_princ( $str204$Also_up_through_the_middle_ontolo );
    }
    else if( qua.eql( $kw197$ALL ) )
    {
      html_utilities.html_princ( $str205$Everything );
    }
    else
    {
      final SubLObject size_val;
      final SubLObject size = size_val = cb_utilities.cb_term_font_size( qua, UNPROVIDED, UNPROVIDED );
      html_utilities.html_markup( html_macros.$html_font_head$.getGlobalValue() );
      if( NIL != size_val )
      {
        html_utilities.html_markup( html_macros.$html_font_size$.getGlobalValue() );
      ...
      {
        html_macros.$html_safe_print$.bind( T, thread );
        cb_utilities.cb_show_term( qua, UNPROVIDED, UNPROVIDED );
      }
      finally
      {
        html_macros.$html_safe_print$.rebind( _prev_bind_0, thread );
  ...
  {
    final SubLObject identifier_string = html_utilities.html_extract_input( $str198$ontology_horizon, args );
    final SubLObject fort = cb_utilities.cb_guess_fort( identifier_string, UNPROVIDED );
    if( NIL != forts.fort_p( fort ) )
    {
      return fort;
    }
    return reader.read_from_string_ignoring_errors( identifier_string, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( ontology_horizon == $kw197$ALL )
    {
      ontology_horizon = NIL;
    }
    $cb_inferred_index_filters$.setDynamicValue( conses_high.putf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw192$ONTOLOGY_HORIZON, ontology_horizon ), thread );
    return NIL;
  }
  ...
  public static SubLObject cb_inferred_index_microtheory_filters(final SubLObject args)
  {
    ...
    return cb_utilities.cb_error( $str206$Time_to_implement_cb_inferred_ind, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    $cb_inferred_index_filters$.setDynamicValue( conses_high.putf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw210$MICROTHEORY, mt ), thread );
  ...
  public static SubLObject cb_link_inferred_gaf_arg_assertions(final SubLObject v_term, final SubLObject display_term, SubLObject qua, SubLObject argnum, SubLObject pred)
  {
    ...
    final SubLObject size = cb_utilities.cb_term_font_size( display_term, UNPROVIDED, UNPROVIDED );
    final SubLObject frame_name_var = cb_utilities.cb_frame_name( $kw122$CONTENT );
    html_utilities.html_markup( html_macros.$html_anchor_head$.getGlobalValue() );
    html_utilities.html_markup( html_macros.$html_anchor_href$.getGlobalValue() );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    ...
    {
      PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str211$cb_inferred_gaf_arg_assertions__A, new SubLObject[] { cb_utilities.cb_index_identifier( v_term ), cb_utilities.cb_index_identifier(
          qua ), argnum, cb_utilities.cb_index_identifier( pred )
      } );
    }
    else if( NIL == qua && NIL != argnum && NIL != pred )
    {
      PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str211$cb_inferred_gaf_arg_assertions__A, new SubLObject[] { cb_utilities.cb_index_identifier( v_term ), NIL, argnum, cb_utilities
          .cb_index_identifier( pred )
      } );
    }
    else if( NIL != qua && NIL == argnum && NIL == pred )
    {
      PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str212$cb_inferred_gaf_arg_assertions__A, cb_utilities.cb_index_identifier( v_term ), cb_utilities.cb_index_identifier( qua ) );
    }
    else if( NIL == qua && NIL == argnum && NIL == pred )
    {
      PrintLow.format( html_macros.$html_stream$.getDynamicValue( thread ), $str213$cb_inferred_gaf_arg_assertions__A, cb_utilities.cb_index_identifier( v_term ) );
    }
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    if( NIL != frame_name_var )
    {
  ...
  public static SubLObject cb_inferred_gaf_arg_assertions(final SubLObject args)
  {
    ...
    cdestructuring_bind.destructuring_bind_must_consp( args, args, $list215 );
    term_spec = args.first();
    SubLObject current = args.rest();
    final SubLObject qua_spec = current.isCons() ? current.first() : NIL;
    cdestructuring_bind.destructuring_bind_must_listp( current, args, $list215 );
    current = current.rest();
    ...
    if( NIL != current )
    {
      cdestructuring_bind.cdestructuring_bind_error( args, $list215 );
      return NIL;
    }
    ...
    if( NIL == kb_indexing_datastructures.indexed_term_p( v_term ) )
    {
      return cb_utilities.cb_error( $str216$Could_not_determine_a_term_from__, term_spec, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
    }
    if( NIL != qua_spec && !$str217$NIL.equal( qua_spec ) )
    {
      qua = cb_utilities.cb_guess_index( qua_spec );
      if( NIL == kb_indexing_datastructures.indexed_term_p( qua ) )
      {
        return cb_utilities.cb_error( $str216$Could_not_determine_a_term_from__, qua_spec, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
    }
    if( NIL != argnum_spec )
    {
      argnum = reader.read_from_string_ignoring_errors( argnum_spec, NIL, NIL, UNPROVIDED, UNPROVIDED );
      if( !argnum.isInteger() )
      {
        return cb_utilities.cb_error( $str218$Could_not_determine_an_argnum_fro, argnum_spec, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
    }
    if( NIL != pred_spec )
    {
      ...
      {
        return cb_utilities.cb_error( $str216$Could_not_determine_a_term_from__, pred_spec, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
      }
    }
  ...
  public static SubLObject cb_inferred_gaf_arg_assertions_guts(final SubLObject v_term, final SubLObject qua, final SubLObject argnum, final SubLObject predicate)
  {
    ...
    final SubLObject title = title_var = PrintLow.format( NIL, $str220$Inferred_GAF_arg_index_for__S, v_term );
    ...
    try
    {
      ...
      try
      {
        ...
        try
        {
          ...
          html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
          html_utilities.html_markup( $str221$yui_skin_sam );
          html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
          html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
          ...
          try
          {
            ...
            html_utilities.html_markup( html_macros.$html_attribute_id$.getGlobalValue() );
            html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
            html_utilities.html_markup( $str222$reloadFrameButton );
            html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
            html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
            ...
            try
            {
              ...
              html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
              html_utilities.html_markup( $str223$button );
              html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
              html_utilities.html_markup( html_macros.$html_input_name$.getGlobalValue() );
              html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
              html_utilities.html_markup( $str224$reload );
              html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
              html_utilities.html_markup( html_macros.$html_input_value$.getGlobalValue() );
              html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
              html_utilities.html_princ( $str225$Refresh );
              html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
              html_utilities.html_markup( html_macros.$html_event_attribute_onclick$.getGlobalValue() );
              html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
              html_utilities.html_markup( $str226$reloadCurrentFrame__reloadFrameBu );
              html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
            ...
            cb_possibly_show_term_as_seen_from_mt_header( mt, $kw84$AFTER );
            final SubLObject pcase_var = order_by;
            if( pcase_var.eql( $kw0$ONTOLOGY ) )
            {
              cb_show_inferred_gaf_arg_assertions_by_ontology( v_term, tuple_groups );
            }
            else if( pcase_var.eql( $kw92$PREDICATE ) )
            {
              cb_show_inferred_gaf_arg_assertions_by_predicate( v_term, tuple_groups );
            }
            else
            {
              cb_utilities.cb_error( $str104$Unexpected_order_by____S, order_by, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
            }
            html_utilities.html_source_readability_terpri( UNPROVIDED );
            html_utilities.html_copyright_notice();
          }
  ...
  public static SubLObject cb_show_inferred_gaf_arg_assertions_by_ontology(final SubLObject v_term, final SubLObject tuple_groups)
  {
    ...
    try
    {
      ...
      for( index = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), tuples = list_var.first(), index = Numbers.add( ONE_INTEGER, index ) )
      {
        if( !index.isZero() )
        {
          html_utilities.html_newline( UNPROVIDED );
  ...
  public static SubLObject cb_show_inferred_gaf_arg_assertions_by_predicate(final SubLObject v_term, final SubLObject tuple_groups)
  {
    ...
    {
      cb_browser.$cb_c_gaf_arg_show_arg_headerP$.bind( NIL, thread );
      final SubLObject ontology_horizon = conses_high.getf( $cb_inferred_index_filters$.getDynamicValue( thread ), $kw192$ONTOLOGY_HORIZON, UNPROVIDED );
      SubLObject list_var = NIL;
      SubLObject tuples = NIL;
      SubLObject index = NIL;
      list_var = tuple_groups;
      ...
      for( index = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), tuples = list_var.first(), index = Numbers.add( ONE_INTEGER, index ) )
      {
        ...
        for( tuple_index = ZERO_INTEGER; NIL != list_var_$44; list_var_$44 = list_var_$44.rest(), tuple = list_var_$44.first(), tuple_index = Numbers.add( ONE_INTEGER, tuple_index ) )
        {
          SubLObject current;
          final SubLObject datum = current = tuple;
          SubLObject infer_pred = NIL;
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    if( infer_pred.eql( $kw227$QUERY_ISA ) )
    {
      ...
      html_utilities.html_princ( $str228$_query );
      html_utilities.html_indent( UNPROVIDED );
      cb_utilities.cb_link( $kw113$LITERAL_QUERY, v_term, argnum, pred, $const82$EverythingPSC, UNPROVIDED );
      html_utilities.html_newline( UNPROVIDED );
    }
  ...
  {
    return list_utilities.alist_lookup_without_values( $predicate_support_module_map$.getGlobalValue(), predicate, Symbols.symbol_function( EQUAL ), $kw230$QUERY );
  }
  ...
  {
    final SubLObject leader = ( NIL != kb_utilities.kbeq( infer_pred, $const231$equals ) ) ? $str232$on_ : $str106$via_;
    html_utilities.html_markup( html_macros.$html_strong_head$.getGlobalValue() );
    html_utilities.html_princ( leader );
    html_utilities.html_indent( UNPROVIDED );
    if( NIL != kb_utilities.kbeq( infer_pred, $const231$equals ) )
    {
      html_utilities.html_princ( $str233$the_term );
    }
    else
    {
      cb_utilities.cb_show_term( qua, ZERO_INTEGER, NIL );
    }
    html_utilities.html_markup( html_macros.$html_strong_tail$.getGlobalValue() );
    if( NIL == kb_utilities.kbeq( infer_pred, $const231$equals ) )
    {
      if( infer_pred == $kw227$QUERY_ISA )
      {
        infer_pred = $const234$isa;
      }
      ...
      final SubLObject support = arguments.make_hl_support( module, sentence, $const82$EverythingPSC, UNPROVIDED );
      html_utilities.html_indent( UNPROVIDED );
      html_utilities.html_markup( html_macros.$html_superscript_head$.getGlobalValue() );
      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
      cb_utilities.cb_link( $kw235$HL_SUPPORT, support, $kw236$NONE, $str237$___, UNPROVIDED, UNPROVIDED );
      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
  ...
  public static SubLObject filter_gaf_arg_index_tuples(final SubLObject tuples, SubLObject match_qua, SubLObject match_argnum, SubLObject match_pred)
  {
    ...
    while ( NIL != cdolist_list_var)
    {
      ...
      if( NIL == current )
      {
        ...
        {
          result_tuples = ConsesLow.cons( tuple, result_tuples );
        }
      }
      else
      {
  ...
  public static SubLObject inferred_index_definitional_information_override(SubLObject filters, final SubLObject fort)
  {
    ...
    filters = conses_high.putf( filters, $kw160$ALLOW_PREDICATES, predicates );
    filters = conses_high.putf( filters, $kw161$ALLOW_PREDICATE_TYPES, NIL );
    filters = conses_high.putf( filters, $kw162$FORBID_PREDICATES, NIL );
    filters = conses_high.putf( filters, $kw163$FORBID_PREDICATE_TYPES, $list238 );
    return filters;
  }
  ...
  public static SubLObject cb_term_type_header_with_gaf_entry(final SubLObject v_term, SubLObject gaf_entry_properties)
  {
    ...
    if( NIL != forts.fort_p( v_term ) )
    {
      ...
      {
        html_utilities.html_indent( UNPROVIDED );
        cure_api.cb_possibly_add_cure_link( v_term, Sequences.cconcatenate( $str246$Open_the_CURE_on_, new SubLObject[] { format_nil.format_nil_a_no_copy( cycl_utilities.denotational_term_name( v_term ) ),
          $str247$_to_add_more_facts_
        } ), UNPROVIDED );
      }
      html_utilities.html_newline( TWO_INTEGER );
  ...
  public static SubLObject cb_term_type_header(final SubLObject v_term, SubLObject baseline_size)
  {
    ...
    try
    {
      ...
      html_utilities.html_princ( $str248$___ );
    }
    finally
    {
      html_macros.$html_safe_print$.rebind( _prev_bind_0, thread );
    ...
    final SubLObject size = cb_utilities.cb_term_font_size( v_term, baseline_size, UNPROVIDED );
    html_utilities.html_markup( html_macros.$html_strong_head$.getGlobalValue() );
    ...
    {
      html_utilities.html_princ( $str249$__ );
    }
    return v_term;
  }
  ...
  public static SubLObject cb_gaf_entry_widget(final SubLObject fort, SubLObject v_properties)
  {
    ...
    while ( NIL != rest)
    {
      ...
      rest = rest.rest();
      cdestructuring_bind.destructuring_bind_must_consp( rest, datum, $list250 );
      if( NIL == conses_high.member( current_$45, $list251, UNPROVIDED, UNPROVIDED ) )
      {
        bad = T;
      }
      if( current_$45 == $kw252$ALLOW_OTHER_KEYS )
      {
    ...
    final SubLObject name_tail = cdestructuring_bind.property_list_member( $kw253$NAME, current );
    final SubLObject name = ( NIL != name_tail ) ? conses_high.cadr( name_tail ) : $str243$gaf_entry;
    final SubLObject pred_tail = cdestructuring_bind.property_list_member( $kw254$PRED, current );
    final SubLObject pred = ( NIL != pred_tail ) ? conses_high.cadr( pred_tail ) : NIL;
    final SubLObject argnum_tail = cdestructuring_bind.property_list_member( $kw255$ARGNUM, current );
    final SubLObject argnum = ( NIL != argnum_tail ) ? conses_high.cadr( argnum_tail ) : NIL;
    final SubLObject text_width = $int256$200;
    dhtml_macros.dhtml_set_switched_visibility( name, $kw3$INVISIBLE, $kw257$PARAGRAPH );
    html_utilities.html_markup( html_macros.$html_div_head$.getGlobalValue() );
    if( NIL != name )
    {
      html_utilities.html_markup( html_macros.$html_attribute_id$.getGlobalValue() );
    ...
    {
      html_macros.$html_safe_print$.bind( T, thread );
      dhtml_macros.dhtml_set_switched_visibility( $str258$unary_frame, $kw3$INVISIBLE, $kw257$PARAGRAPH );
      html_utilities.html_markup( html_macros.$html_div_head$.getGlobalValue() );
      html_utilities.html_markup( html_macros.$html_attribute_id$.getGlobalValue() );
      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
      html_utilities.html_markup( $str258$unary_frame );
      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
      ...
      try
      {
        ...
        try
        {
          ...
          html_macros.$within_html_form$.bind( T, thread );
          html_macros.$html_form_field_uniquifier_code$.bind( html_macros.next_html_form_field_uniquifier_code(), thread );
          html_utilities.html_hidden_input( $str259$cb_handle_gaf_entry, T, UNPROVIDED );
          html_utilities.html_hidden_input( $str260$implicit_arg1, cb_utilities.cb_fort_identifier( fort ), UNPROVIDED );
          html_utilities.html_markup( html_macros.$html_table_head$.getGlobalValue() );
          html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
          ...
          try
          {
            ...
            html_utilities.html_markup( html_macros.$html_table_data_valign$.getGlobalValue() );
            html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
            html_utilities.html_markup( html_utilities.html_align( $kw203$MIDDLE ) );
            html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
            html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
            ...
            try
            {
              ...
              try
              {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                      html_complete.html_complete_link( $str261$unary_frame_pred, $str262$unary_predicate, $const263$UnaryPredicate, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                    }
                    finally
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_event_attribute_onclick$.getGlobalValue() );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_markup( dhtml_macros.dhtml_change_visible_section_onclick( $str264$binary_frame, $str258$unary_frame ) );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                      ...
                      {
                        html_macros.$html_safe_print$.bind( T, thread );
                        html_utilities.html_princ( $str265$_arg2 );
                      }
                      finally
                      {
                ...
                html_utilities.html_markup( html_macros.$html_table_data_valign$.getGlobalValue() );
                html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                html_utilities.html_markup( html_utilities.html_align( $kw266$BOTTOM ) );
                html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                ...
                {
                  html_macros.$html_safe_print$.bind( T, thread );
                  html_utilities.html_submit_input( $str267$Assert, $str258$unary_frame, UNPROVIDED );
                }
                finally
                {
            ...
            try
            {
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                cb_form_widgets.cb_el_term_input_section( NIL, ConsesLow.list( new SubLObject[] { $kw268$INPUT_NAME, $str261$unary_frame_pred, $kw269$COMPLETE_TYPE, $const263$UnaryPredicate, $kw270$CLEAR_LABEL, NIL,
                  $kw271$COMPLETE_LABEL, NIL, $kw272$WIDTH, text_width
                } ) );
              }
              finally
              {
      ...
      html_utilities.html_markup( html_macros.$html_div_tail$.getGlobalValue() );
      html_utilities.html_source_readability_terpri( UNPROVIDED );
      dhtml_macros.dhtml_set_switched_visibility( $str264$binary_frame, $kw109$VISIBLE, $kw257$PARAGRAPH );
      html_utilities.html_markup( html_macros.$html_div_head$.getGlobalValue() );
      html_utilities.html_markup( html_macros.$html_attribute_id$.getGlobalValue() );
      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
      html_utilities.html_markup( $str264$binary_frame );
      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
        ...
        try
        {
          ...
          try
          {
            ...
            try
            {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                      html_complete.html_complete_link( $str273$binary_frame_pred, $str274$binary_predicate, $const275$BinaryPredicate, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                    }
                    finally
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_event_attribute_onclick$.getGlobalValue() );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_markup( dhtml_macros.dhtml_change_visible_section_onclick( $str276$binary, $str264$binary_frame ) );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                      ...
                      {
                        html_macros.$html_safe_print$.bind( T, thread );
                        html_utilities.html_princ( $str277$_arg1 );
                      }
                      finally
                      {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                      html_complete.html_complete_link( $str278$binary_frame_arg2, $str279$arg2, $const280$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                    }
                    finally
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_event_attribute_onclick$.getGlobalValue() );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_markup( dhtml_macros.dhtml_change_visible_section_onclick( $str258$unary_frame, $str264$binary_frame ) );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                      ...
                      {
                        html_macros.$html_safe_print$.bind( T, thread );
                        final SubLObject image_src = cyc_file_dependencies.cb_icon_file_path( $kw239$CLOSE_RED );
                        final SubLObject align = $kw88$TOP;
                        final SubLObject alt = cyc_file_dependencies.cb_get_icon_alt_string( $kw239$CLOSE_RED );
                        final SubLObject border = ZERO_INTEGER;
                        html_utilities.html_markup( html_macros.$html_image_head$.getGlobalValue() );
                        html_utilities.html_markup( html_macros.$html_image_src$.getGlobalValue() );
                        html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_event_attribute_onclick$.getGlobalValue() );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_markup( dhtml_macros.dhtml_change_visible_section_onclick( $str281$ternary, $str264$binary_frame ) );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                      ...
                      {
                        html_macros.$html_safe_print$.bind( T, thread );
                        html_utilities.html_princ( $str282$_arg3 );
                      }
                      finally
                      {
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                html_utilities.html_submit_input( $str267$Assert, $str264$binary_frame, UNPROVIDED );
              }
              finally
              {
            ...
            try
            {
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                cb_form_widgets.cb_el_term_input_section( NIL, ConsesLow.list( new SubLObject[] { $kw268$INPUT_NAME, $str273$binary_frame_pred, $kw269$COMPLETE_TYPE, $const275$BinaryPredicate, $kw270$CLEAR_LABEL, NIL,
                  $kw271$COMPLETE_LABEL, NIL, $kw272$WIDTH, text_width
                } ) );
              }
              finally
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                cb_form_widgets.cb_el_term_input_section( NIL, ConsesLow.list( $kw268$INPUT_NAME, $str278$binary_frame_arg2, $kw270$CLEAR_LABEL, NIL, $kw271$COMPLETE_LABEL, NIL, $kw272$WIDTH, text_width ) );
              }
              finally
              {
      ...
      html_utilities.html_markup( html_macros.$html_div_tail$.getGlobalValue() );
      html_utilities.html_source_readability_terpri( UNPROVIDED );
      dhtml_macros.dhtml_set_switched_visibility( $str276$binary, $kw3$INVISIBLE, $kw257$PARAGRAPH );
      html_utilities.html_markup( html_macros.$html_div_head$.getGlobalValue() );
      html_utilities.html_markup( html_macros.$html_attribute_id$.getGlobalValue() );
      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
      html_utilities.html_markup( $str276$binary );
      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
        ...
        try
        {
          ...
          try
          {
            ...
            try
            {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                      html_complete.html_complete_link( $str283$binary_pred, $str274$binary_predicate, $const275$BinaryPredicate, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                    }
                    finally
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                      html_complete.html_complete_link( $str284$binary_arg1, $str285$arg1, $const280$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                    }
                    finally
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_event_attribute_onclick$.getGlobalValue() );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_markup( dhtml_macros.dhtml_change_visible_section_onclick( $str264$binary_frame, $str276$binary ) );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                      html_complete.html_complete_link( $str286$binary_arg2, $str279$arg2, $const280$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                    }
                    finally
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_event_attribute_onclick$.getGlobalValue() );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_markup( dhtml_macros.dhtml_change_visible_section_onclick( $str281$ternary, $str276$binary ) );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                html_utilities.html_submit_input( $str267$Assert, $str276$binary, UNPROVIDED );
              }
              finally
              {
            ...
            try
            {
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                cb_form_widgets.cb_el_term_input_section( NIL, ConsesLow.list( new SubLObject[] { $kw268$INPUT_NAME, $str283$binary_pred, $kw269$COMPLETE_TYPE, $const275$BinaryPredicate, $kw270$CLEAR_LABEL, NIL,
                  $kw271$COMPLETE_LABEL, NIL, $kw272$WIDTH, text_width
                } ) );
              }
              finally
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                cb_form_widgets.cb_el_term_input_section( NIL, ConsesLow.list( $kw268$INPUT_NAME, $str284$binary_arg1, $kw270$CLEAR_LABEL, NIL, $kw271$COMPLETE_LABEL, NIL, $kw272$WIDTH, text_width ) );
              }
              finally
              {
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                cb_form_widgets.cb_el_term_input_section( NIL, ConsesLow.list( $kw268$INPUT_NAME, $str286$binary_arg2, $kw270$CLEAR_LABEL, NIL, $kw271$COMPLETE_LABEL, NIL, $kw272$WIDTH, text_width ) );
              }
              finally
              {
      ...
      html_utilities.html_markup( html_macros.$html_div_tail$.getGlobalValue() );
      html_utilities.html_source_readability_terpri( UNPROVIDED );
      dhtml_macros.dhtml_set_switched_visibility( $str281$ternary, $kw3$INVISIBLE, $kw257$PARAGRAPH );
      html_utilities.html_markup( html_macros.$html_div_head$.getGlobalValue() );
      html_utilities.html_markup( html_macros.$html_attribute_id$.getGlobalValue() );
      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
      html_utilities.html_markup( $str281$ternary );
      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
          ...
          try
          {
            ...
            try
            {
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                      html_complete.html_complete_link( $str287$ternary_pred, $str288$ternary_predicate, $const289$TernaryPredicate, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                    }
                    finally
              ...
              try
              {
                ...
                html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                html_complete.html_complete_link( $str290$ternary_arg1, $str285$arg1, $const280$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
              }
              finally
              ...
              try
              {
                ...
                html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                html_complete.html_complete_link( $str291$ternary_arg2, $str279$arg2, $const280$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
              }
              finally
                ...
                try
                {
                  ...
                  try
                  {
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                      html_complete.html_complete_link( $str292$ternary_arg3, $str293$arg3, $const280$Thing, UNPROVIDED, UNPROVIDED, UNPROVIDED );
                      html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                    }
                    finally
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_event_attribute_onclick$.getGlobalValue() );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_markup( dhtml_macros.dhtml_change_visible_section_onclick( $str276$binary, $str281$ternary ) );
                      html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
                      html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
                    ...
                    try
                    {
                      ...
                      html_utilities.html_markup( html_macros.$html_italic_head$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_small_head$.getGlobalValue() );
                      html_utilities.html_princ( $str294$_arg4 );
                      html_utilities.html_markup( html_macros.$html_small_tail$.getGlobalValue() );
                      html_utilities.html_markup( html_macros.$html_italic_tail$.getGlobalValue() );
                    }
                    finally
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                html_utilities.html_submit_input( $str267$Assert, $str281$ternary, UNPROVIDED );
              }
              finally
              {
            ...
            try
            {
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                cb_form_widgets.cb_el_term_input_section( NIL, ConsesLow.list( new SubLObject[] { $kw268$INPUT_NAME, $str287$ternary_pred, $kw269$COMPLETE_TYPE, $const289$TernaryPredicate, $kw270$CLEAR_LABEL, NIL,
                  $kw271$COMPLETE_LABEL, NIL, $kw272$WIDTH, text_width
                } ) );
              }
              finally
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                cb_form_widgets.cb_el_term_input_section( NIL, ConsesLow.list( $kw268$INPUT_NAME, $str290$ternary_arg1, $kw270$CLEAR_LABEL, NIL, $kw271$COMPLETE_LABEL, NIL, $kw272$WIDTH, text_width ) );
              }
              finally
              {
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                cb_form_widgets.cb_el_term_input_section( NIL, ConsesLow.list( $kw268$INPUT_NAME, $str291$ternary_arg2, $kw270$CLEAR_LABEL, NIL, $kw271$COMPLETE_LABEL, NIL, $kw272$WIDTH, text_width ) );
              }
              finally
              {
              ...
              {
                html_macros.$html_safe_print$.bind( T, thread );
                cb_form_widgets.cb_el_term_input_section( NIL, ConsesLow.list( $kw268$INPUT_NAME, $str292$ternary_arg3, $kw270$CLEAR_LABEL, NIL, $kw271$COMPLETE_LABEL, NIL, $kw272$WIDTH, text_width ) );
              }
              finally
              {
  ...
  public static SubLObject cb_handle_gaf_entry(final SubLObject args)
  {
    ...
    return cb_assertion_editor.cb_assert_internal( $kw295$DEFAULT, NIL, sentence, UNPROVIDED );
  }
  ...
  {
    if( NIL != html_utilities.html_extract_input( $str258$unary_frame, args ) )
    {
      final SubLObject pred = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str261$unary_frame_pred, args ), UNPROVIDED );
      final SubLObject arg1 = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str260$implicit_arg1, args ), UNPROVIDED );
      if( NIL == pred )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str261$unary_frame_pred, args ) ), $str297$_did_not_specify_a_term ) );
      }
      if( NIL == arg1 )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str260$implicit_arg1, args ) ), $str297$_did_not_specify_a_term ) );
      }
      final SubLObject sentence = el_utilities.make_unary_formula( pred, arg1 );
      return Values.values( sentence, NIL );
    }
    else if( NIL != html_utilities.html_extract_input( $str264$binary_frame, args ) )
    {
      final SubLObject pred = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str273$binary_frame_pred, args ), UNPROVIDED );
      final SubLObject arg1 = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str260$implicit_arg1, args ), UNPROVIDED );
      final SubLObject arg2 = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str278$binary_frame_arg2, args ), UNPROVIDED );
      if( NIL == pred )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str273$binary_frame_pred, args ) ), $str297$_did_not_specify_a_term ) );
      }
      if( NIL == arg1 )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str260$implicit_arg1, args ) ), $str297$_did_not_specify_a_term ) );
      ...
      if( NIL == arg2 )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str278$binary_frame_arg2, args ) ), $str297$_did_not_specify_a_term ) );
      }
      final SubLObject sentence2 = el_utilities.make_binary_formula( pred, arg1, arg2 );
      return Values.values( sentence2, NIL );
    }
    else if( NIL != html_utilities.html_extract_input( $str276$binary, args ) )
    {
      final SubLObject pred = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str283$binary_pred, args ), UNPROVIDED );
      final SubLObject arg1 = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str284$binary_arg1, args ), UNPROVIDED );
      final SubLObject arg2 = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str286$binary_arg2, args ), UNPROVIDED );
      if( NIL == pred )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str283$binary_pred, args ) ), $str297$_did_not_specify_a_term ) );
      }
      if( NIL == arg1 )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str284$binary_arg1, args ) ), $str297$_did_not_specify_a_term ) );
      }
      if( NIL == arg2 )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str286$binary_arg2, args ) ), $str297$_did_not_specify_a_term ) );
      }
      final SubLObject sentence2 = el_utilities.make_binary_formula( pred, arg1, arg2 );
      return Values.values( sentence2, NIL );
    }
    ...
    {
      if( NIL == html_utilities.html_extract_input( $str281$ternary, args ) )
      {
        return Values.values( NIL, $str298$Unexpected_sentence_entry_method );
      }
      final SubLObject pred = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str287$ternary_pred, args ), UNPROVIDED );
      final SubLObject arg1 = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str290$ternary_arg1, args ), UNPROVIDED );
      final SubLObject arg2 = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str291$ternary_arg2, args ), UNPROVIDED );
      final SubLObject arg3 = cb_utilities.cb_guess_term( html_utilities.html_extract_input( $str292$ternary_arg3, args ), UNPROVIDED );
      if( NIL == pred )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str287$ternary_pred, args ) ), $str297$_did_not_specify_a_term ) );
      }
      if( NIL == arg1 )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str290$ternary_arg1, args ) ), $str297$_did_not_specify_a_term ) );
      }
      if( NIL == arg2 )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str291$ternary_arg2, args ) ), $str297$_did_not_specify_a_term ) );
      }
      if( NIL == arg3 )
      {
        return Values.values( NIL, Sequences.cconcatenate( format_nil.format_nil_a_no_copy( html_utilities.html_extract_input( $str292$ternary_arg3, args ) ), $str297$_did_not_specify_a_term ) );
      }
      final SubLObject sentence3 = el_utilities.make_ternary_formula( pred, arg1, arg2, arg3 );
      return Values.values( sentence3, NIL );
    }
  }
  ...
  {
    return cb_utilities.cb_error( $str299$_A, error, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  }
  ...
  {
    final SubLThread thread = SubLProcess.currentSubLThread();
    final SubLObject dim_id = Sequences.cconcatenate( $str300$dim_, format_nil.format_nil_a_no_copy( random.random( $int301$10000 ) ) );
    final SubLObject bright_id = Sequences.cconcatenate( $str300$dim_, format_nil.format_nil_a_no_copy( random.random( $int301$10000 ) ) );
    ...
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    html_utilities.html_markup( Sequences.cconcatenate( $str302$setVisibility__, new SubLObject[] { format_nil.format_nil_a_no_copy( bright_id ), $str303$___inline___setVisibility__, format_nil.format_nil_a_no_copy(
        dim_id ), $str304$___none___
    } ) );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    html_utilities.html_markup( html_macros.$html_anchor_onmouseout$.getGlobalValue() );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    html_utilities.html_markup( Sequences.cconcatenate( $str302$setVisibility__, new SubLObject[] { format_nil.format_nil_a_no_copy( dim_id ), $str303$___inline___setVisibility__, format_nil.format_nil_a_no_copy(
        bright_id ), $str304$___none___
    } ) );
    html_utilities.html_char( Characters.CHAR_quotation, UNPROVIDED );
    html_utilities.html_char( Characters.CHAR_greater, UNPROVIDED );
    final SubLObject _prev_bind_0 = html_macros.$html_safe_print$.currentBinding( thread );
  ...
  {
    SubLFiles.declareFunction( me, "cb_inferred_index_frame", "CB-INFERRED-INDEX-FRAME", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_inferred_index", "CB-LINK-INFERRED-INDEX", 1, 2, false );
    SubLFiles.declareFunction( me, "cb_legacy_index_frame", "CB-LEGACY-INDEX-FRAME", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_legacy_index", "CB-LINK-LEGACY-INDEX", 1, 2, false );
    SubLFiles.declareFunction( me, "cb_inferred_index", "CB-INFERRED-INDEX", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_gaf_arg_index_utilities_section", "CB-SHOW-INFERRED-GAF-ARG-INDEX-UTILITIES-SECTION", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_possibly_show_term_as_seen_from_mt_header", "CB-POSSIBLY-SHOW-TERM-AS-SEEN-FROM-MT-HEADER", 1, 1, false );
    SubLFiles.declareFunction( me, "cb_show_term_as_seen_from_mt_header", "CB-SHOW-TERM-AS-SEEN-FROM-MT-HEADER", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_gaf_arg_index_header", "CB-SHOW-INFERRED-GAF-ARG-INDEX-HEADER", 3, 0, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_gaf_arg_index", "CB-SHOW-INFERRED-GAF-ARG-INDEX", 1, 2, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_gaf_arg_index_by_ontology", "CB-SHOW-INFERRED-GAF-ARG-INDEX-BY-ONTOLOGY", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_gaf_arg_index_by_predicate", "CB-SHOW-INFERRED-GAF-ARG-INDEX-BY-PREDICATE", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_gaf_arg_index_all_assertions_line", "CB-SHOW-INFERRED-GAF-ARG-INDEX-ALL-ASSERTIONS-LINE", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_index_count", "CB-SHOW-INFERRED-INDEX-COUNT", 1, 1, false );
    SubLFiles.declareFunction( me, "cb_make_inferred_gaf_arg_index_tuples_object_id", "CB-MAKE-INFERRED-GAF-ARG-INDEX-TUPLES-OBJECT-ID", 1, 1, false );
    SubLFiles.declareFunction( me, "cb_link_literal_query", "CB-LINK-LITERAL-QUERY", 3, 1, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_index_literal_query_linkP", "CB-SHOW-INFERRED-INDEX-LITERAL-QUERY-LINK?", 3, 0, false );
    SubLFiles.declareFunction( me, "cb_link_hier_brow", "CB-LINK-HIER-BROW", 3, 1, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_index_hierarchy_browser_linkP", "CB-SHOW-INFERRED-INDEX-HIERARCHY-BROWSER-LINK?", 3, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_order_by", "CB-INFERRED-INDEX-ORDER-BY", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_inferred_index_order_by", "CB-LINK-INFERRED-INDEX-ORDER-BY", 3, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_visibility", "CB-INFERRED-INDEX-VISIBILITY", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_inferred_index_toggle_visibility", "CB-LINK-INFERRED-INDEX-TOGGLE-VISIBILITY", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_predicate_filters", "CB-INFERRED-INDEX-PREDICATE-FILTERS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_inferred_index_predicate_filters", "CB-LINK-INFERRED-INDEX-PREDICATE-FILTERS", 0, 2, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_predicate_filters_guts", "CB-INFERRED-INDEX-PREDICATE-FILTERS-GUTS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_predicate_type_filter_remove_allow_checkbox", "CB-INFERRED-INDEX-PREDICATE-TYPE-FILTER-REMOVE-ALLOW-CHECKBOX", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_predicate_type_filter_remove_forbid_checkbox", "CB-INFERRED-INDEX-PREDICATE-TYPE-FILTER-REMOVE-FORBID-CHECKBOX", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_predicate_filter_forbid_checkbox", "CB-INFERRED-INDEX-PREDICATE-FILTER-FORBID-CHECKBOX", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_predicate_filter_allow_checkbox", "CB-INFERRED-INDEX-PREDICATE-FILTER-ALLOW-CHECKBOX", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_handle_inferred_index_predicate_filters", "CB-HANDLE-INFERRED-INDEX-PREDICATE-FILTERS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_extract_inferred_index_predicate_filters", "CB-EXTRACT-INFERRED-INDEX-PREDICATE-FILTERS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_clear_inferred_index_predicate_filters", "CB-CLEAR-INFERRED-INDEX-PREDICATE-FILTERS", 0, 0, false );
    SubLFiles.declareFunction( me, "cb_update_inferred_index_predicate_filters", "CB-UPDATE-INFERRED-INDEX-PREDICATE-FILTERS", 6, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_ontology_filters", "CB-INFERRED-INDEX-ONTOLOGY-FILTERS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_inferred_index_ontology_filters", "CB-LINK-INFERRED-INDEX-ONTOLOGY-FILTERS", 0, 2, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_ontology_filters_guts", "CB-INFERRED-INDEX-ONTOLOGY-FILTERS-GUTS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_ontology_horizon_radio_button", "CB-INFERRED-INDEX-ONTOLOGY-HORIZON-RADIO-BUTTON", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_handle_inferred_index_ontology_filters", "CB-HANDLE-INFERRED-INDEX-ONTOLOGY-FILTERS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_show_ontology_horizon_term", "CB-SHOW-ONTOLOGY-HORIZON-TERM", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_extract_inferred_index_ontology_horizon", "CB-EXTRACT-INFERRED-INDEX-ONTOLOGY-HORIZON", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_update_inferred_index_ontology_filters", "CB-UPDATE-INFERRED-INDEX-ONTOLOGY-FILTERS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_microtheory_filters", "CB-INFERRED-INDEX-MICROTHEORY-FILTERS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_inferred_index_microtheory_filters", "CB-LINK-INFERRED-INDEX-MICROTHEORY-FILTERS", 0, 2, false );
    SubLFiles.declareFunction( me, "cb_set_microtheory_browsing_filter", "CB-SET-MICROTHEORY-BROWSING-FILTER", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_link_inferred_gaf_arg_assertions", "CB-LINK-INFERRED-GAF-ARG-ASSERTIONS", 2, 3, false );
    SubLFiles.declareFunction( me, "cb_inferred_gaf_arg_assertions", "CB-INFERRED-GAF-ARG-ASSERTIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_inferred_gaf_arg_assertions_guts", "CB-INFERRED-GAF-ARG-ASSERTIONS-GUTS", 4, 0, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_gaf_arg_assertions_by_ontology", "CB-SHOW-INFERRED-GAF-ARG-ASSERTIONS-BY-ONTOLOGY", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_gaf_arg_assertions_by_predicate", "CB-SHOW-INFERRED-GAF-ARG-ASSERTIONS-BY-PREDICATE", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_show_inferred_gaf_arg_index_assertions_final", "CB-SHOW-INFERRED-GAF-ARG-INDEX-ASSERTIONS-FINAL", 5, 0, false );
    SubLFiles.declareFunction( me, "hl_support_module_for_predicate", "HL-SUPPORT-MODULE-FOR-PREDICATE", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_show_qua_justification", "CB-SHOW-QUA-JUSTIFICATION", 3, 0, false );
    SubLFiles.declareFunction( me, "filter_gaf_arg_index_tuples", "FILTER-GAF-ARG-INDEX-TUPLES", 1, 3, false );
    SubLFiles.declareFunction( me, "cb_inferred_index_definitional_information", "CB-INFERRED-INDEX-DEFINITIONAL-INFORMATION", 1, 0, false );
    SubLFiles.declareFunction( me, "inferred_index_definitional_information_override", "INFERRED-INDEX-DEFINITIONAL-INFORMATION-OVERRIDE", 2, 0, false );
    SubLFiles.declareFunction( me, "cb_term_type_header_with_gaf_entry", "CB-TERM-TYPE-HEADER-WITH-GAF-ENTRY", 1, 1, false );
    SubLFiles.declareFunction( me, "cb_term_type_header", "CB-TERM-TYPE-HEADER", 1, 1, false );
    SubLFiles.declareFunction( me, "cb_gaf_entry_widget_links", "CB-GAF-ENTRY-WIDGET-LINKS", 0, 3, false );
    SubLFiles.declareFunction( me, "cb_gaf_entry_widget", "CB-GAF-ENTRY-WIDGET", 1, 1, false );
    SubLFiles.declareFunction( me, "cb_handle_gaf_entry", "CB-HANDLE-GAF-ENTRY", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_extract_gaf_entry_sentence", "CB-EXTRACT-GAF-ENTRY-SENTENCE", 1, 0, false );
    SubLFiles.declareFunction( me, "cb_show_gaf_entry_error", "CB-SHOW-GAF-ENTRY-ERROR", 1, 0, false );
    SubLFiles.declareFunction( me, "dhtml_highlight_icon_on_mouseover", "DHTML-HIGHLIGHT-ICON-ON-MOUSEOVER", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_cb_inferred_index_file()
  {
    $cb_inferred_index_order_by$ = SubLFiles.defvar( "*CB-INFERRED-INDEX-ORDER-BY*", $kw0$ONTOLOGY );
    $cb_inferred_index_filters$ = SubLFiles.defvar( "*CB-INFERRED-INDEX-FILTERS*", NIL );
    $cb_inferred_index_visibility$ = SubLFiles.defvar( "*CB-INFERRED-INDEX-VISIBILITY*", $kw3$INVISIBLE );
    $predicate_support_module_map$ = SubLFiles.deflexical( "*PREDICATE-SUPPORT-MODULE-MAP*", $list229 );
    return NIL;
  }

  public static SubLObject setup_cb_inferred_index_file()
  {
    utilities_macros.register_html_state_variable( $sym1$_CB_INFERRED_INDEX_ORDER_BY_ );
    utilities_macros.register_html_interface_variable( $sym1$_CB_INFERRED_INDEX_ORDER_BY_ );
    utilities_macros.register_html_state_variable( $sym2$_CB_INFERRED_INDEX_FILTERS_ );
    utilities_macros.register_html_interface_variable( $sym2$_CB_INFERRED_INDEX_FILTERS_ );
    utilities_macros.register_html_state_variable( $sym4$_CB_INFERRED_INDEX_VISIBILITY_ );
    utilities_macros.register_html_interface_variable( $sym4$_CB_INFERRED_INDEX_VISIBILITY_ );
    html_macros.note_cgi_handler_function( $sym7$CB_INFERRED_INDEX_FRAME, $kw8$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw12$INFERRED_INDEX, $sym13$CB_LINK_INFERRED_INDEX, THREE_INTEGER );
    html_macros.note_cgi_handler_function( $sym14$CB_LEGACY_INDEX_FRAME, $kw8$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw17$LEGACY_INDEX, $sym18$CB_LINK_LEGACY_INDEX, THREE_INTEGER );
    cb_utilities.setup_cb_link_method( $kw113$LITERAL_QUERY, $sym126$CB_LINK_LITERAL_QUERY, FOUR_INTEGER );
    cb_utilities.setup_cb_link_method( $kw114$HIER_BROW, $sym130$CB_LINK_HIER_BROW, FOUR_INTEGER );
    html_macros.note_cgi_handler_function( $sym133$CB_INFERRED_INDEX_ORDER_BY, $kw8$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw94$INFERRED_INDEX_ORDER_BY, $sym135$CB_LINK_INFERRED_INDEX_ORDER_BY, THREE_INTEGER );
    html_macros.note_cgi_handler_function( $sym137$CB_INFERRED_INDEX_VISIBILITY, $kw8$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw117$INFERRED_INDEX_TOGGLE_VISIBILITY, $sym144$CB_LINK_INFERRED_INDEX_TOGGLE_VISIBILITY, ONE_INTEGER );
    html_macros.note_cgi_handler_function( $sym147$CB_INFERRED_INDEX_PREDICATE_FILTERS, $kw8$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw97$INFERRED_INDEX_PREDICATE_FILTERS, $sym150$CB_LINK_INFERRED_INDEX_PREDICATE_FILTERS, TWO_INTEGER );
    html_macros.note_cgi_handler_function( $sym184$CB_HANDLE_INFERRED_INDEX_PREDICATE_FILTERS, $kw8$HTML_HANDLER );
    html_macros.note_cgi_handler_function( $sym186$CB_INFERRED_INDEX_ONTOLOGY_FILTERS, $kw8$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw98$INFERRED_INDEX_ONTOLOGY_FILTERS, $sym189$CB_LINK_INFERRED_INDEX_ONTOLOGY_FILTERS, TWO_INTEGER );
    html_macros.note_cgi_handler_function( $sym199$CB_HANDLE_INFERRED_INDEX_ONTOLOGY_FILTERS, $kw8$HTML_HANDLER );
    html_macros.note_cgi_handler_function( $sym207$CB_INFERRED_INDEX_MICROTHEORY_FILTERS, $kw8$HTML_HANDLER );
    cb_utilities.setup_cb_link_method( $kw99$INFERRED_INDEX_MICROTHEORY_FILTERS, $sym209$CB_LINK_INFERRED_INDEX_MICROTHEORY_FILTERS, TWO_INTEGER );
    cb_utilities.setup_cb_link_method( $kw107$INFERRED_GAF_ARG_ASSERTIONS, $sym214$CB_LINK_INFERRED_GAF_ARG_ASSERTIONS, FIVE_INTEGER );
    html_macros.note_cgi_handler_function( $sym219$CB_INFERRED_GAF_ARG_ASSERTIONS, $kw8$HTML_HANDLER );
    Hashtables.sethash( $kw239$CLOSE_RED, cyc_file_dependencies.$cb_icon_definitions$.getGlobalValue(), ConsesLow.list( $str240$red_x_close_15_gif, NIL ) );
    Hashtables.sethash( $kw241$CLOSE_RED_DIM, cyc_file_dependencies.$cb_icon_definitions$.getGlobalValue(), ConsesLow.list( $str242$dim_red_x_close_15_gif, NIL ) );
    html_macros.note_cgi_handler_function( $sym296$CB_HANDLE_GAF_ENTRY, $kw8$HTML_HANDLER );
    return NIL;
  }
  ...
  static
  {
    me = new cb_inferred_index();
    $cb_inferred_index_order_by$ = null;
    $cb_inferred_index_filters$ = null;
    $cb_inferred_index_visibility$ = null;
    $predicate_support_module_map$ = null;
    $kw0$ONTOLOGY = makeKeyword( "ONTOLOGY" );
    $sym1$_CB_INFERRED_INDEX_ORDER_BY_ = makeSymbol( "*CB-INFERRED-INDEX-ORDER-BY*" );
    $sym2$_CB_INFERRED_INDEX_FILTERS_ = makeSymbol( "*CB-INFERRED-INDEX-FILTERS*" );
    $kw3$INVISIBLE = makeKeyword( "INVISIBLE" );
    $sym4$_CB_INFERRED_INDEX_VISIBILITY_ = makeSymbol( "*CB-INFERRED-INDEX-VISIBILITY*" );
    $list5 = ConsesLow.list( makeSymbol( "INDEX-ID" ) );
    $str6$Unable_to_determine_a_term_from__ = makeString( "Unable to determine a term from ~S" );
    $sym7$CB_INFERRED_INDEX_FRAME = makeSymbol( "CB-INFERRED-INDEX-FRAME" );
    $kw8$HTML_HANDLER = makeKeyword( "HTML-HANDLER" );
    $kw9$SELF = makeKeyword( "SELF" );
    $str10$_Inferred_ = makeString( "[Inferred]" );
    $str11$cb_inferred_index_frame__A = makeString( "cb-inferred-index-frame&~A" );
    $kw12$INFERRED_INDEX = makeKeyword( "INFERRED-INDEX" );
    $sym13$CB_LINK_INFERRED_INDEX = makeSymbol( "CB-LINK-INFERRED-INDEX" );
    $sym14$CB_LEGACY_INDEX_FRAME = makeSymbol( "CB-LEGACY-INDEX-FRAME" );
    $str15$_Legacy_ = makeString( "[Legacy]" );
    $str16$cb_legacy_index_frame__A = makeString( "cb-legacy-index-frame&~A" );
    $kw17$LEGACY_INDEX = makeKeyword( "LEGACY-INDEX" );
    $sym18$CB_LINK_LEGACY_INDEX = makeSymbol( "CB-LINK-LEGACY-INDEX" );
    ...
    $str23$Browsing___ = makeString( "Browsing : " );
    $kw24$DOCUMENTATION = makeKeyword( "DOCUMENTATION" );
    $str25$documentation = makeString( "documentation" );
    $str26$___ = makeString( " | " );
    $kw27$DEFINITIONAL = makeKeyword( "DEFINITIONAL" );
    $str28$definitional = makeString( "definitional" );
    $kw29$LEXICAL = makeKeyword( "LEXICAL" );
    $str30$lexical = makeString( "lexical" );
    $str31$Editing___ = makeString( "Editing : " );
    $kw32$EDIT_IN_SMT = makeKeyword( "EDIT-IN-SMT" );
    $str33$edit_in_SMT = makeString( "edit in SMT" );
    $kw34$CREATE_SIMILAR = makeKeyword( "CREATE-SIMILAR" );
    $str35$copy = makeString( "copy" );
    $kw36$RENAME = makeKeyword( "RENAME" );
    $str37$rename = makeString( "rename" );
    $kw38$LEXIFY_TERM = makeKeyword( "LEXIFY-TERM" );
    $str39$lexify = makeString( "lexify" );
    $kw40$MERGE = makeKeyword( "MERGE" );
    $str41$merge = makeString( "merge" );
    $kw42$CONFIRM_KILL = makeKeyword( "CONFIRM-KILL" );
    $kw43$KILL = makeKeyword( "KILL" );
    $str44$kill = makeString( "kill" );
    $kw45$CREATE_INSTANCE = makeKeyword( "CREATE-INSTANCE" );
    $str46$create_instance = makeString( "create instance" );
    $kw47$CREATE_SPEC = makeKeyword( "CREATE-SPEC" );
    $str48$create_spec = makeString( "create spec" );
    $str49$Advanced___ = makeString( "Advanced : " );
    $kw50$CHRONOLOGICAL_ORDER = makeKeyword( "CHRONOLOGICAL-ORDER" );
    $str51$history = makeString( "history" );
    $kw52$DESCRIBE_NART = makeKeyword( "DESCRIBE-NART" );
    $kw53$DESCRIBE_CONSTANT = makeKeyword( "DESCRIBE-CONSTANT" );
    $kw54$TTT_TEST = makeKeyword( "TTT-TEST" );
    $str55$take_test = makeString( "take test" );
    $kw56$KCT_TEST = makeKeyword( "KCT-TEST" );
    $str57$run_test = makeString( "run test" );
    $kw58$KBQ_ASK = makeKeyword( "KBQ-ASK" );
    $str59$ask_query = makeString( "ask query" );
    $kw60$KBQ_ASK_IN_PROOF_CHECKER = makeKeyword( "KBQ-ASK-IN-PROOF-CHECKER" );
    $str61$proof_check_query = makeString( "proof-check query" );
    $kw62$KCT_EDIT = makeKeyword( "KCT-EDIT" );
    $str63$edit_test = makeString( "edit test" );
    $kw64$KBQ_EDIT = makeKeyword( "KBQ-EDIT" );
    $str65$edit_query = makeString( "edit query" );
    $kw66$KB_MONITOR_INDEX_HOOK = makeKeyword( "KB-MONITOR-INDEX-HOOK" );
    $str67$monitor = makeString( "monitor" );
    $kw68$KCT_TEST_SET = makeKeyword( "KCT-TEST-SET" );
    $str69$run_test_set = makeString( "run test set" );
    $str70$more_filters = makeString( "more filters" );
    $kw71$HANDLER = makeKeyword( "HANDLER" );
    $sym72$CB_C_PERTINENT_QUERY_LINKS = makeSymbol( "CB-C-PERTINENT-QUERY-LINKS" );
    $kw73$ARGS = makeKeyword( "ARGS" );
    $str74$term = makeString( "term" );
    $kw75$MESSAGE = makeKeyword( "MESSAGE" );
    $str76$Checking_for_Pertinent_Queries___ = makeString( "Checking for Pertinent Queries..." );
    $kw77$TAG = makeKeyword( "TAG" );
    $str78$div = makeString( "div" );
    $kw79$DELAY = makeKeyword( "DELAY" );
    $int80$50 = makeInteger( 50 );
    $kw81$BEFORE = makeKeyword( "BEFORE" );
    $const82$EverythingPSC = constant_handles.reader_make_constant_shell( makeString( "EverythingPSC" ) );
    $kw83$BOTH = makeKeyword( "BOTH" );
    $kw84$AFTER = makeKeyword( "AFTER" );
    $str85$as_seen_from = makeString( "as seen from" );
    $str86$100_ = makeString( "100%" );
    $kw87$LEFT = makeKeyword( "LEFT" );
    $kw88$TOP = makeKeyword( "TOP" );
    $kw89$RIGHT = makeKeyword( "RIGHT" );
    $str90$40_ = makeString( "40%" );
    $str91$order_by__ = makeString( "order by :" );
    $kw92$PREDICATE = makeKeyword( "PREDICATE" );
    $str93$predicate = makeString( "predicate" );
    $kw94$INFERRED_INDEX_ORDER_BY = makeKeyword( "INFERRED-INDEX-ORDER-BY" );
    $str95$ontology = makeString( "ontology" );
    $str96$filters__ = makeString( "filters :" );
    $kw97$INFERRED_INDEX_PREDICATE_FILTERS = makeKeyword( "INFERRED-INDEX-PREDICATE-FILTERS" );
    $kw98$INFERRED_INDEX_ONTOLOGY_FILTERS = makeKeyword( "INFERRED-INDEX-ONTOLOGY-FILTERS" );
    $kw99$INFERRED_INDEX_MICROTHEORY_FILTERS = makeKeyword( "INFERRED-INDEX-MICROTHEORY-FILTERS" );
    $str100$mt = makeString( "mt" );
    $str101$index_view__ = makeString( "index view :" );
    $str102$inferred = makeString( "inferred" );
    $str103$legacy = makeString( "legacy" );
    $str104$Unexpected_order_by____S = makeString( "Unexpected order-by : ~S" );
    $str105$ = makeString( "" );
    $str106$via_ = makeString( "via " );
    $kw107$INFERRED_GAF_ARG_ASSERTIONS = makeKeyword( "INFERRED-GAF-ARG-ASSERTIONS" );
    $int108$100 = makeInteger( 100 );
    $kw109$VISIBLE = makeKeyword( "VISIBLE" );
    $kw110$TEXT = makeKeyword( "TEXT" );
    $list111 = ConsesLow.list( makeSymbol( "INFER-PRED" ), makeSymbol( "QUA" ), makeSymbol( "ARGNUM" ), makeSymbol( "PRED" ) );
    $str112$_arg_S = makeString( " arg~S" );
    $kw113$LITERAL_QUERY = makeKeyword( "LITERAL-QUERY" );
    $kw114$HIER_BROW = makeKeyword( "HIER-BROW" );
    $str115$All_Assertions = makeString( "All Assertions" );
    $int116$1000 = makeInteger( 1000 );
    $kw117$INFERRED_INDEX_TOGGLE_VISIBILITY = makeKeyword( "INFERRED-INDEX-TOGGLE-VISIBILITY" );
    $str118$__A_ = makeString( "(~A)" );
    $str119$color__red__background_color_yell = makeString( "color: red; background-color:yellow; font-family:monospace" );
    $str120$_ = makeString( "!" );
    $str121$igai_ = makeString( "igai_" );
    $kw122$CONTENT = makeKeyword( "CONTENT" );
    $str123$cb_lq__A__A__A__A = makeString( "cb-lq&~A&~A&~A&~A" );
    $str124$cb_lq__A__A__A = makeString( "cb-lq&~A&~A&~A" );
    $kw125$PLUS_GREEN = makeKeyword( "PLUS-GREEN" );
    $sym126$CB_LINK_LITERAL_QUERY = makeSymbol( "CB-LINK-LITERAL-QUERY" );
    $str127$cb_hier__A__A__A__A = makeString( "cb-hier&~A&~A&~A&~A" );
    $str128$cb_hier__A__A__A = makeString( "cb-hier&~A&~A&~A" );
    $kw129$RED_DIAMOND = makeKeyword( "RED-DIAMOND" );
    $sym130$CB_LINK_HIER_BROW = makeSymbol( "CB-LINK-HIER-BROW" );
    $list131 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "genls" ) ), constant_handles.reader_make_constant_shell( makeString( "genlPreds" ) ), constant_handles.reader_make_constant_shell(
        makeString( "genlMt" ) ) );
    $list132 = ConsesLow.list( makeSymbol( "INDEX-ID" ), makeSymbol( "ORDER-BY-STRING" ) );
    $sym133$CB_INFERRED_INDEX_ORDER_BY = makeSymbol( "CB-INFERRED-INDEX-ORDER-BY" );
    $str134$cb_inferred_index_order_by__A__A = makeString( "cb-inferred-index-order-by&~A&~A" );
    $sym135$CB_LINK_INFERRED_INDEX_ORDER_BY = makeSymbol( "CB-LINK-INFERRED-INDEX-ORDER-BY" );
    $list136 = ConsesLow.list( makeSymbol( "INDEX-ID" ), makeSymbol( "VISIBILITY-STRING" ) );
    $sym137$CB_INFERRED_INDEX_VISIBILITY = makeSymbol( "CB-INFERRED-INDEX-VISIBILITY" );
    $str138$close_all = makeString( "close all" );
    $str139$open_all = makeString( "open all" );
    $kw140$DOWN_TRIANGLE_V = makeKeyword( "DOWN-TRIANGLE-V" );
    $kw141$RIGHT_TRIANGLE_V = makeKeyword( "RIGHT-TRIANGLE-V" );
    $str142$cb_inferred_index_visibility__A__ = makeString( "cb-inferred-index-visibility&~A&~S" );
    $kw143$CENTER = makeKeyword( "CENTER" );
    $sym144$CB_LINK_INFERRED_INDEX_TOGGLE_VISIBILITY = makeSymbol( "CB-LINK-INFERRED-INDEX-TOGGLE-VISIBILITY" );
    $list145 = ConsesLow.list( makeSymbol( "ID-STRING" ) );
    $str146$_S_did_not_specify_a_term = makeString( "~S did not specify a term" );
    $sym147$CB_INFERRED_INDEX_PREDICATE_FILTERS = makeSymbol( "CB-INFERRED-INDEX-PREDICATE-FILTERS" );
    $str148$_Predicate_Filters_ = makeString( "[Predicate Filters]" );
    $str149$cb_inferred_index_predicate_filte = makeString( "cb-inferred-index-predicate-filters&~A" );
    $sym150$CB_LINK_INFERRED_INDEX_PREDICATE_FILTERS = makeSymbol( "CB-LINK-INFERRED-INDEX-PREDICATE-FILTERS" );
    $str151$Inferred_Index_Predicate_Filters = makeString( "Inferred Index Predicate Filters" );
    $str152$post = makeString( "post" );
    $str153$cb_handle_inferred_index_predicat = makeString( "cb-handle-inferred-index-predicate-filters" );
    $str154$relevant_to_ = makeString( "relevant to " );
    $str155$Update_Filters = makeString( "Update Filters" );
    $str156$update = makeString( "update" );
    $str157$Reset_Values = makeString( "Reset Values" );
    $str158$Remove_All_Filters = makeString( "Remove All Filters" );
    $str159$clear = makeString( "clear" );
    $kw160$ALLOW_PREDICATES = makeKeyword( "ALLOW-PREDICATES" );
    $kw161$ALLOW_PREDICATE_TYPES = makeKeyword( "ALLOW-PREDICATE-TYPES" );
    $kw162$FORBID_PREDICATES = makeKeyword( "FORBID-PREDICATES" );
    $kw163$FORBID_PREDICATE_TYPES = makeKeyword( "FORBID-PREDICATE-TYPES" );
    $str164$Allowed_Types = makeString( "Allowed Types" );
    $str165$check_to_remove = makeString( "check to remove" );
    $str166$add_ = makeString( "add " );
    $str167$type_allow = makeString( "type_allow" );
    $int168$30 = makeInteger( 30 );
    $str169$Complete = makeString( "Complete" );
    $const170$Collection = constant_handles.reader_make_constant_shell( makeString( "Collection" ) );
    $str171$Forbidden_Types = makeString( "Forbidden Types" );
    $str172$type_forbid = makeString( "type_forbid" );
    $str173$Allowed_Predicates = makeString( "Allowed Predicates" );
    $kw174$RED = makeKeyword( "RED" );
    $str175$None_ = makeString( "None!" );
    $str176$check_to_forbid = makeString( "check to forbid" );
    $str177$Forbidden_Predicates = makeString( "Forbidden Predicates" );
    $str178$check_to_allow = makeString( "check to allow" );
    $str179$remove_type_allow_ = makeString( "remove_type_allow_" );
    $str180$T = makeString( "T" );
    $str181$remove_type_forbid_ = makeString( "remove_type_forbid_" );
    $str182$forbid_ = makeString( "forbid_" );
    $str183$allow_ = makeString( "allow_" );
    $sym184$CB_HANDLE_INFERRED_INDEX_PREDICATE_FILTERS = makeSymbol( "CB-HANDLE-INFERRED-INDEX-PREDICATE-FILTERS" );
    $list185 = ConsesLow.list( makeSymbol( "NAME" ), makeSymbol( "VALUE" ) );
    $sym186$CB_INFERRED_INDEX_ONTOLOGY_FILTERS = makeSymbol( "CB-INFERRED-INDEX-ONTOLOGY-FILTERS" );
    $str187$_Ontology_Filters_ = makeString( "[Ontology Filters]" );
    $str188$cb_inferred_index_ontology_filter = makeString( "cb-inferred-index-ontology-filters&~A" );
    $sym189$CB_LINK_INFERRED_INDEX_ONTOLOGY_FILTERS = makeSymbol( "CB-LINK-INFERRED-INDEX-ONTOLOGY-FILTERS" );
    $str190$Inferred_Index_Ontology_Filters = makeString( "Inferred Index Ontology Filters" );
    $str191$cb_handle_inferred_index_ontology = makeString( "cb-handle-inferred-index-ontology-filters" );
    $kw192$ONTOLOGY_HORIZON = makeKeyword( "ONTOLOGY-HORIZON" );
    $str193$Generality_Horizon = makeString( "Generality Horizon" );
    $str194$select_a_qualitative_boundary = makeString( "select a qualitative boundary" );
    $list195 = ConsesLow.list( makeKeyword( "SELF" ), makeKeyword( "LOWER" ), makeKeyword( "MIDDLE" ), makeKeyword( "ALL" ) );
    $str196$or_a_generalization = makeString( "or a generalization" );
    $kw197$ALL = makeKeyword( "ALL" );
    $str198$ontology_horizon = makeString( "ontology-horizon" );
    $sym199$CB_HANDLE_INFERRED_INDEX_ONTOLOGY_FILTERS = makeSymbol( "CB-HANDLE-INFERRED-INDEX-ONTOLOGY-FILTERS" );
    $str200$Just_on_the_term = makeString( "Just on the term" );
    $kw201$LOWER = makeKeyword( "LOWER" );
    $str202$Also_from_the_lower_ontology = makeString( "Also from the lower ontology" );
    $kw203$MIDDLE = makeKeyword( "MIDDLE" );
    $str204$Also_up_through_the_middle_ontolo = makeString( "Also up through the middle ontology" );
    $str205$Everything = makeString( "Everything" );
    $str206$Time_to_implement_cb_inferred_ind = makeString( "Time to implement cb-inferred-index-microtheory-filters-guts" );
    $sym207$CB_INFERRED_INDEX_MICROTHEORY_FILTERS = makeSymbol( "CB-INFERRED-INDEX-MICROTHEORY-FILTERS" );
    $str208$_Microtheory_Filters_ = makeString( "[Microtheory Filters]" );
    $sym209$CB_LINK_INFERRED_INDEX_MICROTHEORY_FILTERS = makeSymbol( "CB-LINK-INFERRED-INDEX-MICROTHEORY-FILTERS" );
    $kw210$MICROTHEORY = makeKeyword( "MICROTHEORY" );
    $str211$cb_inferred_gaf_arg_assertions__A = makeString( "cb-inferred-gaf-arg-assertions&~A&~A&~A&~A" );
    $str212$cb_inferred_gaf_arg_assertions__A = makeString( "cb-inferred-gaf-arg-assertions&~A&~A" );
    $str213$cb_inferred_gaf_arg_assertions__A = makeString( "cb-inferred-gaf-arg-assertions&~A" );
    $sym214$CB_LINK_INFERRED_GAF_ARG_ASSERTIONS = makeSymbol( "CB-LINK-INFERRED-GAF-ARG-ASSERTIONS" );
    $list215 = ConsesLow.list( makeSymbol( "TERM-SPEC" ), makeSymbol( "&OPTIONAL" ), makeSymbol( "QUA-SPEC" ), makeSymbol( "ARGNUM-SPEC" ), makeSymbol( "PRED-SPEC" ) );
    $str216$Could_not_determine_a_term_from__ = makeString( "Could not determine a term from ~a" );
    $str217$NIL = makeString( "NIL" );
    $str218$Could_not_determine_an_argnum_fro = makeString( "Could not determine an argnum from ~a" );
    $sym219$CB_INFERRED_GAF_ARG_ASSERTIONS = makeSymbol( "CB-INFERRED-GAF-ARG-ASSERTIONS" );
    $str220$Inferred_GAF_arg_index_for__S = makeString( "Inferred GAF arg index for ~S" );
    $str221$yui_skin_sam = makeString( "yui-skin-sam" );
    $str222$reloadFrameButton = makeString( "reloadFrameButton" );
    $str223$button = makeString( "button" );
    $str224$reload = makeString( "reload" );
    $str225$Refresh = makeString( "Refresh" );
    $str226$reloadCurrentFrame__reloadFrameBu = makeString( "reloadCurrentFrame('reloadFrameButton');" );
    $kw227$QUERY_ISA = makeKeyword( "QUERY-ISA" );
    $str228$_query = makeString( " query" );
    $list229 = ConsesLow.list( ConsesLow.cons( constant_handles.reader_make_constant_shell( makeString( "isa" ) ), makeKeyword( "ISA" ) ), ConsesLow.cons( constant_handles.reader_make_constant_shell( makeString(
        "genls" ) ), makeKeyword( "GENLS" ) ), ConsesLow.cons( constant_handles.reader_make_constant_shell( makeString( "equals" ) ), makeKeyword( "EQUALITY" ) ) );
    $kw230$QUERY = makeKeyword( "QUERY" );
    $const231$equals = constant_handles.reader_make_constant_shell( makeString( "equals" ) );
    $str232$on_ = makeString( "on " );
    $str233$the_term = makeString( "the term" );
    $const234$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $kw235$HL_SUPPORT = makeKeyword( "HL-SUPPORT" );
    $kw236$NONE = makeKeyword( "NONE" );
    $str237$___ = makeString( "[?]" );
    $list238 = ConsesLow.list( constant_handles.reader_make_constant_shell( makeString( "Thing" ) ) );
    $kw239$CLOSE_RED = makeKeyword( "CLOSE-RED" );
    $str240$red_x_close_15_gif = makeString( "red-x-close-15.gif" );
    $kw241$CLOSE_RED_DIM = makeKeyword( "CLOSE-RED-DIM" );
    $str242$dim_red_x_close_15_gif = makeString( "dim-red-x-close-15.gif" );
    $str243$gaf_entry = makeString( "gaf_entry" );
    $str244$___ = makeString( "[+]" );
    $str245$___ = makeString( "[-]" );
    $str246$Open_the_CURE_on_ = makeString( "Open the CURE on " );
    $str247$_to_add_more_facts_ = makeString( " to add more facts." );
    $str248$___ = makeString( " : " );
    $str249$__ = makeString( " ." );
    $list250 = ConsesLow.list( makeSymbol( "&KEY" ), ConsesLow.list( makeSymbol( "NAME" ), makeString( "gaf_entry" ) ), makeSymbol( "PRED" ), makeSymbol( "ARGNUM" ) );
    $list251 = ConsesLow.list( makeKeyword( "NAME" ), makeKeyword( "PRED" ), makeKeyword( "ARGNUM" ) );
    $kw252$ALLOW_OTHER_KEYS = makeKeyword( "ALLOW-OTHER-KEYS" );
    $kw253$NAME = makeKeyword( "NAME" );
    $kw254$PRED = makeKeyword( "PRED" );
    $kw255$ARGNUM = makeKeyword( "ARGNUM" );
    $int256$200 = makeInteger( 200 );
    $kw257$PARAGRAPH = makeKeyword( "PARAGRAPH" );
    $str258$unary_frame = makeString( "unary_frame" );
    $str259$cb_handle_gaf_entry = makeString( "cb-handle-gaf-entry" );
    $str260$implicit_arg1 = makeString( "implicit_arg1" );
    $str261$unary_frame_pred = makeString( "unary_frame_pred" );
    $str262$unary_predicate = makeString( "unary predicate" );
    $const263$UnaryPredicate = constant_handles.reader_make_constant_shell( makeString( "UnaryPredicate" ) );
    $str264$binary_frame = makeString( "binary_frame" );
    $str265$_arg2 = makeString( "+arg2" );
    $kw266$BOTTOM = makeKeyword( "BOTTOM" );
    $str267$Assert = makeString( "Assert" );
    $kw268$INPUT_NAME = makeKeyword( "INPUT-NAME" );
    $kw269$COMPLETE_TYPE = makeKeyword( "COMPLETE-TYPE" );
    $kw270$CLEAR_LABEL = makeKeyword( "CLEAR-LABEL" );
    $kw271$COMPLETE_LABEL = makeKeyword( "COMPLETE-LABEL" );
    $kw272$WIDTH = makeKeyword( "WIDTH" );
    $str273$binary_frame_pred = makeString( "binary_frame_pred" );
    $str274$binary_predicate = makeString( "binary predicate" );
    $const275$BinaryPredicate = constant_handles.reader_make_constant_shell( makeString( "BinaryPredicate" ) );
    $str276$binary = makeString( "binary" );
    $str277$_arg1 = makeString( "+arg1" );
    $str278$binary_frame_arg2 = makeString( "binary_frame_arg2" );
    $str279$arg2 = makeString( "arg2" );
    $const280$Thing = constant_handles.reader_make_constant_shell( makeString( "Thing" ) );
    $str281$ternary = makeString( "ternary" );
    $str282$_arg3 = makeString( "+arg3" );
    $str283$binary_pred = makeString( "binary_pred" );
    $str284$binary_arg1 = makeString( "binary_arg1" );
    $str285$arg1 = makeString( "arg1" );
    $str286$binary_arg2 = makeString( "binary_arg2" );
    $str287$ternary_pred = makeString( "ternary_pred" );
    $str288$ternary_predicate = makeString( "ternary predicate" );
    $const289$TernaryPredicate = constant_handles.reader_make_constant_shell( makeString( "TernaryPredicate" ) );
    $str290$ternary_arg1 = makeString( "ternary_arg1" );
    $str291$ternary_arg2 = makeString( "ternary_arg2" );
    $str292$ternary_arg3 = makeString( "ternary_arg3" );
    $str293$arg3 = makeString( "arg3" );
    $str294$_arg4 = makeString( "+arg4" );
    $kw295$DEFAULT = makeKeyword( "DEFAULT" );
    $sym296$CB_HANDLE_GAF_ENTRY = makeSymbol( "CB-HANDLE-GAF-ENTRY" );
    $str297$_did_not_specify_a_term = makeString( " did not specify a term" );
    $str298$Unexpected_sentence_entry_method = makeString( "Unexpected sentence entry method" );
    $str299$_A = makeString( "~A" );
    $str300$dim_ = makeString( "dim_" );
    $int301$10000 = makeInteger( 10000 );
    $str302$setVisibility__ = makeString( "setVisibility('" );
    $str303$___inline___setVisibility__ = makeString( "','inline');setVisibility('" );
    $str304$___none___ = makeString( "','none');" );
  }
}
/*
 * 
