...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class search extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol SEARCH_STRUC = makeSymbol("SEARCH-STRUC");

    public static final SubLSymbol SEARCH_STRUC_P = makeSymbol("SEARCH-STRUC-P");
    ...
    public static final SubLSymbol PRINT_SEARCH = makeSymbol("PRINT-SEARCH");

    public static final SubLSymbol SEARCH_STRUC_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("SEARCH-STRUC-PRINT-FUNCTION-TRAMPOLINE");
    ...
    public static final SubLList $list121 = list(ZERO_INTEGER);
    ...
    private static final SubLList $list154 = list(makeKeyword("TIME"));
    ...
    public static SubLObject search_struc_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$search_struc_native.class ? T : NIL;
    }

    public static SubLObject search_tree(final SubLObject v_object) {
        assert NIL != search_struc_p(v_object) : "search.search_struc_p error :" + v_object;
    ...
    public static SubLObject search_node_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$search_node_native.class ? T : NIL;
    }

    public static SubLObject snode_search(final SubLObject v_object) {
        assert NIL != search_node_p(v_object) : "search.search_node_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject doomed_search_nodeP(final SubLObject node) {
        assert NIL != search_node_p(node) : "search.search_node_p(node) " + "CommonSymbols.NIL != search.search_node_p(node) " + node;
    ...
    public static SubLObject search_size(final SubLObject v_search) {
        assert NIL != search_struc_p(v_search) : "search.search_struc_p(v_search) " + "CommonSymbols.NIL != search.search_struc_p(v_search) " + v_search;
    ...
    public static SubLObject declare_search_file() {
        declareFunction(me, "search_struc_print_function_trampoline", "SEARCH-STRUC-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "search_struc_p", "SEARCH-STRUC-P", 1, 0, false);
        new search.$search_struc_p$UnaryFunction();
        declareFunction(me, "search_tree", "SEARCH-TREE", 1, 0, false);
        declareFunction(me, "search_leaves", "SEARCH-LEAVES", 1, 0, false);
        declareFunction(me, "search_goals", "SEARCH-GOALS", 1, 0, false);
        declareFunction(me, "search_no_leaves_p_func", "SEARCH-NO-LEAVES-P-FUNC", 1, 0, false);
        declareFunction(me, "search_next_node_func", "SEARCH-NEXT-NODE-FUNC", 1, 0, false);
        declareFunction(me, "search_goal_p_func", "SEARCH-GOAL-P-FUNC", 1, 0, false);
        declareFunction(me, "search_add_goal_func", "SEARCH-ADD-GOAL-FUNC", 1, 0, false);
        declareFunction(me, "search_options_func", "SEARCH-OPTIONS-FUNC", 1, 0, false);
        declareFunction(me, "search_expand_func", "SEARCH-EXPAND-FUNC", 1, 0, false);
        declareFunction(me, "search_add_node_func", "SEARCH-ADD-NODE-FUNC", 1, 0, false);
        declareFunction(me, "search_too_deep_func", "SEARCH-TOO-DEEP-FUNC", 1, 0, false);
        declareFunction(me, "search_state", "SEARCH-STATE", 1, 0, false);
        declareFunction(me, "search_print_func", "SEARCH-PRINT-FUNC", 1, 0, false);
        declareFunction(me, "search_limbo", "SEARCH-LIMBO", 1, 0, false);
        declareFunction(me, "search_current_node", "SEARCH-CURRENT-NODE", 1, 0, false);
        declareFunction(me, "_csetf_search_tree", "_CSETF-SEARCH-TREE", 2, 0, false);
        declareFunction(me, "_csetf_search_leaves", "_CSETF-SEARCH-LEAVES", 2, 0, false);
        declareFunction(me, "_csetf_search_goals", "_CSETF-SEARCH-GOALS", 2, 0, false);
        declareFunction(me, "_csetf_search_no_leaves_p_func", "_CSETF-SEARCH-NO-LEAVES-P-FUNC", 2, 0, false);
        declareFunction(me, "_csetf_search_next_node_func", "_CSETF-SEARCH-NEXT-NODE-FUNC", 2, 0, false);
        declareFunction(me, "_csetf_search_goal_p_func", "_CSETF-SEARCH-GOAL-P-FUNC", 2, 0, false);
        declareFunction(me, "_csetf_search_add_goal_func", "_CSETF-SEARCH-ADD-GOAL-FUNC", 2, 0, false);
        declareFunction(me, "_csetf_search_options_func", "_CSETF-SEARCH-OPTIONS-FUNC", 2, 0, false);
        declareFunction(me, "_csetf_search_expand_func", "_CSETF-SEARCH-EXPAND-FUNC", 2, 0, false);
        declareFunction(me, "_csetf_search_add_node_func", "_CSETF-SEARCH-ADD-NODE-FUNC", 2, 0, false);
        declareFunction(me, "_csetf_search_too_deep_func", "_CSETF-SEARCH-TOO-DEEP-FUNC", 2, 0, false);
        declareFunction(me, "_csetf_search_state", "_CSETF-SEARCH-STATE", 2, 0, false);
        declareFunction(me, "_csetf_search_print_func", "_CSETF-SEARCH-PRINT-FUNC", 2, 0, false);
        declareFunction(me, "_csetf_search_limbo", "_CSETF-SEARCH-LIMBO", 2, 0, false);
        declareFunction(me, "_csetf_search_current_node", "_CSETF-SEARCH-CURRENT-NODE", 2, 0, false);
        declareFunction(me, "make_search_struc", "MAKE-SEARCH-STRUC", 0, 1, false);
        declareFunction(me, "visit_defstruct_search_struc", "VISIT-DEFSTRUCT-SEARCH-STRUC", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_search_struc_method", "VISIT-DEFSTRUCT-OBJECT-SEARCH-STRUC-METHOD", 2, 0, false);
        declareFunction(me, "print_search", "PRINT-SEARCH", 3, 0, false);
        declareFunction(me, "make_static_search_struc", "MAKE-STATIC-SEARCH-STRUC", 0, 0, false);
        declareFunction(me, "init_search_struc", "INIT-SEARCH-STRUC", 1, 0, false);
        declareFunction(me, "free_search_struc_p", "FREE-SEARCH-STRUC-P", 1, 0, false);
        declareFunction(me, "free_search_struc", "FREE-SEARCH-STRUC", 1, 0, false);
        declareFunction(me, "get_search_struc", "GET-SEARCH-STRUC", 0, 0, false);
        declareFunction(me, "new_search", "NEW-SEARCH", 8, 2, false);
        declareFunction(me, "search_node_print_function_trampoline", "SEARCH-NODE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "search_node_p", "SEARCH-NODE-P", 1, 0, false);
        new search.$search_node_p$UnaryFunction();
        declareFunction(me, "snode_search", "SNODE-SEARCH", 1, 0, false);
        declareFunction(me, "snode_parent", "SNODE-PARENT", 1, 0, false);
        declareFunction(me, "snode_children", "SNODE-CHILDREN", 1, 0, false);
        declareFunction(me, "snode_depth", "SNODE-DEPTH", 1, 0, false);
        declareFunction(me, "snode_options", "SNODE-OPTIONS", 1, 0, false);
        declareFunction(me, "snode_state", "SNODE-STATE", 1, 0, false);
        declareFunction(me, "_csetf_snode_search", "_CSETF-SNODE-SEARCH", 2, 0, false);
        declareFunction(me, "_csetf_snode_parent", "_CSETF-SNODE-PARENT", 2, 0, false);
        declareFunction(me, "_csetf_snode_children", "_CSETF-SNODE-CHILDREN", 2, 0, false);
        declareFunction(me, "_csetf_snode_depth", "_CSETF-SNODE-DEPTH", 2, 0, false);
        declareFunction(me, "_csetf_snode_options", "_CSETF-SNODE-OPTIONS", 2, 0, false);
        declareFunction(me, "_csetf_snode_state", "_CSETF-SNODE-STATE", 2, 0, false);
        declareFunction(me, "make_search_node", "MAKE-SEARCH-NODE", 0, 1, false);
        declareFunction(me, "visit_defstruct_search_node", "VISIT-DEFSTRUCT-SEARCH-NODE", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_search_node_method", "VISIT-DEFSTRUCT-OBJECT-SEARCH-NODE-METHOD", 2, 0, false);
        declareFunction(me, "print_snode", "PRINT-SNODE", 3, 0, false);
        declareFunction(me, "make_static_search_node", "MAKE-STATIC-SEARCH-NODE", 0, 0, false);
        declareFunction(me, "init_search_node", "INIT-SEARCH-NODE", 1, 0, false);
        declareFunction(me, "free_search_node_p", "FREE-SEARCH-NODE-P", 1, 0, false);
        declareFunction(me, "free_search_node", "FREE-SEARCH-NODE", 1, 0, false);
        declareFunction(me, "get_search_node", "GET-SEARCH-NODE", 0, 0, false);
        declareFunction(me, "free_entire_search_node", "FREE-ENTIRE-SEARCH-NODE", 1, 1, false);
        declareFunction(me, "dead_end_nodeP", "DEAD-END-NODE?", 1, 0, false);
        declareFunction(me, "reclaim_search_node", "RECLAIM-SEARCH-NODE", 1, 0, false);
        declareFunction(me, "interrupt_generic_search", "INTERRUPT-GENERIC-SEARCH", 0, 0, false);
        declareFunction(me, "abort_generic_search", "ABORT-GENERIC-SEARCH", 0, 0, false);
        declareMacro(me, "do_generic_search", "DO-GENERIC-SEARCH");
        declareFunction(me, "generic_search", "GENERIC-SEARCH", 1, 3, false);
        declareFunction(me, "generic_search_reclaim_node", "GENERIC-SEARCH-RECLAIM-NODE", 1, 0, false);
        declareFunction(me, "generic_search_link_child_to_parent", "GENERIC-SEARCH-LINK-CHILD-TO-PARENT", 2, 0, false);
        declareFunction(me, "reset_search_node_state", "RESET-SEARCH-NODE-STATE", 2, 0, false);
        declareFunction(me, "new_search_node", "NEW-SEARCH-NODE", 1, 0, false);
        declareFunction(me, "new_search_start_node", "NEW-SEARCH-START-NODE", 1, 0, false);
        declareFunction(me, "register_search_start_node", "REGISTER-SEARCH-START-NODE", 2, 0, false);
        declareFunction(me, "add_search_start_node", "ADD-SEARCH-START-NODE", 2, 0, false);
        declareFunction(me, "remove_search_start_node", "REMOVE-SEARCH-START-NODE", 2, 0, false);
        declareFunction(me, "reconsider_limbo", "RECONSIDER-LIMBO", 2, 0, false);
        declareFunction(me, "valid_snode_options", "VALID-SNODE-OPTIONS", 1, 0, false);
        declareFunction(me, "set_valid_snode_options", "SET-VALID-SNODE-OPTIONS", 2, 0, false);
        declareFunction(me, "doomed_search_nodeP", "DOOMED-SEARCH-NODE?", 1, 0, false);
        declareFunction(me, "mark_node_as_doomed", "MARK-NODE-AS-DOOMED", 1, 0, false);
        declareFunction(me, "search_current_path", "SEARCH-CURRENT-PATH", 1, 0, false);
        declareFunction(me, "search_current_path_internal", "SEARCH-CURRENT-PATH-INTERNAL", 1, 0, false);
        declareFunction(me, "remaining_time_cutoff", "REMAINING-TIME-CUTOFF", 2, 0, false);
        declareFunction(me, "search_size", "SEARCH-SIZE", 1, 0, false);
        declareFunction(me, "search_node_size", "SEARCH-NODE-SIZE", 1, 0, false);
        return NIL;
    }
    ...
    public static final class $search_struc_native extends SubLStructNative {
        ...
        private $search_struc_native() {
            this.$tree = Lisp.NIL;
            this.$leaves = Lisp.NIL;
            this.$goals = Lisp.NIL;
            this.$no_leaves_p_func = Lisp.NIL;
            this.$next_node_func = Lisp.NIL;
            this.$goal_p_func = Lisp.NIL;
            this.$add_goal_func = Lisp.NIL;
            this.$options_func = Lisp.NIL;
            this.$expand_func = Lisp.NIL;
            this.$add_node_func = Lisp.NIL;
            this.$too_deep_func = Lisp.NIL;
            this.$state = Lisp.NIL;
            this.$print_func = Lisp.NIL;
            this.$limbo = Lisp.NIL;
            this.$current_node = Lisp.NIL;
        }
        ...
        static {
            structDecl = makeStructDeclNative($search_struc_native.class, SEARCH_STRUC, SEARCH_STRUC_P, $list2, $list3, new String[]{ "$tree", "$leaves", "$goals", "$no_leaves_p_func", "$next_node_func", "$goal_p_func", "$add_goal_func", "$options_func", "$expand_func", "$add_node_func", "$too_deep_func", "$state", "$print_func", "$limbo", "$current_node" }, $list4, $list5, PRINT_SEARCH);
        }
    }
    ...
    public static final class $search_node_native extends SubLStructNative {
        ...
        private $search_node_native() {
            this.$search = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative($search_node_native.class, SEARCH_NODE, SEARCH_NODE_P, $list65, $list66, new String[]{ "$search", "$parent", "$children", "$depth", "$options", "$state" }, $list67, $list68, PRINT_SNODE);
        }
    }
