...
import static com.cyc.cycjava.cycl.search.*;
...
public final class search extends SubLTranslatedFile {
    ...
    public static SubLObject search_struc_p(final SubLObject v_object) {
        return v_object.getClass() == search.$search_struc_native.class ? T : NIL;
    }

    public static SubLObject search_tree(final SubLObject v_object) {
        assert NIL != search_struc_p(v_object) : "search.search_struc_p(v_object) " + "CommonSymbols.NIL != search.search_struc_p(v_object) " + v_object;
    ...
    public static SubLObject make_search_struc(SubLObject arglist) {
        ...
        final SubLObject v_new = new search.$search_struc_native();
        SubLObject next;
    ...
    public static SubLObject search_node_p(final SubLObject v_object) {
        return v_object.getClass() == search.$search_node_native.class ? T : NIL;
    }

    public static SubLObject snode_search(final SubLObject v_object) {
        assert NIL != search_node_p(v_object) : "search.search_node_p(v_object) " + "CommonSymbols.NIL != search.search_node_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_search_node(SubLObject arglist) {
        ...
        final SubLObject v_new = new search.$search_node_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $search_node_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(search.$search_node_native.class, SEARCH_NODE, SEARCH_NODE_P, $list65, $list66, new String[]{ "$search", "$parent", "$children", "$depth", "$options", "$state" }, $list67, $list68, PRINT_SNODE);
        }
    }
