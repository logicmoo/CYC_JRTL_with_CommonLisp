...
public final class subcyclifier extends SubLTranslatedFile {
    ...
    public static SubLObject cyclifier_pool_p(final SubLObject v_object) {
        return v_object.getClass() == subcyclifier.$cyclifier_pool_native.class ? T : NIL;
    }

    public static SubLObject cyclifier_pool_cyclifiers(final SubLObject v_object) {
        assert NIL != cyclifier_pool_p(v_object) : "subcyclifier.cyclifier_pool_p(v_object) " + "CommonSymbols.NIL != subcyclifier.cyclifier_pool_p(v_object) " + v_object;
    ...
    public static SubLObject make_cyclifier_pool(SubLObject arglist) {
        ...
        final SubLObject v_new = new subcyclifier.$cyclifier_pool_native();
        SubLObject next;
    ...
    public static final class $cyclifier_pool_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subcyclifier.$cyclifier_pool_native.class, CYCLIFIER_POOL, CYCLIFIER_POOL_P, $list27, $list28, new String[]{ "$cyclifiers" }, $list29, $list30, CYCLIFIER_POOL_PRINT);
        }
    }
