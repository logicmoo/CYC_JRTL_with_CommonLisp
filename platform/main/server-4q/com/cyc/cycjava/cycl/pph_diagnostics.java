...
public final class pph_diagnostics extends SubLTranslatedFile implements V02 {
    ...
    public static final String myName = "com.cyc.cycjava.cycl.pph_diagnostics";
                        ...
                        if (NIL != time_string) {
                            {
                                ...
                                SubLObject elapsed_seconds = add(new SubLObject[]{ seconds, multiply(minutes, numeric_date_utilities.$seconds_in_a_minute$.getGlobalValue()), NIL != days ? ((SubLObject) (multiply(days, numeric_date_utilities.$seconds_in_a_day$.getGlobalValue()))) : ZERO_INTEGER, NIL != hours ? ((SubLObject) (multiply(hours, numeric_date_utilities.$seconds_in_an_hour$.getGlobalValue()))) : ZERO_INTEGER });
                ...
                SubLObject mt_var = mt_relevance_macros.with_inference_mt_relevance_validate(pph_vars.$pph_language_mt$.getDynamicValue(thread));
                {
                    ...
                    try {
                        ...
                        mt_relevance_macros.$relevant_mts$.bind(mt_relevance_macros.update_inference_mt_relevance_mt_list(mt_var), thread);
                        {
                            ...
                            SubLObject reln = NIL;
                            for (i = ZERO_INTEGER, relns = kb_mapping_utilities.pred_refs(genpred, UNPROVIDED, UNPROVIDED), reln = nth(random.random(length(relns)), relns); !i.numE(sample_relns); i = number_utilities.f_1X(i) , relns = relns , reln = nth(random.random(length(relns)), relns)) {
                                if (NIL != reln) {
    ...
    public static final SubLObject initialize_pph_benchmark_thcl_gafs_from_kb() {
        {
            ...
            if (NIL == tuples) {
                ...
                if (NIL != list_utilities.duplicatesP(tuples, symbol_function(EQL), symbol_function(SECOND))) {
                    ...
                    if (NIL != list_utilities.find_if_not(ASSERTION_P, tuples, symbol_function(FIRST), UNPROVIDED, UNPROVIDED)) {
    ...
    static private final SubLList $list_alt85 = list(constant_handles.reader_make_constant_shell(makeString("UnitOfMeasure")), constant_handles.reader_make_constant_shell(makeString("SkolemFunction")), constant_handles.reader_make_constant_shell(makeString("LFAttribute-Function")), constant_handles.reader_make_constant_shell(makeString("KSTerm")), constant_handles.reader_make_constant_shell(makeString("NLPredicate")));

    static private final SubLList $list_alt86 = list(constant_handles.reader_make_constant_shell(makeString("ThesaurusConstant")), constant_handles.reader_make_constant_shell(makeString("CycLReformulatorConstant")), constant_handles.reader_make_constant_shell(makeString("ProprietaryConstant")), constant_handles.reader_make_constant_shell(makeString("TestingConstant")), constant_handles.reader_make_constant_shell(makeString("CycLReformulatorConstant")), constant_handles.reader_make_constant_shell(makeString("TestingConstant")));
