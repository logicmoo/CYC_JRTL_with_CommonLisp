...
import com.cyc.cycjava.cycl.cb_formula_templates;
...
import static com.cyc.cycjava.cycl.cb_formula_templates.*;
...
public final class cb_formula_templates extends SubLTranslatedFile {
    ...
    public static SubLObject formula_template_editing_state_p(final SubLObject v_object) {
        return v_object.getClass() == cb_formula_templates.$formula_template_editing_state_native.class ? T : NIL;
    }

    public static SubLObject formula_template_editing_state_phase(final SubLObject v_object) {
        assert NIL != formula_template_editing_state_p(v_object) : "cb_formula_templates.formula_template_editing_state_p(v_object) " + "CommonSymbols.NIL != cb_formula_templates.formula_template_editing_state_p(v_object) " + v_object;
    ...
    public static SubLObject make_formula_template_editing_state(SubLObject arglist) {
        ...
        final SubLObject v_new = new cb_formula_templates.$formula_template_editing_state_native();
        SubLObject next;
