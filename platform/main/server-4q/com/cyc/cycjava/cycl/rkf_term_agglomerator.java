...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class rkf_term_agglomerator extends SubLTranslatedFile {
    ...
    public static SubLObject agglomeration_state_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$agglomeration_state_native.class ? T : NIL;
    }

    public static SubLObject agglomeration_state_uncovered_terms(final SubLObject v_object) {
        assert NIL != agglomeration_state_p(v_object) : "rkf_term_agglomerator.agglomeration_state_p error :" + v_object;
    ...
    public static final class $agglomeration_state_native extends SubLStructNative {
        ...
        private $agglomeration_state_native() {
        ...
        static {
            structDecl = makeStructDeclNative($agglomeration_state_native.class, AGGLOMERATION_STATE, AGGLOMERATION_STATE_P, $list15, $list16, new String[]{ "$uncovered_terms", "$agglomerations_available", "$agglomerations_used" }, $list17, $list18, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
