...
import static com.cyc.cycjava.cycl.cb_form_widgets.*;
...
public final class cb_form_widgets extends SubLTranslatedFile {
    ...
    private static final SubLList $list197 = list(list(list(list(reader_make_constant_shell(makeString("nameString")), reader_make_constant_shell(makeString("CityOfBeijingChina")), makeString("&#21271;&#20140;&#24066;"))), list(reader_make_constant_shell(makeString("nameString")), reader_make_constant_shell(makeString("CityOfBeijingChina")), list(reader_make_constant_shell(makeString("UnicodeStringFn")), makeString("&u5317;&u4EAC;&u5E02;")))), list(list(list(reader_make_constant_shell(makeString("nameString")), reader_make_constant_shell(makeString("CityOfBeijingChina")), list(reader_make_constant_shell(makeString("UnicodeStringFn")), makeString("&u5317;&u4eac;&u5e02;")))), list(reader_make_constant_shell(makeString("nameString")), reader_make_constant_shell(makeString("CityOfBeijingChina")), list(reader_make_constant_shell(makeString("UnicodeStringFn")), makeString("&u5317;&u4EAC;&u5E02;")))), list(list(list(reader_make_constant_shell(makeString("nameString")), reader_make_constant_shell(makeString("Thing")), makeString("The Big Thing"))), list(reader_make_constant_shell(makeString("nameString")), reader_make_constant_shell(makeString("Thing")), makeString("The Big Thing"))), list(list(list(reader_make_constant_shell(makeString("nameString")), reader_make_constant_shell(makeString("Thing")), list(reader_make_constant_shell(makeString("UnicodeStringFn")), makeString("The Big Thing")))), list(reader_make_constant_shell(makeString("nameString")), reader_make_constant_shell(makeString("Thing")), makeString("The Big Thing"))), list(list(list(reader_make_constant_shell(makeString("mathRenderAs")), reader_make_constant_shell(makeString("InfixTimesFn")), list(reader_make_constant_shell(makeString("UnicodeStringFn")), makeString("&u2260;")))), list(reader_make_constant_shell(makeString("mathRenderAs")), reader_make_constant_shell(makeString("InfixTimesFn")), list(reader_make_constant_shell(makeString("UnicodeStringFn")), makeString("&u2260;")))), list(list(list(reader_make_constant_shell(makeString("mathRenderAs")), reader_make_constant_shell(makeString("InfixTimesFn")), makeString("&ne;"))), list(reader_make_constant_shell(makeString("mathRenderAs")), reader_make_constant_shell(makeString("InfixTimesFn")), list(reader_make_constant_shell(makeString("UnicodeStringFn")), makeString("&u2260;")))), list(list(list(reader_make_constant_shell(makeString("UnicodeStringFn")), makeString("&u2260;"))), list(reader_make_constant_shell(makeString("UnicodeStringFn")), makeString("&u2260;"))));
