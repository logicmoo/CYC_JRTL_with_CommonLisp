...
import static com.cyc.cycjava.cycl.assertions_low.*;
...
public final class assertions_low extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol ASSERTION_CONTENT = makeSymbol("ASSERTION-CONTENT");

    public static final SubLSymbol ASSERTION_CONTENT_P = makeSymbol("ASSERTION-CONTENT-P");



    private static final SubLInteger $int$148 = makeInteger(148);

    public static final SubLSymbol ASSERTION_CONTENT_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("ASSERTION-CONTENT-PRINT-FUNCTION-TRAMPOLINE");
    ...
    private static final SubLSymbol $sym40$_PREFER_RULE_SET_OVER_FLAGS__ = makeSymbol("*PREFER-RULE-SET-OVER-FLAGS?*");
    ...
    private static final SubLSymbol $sym49$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__ = makeSymbol("*APPEND-STACK-TRACES-TO-ERROR-MESSAGES?*");
    ...
    private static final SubLSymbol $sym55$_PREFER_NON_TRUE_SET_OVER_FLAGS__ = makeSymbol("*PREFER-NON-TRUE-SET-OVER-FLAGS?*");
    ...
    public static SubLObject as_content_formula_data(final SubLObject v_object) {
        assert NIL != assertion_content_p(v_object) : "assertions_low.assertion_content_p(v_object) " + "CommonSymbols.NIL != assertions_low.assertion_content_p(v_object) " + v_object;
    ...
    public static SubLObject setup_rule_set(final SubLObject estimated_assertion_size) {
        assert NIL != subl_promotions.non_negative_integer_p(estimated_assertion_size) : "subl_promotions.non_negative_integer_p(estimated_assertion_size) " + "CommonSymbols.NIL != subl_promotions.non_negative_integer_p(estimated_assertion_size) " + estimated_assertion_size;
    ...
    public static SubLObject dump_rule_set_to_stream(final SubLObject stream) {
        ...
        assert NIL != keyhash.keyhash_p(rule_set) : "keyhash.keyhash_p(rule_set) " + "CommonSymbols.NIL != keyhash.keyhash_p(rule_set) " + rule_set;
                    ...
                    if (NIL == id_index_dense_objects_empty_p(idx_$6, $SKIP)) {
                        ...
                        for (length = length(vector_var), v_iteration = NIL, v_iteration = ZERO_INTEGER; v_iteration.numL(length); v_iteration = add(v_iteration, ONE_INTEGER)) {
                            ...
                            if ((NIL == id_index_tombstone_p(a_handle)) || (NIL == id_index_skip_tombstones_p($SKIP))) {
                                ...
                                message_var = NIL;
                                was_appendingP = eval($sym49$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__);
                                eval($list50);
                                try {
                                    try {
                                    ...
                                    try {
                                        ...
                                        eval(list(CSETQ, $sym49$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__, was_appendingP));
                                        restoreValuesFromVector(_values);
                                    } finally {
                    ...
                    if ((NIL == id_index_sparse_objects_empty_p(idx_$7)) || (NIL == id_index_skip_tombstones_p($SKIP))) {
                        ...
                        while (a_id2.numL(end_id)) {
                            ...
                            if ((NIL == id_index_skip_tombstones_p($SKIP)) || (NIL == id_index_tombstone_p(a_handle2))) {
                                ...
                                final SubLObject was_appendingP2 = eval($sym49$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__);
                                eval($list50);
                                try {
                                    try {
                                        thread.throwStack.push($catch_error_message_target$.getGlobalValue());
                                    ...
                                    try {
                                        ...
                                        eval(list(CSETQ, $sym49$_APPEND_STACK_TRACES_TO_ERROR_MESSAGES__, was_appendingP2));
    ...
    public static SubLObject reset_assertion_variable_names(final SubLObject assertion, final SubLObject new_variable_names) {
        assert NIL != assertion_handles.assertion_p(assertion) : "assertion_handles.assertion_p(assertion) " + "CommonSymbols.NIL != assertion_handles.assertion_p(assertion) " + assertion;
        assert NIL != list_utilities.non_dotted_list_p(new_variable_names) : "list_utilities.non_dotted_list_p(new_variable_names) " + "CommonSymbols.NIL != list_utilities.non_dotted_list_p(new_variable_names) " + new_variable_names;
    ...
    public static SubLObject reset_assertion_dependents(final SubLObject assertion, final SubLObject new_dependents) {
        assert NIL != set_contents.set_contents_p(new_dependents) : "set_contents.set_contents_p(new_dependents) " + "CommonSymbols.NIL != set_contents.set_contents_p(new_dependents) " + new_dependents;
    ...
    public static SubLObject declare_assertions_low_file() {
        declareFunction(me, "assertion_content_print_function_trampoline", "ASSERTION-CONTENT-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "assertion_content_p", "ASSERTION-CONTENT-P", 1, 0, false);
        new assertions_low.$assertion_content_p$UnaryFunction();
        declareFunction(me, "as_content_formula_data", "AS-CONTENT-FORMULA-DATA", 1, 0, false);
        declareFunction(me, "as_content_mt", "AS-CONTENT-MT", 1, 0, false);
        declareFunction(me, "as_content_flags", "AS-CONTENT-FLAGS", 1, 0, false);
        declareFunction(me, "as_content_arguments", "AS-CONTENT-ARGUMENTS", 1, 0, false);
        declareFunction(me, "as_content_plist", "AS-CONTENT-PLIST", 1, 0, false);
        declareFunction(me, "_csetf_as_content_formula_data", "_CSETF-AS-CONTENT-FORMULA-DATA", 2, 0, false);
        declareFunction(me, "_csetf_as_content_mt", "_CSETF-AS-CONTENT-MT", 2, 0, false);
        declareFunction(me, "_csetf_as_content_flags", "_CSETF-AS-CONTENT-FLAGS", 2, 0, false);
        declareFunction(me, "_csetf_as_content_arguments", "_CSETF-AS-CONTENT-ARGUMENTS", 2, 0, false);
        declareFunction(me, "_csetf_as_content_plist", "_CSETF-AS-CONTENT-PLIST", 2, 0, false);
        declareFunction(me, "make_assertion_content", "MAKE-ASSERTION-CONTENT", 0, 1, false);
        declareFunction(me, "visit_defstruct_assertion_content", "VISIT-DEFSTRUCT-ASSERTION-CONTENT", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_assertion_content_method", "VISIT-DEFSTRUCT-OBJECT-ASSERTION-CONTENT-METHOD", 2, 0, false);
        declareFunction(me, "create_assertion_content", "CREATE-ASSERTION-CONTENT", 1, 0, false);
        declareFunction(me, "destroy_assertion_content", "DESTROY-ASSERTION-CONTENT", 1, 0, false);
        declareFunction(me, "lookup_assertion_formula_data", "LOOKUP-ASSERTION-FORMULA-DATA", 1, 0, false);
        declareFunction(me, "lookup_assertion_mt", "LOOKUP-ASSERTION-MT", 1, 0, false);
        declareFunction(me, "lookup_assertion_flags", "LOOKUP-ASSERTION-FLAGS", 1, 0, false);
        declareFunction(me, "lookup_assertion_arguments", "LOOKUP-ASSERTION-ARGUMENTS", 1, 0, false);
        declareFunction(me, "lookup_assertion_plist", "LOOKUP-ASSERTION-PLIST", 1, 0, false);
        declareFunction(me, "set_assertion_formula_data", "SET-ASSERTION-FORMULA-DATA", 2, 0, false);
        declareFunction(me, "set_assertion_flags", "SET-ASSERTION-FLAGS", 2, 0, false);
        declareFunction(me, "set_assertion_arguments", "SET-ASSERTION-ARGUMENTS", 2, 0, false);
        declareFunction(me, "set_assertion_plist", "SET-ASSERTION-PLIST", 2, 0, false);
        declareFunction(me, "dump_assertion_content", "DUMP-ASSERTION-CONTENT", 2, 0, false);
        declareFunction(me, "assertion_plist_for_dumping", "ASSERTION-PLIST-FOR-DUMPING", 1, 0, false);
        declareFunction(me, "load_assertion_content", "LOAD-ASSERTION-CONTENT", 2, 0, false);
        declareFunction(me, "load_assertion_content_int", "LOAD-ASSERTION-CONTENT-INT", 6, 0, false);
        declareFunction(me, "assertion_cnf_internal", "ASSERTION-CNF-INTERNAL", 1, 0, false);
        declareFunction(me, "possibly_assertion_cnf_internal", "POSSIBLY-ASSERTION-CNF-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_mt_internal", "ASSERTION-MT-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_gaf_hl_formula_internal", "ASSERTION-GAF-HL-FORMULA-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_cons_internal", "ASSERTION-CONS-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_direction_internal", "ASSERTION-DIRECTION-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_truth_internal", "ASSERTION-TRUTH-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_strength_internal", "ASSERTION-STRENGTH-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_tv", "ASSERTION-TV", 1, 0, false);
        declareFunction(me, "assertion_tv_internal", "ASSERTION-TV-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_variable_names_internal", "ASSERTION-VARIABLE-NAMES-INTERNAL", 1, 0, false);
        declareFunction(me, "asserted_by_internal", "ASSERTED-BY-INTERNAL", 1, 0, false);
        declareFunction(me, "asserted_when_internal", "ASSERTED-WHEN-INTERNAL", 1, 0, false);
        declareFunction(me, "asserted_why_internal", "ASSERTED-WHY-INTERNAL", 1, 0, false);
        declareFunction(me, "asserted_second_internal", "ASSERTED-SECOND-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_arguments_internal", "ASSERTION-ARGUMENTS-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_dependents_internal", "ASSERTION-DEPENDENTS-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_dependent_count_internal", "ASSERTION-DEPENDENT-COUNT-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_has_dependents_p_internal", "ASSERTION-HAS-DEPENDENTS-P-INTERNAL", 1, 0, false);
        declareFunction(me, "assertion_formula_data", "ASSERTION-FORMULA-DATA", 1, 0, false);
        declareFunction(me, "reset_assertion_formula_data", "RESET-ASSERTION-FORMULA-DATA", 2, 0, false);
        declareFunction(me, "assertion_hl_cnf", "ASSERTION-HL-CNF", 1, 0, false);
        declareFunction(me, "update_assertion_formula_data", "UPDATE-ASSERTION-FORMULA-DATA", 2, 0, false);
        declareFunction(me, "assertion_clause_struc", "ASSERTION-CLAUSE-STRUC", 1, 0, false);
        declareFunction(me, "reset_assertion_cnf", "RESET-ASSERTION-CNF", 2, 0, false);
        declareFunction(me, "reset_assertion_clause_struc", "RESET-ASSERTION-CLAUSE-STRUC", 2, 0, false);
        declareFunction(me, "reset_assertion_gaf_formula", "RESET-ASSERTION-GAF-FORMULA", 2, 0, false);
        declareFunction(me, "annihilate_assertion_formula_data", "ANNIHILATE-ASSERTION-FORMULA-DATA", 1, 0, false);
        declareFunction(me, "assertion_flags", "ASSERTION-FLAGS", 1, 0, false);
        declareFunction(me, "reset_assertion_flags", "RESET-ASSERTION-FLAGS", 2, 0, false);
        declareFunction(me, "assertion_flags_gaf_code", "ASSERTION-FLAGS-GAF-CODE", 1, 0, false);
        declareFunction(me, "set_assertion_flags_gaf_code", "SET-ASSERTION-FLAGS-GAF-CODE", 2, 0, false);
        declareFunction(me, "assertion_flags_direction_code", "ASSERTION-FLAGS-DIRECTION-CODE", 1, 0, false);
        declareFunction(me, "set_assertion_flags_direction_code", "SET-ASSERTION-FLAGS-DIRECTION-CODE", 2, 0, false);
        declareFunction(me, "assertion_flags_tv_code", "ASSERTION-FLAGS-TV-CODE", 1, 0, false);
        declareFunction(me, "set_assertion_flags_tv_code", "SET-ASSERTION-FLAGS-TV-CODE", 2, 0, false);
        declareFunction(me, "assertion_flags_gaf_p", "ASSERTION-FLAGS-GAF-P", 1, 0, false);
        declareFunction(me, "set_assertion_flags_gaf_p", "SET-ASSERTION-FLAGS-GAF-P", 2, 0, false);
        declareFunction(me, "use_rule_setP", "USE-RULE-SET?", 0, 0, false);
        declareFunction(me, "setup_rule_set", "SETUP-RULE-SET", 1, 0, false);
        declareFunction(me, "kb_rule_set", "KB-RULE-SET", 0, 0, false);
        declareFunction(me, "assertion_gaf_p", "ASSERTION-GAF-P", 1, 0, false);
        declareFunction(me, "assertion_rule_p", "ASSERTION-RULE-P", 1, 0, false);
        declareFunction(me, "rule_count", "RULE-COUNT", 0, 0, false);
        declareFunction(me, "gaf_count", "GAF-COUNT", 0, 0, false);
        declareFunction(me, "set_assertion_gaf_p", "SET-ASSERTION-GAF-P", 2, 0, false);
        declareFunction(me, "possibly_rule_set_delete", "POSSIBLY-RULE-SET-DELETE", 1, 0, false);
        declareFunction(me, "recompute_assertion_gaf_p", "RECOMPUTE-ASSERTION-GAF-P", 1, 0, false);
        declareFunction(me, "determine_cnf_gaf_p", "DETERMINE-CNF-GAF-P", 1, 0, false);
        declareFunction(me, "dump_rule_set_to_stream", "DUMP-RULE-SET-TO-STREAM", 1, 0, false);
        declareFunction(me, "load_rule_set_from_stream", "LOAD-RULE-SET-FROM-STREAM", 1, 0, false);
        declareFunction(me, "rebuild_rule_set", "REBUILD-RULE-SET", 0, 0, false);
        declareFunction(me, "gaf_formula_to_cnf", "GAF-FORMULA-TO-CNF", 1, 0, false);
        declareFunction(me, "cnf_to_gaf_formula", "CNF-TO-GAF-FORMULA", 1, 0, false);
        declareFunction(me, "kb_set_assertion_direction_internal", "KB-SET-ASSERTION-DIRECTION-INTERNAL", 2, 0, false);
        declareFunction(me, "reset_assertion_direction", "RESET-ASSERTION-DIRECTION", 2, 0, false);
        declareFunction(me, "reset_assertion_tv", "RESET-ASSERTION-TV", 2, 0, false);
        declareFunction(me, "reset_assertion_truth", "RESET-ASSERTION-TRUTH", 2, 0, false);
        declareFunction(me, "reset_assertion_strength", "RESET-ASSERTION-STRENGTH", 2, 0, false);
        declareFunction(me, "use_non_true_assertion_tv_cacheP", "USE-NON-TRUE-ASSERTION-TV-CACHE?", 0, 0, false);
        declareFunction(me, "setup_non_true_assertion_tv_cache", "SETUP-NON-TRUE-ASSERTION-TV-CACHE", 1, 0, false);
        declareFunction(me, "kb_non_true_assertion_tv_cache", "KB-NON-TRUE-ASSERTION-TV-CACHE", 0, 0, false);
        declareFunction(me, "assertion_true_p", "ASSERTION-TRUE-P", 1, 0, false);
        declareFunction(me, "assertion_non_true_tv", "ASSERTION-NON-TRUE-TV", 1, 0, false);
        declareFunction(me, "non_true_assertion_count", "NON-TRUE-ASSERTION-COUNT", 0, 0, false);
        declareFunction(me, "true_assertion_count", "TRUE-ASSERTION-COUNT", 0, 0, false);
        declareFunction(me, "set_assertion_non_true_cache_tv", "SET-ASSERTION-NON-TRUE-CACHE-TV", 2, 0, false);
        declareFunction(me, "possibly_non_true_assertion_tv_cache_delete", "POSSIBLY-NON-TRUE-ASSERTION-TV-CACHE-DELETE", 1, 0, false);
        declareFunction(me, "dump_non_true_assertion_tv_cache_to_stream", "DUMP-NON-TRUE-ASSERTION-TV-CACHE-TO-STREAM", 1, 0, false);
        declareFunction(me, "load_non_true_assertion_tv_cache_from_stream", "LOAD-NON-TRUE-ASSERTION-TV-CACHE-FROM-STREAM", 1, 0, false);
        declareFunction(me, "rebuild_non_true_assertion_tv_cache", "REBUILD-NON-TRUE-ASSERTION-TV-CACHE", 0, 0, false);
        declareFunction(me, "assertion_plist", "ASSERTION-PLIST", 1, 0, false);
        declareFunction(me, "reset_assertion_plist", "RESET-ASSERTION-PLIST", 2, 0, false);
        declareFunction(me, "get_assertion_prop", "GET-ASSERTION-PROP", 2, 1, false);
        declareFunction(me, "set_assertion_prop", "SET-ASSERTION-PROP", 3, 0, false);
        declareFunction(me, "rem_assertion_prop", "REM-ASSERTION-PROP", 2, 0, false);
        declareFunction(me, "reset_assertion_variable_names", "RESET-ASSERTION-VARIABLE-NAMES", 2, 0, false);
        declareFunction(me, "does_assertion_have_meta_assertionsP", "DOES-ASSERTION-HAVE-META-ASSERTIONS?", 1, 0, false);
        declareFunction(me, "all_meta_assertions_for_assertion", "ALL-META-ASSERTIONS-FOR-ASSERTION", 1, 0, false);
        declareFunction(me, "assertion_index", "ASSERTION-INDEX", 1, 0, false);
        declareFunction(me, "assertion_index_swapped_inP", "ASSERTION-INDEX-SWAPPED-IN?", 1, 0, false);
        declareFunction(me, "reset_assertion_index", "RESET-ASSERTION-INDEX", 2, 0, false);
        declareFunction(me, "clear_assertion_index", "CLEAR-ASSERTION-INDEX", 1, 0, false);
        declareMacro(me, "destructure_assert_info", "DESTRUCTURE-ASSERT-INFO");
        declareFunction(me, "assertion_assert_info", "ASSERTION-ASSERT-INFO", 1, 0, false);
        declareFunction(me, "reset_assertion_assert_info", "RESET-ASSERTION-ASSERT-INFO", 2, 0, false);
        declareFunction(me, "asserted_assertion_timestampedP", "ASSERTED-ASSERTION-TIMESTAMPED?", 1, 0, false);
        declareFunction(me, "make_assert_info", "MAKE-ASSERT-INFO", 0, 4, false);
        declareFunction(me, "assert_info_who", "ASSERT-INFO-WHO", 1, 0, false);
        declareFunction(me, "assert_info_when", "ASSERT-INFO-WHEN", 1, 0, false);
        declareFunction(me, "assert_info_why", "ASSERT-INFO-WHY", 1, 0, false);
        declareFunction(me, "assert_info_second", "ASSERT-INFO-SECOND", 1, 0, false);
        declareFunction(me, "set_assertion_asserted_by", "SET-ASSERTION-ASSERTED-BY", 2, 0, false);
        declareFunction(me, "set_assertion_asserted_when", "SET-ASSERTION-ASSERTED-WHEN", 2, 0, false);
        declareFunction(me, "set_assertion_asserted_why", "SET-ASSERTION-ASSERTED-WHY", 2, 0, false);
        declareFunction(me, "set_assertion_asserted_second", "SET-ASSERTION-ASSERTED-SECOND", 2, 0, false);
        declareFunction(me, "valid_assertion_robustP", "VALID-ASSERTION-ROBUST?", 1, 0, false);
        declareFunction(me, "valid_assertion_with_contentP", "VALID-ASSERTION-WITH-CONTENT?", 1, 0, false);
        declareFunction(me, "kb_create_assertion_kb_store", "KB-CREATE-ASSERTION-KB-STORE", 7, 0, false);
        declareFunction(me, "kb_create_assertion_int", "KB-CREATE-ASSERTION-INT", 9, 0, false);
        declareFunction(me, "kb_create_assertion_cyc", "KB-CREATE-ASSERTION-CYC", 1, 0, false);
        declareFunction(me, "find_cnf_formula_data_hook", "FIND-CNF-FORMULA-DATA-HOOK", 1, 0, false);
        declareFunction(me, "find_hl_cnf_hook", "FIND-HL-CNF-HOOK", 1, 0, false);
        declareFunction(me, "find_gaf_formula_hook", "FIND-GAF-FORMULA-HOOK", 1, 0, false);
        declareFunction(me, "connect_assertion", "CONNECT-ASSERTION", 2, 0, false);
        declareFunction(me, "connect_assertion_formula_data", "CONNECT-ASSERTION-FORMULA-DATA", 2, 0, false);
        declareFunction(me, "kb_remove_assertion_internal", "KB-REMOVE-ASSERTION-INTERNAL", 1, 0, false);
        declareFunction(me, "reconnect_assertion", "RECONNECT-ASSERTION", 2, 0, false);
        declareFunction(me, "disconnect_assertion", "DISCONNECT-ASSERTION", 1, 0, false);
        declareFunction(me, "disconnect_assertion_formula_data", "DISCONNECT-ASSERTION-FORMULA-DATA", 1, 0, false);
        declareFunction(me, "add_new_assertion_argument", "ADD-NEW-ASSERTION-ARGUMENT", 2, 0, false);
        declareFunction(me, "remove_assertion_argument", "REMOVE-ASSERTION-ARGUMENT", 2, 0, false);
        declareFunction(me, "reset_assertion_dependents", "RESET-ASSERTION-DEPENDENTS", 2, 0, false);
        declareFunction(me, "add_assertion_dependent", "ADD-ASSERTION-DEPENDENT", 2, 0, false);
        declareFunction(me, "remove_assertion_dependent", "REMOVE-ASSERTION-DEPENDENT", 2, 0, false);
        declareFunction(me, "assertion_dependencies", "ASSERTION-DEPENDENCIES", 1, 0, false);
        declareFunction(me, "mark_dependent_assertion", "MARK-DEPENDENT-ASSERTION", 1, 0, false);
        declareFunction(me, "mark_dependent_deduction", "MARK-DEPENDENT-DEDUCTION", 1, 0, false);
        declareFunction(me, "verify_assertion_content_table", "VERIFY-ASSERTION-CONTENT-TABLE", 0, 1, false);
        declareFunction(me, "random_assertion_internal", "RANDOM-ASSERTION-INTERNAL", 0, 1, false);
        declareFunction(me, "random_rule_internal", "RANDOM-RULE-INTERNAL", 0, 0, false);
        declareFunction(me, "random_gaf_internal", "RANDOM-GAF-INTERNAL", 0, 0, false);
        return NIL;
    }
    ...
    public static SubLObject init_assertions_low_file() {
        ...
        deflexical("*PREFER-RULE-SET-OVER-FLAGS?*", NIL != boundp($sym40$_PREFER_RULE_SET_OVER_FLAGS__) ? $prefer_rule_set_over_flagsP$.getGlobalValue() : T);
        ...
        deflexical("*PREFER-NON-TRUE-SET-OVER-FLAGS?*", NIL != boundp($sym55$_PREFER_NON_TRUE_SET_OVER_FLAGS__) ? $prefer_non_true_set_over_flagsP$.getGlobalValue() : T);
    ...
    public static SubLObject setup_assertions_low_file() {
        ...
        declare_defglobal($sym40$_PREFER_RULE_SET_OVER_FLAGS__);
        declare_defglobal($non_true_assertion_tv_cache$);
        declare_defglobal($sym55$_PREFER_NON_TRUE_SET_OVER_FLAGS__);
        return NIL;
    }
    ...
    public static final class $assertion_content_native extends SubLStructNative implements SubLStruct {
        ...
        static {
            if (false)
                ...
                structDecl = SubLStructDeclNative.makeStructDeclNative(assertions_low.$assertion_content_native.class, ASSERTION_CONTENT, "AS-CONTENT", "_CSETF-");
        ...
        public $assertion_content_native() {
            this.$formula_data = Lisp.NIL;
            this.$mt = Lisp.NIL;
            this.$flags = Lisp.NIL;
            this.$arguments = Lisp.NIL;
            this.$plist = Lisp.NIL;
        ...
        public String toString() {
            try {
                return princ_to_string(this).getStringValue();
