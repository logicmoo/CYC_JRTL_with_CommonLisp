...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class os_process_utilities extends SubLTranslatedFile {
    ...
    public static SubLObject os_process_impl_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$os_process_impl_native.class ? T : NIL;
    }

    public static SubLObject os_process_impl_id(final SubLObject v_object) {
        assert NIL != os_process_impl_p(v_object) : "os_process_utilities.os_process_impl_p error :" + v_object;
    ...
    public static final class $os_process_impl_native extends SubLStructNative {
        ...
        private $os_process_impl_native() {
            this.$id = Lisp.NIL;
            this.$name = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative($os_process_impl_native.class, OS_PROCESS_IMPL, OS_PROCESS_IMPL_P, $list2, $list3, new String[]{ "$id", "$name", "$program", "$arguments", "$stdin_stream", "$stdin_filename", "$stdout_stream", "$stdout_filename", "$stderr_stream", "$stderr_filename", "$status", "$started", "$finished", "$exit_code", "$properties" }, $list4, $list5, PRINT_OS_PROCESS_IMPL);
        }
    }
