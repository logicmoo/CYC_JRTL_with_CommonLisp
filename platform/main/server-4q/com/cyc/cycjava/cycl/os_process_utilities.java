...
import static com.cyc.cycjava.cycl.os_process_utilities.*;
...
public final class os_process_utilities extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol OS_PROCESS_IMPL = makeSymbol("OS-PROCESS-IMPL");

    public static final SubLSymbol OS_PROCESS_IMPL_P = makeSymbol("OS-PROCESS-IMPL-P");
    ...
    public static final SubLSymbol PRINT_OS_PROCESS_IMPL = makeSymbol("PRINT-OS-PROCESS-IMPL");

    public static final SubLSymbol OS_PROCESS_IMPL_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("OS-PROCESS-IMPL-PRINT-FUNCTION-TRAMPOLINE");
    ...
    private static final SubLList $list65 = list(makeKeyword("INITIALIZING"), makeKeyword("RUNNING"), makeKeyword("DEAD"), makeKeyword("FAILURE"));
    ...
    private static final SubLList $list85 = list(list(makeSymbol("OS-PROCESS-VAR"), makeSymbol("COMMAND"), makeSymbol("&KEY"), list(makeSymbol("ARGS"), NIL), list(makeSymbol("NAME"), makeString("My OS process")), list(makeSymbol("STDIN"), list(makeSymbol("QUOTE"), makeSymbol("*STANDARD-INPUT*"))), list(makeSymbol("STDOUT"), list(makeSymbol("QUOTE"), makeSymbol("*STANDARD-OUTPUT*"))), list(makeSymbol("STDERR"), makeKeyword("OUTPUT"))), makeSymbol("&BODY"), makeSymbol("BODY"));

    private static final SubLList $list86 = list(makeKeyword("ARGS"), makeKeyword("NAME"), makeKeyword("STDIN"), makeKeyword("STDOUT"), makeKeyword("STDERR"));
    ...
    public static SubLObject os_process_impl_p(final SubLObject v_object) {
        return v_object.getClass() == os_process_utilities.$os_process_impl_native.class ? T : NIL;
    }

    public static SubLObject os_process_impl_id(final SubLObject v_object) {
        assert NIL != os_process_impl_p(v_object) : "os_process_utilities.os_process_impl_p(v_object) " + "CommonSymbols.NIL != os_process_utilities.os_process_impl_p(v_object) " + v_object;
    ...
    public static SubLObject make_os_process_impl(SubLObject arglist) {
        ...
        final SubLObject v_new = new os_process_utilities.$os_process_impl_native();
        SubLObject next;
    ...
    public static SubLObject make_os_process(final SubLObject name, final SubLObject program, SubLObject args, SubLObject stdin, SubLObject stdout, SubLObject stderr) {
        ...
        assert NIL != stringp(program) : "Types.stringp(program) " + "CommonSymbols.NIL != Types.stringp(program) " + program;
        assert NIL != sequencep(args) : "Types.sequencep(args) " + "CommonSymbols.NIL != Types.sequencep(args) " + args;
        assert NIL != valid_os_process_input_stream_spec_p(stdin) : "os_process_utilities.valid_os_process_input_stream_spec_p(stdin) " + "CommonSymbols.NIL != os_process_utilities.valid_os_process_input_stream_spec_p(stdin) " + stdin;
        assert NIL != valid_os_process_error_output_stream_spec_p(stderr) : "os_process_utilities.valid_os_process_error_output_stream_spec_p(stderr) " + "CommonSymbols.NIL != os_process_utilities.valid_os_process_error_output_stream_spec_p(stderr) " + stderr;
        assert NIL != valid_os_process_output_stream_spec_p(stdout) : "os_process_utilities.valid_os_process_output_stream_spec_p(stdout) " + "CommonSymbols.NIL != os_process_utilities.valid_os_process_output_stream_spec_p(stdout) " + stdout;
    ...
    public static SubLObject os_process_runningP(final SubLObject os_process) {
        assert NIL != os_process_p(os_process) : "os_process_utilities.os_process_p(os_process) " + "CommonSymbols.NIL != os_process_utilities.os_process_p(os_process) " + os_process;
    ...
    public static SubLObject declare_os_process_utilities_file() {
        declareFunction(me, "os_process_impl_print_function_trampoline", "OS-PROCESS-IMPL-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
        declareFunction(me, "os_process_impl_p", "OS-PROCESS-IMPL-P", 1, 0, false);
        new os_process_utilities.$os_process_impl_p$UnaryFunction();
        declareFunction(me, "os_process_impl_id", "OS-PROCESS-IMPL-ID", 1, 0, false);
        declareFunction(me, "os_process_impl_name", "OS-PROCESS-IMPL-NAME", 1, 0, false);
        declareFunction(me, "os_process_impl_program", "OS-PROCESS-IMPL-PROGRAM", 1, 0, false);
        declareFunction(me, "os_process_impl_arguments", "OS-PROCESS-IMPL-ARGUMENTS", 1, 0, false);
        declareFunction(me, "os_process_impl_stdin_stream", "OS-PROCESS-IMPL-STDIN-STREAM", 1, 0, false);
        declareFunction(me, "os_process_impl_stdin_filename", "OS-PROCESS-IMPL-STDIN-FILENAME", 1, 0, false);
        declareFunction(me, "os_process_impl_stdout_stream", "OS-PROCESS-IMPL-STDOUT-STREAM", 1, 0, false);
        declareFunction(me, "os_process_impl_stdout_filename", "OS-PROCESS-IMPL-STDOUT-FILENAME", 1, 0, false);
        declareFunction(me, "os_process_impl_stderr_stream", "OS-PROCESS-IMPL-STDERR-STREAM", 1, 0, false);
        declareFunction(me, "os_process_impl_stderr_filename", "OS-PROCESS-IMPL-STDERR-FILENAME", 1, 0, false);
        declareFunction(me, "os_process_impl_status", "OS-PROCESS-IMPL-STATUS", 1, 0, false);
        declareFunction(me, "os_process_impl_started", "OS-PROCESS-IMPL-STARTED", 1, 0, false);
        declareFunction(me, "os_process_impl_finished", "OS-PROCESS-IMPL-FINISHED", 1, 0, false);
        declareFunction(me, "os_process_impl_exit_code", "OS-PROCESS-IMPL-EXIT-CODE", 1, 0, false);
        declareFunction(me, "os_process_impl_properties", "OS-PROCESS-IMPL-PROPERTIES", 1, 0, false);
        declareFunction(me, "_csetf_os_process_impl_id", "_CSETF-OS-PROCESS-IMPL-ID", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_name", "_CSETF-OS-PROCESS-IMPL-NAME", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_program", "_CSETF-OS-PROCESS-IMPL-PROGRAM", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_arguments", "_CSETF-OS-PROCESS-IMPL-ARGUMENTS", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_stdin_stream", "_CSETF-OS-PROCESS-IMPL-STDIN-STREAM", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_stdin_filename", "_CSETF-OS-PROCESS-IMPL-STDIN-FILENAME", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_stdout_stream", "_CSETF-OS-PROCESS-IMPL-STDOUT-STREAM", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_stdout_filename", "_CSETF-OS-PROCESS-IMPL-STDOUT-FILENAME", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_stderr_stream", "_CSETF-OS-PROCESS-IMPL-STDERR-STREAM", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_stderr_filename", "_CSETF-OS-PROCESS-IMPL-STDERR-FILENAME", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_status", "_CSETF-OS-PROCESS-IMPL-STATUS", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_started", "_CSETF-OS-PROCESS-IMPL-STARTED", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_finished", "_CSETF-OS-PROCESS-IMPL-FINISHED", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_exit_code", "_CSETF-OS-PROCESS-IMPL-EXIT-CODE", 2, 0, false);
        declareFunction(me, "_csetf_os_process_impl_properties", "_CSETF-OS-PROCESS-IMPL-PROPERTIES", 2, 0, false);
        declareFunction(me, "make_os_process_impl", "MAKE-OS-PROCESS-IMPL", 0, 1, false);
        declareFunction(me, "visit_defstruct_os_process_impl", "VISIT-DEFSTRUCT-OS-PROCESS-IMPL", 2, 0, false);
        declareFunction(me, "visit_defstruct_object_os_process_impl_method", "VISIT-DEFSTRUCT-OBJECT-OS-PROCESS-IMPL-METHOD", 2, 0, false);
        declareFunction(me, "print_os_process_impl", "PRINT-OS-PROCESS-IMPL", 3, 0, false);
        declareFunction(me, "valid_os_process_input_stream_spec_p", "VALID-OS-PROCESS-INPUT-STREAM-SPEC-P", 1, 0, false);
        declareFunction(me, "valid_os_process_output_stream_spec_p", "VALID-OS-PROCESS-OUTPUT-STREAM-SPEC-P", 1, 0, false);
        declareFunction(me, "valid_os_process_error_output_stream_spec_p", "VALID-OS-PROCESS-ERROR-OUTPUT-STREAM-SPEC-P", 1, 0, false);
        declareFunction(me, "is_valid_os_process_status_p", "IS-VALID-OS-PROCESS-STATUS-P", 1, 0, false);
        declareFunction(me, "os_process_p", "OS-PROCESS-P", 1, 0, false);
        declareFunction(me, "clear_active_os_processes", "CLEAR-ACTIVE-OS-PROCESSES", 0, 0, false);
        declareFunction(me, "all_os_processes", "ALL-OS-PROCESSES", 0, 0, false);
        declareFunction(me, "show_os_processes", "SHOW-OS-PROCESSES", 0, 0, false);
        declareFunction(me, "os_processes_named", "OS-PROCESSES-NAMED", 1, 0, false);
        declareFunction(me, "kill_os_processes_named", "KILL-OS-PROCESSES-NAMED", 1, 0, false);
        declareFunction(me, "add_os_process_to_active_list", "ADD-OS-PROCESS-TO-ACTIVE-LIST", 1, 0, false);
        declareFunction(me, "remove_os_process_from_active_list", "REMOVE-OS-PROCESS-FROM-ACTIVE-LIST", 1, 1, false);
        declareFunction(me, "make_os_process", "MAKE-OS-PROCESS", 2, 4, false);
        declareFunction(me, "valid_os_process_idP", "VALID-OS-PROCESS-ID?", 1, 0, false);
        declareFunction(me, "os_process_runningP", "OS-PROCESS-RUNNING?", 1, 0, false);
        declareFunction(me, "wait_until_os_processes_finished", "WAIT-UNTIL-OS-PROCESSES-FINISHED", 1, 0, false);
        declareFunction(me, "wait_until_os_process_finished", "WAIT-UNTIL-OS-PROCESS-FINISHED", 1, 0, false);
        declareFunction(me, "make_os_process_internal", "MAKE-OS-PROCESS-INTERNAL", 5, 0, false);
        declareFunction(me, "get_null_file_stream_path", "GET-NULL-FILE-STREAM-PATH", 0, 0, false);
        declareFunction(me, "external_program_command_line_from_program_and_args", "EXTERNAL-PROGRAM-COMMAND-LINE-FROM-PROGRAM-AND-ARGS", 2, 0, false);
        declareFunction(me, "external_program_command_line_for_os_process", "EXTERNAL-PROGRAM-COMMAND-LINE-FOR-OS-PROCESS", 1, 0, false);
        declareFunction(me, "verify_os_process_run_status", "VERIFY-OS-PROCESS-RUN-STATUS", 1, 1, false);
        declareFunction(me, "get_current_os_process_status_internal", "GET-CURRENT-OS-PROCESS-STATUS-INTERNAL", 1, 1, false);
        declareFunction(me, "get_current_os_process_status_implementation", "GET-CURRENT-OS-PROCESS-STATUS-IMPLEMENTATION", 2, 0, false);
        declareFunction(me, "kill_os_process", "KILL-OS-PROCESS", 1, 0, false);
        declareFunction(me, "cleanup_os_process", "CLEANUP-OS-PROCESS", 1, 0, false);
        declareFunction(me, "destroy_os_process", "DESTROY-OS-PROCESS", 1, 0, false);
        declareFunction(me, "kill_os_process_internal", "KILL-OS-PROCESS-INTERNAL", 1, 0, false);
        declareMacro(me, "run_os_process", "RUN-OS-PROCESS");
        declareMacro(me, "run_os_process_to_completion", "RUN-OS-PROCESS-TO-COMPLETION");
        declareFunction(me, "system_eval_using_make_os_process", "SYSTEM-EVAL-USING-MAKE-OS-PROCESS", 1, 4, false);
        declareFunction(me, "system_eval_using_make_os_process_successfulP", "SYSTEM-EVAL-USING-MAKE-OS-PROCESS-SUCCESSFUL?", 1, 5, false);
        declareFunction(me, "os_process_evaluation_output_strings", "OS-PROCESS-EVALUATION-OUTPUT-STRINGS", 1, 3, false);
        declareFunction(me, "os_process_id", "OS-PROCESS-ID", 1, 0, false);
        declareFunction(me, "os_process_arguments", "OS-PROCESS-ARGUMENTS", 1, 0, false);
        declareFunction(me, "os_process_exit_code", "OS-PROCESS-EXIT-CODE", 1, 0, false);
        declareFunction(me, "os_process_finished", "OS-PROCESS-FINISHED", 1, 0, false);
        declareFunction(me, "os_process_name", "OS-PROCESS-NAME", 1, 0, false);
        declareFunction(me, "os_process_program", "OS-PROCESS-PROGRAM", 1, 0, false);
        declareFunction(me, "os_process_started", "OS-PROCESS-STARTED", 1, 0, false);
        declareFunction(me, "os_process_status", "OS-PROCESS-STATUS", 1, 0, false);
        declareFunction(me, "os_process_stderr_filename", "OS-PROCESS-STDERR-FILENAME", 1, 0, false);
        declareFunction(me, "os_process_stderr_stream", "OS-PROCESS-STDERR-STREAM", 1, 0, false);
        declareFunction(me, "os_process_stdin_filename", "OS-PROCESS-STDIN-FILENAME", 1, 0, false);
        declareFunction(me, "os_process_stdin_stream", "OS-PROCESS-STDIN-STREAM", 1, 0, false);
        declareFunction(me, "os_process_stdout_filename", "OS-PROCESS-STDOUT-FILENAME", 1, 0, false);
        declareFunction(me, "os_process_stdout_stream", "OS-PROCESS-STDOUT-STREAM", 1, 0, false);
        declareFunction(me, "fork_cyc_server_process", "FORK-CYC-SERVER-PROCESS", 1, 2, false);
        declareFunction(me, "fork_cyc_server_process_implementation", "FORK-CYC-SERVER-PROCESS-IMPLEMENTATION", 0, 0, false);
        return NIL;
    }
    ...
    public static final class $os_process_impl_native extends SubLStructNative {
        ...
        public $os_process_impl_native() {
            this.$id = Lisp.NIL;
            this.$name = Lisp.NIL;
            this.$program = Lisp.NIL;
            this.$arguments = Lisp.NIL;
            this.$stdin_stream = Lisp.NIL;
            this.$stdin_filename = Lisp.NIL;
            this.$stdout_stream = Lisp.NIL;
            this.$stdout_filename = Lisp.NIL;
            this.$stderr_stream = Lisp.NIL;
            this.$stderr_filename = Lisp.NIL;
            this.$status = Lisp.NIL;
            this.$started = Lisp.NIL;
            this.$finished = Lisp.NIL;
            this.$exit_code = Lisp.NIL;
        ...
        static {
            structDecl = makeStructDeclNative(os_process_utilities.$os_process_impl_native.class, OS_PROCESS_IMPL, OS_PROCESS_IMPL_P, $list2, $list3, new String[]{ "$id", "$name", "$program", "$arguments", "$stdin_stream", "$stdin_filename", "$stdout_stream", "$stdout_filename", "$stderr_stream", "$stderr_filename", "$status", "$started", "$finished", "$exit_code", "$properties" }, $list4, $list5, PRINT_OS_PROCESS_IMPL);
        }
    }
