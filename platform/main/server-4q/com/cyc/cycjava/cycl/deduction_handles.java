...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class deduction_handles extends SubLTranslatedFile {
    ...
    public static SubLObject deduction_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$deduction_native.class ? T : NIL;
    }

    public static SubLObject d_id(final SubLObject v_object) {
        assert NIL != deduction_p(v_object) : "deduction_handles.deduction_p error :" + v_object;
    ...
    public static final class $deduction_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($deduction_native.class, DEDUCTION, DEDUCTION_P, $list46, $list47, new String[]{ "$id" }, $list48, $list49, PRINT_DEDUCTION);
        }
    }
