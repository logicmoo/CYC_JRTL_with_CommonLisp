...
public final class subloop_structures extends SubLTranslatedFile {
    ...
    public static SubLObject class_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$class_native.class ? T : NIL;
    }

    public static SubLObject class_name(final SubLObject v_object) {
        assert NIL != class_p(v_object) : "subloop_structures.class_p(v_object) " + "CommonSymbols.NIL != subloop_structures.class_p(v_object) " + v_object;
    ...
    public static SubLObject class_tablified_instance_methods(final SubLObject v_object) {
        assert NIL != class_p(v_object) : "subloop_structures.class_p(v_object) " + "CommonSymbols.NIL != subloop_structures.class_p(v_object) " + v_object;
        return ((subloop_structures.$class_native) (v_object)).$tablified_instance_methods;
    }

    public static SubLObject class_definition_lock(final SubLObject v_object) {
        assert NIL != class_p(v_object) : "subloop_structures.class_p(v_object) " + "CommonSymbols.NIL != subloop_structures.class_p(v_object) " + v_object;
        return ((subloop_structures.$class_native) (v_object)).$definition_lock;
    }

    public static SubLObject class_access_lock(final SubLObject v_object) {
        assert NIL != class_p(v_object) : "subloop_structures.class_p(v_object) " + "CommonSymbols.NIL != subloop_structures.class_p(v_object) " + v_object;
        return ((subloop_structures.$class_native) (v_object)).$access_lock;
    }

    public static SubLObject class_synchronized_slots_p(final SubLObject v_object) {
        assert NIL != class_p(v_object) : "subloop_structures.class_p(v_object) " + "CommonSymbols.NIL != subloop_structures.class_p(v_object) " + v_object;
        return ((subloop_structures.$class_native) (v_object)).$synchronized_slots_p;
    }

    public static SubLObject class_plist(final SubLObject v_object) {
        assert NIL != class_p(v_object) : "subloop_structures.class_p(v_object) " + "CommonSymbols.NIL != subloop_structures.class_p(v_object) " + v_object;
        return ((subloop_structures.$class_native) (v_object)).$plist;
    }

    public static SubLObject class_class_initialization_function(final SubLObject v_object) {
        assert NIL != class_p(v_object) : "subloop_structures.class_p(v_object) " + "CommonSymbols.NIL != subloop_structures.class_p(v_object) " + v_object;
        return ((subloop_structures.$class_native) (v_object)).$class_initialization_function;
    }

    public static SubLObject class_class_initialized_p(final SubLObject v_object) {
        assert NIL != class_p(v_object) : "subloop_structures.class_p(v_object) " + "CommonSymbols.NIL != subloop_structures.class_p(v_object) " + v_object;
        return ((subloop_structures.$class_native) (v_object)).$class_initialized_p;
    }

    public static SubLObject class_instance_initialization_function(final SubLObject v_object) {
        assert NIL != class_p(v_object) : "subloop_structures.class_p(v_object) " + "CommonSymbols.NIL != subloop_structures.class_p(v_object) " + v_object;
        return ((subloop_structures.$class_native) (v_object)).$instance_initialization_function;
    }

    public static SubLObject class_class_properties(final SubLObject v_object) {
        assert NIL != class_p(v_object) : "subloop_structures.class_p(v_object) " + "CommonSymbols.NIL != subloop_structures.class_p(v_object) " + v_object;
        return ((subloop_structures.$class_native) (v_object)).$class_properties;
    }
    ...
    public static SubLObject make_class(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$class_native();
        SubLObject next;
    ...
    public static SubLObject instance_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$instance_native.class ? T : NIL;
    }

    public static SubLObject instance_class(final SubLObject v_object) {
        assert NIL != instance_p(v_object) : "subloop_structures.instance_p(v_object) " + "CommonSymbols.NIL != subloop_structures.instance_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_instance(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$instance_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject interface_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$interface_native.class ? T : NIL;
    }

    public static SubLObject interface_name(final SubLObject v_object) {
        assert NIL != interface_p(v_object) : "subloop_structures.interface_p(v_object) " + "CommonSymbols.NIL != subloop_structures.interface_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_interface(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$interface_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject method_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$method_native.class ? T : NIL;
    }

    public static SubLObject method_name(final SubLObject v_object) {
        assert NIL != method_p(v_object) : "subloop_structures.method_p(v_object) " + "CommonSymbols.NIL != subloop_structures.method_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_method(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$method_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject method_trace_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$method_trace_native.class ? T : NIL;
    }

    public static SubLObject method_trace_name(final SubLObject v_object) {
        assert NIL != method_trace_p(v_object) : "subloop_structures.method_trace_p(v_object) " + "CommonSymbols.NIL != subloop_structures.method_trace_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_method_trace(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$method_trace_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject method_info_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$method_info_native.class ? T : NIL;
    }

    public static SubLObject mi_method_name(final SubLObject v_object) {
        assert NIL != method_info_p(v_object) : "subloop_structures.method_info_p(v_object) " + "CommonSymbols.NIL != subloop_structures.method_info_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_method_info(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$method_info_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject slot_listener_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$slot_listener_native.class ? T : NIL;
    }

    public static SubLObject sl_slot_name(final SubLObject v_object) {
        assert NIL != slot_listener_p(v_object) : "subloop_structures.slot_listener_p(v_object) " + "CommonSymbols.NIL != subloop_structures.slot_listener_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_slot_listener(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$slot_listener_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject slot_listener_registry_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$slot_listener_registry_native.class ? T : NIL;
    }

    public static SubLObject slr_instance(final SubLObject v_object) {
        assert NIL != slot_listener_registry_p(v_object) : "subloop_structures.slot_listener_registry_p(v_object) " + "CommonSymbols.NIL != subloop_structures.slot_listener_registry_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_slot_listener_registry(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$slot_listener_registry_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject method_listener_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$method_listener_native.class ? T : NIL;
    }

    public static SubLObject ml_owning_method_name(final SubLObject v_object) {
        assert NIL != method_listener_p(v_object) : "subloop_structures.method_listener_p(v_object) " + "CommonSymbols.NIL != subloop_structures.method_listener_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_method_listener(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$method_listener_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject function_detail_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$function_detail_native.class ? T : NIL;
    }

    public static SubLObject fd_function_name(final SubLObject v_object) {
        assert NIL != function_detail_p(v_object) : "subloop_structures.function_detail_p(v_object) " + "CommonSymbols.NIL != subloop_structures.function_detail_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_function_detail(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$function_detail_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject method_detail_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$method_detail_native.class ? T : NIL;
    }

    public static SubLObject md_method_name(final SubLObject v_object) {
        assert NIL != method_detail_p(v_object) : "subloop_structures.method_detail_p(v_object) " + "CommonSymbols.NIL != subloop_structures.method_detail_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_method_detail(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$method_detail_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject method_listener_registry_p(final SubLObject v_object) {
        return v_object.getClass() == subloop_structures.$method_listener_registry_native.class ? T : NIL;
    }

    public static SubLObject mlr_instance(final SubLObject v_object) {
        assert NIL != method_listener_registry_p(v_object) : "subloop_structures.method_listener_registry_p(v_object) " + "CommonSymbols.NIL != subloop_structures.method_listener_registry_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_method_listener_registry(SubLObject arglist) {
        ...
        final SubLObject v_new = new subloop_structures.$method_listener_registry_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $instance_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_structures.$instance_native.class, INSTANCE, INSTANCE_P, $list132, $list133, new String[]{ "$class", "$boolean_slots", "$any_slots", "$plist" }, $list134, $list135, PRINT_INSTANCE);
        }
    }
    ...
    public static final class $method_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_structures.$method_native.class, METHOD, METHOD_P, $list210, $list211, new String[]{ "$name", "$class_name", "$lambda_list", "$body", "$protection", "$scope", "$update_type", "$function_name", "$function_def", "$before_listeners", "$after_listeners", "$instantiate_template" }, $list212, $list213, PRINT_METHOD);
        }
    }
    ...
    public static final class $method_trace_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_structures.$method_trace_native.class, METHOD_TRACE, METHOD_TRACE_P, $list261, $list262, new String[]{ "$name", "$class_name", "$function", "$outer" }, $list263, $list264, PRINT_METHOD_TRACE);
        }
    }
    ...
    public static final class $method_info_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_structures.$method_info_native.class, METHOD_INFO, METHOD_INFO_P, $list286, $list287, new String[]{ "$method_name", "$class_name", "$mv_used_in_body", "$mv_modified_in_body", "$methods_used_in_body" }, $list288, $list289, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $slot_listener_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_structures.$slot_listener_native.class, SLOT_LISTENER, SLOT_LISTENER_P, $list314, $list315, new String[]{ "$slot_name", "$demon_type", "$value_trigger", "$functional_type", "$isa_method", "$target_instance" }, $list316, $list317, PRINT_SLOT_LISTENER);
        }
    }
    ...
    public static final class $slot_listener_registry_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_structures.$slot_listener_registry_native.class, SLOT_LISTENER_REGISTRY, SLOT_LISTENER_REGISTRY_P, $list347, $list348, new String[]{ "$instance", "$slot_count", "$listeners_vector" }, $list349, $list350, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $method_listener_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_structures.$method_listener_native.class, METHOD_LISTENER, METHOD_LISTENER_P, $list370, $list371, new String[]{ "$owning_method_name", "$owning_class_name", "$demon_type", "$detail" }, $list372, $list373, PRINT_METHOD_LISTENER);
        }
    }
    ...
    public static final class $function_detail_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_structures.$function_detail_native.class, FUNCTION_DETAIL, FUNCTION_DETAIL_P, $list395, $list396, new String[]{ "$function_name", "$arglist" }, $list397, $list398, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $method_detail_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_structures.$method_detail_native.class, METHOD_DETAIL, METHOD_DETAIL_P, $list413, $list414, new String[]{ "$method_name", "$function_name", "$arglist", "$instance" }, $list415, $list416, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $method_listener_registry_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(subloop_structures.$method_listener_registry_native.class, METHOD_LISTENER_REGISTRY, METHOD_LISTENER_REGISTRY_P, $list434, $list435, new String[]{ "$instance", "$listener_alist" }, $list436, $list437, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
