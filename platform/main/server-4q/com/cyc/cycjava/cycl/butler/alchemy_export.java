...
public final class alchemy_export extends SubLTranslatedFile {
	...
	public static final SubLList $list20 = list(new SubLObject[] { makeKeyword("UNION"), makeKeyword("CRITERION"), makeKeyword("INTERSECTION"), makeKeyword("CRITERION"), makeKeyword("EXCEPTION"), list(makeKeyword("CRITERION"), makeKeyword("CRITERION")), makeKeyword("IN-MT"), list(makeSymbol("HLMT-P")), makeKeyword("VISIBLE-FROM-MT"), list(makeSymbol("HLMT-P")), makeKeyword("COLLECTION-EXTENT"),
			list(makeSymbol("COLLECTION-P")), makeKeyword("COLLECTION-EXTENTS"), list(makeSymbol("CYCL-DENOTATIONAL-TERM-P")), makeKeyword("COLLECTION-EXTENTS-QUOTED"), list(makeSymbol("COLLECTION-P")), makeKeyword("PREDICATE-EXTENT"), list(makeSymbol("PREDICATE-P")), makeKeyword("PREDICATE-EXTENTS"), list(makeSymbol("CYCL-DENOTATIONAL-TERM-P")), makeKeyword("PREDICATE-EXTENTS-QUOTED"),
			list(makeSymbol("COLLECTION-P")), makeKeyword("ASSERTIONS-MEETING-CRITERION-PLUS-EXTENTS-OF-PREDICATES-MENTIONED"), list(makeKeyword("CRITERION")), makeKeyword("ASSERTIONS-MEETING-CRITERION-PLUS-EXTENTS-OF-PREDICATES-AND-COLLECTIONS-MENTIONED"), list(makeKeyword("CRITERION")), makeKeyword("MENTIONS-TERM"), list(makeSymbol("INDEXED-TERM-P")), makeKeyword("MENTIONS-TERM-AT-LEAST-N-TIMES"),
			list(makeSymbol("INDEXED-TERM-P"), makeSymbol("POSITIVE-INTEGER-P")), makeKeyword("MENTIONS-TERM-IN-ARGPOS"), list(makeSymbol("INDEXED-TERM-P"), makeSymbol("POSITIVE-INTEGER-P")), makeKeyword("MENTIONS-ANY-INSTANTIATION-OF"), list(makeSymbol("CYCL-DENOTATIONAL-TERM-P")), makeKeyword("MENTIONS-ANY-QUOTED-INSTANCE-OF"), list(makeSymbol("COLLECTION-P")),
			makeKeyword("MENTIONS-INSTANTIATIONS-OF-AT-LEAST-N-TIMES"), list(makeSymbol("CYCL-DENOTATIONAL-TERM-P"), makeSymbol("POSITIVE-INTEGER-P")), makeKeyword("MENTIONS-QUOTED-INSTANCES-OF-AT-LEAST-N-TIMES"), list(makeSymbol("COLLECTION-P"), makeSymbol("POSITIVE-INTEGER-P")), makeKeyword("MENTIONS-ANY-INSTANTIATION-OF-IN-ARGPOS"), list(makeSymbol("CYCL-DENOTATIONAL-TERM-P"), makeSymbol("POSITIVE-INTEGER-P")),
			makeKeyword("MENTIONS-ANY-QUOTED-INSTANCE-OF-IN-ARGPOS"), list(makeSymbol("COLLECTION-P"), makeSymbol("POSITIVE-INTEGER-P")), makeKeyword("MENTIONS-ALL-INSTANTIATIONS-OF"), list(makeSymbol("CYCL-DENOTATIONAL-TERM-P")), makeKeyword("MENTIONS-ALL-QUOTED-INSTANCES-OF"), list(makeSymbol("COLLECTION-P")), makeKeyword("MENTIONS-ONLY-INSTANTIATIONS-OF"), list(makeSymbol("CYCL-DENOTATIONAL-TERM-P")),
			makeKeyword("MENTIONS-ONLY-QUOTED-INSTANCES-OF"), list(makeSymbol("COLLECTION-P")) });
	...
	private static final SubLList $list210 = list(makeSymbol("ALCHEMY-EXPORT"), list(makeSymbol("QUOTE"), list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("AlchemyDemoRulesMt")))), list(makeSymbol("QUOTE"), list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("AlchemyDemoTrainingGAFsMt")))),
			list(makeSymbol("QUOTE"), list(list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("AlchemyDemoEvidenceGAFsMt"))))), makeString("A-rules.mln"), makeString("A-train.db"), list(makeSymbol("QUOTE"), list(makeString("A-evid.db"))));

	private static final SubLString $$$B = makeString("B");

	private static final SubLList $list212 = list(makeSymbol("ALCHEMY-EXPORT"), list(makeSymbol("QUOTE"), list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("AlchemyCyclistRulesMt")))), list(makeSymbol("QUOTE"), list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("AlchemyCyclistTrainingDataMt")))),
			list(makeSymbol("QUOTE"), list(list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("AlchemyCyclistTestingDataMt"))))), makeString("B-rules.mln"), makeString("B-train.db"), list(makeSymbol("QUOTE"), list(makeString("B-evid.db"))));

	private static final SubLString $$$C = makeString("C");

	private static final SubLList $list214 = list(makeSymbol("ALCHEMY-EXPORT"), list(makeSymbol("QUOTE"), list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("TheSimpsonsMt")))), list(makeSymbol("QUOTE"), list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("TheSimpsonsMt")))),
			list(makeSymbol("QUOTE"), list(list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("TheSimpsonsMt"))))), makeString("C-rules.mln"), makeString("C-train.db"), list(makeSymbol("QUOTE"), list(makeString("C-evid.db"))));

	private static final SubLString $$$D = makeString("D");

	private static final SubLList $list216 = list(makeSymbol("ALCHEMY-EXPORT"), list(makeSymbol("QUOTE"), list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("AcademicOrganizationMt")))), list(makeSymbol("QUOTE"), list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("UniversityDataMt")))),
			list(makeSymbol("QUOTE"), list(list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("UniversityDataMt"))))), makeString("D-rules.mln"), makeString("D-train.db"), list(makeSymbol("QUOTE"), list(makeString("D-evid.db"))));

	private static final SubLString $$$E = makeString("E");

	private static final SubLList $list218 = list(makeSymbol("ALCHEMY-EXPORT"), list(makeSymbol("QUOTE"), list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("AlchemyDemoIIRulesMt")))), list(makeSymbol("QUOTE"), list(makeKeyword("IN-MT"), reader_make_constant_shell(makeString("AustinAreaMt")))),
			list(makeSymbol("BQ-LIST"), list(makeSymbol("BQ-LIST"), makeKeyword("IN-MT"), list(makeSymbol("CANONICALIZE-TERM"), list(makeSymbol("QUOTE"), list(reader_make_constant_shell(makeString("ContentMtFn")), reader_make_constant_shell(makeString("WashingtonPostEntertainmentGuide-KS"))))))), makeString("E-rules.mln"), makeString("E-train.db"), list(makeSymbol("QUOTE"), list(makeString("E-evid.db"))));
	...
	private static final SubLList $list299 = list(new SubLObject[] {
			list(list(list(reader_make_constant_shell(makeString("likesAsFriend")), reader_make_constant_shell(makeString("RonaldReagan")), reader_make_constant_shell(makeString("Madonna")))), makeString("\npred2C_likesAsFriend(C_RonaldReagan,C_Madonna)\n(pred2C_likesAsFriend(arg1,ins)) => (pred1C_PerceptualAgent-Embodied(ins))\n(pred2C_likesAsFriend(ins,arg2)) => (pred1C_PerceptualAgent-Embodied(ins))")),
			list(list(list(reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("Cyc")), reader_make_constant_shell(makeString("Emu")))),
			...
			list(list(list(reader_make_constant_shell(makeString("eatsWillingly")), list(reader_make_constant_shell(makeString("MotherFn")), reader_make_constant_shell(makeString("Cyc"))), reader_make_constant_shell(makeString("Emu")))), makeString(
			...
			list(list(list(reader_make_constant_shell(makeString("dayTimeDecayRate")), reader_make_constant_shell(makeString("12-dimethylhydrazine")), ZERO_INTEGER)),
			...
			list(list(list(reader_make_constant_shell(makeString("not")), list(reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("Cyc")), reader_make_constant_shell(makeString("Emu"))))),
					makeString("\n!(pred1C_Emu(C_Cyc))\n(pred2C_isa(arg1,ins)) => (pred1C_Collection(ins))\n(pred2C_isa(arg1,ins)) => (pred1C_Collection(ins))\n(pred2C_isa(ins,arg2)) => (pred1C_Thing(ins))\n(pred2C_isa(ins,arg2)) => (pred1C_Thing(ins))\n((pred2C_isa(arg1,old)) ^ (pred2C_genls(old,new))) => (pred2C_isa(arg1,new))\n(pred2C_isa(x,C_Emu)) <=> (pred1C_Emu(x)).")),
			list(list(list(reader_make_constant_shell(makeString("and")), list(reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("Cyc")), reader_make_constant_shell(makeString("Emu"))), list(reader_make_constant_shell(makeString("eatsWillingly")), reader_make_constant_shell(makeString("Cyc")), reader_make_constant_shell(makeString("Pizza"))))), makeString(
					"\npred2C_eatsWillingly(C_Cyc,C_Pizza)\npred1C_Emu(C_Cyc)\n(pred2C_isa(arg1,ins)) => (pred1C_Collection(ins))\n(pred2C_isa(arg1,ins)) => (pred1C_Collection(ins))\n(pred2C_isa(ins,arg2)) => (pred1C_Thing(ins))\n(pred2C_isa(ins,arg2)) => (pred1C_Thing(ins))\n((pred2C_isa(arg1,old)) ^ (pred2C_genls(old,new))) => (pred2C_isa(arg1,new))\n(pred2C_isa(x,C_Emu)) <=> (pred1C_Emu(x)).\n(pred2C_eatsWillingly(arg1,ins)) => (pred1C_TemporalStuffType(ins))\n(pred2C_eatsWillingly(ins,arg2)) => (pred1C_Animal(ins))\n((pred2C_eatsWillingly(arg1,old)) ^ (pred2C_genls(old,new))) => (pred2C_eatsWillingly(arg1,new))\n(pred2C_isa(x,C_Pizza)) <=> (pred1C_Pizza(x)).")),
			list(list(list(reader_make_constant_shell(makeString("or")), list(reader_make_constant_shell(makeString("isa")), reader_make_constant_shell(makeString("Cyc")), reader_make_constant_shell(makeString("Emu"))), list(reader_make_constant_shell(makeString("eatsWillingly")), reader_make_constant_shell(makeString("Cyc")), reader_make_constant_shell(makeString("Pizza"))))), makeString(
					"\n(pred1C_Emu(C_Cyc)) v (pred2C_eatsWillingly(C_Cyc,C_Pizza))\n(pred2C_isa(arg1,ins)) => (pred1C_Collection(ins))\n(pred2C_isa(arg1,ins)) => (pred1C_Collection(ins))\n(pred2C_isa(ins,arg2)) => (pred1C_Thing(ins))\n(pred2C_isa(ins,arg2)) => (pred1C_Thing(ins))\n((pred2C_isa(arg1,old)) ^ (pred2C_genls(old,new))) => (pred2C_isa(arg1,new))\n(pred2C_isa(x,C_Emu)) <=> (pred1C_Emu(x)).\n(pred2C_eatsWillingly(arg1,ins)) => (pred1C_TemporalStuffType(ins))\n(pred2C_eatsWillingly(ins,arg2)) => (pred1C_Animal(ins))\n((pred2C_eatsWillingly(arg1,old)) ^ (pred2C_genls(old,new))) => (pred2C_eatsWillingly(arg1,new))\n(pred2C_isa(x,C_Pizza)) <=> (pred1C_Pizza(x)).")),
			list(list(list(reader_make_constant_shell(makeString("implies")), list(reader_make_constant_shell(makeString("isa")), makeSymbol("?X"), reader_make_constant_shell(makeString("Emu"))), list(reader_make_constant_shell(makeString("likesAsFriend")), reader_make_constant_shell(makeString("Madonna")), makeSymbol("?X")))), makeString(
					"\n(pred1C_Emu(x)) => (pred2C_likesAsFriend(C_Madonna,x))\n(pred2C_isa(arg1,ins)) => (pred1C_Collection(ins))\n(pred2C_isa(arg1,ins)) => (pred1C_Collection(ins))\n(pred2C_isa(ins,arg2)) => (pred1C_Thing(ins))\n(pred2C_isa(ins,arg2)) => (pred1C_Thing(ins))\n((pred2C_isa(arg1,old)) ^ (pred2C_genls(old,new))) => (pred2C_isa(arg1,new))\n(pred2C_isa(x,C_Emu)) <=> (pred1C_Emu(x)).\n(pred2C_likesAsFriend(arg1,ins)) => (pred1C_PerceptualAgent-Embodied(ins))\n(pred2C_likesAsFriend(ins,arg2)) => (pred1C_PerceptualAgent-Embodied(ins))")),
			list(list(list(reader_make_constant_shell(makeString("forAll")), makeSymbol("?THING"), list(reader_make_constant_shell(makeString("isa")), makeSymbol("?THING"), reader_make_constant_shell(makeString("Thing"))))),
	...
	private static final SubLList $list303 = list(list(list(list(reader_make_constant_shell(makeString("FOL-AtomicTermFn")), reader_make_constant_shell(makeString("Thing")))), makeString("C_Thing")),
			list(list(list(list(reader_make_constant_shell(makeString("FOL-FunctionFn")), reader_make_constant_shell(makeString("EnglishSuffixationFn"))), list(reader_make_constant_shell(makeString("FOL-StringFn")), makeString("glory")), list(reader_make_constant_shell(makeString("FOL-StringFn")), makeString("ous")))),
			...
			list(list(makeSymbol("?WHAT")), makeString("what")), list(list(makeSymbol("??WHAT")), makeString("what")), list(list(list(reader_make_constant_shell(makeString("FOL-StringFn")), makeString("blork"))), makeString("\"blork\"")), list(list(list(reader_make_constant_shell(makeString("FOL-NumberFn")), makeInteger(-4))), makeString("-4")));
	...
	public static SubLObject check_non_atomic_assertion_selection_criterion_arg_type(final SubLObject arg, final SubLObject v_arg_type) {
		...
		} else if (NIL == funcall(v_arg_type, arg)) {
	...
	public static SubLObject find_assertions_by_criterion_int(final SubLObject criterion) {
		if (criterion.isKeyword()) {
			...
			} else if (pcase_var.eql($VISIBLE_FROM_MT)) {
			...
			} else if (pcase_var.eql($COLLECTION_EXTENT)) {
			...
			} else if (pcase_var.eql($COLLECTION_EXTENTS)) {
			...
			} else if (pcase_var.eql($COLLECTION_EXTENTS_QUOTED)) {
			...
			} else if (pcase_var.eql($PREDICATE_EXTENTS)) {
			...
			} else if (pcase_var.eql($PREDICATE_EXTENTS_QUOTED)) {
			...
			} else if (pcase_var.eql($ASSERTIONS_MEETING_CRITERION_PLUS_EXTENTS_OF_PREDICATES_MENTIONED)) {
			...
			} else if (pcase_var.eql($MENTIONS_TERM)) {
			...
			} else if (pcase_var.eql($MENTIONS_TERM_AT_LEAST_N_TIMES)) {
			...
			} else if (pcase_var.eql($MENTIONS_TERM_IN_ARGPOS)) {
			...
			} else if (pcase_var.eql($MENTIONS_ANY_INSTANTIATION_OF)) {
			...
			} else if (pcase_var.eql($MENTIONS_ANY_QUOTED_INSTANCE_OF)) {
			...
			} else if (pcase_var.eql($MENTIONS_INSTANTIATIONS_OF_AT_LEAST_N_TIMES)) {
			...
			} else if (pcase_var.eql($MENTIONS_QUOTED_INSTANCES_OF_AT_LEAST_N_TIMES)) {
			...
			} else if (pcase_var.eql($MENTIONS_ANY_INSTANTIATION_OF_IN_ARGPOS)) {
			...
			} else if (pcase_var.eql($MENTIONS_ANY_QUOTED_INSTANCE_OF_IN_ARGPOS)) {
			...
			} else if (pcase_var.eql($MENTIONS_ALL_INSTANTIATIONS_OF)) {
			...
			} else if (pcase_var.eql($MENTIONS_ALL_QUOTED_INSTANCES_OF)) {
			...
			} else if (pcase_var.eql($MENTIONS_ONLY_INSTANTIATIONS_OF)) {
			...
			} else if (pcase_var.eql($MENTIONS_ONLY_QUOTED_INSTANCES_OF)) {
	...
	public static SubLObject alchemy_export_isa_term_type(final SubLObject v_term, final SubLObject type) {
		...
		} else if (type.isCons() && cycl_utilities.formula_arg0(type).eql($$CollectionIntersectionFn)) {
	...
	public static SubLObject alchemy_export_sentence(final SubLObject focycl_sentence, SubLObject stream, SubLObject top_levelP, SubLObject hardP) {
		...
		} else if (pcase_var.eql($$and) || pcase_var.eql($$or)) {
		...
		} else if (pcase_var.eql($$implies) || pcase_var.eql($$equiv)) {
		...
		} else if (pcase_var.eql($$forAll) || pcase_var.eql($$thereExists)) {
