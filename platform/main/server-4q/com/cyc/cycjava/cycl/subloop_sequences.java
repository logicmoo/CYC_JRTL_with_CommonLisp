...
import static com.cyc.cycjava.cycl.subloop_sequences.*;
...
public final class subloop_sequences extends SubLTranslatedFile {
    ...
    // Internal Constants
    public static final SubLSymbol SEQUENCE_ELEMENT_TEMPLATE = makeSymbol("SEQUENCE-ELEMENT-TEMPLATE");

    public static final SubLList $list1 = list(new SubLObject[]{ list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SELF-DELETION-MODE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-SELF-DELETION-MODE"), list(makeSymbol("MODE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-INDEX"), list(makeSymbol("SEQUENCE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-INDEX"), list(makeSymbol("SEQUENCE"), makeSymbol("INDEX")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DELETE-SELF-FROM-SEQUENCE"), list(makeSymbol("SEQUENCE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("TRANSFER-SELF"), list(makeSymbol("CURRENT-SEQUENCE"), makeSymbol("NEW-SEQUENCE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DELETE-SELF-FROM-ALL-SEQUENCES"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("MEMBER-P"), list(makeSymbol("SEQUENCE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SEQUENCES"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ON-ADD"), list(makeSymbol("PARENT-SEQUENCE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ON-DELETE"), list(makeSymbol("PARENT-SEQUENCE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PERFORM-ACTION"), list(makeSymbol("ACTION"), makeSymbol("PARAMETERS")), makeKeyword("PUBLIC")) });



    public static final SubLList $list3 = list(new SubLObject[]{ list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CLEAR"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-LENGTH"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-NTH"), list(makeSymbol("N"), makeSymbol("&OPTIONAL"), list(makeSymbol("OUT-OF-RANGE-VALUE"), NIL)), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-NTH"), list(makeSymbol("N"), makeSymbol("NEW-VALUE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SUBSEQUENCE"), list(makeSymbol("START-INDEX"), makeSymbol("&OPTIONAL"), list(makeSymbol("END-INDEX"), NIL)), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADD"), list(makeSymbol("NEW-ELEMENT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SEQUENCE-CLASS"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-SEQUENCE-CLASS"), list(makeSymbol("NEW-CLASS")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-CONTENTS"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOCATE-ENUMERATOR"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DEALLOCATE-ENUMERATOR"), list(makeSymbol("OLD-ENUMERATOR")), makeKeyword("PUBLIC")) });



    public static final SubLList $list5 = list(makeKeyword("PUBLIC"));

    public static final SubLList $list6 = list(list(makeSymbol("CLET"), list(list(makeSymbol("LIST-OF-CONTENTS"), NIL)), list(makeSymbol("CDOTIMES"), list(makeSymbol("INDEX"), list(makeSymbol("GET-LENGTH"), makeSymbol("SELF"))), list(makeSymbol("CPUSH"), list(makeSymbol("GET-NTH"), makeSymbol("SELF"), makeSymbol("INDEX")), makeSymbol("LIST-OF-CONTENTS"))), list(makeSymbol("RET"), list(makeSymbol("NREVERSE"), makeSymbol("LIST-OF-CONTENTS")))));

    public static final SubLSymbol SEQUENCE_TEMPLATE = makeSymbol("SEQUENCE-TEMPLATE");

    public static final SubLList $list8 = list(makeSymbol("SEQUENCE"));

    public static final SubLList $list9 = list(makeKeyword("EXTENDS"), list(makeSymbol("SEQUENCE")));

    public static final SubLList $list10 = list(new SubLObject[]{ list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-INTERNAL-STORAGE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-INTERNAL-STORAGE"), list(makeSymbol("NEW-INTERNAL-STORAGE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CLEAR"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-LENGTH"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-NTH"), list(makeSymbol("N"), makeSymbol("&OPTIONAL"), list(makeSymbol("OUT-OF-RANGE-VALUE"))), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-NTH"), list(makeSymbol("N"), makeSymbol("NEW-VALUE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INSERT-AT"), list(makeSymbol("N"), makeSymbol("NEW-VALUE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SUBSEQUENCE"), list(makeSymbol("START-INDEX"), makeSymbol("&OPTIONAL"), list(makeSymbol("END-INDEX"), NIL)), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADD"), list(makeSymbol("NEW-ELEMENT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOCATE-ENUMERATOR"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DEALLOCATE-ENUMERATOR"), list(makeSymbol("OLD-ENUMERATOR")), makeKeyword("PUBLIC")) });



    public static final SubLList $list12 = list(list(makeSymbol("SET-INTERNAL-STORAGE"), makeSymbol("SELF"), NIL), list(makeSymbol("RET"), NIL));



    public static final SubLList $list14 = list(list(makeSymbol("RET"), list(makeSymbol("LENGTH"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF")))));



    public static final SubLList $list16 = list(makeSymbol("N"), makeSymbol("&OPTIONAL"), list(makeSymbol("OUT-OF-RANGE-VALUE")));

    public static final SubLList $list17 = list(list(makeSymbol("PWHEN"), list(makeSymbol("<"), makeSymbol("N"), ZERO_INTEGER), list(makeSymbol("RET"), makeSymbol("OUT-OF-RANGE-VALUE"))), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-CURRENT-CONS"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF"))), list(makeSymbol("TEMPLATE-INDEX"), ZERO_INTEGER)), list(makeSymbol("WHILE"), makeSymbol("TEMPLATE-CURRENT-CONS"), list(makeSymbol("PWHEN"), list(makeSymbol("="), makeSymbol("N"), makeSymbol("TEMPLATE-INDEX")), list(makeSymbol("RET"), list(makeSymbol("CAR"), makeSymbol("TEMPLATE-CURRENT-CONS")))), list(makeSymbol("CINC"), makeSymbol("TEMPLATE-INDEX")), list(makeSymbol("CSETQ"), makeSymbol("TEMPLATE-CURRENT-CONS"), list(makeSymbol("CDR"), makeSymbol("TEMPLATE-CURRENT-CONS")))), list(makeSymbol("RET"), makeSymbol("OUT-OF-RANGE-VALUE"))));



    public static final SubLList $list19 = list(makeSymbol("N"), makeSymbol("NEW-VALUE"));

    public static final SubLList $list20 = list(list(makeSymbol("SET-NTH"), makeSymbol("N"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF")), makeSymbol("NEW-VALUE")), list(makeSymbol("RET"), makeSymbol("NEW-VALUE")));



    public static final SubLList $list22 = list(makeSymbol("START-INDEX"), makeSymbol("&OPTIONAL"), list(makeSymbol("END-INDEX"), NIL));

    public static final SubLList $list23 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-CLASS"), list(makeSymbol("GET-SEQUENCE-CLASS"), makeSymbol("SELF"))), list(makeSymbol("TEMPLATE-INSTANCE"), list(makeSymbol("NEW-OBJECT-INSTANCE"), makeSymbol("TEMPLATE-CLASS"))), list(makeSymbol("TEMPLATE-SUBLIST"), list(makeSymbol("NTHCDR"), makeSymbol("START-INDEX"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF"))))), list(makeSymbol("PIF"), makeSymbol("END-INDEX"), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-NEW-STORAGE"), NIL), list(makeSymbol("TEMPLATE-POINTER"), makeSymbol("TEMPLATE-SUBLIST"))), list(makeSymbol("CDOTIMES"), list(makeSymbol("I"), list(makeSymbol("-"), makeSymbol("END-INDEX"), makeSymbol("START-INDEX"))), list(makeSymbol("CPUSH"), list(makeSymbol("CAR"), makeSymbol("TEMPLATE-POINTER")), makeSymbol("TEMPLATE-NEW-STORAGE")), list(makeSymbol("CSETQ"), makeSymbol("TEMPLATE-POINTER"), list(makeSymbol("CDR"), makeSymbol("TEMPLATE-POINTER")))), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("TEMPLATE-INSTANCE"), list(makeSymbol("QUOTE"), makeSymbol("SET-INTERNAL-STORAGE")), list(makeSymbol("NREVERSE"), makeSymbol("TEMPLATE-NEW-STORAGE")))), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("TEMPLATE-INSTANCE"), list(makeSymbol("QUOTE"), makeSymbol("SET-INTERNAL-STORAGE")), list(makeSymbol("COPY-LIST"), makeSymbol("TEMPLATE-SUBLIST")))), list(makeSymbol("RET"), makeSymbol("TEMPLATE-INSTANCE"))));



    public static final SubLList $list25 = list(makeSymbol("NEW-ELEMENT"));

    public static final SubLList $list26 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-INTERNAL-STORAGE"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF")))), list(makeSymbol("PIF"), list(makeSymbol("NULL"), makeSymbol("TEMPLATE-INTERNAL-STORAGE")), list(makeSymbol("PROGN"), list(makeSymbol("SET-INTERNAL-STORAGE"), makeSymbol("SELF"), list(makeSymbol("LIST"), makeSymbol("NEW-ELEMENT"))), list(makeSymbol("RET"), makeSymbol("NEW-ELEMENT"))), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-LAST-CONS"), list(makeSymbol("LAST"), makeSymbol("TEMPLATE-INTERNAL-STORAGE")))), list(makeSymbol("RPLACD"), makeSymbol("TEMPLATE-LAST-CONS"), list(makeSymbol("LIST"), makeSymbol("NEW-ELEMENT"))), list(makeSymbol("RET"), makeSymbol("NEW-ELEMENT"))))));



    public static final SubLList $list28 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-INTERNAL-STORAGE"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF")))), list(makeSymbol("PWHEN"), makeSymbol("TEMPLATE-INTERNAL-STORAGE"), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-ENUMERATOR"), list(makeSymbol("NEW-CLASS-INSTANCE"), list(makeSymbol("QUOTE"), makeSymbol("BASIC-SEQUENCE-ENUMERATOR"))))), list(makeSymbol("BASIC-SEQUENCE-ENUMERATOR-SET-SHARED-STORAGE-METHOD"), makeSymbol("TEMPLATE-ENUMERATOR"), makeSymbol("TEMPLATE-INTERNAL-STORAGE")), list(makeSymbol("RET"), makeSymbol("TEMPLATE-ENUMERATOR"))))), list(makeSymbol("RET"), NIL));



    public static final SubLList $list30 = list(makeSymbol("OLD-ENUMERATOR"));

    public static final SubLList $list31 = list(list(makeSymbol("MUST"), list(makeSymbol("BASIC-SEQUENCE-ENUMERATOR-P"), makeSymbol("OLD-ENUMERATOR")), makeString("(DEALLOCATE-ENUMERATOR ~S): ~S is not an instance of BASIC-SEQUENCE-ENUMERATOR."), makeSymbol("SELF"), makeSymbol("OLD-ENUMERATOR")), list(makeSymbol("BASIC-SEQUENCE-ENUMERATOR-SET-SHARED-STORAGE-METHOD"), makeSymbol("OLD-ENUMERATOR"), NIL), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR = makeSymbol("BASIC-SEQUENCE-ENUMERATOR");



    public static final SubLList $list34 = list(makeSymbol("ENUMERATOR-TEMPLATE"));

    public static final SubLList $list35 = list(new SubLObject[]{ list(makeSymbol("SHARED-STORAGE"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("LENGTH"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("CURRENT-INDEX"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INITIALIZE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-SHARED-STORAGE"), list(makeSymbol("NEW-SHARED-STORAGE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("EMPTY-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("FIRST-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("LAST-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CURRENT"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("FIRST"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("LAST"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("NEXT"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PREVIOUS"), NIL, makeKeyword("PUBLIC")) });
    ...
    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_BASIC_SEQUENCE_ENUMERATOR_CLASS = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-BASIC-SEQUENCE-ENUMERATOR-CLASS");





    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_BASIC_SEQUENCE_ENUMERATOR_INSTANCE = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-BASIC-SEQUENCE-ENUMERATOR-INSTANCE");



    public static final SubLList $list45 = list(makeKeyword("PROTECTED"));

    public static final SubLList $list46 = list(list(makeSymbol("INITIALIZE"), makeSymbol("SUPER")), list(makeSymbol("CSETQ"), makeSymbol("SHARED-STORAGE"), NIL), list(makeSymbol("CSETQ"), makeSymbol("LENGTH"), MINUS_ONE_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol $sym47$OUTER_CATCH_FOR_BASIC_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR_INITIALIZE_METHOD = makeSymbol("BASIC-SEQUENCE-ENUMERATOR-INITIALIZE-METHOD");

    public static final SubLSymbol SET_SHARED_STORAGE = makeSymbol("SET-SHARED-STORAGE");

    public static final SubLList $list50 = list(makeSymbol("NEW-SHARED-STORAGE"));

    public static final SubLList $list51 = list(list(makeSymbol("MUST"), list(makeSymbol("LISTP"), makeSymbol("NEW-SHARED-STORAGE")), makeString("(SET-SHARED-STORAGE ~S): ~S is not a list."), makeSymbol("SELF"), makeSymbol("NEW-SHARED-STORAGE")), list(makeSymbol("CSETQ"), makeSymbol("SHARED-STORAGE"), makeSymbol("NEW-SHARED-STORAGE")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("LENGTH"), list(makeSymbol("LENGTH"), makeSymbol("SHARED-STORAGE"))), list(makeSymbol("RET"), makeSymbol("NEW-SHARED-STORAGE")));

    public static final SubLSymbol $sym52$OUTER_CATCH_FOR_BASIC_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLString $str53$_SET_SHARED_STORAGE__S____S_is_no = makeString("(SET-SHARED-STORAGE ~S): ~S is not a list.");

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR_SET_SHARED_STORAGE_METHOD = makeSymbol("BASIC-SEQUENCE-ENUMERATOR-SET-SHARED-STORAGE-METHOD");



    public static final SubLList $list56 = list(list(makeSymbol("RET"), list(makeSymbol("<="), makeSymbol("LENGTH"), ZERO_INTEGER)));

    public static final SubLSymbol $sym57$OUTER_CATCH_FOR_BASIC_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR_EMPTY_P_METHOD = makeSymbol("BASIC-SEQUENCE-ENUMERATOR-EMPTY-P-METHOD");



    public static final SubLList $list60 = list(list(makeSymbol("RET"), list(makeSymbol("="), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER)));

    public static final SubLSymbol $sym61$OUTER_CATCH_FOR_BASIC_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR_FIRST_P_METHOD = makeSymbol("BASIC-SEQUENCE-ENUMERATOR-FIRST-P-METHOD");



    public static final SubLList $list64 = list(list(makeSymbol("RET"), list(makeSymbol("="), makeSymbol("CURRENT-INDEX"), list(makeSymbol("-"), makeSymbol("LENGTH"), ONE_INTEGER))));

    public static final SubLSymbol $sym65$OUTER_CATCH_FOR_BASIC_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR_LAST_P_METHOD = makeSymbol("BASIC-SEQUENCE-ENUMERATOR-LAST-P-METHOD");



    public static final SubLList $list68 = list(list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol(">="), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("<"), makeSymbol("CURRENT-INDEX"), makeSymbol("LENGTH"))), list(makeSymbol("RET"), list(makeSymbol("NTH"), makeSymbol("CURRENT-INDEX"), makeSymbol("SHARED-STORAGE")))), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol $sym69$OUTER_CATCH_FOR_BASIC_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR_CURRENT_METHOD = makeSymbol("BASIC-SEQUENCE-ENUMERATOR-CURRENT-METHOD");



    public static final SubLList $list72 = list(list(makeSymbol("PWHEN"), list(makeSymbol(">="), makeSymbol("LENGTH"), ZERO_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("RET"), list(makeSymbol("NTH"), ZERO_INTEGER, makeSymbol("SHARED-STORAGE")))), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol $sym73$OUTER_CATCH_FOR_BASIC_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR_FIRST_METHOD = makeSymbol("BASIC-SEQUENCE-ENUMERATOR-FIRST-METHOD");



    public static final SubLList $list76 = list(list(makeSymbol("PWHEN"), list(makeSymbol(">="), makeSymbol("LENGTH"), ZERO_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), list(makeSymbol("-"), makeSymbol("LENGTH"), ONE_INTEGER)), list(makeSymbol("RET"), list(makeSymbol("NTH"), makeSymbol("CURRENT-INDEX"), makeSymbol("SHARED-STORAGE")))), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol $sym77$OUTER_CATCH_FOR_BASIC_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR_LAST_METHOD = makeSymbol("BASIC-SEQUENCE-ENUMERATOR-LAST-METHOD");



    public static final SubLList $list80 = list(makeKeyword("AUTO-UPDATE"), makeKeyword("PUBLIC"));

    public static final SubLList $list81 = list(list(makeSymbol("PWHEN"), list(makeSymbol(">="), makeSymbol("CURRENT-INDEX"), makeSymbol("LENGTH")), list(makeSymbol("RET"), NIL)), list(makeSymbol("CINC"), makeSymbol("CURRENT-INDEX")), list(makeSymbol("RET"), list(makeSymbol("CURRENT"), makeSymbol("SELF"))));

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR_NEXT_METHOD = makeSymbol("BASIC-SEQUENCE-ENUMERATOR-NEXT-METHOD");



    public static final SubLList $list84 = list(list(makeSymbol("PWHEN"), list(makeSymbol("<="), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("RET"), NIL)), list(makeSymbol("CDEC"), makeSymbol("CURRENT-INDEX")), list(makeSymbol("RET"), list(makeSymbol("CURRENT"), makeSymbol("SELF"))));

    public static final SubLSymbol BASIC_SEQUENCE_ENUMERATOR_PREVIOUS_METHOD = makeSymbol("BASIC-SEQUENCE-ENUMERATOR-PREVIOUS-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE = makeSymbol("BASIC-SEQUENCE");

    public static final SubLList $list87 = list(makeSymbol("SEQUENCE-TEMPLATE"));

    public static final SubLList $list88 = list(new SubLObject[]{ list(makeSymbol("INTERNAL-STORAGE"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("SEQUENCE-CLASS"), makeKeyword("INSTANCE"), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INITIALIZE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT"), list(makeSymbol("STREAM"), makeSymbol("DEPTH")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-INTERNAL-STORAGE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-INTERNAL-STORAGE"), list(makeSymbol("NEW-INTERNAL-STORAGE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CLEAR"), NIL, makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-LENGTH"), NIL, makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-NTH"), list(makeSymbol("N"), makeSymbol("&OPTIONAL"), list(makeSymbol("OUT-OF-RANGE-VALUE"))), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-NTH"), list(makeSymbol("N"), makeSymbol("NEW-VALUE")), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SUBSEQUENCE"), list(makeSymbol("START-INDEX"), makeSymbol("&OPTIONAL"), list(makeSymbol("END-INDEX"), NIL)), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADD"), list(makeSymbol("NEW-ELEMENT")), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-CONTENTS"), NIL, makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SEQUENCE-CLASS"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-SEQUENCE-CLASS"), list(makeSymbol("NEW-CLASS")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOCATE-ENUMERATOR"), NIL, makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DEALLOCATE-ENUMERATOR"), list(makeSymbol("OLD-ENUMERATOR")), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")) });





    public static final SubLString $str91$_DEALLOCATE_ENUMERATOR__S____S_is = makeString("(DEALLOCATE-ENUMERATOR ~S): ~S is not an instance of BASIC-SEQUENCE-ENUMERATOR.");

    public static final SubLSymbol BASIC_SEQUENCE_DEALLOCATE_ENUMERATOR_METHOD = makeSymbol("BASIC-SEQUENCE-DEALLOCATE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_ALLOCATE_ENUMERATOR_METHOD = makeSymbol("BASIC-SEQUENCE-ALLOCATE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_GET_CONTENTS_METHOD = makeSymbol("BASIC-SEQUENCE-GET-CONTENTS-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_ADD_METHOD = makeSymbol("BASIC-SEQUENCE-ADD-METHOD");



    public static final SubLSymbol BASIC_SEQUENCE_GET_SUBSEQUENCE_METHOD = makeSymbol("BASIC-SEQUENCE-GET-SUBSEQUENCE-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_SET_NTH_METHOD = makeSymbol("BASIC-SEQUENCE-SET-NTH-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_GET_NTH_METHOD = makeSymbol("BASIC-SEQUENCE-GET-NTH-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_GET_LENGTH_METHOD = makeSymbol("BASIC-SEQUENCE-GET-LENGTH-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_CLEAR_METHOD = makeSymbol("BASIC-SEQUENCE-CLEAR-METHOD");

    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_BASIC_SEQUENCE_CLASS = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-BASIC-SEQUENCE-CLASS");

    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_BASIC_SEQUENCE_INSTANCE = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-BASIC-SEQUENCE-INSTANCE");

    public static final SubLList $list104 = list(list(makeSymbol("INITIALIZE"), makeSymbol("SUPER")), list(makeSymbol("CSETQ"), makeSymbol("INTERNAL-STORAGE"), NIL), list(makeSymbol("CSETQ"), makeSymbol("SEQUENCE-CLASS"), list(makeSymbol("QUOTE"), makeSymbol("BASIC-SEQUENCE"))), list(makeSymbol("RET"), makeSymbol("SELF")));

    public static final SubLSymbol $sym105$OUTER_CATCH_FOR_BASIC_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_INITIALIZE_METHOD = makeSymbol("BASIC-SEQUENCE-INITIALIZE-METHOD");



    public static final SubLList $list108 = list(makeSymbol("STREAM"), makeSymbol("DEPTH"));

    public static final SubLList $list109 = list(list(makeSymbol("IGNORE"), makeSymbol("DEPTH")), list(makeSymbol("PWHEN"), list(makeSymbol("NULL"), makeSymbol("INTERNAL-STORAGE")), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("[]")), list(makeSymbol("RET"), makeSymbol("SELF"))), list(makeSymbol("PWHEN"), list(makeSymbol("NULL"), list(makeSymbol("CDR"), makeSymbol("INTERNAL-STORAGE"))), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("[~S]"), list(makeSymbol("CAR"), makeSymbol("INTERNAL-STORAGE"))), list(makeSymbol("RET"), makeSymbol("SELF"))), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("[~S"), list(makeSymbol("CAR"), makeSymbol("INTERNAL-STORAGE"))), list(makeSymbol("CDOLIST"), list(makeSymbol("ELEMENT"), list(makeSymbol("CDR"), makeSymbol("INTERNAL-STORAGE"))), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString(", ~S"), makeSymbol("ELEMENT"))), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("]")), list(makeSymbol("RET"), makeSymbol("SELF")));

    public static final SubLSymbol $sym110$OUTER_CATCH_FOR_BASIC_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-METHOD");

    public static final SubLString $str111$__ = makeString("[]");

    public static final SubLString $str112$__S_ = makeString("[~S]");

    public static final SubLString $str113$__S = makeString("[~S");

    public static final SubLString $str114$___S = makeString(", ~S");

    public static final SubLString $str115$_ = makeString("]");

    public static final SubLSymbol BASIC_SEQUENCE_PRINT_METHOD = makeSymbol("BASIC-SEQUENCE-PRINT-METHOD");



    public static final SubLList $list118 = list(list(makeSymbol("RET"), makeSymbol("INTERNAL-STORAGE")));

    public static final SubLSymbol $sym119$OUTER_CATCH_FOR_BASIC_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_GET_INTERNAL_STORAGE_METHOD = makeSymbol("BASIC-SEQUENCE-GET-INTERNAL-STORAGE-METHOD");

    public static final SubLList $list121 = list(makeSymbol("NEW-INTERNAL-STORAGE"));

    public static final SubLList $list122 = list(list(makeSymbol("MUST"), list(makeSymbol("LISTP"), makeSymbol("NEW-INTERNAL-STORAGE")), makeString("(SET-INTERNAL-STORAGE ~S): ~S is not a LIST."), makeSymbol("SELF"), makeSymbol("NEW-INTERNAL-STORAGE")), list(makeSymbol("CSETQ"), makeSymbol("INTERNAL-STORAGE"), makeSymbol("NEW-INTERNAL-STORAGE")), list(makeSymbol("RET"), makeSymbol("NEW-INTERNAL-STORAGE")));

    public static final SubLSymbol $sym123$OUTER_CATCH_FOR_BASIC_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-METHOD");

    public static final SubLString $str124$_SET_INTERNAL_STORAGE__S____S_is_ = makeString("(SET-INTERNAL-STORAGE ~S): ~S is not a LIST.");

    public static final SubLSymbol BASIC_SEQUENCE_SET_INTERNAL_STORAGE_METHOD = makeSymbol("BASIC-SEQUENCE-SET-INTERNAL-STORAGE-METHOD");



    public static final SubLList $list127 = list(list(makeSymbol("RET"), makeSymbol("SEQUENCE-CLASS")));

    public static final SubLSymbol $sym128$OUTER_CATCH_FOR_BASIC_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_SEQUENCE_GET_SEQUENCE_CLASS_METHOD = makeSymbol("BASIC-SEQUENCE-GET-SEQUENCE-CLASS-METHOD");

    public static final SubLSymbol SET_SEQUENCE_CLASS = makeSymbol("SET-SEQUENCE-CLASS");

    public static final SubLList $list131 = list(makeSymbol("NEW-CLASS"));

    public static final SubLList $list132 = list(list(makeSymbol("MUST"), list(makeSymbol("COR"), list(makeSymbol("NULL"), makeSymbol("NEW-CLASS")), list(makeSymbol("CAND"), list(makeSymbol("SYMBOLP"), makeSymbol("NEW-CLASS")), list(makeSymbol("SUBCLASSP"), makeSymbol("NEW-CLASS"), list(makeSymbol("QUOTE"), makeSymbol("BASIC-SEQUENCE"))))), makeString("(SET-SEQUENCE-CLASS ~S): ~S is not a subclass of BASIC-SEQUENCE."), makeSymbol("SELF"), makeSymbol("NEW-CLASS")), list(makeSymbol("CSETQ"), makeSymbol("SEQUENCE-CLASS"), makeSymbol("NEW-CLASS")), list(makeSymbol("RET"), makeSymbol("NEW-CLASS")));

    public static final SubLSymbol $sym133$OUTER_CATCH_FOR_BASIC_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-SEQUENCE-METHOD");

    public static final SubLString $str134$_SET_SEQUENCE_CLASS__S____S_is_no = makeString("(SET-SEQUENCE-CLASS ~S): ~S is not a subclass of BASIC-SEQUENCE.");

    public static final SubLSymbol BASIC_SEQUENCE_SET_SEQUENCE_CLASS_METHOD = makeSymbol("BASIC-SEQUENCE-SET-SEQUENCE-CLASS-METHOD");

    public static final SubLSymbol VARIABLE_LENGTH_SEQUENCE = makeSymbol("VARIABLE-LENGTH-SEQUENCE");

    public static final SubLList $list137 = list(list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-DEFAULT-VALUE"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-DEFAULT-VALUE"), list(makeSymbol("NEW-DEFAULT-VALUE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-GROWTH-FACTOR"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-GROWTH-FACTOR"), list(makeSymbol("NEW-GROWTH-FACTOR")), makeKeyword("PUBLIC")));

    public static final SubLSymbol VARIABLE_LENGTH_SEQUENCE_TEMPLATE = makeSymbol("VARIABLE-LENGTH-SEQUENCE-TEMPLATE");

    public static final SubLList $list139 = list(makeSymbol("VARIABLE-LENGTH-SEQUENCE"));

    public static final SubLList $list140 = list(makeKeyword("EXTENDS"), list(makeSymbol("VARIABLE-LENGTH-SEQUENCE")));

    public static final SubLList $list141 = list(new SubLObject[]{ list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CLEAR"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-LENGTH"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-NTH"), list(makeSymbol("N"), makeSymbol("&OPTIONAL"), list(makeSymbol("OUT-OF-RANGE-VALUE"), NIL)), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-NTH"), list(makeSymbol("N"), makeSymbol("NEW-VALUE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SUBSEQUENCE"), list(makeSymbol("START-INDEX"), makeSymbol("&OPTIONAL"), list(makeSymbol("END-INDEX"), NIL)), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADD"), list(makeSymbol("NEW-ELEMENT")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-INTERNAL-STORAGE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-INTERNAL-STORAGE"), list(makeSymbol("NEW-INTERNAL-STORAGE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-STORAGE-SIZE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-STORAGE-SIZE"), list(makeSymbol("NEW-STORAGE-SIZE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-LARGEST-INDEX"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-LARGEST-INDEX"), list(makeSymbol("NEW-LARGEST-INDEX")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("RECORD-INDEX"), list(makeSymbol("CURRENT-INDEX")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-DEFAULT-VALUE"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-DEFAULT-VALUE"), list(makeSymbol("NEW-DEFAULT-VALUE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-GROWTH-FACTOR"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-GROWTH-FACTOR"), list(makeSymbol("NEW-GROWTH-FACTOR")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOCATE-ENUMERATOR"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DEALLOCATE-ENUMERATOR"), list(makeSymbol("OLD-ENUMERATOR")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALL-NULL-P"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INDEX-OF-NEXT-NON-NIL-ELEMENT"), list(makeSymbol("START-INDEX")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INDEX-OF-PREVIOUS-NON-NIL-ELEMENT"), list(makeSymbol("START-INDEX")), makeKeyword("PUBLIC")) });

    public static final SubLList $list142 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-STORAGE"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF"))), list(makeSymbol("TEMPLATE-SIZE"), list(makeSymbol("GET-STORAGE-SIZE"), makeSymbol("SELF"))), list(makeSymbol("TEMPLATE-DEFAULT-VALUE"), list(makeSymbol("GET-DEFAULT-VALUE"), makeSymbol("SELF")))), list(makeSymbol("CDOTIMES"), list(makeSymbol("TEMPLATE-INDEX"), makeSymbol("TEMPLATE-SIZE")), list(makeSymbol("SET-AREF"), makeSymbol("TEMPLATE-STORAGE"), makeSymbol("TEMPLATE-INDEX"), makeSymbol("TEMPLATE-DEFAULT-VALUE"))), list(makeSymbol("SET-LARGEST-INDEX"), makeSymbol("SELF"), MINUS_ONE_INTEGER), list(makeSymbol("RET"), makeSymbol("TEMPLATE-DEFAULT-VALUE"))));

    public static final SubLList $list143 = list(list(makeSymbol("RET"), list(makeSymbol("+"), list(makeSymbol("GET-LARGEST-INDEX"), makeSymbol("SELF")), ONE_INTEGER)));

    public static final SubLList $list144 = list(makeSymbol("N"), makeSymbol("&OPTIONAL"), list(makeSymbol("OUT-OF-RANGE-VALUE"), NIL));

    public static final SubLList $list145 = list(list(makeSymbol("PWHEN"), list(makeSymbol("COR"), list(makeSymbol("<"), makeSymbol("N"), ZERO_INTEGER), list(makeSymbol(">"), makeSymbol("N"), list(makeSymbol("GET-LARGEST-INDEX"), makeSymbol("SELF")))), list(makeSymbol("RET"), makeSymbol("OUT-OF-RANGE-VALUE"))), list(makeSymbol("RET"), list(makeSymbol("AREF"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF")), makeSymbol("N"))));

    public static final SubLList $list146 = list(list(makeSymbol("MUST"), list(makeSymbol(">="), makeSymbol("N"), ZERO_INTEGER), makeString("(SET-NTH ~S): Index ~S is less than zero.  Only non-negative indices are accepted."), makeSymbol("SELF"), makeSymbol("N")), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-LARGEST-INDEX"), list(makeSymbol("GET-LARGEST-INDEX"), makeSymbol("SELF"))), list(makeSymbol("TEMPLATE-STORAGE-SIZE"), list(makeSymbol("GET-STORAGE-SIZE"), makeSymbol("SELF")))), list(makeSymbol("PIF"), list(makeSymbol(">="), makeSymbol("N"), makeSymbol("TEMPLATE-STORAGE-SIZE")), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-NEW-STORAGE-SIZE"), list(makeSymbol("*"), list(makeSymbol("GET-GROWTH-FACTOR"), makeSymbol("SELF")), makeSymbol("N"))), list(makeSymbol("TEMPLATE-OLD-STORAGE"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF"))), list(makeSymbol("TEMPLATE-DEFAULT-VALUE"), list(makeSymbol("GET-DEFAULT-VALUE"), makeSymbol("SELF"))), list(makeSymbol("TEMPLATE-NEW-STORAGE"), list(makeSymbol("MAKE-VECTOR"), makeSymbol("TEMPLATE-NEW-STORAGE-SIZE"), makeSymbol("TEMPLATE-DEFAULT-VALUE")))), list(makeSymbol("CDOTIMES"), list(makeSymbol("TEMPLATE-INDEX"), list(makeSymbol("+"), makeSymbol("TEMPLATE-LARGEST-INDEX"), ONE_INTEGER)), list(makeSymbol("SET-AREF"), makeSymbol("TEMPLATE-NEW-STORAGE"), makeSymbol("TEMPLATE-INDEX"), list(makeSymbol("AREF"), makeSymbol("TEMPLATE-OLD-STORAGE"), makeSymbol("TEMPLATE-INDEX")))), list(makeSymbol("RECORD-INDEX"), makeSymbol("SELF"), makeSymbol("N")), list(makeSymbol("SET-INTERNAL-STORAGE"), makeSymbol("SELF"), makeSymbol("TEMPLATE-NEW-STORAGE")), list(makeSymbol("SET-STORAGE-SIZE"), makeSymbol("SELF"), makeSymbol("TEMPLATE-NEW-STORAGE-SIZE")), list(makeSymbol("SET-AREF"), makeSymbol("TEMPLATE-NEW-STORAGE"), makeSymbol("N"), makeSymbol("NEW-VALUE"))), list(makeSymbol("PROGN"), list(makeSymbol("RECORD-INDEX"), makeSymbol("SELF"), makeSymbol("N")), list(makeSymbol("SET-AREF"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF")), makeSymbol("N"), makeSymbol("NEW-VALUE")))), list(makeSymbol("RET"), makeSymbol("NEW-VALUE"))));

    public static final SubLList $list147 = list(list(makeSymbol("MUST"), list(makeSymbol(">="), makeSymbol("START-INDEX"), ZERO_INTEGER), makeString("(GET-SUBSEQUENCE ~S): Index ~S is less than zero.  Only non-negative indices are accepted."), makeSymbol("SELF"), makeSymbol("START-INDEX")), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-LENGTH"), list(makeSymbol("GET-LENGTH"), makeSymbol("SELF")))), list(makeSymbol("PUNLESS"), makeSymbol("END-INDEX"), list(makeSymbol("CSETQ"), makeSymbol("END-INDEX"), makeSymbol("TEMPLATE-LENGTH"))), list(makeSymbol("MUST"), list(makeSymbol("<="), makeSymbol("END-INDEX"), makeSymbol("TEMPLATE-LENGTH")), makeString("(GET-SUBSEQUENCE ~S): End index ~S exceeds the length ~S of this sequence."), makeSymbol("END-INDEX"), makeSymbol("TEMPLATE-LENGTH")), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-CLASS"), list(makeSymbol("GET-SEQUENCE-CLASS"), makeSymbol("SELF"))), list(makeSymbol("TEMPLATE-INSTANCE"), list(makeSymbol("NEW-OBJECT-INSTANCE"), makeSymbol("TEMPLATE-CLASS"))), list(makeSymbol("TEMPLATE-ORIGINAL-INDEX"), makeSymbol("START-INDEX")), list(makeSymbol("TEMPLATE-INDEX-COUNT"), list(makeSymbol("-"), makeSymbol("END-INDEX"), makeSymbol("START-INDEX")))), list(makeSymbol("CDOTIMES"), list(makeSymbol("TEMPLATE-INDEX"), makeSymbol("TEMPLATE-INDEX-COUNT")), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("TEMPLATE-INSTANCE"), list(makeSymbol("QUOTE"), makeSymbol("SET-NTH")), makeSymbol("TEMPLATE-INDEX"), list(makeSymbol("GET-NTH"), makeSymbol("SELF"), makeSymbol("TEMPLATE-ORIGINAL-INDEX"))), list(makeSymbol("CINC"), makeSymbol("TEMPLATE-ORIGINAL-INDEX"))), list(makeSymbol("RET"), makeSymbol("TEMPLATE-INSTANCE")))));

    public static final SubLList $list148 = list(list(makeSymbol("RET"), list(makeSymbol("SET-NTH"), makeSymbol("SELF"), list(makeSymbol("+"), list(makeSymbol("GET-LARGEST-INDEX"), makeSymbol("SELF")), ONE_INTEGER), makeSymbol("NEW-ELEMENT"))));

    public static final SubLList $list149 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-ENUMERATOR"), list(makeSymbol("NEW-CLASS-INSTANCE"), list(makeSymbol("QUOTE"), makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR"))))), list(makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SET-SEQUENCE-METHOD"), makeSymbol("TEMPLATE-ENUMERATOR"), makeSymbol("SELF")), list(makeSymbol("RET"), makeSymbol("TEMPLATE-ENUMERATOR"))));

    public static final SubLList $list150 = list(list(makeSymbol("MUST"), list(makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-P"), makeSymbol("OLD-ENUMERATOR")), makeString("(DEALLOCATE-ENUMERATOR ~S): ~S is not an instance BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR."), makeSymbol("SELF"), makeSymbol("OLD-ENUMERATOR")), list(makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SET-SEQUENCE-METHOD"), makeSymbol("OLD-ENUMERATOR"), NIL), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol ALL_NULL_P = makeSymbol("ALL-NULL-P");

    public static final SubLList $list152 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-STORAGE"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF"))), list(makeSymbol("TEMPLATE-LENGTH"), list(makeSymbol("GET-LENGTH"), makeSymbol("SELF")))), list(makeSymbol("CDOTIMES"), list(makeSymbol("TEMPLATE-INDEX"), makeSymbol("TEMPLATE-LENGTH")), list(makeSymbol("PWHEN"), list(makeSymbol("AREF"), makeSymbol("TEMPLATE-STORAGE"), makeSymbol("TEMPLATE-INDEX")), list(makeSymbol("RET"), NIL))), list(makeSymbol("RET"), T)));



    public static final SubLList $list154 = list(makeSymbol("START-INDEX"));

    public static final SubLList $list155 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-INTERNAL-STORAGE"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF")))), list(makeSymbol("PUNLESS"), makeSymbol("TEMPLATE-INTERNAL-STORAGE"), list(makeSymbol("RET"), NIL)), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-LENGTH"), list(makeSymbol("GET-LENGTH"), makeSymbol("SELF")))), list(makeSymbol("PWHEN"), list(makeSymbol("ZEROP"), makeSymbol("TEMPLATE-LENGTH")), list(makeSymbol("RET"), NIL)), list(makeSymbol("PWHEN"), list(makeSymbol(">="), makeSymbol("START-INDEX"), makeSymbol("TEMPLATE-LENGTH")), list(makeSymbol("RET"), NIL)), list(makeSymbol("CSETQ"), makeSymbol("START-INDEX"), list(makeSymbol("MIN"), list(makeSymbol("MAX"), makeSymbol("START-INDEX"), ZERO_INTEGER), list(makeSymbol("-"), makeSymbol("TEMPLATE-LENGTH"), ONE_INTEGER))), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-INDEX"), makeSymbol("START-INDEX"))), list(makeSymbol("WHILE"), list(makeSymbol("<"), makeSymbol("TEMPLATE-INDEX"), makeSymbol("TEMPLATE-LENGTH")), list(makeSymbol("PWHEN"), list(makeSymbol("AREF"), makeSymbol("TEMPLATE-INTERNAL-STORAGE"), makeSymbol("TEMPLATE-INDEX")), list(makeSymbol("RET"), makeSymbol("TEMPLATE-INDEX"))), list(makeSymbol("CINC"), makeSymbol("TEMPLATE-INDEX"))), list(makeSymbol("RET"), NIL)))));

    public static final SubLSymbol INDEX_OF_PREVIOUS_NON_NIL_ELEMENT = makeSymbol("INDEX-OF-PREVIOUS-NON-NIL-ELEMENT");

    public static final SubLList $list157 = list(list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-INTERNAL-STORAGE"), list(makeSymbol("GET-INTERNAL-STORAGE"), makeSymbol("SELF")))), list(makeSymbol("PUNLESS"), makeSymbol("TEMPLATE-INTERNAL-STORAGE"), list(makeSymbol("RET"), NIL)), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-LENGTH"), list(makeSymbol("GET-LENGTH"), makeSymbol("SELF")))), list(makeSymbol("PWHEN"), list(makeSymbol("ZEROP"), makeSymbol("TEMPLATE-LENGTH")), list(makeSymbol("RET"), NIL)), list(makeSymbol("CSETQ"), makeSymbol("START-INDEX"), list(makeSymbol("MIN"), list(makeSymbol("MAX"), makeSymbol("START-INDEX"), ZERO_INTEGER), list(makeSymbol("-"), makeSymbol("TEMPLATE-LENGTH"), ONE_INTEGER))), list(makeSymbol("CLET"), list(list(makeSymbol("TEMPLATE-INDEX"), makeSymbol("START-INDEX"))), list(makeSymbol("WHILE"), list(makeSymbol(">="), makeSymbol("TEMPLATE-INDEX"), ZERO_INTEGER), list(makeSymbol("PWHEN"), list(makeSymbol("AREF"), makeSymbol("TEMPLATE-INTERNAL-STORAGE"), makeSymbol("TEMPLATE-INDEX")), list(makeSymbol("RET"), makeSymbol("TEMPLATE-INDEX"))), list(makeSymbol("CDEC"), makeSymbol("TEMPLATE-INDEX"))), list(makeSymbol("RET"), NIL)))));

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR");
    ...
    public static final SubLSymbol $sym162$SUBLOOP_RESERVED_INITIALIZE_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMER = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-CLASS");

    public static final SubLSymbol $sym163$SUBLOOP_RESERVED_INITIALIZE_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMER = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-INSTANCE");

    public static final SubLList $list164 = list(list(makeSymbol("INITIALIZE"), makeSymbol("SUPER")), list(makeSymbol("CSETQ"), makeSymbol("SEQUENCE"), NIL), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("IGNORE-NULL-VALUES"), T), list(makeSymbol("RET"), makeSymbol("SELF")));

    public static final SubLSymbol $sym165$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_INITIALIZE_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-INITIALIZE-METHOD");

    public static final SubLSymbol SEEK_NON_NULL_FORWARD = makeSymbol("SEEK-NON-NULL-FORWARD");

    public static final SubLList $list168 = list(list(makeSymbol("CLET"), list(list(makeSymbol("CURRENT-LENGTH"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("LENGTH"))))), list(makeSymbol("PWHEN"), list(makeSymbol(">="), makeSymbol("CURRENT-INDEX"), makeSymbol("CURRENT-LENGTH")), list(makeSymbol("RET"), NIL)), list(makeSymbol("CLET"), list(list(makeSymbol("INDEX"), makeSymbol("CURRENT-INDEX"))), list(makeSymbol("WHILE"), list(makeSymbol("<"), makeSymbol("INDEX"), makeSymbol("CURRENT-LENGTH")), list(makeSymbol("PWHEN"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("GET-NTH")), makeSymbol("INDEX")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), makeSymbol("INDEX")), list(makeSymbol("RET"), T)), list(makeSymbol("CINC"), makeSymbol("INDEX"))), list(makeSymbol("RET"), NIL))));

    public static final SubLSymbol $sym169$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol $sym170$BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_SEEK_NON_NULL_FORWARD_M = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SEEK-NON-NULL-FORWARD-METHOD");

    public static final SubLSymbol SEEK_NON_NULL_BACKWARD = makeSymbol("SEEK-NON-NULL-BACKWARD");

    public static final SubLList $list172 = list(list(makeSymbol("PWHEN"), list(makeSymbol("="), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("RET"), NIL)), list(makeSymbol("CLET"), list(list(makeSymbol("INDEX"), makeSymbol("CURRENT-INDEX"))), list(makeSymbol("WHILE"), list(makeSymbol(">="), makeSymbol("INDEX"), ZERO_INTEGER), list(makeSymbol("PWHEN"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("GET-NTH")), makeSymbol("INDEX")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), makeSymbol("INDEX")), list(makeSymbol("RET"), T)), list(makeSymbol("CDEC"), makeSymbol("INDEX"))), list(makeSymbol("RET"), NIL)));

    public static final SubLSymbol $sym173$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol $sym174$BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_SEEK_NON_NULL_BACKWARD_ = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SEEK-NON-NULL-BACKWARD-METHOD");

    public static final SubLSymbol SET_SEQUENCE = makeSymbol("SET-SEQUENCE");

    public static final SubLList $list176 = list(makeSymbol("NEW-SEQUENCE"));

    public static final SubLList $list177 = list(list(makeSymbol("MUST"), list(makeSymbol("COR"), list(makeSymbol("NULL"), makeSymbol("NEW-SEQUENCE")), list(makeSymbol("VARIABLE-LENGTH-SEQUENCE-TEMPLATE-P"), makeSymbol("NEW-SEQUENCE"))), makeString("(SET-SEQUENCE ~S): ~S is not an instance of a class that implements VARIABLE-LENGTH-SEQUENCE-TEMPLATE."), makeSymbol("SELF"), makeSymbol("NEW-SEQUENCE")), list(makeSymbol("CSETQ"), makeSymbol("SEQUENCE"), makeSymbol("NEW-SEQUENCE")), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("RET"), makeSymbol("SELF")));

    public static final SubLSymbol $sym178$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLString $str179$_SET_SEQUENCE__S____S_is_not_an_i = makeString("(SET-SEQUENCE ~S): ~S is not an instance of a class that implements VARIABLE-LENGTH-SEQUENCE-TEMPLATE.");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_SET_SEQUENCE_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SET-SEQUENCE-METHOD");

    public static final SubLSymbol GET_IGNORE_NULL_VALUES = makeSymbol("GET-IGNORE-NULL-VALUES");

    public static final SubLList $list182 = list(makeKeyword("READ-ONLY"), makeKeyword("PUBLIC"));

    public static final SubLList $list183 = list(list(makeSymbol("RET"), makeSymbol("IGNORE-NULL-VALUES")));

    public static final SubLSymbol $sym184$BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_GET_IGNORE_NULL_VALUES_ = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-GET-IGNORE-NULL-VALUES-METHOD");

    public static final SubLSymbol SET_IGNORE_NULL_VALUES = makeSymbol("SET-IGNORE-NULL-VALUES");

    public static final SubLList $list186 = list(makeSymbol("NEW-VALUE"));

    public static final SubLList $list187 = list(list(makeSymbol("CSETQ"), makeSymbol("IGNORE-NULL-VALUES"), list(makeSymbol("FIF"), makeSymbol("NEW-VALUE"), T, NIL)), list(makeSymbol("RET"), makeSymbol("IGNORE-NULL-VALUES")));

    public static final SubLSymbol $sym188$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol $sym189$BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_SET_IGNORE_NULL_VALUES_ = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SET-IGNORE-NULL-VALUES-METHOD");

    public static final SubLList $list190 = list(list(makeSymbol("PUNLESS"), makeSymbol("SEQUENCE"), list(makeSymbol("RET"), T)), list(makeSymbol("PIF"), makeSymbol("IGNORE-NULL-VALUES"), list(makeSymbol("RET"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("ALL-NULL-P")))), list(makeSymbol("RET"), list(makeSymbol("="), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("GET-LENGTH"))), ZERO_INTEGER))));

    public static final SubLSymbol $sym191$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_EMPTY_P_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-EMPTY-P-METHOD");

    public static final SubLList $list193 = list(list(makeSymbol("PUNLESS"), makeSymbol("SEQUENCE"), list(makeSymbol("RET"), NIL)), list(makeSymbol("PIF"), makeSymbol("IGNORE-NULL-VALUES"), list(makeSymbol("RET"), list(makeSymbol("="), makeSymbol("CURRENT-INDEX"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("INDEX-OF-NEXT-NON-NIL-ELEMENT")), ZERO_INTEGER))), list(makeSymbol("RET"), list(makeSymbol("="), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER))));

    public static final SubLSymbol $sym194$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_FIRST_P_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-FIRST-P-METHOD");

    public static final SubLList $list196 = list(list(makeSymbol("PUNLESS"), makeSymbol("SEQUENCE"), list(makeSymbol("RET"), NIL)), list(makeSymbol("CLET"), list(list(makeSymbol("LENGTH"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("GET-LENGTH"))))), list(makeSymbol("PIF"), makeSymbol("IGNORE-NULL-VALUES"), list(makeSymbol("RET"), list(makeSymbol("="), makeSymbol("CURRENT-INDEX"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("INDEX-OF-PREVIOUS-NON-NIL-ELEMENT")), makeSymbol("LENGTH")))), list(makeSymbol("RET"), list(makeSymbol("="), makeSymbol("CURRENT-INDEX"), list(makeSymbol("-"), makeSymbol("LENGTH"), ONE_INTEGER))))));

    public static final SubLSymbol $sym197$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_LAST_P_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-LAST-P-METHOD");

    public static final SubLList $list199 = list(list(makeSymbol("PUNLESS"), makeSymbol("SEQUENCE"), list(makeSymbol("RET"), NIL)), list(makeSymbol("CLET"), list(list(makeSymbol("LENGTH"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("GET-LENGTH"))))), list(makeSymbol("PWHEN"), list(makeSymbol("CAND"), list(makeSymbol(">="), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("<"), makeSymbol("CURRENT-INDEX"), makeSymbol("LENGTH"))), list(makeSymbol("RET"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("GET-NTH")), makeSymbol("CURRENT-INDEX"))))), list(makeSymbol("RET"), NIL));

    public static final SubLSymbol $sym200$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_CURRENT_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-CURRENT-METHOD");

    public static final SubLList $list202 = list(list(makeSymbol("PIF"), makeSymbol("IGNORE-NULL-VALUES"), list(makeSymbol("CLET"), list(list(makeSymbol("FIRST-INDEX"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("INDEX-OF-NEXT-NON-NIL-ELEMENT")), ZERO_INTEGER))), list(makeSymbol("PIF"), makeSymbol("FIRST-INDEX"), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), makeSymbol("FIRST-INDEX")), list(makeSymbol("RET"), list(makeSymbol("CURRENT"), makeSymbol("SELF")))), list(makeSymbol("RET"), NIL))), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("RET"), list(makeSymbol("CURRENT"), makeSymbol("SELF"))))));

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_FIRST_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-FIRST-METHOD");

    public static final SubLList $list204 = list(list(makeSymbol("PUNLESS"), makeSymbol("SEQUENCE"), list(makeSymbol("RET"), NIL)), list(makeSymbol("CLET"), list(list(makeSymbol("LENGTH"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("GET-LENGTH"))))), list(makeSymbol("PIF"), makeSymbol("IGNORE-NULL-VALUES"), list(makeSymbol("CLET"), list(list(makeSymbol("LAST-INDEX"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("INDEX-OF-PREVIOUS-NON-NIL-ELEMENT")), makeSymbol("LENGTH")))), list(makeSymbol("PIF"), makeSymbol("LAST-INDEX"), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), makeSymbol("LAST-INDEX")), list(makeSymbol("RET"), list(makeSymbol("CURRENT"), makeSymbol("SELF")))), list(makeSymbol("RET"), NIL))), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), list(makeSymbol("-"), makeSymbol("LENGTH"), ONE_INTEGER)), list(makeSymbol("RET"), list(makeSymbol("CURRENT"), makeSymbol("SELF")))))));

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_LAST_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-LAST-METHOD");

    public static final SubLList $list206 = list(list(makeSymbol("PUNLESS"), makeSymbol("SEQUENCE"), list(makeSymbol("RET"), NIL)), list(makeSymbol("CLET"), list(list(makeSymbol("LENGTH"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("GET-LENGTH"))))), list(makeSymbol("PWHEN"), list(makeSymbol(">="), makeSymbol("CURRENT-INDEX"), makeSymbol("LENGTH")), list(makeSymbol("RET"), NIL)), list(makeSymbol("PIF"), makeSymbol("IGNORE-NULL-VALUES"), list(makeSymbol("CLET"), list(list(makeSymbol("NEXT-INDEX"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("INDEX-OF-NEXT-NON-NIL-ELEMENT")), list(makeSymbol("+"), makeSymbol("CURRENT-INDEX"), ONE_INTEGER)))), list(makeSymbol("PIF"), makeSymbol("NEXT-INDEX"), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), makeSymbol("NEXT-INDEX")), list(makeSymbol("RET"), list(makeSymbol("CURRENT"), makeSymbol("SELF")))), list(makeSymbol("RET"), NIL))), list(makeSymbol("PROGN"), list(makeSymbol("CINC"), makeSymbol("CURRENT-INDEX")), list(makeSymbol("RET"), list(makeSymbol("CURRENT"), makeSymbol("SELF")))))));

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_NEXT_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-NEXT-METHOD");

    public static final SubLList $list208 = list(list(makeSymbol("PUNLESS"), makeSymbol("SEQUENCE"), list(makeSymbol("RET"), NIL)), list(makeSymbol("PWHEN"), list(makeSymbol("<="), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER), list(makeSymbol("RET"), NIL)), list(makeSymbol("PIF"), makeSymbol("IGNORE-NULL-VALUES"), list(makeSymbol("CLET"), list(list(makeSymbol("PREVIOUS-INDEX"), list(makeSymbol("FUNCALL-INSTANCE-METHOD"), makeSymbol("SEQUENCE"), list(makeSymbol("QUOTE"), makeSymbol("INDEX-OF-PREVIOUS-NON-NIL-ELEMENT")), list(makeSymbol("-"), makeSymbol("CURRENT-INDEX"), ONE_INTEGER)))), list(makeSymbol("PIF"), makeSymbol("PREVIOUS-INDEX"), list(makeSymbol("PROGN"), list(makeSymbol("CSETQ"), makeSymbol("CURRENT-INDEX"), makeSymbol("PREVIOUS-INDEX")), list(makeSymbol("RET"), list(makeSymbol("CURRENT"), makeSymbol("SELF")))), list(makeSymbol("RET"), NIL))), list(makeSymbol("PROGN"), list(makeSymbol("CDEC"), makeSymbol("CURRENT-INDEX")), list(makeSymbol("RET"), list(makeSymbol("CURRENT"), makeSymbol("SELF"))))));

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ENUMERATOR_PREVIOUS_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-PREVIOUS-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE");

    public static final SubLList $list211 = list(makeSymbol("VARIABLE-LENGTH-SEQUENCE-TEMPLATE"));

    public static final SubLList $list212 = list(new SubLObject[]{ list(makeSymbol("INTERNAL-STORAGE"), makeKeyword("INSTANCE"), makeKeyword("PRIVATE")), list(makeSymbol("STORAGE-SIZE"), makeKeyword("INSTANCE"), makeKeyword("PRIVATE")), list(makeSymbol("LARGEST-INDEX"), makeKeyword("INSTANCE"), makeKeyword("PRIVATE")), list(makeSymbol("DEFAULT-VALUE"), makeKeyword("INSTANCE"), makeKeyword("PRIVATE")), list(makeSymbol("GROWTH-FACTOR"), makeKeyword("INSTANCE"), makeKeyword("PRIVATE")), list(makeSymbol("SEQUENCE-CLASS"), makeKeyword("INSTANCE"), makeKeyword("PRIVATE")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INITIALIZE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("PRINT"), list(makeSymbol("STREAM"), makeSymbol("DEPTH")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("CLEAR"), NIL, makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-LENGTH"), NIL, makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-NTH"), list(makeSymbol("N"), makeSymbol("&OPTIONAL"), list(makeSymbol("OUT-OF-RANGE-VALUE"), NIL)), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-NTH"), list(makeSymbol("N"), makeSymbol("NEW-VALUE")), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SUBSEQUENCE"), list(makeSymbol("START-INDEX"), makeSymbol("&OPTIONAL"), list(makeSymbol("END-INDEX"), NIL)), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ADD"), list(makeSymbol("NEW-ELEMENT")), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-CONTENTS"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-INTERNAL-STORAGE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-INTERNAL-STORAGE"), list(makeSymbol("NEW-INTERNAL-STORAGE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-STORAGE-SIZE"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-STORAGE-SIZE"), list(makeSymbol("NEW-STORAGE-SIZE")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-LARGEST-INDEX"), NIL, makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-LARGEST-INDEX"), list(makeSymbol("NEW-LARGEST-INDEX")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("RECORD-INDEX"), list(makeSymbol("CURRENT-INDEX")), makeKeyword("PROTECTED")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-DEFAULT-VALUE"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-DEFAULT-VALUE"), list(makeSymbol("NEW-DEFAULT-VALUE")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-GROWTH-FACTOR"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-GROWTH-FACTOR"), list(makeSymbol("NEW-GROWTH-FACTOR")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-SEQUENCE-CLASS"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-SEQUENCE-CLASS"), list(makeSymbol("NEW-CLASS")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALLOCATE-ENUMERATOR"), NIL, makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("DEALLOCATE-ENUMERATOR"), list(makeSymbol("OLD-ENUMERATOR")), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("ALL-NULL-P"), NIL, makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INDEX-OF-NEXT-NON-NIL-ELEMENT"), list(makeSymbol("START-INDEX")), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("INDEX-OF-PREVIOUS-NON-NIL-ELEMENT"), list(makeSymbol("START-INDEX")), makeKeyword("INSTANTIATE-TEMPLATE"), makeKeyword("PUBLIC")) });
    ...
    public static final SubLSymbol $sym217$BASIC_VARIABLE_LENGTH_SEQUENCE_INDEX_OF_PREVIOUS_NON_NIL_ELEMENT_ = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-INDEX-OF-PREVIOUS-NON-NIL-ELEMENT-METHOD");

    public static final SubLSymbol $sym218$BASIC_VARIABLE_LENGTH_SEQUENCE_INDEX_OF_NEXT_NON_NIL_ELEMENT_METH = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-INDEX-OF-NEXT-NON-NIL-ELEMENT-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ALL_NULL_P_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ALL-NULL-P-METHOD");

    public static final SubLString $str220$_DEALLOCATE_ENUMERATOR__S____S_is = makeString("(DEALLOCATE-ENUMERATOR ~S): ~S is not an instance BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR.");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_DEALLOCATE_ENUMERATOR_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-DEALLOCATE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ALLOCATE_ENUMERATOR_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ALLOCATE-ENUMERATOR-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_ADD_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-ADD-METHOD");

    public static final SubLString $str224$_GET_SUBSEQUENCE__S___Index__S_is = makeString("(GET-SUBSEQUENCE ~S): Index ~S is less than zero.  Only non-negative indices are accepted.");

    public static final SubLString $str225$_GET_SUBSEQUENCE__S___End_index__ = makeString("(GET-SUBSEQUENCE ~S): End index ~S exceeds the length ~S of this sequence.");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_GET_SUBSEQUENCE_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-GET-SUBSEQUENCE-METHOD");

    public static final SubLString $str227$_SET_NTH__S___Index__S_is_less_th = makeString("(SET-NTH ~S): Index ~S is less than zero.  Only non-negative indices are accepted.");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_SET_NTH_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-SET-NTH-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_GET_NTH_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-GET-NTH-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_GET_LENGTH_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-GET-LENGTH-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_CLEAR_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-CLEAR-METHOD");

    public static final SubLSymbol SUBLOOP_RESERVED_INITIALIZE_BASIC_VARIABLE_LENGTH_SEQUENCE_CLASS = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-BASIC-VARIABLE-LENGTH-SEQUENCE-CLASS");

    public static final SubLSymbol $sym233$SUBLOOP_RESERVED_INITIALIZE_BASIC_VARIABLE_LENGTH_SEQUENCE_INSTAN = makeSymbol("SUBLOOP-RESERVED-INITIALIZE-BASIC-VARIABLE-LENGTH-SEQUENCE-INSTANCE");

    public static final SubLList $list234 = list(list(makeSymbol("INITIALIZE"), makeSymbol("SUPER")), list(makeSymbol("CSETQ"), makeSymbol("INTERNAL-STORAGE"), list(makeSymbol("MAKE-VECTOR"), TEN_INTEGER, NIL)), list(makeSymbol("CSETQ"), makeSymbol("STORAGE-SIZE"), TEN_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("LARGEST-INDEX"), MINUS_ONE_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("DEFAULT-VALUE"), NIL), list(makeSymbol("CSETQ"), makeSymbol("GROWTH-FACTOR"), TWO_INTEGER), list(makeSymbol("CSETQ"), makeSymbol("SEQUENCE-CLASS"), list(makeSymbol("QUOTE"), makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE"))), list(makeSymbol("RET"), makeSymbol("SELF")));

    public static final SubLSymbol $sym235$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_INITIALIZE_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-INITIALIZE-METHOD");

    public static final SubLList $list237 = list(list(makeSymbol("IGNORE"), makeSymbol("DEPTH")), list(makeSymbol("PUNLESS"), makeSymbol("LARGEST-INDEX"), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("#<BASIC-VARIABLE-LENGTH-SEQUENCE: UNINITIALIZED>")), list(makeSymbol("RET"), makeSymbol("SELF"))), list(makeSymbol("PWHEN"), list(makeSymbol("="), makeSymbol("LARGEST-INDEX"), MINUS_ONE_INTEGER), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("[]")), list(makeSymbol("RET"), makeSymbol("SELF"))), list(makeSymbol("CLET"), list(list(makeSymbol("LENGTH"), list(makeSymbol("+"), makeSymbol("LARGEST-INDEX"), ONE_INTEGER))), list(makeSymbol("PWHEN"), list(makeSymbol("="), makeSymbol("LENGTH"), ZERO_INTEGER), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("[]")), list(makeSymbol("RET"), makeSymbol("SELF"))), list(makeSymbol("PWHEN"), list(makeSymbol("="), makeSymbol("LENGTH"), ONE_INTEGER), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("[~S]"), list(makeSymbol("AREF"), makeSymbol("INTERNAL-STORAGE"), ZERO_INTEGER)), list(makeSymbol("RET"), makeSymbol("SELF"))), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("[~S"), list(makeSymbol("AREF"), makeSymbol("INTERNAL-STORAGE"), ZERO_INTEGER)), list(makeSymbol("CDOTIMES"), list(makeSymbol("I"), makeSymbol("LARGEST-INDEX")), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString(", ~S"), list(makeSymbol("AREF"), makeSymbol("INTERNAL-STORAGE"), list(makeSymbol("+"), makeSymbol("I"), ONE_INTEGER)))), list(makeSymbol("FORMAT"), makeSymbol("STREAM"), makeString("]"))), list(makeSymbol("RET"), makeSymbol("SELF")));

    public static final SubLSymbol $sym238$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLString $str239$__BASIC_VARIABLE_LENGTH_SEQUENCE_ = makeString("#<BASIC-VARIABLE-LENGTH-SEQUENCE: UNINITIALIZED>");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_PRINT_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-PRINT-METHOD");

    public static final SubLSymbol $sym241$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_GET_INTERNAL_STORAGE_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-GET-INTERNAL-STORAGE-METHOD");

    public static final SubLList $list243 = list(list(makeSymbol("PUNLESS"), makeSymbol("INTERNAL-STORAGE"), list(makeSymbol("RET"), NIL)), list(makeSymbol("CLET"), list(list(makeSymbol("LENGTH"), list(makeSymbol("GET-LENGTH"), makeSymbol("SELF"))), list(makeSymbol("ELEMENT"), NIL), list(makeSymbol("CONTENTS"), NIL)), list(makeSymbol("CDOTIMES"), list(makeSymbol("I"), makeSymbol("LENGTH")), list(makeSymbol("CSETQ"), makeSymbol("ELEMENT"), list(makeSymbol("AREF"), makeSymbol("INTERNAL-STORAGE"), makeSymbol("I"))), list(makeSymbol("PWHEN"), makeSymbol("ELEMENT"), list(makeSymbol("CPUSH"), makeSymbol("ELEMENT"), makeSymbol("CONTENTS")))), list(makeSymbol("RET"), list(makeSymbol("NREVERSE"), makeSymbol("CONTENTS")))));

    public static final SubLSymbol $sym244$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_GET_CONTENTS_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-GET-CONTENTS-METHOD");

    public static final SubLList $list246 = list(list(makeSymbol("MUST"), list(makeSymbol("VECTORP"), makeSymbol("NEW-INTERNAL-STORAGE")), makeString("(SET-INTERNAL-STORAGE ~S): ~S is not a vector."), makeSymbol("SELF"), makeSymbol("NEW-INTERNAL-STORAGE")), list(makeSymbol("CSETQ"), makeSymbol("INTERNAL-STORAGE"), makeSymbol("NEW-INTERNAL-STORAGE")), list(makeSymbol("RET"), makeSymbol("NEW-INTERNAL-STORAGE")));

    public static final SubLSymbol $sym247$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLString $str248$_SET_INTERNAL_STORAGE__S____S_is_ = makeString("(SET-INTERNAL-STORAGE ~S): ~S is not a vector.");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_SET_INTERNAL_STORAGE_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-SET-INTERNAL-STORAGE-METHOD");



    public static final SubLList $list251 = list(list(makeSymbol("RET"), makeSymbol("STORAGE-SIZE")));

    public static final SubLSymbol $sym252$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_GET_STORAGE_SIZE_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-GET-STORAGE-SIZE-METHOD");

    public static final SubLSymbol SET_STORAGE_SIZE = makeSymbol("SET-STORAGE-SIZE");

    public static final SubLList $list255 = list(makeSymbol("NEW-STORAGE-SIZE"));

    public static final SubLList $list256 = list(list(makeSymbol("MUST"), list(makeSymbol("CAND"), list(makeSymbol("INTEGERP"), makeSymbol("NEW-STORAGE-SIZE")), list(makeSymbol(">="), makeSymbol("NEW-STORAGE-SIZE"), ZERO_INTEGER)), makeString("(SET-STORAGE-SIZE ~S): ~S is not a valid storage size.  A non-negative integer was expected."), makeSymbol("SELF"), makeSymbol("NEW-STORAGE-SIZE")), list(makeSymbol("CSETQ"), makeSymbol("STORAGE-SIZE"), makeSymbol("NEW-STORAGE-SIZE")), list(makeSymbol("RET"), makeSymbol("NEW-STORAGE-SIZE")));

    public static final SubLSymbol $sym257$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLString $str258$_SET_STORAGE_SIZE__S____S_is_not_ = makeString("(SET-STORAGE-SIZE ~S): ~S is not a valid storage size.  A non-negative integer was expected.");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_SET_STORAGE_SIZE_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-SET-STORAGE-SIZE-METHOD");



    public static final SubLList $list261 = list(list(makeSymbol("RET"), makeSymbol("LARGEST-INDEX")));

    public static final SubLSymbol $sym262$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_GET_LARGEST_INDEX_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-GET-LARGEST-INDEX-METHOD");

    public static final SubLSymbol SET_LARGEST_INDEX = makeSymbol("SET-LARGEST-INDEX");

    public static final SubLList $list265 = list(makeSymbol("NEW-LARGEST-INDEX"));

    public static final SubLList $list266 = list(list(makeSymbol("CSETQ"), makeSymbol("LARGEST-INDEX"), makeSymbol("NEW-LARGEST-INDEX")), list(makeSymbol("RET"), makeSymbol("NEW-LARGEST-INDEX")));

    public static final SubLSymbol $sym267$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_SET_LARGEST_INDEX_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-SET-LARGEST-INDEX-METHOD");



    public static final SubLList $list270 = list(makeSymbol("CURRENT-INDEX"));

    public static final SubLList $list271 = list(list(makeSymbol("MUST"), list(makeSymbol("CAND"), list(makeSymbol("INTEGERP"), makeSymbol("CURRENT-INDEX")), list(makeSymbol(">="), makeSymbol("CURRENT-INDEX"), ZERO_INTEGER)), makeString("(RECORD-INDEX ~S): ~S is not a valid index.  A non-negative integer was expected."), makeSymbol("SELF"), makeSymbol("CURRENT-INDEX")), list(makeSymbol("CSETQ"), makeSymbol("LARGEST-INDEX"), list(makeSymbol("MAX"), makeSymbol("LARGEST-INDEX"), makeSymbol("CURRENT-INDEX"))), list(makeSymbol("RET"), makeSymbol("LARGEST-INDEX")));

    public static final SubLSymbol $sym272$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLString $str273$_RECORD_INDEX__S____S_is_not_a_va = makeString("(RECORD-INDEX ~S): ~S is not a valid index.  A non-negative integer was expected.");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_RECORD_INDEX_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-RECORD-INDEX-METHOD");



    public static final SubLList $list276 = list(list(makeSymbol("RET"), makeSymbol("DEFAULT-VALUE")));

    public static final SubLSymbol $sym277$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_GET_DEFAULT_VALUE_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-GET-DEFAULT-VALUE-METHOD");

    public static final SubLSymbol SET_DEFAULT_VALUE = makeSymbol("SET-DEFAULT-VALUE");

    public static final SubLList $list280 = list(makeSymbol("NEW-DEFAULT-VALUE"));

    public static final SubLList $list281 = list(list(makeSymbol("CSETQ"), makeSymbol("DEFAULT-VALUE"), makeSymbol("NEW-DEFAULT-VALUE")), list(makeSymbol("RET"), makeSymbol("NEW-DEFAULT-VALUE")));

    public static final SubLSymbol $sym282$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_SET_DEFAULT_VALUE_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-SET-DEFAULT-VALUE-METHOD");



    public static final SubLList $list285 = list(list(makeSymbol("RET"), makeSymbol("GROWTH-FACTOR")));

    public static final SubLSymbol $sym286$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_GET_GROWTH_FACTOR_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-GET-GROWTH-FACTOR-METHOD");

    public static final SubLSymbol SET_GROWTH_FACTOR = makeSymbol("SET-GROWTH-FACTOR");

    public static final SubLList $list289 = list(makeSymbol("NEW-GROWTH-FACTOR"));

    public static final SubLList $list290 = list(list(makeSymbol("MUST"), list(makeSymbol("CAND"), list(makeSymbol("NUMBERP"), makeSymbol("NEW-GROWTH-FACTOR")), list(makeSymbol(">"), makeSymbol("NEW-GROWTH-FACTOR"), makeDouble(1.0))), makeString("(SET-GROWTH-FACTOR ~S): ~S is not a valid growth factor.  The growth factor must be a number > 1.0."), makeSymbol("SELF"), makeSymbol("NEW-GROWTH-FACTOR")), list(makeSymbol("CSETQ"), makeSymbol("GROWTH-FACTOR"), makeSymbol("NEW-GROWTH-FACTOR")), list(makeSymbol("RET"), makeSymbol("NEW-GROWTH-FACTOR")));

    public static final SubLSymbol $sym291$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    private static final SubLFloat $float$1_0 = makeDouble(1.0);

    public static final SubLString $str293$_SET_GROWTH_FACTOR__S____S_is_not = makeString("(SET-GROWTH-FACTOR ~S): ~S is not a valid growth factor.  The growth factor must be a number > 1.0.");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_SET_GROWTH_FACTOR_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-SET-GROWTH-FACTOR-METHOD");

    public static final SubLSymbol $sym295$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_GET_SEQUENCE_CLASS_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-GET-SEQUENCE-CLASS-METHOD");

    public static final SubLList $list297 = list(list(makeSymbol("MUST"), list(makeSymbol("COR"), list(makeSymbol("NULL"), makeSymbol("NEW-CLASS")), list(makeSymbol("CAND"), list(makeSymbol("SYMBOLP"), makeSymbol("NEW-CLASS")), list(makeSymbol("SUBCLASSP"), makeSymbol("NEW-CLASS"), list(makeSymbol("QUOTE"), makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE"))))), makeString("(SET-SEQUENCE-CLASS ~S): ~S is not a subclass of BASIC-VARIABLE-LENGTH-SEQUENCE."), makeSymbol("SELF"), makeSymbol("NEW-CLASS")), list(makeSymbol("CSETQ"), makeSymbol("SEQUENCE-CLASS"), makeSymbol("NEW-CLASS")), list(makeSymbol("RET"), makeSymbol("NEW-CLASS")));

    public static final SubLSymbol $sym298$OUTER_CATCH_FOR_BASIC_VARIABLE_LENGTH_SEQUENCE_METHOD = makeUninternedSymbol("OUTER-CATCH-FOR-BASIC-VARIABLE-LENGTH-SEQUENCE-METHOD");

    public static final SubLString $str299$_SET_SEQUENCE_CLASS__S____S_is_no = makeString("(SET-SEQUENCE-CLASS ~S): ~S is not a subclass of BASIC-VARIABLE-LENGTH-SEQUENCE.");

    public static final SubLSymbol BASIC_VARIABLE_LENGTH_SEQUENCE_SET_SEQUENCE_CLASS_METHOD = makeSymbol("BASIC-VARIABLE-LENGTH-SEQUENCE-SET-SEQUENCE-CLASS-METHOD");

    public static final SubLSymbol FIXED_LENGTH_SEQUENCE = makeSymbol("FIXED-LENGTH-SEQUENCE");

    public static final SubLList $list302 = list(list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-LENGTH"), list(makeSymbol("NEW-LENGTH")), makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("GET-DEFAULT-VALUE"), NIL, makeKeyword("PUBLIC")), list(makeSymbol("DEF-INSTANCE-METHOD"), makeSymbol("SET-DEFAULT-VALUE"), list(makeSymbol("NEW-DEFAULT-VALUE")), makeKeyword("PUBLIC")));
    ...
    public static SubLObject declare_subloop_sequences_file() {
        declareFunction(me, "sequence_element_template_p", "SEQUENCE-ELEMENT-TEMPLATE-P", 1, 0, false);
        declareFunction(me, "sequence_p", "SEQUENCE-P", 1, 0, false);
        declareFunction(me, "sequence_template_p", "SEQUENCE-TEMPLATE-P", 1, 0, false);
        declareFunction(me, "get_basic_sequence_enumerator_current_index", "GET-BASIC-SEQUENCE-ENUMERATOR-CURRENT-INDEX", 1, 0, false);
        declareFunction(me, "set_basic_sequence_enumerator_current_index", "SET-BASIC-SEQUENCE-ENUMERATOR-CURRENT-INDEX", 2, 0, false);
        declareFunction(me, "get_basic_sequence_enumerator_length", "GET-BASIC-SEQUENCE-ENUMERATOR-LENGTH", 1, 0, false);
        declareFunction(me, "set_basic_sequence_enumerator_length", "SET-BASIC-SEQUENCE-ENUMERATOR-LENGTH", 2, 0, false);
        declareFunction(me, "get_basic_sequence_enumerator_shared_storage", "GET-BASIC-SEQUENCE-ENUMERATOR-SHARED-STORAGE", 1, 0, false);
        declareFunction(me, "set_basic_sequence_enumerator_shared_storage", "SET-BASIC-SEQUENCE-ENUMERATOR-SHARED-STORAGE", 2, 0, false);
        declareFunction(me, "subloop_reserved_initialize_basic_sequence_enumerator_class", "SUBLOOP-RESERVED-INITIALIZE-BASIC-SEQUENCE-ENUMERATOR-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_basic_sequence_enumerator_instance", "SUBLOOP-RESERVED-INITIALIZE-BASIC-SEQUENCE-ENUMERATOR-INSTANCE", 1, 0, false);
        declareFunction(me, "basic_sequence_enumerator_p", "BASIC-SEQUENCE-ENUMERATOR-P", 1, 0, false);
        declareFunction(me, "basic_sequence_enumerator_initialize_method", "BASIC-SEQUENCE-ENUMERATOR-INITIALIZE-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_enumerator_set_shared_storage_method", "BASIC-SEQUENCE-ENUMERATOR-SET-SHARED-STORAGE-METHOD", 2, 0, false);
        declareFunction(me, "basic_sequence_enumerator_empty_p_method", "BASIC-SEQUENCE-ENUMERATOR-EMPTY-P-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_enumerator_first_p_method", "BASIC-SEQUENCE-ENUMERATOR-FIRST-P-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_enumerator_last_p_method", "BASIC-SEQUENCE-ENUMERATOR-LAST-P-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_enumerator_current_method", "BASIC-SEQUENCE-ENUMERATOR-CURRENT-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_enumerator_first_method", "BASIC-SEQUENCE-ENUMERATOR-FIRST-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_enumerator_last_method", "BASIC-SEQUENCE-ENUMERATOR-LAST-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_enumerator_next_method", "BASIC-SEQUENCE-ENUMERATOR-NEXT-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_enumerator_previous_method", "BASIC-SEQUENCE-ENUMERATOR-PREVIOUS-METHOD", 1, 0, false);
        declareFunction(me, "get_basic_sequence_sequence_class", "GET-BASIC-SEQUENCE-SEQUENCE-CLASS", 1, 0, false);
        declareFunction(me, "set_basic_sequence_sequence_class", "SET-BASIC-SEQUENCE-SEQUENCE-CLASS", 2, 0, false);
        declareFunction(me, "get_basic_sequence_internal_storage", "GET-BASIC-SEQUENCE-INTERNAL-STORAGE", 1, 0, false);
        declareFunction(me, "set_basic_sequence_internal_storage", "SET-BASIC-SEQUENCE-INTERNAL-STORAGE", 2, 0, false);
        declareFunction(me, "basic_sequence_deallocate_enumerator_method", "BASIC-SEQUENCE-DEALLOCATE-ENUMERATOR-METHOD", 2, 0, false);
        declareFunction(me, "basic_sequence_allocate_enumerator_method", "BASIC-SEQUENCE-ALLOCATE-ENUMERATOR-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_get_contents_method", "BASIC-SEQUENCE-GET-CONTENTS-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_add_method", "BASIC-SEQUENCE-ADD-METHOD", 2, 0, false);
        declareFunction(me, "basic_sequence_get_subsequence_method", "BASIC-SEQUENCE-GET-SUBSEQUENCE-METHOD", 2, 1, false);
        declareFunction(me, "basic_sequence_set_nth_method", "BASIC-SEQUENCE-SET-NTH-METHOD", 3, 0, false);
        declareFunction(me, "basic_sequence_get_nth_method", "BASIC-SEQUENCE-GET-NTH-METHOD", 2, 1, false);
        declareFunction(me, "basic_sequence_get_length_method", "BASIC-SEQUENCE-GET-LENGTH-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_clear_method", "BASIC-SEQUENCE-CLEAR-METHOD", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_basic_sequence_class", "SUBLOOP-RESERVED-INITIALIZE-BASIC-SEQUENCE-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_basic_sequence_instance", "SUBLOOP-RESERVED-INITIALIZE-BASIC-SEQUENCE-INSTANCE", 1, 0, false);
        declareFunction(me, "basic_sequence_p", "BASIC-SEQUENCE-P", 1, 0, false);
        declareFunction(me, "basic_sequence_initialize_method", "BASIC-SEQUENCE-INITIALIZE-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_print_method", "BASIC-SEQUENCE-PRINT-METHOD", 3, 0, false);
        declareFunction(me, "basic_sequence_get_internal_storage_method", "BASIC-SEQUENCE-GET-INTERNAL-STORAGE-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_set_internal_storage_method", "BASIC-SEQUENCE-SET-INTERNAL-STORAGE-METHOD", 2, 0, false);
        declareFunction(me, "basic_sequence_get_sequence_class_method", "BASIC-SEQUENCE-GET-SEQUENCE-CLASS-METHOD", 1, 0, false);
        declareFunction(me, "basic_sequence_set_sequence_class_method", "BASIC-SEQUENCE-SET-SEQUENCE-CLASS-METHOD", 2, 0, false);
        declareFunction(me, "variable_length_sequence_p", "VARIABLE-LENGTH-SEQUENCE-P", 1, 0, false);
        declareFunction(me, "variable_length_sequence_template_p", "VARIABLE-LENGTH-SEQUENCE-TEMPLATE-P", 1, 0, false);
        declareFunction(me, "get_basic_variable_length_sequence_enumerator_current_index", "GET-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-CURRENT-INDEX", 1, 0, false);
        declareFunction(me, "set_basic_variable_length_sequence_enumerator_current_index", "SET-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-CURRENT-INDEX", 2, 0, false);
        declareFunction(me, "get_basic_variable_length_sequence_enumerator_sequence", "GET-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SEQUENCE", 1, 0, false);
        declareFunction(me, "set_basic_variable_length_sequence_enumerator_sequence", "SET-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SEQUENCE", 2, 0, false);
        declareFunction(me, "get_basic_variable_length_sequence_enumerator_ignore_null_values", "GET-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-IGNORE-NULL-VALUES", 1, 0, false);
        declareFunction(me, "set_basic_variable_length_sequence_enumerator_ignore_null_values", "SET-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-IGNORE-NULL-VALUES", 2, 0, false);
        declareFunction(me, "subloop_reserved_initialize_basic_variable_length_sequence_enumerator_class", "SUBLOOP-RESERVED-INITIALIZE-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_basic_variable_length_sequence_enumerator_instance", "SUBLOOP-RESERVED-INITIALIZE-BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-INSTANCE", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_p", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-P", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_initialize_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-INITIALIZE-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_seek_non_null_forward_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SEEK-NON-NULL-FORWARD-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_seek_non_null_backward_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SEEK-NON-NULL-BACKWARD-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_set_sequence_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SET-SEQUENCE-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_get_ignore_null_values_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-GET-IGNORE-NULL-VALUES-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_set_ignore_null_values_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-SET-IGNORE-NULL-VALUES-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_empty_p_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-EMPTY-P-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_first_p_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-FIRST-P-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_last_p_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-LAST-P-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_current_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-CURRENT-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_first_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-FIRST-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_last_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-LAST-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_next_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-NEXT-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_enumerator_previous_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ENUMERATOR-PREVIOUS-METHOD", 1, 0, false);
        declareFunction(me, "get_basic_variable_length_sequence_sequence_class", "GET-BASIC-VARIABLE-LENGTH-SEQUENCE-SEQUENCE-CLASS", 1, 0, false);
        declareFunction(me, "set_basic_variable_length_sequence_sequence_class", "SET-BASIC-VARIABLE-LENGTH-SEQUENCE-SEQUENCE-CLASS", 2, 0, false);
        declareFunction(me, "get_basic_variable_length_sequence_growth_factor", "GET-BASIC-VARIABLE-LENGTH-SEQUENCE-GROWTH-FACTOR", 1, 0, false);
        declareFunction(me, "set_basic_variable_length_sequence_growth_factor", "SET-BASIC-VARIABLE-LENGTH-SEQUENCE-GROWTH-FACTOR", 2, 0, false);
        declareFunction(me, "get_basic_variable_length_sequence_default_value", "GET-BASIC-VARIABLE-LENGTH-SEQUENCE-DEFAULT-VALUE", 1, 0, false);
        declareFunction(me, "set_basic_variable_length_sequence_default_value", "SET-BASIC-VARIABLE-LENGTH-SEQUENCE-DEFAULT-VALUE", 2, 0, false);
        declareFunction(me, "get_basic_variable_length_sequence_largest_index", "GET-BASIC-VARIABLE-LENGTH-SEQUENCE-LARGEST-INDEX", 1, 0, false);
        declareFunction(me, "set_basic_variable_length_sequence_largest_index", "SET-BASIC-VARIABLE-LENGTH-SEQUENCE-LARGEST-INDEX", 2, 0, false);
        declareFunction(me, "get_basic_variable_length_sequence_storage_size", "GET-BASIC-VARIABLE-LENGTH-SEQUENCE-STORAGE-SIZE", 1, 0, false);
        declareFunction(me, "set_basic_variable_length_sequence_storage_size", "SET-BASIC-VARIABLE-LENGTH-SEQUENCE-STORAGE-SIZE", 2, 0, false);
        declareFunction(me, "get_basic_variable_length_sequence_internal_storage", "GET-BASIC-VARIABLE-LENGTH-SEQUENCE-INTERNAL-STORAGE", 1, 0, false);
        declareFunction(me, "set_basic_variable_length_sequence_internal_storage", "SET-BASIC-VARIABLE-LENGTH-SEQUENCE-INTERNAL-STORAGE", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_index_of_previous_non_nil_element_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-INDEX-OF-PREVIOUS-NON-NIL-ELEMENT-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_index_of_next_non_nil_element_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-INDEX-OF-NEXT-NON-NIL-ELEMENT-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_all_null_p_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ALL-NULL-P-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_deallocate_enumerator_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-DEALLOCATE-ENUMERATOR-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_allocate_enumerator_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ALLOCATE-ENUMERATOR-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_add_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-ADD-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_get_subsequence_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-GET-SUBSEQUENCE-METHOD", 2, 1, false);
        declareFunction(me, "basic_variable_length_sequence_set_nth_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-SET-NTH-METHOD", 3, 0, false);
        declareFunction(me, "basic_variable_length_sequence_get_nth_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-GET-NTH-METHOD", 2, 1, false);
        declareFunction(me, "basic_variable_length_sequence_get_length_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-GET-LENGTH-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_clear_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-CLEAR-METHOD", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_basic_variable_length_sequence_class", "SUBLOOP-RESERVED-INITIALIZE-BASIC-VARIABLE-LENGTH-SEQUENCE-CLASS", 1, 0, false);
        declareFunction(me, "subloop_reserved_initialize_basic_variable_length_sequence_instance", "SUBLOOP-RESERVED-INITIALIZE-BASIC-VARIABLE-LENGTH-SEQUENCE-INSTANCE", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_p", "BASIC-VARIABLE-LENGTH-SEQUENCE-P", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_initialize_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-INITIALIZE-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_print_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-PRINT-METHOD", 3, 0, false);
        declareFunction(me, "basic_variable_length_sequence_get_internal_storage_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-GET-INTERNAL-STORAGE-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_get_contents_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-GET-CONTENTS-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_set_internal_storage_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-SET-INTERNAL-STORAGE-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_get_storage_size_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-GET-STORAGE-SIZE-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_set_storage_size_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-SET-STORAGE-SIZE-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_get_largest_index_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-GET-LARGEST-INDEX-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_set_largest_index_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-SET-LARGEST-INDEX-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_record_index_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-RECORD-INDEX-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_get_default_value_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-GET-DEFAULT-VALUE-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_set_default_value_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-SET-DEFAULT-VALUE-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_get_growth_factor_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-GET-GROWTH-FACTOR-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_set_growth_factor_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-SET-GROWTH-FACTOR-METHOD", 2, 0, false);
        declareFunction(me, "basic_variable_length_sequence_get_sequence_class_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-GET-SEQUENCE-CLASS-METHOD", 1, 0, false);
        declareFunction(me, "basic_variable_length_sequence_set_sequence_class_method", "BASIC-VARIABLE-LENGTH-SEQUENCE-SET-SEQUENCE-CLASS-METHOD", 2, 0, false);
        declareFunction(me, "fixed_length_sequence_p", "FIXED-LENGTH-SEQUENCE-P", 1, 0, false);
        return NIL;
    }
