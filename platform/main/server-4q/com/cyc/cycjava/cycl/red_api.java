...
public final class red_api extends SubLTranslatedFile {
    ...
    public static SubLObject red_struct_p(final SubLObject v_object) {
        return v_object.getClass() == red_api.$red_struct_native.class ? T : NIL;
    }

    public static SubLObject red_struct_cobj(final SubLObject v_object) {
        assert NIL != red_struct_p(v_object) : "red_api.red_struct_p(v_object) " + "CommonSymbols.NIL != red_api.red_struct_p(v_object) " + v_object;
    ...
    public static SubLObject make_red_struct(SubLObject arglist) {
        ...
        final SubLObject v_new = new red_api.$red_struct_native();
        SubLObject next;
    ...
    public static SubLObject red_repository_struct_p(final SubLObject v_object) {
        return v_object.getClass() == red_api.$red_repository_struct_native.class ? T : NIL;
    }

    public static SubLObject red_repository_struct_filename(final SubLObject v_object) {
        assert NIL != red_repository_struct_p(v_object) : "red_api.red_repository_struct_p(v_object) " + "CommonSymbols.NIL != red_api.red_repository_struct_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_red_repository_struct(SubLObject arglist) {
        ...
        final SubLObject v_new = new red_api.$red_repository_struct_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject red_repository_list_struct_p(final SubLObject v_object) {
        return v_object.getClass() == red_api.$red_repository_list_struct_native.class ? T : NIL;
    }

    public static SubLObject red_repository_list_struct_type(final SubLObject v_object) {
        assert NIL != red_repository_list_struct_p(v_object) : "red_api.red_repository_list_struct_p(v_object) " + "CommonSymbols.NIL != red_api.red_repository_list_struct_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_red_repository_list_struct(SubLObject arglist) {
        ...
        final SubLObject v_new = new red_api.$red_repository_list_struct_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static SubLObject red_element_struct_p(final SubLObject v_object) {
        return v_object.getClass() == red_api.$red_element_struct_native.class ? T : NIL;
    }

    public static SubLObject red_element_struct_repository_list(final SubLObject v_object) {
        assert NIL != red_element_struct_p(v_object) : "red_api.red_element_struct_p(v_object) " + "CommonSymbols.NIL != red_api.red_element_struct_p(v_object) " + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject make_red_element_struct(SubLObject arglist) {
        ...
        final SubLObject v_new = new red_api.$red_element_struct_native();
        SubLObject next;
        SubLObject current_arg;
        SubLObject current_value;
        SubLObject pcase_var;
    ...
    public static final class $red_struct_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(red_api.$red_struct_native.class, RED_STRUCT, RED_STRUCT_P, $list2, $list3, new String[]{ "$cobj" }, $list4, $list5, PRINT_RED_STRUCT);
        }
    }
    ...
    public static final class $red_repository_struct_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(red_api.$red_repository_struct_native.class, RED_REPOSITORY_STRUCT, RED_REPOSITORY_STRUCT_P, $list20, $list21, new String[]{ "$filename" }, $list22, $list23, PRINT_RED_REPOSITORY_STRUCT);
        }
    }
    ...
    public static final class $red_repository_list_struct_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(red_api.$red_repository_list_struct_native.class, RED_REPOSITORY_LIST_STRUCT, RED_REPOSITORY_LIST_STRUCT_P, $list50, $list51, new String[]{ "$type" }, $list52, $list53, PRINT_RED_REPOSITORY_LIST_STRUCT);
        }
    }
    ...
    public static final class $red_element_struct_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(red_api.$red_element_struct_native.class, RED_ELEMENT_STRUCT, RED_ELEMENT_STRUCT_P, $list77, $list78, new String[]{ "$repository_list", "$key_string" }, $list79, $list80, PRINT_RED_ELEMENT_STRUCT);
        }
    }
