...
public final class rkf_scenario_constructor
    extends
      SubLTranslatedFile
{
  ...
  public static SubLObject with_sc_lock(final SubLObject macroform, final SubLObject environment)
  {
    ...
    return ConsesLow.listS( $sym5$WITH_LOCK_HELD, $list6, ConsesLow.append( body, NIL ) );
  }
  ...
  {
    return ( v_object.getClass() == $sc_session_native.class ) ? T : NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/rkf-scenario-constructor.lisp", position = 5512L)
  public static SubLObject sc_session_id(final SubLObject v_object)
  {
    assert NIL != sc_session_p( v_object ) : v_object;
  ...
  public static SubLObject make_sc_session(SubLObject arglist)
  {
    ...
    final SubLObject v_new = new $sc_session_native();
    SubLObject next;
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw40$BEGIN, $sym41$MAKE_SC_SESSION, SEVEN_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw32$ID, sc_session_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw33$STATE, sc_session_state( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw34$PHRASE, sc_session_phrase( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw35$CANDIDATE_SCENARIOS, sc_session_candidate_scenarios( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw36$PERMISSION, sc_session_permission( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw37$SCENARIO, sc_session_scenario( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw38$INTERNAL_STATE, sc_session_internal_state( obj ) );
    Functions.funcall( visitor_fn, obj, $kw43$END, $sym41$MAKE_SC_SESSION, SEVEN_INTEGER );
    return obj;
  }
  ...
  public static SubLObject sc_new_session(final SubLObject state, final SubLObject permission, SubLObject phrase)
  {
    ...
    assert NIL != sc_state_p( state ) : state;
    ...
    try
    {
      release = Locks.seize_lock( $sc_lock$.getGlobalValue() );
    ...
    finally
    {
      if( NIL != release )
      {
        Locks.release_lock( $sc_lock$.getGlobalValue() );
      }
    }
    return session;
  }
  ...
  {
    assert NIL != sc_session_p( session ) : session;
  ...
  public static SubLObject sc_add_session_candidate_scenario(final SubLObject session, final SubLObject v_scenario)
  {
    ...
    {
      release = Locks.seize_lock( $sc_lock$.getGlobalValue() );
      if( NIL == conses_high.member( v_scenario, sc_session_candidate_scenarios( session ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_sc_session_candidate_scenarios( session, ConsesLow.cons( v_scenario, sc_session_candidate_scenarios( session ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject sc_rem_candidate_scenario(final SubLObject session, final SubLObject v_scenario)
  {
    ...
    {
      release = Locks.seize_lock( $sc_lock$.getGlobalValue() );
      _csetf_sc_session_candidate_scenarios( session, Sequences.remove( v_scenario, sc_session_candidate_scenarios( session ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
    }
    finally
    {
      if( NIL != release )
  ...
  {
    return makeBoolean( NIL != sc_session_p( v_object ) && sc_session_permission( v_object ) == $kw50$EDIT );
  }
  ...
  {
    return makeBoolean( NIL != sc_session_p( v_object ) && sc_session_permission( v_object ) == $kw51$VIEW );
  }
  ...
  {
    return ( v_object.getClass() == $sc_state_native.class ) ? T : NIL;
  }

  @SubLTranslatedFile.SubL(source = "cycl/rkf-scenario-constructor.lisp", position = 9142L)
  public static SubLObject sc_state_id(final SubLObject v_object)
  {
    assert NIL != sc_state_p( v_object ) : v_object;
    return v_object.getField2();
  }
  ...
  public static SubLObject make_sc_state(SubLObject arglist)
  {
    ...
    final SubLObject v_new = new $sc_state_native();
    SubLObject next;
    SubLObject current_arg;
    SubLObject current_value;
    SubLObject pcase_var;
  ...
  {
    Functions.funcall( visitor_fn, obj, $kw40$BEGIN, $sym96$MAKE_SC_STATE, THIRTEEN_INTEGER );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw32$ID, sc_state_id( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw85$INTERACTION, sc_state_interaction( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw86$ACTIVE_SESSION, sc_state_active_session( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw87$CONSTRUCTION_SESSIONS, sc_state_construction_sessions( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw88$BROWSING_SESSIONS, sc_state_browsing_sessions( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw89$MERGE_INFO, sc_state_merge_info( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw90$PARSING_MT, sc_state_parsing_mt( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw91$GENERATION_MT, sc_state_generation_mt( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw92$DOMAIN_MT, sc_state_domain_mt( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw93$DOMAIN_INTERACTION_MT, sc_state_domain_interaction_mt( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw94$SCENARIO_INTERACTION_MT, sc_state_scenario_interaction_mt( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw95$GEN_POINTS, sc_state_gen_points( obj ) );
    Functions.funcall( visitor_fn, obj, $kw42$SLOT, $kw33$STATE, sc_state_state( obj ) );
    Functions.funcall( visitor_fn, obj, $kw43$END, $sym96$MAKE_SC_STATE, THIRTEEN_INTEGER );
    return obj;
  }
  ...
  {
    assert NIL != sc_state_p( state ) : state;
    assert NIL != sc_construction_session_p( session ) : session;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $sc_lock$.getGlobalValue() );
      if( NIL == conses_high.member( session, sc_state_construction_sessions( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_sc_state_construction_sessions( state, ConsesLow.cons( session, sc_state_construction_sessions( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject retire_sc_us_construction_session(final SubLObject state, final SubLObject session)
  {
    ...
    {
      release = Locks.seize_lock( $sc_lock$.getGlobalValue() );
      _csetf_sc_state_construction_sessions( state, Sequences.remove( session, sc_state_construction_sessions( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
  ...
  {
    assert NIL != sc_state_p( state ) : state;
    assert NIL != sc_browsing_session_p( session ) : session;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $sc_lock$.getGlobalValue() );
      if( NIL == conses_high.member( session, sc_state_browsing_sessions( state ), Symbols.symbol_function( EQL ), Symbols.symbol_function( IDENTITY ) ) )
      {
        _csetf_sc_state_browsing_sessions( state, ConsesLow.cons( session, sc_state_browsing_sessions( state ) ) );
      }
    }
    finally
    {
  ...
  public static SubLObject retire_sc_us_browsing_session(final SubLObject state, final SubLObject session)
  {
    ...
    {
      release = Locks.seize_lock( $sc_lock$.getGlobalValue() );
      _csetf_sc_state_browsing_sessions( state, Sequences.remove( session, sc_state_browsing_sessions( state ), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED ) );
      sc_cleanup_session( session );
    }
    finally
    {
  ...
  {
    assert NIL != sc_state_p( state ) : state;
    assert NIL != rkf_scenario_manipulator.sm_merge_info_p( merge_info ) : merge_info;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $sc_lock$.getGlobalValue() );
  ...
  public static SubLObject initialize_sc_state_mts(final SubLObject state)
  {
    ...
    try
    {
      ...
      else
      {
        ...
        _csetf_sc_state_scenario_interaction_mt( state, $const2$ScenarioDescriptionMt );
      }
    }
    finally
    {
  ...
  {
    assert NIL != sc_state_p( state ) : state;
    assert NIL != Types.listp( gen_points ) : gen_points;
    SubLObject release = NIL;
    try
    {
      release = Locks.seize_lock( $sc_lock$.getGlobalValue() );
  ...
  {
    final SubLObject interaction = sc_state_interaction( state );
    final SubLObject act = user_interaction_agenda.ui_state_lookup( interaction, $kw103$SC_ACT, UNPROVIDED );
    if( NIL != act )
    {
      return act;
    }
    ...
    {
      return $kw105$GENERALIZE;
    }
    if( NIL != user_interaction_agenda.ui_state_lookup( interaction, $kw106$CONSTRAINT_SENTENCE, NIL ) )
    {
      return $kw107$PARSE_CONSTRAINT;
    }
    if( NIL != user_interaction_agenda.ui_state_lookup( interaction, $kw108$INDEXICAL_PHRASE, NIL ) )
    {
      return $kw109$PARSE_TERM;
    }
    if( NIL != user_interaction_agenda.ui_state_lookup( interaction, $kw110$SCENARIO_PHRASE, NIL ) )
    {
      return $kw111$PARSE_SCENARIO;
    }
    if( NIL == sc_state_active_session( state ) )
    {
      return $kw112$OPEN;
    }
    return $kw113$CONSTRUCT;
  }
  ...
  {
    return sc_state_update( sc_state, $kw114$LIMITATIONS, limitations );
  }
  ...
  {
    return sc_state_lookup( sc_state, $kw114$LIMITATIONS, $rkf_sc_state_empty_limitations$.getGlobalValue() );
  }
  ...
  public static SubLObject sc_concept_harvester(final SubLObject string, final SubLObject category, final SubLObject syntactic_mt)
  {
    ...
    try
    {
      rkf_concept_harvester.$rkf_ch_template_parses_method$.bind( $sym115$SC_ITP_SEQUEL, thread );
  ...
  public static SubLObject sc_act_initialize_construction_session(final SubLObject state, SubLObject phrase)
  {
    ...
    final SubLObject session = sc_new_session( state, $kw50$EDIT, phrase );
  ...
  public static SubLObject sc_act_suggest_scenarios(final SubLObject state, final SubLObject phrase)
  {
    ...
    if( NIL != scenario_expression )
    {
      ...
      return ConsesLow.list( v_scenario );
    }
    return NIL;
  }
  ...
  {
    sc_session_state_clear( session, $kw116$INDEXICAL_TABLE );
    final SubLObject v_scenario = sc_session_scenario( session );
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != el_utilities.el_formula_p( v_isa ) )
      {
        v_isa = narts_high.find_nart( v_isa );
      }
      indexical_isas = ConsesLow.cons( v_isa, indexical_isas );
      cdolist_list_var = cdolist_list_var.rest();
      v_isa = cdolist_list_var.first();
    }
    ...
    while ( NIL != cdolist_list_var)
    {
      if( NIL != el_utilities.el_formula_p( genl ) )
      {
        genl = narts_high.find_nart( genl );
      }
      indexical_genls = ConsesLow.cons( genl, indexical_genls );
      cdolist_list_var = cdolist_list_var.rest();
      genl = cdolist_list_var.first();
    }
  ...
  public static SubLObject sc_act_add_new_indexical(final SubLObject session, final SubLObject indexical_phrase, SubLObject indexical_isa, SubLObject indexical_genls)
  {
    sc_session_state_clear( session, $kw116$INDEXICAL_TABLE );
    final SubLObject v_scenario = sc_session_scenario( session );
    if( NIL != el_utilities.el_formula_p( indexical_isa ) )
    {
      indexical_isa = narts_high.find_nart( indexical_isa );
    }
    if( NIL != el_utilities.el_formula_p( indexical_genls ) )
    {
  ...
  {
    SubLObject indexical_table = sc_session_state_lookup( session, $kw116$INDEXICAL_TABLE, UNPROVIDED );
    if( NIL == indexical_table )
    {
      final SubLObject v_scenario = sc_session_scenario( session );
      indexical_table = rkf_scenario_manipulator.sm_act_construct_indexical_table( v_scenario );
      sc_session_state_update( session, $kw116$INDEXICAL_TABLE, indexical_table );
    }
  ...
  {
    assert NIL != el_utilities.el_formula_p( cycl_sentence ) : cycl_sentence;
    final SubLObject session = sc_state_active_session( state );
    final SubLObject v_scenario = sc_session_scenario( session );
    final SubLObject domain_mt = sc_state_domain_interaction_mt( state );
  ...
  public static SubLObject sc_act_generalize_scenario(final SubLObject state, final SubLObject v_scenario)
  {
    ...
    gen_points = Sequences.remove_if( Symbols.symbol_function( $sym120$SM_GEN_POINT_WITHOUT_POSITIONS_P ), gen_points, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED );
  ...
  {
    SubLFiles.declareFunction( me, "sc_parsing_mt", "SC-PARSING-MT", 0, 0, false );
    SubLFiles.declareFunction( me, "sc_semantic_mt", "SC-SEMANTIC-MT", 0, 0, false );
    SubLFiles.declareFunction( me, "sc_storage_mt", "SC-STORAGE-MT", 0, 0, false );
    SubLFiles.declareFunction( me, "sc_generation_mt", "SC-GENERATION-MT", 0, 0, false );
    SubLFiles.declareMacro( me, "with_sc_lock", "WITH-SC-LOCK" );
    SubLFiles.declareFunction( me, "sc_find_session_by_id", "SC-FIND-SESSION-BY-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_find_session_by_id_string", "SC-FIND-SESSION-BY-ID-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_find_state_by_id", "SC-FIND-STATE-BY-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_find_state_by_id_string", "SC-FIND-STATE-BY-ID-STRING", 1, 0, false );
    SubLFiles.declareFunction( me, "next_sc_id", "NEXT-SC-ID", 0, 0, false );
    SubLFiles.declareFunction( me, "sc_add_object", "SC-ADD-OBJECT", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_rem_object", "SC-REM-OBJECT", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_find_object_by_id", "SC-FIND-OBJECT-BY-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_session_print_function_trampoline", "SC-SESSION-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_session_p", "SC-SESSION-P", 1, 0, false );
    new $sc_session_p$UnaryFunction();
    SubLFiles.declareFunction( me, "sc_session_id", "SC-SESSION-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_session_state", "SC-SESSION-STATE", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_session_phrase", "SC-SESSION-PHRASE", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_session_candidate_scenarios", "SC-SESSION-CANDIDATE-SCENARIOS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_session_permission", "SC-SESSION-PERMISSION", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_session_scenario", "SC-SESSION-SCENARIO", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_session_internal_state", "SC-SESSION-INTERNAL-STATE", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_session_id", "_CSETF-SC-SESSION-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_session_state", "_CSETF-SC-SESSION-STATE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_session_phrase", "_CSETF-SC-SESSION-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_session_candidate_scenarios", "_CSETF-SC-SESSION-CANDIDATE-SCENARIOS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_session_permission", "_CSETF-SC-SESSION-PERMISSION", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_session_scenario", "_CSETF-SC-SESSION-SCENARIO", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_session_internal_state", "_CSETF-SC-SESSION-INTERNAL-STATE", 2, 0, false );
    SubLFiles.declareFunction( me, "make_sc_session", "MAKE-SC-SESSION", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_sc_session", "VISIT-DEFSTRUCT-SC-SESSION", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_sc_session_method", "VISIT-DEFSTRUCT-OBJECT-SC-SESSION-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_new_session", "SC-NEW-SESSION", 2, 1, false );
    SubLFiles.declareFunction( me, "sc_set_session_phrase", "SC-SET-SESSION-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_set_session_permission", "SC-SET-SESSION-PERMISSION", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_add_session_candidate_scenarios", "SC-ADD-SESSION-CANDIDATE-SCENARIOS", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_add_session_candidate_scenario", "SC-ADD-SESSION-CANDIDATE-SCENARIO", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_rem_candidate_scenario", "SC-REM-CANDIDATE-SCENARIO", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_set_session_scenario", "SC-SET-SESSION-SCENARIO", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_construction_session_p", "SC-CONSTRUCTION-SESSION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_browsing_session_p", "SC-BROWSING-SESSION-P", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_cleanup_session", "SC-CLEANUP-SESSION", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_session_state_lookup", "SC-SESSION-STATE-LOOKUP", 2, 1, false );
    SubLFiles.declareFunction( me, "sc_session_state_update", "SC-SESSION-STATE-UPDATE", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_session_state_clear", "SC-SESSION-STATE-CLEAR", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_state_print_function_trampoline", "SC-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_state_p", "SC-STATE-P", 1, 0, false );
    new $sc_state_p$UnaryFunction();
    SubLFiles.declareFunction( me, "sc_state_id", "SC-STATE-ID", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_interaction", "SC-STATE-INTERACTION", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_active_session", "SC-STATE-ACTIVE-SESSION", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_construction_sessions", "SC-STATE-CONSTRUCTION-SESSIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_browsing_sessions", "SC-STATE-BROWSING-SESSIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_merge_info", "SC-STATE-MERGE-INFO", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_parsing_mt", "SC-STATE-PARSING-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_generation_mt", "SC-STATE-GENERATION-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_domain_mt", "SC-STATE-DOMAIN-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_domain_interaction_mt", "SC-STATE-DOMAIN-INTERACTION-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_scenario_interaction_mt", "SC-STATE-SCENARIO-INTERACTION-MT", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_gen_points", "SC-STATE-GEN-POINTS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_state", "SC-STATE-STATE", 1, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_id", "_CSETF-SC-STATE-ID", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_interaction", "_CSETF-SC-STATE-INTERACTION", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_active_session", "_CSETF-SC-STATE-ACTIVE-SESSION", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_construction_sessions", "_CSETF-SC-STATE-CONSTRUCTION-SESSIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_browsing_sessions", "_CSETF-SC-STATE-BROWSING-SESSIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_merge_info", "_CSETF-SC-STATE-MERGE-INFO", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_parsing_mt", "_CSETF-SC-STATE-PARSING-MT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_generation_mt", "_CSETF-SC-STATE-GENERATION-MT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_domain_mt", "_CSETF-SC-STATE-DOMAIN-MT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_domain_interaction_mt", "_CSETF-SC-STATE-DOMAIN-INTERACTION-MT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_scenario_interaction_mt", "_CSETF-SC-STATE-SCENARIO-INTERACTION-MT", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_gen_points", "_CSETF-SC-STATE-GEN-POINTS", 2, 0, false );
    SubLFiles.declareFunction( me, "_csetf_sc_state_state", "_CSETF-SC-STATE-STATE", 2, 0, false );
    SubLFiles.declareFunction( me, "make_sc_state", "MAKE-SC-STATE", 0, 1, false );
    SubLFiles.declareFunction( me, "visit_defstruct_sc_state", "VISIT-DEFSTRUCT-SC-STATE", 2, 0, false );
    SubLFiles.declareFunction( me, "visit_defstruct_object_sc_state_method", "VISIT-DEFSTRUCT-OBJECT-SC-STATE-METHOD", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_new_state", "SC-NEW-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "cleanup_sc_state", "CLEANUP-SC-STATE", 1, 0, false );
    SubLFiles.declareFunction( me, "note_sc_state_interaction", "NOTE-SC-STATE-INTERACTION", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_add_us_construction_session", "SC-ADD-US-CONSTRUCTION-SESSION", 2, 0, false );
    SubLFiles.declareFunction( me, "retire_sc_us_construction_session", "RETIRE-SC-US-CONSTRUCTION-SESSION", 2, 0, false );
    SubLFiles.declareFunction( me, "deactivate_and_retire_sc_us_construction_session", "DEACTIVATE-AND-RETIRE-SC-US-CONSTRUCTION-SESSION", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_add_us_browsing_session", "SC-ADD-US-BROWSING-SESSION", 2, 0, false );
    SubLFiles.declareFunction( me, "retire_sc_us_browsing_session", "RETIRE-SC-US-BROWSING-SESSION", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_activate_session", "SC-ACTIVATE-SESSION", 2, 0, false );
    SubLFiles.declareFunction( me, "deactivate_active_sc_session", "DEACTIVATE-ACTIVE-SC-SESSION", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_set_state_merge_info", "SC-SET-STATE-MERGE-INFO", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_rem_state_merge_info", "SC-REM-STATE-MERGE-INFO", 1, 0, false );
    SubLFiles.declareFunction( me, "initialize_sc_state_mts", "INITIALIZE-SC-STATE-MTS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_set_state_gen_points", "SC-SET-STATE-GEN-POINTS", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_clear_state_gen_points", "SC-CLEAR-STATE-GEN-POINTS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_active_scenario", "SC-STATE-ACTIVE-SCENARIO", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_active_scenario_incomplete", "SC-STATE-ACTIVE-SCENARIO-INCOMPLETE", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_current_act", "SC-STATE-CURRENT-ACT", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_update", "SC-STATE-UPDATE", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_state_lookup", "SC-STATE-LOOKUP", 2, 1, false );
    SubLFiles.declareFunction( me, "sc_state_clear", "SC-STATE-CLEAR", 2, 0, false );
    SubLFiles.declareFunction( me, "rkf_sc_new_limitations", "RKF-SC-NEW-LIMITATIONS", 0, 0, false );
    SubLFiles.declareFunction( me, "rkf_sc_add_limitation", "RKF-SC-ADD-LIMITATION", 3, 0, false );
    SubLFiles.declareFunction( me, "rkf_sc_get_limitation", "RKF-SC-GET-LIMITATION", 2, 1, false );
    SubLFiles.declareFunction( me, "sc_state_note_limitations", "SC-STATE-NOTE-LIMITATIONS", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_state_get_limitations", "SC-STATE-GET-LIMITATIONS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_concept_harvester", "SC-CONCEPT-HARVESTER", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_itp_sequel", "SC-ITP-SEQUEL", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_act_new_state", "SC-ACT-NEW-STATE", 0, 0, false );
    SubLFiles.declareFunction( me, "sc_act_initialize_scenario", "SC-ACT-INITIALIZE-SCENARIO", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_act_new_state_with_phrase", "SC-ACT-NEW-STATE-WITH-PHRASE", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_act_initialize_construction_session", "SC-ACT-INITIALIZE-CONSTRUCTION-SESSION", 1, 1, false );
    SubLFiles.declareFunction( me, "sc_act_new_state_with_construction_scenario", "SC-ACT-NEW-STATE-WITH-CONSTRUCTION-SCENARIO", 1, 1, false );
    SubLFiles.declareFunction( me, "sc_act_set_session_scenario", "SC-ACT-SET-SESSION-SCENARIO", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_read_scenario", "SC-ACT-READ-SCENARIO", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_act_suggest_scenarios", "SC-ACT-SUGGEST-SCENARIOS", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_determine_scenario_expression", "SC-ACT-DETERMINE-SCENARIO-EXPRESSION", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_initialize_scenario_from_expression", "SC-ACT-INITIALIZE-SCENARIO-FROM-EXPRESSION", 2, 1, false );
    SubLFiles.declareFunction( me, "sc_determine_scenario_expression_int", "SC-DETERMINE-SCENARIO-EXPRESSION-INT", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_act_suggest_new_indexical_type", "SC-ACT-SUGGEST-NEW-INDEXICAL-TYPE", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_add_new_indexical_multiple", "SC-ACT-ADD-NEW-INDEXICAL-MULTIPLE", 4, 0, false );
    SubLFiles.declareFunction( me, "sc_act_add_new_indexical", "SC-ACT-ADD-NEW-INDEXICAL", 4, 0, false );
    SubLFiles.declareFunction( me, "sc_act_find_indexical", "SC-ACT-FIND-INDEXICAL", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_remove_indexical", "SC-ACT-REMOVE-INDEXICAL", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_suggest_differences", "SC-ACT-SUGGEST-DIFFERENCES", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_distinguish_indexicals", "SC-ACT-DISTINGUISH-INDEXICALS", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_act_add_indexical_phrase", "SC-ACT-ADD-INDEXICAL-PHRASE", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_act_remove_indexical_phrase", "SC-ACT-REMOVE-INDEXICAL-PHRASE", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_act_remove_isaXgenls_constraint", "SC-ACT-REMOVE-ISA/GENLS-CONSTRAINT", 4, 1, false );
    SubLFiles.declareFunction( me, "sc_act_suggest_new_constraint", "SC-ACT-SUGGEST-NEW-CONSTRAINT", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_add_new_constraint", "SC-ACT-ADD-NEW-CONSTRAINT", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_remove_constraint", "SC-ACT-REMOVE-CONSTRAINT", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_remove_all_constraints", "SC-ACT-REMOVE-ALL-CONSTRAINTS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_act_import_constraint", "SC-ACT-IMPORT-CONSTRAINT", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_modify_phrase", "SC-ACT-MODIFY-PHRASE", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_construct_indexical_table", "SC-ACT-CONSTRUCT-INDEXICAL-TABLE", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_act_constraint_record_nl_sentence", "SC-ACT-CONSTRAINT-RECORD-NL-SENTENCE", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_act_propose_sentence_adjustment", "SC-ACT-PROPOSE-SENTENCE-ADJUSTMENT", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_merge_register_from_scenario", "SC-ACT-MERGE-REGISTER-FROM-SCENARIO", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_merge_register_to_scenario", "SC-ACT-MERGE-REGISTER-TO-SCENARIO", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_merge_register_align_to", "SC-ACT-MERGE-REGISTER-ALIGN-TO", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_merge_register_align_from", "SC-ACT-MERGE-REGISTER-ALIGN-FROM", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_merge_update_indexical_equivalences", "SC-ACT-MERGE-UPDATE-INDEXICAL-EQUIVALENCES", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_act_abandon_merge", "SC-ACT-ABANDON-MERGE", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_act_merge_scenarios", "SC-ACT-MERGE-SCENARIOS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_state_merge_from_scenario", "SC-STATE-MERGE-FROM-SCENARIO", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_indexical_record_alignedP", "SC-INDEXICAL-RECORD-ALIGNED?", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_generalize_scenario", "SC-ACT-GENERALIZE-SCENARIO", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_save_scenario", "SC-ACT-SAVE-SCENARIO", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_act_enumerate_saved_scenarios", "SC-ACT-ENUMERATE-SAVED-SCENARIOS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_act_discard_template", "SC-ACT-DISCARD-TEMPLATE", 3, 0, false );
    SubLFiles.declareFunction( me, "sc_act_compute_unused_indexicals", "SC-ACT-COMPUTE-UNUSED-INDEXICALS", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_act_discard_session", "SC-ACT-DISCARD-SESSION", 1, 0, false );
    SubLFiles.declareFunction( me, "sc_act_activate_session", "SC-ACT-ACTIVATE-SESSION", 2, 0, false );
    SubLFiles.declareFunction( me, "sc_act_set_indexical_record_var", "SC-ACT-SET-INDEXICAL-RECORD-VAR", 2, 0, false );
    return NIL;
  }

  public static SubLObject init_rkf_scenario_constructor_file()
  {
    $sc_parsing_mt$ = SubLFiles.defparameter( "*SC-PARSING-MT*", $const0$EBertTemplateMt );
    $sc_semantic_mt$ = SubLFiles.defparameter( "*SC-SEMANTIC-MT*", $const1$MassMediaMt );
    $sc_storage_mt$ = SubLFiles.defparameter( "*SC-STORAGE-MT*", $const2$ScenarioDescriptionMt );
    $sc_generation_mt$ = SubLFiles.defparameter( "*SC-GENERATION-MT*", $const3$EnglishParaphraseMt );
    $sc_lock$ = SubLFiles.deflexical( "*SC-LOCK*", Locks.make_lock( $str4$Scenario_Constructor_Lock ) );
    $sc_isg$ = SubLFiles.deflexical( "*SC-ISG*", maybeDefault( $sym7$_SC_ISG_, $sc_isg$, () -> ( integer_sequence_generator.new_integer_sequence_generator( UNPROVIDED, UNPROVIDED, UNPROVIDED ) ) ) );
    $sc_index$ = SubLFiles.deflexical( "*SC-INDEX*", maybeDefault( $sym8$_SC_INDEX_, $sc_index$, () -> ( dictionary.new_dictionary( UNPROVIDED, UNPROVIDED ) ) ) );
    $dtp_sc_session$ = SubLFiles.defconstant( "*DTP-SC-SESSION*", $sym9$SC_SESSION );
    $dtp_sc_state$ = SubLFiles.defconstant( "*DTP-SC-STATE*", $sym52$SC_STATE );
    $rkf_sc_state_empty_limitations$ = SubLFiles.deflexical( "*RKF-SC-STATE-EMPTY-LIMITATIONS*", rkf_sc_new_limitations() );
    $sc_rtp_category$ = SubLFiles.defparameter( "*SC-RTP-CATEGORY*", NIL );
    $sc_rtp_syntactic_mt$ = SubLFiles.defparameter( "*SC-RTP-SYNTACTIC-MT*", NIL );
    return NIL;
  }

  public static SubLObject setup_rkf_scenario_constructor_file()
  {
    subl_macro_promotions.declare_defglobal( $sym7$_SC_ISG_ );
    subl_macro_promotions.declare_defglobal( $sym8$_SC_INDEX_ );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_sc_session$.getGlobalValue(), Symbols.symbol_function( $sym16$SC_SESSION_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list17 );
    Structures.def_csetf( $sym18$SC_SESSION_ID, $sym19$_CSETF_SC_SESSION_ID );
    Structures.def_csetf( $sym20$SC_SESSION_STATE, $sym21$_CSETF_SC_SESSION_STATE );
    Structures.def_csetf( $sym22$SC_SESSION_PHRASE, $sym23$_CSETF_SC_SESSION_PHRASE );
    Structures.def_csetf( $sym24$SC_SESSION_CANDIDATE_SCENARIOS, $sym25$_CSETF_SC_SESSION_CANDIDATE_SCENARIOS );
    Structures.def_csetf( $sym26$SC_SESSION_PERMISSION, $sym27$_CSETF_SC_SESSION_PERMISSION );
    Structures.def_csetf( $sym28$SC_SESSION_SCENARIO, $sym29$_CSETF_SC_SESSION_SCENARIO );
    Structures.def_csetf( $sym30$SC_SESSION_INTERNAL_STATE, $sym31$_CSETF_SC_SESSION_INTERNAL_STATE );
    Equality.identity( $sym9$SC_SESSION );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_sc_session$.getGlobalValue(), Symbols.symbol_function( $sym44$VISIT_DEFSTRUCT_OBJECT_SC_SESSION_METHOD ) );
    Structures.register_method( print_high.$print_object_method_table$.getGlobalValue(), $dtp_sc_state$.getGlobalValue(), Symbols.symbol_function( $sym57$SC_STATE_PRINT_FUNCTION_TRAMPOLINE ) );
    SubLSpecialOperatorDeclarations.proclaim( $list58 );
    Structures.def_csetf( $sym59$SC_STATE_ID, $sym60$_CSETF_SC_STATE_ID );
    Structures.def_csetf( $sym61$SC_STATE_INTERACTION, $sym62$_CSETF_SC_STATE_INTERACTION );
    Structures.def_csetf( $sym63$SC_STATE_ACTIVE_SESSION, $sym64$_CSETF_SC_STATE_ACTIVE_SESSION );
    Structures.def_csetf( $sym65$SC_STATE_CONSTRUCTION_SESSIONS, $sym66$_CSETF_SC_STATE_CONSTRUCTION_SESSIONS );
    Structures.def_csetf( $sym67$SC_STATE_BROWSING_SESSIONS, $sym68$_CSETF_SC_STATE_BROWSING_SESSIONS );
    Structures.def_csetf( $sym69$SC_STATE_MERGE_INFO, $sym70$_CSETF_SC_STATE_MERGE_INFO );
    Structures.def_csetf( $sym71$SC_STATE_PARSING_MT, $sym72$_CSETF_SC_STATE_PARSING_MT );
    Structures.def_csetf( $sym73$SC_STATE_GENERATION_MT, $sym74$_CSETF_SC_STATE_GENERATION_MT );
    Structures.def_csetf( $sym75$SC_STATE_DOMAIN_MT, $sym76$_CSETF_SC_STATE_DOMAIN_MT );
    Structures.def_csetf( $sym77$SC_STATE_DOMAIN_INTERACTION_MT, $sym78$_CSETF_SC_STATE_DOMAIN_INTERACTION_MT );
    Structures.def_csetf( $sym79$SC_STATE_SCENARIO_INTERACTION_MT, $sym80$_CSETF_SC_STATE_SCENARIO_INTERACTION_MT );
    Structures.def_csetf( $sym81$SC_STATE_GEN_POINTS, $sym82$_CSETF_SC_STATE_GEN_POINTS );
    Structures.def_csetf( $sym83$SC_STATE_STATE, $sym84$_CSETF_SC_STATE_STATE );
    Equality.identity( $sym52$SC_STATE );
    Structures.register_method( visitation.$visit_defstruct_object_method_table$.getGlobalValue(), $dtp_sc_state$.getGlobalValue(), Symbols.symbol_function( $sym97$VISIT_DEFSTRUCT_OBJECT_SC_STATE_METHOD ) );
    return NIL;
  }
  ...
  static
  {
    me = new rkf_scenario_constructor();
    $sc_parsing_mt$ = null;
    $sc_semantic_mt$ = null;
    $sc_storage_mt$ = null;
    $sc_generation_mt$ = null;
    $sc_lock$ = null;
    $sc_isg$ = null;
    $sc_index$ = null;
    $dtp_sc_session$ = null;
    $dtp_sc_state$ = null;
    $rkf_sc_state_empty_limitations$ = null;
    $sc_rtp_category$ = null;
    $sc_rtp_syntactic_mt$ = null;
    $const0$EBertTemplateMt = constant_handles.reader_make_constant_shell( makeString( "EBertTemplateMt" ) );
    $const1$MassMediaMt = constant_handles.reader_make_constant_shell( makeString( "MassMediaMt" ) );
    $const2$ScenarioDescriptionMt = constant_handles.reader_make_constant_shell( makeString( "ScenarioDescriptionMt" ) );
    $const3$EnglishParaphraseMt = constant_handles.reader_make_constant_shell( makeString( "EnglishParaphraseMt" ) );
    $str4$Scenario_Constructor_Lock = makeString( "Scenario Constructor Lock" );
    $sym5$WITH_LOCK_HELD = makeSymbol( "WITH-LOCK-HELD" );
    $list6 = ConsesLow.list( makeSymbol( "*SC-LOCK*" ) );
    $sym7$_SC_ISG_ = makeSymbol( "*SC-ISG*" );
    $sym8$_SC_INDEX_ = makeSymbol( "*SC-INDEX*" );
    $sym9$SC_SESSION = makeSymbol( "SC-SESSION" );
    $sym10$SC_SESSION_P = makeSymbol( "SC-SESSION-P" );
    $list11 = ConsesLow.list( makeSymbol( "ID" ), makeSymbol( "STATE" ), makeSymbol( "PHRASE" ), makeSymbol( "CANDIDATE-SCENARIOS" ), makeSymbol( "PERMISSION" ), makeSymbol( "SCENARIO" ), makeSymbol(
        "INTERNAL-STATE" ) );
    $list12 = ConsesLow.list( makeKeyword( "ID" ), makeKeyword( "STATE" ), makeKeyword( "PHRASE" ), makeKeyword( "CANDIDATE-SCENARIOS" ), makeKeyword( "PERMISSION" ), makeKeyword( "SCENARIO" ), makeKeyword(
        "INTERNAL-STATE" ) );
    $list13 = ConsesLow.list( makeSymbol( "SC-SESSION-ID" ), makeSymbol( "SC-SESSION-STATE" ), makeSymbol( "SC-SESSION-PHRASE" ), makeSymbol( "SC-SESSION-CANDIDATE-SCENARIOS" ), makeSymbol( "SC-SESSION-PERMISSION" ),
        makeSymbol( "SC-SESSION-SCENARIO" ), makeSymbol( "SC-SESSION-INTERNAL-STATE" ) );
    $list14 = ConsesLow.list( makeSymbol( "_CSETF-SC-SESSION-ID" ), makeSymbol( "_CSETF-SC-SESSION-STATE" ), makeSymbol( "_CSETF-SC-SESSION-PHRASE" ), makeSymbol( "_CSETF-SC-SESSION-CANDIDATE-SCENARIOS" ), makeSymbol(
        "_CSETF-SC-SESSION-PERMISSION" ), makeSymbol( "_CSETF-SC-SESSION-SCENARIO" ), makeSymbol( "_CSETF-SC-SESSION-INTERNAL-STATE" ) );
    $sym15$DEFAULT_STRUCT_PRINT_FUNCTION = makeSymbol( "DEFAULT-STRUCT-PRINT-FUNCTION" );
    $sym16$SC_SESSION_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "SC-SESSION-PRINT-FUNCTION-TRAMPOLINE" );
    $list17 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "SC-SESSION-P" ) );
    $sym18$SC_SESSION_ID = makeSymbol( "SC-SESSION-ID" );
    $sym19$_CSETF_SC_SESSION_ID = makeSymbol( "_CSETF-SC-SESSION-ID" );
    $sym20$SC_SESSION_STATE = makeSymbol( "SC-SESSION-STATE" );
    $sym21$_CSETF_SC_SESSION_STATE = makeSymbol( "_CSETF-SC-SESSION-STATE" );
    $sym22$SC_SESSION_PHRASE = makeSymbol( "SC-SESSION-PHRASE" );
    $sym23$_CSETF_SC_SESSION_PHRASE = makeSymbol( "_CSETF-SC-SESSION-PHRASE" );
    $sym24$SC_SESSION_CANDIDATE_SCENARIOS = makeSymbol( "SC-SESSION-CANDIDATE-SCENARIOS" );
    $sym25$_CSETF_SC_SESSION_CANDIDATE_SCENARIOS = makeSymbol( "_CSETF-SC-SESSION-CANDIDATE-SCENARIOS" );
    $sym26$SC_SESSION_PERMISSION = makeSymbol( "SC-SESSION-PERMISSION" );
    $sym27$_CSETF_SC_SESSION_PERMISSION = makeSymbol( "_CSETF-SC-SESSION-PERMISSION" );
    $sym28$SC_SESSION_SCENARIO = makeSymbol( "SC-SESSION-SCENARIO" );
    $sym29$_CSETF_SC_SESSION_SCENARIO = makeSymbol( "_CSETF-SC-SESSION-SCENARIO" );
    $sym30$SC_SESSION_INTERNAL_STATE = makeSymbol( "SC-SESSION-INTERNAL-STATE" );
    $sym31$_CSETF_SC_SESSION_INTERNAL_STATE = makeSymbol( "_CSETF-SC-SESSION-INTERNAL-STATE" );
    $kw32$ID = makeKeyword( "ID" );
    $kw33$STATE = makeKeyword( "STATE" );
    $kw34$PHRASE = makeKeyword( "PHRASE" );
    $kw35$CANDIDATE_SCENARIOS = makeKeyword( "CANDIDATE-SCENARIOS" );
    $kw36$PERMISSION = makeKeyword( "PERMISSION" );
    $kw37$SCENARIO = makeKeyword( "SCENARIO" );
    $kw38$INTERNAL_STATE = makeKeyword( "INTERNAL-STATE" );
    $str39$Invalid_slot__S_for_construction_ = makeString( "Invalid slot ~S for construction function" );
    $kw40$BEGIN = makeKeyword( "BEGIN" );
    $sym41$MAKE_SC_SESSION = makeSymbol( "MAKE-SC-SESSION" );
    $kw42$SLOT = makeKeyword( "SLOT" );
    $kw43$END = makeKeyword( "END" );
    $sym44$VISIT_DEFSTRUCT_OBJECT_SC_SESSION_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-SC-SESSION-METHOD" );
    $sym45$SC_STATE_P = makeSymbol( "SC-STATE-P" );
    $sym46$STRINGP = makeSymbol( "STRINGP" );
    $list47 = ConsesLow.list( makeKeyword( "EDIT" ), makeKeyword( "VIEW" ) );
    $str48$Error___a_is_not_a_known_scenario = makeString( "Error: ~a is not a known scenario construction permission type." );
    $sym49$SM_SCENARIO_P = makeSymbol( "SM-SCENARIO-P" );
    $kw50$EDIT = makeKeyword( "EDIT" );
    $kw51$VIEW = makeKeyword( "VIEW" );
    $sym52$SC_STATE = makeSymbol( "SC-STATE" );
    $list53 = ConsesLow.list( new SubLObject[] { makeSymbol( "ID" ), makeSymbol( "INTERACTION" ), makeSymbol( "ACTIVE-SESSION" ), makeSymbol( "CONSTRUCTION-SESSIONS" ), makeSymbol( "BROWSING-SESSIONS" ), makeSymbol(
        "MERGE-INFO" ), makeSymbol( "PARSING-MT" ), makeSymbol( "GENERATION-MT" ), makeSymbol( "DOMAIN-MT" ), makeSymbol( "DOMAIN-INTERACTION-MT" ), makeSymbol( "SCENARIO-INTERACTION-MT" ), makeSymbol( "GEN-POINTS" ),
      makeSymbol( "STATE" )
    } );
    $list54 = ConsesLow.list( new SubLObject[] { makeKeyword( "ID" ), makeKeyword( "INTERACTION" ), makeKeyword( "ACTIVE-SESSION" ), makeKeyword( "CONSTRUCTION-SESSIONS" ), makeKeyword( "BROWSING-SESSIONS" ),
      makeKeyword( "MERGE-INFO" ), makeKeyword( "PARSING-MT" ), makeKeyword( "GENERATION-MT" ), makeKeyword( "DOMAIN-MT" ), makeKeyword( "DOMAIN-INTERACTION-MT" ), makeKeyword( "SCENARIO-INTERACTION-MT" ), makeKeyword(
          "GEN-POINTS" ), makeKeyword( "STATE" )
    } );
    $list55 = ConsesLow.list( new SubLObject[] { makeSymbol( "SC-STATE-ID" ), makeSymbol( "SC-STATE-INTERACTION" ), makeSymbol( "SC-STATE-ACTIVE-SESSION" ), makeSymbol( "SC-STATE-CONSTRUCTION-SESSIONS" ), makeSymbol(
        "SC-STATE-BROWSING-SESSIONS" ), makeSymbol( "SC-STATE-MERGE-INFO" ), makeSymbol( "SC-STATE-PARSING-MT" ), makeSymbol( "SC-STATE-GENERATION-MT" ), makeSymbol( "SC-STATE-DOMAIN-MT" ), makeSymbol(
            "SC-STATE-DOMAIN-INTERACTION-MT" ), makeSymbol( "SC-STATE-SCENARIO-INTERACTION-MT" ), makeSymbol( "SC-STATE-GEN-POINTS" ), makeSymbol( "SC-STATE-STATE" )
    } );
    $list56 = ConsesLow.list( new SubLObject[] { makeSymbol( "_CSETF-SC-STATE-ID" ), makeSymbol( "_CSETF-SC-STATE-INTERACTION" ), makeSymbol( "_CSETF-SC-STATE-ACTIVE-SESSION" ), makeSymbol(
        "_CSETF-SC-STATE-CONSTRUCTION-SESSIONS" ), makeSymbol( "_CSETF-SC-STATE-BROWSING-SESSIONS" ), makeSymbol( "_CSETF-SC-STATE-MERGE-INFO" ), makeSymbol( "_CSETF-SC-STATE-PARSING-MT" ), makeSymbol(
            "_CSETF-SC-STATE-GENERATION-MT" ), makeSymbol( "_CSETF-SC-STATE-DOMAIN-MT" ), makeSymbol( "_CSETF-SC-STATE-DOMAIN-INTERACTION-MT" ), makeSymbol( "_CSETF-SC-STATE-SCENARIO-INTERACTION-MT" ), makeSymbol(
                "_CSETF-SC-STATE-GEN-POINTS" ), makeSymbol( "_CSETF-SC-STATE-STATE" )
    } );
    $sym57$SC_STATE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol( "SC-STATE-PRINT-FUNCTION-TRAMPOLINE" );
    $list58 = ConsesLow.list( makeSymbol( "OPTIMIZE-FUNCALL" ), makeSymbol( "SC-STATE-P" ) );
    $sym59$SC_STATE_ID = makeSymbol( "SC-STATE-ID" );
    $sym60$_CSETF_SC_STATE_ID = makeSymbol( "_CSETF-SC-STATE-ID" );
    $sym61$SC_STATE_INTERACTION = makeSymbol( "SC-STATE-INTERACTION" );
    $sym62$_CSETF_SC_STATE_INTERACTION = makeSymbol( "_CSETF-SC-STATE-INTERACTION" );
    $sym63$SC_STATE_ACTIVE_SESSION = makeSymbol( "SC-STATE-ACTIVE-SESSION" );
    $sym64$_CSETF_SC_STATE_ACTIVE_SESSION = makeSymbol( "_CSETF-SC-STATE-ACTIVE-SESSION" );
    $sym65$SC_STATE_CONSTRUCTION_SESSIONS = makeSymbol( "SC-STATE-CONSTRUCTION-SESSIONS" );
    $sym66$_CSETF_SC_STATE_CONSTRUCTION_SESSIONS = makeSymbol( "_CSETF-SC-STATE-CONSTRUCTION-SESSIONS" );
    $sym67$SC_STATE_BROWSING_SESSIONS = makeSymbol( "SC-STATE-BROWSING-SESSIONS" );
    $sym68$_CSETF_SC_STATE_BROWSING_SESSIONS = makeSymbol( "_CSETF-SC-STATE-BROWSING-SESSIONS" );
    $sym69$SC_STATE_MERGE_INFO = makeSymbol( "SC-STATE-MERGE-INFO" );
    $sym70$_CSETF_SC_STATE_MERGE_INFO = makeSymbol( "_CSETF-SC-STATE-MERGE-INFO" );
    $sym71$SC_STATE_PARSING_MT = makeSymbol( "SC-STATE-PARSING-MT" );
    $sym72$_CSETF_SC_STATE_PARSING_MT = makeSymbol( "_CSETF-SC-STATE-PARSING-MT" );
    $sym73$SC_STATE_GENERATION_MT = makeSymbol( "SC-STATE-GENERATION-MT" );
    $sym74$_CSETF_SC_STATE_GENERATION_MT = makeSymbol( "_CSETF-SC-STATE-GENERATION-MT" );
    $sym75$SC_STATE_DOMAIN_MT = makeSymbol( "SC-STATE-DOMAIN-MT" );
    $sym76$_CSETF_SC_STATE_DOMAIN_MT = makeSymbol( "_CSETF-SC-STATE-DOMAIN-MT" );
    $sym77$SC_STATE_DOMAIN_INTERACTION_MT = makeSymbol( "SC-STATE-DOMAIN-INTERACTION-MT" );
    $sym78$_CSETF_SC_STATE_DOMAIN_INTERACTION_MT = makeSymbol( "_CSETF-SC-STATE-DOMAIN-INTERACTION-MT" );
    $sym79$SC_STATE_SCENARIO_INTERACTION_MT = makeSymbol( "SC-STATE-SCENARIO-INTERACTION-MT" );
    $sym80$_CSETF_SC_STATE_SCENARIO_INTERACTION_MT = makeSymbol( "_CSETF-SC-STATE-SCENARIO-INTERACTION-MT" );
    $sym81$SC_STATE_GEN_POINTS = makeSymbol( "SC-STATE-GEN-POINTS" );
    $sym82$_CSETF_SC_STATE_GEN_POINTS = makeSymbol( "_CSETF-SC-STATE-GEN-POINTS" );
    $sym83$SC_STATE_STATE = makeSymbol( "SC-STATE-STATE" );
    $sym84$_CSETF_SC_STATE_STATE = makeSymbol( "_CSETF-SC-STATE-STATE" );
    $kw85$INTERACTION = makeKeyword( "INTERACTION" );
    $kw86$ACTIVE_SESSION = makeKeyword( "ACTIVE-SESSION" );
    $kw87$CONSTRUCTION_SESSIONS = makeKeyword( "CONSTRUCTION-SESSIONS" );
    $kw88$BROWSING_SESSIONS = makeKeyword( "BROWSING-SESSIONS" );
    $kw89$MERGE_INFO = makeKeyword( "MERGE-INFO" );
    $kw90$PARSING_MT = makeKeyword( "PARSING-MT" );
    $kw91$GENERATION_MT = makeKeyword( "GENERATION-MT" );
    $kw92$DOMAIN_MT = makeKeyword( "DOMAIN-MT" );
    $kw93$DOMAIN_INTERACTION_MT = makeKeyword( "DOMAIN-INTERACTION-MT" );
    $kw94$SCENARIO_INTERACTION_MT = makeKeyword( "SCENARIO-INTERACTION-MT" );
    $kw95$GEN_POINTS = makeKeyword( "GEN-POINTS" );
    $sym96$MAKE_SC_STATE = makeSymbol( "MAKE-SC-STATE" );
    $sym97$VISIT_DEFSTRUCT_OBJECT_SC_STATE_METHOD = makeSymbol( "VISIT-DEFSTRUCT-OBJECT-SC-STATE-METHOD" );
    $sym98$USER_INTERACTION_P = makeSymbol( "USER-INTERACTION-P" );
    $sym99$SC_CONSTRUCTION_SESSION_P = makeSymbol( "SC-CONSTRUCTION-SESSION-P" );
    $sym100$SC_BROWSING_SESSION_P = makeSymbol( "SC-BROWSING-SESSION-P" );
    $sym101$SM_MERGE_INFO_P = makeSymbol( "SM-MERGE-INFO-P" );
    $sym102$LISTP = makeSymbol( "LISTP" );
    $kw103$SC_ACT = makeKeyword( "SC-ACT" );
    $kw104$MERGE = makeKeyword( "MERGE" );
    $kw105$GENERALIZE = makeKeyword( "GENERALIZE" );
    $kw106$CONSTRAINT_SENTENCE = makeKeyword( "CONSTRAINT-SENTENCE" );
    $kw107$PARSE_CONSTRAINT = makeKeyword( "PARSE-CONSTRAINT" );
    $kw108$INDEXICAL_PHRASE = makeKeyword( "INDEXICAL-PHRASE" );
    $kw109$PARSE_TERM = makeKeyword( "PARSE-TERM" );
    $kw110$SCENARIO_PHRASE = makeKeyword( "SCENARIO-PHRASE" );
    $kw111$PARSE_SCENARIO = makeKeyword( "PARSE-SCENARIO" );
    $kw112$OPEN = makeKeyword( "OPEN" );
    $kw113$CONSTRUCT = makeKeyword( "CONSTRUCT" );
    $kw114$LIMITATIONS = makeKeyword( "LIMITATIONS" );
    $sym115$SC_ITP_SEQUEL = makeSymbol( "SC-ITP-SEQUEL" );
    $kw116$INDEXICAL_TABLE = makeKeyword( "INDEXICAL-TABLE" );
    $const117$isa = constant_handles.reader_make_constant_shell( makeString( "isa" ) );
    $sym118$SM_CONSTRAINT_RECORD_P = makeSymbol( "SM-CONSTRAINT-RECORD-P" );
    $sym119$EL_FORMULA_P = makeSymbol( "EL-FORMULA-P" );
    $sym120$SM_GEN_POINT_WITHOUT_POSITIONS_P = makeSymbol( "SM-GEN-POINT-WITHOUT-POSITIONS-P" );
  }

  public static final class $sc_session_native
      extends
        SubLStructNative
  {
    ...
    public $sc_session_native()
    {
      ...
      this.$candidate_scenarios = CommonSymbols.NIL;
      this.$permission = CommonSymbols.NIL;
      this.$scenario = CommonSymbols.NIL;
      this.$internal_state = CommonSymbols.NIL;
    }

    @Override
    public SubLStructDecl getStructDecl()
    {
      return $sc_session_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $sc_session_native.class, $sym9$SC_SESSION, $sym10$SC_SESSION_P, $list11, $list12, new String[] { "$id", "$state", "$phrase", "$candidate_scenarios", "$permission",
        "$scenario", "$internal_state"
      }, $list13, $list14, $sym15$DEFAULT_STRUCT_PRINT_FUNCTION );
    }
  }

  public static final class $sc_session_p$UnaryFunction
      extends
        UnaryFunction
  {
  ...
  public static final class $sc_state_native
      extends
        SubLStructNative
  {
    public SubLObject $id;
    ...
    public $sc_state_native()
    {
      ...
      this.$active_session = CommonSymbols.NIL;
      this.$construction_sessions = CommonSymbols.NIL;
      this.$browsing_sessions = CommonSymbols.NIL;
      this.$merge_info = CommonSymbols.NIL;
      ...
      this.$scenario_interaction_mt = CommonSymbols.NIL;
      this.$gen_points = CommonSymbols.NIL;
      this.$state = CommonSymbols.NIL;
    }
    ...
    public SubLStructDecl getStructDecl()
    {
      return $sc_state_native.structDecl;
    }
    ...
    static
    {
      structDecl = Structures.makeStructDeclNative( $sc_state_native.class, $sym52$SC_STATE, $sym45$SC_STATE_P, $list53, $list54, new String[] { "$id", "$interaction", "$active_session", "$construction_sessions",
        "$browsing_sessions", "$merge_info", "$parsing_mt", "$generation_mt", "$domain_mt", "$domain_interaction_mt", "$scenario_interaction_mt", "$gen_points", "$state"
      }, $list55, $list56, $sym15$DEFAULT_STRUCT_PRINT_FUNCTION );
    }
  }

  public static final class $sc_state_p$UnaryFunction
      extends
        UnaryFunction
  {
