...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class rkf_scenario_constructor extends SubLTranslatedFile {
    ...
    public static SubLObject sc_session_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$sc_session_native.class ? T : NIL;
    }

    public static SubLObject sc_session_id(final SubLObject v_object) {
        assert NIL != sc_session_p(v_object) : "rkf_scenario_constructor.sc_session_p error :" + v_object;
    ...
    public static SubLObject sc_state_p(final SubLObject v_object) {
        return v_object.getJavaClass() ==$sc_state_native.class ? T : NIL;
    }

    public static SubLObject sc_state_id(final SubLObject v_object) {
        assert NIL != sc_state_p(v_object) : "rkf_scenario_constructor.sc_state_p error :" + v_object;
        return v_object.getField2();
    }
    ...
    public static SubLObject init_rkf_scenario_constructor_file() {
        ...
        deflexical("*SC-ISG*", SubLSystemTrampolineFile.maybeDefault($sc_isg$, $sc_isg$, () -> integer_sequence_generator.new_integer_sequence_generator(UNPROVIDED, UNPROVIDED, UNPROVIDED)));
        deflexical("*SC-INDEX*", SubLSystemTrampolineFile.maybeDefault($sc_index$, $sc_index$, () -> dictionary.new_dictionary(UNPROVIDED, UNPROVIDED)));
    ...
    public static final class $sc_session_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($sc_session_native.class, SC_SESSION, SC_SESSION_P, $list11, $list12, new String[]{ "$id", "$state", "$phrase", "$candidate_scenarios", "$permission", "$scenario", "$internal_state" }, $list13, $list14, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
    ...
    public static final class $sc_state_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative($sc_state_native.class, SC_STATE, SC_STATE_P, $list53, $list54, new String[]{ "$id", "$interaction", "$active_session", "$construction_sessions", "$browsing_sessions", "$merge_info", "$parsing_mt", "$generation_mt", "$domain_mt", "$domain_interaction_mt", "$scenario_interaction_mt", "$gen_points", "$state" }, $list55, $list56, DEFAULT_STRUCT_PRINT_FUNCTION);
        }
    }
