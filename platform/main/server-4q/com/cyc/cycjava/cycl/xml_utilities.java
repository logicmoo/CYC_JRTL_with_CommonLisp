...
public final class xml_utilities extends SubLTranslatedFile {
    ...
    public static final SubLSymbol VALID_XML_CHAR_P = makeSymbol("VALID-XML-CHAR-P");
    ...
    public static final SubLList $list21 = list(list(makeSymbol("NAME"), makeSymbol("&OPTIONAL"), makeSymbol("ATTRIBUTES"), makeSymbol("ATOMIC?"), makeSymbol("NO-NESTED-ELEMENTS?"), makeSymbol("MULTIPLE-LINE-ATTRIBUTES?"), list(makeSymbol("DEFAULT-NAMESPACE"), makeSymbol("*XML-DEFAULT-NAMESPACE*"))), makeSymbol("&BODY"), makeSymbol("BODY"));



    public static final SubLSymbol WITH_XML_INDENTATION = makeSymbol("WITH-XML-INDENTATION");
    ...
    public static final SubLList $list37 = list(makeInteger(46), makeInteger(45), makeInteger(95), makeInteger(58));

    public static final SubLObject $list38 = _constant_38_initializer();

    public static final SubLList $list39 = list(list(makeInteger(19968), makeInteger(40869)), list(makeInteger(12295), makeInteger(12295)), list(makeInteger(12321), makeInteger(12329)));
    ...
    public static final SubLList $list53 = list(cons(makeString("&gt;"), makeString(">")), cons(makeString("&lt;"), makeString("<")), cons(makeString("&amp;"), makeString("&")), cons(makeString("&quot;"), makeString("\"")), cons(makeString("&apos;"), makeString("'")));
    ...
    public static final SubLList $list66 = cons(makeSymbol("ELEMENT-NAME"), makeSymbol("ATTRIBUTES"));
    ...
    public static SubLObject xml_write_char(final SubLObject v_char) {
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != valid_xml_char_p(v_char) : "xml_utilities.valid_xml_char_p(v_char) " + "CommonSymbols.NIL != xml_utilities.valid_xml_char_p(v_char) " + v_char;
        write_char(v_char, xml_vars.$xml_stream$.getDynamicValue(thread));
        return NIL;
    }
    ...
    public static SubLObject xml_header(SubLObject version, SubLObject encoding, SubLObject standalone) {
        ...
        final SubLThread thread = SubLProcess.currentSubLThread();
        assert NIL != floatp(version) : "Types.floatp(version) " + "CommonSymbols.NIL != Types.floatp(version) " + version;
        assert NIL != stringp(encoding) : "Types.stringp(encoding) " + "CommonSymbols.NIL != Types.stringp(encoding) " + encoding;
        assert NIL != booleanp(standalone) : "Types.booleanp(standalone) " + "CommonSymbols.NIL != Types.booleanp(standalone) " + standalone;
    ...
    public static SubLObject xml_start_tag_internal(final SubLObject name, SubLObject attributes, final SubLObject atomicP, SubLObject multiple_line_attributesP, SubLObject default_namespace) {
        ...
        if (NIL != misc_utilities.initialized_p(default_namespace)) {
            assert NIL != stringp(default_namespace) : "Types.stringp(default_namespace) " + "CommonSymbols.NIL != Types.stringp(default_namespace) " + default_namespace;
    ...
    public static SubLObject declare_xml_utilities_file() {
        declareFunction(me, "xml_version", "XML-VERSION", 0, 0, false);
        declareFunction(me, "xml_add_indentation", "XML-ADD-INDENTATION", 0, 1, false);
        declareMacro(me, "with_xml_indentation", "WITH-XML-INDENTATION");
        declareFunction(me, "xml_terpri", "XML-TERPRI", 0, 0, false);
        declareFunction(me, "xml_write_string", "XML-WRITE-STRING", 1, 2, false);
        declareFunction(me, "xml_write_char", "XML-WRITE-CHAR", 1, 0, false);
        declareFunction(me, "xml_write_string_indented", "XML-WRITE-STRING-INDENTED", 1, 2, false);
        declareFunction(me, "xml_header", "XML-HEADER", 0, 3, false);
        declareFunction(me, "xml_cdata_prefix", "XML-CDATA-PREFIX", 0, 0, false);
        declareFunction(me, "xml_cdata_suffix", "XML-CDATA-SUFFIX", 0, 0, false);
        declareFunction(me, "xml_cdata", "XML-CDATA", 1, 0, false);
        declareFunction(me, "xml_markup", "XML-MARKUP", 1, 0, false);
        declareFunction(me, "xml_comment", "XML-COMMENT", 1, 0, false);
        declareMacro(me, "xml_tag", "XML-TAG");
        declareFunction(me, "xml_start_tag_internal", "XML-START-TAG-INTERNAL", 3, 2, false);
        declareFunction(me, "xml_end_tag_internal", "XML-END-TAG-INTERNAL", 1, 0, false);
        declareFunction(me, "xml_print", "XML-PRINT", 1, 1, false);
        declareFunction(me, "xml_prin1", "XML-PRIN1", 1, 1, false);
        declareFunction(me, "xml_print_line", "XML-PRINT-LINE", 1, 1, false);
        declareFunction(me, "xml_prin1_line", "XML-PRIN1-LINE", 1, 1, false);
        declareFunction(me, "xml_write", "XML-WRITE", 1, 1, false);
        declareFunction(me, "xml_write_line", "XML-WRITE-LINE", 1, 1, false);
        declareFunction(me, "valid_xml_name_p", "VALID-XML-NAME-P", 1, 0, false);
        declareFunction(me, "remove_invalid_xml_name_chars", "REMOVE-INVALID-XML-NAME-CHARS", 1, 0, false);
        declareFunction(me, "valid_ascii_xml_name_p", "VALID-ASCII-XML-NAME-P", 1, 0, false);
        declareFunction(me, "valid_xml_name_initial_char_p", "VALID-XML-NAME-INITIAL-CHAR-P", 1, 0, false);
        declareFunction(me, "valid_xml_name_initial_char_code_p", "VALID-XML-NAME-INITIAL-CHAR-CODE-P", 1, 0, false);
        declareFunction(me, "valid_non_ascii_xml_name_p", "VALID-NON-ASCII-XML-NAME-P", 1, 0, false);
        declareFunction(me, "valid_xml_name_char_p", "VALID-XML-NAME-CHAR-P", 1, 0, false);
        declareFunction(me, "remove_invalid_xml_name_chars_from_ascii_string", "REMOVE-INVALID-XML-NAME-CHARS-FROM-ASCII-STRING", 1, 0, false);
        declareFunction(me, "remove_invalid_xml_name_chars_from_non_ascii_string", "REMOVE-INVALID-XML-NAME-CHARS-FROM-NON-ASCII-STRING", 1, 0, false);
        declareFunction(me, "valid_xml_name_char_code_p", "VALID-XML-NAME-CHAR-CODE-P", 1, 0, false);
        declareFunction(me, "digit_char_code_p", "DIGIT-CHAR-CODE-P", 1, 0, false);
        declareFunction(me, "xml_letter_char_p", "XML-LETTER-CHAR-P", 1, 0, false);
        declareFunction(me, "xml_letter_char_code_p", "XML-LETTER-CHAR-CODE-P", 1, 0, false);
        declareFunction(me, "xml_base_char_p", "XML-BASE-CHAR-P", 1, 0, false);
        declareFunction(me, "xml_base_char_code_p", "XML-BASE-CHAR-CODE-P", 1, 0, false);
        declareFunction(me, "xml_ideographic_char_p", "XML-IDEOGRAPHIC-CHAR-P", 1, 0, false);
        declareFunction(me, "xml_ideographic_char_code_p", "XML-IDEOGRAPHIC-CHAR-CODE-P", 1, 0, false);
        declareFunction(me, "valid_xml_char_p", "VALID-XML-CHAR-P", 1, 0, false);
        declareFunction(me, "valid_xml_char_code_p", "VALID-XML-CHAR-CODE-P", 1, 0, false);
        declareFunction(me, "char_in_ranges_p", "CHAR-IN-RANGES-P", 2, 0, false);
        declareFunction(me, "char_code_in_ranges_p", "CHAR-CODE-IN-RANGES-P", 2, 0, false);
        declareFunction(me, "xml_special_charP", "XML-SPECIAL-CHAR?", 1, 0, false);
        declareFunction(me, "xml_char_escaped_version", "XML-CHAR-ESCAPED-VERSION", 1, 0, false);
        declareFunction(me, "xml_unescape_string", "XML-UNESCAPE-STRING", 1, 0, false);
        declareFunction(me, "xml_write_wXescaped_special_chars", "XML-WRITE-W/ESCAPED-SPECIAL-CHARS", 1, 0, false);
        declareFunction(me, "possible_xml_entity_reference_p", "POSSIBLE-XML-ENTITY-REFERENCE-P", 1, 2, false);
        declareFunction(me, "possible_xml_entity_name_p", "POSSIBLE-XML-ENTITY-NAME-P", 1, 0, false);
        declareFunction(me, "possible_xml_numeric_character_reference_p", "POSSIBLE-XML-NUMERIC-CHARACTER-REFERENCE-P", 1, 0, false);
        declareFunction(me, "valid_xml_entity_name_first_char_p", "VALID-XML-ENTITY-NAME-FIRST-CHAR-P", 1, 0, false);
        declareFunction(me, "valid_xml_entity_name_char_p", "VALID-XML-ENTITY-NAME-CHAR-P", 1, 0, false);
        declareMacro(me, "with_xml_output_to_stream", "WITH-XML-OUTPUT-TO-STREAM");
        declareMacro(me, "with_xml_output_to_string", "WITH-XML-OUTPUT-TO-STRING");
        declareFunction(me, "generate_valid_xml_header", "GENERATE-VALID-XML-HEADER", 1, 0, false);
        declareFunction(me, "generate_xml_header_entry_for_dtd", "GENERATE-XML-HEADER-ENTRY-FOR-DTD", 2, 1, false);
        declareFunction(me, "resolve_xml_namespaces", "RESOLVE-XML-NAMESPACES", 2, 0, false);
        declareFunction(me, "maybe_resolve_xml_namespace", "MAYBE-RESOLVE-XML-NAMESPACE", 3, 0, false);
        declareFunction(me, "resolve_xml_namespace", "RESOLVE-XML-NAMESPACE", 3, 0, false);
        declareFunction(me, "xml_sexpr_output_as_xml", "XML-SEXPR-OUTPUT-AS-XML", 1, 0, false);
        declareFunction(me, "xml_sexpr_output_daughters", "XML-SEXPR-OUTPUT-DAUGHTERS", 1, 1, false);
        declareFunction(me, "xml_tag_attributes_from_sexpr", "XML-TAG-ATTRIBUTES-FROM-SEXPR", 1, 0, false);
        declareFunction(me, "alists_sort_key", "ALISTS-SORT-KEY", 1, 0, false);
        declareFunction(me, "attribute_vars", "ATTRIBUTE-VARS", 1, 0, false);
        declareFunction(me, "sort_query_results_on_el_var", "SORT-QUERY-RESULTS-ON-EL-VAR", 2, 0, false);
        declareFunction(me, "write_xml_from_grouped_bindings", "WRITE-XML-FROM-GROUPED-BINDINGS", 5, 0, false);
        declareFunction(me, "query_bindings_to_xml", "QUERY-BINDINGS-TO-XML", 5, 0, false);
        declareFunction(me, "get_default_xml_spec_for_el_vars", "GET-DEFAULT-XML-SPEC-FOR-EL-VARS", 1, 0, false);
        declareFunction(me, "query_bindings_to_xml_stream", "QUERY-BINDINGS-TO-XML-STREAM", 4, 1, false);
        declareFunction(me, "query_results_to_xml_stream", "QUERY-RESULTS-TO-XML-STREAM", 1, 4, false);
        declareFunction(me, "download_xml_url", "DOWNLOAD-XML-URL", 1, 3, false);
        declareFunction(me, "query_results_to_xml_file", "QUERY-RESULTS-TO-XML-FILE", 2, 3, false);
        declareFunction(me, "query_results_to_xml_string", "QUERY-RESULTS-TO-XML-STRING", 1, 3, false);
        declareFunction(me, "boolean_to_trueXfalse_string", "BOOLEAN-TO-TRUE/FALSE-STRING", 1, 0, false);
        return NIL;
    }
