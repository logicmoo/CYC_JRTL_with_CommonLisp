...
public final class xml_utilities extends SubLTranslatedFile implements V12 {
	...
	private static final SubLObject _constant_36_initializer() {
		return list(new SubLObject[] { list(makeInteger(65), makeInteger(90)), list(makeInteger(97), makeInteger(122)),
				list(makeInteger(192), makeInteger(214)), list(makeInteger(216), makeInteger(246)),
				list(makeInteger(248), makeInteger(255)), list(makeInteger(256), makeInteger(305)),
				list(makeInteger(308), makeInteger(318)), list(makeInteger(321), makeInteger(328)),
				list(makeInteger(330), makeInteger(382)), list(makeInteger(384), makeInteger(451)),
				list(makeInteger(461), makeInteger(496)), list(makeInteger(500), makeInteger(501)),
				list(makeInteger(506), makeInteger(535)), list(makeInteger(592), makeInteger(680)),
				list(makeInteger(699), makeInteger(705)), list(makeInteger(902), makeInteger(902)),
				list(makeInteger(904), makeInteger(906)), list(makeInteger(908), makeInteger(908)),
				list(makeInteger(910), makeInteger(929)), list(makeInteger(931), makeInteger(974)),
				list(makeInteger(976), makeInteger(982)), list(makeInteger(986), makeInteger(986)),
				list(makeInteger(988), makeInteger(988)), list(makeInteger(990), makeInteger(990)),
				list(makeInteger(992), makeInteger(992)), list(makeInteger(994), makeInteger(1011)),
				list(makeInteger(1025), makeInteger(1036)), list(makeInteger(1038), makeInteger(1103)),
				list(makeInteger(1105), makeInteger(1116)), list(makeInteger(1118), makeInteger(1153)),
				list(makeInteger(1168), makeInteger(1220)), list(makeInteger(1223), makeInteger(1224)),
				list(makeInteger(1227), makeInteger(1228)), list(makeInteger(1232), makeInteger(1259)),
				list(makeInteger(1262), makeInteger(1269)), list(makeInteger(1272), makeInteger(1273)),
				list(makeInteger(1329), makeInteger(1366)), list(makeInteger(1369), makeInteger(1369)),
				list(makeInteger(1377), makeInteger(1414)), list(makeInteger(1488), makeInteger(1514)),
				list(makeInteger(1520), makeInteger(1522)), list(makeInteger(1569), makeInteger(1594)),
				list(makeInteger(1601), makeInteger(1610)), list(makeInteger(1649), makeInteger(1719)),
				list(makeInteger(1722), makeInteger(1726)), list(makeInteger(1728), makeInteger(1742)),
				list(makeInteger(1744), makeInteger(1747)), list(makeInteger(1749), makeInteger(1749)),
				list(makeInteger(1765), makeInteger(1766)), list(makeInteger(2309), makeInteger(2361)),
				list(makeInteger(2365), makeInteger(2365)), list(makeInteger(2392), makeInteger(2401)),
				list(makeInteger(2437), makeInteger(2444)), list(makeInteger(2447), makeInteger(2448)),
				list(makeInteger(2451), makeInteger(2472)), list(makeInteger(2474), makeInteger(2480)),
				list(makeInteger(2482), makeInteger(2482)), list(makeInteger(2486), makeInteger(2489)),
				list(makeInteger(2524), makeInteger(2525)), list(makeInteger(2527), makeInteger(2529)),
				list(makeInteger(2544), makeInteger(2545)), list(makeInteger(2565), makeInteger(2570)),
				list(makeInteger(2575), makeInteger(2576)), list(makeInteger(2579), makeInteger(2600)),
				list(makeInteger(2602), makeInteger(2608)), list(makeInteger(2610), makeInteger(2611)),
				list(makeInteger(2613), makeInteger(2614)), list(makeInteger(2616), makeInteger(2617)),
				list(makeInteger(2649), makeInteger(2652)), list(makeInteger(2654), makeInteger(2654)),
				list(makeInteger(2674), makeInteger(2676)), list(makeInteger(2693), makeInteger(2699)),
				list(makeInteger(2701), makeInteger(2701)), list(makeInteger(2703), makeInteger(2705)),
				list(makeInteger(2707), makeInteger(2728)), list(makeInteger(2730), makeInteger(2736)),
				list(makeInteger(2738), makeInteger(2739)), list(makeInteger(2741), makeInteger(2745)),
				list(makeInteger(2749), makeInteger(2749)), list(makeInteger(2784), makeInteger(2784)),
				list(makeInteger(2821), makeInteger(2828)), list(makeInteger(2831), makeInteger(2832)),
				list(makeInteger(2835), makeInteger(2856)), list(makeInteger(2858), makeInteger(2864)),
				list(makeInteger(2866), makeInteger(2867)), list(makeInteger(2870), makeInteger(2873)),
				list(makeInteger(2877), makeInteger(2877)), list(makeInteger(2908), makeInteger(2909)),
				list(makeInteger(2911), makeInteger(2913)), list(makeInteger(2949), makeInteger(2954)),
				list(makeInteger(2958), makeInteger(2960)), list(makeInteger(2962), makeInteger(2965)),
				list(makeInteger(2969), makeInteger(2970)), list(makeInteger(2972), makeInteger(2972)),
				list(makeInteger(2974), makeInteger(2975)), list(makeInteger(2979), makeInteger(2980)),
				list(makeInteger(2984), makeInteger(2986)), list(makeInteger(2990), makeInteger(2997)),
				list(makeInteger(2999), makeInteger(3001)), list(makeInteger(3077), makeInteger(3084)),
				list(makeInteger(3086), makeInteger(3088)), list(makeInteger(3090), makeInteger(3112)),
				list(makeInteger(3114), makeInteger(3123)), list(makeInteger(3125), makeInteger(3129)),
				list(makeInteger(3168), makeInteger(3169)), list(makeInteger(3205), makeInteger(3212)),
				list(makeInteger(3214), makeInteger(3216)), list(makeInteger(3218), makeInteger(3240)),
				list(makeInteger(3242), makeInteger(3251)), list(makeInteger(3253), makeInteger(3257)),
				list(makeInteger(3294), makeInteger(3294)), list(makeInteger(3296), makeInteger(3297)),
				list(makeInteger(3333), makeInteger(3340)), list(makeInteger(3342), makeInteger(3344)),
				list(makeInteger(3346), makeInteger(3368)), list(makeInteger(3370), makeInteger(3385)),
				list(makeInteger(3424), makeInteger(3425)), list(makeInteger(3585), makeInteger(3630)),
				list(makeInteger(3632), makeInteger(3632)), list(makeInteger(3634), makeInteger(3635)),
				list(makeInteger(3648), makeInteger(3653)), list(makeInteger(3713), makeInteger(3714)),
				list(makeInteger(3716), makeInteger(3716)), list(makeInteger(3719), makeInteger(3720)),
				list(makeInteger(3722), makeInteger(3722)), list(makeInteger(3725), makeInteger(3725)),
				list(makeInteger(3732), makeInteger(3735)), list(makeInteger(3737), makeInteger(3743)),
				list(makeInteger(3745), makeInteger(3747)), list(makeInteger(3749), makeInteger(3749)),
				list(makeInteger(3751), makeInteger(3751)), list(makeInteger(3754), makeInteger(3755)),
				list(makeInteger(3757), makeInteger(3758)), list(makeInteger(3760), makeInteger(3760)),
				list(makeInteger(3762), makeInteger(3763)), list(makeInteger(3773), makeInteger(3773)),
				list(makeInteger(3776), makeInteger(3780)), list(makeInteger(3904), makeInteger(3911)),
				list(makeInteger(3913), makeInteger(3945)), list(makeInteger(4256), makeInteger(4293)),
				list(makeInteger(4304), makeInteger(4342)), list(makeInteger(4352), makeInteger(4352)),
				list(makeInteger(4354), makeInteger(4355)), list(makeInteger(4357), makeInteger(4359)),
				list(makeInteger(4361), makeInteger(4361)), list(makeInteger(4363), makeInteger(4364)),
				list(makeInteger(4366), makeInteger(4370)), list(makeInteger(4412), makeInteger(4412)),
				list(makeInteger(4414), makeInteger(4414)), list(makeInteger(4416), makeInteger(4416)),
				list(makeInteger(4428), makeInteger(4428)), list(makeInteger(4430), makeInteger(4430)),
				list(makeInteger(4432), makeInteger(4432)), list(makeInteger(4436), makeInteger(4437)),
				list(makeInteger(4441), makeInteger(4441)), list(makeInteger(4447), makeInteger(4449)),
				list(makeInteger(4451), makeInteger(4451)), list(makeInteger(4453), makeInteger(4453)),
				list(makeInteger(4455), makeInteger(4455)), list(makeInteger(4457), makeInteger(4457)),
				list(makeInteger(4461), makeInteger(4462)), list(makeInteger(4466), makeInteger(4467)),
				list(makeInteger(4469), makeInteger(4469)), list(makeInteger(4510), makeInteger(4510)),
				list(makeInteger(4520), makeInteger(4520)), list(makeInteger(4523), makeInteger(4523)),
				list(makeInteger(4526), makeInteger(4527)), list(makeInteger(4535), makeInteger(4536)),
				list(makeInteger(4538), makeInteger(4538)), list(makeInteger(4540), makeInteger(4546)),
				list(makeInteger(4587), makeInteger(4587)), list(makeInteger(4592), makeInteger(4592)),
				list(makeInteger(4601), makeInteger(4601)), list(makeInteger(7680), makeInteger(7835)),
				list(makeInteger(7840), makeInteger(7929)), list(makeInteger(7936), makeInteger(7957)),
				list(makeInteger(7960), makeInteger(7965)), list(makeInteger(7968), makeInteger(8005)),
				list(makeInteger(8008), makeInteger(8013)), list(makeInteger(8016), makeInteger(8023)),
				list(makeInteger(8025), makeInteger(8025)), list(makeInteger(8027), makeInteger(8027)),
				list(makeInteger(8029), makeInteger(8029)), list(makeInteger(8031), makeInteger(8061)),
				list(makeInteger(8064), makeInteger(8116)), list(makeInteger(8118), makeInteger(8124)),
				list(makeInteger(8126), makeInteger(8126)), list(makeInteger(8130), makeInteger(8132)),
				list(makeInteger(8134), makeInteger(8140)), list(makeInteger(8144), makeInteger(8147)),
				list(makeInteger(8150), makeInteger(8155)), list(makeInteger(8160), makeInteger(8172)),
				list(makeInteger(8178), makeInteger(8180)), list(makeInteger(8182), makeInteger(8188)),
				list(makeInteger(8486), makeInteger(8486)), list(makeInteger(8490), makeInteger(8491)),
				list(makeInteger(8494), makeInteger(8494)), list(makeInteger(8576), makeInteger(8578)),
				list(makeInteger(12353), makeInteger(12436)), list(makeInteger(12449), makeInteger(12538)),
				list(makeInteger(12549), makeInteger(12588)), list(makeInteger(44032), makeInteger(55203)) });
	}
	...
	// deflexical
	@LispMethod(comment = "deflexical")
	private static final SubLSymbol $xml_ideographic_char_code_ranges$ = makeSymbol(
			"*XML-IDEOGRAPHIC-CHAR-CODE-RANGES*");
	...
	static private final SubLList $list2 = list(
			list(makeSymbol("*XML-INDENTATION-LEVEL*"),
					list(makeSymbol("+"), makeSymbol("*XML-INDENTATION-AMOUNT*"),
							makeSymbol("*XML-INDENTATION-LEVEL*"))),
	...
	static private final SubLString $str4$Skipping_invalid_xml_character__S = makeString(
			"Skipping invalid xml character ~S in ~S");
	...
	static private final SubLList $list21 = list(
			list(makeSymbol("NAME"), makeSymbol("&OPTIONAL"), makeSymbol("ATTRIBUTES"), makeSymbol("ATOMIC?"),
					makeSymbol("NO-NESTED-ELEMENTS?"), makeSymbol("MULTIPLE-LINE-ATTRIBUTES?"),
					list(makeSymbol("DEFAULT-NAMESPACE"), makeSymbol("*XML-DEFAULT-NAMESPACE*"))),
	...
	static private final SubLList $list39 = list(list(makeInteger(19968), makeInteger(40869)),
			list(makeInteger(12295), makeInteger(12295)), list(makeInteger(12321), makeInteger(12329)));

	private static final SubLList $list40 = list(makeSymbol("LOW"), makeSymbol("HIGH"));

	private static final SubLList $list41 = list(CHAR_ampersand, CHAR_quotation, CHAR_quote, CHAR_greater, CHAR_less,
			CHAR_newline);
	...
	static private final SubLList $list53 = list(cons(makeString("&gt;"), makeString(">")),
			cons(makeString("&lt;"), makeString("<")), cons(makeString("&amp;"), makeString("&")),
			cons(makeString("&quot;"), makeString("\"")), cons(makeString("&apos;"), makeString("'")));
	...
	private static final SubLString $str72$Couldn_t_resolve__S_based_on__S_a = makeString(
			"Couldn't resolve ~S based on ~S and ~S.");
	...
	private static final SubLString $str107$503_Service_Temporarily_Unavailab = makeString(
	...
	private static final SubLString $str110$Not_XML_document__Starts_with_ = makeString(
			"Not XML document. Starts with ");

	private static final SubLString $str111$Encountered_error_trying_to_downl = makeString(
			"Encountered error trying to download ~S:~% ~S");
	 ...
	 *
	 * @unknown Non-whitespace control characters and other invalid XML characters
	 *          will be omitted.
	 */
	...
	public static SubLObject xml_write_string(final SubLObject string, SubLObject start, SubLObject end) {
		...
		if (NIL != list_utilities.find_if_not(VALID_XML_CHAR_P, string, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			...
			SubLObject char_num;
			SubLObject v_char;
			for (end_var = end_var_$1 = (NIL != end) ? end : length(string), char_num = NIL, char_num = start; !char_num
					.numGE(end_var_$1); char_num = number_utilities.f_1X(char_num)) {
	...
	public static SubLObject xml_write_char(final SubLObject v_char) {
		final SubLThread thread = SubLProcess.currentSubLThread();
		assert NIL != valid_xml_char_p(v_char) : "! xml_utilities.valid_xml_char_p(v_char) "
				+ ("xml_utilities.valid_xml_char_p(v_char) "
						+ "CommonSymbols.NIL != xml_utilities.valid_xml_char_p(v_char) ")
				+ v_char;
		write_char(v_char, xml_vars.$xml_stream$.getDynamicValue(thread));
		return NIL;
	}
	...
	/**
	 * Write the part of STRING from START to END to the XML stream. Instead of
	 * emitting #Newlines, call XML-TERPRI instead.
	 */
	...
	public static final SubLObject xml_write_string_indented_alt(SubLObject string, SubLObject start, SubLObject end) {
		...
		while (start.numL(end)) {
			{
				SubLObject end_of_line = position(CHAR_newline, string, symbol_function($sym5$CHAR_),
						symbol_function(IDENTITY), start, end);
	...
	public static SubLObject xml_write_string_indented(final SubLObject string, SubLObject start, SubLObject end) {
		...
		while (start.numL(end)) {
			final SubLObject end_of_line = position(CHAR_newline, string, symbol_function($sym5$CHAR_),
					symbol_function(IDENTITY), start, end);
	...
	public static SubLObject xml_header(SubLObject version, SubLObject encoding, SubLObject standalone) {
		...
		final SubLThread thread = SubLProcess.currentSubLThread();
		assert NIL != floatp(version) : "! floatp(version) "
				+ ("Types.floatp(version) " + "CommonSymbols.NIL != Types.floatp(version) ") + version;
		assert NIL != stringp(encoding) : "! stringp(encoding) "
				+ ("Types.stringp(encoding) " + "CommonSymbols.NIL != Types.stringp(encoding) ") + encoding;
		assert NIL != booleanp(standalone) : "! booleanp(standalone) "
				+ ("Types.booleanp(standalone) " + "CommonSymbols.NIL != Types.booleanp(standalone) ") + standalone;
	...
	public static final SubLObject xml_cdata_alt(SubLObject string) {
		com.cyc.cycjava.cycl.xml_utilities.xml_write_string(com.cyc.cycjava.cycl.xml_utilities.xml_cdata_prefix(),
				UNPROVIDED, UNPROVIDED);
		com.cyc.cycjava.cycl.xml_utilities.xml_write_string(string, UNPROVIDED, UNPROVIDED);
		com.cyc.cycjava.cycl.xml_utilities.xml_write_string(com.cyc.cycjava.cycl.xml_utilities.xml_cdata_suffix(),
				UNPROVIDED, UNPROVIDED);
		return NIL;
	}
	 ...
	 *
	 * @param name                Tag name.
	 * @param attributes          List of the form (ATT-NAME-0 ATT-VALUE-0
	 *                            ATT-NAME-1 ATT-VALUE-1...)
	 * @param atomic?             If true, element will be atomic (i.e., end with
	 *                            />). Otherwise, the element will output an end
	 *                            tag.
	 * @param no-nested-elements? If non-NIL, no newline will be added before the
	 *                            end tag.
	 * @unknown Outputs an start and end tag of type NAME to @xref :variable
	 *          *xml-stream* with attributes ATTRIBUTES.
	 */
				...
				current = current.first();
				{
					...
					current = current.rest();
					{
						...
						current = current.rest();
						{
							...
							current = current.rest();
							{
								SubLObject no_nested_elementsP = (current.isCons()) ? ((SubLObject) (current.first()))
										: NIL;
								destructuring_bind_must_listp(current, datum, $list_alt21);
								current = current.rest();
								if (NIL == current) {
									current = temp;
									{
										SubLObject body = current;
										return list(PROGN,
												listS(WITH_XML_INDENTATION,
														list(XML_START_TAG_INTERNAL, name, attributes, atomicP),
														append(body, NIL)),
												list(PUNLESS, atomicP, listS(PUNLESS, no_nested_elementsP, $list_alt26),
														list(XML_END_TAG_INTERNAL, name)));
									}
								} else {
	...
	public static SubLObject xml_tag(final SubLObject macroform, final SubLObject environment) {
		...
		destructuring_bind_must_listp(current, datum, $list21);
		current = current.rest();
		final SubLObject default_namespace = (current.isCons()) ? current.first()
				: xml_vars.$xml_default_namespace$.getDynamicValue(thread);
		destructuring_bind_must_listp(current, datum, $list21);
		current = current.rest();
		if (NIL == current) {
			final SubLObject body;
			current = body = temp;
			return list(CUNWIND_PROTECT,
					list(WITH_XML_INDENTATION,
							list(XML_START_TAG_INTERNAL, name, attributes, atomicP, multiple_line_attributesP,
									default_namespace),
							listS(CLET, list(list($xml_default_namespace$, default_namespace)), append(body, NIL))),
					list(PUNLESS, atomicP, listS(PUNLESS, no_nested_elementsP, $list27),
							list(XML_END_TAG_INTERNAL, name)));
		}
	 ...
	 *
	 * @param name       Tag name.
	 * @param attributes List of the form (ATT-NAME-0 ATT-VALUE-0 ATT-NAME-1
	 *                   ATT-VALUE-1...)
	 * @param atomic?    If true, element will be atomic (i.e., end with />).
	 *                   Otherwise, the element will require an end-tag @see
	 *                   XML-END-TAG-INTERNAL.
	...
	public static final SubLObject xml_start_tag_internal(SubLObject name, SubLObject attributes, SubLObject atomicP) {
		...
		com.cyc.cycjava.cycl.xml_utilities.xml_write_string(name, UNPROVIDED, UNPROVIDED);
		{
			...
			for (att_list = attributes, att_name = att_list.first(), att_value = second(
					att_list); NIL != att_name; att_list = cddr(
							att_list), att_name = att_list.first(), att_value = second(att_list)) {
				...
				com.cyc.cycjava.cycl.xml_utilities.xml_write_wXescaped_special_chars(
						att_value.isString() ? ((SubLObject) (att_value)) : prin1_to_string(att_value));
	...
	public static SubLObject xml_start_tag_internal(final SubLObject name, SubLObject attributes,
			final SubLObject atomicP, SubLObject multiple_line_attributesP, SubLObject default_namespace) {
		...
		if (NIL != misc_utilities.initialized_p(default_namespace)) {
			assert NIL != stringp(default_namespace) : "! stringp(default_namespace) "
					+ ("Types.stringp(default_namespace) " + "CommonSymbols.NIL != Types.stringp(default_namespace) ")
					+ default_namespace;
	 ...
	 *
	 * @param name tag name
	 * @unknown Writes an XML end tag with name NAME to @xref :variable
	 *          *xml-stream*.
	 * @return nil
	 */
			...
			for (i = ZERO_INTEGER; i.numL(cdotimes_end_var); i = add(i, ONE_INTEGER)) {
				{
					...
					if (NIL != ent) {
						com.cyc.cycjava.cycl.xml_utilities.xml_write_string(
								cconcatenate($str_alt31$_, new SubLObject[] { ent.rest(), $str_alt32$_ }), UNPROVIDED,
								UNPROVIDED);
					} else {
	...
	public static SubLObject xml_write(final SubLObject string, SubLObject entity_table) {
		...
		assert NIL != stringp(string) : "! stringp(string) "
				+ ("Types.stringp(string) " + "CommonSymbols.NIL != Types.stringp(string) ") + string;
		SubLObject cdotimes_end_var;
		SubLObject i;
		SubLObject ch;
		SubLObject ent;
		for (cdotimes_end_var = length(string), i = NIL, i = ZERO_INTEGER; i
				.numL(cdotimes_end_var); i = add(i, ONE_INTEGER)) {
			ch = Strings.sublisp_char(string, i);
			ent = assoc(ch, entity_table, UNPROVIDED, UNPROVIDED);
			if (NIL != ent) {
				xml_write_string(cconcatenate($str33$_, new SubLObject[] { ent.rest(), $str34$_ }), UNPROVIDED,
						UNPROVIDED);
			} else {
				xml_write_char(ch);
			}
	...
	public static final SubLObject valid_xml_name_p_alt(SubLObject name) {
		return makeBoolean(name.isString() && (NIL != (NIL != unicode_strings.ascii_string_p(name)
				? ((SubLObject) (com.cyc.cycjava.cycl.xml_utilities.valid_ascii_xml_name_p(name)))
				: com.cyc.cycjava.cycl.xml_utilities.valid_non_ascii_xml_name_p(name))));
	}

	public static SubLObject valid_xml_name_p(final SubLObject name) {
		return makeBoolean((NIL != string_utilities.non_empty_string_p(name))
				&& (NIL != (NIL != unicode_strings.ascii_string_p(name) ? valid_ascii_xml_name_p(name)
						: valid_non_ascii_xml_name_p(name))));
	}
	...
	public static final SubLObject remove_invalid_xml_name_chars_alt(SubLObject name) {
		...
		return NIL != unicode_strings.ascii_string_p(name)
				...
				: com.cyc.cycjava.cycl.xml_utilities.remove_invalid_xml_name_chars_from_non_ascii_string(name);
	}
	...
	public static SubLObject remove_invalid_xml_name_chars(final SubLObject name) {
		assert NIL != stringp(name) : "! stringp(name) "
				+ ("Types.stringp(name) " + "CommonSymbols.NIL != Types.stringp(name) ") + name;
		return NIL != unicode_strings.ascii_string_p(name) ? remove_invalid_xml_name_chars_from_ascii_string(name)
				: remove_invalid_xml_name_chars_from_non_ascii_string(name);
	}

	public static final SubLObject valid_ascii_xml_name_p_alt(SubLObject name) {
		return makeBoolean((NIL != com.cyc.cycjava.cycl.xml_utilities
				.valid_xml_name_initial_char_p(string_utilities.first_char(name)))
				&& (NIL == list_utilities.find_if_not(VALID_XML_NAME_CHAR_P, name, UNPROVIDED, UNPROVIDED,
						UNPROVIDED)));
	}

	public static SubLObject valid_ascii_xml_name_p(final SubLObject name) {
		return makeBoolean(
				(NIL != valid_xml_name_initial_char_p(string_utilities.first_char(name))) && (NIL == list_utilities
						.find_if_not(VALID_XML_NAME_CHAR_P, name, UNPROVIDED, UNPROVIDED, UNPROVIDED)));
	}

	public static final SubLObject valid_xml_name_initial_char_p_alt(SubLObject v_char) {
		return makeBoolean(((v_char == CHAR_underbar) || (v_char == CHAR_colon))
				|| (NIL != com.cyc.cycjava.cycl.xml_utilities.xml_letter_char_p(v_char)));
	}
	...
	public static final SubLObject valid_xml_name_initial_char_code_p_alt(SubLObject code) {
		return makeBoolean((code.eql(char_code(CHAR_underbar)) || code.eql(char_code(CHAR_colon)))
				|| (NIL != com.cyc.cycjava.cycl.xml_utilities.xml_letter_char_code_p(code)));
	}

	public static SubLObject valid_xml_name_initial_char_code_p(final SubLObject code) {
		return makeBoolean((code.eql(char_code(CHAR_underbar)) || code.eql(char_code(CHAR_colon)))
				|| (NIL != xml_letter_char_code_p(code)));
	}
	...
	public static final SubLObject valid_non_ascii_xml_name_p_alt(SubLObject name) {
		{
			...
			return makeBoolean((((string_utilities.first_char(name) == CHAR_underbar)
					|| (string_utilities.first_char(name) == CHAR_colon))
					|| (NIL != com.cyc.cycjava.cycl.xml_utilities
							.xml_letter_char_code_p(aref(char_codes, ZERO_INTEGER))))
					&& (NIL == list_utilities.find_if_not(VALID_XML_NAME_CHAR_CODE_P, char_codes, UNPROVIDED,
							UNPROVIDED, UNPROVIDED)));
		}
	}
	...
	public static SubLObject valid_non_ascii_xml_name_p(final SubLObject name) {
		...
		return makeBoolean(((string_utilities.first_char(name).eql(CHAR_underbar)
				|| string_utilities.first_char(name).eql(CHAR_colon))
				|| (NIL != xml_letter_char_code_p(aref(char_codes, ZERO_INTEGER))))
				&& (NIL == list_utilities.find_if_not(VALID_XML_NAME_CHAR_CODE_P, char_codes, UNPROVIDED, UNPROVIDED,
						UNPROVIDED)));
	}
	...
	public static final SubLObject remove_invalid_xml_name_chars_from_ascii_string_alt(SubLObject name) {
		{
			...
			while (!((NIL != string_utilities.empty_string_p(new_name)) || (NIL != com.cyc.cycjava.cycl.xml_utilities
					.valid_xml_name_initial_char_p(string_utilities.first_char(new_name))))) {
				new_name = string_utilities.substring(new_name, ONE_INTEGER, UNPROVIDED);
			}
			return list_utilities.remove_if_not(VALID_XML_NAME_CHAR_P, new_name, UNPROVIDED, UNPROVIDED, UNPROVIDED,
					UNPROVIDED);
		}
	}
	...
	public static SubLObject remove_invalid_xml_name_chars_from_ascii_string(final SubLObject name) {
		SubLObject new_name;
		for (new_name = name; (NIL == string_utilities.empty_string_p(new_name))
				&& (NIL == valid_xml_name_initial_char_p(
						string_utilities.first_char(new_name))); new_name = string_utilities.substring(new_name,
	...
	public static final SubLObject remove_invalid_xml_name_chars_from_non_ascii_string_alt(SubLObject name) {
		{
			...
			while (!((NIL != list_utilities.lengthE(char_codes, ZERO_INTEGER, UNPROVIDED))
					|| (NIL != com.cyc.cycjava.cycl.xml_utilities
							.valid_xml_name_initial_char_code_p(aref(char_codes, ZERO_INTEGER))))) {
				found_invalidP = T;
				char_codes = subseq(char_codes, ONE_INTEGER, UNPROVIDED);
			}
			if ((NIL != found_invalidP) || (NIL != list_utilities.find_if_not(VALID_XML_NAME_CHAR_CODE_P, char_codes,
					UNPROVIDED, UNPROVIDED, UNPROVIDED))) {
				return unicode_strings.utf8_vector_to_utf8_string(unicode_strings
						.unicode_vector_to_utf8_vector(list_utilities.delete_if_not(VALID_XML_NAME_CHAR_CODE_P,
								char_codes, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED), UNPROVIDED, UNPROVIDED));
			} else {
				return name;
			}
		}
	...
	public static SubLObject remove_invalid_xml_name_chars_from_non_ascii_string(final SubLObject name) {
		...
		SubLObject found_invalidP = NIL;
		while ((NIL == list_utilities.lengthE(char_codes, ZERO_INTEGER, UNPROVIDED))
				&& (NIL == valid_xml_name_initial_char_code_p(aref(char_codes, ZERO_INTEGER)))) {
			found_invalidP = T;
			char_codes = subseq(char_codes, ONE_INTEGER, UNPROVIDED);
		}
		if ((NIL != found_invalidP) || (NIL != list_utilities.find_if_not(VALID_XML_NAME_CHAR_CODE_P, char_codes,
				UNPROVIDED, UNPROVIDED, UNPROVIDED))) {
			return unicode_strings.utf8_vector_to_utf8_string(unicode_strings
					.unicode_vector_to_utf8_vector(list_utilities.delete_if_not(VALID_XML_NAME_CHAR_CODE_P, char_codes,
	...
	public static final SubLObject valid_xml_name_char_code_p_alt(SubLObject code) {
		return makeBoolean((NIL != subl_promotions.non_negative_integer_p(code))
				&& (((NIL != com.cyc.cycjava.cycl.xml_utilities.xml_letter_char_code_p(code))
						|| (NIL != com.cyc.cycjava.cycl.xml_utilities.digit_char_code_p(code)))
						|| (NIL != member(code, $list_alt35, UNPROVIDED, UNPROVIDED))));
	}
	...
	public static SubLObject valid_xml_name_char_code_p(final SubLObject code) {
		return makeBoolean((NIL != subl_promotions.non_negative_integer_p(code))
				&& (((NIL != xml_letter_char_code_p(code)) || (NIL != digit_char_code_p(code)))
						|| (NIL != member(code, $list37, UNPROVIDED, UNPROVIDED))));
	}
	...
	public static final SubLObject xml_letter_char_p_alt(SubLObject v_char) {
		return makeBoolean((NIL != com.cyc.cycjava.cycl.xml_utilities.xml_base_char_p(v_char))
				|| (NIL != com.cyc.cycjava.cycl.xml_utilities.xml_ideographic_char_p(v_char)));
	}
	...
	public static final SubLObject xml_letter_char_code_p_alt(SubLObject v_object) {
		return makeBoolean((NIL != com.cyc.cycjava.cycl.xml_utilities.xml_base_char_code_p(v_object))
				|| (NIL != com.cyc.cycjava.cycl.xml_utilities.xml_ideographic_char_code_p(v_object)));
	}
	...
	public static final SubLObject xml_base_char_p_alt(SubLObject v_object) {
		return makeBoolean(v_object.isChar() && (NIL != com.cyc.cycjava.cycl.xml_utilities.char_in_ranges_p(v_object,
				$xml_base_char_code_ranges$.getGlobalValue())));
	}

	public static SubLObject xml_base_char_p(final SubLObject v_object) {
		return makeBoolean(
				v_object.isChar() && (NIL != char_in_ranges_p(v_object, $xml_base_char_code_ranges$.getGlobalValue())));
	}

	public static final SubLObject xml_base_char_code_p_alt(SubLObject v_object) {
		return makeBoolean(v_object.isNumber() && (NIL != com.cyc.cycjava.cycl.xml_utilities
				.char_code_in_ranges_p(v_object, $xml_base_char_code_ranges$.getGlobalValue())));
	}

	public static SubLObject xml_base_char_code_p(final SubLObject v_object) {
		return makeBoolean(v_object.isNumber()
				&& (NIL != char_code_in_ranges_p(v_object, $xml_base_char_code_ranges$.getGlobalValue())));
	}

	public static final SubLObject xml_ideographic_char_p_alt(SubLObject v_object) {
		return makeBoolean(v_object.isChar() && (NIL != com.cyc.cycjava.cycl.xml_utilities.char_in_ranges_p(v_object,
				$xml_ideographic_char_code_ranges$.getGlobalValue())));
	}

	public static SubLObject xml_ideographic_char_p(final SubLObject v_object) {
		return makeBoolean(v_object.isChar()
				&& (NIL != char_in_ranges_p(v_object, $xml_ideographic_char_code_ranges$.getGlobalValue())));
	}

	public static final SubLObject xml_ideographic_char_code_p_alt(SubLObject v_object) {
		return makeBoolean(v_object.isNumber() && (NIL != com.cyc.cycjava.cycl.xml_utilities
				.char_code_in_ranges_p(v_object, $xml_ideographic_char_code_ranges$.getGlobalValue())));
	}

	public static SubLObject xml_ideographic_char_code_p(final SubLObject v_object) {
		return makeBoolean(v_object.isNumber()
				&& (NIL != char_code_in_ranges_p(v_object, $xml_ideographic_char_code_ranges$.getGlobalValue())));
	}

	public static final SubLObject valid_xml_char_p_alt(SubLObject v_char) {
		return makeBoolean(v_char.isChar() && (NIL != com.cyc.cycjava.cycl.xml_utilities
				.char_code_in_ranges_p(char_code(v_char), xml_vars.$xml_valid_char_code_ranges$.getGlobalValue())));
	}

	public static SubLObject valid_xml_char_p(final SubLObject v_char) {
		return makeBoolean(v_char.isChar() && (NIL != char_code_in_ranges_p(char_code(v_char),
				xml_vars.$xml_valid_char_code_ranges$.getGlobalValue())));
	}

	public static final SubLObject valid_xml_char_code_p_alt(SubLObject char_code) {
		return makeBoolean(char_code.isNumber() && (NIL != com.cyc.cycjava.cycl.xml_utilities
				.char_code_in_ranges_p(char_code, xml_vars.$xml_valid_char_code_ranges$.getGlobalValue())));
	}

	public static SubLObject valid_xml_char_code_p(final SubLObject char_code) {
		return makeBoolean(char_code.isNumber()
				&& (NIL != char_code_in_ranges_p(char_code, xml_vars.$xml_valid_char_code_ranges$.getGlobalValue())));
	}
			...
			if (NIL == okP) {
				{
					...
					for (range = csome_list_var
							.first(); !((NIL != okP) || (NIL == csome_list_var)); csome_list_var = csome_list_var
									.rest(), range = csome_list_var.first()) {
						{
	...
	public static final SubLObject xml_special_charP_alt(SubLObject v_char) {
		return makeBoolean((NIL != string_utilities.control_char_p(v_char))
				|| (NIL != member(v_char, $xml_special_chars$.getGlobalValue(), UNPROVIDED, UNPROVIDED)));
	}
			...
			for (i = ZERO_INTEGER; !i.numGE(end_var_2); i = number_utilities.f_1X(i)) {
				{
					...
					if ((v_char == CHAR_ampersand) && (NIL != com.cyc.cycjava.cycl.xml_utilities
							.possible_xml_entity_reference_p(string, i, UNPROVIDED))) {
						...
						if (NIL != com.cyc.cycjava.cycl.xml_utilities.xml_special_charP(v_char)) {
							com.cyc.cycjava.cycl.xml_utilities.xml_write_string(
									com.cyc.cycjava.cycl.xml_utilities.xml_char_escaped_version(v_char), UNPROVIDED,
									UNPROVIDED);
						} else {
							if (NIL == com.cyc.cycjava.cycl.xml_utilities.valid_xml_char_p(v_char)) {
								com.cyc.cycjava.cycl.xml_utilities.xml_write_char(CHAR_space);
	...
	public static SubLObject xml_write_wXescaped_special_chars(final SubLObject string) {
		...
		SubLObject i;
		SubLObject v_char;
		for (end_var = end_var_$2 = length(string), i = NIL, i = ZERO_INTEGER; !i
				.numGE(end_var_$2); i = number_utilities.f_1X(i)) {
			v_char = Strings.sublisp_char(string, i);
			if (v_char.eql(CHAR_newline)) {
				xml_write_char(v_char);
			} else if (v_char.eql(CHAR_ampersand) && (NIL != possible_xml_entity_reference_p(string, i, UNPROVIDED))) {
				xml_write_char(v_char);
	...
	public static final SubLObject possible_xml_entity_reference_p_alt(SubLObject string, SubLObject start,
			SubLObject end) {
		if (start == UNPROVIDED) {
			start = ZERO_INTEGER;
		}
		...
		if (((Strings.sublisp_char(string, start) == CHAR_ampersand)
				&& (NIL != list_utilities.lengthG(string, add(start, TWO_INTEGER), UNPROVIDED)))
				&& (NIL != com.cyc.cycjava.cycl.xml_utilities.valid_xml_entity_name_first_char_p(
					...
					for (i = add(start, TWO_INTEGER); !i.numGE(end_var_3); i = number_utilities.f_1X(i)) {
						{
							...
							if (v_char == CHAR_semicolon) {
								return com.cyc.cycjava.cycl.xml_utilities
										.possible_xml_entity_name_p(get_output_stream_string(name_stream));
							} else {
								if (end.isInteger() && i.numG(end)) {
									return NIL;
								} else {
									if (NIL != com.cyc.cycjava.cycl.xml_utilities
											.valid_xml_entity_name_char_p(v_char)) {
	...
	public static SubLObject possible_xml_entity_reference_p(final SubLObject string, SubLObject start,
			SubLObject end) {
		if (start == UNPROVIDED) {
			start = ZERO_INTEGER;
		}
		...
		if ((Strings.sublisp_char(string, start).eql(CHAR_ampersand)
				&& (NIL != list_utilities.lengthG(string, add(start, TWO_INTEGER), UNPROVIDED)))
			...
			SubLObject i;
			SubLObject v_char;
			for (end_var = end_var_$3 = length(string), i = NIL, i = add(start, TWO_INTEGER); !i
					.numGE(end_var_$3); i = number_utilities.f_1X(i)) {
				v_char = Strings.sublisp_char(string, i);
	...
	public static final SubLObject possible_xml_entity_name_p_alt(SubLObject string) {
		{
			...
			if (NIL != uninitialized_p(xml_vars.$xml_document_entity_names$.getDynamicValue(thread))) {
				...
				if (NIL != com.cyc.cycjava.cycl.xml_utilities.possible_xml_numeric_character_reference_p(string)) {
					...
					if (NIL != list_utilities.alist_has_keyP(xml_vars.$xml_predefined_entities$.getGlobalValue(),
							string, UNPROVIDED)) {
						return T;
					} else {
						return subl_promotions.memberP(string,
								xml_vars.$xml_document_entity_names$.getDynamicValue(thread), symbol_function(EQUALP),
								UNPROVIDED);
					}
				}
			}
	...
	public static SubLObject possible_xml_entity_name_p(final SubLObject string) {
		...
		if (NIL != list_utilities.alist_has_keyP(xml_vars.$xml_predefined_entities$.getGlobalValue(), string,
				UNPROVIDED)) {
			return T;
		}
		return subl_promotions.memberP(string, xml_vars.$xml_document_entity_names$.getDynamicValue(thread),
	...
	public static final SubLObject possible_xml_numeric_character_reference_p_alt(SubLObject string) {
		{
			...
			if (string_utilities.first_char(string).eql(CHAR_hash)) {
				if (NIL == list_utilities.find_if_not(DIGIT_CHAR_P, string, symbol_function(IDENTITY), ONE_INTEGER,
						UNPROVIDED)) {
					possibleP = T;
				} else {
					if (Strings.sublisp_char(string, ONE_INTEGER).eql(CHAR_x) && (NIL == list_utilities
							.find_if_not(HEX_CHAR_P, string, symbol_function(IDENTITY), TWO_INTEGER, UNPROVIDED))) {
						possibleP = T;
					}
				}
			}
	...
	public static SubLObject possible_xml_numeric_character_reference_p(final SubLObject string) {
		...
		if (string_utilities.first_char(string).eql(CHAR_hash)) {
			if (NIL == list_utilities.find_if_not(DIGIT_CHAR_P, string, symbol_function(IDENTITY), ONE_INTEGER,
					UNPROVIDED)) {
				possibleP = T;
			} else if (Strings.sublisp_char(string, ONE_INTEGER).eql(CHAR_x) && (NIL == list_utilities
					.find_if_not(HEX_CHAR_P, string, symbol_function(IDENTITY), TWO_INTEGER, UNPROVIDED))) {
				possibleP = T;
			}
	...
	public static final SubLObject valid_xml_entity_name_char_p_alt(SubLObject v_char) {
		return makeBoolean((((NIL != com.cyc.cycjava.cycl.xml_utilities.valid_xml_entity_name_first_char_p(v_char))
				|| (NIL != digit_char_p(v_char, UNPROVIDED))) || (v_char == CHAR_period)) || (v_char == CHAR_hyphen));
	}

	public static SubLObject valid_xml_entity_name_char_p(final SubLObject v_char) {
		return makeBoolean(
				(((NIL != valid_xml_entity_name_first_char_p(v_char)) || (NIL != digit_char_p(v_char, UNPROVIDED)))
						|| v_char.eql(CHAR_period)) || v_char.eql(CHAR_hyphen));
	}
	...
	/**
	 * Evaluate BODY with all XML output redirected to a string. On completion of
	 * BODY, the variable STRING-VAR is set to the resulting string.
	 */
			...
			current = current.rest();
			{
				...
				SubLSystemTrampolineFile.checkType(string_var, SYMBOLP);
				{
					...
					return list(CWITH_OUTPUT_TO_STRING, list(stream, string_var),
							listS(WITH_XML_OUTPUT_TO_STREAM, stream, append(body, NIL)));
				}
			}
		}
	}
	...
	public static SubLObject with_xml_output_to_string(final SubLObject macroform, final SubLObject environment) {
		...
		final SubLObject body;
		current = body = current.rest();
		assert NIL != symbolp(string_var) : "! symbolp(string_var) "
				+ ("Types.symbolp(string_var) " + "CommonSymbols.NIL != Types.symbolp(string_var) ") + string_var;
	...
	public static final SubLObject generate_valid_xml_header_alt(SubLObject stream) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				...
				try {
					...
					com.cyc.cycjava.cycl.xml_utilities.xml_header(com.cyc.cycjava.cycl.xml_utilities.xml_version(),
							$str_alt6$US_ASCII, NIL);
				} finally {
	...
	public static final SubLObject generate_xml_header_entry_for_dtd_alt(SubLObject sysid, SubLObject dtd,
			SubLObject stream) {
	...
	public static SubLObject generate_xml_header_entry_for_dtd(final SubLObject sysid, final SubLObject dtd,
			SubLObject stream) {
		if (stream == UNPROVIDED) {
			stream = xml_vars.$xml_stream$.getDynamicValue();
		}
	...
	public static final SubLObject resolve_xml_namespaces_alt(SubLObject token, SubLObject stack) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
						...
						for (cons = cdolist_list_var
										...
										.rest(), cons = cdolist_list_var.first()) {
							{
								...
								if (NIL != string_utilities.starts_with(attribute, $str_alt64$xmlns_)) {
									new_bindings = cons(
											cons(string_utilities.substring(attribute, SIX_INTEGER, position(CHAR_equal,
													attribute, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)), value),
											new_bindings);
								}
							}
						}
				...
				{
					SubLObject resolved_element_name = com.cyc.cycjava.cycl.xml_utilities
							.maybe_resolve_xml_namespace(element_name, new_bindings, stack);
					SubLObject something_changedP = string_utilities.non_empty_string_p(resolved_element_name);
					SubLObject new_element_name = (NIL != resolved_element_name)
							? ((SubLObject) (resolved_element_name))
							: element_name;
					SubLObject new_attributes = attributes;
					SubLObject cdolist_list_var = attributes;
					SubLObject cons = NIL;
					for (cons = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var
							.rest(), cons = cdolist_list_var.first()) {
						{
							...
							value = current_7;
							{
								SubLObject new_value = com.cyc.cycjava.cycl.xml_utilities
										.maybe_resolve_xml_namespace(value, new_bindings, stack);
								if (NIL != new_value) {
									new_attributes = list_utilities.alist_enter(new_attributes, key, new_value,
											symbol_function(EQUAL));
					...
					if (NIL != something_changedP) {
						{
							...
							try {
								stream = make_private_string_output_stream();
								{
									...
									try {
										xml_vars.$xml_stream$.bind(stream, thread);
										if ((NIL != web_utilities.xml_opening_tag_p(token))
												|| (NIL != web_utilities.xml_empty_tagP(token))) {
											com.cyc.cycjava.cycl.xml_utilities.xml_start_tag_internal(new_element_name,
													list_utilities.alist_to_plist(new_attributes),
													web_utilities.xml_empty_tagP(token));
										} else {
	...
	public static SubLObject resolve_xml_namespaces(final SubLObject token, final SubLObject stack) {
		...
		if (NIL != string_utilities.substringP($str67$xmlns_, token, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
			...
			while (NIL != cdolist_list_var) {
				...
				if (NIL != string_utilities.starts_with(attribute, $str67$xmlns_)) {
					new_bindings = cons(cons(
							string_utilities.substring(attribute, SIX_INTEGER,
									position(CHAR_equal, attribute, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)),
							value), new_bindings);
				}
		...
		if (NIL != something_changedP) {
			...
			try {
				...
				try {
					xml_vars.$xml_stream$.bind(stream, thread);
					if ((NIL != xml_parsing_utilities.xml_opening_tag_p(token))
							|| (NIL != xml_parsing_utilities.xml_empty_tagP(token))) {
						xml_start_tag_internal(new_element_name, list_utilities.alist_to_plist(new_attributes),
								xml_parsing_utilities.xml_empty_tagP(token), UNPROVIDED, UNPROVIDED);
					} else {
	...
	public static final SubLObject maybe_resolve_xml_namespace_alt(SubLObject name, SubLObject new_bindings,
			SubLObject stack) {
		return (((NIL != find(CHAR_colon, name, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED))
				&& (NIL == string_utilities.starts_with(name, $str_alt64$xmlns_)))
				&& (NIL == string_utilities.starts_with(name, $str_alt67$xml_)))
				&& (NIL == string_utilities.starts_with(name, $str_alt68$http_))
						? ((SubLObject) (com.cyc.cycjava.cycl.xml_utilities.resolve_xml_namespace(name, new_bindings,
								stack)))
						: NIL;
	}

	public static SubLObject maybe_resolve_xml_namespace(final SubLObject name, final SubLObject new_bindings,
			final SubLObject stack) {
		return (((NIL != find(CHAR_colon, name, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED))
				&& (NIL == string_utilities.starts_with(name, $str67$xmlns_)))
				&& (NIL == string_utilities.starts_with(name, $str70$xml_)))
				&& (NIL == string_utilities.starts_with(name, $str71$http_))
						? resolve_xml_namespace(name, new_bindings, stack)
						: NIL;
	}
	...
	public static final SubLObject resolve_xml_namespace_alt(SubLObject name, SubLObject new_bindings,
			SubLObject stack) {
		{
			SubLObject namespace = web_utilities.xml_prefixed_name_namespace(name);
			SubLObject expanded = list_utilities.alist_lookup_without_values(new_bindings, namespace,
					symbol_function(EQUAL), NIL);
			if (NIL == expanded) {
				{
					SubLObject csome_list_var = stack;
					SubLObject binding = NIL;
					for (binding = csome_list_var
							.first(); !((NIL != expanded) || (NIL == csome_list_var)); csome_list_var = csome_list_var
									.rest(), binding = csome_list_var.first()) {
	 ...
	 */
	@LispMethod(comment = "Return the expanded version of NAME based on NEW-BINDINGS and STACK.")
	public static SubLObject resolve_xml_namespace(final SubLObject name, final SubLObject new_bindings,
			final SubLObject stack) {
	...
	public static final SubLObject xml_sexpr_output_as_xml_alt(SubLObject sexpr) {
		{
			...
			if (sexpr.isString()) {
			...
			} else {
				{
					...
					SubLObject no_nested_elementsP = sublisp_null(find_if(LISTP,
							web_utilities.xml_sexpr_daughters(sexpr, UNPROVIDED), UNPROVIDED, UNPROVIDED, UNPROVIDED));
					{
						...
						try {
							$xml_indentation_level$.bind(add($xml_indentation_amount$.getDynamicValue(thread),
									$xml_indentation_level$.getDynamicValue(thread)), thread);
							$cycml_indent_level$.bind($xml_indentation_level$.getDynamicValue(thread), thread);
							com.cyc.cycjava.cycl.xml_utilities.xml_start_tag_internal(
									web_utilities.xml_sexpr_type(sexpr),
									com.cyc.cycjava.cycl.xml_utilities.xml_tag_attributes_from_sexpr(sexpr), atomicP);
	...
	public static SubLObject xml_sexpr_output_as_xml(final SubLObject sexpr) {
		...
		if (sexpr.isString()) {
			...
			final SubLObject no_nested_elementsP = sublisp_null(find_if(LISTP,
					xml_parsing_utilities.xml_sexpr_daughters(sexpr, UNPROVIDED), UNPROVIDED, UNPROVIDED, UNPROVIDED));
			try {
				...
				try {
					$xml_indentation_level$.bind(add($xml_indentation_amount$.getDynamicValue(thread),
							$xml_indentation_level$.getDynamicValue(thread)), thread);
					$cycml_indent_level$.bind($xml_indentation_level$.getDynamicValue(thread), thread);
					xml_start_tag_internal(xml_parsing_utilities.xml_sexpr_type(sexpr),
							xml_tag_attributes_from_sexpr(sexpr), atomicP, NIL, $UNINITIALIZED);
	...
	public static final SubLObject xml_sexpr_output_daughters_alt(SubLObject sexpr, SubLObject tag) {
		...
		}
		{
			...
			for (list_var = dtrs, dtr_sexpr = list_var
					.first(), dtr_num = ZERO_INTEGER; NIL != list_var; list_var = list_var
							.rest(), dtr_sexpr = list_var.first(), dtr_num = add(ONE_INTEGER, dtr_num)) {
				com.cyc.cycjava.cycl.xml_utilities.xml_sexpr_output_as_xml(dtr_sexpr);
				if (!(dtr_sexpr.isString()
						|| (NIL != list_utilities.lengthE(dtrs, number_utilities.f_1X(dtr_num), UNPROVIDED)))) {
					com.cyc.cycjava.cycl.xml_utilities.xml_terpri();
				}
			}
		}
	...
	public static SubLObject xml_sexpr_output_daughters(final SubLObject sexpr, SubLObject tag) {
		...
		for (dtr_num = ZERO_INTEGER; NIL != list_var; list_var = list_var.rest(), dtr_sexpr = list_var
				.first(), dtr_num = add(ONE_INTEGER, dtr_num)) {
	 ...
	 *
	 *
	 * @return LISTP; the attributes from SEXPR in the format required by @xref
	 *         XML-TAG
	 */
	...
	public static final SubLObject alists_sort_key_alt(SubLObject alist) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			return list_utilities.alist_lookup(alist, $alists_sort_key$.getDynamicValue(thread), UNPROVIDED,
					UNPROVIDED);
		}
	}
			...
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				SubLObject results = NIL;
				{
					...
					try {
						...
						results = Sort.sort(copy_list(alists), symbol_function($sym71$TERM___WITH_CONSTANT_BY_NAME),
								ALISTS_SORT_KEY);
					} finally {
	...
	public static SubLObject sort_query_results_on_el_var(final SubLObject alists, final SubLObject sort_key) {
		...
		try {
			$alists_sort_key$.bind(sort_key, thread);
			results = Sort.sort(copy_list(alists), symbol_function($sym75$TERM___WITH_CONSTANT_BY_NAME),
					ALISTS_SORT_KEY);
		} finally {
			$alists_sort_key$.rebind(_prev_bind_0, thread);
		}
	...
	public static final SubLObject write_xml_from_grouped_bindings_alt(SubLObject grouped_bindings, SubLObject xml_spec,
			SubLObject indent_num, SubLObject output_stream, SubLObject cycl_prefixP) {
		{
					...
					.rest(), cons = cdolist_list_var.first()) {
				{
					...
					if (grouping_key_tuples.isList()) {
						{
							...
							for (attribute_var = cdolist_list_var_8
									.first(); NIL != cdolist_list_var_8; cdolist_list_var_8 = cdolist_list_var_8
											.rest(), attribute_var = cdolist_list_var_8.first()) {
								{
									SubLObject value = format_nil.format_nil_a(list_utilities
											.alist_lookup(grouping_key_tuples, attribute_var, UNPROVIDED, UNPROVIDED));
									if (NIL == cycl_prefixP) {
										value = string_utilities.remove_substring(value, $str_alt79$__);
									}
									format(output_stream, $str_alt80$__A__A,
											getf(reverse(attributes), attribute_var, UNPROVIDED),
											string_utilities.quote_string(value, UNPROVIDED));
								}
							}
						}
					}
					if ((NIL != elements) || (NIL != text)) {
						...
						if (NIL != text) {
							string_utilities.indent(output_stream, indent_num);
							{
								SubLObject value = format_nil.format_nil_a(
										list_utilities.alist_lookup(grouping_key_tuples, text, UNPROVIDED, UNPROVIDED));
								if (NIL == cycl_prefixP) {
									value = string_utilities.remove_substring(value, $str_alt79$__);
								}
						...
						if (NIL != other_bindings) {
							{
								...
								for (element = cdolist_list_var_9
										.first(); NIL != cdolist_list_var_9; cdolist_list_var_9 = cdolist_list_var_9
												.rest(), element = cdolist_list_var_9.first()) {
									com.cyc.cycjava.cycl.xml_utilities.query_bindings_to_xml(other_bindings, element,
											add(indent_num, TWO_INTEGER), output_stream, cycl_prefixP);
								}
							}
						}
						string_utilities.indent(output_stream, indent_num);
	...
	public static SubLObject write_xml_from_grouped_bindings(final SubLObject grouped_bindings,
			final SubLObject xml_spec, final SubLObject indent_num, final SubLObject output_stream,
			final SubLObject cycl_prefixP) {
		...
		while (NIL != cdolist_list_var) {
			...
			if (grouping_key_tuples.isList()) {
				...
				while (NIL != cdolist_list_var_$9) {
					SubLObject value = format_nil.format_nil_a(
							list_utilities.alist_lookup(grouping_key_tuples, attribute_var, UNPROVIDED, UNPROVIDED));
					if (NIL == cycl_prefixP) {
						value = string_utilities.remove_substring(value, $str83$__);
					}
					format(output_stream, $str84$__A__A, getf(reverse(attributes), attribute_var, UNPROVIDED),
							string_utilities.quote_string(value, UNPROVIDED));
			...
			if ((NIL != elements) || (NIL != text)) {
				...
				if (NIL != text) {
					string_utilities.indent(output_stream, indent_num);
					SubLObject value2 = format_nil.format_nil_a(
							list_utilities.alist_lookup(grouping_key_tuples, text, UNPROVIDED, UNPROVIDED));
					if (NIL == cycl_prefixP) {
				...
				if (NIL != other_bindings) {
					...
					while (NIL != cdolist_list_var_$10) {
						query_bindings_to_xml(other_bindings, element, add(indent_num, TWO_INTEGER), output_stream,
								cycl_prefixP);
	...
	public static final SubLObject query_bindings_to_xml_alt(SubLObject query_bindings,
			SubLObject query_result_xml_spec, SubLObject indent_num, SubLObject output_stream,
			SubLObject cycl_prefixP) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				...
				if (NIL != sort_asc) {
					query_results = reverse(
							com.cyc.cycjava.cycl.xml_utilities.sort_query_results_on_el_var(query_bindings, sort_asc));
				} else {
					if (NIL != sort_desc) {
						query_results = com.cyc.cycjava.cycl.xml_utilities.sort_query_results_on_el_var(query_bindings,
								sort_desc);
					}
				}
				if (NIL != text) {
				...
				}
				{
					...
					for (query_result = cdolist_list_var
							.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var
									.rest(), query_result = cdolist_list_var.first()) {
						if (NIL != grouping_keys) {
							{
								...
								SubLObject binding = NIL;
								for (binding = cdolist_list_var_12
										.first(); NIL != cdolist_list_var_12; cdolist_list_var_12 = cdolist_list_var_12
												.rest(), binding = cdolist_list_var_12.first()) {
									{
								...
								other_bindings_by_el_value_tuples = list_utilities.alist_push(
										other_bindings_by_el_value_tuples, grouping_key_tuples, query_result,
										symbol_function(EQUAL));
							}
						} else {
							other_bindings_by_el_value_tuples = list_utilities.alist_push(
									other_bindings_by_el_value_tuples, count, query_result, symbol_function(EQUAL));
							count = number_utilities.f_1X(count);
						}
					}
				}
				com.cyc.cycjava.cycl.xml_utilities.write_xml_from_grouped_bindings(other_bindings_by_el_value_tuples,
						query_result_xml_spec, indent_num, output_stream, cycl_prefixP);
			}
			return T;
		}
	}

	public static SubLObject query_bindings_to_xml(final SubLObject query_bindings,
			final SubLObject query_result_xml_spec, final SubLObject indent_num, final SubLObject output_stream,
			final SubLObject cycl_prefixP) {
		final SubLThread thread = SubLProcess.currentSubLThread();
		SubLObject query_results = query_bindings;
		...
		while (NIL != cdolist_list_var) {
			if (NIL != grouping_keys) {
				...
				other_bindings_by_el_value_tuples = list_utilities.alist_push(other_bindings_by_el_value_tuples,
						grouping_key_tuples, query_result, symbol_function(EQUAL));
			} else {
				other_bindings_by_el_value_tuples = list_utilities.alist_push(other_bindings_by_el_value_tuples, count,
						query_result, symbol_function(EQUAL));
				count = number_utilities.f_1X(count);
			}
			cdolist_list_var = cdolist_list_var.rest();
			query_result = cdolist_list_var.first();
		}
		write_xml_from_grouped_bindings(other_bindings_by_el_value_tuples, query_result_xml_spec, indent_num,
				output_stream, cycl_prefixP);
		return T;
	}
	...
	public static final SubLObject get_default_xml_spec_for_el_vars_alt(SubLObject el_vars) {
		{
			...
			for (el_var = cdolist_list_var.first(); NIL != cdolist_list_var; cdolist_list_var = cdolist_list_var
					.rest(), el_var = cdolist_list_var.first()) {
				xml_spec = cconcatenate(format_nil.format_nil_a_no_copy(xml_spec),
						new SubLObject[] { $str_alt88$__name__,
								format_nil.format_nil_a_no_copy(Strings.string_downcase(
										cycl_variables.el_var_name_without_prefix(el_var), UNPROVIDED, UNPROVIDED)),
								$str_alt89$___text_, format_nil.format_nil_a_no_copy(el_var), $str_alt90$__ });
			}
	...
	public static SubLObject get_default_xml_spec_for_el_vars(final SubLObject el_vars) {
		...
		while (NIL != cdolist_list_var) {
			xml_spec = cconcatenate(format_nil.format_nil_a_no_copy(xml_spec),
					new SubLObject[] { $str92$__name__,
							format_nil.format_nil_a_no_copy(Strings.string_downcase(
									cycl_variables.el_var_name_without_prefix(el_var), UNPROVIDED, UNPROVIDED)),
							$str93$___text_, format_nil.format_nil_a_no_copy(el_var), $str94$__ });
			cdolist_list_var = cdolist_list_var.rest();
			el_var = cdolist_list_var.first();
		}
	...
	public static final SubLObject query_bindings_to_xml_stream_alt(SubLObject el_bindings, SubLObject xml_spec,
			SubLObject indent_num, SubLObject stream, SubLObject cycl_prefixP) {
		...
		}
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				...
				try {
					...
					com.cyc.cycjava.cycl.xml_utilities.xml_terpri();
					com.cyc.cycjava.cycl.xml_utilities.query_bindings_to_xml(el_bindings, xml_spec, indent_num, stream,
							cycl_prefixP);
	...
	public static SubLObject query_bindings_to_xml_stream(final SubLObject el_bindings, final SubLObject xml_spec,
			final SubLObject indent_num, final SubLObject stream, SubLObject cycl_prefixP) {
		if (cycl_prefixP == UNPROVIDED) {
			cycl_prefixP = T;
		}
		final SubLThread thread = SubLProcess.currentSubLThread();
	...
	public static final SubLObject query_results_to_xml_stream_alt(SubLObject query_sent, SubLObject query_mt,
			SubLObject query_properties, SubLObject xml_spec, SubLObject stream) {
		...
		}
		{
			...
			com.cyc.cycjava.cycl.xml_utilities.query_bindings_to_xml_stream(el_bindings, xml_spec, TWO_INTEGER, stream,
					UNPROVIDED);
		}
		return stream;
	}

	public static SubLObject query_results_to_xml_stream(final SubLObject query_sent, SubLObject query_mt,
			SubLObject query_properties, SubLObject xml_spec, SubLObject stream) {
		if (query_mt == UNPROVIDED) {
			query_mt = NIL;
		}
	...
	public static SubLObject download_xml_url(final SubLObject url, SubLObject source_file, SubLObject accept_types,
			SubLObject follow_redirectsP) {
		...
		final SubLThread thread = SubLProcess.currentSubLThread();
		assert NIL != web_utilities.url_p(url) : "! web_utilities.url_p(url) "
				+ ("web_utilities.url_p(url) " + "CommonSymbols.NIL != web_utilities.url_p(url) ") + url;
		if (NIL == source_file) {
		...
		if (NIL == error_message) {
			...
			try {
				...
				if (file_length(s).numL($int$2000)) {
					final SubLObject contents = string_utilities.read_string_from_file(source_file, UNPROVIDED,
							UNPROVIDED);
					if ((NIL != search($$$404, contents, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED,
							UNPROVIDED))
							&& (NIL != search($$$Not_Found, contents, symbol_function(EQUALP), UNPROVIDED, UNPROVIDED,
									UNPROVIDED, UNPROVIDED, UNPROVIDED))) {
						error_message = $str106$Url_not_found_;
					} else if (NIL != search($str107$503_Service_Temporarily_Unavailab, contents, UNPROVIDED,
							UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED)) {
						error_message = $$$Server_not_available;
					} else if (NIL == string_utilities.starts_with_by_test(contents, $str109$__xml,
						...
						error_message = cconcatenate($str110$Not_XML_document__Starts_with_,
								format_nil.format_nil_s_no_copy(snippet));
					}
	...
	public static final SubLObject query_results_to_xml_file_alt(SubLObject query_sent, SubLObject file,
			SubLObject query_mt, SubLObject query_properties, SubLObject xml_spec) {
		if (query_mt == UNPROVIDED) {
			query_mt = NIL;
		}
		if (query_properties == UNPROVIDED) {
		...
		}
		{
			...
			try {
				...
				}
				{
					...
					com.cyc.cycjava.cycl.xml_utilities.query_results_to_xml_stream(query_sent, query_mt,
							query_properties, xml_spec, s_out);
				}
			} finally {
				{
	...
	public static SubLObject query_results_to_xml_file(final SubLObject query_sent, final SubLObject file,
			SubLObject query_mt, SubLObject query_properties, SubLObject xml_spec) {
		if (query_mt == UNPROVIDED) {
			query_mt = NIL;
		}
	...
	public static final SubLObject query_results_to_xml_string_alt(SubLObject query_sent, SubLObject query_mt,
			SubLObject query_properties, SubLObject xml_spec) {
		if (query_mt == UNPROVIDED) {
			query_mt = NIL;
		}
		if (query_properties == UNPROVIDED) {
		...
		}
		{
			...
			try {
				stream = make_private_string_output_stream();
				com.cyc.cycjava.cycl.xml_utilities.query_bindings_to_xml_stream(el_bindings, xml_spec, TWO_INTEGER,
						stream, UNPROVIDED);
	...
	public static SubLObject query_results_to_xml_string(final SubLObject query_sent, SubLObject query_mt,
			SubLObject query_properties, SubLObject xml_spec) {
		if (query_mt == UNPROVIDED) {
			query_mt = NIL;
		}
	...
	public static final SubLObject declare_xml_utilities_file_alt() {
		...
		declareFunction("remove_invalid_xml_name_chars_from_ascii_string",
				"REMOVE-INVALID-XML-NAME-CHARS-FROM-ASCII-STRING", 1, 0, false);
		declareFunction("remove_invalid_xml_name_chars_from_non_ascii_string",
				"REMOVE-INVALID-XML-NAME-CHARS-FROM-NON-ASCII-STRING", 1, 0, false);
		...
		declareFunction("possible_xml_numeric_character_reference_p", "POSSIBLE-XML-NUMERIC-CHARACTER-REFERENCE-P", 1,
				0, false);
	...
	public static SubLObject declare_xml_utilities_file() {
		if (SubLFiles.USE_V1) {
			...
			declareFunction("possible_xml_entity_reference_p", "POSSIBLE-XML-ENTITY-REFERENCE-P", 1, 2, false);
			declareFunction("possible_xml_entity_name_p", "POSSIBLE-XML-ENTITY-NAME-P", 1, 0, false);
			declareFunction("possible_xml_numeric_character_reference_p", "POSSIBLE-XML-NUMERIC-CHARACTER-REFERENCE-P",
					1, 0, false);
			declareFunction("valid_xml_entity_name_first_char_p", "VALID-XML-ENTITY-NAME-FIRST-CHAR-P", 1, 0, false);
			declareFunction("valid_xml_entity_name_char_p", "VALID-XML-ENTITY-NAME-CHAR-P", 1, 0, false);
			declareMacro("with_xml_output_to_stream", "WITH-XML-OUTPUT-TO-STREAM");
	...
	static private final SubLString $str_alt4$Skipping_invalid_xml_character__S = makeString(
			"Skipping invalid xml character ~S in ~S");
	...
	static private final SubLList $list_alt21 = list(list(makeSymbol("NAME"), makeSymbol("&OPTIONAL"),
			makeSymbol("ATTRIBUTES"), makeSymbol("ATOMIC?"), makeSymbol("NO-NESTED-ELEMENTS?")), makeSymbol("&BODY"),
			makeSymbol("BODY"));
	...
	static private final SubLList $list_alt35 = list(makeInteger(46), makeInteger(45), makeInteger(95),
			makeInteger(58));

	public static final SubLObject $list_alt36 = com.cyc.cycjava.cycl.xml_utilities._constant_36_initializer();

	static private final SubLList $list_alt37 = list(list(makeInteger(19968), makeInteger(40869)),
			list(makeInteger(12295), makeInteger(12295)), list(makeInteger(12321), makeInteger(12329)));

	static private final SubLList $list_alt38 = list(makeSymbol("LOW"), makeSymbol("HIGH"));

	static private final SubLList $list_alt39 = list(CHAR_ampersand, CHAR_quotation, CHAR_quote, CHAR_greater,
			CHAR_less, CHAR_newline);
	...
	static private final SubLString $str_alt69$Couldn_t_resolve__S_based_on__S_a = makeString(
			"Couldn't resolve ~S based on ~S and ~S.");
	...
	static private final SubLString $str_alt87$__name__binding___elements__ = makeString(
