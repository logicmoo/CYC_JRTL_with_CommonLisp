...
import com.cyc.cycjava.cycl.predicate_strengthener;
...
import static com.cyc.cycjava.cycl.predicate_strengthener.*;
...
public final class predicate_strengthener extends SubLTranslatedFile {
    ...
    public static SubLObject constraint_p(final SubLObject v_object) {
        return v_object.getClass() == predicate_strengthener.$constraint_native.class ? T : NIL;
    }

    public static SubLObject constraint_variable(final SubLObject v_object) {
        assert NIL != constraint_p(v_object) : "predicate_strengthener.constraint_p(v_object) " + "CommonSymbols.NIL != predicate_strengthener.constraint_p(v_object) " + v_object;
    ...
    public static SubLObject make_constraint(SubLObject arglist) {
        ...
        final SubLObject v_new = new predicate_strengthener.$constraint_native();
        SubLObject next;
    ...
    public static final class $constraint_native extends SubLStructNative {
        ...
        static {
            structDecl = makeStructDeclNative(predicate_strengthener.$constraint_native.class, CONSTRAINT, CONSTRAINT_P, $list48, $list49, new String[]{ "$variable", "$isa_list", "$genl_list" }, $list50, $list51, PRINT_CONSTRAINT);
        }
    }
