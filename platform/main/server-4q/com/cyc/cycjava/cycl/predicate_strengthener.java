...
import com.cyc.tool.subl.util.SubLTranslatedFile; 
 public final class predicate_strengthener extends SubLTranslatedFile {
    ...
    public static SubLObject init_predicate_strengthener_file() {
        ...
        deflexical("*REFORMULATOR-RULES-TO-USE*", SubLSystemTrampolineFile.maybeDefault($reformulator_rules_to_use$, $reformulator_rules_to_use$, NIL));
        deflexical("*REFORMULATOR-RULES-TO-IGNORE*", SubLSystemTrampolineFile.maybeDefault($reformulator_rules_to_ignore$, $reformulator_rules_to_ignore$, NIL));
