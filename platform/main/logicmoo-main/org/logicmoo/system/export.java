...
public final class export extends SubLTranslatedFile {
	...
	public static SubLObject dt() throws Exception {
	...
	private static final SubLList $list108 = list(new SubLObject[] { makeSymbol("ASSERTED-ASSERTION?"), makeSymbol("DEDUCED-ASSERTION?"), makeSymbol("CODE-ASSERTION?"), makeSymbol("ASSERTION-HAS-DEPENDENTS-P"), makeSymbol("ASSERTION-VARIABLE-GUARD"), makeSymbol("ASSERTED-BY"), makeSymbol("ASSERTED-WHEN"), makeSymbol("ASSERTION-HAS-META-ASSERTIONS?"), makeSymbol("SYNTACTICALLY-ILL-FORMED-ASSERTION?"),
			...
			makeSymbol("INFERENCE-RELEVANT-ASSERTION?"), makeSymbol("INFERENCE-IRRELEVANT-ASSERTION?"), makeSymbol("INDIRECT-LEXICAL-ASSERTION?"), makeSymbol("IMPLEMENTATION-ASSERTION?"), makeSymbol("HAS-GENSTRING-ASSERTION?"), makeSymbol("FALSE-ASSERTION?"), makeSymbol("CURRENTLY-FORWARD-PROPAGATING-ASSERTION?"), makeSymbol("CONTEXTUALLY-DEPENDENT-LEXICAL-ASSERTION?"), makeSymbol("COMPUTED-SKOLEM-ASSERTION?"),
			makeSymbol("CHECK-FOR-ISOMORPHIC-ASSERTION?"), makeSymbol("BACKWARD-RULE-REQUIRED-FOR-ASSERTION?"), makeSymbol("NOT-ASSERTIBLE-ASSERTION-P"), makeSymbol("GEN-TEMPLATE-QUERY-SENTENCE-ASSERTION-P"), makeSymbol("RULE-META-ASSERTION-P"), makeSymbol("FTEMPLATE-POLYCANONICALIZED-ASSERTION-P"), makeSymbol("UNBOUND-RULE-ASSERTION-P"), makeSymbol("LIFTING-ASSERTION-P"),
			makeSymbol("ASSERTION-PRODUCED-BY-TEMPORAL-PROJECTION?"), makeSymbol("ABNORMAL-ASSERTION-P"), makeSymbol("ABBREVIATION-ASSERTION-P"), makeSymbol("TVA-ASSERTION-P"), makeSymbol("TERM-OF-UNIT-ASSERTION-P"), makeSymbol("LIST-OF-RULE-ASSERTION-P"), makeSymbol("DOCUMENTATION-ASSERTION-P"), makeSymbol("BOOKKEEPING-ASSERTION-P"), makeSymbol("META-ASSERTION-P"), makeSymbol("HIGHER-ORDER-ASSERTION-P"),
			makeSymbol("GTQS-ASSERTION-P"), makeSymbol("CVA-ASSERTION-P"), makeSymbol("ASSERTION-NEEDS-REVIEW-P"), makeSymbol("ASSERTION-USES-NON-EXTENSIONAL-SET?"), makeSymbol("ASSERTION-SYNTACTICALLY-ILLFORMED?") });
