...
public final class export extends SubLTranslatedFile {
	...
	plw_term(list(Functions.funcall(makeFunctionSymbol("SUPPORT-MT"), d), Functions.funcall(makeFunctionSymbol("SUPPORT-SENTENCE"), d), Symbols.symbol_name(Functions.funcall(makeFunctionSymbol("SUPPORT-TRUTH"), d)),
		Symbols.symbol_name(Functions.funcall(makeFunctionSymbol("SUPPORT-STRENGTH"), d)), Symbols.symbol_name(Functions.funcall(makeFunctionSymbol("SUPPORT-MODULE"), d))), UNPROVIDED);
	return NIL;
    }
	...
	{
	    SubLObject nfound = Sequences.substitute(Characters.CHAR_underbar, Characters.CHAR_hyphen, Sequences.substitute(Characters.CHAR_underbar, Characters.CHAR_colon, found, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED,
		    UNPROVIDED);
	...
	// declareFunction("te2c", "TE2C", 0, 0, false);
	declareFunction("force_print", "FORCE-PRINT", 1, 0, false);
	// declareFunction("trans", "TRANS", 0, 0, false);
	declareFunction("plw_str", "PLW-STR", 1, 0, false);
	declareFunction("plw_nl", "PLW-NL", 0, 0, false);
	declareFunction("prolog_no_need_quote", "PROLOG-NO-NEED-QUOTE", 1, 0, false);
	declareFunction("prolog_need_quote", "PROLOG-NEED-QUOTE", 1, 0, false);
	declareFunction("plw_list", "PLW-LIST", 1, 3, false);
	declareFunction("plw_cdr", "PLW-CDR", 1, 3, false);
	declareFunction("plw_atom", "PLW-ATOM", 1, 1, false);
	declareFunction("simple_name", "SIMPLE-NAME", 1, 0, false);
	declareFunction("plw_naut", "PLW-NAUT", 2, 0, false);
	declareFunction("assertion_varnames", "ASSERTION-VARNAMES", 1, 0, false);
	declareFunction("plw_dotl", "PLW-DOTL", 1, 0, false);
	declareFunction("plw_argz", "PLW-ARGZ", 2, 0, false);
	declareFunction("plw_string", "PLW-STRING", 1, 0, false);
	declareFunction("rsw", "RSW", 1, 0, false);
	declareFunction("split", "SPLIT", 1, 0, false);
	declareFunction("unescape", "UNESCAPE", 1, 0, false);
	declareFunction("plw_term", "PLW-TERM", 1, 1, false);
	// declareFunction("plw_term_cons", "PLW-TERM-CONS", 1, 1,
	// false);
	// declareFunction("pre_export", "PRE-EXPORT", 0, 0, false);
	// declareFunction("constant_prolog_name",
	// "CONSTANT-PROLOG-NAME", 1, 0, false);
	// declareFunction("plw_writel", "PLW-WRITEL", 1, 0, false);
	declareFunction("showa", "SHOWA", 1, 1, false);
	// declareFunction("plw_ruleinfo", "PLW-RULEINFO", 1, 1, false);
	declareFunction("assertion_variable_guard", "ASSERTION-VARIABLE-GUARD", 1, 0, false);
	// declareFunction("ri", "RI", 0, 0, false);
	// declareFunction("ruleinfo", "RULEINFO", 2, 1, false);
	// //declareMacro("no_errors", "NO-ERRORS");
	// //declareFunction("my_funcall", "MY-FUNCALL", 3, 0, false);
	// declareFunction("ruleinfo_not", "RULEINFO-NOT", 2, 1, false);
	// declareFunction("mruleinfo", "MRULEINFO", 1, 0, false);
	// declareFunction("remove_string_ending",
	// "REMOVE-STRING-ENDING", 2, 0, false);
	// declareFunction("remove_string_starting",
	// "REMOVE-STRING-STARTING", 2, 0, false);
	// declareFunction("simple_type_str", "SIMPLE-TYPE-STR", 1, 0,
	// false);
	// declareFunction("rana", "RANA", 0, 1, false);
	// declareFunction("w", "W", 0, 1, false);
	// declareFunction("w0", "W0", 0, 1, false);
	// declareFunction("plw_support", "PLW-SUPPORT", 1, 0, false);
	// declareFunction("plw_id", "PLW-ID", 2, 0, false);
	// declareFunction("plw_deduction", "PLW-DEDUCTION", 1, 0,
	// false);
	// declareFunction("foc", "FOC", 1, 0, false);
	// declareFunction("ds", "DS", 0, 0, false);
	// declareFunction("ds1", "DS1", 1, 0, false);
	// declareFunction("dt", "DT", 0, 0, false);
	declareFunction("dumpt", "DUMPT", 0, 3, false);
	declareFunction("et", "ET", 0, 0, false);
	declareFunction("save_constsl", "SAVE-CONSTSL", 0, 0, false);
	declareFunction("save_consts2", "SAVE-CONSTS2", 0, 0, false);
	declareFunction("check_consts", "CHECK-CONSTS", 0, 0, false);
	declareFunction("check_consts2", "CHECK-CONSTS2", 0, 0, false);
	declareFunction("simplrename", "SIMPLRENAME", 1, 0, false);
	return NIL;
    }
    ...
    private static final SubLList $list90 = list(makeSymbol("FUNCTION"), list(makeSymbol("LAMBDA"), list(makeSymbol("&REST"), makeSymbol("WHATEVAH")), list(makeSymbol("CSETQ"), makeSymbol("HADERROR"), makeSymbol("*ERROR-MESSAGE*")),
	    list(makeSymbol("FORMAT"), makeSymbol("*TERMINAL-IO*"), makeString("~&~&~&~&;; made-handler ~S durring: ~S ~S ~&"), makeSymbol("*ERROR-MESSAGE*"), makeSymbol("WHATEVAH"), makeSymbol("CODE")), list(makeSymbol("RET"), makeSymbol("HADERROR"))));
    ...
    private static final SubLList $list101 = list(makeSymbol("LAMBDA"), list(makeSymbol("&REST"), makeSymbol("WHATEVAH")), list(makeSymbol("CSETQ"), makeSymbol("HADERROR"), makeSymbol("*ERROR-MESSAGE*")),
	    list(makeSymbol("FORMAT"), makeSymbol("*TERMINAL-IO*"), makeString("~&~&~&~&;; made-handler ~S durring: ~S ~S ~&"), makeSymbol("*ERROR-MESSAGE*"), makeSymbol("WHATEVAH"), makeSymbol("CODE")), list(makeSymbol("RET"), makeSymbol("HADERROR")));
    ...
    private static final SubLList $list104 = list(new SubLObject[] { makeSymbol("SELF-LOOPING-RULE?"), makeSymbol("PROOF-VIEW-PRUNING-RULE?"), makeSymbol("SELF-EXPANDING-RULE?"), makeSymbol("INERT-RULE?"), makeSymbol("LOOKS-LIKE-KAPPA-REPHRASE-RULE?"), makeSymbol("EXPANSION-RULE?"),
	    makeSymbol("APPEARS-IN-FORWARD-REIFICATION-RULE?"), makeSymbol("PSP-TRACED-RULE?"), makeSymbol("UNIVERSAL-LIFTING-RULE?"), makeSymbol("DECONTEXTUALIZED-RULE?"), makeSymbol("SOME-SUGGESTED-PRAGMA-SENTENCES-FOR-RULE?"), makeSymbol("CURRENT-NC-RULE?"),
	    makeSymbol("SINGLE-LITERAL-ANTECEDENT-RULE?"), makeSymbol("CONSIDERED-BUT-NOT-SUCCESSFUL-RULE?"), makeSymbol("CONSTRAINT-RULE?"), makeSymbol("LIFTING-CONSEQUENT-RULE?"), makeSymbol("ASSERTIVE-WFF-RULE?"), makeSymbol("TWO-LITERAL-ANTECEDENT-RULE?"), makeSymbol("REWRITE-RULE?"),
	    makeSymbol("SINGLE-LITERAL-RULE?"), makeSymbol("OBSOLETE-RULE?"), makeSymbol("SKOLEM-RULE?"), makeSymbol("FORWARD-TMS-RULE?"), makeSymbol("CYCL-REFORMULATION-RULE?"), makeSymbol("IS-KNOWN-ILP-EXPORT-RULE?"), makeSymbol("VERBOSIFIED-EL-RULE?"), makeSymbol("PPH-REQUIRED-RULE?"),
	    makeSymbol("NON-ABDUCIBLE-RULE?"), makeSymbol("CYCL-REFORMULATOR-RULE?"), makeSymbol("LIFTING-RULE?") });
    ...
    private static final SubLList $list108 = list(new SubLObject[] { makeSymbol("ASSERTED-ASSERTION?"), makeSymbol("DEDUCED-ASSERTION?"), makeSymbol("CODE-ASSERTION?"), makeSymbol("ASSERTION-HAS-DEPENDENTS-P"), makeSymbol("ASSERTION-VARIABLE-GUARD"), makeSymbol("ASSERTED-BY"),
	    makeSymbol("ASSERTED-WHEN"), makeSymbol("ASSERTION-HAS-META-ASSERTIONS?"), makeSymbol("SYNTACTICALLY-ILL-FORMED-ASSERTION?"), makeSymbol("SOME-CONSERVATIVE-VIA-ARG-ASSERTION?"), makeSymbol("RELEVANT-ASSERTION?"), makeSymbol("REFORMULATOR-RELEVANT-ASSERTION?"),
	    makeSymbol("PPH-HL-SUPPORT-WITH-ISOMORPHIC-ASSERTION?"), makeSymbol("OWL-EXPORTABLE-RULE-ASSERTION?"), makeSymbol("NL-TRIE-SYNTACTIC-ASSERTION?"), makeSymbol("IST-SENTENCE-DESIGNATING-ASSERTION?"), makeSymbol("INVALID-ASSERTION?"), makeSymbol("INFERENCE-RELEVANT-ASSERTION?"),
	    makeSymbol("INFERENCE-IRRELEVANT-ASSERTION?"), makeSymbol("INDIRECT-LEXICAL-ASSERTION?"), makeSymbol("IMPLEMENTATION-ASSERTION?"), makeSymbol("HAS-GENSTRING-ASSERTION?"), makeSymbol("FALSE-ASSERTION?"), makeSymbol("CURRENTLY-FORWARD-PROPAGATING-ASSERTION?"),
	    makeSymbol("CONTEXTUALLY-DEPENDENT-LEXICAL-ASSERTION?"), makeSymbol("COMPUTED-SKOLEM-ASSERTION?"), makeSymbol("CHECK-FOR-ISOMORPHIC-ASSERTION?"), makeSymbol("BACKWARD-RULE-REQUIRED-FOR-ASSERTION?"), makeSymbol("NOT-ASSERTIBLE-ASSERTION-P"),
	    makeSymbol("GEN-TEMPLATE-QUERY-SENTENCE-ASSERTION-P"), makeSymbol("RULE-META-ASSERTION-P"), makeSymbol("FTEMPLATE-POLYCANONICALIZED-ASSERTION-P"), makeSymbol("UNBOUND-RULE-ASSERTION-P"), makeSymbol("LIFTING-ASSERTION-P"), makeSymbol("ASSERTION-PRODUCED-BY-TEMPORAL-PROJECTION?"),
	    makeSymbol("ABNORMAL-ASSERTION-P"), makeSymbol("ABBREVIATION-ASSERTION-P"), makeSymbol("TVA-ASSERTION-P"), makeSymbol("TERM-OF-UNIT-ASSERTION-P"), makeSymbol("LIST-OF-RULE-ASSERTION-P"), makeSymbol("DOCUMENTATION-ASSERTION-P"), makeSymbol("BOOKKEEPING-ASSERTION-P"),
	    makeSymbol("META-ASSERTION-P"), makeSymbol("HIGHER-ORDER-ASSERTION-P"), makeSymbol("GTQS-ASSERTION-P"), makeSymbol("CVA-ASSERTION-P"), makeSymbol("ASSERTION-NEEDS-REVIEW-P"), makeSymbol("ASSERTION-USES-NON-EXTENSIONAL-SET?"), makeSymbol("ASSERTION-SYNTACTICALLY-ILLFORMED?") });
