...
public class spoon_test extends SubLTrampolineFile {
	...
	if (NIL != c_structure_tag)
	    return ConsesLow.list(spoon_test.$sym62$_CLEAR_STRUCTURE, ConsesLow.list(spoon_test.$sym63$_NEW_STRUCTURE, c_structure_tag, size), size);
	return ConsesLow.list(spoon_test.$sym64$_CLEAR_SUB_STRUCTURE, ConsesLow.list(spoon_test.$sym63$_NEW_STRUCTURE, spoon_test.$sym65$_DTP_STRUCTURES_BAG_, size), size, type_var);
    }
	...
	return ConsesLow.list(spoon_test.$sym54$CAND, ConsesLow.list(spoon_test.$sym55$_STRUCTURES_BAG_P, object), ConsesLow.list(EQ, ConsesLow.listS(spoon_test.$sym56$_STRUCTURE_SLOT, object, spoon_test.$list57), type_var));
    }
	...
	return ConsesLow.list(spoon_test.$sym12$_REGISTER_METHOD, method_table, dtp_var, ConsesLow.list(spoon_test.$sym13$FUNCTION, method_function));
    }
	...
	SubLObject alias_list = conses_high.second(conses_high.assoc(Symbols.symbol_name(type), spoon_test.$polymorphic_type_hierarchy$.getDynamicValue(thread), Symbols.symbol_function(spoon_test.$sym14$STRING_), UNPROVIDED));
	if (NIL != alias_list) {
	...
	return ConsesLow.listS(spoon_test.$sym2$PROGN, ConsesLow.listS(spoon_test.$sym5$DEFINE, method_function, plain_args, ConsesLow.append(body, NIL)), ConsesLow.append(regmethod_list, NIL));
    }
	...
	return ConsesLow.list(spoon_test.$sym2$PROGN, ConsesLow.listS(spoon_test.$sym3$DEFLEXICAL, method_table_var, spoon_test.$list4),
		ConsesLow.listS(spoon_test.$sym5$DEFINE, name, arglist, ConsesLow.append(doc_string, ConsesLow.list(ConsesLow.listS(spoon_test.$sym6$CLET, ConsesLow.list(ConsesLow.list(method_function_var, ConsesLow.list(spoon_test.$sym7$_METHOD, arglist.first(), method_table_var))),
			ConsesLow.list(spoon_test.$sym8$PWHEN, method_function_var, ConsesLow.list(spoon_test.$sym9$RET, ConsesLow.listS(spoon_test.$sym10$FUNCALL, method_function_var, ConsesLow.append(full_formal_parameter_list(arglist), NIL)))), ConsesLow.append(body, NIL))))));
    }
	...
	SubLObject conc_name = conses_high.second(conses_high.assoc(spoon_test.$kw24$CONC_NAME, options, UNPROVIDED, UNPROVIDED));
	SubLObject print_function = conses_high.second(conses_high.assoc(spoon_test.$kw25$PRINT_FUNCTION, options, UNPROVIDED, UNPROVIDED));
	SubLObject c_structure_tag = conses_high.second(conses_high.assoc(spoon_test.$kw26$C_STRUCTURE_TAG, options, UNPROVIDED, UNPROVIDED));
	SubLObject raw_make_visit_fnP = conses_high.assoc(spoon_test.$kw27$GENERATE_VISIT_FUNCTION_, options, UNPROVIDED, UNPROVIDED);
	SubLObject make_visit_fnP = NIL == raw_make_visit_fnP ? spoon_test.$default_generate_visit_functionP$.getDynamicValue(thread) : conses_high.second(raw_make_visit_fnP);
	...
	return ConsesLow.listS(spoon_test.$kw28$NAME, name, ConsesLow.append(new SubLObject[] { NIL != conc_name ? ConsesLow.list(spoon_test.$kw24$CONC_NAME, conc_name) : NIL, NIL != print_function ? ConsesLow.list(spoon_test.$kw25$PRINT_FUNCTION, print_function) : NIL,
		NIL != c_structure_tag ? ConsesLow.list(spoon_test.$kw26$C_STRUCTURE_TAG, c_structure_tag) : NIL, NIL != make_visit_fnP ? ConsesLow.list(spoon_test.$kw27$GENERATE_VISIT_FUNCTION_, make_visit_fnP, spoon_test.$kw29$HOST_FN_NAME, host_fn_name) : NIL, ConsesLow.list(new SubLObject[] {
			spoon_test.$kw30$PREDICATE, predicate, spoon_test.$kw31$CONSTRUCTOR, constructor, spoon_test.$kw32$TYPE_VAR, type_var, spoon_test.$kw33$SLOTS, slots, spoon_test.$kw34$SLOT_KEYWORDS, slot_keywords, spoon_test.$kw35$GETTERS, getters, spoon_test.$kw36$SETTERS, setters }) }));
    }
	...
	gencaseslots = ConsesLow.cons(ConsesLow.list(spoon_test.$sym88$OTHERWISE, ConsesLow.list(spoon_test.$sym89$ERROR, spoon_test.$str90$Invalid_slot__S_for_construction_, current_arg)), gencaseslots);
	return ConsesLow.list(spoon_test.$sym91$CDO, ConsesLow.list(ConsesLow.list(next, arglist_var, ConsesLow.list(spoon_test.$sym92$CDDR, next))), ConsesLow.list(ConsesLow.list(spoon_test.$sym93$NULL, next)), ConsesLow.list(spoon_test.$sym6$CLET,
		ConsesLow.list(ConsesLow.list(current_arg, ConsesLow.list(spoon_test.$sym94$CAR, next)), ConsesLow.list(current_value, ConsesLow.list(spoon_test.$sym95$CADR, next))), ConsesLow.listS(spoon_test.$sym96$PCASE, current_arg, ConsesLow.append(Sequences.nreverse(gencaseslots), NIL))));
    }
	...
	return ConsesLow.list(spoon_test.$sym5$DEFINE, constructor, arglist,
		ConsesLow.list(spoon_test.$sym6$CLET, ConsesLow.list(ConsesLow.list(new_var, ConsesLow.list(spoon_test.$sym83$_DEFSTRUCT_CONSTRUCT, c_structure_tag, size, type_var, type))), arglist_handler, ConsesLow.list(spoon_test.$sym9$RET, new_var)));
    }
	...
	while (NIL != rest_getters) {
	    forms = ConsesLow.cons(ConsesLow.list(spoon_test.$sym81$_DEF_CSETF, ConsesLow.list(spoon_test.$sym50$QUOTE, getter), ConsesLow.list(spoon_test.$sym50$QUOTE, setter)), forms);
	...
	SubLObject print_function_tail = cdestructuring_bind.property_list_member(spoon_test.$kw25$PRINT_FUNCTION, analysis);
	SubLObject print_function = NIL != print_function_tail ? conses_high.cadr(print_function_tail) : NIL;
	SubLObject c_structure_tag_tail = cdestructuring_bind.property_list_member(spoon_test.$kw26$C_STRUCTURE_TAG, analysis);
	SubLObject c_structure_tag = NIL != c_structure_tag_tail ? conses_high.cadr(c_structure_tag_tail) : NIL;
	SubLObject generate_visit_functionP_tail = cdestructuring_bind.property_list_member(spoon_test.$kw27$GENERATE_VISIT_FUNCTION_, analysis);
	...
	SubLObject host_fn_name_tail = cdestructuring_bind.property_list_member(spoon_test.$kw29$HOST_FN_NAME, analysis);
	...
	SubLObject slot_keywords_tail = cdestructuring_bind.property_list_member(spoon_test.$kw34$SLOT_KEYWORDS, analysis);
	...
	if (NIL != Sequences.find(spoon_test.$kw47$SL2JAVA, reader.$features$.getDynamicValue(thread), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED))
	    c_structure_tag = NIL;
	...
	return ConsesLow.listS(spoon_test.$sym2$PROGN, type_var_form, ConsesLow.append(print_forms, NIL != register_form ? ConsesLow.list(register_form) : NIL, ConsesLow.listS(ConsesLow.list(spoon_test.$sym48$DECLAIM, ConsesLow.list(spoon_test.$sym49$OPTIMIZE_FUNCALL, predicate)), predicate_form,
		ConsesLow.append(getter_forms, setter_forms, def_csetf_forms, ConsesLow.list(constructor_form, ConsesLow.list(IDENTITY, ConsesLow.list(spoon_test.$sym50$QUOTE, name)), NIL != generate_visit_functionP ? host_fn_form : spoon_test.$list51)))));
    }
	...
	return ConsesLow.list(spoon_test.$sym5$DEFINE, getter, arglist, ConsesLow.list(spoon_test.$sym77$CHECK_TYPE, getter_var, predicate), ConsesLow.list(spoon_test.$sym9$RET, ConsesLow.list(spoon_test.$sym78$_DEFSTRUCT_GET_SLOT, getter_var, index, type, slot)));
    }
	...
	statements = ConsesLow.cons(ConsesLow.list(spoon_test.$sym10$FUNCALL, visitor_fn_arg, object_arg, spoon_test.$kw97$BEGIN, ConsesLow.list(spoon_test.$sym50$QUOTE, constructor_fn), size), statements);
	SubLObject index;
	SubLObject slot_keyword;
	...
	for (index = NIL, index = ZERO_INTEGER; index.numL(size); index = Numbers.add(index, ONE_INTEGER)) {
	    ...
	    statements = ConsesLow.cons(ConsesLow.list(spoon_test.$sym10$FUNCALL, visitor_fn_arg, object_arg, spoon_test.$kw98$SLOT, slot_keyword, ConsesLow.list(slot_getter, object_arg)), statements);
	}
	statements = ConsesLow.cons(ConsesLow.list(spoon_test.$sym10$FUNCALL, visitor_fn_arg, object_arg, spoon_test.$kw99$END, ConsesLow.list(spoon_test.$sym50$QUOTE, constructor_fn), size), statements);
	statements = Sequences.nreverse(statements);
	return ConsesLow.list(spoon_test.$sym2$PROGN, ConsesLow.list(spoon_test.$sym5$DEFINE, host_fn, arglist, reader.bq_cons(spoon_test.$sym2$PROGN, ConsesLow.append(statements, NIL)), ConsesLow.list(spoon_test.$sym9$RET, object_arg)),
		ConsesLow.list(spoon_test.$sym100$DEFINE_METHOD, spoon_test.$sym101$VISIT_DEFSTRUCT_OBJECT, reader.bq_cons(ConsesLow.list(spoon_test.$sym102$OBJ, type_name), spoon_test.$list103), ConsesLow.list(spoon_test.$sym9$RET, reader.bq_cons(host_fn, spoon_test.$list104))));
    }
	...
	return ConsesLow.list(spoon_test.$sym5$DEFINE, predicate, arglist, ConsesLow.list(spoon_test.$sym9$RET, ConsesLow.list(spoon_test.$sym75$_DEFSTRUCT_OBJECT_P, predicate_var, c_structure_tag, type_var, type)));
    }
	...
	return ConsesLow.listS(ConsesLow.list(spoon_test.$sym48$DECLAIM, ConsesLow.list(spoon_test.$sym69$FACCESS, spoon_test.$sym70$PRIVATE, print_method)), ConsesLow.list(spoon_test.$sym5$DEFINE, print_method, spoon_test.$list71, reader.bq_cons(print_function, spoon_test.$list72)),
		ConsesLow.append(NIL != c_structure_tag ? NIL : ConsesLow.list(ConsesLow.list(spoon_test.$sym12$_REGISTER_METHOD, spoon_test.$sym73$_PRINT_OBJECT_METHOD_TABLE_, tag_var, ConsesLow.list(spoon_test.$sym13$FUNCTION, print_method))), NIL));
    }
	...
	return intern_accessor(Sequences.cconcatenate(Symbols.symbol_name(name), spoon_test.$str67$_PRINT_FUNCTION_TRAMPOLINE));
    }
	...
	if (NIL != c_structure_tag)
	    return ConsesLow.list(spoon_test.$sym74$_REGISTER_DEFSTRUCT, Symbols.symbol_name(name), c_structure_tag, Sequences.length(slots), ConsesLow.list(spoon_test.$sym50$QUOTE, print_method), ConsesLow.list(spoon_test.$sym50$QUOTE, slots));
	return NIL;
    }
	...
	return ConsesLow.list(spoon_test.$sym5$DEFINE, setter, arglist, ConsesLow.list(spoon_test.$sym77$CHECK_TYPE, object_var, predicate), ConsesLow.list(spoon_test.$sym9$RET, ConsesLow.list(spoon_test.$sym79$_DEFSTRUCT_SET_SLOT, object_var, index, value_var, type, slot)));
    }
	...
	return intern_accessor(Sequences.cconcatenate(spoon_test.$str19$_DTP_, new SubLObject[] { Symbols.symbol_name(name), spoon_test.$str15$_ }));
    }
	...
	return ConsesLow.list(spoon_test.$sym66$DEFCONSTANT, type_var, NIL != c_structure_tag ? c_structure_tag : ConsesLow.list(spoon_test.$sym50$QUOTE, name));
    }

    @SubL(source = "sublisp/complex-special-forms.lisp", position = 7690L)
    public static SubLObject dtp_var(SubLObject name) {
	SubLObject symbol = intern_accessor(Sequences.cconcatenate(spoon_test.$str19$_DTP_, new SubLObject[] { Symbols.symbol_name(name), spoon_test.$str15$_ }));
	return symbol;
    }
	...
	pairs = Sort.sort(pairs, Symbols.symbol_function(spoon_test.$sym111$_), Symbols.symbol_function(spoon_test.$sym112$CDR));
	return pairs;
    }
	...
	spoon_test.$polymorphic_type_hierarchy$ = SubLFiles.defparameter("*POLYMORPHIC-TYPE-HIERARCHY*", spoon_test.$list11);
	...
	return intern_accessor(Sequences.cconcatenate(Symbols.symbol_name(name), new SubLObject[] { spoon_test.$str17$_, Symbols.symbol_name(type), spoon_test.$str18$_METHOD }));
    }
	...
	try {
	    ...
	    symbol = intern_accessor(Sequences.cconcatenate(spoon_test.$str15$_, new SubLObject[] { Symbols.symbol_name(name), spoon_test.$str16$_METHOD_TABLE_ }));
	} finally {
	...
	SubLThread thread = SubLProcess.currentSubLThread();
	if (NIL != spoon_test.$call_profiling_enabledP$.getDynamicValue(thread) && NIL != spoon_test.$call_profiling_table$.getDynamicValue(thread))
	    Hashtables.sethash(name, spoon_test.$call_profiling_table$.getDynamicValue(thread), Numbers.add(Hashtables.gethash_without_values(name, spoon_test.$call_profiling_table$.getDynamicValue(thread), ZERO_INTEGER), ONE_INTEGER));
	return NIL;
    }
	...
	SubLObject body;
	current = body = current.rest();
	return ConsesLow.list(spoon_test.$sym6$CLET, spoon_test.$list106, ConsesLow.list(spoon_test.$sym107$CUNWIND_PROTECT, reader.bq_cons(spoon_test.$sym2$PROGN, ConsesLow.append(body, NIL)), ConsesLow.listS(spoon_test.$sym108$CSETF, place, spoon_test.$list109)));
    }
    ...
    final private static SubLSymbol $sym7$_METHOD;
