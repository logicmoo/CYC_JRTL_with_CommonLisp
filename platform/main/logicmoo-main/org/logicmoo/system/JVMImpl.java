...
public /*abstract*/ class JVMImpl {
	...
	static class ThrowerLoader extends ClassLoader implements Opcodes {
		public static byte[] dump() {
			...
			//groovyjarjarasm.asm.
			MethodVisitor mv;
			cw.visit(Opcodes.V1_5, Opcodes.ACC_PUBLIC + Opcodes.ACC_SUPER, JVMImpl.THROWERNAME, null, "java/lang/Object", new String[] { "org/logicmoo/system/JVMImpl$Thrower" });
			cw.visitSource("JVMImpl.java", null);
			cw.visitInnerClass("org/logicmoo/system/JVMImpl$Thrower", "org/logicmoo/system/JVMImpl", "Thrower", Opcodes.ACC_PUBLIC + Opcodes.ACC_STATIC + Opcodes.ACC_ABSTRACT + Opcodes.ACC_INTERFACE);
			{
				mv = (MethodVisitor) (Object) cw.visitMethod(Opcodes.ACC_PUBLIC, "<init>", "()V", null, null);
				mv.visitCode();
				//Label l0 = new Label();
				//mv.visitLabel(l0);
			...
			{
				mv = (MethodVisitor) (Object) (MethodVisitor) (Object) cw.visitMethod(Opcodes.ACC_PUBLIC, "doThrow", "(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;", null, null);
				mv.visitCode();
				//	Label l0 = new Label();
				//	mv.visitLabel(l0);
	...
	public static RuntimeException doThrow(RuntimeException throwable) {
		...
		//        }
		if (throwable instanceof SubLProcess.TerminationRequest)
			return throwable;
	...
	public static Throwable doThrowObject_hide(final Object throwable, final Object nullOrOneDeclaredThowableOrArrayOfDeclaredThrowables) throws Error {
		...
		if (nullOrOneDeclaredThowableOrArrayOfDeclaredThrowables == null)
	...
	public static Thrower getThrowerOld() {
		if (JVMImpl.thrower == null) {
			if (JVMImpl.throwerClass == null) {
				if (JVMImpl.throwerloader == null)
					JVMImpl.throwerloader = new ThrowerLoader();
				if (JVMImpl.throwerClass == null)
					try {
