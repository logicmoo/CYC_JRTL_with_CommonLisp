	...
	implements Runnable, ConsoleInterface,Serializable
{
	...
	*/
		...
		Reader in, PrintStream out, PrintStream err, boolean interactive)
    {
		...
		//BeanShellCntrl.setSingleton(this);
	...
	*/
    public Interpreter(ConsoleInterface console, NameSpace globalNameSpace) {
		...
		//BeanShellCntrl.setSingleton(console);
		setConsole( console );
    }
	...
	*/
    public Interpreter()
    {
		this( new StringReader(""),
				SystemCurrent.out, SystemCurrent.err, false, null );
        evalOnly = true;
    ...
    public static void main( String [] args )
	{
        ...
        } else
		{
				...
				&& System.getProperty("java.version").startsWith("1.1."))
			{
				...
				src = SystemCurrent.in;

            Reader in = new CommandLineReader( new InputStreamReader(src));
            Interpreter interpreter =
				new Interpreter( in, SystemCurrent.out, SystemCurrent.err, true );
        	interpreter.run();
        }
    }
	...
	*/
		...
		throws EvalError
	{
		...
		String s = ( statements.trim().endsWith(";") ? statements : statements+";" );
        return eval(
	...
	*/
		...
		throws java.io.IOException, ClassNotFoundException
	{
		...
		if ( console != null ) {
			...
			setOut( SystemCurrent.out );
			setErr( SystemCurrent.err );
		}
	}
