...
public  final class user_actions extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_user_actions_file() {
    ...
    declareFunction("action_type_p", "ACTION-TYPE-P", 1, 0, false); new $action_type_p$UnaryFunction();
    ...
    declareFunction("user_action_p", "USER-ACTION-P", 1, 0, false); new $user_action_p$UnaryFunction();
