...
those strings by #$oldConstantName. */
  ...
  public static final SubLObject declare_ke_file() {
    //declareFunction(myName, "ke_create", "KE-CREATE", 1, 0, false);
    //declareFunction(myName, "ke_create_from_serialization", "KE-CREATE-FROM-SERIALIZATION", 2, 0, false);
    //declareFunction(myName, "ke_create_internal", "KE-CREATE-INTERNAL", 1, 1, false);
    declareFunction(myName, "ke_create_now", "KE-CREATE-NOW", 1, 1, false);
    declareFunction(myName, "ke_find_or_create_now", "KE-FIND-OR-CREATE-NOW", 1, 1, false);
    //declareFunction(myName, "ke_recreate_now", "KE-RECREATE-NOW", 1, 0, false);
    //declareFunction(myName, "ke_merge", "KE-MERGE", 2, 0, false);
    //declareFunction(myName, "ke_merge_now", "KE-MERGE-NOW", 2, 0, false);
    //declareFunction(myName, "ke_kill", "KE-KILL", 1, 0, false);
    declareFunction(myName, "ke_kill_now", "KE-KILL-NOW", 1, 0, false);
    //declareFunction(myName, "ke_recreate", "KE-RECREATE", 1, 0, false);
    //declareFunction(myName, "rename_code_constant", "RENAME-CODE-CONSTANT", 2, 0, false);
    //declareFunction(myName, "ke_rename", "KE-RENAME", 2, 0, false);
    //declareFunction(myName, "ke_rename_code_constant", "KE-RENAME-CODE-CONSTANT", 2, 0, false);
    //declareFunction(myName, "ke_rename_internal", "KE-RENAME-INTERNAL", 2, 0, false);
    //declareFunction(myName, "note_old_constant_name", "NOTE-OLD-CONSTANT-NAME", 2, 0, false);
    declareFunction(myName, "ke_rename_now", "KE-RENAME-NOW", 2, 0, false);
    //declareFunction(myName, "ke_assert", "KE-ASSERT", 2, 2, false);
    //declareFunction(myName, "ke_reassert_assertion_now", "KE-REASSERT-ASSERTION-NOW", 3, 0, false);
    //declareFunction(myName, "ke_reassert_assertion_now_int", "KE-REASSERT-ASSERTION-NOW-INT", 3, 0, false);
    //declareFunction(myName, "ke_reassert_assertion", "KE-REASSERT-ASSERTION", 3, 0, false);
    //declareFunction(myName, "ke_repropagate_assertion_now", "KE-REPROPAGATE-ASSERTION-NOW", 1, 0, false);
    //declareFunction(myName, "ke_repropagate_assertion", "KE-REPROPAGATE-ASSERTION", 1, 0, false);
    declareFunction(myName, "ke_assert_now", "KE-ASSERT-NOW", 2, 2, false);
    //declareFunction(myName, "ke_assert_wff_now", "KE-ASSERT-WFF-NOW", 2, 2, false);
    declareFunction(myName, "ke_assert_now_int", "KE-ASSERT-NOW-INT", 5, 0, false);
    //declareFunction(myName, "ke_assert_with_implicature", "KE-ASSERT-WITH-IMPLICATURE", 2, 2, false);
    //declareFunction(myName, "ke_assert_now_with_implicature", "KE-ASSERT-NOW-WITH-IMPLICATURE", 2, 2, false);
    //declareFunction(myName, "ke_assert_with_implicature_int", "KE-ASSERT-WITH-IMPLICATURE-INT", 5, 0, false);
    //declareFunction(myName, "ke_assert_with_implicature_int_assert", "KE-ASSERT-WITH-IMPLICATURE-INT-ASSERT", 5, 0, false);
    //declareFunction(myName, "ke_unassert", "KE-UNASSERT", 2, 0, false);
    //declareFunction(myName, "ke_unassert_assertion", "KE-UNASSERT-ASSERTION", 1, 0, false);
    //declareFunction(myName, "ke_unassert_now", "KE-UNASSERT-NOW", 2, 0, false);
    //declareFunction(myName, "ke_unassert_assertion_now", "KE-UNASSERT-ASSERTION-NOW", 1, 0, false);
    //declareFunction(myName, "ke_edit", "KE-EDIT", 3, 3, false);
    //declareFunction(myName, "ke_edit_now", "KE-EDIT-NOW", 3, 3, false);
    //declareFunction(myName, "ke_edit_assertion", "KE-EDIT-ASSERTION", 2, 3, false);
    //declareFunction(myName, "ke_edit_assertion_preserving_meta_assertions", "KE-EDIT-ASSERTION-PRESERVING-META-ASSERTIONS", 3, 3, false);
    //declareFunction(myName, "ke_edit_assertion_now_preserving_meta_assertions", "KE-EDIT-ASSERTION-NOW-PRESERVING-META-ASSERTIONS", 3, 3, false);
    //declareFunction(myName, "ke_edit_assertion_preserving_meta_assertions_int", "KE-EDIT-ASSERTION-PRESERVING-META-ASSERTIONS-INT", 7, 0, false);
    //declareFunction(myName, "ke_edit_assertion_preserving_all_meta_assertions", "KE-EDIT-ASSERTION-PRESERVING-ALL-META-ASSERTIONS", 2, 3, false);
    //declareFunction(myName, "ke_edit_assertion_now_preserving_all_meta_assertions", "KE-EDIT-ASSERTION-NOW-PRESERVING-ALL-META-ASSERTIONS", 2, 3, false);
    //declareFunction(myName, "ke_null_edit_assertion", "KE-NULL-EDIT-ASSERTION", 1, 0, false);
    //declareFunction(myName, "ke_edit_compute_new_meta_assertion_assertibles", "KE-EDIT-COMPUTE-NEW-META-ASSERTION-ASSERTIBLES", 4, 0, false);
    //declareFunction(myName, "extract_old_meta_assertion_info", "EXTRACT-OLD-META-ASSERTION-INFO", 1, 0, false);
    //declareFunction(myName, "ke_edit_assertion_strings", "KE-EDIT-ASSERTION-STRINGS", 2, 1, false);
    //declareFunction(myName, "ke_recanonicalize_assertion", "KE-RECANONICALIZE-ASSERTION", 1, 1, false);
    //declareFunction(myName, "ke_recanonicalize_assertion_now", "KE-RECANONICALIZE-ASSERTION-NOW", 1, 1, false);
    //declareFunction(myName, "ke_edit_assertion_but_not_bookkeeping", "KE-EDIT-ASSERTION-BUT-NOT-BOOKKEEPING", 2, 4, false);
    //declareFunction(myName, "ke_edit_assertion_now_but_not_bookkeeping", "KE-EDIT-ASSERTION-NOW-BUT-NOT-BOOKKEEPING", 2, 4, false);
    //declareFunction(myName, "formulas_differ_only_in_strings", "FORMULAS-DIFFER-ONLY-IN-STRINGS", 2, 0, false);
    //declareFunction(myName, "tree_equal_ignoring_type", "TREE-EQUAL-IGNORING-TYPE", 3, 1, false);
    //declareFunction(myName, "ke_blast", "KE-BLAST", 2, 0, false);
    //declareFunction(myName, "ke_blast_assertion", "KE-BLAST-ASSERTION", 1, 0, false);
    //declareFunction(myName, "ke_rename_variables", "KE-RENAME-VARIABLES", 3, 0, false);
    //declareFunction(myName, "ke_remove_argument", "KE-REMOVE-ARGUMENT", 3, 0, false);
    //declareFunction(myName, "ke_remove_deduction", "KE-REMOVE-DEDUCTION", 1, 0, false);
    //declareFunction(myName, "ke_tms_reconsider_term", "KE-TMS-RECONSIDER-TERM", 1, 1, false);
    //declareFunction(myName, "ke_tms_reconsider_formula", "KE-TMS-RECONSIDER-FORMULA", 2, 0, false);
    //declareFunction(myName, "ke_tms_reconsider_assertion", "KE-TMS-RECONSIDER-ASSERTION", 1, 0, false);
    //declareFunction(myName, "ke_blast_all_dependents", "KE-BLAST-ALL-DEPENDENTS", 1, 0, false);
    //declareFunction(myName, "ke_change_assertion_direction", "KE-CHANGE-ASSERTION-DIRECTION", 2, 0, false);
    //declareFunction(myName, "ke_change_assertion_strength", "KE-CHANGE-ASSERTION-STRENGTH", 2, 0, false);
    //declareFunction(myName, "ke_change_assertion_mt", "KE-CHANGE-ASSERTION-MT", 2, 1, false);
    //declareFunction(myName, "ke_convert_assertion", "KE-CONVERT-ASSERTION", 2, 2, false);
    declareFunction(myName, "old_constant_names", "OLD-CONSTANT-NAMES", 1, 0, false);
    declareFunction(myName, "initialize_old_constant_names", "INITIALIZE-OLD-CONSTANT-NAMES", 0, 0, false);
    declareFunction(myName, "cache_old_constant_name", "CACHE-OLD-CONSTANT-NAME", 2, 0, false);
    declareFunction(myName, "decache_old_constant_name", "DECACHE-OLD-CONSTANT-NAME", 2, 0, false);
    //declareFunction(myName, "do_edit_op", "DO-EDIT-OP", 1, 0, false);
    //declareFunction(myName, "find_assertions_via_tl", "FIND-ASSERTIONS-VIA-TL", 2, 0, false);
    //declareFunction(myName, "ke_assertion_edit_formula", "KE-ASSERTION-EDIT-FORMULA", 1, 0, false);
    //declareFunction(myName, "ke_assertion_find_formula", "KE-ASSERTION-FIND-FORMULA", 1, 0, false);
    //declareFunction(myName, "cyclist_is_guest", "CYCLIST-IS-GUEST", 0, 0, false);
    //declareFunction(myName, "ensure_cyclist_ok", "ENSURE-CYCLIST-OK", 0, 0, false);
    //declareFunction(myName, "ke_eval_now", "KE-EVAL-NOW", 1, 0, false);
    return NIL;
  }
  ...
  public static final SubLObject init_ke_file() {
    ...
    $ke_edit_use_fi_edit$ = deflexical("*KE-EDIT-USE-FI-EDIT*", ((NIL != Symbols.boundp($sym62$_KE_EDIT_USE_FI_EDIT_)) ? ((SubLObject) $ke_edit_use_fi_edit$.getGlobalValue()) : NIL));
    $old_constant_names_table$ = deflexical("*OLD-CONSTANT-NAMES-TABLE*", ((NIL != Symbols.boundp($sym82$_OLD_CONSTANT_NAMES_TABLE_)) ? ((SubLObject) $old_constant_names_table$.getGlobalValue()) : NIL));
