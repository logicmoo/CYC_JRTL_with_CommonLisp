...
If not found, create a new intermediate index for KEY, with an equality test determined from KEY-HISTORY. */
  ...
  public static final SubLObject declare_kb_indexing_datastructures_file() {
    ...
    declareFunction("indexed_term_p", "INDEXED-TERM-P", 1, 0, false); new $indexed_term_p$UnaryFunction();
    ...
    declareFunction("invalid_indexed_termP", "INVALID-INDEXED-TERM?", 1, 0, false); new $invalid_indexed_termP$UnaryFunction();
    ...
    declareFunction("fully_indexed_term_p", "FULLY-INDEXED-TERM-P", 1, 0, false); new $fully_indexed_term_p$UnaryFunction();
  ...
  public static final SubLObject init_kb_indexing_datastructures_file() {
    $assertion_indexing_store$ = deflexical("*ASSERTION-INDEXING-STORE*", maybeDefault( $sym0$_ASSERTION_INDEXING_STORE_, $assertion_indexing_store$, NIL));
