...
@see quiet-has-type? */
  ...
  public static final SubLObject declare_isa_file() {
    //declareFunction(myName, "isa", "ISA", 1, 2, false);
    //declareFunction(myName, "min_isa", "MIN-ISA", 1, 2, false);
    //declareFunction(myName, "min_isa_in_mt", "MIN-ISA-IN-MT", 2, 0, false);
    //declareFunction(myName, "nat_isa", "NAT-ISA", 1, 2, false);
    //declareFunction(myName, "naut_isa", "NAUT-ISA", 1, 1, false);
    //declareFunction(myName, "not_isa", "NOT-ISA", 1, 2, false);
    //declareFunction(myName, "max_not_isa", "MAX-NOT-ISA", 1, 2, false);
    //declareFunction(myName, "nat_max_not_isa", "NAT-MAX-NOT-ISA", 1, 2, false);
    //declareFunction(myName, "instances", "INSTANCES", 1, 2, false);
    //declareFunction(myName, "max_instances", "MAX-INSTANCES", 1, 2, false);
    //declareFunction(myName, "all_instances_with_max", "ALL-INSTANCES-WITH-MAX", 2, 0, false);
    //declareFunction(myName, "not_instances", "NOT-INSTANCES", 1, 2, false);
    //declareFunction(myName, "min_not_instances", "MIN-NOT-INSTANCES", 1, 2, false);
    //declareFunction(myName, "isa_siblings", "ISA-SIBLINGS", 1, 2, false);
    //declareFunction(myName, "instance_siblings", "INSTANCE-SIBLINGS", 1, 2, false);
    //declareFunction(myName, "map_isa", "MAP-ISA", 2, 2, false);
    //declareFunction(myName, "map_min_isa", "MAP-MIN-ISA", 2, 2, false);
    //declareFunction(myName, "map_instances", "MAP-INSTANCES", 2, 2, false);
    //declareFunction(myName, "min_isas_of_type", "MIN-ISAS-OF-TYPE", 2, 2, false);
    declareFunction(myName, "all_isa", "ALL-ISA", 1, 2, false);
    //declareFunction(myName, "all_isa_in_any_mt", "ALL-ISA-IN-ANY-MT", 1, 0, false);
    //declareFunction(myName, "all_isa_in_mt", "ALL-ISA-IN-MT", 1, 1, false);
    //declareFunction(myName, "all_isa_in_mts", "ALL-ISA-IN-MTS", 1, 1, false);
    //declareFunction(myName, "nat_all_isa", "NAT-ALL-ISA", 1, 2, false);
    declareFunction(myName, "all_instances", "ALL-INSTANCES", 1, 2, false);
    //declareFunction(myName, "all_instances_in_all_mts", "ALL-INSTANCES-IN-ALL-MTS", 1, 0, false);
    //declareFunction(myName, "all_fort_instances", "ALL-FORT-INSTANCES", 1, 2, false);
    //declareFunction(myName, "all_fort_instances_in_all_mts", "ALL-FORT-INSTANCES-IN-ALL-MTS", 1, 0, false);
    //declareFunction(myName, "all_isas_wrt", "ALL-ISAS-WRT", 2, 2, false);
    //declareFunction(myName, "gather_isa_wrt_isa", "GATHER-ISA-WRT-ISA", 1, 0, false);
    //declareFunction(myName, "union_all_isa", "UNION-ALL-ISA", 1, 2, false);
    //declareFunction(myName, "union_all_instances", "UNION-ALL-INSTANCES", 1, 2, false);
    declareFunction(myName, "all_isa_among", "ALL-ISA-AMONG", 2, 2, false);
    //declareFunction(myName, "min_isa_among", "MIN-ISA-AMONG", 2, 2, false);
    //declareFunction(myName, "all_instances_among", "ALL-INSTANCES-AMONG", 2, 2, false);
    //declareFunction(myName, "all_instances_among_fast", "ALL-INSTANCES-AMONG-FAST", 2, 1, false);
    //declareFunction(myName, "all_isa_if", "ALL-ISA-IF", 2, 2, false);
    //declareFunction(myName, "all_instances_if", "ALL-INSTANCES-IF", 2, 2, false);
    //declareFunction(myName, "all_isa_if_with_pruning", "ALL-ISA-IF-WITH-PRUNING", 2, 2, false);
    //declareFunction(myName, "all_not_isa", "ALL-NOT-ISA", 1, 2, false);
    //declareFunction(myName, "all_not_instances", "ALL-NOT-INSTANCES", 1, 2, false);
    //declareFunction(myName, "not_isa_among", "NOT-ISA-AMONG", 2, 2, false);
    //declareFunction(myName, "not_instances_among", "NOT-INSTANCES-AMONG", 0, 0, false);
    //declareFunction(myName, "map_all_isa", "MAP-ALL-ISA", 2, 2, false);
    //declareFunction(myName, "map_all_instances", "MAP-ALL-INSTANCES", 2, 2, false);
    //declareFunction(myName, "any_all_isa", "ANY-ALL-ISA", 2, 2, false);
    //declareFunction(myName, "any_wrt_all_isa", "ANY-WRT-ALL-ISA", 2, 2, false);
    //declareFunction(myName, "any_all_forward_true_nodes_isa", "ANY-ALL-FORWARD-TRUE-NODES-ISA", 3, 2, false);
    //declareFunction(myName, "sample_leaf_instances", "SAMPLE-LEAF-INSTANCES", 1, 3, false);
    //declareFunction(myName, "sample_different_leaf_instances", "SAMPLE-DIFFERENT-LEAF-INSTANCES", 2, 3, false);
    //declareFunction(myName, "sbhl_record_all_isa", "SBHL-RECORD-ALL-ISA", 1, 2, false);
    //declareFunction(myName, "count_all_instances", "COUNT-ALL-INSTANCES", 1, 2, false);
    //declareFunction(myName, "count_all_instances_if", "COUNT-ALL-INSTANCES-IF", 2, 2, false);
    //declareFunction(myName, "count_all_instances_E", "COUNT-ALL-INSTANCES-=", 2, 2, false);
    //declareFunction(myName, "count_all_instances_G", "COUNT-ALL-INSTANCES->", 2, 2, false);
    //declareFunction(myName, "count_all_instances_GE", "COUNT-ALL-INSTANCES->=", 2, 2, false);
    //declareFunction(myName, "count_all_instances_L", "COUNT-ALL-INSTANCES-<", 2, 2, false);
    //declareFunction(myName, "count_all_instances_LE", "COUNT-ALL-INSTANCES-<=", 2, 2, false);
    //declareFunction(myName, "count_all_quoted_instances", "COUNT-ALL-QUOTED-INSTANCES", 1, 2, false);
    //declareFunction(myName, "count_all_quoted_instances_if", "COUNT-ALL-QUOTED-INSTANCES-IF", 2, 2, false);
    //declareFunction(myName, "count_all_quoted_instances_E", "COUNT-ALL-QUOTED-INSTANCES-=", 2, 2, false);
    //declareFunction(myName, "count_all_quoted_instances_G", "COUNT-ALL-QUOTED-INSTANCES->", 2, 2, false);
    //declareFunction(myName, "count_all_quoted_instances_GE", "COUNT-ALL-QUOTED-INSTANCES->=", 2, 2, false);
    //declareFunction(myName, "count_all_quoted_instances_L", "COUNT-ALL-QUOTED-INSTANCES-<", 2, 2, false);
    //declareFunction(myName, "count_all_quoted_instances_LE", "COUNT-ALL-QUOTED-INSTANCES-<=", 2, 2, false);
    declareFunction(myName, "isaP", "ISA?", 2, 2, false);
    //declareFunction(myName, "isa_in_mtsP", "ISA-IN-MTS?", 3, 0, false);
    declareFunction(myName, "isa_in_any_mtP", "ISA-IN-ANY-MT?", 2, 0, false);
    //declareFunction(myName, "nat_isaP", "NAT-ISA?", 2, 2, false);
    //declareFunction(myName, "nat_isa_intP", "NAT-ISA-INT?", 3, 0, false);
    //declareFunction(myName, "result_isa_colP", "RESULT-ISA-COL?", 2, 1, false);
    //declareFunction(myName, "weak_not_result_isa_colP", "WEAK-NOT-RESULT-ISA-COL?", 2, 1, false);
    //declareFunction(myName, "result_isa_arg_colP", "RESULT-ISA-ARG-COL?", 2, 1, false);
    //declareFunction(myName, "weak_not_result_isa_arg_colP", "WEAK-NOT-RESULT-ISA-ARG-COL?", 2, 1, false);
    //declareFunction(myName, "result_isa_inter_arg_colP", "RESULT-ISA-INTER-ARG-COL?", 2, 1, false);
    //declareFunction(myName, "result_isa_inter_arg_reln_colP", "RESULT-ISA-INTER-ARG-RELN-COL?", 2, 1, false);
    //declareFunction(myName, "isaP_goal", "ISA?-GOAL", 1, 0, false);
    //declareFunction(myName, "any_isaP", "ANY-ISA?", 2, 2, false);
    //declareFunction(myName, "isa_anyP", "ISA-ANY?", 2, 2, false);
    //declareFunction(myName, "nat_any_isaP", "NAT-ANY-ISA?", 2, 2, false);
    //declareFunction(myName, "find_if_isaP", "FIND-IF-ISA?", 2, 0, false);
    //declareFunction(myName, "all_isaP", "ALL-ISA?", 2, 2, false);
    //declareFunction(myName, "all_instancesP", "ALL-INSTANCES?", 2, 2, false);
    //declareFunction(myName, "any_isa_anyP", "ANY-ISA-ANY?", 2, 2, false);
    //declareFunction(myName, "not_isaP", "NOT-ISA?", 2, 2, false);
    //declareFunction(myName, "not_isa_someP", "NOT-ISA-SOME?", 2, 2, false);
    //declareFunction(myName, "not_isa_by_sbhlP", "NOT-ISA-BY-SBHL?", 2, 2, false);
    //declareFunction(myName, "not_isa_by_extent_knownP", "NOT-ISA-BY-EXTENT-KNOWN?", 2, 2, false);
    //declareFunction(myName, "argue_not_isaP", "ARGUE-NOT-ISA?", 2, 2, false);
    //declareFunction(myName, "not_isa_in_any_mtP", "NOT-ISA-IN-ANY-MT?", 2, 0, false);
    //declareFunction(myName, "nat_not_isaP", "NAT-NOT-ISA?", 2, 2, false);
    //declareFunction(myName, "why_isaP", "WHY-ISA?", 2, 3, false);
    //declareFunction(myName, "any_just_of_isa", "ANY-JUST-OF-ISA", 2, 1, false);
    //declareFunction(myName, "any_just_of_nat_isa", "ANY-JUST-OF-NAT-ISA", 2, 1, false);
    //declareFunction(myName, "why_not_isaP", "WHY-NOT-ISA?", 2, 3, false);
    //declareFunction(myName, "any_just_of_not_isa", "ANY-JUST-OF-NOT-ISA", 2, 1, false);
    //declareFunction(myName, "any_just_of_nat_not_isa", "ANY-JUST-OF-NAT-NOT-ISA", 2, 1, false);
    //declareFunction(myName, "instancesP", "INSTANCES?", 1, 2, false);
    //declareFunction(myName, "instancesP_int", "INSTANCES?-INT", 1, 2, false);
    //declareFunction(myName, "forts_of_type", "FORTS-OF-TYPE", 2, 2, false);
    //declareFunction(myName, "all_isa_mts", "ALL-ISA-MTS", 1, 0, false);
    //declareFunction(myName, "gather_genls_mts", "GATHER-GENLS-MTS", 1, 0, false);
    //declareFunction(myName, "partial_isa_extensionP", "PARTIAL-ISA-EXTENSION?", 1, 1, false);
    //declareFunction(myName, "random_instance_of", "RANDOM-INSTANCE-OF", 1, 1, false);
    //declareFunction(myName, "min_ceiling_isa", "MIN-CEILING-ISA", 1, 3, false);
    //declareFunction(myName, "nearest_common_isa", "NEAREST-COMMON-ISA", 1, 3, false);
    //declareFunction(myName, "max_floor_instances", "MAX-FLOOR-INSTANCES", 1, 2, false);
    //declareFunction(myName, "max_floor_mts_of_isa_paths_wrt", "MAX-FLOOR-MTS-OF-ISA-PATHS-WRT", 3, 0, false);
    //declareFunction(myName, "max_floor_mts_of_isa_paths", "MAX-FLOOR-MTS-OF-ISA-PATHS", 2, 1, false);
    //declareFunction(myName, "min_mts_of_isa_paths", "MIN-MTS-OF-ISA-PATHS", 2, 1, false);
    //declareFunction(myName, "nat_min_mts_of_isa_paths", "NAT-MIN-MTS-OF-ISA-PATHS", 2, 0, false);
    //declareFunction(myName, "min_mts_of_quoted_isa_paths", "MIN-MTS-OF-QUOTED-ISA-PATHS", 2, 1, false);
    //declareFunction(myName, "nat_min_mts_of_quoted_isa_paths", "NAT-MIN-MTS-OF-QUOTED-ISA-PATHS", 2, 0, false);
    //declareFunction(myName, "gather_min_mts_of_paths_between", "GATHER-MIN-MTS-OF-PATHS-BETWEEN", 1, 0, false);
    //declareFunction(myName, "cache_mts_of_arg", "CACHE-MTS-OF-ARG", 1, 0, false);
    //declareFunction(myName, "max_floor_mts_of_not_isa_paths", "MAX-FLOOR-MTS-OF-NOT-ISA-PATHS", 2, 1, false);
    //declareFunction(myName, "min_mts_of_not_isa_paths", "MIN-MTS-OF-NOT-ISA-PATHS", 2, 1, false);
    //declareFunction(myName, "instantiationP", "INSTANTIATION?", 2, 1, false);
    //declareFunction(myName, "instantiations", "INSTANTIATIONS", 1, 1, false);
    //declareFunction(myName, "all_instantiations", "ALL-INSTANTIATIONS", 1, 1, false);
    //declareFunction(myName, "random_instantiation", "RANDOM-INSTANTIATION", 1, 1, false);
    //declareFunction(myName, "set_naut_p", "SET-NAUT-P", 1, 0, false);
    //declareFunction(myName, "member_of_cycl_setP", "MEMBER-OF-CYCL-SET?", 2, 0, false);
    //declareFunction(myName, "members_of_cycl_set", "MEMBERS-OF-CYCL-SET", 1, 0, false);
    //declareFunction(myName, "random_member_of_cycl_set", "RANDOM-MEMBER-OF-CYCL-SET", 1, 0, false);
    //declareFunction(myName, "isas_mts", "ISAS-MTS", 1, 0, false);
    //declareFunction(myName, "isa_mts", "ISA-MTS", 1, 0, false);
    //declareFunction(myName, "type_mts", "TYPE-MTS", 1, 0, false);
    declareFunction(myName, "asserted_isaP", "ASSERTED-ISA?", 1, 1, false);
    declareFunction(myName, "asserted_isa", "ASSERTED-ISA", 1, 1, false);
    //declareFunction(myName, "asserted_not_isa", "ASSERTED-NOT-ISA", 1, 1, false);
    //declareFunction(myName, "supported_isa", "SUPPORTED-ISA", 1, 1, false);
    //declareFunction(myName, "supported_not_isa", "SUPPORTED-NOT-ISA", 1, 1, false);
    //declareFunction(myName, "asserted_instance", "ASSERTED-INSTANCE", 1, 1, false);
    //declareFunction(myName, "asserted_not_instance", "ASSERTED-NOT-INSTANCE", 1, 1, false);
    //declareFunction(myName, "supported_instance", "SUPPORTED-INSTANCE", 1, 1, false);
    //declareFunction(myName, "supported_not_instance", "SUPPORTED-NOT-INSTANCE", 1, 1, false);
    declareFunction(myName, "instanceof_after_adding", "INSTANCEOF-AFTER-ADDING", 2, 0, false); new $instanceof_after_adding$BinaryFunction();
    declareFunction(myName, "isa_after_adding", "ISA-AFTER-ADDING", 2, 0, false);
    declareFunction(myName, "possibly_propagate_isa_collection_subset_fn_the_set_of", "POSSIBLY-PROPAGATE-ISA-COLLECTION-SUBSET-FN-THE-SET-OF", 1, 0, false);
    declareFunction(myName, "possibly_propagate_isa_the_collection_of", "POSSIBLY-PROPAGATE-ISA-THE-COLLECTION-OF", 1, 0, false);
    //declareFunction(myName, "possibly_propagate_isa_the_set_of", "POSSIBLY-PROPAGATE-ISA-THE-SET-OF", 3, 0, false);
    declareFunction(myName, "instanceof_after_removing", "INSTANCEOF-AFTER-REMOVING", 2, 0, false); new $instanceof_after_removing$BinaryFunction();
    declareFunction(myName, "isa_after_removing", "ISA-AFTER-REMOVING", 2, 0, false);
    //declareFunction(myName, "clear_isa_graph", "CLEAR-ISA-GRAPH", 0, 0, false);
    //declareFunction(myName, "clear_node_isa_links", "CLEAR-NODE-ISA-LINKS", 1, 0, false);
    //declareFunction(myName, "reset_isa_links", "RESET-ISA-LINKS", 1, 0, false);
    //declareFunction(myName, "reset_isa_links_in_mt", "RESET-ISA-LINKS-IN-MT", 2, 0, false);
    //declareFunction(myName, "reset_isa_graph", "RESET-ISA-GRAPH", 0, 1, false);
    //declareFunction(myName, "quoted_isa", "QUOTED-ISA", 1, 2, false);
    //declareFunction(myName, "nat_quoted_isa", "NAT-QUOTED-ISA", 1, 2, false);
    //declareFunction(myName, "not_quoted_isa", "NOT-QUOTED-ISA", 1, 2, false);
    declareFunction(myName, "quoted_isaP", "QUOTED-ISA?", 2, 2, false);
    declareFunction(myName, "quoted_isa_in_any_mtP", "QUOTED-ISA-IN-ANY-MT?", 2, 0, false);
    //declareFunction(myName, "any_quoted_isaP", "ANY-QUOTED-ISA?", 2, 2, false);
    //declareFunction(myName, "quoted_isa_anyP", "QUOTED-ISA-ANY?", 2, 2, false);
    //declareFunction(myName, "all_quoted_isaP", "ALL-QUOTED-ISA?", 2, 2, false);
    //declareFunction(myName, "not_quoted_isaP", "NOT-QUOTED-ISA?", 2, 2, false);
    //declareFunction(myName, "not_quoted_isa_by_sbhlP", "NOT-QUOTED-ISA-BY-SBHL?", 2, 2, false);
    //declareFunction(myName, "not_quoted_isa_by_extent_knownP", "NOT-QUOTED-ISA-BY-EXTENT-KNOWN?", 2, 2, false);
    //declareFunction(myName, "quoted_instances", "QUOTED-INSTANCES", 1, 2, false);
    //declareFunction(myName, "union_all_quoted_instances", "UNION-ALL-QUOTED-INSTANCES", 1, 2, false);
    //declareFunction(myName, "map_all_quoted_isa", "MAP-ALL-QUOTED-ISA", 2, 2, false);
    //declareFunction(myName, "map_all_quoted_instances", "MAP-ALL-QUOTED-INSTANCES", 2, 2, false);
    //declareFunction(myName, "map_quoted_isa", "MAP-QUOTED-ISA", 2, 2, false);
    //declareFunction(myName, "map_min_quoted_isa", "MAP-MIN-QUOTED-ISA", 2, 2, false);
    //declareFunction(myName, "all_quoted_isa", "ALL-QUOTED-ISA", 1, 2, false);
    //declareFunction(myName, "all_quoted_isa_in_any_mt", "ALL-QUOTED-ISA-IN-ANY-MT", 1, 0, false);
    //declareFunction(myName, "all_quoted_isa_in_mt", "ALL-QUOTED-ISA-IN-MT", 1, 1, false);
    //declareFunction(myName, "all_quoted_isa_in_mts", "ALL-QUOTED-ISA-IN-MTS", 1, 1, false);
    //declareFunction(myName, "all_quoted_isas_wrt", "ALL-QUOTED-ISAS-WRT", 2, 2, false);
    //declareFunction(myName, "all_quoted_instances", "ALL-QUOTED-INSTANCES", 1, 2, false);
    //declareFunction(myName, "all_quoted_instances_in_all_mts", "ALL-QUOTED-INSTANCES-IN-ALL-MTS", 1, 0, false);
    //declareFunction(myName, "all_quoted_isa_among", "ALL-QUOTED-ISA-AMONG", 2, 2, false);
    declareFunction(myName, "asserted_quoted_isaP", "ASSERTED-QUOTED-ISA?", 1, 1, false);
    //declareFunction(myName, "asserted_quoted_isa", "ASSERTED-QUOTED-ISA", 1, 1, false);
    declareFunction(myName, "quoted_instanceof_after_adding", "QUOTED-INSTANCEOF-AFTER-ADDING", 2, 0, false);
    //declareFunction(myName, "quoted_instanceof_after_removing", "QUOTED-INSTANCEOF-AFTER-REMOVING", 2, 0, false);
    //declareFunction(myName, "all_instances_via_indexing", "ALL-INSTANCES-VIA-INDEXING", 1, 1, false);
    //declareFunction(myName, "instances_via_indexing", "INSTANCES-VIA-INDEXING", 1, 1, false);
    return NIL;
  }
