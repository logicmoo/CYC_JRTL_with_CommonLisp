...
public  final class sdc extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_sdc_file() {
    //declareMacro(myName, "with_sbhl_sd_marking_spaces", "WITH-SBHL-SD-MARKING-SPACES");
    //declareMacro(myName, "with_sbhl_sd_genls_isas_spaces", "WITH-SBHL-SD-GENLS-ISAS-SPACES");
    declareFunction(myName, "any_isa_common_sdct", "ANY-ISA-COMMON-SDCT", 2, 2, false);
    declareFunction(myName, "any_isa_common_sdct_among", "ANY-ISA-COMMON-SDCT-AMONG", 2, 2, false);
    declareFunction(myName, "sbhl_mark_sd_c1_genls_and_non_c2_genls_isas", "SBHL-MARK-SD-C1-GENLS-AND-NON-C2-GENLS-ISAS", 2, 0, false);
    declareFunction(myName, "sbhl_mark_sd_c1s_genls_and_non_c2_genls_isas", "SBHL-MARK-SD-C1S-GENLS-AND-NON-C2-GENLS-ISAS", 2, 0, false);
    declareFunction(myName, "sbhl_mark_sd_genls_isas", "SBHL-MARK-SD-GENLS-ISAS", 1, 0, false); new $sbhl_mark_sd_genls_isas$UnaryFunction();
    declareFunction(myName, "sbhl_gather_first_sd_or_store_sd_candidates", "SBHL-GATHER-FIRST-SD-OR-STORE-SD-CANDIDATES", 1, 0, false);
    declareFunction(myName, "sbhl_gather_sd_candidates", "SBHL-GATHER-SD-CANDIDATES", 1, 0, false); new $sbhl_gather_sd_candidates$UnaryFunction();
    declareFunction(myName, "sbhl_determine_sd_and_store_candidates", "SBHL-DETERMINE-SD-AND-STORE-CANDIDATES", 1, 0, false); new $sbhl_determine_sd_and_store_candidates$UnaryFunction();
    //declareFunction(myName, "clear_cached_sbhl_sd_relevant_c2_genl_isa_candidateP", "CLEAR-CACHED-SBHL-SD-RELEVANT-C2-GENL-ISA-CANDIDATE?", 0, 0, false);
    //declareFunction(myName, "remove_cached_sbhl_sd_relevant_c2_genl_isa_candidateP", "REMOVE-CACHED-SBHL-SD-RELEVANT-C2-GENL-ISA-CANDIDATE?", 1, 0, false);
    //declareFunction(myName, "cached_sbhl_sd_relevant_c2_genl_isa_candidateP_internal", "CACHED-SBHL-SD-RELEVANT-C2-GENL-ISA-CANDIDATE?-INTERNAL", 1, 0, false);
    //declareFunction(myName, "cached_sbhl_sd_relevant_c2_genl_isa_candidateP", "CACHED-SBHL-SD-RELEVANT-C2-GENL-ISA-CANDIDATE?", 1, 0, false);
    declareFunction(myName, "sbhl_sd_relevant_c2_genl_isa_candidateP", "SBHL-SD-RELEVANT-C2-GENL-ISA-CANDIDATE?", 1, 0, false);
    //declareFunction(myName, "sbhl_determine_sd_and_store_relevant_candidates", "SBHL-DETERMINE-SD-AND-STORE-RELEVANT-CANDIDATES", 1, 0, false);
    declareFunction(myName, "sbhl_determine_sd_path_with_no_exceptions", "SBHL-DETERMINE-SD-PATH-WITH-NO-EXCEPTIONS", 1, 0, false);
    declareFunction(myName, "sbhl_determine_sd_path_with_no_exceptions_among", "SBHL-DETERMINE-SD-PATH-WITH-NO-EXCEPTIONS-AMONG", 1, 0, false);
    //declareFunction(myName, "any_sd_isa_path_excluding_exceptions_p", "ANY-SD-ISA-PATH-EXCLUDING-EXCEPTIONS-P", 3, 0, false);
    //declareFunction(myName, "sbhl_sd_genls_and_genls_isa_path_p", "SBHL-SD-GENLS-AND-GENLS-ISA-PATH-P", 2, 0, false);
    //declareFunction(myName, "sbhl_sd_goal_in_genls_isas_p", "SBHL-SD-GOAL-IN-GENLS-ISAS-P", 1, 0, false);
    //declareFunction(myName, "sdc", "SDC", 1, 1, false);
    //declareFunction(myName, "max_sdc", "MAX-SDC", 1, 1, false);
    //declareFunction(myName, "all_sdc", "ALL-SDC", 1, 1, false);
    //declareFunction(myName, "max_sdc_int", "MAX-SDC-INT", 1, 0, false);
    //declareFunction(myName, "all_sdc_int", "ALL-SDC-INT", 1, 0, false);
    //declareFunction(myName, "remote_sdc_wrt", "REMOTE-SDC-WRT", 2, 1, false);
    //declareFunction(myName, "isa_sdct", "ISA-SDCT", 1, 1, false);
    //declareFunction(myName, "max_isa_sdct", "MAX-ISA-SDCT", 1, 1, false);
    //declareFunction(myName, "applicable_sdct", "APPLICABLE-SDCT", 1, 1, false);
    //declareFunction(myName, "gather_sdct_isas", "GATHER-SDCT-ISAS", 1, 0, false);
    //declareFunction(myName, "gather_if_sdctP", "GATHER-IF-SDCT?", 1, 0, false);
    //declareFunction(myName, "all_isa_sdct", "ALL-ISA-SDCT", 1, 1, false);
    declareFunction(myName, "clear_cached_all_isa_sdct", "CLEAR-CACHED-ALL-ISA-SDCT", 0, 0, false);
    //declareFunction(myName, "remove_cached_all_isa_sdct", "REMOVE-CACHED-ALL-ISA-SDCT", 2, 0, false);
    //declareFunction(myName, "cached_all_isa_sdct_internal", "CACHED-ALL-ISA-SDCT-INTERNAL", 2, 0, false);
    //declareFunction(myName, "cached_all_isa_sdct", "CACHED-ALL-ISA-SDCT", 2, 0, false);
    //declareFunction(myName, "union_all_isa_sdct", "UNION-ALL-ISA-SDCT", 1, 1, false);
    //declareFunction(myName, "sdc_elementP", "SDC-ELEMENT?", 1, 1, false);
    //declareFunction(myName, "sdct_elementP", "SDCT-ELEMENT?", 1, 1, false);
    //declareFunction(myName, "safe_sdct_elementP", "SAFE-SDCT-ELEMENT?", 1, 1, false);
    //declareFunction(myName, "applicable_sdctP", "APPLICABLE-SDCT?", 1, 1, false);
    declareFunction(myName, "sdcP", "SDC?", 2, 1, false);
    declareFunction(myName, "sdc_intP", "SDC-INT?", 2, 0, false);
    declareFunction(myName, "any_sdc_wrtP", "ANY-SDC-WRT?", 2, 1, false); new $any_sdc_wrtP$BinaryFunction();
    //declareFunction(myName, "any_sdc_wrt", "ANY-SDC-WRT", 2, 1, false);
    //declareFunction(myName, "any_sdc_anyP", "ANY-SDC-ANY?", 2, 1, false);
    //declareFunction(myName, "any_sdc_any", "ANY-SDC-ANY", 2, 1, false);
    declareFunction(myName, "sdc_exceptions", "SDC-EXCEPTIONS", 1, 1, false);
    declareFunction(myName, "sdc_exceptions_int", "SDC-EXCEPTIONS-INT", 1, 1, false);
    //declareFunction(myName, "clear_cached_sdc_exceptions", "CLEAR-CACHED-SDC-EXCEPTIONS", 0, 0, false);
    //declareFunction(myName, "remove_cached_sdc_exceptions", "REMOVE-CACHED-SDC-EXCEPTIONS", 1, 0, false);
    //declareFunction(myName, "cached_sdc_exceptions_internal", "CACHED-SDC-EXCEPTIONS-INTERNAL", 1, 0, false);
    //declareFunction(myName, "cached_sdc_exceptions", "CACHED-SDC-EXCEPTIONS", 1, 0, false);
    //declareFunction(myName, "declared_sdc_exceptions", "DECLARED-SDC-EXCEPTIONS", 1, 1, false);
    //declareFunction(myName, "sdc_exceptions_of_genls", "SDC-EXCEPTIONS-OF-GENLS", 1, 1, false);
    //declareFunction(myName, "gather_direct_sdc_exceptions", "GATHER-DIRECT-SDC-EXCEPTIONS", 1, 0, false);
    declareFunction(myName, "direct_sdc_exceptions", "DIRECT-SDC-EXCEPTIONS", 1, 1, false);
    //declareFunction(myName, "direct_sdc_exceptionP", "DIRECT-SDC-EXCEPTION?", 2, 1, false);
    //declareFunction(myName, "collections_sharing_specs", "COLLECTIONS-SHARING-SPECS", 1, 1, false);
    //declareFunction(myName, "sdc_exceptionP", "SDC-EXCEPTION?", 2, 1, false);
    //declareFunction(myName, "declared_sdc_exceptionP", "DECLARED-SDC-EXCEPTION?", 2, 1, false);
    //declareFunction(myName, "remote_sdc_exceptionP", "REMOTE-SDC-EXCEPTION?", 2, 1, false);
    //declareFunction(myName, "any_remote_sdc_exception_pair", "ANY-REMOTE-SDC-EXCEPTION-PAIR", 2, 1, false);
    //declareFunction(myName, "gather_any_genls_sdc_exception", "GATHER-ANY-GENLS-SDC-EXCEPTION", 1, 0, false);
    //declareFunction(myName, "gather_direct_sdc_exception", "GATHER-DIRECT-SDC-EXCEPTION", 1, 0, false);
    //declareFunction(myName, "sdc_common_specP", "SDC-COMMON-SPEC?", 2, 1, false);
    //declareFunction(myName, "remote_sdc_common_specP", "REMOTE-SDC-COMMON-SPEC?", 2, 1, false);
    //declareFunction(myName, "sdct_elements", "SDCT-ELEMENTS", 1, 1, false);
    //declareFunction(myName, "cols_with_applicable_sdct", "COLS-WITH-APPLICABLE-SDCT", 1, 1, false);
    declareFunction(myName, "establishing_supersetP", "ESTABLISHING-SUPERSET?", 2, 2, false);
    declareFunction(myName, "establishing_instance_ofP", "ESTABLISHING-INSTANCE-OF?", 2, 2, false);
    //declareFunction(myName, "why_sdcP", "WHY-SDC?", 2, 2, false);
    //declareFunction(myName, "assemble_sdc_just", "ASSEMBLE-SDC-JUST", 1, 0, false);
    //declareFunction(myName, "any_just_of_sdc", "ANY-JUST-OF-SDC", 2, 1, false);
    //declareFunction(myName, "any_just_of_isa_sdct", "ANY-JUST-OF-ISA-SDCT", 2, 1, false);
    //declareFunction(myName, "why_sdc_exceptionP", "WHY-SDC-EXCEPTION?", 2, 1, false);
    //declareFunction(myName, "why_declared_sdc_exceptionP", "WHY-DECLARED-SDC-EXCEPTION?", 2, 1, false);
    //declareFunction(myName, "why_direct_sdc_exceptionP", "WHY-DIRECT-SDC-EXCEPTION?", 2, 1, false);
    //declareFunction(myName, "why_remote_sdc_exceptionP", "WHY-REMOTE-SDC-EXCEPTION?", 2, 1, false);
    //declareFunction(myName, "why_sdc_common_specP", "WHY-SDC-COMMON-SPEC?", 2, 1, false);
    //declareFunction(myName, "why_remote_common_specP", "WHY-REMOTE-COMMON-SPEC?", 2, 1, false);
    declareFunction(myName, "isa_common_sdctP", "ISA-COMMON-SDCT?", 2, 1, false);
    //declareFunction(myName, "isa_common_sdct_amongP", "ISA-COMMON-SDCT-AMONG?", 2, 1, false);
    //declareFunction(myName, "sdw_error", "SDW-ERROR", 2, 5, false);
    return NIL;
  }
