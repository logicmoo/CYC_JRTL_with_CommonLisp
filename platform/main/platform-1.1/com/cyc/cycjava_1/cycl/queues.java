...
list would contain same-named keys for queue items. */
  ...
  public static final SubLObject declare_queues_file() {
    ...
    declareFunction("queue_p", "QUEUE-P", 1, 0, false); new $queue_p$UnaryFunction();
    ...
    declareFunction("priority_queue_p", "PRIORITY-QUEUE-P", 1, 0, false); new $priority_queue_p$UnaryFunction();
    ...
    declareFunction("pq_collision_enter", "PQ-COLLISION-ENTER", 2, 0, false); new $pq_collision_enter$BinaryFunction();
    ...
    declareFunction("pq_collision_remove", "PQ-COLLISION-REMOVE", 2, 0, false); new $pq_collision_remove$BinaryFunction();
    declareFunction("pq_collision_empty", "PQ-COLLISION-EMPTY", 1, 0, false); new $pq_collision_empty$UnaryFunction();
    declareFunction("lazy_priority_queue_print_function_trampoline", "LAZY-PRIORITY-QUEUE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction("lazy_priority_queue_p", "LAZY-PRIORITY-QUEUE-P", 1, 0, false); new $lazy_priority_queue_p$UnaryFunction();
    ...
    declareFunction("locked_queue_p", "LOCKED-QUEUE-P", 1, 0, false); new $locked_queue_p$UnaryFunction();
    ...
    declareFunction("locked_p_queue_p", "LOCKED-P-QUEUE-P", 1, 0, false); new $locked_p_queue_p$UnaryFunction();
