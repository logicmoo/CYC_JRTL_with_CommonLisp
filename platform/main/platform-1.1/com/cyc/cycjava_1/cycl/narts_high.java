...
public  final class narts_high extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_narts_high_file() {
    //declareFunction("nart_hl_formula", "NART-HL-FORMULA", 1, 0, false); new $nart_hl_formula$UnaryFunction();
    ...
    //declareFunction("find_nart", "FIND-NART", 1, 0, false); new $find_nart$UnaryFunction();
