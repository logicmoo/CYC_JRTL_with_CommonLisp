...
public  final class kb_indexing_macros extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_kb_indexing_macros_file() {
    //declareMacro(myName, "set_num_arbitrary_index", "SET-NUM-ARBITRARY-INDEX");
    //declareMacro(myName, "set_relevant_simple_index_count", "SET-RELEVANT-SIMPLE-INDEX-COUNT");
    //declareMacro(myName, "set_relevant_complex_index_count", "SET-RELEVANT-COMPLEX-INDEX-COUNT");
    //declareMacro(myName, "set_relevant_num_arbitrary_index", "SET-RELEVANT-NUM-ARBITRARY-INDEX");
    declareFunction(myName, "number_has_reached_cutoffP", "NUMBER-HAS-REACHED-CUTOFF?", 2, 0, false);
    //declareMacro(myName, "set_relevant_simple_index_count_with_cutoff", "SET-RELEVANT-SIMPLE-INDEX-COUNT-WITH-CUTOFF");
    //declareMacro(myName, "set_relevant_complex_index_count_with_cutoff", "SET-RELEVANT-COMPLEX-INDEX-COUNT-WITH-CUTOFF");
    //declareMacro(myName, "set_relevant_num_arbitrary_index_with_cutoff", "SET-RELEVANT-NUM-ARBITRARY-INDEX-WITH-CUTOFF");
    //declareMacro(myName, "set_key_arbitrary_index", "SET-KEY-ARBITRARY-INDEX");
    //declareMacro(myName, "set_relevant_key_simple_index", "SET-RELEVANT-KEY-SIMPLE-INDEX");
    //declareMacro(myName, "set_relevant_key_complex_index", "SET-RELEVANT-KEY-COMPLEX-INDEX");
    //declareMacro(myName, "set_relevant_key_arbitrary_index", "SET-RELEVANT-KEY-ARBITRARY-INDEX");
    //declareFunction(myName, "mt_key_level", "MT-KEY-LEVEL", 1, 0, false);
    //declareFunction(myName, "list_of_first_n_args", "LIST-OF-FIRST-N-ARGS", 1, 5, false);
    declareFunction(myName, "number_of_non_null_args_in_order", "NUMBER-OF-NON-NULL-ARGS-IN-ORDER", 0, 5, false);
    //declareMacro(myName, "do_gaf_arg_indices", "DO-GAF-ARG-INDICES");
    //declareMacro(myName, "do_gaf_arg_index_keys", "DO-GAF-ARG-INDEX-KEYS");
    //declareFunction(myName, "term_gaf_arg_index", "TERM-GAF-ARG-INDEX", 1, 0, false);
    //declareFunction(myName, "valid_gaf_arg_index_keyP", "VALID-GAF-ARG-INDEX-KEY?", 1, 0, false);
    //declareMacro(myName, "do_nart_arg_indices", "DO-NART-ARG-INDICES");
    //declareMacro(myName, "do_nart_arg_index_keys", "DO-NART-ARG-INDEX-KEYS");
    //declareFunction(myName, "term_nart_arg_index", "TERM-NART-ARG-INDEX", 1, 0, false);
    //declareFunction(myName, "valid_nart_arg_index_keyP", "VALID-NART-ARG-INDEX-KEY?", 1, 0, false);
    //declareMacro(myName, "do_predicate_rule_indices", "DO-PREDICATE-RULE-INDICES");
    //declareMacro(myName, "do_predicate_rule_index_keys", "DO-PREDICATE-RULE-INDEX-KEYS");
    //declareFunction(myName, "term_predicate_rule_index", "TERM-PREDICATE-RULE-INDEX", 1, 0, false);
    //declareFunction(myName, "valid_predicate_rule_index_keyP", "VALID-PREDICATE-RULE-INDEX-KEY?", 1, 0, false);
    //declareMacro(myName, "do_decontextualized_ist_predicate_rule_indices", "DO-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDICES");
    //declareMacro(myName, "do_decontextualized_ist_predicate_rule_index_keys", "DO-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX-KEYS");
    //declareFunction(myName, "term_decontextualized_ist_predicate_rule_index", "TERM-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX", 1, 0, false);
    //declareFunction(myName, "valid_decontextualized_ist_predicate_rule_index_keyP", "VALID-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX-KEY?", 1, 0, false);
    //declareMacro(myName, "do_isa_rule_indices", "DO-ISA-RULE-INDICES");
    //declareMacro(myName, "do_isa_rule_index_keys", "DO-ISA-RULE-INDEX-KEYS");
    //declareFunction(myName, "term_isa_rule_index", "TERM-ISA-RULE-INDEX", 1, 0, false);
    //declareFunction(myName, "valid_isa_rule_index_keyP", "VALID-ISA-RULE-INDEX-KEY?", 1, 0, false);
    //declareMacro(myName, "do_genls_rule_indices", "DO-GENLS-RULE-INDICES");
    //declareMacro(myName, "do_genls_rule_index_keys", "DO-GENLS-RULE-INDEX-KEYS");
    //declareFunction(myName, "term_genls_rule_index", "TERM-GENLS-RULE-INDEX", 1, 0, false);
    //declareFunction(myName, "valid_genls_rule_index_keyP", "VALID-GENLS-RULE-INDEX-KEY?", 1, 0, false);
    //declareMacro(myName, "do_genl_mt_rule_indices", "DO-GENL-MT-RULE-INDICES");
    //declareMacro(myName, "do_genl_mt_rule_index_keys", "DO-GENL-MT-RULE-INDEX-KEYS");
    //declareFunction(myName, "term_genl_mt_rule_index", "TERM-GENL-MT-RULE-INDEX", 1, 0, false);
    //declareFunction(myName, "valid_genl_mt_rule_index_keyP", "VALID-GENL-MT-RULE-INDEX-KEY?", 1, 0, false);
    return NIL;
  }
