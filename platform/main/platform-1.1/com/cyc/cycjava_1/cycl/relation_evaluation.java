...
A third returned value is T iff the evaluation included evaluation of a contextualized relation. */
  ...
  public static final SubLObject declare_relation_evaluation_file() {
    ...
    declareFunction("cyc_evaluate_arg", "CYC-EVALUATE-ARG", 1, 0, false); new $cyc_evaluate_arg$UnaryFunction();
    ...
    declareFunction("clear_cached_evaluation_function", "CLEAR-CACHED-EVALUATION-FUNCTION", 0, 0, false); new $clear_cached_evaluation_function$ZeroArityFunction();
