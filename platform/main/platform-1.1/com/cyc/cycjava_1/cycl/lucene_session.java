...
public  final class lucene_session extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_lucene_session_file() {
    declareFunction(myName, "get_lucene_host", "GET-LUCENE-HOST", 0, 0, false);
    declareFunction(myName, "get_lucene_port", "GET-LUCENE-PORT", 0, 0, false);
    declareMacro(myName, "with_lucene_session", "WITH-LUCENE-SESSION");
    declareFunction(myName, "lucene_session_print_function_trampoline", "LUCENE-SESSION-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction(myName, "lucene_session_p", "LUCENE-SESSION-P", 1, 0, false); new $lucene_session_p$UnaryFunction();
    declareFunction(myName, "lucene_host", "LUCENE-HOST", 1, 0, false);
    declareFunction(myName, "lucene_port", "LUCENE-PORT", 1, 0, false);
    declareFunction(myName, "lucene_connection", "LUCENE-CONNECTION", 1, 0, false);
    declareFunction(myName, "lucene_session_type", "LUCENE-SESSION-TYPE", 1, 0, false);
    declareFunction(myName, "lucene_index", "LUCENE-INDEX", 1, 0, false);
    declareFunction(myName, "lucene_overwrite", "LUCENE-OVERWRITE", 1, 0, false);
    declareFunction(myName, "_csetf_lucene_host", "_CSETF-LUCENE-HOST", 2, 0, false);
    declareFunction(myName, "_csetf_lucene_port", "_CSETF-LUCENE-PORT", 2, 0, false);
    declareFunction(myName, "_csetf_lucene_connection", "_CSETF-LUCENE-CONNECTION", 2, 0, false);
    declareFunction(myName, "_csetf_lucene_session_type", "_CSETF-LUCENE-SESSION-TYPE", 2, 0, false);
    declareFunction(myName, "_csetf_lucene_index", "_CSETF-LUCENE-INDEX", 2, 0, false);
    declareFunction(myName, "_csetf_lucene_overwrite", "_CSETF-LUCENE-OVERWRITE", 2, 0, false);
    declareFunction(myName, "make_lucene_session", "MAKE-LUCENE-SESSION", 0, 1, false);
    declareFunction(myName, "new_lucene_session", "NEW-LUCENE-SESSION", 4, 1, false);
    declareFunction(myName, "lucene_finalize", "LUCENE-FINALIZE", 1, 0, false);
    declareFunction(myName, "lucene_print", "LUCENE-PRINT", 3, 0, false);
    declareFunction(myName, "lucene_init", "LUCENE-INIT", 3, 0, false);
    declareFunction(myName, "lucene_new_index_writer", "LUCENE-NEW-INDEX-WRITER", 1, 1, false);
    declareFunction(myName, "lucene_close_index_writer", "LUCENE-CLOSE-INDEX-WRITER", 1, 0, false);
    declareFunction(myName, "default_lucene_confirmed_terms_boost", "DEFAULT-LUCENE-CONFIRMED-TERMS-BOOST", 0, 0, false);
    declareFunction(myName, "lucene_add_document", "LUCENE-ADD-DOCUMENT", 6, 2, false);
    declareFunction(myName, "lucene_optimize", "LUCENE-OPTIMIZE", 1, 0, false);
    declareFunction(myName, "lucene_query", "LUCENE-QUERY", 2, 1, false);
    declareFunction(myName, "lucene_send", "LUCENE-SEND", 3, 0, false);
    declareFunction(myName, "lucene_receive", "LUCENE-RECEIVE", 1, 0, false);
    declareFunction(myName, "lucene_execute", "LUCENE-EXECUTE", 3, 0, false);
    declareFunction(myName, "interpret_lucene_response", "INTERPRET-LUCENE-RESPONSE", 1, 0, false);
    return NIL;
  }
