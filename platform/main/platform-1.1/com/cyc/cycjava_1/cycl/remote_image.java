...
public  final class remote_image extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_remote_image_file() {
    ...
    declareFunction("remote_image_p", "REMOTE-IMAGE-P", 1, 0, false); new $remote_image_p$UnaryFunction();
    ...
    declareFunction("remote_image_connection_p", "REMOTE-IMAGE-CONNECTION-P", 1, 0, false); new $remote_image_connection_p$UnaryFunction();
