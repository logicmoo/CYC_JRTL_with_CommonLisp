...
public  final class modules extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_modules_file() {
    declareMacro(myName, "with_module_lock", "WITH-MODULE-LOCK");
    declareMacro(myName, "with_system_lock", "WITH-SYSTEM-LOCK");
    declareFunction(myName, "module_print_function_trampoline", "MODULE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction(myName, "module_p", "MODULE-P", 1, 0, false); new $module_p$UnaryFunction();
    declareFunction(myName, "module_basis", "MODULE-BASIS", 1, 0, false);
    declareFunction(myName, "module_name", "MODULE-NAME", 1, 0, false);
    declareFunction(myName, "module_system", "MODULE-SYSTEM", 1, 0, false);
    declareFunction(myName, "module_pathname", "MODULE-PATHNAME", 1, 0, false);
    declareFunction(myName, "module_test_cases", "MODULE-TEST-CASES", 1, 0, false);
    declareFunction(myName, "module_test_suites", "MODULE-TEST-SUITES", 1, 0, false);
    declareFunction(myName, "module_provisional_p", "MODULE-PROVISIONAL-P", 1, 0, false);
    declareFunction(myName, "_csetf_module_basis", "_CSETF-MODULE-BASIS", 2, 0, false);
    declareFunction(myName, "_csetf_module_name", "_CSETF-MODULE-NAME", 2, 0, false);
    declareFunction(myName, "_csetf_module_system", "_CSETF-MODULE-SYSTEM", 2, 0, false);
    declareFunction(myName, "_csetf_module_pathname", "_CSETF-MODULE-PATHNAME", 2, 0, false);
    declareFunction(myName, "_csetf_module_test_cases", "_CSETF-MODULE-TEST-CASES", 2, 0, false);
    declareFunction(myName, "_csetf_module_test_suites", "_CSETF-MODULE-TEST-SUITES", 2, 0, false);
    declareFunction(myName, "_csetf_module_provisional_p", "_CSETF-MODULE-PROVISIONAL-P", 2, 0, false);
    declareFunction(myName, "make_module", "MAKE-MODULE", 0, 1, false);
    declareFunction(myName, "print_module", "PRINT-MODULE", 3, 0, false);
    declareFunction(myName, "sxhash_module_method", "SXHASH-MODULE-METHOD", 1, 0, false);
    declareFunction(myName, "module_store", "MODULE-STORE", 1, 0, false);
    declareFunction(myName, "module_remove", "MODULE-REMOVE", 1, 0, false);
    declareFunction(myName, "module_lookup", "MODULE-LOOKUP", 2, 0, false);
    declareFunction(myName, "all_modules", "ALL-MODULES", 0, 0, false);
    declareMacro(myName, "do_modules", "DO-MODULES");
    declareFunction(myName, "module_get_index", "MODULE-GET-INDEX", 0, 0, false);
    declareFunction(myName, "module_new", "MODULE-NEW", 2, 2, false);
    declareFunction(myName, "ensure_provisional_module", "ENSURE-PROVISIONAL-MODULE", 3, 0, false);
    declareFunction(myName, "create_provisional_module", "CREATE-PROVISIONAL-MODULE", 3, 0, false);
    declareFunction(myName, "create_module", "CREATE-MODULE", 2, 0, false);
    declareFunction(myName, "module_get_name", "MODULE-GET-NAME", 1, 0, false);
    declareFunction(myName, "module_get_system", "MODULE-GET-SYSTEM", 1, 0, false);
    declareFunction(myName, "module_get_pathname", "MODULE-GET-PATHNAME", 1, 0, false);
    declareFunction(myName, "module_add_test_case", "MODULE-ADD-TEST-CASE", 2, 0, false);
    declareFunction(myName, "module_remove_test_case", "MODULE-REMOVE-TEST-CASE", 2, 0, false);
    declareFunction(myName, "module_get_test_cases", "MODULE-GET-TEST-CASES", 1, 0, false);
    declareFunction(myName, "module_add_test_suite", "MODULE-ADD-TEST-SUITE", 2, 0, false);
    declareFunction(myName, "module_remove_test_suite", "MODULE-REMOVE-TEST-SUITE", 2, 0, false);
    declareFunction(myName, "module_get_test_suites", "MODULE-GET-TEST-SUITES", 1, 0, false);
    declareFunction(myName, "module_get_provisional_p", "MODULE-GET-PROVISIONAL-P", 1, 0, false);
    declareFunction(myName, "system_print_function_trampoline", "SYSTEM-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction(myName, "system_p", "SYSTEM-P", 1, 0, false); new $system_p$UnaryFunction();
    declareFunction(myName, "system_basis", "SYSTEM-BASIS", 1, 0, false);
    declareFunction(myName, "system_name", "SYSTEM-NAME", 1, 0, false);
    declareFunction(myName, "system_default_pathname", "SYSTEM-DEFAULT-PATHNAME", 1, 0, false);
    declareFunction(myName, "system_modules", "SYSTEM-MODULES", 1, 0, false);
    declareFunction(myName, "system_provisional_p", "SYSTEM-PROVISIONAL-P", 1, 0, false);
    declareFunction(myName, "_csetf_system_basis", "_CSETF-SYSTEM-BASIS", 2, 0, false);
    declareFunction(myName, "_csetf_system_name", "_CSETF-SYSTEM-NAME", 2, 0, false);
    declareFunction(myName, "_csetf_system_default_pathname", "_CSETF-SYSTEM-DEFAULT-PATHNAME", 2, 0, false);
    declareFunction(myName, "_csetf_system_modules", "_CSETF-SYSTEM-MODULES", 2, 0, false);
    declareFunction(myName, "_csetf_system_provisional_p", "_CSETF-SYSTEM-PROVISIONAL-P", 2, 0, false);
    declareFunction(myName, "make_system", "MAKE-SYSTEM", 0, 1, false);
    declareFunction(myName, "print_system", "PRINT-SYSTEM", 3, 0, false);
    declareFunction(myName, "sxhash_system_method", "SXHASH-SYSTEM-METHOD", 1, 0, false);
    declareFunction(myName, "system_store", "SYSTEM-STORE", 1, 0, false);
    declareFunction(myName, "system_remove", "SYSTEM-REMOVE", 1, 0, false);
    declareFunction(myName, "system_lookup", "SYSTEM-LOOKUP", 1, 0, false);
    declareFunction(myName, "all_systems", "ALL-SYSTEMS", 0, 0, false);
    declareFunction(myName, "system_new", "SYSTEM-NEW", 1, 2, false);
    declareFunction(myName, "ensure_provisional_system", "ENSURE-PROVISIONAL-SYSTEM", 2, 0, false);
    declareFunction(myName, "create_provisional_system", "CREATE-PROVISIONAL-SYSTEM", 2, 0, false);
    declareFunction(myName, "create_system", "CREATE-SYSTEM", 1, 0, false);
    declareFunction(myName, "system_get_name", "SYSTEM-GET-NAME", 1, 0, false);
    declareFunction(myName, "system_get_default_pathname", "SYSTEM-GET-DEFAULT-PATHNAME", 1, 0, false);
    declareFunction(myName, "system_get_modules", "SYSTEM-GET-MODULES", 1, 1, false);
    declareFunction(myName, "system_add_module", "SYSTEM-ADD-MODULE", 2, 0, false);
    declareFunction(myName, "system_remove_module", "SYSTEM-REMOVE-MODULE", 2, 0, false);
    declareFunction(myName, "system_get_provisional_p", "SYSTEM-GET-PROVISIONAL-P", 1, 0, false);
    declareFunction(myName, "system_module_names", "SYSTEM-MODULE-NAMES", 1, 1, false);
    declareFunction(myName, "system_names", "SYSTEM-NAMES", 0, 1, false);
    declareMacro(myName, "note_translated_modules", "NOTE-TRANSLATED-MODULES");
    return NIL;
  }
