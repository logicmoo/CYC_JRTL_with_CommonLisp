...
public  final class tva_utilities extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_tva_utilities_file() {
    ...
    declareFunction("tva_assertion_p", "TVA-ASSERTION-P", 1, 0, false); new $tva_assertion_p$UnaryFunction();
    declareFunction("cva_assertion_p", "CVA-ASSERTION-P", 1, 0, false);
    declareFunction("some_transitive_via_arg_assertionP", "SOME-TRANSITIVE-VIA-ARG-ASSERTION?", 1, 0, false); new $some_transitive_via_arg_assertionP$UnaryFunction();
    declareFunction("some_conservative_via_arg_assertionP", "SOME-CONSERVATIVE-VIA-ARG-ASSERTION?", 1, 0, false); new $some_conservative_via_arg_assertionP$UnaryFunction();
    ...
    declareFunction("clear_cached_some_tva_for_predicate", "CLEAR-CACHED-SOME-TVA-FOR-PREDICATE", 0, 0, false); new $clear_cached_some_tva_for_predicate$ZeroArityFunction();
    ...
    declareFunction("clear_cached_some_cva_for_predicate", "CLEAR-CACHED-SOME-CVA-FOR-PREDICATE", 0, 0, false); new $clear_cached_some_cva_for_predicate$ZeroArityFunction();
    ...
    declareFunction("clear_cached_tva_spec_preds_and_inverses", "CLEAR-CACHED-TVA-SPEC-PREDS-AND-INVERSES", 0, 0, false); new $clear_cached_tva_spec_preds_and_inverses$ZeroArityFunction();
