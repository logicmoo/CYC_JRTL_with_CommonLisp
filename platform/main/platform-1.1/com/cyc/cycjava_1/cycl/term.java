...
i.e. contains no HL variables. */
  ...
  public static final SubLObject declare_term_file() {
    ...
    declareFunction("kb_assertionP", "KB-ASSERTION?", 1, 0, false); new $kb_assertionP$UnaryFunction();
    ...
    declareFunction("reified_skolem_constant_termP", "REIFIED-SKOLEM-CONSTANT-TERM?", 1, 0, false); new $reified_skolem_constant_termP$UnaryFunction();
    declareFunction("skolem_constantP", "SKOLEM-CONSTANT?", 1, 0, false); new $skolem_constantP$UnaryFunction();
    ...
    declareFunction("fast_reified_skolemP", "FAST-REIFIED-SKOLEM?", 1, 0, false); new $fast_reified_skolemP$UnaryFunction();
    declareFunction("skolem_nartP", "SKOLEM-NART?", 1, 0, false);
    declareFunction("fast_skolem_nartP", "FAST-SKOLEM-NART?", 1, 0, false);
    declareFunction("fast_skolem_natP", "FAST-SKOLEM-NAT?", 1, 0, false); new $fast_skolem_natP$UnaryFunction();
    declareFunction("skolem_termP", "SKOLEM-TERM?", 1, 0, false);
    declareFunction("unreified_skolem_termP", "UNREIFIED-SKOLEM-TERM?", 1, 0, false); new $unreified_skolem_termP$UnaryFunction();
    ...
    declareFunction("closed_nautP", "CLOSED-NAUT?", 1, 1, false); new $closed_nautP$UnaryFunction(); new $closed_nautP$BinaryFunction();
    ...
    declareFunction("var_specP", "VAR-SPEC?", 1, 0, false); new $var_specP$UnaryFunction();
