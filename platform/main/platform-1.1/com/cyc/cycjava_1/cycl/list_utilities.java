...
@note Assumes no two elements are equal with respect to TEST. */
  ...
  public static final SubLObject declare_list_utilities_file() {
    declareFunction(myName, "sublisp_boolean", "BOOLEAN", 1, 0, false);
    //declareFunction(myName, "not_boolean", "NOT-BOOLEAN", 1, 0, false);
    declareFunction(myName, "not_eq", "NOT-EQ", 2, 0, false);
    //declareFunction(myName, "not_eql", "NOT-EQL", 2, 0, false);
    //declareFunction(myName, "not_equal", "NOT-EQUAL", 2, 0, false);
    //declareFunction(myName, "not_equalp", "NOT-EQUALP", 2, 0, false);
    //declareFunction(myName, "not_assoc", "NOT-ASSOC", 2, 2, false);
    //declareFunction(myName, "not_consp", "NOT-CONSP", 1, 0, false);
    //declareFunction(myName, "eq_and_not_eq", "EQ-AND-NOT-EQ", 2, 0, false);
    //declareFunction(myName, "bull", "BULL", 2, 0, false);
    //declareFunction(myName, "caadr", "CAADR", 1, 0, false);
    //declareFunction(myName, "caddr", "CADDR", 1, 0, false);
    declareFunction(myName, "cdddr", "CDDDR", 1, 0, false);
    //declareFunction(myName, "cadddr", "CADDDR", 1, 0, false);
    //declareFunction(myName, "cadadr", "CADADR", 1, 0, false);
    //declareFunction(myName, "cadar", "CADAR", 1, 0, false); new $cadar$UnaryFunction();
    //declareFunction(myName, "cdadr", "CDADR", 1, 0, false);
    //declareFunction(myName, "snoc", "SNOC", 2, 0, false);
    //declareFunction(myName, "list_rotate_left", "LIST-ROTATE-LEFT", 1, 0, false);
    //declareFunction(myName, "list_rotate_right", "LIST-ROTATE-RIGHT", 1, 0, false);
    declareFunction(myName, "proper_subsetp", "PROPER-SUBSETP", 2, 2, false);
    //declareFunction(myName, "proper_subsetp_pre_sorted", "PROPER-SUBSETP-PRE-SORTED", 2, 2, false);
    //declareFunction(myName, "nth_cycling", "NTH-CYCLING", 2, 2, false);
    //declareMacro(myName, "pop_setq", "POP-SETQ");
    //declareMacro(myName, "pop_bind", "POP-BIND");
    //declareMacro(myName, "push_max_length", "PUSH-MAX-LENGTH");
    //declareMacro(myName, "cdolist_multiple", "CDOLIST-MULTIPLE");
    //declareMacro(myName, "cdolist_multiple_numbered", "CDOLIST-MULTIPLE-NUMBERED");
    //declareMacro(myName, "csome_multiple", "CSOME-MULTIPLE");
    //declareMacro(myName, "cdolist_numbered", "CDOLIST-NUMBERED");
    //declareMacro(myName, "cdolist_backward", "CDOLIST-BACKWARD");
    //declareMacro(myName, "cdolist_backward_numbered", "CDOLIST-BACKWARD-NUMBERED");
    //declareMacro(myName, "csome_numbered", "CSOME-NUMBERED");
    //declareMacro(myName, "cdolist_cycling", "CDOLIST-CYCLING");
    //declareMacro(myName, "cdolist_cycling_complex", "CDOLIST-CYCLING-COMPLEX");
    //declareMacro(myName, "do_tree_leaves", "DO-TREE-LEAVES");
    //declareFunction(myName, "args_from_arg_list", "ARGS-FROM-ARG-LIST", 1, 0, false);
    declareFunction(myName, "lengthL", "LENGTH<", 2, 1, false);
    declareFunction(myName, "lengthLE", "LENGTH<=", 2, 1, false);
    declareFunction(myName, "lengthE", "LENGTH=", 2, 1, false);
    //declareFunction(myName, "lengthsE", "LENGTHS=", 2, 1, false);
    declareFunction(myName, "lengthG", "LENGTH>", 2, 1, false);
    declareFunction(myName, "lengthGE", "LENGTH>=", 2, 1, false);
    //declareFunction(myName, "zero_length_p", "ZERO-LENGTH-P", 1, 0, false);
    //declareFunction(myName, "same_length_p", "SAME-LENGTH-P", 2, 0, false);
    //declareFunction(myName, "same_lengths_p", "SAME-LENGTHS-P", 1, 0, false);
    //declareFunction(myName, "longer_p", "LONGER-P", 2, 0, false);
    declareFunction(myName, "greater_length_p", "GREATER-LENGTH-P", 2, 0, false);
    declareFunction(myName, "greater_or_same_length_p", "GREATER-OR-SAME-LENGTH-P", 2, 0, false);
    //declareFunction(myName, "shorter_p", "SHORTER-P", 2, 0, false);
    //declareFunction(myName, "lesser_length_p", "LESSER-LENGTH-P", 2, 0, false);
    //declareFunction(myName, "lesser_or_same_length_p", "LESSER-OR-SAME-LENGTH-P", 2, 0, false);
    //declareFunction(myName, "empty_list_p", "EMPTY-LIST-P", 1, 0, false);
    //declareFunction(myName, "non_empty_list_p", "NON-EMPTY-LIST-P", 1, 0, false);
    declareFunction(myName, "proper_list_p", "PROPER-LIST-P", 1, 0, false);
    declareFunction(myName, "dotted_list_p", "DOTTED-LIST-P", 1, 0, false); new $dotted_list_p$UnaryFunction();
    declareFunction(myName, "non_dotted_list_p", "NON-DOTTED-LIST-P", 1, 0, false);
    declareFunction(myName, "dotted_length", "DOTTED-LENGTH", 1, 0, false);
    //declareFunction(myName, "dotted_last", "DOTTED-LAST", 1, 0, false);
    //declareFunction(myName, "dotted_butlast", "DOTTED-BUTLAST", 1, 0, false);
    //declareFunction(myName, "undot", "UNDOT", 1, 0, false);
    //declareFunction(myName, "add_to_dotted_end", "ADD-TO-DOTTED-END", 2, 0, false);
    //declareFunction(myName, "nadd_to_dotted_end", "NADD-TO-DOTTED-END", 2, 0, false);
    //declareFunction(myName, "ndot_last", "NDOT-LAST", 1, 0, false);
    //declareFunction(myName, "dot_last", "DOT-LAST", 1, 0, false);
    //declareFunction(myName, "possible_dotted_list_to_dotted_list", "POSSIBLE-DOTTED-LIST-TO-DOTTED-LIST", 1, 1, false);
    //declareFunction(myName, "list_non_dotted_through_n_p", "LIST-NON-DOTTED-THROUGH-N-P", 2, 0, false);
    declareFunction(myName, "negated_test_func", "NEGATED-TEST-FUNC", 1, 0, false); new $negated_test_func$UnaryFunction();
    declareFunction(myName, "remove_if_not", "REMOVE-IF-NOT", 2, 4, false);
    declareFunction(myName, "delete_if_not", "DELETE-IF-NOT", 2, 4, false);
    //declareFunction(myName, "substitute_if_not", "SUBSTITUTE-IF-NOT", 3, 4, false);
    //declareFunction(myName, "nsubstitute_if_not", "NSUBSTITUTE-IF-NOT", 3, 4, false);
    declareFunction(myName, "find_if_not", "FIND-IF-NOT", 2, 3, false);
    //declareFunction(myName, "position_if_not", "POSITION-IF-NOT", 2, 3, false);
    //declareFunction(myName, "position_if_binary_lambda", "POSITION-IF-BINARY-LAMBDA", 1, 0, false);
    //declareFunction(myName, "position_if_binary", "POSITION-IF-BINARY", 3, 3, false);
    //declareFunction(myName, "position_from_end", "POSITION-FROM-END", 2, 4, false);
    //declareFunction(myName, "tree_positions", "TREE-POSITIONS", 2, 2, false);
    //declareFunction(myName, "tree_position_bfs", "TREE-POSITION-BFS", 2, 1, false);
    //declareFunction(myName, "tree_position_dfs", "TREE-POSITION-DFS", 2, 1, false);
    //declareFunction(myName, "list_position", "LIST-POSITION", 2, 2, false);
    //declareFunction(myName, "tree_position_p", "TREE-POSITION-P", 1, 0, false);
    //declareFunction(myName, "tree_nested_nths", "TREE-NESTED-NTHS", 2, 0, false);
    //declareFunction(myName, "tree_nths", "TREE-NTHS", 2, 0, false);
    //declareFunction(myName, "has_nested_nth_p", "HAS-NESTED-NTH-P", 2, 0, false);
    //declareFunction(myName, "get_nested_nth", "GET-NESTED-NTH", 2, 1, false);
    //declareFunction(myName, "replace_nested_nth", "REPLACE-NESTED-NTH", 3, 0, false);
    //declareFunction(myName, "nreplace_nested_nth", "NREPLACE-NESTED-NTH", 3, 0, false);
    //declareFunction(myName, "remove_nested_nth", "REMOVE-NESTED-NTH", 2, 0, false);
    //declareFunction(myName, "delete_nested_nth", "DELETE-NESTED-NTH", 2, 0, false);
    //declareFunction(myName, "delete_nested_nth_internal", "DELETE-NESTED-NTH-INTERNAL", 2, 0, false);
    //declareFunction(myName, "tree_positions_int", "TREE-POSITIONS-INT", 3, 1, false);
    //declareFunction(myName, "tree_positions_dfs", "TREE-POSITIONS-DFS", 2, 1, false);
    //declareFunction(myName, "tree_positions_bfs", "TREE-POSITIONS-BFS", 2, 1, false);
    //declareFunction(myName, "containing_subtrees", "CONTAINING-SUBTREES", 2, 0, false);
    //declareFunction(myName, "tree_positions_if_dfs", "TREE-POSITIONS-IF-DFS", 2, 1, false);
    //declareFunction(myName, "tree_positions_if_bfs", "TREE-POSITIONS-IF-BFS", 2, 1, false);
    //declareFunction(myName, "tree_positions_if_dfs_int", "TREE-POSITIONS-IF-DFS-INT", 2, 1, false);
    //declareFunction(myName, "tree_position_if_bfs", "TREE-POSITION-IF-BFS", 2, 1, false);
    //declareFunction(myName, "tree_position_if_dfs", "TREE-POSITION-IF-DFS", 2, 1, false);
    //declareFunction(myName, "count_if_not", "COUNT-IF-NOT", 2, 3, false);
    //declareFunction(myName, "subst_if_not", "SUBST-IF-NOT", 3, 1, false);
    //declareFunction(myName, "nsubst_if_not", "NSUBST-IF-NOT", 3, 1, false);
    //declareFunction(myName, "member_if_not", "MEMBER-IF-NOT", 2, 1, false);
    //declareFunction(myName, "assoc_if_not", "ASSOC-IF-NOT", 2, 0, false);
    //declareFunction(myName, "rassoc_if_not", "RASSOC-IF-NOT", 2, 0, false);
    //declareFunction(myName, "assoc_all", "ASSOC-ALL", 2, 1, false);
    //declareFunction(myName, "assoc_push", "ASSOC-PUSH", 3, 1, false);
    //declareFunction(myName, "assoc_pushnew", "ASSOC-PUSHNEW", 3, 1, false);
    //declareFunction(myName, "dotted_assoc_push", "DOTTED-ASSOC-PUSH", 3, 1, false);
    //declareFunction(myName, "assoc_equal", "ASSOC-EQUAL", 2, 0, false);
    //declareFunction(myName, "assoc_subsumedP", "ASSOC-SUBSUMED?", 3, 0, false);
    //declareFunction(myName, "alist_extend", "ALIST-EXTEND", 2, 0, false);
    //declareFunction(myName, "make_alist", "MAKE-ALIST", 1, 1, false);
    //declareFunction(myName, "make_alist_from_keys_and_values", "MAKE-ALIST-FROM-KEYS-AND-VALUES", 2, 0, false);
    //declareFunction(myName, "make_pair_list", "MAKE-PAIR-LIST", 2, 0, false);
    //declareFunction(myName, "make_paired_lists", "MAKE-PAIRED-LISTS", 1, 0, false);
    //declareFunction(myName, "first_safe_for_atoms", "FIRST-SAFE-FOR-ATOMS", 1, 0, false);
    //declareMacro(myName, "first_of", "FIRST-OF");
    declareFunction(myName, "recons", "RECONS", 3, 0, false);
    declareFunction(myName, "ncons", "NCONS", 3, 0, false);
    declareFunction(myName, "delete_first", "DELETE-FIRST", 2, 1, false);
    //declareFunction(myName, "remove_first", "REMOVE-FIRST", 2, 1, false);
    declareFunction(myName, "nmapcar", "NMAPCAR", 2, 0, false);
    declareFunction(myName, "mapappend", "MAPAPPEND", 2, 0, false);
    declareFunction(myName, "mapunion", "MAPUNION", 2, 1, false);
    declareFunction(myName, "mapnunion", "MAPNUNION", 2, 1, false);
    declareFunction(myName, "mapcar_product", "MAPCAR-PRODUCT", 3, 0, false);
    //declareFunction(myName, "mapcar_unique", "MAPCAR-UNIQUE", 2, 1, false);
    declareFunction(myName, "last1", "LAST1", 1, 0, false);
    //declareFunction(myName, "add_to_end", "ADD-TO-END", 2, 0, false);
    declareFunction(myName, "nadd_to_end", "NADD-TO-END", 2, 0, false);
    //declareFunction(myName, "adjoin_to_end", "ADJOIN-TO-END", 2, 1, false);
    //declareFunction(myName, "nadjoin_to_end", "NADJOIN-TO-END", 2, 1, false);
    //declareFunction(myName, "add_to_end_if", "ADD-TO-END-IF", 2, 0, false);
    //declareFunction(myName, "nadd_to_end_if", "NADD-TO-END-IF", 2, 0, false);
    //declareFunction(myName, "nth_from_end", "NTH-FROM-END", 2, 0, false);
    //declareFunction(myName, "remove_from_end", "REMOVE-FROM-END", 2, 1, false);
    //declareFunction(myName, "remove_objects_from_list", "REMOVE-OBJECTS-FROM-LIST", 2, 1, false);
    declareFunction(myName, "partition_list", "PARTITION-LIST", 2, 0, false);
    //declareFunction(myName, "npartition_list", "NPARTITION-LIST", 2, 0, false);
    //declareFunction(myName, "partition_list_by_equality", "PARTITION-LIST-BY-EQUALITY", 2, 2, false);
    //declareFunction(myName, "partition_list_n_ways", "PARTITION-LIST-N-WAYS", 2, 0, false);
    //declareFunction(myName, "randomly_partition_list_n_ways", "RANDOMLY-PARTITION-LIST-N-WAYS", 2, 0, false);
    //declareFunction(myName, "split_list", "SPLIT-LIST", 2, 0, false);
    //declareFunction(myName, "random_element", "RANDOM-ELEMENT", 1, 0, false);
    //declareFunction(myName, "random_aref", "RANDOM-AREF", 1, 0, false);
    //declareFunction(myName, "random_n", "RANDOM-N", 2, 0, false);
    //declareFunction(myName, "random_remove_n", "RANDOM-REMOVE-N", 2, 0, false);
    //declareFunction(myName, "random_delete", "RANDOM-DELETE", 1, 0, false);
    //declareFunction(myName, "randomize_list", "RANDOMIZE-LIST", 1, 0, false);
    //declareFunction(myName, "randomize_vector", "RANDOMIZE-VECTOR", 1, 0, false);
    //declareFunction(myName, "randomize_vector_int", "RANDOMIZE-VECTOR-INT", 3, 0, false);
    //declareFunction(myName, "random_compare", "RANDOM-COMPARE", 2, 0, false);
    //declareFunction(myName, "thirdL", "THIRD<", 2, 0, false);
    //declareFunction(myName, "find_all", "FIND-ALL", 2, 2, false);
    //declareFunction(myName, "find_all_if", "FIND-ALL-IF", 2, 1, false);
    declareFunction(myName, "find_all_if_not", "FIND-ALL-IF-NOT", 2, 1, false);
    //declareFunction(myName, "all_positions", "ALL-POSITIONS", 2, 3, false);
    declareFunction(myName, "only_one", "ONLY-ONE", 1, 0, false);
    //declareFunction(myName, "last_one", "LAST-ONE", 1, 0, false);
    //declareFunction(myName, "penultimate_one", "PENULTIMATE-ONE", 1, 0, false);
    //declareFunction(myName, "cons_if", "CONS-IF", 2, 0, false);
    //declareFunction(myName, "list_if", "LIST-IF", 1, 0, false);
    //declareFunction(myName, "adjoin_if", "ADJOIN-IF", 2, 1, false);
    declareFunction(myName, "flatten", "FLATTEN", 1, 0, false);
    //declareFunction(myName, "insert_between_each", "INSERT-BETWEEN-EACH", 2, 0, false);
    //declareFunction(myName, "safe_nth", "SAFE-NTH", 2, 0, false);
    //declareFunction(myName, "nths", "NTHS", 2, 0, false);
    //declareFunction(myName, "every_nth", "EVERY-NTH", 2, 0, false);
    declareFunction(myName, "first_n", "FIRST-N", 2, 0, false);
    //declareFunction(myName, "first_n_percent", "FIRST-N-PERCENT", 2, 0, false);
    //declareFunction(myName, "first_n_if", "FIRST-N-IF", 3, 1, false);
    //declareFunction(myName, "first_2", "FIRST-2", 1, 0, false);
    //declareFunction(myName, "first_10", "FIRST-10", 1, 0, false);
    //declareFunction(myName, "last_n", "LAST-N", 2, 0, false);
    //declareFunction(myName, "nth_chunk_of_k", "NTH-CHUNK-OF-K", 3, 0, false);
    //declareFunction(myName, "delete_nth", "DELETE-NTH", 2, 0, false);
    //declareFunction(myName, "remove_nth", "REMOVE-NTH", 2, 0, false);
    //declareFunction(myName, "remove_last", "REMOVE-LAST", 1, 0, false);
    //declareFunction(myName, "remove_nths", "REMOVE-NTHS", 2, 0, false);
    //declareFunction(myName, "nreplace_last", "NREPLACE-LAST", 2, 0, false);
    declareFunction(myName, "nreplace_nth", "NREPLACE-NTH", 3, 0, false);
    //declareFunction(myName, "find_and_replace", "FIND-AND-REPLACE", 3, 1, false);
    //declareFunction(myName, "find_and_nreplace", "FIND-AND-NREPLACE", 3, 1, false);
    //declareFunction(myName, "find_first_and_nreplace", "FIND-FIRST-AND-NREPLACE", 3, 1, false);
    //declareFunction(myName, "ncollapse_n_from_pos", "NCOLLAPSE-N-FROM-POS", 4, 0, false);
    //declareFunction(myName, "ninsert_by_position", "NINSERT-BY-POSITION", 3, 0, false);
    //declareFunction(myName, "ninsert_randomly", "NINSERT-RANDOMLY", 2, 0, false);
    //declareFunction(myName, "ninsert_somewhere_before_and_after", "NINSERT-SOMEWHERE-BEFORE-AND-AFTER", 3, 1, false);
    //declareFunction(myName, "ninsert_somewhere_before", "NINSERT-SOMEWHERE-BEFORE", 3, 0, false);
    //declareFunction(myName, "ninsert_somewhere_before_or_at", "NINSERT-SOMEWHERE-BEFORE-OR-AT", 3, 0, false);
    //declareFunction(myName, "ninsert_somewhere_after", "NINSERT-SOMEWHERE-AFTER", 3, 0, false);
    //declareFunction(myName, "move_nth_to_front", "MOVE-NTH-TO-FRONT", 2, 0, false);
    //declareFunction(myName, "move_nth_to_position", "MOVE-NTH-TO-POSITION", 3, 0, false);
    //declareFunction(myName, "nmove_to_front", "NMOVE-TO-FRONT", 2, 1, false);
    //declareFunction(myName, "move_to_front", "MOVE-TO-FRONT", 2, 1, false);
    //declareFunction(myName, "nmove_to_end", "NMOVE-TO-END", 2, 0, false);
    //declareFunction(myName, "move_to_end", "MOVE-TO-END", 2, 0, false);
    declareFunction(myName, "replace_nth", "REPLACE-NTH", 3, 0, false);
    //declareFunction(myName, "replace_last", "REPLACE-LAST", 2, 0, false);
    //declareFunction(myName, "remove_duplicates_from_end", "REMOVE-DUPLICATES-FROM-END", 1, 4, false);
    //declareFunction(myName, "remove_duplicates_from_start", "REMOVE-DUPLICATES-FROM-START", 1, 4, false);
    //declareFunction(myName, "delete_duplicates_from_end", "DELETE-DUPLICATES-FROM-END", 1, 4, false);
    //declareFunction(myName, "delete_duplicates_from_start", "DELETE-DUPLICATES-FROM-START", 1, 4, false);
    //declareFunction(myName, "remove_null", "REMOVE-NULL", 1, 4, false);
    //declareFunction(myName, "remove_from_end_duplicates_and_those_wXkey", "REMOVE-FROM-END-DUPLICATES-AND-THOSE-W/KEY", 2, 4, false);
    //declareFunction(myName, "skipping_positions", "SKIPPING-POSITIONS", 2, 0, false);
    declareFunction(myName, "num_list", "NUM-LIST", 1, 1, false);
    declareFunction(myName, "new_num_list", "NEW-NUM-LIST", 1, 1, false);
    declareFunction(myName, "verify_num_list", "VERIFY-NUM-LIST", 3, 0, false);
    //declareFunction(myName, "clear_num_list_cached", "CLEAR-NUM-LIST-CACHED", 0, 0, false);
    //declareFunction(myName, "remove_num_list_cached", "REMOVE-NUM-LIST-CACHED", 2, 0, false);
    declareFunction(myName, "num_list_cached_internal", "NUM-LIST-CACHED-INTERNAL", 2, 0, false);
    declareFunction(myName, "num_list_cached", "NUM-LIST-CACHED", 2, 0, false);
    declareFunction(myName, "numlist", "NUMLIST", 1, 1, false);
    //declareFunction(myName, "tree_ancestor", "TREE-ANCESTOR", 2, 1, false);
    declareFunction(myName, "member_eqP", "MEMBER-EQ?", 2, 0, false);
    declareFunction(myName, "member_equalP", "MEMBER-EQUAL?", 2, 0, false);
    //declareFunction(myName, "member_equalpP", "MEMBER-EQUALP?", 2, 0, false);
    //declareFunction(myName, "nmemberP", "NMEMBER?", 2, 1, false);
    //declareFunction(myName, "nmember_eqP", "NMEMBER-EQ?", 2, 0, false);
    //declareFunction(myName, "nmember_eqlP", "NMEMBER-EQL?", 2, 0, false);
    //declareFunction(myName, "nmember_equalP", "NMEMBER-EQUAL?", 2, 0, false);
    //declareFunction(myName, "nmember_equalpP", "NMEMBER-EQUALP?", 2, 0, false);
    //declareFunction(myName, "nmember_funcallP", "NMEMBER-FUNCALL?", 3, 0, false);
    //declareFunction(myName, "nmember_success", "NMEMBER-SUCCESS", 3, 0, false);
    //declareFunction(myName, "intersectP", "INTERSECT?", 2, 2, false);
    //declareFunction(myName, "intersect_sortedP", "INTERSECT-SORTED?", 2, 2, false);
    //declareFunction(myName, "which_intersect_element_sorted", "WHICH-INTERSECT-ELEMENT-SORTED", 2, 2, false);
    //declareFunction(myName, "sorted_subsetp", "SORTED-SUBSETP", 2, 3, false);
    //declareFunction(myName, "sortedP", "SORTED?", 1, 1, false);
    //declareFunction(myName, "occurs_onceP", "OCCURS-ONCE?", 2, 1, false);
    //declareFunction(myName, "not_only_elementP", "NOT-ONLY-ELEMENT?", 2, 1, false);
    //declareFunction(myName, "occurs_at_least_n_timesP", "OCCURS-AT-LEAST-N-TIMES?", 3, 1, false);
    //declareFunction(myName, "occurs_exactly_n_timesP", "OCCURS-EXACTLY-N-TIMES?", 3, 1, false);
    //declareFunction(myName, "occurs_at_most_n_timesP", "OCCURS-AT-MOST-N-TIMES?", 3, 1, false);
    declareFunction(myName, "singletonP", "SINGLETON?", 1, 0, false);
    declareFunction(myName, "doubletonP", "DOUBLETON?", 1, 0, false);
    declareFunction(myName, "tripleP", "TRIPLE?", 1, 0, false);
    //declareFunction(myName, "list_of_length_p", "LIST-OF-LENGTH-P", 2, 1, false);
    //declareFunction(myName, "list_of_doubletonP", "LIST-OF-DOUBLETON?", 1, 0, false);
    //declareFunction(myName, "exactly_one_distinct_memberP", "EXACTLY-ONE-DISTINCT-MEMBER?", 1, 1, false);
    declareFunction(myName, "duplicatesP", "DUPLICATES?", 1, 2, false);
    //declareFunction(myName, "equal_duplicatesP", "EQUAL-DUPLICATES?", 1, 1, false);
    declareFunction(myName, "duplicates", "DUPLICATES", 1, 2, false);
    //declareFunction(myName, "duplicate_memberP", "DUPLICATE-MEMBER?", 2, 1, false);
    //declareFunction(myName, "list_starts_with_repeating_sequenceP", "LIST-STARTS-WITH-REPEATING-SEQUENCE?", 1, 3, false);
    //declareFunction(myName, "update_repeating_sequence", "UPDATE-REPEATING-SEQUENCE", 8, 0, false);
    declareFunction(myName, "multisets_equalP", "MULTISETS-EQUAL?", 2, 1, false);
    declareFunction(myName, "sets_equalP", "SETS-EQUAL?", 2, 1, false);
    declareFunction(myName, "fast_sets_equalP", "FAST-SETS-EQUAL?", 2, 1, false);
    declareFunction(myName, "fast_subsetP", "FAST-SUBSET?", 2, 1, false);
    //declareFunction(myName, "fast_subset_equalP", "FAST-SUBSET-EQUAL?", 2, 0, false);
    //declareFunction(myName, "fast_supersetP", "FAST-SUPERSET?", 2, 1, false);
    //declareFunction(myName, "fast_superset_equalP", "FAST-SUPERSET-EQUAL?", 2, 0, false);
    //declareFunction(myName, "sets_equal_equalP", "SETS-EQUAL-EQUAL?", 2, 0, false);
    //declareFunction(myName, "subsetp_equalP", "SUBSETP-EQUAL?", 2, 1, false);
    //declareFunction(myName, "supersetp", "SUPERSETP", 2, 2, false);
    //declareFunction(myName, "set_differenceP", "SET-DIFFERENCE?", 2, 2, false);
    //declareFunction(myName, "tree_set_equalP", "TREE-SET-EQUAL?", 2, 0, false);
    //declareFunction(myName, "ordered_merge", "ORDERED-MERGE", 2, 2, false);
    declareFunction(myName, "ordered_union", "ORDERED-UNION", 2, 2, false);
    //declareFunction(myName, "union_all", "UNION-ALL", 1, 2, false);
    declareFunction(myName, "ordered_set_difference", "ORDERED-SET-DIFFERENCE", 2, 2, false);
    //declareFunction(myName, "hash_set_difference", "HASH-SET-DIFFERENCE", 2, 1, false);
    declareFunction(myName, "fast_set_difference", "FAST-SET-DIFFERENCE", 2, 1, false);
    //declareFunction(myName, "partial_order_sort", "PARTIAL-ORDER-SORT", 2, 1, false);
    //declareFunction(myName, "list2vector", "LIST2VECTOR", 1, 0, false);
    //declareFunction(myName, "vector2list", "VECTOR2LIST", 1, 0, false);
    //declareFunction(myName, "list_without_repetition_p", "LIST-WITHOUT-REPETITION-P", 1, 2, false);
    //declareFunction(myName, "sequence_elements", "SEQUENCE-ELEMENTS", 2, 0, false);
    //declareFunction(myName, "set_difference_forts", "SET-DIFFERENCE-FORTS", 2, 0, false);
    //declareFunction(myName, "ordered_intersection", "ORDERED-INTERSECTION", 2, 2, false);
    //declareFunction(myName, "intersect_all", "INTERSECT-ALL", 1, 2, false);
    //declareFunction(myName, "fast_intersect_all", "FAST-INTERSECT-ALL", 1, 2, false);
    //declareFunction(myName, "safe_pairlis", "SAFE-PAIRLIS", 2, 0, false);
    declareFunction(myName, "flip_alist", "FLIP-ALIST", 1, 0, false);
    declareFunction(myName, "flip_cons", "FLIP-CONS", 1, 0, false); new $flip_cons$UnaryFunction();
    //declareFunction(myName, "flip_doubleton", "FLIP-DOUBLETON", 1, 0, false);
    //declareFunction(myName, "substitute_sequence", "SUBSTITUTE-SEQUENCE", 3, 0, false);
    //declareFunction(myName, "substitute_sequence_1", "SUBSTITUTE-SEQUENCE-1", 4, 0, false);
    //declareFunction(myName, "compare_lists", "COMPARE-LISTS", 2, 2, false);
    //declareFunction(myName, "unique_difference_among_lists", "UNIQUE-DIFFERENCE-AMONG-LISTS", 1, 0, false);
    //declareFunction(myName, "unique_difference_between_lists", "UNIQUE-DIFFERENCE-BETWEEN-LISTS", 2, 0, false);
    //declareFunction(myName, "list_subst", "LIST-SUBST", 3, 1, false);
    declareFunction(myName, "self_evaluating_form_p", "SELF-EVALUATING-FORM-P", 1, 0, false);
    //declareFunction(myName, "quote_form_p", "QUOTE-FORM-P", 1, 0, false);
    //declareFunction(myName, "non_side_effecting_form_p", "NON-SIDE-EFFECTING-FORM-P", 1, 0, false);
    declareFunction(myName, "quotify", "QUOTIFY", 1, 0, false); new $quotify$UnaryFunction();
    //declareFunction(myName, "unquotify", "UNQUOTIFY", 1, 0, false);
    //declareFunction(myName, "sort_adjoin", "SORT-ADJOIN", 2, 3, false);
    //declareFunction(myName, "sorted_add_to_list", "SORTED-ADD-TO-LIST", 3, 1, false);
    declareFunction(myName, "splice_into_sorted_list", "SPLICE-INTO-SORTED-LIST", 3, 1, false);
    //declareFunction(myName, "safe_splice_into_sorted_list", "SAFE-SPLICE-INTO-SORTED-LIST", 3, 1, false);
    //declareFunction(myName, "element_precedes_specified_othersP", "ELEMENT-PRECEDES-SPECIFIED-OTHERS?", 3, 2, false);
    //declareFunction(myName, "function_arglist_max_args", "FUNCTION-ARGLIST-MAX-ARGS", 1, 0, false);
    //declareFunction(myName, "function_arglist_min_args", "FUNCTION-ARGLIST-MIN-ARGS", 1, 0, false);
    //declareFunction(myName, "remove_self_binds", "REMOVE-SELF-BINDS", 1, 1, false);
    //declareFunction(myName, "self_bindP", "SELF-BIND?", 1, 1, false);
    //declareFunction(myName, "bind_for_var", "BIND-FOR-VAR", 2, 2, false);
    //declareFunction(myName, "remove_bind", "REMOVE-BIND", 2, 2, false);
    //declareFunction(myName, "extract_bindings", "EXTRACT-BINDINGS", 2, 0, false);
    //declareFunction(myName, "car_is_el_varP", "CAR-IS-EL-VAR?", 1, 0, false);
    //declareFunction(myName, "extract_binding_strings", "EXTRACT-BINDING-STRINGS", 2, 0, false);
    declareFunction(myName, "tree_funcall_if", "TREE-FUNCALL-IF", 3, 1, false);
    //declareFunction(myName, "tree_find_all_if", "TREE-FIND-ALL-IF", 2, 1, false);
    //declareFunction(myName, "tree_remove_all_if", "TREE-REMOVE-ALL-IF", 2, 1, false);
    //declareFunction(myName, "nswap_tree", "NSWAP-TREE", 3, 2, false);
    //declareFunction(myName, "swap_tree", "SWAP-TREE", 3, 2, false);
    //declareFunction(myName, "tree_find_all_nested_if", "TREE-FIND-ALL-NESTED-IF", 2, 1, false);
    //declareFunction(myName, "tree_find_all_nested_if_int", "TREE-FIND-ALL-NESTED-IF-INT", 3, 0, false);
    //declareFunction(myName, "hash_delete_duplicates", "HASH-DELETE-DUPLICATES", 1, 4, false);
    //declareFunction(myName, "hash_delete_duplicates_int", "HASH-DELETE-DUPLICATES-INT", 5, 0, false);
    //declareFunction(myName, "hash_remove_duplicates", "HASH-REMOVE-DUPLICATES", 1, 4, false);
    //declareFunction(myName, "fast_delete_duplicates_hashtable", "FAST-DELETE-DUPLICATES-HASHTABLE", 1, 0, false);
    declareFunction(myName, "fast_delete_duplicates", "FAST-DELETE-DUPLICATES", 1, 5, false);
    //declareFunction(myName, "fast_remove_duplicates", "FAST-REMOVE-DUPLICATES", 1, 5, false);
    declareFunction(myName, "remove_duplicate_forts", "REMOVE-DUPLICATE-FORTS", 1, 0, false);
    declareFunction(myName, "delete_duplicate_forts", "DELETE-DUPLICATE-FORTS", 1, 0, false);
    //declareFunction(myName, "hash_unique_elements", "HASH-UNIQUE-ELEMENTS", 2, 0, false);
    //declareFunction(myName, "unique_elements", "UNIQUE-ELEMENTS", 1, 1, false);
    //declareFunction(myName, "remove_all_n_icates", "REMOVE-ALL-N-ICATES", 2, 1, false);
    //declareFunction(myName, "nsort_intersection", "NSORT-INTERSECTION", 2, 2, false);
    //declareFunction(myName, "intersect_sorted", "INTERSECT-SORTED", 2, 2, false);
    //declareFunction(myName, "nintersect_sorted", "NINTERSECT-SORTED", 2, 2, false);
    //declareFunction(myName, "nintersect_sorted_destroy_first_only", "NINTERSECT-SORTED-DESTROY-FIRST-ONLY", 2, 2, false);
    //declareFunction(myName, "nintersect_sorted_int", "NINTERSECT-SORTED-INT", 4, 0, false);
    //declareFunction(myName, "sort_intersection", "SORT-INTERSECTION", 2, 2, false);
    //declareFunction(myName, "union_sorted", "UNION-SORTED", 2, 2, false);
    //declareFunction(myName, "nunion_sorted", "NUNION-SORTED", 2, 2, false);
    //declareFunction(myName, "union_sorted_int", "UNION-SORTED-INT", 5, 0, false);
    //declareFunction(myName, "union_of_intersecting_sorted_lists", "UNION-OF-INTERSECTING-SORTED-LISTS", 1, 2, false);
    //declareFunction(myName, "union_of_intersecting_sorted_lists_recursive", "UNION-OF-INTERSECTING-SORTED-LISTS-RECURSIVE", 4, 0, false);
    declareFunction(myName, "delete_duplicates_sorted", "DELETE-DUPLICATES-SORTED", 1, 1, false);
    //declareFunction(myName, "remove_duplicates_sorted", "REMOVE-DUPLICATES-SORTED", 1, 1, false);
    //declareFunction(myName, "position_wrt", "POSITION-WRT", 3, 3, false);
    //declareFunction(myName, "difference_sorted", "DIFFERENCE-SORTED", 2, 2, false);
    declareFunction(myName, "alist_p", "ALIST-P", 1, 0, false);
    declareFunction(myName, "alist_lookup", "ALIST-LOOKUP", 2, 2, false);
    declareFunction(myName, "alist_lookup_without_values", "ALIST-LOOKUP-WITHOUT-VALUES", 2, 2, false);
    //declareFunction(myName, "alist_nlookup_without_values", "ALIST-NLOOKUP-WITHOUT-VALUES", 2, 2, false);
    //declareFunction(myName, "alist_nlookup_eq", "ALIST-NLOOKUP-EQ", 2, 1, false);
    //declareFunction(myName, "alist_nlookup_eql", "ALIST-NLOOKUP-EQL", 2, 1, false);
    //declareFunction(myName, "alist_nlookup_equal", "ALIST-NLOOKUP-EQUAL", 2, 1, false);
    //declareFunction(myName, "alist_nlookup_equalp", "ALIST-NLOOKUP-EQUALP", 2, 1, false);
    //declareFunction(myName, "alist_nlookup_funcall", "ALIST-NLOOKUP-FUNCALL", 3, 1, false);
    //declareFunction(myName, "alist_nlookup_success", "ALIST-NLOOKUP-SUCCESS", 4, 0, false);
    declareFunction(myName, "alist_has_keyP", "ALIST-HAS-KEY?", 2, 1, false);
    //declareFunction(myName, "alist_has_valueP", "ALIST-HAS-VALUE?", 2, 1, false);
    //declareFunction(myName, "alist_reverse_lookup", "ALIST-REVERSE-LOOKUP", 2, 2, false);
    //declareFunction(myName, "alist_reverse_lookup_without_values", "ALIST-REVERSE-LOOKUP-WITHOUT-VALUES", 2, 2, false);
    declareFunction(myName, "alist_enter", "ALIST-ENTER", 3, 1, false);
    declareFunction(myName, "alist_enter_without_values", "ALIST-ENTER-WITHOUT-VALUES", 3, 1, false);
    //declareFunction(myName, "alist_capacity_enter_without_values", "ALIST-CAPACITY-ENTER-WITHOUT-VALUES", 4, 1, false);
    //declareFunction(myName, "alist_promote", "ALIST-PROMOTE", 2, 1, false);
    declareFunction(myName, "alist_delete", "ALIST-DELETE", 2, 1, false);
    //declareFunction(myName, "alist_delete_without_values", "ALIST-DELETE-WITHOUT-VALUES", 2, 1, false);
    //declareFunction(myName, "alist_remove", "ALIST-REMOVE", 2, 1, false);
    //declareFunction(myName, "alist_remove_without_values", "ALIST-REMOVE-WITHOUT-VALUES", 2, 1, false);
    declareFunction(myName, "alist_push", "ALIST-PUSH", 3, 1, false);
    //declareFunction(myName, "alist_pushnew", "ALIST-PUSHNEW", 3, 2, false);
    //declareFunction(myName, "alist_remove_from_value", "ALIST-REMOVE-FROM-VALUE", 3, 2, false);
    //declareMacro(myName, "pushnew_onto_alist", "PUSHNEW-ONTO-ALIST");
    //declareMacro(myName, "push_onto_alist", "PUSH-ONTO-ALIST");
    //declareMacro(myName, "enter_into_alist", "ENTER-INTO-ALIST");
    declareFunction(myName, "alist_keys", "ALIST-KEYS", 1, 0, false);
    declareFunction(myName, "alist_values", "ALIST-VALUES", 1, 0, false);
    declareFunction(myName, "alist_optimize", "ALIST-OPTIMIZE", 2, 0, false);
    //declareFunction(myName, "alist_E", "ALIST-=", 2, 2, false);
    //declareFunction(myName, "alist_subsumesP", "ALIST-SUBSUMES?", 2, 2, false);
    declareFunction(myName, "alist_to_hash_table", "ALIST-TO-HASH-TABLE", 1, 1, false);
    declareFunction(myName, "alist_to_reverse_hash_table", "ALIST-TO-REVERSE-HASH-TABLE", 1, 1, false);
    //declareFunction(myName, "sort_alist_by_keys", "SORT-ALIST-BY-KEYS", 2, 0, false);
    //declareFunction(myName, "sort_alist_by_values", "SORT-ALIST-BY-VALUES", 2, 0, false);
    //declareFunction(myName, "property_list_p", "PROPERTY-LIST-P", 1, 0, false);
    //declareFunction(myName, "non_empty_property_list_p", "NON-EMPTY-PROPERTY-LIST-P", 1, 0, false);
    declareFunction(myName, "filter_plist", "FILTER-PLIST", 2, 0, false);
    //declareFunction(myName, "prune_plist", "PRUNE-PLIST", 1, 1, false);
    //declareFunction(myName, "plist_of_type_p", "PLIST-OF-TYPE-P", 2, 0, false);
    //declareFunction(myName, "plist_of_value_type_p", "PLIST-OF-VALUE-TYPE-P", 2, 0, false);
    //declareFunction(myName, "make_plist", "MAKE-PLIST", 2, 0, false);
    //declareMacro(myName, "plist_enter", "PLIST-ENTER");
    //declareFunction(myName, "plist_lookup", "PLIST-LOOKUP", 2, 1, false);
    //declareMacro(myName, "plist_increment", "PLIST-INCREMENT");
    //declareMacro(myName, "plist_push", "PLIST-PUSH");
    //declareFunction(myName, "alist_to_plist", "ALIST-TO-PLIST", 1, 0, false);
    //declareFunction(myName, "plist_to_alist", "PLIST-TO-ALIST", 1, 0, false);
    declareFunction(myName, "nmerge_plist", "NMERGE-PLIST", 2, 0, false);
    declareFunction(myName, "merge_plist", "MERGE-PLIST", 2, 0, false);
    //declareFunction(myName, "sort_plist_by_properties", "SORT-PLIST-BY-PROPERTIES", 2, 0, false);
    //declareFunction(myName, "sort_plist_via_position", "SORT-PLIST-VIA-POSITION", 2, 1, false);
    //declareFunction(myName, "indicator_presentP", "INDICATOR-PRESENT?", 2, 0, false);
    //declareFunction(myName, "plist_has_keyP", "PLIST-HAS-KEY?", 2, 0, false);
    //declareFunction(myName, "member_plist_key_p", "MEMBER-PLIST-KEY-P", 2, 0, false);
    //declareFunction(myName, "non_nil_plist_valueP", "NON-NIL-PLIST-VALUE?", 2, 0, false);
    //declareFunction(myName, "get_property_with_defaults", "GET-PROPERTY-WITH-DEFAULTS", 3, 1, false);
    //declareFunction(myName, "augment_plist_with_defaults", "AUGMENT-PLIST-WITH-DEFAULTS", 2, 0, false);
    //declareFunction(myName, "plist_restricted_to_indicatorsP", "PLIST-RESTRICTED-TO-INDICATORS?", 2, 0, false);
    //declareFunction(myName, "maybe_putf", "MAYBE-PUTF", 3, 0, false);
    //declareFunction(myName, "plist_properties", "PLIST-PROPERTIES", 1, 0, false);
    //declareFunction(myName, "plist_keys", "PLIST-KEYS", 1, 0, false);
    //declareFunction(myName, "plist_values", "PLIST-VALUES", 1, 0, false);
    //declareFunction(myName, "plist_restricted_to_indicators", "PLIST-RESTRICTED-TO-INDICATORS", 2, 0, false);
    //declareFunction(myName, "plist_except", "PLIST-EXCEPT", 2, 0, false);
    //declareFunction(myName, "plistlist_if_getf", "PLISTLIST-IF-GETF", 3, 1, false);
    //declareFunction(myName, "plistlist_sort", "PLISTLIST-SORT", 3, 0, false);
    //declareFunction(myName, "plistlist_sort_key", "PLISTLIST-SORT-KEY", 1, 0, false);
    //declareFunction(myName, "sub_plistP", "SUB-PLIST?", 2, 1, false);
    //declareFunction(myName, "slow_plists_equalP", "SLOW-PLISTS-EQUAL?", 2, 1, false);
    //declareFunction(myName, "format_item_list", "FORMAT-ITEM-LIST", 1, 0, false);
    //declareFunction(myName, "print_plist_readably", "PRINT-PLIST-READABLY", 1, 1, false);
    //declareFunction(myName, "pretty_print_plist", "PRETTY-PRINT-PLIST", 1, 1, false);
    //declareFunction(myName, "pretty_print_alist", "PRETTY-PRINT-ALIST", 1, 1, false);
    //declareFunction(myName, "print_list_of_lists_as_table", "PRINT-LIST-OF-LISTS-AS-TABLE", 1, 1, false);
    //declareFunction(myName, "print_list_as_delimited_line", "PRINT-LIST-AS-DELIMITED-LINE", 1, 2, false);
    declareFunction(myName, "any_in_list", "ANY-IN-LIST", 2, 1, false);
    declareFunction(myName, "every_in_list", "EVERY-IN-LIST", 2, 1, false);
    //declareFunction(myName, "not_any_in_list", "NOT-ANY-IN-LIST", 2, 1, false);
    //declareFunction(myName, "not_every_in_list", "NOT-EVERY-IN-LIST", 2, 1, false);
    //declareFunction(myName, "plist_difference", "PLIST-DIFFERENCE", 2, 1, false);
    //declareFunction(myName, "list_subseq_subst_combos", "LIST-SUBSEQ-SUBST-COMBOS", 2, 0, false);
    //declareFunction(myName, "list_subseq_subst_combos_internal", "LIST-SUBSEQ-SUBST-COMBOS-INTERNAL", 3, 0, false);
    //declareFunction(myName, "greedy_list_subseq_subst", "GREEDY-LIST-SUBSEQ-SUBST", 2, 0, false);
    //declareFunction(myName, "greedy_list_subseq_subst_internal", "GREEDY-LIST-SUBSEQ-SUBST-INTERNAL", 3, 0, false);
    declareFunction(myName, "extremal", "EXTREMAL", 2, 1, false);
    //declareFunction(myName, "extremals", "EXTREMALS", 2, 1, false);
    //declareFunction(myName, "nth_rank_items", "NTH-RANK-ITEMS", 2, 2, false);
    //declareFunction(myName, "rerank", "RERANK", 2, 3, false);
    //declareFunction(myName, "powerset", "POWERSET", 1, 0, false);
    //declareFunction(myName, "subsets_of_size", "SUBSETS-OF-SIZE", 2, 0, false);
    //declareFunction(myName, "subsets_of_size_int", "SUBSETS-OF-SIZE-INT", 2, 0, false);
    declareFunction(myName, "position_L", "POSITION-<", 3, 2, false);
    declareFunction(myName, "sort_via_position", "SORT-VIA-POSITION", 2, 2, false);
    declareFunction(myName, "stable_sort_via_position", "STABLE-SORT-VIA-POSITION", 2, 2, false);
    declareFunction(myName, "sort_via_position_earlier", "SORT-VIA-POSITION-EARLIER", 2, 0, false); new $sort_via_position_earlier$BinaryFunction();
    //declareFunction(myName, "sort_via_test", "SORT-VIA-TEST", 2, 1, false);
    //declareFunction(myName, "stable_sort_via_test", "STABLE-SORT-VIA-TEST", 2, 1, false);
    //declareFunction(myName, "sort_via_test_earlier", "SORT-VIA-TEST-EARLIER", 2, 0, false);
    //declareFunction(myName, "sort_L", "SORT-<", 1, 1, false);
    //declareFunction(myName, "sort_G", "SORT->", 1, 1, false);
    //declareFunction(myName, "safe_sort_L", "SAFE-SORT-<", 1, 1, false);
    //declareFunction(myName, "safe_sort_G", "SAFE-SORT->", 1, 1, false);
    //declareFunction(myName, "sets_of_sets_L", "SETS-OF-SETS-<", 2, 1, false);
    //declareFunction(myName, "sets_L", "SETS-<", 2, 1, false);
    //declareFunction(myName, "set_L", "SET-<", 2, 1, false);
    //declareFunction(myName, "list_structure", "LIST-STRUCTURE", 1, 1, false);
    //declareFunction(myName, "list_structure_min", "LIST-STRUCTURE-MIN", 1, 0, false);
    //declareFunction(myName, "list_structure_L", "LIST-STRUCTURE-<", 2, 0, false);
    //declareFunction(myName, "tree_min", "TREE-MIN", 1, 0, false);
    //declareFunction(myName, "safe_tree_L", "SAFE-TREE-<", 2, 0, false);
    //declareFunction(myName, "safe_L", "SAFE-<", 2, 0, false);
    //declareFunction(myName, "safe_G", "SAFE->", 2, 0, false);
    //declareFunction(myName, "safe_GE", "SAFE->=", 2, 0, false);
    //declareFunction(myName, "safe_LE", "SAFE-<=", 2, 0, false);
    //declareFunction(myName, "safe_max", "SAFE-MAX", 1, 1, false);
    //declareFunction(myName, "safe_difference", "SAFE-DIFFERENCE", 2, 0, false);
    //declareFunction(myName, "safe_quotient", "SAFE-QUOTIENT", 2, 0, false);
    //declareFunction(myName, "safe_product", "SAFE-PRODUCT", 2, 0, false);
    //declareFunction(myName, "safe_sum", "SAFE-SUM", 2, 0, false);
    declareFunction(myName, "safe_E", "SAFE-=", 2, 0, false);
    //declareFunction(myName, "equalE", "EQUAL=", 2, 0, false);
    //declareFunction(myName, "tree_L", "TREE-<", 2, 2, false);
    //declareFunction(myName, "tree_lt_intP", "TREE-LT-INT?", 4, 0, false);
    declareFunction(myName, "parametrized_median", "PARAMETRIZED-MEDIAN", 2, 0, false);
    //declareFunction(myName, "shortest", "SHORTEST", 1, 0, false);
    //declareFunction(myName, "longest", "LONGEST", 1, 0, false);
    //declareFunction(myName, "cons_count", "CONS-COUNT", 1, 0, false);
    //declareFunction(myName, "tree_delete", "TREE-DELETE", 2, 2, false);
    //declareFunction(myName, "tree_map", "TREE-MAP", 2, 1, false);
    //declareFunction(myName, "tree_ntransform_if", "TREE-NTRANSFORM-IF", 3, 1, false);
    //declareFunction(myName, "tree_transform_if", "TREE-TRANSFORM-IF", 3, 1, false);
    //declareFunction(myName, "cons_tree_find", "CONS-TREE-FIND", 2, 2, false);
    declareFunction(myName, "tree_find", "TREE-FIND", 2, 2, false);
    declareFunction(myName, "simple_tree_findP", "SIMPLE-TREE-FIND?", 2, 0, false);
    declareFunction(myName, "simple_tree_find_via_equalP", "SIMPLE-TREE-FIND-VIA-EQUAL?", 2, 0, false);
    declareFunction(myName, "tree_find_any", "TREE-FIND-ANY", 2, 2, false);
    declareFunction(myName, "cons_tree_find_if", "CONS-TREE-FIND-IF", 2, 1, false);
    declareFunction(myName, "tree_find_if", "TREE-FIND-IF", 2, 1, false);
    //declareFunction(myName, "cons_tree_count", "CONS-TREE-COUNT", 2, 2, false);
    //declareFunction(myName, "tree_count", "TREE-COUNT", 2, 2, false);
    //declareFunction(myName, "tree_countG", "TREE-COUNT>", 3, 2, false);
    //declareFunction(myName, "tree_countGE", "TREE-COUNT>=", 3, 2, false);
    //declareFunction(myName, "tree_countL", "TREE-COUNT<", 3, 2, false);
    //declareFunction(myName, "tree_countLE", "TREE-COUNT<=", 3, 2, false);
    //declareFunction(myName, "tree_countE", "TREE-COUNT=", 3, 2, false);
    //declareFunction(myName, "tree_count_internal", "TREE-COUNT-INTERNAL", 5, 1, false);
    //declareFunction(myName, "simple_tree_count", "SIMPLE-TREE-COUNT", 2, 0, false);
    //declareFunction(myName, "simple_tree_count_recursive", "SIMPLE-TREE-COUNT-RECURSIVE", 3, 0, false);
    //declareFunction(myName, "cons_tree_count_if", "CONS-TREE-COUNT-IF", 2, 1, false);
    declareFunction(myName, "tree_count_if", "TREE-COUNT-IF", 2, 1, false);
    //declareFunction(myName, "tree_count_if_unique", "TREE-COUNT-IF-UNIQUE", 2, 1, false);
    //declareFunction(myName, "cons_tree_gather", "CONS-TREE-GATHER", 2, 3, false);
    declareFunction(myName, "tree_gather", "TREE-GATHER", 2, 3, false);
    declareFunction(myName, "tree_gather_internal", "TREE-GATHER-INTERNAL", 6, 0, false);
    //declareFunction(myName, "tree_gather_ordered", "TREE-GATHER-ORDERED", 2, 2, false);
    //declareFunction(myName, "tree_gather_ordered_subs", "TREE-GATHER-ORDERED-SUBS", 3, 0, false);
    //declareFunction(myName, "tree_gather_ordered_no_subs", "TREE-GATHER-ORDERED-NO-SUBS", 3, 0, false);
    //declareFunction(myName, "tree_substitute", "TREE-SUBSTITUTE", 3, 0, false);
    //declareFunction(myName, "tree_substitute_using_dictionary", "TREE-SUBSTITUTE-USING-DICTIONARY", 2, 0, false);
    //declareFunction(myName, "tree_splice", "TREE-SPLICE", 3, 0, false);
    //declareFunction(myName, "tree_gather_transformations", "TREE-GATHER-TRANSFORMATIONS", 3, 2, false);
    //declareFunction(myName, "remove_if_doesnt_include", "REMOVE-IF-DOESNT-INCLUDE", 2, 0, false);
    declareFunction(myName, "delete_subsumed_items", "DELETE-SUBSUMED-ITEMS", 2, 1, false);
    //declareFunction(myName, "delete_subsumed_items_internal", "DELETE-SUBSUMED-ITEMS-INTERNAL", 3, 0, false);
    //declareFunction(myName, "subsumedP", "SUBSUMED?", 4, 0, false);
    //declareFunction(myName, "subsumesP", "SUBSUMES?", 4, 0, false);
    //declareFunction(myName, "subsumesP_internal", "SUBSUMES?-INTERNAL", 4, 0, false);
    //declareFunction(myName, "remove_subsumed_items", "REMOVE-SUBSUMED-ITEMS", 2, 1, false);
    //declareFunction(myName, "cross_products", "CROSS-PRODUCTS", 1, 0, false);
    //declareFunction(myName, "map_pairs", "MAP-PAIRS", 3, 0, false);
    //declareFunction(myName, "fn_with_each", "FN-WITH-EACH", 3, 0, false);
    //declareFunction(myName, "indexed_products", "INDEXED-PRODUCTS", 1, 0, false);
    //declareFunction(myName, "explicate_permutations", "EXPLICATE-PERMUTATIONS", 1, 1, false);
    //declareFunction(myName, "untranslate_elements_from_tagged_sets", "UNTRANSLATE-ELEMENTS-FROM-TAGGED-SETS", 2, 1, false);
    //declareFunction(myName, "translate_elements_to_tagged_sets", "TRANSLATE-ELEMENTS-TO-TAGGED-SETS", 2, 0, false);
    declareFunction(myName, "permute_list", "PERMUTE-LIST", 1, 1, false);
    declareFunction(myName, "permute_list_int", "PERMUTE-LIST-INT", 1, 1, false);
    declareFunction(myName, "all_permutations", "ALL-PERMUTATIONS", 1, 0, false);
    //declareFunction(myName, "nsublis_permute", "NSUBLIS-PERMUTE", 3, 0, false);
    //declareFunction(myName, "sublis_permute", "SUBLIS-PERMUTE", 3, 0, false);
    declareFunction(myName, "permute", "PERMUTE", 2, 0, false);
    //declareFunction(myName, "random_permutation", "RANDOM-PERMUTATION", 1, 0, false);
    //declareFunction(myName, "choose_n_between", "CHOOSE-N-BETWEEN", 2, 0, false);
    //declareFunction(myName, "trigram_transform", "TRIGRAM-TRANSFORM", 2, 2, false);
    //declareFunction(myName, "chunk", "CHUNK", 2, 0, false);
    //declareFunction(myName, "get_arglist", "GET-ARGLIST", 1, 0, false);
    //declareFunction(myName, "get_documentation", "GET-DOCUMENTATION", 1, 0, false);
    //declareFunction(myName, "push_on_car", "PUSH-ON-CAR", 2, 0, false);
    //declareFunction(myName, "pop_and_reverse_car_and_push_on_cadr", "POP-AND-REVERSE-CAR-AND-PUSH-ON-CADR", 1, 0, false);
    declareFunction(myName, "cartesian_product", "CARTESIAN-PRODUCT", 1, 3, false);
    declareFunction(myName, "cartesian_helper", "CARTESIAN-HELPER", 3, 0, false);
    //declareFunction(myName, "cartesian_helper_with_test", "CARTESIAN-HELPER-WITH-TEST", 4, 0, false);
    //declareFunction(myName, "pick_two", "PICK-TWO", 1, 0, false);
    //declareMacro(myName, "mapexp", "MAPEXP");
    //declareFunction(myName, "recursive_member", "RECURSIVE-MEMBER", 2, 1, false);
    declareFunction(myName, "list_of_type_p", "LIST-OF-TYPE-P", 2, 0, false);
    //declareFunction(myName, "non_empty_list_of_type_p", "NON-EMPTY-LIST-OF-TYPE-P", 2, 0, false);
    //declareFunction(myName, "list_of_list_p", "LIST-OF-LIST-P", 1, 0, false);
    //declareFunction(myName, "list_of_keyword_p", "LIST-OF-KEYWORD-P", 1, 0, false);
    //declareFunction(myName, "string_list_p", "STRING-LIST-P", 1, 0, false);
    //declareFunction(myName, "symbol_list_p", "SYMBOL-LIST-P", 1, 0, false);
    //declareFunction(myName, "function_symbol_list_p", "FUNCTION-SYMBOL-LIST-P", 1, 0, false);
    //declareFunction(myName, "form_with_operator_p", "FORM-WITH-OPERATOR-P", 2, 0, false);
    //declareFunction(myName, "verify_operator", "VERIFY-OPERATOR", 2, 0, false);
    //declareFunction(myName, "verify_form_with_operator", "VERIFY-FORM-WITH-OPERATOR", 2, 0, false);
    //declareFunction(myName, "functor_in_expression_p", "FUNCTOR-IN-EXPRESSION-P", 2, 0, false);
    //declareFunction(myName, "functor_in_body_p", "FUNCTOR-IN-BODY-P", 2, 0, false);
    //declareFunction(myName, "variable_value_used_in_body_p", "VARIABLE-VALUE-USED-IN-BODY-P", 2, 0, false);
    //declareFunction(myName, "variable_value_used_in_expression_p", "VARIABLE-VALUE-USED-IN-EXPRESSION-P", 2, 0, false);
    //declareFunction(myName, "object_in_expression_p", "OBJECT-IN-EXPRESSION-P", 2, 0, false);
    //declareFunction(myName, "parse_to_list_of_strings", "PARSE-TO-LIST-OF-STRINGS", 1, 2, false);
    //declareFunction(myName, "tree_substitute_by_association", "TREE-SUBSTITUTE-BY-ASSOCIATION", 2, 3, false);
    //declareFunction(myName, "safe_read_delimited_list", "SAFE-READ-DELIMITED-LIST", 1, 2, false);
    //declareFunction(myName, "multi_sublis", "MULTI-SUBLIS", 2, 2, false);
    //declareFunction(myName, "multi_assoc", "MULTI-ASSOC", 2, 2, false);
    //declareFunction(myName, "valid_and_conformant_alist_p", "VALID-AND-CONFORMANT-ALIST-P", 1, 2, false);
    //declareFunction(myName, "histogram", "HISTOGRAM", 1, 3, false);
    //declareFunction(myName, "histogram_as_plist", "HISTOGRAM-AS-PLIST", 1, 3, false);
    //declareFunction(myName, "pretty_print_histogram", "PRETTY-PRINT-HISTOGRAM", 1, 0, false);
    //declareFunction(myName, "n_within", "N-WITHIN", 3, 0, false);
    //declareFunction(myName, "middle_sublist", "MIDDLE-SUBLIST", 2, 0, false);
    //declareFunction(myName, "categorize_list_elements", "CATEGORIZE-LIST-ELEMENTS", 2, 1, false);
    //declareFunction(myName, "rank_tuples", "RANK-TUPLES", 1, 0, false);
    //declareFunction(myName, "collate", "COLLATE", 1, 0, false);
    //declareFunction(myName, "list_with_first_p", "LIST-WITH-FIRST-P", 2, 0, false);
    return NIL;
  }
