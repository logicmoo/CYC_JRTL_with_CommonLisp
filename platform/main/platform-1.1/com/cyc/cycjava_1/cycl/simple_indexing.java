...
convert it to the simpler form. */
  ...
  public static final SubLObject declare_simple_indexing_file() {
    declareFunction(myName, "gaf_arg_index_simple_match_p", "GAF-ARG-INDEX-SIMPLE-MATCH-P", 2, 3, false);
    declareFunction(myName, "matches_gaf_arg_index", "MATCHES-GAF-ARG-INDEX", 2, 3, false);
    declareFunction(myName, "simple_key_gaf_arg_index", "SIMPLE-KEY-GAF-ARG-INDEX", 3, 2, false);
    declareFunction(myName, "matches_gaf_arg_index_internal", "MATCHES-GAF-ARG-INDEX-INTERNAL", 5, 0, false);
    declareFunction(myName, "simple_key_gaf_arg_index_internal", "SIMPLE-KEY-GAF-ARG-INDEX-INTERNAL", 5, 0, false);
    declareFunction(myName, "matches_nart_arg_index", "MATCHES-NART-ARG-INDEX", 2, 2, false);
    declareFunction(myName, "simple_key_nart_arg_index", "SIMPLE-KEY-NART-ARG-INDEX", 3, 2, false);
    declareFunction(myName, "matches_nart_arg_index_internal", "MATCHES-NART-ARG-INDEX-INTERNAL", 4, 0, false);
    declareFunction(myName, "simple_key_nart_arg_index_internal", "SIMPLE-KEY-NART-ARG-INDEX-INTERNAL", 5, 0, false);
    declareFunction(myName, "matches_predicate_extent_index", "MATCHES-PREDICATE-EXTENT-INDEX", 2, 1, false);
    declareFunction(myName, "simple_key_predicate_extent_index", "SIMPLE-KEY-PREDICATE-EXTENT-INDEX", 3, 0, false);
    declareFunction(myName, "matches_predicate_extent_index_internal", "MATCHES-PREDICATE-EXTENT-INDEX-INTERNAL", 3, 0, false);
    declareFunction(myName, "matches_function_extent_index", "MATCHES-FUNCTION-EXTENT-INDEX", 2, 0, false);
    declareFunction(myName, "matches_function_extent_index_internal", "MATCHES-FUNCTION-EXTENT-INDEX-INTERNAL", 2, 0, false);
    declareFunction(myName, "matches_predicate_rule_index", "MATCHES-PREDICATE-RULE-INDEX", 2, 3, false);
    declareFunction(myName, "simple_key_predicate_rule_index", "SIMPLE-KEY-PREDICATE-RULE-INDEX", 3, 2, false);
    declareFunction(myName, "matches_predicate_rule_index_test", "MATCHES-PREDICATE-RULE-INDEX-TEST", 2, 0, false);
    declareFunction(myName, "matches_ist_predicate_rule_index", "MATCHES-IST-PREDICATE-RULE-INDEX", 2, 3, false);
    declareFunction(myName, "simple_key_ist_predicate_rule_index", "SIMPLE-KEY-IST-PREDICATE-RULE-INDEX", 3, 2, false);
    declareFunction(myName, "matches_ist_predicate_rule_index_test", "MATCHES-IST-PREDICATE-RULE-INDEX-TEST", 2, 0, false);
    declareFunction(myName, "matches_decontextualized_ist_predicate_rule_index", "MATCHES-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX", 2, 2, false);
    declareFunction(myName, "simple_key_decontextualized_ist_predicate_rule_index", "SIMPLE-KEY-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX", 3, 1, false);
    declareFunction(myName, "matches_decontextualized_ist_predicate_rule_index_test", "MATCHES-DECONTEXTUALIZED-IST-PREDICATE-RULE-INDEX-TEST", 2, 0, false);
    declareFunction(myName, "matches_isa_rule_index", "MATCHES-ISA-RULE-INDEX", 2, 3, false);
    declareFunction(myName, "simple_key_isa_rule_index", "SIMPLE-KEY-ISA-RULE-INDEX", 3, 2, false);
    declareFunction(myName, "matches_isa_rule_index_test", "MATCHES-ISA-RULE-INDEX-TEST", 2, 0, false);
    declareFunction(myName, "matches_quoted_isa_rule_index", "MATCHES-QUOTED-ISA-RULE-INDEX", 2, 3, false);
    declareFunction(myName, "simple_key_quoted_isa_rule_index", "SIMPLE-KEY-QUOTED-ISA-RULE-INDEX", 3, 2, false);
    declareFunction(myName, "matches_quoted_isa_rule_index_test", "MATCHES-QUOTED-ISA-RULE-INDEX-TEST", 2, 0, false);
    declareFunction(myName, "matches_genls_rule_index", "MATCHES-GENLS-RULE-INDEX", 2, 3, false);
    declareFunction(myName, "simple_key_genls_rule_index", "SIMPLE-KEY-GENLS-RULE-INDEX", 3, 2, false);
    declareFunction(myName, "matches_genls_rule_index_test", "MATCHES-GENLS-RULE-INDEX-TEST", 2, 0, false);
    declareFunction(myName, "matches_genl_mt_rule_index", "MATCHES-GENL-MT-RULE-INDEX", 2, 3, false);
    declareFunction(myName, "simple_key_genl_mt_rule_index", "SIMPLE-KEY-GENL-MT-RULE-INDEX", 3, 2, false);
    declareFunction(myName, "matches_genl_mt_rule_index_test", "MATCHES-GENL-MT-RULE-INDEX-TEST", 2, 0, false);
    declareFunction(myName, "matches_function_rule_index", "MATCHES-FUNCTION-RULE-INDEX", 2, 2, false);
    declareFunction(myName, "simple_key_function_rule_index", "SIMPLE-KEY-FUNCTION-RULE-INDEX", 3, 1, false);
    declareFunction(myName, "matches_function_rule_index_test", "MATCHES-FUNCTION-RULE-INDEX-TEST", 2, 0, false);
    declareFunction(myName, "matches_exception_rule_index", "MATCHES-EXCEPTION-RULE-INDEX", 2, 2, false);
    declareFunction(myName, "simple_key_exception_rule_index", "SIMPLE-KEY-EXCEPTION-RULE-INDEX", 3, 1, false);
    declareFunction(myName, "matches_exception_rule_index_test", "MATCHES-EXCEPTION-RULE-INDEX-TEST", 2, 0, false);
    declareFunction(myName, "matches_pragma_rule_index", "MATCHES-PRAGMA-RULE-INDEX", 2, 2, false);
    declareFunction(myName, "simple_key_pragma_rule_index", "SIMPLE-KEY-PRAGMA-RULE-INDEX", 3, 1, false);
    declareFunction(myName, "matches_pragma_rule_index_test", "MATCHES-PRAGMA-RULE-INDEX-TEST", 2, 0, false); new $matches_pragma_rule_index_test$BinaryFunction();
    declareFunction(myName, "matches_unbound_rule_index", "MATCHES-UNBOUND-RULE-INDEX", 1, 3, false);
    declareFunction(myName, "simple_key_unbound_rule_index", "SIMPLE-KEY-UNBOUND-RULE-INDEX", 2, 2, false);
    declareFunction(myName, "matches_mt_index", "MATCHES-MT-INDEX", 2, 0, false);
    declareFunction(myName, "matches_other_index", "MATCHES-OTHER-INDEX", 2, 0, false);
    declareFunction(myName, "add_simple_index", "ADD-SIMPLE-INDEX", 2, 0, false);
    declareFunction(myName, "rem_simple_index", "REM-SIMPLE-INDEX", 2, 0, false);
    declareFunction(myName, "assertion_property_match_p", "ASSERTION-PROPERTY-MATCH-P", 1, 3, false);
    declareMacro(myName, "noting_terms_to_toggle_indexing_mode", "NOTING-TERMS-TO-TOGGLE-INDEXING-MODE");
    declareFunction(myName, "noting_terms_to_toggle_indexing_mode_internal", "NOTING-TERMS-TO-TOGGLE-INDEXING-MODE-INTERNAL", 0, 0, false);
    declareFunction(myName, "possibly_toggle_term_index_mode", "POSSIBLY-TOGGLE-TERM-INDEX-MODE", 1, 0, false);
    declareFunction(myName, "toggle_term_index_mode", "TOGGLE-TERM-INDEX-MODE", 1, 0, false);
    declareFunction(myName, "convert_to_complex_index", "CONVERT-TO-COMPLEX-INDEX", 1, 0, false);
    declareFunction(myName, "convert_to_simple_index", "CONVERT-TO-SIMPLE-INDEX", 1, 0, false);
    declareFunction(myName, "reconstruct_complex_index", "RECONSTRUCT-COMPLEX-INDEX", 1, 0, false);
    declareFunction(myName, "clean_kb_indexing", "CLEAN-KB-INDEXING", 0, 0, false);
    declareFunction(myName, "clean_term_index", "CLEAN-TERM-INDEX", 1, 0, false);
    declareFunction(myName, "clean_term_index_internal", "CLEAN-TERM-INDEX-INTERNAL", 1, 0, false);
    return NIL;
  }
