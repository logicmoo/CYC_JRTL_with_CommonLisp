...
public  final class constant_completion extends SubLTranslatedFile {
  ...
  public static final SubLObject init_constant_completion_file() {
    $constant_names_in_code$ = deflexical("*CONSTANT-NAMES-IN-CODE*", maybeDefault( $sym0$_CONSTANT_NAMES_IN_CODE_, $constant_names_in_code$, NIL));
    $bogus_constant_names_in_code$ = deflexical("*BOGUS-CONSTANT-NAMES-IN-CODE*", maybeDefault( $sym1$_BOGUS_CONSTANT_NAMES_IN_CODE_, $bogus_constant_names_in_code$, NIL));
    return NIL;
  }
