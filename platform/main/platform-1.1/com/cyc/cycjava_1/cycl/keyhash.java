...
public  final class keyhash extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_keyhash_file() {
    ...
    declareFunction("keyhash_p", "KEYHASH-P", 1, 0, false); new $keyhash_p$UnaryFunction();
    ...
    declareFunction("iterate_keyhash_necessary", "ITERATE-KEYHASH-NECESSARY", 1, 0, false); new $iterate_keyhash_necessary$UnaryFunction();
