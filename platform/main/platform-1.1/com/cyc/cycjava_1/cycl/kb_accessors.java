...
//dm import com.cyc.cycjava_1.cycl.czer_trampolines;
...
the #$fanOutArg for hierarchically transitive PRED. */
  ...
  public static final SubLObject declare_kb_accessors_file() {
    ...
    declareFunction("fast_non_skolem_indeterminate_termP", "FAST-NON-SKOLEM-INDETERMINATE-TERM?", 1, 0, false); new $fast_non_skolem_indeterminate_termP$UnaryFunction();
    ...
    //declareFunction("clear_guess_the_cyclist_from_user_name", "CLEAR-GUESS-THE-CYCLIST-FROM-USER-NAME", 0, 0, false); new $clear_guess_the_cyclist_from_user_name$ZeroArityFunction();
