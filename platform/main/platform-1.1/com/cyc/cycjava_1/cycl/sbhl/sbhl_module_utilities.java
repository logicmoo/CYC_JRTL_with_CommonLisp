...
public  final class sbhl_module_utilities extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_sbhl_module_utilities_file() {
    declareFunction(myName, "init_sbhl_module_data", "INIT-SBHL-MODULE-DATA", 2, 0, false);
    declareFunction(myName, "clear_get_sbhl_predicates", "CLEAR-GET-SBHL-PREDICATES", 0, 0, false);
    //declareFunction(myName, "remove_get_sbhl_predicates", "REMOVE-GET-SBHL-PREDICATES", 0, 0, false);
    declareFunction(myName, "get_sbhl_predicates_internal", "GET-SBHL-PREDICATES-INTERNAL", 0, 0, false);
    declareFunction(myName, "get_sbhl_predicates", "GET-SBHL-PREDICATES", 0, 0, false);
    declareFunction(myName, "sbhl_predicate_p", "SBHL-PREDICATE-P", 1, 0, false);
    //declareFunction(myName, "sbhl_module_or_predicate_p", "SBHL-MODULE-OR-PREDICATE-P", 1, 0, false);
    //declareFunction(myName, "sbhl_non_time_module_p", "SBHL-NON-TIME-MODULE-P", 1, 0, false);
    declareFunction(myName, "sbhl_non_time_predicate_p", "SBHL-NON-TIME-PREDICATE-P", 1, 0, false);
    //declareFunction(myName, "sbhl_graph_p", "SBHL-GRAPH-P", 1, 0, false);
    declareFunction(myName, "get_sbhl_link_pred", "GET-SBHL-LINK-PRED", 1, 0, false);
    declareFunction(myName, "get_sbhl_link_style", "GET-SBHL-LINK-STYLE", 1, 0, false);
    //declareFunction(myName, "get_sbhl_module_naut_forward_true_generators", "GET-SBHL-MODULE-NAUT-FORWARD-TRUE-GENERATORS", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_type", "GET-SBHL-MODULE-TYPE", 1, 0, false);
    declareFunction(myName, "get_sbhl_path_terminating_markP_fn", "GET-SBHL-PATH-TERMINATING-MARK?-FN", 1, 0, false);
    declareFunction(myName, "get_sbhl_marking_fn", "GET-SBHL-MARKING-FN", 1, 0, false);
    declareFunction(myName, "get_sbhl_unmarking_fn", "GET-SBHL-UNMARKING-FN", 1, 0, false);
    //declareFunction(myName, "get_sbhl_module_marking_increment", "GET-SBHL-MODULE-MARKING-INCREMENT", 1, 0, false);
    declareFunction(myName, "get_sbhl_index_arg", "GET-SBHL-INDEX-ARG", 1, 0, false);
    //declareFunction(myName, "get_sbhl_gather_arg", "GET-SBHL-GATHER-ARG", 1, 0, false);
    declareFunction(myName, "get_sbhl_add_node_to_result_test", "GET-SBHL-ADD-NODE-TO-RESULT-TEST", 1, 0, false);
    //declareFunction(myName, "get_sbhl_add_unmarked_node_to_result_test", "GET-SBHL-ADD-UNMARKED-NODE-TO-RESULT-TEST", 1, 0, false);
    declareFunction(myName, "get_sbhl_type_test", "GET-SBHL-TYPE-TEST", 1, 0, false);
    //declareFunction(myName, "get_sbhl_module_root", "GET-SBHL-MODULE-ROOT", 1, 0, false);
    //declareFunction(myName, "get_sbhl_transfers_via_arg", "GET-SBHL-TRANSFERS-VIA-ARG", 1, 0, false);
    declareFunction(myName, "get_sbhl_accessible_link_preds", "GET-SBHL-ACCESSIBLE-LINK-PREDS", 1, 0, false);
    declareFunction(myName, "sbhl_module_indicates_predicate_search_p", "SBHL-MODULE-INDICATES-PREDICATE-SEARCH-P", 1, 0, false);
    //declareFunction(myName, "get_sbhl_node_modules", "GET-SBHL-NODE-MODULES", 1, 0, false);
    declareFunction(myName, "sbhl_disjoins_search_p", "SBHL-DISJOINS-SEARCH-P", 0, 0, false);
    declareFunction(myName, "sbhl_time_search_p", "SBHL-TIME-SEARCH-P", 0, 0, false);
    //declareFunction(myName, "sbhl_root_p", "SBHL-ROOT-P", 2, 0, false);
    //declareFunction(myName, "get_sbhl_inverse_link_module", "GET-SBHL-INVERSE-LINK-MODULE", 1, 0, false);
    //declareFunction(myName, "get_sbhl_module_relevant_naut_link_generators", "GET-SBHL-MODULE-RELEVANT-NAUT-LINK-GENERATORS", 3, 0, false);
    declareFunction(myName, "sbhl_simple_module_p", "SBHL-SIMPLE-MODULE-P", 1, 0, false);
    declareFunction(myName, "sbhl_time_module_p", "SBHL-TIME-MODULE-P", 1, 0, false);
    declareFunction(myName, "sbhl_transitive_module_p", "SBHL-TRANSITIVE-MODULE-P", 1, 0, false);
    declareFunction(myName, "sbhl_inverse_module_p", "SBHL-INVERSE-MODULE-P", 1, 0, false);
    //declareFunction(myName, "get_sbhl_inverse_module", "GET-SBHL-INVERSE-MODULE", 1, 0, false);
    //declareFunction(myName, "get_sbhl_module_with_inverted_arguments", "GET-SBHL-MODULE-WITH-INVERTED-ARGUMENTS", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_which_this_module_inverts_arguments_of", "GET-SBHL-MODULE-WHICH-THIS-MODULE-INVERTS-ARGUMENTS-OF", 1, 0, false);
    //declareFunction(myName, "get_sbhl_module_tag", "GET-SBHL-MODULE-TAG", 1, 0, false);
    declareFunction(myName, "new_sbhl_module_graph", "NEW-SBHL-MODULE-GRAPH", 1, 0, false);
    declareFunction(myName, "get_sbhl_graph", "GET-SBHL-GRAPH", 1, 0, false);
    //declareFunction(myName, "get_sbhl_graphs", "GET-SBHL-GRAPHS", 0, 0, false);
    declareFunction(myName, "sbhl_disjoins_module_p", "SBHL-DISJOINS-MODULE-P", 1, 0, false);
    declareFunction(myName, "get_sbhl_disjoins_module", "GET-SBHL-DISJOINS-MODULE", 1, 0, false);
    declareFunction(myName, "sbhl_transfers_through_module_p", "SBHL-TRANSFERS-THROUGH-MODULE-P", 1, 0, false);
    declareFunction(myName, "get_sbhl_transfers_through_module", "GET-SBHL-TRANSFERS-THROUGH-MODULE", 1, 0, false);
    declareFunction(myName, "sbhl_reflexive_module_p", "SBHL-REFLEXIVE-MODULE-P", 1, 0, false);
    declareFunction(myName, "get_sbhl_disjoins_search_tt_module", "GET-SBHL-DISJOINS-SEARCH-TT-MODULE", 1, 0, false);
    declareFunction(myName, "get_sbhl_reductions_module", "GET-SBHL-REDUCTIONS-MODULE", 1, 0, false);
    declareFunction(myName, "get_sbhl_premark_module", "GET-SBHL-PREMARK-MODULE", 1, 0, false);
    //declareFunction(myName, "sbhl_search_direction_p", "SBHL-SEARCH-DIRECTION-P", 1, 0, false);
    //declareFunction(myName, "sbhl_forward_direction_for_module_p", "SBHL-FORWARD-DIRECTION-FOR-MODULE-P", 2, 0, false);
    declareFunction(myName, "get_sbhl_module_forward_direction", "GET-SBHL-MODULE-FORWARD-DIRECTION", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_backward_direction", "GET-SBHL-MODULE-BACKWARD-DIRECTION", 1, 0, false);
    //declareFunction(myName, "get_sbhl_opposite_search_direction", "GET-SBHL-OPPOSITE-SEARCH-DIRECTION", 0, 1, false);
    declareFunction(myName, "sbhl_module_directed_linksP", "SBHL-MODULE-DIRECTED-LINKS?", 1, 0, false);
    declareFunction(myName, "sbhl_search_direction_to_link_direction", "SBHL-SEARCH-DIRECTION-TO-LINK-DIRECTION", 2, 0, false);
    //declareFunction(myName, "sbhl_search_direction_to_opposite_link_direction", "SBHL-SEARCH-DIRECTION-TO-OPPOSITE-LINK-DIRECTION", 2, 0, false);
    declareFunction(myName, "get_relevant_sbhl_directions", "GET-RELEVANT-SBHL-DIRECTIONS", 1, 0, false);
    declareFunction(myName, "sbhl_predicate_cardinality", "SBHL-PREDICATE-CARDINALITY", 2, 0, false);
    declareFunction(myName, "sbhl_inverse_cardinality", "SBHL-INVERSE-CARDINALITY", 2, 0, false);
    //declareFunction(myName, "sbhl_module_hl_support_module", "SBHL-MODULE-HL-SUPPORT-MODULE", 1, 0, false);
    //declareFunction(myName, "sbhl_pred_hl_support_module", "SBHL-PRED-HL-SUPPORT-MODULE", 1, 0, false);
    //declareFunction(myName, "sbhl_old_mode", "SBHL-OLD-MODE", 2, 0, false);
    declareFunction(myName, "sbhl_pred_get_hl_module", "SBHL-PRED-GET-HL-MODULE", 1, 0, false);
    //declareFunction(myName, "sbhl_old_module", "SBHL-OLD-MODULE", 1, 0, false);
    //declareFunction(myName, "sbhl_predicate_for_hl_module", "SBHL-PREDICATE-FOR-HL-MODULE", 1, 0, false);
    //declareFunction(myName, "sbhl_predicate_from_fort_type", "SBHL-PREDICATE-FROM-FORT-TYPE", 1, 0, false);
    //declareFunction(myName, "sbhl_node_has_type_associated_to_predicate_p", "SBHL-NODE-HAS-TYPE-ASSOCIATED-TO-PREDICATE-P", 2, 0, false);
    //declareFunction(myName, "determine_sbhl_predicate_from_fort_type", "DETERMINE-SBHL-PREDICATE-FROM-FORT-TYPE", 1, 1, false);
    //declareFunction(myName, "determine_sbhl_module_from_fort_type", "DETERMINE-SBHL-MODULE-FROM-FORT-TYPE", 1, 1, false);
    //declareFunction(myName, "sbhl_node_with_any_sbhl_type_p", "SBHL-NODE-WITH-ANY-SBHL-TYPE-P", 1, 1, false);
    //declareFunction(myName, "sbhl_fortP", "SBHL-FORT?", 1, 0, false);
    declareFunction(myName, "sbhl_isa_collection_p", "SBHL-ISA-COLLECTION-P", 1, 0, false);
    declareFunction(myName, "sbhl_isa_microtheory_p", "SBHL-ISA-MICROTHEORY-P", 1, 0, false);
    declareFunction(myName, "sbhl_isa_predicate_p", "SBHL-ISA-PREDICATE-P", 1, 0, false);
    declareFunction(myName, "apply_sbhl_module_type_test", "APPLY-SBHL-MODULE-TYPE-TEST", 2, 0, false);
    //declareFunction(myName, "sbhl_module_meets_requisitesP", "SBHL-MODULE-MEETS-REQUISITES?", 1, 0, false);
    return NIL;
  }
