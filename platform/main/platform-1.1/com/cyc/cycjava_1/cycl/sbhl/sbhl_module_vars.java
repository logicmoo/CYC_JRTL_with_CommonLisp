...
extent.   The two possible values are t (assume nonempty) and nil (assume nothing) */
  ...
  public static final SubLObject declare_sbhl_module_vars_file() {
    declareFunction(myName, "sbhl_module_print_function_trampoline", "SBHL-MODULE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction(myName, "sbhl_module_p", "SBHL-MODULE-P", 1, 0, false); new $sbhl_module_p$UnaryFunction();
    declareFunction(myName, "sbhl_mod_link_pred", "SBHL-MOD-LINK-PRED", 1, 0, false);
    declareFunction(myName, "sbhl_mod_accessible_link_preds", "SBHL-MOD-ACCESSIBLE-LINK-PREDS", 1, 0, false);
    declareFunction(myName, "sbhl_mod_graph", "SBHL-MOD-GRAPH", 1, 0, false);
    declareFunction(myName, "sbhl_mod_link_style", "SBHL-MOD-LINK-STYLE", 1, 0, false);
    declareFunction(myName, "sbhl_mod_index_arg", "SBHL-MOD-INDEX-ARG", 1, 0, false);
    declareFunction(myName, "sbhl_mod_module_type", "SBHL-MOD-MODULE-TYPE", 1, 0, false);
    declareFunction(myName, "sbhl_mod_type_test", "SBHL-MOD-TYPE-TEST", 1, 0, false);
    declareFunction(myName, "sbhl_mod_path_terminating_mark_fn", "SBHL-MOD-PATH-TERMINATING-MARK-FN", 1, 0, false);
    declareFunction(myName, "sbhl_mod_marking_fn", "SBHL-MOD-MARKING-FN", 1, 0, false);
    declareFunction(myName, "sbhl_mod_unmarking_fn", "SBHL-MOD-UNMARKING-FN", 1, 0, false);
    //declareFunction(myName, "sbhl_mod_var_bindings", "SBHL-MOD-VAR-BINDINGS", 1, 0, false);
    declareFunction(myName, "sbhl_mod_misc_properties", "SBHL-MOD-MISC-PROPERTIES", 1, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_link_pred", "_CSETF-SBHL-MOD-LINK-PRED", 2, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_accessible_link_preds", "_CSETF-SBHL-MOD-ACCESSIBLE-LINK-PREDS", 2, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_graph", "_CSETF-SBHL-MOD-GRAPH", 2, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_link_style", "_CSETF-SBHL-MOD-LINK-STYLE", 2, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_index_arg", "_CSETF-SBHL-MOD-INDEX-ARG", 2, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_module_type", "_CSETF-SBHL-MOD-MODULE-TYPE", 2, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_type_test", "_CSETF-SBHL-MOD-TYPE-TEST", 2, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_path_terminating_mark_fn", "_CSETF-SBHL-MOD-PATH-TERMINATING-MARK-FN", 2, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_marking_fn", "_CSETF-SBHL-MOD-MARKING-FN", 2, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_unmarking_fn", "_CSETF-SBHL-MOD-UNMARKING-FN", 2, 0, false);
    //declareFunction(myName, "_csetf_sbhl_mod_var_bindings", "_CSETF-SBHL-MOD-VAR-BINDINGS", 2, 0, false);
    declareFunction(myName, "_csetf_sbhl_mod_misc_properties", "_CSETF-SBHL-MOD-MISC-PROPERTIES", 2, 0, false);
    declareFunction(myName, "make_sbhl_module", "MAKE-SBHL-MODULE", 0, 1, false);
    //declareFunction(myName, "print_sbhl_module", "PRINT-SBHL-MODULE", 3, 0, false);
    declareFunction(myName, "new_sbhl_module", "NEW-SBHL-MODULE", 1, 0, false);
    declareFunction(myName, "set_sbhl_module_property", "SET-SBHL-MODULE-PROPERTY", 3, 0, false);
    declareFunction(myName, "get_sbhl_module_property", "GET-SBHL-MODULE-PROPERTY", 2, 0, false);
    declareFunction(myName, "get_sbhl_module_link_pred", "GET-SBHL-MODULE-LINK-PRED", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_accessible_link_preds", "GET-SBHL-MODULE-ACCESSIBLE-LINK-PREDS", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_graph", "GET-SBHL-MODULE-GRAPH", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_link_style", "GET-SBHL-MODULE-LINK-STYLE", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_index_arg", "GET-SBHL-MODULE-INDEX-ARG", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_module_type", "GET-SBHL-MODULE-MODULE-TYPE", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_type_test", "GET-SBHL-MODULE-TYPE-TEST", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_path_terminating_mark", "GET-SBHL-MODULE-PATH-TERMINATING-MARK", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_marking_fn", "GET-SBHL-MODULE-MARKING-FN", 1, 0, false);
    declareFunction(myName, "get_sbhl_module_unmarking_fn", "GET-SBHL-MODULE-UNMARKING-FN", 1, 0, false);
    declareFunction(myName, "sbhl_module_object_p", "SBHL-MODULE-OBJECT-P", 1, 0, false);
    declareFunction(myName, "reset_sbhl_modules", "RESET-SBHL-MODULES", 0, 0, false);
    //declareFunction(myName, "rebuild_sbhl_modules", "REBUILD-SBHL-MODULES", 0, 0, false);
    declareFunction(myName, "get_sbhl_modules", "GET-SBHL-MODULES", 0, 0, false);
    declareFunction(myName, "add_sbhl_module", "ADD-SBHL-MODULE", 2, 0, false);
    //declareFunction(myName, "remove_sbhl_module", "REMOVE-SBHL-MODULE", 1, 0, false);
    //declareMacro(myName, "do_sbhl_modules", "DO-SBHL-MODULES");
    declareFunction(myName, "get_sbhl_predicates_int", "GET-SBHL-PREDICATES-INT", 0, 0, false);
    declareFunction(myName, "get_sbhl_module_list", "GET-SBHL-MODULE-LIST", 0, 0, false);
    declareFunction(myName, "sbhl_predicate_object_p", "SBHL-PREDICATE-OBJECT-P", 1, 0, false);
    declareFunction(myName, "sbhl_simple_reflexive_module_type_p", "SBHL-SIMPLE-REFLEXIVE-MODULE-TYPE-P", 1, 0, false);
    declareFunction(myName, "sbhl_simple_non_reflexive_module_type_p", "SBHL-SIMPLE-NON-REFLEXIVE-MODULE-TYPE-P", 1, 0, false);
    declareFunction(myName, "sbhl_transfers_through_module_type_p", "SBHL-TRANSFERS-THROUGH-MODULE-TYPE-P", 1, 0, false);
    declareFunction(myName, "sbhl_disjoins_module_type_p", "SBHL-DISJOINS-MODULE-TYPE-P", 1, 0, false);
    declareFunction(myName, "sbhl_time_module_type_p", "SBHL-TIME-MODULE-TYPE-P", 1, 0, false);
    declareFunction(myName, "sbhl_transitive_module_type_p", "SBHL-TRANSITIVE-MODULE-TYPE-P", 1, 0, false);
    //declareFunction(myName, "sbhl_module_type_p", "SBHL-MODULE-TYPE-P", 1, 0, false);
    //declareMacro(myName, "do_sbhl_simple_modules", "DO-SBHL-SIMPLE-MODULES");
    //declareMacro(myName, "do_sbhl_time_modules", "DO-SBHL-TIME-MODULES");
    //declareMacro(myName, "do_sbhl_time_predicates", "DO-SBHL-TIME-PREDICATES");
    declareFunction(myName, "init_sbhl_module_properties", "INIT-SBHL-MODULE-PROPERTIES", 1, 0, false);
    //declareFunction(myName, "get_sbhl_module_properties", "GET-SBHL-MODULE-PROPERTIES", 0, 0, false);
    //declareFunction(myName, "add_sbhl_module_property", "ADD-SBHL-MODULE-PROPERTY", 2, 0, false);
    declareFunction(myName, "sbhl_module_property_p", "SBHL-MODULE-PROPERTY-P", 1, 0, false);
    //declareMacro(myName, "do_sbhl_module_properties", "DO-SBHL-MODULE-PROPERTIES");
    //declareFunction(myName, "get_sbhl_module_required_properties", "GET-SBHL-MODULE-REQUIRED-PROPERTIES", 0, 0, false);
    //declareFunction(myName, "sbhl_module_required_property_p", "SBHL-MODULE-REQUIRED-PROPERTY-P", 1, 0, false);
    //declareMacro(myName, "do_sbhl_module_required_properties", "DO-SBHL-MODULE-REQUIRED-PROPERTIES");
    declareFunction(myName, "get_sbhl_module", "GET-SBHL-MODULE", 0, 1, false); new $get_sbhl_module$ZeroArityFunction(); new $get_sbhl_module$UnaryFunction();
    //declareMacro(myName, "with_sbhl_module", "WITH-SBHL-MODULE");
    //declareMacro(myName, "possibly_with_sbhl_module", "POSSIBLY-WITH-SBHL-MODULE");
    declareFunction(myName, "fort_denotes_sbhl_directed_graph_p", "FORT-DENOTES-SBHL-DIRECTED-GRAPH-P", 1, 0, false);
    //declareFunction(myName, "sbhl_link_style_specifier_p", "SBHL-LINK-STYLE-SPECIFIER-P", 1, 0, false);
    declareFunction(myName, "clean_sbhl_modules", "CLEAN-SBHL-MODULES", 0, 0, false);
    declareFunction(myName, "optimize_sbhl_modules", "OPTIMIZE-SBHL-MODULES", 0, 0, false);
    declareFunction(myName, "sbhl_modules_link_pred_L", "SBHL-MODULES-LINK-PRED-<", 2, 0, false);
    declareFunction(myName, "sbhl_module_link_pred_preference_order", "SBHL-MODULE-LINK-PRED-PREFERENCE-ORDER", 0, 0, false);
    return NIL;
  }
