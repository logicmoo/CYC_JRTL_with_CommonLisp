...
public  final class sbhl_macros extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_sbhl_macros_file() {
    //declareMacro(myName, "do_sbhl_link_nodes", "DO-SBHL-LINK-NODES");
    //declareMacro(myName, "do_sbhl_tv_links", "DO-SBHL-TV-LINKS");
    //declareMacro(myName, "do_sbhl_mt_link", "DO-SBHL-MT-LINK");
    //declareMacro(myName, "do_sbhl_mt_links", "DO-SBHL-MT-LINKS");
    //declareMacro(myName, "do_sbhl_direction_link", "DO-SBHL-DIRECTION-LINK");
    //declareMacro(myName, "do_sbhl_graph_link", "DO-SBHL-GRAPH-LINK");
    //declareMacro(myName, "do_sbhl_forward_true_link_mts", "DO-SBHL-FORWARD-TRUE-LINK-MTS");
    //declareMacro(myName, "do_sbhl_forward_true_link_nodes_and_mts", "DO-SBHL-FORWARD-TRUE-LINK-NODES-AND-MTS");
    //declareMacro(myName, "do_all_sbhl_tv_links", "DO-ALL-SBHL-TV-LINKS");
    //declareMacro(myName, "do_all_sbhl_link_nodes", "DO-ALL-SBHL-LINK-NODES");
    //declareMacro(myName, "do_all_sbhl_forward_true_link_nodes", "DO-ALL-SBHL-FORWARD-TRUE-LINK-NODES");
    //declareMacro(myName, "do_all_sbhl_backward_true_link_nodes", "DO-ALL-SBHL-BACKWARD-TRUE-LINK-NODES");
    //declareMacro(myName, "with_sbhl_graph_link", "WITH-SBHL-GRAPH-LINK");
    //declareMacro(myName, "with_relevant_sbhl_link_nodes", "WITH-RELEVANT-SBHL-LINK-NODES");
    //declareMacro(myName, "with_relevant_sbhl_link_nodes_and_non_forts", "WITH-RELEVANT-SBHL-LINK-NODES-AND-NON-FORTS");
    //declareMacro(myName, "with_relevant_sbhl_fort_link_nodes", "WITH-RELEVANT-SBHL-FORT-LINK-NODES");
    //declareMacro(myName, "do_non_fort_direct_instance_links", "DO-NON-FORT-DIRECT-INSTANCE-LINKS");
    //declareMacro(myName, "with_sbhl_non_fort_links", "WITH-SBHL-NON-FORT-LINKS");
    declareFunction(myName, "do_sbhl_non_fort_linksP", "DO-SBHL-NON-FORT-LINKS?", 2, 0, false);
    declareFunction(myName, "collection_supports_non_fort_instancesP", "COLLECTION-SUPPORTS-NON-FORT-INSTANCES?", 1, 0, false);
    //declareFunction(myName, "admissible_non_fort_link_nodeP", "ADMISSIBLE-NON-FORT-LINK-NODE?", 1, 0, false);
    //declareMacro(myName, "do_relevant_sbhl_naut_generated_links", "DO-RELEVANT-SBHL-NAUT-GENERATED-LINKS");
    //declareMacro(myName, "do_relevant_forward_sbhl_link_nodes", "DO-RELEVANT-FORWARD-SBHL-LINK-NODES");
    //declareMacro(myName, "do_relevant_backward_sbhl_link_nodes", "DO-RELEVANT-BACKWARD-SBHL-LINK-NODES");
    //declareMacro(myName, "with_accessible_sbhl_link_nodes", "WITH-ACCESSIBLE-SBHL-LINK-NODES");
    //declareMacro(myName, "with_accessible_sbhl_link_nodes_and_non_forts", "WITH-ACCESSIBLE-SBHL-LINK-NODES-AND-NON-FORTS");
    //declareMacro(myName, "do_accessible_sbhl_link_nodes", "DO-ACCESSIBLE-SBHL-LINK-NODES");
    //declareMacro(myName, "do_accessible_sbhl_link_nodes_and_non_forts", "DO-ACCESSIBLE-SBHL-LINK-NODES-AND-NON-FORTS");
    //declareMacro(myName, "do_accessible_sbhl_link_node_search_states", "DO-ACCESSIBLE-SBHL-LINK-NODE-SEARCH-STATES");
    //declareMacro(myName, "do_accessible_sbhl_tv_links", "DO-ACCESSIBLE-SBHL-TV-LINKS");
    //declareMacro(myName, "do_relevant_sbhl_link_nodes", "DO-RELEVANT-SBHL-LINK-NODES");
    //declareMacro(myName, "do_relevant_sbhl_forward_link_nodes", "DO-RELEVANT-SBHL-FORWARD-LINK-NODES");
    //declareMacro(myName, "do_relevant_sbhl_backward_link_nodes", "DO-RELEVANT-SBHL-BACKWARD-LINK-NODES");
    //declareMacro(myName, "do_sbhl_predicates", "DO-SBHL-PREDICATES");
    //declareMacro(myName, "do_sbhl_non_time_predicates", "DO-SBHL-NON-TIME-PREDICATES");
    //declareMacro(myName, "do_sbhl_non_time_modules", "DO-SBHL-NON-TIME-MODULES");
    //declareMacro(myName, "do_sbhl_graphs", "DO-SBHL-GRAPHS");
    //declareMacro(myName, "with_forward_sbhl_link_direction", "WITH-FORWARD-SBHL-LINK-DIRECTION");
    //declareMacro(myName, "with_backward_sbhl_link_direction", "WITH-BACKWARD-SBHL-LINK-DIRECTION");
    //declareMacro(myName, "with_sbhl_type_test", "WITH-SBHL-TYPE-TEST");
    //declareMacro(myName, "do_sbhl_module_graph", "DO-SBHL-MODULE-GRAPH");
    //declareMacro(myName, "do_with_relevant_sbhl_modules", "DO-WITH-RELEVANT-SBHL-MODULES");
    declareFunction(myName, "get_sbhl_accessible_modules", "GET-SBHL-ACCESSIBLE-MODULES", 1, 0, false);
    //declareMacro(myName, "do_relevant_sbhl_directions", "DO-RELEVANT-SBHL-DIRECTIONS");
    //declareMacro(myName, "bind_sbhl_search_behavior", "BIND-SBHL-SEARCH-BEHAVIOR");
    //declareMacro(myName, "bind_sbhl_boolean_goal_fn", "BIND-SBHL-BOOLEAN-GOAL-FN");
    //declareMacro(myName, "bind_sbhl_sample_leaf_search_behavior", "BIND-SBHL-SAMPLE-LEAF-SEARCH-BEHAVIOR");
    //declareMacro(myName, "do_all_simple_true_links", "DO-ALL-SIMPLE-TRUE-LINKS");
    //declareMacro(myName, "do_all_simple_forward_true_links", "DO-ALL-SIMPLE-FORWARD-TRUE-LINKS");
    //declareMacro(myName, "do_all_simple_backward_true_links", "DO-ALL-SIMPLE-BACKWARD-TRUE-LINKS");
    //declareMacro(myName, "do_all_simple_true_links_for_inverses", "DO-ALL-SIMPLE-TRUE-LINKS-FOR-INVERSES");
    //declareMacro(myName, "do_all_simple_forward_true_links_for_inverses", "DO-ALL-SIMPLE-FORWARD-TRUE-LINKS-FOR-INVERSES");
    //declareMacro(myName, "do_all_simple_backward_true_links_for_inverses", "DO-ALL-SIMPLE-BACKWARD-TRUE-LINKS-FOR-INVERSES");
    //declareMacro(myName, "do_all_mode_true_links_for_inverses", "DO-ALL-MODE-TRUE-LINKS-FOR-INVERSES");
    //declareMacro(myName, "do_all_mode_backward_true_links_for_inverses", "DO-ALL-MODE-BACKWARD-TRUE-LINKS-FOR-INVERSES");
    //declareMacro(myName, "do_all_mode_forward_true_links_for_inverses", "DO-ALL-MODE-FORWARD-TRUE-LINKS-FOR-INVERSES");
    //declareMacro(myName, "do_all_forward_true_links_for_tt", "DO-ALL-FORWARD-TRUE-LINKS-FOR-TT");
    //declareMacro(myName, "do_all_backward_true_links_for_tt", "DO-ALL-BACKWARD-TRUE-LINKS-FOR-TT");
    //declareMacro(myName, "do_true_isa_links", "DO-TRUE-ISA-LINKS");
    //declareMacro(myName, "do_relevant_isa_links", "DO-RELEVANT-ISA-LINKS");
    //declareMacro(myName, "do_local_isas", "DO-LOCAL-ISAS");
    //declareMacro(myName, "some_relevant_isa", "SOME-RELEVANT-ISA");
    //declareMacro(myName, "do_true_instance_links", "DO-TRUE-INSTANCE-LINKS");
    //declareMacro(myName, "do_relevant_instance_links", "DO-RELEVANT-INSTANCE-LINKS");
    //declareMacro(myName, "do_local_instances", "DO-LOCAL-INSTANCES");
    //declareMacro(myName, "do_true_quoted_isa_links", "DO-TRUE-QUOTED-ISA-LINKS");
    //declareMacro(myName, "do_local_quoted_isas", "DO-LOCAL-QUOTED-ISAS");
    //declareMacro(myName, "do_true_quoted_instance_links", "DO-TRUE-QUOTED-INSTANCE-LINKS");
    //declareMacro(myName, "do_local_quoted_instances", "DO-LOCAL-QUOTED-INSTANCES");
    //declareMacro(myName, "do_all_isa", "DO-ALL-ISA");
    //declareMacro(myName, "do_all_isa_depth", "DO-ALL-ISA-DEPTH");
    //declareMacro(myName, "do_all_isa_breadth", "DO-ALL-ISA-BREADTH");
    //declareMacro(myName, "do_all_isas_by_generality", "DO-ALL-ISAS-BY-GENERALITY");
    //declareMacro(myName, "do_all_instances", "DO-ALL-INSTANCES");
    //declareMacro(myName, "do_all_instances_depth", "DO-ALL-INSTANCES-DEPTH");
    //declareMacro(myName, "do_all_instances_breadth", "DO-ALL-INSTANCES-BREADTH");
    //declareMacro(myName, "do_all_fort_instances", "DO-ALL-FORT-INSTANCES");
    //declareMacro(myName, "do_all_instances_of_all", "DO-ALL-INSTANCES-OF-ALL");
    //declareMacro(myName, "do_all_quoted_instances", "DO-ALL-QUOTED-INSTANCES");
    //declareMacro(myName, "do_all_quoted_instances_of_all", "DO-ALL-QUOTED-INSTANCES-OF-ALL");
    //declareMacro(myName, "do_true_genls_links", "DO-TRUE-GENLS-LINKS");
    //declareMacro(myName, "do_relevant_genls_links", "DO-RELEVANT-GENLS-LINKS");
    //declareMacro(myName, "do_genls", "DO-GENLS");
    //declareMacro(myName, "do_local_genls", "DO-LOCAL-GENLS");
    //declareMacro(myName, "do_true_spec_links", "DO-TRUE-SPEC-LINKS");
    //declareMacro(myName, "do_relevant_spec_links", "DO-RELEVANT-SPEC-LINKS");
    //declareMacro(myName, "do_local_specs", "DO-LOCAL-SPECS");
    //declareMacro(myName, "do_all_genls", "DO-ALL-GENLS");
    //declareMacro(myName, "do_all_genls_depth", "DO-ALL-GENLS-DEPTH");
    //declareMacro(myName, "do_all_genls_breadth", "DO-ALL-GENLS-BREADTH");
    //declareMacro(myName, "do_all_genls_by_generality", "DO-ALL-GENLS-BY-GENERALITY");
    //declareMacro(myName, "do_all_specs", "DO-ALL-SPECS");
    //declareMacro(myName, "do_all_specs_depth", "DO-ALL-SPECS-DEPTH");
    //declareMacro(myName, "do_all_specs_breadth", "DO-ALL-SPECS-BREADTH");
    //declareMacro(myName, "do_all_specs_by_generality", "DO-ALL-SPECS-BY-GENERALITY");
    //declareMacro(myName, "do_true_genl_predicate_links", "DO-TRUE-GENL-PREDICATE-LINKS");
    //declareMacro(myName, "do_relevant_genl_predicate_links", "DO-RELEVANT-GENL-PREDICATE-LINKS");
    //declareMacro(myName, "do_true_spec_predicate_links", "DO-TRUE-SPEC-PREDICATE-LINKS");
    //declareMacro(myName, "do_relevant_spec_predicate_links", "DO-RELEVANT-SPEC-PREDICATE-LINKS");
    //declareMacro(myName, "do_all_genl_predicates", "DO-ALL-GENL-PREDICATES");
    //declareMacro(myName, "do_all_genl_predicates_depth", "DO-ALL-GENL-PREDICATES-DEPTH");
    //declareMacro(myName, "do_all_genl_predicates_breadth", "DO-ALL-GENL-PREDICATES-BREADTH");
    //declareMacro(myName, "do_all_genl_predicates_and_inverses", "DO-ALL-GENL-PREDICATES-AND-INVERSES");
    //declareMacro(myName, "do_all_spec_predicates", "DO-ALL-SPEC-PREDICATES");
    //declareMacro(myName, "do_all_spec_predicates_depth", "DO-ALL-SPEC-PREDICATES-DEPTH");
    //declareMacro(myName, "do_all_spec_predicates_breadth", "DO-ALL-SPEC-PREDICATES-BREADTH");
    //declareMacro(myName, "do_all_spec_predicates_and_inverses", "DO-ALL-SPEC-PREDICATES-AND-INVERSES");
    //declareMacro(myName, "do_all_proper_genl_predicates", "DO-ALL-PROPER-GENL-PREDICATES");
    //declareMacro(myName, "do_all_proper_genl_inverses", "DO-ALL-PROPER-GENL-INVERSES");
    //declareMacro(myName, "do_true_genl_inverse_links", "DO-TRUE-GENL-INVERSE-LINKS");
    //declareMacro(myName, "do_relevant_genl_inverse_links", "DO-RELEVANT-GENL-INVERSE-LINKS");
    //declareMacro(myName, "do_true_spec_inverse_links", "DO-TRUE-SPEC-INVERSE-LINKS");
    //declareMacro(myName, "do_relevant_spec_inverse_links", "DO-RELEVANT-SPEC-INVERSE-LINKS");
    //declareMacro(myName, "do_all_genl_inverses", "DO-ALL-GENL-INVERSES");
    //declareMacro(myName, "do_all_genl_inverses_depth", "DO-ALL-GENL-INVERSES-DEPTH");
    //declareMacro(myName, "do_all_genl_inverses_breadth", "DO-ALL-GENL-INVERSES-BREADTH");
    //declareMacro(myName, "do_all_spec_inverses", "DO-ALL-SPEC-INVERSES");
    //declareMacro(myName, "do_all_spec_inverses_depth", "DO-ALL-SPEC-INVERSES-DEPTH");
    //declareMacro(myName, "do_all_spec_inverses_breadth", "DO-ALL-SPEC-INVERSES-BREADTH");
    //declareMacro(myName, "do_all_genl_preds_and_inverses_breadth", "DO-ALL-GENL-PREDS-AND-INVERSES-BREADTH");
    //declareMacro(myName, "do_all_genl_preds_and_inverses_depth", "DO-ALL-GENL-PREDS-AND-INVERSES-DEPTH");
    //declareMacro(myName, "do_all_preds_and_inverses", "DO-ALL-PREDS-AND-INVERSES");
    //declareMacro(myName, "do_true_genl_mt_links", "DO-TRUE-GENL-MT-LINKS");
    //declareMacro(myName, "do_relevant_genl_mt_links", "DO-RELEVANT-GENL-MT-LINKS");
    //declareMacro(myName, "do_true_spec_mt_links", "DO-TRUE-SPEC-MT-LINKS");
    //declareMacro(myName, "do_relevant_spec_mt_links", "DO-RELEVANT-SPEC-MT-LINKS");
    //declareMacro(myName, "do_all_genl_mts", "DO-ALL-GENL-MTS");
    //declareMacro(myName, "do_all_genl_mts_depth", "DO-ALL-GENL-MTS-DEPTH");
    //declareMacro(myName, "do_all_genl_mts_breadth", "DO-ALL-GENL-MTS-BREADTH");
    //declareMacro(myName, "do_all_spec_mts", "DO-ALL-SPEC-MTS");
    //declareMacro(myName, "do_all_spec_mts_depth", "DO-ALL-SPEC-MTS-DEPTH");
    //declareMacro(myName, "do_all_spec_mts_breadth", "DO-ALL-SPEC-MTS-BREADTH");
    return NIL;
  }
