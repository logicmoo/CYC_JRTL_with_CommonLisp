...
public  final class sbhl_module_declarations extends SubLTranslatedFile {
  ...
  public static final SubLObject init_sbhl_module_declarations_file() {
    $sbhl_modules_initializedP$ = deflexical("*SBHL-MODULES-INITIALIZED?*", ((NIL != Symbols.boundp($sym54$_SBHL_MODULES_INITIALIZED__)) ? ((SubLObject) $sbhl_modules_initializedP$.getGlobalValue()) : NIL));
    return NIL;
  }
