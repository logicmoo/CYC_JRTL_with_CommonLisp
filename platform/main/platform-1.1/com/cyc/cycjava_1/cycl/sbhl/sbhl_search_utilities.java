...
public  final class sbhl_search_utilities extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_sbhl_search_utilities_file() {
    ...
    declareFunction("sbhl_push_onto_result_if", "SBHL-PUSH-ONTO-RESULT-IF", 1, 0, false); new $sbhl_push_onto_result_if$UnaryFunction();
    ...
    declareFunction("sbhl_check_cutoff", "SBHL-CHECK-CUTOFF", 1, 0, false); new $sbhl_check_cutoff$UnaryFunction();
    ...
    declareFunction("sbhl_consider_any_node", "SBHL-CONSIDER-ANY-NODE", 1, 0, false); new $sbhl_consider_any_node$UnaryFunction();
    ...
    declareFunction("sbhl_node_locally_disjoint_with_self_p", "SBHL-NODE-LOCALLY-DISJOINT-WITH-SELF-P", 1, 0, false); new $sbhl_node_locally_disjoint_with_self_p$UnaryFunction();
    ...
    declareFunction("sbhl_step_gather_disjoins", "SBHL-STEP-GATHER-DISJOINS", 1, 0, false); new $sbhl_step_gather_disjoins$UnaryFunction();
