...
import com.cyc.cycjava_1.cycl.unicode_subsets;
...
public  final class unicode_strings extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_unicode_strings_file() {
    declareFunction(myName, "unicode_char_print_function_trampoline", "UNICODE-CHAR-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction(myName, "unicode_char_p", "UNICODE-CHAR-P", 1, 0, false); new $unicode_char_p$UnaryFunction();
    declareFunction(myName, "unicode_char_uchar", "UNICODE-CHAR-UCHAR", 1, 0, false);
    declareFunction(myName, "_csetf_unicode_char_uchar", "_CSETF-UNICODE-CHAR-UCHAR", 2, 0, false);
    declareFunction(myName, "make_unicode_char", "MAKE-UNICODE-CHAR", 0, 1, false);
    declareFunction(myName, "unicode_char_create", "UNICODE-CHAR-CREATE", 1, 0, false);
    declareFunction(myName, "print_unicode_char", "PRINT-UNICODE-CHAR", 3, 0, false);
    declareFunction(myName, "unicode_char_get_char", "UNICODE-CHAR-GET-CHAR", 1, 0, false);
    declareFunction(myName, "unicode_char_set_char", "UNICODE-CHAR-SET-CHAR", 2, 0, false);
    declareFunction(myName, "unicode_string_print_function_trampoline", "UNICODE-STRING-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction(myName, "unicode_string_p", "UNICODE-STRING-P", 1, 0, false); new $unicode_string_p$UnaryFunction();
    declareFunction(myName, "unicode_string_vect", "UNICODE-STRING-VECT", 1, 0, false);
    declareFunction(myName, "_csetf_unicode_string_vect", "_CSETF-UNICODE-STRING-VECT", 2, 0, false);
    declareFunction(myName, "make_unicode_string", "MAKE-UNICODE-STRING", 0, 1, false);
    declareFunction(myName, "unicode_string_create", "UNICODE-STRING-CREATE", 1, 0, false);
    declareFunction(myName, "print_unicode_string", "PRINT-UNICODE-STRING", 3, 0, false);
    declareFunction(myName, "unicode_string_get_vector", "UNICODE-STRING-GET-VECTOR", 1, 0, false);
    declareFunction(myName, "unicode_string_set_vector", "UNICODE-STRING-SET-VECTOR", 2, 0, false);
    declareFunction(myName, "unicode_vector_string_p", "UNICODE-VECTOR-STRING-P", 1, 0, false);
    declareFunction(myName, "utf8_vector_string_p", "UTF8-VECTOR-STRING-P", 1, 0, false);
    declareFunction(myName, "ascii_string_p", "ASCII-STRING-P", 1, 0, false);
    declareFunction(myName, "non_ascii_string_p", "NON-ASCII-STRING-P", 1, 0, false);
    declareFunction(myName, "ascii_char_p", "ASCII-CHAR-P", 1, 0, false);
    declareFunction(myName, "non_ascii_char_p", "NON-ASCII-CHAR-P", 1, 0, false);
    declareFunction(myName, "ascii_char_p_int", "ASCII-CHAR-P-INT", 1, 0, false);
    declareFunction(myName, "display_vector_is_ascii_p", "DISPLAY-VECTOR-IS-ASCII-P", 1, 0, false);
    declareFunction(myName, "display_vector_string_p", "DISPLAY-VECTOR-STRING-P", 1, 0, false);
    declareFunction(myName, "display_to_unicode_vector", "DISPLAY-TO-UNICODE-VECTOR", 1, 0, false);
    declareFunction(myName, "display_to_subl_string", "DISPLAY-TO-SUBL-STRING", 1, 2, false);
    declareFunction(myName, "unicode_vector_to_display", "UNICODE-VECTOR-TO-DISPLAY", 1, 0, false);
    declareFunction(myName, "element_vector", "ELEMENT-VECTOR", 2, 0, false);
    declareFunction(myName, "unicode_vector_to_utf8_vector", "UNICODE-VECTOR-TO-UTF8-VECTOR", 1, 2, false);
    declareFunction(myName, "utf8_vector_to_unicode_vector", "UTF8-VECTOR-TO-UNICODE-VECTOR", 1, 0, false);
    declareFunction(myName, "unicode_char_code", "UNICODE-CHAR-CODE", 1, 0, false);
    declareFunction(myName, "unicode_code_char", "UNICODE-CODE-CHAR", 1, 0, false);
    declareFunction(myName, "unicode_character_p", "UNICODE-CHARACTER-P", 1, 0, false);
    declareFunction(myName, "number_utf8_bytes", "NUMBER-UTF8-BYTES", 1, 0, false);
    declareFunction(myName, "to_utf8_vector", "TO-UTF8-VECTOR", 1, 0, false);
    declareFunction(myName, "print_utf_hex_list", "PRINT-UTF-HEX-LIST", 1, 0, false);
    declareFunction(myName, "to_utc8_vector_internal", "TO-UTC8-VECTOR-INTERNAL", 3, 0, false);
    declareFunction(myName, "length_utf8_vector_codepoint", "LENGTH-UTF8-VECTOR-CODEPOINT", 2, 0, false);
    declareFunction(myName, "length_utf8_from_first_byte", "LENGTH-UTF8-FROM-FIRST-BYTE", 1, 0, false);
    declareFunction(myName, "utf8_vector_is_ascii_string_p", "UTF8-VECTOR-IS-ASCII-STRING-P", 1, 2, false);
    declareFunction(myName, "utf8_char_is_ascii_p", "UTF8-CHAR-IS-ASCII-P", 2, 0, false);
    declareFunction(myName, "unicode_vector_is_ascii_string_p", "UNICODE-VECTOR-IS-ASCII-STRING-P", 1, 2, false);
    declareFunction(myName, "unicode_char_is_ascii_char_p", "UNICODE-CHAR-IS-ASCII-CHAR-P", 1, 0, false);
    declareFunction(myName, "utf8_char_p", "UTF8-CHAR-P", 2, 0, false);
    declareFunction(myName, "get_unicode_char_at_or_after_offset", "GET-UNICODE-CHAR-AT-OR-AFTER-OFFSET", 2, 0, false);
    declareFunction(myName, "get_unicode_char_at_or_before_offset", "GET-UNICODE-CHAR-AT-OR-BEFORE-OFFSET", 2, 0, false);
    declareFunction(myName, "get_unicode_char_at_offset", "GET-UNICODE-CHAR-AT-OFFSET", 2, 0, false);
    declareFunction(myName, "string_from_char_list", "STRING-FROM-CHAR-LIST", 1, 1, false);
    declareFunction(myName, "unicode_to_html_escaped", "UNICODE-TO-HTML-ESCAPED", 1, 0, false);
    declareFunction(myName, "unicode_string_to_utf8", "UNICODE-STRING-TO-UTF8", 1, 0, false);
    declareFunction(myName, "unicode_string_to_subl_string", "UNICODE-STRING-TO-SUBL-STRING", 1, 0, false);
    declareFunction(myName, "unicode_display_to_utf8", "UNICODE-DISPLAY-TO-UTF8", 1, 0, false);
    declareFunction(myName, "unicode_display_to_html", "UNICODE-DISPLAY-TO-HTML", 1, 0, false);
    declareFunction(myName, "html_escaped_to_utf8_vector", "HTML-ESCAPED-TO-UTF8-VECTOR", 1, 0, false);
    declareFunction(myName, "utf8_string_to_unicode_vector", "UTF8-STRING-TO-UNICODE-VECTOR", 1, 0, false);
    declareFunction(myName, "html_escaped_to_unicode_vector", "HTML-ESCAPED-TO-UNICODE-VECTOR", 1, 0, false);
    declareFunction(myName, "utf8_vector_to_utf8_string", "UTF8-VECTOR-TO-UTF8-STRING", 1, 0, false);
    declareFunction(myName, "utf8_string_to_utf8_vector", "UTF8-STRING-TO-UTF8-VECTOR", 1, 0, false);
    declareFunction(myName, "utf8_string_to_subl_string", "UTF8-STRING-TO-SUBL-STRING", 1, 0, false);
    declareFunction(myName, "utf8_string_to_display", "UTF8-STRING-TO-DISPLAY", 1, 0, false);
    declareFunction(myName, "html_escaped_to_utf8_string", "HTML-ESCAPED-TO-UTF8-STRING", 1, 0, false);
    declareFunction(myName, "display_to_utf8_string", "DISPLAY-TO-UTF8-STRING", 1, 0, false);
    declareFunction(myName, "html_escaped_to_display", "HTML-ESCAPED-TO-DISPLAY", 1, 0, false);
    declareFunction(myName, "map_character_entity_to_decimal_value", "MAP-CHARACTER-ENTITY-TO-DECIMAL-VALUE", 1, 0, false);
    declareFunction(myName, "map_decimal_value_to_character_entity", "MAP-DECIMAL-VALUE-TO-CHARACTER-ENTITY", 1, 0, false);
    declareFunction(myName, "unicode_string_concatenate", "UNICODE-STRING-CONCATENATE", 2, 0, false);
    declareFunction(myName, "cfasl_output_object_unicode_char_method", "CFASL-OUTPUT-OBJECT-UNICODE-CHAR-METHOD", 2, 0, false);
    declareFunction(myName, "cfasl_output_unicode_char", "CFASL-OUTPUT-UNICODE-CHAR", 2, 0, false);
    declareFunction(myName, "cfasl_input_unicode_char", "CFASL-INPUT-UNICODE-CHAR", 1, 0, false);
    declareFunction(myName, "cfasl_output_object_unicode_string_method", "CFASL-OUTPUT-OBJECT-UNICODE-STRING-METHOD", 2, 0, false);
    declareFunction(myName, "cfasl_output_unicode_string", "CFASL-OUTPUT-UNICODE-STRING", 2, 0, false);
    declareFunction(myName, "cfasl_input_unicode_string", "CFASL-INPUT-UNICODE-STRING", 1, 0, false);
    return NIL;
  }
