...
public  final class morphology extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_morphology_file() {
    //declareFunction(myName, "get_vowel_positions", "GET-VOWEL-POSITIONS", 1, 0, false);
    //declareFunction(myName, "estimated_syllable_count", "ESTIMATED-SYLLABLE-COUNT", 1, 0, false);
    //declareFunction(myName, "monosyllabicP", "MONOSYLLABIC?", 1, 0, false);
    //declareFunction(myName, "polysyllabicP", "POLYSYLLABIC?", 1, 1, false);
    //declareFunction(myName, "vowel_charP", "VOWEL-CHAR?", 1, 1, false);
    //declareFunction(myName, "consonant_charP", "CONSONANT-CHAR?", 1, 0, false);
    //declareFunction(myName, "get_consonant_positions", "GET-CONSONANT-POSITIONS", 1, 0, false);
    //declareFunction(myName, "ends_with_vowelP", "ENDS-WITH-VOWEL?", 1, 0, false);
    //declareFunction(myName, "starts_with_vowelP", "STARTS-WITH-VOWEL?", 1, 0, false);
    //declareFunction(myName, "ends_with_consonantP", "ENDS-WITH-CONSONANT?", 1, 0, false);
    //declareFunction(myName, "starts_with_consonantP", "STARTS-WITH-CONSONANT?", 1, 0, false);
    //declareFunction(myName, "single_c_codaP", "SINGLE-C-CODA?", 1, 0, false);
    //declareFunction(myName, "ends_with_doublerP", "ENDS-WITH-DOUBLER?", 1, 0, false);
    //declareFunction(myName, "starts_with_unstressed_pfxP", "STARTS-WITH-UNSTRESSED-PFX?", 1, 0, false);
    //declareFunction(myName, "ends_in_cvcP", "ENDS-IN-CVC?", 1, 0, false);
    //declareFunction(myName, "ends_in_quvcP", "ENDS-IN-QUVC?", 1, 0, false);
    //declareFunction(myName, "make_geminate", "MAKE-GEMINATE", 2, 0, false);
    //declareFunction(myName, "geminate_last", "GEMINATE-LAST", 1, 0, false);
    //declareFunction(myName, "correct_capitalization", "CORRECT-CAPITALIZATION", 2, 0, false);
    //declareFunction(myName, "regular_string_function", "REGULAR-STRING-FUNCTION", 1, 0, false);
    //declareFunction(myName, "suffix_rules_for_pred", "SUFFIX-RULES-FOR-PRED", 1, 0, false);
    //declareFunction(myName, "generate_regular_string_from_form", "GENERATE-REGULAR-STRING-FROM-FORM", 3, 1, false);
    //declareFunction(myName, "generate_regular_strings_from_form", "GENERATE-REGULAR-STRINGS-FROM-FORM", 3, 3, false);
    //declareFunction(myName, "generate_regular_strings_from_form_int", "GENERATE-REGULAR-STRINGS-FROM-FORM-INT", 6, 0, false);
    //declareFunction(myName, "add_english_suffix", "ADD-ENGLISH-SUFFIX", 2, 0, false);
    //declareFunction(myName, "aes_do_orthographic_changes", "AES-DO-ORTHOGRAPHIC-CHANGES", 2, 0, false);
    //declareFunction(myName, "aes_do_orthographic_change_fns", "AES-DO-ORTHOGRAPHIC-CHANGE-FNS", 0, 0, false);
    //declareFunction(myName, "aes_do_orthographic_change", "AES-DO-ORTHOGRAPHIC-CHANGE", 4, 0, false);
    //declareFunction(myName, "ends_with_sibilantP", "ENDS-WITH-SIBILANT?", 1, 0, false);
    //declareFunction(myName, "aes_add_e_before_s", "AES-ADD-E-BEFORE-S", 2, 0, false); new $aes_add_e_before_s$BinaryFunction();
    //declareFunction(myName, "aes_change_y_to_i", "AES-CHANGE-Y-TO-I", 2, 0, false); new $aes_change_y_to_i$BinaryFunction();
    //declareFunction(myName, "aes_ble_to_bil_before_ity", "AES-BLE-TO-BIL-BEFORE-ITY", 2, 0, false); new $aes_ble_to_bil_before_ity$BinaryFunction();
    //declareFunction(myName, "aes_change_aic_to_ac", "AES-CHANGE-AIC-TO-AC", 2, 0, false); new $aes_change_aic_to_ac$BinaryFunction();
    //declareFunction(myName, "aes_strip_final_e", "AES-STRIP-FINAL-E", 2, 0, false); new $aes_strip_final_e$BinaryFunction();
    //declareFunction(myName, "aes_strip_final_vowels_before_ic", "AES-STRIP-FINAL-VOWELS-BEFORE-IC", 2, 0, false); new $aes_strip_final_vowels_before_ic$BinaryFunction();
    //declareFunction(myName, "aes_change_ie_to_y", "AES-CHANGE-IE-TO-Y", 2, 0, false); new $aes_change_ie_to_y$BinaryFunction();
    //declareFunction(myName, "aes_change_ism_to_ist", "AES-CHANGE-ISM-TO-IST", 2, 0, false); new $aes_change_ism_to_ist$BinaryFunction();
    //declareFunction(myName, "aes_change_ceive_to_cept", "AES-CHANGE-CEIVE-TO-CEPT", 2, 0, false); new $aes_change_ceive_to_cept$BinaryFunction();
    //declareFunction(myName, "aes_remove_able_le_before_ly", "AES-REMOVE-ABLE-LE-BEFORE-LY", 2, 0, false); new $aes_remove_able_le_before_ly$BinaryFunction();
    //declareFunction(myName, "aes_geminate_last", "AES-GEMINATE-LAST", 2, 0, false); new $aes_geminate_last$BinaryFunction();
    //declareFunction(myName, "aes_able_to_ate", "AES-ABLE-TO-ATE", 2, 0, false); new $aes_able_to_ate$BinaryFunction();
    //declareFunction(myName, "try_regular_adj_morphologyP", "TRY-REGULAR-ADJ-MORPHOLOGY?", 1, 0, false);
    //declareFunction(myName, "most_form", "MOST-FORM", 1, 0, false);
    //declareFunction(myName, "more_form", "MORE-FORM", 1, 0, false);
    //declareFunction(myName, "most_form_p", "MOST-FORM-P", 1, 0, false);
    //declareFunction(myName, "more_form_p", "MORE-FORM-P", 1, 0, false);
    //declareFunction(myName, "more_or_most_form_p", "MORE-OR-MOST-FORM-P", 2, 0, false);
    //declareFunction(myName, "comparative_reg", "COMPARATIVE-REG", 1, 0, false);
    //declareFunction(myName, "comparative_adverb_reg", "COMPARATIVE-ADVERB-REG", 1, 0, false);
    //declareFunction(myName, "superlative_reg", "SUPERLATIVE-REG", 1, 0, false);
    //declareFunction(myName, "superlative_adverb_reg", "SUPERLATIVE-ADVERB-REG", 1, 0, false);
    //declareFunction(myName, "past_tense_reg", "PAST-TENSE-REG", 1, 0, false);
    //declareFunction(myName, "gerund_reg", "GERUND-REG", 1, 0, false);
    //declareFunction(myName, "third_sg_reg", "THIRD-SG-REG", 1, 0, false);
    //declareFunction(myName, "plural_reg", "PLURAL-REG", 1, 0, false);
    //declareFunction(myName, "pn_plural_reg", "PN-PLURAL-REG", 1, 0, false);
    //declareFunction(myName, "infinitive_to_third_sing", "INFINITIVE-TO-THIRD-SING", 1, 0, false);
    //declareFunction(myName, "infinitive_to_pres_participle", "INFINITIVE-TO-PRES-PARTICIPLE", 1, 0, false);
    //declareFunction(myName, "possessivize_string", "POSSESSIVIZE-STRING", 1, 1, false);
    //declareFunction(myName, "english_lexical_possessive_version_of_string", "ENGLISH-LEXICAL-POSSESSIVE-VERSION-OF-STRING", 1, 0, false);
    //declareFunction(myName, "english_possessive_suffix_for_string", "ENGLISH-POSSESSIVE-SUFFIX-FOR-STRING", 1, 1, false);
    //declareFunction(myName, "locativize_string", "LOCATIVIZE-STRING", 2, 0, false);
    //declareFunction(myName, "not_locativizable_english_stringP", "NOT-LOCATIVIZABLE-ENGLISH-STRING?", 1, 0, false);
    //declareFunction(myName, "english_locative_preposition_for_denot", "ENGLISH-LOCATIVE-PREPOSITION-FOR-DENOT", 1, 0, false);
    //declareFunction(myName, "pluralize_string", "PLURALIZE-STRING", 1, 1, false);
    //declareFunction(myName, "singularize_string", "SINGULARIZE-STRING", 1, 1, false);
    //declareFunction(myName, "has_word_for_string_and_pos", "HAS-WORD-FOR-STRING-AND-POS", 2, 0, false);
    //declareFunction(myName, "has_word_for_string_and_pos_list", "HAS-WORD-FOR-STRING-AND-POS-LIST", 2, 0, false);
    //declareFunction(myName, "is_word", "IS-WORD", 1, 0, false);
    //declareFunction(myName, "is_noun", "IS-NOUN", 1, 0, false);
    //declareFunction(myName, "is_verb", "IS-VERB", 1, 0, false);
    //declareFunction(myName, "is_noun_or_verb", "IS-NOUN-OR-VERB", 1, 0, false);
    //declareFunction(myName, "clear_find_stem_memoized", "CLEAR-FIND-STEM-MEMOIZED", 0, 0, false);
    //declareFunction(myName, "remove_find_stem_memoized", "REMOVE-FIND-STEM-MEMOIZED", 1, 1, false);
    //declareFunction(myName, "find_stem_memoized_internal", "FIND-STEM-MEMOIZED-INTERNAL", 2, 0, false);
    //declareFunction(myName, "find_stem_memoized", "FIND-STEM-MEMOIZED", 1, 1, false);
    //declareFunction(myName, "find_stem", "FIND-STEM", 1, 1, false);
    //declareFunction(myName, "inflected_verb_to_infinitive", "INFLECTED-VERB-TO-INFINITIVE", 1, 0, false);
    //declareFunction(myName, "agentive_to_infinitive", "AGENTIVE-TO-INFINITIVE", 1, 0, false);
    //declareFunction(myName, "third_sg_verb_to_infinitive", "THIRD-SG-VERB-TO-INFINITIVE", 1, 0, false);
    //declareFunction(myName, "plural_noun_to_sg", "PLURAL-NOUN-TO-SG", 1, 1, false);
    //declareFunction(myName, "singular_reg", "SINGULAR-REG", 1, 0, false);
    //declareFunction(myName, "plural_nounP", "PLURAL-NOUN?", 1, 0, false);
    //declareFunction(myName, "infinitive_verbP", "INFINITIVE-VERB?", 1, 0, false);
    //declareFunction(myName, "progressive_stringP", "PROGRESSIVE-STRING?", 1, 0, false);
    //declareFunction(myName, "perfect_stringP", "PERFECT-STRING?", 1, 0, false);
    //declareFunction(myName, "f_3sg_stringP", "3SG-STRING?", 1, 0, false);
    //declareFunction(myName, "numberspp", "NUMBERSPP", 1, 0, false);
    //declareFunction(myName, "comparative_degreeP", "COMPARATIVE-DEGREE?", 1, 0, false);
    //declareFunction(myName, "superlative_degreeP", "SUPERLATIVE-DEGREE?", 1, 0, false);
    //declareFunction(myName, "pos_of_unknown_word", "POS-OF-UNKNOWN-WORD", 1, 0, false);
    //declareFunction(myName, "proper_nounp", "PROPER-NOUNP", 1, 0, false);
    //declareFunction(myName, "verbp", "VERBP", 1, 0, false);
    //declareFunction(myName, "nounp", "NOUNP", 1, 0, false);
    //declareFunction(myName, "adjectivep", "ADJECTIVEP", 1, 0, false);
    //declareFunction(myName, "adverbp", "ADVERBP", 1, 0, false);
    //declareFunction(myName, "pos_keyword_p", "POS-KEYWORD-P", 1, 0, false);
    //declareFunction(myName, "root_predicate", "ROOT-PREDICATE", 1, 0, false);
    //declareFunction(myName, "get_root_of_head", "GET-ROOT-OF-HEAD", 1, 1, false);
    //declareFunction(myName, "get_root", "GET-ROOT", 1, 1, false);
    //declareFunction(myName, "expand_contracted_root", "EXPAND-CONTRACTED-ROOT", 1, 0, false);
    return NIL;
  }
