...
public  final class unification extends SubLTranslatedFile {
  ...
  public static final String myName = "com.cyc.cycjava_1.cycl.unification";
...
in the inverted variable space? */
  ...
  public static final SubLObject declare_unification_file() {
    ...
    declareFunction("base_variable_p", "BASE-VARIABLE-P", 1, 0, false); new $base_variable_p$UnaryFunction();
    ...
    declareFunction("variable_non_base_version", "VARIABLE-NON-BASE-VERSION", 1, 0, false); new $variable_non_base_version$UnaryFunction();
