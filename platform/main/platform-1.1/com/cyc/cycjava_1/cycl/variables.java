...
public  final class variables extends SubLTranslatedFile {
  ...
  public static final String myName = "com.cyc.cycjava_1.cycl.variables";
...
of the prefix in @xref print-variable */
  ...
  public static final SubLObject init_variables_file() {
    ...
    $variable_array$ = deflexical("*VARIABLE-ARRAY*", maybeDefault( $sym20$_VARIABLE_ARRAY_, $variable_array$, NIL));
