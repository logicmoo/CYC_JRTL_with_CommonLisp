...
public  final class sdbc extends SubLTranslatedFile {
  ...
  public static final String myName = "com.cyc.cycjava_1.cycl.sdbc";
  ...
  public static final SubLObject declare_sdbc_file() {
    ...
    //declareFunction("sql_connection_p", "SQL-CONNECTION-P", 1, 0, false); new $sql_connection_p$UnaryFunction();
    ...
    //declareFunction("sql_ticket_p", "SQL-TICKET-P", 1, 0, false); new $sql_ticket_p$UnaryFunction();
    ...
    //declareFunction("sdbc_error_p", "SDBC-ERROR-P", 1, 0, false); new $sdbc_error_p$UnaryFunction();
    ...
    //declareFunction("sql_result_set_p", "SQL-RESULT-SET-P", 1, 0, false); new $sql_result_set_p$UnaryFunction();
    ...
    //declareFunction("sql_statement_p", "SQL-STATEMENT-P", 1, 0, false); new $sql_statement_p$UnaryFunction();
