...
public  final class at_utilities extends SubLTranslatedFile {
  ...
  public static final SubLObject init_at_utilities_file() {
    $generic_arg_store$ = deflexical("*GENERIC-ARG-STORE*", maybeDefault( $sym5$_GENERIC_ARG_STORE_, $generic_arg_store$, NIL));
    $some_inter_arg_isa_assertion_somewhere_cache$ = deflexical("*SOME-INTER-ARG-ISA-ASSERTION-SOMEWHERE-CACHE*", maybeDefault( $sym58$_SOME_INTER_ARG_ISA_ASSERTION_SOMEWHERE_CACHE_, $some_inter_arg_isa_assertion_somewhere_cache$, NIL));
    $some_inter_arg_format_assertion_somewhere_cache$ = deflexical("*SOME-INTER-ARG-FORMAT-ASSERTION-SOMEWHERE-CACHE*", maybeDefault( $sym77$_SOME_INTER_ARG_FORMAT_ASSERTION_SOMEWHERE_CACHE_, $some_inter_arg_format_assertion_somewhere_cache$, NIL));
