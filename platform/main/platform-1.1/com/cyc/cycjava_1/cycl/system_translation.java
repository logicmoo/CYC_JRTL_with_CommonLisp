...
import com.cyc.cycjava_1.cycl.c_backend;
import com.cyc.cycjava_1.cycl.constant_handles;
import com.cyc.cycjava_1.cycl.control_vars;
import com.cyc.cycjava_1.cycl.file_translation;
...
import com.cyc.cycjava_1.cycl.secure_translation;
import com.cyc.cycjava_1.cycl.string_utilities;
import com.cyc.cycjava_1.cycl.subl_macro_promotions;
import com.cyc.cycjava_1.cycl.subl_macros;
import com.cyc.cycjava_1.cycl.subl_promotions;
import com.cyc.cycjava_1.cycl.utilities_macros;
import com.cyc.cycjava_1.cycl.xref_database;
...
public  final class system_translation extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_system_translation_file() {
    //declareFunction(myName, "translator_output_enabled_p", "TRANSLATOR-OUTPUT-ENABLED-P", 0, 0, false);
    //declareFunction(myName, "translator_backend_p", "TRANSLATOR-BACKEND-P", 1, 0, false);
    declareFunction(myName, "current_system_translation", "CURRENT-SYSTEM-TRANSLATION", 0, 0, false);
    //declareFunction(myName, "current_system_translation_secureP", "CURRENT-SYSTEM-TRANSLATION-SECURE?", 0, 0, false);
    //declareFunction(myName, "current_system_translation_security_level", "CURRENT-SYSTEM-TRANSLATION-SECURITY-LEVEL", 0, 0, false);
    declareFunction(myName, "system_translation_print_function_trampoline", "SYSTEM-TRANSLATION-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    //declareFunction(myName, "system_translation_p", "SYSTEM-TRANSLATION-P", 1, 0, false); new $system_translation_p$UnaryFunction();
    //declareFunction(myName, "sys_tr_system", "SYS-TR-SYSTEM", 1, 0, false);
    //declareFunction(myName, "sys_tr_backend", "SYS-TR-BACKEND", 1, 0, false);
    //declareFunction(myName, "sys_tr_features", "SYS-TR-FEATURES", 1, 0, false);
    //declareFunction(myName, "sys_tr_input_directory", "SYS-TR-INPUT-DIRECTORY", 1, 0, false);
    //declareFunction(myName, "sys_tr_output_directory", "SYS-TR-OUTPUT-DIRECTORY", 1, 0, false);
    //declareFunction(myName, "sys_tr_manifest_file", "SYS-TR-MANIFEST-FILE", 1, 0, false);
    //declareFunction(myName, "sys_tr_modules", "SYS-TR-MODULES", 1, 0, false);
    //declareFunction(myName, "sys_tr_module_filename_table", "SYS-TR-MODULE-FILENAME-TABLE", 1, 0, false);
    //declareFunction(myName, "sys_tr_module_features_table", "SYS-TR-MODULE-FEATURES-TABLE", 1, 0, false);
    //declareFunction(myName, "sys_tr_module_initialization_table", "SYS-TR-MODULE-INITIALIZATION-TABLE", 1, 0, false);
    //declareFunction(myName, "sys_tr_xref_database", "SYS-TR-XREF-DATABASE", 1, 0, false);
    //declareFunction(myName, "sys_tr_secure_id_database", "SYS-TR-SECURE-ID-DATABASE", 1, 0, false);
    //declareFunction(myName, "sys_tr_last_translation_time", "SYS-TR-LAST-TRANSLATION-TIME", 1, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_system", "_CSETF-SYS-TR-SYSTEM", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_backend", "_CSETF-SYS-TR-BACKEND", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_features", "_CSETF-SYS-TR-FEATURES", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_input_directory", "_CSETF-SYS-TR-INPUT-DIRECTORY", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_output_directory", "_CSETF-SYS-TR-OUTPUT-DIRECTORY", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_manifest_file", "_CSETF-SYS-TR-MANIFEST-FILE", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_modules", "_CSETF-SYS-TR-MODULES", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_module_filename_table", "_CSETF-SYS-TR-MODULE-FILENAME-TABLE", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_module_features_table", "_CSETF-SYS-TR-MODULE-FEATURES-TABLE", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_module_initialization_table", "_CSETF-SYS-TR-MODULE-INITIALIZATION-TABLE", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_xref_database", "_CSETF-SYS-TR-XREF-DATABASE", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_secure_id_database", "_CSETF-SYS-TR-SECURE-ID-DATABASE", 2, 0, false);
    //declareFunction(myName, "_csetf_sys_tr_last_translation_time", "_CSETF-SYS-TR-LAST-TRANSLATION-TIME", 2, 0, false);
    //declareFunction(myName, "make_system_translation", "MAKE-SYSTEM-TRANSLATION", 0, 1, false);
    //declareFunction(myName, "print_system_translation", "PRINT-SYSTEM-TRANSLATION", 3, 0, false);
    //declareFunction(myName, "new_system_translation", "NEW-SYSTEM-TRANSLATION", 7, 0, false);
    //declareFunction(myName, "destroy_system_translation", "DESTROY-SYSTEM-TRANSLATION", 1, 0, false);
    //declareFunction(myName, "sys_tran_system", "SYS-TRAN-SYSTEM", 1, 0, false);
    //declareFunction(myName, "sys_tran_backend", "SYS-TRAN-BACKEND", 1, 0, false);
    //declareFunction(myName, "sys_tran_features", "SYS-TRAN-FEATURES", 1, 0, false);
    //declareFunction(myName, "sys_tran_input_directory", "SYS-TRAN-INPUT-DIRECTORY", 1, 0, false);
    //declareFunction(myName, "sys_tran_output_directory", "SYS-TRAN-OUTPUT-DIRECTORY", 1, 0, false);
    //declareFunction(myName, "sys_tran_manifest_file", "SYS-TRAN-MANIFEST-FILE", 1, 0, false);
    //declareFunction(myName, "sys_tran_xref_database", "SYS-TRAN-XREF-DATABASE", 1, 0, false);
    //declareFunction(myName, "sys_tran_secure_id_database", "SYS-TRAN-SECURE-ID-DATABASE", 1, 0, false);
    //declareFunction(myName, "sys_tran_modules", "SYS-TRAN-MODULES", 1, 0, false);
    //declareFunction(myName, "sys_tran_set_modules", "SYS-TRAN-SET-MODULES", 2, 0, false);
    //declareFunction(myName, "sys_tran_set_last_translation_time", "SYS-TRAN-SET-LAST-TRANSLATION-TIME", 1, 1, false);
    //declareFunction(myName, "sys_tran_security_level", "SYS-TRAN-SECURITY-LEVEL", 1, 0, false);
    //declareFunction(myName, "sys_tran_secureP", "SYS-TRAN-SECURE?", 1, 0, false);
    //declareFunction(myName, "sys_tran_includes_moduleP", "SYS-TRAN-INCLUDES-MODULE?", 2, 0, false);
    //declareFunction(myName, "sys_tran_module_input_filename", "SYS-TRAN-MODULE-INPUT-FILENAME", 2, 0, false);
    //declareFunction(myName, "sys_tran_module_output_filename", "SYS-TRAN-MODULE-OUTPUT-FILENAME", 2, 0, false);
    //declareFunction(myName, "sys_tran_relative_input_filename", "SYS-TRAN-RELATIVE-INPUT-FILENAME", 2, 0, false);
    //declareFunction(myName, "sys_tran_module_features", "SYS-TRAN-MODULE-FEATURES", 2, 0, false);
    //declareFunction(myName, "sys_tran_module_declare_function", "SYS-TRAN-MODULE-DECLARE-FUNCTION", 2, 0, false);
    //declareFunction(myName, "sys_tran_module_init_function", "SYS-TRAN-MODULE-INIT-FUNCTION", 2, 0, false);
    //declareFunction(myName, "sys_tran_module_setup_function", "SYS-TRAN-MODULE-SETUP-FUNCTION", 2, 0, false);
    //declareFunction(myName, "sys_tran_all_init_functions", "SYS-TRAN-ALL-INIT-FUNCTIONS", 1, 0, false);
    //declareFunction(myName, "sys_tran_system_default_path", "SYS-TRAN-SYSTEM-DEFAULT-PATH", 1, 0, false);
    //declareFunction(myName, "sys_tran_secure_module_id", "SYS-TRAN-SECURE-MODULE-ID", 2, 0, false);
    //declareFunction(myName, "sys_tran_secure_method_id", "SYS-TRAN-SECURE-METHOD-ID", 2, 0, false);
    //declareFunction(myName, "sys_tran_secure_global_id", "SYS-TRAN-SECURE-GLOBAL-ID", 2, 0, false);
    //declareFunction(myName, "sys_tran_secure_symbol_name", "SYS-TRAN-SECURE-SYMBOL-NAME", 2, 0, false);
    //declareFunction(myName, "current_system_translation_secure_symbol_name", "CURRENT-SYSTEM-TRANSLATION-SECURE-SYMBOL-NAME", 1, 0, false);
    //declareFunction(myName, "sys_tran_note_module_filenames", "SYS-TRAN-NOTE-MODULE-FILENAMES", 4, 0, false);
    //declareFunction(myName, "sys_tran_note_module_features", "SYS-TRAN-NOTE-MODULE-FEATURES", 3, 0, false);
    //declareFunction(myName, "sys_tran_initialize_last_translation_time", "SYS-TRAN-INITIALIZE-LAST-TRANSLATION-TIME", 1, 0, false);
    //declareFunction(myName, "translator_possibly_update_current_system_modules", "TRANSLATOR-POSSIBLY-UPDATE-CURRENT-SYSTEM-MODULES", 0, 0, false);
    //declareFunction(myName, "translator_possibly_translate_one_module", "TRANSLATOR-POSSIBLY-TRANSLATE-ONE-MODULE", 1, 0, false);
    //declareFunction(myName, "translator_possibly_output_system_level_files", "TRANSLATOR-POSSIBLY-OUTPUT-SYSTEM-LEVEL-FILES", 0, 0, false);
    //declareFunction(myName, "translator_possibly_output_secure_id_database_file", "TRANSLATOR-POSSIBLY-OUTPUT-SECURE-ID-DATABASE-FILE", 0, 0, false);
    //declareFunction(myName, "sys_tran_possibly_note_module_initialization_methods", "SYS-TRAN-POSSIBLY-NOTE-MODULE-INITIALIZATION-METHODS", 4, 0, false);
    //declareFunction(myName, "translate_one_system", "TRANSLATE-ONE-SYSTEM", 1, 0, false);
    //declareFunction(myName, "sys_tran_initialize_xref_database", "SYS-TRAN-INITIALIZE-XREF-DATABASE", 1, 0, false);
    //declareFunction(myName, "sys_tran_initialize_module_info", "SYS-TRAN-INITIALIZE-MODULE-INFO", 1, 0, false);
    //declareFunction(myName, "translator_compute_relevant_modules_from_manifest", "TRANSLATOR-COMPUTE-RELEVANT-MODULES-FROM-MANIFEST", 4, 0, false);
    //declareFunction(myName, "translator_compute_module_input_file", "TRANSLATOR-COMPUTE-MODULE-INPUT-FILE", 3, 0, false);
    //declareFunction(myName, "sys_tran_compute_module_output_file", "SYS-TRAN-COMPUTE-MODULE-OUTPUT-FILE", 3, 0, false);
    //declareFunction(myName, "translate_backend_compute_output_module_path", "TRANSLATE-BACKEND-COMPUTE-OUTPUT-MODULE-PATH", 3, 0, false);
    //declareFunction(myName, "translator_backend_output_file_extension", "TRANSLATOR-BACKEND-OUTPUT-FILE-EXTENSION", 1, 0, false);
    //declareFunction(myName, "sys_tran_backend_output_module_filename", "SYS-TRAN-BACKEND-OUTPUT-MODULE-FILENAME", 3, 0, false);
    //declareFunction(myName, "java_backend_output_module_filename", "JAVA-BACKEND-OUTPUT-MODULE-FILENAME", 1, 1, false);
    //declareFunction(myName, "translator_compute_full_filename", "TRANSLATOR-COMPUTE-FULL-FILENAME", 4, 0, false);
    //declareFunction(myName, "translator_module_feature_expression_match", "TRANSLATOR-MODULE-FEATURE-EXPRESSION-MATCH", 2, 0, false);
    //declareFunction(myName, "sys_tran_possibly_update_xref_module_features", "SYS-TRAN-POSSIBLY-UPDATE-XREF-MODULE-FEATURES", 1, 0, false);
    //declareFunction(myName, "sys_tran_trace_format", "SYS-TRAN-TRACE-FORMAT", 1, 3, false);
    //declareMacro(myName, "with_simple_restart_loop", "WITH-SIMPLE-RESTART-LOOP");
    //declareFunction(myName, "sys_tran_perform_initial_translation", "SYS-TRAN-PERFORM-INITIAL-TRANSLATION", 1, 0, false);
    //declareFunction(myName, "sys_tran_translate_modules", "SYS-TRAN-TRANSLATE-MODULES", 2, 0, false);
    //declareFunction(myName, "translate_one_module", "TRANSLATE-ONE-MODULE", 5, 0, false);
    //declareFunction(myName, "translate_one_system_module", "TRANSLATE-ONE-SYSTEM-MODULE", 2, 0, false);
    //declareFunction(myName, "translator_parse_manifest_file", "TRANSLATOR-PARSE-MANIFEST-FILE", 1, 0, false);
    //declareMacro(myName, "do_manifest_systems", "DO-MANIFEST-SYSTEMS");
    //declareFunction(myName, "manifest_system_name", "MANIFEST-SYSTEM-NAME", 1, 0, false);
    //declareFunction(myName, "manifest_system_lookup", "MANIFEST-SYSTEM-LOOKUP", 2, 0, false);
    //declareFunction(myName, "manifest_system_modules", "MANIFEST-SYSTEM-MODULES", 1, 0, false);
    //declareFunction(myName, "manifest_system_default_path", "MANIFEST-SYSTEM-DEFAULT-PATH", 1, 0, false);
    //declareFunction(myName, "manifest_module_name", "MANIFEST-MODULE-NAME", 1, 0, false);
    //declareFunction(myName, "manifest_module_relative_path", "MANIFEST-MODULE-RELATIVE-PATH", 1, 0, false);
    //declareFunction(myName, "manifest_module_features", "MANIFEST-MODULE-FEATURES", 1, 0, false);
    //declareFunction(myName, "manifest_module_path", "MANIFEST-MODULE-PATH", 2, 0, false);
    //declareFunction(myName, "manifest_module_features_allowedP", "MANIFEST-MODULE-FEATURES-ALLOWED?", 3, 0, false);
    //declareFunction(myName, "translator_regenerate_manifest_file", "TRANSLATOR-REGENERATE-MANIFEST-FILE", 1, 0, false);
    //declareFunction(myName, "translator_generate_manifest_file", "TRANSLATOR-GENERATE-MANIFEST-FILE", 1, 0, false);
    //declareFunction(myName, "translator_generate_manifest_to_stream", "TRANSLATOR-GENERATE-MANIFEST-TO-STREAM", 1, 0, false);
    //declareFunction(myName, "translator_generate_manifest_system_to_stream", "TRANSLATOR-GENERATE-MANIFEST-SYSTEM-TO-STREAM", 2, 0, false);
    //declareFunction(myName, "translator_system_module_specs", "TRANSLATOR-SYSTEM-MODULE-SPECS", 1, 0, false);
    //declareFunction(myName, "translator_system_directory", "TRANSLATOR-SYSTEM-DIRECTORY", 1, 0, false);
    //declareFunction(myName, "translator_system_package", "TRANSLATOR-SYSTEM-PACKAGE", 1, 0, false);
    //declareFunction(myName, "translator_system_required_systems", "TRANSLATOR-SYSTEM-REQUIRED-SYSTEMS", 1, 0, false);
    //declareFunction(myName, "translator_system_modules", "TRANSLATOR-SYSTEM-MODULES", 1, 0, false);
    //declareFunction(myName, "translator_system_module_directory", "TRANSLATOR-SYSTEM-MODULE-DIRECTORY", 2, 0, false);
    //declareFunction(myName, "translator_system_module_features", "TRANSLATOR-SYSTEM-MODULE-FEATURES", 2, 0, false);
    //declareFunction(myName, "untransformed_feature_symbol_p", "UNTRANSFORMED-FEATURE-SYMBOL-P", 1, 0, false);
    //declareFunction(myName, "transform_feature_symbol", "TRANSFORM-FEATURE-SYMBOL", 1, 0, false);
    //declareFunction(myName, "sys_tran_output_system_level_files", "SYS-TRAN-OUTPUT-SYSTEM-LEVEL-FILES", 1, 0, false);
    //declareFunction(myName, "sys_tran_possibly_output_secure_id_database_file", "SYS-TRAN-POSSIBLY-OUTPUT-SECURE-ID-DATABASE-FILE", 1, 0, false);
    //declareFunction(myName, "translator_system_directory_module_map", "TRANSLATOR-SYSTEM-DIRECTORY-MODULE-MAP", 4, 0, false);
    //declareFunction(myName, "translator_libraries_from_directory_module_map", "TRANSLATOR-LIBRARIES-FROM-DIRECTORY-MODULE-MAP", 2, 0, false);
    //declareFunction(myName, "translator_paths_from_directory_module_map", "TRANSLATOR-PATHS-FROM-DIRECTORY-MODULE-MAP", 1, 0, false);
    //declareFunction(myName, "retranslate_modules", "RETRANSLATE-MODULES", 1, 0, false);
    //declareFunction(myName, "module_damaged_wrt_introspectionP", "MODULE-DAMAGED-WRT-INTROSPECTION?", 1, 0, false);
    //declareFunction(myName, "test_translate_and_output_form", "TEST-TRANSLATE-AND-OUTPUT-FORM", 1, 3, false);
    //declareFunction(myName, "test_translate_and_output_form_to_string", "TEST-TRANSLATE-AND-OUTPUT-FORM-TO-STRING", 1, 2, false);
    return NIL;
  }
