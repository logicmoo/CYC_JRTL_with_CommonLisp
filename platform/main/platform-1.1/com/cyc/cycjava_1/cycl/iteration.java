...
public  final class iteration extends SubLTranslatedFile {
  ...
  public static final String myName = "com.cyc.cycjava_1.cycl.iteration";
...
of iterators. */
  ...
  public static final SubLObject declare_iteration_file() {
    ...
    declareFunction("iterator_p", "ITERATOR-P", 1, 0, false); new $iterator_p$UnaryFunction();
    ...
    declareFunction("iterate_non_null_singleton_next", "ITERATE-NON-NULL-SINGLETON-NEXT", 1, 0, false); new $iterate_non_null_singleton_next$UnaryFunction();
    ...
    declareFunction("iterate_number_done", "ITERATE-NUMBER-DONE", 1, 0, false); new $iterate_number_done$UnaryFunction();
    ...
    declareFunction("iterate_list_done", "ITERATE-LIST-DONE", 1, 0, false); new $iterate_list_done$UnaryFunction();
    declareFunction("iterate_list_next", "ITERATE-LIST-NEXT", 1, 0, false); new $iterate_list_next$UnaryFunction();
    ...
    declareFunction("iterate_vector_next", "ITERATE-VECTOR-NEXT", 1, 0, false); new $iterate_vector_next$UnaryFunction();
    ...
    declareFunction("iterator_iterator_done", "ITERATOR-ITERATOR-DONE", 1, 0, false); new $iterator_iterator_done$UnaryFunction();
    declareFunction("iterator_iterator_next", "ITERATOR-ITERATOR-NEXT", 1, 0, false); new $iterator_iterator_next$UnaryFunction();
    ...
    declareFunction("reusable_iterator_done", "REUSABLE-ITERATOR-DONE", 1, 0, false); new $reusable_iterator_done$UnaryFunction();
    declareFunction("reusable_iterator_next", "REUSABLE-ITERATOR-NEXT", 1, 0, false); new $reusable_iterator_next$UnaryFunction();
    ...
    declareFunction("reusable_iterator_cartesian_iterator_done", "REUSABLE-ITERATOR-CARTESIAN-ITERATOR-DONE", 1, 0, false); new $reusable_iterator_cartesian_iterator_done$UnaryFunction();
    declareFunction("all_iterators_doneP", "ALL-ITERATORS-DONE?", 1, 0, false);
    declareFunction("reusable_iterator_cartesian_iterator_next", "REUSABLE-ITERATOR-CARTESIAN-ITERATOR-NEXT", 1, 0, false); new $reusable_iterator_cartesian_iterator_next$UnaryFunction();
    ...
    declareFunction("default_iterator_done_p", "DEFAULT-ITERATOR-DONE-P", 1, 0, false); new $default_iterator_done_p$UnaryFunction();
