...
public  final class simplifier extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_simplifier_file() {
    //declareFunction(myName, "lift_disjuncts", "LIFT-DISJUNCTS", 1, 0, false);
    declareFunction(myName, "nlift_disjuncts", "NLIFT-DISJUNCTS", 1, 0, false);
    declareFunction(myName, "disjoin", "DISJOIN", 1, 1, false);
    declareFunction(myName, "ndisjoin", "NDISJOIN", 1, 1, false);
    //declareFunction(myName, "simplify_unary_junct", "SIMPLIFY-UNARY-JUNCT", 1, 0, false);
    //declareFunction(myName, "simplify_unary_juncts", "SIMPLIFY-UNARY-JUNCTS", 1, 0, false);
    //declareFunction(myName, "simplify_duplicate_juncts", "SIMPLIFY-DUPLICATE-JUNCTS", 1, 0, false);
    //declareFunction(myName, "lift_conjuncts", "LIFT-CONJUNCTS", 1, 0, false);
    //declareFunction(myName, "nlift_conjuncts", "NLIFT-CONJUNCTS", 1, 0, false);
    //declareFunction(myName, "conjoin", "CONJOIN", 1, 1, false);
    //declareFunction(myName, "nconjoin", "NCONJOIN", 1, 1, false);
    //declareFunction(myName, "lift_conjuncts_recursive", "LIFT-CONJUNCTS-RECURSIVE", 1, 0, false);
    //declareFunction(myName, "liftable_conjunctsP", "LIFTABLE-CONJUNCTS?", 1, 0, false);
    //declareFunction(myName, "simplify_el_syntax", "SIMPLIFY-EL-SYNTAX", 1, 1, false);
    //declareFunction(myName, "try_to_simplify_non_wff_into_wff", "TRY-TO-SIMPLIFY-NON-WFF-INTO-WFF", 1, 2, false);
    declareFunction(myName, "simplify_cycl_sentence_deep", "SIMPLIFY-CYCL-SENTENCE-DEEP", 1, 1, false);
    declareFunction(myName, "simplify_cycl_sentence", "SIMPLIFY-CYCL-SENTENCE", 1, 1, false);
    declareFunction(myName, "simplify_cycl_sentence_syntax", "SIMPLIFY-CYCL-SENTENCE-SYNTAX", 1, 1, false);
    declareFunction(myName, "simplify_cycl_sentence_int", "SIMPLIFY-CYCL-SENTENCE-INT", 1, 1, false); new $simplify_cycl_sentence_int$UnaryFunction(); new $simplify_cycl_sentence_int$BinaryFunction();
    //declareFunction(myName, "simplify_true_sentence", "SIMPLIFY-TRUE-SENTENCE", 1, 1, false);
    //declareFunction(myName, "simplify_exception", "SIMPLIFY-EXCEPTION", 1, 1, false);
    declareFunction(myName, "simplify_cycl_literal_syntax", "SIMPLIFY-CYCL-LITERAL-SYNTAX", 1, 1, false);
    declareFunction(myName, "simplify_cycl_literal", "SIMPLIFY-CYCL-LITERAL", 1, 1, false);
    declareFunction(myName, "simplify_cycl_literal_int", "SIMPLIFY-CYCL-LITERAL-INT", 1, 1, false);
    //declareFunction(myName, "distributes_out_of_argP", "DISTRIBUTES-OUT-OF-ARG?", 3, 1, false);
    declareFunction(myName, "simplify_distributing_out_args", "SIMPLIFY-DISTRIBUTING-OUT-ARGS", 1, 0, false);
    declareFunction(myName, "simplify_cycl_literal_terms", "SIMPLIFY-CYCL-LITERAL-TERMS", 1, 1, false);
    //declareFunction(myName, "simplify_mt_literal_terms", "SIMPLIFY-MT-LITERAL-TERMS", 2, 0, false);
    declareFunction(myName, "simplify_cycl_literal_terms_int", "SIMPLIFY-CYCL-LITERAL-TERMS-INT", 1, 1, false);
    declareFunction(myName, "simplify_cycl_term", "SIMPLIFY-CYCL-TERM", 1, 1, false);
    //declareFunction(myName, "el_negate", "EL-NEGATE", 1, 0, false);
    declareFunction(myName, "simplify_cycl_negation", "SIMPLIFY-CYCL-NEGATION", 1, 1, false);
    declareFunction(myName, "simplify_cycl_conjunction", "SIMPLIFY-CYCL-CONJUNCTION", 1, 1, false);
    declareFunction(myName, "simplify_cycl_disjunction", "SIMPLIFY-CYCL-DISJUNCTION", 1, 1, false);
    declareFunction(myName, "simplify_cycl_disjunction_int", "SIMPLIFY-CYCL-DISJUNCTION-INT", 1, 1, false);
    declareFunction(myName, "simplify_cycl_implication", "SIMPLIFY-CYCL-IMPLICATION", 1, 1, false);
    //declareFunction(myName, "equal_implication_argsP", "EQUAL-IMPLICATION-ARGS?", 1, 1, false);
    //declareFunction(myName, "simplify_cycl_universal", "SIMPLIFY-CYCL-UNIVERSAL", 1, 0, false);
    declareFunction(myName, "simplify_cycl_existential", "SIMPLIFY-CYCL-EXISTENTIAL", 1, 0, false);
    //declareFunction(myName, "simplify_cycl_relation", "SIMPLIFY-CYCL-RELATION", 1, 0, false);
    declareFunction(myName, "simplify_special_cases", "SIMPLIFY-SPECIAL-CASES", 1, 0, false);
    declareFunction(myName, "simplify_nested_collectionsubsetfn_expression", "SIMPLIFY-NESTED-COLLECTIONSUBSETFN-EXPRESSION", 1, 0, false);
    declareFunction(myName, "transform_nested_collectionsubsetfn_expression", "TRANSFORM-NESTED-COLLECTIONSUBSETFN-EXPRESSION", 1, 0, false);
    declareFunction(myName, "nested_collectionsubsetfn_expressionP", "NESTED-COLLECTIONSUBSETFN-EXPRESSION?", 1, 0, false); new $nested_collectionsubsetfn_expressionP$UnaryFunction();
    declareFunction(myName, "simplify_redundanciesP", "SIMPLIFY-REDUNDANCIES?", 0, 0, false);
    //declareFunction(myName, "simplify_kappa_asent", "SIMPLIFY-KAPPA-ASENT", 1, 0, false);
    //declareFunction(myName, "simplify_ist_sentence", "SIMPLIFY-IST-SENTENCE", 1, 0, false);
    declareFunction(myName, "simplify_sequence_variables", "SIMPLIFY-SEQUENCE-VARIABLES", 1, 0, false);
    declareFunction(myName, "simplify_sequence_variables_1", "SIMPLIFY-SEQUENCE-VARIABLES-1", 1, 0, false);
    //declareFunction(myName, "simplify_sequence_variables_int", "SIMPLIFY-SEQUENCE-VARIABLES-INT", 3, 0, false);
    //declareFunction(myName, "possible_sequence_var_simplification", "POSSIBLE-SEQUENCE-VAR-SIMPLIFICATION", 2, 0, false);
    //declareFunction(myName, "simplify_sequence_vars_using_kb_arityP", "SIMPLIFY-SEQUENCE-VARS-USING-KB-ARITY?", 0, 0, false);
    //declareFunction(myName, "ignore_sequence_var_if_wff", "IGNORE-SEQUENCE-VAR-IF-WFF", 2, 1, false);
    //declareFunction(myName, "regularize_sequence_var_if_wff", "REGULARIZE-SEQUENCE-VAR-IF-WFF", 2, 1, false);
    //declareFunction(myName, "split_sequence_var_if_wff", "SPLIT-SEQUENCE-VAR-IF-WFF", 1, 5, false);
    //declareFunction(myName, "sequence_var_simplifiableP", "SEQUENCE-VAR-SIMPLIFIABLE?", 1, 0, false);
    //declareFunction(myName, "simplify_transitive_redundancies", "SIMPLIFY-TRANSITIVE-REDUNDANCIES", 1, 1, false);
    //declareFunction(myName, "simplify_transitive_redundancies_in_cycl_disjunction", "SIMPLIFY-TRANSITIVE-REDUNDANCIES-IN-CYCL-DISJUNCTION", 1, 1, false);
    //declareFunction(myName, "subsumed_by_another_conjunctP", "SUBSUMED-BY-ANOTHER-CONJUNCT?", 2, 0, false);
    //declareFunction(myName, "conjunct_subsumed_by_conjunctP", "CONJUNCT-SUBSUMED-BY-CONJUNCT?", 2, 0, false);
    //declareFunction(myName, "subsumed_args_by_constsP", "SUBSUMED-ARGS-BY-CONSTS?", 3, 0, false);
    //declareFunction(myName, "subsumed_argsP", "SUBSUMED-ARGS?", 3, 0, false);
    //declareFunction(myName, "simplify_transitive_redundancies_in_disjunction", "SIMPLIFY-TRANSITIVE-REDUNDANCIES-IN-DISJUNCTION", 1, 0, false);
    //declareFunction(myName, "necessary_constraint_dict", "NECESSARY-CONSTRAINT-DICT", 2, 0, false);
    //declareFunction(myName, "transitive_constraint_dict", "TRANSITIVE-CONSTRAINT-DICT", 2, 0, false);
    //declareFunction(myName, "transitive_constraint_raw_info", "TRANSITIVE-CONSTRAINT-RAW-INFO", 1, 0, false);
    declareFunction(myName, "simplify_transitive_redundanciesP", "SIMPLIFY-TRANSITIVE-REDUNDANCIES?", 0, 0, false);
    //declareFunction(myName, "simplify_transitive_redundancies_old", "SIMPLIFY-TRANSITIVE-REDUNDANCIES-OLD", 2, 0, false);
    //declareFunction(myName, "simplify_transitive_redundancies_in_disjunction_old", "SIMPLIFY-TRANSITIVE-REDUNDANCIES-IN-DISJUNCTION-OLD", 2, 0, false);
    //declareFunction(myName, "simplify_number_expression", "SIMPLIFY-NUMBER-EXPRESSION", 1, 0, false);
    return NIL;
  }
