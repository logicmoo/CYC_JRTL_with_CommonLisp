...
public  final class skolems extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_skolems_file() {
    //declareFunction(myName, "reify_skolems_in", "REIFY-SKOLEMS-IN", 4, 0, false);
    //declareFunction(myName, "canonicalize_fns_in_sk_term", "CANONICALIZE-FNS-IN-SK-TERM", 1, 0, false);
    declareFunction(myName, "subst_skolem_in", "SUBST-SKOLEM-IN", 3, 0, false);
    declareFunction(myName, "skolem_function_dependent_vars", "SKOLEM-FUNCTION-DEPENDENT-VARS", 1, 0, false);
    declareFunction(myName, "skolem_function_var", "SKOLEM-FUNCTION-VAR", 1, 0, false);
    //declareFunction(myName, "skolem_args", "SKOLEM-ARGS", 3, 0, false);
    //declareFunction(myName, "canonicalize_skolem_term", "CANONICALIZE-SKOLEM-TERM", 4, 0, false);
    //declareFunction(myName, "replace_unreified_skolem_terms_with_variables", "REPLACE-UNREIFIED-SKOLEM-TERMS-WITH-VARIABLES", 1, 0, false);
    //declareFunction(myName, "lookup_sk_constant_from_defns", "LOOKUP-SK-CONSTANT-FROM-DEFNS", 3, 0, false);
    //declareFunction(myName, "defn_unreified_sk_term", "DEFN-UNREIFIED-SK-TERM", 3, 0, false);
    //declareFunction(myName, "skolem_collection", "SKOLEM-COLLECTION", 1, 0, false);
    //declareFunction(myName, "create_skolem", "CREATE-SKOLEM", 5, 0, false);
    //declareFunction(myName, "sk_defn_from_clauses", "SK-DEFN-FROM-CLAUSES", 2, 1, false);
    //declareFunction(myName, "alpha_sort_clauses", "ALPHA-SORT-CLAUSES", 1, 0, false);
    //declareFunction(myName, "rename_skolem_clause_vars", "RENAME-SKOLEM-CLAUSE-VARS", 2, 1, false);
    //declareFunction(myName, "sk_defn_var", "SK-DEFN-VAR", 0, 0, false);
    //declareFunction(myName, "clear_formula_constant_str", "CLEAR-FORMULA-CONSTANT-STR", 0, 0, false);
    //declareFunction(myName, "remove_formula_constant_str", "REMOVE-FORMULA-CONSTANT-STR", 1, 0, false);
    //declareFunction(myName, "formula_constant_str_internal", "FORMULA-CONSTANT-STR-INTERNAL", 1, 0, false);
    //declareFunction(myName, "formula_constant_str", "FORMULA-CONSTANT-STR", 1, 0, false);
    //declareFunction(myName, "cyc_var_except_for_x_0P", "CYC-VAR-EXCEPT-FOR-X-0?", 1, 0, false);
    //declareFunction(myName, "make_sk_defn", "MAKE-SK-DEFN", 4, 0, false);
    //declareFunction(myName, "sk_arity", "SK-ARITY", 1, 1, false);
    //declareFunction(myName, "make_unreified_sk_nat", "MAKE-UNREIFIED-SK-NAT", 4, 0, false);
    //declareFunction(myName, "skolem_defn", "SKOLEM-DEFN", 1, 0, false);
    //declareFunction(myName, "skolem_defnXkey", "SKOLEM-DEFN&KEY", 1, 0, false);
    //declareFunction(myName, "skolem_defn_key", "SKOLEM-DEFN-KEY", 1, 0, false);
    declareFunction(myName, "skolem_of_defn", "SKOLEM-OF-DEFN", 1, 0, false);
    declareFunction(myName, "unreified_sk_term", "UNREIFIED-SK-TERM", 1, 0, false);
    //declareFunction(myName, "skolem_defn_mt", "SKOLEM-DEFN-MT", 1, 0, false);
    declareFunction(myName, "skolem_seqvar", "SKOLEM-SEQVAR", 1, 0, false);
    declareFunction(myName, "skolem_defn_seqvar", "SKOLEM-DEFN-SEQVAR", 1, 0, false);
    //declareFunction(myName, "old_format_skolemP", "OLD-FORMAT-SKOLEM?", 1, 0, false);
    declareFunction(myName, "skolem_number", "SKOLEM-NUMBER", 1, 0, false);
    //declareFunction(myName, "skolem_defn_number", "SKOLEM-DEFN-NUMBER", 1, 0, false);
    //declareFunction(myName, "skolem_defn_args", "SKOLEM-DEFN-ARGS", 1, 0, false);
    declareFunction(myName, "skolem_var", "SKOLEM-VAR", 1, 0, false);
    //declareFunction(myName, "el_unreified_sk_term", "EL-UNREIFIED-SK-TERM", 1, 0, false);
    //declareFunction(myName, "compute_unreified_sk_term_via_hl", "COMPUTE-UNREIFIED-SK-TERM-VIA-HL", 1, 0, false);
    //declareFunction(myName, "compute_skolem_info_from_assertions", "COMPUTE-SKOLEM-INFO-FROM-ASSERTIONS", 2, 0, false);
    declareFunction(myName, "skolem_table_key_from_defn", "SKOLEM-TABLE-KEY-FROM-DEFN", 1, 0, false);
    declareFunction(myName, "skolem_table_key_from_constant", "SKOLEM-TABLE-KEY-FROM-CONSTANT", 1, 0, false);
    declareFunction(myName, "skolem_hash_key", "SKOLEM-HASH-KEY", 2, 0, false);
    //declareFunction(myName, "opaquify_unreified_skolem_terms", "OPAQUIFY-UNREIFIED-SKOLEM-TERMS", 1, 0, false);
    declareFunction(myName, "skolem_defns_from_key_specification", "SKOLEM-DEFNS-FROM-KEY-SPECIFICATION", 2, 0, false);
    //declareFunction(myName, "cnfs_of_skolem_defn", "CNFS-OF-SKOLEM-DEFN", 1, 0, false);
    //declareFunction(myName, "mt_of_skolem_defn", "MT-OF-SKOLEM-DEFN", 1, 0, false);
    //declareFunction(myName, "skolem_defn_cnfs", "SKOLEM-DEFN-CNFS", 1, 0, false);
    //declareFunction(myName, "skolem_defn_assertions_robust", "SKOLEM-DEFN-ASSERTIONS-ROBUST", 1, 1, false);
    declareFunction(myName, "skolem_function_has_no_defn_assertions_robustP", "SKOLEM-FUNCTION-HAS-NO-DEFN-ASSERTIONS-ROBUST?", 1, 0, false);
    declareFunction(myName, "skolem_function_has_no_defn_assertionsP", "SKOLEM-FUNCTION-HAS-NO-DEFN-ASSERTIONS?", 1, 0, false);
    //declareFunction(myName, "skolem_defining_bookkeeping_assertion", "SKOLEM-DEFINING-BOOKKEEPING-ASSERTION", 1, 0, false);
    //declareFunction(myName, "skolem_defn_assertions", "SKOLEM-DEFN-ASSERTIONS", 1, 1, false);
    declareFunction(myName, "skolems_defn_assertions", "SKOLEMS-DEFN-ASSERTIONS", 1, 0, false);
    declareFunction(myName, "skolem_defn_siblings", "SKOLEM-DEFN-SIBLINGS", 1, 0, false);
    //declareFunction(myName, "skolem_defn_proper_siblings", "SKOLEM-DEFN-PROPER-SIBLINGS", 1, 0, false);
    //declareFunction(myName, "skolem_canonical_sibling", "SKOLEM-CANONICAL-SIBLING", 1, 0, false);
    declareFunction(myName, "skolems_min_mt", "SKOLEMS-MIN-MT", 1, 0, false);
    declareFunction(myName, "skolem_only_mentioned_in_el_templatesP", "SKOLEM-ONLY-MENTIONED-IN-EL-TEMPLATES?", 2, 0, false);
    //declareFunction(myName, "skolem_defn_assertionP", "SKOLEM-DEFN-ASSERTION?", 2, 1, false);
    //declareFunction(myName, "gaf_has_corresponding_cnf_in_skolem_defnP", "GAF-HAS-CORRESPONDING-CNF-IN-SKOLEM-DEFN?", 2, 1, false);
    //declareFunction(myName, "constant_denoting_reified_skolem_fnP", "CONSTANT-DENOTING-REIFIED-SKOLEM-FN?", 1, 0, false);
    //declareFunction(myName, "computed_skolem_assertionP", "COMPUTED-SKOLEM-ASSERTION?", 1, 0, false);
    //declareFunction(myName, "skolem_defining_assertionP", "SKOLEM-DEFINING-ASSERTION?", 1, 0, false);
    //declareFunction(myName, "defn_assertion_of_skolemP", "DEFN-ASSERTION-OF-SKOLEM?", 2, 0, false);
    //declareFunction(myName, "assertion_skolems", "ASSERTION-SKOLEMS", 1, 0, false);
    //declareFunction(myName, "defn_assertion_skolems", "DEFN-ASSERTION-SKOLEMS", 1, 0, false);
    //declareFunction(myName, "all_skolem_mt_defn_assertions", "ALL-SKOLEM-MT-DEFN-ASSERTIONS", 2, 1, false);
    //declareFunction(myName, "recomputing_skolem_defn_info_constant", "RECOMPUTING-SKOLEM-DEFN-INFO-CONSTANT", 0, 0, false);
    //declareFunction(myName, "recomputing_skolem_defn_info_var", "RECOMPUTING-SKOLEM-DEFN-INFO-VAR", 0, 0, false);
    //declareFunction(myName, "really_recomputing_skolem_defnP", "REALLY-RECOMPUTING-SKOLEM-DEFN?", 0, 0, false);
    //declareFunction(myName, "recomputing_skolem_defn_info_defn", "RECOMPUTING-SKOLEM-DEFN-INFO-DEFN", 0, 0, false);
    //declareFunction(myName, "recomputing_skolem_defn_info_key", "RECOMPUTING-SKOLEM-DEFN-INFO-KEY", 0, 0, false);
    //declareFunction(myName, "recomputing_skolem_defn_info_blist", "RECOMPUTING-SKOLEM-DEFN-INFO-BLIST", 0, 0, false);
    //declareFunction(myName, "set_recomputing_skolem_defn_result", "SET-RECOMPUTING-SKOLEM-DEFN-RESULT", 2, 0, false);
    //declareFunction(myName, "set_recomputing_skolem_defn_blist", "SET-RECOMPUTING-SKOLEM-DEFN-BLIST", 1, 0, false);
    //declareFunction(myName, "recomputing_skolem_defnP", "RECOMPUTING-SKOLEM-DEFN?", 0, 0, false);
    //declareFunction(myName, "recomputing_defn_of_skolemP", "RECOMPUTING-DEFN-OF-SKOLEM?", 1, 0, false);
    //declareFunction(myName, "recomputing_skolem_defn_ofP", "RECOMPUTING-SKOLEM-DEFN-OF?", 1, 0, false);
    //declareFunction(myName, "note_skolem_binding", "NOTE-SKOLEM-BINDING", 2, 0, false);
    //declareFunction(myName, "recompute_skolem_defn", "RECOMPUTE-SKOLEM-DEFN", 6, 0, false);
    //declareFunction(myName, "remove_defn_of_skolem", "REMOVE-DEFN-OF-SKOLEM", 1, 1, false);
    //declareFunction(myName, "add_skolem_defn", "ADD-SKOLEM-DEFN", 1, 1, false);
    //declareFunction(myName, "kb_skolems", "KB-SKOLEMS", 0, 0, false);
    declareFunction(myName, "skolem_table_contains_old_format_skolemsP", "SKOLEM-TABLE-CONTAINS-OLD-FORMAT-SKOLEMS?", 0, 0, false);
    //declareFunction(myName, "reset_skolem_defn_table", "RESET-SKOLEM-DEFN-TABLE", 0, 2, false);
    //declareFunction(myName, "reset_defn_of_skolem", "RESET-DEFN-OF-SKOLEM", 1, 1, false);
    //declareFunction(myName, "skolem_defn_from_assertions", "SKOLEM-DEFN-FROM-ASSERTIONS", 1, 1, false);
    //declareFunction(myName, "reset_skolem_defn_from_assertions", "RESET-SKOLEM-DEFN-FROM-ASSERTIONS", 1, 2, false);
    declareFunction(myName, "skolem_variable_from_assertions", "SKOLEM-VARIABLE-FROM-ASSERTIONS", 2, 0, false);
    declareFunction(myName, "skolem_scalar_termP", "SKOLEM-SCALAR-TERM?", 1, 1, false);
    declareFunction(myName, "skolem_result_types_from_cnfs", "SKOLEM-RESULT-TYPES-FROM-CNFS", 2, 2, false);
    //declareFunction(myName, "guess_skolem_result_types_from_cnfs", "GUESS-SKOLEM-RESULT-TYPES-FROM-CNFS", 3, 2, false);
    //declareFunction(myName, "skolem_cnfs_pos_lit_types", "SKOLEM-CNFS-POS-LIT-TYPES", 2, 1, false);
    declareFunction(myName, "skolem_var_isa_constraints_wrt_cnfs", "SKOLEM-VAR-ISA-CONSTRAINTS-WRT-CNFS", 2, 1, false);
    declareFunction(myName, "skolem_var_genl_constraints_wrt_cnfs", "SKOLEM-VAR-GENL-CONSTRAINTS-WRT-CNFS", 2, 1, false);
    //declareFunction(myName, "skolem_arg_isa_constraints", "SKOLEM-ARG-ISA-CONSTRAINTS", 2, 1, false);
    //declareFunction(myName, "install_skolem_arg_types", "INSTALL-SKOLEM-ARG-TYPES", 0, 2, false);
    //declareFunction(myName, "cnf_fn_argn_isa", "CNF-FN-ARGN-ISA", 3, 1, false);
    //declareFunction(myName, "cnf_fn_argn_var", "CNF-FN-ARGN-VAR", 3, 0, false);
    //declareFunction(myName, "interpolate_arg_type", "INTERPOLATE-ARG-TYPE", 1, 1, false);
    //declareFunction(myName, "max_skolem_arity", "MAX-SKOLEM-ARITY", 0, 0, false);
    declareFunction(myName, "skolems_of_arity", "SKOLEMS-OF-ARITY", 0, 1, false);
    declareFunction(myName, "skolem_hosedP", "SKOLEM-HOSED?", 1, 0, false);
    declareFunction(myName, "skolem_ill_formedP", "SKOLEM-ILL-FORMED?", 1, 0, false);
    declareFunction(myName, "skolem_rule_hosedP", "SKOLEM-RULE-HOSED?", 2, 0, false);
    //declareFunction(myName, "all_hosed_skolems", "ALL-HOSED-SKOLEMS", 0, 0, false);
    //declareFunction(myName, "multi_skolem_skolems", "MULTI-SKOLEM-SKOLEMS", 0, 0, false);
    //declareFunction(myName, "misindexed_skolem_keys", "MISINDEXED-SKOLEM-KEYS", 0, 1, false);
    //declareFunction(myName, "sk_defns_wXo_sk_constants", "SK-DEFNS-W/O-SK-CONSTANTS", 0, 1, false);
    //declareFunction(myName, "sk_keys_wXo_sk_defns", "SK-KEYS-W/O-SK-DEFNS", 0, 1, false);
    //declareFunction(myName, "install_skolemfunction_fn_in_skolem_defns", "INSTALL-SKOLEMFUNCTION-FN-IN-SKOLEM-DEFNS", 0, 2, false);
    //declareFunction(myName, "sk_defns_wXo_mts", "SK-DEFNS-W/O-MTS", 0, 1, false);
    declareFunction(myName, "skolem_wffP", "SKOLEM-WFF?", 1, 0, false);
    declareFunction(myName, "skolem_not_wffP", "SKOLEM-NOT-WFF?", 1, 0, false);
    declareFunction(myName, "why_skolem_not_wff", "WHY-SKOLEM-NOT-WFF", 1, 0, false);
    declareFunction(myName, "skolem_defn_wffP", "SKOLEM-DEFN-WFF?", 1, 0, false);
    //declareFunction(myName, "skolem_defn_not_wffP", "SKOLEM-DEFN-NOT-WFF?", 1, 0, false);
    declareFunction(myName, "why_skolem_defn_not_wff", "WHY-SKOLEM-DEFN-NOT-WFF", 1, 0, false);
    //declareFunction(myName, "skolem_all_goodP", "SKOLEM-ALL-GOOD?", 1, 0, false);
    declareFunction(myName, "skolem_function_skolem_assertion_goodP", "SKOLEM-FUNCTION-SKOLEM-ASSERTION-GOOD?", 1, 0, false);
    declareFunction(myName, "skolem_functions_with_bad_skolem_assertions", "SKOLEM-FUNCTIONS-WITH-BAD-SKOLEM-ASSERTIONS", 0, 0, false);
    //declareFunction(myName, "diagnose_all_skolems", "DIAGNOSE-ALL-SKOLEMS", 0, 0, false);
    //declareFunction(myName, "diagnose_skolems", "DIAGNOSE-SKOLEMS", 1, 1, false);
    //declareFunction(myName, "diagnose_skolem", "DIAGNOSE-SKOLEM", 1, 0, false);
    //declareFunction(myName, "diagnose_just_this_skolem_internal", "DIAGNOSE-JUST-THIS-SKOLEM-INTERNAL", 1, 0, false);
    //declareFunction(myName, "diagnose_just_this_skolem", "DIAGNOSE-JUST-THIS-SKOLEM", 1, 0, false);
    //declareFunction(myName, "recanonicalize_skolem_defn_assertions", "RECANONICALIZE-SKOLEM-DEFN-ASSERTIONS", 1, 0, false);
    declareFunction(myName, "skolem_safe_to_recanonicalize_at_elP", "SKOLEM-SAFE-TO-RECANONICALIZE-AT-EL?", 1, 0, false);
    //declareFunction(myName, "compute_target_consequent_literal_count", "COMPUTE-TARGET-CONSEQUENT-LITERAL-COUNT", 1, 0, false);
    //declareFunction(myName, "conjunction_of_literalsP", "CONJUNCTION-OF-LITERALS?", 1, 0, false);
    //declareFunction(myName, "modernize_skolem_axiom_table", "MODERNIZE-SKOLEM-AXIOM-TABLE", 0, 0, false);
    //declareFunction(myName, "possibly_modernize_unreified_sk_term", "POSSIBLY-MODERNIZE-UNREIFIED-SK-TERM", 1, 0, false);
    declareFunction(myName, "skolems_with_mismatched_unreified_sk_terms", "SKOLEMS-WITH-MISMATCHED-UNREIFIED-SK-TERMS", 0, 0, false);
    declareFunction(myName, "skolem_unreified_sk_terms_matchP", "SKOLEM-UNREIFIED-SK-TERMS-MATCH?", 1, 0, false);
    //declareFunction(myName, "possibly_nrepair_skolems_with_duplicate_vars", "POSSIBLY-NREPAIR-SKOLEMS-WITH-DUPLICATE-VARS", 1, 0, false);
    //declareFunction(myName, "possibly_nrepair_skolem_with_duplicate_vars", "POSSIBLY-NREPAIR-SKOLEM-WITH-DUPLICATE-VARS", 1, 0, false);
    //declareFunction(myName, "nrepair_skolem_with_duplicate_vars", "NREPAIR-SKOLEM-WITH-DUPLICATE-VARS", 1, 0, false);
    //declareFunction(myName, "possibly_nrepair_skolems_with_malformed_numbers", "POSSIBLY-NREPAIR-SKOLEMS-WITH-MALFORMED-NUMBERS", 1, 0, false);
    //declareFunction(myName, "possibly_nrepair_skolem_with_malformed_numbers", "POSSIBLY-NREPAIR-SKOLEM-WITH-MALFORMED-NUMBERS", 1, 0, false);
    //declareFunction(myName, "nrepair_skolem_with_malformed_numbers", "NREPAIR-SKOLEM-WITH-MALFORMED-NUMBERS", 1, 0, false);
    declareFunction(myName, "tmi_skolemP", "TMI-SKOLEM?", 1, 0, false);
    //declareFunction(myName, "recanonicalize_tmi_skolems", "RECANONICALIZE-TMI-SKOLEMS", 1, 0, false);
    //declareFunction(myName, "recanonicalize_tmi_skolem", "RECANONICALIZE-TMI-SKOLEM", 1, 0, false);
    //declareFunction(myName, "possibly_rehabilitate_skolem_defn_table", "POSSIBLY-REHABILITATE-SKOLEM-DEFN-TABLE", 0, 0, false);
    return NIL;
  }
