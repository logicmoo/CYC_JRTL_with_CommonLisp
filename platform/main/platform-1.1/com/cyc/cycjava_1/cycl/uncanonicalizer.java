...
public  final class uncanonicalizer extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_uncanonicalizer_file() {
    ...
    //declareFunction("fast_fi_not_el_termP", "FAST-FI-NOT-EL-TERM?", 1, 0, false); new $fast_fi_not_el_termP$UnaryFunction();
    //declareFunction("potentially_interestingly_uncanonicalizable_tense_termP", "POTENTIALLY-INTERESTINGLY-UNCANONICALIZABLE-TENSE-TERM?", 1, 0, false); new $potentially_interestingly_uncanonicalizable_tense_termP$UnaryFunction();
