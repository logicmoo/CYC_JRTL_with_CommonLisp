...
public  final class mail_message extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_mail_message_file() {
    declareFunction(myName, "message_print_function_trampoline", "MESSAGE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction(myName, "message_p", "MESSAGE-P", 1, 0, false); new $message_p$UnaryFunction();
    declareFunction(myName, "msg_from", "MSG-FROM", 1, 0, false);
    declareFunction(myName, "msg_to", "MSG-TO", 1, 0, false);
    declareFunction(myName, "msg_cc", "MSG-CC", 1, 0, false);
    declareFunction(myName, "msg_bcc", "MSG-BCC", 1, 0, false);
    declareFunction(myName, "msg_subject", "MSG-SUBJECT", 1, 0, false);
    declareFunction(myName, "msg_additional_headers", "MSG-ADDITIONAL-HEADERS", 1, 0, false);
    declareFunction(myName, "msg_host", "MSG-HOST", 1, 0, false);
    declareFunction(myName, "msg_port", "MSG-PORT", 1, 0, false);
    declareFunction(myName, "msg_parts", "MSG-PARTS", 1, 0, false);
    declareFunction(myName, "_csetf_msg_from", "_CSETF-MSG-FROM", 2, 0, false);
    declareFunction(myName, "_csetf_msg_to", "_CSETF-MSG-TO", 2, 0, false);
    declareFunction(myName, "_csetf_msg_cc", "_CSETF-MSG-CC", 2, 0, false);
    declareFunction(myName, "_csetf_msg_bcc", "_CSETF-MSG-BCC", 2, 0, false);
    declareFunction(myName, "_csetf_msg_subject", "_CSETF-MSG-SUBJECT", 2, 0, false);
    declareFunction(myName, "_csetf_msg_additional_headers", "_CSETF-MSG-ADDITIONAL-HEADERS", 2, 0, false);
    declareFunction(myName, "_csetf_msg_host", "_CSETF-MSG-HOST", 2, 0, false);
    declareFunction(myName, "_csetf_msg_port", "_CSETF-MSG-PORT", 2, 0, false);
    declareFunction(myName, "_csetf_msg_parts", "_CSETF-MSG-PARTS", 2, 0, false);
    declareFunction(myName, "make_message", "MAKE-MESSAGE", 0, 1, false);
    declareFunction(myName, "print_message", "PRINT-MESSAGE", 3, 0, false);
    declareFunction(myName, "new_message", "NEW-MESSAGE", 0, 6, false);
    declareFunction(myName, "message_set_from", "MESSAGE-SET-FROM", 2, 0, false);
    declareFunction(myName, "message_from", "MESSAGE-FROM", 1, 0, false);
    declareFunction(myName, "message_add_to", "MESSAGE-ADD-TO", 2, 0, false);
    declareFunction(myName, "message_to", "MESSAGE-TO", 1, 0, false);
    declareFunction(myName, "message_add_cc", "MESSAGE-ADD-CC", 2, 0, false);
    declareFunction(myName, "message_cc", "MESSAGE-CC", 1, 0, false);
    declareFunction(myName, "message_add_bcc", "MESSAGE-ADD-BCC", 2, 0, false);
    declareFunction(myName, "message_bcc", "MESSAGE-BCC", 1, 0, false);
    declareFunction(myName, "message_set_subject", "MESSAGE-SET-SUBJECT", 2, 0, false);
    declareFunction(myName, "message_subject", "MESSAGE-SUBJECT", 1, 0, false);
    declareFunction(myName, "message_add_header", "MESSAGE-ADD-HEADER", 2, 0, false);
    declareFunction(myName, "message_additional_headers", "MESSAGE-ADDITIONAL-HEADERS", 1, 0, false);
    declareFunction(myName, "message_set_host", "MESSAGE-SET-HOST", 2, 0, false);
    declareFunction(myName, "message_host", "MESSAGE-HOST", 1, 0, false);
    declareFunction(myName, "message_set_port", "MESSAGE-SET-PORT", 2, 0, false);
    declareFunction(myName, "message_port", "MESSAGE-PORT", 1, 0, false);
    declareFunction(myName, "message_add_part", "MESSAGE-ADD-PART", 2, 0, false);
    declareFunction(myName, "message_parts", "MESSAGE-PARTS", 1, 0, false);
    declareFunction(myName, "send_message", "SEND-MESSAGE", 1, 1, false);
    declareFunction(myName, "send_message_parts", "SEND-MESSAGE-PARTS", 2, 0, false);
    declareFunction(myName, "sxhash_message_method", "SXHASH-MESSAGE-METHOD", 1, 0, false);
    declareFunction(myName, "sxhash_message", "SXHASH-MESSAGE", 1, 0, false);
    declareFunction(myName, "validate_message", "VALIDATE-MESSAGE", 1, 0, false);
    declareFunction(myName, "send_message_internal", "SEND-MESSAGE-INTERNAL", 2, 0, false);
    declareFunction(myName, "message_part_print_function_trampoline", "MESSAGE-PART-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction(myName, "message_part_p", "MESSAGE-PART-P", 1, 0, false); new $message_part_p$UnaryFunction();
    declareFunction(myName, "msg_part_content_type", "MSG-PART-CONTENT-TYPE", 1, 0, false);
    declareFunction(myName, "msg_part_content_type_parameters", "MSG-PART-CONTENT-TYPE-PARAMETERS", 1, 0, false);
    declareFunction(myName, "msg_part_disposition", "MSG-PART-DISPOSITION", 1, 0, false);
    declareFunction(myName, "msg_part_content_disposition_parameters", "MSG-PART-CONTENT-DISPOSITION-PARAMETERS", 1, 0, false);
    declareFunction(myName, "msg_part_encoding", "MSG-PART-ENCODING", 1, 0, false);
    declareFunction(myName, "msg_part_data", "MSG-PART-DATA", 1, 0, false);
    declareFunction(myName, "msg_part_data_type", "MSG-PART-DATA-TYPE", 1, 0, false);
    declareFunction(myName, "_csetf_msg_part_content_type", "_CSETF-MSG-PART-CONTENT-TYPE", 2, 0, false);
    declareFunction(myName, "_csetf_msg_part_content_type_parameters", "_CSETF-MSG-PART-CONTENT-TYPE-PARAMETERS", 2, 0, false);
    declareFunction(myName, "_csetf_msg_part_disposition", "_CSETF-MSG-PART-DISPOSITION", 2, 0, false);
    declareFunction(myName, "_csetf_msg_part_content_disposition_parameters", "_CSETF-MSG-PART-CONTENT-DISPOSITION-PARAMETERS", 2, 0, false);
    declareFunction(myName, "_csetf_msg_part_encoding", "_CSETF-MSG-PART-ENCODING", 2, 0, false);
    declareFunction(myName, "_csetf_msg_part_data", "_CSETF-MSG-PART-DATA", 2, 0, false);
    declareFunction(myName, "_csetf_msg_part_data_type", "_CSETF-MSG-PART-DATA-TYPE", 2, 0, false);
    declareFunction(myName, "make_message_part", "MAKE-MESSAGE-PART", 0, 1, false);
    declareFunction(myName, "print_message_part", "PRINT-MESSAGE-PART", 3, 0, false);
    declareFunction(myName, "new_inline_message_part", "NEW-INLINE-MESSAGE-PART", 1, 2, false);
    declareFunction(myName, "new_message_attachment", "NEW-MESSAGE-ATTACHMENT", 1, 3, false);
    declareFunction(myName, "valid_message_part_data_type_p", "VALID-MESSAGE-PART-DATA-TYPE-P", 1, 0, false);
    declareFunction(myName, "valid_message_part_encoding_p", "VALID-MESSAGE-PART-ENCODING-P", 1, 0, false);
    declareFunction(myName, "new_message_part", "NEW-MESSAGE-PART", 5, 0, false);
    declareFunction(myName, "message_part_content_type", "MESSAGE-PART-CONTENT-TYPE", 1, 0, false);
    declareFunction(myName, "message_part_set_content_type", "MESSAGE-PART-SET-CONTENT-TYPE", 2, 0, false);
    declareFunction(myName, "message_part_content_disposition_parameters", "MESSAGE-PART-CONTENT-DISPOSITION-PARAMETERS", 1, 0, false);
    declareFunction(myName, "message_part_set_attachment_name", "MESSAGE-PART-SET-ATTACHMENT-NAME", 2, 0, false);
    declareFunction(myName, "message_part_disposition", "MESSAGE-PART-DISPOSITION", 1, 0, false);
    declareFunction(myName, "message_part_encoding", "MESSAGE-PART-ENCODING", 1, 0, false);
    declareFunction(myName, "message_part_data", "MESSAGE-PART-DATA", 1, 0, false);
    declareFunction(myName, "message_part_data_type", "MESSAGE-PART-DATA-TYPE", 1, 0, false);
    declareFunction(myName, "sxhash_message_part_method", "SXHASH-MESSAGE-PART-METHOD", 1, 0, false);
    declareFunction(myName, "sxhash_message_part", "SXHASH-MESSAGE-PART", 1, 0, false);
    declareFunction(myName, "message_part_set_content_disposition_parameter", "MESSAGE-PART-SET-CONTENT-DISPOSITION-PARAMETER", 3, 0, false);
    declareFunction(myName, "send_message_part", "SEND-MESSAGE-PART", 3, 0, false);
    declareFunction(myName, "send_message_part_headers", "SEND-MESSAGE-PART-HEADERS", 2, 0, false);
    declareFunction(myName, "send_message_part_data", "SEND-MESSAGE-PART-DATA", 2, 0, false);
    return NIL;
  }
