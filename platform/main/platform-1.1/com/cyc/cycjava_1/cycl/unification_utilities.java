...
public  final class unification_utilities extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_unification_utilities_file() {
    ...
    //declareFunction("unify_clause", "UNIFY-CLAUSE", 2, 2, false); new $unify_clause$BinaryFunction();
    ...
    //declareFunction("genl_mt_unify_no_time", "GENL-MT-UNIFY-NO-TIME", 3, 0, false);
