...
public  final class removal_modules_tva_lookup extends SubLTranslatedFile {
  ...
  public static final String myName = "com.cyc.cycjava_1.cycl.inference.modules.removal.removal_modules_tva_lookup";
  ...
  public static final SubLObject declare_removal_modules_tva_lookup_file() {
    ...
    declareFunction("removal_tva_unify_cost", "REMOVAL-TVA-UNIFY-COST", 1, 1, false); new $removal_tva_unify_cost$UnaryFunction(); new $removal_tva_unify_cost$BinaryFunction();
    declareFunction("removal_tva_unify_iterator", "REMOVAL-TVA-UNIFY-ITERATOR", 1, 0, false);
    declareFunction("removal_tva_unify_closure_required", "REMOVAL-TVA-UNIFY-CLOSURE-REQUIRED", 1, 1, false); new $removal_tva_unify_closure_required$UnaryFunction(); new $removal_tva_unify_closure_required$BinaryFunction();
    ...
    declareFunction("removal_tva_unify_closure_conjunction_applicability", "REMOVAL-TVA-UNIFY-CLOSURE-CONJUNCTION-APPLICABILITY", 1, 0, false); new $removal_tva_unify_closure_conjunction_applicability$UnaryFunction();
