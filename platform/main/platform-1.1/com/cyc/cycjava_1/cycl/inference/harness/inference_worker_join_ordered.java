...
public  final class inference_worker_join_ordered extends SubLTranslatedFile {
  ...
  public static final class $join_ordered_link_data_native extends SubLStructNative {
    ...
    public SubLObject getField2() { return $focal_proof_index; }
    public SubLObject getField3() { return $non_focal_proof_index; }
    public SubLObject getField4() { return $restricted_non_focal_link_index; }
    public SubLObject setField2(SubLObject value) { return $focal_proof_index = value; }
    public SubLObject setField3(SubLObject value) { return $non_focal_proof_index = value; }
    public SubLObject setField4(SubLObject value) { return $restricted_non_focal_link_index = value; }
    ...
    Structures.makeStructDeclNative($join_ordered_link_data_native.class, $sym0$JOIN_ORDERED_LINK_DATA, $sym1$JOIN_ORDERED_LINK_DATA_P, $list2, $list3, new String[] {"$focal_proof_index", "$non_focal_proof_index", "$restricted_non_focal_link_index"}, $list4, $list5, $sym6$DEFAULT_STRUCT_PRINT_FUNCTION);
  }
  ...
  public static final class $join_ordered_link_data_p$UnaryFunction extends UnaryFunction {
    public $join_ordered_link_data_p$UnaryFunction() { super(extractFunctionNamed("JOIN-ORDERED-LINK-DATA-P")); }
    public SubLObject processItem(SubLObject arg1) { return Errors
			.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36364"); }
  }
  ...
  public static final SubLObject join_ordered_link_p(SubLObject object) {
    return makeBoolean(((NIL != inference_datastructures_problem_link.problem_link_p(object))
           && ($kw18$JOIN_ORDERED == inference_datastructures_problem_link.problem_link_type(object))));
  }
  ...
  public static final SubLObject join_ordered_tactic_p(SubLObject object) {
    {
      ...
      return makeBoolean(((NIL != inference_datastructures_tactic.tactic_p(object))
             && ($join_ordered_module$.getDynamicValue(thread) == inference_datastructures_tactic.tactic_hl_module(object))));
    }
  }
  ...
  public static final SubLObject single_focal_literal_join_ordered_tactic_p(SubLObject join_ordered_tactic) {
    return makeBoolean(((NIL != join_ordered_tactic_p(join_ordered_tactic))
           && (NIL != clause_utilities.single_literal_subclause_specP(join_ordered_tactic_focal_supporting_problem_spec(join_ordered_tactic)))));
  }
                ...
                for (v_iteration = ZERO_INTEGER; v_iteration.numL(length); v_iteration = Numbers.add(v_iteration, ONE_INTEGER)) {
                  {
                    ...
                    if ((!(((NIL != id_index.id_index_tombstone_p(inference))
                           && (NIL != id_index.id_index_skip_tombstones_p($kw56$SKIP)))))) {
                      if ((NIL != id_index.id_index_tombstone_p(inference))) {
                        inference = $kw56$SKIP;
                      }
  ...
  public static final SubLObject determine_new_join_ordered_tactics(SubLObject supported_problem, SubLObject dnf_clause) {
    {
      ...
      if ((NIL == problem_has_a_complete_conjunctive_removal_tacticP(supported_problem))) {
        determine_new_single_literal_join_ordered_tactics(supported_problem, dnf_clause);
        {
          ...
          if ((!(((NIL != $only_add_multi_literal_jo_tactics_when_no_possible_complete_tacticP$.getDynamicValue(thread))
                 && (NIL != Errors
						.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36377")))))) {
            {
  ...
  public static final SubLObject problem_has_a_complete_conjunctive_removal_tacticP(SubLObject problem) {
    {
      ...
      for (tactic = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var.rest(), tactic = cdolist_list_var.first()) {
        if (((NIL != inference_datastructures_problem.do_problem_tactics_type_match(tactic, $kw57$REMOVAL_CONJUNCTIVE))
             && (NIL != inference_datastructures_problem.do_problem_tactics_completeness_match(tactic, $kw58$COMPLETE)))) {
          return T;
        }
      }
    }
        ...
        for (contextualized_asent = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var.rest(), contextualized_asent = cdolist_list_var.first()) {
          {
            ...
            if (((NIL == some_backchain_requiredP)
                || (NIL != inference_trampolines.inference_backchain_required_contextualized_asentP(contextualized_asent)))) {
  ...
  public static final SubLObject problem_store_followup_query_problem_p(SubLObject supported_problem) {
    return makeBoolean(((NIL != inference_datastructures_problem.problem_p(supported_problem))
           && inference_datastructures_problem_store.problem_store_historical_root_problem_count(inference_datastructures_problem.problem_store(supported_problem)).numGE(TWO_INTEGER)
           && (NIL != inference_datastructures_problem.problem_has_dependent_link_of_typeP(supported_problem, $kw62$ANSWER))));
  }
                  ...
                  if ((NIL != inference_datastructures_problem_link.problem_link_has_typeP(union_link, $kw63$UNION))) {
                    {
                      ...
                      for (state_7 = set_contents.do_set_contents_initial_state(basis_object_6, set_contents_var_5); (NIL == set_contents.do_set_contents_doneP(basis_object_6, state_7)); state_7 = set_contents.do_set_contents_update_state(state_7)) {
                        {
                                    ...
                                    if ((NIL != inference_datastructures_problem.multi_literal_problem_p(sibling_problem))) {
                                      {
                                        ...
                                        SubLObject cdolist_list_var = Errors
												.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36382");
                                        SubLObject subclause_spec = NIL;
                                        for (subclause_spec = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var.rest(), subclause_spec = cdolist_list_var.first()) {
                                          {
  ...
  public static final SubLObject matching_subclause_specs(SubLObject dnf_clause, SubLObject other_dnf_clause) {
    {
      ...
      if (((NIL != list_utilities.greater_or_same_length_p(pos_lits, other_pos_lits))
           && (NIL != list_utilities.greater_or_same_length_p(neg_lits, other_neg_lits))
           && ((NIL != list_utilities.greater_length_p(pos_lits, other_pos_lits))
            || (NIL != list_utilities.greater_length_p(neg_lits, other_neg_lits))))) {
        {
          SubLObject pos_dict = Errors
				.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36369");
          if ((NIL != pos_dict)) {
            {
              SubLObject neg_dict = Errors
					.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36370");
              if ((NIL != neg_dict)) {
                {
                  SubLObject positive_indices_list = Errors
						.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36371");
                  SubLObject negative_indices_list = Errors
						.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36372");
  ...
  public static final SubLObject execute_join_ordered_tactic(SubLObject tactic) {
    ...
    if ((NIL != inference_tactician_strategic_uninterestingness.tactic_preferredP(tactic, $kw65$TACTICAL))) {
      if ((!(((NIL != inference_tactician.better_term_chosen_handlingP())
...
@return 1 whether the returned proof was newly created */
  ...
  public static final SubLObject join_ordered_proof_p(SubLObject object) {
    return makeBoolean(((NIL != inference_datastructures_proof.proof_p(object))
           && ($kw18$JOIN_ORDERED == inference_datastructures_proof.proof_type(object))));
  }
  ...
  public static final SubLObject connected_conjunction_proof_p(SubLObject object) {
    return makeBoolean(((NIL != join_ordered_proof_p(object))
          || (NIL != inference_worker_join.join_proof_p(object))));
  }
...
to restrict it.
   @param FOCAL-RESTRICTION-BINDINGS binding-list-p; focal-problem-vars -> restriction.
...
@param FOCAL-PROBLEM-PROOF; the proof that triggered the split-restriction */
  ...
  /** @param RESTRICTION-BINDINGS binding-list-p; UNRESTRICTED-PROBLEM's vars -> restriction.
  ...
  public static final SubLObject find_or_create_restricted_problem_int(SubLObject unrestricted_problem, SubLObject restriction_bindings, SubLObject creation_allowedP) {
    {
      ...
      }
      {
        ...
        SubLObject restricted_mapped_problem = ((NIL != creation_allowedP) ? ((SubLObject) inference_worker.find_or_create_problem(store, restricted_query, UNPROVIDED)) : Errors
				.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35228"));
  ...
  public static final SubLObject focal_problem_is_a_single_literal_backchain_requiredP(SubLObject join_ordered_link) {
    {
      ...
      return makeBoolean(((NIL != inference_datastructures_problem.single_literal_problem_p(focal_problem))
             && (NIL != inference_trampolines.problem_backchain_requiredP(focal_problem))));
    }
  }
              ...
              for (collision = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var.rest(), collision = cdolist_list_var.first()) {
                {
                  ...
                  if ((join_ordered_link == cached_args.first())) {
                    ...
                    if (((NIL != cached_args)
                         ...
                         && (trigger_is_focalP == cached_args.first()))) {
...
to JOIN-ORDERED-LINK. */
  ...
  public static final SubLObject join_ordered_link_sibling_proofs_lookup(SubLObject join_ordered_link, SubLObject sibling_proof_bindings, SubLObject trigger_is_focalP) {
    return ((NIL != trigger_is_focalP) ? ((SubLObject) join_ordered_link_non_focal_proofs_lookup(join_ordered_link, sibling_proof_bindings)) : join_ordered_link_focal_proofs_lookup(join_ordered_link, sibling_proof_bindings));
  }
  ...
  public static final SubLObject bubble_up_proof_to_join_ordered_link_int(SubLObject trigger_subproof, SubLObject variable_map, SubLObject join_ordered_link, SubLObject trigger_is_focalP) {
    {
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
        ...
        SubLObject sibling_proofs = list_utilities.remove_if_not($sym78$PROOF_PROVEN_, join_ordered_link_sibling_proofs_lookup(join_ordered_link, sibling_proof_bindings, trigger_is_focalP), UNPROVIDED, UNPROVIDED, UNPROVIDED, UNPROVIDED);
              ...
              if ((NIL == current)) {
                {
                  ...
                  if ((NIL != cycl_variables.hl_varP(pred))) {
                    if ((NIL != list_utilities.member_eqP(pred, Errors
							.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36373")))) {
                      return T;
                    }
                  }
                }
              ...
              if ((NIL == current)) {
                {
                  ...
                  if ((NIL != cycl_variables.hl_varP(pred))) {
                    if ((NIL != list_utilities.member_eqP(pred, Errors
							.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36374")))) {
                      return T;
                    }
                  }
                }
...
the ?var1 is restricted by the focal problem. */
              ...
              if ((NIL == current)) {
                {
                  ...
                  if (((pred == $const81$isa)
                       && (NIL != variables.variable_p(arg1))
                       && (NIL != variables.variable_p(arg2))
                       && (NIL != list_utilities.member_eqP(arg2, Errors
							.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36375"))))) {
                    return T;
                  }
                }
              } else {
              ...
              if ((NIL == current)) {
                {
                  ...
                  if (((pred == $const81$isa)
                       ...
                       && (NIL != variables.variable_p(arg2))
                       && (NIL != list_utilities.member_eqP(arg2, Errors
							.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36376"))))) {
                    return T;
                  }
                }
              } else {
  ...
  public static final SubLObject declare_inference_worker_join_ordered_file() {
    ...
    declareFunction(myName, "join_ordered_link_data_p", "JOIN-ORDERED-LINK-DATA-P", 1, 0, false); new $join_ordered_link_data_p$UnaryFunction();
  ...
  public static final SubLObject setup_inference_worker_join_ordered_file() {
    // CVS_ID("Id: inference-worker-join-ordered.lisp 128924 2009-10-07 17:48:12Z pace ");
  ...
  public static final SubLList $list31 = list(list(makeSymbol("RESTRICTED-NON-FOCAL-PROBLEM-VAR"), makeSymbol("JOIN-ORDERED-LINK"), makeSymbol("&KEY"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));
  ...
  public static final SubLList $list44 = list(list(makeSymbol("JOIN-ORDERED-LINK-VAR"), makeSymbol("RESTRICTED-NON-FOCAL-PROBLEM"), makeSymbol("&KEY"), makeSymbol("DONE")), makeSymbol("&BODY"), makeSymbol("BODY"));
