...
public  final class kbq_query_run extends SubLTranslatedFile {
  ...
  public static final SubLObject init_kbq_query_run_file() {
    ...
    $last_query_set_run$ = deflexical("*LAST-QUERY-SET-RUN*", ((NIL != Symbols.boundp($sym189$_LAST_QUERY_SET_RUN_)) ? ((SubLObject) $last_query_set_run$.getGlobalValue()) : NIL));
    $last_test_set_run$ = deflexical("*LAST-TEST-SET-RUN*", ((NIL != Symbols.boundp($sym211$_LAST_TEST_SET_RUN_)) ? ((SubLObject) $last_test_set_run$.getGlobalValue()) : NIL));
    $runstate_isg$ = deflexical("*RUNSTATE-ISG*", ((NIL != Symbols.boundp($sym219$_RUNSTATE_ISG_)) ? ((SubLObject) $runstate_isg$.getGlobalValue()) : integer_sequence_generator.new_integer_sequence_generator(UNPROVIDED, UNPROVIDED, UNPROVIDED)));
    $runstate_index$ = deflexical("*RUNSTATE-INDEX*", ((NIL != Symbols.boundp($sym220$_RUNSTATE_INDEX_)) ? ((SubLObject) $runstate_index$.getGlobalValue()) : dictionary.new_dictionary(UNPROVIDED, UNPROVIDED)));
