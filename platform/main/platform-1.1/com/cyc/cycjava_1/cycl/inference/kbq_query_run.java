...
public  final class kbq_query_run extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_kbq_query_run_file() {
    ...
    declareFunction("kbq_runstate_p", "KBQ-RUNSTATE-P", 1, 0, false); new $kbq_runstate_p$UnaryFunction();
    ...
    //declareFunction("kct_runstate_p", "KCT-RUNSTATE-P", 1, 0, false); new $kct_runstate_p$UnaryFunction();
    ...
    //declareFunction("kct_set_runstate_p", "KCT-SET-RUNSTATE-P", 1, 0, false); new $kct_set_runstate_p$UnaryFunction();
    ...
    //declareFunction("clear_cached_all_instances_among", "CLEAR-CACHED-ALL-INSTANCES-AMONG", 0, 0, false); new $clear_cached_all_instances_among$ZeroArityFunction();
