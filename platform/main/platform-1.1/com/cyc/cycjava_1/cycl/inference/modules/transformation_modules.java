...
public  final class transformation_modules extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_transformation_modules_file() {
    ...
    declareFunction("trans_predicate_pos_required", "TRANS-PREDICATE-POS-REQUIRED", 1, 0, false); new $trans_predicate_pos_required$UnaryFunction();
    declareFunction("trans_predicate_neg_required", "TRANS-PREDICATE-NEG-REQUIRED", 1, 0, false);
    declareFunction("trans_predicate_pos_cost", "TRANS-PREDICATE-POS-COST", 1, 0, false); new $trans_predicate_pos_cost$UnaryFunction();
    declareFunction("trans_predicate_neg_cost", "TRANS-PREDICATE-NEG-COST", 1, 0, false);
    declareFunction("trans_predicate_pos_rule_select", "TRANS-PREDICATE-POS-RULE-SELECT", 1, 0, false); new $trans_predicate_pos_rule_select$UnaryFunction();
    declareFunction("trans_predicate_neg_rule_select", "TRANS-PREDICATE-NEG-RULE-SELECT", 1, 0, false);
    declareFunction("trans_predicate_pos_rule_filter", "TRANS-PREDICATE-POS-RULE-FILTER", 2, 0, false); new $trans_predicate_pos_rule_filter$BinaryFunction();
    declareFunction("trans_predicate_neg_rule_filter", "TRANS-PREDICATE-NEG-RULE-FILTER", 2, 0, false);
    declareFunction("trans_predicate_pos_expand", "TRANS-PREDICATE-POS-EXPAND", 2, 0, false); new $trans_predicate_pos_expand$BinaryFunction();
    ...
    declareFunction("trans_predicate_genlpreds_pos_required", "TRANS-PREDICATE-GENLPREDS-POS-REQUIRED", 1, 0, false); new $trans_predicate_genlpreds_pos_required$UnaryFunction();
    declareFunction("trans_predicate_genlpreds_neg_required", "TRANS-PREDICATE-GENLPREDS-NEG-REQUIRED", 1, 0, false);
    declareFunction("trans_predicate_genlpreds_pos_cost", "TRANS-PREDICATE-GENLPREDS-POS-COST", 1, 0, false); new $trans_predicate_genlpreds_pos_cost$UnaryFunction();
    declareFunction("trans_predicate_genlpreds_neg_cost", "TRANS-PREDICATE-GENLPREDS-NEG-COST", 1, 0, false);
    declareFunction("trans_predicate_genlpreds_pos_rule_select", "TRANS-PREDICATE-GENLPREDS-POS-RULE-SELECT", 1, 0, false); new $trans_predicate_genlpreds_pos_rule_select$UnaryFunction();
    ...
    declareFunction("trans_predicate_symmetry_pos_cost", "TRANS-PREDICATE-SYMMETRY-POS-COST", 1, 0, false); new $trans_predicate_symmetry_pos_cost$UnaryFunction();
    declareFunction("trans_predicate_symmetry_neg_cost", "TRANS-PREDICATE-SYMMETRY-NEG-COST", 1, 0, false);
    declareFunction("trans_predicate_symmetry_pos_rule_select", "TRANS-PREDICATE-SYMMETRY-POS-RULE-SELECT", 1, 0, false); new $trans_predicate_symmetry_pos_rule_select$UnaryFunction();
    declareFunction("trans_predicate_symmetry_neg_rule_select", "TRANS-PREDICATE-SYMMETRY-NEG-RULE-SELECT", 1, 0, false);
    declareFunction("trans_predicate_symmetry_pos_rule_filter", "TRANS-PREDICATE-SYMMETRY-POS-RULE-FILTER", 2, 0, false); new $trans_predicate_symmetry_pos_rule_filter$BinaryFunction();
    declareFunction("trans_predicate_symmetry_neg_rule_filter", "TRANS-PREDICATE-SYMMETRY-NEG-RULE-FILTER", 2, 0, false);
    declareFunction("trans_predicate_symmetry_pos_expand", "TRANS-PREDICATE-SYMMETRY-POS-EXPAND", 2, 0, false); new $trans_predicate_symmetry_pos_expand$BinaryFunction();
    ...
    declareFunction("trans_unbound_predicate_pos_required", "TRANS-UNBOUND-PREDICATE-POS-REQUIRED", 1, 0, false); new $trans_unbound_predicate_pos_required$UnaryFunction();
    declareFunction("trans_unbound_predicate_neg_required", "TRANS-UNBOUND-PREDICATE-NEG-REQUIRED", 1, 0, false);
    declareFunction("trans_unbound_predicate_pos_cost", "TRANS-UNBOUND-PREDICATE-POS-COST", 1, 0, false); new $trans_unbound_predicate_pos_cost$UnaryFunction();
