...
public  final class removal_modules_reflexivity extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_removal_modules_reflexivity_file() {
    ...
    declareFunction("removal_reflexive_one_arg_expand", "REMOVAL-REFLEXIVE-ONE-ARG-EXPAND", 1, 1, false); new $removal_reflexive_one_arg_expand$UnaryFunction(); new $removal_reflexive_one_arg_expand$BinaryFunction();
