...
public  final class removal_modules_relation_all_instance extends SubLTranslatedFile {
  ...
  public static final String myName = "com.cyc.cycjava_1.cycl.inference.modules.removal.removal_modules_relation_all_instance";
  ...
  public static final SubLObject declare_removal_modules_relation_all_instance_file() {
    ...
    declareFunction("removal_relation_all_instance_unify_required", "REMOVAL-RELATION-ALL-INSTANCE-UNIFY-REQUIRED", 1, 1, false); new $removal_relation_all_instance_unify_required$UnaryFunction(); new $removal_relation_all_instance_unify_required$BinaryFunction();
    ...
    declareFunction("removal_relation_all_instance_iterate_required", "REMOVAL-RELATION-ALL-INSTANCE-ITERATE-REQUIRED", 1, 1, false); new $removal_relation_all_instance_iterate_required$UnaryFunction(); new $removal_relation_all_instance_iterate_required$BinaryFunction();
    ...
    declareFunction("removal_relation_instance_all_unify_required", "REMOVAL-RELATION-INSTANCE-ALL-UNIFY-REQUIRED", 1, 1, false); new $removal_relation_instance_all_unify_required$UnaryFunction(); new $removal_relation_instance_all_unify_required$BinaryFunction();
    ...
    declareFunction("removal_relation_instance_all_iterate_required", "REMOVAL-RELATION-INSTANCE-ALL-ITERATE-REQUIRED", 1, 1, false); new $removal_relation_instance_all_iterate_required$UnaryFunction(); new $removal_relation_instance_all_iterate_required$BinaryFunction();
  ...
  public static final SubLObject init_removal_modules_relation_all_instance_file() {
    ...
    $relation_all_instance_defining_mt$ = deflexical("*RELATION-ALL-INSTANCE-DEFINING-MT*", maybeDefault( $sym2$_RELATION_ALL_INSTANCE_DEFINING_MT_, $relation_all_instance_defining_mt$, ()-> ($const3$BaseKB)));
    ...
    $relation_instance_all_defining_mt$ = deflexical("*RELATION-INSTANCE-ALL-DEFINING-MT*", maybeDefault( $sym34$_RELATION_INSTANCE_ALL_DEFINING_MT_, $relation_instance_all_defining_mt$, ()-> ($const3$BaseKB)));
