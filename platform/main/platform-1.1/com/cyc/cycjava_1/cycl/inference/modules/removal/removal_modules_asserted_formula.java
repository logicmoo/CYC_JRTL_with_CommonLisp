...
public  final class removal_modules_asserted_formula extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_removal_modules_asserted_formula_file() {
    ...
    declareFunction("removal_asserted_sentence_lookup_pos_cost", "REMOVAL-ASSERTED-SENTENCE-LOOKUP-POS-COST", 1, 1, false); new $removal_asserted_sentence_lookup_pos_cost$UnaryFunction(); new $removal_asserted_sentence_lookup_pos_cost$BinaryFunction();
    declareFunction("removal_asserted_sentence_lookup_iterator", "REMOVAL-ASSERTED-SENTENCE-LOOKUP-ITERATOR", 1, 0, false); new $removal_asserted_sentence_lookup_iterator$UnaryFunction();
