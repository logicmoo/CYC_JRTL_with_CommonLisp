...
public  final class removal_modules_genlpreds_lookup extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_removal_modules_genlpreds_lookup_file() {
    declareFunction("removal_genlpreds_lookup_pos_cost", "REMOVAL-GENLPREDS-LOOKUP-POS-COST", 1, 1, false); new $removal_genlpreds_lookup_pos_cost$UnaryFunction(); new $removal_genlpreds_lookup_pos_cost$BinaryFunction();
    declareFunction("removal_genlpreds_lookup_pos_iterator", "REMOVAL-GENLPREDS-LOOKUP-POS-ITERATOR", 1, 0, false); new $removal_genlpreds_lookup_pos_iterator$UnaryFunction();
    ...
    declareFunction("removal_genlpreds_pred_index_pos_cost", "REMOVAL-GENLPREDS-PRED-INDEX-POS-COST", 1, 1, false); new $removal_genlpreds_pred_index_pos_cost$UnaryFunction(); new $removal_genlpreds_pred_index_pos_cost$BinaryFunction();
    ...
    declareFunction("removal_genlinverse_lookup_pos_cost", "REMOVAL-GENLINVERSE-LOOKUP-POS-COST", 1, 1, false); new $removal_genlinverse_lookup_pos_cost$UnaryFunction(); new $removal_genlinverse_lookup_pos_cost$BinaryFunction();
    declareFunction("removal_genlinverse_lookup_pos_iterator", "REMOVAL-GENLINVERSE-LOOKUP-POS-ITERATOR", 1, 0, false); new $removal_genlinverse_lookup_pos_iterator$UnaryFunction();
