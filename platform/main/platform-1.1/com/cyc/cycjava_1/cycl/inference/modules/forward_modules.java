...
import com.cyc.cycjava_1.cycl.inference.modules.removal.removal_modules_natfunction;
...
public  final class forward_modules extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_forward_modules_file() {
    ...
    declareMacro(myName, "do_forward_modules", "DO-FORWARD-MODULES");
    ...
    declareFunction(myName, "forward_normal_pos_rule_select", "FORWARD-NORMAL-POS-RULE-SELECT", 1, 0, false); new $forward_normal_pos_rule_select$UnaryFunction();
    declareFunction(myName, "forward_normal_pos_rule_filter", "FORWARD-NORMAL-POS-RULE-FILTER", 2, 0, false);
    declareFunction(myName, "forward_normal_pos_expand", "FORWARD-NORMAL-POS-EXPAND", 2, 0, false); new $forward_normal_pos_expand$BinaryFunction();
    ...
    declareFunction(myName, "forward_isa_rule_select", "FORWARD-ISA-RULE-SELECT", 1, 0, false); new $forward_isa_rule_select$UnaryFunction();
    declareFunction(myName, "forward_isa_rule_filter", "FORWARD-ISA-RULE-FILTER", 2, 0, false);
    declareFunction(myName, "forward_isa_expand", "FORWARD-ISA-EXPAND", 2, 0, false); new $forward_isa_expand$BinaryFunction();
    ...
    declareFunction(myName, "forward_symmetric_pos_rule_select", "FORWARD-SYMMETRIC-POS-RULE-SELECT", 1, 0, false); new $forward_symmetric_pos_rule_select$UnaryFunction();
    ...
    declareFunction(myName, "forward_asymmetric_required", "FORWARD-ASYMMETRIC-REQUIRED", 1, 0, false); new $forward_asymmetric_required$UnaryFunction();
    ...
    declareFunction(myName, "forward_genlpreds_pos_rule_select", "FORWARD-GENLPREDS-POS-RULE-SELECT", 1, 0, false); new $forward_genlpreds_pos_rule_select$UnaryFunction();
    ...
    declareFunction(myName, "forward_genlinverse_pos_rule_select", "FORWARD-GENLINVERSE-POS-RULE-SELECT", 1, 0, false); new $forward_genlinverse_pos_rule_select$UnaryFunction();
    ...
    declareFunction(myName, "forward_negationpreds_required", "FORWARD-NEGATIONPREDS-REQUIRED", 1, 0, false); new $forward_negationpreds_required$UnaryFunction();
    ...
    declareFunction(myName, "forward_negationinverse_required", "FORWARD-NEGATIONINVERSE-REQUIRED", 1, 0, false); new $forward_negationinverse_required$UnaryFunction();
    ...
    declareFunction(myName, "forward_eval_exclusive_pos", "FORWARD-EVAL-EXCLUSIVE-POS", 1, 0, false); new $forward_eval_exclusive_pos$UnaryFunction();
    ...
    declareFunction(myName, "forward_unbound_pred_pos_required", "FORWARD-UNBOUND-PRED-POS-REQUIRED", 1, 0, false); new $forward_unbound_pred_pos_required$UnaryFunction();
    ...
    declareFunction(myName, "forward_ist_pos_rule_select", "FORWARD-IST-POS-RULE-SELECT", 1, 0, false); new $forward_ist_pos_rule_select$UnaryFunction();
    declareFunction(myName, "forward_ist_pos_rule_filter", "FORWARD-IST-POS-RULE-FILTER", 2, 0, false);
    declareFunction(myName, "forward_ist_pos_expand", "FORWARD-IST-POS-EXPAND", 2, 0, false); new $forward_ist_pos_expand$BinaryFunction();
