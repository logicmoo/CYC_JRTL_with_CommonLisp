...
public  final class removal_module_cost_tests extends SubLTranslatedFile {
  ...
  public static final SubLObject init_removal_module_cost_tests_file() {
    ...
    $removal_module_cost_tests$ = deflexical("*REMOVAL-MODULE-COST-TESTS*", ((NIL != Symbols.boundp($sym42$_REMOVAL_MODULE_COST_TESTS_)) ? ((SubLObject) $removal_module_cost_tests$.getGlobalValue()) : Hashtables.make_hash_table($int43$100, UNPROVIDED, UNPROVIDED)));
    return NIL;
  }
