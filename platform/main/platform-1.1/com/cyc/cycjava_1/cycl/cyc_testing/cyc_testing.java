      ...
      SubLTranslatedFile
{
        ...
        SubLStructNative
  {
    ...
    private static final SubLStructDeclNative structDecl = Structures.makeStructDeclNative( $cyc_test_native.class, $sym29$CYC_TEST, $sym30$CYC_TEST_P, $list31, $list32, new String[] { "$file", "$guts"
        ...
        SubLStructNative
  {
    ...
    private static final SubLStructDeclNative structDecl = Structures.makeStructDeclNative( $cyc_test_file_native.class, $sym135$CYC_TEST_FILE, $sym136$CYC_TEST_FILE_P, $list137, $list138, new String[] { "$filename",
      "$kb"
