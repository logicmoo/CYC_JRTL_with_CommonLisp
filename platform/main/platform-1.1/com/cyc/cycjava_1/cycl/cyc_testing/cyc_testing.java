...
// //dm import com.cyc.cycjava_1.cycl.cyc_testing.evaluatable_relation_tests;
...
// //dm import com.cyc.cycjava_1.cycl.cyc_testing.inference_unit_tests;
...
// //dm import com.cyc.cycjava_1.cycl.cyc_testing.removal_module_cost_tests;
// //dm import com.cyc.cycjava_1.cycl.cyc_testing.removal_module_tests;
//dm import com.cyc.cycjava_1.cycl.string_utilities;
//dm import com.cyc.cycjava_1.cycl.subl_macro_promotions;
//dm import com.cyc.cycjava_1.cycl.subl_macros;
//dm import com.cyc.cycjava_1.cycl.subl_promotions;
//dm import com.cyc.cycjava_1.cycl.system_info;
// //dm import com.cyc.cycjava_1.cycl.cyc_testing.transformation_module_tests;
//dm import com.cyc.cycjava_1.cycl.utilities_macros;

 final class cyc_testing_hide
    extends
      SubLTranslatedFile
{
  //// Constructor
  private cyc_testing_hide()
  {}
  public static final SubLFile me = new cyc_testing_hide();
  public static final String myName = "com.cyc.cycjava_1.cycl.cyc_testing.cyc_testing_hide";
  //// Definitions
  ...
  /**
   * Whether to test real-time while-inference-is-running pruning. This will
   * force :compute-answer-justifications? to NIL and will only run tests where
   * that makes sense.
   */
  ...
  /**
   * Bound to the current file being loaded, so that the tests can know what
   * file they're in
   */
  ...
  {
    {
      ...
      if( name.isCons() )
      {
        Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32431" );
      }
      ...
      {
        {
          ...
          {
            Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32432" );
          }
        }
      }
      if( ( NIL != cyc_testing_initialization.cyc_tests_initializedP() ) )
      {
        {
          ...
          {
            Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32433" );
          }
        }
      }
      return ct;
        ...
        SubLStructNative
  {
    ...
    public static final SubLStructDeclNative structDecl = Structures.makeStructDeclNative( $cyc_test_native.class, $sym29$CYC_TEST, $sym30$CYC_TEST_P, $list31, $list32, new String[] { "$file", "$guts"
  ...
  {
    Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32446" );
    return NIL;
  }
        ...
        UnaryFunction
  {
    ...
    {
      return Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32382" );
    }
  }
      ...
      }
      {
        ...
        _csetf_ct_guts( ct, guts );
        {
          ...
          if( ( NIL != existing_ct ) )
          {
            ...
            Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32458" );
          }
          {
  ...
  public static final SubLObject cyc_test_guts_type(SubLObject guts)
  {
    ...
    else if( ( NIL != Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32334" ) ) )
    {
      return $kw53$IUT;
    }
    else if( ( NIL != Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32476" ) ) )
    {
      return $kw54$RMT;
    }
    else if( ( NIL != Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32510" ) ) )
    {
      return $kw55$RMCT;
    }
    else if( ( NIL != Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32552" ) ) )
    {
      return $kw56$TMT;
    }
    else if( ( NIL != Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32268" ) ) )
    {
      return $kw57$ERT;
    }
    else if( ( NIL != Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 1237" ) ) )
    {
      return $kw58$IT;
    }
    else if( ( NIL != Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 1431" ) ) )
    {
      return $kw59$KCT;
    }
    else
  ...
  {
    {
      ...
      {
        return Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32325" );
      }
      ...
      {
        return Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32474" );
      }
      else if( pcase_var.eql( $kw56$TMT ) )
      {
        return Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32551" );
      }
      else if( pcase_var.eql( $kw55$RMCT ) )
      {
        return Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32508" );
      }
      else if( pcase_var.eql( $kw57$ERT ) )
      {
        return Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32265" );
      }
      ...
      {
        return Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 1" );
      }
      else
      {
        ...
        SubLStructNative
  {
    ...
    public static final SubLStructDeclNative structDecl = Structures.makeStructDeclNative( $cyc_test_file_native.class, $sym135$CYC_TEST_FILE, $sym136$CYC_TEST_FILE_P, $list137, $list138, new String[] { "$filename",
      "$kb"
    }, $list139, $list140, $sym141$PRINT_CYC_TEST_FILE );
  }
  ...
  {
    Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32447" );
    return NIL;
  }
        ...
        UnaryFunction
  {
    ...
    public SubLObject processItem(SubLObject arg1)
    {
      return Errors.handleMissingMethodError( "This call was replaced for LarKC purposes. Originally a method was called. Refer to number 32372" );
    }
  }
  /**
   * The most recent runs are saved here for the cases where they're not
   * returned directly
   */
  @SubL(source = "cycl/cyc-testing/cyc-testing.lisp", position = 37365)
  private static SubLSymbol $most_recent_cyc_test_runs$ = null;
  /**
   * The cyc test files which failed to load the last time load-all-cyc-tests
   * was evaluated.
   */
  ...
  /**
   * A list of tests that will fail if :compute-answer-justifications? is forced
   * to NIL and/or if problem store pruning happens while they're running.
   */
  ...
  public static final SubLObject declare_cyc_testing_file()
  {
    ...
    declareFunction( myName, "cyc_test_p", "CYC-TEST-P", 1, 0, false );
    ...
    declareFunction( myName, "cyc_test_file_p", "CYC-TEST-FILE-P", 1, 0, false );
  ...
  public static final SubLObject init_cyc_testing_file()
  {
    ...
    $cyc_test_result_values$ = deflexical( "*CYC-TEST-RESULT-VALUES*", ConsesLow.append( $cyc_test_result_success_values$.getGlobalValue(), $cyc_test_result_failure_values$.getGlobalValue(),
        $cyc_test_result_ignore_values$.getGlobalValue() ) );
    $cyc_test_type_table$ = deflexical( "*CYC-TEST-TYPE-TABLE*", $list7 );
    $cyc_tests$ = deflexical( "*CYC-TESTS*", maybeDefault( $sym11$_CYC_TESTS_, $cyc_tests$, NIL ) );
    $cyc_test_by_name$ = deflexical( "*CYC-TEST-BY-NAME*", maybeDefault( $sym21$_CYC_TEST_BY_NAME_, $cyc_test_by_name$, () -> ( Hashtables.make_hash_table( $int22$212, Symbols.symbol_function( EQUAL ),
        UNPROVIDED ) ) ) );
    $cyc_test_by_dwimmed_name$ = deflexical( "*CYC-TEST-BY-DWIMMED-NAME*", maybeDefault( $sym23$_CYC_TEST_BY_DWIMMED_NAME_, $cyc_test_by_dwimmed_name$, () -> ( Hashtables.make_hash_table( $int22$212, Symbols
    ...
    $cyc_test_files$ = deflexical( "*CYC-TEST-FILES*", maybeDefault( $sym128$_CYC_TEST_FILES_, $cyc_test_files$, NIL ) );
    $dtp_cyc_test_file$ = defconstant( "*DTP-CYC-TEST-FILE*", $sym135$CYC_TEST_FILE );
    $most_recent_cyc_test_runs$ = deflexical( "*MOST-RECENT-CYC-TEST-RUNS*", maybeDefault( $sym151$_MOST_RECENT_CYC_TEST_RUNS_, $most_recent_cyc_test_runs$, NIL ) );
    $most_recent_cyc_test_file_load_failures$ = deflexical( "*MOST-RECENT-CYC-TEST-FILE-LOAD-FAILURES*", maybeDefault( $sym152$_MOST_RECENT_CYC_TEST_FILE_LOAD_FAILURES_, $most_recent_cyc_test_file_load_failures$,
        NIL ) );
  ...
  public static final SubLList $list7 = list( list( makeKeyword( "IUT" ), makeString( "inference unit test" ) ), list( makeKeyword( "IT" ), makeString( "inference test" ) ), list( makeKeyword( "RMT" ), makeString(
      "removal module test" ) ), list( makeKeyword( "TMT" ), makeString( "transformation module test" ) ), list( makeKeyword( "RMCT" ), makeString( "removal module cost test" ) ), list( makeKeyword( "ERT" ), makeString(
          "evaluatable relation test" ) ), list( makeKeyword( "TCT" ), makeString( "test case table" ) ), list( makeKeyword( "KCT" ), makeString( "KB content test" ) ) );
  ...
  public static final SubLList $list18 = list( list( makeSymbol( "CYC-TEST" ), makeSymbol( "&OPTIONAL" ), list( makeSymbol( "MESSAGE" ), makeString( "Iterating over all Cyc tests" ) ) ), makeSymbol( "&BODY" ),
      makeSymbol( "BODY" ) );
  ...
  public static final SubLList $list68 = list( makeSymbol( "NAME" ), makeSymbol( "&KEY" ), list( makeSymbol( "VERBOSITY" ), makeKeyword( "TERSE" ) ), makeSymbol( "BROWSABLE?" ), makeSymbol( "BLOCK?" ), list( makeSymbol(
      "OUTPUT-FORMAT" ), makeKeyword( "STANDARD" ) ), list( makeSymbol( "STREAM" ), list( makeSymbol( "QUOTE" ), makeSymbol( "*STANDARD-OUTPUT*" ) ) ), list( makeSymbol( "RUN-TINY-KB-TESTS-IN-FULL-KB?" ), list(
          makeSymbol( "QUOTE" ), makeSymbol( "*RUN-TINY-KB-TESTS-IN-FULL-KB?*" ) ) ) );
  public static final SubLList $list69 = list( makeKeyword( "VERBOSITY" ), makeKeyword( "BROWSABLE?" ), makeKeyword( "BLOCK?" ), makeKeyword( "OUTPUT-FORMAT" ), makeKeyword( "STREAM" ), makeKeyword(
      "RUN-TINY-KB-TESTS-IN-FULL-KB?" ) );
  ...
  public static final SubLList $list80 = list( makeSymbol( "NAME" ), makeSymbol( "&KEY" ), makeSymbol( "BROWSABLE?" ), makeSymbol( "BLOCK?" ), list( makeSymbol( "OUTPUT-FORMAT" ), makeKeyword( "STANDARD" ) ), list(
      makeSymbol( "STREAM" ), list( makeSymbol( "QUOTE" ), makeSymbol( "*STANDARD-OUTPUT*" ) ) ), list( makeSymbol( "RUN-TINY-KB-TESTS-IN-FULL-KB?" ), list( makeSymbol( "QUOTE" ), makeSymbol(
          "*RUN-TINY-KB-TESTS-IN-FULL-KB?*" ) ) ) );
  ...
  public static final SubLList $list88 = list( new SubLObject[] { makeSymbol( "NAME" ), makeSymbol( "&KEY" ), list( makeSymbol( "NTHREADS" ), FOUR_INTEGER ), list( makeSymbol( "NTIMES" ), TEN_INTEGER ), list( makeSymbol(
      "VERBOSITY" ), makeKeyword( "TERSE" ) ), makeSymbol( "BROWSABLE?" ), makeSymbol( "BLOCK?" ), list( makeSymbol( "OUTPUT-FORMAT" ), makeKeyword( "STANDARD" ) ), list( makeSymbol( "STREAM" ), list( makeSymbol(
          "QUOTE" ), makeSymbol( "*STANDARD-OUTPUT*" ) ) ), list( makeSymbol( "RUN-TINY-KB-TESTS-IN-FULL-KB?" ), list( makeSymbol( "QUOTE" ), makeSymbol( "*RUN-TINY-KB-TESTS-IN-FULL-KB?*" ) ) )
  } );
  public static final SubLList $list89 = list( makeKeyword( "NTHREADS" ), makeKeyword( "NTIMES" ), makeKeyword( "VERBOSITY" ), makeKeyword( "BROWSABLE?" ), makeKeyword( "BLOCK?" ), makeKeyword( "OUTPUT-FORMAT" ),
      makeKeyword( "STREAM" ), makeKeyword( "RUN-TINY-KB-TESTS-IN-FULL-KB?" ) );
  ...
  public static final SubLList $list132 = list( list( makeSymbol( "CYC-TEST-FILE" ), makeSymbol( "&OPTIONAL" ), list( makeSymbol( "MESSAGE" ), makeString( "Iterating over all test files" ) ) ), makeSymbol( "&BODY" ),
      makeSymbol( "BODY" ) );
  ...
  public static final SubLList $list155 = list( new SubLObject[] { makeSymbol( "PATH" ), makeSymbol( "&KEY" ), list( makeSymbol( "STREAM" ), list( makeSymbol( "QUOTE" ), makeSymbol( "*STANDARD-OUTPUT*" ) ) ), list(
      makeSymbol( "VERBOSITY" ), makeKeyword( "TERSE" ) ), list( makeSymbol( "STOP-AT-FIRST-FAILURE?" ), NIL ), list( makeSymbol( "OUTPUT-FORMAT" ), makeKeyword( "STANDARD" ) ), list( makeSymbol(
          "RUN-TINY-KB-TESTS-IN-FULL-KB?" ), list( makeSymbol( "QUOTE" ), makeSymbol( "*RUN-TINY-KB-TESTS-IN-FULL-KB?*" ) ) ), list( makeSymbol( "RUN-TEST-CASE-TABLES?" ), T ), list( makeSymbol( "RETURN-TEST-RUNS?" ),
              NIL ), list( makeSymbol( "TYPE" ), makeKeyword( "ALL" ) ), list( makeSymbol( "RUN-NON-WORKING-TESTS" ), NIL )
  } );
  public static final SubLList $list156 = list( new SubLObject[] { makeKeyword( "STREAM" ), makeKeyword( "VERBOSITY" ), makeKeyword( "STOP-AT-FIRST-FAILURE?" ), makeKeyword( "OUTPUT-FORMAT" ), makeKeyword(
      "RUN-TINY-KB-TESTS-IN-FULL-KB?" ), makeKeyword( "RUN-TEST-CASE-TABLES?" ), makeKeyword( "RETURN-TEST-RUNS?" ), makeKeyword( "TYPE" ), makeKeyword( "RUN-NON-WORKING-TESTS" )
  } );
  ...
  public static final SubLList $list163 = list( makeSymbol( "&KEY" ), list( makeSymbol( "STREAM" ), list( makeSymbol( "QUOTE" ), makeSymbol( "*STANDARD-OUTPUT*" ) ) ), list( makeSymbol( "VERBOSITY" ), makeKeyword(
      "VERBOSE" ) ), list( makeSymbol( "STOP-AT-FIRST-FAILURE?" ), NIL ), list( makeSymbol( "OUTPUT-FORMAT" ), makeKeyword( "STANDARD" ) ), list( makeSymbol( "RETURN-TEST-RUNS?" ), NIL ), list( makeSymbol( "TYPE" ),
          makeKeyword( "ALL" ) ), list( makeSymbol( "RUN-NON-WORKING-TESTS" ), NIL ) );
  public static final SubLList $list164 = list( makeKeyword( "STREAM" ), makeKeyword( "VERBOSITY" ), makeKeyword( "STOP-AT-FIRST-FAILURE?" ), makeKeyword( "OUTPUT-FORMAT" ), makeKeyword( "RETURN-TEST-RUNS?" ),
      makeKeyword( "TYPE" ), makeKeyword( "RUN-NON-WORKING-TESTS" ) );
  ...
  public static final SubLList $list170 = list( new SubLObject[] { makeSymbol( "NAMES" ), makeSymbol( "&KEY" ), list( makeSymbol( "STREAM" ), list( makeSymbol( "QUOTE" ), makeSymbol( "*STANDARD-OUTPUT*" ) ) ), list(
      makeSymbol( "VERBOSITY" ), makeKeyword( "VERBOSE" ) ), list( makeSymbol( "STOP-AT-FIRST-FAILURE?" ), NIL ), list( makeSymbol( "OUTPUT-FORMAT" ), makeKeyword( "STANDARD" ) ), list( makeSymbol( "RETURN-TEST-RUNS?" ),
          NIL ), list( makeSymbol( "TYPE" ), makeKeyword( "ALL" ) ), list( makeSymbol( "RUN-NON-WORKING-TESTS" ), NIL )
  } );
  ...
  public static final SubLList $list206 = list( new SubLObject[] { makeKeyword( "CANONICALIZE-INFERENCE-ANSWER-JUSTIFICATIONS" ), makeKeyword( "NON-EXPLANATORY-SENTENCE-SUPPORTS" ), makeKeyword(
      "NON-EXPLANATORY-VARIABLE-MAP-SUPPORTS" ), makeKeyword( "TRUE-SENTENCE-NOT-CANONICALIZATION" ), makeKeyword( "TRUE-SENTENCE-OF-ATOMIC-SENTENCE-REDUCTION" ), makeKeyword( "IST-OF-ATOMIC-SENTENCE-REDUCTION" ),
    makeKeyword( "RELATION-ALL-INSTANCE-ITERATE-2" ), makeKeyword( "RELATION-INSTANCE-ALL-ITERATE-2" ), makeKeyword( "REJECT-PREVIOUSLY-PROVEN-PROOFS" ), makeKeyword( "INFERENCE-HARNESS-OVERHEAD" ), makeKeyword(
        "TACTICALLY-UNEXAMINED-NO-GOOD-IMPLIES-STRATEGICALLY-UNEXAMINED-NO-GOOD" ), makeKeyword( "THE-SET-OF-ELEMENTS-RETURNS-HL-NARTS" ), makeKeyword( "THE-COLLECTION-OF-INSTANCES-RETURNS-HL-NARTS" ), makeKeyword(
            "GENLPREDS-LOOKUP-GENERATES-CORRECT-SUPPORTS" ), makeKeyword( "KAPPA-REMOVAL-WORKS" ), makeKeyword( "DONT-REOPEN-ANSWER-LINK" ), makeKeyword( "REMOVAL-TRUE-SENTENCE-UNIVERSAL-DISJUNCTION-14A" ), makeKeyword(
                "CLOSED-ASENT-WITH-3-CHILDREN" ), makeKeyword( "SIMPLE-EXCEPT-WHEN" ), makeKeyword( "SIMPLE-EXCEPT-WHEN-RESIDUAL-TRANSFORMATION" ), makeKeyword( "PARTIAL-EXCEPT-WHEN" ), makeKeyword(
                    "VARIABLE-MAP-EXCEPT-WHEN" ), makeKeyword( "TRUE-SENTENCE-IMPLIES-VAR-CANONICALIZATION" ), makeKeyword( "EXCEPTION-TMS-BACKWARD-NO-OP" ), makeKeyword(
                        "MULTIPLE-TRANSFORMATION-PROOFS-FOR-CLOSED-PROBLEM" ), makeKeyword( "BACKCHAIN-TO-REMOVAL-TRUE-SENTENCE-UNIVERSAL-DISJUNCTION-1" ), makeKeyword(
                            "BACKCHAIN-TO-REMOVAL-TRUE-SENTENCE-UNIVERSAL-DISJUNCTION-2" ), makeKeyword( "BACKCHAIN-TO-REMOVAL-TRUE-SENTENCE-UNIVERSAL-DISJUNCTION-3" ), makeKeyword(
                                "COLLECTION-ISA-BACKCHAIN-REQUIRED-4" ), makeKeyword( "COLLECTION-GENLS-BACKCHAIN-REQUIRED-4" ), makeKeyword( "COLLECTION-BACKCHAIN-REQUIRED-3" ), makeKeyword(
                                    "COLLECTION-BACKCHAIN-REQUIRED-4" ), makeKeyword( "EARLY-REMOVAL-OF-8-RESTRICTED-PROBLEMS-REQUIRING-TRANSFORMATION" ), makeKeyword(
                                        "EARLY-NEW-ROOT-OF-9-RESTRICTED-PROBLEMS-REQUIRING-TRANSFORMATION" ), makeKeyword( "FORWARD-INDETERMINATE-RESULT" ), makeKeyword( "SIMPLE-FORWARD-PRAGMATIC-REQUIREMENT" ),
    makeKeyword( "SIMPLE-FORWARD-PRAGMATIC-REQUIREMENT-SUPPORTS" ), makeKeyword( "NART-ISA-IN-RIGHT-MT" ), makeKeyword( "FORWARD-PROBLEM-STORE-DESTRUCTION-ON-CONFLICT" ), makeKeyword(
        "FORWARD-RULE-CONCLUDING-CONSEQUENT-IN-WRONG-MT" ), makeKeyword( "SKOLEMIZE-FORWARD" ), makeKeyword( "FORWARD-INFERENCE-WITH-DEFNS" ), makeKeyword( "COMPLETENESS-IN-LOW-MT-DOESNT-HOSE-FORWARD-INFERENCE" ),
    makeKeyword( "HYPOTHETICAL-MT-COMPLETENESS-ASSERTION-DOESNT-HOSE-FORWARD-INFERENCE" ), makeKeyword( "EXCEPT-MT-IN-MID-MT-BLOCKS-HIGH-MT-FROM-LOW-MT" ), makeKeyword( "EXCEPT-MT-IN-HIGH-MT-HOSES-BACKWARD-INFERENCE" ),
    makeKeyword( "CYC-ASSERT-WITH-REIFIABLE-MONAD-MT" ), makeKeyword( "FORWARD-RULE-CONCLUDING-FALSE" ), makeKeyword( "SKOLEM-RESULT-ARG" ), makeKeyword( "UNASSERT-REIFIABLE-NAT-MT" ), makeKeyword(
        "UNASSERT-NART-MT-SENTENCE-WITH-NART" ), makeKeyword( "UNASSERT-REIFIABLE-NAT-MT-VIA-TL" ), makeKeyword( "CANONICALIZE-NESTED-MT" ), makeKeyword( "FUNCTION-TEST" ), makeKeyword( "NAT-REMOVAL" ), makeKeyword(
            "RESULTTYPE-CHANGE" ), makeKeyword( "META-ASSERTION-REMOVAL" ), makeKeyword( "ARG-TYPE-MT-DENOTING-FUNCTION" ), makeKeyword( "MAX-FLOOR-MTS-OF-NAT" ), makeKeyword(
                "CONTEXTUALIZED-COLLECTION-SPECPRED-OF-ISA" ), makeKeyword( "USE-DEFNS-TO-CHECK-INFERENCE-SEMANTICALLY-VALID-DNF" ), makeKeyword( "SBHL-TRUMPS-DEFNS" ), makeKeyword(
                    "SKOLEMIZE-FORWARD-NAUT-GENL-MT-WFF-EXCEPTION" ), makeKeyword( "ONE-STEP" ), makeKeyword( "TWO-STEP" ), makeKeyword( "TWO-STEP" ), makeKeyword( "TWO-STEP-ARG-1" ), makeKeyword( "TWO-STEP-ARG-1" ),
    makeKeyword( "MANY-STEP" ), makeKeyword( "CROSS-MT" ), makeKeyword( "DISJUNCTIVE-SYLLOGISM" ), makeKeyword( "ARGUMENTATION" ), makeKeyword( "TMS-LOOP" ), makeKeyword( "RECONSIDER-DEDUCTION" ), makeKeyword(
        "RECONSIDER-DEDUCTION" ), makeKeyword( "HL-SUPPORT-MT-HANDLING" ), makeKeyword( "THERE-EXISTS" ), makeKeyword( "EXCEPT-WHEN" ), makeKeyword( "EXCEPT-WHEN" ), makeKeyword( "STRENGTH-PROPAGATION" ), makeKeyword(
            "SEQUENCE-VARIABLES-INFERENCE" ), makeKeyword( "INFERENCE-ANSWER-TEMPLATE" ), makeKeyword( "FORWARD-PROPAGATE-MT" ), makeKeyword( "FORWARD-PROPAGATE-MT-CONTINUE" ), makeKeyword(
                "IST-TRIGGERS-FORWARD-INFERENCE-SIMPLE" ), makeKeyword( "FORWARD-NON-TRIGGER-LITERAL-HONORED" ), makeKeyword( "EXCEPT-BLOCKS-BACKWARD" ), makeKeyword( "EXCEPT-BLOCKS-FORWARD" ), makeKeyword(
                    "TRUE-SENTENCE-UNIVERSAL-DISJUNCTION-SCOPING" ), makeKeyword( "TMS-RECONSIDERATION-WITH-BACKCHAIN-FORBIDDEN" ), makeKeyword( "TMS-FOR-HL-SUPPORTS" ), makeKeyword( "ASSERTION-DIRECTION" ), makeKeyword(
                        "MERGE-IGNORES-OPAQUE-REFERENCES" ), makeKeyword( "MT-FLOORS-WRT-ISA-PATHS" ), makeKeyword( "MIN-GENL-MTS" ), makeKeyword( "MIN-GENL-PREDICATES" ), makeKeyword( "MIN-GENLS-COLLECTION" ),
    makeKeyword( "SPLIT-NO-GOODNESS-PROPAGATION" ), makeKeyword( "LAZILY-MANIFEST-NON-FOCALS" ), makeKeyword( "CONSIDER-NO-GOOD-AFTER-DETERMINING-TACTICS" ), makeKeyword( "REMOVAL-ALL-ISA-OF-TYPE-2" ), makeKeyword(
        "AVOID-LOOKUP-ON-INDETERMINATES" ), makeKeyword( "IRRELEVANT-DOES-NOT-IMPLY-PENDING" ), makeKeyword( "ASSERTED-INSTANCE-OF-DISJOINT-COLLECTIONS" ), makeKeyword( "CHAINING-SKOLEM-STRAIGHTFORWARD" ), makeKeyword(
            "CHAINING-SKOLEM-SHALLOW" ), makeKeyword( "CHAINING-SKOLEM-DEEP" ), makeKeyword( "CHAINING-SKOLEM" ), makeKeyword( "EXCEPT-DECONTEXTUALIZED" ), makeKeyword( "PROBLEM-STORE-PRUNING-MAX-INSUFFICIENT" ),
    makeKeyword( "RESTRICTED-CLOSED-GOOD-PROBLEMS-STAY-UNEXAMINED" ), makeKeyword( "GENLS-BETWEEN" ), makeKeyword( "CONJUNCTIVE-INTEGER-BETWEEN-1" ), makeKeyword( "CONJUNCTIVE-INTEGER-BETWEEN-2" ), makeKeyword(
        "CONJUNCTIVE-INTEGER-BETWEEN-3" ), makeKeyword( "CONJUNCTIVE-INTEGER-BETWEEN-4" ), makeKeyword( "CONJUNCTIVE-INTEGER-BETWEEN-5" ), makeKeyword( "CONJUNCTIVE-INTEGER-BETWEEN-6" ), makeKeyword(
            "CONJUNCTIVE-INTEGER-BETWEEN-7" ), makeKeyword( "CONJUNCTIVE-INTEGER-BETWEEN-8" ), makeKeyword( "CONJUNCTIVE-FOLLOWUP-ADDITIONAL-JOIN-ORDERED" ), makeKeyword(
                "CONJUNCTIVE-FOLLOWUP-ADDITIONAL-JOIN-ORDERED-WITHOUT-INFERENCE" ), makeKeyword( "CIRCULAR-PROOFS" )
  } );
