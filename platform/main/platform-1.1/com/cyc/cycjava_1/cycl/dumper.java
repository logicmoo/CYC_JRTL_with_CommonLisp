      ...
      SubLTranslatedFile
{
  ...
  {
    $force_monolithic_kb_assumption$ = deflexical( "*FORCE-MONOLITHIC-KB-ASSUMPTION*", ( ( NIL != Symbols.boundp( $sym0$_FORCE_MONOLITHIC_KB_ASSUMPTION_ ) ) ? ( (SubLObject) $force_monolithic_kb_assumption$
        .getGlobalValue() ) : NIL ) );
