...
string-trigraph-match-p, which is defined below. */
  ...
  public static final SubLObject declare_string_utilities_file() {
    ...
    declareFunction("not_digit_char_p", "NOT-DIGIT-CHAR-P", 1, 0, false); new $not_digit_char_p$UnaryFunction();
    ...
    //declareFunction("string_wXo_control_charsP", "STRING-W/O-CONTROL-CHARS?", 1, 0, false); new $string_wXo_control_charsP$UnaryFunction();
    ...
    //declareFunction("char_in_char_set", "CHAR-IN-CHAR-SET", 1, 0, false); new $char_in_char_set$UnaryFunction();
    ...
    declareFunction("whitespacep", "WHITESPACEP", 1, 0, false); new $whitespacep$UnaryFunction();
    ...
    //declareFunction("cyclify_status_p", "CYCLIFY-STATUS-P", 1, 0, false); new $cyclify_status_p$UnaryFunction();
