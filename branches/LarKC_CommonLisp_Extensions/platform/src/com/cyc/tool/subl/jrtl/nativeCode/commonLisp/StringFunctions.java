...
public final class StringFunctions {
	 ...
	 */
	static final StringIndicesAndChars stringIndicesAndChars(SubLObject... params) {
	 ...
	 *  Description of the Method
	 *
	 * @param  indicesAndChars  Description of Parameter
	 * @return                  Description of the Returned Value
	 */
	static final int notEqual(StringIndicesAndChars indicesAndChars) {
		...
		while (true) {
			...
			if (upcaseIfNeeded(indicesAndChars.array1[i], indicesAndChars.convertCase) != upcaseIfNeeded(
					indicesAndChars.array2[j], indicesAndChars.convertCase)) {
				return i;
			}
			++i;
			++j;
	...
	static final int lessThan(StringIndicesAndChars indicesAndChars) {
		...
		while (true) {
			...
			char c1 = upcaseIfNeeded(indicesAndChars.array1[i], indicesAndChars.convertCase);
			char c2 = upcaseIfNeeded(indicesAndChars.array2[j], indicesAndChars.convertCase);
			if (c1 == c2) {
				++i;
				++j;
				continue;
	...
	private static final void checkParams(StringIndicesAndChars indicesAndChars) {
		if (indicesAndChars.start1 < 0 || indicesAndChars.start1 > indicesAndChars.array1.length) {
			error(new TypeError("Invalid start position " + indicesAndChars.start1 + "."));
		}
		if (indicesAndChars.end1 < 0 || indicesAndChars.end1 > indicesAndChars.array1.length) {
			error(new TypeError("Invalid end position " + indicesAndChars.end1 + "."));
		}

		if (indicesAndChars.start1 > indicesAndChars.end1) {
			error(new TypeError("Start (" + indicesAndChars.start1 + ") is greater than end (" + indicesAndChars.end1 + ")."));
		}
		if (indicesAndChars.array2 != null) {
			if (indicesAndChars.start2 < 0 || indicesAndChars.start2 > indicesAndChars.array2.length) {
				error(new TypeError("Invalid start2 position " + indicesAndChars.start2 + "."));
			}
			if (indicesAndChars.end2 < 0 || indicesAndChars.end2 > indicesAndChars.array2.length) {
				error(new TypeError("Invalid end2 position " + indicesAndChars.end2 + "."));
			}
			if (indicesAndChars.start2 > indicesAndChars.end2) {
				error(new TypeError("Start2 (" + indicesAndChars.start2 + ") is greater than end2 (" + indicesAndChars.end2
						+ ")."));
			}
		}
	}
	 ...
	 * @param  convert  Description of Parameter
	 * @return          Description of the Returned Value
	 */
	 ...
	 * @author    Administrator
	 */
	private static final class pf___string_equal extends JavaPrimitive {
		 ...
		 *  Description of the Method
		 *
		 * @param  string1  Description of Parameter
		 * @param  string2  Description of Parameter
		 * @return          Description of the Returned Value
		 */
		public SubLObject execute(SubLObject string1, SubLObject string2) {
			return pf___string_equal_execute(string1, string2);
		}
	}
	...
	public SubLObject pf___string_equal_execute(SubLObject string1, SubLObject string2) {
		StringIndicesAndChars chars = stringIndicesAndChars(string1, string2);
		return Arrays.equals(chars.array1, chars.array2) ? T : NIL;
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_equal extends JavaPrimitive {
		 ...
		 * @param  string1  Description of Parameter
		 * @param  string2  Description of Parameter
		 * @param  start1   Description of Parameter
		 * @param  end1     Description of Parameter
		 * @param  start2   Description of Parameter
		 * @param  end2     Description of Parameter
		 * @return          Description of the Returned Value
		 */
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
			...
			return pf__string_equal_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_equal_execute(SubLObject string1, SubLObject string2, SubLObject start1,
			SubLObject end1, SubLObject start2, SubLObject end2) {
		return (_STRING_NOT_EQUAL.execute(string1, string2, start1, end1, start2, end2) == NIL) ? T : NIL;
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_not_equal extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_not_equal_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_not_equal_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string1, string2, start1, end1, start2, end2);
		int tmp = notEqual(indicesAndChars);
		return (tmp >= 0) ? LispObjectFactory.makeInteger(tmp) : NIL;
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_equal_ignore_case extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_equal_ignore_case_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_equal_ignore_case_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
		return (_STRING_NOT_EQUAL_IGNORE_CASE.execute(string1, string2, start1, end1, start2, end2) == NIL) ? T : NIL;
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_not_equal_ignore_case extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_not_equal_ignore_case_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_not_equal_ignore_case_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string1, string2, start1, end1, start2, end2);
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_less_than extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_less_than_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_less_than_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string1, string2, start1, end1, start2, end2);
		int retVal = lessThan(indicesAndChars);
		return (retVal >= 0) ? LispObjectFactory.makeInteger(retVal) : NIL;
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_greater_than extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_greater_than_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_greater_than_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
		// note the swap of the strings and lengths here..
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string2, string1, start2, end2, start1, end1);
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_le extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_le_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_le_execute(SubLObject string1, SubLObject string2, SubLObject start1,
			SubLObject end1, SubLObject start2, SubLObject end2) {
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_ge extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_ge_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_ge_execute(SubLObject string1, SubLObject string2, SubLObject start1,
			SubLObject end1, SubLObject start2, SubLObject end2) {
		// note the swap of the strings and lengths here..
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string2, string1, start2, end2, start1, end1);
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_lessp extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_lessp_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_lessp_execute(SubLObject string1, SubLObject string2, SubLObject start1,
			SubLObject end1, SubLObject start2, SubLObject end2) {
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string1, string2, start1, end1, start2, end2);
		indicesAndChars.convertCase = true;
		int retVal = lessThan(indicesAndChars);
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_greaterp extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_greaterp_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_greaterp_execute(SubLObject string1, SubLObject string2, SubLObject start1,
			SubLObject end1, SubLObject start2, SubLObject end2) {
		// note the swap of the strings and lengths here..
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string2, string1, start2, end2, start1, end1);
		indicesAndChars.convertCase = true;
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_not_lessp extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_not_lessp_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_not_lessp_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
		// note the swap of the strings and lengths here..
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string2, string1, start2, end2, start1, end1);
		indicesAndChars.convertCase = true;
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_not_greaterp extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string1, SubLObject string2, SubLObject start1, SubLObject end1,
				SubLObject start2, SubLObject end2) {
			return pf__string_not_greaterp_execute(string1, string2, start1, end1, start2, end2);
		}
	}

	@InlinableMethod
	static final public SubLObject pf__string_not_greaterp_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string1, string2, start1, end1, start2, end2);
		indicesAndChars.convertCase = true;
		int tmp = lessThanOrEqual(indicesAndChars);
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_upcase extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject string, SubLObject start, SubLObject end) {
			return pf__string_upcase_execute(string, start, end);
		}
	}
	...
	public SubLObject pf__string_upcase_execute(SubLObject string, SubLObject start, SubLObject end) {
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string, start, end);
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_downcase extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject string, SubLObject start, SubLObject end) {
			return pf__string_downcase_execute(string, start, end);
		}
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf__string_capitalize extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject string, SubLObject start, SubLObject end) {
			return pf__string_capitalize_execute(string, start, end);
		}
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf__nstring_upcase extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject string, SubLObject start, SubLObject end) {
			return pf__nstring_upcase_execute(string, start, end);
		}
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf__nstring_downcase extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject string, SubLObject start, SubLObject end) {
			return pf__nstring_downcase_execute(string, start, end);
		}
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf__nstring_capitalize extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject string, SubLObject start, SubLObject end) {
			return pf__nstring_capitalize_execute(string, start, end);
		}
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf_stringp extends JavaPrimitive {
	 ...
	 * @author    Administrator
	 */
	private static final class pf_simple_string_p extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject arg) {
			return pf_simple_string_p_execute(arg);
		}
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf__make_string extends JavaPrimitive {
		 ...
		 * @param  initialElement  Description of Parameter
		...
		public SubLObject execute(SubLObject size, SubLObject initialElement, SubLObject elementType) {
			return pf__make_string_execute(size, initialElement, elementType);
		}
	}
	...
	public SubLObject pf__make_string_execute(SubLObject size, SubLObject initialElement, SubLObject elementType) {
		...
		// Ignore elementType.
		SubLString string = makeString(n);
	 ...
	 * @author    Administrator
	 */
	private static final class pf_char extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject first, SubLObject second) {
			return pf_char_execute(first, second);
		}
	}

	@InlinableMethod
	static final public SubLObject pf_char_execute(SubLObject first, SubLObject second) {
	 ...
	 * @author    Administrator
	 */
	private static final class pf_schar extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return pf_schar_execute(first, second);
		}
	}

	@InlinableMethod
	static final public SubLObject pf_schar_execute(SubLObject first, SubLObject second) {
	 ...
	 * @author    Administrator
	 */
	private static final class pf_set_char extends JavaPrimitive {
		...
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return pf_set_char_execute(first, second, third);
		}
	}
	...
	public SubLObject pf_set_char_execute(SubLObject first, SubLObject second, SubLObject third) {
		checkString(first).setChar(second.intValue(), third.charValue());
		return third;
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf_set_schar extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return pf_set_schar_execute(first, second, third);
		}
	}
	...
	public SubLObject pf_set_schar_execute(SubLObject first, SubLObject second, SubLObject third) {
		...
		return type_error(first, LispSymbols.SIMPLE_STRING);
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf_string_position extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
			return pf_string_position_execute(first, second, third);
		}
	}
	...
	public SubLObject pf_string_position_execute(SubLObject first, SubLObject second, SubLObject third) {
		...
		SubLString string = checkString(second);
	 ...
	 * @author    Administrator
	 */
	private static final class pf_string_find extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return pf_string_find_execute(first, second);
		}
	}

	@InlinableMethod
	static final public SubLObject pf_string_find_execute(SubLObject first, SubLObject second) {
	 ...
	 * @author    Administrator
	 */
	private static final class pf_simple_string_search extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return pf_simple_string_search_execute(first, second);
		}
	}

	@InlinableMethod
	static final public SubLObject pf_simple_string_search_execute(SubLObject first, SubLObject second) {
		// FIXME Don't call getStringValue() here! (Just look at the chars.)
		int index = second.getString().indexOf(first.getString());
		return index >= 0 ? LispObjectFactory.makeInteger(index) : NIL;
	}
	 ...
	 * @author    Administrator
	 */
	private static final class pf_string_fill extends JavaPrimitive {
		 ...
		 */
		public SubLObject execute(SubLObject first, SubLObject second) {
			return pf_string_fill_execute(first, second);
		}
	}

	@InlinableMethod
	static final public SubLObject pf_string_fill_execute(SubLObject first, SubLObject second) {
