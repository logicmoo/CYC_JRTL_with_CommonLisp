...
public final class BigDecimalFloat extends LispFloat
{
    public static final BigDecimalFloat ZERO       = new BigDecimalFloat(0);
    public static final BigDecimalFloat MINUS_ZERO = new BigDecimalFloat(-0.0d);
    public static final BigDecimalFloat ONE        = new BigDecimalFloat(1);
    public static final BigDecimalFloat MINUS_ONE  = new BigDecimalFloat(-1);

    public static final BigDecimalFloat DOUBLE_FLOAT_POSITIVE_INFINITY =
        makeDouble(Double.POSITIVE_INFINITY);

    public static final BigDecimalFloat DOUBLE_FLOAT_NEGATIVE_INFINITY =
    ...
    public boolean eql(SubLObject obj)
    {
        ...
        if (obj instanceof BigDecimalFloat) {
            ...
            if (value == ((BigDecimalFloat)obj).value)
                return true;
        }
        return false;
    }
    ...
    public boolean equalp(SubLObject obj)
    {
        ...
        if (obj instanceof BigDecimalFloat)
            return value == ((BigDecimalFloat)obj).value;
...
//    }
    ...
    public SubLObject add(SubLObject obj)
    {
        ...
        if (obj instanceof BigDecimalFloat)
            return makeDouble(value + ((BigDecimalFloat)obj).value);
        if (obj instanceof Bignum)
