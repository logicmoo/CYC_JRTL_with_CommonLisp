...
public final class SimpleArray_T extends AbstractSimpleArray
{
  ...
  public SimpleArray_T(final int[] dimv, final SubLObject[] initialData,
          final SubLObject elementType) {
      this.dimv = dimv;
      this.elementType = elementType;
