...
public  final class search extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_search_file() {
    declareFunction(myName, "search_struc_print_function_trampoline", "SEARCH-STRUC-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    //declareFunction(myName, "search_struc_p", "SEARCH-STRUC-P", 1, 0, false); new $search_struc_p$UnaryFunction();
    //declareFunction(myName, "search_tree", "SEARCH-TREE", 1, 0, false);
    //declareFunction(myName, "search_leaves", "SEARCH-LEAVES", 1, 0, false);
    //declareFunction(myName, "search_goals", "SEARCH-GOALS", 1, 0, false);
    //declareFunction(myName, "search_no_leaves_p_func", "SEARCH-NO-LEAVES-P-FUNC", 1, 0, false);
    //declareFunction(myName, "search_next_node_func", "SEARCH-NEXT-NODE-FUNC", 1, 0, false);
    //declareFunction(myName, "search_goal_p_func", "SEARCH-GOAL-P-FUNC", 1, 0, false);
    //declareFunction(myName, "search_add_goal_func", "SEARCH-ADD-GOAL-FUNC", 1, 0, false);
    //declareFunction(myName, "search_options_func", "SEARCH-OPTIONS-FUNC", 1, 0, false);
    //declareFunction(myName, "search_expand_func", "SEARCH-EXPAND-FUNC", 1, 0, false);
    //declareFunction(myName, "search_add_node_func", "SEARCH-ADD-NODE-FUNC", 1, 0, false);
    //declareFunction(myName, "search_too_deep_func", "SEARCH-TOO-DEEP-FUNC", 1, 0, false);
    //declareFunction(myName, "search_state", "SEARCH-STATE", 1, 0, false);
    //declareFunction(myName, "search_print_func", "SEARCH-PRINT-FUNC", 1, 0, false);
    //declareFunction(myName, "search_limbo", "SEARCH-LIMBO", 1, 0, false);
    //declareFunction(myName, "search_current_node", "SEARCH-CURRENT-NODE", 1, 0, false);
    //declareFunction(myName, "_csetf_search_tree", "_CSETF-SEARCH-TREE", 2, 0, false);
    //declareFunction(myName, "_csetf_search_leaves", "_CSETF-SEARCH-LEAVES", 2, 0, false);
    //declareFunction(myName, "_csetf_search_goals", "_CSETF-SEARCH-GOALS", 2, 0, false);
    //declareFunction(myName, "_csetf_search_no_leaves_p_func", "_CSETF-SEARCH-NO-LEAVES-P-FUNC", 2, 0, false);
    //declareFunction(myName, "_csetf_search_next_node_func", "_CSETF-SEARCH-NEXT-NODE-FUNC", 2, 0, false);
    //declareFunction(myName, "_csetf_search_goal_p_func", "_CSETF-SEARCH-GOAL-P-FUNC", 2, 0, false);
    //declareFunction(myName, "_csetf_search_add_goal_func", "_CSETF-SEARCH-ADD-GOAL-FUNC", 2, 0, false);
    //declareFunction(myName, "_csetf_search_options_func", "_CSETF-SEARCH-OPTIONS-FUNC", 2, 0, false);
    //declareFunction(myName, "_csetf_search_expand_func", "_CSETF-SEARCH-EXPAND-FUNC", 2, 0, false);
    //declareFunction(myName, "_csetf_search_add_node_func", "_CSETF-SEARCH-ADD-NODE-FUNC", 2, 0, false);
    //declareFunction(myName, "_csetf_search_too_deep_func", "_CSETF-SEARCH-TOO-DEEP-FUNC", 2, 0, false);
    //declareFunction(myName, "_csetf_search_state", "_CSETF-SEARCH-STATE", 2, 0, false);
    //declareFunction(myName, "_csetf_search_print_func", "_CSETF-SEARCH-PRINT-FUNC", 2, 0, false);
    //declareFunction(myName, "_csetf_search_limbo", "_CSETF-SEARCH-LIMBO", 2, 0, false);
    //declareFunction(myName, "_csetf_search_current_node", "_CSETF-SEARCH-CURRENT-NODE", 2, 0, false);
    //declareFunction(myName, "make_search_struc", "MAKE-SEARCH-STRUC", 0, 1, false);
    //declareFunction(myName, "print_search", "PRINT-SEARCH", 3, 0, false);
    //declareFunction(myName, "make_static_search_struc", "MAKE-STATIC-SEARCH-STRUC", 0, 0, false);
    //declareFunction(myName, "init_search_struc", "INIT-SEARCH-STRUC", 1, 0, false);
    //declareFunction(myName, "free_search_struc_p", "FREE-SEARCH-STRUC-P", 1, 0, false);
    //declareFunction(myName, "free_search_struc", "FREE-SEARCH-STRUC", 1, 0, false);
    //declareFunction(myName, "get_search_struc", "GET-SEARCH-STRUC", 0, 0, false);
    //declareFunction(myName, "new_search", "NEW-SEARCH", 8, 2, false);
    declareFunction(myName, "search_node_print_function_trampoline", "SEARCH-NODE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    //declareFunction(myName, "search_node_p", "SEARCH-NODE-P", 1, 0, false); new $search_node_p$UnaryFunction();
    //declareFunction(myName, "snode_search", "SNODE-SEARCH", 1, 0, false);
    //declareFunction(myName, "snode_parent", "SNODE-PARENT", 1, 0, false);
    //declareFunction(myName, "snode_children", "SNODE-CHILDREN", 1, 0, false);
    //declareFunction(myName, "snode_depth", "SNODE-DEPTH", 1, 0, false);
    //declareFunction(myName, "snode_options", "SNODE-OPTIONS", 1, 0, false);
    //declareFunction(myName, "snode_state", "SNODE-STATE", 1, 0, false);
    //declareFunction(myName, "_csetf_snode_search", "_CSETF-SNODE-SEARCH", 2, 0, false);
    //declareFunction(myName, "_csetf_snode_parent", "_CSETF-SNODE-PARENT", 2, 0, false);
    //declareFunction(myName, "_csetf_snode_children", "_CSETF-SNODE-CHILDREN", 2, 0, false);
    //declareFunction(myName, "_csetf_snode_depth", "_CSETF-SNODE-DEPTH", 2, 0, false);
    //declareFunction(myName, "_csetf_snode_options", "_CSETF-SNODE-OPTIONS", 2, 0, false);
    //declareFunction(myName, "_csetf_snode_state", "_CSETF-SNODE-STATE", 2, 0, false);
    //declareFunction(myName, "make_search_node", "MAKE-SEARCH-NODE", 0, 1, false);
    //declareFunction(myName, "print_snode", "PRINT-SNODE", 3, 0, false);
    //declareFunction(myName, "make_static_search_node", "MAKE-STATIC-SEARCH-NODE", 0, 0, false);
    //declareFunction(myName, "init_search_node", "INIT-SEARCH-NODE", 1, 0, false);
    //declareFunction(myName, "free_search_node_p", "FREE-SEARCH-NODE-P", 1, 0, false);
    //declareFunction(myName, "free_search_node", "FREE-SEARCH-NODE", 1, 0, false);
    //declareFunction(myName, "get_search_node", "GET-SEARCH-NODE", 0, 0, false);
    //declareFunction(myName, "free_entire_search_node", "FREE-ENTIRE-SEARCH-NODE", 1, 1, false);
    //declareFunction(myName, "dead_end_nodeP", "DEAD-END-NODE?", 1, 0, false);
    //declareFunction(myName, "reclaim_search_node", "RECLAIM-SEARCH-NODE", 1, 0, false);
    //declareFunction(myName, "interrupt_generic_search", "INTERRUPT-GENERIC-SEARCH", 0, 0, false);
    //declareFunction(myName, "abort_generic_search", "ABORT-GENERIC-SEARCH", 0, 0, false);
    //declareMacro(myName, "do_generic_search", "DO-GENERIC-SEARCH");
    //declareFunction(myName, "generic_search", "GENERIC-SEARCH", 1, 3, false);
    //declareFunction(myName, "generic_search_reclaim_node", "GENERIC-SEARCH-RECLAIM-NODE", 1, 0, false);
    //declareFunction(myName, "generic_search_link_child_to_parent", "GENERIC-SEARCH-LINK-CHILD-TO-PARENT", 2, 0, false);
    //declareFunction(myName, "reset_search_node_state", "RESET-SEARCH-NODE-STATE", 2, 0, false);
    //declareFunction(myName, "new_search_node", "NEW-SEARCH-NODE", 1, 0, false);
    //declareFunction(myName, "new_search_start_node", "NEW-SEARCH-START-NODE", 1, 0, false);
    //declareFunction(myName, "register_search_start_node", "REGISTER-SEARCH-START-NODE", 2, 0, false);
    //declareFunction(myName, "add_search_start_node", "ADD-SEARCH-START-NODE", 2, 0, false);
    //declareFunction(myName, "remove_search_start_node", "REMOVE-SEARCH-START-NODE", 2, 0, false);
    //declareFunction(myName, "reconsider_limbo", "RECONSIDER-LIMBO", 2, 0, false);
    //declareFunction(myName, "valid_snode_options", "VALID-SNODE-OPTIONS", 1, 0, false);
    //declareFunction(myName, "set_valid_snode_options", "SET-VALID-SNODE-OPTIONS", 2, 0, false);
    //declareFunction(myName, "doomed_search_nodeP", "DOOMED-SEARCH-NODE?", 1, 0, false);
    //declareFunction(myName, "mark_node_as_doomed", "MARK-NODE-AS-DOOMED", 1, 0, false);
    //declareFunction(myName, "search_current_path", "SEARCH-CURRENT-PATH", 1, 0, false);
    //declareFunction(myName, "search_current_path_internal", "SEARCH-CURRENT-PATH-INTERNAL", 1, 0, false);
    //declareFunction(myName, "remaining_time_cutoff", "REMAINING-TIME-CUTOFF", 2, 0, false);
    //declareFunction(myName, "search_size", "SEARCH-SIZE", 1, 0, false);
    //declareFunction(myName, "search_node_size", "SEARCH-NODE-SIZE", 1, 0, false);
    return NIL;
  }
