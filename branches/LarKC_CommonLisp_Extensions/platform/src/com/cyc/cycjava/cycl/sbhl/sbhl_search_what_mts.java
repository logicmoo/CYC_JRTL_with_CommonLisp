...
public  final class sbhl_search_what_mts extends SubLTranslatedFile {
  ...
  public static final SubLObject declare_sbhl_search_what_mts_file() {
    //declareMacro(myName, "sbhl_rebind_path_mts", "SBHL-REBIND-PATH-MTS");
    declareFunction(myName, "possibly_update_sbhl_path_mts", "POSSIBLY-UPDATE-SBHL-PATH-MTS", 2, 0, false);
    //declareMacro(myName, "with_new_sbhl_what_mts_marking_spaces", "WITH-NEW-SBHL-WHAT-MTS-MARKING-SPACES");
    declareFunction(myName, "sbhl_primary_what_mts_spaces", "SBHL-PRIMARY-WHAT-MTS-SPACES", 0, 0, false);
    //declareFunction(myName, "sbhl_secondary_what_mts_spaces", "SBHL-SECONDARY-WHAT-MTS-SPACES", 0, 0, false);
    //declareMacro(myName, "within_sbhl_what_mts_spaces", "WITHIN-SBHL-WHAT-MTS-SPACES");
    declareFunction(myName, "get_sbhl_what_mts_marking_space", "GET-SBHL-WHAT-MTS-MARKING-SPACE", 0, 0, false);
    declareFunction(myName, "get_sbhl_what_mts_marking", "GET-SBHL-WHAT-MTS-MARKING", 1, 0, false);
    declareFunction(myName, "sbhl_what_mts_mark_mt_paths_to_node", "SBHL-WHAT-MTS-MARK-MT-PATHS-TO-NODE", 1, 0, false);
    declareFunction(myName, "sbhl_what_mts_marking_subsumes_marking_p", "SBHL-WHAT-MTS-MARKING-SUBSUMES-MARKING-P", 1, 0, false);
    declareFunction(myName, "determine_sbhl_link_mt", "DETERMINE-SBHL-LINK-MT", 2, 0, false);
    //declareFunction(myName, "sbhl_encountered_difficult_naut_mt_generator", "SBHL-ENCOUNTERED-DIFFICULT-NAUT-MT-GENERATOR", 0, 0, false);
    //declareMacro(myName, "with_new_naut_mt_relevance_verification", "WITH-NEW-NAUT-MT-RELEVANCE-VERIFICATION");
    declareFunction(myName, "sbhl_verify_naut_mt_relevance_p", "SBHL-VERIFY-NAUT-MT-RELEVANCE-P", 0, 0, false);
    //declareMacro(myName, "with_sbhl_what_mts_map_function", "WITH-SBHL-WHAT-MTS-MAP-FUNCTION");
    declareFunction(myName, "get_sbhl_what_mts_map_function", "GET-SBHL-WHAT-MTS-MAP-FUNCTION", 0, 0, false);
    declareFunction(myName, "sbhl_what_mts_not_mapping_p", "SBHL-WHAT-MTS-NOT-MAPPING-P", 0, 0, false);
    declareFunction(myName, "sbhl_apply_what_mts_map_function", "SBHL-APPLY-WHAT-MTS-MAP-FUNCTION", 1, 0, false);
    declareFunction(myName, "get_sbhl_what_mts_goal", "GET-SBHL-WHAT-MTS-GOAL", 0, 0, false);
    //declareMacro(myName, "with_sbhl_what_mts_goal", "WITH-SBHL-WHAT-MTS-GOAL");
    declareFunction(myName, "sbhl_what_mts_goal_p", "SBHL-WHAT-MTS-GOAL-P", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_proper_mark_p", "SBHL-WHAT-MTS-PROPER-MARK-P", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_proper_goal_mark_p", "SBHL-WHAT-MTS-PROPER-GOAL-MARK-P", 1, 0, false);
    declareFunction(myName, "sbhl_what_mts_mark_and_sweep", "SBHL-WHAT-MTS-MARK-AND-SWEEP", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_mark_and_sweep_marked_nodes", "SBHL-WHAT-MTS-MARK-AND-SWEEP-MARKED-NODES", 1, 0, false);
    declareFunction(myName, "sbhl_what_mts_step_across_links", "SBHL-WHAT-MTS-STEP-ACROSS-LINKS", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_step_across_marked_links", "SBHL-WHAT-MTS-STEP-ACROSS-MARKED-LINKS", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_step_and_update_links", "SBHL-WHAT-MTS-STEP-AND-UPDATE-LINKS", 1, 0, false);
    declareFunction(myName, "sbhl_what_mts_sweep", "SBHL-WHAT-MTS-SWEEP", 6, 0, false);
    //declareFunction(myName, "sbhl_what_mts_sweep_marked", "SBHL-WHAT-MTS-SWEEP-MARKED", 7, 0, false);
    declareFunction(myName, "sbhl_what_mts_step", "SBHL-WHAT-MTS-STEP", 5, 0, false);
    //declareFunction(myName, "sbhl_what_mts_step_marked", "SBHL-WHAT-MTS-STEP-MARKED", 6, 0, false);
    //declareFunction(myName, "sbhl_what_mts_step_and_update_mts", "SBHL-WHAT-MTS-STEP-AND-UPDATE-MTS", 6, 0, false);
    declareFunction(myName, "sbhl_simple_true_what_mts_search", "SBHL-SIMPLE-TRUE-WHAT-MTS-SEARCH", 1, 0, false);
    //declareFunction(myName, "sbhl_simple_false_what_mts_search", "SBHL-SIMPLE-FALSE-WHAT-MTS-SEARCH", 1, 0, false);
    //declareFunction(myName, "sbhl_false_what_mts_step", "SBHL-FALSE-WHAT-MTS-STEP", 1, 0, false);
    //declareFunction(myName, "sbhl_false_what_mts_sweep", "SBHL-FALSE-WHAT-MTS-SWEEP", 1, 0, false);
    declareFunction(myName, "sbhl_tt_what_mts_search", "SBHL-TT-WHAT-MTS-SEARCH", 1, 0, false);
    declareFunction(myName, "sbhl_what_mts_tt_sweep", "SBHL-WHAT-MTS-TT-SWEEP", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_tt_backward_search", "SBHL-WHAT-MTS-TT-BACKWARD-SEARCH", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_tt_step", "SBHL-WHAT-MTS-TT-STEP", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_premark_disjoins", "SBHL-WHAT-MTS-PREMARK-DISJOINS", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_true_disjoins_search", "SBHL-WHAT-MTS-TRUE-DISJOINS-SEARCH", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_step_across_marked_disjoins", "SBHL-WHAT-MTS-STEP-ACROSS-MARKED-DISJOINS", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_sweep_marked_disjoins", "SBHL-WHAT-MTS-SWEEP-MARKED-DISJOINS", 1, 0, false);
    //declareFunction(myName, "get_sbhl_what_mts_sweep_disjoins_module", "GET-SBHL-WHAT-MTS-SWEEP-DISJOINS-MODULE", 0, 0, false);
    //declareFunction(myName, "sbhl_what_mts_false_disjoins_search", "SBHL-WHAT-MTS-FALSE-DISJOINS-SEARCH", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_sweep_forward_step_and_sweep_false_disjoins", "SBHL-WHAT-MTS-SWEEP-FORWARD-STEP-AND-SWEEP-FALSE-DISJOINS", 1, 0, false);
    //declareFunction(myName, "sbhl_what_mts_sweep_false_disjoins", "SBHL-WHAT-MTS-SWEEP-FALSE-DISJOINS", 1, 0, false);
    declareFunction(myName, "determine_sbhl_what_mts_behavior", "DETERMINE-SBHL-WHAT-MTS-BEHAVIOR", 3, 0, false);
    declareFunction(myName, "get_sbhl_what_mts_behavior", "GET-SBHL-WHAT-MTS-BEHAVIOR", 0, 0, false);
    //declareMacro(myName, "bind_sbhl_what_mts_behavior", "BIND-SBHL-WHAT-MTS-BEHAVIOR");
    declareFunction(myName, "sbhl_apply_what_mts_behavior", "SBHL-APPLY-WHAT-MTS-BEHAVIOR", 1, 0, false);
    declareFunction(myName, "sbhl_what_mts_terminating_space", "SBHL-WHAT-MTS-TERMINATING-SPACE", 0, 0, false);
    declareFunction(myName, "sbhl_what_mts_final_mt_paths", "SBHL-WHAT-MTS-FINAL-MT-PATHS", 1, 0, false);
    declareFunction(myName, "sbhl_what_mts_goal_final_mt_paths", "SBHL-WHAT-MTS-GOAL-FINAL-MT-PATHS", 0, 0, false);
    declareFunction(myName, "sbhl_predicate_mt_paths", "SBHL-PREDICATE-MT-PATHS", 3, 1, false);
    //declareFunction(myName, "sbhl_inverse_mt_paths", "SBHL-INVERSE-MT-PATHS", 3, 1, false);
    //declareFunction(myName, "sbhl_false_predicate_mt_paths", "SBHL-FALSE-PREDICATE-MT-PATHS", 3, 1, false);
    //declareFunction(myName, "sbhl_false_inverse_mt_paths", "SBHL-FALSE-INVERSE-MT-PATHS", 3, 1, false);
    declareFunction(myName, "sbhl_what_mt_paths_from_node_to_node", "SBHL-WHAT-MT-PATHS-FROM-NODE-TO-NODE", 2, 0, false);
    declareFunction(myName, "sbhl_min_mt_paths", "SBHL-MIN-MT-PATHS", 1, 0, false);
    declareFunction(myName, "sbhl_min_mts_of_predicate_paths", "SBHL-MIN-MTS-OF-PREDICATE-PATHS", 3, 1, false);
    //declareFunction(myName, "sbhl_min_mts_of_inverse_paths", "SBHL-MIN-MTS-OF-INVERSE-PATHS", 3, 1, false);
    //declareFunction(myName, "sbhl_min_mts_of_false_predicate_paths", "SBHL-MIN-MTS-OF-FALSE-PREDICATE-PATHS", 3, 1, false);
    //declareFunction(myName, "sbhl_min_mts_of_false_inverse_paths", "SBHL-MIN-MTS-OF-FALSE-INVERSE-PATHS", 3, 1, false);
    declareFunction(myName, "sbhl_max_floor_mts", "SBHL-MAX-FLOOR-MTS", 1, 0, false); new $sbhl_max_floor_mts$UnaryFunction();
    declareFunction(myName, "sbhl_max_floor_mts_of_paths", "SBHL-MAX-FLOOR-MTS-OF-PATHS", 1, 0, false);
    declareFunction(myName, "sbhl_max_floor_mts_of_predicate_paths", "SBHL-MAX-FLOOR-MTS-OF-PREDICATE-PATHS", 3, 1, false);
    //declareFunction(myName, "sbhl_max_floor_mts_of_inverse_paths", "SBHL-MAX-FLOOR-MTS-OF-INVERSE-PATHS", 3, 1, false);
    //declareFunction(myName, "sbhl_max_floor_mts_of_false_predicate_paths", "SBHL-MAX-FLOOR-MTS-OF-FALSE-PREDICATE-PATHS", 3, 1, false);
    //declareFunction(myName, "sbhl_max_floor_mts_of_false_inverse_paths", "SBHL-MAX-FLOOR-MTS-OF-FALSE-INVERSE-PATHS", 3, 1, false);
    //declareFunction(myName, "sbhl_mt_table_of_floors_for_predicate_path", "SBHL-MT-TABLE-OF-FLOORS-FOR-PREDICATE-PATH", 3, 2, false);
    //declareFunction(myName, "sbhl_floors_in_space", "SBHL-FLOORS-IN-SPACE", 3, 2, false);
    //declareFunction(myName, "sbhl_closure_intersection_in_space", "SBHL-CLOSURE-INTERSECTION-IN-SPACE", 2, 0, false);
    //declareFunction(myName, "sbhl_sort_by_least_inverse_cardinality", "SBHL-SORT-BY-LEAST-INVERSE-CARDINALITY", 1, 1, false);
    //declareFunction(myName, "sbhl_inverse_cardinalityL", "SBHL-INVERSE-CARDINALITY<", 2, 0, false);
    return NIL;
  }
