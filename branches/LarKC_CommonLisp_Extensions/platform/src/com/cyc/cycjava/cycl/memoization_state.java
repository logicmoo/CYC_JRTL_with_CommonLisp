...
These are intended to clear mt-dependent caches. */
  ...
  public static final SubLObject declare_memoization_state_file() {
    declareFunction(myName, "note_cached_function_called", "NOTE-CACHED-FUNCTION-CALLED", 1, 0, false);
    declareFunction(myName, "note_cached_function_called_but_not_cached", "NOTE-CACHED-FUNCTION-CALLED-BUT-NOT-CACHED", 1, 0, false);
    declareFunction(myName, "show_function_caching_results", "SHOW-FUNCTION-CACHING-RESULTS", 0, 0, false);
    declareFunction(myName, "clear_function_caching_results", "CLEAR-FUNCTION-CACHING-RESULTS", 0, 0, false);
    declareMacro(myName, "with_caching_mode", "WITH-CACHING-MODE");
    declareFunction(myName, "caching_mode_enable", "CACHING-MODE-ENABLE", 0, 1, false);
    declareFunction(myName, "caching_mode_disable", "CACHING-MODE-DISABLE", 0, 1, false);
    declareFunction(myName, "caching_disabled", "CACHING-DISABLED", 1, 0, false);
    declareFunction(myName, "sxhash_calc_n", "SXHASH-CALC-N", 1, 0, false);
    declareFunction(myName, "sxhash_calc_10", "SXHASH-CALC-10", 10, 0, false);
    declareFunction(myName, "sxhash_calc_9", "SXHASH-CALC-9", 9, 0, false);
    declareFunction(myName, "sxhash_calc_8", "SXHASH-CALC-8", 8, 0, false);
    declareFunction(myName, "sxhash_calc_7", "SXHASH-CALC-7", 7, 0, false);
    declareFunction(myName, "sxhash_calc_6", "SXHASH-CALC-6", 6, 0, false);
    declareFunction(myName, "sxhash_calc_5", "SXHASH-CALC-5", 5, 0, false);
    declareFunction(myName, "sxhash_calc_4", "SXHASH-CALC-4", 4, 0, false);
    declareFunction(myName, "sxhash_calc_3", "SXHASH-CALC-3", 3, 0, false);
    declareFunction(myName, "sxhash_calc_2", "SXHASH-CALC-2", 2, 0, false);
    declareMacro(myName, "possibly_with_memoization_state_writer_lock", "POSSIBLY-WITH-MEMOIZATION-STATE-WRITER-LOCK");
    declareMacro(myName, "possibly_with_memoization_state_reader_lock", "POSSIBLY-WITH-MEMOIZATION-STATE-READER-LOCK");
    declareMacro(myName, "possibly_with_caching_state_writer_lock", "POSSIBLY-WITH-CACHING-STATE-WRITER-LOCK");
    declareMacro(myName, "possibly_with_caching_state_reader_lock", "POSSIBLY-WITH-CACHING-STATE-READER-LOCK");
    declareFunction(myName, "caching_state_print_function_trampoline", "CACHING-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction(myName, "caching_state_p", "CACHING-STATE-P", 1, 0, false); new $caching_state_p$UnaryFunction();
    declareFunction(myName, "caching_state_store", "CACHING-STATE-STORE", 1, 0, false);
    declareFunction(myName, "caching_state_zero_arg_results", "CACHING-STATE-ZERO-ARG-RESULTS", 1, 0, false);
    declareFunction(myName, "caching_state_lock", "CACHING-STATE-LOCK", 1, 0, false);
    declareFunction(myName, "caching_state_capacity", "CACHING-STATE-CAPACITY", 1, 0, false);
    declareFunction(myName, "caching_state_func_symbol", "CACHING-STATE-FUNC-SYMBOL", 1, 0, false);
    declareFunction(myName, "caching_state_test", "CACHING-STATE-TEST", 1, 0, false);
    declareFunction(myName, "caching_state_args_length", "CACHING-STATE-ARGS-LENGTH", 1, 0, false);
    declareFunction(myName, "_csetf_caching_state_store", "_CSETF-CACHING-STATE-STORE", 2, 0, false);
    declareFunction(myName, "_csetf_caching_state_zero_arg_results", "_CSETF-CACHING-STATE-ZERO-ARG-RESULTS", 2, 0, false);
    declareFunction(myName, "_csetf_caching_state_lock", "_CSETF-CACHING-STATE-LOCK", 2, 0, false);
    declareFunction(myName, "_csetf_caching_state_capacity", "_CSETF-CACHING-STATE-CAPACITY", 2, 0, false);
    declareFunction(myName, "_csetf_caching_state_func_symbol", "_CSETF-CACHING-STATE-FUNC-SYMBOL", 2, 0, false);
    declareFunction(myName, "_csetf_caching_state_test", "_CSETF-CACHING-STATE-TEST", 2, 0, false);
    declareFunction(myName, "_csetf_caching_state_args_length", "_CSETF-CACHING-STATE-ARGS-LENGTH", 2, 0, false);
    declareFunction(myName, "make_caching_state", "MAKE-CACHING-STATE", 0, 1, false);
    declareFunction(myName, "create_caching_state", "CREATE-CACHING-STATE", 3, 3, false);
    declareFunction(myName, "print_caching_state_internal", "PRINT-CACHING-STATE-INTERNAL", 3, 0, false);
    declareFunction(myName, "print_caching_state", "PRINT-CACHING-STATE", 3, 0, false);
    declareFunction(myName, "caching_state_get_zero_arg_results_internal", "CACHING-STATE-GET-ZERO-ARG-RESULTS-INTERNAL", 1, 0, false);
    declareFunction(myName, "caching_state_get_zero_arg_results", "CACHING-STATE-GET-ZERO-ARG-RESULTS", 1, 1, false);
    declareFunction(myName, "caching_state_set_zero_arg_results_internal", "CACHING-STATE-SET-ZERO-ARG-RESULTS-INTERNAL", 2, 0, false);
    declareFunction(myName, "caching_state_set_zero_arg_results", "CACHING-STATE-SET-ZERO-ARG-RESULTS", 2, 1, false);
    declareFunction(myName, "caching_state_lookup_internal", "CACHING-STATE-LOOKUP-INTERNAL", 2, 1, false);
    declareFunction(myName, "caching_state_lookup", "CACHING-STATE-LOOKUP", 2, 1, false);
    declareFunction(myName, "caching_state_put_internal", "CACHING-STATE-PUT-INTERNAL", 3, 0, false);
    declareFunction(myName, "caching_state_put", "CACHING-STATE-PUT", 3, 1, false);
    declareFunction(myName, "caching_state_clear_internal", "CACHING-STATE-CLEAR-INTERNAL", 1, 0, false);
    declareFunction(myName, "caching_state_clear", "CACHING-STATE-CLEAR", 1, 0, false);
    declareFunction(myName, "caching_state_get_capacity", "CACHING-STATE-GET-CAPACITY", 1, 0, false);
    declareFunction(myName, "caching_state_get_func_symbol", "CACHING-STATE-GET-FUNC-SYMBOL", 1, 0, false);
    declareFunction(myName, "caching_state_get_test", "CACHING-STATE-GET-TEST", 1, 0, false);
    declareFunction(myName, "caching_state_keys_internal", "CACHING-STATE-KEYS-INTERNAL", 1, 0, false);
    declareFunction(myName, "caching_state_keys", "CACHING-STATE-KEYS", 1, 1, false);
    declareFunction(myName, "caching_state_size_internal", "CACHING-STATE-SIZE-INTERNAL", 1, 0, false);
    declareFunction(myName, "caching_state_size", "CACHING-STATE-SIZE", 1, 1, false);
    declareFunction(myName, "caching_state_remove_internal", "CACHING-STATE-REMOVE-INTERNAL", 2, 0, false);
    declareFunction(myName, "caching_state_remove", "CACHING-STATE-REMOVE", 2, 1, false);
    declareFunction(myName, "caching_state_remove_function_results_with_args_internal", "CACHING-STATE-REMOVE-FUNCTION-RESULTS-WITH-ARGS-INTERNAL", 2, 1, false);
    declareFunction(myName, "caching_state_remove_function_results_with_args", "CACHING-STATE-REMOVE-FUNCTION-RESULTS-WITH-ARGS", 2, 2, false);
    declareFunction(myName, "caching_state_clone_internal", "CACHING-STATE-CLONE-INTERNAL", 1, 0, false);
    declareFunction(myName, "caching_state_store_as_dictionary", "CACHING-STATE-STORE-AS-DICTIONARY", 1, 0, false);
    declareFunction(myName, "caching_state_clone", "CACHING-STATE-CLONE", 1, 1, false);
    declareFunction(myName, "caching_state_multi_key_n_is_cached", "CACHING-STATE-MULTI-KEY-N-IS-CACHED", 2, 0, false);
    declareFunction(myName, "caching_state_lookup_multi_key_n", "CACHING-STATE-LOOKUP-MULTI-KEY-N", 2, 2, false);
    declareFunction(myName, "caching_state_lookup_multi_key_1", "CACHING-STATE-LOOKUP-MULTI-KEY-1", 2, 0, false);
    declareFunction(myName, "caching_state_enter_multi_key_n", "CACHING-STATE-ENTER-MULTI-KEY-N", 5, 0, false);
    declareFunction(myName, "memoization_state_print_function_trampoline", "MEMOIZATION-STATE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
    declareFunction(myName, "memoization_state_p", "MEMOIZATION-STATE-P", 1, 0, false); new $memoization_state_p$UnaryFunction();
    declareFunction(myName, "memoization_state_store", "MEMOIZATION-STATE-STORE", 1, 0, false);
    declareFunction(myName, "memoization_state_current_process", "MEMOIZATION-STATE-CURRENT-PROCESS", 1, 0, false);
    declareFunction(myName, "memoization_state_lock", "MEMOIZATION-STATE-LOCK", 1, 0, false);
    declareFunction(myName, "memoization_state_name", "MEMOIZATION-STATE-NAME", 1, 0, false);
    declareFunction(myName, "memoization_state_should_clone", "MEMOIZATION-STATE-SHOULD-CLONE", 1, 0, false);
    declareFunction(myName, "_csetf_memoization_state_store", "_CSETF-MEMOIZATION-STATE-STORE", 2, 0, false);
    declareFunction(myName, "_csetf_memoization_state_current_process", "_CSETF-MEMOIZATION-STATE-CURRENT-PROCESS", 2, 0, false);
    declareFunction(myName, "_csetf_memoization_state_lock", "_CSETF-MEMOIZATION-STATE-LOCK", 2, 0, false);
    declareFunction(myName, "_csetf_memoization_state_name", "_CSETF-MEMOIZATION-STATE-NAME", 2, 0, false);
    declareFunction(myName, "_csetf_memoization_state_should_clone", "_CSETF-MEMOIZATION-STATE-SHOULD-CLONE", 2, 0, false);
    declareFunction(myName, "make_memoization_state", "MAKE-MEMOIZATION-STATE", 0, 1, false);
    declareFunction(myName, "create_memoization_state", "CREATE-MEMOIZATION-STATE", 0, 4, false);
    declareFunction(myName, "new_memoization_state", "NEW-MEMOIZATION-STATE", 0, 4, false);
    declareFunction(myName, "print_memoization_state_internal", "PRINT-MEMOIZATION-STATE-INTERNAL", 3, 0, false);
    declareFunction(myName, "print_memoization_state", "PRINT-MEMOIZATION-STATE", 3, 0, false);
    declareFunction(myName, "memoization_state_lookup_internal", "MEMOIZATION-STATE-LOOKUP-INTERNAL", 2, 1, false);
    declareFunction(myName, "memoization_state_lookup", "MEMOIZATION-STATE-LOOKUP", 2, 1, false);
    declareFunction(myName, "memoization_state_get_caching_state_for_function", "MEMOIZATION-STATE-GET-CACHING-STATE-FOR-FUNCTION", 2, 0, false);
    declareFunction(myName, "memoization_state_put_internal", "MEMOIZATION-STATE-PUT-INTERNAL", 3, 0, false);
    declareFunction(myName, "memoization_state_put", "MEMOIZATION-STATE-PUT", 3, 0, false);
    declareFunction(myName, "memoization_state_remove_internal", "MEMOIZATION-STATE-REMOVE-INTERNAL", 2, 0, false);
    declareFunction(myName, "memoization_state_remove", "MEMOIZATION-STATE-REMOVE", 2, 0, false);
    declareFunction(myName, "memoization_state_clear_internal", "MEMOIZATION-STATE-CLEAR-INTERNAL", 1, 0, false);
    declareFunction(myName, "memoization_state_clear", "MEMOIZATION-STATE-CLEAR", 1, 0, false);
    declareFunction(myName, "memoization_state_get_test", "MEMOIZATION-STATE-GET-TEST", 1, 0, false);
    declareFunction(myName, "memoization_state_get_lock", "MEMOIZATION-STATE-GET-LOCK", 1, 0, false);
    declareFunction(myName, "memoization_state_get_name", "MEMOIZATION-STATE-GET-NAME", 1, 0, false);
    declareFunction(myName, "memoization_state_get_should_clone", "MEMOIZATION-STATE-GET-SHOULD-CLONE", 1, 0, false);
    declareFunction(myName, "memoization_state_get_current_process_internal", "MEMOIZATION-STATE-GET-CURRENT-PROCESS-INTERNAL", 1, 0, false);
    declareFunction(myName, "memoization_state_get_current_process", "MEMOIZATION-STATE-GET-CURRENT-PROCESS", 1, 0, false);
    declareFunction(myName, "memoization_state_keys_internal", "MEMOIZATION-STATE-KEYS-INTERNAL", 1, 0, false);
    declareFunction(myName, "memoization_state_keys", "MEMOIZATION-STATE-KEYS", 1, 0, false);
    declareFunction(myName, "memoization_state_set_current_process_internal", "MEMOIZATION-STATE-SET-CURRENT-PROCESS-INTERNAL", 2, 0, false);
    declareFunction(myName, "memoization_state_set_current_process", "MEMOIZATION-STATE-SET-CURRENT-PROCESS", 2, 0, false);
    declareFunction(myName, "memoization_state_clone", "MEMOIZATION-STATE-CLONE", 1, 0, false);
    declareFunction(myName, "memoization_state_merge_cloned_state", "MEMOIZATION-STATE-MERGE-CLONED-STATE", 2, 0, false);
    declareFunction(myName, "caching_state_results_has_argsP", "CACHING-STATE-RESULTS-HAS-ARGS?", 2, 0, false);
    declareFunction(myName, "current_memoization_state", "CURRENT-MEMOIZATION-STATE", 0, 0, false);
    declareMacro(myName, "with_memoization_state", "WITH-MEMOIZATION-STATE");
    declareFunction(myName, "possibly_clone_memoization_state", "POSSIBLY-CLONE-MEMOIZATION-STATE", 1, 0, false);
    declareFunction(myName, "possibly_merge_back_memoization_state", "POSSIBLY-MERGE-BACK-MEMOIZATION-STATE", 3, 0, false);
    declareMacro(myName, "with_new_memoization_state", "WITH-NEW-MEMOIZATION-STATE");
    declareMacro(myName, "with_possibly_new_memoization_state", "WITH-POSSIBLY-NEW-MEMOIZATION-STATE");
    declareFunction(myName, "possibly_new_memoization_state", "POSSIBLY-NEW-MEMOIZATION-STATE", 0, 0, false);
    declareFunction(myName, "clear_memoization", "CLEAR-MEMOIZATION", 2, 0, false);
    declareFunction(myName, "clear_current_memoization", "CLEAR-CURRENT-MEMOIZATION", 1, 0, false);
    declareFunction(myName, "clear_all_memoization", "CLEAR-ALL-MEMOIZATION", 1, 0, false);
    declareFunction(myName, "clear_all_current_memoization", "CLEAR-ALL-CURRENT-MEMOIZATION", 0, 0, false);
    declareFunction(myName, "note_memoized_function", "NOTE-MEMOIZED-FUNCTION", 1, 0, false);
    declareFunction(myName, "memoized_functions", "MEMOIZED-FUNCTIONS", 0, 0, false);
    declareMacro(myName, "define_memoized", "DEFINE-MEMOIZED");
    declareFunction(myName, "macro_test_to_run_time_test", "MACRO-TEST-TO-RUN-TIME-TEST", 1, 0, false);
    declareFunction(myName, "define_memoized_internal", "DEFINE-MEMOIZED-INTERNAL", 8, 0, false);
    declareFunction(myName, "define_memoized_internal_0_or_1", "DEFINE-MEMOIZED-INTERNAL-0-OR-1", 8, 0, false);
    declareFunction(myName, "define_memoized_internal_n", "DEFINE-MEMOIZED-INTERNAL-N", 8, 0, false);
    declareFunction(myName, "caching_sxhash_code", "CACHING-SXHASH-CODE", 1, 0, false);
    declareFunction(myName, "caching_lookup_code", "CACHING-LOOKUP-CODE", 5, 0, false);
    declareFunction(myName, "lookup_memoization_state_code", "LOOKUP-MEMOIZATION-STATE-CODE", 4, 0, false);
    declareFunction(myName, "note_memoized_function_code", "NOTE-MEMOIZED-FUNCTION-CODE", 1, 0, false);
    declareFunction(myName, "note_globally_cached_function", "NOTE-GLOBALLY-CACHED-FUNCTION", 1, 0, false);
    declareFunction(myName, "globally_cached_functions", "GLOBALLY-CACHED-FUNCTIONS", 0, 0, false);
    declareFunction(myName, "global_cache_variables", "GLOBAL-CACHE-VARIABLES", 0, 0, false);
    declareFunction(myName, "global_cache_variable_values", "GLOBAL-CACHE-VARIABLE-VALUES", 0, 0, false);
    declareFunction(myName, "memoized_or_cached_functions", "MEMOIZED-OR-CACHED-FUNCTIONS", 0, 0, false);
    declareFunction(myName, "clear_all_globally_cached_functions", "CLEAR-ALL-GLOBALLY-CACHED-FUNCTIONS", 0, 0, false);
    declareMacro(myName, "define_cached_new", "DEFINE-CACHED-NEW");
    declareMacro(myName, "define_cached", "DEFINE-CACHED");
    declareMacro(myName, "define_cached_multiarg", "DEFINE-CACHED-MULTIARG");
    declareFunction(myName, "cache_clear_trigger_p", "CACHE-CLEAR-TRIGGER-P", 1, 0, false);
    declareFunction(myName, "define_cached_internal", "DEFINE-CACHED-INTERNAL", 8, 0, false);
    declareFunction(myName, "define_cached_internal_0_or_1", "DEFINE-CACHED-INTERNAL-0-OR-1", 8, 0, false);
    declareFunction(myName, "define_cached_internal_n", "DEFINE-CACHED-INTERNAL-N", 8, 0, false);
    declareFunction(myName, "load_caching_state_contents_from_hash_table", "LOAD-CACHING-STATE-CONTENTS-FROM-HASH-TABLE", 2, 0, false);
    declareFunction(myName, "load_caching_state_contents_from_hash_table_internal", "LOAD-CACHING-STATE-CONTENTS-FROM-HASH-TABLE-INTERNAL", 2, 0, false);
    declareFunction(myName, "get_caching_state_contents_as_hash_table", "GET-CACHING-STATE-CONTENTS-AS-HASH-TABLE", 1, 0, false);
    declareFunction(myName, "get_caching_state_contents_as_hash_table_internal", "GET-CACHING-STATE-CONTENTS-AS-HASH-TABLE-INTERNAL", 1, 0, false);
    declareFunction(myName, "get_caching_state_for_globally_cached_function", "GET-CACHING-STATE-FOR-GLOBALLY-CACHED-FUNCTION", 1, 4, false);
    declareFunction(myName, "create_global_caching_state_for_name", "CREATE-GLOBAL-CACHING-STATE-FOR-NAME", 6, 0, false);
    declareFunction(myName, "memoize_caching_state_for_function_new", "MEMOIZE-CACHING-STATE-FOR-FUNCTION-NEW", 2, 0, false);
    declareFunction(myName, "global_caching_reset_from_function", "GLOBAL-CACHING-RESET-FROM-FUNCTION", 1, 0, false);
    declareFunction(myName, "global_caching_lock", "GLOBAL-CACHING-LOCK", 1, 0, false);
    declareFunction(myName, "global_caching_variable_new", "GLOBAL-CACHING-VARIABLE-NEW", 1, 0, false);
    declareFunction(myName, "global_caching_variable_code", "GLOBAL-CACHING-VARIABLE-CODE", 1, 0, false);
    declareFunction(myName, "global_caching_reset_function", "GLOBAL-CACHING-RESET-FUNCTION", 1, 0, false);
    declareFunction(myName, "global_caching_register_reset_code_new", "GLOBAL-CACHING-REGISTER-RESET-CODE-NEW", 2, 0, false);
    declareFunction(myName, "global_caching_reset_code_new", "GLOBAL-CACHING-RESET-CODE-NEW", 1, 0, false);
    declareFunction(myName, "global_caching_remove_function", "GLOBAL-CACHING-REMOVE-FUNCTION", 1, 0, false);
    declareFunction(myName, "global_caching_n_remove_code_new", "GLOBAL-CACHING-N-REMOVE-CODE-NEW", 3, 0, false);
    declareFunction(myName, "register_hl_store_cache_clear_callback", "REGISTER-HL-STORE-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "deregister_hl_store_cache_clear_callback", "DEREGISTER-HL-STORE-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "clear_hl_store_dependent_caches", "CLEAR-HL-STORE-DEPENDENT-CACHES", 0, 0, false);
    declareFunction(myName, "register_mt_dependent_cache_clear_callback", "REGISTER-MT-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "deregister_mt_dependent_cache_clear_callback", "DEREGISTER-MT-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "clear_mt_dependent_cachesP", "CLEAR-MT-DEPENDENT-CACHES?", 0, 0, false);
    declareMacro(myName, "without_clearing_mt_dependent_caches", "WITHOUT-CLEARING-MT-DEPENDENT-CACHES");
    declareFunction(myName, "register_genl_preds_dependent_cache_clear_callback", "REGISTER-GENL-PREDS-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "deregister_genl_preds_dependent_cache_clear_callback", "DEREGISTER-GENL-PREDS-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "register_genls_dependent_cache_clear_callback", "REGISTER-GENLS-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "deregister_genls_dependent_cache_clear_callback", "DEREGISTER-GENLS-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "register_isa_dependent_cache_clear_callback", "REGISTER-ISA-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "deregister_isa_dependent_cache_clear_callback", "DEREGISTER-ISA-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "register_quoted_isa_dependent_cache_clear_callback", "REGISTER-QUOTED-ISA-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareFunction(myName, "deregister_quoted_isa_dependent_cache_clear_callback", "DEREGISTER-QUOTED-ISA-DEPENDENT-CACHE-CLEAR-CALLBACK", 1, 0, false);
    declareMacro(myName, "memoized_already", "MEMOIZED-ALREADY");
    declareMacro(myName, "cached_already", "CACHED-ALREADY");
    declareFunction(myName, "define_formal_args", "DEFINE-FORMAL-ARGS", 1, 0, false);
    declareFunction(myName, "caching_results", "CACHING-RESULTS", 1, 0, false);
    declareFunction(myName, "global_caching_note_function_code", "GLOBAL-CACHING-NOTE-FUNCTION-CODE", 1, 0, false);
    declareFunction(myName, "caching_internal_function", "CACHING-INTERNAL-FUNCTION", 1, 0, false);
    declareFunction(myName, "caching_internal_function_code", "CACHING-INTERNAL-FUNCTION-CODE", 3, 0, false);
    declareFunction(myName, "caching_faccess_code", "CACHING-FACCESS-CODE", 3, 0, false);
    return NIL;
  }
