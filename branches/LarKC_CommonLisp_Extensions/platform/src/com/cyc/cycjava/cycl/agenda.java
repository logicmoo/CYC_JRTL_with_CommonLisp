...
public  final class agenda extends SubLTranslatedFile {
  ...
  public static final SubLObject initialize_agenda() {
    {
      ...
      if (((NIL != system_parameters.$start_agenda_at_startupP$.getDynamicValue(thread))
           && (NIL == agenda_running()))) {
        ...
        try {
        ...
        } finally {
          {
            ...
            try {
              ...
              Errors
					.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 31522");
            } finally {
  ...
  public static final SubLObject start_agenda(SubLObject waitP) {
    ...
    if ((NIL != agenda_running())) {
      Errors
			.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 31524");
    }
  ...
  public static final SubLObject wait_for_agenda_running(SubLObject wait_time) {
    ...
    }
    {
      ...
      for (; (!(((NIL != agenda_running())
            || (NIL != Time.time_has_arrivedP(time))))); ) {
  ...
  public static final class $agenda_work_to_do$ZeroArityFunction extends ZeroArityFunction {
    public $agenda_work_to_do$ZeroArityFunction() { super(extractFunctionNamed("AGENDA-WORK-TO-DO")); }
    public SubLObject processItem() { return agenda_work_to_do(); }
  }
...
TEST and ACTION are functions of no arguments. */
  ...
  public static final SubLObject declare_agenda_task(SubLObject test, SubLObject action, SubLObject priority) {
    ...
    undeclare_agenda_task(test);
    {
      ...
      try {
        release = Locks.seize_lock(lock);
        $agenda_action_table$.setGlobalValue(list_utilities.splice_into_sorted_list(list(test, action, priority), $agenda_action_table$.getGlobalValue(), Symbols.symbol_function($sym19$_), Symbols.symbol_function($sym20$AGENDA_TASK_PRIORITY)));
      } finally {
        if ((NIL != release)) {
          Locks.release_lock(lock);
        }
  ...
  public static final SubLObject undeclare_agenda_task(SubLObject test) {
    {
      ...
      try {
        release = Locks.seize_lock(lock);
        $agenda_action_table$.setGlobalValue(Sequences.delete(test, $agenda_action_table$.getGlobalValue(), Symbols.symbol_function(EQL), Symbols.symbol_function($sym21$FIRST), UNPROVIDED, UNPROVIDED, UNPROVIDED));
      } finally {
        if ((NIL != release)) {
          Locks.release_lock(lock);
        }
  ...
  public static final class $agenda_should_quitP$ZeroArityFunction extends ZeroArityFunction {
    public $agenda_should_quitP$ZeroArityFunction() { super(extractFunctionNamed("AGENDA-SHOULD-QUIT?")); }
    public SubLObject processItem() { return agenda_should_quitP(); }
  }
  ...
  public static final class $restart_agenda_flagP$ZeroArityFunction extends ZeroArityFunction {
    public $restart_agenda_flagP$ZeroArityFunction() { super(extractFunctionNamed("RESTART-AGENDA-FLAG?")); }
    public SubLObject processItem() { return restart_agenda_flagP(); }
  }
  ...
  public static final SubLObject save_operationsP() {
    return makeBoolean(((NIL != operation_communication.saving_operationsP())
           && (((NIL != Time.time_has_arrivedP($next_save_transcript_time$.getGlobalValue()))
               && (NIL == operation_queues.transcript_queue_empty())
               && (NIL != operation_queues.local_queue_empty()))
            || operation_queues.transcript_queue_size().numG($transcript_queue_worry_size$.getGlobalValue()))));
  }

  public static final class $save_operationsP$ZeroArityFunction extends ZeroArityFunction {
    public $save_operationsP$ZeroArityFunction() { super(extractFunctionNamed("SAVE-OPERATIONS?")); }
    public SubLObject processItem() { return save_operationsP(); }
  }
  ...
  public static final SubLObject worry_transmit_operationsP() {
    return makeBoolean(((NIL != operation_communication.allow_transmitting())
           && (((NIL != Time.time_has_arrivedP($next_worry_transmit_time$.getGlobalValue()))
               && (NIL == operation_queues.transmit_queue_empty()))
  ...
  public static final class $worry_transmit_operationsP$ZeroArityFunction extends ZeroArityFunction {
    public $worry_transmit_operationsP$ZeroArityFunction() { super(extractFunctionNamed("WORRY-TRANSMIT-OPERATIONS?")); }
    public SubLObject processItem() { return worry_transmit_operationsP(); }
  }

  @SubL(source = "cycl/agenda.lisp", position = 11927) 
  public static final SubLObject run_auxiliary_opP() {
    return makeBoolean(((NIL != operation_communication.process_auxiliary_operationsP())
           && (NIL == operation_queues.auxiliary_queue_empty())));
  }

  public static final class $run_auxiliary_opP$ZeroArityFunction extends ZeroArityFunction {
    public $run_auxiliary_opP$ZeroArityFunction() { super(extractFunctionNamed("RUN-AUXILIARY-OP?")); }
    public SubLObject processItem() { return run_auxiliary_opP(); }
  }

  @SubL(source = "cycl/agenda.lisp", position = 13855) 
  public static final SubLObject run_local_opP() {
    return makeBoolean(((NIL != operation_communication.process_local_operationsP())
           && (NIL == operation_queues.local_queue_empty())));
  }

  public static final class $run_local_opP$ZeroArityFunction extends ZeroArityFunction {
    public $run_local_opP$ZeroArityFunction() { super(extractFunctionNamed("RUN-LOCAL-OP?")); }
    public SubLObject processItem() { return run_local_opP(); }
  }
  ...
  public static final SubLObject normal_transmit_operationsP() {
    return makeBoolean(((NIL != Time.time_has_arrivedP($next_normal_transmit_time$.getGlobalValue()))
           && (NIL == operation_queues.transmit_queue_empty())
           && (NIL != operation_communication.allow_transmitting())
           && (NIL != operation_queues.local_queue_empty())
           && (NIL != operation_queues.transcript_queue_empty())));
  }

  public static final class $normal_transmit_operationsP$ZeroArityFunction extends ZeroArityFunction {
    public $normal_transmit_operationsP$ZeroArityFunction() { super(extractFunctionNamed("NORMAL-TRANSMIT-OPERATIONS?")); }
    public SubLObject processItem() { return normal_transmit_operationsP(); }
  }
  ...
  public static final class $run_remote_opP$ZeroArityFunction extends ZeroArityFunction {
    public $run_remote_opP$ZeroArityFunction() { super(extractFunctionNamed("RUN-REMOTE-OP?")); }
    public SubLObject processItem() { return run_remote_opP(); }
  }
  ...
  public static final SubLObject load_operationsP() {
    return makeBoolean(((NIL != operation_communication.receiving_remote_operationsP())
           && (NIL != Time.time_has_arrivedP($next_load_transcript_time$.getGlobalValue()))));
  }

  public static final class $load_operationsP$ZeroArityFunction extends ZeroArityFunction {
    public $load_operationsP$ZeroArityFunction() { super(extractFunctionNamed("LOAD-OPERATIONS?")); }
    public SubLObject processItem() { return load_operationsP(); }
  }
  ...
  public static final SubLObject save_experienceP() {
    return makeBoolean(((NIL != $save_recent_experienceP$.getGlobalValue())
           && (NIL != Time.time_has_arrivedP($next_save_experience_transcript_time$.getGlobalValue()))));
  }

  public static final class $save_experienceP$ZeroArityFunction extends ZeroArityFunction {
    public $save_experienceP$ZeroArityFunction() { super(extractFunctionNamed("SAVE-EXPERIENCE?")); }
    public SubLObject processItem() { return save_experienceP(); }
  }
  ...
  public static final SubLObject agenda_save_asked_queriesP() {
    return makeBoolean(((NIL != control_vars.save_asked_queriesP())
           && (NIL != Time.time_has_arrivedP($next_save_asked_queries_transcript_time$.getGlobalValue()))));
  }

  public static final class $agenda_save_asked_queriesP$ZeroArityFunction extends ZeroArityFunction {
    public $agenda_save_asked_queriesP$ZeroArityFunction() { super(extractFunctionNamed("AGENDA-SAVE-ASKED-QUERIES?")); }
    public SubLObject processItem() { return agenda_save_asked_queriesP(); }
  }
  ...
  /** Local time in form of (HH MM SS) at which a daily (gc) by the agenda is invoked. */
  ...
  public static final SubLObject agenda_daily_gc_ready_p() {
    return makeBoolean(((NIL != $agenda_daily_gc_enabled$.getGlobalValue())
           && (NIL != $next_agenda_daily_gc_time$.getGlobalValue())
           && (NIL != Time.time_has_arrivedP($next_agenda_daily_gc_time$.getGlobalValue()))));
  }

  public static final class $agenda_daily_gc_ready_p$ZeroArityFunction extends ZeroArityFunction {
    public $agenda_daily_gc_ready_p$ZeroArityFunction() { super(extractFunctionNamed("AGENDA-DAILY-GC-READY-P")); }
    public SubLObject processItem() { return agenda_daily_gc_ready_p(); }
  }
  ...
  public static final SubLObject declare_agenda_file() {
    ...
    declareFunction(myName, "agenda_work_to_do", "AGENDA-WORK-TO-DO", 0, 0, false); new $agenda_work_to_do$ZeroArityFunction();
    ...
    declareFunction(myName, "agenda_should_quitP", "AGENDA-SHOULD-QUIT?", 0, 0, false); new $agenda_should_quitP$ZeroArityFunction();
    declareFunction(myName, "do_nothing", "DO-NOTHING", 0, 0, false);
    declareFunction(myName, "restart_agenda_flagP", "RESTART-AGENDA-FLAG?", 0, 0, false); new $restart_agenda_flagP$ZeroArityFunction();
    declareFunction(myName, "save_operationsP", "SAVE-OPERATIONS?", 0, 0, false); new $save_operationsP$ZeroArityFunction();
    declareFunction(myName, "save_local_operations", "SAVE-LOCAL-OPERATIONS", 0, 0, false);
    declareFunction(myName, "worry_transmit_operationsP", "WORRY-TRANSMIT-OPERATIONS?", 0, 0, false); new $worry_transmit_operationsP$ZeroArityFunction();
    declareFunction(myName, "worry_transmit_operations", "WORRY-TRANSMIT-OPERATIONS", 0, 0, false);
    declareFunction(myName, "run_auxiliary_opP", "RUN-AUXILIARY-OP?", 0, 0, false); new $run_auxiliary_opP$ZeroArityFunction();
    ...
    declareFunction(myName, "run_local_opP", "RUN-LOCAL-OP?", 0, 0, false); new $run_local_opP$ZeroArityFunction();
    ...
    declareFunction(myName, "normal_transmit_operationsP", "NORMAL-TRANSMIT-OPERATIONS?", 0, 0, false); new $normal_transmit_operationsP$ZeroArityFunction();
    declareFunction(myName, "normal_transmit_operations", "NORMAL-TRANSMIT-OPERATIONS", 0, 0, false);
    declareFunction(myName, "run_remote_opP", "RUN-REMOTE-OP?", 0, 0, false); new $run_remote_opP$ZeroArityFunction();
    declareFunction(myName, "run_one_remote_op_in_agenda", "RUN-ONE-REMOTE-OP-IN-AGENDA", 0, 0, false);
    declareFunction(myName, "load_operationsP", "LOAD-OPERATIONS?", 0, 0, false); new $load_operationsP$ZeroArityFunction();
    declareFunction(myName, "load_remote_operations", "LOAD-REMOTE-OPERATIONS", 0, 0, false);
    declareFunction(myName, "save_experienceP", "SAVE-EXPERIENCE?", 0, 0, false); new $save_experienceP$ZeroArityFunction();
    declareFunction(myName, "save_local_experience", "SAVE-LOCAL-EXPERIENCE", 0, 0, false);
    declareFunction(myName, "agenda_save_asked_queriesP", "AGENDA-SAVE-ASKED-QUERIES?", 0, 0, false); new $agenda_save_asked_queriesP$ZeroArityFunction();
    ...
    declareFunction(myName, "agenda_daily_gc_ready_p", "AGENDA-DAILY-GC-READY-P", 0, 0, false); new $agenda_daily_gc_ready_p$ZeroArityFunction();
  ...
  public static final SubLObject init_agenda_file() {
    ...
    $next_save_transcript_time$ = deflexical("*NEXT-SAVE-TRANSCRIPT-TIME*", ((NIL != Symbols.boundp($sym26$_NEXT_SAVE_TRANSCRIPT_TIME_)) ? ((SubLObject) $next_save_transcript_time$.getGlobalValue()) : Time.get_universal_time()));
    ...
    $next_worry_transmit_time$ = deflexical("*NEXT-WORRY-TRANSMIT-TIME*", ((NIL != Symbols.boundp($sym30$_NEXT_WORRY_TRANSMIT_TIME_)) ? ((SubLObject) $next_worry_transmit_time$.getGlobalValue()) : Time.get_universal_time()));
    $normal_transmit_quantum$ = deflexical("*NORMAL-TRANSMIT-QUANTUM*", $int59$120);
    $next_normal_transmit_time$ = deflexical("*NEXT-NORMAL-TRANSMIT-TIME*", ((NIL != Symbols.boundp($sym60$_NEXT_NORMAL_TRANSMIT_TIME_)) ? ((SubLObject) $next_normal_transmit_time$.getGlobalValue()) : Time.get_universal_time()));
    $load_transcript_quantum$ = deflexical("*LOAD-TRANSCRIPT-QUANTUM*", $int59$120);
    $next_load_transcript_time$ = deflexical("*NEXT-LOAD-TRANSCRIPT-TIME*", ((NIL != Symbols.boundp($sym68$_NEXT_LOAD_TRANSCRIPT_TIME_)) ? ((SubLObject) $next_load_transcript_time$.getGlobalValue()) : Time.get_universal_time()));
    ...
    $next_save_experience_transcript_time$ = deflexical("*NEXT-SAVE-EXPERIENCE-TRANSCRIPT-TIME*", ((NIL != Symbols.boundp($sym72$_NEXT_SAVE_EXPERIENCE_TRANSCRIPT_TIME_)) ? ((SubLObject) $next_save_experience_transcript_time$.getGlobalValue()) : Time.get_universal_time()));
    ...
    $next_save_asked_queries_transcript_time$ = deflexical("*NEXT-SAVE-ASKED-QUERIES-TRANSCRIPT-TIME*", ((NIL != Symbols.boundp($sym75$_NEXT_SAVE_ASKED_QUERIES_TRANSCRIPT_TIME_)) ? ((SubLObject) $next_save_asked_queries_transcript_time$.getGlobalValue()) : Time.get_universal_time()));
    ...
    $agenda_daily_gc_time_of_day$ = deflexical("*AGENDA-DAILY-GC-TIME-OF-DAY*", ((NIL != Symbols.boundp($sym81$_AGENDA_DAILY_GC_TIME_OF_DAY_)) ? ((SubLObject) $agenda_daily_gc_time_of_day$.getGlobalValue()) : $list82));
