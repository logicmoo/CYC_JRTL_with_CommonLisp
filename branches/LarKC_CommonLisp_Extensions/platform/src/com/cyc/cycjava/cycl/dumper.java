...
public  final class dumper extends SubLTranslatedFile {
  ...
  /** Force the KB to be completely stored in memory and therefore able written out as a single image file with no other dependencies. */
  @SubL(source = "cycl/dumper.lisp", position = 1024) 
  private static SubLSymbol $force_monolithic_kb_assumption$ = null;
  ...
  private static SubLSymbol $dump_bytes_per_assertion$ = null;
  ...
  private static SubLSymbol $kb_load_gc_checkpoints_enabledP$ = null;
          ...
          try {
            control_vars.$save_asked_queriesP$.bind(NIL, thread);
            {
              ...
              if ((NIL != force_monolithic_kb_assumptionP())) {
                Errors
						.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 2354");
              ...
              if ((NIL != $dump_verbose$.getDynamicValue(thread))) {
                PrintLow.format(T, $str48$________Load_of_KB__A_completed__, new SubLObject[] {control_vars.kb_loaded(), numeric_date_utilities.elapsed_time_abbreviation_string(load_time), numeric_date_utilities.timestring(UNPROVIDED)});
  ...
  private static SubLSymbol $kb_dump_common_symbols$ = null;
  ...
  public static final SubLObject setup_kb_state_from_dump(SubLObject directory_path) {
    {
      ...
      if (((NIL != nart_count)
           && (NIL != assertion_count)
           && (NIL != deduction_count)
           && (NIL != kb_hl_support_count)
           && (NIL != clause_struc_count)
        ...
        Errors
				.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 4883");
      }
    }
    return NIL;
  }
  ...
  public static final SubLObject load_nart_shells(SubLObject directory_path) {
    {
      ...
      if ((NIL != nart_count)) {
        ...
        Errors
				.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 10574");
      }
    }
    return NIL;
  }
  ...
  public static final SubLObject load_assertion_shells(SubLObject directory_path) {
    {
      ...
      if ((NIL != assertion_count)) {
        ...
        Errors
				.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 10565");
      }
    }
    return NIL;
  }
  ...
  public static final SubLObject load_kb_hl_support_shells(SubLObject directory_path) {
    {
      ...
      if ((NIL != kb_hl_support_count)) {
        ...
        Errors
				.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 10567");
      }
    }
    return NIL;
  }
  ...
  public static final SubLObject load_deduction_defs(SubLObject directory_path) {
    {
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
        ...
        if (((NIL == $force_monolithic_kb_assumption$.getGlobalValue())
          ...
          //PrintLow.format(T, $str95$__Deduction_definitions_will_be_s, deduction_cfasl_file, deduction_index_file);
          {
  ...
  public static final class $load_deduction_def_from_cache$BinaryFunction extends BinaryFunction {
    public $load_deduction_def_from_cache$BinaryFunction() { super(extractFunctionNamed("LOAD-DEDUCTION-DEF-FROM-CACHE")); }
    public SubLObject processItem(SubLObject arg1, SubLObject arg2) { return load_deduction_def_from_cache(arg1, arg2); }
  }
  ...
  public static final SubLObject load_assertion_defs(SubLObject directory_path) {
    {
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
        ...
        if (((NIL == $force_monolithic_kb_assumption$.getGlobalValue())
          ...
          //PrintLow.format(T, $str102$__Assertion_definitions_will_be_s, assertion_cfasl_file, assertion_index_file);
  ...
  public static final class $load_assertion_def_from_cache$BinaryFunction extends BinaryFunction {
    public $load_assertion_def_from_cache$BinaryFunction() { super(extractFunctionNamed("LOAD-ASSERTION-DEF-FROM-CACHE")); }
    public SubLObject processItem(SubLObject arg1, SubLObject arg2) { return load_assertion_def_from_cache(arg1, arg2); }
  }
  ...
  public static final SubLObject load_kb_hl_support_defs(SubLObject directory_path) {
    {
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
        ...
        if (((NIL == $force_monolithic_kb_assumption$.getGlobalValue())
          ...
          //PrintLow.format(T, $str108$__KB_HL_supports_will_be_swapped_, cfasl_file, index_file);
  ...
  public static final SubLObject load_constant_indices(SubLObject directory_path) {
    {
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
        ...
        if (((NIL == $force_monolithic_kb_assumption$.getGlobalValue())
             && (NIL != Filesys.probe_file(index_file)))) {
        //  PrintLow.format(T, $str123$__Constant_indexing_will_be_swapp, cfasl_file, index_file);
  ...
  public static final SubLObject load_nart_indices(SubLObject directory_path) {
    {
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
        ...
        if (((NIL == $force_monolithic_kb_assumption$.getGlobalValue())
             && (NIL != Filesys.probe_file(index_file)))) {
         // PrintLow.format(T, $str129$__NART_indexing_will_be_swapped_i, cfasl_file, index_file);
                  ...
                  try {
                    ...
                    utilities_macros.noting_percent_progress_preamble($str130$Loading_NART_indices);
                    {
                      ...
                      for (dump_id = cfasl.cfasl_input(stream_86, NIL, UNPROVIDED); (dump_id != $kw58$EOF); dump_id = cfasl.cfasl_input(stream_86, NIL, UNPROVIDED)) {
                        ...
                        if (dump_id.isInteger()) {
                          Errors
								.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 10571");
                        }
                      }
                    }
                    utilities_macros.noting_percent_progress_postamble();
  ...
  public static final SubLObject load_unrepresented_term_indices(SubLObject directory_path) {
    {
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
        ...
        if (((NIL == $force_monolithic_kb_assumption$.getGlobalValue())
             && (NIL != Filesys.probe_file(index_file)))) {
  //        PrintLow.format(T, $str135$__Unrepresented_term_indexing_wil, cfasl_file, index_file);
  ...
  public static final SubLObject load_nart_hl_formulas(SubLObject directory_path) {
    {
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
        ...
        if (((NIL == $force_monolithic_kb_assumption$.getGlobalValue())
          ...
          //PrintLow.format(T, $str157$__NART_HL_formulas_will_be_swappe, nart_hl_formula_cfasl_file, nart_hl_formula_index_file);
                  ...
                  try {
                    ...
                    utilities_macros.noting_percent_progress_preamble($str158$Loading_nart_hl_formula_definitio);
                    {
                      ...
                      for (dump_id = cfasl.cfasl_input(stream_112, NIL, UNPROVIDED); (dump_id != $kw58$EOF); dump_id = cfasl.cfasl_input(stream_112, NIL, UNPROVIDED)) {
                        ...
                        if (dump_id.isInteger()) {
                          Errors
								.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 10568");
                        }
                      }
                    }
                    utilities_macros.noting_percent_progress_postamble();
  ...
  public static final class $load_nart_hl_formula_from_cache$BinaryFunction extends BinaryFunction {
    public $load_nart_hl_formula_from_cache$BinaryFunction() { super(extractFunctionNamed("LOAD-NART-HL-FORMULA-FROM-CACHE")); }
    public SubLObject processItem(SubLObject arg1, SubLObject arg2) { return Errors
			.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 10570"); }
  }
  ...
  public static final SubLObject load_sbhl_data(SubLObject directory_path) {
    {
      final SubLThread thread = SubLProcess.currentSubLThread();
      {
        ...
        if ((NIL != verify_file_existence(cfasl_file, UNPROVIDED))) {
          if (((NIL != verify_file_existence(data_file, $kw168$WARN_ONLY))
               && (NIL != verify_file_existence(index_file, $kw168$WARN_ONLY)))) {
                          ...
                          if ((cfasl.cfasl_opcode_peek(stream_117, UNPROVIDED, UNPROVIDED) == $int170$30)) {
                            {
                              ...
                              if (((NIL != constant_handles.valid_constantP(predicate, UNPROVIDED))
                                   && graph.isHashtable()
                                   && (NIL != sbhl_module_vars.sbhl_module_p(module)))) {
  ...
  public static final SubLObject load_sbhl_miscellany(SubLObject stream) {
    {
      ...
      while (($kw172$END != token)) {
        ...
        if (token.isHashtable()) {
          ...
          Errors
				.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 1805");
          token = $kw172$END;
        } else {
          {
  ...
  public static final SubLObject declare_dumper_file() {
    ...
    //declareMacro(myName, "with_kb_load_area_allocation", "WITH-KB-LOAD-AREA-ALLOCATION");
    //declareMacro(myName, "without_kb_load_area_allocation", "WITHOUT-KB-LOAD-AREA-ALLOCATION");
    //declareMacro(myName, "with_kb_dump_filename", "WITH-KB-DUMP-FILENAME");
    //declareMacro(myName, "with_kb_dump_binary_file", "WITH-KB-DUMP-BINARY-FILE");
    ...
    //declareFunction(myName, "kb_dump_directory", "KB-DUMP-DIRECTORY", 0, 2, false);
    declareFunction(myName, "kb_dump_file", "KB-DUMP-FILE", 2, 1, false);
    //declareFunction(myName, "kb_dump_product_file", "KB-DUMP-PRODUCT-FILE", 2, 1, false);
    //declareFunction(myName, "dump_estimated_size", "DUMP-ESTIMATED-SIZE", 0, 1, false);
    declareFunction(myName, "verify_file_existence", "VERIFY-FILE-EXISTENCE", 1, 1, false);
    //declareFunction(myName, "validate_dump_directory", "VALIDATE-DUMP-DIRECTORY", 1, 0, false);
    declareFunction(myName, "kb_load_gc_checkpoint", "KB-LOAD-GC-CHECKPOINT", 0, 0, false);
    //declareFunction(myName, "preprocess_experience_and_dump_standard_kb", "PREPROCESS-EXPERIENCE-AND-DUMP-STANDARD-KB", 0, 3, false);
    //declareFunction(myName, "dump_standard_kb", "DUMP-STANDARD-KB", 0, 1, false);
    //declareFunction(myName, "perform_standard_pre_dump_kb_cleanups", "PERFORM-STANDARD-PRE-DUMP-KB-CLEANUPS", 0, 0, false);
    //declareFunction(myName, "perform_kb_cleanups", "PERFORM-KB-CLEANUPS", 0, 0, false);
    //declareFunction(myName, "preprocess_experience", "PREPROCESS-EXPERIENCE", 0, 2, false);
    //declareFunction(myName, "preprocess_experience_and_dump_non_computable_kb", "PREPROCESS-EXPERIENCE-AND-DUMP-NON-COMPUTABLE-KB", 0, 3, false);
    //declareFunction(myName, "dump_non_computable_kb", "DUMP-NON-COMPUTABLE-KB", 1, 0, false);
    //declareFunction(myName, "load_non_computable_kb_and_rebuild_computable_kb_and_write_image", "LOAD-NON-COMPUTABLE-KB-AND-REBUILD-COMPUTABLE-KB-AND-WRITE-IMAGE", 3, 0, false);
    //declareFunction(myName, "load_non_computable_kb", "LOAD-NON-COMPUTABLE-KB", 1, 0, false);
    //declareFunction(myName, "dump_computable_kb_and_content", "DUMP-COMPUTABLE-KB-AND-CONTENT", 2, 0, false);
    //declareFunction(myName, "dump_kb", "DUMP-KB", 0, 1, false);
    declareFunction(myName, "load_kb", "LOAD-KB", 1, 0, false);
    //declareFunction(myName, "kb_dump_to_directory", "KB-DUMP-TO-DIRECTORY", 1, 0, false);
    ...
    //declareFunction(myName, "dump_essential_kb", "DUMP-ESSENTIAL-KB", 1, 0, false);
    ...
    //declareFunction(myName, "dump_computable_content", "DUMP-COMPUTABLE-CONTENT", 1, 0, false);
    declareFunction(myName, "load_computable_content", "LOAD-COMPUTABLE-CONTENT", 1, 0, false);
    //declareFunction(myName, "rebuild_computable_content", "REBUILD-COMPUTABLE-CONTENT", 0, 0, false);
    //declareFunction(myName, "rebuild_computable_content_dumpable", "REBUILD-COMPUTABLE-CONTENT-DUMPABLE", 0, 0, false);
    //declareFunction(myName, "rebuild_computable_content_dumpable_low", "REBUILD-COMPUTABLE-CONTENT-DUMPABLE-LOW", 0, 0, false);
    //declareFunction(myName, "dump_computable_kb", "DUMP-COMPUTABLE-KB", 1, 0, false);
    declareFunction(myName, "load_computable_kb", "LOAD-COMPUTABLE-KB", 1, 0, false);
    //declareFunction(myName, "rebuild_computable_kb", "REBUILD-COMPUTABLE-KB", 0, 0, false);
    //declareFunction(myName, "dump_computable_remaining_hl", "DUMP-COMPUTABLE-REMAINING-HL", 1, 0, false);
    declareFunction(myName, "load_computable_remaining_hl", "LOAD-COMPUTABLE-REMAINING-HL", 1, 0, false);
    //declareFunction(myName, "rebuild_computable_remaining_hl", "REBUILD-COMPUTABLE-REMAINING-HL", 0, 0, false);
    //declareFunction(myName, "rebuild_computable_remaining_hl_low", "REBUILD-COMPUTABLE-REMAINING-HL-LOW", 0, 0, false);
    //declareFunction(myName, "rebuild_computable_remaining_hl_high", "REBUILD-COMPUTABLE-REMAINING-HL-HIGH", 0, 0, false);
    ...
    //declareFunction(myName, "dump_kb_object_count", "DUMP-KB-OBJECT-COUNT", 3, 0, false);
    declareFunction(myName, "load_kb_object_count", "LOAD-KB-OBJECT-COUNT", 2, 0, false);
    //declareFunction(myName, "kb_dump_common_symbols", "KB-DUMP-COMMON-SYMBOLS", 0, 0, false);
    //declareFunction(myName, "dump_special_objects", "DUMP-SPECIAL-OBJECTS", 1, 0, false);
    //declareFunction(myName, "dump_special_objects_internal", "DUMP-SPECIAL-OBJECTS-INTERNAL", 2, 0, false);
    ...
    //declareFunction(myName, "dump_constant_shells", "DUMP-CONSTANT-SHELLS", 1, 0, false);
    ...
    //declareFunction(myName, "dump_constant_shell", "DUMP-CONSTANT-SHELL", 2, 0, false);
    //declareFunction(myName, "dump_constant_shell_internal", "DUMP-CONSTANT-SHELL-INTERNAL", 4, 0, false);
    ...
    //declareFunction(myName, "generate_constant_shell_file", "GENERATE-CONSTANT-SHELL-FILE", 1, 0, false);
    //declareFunction(myName, "dump_nart_count", "DUMP-NART-COUNT", 1, 0, false);
    ...
    //declareFunction(myName, "load_nart_shells_legacy", "LOAD-NART-SHELLS-LEGACY", 1, 0, false);
    //declareFunction(myName, "dump_nart_shell", "DUMP-NART-SHELL", 2, 0, false);
    //declareFunction(myName, "load_nart_shell", "LOAD-NART-SHELL", 2, 0, false);
    //declareFunction(myName, "dump_assertion_count", "DUMP-ASSERTION-COUNT", 1, 0, false);
    ...
    //declareFunction(myName, "load_assertion_shells_legacy", "LOAD-ASSERTION-SHELLS-LEGACY", 1, 0, false);
    //declareFunction(myName, "dump_assertion_shell", "DUMP-ASSERTION-SHELL", 2, 0, false);
    //declareFunction(myName, "load_assertion_shell", "LOAD-ASSERTION-SHELL", 2, 0, false);
    //declareFunction(myName, "dump_kb_hl_support_count", "DUMP-KB-HL-SUPPORT-COUNT", 1, 0, false);
    ...
    //declareFunction(myName, "load_kb_hl_support_shells_legacy", "LOAD-KB-HL-SUPPORT-SHELLS-LEGACY", 1, 0, false);
    //declareFunction(myName, "dump_kb_hl_support_shell", "DUMP-KB-HL-SUPPORT-SHELL", 2, 0, false);
    //declareFunction(myName, "load_kb_hl_support_shell", "LOAD-KB-HL-SUPPORT-SHELL", 2, 0, false);
    //declareFunction(myName, "dump_kb_unrepresented_terms", "DUMP-KB-UNREPRESENTED-TERMS", 1, 0, false);
    declareFunction(myName, "load_kb_unrepresented_terms", "LOAD-KB-UNREPRESENTED-TERMS", 1, 0, false);
    //declareFunction(myName, "dump_kb_unrepresented_term", "DUMP-KB-UNREPRESENTED-TERM", 2, 0, false);
    ...
    //declareFunction(myName, "dump_clause_struc_defs", "DUMP-CLAUSE-STRUC-DEFS", 1, 0, false);
    declareFunction(myName, "load_clause_struc_defs", "LOAD-CLAUSE-STRUC-DEFS", 1, 0, false);
    //declareFunction(myName, "dump_clause_struc_def", "DUMP-CLAUSE-STRUC-DEF", 2, 0, false);
    ...
    //declareFunction(myName, "dump_deduction_defs", "DUMP-DEDUCTION-DEFS", 1, 0, false);
    declareFunction(myName, "load_deduction_defs", "LOAD-DEDUCTION-DEFS", 1, 0, false);
    //declareFunction(myName, "dump_deduction_def", "DUMP-DEDUCTION-DEF", 2, 0, false);
    declareFunction(myName, "load_deduction_def", "LOAD-DEDUCTION-DEF", 2, 0, false);
    declareFunction(myName, "load_deduction_def_from_cache", "LOAD-DEDUCTION-DEF-FROM-CACHE", 2, 0, false); new $load_deduction_def_from_cache$BinaryFunction();
    declareFunction(myName, "load_deduction_count", "LOAD-DEDUCTION-COUNT", 1, 0, false);
    //declareFunction(myName, "dump_assertion_defs", "DUMP-ASSERTION-DEFS", 1, 0, false);
    declareFunction(myName, "load_assertion_defs", "LOAD-ASSERTION-DEFS", 1, 0, false);
    //declareFunction(myName, "dump_assertion_def", "DUMP-ASSERTION-DEF", 2, 0, false);
    declareFunction(myName, "load_assertion_def", "LOAD-ASSERTION-DEF", 2, 0, false);
    declareFunction(myName, "load_assertion_def_from_cache", "LOAD-ASSERTION-DEF-FROM-CACHE", 2, 0, false); new $load_assertion_def_from_cache$BinaryFunction();
    //declareFunction(myName, "dump_kb_hl_support_defs", "DUMP-KB-HL-SUPPORT-DEFS", 1, 0, false);
    declareFunction(myName, "load_kb_hl_support_defs", "LOAD-KB-HL-SUPPORT-DEFS", 1, 0, false);
    //declareFunction(myName, "dump_kb_hl_support_def", "DUMP-KB-HL-SUPPORT-DEF", 2, 0, false);
    ...
    //declareFunction(myName, "dump_kb_hl_support_indexing", "DUMP-KB-HL-SUPPORT-INDEXING", 1, 0, false);
    declareFunction(myName, "load_kb_hl_support_indexing", "LOAD-KB-HL-SUPPORT-INDEXING", 1, 0, false);
    //declareFunction(myName, "dump_bookkeeping_assertions", "DUMP-BOOKKEEPING-ASSERTIONS", 1, 0, false);
    //declareFunction(myName, "dump_bookkeeping_assertions_for_pred", "DUMP-BOOKKEEPING-ASSERTIONS-FOR-PRED", 3, 0, false);
    //declareFunction(myName, "dump_bookkeeping_assertion", "DUMP-BOOKKEEPING-ASSERTION", 3, 0, false);
    ...
    //declareFunction(myName, "dump_experience", "DUMP-EXPERIENCE", 1, 0, false);
    //declareFunction(myName, "dump_rule_utility_experience", "DUMP-RULE-UTILITY-EXPERIENCE", 1, 1, false);
    ...
    //declareFunction(myName, "reload_experience", "RELOAD-EXPERIENCE", 0, 1, false);
    //declareFunction(myName, "dump_kb_indexing", "DUMP-KB-INDEXING", 1, 0, false);
    declareFunction(myName, "load_kb_indexing", "LOAD-KB-INDEXING", 1, 0, false);
    //declareFunction(myName, "rebuild_kb_indexing", "REBUILD-KB-INDEXING", 0, 0, false);
    //declareFunction(myName, "test_dump_kb_indexing", "TEST-DUMP-KB-INDEXING", 1, 0, false);
    //declareFunction(myName, "test_load_kb_indexing", "TEST-LOAD-KB-INDEXING", 1, 0, false);
    //declareFunction(myName, "dump_constant_indices", "DUMP-CONSTANT-INDICES", 1, 0, false);
    declareFunction(myName, "load_constant_indices", "LOAD-CONSTANT-INDICES", 1, 0, false);
    //declareFunction(myName, "dump_constant_index", "DUMP-CONSTANT-INDEX", 2, 0, false);
    ...
    //declareFunction(myName, "dump_nart_indices", "DUMP-NART-INDICES", 1, 0, false);
    declareFunction(myName, "load_nart_indices", "LOAD-NART-INDICES", 1, 0, false);
    //declareFunction(myName, "dump_nart_index", "DUMP-NART-INDEX", 2, 0, false);
    //declareFunction(myName, "load_nart_index", "LOAD-NART-INDEX", 2, 0, false);
    //declareFunction(myName, "load_nart_index_from_cache", "LOAD-NART-INDEX-FROM-CACHE", 2, 0, false);
    //declareFunction(myName, "dump_unrepresented_term_indices", "DUMP-UNREPRESENTED-TERM-INDICES", 1, 0, false);
    declareFunction(myName, "load_unrepresented_term_indices", "LOAD-UNREPRESENTED-TERM-INDICES", 1, 0, false);
    //declareFunction(myName, "dump_unrepresented_term_index", "DUMP-UNREPRESENTED-TERM-INDEX", 2, 0, false);
    ...
    //declareFunction(myName, "dump_assertion_indices", "DUMP-ASSERTION-INDICES", 1, 0, false);
    declareFunction(myName, "load_assertion_indices", "LOAD-ASSERTION-INDICES", 1, 0, false);
    //declareFunction(myName, "dump_assertion_index", "DUMP-ASSERTION-INDEX", 2, 0, false);
    declareFunction(myName, "load_assertion_index", "LOAD-ASSERTION-INDEX", 2, 0, false);
    //declareFunction(myName, "dump_auxiliary_indices_file", "DUMP-AUXILIARY-INDICES-FILE", 1, 0, false);
    declareFunction(myName, "load_auxiliary_indices_file", "LOAD-AUXILIARY-INDICES-FILE", 1, 0, false);
    //declareFunction(myName, "dump_bookkeeping_indices_file", "DUMP-BOOKKEEPING-INDICES-FILE", 1, 0, false);
    declareFunction(myName, "load_bookkeeping_indices_file", "LOAD-BOOKKEEPING-INDICES-FILE", 1, 0, false);
    //declareFunction(myName, "dump_bookkeeping_indices", "DUMP-BOOKKEEPING-INDICES", 1, 0, false);
    ...
    //declareFunction(myName, "dump_nart_hl_formulas", "DUMP-NART-HL-FORMULAS", 1, 0, false);
    declareFunction(myName, "load_nart_hl_formulas", "LOAD-NART-HL-FORMULAS", 1, 0, false);
    //declareFunction(myName, "dump_nart_hl_formula", "DUMP-NART-HL-FORMULA", 3, 0, false);
    //declareFunction(myName, "load_nart_hl_formula", "LOAD-NART-HL-FORMULA", 2, 0, false);
    //declareFunction(myName, "load_nart_hl_formula_from_cache", "LOAD-NART-HL-FORMULA-FROM-CACHE", 2, 0, false); new $load_nart_hl_formula_from_cache$BinaryFunction();
    //declareFunction(myName, "dump_miscellaneous", "DUMP-MISCELLANEOUS", 1, 0, false);
    ...
    //declareFunction(myName, "old_dump_sbhl_data", "OLD-DUMP-SBHL-DATA", 1, 0, false);
    declareFunction(myName, "load_sbhl_data", "LOAD-SBHL-DATA", 1, 0, false);
    //declareFunction(myName, "rebuild_sbhl_data", "REBUILD-SBHL-DATA", 0, 0, false);
    //declareFunction(myName, "dump_sbhl_miscellany", "DUMP-SBHL-MISCELLANY", 1, 0, false);
    //declareFunction(myName, "dump_isa_arg2_naut_table", "DUMP-ISA-ARG2-NAUT-TABLE", 1, 0, false);
    //declareFunction(myName, "dump_non_fort_isa_table", "DUMP-NON-FORT-ISA-TABLE", 1, 0, false);
    //declareFunction(myName, "dump_non_fort_instance_table", "DUMP-NON-FORT-INSTANCE-TABLE", 1, 0, false);
    ...
    //declareFunction(myName, "dump_sbhl_cache", "DUMP-SBHL-CACHE", 1, 0, false);
    declareFunction(myName, "load_sbhl_cache", "LOAD-SBHL-CACHE", 1, 0, false);
    //declareFunction(myName, "rebuild_sbhl_cache", "REBUILD-SBHL-CACHE", 0, 0, false);
    //declareFunction(myName, "dump_cardinality_estimates", "DUMP-CARDINALITY-ESTIMATES", 1, 0, false);
    declareFunction(myName, "load_cardinality_estimates", "LOAD-CARDINALITY-ESTIMATES", 1, 0, false);
    //declareMacro(myName, "not_computing_arg_type_cache", "NOT-COMPUTING-ARG-TYPE-CACHE");
    //declareFunction(myName, "dump_arg_type_cache", "DUMP-ARG-TYPE-CACHE", 1, 0, false);
    declareFunction(myName, "load_arg_type_cache", "LOAD-ARG-TYPE-CACHE", 1, 0, false);
    //declareFunction(myName, "rebuild_arg_type_cache", "REBUILD-ARG-TYPE-CACHE", 0, 0, false);
    //declareFunction(myName, "dump_defns_cache", "DUMP-DEFNS-CACHE", 1, 0, false);
    ...
    //declareFunction(myName, "dump_somewhere_cache", "DUMP-SOMEWHERE-CACHE", 1, 0, false);
    declareFunction(myName, "load_somewhere_cache", "LOAD-SOMEWHERE-CACHE", 1, 0, false);
    //declareFunction(myName, "dump_arity_cache", "DUMP-ARITY-CACHE", 1, 0, false);
    declareFunction(myName, "load_arity_cache", "LOAD-ARITY-CACHE", 1, 0, false);
    //declareFunction(myName, "dump_kb_activities", "DUMP-KB-ACTIVITIES", 1, 0, false);
    ...
    //declareFunction(myName, "show_kb_features", "SHOW-KB-FEATURES", 0, 0, false);
    return NIL;
  }

  public static final SubLObject init_dumper_file() {
    $force_monolithic_kb_assumption$ = deflexical("*FORCE-MONOLITHIC-KB-ASSUMPTION*", ((NIL != Symbols.boundp($sym0$_FORCE_MONOLITHIC_KB_ASSUMPTION_)) ? ((SubLObject) $force_monolithic_kb_assumption$.getGlobalValue()) : NIL));
    ...
    $kb_dump_common_symbols$ = defparameter("*KB-DUMP-COMMON-SYMBOLS*", ConsesLow.append(new SubLObject[] {enumeration_types.valid_hl_truth_values(), enumeration_types.valid_directions(), arguments.asserted_argument_tokens(), hl_supports.hl_support_modules(), hash_table_utilities.valid_hash_test_symbols(), $list64}));
  ...
  public static final SubLList $list9 = list(list(makeSymbol("*CFASL-CONSTANT-HANDLE-LOOKUP-FUNC*"), list(makeSymbol("QUOTE"), makeSymbol("FIND-CONSTANT-BY-DUMP-ID"))), list(makeSymbol("*CFASL-NART-HANDLE-LOOKUP-FUNC*"), list(makeSymbol("QUOTE"), makeSymbol("FIND-NART-BY-DUMP-ID"))), list(makeSymbol("*CFASL-ASSERTION-HANDLE-LOOKUP-FUNC*"), list(makeSymbol("QUOTE"), makeSymbol("FIND-ASSERTION-BY-DUMP-ID"))), list(makeSymbol("*CFASL-DEDUCTION-HANDLE-LOOKUP-FUNC*"), list(makeSymbol("QUOTE"), makeSymbol("FIND-DEDUCTION-BY-DUMP-ID"))), list(makeSymbol("*CFASL-KB-HL-SUPPORT-HANDLE-LOOKUP-FUNC*"), list(makeSymbol("QUOTE"), makeSymbol("FIND-KB-HL-SUPPORT-BY-DUMP-ID"))), list(makeSymbol("*CFASL-CLAUSE-STRUC-HANDLE-LOOKUP-FUNC*"), list(makeSymbol("QUOTE"), makeSymbol("FIND-CLAUSE-STRUC-BY-DUMP-ID"))));
