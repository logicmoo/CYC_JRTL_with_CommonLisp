 ...
 * $Id: logorc2.java,v 1.4 2003-12-10 08:55:00 asimon Exp $
 *
...
{
    private logorc2(String name, String arglist)
    {
        super(name,arglist);
    }
    ...
    private static final logorc2 LOGORC2 = new logorc2("logorc2","integer-1 integer-2");
}
