 ...
 * $Id: Symbol.java,v 1.134 2004-05-31 19:21:22 piso Exp $
 *
...
public class Symbol extends LispObject
{
    ...
    public static final Symbol SOCKET_STREAM                    = PACKAGE_SYS.addExternalSymbol("SOCKET-STREAM");
    ...
    {
        LispObject obj = get(this, PACKAGE_SYS.intern("SETF-FUNCTION"));
        if (obj == null)
