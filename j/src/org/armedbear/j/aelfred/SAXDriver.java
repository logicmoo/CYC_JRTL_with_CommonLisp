...
import org.armedbear.j.aelfred.DefaultHandler;


// $Id: SAXDriver.java,v 1.1.1.1 2002-09-24 16:10:24 piso Exp $
 ...
 * @version $Date: 2002-09-24 16:10:24 $
    ...
    implements Locator, Attributes, XMLReader, Parser, AttributeList
{
    ...
    throws SAXException
    {
	LexicalHandler handler = lexicalHandler;
