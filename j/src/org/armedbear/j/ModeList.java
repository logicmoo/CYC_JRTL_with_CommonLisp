 ...
 * $Id: ModeList.java,v 1.2 2002-10-06 18:14:22 piso Exp $
 *
...
public final class ModeList implements Constants
{
    ...
    private ModeList()
    {
        ...
        addEntry(BEANSHELL_MODE, BEANSHELL_MODE_NAME, "BeanShellMode", true, ".+\\.bsh");
        ...
        addEntry(LISP_MODE, LISP_MODE_NAME, "LispMode", true, ".+\\.[ej]l|.*\\.lisp|.*\\.emacs");
        ...
        addEntry(SCHEME_MODE, SCHEME_MODE_NAME, "SchemeMode", true, ".+\\.scm");
