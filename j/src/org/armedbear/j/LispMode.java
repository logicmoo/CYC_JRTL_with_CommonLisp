...
public class LispMode extends AbstractMode implements Constants, Mode
{
    ...
    private final String[] specials = new String[] {
        "case", "catch", "do-all-symbols", "do-external-symbols", "do-symbols",
        "dolist", "dotimes", "ecase", "eval-when", "flet", "handler-bind",
        "lambda", "let", "let*", "loop", "multiple-value-bind", "progn",
        "typecase", "unless", "when"
    };
