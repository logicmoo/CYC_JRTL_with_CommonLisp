 ...
 * $Id: Editor.java,v 1.1.1.1 2002-09-24 16:08:56 piso Exp $
 *
...
public final class Editor extends JPanel implements Constants, ComponentListener
{
    ...
    public Position findMatchInternal(Position start, int numLines)
    {
        ...
        if (mode.isInComment(getBuffer(), start))
            return null;
    ...
    {
        CompoundEdit compoundEdit = beginCompoundEdit();
        if  (Utilities.isLinePaste(toBeInserted) && mark == null) {
