    ...
    ComponentListener, MouseWheelListener
{
    ...
    final static PrintStream sout = System.out;
    private static final void usage()
    {
        version();

        sout.println("Usage: j [options] [+linenum] file");
        sout.println("Options:");
        sout.println("  -h, -help");
        sout.println("  -d, --debug");
        sout.println("  -n, --no-restore");
        sout.println("  -version");
        sout.println("  --force-new-instance");
        sout.println("  --no-session");
        sout.println("  --no-server");
        sout.println("  --home=directory");
    }
